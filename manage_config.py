...
def view_config():
    ...
    if client.auth_status.value == "authenticated":
        ...
        print(f"🔑 Access token: {client.auth_tokens.access_token[:30]}...{client.auth_tokens.access_token[-15:]}")
...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description="Manage Meijer authentication configuration")
    parser.add_argument('action', choices=['view', 'test', 'clear', 'refresh'], 
