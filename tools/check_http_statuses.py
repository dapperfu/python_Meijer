...
def check_http_statuses():
    ...
    try:
        ...
        if 200 in status_counts:
            ...
            # Show a few examples
            success_positions = [m.start() for m in re.finditer(r'11:status_code;(\d+):200', decoded_content)]
        ...
        if 400 in status_counts:
            ...
            # Show a few examples
            error_positions = [m.start() for m in re.finditer(r'11:status_code;(\d+):400', decoded_content)]
