...
class MultiLogCouponAnalyzer:
    ...
    def _search_patterns_in_content(
        self, content: str, file_results: Dict[str, Any]
    ) -> None:
        ...
        dollar_off_matches = re.findall(
            r"\$15\.00.*[Oo]ff|[Oo]ff.*\$15\.00", content, re.IGNORECASE
        )
        ...
        endpoint_patterns = [r"ads", r"coupons", r"rewards", r"offers", r"promotions"]
        ...
        if self.cottonelle_items:
            ...
            for item in self.cottonelle_items[:3]:
                if isinstance(item, dict):
                    ...
                    print(
                        f"    Description: {description[:100] if description else 'N/A'}..."
                    )
                    print()
