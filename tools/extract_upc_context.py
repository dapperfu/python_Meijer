    ...
    while True:
        ...
        try:
            ...
            results["upc_629_contexts"].append(
                {"position": pos, "context": context_text, "json_matches": json_matches}
            )
...
def generate_complete_session_template(
...
def main():
    ...
    for i, (upc, pos) in enumerate(
        analysis["upc_scanning_sequence"][:20]
    ):  # Show first 20
