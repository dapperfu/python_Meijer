...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage:")
        print(
            "  python manage_auth_config.py view                    # View current configuration"
        )
        print(
            "  python manage_auth_config.py edit <key> <value>     # Edit a configuration value"
        )
        print(
            "  python manage_auth_config.py reset                  # Reset to default configuration"
        )
        print(
            "  python manage_auth_config.py path                   # Show configuration file path"
        )
        return
    ...
    if command == "view":
        ...
        if len(sys.argv) < 4:
            ...
            print(
                "Example: python manage_auth_config.py edit oauth2.client_id new_client_id"
            )
            return
