        ...
        while True:
            ...
            try:
                ...
                if http_match:
                    ...
                    operation = (
                        operation_match.group(1) if operation_match else "UNKNOWN"
                    )
                    ...
                    if (
                        operation
                        not in results["checkout_endpoints"][endpoint_key]["operations"]
                    ):
                        results["checkout_endpoints"][endpoint_key]["operations"][
                            operation
                        ] = 0
                    results["checkout_endpoints"][endpoint_key]["operations"][
                        operation
        ...
        while True:
            ...
            try:
                ...
                results["checkout_operations"][pattern.decode("utf-8")] = {
                    "count": results["checkout_operations"]
                    .get(pattern.decode("utf-8"), {})
                    .get("count", 0)
                    + 1,
                    "endpoint": endpoint,
                    "device_id": device_id,
            ...
            try:
                ...
                checkout_context = (
                    ...
                    if any(
                        ...
                        for word in ["checkout", "transfer", "complete"]
                    )
                    else "other"
                )
    ...
    for pattern in summary_patterns:
        ...
        while True:
            ...
            try:
                ...
                prices = [
                    float(p) for p in price_matches if p.replace(".", "").isdigit()
                ]
