...
def generate_session_start_template(device_info: Dict[str, Any]) -> Dict[str, Any]:
    ...
    device_id = device_info['unique_device_ids'][0] if device_info['unique_device_ids'] else "50dbc7dc-e839-46d9-9bfd-292c0d4f831e"
    device_os = device_info['device_os_info'][0] if device_info['device_os_info'] else "Android"
    app_version = device_info['app_versions'][0] if device_info['app_versions'] else "10.28.0"
