...
def is_auth_flow(flow: Dict[str, Any]) -> bool:
    ...
    if any(header.lower() in ['authorization', 'cookie'] for header in flow.get('headers', {})):
        return True
...
def save_analysis_results(analysis: Dict[str, Any], output_file: str = "binary_auth_analysis.json"):
...
def main():
    ...
    print("=" * 80)
    print("This tool analyzes mitmproxy binary logs to extract authentication patterns.")
    print()
