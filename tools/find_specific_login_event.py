...
def find_login_sequence(content: str) -> Dict[str, Any]:
    ...
    okta_matches = re.finditer(r'id\.meijer\.com.*oauth2.*authorize', content, re.IGNORECASE)
    ...
    username_matches = re.finditer(r'POST.*id\.meijer\.com.*identify', content, re.IGNORECASE)
    ...
    password_matches = re.finditer(r'POST.*id\.meijer\.com.*challenge.*answer', content, re.IGNORECASE)
    ...
    twofa_matches = re.finditer(r'challenge.*email.*verification', content, re.IGNORECASE)
    ...
    verification_matches = re.finditer(r'POST.*challenge.*answer.*verification', content, re.IGNORECASE)
...
def display_login_sequence(login_sequence: Dict[str, Any]) -> None:
    ...
    if login_sequence['2fa_challenge'] and 'email' in login_sequence['2fa_challenge']['context'].lower():
        print("✅ Email-based 2FA confirmed!")
    
    # Check for successful authentication
    if login_sequence['final_landing']:
        print("✅ Successful authentication confirmed!")
        print(f"   Final landing: {login_sequence['final_landing']['context'][:200]}...")
