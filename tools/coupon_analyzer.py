...
class MeijerCouponAnalyzer:
    ...
    def _extract_offer_structures(
        ...
        if isinstance(response_data, dict):
            ...
            elif "results" in response_data and isinstance(
    ...
    def _analyze_single_offer(self, offer: Dict[str, Any], endpoint_type: str) -> None:
        ...
        for field_name, field_value in offer.items():
            ...
            if field_name not in self.analysis.data_types:
                ...
                # Handle mixed types
                self.analysis.data_types[field_name] = (
                    f"Union[{self.analysis.data_types[field_name]}, {field_type}]"
                )
    ...
    def generate_coupon_class_definition(self) -> str:
        ...
        sorted_fields = sorted(
            self.analysis.common_fields.items(), key=lambda x: x[1], reverse=True
        )
...
'''
    ...
    def generate_report(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "sample_offers": {
                endpoint: structures[:3]
                if len(structures) > 3
                else structures  # First 3 examples
