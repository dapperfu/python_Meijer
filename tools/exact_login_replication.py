...
class ExactLoginReplication:
    ...
    def __init__(self, username: str, password: str, proxy_host: str = "127.0.0.1", proxy_port: int = 8080):
        ...
        if os.path.exists(self.ssl_cert_path):
            ...
            print(f"⚠️  SSL certificate not found at {self.ssl_cert_path}, SSL verification disabled")
