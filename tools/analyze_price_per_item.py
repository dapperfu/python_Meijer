...
def analyze_price_per_item_changes(
                            ...
                            if curr_step["items_added"] > 0:
                                ...
                                if i > 0:
                                    ...
                                    if prev_price > 0 and price_per_item < prev_price:
                                        ...
                                        print(
                                            f"    → PRICE DROP! ${prev_price:.2f} → ${price_per_item:.2f} (Save: ${discount:.2f})"
                                        )
                                    ...
                                    if total_items == 5 and price_per_item == 2.99:
                                        ...
                                        print(
                                            "    → Hit 4-item threshold - price dropped!"
                                        )
                                    elif total_items == 2 and price_per_item < 3.99:
                                        print(
                                            "    → Hit 2-item threshold - price dropped!"
                                        )

                # Look for quantity patterns in the content
                quantity_matches = re.findall(
                    r'"quantityWeight":([\d.]+).*?"pricingText":"([^"]+)"', content_str
                )
            ...
            if pricing_drops:
                ...
                for drop in pricing_drops:
                    ...
                    if drop["total_items"] == 5 and drop["new_price"] == 2.99:
                        print(
                            "    → This is the 5-item threshold drop for LPC LITTLE REDS!"
                        )
