...
def analyze_latest_log():
    ...
    try:
        ...
        for i, flow in enumerate(flows):
            ...
            if (flow.get('host') == 'id.meijer.com' and 
                flow.get('path', '').startswith('/oauth2/default/v1/authorize') and
                'login_hint' in flow.get('url', '') and
                flow.get('status_code') == 200):
            ...
            elif (flow.get('host') == 'id.meijer.com' and 
                  flow.get('path') == '/oauth2/default/v1/logout' and
                  flow.get('status_code') == 200):
            ...
            # Look for device nonce requests
                  ...
                  flow.get('path') == '/api/v1/internal/device/nonce' and
                  flow.get('method') == 'POST' and
                  flow.get('status_code') == 200):
            ...
            # Look for challenge answer (password submission)
                  ...
                  flow.get('path') == '/idp/idx/challenge/answer' and
                  flow.get('method') == 'POST' and
                  flow.get('status_code') == 200):
            ...
            # Look for OAuth keys request
                  ...
                  flow.get('path', '').startswith('/oauth2/default/v1/keys') and
                  flow.get('status_code') == 200):
            ...
            # Look for token exchange
                  ...
                  flow.get('path') == '/oauth2/default/v1/token' and
                  flow.get('method') == 'POST' and
                  flow.get('status_code') == 200):
