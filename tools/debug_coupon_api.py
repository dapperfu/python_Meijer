                    ...
                    for field in [
                        ...
                        if field in data:
                            ...
                            if isinstance(potential_offers, list):
                                ...
                                print(
                                    f"   ✅ Found offers in '{field}': {len(offers)} items"
                                )
                                break
                            elif (
                                isinstance(potential_offers, dict)
                                and "offers" in potential_offers
                            ):
                                offers = potential_offers["offers"]
                                print(
                                    f"   ✅ Found offers in '{field}.offers': {len(offers)} items"
                                )
                                break
    ...
    for variant in test_variants:
        ...
        try:
            ...
            response = client._make_request(
                "POST", url, headers=headers, json=variant_body
            )
