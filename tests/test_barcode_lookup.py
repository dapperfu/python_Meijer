...
class BarcodeLookupTester:
    ...
    def test_single_barcode_lookup(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if product:
                ...
                return {"success": True, "barcode": test_barcode, "product": product}
            else:
            ...
            return {"success": False, "barcode": test_barcode, "error": str(e)}
        ...
        try:
            ...
            for barcode in weighted_barcodes:
                ...
                if product:
                    ...
                    print(
                        f"   ✅ {title}: ${price:.2f}{price_unit} {'(Weighted)' if is_weighted else ''}"
                    )
            ...
            found_weighted = sum(
                1 for p in weighted_results.values() if p and p.get("isWeighted")
            )
    ...
    def test_store_specific_pricing(self) -> Dict[str, Any]:
        ...
        try:
            ...
            product_with_store = self.client.lookup_barcode_price(
                test_barcode, store_id="771"
            )

            results = {"no_store": product_no_store, "with_store": product_with_store}
    ...
    def run_comprehensive_test(self):
        ...
        if sample_product:
            print("\n💡 Usage Example:")
            print("   client = Meijer()")
            print('   product = client.lookup_barcode_price("049000050103")')
            print("   print(f\"{product['title']}: ${product['unitPrice']:.2f}\")")
