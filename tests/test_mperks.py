...
from meijer.mperks import EarnedReward, MCardInfo, MPerksEarnedRewards
...
class TestMPerksEarnedRewards:
    ...
    def test_get_earned_rewards_success(self):
        ...
        assert (
            self.mperks.endpoints["earned_rewards"] in call_args[0][1]
    ...
    def test_get_earned_rewards_with_parameters(self):
        ...
        rewards = self.mperks.get_earned_rewards(
            category="test", reward_type="points", is_active=True
        )
    ...
    def test_get_available_rewards_success(self):
        ...
        assert (
            self.mperks.endpoints["available_rewards"] in call_args[0][1]
        )  # URL contains endpoint
    ...
    def test_get_reward_categories_success(self):
        ...
        assert call_args[0][0] == "GET"  # method
        assert (
            self.mperks.endpoints["reward_categories"] in call_args[0][1]
        )  # URL contains endpoint
