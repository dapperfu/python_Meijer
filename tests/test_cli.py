...
from meijer.cli import display_items_table, get_meijer_client
...
class TestCLIFunctions:
    ...
    def test_display_items_table_with_items(self):
        ...
        mock_items = [
            Mock(name="Milk", quantity=2, checked=False, notes="Organic"),
            Mock(name="Bread", quantity=1, checked=True, notes=None),
        ]
