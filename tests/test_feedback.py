...
class TestMeijerFeedback:
    ...
    @pytest.mark.asyncio
    async def test_submit_feedback_success(self, feedback_client, sample_device_data, sample_form_data):
        ...
        # Submit feedback
        result = await feedback_client.submit_feedback(sample_form_data, sample_device_data)
    ...
    @pytest.mark.asyncio
    async def test_submit_feedback_api_error(self, feedback_client, sample_device_data, sample_form_data):
    ...
    @pytest.mark.asyncio
    async def test_submit_feedback_exception(self, feedback_client, sample_device_data, sample_form_data):
        """Test feedback submission with general exception."""
        # Mock API call that raises exception
        feedback_client.api_client.post = AsyncMock(side_effect=Exception("Network error"))
        
        # Submit feedback should raise FeedbackError
        with pytest.raises(FeedbackError, match="Error submitting feedback: Network error"):
            await feedback_client.submit_feedback(sample_form_data, sample_device_data)
    
    @pytest.mark.asyncio
    async def test_submit_store_search_feedback(self, feedback_client, sample_device_data):
    ...
    @pytest.mark.asyncio
    async def test_submit_registration_feedback(self, feedback_client, sample_device_data):
