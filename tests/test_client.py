...
from meijer.models import MeijerItem, MeijerCoupon, Store, ListItem
...
class TestMeijerClient:
    ...
    def test_lookup_barcode_price(self):
        ...
        self.client.shop_scan.lookup_barcode_price.assert_called_once_with("049000050103", None)
    ...
    def test_bulk_lookup_barcodes(self):
        ...
        self.client.shop_scan.bulk_lookup_barcodes.assert_called_once_with(barcodes, None)
