...
class FirefoxProfileManager:
    ...
    def __init__(
        self, profile_name: str = "meijer_automation", base_dir: Optional[str] = None
    ):
        """
        ...
        logger.info(
            f"Firefox Profile Manager initialized for profile: {self.profile_name}"
        )
    ...
    def configure_selenium_options(
        self,
        options: Options,
    ...
    def create_firefox_profile_object(
        self, proxy_host: Optional[str] = None, proxy_port: Optional[int] = None
    ) -> FirefoxProfile:
        """
