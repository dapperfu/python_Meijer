...
class MeijerRegistrationClient:
    ...
    def validate_phone(self, phone_number: str) -> PhoneValidationResult:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                is_valid = data.get('isValid') == 'true'  # API returns string "true"/"false"
    ...
    def create_account(self, registration_data: Union[RegistrationData, Dict[str, Any]]) -> AccountCreationResult:
        """
