...
class MPerksEarnedRewards:
    ...
    def get_earned_rewards(self, **kwargs) -> List[EarnedReward]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                raise MeijerAPIError(f"Failed to get earned rewards: {response.status_code} - {response.text}")
    ...
    def get_mcard_info(self, **kwargs) -> MCardInfo:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                raise MeijerAPIError(f"Failed to get mCard info: {response.status_code} - {response.text}")
    ...
    def get_available_rewards(self, **kwargs) -> List[EarnedReward]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                raise MeijerAPIError(f"Failed to get available rewards: {response.status_code} - {response.text}")
    ...
    def get_reward_categories(self, clip_filter: str = "unclippedonly", **kwargs) -> List[str]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                raise MeijerAPIError(f"Failed to get reward categories: {response.status_code} - {response.text}")
    ...
    def _parse_earned_rewards_response(self, data: Dict[str, Any]) -> List[EarnedReward]:
        ...
        try:
            ...
            if "earnedRewards" in data:
                ...
                self.logger.warning(f"Unexpected earned rewards response structure: {data.keys()}")
                return []
            ...
            for reward_data in rewards_data:
                try:
                    reward = EarnedReward(
                        ...
                        expiration_date=self._parse_datetime(reward_data.get("expirationDate")),
    ...
    def _parse_available_rewards_response(self, data: Dict[str, Any]) -> List[EarnedReward]:
        ...
        try:
            ...
            if "availableRewards" in data:
                ...
                self.logger.warning(f"Unexpected available rewards response structure: {data.keys()}")
                return []
    ...
    def _parse_categories_response(self, data: Dict[str, Any]) -> List[str]:
        ...
        try:
            ...
            if "categories" in data:
                ...
                self.logger.warning(f"Unexpected categories response structure: {data.keys()}")
                return []
            ...
            for category_data in categories_data:
                if isinstance(category_data, str):
                    ...
                    category_name = category_data.get("name") or category_data.get("title")
                    if category_name:
