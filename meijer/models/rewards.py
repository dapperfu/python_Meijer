...
class BaseReward(ABC):
    ...
    def __init__(
        ...
        self.requirements = requirements or RewardRequirements(
    ...
    def is_claimable(self) -> bool:
        ...
        return (
            ...
            and self.metadata.expiration_date
            and self.metadata.expiration_date > datetime.now()
        )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "metadata": {
                ...
                "expiration_date": self.metadata.expiration_date.isoformat()
                if self.metadata.expiration_date
                else None,
                "earn_date": self.metadata.earn_date.isoformat()
                if self.metadata.earn_date
                else None,
                "redeem_date": self.metadata.redeem_date.isoformat()
                if self.metadata.redeem_date
                else None,
                "transaction_date": self.metadata.transaction_date.isoformat()
                if self.metadata.transaction_date
                else None,
            ...
            "requirements": {
                ...
                "minimum_purchase": str(self.requirements.minimum_purchase)
                if self.requirements.minimum_purchase
                else None,
        ...
        base_dict.update(
            {
                ...
                "maximum_discount": str(self.maximum_discount)
                if self.maximum_discount
                else None,
...
class RewardFactory:
    ...
    def create_product_reward(
        title: str, description: str, points_required: int, product_name: str, **kwargs
    ) -> ProductReward:
    ...
    def from_dict(data: Dict[str, Any]) -> BaseReward:
        ...
        if reward_type == RewardType.FUEL.value:
            ...
            return TotalPurchaseDiscountReward(
                ...
                maximum_discount=Decimal(data.get("maximum_discount", "0"))
