...
class AccountManager:
    ...
    def get_profile(self) -> Optional[AccountProfile]:
        ...
        try:
            ...
            response = self.client._make_request(
                "GET",
                f"{self.client.api_base_url}{self.endpoints['get_account']}"
            )
            ...
            if response.status_code == 200:
                ...
                if self.logger:
                    self.logger.warning(f"⚠️ Failed to get profile: {response.status_code}")
                return None
    ...
    def update_profile(self, updates: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if self.logger:
                    self.logger.warning(f"⚠️ Failed to update profile: {response.status_code}")
                return False
    ...
    def is_shop_scan_enabled(self) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if self.logger:
                    self.logger.warning(f"⚠️ Failed to check Shop & Scan: {response.status_code}")
                return False
    ...
    def get_mperks_barcode(self) -> Optional[str]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if self.logger:
                    self.logger.warning(f"⚠️ Failed to get barcode: {response.status_code}")
                return None
    ...
    def get_receipts(self, page: int = 0, page_size: int = 10) -> List[Receipt]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if self.logger:
                    self.logger.warning(f"⚠️ Failed to get receipts: {response.status_code}")
                return []
    ...
    def get_receipt(self, receipt_id: str) -> Optional[Receipt]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if self.logger:
                    self.logger.warning(f"⚠️ Failed to get receipt: {response.status_code}")
                return None
    ...
    def download_receipt(self, receipt_id: str, file_path: str, format: ReceiptFormat = ReceiptFormat.PDF) -> bool:
        """
        ...
        try:
            if self.logger:
                self.logger.info(f"📥 Downloading receipt {receipt_id} as {format.value}...")
            ...
            if response.status_code == 200:
                ...
                if self.logger:
                    self.logger.warning(f"⚠️ Failed to download receipt: {response.status_code}")
                return False
    ...
    def get_orders(self, page: int = 0, page_size: int = 10) -> Dict[str, Any]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if self.logger:
                    self.logger.warning(f"⚠️ Failed to get orders: {response.status_code}")
                return {}
    ...
    def get_order_details(self, order_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if self.logger:
                    self.logger.warning(f"⚠️ Failed to get order details: {response.status_code}")
                return None
    ...
    def get_savings_summary(self) -> Optional[SavingsSummary]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if self.logger:
                    self.logger.warning(f"⚠️ Failed to get savings: {response.status_code}")
                return None
    ...
    def get_savings_history(self, page: int = 0, page_size: int = 10) -> List[SavingsSummary]:
        """
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if self.logger:
                    self.logger.warning(f"⚠️ Failed to get savings history: {response.status_code}")
                return []
    ...
    def get_preferences(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            response = self.client._make_request(
                "GET",
                f"{self.client.api_base_url}{self.endpoints['get_preferences']}"
            )
            ...
            if response.status_code == 200:
                ...
                if self.logger:
                    self.logger.warning(f"⚠️ Failed to get preferences: {response.status_code}")
                return []
    ...
    def update_preference(self, preference_type: str, preference_value: str, 
                         owning_program: str = "DigitalGrocery") -> bool:
        """
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if self.logger:
                    self.logger.warning(f"⚠️ Failed to update preference: {response.status_code}")
                return False
    ...
    def get_vehicle_information(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            response = self.client._make_request(
                "GET",
                f"{self.client.api_base_url}{self.endpoints['get_vehicle_info']}"
            )
            ...
            if response.status_code == 200:
                ...
                if self.logger:
                    self.logger.warning(f"⚠️ Failed to get vehicle info: {response.status_code}")
                return None
    ...
    def update_vehicle_information(self, vehicle_description: str, 
                                 vehicle_id: Optional[int] = None) -> bool:
        """
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if self.logger:
                    self.logger.warning(f"⚠️ Failed to update vehicle: {response.status_code}")
                return False
