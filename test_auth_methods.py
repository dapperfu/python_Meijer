...
def test_authentication_methods():
    ...
    print("1. Username/Password (Selenium) - auth.txt with user=/pass= or username=/password=")
    ...
    for auth_file in auth_files:
        if os.path.exists(auth_file):
            ...
            with open(auth_file, 'r') as f:
                content = f.read()
                if any(keyword in content for keyword in ['user=', 'username=', 'pass=', 'password=']):
    ...
    possible_logs = ["meijer.log", "meijer2.log", "mitmproxy.log", "mitmdump.log", "flows.log"]
...
"""
    ...
    print("1. Replace 'your_email@example.com' and 'your_password' with real credentials")
