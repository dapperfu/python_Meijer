...
public final class q {
    ...
    static final class a extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        ...
        final /* synthetic */ s f10890d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ WebView f10891e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(s sVar, WebView webView, Continuation<? super a> continuation) {
            super(2, continuation);
            this.f10890d = sVar;
            this.f10891e = webView;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new a(this.f10890d, this.f10891e, continuation);
        }
    ...
    static final class b extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ t f10893b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ WebView f10894c;
        ...
        b(t tVar, WebView webView, Continuation<? super b> continuation) {
            super(2, continuation);
            this.f10893b = tVar;
            this.f10894c = webView;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new b(this.f10893b, this.f10894c, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                ResultKt.b(obj);
                final t tVar = this.f10893b;
                InterfaceC16561f interfaceC16561fQ = o1.q(new Function0() { // from class: Fr.r
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        return q.b.g(tVar);
                    }
                });
                a aVar = new a(this.f10894c);
                this.f10892a = 1;
    ...
    static final class c implements Function3<InterfaceC14900d, Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ t f10896a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ boolean f10897b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ s f10898c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Function1<WebView, Unit> f10899d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ Function1<WebView, Unit> f10900e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Fr.b f10901f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Fr.a f10902g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Function1<Context, WebView> f10903h;
        ...
        c(t tVar, boolean z10, s sVar, Function1<? super WebView, Unit> function1, Function1<? super WebView, Unit> function12, Fr.b bVar, Fr.a aVar, Function1<? super Context, ? extends WebView> function13) {
            ...
            this.f10897b = z10;
            this.f10898c = sVar;
            this.f10899d = function1;
            this.f10900e = function12;
            this.f10901f = bVar;
            this.f10902g = aVar;
            this.f10903h = function13;
        }
        ...
        public final void a(InterfaceC14900d BoxWithConstraints, Composer composer, int i10) {
            ...
            q.n(this.f10896a, new FrameLayout.LayoutParams(H1.b.j(BoxWithConstraints.getConstraints()) ? -1 : -2, H1.b.i(BoxWithConstraints.getConstraints()) ? -1 : -2), Modifier.INSTANCE, this.f10897b, this.f10898c, this.f10899d, this.f10900e, this.f10901f, this.f10902g, this.f10903h, composer, 384, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    */
    ...
    static {
        ...
        f10886a = L0.b.a(new Function2() { // from class: Fr.f
            @Override // kotlin.jvm.functions.Function2
    ...
    */
    ...
    public static final s y(InterfaceC15783O interfaceC15783O, Composer composer, int i10, int i11) {
