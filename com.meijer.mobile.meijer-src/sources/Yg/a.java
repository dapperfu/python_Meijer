...
public final class a {
    ...
    private static final int[] f43056a = {0, 4, 1, 5};

    /* renamed from: b, reason: collision with root package name */
    private static final int[] f43057b = {6, 2, 7, 3};

    /* renamed from: c, reason: collision with root package name */
    private static final int[] f43058c = {8, 1, 1, 1, 1, 1, 1, 3};

    /* renamed from: d, reason: collision with root package name */
    private static final int[] f43059d = {7, 1, 1, 3, 1, 1, 1, 2, 1};

    /* renamed from: e, reason: collision with root package name */
    private static final int[] f43060e = {0, 180, 270, 90};
    ...
    private static int[] e(Ig.b bVar, int i10, int i11, int i12, int[] iArr, int[] iArr2) {
    ...
    private static o[] f(Ig.b bVar, int i10, int i11, int i12, int i13, int i14, int[] iArr) {
        int i15;
        boolean z10;
        int[] iArrE;
        o[] oVarArr = new o[4];
    ...
    private static Ig.b a(Ig.b bVar, int i10) {
        if (i10 % 360 == 0) {
            return bVar;
        }
        Ig.b bVarClone = bVar.clone();
        bVarClone.n(i10);
        return bVarClone;
    }
    ...
    */
    private static java.util.List<com.google.zxing.o[]> d(boolean r8, Ig.b r9) {
        /*
        ...
        L7a:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: Yg.a.d(boolean, Ig.b):java.util.List");
    }

    public static b c(c cVar, Map<d, ?> map, boolean z10) throws NotFoundException {
        Ig.b bVarA = cVar.a();
        for (int i10 : f43060e) {
            Ig.b bVarA2 = a(bVarA, i10);
    ...
    private static o[] g(Ig.b bVar, int i10, int i11) {
        int iJ = bVar.j();
        int iM = bVar.m();
        o[] oVarArr = new o[8];
        int iMax = 10;
        int i12 = i10;
        int i13 = i11;
        b(oVarArr, f(bVar, iJ, iM, i12, i13, 10, f43058c), f43056a);
        o oVar = oVarArr[4];
        if (oVar != null) {
            int iC = (int) oVar.c();
        ...
        b(oVarArr, f(bVar, iJ, iM, i12, i13, iMax, f43059d), f43057b);
        return oVarArr;
    }
}
