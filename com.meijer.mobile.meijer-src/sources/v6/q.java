...
public final class q {
    ...
    public static final Matrix f165686a = new Matrix();

    /* renamed from: b, reason: collision with root package name */
    private static final ThreadLocal<PathMeasure> f165687b = new a();

    /* renamed from: c, reason: collision with root package name */
    private static final ThreadLocal<Path> f165688c = new b();

    /* renamed from: d, reason: collision with root package name */
    private static final ThreadLocal<Path> f165689d = new c();

    /* renamed from: e, reason: collision with root package name */
    private static final ThreadLocal<float[]> f165690e = new d();

    /* renamed from: f, reason: collision with root package name */
    private static final float f165691f = (float) (Math.sqrt(2.0d) / 2.0d);
    ...
    public static void b(Path path, u uVar) {
        ...
        a(path, ((C15096d) uVar.j()).r() / 100.0f, ((C15096d) uVar.g()).r() / 100.0f, ((C15096d) uVar.i()).r() / 360.0f);
    }
    ...
    public static void a(Path path, float f10, float f11, float f12) {
        if (C14474e.h()) {
            C14474e.b("applyTrimPathIfNeeded");
        }
        PathMeasure pathMeasure = f165687b.get();
        Path path2 = f165688c.get();
        Path path3 = f165689d.get();
        pathMeasure.setPath(path, false);
        float length = pathMeasure.getLength();
        if (f10 == 1.0f && f11 == 0.0f) {
            if (C14474e.h()) {
                C14474e.c("applyTrimPathIfNeeded");
                return;
            }
            return;
        }
    ...
    public static void o(Canvas canvas, RectF rectF, Paint paint, int i10) {
        if (C14474e.h()) {
            C14474e.b("Utils#saveLayer");
        }
        canvas.saveLayer(rectF, paint);
        if (C14474e.h()) {
            C14474e.c("Utils#saveLayer");
        }
    }
}
