...
public class e {
    public static int c(float f10, int i10, int i11) {
        ...
        float f11 = ((i10 >> 24) & l3.f93323c) / 255.0f;
        float f12 = ((i10 >> 16) & l3.f93323c) / 255.0f;
        float f13 = ((i10 >> 8) & l3.f93323c) / 255.0f;
        float f14 = ((i11 >> 24) & l3.f93323c) / 255.0f;
        float f15 = ((i11 >> 16) & l3.f93323c) / 255.0f;
        float f16 = ((i11 >> 8) & l3.f93323c) / 255.0f;
        float fA = a(f12);
        float fA2 = a(f13);
        float fA3 = a((i10 & l3.f93323c) / 255.0f);
        float fA4 = a(f15);
        float f17 = f11 + ((f14 - f11) * f10);
        float fA5 = fA2 + ((a(f16) - fA2) * f10);
        float fA6 = fA3 + (f10 * (a((i11 & l3.f93323c) / 255.0f) - fA3));
