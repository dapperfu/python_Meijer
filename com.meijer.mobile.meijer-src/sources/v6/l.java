...
public class l {
    ...
    private static final PointF f165648a = new PointF();
    ...
    public static void h(q6.o oVar, Path path) {
        Path path2;
        path.reset();
        PointF pointFB = oVar.b();
        path.moveTo(pointFB.x, pointFB.y);
        f165648a.set(pointFB.x, pointFB.y);
        int i10 = 0;
        while (i10 < oVar.a().size()) {
            C16075a c16075a = oVar.a().get(i10);
            PointF pointFA = c16075a.a();
            PointF pointFB2 = c16075a.b();
            PointF pointFC = c16075a.c();
            PointF pointF = f165648a;
    ...
    public static void k(o6.e eVar, int i10, List<o6.e> list, o6.e eVar2, j6.k kVar) {
