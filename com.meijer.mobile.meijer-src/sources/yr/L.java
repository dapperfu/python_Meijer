...
@Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0004\u001a9\u0010\t\u001a\u00020\u0007*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u00012\u0006\u0010\u0004\u001a\u00020\u00032\u0006\u0010\u0005\u001a\u00020\u00032\f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006H\u0007¢\u0006\u0004\b\t\u0010\n¨\u0006\u000b"}, d2 = {"LKi/M;", "Landroidx/compose/ui/Modifier;", "modifier", "", "isProductCarouselTitleVisible", "isViewAllLinkVisible", "Lkotlin/Function0;", "", "onViewAllProductsClicked", "c", "(LKi/M;Landroidx/compose/ui/Modifier;ZZLkotlin/jvm/functions/Function0;Landroidx/compose/runtime/Composer;I)V", "common_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class L {
    public static final void c(final LocalThemeScope localThemeScope, final Modifier modifier, final boolean z10, final boolean z11, final Function0<Unit> onViewAllProductsClicked, Composer composer, final int i10) {
        ...
        if ((i13 & 9363) == 9362 && composerStartRestartGroup.j()) {
            ...
            if (z10) {
                float f10 = 3;
                q1.Label label = new q1.Label(androidx.compose.foundation.layout.D.m(InterfaceC14888I.b(c14889j, Modifier.INSTANCE, 1.0f, false, 2, null), 0.0f, H1.h.p(f10), 0.0f, H1.h.p(f10), 5, null), null, null, null, F1.t.INSTANCE.b(), false, 2, localThemeScope.getAdsTypography().getHeadings().getSix(), null, HttpResponseStatus.REDIRECTION_FOUND, null);
                String string = ((Context) composerStartRestartGroup.o(AndroidCompositionLocals_androidKt.g())).getString(Q.f171759a);
                Intrinsics.i(string, "getString(...)");
                composer2 = composerStartRestartGroup;
                i12 = 0;
                str = "getString(...)";
                si.j.h(localThemeScope, label, string, null, composer2, (q1.Label.f142335j << 3) | LocalThemeScope.f17314g | (i13 & 14), 4);
            } else {
                composer2 = composerStartRestartGroup;
                i12 = 0;
                str = "getString(...)";
            ...
            if (z11) {
                A0 a02 = A0.f153872a;
                String string2 = ((Context) composer2.o(AndroidCompositionLocals_androidKt.g())).getString(Cj.o.f5042S0);
                Intrinsics.i(string2, str);
                String strC = C16338g.c(Cj.o.f5042S0, composer2, i12);
                ...
                P0.k(localThemeScope, a02, string2, (Function0) objB, null, strC, false, 0L, false, composerStartRestartGroup, LocalThemeScope.f17314g | (i13 & 14) | (A0.f153873b << 3), 232);
            } else {
                composerStartRestartGroup = composer2;
            }
