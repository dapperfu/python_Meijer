...
@Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\u001a\u001d\u0010\u0004\u001a\u00020\u0003*\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u0001H\u0007¢\u0006\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"LKi/M;", "", "description", "", "b", "(LKi/M;Ljava/lang/String;Landroidx/compose/runtime/Composer;II)V", "common_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class N {
    ...
    static final class a implements Function3<InterfaceC15154X, Composer, Integer, Unit> {
        ...
        final /* synthetic */ LocalThemeScope f171728a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ String f171729b;

        a(LocalThemeScope localThemeScope, String str) {
            this.f171728a = localThemeScope;
            this.f171729b = str;
        }
        ...
        public final void a(InterfaceC15154X Assemble, Composer composer, int i10) {
            ...
            Ci.m.d(this.f171728a, androidx.compose.foundation.layout.J.f(Modifier.INSTANCE, 0.0f, 1, null), largeLoading, oVar, null, this.f171729b, null, composer, LocalThemeScope.f17314g | 3120 | (q1.k.Large.f142345f << 6), 40);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final void b(final LocalThemeScope localThemeScope, final String str, Composer composer, final int i10, final int i11) {
        ...
        if ((i12 & 19) == 18 && composerStartRestartGroup.j()) {
            ...
            Ki.Q.e(localThemeScope, Q0.b.f141966a, ComposableLambdaKt.c(-808219398, true, new a(localThemeScope, str), composerStartRestartGroup, 54), composerStartRestartGroup, (i12 & 14) | LocalThemeScope.f17314g | 384 | (Q0.b.f141967b << 3));
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
