...
@Metadata(d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010 \n\u0002\b\u0006\u001aa\u0010\r\u001a\u00020\u000b*\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00012\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u000326\u0010\f\u001a2\u0012\u0013\u0012\u00110\u0003¢\u0006\f\b\u0006\u0012\b\b\u0007\u0012\u0004\b\b(\b\u0012\u0013\u0012\u00110\t¢\u0006\f\b\u0006\u0012\b\b\u0007\u0012\u0004\b\b(\n\u0012\u0004\u0012\u00020\u000b0\u0005H\u0007¢\u0006\u0004\b\r\u0010\u000e\"\u0016\u0010\u0012\u001a\u00020\u000f8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0010\u0010\u0011\"\u001a\u0010\u0015\u001a\b\u0012\u0004\u0012\u00020\u00030\u00138\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\r\u0010\u0014¨\u0006\u0019²\u0006\u000e\u0010\n\u001a\u00020\t8\n@\nX\u008a\u008e\u0002²\u0006\u0010\u0010\u0016\u001a\u0004\u0018\u00010\u00038\n@\nX\u008a\u008e\u0002²\u0006\u0010\u0010\u0017\u001a\u0004\u0018\u00010\u00038\n@\nX\u008a\u008e\u0002²\u0006\u000e\u0010\u0018\u001a\u00020\t8\n@\nX\u008a\u008e\u0002"}, d2 = {"LKi/M;", "Landroidx/compose/ui/Modifier;", "modifier", "", "initialValue", "Lkotlin/Function2;", "Lkotlin/ParameterName;", "name", "value", "", "isFocused", "", "onValueChanged", "b", "(LKi/M;Landroidx/compose/ui/Modifier;Ljava/lang/String;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;II)V", "", "a", "I", "currentYear", "", "Ljava/util/List;", "years", "currentValue", "yearPickerValue", "focused", "common_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* loaded from: classes12.dex */
public final class q0 {

    /* renamed from: a, reason: collision with root package name */
    private static int f172011a = LocalDate.now().getYear();

    /* renamed from: b, reason: collision with root package name */
    private static final List<String> f172012b;
    ...
    static final class a implements Function3<InterfaceC15149S, Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ String f172013a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f172014b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Modifier f172015c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Function2<String, Boolean, Unit> f172016d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ InterfaceC5872l0<Boolean> f172017e;
        ...
        a(String str, LocalThemeScope localThemeScope, Modifier modifier, Function2<? super String, ? super Boolean, Unit> function2, InterfaceC5872l0<Boolean> interfaceC5872l0) {
            this.f172013a = str;
            this.f172014b = localThemeScope;
            this.f172015c = modifier;
            this.f172016d = function2;
            this.f172017e = interfaceC5872l0;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Unit g(InterfaceC5872l0 interfaceC5872l0, androidx.compose.ui.focus.E state) {
            Intrinsics.j(state, "state");
            q0.d(interfaceC5872l0, state.a());
            return Unit.f143329a;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Unit k(Function2 function2, InterfaceC5872l0 interfaceC5872l0, InterfaceC5872l0 interfaceC5872l02, String str, int i10) {
            Intrinsics.j(str, "<unused var>");
            f(interfaceC5872l0, (String) q0.f172012b.get(i10));
            function2.invoke(q0.f172012b.get(i10), Boolean.valueOf(q0.c(interfaceC5872l02)));
            return Unit.f143329a;
        }
        ...
        public final void d(final InterfaceC15149S Assemble, Composer composer, int i10) {
            ...
            final String strC = C16338g.c(Q.f171775i, composer, 0);
            composer.startReplaceGroup(5004770);
            boolean zV = composer.V(this.f172013a);
            String str = this.f172013a;
            ...
            composer.P();
            LocalThemeScope localThemeScope = this.f172014b;
            Modifier modifier = this.f172015c;
            composer.startReplaceGroup(5004770);
            final InterfaceC5872l0<Boolean> interfaceC5872l02 = this.f172017e;
            ...
            if (objB2 == companion.a()) {
                objB2 = new Function1() { // from class: yr.n0
                    ...
                    public final Object invoke(Object obj) {
                        return q0.a.g(interfaceC5872l02, (androidx.compose.ui.focus.E) obj);
                    }
                };
                composer.t(objB2);
            }
            ...
            if (strE == null) {
                strE = (String) CollectionsKt.s0(q0.f172012b);
            }
            q1.f.Dropdown dropdownB = Bi.m0.b(Assemble.getInputFields(), false, false, false, false, false, null, 63, null);
            String str2 = strE;
            List list = q0.f172012b;
            composer.startReplaceGroup(-1746271574);
            boolean zV2 = composer.V(interfaceC5872l0) | composer.V(this.f172016d);
            final Function2<String, Boolean, Unit> function2 = this.f172016d;
            final InterfaceC5872l0<Boolean> interfaceC5872l03 = this.f172017e;
            Object objB3 = composer.B();
            if (zV2 || objB3 == companion.a()) {
                objB3 = new Function2() { // from class: yr.o0
                    @Override // kotlin.jvm.functions.Function2
                    public final Object invoke(Object obj, Object obj2) {
                        return q0.a.k(function2, interfaceC5872l0, interfaceC5872l03, (String) obj, ((Integer) obj2).intValue());
                    }
                };
                composer.t(objB3);
            }
            ...
            if (zD || objB4 == companion.a()) {
                objB4 = new Function1() { // from class: yr.p0
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
                        return q0.a.l(Assemble, strC, (Bi.n0) obj);
                    }
                };
                composer.t(objB4);
            }
            composer.P();
            C2962v.v(localThemeScope, modifierA, str2, dropdownB, list, function22, (Function1) objB4, composer, LocalThemeScope.f17314g | (q1.f.Dropdown.f142250m << 9), 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final void b(final LocalThemeScope localThemeScope, Modifier modifier, String str, final Function2<? super String, ? super Boolean, Unit> onValueChanged, Composer composer, final int i10, final int i11) {
        ...
        if ((i15 & 1171) == 1170 && composerStartRestartGroup.j()) {
            ...
            str = str2;
            Ki.Q.e(localThemeScope, h02, ComposableLambdaKt.c(1023563557, true, aVar, composerStartRestartGroup, 54), composerStartRestartGroup, LocalThemeScope.f17314g | 384 | (i15 & 14) | (H0.f141924b << 3));
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
            modifier2 = modifier3;
    ...
    static {
        ...
        while (it.hasNext()) {
            arrayList.add(String.valueOf(((IntIterator) it).nextInt() + f172011a));
        }
        f172012b = arrayList;
    }
