...
public final class C6515b {
    ...
    public static final C6515b f62512a = new C6515b();
    ...
    public final b.Companion b(Context context, final OkHttpClient okHttpClient, HttpUrl oktaIssuerUrl, String oktaClientId) {
        ...
        C5105a.f31426a.a(context);
        try {
            Result.Companion companion = Result.INSTANCE;
            p.f31427a.L(new Function0() { // from class: cj.a
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return C6515b.c(okHttpClient);
                }
            });
        ...
        if (thE != null) {
            qw.a.INSTANCE.u(thE, "AuthFoundationDefaults.okHttpClientFactory already initialized with " + p.f31427a.E(), new Object[0]);
        }
        try {
            j.INSTANCE.e(new j(oktaClientId, "openid profile offline_access", oktaIssuerUrl.getUrl()));
            objB2 = Result.b(Unit.f143329a);
        } catch (Throwable th3) {
        ...
        if (thE2 != null) {
            qw.a.INSTANCE.u(thE2, "OidcConfiguration.default already initialized with " + j.INSTANCE.d(), new Object[0]);
        }
