...
@Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\u001a%\u0010\u0006\u001a\u00020\u0005*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u00012\b\b\u0002\u0010\u0004\u001a\u00020\u0003H\u0001¢\u0006\u0004\b\u0006\u0010\u0007\u001a9\u0010\r\u001a\u00020\u0005*\u00020\u00002\u0006\u0010\t\u001a\u00020\b2\b\b\u0002\u0010\u0004\u001a\u00020\u00032\u0012\u0010\f\u001a\u000e\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\u00050\nH\u0003¢\u0006\u0004\b\r\u0010\u000e\u001a\u001d\u0010\u000f\u001a\u00020\u0005*\u00020\u00002\b\b\u0002\u0010\u0004\u001a\u00020\u0003H\u0003¢\u0006\u0004\b\u000f\u0010\u0010¨\u0006\u0011²\u0006\f\u0010\t\u001a\u00020\b8\nX\u008a\u0084\u0002"}, d2 = {"LKi/M;", "Lmq/y;", "viewModel", "Landroidx/compose/ui/Modifier;", "modifier", "", "n", "(LKi/M;Lmq/y;Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;II)V", "Lmq/y$c;", "viewState", "Lkotlin/Function1;", "Lmq/y$b;", "sendEvent", "f", "(LKi/M;Lmq/y$c;Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;II)V", "h", "(LKi/M;Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;II)V", "shopandscan_playstoreRelease"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class g {
    ...
    static final class a implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ LocalThemeScope f31266a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ y.ViewState f31267b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Function1<y.b, Unit> f31268c;

        /* JADX WARN: Multi-variable type inference failed */
        a(LocalThemeScope localThemeScope, y.ViewState viewState, Function1<? super y.b, Unit> function1) {
            this.f31266a = localThemeScope;
            this.f31267b = viewState;
            this.f31268c = function1;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Unit c(Function1 function1) {
            function1.invoke(y.b.e.f151439a);
        ...
        public final void b(Composer composer, int i10) {
            ...
            LocalThemeScope localThemeScope = this.f31266a;
            AbstractC6392a appBarTitle = this.f31267b.getAppBarTitle();
            Asset navigationIcon = this.f31267b.getNavigationIcon();
            composer.startReplaceGroup(5004770);
            boolean zV = composer.V(this.f31268c);
            final Function1<y.b, Unit> function1 = this.f31268c;
    ...
    static final class b implements Function3<InterfaceC14882C, Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f31269a;

        b(LocalThemeScope localThemeScope) {
            this.f31269a = localThemeScope;
        }
        ...
        public final void a(InterfaceC14882C paddingValues, Composer composer, int i10) throws Resources.NotFoundException {
            ...
            g.h(this.f31269a, D.h(Modifier.INSTANCE, paddingValues), composer, LocalThemeScope.f17314g, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final class d extends Lambda implements Function1 {
        ...
        public static final d f31272f = new d();
    ...
    public static final class e extends Lambda implements Function1<Integer, Object> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function1 f31273f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ List f31274g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public e(Function1 function1, List list) {
            super(1);
            this.f31273f = function1;
            this.f31274g = list;
        }

        public final Object a(int i10) {
            return this.f31273f.invoke(this.f31274g.get(i10));
        }
    ...
    public static final class f extends Lambda implements Function4<InterfaceC15433c, Integer, Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ List f31275f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f31276g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public f(List list, LocalThemeScope localThemeScope) {
            super(4);
            this.f31275f = list;
            this.f31276g = localThemeScope;
        }
        ...
        public final void a(InterfaceC15433c interfaceC15433c, int i10, Composer composer, int i11) {
            ...
            FAQItem fAQItem = (FAQItem) this.f31275f.get(i10);
            composer.startReplaceGroup(448814581);
            g.l(this.f31276g, null, fAQItem.getQuestion(), composer, 0, 1);
            g.i(this.f31276g, null, fAQItem.getAnswer(), composer, 0, 1);
            C17983Z.a(null, this.f31276g.getAdsColors().getAdsColorUIBorder02().getColor(), 0.0f, 0.0f, composer, 0, 13);
            composer.P();
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
    ...
    */
    private static final void f(final Ki.LocalThemeScope r33, final mq.y.ViewState r34, androidx.compose.ui.Modifier r35, final kotlin.jvm.functions.Function1<? super mq.y.b, kotlin.Unit> r36, androidx.compose.runtime.Composer r37, final int r38, final int r39) {
        /*
            Method dump skipped, instructions count: 267
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: Qp.g.f(Ki.M, mq.y$c, androidx.compose.ui.Modifier, kotlin.jvm.functions.Function1, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    private static final void j(final LocalThemeScope localThemeScope, Modifier modifier, final List<FAQItem> list, Composer composer, int i10, int i11) {
        ...
        composer.P();
        C15432b.a(modifier, null, null, false, mVarH, null, null, false, null, (Function1) objB, composer, (i10 & 14) | 24576, 494);
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        composer.P();
    ...
    public static final Unit k(List list, LocalThemeScope localThemeScope, w LazyColumn) {
        ...
        LazyColumn.i(list.size(), null, new e(d.f31272f, list), ComposableLambdaKt.composableLambdaInstance(-632812321, true, new f(list, localThemeScope)));
        return Unit.f143329a;
    }
    ...
    public static final void n(LocalThemeScope localThemeScope, final y viewModel, Modifier modifier, Composer composer, final int i10, final int i11) {
        ...
        if ((i12 & 147) == 146 && composerStartRestartGroup.j()) {
            ...
            composerStartRestartGroup.P();
            localThemeScope2 = localThemeScope;
            f(localThemeScope2, viewStateO, modifier3, (Function1) objB2, composerStartRestartGroup, LocalThemeScope.f17314g | (i12 & 14) | (AbstractC6392a.f60445b << 3) | (i12 & 896), 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
            modifier2 = modifier3;
    ...
    public static final void h(LocalThemeScope localThemeScope, final Modifier modifier, Composer composer, final int i10, final int i11) throws Resources.NotFoundException {
        ...
        if ((i12 & 19) == 18 && composerStartRestartGroup.j()) {
            ...
            String[] stringArray = resources.getStringArray(com.meijer.mobile.shopandscan.a.f117699b);
            Intrinsics.i(stringArray, "getStringArray(...)");
            String[] stringArray2 = resources.getStringArray(com.meijer.mobile.shopandscan.a.f117698a);
