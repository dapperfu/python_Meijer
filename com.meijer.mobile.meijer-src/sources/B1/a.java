...
public final class a implements f {
    ...
    public Locale a(String languageTag) {
        ...
        if (Intrinsics.e(localeForLanguageTag.toLanguageTag(), "und")) {
            FS.log_e(b.f2188a, "The language tag " + languageTag + " is not well-formed. Locale is resolved to Undetermined. Note that underscore '_' is not a valid subtag delimiter and must be replaced with '-'.");
        }
