...
public final class j {
    ...
    public static final String c(Date date) {
        ...
        String strB = b(f134092a, date, "yyyy-MM-dd'T'HH:mm:ssXX", null, 4, null);
    ...
    public static final String e(Date date) {
        Intrinsics.j(date, "date");
        String strA = f134092a.a(date, "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'", DesugarTimeZone.getTimeZone("GMT"));
