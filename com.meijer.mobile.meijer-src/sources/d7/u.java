...
public final class u<DataT> implements o<Uri, DataT> {
    ...
    private final Context f128273a;

    /* renamed from: b, reason: collision with root package name */
    private final o<Integer, DataT> f128274b;

    private static final class a implements p<Uri, AssetFileDescriptor> {

        /* renamed from: a, reason: collision with root package name */
        private final Context f128275a;

        @Override // d7.p
        public o<Uri, AssetFileDescriptor> d(s sVar) {
            return new u(this.f128275a, sVar.d(Integer.class, AssetFileDescriptor.class));
        }
    ...
    private static final class b implements p<Uri, InputStream> {
        ...
        public o<Uri, InputStream> d(s sVar) {
            return new u(this.f128276a, sVar.d(Integer.class, InputStream.class));
        }
    ...
    private o.a<DataT> g(Uri uri, int i10, int i11, X6.g gVar) throws NumberFormatException {
        try {
            int i12 = Integer.parseInt(uri.getPathSegments().get(0));
            if (i12 != 0) {
                return this.f128274b.b(Integer.valueOf(i12), i10, i11, gVar);
            }
    ...
    public boolean a(Uri uri) {
        return "android.resource".equals(uri.getScheme()) && this.f128273a.getPackageName().equals(uri.getAuthority());
    }
    ...
    private o.a<DataT> h(Uri uri, int i10, int i11, X6.g gVar) {
        List<String> pathSegments = uri.getPathSegments();
        int identifier = this.f128273a.getResources().getIdentifier(pathSegments.get(1), pathSegments.get(0), this.f128273a.getPackageName());
        if (identifier == 0) {
            if (Log.isLoggable("ResourceUriLoader", 5)) {
        ...
        return this.f128274b.b(Integer.valueOf(identifier), i10, i11, gVar);
    }
