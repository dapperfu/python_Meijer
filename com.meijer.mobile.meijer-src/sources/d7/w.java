...
public class w<Data> implements o<String, Data> {
    ...
    private final o<Uri, Data> f128278a;
    ...
    public o.a<Data> b(String str, int i10, int i11, X6.g gVar) {
        Uri uriE = e(str);
        if (uriE != null && this.f128278a.a(uriE)) {
            return this.f128278a.b(uriE, i10, i11, gVar);
        }
        return null;
    }
}
