...
class F<K, V> implements Map<K, V>, KMappedMarker {
    ...
    private C5610h<K, V> _entries;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private C5622u<K, V> _keys;
    ...
    public Set<Map.Entry<K, V>> a() {
        C5610h<K, V> c5610h = this._entries;
        if (c5610h != null) {
            return c5610h;
        }
        C5610h<K, V> c5610h2 = new C5610h<>(this.parent);
        this._entries = c5610h2;
        return c5610h2;
    }

    public Set<K> b() {
        C5622u<K, V> c5622u = this._keys;
        if (c5622u != null) {
            return c5622u;
        }
        C5622u<K, V> c5622u2 = new C5622u<>(this.parent);
        this._keys = c5622u2;
        return c5622u2;
    }
