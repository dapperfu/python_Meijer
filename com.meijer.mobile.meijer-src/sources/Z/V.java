...
final class V<E> extends g0<E> implements Set<E>, KMutableSet {
    ...
    public static final class a implements Iterator<E>, KMutableIterator {
        ...
        static final class C0918a extends RestrictedSuspendLambda implements Function2<SequenceScope<? super E>, Continuation<? super Unit>, Object> {
            ...
            private /* synthetic */ Object f43378g;

            /* renamed from: h, reason: collision with root package name */
            final /* synthetic */ V<E> f43379h;

            /* renamed from: i, reason: collision with root package name */
            final /* synthetic */ a f43380i;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C0918a(V<E> v10, a aVar, Continuation<? super C0918a> continuation) {
            ...
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C0918a c0918a = new C0918a(this.f43379h, this.f43380i, continuation);
                c0918a.f43378g = obj;
                return c0918a;
            }
            ...
            public final Object invoke(SequenceScope<? super E> sequenceScope, Continuation<? super Unit> continuation) {
                return ((C0918a) create(sequenceScope, continuation)).invokeSuspend(Unit.f143329a);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i11 != 0) {
                    if (i11 == 1) {
                        i10 = this.f43376e;
                        jArr = (long[]) this.f43375d;
                        v10 = (V) this.f43374c;
                        aVar = (a) this.f43373b;
                        sequenceScope = (SequenceScope) this.f43378g;
                        ResultKt.b(obj);
                    } else {
                    ...
                    ResultKt.b(obj);
                    SequenceScope sequenceScope2 = (SequenceScope) this.f43378g;
                    U u10 = ((V) this.f43379h).parent;
                    a aVar2 = this.f43380i;
                    v10 = this.f43379h;
        ...
        a(V<E> v10) {
            this.f43372c = v10;
            this.iterator = SequencesKt.a(new C0918a(v10, this, null));
        }
        ...
        public void remove() {
            if (this.current != -1) {
                ((V) this.f43372c).parent.z(this.current);
                this.current = -1;
            }
        }
    }
