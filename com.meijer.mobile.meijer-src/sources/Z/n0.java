...
public class n0<K, V> {
    ...
    @JvmOverloads
    public n0(int i10) {
        this.hashes = i10 == 0 ? C5637a.f44159a : new int[i10];
        this.array = i10 == 0 ? C5637a.f44161c : new Object[i10 << 1];
    }
    ...
    private final int c(K key, int hash) {
        ...
        int iA = C5637a.a(this.hashes, i10, hash);
    ...
    private final int f() {
        ...
        int iA = C5637a.a(this.hashes, i10, 0);
