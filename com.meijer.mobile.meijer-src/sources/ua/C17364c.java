...
import I9.h;
import I9.i;
import X9.AppEventActionModel;
import X9.CustomEventActionModel;
import X9.DismissActionModel;
import X9.OpenExternalUrlActionModel;
import aa.InboxResult;
import aa.Message;
...
@Metadata(d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0017\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001B\u0007¢\u0006\u0004\b\u0004\u0010\u0005J\u0017\u0010\t\u001a\u00020\b2\u0006\u0010\u0007\u001a\u00020\u0006H\u0012¢\u0006\u0004\b\t\u0010\nJ\u001d\u0010\r\u001a\b\u0012\u0004\u0012\u00020\f0\u000b2\u0006\u0010\u0007\u001a\u00020\u0006H\u0012¢\u0006\u0004\b\r\u0010\u000eJ\u0019\u0010\u0011\u001a\u0004\u0018\u00010\u00102\u0006\u0010\u000f\u001a\u00020\u0006H\u0012¢\u0006\u0004\b\u0011\u0010\u0012J\u0017\u0010\u0014\u001a\u00020\u00032\u0006\u0010\u0013\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0014\u0010\u0015¨\u0006\u0016"}, d2 = {"Lua/c;", "LS8/c;", "LD9/c;", "Laa/a;", "<init>", "()V", "Lorg/json/JSONObject;", "inboxMessageResponse", "Laa/b;", "c", "(Lorg/json/JSONObject;)Laa/b;", "", "", "e", "(Lorg/json/JSONObject;)Ljava/util/List;", "actionJson", "LX9/a;", "b", "(Lorg/json/JSONObject;)LX9/a;", "responseModel", "d", "(LD9/c;)Laa/a;", "mobile-engage_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* renamed from: ua.c, reason: case insensitive filesystem */
/* loaded from: classes4.dex */
public class C17364c implements S8.c<ResponseModel, InboxResult> {
    private X9.a b(JSONObject actionJson) throws JSONException {
        URL url;
    ...
    private Message c(JSONObject inboxMessageResponse) throws JSONException {
        ...
        if (jSONObjectOptJSONObject != null && (jSONArrayOptJSONArray = jSONObjectOptJSONObject.optJSONArray("actions")) != null) {
            List<JSONObject> listH = h.f14391a.h(jSONArrayOptJSONArray);
            arrayList = new ArrayList();
            Iterator<T> it = listH.iterator();
            while (it.hasNext()) {
                X9.a aVarB = b((JSONObject) it.next());
                if (aVarB != null) {
                    arrayList.add(aVarB);
                }
            }
