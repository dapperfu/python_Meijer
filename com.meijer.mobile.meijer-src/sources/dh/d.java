...
final class d {
    static int a(C13682b c13682b) {
        return b(c13682b, true) + b(c13682b, false);
    }
    ...
    */
    static boolean f(int r1, int r2, int r3) {
        ...
        L44:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: dh.d.f(int, int, int):boolean");
    }
    ...
    private static int b(C13682b c13682b, boolean z10) {
        int iD = z10 ? c13682b.d() : c13682b.e();
        int iE = z10 ? c13682b.e() : c13682b.d();
        byte[][] bArrC = c13682b.c();
        int i10 = 0;
