...
public final class C14588a {
    ...
    public static final C14588a f136686a = new C14588a();

    @JvmStatic
    public static final boolean a(C6023p0 clipEntry) {
        if (clipEntry == null) {
            return false;
        }
    ...
    @JvmStatic
    public static final C6023p0 c(AnnotatedString annotatedString) {
        if (annotatedString == null) {
            return null;
        }
        return new C6023p0(ClipData.newPlainText("plain text", C14589b.b(annotatedString)));
    }
    ...
    @JvmStatic
    public static final AnnotatedString b(C6023p0 clipEntry) {
        CharSequence text;
        ClipData.Item itemAt = clipEntry.getClipData().getItemAt(0);
        if (itemAt != null && (text = itemAt.getText()) != null) {
            return C14589b.a(text);
        }
        return null;
    }
}
