...
public final class C14589b {
        ...
        if (iM0 >= 0) {
            while (true) {
                ...
                if (Intrinsics.e(annotation.getKey(), "androidx.compose.text.SpanStyle")) {
                    arrayList.add(new AnnotatedString.Range(new C14590c(annotation.getValue()).k(), spanned.getSpanStart(annotation), spanned.getSpanEnd(annotation)));
                }
                if (i10 == iM0) {
                    break;
                }
    ...
    public static final CharSequence b(AnnotatedString annotatedString) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            c14591d.q();
            c14591d.g(spanStyleA);
            spannableString.setSpan(new Annotation("androidx.compose.text.SpanStyle", c14591d.p()), start, end, 33);
        }
        return spannableString;
    }

    public static final boolean c(C6023p0 c6023p0) {
        return C14588a.a(c6023p0);
    }

    public static final AnnotatedString d(C6023p0 c6023p0) {
        return C14588a.b(c6023p0);
    }

    public static final C6023p0 e(AnnotatedString annotatedString) {
        return C14588a.c(annotatedString);
    }
}
