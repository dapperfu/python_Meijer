...
public final class w {
    ...
    static final class a<T> extends Lambda implements Function1<T, Boolean> {
        ...
        final /* synthetic */ Function1<T, Boolean> f15539f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ List<T> f15540g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        a(Function1<? super T, Boolean> function1, List<T> list) {
            super(1);
            this.f15539f = function1;
            this.f15540g = list;
        }
        ...
        public final Boolean invoke(T t10) {
            boolean z10;
            if (this.f15539f.invoke(t10).booleanValue()) {
                this.f15540g.add(t10);
                z10 = true;
            } else {
                z10 = false;
            }
