...
import androidx.compose.ui.platform.C6053z1;
...
public final class b implements o, InterfaceC6157f, View.OnAttachStateChangeListener {
    ...
    private EnumC0732b translateStatus = EnumC0732b.f31529a;

    /* renamed from: g, reason: collision with root package name and from kotlin metadata */
    private boolean currentSemanticsNodesInvalidated = true;

    /* renamed from: h, reason: collision with root package name and from kotlin metadata */
    private final ov.g<Unit> boundsUpdateChannel = ov.j.b(1, null, null, 6, null);

    /* renamed from: i, reason: collision with root package name and from kotlin metadata */
    private final Handler handler = new Handler(Looper.getMainLooper());

    /* renamed from: j, reason: collision with root package name and from kotlin metadata */
    private AbstractC5619q<A1> currentSemanticsNodes = r.b();

    /* renamed from: l, reason: collision with root package name and from kotlin metadata */
    private K<C6053z1> previousSemanticsNodes = r.c();
    ...
    private static final class EnumC0732b {

        /* renamed from: a, reason: collision with root package name */
        public static final EnumC0732b f31529a = new EnumC0732b("SHOW_ORIGINAL", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final EnumC0732b f31530b = new EnumC0732b("SHOW_TRANSLATED", 1);

        /* renamed from: c, reason: collision with root package name */
        private static final /* synthetic */ EnumC0732b[] f31531c;

        /* renamed from: d, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f31532d;

        static {
            EnumC0732b[] enumC0732bArrA = a();
            f31531c = enumC0732bArrA;
            f31532d = EnumEntriesKt.a(enumC0732bArrA);
        }

        private static final /* synthetic */ EnumC0732b[] a() {
            return new EnumC0732b[]{f31529a, f31530b};
        }

        public static EnumC0732b valueOf(String str) {
            return (EnumC0732b) Enum.valueOf(EnumC0732b.class, str);
        }

        public static EnumC0732b[] values() {
            return (EnumC0732b[]) f31531c.clone();
        }

        private EnumC0732b(String str, int i10) {
        }
    }
    ...
    static final class c {
        ...
        public static final void e(b bVar, LongSparseArray longSparseArray) {
            f31533a.b(bVar, longSparseArray);
        }
        ...
        */
        ...
        private final void b(b contentCaptureManager, LongSparseArray<ViewTranslationResponse> response) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                if (viewTranslationResponseA != null && (value = viewTranslationResponseA.getValue("android:text")) != null && (text = value.getText()) != null && (a1B = contentCaptureManager.k().b((int) jKeyAt)) != null && (c16820nB = a1B.getSemanticsNode()) != null && (accessibilityAction = (AccessibilityAction) SemanticsConfigurationKt.getOrNull(c16820nB.getUnmergedConfig(), SemanticsActions.INSTANCE.z())) != null && (function1 = (Function1) accessibilityAction.a()) != null) {
                }
            }
        }
    }
    ...
    static final class f extends Lambda implements Function2<Integer, C16820n, Unit> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ C6053z1 f31539f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ b f31540g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        f(C6053z1 c6053z1, b bVar) {
            super(2);
            this.f31539f = c6053z1;
            this.f31540g = bVar;
        }

        public final void a(int i10, C16820n c16820n) {
            if (this.f31539f.getChildren().a(c16820n.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String())) {
                return;
            }
            this.f31540g.E(i10, c16820n);
            this.f31540g.q();
        }

        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Unit invoke(Integer num, C16820n c16820n) {
            a(num.intValue(), c16820n);
            return Unit.f143329a;
        }
    }

    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0001\u001a\u00020\u00002\u0006\u0010\u0003\u001a\u00020\u0002H\n¢\u0006\u0004\b\u0005\u0010\u0006"}, d2 = {"", "i", "Lr1/n;", "child", "", "a", "(ILr1/n;)V"}, k = 3, mv = {1, 9, 0})
    static final class g extends Lambda implements Function2<Integer, C16820n, Unit> {
        g() {
            super(2);
        }

        public final void a(int i10, C16820n c16820n) {
            b.this.E(i10, c16820n);
        }
    ...
    public /* synthetic */ class d {
        ...
        static {
            ...
            try {
                iArr[n.f31548a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[n.f31549b.ordinal()] = 2;
    ...
    private final void A() {
        K<C6053z1> k10 = this.previousSemanticsNodes;
        int[] iArr = k10.keys;
    ...
    private final void B(int id2, String newText) {
        ...
        if (Build.VERSION.SDK_INT >= 29 && (dVar = this.contentCaptureSession) != null) {
            ...
            if (autofillIdB != null) {
                ...
                C14920a.c("Invalid content capture ID");
                throw new KotlinNothingValueException();
            }
        }
    }

    private final n1.f D(C16820n c16820n, int i10) {
        n1.b bVarA;
        ...
        n1.f fVarC = dVar.c(autofillIdA, c16820n.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String());
        if (fVarC == null) {
            return null;
        }
        SemanticsConfiguration semanticsConfigurationW = c16820n.getUnmergedConfig();
        ...
        if (str != null) {
            fVarC.e(c16820n.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String(), null, null, str);
        }
    ...
    */
    ...
    private final void e(int virtualId, n1.f viewStructure) {
        ...
        this.bufferedEvents.add(new ContentCaptureEvent(virtualId, this.currentSemanticsNodesSnapshotTimestampMillis, n.f31548a, viewStructure));
    }

    private final void f(int virtualId) {
        this.bufferedEvents.add(new ContentCaptureEvent(virtualId, this.currentSemanticsNodesSnapshotTimestampMillis, n.f31549b, null));
    }

    private final void g(AbstractC5619q<A1> newSemanticsNodes) {
        int[] iArr;
        long[] jArr;
        int[] iArr2;
        long[] jArr2;
        ...
        int i12;
        long[] jArr3;
        AbstractC5619q<A1> abstractC5619q = newSemanticsNodes;
        int[] iArr3 = abstractC5619q.keys;
        long[] jArr4 = abstractC5619q.metadata;
            ...
            if ((((~j13) << 7) & j13 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i16 < i15) {
                    if ((j13 & 255) < 128) {
                        ...
                        c10 = c11;
                        C6053z1 c6053z1B = this.previousSemanticsNodes.b(i17);
                        A1 a1B = abstractC5619q.b(i17);
                        C16820n c16820nB = a1B != null ? a1B.getSemanticsNode() : null;
                        if (c16820nB == null) {
                            C14920a.c("no value for specified key");
                            throw new KotlinNothingValueException();
                        }
                        if (c6053z1B == null) {
                            W<SemanticsPropertyKey<?>, Object> wQ = c16820nB.getUnmergedConfig().q();
                            j11 = j14;
                                        ...
                                        while (i21 < i20) {
                                            if ((j15 & 255) < 128) {
                                                ...
                                                if (Intrinsics.e(semanticsPropertyKey, semanticsProperties.getText())) {
                                                    List list = (List) SemanticsConfigurationKt.getOrNull(c16820nB.getUnmergedConfig(), semanticsProperties.getText());
                                                    B(c16820nB.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String(), String.valueOf(list != null ? (AnnotatedString) CollectionsKt.u0(list) : null));
                                                }
                                            } else {
                                                i12 = i21;
                                                jArr3 = jArr4;
                            ...
                            jArr2 = jArr4;
                            j11 = j14;
                            W<SemanticsPropertyKey<?>, Object> wQ2 = c16820nB.getUnmergedConfig().q();
                                        ...
                                        while (i24 < i23) {
                                            if ((j16 & 255) < 128) {
                                                ...
                                                if (Intrinsics.e(semanticsPropertyKey2, semanticsProperties2.getText())) {
                                                    List list2 = (List) SemanticsConfigurationKt.getOrNull(c6053z1B.getUnmergedConfig(), semanticsProperties2.getText());
                                                    AnnotatedString annotatedString = list2 != null ? (AnnotatedString) CollectionsKt.u0(list2) : null;
                                                    j12 = j13;
                                                    List list3 = (List) SemanticsConfigurationKt.getOrNull(c16820n2.getUnmergedConfig(), semanticsProperties2.getText());
                                                    ...
                                                    if (!Intrinsics.e(annotatedString, annotatedString2)) {
                                                        B(c16820n2.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String(), String.valueOf(annotatedString2));
                                                    }
                                                }
                                                j16 >>= 8;
                                                i24 = i11 + 1;
                    ...
                    j13 = j10 >> i10;
                    i16++;
                    abstractC5619q = newSemanticsNodes;
                    i14 = i10;
                    c11 = c10;
                    j14 = j11;
                    iArr3 = iArr2;
    ...
    private final void y(C16820n newNode, C6053z1 oldNode) {
        j(newNode, new f(oldNode, this));
        List<C16820n> listT = newNode.t();
        int size = listT.size();
        for (int i10 = 0; i10 < size; i10++) {
            C16820n c16820n = listT.get(i10);
            if (k().a(c16820n.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String()) && this.previousSemanticsNodes.a(c16820n.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String())) {
                C6053z1 c6053z1B = this.previousSemanticsNodes.b(c16820n.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String());
                if (c6053z1B == null) {
                    C14920a.c("node not present in pruned tree before this change");
                    throw new KotlinNothingValueException();
                }
                y(c16820n, c6053z1B);
            }
    ...
    */
    public final java.lang.Object d(kotlin.coroutines.Continuation<? super kotlin.Unit> r10) {
        ...
        L13:
            ...
            r0.<init>(r10)
        L18:
            java.lang.Object r10 = r0.f31536c
            ...
            if (r2 == r4) goto L3e
            if (r2 != r3) goto L36
            java.lang.Object r2 = r0.f31535b
            ov.i r2 = (ov.i) r2
        ...
        L4a:
            kotlin.ResultKt.b(r10)
            ov.g<kotlin.Unit> r10 = r9.boundsUpdateChannel
            ov.i r10 = r10.iterator()
            r2 = r9
        L54:
            r0.f31534a = r2
            r0.f31535b = r10
        ...
        L86:
            ...
            r0.f31535b = r2
            r0.f31538e = r3
            java.lang.Object r10 = mv.Z.b(r6, r0)
            if (r10 != r1) goto L33
        L94:
            return r1
        L95:
    ...
    public final AbstractC5619q<A1> k() {
    ...
    public b(AndroidComposeView androidComposeView, Function0<? extends n1.d> function0) {
        ...
        this.previousSemanticsRoot = new C6053z1(androidComposeView.getSemanticsOwner().d(), r.b());
    }

    private final void C() {
        AccessibilityAction accessibilityAction;
        Function1 function1;
        AbstractC5619q<A1> abstractC5619qK = k();
        Object[] objArr = abstractC5619qK.values;
        long[] jArr = abstractC5619qK.metadata;
        int length = jArr.length - 2;
        if (length >= 0) {
            int i10 = 0;
            while (true) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void E(int index, C16820n node) {
        if (!o()) {
            return;
        }
        H(node);
    ...
    private final void H(C16820n node) {
        AccessibilityAction accessibilityAction;
        Function1 function1;
        ...
        if (this.translateStatus == EnumC0732b.f31529a && Intrinsics.e(bool, Boolean.TRUE)) {
        ...
        if (this.translateStatus == EnumC0732b.f31530b && Intrinsics.e(bool, Boolean.FALSE) && (accessibilityAction = (AccessibilityAction) SemanticsConfigurationKt.getOrNull(semanticsConfigurationW, SemanticsActions.INSTANCE.A())) != null && (function1 = (Function1) accessibilityAction.a()) != null) {
        }
    }
    ...
    private final void j(C16820n c16820n, Function2<? super Integer, ? super C16820n, Unit> function2) {
        List<C16820n> listT = c16820n.t();
        int size = listT.size();
        int i10 = 0;
        for (int i11 = 0; i11 < size; i11++) {
            C16820n c16820n2 = listT.get(i11);
            if (k().a(c16820n2.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String())) {
                function2.invoke(Integer.valueOf(i10), c16820n2);
                i10++;
            }
        }
    }
