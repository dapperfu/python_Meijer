...
public class bD implements bC {
    ...
    private final Map f133012a = new WeakHashMap();
        ...
        if (arrayList_fsGetGroups != null && !arrayList_fsGetGroups.isEmpty()) {
            for (Object obj : arrayList_fsGetGroups) {
                if (obj instanceof FSComposeAnchor) {
                    ...
                    C14228fu.c("Encountered unexpected type in FSComposeGroupSourceInformation groups: %s", obj.getClass().getName());
                }
            }
        }
        return false;
    ...
    private void b(FSComposeSlotWriter fSComposeSlotWriter, int i10) {
        ...
        if (obj_fsGetNode instanceof FSComposeLayoutNode) {
            this.f133012a.put((FSComposeLayoutNode) obj_fsGetNode, c(fSComposeSlotWriter, i10));
        }
    ...
    private void d(FSComposeSlotWriter fSComposeSlotWriter, int i10) {
        ...
        C14228fu.b(i_fsGetGroupSize2 == i_fsGetGroupSize, "Ended up past end of group when scanning children", new Object[0]);
    }

    @Override // fsimpl.bC
    public List a(FSComposeLayoutNode fSComposeLayoutNode) {
        return (List) this.f133012a.get(fSComposeLayoutNode);
    }

    public void a(FSComposeSlotWriter fSComposeSlotWriter, int i10) {
        C14228fu.a("ComposeChainCacheImpl.onSlotsInserted", new Object[0]);
        C14228fu.b(i10 > 0, "Size of inserted group must be > 0 but was %d", Integer.valueOf(i10));
        ...
        if (C14228fu.f133537a) {
            C14228fu.b(i_fsGetCurrentGroup >= 0, "Invalid groupIndex: %d", Integer.valueOf(i_fsGetCurrentGroup));
            int i_fsGetGroupSize = fSComposeSlotWriter._fsGetGroupSize(i_fsGetCurrentGroup);
            C14228fu.b(i_fsGetGroupSize == i10, "Group size at index %d was %d, which does not match size of group inserted of %d", Integer.valueOf(i_fsGetCurrentGroup), Integer.valueOf(i_fsGetGroupSize), Integer.valueOf(i10));
        }
