...
public class dG {
    ...
    private final ByteBuffer f133263a;

    /* renamed from: b, reason: collision with root package name */
    private int f133264b;

    public dG(ByteBuffer byteBuffer) {
        this.f133263a = byteBuffer;
        a();
    }
    ...
    private void a(byte b10, long j10) {
        ...
        dH.a(b10, C14170dq.DARKEN);
        b(b10);
        b(j10);
    }

    private void b(byte b10) {
        if (this.f133263a.position() != 0) {
            c(dH.a(b10));
        } else if (b10 != 0) {
    ...
    private void d(byte b10, int i10) {
        ...
        if (i10 == -1) {
            ...
            int i11 = (i10 >> 24) & l3.f93323c;
            int i12 = (i10 >> 16) & l3.f93323c;
            int i13 = (i10 >> 8) & l3.f93323c;
            int i14 = i10 & l3.f93323c;
            if (i12 == i13 && i13 == i14) {
                z10 = true;
            }
            this.f133264b = i10;
    ...
    private void s(int i10) {
        c((byte) (i10 & l3.f93323c));
        int i11 = i10 >> 8;
        c((byte) (i11 & l3.f93323c));
        int i12 = i11 >> 8;
        c((byte) (i12 & l3.f93323c));
        c((byte) ((i12 >> 8) & l3.f93323c));
    }

    private void t(int i10) {
        while ((i10 & (-128)) != 0) {
            c((byte) ((i10 & l3.f93324d) | 128));
            i10 >>>= 7;
        }
        c((byte) i10);
    }
    ...
    public void a() {
        this.f133263a.clear();
        this.f133264b = -1728053248;
    }

    public void a(byte b10, float[] fArr) {
        dH.a(b10, C14170dq.DST_ATOP);
        b(b10);
        for (float f10 : fArr) {
            d(f10);
        }
    ...
    public void c() {
        ByteBuffer byteBuffer = this.f133263a;
        byteBuffer.limit(byteBuffer.position());
        this.f133263a.position(0);
    }
    ...
    public boolean f() {
        return this.f133263a.remaining() < 256;
    }
