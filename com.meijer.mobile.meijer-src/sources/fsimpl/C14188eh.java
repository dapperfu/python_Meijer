...
public class C14188eh implements InterfaceC14194en {

    /* renamed from: a, reason: collision with root package name */
    private final RustInterface f133389a;

    public C14188eh(RustInterface rustInterface) {
        this.f133389a = rustInterface;
    }
    ...
    private void a(HttpURLConnection httpURLConnection, long j10, long j11) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
        ...
        fS.a(this.f133389a, httpURLConnection, j10, j11, responseCode);
        if (responseCode != 200) {
            ...
            try {
                ...
                throw new C14193em(httpURLConnection.getResponseCode(), "Didn't get a 200 response: " + httpURLConnection.getResponseCode() + " " + httpURLConnection.getResponseMessage());
            } catch (Throwable th2) {
                if (errorStream != null) {
                    try {
                        errorStream.close();
    ...
    @Override // fsimpl.InterfaceC14194en
    public void a(File file, String str, URL url, String str2, boolean z10) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
        ...
        if (z10) {
            AbstractC14222fo abstractC14222foA = C14221fn.a();
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        jB = abstractC14222foA.b(fileInputStream, outputStream);
