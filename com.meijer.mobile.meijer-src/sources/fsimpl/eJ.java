...
public class eJ extends WebViewClient {
    ...
    private WebViewTracker f133334a;

    /* renamed from: b, reason: collision with root package name */
    private WebViewClient f133335b;

    /* renamed from: c, reason: collision with root package name */
    private WebViewClient f133336c;

    public eJ(WebViewTracker webViewTracker) {
        this.f133334a = webViewTracker;
    }

    private void b() {
        if (this.f133335b == this.f133336c) {
    ...
    public void a(WebViewClient webViewClient) {
        this.f133336c = webViewClient;
    }

    public void b(WebViewClient webViewClient) {
        if (webViewClient == null) {
            webViewClient = this.f133336c;
        }
        this.f133335b = webViewClient;
    }

    @Override // android.webkit.WebViewClient
    public void doUpdateVisitedHistory(WebView webView, String str, boolean z10) {
        this.f133334a.b(webView, str);
        WebViewClient webViewClient = this.f133335b;
        if (webViewClient != null) {
    ...
    public void onReceivedError(WebView webView, int i10, String str, String str2) {
        this.f133334a.a(webView, i10, str, str2);
        WebViewClient webViewClient = this.f133335b;
        if (webViewClient != null) {
    ...
    public void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        this.f133334a.a(webView, webResourceRequest, webResourceError);
        WebViewClient webViewClient = this.f133335b;
        if (webViewClient != null) {
    ...
    public void onReceivedHttpError(WebView webView, WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse) {
        this.f133334a.a(webView, webResourceRequest, webResourceResponse);
        WebViewClient webViewClient = this.f133335b;
        if (webViewClient != null) {
    ...
    public WebResourceResponse shouldInterceptRequest(WebView webView, WebResourceRequest webResourceRequest) throws IOException {
        WebResourceResponse webResourceResponseA = this.f133334a.a(webView, webResourceRequest.getUrl().toString());
        WebViewClient webViewClient = this.f133335b;
    ...
    public WebResourceResponse shouldInterceptRequest(WebView webView, String str) throws IOException {
        WebResourceResponse webResourceResponseA = this.f133334a.a(webView, str);
        WebViewClient webViewClient = this.f133335b;
