...
public class aG {
    ...
    private static final Map f132718a = new WeakHashMap();

    /* renamed from: b, reason: collision with root package name */
    private static final Set f132719b = Collections.newSetFromMap(new WeakHashMap());

    /* renamed from: c, reason: collision with root package name */
    private static final Field f132720c;

    /* renamed from: d, reason: collision with root package name */
    private static boolean f132721d;

    static {
        f132720c = C14118br.e() ? fT.a(C14118br.f133120a, "componentName") : null;
    }
    ...
    public static aF a(FSComposeLayoutNode fSComposeLayoutNode, bC bCVar, InterfaceC14125by interfaceC14125by) {
        InterfaceC14126bz interfaceC14126bzA;
        List listA = bCVar.a(fSComposeLayoutNode);
        aF aFVarA = null;
        if (listA != null && !listA.isEmpty()) {
            boolean zB = b(fSComposeLayoutNode, bCVar, interfaceC14125by);
            boolean z10 = true;
            for (int size = listA.size() - 1; size >= 0; size--) {
                Integer num = (Integer) listA.get(size);
                if (num != null && (interfaceC14126bzA = interfaceC14125by.a(num.intValue())) != null) {
                    boolean z11 = false;
                    if (interfaceC14126bzA.e()) {
                        zB = false;
                        z10 = false;
                    } else {
                        boolean zA = a(interfaceC14126bzA);
                        boolean z12 = (z10 && zA && !zB) ? false : true;
                        if (z12 && interfaceC14126bzA.d()) {
                            z11 = true;
                        }
                        if (z12) {
                            aK aKVar = new aK();
                            String strC = interfaceC14126bzA.c();
                            if (strC != null) {
                                strC = strC.toLowerCase();
                            }
                            aKVar.f132735a = strC;
                            aKVar.f132739e = interfaceC14126bzA.a();
                            aKVar.f132740f = interfaceC14126bzA.b();
    ...
    */
    public static fsimpl.aK a(android.view.View r5, fsimpl.aL r6) {
        /*
            ...
            r0.a()
            java.util.Map r2 = r0.f132738d
            java.lang.String r3 = "tag"
            r2.put(r3, r1)
            boolean r2 = fsimpl.C14118br.e(r5)
            if (r2 == 0) goto L38
            java.util.Map r2 = r0.f132738d
            java.lang.String r3 = "testid"
            r2.put(r3, r1)
        L38:
            boolean r1 = fsimpl.aG.f132721d
            r2 = 1
            if (r1 != 0) goto L66
            boolean r1 = fsimpl.C14118br.e()
            if (r1 == 0) goto L66
            boolean r1 = fsimpl.C14118br.c(r5)
            if (r1 == 0) goto L66
            java.lang.reflect.Field r1 = fsimpl.aG.f132720c
            if (r1 == 0) goto L66
            ...
            java.util.Map r3 = r0.f132738d     // Catch: java.lang.Throwable -> L5e
            java.lang.String r4 = "screen-name"
            r3.put(r4, r1)     // Catch: java.lang.Throwable -> L5e
            goto L66
        L5e:
            r1 = move-exception
            fsimpl.aG.f132721d = r2
    ...
    public static aK a(FSComposeLayoutNode fSComposeLayoutNode, C14138ck c14138ck) {
        aK aKVar = new aK();
        aKVar.f132735a = b(fSComposeLayoutNode);
        aKVar.f132740f = a(fSComposeLayoutNode);
        ...
        if (fSComposeModifier_fsGetModifier != null) {
            ...
            if (!a(fSComposeLayoutNode, fSComposeModifier_fsGetModifier, aJVar, c14138ck)) {
                aKVar.a(true);
            }
            int iX = c14138ck.x();
            aKVar.f132742h = aJVar.f132729e;
            aKVar.b(aJVar.f132730f);
            aKVar.c(aJVar.f132731g);
            aKVar.d(!aJVar.f132732h);
            aKVar.e(aJVar.f132733i);
            aKVar.f(aJVar.f132734j);
            if (aJVar.f132728d != null) {
                for (Map.Entry entry : aJVar.f132728d.entrySet()) {
                    aKVar.a();
                    aKVar.f132738d.put(((String) entry.getKey()).toLowerCase(), (String) entry.getValue());
                }
            }
            if (aJVar.f132727c != null) {
                for (String str2 : aJVar.f132727c) {
                    aKVar.b();
                    aKVar.f132737c.add(str2);
                }
            }
            if (aJVar.f132725a != null) {
                boolean z11 = true;
                for (String str3 : aJVar.f132725a) {
                    if (iX < 2) {
                        if (z11) {
                            aKVar.f132736b = str3;
                            z11 = false;
                        } else {
                            str3 = aKVar.f132736b + "__" + str3;
                        }
                    }
                    aKVar.f132736b = str3;
                }
            }
            if (aJVar.f132726b != null) {
                for (String str4 : aJVar.f132726b) {
                    if (iX < 2) {
                        if (z10) {
                            str = str4;
                            z10 = false;
                ...
                if (str != null) {
                    aKVar.a();
                    if (iX >= 2) {
                        aKVar.f132735a = str.toLowerCase();
                    } else {
                        aKVar.f132738d.put("tag", str);
                    }
                }
            }
        } else {
    ...
    public static String a(View view) {
        ...
        synchronized (map) {
            ...
            if (aIVar != null) {
                if (id2 == aIVar.f132723a) {
                    return aIVar.f132724b;
                }
                map.remove(view);
            }
            try {
            ...
            f132718a.put(view, new aI(id2, resourceEntryName));
    ...
    private static void a(FSComposeFocusChangedElement fSComposeFocusChangedElement, aJ aJVar) {
        ...
        switch (aH.f132722a[fSComposeImeOptions_fsGetImeOptions._fsGetKeyboardType().ordinal()]) {
            case 1:
            case 2:
                b10 = 6;
                break;
    ...
    private static void a(aJ aJVar, String str, String str2) {
        if (aJVar.f132728d == null) {
            aJVar.f132728d = new HashMap();
        }
        aJVar.f132728d.put(str, str2);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void a(boolean[] zArr, aJ aJVar, FSComposeLayoutNode fSComposeLayoutNode, C14138ck c14138ck, int i10, FSComposeModifier fSComposeModifier) {
                ...
                if (fSComposeModifier instanceof FSComposeFocusChangedElement) {
                    if (aJVar.f132729e != 4) {
                        ...
                        if (aJVar.f132729e != 0) {
                            ...
                            if (aJVar.f132729e == 4) {
                                f132719b.add(fSComposeLayoutNode);
                                return;
                            }
                            return;
                        }
    ...
    public static boolean a(final FSComposeLayoutNode fSComposeLayoutNode, FSComposeModifier fSComposeModifier, final aJ aJVar, final C14138ck c14138ck) {
        final int iX = c14138ck.x();
        final boolean[] zArr = new boolean[1];
        if (f132719b.contains(fSComposeLayoutNode)) {
            if (iX >= 3) {
                zArr[0] = true;
            }
            aJVar.f132729e = (byte) 4;
        }
        bG.a(fSComposeModifier, new bH() { // from class: fsimpl.aG$$ExternalSyntheticLambda1
            @Override // fsimpl.bH
            public final void accept(FSComposeModifier fSComposeModifier2) {
                aG.a(zArr, aJVar, fSComposeLayoutNode, c14138ck, iX, fSComposeModifier2);
            }
        });
        if (c14138ck.A() && fSComposeLayoutNode._fsIsAttached()) {
            a(fSComposeLayoutNode, fSComposeLayoutNode._fsGetCollapsedSemantics(), aJVar, zArr, iX);
        }
        return zArr[0];
    }

    private static boolean a(InterfaceC14126bz interfaceC14126bz) {
        String strA = interfaceC14126bz.a();
    ...
    private static void b(FSComposeLayoutNode fSComposeLayoutNode, FSComposeSemanticsConfiguration fSComposeSemanticsConfiguration, aJ aJVar, boolean[] zArr, int i10) {
        if (aJVar.f132729e == 4 || !fSComposeSemanticsConfiguration._fsIsPassword()) {
            return;
        }
        if (i10 >= 3) {
            zArr[0] = true;
    ...
    private static void b(FSComposeSemanticsConfiguration fSComposeSemanticsConfiguration, aJ aJVar) {
        ...
        aJVar.f132734j = fSComposeSemanticsConfiguration._fsIsFocused();
    }
    ...
    private static boolean b(FSComposeLayoutNode fSComposeLayoutNode, bC bCVar, InterfaceC14125by interfaceC14125by) {
        InterfaceC14126bz interfaceC14126bzA;
        while (fSComposeLayoutNode._fsGetParent() != null) {
            ...
            if (listA != null) {
                for (int i10 = 0; i10 < listA.size(); i10++) {
                    ...
                    if (num != null && (interfaceC14126bzA = interfaceC14125by.a(num.intValue())) != null) {
                        if (!a(interfaceC14126bzA)) {
                            return true;
                        }
                        if (!interfaceC14126bzA.d()) {
                            return false;
                        }
                    }
                }
