...
public class fT {
    ...
    private static final boolean f133488a;

    /* renamed from: b, reason: collision with root package name */
    private static final Method f133489b;

    /* renamed from: c, reason: collision with root package name */
    private static final Method f133490c;
    ...
    public static Field a(int i10, Class cls, String str) {
        ...
        try {
            Field field = (Field) f133490c.invoke(cls, str);
    ...
    public static Method a(int i10, Class cls, String str, Class... clsArr) {
        ...
        try {
            Method method = (Method) f133489b.invoke(cls, str, clsArr);
    ...
    public static boolean a() {
        if (f133488a) {
            return (f133489b == null || f133490c == null) ? false : true;
        }
        return true;
    }
