...
public final class g {
    public static final SubmitTransactionRequest a(TransactionDetails transactionDetails) {
        ...
        String str = transactionDetails.getTransactionDate().format(C17898a.ISO_LOCAL_DATE);
        Intrinsics.i(str, "format(...)");
        String str2 = transactionDetails.getTransactionTime().format(C17898a.f167225a.u());
