...
public final class e {
    public static final DigitalReceipt a(NextGenDigitalReceiptJson nextGenDigitalReceiptJson) {
        DigitalReceipt.EnumC2792b next;
        Intrinsics.j(nextGenDigitalReceiptJson, "<this>");
        String nextgenReceiptId = nextGenDigitalReceiptJson.getNextgenReceiptId();
        Object objA = wk.d.a(nextGenDigitalReceiptJson.getTransactionDateTime(), C17898a.f167225a.s(), new j());
        ...
        Iterator<DigitalReceipt.EnumC2792b> it = DigitalReceipt.EnumC2792b.b().iterator();
        while (true) {
            if (!it.hasNext()) {
                next = null;
                break;
