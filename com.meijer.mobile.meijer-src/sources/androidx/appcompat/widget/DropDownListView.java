...
class DropDownListView extends ListView implements FSDispatchDraw {
    ...
    private androidx.core.view.h f46852k;

    /* renamed from: l, reason: collision with root package name */
    private androidx.core.widget.h f46853l;
    ...
    static class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private static Method f46855a;

        /* renamed from: b, reason: collision with root package name */
        private static Method f46856b;

        /* renamed from: c, reason: collision with root package name */
        private static Method f46857c;

        /* renamed from: d, reason: collision with root package name */
        private static boolean f46858d;
        ...
        static void b(DropDownListView dropDownListView, int i10, View view) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            try {
                f46855a.invoke(dropDownListView, Integer.valueOf(i10), view, Boolean.FALSE, -1, -1);
                f46856b.invoke(dropDownListView, Integer.valueOf(i10));
                f46857c.invoke(dropDownListView, Integer.valueOf(i10));
        ...
        static {
            try {
                ...
                f46855a = declaredMethod;
                declaredMethod.setAccessible(true);
                Method declaredMethod2 = AdapterView.class.getDeclaredMethod("setSelectedPositionInt", cls);
                f46856b = declaredMethod2;
                declaredMethod2.setAccessible(true);
                Method declaredMethod3 = AdapterView.class.getDeclaredMethod("setNextSelectedPositionInt", cls);
                f46857c = declaredMethod3;
    ...
    private static class d extends C15075a implements FSDraw {
        ...
        @Override // k.C15075a, android.graphics.drawable.Drawable
    ...
    static class e {
        ...
        /* renamed from: a, reason: collision with root package name */
        private static final Field f46860a;
    ...
    DropDownListView(Context context, boolean z10) {
        super(context, null, C14578a.f136263C);
        this.f46842a = new Rect();
        this.f46843b = 0;
        this.f46844c = 0;
        this.f46845d = 0;
        this.f46846e = 0;
    ...
    private void a() {
        ...
        View childAt = getChildAt(this.f46847f - getFirstVisiblePosition());
        if (childAt != null) {
            childAt.setPressed(false);
        }
        androidx.core.view.h hVar = this.f46852k;
        if (hVar != null) {
            hVar.c();
            this.f46852k = null;
        }
    ...
    private void c(Canvas canvas) {
        Drawable selector;
        if (this.f46842a.isEmpty() || (selector = getSelector()) == null) {
            return;
        }
        selector.setBounds(this.f46842a);
        selector.draw(canvas);
    }

    private void f(int i10, View view) throws IllegalAccessException, IllegalArgumentException {
        Rect rect = this.f46842a;
        rect.set(view.getLeft(), view.getTop(), view.getRight(), view.getBottom());
        rect.left -= this.f46843b;
        rect.top -= this.f46844c;
        rect.right += this.f46845d;
        rect.bottom += this.f46846e;
        boolean zJ = j();
    ...
    public boolean hasFocus() {
        return this.f46850i || super.hasFocus();
    }

    @Override // android.view.View
    public boolean hasWindowFocus() {
        return this.f46850i || super.hasWindowFocus();
    }

    @Override // android.view.View
    public boolean isFocused() {
        return this.f46850i || super.isFocused();
    }

    @Override // android.view.View
    public boolean isInTouchMode() {
        return (this.f46850i && this.f46849h) || super.isInTouchMode();
    }
    ...
    public boolean onHoverEvent(MotionEvent motionEvent) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        if (actionMasked == 10 && this.f46854m == null) {
            f fVar = new f();
            this.f46854m = fVar;
            fVar.b();
        }
    ...
    public void setSelector(Drawable drawable) {
        ...
        this.f46843b = rect.left;
        this.f46844c = rect.top;
        this.f46845d = rect.right;
        this.f46846e = rect.bottom;
    }
    ...
    private void g(int i10, View view) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (z10) {
            ...
            C13595a.k(selector, fExactCenterX, fExactCenterY);
        }
    }
    ...
    */
    public boolean e(android.view.MotionEvent r8, int r9) throws java.lang.IllegalAccessException, java.lang.IllegalArgumentException {
        ...
        L4d:
            if (r3 == 0) goto L65
            androidx.core.widget.h r9 = r7.f46853l
            if (r9 != 0) goto L5a
        ...
        L5a:
            ...
            return r3
        L65:
            androidx.core.widget.h r8 = r7.f46853l
            if (r8 == 0) goto L6c
            r8.m(r2)
        L6c:
            return r3
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            this.f46847f = pointToPosition((int) motionEvent.getX(), (int) motionEvent.getY());
        }
        f fVar = this.f46854m;
        if (fVar != null) {
            fVar.a();
