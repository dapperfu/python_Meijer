...
public class LinearLayoutCompat extends ViewGroup {
    ...
    protected boolean r(int i10) {
        if (i10 == 0) {
            return (this.f46924n & 1) != 0;
        }
        if (i10 == getChildCount()) {
            return (this.f46924n & 4) != 0;
        }
        if ((this.f46924n & 2) != 0) {
    ...
    public void setWeightSum(float f10) {
        this.f46917g = Math.max(0.0f, f10);
    }
    ...
    */
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.f46912b = -1;
        this.f46913c = 0;
        this.f46915e = 8388659;
        M mV = M.v(context, attributeSet, C14587j.f136598i1, i10, 0);
        ViewCompat.k0(this, context, C14587j.f136598i1, attributeSet, mV.r(), i10, 0);
        int iK = mV.k(C14587j.f136608k1, -1);
        if (iK >= 0) {
            setOrientation(iK);
        }
        int iK2 = mV.k(C14587j.f136603j1, -1);
        if (iK2 >= 0) {
            setGravity(iK2);
        }
        boolean zA = mV.a(C14587j.f136613l1, true);
        if (!zA) {
            setBaselineAligned(zA);
        }
        this.f46917g = mV.i(C14587j.f136623n1, -1.0f);
        this.f46912b = mV.k(C14587j.f136618m1, -1);
        this.f46918h = mV.a(C14587j.f136638q1, false);
        setDividerDrawable(mV.g(C14587j.f136628o1));
        this.f46924n = mV.k(C14587j.f136643r1, 0);
        this.f46925o = mV.f(C14587j.f136633p1, 0);
        mV.x();
    }
    ...
    void g(Canvas canvas, int i10) {
        this.f46921k.setBounds(getPaddingLeft() + this.f46925o, i10, (getWidth() - getPaddingRight()) - this.f46925o, this.f46923m + i10);
        this.f46921k.draw(canvas);
    }
    ...
    public int getBaseline() {
        ...
        int bottom = this.f46913c;
        if (this.f46914d == 1 && (i10 = this.f46915e & 112) != 48) {
            if (i10 == 16) {
                bottom += ((((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom()) - this.f46916f) / 2;
            } else if (i10 == 80) {
                bottom = ((getBottom() - getTop()) - getPaddingBottom()) - this.f46916f;
            }
        }
    ...
    void h(Canvas canvas, int i10) {
        this.f46921k.setBounds(i10, getPaddingTop() + this.f46925o, this.f46922l + i10, (getHeight() - getPaddingBottom()) - this.f46925o);
        this.f46921k.draw(canvas);
    }
    ...
    */
    ...
    public void setDividerDrawable(Drawable drawable) {
        if (drawable == this.f46921k) {
            return;
        }
        this.f46921k = drawable;
        if (drawable != null) {
            this.f46922l = drawable.getIntrinsicWidth();
            this.f46923m = drawable.getIntrinsicHeight();
        } else {
            this.f46922l = 0;
            this.f46923m = 0;
        }
    ...
    public void setVerticalGravity(int i10) {
        int i11 = i10 & 112;
        int i12 = this.f46915e;
        if ((i12 & 112) != i11) {
            this.f46915e = i11 | (i12 & (-113));
            requestLayout();
        }
    }
        ...
        for (int i11 = 0; i11 < virtualChildCount; i11++) {
            ...
            if (viewQ != null && viewQ.getVisibility() != 8 && r(i11)) {
                ...
                if (zB) {
                    ...
                    left2 = (viewQ.getLeft() - ((LinearLayout.LayoutParams) aVar).leftMargin) - this.f46922l;
                }
                h(canvas, left2);
            }
        }
    ...
    void f(Canvas canvas) {
        ...
        for (int i10 = 0; i10 < virtualChildCount; i10++) {
            ...
            if (viewQ != null && viewQ.getVisibility() != 8 && r(i10)) {
                g(canvas, (viewQ.getTop() - ((LinearLayout.LayoutParams) ((a) viewQ.getLayoutParams())).topMargin) - this.f46923m);
            }
        }
        if (r(virtualChildCount)) {
            View viewQ2 = q(virtualChildCount - 1);
            if (viewQ2 == null) {
                bottom = (getHeight() - getPaddingBottom()) - this.f46923m;
            } else {
