...
public abstract class A implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    private Runnable f46576e;

    /* renamed from: f, reason: collision with root package name */
    private Runnable f46577f;
    ...
    private final int[] f46580i = new int[2];
    ...
    private class a implements Runnable {
        ...
        public void run() {
            ViewParent parent = A.this.f46575d.getParent();
            if (parent != null) {
    ...
    public void onViewDetachedFromWindow(View view) {
        this.f46578g = false;
        this.f46579h = -1;
        Runnable runnable = this.f46576e;
        if (runnable != null) {
            this.f46575d.removeCallbacks(runnable);
        }
    }

    private void c() {
        Runnable runnable = this.f46577f;
        if (runnable != null) {
            this.f46575d.removeCallbacks(runnable);
        }
        Runnable runnable2 = this.f46576e;
        if (runnable2 != null) {
            this.f46575d.removeCallbacks(runnable2);
        }
    }

    private boolean h(MotionEvent motionEvent) throws IllegalAccessException, IllegalArgumentException {
        DropDownListView dropDownListView;
        View view = this.f46575d;
        ...
        if (showableListMenuD != null && showableListMenuD.b() && (dropDownListView = (DropDownListView) showableListMenuD.getListView()) != null && dropDownListView.isShown()) {
            ...
            boolean zE = dropDownListView.e(motionEventObtainNoHistory, this.f46579h);
    ...
    */
    private boolean i(android.view.MotionEvent r6) {
        /*
            r5 = this;
            android.view.View r0 = r5.f46575d
        ...
        L41:
            ...
            r5.f46579h = r6
            java.lang.Runnable r6 = r5.f46576e
            if (r6 != 0) goto L52
        ...
        L52:
            ...
            java.lang.Runnable r6 = r5.f46577f
            if (r6 != 0) goto L65
    ...
    private boolean k(View view, MotionEvent motionEvent) {
        view.getLocationOnScreen(this.f46580i);
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (z11) {
            ...
            if (z10) {
                ...
                this.f46575d.onTouchEvent(motionEventObtain);
    ...
    public A(View view) {
        ...
        this.f46572a = ViewConfiguration.get(view.getContext()).getScaledTouchSlop();
        int tapTimeout = ViewConfiguration.getTapTimeout();
        this.f46573b = tapTimeout;
        this.f46574c = (tapTimeout + ViewConfiguration.getLongPressTimeout()) / 2;
    }
