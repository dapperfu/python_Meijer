...
public class AppCompatCheckBox extends CheckBox implements androidx.core.widget.m {
    ...
    private final C5770d f46710a;

    /* renamed from: b, reason: collision with root package name */
    private final C5768b f46711b;

    /* renamed from: c, reason: collision with root package name */
    private final C5781o f46712c;

    /* renamed from: d, reason: collision with root package name */
    private C5773g f46713d;

    public AppCompatCheckBox(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C14578a.f136296r);
    }

    @Override // android.widget.CompoundButton
    public void setButtonDrawable(Drawable drawable) {
        super.setButtonDrawable(drawable);
        C5770d c5770d = this.f46710a;
        if (c5770d != null) {
            c5770d.e();
        }
    }
    ...
    private C5773g getEmojiTextViewHelper() {
        if (this.f46713d == null) {
            this.f46713d = new C5773g(this);
        }
        return this.f46713d;
    }

    public ColorStateList getSupportBackgroundTintList() {
        C5768b c5768b = this.f46711b;
        if (c5768b != null) {
            return c5768b.c();
        }
        return null;
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f46712c.j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f46712c.k();
    }
