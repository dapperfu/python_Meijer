...
public class AppCompatSpinner extends Spinner {
    ...
    private static final int[] f46738i = {R.attr.spinnerMode};

    /* renamed from: a, reason: collision with root package name */
    private final C5768b f46739a;
    ...
    private SpinnerAdapter f46742d;
    ...
    class d implements h, DialogInterface.OnClickListener {
        ...
        /* renamed from: a, reason: collision with root package name */
        androidx.appcompat.app.c f46750a;

        /* renamed from: b, reason: collision with root package name */
        private ListAdapter f46751b;

        /* renamed from: c, reason: collision with root package name */
        private CharSequence f46752c;
        ...
        @Override // androidx.appcompat.widget.AppCompatSpinner.h
        public boolean b() {
            androidx.appcompat.app.c cVar = this.f46750a;
            if (cVar != null) {
        ...
        public void l(int i10, int i11) {
            ...
            CharSequence charSequence = this.f46752c;
            if (charSequence != null) {
                aVar.setTitle(charSequence);
            }
            androidx.appcompat.app.c cVarCreate = aVar.setSingleChoiceItems(this.f46751b, AppCompatSpinner.this.getSelectedItemPosition(), this).create();
            this.f46750a = cVarCreate;
        ...
        public void onClick(DialogInterface dialogInterface, int i10) {
            ...
            if (AppCompatSpinner.this.getOnItemClickListener() != null) {
                AppCompatSpinner.this.performItemClick(null, i10, this.f46751b.getItemId(i10));
            }
            dismiss();
        }
    }
    ...
    private static class e implements ListAdapter, SpinnerAdapter {
        ...
        /* renamed from: a, reason: collision with root package name */
        private SpinnerAdapter f46754a;

        /* renamed from: b, reason: collision with root package name */
        private ListAdapter f46755b;
        ...
        public boolean areAllItemsEnabled() {
            ListAdapter listAdapter = this.f46755b;
            if (listAdapter != null) {
        ...
        @Override // android.widget.Adapter
        public int getCount() {
            SpinnerAdapter spinnerAdapter = this.f46754a;
        ...
        public e(SpinnerAdapter spinnerAdapter, Resources.Theme theme) {
            this.f46754a = spinnerAdapter;
            if (spinnerAdapter instanceof ListAdapter) {
                this.f46755b = (ListAdapter) spinnerAdapter;
            }
            if (theme != null) {
    ...
    class f extends B implements h {
        ...
        /* renamed from: I, reason: collision with root package name */
        private CharSequence f46756I;

        /* renamed from: J, reason: collision with root package name */
        ListAdapter f46757J;

        /* renamed from: K, reason: collision with root package name */
        private final Rect f46758K;
        ...
        class a implements AdapterView.OnItemClickListener {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ AppCompatSpinner f46761a;

            a(AppCompatSpinner appCompatSpinner) {
                this.f46761a = appCompatSpinner;
            }
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i10, long j10) {
                ...
                if (AppCompatSpinner.this.getOnItemClickListener() != null) {
                    f fVar = f.this;
                    AppCompatSpinner.this.performItemClick(view, i10, fVar.f46757J.getItemId(i10));
                }
                f.this.dismiss();
            }
        }
        ...
        class c implements PopupWindow.OnDismissListener {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ ViewTreeObserver.OnGlobalLayoutListener f46764a;

            c(ViewTreeObserver.OnGlobalLayoutListener onGlobalLayoutListener) {
                this.f46764a = onGlobalLayoutListener;
            }
            ...
            public void onDismiss() {
                ViewTreeObserver viewTreeObserver = AppCompatSpinner.this.getViewTreeObserver();
                if (viewTreeObserver != null) {
                    viewTreeObserver.removeGlobalOnLayoutListener(this.f46764a);
                }
            }
        }
        ...
        void S() {
            ...
            if (drawableH != null) {
                drawableH.getPadding(AppCompatSpinner.this.f46746h);
                if (Y.b(AppCompatSpinner.this)) {
                    i10 = AppCompatSpinner.this.f46746h.right;
                } else {
                    i10 = -AppCompatSpinner.this.f46746h.left;
                }
            } else {
                Rect rect = AppCompatSpinner.this.f46746h;
                rect.right = 0;
                rect.left = 0;
                i10 = 0;
            }
            ...
            int i11 = appCompatSpinner.f46745g;
            if (i11 == -2) {
                int iA = appCompatSpinner.a((SpinnerAdapter) this.f46757J, h());
                int i12 = AppCompatSpinner.this.getContext().getResources().getDisplayMetrics().widthPixels;
                Rect rect2 = AppCompatSpinner.this.f46746h;
        ...
        boolean U(View view) {
            if (view.isAttachedToWindow() && view.getGlobalVisibleRect(this.f46758K)) {
                return true;
            }
            return false;
        }
    ...
    static class g extends View.BaseSavedState {
        ...
        g(Parcel parcel) {
            super(parcel);
            this.f46766a = parcel.readByte() != 0;
        }

        @Override // android.view.View.BaseSavedState, android.view.AbsSavedState, android.os.Parcelable
        public void writeToParcel(Parcel parcel, int i10) {
            super.writeToParcel(parcel, i10);
            parcel.writeByte(this.f46766a ? (byte) 1 : (byte) 0);
        }
    }
    ...
    public AppCompatSpinner(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C14578a.f136274N);
    }
    ...
    int a(SpinnerAdapter spinnerAdapter, Drawable drawable) {
        ...
        drawable.getPadding(this.f46746h);
        Rect rect = this.f46746h;
    ...
    void b() {
        this.f46744f.l(getTextDirection(), getTextAlignment());
    }
    ...
    public int getDropDownWidth() {
        return this.f46744f != null ? this.f46745g : super.getDropDownWidth();
    }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (!gVar.f46766a || (viewTreeObserver = getViewTreeObserver()) == null) {
            return;
        }
    ...
    public void setAdapter(SpinnerAdapter spinnerAdapter) {
        ...
        if (this.f46744f != null) {
            ...
            this.f46744f.n(new e(spinnerAdapter, context.getTheme()));
        }
    }
    ...
    protected void onMeasure(int i10, int i11) {
        ...
        if (this.f46744f != null && View.MeasureSpec.getMode(i10) == Integer.MIN_VALUE) {
    ...
    public void setPopupBackgroundResource(int i10) {
        setPopupBackgroundDrawable(C14879a.b(getPopupContext(), i10));
    }
