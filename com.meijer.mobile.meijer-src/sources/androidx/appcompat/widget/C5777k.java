...
class C5777k {
    ...
    private static final int[] f47212c = {R.attr.indeterminateDrawable, R.attr.progressDrawable};

    /* renamed from: a, reason: collision with root package name */
    private final ProgressBar f47213a;
    ...
    void c(AttributeSet attributeSet, int i10) {
        M mV = M.v(this.f47213a.getContext(), attributeSet, f47212c, i10, 0);
        Drawable drawableH = mV.h(0);
        if (drawableH != null) {
            this.f47213a.setIndeterminateDrawable(e(drawableH));
        }
        Drawable drawableH2 = mV.h(1);
        if (drawableH2 != null) {
            this.f47213a.setProgressDrawable(d(drawableH2, false));
        }
        mV.x();
    }
    ...
    Drawable d(Drawable drawable, boolean z10) {
        if (drawable instanceof InterfaceC13597c) {
            InterfaceC13597c interfaceC13597c = (InterfaceC13597c) drawable;
            Drawable drawableA = interfaceC13597c.a();
            if (drawableA != null) {
                interfaceC13597c.b(d(drawableA, z10));
                return drawable;
            }
        } else {
    ...
    C5777k(ProgressBar progressBar) {
        this.f47213a = progressBar;
    }
}
