...
public class AppCompatMultiAutoCompleteTextView extends MultiAutoCompleteTextView {
    ...
    private static final int[] f46728d = {R.attr.popupBackground};

    /* renamed from: a, reason: collision with root package name */
    private final C5768b f46729a;

    /* renamed from: b, reason: collision with root package name */
    private final C5781o f46730b;

    /* renamed from: c, reason: collision with root package name */
    private final C5772f f46731c;
    ...
    public AppCompatMultiAutoCompleteTextView(Context context, AttributeSet attributeSet, int i10) {
        ...
        H.a(this, getContext());
        M mV = M.v(getContext(), attributeSet, f46728d, i10, 0);
        if (mV.s(0)) {
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f46731c.a(keyListener));
    }
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f46731c.d(C5774h.a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
