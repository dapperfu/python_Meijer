...
public final class C5875n implements InterfaceC5898z, Q0, K0 {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final AbstractC5869k parent;
    ...
    private C5875n invalidationDelegate;
    ...
    public C5875n(AbstractC5869k abstractC5869k, Applier<?> applier, CoroutineContext coroutineContext) {
        this.parent = abstractC5869k;
        ...
        this.observerHolder = new C5888u(null, false, 3, null);
        ComposerImpl composerImpl = new ComposerImpl(applier, abstractC5869k, slotTable, setL, aVar, aVar2, this);
        abstractC5869k.o(composerImpl);
        this.composer = composerImpl;
        this._recomposeContext = coroutineContext;
        this.isRoot = abstractC5869k instanceof Recomposer;
        this.composable = C5856e.f50484a.a();
    }

    @Override // androidx.compose.runtime.InterfaceC5898z
    public void f(List<Pair<C5862g0, C5862g0>> references) {
    ...
    private final void A(Function2<? super Composer, ? super Integer, Unit> content) {
        if (this.disposed) {
            C5899z0.b("The composition is disposed");
        }
    ...
    private final void B() {
        Object andSet = this.pendingModifications.getAndSet(C5877o.f50545a);
        if (andSet != null) {
            if (Intrinsics.e(andSet, C5877o.f50545a)) {
    ...
    private final void D() {
        ...
        if (Intrinsics.e(andSet, C5877o.f50545a) || andSet == null) {
            return;
        }
        if (andSet instanceof Set) {
            x((Set) andSet, false);
    ...
    */
    private final androidx.compose.runtime.T G(androidx.compose.runtime.I0 r21, androidx.compose.runtime.Anchor r22, java.lang.Object r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.C5875n.G(androidx.compose.runtime.I0, androidx.compose.runtime.Anchor, java.lang.Object):androidx.compose.runtime.T");
    }
    ...
    private final O0.c I() {
        C5888u c5888u = this.observerHolder;
        if (c5888u.getRoot()) {
            c5888u.a();
            return null;
        }
        C5888u c5888uI = this.parent.getObserverHolder();
        if (c5888uI != null) {
            c5888uI.a();
        }
        c5888u.a();
    ...
    private final void w(Object value, boolean forgetConditionalScopes) {
        ...
        if (!(objE instanceof Z.X)) {
            I0 i02 = (I0) objE;
            if (D0.g.g(this.observationsProcessed, value, i02) || i02.v(value) == T.f50376a) {
                return;
            }
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        I0 i03 = (I0) objArr[(i10 << 3) + i12];
                        if (!D0.g.g(this.observationsProcessed, value, i03) && i03.v(value) != T.f50376a) {
    ...
    */
    private final void x(java.util.Set<? extends java.lang.Object> r36, boolean r37) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.C5875n.x(java.util.Set, boolean):void");
    }
    ...
    public final C5888u getObserverHolder() {
    ...
    @Override // androidx.compose.runtime.InterfaceC5898z, androidx.compose.runtime.K0
        ...
        synchronized (this.lock) {
            try {
                if (this.composer.getIsComposing()) {
                    C5899z0.b("Composition is disposed while composing. If dispose is triggered by a call in @Composable function, consider wrapping it with SideEffect block.");
                }
                if (!this.disposed) {
                    this.disposed = true;
                    this.composable = C5856e.f50484a.b();
    ...
    @Override // androidx.compose.runtime.InterfaceC5898z
    public <R> R g(InterfaceC5898z to2, int groupIndex, Function0<? extends R> block) {
        if (to2 == null || Intrinsics.e(to2, this) || groupIndex < 0) {
            return block.invoke();
        }
        this.invalidationDelegate = (C5875n) to2;
    ...
    */
    public boolean j(java.util.Set<? extends java.lang.Object> r15) {
        ...
        L7d:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.C5875n.j(java.util.Set):boolean");
    }
    ...
    public void n(Set<? extends Object> values) {
        ...
        do {
            ...
            if (obj == null ? true : Intrinsics.e(obj, C5877o.f50545a)) {
                setJ = values;
    ...
    */
    public void r(java.lang.Object r15) {
        ...
        L5c:
            ...
            r14.H(r15)     // Catch: java.lang.Throwable -> L4f
        L61:
            kotlin.Unit r15 = kotlin.Unit.f143329a     // Catch: java.lang.Throwable -> L4f
            monitor-exit(r0)
            return
        L65:
            monitor-exit(r0)
            throw r15
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.C5875n.r(java.lang.Object):void");
    }
    ...
    public T k(I0 scope, Object instance) {
        ...
        if (anchor != null && anchor.b()) {
            if (!this.slotTable.D(anchor)) {
                synchronized (this.lock) {
                    c5875n = this.invalidationDelegate;
                }
                if (c5875n != null && c5875n.M(scope, instance)) {
                    return T.f50379d;
                }
                return T.f50376a;
            }
    ...
    public /* synthetic */ C5875n(AbstractC5869k abstractC5869k, Applier applier, CoroutineContext coroutineContext, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(abstractC5869k, applier, (i10 & 4) != 0 ? null : coroutineContext);
    }
}
