...
public class MutableState<T> extends M0.x implements M0.l<T> {
    ...
    @Override // androidx.compose.runtime.InterfaceC5872l0, androidx.compose.runtime.z1
    public T getValue() {
