...
public final class SlotWriter {
    ...
    public final void C(int amount) {
        ...
        if (!(this.insertCount <= 0)) {
            C5899z0.b("Cannot call seek() while inserting");
        }
        if (amount == 0) {
            return;
        }
    ...
    public final void U() {
        if (!(this.insertCount > 0)) {
            C5899z0.b("Unbalanced begin/end insert");
        }
    ...
    public final List<Anchor> x0(SlotTable table, int index, boolean removeSourceGroup) {
        ...
        HashMap<Anchor, GroupSourceInformation> mapV = table.v();
        Z.K<Z.L> kR = table.r();
        this.groups = groups;
        this.slots = slots;
        ...
        this.sourceInformationMap = mapV;
        this.calledByMap = kR;
    ...
    public SlotWriter(SlotTable slotTable) {
        ...
        this.sourceInformationMap = slotTable.v();
