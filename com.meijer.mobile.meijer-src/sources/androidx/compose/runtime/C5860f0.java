...
public final class C5860f0 {
    ...
    static final class a extends Lambda implements Function1<C5862g0, Integer> {
        a() {
            super(1);
        }
        ...
        public final Integer invoke(C5862g0 c5862g0) {
            return Integer.valueOf(C5860f0.this.getSlotTable().f(c5862g0.getAnchor()));
        }
    }

    public final Z.h0<C5862g0, C5860f0> c(Applier<?> applier, Z.c0<C5862g0> references) {
        ...
        while (true) {
            ...
            if (this.slotTable.D(((C5862g0) objArr[i11]).getAnchor())) {
                i11++;
            } else {
                ...
                for (int i13 = 0; i13 < i12; i13++) {
                    ...
                    if (this.slotTable.D(((C5862g0) obj).getAnchor())) {
                        t10.n(obj);
                    }
                }
                references = t10;
        ...
        try {
            ...
            for (int i15 = 0; i15 < i14; i15++) {
                C5862g0 c5862g0 = (C5862g0) objArr3[i15];
                int iE = slotWriterC.E(c5862g0.getAnchor());
                int iParent = slotWriterC.parent(iE);
                a(slotWriterC, iParent);
                b(slotWriterC, iParent);
                slotWriterC.C(iE - slotWriterC.getCurrentGroup());
                wC.x(c5862g0, ComposerKt.x(c5862g0.getComposition(), c5862g0, slotWriterC, applier));
            }
    ...
    public C5860f0(SlotTable slotTable) {
