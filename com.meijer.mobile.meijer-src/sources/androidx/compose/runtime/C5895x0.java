...
final class C5895x0 {
    ...
    static final class a extends Lambda implements Function0<D0.b<Object, V>> {
        ...
        public final Z.W<Object, Object> c() {
            Z.W<Object, Object> wN = ComposerKt.N(C5895x0.this.b().size());
            C5895x0 c5895x0 = C5895x0.this;
            int size = c5895x0.b().size();
            for (int i10 = 0; i10 < size; i10++) {
                V v10 = c5895x0.b().get(i10);
    ...
    public C5895x0(List<V> list, int i10) {
        boolean z10;
        this.keyInfos = list;
        this.startIndex = i10;
        if (i10 >= 0) {
