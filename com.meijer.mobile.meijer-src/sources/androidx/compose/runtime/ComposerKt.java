...
public final class ComposerKt {
    ...
    private static final Object f50186a = new OpaqueKey("provider");

    /* renamed from: b, reason: collision with root package name */
    private static final Object f50187b = new OpaqueKey("provider");

    /* renamed from: c, reason: collision with root package name */
    private static final Object f50188c = new OpaqueKey("compositionLocalMap");

    /* renamed from: d, reason: collision with root package name */
    private static final Object f50189d = new OpaqueKey("providerValues");

    /* renamed from: e, reason: collision with root package name */
    private static final Object f50190e = new OpaqueKey("providers");

    /* renamed from: f, reason: collision with root package name */
    private static final Object f50191f = new OpaqueKey("reference");

    /* renamed from: g, reason: collision with root package name */
    private static final Comparator<S> f50192g = new Comparator() { // from class: androidx.compose.runtime.i
    ...
    public static final class a implements K0 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ InterfaceC5898z f50193a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ C5862g0 f50194b;
        ...
        a(InterfaceC5898z interfaceC5898z, C5862g0 c5862g0) {
            this.f50193a = interfaceC5898z;
            this.f50194b = c5862g0;
        }

        @Override // androidx.compose.runtime.K0
        public T k(I0 scope, Object instance) {
            T tK;
            InterfaceC5898z interfaceC5898z = this.f50193a;
            K0 k02 = interfaceC5898z instanceof K0 ? (K0) interfaceC5898z : null;
            ...
            C5862g0 c5862g0 = this.f50194b;
            c5862g0.i(CollectionsKt.Q0(c5862g0.d(), TuplesKt.a(scope, instance)));
            return T.f50377b;
        }
    }
    ...
    public static final C5860f0 x(InterfaceC5898z interfaceC5898z, C5862g0 c5862g0, SlotWriter slotWriter, Applier<?> applier) {
        ...
        try {
            slotWriterC.H();
            slotWriterC.j1(126665345, c5862g0.c());
            SlotWriter.v0(slotWriterC, 0, 1, null);
            slotWriterC.o1(c5862g0.getParameter());
            List<Anchor> listC0 = slotWriter.C0(c5862g0.getAnchor(), 1, slotWriterC);
            slotWriterC.Y0();
            slotWriterC.T();
            slotWriterC.U();
            slotWriterC.L(true);
            C5860f0 c5860f0 = new C5860f0(slotTable);
            I0.Companion companion = I0.INSTANCE;
            if (!companion.b(slotTable, listC0)) {
                return c5860f0;
            }
            a aVar = new a(interfaceC5898z, c5862g0);
    ...
    public static final void P(SlotWriter slotWriter, RememberManager rememberManager) {
        ...
        for (int iQ2 = slotWriter.Q(slotWriter.groups, slotWriter.k0(slotWriter.getCurrentGroup())); iQ2 < iQ; iQ2++) {
            ...
            if (obj instanceof InterfaceC5861g) {
                rememberManager.b((InterfaceC5861g) obj, slotWriter.h0() - iQ2, -1, -1);
            }
    ...
    public static final void v(SlotWriter slotWriter, RememberManager rememberManager) {
        ...
        for (int iQ2 = slotWriter.Q(slotWriter.groups, slotWriter.k0(slotWriter.getCurrentGroup())); iQ2 < iQ; iQ2++) {
            ...
            int iE = -1;
            if (obj instanceof InterfaceC5861g) {
                rememberManager.g((InterfaceC5861g) obj, slotWriter.h0() - iQ2, -1, -1);
