...
public final class a extends d {
    ...
    public final void g(List<? extends Object> nodes, IntRef effectiveNodeIndex) {
        ...
        Operation.C5848d c5848d = Operation.C5848d.f50447c;
        cVar.j(c5848d);
    ...
    public final void k(Object[] nodes) {
        ...
        c cVar = this.operations;
        Operation.C5852h c5852h = Operation.C5852h.f50451c;
        cVar.j(c5852h);
    ...
    public final void A() {
        this.operations.i(Operation.x.f50466c);
    }

    public final void B(Function0<Unit> effect) {
        c cVar = this.operations;
        Operation.y yVar = Operation.y.f50467c;
        cVar.j(yVar);
    ...
    public final void C() {
        this.operations.i(Operation.z.f50468c);
    }

    public final void D(I0 scope) {
        c cVar = this.operations;
        Operation.A a10 = Operation.A.f50434c;
        cVar.j(a10);
    ...
    public final void E(int count) {
        c cVar = this.operations;
        Operation.B b10 = Operation.B.f50435c;
        cVar.j(b10);
        c cVarA = c.b.a(cVar);
    ...
    public final void F(Object value, Anchor anchor, int groupSlotIndex) {
        c cVar = this.operations;
        Operation.C c10 = Operation.C.f50436c;
        cVar.j(c10);
        c cVarA = c.b.a(cVar);
    ...
    public final void G(Object data) {
        c cVar = this.operations;
        Operation.D d10 = Operation.D.f50437c;
        cVar.j(d10);
    ...
    public final void I(Object value, int groupSlotIndex) {
        c cVar = this.operations;
        Operation.F f10 = Operation.F.f50439c;
        cVar.j(f10);
        c cVarA = c.b.a(cVar);
    ...
    public final void J(int count) {
        c cVar = this.operations;
        Operation.G g10 = Operation.G.f50440c;
        cVar.j(g10);
        c cVarA = c.b.a(cVar);
        cVarA.intArgs[cVarA.intArgsSize - cVarA.opCodes[cVarA.opCodesSize - 1].getInts()] = count;
        cVar.c(g10);
    ...
    public final void K(Object node) {
        if (node instanceof InterfaceC5861g) {
            this.operations.i(Operation.H.f50441c);
        }
    }
    ...
    public final void e(int distance) {
        c cVar = this.operations;
        Operation.C5845a c5845a = Operation.C5845a.f50444c;
        cVar.j(c5845a);
        c cVarA = c.b.a(cVar);
    ...
    public final void f(Anchor anchor, Object value) {
        c cVar = this.operations;
        Operation.C5846b c5846b = Operation.C5846b.f50445c;
        cVar.j(c5846b);
        c.b.c(c.b.a(cVar), Operation.r.a(0), anchor, Operation.r.a(1), value);
        cVar.c(c5846b);
    }

    public final void h(C5860f0 resolvedState, AbstractC5869k parentContext, C5862g0 from, C5862g0 to2) {
        c cVar = this.operations;
        Operation.C5849e c5849e = Operation.C5849e.f50448c;
        cVar.j(c5849e);
    ...
    public final void i() {
        this.operations.i(Operation.C5850f.f50449c);
    }

    public final void j(IntRef effectiveNodeIndexOut, Anchor anchor) {
        c cVar = this.operations;
        Operation.C5851g c5851g = Operation.C5851g.f50450c;
        cVar.j(c5851g);
        c.b.c(c.b.a(cVar), Operation.r.a(0), effectiveNodeIndexOut, Operation.r.a(1), anchor);
        cVar.c(c5851g);
    }

    public final void l(Function1<? super InterfaceC5867j, Unit> action, InterfaceC5867j composition) {
        c cVar = this.operations;
        Operation.i iVar = Operation.i.f50452c;
        cVar.j(iVar);
    ...
    public final void m() {
        this.operations.i(Operation.j.f50453c);
    }

    public final void n() {
        this.operations.i(Operation.k.f50454c);
    }

    public final void o(I0 scope) {
        c cVar = this.operations;
        Operation.l lVar = Operation.l.f50455c;
        cVar.j(lVar);
        c.b.b(c.b.a(cVar), Operation.r.a(0), scope);
        cVar.c(lVar);
    }
    ...
    public final void p(Anchor anchor) {
        c cVar = this.operations;
        Operation.m mVar = Operation.m.f50456c;
        cVar.j(mVar);
    ...
    public final void q() {
        this.operations.i(Operation.n.f50457c);
    }

    public final void s(Anchor anchor, SlotTable from) {
        c cVar = this.operations;
        Operation.InsertSlots insertSlots = Operation.InsertSlots.f50442c;
        cVar.j(insertSlots);
    ...
    public final void t(Anchor anchor, SlotTable from, b fixups) {
        c cVar = this.operations;
        Operation.InsertSlotsWithFixups insertSlotsWithFixups = Operation.InsertSlotsWithFixups.f50443c;
    ...
    public final void u(int offset) {
        c cVar = this.operations;
        Operation.p pVar = Operation.p.f50459c;
        cVar.j(pVar);
        c cVarA = c.b.a(cVar);
    ...
    public final void v(int to2, int from, int count) {
        c cVar = this.operations;
        Operation.q qVar = Operation.q.f50460c;
        cVar.j(qVar);
        c cVarA = c.b.a(cVar);
    ...
    public final void w(InterfaceC5898z composition, AbstractC5869k parentContext, C5862g0 reference) {
        c cVar = this.operations;
        Operation.t tVar = Operation.t.f50462c;
        cVar.j(tVar);
    ...
    public final void x(O0 value) {
        c cVar = this.operations;
        Operation.u uVar = Operation.u.f50463c;
        cVar.j(uVar);
    ...
    public final void y() {
        this.operations.i(Operation.v.f50464c);
    }

    public final void z(int removeFrom, int moveCount) {
        c cVar = this.operations;
        Operation.w wVar = Operation.w.f50465c;
        cVar.j(wVar);
        c cVarA = c.b.a(cVar);
        int iA = cVarA.intArgsSize - cVarA.opCodes[cVarA.opCodesSize - 1].getInts();
        int[] iArr = cVarA.intArgs;
    ...
    public final void r(a changeList, IntRef effectiveNodeIndex) {
        if (changeList.d()) {
            c cVar = this.operations;
            Operation.C5847c c5847c = Operation.C5847c.f50446c;
            cVar.j(c5847c);
