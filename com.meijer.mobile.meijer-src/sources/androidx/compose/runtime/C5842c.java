...
public final class C5842c implements InterfaceC5840b0 {
    ...
    static final class b extends Lambda implements Function1<Throwable, Unit> {
        ...
        public final void a(Throwable th2) {
            Object obj = C5842c.this.lock;
            C5842c c5842c = C5842c.this;
            Object obj2 = this.f50430g;
            synchronized (obj) {
                try {
                    c5842c.awaiters.remove(obj2);
                    if (c5842c.awaiters.isEmpty()) {
                        c5842c.hasAwaitersUnlocked.set(0);
                    }
    ...
    public <R> Object O(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        ...
        c15819p.C();
        a aVar = new a(function1, c15819p);
        synchronized (this.lock) {
            Throwable th2 = this.failureCause;
            if (th2 != null) {
                Result.Companion companion = Result.INSTANCE;
                c15819p.resumeWith(Result.b(ResultKt.a(th2)));
            } else {
    ...
    public C5842c(Function0<Unit> function0) {
