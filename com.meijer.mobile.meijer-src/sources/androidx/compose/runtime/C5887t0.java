...
final class C5887t0 extends MutableIntState implements Parcelable {

    @JvmField
    public static final Parcelable.Creator<C5887t0> CREATOR = new a();
    ...
    public static final class a implements Parcelable.Creator<C5887t0> {
        @Override // android.os.Parcelable.Creator
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public C5887t0 createFromParcel(Parcel parcel) {
            return new C5887t0(parcel.readInt());
        }

        @Override // android.os.Parcelable.Creator
        /* renamed from: b, reason: merged with bridge method [inline-methods] */
        public C5887t0[] newArray(int size) {
            return new C5887t0[size];
        }
