...
final class C5874m0 {
    ...
    static final class a extends Lambda implements Function1<C5876n0, Boolean> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ C5862g0 f50516f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(C5862g0 c5862g0) {
            super(1);
            this.f50516f = c5862g0;
        }

        @Override // kotlin.jvm.functions.Function1
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final Boolean invoke(C5876n0 c5876n0) {
            return Boolean.valueOf(Intrinsics.e(c5876n0.getContainer(), this.f50516f));
        }
    }

    public final void a(C5857e0<Object> content, C5876n0 nestedContent) {
    ...
    public final boolean c(C5857e0<Object> key) {
        return D0.b.f(this.contentMap, key);
    }

    public final C5876n0 d(C5857e0<Object> key) {
        C5876n0 c5876n0 = (C5876n0) D0.b.m(this.contentMap, key);
    ...
    public final void e(C5862g0 reference) {
        ...
        if (objE != null) {
            if (!(objE instanceof Z.T)) {
                ...
                D0.b.n(this.contentMap, (C5857e0) objE, new a(reference));
                return;
            }
            ...
            for (int i11 = 0; i11 < i10; i11++) {
                ...
                D0.b.n(this.contentMap, (C5857e0) obj, new a(reference));
            }
        }
    }
}
