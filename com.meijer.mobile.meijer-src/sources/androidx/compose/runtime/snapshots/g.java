...
public abstract class g {
    ...
    public static final int f50622f = 8;
    ...
    public static final class Companion {
        ...
        public static final void i(Function2 function2) {
            synchronized (j.J()) {
                j.f50649i = CollectionsKt.M0(j.f50649i, function2);
        ...
        public static final void k(Function1 function1) {
            synchronized (j.J()) {
                j.f50650j = CollectionsKt.M0(j.f50650j, function1);
                Unit unit = Unit.f143329a;
            }
            j.C();
        }
        ...
        public final M0.b h(final Function2<? super Set<? extends Object>, ? super g, Unit> observer) {
            j.B(j.f50641a);
            synchronized (j.J()) {
                j.f50649i = CollectionsKt.Q0(j.f50649i, observer);
                Unit unit = Unit.f143329a;
            }
        ...
        public final M0.b j(final Function1<Object, Unit> observer) {
            synchronized (j.J()) {
                j.f50650j = CollectionsKt.Q0(j.f50650j, observer);
                Unit unit = Unit.f143329a;
            }
            j.C();
    ...
    private g(long j10, i iVar) {
        this.invalid = iVar;
        this.snapshotId = j10;
        this.pinningTrackingHandle = j10 != j.f50642b ? j.c0(j10, getInvalid()) : -1;
    }
    ...
    public final void z() {
        if (this.disposed) {
            C5899z0.a("Cannot use a disposed snapshot");
        }
    }
    ...
    public void c() {
        j.f50645e = j.f50645e.p(getSnapshotId());
    }
