...
public interface RememberManager {
    ...
    void b(InterfaceC5861g instance, int endRelativeOrder, int priority, int endRelativeAfter);
    ...
    void g(InterfaceC5861g instance, int endRelativeOrder, int priority, int endRelativeAfter);
}
