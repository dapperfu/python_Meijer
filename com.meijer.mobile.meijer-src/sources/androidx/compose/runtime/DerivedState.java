...
final class DerivedState<T> extends M0.x implements B<T> {
    ...
    public static final class a<T> extends M0.y implements B.a<T> {
        ...
        private static final Object f50107j = new Object();
        ...
        */
        public final boolean l(androidx.compose.runtime.B<?> r6, androidx.compose.runtime.snapshots.g r7) {
            ...
            L1f:
                ...
                java.lang.Object r4 = androidx.compose.runtime.DerivedState.a.f50107j
                if (r0 == r4) goto L31
                if (r1 == 0) goto L32
            ...
            L32:
                ...
                kotlin.Unit r7 = kotlin.Unit.f143329a     // Catch: java.lang.Throwable -> L4b
                monitor-exit(r6)
                return r2
            L4b:
                r7 = move-exception
    ...
    static final class b extends Lambda implements Function1<Object, Unit> {
        ...
        final /* synthetic */ DerivedState<T> f50113f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ IntRef f50114g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Z.S<M0.w> f50115h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ int f50116i;
        ...
        public final void invoke2(Object obj) {
            ...
            if (obj instanceof M0.w) {
                int element = this.f50114g.getElement();
                Z.S<M0.w> s10 = this.f50115h;
                s10.u(obj, Math.min(element - this.f50116i, s10.e(obj, a.e.API_PRIORITY_OTHER)));
            }
        }
    }
