...
public interface InterfaceC5898z extends InterfaceC5867j {
    void a(Object value);
    ...
    void e(C5860f0 state);

    void f(List<Pair<C5862g0, C5862g0>> references);

    <R> R g(InterfaceC5898z to2, int groupIndex, Function0<? extends R> block);
