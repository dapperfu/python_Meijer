...
public final class ComposerImpl implements Composer {
    ...
    private InterfaceC5897y0 providerCache;
    ...
    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private final AbstractC5869k parentContext;
    ...
    private Z.K<InterfaceC5897y0> providerUpdates;
    ...
    private InterfaceC5897y0 parentProvider = J0.g.a();
    ...
    @SourceDebugExtension
    public final class b extends AbstractC5869k {
        ...
        /* renamed from: d, reason: collision with root package name and from kotlin metadata */
        private final C5888u observerHolder;
        ...
        /* renamed from: g, reason: collision with root package name and from kotlin metadata */
        private final InterfaceC5872l0 compositionLocalScope = o1.i(J0.g.a(), o1.o());

        public b(int i10, boolean z10, boolean z11, C5888u c5888u) {
            this.compoundHashKey = i10;
            this.collectingParameterInformation = z10;
            this.collectingSourceInformation = z11;
            this.observerHolder = c5888u;
        }

        private final InterfaceC5897y0 v() {
            return (InterfaceC5897y0) this.compositionLocalScope.getValue();
        }

        private final void w(InterfaceC5897y0 interfaceC5897y0) {
            this.compositionLocalScope.setValue(interfaceC5897y0);
        }

        @Override // androidx.compose.runtime.AbstractC5869k
        public void a(InterfaceC5898z composition, Function2<? super Composer, ? super Integer, Unit> content) {
        ...
        public C5888u getObserverHolder() {
        ...
        @Override // androidx.compose.runtime.AbstractC5869k
        public void l(C5862g0 reference, C5860f0 data, Applier<?> applier) {
        ...
        public final void x(InterfaceC5897y0 scope) {
            w(scope);
        }
    }
    ...
    static final class d extends Lambda implements Function0<Unit> {
        ...
        final /* synthetic */ androidx.compose.runtime.changelist.a f50179g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ SlotReader f50180h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ C5862g0 f50181i;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        d(androidx.compose.runtime.changelist.a aVar, SlotReader slotReader, C5862g0 c5862g0) {
            super(0);
            this.f50179g = aVar;
            this.f50180h = slotReader;
            this.f50181i = c5862g0;
        }
        ...
        public final void invoke2() {
            ...
            androidx.compose.runtime.changelist.a aVar2 = this.f50179g;
            ComposerImpl composerImpl = ComposerImpl.this;
            SlotReader slotReader = this.f50180h;
            C5862g0 c5862g0 = this.f50181i;
            ...
            try {
                ...
                try {
                    ...
                    try {
                        aVar3.V(false);
                        composerImpl.O0(c5862g0.c(), c5862g0.getLocals(), c5862g0.getParameter(), true);
    ...
    static final class e extends Lambda implements Function0<Unit> {
        ...
        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ C5862g0 f50183g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        e(C5862g0 c5862g0) {
            super(0);
            this.f50183g = c5862g0;
        }
        ...
        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final void invoke2() {
            ComposerImpl.this.O0(this.f50183g.c(), this.f50183g.getLocals(), this.f50183g.getParameter(), true);
        }
    }
    ...
    static final class f extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ C5857e0<Object> f50184f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Object f50185g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        f(C5857e0<Object> c5857e0, Object obj) {
            super(2);
            this.f50184f = c5857e0;
            this.f50185g = obj;
        }
        ...
        public final void a(Composer composer, int i10) {
            ...
            this.f50184f.a().invoke(this.f50185g, composer, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    */
    ...
    private final void u1() {
        ...
        Set<O0.a> set = (Set) C5886t.b(this.parentProvider, O0.e.a());
        if (set != null) {
            set.add(C());
    ...
    private final void A0(boolean isNode, C5895x0 newPending) {
    ...
    private final void B0(int expectedNodeCount, boolean inserting) {
        C5895x0 c5895x0 = (C5895x0) y1.i(this.pendingStack);
        if (c5895x0 != null && !inserting) {
            c5895x0.l(c5895x0.getGroupIndex() + 1);
        }
        this.pending = c5895x0;
    ...
    private final void L0(List<Pair<C5862g0, C5862g0>> references) throws Throwable {
        C0.a aVar;
        ...
        List<Pair<C5862g0, C5862g0>> list = references;
        ...
        try {
            ...
            while (i13 < size) {
                try {
                    Pair<C5862g0, C5862g0> pair = list.get(i13);
                    C5862g0 c5862g0A = pair.a();
                    C5862g0 c5862g0B = pair.b();
                    Anchor anchor2 = c5862g0A.getAnchor();
                    int iF = c5862g0A.getSlotTable().f(anchor2);
                    IntRef intRef = new IntRef(i12, 1, null);
                    this.changeListWriter.e(intRef, anchor2);
                    if (c5862g0B == null) {
                        if (Intrinsics.e(c5862g0A.getSlotTable(), this.insertTable)) {
                            o0();
                        }
                        SlotReader slotReaderB = c5862g0A.getSlotTable().B();
                        try {
                            slotReaderB.Q(iF);
                            this.changeListWriter.A(iF);
                            androidx.compose.runtime.changelist.a aVar9 = new androidx.compose.runtime.changelist.a();
                            Y0(this, null, null, null, null, new d(aVar9, slotReaderB, c5862g0A), 15, null);
                        ...
                        C5860f0 c5860f0M = this.parentContext.m(c5862g0B);
                        if (c5860f0M == null || (slotTable = c5860f0M.getSlotTable()) == null) {
                            slotTable = c5862g0B.getSlotTable();
                        }
                        if (c5860f0M == null || (slotTable2 = c5860f0M.getSlotTable()) == null || (anchor = slotTable2.a(0)) == null) {
                            anchor = c5862g0B.getAnchor();
                        }
                        List<? extends Object> listR = ComposerKt.r(slotTable, anchor);
                        if (!listR.isEmpty()) {
                            this.changeListWriter.b(listR, intRef);
                            if (Intrinsics.e(c5862g0A.getSlotTable(), this.slotTable)) {
                                int iF2 = this.slotTable.f(anchor2);
                                y1(iF2, D1(iF2) + listR.size());
                            }
                        }
                        this.changeListWriter.c(c5860f0M, this.parentContext, c5862g0B, c5862g0A);
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            try {
                                                ...
                                                aVar6 = changeList2;
                                                try {
                                                    X0(c5862g0B.getComposition(), c5862g0A.getComposition(), Integer.valueOf(slotReader.getCurrent()), c5862g0B.d(), new e(c5862g0A));
                                                    try {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private final <R> R X0(androidx.compose.runtime.InterfaceC5898z r7, androidx.compose.runtime.InterfaceC5898z r8, java.lang.Integer r9, java.util.List<? extends kotlin.Pair<androidx.compose.runtime.I0, ? extends java.lang.Object>> r10, kotlin.jvm.functions.Function0<? extends R> r11) {
        /*
            r6 = this;
    ...
    static /* synthetic */ Object Y0(ComposerImpl composerImpl, InterfaceC5898z interfaceC5898z, InterfaceC5898z interfaceC5898z2, Integer num, List list, Function0 function0, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            interfaceC5898z = null;
        }
        if ((i10 & 2) != 0) {
            interfaceC5898z2 = null;
        }
        if ((i10 & 4) != 0) {
            num = null;
        }
        ...
        return composerImpl.X0(interfaceC5898z, interfaceC5898z2, num, list, function0);
    }
    ...
    private final void c1(InterfaceC5897y0 providers) {
        Z.K<InterfaceC5897y0> k10 = this.providerUpdates;
        if (k10 == null) {
    ...
    private static final C5862g0 h1(ComposerImpl composerImpl, int i10, List<C5862g0> list) {
        ...
        return new C5862g0(c5857e0, objB, composerImpl.getComposition(), composerImpl.slotTable, anchorA, arrayList, composerImpl.q0(i10), list);
    }

    private static final C5862g0 i1(ComposerImpl composerImpl, int i10) {
        int iC = composerImpl.reader.C(i10);
        Object objD = composerImpl.reader.D(i10);
        ArrayList arrayList = null;
        if (iC != 126665345 || !(objD instanceof C5857e0)) {
            return null;
        }
    ...
    private static final void j1(ComposerImpl composerImpl, List<C5862g0> list, int i10) {
        int iE = composerImpl.reader.E(i10) + i10;
        int iE2 = i10 + 1;
        while (iE2 < iE) {
            if (composerImpl.reader.F(iE2)) {
                C5862g0 c5862g0I1 = i1(composerImpl, iE2);
                if (c5862g0I1 != null) {
                    list.add(c5862g0I1);
                }
    ...
    private static final int k1(ComposerImpl composerImpl, int i10, int i11, boolean z10, int i12) {
        ...
        if (iC == 126665345 && (objD instanceof C5857e0)) {
            C5862g0 c5862g0I1 = i1(composerImpl, i11);
            if (c5862g0I1 != null) {
                composerImpl.parentContext.b(c5862g0I1);
                composerImpl.changeListWriter.M();
                composerImpl.changeListWriter.O(composerImpl.getComposition(), composerImpl.parentContext, c5862g0I1);
            }
            if (!z10 || i11 == i10) {
                return slotReader.N(i11);
            }
    ...
    private final InterfaceC5897y0 p0() {
        InterfaceC5897y0 interfaceC5897y0 = this.providerCache;
        return interfaceC5897y0 != null ? interfaceC5897y0 : q0(this.reader.getParent());
    }
    ...
    private final void v0(boolean isNode) {
        ...
        C5895x0 c5895x0 = this.pending;
        if (c5895x0 != null && c5895x0.b().size() > 0) {
            List<V> listB = c5895x0.b();
            List<V> listF = c5895x0.f();
                ...
                if (setE.contains(v10)) {
                    ...
                    if (!linkedHashSet.contains(v10)) {
                        if (i12 < size) {
                            V v11 = listF.get(i12);
                            if (v11 != v10) {
                                int iG = c5895x0.g(v11);
                                linkedHashSet.add(v11);
                                if (iG != iO) {
                                    int iO2 = c5895x0.o(v11);
                                    list2 = listF;
                                    this.changeListWriter.y(c5895x0.getStartIndex() + iG, iO + c5895x0.getStartIndex(), iO2);
                                    c5895x0.j(iG, iO, iO2);
                                } else {
                                    list2 = listF;
                                }
                    ...
                    this.changeListWriter.R(c5895x0.g(v10) + c5895x0.getStartIndex(), v10.getNodes());
                    c5895x0.n(v10.getLocation(), 0);
    ...
    public O0.a C() {
        ...
        C5873m c5873m = new C5873m(getComposition());
        this._compositionData = c5873m;
        return c5873m;
    }
    ...
    public InterfaceC5898z getComposition() {
    ...
    public AbstractC5869k R() {
        ...
        if (aVar == null) {
            ...
            InterfaceC5898z composition = getComposition();
            C5875n c5875n = composition instanceof C5875n ? (C5875n) composition : null;
            aVar = new a(new b(compoundKeyHash, z10, z11, c5875n != null ? c5875n.getObserverHolder() : null));
            C1(aVar);
        }
        aVar.getRef().x(p0());
        w0();
    ...
    public T0 l() {
        ...
        if (i03 != null) {
            i03.I(false);
            Function1<InterfaceC5867j, Unit> function1H = i03.h(this.compositionToken);
            if (function1H != null) {
    ...
    */
    ...
    public final void x0() {
        if (!(!this.isComposing && this.reusingGroup == 100)) {
            C5899z0.a("Cannot disable reuse from root if it was caused by other groups");
        }
        this.reusingGroup = -1;
        this.reusing = false;
    }
    ...
    */
    public final void x1(Z.W<java.lang.Object, java.lang.Object> r17) {
        ...
        L2a:
            ...
            androidx.compose.runtime.S0 r5 = androidx.compose.runtime.S0.f50340a
            if (r12 != r5) goto L54
            r12 = 0
        L54:
    ...
    public ComposerImpl(Applier<?> applier, AbstractC5869k abstractC5869k, SlotTable slotTable, Set<N0> set, androidx.compose.runtime.changelist.a aVar, androidx.compose.runtime.changelist.a aVar2, InterfaceC5898z interfaceC5898z) {
        boolean z10;
        this.applier = applier;
        this.parentContext = abstractC5869k;
        this.slotTable = slotTable;
        this.abandonSet = set;
        this.changes = aVar;
        this.lateChanges = aVar2;
        this.composition = interfaceC5898z;
        if (!abstractC5869k.getCollectingSourceInformation() && !abstractC5869k.d()) {
            z10 = false;
        } else {
            z10 = true;
        }
        ...
        if (abstractC5869k.getCollectingSourceInformation()) {
            slotTable2.o();
        }
        if (abstractC5869k.d()) {
            slotTable2.n();
    ...
    private final InterfaceC5897y0 A1(InterfaceC5897y0 parentScope, InterfaceC5897y0 currentProviders) {
        f.a<AbstractC5879p<Object>, E1<Object>> aVarBuilder2 = parentScope.builder2();
    ...
    public final void O0(C5857e0<Object> content, InterfaceC5897y0 locals, Object parameter, boolean force) {
        ...
        try {
            ...
            if (getInserting() && !force) {
                ...
                SlotWriter slotWriter = this.writer;
                this.parentContext.j(new C5862g0(content, parameter, getComposition(), this.insertTable, slotWriter.D(slotWriter.parent(slotWriter.getParent())), CollectionsKt.m(), p0(), null));
            } else {
    ...
    */
    private final void i0() {
        /*
            ...
            androidx.compose.runtime.n r2 = (androidx.compose.runtime.C5875n) r2
            r0.<init>(r2)
        ...
        L24:
            ...
            androidx.compose.runtime.n r3 = (androidx.compose.runtime.C5875n) r3
            r2.<init>(r3)
            r4.C1(r2)
            goto L5b
        L54:
    ...
    private final InterfaceC5897y0 q0(int group) {
        InterfaceC5897y0 interfaceC5897y0B;
        if (getInserting() && this.writerHasAProvider) {
            ...
            while (parent > 0) {
                if (this.writer.groupKey(parent) == 202 && Intrinsics.e(this.writer.groupObjectKey(parent), ComposerKt.C())) {
                    ...
                    InterfaceC5897y0 interfaceC5897y0 = (InterfaceC5897y0) objJ0;
                    this.providerCache = interfaceC5897y0;
                    return interfaceC5897y0;
                }
        ...
        if (this.reader.getGroupsSize() > 0) {
            while (group > 0) {
                if (this.reader.C(group) == 202 && Intrinsics.e(this.reader.D(group), ComposerKt.C())) {
                    Z.K<InterfaceC5897y0> k10 = this.providerUpdates;
                    if (k10 == null || (interfaceC5897y0B = k10.b(group)) == null) {
                        ...
                        interfaceC5897y0B = (InterfaceC5897y0) objZ;
                    }
                    this.providerCache = interfaceC5897y0B;
                    return interfaceC5897y0B;
                }
                group = this.reader.P(group);
            }
        }
        InterfaceC5897y0 interfaceC5897y02 = this.parentProvider;
        this.providerCache = interfaceC5897y02;
        return interfaceC5897y02;
    }
    ...
    private final void z1(int group, int newCount) {
        ...
        if (iD1 != newCount) {
            ...
            while (group != -1) {
                ...
                while (true) {
                    if (-1 < i11) {
                        C5895x0 c5895x0 = (C5895x0) y1.h(this.pendingStack, i11);
                        if (c5895x0 != null && c5895x0.n(group, iD12)) {
                            iD = i11 - 1;
                            break;
                        }
                        i11--;
    ...
    public void H(G0<?> value) {
        E1<?> e12;
        InterfaceC5897y0 interfaceC5897y0P0 = p0();
        ...
        AbstractC5879p<?> abstractC5879pB = value.b();
        Intrinsics.h(abstractC5879pB, "null cannot be cast to non-null type androidx.compose.runtime.CompositionLocal<kotlin.Any?>");
        Intrinsics.h(value, "null cannot be cast to non-null type androidx.compose.runtime.ProvidedValue<kotlin.Any?>");
        E1<?> e1B = abstractC5879pB.b(value, e12);
        ...
        boolean z11 = false;
        if (getInserting()) {
            if (value.getCanOverride() || !C5886t.a(interfaceC5897y0P0, abstractC5879pB)) {
                interfaceC5897y0P0 = interfaceC5897y0P0.l(abstractC5879pB, e1B);
            }
            this.writerHasAProvider = true;
        } else {
            SlotReader slotReader = this.reader;
            ...
            Intrinsics.h(objZ, "null cannot be cast to non-null type androidx.compose.runtime.PersistentCompositionLocalMap");
            InterfaceC5897y0 interfaceC5897y0 = (InterfaceC5897y0) objZ;
            if ((j() && zE) || (!value.getCanOverride() && C5886t.a(interfaceC5897y0P0, abstractC5879pB))) {
                if ((zE && !this.providersInvalid) || !this.providersInvalid) {
                    interfaceC5897y0P0 = interfaceC5897y0;
                }
            } else {
                interfaceC5897y0P0 = interfaceC5897y0P0.l(abstractC5879pB, e1B);
            }
            if (!this.reusing && interfaceC5897y0 == interfaceC5897y0P0) {
                z10 = false;
            }
            z11 = z10;
        }
        if (z11 && !getInserting()) {
            c1(interfaceC5897y0P0);
        }
        this.providersInvalidStack.h(ComposerKt.q(this.providersInvalid));
        this.providersInvalid = z11;
        this.providerCache = interfaceC5897y0P0;
        p1(HttpResponseStatus.SUCCESS_ACCEPTED, ComposerKt.C(), O.INSTANCE.a(), interfaceC5897y0P0);
    }
    ...
    public void M0(List<Pair<C5862g0, C5862g0>> references) {
        try {
            L0(references);
            k0();
        } catch (Throwable th2) {
    ...
    public void W(G0<?>[] values) {
        InterfaceC5897y0 interfaceC5897y0A1;
        InterfaceC5897y0 interfaceC5897y0P0 = p0();
        r1(HttpResponseStatus.SUCCESS_CREATED, ComposerKt.G());
        boolean z10 = true;
        boolean z11 = false;
        if (getInserting()) {
            interfaceC5897y0A1 = A1(interfaceC5897y0P0, C5886t.d(values, interfaceC5897y0P0, null, 4, null));
            this.writerHasAProvider = true;
        } else {
            ...
            InterfaceC5897y0 interfaceC5897y0 = (InterfaceC5897y0) objA;
            ...
            InterfaceC5897y0 interfaceC5897y02 = (InterfaceC5897y0) objA2;
            InterfaceC5897y0 interfaceC5897y0C = C5886t.c(values, interfaceC5897y0P0, interfaceC5897y02);
            if (j() && !this.reusing && Intrinsics.e(interfaceC5897y02, interfaceC5897y0C)) {
                n1();
                interfaceC5897y0A1 = interfaceC5897y0;
            } else {
                interfaceC5897y0A1 = A1(interfaceC5897y0P0, interfaceC5897y0C);
                if (!this.reusing && Intrinsics.e(interfaceC5897y0A1, interfaceC5897y0)) {
                    z10 = false;
                }
                z11 = z10;
            }
        ...
        if (z11 && !getInserting()) {
            c1(interfaceC5897y0A1);
        }
        this.providersInvalidStack.h(ComposerKt.q(this.providersInvalid));
        this.providersInvalid = z11;
        this.providerCache = interfaceC5897y0A1;
        p1(HttpResponseStatus.SUCCESS_ACCEPTED, ComposerKt.C(), O.INSTANCE.a(), interfaceC5897y0A1);
    }
    ...
    @Override // androidx.compose.runtime.Composer
    public <T> T o(AbstractC5879p<T> key) {
        return (T) C5886t.b(p0(), key);
    }

    @Override // androidx.compose.runtime.Composer
    public InterfaceC5884s r() {
        return p0();
    }
    ...
    public void s() {
        ...
        if (this.reusing && (objI0 instanceof InterfaceC5861g)) {
