...
public final class f {
    ...
    public static final Modifier c(Modifier modifier, Function0<? extends InterfaceC15885r> function0, InterfaceC15852K interfaceC15852K, EnumC13937z enumC13937z, boolean z10, boolean z11, Composer composer, int i10) {
        if (ComposerKt.M()) {
            ComposerKt.U(1070136913, i10, -1, "androidx.compose.foundation.lazy.layout.lazyLayoutSemantics (LazyLayoutSemantics.kt:48)");
        }
        Modifier modifierThen = modifier.then(new LazyLayoutSemanticsModifier(function0, interfaceC15852K, enumC13937z, z10, z11));
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        return modifierThen;
