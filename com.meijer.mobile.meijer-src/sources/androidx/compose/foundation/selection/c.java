...
final class c extends d {
    ...
    private EnumC17174a state;

    public /* synthetic */ c(EnumC17174a enumC17174a, l lVar, InterfaceC13561B interfaceC13561B, boolean z10, Role role, Function0 function0, DefaultConstructorMarker defaultConstructorMarker) {
        this(enumC17174a, lVar, interfaceC13561B, z10, role, function0);
    }

    private c(EnumC17174a enumC17174a, l lVar, InterfaceC13561B interfaceC13561B, boolean z10, Role role, Function0<Unit> function0) {
        super(lVar, interfaceC13561B, z10, null, role, function0, null);
    ...
    public final void q3(EnumC17174a state, l interactionSource, InterfaceC13561B indicationNodeFactory, boolean enabled, Role role, Function0<Unit> onClick) {
        if (this.state != state) {
            this.state = state;
            v0.b(this);
        }
