...
final class b extends d {
    ...
    static final class a extends Lambda implements Function0<Unit> {
        ...
        final /* synthetic */ Function1<Boolean, Unit> f49194f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ boolean f49195g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        a(Function1<? super Boolean, Unit> function1, boolean z10) {
            super(0);
            this.f49194f = function1;
            this.f49195g = z10;
        }
        ...
        public final void invoke2() {
            this.f49194f.invoke(Boolean.valueOf(!this.f49195g));
        }
    }

    @Metadata(d1 = {"\u0000\b\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002"}, d2 = {"<anonymous>", "", "invoke"}, k = 3, mv = {1, 9, 0}, xi = 48)
    /* renamed from: androidx.compose.foundation.selection.b$b, reason: collision with other inner class name */
    static final class C1016b extends Lambda implements Function0<Unit> {
        C1016b() {
            super(0);
        }
    ...
    public /* synthetic */ b(boolean z10, l lVar, InterfaceC13561B interfaceC13561B, boolean z11, Role role, Function1 function1, DefaultConstructorMarker defaultConstructorMarker) {
        this(z10, lVar, interfaceC13561B, z11, role, function1);
    }

    private b(boolean z10, l lVar, InterfaceC13561B interfaceC13561B, boolean z11, Role role, Function1<? super Boolean, Unit> function1) {
        super(lVar, interfaceC13561B, z11, null, role, new a(function1, z10), null);
        this.value = z10;
        this.onValueChange = function1;
        this._onClick = new C1016b();
    }
    ...
    public final void s3(boolean value, l interactionSource, InterfaceC13561B indicationNodeFactory, boolean enabled, Role role, Function1<? super Boolean, Unit> onValueChange) {
        if (this.value != value) {
            this.value = value;
            v0.b(this);
        }
