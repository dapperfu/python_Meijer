...
final class C5802f extends Modifier.c implements androidx.compose.ui.node.D {
    ...
    static final class a extends Lambda implements Function1<f0.a, Unit> {
        ...
        public final void a(f0.a aVar) {
            f0.a.l(aVar, this.f48810f, 0, 0, 0.0f, 4, null);
        }
    ...
    public C5802f(float f10, boolean z10) {
        this.aspectRatio = f10;
        this.matchHeightConstraintsFirst = z10;
    }
    ...
    private final long N2(long j10, boolean z10) {
        int iRound;
        int iK = H1.b.k(j10);
        if (iK != Integer.MAX_VALUE && (iRound = Math.round(iK * this.aspectRatio)) > 0 && (!z10 || C5801e.c(j10, iRound, iK))) {
    ...
    private final long O2(long j10, boolean z10) {
        int iRound;
        int iL = H1.b.l(j10);
        if (iL != Integer.MAX_VALUE && (iRound = Math.round(iL / this.aspectRatio)) > 0 && (!z10 || C5801e.c(j10, iL, iRound))) {
    ...
    private final long P2(long j10, boolean z10) {
        ...
        if (iRound > 0 && (!z10 || C5801e.c(j10, iRound, iM))) {
    ...
    private final long Q2(long j10, boolean z10) {
        ...
        if (iRound > 0 && (!z10 || C5801e.c(j10, iN, iRound))) {
