...
final class AspectRatioElement extends Y<C5802f> {
    ...
    public C5802f b() {
        return new C5802f(this.aspectRatio, this.matchHeightConstraintsFirst);
    }

    @Override // androidx.compose.ui.node.Y
    /* renamed from: n, reason: merged with bridge method [inline-methods] */
    public void e(C5802f node) {
    ...
    public AspectRatioElement(float f10, boolean z10, Function1<? super N0, Unit> function1) {
        ...
        if (!z11) {
            C15077a.a("aspectRatio " + f10 + " must be > 0");
        }
    }
}
