...
public abstract class q {
    ...
    public static final class a {
        ...
        public static final a f48902a = new a("Visible", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final a f48903b = new a("Clip", 1);

        /* renamed from: c, reason: collision with root package name */
        public static final a f48904c = new a("ExpandIndicator", 2);

        /* renamed from: d, reason: collision with root package name */
        public static final a f48905d = new a("ExpandOrCollapseIndicator", 3);

        /* renamed from: e, reason: collision with root package name */
        private static final /* synthetic */ a[] f48906e;

        /* renamed from: f, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f48907f;

        private static final /* synthetic */ a[] a() {
            return new a[]{f48902a, f48903b, f48904c, f48905d};
        }
        ...
        public static a[] values() {
            return (a[]) f48906e.clone();
        }

        static {
            a[] aVarArrA = a();
            f48906e = aVarArrA;
            f48907f = EnumEntriesKt.a(aVarArrA);
        }
    ...
    public /* synthetic */ class b {
        ...
        static {
            ...
            try {
                iArr[a.f48904c.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[a.f48905d.ordinal()] = 2;
