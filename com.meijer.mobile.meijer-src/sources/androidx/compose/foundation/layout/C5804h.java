...
public final class C5804h {
    ...
    private static final W<P0.e, MeasurePolicy> f48813a = d(true);

    /* renamed from: b, reason: collision with root package name */
    private static final W<P0.e, MeasurePolicy> f48814b = d(false);

    /* renamed from: c, reason: collision with root package name */
    private static final MeasurePolicy f48815c = new C5805i(P0.e.INSTANCE.o(), false);

    /* renamed from: d, reason: collision with root package name */
    private static final MeasurePolicy f48816d = b.f48819a;
    ...
    static final class a extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ Modifier f48817f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f48818g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(Modifier modifier, int i10) {
            super(2);
            this.f48817f = modifier;
            this.f48818g = i10;
        }

        public final void a(Composer composer, int i10) {
            C5804h.a(this.f48817f, composer, J0.a(this.f48818g | 1));
        }
    ...
    static final class b implements MeasurePolicy {
        ...
        static final class a extends Lambda implements Function1<f0.a, Unit> {
            ...
            /* renamed from: f, reason: collision with root package name */
            public static final a f48820f = new a();
        ...
        public final androidx.compose.ui.layout.J d(androidx.compose.ui.layout.K k10, List<? extends androidx.compose.ui.layout.I> list, long j10) {
            return androidx.compose.ui.layout.K.G0(k10, H1.b.n(j10), H1.b.m(j10), null, a.f48820f, 4, null);
        }
    }
    ...
    private static final W<P0.e, MeasurePolicy> d(boolean z10) {
        ...
        w10.x(companion.o(), new C5805i(companion.o(), z10));
        w10.x(companion.m(), new C5805i(companion.m(), z10));
        w10.x(companion.n(), new C5805i(companion.n(), z10));
        w10.x(companion.h(), new C5805i(companion.h(), z10));
        w10.x(companion.e(), new C5805i(companion.e(), z10));
        w10.x(companion.f(), new C5805i(companion.f(), z10));
        w10.x(companion.d(), new C5805i(companion.d(), z10));
        w10.x(companion.b(), new C5805i(companion.b(), z10));
        w10.x(companion.c(), new C5805i(companion.c(), z10));
        return w10;
    }

    @PublishedApi
    public static final MeasurePolicy g(P0.e eVar, boolean z10) {
        MeasurePolicy measurePolicyE = (z10 ? f48813a : f48814b).e(eVar);
        return measurePolicyE == null ? new C5805i(eVar, z10) : measurePolicyE;
    }
    ...
    public static final void a(Modifier modifier, Composer composer, int i10) {
        ...
        if (composerStartRestartGroup.p(z10, i11 & 1)) {
            ...
            MeasurePolicy measurePolicy = f48816d;
    ...
    private static final C5803g e(androidx.compose.ui.layout.I i10) {
        Object objA = i10.getParentData();
        if (objA instanceof C5803g) {
            return (C5803g) objA;
        }
        return null;
    }
    ...
    public static final boolean f(androidx.compose.ui.layout.I i10) {
        C5803g c5803gE = e(i10);
        if (c5803gE != null) {
            return c5803gE.getMatchParentSize();
        }
        return false;
    }
    ...
    public static final void h(f0.a aVar, f0 f0Var, androidx.compose.ui.layout.I i10, H1.t tVar, int i11, int i12, P0.e eVar) {
        ...
        P0.e alignment;
        C5803g c5803gE = e(i10);
        if (c5803gE != null && (alignment = c5803gE.getAlignment()) != null) {
            eVar2 = alignment;
        } else {
            eVar2 = eVar;
        }
    ...
    public static final MeasurePolicy i(P0.e eVar, boolean z10, Composer composer, int i10) {
        ...
        if (Intrinsics.e(eVar, P0.e.INSTANCE.o()) && !z10) {
            ...
            if (z13 || objB == Composer.INSTANCE.a()) {
                objB = new C5805i(eVar, z10);
                composer.t(objB);
            }
            measurePolicy = (C5805i) objB;
            composer.P();
        }
        if (ComposerKt.M()) {
            ComposerKt.T();
