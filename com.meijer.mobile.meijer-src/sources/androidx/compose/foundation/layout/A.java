...
public final class A {
    ...
    static final class a extends Lambda implements Function1<N0, Unit> {
        ...
        public final void a(N0 n02) {
            n02.b("offset");
            n02.getProperties().c("x", H1.h.l(this.f48610f));
            n02.getProperties().c("y", H1.h.l(this.f48611g));
        }
    ...
    static final class b extends Lambda implements Function1<N0, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function1<H1.d, H1.n> f48612f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        b(Function1<? super H1.d, H1.n> function1) {
            super(1);
            this.f48612f = function1;
        }

        public final void a(N0 n02) {
            n02.b("offset");
            n02.getProperties().c("offset", this.f48612f);
        }
