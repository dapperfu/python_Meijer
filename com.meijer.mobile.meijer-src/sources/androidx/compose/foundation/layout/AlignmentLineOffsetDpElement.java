...
final class AlignmentLineOffsetDpElement extends Y<C5798b> {
    ...
    public /* synthetic */ AlignmentLineOffsetDpElement(AbstractC5916a abstractC5916a, float f10, float f11, Function1 function1, DefaultConstructorMarker defaultConstructorMarker) {
        this(abstractC5916a, f10, f11, function1);
    }
    ...
    private AlignmentLineOffsetDpElement(AbstractC5916a abstractC5916a, float f10, float f11, Function1<? super N0, Unit> function1) {
        ...
        if (!z11 || !z10) {
            C15077a.a("Padding from alignment line must be a non-negative number");
        }
    }
    ...
    public C5798b b() {
        return new C5798b(this.alignmentLine, this.before, this.after, null);
    }

    @Override // androidx.compose.ui.node.Y
    /* renamed from: n, reason: merged with bridge method [inline-methods] */
    public void e(C5798b node) {
