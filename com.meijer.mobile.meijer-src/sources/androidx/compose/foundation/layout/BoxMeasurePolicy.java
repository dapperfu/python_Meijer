...
final /* data */ class BoxMeasurePolicy implements MeasurePolicy {
    ...
    static final class a extends Lambda implements Function1<f0.a, Unit> {
        ...
        public static final a f48823f = new a();
    ...
    static final class b extends Lambda implements Function1<f0.a, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ f0 f48824f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ androidx.compose.ui.layout.I f48825g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ androidx.compose.ui.layout.K f48826h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ int f48827i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ int f48828j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ BoxMeasurePolicy f48829k;
        ...
        b(f0 f0Var, androidx.compose.ui.layout.I i10, androidx.compose.ui.layout.K k10, int i11, int i12, BoxMeasurePolicy boxMeasurePolicy) {
            ...
            this.f48827i = i11;
            this.f48828j = i12;
            this.f48829k = boxMeasurePolicy;
        }

        public final void a(f0.a aVar) {
            C5804h.h(aVar, this.f48824f, this.f48825g, this.f48826h.getLayoutDirection(), this.f48827i, this.f48828j, this.f48829k.alignment);
        }
    ...
    static final class c extends Lambda implements Function1<f0.a, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ f0[] f48830f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ List<androidx.compose.ui.layout.I> f48831g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ androidx.compose.ui.layout.K f48832h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ Ref.IntRef f48833i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ Ref.IntRef f48834j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ BoxMeasurePolicy f48835k;
        ...
        c(f0[] f0VarArr, List<? extends androidx.compose.ui.layout.I> list, androidx.compose.ui.layout.K k10, Ref.IntRef intRef, Ref.IntRef intRef2, BoxMeasurePolicy boxMeasurePolicy) {
            super(1);
            this.f48830f = f0VarArr;
            this.f48831g = list;
            this.f48832h = k10;
            this.f48833i = intRef;
            this.f48834j = intRef2;
            this.f48835k = boxMeasurePolicy;
        }

        public final void a(f0.a aVar) {
            f0[] f0VarArr = this.f48830f;
            List<androidx.compose.ui.layout.I> list = this.f48831g;
            androidx.compose.ui.layout.K k10 = this.f48832h;
            Ref.IntRef intRef = this.f48833i;
            Ref.IntRef intRef2 = this.f48834j;
            BoxMeasurePolicy boxMeasurePolicy = this.f48835k;
            ...
            while (i10 < length) {
                ...
                C5804h.h(aVar, f0Var, list.get(i11), k10.getLayoutDirection(), intRef.f143740a, intRef2.f143740a, boxMeasurePolicy.alignment);
                i10++;
                i11++;
            }
        }
    ...
    public androidx.compose.ui.layout.J d(androidx.compose.ui.layout.K k10, List<? extends androidx.compose.ui.layout.I> list, long j10) {
        ...
        f0 f0VarK0;
        if (list.isEmpty()) {
            return androidx.compose.ui.layout.K.G0(k10, H1.b.n(j10), H1.b.m(j10), null, a.f48823f, 4, null);
        }
        ...
        intRef.f143740a = H1.b.n(j10);
        Ref.IntRef intRef2 = new Ref.IntRef();
        intRef2.f143740a = H1.b.m(j10);
        ...
        for (int i13 = 0; i13 < size; i13++) {
            ...
            if (C5804h.f(i14)) {
                ...
                intRef.f143740a = Math.max(intRef.f143740a, f0VarK02.getWidth());
                intRef2.f143740a = Math.max(intRef2.f143740a, f0VarK02.getHeight());
            }
        }
        if (z10) {
            int i15 = intRef.f143740a;
            int i16 = i15 != Integer.MAX_VALUE ? i15 : 0;
            int i17 = intRef2.f143740a;
        ...
        return androidx.compose.ui.layout.K.G0(k10, intRef.f143740a, intRef2.f143740a, null, new c(f0VarArr, list, k10, intRef, intRef2, this), 4, null);
    }
