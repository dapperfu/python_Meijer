...
public final class o {
    ...
    public final b b(boolean nextItemHasNext, int nextIndexInLine, long leftOver, C5616n nextSize, int lineIndex, int totalCrossAxisSize, int currentLineCrossAxisSize, boolean isWrappingRound, boolean isEllipsisWrap) {
        int i10 = totalCrossAxisSize + currentLineCrossAxisSize;
        if (nextSize == null) {
            return new b(true, true);
        }
        if (this.overflow.getType() != q.a.f48902a && (lineIndex >= this.maxLines || C5616n.f(leftOver) - C5616n.f(nextSize.getPackedValue()) < 0)) {
            return new b(true, true);
        }
        if (nextIndexInLine != 0 && (nextIndexInLine >= this.maxItemsInMainAxis || C5616n.e(leftOver) - C5616n.e(nextSize.getPackedValue()) < 0)) {
            return isWrappingRound ? new b(true, true) : new b(true, b(nextItemHasNext, 0, C5616n.b(H1.b.l(this.constraints), (C5616n.f(leftOver) - this.crossAxisSpacing) - currentLineCrossAxisSize), C5616n.a(C5616n.b(C5616n.e(nextSize.getPackedValue()) - this.mainAxisSpacing, C5616n.f(nextSize.getPackedValue()))), lineIndex + 1, i10, 0, true, false).getIsLastItemInContainer());
        }
        int iMax = totalCrossAxisSize + Math.max(currentLineCrossAxisSize, C5616n.f(nextSize.getPackedValue()));
        C5616n c5616nF = isEllipsisWrap ? null : this.overflow.f(nextItemHasNext, lineIndex, iMax);
        if (c5616nF != null) {
            c5616nF.getPackedValue();
            if (nextIndexInLine + 1 >= this.maxItemsInMainAxis || ((C5616n.e(leftOver) - C5616n.e(nextSize.getPackedValue())) - this.mainAxisSpacing) - C5616n.e(c5616nF.getPackedValue()) < 0) {
                if (isEllipsisWrap) {
                    return new b(true, true);
                }
                b bVarB = b(false, 0, C5616n.b(H1.b.l(this.constraints), (C5616n.f(leftOver) - this.crossAxisSpacing) - Math.max(currentLineCrossAxisSize, C5616n.f(nextSize.getPackedValue()))), c5616nF, lineIndex + 1, iMax, 0, true, true);
    ...
    public final a a(b wrapInfo, boolean hasNext, int lastContentLineIndex, int totalCrossAxisSize, int leftOverMainAxis, int nextIndexInLine) {
        ...
        if (lastContentLineIndex >= 0 && (nextIndexInLine == 0 || (leftOverMainAxis - C5616n.e(aVarE.getEllipsisSize()) >= 0 && nextIndexInLine < this.maxItemsInMainAxis))) {
            z10 = true;
        } else {
            z10 = false;
        }
