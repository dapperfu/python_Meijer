...
final class FillElement extends Y<C5810n> {
    ...
    public static final class Companion {
        ...
        public final FillElement a(float fraction) {
            return new FillElement(EnumC14907k.f139711a, fraction, "fillMaxHeight");
        }

        public final FillElement b(float fraction) {
            return new FillElement(EnumC14907k.f139713c, fraction, "fillMaxSize");
        }

        public final FillElement c(float fraction) {
            return new FillElement(EnumC14907k.f139712b, fraction, "fillMaxWidth");
        }
    }
    ...
    public C5810n b() {
        return new C5810n(this.direction, this.fraction);
    }

    @Override // androidx.compose.ui.node.Y
    /* renamed from: n, reason: merged with bridge method [inline-methods] */
    public void e(C5810n node) {
        node.K2(this.direction);
        node.L2(this.fraction);
    }

    public FillElement(EnumC14907k enumC14907k, float f10, String str) {
