...
public final class G {
    ...
    private static final MeasurePolicy f48660a = new RowMeasurePolicy(C5800d.f48779a.g(), P0.e.INSTANCE.l());
    ...
    @PublishedApi
    public static final MeasurePolicy b(C5800d.e eVar, e.c cVar, Composer composer, int i10) {
        boolean z10;
        MeasurePolicy measurePolicy;
        if (ComposerKt.M()) {
            ComposerKt.U(-837807694, i10, -1, "androidx.compose.foundation.layout.rowMeasurePolicy (Row.kt:121)");
        }
        if (Intrinsics.e(eVar, C5800d.f48779a.g()) && Intrinsics.e(cVar, P0.e.INSTANCE.l())) {
            composer.startReplaceGroup(-848964613);
            composer.P();
            measurePolicy = f48660a;
        } else {
