...
final class E extends Modifier.c implements androidx.compose.ui.node.D {
    ...
    static final class a extends Lambda implements Function1<f0.a, Unit> {
        ...
        final /* synthetic */ f0 f48650g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ androidx.compose.ui.layout.K f48651h;
        ...
        public final void a(f0.a aVar) {
            if (E.this.getRtlAware()) {
                f0.a.l(aVar, this.f48650g, this.f48651h.E0(E.this.getStart()), this.f48651h.E0(E.this.getTop()), 0.0f, 4, null);
            } else {
                f0.a.h(aVar, this.f48650g, this.f48651h.E0(E.this.getStart()), this.f48651h.E0(E.this.getTop()), 0.0f, 4, null);
            }
        }
