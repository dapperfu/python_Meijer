...
public final class C5807k {
    ...
    private static final MeasurePolicy f48838a = new ColumnMeasurePolicy(C5800d.f48779a.h(), P0.e.INSTANCE.k());
    ...
    @PublishedApi
    public static final MeasurePolicy a(C5800d.m mVar, e.b bVar, Composer composer, int i10) {
        boolean z10;
        MeasurePolicy measurePolicy;
        if (ComposerKt.M()) {
            ComposerKt.U(1089876336, i10, -1, "androidx.compose.foundation.layout.columnMeasurePolicy (Column.kt:108)");
        }
        if (Intrinsics.e(mVar, C5800d.f48779a.h()) && Intrinsics.e(bVar, P0.e.INSTANCE.k())) {
            composer.startReplaceGroup(346089448);
            composer.P();
            measurePolicy = f48838a;
        } else {
