...
public final class C5801e {
    ...
    public static final class a extends Lambda implements Function1<N0, Unit> {
        ...
        final /* synthetic */ float f48806f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ boolean f48807g;
        ...
        public final void a(N0 n02) {
            n02.b("aspectRatio");
            n02.getProperties().c("ratio", Float.valueOf(this.f48806f));
            n02.getProperties().c("matchHeightConstraintsFirst", Boolean.valueOf(this.f48807g));
        }
