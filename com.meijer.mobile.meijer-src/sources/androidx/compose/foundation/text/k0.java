...
public final class k0 {
    ...
    private final InterfaceC5872l0 textLayoutResult = t1.e(null, null, 2, null);
    ...
    static final class b extends Lambda implements Function1<r1.u, Unit> {
        ...
        public static final b f49818f = new b();
        ...
        public final void a(r1.u uVar) {
            uVar.a(SemanticsProperties.INSTANCE.s(), Unit.f143329a);
        }
    ...
    static final class c extends Lambda implements Function0<Unit> {
        ...
        final /* synthetic */ AnnotatedString.Range<androidx.compose.ui.text.f> f49820g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ L1 f49821h;
        ...
        public final void invoke2() {
            k0.this.o(this.f49820g.g(), this.f49821h);
        }
    }
    ...
    static final class d extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new d(this.f49823b, continuation);
        }
    ...
    static final class e extends Lambda implements Function1<K, Unit> {
        ...
        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ AnnotatedString.Range<androidx.compose.ui.text.f> f49825g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ C f49826h;
        ...
        public final void a(K k10) {
            ...
            u1.w styles3;
            k0 k0Var = k0.this;
            u1.w styles4 = this.f49825g.g().getStyles();
            SpanStyle pressedStyle = null;
            SpanStyle spanStyleP = k0Var.p(k0Var.p(styles4 != null ? styles4.getStyle() : null, (!this.f49826h.f() || (styles3 = this.f49825g.g().getStyles()) == null) ? null : styles3.getFocusedStyle()), (!this.f49826h.g() || (styles2 = this.f49825g.g().getStyles()) == null) ? null : styles2.getHoveredStyle());
            if (this.f49826h.h() && (styles = this.f49825g.g().getStyles()) != null) {
                pressedStyle = styles.getPressedStyle();
            }
            k10.b(this.f49825g, k0Var.p(spanStyleP, pressedStyle));
        }
    ...
    static final class f extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final void a(Composer composer, int i10) {
            k0.this.b(composer, J0.a(this.f49828g | 1));
        }
    ...
    static final class g extends Lambda implements Function1<androidx.compose.runtime.F, androidx.compose.runtime.E> {
        ...
        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function1<K, Unit> f49830g;
        ...
        public static final class a implements androidx.compose.runtime.E {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ k0 f49831a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ Function1 f49832b;

            public a(k0 k0Var, Function1 function1) {
                this.f49831a = k0Var;
                this.f49832b = function1;
            }

            @Override // androidx.compose.runtime.E
            public void dispose() {
                this.f49831a.annotators.remove(this.f49832b);
            }
        }
        ...
        g(Function1<? super K, Unit> function1) {
            super(1);
            this.f49830g = function1;
        }

        @Override // kotlin.jvm.functions.Function1
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final androidx.compose.runtime.E invoke(androidx.compose.runtime.F f10) {
            k0.this.annotators.add(this.f49830g);
            return new a(k0.this, this.f49830g);
        }
    }
    ...
    static final class h extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Object[] f49834g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Function1<K, Unit> f49835h;
        ...
        h(Object[] objArr, Function1<? super K, Unit> function1, int i10) {
            super(2);
            this.f49834g = objArr;
            this.f49835h = function1;
            this.f49836i = i10;
        }

        public final void a(Composer composer, int i10) {
            k0 k0Var = k0.this;
            Object[] objArr = this.f49834g;
            k0Var.c(Arrays.copyOf(objArr, objArr.length), this.f49835h, composer, J0.a(this.f49836i | 1));
        }
    ...
    static final class i extends Lambda implements Function1<androidx.compose.ui.graphics.e, Unit> {
        ...
        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ AnnotatedString.Range<androidx.compose.ui.text.f> f49838g;
    ...
    public static final class j implements D1 {
        ...
        public AbstractC5480m1 a(long size, H1.t layoutDirection, H1.d density) {
            return new AbstractC5480m1.a(this.f49839a);
        }
    }
    ...
    static final class m extends Lambda implements Function0<H1.n> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final m f49842f = new m();
    ...
    static final class n extends Lambda implements Function0<H1.n> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final n f49843f = new n();
    ...
    public final void o(androidx.compose.ui.text.f link, L1 uriHandler) {
        InterfaceC17339d linkInteractionListener;
        Unit unit;
        ...
        InterfaceC17339d linkInteractionListener2 = link.getLinkInteractionListener();
    ...
    private final Modifier t(Modifier modifier, final AnnotatedString.Range<androidx.compose.ui.text.f> range) {
        return modifier.then(new q0(new r0() { // from class: androidx.compose.foundation.text.j0
            ...
            public final o0 a(p0 p0Var) {
                return k0.u(this.f49810a, range, p0Var);
            }
        }));
    }
    ...
    public final void b(Composer composer, int i10) {
        ...
        if (composerStartRestartGroup.p((i11 & 3) != 2, i11 & 1)) {
            ...
            L1 l12 = (L1) composerStartRestartGroup.o(C6034t0.s());
            ...
            while (i13 < size) {
                ...
                if (range.h() != range.f()) {
                    ...
                    h0.l lVar = (h0.l) objB;
                    Modifier modifierB = C14320x.b(androidx.compose.foundation.h.b(t(C16819m.d(k(Modifier.INSTANCE, range), false, b.f49818f, i12, null), range), lVar, false, 2, null), InterfaceC14319w.INSTANCE.b(), false, 2, null);
                    ...
                    C5804h.a(ClickableKt.f(modifierB, lVar, null, false, null, null, null, null, null, false, (Function0) objB2, 508, null), composerStartRestartGroup, 0);
    ...
    public k0(AnnotatedString annotatedString) {
        ...
        this.text = annotatedString.a(a.f49817f);
    }
