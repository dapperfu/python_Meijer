...
public final class a {
    ...
    private static final float f49770a;

    /* renamed from: b, reason: collision with root package name */
    private static final float f49771b;

    /* renamed from: c, reason: collision with root package name */
    private static final DpTouchBoundsExpansion f49772c;
    ...
    public static final Modifier b(Modifier modifier, boolean z10, boolean z11, Function0<Unit> function0) {
        ...
        if (z11) {
            modifier = C14320x.c(modifier, n0.a(), false, f49772c);
        }
