...
public final class O {
    ...
    public static /* synthetic */ N c(N n10, AnnotatedString annotatedString, TextStyle textStyle, H1.d dVar, AbstractC18269l.b bVar, boolean z10, int i10, int i11, int i12, List list, int i13, Object obj) {
        if ((i13 & 32) != 0) {
            z10 = true;
        }
        if ((i13 & 64) != 0) {
    ...
    public static final N b(N n10, AnnotatedString annotatedString, TextStyle textStyle, H1.d dVar, AbstractC18269l.b bVar, boolean z10, int i10, int i11, int i12, List<AnnotatedString.Range<Placeholder>> list) {
        AbstractC18269l.b bVar2;
        boolean z11;
        int i13;
        int i14;
        int i15;
