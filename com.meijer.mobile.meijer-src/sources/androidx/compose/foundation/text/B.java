...
public final class B {
    ...
    private final InterfaceC5872l0 deletionPreviewHighlightRange;
    ...
    private final C18428k processor = new C18428k();

    /* renamed from: e, reason: collision with root package name and from kotlin metadata */
    private z1.T inputSession;

    /* renamed from: f, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5872l0 hasFocus;

    /* renamed from: g, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5872l0 minHeightForSingleLineField;

    /* renamed from: h, reason: collision with root package name and from kotlin metadata */
    private LayoutCoordinates _layoutCoordinates;

    /* renamed from: i, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5872l0<h0> layoutResultState;

    /* renamed from: j, reason: collision with root package name and from kotlin metadata */
    private AnnotatedString untransformedText;

    /* renamed from: k, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5872l0 handleState;

    /* renamed from: l, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5872l0 showFloatingToolbar;

    /* renamed from: m, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5872l0 showSelectionHandleStart;

    /* renamed from: n, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5872l0 showSelectionHandleEnd;

    /* renamed from: o, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5872l0 showCursorHandle;

    /* renamed from: p, reason: collision with root package name and from kotlin metadata */
    private boolean isLayoutResultStale;

    /* renamed from: q, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5872l0 isInTouchMode;

    /* renamed from: r, reason: collision with root package name and from kotlin metadata */
    private final C5833x keyboardActionRunner;

    /* renamed from: s, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5872l0 autofillHighlightOn;

    /* renamed from: t, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5872l0 justAutofilled;
    ...
    private final InterfaceC5872l0 selectionPreviewHighlightRange;
    ...
    static final class c extends Lambda implements Function1<TextFieldValue, Unit> {
        ...
        public static final c f49236f = new c();
    ...
    public final void E(EnumC5825o enumC5825o) {
        this.handleState.setValue(enumC5825o);
    }
    ...
    public final void R(AnnotatedString untransformedText, AnnotatedString visualText, TextStyle textStyle, boolean softWrap, H1.d density, AbstractC18269l.b fontFamilyResolver, Function1<? super TextFieldValue, Unit> onValueChange, C5835z keyboardActions, InterfaceC5914o focusManager, long selectionBackgroundColor) {
        this.onValueChangeOriginal = onValueChange;
        this.selectionBackgroundColor = selectionBackgroundColor;
        C5833x c5833x = this.keyboardActionRunner;
        c5833x.f(keyboardActions);
        c5833x.e(focusManager);
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final EnumC5825o e() {
        return (EnumC5825o) this.handleState.getValue();
    }
    ...
    public final C18428k getProcessor() {
    ...
    public B(N n10, H0 h02, D1 d12) {
        ...
        this.handleState = t1.e(EnumC5825o.f49921a, null, 2, null);
