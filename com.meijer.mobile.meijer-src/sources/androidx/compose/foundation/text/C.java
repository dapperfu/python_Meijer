...
public final class C {
    ...
    private final InterfaceC5868j0 interactionState = C5844c1.a(0);
    ...
    static final class a<T> implements InterfaceC16562g {
        ...
        final /* synthetic */ Z.T<h0.i> f49242a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ C f49243b;
        ...
        public final Object emit(h0.i iVar, Continuation<? super Unit> continuation) {
            ...
            if (iVar instanceof h0.g ? true : iVar instanceof h0.d ? true : iVar instanceof n.b) {
                ...
                this.f49242a.y(((h0.h) iVar).getEnter());
            } else if (iVar instanceof h0.e) {
                this.f49242a.y(((h0.e) iVar).getFocus());
            } else if (iVar instanceof n.c) {
                this.f49242a.y(((n.c) iVar).getPress());
            } else if (iVar instanceof n.a) {
                this.f49242a.y(((n.a) iVar).getPress());
            }
            Z.T<h0.i> t10 = this.f49242a;
            C c10 = this.f49243b;
            ...
            this.f49243b.interactionState.i(i12);
