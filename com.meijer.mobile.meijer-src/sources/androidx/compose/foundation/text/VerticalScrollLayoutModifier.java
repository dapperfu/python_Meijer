...
final /* data */ class VerticalScrollLayoutModifier implements androidx.compose.ui.layout.B {
    ...
    static final class a extends Lambda implements Function1<f0.a, Unit> {
        ...
        final /* synthetic */ androidx.compose.ui.layout.K f50022f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ VerticalScrollLayoutModifier f50023g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ androidx.compose.ui.layout.f0 f50024h;
        ...
        a(androidx.compose.ui.layout.K k10, VerticalScrollLayoutModifier verticalScrollLayoutModifier, androidx.compose.ui.layout.f0 f0Var, int i10) {
            super(1);
            this.f50022f = k10;
            this.f50023g = verticalScrollLayoutModifier;
            this.f50024h = f0Var;
            this.f50025i = i10;
        }

        public final void a(f0.a aVar) {
            androidx.compose.ui.layout.K k10 = this.f50022f;
            int cursorOffset = this.f50023g.getCursorOffset();
            TransformedText transformedText = this.f50023g.getTransformedText();
            h0 h0VarInvoke = this.f50023g.k().invoke();
            this.f50023g.getScrollerPosition().k(EnumC13937z.f131419a, b0.c(k10, cursorOffset, transformedText, h0VarInvoke != null ? h0VarInvoke.getValue() : null, false, this.f50024h.getWidth()), this.f50025i, this.f50024h.getHeight());
            f0.a.l(aVar, this.f50024h, 0, Math.round(-this.f50023g.getScrollerPosition().d()), 0.0f, 4, null);
        }
