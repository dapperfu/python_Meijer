...
import androidx.compose.ui.layout.C5922g;
...
public final class E extends NodeCoordinator {
    ...
    private static final o1 f51403Y;
    ...
    private C5922g approachMeasureScope;
    ...
    public static final class c implements androidx.compose.ui.layout.J {
        ...
        private final /* synthetic */ androidx.compose.ui.layout.J f51409a;
    ...
    public int A(int width) {
        C5922g c5922g = this.approachMeasureScope;
        return c5922g != null ? c5922g.getApproachNode().q1(c5922g, P3(), width) : this.layoutModifierNode.r(this, P3(), width);
    }
    ...
    public final void R3(D d10) {
        if (!Intrinsics.e(d10, this.layoutModifierNode)) {
            ...
            if ((node.getKindSet() & C5952f0.a(512)) != 0) {
                Intrinsics.h(d10, "null cannot be cast to non-null type androidx.compose.ui.layout.ApproachLayoutModifierNode");
                InterfaceC5920e interfaceC5920e = (InterfaceC5920e) d10;
                C5922g c5922g = this.approachMeasureScope;
                if (c5922g != null) {
                    c5922g.A(interfaceC5920e);
                } else {
                    c5922g = new C5922g(this, interfaceC5920e);
                }
                this.approachMeasureScope = c5922g;
            } else {
    ...
    public int W(int width) {
        C5922g c5922g = this.approachMeasureScope;
        return c5922g != null ? c5922g.getApproachNode().A1(c5922g, P3(), width) : this.layoutModifierNode.F(this, P3(), width);
    }

    @Override // androidx.compose.ui.layout.r
    public int d0(int height) {
        C5922g c5922g = this.approachMeasureScope;
        return c5922g != null ? c5922g.getApproachNode().M0(c5922g, P3(), height) : this.layoutModifierNode.J(this, P3(), height);
    }

    @Override // androidx.compose.ui.layout.r
    public int j0(int height) {
        C5922g c5922g = this.approachMeasureScope;
        return c5922g != null ? c5922g.getApproachNode().l1(c5922g, P3(), height) : this.layoutModifierNode.N(this, P3(), height);
    }
    ...
    public E(LayoutNode layoutNode, D d10) {
        ...
        if ((d10.getNode().getKindSet() & C5952f0.a(512)) != 0) {
            Intrinsics.h(d10, "null cannot be cast to non-null type androidx.compose.ui.layout.ApproachLayoutModifierNode");
            c5922g = new C5922g(this, (InterfaceC5920e) d10);
        }
        this.approachMeasureScope = c5922g;
    }
