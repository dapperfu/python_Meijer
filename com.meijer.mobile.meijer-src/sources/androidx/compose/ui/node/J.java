...
public final class J implements X0.f, X0.c {
    ...
    private InterfaceC5965t drawNode;
    ...
    public final void a(Canvas canvas, long size, NodeCoordinator coordinator, Modifier.c drawNode, GraphicsLayer layer) {
        int iA = C5952f0.a(4);
        AbstractC5959m abstractC5959mH = drawNode;
        D0.c cVar = null;
        while (abstractC5959mH != 0) {
            if (abstractC5959mH instanceof InterfaceC5965t) {
                f(canvas, size, coordinator, abstractC5959mH, layer);
    ...
    public final void q(InterfaceC5965t interfaceC5965t, Canvas canvas, GraphicsLayer graphicsLayer) {
        NodeCoordinator nodeCoordinatorJ = C5957k.j(interfaceC5965t, C5952f0.a(4));
        nodeCoordinatorJ.getLayoutNode().c0().f(canvas, H1.s.d(nodeCoordinatorJ.c()), nodeCoordinatorJ, interfaceC5965t, graphicsLayer);
    }
    ...
    @Override // X0.f
    public void C1(AbstractC5467i0 brush, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, X0.g style, C5490r0 colorFilter, int blendMode) {
        this.canvasDrawScope.C1(brush, startAngle, sweepAngle, useCenter, topLeft, size, alpha, style, colorFilter, blendMode);
    }

    @Override // X0.f
    public void H1(long color, long topLeft, long size, long cornerRadius, X0.g style, float alpha, C5490r0 colorFilter, int blendMode) {
    ...
    @Override // X0.f
    public void P1(long color, float radius, long center, float alpha, X0.g style, C5490r0 colorFilter, int blendMode) {
        this.canvasDrawScope.P1(color, radius, center, alpha, style, colorFilter, blendMode);
    }

    @Override // X0.f
    public void U1(InterfaceC5459f1 image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, X0.g style, C5490r0 colorFilter, int blendMode, int filterQuality) {
        this.canvasDrawScope.U1(image, srcOffset, srcSize, dstOffset, dstSize, alpha, style, colorFilter, blendMode, filterQuality);
    }

    @Override // X0.f
    public void W0(AbstractC5467i0 brush, long topLeft, long size, float alpha, X0.g style, C5490r0 colorFilter, int blendMode) {
        this.canvasDrawScope.W0(brush, topLeft, size, alpha, style, colorFilter, blendMode);
    }

    @Override // X0.f
    public void b2(long color, long topLeft, long size, float alpha, X0.g style, C5490r0 colorFilter, int blendMode) {
        this.canvasDrawScope.b2(color, topLeft, size, alpha, style, colorFilter, blendMode);
    }

    @Override // X0.f
    public void c0(AbstractC5467i0 brush, long topLeft, long size, long cornerRadius, float alpha, X0.g style, C5490r0 colorFilter, int blendMode) {
        this.canvasDrawScope.c0(brush, topLeft, size, cornerRadius, alpha, style, colorFilter, blendMode);
    }

    @Override // X0.f
    public void d2(q1 path, AbstractC5467i0 brush, float alpha, X0.g style, C5490r0 colorFilter, int blendMode) {
        this.canvasDrawScope.d2(path, brush, alpha, style, colorFilter, blendMode);
    }

    public final void f(Canvas canvas, long size, NodeCoordinator coordinator, InterfaceC5965t drawNode, GraphicsLayer layer) {
        InterfaceC5965t interfaceC5965t = this.drawNode;
    ...
    @Override // X0.f
    public void q0(InterfaceC5459f1 image, long topLeft, float alpha, X0.g style, C5490r0 colorFilter, int blendMode) {
        this.canvasDrawScope.q0(image, topLeft, alpha, style, colorFilter, blendMode);
    }

    @Override // X0.f
    public void s0(long color, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, X0.g style, C5490r0 colorFilter, int blendMode) {
        this.canvasDrawScope.s0(color, startAngle, sweepAngle, useCenter, topLeft, size, alpha, style, colorFilter, blendMode);
    }

    @Override // X0.f
    public void z0(q1 path, long color, float alpha, X0.g style, C5490r0 colorFilter, int blendMode) {
    ...
    public void a2() {
        ...
        if (interfaceC5965t != null) {
            AbstractC5959m abstractC5959mB = K.b(interfaceC5965t);
            if (abstractC5959mB != 0) {
                int iA = C5952f0.a(4);
                D0.c cVar = null;
                while (abstractC5959mB != 0) {
                    if (abstractC5959mB instanceof InterfaceC5965t) {
                        q((InterfaceC5965t) abstractC5959mB, canvasG, getDrawContext().getGraphicsLayer());
                    } else if ((abstractC5959mB.getKindSet() & iA) != 0 && (abstractC5959mB instanceof AbstractC5959m)) {
                        Modifier.c delegate = abstractC5959mB.getDelegate();
                        int i10 = 0;
                        abstractC5959mB = abstractC5959mB;
                        while (delegate != null) {
                            if ((delegate.getKindSet() & iA) != 0) {
                                i10++;
                                if (i10 == 1) {
                                    abstractC5959mB = delegate;
                                } else {
                                    if (cVar == null) {
                                        cVar = new D0.c(new Modifier.c[16], 0);
                                    }
                                    if (abstractC5959mB != 0) {
                                        cVar.c(abstractC5959mB);
                                        abstractC5959mB = 0;
                                    }
                                    cVar.c(delegate);
                                }
                    ...
                    abstractC5959mB = C5957k.h(cVar);
                }
                return;
            }
            NodeCoordinator nodeCoordinatorJ = C5957k.j(interfaceC5965t, C5952f0.a(4));
            if (nodeCoordinatorJ.N2() == interfaceC5965t.getNode()) {
        ...
        C14920a.c("Attempting to drawContent for a `null` node. This usually means that a call to ContentDrawScope#drawContent() has been captured inside a lambda, and is being invoked outside of the draw pass. Capturing the scope this way is unsupported - if you are trying to record drawContent with graphicsLayer.record(), make sure you are using the GraphicsLayer#record function within DrawScope, instead of the member function on GraphicsLayer.");
