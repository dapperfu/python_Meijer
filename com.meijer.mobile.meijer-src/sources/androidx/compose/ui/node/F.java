...
public final class F {
    ...
    public static final int b(Q q10, AbstractC5916a abstractC5916a) {
        boolean z10;
        int iK;
        Q qM1 = q10.m1();
        if (qM1 != null) {
        ...
        if (!z10) {
            C14920a.b("Child of " + q10 + " cannot be null when calculating alignment line");
        }
        if (q10.s1().r().containsKey(abstractC5916a)) {
            Integer num = q10.s1().r().get(abstractC5916a);
            if (num == null) {
                return Integer.MIN_VALUE;
            }
            return num.intValue();
        }
        int iL0 = qM1.l0(abstractC5916a);
        ...
        qM1.X1(false);
        q10.V1(false);
        if (abstractC5916a instanceof C5932q) {
