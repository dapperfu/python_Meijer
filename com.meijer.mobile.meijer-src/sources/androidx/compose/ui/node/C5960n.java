...
public final class C5960n {
    ...
    private final D0<LayoutNode> set = new D0<>(C5961o.f51784a);
    ...
    public final boolean b(LayoutNode node) {
        ...
        if (this.extraAssertions) {
            if (!(zContains == f().a(node))) {
                C14920a.b("inconsistency in TreeSet");
            }
        }
        return zContains;
    }
    ...
    public final void a(LayoutNode node) {
        boolean z10;
        if (!node.isAttached()) {
            C14920a.b("DepthSortedSet.add called on an unattached node");
        }
        if (this.extraAssertions) {
            Z.S<LayoutNode> sF = f();
    ...
    public final boolean e(LayoutNode node) {
        ...
        boolean z10;
        if (!node.isAttached()) {
            C14920a.b("DepthSortedSet.remove called on an unattached node");
        }
