...
public final class V extends androidx.compose.ui.layout.f0 implements androidx.compose.ui.layout.I, InterfaceC5943b, Z {
    ...
    private final AbstractC5941a alignmentLines;
    ...
    public /* synthetic */ class a {
        ...
        static {
            ...
            try {
                iArr[LayoutNode.e.f51465a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[LayoutNode.e.f51467c.ordinal()] = 2;
    ...
    static final class b extends Lambda implements Function0<Unit> {
        ...
        static final class a extends Lambda implements Function1<InterfaceC5943b, Unit> {
            ...
            public static final a f51686f = new a();
        ...
        static final class C1066b extends Lambda implements Function1<InterfaceC5943b, Unit> {

            /* renamed from: f, reason: collision with root package name */
            public static final C1066b f51687f = new C1066b();
    ...
    @Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0001\u001a\u00020\u0000H\n¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"Landroidx/compose/ui/node/b;", "it", "", "a", "(Landroidx/compose/ui/node/b;)V"}, k = 3, mv = {1, 9, 0})
    static final class e extends Lambda implements Function1<InterfaceC5943b, Unit> {

        /* renamed from: f, reason: collision with root package name */
        public static final e f51690f = new e();
    ...
    private final void p2(long position, float zIndex, Function1<? super androidx.compose.ui.graphics.e, Unit> layerBlock, GraphicsLayer layer) {
        ...
        if ((tA13 == null || tA13.getPlacedOnce()) ? false : true) {
            C14920a.b("Error: Placement happened before lookahead.");
        }
    ...
    public final void m2() {
        ...
        if (parent$ui_release == null) {
            this.placeOrder = 0;
        } else if (!this.relayoutWithoutParentInProgress && parent$ui_release.X() == LayoutNode.e.f51467c) {
    ...
    public final void r2() {
        ...
        try {
            ...
            if (!this.placedOnce) {
                C14920a.b("replace called on unplaced item");
            }
    ...
    public final void s1() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (vD0.measuredByParent == LayoutNode.g.f51474b) {
                vD0.measuredByParent = LayoutNode.g.f51475c;
            }
        }
    }
    ...
    private final void j2() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            LayoutNode layoutNode = layoutNodeArr[i10];
            if (layoutNode.e0() && layoutNode.g0() == LayoutNode.g.f51473a && LayoutNode.g1(layoutNode, null, 1, null)) {
    ...
    public int l0(AbstractC5916a alignmentLine) {
        ...
        if (eVarX == LayoutNode.e.f51465a) {
            ...
            if (eVarX2 == LayoutNode.e.f51467c) {
    ...
    public final void n2(long constraints) {
        boolean z10;
        LayoutNode.e eVarZ1 = z1();
        LayoutNode.e eVar = LayoutNode.e.f51469e;
        if (eVarZ1 == eVar) {
            z10 = true;
        } else {
            z10 = false;
        ...
        if (!z10) {
            C14920a.b("layout state is not idle before measure starts");
        }
        this.performMeasureConstraints = constraints;
        LayoutNode.e eVar2 = LayoutNode.e.f51465a;
        t2(eVar2);
