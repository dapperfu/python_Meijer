...
public final class X {
    ...
    public /* synthetic */ class a {
        ...
        static {
            ...
            try {
                iArr[LayoutNode.e.f51468d.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[LayoutNode.e.f51465a.ordinal()] = 3;
    ...
    public static final List<List<androidx.compose.ui.layout.I>> a(InterfaceC5933s interfaceC5933s) {
        Intrinsics.h(interfaceC5933s, "null cannot be cast to non-null type androidx.compose.ui.node.MeasureScopeWithLayoutNode");
        LayoutNode layoutNode = ((W) interfaceC5933s).getLayoutNode();
