...
public final class C5957k {
    /* JADX WARN: Multi-variable type inference failed */
    public static final D d(Modifier.c cVar) {
        if ((C5952f0.a(2) & cVar.getKindSet()) != 0) {
            if (cVar instanceof D) {
                return (D) cVar;
            }
            if (cVar instanceof AbstractC5959m) {
                Modifier.c cVarL2 = ((AbstractC5959m) cVar).getDelegate();
                while (cVarL2 != 0) {
                    if (cVarL2 instanceof D) {
                        return (D) cVarL2;
                    }
                    cVarL2 = (!(cVarL2 instanceof AbstractC5959m) || (C5952f0.a(2) & cVarL2.getKindSet()) == 0) ? cVarL2.getChild() : ((AbstractC5959m) cVarL2).getDelegate();
                }
            }
        }
        return null;
    ...
    public static final boolean f(InterfaceC5956j interfaceC5956j, int i10) {
        if ((interfaceC5956j.getNode().getAggregateChildKindSet() & i10) != 0) {
            return true;
        }
        return false;
    }

    public static final boolean g(InterfaceC5956j interfaceC5956j) {
        if (interfaceC5956j.getNode() == interfaceC5956j) {
            return true;
        }
        return false;
    }

    public static final void i(InterfaceC5956j interfaceC5956j) {
        o(interfaceC5956j).k1();
    }

    public static final NodeCoordinator j(InterfaceC5956j interfaceC5956j, int i10) {
        NodeCoordinator coordinator = interfaceC5956j.getNode().getCoordinator();
        Intrinsics.g(coordinator);
        if (coordinator.N2() == interfaceC5956j && g0.i(i10)) {
    ...
    public static final H1.d k(InterfaceC5956j interfaceC5956j) {
        return o(interfaceC5956j).getDensity();
    }

    public static final InterfaceC5453d1 l(InterfaceC5956j interfaceC5956j) {
        return p(interfaceC5956j).getGraphicsContext();
    }

    public static final LayoutCoordinates m(InterfaceC5956j interfaceC5956j) {
        if (!interfaceC5956j.getNode().getIsAttached()) {
            C14920a.b("Cannot get LayoutCoordinates, Modifier.Node is not attached.");
        }
        LayoutCoordinates layoutCoordinatesQ1 = j(interfaceC5956j, C5952f0.a(2)).q1();
        if (!layoutCoordinatesQ1.isAttached()) {
            C14920a.b("LayoutCoordinates is not attached.");
        }
        return layoutCoordinatesQ1;
    }

    public static final H1.t n(InterfaceC5956j interfaceC5956j) {
        return o(interfaceC5956j).getLayoutDirection();
    }

    public static final LayoutNode o(InterfaceC5956j interfaceC5956j) {
        NodeCoordinator coordinator = interfaceC5956j.getNode().getCoordinator();
        if (coordinator != null) {
            return coordinator.getLayoutNode();
        }
        C14920a.c("Cannot obtain node coordinator. Is the Modifier.Node attached?");
        throw new KotlinNothingValueException();
    }

    public static final Owner p(InterfaceC5956j interfaceC5956j) {
        Owner owner$ui_release = o(interfaceC5956j).getOwner();
        if (owner$ui_release != null) {
            return owner$ui_release;
        }
        C14920a.c("This node does not have an owner.");
        throw new KotlinNothingValueException();
    }

    public static final InterfaceC16816j q(InterfaceC5956j interfaceC5956j) {
        return o(interfaceC5956j);
    }
}
