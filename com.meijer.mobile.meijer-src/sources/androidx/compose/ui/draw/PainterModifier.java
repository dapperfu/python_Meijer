...
final class PainterModifier extends Modifier.c implements D, InterfaceC5965t {
    ...
    static final class a extends Lambda implements Function1<f0.a, Unit> {
        ...
        public final void a(f0.a aVar) {
            f0.a.l(aVar, this.f50795f, 0, 0, 0.0f, 4, null);
        }
    ...
    public final void S2(C5490r0 c5490r0) {
        this.colorFilter = c5490r0;
    }

    public final void T2(InterfaceC5926k interfaceC5926k) {
    ...
    public PainterModifier(Z0.c cVar, boolean z10, P0.e eVar, InterfaceC5926k interfaceC5926k, float f10, C5490r0 c5490r0) {
        this.painter = cVar;
        this.sizeToIntrinsics = z10;
        this.alignment = eVar;
        this.contentScale = interfaceC5926k;
