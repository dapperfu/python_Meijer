...
public final class a2 {
    ...
    public static final class a implements View.OnAttachStateChangeListener {
        ...
        public void onViewDetachedFromWindow(View v10) {
            ...
            C0.a.a(this.f52224a, null, 1, null);
        }
    }
    ...
    static final class b extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        ...
        final /* synthetic */ Recomposer f52226b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ View f52227c;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(Recomposer recomposer, View view, Continuation<? super b> continuation) {
            super(2, continuation);
            this.f52226b = recomposer;
            this.f52227c = view;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new b(this.f52226b, this.f52227c, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                if (i10 != 0) {
                    ...
                    ResultKt.b(obj);
                    Recomposer recomposer = this.f52226b;
                    this.f52225a = 1;
                    if (recomposer.m0(this) == objF) {
                        return objF;
                    }
                }
                if (b2.f(view) == this.f52226b) {
                    b2.i(this.f52227c, null);
                }
                return Unit.f143329a;
            } finally {
                if (b2.f(this.f52227c) == this.f52226b) {
                    b2.i(this.f52227c, null);
                }
            }
        }
    ...
    public final Recomposer a(View rootView) {
        ...
        rootView.addOnAttachStateChangeListener(new a(C15809k.d(C15832v0.f151773a, C16029f.b(rootView.getHandler(), "windowRecomposer cleanup").X0(), null, new b(recomposerA, rootView, null), 2, null)));
        return recomposerA;
    }
