...
public final class A0 {
    ...
    public final void l(int fontSynthesis) {
        C18281x.Companion companion = C18281x.INSTANCE;
        byte b10 = 0;
        if (!C18281x.h(fontSynthesis, companion.b())) {
            if (C18281x.h(fontSynthesis, companion.a())) {
                b10 = 1;
            } else if (C18281x.h(fontSynthesis, companion.d())) {
                b10 = 2;
            } else if (C18281x.h(fontSynthesis, companion.c())) {
                b10 = 3;
            }
        }
        a(b10);
    ...
    public final void o(int fontStyle) {
        C18280w.Companion companion = C18280w.INSTANCE;
        byte b10 = 0;
        if (!C18280w.f(fontStyle, companion.b()) && C18280w.f(fontStyle, companion.a())) {
            b10 = 1;
        }
        a(b10);
    }
    ...
    public final void d(F1.k textDecoration) {
    ...
    public final void g(SpanStyle spanStyle) {
        ...
        if (!H1.v.e(spanStyle.getLetterSpacing(), companion2.a())) {
            a((byte) 7);
        ...
        if (!C5489q0.s(spanStyle.getBackground(), companion.j())) {
            a((byte) 10);
    ...
    public final void j(long textUnit) {
        long jG = H1.v.g(textUnit);
        x.Companion companion = H1.x.INSTANCE;
        byte b10 = 0;
        if (!H1.x.g(jG, companion.c())) {
            if (H1.x.g(jG, companion.b())) {
                b10 = 1;
            } else if (H1.x.g(jG, companion.a())) {
                b10 = 2;
            }
        }
        a(b10);
        if (!H1.x.g(H1.v.g(textUnit), companion.c())) {
            b(H1.v.h(textUnit));
        }
    }
