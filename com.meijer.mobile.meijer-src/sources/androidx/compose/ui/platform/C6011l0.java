...
final class C6011l0 implements InterfaceC6008k0 {
    ...
    public /* synthetic */ C6011l0(float[] fArr, DefaultConstructorMarker defaultConstructorMarker) {
        this(fArr);
    }

    private C6011l0(float[] fArr) {
        this.tmpMatrix = fArr;
    ...
    @Override // androidx.compose.ui.platform.InterfaceC6008k0
