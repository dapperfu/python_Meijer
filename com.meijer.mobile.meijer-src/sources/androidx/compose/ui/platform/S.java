...
public final class S implements InterfaceC5840b0 {
    ...
    static final class a extends Lambda implements Function1<Throwable, Unit> {
        ...
        final /* synthetic */ P f52150f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Choreographer.FrameCallback f52151g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(P p10, Choreographer.FrameCallback frameCallback) {
            super(1);
            this.f52150f = p10;
            this.f52151g = frameCallback;
        }

        public final void a(Throwable th2) {
            this.f52150f.q1(this.f52151g);
        }
    ...
    static final class b extends Lambda implements Function1<Throwable, Unit> {
        ...
        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Choreographer.FrameCallback f52153g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(Choreographer.FrameCallback frameCallback) {
            super(1);
            this.f52153g = frameCallback;
        }

        public final void a(Throwable th2) {
            S.this.getChoreographer().removeFrameCallback(this.f52153g);
        }
    ...
    static final class c implements Choreographer.FrameCallback {
        ...
        final /* synthetic */ InterfaceC15815n<R> f52154a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ S f52155b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Function1<Long, R> f52156c;

        /* JADX WARN: Multi-variable type inference failed */
        c(InterfaceC15815n<? super R> interfaceC15815n, S s10, Function1<? super Long, ? extends R> function1) {
            this.f52154a = interfaceC15815n;
            this.f52155b = s10;
            this.f52156c = function1;
        }

        @Override // android.view.Choreographer.FrameCallback
        public final void doFrame(long j10) {
            Object objB;
            Continuation continuation = this.f52154a;
            Function1<Long, R> function1 = this.f52156c;
            try {
    ...
    public <R> Object O(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        ...
        c15819p.C();
        c cVar = new c(c15819p, this, function1);
        if (p10 == null || !Intrinsics.e(p10.getChoreographer(), getChoreographer())) {
            getChoreographer().postFrameCallback(cVar);
            c15819p.F(new b(cVar));
        } else {
            p10.n1(cVar);
            c15819p.F(new a(p10, cVar));
        }
