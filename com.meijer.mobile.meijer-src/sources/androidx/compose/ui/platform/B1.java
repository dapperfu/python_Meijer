...
public final class B1 {
    ...
    private static final Rect f51989a = new Rect(0.0f, 0.0f, 10.0f, 10.0f);

    public static final C6050y1 a(List<C6050y1> list, int i10) {
        int size = list.size();
    ...
    public static final AbstractC5619q<A1> b(C16822p c16822p) {
        C16820n c16820nD = c16822p.d();
        if (c16820nD.getLayoutNode().f() && c16820nD.getLayoutNode().isAttached()) {
            Z.K k10 = new Z.K(48);
            Rect rectI = c16820nD.i();
            c(new Region(Math.round(rectI.getLeft()), Math.round(rectI.getTop()), Math.round(rectI.l()), Math.round(rectI.i())), c16820nD, k10, c16820nD, new Region());
            return k10;
        }
        return Z.r.a();
    }

    private static final void c(Region region, C16820n c16820n, Z.K<A1> k10, C16820n c16820n2, Region region2) {
        boolean z10;
        int i10;
        Rect rectI;
        InterfaceC5940z interfaceC5940zP;
        if (c16820n2.getLayoutNode().f() && c16820n2.getLayoutNode().isAttached()) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (!region.isEmpty() || c16820n2.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String() == c16820n.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String()) {
            if (!z10 || c16820n2.getIsFake()) {
                Rect rectV = c16820n2.v();
                ...
                if (c16820n2.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String() == c16820n.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String()) {
                    i10 = -1;
                } else {
                    i10 = c16820n2.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String();
                }
                if (region2.op(region, Region.Op.INTERSECT)) {
                    k10.r(i10, new A1(c16820n2, region2.getBounds()));
                    List<C16820n> listT = c16820n2.t();
                    for (int size = listT.size() - 1; -1 < size; size--) {
                        if (!listT.get(size).n().contains(SemanticsProperties.INSTANCE.s())) {
                            c(region, c16820n, k10, listT.get(size), region2);
                        }
                    }
                    if (g(c16820n2)) {
                ...
                if (c16820n2.getIsFake()) {
                    C16820n c16820nR = c16820n2.r();
                    if (c16820nR != null && (interfaceC5940zP = c16820nR.p()) != null && interfaceC5940zP.f()) {
                        rectI = c16820nR.i();
                    } else {
                        rectI = f51989a;
                    }
                    k10.r(i10, new A1(c16820n2, new android.graphics.Rect(Math.round(rectI.getLeft()), Math.round(rectI.getTop()), Math.round(rectI.l()), Math.round(rectI.i()))));
                    return;
                }
                if (i10 == -1) {
                    k10.r(i10, new A1(c16820n2, region2.getBounds()));
    ...
    public static final boolean f(C16820n c16820n) {
        if (!c16820n.z()) {
            SemanticsConfiguration unmergedConfig = c16820n.getUnmergedConfig();
            SemanticsProperties semanticsProperties = SemanticsProperties.INSTANCE;
            if (!unmergedConfig.contains(semanticsProperties.g()) && !c16820n.getUnmergedConfig().contains(semanticsProperties.l())) {
                return false;
            }
            return true;
        }
    ...
    public static final boolean g(C16820n c16820n) {
        if (!f(c16820n)) {
            if (c16820n.getUnmergedConfig().getIsMergingSemanticsOfDescendants() || c16820n.getUnmergedConfig().h()) {
                return true;
            }
            return false;
        }
