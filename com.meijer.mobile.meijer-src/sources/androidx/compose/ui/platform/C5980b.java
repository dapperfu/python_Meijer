...
public class C5980b extends AbstractC5977a {
    ...
    public static final class Companion {
        ...
        public final C5980b a(Locale locale) {
            if (C5980b.f52230f == null) {
                C5980b.f52230f = new C5980b(locale, null);
            }
            C5980b c5980b = C5980b.f52230f;
            Intrinsics.h(c5980b, "null cannot be cast to non-null type androidx.compose.ui.platform.AccessibilityIterators.CharacterTextSegmentIterator");
            return c5980b;
        }
    }

    public /* synthetic */ C5980b(Locale locale, DefaultConstructorMarker defaultConstructorMarker) {
        this(locale);
    }

    private C5980b(Locale locale) {
        i(locale);
    }
