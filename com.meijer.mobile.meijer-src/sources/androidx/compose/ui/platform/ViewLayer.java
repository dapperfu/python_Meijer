...
public final class ViewLayer extends View implements OwnedLayer, FSDispatchDraw {
    ...
    public static final int f52173q = 8;

    /* renamed from: r, reason: collision with root package name */
    private static final Function2<View, Matrix, Unit> f52174r = b.f52195f;

    /* renamed from: s, reason: collision with root package name */
    private static final ViewOutlineProvider f52175s = new a();

    /* renamed from: t, reason: collision with root package name */
    private static Method f52176t;

    /* renamed from: u, reason: collision with root package name */
    private static Field f52177u;

    /* renamed from: v, reason: collision with root package name */
    private static boolean f52178v;

    /* renamed from: w, reason: collision with root package name */
    private static boolean f52179w;
    ...
    static final class b extends Lambda implements Function2<View, Matrix, Unit> {
        ...
        public static final b f52195f = new b();
    ...
    public static final class Companion {
        ...
        public final void d(View view) {
            try {
                if (!a()) {
                    ViewLayer.f52178v = true;
                    if (Build.VERSION.SDK_INT < 28) {
                        ViewLayer.f52176t = View.class.getDeclaredMethod("updateDisplayListIfDirty", null);
                        ViewLayer.f52177u = View.class.getDeclaredField("mRecreateDisplayList");
                    } else {
                        ViewLayer.f52176t = (Method) Class.class.getDeclaredMethod("getDeclaredMethod", String.class, new Class[0].getClass()).invoke(View.class, "updateDisplayListIfDirty", new Class[0]);
                        ViewLayer.f52177u = (Field) Class.class.getDeclaredMethod("getDeclaredField", String.class).invoke(View.class, "mRecreateDisplayList");
                    }
                    Method method = ViewLayer.f52176t;
                    if (method != null) {
                        method.setAccessible(true);
                    }
                    Field field = ViewLayer.f52177u;
                    if (field != null) {
                        field.setAccessible(true);
                    }
                }
                Field field2 = ViewLayer.f52177u;
                if (field2 != null) {
                    field2.setBoolean(view, true);
                }
                Method method2 = ViewLayer.f52176t;
                if (method2 != null) {
        ...
        public final boolean a() {
            return ViewLayer.f52178v;
        }

        public final boolean b() {
            return ViewLayer.f52179w;
        }

        public final void c(boolean z10) {
            ViewLayer.f52179w = z10;
        }
    }
    ...
    private final void v() {
        setOutlineProvider(this.outlineResolver.b() != null ? f52175s : null);
    }

    @Override // androidx.compose.ui.node.OwnedLayer
    public void a(float[] matrix) {
        C5474k1.l(matrix, this.matrixCache.b(this));
    }
    ...
    protected void dispatchDraw(android.graphics.Canvas canvas) {
        ...
        android.graphics.Canvas canvasZ = c5473k0.getAndroidCanvas().getInternalCanvas();
        c5473k0.getAndroidCanvas().A(canvas);
        androidx.compose.ui.graphics.a aVarA = c5473k0.getAndroidCanvas();
        ...
        c5473k0.getAndroidCanvas().A(canvasZ);
        setInvalidated(false);
    }
    ...
    public ViewLayer(AndroidComposeView androidComposeView, DrawChildContainer drawChildContainer, Function2<? super Canvas, ? super GraphicsLayer, Unit> function2, Function0<Unit> function0) {
        ...
        this.canvasHolder = new C5473k0();
        this.matrixCache = new R0<>(f52174r);
        this.mTransformOrigin = androidx.compose.ui.graphics.i.INSTANCE.a();
    ...
    public void g(androidx.compose.ui.graphics.g scope) {
        ...
        if (i10 >= 28) {
            if ((iB & 64) != 0) {
                R1.f52130a.a(this, C5492s0.j(scope.getAmbientShadowColor()));
            }
            if ((iB & 128) != 0) {
                R1.f52130a.b(this, C5492s0.j(scope.getSpotShadowColor()));
            }
        }
