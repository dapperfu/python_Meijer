...
public final class C5995g extends AbstractC5977a {

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);

    /* renamed from: e, reason: collision with root package name */
    public static final int f52305e = 8;

    /* renamed from: f, reason: collision with root package name */
    private static C5995g f52306f;
    ...
    public static final class Companion {
        ...
        public final C5995g a(Locale locale) {
            if (C5995g.f52306f == null) {
                C5995g.f52306f = new C5995g(locale, null);
            }
            C5995g c5995g = C5995g.f52306f;
            Intrinsics.h(c5995g, "null cannot be cast to non-null type androidx.compose.ui.platform.AccessibilityIterators.WordTextSegmentIterator");
            return c5995g;
        }
    }

    public /* synthetic */ C5995g(Locale locale, DefaultConstructorMarker defaultConstructorMarker) {
        this(locale);
    }

    private C5995g(Locale locale) {
        l(locale);
    }
    ...
    @Override // androidx.compose.ui.platform.AbstractC5977a
