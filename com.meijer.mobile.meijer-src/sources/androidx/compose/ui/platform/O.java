...
public final class O implements H1 {
    ...
    private final C15654c textActionModeCallback = new C15654c(new a(), null, null, null, null, null, null, 126, null);

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    private J1 status = J1.f52050b;
    ...
    public void e(Rect rect, Function0<Unit> onCopyRequested, Function0<Unit> onPasteRequested, Function0<Unit> onCutRequested, Function0<Unit> onSelectAllRequested, Function0<Unit> onAutofillRequested) {
        ...
        ActionMode actionMode = this.actionMode;
        if (actionMode == null) {
            this.status = J1.f52049a;
            this.actionMode = I1.f52046a.a(this.view, new C15652a(this.textActionModeCallback), 1);
