...
public final class C6053z1 {
    ...
    public C6053z1(C16820n c16820n, AbstractC5619q<A1> abstractC5619q) {
        this.unmergedConfig = c16820n.getUnmergedConfig();
        this.children = new Z.L(c16820n.t().size());
        List<C16820n> listT = c16820n.t();
        int size = listT.size();
        for (int i10 = 0; i10 < size; i10++) {
            C16820n c16820n2 = listT.get(i10);
            if (abstractC5619q.a(c16820n2.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String())) {
                this.children.g(c16820n2.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String());
            }
        }
    }
}
