...
public abstract class AbstractComposeView extends ViewGroup {
    ...
    private WeakReference<AbstractC5869k> cachedViewTreeCompositionContext;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private IBinder previousAttachedWindowToken;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private InterfaceC5867j composition;

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    private AbstractC5869k parentContext;
    ...
    private final boolean i(AbstractC5869k abstractC5869k) {
        return !(abstractC5869k instanceof Recomposer) || ((Recomposer) abstractC5869k).f0().getValue().compareTo(Recomposer.d.f50288b) > 0;
    }

    private final AbstractC5869k j() {
        AbstractC5869k abstractC5869k;
        AbstractC5869k abstractC5869kB = this.parentContext;
        if (abstractC5869kB == null) {
            AbstractC5869k abstractC5869kD = b2.d(this);
            AbstractC5869k abstractC5869k2 = null;
            abstractC5869kB = abstractC5869kD != null ? b(abstractC5869kD) : null;
            if (abstractC5869kB == null) {
                WeakReference<AbstractC5869k> weakReference = this.cachedViewTreeCompositionContext;
                if (weakReference != null && (abstractC5869k = weakReference.get()) != null && i(abstractC5869k)) {
                    abstractC5869k2 = abstractC5869k;
                }
                return abstractC5869k2 == null ? b(b2.h(this)) : abstractC5869k2;
            }
        }
        return abstractC5869kB;
    }

    private final void setParentContext(AbstractC5869k abstractC5869k) {
        if (this.parentContext != abstractC5869k) {
            this.parentContext = abstractC5869k;
            if (abstractC5869k != null) {
                this.cachedViewTreeCompositionContext = null;
            }
            InterfaceC5867j interfaceC5867j = this.composition;
            if (interfaceC5867j != null) {
    ...
    private final AbstractC5869k b(AbstractC5869k abstractC5869k) {
        AbstractC5869k abstractC5869k2;
        if (i(abstractC5869k)) {
            abstractC5869k2 = abstractC5869k;
        } else {
            abstractC5869k2 = null;
        }
        if (abstractC5869k2 != null) {
            this.cachedViewTreeCompositionContext = new WeakReference<>(abstractC5869k2);
        }
        return abstractC5869k;
    }
    ...
    public final void setParentCompositionContext(AbstractC5869k parent) {
