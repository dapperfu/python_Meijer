...
public final class R0<T> {
    ...
    private float[] matrixCache = C5474k1.c(null, 1, null);

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    private float[] inverseMatrixCache = C5474k1.c(null, 1, null);
    ...
    public final void h() {
        ...
        C5474k1.h(this.inverseMatrixCache);
    }
    ...
    public final float[] b(T target) {
        ...
        V0.N.b(fArr, matrix);
        this.isDirty = false;
        this.isIdentity = C5477l1.a(fArr);
        return fArr;
    }
