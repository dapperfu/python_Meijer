...
public final class C6054a implements InterfaceC17341f {
    ...
    public /* synthetic */ class C1084a {
        ...
        static {
            ...
            try {
                iArr[F1.i.f8930a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[F1.i.f8931b.ordinal()] = 2;
    ...
    static final class b extends Lambda implements Function2<RectF, RectF, Boolean> {
        ...
        public final Boolean invoke(RectF rectF, RectF rectF2) {
            return Boolean.valueOf(this.f52659f.a(w1.f(rectF), w1.f(rectF2)));
        }
    }

    public /* synthetic */ C6054a(C1.d dVar, int i10, int i11, long j10, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    */
    private C6054a(C1.d r23, int r24, int r25, long r26) {
        /*
            Method dump skipped, instructions count: 796
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.C6054a.<init>(C1.d, int, int, long):void");
    }
    ...
    static /* synthetic */ o0 F(C6054a c6054a, int i10, int i11, TextUtils.TruncateAt truncateAt, int i12, int i13, int i14, int i15, int i16, CharSequence charSequence, int i17, Object obj) {
        return c6054a.E(i10, i11, truncateAt, i12, i13, i14, i15, i16, (i17 & 256) != 0 ? c6054a.charSequence : charSequence);
    }
    ...
    public long g(Rect rect, int granularity, u1.t inclusionStrategy) {
        int[] iArrC = this.layout.C(w1.c(rect), C17336a.r(granularity), new b(inclusionStrategy));
        return iArrC == null ? y.INSTANCE.a() : C17334A.b(iArrC[0], iArrC[1]);
    }
    ...
    public F1.i h(int offset) {
        return this.layout.z(this.layout.q(offset)) == 1 ? F1.i.f8930a : F1.i.f8931b;
    }
    ...
    public long k(int offset) {
        C17819i c17819iI = this.layout.I();
        return C17334A.b(C17818h.b(c17819iI, offset), C17818h.a(c17819iI, offset));
    }
    ...
    public F1.i z(int offset) {
        return this.layout.K(offset) ? F1.i.f8931b : F1.i.f8930a;
    }
    ...
    @Override // u1.InterfaceC17341f
    public void y(Canvas canvas, AbstractC5467i0 brush, float alpha, Shadow shadow, F1.k textDecoration, X0.g drawStyle, int blendMode) {
        int backingBlendMode = I().getBackingBlendMode();
        C1.i iVarI = I();
