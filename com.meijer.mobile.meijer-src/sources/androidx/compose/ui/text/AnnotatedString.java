...
public final class AnnotatedString implements CharSequence, FSComposeAnnotatedString {
    ...
    private static final L0.k<AnnotatedString, ?> f52630f = q.h();
    ...
    public static final class b implements Appendable {
        ...
        public final void f(AnnotatedString text, int start, int end) {
            ...
            List listH = C6055b.h(text, start, end, null, 4, null);
            if (listH != null) {
                int size = listH.size();
                for (int i10 = 0; i10 < size; i10++) {
    ...
    public AnnotatedString(List<? extends Range<? extends a>> list, String str) {
        ...
        J jD = C5618p.d(((Range) CollectionsKt.s0(listZ0)).f());
    ...
    public final List<Range<f>> e(int start, int end) {
        ...
        if (list != null) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                if ((range2.g() instanceof f) && C6055b.i(start, end, range2.h(), range2.f())) {
                    listM.add(range);
                }
            }
        } else {
    ...
    public final List<Range<String>> j(int start, int end) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            Range<? extends a> range = list.get(i10);
            if ((range.g() instanceof t) && C6055b.i(start, end, range.h(), range.f())) {
    ...
    public final List<Range<String>> k(String tag, int start, int end) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            Range<? extends a> range = list.get(i10);
            if ((range.g() instanceof t) && Intrinsics.e(tag, range.getTag()) && C6055b.i(start, end, range.h(), range.f())) {
                arrayList.add(u.a(range));
            }
        }
        return arrayList;
    ...
    public final List<Range<A>> l(int start, int end) {
        ...
        if (list != null) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                Range<? extends a> range = list.get(i10);
                Range<? extends a> range2 = range;
                if ((range2.g() instanceof A) && C6055b.i(start, end, range2.h(), range2.f())) {
                    listM.add(range);
                }
            }
        } else {
    ...
    public final List<Range<UrlAnnotation>> m(int start, int end) {
        ...
        if (list != null) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                Range<? extends a> range = list.get(i10);
                Range<? extends a> range2 = range;
                if ((range2.g() instanceof UrlAnnotation) && C6055b.i(start, end, range2.h(), range2.f())) {
                    listM.add(range);
                }
            }
        } else {
    ...
    public final boolean o(int start, int end) {
        ...
        if (list != null) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                Range<? extends a> range = list.get(i10);
                if ((range.g() instanceof f) && C6055b.i(start, end, range.h(), range.f())) {
                    return true;
                }
            }
        }
    ...
    public AnnotatedString subSequence(int startIndex, int endIndex) {
        ...
        return new AnnotatedString((List<? extends Range<? extends a>>) C6055b.f(this.annotations, startIndex, endIndex), strSubstring);
    }
    ...
    public AnnotatedString(String str, List<Range<SpanStyle>> list, List<Range<ParagraphStyle>> list2) {
        this((List<? extends Range<? extends a>>) C6055b.d(list, list2), str);
    }
