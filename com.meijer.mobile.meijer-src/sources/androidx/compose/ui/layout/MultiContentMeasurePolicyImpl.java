...
public final /* data */ class MultiContentMeasurePolicyImpl implements MeasurePolicy {
    ...
    public int e(InterfaceC5933s interfaceC5933s, List<? extends r> list, int i10) {
        return this.measurePolicy.e(interfaceC5933s, androidx.compose.ui.node.X.a(interfaceC5933s), i10);
    }

    @Override // androidx.compose.ui.layout.MeasurePolicy
    public int g(InterfaceC5933s interfaceC5933s, List<? extends r> list, int i10) {
        return this.measurePolicy.g(interfaceC5933s, androidx.compose.ui.node.X.a(interfaceC5933s), i10);
    }

    @Override // androidx.compose.ui.layout.MeasurePolicy
    public int i(InterfaceC5933s interfaceC5933s, List<? extends r> list, int i10) {
        return this.measurePolicy.i(interfaceC5933s, androidx.compose.ui.node.X.a(interfaceC5933s), i10);
    }

    @Override // androidx.compose.ui.layout.MeasurePolicy
    public int j(InterfaceC5933s interfaceC5933s, List<? extends r> list, int i10) {
        return this.measurePolicy.j(interfaceC5933s, androidx.compose.ui.node.X.a(interfaceC5933s), i10);
    }
