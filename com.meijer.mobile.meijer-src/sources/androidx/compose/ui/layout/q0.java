...
public final class q0 {
    ...
    private final Function2<LayoutNode, AbstractC5869k, Unit> setCompositionContext;
    ...
    static final class b extends Lambda implements Function2<LayoutNode, AbstractC5869k, Unit> {
        b() {
            super(2);
        }

        public final void a(LayoutNode layoutNode, AbstractC5869k abstractC5869k) {
            q0.this.h().H(abstractC5869k);
        }

        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Unit invoke(LayoutNode layoutNode, AbstractC5869k abstractC5869k) {
            a(layoutNode, abstractC5869k);
    ...
    public final Function2<LayoutNode, AbstractC5869k, Unit> e() {
