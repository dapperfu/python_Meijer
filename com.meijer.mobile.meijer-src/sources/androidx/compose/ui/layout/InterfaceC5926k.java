...
public interface InterfaceC5926k {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    public static final Companion INSTANCE = Companion.f51329a;
    ...
    public static final class Companion {
        ...
        static final /* synthetic */ Companion f51329a = new Companion();

        /* renamed from: b, reason: collision with root package name and from kotlin metadata */
        private static final InterfaceC5926k Crop = new C1065a();

        /* renamed from: c, reason: collision with root package name and from kotlin metadata */
        private static final InterfaceC5926k Fit = new e();

        /* renamed from: d, reason: collision with root package name and from kotlin metadata */
        private static final InterfaceC5926k FillHeight = new c();

        /* renamed from: e, reason: collision with root package name and from kotlin metadata */
        private static final InterfaceC5926k FillWidth = new d();

        /* renamed from: f, reason: collision with root package name and from kotlin metadata */
        private static final InterfaceC5926k Inside = new f();

        /* renamed from: g, reason: collision with root package name and from kotlin metadata */
        private static final FixedScale None = new FixedScale(1.0f);

        /* renamed from: h, reason: collision with root package name and from kotlin metadata */
        private static final InterfaceC5926k FillBounds = new b();
        ...
        public static final class b implements InterfaceC5926k {
        ...
        public static final class d implements InterfaceC5926k {
            @Override // androidx.compose.ui.layout.InterfaceC5926k
            public long a(long srcSize, long dstSize) {
                float fIntBitsToFloat = Float.intBitsToFloat((int) (dstSize >> 32)) / Float.intBitsToFloat((int) (srcSize >> 32));
        ...
        public static final class f implements InterfaceC5926k {
            @Override // androidx.compose.ui.layout.InterfaceC5926k
            public long a(long srcSize, long dstSize) {
                ...
                float fD = C5927l.d(srcSize, dstSize);
        ...
        public static final class C1065a implements InterfaceC5926k {
            C1065a() {
            }

            @Override // androidx.compose.ui.layout.InterfaceC5926k
            public long a(long srcSize, long dstSize) {
                float fC = C5927l.c(srcSize, dstSize);
        ...
        public static final class c implements InterfaceC5926k {
            c() {
            }
        ...
        public static final class e implements InterfaceC5926k {
            e() {
            }
        ...
        public final InterfaceC5926k a() {
            return Crop;
        }

        public final InterfaceC5926k b() {
            return FillBounds;
        }

        public final InterfaceC5926k c() {
            return FillHeight;
        }

        public final InterfaceC5926k d() {
            return FillWidth;
        }

        public final InterfaceC5926k e() {
            return Fit;
        }

        public final InterfaceC5926k f() {
            return Inside;
        }
