...
public interface K extends InterfaceC5933s {
    ...
    public static final class b implements J {
        ...
        final /* synthetic */ int f51248e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ K f51249f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function1<f0.a, Unit> f51250g;

        /* JADX WARN: Multi-variable type inference failed */
        b(int i10, int i11, Map<AbstractC5916a, Integer> map, Function1<? super l0, Unit> function1, K k10, Function1<? super f0.a, Unit> function12) {
            this.f51248e = i10;
            this.f51249f = k10;
            this.f51250g = function12;
            this.width = i10;
            this.height = i11;
        ...
        public int getF51588b() {
            return this.height;
        }

        @Override // androidx.compose.ui.layout.J
        /* renamed from: getWidth, reason: from getter */
        public int getF51587a() {
            return this.width;
        }
        ...
        public void s() {
            ...
            if (k10 instanceof androidx.compose.ui.node.Q) {
                this.f51250g.invoke(((androidx.compose.ui.node.Q) k10).getPlacementScope());
            } else {
                this.f51250g.invoke(new o0(this.f51248e, this.f51249f.getLayoutDirection()));
            }
        }
    ...
    default J g1(int width, int height, Map<AbstractC5916a, Integer> alignmentLines, Function1<? super f0.a, Unit> placementBlock) {
    ...
    default J O1(int width, int height, Map<AbstractC5916a, Integer> alignmentLines, Function1<? super l0, Unit> rulers, Function1<? super f0.a, Unit> placementBlock) {
