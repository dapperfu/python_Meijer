...
final class M {
    ...
    public static final M f51252a = new M();
    ...
    private static final class a implements I {
        ...
        public f0 k0(long constraints) {
            if (this.widthHeight == d.f51260a) {
                return new b(this.minMax == c.f51257b ? this.measurable.j0(H1.b.k(constraints)) : this.measurable.d0(H1.b.k(constraints)), H1.b.g(constraints) ? H1.b.k(constraints) : 32767);
            }
            return new b(H1.b.h(constraints) ? H1.b.l(constraints) : 32767, this.minMax == c.f51257b ? this.measurable.A(H1.b.l(constraints)) : this.measurable.W(H1.b.l(constraints)));
        }
    ...
    private static final class c {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final c f51256a = new c("Min", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final c f51257b = new c("Max", 1);

        /* renamed from: c, reason: collision with root package name */
        private static final /* synthetic */ c[] f51258c;

        /* renamed from: d, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f51259d;

        private static final /* synthetic */ c[] a() {
            return new c[]{f51256a, f51257b};
        }
        ...
        public static c[] values() {
            return (c[]) f51258c.clone();
        }

        static {
            c[] cVarArrA = a();
            f51258c = cVarArrA;
            f51259d = EnumEntriesKt.a(cVarArrA);
        }
    ...
    private static final class d {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final d f51260a = new d("Width", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final d f51261b = new d("Height", 1);

        /* renamed from: c, reason: collision with root package name */
        private static final /* synthetic */ d[] f51262c;

        /* renamed from: d, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f51263d;

        private static final /* synthetic */ d[] a() {
            return new d[]{f51260a, f51261b};
        }
        ...
        public static d[] values() {
            return (d[]) f51262c.clone();
        }

        static {
            d[] dVarArrA = a();
            f51262c = dVarArrA;
            f51263d = EnumEntriesKt.a(dVarArrA);
        }
    ...
    public final int a(B modifier, InterfaceC5933s intrinsicMeasureScope, r intrinsicMeasurable, int w10) {
        return modifier.a(new C5936v(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), new a(intrinsicMeasurable, c.f51257b, d.f51261b), H1.c.b(0, w10, 0, 0, 13, null)).getF51588b();
    }

    public final int b(B modifier, InterfaceC5933s intrinsicMeasureScope, r intrinsicMeasurable, int h10) {
        return modifier.a(new C5936v(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), new a(intrinsicMeasurable, c.f51257b, d.f51260a), H1.c.b(0, 0, 0, h10, 7, null)).getF51587a();
    }

    public final int c(B modifier, InterfaceC5933s intrinsicMeasureScope, r intrinsicMeasurable, int w10) {
        return modifier.a(new C5936v(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), new a(intrinsicMeasurable, c.f51256a, d.f51261b), H1.c.b(0, w10, 0, 0, 13, null)).getF51588b();
    }

    public final int d(B modifier, InterfaceC5933s intrinsicMeasureScope, r intrinsicMeasurable, int h10) {
        return modifier.a(new C5936v(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), new a(intrinsicMeasurable, c.f51256a, d.f51260a), H1.c.b(0, 0, 0, h10, 7, null)).getF51587a();
    }
