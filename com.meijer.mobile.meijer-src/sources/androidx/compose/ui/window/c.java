...
public final class c implements MeasurePolicy {
    ...
    public static final class a extends Lambda implements Function1<f0.a, Unit> {
        ...
        public static final a f53144f = new a();
    ...
    public static final class b extends Lambda implements Function1<f0.a, Unit> {
        ...
        public final void a(f0.a aVar) {
            f0.a.l(aVar, this.f53145f, 0, 0, 0.0f, 4, null);
        }
    ...
    public static final class C1098c extends Lambda implements Function1<f0.a, Unit> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ List<f0> f53146f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C1098c(List<? extends f0> list) {
            super(1);
            this.f53146f = list;
        }

        public final void a(f0.a aVar) {
            int iO = CollectionsKt.o(this.f53146f);
            if (iO < 0) {
                return;
            }
            int i10 = 0;
            while (true) {
                f0.a aVar2 = aVar;
                f0.a.l(aVar2, this.f53146f.get(i10), 0, 0, 0.0f, 4, null);
                if (i10 == iO) {
                    return;
                }
                i10++;
