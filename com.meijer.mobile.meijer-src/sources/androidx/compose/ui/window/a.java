...
public final class a {
    ...
    static final class C1092a extends Lambda implements Function1<F, E> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ j f53089f;
        ...
        public static final class C1093a implements E {
            ...
            final /* synthetic */ j f53090a;

            public C1093a(j jVar) {
                this.f53090a = jVar;
            }

            @Override // androidx.compose.runtime.E
            public void dispose() {
                this.f53090a.dismiss();
                this.f53090a.h();
            }
        }
        ...
        public final E invoke(F f10) {
            this.f53089f.show();
            return new C1093a(this.f53089f);
        }
    }
    ...
    static final class b extends Lambda implements Function0<Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ j f53091f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f53092g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ h f53093h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ t f53094i;
        ...
        public final void invoke2() {
            this.f53091f.l(this.f53092g, this.f53093h, this.f53094i);
        }
    }
    ...
    static final class c extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f53095f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ h f53096g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Function2<Composer, Integer, Unit> f53097h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ int f53098i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ int f53099j;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        c(Function0<Unit> function0, h hVar, Function2<? super Composer, ? super Integer, Unit> function2, int i10, int i11) {
            super(2);
            this.f53095f = function0;
            this.f53096g = hVar;
            this.f53097h = function2;
            this.f53098i = i10;
            this.f53099j = i11;
        }

        public final void a(Composer composer, int i10) {
            a.a(this.f53095f, this.f53096g, this.f53097h, composer, J0.a(this.f53098i | 1), this.f53099j);
        }
    ...
    static final class d extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ z1<Function2<Composer, Integer, Unit>> f53100f;

        @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"Lr1/u;", "", "a", "(Lr1/u;)V"}, k = 3, mv = {1, 9, 0})
        /* renamed from: androidx.compose.ui.window.a$d$a, reason: collision with other inner class name */
        static final class C1094a extends Lambda implements Function1<u, Unit> {

            /* renamed from: f, reason: collision with root package name */
            public static final C1094a f53101f = new C1094a();
        ...
        public final void a(Composer composer, int i10) {
            ...
            a.c(C16819m.d(Modifier.INSTANCE, false, C1094a.f53101f, 1, null), a.b(this.f53100f), composer, 0, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class f implements MeasurePolicy {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final f f53103a = new f();

        @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"Landroidx/compose/ui/layout/f0$a;", "", "a", "(Landroidx/compose/ui/layout/f0$a;)V"}, k = 3, mv = {1, 9, 0})
        @SourceDebugExtension
        /* renamed from: androidx.compose.ui.window.a$f$a, reason: collision with other inner class name */
        static final class C1095a extends Lambda implements Function1<f0.a, Unit> {

            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ List<f0> f53104f;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C1095a(List<? extends f0> list) {
                super(1);
                this.f53104f = list;
            }

            public final void a(f0.a aVar) {
                List<f0> list = this.f53104f;
                int size = list.size();
        ...
        public final J d(K k10, List<? extends I> list, long j10) {
            ...
            return K.G0(k10, iN, iM, null, new C1095a(arrayList), 4, null);
        }
    }
    ...
    static final class g extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Modifier f53105f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function2<Composer, Integer, Unit> f53106g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f53107h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ int f53108i;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        g(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, int i10, int i11) {
            super(2);
            this.f53105f = modifier;
            this.f53106g = function2;
            this.f53107h = i10;
            this.f53108i = i11;
        }

        public final void a(Composer composer, int i10) {
            a.c(this.f53105f, this.f53106g, composer, J0.a(this.f53107h | 1), this.f53108i);
        }
    ...
    static final class e extends Lambda implements Function0<UUID> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final e f53102f = new e();
