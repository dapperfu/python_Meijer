...
public final /* data */ class PointerHoverIconModifierElement extends Y<C14318v> {
    ...
    public C14318v b() {
        return new C14318v(this.icon, this.overrideDescendants);
    }

    @Override // androidx.compose.ui.node.Y
    /* renamed from: n, reason: merged with bridge method [inline-methods] */
    public void e(C14318v node) {
        node.Y2(this.icon);
        node.Z2(this.overrideDescendants);
    }

    public PointerHoverIconModifierElement(InterfaceC14319w interfaceC14319w, boolean z10) {
