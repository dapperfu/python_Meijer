...
public final class g implements e {
    ...
    private long ambientShadowColor = C5456e1.a();

    /* renamed from: i, reason: collision with root package name and from kotlin metadata */
    private long spotShadowColor = C5456e1.a();
    ...
    public void E(long j10) {
        if (C5489q0.s(this.spotShadowColor, j10)) {
            return;
        }
    ...
    public final AbstractC5480m1 getOutline() {
        return this.outline;
    }
    ...
    public void z(long j10) {
        if (C5489q0.s(this.ambientShadowColor, j10)) {
            return;
        }
