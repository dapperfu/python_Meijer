...
public final class ViewLayer extends View implements FSDispatchDraw {
    ...
    private static final ViewOutlineProvider f51033l = new a();
    ...
    public final boolean d(Outline outline) {
        ...
        return g.f51153a.a(this);
    }

    @Override // android.view.View
    protected void dispatchDraw(Canvas canvas) {
        C5473k0 c5473k0 = this.canvasHolder;
        Canvas canvasZ = c5473k0.getAndroidCanvas().getInternalCanvas();
    ...
    public final C5473k0 getCanvasHolder() {
    ...
    public ViewLayer(View view, C5473k0 c5473k0, X0.a aVar) {
        super(view.getContext());
        this.ownerView = view;
        this.canvasHolder = c5473k0;
        this.canvasDrawScope = aVar;
        setOutlineProvider(f51033l);
        this.canUseCompositingLayer = true;
        this.density = X0.e.a();
        this.layoutDirection = t.f13338a;
