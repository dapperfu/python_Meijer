...
public final class d implements b {
    ...
    public d(long j10, C5473k0 c5473k0, X0.a aVar) {
        this.ownerId = j10;
    ...
    public void E(long j10) {
        ...
        this.renderNode.setSpotShadowColor(C5492s0.j(j10));
    }
    ...
    public void g(y1 y1Var) {
        if (Build.VERSION.SDK_INT >= 31) {
            F.f42771a.a(this.renderNode, y1Var);
        }
    }
    ...
    public void x(H1.d density, t layoutDirection, GraphicsLayer layer, Function1<? super X0.f, Unit> block) {
        ...
        try {
            ...
            c5473k0.getAndroidCanvas().A(recordingCanvasBeginRecording);
    ...
    public void z(long j10) {
        ...
        this.renderNode.setAmbientShadowColor(C5492s0.j(j10));
    }
    ...
    public /* synthetic */ d(long j10, C5473k0 c5473k0, X0.a aVar, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(j10, (i10 & 2) != 0 ? new C5473k0() : c5473k0, (i10 & 4) != 0 ? new X0.a() : aVar);
    }
}
