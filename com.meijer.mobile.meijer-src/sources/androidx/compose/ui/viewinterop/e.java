...
public final class e {
    ...
    private static final Function1<View, Unit> f53015a = h.f53033f;

    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    static final class a extends Lambda implements Function2<Composer, Integer, Unit> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function1<Context, T> f53016f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Modifier f53017g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Function1<T, Unit> f53018h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ int f53019i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ int f53020j;
        ...
        a(Function1<? super Context, ? extends T> function1, Modifier modifier, Function1<? super T, Unit> function12, int i10, int i11) {
            super(2);
            this.f53016f = function1;
            this.f53017g = modifier;
            this.f53018h = function12;
            this.f53019i = i10;
            this.f53020j = i11;
        }

        public final void a(Composer composer, int i10) {
            e.a(this.f53016f, this.f53017g, this.f53018h, composer, J0.a(this.f53019i | 1), this.f53020j);
        }
    ...
    static final class C1091e<T> extends Lambda implements Function2<LayoutNode, Function1<? super T, ? extends Unit>, Unit> {

        /* renamed from: f, reason: collision with root package name */
        public static final C1091e f53024f = new C1091e();
    ...
    static final class f<T> extends Lambda implements Function2<LayoutNode, Function1<? super T, ? extends Unit>, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final f f53025f = new f();
    ...
    static final class g extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function1<Context, T> f53026f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Modifier f53027g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Function1<T, Unit> f53028h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ Function1<T, Unit> f53029i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ Function1<T, Unit> f53030j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ int f53031k;

        /* renamed from: l, reason: collision with root package name */
        final /* synthetic */ int f53032l;
        ...
        g(Function1<? super Context, ? extends T> function1, Modifier modifier, Function1<? super T, Unit> function12, Function1<? super T, Unit> function13, Function1<? super T, Unit> function14, int i10, int i11) {
            super(2);
            this.f53026f = function1;
            this.f53027g = modifier;
            this.f53028h = function12;
            this.f53029i = function13;
            this.f53030j = function14;
            this.f53031k = i10;
            this.f53032l = i11;
        }

        public final void a(Composer composer, int i10) {
            e.b(this.f53026f, this.f53027g, this.f53028h, this.f53029i, this.f53030j, composer, J0.a(this.f53031k | 1), this.f53032l);
        }
    ...
    static final class h extends Lambda implements Function1<View, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final h f53033f = new h();
    ...
    static final class i extends Lambda implements Function0<LayoutNode> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Context f53034f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function1<Context, T> f53035g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ AbstractC5869k f53036h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ L0.h f53037i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ int f53038j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ View f53039k;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        i(Context context, Function1<? super Context, ? extends T> function1, AbstractC5869k abstractC5869k, L0.h hVar, int i10, View view) {
            super(0);
            this.f53034f = context;
            this.f53035g = function1;
            this.f53036h = abstractC5869k;
            this.f53037i = hVar;
            this.f53038j = i10;
            this.f53039k = view;
        }
        ...
        public final LayoutNode invoke() {
            Context context = this.f53034f;
            Function1<Context, T> function1 = this.f53035g;
            AbstractC5869k abstractC5869k = this.f53036h;
            L0.h hVar = this.f53037i;
            int i10 = this.f53038j;
            KeyEvent.Callback callback = this.f53039k;
            Intrinsics.h(callback, "null cannot be cast to non-null type androidx.compose.ui.node.Owner");
            return new ViewFactoryHolder(context, function1, abstractC5869k, hVar, i10, (Owner) callback).getLayoutNode();
        }
    }
    ...
    static final class j extends Lambda implements Function2<LayoutNode, Modifier, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final j f53040f = new j();
    ...
    static final class k extends Lambda implements Function2<LayoutNode, H1.d, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final k f53041f = new k();
    ...
    static final class l extends Lambda implements Function2<LayoutNode, InterfaceC6172s, Unit> {

        /* renamed from: f, reason: collision with root package name */
        public static final l f53042f = new l();
        ...
        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Unit invoke(LayoutNode layoutNode, InterfaceC6172s interfaceC6172s) {
            a(layoutNode, interfaceC6172s);
            return Unit.f143329a;
        }

        public final void a(LayoutNode layoutNode, InterfaceC6172s interfaceC6172s) {
            e.f(layoutNode).setLifecycleOwner(interfaceC6172s);
        }
    }
    ...
    static final class m extends Lambda implements Function2<LayoutNode, InterfaceC18089i, Unit> {

        /* renamed from: f, reason: collision with root package name */
        public static final m f53043f = new m();
        ...
        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Unit invoke(LayoutNode layoutNode, InterfaceC18089i interfaceC18089i) {
            a(layoutNode, interfaceC18089i);
            return Unit.f143329a;
        }

        public final void a(LayoutNode layoutNode, InterfaceC18089i interfaceC18089i) {
            e.f(layoutNode).setSavedStateRegistryOwner(interfaceC18089i);
        }
    }
    ...
    static final class n extends Lambda implements Function2<LayoutNode, t, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final n f53044f = new n();
    ...
    public static final <T extends View> void a(Function1<? super Context, ? extends T> function1, Modifier modifier, Function1<? super T, Unit> function12, Composer composer, int i10, int i11) {
        ...
        if (composerStartRestartGroup.p((i12 & 147) != 146, i12 & 1)) {
            ...
            Function1<? super T, Unit> function14 = i14 != 0 ? f53015a : function12;
            if (ComposerKt.M()) {
                ComposerKt.U(-1783766393, i12, -1, "androidx.compose.ui.viewinterop.AndroidView (AndroidView.android.kt:104)");
            }
            b(function1, modifier3, null, f53015a, function14, composerStartRestartGroup, (i12 & 14) | 3072 | (i12 & 112) | (57344 & (i12 << 6)), 4);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
            modifier2 = modifier3;
    ...
    */
    ...
    private static final <T extends View> void g(Composer composer, Modifier modifier, int i10, H1.d dVar, InterfaceC6172s interfaceC6172s, InterfaceC18089i interfaceC18089i, t tVar, InterfaceC5884s interfaceC5884s) {
        InterfaceC5953g.Companion companion = InterfaceC5953g.INSTANCE;
        D1.c(composer, interfaceC5884s, companion.g());
        D1.c(composer, modifier, j.f53040f);
        D1.c(composer, dVar, k.f53041f);
        D1.c(composer, interfaceC6172s, l.f53042f);
        D1.c(composer, interfaceC18089i, m.f53043f);
        D1.c(composer, tVar, n.f53044f);
    ...
    private static final <T extends View> Function0<LayoutNode> d(Function1<? super Context, ? extends T> function1, Composer composer, int i10) {
        ...
        boolean zD2 = zD | z10 | composer.D(abstractC5869kD) | composer.D(hVar) | composer.d(iA) | composer.D(view);
        Object objB = composer.B();
        if (zD2 || objB == Composer.INSTANCE.a()) {
            Object iVar = new i(context, function1, abstractC5869kD, hVar, iA, view);
            composer.t(iVar);
            objB = iVar;
        }
