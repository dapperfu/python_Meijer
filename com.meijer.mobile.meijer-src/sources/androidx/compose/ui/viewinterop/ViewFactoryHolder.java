...
public final class ViewFactoryHolder<T extends View> extends AndroidViewHolder implements T1 {
    ...
    static final class a extends Lambda implements Function0<Object> {
        ...
        final /* synthetic */ ViewFactoryHolder<T> f52985f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(ViewFactoryHolder<T> viewFactoryHolder) {
            super(0);
            this.f52985f = viewFactoryHolder;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            SparseArray<Parcelable> sparseArray = new SparseArray<>();
            ((ViewFactoryHolder) this.f52985f).typedView.saveHierarchyState(sparseArray);
            return sparseArray;
        }
    }
    ...
    static final class b extends Lambda implements Function0<Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ ViewFactoryHolder<T> f52986f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(ViewFactoryHolder<T> viewFactoryHolder) {
            super(0);
            this.f52986f = viewFactoryHolder;
        }
        ...
        public final void invoke2() {
            this.f52986f.getReleaseBlock().invoke(((ViewFactoryHolder) this.f52986f).typedView);
            this.f52986f.I();
        }
    }
    ...
    static final class c extends Lambda implements Function0<Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ ViewFactoryHolder<T> f52987f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        c(ViewFactoryHolder<T> viewFactoryHolder) {
            super(0);
            this.f52987f = viewFactoryHolder;
        }
        ...
        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final void invoke2() {
            this.f52987f.getResetBlock().invoke(((ViewFactoryHolder) this.f52987f).typedView);
        }
    }
    ...
    static final class d extends Lambda implements Function0<Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ ViewFactoryHolder<T> f52988f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        d(ViewFactoryHolder<T> viewFactoryHolder) {
            super(0);
            this.f52988f = viewFactoryHolder;
        }
        ...
        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final void invoke2() {
            this.f52988f.getUpdateBlock().invoke(((ViewFactoryHolder) this.f52988f).typedView);
        }
    }

    /* synthetic */ ViewFactoryHolder(Context context, AbstractC5869k abstractC5869k, View view, C13939b c13939b, L0.h hVar, int i10, Owner owner, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i11 & 2) != 0 ? null : abstractC5869k, view, (i11 & 8) != 0 ? new C13939b() : c13939b, hVar, i10, owner);
    }
    ...
    public final C13939b getDispatcher() {
    ...
    private ViewFactoryHolder(Context context, AbstractC5869k abstractC5869k, T t10, C13939b c13939b, L0.h hVar, int i10, Owner owner) {
        super(context, abstractC5869k, i10, c13939b, t10, owner);
        this.typedView = t10;
    ...
    public ViewFactoryHolder(Context context, Function1<? super Context, ? extends T> function1, AbstractC5869k abstractC5869k, L0.h hVar, int i10, Owner owner) {
        this(context, abstractC5869k, function1.invoke(context), null, hVar, i10, owner, 8, null);
    }
}
