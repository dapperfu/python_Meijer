...
import androidx.compose.ui.focus.C5915p;
...
public final class f {
    ...
    public static final Modifier e(Modifier modifier) {
        return C5915p.a(C5915p.a(modifier.then(FocusGroupPropertiesElement.f52974b)).then(FocusTargetPropertiesElement.f52975b));
    }
    ...
    public static final View g(Modifier.c cVar) {
        View viewR = C5957k.o(cVar.getNode()).R();
        if (viewR != null) {
            return viewR;
        }
