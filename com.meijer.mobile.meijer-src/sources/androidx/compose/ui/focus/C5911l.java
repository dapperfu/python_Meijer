...
import androidx.compose.ui.focus.C5910k;
...
public final class C5911l {
    public static final C5905f d(int i10) {
        if (i10 == 1) {
            return C5905f.i(C5905f.INSTANCE.f());
        }
        if (i10 == 2) {
            return C5905f.i(C5905f.INSTANCE.e());
        }
        if (i10 == 17) {
            return C5905f.i(C5905f.INSTANCE.d());
        }
        if (i10 == 33) {
            return C5905f.i(C5905f.INSTANCE.h());
        }
        if (i10 == 66) {
            return C5905f.i(C5905f.INSTANCE.g());
        }
        if (i10 != 130) {
            return null;
        }
        return C5905f.i(C5905f.INSTANCE.a());
    }

    public static final Rect a(View view, View view2) {
        C5910k.Companion companion = C5910k.INSTANCE;
    ...
    public static final Integer c(int i10) {
        ...
        return C5905f.l(i10, companion.f()) ? 1 : null;
    }
