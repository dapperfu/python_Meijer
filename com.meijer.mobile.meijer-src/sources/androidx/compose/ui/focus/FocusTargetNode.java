...
public final class FocusTargetNode extends Modifier.c implements InterfaceC5954h, G, i0, k1.h {
    ...
    public /* synthetic */ class a {
        ...
        static {
            ...
            try {
                iArr[EnumC5902c.f50865a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[EnumC5902c.f50867c.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[EnumC5902c.f50866b.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[EnumC5902c.f50868d.ordinal()] = 4;
            ...
            try {
                iArr2[F.f50802c.ordinal()] = 2;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                iArr2[F.f50801b.ordinal()] = 3;
    ...
    static final class b extends Lambda implements Function0<Unit> {
        ...
        final /* synthetic */ Ref.ObjectRef<u> f50836f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ FocusTargetNode f50837g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(Ref.ObjectRef<u> objectRef, FocusTargetNode focusTargetNode) {
            super(0);
            this.f50836f = objectRef;
            this.f50837g = focusTargetNode;
        }
        ...
        public final void invoke2() {
            this.f50836f.f143742a = this.f50837g.R2();
        }
    }
    ...
    private static final boolean V2(FocusTargetNode focusTargetNode) {
        ...
        if (child == null) {
            C5957k.c(cVar, focusTargetNode.getNode(), false);
        } else {
            cVar.c(child);
        }
    ...
    public final void P2() {
        ...
        int iA = C5952f0.a(RecyclerView.m.FLAG_APPEARED_IN_PRE_LAYOUT);
                ...
                while (node2 != null) {
                    if ((node2.getKindSet() & i10) != 0) {
                        ...
                        if ((node2.getKindSet() & iA) != 0) {
                            AbstractC5959m abstractC5959mH = node2;
                            D0.c cVar = null;
                            while (abstractC5959mH != 0) {
                                if (abstractC5959mH instanceof InterfaceC5908i) {
                                    InterfaceC5908i interfaceC5908i = (InterfaceC5908i) abstractC5959mH;
                                    interfaceC5908i.U(C5909j.a(interfaceC5908i));
    ...
    public final u R2() {
        ...
        int iA = C5952f0.a(RecyclerView.m.FLAG_MOVED);
        int iA2 = C5952f0.a(1024);
        Modifier.c node = getNode();
        int i10 = iA | iA2;
        if (!getNode().getIsAttached()) {
                ...
                while (node2 != null) {
                    if ((node2.getKindSet() & i10) != 0) {
                        ...
                        if ((node2.getKindSet() & iA) != 0) {
                            ...
                            D0.c cVar = null;
                            while (abstractC5959mH != 0) {
                                if (abstractC5959mH instanceof w) {
                                    ((w) abstractC5959mH).j1(vVar);
                                } else if ((abstractC5959mH.getKindSet() & iA) != 0 && (abstractC5959mH instanceof AbstractC5959m)) {
                                    Modifier.c delegate = abstractC5959mH.getDelegate();
                                    int i11 = 0;
                                    abstractC5959mH = abstractC5959mH;
    ...
    public F d0() {
        ...
        if (this == focusTargetNodeH) {
            return focusOwner.m() ? F.f50802c : F.f50800a;
        }
    ...
    public final void O2() {
        ...
        if (fJ != null) {
            ...
            C14920a.c("committing a node that was not updated in the current transaction");
            throw new KotlinNothingValueException();
        }
    }

    public final InterfaceC5923h S2() {
        return (InterfaceC5923h) q(C5924i.a());
    }
            ...
            if (!P0.h.isTrackFocusEnabled) {
                ...
                try {
                    ...
                    if (initialFocusState == null) {
                        if (W2(this) && V2(this)) {
                            initialFocusState = F.f50801b;
                        } else {
                            initialFocusState = F.f50803d;
                        }
                    }
    ...
    public final void Z2() {
        ...
        if (i10 == 1 || i10 == 2) {
            ...
            if (!uVar.getCanFocus()) {
                C5957k.p(this).getFocusOwner().v(true);
            }
        }
    }
    ...
    public void u2() {
        ...
        if (i10 != 1 && i10 != 2) {
            ...
            s focusOwner = C5957k.p(this).getFocusOwner();
            focusOwner.n(true, true, false, C5905f.INSTANCE.c());
            if (P0.h.isTrackFocusEnabled) {
                focusOwner.j();
            } else {
                I.b(this);
