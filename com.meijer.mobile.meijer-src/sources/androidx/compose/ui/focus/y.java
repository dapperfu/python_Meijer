...
public final class y {
    ...
    private static final y f50914c = new y();

    /* renamed from: d, reason: collision with root package name */
    private static final y f50915d = new y();

    /* renamed from: e, reason: collision with root package name */
    private static final y f50916e = new y();
    ...
    static final class b extends Lambda implements Function1<FocusTargetNode, Boolean> {
        ...
        public final Boolean invoke(FocusTargetNode focusTargetNode) {
            return Boolean.valueOf(focusTargetNode.W(this.f50918f));
        }
    }

    public static /* synthetic */ boolean h(y yVar, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            i10 = C5905f.INSTANCE.b();
        }
        return yVar.g(i10);
    }
