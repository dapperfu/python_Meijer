...
public final class FocusOwnerImpl implements s {
    ...
    private final Function2<C5905f, Rect, Boolean> onRequestFocusForOwner;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final Function1<C5905f, Boolean> onMoveFocusInterop;
    ...
    private final C5912m focusInvalidationManager;
    ...
    private final Modifier modifier = new Y<FocusTargetNode>() { // from class: androidx.compose.ui.focus.FocusOwnerImpl$modifier$1
        ...
        public int hashCode() {
            return this.f50826b.getRootFocusNode().hashCode();
        }

        @Override // androidx.compose.ui.node.Y
        /* renamed from: k, reason: merged with bridge method [inline-methods] */
        public FocusTargetNode getNode() {
            return this.f50826b.getRootFocusNode();
        }
    };

    /* renamed from: k, reason: collision with root package name and from kotlin metadata */
    private final T<InterfaceC5913n> listeners = new T<>(1);
    ...
    public /* synthetic */ class a {
        ...
        static {
            int[] iArr = new int[EnumC5902c.values().length];
            try {
                iArr[EnumC5902c.f50867c.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[EnumC5902c.f50866b.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[EnumC5902c.f50868d.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[EnumC5902c.f50865a.ordinal()] = 4;
    ...
    static final class b extends Lambda implements Function0<Unit> {
        ...
        public static final b f50819f = new b();
    ...
    static final class f extends Lambda implements Function1<FocusTargetNode, Boolean> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ FocusTargetNode f50820f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ FocusOwnerImpl f50821g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Function1<FocusTargetNode, Boolean> f50822h;
        ...
        f(FocusTargetNode focusTargetNode, FocusOwnerImpl focusOwnerImpl, Function1<? super FocusTargetNode, Boolean> function1) {
            super(1);
            this.f50820f = focusTargetNode;
            this.f50821g = focusOwnerImpl;
            this.f50822h = function1;
        }
        ...
        public final Boolean invoke(FocusTargetNode focusTargetNode) {
            ...
            if (Intrinsics.e(focusTargetNode, this.f50820f)) {
                zBooleanValue = false;
            } else {
                if (Intrinsics.e(focusTargetNode, this.f50821g.getRootFocusNode())) {
                    throw new IllegalStateException("Focus search landed at the root.");
                }
                zBooleanValue = this.f50822h.invoke(focusTargetNode).booleanValue();
            }
    ...
    static final class g extends Lambda implements Function1<FocusTargetNode, Boolean> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Ref.ObjectRef<Boolean> f50823f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f50824g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        g(Ref.ObjectRef<Boolean> objectRef, int i10) {
            super(1);
            this.f50823f = objectRef;
            this.f50824g = i10;
        }
        ...
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final Boolean invoke(FocusTargetNode focusTargetNode) {
            this.f50823f.f143742a = Boolean.valueOf(focusTargetNode.W(this.f50824g));
            Boolean bool = this.f50823f.f143742a;
    ...
    static final class h extends Lambda implements Function1<FocusTargetNode, Boolean> {
        ...
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final Boolean invoke(FocusTargetNode focusTargetNode) {
            return Boolean.valueOf(focusTargetNode.W(this.f50825f));
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void B() {
        if ((P0.h.isTrackFocusEnabled && getActiveFocusTargetNode() == null) || this.rootFocusNode.d0() == F.f50803d) {
            this.onClearFocusForOwner.invoke();
        }
    }

    private final Modifier.c C(InterfaceC5956j interfaceC5956j) {
        int iA = C5952f0.a(1024) | C5952f0.a(8192);
        if (!interfaceC5956j.getNode().getIsAttached()) {
            C14920a.b("visitLocalDescendants called on an unattached node");
        }
        Modifier.c node = interfaceC5956j.getNode();
        ...
        if ((node.getAggregateChildKindSet() & iA) != 0) {
            for (Modifier.c child = node.getChild(); child != null; child = child.getChild()) {
                if ((child.getKindSet() & iA) != 0) {
                    if ((C5952f0.a(1024) & child.getKindSet()) != 0) {
                        return cVar;
                    }
                    cVar = child;
                }
    ...
    public void D(boolean z10) {
        if (!((z10 && getActiveFocusTargetNode() == null) ? false : true)) {
            C14920a.a("Cannot capture focus when the active focus target node is unset");
        }
    ...
    @Override // androidx.compose.ui.focus.s
    public void b(InterfaceC5908i node) {
    ...
    public boolean c(RotaryScrollEvent event, Function0<Boolean> onFocusedItem) {
        ...
        int size;
        C5946c0 nodes;
        AbstractC5959m abstractC5959mH;
        C5946c0 nodes2;
        ...
        if (focusTargetNodeZ != null) {
            ...
            LayoutNode layoutNodeO = C5957k.o(focusTargetNodeZ);
            loop0: while (true) {
                if (layoutNodeO == null) {
                    abstractC5959mH = 0;
                    break;
                ...
                if ((layoutNodeO.getNodes().getHead().getAggregateChildKindSet() & iA) != 0) {
                    while (node != null) {
                        if ((node.getKindSet() & iA) != 0) {
                            D0.c cVar = null;
                            abstractC5959mH = node;
                            while (abstractC5959mH != 0) {
                                if (abstractC5959mH instanceof InterfaceC14593a) {
                                    break loop0;
                                }
            ...
            interfaceC14593a = (InterfaceC14593a) abstractC5959mH;
        } else {
            interfaceC14593a = null;
        }
        if (interfaceC14593a != null) {
            int iA2 = C5952f0.a(16384);
            if (!interfaceC14593a.getNode().getIsAttached()) {
                C14920a.b("visitAncestors called on an unattached node");
            }
            Modifier.c parent = interfaceC14593a.getNode().getParent();
            LayoutNode layoutNodeO2 = C5957k.o(interfaceC14593a);
                ...
                if ((layoutNodeO2.getNodes().getHead().getAggregateChildKindSet() & iA2) != 0) {
                    while (parent != null) {
                        if ((parent.getKindSet() & iA2) != 0) {
                            ...
                            D0.c cVar2 = null;
                            while (cVarH != null) {
                                if (cVarH instanceof InterfaceC14593a) {
                                    if (arrayList == null) {
                                        arrayList = new ArrayList();
                                    }
                                    arrayList.add(cVarH);
                                } else if ((cVarH.getKindSet() & iA2) != 0 && (cVarH instanceof AbstractC5959m)) {
                                    int i11 = 0;
            ...
            if (arrayList != null && arrayList.size() - 1 >= 0) {
                while (true) {
                    int i12 = size - 1;
                    if (((InterfaceC14593a) arrayList.get(size)).Y1(event)) {
                        return true;
                    }
                    if (i12 < 0) {
                        break;
            ...
            AbstractC5959m node2 = interfaceC14593a.getNode();
            D0.c cVar3 = null;
            while (node2 != 0) {
                if (node2 instanceof InterfaceC14593a) {
                    if (((InterfaceC14593a) node2).Y1(event)) {
                        return true;
                    }
                ...
                node2 = C5957k.h(cVar3);
            }
            if (onFocusedItem.invoke().booleanValue()) {
                return true;
            }
            AbstractC5959m node3 = interfaceC14593a.getNode();
            D0.c cVar4 = null;
            while (node3 != 0) {
                if (node3 instanceof InterfaceC14593a) {
                    if (((InterfaceC14593a) node3).X(event)) {
                        return true;
                    }
                } else if ((node3.getKindSet() & iA2) != 0 && (node3 instanceof AbstractC5959m)) {
                ...
                node3 = C5957k.h(cVar4);
            }
            if (arrayList != null) {
                int size2 = arrayList.size();
                for (int i15 = 0; i15 < size2; i15++) {
                    if (((InterfaceC14593a) arrayList.get(i15)).X(event)) {
                        return true;
                    }
                }
            }
    ...
    @Override // androidx.compose.ui.focus.InterfaceC5914o
    public boolean e(int focusDirection) {
        if (P0.h.isViewFocusFixEnabled && this.onMoveFocusInterop.invoke(C5905f.i(focusDirection)).booleanValue()) {
            return true;
        }
        Ref.ObjectRef objectRef = new Ref.ObjectRef();
        objectRef.f143742a = Boolean.FALSE;
        ...
        if (boolW != null && objectRef.f143742a != 0) {
            if (Intrinsics.e(boolW, bool) && Intrinsics.e(objectRef.f143742a, bool)) {
                return true;
            }
    ...
    public boolean g(KeyEvent keyEvent) {
        ...
        if (focusTargetNodeB != null) {
                ...
                if ((layoutNodeO.getNodes().getHead().getAggregateChildKindSet() & iA) != 0) {
                    while (node != null) {
                        if ((node.getKindSet() & iA) != 0) {
                            ...
                            abstractC5959mH = node;
                            while (abstractC5959mH != 0) {
                                if (abstractC5959mH instanceof e1.g) {
                                    break loop0;
                                }
                                if ((abstractC5959mH.getKindSet() & iA) != 0 && (abstractC5959mH instanceof AbstractC5959m)) {
                                    Modifier.c delegate = abstractC5959mH.getDelegate();
            ...
            gVar = (e1.g) abstractC5959mH;
        } else {
            gVar = null;
        }
        if (gVar != null) {
            int iA2 = C5952f0.a(131072);
            if (!gVar.getNode().getIsAttached()) {
                C14920a.b("visitAncestors called on an unattached node");
            }
            Modifier.c parent = gVar.getNode().getParent();
            LayoutNode layoutNodeO2 = C5957k.o(gVar);
            ArrayList arrayList = null;
            while (layoutNodeO2 != null) {
                if ((layoutNodeO2.getNodes().getHead().getAggregateChildKindSet() & iA2) != 0) {
                    while (parent != null) {
            ...
            AbstractC5959m node2 = gVar.getNode();
            D0.c cVar3 = null;
            while (node2 != 0) {
            ...
            AbstractC5959m node3 = gVar.getNode();
            D0.c cVar4 = null;
            while (node3 != 0) {
    ...
    */
    public boolean n(boolean r8, boolean r9, boolean r10, int r11) {
        ...
        L31:
            ...
            androidx.compose.ui.focus.FocusOwnerImpl$b r5 = androidx.compose.ui.focus.FocusOwnerImpl.b.f50819f
    ...
    public void r(FocusTargetNode focusTargetNode) {
        ...
        if (P0.h.isSemanticAutofillEnabled) {
            T<InterfaceC5913n> t10 = t();
            Object[] objArr = t10.content;
            int i10 = t10._size;
            for (int i11 = 0; i11 < i10; i11++) {
                ((InterfaceC5913n) objArr[i11]).b(focusTargetNode2, focusTargetNode);
            }
        }
    }
    ...
    @Override // androidx.compose.ui.focus.s
    public T<InterfaceC5913n> t() {
        return this.listeners;
    }

    @Override // androidx.compose.ui.focus.s
    public boolean u(C5905f focusDirection, Rect previouslyFocusedRect) {
        return this.onRequestFocusForOwner.invoke(focusDirection, previouslyFocusedRect).booleanValue();
    }

    @Override // androidx.compose.ui.focus.InterfaceC5914o
    public void v(boolean force) {
        n(force, true, true, C5905f.INSTANCE.c());
    }

    /* JADX WARN: Multi-variable type inference failed */
    public FocusOwnerImpl(Function1<? super Function0<Unit>, Unit> function1, Function2<? super C5905f, ? super Rect, Boolean> function2, Function1<? super C5905f, Boolean> function12, Function0<Unit> function0, Function0<Rect> function02, Function0<? extends H1.t> function03) {
        ...
        this.focusInvalidationManager = new C5912m(function1, new c(this), new PropertyReference0Impl(this) { // from class: androidx.compose.ui.focus.FocusOwnerImpl.d
    ...
    private final boolean y(boolean forced, boolean refreshFocusEvents) {
        ...
        if (refreshFocusEvents && activeFocusTargetNode != null) {
            ...
            activeFocusTargetNode.Q2(f10, F.f50803d);
            ...
            LayoutNode layoutNodeO = C5957k.o(activeFocusTargetNode);
                        ...
                        if ((parent.getKindSet() & iA) != 0) {
                            ...
                            while (cVarH != null) {
                                if (cVarH instanceof FocusTargetNode) {
                                    ((FocusTargetNode) cVarH).Q2(F.f50801b, F.f50803d);
