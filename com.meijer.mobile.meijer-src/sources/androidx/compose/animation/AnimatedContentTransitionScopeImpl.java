...
public final class AnimatedContentTransitionScopeImpl<S> implements d<S> {
    ...
    private final InterfaceC5872l0 measuredSize = t1.e(r.b(r.INSTANCE.a()), null, 2, null);
    ...
    private static final class SizeModifierElement<S> extends Y<b<S>> {
        ...
        public int hashCode() {
            ...
            k0<S>.a<r, C6457n> aVar = this.sizeAnimation;
        ...
        public SizeModifierElement(k0<S>.a<r, C6457n> aVar, z1<? extends u> z1Var, AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl) {
    ...
    @Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\t\b\u0000\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u001d\u0010\t\u001a\u00020\u0007*\u00020\u00062\b\u0010\b\u001a\u0004\u0018\u00010\u0007H\u0016¢\u0006\u0004\b\t\u0010\nR+\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u000b\u001a\u00020\u00028F@FX\u0086\u008e\u0002¢\u0006\u0012\n\u0004\b\f\u0010\r\u001a\u0004\b\f\u0010\u000e\"\u0004\b\u000f\u0010\u0005¨\u0006\u0010"}, d2 = {"Landroidx/compose/animation/AnimatedContentTransitionScopeImpl$a;", "Landroidx/compose/ui/layout/c0;", "", "isTarget", "<init>", "(Z)V", "LH1/d;", "", "parentData", "R", "(LH1/d;Ljava/lang/Object;)Ljava/lang/Object;", "<set-?>", "b", "Landroidx/compose/runtime/l0;", "()Z", "e", "animation_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    @SourceDebugExtension
    public static final class a implements c0 {

        /* renamed from: b, reason: collision with root package name and from kotlin metadata */
        private final InterfaceC5872l0 isTarget;
    ...
    @SourceDebugExtension
    private static final class b<S> extends AbstractC6316q {

        /* renamed from: o, reason: collision with root package name and from kotlin metadata */
        private k0<S>.a<r, C6457n> sizeAnimation;
        ...
        private long lastSize = androidx.compose.animation.a.f47980a;
        ...
        static final class a extends Lambda implements Function1<f0.a, Unit> {
            ...
            final /* synthetic */ b<S> f47962f;

            /* renamed from: g, reason: collision with root package name */
            final /* synthetic */ f0 f47963g;

            /* renamed from: h, reason: collision with root package name */
            final /* synthetic */ long f47964h;
            ...
            public final void a(f0.a aVar) {
                f0.a.j(aVar, this.f47963g, this.f47962f.L2().getContentAlignment().a(r.c((this.f47963g.getWidth() << 32) | (this.f47963g.getHeight() & 4294967295L)), this.f47964h, t.f13338a), 0.0f, 2, null);
            }
        ...
        static final class c extends Lambda implements Function1<S, r> {
            ...
            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ b<S> f47967f;

            /* renamed from: g, reason: collision with root package name */
            final /* synthetic */ long f47968g;
            ...
            public final long a(S s10) {
                if (Intrinsics.e(s10, this.f47967f.L2().b())) {
                    return this.f47967f.N2(this.f47968g);
                }
                z1<r> z1VarE = this.f47967f.L2().h().e(s10);
        ...
        static final class C0981b extends Lambda implements Function1<k0.b<S>, InterfaceC6419F<r>> {

            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ b<S> f47965f;

            /* renamed from: g, reason: collision with root package name */
            final /* synthetic */ long f47966g;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C0981b(b<S> bVar, long j10) {
                super(1);
                this.f47965f = bVar;
                this.f47966g = j10;
            }
            ...
            public final InterfaceC6419F<r> invoke(k0.b<S> bVar) {
                long jA;
                long jA2;
                InterfaceC6419F<r> interfaceC6419FB;
                if (Intrinsics.e(bVar.b(), this.f47965f.L2().b())) {
                    jA = this.f47965f.N2(this.f47966g);
                } else {
                    z1<r> z1VarE = this.f47965f.L2().h().e(bVar.b());
                    if (z1VarE != null) {
                ...
                z1<r> z1VarE2 = this.f47965f.L2().h().e(bVar.a());
                if (z1VarE2 != null) {
                    jA2 = z1VarE2.getValue().getPackedValue();
                } else {
                    jA2 = r.INSTANCE.a();
                }
                u value = this.f47965f.M2().getValue();
                if (value != null && (interfaceC6419FB = value.b(jA, jA2)) != null) {
                    return interfaceC6419FB;
                }
                return C6453j.j(0.0f, 400.0f, null, 5, null);
            }
        }

        /* JADX INFO: Access modifiers changed from: private */
        public final long N2(long j10) {
            return r.e(this.lastSize, androidx.compose.animation.a.f47980a) ? j10 : this.lastSize;
        }
        ...
        public final void P2(k0<S>.a<r, C6457n> aVar) {
            this.sizeAnimation = aVar;
        }
        ...
        public b(k0<S>.a<r, C6457n> aVar, z1<? extends u> z1Var, AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl) {
            this.sizeAnimation = aVar;
            this.sizeTransform = z1Var;
            this.scope = animatedContentTransitionScopeImpl;
        }
        ...
        public J a(K k10, I i10, long j10) {
            ...
            if (k10.v0()) {
                ...
                k0<S>.a<r, C6457n> aVar = this.sizeAnimation;
                Intrinsics.g(aVar);
                z1<r> z1VarA = aVar.a(new C0981b(this, jC), new c(this, jC));
                this.scope.i(z1VarA);
        ...
        public void v2() {
            super.v2();
            this.lastSize = androidx.compose.animation.a.f47980a;
        }
    }
    ...
    public final Modifier d(C6309i c6309i, Composer composer, int i10) {
        Modifier modifier;
        Object objB;
        if (ComposerKt.M()) {
        ...
        z1 z1VarP = o1.p(c6309i.getSizeTransform(), composer, 0);
