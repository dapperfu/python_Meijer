...
final class g extends AbstractC6316q {

    /* renamed from: o, reason: collision with root package name and from kotlin metadata */
    private k0<EnumC6311k> transition;

    /* renamed from: p, reason: collision with root package name and from kotlin metadata */
    private k0<EnumC6311k>.a<r, C6457n> sizeAnimation;

    /* renamed from: q, reason: collision with root package name and from kotlin metadata */
    private k0<EnumC6311k>.a<n, C6457n> offsetAnimation;

    /* renamed from: r, reason: collision with root package name and from kotlin metadata */
    private k0<EnumC6311k>.a<n, C6457n> slideAnimation;
    ...
    private final Function1<k0.b<EnumC6311k>, InterfaceC6419F<r>> sizeTransitionSpec = new i();

    /* renamed from: B, reason: collision with root package name and from kotlin metadata */
    private final Function1<k0.b<EnumC6311k>, InterfaceC6419F<n>> slideSpec = new j();
    ...
    static final class b extends Lambda implements Function1<f0.a, Unit> {
        ...
        public final void a(f0.a aVar) {
            f0.a.h(aVar, this.f48083f, 0, 0, 0.0f, 4, null);
        }
    ...
    static final class c extends Lambda implements Function1<f0.a, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ f0 f48084f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ long f48085g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ long f48086h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ Function1<androidx.compose.ui.graphics.e, Unit> f48087i;
        ...
        c(f0 f0Var, long j10, long j11, Function1<? super androidx.compose.ui.graphics.e, Unit> function1) {
            ...
            this.f48085g = j10;
            this.f48086h = j11;
            this.f48087i = function1;
        }

        public final void a(f0.a aVar) {
            aVar.u(this.f48084f, n.k(this.f48086h) + n.k(this.f48085g), n.l(this.f48086h) + n.l(this.f48085g), 0.0f, this.f48087i);
        }
    ...
    static final class d extends Lambda implements Function1<f0.a, Unit> {
        ...
        public final void a(f0.a aVar) {
            f0.a.h(aVar, this.f48088f, 0, 0, 0.0f, 4, null);
        }
    ...
    static final class e extends Lambda implements Function1<EnumC6311k, r> {

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ long f48090g;
        ...
        public final long a(EnumC6311k enumC6311k) {
            return g.this.W2(enumC6311k, this.f48090g);
        }

        @Override // kotlin.jvm.functions.Function1
        public /* bridge */ /* synthetic */ r invoke(EnumC6311k enumC6311k) {
            return r.b(a(enumC6311k));
        }
    }

    @Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0001\u001a\u00020\u0000H\n¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"Lb0/k;", "it", "LH1/n;", "a", "(Lb0/k;)J"}, k = 3, mv = {1, 9, 0})
    /* renamed from: androidx.compose.animation.g$g, reason: collision with other inner class name */
    static final class C0988g extends Lambda implements Function1<EnumC6311k, n> {

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ long f48093g;
        ...
        public final long a(EnumC6311k enumC6311k) {
            return g.this.Y2(enumC6311k, this.f48093g);
        }

        @Override // kotlin.jvm.functions.Function1
        public /* bridge */ /* synthetic */ n invoke(EnumC6311k enumC6311k) {
            return n.c(a(enumC6311k));
        }
    }

    @Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0001\u001a\u00020\u0000H\n¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"Lb0/k;", "it", "LH1/n;", "a", "(Lb0/k;)J"}, k = 3, mv = {1, 9, 0})
    static final class h extends Lambda implements Function1<EnumC6311k, n> {

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ long f48095g;
        ...
        public final long a(EnumC6311k enumC6311k) {
            return g.this.X2(enumC6311k, this.f48095g);
        }
    ...
    static final class i extends Lambda implements Function1<k0.b<EnumC6311k>, InterfaceC6419F<r>> {
        i() {
            super(1);
        }
        ...
        public final InterfaceC6419F<r> invoke(k0.b<EnumC6311k> bVar) {
            EnumC6311k enumC6311k = EnumC6311k.f59822a;
            EnumC6311k enumC6311k2 = EnumC6311k.f59823b;
            InterfaceC6419F<r> interfaceC6419FB = null;
            if (bVar.c(enumC6311k, enumC6311k2)) {
                ChangeSize changeSize = g.this.getEnter().getData().getChangeSize();
                if (changeSize != null) {
                    interfaceC6419FB = changeSize.b();
                }
            } else if (bVar.c(enumC6311k2, EnumC6311k.f59824c)) {
                ChangeSize changeSize2 = g.this.getExit().getData().getChangeSize();
                if (changeSize2 != null) {
                    interfaceC6419FB = changeSize2.b();
                }
            } else {
                interfaceC6419FB = androidx.compose.animation.f.f48034d;
            }
            return interfaceC6419FB == null ? androidx.compose.animation.f.f48034d : interfaceC6419FB;
        }
    }

    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u0002*\b\u0012\u0004\u0012\u00020\u00010\u0000H\n¢\u0006\u0004\b\u0004\u0010\u0005"}, d2 = {"Lc0/k0$b;", "Lb0/k;", "Lc0/F;", "LH1/n;", "a", "(Lc0/k0$b;)Lc0/F;"}, k = 3, mv = {1, 9, 0})
    static final class j extends Lambda implements Function1<k0.b<EnumC6311k>, InterfaceC6419F<n>> {
        j() {
            super(1);
        }
        ...
        @Override // kotlin.jvm.functions.Function1
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final InterfaceC6419F<n> invoke(k0.b<EnumC6311k> bVar) {
            InterfaceC6419F<n> interfaceC6419FA;
            InterfaceC6419F<n> interfaceC6419FA2;
            EnumC6311k enumC6311k = EnumC6311k.f59822a;
            EnumC6311k enumC6311k2 = EnumC6311k.f59823b;
            if (bVar.c(enumC6311k, enumC6311k2)) {
                Slide slide = g.this.getEnter().getData().getSlide();
                return (slide == null || (interfaceC6419FA2 = slide.a()) == null) ? androidx.compose.animation.f.f48033c : interfaceC6419FA2;
            }
            if (!bVar.c(enumC6311k2, EnumC6311k.f59824c)) {
                return androidx.compose.animation.f.f48033c;
            }
            Slide slide2 = g.this.getExit().getData().getSlide();
            return (slide2 == null || (interfaceC6419FA = slide2.a()) == null) ? androidx.compose.animation.f.f48033c : interfaceC6419FA;
        }
    }
    ...
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u0002*\b\u0012\u0004\u0012\u00020\u00010\u0000H\n¢\u0006\u0004\b\u0004\u0010\u0005"}, d2 = {"Lc0/k0$b;", "Lb0/k;", "Lc0/F;", "LH1/n;", "a", "(Lc0/k0$b;)Lc0/F;"}, k = 3, mv = {1, 9, 0})
    static final class f extends Lambda implements Function1<k0.b<EnumC6311k>, InterfaceC6419F<n>> {

        /* renamed from: f, reason: collision with root package name */
        public static final f f48091f = new f();
    ...
    public final P0.e K2() {
        P0.e alignment;
        P0.e alignment2;
        if (this.transition.m().c(EnumC6311k.f59822a, EnumC6311k.f59823b)) {
    ...
    public final void S2(k0<EnumC6311k>.a<n, C6457n> aVar) {
        this.offsetAnimation = aVar;
    }

    public final void T2(k0<EnumC6311k>.a<r, C6457n> aVar) {
        this.sizeAnimation = aVar;
    }

    public final void U2(k0<EnumC6311k>.a<n, C6457n> aVar) {
        this.slideAnimation = aVar;
    }

    public final void V2(k0<EnumC6311k> k0Var) {
        this.transition = k0Var;
    }

    public final long W2(EnumC6311k targetState, long fullSize) {
    ...
    public final long X2(EnumC6311k targetState, long fullSize) {
    ...
    public final long Y2(EnumC6311k targetState, long fullSize) {
    ...
    public J a(K k10, I i10, long j10) {
        ...
        k0<EnumC6311k>.a<r, C6457n> aVar = this.sizeAnimation;
        ...
        k0<EnumC6311k>.a<n, C6457n> aVar2 = this.offsetAnimation;
        long jB = (aVar2 == null || (z1VarA2 = aVar2.a(f.f48091f, new C0988g(j11))) == null) ? n.INSTANCE.b() : z1VarA2.getValue().getPackedValue();
        k0<EnumC6311k>.a<n, C6457n> aVar3 = this.slideAnimation;
        long jB2 = (aVar3 == null || (z1VarA = aVar3.a(this.slideSpec, new h(j11))) == null) ? n.INSTANCE.b() : z1VarA.getValue().getPackedValue();
        P0.e eVar = this.currentAlignment;
        return K.G0(k10, (int) (jD >> 32), (int) (jD & 4294967295L), null, new c(f0VarK03, n.o(eVar != null ? eVar.a(j11, jD, t.f13338a) : n.INSTANCE.b(), jB2), jB, function1Init), 4, null);
    }

    public g(k0<EnumC6311k> k0Var, k0<EnumC6311k>.a<r, C6457n> aVar, k0<EnumC6311k>.a<n, C6457n> aVar2, k0<EnumC6311k>.a<n, C6457n> aVar3, androidx.compose.animation.h hVar, androidx.compose.animation.j jVar, Function0<Boolean> function0, p pVar) {
        this.transition = k0Var;
        this.sizeAnimation = aVar;
