...
final class b implements MeasurePolicy {
    ...
    static final class a extends Lambda implements Function1<f0.a, Unit> {
        ...
        public final void a(f0.a aVar) {
            f0[] f0VarArr;
            f0[] f0VarArr2 = this.f48025f;
            b bVar = this.f48026g;
            int i10 = this.f48027h;
            int i11 = this.f48028i;
            ...
            while (i12 < length) {
                ...
                if (f0Var != null) {
                    f0VarArr = f0VarArr2;
                    long jA = bVar.a().getContentAlignment().a(r.c((f0Var.getWidth() << 32) | (f0Var.getHeight() & 4294967295L)), r.c((i11 & 4294967295L) | (i10 << 32)), t.f13338a);
