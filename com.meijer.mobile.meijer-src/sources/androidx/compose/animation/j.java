...
public abstract class j {
    ...
    private static final j f48102b;

    /* renamed from: c, reason: collision with root package name */
    private static final j f48103c;
    ...
    static {
        ...
        Scale scale = null;
        Map map = null;
        f48102b = new k(new TransitionData(fade, slide, changeSize, scale, false, map, 63, defaultConstructorMarker));
        f48103c = new k(new TransitionData(fade, slide, changeSize, scale, true, map, 47, defaultConstructorMarker));
    }
    ...
    public String toString() {
        if (Intrinsics.e(this, f48102b)) {
            return "ExitTransition.None";
        }
        if (Intrinsics.e(this, f48103c)) {
