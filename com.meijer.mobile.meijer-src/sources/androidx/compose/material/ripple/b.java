...
final class b extends RippleDrawable {
    ...
    private static final class C1050b {

        /* renamed from: a, reason: collision with root package name */
        public static final C1050b f50101a = new C1050b();
    ...
    private final long a(long color, float alpha) {
        ...
        return C5489q0.q(color, RangesKt.j(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
    ...
    public final void b(long color, float alpha) {
        ...
        C5489q0 c5489q0 = this.rippleColor;
        if (c5489q0 == null) {
            zS = false;
        } else {
            zS = C5489q0.s(c5489q0.getValue(), jA);
        }
        if (!zS) {
            this.rippleColor = C5489q0.m(jA);
            setColor(ColorStateList.valueOf(C5492s0.j(jA)));
        }
    }
}
