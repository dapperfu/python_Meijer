...
public abstract class F {
    private final CopyOnWriteArrayList<InterfaceC5757c> cancellables = new CopyOnWriteArrayList<>();
    ...
    public void handleOnBackProgressed(C5756b backEvent) {
        Intrinsics.j(backEvent, "backEvent");
    }

    public void handleOnBackStarted(C5756b backEvent) {
        Intrinsics.j(backEvent, "backEvent");
    }

    @JvmName
    public final void addCancellable(InterfaceC5757c cancellable) {
    ...
    public final void remove() {
        ...
        while (it.hasNext()) {
            ((InterfaceC5757c) it.next()).cancel();
        }
    }

    @JvmName
    public final void removeCancellable(InterfaceC5757c cancellable) {
        Intrinsics.j(cancellable, "cancellable");
