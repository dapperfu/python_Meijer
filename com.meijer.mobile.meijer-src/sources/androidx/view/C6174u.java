...
public class C6174u extends AbstractC6165l {
    ...
    private C16326a<InterfaceC6171r, b> observerMap;

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    private AbstractC6165l.b state;

    /* renamed from: e, reason: collision with root package name and from kotlin metadata */
    private final WeakReference<InterfaceC6172s> lifecycleOwner;
    ...
    private ArrayList<AbstractC6165l.b> parentStates;

    /* renamed from: j, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC16549B<AbstractC6165l.b> _currentStateFlow;
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final AbstractC6165l.b a(AbstractC6165l.b state1, AbstractC6165l.b state2) {
    ...
    public static final class b {
        ...
        /* renamed from: b, reason: collision with root package name and from kotlin metadata */
        private InterfaceC6169p lifecycleObserver;

        public b(InterfaceC6171r interfaceC6171r, AbstractC6165l.b initialState) {
            Intrinsics.j(initialState, "initialState");
            Intrinsics.g(interfaceC6171r);
            this.lifecycleObserver = C6179z.f(interfaceC6171r);
            this.state = initialState;
        }

        public final void a(InterfaceC6172s owner, AbstractC6165l.a event) {
            Intrinsics.j(event, "event");
            AbstractC6165l.b bVarE = event.e();
            this.state = C6174u.INSTANCE.a(this.state, bVarE);
            InterfaceC6169p interfaceC6169p = this.lifecycleObserver;
            Intrinsics.g(owner);
            interfaceC6169p.onStateChanged(owner, event);
            this.state = bVarE;
        }

        /* renamed from: b, reason: from getter */
        public final AbstractC6165l.b getState() {
            return this.state;
        }
    }

    private C6174u(InterfaceC6172s interfaceC6172s, boolean z10) {
        this.enforceMainThread = z10;
        this.observerMap = new C16326a<>();
        AbstractC6165l.b bVar = AbstractC6165l.b.f55500b;
        this.state = bVar;
        this.parentStates = new ArrayList<>();
        this.lifecycleOwner = new WeakReference<>(interfaceC6172s);
        this._currentStateFlow = S.a(bVar);
    }

    private final void e(InterfaceC6172s lifecycleOwner) {
        Iterator<Map.Entry<InterfaceC6171r, b>> itDescendingIterator = this.observerMap.descendingIterator();
        Intrinsics.i(itDescendingIterator, "descendingIterator(...)");
        while (itDescendingIterator.hasNext() && !this.newEventOccurred) {
            Map.Entry<InterfaceC6171r, b> next = itDescendingIterator.next();
            Intrinsics.g(next);
            InterfaceC6171r key = next.getKey();
            b value = next.getValue();
            while (value.getState().compareTo(this.state) > 0 && !this.newEventOccurred && this.observerMap.contains(key)) {
                AbstractC6165l.a aVarA = AbstractC6165l.a.INSTANCE.a(value.getState());
                if (aVarA == null) {
    ...
    private final AbstractC6165l.b f(InterfaceC6171r observer) {
        b value;
        Map.Entry<InterfaceC6171r, b> entryN = this.observerMap.n(observer);
        AbstractC6165l.b bVar = null;
        AbstractC6165l.b state = (entryN == null || (value = entryN.getValue()) == null) ? null : value.getState();
    ...
    private final void g(String methodName) {
        if (!this.enforceMainThread || C6177x.a()) {
            return;
        }
        throw new IllegalStateException(("Method " + methodName + " must be called on the main thread").toString());
    }

    private final void h(InterfaceC6172s lifecycleOwner) {
        C16327b<InterfaceC6171r, b>.d dVarF = this.observerMap.f();
        Intrinsics.i(dVarF, "iteratorWithAdditions(...)");
        while (dVarF.hasNext() && !this.newEventOccurred) {
            Map.Entry next = dVarF.next();
            InterfaceC6171r interfaceC6171r = (InterfaceC6171r) next.getKey();
            b bVar = (b) next.getValue();
            while (bVar.getState().compareTo(this.state) < 0 && !this.newEventOccurred && this.observerMap.contains(interfaceC6171r)) {
                m(bVar.getState());
                AbstractC6165l.a aVarB = AbstractC6165l.a.INSTANCE.b(bVar.getState());
                if (aVarB == null) {
    ...
    private final boolean j() {
        ...
        Map.Entry<InterfaceC6171r, b> entryA = this.observerMap.a();
        Intrinsics.g(entryA);
        AbstractC6165l.b state = entryA.getValue().getState();
        Map.Entry<InterfaceC6171r, b> entryH = this.observerMap.h();
        Intrinsics.g(entryH);
        AbstractC6165l.b state2 = entryH.getValue().getState();
        return state == state2 && this.state == state2;
    }

    private final void k(AbstractC6165l.b next) {
        if (this.state == next) {
            return;
        }
        C6175v.a(this.lifecycleOwner.get(), this.state, next);
        this.state = next;
        ...
        if (this.state == AbstractC6165l.b.f55499a) {
            this.observerMap = new C16326a<>();
        }
    }
    ...
    private final void m(AbstractC6165l.b state) {
        this.parentStates.add(state);
    }

    private final void o() {
        InterfaceC6172s interfaceC6172s = this.lifecycleOwner.get();
        if (interfaceC6172s == null) {
            throw new IllegalStateException("LifecycleOwner of this LifecycleRegistry is already garbage collected. It is too late to change lifecycle state.");
        }
        while (!j()) {
            this.newEventOccurred = false;
            AbstractC6165l.b bVar = this.state;
            Map.Entry<InterfaceC6171r, b> entryA = this.observerMap.a();
            Intrinsics.g(entryA);
    ...
    public void a(InterfaceC6171r observer) {
        ...
        g("addObserver");
        AbstractC6165l.b bVar = this.state;
        AbstractC6165l.b bVar2 = AbstractC6165l.b.f55499a;
        if (bVar != bVar2) {
            bVar2 = AbstractC6165l.b.f55500b;
        }
        b bVar3 = new b(observer, bVar2);
        if (this.observerMap.l(observer, bVar3) == null && (interfaceC6172s = this.lifecycleOwner.get()) != null) {
            boolean z10 = this.addingObserverCounter != 0 || this.handlingEvent;
            AbstractC6165l.b bVarF = f(observer);
            this.addingObserverCounter++;
            while (bVar3.getState().compareTo(bVarF) < 0 && this.observerMap.contains(observer)) {
                m(bVar3.getState());
                AbstractC6165l.a aVarB = AbstractC6165l.a.INSTANCE.b(bVar3.getState());
                if (aVarB == null) {
                    throw new IllegalStateException("no event up from " + bVar3.getState());
                }
                bVar3.a(interfaceC6172s, aVarB);
                l();
                bVarF = f(observer);
            }
            if (!z10) {
    ...
    @Override // androidx.view.AbstractC6165l
    /* renamed from: b, reason: from getter */
    public AbstractC6165l.b getState() {
        return this.state;
    }
    ...
    public void i(AbstractC6165l.a event) {
        Intrinsics.j(event, "event");
        g("handleLifecycleEvent");
        k(event.e());
    }

    public void n(AbstractC6165l.b state) {
    ...
    public C6174u(InterfaceC6172s provider) {
        this(provider, true);
