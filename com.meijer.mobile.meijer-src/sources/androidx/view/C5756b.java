...
public final class C5756b {
    ...
    public C5756b(float f10, float f11, float f12, int i10) {
        this.touchX = f10;
        this.touchY = f11;
        this.progress = f12;
        this.swipeEdge = i10;
    ...
    public C5756b(BackEvent backEvent) {
        Intrinsics.j(backEvent, "backEvent");
        C5755a c5755a = C5755a.f45926a;
        this(c5755a.c(backEvent), c5755a.d(backEvent), c5755a.a(backEvent), c5755a.b(backEvent));
    }
}
