...
public final class G {
    ...
    private final InterfaceC16068a<Boolean> onHasEnabledCallbacksChanged;
    ...
    static final class a extends Lambda implements Function1<C5756b, Unit> {
        a() {
            super(1);
        }
        ...
        public /* bridge */ /* synthetic */ Unit invoke(C5756b c5756b) {
            a(c5756b);
    ...
    @Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0001\u001a\u00020\u0000H\n¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"Landroidx/activity/b;", "backEvent", "", "a", "(Landroidx/activity/b;)V"}, k = 3, mv = {1, 8, 0})
    static final class b extends Lambda implements Function1<C5756b, Unit> {
        b() {
            super(1);
        }
    ...
    public static final class g {
        ...
        public static final class a implements OnBackAnimationCallback {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ Function1<C5756b, Unit> f45904a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ Function1<C5756b, Unit> f45905b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ Function0<Unit> f45906c;

            /* renamed from: d, reason: collision with root package name */
            final /* synthetic */ Function0<Unit> f45907d;

            /* JADX WARN: Multi-variable type inference failed */
            a(Function1<? super C5756b, Unit> function1, Function1<? super C5756b, Unit> function12, Function0<Unit> function0, Function0<Unit> function02) {
                this.f45904a = function1;
                this.f45905b = function12;
                this.f45906c = function0;
                this.f45907d = function02;
            }
            ...
            public void onBackProgressed(BackEvent backEvent) {
                Intrinsics.j(backEvent, "backEvent");
                this.f45905b.invoke(new C5756b(backEvent));
            }

            public void onBackStarted(BackEvent backEvent) {
                Intrinsics.j(backEvent, "backEvent");
                this.f45904a.invoke(new C5756b(backEvent));
            }
        }

        public final OnBackInvokedCallback a(Function1<? super C5756b, Unit> onBackStarted, Function1<? super C5756b, Unit> onBackProgressed, Function0<Unit> onBackInvoked, Function0<Unit> onBackCancelled) {
    ...
    private final class h implements InterfaceC6169p, InterfaceC5757c {
        ...
        /* renamed from: c, reason: collision with root package name and from kotlin metadata */
        private InterfaceC5757c currentCancellable;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ G f45911d;

        public h(G g10, AbstractC6165l lifecycle, F onBackPressedCallback) {
        ...
        @Override // androidx.view.InterfaceC5757c
        public void cancel() {
            this.lifecycle.d(this);
            this.onBackPressedCallback.removeCancellable(this);
            InterfaceC5757c interfaceC5757c = this.currentCancellable;
            if (interfaceC5757c != null) {
                interfaceC5757c.cancel();
            }
        ...
        public void onStateChanged(InterfaceC6172s source, AbstractC6165l.a event) {
            ...
            if (event == AbstractC6165l.a.ON_START) {
                this.currentCancellable = this.f45911d.j(this.onBackPressedCallback);
                return;
            }
            if (event != AbstractC6165l.a.ON_STOP) {
    ...
    private final class i implements InterfaceC5757c {

        /* renamed from: a, reason: collision with root package name and from kotlin metadata */
        private final F onBackPressedCallback;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ G f45913b;
        ...
        @Override // androidx.view.InterfaceC5757c
        public void cancel() {
            this.f45913b.onBackPressedCallbacks.remove(this.onBackPressedCallback);
            if (Intrinsics.e(this.f45913b.inProgressCallback, this.onBackPressedCallback)) {
                this.onBackPressedCallback.handleOnBackCancelled();
                this.f45913b.inProgressCallback = null;
            }
            this.onBackPressedCallback.removeCancellable(this);
    ...
    public G(Runnable runnable, InterfaceC16068a<Boolean> interfaceC16068a) {
        this.fallbackOnBackPressed = runnable;
        this.onHasEnabledCallbacksChanged = interfaceC16068a;
        this.onBackPressedCallbacks = new ArrayDeque<>();
        int i10 = Build.VERSION.SDK_INT;
        if (i10 >= 33) {
            this.onBackInvokedCallback = i10 >= 34 ? g.f45903a.a(new a(), new b(), new c(), new d()) : f.f45902a.b(new e());
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void m(C5756b backEvent) {
        F fPrevious;
        F f10 = this.inProgressCallback;
        if (f10 == null) {
            ArrayDeque<F> arrayDeque = this.onBackPressedCallbacks;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void n(C5756b backEvent) {
        F fPrevious;
        ArrayDeque<F> arrayDeque = this.onBackPressedCallbacks;
        ListIterator<F> listIterator = arrayDeque.listIterator(arrayDeque.size());
        while (true) {
    ...
    private final void p(boolean shouldBeRegistered) {
        ...
        if (shouldBeRegistered && !this.backInvokedCallbackRegistered) {
            f.f45902a.d(onBackInvokedDispatcher, 0, onBackInvokedCallback);
            this.backInvokedCallbackRegistered = true;
        } else {
            if (shouldBeRegistered || !this.backInvokedCallbackRegistered) {
                return;
            }
            f.f45902a.e(onBackInvokedDispatcher, onBackInvokedCallback);
    ...
    public final void q() {
        ...
        if (z11 != z10) {
            InterfaceC16068a<Boolean> interfaceC16068a = this.onHasEnabledCallbacksChanged;
            if (interfaceC16068a != null) {
                interfaceC16068a.accept(Boolean.valueOf(z11));
            }
    ...
    public final void i(InterfaceC6172s owner, F onBackPressedCallback) {
        Intrinsics.j(owner, "owner");
        Intrinsics.j(onBackPressedCallback, "onBackPressedCallback");
        AbstractC6165l lifecycle = owner.getLifecycle();
    ...
    public final InterfaceC5757c j(F onBackPressedCallback) {
        Intrinsics.j(onBackPressedCallback, "onBackPressedCallback");
