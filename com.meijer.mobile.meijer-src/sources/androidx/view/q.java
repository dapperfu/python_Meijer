...
public class q extends Dialog implements InterfaceC6172s, J, InterfaceC18089i {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private C6174u _lifecycleRegistry;
    ...
    private final C6174u b() {
        C6174u c6174u = this._lifecycleRegistry;
        if (c6174u != null) {
            return c6174u;
        }
        C6174u c6174u2 = new C6174u(this);
        this._lifecycleRegistry = c6174u2;
        return c6174u2;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b().i(AbstractC6165l.a.ON_CREATE);
    }
    ...
    protected void onStart() {
        super.onStart();
        b().i(AbstractC6165l.a.ON_RESUME);
    }

    @Override // android.app.Dialog
    protected void onStop() {
        b().i(AbstractC6165l.a.ON_DESTROY);
