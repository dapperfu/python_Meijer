...
public abstract class AbstractC6165l {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private C6154c<Object> internalScopeRef = new C6154c<>(null);
        ...
        public static final class Companion {
            ...
            public /* synthetic */ class C1132a {
                ...
                static {
                    ...
                    try {
                        iArr[b.f55501c.ordinal()] = 1;
                    } catch (NoSuchFieldError unused) {
                    }
                    try {
                        iArr[b.f55502d.ordinal()] = 2;
                    } catch (NoSuchFieldError unused2) {
                    }
                    try {
                        iArr[b.f55503e.ordinal()] = 3;
                    } catch (NoSuchFieldError unused3) {
                    }
                    try {
                        iArr[b.f55499a.ordinal()] = 4;
                    } catch (NoSuchFieldError unused4) {
                    }
                    try {
                        iArr[b.f55500b.ordinal()] = 5;
            ...
            public final a a(b state) {
                ...
                int i10 = C1132a.$EnumSwitchMapping$0[state.ordinal()];
                if (i10 == 1) {
                    return a.ON_DESTROY;
                }
                if (i10 == 2) {
    ...
    public static final class b {
        ...
        public static final b f55499a = new b("DESTROYED", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final b f55500b = new b("INITIALIZED", 1);

        /* renamed from: c, reason: collision with root package name */
        public static final b f55501c = new b("CREATED", 2);

        /* renamed from: d, reason: collision with root package name */
        public static final b f55502d = new b("STARTED", 3);

        /* renamed from: e, reason: collision with root package name */
        public static final b f55503e = new b("RESUMED", 4);

        /* renamed from: f, reason: collision with root package name */
        private static final /* synthetic */ b[] f55504f;

        /* renamed from: g, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f55505g;

        private static final /* synthetic */ b[] a() {
            return new b[]{f55499a, f55500b, f55501c, f55502d, f55503e};
        }

        static {
            b[] bVarArrA = a();
            f55504f = bVarArrA;
            f55505g = EnumEntriesKt.a(bVarArrA);
        }
    ...
    public abstract void a(InterfaceC6171r observer);

    public abstract b b();

    public abstract void d(InterfaceC6171r observer);

    public final C6154c<Object> c() {
