...
public final class C6147V {

    /* renamed from: a, reason: collision with root package name */
    private static final List<Class<?>> f55446a = CollectionsKt.p(Application.class, C6138L.class);

    /* renamed from: b, reason: collision with root package name */
    private static final List<Class<?>> f55447b = CollectionsKt.e(C6138L.class);
    ...
    public static final <T> Constructor<T> c(Class<T> modelClass, List<? extends Class<?>> signature) {
        ...
        while (itA.hasNext()) {
            ...
            List listH1 = ArraysKt.h1(parameterTypes);
            if (Intrinsics.e(signature, listH1)) {
            ...
            if (signature.size() == listH1.size() && listH1.containsAll(signature)) {
