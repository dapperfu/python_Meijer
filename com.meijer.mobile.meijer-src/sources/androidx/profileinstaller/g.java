...
class g {
    ...
    static final byte[] f58041a = {112, 114, 111, 0};

    /* renamed from: b, reason: collision with root package name */
    static final byte[] f58042b = {112, 114, 109, 0};

    private static void L(OutputStream outputStream, c[] cVarArr) throws IOException {
        d.p(outputStream, cVarArr.length);
        for (c cVar : cVarArr) {
            String strJ = j(cVar.f58023a, cVar.f58024b, i.f58058e);
            d.p(outputStream, d.k(strJ));
            d.p(outputStream, cVar.f58031i.size());
            d.p(outputStream, cVar.f58030h.length);
            d.q(outputStream, cVar.f58025c);
            d.n(outputStream, strJ);
            Iterator<Integer> it = cVar.f58031i.keySet().iterator();
            while (it.hasNext()) {
                d.p(outputStream, it.next().intValue());
            }
            for (int i10 : cVar.f58030h) {
    ...
    private static void M(OutputStream outputStream, c[] cVarArr) throws IOException {
        ...
        for (c cVar : cVarArr) {
            int size = cVar.f58031i.size() * 4;
            String strJ = j(cVar.f58023a, cVar.f58024b, i.f58057d);
            d.p(outputStream, d.k(strJ));
            d.p(outputStream, cVar.f58030h.length);
    ...
    private static byte[] b(c[] cVarArr, byte[] bArr) throws IOException {
        ...
        int iK = 0;
        for (c cVar : cVarArr) {
            iK += d.k(j(cVar.f58023a, cVar.f58024b, bArr)) + 16 + (cVar.f58027e * 2) + cVar.f58028f + k(cVar.f58029g);
        }
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream(iK);
        if (Arrays.equals(bArr, i.f58056c)) {
            int length = cVarArr.length;
            while (i10 < length) {
                c cVar2 = cVarArr[i10];
                H(byteArrayOutputStream, cVar2, j(cVar2.f58023a, cVar2.f58024b, bArr));
                G(byteArrayOutputStream, cVar2);
                i10++;
            }
        } else {
            for (c cVar3 : cVarArr) {
                H(byteArrayOutputStream, cVar3, j(cVar3.f58023a, cVar3.f58024b, bArr));
            }
    ...
    private static c i(c[] cVarArr, String str) {
        ...
        for (int i10 = 0; i10 < cVarArr.length; i10++) {
            if (cVarArr[i10].f58024b.equals(strH)) {
                return cVarArr[i10];
            }
        }
        return null;
    ...
    static byte[] p(InputStream inputStream, byte[] bArr) throws IOException {
        if (Arrays.equals(bArr, d.d(inputStream, bArr.length))) {
            return d.d(inputStream, i.f58055b.length);
        }
    ...
    static boolean C(OutputStream outputStream, byte[] bArr, c[] cVarArr) throws IOException {
        ...
        if (!Arrays.equals(bArr, i.f58058e)) {
            return false;
        }
    ...
    private static j E(c[] cVarArr) throws IOException {
        ...
        try {
            ...
            int i10 = 2;
            for (c cVar : cVarArr) {
                d.q(byteArrayOutputStream, cVar.f58025c);
                d.q(byteArrayOutputStream, cVar.f58026d);
                d.q(byteArrayOutputStream, cVar.f58029g);
                String strJ = j(cVar.f58023a, cVar.f58024b, i.f58054a);
                int iK = d.k(strJ);
    ...
    static void F(OutputStream outputStream, byte[] bArr) throws IOException {
        outputStream.write(f58041a);
        outputStream.write(bArr);
    }

    private static void I(OutputStream outputStream, c cVar) throws IOException {
        byte[] bArr = new byte[k(cVar.f58029g)];
        for (Map.Entry<Integer, Integer> entry : cVar.f58031i.entrySet()) {
    ...
    private static void J(OutputStream outputStream, int i10, c cVar) throws IOException {
        byte[] bArr = new byte[l(i10, cVar.f58029g)];
        for (Map.Entry<Integer, Integer> entry : cVar.f58031i.entrySet()) {
            int iIntValue = entry.getKey().intValue();
            int iIntValue2 = entry.getValue().intValue();
            int i11 = 0;
            for (int i12 = 1; i12 <= 4; i12 <<= 1) {
                if (i12 != 1 && (i12 & i10) != 0) {
                    if ((i12 & iIntValue2) == i12) {
                        int i13 = (cVar.f58029g * i11) + iIntValue;
                        int i14 = i13 / 8;
    ...
    private static void Q(OutputStream outputStream, c[] cVarArr) throws IOException {
        ...
        long length2 = i.f58054a.length + f58041a.length + 4 + (arrayList.size() * 16);
        d.q(outputStream, arrayList.size());
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            j jVar = (j) arrayList.get(i10);
            d.q(outputStream, jVar.f58061a.b());
            d.q(outputStream, length2);
            if (jVar.f58064d) {
                byte[] bArr = jVar.f58063c;
                ...
                arrayList2.add(jVar.f58063c);
                d.q(outputStream, jVar.f58063c.length);
                d.q(outputStream, 0L);
                length = jVar.f58063c.length;
            }
            length2 += length;
        }
    ...
    private static int a(c cVar) {
        Iterator<Map.Entry<Integer, Integer>> it = cVar.f58031i.entrySet().iterator();
        int iIntValue = 0;
        while (it.hasNext()) {
    ...
    private static j c(c[] cVarArr) throws IOException {
        ...
        for (int i11 = 0; i11 < cVarArr.length; i11++) {
            try {
                ...
                d.p(byteArrayOutputStream, cVar.f58027e);
                i10 = i10 + 4 + (cVar.f58027e * 2);
    ...
    static c[] r(InputStream inputStream, byte[] bArr, byte[] bArr2, c[] cVarArr) throws IOException {
        if (Arrays.equals(bArr, i.f58059f)) {
            if (Arrays.equals(i.f58054a, bArr2)) {
        ...
        if (Arrays.equals(bArr, i.f58060g)) {
    ...
    private static void w(InputStream inputStream, c cVar) throws IOException {
        BitSet bitSetValueOf = BitSet.valueOf(d.d(inputStream, d.a(cVar.f58029g * 2)));
        int i10 = 0;
        while (true) {
            int i11 = cVar.f58029g;
            if (i10 >= i11) {
                return;
            }
            int iO = o(bitSetValueOf, i10, i11);
            if (iO != 0) {
                Integer num = cVar.f58031i.get(Integer.valueOf(i10));
                if (num == null) {
                    num = 0;
                }
                cVar.f58031i.put(Integer.valueOf(i10), Integer.valueOf(iO | num.intValue()));
            }
            i10++;
        }
    }
    ...
    private static c[] y(InputStream inputStream, String str, int i10) throws IOException {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            c cVar = cVarArr[i12];
            q(inputStream, cVar);
            cVar.f58030h = n(inputStream, cVar.f58027e);
            w(inputStream, cVar);
        }
        return cVarArr;
    }
    ...
    private static void H(OutputStream outputStream, c cVar, String str) throws IOException {
        ...
        d.p(outputStream, cVar.f58027e);
        d.q(outputStream, cVar.f58028f);
        d.q(outputStream, cVar.f58025c);
        d.q(outputStream, cVar.f58029g);
    ...
    private static void q(InputStream inputStream, c cVar) throws IOException {
        int iAvailable = inputStream.available() - cVar.f58028f;
        int iH = 0;
        while (inputStream.available() > iAvailable) {
            iH += d.h(inputStream);
            cVar.f58031i.put(Integer.valueOf(iH), 1);
    ...
    private static c[] t(InputStream inputStream, int i10, c[] cVarArr) throws IOException {
        ...
        if (i10 == cVarArr.length) {
            ...
            for (int i12 = 0; i12 < i10; i12++) {
                c cVar = cVarArr[i12];
                if (cVar.f58024b.equals(strArr[i12])) {
                    int i13 = iArr[i12];
                    cVar.f58027e = i13;
                    cVar.f58030h = n(inputStream, i13);
                } else {
