...
public abstract class b {
    ...
    public static final class Companion {
        ...
        static final class C1143a extends Lambda implements Function1<Context, d> {

            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ Context f57974f;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C1143a(Context context) {
                super(1);
                this.f57974f = context;
            }
        ...
        public final b a(Context context) {
            ...
            sb2.append(c15453a.a());
            FS.log_d("MeasurementManager", sb2.toString());
            if (c15453a.a() >= 5) {
                return new g(context);
            }
            if (c15453a.b() >= 9) {
                return (b) l4.b.f149294a.a(context, "MeasurementManager", new C1143a(context));
            }
            return null;
        }
    }
