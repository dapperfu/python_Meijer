...
public class F extends u {
    ...
    static final class a extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f57991b = obj;
            this.f57993d |= Integer.MIN_VALUE;
            return F.e(F.this, null, this);
        }
    }

    @Override // androidx.privacysandbox.ads.adservices.topics.u
    public Object a(C6245b c6245b, Continuation<? super h> continuation) {
        return e(this, c6245b, continuation);
    }
    ...
    */
    static /* synthetic */ java.lang.Object e(androidx.privacysandbox.ads.adservices.topics.F r4, androidx.privacysandbox.ads.adservices.topics.C6245b r5, kotlin.coroutines.Continuation<? super androidx.privacysandbox.ads.adservices.topics.h> r6) {
        /*
        ...
        L18:
            ...
            if (r2 == 0) goto L35
            if (r2 != r3) goto L2d
            java.lang.Object r4 = r0.f57990a
    ...
    private final Object f(GetTopicsRequest getTopicsRequest, Continuation<? super GetTopicsResponse> continuation) {
        ...
        c15819p.C();
        this.mTopicsManager.getTopics(getTopicsRequest, new androidx.privacysandbox.ads.adservices.measurement.k(), j2.m.a(c15819p));
    ...
    public GetTopicsRequest c(C6245b request) {
        ...
        return g.f58001a.b(request);
    }

    public h d(GetTopicsResponse response) {
        Intrinsics.j(response, "response");
        return s.f58004a.a(response);
    }
}
