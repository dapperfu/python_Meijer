...
public final class C6245b {
    ...
    public static final class a {
        ...
        public final C6245b a() {
            return new C6245b(this.adsSdkName, this.shouldRecordObservation);
        }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof C6245b)) {
            return false;
        }
        C6245b c6245b = (C6245b) other;
        return Intrinsics.e(this.adsSdkName, c6245b.adsSdkName) && this.shouldRecordObservation == c6245b.shouldRecordObservation;
    }

    public C6245b(String adsSdkName, boolean z10) {
        Intrinsics.j(adsSdkName, "adsSdkName");
        this.adsSdkName = adsSdkName;
    ...
    public /* synthetic */ C6245b(String str, boolean z10, int i10, DefaultConstructorMarker defaultConstructorMarker) {
