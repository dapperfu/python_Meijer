...
public final class C6244a {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof C6244a)) {
            return false;
        }
        C6244a c6244a = (C6244a) other;
        return Arrays.equals(this.EncryptedTopic, c6244a.EncryptedTopic) && this.KeyIdentifier.contentEquals(c6244a.KeyIdentifier) && Arrays.equals(this.EncapsulatedKey, c6244a.EncapsulatedKey);
    }

    public C6244a(byte[] encryptedTopic, String keyIdentifier, byte[] encapsulatedKey) {
