...
public class CoordinatorLayout extends ViewGroup implements InterfaceC16343D, E, FSDispatchDraw {

    /* renamed from: t, reason: collision with root package name */
    static final String f53829t;

    /* renamed from: u, reason: collision with root package name */
    static final Class<?>[] f53830u;

    /* renamed from: v, reason: collision with root package name */
    static final ThreadLocal<Map<String, Constructor<c>>> f53831v;

    /* renamed from: w, reason: collision with root package name */
    static final Comparator<View> f53832w;

    /* renamed from: x, reason: collision with root package name */
    private static final o2.f<Rect> f53833x;

    /* renamed from: a, reason: collision with root package name */
    private final List<View> f53834a;

    /* renamed from: b, reason: collision with root package name */
    private final androidx.coordinatorlayout.widget.a<View> f53835b;

    /* renamed from: c, reason: collision with root package name */
    private final List<View> f53836c;

    /* renamed from: d, reason: collision with root package name */
    private Paint f53837d;
    ...
    private View f53843j;

    /* renamed from: k, reason: collision with root package name */
    private View f53844k;

    /* renamed from: l, reason: collision with root package name */
    private g f53845l;

    /* renamed from: m, reason: collision with root package name */
    private boolean f53846m;

    /* renamed from: n, reason: collision with root package name */
    private j f53847n;

    /* renamed from: o, reason: collision with root package name */
    private boolean f53848o;

    /* renamed from: p, reason: collision with root package name */
    private Drawable f53849p;

    /* renamed from: q, reason: collision with root package name */
    ViewGroup.OnHierarchyChangeListener f53850q;

    /* renamed from: r, reason: collision with root package name */
    private G f53851r;

    /* renamed from: s, reason: collision with root package name */
    private final F f53852s;
    ...
    private class e implements ViewGroup.OnHierarchyChangeListener {
        ...
        public void onChildViewAdded(View view, View view2) {
            ViewGroup.OnHierarchyChangeListener onHierarchyChangeListener = CoordinatorLayout.this.f53850q;
    ...
    public static class f extends ViewGroup.MarginLayoutParams {
        ...
        /* renamed from: m, reason: collision with root package name */
        private boolean f53867m;

        /* renamed from: n, reason: collision with root package name */
        private boolean f53868n;

        /* renamed from: o, reason: collision with root package name */
        private boolean f53869o;
        ...
        private void n(View view, CoordinatorLayout coordinatorLayout) {
            View viewFindViewById = coordinatorLayout.findViewById(this.f53860f);
            this.f53865k = viewFindViewById;
            if (viewFindViewById == null) {
                ...
                throw new IllegalStateException("Could not find CoordinatorLayout descendant view with id " + coordinatorLayout.getResources().getResourceName(this.f53860f) + " to anchor view " + view);
            }
            ...
            this.f53866l = viewFindViewById;
        }

        private boolean t(View view, CoordinatorLayout coordinatorLayout) {
            if (this.f53865k.getId() != this.f53860f) {
                return false;
            }
            View view2 = this.f53865k;
        ...
        boolean a() {
            return this.f53865k == null && this.f53860f != -1;
        }

        boolean b(CoordinatorLayout coordinatorLayout, View view, View view2) {
            if (view2 == this.f53866l || s(view2, ViewCompat.z(coordinatorLayout))) {
                return true;
            }
            c cVar = this.f53855a;
        ...
        View d(CoordinatorLayout coordinatorLayout, View view) {
            ...
            if (this.f53865k == null || !t(view, coordinatorLayout)) {
        ...
        private boolean s(View view, int i10) {
            int iB = r.b(((f) view.getLayoutParams()).f53861g, i10);
            if (iB != 0 && (r.b(this.f53862h, i10) & iB) == iB) {
                return true;
            }
            return false;
        }
        ...
        f(Context context, AttributeSet attributeSet) {
            ...
            this.f53862h = 0;
            this.f53871q = new Rect();
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, X1.c.f41508d);
            this.f53857c = typedArrayObtainStyledAttributes.getInteger(X1.c.f41509e, 0);
            this.f53860f = typedArrayObtainStyledAttributes.getResourceId(X1.c.f41510f, -1);
            this.f53858d = typedArrayObtainStyledAttributes.getInteger(X1.c.f41511g, 0);
            this.f53859e = typedArrayObtainStyledAttributes.getInteger(X1.c.f41515k, -1);
            this.f53861g = typedArrayObtainStyledAttributes.getInt(X1.c.f41514j, 0);
            this.f53862h = typedArrayObtainStyledAttributes.getInt(X1.c.f41513i, 0);
            boolean zHasValue = typedArrayObtainStyledAttributes.hasValue(X1.c.f41512h);
            this.f53856b = zHasValue;
            if (zHasValue) {
                this.f53855a = CoordinatorLayout.M(context, attributeSet, typedArrayObtainStyledAttributes.getString(X1.c.f41512h));
            }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, X1.a.f41503a);
    }
    ...
    public void n(View view, int i10, int i11, int i12, int i13, int i14) {
        m(view, i10, i11, i12, i13, 0, this.f53839f);
    }
    ...
    protected static class h extends AbstractC17821a {
        ...
        /* renamed from: c, reason: collision with root package name */
        SparseArray<Parcelable> f53874c;
        ...
        public h(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f53874c = new SparseArray<>(i10);
            for (int i11 = 0; i11 < i10; i11++) {
                this.f53874c.append(iArr[i11], parcelableArray[i11]);
            }
        }
        ...
        public void writeToParcel(Parcel parcel, int i10) {
            ...
            SparseArray<Parcelable> sparseArray = this.f53874c;
            if (sparseArray != null) {
            ...
            for (int i11 = 0; i11 < size; i11++) {
                iArr[i11] = this.f53874c.keyAt(i11);
                parcelableArr[i11] = this.f53874c.valueAt(i11);
            }
    ...
    static {
        ...
        f53829t = r02 != null ? r02.getName() : null;
        f53832w = new i();
        f53830u = new Class[]{Context.class, AttributeSet.class};
        f53831v = new ThreadLocal<>();
        f53833x = new o2.h(12);
    }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.f53835b = new androidx.coordinatorlayout.widget.a<>();
        this.f53836c = new ArrayList();
        this.f53838e = new int[2];
        this.f53839f = new int[2];
        this.f53852s = new F(this);
        TypedArray typedArrayObtainStyledAttributes = i10 == 0 ? context.obtainStyledAttributes(attributeSet, X1.c.f41505a, 0, X1.b.f41504a) : context.obtainStyledAttributes(attributeSet, X1.c.f41505a, i10, 0);
        if (i10 == 0) {
            coordinatorLayout = this;
            context2 = context;
            ViewCompat.k0(coordinatorLayout, context2, X1.c.f41505a, attributeSet, typedArrayObtainStyledAttributes, 0, X1.b.f41504a);
        } else {
            context2 = context;
            coordinatorLayout = this;
            ViewCompat.k0(coordinatorLayout, context2, X1.c.f41505a, attributeSet, typedArrayObtainStyledAttributes, i10, 0);
        }
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(X1.c.f41506b, 0);
        if (resourceId != 0) {
            Resources resources = context2.getResources();
            coordinatorLayout.f53842i = resources.getIntArray(resourceId);
            float f10 = resources.getDisplayMetrics().density;
            int length = coordinatorLayout.f53842i.length;
            for (int i11 = 0; i11 < length; i11++) {
                coordinatorLayout.f53842i[i11] = (int) (r12[i11] * f10);
            }
        }
        coordinatorLayout.f53849p = __fsTypeCheck_7aed730c0cb897b271b15a3fca45c160(typedArrayObtainStyledAttributes, X1.c.f41507c);
        typedArrayObtainStyledAttributes.recycle();
        a0();
    ...
    private void P() {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            this.f53835b.b(childAt);
            for (int i11 = 0; i11 < childCount; i11++) {
                if (i11 != i10) {
                    View childAt2 = getChildAt(i11);
                    if (fVarZ.b(this, childAt, childAt2)) {
                        if (!this.f53835b.d(childAt2)) {
                            this.f53835b.b(childAt2);
                        }
                        this.f53835b.a(childAt2, childAt);
                    }
                }
            }
        }
        this.f53834a.addAll(this.f53835b.j());
        Collections.reverse(this.f53834a);
    }

    private void T() {
        View view = this.f53843j;
        if (view != null) {
            c cVarF = ((f) view.getLayoutParams()).f();
            if (cVarF != null) {
                long jUptimeMillis = SystemClock.uptimeMillis();
                MotionEvent motionEventObtain = MotionEvent.obtain(jUptimeMillis, jUptimeMillis, 3, 0.0f, 0.0f, 0);
                cVarF.H(this, this.f53843j, motionEventObtain);
    ...
    */
    ...
    void S() {
        if (this.f53841h && this.f53845l != null) {
            getViewTreeObserver().removeOnPreDrawListener(this.f53845l);
        }
        this.f53846m = false;
    }

    final j Z(j jVar) {
        if (o2.c.a(this.f53847n, jVar)) {
            return jVar;
        }
        this.f53847n = jVar;
        boolean z10 = false;
    ...
    void b() {
        if (this.f53841h) {
            ...
            getViewTreeObserver().addOnPreDrawListener(this.f53845l);
        }
        this.f53846m = true;
    }
    ...
    */
    protected boolean drawChild(android.graphics.Canvas r17, android.view.View r18, long r19) {
        /*
            ...
            androidx.coordinatorlayout.widget.CoordinatorLayout$c r3 = r2.f53855a
            if (r3 == 0) goto L8f
            float r3 = r3.h(r0, r1)
            r4 = 0
            int r4 = (r3 > r4 ? 1 : (r3 == r4 ? 0 : -1))
            if (r4 <= 0) goto L8f
            android.graphics.Paint r4 = r0.f53837d
            if (r4 != 0) goto L22
        ...
        L22:
            android.graphics.Paint r4 = r0.f53837d
            androidx.coordinatorlayout.widget.CoordinatorLayout$c r2 = r2.f53855a
            int r2 = r2.g(r0, r1)
            r4.setColor(r2)
            android.graphics.Paint r2 = r0.f53837d
        ...
        L65:
            ...
            int r3 = r3 - r4
            float r14 = (float) r3
            android.graphics.Paint r15 = r0.f53837d
            r10 = r17
    ...
    public void g(View view) {
        ArrayList<View> arrayListH = this.f53835b.h(view);
    ...
    public void i(View view, View view2, int i10, int i11) {
        ...
        int i12;
        int i13;
        this.f53852s.c(view, view2, i10, i11);
        this.f53844k = view2;
        int childCount = getChildCount();
        int i14 = 0;
        ...
        for (int i15 = 0; i15 < childCount; i15++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (fVar.j(i14) && (cVarF = fVar.f()) != null) {
                    ...
                    iMax = i12 > 0 ? Math.max(iMax, this.f53838e[0]) : Math.min(iMax, this.f53838e[0]);
                    iMax2 = i13 > 0 ? Math.max(iMax2, this.f53838e[1]) : Math.min(iMax2, this.f53838e[1]);
                    z10 = true;
                }
            }
        }
    ...
    */
    ...
    protected void onRestoreInstanceState(Parcelable parcelable) {
        ...
        SparseArray<Parcelable> sparseArray = hVar.f53874c;
        int childCount = getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            View childAt = getChildAt(i10);
    ...
    public List<View> s(View view) {
        List<View> listI = this.f53835b.i(view);
        return listI == null ? Collections.EMPTY_LIST : listI;
    }

    @Override // android.view.ViewGroup
    public void setOnHierarchyChangeListener(ViewGroup.OnHierarchyChangeListener onHierarchyChangeListener) {
        this.f53850q = onHierarchyChangeListener;
    }

    public void setStatusBarBackground(Drawable drawable) {
        Drawable drawable2 = this.f53849p;
        if (drawable2 != drawable) {
            if (drawable2 != null) {
                drawable2.setCallback(null);
            }
            Drawable drawableMutate = drawable != null ? drawable.mutate() : null;
            this.f53849p = drawableMutate;
            if (drawableMutate != null) {
                if (drawableMutate.isStateful()) {
                    this.f53849p.setState(getDrawableState());
                }
                C13595a.m(this.f53849p, ViewCompat.z(this));
                this.f53849p.setVisible(getVisibility() == 0, false);
                this.f53849p.setCallback(this);
            }
            ViewCompat.d0(this);
        }
    }
    ...
    public List<View> t(View view) {
        List<View> listG = this.f53835b.g(view);
    ...
    private void A(List<View> list) {
        ...
        Comparator<View> comparator = f53832w;
        if (comparator != null) {
    ...
    private void D(View view, int i10) {
        ...
        if (this.f53847n != null && ViewCompat.w(this) && !ViewCompat.w(view)) {
            rectA.left += this.f53847n.k();
            rectA.top += this.f53847n.m();
            rectA.right -= this.f53847n.l();
            rectA.bottom -= this.f53847n.j();
        }
        Rect rectA2 = a();
        r.a(V(fVar.f53857c), view.getMeasuredWidth(), view.getMeasuredHeight(), rectA, rectA2, i10);
    ...
    private void H(View view, Rect rect, int i10) {
        ...
        if (ViewCompat.S(view) && view.getWidth() > 0 && view.getHeight() > 0) {
            ...
            int iB = r.b(fVar.f53862h, i10);
            boolean z12 = true;
            if ((iB & 48) == 48 && (i15 = (rectA.top - ((ViewGroup.MarginLayoutParams) fVar).topMargin) - fVar.f53864j) < (i16 = rect.top)) {
                Y(view, i16 - i15);
                z10 = true;
            } else {
                z10 = false;
            }
            if ((iB & 80) == 80 && (height = ((getHeight() - rectA.bottom) - ((ViewGroup.MarginLayoutParams) fVar).bottomMargin) + fVar.f53864j) < (i14 = rect.bottom)) {
                Y(view, height - i14);
                z10 = true;
            }
            if (!z10) {
            ...
            if ((iB & 3) == 3 && (i12 = (rectA.left - ((ViewGroup.MarginLayoutParams) fVar).leftMargin) - fVar.f53863i) < (i13 = rect.left)) {
                X(view, i13 - i12);
                z11 = true;
            } else {
                z11 = false;
            }
            if ((iB & 5) == 5 && (width = ((getWidth() - rectA.right) - ((ViewGroup.MarginLayoutParams) fVar).rightMargin) + fVar.f53863i) < (i11 = rect.right)) {
                X(view, width - i11);
            } else {
                z12 = z11;
            }
    ...
    static c M(Context context, AttributeSet attributeSet, String str) throws NoSuchMethodException, SecurityException {
        ...
        try {
            ThreadLocal<Map<String, Constructor<c>>> threadLocal = f53831v;
            ...
            if (constructor == null) {
                constructor = Class.forName(str, false, context.getClassLoader()).getConstructor(f53830u);
    ...
    private void a0() {
        if (ViewCompat.w(this)) {
            if (this.f53851r == null) {
                this.f53851r = new a();
            }
            ViewCompat.A0(this, this.f53851r);
    ...
    void I(View view, int i10) {
        c cVarF;
        f fVar = (f) view.getLayoutParams();
        if (fVar.f53865k != null) {
            Rect rectA = a();
            Rect rectA2 = a();
            Rect rectA3 = a();
            u(fVar.f53865k, rectA);
            boolean z10 = false;
            r(view, false, rectA2);
            int measuredWidth = view.getMeasuredWidth();
            int measuredHeight = view.getMeasuredHeight();
            ...
            if (z10 && (cVarF = fVar.f()) != null) {
                cVarF.l(this, view, fVar.f53865k);
            }
            R(rectA);
            R(rectA2);
            R(rectA3);
    ...
    public void K(View view, int i10) {
        f fVar = (f) view.getLayoutParams();
        if (!fVar.a()) {
            View view2 = fVar.f53865k;
            if (view2 != null) {
                E(view, view2, i10);
                return;
            }
            int i11 = fVar.f53859e;
            if (i11 >= 0) {
                F(view, i11, i10);
                return;
            } else {
    ...
    protected void drawableStateChanged() {
        ...
        Drawable drawable = this.f53849p;
    ...
    final List<View> getDependencySortedChildren() {
        P();
        return Collections.unmodifiableList(this.f53834a);
    }
        ...
        for (int i15 = 0; i15 < childCount; i15++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (fVar.j(i12) && (cVarF = fVar.f()) != null) {
                    ...
                    if (i10 > 0) {
                        iMin = Math.max(i13, this.f53838e[0]);
                    } else {
                        iMin = Math.min(i13, this.f53838e[0]);
                    }
                    i13 = iMin;
                    if (i11 > 0) {
                        iMin2 = Math.max(i14, this.f53838e[1]);
                    } else {
                        iMin2 = Math.min(i14, this.f53838e[1]);
                    }
                    i14 = iMin2;
                    z10 = true;
                }
    ...
    public void onAttachedToWindow() {
        ...
        if (this.f53847n == null && ViewCompat.w(this)) {
            ViewCompat.j0(this);
        }
        this.f53841h = true;
    }
    ...
    public void onDetachedFromWindow() {
        ...
        T();
        if (this.f53846m && this.f53845l != null) {
            getViewTreeObserver().removeOnPreDrawListener(this.f53845l);
        }
        View view = this.f53844k;
        if (view != null) {
    ...
    public void onDraw(Canvas canvas) {
        int iM;
        super.onDraw(canvas);
        if (this.f53848o && this.f53849p != null) {
            j jVar = this.f53847n;
            if (jVar != null) {
                iM = jVar.m();
            } else {
            ...
            if (iM > 0) {
                this.f53849p.setBounds(0, 0, getWidth(), iM);
                this.f53849p.draw(canvas);
            }
        }
    }
    ...
    protected void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int size = this.f53834a.size();
        for (int i14 = 0; i14 < size; i14++) {
            View view = this.f53834a.get(i14);
    ...
    */
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (view != null) {
            c cVarF = ((f) view.getLayoutParams()).f();
            zO = cVarF != null ? cVarF.H(this, this.f53843j, motionEvent) : false;
        } else {
            zO = O(motionEvent, 1);
        ...
        if (this.f53843j != null && actionMasked != 3) {
            if (z10) {
    ...
    public void setVisibility(int i10) {
        ...
        if (drawable != null && drawable.isVisible() != z10) {
            this.f53849p.setVisible(z10, false);
        }
    }
    ...
    protected boolean verifyDrawable(Drawable drawable) {
        if (!super.verifyDrawable(drawable) && drawable != this.f53849p) {
            return false;
        }
        return true;
    }
