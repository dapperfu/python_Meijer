...
public class MergedDataBinderMapper extends e {
    ...
    private Set<Class<? extends e>> f54312a = new HashSet();

    /* renamed from: b, reason: collision with root package name */
    private List<e> f54313b = new CopyOnWriteArrayList();

    /* renamed from: c, reason: collision with root package name */
    private List<String> f54314c = new CopyOnWriteArrayList();

    private boolean e() throws ClassNotFoundException {
        boolean z10 = false;
        for (String str : this.f54314c) {
            try {
                Class<?> cls = Class.forName(str);
                if (e.class.isAssignableFrom(cls)) {
                    d((e) cls.newInstance());
                    this.f54314c.remove(str);
                    z10 = true;
                }
    ...
    public p b(f fVar, View view, int i10) {
        Iterator<e> it = this.f54313b.iterator();
        while (it.hasNext()) {
    ...
    public void d(e eVar) {
        if (this.f54312a.add(eVar.getClass())) {
            this.f54313b.add(eVar);
