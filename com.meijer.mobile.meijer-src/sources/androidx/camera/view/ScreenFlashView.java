...
public final class ScreenFlashView extends View {
    ...
    class a implements H.i {
        ...
        /* renamed from: a, reason: collision with root package name */
        private float f47830a;

        /* renamed from: b, reason: collision with root package name */
        private ValueAnimator f47831b;
        ...
        public void a(long j10, final H.j jVar) {
            ...
            this.f47830a = ScreenFlashView.this.getBrightness();
            ScreenFlashView.this.setBrightness(1.0f);
            ValueAnimator valueAnimator = this.f47831b;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            ScreenFlashView screenFlashView = ScreenFlashView.this;
            Objects.requireNonNull(jVar);
            this.f47831b = screenFlashView.e(new Runnable() { // from class: U.g
        ...
        public void clear() {
            ...
            ScreenFlashView.this.setBrightness(this.f47830a);
        }
    }
    ...
    class b implements Animator.AnimatorListener {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Runnable f47833a;
    ...
    public ValueAnimator e(Runnable runnable) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: U.f
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ScreenFlashView.a(this.f36918a, valueAnimator);
            }
        });
    ...
    private void f(Window window) {
        if (this.f47828a != window) {
            this.f47829b = window == null ? null : new a();
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public float getBrightness() {
        Window window = this.f47828a;
        if (window != null) {
    ...
    public void setBrightness(float f10) {
        ...
        WindowManager.LayoutParams attributes = this.f47828a.getAttributes();
        attributes.screenBrightness = f10;
        this.f47828a.setAttributes(attributes);
