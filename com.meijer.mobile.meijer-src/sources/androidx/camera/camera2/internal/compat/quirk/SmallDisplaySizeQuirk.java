...
public class SmallDisplaySizeQuirk implements g0 {
    ...
    private static final Map<String, Size> f47455a;
    ...
    static boolean d() {
        return f47455a.containsKey(Build.MODEL.toUpperCase(Locale.US));
    }

    public Size c() {
        return f47455a.get(Build.MODEL.toUpperCase(Locale.US));
    }
}
