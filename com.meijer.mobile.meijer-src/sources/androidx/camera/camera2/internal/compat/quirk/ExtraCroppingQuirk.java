...
public class ExtraCroppingQuirk implements g0 {
    ...
    private static final Map<String, Range<Integer>> f47433a;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f47434a[v0.b.YUV.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f47434a[v0.b.JPEG.ordinal()] = 3;
    ...
    private static boolean d() {
        ...
        Map<String, Range<Integer>> map = f47433a;
    ...
    public Size c(v0.b bVar) {
        ...
        int i10 = a.f47434a[bVar.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 != 3) {
                    return null;
