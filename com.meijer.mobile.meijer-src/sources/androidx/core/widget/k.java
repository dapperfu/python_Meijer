...
public final class k {
    ...
    private static class e implements ActionMode.Callback {
        ...
        private final ActionMode.Callback f54306a;

        /* renamed from: b, reason: collision with root package name */
        private final TextView f54307b;

        /* renamed from: c, reason: collision with root package name */
        private Class<?> f54308c;

        /* renamed from: d, reason: collision with root package name */
        private Method f54309d;

        /* renamed from: e, reason: collision with root package name */
        private boolean f54310e;

        /* renamed from: f, reason: collision with root package name */
        private boolean f54311f = false;
        ...
        private void g(Menu menu) throws IllegalAccessException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
            Context context = this.f54307b.getContext();
            PackageManager packageManager = context.getPackageManager();
            boolean z10 = this.f54311f;
            ...
            if (!z10) {
                ...
                try {
                    ...
                    this.f54308c = cls2;
                    this.f54309d = cls2.getDeclaredMethod("removeItemAt", cls);
                    this.f54310e = true;
            ...
            try {
                Method declaredMethod = (this.f54310e && this.f54308c.isInstance(menu)) ? this.f54309d : menu.getClass().getDeclaredMethod("removeItemAt", cls);
                ...
                for (int i10 = 0; i10 < listC.size(); i10++) {
                    ...
                    menu.add(0, 0, i10 + 100, resolveInfo.loadLabel(packageManager)).setIntent(b(resolveInfo, this.f54307b)).setShowAsAction(1);
                }
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            return this.f54306a.onActionItemClicked(actionMode, menuItem);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            return this.f54306a.onCreateActionMode(actionMode, menu);
        }

        @Override // android.view.ActionMode.Callback
        public void onDestroyActionMode(ActionMode actionMode) {
            this.f54306a.onDestroyActionMode(actionMode);
        }

        e(ActionMode.Callback callback, TextView textView) {
            this.f54306a = callback;
        ...
        public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) throws IllegalAccessException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
            g(menu);
            return this.f54306a.onPrepareActionMode(actionMode, menu);
        }
    }
    ...
    public static r.a g(TextView textView) {
        ...
        r.a.C2321a c2321a = new r.a.C2321a(new TextPaint(textView.getPaint()));
        c2321a.b(a.a(textView));
        c2321a.c(a.b(textView));
        c2321a.d(f(textView));
        return c2321a.a();
    }
