...
public class ViewCompat {
    ...
    private static WeakHashMap<View, androidx.core.view.h> f54119a;

    /* renamed from: b, reason: collision with root package name */
    private static Field f54120b;

    /* renamed from: c, reason: collision with root package name */
    private static boolean f54121c;

    /* renamed from: d, reason: collision with root package name */
    private static final int[] f54122d = {Y1.e.f42805b, Y1.e.f42806c, Y1.e.f42817n, Y1.e.f42828y, Y1.e.f42785B, Y1.e.f42786C, Y1.e.f42787D, Y1.e.f42788E, Y1.e.f42789F, Y1.e.f42790G, Y1.e.f42807d, Y1.e.f42808e, Y1.e.f42809f, Y1.e.f42810g, Y1.e.f42811h, Y1.e.f42812i, Y1.e.f42813j, Y1.e.f42814k, Y1.e.f42815l, Y1.e.f42816m, Y1.e.f42818o, Y1.e.f42819p, Y1.e.f42820q, Y1.e.f42821r, Y1.e.f42822s, Y1.e.f42823t, Y1.e.f42824u, Y1.e.f42825v, Y1.e.f42826w, Y1.e.f42827x, Y1.e.f42829z, Y1.e.f42784A};

    /* renamed from: e, reason: collision with root package name */
    private static final I f54123e = new I() { // from class: p2.X
        @Override // p2.I
        public final C16348c a(C16348c c16348c) {
            return ViewCompat.a(c16348c);
        }
    };

    /* renamed from: f, reason: collision with root package name */
    private static final e f54124f = new e();

    static class e implements ViewTreeObserver.OnGlobalLayoutListener, View.OnAttachStateChangeListener {

        /* renamed from: a, reason: collision with root package name */
        private final WeakHashMap<View, Boolean> f54125a = new WeakHashMap<>();
        ...
        void a(View view) {
            this.f54125a.put(view, Boolean.valueOf(view.isShown() && view.getWindowVisibility() == 0));
        ...
        public void onGlobalLayout() {
            if (Build.VERSION.SDK_INT < 28) {
                Iterator<Map.Entry<View, Boolean>> it = this.f54125a.entrySet().iterator();
                while (it.hasNext()) {
                    b(it.next());
                }
            }
    ...
    static abstract class f<T> {
        ...
        private boolean b() {
            return Build.VERSION.SDK_INT >= this.f54128c;
        }
        ...
        T e(View view) {
            ...
            T t10 = (T) view.getTag(this.f54126a);
            if (this.f54127b.isInstance(t10)) {
                return t10;
            }
            return null;
        }
        ...
        void f(View view, T t10) {
            if (b()) {
                ...
                ViewCompat.k(view);
                view.setTag(this.f54126a, t10);
                ViewCompat.W(view, this.f54129d);
            }
        }
    }
    ...
    static class g {
        static WindowInsets a(View view, WindowInsets windowInsets) {
            return androidx.core.view.g.f54153b ? androidx.core.view.g.b(view, windowInsets) : view.dispatchApplyWindowInsets(windowInsets);
        }
    ...
    private static class h {
        ...
        class a implements View.OnApplyWindowInsetsListener {
            ...
            /* renamed from: a, reason: collision with root package name */
            androidx.core.view.j f54130a = null;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ View f54131b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ G f54132c;
            ...
            public WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
                ...
                if (i10 < 30) {
                    h.a(windowInsets, this.f54131b);
                    if (jVarC.equals(this.f54130a)) {
                        return this.f54132c.onApplyWindowInsets(view, jVarC).A();
                    }
                }
                this.f54130a = jVarC;
                androidx.core.view.j jVarOnApplyWindowInsets = this.f54132c.onApplyWindowInsets(view, jVarC);
                if (i10 >= 30) {
        ...
        static void a(WindowInsets windowInsets, View view) {
            View.OnApplyWindowInsetsListener onApplyWindowInsetsListener = (View.OnApplyWindowInsetsListener) view.getTag(Y1.e.f42803T);
        ...
        static void m(View view, G g10) {
            ...
            if (Build.VERSION.SDK_INT < 30) {
                view.setTag(Y1.e.f42796M, aVar);
            }
            if (view.getTag(Y1.e.f42795L) != null) {
                return;
            }
            if (aVar != null) {
                view.setOnApplyWindowInsetsListener(aVar);
            } else {
                view.setOnApplyWindowInsetsListener((View.OnApplyWindowInsetsListener) view.getTag(Y1.e.f42803T));
            }
        }
    ...
    static class q {
        ...
        /* renamed from: d, reason: collision with root package name */
        private static final ArrayList<WeakReference<View>> f54133d = new ArrayList<>();

        /* renamed from: a, reason: collision with root package name */
        private WeakHashMap<View, Boolean> f54134a = null;

        /* renamed from: b, reason: collision with root package name */
        private SparseArray<WeakReference<View>> f54135b = null;

        /* renamed from: c, reason: collision with root package name */
        private WeakReference<KeyEvent> f54136c = null;

        static q a(View view) {
            q qVar = (q) view.getTag(Y1.e.f42801R);
            if (qVar != null) {
                return qVar;
            }
            q qVar2 = new q();
            view.setTag(Y1.e.f42801R, qVar2);
            return qVar2;
        }

        private View c(View view, KeyEvent keyEvent) {
            WeakHashMap<View, Boolean> weakHashMap = this.f54134a;
        ...
        private SparseArray<WeakReference<View>> d() {
            if (this.f54135b == null) {
                this.f54135b = new SparseArray<>();
            }
            return this.f54135b;
        }

        private boolean e(View view, KeyEvent keyEvent) {
            ArrayList arrayList = (ArrayList) view.getTag(Y1.e.f42802S);
            if (arrayList == null) {
                return false;
            }
        ...
        private void g() {
            ...
            ArrayList<WeakReference<View>> arrayList = f54133d;
            ...
            synchronized (arrayList) {
                try {
                    if (this.f54134a == null) {
                        this.f54134a = new WeakHashMap<>();
                    }
                    for (int size = arrayList.size() - 1; size >= 0; size--) {
                        ArrayList<WeakReference<View>> arrayList2 = f54133d;
                        View view = arrayList2.get(size).get();
                        if (view == null) {
                            arrayList2.remove(size);
                        } else {
                            this.f54134a.put(view, Boolean.TRUE);
                            for (ViewParent parent = view.getParent(); parent instanceof View; parent = parent.getParent()) {
                                this.f54134a.put((View) parent, Boolean.TRUE);
                            }
                        }
                    }
                } catch (Throwable th2) {
        ...
        boolean f(KeyEvent keyEvent) {
            ...
            int iIndexOfKey;
            WeakReference<KeyEvent> weakReference = this.f54136c;
            if (weakReference != null && weakReference.get() == keyEvent) {
                return false;
            }
            this.f54136c = new WeakReference<>(keyEvent);
    ...
    public static /* synthetic */ C16348c a(C16348c c16348c) {
        return c16348c;
    }

    public static C16348c c0(View view, C16348c c16348c) {
        if (Log.isLoggable("ViewCompat", 3)) {
            FS.log_d("ViewCompat", "performReceiveContent: " + c16348c + ", view=" + view.getClass().getSimpleName() + "[" + view.getId() + "]");
        }
        if (Build.VERSION.SDK_INT >= 31) {
            return o.b(view, c16348c);
        }
        H h10 = (H) view.getTag(Y1.e.f42797N);
        if (h10 == null) {
            return v(view).a(c16348c);
        }
        C16348c c16348cA = h10.a(view, c16348c);
        if (c16348cA == null) {
            return null;
        }
        return v(view).a(c16348cA);
    }
    ...
    private static final class o {
        ...
        public static C16348c b(View view, C16348c c16348c) {
            ContentInfo contentInfoF = c16348c.f();
            ...
            return C16348c.g(contentInfoPerformReceiveContent);
        }
    }

    public static String[] C(View view) {
        return Build.VERSION.SDK_INT >= 31 ? o.a(view) : (String[]) view.getTag(Y1.e.f42798O);
    }
    ...
    private static f<CharSequence> K0() {
        return new c(Y1.e.f42800Q, CharSequence.class, 64, 30);
    }

    private static f<Boolean> b() {
        return new d(Y1.e.f42793J, Boolean.class, 28);
    }

    private static f<CharSequence> b0() {
        return new b(Y1.e.f42794K, CharSequence.class, 8, 28);
    }

    @Deprecated
    public static androidx.core.view.h f(View view) {
        if (f54119a == null) {
            f54119a = new WeakHashMap<>();
        }
        androidx.core.view.h hVar = f54119a.get(view);
        if (hVar != null) {
            return hVar;
        }
        androidx.core.view.h hVar2 = new androidx.core.view.h(view);
        f54119a.put(view, hVar2);
        return hVar2;
    }
    ...
    public static void i0(View view, y.a aVar, CharSequence charSequence, InterfaceC16593B interfaceC16593B) {
        if (interfaceC16593B == null && charSequence == null) {
            g0(view, aVar.b());
        } else {
            d(view, aVar.a(charSequence, interfaceC16593B));
        }
    }
    ...
    private static f<Boolean> l0() {
        return new a(Y1.e.f42799P, Boolean.class, 28);
    }

    public static void m0(View view, androidx.core.view.a aVar) {
        if (aVar == null && (FS.getAccessibilityDelegate(view) instanceof a.C1109a)) {
    ...
    private static List<y.a> p(View view) {
        ArrayList arrayList = (ArrayList) view.getTag(Y1.e.f42791H);
        if (arrayList != null) {
            return arrayList;
        }
        ArrayList arrayList2 = new ArrayList();
        view.setTag(Y1.e.f42791H, arrayList2);
        return arrayList2;
    }

    /* JADX WARN: Multi-variable type inference failed */
    private static I v(View view) {
        return view instanceof I ? (I) view : f54123e;
    }
    ...
    public static int c(View view, CharSequence charSequence, InterfaceC16593B interfaceC16593B) {
        int iQ = q(view, charSequence);
        if (iQ != -1) {
            d(view, new y.a(iQ, charSequence, interfaceC16593B));
        }
        return iQ;
    }
    ...
    public static void e(ViewGroup viewGroup, View view) {
        ...
        C17176b.b((View) view.getParent(), viewGroup);
    }
    ...
    public static androidx.core.view.a m(View view) {
        ...
        if (accessibilityDelegate instanceof a.C1109a) {
            return ((a.C1109a) accessibilityDelegate).f54140a;
        }
