...
class a extends e {
    ...
    private static Class<?> f54090b;

    /* renamed from: c, reason: collision with root package name */
    private static Constructor<?> f54091c;

    /* renamed from: d, reason: collision with root package name */
    private static Method f54092d;

    /* renamed from: e, reason: collision with root package name */
    private static Method f54093e;

    /* renamed from: f, reason: collision with root package name */
    private static boolean f54094f;
    ...
    private static boolean i(Object obj, String str, int i10, boolean z10) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
        l();
        try {
            return ((Boolean) f54092d.invoke(obj, str, Integer.valueOf(i10), Boolean.valueOf(z10))).booleanValue();
    ...
    private static Typeface j(Object obj) throws NoSuchMethodException, ClassNotFoundException, SecurityException, ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
        l();
        try {
            Object objNewInstance = Array.newInstance(f54090b, 1);
            Array.set(objNewInstance, 0, obj);
            return (Typeface) f54093e.invoke(null, objNewInstance);
        } catch (IllegalAccessException | InvocationTargetException e10) {
            throw new RuntimeException(e10);
        }
    }
    ...
    private static Object m() throws NoSuchMethodException, ClassNotFoundException, SecurityException {
        l();
        try {
            return f54091c.newInstance(null);
    ...
    @Override // androidx.core.graphics.e
    public Typeface a(Context context, C6324e.c cVar, Resources resources, int i10) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
        Object objM = m();
