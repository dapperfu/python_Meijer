...
public class c extends a {
    ...
    protected final Class<?> f54099g;

    /* renamed from: h, reason: collision with root package name */
    protected final Constructor<?> f54100h;

    /* renamed from: i, reason: collision with root package name */
    protected final Method f54101i;

    /* renamed from: j, reason: collision with root package name */
    protected final Method f54102j;

    /* renamed from: k, reason: collision with root package name */
    protected final Method f54103k;

    /* renamed from: l, reason: collision with root package name */
    protected final Method f54104l;

    /* renamed from: m, reason: collision with root package name */
    protected final Method f54105m;

    private Object m() {
        try {
            return this.f54100h.newInstance(null);
    ...
    private boolean o(Context context, Object obj, String str, int i10, int i11, int i12, FontVariationAxis[] fontVariationAxisArr) {
        try {
            return ((Boolean) this.f54101i.invoke(obj, context.getAssets(), str, 0, Boolean.FALSE, Integer.valueOf(i10), Integer.valueOf(i11), Integer.valueOf(i12), fontVariationAxisArr)).booleanValue();
    ...
    protected Typeface j(Object obj) throws ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
        try {
            ...
            return (Typeface) this.f54105m.invoke(null, objNewInstance, -1, -1);
        } catch (IllegalAccessException | InvocationTargetException unused) {
            return null;
        }
    }
    ...
    private boolean p(Object obj, ByteBuffer byteBuffer, int i10, int i11, int i12) {
        try {
            return ((Boolean) this.f54102j.invoke(obj, byteBuffer, Integer.valueOf(i10), null, Integer.valueOf(i11), Integer.valueOf(i12))).booleanValue();
        } catch (IllegalAccessException | InvocationTargetException unused) {
            return false;
        }
    }
    ...
    private boolean q(Object obj) {
        try {
            return ((Boolean) this.f54103k.invoke(obj, null)).booleanValue();
        } catch (IllegalAccessException | InvocationTargetException unused) {
            return false;
        }
    }
    ...
    public c() {
        ...
        this.f54099g = clsW;
        this.f54100h = constructorX;
        this.f54101i = methodT;
        this.f54102j = methodU;
        this.f54103k = methodY;
        this.f54104l = methodS;
        this.f54105m = methodV;
    }

    @Override // androidx.core.graphics.a, androidx.core.graphics.e
    public Typeface a(Context context, C6324e.c cVar, Resources resources, int i10) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (!r()) {
        ...
        C6324e.d[] dVarArrA = cVar.a();
        int length = dVarArrA.length;
        int i11 = 0;
        while (i11 < length) {
            C6324e.d dVar = dVarArrA[i11];
