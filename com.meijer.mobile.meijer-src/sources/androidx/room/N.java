...
public final class N implements B4.f, B4.e {
    ...
    @JvmField
    public static final TreeMap<Integer, N> f58623j = new TreeMap<>();
    ...
    public static final class Companion {
        ...
        public final N a(String query, int argumentCount) {
            ...
            TreeMap<Integer, N> treeMap = N.f58623j;
    ...
    public final void h() {
        TreeMap<Integer, N> treeMap = f58623j;
        synchronized (treeMap) {
