...
public final class MultiInstanceInvalidationService extends Service {
    ...
    private final RemoteCallbackList<InterfaceC6267k> callbackList = new b();

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC6268l.a binder = new a();

    @Metadata(d1 = {"\u0000-\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\b\u0004*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J!\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\b\u0010\u0005\u001a\u0004\u0018\u00010\u0004H\u0016¢\u0006\u0004\b\u0007\u0010\bJ\u001f\u0010\u000b\u001a\u00020\n2\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\t\u001a\u00020\u0006H\u0016¢\u0006\u0004\b\u000b\u0010\fJ'\u0010\u000f\u001a\u00020\n2\u0006\u0010\t\u001a\u00020\u00062\u000e\u0010\u000e\u001a\n\u0012\u0006\b\u0001\u0012\u00020\u00040\rH\u0016¢\u0006\u0004\b\u000f\u0010\u0010¨\u0006\u0011"}, d2 = {"androidx/room/MultiInstanceInvalidationService$a", "Landroidx/room/l$a;", "Landroidx/room/k;", "callback", "", "name", "", "u6", "(Landroidx/room/k;Ljava/lang/String;)I", "clientId", "", "p9", "(Landroidx/room/k;I)V", "", "tables", "U4", "(I[Ljava/lang/String;)V", "room-runtime_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
    public static final class a extends InterfaceC6268l.a {
        a() {
        }

        @Override // androidx.room.InterfaceC6268l
        public void U4(int clientId, String[] tables) {
            Intrinsics.j(tables, "tables");
            RemoteCallbackList<InterfaceC6267k> remoteCallbackListA = MultiInstanceInvalidationService.this.a();
                ...
                for (int i10 = 0; i10 < iBeginBroadcast; i10++) {
                    try {
                        ...
                        if (clientId != iIntValue && Intrinsics.e(str, str2)) {
                            try {
                                ((InterfaceC6267k) multiInstanceInvalidationService.a().getBroadcastItem(i10)).M1(tables);
        ...
        @Override // androidx.room.InterfaceC6268l
        public void p9(InterfaceC6267k callback, int clientId) {
        ...
        @Override // androidx.room.InterfaceC6268l
        public int u6(InterfaceC6267k callback, String name) {
            Intrinsics.j(callback, "callback");
            int i10 = 0;
            if (name == null) {
                return 0;
    ...
    public static final class b extends RemoteCallbackList<InterfaceC6267k> {
        b() {
        }

        @Override // android.os.RemoteCallbackList
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public void onCallbackDied(InterfaceC6267k callback, Object cookie) {
            Intrinsics.j(callback, "callback");
    ...
    public final RemoteCallbackList<InterfaceC6267k> a() {
