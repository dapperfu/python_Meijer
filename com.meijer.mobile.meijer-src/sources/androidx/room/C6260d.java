...
public final class C6260d {
    ...
    public static final class Companion {
        ...
        static final class C1156a<R> extends ContinuationImpl {

            /* renamed from: a, reason: collision with root package name */
            Object f58760a;

            /* renamed from: b, reason: collision with root package name */
            /* synthetic */ Object f58761b;

            /* renamed from: d, reason: collision with root package name */
            int f58763d;

            C1156a(Continuation<? super C1156a> continuation) {
                super(continuation);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                this.f58761b = obj;
                this.f58763d |= Integer.MIN_VALUE;
                return Companion.this.e(null, false, null, this);
            }
        }

        /* JADX INFO: Add missing generic type declarations: [R] */
        @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0003\u001a\n \u0002*\u0004\u0018\u00018\u00008\u0000\"\u0004\b\u0000\u0010\u0000*\u00020\u0001H\n"}, d2 = {"R", "Lmv/O;", "kotlin.jvm.PlatformType", "<anonymous>"}, k = 3, mv = {2, 0, 0})
        ...
        static final class b<R> extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super R>, Object> {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ Callable<R> f58765b;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            b(Callable<R> callable, Continuation<? super b> continuation) {
                super(2, continuation);
                this.f58765b = callable;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new b(this.f58765b, continuation);
            }
        ...
        static final class c<R> extends ContinuationImpl {
            ...
            public final Object invokeSuspend(Object obj) {
                this.f58770e = obj;
                this.f58772g |= Integer.MIN_VALUE;
        ...
        static final class C1157d implements Function1<Throwable, Unit> {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ CancellationSignal f58773a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ C0 f58774b;

            C1157d(CancellationSignal cancellationSignal, C0 c02) {
                this.f58773a = cancellationSignal;
                this.f58774b = c02;
            }

            public final void a(Throwable th2) {
                CancellationSignal cancellationSignal = this.f58773a;
                if (cancellationSignal != null) {
                    cancellationSignal.cancel();
                }
                C0.a.a(this.f58774b, null, 1, null);
            }
        ...
        static final class e extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ Callable<R> f58776b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ InterfaceC15815n<R> f58777c;

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new e(this.f58776b, this.f58777c, continuation);
            }

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            e(Callable<R> callable, InterfaceC15815n<? super R> interfaceC15815n, Continuation<? super e> continuation) {
                super(2, continuation);
                this.f58776b = callable;
                this.f58777c = interfaceC15815n;
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (this.f58775a == 0) {
                    ResultKt.b(obj);
                    try {
                        this.f58777c.resumeWith(Result.b(this.f58776b.call()));
                    } catch (Throwable th2) {
                        Continuation continuation = this.f58777c;
        ...
        public static final Object c(Callable callable, A4.b it) {
            Intrinsics.j(it, "it");
        ...
        @Deprecated
        @JvmStatic
        public final <R> InterfaceC16561f<R> b(G db2, boolean inTransaction, String[] tableNames, final Callable<R> callable) {
            Intrinsics.j(db2, "db");
            Intrinsics.j(tableNames, "tableNames");
            Intrinsics.j(callable, "callable");
            return C17019j.a(db2, inTransaction, tableNames, new Function1() { // from class: androidx.room.c
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return C6260d.Companion.c(callable, (A4.b) obj);
                }
            });
        }
        ...
        */
        public final <R> java.lang.Object d(androidx.room.G r17, boolean r18, android.os.CancellationSignal r19, java.util.concurrent.Callable<R> r20, kotlin.coroutines.Continuation<? super R> r21) {
            /*
                ...
                r0 = r17
                r1 = r21
                boolean r2 = r1 instanceof androidx.room.C6260d.Companion.c
                if (r2 == 0) goto L19
                r2 = r1
                androidx.room.d$a$c r2 = (androidx.room.C6260d.Companion.c) r2
                int r3 = r2.f58772g
            ...
            L19:
                ...
                r2.<init>(r1)
            L20:
                java.lang.Object r1 = r2.f58770e
                ...
                if (r5 == r7) goto L4c
                if (r5 != r6) goto L44
                java.lang.Object r0 = r2.f58769d
                kotlin.coroutines.CoroutineContext r0 = (kotlin.coroutines.CoroutineContext) r0
                java.lang.Object r0 = r2.f58768c
                java.util.concurrent.Callable r0 = (java.util.concurrent.Callable) r0
                java.lang.Object r0 = r2.f58767b
                android.os.CancellationSignal r0 = (android.os.CancellationSignal) r0
                java.lang.Object r0 = r2.f58766a
            ...
            L75:
                ...
                r2.f58772g = r7
                r8 = r18
                java.lang.Object r8 = w4.C17824b.d(r0, r8, r2)
                if (r8 != r4) goto L8a
                goto Lcb
            L8a:
                r10 = r8
                ...
                r14 = 0
                r11 = 0
                mv.C0 r0 = mv.C15805i.d(r9, r10, r11, r12, r13, r14)
            ...
            Lcc:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.room.C6260d.Companion.d(androidx.room.G, boolean, android.os.CancellationSignal, java.util.concurrent.Callable, kotlin.coroutines.Continuation):java.lang.Object");
        }
        ...
        */
        public final <R> java.lang.Object e(androidx.room.G r6, boolean r7, java.util.concurrent.Callable<R> r8, kotlin.coroutines.Continuation<? super R> r9) {
            /*
                r5 = this;
                boolean r0 = r9 instanceof androidx.room.C6260d.Companion.C1156a
                if (r0 == 0) goto L13
                r0 = r9
                androidx.room.d$a$a r0 = (androidx.room.C6260d.Companion.C1156a) r0
                int r1 = r0.f58763d
            ...
            L13:
                ...
                r0.<init>(r9)
            L18:
                java.lang.Object r9 = r0.f58761b
                java.lang.Object r1 = kotlin.coroutines.intrinsics.IntrinsicsKt.f()
                int r2 = r0.f58763d
                r3 = 2
                r4 = 1
            ...
            L51:
                r0.f58760a = r8
                r0.f58763d = r4
                java.lang.Object r9 = w4.C17824b.d(r6, r7, r0)
                if (r9 != r1) goto L5c
                goto L6e
            L5c:
                ...
                r0.f58760a = r7
                r0.f58763d = r3
                java.lang.Object r6 = mv.C15805i.g(r9, r6, r0)
                if (r6 != r1) goto L6f
            L6e:
                return r1
            L6f:
                return r6
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.room.C6260d.Companion.e(androidx.room.G, boolean, java.util.concurrent.Callable, kotlin.coroutines.Continuation):java.lang.Object");
        }
    }

    @Deprecated
    @JvmStatic
    public static final <R> InterfaceC16561f<R> a(G g10, boolean z10, String[] strArr, Callable<R> callable) {
