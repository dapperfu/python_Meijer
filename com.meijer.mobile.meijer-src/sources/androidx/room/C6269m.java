...
public final class C6269m {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final G database;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final Set<AbstractC6127A<?>> liveDataSet;

    public C6269m(G database) {
        Intrinsics.j(database, "database");
        this.database = database;
        Set<AbstractC6127A<?>> setNewSetFromMap = Collections.newSetFromMap(new IdentityHashMap());
        Intrinsics.i(setNewSetFromMap, "newSetFromMap(...)");
        this.liveDataSet = setNewSetFromMap;
    }

    public final <T> AbstractC6127A<T> a(String[] tableNames, boolean inTransaction, Callable<T> callableFunction) {
        Intrinsics.j(tableNames, "tableNames");
        Intrinsics.j(callableFunction, "callableFunction");
        return new C6279x(this.database, this, inTransaction, tableNames, callableFunction);
    }

    public final void b(AbstractC6127A<?> liveData) {
        Intrinsics.j(liveData, "liveData");
        this.liveDataSet.add(liveData);
    }

    public final void c(AbstractC6127A<?> liveData) {
        Intrinsics.j(liveData, "liveData");
