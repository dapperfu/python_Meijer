...
public abstract class O<T> extends AbstractC6127A<T> {

    /* renamed from: l, reason: collision with root package name and from kotlin metadata */
    private final G database;

    /* renamed from: m, reason: collision with root package name and from kotlin metadata */
    private final C6269m container;
    ...
    static final class a extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new a(this.f58641b, continuation);
        }
    ...
    public static final class b extends C6273q.b {

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ O<T> f58642b;
        ...
        public void c(Set<String> tables) {
            ...
            C16032c c16032cH = C16032c.h();
            final O<T> o10 = this.f58642b;
            c16032cH.b(new Runnable() { // from class: androidx.room.P
    ...
    static final class c extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new c(this.f58644b, continuation);
        }
    ...
    static final class d extends ContinuationImpl {
        ...
        /* synthetic */ Object f58647c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ O<T> f58648d;
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return this.f58648d.t(this);
        }
    }

    public /* synthetic */ O(G g10, C6269m c6269m, boolean z10, String[] strArr, DefaultConstructorMarker defaultConstructorMarker) {
        this(g10, c6269m, z10, strArr);
    }

    public abstract Object r(Continuation<? super T> continuation);

    private O(G g10, C6269m c6269m, boolean z10, String[] strArr) {
        this.database = g10;
        this.container = c6269m;
        this.inTransaction = z10;
        this.observer = new b(strArr, this);
        this.invalid = new AtomicBoolean(true);
        this.computing = new AtomicBoolean(false);
        this.registeredObserver = new AtomicBoolean(false);
        this.launchContext = g10.inCompatibilityMode$room_runtime_release() ? z10 ? g10.getTransactionContext$room_runtime_release() : g10.getQueryContext() : EmptyCoroutineContext.f143553a;
    }
    ...
    */
    public final java.lang.Object t(kotlin.coroutines.Continuation<? super kotlin.Unit> r9) {
        ...
        L13:
            ...
            r0.<init>(r8, r9)
        L18:
            java.lang.Object r9 = r0.f58647c
            ...
            if (r2 != r4) goto L37
            int r2 = r0.f58646b
            java.lang.Object r5 = r0.f58645a
        ...
        L61:
            ...
            if (r6 == 0) goto L81
            r0.f58645a = r5     // Catch: java.lang.Throwable -> L33 java.lang.Exception -> L35
            r0.f58646b = r4     // Catch: java.lang.Throwable -> L33 java.lang.Exception -> L35
            r0.f58649e = r4     // Catch: java.lang.Throwable -> L33 java.lang.Exception -> L35
    ...
    public final void s() {
        ...
        if (this.invalid.compareAndSet(false, true) && zG) {
            C15809k.d(this.database.getCoroutineScope(), this.launchContext, null, new a(this, null), 2, null);
        }
    }
    ...
    protected void k() {
        ...
        C15809k.d(this.database.getCoroutineScope(), this.launchContext, null, new c(this, null), 2, null);
    }
