...
public final class b {
    ...
    @JvmField
    public static final b f59339c = new a().a();
    ...
    public static final class Companion {
        ...
        public final b a(byte[] bytes) {
            ...
            try {
                ...
                AbstractC4373v.e().d(C4357e.f23175a, "Error in Data#fromByteArray: ", e10);
            } catch (ClassNotFoundException e11) {
                AbstractC4373v.e().d(C4357e.f23175a, "Error in Data#fromByteArray: ", e11);
            }
        ...
        public final byte[] e(b data) {
            ...
            try {
                ...
                AbstractC4373v.e().d(C4357e.f23175a, "Error in Data#toByteArray: ", e10);
                return new byte[0];
            }
        }
    ...
    static final class c extends Lambda implements Function1<Map.Entry<? extends String, ? extends Object>, CharSequence> {
        ...
        public static final c f59342f = new c();
    ...
    */
    ...
    public String toString() {
        String str = "Data {" + CollectionsKt.B0(this.values.entrySet(), null, null, null, 0, null, c.f59342f, 31, null) + "}";
