...
public final class MediaCodecUtil {
    ...
    private static final HashMap<b, List<j>> f56652a = new HashMap<>();

    /* renamed from: b, reason: collision with root package name */
    private static int f56653b = -1;
    ...
    private static final class b {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null && obj.getClass() == b.class) {
                b bVar = (b) obj;
                if (TextUtils.equals(this.f56654a, bVar.f56654a) && this.f56655b == bVar.f56655b && this.f56656c == bVar.f56656c) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            return ((((this.f56654a.hashCode() + 31) * 31) + (this.f56655b ? 1231 : 1237)) * 31) + (this.f56656c ? 1231 : 1237);
        }
    ...
    private static final class e implements c {
        ...
        /* renamed from: b, reason: collision with root package name */
        private MediaCodecInfo[] f56658b;
        ...
        private void f() {
            if (this.f56658b == null) {
                this.f56658b = new MediaCodecList(this.f56657a).getCodecInfos();
            }
        }
    ...
    public static /* synthetic */ int b(j jVar) {
        return (jVar.f56724i ? 2 : 0) + (!jVar.f56725j ? 1 : 0);
    }
    ...
    public static /* synthetic */ int d(j jVar) {
        ...
        return (P.f127888a >= 26 || !str.equals("OMX.MTK.AUDIO.DECODER.RAW")) ? 0 : -1;
    }

    private static void e(String str, List<j> list) {
        if ("audio/raw".equals(str)) {
            if (P.f127888a < 26 && Build.DEVICE.equals("R9") && list.size() == 1 && list.get(0).f56716a.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
        ...
        if (P.f127888a >= 32 || list.size() <= 1 || !"OMX.qti.audio.decoder.flac".equals(list.get(0).f56716a)) {
            return;
        }
    ...
    public static String f(t tVar) {
        ...
        if ("audio/eac3-joc".equals(tVar.f44767o)) {
            return "audio/eac3";
        }
        if ("video/dolby-vision".equals(tVar.f44767o) && (pairI = i(tVar)) != null) {
        ...
        if ("video/mv-hevc".equals(tVar.f44767o)) {
            return "video/hevc";
        }
        return null;
    }
    ...
    public static synchronized List<j> k(String str, boolean z10, boolean z11) throws DecoderQueryException {
        try {
            ...
            HashMap<b, List<j>> map = f56652a;
            List<j> list = map.get(bVar);
            if (list != null) {
                return list;
            }
            ArrayList<j> arrayListL = l(bVar, new e(z10, z11, str.equals("video/mv-hevc")));
            if (z10 && arrayListL.isEmpty() && P.f127888a <= 23) {
                arrayListL = l(bVar, new d());
                if (!arrayListL.isEmpty()) {
                    d3.r.i("MediaCodecUtil", "MediaCodecList API didn't list secure decoder for: " + str + ". Assuming: " + arrayListL.get(0).f56716a);
                }
            }
            e(str, arrayListL);
            L lS = L.s(arrayListL);
    ...
    */
    ...
    public static List<j> m(l lVar, t tVar, boolean z10, boolean z11) throws DecoderQueryException {
        List<j> listB = lVar.b(tVar.f44767o, z10, z11);
    ...
    public static Pair<Integer, Integer> q(t tVar) {
        String strH = e3.f.h(tVar.f44770r);
        if (strH == null) {
            return null;
        }
        return C13607i.q(strH, P.c1(strH.trim(), "\\."), tVar.f44740C);
    }

    private static boolean r(MediaCodecInfo mediaCodecInfo) {
        return P.f127888a >= 29 && s(mediaCodecInfo);
    }

    private static boolean u(MediaCodecInfo mediaCodecInfo, String str) {
        return P.f127888a >= 29 ? v(mediaCodecInfo) : !w(mediaCodecInfo, str);
    }
    ...
    private static boolean w(MediaCodecInfo mediaCodecInfo, String str) {
        ...
        String strE = C3106c.e(mediaCodecInfo.getName());
