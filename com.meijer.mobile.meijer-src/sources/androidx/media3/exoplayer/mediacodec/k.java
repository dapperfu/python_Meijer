...
final class k {
    ...
    private static Boolean f56728a;
    ...
    private static final class a {
        private static int b(boolean z10) {
            ...
            try {
                ...
                if (tVarN.f44767o != null) {
                    List<j> listM = MediaCodecUtil.m(l.f56729a, tVarN, z10, false);
                    for (int i10 = 0; i10 < listM.size(); i10++) {
                        if (listM.get(i10).f56719d != null && listM.get(i10).f56719d.getVideoCapabilities() != null && (supportedPerformancePoints = listM.get(i10).f56719d.getVideoCapabilities().getSupportedPerformancePoints()) != null && !supportedPerformancePoints.isEmpty()) {
                            n3.k.a();
        ...
        public static int a(MediaCodecInfo.VideoCapabilities videoCapabilities, int i10, int i11, double d10) {
            ...
            if (iC == 1 && k.f56728a == null) {
                Boolean unused = k.f56728a = Boolean.valueOf(d());
                if (k.f56728a.booleanValue()) {
                    return 0;
                }
            }
            return iC;
