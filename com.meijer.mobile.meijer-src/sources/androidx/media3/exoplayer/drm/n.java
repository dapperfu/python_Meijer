...
public final class n implements m {
    ...
    public static final m.c f56350d = new m.c() { // from class: k3.o
    ...
    private final UUID f56351a;

    /* renamed from: b, reason: collision with root package name */
    private final MediaDrm f56352b;
    ...
    private static class a {
        ...
        public static void b(MediaDrm mediaDrm, byte[] bArr, E1 e12) {
            ...
            if (!logSessionIdA.equals(LogSessionId.LOG_SESSION_ID_NONE)) {
                q.a(C13599a.e(mediaDrm.getPlaybackComponent(bArr))).setLogSessionId(logSessionIdA);
            }
        }
    }

    private boolean A() {
        if (!this.f56351a.equals(C5652i.f44653d)) {
            return this.f56351a.equals(C5652i.f44652c);
        }
    ...
    private String q(String str) {
        ...
        if (P.f127888a >= 33 && "https://default.url".equals(str)) {
            String strY = y("version");
    ...
    private static byte[] r(UUID uuid, byte[] bArr) {
        return C5652i.f44652c.equals(uuid) ? androidx.media3.exoplayer.drm.a.a(bArr) : bArr;
    }
    ...
    */
    private static byte[] s(java.util.UUID r3, byte[] r4) {
        /*
            java.util.UUID r0 = a3.C5652i.f44654e
        ...
        L18:
            ...
            R3.p$a r1 = R3.p.d(r4)
            if (r1 == 0) goto L2e
            java.util.UUID r4 = a3.C5652i.f44651b
            java.util.UUID[] r2 = r1.f31807d
            byte[] r1 = r1.f31806c
            byte[] r4 = R3.p.b(r4, r2, r1)
        L2e:
            int r1 = d3.P.f127888a
            r2 = 23
            if (r1 >= r2) goto L3c
            java.util.UUID r1 = a3.C5652i.f44653d
    ...
    private static String t(UUID uuid, String str) {
        return (P.f127888a < 26 && C5652i.f44652c.equals(uuid) && ("video/mp4".equals(str) || "audio/mp4".equals(str))) ? "cenc" : str;
    }

    private static boolean v(UUID uuid) {
        return P.f127888a < 27 && Objects.equals(uuid, C5652i.f44652c);
    }
    ...
    private static o.b z(UUID uuid, List<o.b> list) {
        if (!C5652i.f44653d.equals(uuid)) {
            return list.get(0);
        }
        if (P.f127888a >= 28 && list.size() > 1) {
            o.b bVar = list.get(0);
            int length = 0;
            for (int i10 = 0; i10 < list.size(); i10++) {
                o.b bVar2 = list.get(i10);
                byte[] bArr = (byte[]) C13599a.e(bVar2.f44698e);
                if (Objects.equals(bVar2.f44697d, bVar.f44697d) && Objects.equals(bVar2.f44696c, bVar.f44696c) && R3.p.c(bArr)) {
                    length += bArr.length;
                }
            }
            ...
            for (int i12 = 0; i12 < list.size(); i12++) {
                byte[] bArr3 = (byte[]) C13599a.e(list.get(i12).f44698e);
        ...
        for (int i13 = 0; i13 < list.size(); i13++) {
            ...
            int iG = R3.p.g((byte[]) C13599a.e(bVar3.f44698e));
            int i14 = P.f127888a;
    ...
    public Map<String, String> a(byte[] bArr) {
        return this.f56352b.queryKeyStatus(bArr);
    }

    @Override // androidx.media3.exoplayer.drm.m
    public m.d b() {
        MediaDrm.ProvisionRequest provisionRequest = this.f56352b.getProvisionRequest();
        return new m.d(provisionRequest.getData(), provisionRequest.getDefaultUrl());
    }

    @Override // androidx.media3.exoplayer.drm.m
    public byte[] c() throws MediaDrmException {
        return this.f56352b.openSession();
    }

    @Override // androidx.media3.exoplayer.drm.m
    public void d(byte[] bArr, byte[] bArr2) {
        this.f56352b.restoreKeys(bArr, bArr2);
    }

    @Override // androidx.media3.exoplayer.drm.m
    public void e(byte[] bArr) throws DeniedByServerException {
        this.f56352b.provideProvisionResponse(bArr);
    }
    ...
    public boolean h(byte[] bArr, String str) throws Throwable {
        ...
        if (P.f127888a >= 31 && A()) {
            MediaDrm mediaDrm = this.f56352b;
            return a.a(mediaDrm, str, mediaDrm.getSecurityLevel(bArr));
        }
        MediaCrypto mediaCrypto2 = null;
        try {
            try {
                mediaCrypto = new MediaCrypto(u(this.f56351a), bArr);
            } catch (Throwable th2) {
                th = th2;
            }
        ...
        try {
            ...
            boolean z10 = !this.f56351a.equals(C5652i.f44652c);
    ...
    public void i(byte[] bArr) {
        this.f56352b.closeSession(bArr);
    }

    @Override // androidx.media3.exoplayer.drm.m
    public byte[] j(byte[] bArr, byte[] bArr2) throws JSONException, DeniedByServerException, NotProvisionedException {
        if (C5652i.f44652c.equals(this.f56351a)) {
            bArr2 = androidx.media3.exoplayer.drm.a.b(bArr2);
        }
        return this.f56352b.provideKeyResponse(bArr, bArr2);
    }

    @Override // androidx.media3.exoplayer.drm.m
    public void k(final m.b bVar) {
        this.f56352b.setOnEventListener(bVar == null ? null : new MediaDrm.OnEventListener() { // from class: k3.n
            @Override // android.media.MediaDrm.OnEventListener
            public final void onEvent(MediaDrm mediaDrm, byte[] bArr, int i10, int i11, byte[] bArr2) {
                androidx.media3.exoplayer.drm.n.o(this.f141420a, bVar, mediaDrm, bArr, i10, i11, bArr2);
            }
        });
    }
    ...
    public m.a m(byte[] bArr, List<o.b> list, int i10, HashMap<String, String> map) throws NotProvisionedException {
        ...
        String strT;
        if (list != null) {
            bVarZ = z(this.f56351a, list);
            bArrS = s(this.f56351a, (byte[]) C13599a.e(bVarZ.f44698e));
            strT = t(this.f56351a, bVarZ.f44697d);
        } else {
            bVarZ = null;
            bArrS = null;
            strT = null;
        }
        MediaDrm.KeyRequest keyRequest = this.f56352b.getKeyRequest(bArr, bArrS, strT, i10, map);
        byte[] bArrR = r(this.f56351a, keyRequest.getData());
        String strQ = q(keyRequest.getDefaultUrl());
        if (TextUtils.isEmpty(strQ) && bVarZ != null && !TextUtils.isEmpty(bVarZ.f44696c)) {
            strQ = bVarZ.f44696c;
        }
        return new m.a(bArrR, strQ, P.f127888a >= 23 ? keyRequest.getRequestType() : Integer.MIN_VALUE);
    }

    @Override // androidx.media3.exoplayer.drm.m
    /* renamed from: w, reason: merged with bridge method [inline-methods] */
    public k3.l g(byte[] bArr) throws MediaCryptoException {
        return new k3.l(u(this.f56351a), bArr);
    }

    public String y(String str) {
        return this.f56352b.getPropertyString(str);
    }
    ...
    private n(UUID uuid) throws UnsupportedSchemeException {
        ...
        this.f56352b = mediaDrm;
        this.f56353c = 1;
        if (C5652i.f44653d.equals(uuid) && B()) {
            x(mediaDrm);
        }
    }
