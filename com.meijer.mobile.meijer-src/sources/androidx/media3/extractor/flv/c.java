...
final class c extends TagPayloadReader {
    ...
    private long f57533b;

    /* renamed from: c, reason: collision with root package name */
    private long[] f57534c;

    /* renamed from: d, reason: collision with root package name */
    private long[] f57535d;
    ...
    public c() {
        super(new C18074m());
        this.f57533b = -9223372036854775807L;
        this.f57534c = new long[0];
        this.f57535d = new long[0];
    }
    ...
    protected boolean c(D d10, long j10) {
        ...
        if (obj instanceof Double) {
            ...
            if (dDoubleValue > 0.0d) {
                this.f57533b = (long) (dDoubleValue * 1000000.0d);
            }
        }
        ...
        if (obj2 instanceof Map) {
            ...
            if ((obj3 instanceof List) && (obj4 instanceof List)) {
                ...
                int size = list2.size();
                this.f57534c = new long[size];
                this.f57535d = new long[size];
                for (int i10 = 0; i10 < size; i10++) {
                    Object obj5 = list.get(i10);
                    Object obj6 = list2.get(i10);
                    if ((obj6 instanceof Double) && (obj5 instanceof Double)) {
                        this.f57534c[i10] = (long) (((Double) obj6).doubleValue() * 1000000.0d);
                        this.f57535d[i10] = ((Double) obj5).longValue();
                    } else {
                        this.f57534c = new long[0];
                        this.f57535d = new long[0];
                        break;
