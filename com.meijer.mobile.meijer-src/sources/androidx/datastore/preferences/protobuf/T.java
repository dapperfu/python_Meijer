...
final class T<T> implements f0<T> {
    ...
    private static final int[] f54407r = new int[0];

    /* renamed from: s, reason: collision with root package name */
    private static final Unsafe f54408s = o0.A();

    /* renamed from: a, reason: collision with root package name */
    private final int[] f54409a;

    /* renamed from: b, reason: collision with root package name */
    private final Object[] f54410b;
    ...
    private final a0 f54416h;

    /* renamed from: i, reason: collision with root package name */
    private final boolean f54417i;

    /* renamed from: j, reason: collision with root package name */
    private final int[] f54418j;

    /* renamed from: k, reason: collision with root package name */
    private final int f54419k;

    /* renamed from: l, reason: collision with root package name */
    private final int f54420l;

    /* renamed from: m, reason: collision with root package name */
    private final V f54421m;

    /* renamed from: n, reason: collision with root package name */
    private final D f54422n;

    /* renamed from: o, reason: collision with root package name */
    private final l0<?, ?> f54423o;

    /* renamed from: p, reason: collision with root package name */
    private final AbstractC6091o<?> f54424p;

    /* renamed from: q, reason: collision with root package name */
    private final K f54425q;
    ...
    */
    static <T> androidx.datastore.preferences.protobuf.T<T> Q(androidx.datastore.preferences.protobuf.d0 r33, androidx.datastore.preferences.protobuf.V r34, androidx.datastore.preferences.protobuf.D r35, androidx.datastore.preferences.protobuf.l0<?, ?> r36, androidx.datastore.preferences.protobuf.AbstractC6091o<?> r37, androidx.datastore.preferences.protobuf.K r38) {
        /*
    ...
    */
    ...
    private boolean B(T t10, int i10, int i11) {
        Map<?, ?> mapE = this.f54425q.e(o0.z(t10, S(i10)));
        if (mapE.isEmpty()) {
            return true;
        }
        if (this.f54425q.b(s(i11)).f54398c.a() != q0.c.MESSAGE) {
            return true;
        }
        ?? C10 = 0;
    ...
    private static boolean C(Object obj) {
        ...
        if (obj instanceof AbstractC6098w) {
            return ((AbstractC6098w) obj).H();
        }
        return true;
    }
    ...
    /*  JADX ERROR: Type inference failed
        ...
        */
    private <UT, UB, ET extends androidx.datastore.preferences.protobuf.C6094s.b<ET>> void H(androidx.datastore.preferences.protobuf.l0<UT, UB> r18, androidx.datastore.preferences.protobuf.AbstractC6091o<ET> r19, T r20, androidx.datastore.preferences.protobuf.e0 r21, androidx.datastore.preferences.protobuf.C6090n r22) throws java.io.IOException {
        /*
    ...
    static <T> T<T> O(Class<T> cls, N n10, V v10, D d10, l0<?, ?> l0Var, AbstractC6091o<?> abstractC6091o, K k10) {
        return n10 instanceof d0 ? Q((d0) n10, v10, d10, l0Var, abstractC6091o, k10) : P((j0) n10, v10, d10, l0Var, abstractC6091o, k10);
    }
    ...
    private int Y(int i10) {
        if (i10 < this.f54411c || i10 > this.f54412d) {
            return -1;
        }
        return h0(i10, 0);
    }
    ...
    private int Z(int i10) {
        return this.f54409a[i10 + 2];
    }

    private <E> void a0(Object obj, long j10, e0 e0Var, f0<E> f0Var, C6090n c6090n) throws IOException {
        e0Var.P(this.f54422n.c(obj, j10), f0Var, c6090n);
    }

    private int h0(int i10, int i11) {
        int length = (this.f54409a.length / 3) - 1;
        while (i11 <= length) {
    ...
    private void i0(T t10, int i10, Object obj) {
        f54408s.putObject(t10, S(l0(i10)), obj);
        f0(t10, i10);
    }

    private void j0(T t10, int i10, int i11, Object obj) {
        f54408s.putObject(t10, S(l0(i11)), obj);
        g0(t10, i10, i11);
    }

    private int l0(int i10) {
        return this.f54409a[i10 + 1];
    }

    private <K, V> void o0(r0 r0Var, int i10, Object obj, int i11) throws IOException {
        if (obj != null) {
            r0Var.M(i10, this.f54425q.b(s(i11)), this.f54425q.e(obj));
        }
    }

    private <K, V, UT, UB> UB p(int i10, int i11, Map<K, V> map, C6100y.e eVar, UB ub2, l0<UT, UB> l0Var, Object obj) {
        I.a<?, ?> aVarB = this.f54425q.b(s(i10));
        ...
        while (it.hasNext()) {
            ...
            if (!eVar.a(((Integer) next.getValue()).intValue())) {
                ...
                AbstractC6083g.h hVarQ = AbstractC6083g.q(I.b(aVarB, next.getKey(), next.getValue()));
                try {
    ...
    private void p0(int i10, Object obj, r0 r0Var) throws IOException {
        if (obj instanceof String) {
            ...
            r0Var.K(i10, (AbstractC6083g) obj);
        }
    }

    private C6100y.e r(int i10) {
        return (C6100y.e) this.f54410b[((i10 / 3) * 2) + 1];
    }

    private Object s(int i10) {
        return this.f54410b[(i10 / 3) * 2];
    }

    private f0 t(int i10) {
        int i11 = (i10 / 3) * 2;
        f0 f0Var = (f0) this.f54410b[i11];
        if (f0Var != null) {
            return f0Var;
        }
        f0<T> f0VarC = b0.a().c((Class) this.f54410b[i11 + 1]);
        this.f54410b[i11] = f0VarC;
        return f0VarC;
    }
    ...
    public int b(T t10) {
        ...
        for (int i12 = 0; i12 < length; i12 += 3) {
            ...
            switch (k0(iL0)) {
                case 0:
                    i10 = i11 * 53;
                    iF = C6100y.f(Double.doubleToLongBits(o0.u(t10, jS)));
                    i11 = i10 + iF;
                    break;
                case 1:
                    i10 = i11 * 53;
                ...
                case 51:
                    if (E(t10, iR, i12)) {
                        i10 = i11 * 53;
                        iF = C6100y.f(Double.doubleToLongBits(U(t10, jS)));
                        i11 = i10 + iF;
                        break;
                    } else {
                        break;
        ...
        int iHashCode2 = (i11 * 53) + this.f54423o.g(t10).hashCode();
        return this.f54414f ? (iHashCode2 * 53) + this.f54424p.c(t10).hashCode() : iHashCode2;
    }
    ...
    public boolean c(T t10, T t11) {
        ...
        if (!this.f54423o.g(t10).equals(this.f54423o.g(t11))) {
            return false;
        }
        if (this.f54414f) {
            return this.f54424p.c(t10).equals(this.f54424p.c(t11));
        }
        return true;
    }
    ...
    @Override // androidx.datastore.preferences.protobuf.f0
    public T d() {
        return (T) this.f54421m.a(this.f54413e);
    }
    ...
    public int g(T t10) {
        ...
        T<T> t11 = this;
        T t12 = t10;
        Unsafe unsafe = f54408s;
        int i13 = 1048575;
        int i14 = 0;
        int i15 = 0;
        int i16 = 0;
        int i17 = 1048575;
        while (i14 < t11.f54409a.length) {
            int iL0 = t11.l0(i14);
            int iK0 = k0(iL0);
            int iR = t11.R(i14);
            int i18 = t11.f54409a[i14 + 2];
            int i19 = i18 & i13;
            if (iK0 <= 17) {
                if (i19 != i17) {
            ...
            int i20 = i16;
            long jS = S(iL0);
            if (iK0 < EnumC6095t.f54628O.a() || iK0 > EnumC6095t.f54641b0.a()) {
                i19 = 0;
            }
            switch (iK0) {
                case 0:
                ...
                case 8:
                    if (t11.y(t12, i14, i17, i15, i10)) {
                        ...
                        iX = object instanceof AbstractC6083g ? CodedOutputStream.g(iR, (AbstractC6083g) object) : CodedOutputStream.S(iR, (String) object);
                        i16 = i20 + iX;
                        t11 = this;
                        break;
                    }
                ...
                case 10:
                    if (t11.y(t12, i14, i17, i15, i10)) {
                        iX = CodedOutputStream.g(iR, (AbstractC6083g) unsafe.getObject(t12, jS));
                        i16 = i20 + iX;
                        t11 = this;
                        break;
                    }
                ...
                case 49:
                    ...
                    break;
                case 50:
                    i11 = t11.f54425q.g(iR, unsafe.getObject(t12, jS), t11.s(i14));
                    i16 = i20 + i11;
                    break;
                case 51:
                    if (t11.E(t12, iR, i14)) {
                ...
                case 59:
                    if (t11.E(t12, iR, i14)) {
                        ...
                        i11 = object2 instanceof AbstractC6083g ? CodedOutputStream.g(iR, (AbstractC6083g) object2) : CodedOutputStream.S(iR, (String) object2);
                        i16 = i20 + i11;
                        break;
                    }
                    i16 = i20;
                ...
                case 61:
                    if (t11.E(t12, iR, i14)) {
                        i11 = CodedOutputStream.g(iR, (AbstractC6083g) unsafe.getObject(t12, jS));
                        i16 = i20 + i11;
                        break;
                    }
                    i16 = i20;
        ...
        int iU2 = i16 + t11.u(t11.f54423o, t12);
        return t11.f54414f ? iU2 + t11.f54424p.c(t12).l() : iU2;
    }

    private T(int[] iArr, Object[] objArr, int i10, int i11, P p10, a0 a0Var, boolean z10, int[] iArr2, int i12, int i13, V v10, D d10, l0<?, ?> l0Var, AbstractC6091o<?> abstractC6091o, K k10) {
        boolean z11;
        this.f54409a = iArr;
        this.f54410b = objArr;
        this.f54411c = i10;
        this.f54412d = i11;
        this.f54415g = p10 instanceof AbstractC6098w;
        this.f54416h = a0Var;
        if (abstractC6091o != null && abstractC6091o.e(p10)) {
            z11 = true;
        } else {
            z11 = false;
        }
    ...
    private final <K, V> void I(Object obj, int i10, Object obj2, C6090n c6090n, e0 e0Var) throws IOException {
        long jS = S(l0(i10));
        Object objZ = o0.z(obj, jS);
        if (objZ == null) {
            objZ = this.f54425q.d(obj2);
            o0.O(obj, jS, objZ);
        } else if (this.f54425q.h(objZ)) {
            Object objD = this.f54425q.d(obj2);
            this.f54425q.a(objD, objZ);
            o0.O(obj, jS, objD);
            objZ = objD;
        }
        e0Var.N(this.f54425q.c(objZ), this.f54425q.b(obj2), c6090n);
    }
    ...
    private void L(T t10, T t11, int i10) {
        ...
        switch (k0(iL0)) {
            ...
            case 48:
            case 49:
                this.f54422n.b(t10, t11, jS);
                break;
            case 50:
                h0.F(this.f54425q, t10, t11, jS);
                break;
            case 51:
            case 52:
            case 53:
    ...
    private Object M(T t10, int i10) {
        ...
        Object object = f54408s.getObject(t10, jS);
        if (C(object)) {
            return object;
        }
        Object objD = f0VarT.d();
    ...
    private Object N(T t10, int i10, int i11) {
        ...
        Object object = f54408s.getObject(t10, S(l0(i11)));
        if (C(object)) {
            return object;
        }
        Object objD = f0VarT.d();
    ...
    static <T> T<T> P(j0 j0Var, V v10, D d10, l0<?, ?> l0Var, AbstractC6091o<?> abstractC6091o, K k10) {
        r[] rVarArrE = j0Var.e();
        if (rVarArrE.length == 0) {
            ...
            if (rVarArrE.length <= 0) {
                ...
                if (rVarArrE.length <= 0) {
                    ...
                    return new T<>(iArr, objArr, 0, 0, j0Var.b(), j0Var.c(), true, iArr4, iArrD.length, iArrD.length + iArr2.length, v10, d10, l0Var, abstractC6091o, k10);
                }
                r rVar = rVarArrE[0];
                throw null;
            }
    ...
    private <E> void b0(Object obj, int i10, e0 e0Var, f0<E> f0Var, C6090n c6090n) throws IOException {
        e0Var.K(this.f54422n.c(obj, S(i10)), f0Var, c6090n);
    }

    private void c0(Object obj, int i10, e0 e0Var) throws IOException {
        if (w(i10)) {
            o0.O(obj, S(i10), e0Var.I());
        } else if (this.f54415g) {
    ...
    private void d0(Object obj, int i10, e0 e0Var) throws IOException {
        if (w(i10)) {
            e0Var.n(this.f54422n.c(obj, S(i10)));
        } else {
            e0Var.B(this.f54422n.c(obj, S(i10)));
        }
    }
    ...
    private <UT, UB> UB o(Object obj, int i10, UB ub2, l0<UT, UB> l0Var, Object obj2) {
        ...
        return (UB) p(i10, iR, this.f54425q.c(objZ), eVarR, ub2, l0Var, obj2);
    }
            ...
            switch (k0(iL0)) {
                ...
                case 8:
                    ...
                    if (objZ instanceof String) {
                        ...
                        break;
                    } else if (objZ instanceof AbstractC6083g) {
                        zEquals = AbstractC6083g.f54456b.equals(objZ);
                        break;
                    } else {
                ...
                case 9:
                    ...
                    return true;
                case 10:
                    zEquals = AbstractC6083g.f54456b.equals(o0.z(t10, jS));
                    break;
                case 11:
                    if (o0.w(t10, jS) == 0) {
                        return false;
    ...
    public void a(T t10, T t11) {
        l(t10);
        t11.getClass();
        for (int i10 = 0; i10 < this.f54409a.length; i10 += 3) {
            L(t10, t11, i10);
        }
        h0.G(this.f54423o, t10, t11);
        if (this.f54414f) {
            h0.E(this.f54424p, t10, t11);
        }
    }
    ...
    */
    public void e(T r8) {
        /*
            ...
            goto L8e
        L8:
            boolean r0 = r8 instanceof androidx.datastore.preferences.protobuf.AbstractC6098w
            if (r0 == 0) goto L18
            r0 = r8
            androidx.datastore.preferences.protobuf.w r0 = (androidx.datastore.preferences.protobuf.AbstractC6098w) r0
            r0.t()
            r0.s()
            r0.J()
        L18:
        ...
        L39:
            goto L7d
        L3a:
            sun.misc.Unsafe r2 = androidx.datastore.preferences.protobuf.T.f54408s
            java.lang.Object r5 = r2.getObject(r8, r3)
            if (r5 == 0) goto L7d
            androidx.datastore.preferences.protobuf.K r6 = r7.f54425q
            java.lang.Object r5 = r6.f(r5)
            r2.putObject(r8, r3, r5)
            goto L7d
        L4c:
            androidx.datastore.preferences.protobuf.D r2 = r7.f54422n
            r2.a(r8, r3)
            goto L7d
        L52:
            int r2 = r7.R(r1)
            ...
            sun.misc.Unsafe r5 = androidx.datastore.preferences.protobuf.T.f54408s
        ...
        L7d:
            ...
            goto L1c
        L80:
            androidx.datastore.preferences.protobuf.l0<?, ?> r0 = r7.f54423o
            r0.j(r8)
            boolean r0 = r7.f54414f
            if (r0 == 0) goto L8e
            androidx.datastore.preferences.protobuf.o<?> r0 = r7.f54424p
            r0.f(r8)
        L8e:
            return
        */
    ...
    */
    public final boolean f(T r15) {
        ...
        L7:
            ...
            if (r8 == r3) goto L32
            if (r8 == r0) goto L2f
            sun.misc.Unsafe r3 = androidx.datastore.preferences.protobuf.T.f54408s
            long r6 = (long) r8
        ...
        L9b:
            r7 = r14
            r8 = r15
            boolean r15 = r7.f54414f
            if (r15 == 0) goto Lae
            androidx.datastore.preferences.protobuf.o<?> r15 = r7.f54424p
    ...
    @Override // androidx.datastore.preferences.protobuf.f0
    public void h(T t10, e0 e0Var, C6090n c6090n) throws IOException {
        c6090n.getClass();
        l(t10);
        H(this.f54423o, this.f54424p, t10, e0Var, c6090n);
    }
