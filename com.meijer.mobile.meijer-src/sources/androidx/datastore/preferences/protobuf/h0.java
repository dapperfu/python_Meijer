...
final class h0 {
    ...
    private static final Class<?> f54491a = B();

    /* renamed from: b, reason: collision with root package name */
    private static final l0<?, ?> f54492b = C();

    /* renamed from: c, reason: collision with root package name */
    private static final l0<?, ?> f54493c = new n0();
    ...
    static <UT, UB> UB A(Object obj, int i10, List<Integer> list, C6100y.e eVar, UB ub2, l0<UT, UB> l0Var) {
        if (eVar == null) {
            return ub2;
        }
    ...
    public static void H(Class<?> cls) {
        Class<?> cls2;
        if (!AbstractC6098w.class.isAssignableFrom(cls) && !b0.f54439d && (cls2 = f54491a) != null && !cls2.isAssignableFrom(cls)) {
    ...
    public static void N(int i10, List<AbstractC6083g> list, r0 r0Var) throws IOException {
        if (list == null || list.isEmpty()) {
            return;
        }
        r0Var.I(i10, list);
    ...
    static <UT, UB> UB z(Object obj, int i10, List<Integer> list, C6100y.d<?> dVar, UB ub2, l0<UT, UB> l0Var) {
        if (dVar == null) {
            return ub2;
        }
        if (!(list instanceof RandomAccess)) {
    ...
    static <T, FT extends C6094s.b<FT>> void E(AbstractC6091o<FT> abstractC6091o, T t10, T t11) {
        C6094s<T> c6094sC = abstractC6091o.c(t11);
        if (!c6094sC.n()) {
            abstractC6091o.d(t10).v(c6094sC);
        }
    }
    ...
    static int c(int i10, List<AbstractC6083g> list) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
    ...
    static int e(List<Integer> list) {
        ...
        if (list instanceof C6099x) {
            ...
            int iL = 0;
            while (i10 < size) {
                iL += CodedOutputStream.l(c6099x.getInt(i10));
                i10++;
            }
            return iL;
        }
    ...
    static int l(List<Integer> list) {
        ...
        if (list instanceof C6099x) {
            ...
            int iW = 0;
            while (i10 < size) {
                iW += CodedOutputStream.w(c6099x.getInt(i10));
                i10++;
            }
            return iW;
        }
    ...
    static int r(List<Integer> list) {
        ...
        if (list instanceof C6099x) {
            ...
            int iP = 0;
            while (i10 < size) {
                iP += CodedOutputStream.P(c6099x.getInt(i10));
                i10++;
            }
            return iP;
        }
    ...
    static int u(int i10, List<?> list) {
        ...
        if (list instanceof C) {
            ...
            while (i11 < size) {
                ...
                if (objC instanceof AbstractC6083g) {
                    iT2 = CodedOutputStream.h((AbstractC6083g) objC);
                } else {
        ...
        while (i11 < size) {
            ...
            if (obj instanceof AbstractC6083g) {
                iT = CodedOutputStream.h((AbstractC6083g) obj);
            } else {
