...
final class S {
    ...
    private static final char[] f54406a;
    ...
    static void d(StringBuilder sb2, int i10, String str, Object obj) throws SecurityException {
        ...
        if (obj instanceof AbstractC6083g) {
            sb2.append(": \"");
            sb2.append(k0.a((AbstractC6083g) obj));
            sb2.append('\"');
            return;
        }
        if (obj instanceof AbstractC6098w) {
            sb2.append(" {");
            e((AbstractC6098w) obj, sb2, i10 + 2);
            sb2.append("\n");
            a(i10, sb2);
            sb2.append("}");
            return;
