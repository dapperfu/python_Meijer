...
class InstrumentationActivityInvoker {
    ...
    public static class BootstrapActivity extends Activity {
        ...
        private static final String f58985c = "androidx.test.core.app.InstrumentationActivityInvoker$BootstrapActivity";

        /* renamed from: a, reason: collision with root package name */
        private final BroadcastReceiver f58986a = new BroadcastReceiver() { // from class: androidx.test.core.app.InstrumentationActivityInvoker.BootstrapActivity.1
        ...
        protected void onCreate(Bundle bundle) {
            ...
            InstrumentationActivityInvoker.d(this, this.f58986a, new IntentFilter("androidx.test.core.app.InstrumentationActivityInvoker.FINISH_BOOTSTRAP_ACTIVITY"));
        ...
        protected void onDestroy() {
            super.onDestroy();
            unregisterReceiver(this.f58986a);
        }
        ...
        protected void onResume() throws IntentSender.SendIntentException {
            ...
            if (!this.f58987b) {
                ...
                try {
                    ...
                    FS.log_e(f58985c, "Failed to start target activity.", e10);
        ...
        protected void onSaveInstanceState(Bundle bundle) {
            ...
            bundle.putBoolean("IS_TARGET_ACTIVITY_STARTED_KEY", this.f58987b);
        }
    }
    ...
    public static class EmptyActivity extends Activity {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final BroadcastReceiver f58989a = new BroadcastReceiver() { // from class: androidx.test.core.app.InstrumentationActivityInvoker.EmptyActivity.1
            @Override // android.content.BroadcastReceiver
            public void onReceive(Context context, Intent intent) {
        ...
        protected void onCreate(Bundle bundle) {
            super.onCreate(bundle);
            InstrumentationActivityInvoker.d(this, this.f58989a, new IntentFilter("androidx.test.core.app.InstrumentationActivityInvoker.FINISH_EMPTY_ACTIVITIES"));
            overridePendingTransition(0, 0);
        }
        ...
        protected void onDestroy() {
            super.onDestroy();
            unregisterReceiver(this.f58989a);
        }
    ...
    public static class EmptyFloatingActivity extends Activity {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final BroadcastReceiver f58991a = new BroadcastReceiver() { // from class: androidx.test.core.app.InstrumentationActivityInvoker.EmptyFloatingActivity.1
            @Override // android.content.BroadcastReceiver
            public void onReceive(Context context, Intent intent) {
        ...
        protected void onCreate(Bundle bundle) {
            super.onCreate(bundle);
            InstrumentationActivityInvoker.d(this, this.f58991a, new IntentFilter("androidx.test.core.app.InstrumentationActivityInvoker.FINISH_EMPTY_ACTIVITIES"));
            overridePendingTransition(0, 0);
        }
        ...
        protected void onDestroy() {
            super.onDestroy();
            unregisterReceiver(this.f58991a);
        }
