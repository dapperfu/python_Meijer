...
public class k extends f.c {
    ...
    private static final a f54858k = new a();
    ...
    static class b implements f.h {
        ...
        private final k2.e f54860b;

        /* renamed from: c, reason: collision with root package name */
        private final a f54861c;

        /* renamed from: d, reason: collision with root package name */
        private final Object f54862d = new Object();

        /* renamed from: e, reason: collision with root package name */
        private Handler f54863e;

        /* renamed from: f, reason: collision with root package name */
        private Executor f54864f;

        /* renamed from: g, reason: collision with root package name */
        private ThreadPoolExecutor f54865g;

        /* renamed from: h, reason: collision with root package name */
        f.i f54866h;

        /* renamed from: i, reason: collision with root package name */
        private ContentObserver f54867i;

        /* renamed from: j, reason: collision with root package name */
        private Runnable f54868j;

        private void b() {
            synchronized (this.f54862d) {
                try {
                    this.f54866h = null;
                    ContentObserver contentObserver = this.f54867i;
                    if (contentObserver != null) {
                        this.f54861c.c(this.f54859a, contentObserver);
                        this.f54867i = null;
                    }
                    Handler handler = this.f54863e;
                    if (handler != null) {
                        handler.removeCallbacks(this.f54868j);
                    }
                    this.f54863e = null;
                    ThreadPoolExecutor threadPoolExecutor = this.f54865g;
        ...
        private g.b e() {
            try {
                g.a aVarB = this.f54861c.b(this.f54859a, this.f54860b);
                if (aVarB.e() == 0) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            Typeface typefaceA = this.f54861c.a(this.f54859a, bVarE);
                            ByteBuffer byteBufferF = c2.h.f(this.f54859a, null, bVarE.d());
            ...
            synchronized (this.f54862d) {
                try {
                    ...
                    if (this.f54864f == null) {
                        ...
                        this.f54865g = threadPoolExecutorB;
                        this.f54864f = threadPoolExecutorB;
                    }
                    this.f54864f.execute(new Runnable() { // from class: androidx.emoji2.text.l
        ...
        b(Context context, k2.e eVar, a aVar) {
            ...
            this.f54859a = context.getApplicationContext();
            this.f54860b = eVar;
            this.f54861c = aVar;
        }
    }
    ...
    public k(Context context, k2.e eVar) {
        super(new b(context, eVar, f54858k));
    }
