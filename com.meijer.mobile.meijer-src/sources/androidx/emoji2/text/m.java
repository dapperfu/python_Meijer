...
class m {
    ...
    private static class a implements c {
        ...
        private final ByteBuffer f54870a;

        @Override // androidx.emoji2.text.m.c
        public void a(int i10) throws IOException {
            ByteBuffer byteBuffer = this.f54870a;
            byteBuffer.position(byteBuffer.position() + i10);
        }

        @Override // androidx.emoji2.text.m.c
        public int b() throws IOException {
            return this.f54870a.getInt();
        }

        @Override // androidx.emoji2.text.m.c
        public long c() throws IOException {
            return m.c(this.f54870a.getInt());
        }

        @Override // androidx.emoji2.text.m.c
        public long getPosition() {
            return this.f54870a.position();
        }

        @Override // androidx.emoji2.text.m.c
        public int readUnsignedShort() throws IOException {
            return m.d(this.f54870a.getShort());
        }

        a(ByteBuffer byteBuffer) {
            this.f54870a = byteBuffer;
    ...
    private static class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final long f54871a;

        /* renamed from: b, reason: collision with root package name */
        private final long f54872b;
