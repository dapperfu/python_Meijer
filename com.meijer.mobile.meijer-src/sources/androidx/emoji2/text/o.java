...
public final class o extends SpannableStringBuilder {
    ...
    private final Class<?> f54879a;

    /* renamed from: b, reason: collision with root package name */
    private final List<a> f54880b;

    private static class a implements TextWatcher, SpanWatcher {

        /* renamed from: a, reason: collision with root package name */
        final Object f54881a;

        /* renamed from: b, reason: collision with root package name */
        private final AtomicInteger f54882b = new AtomicInteger(0);
        ...
        final void a() {
            this.f54882b.incrementAndGet();
        }

        @Override // android.text.TextWatcher
        public void afterTextChanged(Editable editable) {
            ((TextWatcher) this.f54881a).afterTextChanged(editable);
        }

        @Override // android.text.TextWatcher
        public void beforeTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            ((TextWatcher) this.f54881a).beforeTextChanged(charSequence, i10, i11, i12);
        }

        final void c() {
            this.f54882b.decrementAndGet();
        }

        @Override // android.text.SpanWatcher
        public void onSpanAdded(Spannable spannable, Object obj, int i10, int i11) {
            if (this.f54882b.get() <= 0 || !b(obj)) {
                ((SpanWatcher) this.f54881a).onSpanAdded(spannable, obj, i10, i11);
            }
        }
        ...
        */
        public void onSpanChanged(android.text.Spannable r9, java.lang.Object r10, int r11, int r12, int r13, int r14) {
            /*
                r8 = this;
                java.util.concurrent.atomic.AtomicInteger r0 = r8.f54882b
                int r0 = r0.get()
                if (r0 <= 0) goto Lf
                boolean r0 = r8.b(r10)
                if (r0 == 0) goto Lf
            ...
            L1e:
                ...
                r6 = r13
            L20:
                java.lang.Object r11 = r8.f54881a
                r1 = r11
        ...
        public void onSpanRemoved(Spannable spannable, Object obj, int i10, int i11) {
            if (this.f54882b.get() <= 0 || !b(obj)) {
                ((SpanWatcher) this.f54881a).onSpanRemoved(spannable, obj, i10, i11);
            }
        }

        @Override // android.text.TextWatcher
        public void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            ((TextWatcher) this.f54881a).onTextChanged(charSequence, i10, i11, i12);
        }
    ...
    o(Class<?> cls, CharSequence charSequence) {
        super(charSequence);
        this.f54880b = new ArrayList();
        o2.i.h(cls, "watcherClass cannot be null");
        this.f54879a = cls;
    }

    private void b() {
        for (int i10 = 0; i10 < this.f54880b.size(); i10++) {
            this.f54880b.get(i10).a();
        }
    }

    private void e() {
        for (int i10 = 0; i10 < this.f54880b.size(); i10++) {
            this.f54880b.get(i10).onTextChanged(this, 0, length(), length());
        }
    }

    private a f(Object obj) {
        for (int i10 = 0; i10 < this.f54880b.size(); i10++) {
            a aVar = this.f54880b.get(i10);
            if (aVar.f54881a == obj) {
                return aVar;
            }
        }
    ...
    public CharSequence subSequence(int i10, int i11) {
        return new o(this.f54879a, this, i10, i11);
    }
