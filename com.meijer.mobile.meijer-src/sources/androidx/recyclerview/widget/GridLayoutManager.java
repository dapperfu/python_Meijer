...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    final SparseIntArray f58075M;

    /* renamed from: N, reason: collision with root package name */
    final SparseIntArray f58076N;
    ...
    public GridLayoutManager(Context context, AttributeSet attributeSet, int i10, int i11) {
        ...
        this.f58071I = false;
        this.f58072J = -1;
        this.f58075M = new SparseIntArray();
        this.f58076N = new SparseIntArray();
        this.f58077O = new a();
        this.f58078P = new Rect();
        w3(RecyclerView.p.w0(context, attributeSet, i10, i11).f58198b);
    }
    ...
    private void m3(RecyclerView.w wVar, RecyclerView.B b10, LinearLayoutManager.a aVar, int i10) {
        boolean z10 = i10 == 1;
        int iR3 = r3(wVar, b10, aVar.f58099b);
        if (z10) {
            while (iR3 > 0) {
                int i11 = aVar.f58099b;
                if (i11 <= 0) {
                    return;
                }
                int i12 = i11 - 1;
    ...
    private void h3(int i10) {
        this.f58073K = i3(this.f58073K, this.f58072J, i10);
    }
    ...
    private void n3() {
        View[] viewArr = this.f58074L;
        if (viewArr == null || viewArr.length != this.f58072J) {
            this.f58074L = new View[this.f58072J];
        }
    }

    private void t3(float f10, int i10) {
        h3(Math.max(Math.round(f10 * this.f58072J), i10));
    }
    ...
    public int I(RecyclerView.B b10) {
        return this.f58079Q ? k3(b10) : super.I(b10);
    }

    @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.p
    public int J(RecyclerView.B b10) {
        return this.f58079Q ? l3(b10) : super.J(b10);
    }
    ...
    void J2(RecyclerView.w wVar, RecyclerView.B b10, LinearLayoutManager.c cVar, LinearLayoutManager.b bVar) {
        ...
        int iC02;
        View viewD;
        int iL = this.f58092u.l();
        boolean z10 = iL != 1073741824;
        int i13 = b0() > 0 ? this.f58073K[this.f58072J] : 0;
        if (z10) {
            y3();
        }
        boolean z11 = cVar.f58111e == 1;
        int iR3 = this.f58072J;
        if (!z11) {
            iR3 = r3(wVar, b10, cVar.f58110d) + s3(wVar, b10, cVar.f58110d);
        }
        int i14 = 0;
        while (i14 < this.f58072J && cVar.c(b10) && iR3 > 0) {
            int i15 = cVar.f58110d;
            int iS3 = s3(wVar, b10, i15);
            if (iS3 > this.f58072J) {
                throw new IllegalArgumentException("Item at position " + i15 + " requires " + iS3 + " spans but GridLayoutManager has only " + this.f58072J + " spans.");
            }
            iR3 -= iS3;
            if (iR3 < 0 || (viewD = cVar.d(wVar)) == null) {
                break;
            }
            this.f58074L[i14] = viewD;
            i14++;
        }
        if (i14 == 0) {
            bVar.f58104b = true;
        ...
        for (int i17 = 0; i17 < i14; i17++) {
            ...
            A(view, this.f58078P);
            u3(view, iL, false);
            int iE = this.f58092u.e(view);
            if (iE > i16) {
                i16 = iE;
            }
            float f11 = (this.f58092u.f(view) * 1.0f) / ((b) view.getLayoutParams()).f58081f;
            if (f11 > f10) {
                f10 = f11;
            }
        }
        if (z10) {
            ...
            for (int i18 = 0; i18 < i14; i18++) {
                View view2 = this.f58074L[i18];
                u3(view2, 1073741824, true);
                int iE2 = this.f58092u.e(view2);
                if (iE2 > i16) {
                    i16 = iE2;
                }
            }
        ...
        for (int i19 = 0; i19 < i14; i19++) {
            View view3 = this.f58074L[i19];
            if (this.f58092u.e(view3) != i16) {
                b bVar2 = (b) view3.getLayoutParams();
                Rect rect = bVar2.f58202b;
                ...
                int iO3 = o3(bVar2.f58080e, bVar2.f58081f);
                if (this.f58090s == 1) {
        ...
        for (int i22 = 0; i22 < i14; i22++) {
            View view4 = this.f58074L[i22];
            b bVar3 = (b) view4.getLayoutParams();
            if (this.f58090s != 1) {
                paddingTop = this.f58073K[bVar3.f58080e] + getPaddingTop();
                iF2 = this.f58092u.f(view4) + paddingTop;
            } else if (H2()) {
                iF = getPaddingLeft() + this.f58073K[this.f58072J - bVar3.f58080e];
                paddingLeft = iF - this.f58092u.f(view4);
            } else {
                paddingLeft = this.f58073K[bVar3.f58080e] + getPaddingLeft();
                iF = this.f58092u.f(view4) + paddingLeft;
            }
            int i23 = iF2;
            int i24 = paddingTop;
            int i25 = iF;
            ...
            bVar.f58106d = view4.hasFocusable() | bVar.f58106d;
        }
        Arrays.fill(this.f58074L, (Object) null);
    }

    @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.p
    public int L(RecyclerView.B b10) {
        return this.f58079Q ? k3(b10) : super.L(b10);
    }

    @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.p
    public int M(RecyclerView.B b10) {
        return this.f58079Q ? l3(b10) : super.M(b10);
    }
    ...
    public RecyclerView.q V() {
        return this.f58090s == 0 ? new b(-2, -1) : new b(-1, -2);
    }
    ...
    */
    ...
    @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.p
    public boolean d2() {
        return this.f58085D == null && !this.f58071I;
    }
    ...
    void f2(RecyclerView.B b10, LinearLayoutManager.c cVar, RecyclerView.p.c cVar2) {
        int spanSize = this.f58072J;
        for (int i10 = 0; i10 < this.f58072J && cVar.c(b10) && spanSize > 0; i10++) {
            int i11 = cVar.f58110d;
            cVar2.a(i11, Math.max(0, cVar.f58113g));
            spanSize -= this.f58077O.getSpanSize(i11);
            cVar.f58110d += cVar.f58111e;
        }
    }

    @Override // androidx.recyclerview.widget.RecyclerView.p
    public void h1(RecyclerView recyclerView, int i10, int i11) {
        this.f58077O.invalidateSpanIndexCache();
        this.f58077O.invalidateSpanGroupIndexCache();
    }
    ...
    private void g3() {
        ...
        for (int i10 = 0; i10 < iB0; i10++) {
            ...
            int iB = bVar.b();
            this.f58075M.put(iB, bVar.g());
            this.f58076N.put(iB, bVar.f());
        }
    }
    ...
    private int k3(RecyclerView.B b10) {
        ...
        if (b0() != 0 && b10.b() != 0) {
            ...
            if (viewQ2 != null && viewP2 != null) {
                int cachedSpanGroupIndex = this.f58077O.getCachedSpanGroupIndex(v0(viewQ2), this.f58072J);
                int cachedSpanGroupIndex2 = this.f58077O.getCachedSpanGroupIndex(v0(viewP2), this.f58072J);
                ...
                int cachedSpanGroupIndex3 = this.f58077O.getCachedSpanGroupIndex(b10.b() - 1, this.f58072J) + 1;
                if (this.f58095x) {
                ...
                return Math.round((iMax * (Math.abs(this.f58092u.d(viewP2) - this.f58092u.g(viewQ2)) / ((this.f58077O.getCachedSpanGroupIndex(v0(viewP2), this.f58072J) - this.f58077O.getCachedSpanGroupIndex(v0(viewQ2), this.f58072J)) + 1))) + (this.f58092u.m() - this.f58092u.g(viewQ2)));
            }
        }
        return 0;
    }
    ...
    private int l3(RecyclerView.B b10) {
        if (b0() != 0 && b10.b() != 0) {
            ...
            if (viewQ2 != null && viewP2 != null) {
                if (!I2()) {
                    return this.f58077O.getCachedSpanGroupIndex(b10.b() - 1, this.f58072J) + 1;
                }
                int iD = this.f58092u.d(viewP2) - this.f58092u.g(viewQ2);
                int cachedSpanGroupIndex = this.f58077O.getCachedSpanGroupIndex(v0(viewQ2), this.f58072J);
                return (int) ((iD / ((this.f58077O.getCachedSpanGroupIndex(v0(viewP2), this.f58072J) - cachedSpanGroupIndex) + 1)) * (this.f58077O.getCachedSpanGroupIndex(b10.b() - 1, this.f58072J) + 1));
            }
        }
        return 0;
    }
    ...
    private int q3(RecyclerView.w wVar, RecyclerView.B b10, int i10) {
        if (!b10.e()) {
            return this.f58077O.getCachedSpanGroupIndex(i10, this.f58072J);
        }
        int iG = wVar.g(i10);
        if (iG == -1) {
        ...
        return this.f58077O.getCachedSpanGroupIndex(iG, this.f58072J);
    }

    private int r3(RecyclerView.w wVar, RecyclerView.B b10, int i10) {
        if (!b10.e()) {
            return this.f58077O.getCachedSpanIndex(i10, this.f58072J);
        }
        int i11 = this.f58076N.get(i10, -1);
        if (i11 != -1) {
            return i11;
        }
        int iG = wVar.g(i10);
        ...
        return this.f58077O.getCachedSpanIndex(iG, this.f58072J);
    }

    private int s3(RecyclerView.w wVar, RecyclerView.B b10, int i10) {
        if (!b10.e()) {
            return this.f58077O.getSpanSize(i10);
        }
        int i11 = this.f58075M.get(i10, -1);
        if (i11 != -1) {
            return i11;
        }
        int iG = wVar.g(i10);
        ...
        return this.f58077O.getSpanSize(iG);
    }
    ...
    private void u3(View view, int i10, boolean z10) {
        ...
        int iC02;
        b bVar = (b) view.getLayoutParams();
        Rect rect = bVar.f58202b;
        int i11 = rect.top + rect.bottom + ((ViewGroup.MarginLayoutParams) bVar).topMargin + ((ViewGroup.MarginLayoutParams) bVar).bottomMargin;
        int i12 = rect.left + rect.right + ((ViewGroup.MarginLayoutParams) bVar).leftMargin + ((ViewGroup.MarginLayoutParams) bVar).rightMargin;
        int iO3 = o3(bVar.f58080e, bVar.f58081f);
        if (this.f58090s == 1) {
            iC02 = RecyclerView.p.c0(iO3, i10, i12, ((ViewGroup.MarginLayoutParams) bVar).width, false);
            iC0 = RecyclerView.p.c0(this.f58092u.n(), p0(), i11, ((ViewGroup.MarginLayoutParams) bVar).height, true);
        } else {
            int iC03 = RecyclerView.p.c0(iO3, i10, i11, ((ViewGroup.MarginLayoutParams) bVar).height, false);
            int iC04 = RecyclerView.p.c0(this.f58092u.n(), D0(), i12, ((ViewGroup.MarginLayoutParams) bVar).width, true);
            iC0 = iC03;
            iC02 = iC04;
        }
        ...
        while (iB0 != i10) {
            ...
            if (iV0 >= 0 && iV0 < iB && r3(wVar, b10, iV0) == 0) {
                if (((RecyclerView.q) viewA0.getLayoutParams()).d()) {
                    ...
                    if (this.f58092u.g(viewA0) < i12 && this.f58092u.d(viewA0) >= iM) {
                        return viewA0;
                    }
                    if (view == null) {
                        view = viewA0;
