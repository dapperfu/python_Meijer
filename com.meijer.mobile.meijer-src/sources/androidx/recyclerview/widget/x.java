...
public abstract class x extends RecyclerView.m {
    ...
    public boolean animateChange(RecyclerView.F f10, RecyclerView.F f11, RecyclerView.m.c cVar, RecyclerView.m.c cVar2) {
        int i10;
        int i11;
        int i12 = cVar.f58172a;
        int i13 = cVar.f58173b;
        if (f11.shouldIgnore()) {
            int i14 = cVar.f58172a;
            i11 = cVar.f58173b;
            i10 = i14;
        } else {
            i10 = cVar2.f58172a;
    ...
    public boolean animateAppearance(RecyclerView.F f10, RecyclerView.m.c cVar, RecyclerView.m.c cVar2) {
        int i10;
        int i11;
        return (cVar == null || ((i10 = cVar.f58172a) == (i11 = cVar2.f58172a) && cVar.f58173b == cVar2.f58173b)) ? animateAdd(f10) : animateMove(f10, i10, cVar.f58173b, i11, cVar2.f58173b);
    }

    @Override // androidx.recyclerview.widget.RecyclerView.m
    public boolean animateDisappearance(RecyclerView.F f10, RecyclerView.m.c cVar, RecyclerView.m.c cVar2) {
        int i10 = cVar.f58172a;
        int i11 = cVar.f58173b;
        View view = f10.itemView;
        int left = cVar2 == null ? view.getLeft() : cVar2.f58172a;
        int top = cVar2 == null ? view.getTop() : cVar2.f58173b;
    ...
    public boolean animatePersistence(RecyclerView.F f10, RecyclerView.m.c cVar, RecyclerView.m.c cVar2) {
        int i10 = cVar.f58172a;
        int i11 = cVar2.f58172a;
        if (i10 != i11 || cVar.f58173b != cVar2.f58173b) {
            return animateMove(f10, i10, cVar.f58173b, i11, cVar2.f58173b);
        }
