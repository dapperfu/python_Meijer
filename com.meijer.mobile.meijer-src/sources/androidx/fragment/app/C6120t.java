...
class C6120t {
    ...
    static class b extends AnimationSet implements Runnable {
        ...
        private final ViewGroup f55331a;

        /* renamed from: b, reason: collision with root package name */
        private final View f55332b;
        ...
        public void run() {
            if (this.f55333c || !this.f55335e) {
                this.f55331a.endViewTransition(this.f55332b);
                this.f55334d = true;
            } else {
                this.f55335e = false;
                this.f55331a.post(this);
            }
        }
    ...
    private static int d(Context context, int i10, boolean z10) {
        if (i10 == 4097) {
            return z10 ? K2.a.f16256e : K2.a.f16257f;
        }
        if (i10 == 8194) {
            return z10 ? K2.a.f16252a : K2.a.f16253b;
        }
        if (i10 == 8197) {
            return z10 ? c(context, R.attr.activityCloseEnterAnimation) : c(context, R.attr.activityCloseExitAnimation);
        }
        if (i10 == 4099) {
            return z10 ? K2.a.f16254c : K2.a.f16255d;
        }
        if (i10 != 4100) {
            return -1;
        }
    ...
    static a b(Context context, Fragment fragment, boolean z10, boolean z11) throws Resources.NotFoundException {
        ...
        if (viewGroup != null && viewGroup.getTag(K2.b.f16260c) != null) {
            fragment.mContainer.setTag(K2.b.f16260c, null);
        }
    ...
    static class a {
        ...
        /* renamed from: a, reason: collision with root package name */
        public final Animation f55329a;

        /* renamed from: b, reason: collision with root package name */
        public final AnimatorSet f55330b;

        a(Animation animation) {
            this.f55329a = animation;
            this.f55330b = null;
            if (animation == null) {
