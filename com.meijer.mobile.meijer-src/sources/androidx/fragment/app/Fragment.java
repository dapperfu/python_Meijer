...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, InterfaceC6172s, h0, InterfaceC6162j, InterfaceC18089i, FSAndroidXFragment {
    ...
    AbstractC6124x<?> mHost;
    boolean mInDynamicContainer;
    boolean mInLayout;
    boolean mIsCreated;
    private Boolean mIsPrimaryNavigationFragment;
    LayoutInflater mLayoutInflater;
    C6174u mLifecycleRegistry;
    AbstractC6165l.b mMaxState;
    ...
    C18088h mSavedStateRegistryController;
    ...
    C6130D<InterfaceC6172s> mViewLifecycleOwnerLiveData;
    String mWho;

    /* JADX INFO: Add missing generic type declarations: [I] */
    class a<I> extends AbstractC14276c<I> {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ AtomicReference f54994a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ AbstractC14427a f54995b;

        a(AtomicReference atomicReference, AbstractC14427a abstractC14427a) {
            this.f54994a = atomicReference;
            this.f54995b = abstractC14427a;
        }

        @Override // g.AbstractC14276c
        public void b(I i10, androidx.core.app.d dVar) {
            AbstractC14276c abstractC14276c = (AbstractC14276c) this.f54994a.get();
            if (abstractC14276c == null) {
                throw new IllegalStateException("Operation cannot be started before fragment is in created state");
            }
            abstractC14276c.b(i10, dVar);
        }

        @Override // g.AbstractC14276c
        public void c() {
            AbstractC14276c abstractC14276c = (AbstractC14276c) this.f54994a.getAndSet(null);
            if (abstractC14276c != null) {
                abstractC14276c.c();
            }
        }
    ...
    class f extends AbstractC6121u {
        f() {
        }
    ...
    class g implements InterfaceC6169p {
        ...
        public void onStateChanged(InterfaceC6172s interfaceC6172s, AbstractC6165l.a aVar) {
            View view;
            if (aVar != AbstractC6165l.a.ON_STOP || (view = Fragment.this.mView) == null) {
                return;
            }
    ...
    class h implements InterfaceC16578a<Void, AbstractC14278e> {
        h() {
        }

        @Override // q.InterfaceC16578a
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public AbstractC14278e apply(Void r32) {
            Fragment fragment = Fragment.this;
            Object obj = fragment.mHost;
            return obj instanceof InterfaceC14279f ? ((InterfaceC14279f) obj).getActivityResultRegistry() : fragment.requireActivity().getActivityResultRegistry();
        }
    }

    class i implements InterfaceC16578a<Void, AbstractC14278e> {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ AbstractC14278e f55005a;

        i(AbstractC14278e abstractC14278e) {
            this.f55005a = abstractC14278e;
        }

        @Override // q.InterfaceC16578a
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public AbstractC14278e apply(Void r12) {
            return this.f55005a;
        }
    }
    ...
    class j extends l {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ InterfaceC16578a f55007a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ AtomicReference f55008b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ AbstractC14427a f55009c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ InterfaceC14275b f55010d;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        j(InterfaceC16578a interfaceC16578a, AtomicReference atomicReference, AbstractC14427a abstractC14427a, InterfaceC14275b interfaceC14275b) {
            super(null);
            this.f55007a = interfaceC16578a;
            this.f55008b = atomicReference;
            this.f55009c = abstractC14427a;
            this.f55010d = interfaceC14275b;
        }

        @Override // androidx.fragment.app.Fragment.l
        void a() {
            String strGenerateActivityResultKey = Fragment.this.generateActivityResultKey();
            this.f55008b.set(((AbstractC14278e) this.f55007a.apply(null)).l(strGenerateActivityResultKey, Fragment.this, this.f55009c, this.f55010d));
        }
    }
    ...
    public static class m implements Parcelable {
        ...
        public void writeToParcel(Parcel parcel, int i10) {
            parcel.writeBundle(this.f55034a);
        }
    ...
    public Fragment() {
        ...
        this.mMaxState = AbstractC6165l.b.f55503e;
        this.mViewLifecycleOwnerLiveData = new C6130D<>();
    ...
    public void onAttach(Context context) {
        ...
        Activity activityE = abstractC6124x == null ? null : abstractC6124x.getActivity();
        if (activityE != null) {
            this.mCalled = false;
            onAttach(activityE);
        }
    ...
    public void postponeEnterTransition() {
        ensureAnimationInfo().f55033v = true;
    }

    public final <I, O> AbstractC14276c<I> registerForActivityResult(AbstractC14427a<I, O> abstractC14427a, InterfaceC14275b<O> interfaceC14275b) {
        return prepareCallInternal(abstractC14427a, new h(), interfaceC14275b);
    }
    ...
    final void restoreViewState(Bundle bundle) {
        ...
        if (this.mCalled) {
            if (this.mView != null) {
                this.mViewLifecycleOwner.a(AbstractC6165l.a.ON_CREATE);
            }
        } else {
    ...
    static class k {
        ...
        ArrayList<String> f55019h;

        /* renamed from: i, reason: collision with root package name */
        ArrayList<String> f55020i;
        ...
        androidx.core.app.x f55029r;

        /* renamed from: s, reason: collision with root package name */
        androidx.core.app.x f55030s;
    ...
    private int getMinimumMaxLifecycleState() {
        AbstractC6165l.b bVar = this.mMaxState;
        return (bVar == AbstractC6165l.b.f55500b || this.mParentFragment == null) ? bVar.ordinal() : Math.min(bVar.ordinal(), this.mParentFragment.getMinimumMaxLifecycleState());
    }
    ...
    private void initLifecycle() {
        this.mLifecycleRegistry = new C6174u(this);
        this.mSavedStateRegistryController = C18088h.a(this);
    ...
    public static Fragment instantiate(Context context, String str, Bundle bundle) throws IllegalAccessException, java.lang.InstantiationException, IllegalArgumentException, InvocationTargetException {
        try {
            Fragment fragmentNewInstance = C6123w.loadFragmentClass(context.getClassLoader(), str).getConstructor(null).newInstance(null);
            if (bundle == null) {
    ...
    private <I, O> AbstractC14276c<I> prepareCallInternal(AbstractC14427a<I, O> abstractC14427a, InterfaceC16578a<Void, AbstractC14278e> interfaceC16578a, InterfaceC14275b<O> interfaceC14275b) {
        if (this.mState <= 1) {
            AtomicReference atomicReference = new AtomicReference();
            registerOnPreAttachListener(new j(interfaceC16578a, atomicReference, abstractC14427a, interfaceC14275b));
            return new a(atomicReference, abstractC14427a);
        }
    ...
    public final FragmentActivity getActivity() {
        ...
        return (FragmentActivity) abstractC6124x.getActivity();
    }

    public boolean getAllowEnterTransitionOverlap() {
        Boolean bool;
        k kVar = this.mAnimationInfo;
        if (kVar == null || (bool = kVar.f55028q) == null) {
            return true;
        }
    ...
    public boolean getAllowReturnTransitionOverlap() {
        Boolean bool;
        k kVar = this.mAnimationInfo;
        if (kVar == null || (bool = kVar.f55027p) == null) {
            return true;
        }
        return bool.booleanValue();
    }
    ...
    public Context getContext() {
        ...
        return abstractC6124x.getContext();
    }
    ...
    public f0.c getDefaultViewModelProviderFactory() {
        ...
        if (this.mDefaultFactory == null) {
            ...
            this.mDefaultFactory = new C6146U(application, this, getArguments());
        }
    ...
    ArrayList<String> getSharedElementSourceNames() {
        ...
        k kVar = this.mAnimationInfo;
        return (kVar == null || (arrayList = kVar.f55019h) == null) ? new ArrayList<>() : arrayList;
    }

    ArrayList<String> getSharedElementTargetNames() {
        ArrayList<String> arrayList;
        k kVar = this.mAnimationInfo;
        return (kVar == null || (arrayList = kVar.f55020i) == null) ? new ArrayList<>() : arrayList;
    }
    ...
    public InterfaceC6172s getViewLifecycleOwner() {
    ...
    public AbstractC6127A<InterfaceC6172s> getViewLifecycleOwnerLiveData() {
    ...
    public g0 getCom.google.android.libraries.places.api.model.PlaceTypes.STORE java.lang.String() {
        ...
        if (getMinimumMaxLifecycleState() != AbstractC6165l.b.f55500b.ordinal()) {
    ...
    void performCreate(Bundle bundle) {
        ...
        if (this.mCalled) {
            this.mLifecycleRegistry.i(AbstractC6165l.a.ON_CREATE);
            return;
        }
    ...
    void performCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        C6161i0.b(this.mView, this.mViewLifecycleOwner);
        C6163j0.b(this.mView, this.mViewLifecycleOwner);
        C18093m.b(this.mView, this.mViewLifecycleOwner);
        this.mViewLifecycleOwnerLiveData.o(this.mViewLifecycleOwner);
    }

    void performDestroy() {
        this.mChildFragmentManager.dispatchDestroy();
        this.mLifecycleRegistry.i(AbstractC6165l.a.ON_DESTROY);
        this.mState = 0;
        this.mCalled = false;
    ...
    void performDestroyView() {
        ...
        if (this.mView != null && this.mViewLifecycleOwner.getLifecycle().getState().b(AbstractC6165l.b.f55501c)) {
            this.mViewLifecycleOwner.a(AbstractC6165l.a.ON_DESTROY);
        }
        this.mState = 1;
        this.mCalled = false;
        onDestroyView();
    ...
    void performPause() {
        ...
        if (this.mView != null) {
            this.mViewLifecycleOwner.a(AbstractC6165l.a.ON_PAUSE);
        }
        this.mLifecycleRegistry.i(AbstractC6165l.a.ON_PAUSE);
        this.mState = 6;
        this.mCalled = false;
        onPause();
        if (this.mCalled) {
    ...
    void performResume() {
        ...
        C6174u c6174u = this.mLifecycleRegistry;
        AbstractC6165l.a aVar = AbstractC6165l.a.ON_RESUME;
        c6174u.i(aVar);
        if (this.mView != null) {
    ...
    void performStart() {
        ...
        C6174u c6174u = this.mLifecycleRegistry;
        AbstractC6165l.a aVar = AbstractC6165l.a.ON_START;
        c6174u.i(aVar);
        if (this.mView != null) {
            this.mViewLifecycleOwner.a(aVar);
        }
    ...
    void performStop() {
        ...
        if (this.mView != null) {
            this.mViewLifecycleOwner.a(AbstractC6165l.a.ON_STOP);
        }
        this.mLifecycleRegistry.i(AbstractC6165l.a.ON_STOP);
        this.mState = 4;
        this.mCalled = false;
        onStop();
        if (this.mCalled) {
    ...
    public final <I, O> AbstractC14276c<I> registerForActivityResult(AbstractC14427a<I, O> abstractC14427a, AbstractC14278e abstractC14278e, InterfaceC14275b<O> interfaceC14275b) {
        return prepareCallInternal(abstractC14427a, new i(abstractC14278e), interfaceC14275b);
    }
    ...
    void setAnimations(int i10, int i11, int i12, int i13) {
        ...
        ensureAnimationInfo().f55014c = i10;
        ensureAnimationInfo().f55015d = i11;
        ensureAnimationInfo().f55016e = i12;
        ensureAnimationInfo().f55017f = i13;
    }
    ...
    public void setInitialSavedState(m mVar) {
        ...
        if (mVar == null || (bundle = mVar.f55034a) == null) {
            bundle = null;
        }
    ...
    void setNextTransition(int i10) {
        ...
        ensureAnimationInfo();
        this.mAnimationInfo.f55018g = i10;
    }
    ...
    void setPopDirection(boolean z10) {
        ...
        ensureAnimationInfo().f55013b = z10;
    }
    ...
    public void startActivity(Intent intent, Bundle bundle) {
        AbstractC6124x<?> abstractC6124x = this.mHost;
        if (abstractC6124x != null) {
            abstractC6124x.n(this, intent, -1, bundle);
            return;
        }
        throw new IllegalStateException("Fragment " + this + " not attached to Activity");
    }
    ...
    public void startPostponedEnterTransition() {
        if (this.mAnimationInfo == null || !ensureAnimationInfo().f55033v) {
            return;
        }
        if (this.mHost == null) {
            ensureAnimationInfo().f55033v = false;
    ...
    public CreationExtras getDefaultViewModelCreationExtras() {
        ...
        if (getArguments() != null) {
            bVar.c(C6141O.f55432c, getArguments());
        }
        return bVar;
    }
    ...
    public LayoutInflater getLayoutInflater(Bundle bundle) {
        AbstractC6124x<?> abstractC6124x = this.mHost;
        if (abstractC6124x != null) {
            LayoutInflater layoutInflaterK = abstractC6124x.k();
            C16379s.a(layoutInflaterK, this.mChildFragmentManager.getLayoutInflaterFactory());
    ...
    public void setAllowEnterTransitionOverlap(boolean z10) {
        ensureAnimationInfo().f55028q = Boolean.valueOf(z10);
    }

    public void setAllowReturnTransitionOverlap(boolean z10) {
        ensureAnimationInfo().f55027p = Boolean.valueOf(z10);
    }

    public void setEnterSharedElementCallback(androidx.core.app.x xVar) {
        ensureAnimationInfo().f55029r = xVar;
    }

    public void setEnterTransition(Object obj) {
        ensureAnimationInfo().f55021j = obj;
    }

    public void setExitSharedElementCallback(androidx.core.app.x xVar) {
        ensureAnimationInfo().f55030s = xVar;
    }

    public void setExitTransition(Object obj) {
        ensureAnimationInfo().f55023l = obj;
    }

    void setFocusedView(View view) {
        ensureAnimationInfo().f55032u = view;
    }

    void setPostOnViewCreatedAlpha(float f10) {
        ensureAnimationInfo().f55031t = f10;
    }

    public void setReenterTransition(Object obj) {
        ensureAnimationInfo().f55024m = obj;
    }
    ...
    public void setReturnTransition(Object obj) {
        ensureAnimationInfo().f55022k = obj;
    }

    public void setSharedElementEnterTransition(Object obj) {
        ensureAnimationInfo().f55025n = obj;
    }

    void setSharedElementNames(ArrayList<String> arrayList, ArrayList<String> arrayList2) {
        ensureAnimationInfo();
        k kVar = this.mAnimationInfo;
        kVar.f55019h = arrayList;
        kVar.f55020i = arrayList2;
    }

    public void setSharedElementReturnTransition(Object obj) {
        ensureAnimationInfo().f55026o = obj;
    }
