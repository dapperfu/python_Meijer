...
public final class FragmentContainerView extends FrameLayout implements FSDispatchDraw {
    ...
    public FragmentContainerView(Context context, AttributeSet attributeSet, int i10) {
        ...
        if (attributeSet != null) {
            ...
            int[] FragmentContainerView = K2.c.f16265e;
            ...
            if (classAttribute == null) {
                classAttribute = typedArrayObtainStyledAttributes.getString(K2.c.f16266f);
                str = "android:name";
            } else {
                str = "class";
            }
    ...
    public FragmentContainerView(Context context, AttributeSet attrs, FragmentManager fm2) {
        ...
        classAttribute = classAttribute == null ? typedArrayObtainStyledAttributes.getString(K2.c.f16266f) : classAttribute;
        String string = typedArrayObtainStyledAttributes.getString(K2.c.f16267g);
        typedArrayObtainStyledAttributes.recycle();
        int id2 = getId();
