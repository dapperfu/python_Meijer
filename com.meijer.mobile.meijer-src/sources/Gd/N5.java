...
public abstract class N5 extends M4 implements List, RandomAccess {
    ...
    private static final AbstractC3637d f11803b = new L5(S5.f11848e, 0);
    ...
    static N5 m(Object[] objArr, int i10) {
        return i10 == 0 ? S5.f11848e : new S5(objArr, i10);
    }
    ...
    public final AbstractC3637d listIterator(int i10) {
        G1.b(i10, size(), "index");
        if (isEmpty()) {
            return f11803b;
        }
