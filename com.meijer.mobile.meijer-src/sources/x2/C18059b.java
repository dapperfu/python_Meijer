...
class C18059b {
    ...
    public interface InterfaceC2728b<T, V> {
        V a(T t10, int i10);
    ...
    private static class c<T> implements Comparator<T> {
        ...
        private final Rect f170097a = new Rect();

        /* renamed from: b, reason: collision with root package name */
        private final Rect f170098b = new Rect();

        /* renamed from: c, reason: collision with root package name */
        private final boolean f170099c;

        /* renamed from: d, reason: collision with root package name */
        private final a<T> f170100d;

        @Override // java.util.Comparator
        public int compare(T t10, T t11) {
            Rect rect = this.f170097a;
            Rect rect2 = this.f170098b;
            this.f170100d.a(t10, rect);
            this.f170100d.a(t11, rect2);
            int i10 = rect.top;
            int i11 = rect2.top;
            if (i10 < i11) {
                return -1;
    ...
    public static <L, T> T c(L l10, InterfaceC2728b<L, T> interfaceC2728b, a<T> aVar, T t10, Rect rect, int i10) {
        ...
        int iB = interfaceC2728b.b(l10);
        Rect rect3 = new Rect();
        T t11 = null;
        for (int i11 = 0; i11 < iB; i11++) {
            T tA = interfaceC2728b.a(l10, i11);
            if (tA != t10) {
                aVar.a(tA, rect3);
    ...
    public static <L, T> T d(L l10, InterfaceC2728b<L, T> interfaceC2728b, a<T> aVar, T t10, int i10, boolean z10, boolean z11) {
        int iB = interfaceC2728b.b(l10);
        ArrayList arrayList = new ArrayList(iB);
        for (int i11 = 0; i11 < iB; i11++) {
            arrayList.add(interfaceC2728b.a(l10, i11));
        }
