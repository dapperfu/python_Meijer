...
public final class SnapshotStateList<T> implements w, List<T>, RandomAccess, KMutableList {
    ...
    static final class b extends Lambda implements Function1<List<T>, Boolean> {
        ...
        final /* synthetic */ int f19508f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Collection<T> f19509g;
        ...
        b(int i10, Collection<? extends T> collection) {
            super(1);
            this.f19508f = i10;
            this.f19509g = collection;
        }

        @Override // kotlin.jvm.functions.Function1
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final Boolean invoke(List<T> list) {
            return Boolean.valueOf(list.addAll(this.f19508f, this.f19509g));
        }
    }
    ...
    static final class c extends Lambda implements Function1<List<T>, Boolean> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Collection<T> f19510f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        c(Collection<? extends T> collection) {
            super(1);
            this.f19510f = collection;
        }

        @Override // kotlin.jvm.functions.Function1
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final Boolean invoke(List<T> list) {
            return Boolean.valueOf(list.retainAll(this.f19510f));
        }
    }

    public SnapshotStateList(E0.e<? extends T> eVar) {
        this.firstStateRecord = v(eVar);
    }
    ...
    private final y v(E0.e<? extends T> list) {
    ...
    public final int u(Collection<? extends T> elements, int start, int end) {
        int modification;
        E0.e<T> eVarJ;
        androidx.compose.runtime.snapshots.g gVarC;
        boolean zH;
