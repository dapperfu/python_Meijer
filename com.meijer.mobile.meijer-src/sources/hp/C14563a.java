...
public final class C14563a {
    ...
    public static final C14563a f136064a = new C14563a();

    public final InterfaceC14400b b(C14399a dataSource) {
        Intrinsics.j(dataSource, "dataSource");
        return dataSource;
    }

    public final InterfaceC14401c a(HttpUrl baseUrl, OkHttpClient okHttpClient, t constructorMoshi) throws SecurityException {
        Intrinsics.j(baseUrl, "baseUrl");
        Intrinsics.j(okHttpClient, "okHttpClient");
        Intrinsics.j(constructorMoshi, "constructorMoshi");
        Object objCreate = new Retrofit.Builder().addConverterFactory(MoshiConverterFactory.create(constructorMoshi)).baseUrl(baseUrl).client(okHttpClient).build().create(InterfaceC14401c.class);
        Intrinsics.i(objCreate, "create(...)");
        return (InterfaceC14401c) objCreate;
    }
