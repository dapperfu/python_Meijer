...
public final class q {
    ...
    public static final q f159183a = new q();

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private static final SemanticsPropertyKey<Boolean> TestTagsAsResourceId = new SemanticsPropertyKey<>("TestTagsAsResourceId", false, a.f159186f);

    /* renamed from: c, reason: collision with root package name */
    public static final int f159185c = 8;
    ...
    static final class a extends Lambda implements Function2<Boolean, Boolean, Boolean> {
        ...
        public static final a f159186f = new a();
