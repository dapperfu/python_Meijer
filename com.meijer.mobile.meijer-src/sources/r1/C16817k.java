...
public final class C16817k {
    public static final SemanticsConfiguration a(InterfaceC16816j interfaceC16816j) {
        ...
        if (semanticsConfiguration != null && semanticsConfiguration.getIsMergingSemanticsOfDescendants() && !semanticsConfiguration.getIsClearingSemantics()) {
            ...
            T t10 = new T(interfaceC16816j.m().size());
            t10.r(interfaceC16816j.m());
            while (t10.h()) {
                InterfaceC16816j interfaceC16816j2 = (InterfaceC16816j) t10.A(t10._size - 1);
                SemanticsConfiguration semanticsConfiguration2 = interfaceC16816j2.getSemanticsConfiguration();
