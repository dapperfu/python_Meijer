...
public final class C15571a {
    ...
    public static final C15571a f149949a = new C15571a();

    public final InterfaceC15400a a(HttpUrl baseUrl, OkHttpClient okHttpClient, t constructorMoshi) throws SecurityException {
        Intrinsics.j(baseUrl, "baseUrl");
        Intrinsics.j(okHttpClient, "okHttpClient");
        Intrinsics.j(constructorMoshi, "constructorMoshi");
        Object objCreate = new Retrofit.Builder().addConverterFactory(MoshiConverterFactory.create(constructorMoshi)).baseUrl(baseUrl).client(okHttpClient).build().create(InterfaceC15400a.class);
        Intrinsics.i(objCreate, "create(...)");
        return (InterfaceC15400a) objCreate;
    }
