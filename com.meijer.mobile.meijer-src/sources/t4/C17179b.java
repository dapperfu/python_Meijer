...
public final class C17179b implements InterfaceC17011b {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final C17180c supportDriver;

    public C17179b(C17180c supportDriver) {
        Intrinsics.j(supportDriver, "supportDriver");
        this.supportDriver = supportDriver;
    }

    private final C17181d a() {
        String name = this.supportDriver.getOpenHelper().getName();
        if (name == null) {
            name = ":memory:";
        }
        return new C17181d(this.supportDriver.a(name));
    }

    /* renamed from: b, reason: from getter */
    public final C17180c getSupportDriver() {
    ...
    public <R> Object p0(boolean z10, Function2<? super X, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
