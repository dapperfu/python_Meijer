...
public final /* data */ class PointerInputEventData {
    ...
    public String toString() {
        return "PointerInputEventData(id=" + ((Object) C14296A.d(this.id)) + ", uptime=" + this.uptime + ", positionOnScreen=" + ((Object) U0.f.s(this.positionOnScreen)) + ", position=" + ((Object) U0.f.s(this.position)) + ", down=" + this.down + ", pressure=" + this.pressure + ", type=" + ((Object) O.i(this.type)) + ", activeHover=" + this.activeHover + ", historical=" + this.historical + ", scrollDelta=" + ((Object) U0.f.s(this.scrollDelta)) + ", originalEventPosition=" + ((Object) U0.f.s(this.originalEventPosition)) + ')';
    }
}
