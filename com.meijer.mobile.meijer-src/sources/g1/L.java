...
public final class L {
    ...
    static final class a extends Lambda implements Function1<MotionEvent, Boolean> {
        ...
        final /* synthetic */ AndroidViewHolder f133876f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(AndroidViewHolder androidViewHolder) {
            super(1);
            this.f133876f = androidViewHolder;
        }
        ...
        public final Boolean invoke(MotionEvent motionEvent) {
            ...
            switch (motionEvent.getActionMasked()) {
                ...
                case 5:
                case 6:
                    zDispatchTouchEvent = this.f133876f.dispatchTouchEvent(motionEvent);
                    break;
                default:
                    zDispatchTouchEvent = this.f133876f.dispatchGenericMotionEvent(motionEvent);
                    break;
            }
