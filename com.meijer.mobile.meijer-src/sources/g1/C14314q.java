...
public final class C14314q {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final List<PointerInputChange> changes;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final C14304g internalPointerEvent;
    ...
    public C14314q(List<PointerInputChange> list, C14304g c14304g) {
        this.changes = list;
        this.internalPointerEvent = c14304g;
        MotionEvent motionEventF = f();
        this.buttons = C14312o.a(motionEventF != null ? motionEventF.getButtonState() : 0);
    ...
    public final C14304g getInternalPointerEvent() {
        return this.internalPointerEvent;
    }

    public final MotionEvent f() {
        C14304g c14304g = this.internalPointerEvent;
        if (c14304g != null) {
            return c14304g.c();
        }
        return null;
                    ...
                    if (actionMasked != 2) {
                        switch (actionMasked) {
                            ...
                            case 7:
                                break;
                            case 8:
                                return C14316t.INSTANCE.f();
                            case 9:
                                return C14316t.INSTANCE.a();
                            case 10:
                                return C14316t.INSTANCE.b();
                            default:
                                return C14316t.INSTANCE.g();
                        }
                    }
                    return C14316t.INSTANCE.c();
                }
                return C14316t.INSTANCE.e();
            }
            return C14316t.INSTANCE.d();
        }
        List<PointerInputChange> list = this.changes;
        int size = list.size();
        for (int i10 = 0; i10 < size; i10++) {
            PointerInputChange c14297b = list.get(i10);
            if (r.d(c14297b)) {
                return C14316t.INSTANCE.e();
            }
            if (r.b(c14297b)) {
    ...
    public C14314q(List<PointerInputChange> list) {
        this(list, null);
    }
}
