...
public final class C5317u {
    ...
    static final class a implements Function3<InterfaceC14898b, Composer, Integer, Unit> {
        ...
        final /* synthetic */ LocalThemeScope f33981a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Modifier f33982b;
        ...
        a(LocalThemeScope localThemeScope, Modifier modifier, String str, String str2, String str3) {
            this.f33981a = localThemeScope;
            this.f33982b = modifier;
            this.f33983c = str;
            this.f33984d = str2;
            this.f33985e = str3;
        }
        ...
        public final void a(InterfaceC14898b AdsBox, Composer composer, int i10) {
            ...
            LocalThemeScope localThemeScope = this.f33981a;
            Modifier modifier = this.f33982b;
            ...
            C17983Z.a(androidx.compose.foundation.layout.J.d(androidx.compose.foundation.layout.J.z(companion, localThemeScope.getAdsSpacing().getThree().getDp()), 0.0f, 1, null), localThemeScope.getAdsColors().getAdsColorSupportWarning().getColor(), 0.0f, 0.0f, composer, 0, 12);
            q1.h.DrawableIcon drawableIcon = new q1.h.DrawableIcon(C.i.n.f17109d, null, null, null, 0.0f, null, androidx.compose.foundation.layout.J.z(androidx.compose.foundation.layout.J.i(androidx.compose.foundation.layout.D.m(companion, localThemeScope.getAdsSpacing().getThree().getDp(), localThemeScope.getAdsSpacing().getFive().getDp(), 0.0f, 0.0f, 12, null), localThemeScope.getAdsSpacing().getFive().getDp()), localThemeScope.getAdsSpacing().getFive().getDp()), 62, null);
            ...
            int iF = companion4.f();
            si.j.h(localThemeScope, new q1.Label(modifierM2, null, null, F1.j.h(iF), F1.t.INSTANCE.a(), false, 2, two, null, 294, null), str2, null, composer, i11 | (i12 << 3), 4);
            composer.v();
    ...
    */
    public static final void b(final Ki.LocalThemeScope r17, androidx.compose.ui.Modifier r18, final java.lang.String r19, final java.lang.String r20, final java.lang.String r21, androidx.compose.runtime.Composer r22, final int r23, final int r24) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: Rq.C5317u.b(Ki.M, androidx.compose.ui.Modifier, java.lang.String, java.lang.String, java.lang.String, androidx.compose.runtime.Composer, int, int):void");
    }
