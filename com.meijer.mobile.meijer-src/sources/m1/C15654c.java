...
public final class C15654c {
    ...
    public C15654c(Function0<Unit> function0, Rect rect, Function0<Unit> function02, Function0<Unit> function03, Function0<Unit> function04, Function0<Unit> function05, Function0<Unit> function06) {
    ...
    private final void b(Menu menu, EnumC15653b item, Function0<Unit> callback) {
    ...
    public final boolean e(ActionMode mode, Menu menu) {
        ...
        if (this.onCopyRequested != null) {
            a(menu, EnumC15653b.f150485c);
        }
        if (this.onPasteRequested != null) {
            a(menu, EnumC15653b.f150486d);
        }
        if (this.onCutRequested != null) {
            a(menu, EnumC15653b.f150487e);
        }
        if (this.onSelectAllRequested != null) {
            a(menu, EnumC15653b.f150488f);
        }
        if (this.onAutofillRequested == null || Build.VERSION.SDK_INT < 26) {
            return true;
        }
        a(menu, EnumC15653b.f150489g);
        return true;
    }
    ...
    public final void n(Menu menu) {
        b(menu, EnumC15653b.f150485c, this.onCopyRequested);
        b(menu, EnumC15653b.f150486d, this.onPasteRequested);
        b(menu, EnumC15653b.f150487e, this.onCutRequested);
        b(menu, EnumC15653b.f150488f, this.onSelectAllRequested);
        b(menu, EnumC15653b.f150489g, this.onAutofillRequested);
    }

    public final void a(Menu menu, EnumC15653b item) {
    ...
    public final boolean d(ActionMode mode, MenuItem item) {
        ...
        if (itemId == EnumC15653b.f150485c.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String()) {
            Function0<Unit> function0 = this.onCopyRequested;
            if (function0 != null) {
                function0.invoke();
            }
        } else if (itemId == EnumC15653b.f150486d.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String()) {
            Function0<Unit> function02 = this.onPasteRequested;
            if (function02 != null) {
                function02.invoke();
            }
        } else if (itemId == EnumC15653b.f150487e.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String()) {
            Function0<Unit> function03 = this.onCutRequested;
            if (function03 != null) {
                function03.invoke();
            }
        } else if (itemId == EnumC15653b.f150488f.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String()) {
            Function0<Unit> function04 = this.onSelectAllRequested;
            if (function04 != null) {
                function04.invoke();
            }
        } else if (itemId == EnumC15653b.f150489g.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String()) {
    ...
    public /* synthetic */ C15654c(Function0 function0, Rect rect, Function0 function02, Function0 function03, Function0 function04, Function0 function05, Function0 function06, int i10, DefaultConstructorMarker defaultConstructorMarker) {
