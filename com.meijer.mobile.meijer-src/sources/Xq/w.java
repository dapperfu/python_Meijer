...
public final class w {
    ...
    static final class a implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ List<StoreMapItem> f42631a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function1<StoreMapItem, Unit> f42632b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Function1<StoreMapItem, Unit> f42633c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ InterfaceC5872l0<C18545a> f42634d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ InterfaceC5872l0<Bitmap> f42635e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ InterfaceC5872l0<Paint> f42636f;

        /* JADX WARN: Multi-variable type inference failed */
        a(List<StoreMapItem> list, Function1<? super StoreMapItem, Unit> function1, Function1<? super StoreMapItem, Unit> function12, InterfaceC5872l0<C18545a> interfaceC5872l0, InterfaceC5872l0<Bitmap> interfaceC5872l02, InterfaceC5872l0<Paint> interfaceC5872l03) {
            this.f42631a = list;
            this.f42632b = function1;
            this.f42633c = function12;
            this.f42634d = interfaceC5872l0;
            this.f42635e = interfaceC5872l02;
            this.f42636f = interfaceC5872l03;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final boolean d(Function1 function1, StoreMapItem storeMapItem, C4466n it) {
            Intrinsics.j(it, "it");
            if (function1 == null) {
                return false;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final Unit e(Function1 function1, StoreMapItem storeMapItem, C4466n it) {
            Intrinsics.j(it, "it");
            if (function1 != null) {
                function1.invoke(storeMapItem);
            }
        ...
        public final void c(Composer composer, int i10) {
            Bitmap bitmapK;
            InterfaceC5872l0<C18545a> interfaceC5872l0;
            InterfaceC5872l0<Bitmap> interfaceC5872l02;
            Function1<StoreMapItem, Unit> function1;
            int i11;
            InterfaceC5872l0<Paint> interfaceC5872l03;
            ...
            List<StoreMapItem> list = this.f42631a;
            final Function1<StoreMapItem, Unit> function13 = this.f42632b;
            final Function1<StoreMapItem, Unit> function14 = this.f42633c;
            InterfaceC5872l0<C18545a> interfaceC5872l04 = this.f42634d;
            InterfaceC5872l0<Bitmap> interfaceC5872l05 = this.f42635e;
            InterfaceC5872l0<Paint> interfaceC5872l06 = this.f42636f;
            for (final StoreMapItem storeMapItem : list) {
                ...
                if (markerState == null) {
                    ...
                    interfaceC5872l03 = interfaceC5872l06;
                } else {
                    ...
                    Bitmap bitmapB = C18545a.b(w.i(interfaceC5872l04), storeMapItem.getMarker().a().intValue(), null, i12, null);
                    composer2.startReplaceGroup(1899614954);
                    if (bitmapB == null) {
                        bitmapK = null;
                    } else {
                        composer2.startReplaceGroup(1343896346);
                        bitmapK = w.k(interfaceC5872l05);
                        ...
                        if (markerId != null) {
                            w.d(canvas, w.j(interfaceC5872l06), markerId, composer2, 0);
                        }
                        composer2.P();
                        composer2.P();
                    }
                    composer2.P();
                    C4455c c4455cB = bitmapK != null ? C4456d.b(bitmapK) : null;
                    composer2.P();
                    ...
                    if (zV || objB == Composer.INSTANCE.a()) {
                        objB = new Function1() { // from class: Xq.u
                            ...
                            public final Object invoke(Object obj) {
                                return Boolean.valueOf(w.a.d(function13, storeMapItem, (C4466n) obj));
                            }
                        };
                        composer2.t(objB);
                    }
                    ...
                    if (zV2 || objB2 == Composer.INSTANCE.a()) {
                        objB2 = new Function1() { // from class: Xq.v
                            @Override // kotlin.jvm.functions.Function1
                            public final Object invoke(Object obj) {
                                return w.a.e(function14, storeMapItem, (C4466n) obj);
                            }
                        };
                        composer2.t(objB2);
                    }
                    ...
                    interfaceC5872l03 = interfaceC5872l06;
                    function12 = function14;
                    MarkerKt.m51Markerqld6geY(markerState, null, 0.0f, 0L, false, false, c4455cB, 0L, 0.0f, snippet, null, title, false, 0.0f, function15, (Function1) objB2, null, null, composer, MarkerState.$stable, 0, 210366);
                }
                composer.P();
                composer2 = composer;
                function14 = function12;
                interfaceC5872l04 = interfaceC5872l0;
                interfaceC5872l06 = interfaceC5872l03;
                interfaceC5872l05 = interfaceC5872l02;
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit h(LocalThemeScope localThemeScope, Modifier modifier, List list, List list2, LatLng latLng, float f10, InterfaceC14882C interfaceC14882C, String str, Function1 function1, Function1 function12, Function1 function13, Function1 function14, Function0 function0, Function0 function02, Function1 function15, ComposeMapColorScheme composeMapColorScheme, int i10, int i11, int i12, Composer composer, int i13) throws Resources.NotFoundException {
        f(localThemeScope, modifier, list, list2, latLng, f10, interfaceC14882C, str, function1, function12, function13, function14, function0, function02, function15, composeMapColorScheme, composer, J0.a(i10 | 1), J0.a(i11), i12);
        return Unit.f143329a;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final C18545a i(InterfaceC5872l0<C18545a> interfaceC5872l0) {
        return interfaceC5872l0.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Paint j(InterfaceC5872l0<Paint> interfaceC5872l0) {
        return interfaceC5872l0.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Bitmap k(InterfaceC5872l0<Bitmap> interfaceC5872l0) {
        return interfaceC5872l0.getValue();
    }
}
