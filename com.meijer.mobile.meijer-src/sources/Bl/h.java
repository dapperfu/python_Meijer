...
public final class h {
    ...
    public static final Intent b(Context context, Pp.b searchType, Bundle bundle, String searchTerm, boolean isDeepLink, Uri deeplink) {
        ...
        if (!StringsKt.s0(searchTerm == null ? "" : searchTerm)) {
