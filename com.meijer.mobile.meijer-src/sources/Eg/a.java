...
public final class a {
    ...
    private static final int[] f7460g = {3808, 476, 2107, 1799};

    /* renamed from: a, reason: collision with root package name */
    private final Ig.b f7461a;
    ...
    static final class b {
        ...
        o c() {
            return new o(this.f7469a, this.f7470b);
        }
    ...
    private int e(o[] oVarArr) throws NotFoundException {
        ...
        C0149a c0149aH = h(j12, this.f7462b);
        int iA = c0149aH.a();
        if (this.f7462b) {
            this.f7463c = (iA >> 6) + 1;
            this.f7464d = (iA & 63) + 1;
    ...
    private o[] f(b bVar) throws NotFoundException {
        ...
        while (this.f7465e < 9) {
            ...
            if (this.f7465e > 2) {
                double dB = (b(bVarJ4, bVarJ) * this.f7465e) / (b(bVar4, bVar) * (this.f7465e + 2));
        ...
        this.f7462b = i10 == 5;
        return d(new o[]{new o(bVar.a() + 0.5f, bVar.b() - 0.5f), new o(bVar2.a() + 0.5f, bVar2.b() + 0.5f), new o(bVar3.a() - 0.5f, bVar3.b() + 0.5f), new o(bVar4.a() - 0.5f, bVar4.b() - 0.5f)}, (r0 * 2) - 3, this.f7465e * 2);
    }

    private static C0149a h(long j10, boolean z10) throws NotFoundException {
        int i10;
        int i11;
        if (z10) {
            i10 = 7;
        ...
        try {
            int iA = new c(Kg.a.f16618k).a(iArr, i12);
            int i14 = 0;
            for (int i15 = 0; i15 < i11; i15++) {
                i14 = (i14 << 4) + iArr[i15];
            }
            return new C0149a(i14, iA);
    ...
    private b k() {
        ...
        o oVarC5;
        try {
            o[] oVarArrC = new Jg.b(this.f7461a).c();
            oVar2 = oVarArrC[0];
            oVar3 = oVarArrC[1];
            oVar = oVarArrC[2];
            oVarC = oVarArrC[3];
        } catch (NotFoundException unused) {
            int iM = this.f7461a.m() / 2;
            int iJ = this.f7461a.j() / 2;
            int i10 = iM + 7;
            int i11 = iJ - 7;
        ...
        int iC = Jg.a.c((((oVar2.c() + oVarC.c()) + oVar3.c()) + oVar.c()) / 4.0f);
        int iC2 = Jg.a.c((((oVar2.d() + oVarC.d()) + oVar3.d()) + oVar.d()) / 4.0f);
        try {
            o[] oVarArrC2 = new Jg.b(this.f7461a, 15, iC, iC2).c();
            oVarC2 = oVarArrC2[0];
            oVarC3 = oVarArrC2[1];
            oVarC4 = oVarArrC2[2];
            oVarC5 = oVarArrC2[3];
        ...
        return new b(Jg.a.c((((oVarC2.c() + oVarC5.c()) + oVarC3.c()) + oVarC4.c()) / 4.0f), Jg.a.c((((oVarC2.d() + oVarC5.d()) + oVarC3.d()) + oVarC4.d()) / 4.0f));
    }
    ...
    private static int m(int[] iArr, int i10) throws NotFoundException {
        ...
        for (int i14 = 0; i14 < 4; i14++) {
            if (Integer.bitCount(f7460g[i14] ^ i13) <= 2) {
                return i14;
            }
        }
        throw NotFoundException.a();
    ...
    private o[] l(o[] oVarArr) {
        return d(oVarArr, this.f7465e * 2, i());
    }

    private boolean n(int i10, int i11) {
        return i10 >= 0 && i10 < this.f7461a.m() && i11 >= 0 && i11 < this.f7461a.j();
    }

    private boolean p(b bVar, b bVar2, b bVar3, b bVar4) {
        b bVar5 = new b(Math.max(0, bVar.a() - 3), Math.min(this.f7461a.j() - 1, bVar.b() + 3));
        b bVar6 = new b(Math.max(0, bVar2.a() - 3), Math.max(0, bVar2.b() - 3));
        b bVar7 = new b(Math.min(this.f7461a.m() - 1, bVar3.a() + 3), Math.max(0, Math.min(this.f7461a.j() - 1, bVar3.b() - 3)));
        b bVar8 = new b(Math.min(this.f7461a.m() - 1, bVar4.a() + 3), Math.min(this.f7461a.j() - 1, bVar4.b() + 3));
    ...
    private static float b(b bVar, b bVar2) {
        return Jg.a.b(bVar.a(), bVar.b(), bVar2.a(), bVar2.b());
    }

    private static float c(o oVar, o oVar2) {
        return Jg.a.a(oVar.c(), oVar.d(), oVar2.c(), oVar2.d());
    }
    ...
    private int g(b bVar, b bVar2) {
        ...
        float fA2 = bVar.a();
        float fB3 = bVar.b();
        boolean zF = this.f7461a.f(bVar.a(), bVar.b());
        int iFloor = (int) Math.floor(fB);
        int i10 = 0;
        for (int i11 = 0; i11 < iFloor; i11++) {
            if (this.f7461a.f(Jg.a.c(fA2), Jg.a.c(fB3)) != zF) {
                i10++;
            }
            fA2 += fA;
            fB3 += fB2;
    ...
    private b j(b bVar, boolean z10, int i10, int i11) {
        ...
        while (true) {
            iB += i11;
            if (!n(iA, iB) || this.f7461a.f(iA, iB) != z10) {
                break;
            }
            iA += i10;
        }
        int i12 = iA - i10;
        int i13 = iB - i11;
        while (n(i12, i13) && this.f7461a.f(i12, i13) == z10) {
            i12 += i10;
        }
        int i14 = i12 - i10;
        while (n(i14, i13) && this.f7461a.f(i14, i13) == z10) {
            i13 += i11;
        }
    ...
    private boolean o(o oVar) {
        return n(Jg.a.c(oVar.c()), Jg.a.c(oVar.d()));
    }

    private Ig.b q(Ig.b bVar, o oVar, o oVar2, o oVar3, o oVar4) throws NotFoundException {
        l lVarB = l.b();
        int i10 = i();
        float f10 = i10 / 2.0f;
        int i11 = this.f7465e;
    ...
    private int r(o oVar, o oVar2, int i10) {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            float f11 = i12;
            if (this.f7461a.f(Jg.a.c((f11 * fC3) + fC2), Jg.a.c((f11 * fD2) + fD))) {
                i11 |= 1 << ((i10 - i12) - 1);
            }
        }
        return i11;
    ...
    public Cg.a a(boolean z10) throws NotFoundException {
        o[] oVarArrF = f(k());
        if (z10) {
            o oVar = oVarArrF[0];
        ...
        int iE = e(oVarArrF);
        Ig.b bVar = this.f7461a;
        int i10 = this.f7466f;
        return new Cg.a(q(bVar, oVarArrF[i10 % 4], oVarArrF[(i10 + 1) % 4], oVarArrF[(i10 + 2) % 4], oVarArrF[(i10 + 3) % 4]), l(oVarArrF), this.f7462b, this.f7464d, this.f7463c, iE);
    }
}
