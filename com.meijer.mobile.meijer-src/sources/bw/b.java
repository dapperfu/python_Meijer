...
public final class b implements e {
    ...
    public boolean equals(Object other) {
        if (other != this) {
            return (other instanceof b) && Intrinsics.e(((b) other).subjectToCaCerts, this.subjectToCaCerts);
        }
        return true;
    }
