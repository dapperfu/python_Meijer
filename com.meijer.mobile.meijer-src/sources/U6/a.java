...
abstract class a {
    ...
    private static final char[] f37119a;

    /* renamed from: b, reason: collision with root package name */
    private static final byte[] f37120b;

    /* renamed from: c, reason: collision with root package name */
    private static final int[] f37121c;

    /* renamed from: d, reason: collision with root package name */
    private static final byte[] f37122d;
    ...
    static {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            f37121c[f37119a[i10]] = i10;
        }
        f37121c[61] = 0;
        f37120b = new byte[f37119a.length];
        int i11 = 0;
        while (true) {
            char[] cArr = f37119a;
            if (i11 >= cArr.length) {
    ...
    static byte[] a(byte[] bArr, int i10, int i11) {
        ...
        int i14 = i11 - 1;
        int i15 = i10;
        while (i15 < i14 && f37121c[bArr[i15] & 255] < 0) {
            i15++;
        }
        while (i14 > 0 && f37121c[bArr[i14] & 255] < 0) {
            i14--;
        }
        int i16 = 0;
