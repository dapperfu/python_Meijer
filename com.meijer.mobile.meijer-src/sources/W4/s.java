...
@Metadata(d1 = {"\u0000L\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\"\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0012\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0006\bÆ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0017\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0007¢\u0006\u0004\b\u0007\u0010\bJ\u0017\u0010\n\u001a\u00020\u00042\u0006\u0010\t\u001a\u00020\u0006H\u0007¢\u0006\u0004\b\n\u0010\u000bJ\u0017\u0010\u000e\u001a\u00020\u00062\u0006\u0010\r\u001a\u00020\fH\u0007¢\u0006\u0004\b\u000e\u0010\u000fJ\u0017\u0010\u0010\u001a\u00020\f2\u0006\u0010\t\u001a\u00020\u0006H\u0007¢\u0006\u0004\b\u0010\u0010\u0011J\u0017\u0010\u0014\u001a\u00020\u00062\u0006\u0010\u0013\u001a\u00020\u0012H\u0007¢\u0006\u0004\b\u0014\u0010\u0015J\u0017\u0010\u0016\u001a\u00020\u00122\u0006\u0010\t\u001a\u00020\u0006H\u0007¢\u0006\u0004\b\u0016\u0010\u0017J\u0017\u0010\u001a\u001a\u00020\u00062\u0006\u0010\u0019\u001a\u00020\u0018H\u0007¢\u0006\u0004\b\u001a\u0010\u001bJ\u0017\u0010\u001c\u001a\u00020\u00182\u0006\u0010\t\u001a\u00020\u0006H\u0007¢\u0006\u0004\b\u001c\u0010\u001dJ\u001d\u0010\"\u001a\u00020!2\f\u0010 \u001a\b\u0012\u0004\u0012\u00020\u001f0\u001eH\u0007¢\u0006\u0004\b\"\u0010#J\u001d\u0010%\u001a\b\u0012\u0004\u0012\u00020\u001f0\u001e2\u0006\u0010$\u001a\u00020!H\u0007¢\u0006\u0004\b%\u0010&J\u0017\u0010(\u001a\u00020'2\u0006\u0010$\u001a\u00020!H\u0001¢\u0006\u0004\b(\u0010)J\u0017\u0010+\u001a\u00020!2\u0006\u0010*\u001a\u00020'H\u0001¢\u0006\u0004\b+\u0010,¨\u0006-"}, d2 = {"LW4/s;", "", "<init>", "()V", "LO4/N$c;", "state", "", "k", "(LO4/N$c;)I", "value", "g", "(I)LO4/N$c;", "LO4/a;", "backoffPolicy", "a", "(LO4/a;)I", "d", "(I)LO4/a;", "LO4/w;", "networkType", "h", "(LO4/w;)I", "e", "(I)LO4/w;", "LO4/E;", "policy", "i", "(LO4/E;)I", "f", "(I)LO4/E;", "", "LO4/d$c;", "triggers", "", "j", "(Ljava/util/Set;)[B", "bytes", "b", "([B)Ljava/util/Set;", "LX4/y;", "l", "([B)LX4/y;", "requestCompat", "c", "(LX4/y;)[B", "work-runtime_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
@SourceDebugExtension
/* loaded from: classes4.dex */
public final class s {

    /* renamed from: a, reason: collision with root package name */
    public static final s f40787a = new s();
    ...
    public /* synthetic */ class a {
        ...
        static {
            ...
            int[] iArr2 = new int[EnumC4353a.values().length];
            try {
                iArr2[EnumC4353a.EXPONENTIAL.ordinal()] = 1;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                iArr2[EnumC4353a.LINEAR.ordinal()] = 2;
            } catch (NoSuchFieldError unused8) {
            }
            $EnumSwitchMapping$1 = iArr2;
            int[] iArr3 = new int[EnumC4374w.values().length];
            try {
                iArr3[EnumC4374w.NOT_REQUIRED.ordinal()] = 1;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                iArr3[EnumC4374w.CONNECTED.ordinal()] = 2;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                iArr3[EnumC4374w.UNMETERED.ordinal()] = 3;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                iArr3[EnumC4374w.NOT_ROAMING.ordinal()] = 4;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                iArr3[EnumC4374w.METERED.ordinal()] = 5;
    ...
    @JvmStatic
    public static final int a(EnumC4353a backoffPolicy) {
    ...
    @JvmStatic
    public static final Set<C4356d.c> b(byte[] bytes) {
        ...
        try {
            ...
            try {
                ...
                for (int i11 = 0; i11 < i10; i11++) {
                    ...
                    linkedHashSet.add(new C4356d.c(uri, z10));
                }
    ...
    @JvmStatic
    public static final EnumC4353a d(int value) {
        if (value == 0) {
            return EnumC4353a.EXPONENTIAL;
        }
        if (value == 1) {
            return EnumC4353a.LINEAR;
        }
        throw new IllegalArgumentException("Could not convert " + value + " to BackoffPolicy");
    }

    @JvmStatic
    public static final EnumC4374w e(int value) {
        if (value == 0) {
            return EnumC4374w.NOT_REQUIRED;
        }
        if (value == 1) {
            return EnumC4374w.CONNECTED;
        }
        if (value == 2) {
            return EnumC4374w.UNMETERED;
        }
        if (value == 3) {
            return EnumC4374w.NOT_ROAMING;
        }
        if (value == 4) {
            return EnumC4374w.METERED;
        }
        if (Build.VERSION.SDK_INT >= 30 && value == 5) {
            return EnumC4374w.TEMPORARILY_UNMETERED;
        }
    ...
    @JvmStatic
    public static final int h(EnumC4374w networkType) {
        ...
        if (Build.VERSION.SDK_INT >= 30 && networkType == EnumC4374w.TEMPORARILY_UNMETERED) {
            return 5;
        }
    ...
    @JvmStatic
    public static final byte[] j(Set<C4356d.c> triggers) {
    ...
    public static final NetworkRequestCompat l(byte[] bytes) {
        ...
        try {
            ...
            try {
                ...
                NetworkRequestCompat networkRequestCompatB = u.f41602a.b(iArr2, iArr);
                CloseableKt.a(objectInputStream, null);
                CloseableKt.a(byteArrayInputStream, null);
