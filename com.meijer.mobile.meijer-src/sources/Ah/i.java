...
@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\u0018\u00002\u00020\u0001B\u001b\b\u0007\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\b\b\u0001\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0006\u0010\u0007J\u0013\u0010\n\u001a\b\u0012\u0004\u0012\u00020\t0\b¢\u0006\u0004\b\n\u0010\u000bR\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\f\u0010\rR\u0014\u0010\u0005\u001a\u00020\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u000e\u0010\u000f¨\u0006\u0010"}, d2 = {"LAh/i;", "", "Lzh/a;", "accountServerAPIObservable", "LYi/a;", "userTokenGatewayRxJava", "<init>", "(Lzh/a;LYi/a;)V", "Lio/reactivex/l;", "LFh/a;", "e", "()Lio/reactivex/l;", "a", "Lzh/a;", "b", "LYi/a;", "service_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes8.dex */
public final class i {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC18489a accountServerAPIObservable;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final Yi.a userTokenGatewayRxJava;

    public i(InterfaceC18489a accountServerAPIObservable, Yi.a userTokenGatewayRxJava) {
    ...
    public static final BarcodeResponse h(ResponseBody data) {
        ...
        try {
            try {
                ...
                qw.a.INSTANCE.t(e10);
                throw RetrofitException.INSTANCE.e(EnumC17080a.f160811m, e10);
            }
        } catch (Throwable th2) {
            data.close();
            throw th2;
    ...
    public final io.reactivex.l<BarcodeResponse> e() {
        ...
        final Function1 function1 = new Function1() { // from class: Ah.e
            ...
            public final Object invoke(Object obj) {
                return i.f(this.f481a, (BearerToken) obj);
            }
        };
        io.reactivex.l<R> lVarFlatMap = lVarA.flatMap(new o() { // from class: Ah.f
            @Override // Lu.o
            public final Object apply(Object obj) {
                return i.g(function1, obj);
            }
        });
        final Function1 function12 = new Function1() { // from class: Ah.g
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return i.h((ResponseBody) obj);
            }
        };
        io.reactivex.l<BarcodeResponse> map = lVarFlatMap.map(new o() { // from class: Ah.h
            @Override // Lu.o
            public final Object apply(Object obj) {
