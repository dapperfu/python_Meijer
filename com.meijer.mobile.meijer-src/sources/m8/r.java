...
public class r implements s {
    ...
    private static final q f150900b = new q.b().r().C(q.c.ERROR).p();

    /* renamed from: c, reason: collision with root package name */
    private static final q f150901c = new q.b().E(-1).p();

    /* renamed from: a, reason: collision with root package name */
    private final String f150902a;
    ...
    @Override // m8.s
    public q a(Map<String, String> map, EnumC15686a enumC15686a) {
        q.b bVar = new q.b();
        bVar.q(z8.f.o(map, "cp", 0, 1, 1, true));
        bVar.z(z8.f.n(map, "si", 60, 540, BinsView.TOTE_HEIGHT_DP));
        bVar.A(z8.f.n(map, PreferencesHelper.PREF_ID, 0, a.e.API_PRIORITY_OTHER, 1));
        bVar.t(z8.f.n(map, "bl", 1, a.e.API_PRIORITY_OTHER, enumC15686a == EnumC15686a.APP_MON ? 30 : BinsView.TOTE_WIDTH_DP));
        bVar.B(t.a().d(z8.f.n(map, "st", 0, a.e.API_PRIORITY_OTHER, 600)).c());
        bVar.F(z8.f.o(map, "tc", 1, 100, 100, true));
        bVar.v(z8.f.o(map, "mp", 0, a.e.API_PRIORITY_OTHER, 1, true));
        bVar.y(z8.f.o(map, "sm", 0, 1, 1, true) == 1);
        return bVar.p();
    }

    @Override // m8.s
    public void b(q.b bVar, p.b bVar2, JSONObject jSONObject) throws JSONException, ParseException {
        JSONObject jSONObject2;
        r rVar;
        if (jSONObject.has("applicationId")) {
            if (!this.f150902a.equals(jSONObject.getString("applicationId"))) {
    ...
    @Override // m8.s
    public void c(q.b bVar, p.b bVar2, JSONObject jSONObject) throws JSONException {
        r rVar;
        JSONObject jSONObject2;
        r rVar2;
    ...
    @Override // m8.s
    public void d(q.b bVar, JSONObject jSONObject) throws JSONException, ParseException {
        JSONObject jSONObject2;
    ...
    @Override // m8.s
    public q e(q qVar, String str) throws JSONException, InvalidConfigurationException, ClassCastException {
        q.b bVarJ;
        ...
        if (jSONObject.has("timestamp") && jSONObject.has("appConfig") && jSONObject.has("mobileAgentConfig")) {
            ...
            try {
                ...
                bVarJ.E(j10);
                p.b bVarJ2 = p.j();
                c(bVarJ, bVarJ2, jSONObject.getJSONObject("mobileAgentConfig"));
                try {
                    b(bVarJ, bVarJ2, jSONObject.getJSONObject("appConfig"));
                    bVarJ.x(bVarJ2.j());
                } catch (ParseException unused) {
                    return f150900b;
                }
            } catch (JSONException unused2) {
                z8.f.a("dtxCommunication", "parsing v3 config: timestamp must be of type long");
                return f150900b;
            }
        } else {
            bVarJ = qVar.J(true);
        ...
        try {
            d(bVarJ, jSONObject.getJSONObject("dynamicConfig"));
            return bVarJ.p();
    ...
    public q i(String str) throws JSONException, InvalidConfigurationException, ClassCastException {
        q qVarE = e(f150901c, str);
        if (qVarE.z() == q.c.OK) {
            return qVarE;
        }
        throw new InvalidConfigurationException("unexpected status code: " + qVarE.z());
    }
    ...
    private int f(JSONObject jSONObject, String str, int i10, int i11, int i12) {
        if (jSONObject.has(str)) {
            try {
                ...
                z8.f.a("dtxCommunication", "parsing v3 config: expected JSON property \"" + str + "\" to be an Integer, but it was not");
            }
        }
        return i12;
    }
    ...
    private boolean s(JSONObject jSONObject, String str, boolean z10) {
        try {
            ...
            z8.f.a("dtxCommunication", "parsing v3 config: expected JSON property \"" + str + "\" to be a Boolean, but it was not");
            return z10;
        }
    }
