    ...
    public static final class b {
        ...
        public <A extends Appendable> A a(A a10, Iterator<? extends Map.Entry<?, ?>> it) throws IOException {
            ...
            if (it.hasNext()) {
                ...
                a10.append(this.f6146a.j(next.getKey()));
                a10.append(this.f6147b);
                a10.append(this.f6146a.j(next.getValue()));
                while (it.hasNext()) {
                    a10.append(this.f6146a.f6144a);
                    Map.Entry<?, ?> next2 = it.next();
                    a10.append(this.f6146a.j(next2.getKey()));
                    a10.append(this.f6147b);
                    a10.append(this.f6146a.j(next2.getValue()));
                }
            }
            return a10;
        }
