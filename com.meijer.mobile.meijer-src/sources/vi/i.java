...
@Metadata(d1 = {"\u0000>\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0018\b\u0001\u0018\u00002\u00020\u00012\u00020\u0002B=\u0012\u0006\u0010\u0004\u001a\u00020\u0003\u0012\u0006\u0010\u0006\u001a\u00020\u0005\u0012\f\u0010\t\u001a\b\u0012\u0004\u0012\u00020\b0\u0007\u0012\u0006\u0010\n\u001a\u00020\u0005\u0012\u0006\u0010\f\u001a\u00020\u000b\u0012\u0006\u0010\u000e\u001a\u00020\r¢\u0006\u0004\b\u000f\u0010\u0010J\u001b\u0010\u0013\u001a\u000e\u0012\u0004\u0012\u00020\u0012\u0012\u0004\u0012\u00020\b0\u0011H\u0016¢\u0006\u0004\b\u0013\u0010\u0014R\u001a\u0010\u0004\u001a\u00020\u00038\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u0015\u0010\u0016\u001a\u0004\b\u0017\u0010\u0018R\u0017\u0010\u0006\u001a\u00020\u00058\u0006¢\u0006\f\n\u0004\b\u0019\u0010\u001a\u001a\u0004\b\u001b\u0010\u001cR\u001d\u0010\t\u001a\b\u0012\u0004\u0012\u00020\b0\u00078\u0006¢\u0006\f\n\u0004\b\u001d\u0010\u001e\u001a\u0004\b\u001f\u0010 R\u001a\u0010\n\u001a\u00020\u00058\u0016X\u0096\u0004¢\u0006\f\n\u0004\b!\u0010\u001a\u001a\u0004\b\"\u0010\u001cR\u001a\u0010\f\u001a\u00020\u000b8\u0016X\u0096\u0004¢\u0006\f\n\u0004\b#\u0010$\u001a\u0004\b%\u0010&R\u001a\u0010\u000e\u001a\u00020\r8\u0016X\u0096\u0004¢\u0006\f\n\u0004\b'\u0010(\u001a\u0004\b\u0019\u0010)¨\u0006*"}, d2 = {"Lvi/i;", "LJi/h;", "", "Lki/q1$q;", "template", "", "selected", "Lkotlin/Function0;", "", "onClick", "enabled", "", "text", "LKi/M;", "localThemeScope", "<init>", "(Lki/q1$q;ZLkotlin/jvm/functions/Function0;ZLjava/lang/String;LKi/M;)V", "Lkotlin/Function1;", "Landroidx/compose/ui/Modifier;", "a", "()Lkotlin/jvm/functions/Function3;", "b", "Lki/q1$q;", "z0", "()Lki/q1$q;", "c", "Z", "y0", "()Z", "d", "Lkotlin/jvm/functions/Function0;", "l", "()Lkotlin/jvm/functions/Function0;", "e", "h", "f", "Ljava/lang/String;", "A0", "()Ljava/lang/String;", "g", "LKi/M;", "()LKi/M;", "library_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public final class i implements Ji.h, Ji.b {
    ...
    static final class a implements Function3<Modifier, Composer, Integer, Unit> {
        ...
        static final class C2625a implements Function2<Composer, Integer, Unit> {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ i f165983a;
            ...
            public final void a(Composer composer, int i10) {
                ...
                N1.b(this.f165983a.getText(), androidx.compose.foundation.b.d(Modifier.INSTANCE, this.f165983a.getLocalThemeScope().getAdsColors().getAdsColorTransparent().getColor(), null, 2, null), this.f165983a.getSelected() ? this.f165983a.getTemplate().getSelectedTextColor() : this.f165983a.getTemplate().getUnselectedTextColor(), 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, this.f165983a.getLocalThemeScope().getAdsTypography().getHeadings().getSeven().getStyle(), composer, 0, 0, 65528);
                if (ComposerKt.M()) {
                    ComposerKt.T();
                }
            }
        ...
        public final void a(Modifier it, Composer composer, int i10) {
            ...
            A1.b(i.this.getSelected(), i.this.l(), i.this.getTemplate().getModifier(), i.this.getEnabled(), ComposableLambdaKt.c(852664045, true, new C2625a(i.this), composer, 54), null, i.this.getTemplate().x().invoke(composer, 0), 0L, 0L, composer, 221184, 384);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
