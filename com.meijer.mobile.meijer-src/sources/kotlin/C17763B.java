...
public final class C17763B {
    ...
    private static final float f166456a;

    /* renamed from: b, reason: collision with root package name */
    private static final float f166457b;

    /* renamed from: c, reason: collision with root package name */
    private static final SemanticsPropertyKey<SelectionHandleInfo> f166458c = new SemanticsPropertyKey<>("SelectionHandleInfo", null, 2, null);
    ...
    public static final boolean e(F1.i iVar, boolean z10) {
        if (iVar != F1.i.f8930a || z10) {
            return iVar == F1.i.f8931b && z10;
        }
        return true;
    }
