...
public final class C17795k implements InterfaceC17798n {
    ...
    @Override // kotlin.InterfaceC17798n
    ...
    public long c(Selection selection, boolean isStartHandle) {
        ...
        return C17784X.b(textLayoutResultInvoke, RangesKt.o((isStartHandle ? selection.getStart() : selection.getEnd()).getOffset(), 0, l(textLayoutResultInvoke)), isStartHandle, selection.getHandlesCrossed());
    }
    ...
    public long k(int offset) {
        ...
        return C17334A.b(textLayoutResultInvoke.u(iQ), textLayoutResultInvoke.o(iQ, true));
    }

    /* JADX WARN: Multi-variable type inference failed */
    public C17795k(long j10, Function0<? extends LayoutCoordinates> function0, Function0<TextLayoutResult> function02) {
    ...
    public void e(C17765D builder) {
        ...
        C17796l.a(builder, textLayoutResultInvoke, jP2, jP, getSelectableId());
    }
}
