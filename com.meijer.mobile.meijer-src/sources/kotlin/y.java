...
public final class y {
    ...
    private static final float f59849a = ViewConfiguration.getScrollFriction();

    public static final float a() {
        return f59849a;
    }

    public static final <T> InterfaceC6468y<T> b(Composer composer, int i10) {
        if (ComposerKt.M()) {
        ...
        if (zB || objB == Composer.INSTANCE.a()) {
            objB = C6414A.d(new x(dVar));
            composer.t(objB);
        }
        InterfaceC6468y<T> interfaceC6468y = (InterfaceC6468y) objB;
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
