...
public class C14676q<D extends C14675p> {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final AbstractC14656B<? extends D> navigator;
    ...
    private Map<String, C14665f> arguments;

    /* renamed from: f, reason: collision with root package name and from kotlin metadata */
    private List<C14672m> deepLinks;

    /* renamed from: g, reason: collision with root package name and from kotlin metadata */
    private Map<Integer, C14664e> actions;

    public C14676q(AbstractC14656B<? extends D> navigator, int i10, String str) {
    ...
    public D a() {
        ...
        d10.D(this.label);
        for (Map.Entry<String, C14665f> entry : this.arguments.entrySet()) {
            d10.f(entry.getKey(), entry.getValue());
        }
        Iterator<T> it = this.deepLinks.iterator();
        while (it.hasNext()) {
            d10.h((C14672m) it.next());
        }
        for (Map.Entry<Integer, C14664e> entry2 : this.actions.entrySet()) {
    ...
    public C14676q(AbstractC14656B<? extends D> navigator, String str) {
