...
public final class CubicBezierEasing implements InterfaceC6416C {
    ...
    public float a(float fraction) {
        if (fraction > 0.0f && fraction < 1.0f) {
            ...
            float fE = C5446b0.e(0.0f - fMax, this.a - fMax, this.c - fMax, 1.0f - fMax);
            if (Float.isNaN(fE)) {
                b(fraction);
            }
            fraction = C5446b0.c(this.b, this.d, fE);
            float f10 = this.min;
            float f11 = this.max;
            if (fraction < f10) {
                fraction = f10;
    ...
    public CubicBezierEasing(float f10, float f11, float f12, float f13) {
        ...
        if (!z10) {
            C6436X.a("Parameters to CubicBezierEasing cannot be NaN. Actual parameters are: " + f10 + ", " + f11 + ", " + f12 + ", " + f13 + '.');
        }
        long jB = C5446b0.b(0.0f, f11, f13, 1.0f, new float[5], 0);
