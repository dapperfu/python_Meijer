...
public final class C6446d0<T> implements InterfaceC6419F<T> {
    ...
    public C6446d0(float f10, float f11, T t10) {
    ...
    public boolean equals(Object other) {
        if (other instanceof C6446d0) {
            C6446d0 c6446d0 = (C6446d0) other;
            if (c6446d0.dampingRatio == this.dampingRatio && c6446d0.stiffness == this.stiffness && Intrinsics.e(c6446d0.visibilityThreshold, this.visibilityThreshold)) {
                return true;
            }
        }
        return false;
    ...
    public <V extends AbstractC6460q> C0<V> a(o0<T, V> converter) {
        return new C0<>(this.dampingRatio, this.stiffness, C6453j.b(converter, this.visibilityThreshold));
    }

    public /* synthetic */ C6446d0(float f10, float f11, Object obj, int i10, DefaultConstructorMarker defaultConstructorMarker) {
