...
public final class C18016k0 {

    /* renamed from: a, reason: collision with root package name */
    private static final F0<InterfaceC18013j0> f169261a = r.f(b.f169264f);

    /* renamed from: b, reason: collision with root package name */
    private static final F0<H1.h> f169262b = r.d(null, a.f169263f, 1, null);

    @Metadata(d1 = {"\u0000\b\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0001\u001a\u0004\u0018\u00010\u0000H\n¢\u0006\u0004\b\u0001\u0010\u0002"}, d2 = {"Lx0/j0;", "c", "()Lx0/j0;"}, k = 3, mv = {1, 9, 0})
    /* renamed from: x0.k0$b */
    static final class b extends Lambda implements Function0<InterfaceC18013j0> {

        /* renamed from: f, reason: collision with root package name */
        public static final b f169264f = new b();
        ...
        public final InterfaceC18013j0 invoke() {
            return C17969S.f168496a;
        }
    }
    ...
    static final class a extends Lambda implements Function0<H1.h> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final a f169263f = new a();
    ...
    public static final F0<InterfaceC18013j0> d() {
        return f169261a;
    }
    ...
    public static final long b(long j10, float f10, Composer composer, int i10) {
        ...
        long jQ = C5489q0.q(C17942E.b(j10, composer, i10 & 14), ((((float) Math.log(f10 + 1)) * 4.5f) + 2.0f) / 100.0f, 0.0f, 0.0f, 0.0f, 14, null);
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        return jQ;
