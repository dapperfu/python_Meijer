...
public interface ContinuationInterceptor extends CoroutineContext.Element {
    ...
    public static final Companion INSTANCE = Companion.f143550a;
    ...
    public static final class DefaultImpls {
        ...
        public static CoroutineContext b(ContinuationInterceptor continuationInterceptor, CoroutineContext.Key<?> key) {
            Intrinsics.j(key, "key");
            if (!(key instanceof AbstractCoroutineContextKey)) {
                return ContinuationInterceptor.INSTANCE == key ? EmptyCoroutineContext.f143553a : continuationInterceptor;
            }
            AbstractCoroutineContextKey abstractCoroutineContextKey = (AbstractCoroutineContextKey) key;
            return (!abstractCoroutineContextKey.a(continuationInterceptor.getKey()) || abstractCoroutineContextKey.b(continuationInterceptor) == null) ? continuationInterceptor : EmptyCoroutineContext.f143553a;
        }
    }
    ...
    public static final class Companion implements CoroutineContext.Key<ContinuationInterceptor> {
        ...
        static final /* synthetic */ Companion f143550a = new Companion();
