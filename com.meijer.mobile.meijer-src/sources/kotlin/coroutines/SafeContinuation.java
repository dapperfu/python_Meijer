...
public final class SafeContinuation<T> implements Continuation<T>, CoroutineStackFrame {
    ...
    private static final a f143554b = new a(null);

    /* renamed from: c, reason: collision with root package name */
    private static final AtomicReferenceFieldUpdater<SafeContinuation<?>, Object> f143555c = AtomicReferenceFieldUpdater.newUpdater(SafeContinuation.class, Object.class, "result");
    ...
    public final Object b() {
        ...
        CoroutineSingletons coroutineSingletons = CoroutineSingletons.f143558b;
        if (obj == coroutineSingletons) {
            if (b.a(f143555c, this, coroutineSingletons, IntrinsicsKt.f())) {
                return IntrinsicsKt.f();
            }
            obj = this.result;
        }
        if (obj == CoroutineSingletons.f143559c) {
            return IntrinsicsKt.f();
        }
    ...
    public void resumeWith(Object result) {
        while (true) {
            ...
            CoroutineSingletons coroutineSingletons = CoroutineSingletons.f143558b;
            if (obj == coroutineSingletons) {
                if (b.a(f143555c, this, coroutineSingletons, result)) {
                    return;
                }
            } else {
                ...
                if (b.a(f143555c, this, IntrinsicsKt.f(), CoroutineSingletons.f143559c)) {
    ...
    public SafeContinuation(Continuation<? super T> delegate) {
        this(delegate, CoroutineSingletons.f143558b);
        Intrinsics.j(delegate, "delegate");
    }
}
