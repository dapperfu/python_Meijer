...
public class LazyKt__LazyJVMKt {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            try {
                iArr[LazyThreadSafetyMode.f143286a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[LazyThreadSafetyMode.f143287b.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[LazyThreadSafetyMode.f143288c.ordinal()] = 3;
    ...
    public static <T> Lazy<T> a(LazyThreadSafetyMode mode, Function0<? extends T> initializer) {
        ...
        if (i10 == 1) {
            ...
            return new C15326n(initializer, defaultConstructorMarker, i11, defaultConstructorMarker);
        }
        if (i10 == 2) {
    ...
    public static <T> Lazy<T> b(Function0<? extends T> initializer) {
        Intrinsics.j(initializer, "initializer");
        DefaultConstructorMarker defaultConstructorMarker = null;
        return new C15326n(initializer, defaultConstructorMarker, 2, defaultConstructorMarker);
    }
}
