...
public class C14674o {
    ...
    public static final class a {
        ...
        public final C14674o a() {
            return new C14674o(this.uri, this.action, this.mimeType);
        }
    ...
    public C14674o(Uri uri, String str, String str2) {
        this.uri = uri;
        this.action = str;
        this.mimeType = str2;
    }
