...
public final class C0<V extends AbstractC6460q> implements v0<V> {
    ...
    private final /* synthetic */ w0<V> f60681c;

    private C0(float f10, float f11, InterfaceC6462s interfaceC6462s) {
        this.dampingRatio = f10;
        this.stiffness = f11;
        this.f60681c = new w0<>(interfaceC6462s);
    }

    @Override // kotlin.v0, kotlin.r0
    public boolean a() {
        return this.f60681c.a();
    }

    @Override // kotlin.r0
    public long b(V initialValue, V targetValue, V initialVelocity) {
        return this.f60681c.b(initialValue, targetValue, initialVelocity);
    }

    @Override // kotlin.r0
    public V d(long playTimeNanos, V initialValue, V targetValue, V initialVelocity) {
        return (V) this.f60681c.d(playTimeNanos, initialValue, targetValue, initialVelocity);
    }

    @Override // kotlin.r0
    public V f(long playTimeNanos, V initialValue, V targetValue, V initialVelocity) {
        return (V) this.f60681c.f(playTimeNanos, initialValue, targetValue, initialVelocity);
    }

    @Override // kotlin.r0
    public V g(V initialValue, V targetValue, V initialVelocity) {
        return (V) this.f60681c.g(initialValue, targetValue, initialVelocity);
    }
