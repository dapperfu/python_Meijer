...
public final class C6444c0 {
    ...
    public final void c(float f10) {
        if (f10 < 0.0f) {
            C6436X.a("Damping ratio must be non-negative");
        }
    ...
    public final long f(float lastDisplacement, float lastVelocity, long timeElapsed) {
        ...
        return C6432T.a((Float.floatToRawIntBits((float) dExp) & 4294967295L) | (Float.floatToRawIntBits((float) (dExp2 + this.finalPosition)) << 32));
    }

    public C6444c0(float f10) {
        this.finalPosition = f10;
    }

    public final void e(float f10) {
        if (b() <= 0.0f) {
            C6436X.a("Spring stiffness constant must be positive.");
        }
