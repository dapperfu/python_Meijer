...
public final class C6423J implements InterfaceC6420G {
    ...
    private final C6444c0 spring;

    public C6423J(float f10, float f11, float f12) {
        this.dampingRatio = f10;
        this.stiffness = f11;
        this.visibilityThreshold = f12;
        C6444c0 c6444c0 = new C6444c0(1.0f);
        c6444c0.c(f10);
        c6444c0.e(f11);
        this.spring = c6444c0;
    }

    @Override // kotlin.InterfaceC6420G
    ...
    public long e(float initialValue, float targetValue, float initialVelocity) {
        ...
        return C6442b0.b(fB, dampingRatio, initialVelocity / f11, f10 / f11, 1.0f) * 1000000;
    }
    ...
    public /* synthetic */ C6423J(float f10, float f11, float f12, int i10, DefaultConstructorMarker defaultConstructorMarker) {
