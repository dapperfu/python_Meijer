...
public interface InterfaceC16035A {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    public static final Companion INSTANCE = Companion.f153308a;
    ...
    public static final class Companion {
        ...
        static final /* synthetic */ Companion f153308a = new Companion();

        public final InterfaceC16035A a(int pages) {
            if (!(pages >= 0)) {
                C14592e.a("pages should be greater than or equal to 0. You have used " + pages + '.');
            }
            return new C16036B(pages);
        }
