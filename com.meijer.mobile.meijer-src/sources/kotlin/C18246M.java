...
final class C18246M implements InterfaceC18244K {
    ...
    private final Typeface c(String genericFontFamily, FontWeight fontWeight, int fontStyle) {
        ...
        if (C18280w.f(fontStyle, companion.b()) && Intrinsics.e(fontWeight, FontWeight.INSTANCE.e()) && (genericFontFamily == null || genericFontFamily.length() == 0)) {
            return Typeface.DEFAULT;
        }
        return Typeface.create(genericFontFamily == null ? Typeface.DEFAULT : Typeface.create(genericFontFamily, 0), fontWeight.getWeight(), C18280w.f(fontStyle, companion.a()));
    }
