...
public final class C17956L {

    /* renamed from: a, reason: collision with root package name */
    public static final C17956L f168212a = new C17956L();

    /* renamed from: b, reason: collision with root package name */
    public static final int f168213b = 0;
    ...
    private final float a(float f10, float f11, Composer composer, int i10) {
        ...
        long value = ((C5489q0) composer.o(C17960N.a())).getValue();
        if (!C17943E0.f167967a.a(composer, 6).o() ? C5492s0.i(value) >= 0.5d : C5492s0.i(value) <= 0.5d) {
            f10 = f11;
        }
        if (ComposerKt.M()) {
            ComposerKt.T();
