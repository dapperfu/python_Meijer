...
public final class SelectionColors {
    ...
    public boolean equals(Object other) {
        ...
        return C5489q0.s(this.selectionHandleColor, selectionColors.selectionHandleColor) && C5489q0.s(this.selectionBackgroundColor, selectionColors.selectionBackgroundColor);
    }
    ...
    public int hashCode() {
        return (C5489q0.y(this.selectionHandleColor) * 31) + C5489q0.y(this.selectionBackgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + ((Object) C5489q0.z(this.selectionHandleColor)) + ", selectionBackgroundColor=" + ((Object) C5489q0.z(this.selectionBackgroundColor)) + ')';
    }
}
