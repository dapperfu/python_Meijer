...
public final class C18241H {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC18244K platformTypefaceResolver = C18248O.a();
    ...
    public InterfaceC18257Y a(TypefaceRequest typefaceRequest, InterfaceC18242I platformFontLoader, Function1<? super InterfaceC18257Y.b, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        boolean z10;
        Typeface typefaceA;
        AbstractC18269l fontFamily = typefaceRequest.getFontFamily();
        if (fontFamily == null) {
            z10 = true;
        } else {
            z10 = fontFamily instanceof C18266i;
        }
        if (z10) {
            typefaceA = this.platformTypefaceResolver.b(typefaceRequest.getFontWeight(), typefaceRequest.getFontStyle());
        } else if (fontFamily instanceof C18239F) {
            typefaceA = this.platformTypefaceResolver.a((C18239F) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.getFontStyle());
        } else {
            if (!(fontFamily instanceof LoadedFontFamily)) {
                return null;
            }
            InterfaceC18251S typeface = ((LoadedFontFamily) typefaceRequest.getFontFamily()).getTypeface();
        ...
        return new InterfaceC18257Y.b(typefaceA, false, 2, null);
    }
}
