...
public final class SlidingWindowKt {
    ...
    static final class a<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super List<? extends T>>, Continuation<? super Unit>, Object> {
        ...
        private /* synthetic */ Object f143446f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f143447g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f143448h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ Iterator<T> f143449i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ boolean f143450j;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            a aVar = new a(this.f143447g, this.f143448h, this.f143449i, this.f143450j, this.f143451k, continuation);
            aVar.f143446f = obj;
            return aVar;
        }
    ...
    public static final <T> Iterator<List<T>> b(Iterator<? extends T> iterator, int i10, int i11, boolean z10, boolean z11) {
        ...
        return !iterator.hasNext() ? EmptyIterator.f143413a : SequencesKt.a(new a(i10, i11, iterator, z11, z10, null));
    }
}
