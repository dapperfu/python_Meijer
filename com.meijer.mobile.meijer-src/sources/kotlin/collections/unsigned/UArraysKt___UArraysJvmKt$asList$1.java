...
public final class UArraysKt___UArraysJvmKt$asList$1 extends AbstractList<UInt> implements RandomAccess {
    ...
    /* renamed from: f */
    public int getSize() {
        return UIntArray.s(this.f143509b);
    }
    ...
    public boolean isEmpty() {
        return UIntArray.u(this.f143509b);
    }

    public boolean k(int element) {
        return UIntArray.n(this.f143509b, element);
    }
    ...
    public int n(int index) {
        return UIntArray.q(this.f143509b, index);
    }

    public int o(int element) {
        return ArraysKt.r0(this.f143509b, element);
    }

    public int p(int element) {
        return ArraysKt.G0(this.f143509b, element);
    }
