...
public final class UArraysKt___UArraysJvmKt$asList$4 extends AbstractList<UShort> implements RandomAccess {
    ...
    final /* synthetic */ short[] f143512b;
    ...
    /* renamed from: f */
    public int getSize() {
        return UShortArray.s(this.f143512b);
    }
    ...
    public boolean isEmpty() {
        return UShortArray.u(this.f143512b);
    }

    public boolean k(short element) {
        return UShortArray.n(this.f143512b, element);
    }
    ...
    public short n(int index) {
        return UShortArray.q(this.f143512b, index);
    }

    public int o(short element) {
        return ArraysKt.u0(this.f143512b, element);
    }

    public int p(short element) {
        return ArraysKt.J0(this.f143512b, element);
    }
