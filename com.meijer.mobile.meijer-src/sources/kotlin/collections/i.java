...
public class i extends h {
    public static <T> ArrayList<T> g(T... elements) {
        ...
        return elements.length == 0 ? new ArrayList<>() : new ArrayList<>(new C15312c(elements, true));
    }

    public static final <T> Collection<T> h(T[] tArr) {
        Intrinsics.j(tArr, "<this>");
        return new C15312c(tArr, false);
    }

    public static <T> int i(List<? extends T> list, int i10, int i11, Function1<? super T, Integer> comparison) {
