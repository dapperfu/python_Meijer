...
public final class ArraysKt___ArraysJvmKt$asList$1 extends AbstractList<Byte> implements RandomAccess {
    ...
    public boolean isEmpty() {
        return this.f143382b.length == 0;
    }

    public boolean k(byte element) {
        return ArraysKt___ArraysKt.U(this.f143382b, element);
    }
    ...
    public Byte get(int index) {
        return Byte.valueOf(this.f143382b[index]);
    }

    public int o(byte element) {
        return ArraysKt___ArraysKt.p0(this.f143382b, element);
    }

    public int p(byte element) {
        return ArraysKt___ArraysKt.E0(this.f143382b, element);
    }
}
