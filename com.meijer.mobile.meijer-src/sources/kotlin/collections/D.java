...
public class D extends C {
    public static <T> Set<T> e() {
        return EmptySet.f143415a;
    }

    public static <T> LinkedHashSet<T> f(T... elements) {
        Intrinsics.j(elements, "elements");
        return (LinkedHashSet) ArraysKt___ArraysKt.a1(elements, new LinkedHashSet(y.f(elements.length)));
    }

    public static <T> Set<T> g(T... elements) {
        Intrinsics.j(elements, "elements");
        return (Set) ArraysKt___ArraysKt.a1(elements, new LinkedHashSet(y.f(elements.length)));
    }
    ...
    public static <T> Set<T> i(T... elements) {
        Intrinsics.j(elements, "elements");
        return ArraysKt___ArraysKt.t1(elements);
    }
}
