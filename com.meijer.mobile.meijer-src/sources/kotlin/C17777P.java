...
public final class C17777P extends AbstractC17786b<C17777P> {
    ...
    public C17777P(TextFieldValue textFieldValue, InterfaceC18417E interfaceC18417E, h0 h0Var, C17781U c17781u) {
        ...
        super(text, selection, value, interfaceC18417E, c17781u, null);
    ...
    */
    private final int a0(androidx.compose.foundation.text.h0 r9, int r10) {
        ...
        L1b:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.C17777P.a0(androidx.compose.foundation.text.h0, int):int");
    }

    public final List<InterfaceC18426i> Y(Function1<? super C17777P, ? extends InterfaceC18426i> or2) {
        if (y.h(getSelection())) {
            InterfaceC18426i interfaceC18426iInvoke = or2.invoke(this);
            if (interfaceC18426iInvoke != null) {
                return CollectionsKt.e(interfaceC18426iInvoke);
            }
            return null;
        }
