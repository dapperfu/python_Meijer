...
public interface InterfaceC15868a0 {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    public static final Companion INSTANCE = Companion.f151914a;
    ...
    public static final class Companion {
        ...
        static final /* synthetic */ Companion f151914a = new Companion();

        /* renamed from: b, reason: collision with root package name and from kotlin metadata */
        private static final InterfaceC15868a0 StickToTopPlacement = new C2341a();
        ...
        public static final class C2341a implements InterfaceC15868a0 {
            @Override // kotlin.InterfaceC15868a0
            public int a(List<? extends InterfaceC15892y> visibleStickyItems, int itemIndex, int itemSize, int itemOffset, int beforeContentPadding, int afterContentPadding, int layoutWidth, int layoutHeight) {
                InterfaceC15892y interfaceC15892y;
                int size = visibleStickyItems.size();
                int i10 = 0;
                while (true) {
                    if (i10 >= size) {
                        interfaceC15892y = null;
                        break;
                    }
                    interfaceC15892y = visibleStickyItems.get(i10);
                    if (interfaceC15892y.getIndex() != itemIndex) {
                        break;
                    }
                    i10++;
                }
                InterfaceC15892y interfaceC15892y2 = interfaceC15892y;
                int iC = interfaceC15892y2 != null ? C15853L.c(interfaceC15892y2) : Integer.MIN_VALUE;
            ...
            @Override // kotlin.InterfaceC15868a0
            public AbstractC5617o b(int firstVisibleItemIndex, int lastVisibleItemIndex, AbstractC5617o stickyItems) {
                int i10;
                ...
                return iE == -1 ? C5618p.a() : C5618p.b(iE);
            }
        ...
        public final InterfaceC15868a0 a() {
    ...
    int a(List<? extends InterfaceC15892y> visibleStickyItems, int itemIndex, int itemSize, int itemOffset, int beforeContentPadding, int afterContentPadding, int layoutWidth, int layoutHeight);

    AbstractC5617o b(int firstVisibleItemIndex, int lastVisibleItemIndex, AbstractC5617o stickyItems);
}
