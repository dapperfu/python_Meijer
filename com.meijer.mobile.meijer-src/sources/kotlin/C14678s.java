...
public class C14678s extends C14676q<C14677r> {

    /* renamed from: h, reason: collision with root package name and from kotlin metadata */
    private final C14657C provider;
    ...
    private final List<C14675p> destinations;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C14678s(C14657C provider, String startDestination, String str) {
        super(provider.d(C14679t.class), str);
    ...
    public final void c(C14675p destination) {
        Intrinsics.j(destination, "destination");
        this.destinations.add(destination);
    }

    public final <D extends C14675p> void e(C14676q<? extends D> navDestination) {
        Intrinsics.j(navDestination, "navDestination");
        this.destinations.add(navDestination.a());
    }

    /* renamed from: f, reason: from getter */
    public final C14657C getProvider() {
        return this.provider;
    }

    @Override // kotlin.C14676q
    /* renamed from: d, reason: merged with bridge method [inline-methods] */
    public C14677r a() {
        C14677r c14677r = (C14677r) super.a();
        c14677r.I(this.destinations);
