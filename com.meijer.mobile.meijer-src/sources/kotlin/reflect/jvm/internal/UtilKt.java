...
public final class UtilKt {
    ...
    private static final FqName f144050a = new FqName("kotlin.jvm.JvmStatic");
    ...
    public static final <M extends MessageLite, D extends CallableDescriptor> D h(Class<?> moduleAnchor, M proto, NameResolver nameResolver, TypeTable typeTable, BinaryVersion metadataVersion, Function2<? super MemberDeserializer, ? super M, ? extends D> createDescriptor) {
        ...
        if (proto instanceof ProtoBuf.Function) {
            listS0 = ((ProtoBuf.Function) proto).q0();
        } else {
        ...
        VersionRequirementTable versionRequirementTableB = VersionRequirementTable.f146457b.b();
        Intrinsics.g(list);
    ...
    private static final Class<?> n(ClassLoader classLoader, ClassId classId, int i10) {
        ClassId classIdN = JavaToKotlinClassMap.f144399a.n(classId.a().i());
        if (classIdN != null) {
            classId = classIdN;
        }
    ...
    public static final KVisibility r(DescriptorVisibility descriptorVisibility) {
        ...
        if (Intrinsics.e(descriptorVisibility, DescriptorVisibilities.f144507e)) {
            return KVisibility.f143863a;
        }
        if (Intrinsics.e(descriptorVisibility, DescriptorVisibilities.f144505c)) {
            return KVisibility.f143864b;
        }
        if (Intrinsics.e(descriptorVisibility, DescriptorVisibilities.f144506d)) {
            return KVisibility.f143865c;
        }
        if (Intrinsics.e(descriptorVisibility, DescriptorVisibilities.f144503a) || Intrinsics.e(descriptorVisibility, DescriptorVisibilities.f144504b)) {
            return KVisibility.f143866d;
        }
        return null;
    }
