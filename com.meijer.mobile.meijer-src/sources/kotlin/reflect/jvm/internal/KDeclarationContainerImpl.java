...
public abstract class KDeclarationContainerImpl implements ClassBasedDeclarationContainer {
    ...
    private static final Class<?> f143957b = DefaultConstructorMarker.class;

    /* renamed from: c, reason: collision with root package name */
    private static final Regex f143958c = new Regex("<v#(\\d+)>");
    ...
    public static final class Companion {
        ...
        public final Regex a() {
            return KDeclarationContainerImpl.f143958c;
        }
    }
    ...
    public abstract class Data {
        ...
        /* renamed from: c, reason: collision with root package name */
        static final /* synthetic */ KProperty<Object>[] f143959c = {Reflection.j(new PropertyReference1Impl(Data.class, "moduleData", "getModuleData()Lorg/jetbrains/kotlin/descriptors/runtime/components/RuntimeModuleData;", 0))};
        ...
        public final RuntimeModuleData b() {
            T tB = this.moduleData.b(this, f143959c[0]);
    ...
    protected static final class MemberBelonginess {
        ...
        public static final MemberBelonginess f143962a = new MemberBelonginess("DECLARED", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final MemberBelonginess f143963b = new MemberBelonginess("INHERITED", 1);

        /* renamed from: c, reason: collision with root package name */
        private static final /* synthetic */ MemberBelonginess[] f143964c;

        /* renamed from: d, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f143965d;

        private static final /* synthetic */ MemberBelonginess[] a() {
            return new MemberBelonginess[]{f143962a, f143963b};
        }

        static {
            MemberBelonginess[] memberBelonginessArrA = a();
            f143964c = memberBelonginessArrA;
            f143965d = EnumEntriesKt.a(memberBelonginessArrA);
        }
    ...
    public static final CharSequence E(PropertyDescriptor descriptor) {
        ...
        return DescriptorRenderer.f146902k.N(descriptor) + " | " + RuntimeTypeMapper.f144044a.f(descriptor).getString();
    }
    ...
    private final a M(String desc, boolean parseReturnType) {
        ...
        while (true) {
            ...
            if (StringsKt.c0("VZCBSIFJD", cCharAt, false, 2, null)) {
                int i12 = i11 + 1;
                str = desc;
                iP0 = i12;
            } else {
                ...
                str = desc;
                iP0 = StringsKt.p0(str, ';', i10, false, 4, null) + 1;
            }
            arrayList.add(N(str, i10, iP0));
            i10 = iP0;
            desc = str;
        }
    }
    ...
    public static final CharSequence z(FunctionDescriptor descriptor) {
        Intrinsics.j(descriptor, "descriptor");
        return DescriptorRenderer.f146902k.N(descriptor) + " | " + RuntimeTypeMapper.f144044a.g(descriptor).get_signature();
    }
    ...
    public final PropertyDescriptor B(String name, String signature) {
        ...
        MatchResult matchResultI = f143958c.i(signature);
        ...
        for (Object obj : collectionK) {
            if (Intrinsics.e(RuntimeTypeMapper.f144044a.f((PropertyDescriptor) obj).getString(), signature)) {
                arrayList.add(obj);
            }
        }
        ...
        Collection collectionValues = MapsKt.j(linkedHashMap, new O(N.f144035a)).values();
    ...
    */
    protected final java.util.Collection<kotlin.reflect.jvm.internal.KCallableImpl<?>> I(kotlin.reflect.jvm.internal.impl.resolve.scopes.MemberScope r8, kotlin.reflect.jvm.internal.KDeclarationContainerImpl.MemberBelonginess r9) {
        ...
        L20:
            ...
            kotlin.reflect.jvm.internal.impl.descriptors.DescriptorVisibility r6 = kotlin.reflect.jvm.internal.impl.descriptors.DescriptorVisibilities.f144510h
    ...
    */
    ...
    private final void q(List<Class<?>> result, List<? extends Class<?>> valueParameters, boolean isConstructor) {
        Class<?> cls;
        if (Intrinsics.e(CollectionsKt.F0(valueParameters), f143957b)) {
