...
public final class KPackageImpl extends KDeclarationContainerImpl {
    ...
    final class a extends KDeclarationContainerImpl.Data {
        ...
        public a() {
            super();
            this.kotlinClass = ReflectProperties.c(new C15328a0(KPackageImpl.this));
            this.scope = ReflectProperties.c(new C15330b0(this));
            LazyThreadSafetyMode lazyThreadSafetyMode = LazyThreadSafetyMode.f143287b;
            this.multifileFacade = LazyKt.a(lazyThreadSafetyMode, new C15332c0(this, KPackageImpl.this));
        ...
        private final ReflectKotlinClass i() {
            return (ReflectKotlinClass) this.kotlinClass.b(this, f143983j[0]);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final ReflectKotlinClass m(KPackageImpl kPackageImpl) {
            return ReflectKotlinClass.f144947c.a(kPackageImpl.h());
        }
        ...
        public final MemberScope l() {
            T tB = this.scope.b(this, f143983j[1]);
        ...
        public static final Collection n(KPackageImpl kPackageImpl, a aVar) {
            return kPackageImpl.I(aVar.l(), KDeclarationContainerImpl.MemberBelonginess.f143962a);
        }
    ...
    /* synthetic */ class b extends FunctionReferenceImpl implements Function2<MemberDeserializer, ProtoBuf.Property, PropertyDescriptor> {
        ...
        public static final b f143990b = new b();
    ...
    public KPackageImpl(Class<?> jClass) {
        ...
        this.jClass = jClass;
        this.data = LazyKt.a(LazyThreadSafetyMode.f143287b, new Z(this));
    }
    ...
    public Collection<FunctionDescriptor> G(Name name) {
        ...
        return S().b(name, NoLookupLocation.f145029h);
    }
    ...
    public PropertyDescriptor H(int index) {
        ...
        if (tripleJ != null) {
            ...
            GeneratedMessageLite.GeneratedExtension<ProtoBuf.Package, List<ProtoBuf.Property>> packageLocalVariable = JvmProtoBuf.f146473n;
            ...
            if (property != null) {
                ...
                return (PropertyDescriptor) UtilKt.h(clsH, property, jvmNameResolverA, new TypeTable(typeTableW), metadataVersionC, b.f143990b);
            }
        }
        return null;
    }
    ...
    public Collection<PropertyDescriptor> K(Name name) {
        Intrinsics.j(name, "name");
        return S().c(name, NoLookupLocation.f145029h);
    }
