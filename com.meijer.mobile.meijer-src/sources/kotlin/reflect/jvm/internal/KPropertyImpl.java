...
public abstract class KPropertyImpl<V> extends KCallableImpl<V> implements KProperty<V> {
    ...
    private static final Object f144009n = new Object();
    ...
    public static abstract class Getter<V> extends Accessor<V, V> implements KProperty.Getter<V> {
        ...
        static final /* synthetic */ KProperty<Object>[] f144016i = {Reflection.j(new PropertyReference1Impl(Getter.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/PropertyGetterDescriptor;", 0))};

        /* renamed from: g, reason: collision with root package name and from kotlin metadata */
        private final ReflectProperties.LazySoftVal descriptor = ReflectProperties.c(new p0(this));

        /* renamed from: h, reason: collision with root package name and from kotlin metadata */
        private final Lazy caller = LazyKt.a(LazyThreadSafetyMode.f143287b, new q0(this));
        ...
        public PropertyGetterDescriptor X() {
            T tB = this.descriptor.b(this, f144016i[0]);
        ...
        public static final PropertyGetterDescriptor c0(Getter getter) {
            ...
            if (getter2 == null) {
                PropertyGetterDescriptorImpl propertyGetterDescriptorImplD = DescriptorFactory.d(getter.a().X(), Annotations.f144596s3.b());
    ...
    public static abstract class Setter<V> extends Accessor<V, Unit> implements KMutableProperty.Setter<V> {
        ...
        /* renamed from: i, reason: collision with root package name */
        static final /* synthetic */ KProperty<Object>[] f144019i = {Reflection.j(new PropertyReference1Impl(Setter.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/PropertySetterDescriptor;", 0))};

        /* renamed from: g, reason: collision with root package name and from kotlin metadata */
        private final ReflectProperties.LazySoftVal descriptor = ReflectProperties.c(new r0(this));

        /* renamed from: h, reason: collision with root package name and from kotlin metadata */
        private final Lazy caller = LazyKt.a(LazyThreadSafetyMode.f143287b, new s0(this));
        ...
        public PropertySetterDescriptor X() {
            T tB = this.descriptor.b(this, f144019i[0]);
            Intrinsics.i(tB, "getValue(...)");
    ...
    private KPropertyImpl(KDeclarationContainerImpl kDeclarationContainerImpl, String str, String str2, PropertyDescriptor propertyDescriptor, Object obj) {
        ...
        this._javaField = LazyKt.a(LazyThreadSafetyMode.f143287b, new n0(this));
    ...
    public static final Field Y(KPropertyImpl kPropertyImpl) {
        ...
        JvmPropertySignature jvmPropertySignatureF = RuntimeTypeMapper.f144044a.f(kPropertyImpl.X());
        ...
        JvmMemberSignature.Field fieldD = JvmProtoBufUtil.d(JvmProtoBufUtil.f146571a, kotlinProperty.getProto(), kotlinProperty.getNameResolver(), kotlinProperty.getTypeTable(), false, 8, null);
        if (fieldD == null) {
            return null;
        }
    ...
    public String toString() {
        return ReflectionObjectRenderer.f144042a.k(X());
    }
    ...
    protected final Member b0() {
        ...
        JvmPropertySignature jvmPropertySignatureF = RuntimeTypeMapper.f144044a.f(X());
        if (jvmPropertySignatureF instanceof JvmPropertySignature.KotlinProperty) {
            JvmPropertySignature.KotlinProperty kotlinProperty = (JvmPropertySignature.KotlinProperty) jvmPropertySignatureF;
    ...
    public KPropertyImpl(KDeclarationContainerImpl container, PropertyDescriptor descriptor) {
        ...
        this(container, strB, RuntimeTypeMapper.f144044a.f(descriptor).getString(), descriptor, CallableReference.NO_RECEIVER);
    }
}
