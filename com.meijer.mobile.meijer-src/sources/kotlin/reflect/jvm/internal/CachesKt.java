...
public final class CachesKt {
    ...
    private static final CacheByClass<KClassImpl<? extends Object>> f143890a = CacheByClassKt.a(C15327a.f144056a);

    /* renamed from: b, reason: collision with root package name */
    private static final CacheByClass<KPackageImpl> f143891b = CacheByClassKt.a(C15329b.f144058a);

    /* renamed from: c, reason: collision with root package name */
    private static final CacheByClass<KType> f143892c = CacheByClassKt.a(C15331c.f144060a);

    /* renamed from: d, reason: collision with root package name */
    private static final CacheByClass<KType> f143893d = CacheByClassKt.a(C15333d.f144122a);

    /* renamed from: e, reason: collision with root package name */
    private static final CacheByClass<ConcurrentHashMap<Pair<List<KTypeProjection>, Boolean>, KType>> f143894e = CacheByClassKt.a(C15334e.f144124a);
    ...
    public static final <T> KType k(Class<T> jClass, List<KTypeProjection> arguments, boolean z10) {
        ...
        return arguments.isEmpty() ? z10 ? f143893d.a(jClass) : f143892c.a(jClass) : l(jClass, arguments, z10);
    }

    private static final <T> KType l(Class<T> cls, List<KTypeProjection> list, boolean z10) {
        ConcurrentHashMap<Pair<List<KTypeProjection>, Boolean>, KType> concurrentHashMapA = f143894e.a(cls);
    ...
    public static final <T> KClassImpl<T> m(Class<T> jClass) {
        Intrinsics.j(jClass, "jClass");
        KAnnotatedElement kAnnotatedElementA = f143890a.a(jClass);
