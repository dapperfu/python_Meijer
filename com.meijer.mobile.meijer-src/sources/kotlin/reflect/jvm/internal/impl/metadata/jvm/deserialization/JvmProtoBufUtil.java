...
public final class JvmProtoBufUtil {
    ...
    public static final JvmProtoBufUtil f146571a = new JvmProtoBufUtil();

    /* renamed from: b, reason: collision with root package name */
    private static final ExtensionRegistryLite f146572b;
    ...
    static {
        ...
        f146572b = extensionRegistryLiteD;
    }
    ...
    public static final boolean f(ProtoBuf.Property proto) {
        ...
        Flags.BooleanFlagField booleanFlagFieldA = JvmFlags.f146555a.a();
        Object objU = proto.u(JvmProtoBuf.f146464e);
    ...
    public static final Pair<JvmNameResolver, ProtoBuf.Class> h(byte[] bytes, String[] strings) {
        ...
        return new Pair<>(f146571a.k(byteArrayInputStream, strings), ProtoBuf.Class.C1(byteArrayInputStream, f146572b));
    }
    ...
    public static final Pair<JvmNameResolver, ProtoBuf.Function> j(String[] data, String[] strings) {
        ...
        return new Pair<>(f146571a.k(byteArrayInputStream, strings), ProtoBuf.Function.K0(byteArrayInputStream, f146572b));
    }

    private final JvmNameResolver k(InputStream inputStream, String[] strArr) throws IOException {
        JvmProtoBuf.StringTableTypes stringTableTypesE = JvmProtoBuf.StringTableTypes.E(inputStream, f146572b);
    ...
    public static final Pair<JvmNameResolver, ProtoBuf.Package> l(byte[] bytes, String[] strings) {
        ...
        Intrinsics.j(strings, "strings");
        ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(bytes);
        return new Pair<>(f146571a.k(byteArrayInputStream, strings), ProtoBuf.Package.e0(byteArrayInputStream, f146572b));
    }
    ...
    public final JvmMemberSignature.Method b(ProtoBuf.Constructor proto, NameResolver nameResolver, TypeTable typeTable) {
        ...
        GeneratedMessageLite.GeneratedExtension<ProtoBuf.Constructor, JvmProtoBuf.JvmMethodSignature> constructorSignature = JvmProtoBuf.f146460a;
        ...
        if (jvmMethodSignature == null || !jvmMethodSignature.z()) {
            ...
            for (ProtoBuf.ValueParameter valueParameter : list) {
                JvmProtoBufUtil jvmProtoBufUtil = f146571a;
    ...
    public final JvmMemberSignature.Method e(ProtoBuf.Function proto, NameResolver nameResolver, TypeTable typeTable) {
        ...
        Intrinsics.j(nameResolver, "nameResolver");
        Intrinsics.j(typeTable, "typeTable");
        GeneratedMessageLite.GeneratedExtension<ProtoBuf.Function, JvmProtoBuf.JvmMethodSignature> methodSignature = JvmProtoBuf.f146461b;
        ...
        if (jvmMethodSignature == null || !jvmMethodSignature.z()) {
            ...
            while (it.hasNext()) {
                String strG = f146571a.g((ProtoBuf.Type) it.next(), nameResolver);
                if (strG == null) {
                    return null;
                }
                arrayList2.add(strG);
