...
public final class NameResolverImpl implements NameResolver {
    ...
    private final ProtoBuf.StringTable f146454a;

    /* renamed from: b, reason: collision with root package name */
    private final ProtoBuf.QualifiedNameTable f146455b;
    ...
    public NameResolverImpl(ProtoBuf.StringTable strings, ProtoBuf.QualifiedNameTable qualifiedNames) {
        ...
        this.f146454a = strings;
        this.f146455b = qualifiedNames;
    }
    ...
    private final Triple<List<String>, List<String>, Boolean> c(int i10) {
        ...
        boolean z10 = false;
        while (i10 != -1) {
            ProtoBuf.QualifiedNameTable.QualifiedName qualifiedNameV = this.f146455b.v(i10);
            String strV = this.f146454a.v(qualifiedNameV.A());
    ...
    public String getString(int i10) {
        String strV = this.f146454a.v(i10);
    ...
    public String b(int i10) {
        ...
        return CollectionsKt.B0(listA, q2.f93563c, null, null, 0, null, null, 62, null) + '/' + strB0;
    }
}
