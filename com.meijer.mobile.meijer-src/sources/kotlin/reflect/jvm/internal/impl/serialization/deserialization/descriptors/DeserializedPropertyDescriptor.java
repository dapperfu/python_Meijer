...
public final class DeserializedPropertyDescriptor extends PropertyDescriptorImpl implements DeserializedCallableMemberDescriptor {
    ...
    private final ProtoBuf.Property f147449C;

    /* renamed from: D, reason: collision with root package name */
    private final NameResolver f147450D;

    /* renamed from: E, reason: collision with root package name */
    private final TypeTable f147451E;

    /* renamed from: F, reason: collision with root package name */
    private final VersionRequirementTable f147452F;

    /* renamed from: G, reason: collision with root package name */
    private final DeserializedContainerSource f147453G;
    ...
    public DeserializedPropertyDescriptor(DeclarationDescriptor containingDeclaration, PropertyDescriptor propertyDescriptor, Annotations annotations, Modality modality, DescriptorVisibility visibility, boolean z10, Name name, CallableMemberDescriptor.Kind kind, boolean z11, boolean z12, boolean z13, boolean z14, boolean z15, ProtoBuf.Property proto, NameResolver nameResolver, TypeTable typeTable, VersionRequirementTable versionRequirementTable, DeserializedContainerSource deserializedContainerSource) {
        super(containingDeclaration, propertyDescriptor, annotations, modality, visibility, z10, name, kind, SourceElement.f144554a, z11, z12, z15, false, z13, z14);
        ...
        this.f147449C = proto;
        this.f147450D = nameResolver;
        this.f147451E = typeTable;
        this.f147452F = versionRequirementTable;
        this.f147453G = deserializedContainerSource;
    }
    ...
    public boolean isExternal() {
        Boolean boolD = Flags.f146408E.d(c0().f0());
