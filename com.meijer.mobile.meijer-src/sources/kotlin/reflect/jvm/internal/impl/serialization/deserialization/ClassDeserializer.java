...
public final class ClassDeserializer {
    ...
    public static final Companion f147269c = new Companion(null);

    /* renamed from: d, reason: collision with root package name */
    private static final Set<ClassId> f147270d = SetsKt.d(ClassId.f146581d.c(StandardNames.FqNames.f144281d.m()));

    /* renamed from: a, reason: collision with root package name */
    private final DeserializationComponents f147271a;

    /* renamed from: b, reason: collision with root package name */
    private final Function1<a, ClassDescriptor> f147272b;
    ...
    public static final class Companion {
        ...
        public final Set<ClassId> a() {
            return ClassDeserializer.f147270d;
        }
    }
    ...
    static final class a {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final ClassId f147273a;

        /* renamed from: b, reason: collision with root package name */
        private final ClassData f147274b;

        public a(ClassId classId, ClassData classData) {
            Intrinsics.j(classId, "classId");
            this.f147273a = classId;
            this.f147274b = classData;
        }
        ...
        public boolean equals(Object obj) {
            return (obj instanceof a) && Intrinsics.e(this.f147273a, ((a) obj).f147273a);
        }

        public int hashCode() {
            return this.f147273a.hashCode();
        }
    }

    public ClassDeserializer(DeserializationComponents components) {
        Intrinsics.j(components, "components");
        this.f147271a = components;
        this.f147272b = components.u().g(new b(this));
    }
    ...
    public final ClassDescriptor e(ClassId classId, ClassData classData) {
        Intrinsics.j(classId, "classId");
        return this.f147272b.invoke(new a(classId, classData));
    }
    ...
    private final ClassDescriptor d(a aVar) {
        ...
        Iterator<ClassDescriptorFactory> it = this.f147271a.l().iterator();
        while (it.hasNext()) {
        ...
        if (f147270d.contains(classIdB)) {
            return null;
        }
        ClassData classDataA = aVar.a();
        if (classDataA == null && (classDataA = this.f147271a.e().a(classIdB)) == null) {
            return null;
        }
        ...
        if (classIdE != null) {
            ...
            Iterator<T> it2 = PackageFragmentProviderKt.c(this.f147271a.s(), classIdB.f()).iterator();
            while (true) {
                if (it2.hasNext()) {
                    next = it2.next();
            ...
            DeserializationComponents deserializationComponents = this.f147271a;
