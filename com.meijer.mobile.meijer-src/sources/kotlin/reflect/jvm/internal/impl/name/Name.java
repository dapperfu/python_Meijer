...
public final class Name implements Comparable<Name> {
    ...
    private final String f146596a;

    /* renamed from: b, reason: collision with root package name */
    private final boolean f146597b;
    ...
    public boolean equals(Object obj) {
        ...
        Name name = (Name) obj;
        return this.f146597b == name.f146597b && this.f146596a.equals(name.f146596a);
    }
    ...
    public int compareTo(Name name) {
        return this.f146596a.compareTo(name.f146596a);
    }

    public int hashCode() {
        return (this.f146596a.hashCode() * 31) + (this.f146597b ? 1 : 0);
    }
