...
public final class OperatorChecks extends AbstractModifierChecks {
    ...
    public static final OperatorChecks f147983a = new OperatorChecks();

    /* renamed from: b, reason: collision with root package name */
    private static final List<Checks> f147984b;

    static {
        Name name = OperatorNameConventions.f148028k;
        MemberKindCheck.MemberOrExtension memberOrExtension = MemberKindCheck.MemberOrExtension.f147977b;
        ...
        Checks checks2 = new Checks(OperatorNameConventions.f148029l, new Check[]{memberOrExtension, new ValueParameterCountCheck.AtLeast(2)}, c.f148061a);
        Name name2 = OperatorNameConventions.f148013b;
        b bVar = b.f148059a;
        ...
        Checks checks4 = new Checks(OperatorNameConventions.f148015c, new Check[]{memberOrExtension, bVar, new ValueParameterCountCheck.AtLeast(3), aVar}, (Function1) null, 4, (DefaultConstructorMarker) null);
        Checks checks5 = new Checks(OperatorNameConventions.f148017d, new Check[]{memberOrExtension, bVar, new ValueParameterCountCheck.Equals(2), aVar}, (Function1) null, 4, (DefaultConstructorMarker) null);
        Checks checks6 = new Checks(OperatorNameConventions.f148026i, new Check[]{memberOrExtension}, (Function1) null, 4, (DefaultConstructorMarker) null);
        Name name3 = OperatorNameConventions.f148025h;
        ValueParameterCountCheck.SingleValueParameter singleValueParameter = ValueParameterCountCheck.SingleValueParameter.f148056b;
        ReturnsCheck.ReturnsBoolean returnsBoolean = ReturnsCheck.ReturnsBoolean.f148047d;
        ...
        Name name4 = OperatorNameConventions.f148027j;
        ValueParameterCountCheck.NoValueParameters noValueParameters = ValueParameterCountCheck.NoValueParameters.f148055b;
        f147984b = CollectionsKt.p(checks, checks2, checks3, checks4, checks5, checks6, checks7, new Checks(name4, new Check[]{memberOrExtension, noValueParameters}, (Function1) null, 4, (DefaultConstructorMarker) null), new Checks(OperatorNameConventions.f148030m, new Check[]{memberOrExtension, noValueParameters}, (Function1) null, 4, (DefaultConstructorMarker) null), new Checks(OperatorNameConventions.f148031n, new Check[]{memberOrExtension, noValueParameters, returnsBoolean}, (Function1) null, 4, (DefaultConstructorMarker) null), new Checks(OperatorNameConventions.f147992H, new Check[]{memberOrExtension, singleValueParameter, bVar}, (Function1) null, 4, (DefaultConstructorMarker) null), new Checks(OperatorNameConventions.f147993I, new Check[]{memberOrExtension, singleValueParameter, bVar}, (Function1) null, 4, (DefaultConstructorMarker) null), new Checks(OperatorNameConventions.f148019e, new Check[]{MemberKindCheck.Member.f147976b}, d.f148062a), new Checks(OperatorNameConventions.f148023g, new Check[]{memberOrExtension, ReturnsCheck.ReturnsInt.f148048d, singleValueParameter, bVar}, (Function1) null, 4, (DefaultConstructorMarker) null), new Checks(OperatorNameConventions.f148008X, new Check[]{memberOrExtension, singleValueParameter, bVar}, (Function1) null, 4, (DefaultConstructorMarker) null), new Checks(OperatorNameConventions.f148007W, new Check[]{memberOrExtension, noValueParameters}, (Function1) null, 4, (DefaultConstructorMarker) null), new Checks(CollectionsKt.p(OperatorNameConventions.f148041x, OperatorNameConventions.f148042y), new Check[]{memberOrExtension}, e.f148063a), new Checks(OperatorNameConventions.f148016c0, new Check[]{memberOrExtension, ReturnsCheck.ReturnsUnit.f148049d, singleValueParameter, bVar}, (Function1) null, 4, (DefaultConstructorMarker) null), new Checks(OperatorNameConventions.f148033p, new Check[]{memberOrExtension, noValueParameters}, (Function1) null, 4, (DefaultConstructorMarker) null));
    }
    ...
    */
    public static final java.lang.String g(kotlin.reflect.jvm.internal.impl.descriptors.FunctionDescriptor r3) {
        ...
        L51:
            ...
            if (r1 == 0) goto La1
            kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer r1 = kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer.f146901j
    ...
    public static final String i(FunctionDescriptor Checks) {
        ...
        OperatorChecks operatorChecks = f147983a;
        boolean z10 = false;
        if (receiverParameterDescriptorJ != null) {
