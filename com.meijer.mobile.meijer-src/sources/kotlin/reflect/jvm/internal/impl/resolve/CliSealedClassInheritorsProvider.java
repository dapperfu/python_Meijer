...
public final class CliSealedClassInheritorsProvider extends SealedClassInheritorsProvider {
    ...
    public static final CliSealedClassInheritorsProvider f147022a = new CliSealedClassInheritorsProvider();
    ...
    private static final void b(ClassDescriptor classDescriptor, LinkedHashSet<ClassDescriptor> linkedHashSet, MemberScope memberScope, boolean z10) {
        for (DeclarationDescriptor declarationDescriptor : ResolutionScope.DefaultImpls.a(memberScope, DescriptorKindFilter.f147179t, null, 2, null)) {
            if (declarationDescriptor instanceof ClassDescriptor) {
                ...
                if (classDescriptorS.h0()) {
                    ...
                    ClassifierDescriptor classifierDescriptorF = memberScope.f(name, NoLookupLocation.f145034m);
    ...
    public Collection<ClassDescriptor> a(ClassDescriptor sealedClass, boolean z10) {
        ...
        if (sealedClass.q() != Modality.f144527c) {
