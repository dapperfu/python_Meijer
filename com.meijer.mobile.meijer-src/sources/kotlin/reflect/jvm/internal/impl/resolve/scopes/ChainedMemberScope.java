...
public final class ChainedMemberScope implements MemberScope {
    ...
    public static final Companion f147156d = new Companion(null);

    /* renamed from: b, reason: collision with root package name */
    private final String f147157b;

    /* renamed from: c, reason: collision with root package name */
    private final MemberScope[] f147158c;
    ...
    public static final class Companion {
        ...
        public final MemberScope a(String debugName, Iterable<? extends MemberScope> scopes) {
            ...
            for (MemberScope memberScope : scopes) {
                if (memberScope != MemberScope.Empty.f147200b) {
                    if (memberScope instanceof ChainedMemberScope) {
                        CollectionsKt.D(smartList, ((ChainedMemberScope) memberScope).f147158c);
                    } else {
        ...
        public final MemberScope b(String debugName, List<? extends MemberScope> scopes) {
            ...
            return size != 0 ? size != 1 ? new ChainedMemberScope(debugName, (MemberScope[]) scopes.toArray(new MemberScope[0]), null) : scopes.get(0) : MemberScope.Empty.f147200b;
        }
    }
    ...
    private ChainedMemberScope(String str, MemberScope[] memberScopeArr) {
        this.f147157b = str;
        this.f147158c = memberScopeArr;
    }

    @Override // kotlin.reflect.jvm.internal.impl.resolve.scopes.MemberScope
    public Set<Name> a() {
        MemberScope[] memberScopeArr = this.f147158c;
    ...
    @Override // kotlin.reflect.jvm.internal.impl.resolve.scopes.MemberScope
    public Set<Name> e() {
        return MemberScopeKt.a(ArraysKt.R(this.f147158c));
    }
    ...
    public ClassifierDescriptor f(Name name, LookupLocation location) {
        ...
        for (MemberScope memberScope : this.f147158c) {
