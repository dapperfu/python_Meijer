...
public final class IntegerLiteralTypeConstructor implements TypeConstructor {
    ...
    public static final Companion f147087f = new Companion(null);

    /* renamed from: a, reason: collision with root package name */
    private final long f147088a;

    /* renamed from: b, reason: collision with root package name */
    private final ModuleDescriptor f147089b;

    /* renamed from: c, reason: collision with root package name */
    private final Set<KotlinType> f147090c;

    /* renamed from: d, reason: collision with root package name */
    private final SimpleType f147091d;

    /* renamed from: e, reason: collision with root package name */
    private final Lazy f147092e;
    ...
    public static final class Companion {
        ...
        public /* synthetic */ class WhenMappings {
            ...
            static {
                ...
                try {
                    iArr[a.f147093a.ordinal()] = 1;
                } catch (NoSuchFieldError unused) {
                }
                try {
                    iArr[a.f147094b.ordinal()] = 2;
        ...
        private static final class a {
            ...
            /* renamed from: a, reason: collision with root package name */
            public static final a f147093a = new a("COMMON_SUPER_TYPE", 0);

            /* renamed from: b, reason: collision with root package name */
            public static final a f147094b = new a("INTERSECTION_TYPE", 1);

            /* renamed from: c, reason: collision with root package name */
            private static final /* synthetic */ a[] f147095c;

            /* renamed from: d, reason: collision with root package name */
            private static final /* synthetic */ EnumEntries f147096d;

            private static final /* synthetic */ a[] a() {
                return new a[]{f147093a, f147094b};
            }

            static {
                a[] aVarArrA = a();
                f147095c = aVarArrA;
                f147096d = EnumEntriesKt.a(aVarArrA);
            }
        ...
        private final SimpleType c(IntegerLiteralTypeConstructor integerLiteralTypeConstructor, IntegerLiteralTypeConstructor integerLiteralTypeConstructor2, a aVar) {
            ...
            return KotlinTypeFactory.f(TypeAttributes.f147647b.k(), new IntegerLiteralTypeConstructor(integerLiteralTypeConstructor.f147088a, integerLiteralTypeConstructor.f147089b, setX0, null), false);
        }

        public final SimpleType b(Collection<? extends SimpleType> types) {
            Intrinsics.j(types, "types");
            return a(types, a.f147094b);
        }
        ...
        private final SimpleType a(Collection<? extends SimpleType> collection, a aVar) {
            ...
            if (it.hasNext()) {
                ...
                while (it.hasNext()) {
                    ...
                    next = IntegerLiteralTypeConstructor.f147087f.e((SimpleType) next, simpleType, aVar);
                }
    ...
    private IntegerLiteralTypeConstructor(long j10, ModuleDescriptor moduleDescriptor, Set<? extends KotlinType> set) {
        this.f147091d = KotlinTypeFactory.f(TypeAttributes.f147647b.k(), this, false);
        this.f147092e = LazyKt.b(new b(this));
        this.f147088a = j10;
        this.f147089b = moduleDescriptor;
        this.f147090c = set;
    }

    private final List<KotlinType> k() {
        return (List) this.f147092e.getValue();
    }

    private final boolean m() {
        Collection<KotlinType> collectionA = PrimitiveTypeUtilKt.a(this.f147089b);
        if ((collectionA instanceof Collection) && collectionA.isEmpty()) {
            return true;
        }
        Iterator<T> it = collectionA.iterator();
        while (it.hasNext()) {
            if (this.f147090c.contains((KotlinType) it.next())) {
                return false;
            }
        }
        return true;
    ...
    private final String o() {
        return '[' + CollectionsKt.B0(this.f147090c, ",", null, null, 0, null, c.f147106a, 30, null) + ']';
    }
    ...
    public static final List n(IntegerLiteralTypeConstructor integerLiteralTypeConstructor) {
        ...
        List listS = CollectionsKt.s(TypeSubstitutionKt.f(simpleTypeO, CollectionsKt.e(new TypeProjectionImpl(Variance.f147704f, integerLiteralTypeConstructor.f147091d)), null, 2, null));
