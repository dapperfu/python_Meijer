...
public class DescriptorFactory {
    ...
    private static class a extends ClassConstructorDescriptorImpl {
        ...
        public a(ClassDescriptor classDescriptor, SourceElement sourceElement, boolean z10) {
            super(classDescriptor, null, Annotations.f144596s3.b(), true, CallableMemberDescriptor.Kind.DECLARATION, sourceElement);
    ...
    public static PropertyDescriptor f(ClassDescriptor classDescriptor) {
        ...
        Name name = StandardNames.f144205e;
        ...
        SimpleType simpleTypeI = KotlinTypeFactory.i(TypeAttributes.f147647b.k(), classDescriptorA.i(), Collections.singletonList(new TypeProjectionImpl(classDescriptor.o())), false);
    ...
    public static SimpleFunctionDescriptor g(ClassDescriptor classDescriptor) {
        ...
        Annotations.Companion companion = Annotations.f144596s3;
        SimpleFunctionDescriptorImpl simpleFunctionDescriptorImplI1 = SimpleFunctionDescriptorImpl.i1(classDescriptor, companion.b(), StandardNames.f144206f, CallableMemberDescriptor.Kind.SYNTHESIZED, classDescriptor.g());
        ...
        SimpleFunctionDescriptorImpl simpleFunctionDescriptorImplK1 = simpleFunctionDescriptorImplI1.O0(null, null, list, list, Collections.singletonList(valueParameterDescriptorImpl), classDescriptor.o(), Modality.f144526b, DescriptorVisibilities.f144507e);
    ...
    public static SimpleFunctionDescriptor h(ClassDescriptor classDescriptor) {
        ...
        SimpleFunctionDescriptorImpl simpleFunctionDescriptorImplI1 = SimpleFunctionDescriptorImpl.i1(classDescriptor, Annotations.f144596s3.b(), StandardNames.f144204d, CallableMemberDescriptor.Kind.SYNTHESIZED, classDescriptor.g());
        List<ReceiverParameterDescriptor> list = Collections.EMPTY_LIST;
        SimpleFunctionDescriptorImpl simpleFunctionDescriptorImplK1 = simpleFunctionDescriptorImplI1.O0(null, null, list, list, list, DescriptorUtilsKt.m(classDescriptor).m(Variance.f147703e, classDescriptor.o()), Modality.f144526b, DescriptorVisibilities.f144507e);
        if (simpleFunctionDescriptorImplK1 == null) {
            a(23);
        }
        return simpleFunctionDescriptorImplK1;
    ...
    public static boolean p(FunctionDescriptor functionDescriptor) {
        ...
        return functionDescriptor.getName().equals(StandardNames.f144206f) && o(functionDescriptor);
    }
    ...
    public static boolean q(FunctionDescriptor functionDescriptor) {
        ...
        return functionDescriptor.getName().equals(StandardNames.f144204d) && o(functionDescriptor);
    }
}
