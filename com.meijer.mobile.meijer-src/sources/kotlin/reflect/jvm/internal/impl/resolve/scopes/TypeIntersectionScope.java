...
public final class TypeIntersectionScope extends AbstractScopeAdapter {
    ...
    public static final Companion f147211d = new Companion(null);

    /* renamed from: b, reason: collision with root package name */
    private final String f147212b;

    /* renamed from: c, reason: collision with root package name */
    private final MemberScope f147213c;
    ...
    public static final class Companion {
        ...
        public final MemberScope a(String message, Collection<? extends KotlinType> types) {
            ...
            MemberScope memberScopeB = ChainedMemberScope.f147156d.b(message, smartListB);
    ...
    public static final MemberScope m(String str, Collection<? extends KotlinType> collection) {
        return f147211d.a(str, collection);
    }
    ...
    public Collection<SimpleFunctionDescriptor> b(Name name, LookupLocation location) {
        ...
        return OverridingUtilsKt.b(super.b(name, location), h.f147221a);
    }
    ...
    public Collection<PropertyDescriptor> c(Name name, LookupLocation location) {
        Intrinsics.j(name, "name");
        Intrinsics.j(location, "location");
        return OverridingUtilsKt.b(super.c(name, location), i.f147222a);
    }
    ...
    public Collection<DeclarationDescriptor> g(DescriptorKindFilter kindFilter, Function1<? super Name, Boolean> nameFilter) {
        ...
        return CollectionsKt.P0(OverridingUtilsKt.b(list, j.f147223a), list2);
    }
