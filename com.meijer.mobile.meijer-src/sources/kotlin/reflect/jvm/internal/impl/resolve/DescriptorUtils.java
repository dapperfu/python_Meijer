...
public class DescriptorUtils {
    ...
    public static final FqName f147024a = new FqName("kotlin.jvm.JvmName");
    ...
    public static boolean A(DeclarationDescriptor declarationDescriptor) {
        return D(declarationDescriptor, ClassKind.f144494d);
    }
    ...
    public static boolean B(DeclarationDescriptor declarationDescriptor) {
        ...
        return D(declarationDescriptor, ClassKind.f144495e);
    }

    public static boolean C(DeclarationDescriptor declarationDescriptor) {
        return D(declarationDescriptor, ClassKind.f144493c);
    }
    ...
    public static boolean G(DeclarationDescriptor declarationDescriptor) {
        return (D(declarationDescriptor, ClassKind.f144492b) || D(declarationDescriptor, ClassKind.f144493c)) && ((ClassDescriptor) declarationDescriptor).q() == Modality.f144527c;
    }
    ...
    public static DescriptorVisibility k(ClassDescriptor classDescriptor, boolean z10) {
        ...
        if (classKindF == ClassKind.f144494d || classKindF.b()) {
            DescriptorVisibility descriptorVisibility = DescriptorVisibilities.f144503a;
        ...
        if (G(classDescriptor)) {
            if (z10) {
                DescriptorVisibility descriptorVisibility2 = DescriptorVisibilities.f144505c;
                if (descriptorVisibility2 == null) {
                    a(50);
                }
                return descriptorVisibility2;
            }
            DescriptorVisibility descriptorVisibility3 = DescriptorVisibilities.f144503a;
        ...
        if (u(classDescriptor)) {
            DescriptorVisibility descriptorVisibility4 = DescriptorVisibilities.f144514l;
            if (descriptorVisibility4 == null) {
                a(52);
            }
            return descriptorVisibility4;
        }
        DescriptorVisibility descriptorVisibility5 = DescriptorVisibilities.f144507e;
    ...
    public static ClassDescriptor s(ClassDescriptor classDescriptor) {
        ...
        while (it.hasNext()) {
            ...
            if (classDescriptorE.f() != ClassKind.f144493c) {
    ...
    public static boolean t(DeclarationDescriptor declarationDescriptor) {
        return D(declarationDescriptor, ClassKind.f144496f);
    }
    ...
    public static boolean u(DeclarationDescriptor declarationDescriptor) {
        ...
        return v(declarationDescriptor) && declarationDescriptor.getName().equals(SpecialNames.f146602b);
    }

    public static boolean v(DeclarationDescriptor declarationDescriptor) {
        return D(declarationDescriptor, ClassKind.f144492b);
    }

    public static boolean x(DeclarationDescriptor declarationDescriptor) {
        return D(declarationDescriptor, ClassKind.f144497g) && ((ClassDescriptor) declarationDescriptor).Z();
    }

    public static boolean y(DeclarationDescriptor declarationDescriptor) {
        return (declarationDescriptor instanceof DeclarationDescriptorWithVisibility) && ((DeclarationDescriptorWithVisibility) declarationDescriptor).getVisibility() == DescriptorVisibilities.f144508f;
    }
