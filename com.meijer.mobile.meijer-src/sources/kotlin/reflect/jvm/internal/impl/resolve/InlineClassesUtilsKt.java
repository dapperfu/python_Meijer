...
public final class InlineClassesUtilsKt {
    ...
    private static final FqName f147033a;

    /* renamed from: b, reason: collision with root package name */
    private static final ClassId f147034b;

    static {
        FqName fqName = new FqName("kotlin.jvm.JvmInline");
        f147033a = fqName;
        f147034b = ClassId.f146581d.c(fqName);
    }
    ...
    public static final boolean i(KotlinType kotlinType) {
        Intrinsics.j(kotlinType, "<this>");
        ClassifierDescriptor classifierDescriptorD = kotlinType.K0().d();
        return (classifierDescriptorD == null || !d(classifierDescriptorD) || SimpleClassicTypeSystemContext.f147746a.O(kotlinType)) ? false : true;
    }
    ...
    public static final KotlinType j(KotlinType kotlinType) {
        ...
        if (kotlinTypeK != null) {
            return TypeSubstitutor.f(kotlinType).p(kotlinTypeK, Variance.f147703e);
        }
        return null;
    }
