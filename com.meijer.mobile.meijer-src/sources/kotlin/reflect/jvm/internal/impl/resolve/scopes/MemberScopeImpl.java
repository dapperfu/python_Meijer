...
public abstract class MemberScopeImpl implements MemberScope {
    ...
    @Override // kotlin.reflect.jvm.internal.impl.resolve.scopes.MemberScope
    public Set<Name> a() {
        Collection<DeclarationDescriptor> collectionG = g(DescriptorKindFilter.f147181v, FunctionsKt.k());
    ...
    @Override // kotlin.reflect.jvm.internal.impl.resolve.scopes.MemberScope
    public Set<Name> d() {
        Collection<DeclarationDescriptor> collectionG = g(DescriptorKindFilter.f147182w, FunctionsKt.k());
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        for (Object obj : collectionG) {
            if (obj instanceof SimpleFunctionDescriptor) {
                Name name = ((SimpleFunctionDescriptor) obj).getName();
