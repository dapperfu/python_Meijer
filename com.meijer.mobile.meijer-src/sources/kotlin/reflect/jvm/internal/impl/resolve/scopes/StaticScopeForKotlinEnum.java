...
public final class StaticScopeForKotlinEnum extends MemberScopeImpl {
    ...
    static final /* synthetic */ KProperty<Object>[] f147201f = {Reflection.j(new PropertyReference1Impl(StaticScopeForKotlinEnum.class, "functions", "getFunctions()Ljava/util/List;", 0)), Reflection.j(new PropertyReference1Impl(StaticScopeForKotlinEnum.class, "properties", "getProperties()Ljava/util/List;", 0))};

    /* renamed from: b, reason: collision with root package name */
    private final ClassDescriptor f147202b;

    /* renamed from: c, reason: collision with root package name */
    private final boolean f147203c;

    /* renamed from: d, reason: collision with root package name */
    private final NotNullLazyValue f147204d;

    /* renamed from: e, reason: collision with root package name */
    private final NotNullLazyValue f147205e;
    ...
    public StaticScopeForKotlinEnum(StorageManager storageManager, ClassDescriptor containingClass, boolean z10) {
        ...
        this.f147202b = containingClass;
        this.f147203c = z10;
        containingClass.f();
        ClassKind classKind = ClassKind.f144492b;
        this.f147204d = storageManager.c(new d(this));
        this.f147205e = storageManager.c(new e(this));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final List j(StaticScopeForKotlinEnum staticScopeForKotlinEnum) {
        return CollectionsKt.p(DescriptorFactory.g(staticScopeForKotlinEnum.f147202b), DescriptorFactory.h(staticScopeForKotlinEnum.f147202b));
    }

    private final List<SimpleFunctionDescriptor> n() {
        return (List) StorageKt.a(this.f147204d, this, f147201f[0]);
    }

    private final List<PropertyDescriptor> o() {
        return (List) StorageKt.a(this.f147205e, this, f147201f[1]);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final List p(StaticScopeForKotlinEnum staticScopeForKotlinEnum) {
        return staticScopeForKotlinEnum.f147203c ? CollectionsKt.q(DescriptorFactory.f(staticScopeForKotlinEnum.f147202b)) : CollectionsKt.m();
    }
