...
public abstract class VariableDescriptorWithInitializerImpl extends VariableDescriptorImpl {
    ...
    private final boolean f144922f;

    /* renamed from: g, reason: collision with root package name */
    protected NullableLazyValue<ConstantValue<?>> f144923g;

    /* renamed from: h, reason: collision with root package name */
    protected Function0<NullableLazyValue<ConstantValue<?>>> f144924h;
    ...
    public void I0(NullableLazyValue<ConstantValue<?>> nullableLazyValue, Function0<NullableLazyValue<ConstantValue<?>>> function0) {
        ...
        this.f144924h = function0;
        if (nullableLazyValue == null) {
            nullableLazyValue = function0.invoke();
        }
        this.f144923g = nullableLazyValue;
    }
    ...
    public boolean L() {
        return this.f144922f;
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.VariableDescriptor
    public ConstantValue<?> l0() {
        NullableLazyValue<ConstantValue<?>> nullableLazyValue = this.f144923g;
        if (nullableLazyValue != null) {
