...
public abstract class DeclarationDescriptorImpl extends AnnotatedImpl implements DeclarationDescriptor {
    ...
    public static String g0(DeclarationDescriptor declarationDescriptor) {
        ...
        try {
            String str = DescriptorRenderer.f146902k.N(declarationDescriptor) + "[" + declarationDescriptor.getClass().getSimpleName() + "@" + Integer.toHexString(System.identityHashCode(declarationDescriptor)) + "]";
            if (str == null) {
                e0(5);
            }
            return str;
