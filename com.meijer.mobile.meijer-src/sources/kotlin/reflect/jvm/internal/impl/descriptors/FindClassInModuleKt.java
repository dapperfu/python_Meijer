...
public final class FindClassInModuleKt {
    ...
    public static final ClassifierDescriptor c(ModuleDescriptor moduleDescriptor, ClassId classId) {
        ...
        if (moduleDescriptorA == null) {
            ...
            ClassifierDescriptor classifierDescriptorF = packageViewDescriptorI0.n().f((Name) CollectionsKt.s0(listE), NoLookupLocation.f145039r);
            ...
            for (Name name : listE.subList(1, listE.size())) {
                ...
                ClassifierDescriptor classifierDescriptorF2 = ((ClassDescriptor) classifierDescriptorF).R().f(name, NoLookupLocation.f145039r);
        ...
        ClassifierDescriptor classifierDescriptorF3 = packageViewDescriptorI02.n().f((Name) CollectionsKt.s0(listE2), NoLookupLocation.f145039r);
        ...
        for (Name name2 : listE2.subList(1, listE2.size())) {
            if (classifierDescriptorF3 instanceof ClassDescriptor) {
                ClassifierDescriptor classifierDescriptorF4 = ((ClassDescriptor) classifierDescriptorF3).R().f(name2, NoLookupLocation.f145039r);
        ...
        ClassifierDescriptor classifierDescriptorF5 = packageViewDescriptorI03.n().f((Name) CollectionsKt.s0(listE3), NoLookupLocation.f145039r);
        ...
        for (Name name3 : listE3.subList(1, listE3.size())) {
            ...
            ClassifierDescriptor classifierDescriptorF6 = ((ClassDescriptor) classifierDescriptorF5).R().f(name3, NoLookupLocation.f145039r);
    ...
    public static final ClassDescriptor d(ModuleDescriptor moduleDescriptor, ClassId classId, NotFoundClasses notFoundClasses) {
        ...
        return classDescriptorB != null ? classDescriptorB : notFoundClasses.d(classId, SequencesKt.X(SequencesKt.M(SequencesKt.q(classId, new PropertyReference1Impl() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.FindClassInModuleKt.a
