...
public abstract class AbstractReceiverParameterDescriptor extends DeclarationDescriptorImpl implements ReceiverParameterDescriptor {
    ...
    public AbstractReceiverParameterDescriptor(Annotations annotations) {
        super(annotations, SpecialNames.f146609i);
        if (annotations == null) {
            e0(0);
        }
    }
    ...
    public ReceiverParameterDescriptor c(TypeSubstitutor typeSubstitutor) {
        ...
        if (!typeSubstitutor.k()) {
            KotlinType kotlinTypeP = b() instanceof ClassDescriptor ? typeSubstitutor.p(getType(), Variance.f147705g) : typeSubstitutor.p(getType(), Variance.f147703e);
            if (kotlinTypeP == null) {
                return null;
            }
    ...
    public DescriptorVisibility getVisibility() {
        DescriptorVisibility descriptorVisibility = DescriptorVisibilities.f144508f;
