...
public final class ReflectJavaClass extends ReflectJavaElement implements ReflectJavaAnnotationOwner, ReflectJavaModifierListOwner, JavaClass {
    ...
    /* synthetic */ class b extends FunctionReferenceImpl implements Function1<Constructor<?>, ReflectJavaConstructor> {
        ...
        /* renamed from: b, reason: collision with root package name */
        public static final b f144990b = new b();
    ...
    /* synthetic */ class c extends FunctionReferenceImpl implements Function1<Member, Boolean> {
        ...
        /* renamed from: b, reason: collision with root package name */
        public static final c f144991b = new c();
    ...
    /* synthetic */ class d extends FunctionReferenceImpl implements Function1<Field, ReflectJavaField> {
        ...
        /* renamed from: b, reason: collision with root package name */
        public static final d f144992b = new d();
    ...
    /* synthetic */ class e extends FunctionReferenceImpl implements Function1<Method, ReflectJavaMethod> {
        ...
        /* renamed from: b, reason: collision with root package name */
        public static final e f144993b = new e();
    ...
    public Sequence<JavaClassifierType> D() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        Class<?>[] clsArrC = Java16SealedRecordLoader.f144965a.c(this.f144988a);
        if (clsArrC != null) {
    ...
    @Override // kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass
    public boolean K() {
        return this.f144988a.isInterface();
    }

    @Override // kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass
    /* renamed from: W, reason: merged with bridge method [inline-methods] */
    public List<ReflectJavaConstructor> j() throws SecurityException {
        Constructor<?>[] declaredConstructors = this.f144988a.getDeclaredConstructors();
        Intrinsics.i(declaredConstructors, "getDeclaredConstructors(...)");
        return SequencesKt.X(SequencesKt.M(SequencesKt.C(ArraysKt.T(declaredConstructors), a.f144989b), b.f144990b));
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.runtime.structure.ReflectJavaAnnotationOwner
    /* renamed from: X, reason: merged with bridge method [inline-methods] */
    public Class<?> s() {
        return this.f144988a;
    }

    @Override // kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass
    /* renamed from: Y, reason: merged with bridge method [inline-methods] */
    public List<ReflectJavaField> y() {
        Field[] declaredFields = this.f144988a.getDeclaredFields();
        Intrinsics.i(declaredFields, "getDeclaredFields(...)");
        return SequencesKt.X(SequencesKt.M(SequencesKt.C(ArraysKt.T(declaredFields), c.f144991b), d.f144992b));
    }

    @Override // kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass
    /* renamed from: Z, reason: merged with bridge method [inline-methods] */
    public List<Name> B() {
        Class<?>[] declaredClasses = this.f144988a.getDeclaredClasses();
        Intrinsics.i(declaredClasses, "getDeclaredClasses(...)");
        return SequencesKt.X(SequencesKt.N(SequencesKt.C(ArraysKt.T(declaredClasses), kotlin.reflect.jvm.internal.impl.descriptors.runtime.structure.c.f145018a), kotlin.reflect.jvm.internal.impl.descriptors.runtime.structure.d.f145019a));
    }
    ...
    public Collection<JavaClassifierType> a() {
        Class cls;
        cls = Object.class;
        if (Intrinsics.e(this.f144988a, cls)) {
            return CollectionsKt.m();
        }
        SpreadBuilder spreadBuilder = new SpreadBuilder(2);
        Object genericSuperclass = this.f144988a.getGenericSuperclass();
        spreadBuilder.a(genericSuperclass != null ? genericSuperclass : Object.class);
        spreadBuilder.b(this.f144988a.getGenericInterfaces());
    ...
    public List<ReflectJavaMethod> C() throws SecurityException {
        Method[] declaredMethods = this.f144988a.getDeclaredMethods();
        Intrinsics.i(declaredMethods, "getDeclaredMethods(...)");
        return SequencesKt.X(SequencesKt.M(SequencesKt.B(ArraysKt.T(declaredMethods), new kotlin.reflect.jvm.internal.impl.descriptors.runtime.structure.e(this)), e.f144993b));
    }

    @Override // kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass
    /* renamed from: b0, reason: merged with bridge method [inline-methods] */
    public ReflectJavaClass l() {
        Class<?> declaringClass = this.f144988a.getDeclaringClass();
    ...
    @Override // kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass
    public FqName e() {
        return ReflectClassUtilKt.e(this.f144988a).a();
    }

    public boolean equals(Object obj) {
        return (obj instanceof ReflectJavaClass) && Intrinsics.e(this.f144988a, ((ReflectJavaClass) obj).f144988a);
    }
    ...
    public int getModifiers() {
        return this.f144988a.getModifiers();
    }

    @Override // kotlin.reflect.jvm.internal.impl.load.java.structure.JavaNamedElement
    public Name getName() {
        if (!this.f144988a.isAnonymousClass()) {
            Name nameO = Name.o(this.f144988a.getSimpleName());
            Intrinsics.g(nameO);
            return nameO;
        }
        String name = this.f144988a.getName();
        Intrinsics.i(name, "getName(...)");
        Name nameO2 = Name.o(StringsKt.s1(name, ".", null, 2, null));
        Intrinsics.g(nameO2);
        return nameO2;
    }
    ...
    public List<ReflectJavaTypeParameter> getTypeParameters() {
        TypeVariable<Class<?>>[] typeParameters = this.f144988a.getTypeParameters();
    ...
    public Collection<JavaRecordComponent> m() {
        Object[] objArrD = Java16SealedRecordLoader.f144965a.d(this.f144988a);
        if (objArrD == null) {
    ...
    public String toString() {
        return ReflectJavaClass.class.getName() + ": " + this.f144988a;
    }

    @Override // kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass
    public boolean w() {
        return this.f144988a.isEnum();
    }

    @Override // kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass
    public boolean z() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        Boolean boolF = Java16SealedRecordLoader.f144965a.f(this.f144988a);
        if (boolF != null) {
