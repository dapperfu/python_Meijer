...
public final class JavaVisibilities {
    ...
    public static final JavaVisibilities f144937a = new JavaVisibilities();

    public static final class PackageVisibility extends Visibility {

        /* renamed from: c, reason: collision with root package name */
        public static final PackageVisibility f144938c = new PackageVisibility();
        ...
        public Integer a(Visibility visibility) {
            ...
            return Visibilities.f144557a.b(visibility) ? 1 : -1;
        }
        ...
        @Override // kotlin.reflect.jvm.internal.impl.descriptors.Visibility
        public Visibility d() {
            return Visibilities.Protected.f144566c;
        }
    }
    ...
    public static final class ProtectedAndPackage extends Visibility {
        ...
        /* renamed from: c, reason: collision with root package name */
        public static final ProtectedAndPackage f144939c = new ProtectedAndPackage();
        ...
        public Integer a(Visibility visibility) {
            ...
            if (visibility == Visibilities.Internal.f144561c) {
                return null;
            }
            return Visibilities.f144557a.b(visibility) ? 1 : -1;
        }
    ...
    public static final class ProtectedStaticVisibility extends Visibility {
        ...
        /* renamed from: c, reason: collision with root package name */
        public static final ProtectedStaticVisibility f144940c = new ProtectedStaticVisibility();
