...
public class MutableClassDescriptor extends ClassDescriptorBase {
    ...
    private final ClassKind f144841i;

    /* renamed from: j, reason: collision with root package name */
    private final boolean f144842j;

    /* renamed from: k, reason: collision with root package name */
    private Modality f144843k;

    /* renamed from: l, reason: collision with root package name */
    private DescriptorVisibility f144844l;

    /* renamed from: m, reason: collision with root package name */
    private TypeConstructor f144845m;

    /* renamed from: n, reason: collision with root package name */
    private List<TypeParameterDescriptor> f144846n;

    /* renamed from: o, reason: collision with root package name */
    private final Collection<KotlinType> f144847o;

    /* renamed from: p, reason: collision with root package name */
    private final StorageManager f144848p;
    ...
    public MutableClassDescriptor(DeclarationDescriptor declarationDescriptor, ClassKind classKind, boolean z10, boolean z11, Name name, SourceElement sourceElement, StorageManager storageManager) {
        ...
        this.f144847o = new ArrayList();
        this.f144848p = storageManager;
        this.f144841i = classKind;
        this.f144842j = z10;
    }

    public void H0() {
        this.f144845m = new ClassTypeConstructorImpl(this, this.f144846n, this.f144847o, this.f144848p);
    ...
    public void K0(List<TypeParameterDescriptor> list) {
        ...
        if (this.f144846n == null) {
            this.f144846n = new ArrayList(list);
            return;
        }
    ...
    public void L0(DescriptorVisibility descriptorVisibility) {
        ...
        this.f144844l = descriptorVisibility;
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    public ClassKind f() {
        ClassKind classKind = this.f144841i;
        if (classKind == null) {
            B0(8);
        }
        return classKind;
    ...
    public DescriptorVisibility getVisibility() {
        DescriptorVisibility descriptorVisibility = this.f144844l;
        if (descriptorVisibility == null) {
            B0(10);
        }
    ...
    public TypeConstructor i() {
        TypeConstructor typeConstructor = this.f144845m;
    ...
    public List<TypeParameterDescriptor> p() {
        List<TypeParameterDescriptor> list = this.f144846n;
        if (list == null) {
            B0(15);
        }
        return list;
    ...
    public Modality q() {
        Modality modality = this.f144843k;
        if (modality == null) {
            B0(7);
        }
        return modality;
