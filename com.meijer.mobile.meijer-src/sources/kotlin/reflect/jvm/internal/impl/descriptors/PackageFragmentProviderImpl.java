...
public final class PackageFragmentProviderImpl implements PackageFragmentProviderOptimized {
    ...
    private final Collection<PackageFragmentDescriptor> f144544a;
    ...
    public PackageFragmentProviderImpl(Collection<? extends PackageFragmentDescriptor> packageFragments) {
        ...
        this.f144544a = packageFragments;
    }
    ...
    public List<PackageFragmentDescriptor> a(FqName fqName) {
        ...
        Collection<PackageFragmentDescriptor> collection = this.f144544a;
    ...
    public Collection<FqName> m(FqName fqName, Function1<? super Name, Boolean> nameFilter) {
        ...
        return SequencesKt.X(SequencesKt.B(SequencesKt.M(CollectionsKt.f0(this.f144544a), e.f144689a), new f(fqName)));
    }
}
