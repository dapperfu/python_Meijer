...
public final class TypeAliasConstructorDescriptorImpl extends FunctionDescriptorImpl implements TypeAliasConstructorDescriptor {
    ...
    private final StorageManager f144906E;

    /* renamed from: F, reason: collision with root package name */
    private final TypeAliasDescriptor f144907F;

    /* renamed from: G, reason: collision with root package name */
    private final NullableLazyValue f144908G;

    /* renamed from: H, reason: collision with root package name */
    private ClassConstructorDescriptor f144909H;

    /* renamed from: J, reason: collision with root package name */
    static final /* synthetic */ KProperty<Object>[] f144905J = {Reflection.j(new PropertyReference1Impl(TypeAliasConstructorDescriptorImpl.class, "withDispatchReceiver", "getWithDispatchReceiver()Lorg/jetbrains/kotlin/descriptors/impl/TypeAliasConstructorDescriptor;", 0))};

    /* renamed from: I, reason: collision with root package name */
    public static final Companion f144904I = new Companion(null);
    ...
    public static final class Companion {
        ...
        public final TypeAliasConstructorDescriptor b(StorageManager storageManager, TypeAliasDescriptor typeAliasDescriptor, ClassConstructorDescriptor constructor) {
            ...
            ReceiverParameterDescriptor receiverParameterDescriptorI = receiverParameterDescriptorJ != null ? DescriptorFactory.i(typeAliasConstructorDescriptorImpl, typeSubstitutorC.n(receiverParameterDescriptorJ.getType(), Variance.f147703e), Annotations.f144596s3.b()) : null;
            ...
            if (classDescriptorS != null) {
                ...
                for (Object obj : list) {
                    ...
                    KotlinType kotlinTypeN = typeSubstitutorC.n(receiverParameterDescriptor.getType(), Variance.f147703e);
                    ...
                    listM.add(DescriptorFactory.c(classDescriptorS, kotlinTypeN, ((ImplicitContextReceiver) value).a(), Annotations.f144596s3.b(), i10));
                    i10 = i11;
                }
            } else {
                listM = CollectionsKt.m();
            }
            typeAliasConstructorDescriptorImpl.O0(receiverParameterDescriptorI, null, listM, typeAliasDescriptor.p(), listL0, simpleTypeJ, Modality.f144526b, typeAliasDescriptor.getVisibility());
    ...
    private TypeAliasConstructorDescriptorImpl(StorageManager storageManager, TypeAliasDescriptor typeAliasDescriptor, ClassConstructorDescriptor classConstructorDescriptor, TypeAliasConstructorDescriptor typeAliasConstructorDescriptor, Annotations annotations, CallableMemberDescriptor.Kind kind, SourceElement sourceElement) {
        super(typeAliasDescriptor, typeAliasConstructorDescriptor, annotations, SpecialNames.f146610j, kind, sourceElement);
        this.f144906E = storageManager;
        this.f144907F = typeAliasDescriptor;
        S0(m1().V());
        this.f144908G = storageManager.e(new i(this, classConstructorDescriptor));
        this.f144909H = classConstructorDescriptor;
    }
    ...
    public static final TypeAliasConstructorDescriptorImpl o1(TypeAliasConstructorDescriptorImpl typeAliasConstructorDescriptorImpl, ClassConstructorDescriptor classConstructorDescriptor) {
        StorageManager storageManager = typeAliasConstructorDescriptorImpl.f144906E;
        ...
        TypeSubstitutor typeSubstitutorC = f144904I.c(typeAliasConstructorDescriptorImpl.m1());
        ...
        typeAliasConstructorDescriptorImpl2.O0(null, receiverParameterDescriptorC, arrayList, typeAliasConstructorDescriptorImpl.m1().p(), typeAliasConstructorDescriptorImpl.h(), typeAliasConstructorDescriptorImpl.getReturnType(), Modality.f144526b, typeAliasConstructorDescriptorImpl.m1().getVisibility());
        return typeAliasConstructorDescriptorImpl2;
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.impl.TypeAliasConstructorDescriptor
    public ClassConstructorDescriptor Q() {
        return this.f144909H;
    }
    ...
    public TypeAliasConstructorDescriptorImpl I0(DeclarationDescriptor newOwner, FunctionDescriptor functionDescriptor, CallableMemberDescriptor.Kind kind, Name name, Annotations annotations, SourceElement source) {
        ...
        return new TypeAliasConstructorDescriptorImpl(this.f144906E, m1(), Q(), this, annotations, kind2, source);
    }

    public TypeAliasDescriptor m1() {
        return this.f144907F;
    }
    ...
    public TypeAliasConstructorDescriptor c(TypeSubstitutor substitutor) {
        ...
        typeAliasConstructorDescriptorImpl.f144909H = classConstructorDescriptorC;
        return typeAliasConstructorDescriptorImpl;
    }
