...
public final class ScopesHolderForClass<T extends MemberScope> {
    ...
    private final ClassDescriptor f144550a;

    /* renamed from: b, reason: collision with root package name */
    private final Function1<KotlinTypeRefiner, T> f144551b;

    /* renamed from: c, reason: collision with root package name */
    private final KotlinTypeRefiner f144552c;

    /* renamed from: d, reason: collision with root package name */
    private final NotNullLazyValue f144553d;

    /* renamed from: f, reason: collision with root package name */
    static final /* synthetic */ KProperty<Object>[] f144549f = {Reflection.j(new PropertyReference1Impl(ScopesHolderForClass.class, "scopeForOwnerModule", "getScopeForOwnerModule()Lorg/jetbrains/kotlin/resolve/scopes/MemberScope;", 0))};

    /* renamed from: e, reason: collision with root package name */
    public static final Companion f144548e = new Companion(null);
    ...
    private ScopesHolderForClass(ClassDescriptor classDescriptor, StorageManager storageManager, Function1<? super KotlinTypeRefiner, ? extends T> function1, KotlinTypeRefiner kotlinTypeRefiner) {
        this.f144550a = classDescriptor;
        this.f144551b = function1;
        this.f144552c = kotlinTypeRefiner;
        this.f144553d = storageManager.c(new g(this));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final MemberScope d(ScopesHolderForClass scopesHolderForClass, KotlinTypeRefiner kotlinTypeRefiner) {
        return scopesHolderForClass.f144551b.invoke(kotlinTypeRefiner);
    }

    private final T e() {
        return (T) StorageKt.a(this.f144553d, this, f144549f[0]);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final MemberScope f(ScopesHolderForClass scopesHolderForClass) {
        return scopesHolderForClass.f144551b.invoke(scopesHolderForClass.f144552c);
    }

    public final T c(KotlinTypeRefiner kotlinTypeRefiner) {
        Intrinsics.j(kotlinTypeRefiner, "kotlinTypeRefiner");
        if (!kotlinTypeRefiner.d(DescriptorUtilsKt.s(this.f144550a))) {
            return (T) e();
        }
        TypeConstructor typeConstructorI = this.f144550a.i();
        Intrinsics.i(typeConstructorI, "getTypeConstructor(...)");
        return !kotlinTypeRefiner.e(typeConstructorI) ? (T) e() : (T) kotlinTypeRefiner.c(this.f144550a, new h(this, kotlinTypeRefiner));
    }
}
