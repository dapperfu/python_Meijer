...
public final class ReflectJavaWildcardType extends ReflectJavaType implements JavaWildcardType {
    ...
    private final WildcardType f145013b;

    /* renamed from: c, reason: collision with root package name */
    private final Collection<JavaAnnotation> f145014c;

    /* renamed from: d, reason: collision with root package name */
    private final boolean f145015d;

    public ReflectJavaWildcardType(WildcardType reflectType) {
        Intrinsics.j(reflectType, "reflectType");
        this.f145013b = reflectType;
        this.f145014c = CollectionsKt.m();
    }
