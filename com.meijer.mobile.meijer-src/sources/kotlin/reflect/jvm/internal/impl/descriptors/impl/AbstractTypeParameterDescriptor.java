...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    private final Variance f144710e;

    /* renamed from: f, reason: collision with root package name */
    private final boolean f144711f;

    /* renamed from: g, reason: collision with root package name */
    private final int f144712g;

    /* renamed from: h, reason: collision with root package name */
    private final NotNullLazyValue<TypeConstructor> f144713h;

    /* renamed from: i, reason: collision with root package name */
    private final NotNullLazyValue<SimpleType> f144714i;

    /* renamed from: j, reason: collision with root package name */
    private final StorageManager f144715j;

    class a implements Function0<TypeConstructor> {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ StorageManager f144716a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ SupertypeLoopChecker f144717b;

        a(StorageManager storageManager, SupertypeLoopChecker supertypeLoopChecker) {
            this.f144716a = storageManager;
            this.f144717b = supertypeLoopChecker;
        }

        @Override // kotlin.jvm.functions.Function0
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public TypeConstructor invoke() {
            return new c(AbstractTypeParameterDescriptor.this, this.f144716a, this.f144717b);
        }
    }
    ...
    class b implements Function0<SimpleType> {
        ...
        class a implements Function0<MemberScope> {
            ...
            public MemberScope invoke() {
                return TypeIntersectionScope.m("Scope for type parameter " + b.this.f144719a.b(), AbstractTypeParameterDescriptor.this.getUpperBounds());
            }
        }
        ...
        public SimpleType invoke() {
            return KotlinTypeFactory.m(TypeAttributes.f147647b.k(), AbstractTypeParameterDescriptor.this.i(), Collections.EMPTY_LIST, false, new LazyScopeAdapter(new a()));
        }
    }
    ...
    private class c extends AbstractTypeConstructor {
        ...
        private final SupertypeLoopChecker f144722d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ AbstractTypeParameterDescriptor f144723e;
        ...
        public c(AbstractTypeParameterDescriptor abstractTypeParameterDescriptor, StorageManager storageManager, SupertypeLoopChecker supertypeLoopChecker) {
            ...
            this.f144723e = abstractTypeParameterDescriptor;
            this.f144722d = supertypeLoopChecker;
        }
        ...
        public ClassifierDescriptor d() {
            AbstractTypeParameterDescriptor abstractTypeParameterDescriptor = this.f144723e;
        ...
        protected boolean h(ClassifierDescriptor classifierDescriptor) {
            ...
            return (classifierDescriptor instanceof TypeParameterDescriptor) && DescriptorEquivalenceForOverrides.f147023a.m(this.f144723e, (TypeParameterDescriptor) classifierDescriptor, true);
        }

        @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
        public KotlinBuiltIns l() {
            KotlinBuiltIns kotlinBuiltInsM = DescriptorUtilsKt.m(this.f144723e);
        ...
        protected Collection<KotlinType> r() {
            List<KotlinType> listI0 = this.f144723e.I0();
            if (listI0 == null) {
                H(1);
            }
            return listI0;
        ...
        protected KotlinType s() {
            return ErrorUtils.d(ErrorTypeKind.f147883u, new String[0]);
        }

        public String toString() {
            return this.f144723e.getName().toString();
        }

        @Override // kotlin.reflect.jvm.internal.impl.types.AbstractTypeConstructor
        protected SupertypeLoopChecker v() {
            SupertypeLoopChecker supertypeLoopChecker = this.f144722d;
        ...
        protected List<KotlinType> x(List<KotlinType> list) {
            ...
            List<KotlinType> listD0 = this.f144723e.D0(list);
            if (listD0 == null) {
                H(8);
            }
            return listD0;
    ...
    protected AbstractTypeParameterDescriptor(StorageManager storageManager, DeclarationDescriptor declarationDescriptor, Annotations annotations, Name name, Variance variance, boolean z10, int i10, SourceElement sourceElement, SupertypeLoopChecker supertypeLoopChecker) {
        ...
        this.f144710e = variance;
        this.f144711f = z10;
        this.f144712g = i10;
        this.f144713h = storageManager.c(new a(storageManager, supertypeLoopChecker));
        this.f144714i = storageManager.c(new b(name));
        this.f144715j = storageManager;
    }
    ...
    public StorageManager K() {
        StorageManager storageManager = this.f144715j;
        if (storageManager == null) {
            e0(14);
        }
    ...
    @Override // kotlin.reflect.jvm.internal.impl.descriptors.TypeParameterDescriptor
    public int getIndex() {
        return this.f144712g;
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.TypeParameterDescriptor, kotlin.reflect.jvm.internal.impl.descriptors.ClassifierDescriptor
    public final TypeConstructor i() {
        TypeConstructor typeConstructorInvoke = this.f144713h.invoke();
    ...
    @Override // kotlin.reflect.jvm.internal.impl.descriptors.TypeParameterDescriptor
    public Variance k() {
        Variance variance = this.f144710e;
        if (variance == null) {
            e0(7);
        }
        return variance;
    ...
    public SimpleType o() {
        SimpleType simpleTypeInvoke = this.f144714i.invoke();
