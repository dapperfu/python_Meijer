...
public class ReceiverParameterDescriptorImpl extends AbstractReceiverParameterDescriptor {
    ...
    private final DeclarationDescriptor f144900c;

    /* renamed from: d, reason: collision with root package name */
    private ReceiverValue f144901d;
    ...
    public ReceiverParameterDescriptorImpl(DeclarationDescriptor declarationDescriptor, ReceiverValue receiverValue, Annotations annotations) {
        this(declarationDescriptor, receiverValue, annotations, SpecialNames.f146609i);
    ...
    public ReceiverParameterDescriptorImpl(DeclarationDescriptor declarationDescriptor, ReceiverValue receiverValue, Annotations annotations, Name name) {
        ...
        this.f144900c = declarationDescriptor;
        this.f144901d = receiverValue;
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.DeclarationDescriptor
    public DeclarationDescriptor b() {
        DeclarationDescriptor declarationDescriptor = this.f144900c;
        if (declarationDescriptor == null) {
            e0(8);
        }
    ...
    public ReceiverValue getValue() {
        ReceiverValue receiverValue = this.f144901d;
        if (receiverValue == null) {
            e0(7);
        }
