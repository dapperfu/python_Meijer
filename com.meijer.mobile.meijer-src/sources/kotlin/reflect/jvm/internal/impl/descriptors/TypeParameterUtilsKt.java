...
public final class TypeParameterUtilsKt {
    ...
    public static final List<TypeParameterDescriptor> g(ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters) {
        ...
        List listX = SequencesKt.X(SequencesKt.G(SequencesKt.B(SequencesKt.V(DescriptorUtilsKt.u(classifierDescriptorWithTypeParameters), i.f144694a), j.f144936a), k.f144941a));
        ...
        if (listX.isEmpty() && listM.isEmpty()) {
        ...
        List<TypeParameterDescriptor> listP0 = CollectionsKt.P0(listX, listM);
