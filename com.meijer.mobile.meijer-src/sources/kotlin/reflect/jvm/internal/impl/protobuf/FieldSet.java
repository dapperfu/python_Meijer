...
final class FieldSet<FieldDescriptorType extends FieldDescriptorLite<FieldDescriptorType>> {
    ...
    private static final FieldSet f146755d = new FieldSet(true);

    /* renamed from: b, reason: collision with root package name */
    private boolean f146757b;

    /* renamed from: c, reason: collision with root package name */
    private boolean f146758c = false;

    /* renamed from: a, reason: collision with root package name */
    private final d<FieldDescriptorType, Object> f146756a = d.s(16);
    ...
    public int k() {
        int iF = 0;
        for (int i10 = 0; i10 < this.f146756a.j(); i10++) {
            Map.Entry<K, Object> entryI = this.f146756a.i(i10);
            iF += f((FieldDescriptorLite) entryI.getKey(), entryI.getValue());
        }
        Iterator it = this.f146756a.k().iterator();
        while (it.hasNext()) {
    ...
    public void r(FieldSet<FieldDescriptorType> fieldSet) {
        for (int i10 = 0; i10 < fieldSet.f146756a.j(); i10++) {
            s(fieldSet.f146756a.i(i10));
        }
        Iterator it = fieldSet.f146756a.k().iterator();
        while (it.hasNext()) {
            s((Map.Entry) it.next());
        }
    }
    ...
    static /* synthetic */ class a {
        ...
        /* renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f146759a;

        /* renamed from: b, reason: collision with root package name */
        static final /* synthetic */ int[] f146760b;

        static {
            int[] iArr = new int[WireFormat.FieldType.values().length];
            f146760b = iArr;
            try {
                iArr[WireFormat.FieldType.f146804c.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f146760b[WireFormat.FieldType.f146805d.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f146760b[WireFormat.FieldType.f146806e.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f146760b[WireFormat.FieldType.f146807f.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f146760b[WireFormat.FieldType.f146808g.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f146760b[WireFormat.FieldType.f146809h.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f146760b[WireFormat.FieldType.f146810i.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f146760b[WireFormat.FieldType.f146811j.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f146760b[WireFormat.FieldType.f146812k.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f146760b[WireFormat.FieldType.f146815n.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f146760b[WireFormat.FieldType.f146816o.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f146760b[WireFormat.FieldType.f146818q.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f146760b[WireFormat.FieldType.f146819r.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f146760b[WireFormat.FieldType.f146820s.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f146760b[WireFormat.FieldType.f146821t.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f146760b[WireFormat.FieldType.f146813l.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f146760b[WireFormat.FieldType.f146814m.ordinal()] = 17;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f146760b[WireFormat.FieldType.f146817p.ordinal()] = 18;
            ...
            try {
                f146759a[WireFormat.JavaType.LONG.ordinal()] = 2;
            } catch (NoSuchFieldError unused20) {
            }
            try {
                f146759a[WireFormat.JavaType.FLOAT.ordinal()] = 3;
            } catch (NoSuchFieldError unused21) {
            }
            try {
                f146759a[WireFormat.JavaType.DOUBLE.ordinal()] = 4;
            } catch (NoSuchFieldError unused22) {
            }
            try {
                f146759a[WireFormat.JavaType.BOOLEAN.ordinal()] = 5;
            } catch (NoSuchFieldError unused23) {
            }
            try {
                f146759a[WireFormat.JavaType.STRING.ordinal()] = 6;
            } catch (NoSuchFieldError unused24) {
            }
            try {
                f146759a[WireFormat.JavaType.BYTE_STRING.ordinal()] = 7;
            } catch (NoSuchFieldError unused25) {
            }
            try {
                f146759a[WireFormat.JavaType.ENUM.ordinal()] = 8;
            } catch (NoSuchFieldError unused26) {
            }
            try {
                f146759a[WireFormat.JavaType.MESSAGE.ordinal()] = 9;
    ...
    private static int e(WireFormat.FieldType fieldType, Object obj) {
        switch (a.f146760b[fieldType.ordinal()]) {
            case 1:
    ...
    private static void x(CodedOutputStream codedOutputStream, WireFormat.FieldType fieldType, int i10, Object obj) throws IOException {
        if (fieldType == WireFormat.FieldType.f146813l) {
    ...
    public Object h(FieldDescriptorType fielddescriptortype) {
        Object obj = this.f146756a.get(fielddescriptortype);
        return obj instanceof LazyField ? ((LazyField) obj).e() : obj;
    }

    public Iterator<Map.Entry<FieldDescriptorType, Object>> p() {
        return this.f146758c ? new LazyField.c(this.f146756a.entrySet().iterator()) : this.f146756a.entrySet().iterator();
    }
    ...
    private void s(Map.Entry<FieldDescriptorType, Object> entry) {
        ...
        if (key.h()) {
            ...
            this.f146756a.t(key, objH);
            return;
        }
        if (key.j() == WireFormat.JavaType.MESSAGE) {
            Object objH2 = h(key);
            if (objH2 == null) {
                this.f146756a.t(key, c(value));
                return;
            } else {
                this.f146756a.t(key, key.x(((MessageLite) objH2).b(), (MessageLite) value).build());
                return;
            }
        }
        this.f146756a.t(key, c(value));
    ...
    */
    private static void w(kotlin.reflect.jvm.internal.impl.protobuf.WireFormat.FieldType r2, java.lang.Object r3) {
        /*
            r3.getClass()
            int[] r0 = kotlin.reflect.jvm.internal.impl.protobuf.FieldSet.a.f146759a
    ...
    public void a(FieldDescriptorType fielddescriptortype, Object obj) {
        ...
        if (fielddescriptortype.h()) {
            ...
            if (objH == null) {
                ...
                this.f146756a.t(fielddescriptortype, arrayList);
            } else {
                arrayList = (List) objH;
            }
            arrayList.add(obj);
    ...
    public FieldSet<FieldDescriptorType> clone() {
        ...
        fieldSetT.f146758c = this.f146758c;
        return fieldSetT;
    }
    ...
    public boolean m(FieldDescriptorType fielddescriptortype) {
        if (!fielddescriptortype.h()) {
            if (this.f146756a.get(fielddescriptortype) != null) {
                return true;
            }
            return false;
        }
    ...
    public void v(FieldDescriptorType fielddescriptortype, Object obj) {
        ...
        this.f146756a.t(fielddescriptortype, obj);
    }
