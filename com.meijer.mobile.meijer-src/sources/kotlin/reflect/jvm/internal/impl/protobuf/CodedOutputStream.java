...
public final class CodedOutputStream {
    ...
    private final byte[] f146746a;

    /* renamed from: b, reason: collision with root package name */
    private final int f146747b;

    /* renamed from: e, reason: collision with root package name */
    private final OutputStream f146750e;

    /* renamed from: d, reason: collision with root package name */
    private int f146749d = 0;

    /* renamed from: c, reason: collision with root package name */
    private int f146748c = 0;
    ...
    public void n0(long j10) throws IOException {
        h0(((int) j10) & l3.f93323c);
        h0(((int) (j10 >> 8)) & l3.f93323c);
        h0(((int) (j10 >> 16)) & l3.f93323c);
        h0(((int) (j10 >> 24)) & l3.f93323c);
        h0(((int) (j10 >> 32)) & l3.f93323c);
        h0(((int) (j10 >> 40)) & l3.f93323c);
        h0(((int) (j10 >> 48)) & l3.f93323c);
        h0(((int) (j10 >> 56)) & l3.f93323c);
    }
    ...
    private void K() throws IOException {
        OutputStream outputStream = this.f146750e;
        if (outputStream == null) {
            throw new OutOfSpaceException();
        }
        outputStream.write(this.f146746a, 0, this.f146748c);
        this.f146748c = 0;
    }
    ...
    public void g0(byte b10) throws IOException {
        if (this.f146748c == this.f146747b) {
            K();
        }
        byte[] bArr = this.f146746a;
        int i10 = this.f146748c;
        this.f146748c = i10 + 1;
        bArr[i10] = b10;
        this.f146749d++;
    }
    ...
    public void j0(ByteString byteString, int i10, int i11) throws IOException {
        int i12 = this.f146747b;
        int i13 = this.f146748c;
        if (i12 - i13 >= i11) {
            byteString.m(this.f146746a, i10, i13, i11);
            this.f146748c += i11;
            this.f146749d += i11;
            return;
        }
        int i14 = i12 - i13;
        byteString.m(this.f146746a, i10, i13, i14);
        int i15 = i10 + i14;
        int i16 = i11 - i14;
        this.f146748c = this.f146747b;
        this.f146749d += i14;
        K();
        if (i16 <= this.f146747b) {
            byteString.m(this.f146746a, i15, 0, i16);
            this.f146748c = i16;
        } else {
            byteString.B(this.f146750e, i15, i16);
        }
        this.f146749d += i16;
    }
    ...
    public void l0(byte[] bArr, int i10, int i11) throws IOException {
        ...
        int i13 = this.f146748c;
        if (i12 - i13 >= i11) {
            System.arraycopy(bArr, i10, this.f146746a, i13, i11);
            this.f146748c += i11;
            this.f146749d += i11;
            return;
        }
        int i14 = i12 - i13;
        System.arraycopy(bArr, i10, this.f146746a, i13, i14);
        int i15 = i10 + i14;
        int i16 = i11 - i14;
        this.f146748c = this.f146747b;
        this.f146749d += i14;
        K();
        if (i16 <= this.f146747b) {
            System.arraycopy(bArr, i15, this.f146746a, 0, i16);
            this.f146748c = i16;
        } else {
            this.f146750e.write(bArr, i15, i16);
        }
        this.f146749d += i16;
    }
    ...
    public void m0(int i10) throws IOException {
        h0(i10 & l3.f93323c);
        h0((i10 >> 8) & l3.f93323c);
        h0((i10 >> 16) & l3.f93323c);
        h0((i10 >> 24) & l3.f93323c);
    }

    public void o0(int i10) throws IOException {
        while ((i10 & (-128)) != 0) {
            h0((i10 & l3.f93324d) | 128);
            i10 >>>= 7;
        }
        h0(i10);
    }
    ...
    private CodedOutputStream(OutputStream outputStream, byte[] bArr) {
        this.f146750e = outputStream;
        this.f146746a = bArr;
        this.f146747b = bArr.length;
    }
