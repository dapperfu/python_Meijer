...
public abstract class ByteString implements Iterable<Byte> {
    ...
    public static final ByteString f146726a = new b(new byte[0]);
    ...
    public static final class Output extends OutputStream {
        ...
        private static final byte[] f146727f = new byte[0];

        /* renamed from: a, reason: collision with root package name */
        private final int f146728a;

        /* renamed from: b, reason: collision with root package name */
        private final ArrayList<ByteString> f146729b;

        /* renamed from: c, reason: collision with root package name */
        private int f146730c;

        /* renamed from: d, reason: collision with root package name */
        private byte[] f146731d;

        /* renamed from: e, reason: collision with root package name */
        private int f146732e;

        public synchronized int d() {
            return this.f146730c + this.f146732e;
        }

        public synchronized ByteString g() {
            c();
            return ByteString.f(this.f146729b);
        }

        @Override // java.io.OutputStream
        public synchronized void write(int i10) {
            try {
                if (this.f146732e == this.f146731d.length) {
                    b(1);
                }
                byte[] bArr = this.f146731d;
                int i11 = this.f146732e;
                this.f146732e = i11 + 1;
                bArr[i11] = (byte) i10;
            } catch (Throwable th2) {
                throw th2;
        ...
        private void b(int i10) {
            this.f146729b.add(new b(this.f146731d));
            int length = this.f146730c + this.f146731d.length;
            this.f146730c = length;
            this.f146731d = new byte[Math.max(this.f146728a, Math.max(i10, length >>> 1))];
            this.f146732e = 0;
        }

        private void c() {
            int i10 = this.f146732e;
            byte[] bArr = this.f146731d;
            if (i10 >= bArr.length) {
                this.f146729b.add(new b(this.f146731d));
                this.f146731d = f146727f;
            } else if (i10 > 0) {
                this.f146729b.add(new b(a(bArr, i10)));
            }
            this.f146730c += this.f146732e;
            this.f146732e = 0;
        }
        ...
        Output(int i10) {
            if (i10 >= 0) {
                this.f146728a = i10;
                this.f146729b = new ArrayList<>();
                this.f146731d = new byte[i10];
                return;
            }
        ...
        public synchronized void write(byte[] bArr, int i10, int i11) {
            try {
                byte[] bArr2 = this.f146731d;
                int length = bArr2.length;
                int i12 = this.f146732e;
                if (i11 <= length - i12) {
                    ...
                    int i13 = i11 - length2;
                    b(i13);
                    System.arraycopy(bArr, i10 + length2, this.f146731d, 0, i13);
                    this.f146732e = i13;
                }
            } catch (Throwable th2) {
                throw th2;
    ...
    public static ByteString f(Iterable<ByteString> iterable) {
        ...
        return arrayList.isEmpty() ? f146726a : a(arrayList.iterator(), arrayList.size());
    }
