...
public class LazyStringArrayList extends AbstractList<String> implements RandomAccess, LazyStringList {
    ...
    public static final LazyStringList f146791b = new LazyStringArrayList().J();

    /* renamed from: a, reason: collision with root package name */
    private final List<Object> f146792a;

    public LazyStringArrayList() {
        this.f146792a = new ArrayList();
    }
    ...
    public boolean addAll(int i10, Collection<? extends String> collection) {
        ...
        boolean zAddAll = this.f146792a.addAll(i10, collection);
        ((AbstractList) this).modCount++;
        return zAddAll;
    }
    ...
    @Override // kotlin.reflect.jvm.internal.impl.protobuf.LazyStringList
    public List<?> g() {
        return Collections.unmodifiableList(this.f146792a);
    }

    @Override // java.util.AbstractList, java.util.List
    /* renamed from: h, reason: merged with bridge method [inline-methods] */
    public String get(int i10) {
        Object obj = this.f146792a.get(i10);
    ...
    public String remove(int i10) {
        Object objRemove = this.f146792a.remove(i10);
        ((AbstractList) this).modCount++;
        return f(objRemove);
    }
    ...
    public ByteString k1(int i10) {
        ...
        if (byteStringE != obj) {
            this.f146792a.set(i10, byteStringE);
        }
        return byteStringE;
    }
    ...
    public String set(int i10, String str) {
        return f(this.f146792a.set(i10, str));
    }

    @Override // java.util.AbstractCollection, java.util.Collection, java.util.List
    public int size() {
        return this.f146792a.size();
    }

    public LazyStringArrayList(LazyStringList lazyStringList) {
        this.f146792a = new ArrayList(lazyStringList.size());
