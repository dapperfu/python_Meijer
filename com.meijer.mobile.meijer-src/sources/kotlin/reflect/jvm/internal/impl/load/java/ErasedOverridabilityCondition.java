    ...
    public ExternalOverridabilityCondition.Result b(CallableDescriptor superDescriptor, CallableDescriptor subDescriptor, ClassDescriptor classDescriptor) {
        ...
        if (subDescriptor instanceof JavaMethodDescriptor) {
            ...
            if (typeParameters.isEmpty()) {
                ...
                Sequence sequenceM = SequencesKt.M(CollectionsKt.f0(listH), f.f145285a);
                KotlinType returnType = javaMethodDescriptor.getReturnType();
                Intrinsics.g(returnType);
                Sequence sequenceQ = SequencesKt.Q(sequenceM, returnType);
                ReceiverParameterDescriptor receiverParameterDescriptorN = javaMethodDescriptor.N();
                for (KotlinType kotlinType : SequencesKt.P(sequenceQ, CollectionsKt.q(receiverParameterDescriptorN != null ? receiverParameterDescriptorN.getType() : null))) {
                ...
                OverridingUtil.OverrideCompatibilityInfo.Result resultC = OverridingUtil.f147039f.F(callableDescriptorC, subDescriptor, false).c();
