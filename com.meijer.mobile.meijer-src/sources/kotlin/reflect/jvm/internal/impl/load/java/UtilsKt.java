...
public final class UtilsKt {
    ...
    public static final boolean b(CallableMemberDescriptor memberDescriptor) {
        ...
        return (memberDescriptor instanceof FunctionDescriptor) && Intrinsics.e(memberDescriptor.r0(JavaMethodDescriptor.f145271H), Boolean.TRUE);
    }
    ...
    public static final boolean c(JavaTypeEnhancementState javaTypeEnhancementState) {
        ...
        return javaTypeEnhancementState.c().invoke(JavaNullabilityAnnotationSettingsKt.e()) == ReportLevel.f145185e;
    }
