...
public final class DeserializedDescriptorResolver {
    ...
    public static final Companion f145692b = new Companion(null);

    /* renamed from: c, reason: collision with root package name */
    private static final Set<KotlinClassHeader.Kind> f145693c = SetsKt.d(KotlinClassHeader.Kind.f145775e);

    /* renamed from: d, reason: collision with root package name */
    private static final Set<KotlinClassHeader.Kind> f145694d = SetsKt.i(KotlinClassHeader.Kind.f145776f, KotlinClassHeader.Kind.f145779i);

    /* renamed from: e, reason: collision with root package name */
    private static final MetadataVersion f145695e = new MetadataVersion(1, 1, 2);

    /* renamed from: f, reason: collision with root package name */
    private static final MetadataVersion f145696f = new MetadataVersion(1, 1, 11);

    /* renamed from: g, reason: collision with root package name */
    private static final MetadataVersion f145697g = new MetadataVersion(1, 1, 13);

    /* renamed from: a, reason: collision with root package name */
    public DeserializationComponents f145698a;
    ...
    public static final class Companion {
        ...
        public final MetadataVersion a() {
            return DeserializedDescriptorResolver.f145697g;
        }
    }
    ...
    public final MemberScope c(PackageFragmentDescriptor descriptor, KotlinJvmBinaryClass kotlinClass) {
        ...
        String[] strArrM = m(kotlinClass, f145694d);
        ...
        return new DeserializedPackageMemberScope(descriptor, packageB, jvmNameResolverA, kotlinClass.b().d(), jvmPackagePartSource, f(), "scope for " + jvmPackagePartSource + " in " + descriptor, d.f145761a);
    }

    public final DeserializationComponents f() {
        DeserializationComponents deserializationComponents = this.f145698a;
    ...
    public final ClassData l(KotlinJvmBinaryClass kotlinClass) {
        ...
        Intrinsics.j(kotlinClass, "kotlinClass");
        String[] strArrM = m(kotlinClass, f145693c);
        if (strArrM == null || (strArrG = kotlinClass.b().g()) == null) {
            return null;
        }
        try {
    ...
    public final void p(DeserializationComponents deserializationComponents) {
        ...
        this.f145698a = deserializationComponents;
    }
    ...
    private final DeserializedContainerAbiStability e(KotlinJvmBinaryClass kotlinJvmBinaryClass) {
        if (f().g().e()) {
            return DeserializedContainerAbiStability.f147409a;
        }
        if (kotlinJvmBinaryClass.b().j()) {
            return DeserializedContainerAbiStability.f147410b;
        }
        return DeserializedContainerAbiStability.f147409a;
    }
    ...
    private final IncompatibleVersionErrorData<MetadataVersion> g(KotlinJvmBinaryClass kotlinJvmBinaryClass) {
        if (!i() && !kotlinJvmBinaryClass.b().d().h(h())) {
            return new IncompatibleVersionErrorData<>(kotlinJvmBinaryClass.b().d(), MetadataVersion.f146450i, h(), h().k(kotlinJvmBinaryClass.b().d().j()), kotlinJvmBinaryClass.getLocation(), kotlinJvmBinaryClass.f());
        }
        return null;
    }
    ...
    private final boolean j(KotlinJvmBinaryClass kotlinJvmBinaryClass) {
        if (!f().g().b() && kotlinJvmBinaryClass.b().i() && Intrinsics.e(kotlinJvmBinaryClass.b().d(), f145696f)) {
            return true;
        }
        return false;
    }
    ...
    private final boolean k(KotlinJvmBinaryClass kotlinJvmBinaryClass) {
        if ((f().g().g() && (kotlinJvmBinaryClass.b().i() || Intrinsics.e(kotlinJvmBinaryClass.b().d(), f145695e))) || j(kotlinJvmBinaryClass)) {
            return true;
        }
        return false;
    }
