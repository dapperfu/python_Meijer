...
public final class JavaIncompatibilityRulesOverridabilityCondition implements ExternalOverridabilityCondition {
    ...
    public static final Companion f145097a = new Companion(null);
    ...
    public ExternalOverridabilityCondition.Result b(CallableDescriptor superDescriptor, CallableDescriptor subDescriptor, ClassDescriptor classDescriptor) {
        Intrinsics.j(superDescriptor, "superDescriptor");
        Intrinsics.j(subDescriptor, "subDescriptor");
        return c(superDescriptor, subDescriptor, classDescriptor) ? ExternalOverridabilityCondition.Result.INCOMPATIBLE : f145097a.a(superDescriptor, subDescriptor) ? ExternalOverridabilityCondition.Result.INCOMPATIBLE : ExternalOverridabilityCondition.Result.UNKNOWN;
    }
}
