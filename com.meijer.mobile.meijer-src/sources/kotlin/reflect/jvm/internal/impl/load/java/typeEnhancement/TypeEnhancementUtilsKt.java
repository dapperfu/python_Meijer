...
public final class TypeEnhancementUtilsKt {
    public static final JavaTypeQualifiers a(JavaTypeQualifiers javaTypeQualifiers, Collection<JavaTypeQualifiers> superQualifiers, boolean z10, boolean z11, boolean z12) {
        ...
        MutabilityQualifier mutabilityQualifier = (MutabilityQualifier) e(CollectionsKt.o1(arrayList3), MutabilityQualifier.f145553b, MutabilityQualifier.f145552a, javaTypeQualifiers.e(), z10);
        if (nullabilityQualifierF == null || z12 || (z11 && nullabilityQualifierF == NullabilityQualifier.f145559b)) {
            nullabilityQualifierF = null;
        }
        boolean z13 = false;
        boolean z14 = nullabilityQualifierF != null && nullabilityQualifierF2 == null;
        if (nullabilityQualifierF == NullabilityQualifier.f145560c) {
    ...
    private static final NullabilityQualifier f(Set<? extends NullabilityQualifier> set, NullabilityQualifier nullabilityQualifier, boolean z10) {
        NullabilityQualifier nullabilityQualifier2 = NullabilityQualifier.f145558a;
        return nullabilityQualifier == nullabilityQualifier2 ? nullabilityQualifier2 : (NullabilityQualifier) e(set, NullabilityQualifier.f145560c, NullabilityQualifier.f145559b, nullabilityQualifier, z10);
    }
