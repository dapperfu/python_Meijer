...
public abstract class AbstractSignatureParts<TAnnotation> {
    ...
    static final class a {
        ...
        private final KotlinTypeMarker f145523a;

        /* renamed from: b, reason: collision with root package name */
        private final JavaTypeQualifiersByElementType f145524b;

        /* renamed from: c, reason: collision with root package name */
        private final TypeParameterMarker f145525c;

        public final JavaTypeQualifiersByElementType a() {
            return this.f145524b;
        }

        public final KotlinTypeMarker b() {
            return this.f145523a;
        }
        ...
        public a(KotlinTypeMarker kotlinTypeMarker, JavaTypeQualifiersByElementType javaTypeQualifiersByElementType, TypeParameterMarker typeParameterMarker) {
            this.f145523a = kotlinTypeMarker;
            this.f145524b = javaTypeQualifiersByElementType;
            this.f145525c = typeParameterMarker;
        }
    }
    ...
    public static final JavaTypeQualifiers e(TypeEnhancementInfo typeEnhancementInfo, JavaTypeQualifiers[] javaTypeQualifiersArr, int i10) {
        ...
        return (typeEnhancementInfo == null || (mapB = typeEnhancementInfo.b()) == null || (javaTypeQualifiers = mapB.get(Integer.valueOf(i10))) == null) ? (i10 < 0 || i10 >= javaTypeQualifiersArr.length) ? JavaTypeQualifiers.f145543e.a() : javaTypeQualifiersArr[i10] : javaTypeQualifiers;
    }
    ...
    public final Function1<Integer, JavaTypeQualifiers> d(KotlinTypeMarker kotlinTypeMarker, Iterable<? extends KotlinTypeMarker> overrides, TypeEnhancementInfo typeEnhancementInfo, boolean z10) {
        ...
        return new C15355b(typeEnhancementInfo, javaTypeQualifiersArr);
    }

    private final List<a> H(KotlinTypeMarker kotlinTypeMarker) {
        return j(new a(kotlinTypeMarker, f(kotlinTypeMarker, r()), null), new C15356c(this, A()));
    }
    ...
    private final JavaTypeQualifiers h(a aVar) {
        ...
        if (aVar.b() == null) {
            ...
            if (typeVarianceY == TypeVariance.f147920b) {
                return JavaTypeQualifiers.f145543e.a();
            }
        }
        boolean z13 = false;
        if (aVar.c() == null) {
        ...
        if (q() == AnnotationQualifierApplicabilityType.f145063f) {
            z11 = true;
        } else {
            z11 = false;
        }
        ...
        NullabilityQualifierWithMigrationStatus nullabilityQualifierWithMigrationStatusH = m().h(listM, new C15354a(this, aVar));
        if (nullabilityQualifierWithMigrationStatusH != null) {
            ...
            if (nullabilityQualifierWithMigrationStatusH.c() == NullabilityQualifier.f145560c && typeParameterMarkerU != null) {
                z13 = true;
            }
            return new JavaTypeQualifiers(nullabilityQualifierC3, mutabilityQualifierG, z13, nullabilityQualifierWithMigrationStatusH.d());
        }
        if (!z10 && !z11) {
            annotationQualifierApplicabilityTypeQ = AnnotationQualifierApplicabilityType.f145062e;
        } else {
        ...
        if (nullabilityQualifierC != NullabilityQualifier.f145560c && (typeParameterMarkerU == null || javaDefaultQualifiersA == null || !javaDefaultQualifiersA.c())) {
            z12 = false;
        } else {
            z12 = true;
        }
        ...
        if (typeParameterMarkerC2 != null && (nullabilityQualifierWithMigrationStatusO2 = o(typeParameterMarkerC2)) != null) {
            if (nullabilityQualifierWithMigrationStatusO2.c() == NullabilityQualifier.f145559b) {
                nullabilityQualifierWithMigrationStatusO2 = NullabilityQualifierWithMigrationStatus.b(nullabilityQualifierWithMigrationStatusO2, NullabilityQualifier.f145558a, false, 2, null);
            }
        } else {
                                ...
                                if (!(list2 instanceof Collection) || !list2.isEmpty()) {
                                    ...
                                    while (it5.hasNext()) {
                                        if (!typeSystemContextA.O((KotlinTypeMarker) it5.next())) {
                                            nullabilityQualifier = NullabilityQualifier.f145560c;
                                            break;
                                        }
                                    }
                                    nullabilityQualifier = NullabilityQualifier.f145559b;
                                } else {
                                    nullabilityQualifier = NullabilityQualifier.f145559b;
                                }
                                if (arrayList != listU) {
    ...
    private final NullabilityQualifier y(KotlinTypeMarker kotlinTypeMarker) {
        ...
        if (typeSystemContextA.E0(typeSystemContextA.A0(kotlinTypeMarker))) {
            return NullabilityQualifier.f145559b;
        }
        if (!typeSystemContextA.E0(typeSystemContextA.C(kotlinTypeMarker))) {
            return NullabilityQualifier.f145560c;
        }
        return null;
    }
}
