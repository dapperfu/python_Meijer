...
public final class RawSubstitution extends TypeSubstitution {
    ...
    public static final Companion f145503e = new Companion(null);

    /* renamed from: f, reason: collision with root package name */
    private static final JavaTypeAttributes f145504f;

    /* renamed from: g, reason: collision with root package name */
    private static final JavaTypeAttributes f145505g;

    /* renamed from: c, reason: collision with root package name */
    private final RawProjectionComputer f145506c;

    /* renamed from: d, reason: collision with root package name */
    private final TypeParameterUpperBoundEraser f145507d;
    ...
    static {
        TypeUsage typeUsage = TypeUsage.f147695b;
        f145504f = JavaTypeAttributesKt.b(typeUsage, false, true, null, 5, null).l(JavaTypeFlexibility.f145495c);
        f145505g = JavaTypeAttributesKt.b(typeUsage, false, true, null, 5, null).l(JavaTypeFlexibility.f145494b);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public RawSubstitution(TypeParameterUpperBoundEraser typeParameterUpperBoundEraser) {
        RawProjectionComputer rawProjectionComputer = new RawProjectionComputer();
        this.f145506c = rawProjectionComputer;
        ...
        this.f145507d = typeParameterUpperBoundEraser;
    }
    ...
    private final Pair<SimpleType, Boolean> j(SimpleType simpleType, ClassDescriptor classDescriptor, JavaTypeAttributes javaTypeAttributes) {
        ...
        if (KotlinTypeKt.a(simpleType)) {
            return TuplesKt.a(ErrorUtils.d(ErrorTypeKind.f147828J, simpleType.K0().toString()), Boolean.FALSE);
        }
        ...
        for (TypeParameterDescriptor typeParameterDescriptor : list) {
            RawProjectionComputer rawProjectionComputer = this.f145506c;
            Intrinsics.g(typeParameterDescriptor);
            arrayList.add(ErasureProjectionComputer.b(rawProjectionComputer, typeParameterDescriptor, javaTypeAttributes, this.f145507d, null, 8, null));
        }
    ...
    static /* synthetic */ KotlinType m(RawSubstitution rawSubstitution, KotlinType kotlinType, JavaTypeAttributes javaTypeAttributes, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            javaTypeAttributes = new JavaTypeAttributes(TypeUsage.f147695b, null, false, false, null, null, 62, null);
        }
    ...
    private final KotlinType l(KotlinType kotlinType, JavaTypeAttributes javaTypeAttributes) {
        ...
        if (classifierDescriptorD instanceof TypeParameterDescriptor) {
            return l(this.f145507d.e((TypeParameterDescriptor) classifierDescriptorD, javaTypeAttributes.j(true)), javaTypeAttributes);
        }
        if (classifierDescriptorD instanceof ClassDescriptor) {
            ...
            if (classifierDescriptorD2 instanceof ClassDescriptor) {
                Pair<SimpleType, Boolean> pairJ = j(FlexibleTypesKt.c(kotlinType), (ClassDescriptor) classifierDescriptorD, f145504f);
                SimpleType simpleTypeA = pairJ.a();
                boolean zBooleanValue = pairJ.b().booleanValue();
                Pair<SimpleType, Boolean> pairJ2 = j(FlexibleTypesKt.d(kotlinType), (ClassDescriptor) classifierDescriptorD2, f145505g);
