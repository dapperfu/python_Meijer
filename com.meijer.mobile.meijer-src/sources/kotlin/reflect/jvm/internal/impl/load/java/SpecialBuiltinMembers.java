...
public final class SpecialBuiltinMembers {
    ...
    public static final String e(CallableMemberDescriptor callableMemberDescriptor) {
        ...
        if (callableMemberDescriptorF != null && (callableMemberDescriptorW = DescriptorUtilsKt.w(callableMemberDescriptorF)) != null) {
            if (callableMemberDescriptorW instanceof PropertyDescriptor) {
                return ClassicBuiltinSpecialProperties.f145076a.b(callableMemberDescriptorW);
            }
            if ((callableMemberDescriptorW instanceof SimpleFunctionDescriptor) && (nameJ = BuiltinMethodsWithDifferentJvmName.f145068o.j((SimpleFunctionDescriptor) callableMemberDescriptorW)) != null) {
                return nameJ.b();
            }
        }
        return null;
    ...
    public static final <T extends CallableMemberDescriptor> T g(T t10) {
        ...
        if (!SpecialGenericSignatures.f145189a.g().contains(t10.getName()) && !BuiltinSpecialProperties.f145070a.d().contains(DescriptorUtilsKt.w(t10).getName())) {
            return null;
        }
        if ((t10 instanceof PropertyDescriptor) || (t10 instanceof PropertyAccessorDescriptor)) {
            return (T) DescriptorUtilsKt.i(t10, false, i.f145288a, 1, null);
        }
        if (t10 instanceof SimpleFunctionDescriptor) {
            return (T) DescriptorUtilsKt.i(t10, false, j.f145289a, 1, null);
        }
        return null;
    }
    ...
    public static final boolean h(CallableMemberDescriptor it) {
        Intrinsics.j(it, "it");
        return ClassicBuiltinSpecialProperties.f145076a.d(DescriptorUtilsKt.w(it));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean i(CallableMemberDescriptor it) {
        Intrinsics.j(it, "it");
        return BuiltinMethodsWithDifferentJvmName.f145068o.k((SimpleFunctionDescriptor) it);
    }
    ...
    public static final <T extends CallableMemberDescriptor> T j(T t10) {
        ...
        if (builtinMethodsWithSpecialGenericSignature.n(name)) {
            return (T) DescriptorUtilsKt.i(t10, false, k.f145290a, 1, null);
        }
        return null;
    }
