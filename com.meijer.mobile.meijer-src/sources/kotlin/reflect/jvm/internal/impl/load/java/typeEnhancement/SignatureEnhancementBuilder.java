...
final class SignatureEnhancementBuilder {
    ...
    private final Map<String, PredefinedFunctionEnhancementInfo> f145578a = new LinkedHashMap();

    public final class ClassEnhancementBuilder {

        /* renamed from: a, reason: collision with root package name */
        private final String f145579a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ SignatureEnhancementBuilder f145580b;

        @SourceDebugExtension
        public final class FunctionEnhancementBuilder {

            /* renamed from: a, reason: collision with root package name */
            private final String f145581a;

            /* renamed from: b, reason: collision with root package name */
            private final String f145582b;

            /* renamed from: c, reason: collision with root package name */
            private final List<Pair<String, TypeEnhancementInfo>> f145583c;

            /* renamed from: d, reason: collision with root package name */
            private Pair<String, TypeEnhancementInfo> f145584d;

            /* renamed from: e, reason: collision with root package name */
            final /* synthetic */ ClassEnhancementBuilder f145585e;
            ...
            public FunctionEnhancementBuilder(ClassEnhancementBuilder classEnhancementBuilder, String functionName, String str) {
                ...
                this.f145585e = classEnhancementBuilder;
                this.f145581a = functionName;
                this.f145582b = str;
                this.f145583c = new ArrayList();
                this.f145584d = TuplesKt.a("V", null);
            }
            ...
            public final Pair<String, PredefinedFunctionEnhancementInfo> a() {
                ...
                String strC = this.f145585e.c();
                String str = this.f145581a;
                List<Pair<String, TypeEnhancementInfo>> list = this.f145583c;
                ArrayList arrayList = new ArrayList(CollectionsKt.x(list, 10));
                Iterator<T> it = list.iterator();
                while (it.hasNext()) {
                    arrayList.add((String) ((Pair) it.next()).c());
                }
                String strM = signatureBuildingComponents.m(strC, signatureBuildingComponents.k(str, arrayList, this.f145584d.c()));
                TypeEnhancementInfo typeEnhancementInfoD = this.f145584d.d();
                List<Pair<String, TypeEnhancementInfo>> list2 = this.f145583c;
                ArrayList arrayList2 = new ArrayList(CollectionsKt.x(list2, 10));
                Iterator<T> it2 = list2.iterator();
                while (it2.hasNext()) {
                    arrayList2.add((TypeEnhancementInfo) ((Pair) it2.next()).d());
                }
                return TuplesKt.a(strM, new PredefinedFunctionEnhancementInfo(typeEnhancementInfoD, arrayList2, this.f145582b));
            }
            ...
            public final void b(String type, JavaTypeQualifiers... qualifiers) {
                ...
                if (qualifiers.length == 0) {
                    ...
                    Iterable<IndexedValue> iterableU1 = ArraysKt.u1(qualifiers);
                    LinkedHashMap linkedHashMap = new LinkedHashMap(RangesKt.f(MapsKt.f(CollectionsKt.x(iterableU1, 10)), 16));
            ...
            public final void c(String type, JavaTypeQualifiers... qualifiers) {
                ...
                this.f145584d = TuplesKt.a(type, new TypeEnhancementInfo(linkedHashMap));
            }
            ...
            public final void d(JvmPrimitiveType type) {
                ...
                this.f145584d = TuplesKt.a(strL, null);
            }
        }

        public ClassEnhancementBuilder(SignatureEnhancementBuilder signatureEnhancementBuilder, String className) {
            Intrinsics.j(className, "className");
            this.f145580b = signatureEnhancementBuilder;
            this.f145579a = className;
        }
        ...
        public final void a(String name, String str, Function1<? super FunctionEnhancementBuilder, Unit> block) {
            ...
            Map map = this.f145580b.f145578a;
