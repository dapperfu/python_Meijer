...
public abstract class AbstractBinaryClassAnnotationLoader<A, S extends AnnotationsContainer<? extends A>> implements AnnotationLoader<A> {
    ...
    public static final Companion f145652b = new Companion(null);

    /* renamed from: a, reason: collision with root package name */
    private final KotlinClassFinder f145653a;
    ...
    private static final class a {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final a f145654a = new a("PROPERTY", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final a f145655b = new a("BACKING_FIELD", 1);

        /* renamed from: c, reason: collision with root package name */
        public static final a f145656c = new a("DELEGATE_FIELD", 2);

        /* renamed from: d, reason: collision with root package name */
        private static final /* synthetic */ a[] f145657d;

        /* renamed from: e, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f145658e;

        private static final /* synthetic */ a[] a() {
            return new a[]{f145654a, f145655b, f145656c};
        }

        static {
            a[] aVarArrA = a();
            f145657d = aVarArrA;
            f145658e = EnumEntriesKt.a(aVarArrA);
        }
    ...
    public AbstractBinaryClassAnnotationLoader(KotlinClassFinder kotlinClassFinder) {
        Intrinsics.j(kotlinClassFinder, "kotlinClassFinder");
        this.f145653a = kotlinClassFinder;
    }
    ...
    private final List<A> n(ProtoContainer protoContainer, MemberSignature memberSignature, boolean z10, boolean z11, Boolean bool, boolean z12) {
        KotlinJvmBinaryClass kotlinJvmBinaryClassP = p(protoContainer, f145652b.a(protoContainer, z10, z11, bool, z12, this.f145653a, v()));
    ...
    private final List<A> z(ProtoContainer protoContainer, ProtoBuf.Property property, a aVar) {
        Boolean boolD = Flags.f146405B.d(property.f0());
        ...
        return StringsKt.d0(memberSignatureB2.a(), "$delegate", false, 2, null) != (aVar == a.f145656c) ? CollectionsKt.m() : n(protoContainer, memberSignatureB2, true, true, boolD, zF);
    }
    ...
    public List<A> a(ProtoContainer container, MessageLite callableProto, AnnotatedCallableKind kind, int i10, ProtoBuf.ValueParameter proto) {
        ...
        return o(this, container, MemberSignature.f145733b.e(memberSignatureT, i10 + m(container, callableProto)), false, false, null, false, 60, null);
    }
    ...
    public List<A> b(ProtoContainer.Class container) {
        ...
        if (kotlinJvmBinaryClassA != null) {
            ...
            kotlinJvmBinaryClassA.c(new KotlinJvmBinaryClass.AnnotationVisitor(this) { // from class: kotlin.reflect.jvm.internal.impl.load.kotlin.AbstractBinaryClassAnnotationLoader$loadClassAnnotations$1
                ...
                /* renamed from: a, reason: collision with root package name */
                final /* synthetic */ AbstractBinaryClassAnnotationLoader<A, S> f145659a;
                ...
                public KotlinJvmBinaryClass.AnnotationArgumentVisitor c(ClassId classId, SourceElement source) {
                    ...
                    return this.f145659a.y(classId, source, arrayList);
                }
    ...
    public List<A> c(ProtoBuf.Type proto, NameResolver nameResolver) {
        ...
        Object objU = proto.u(JvmProtoBuf.f146465f);
    ...
    public List<A> d(ProtoContainer container, ProtoBuf.EnumEntry proto) {
        Intrinsics.j(container, "container");
        Intrinsics.j(proto, "proto");
        return o(this, container, MemberSignature.f145733b.a(container.b().getString(proto.G()), ClassMapperLite.b(((ProtoContainer.Class) container).e().b())), false, false, null, false, 60, null);
    }
    ...
    public List<A> e(ProtoContainer container, MessageLite proto, AnnotatedCallableKind kind) {
        ...
        if (kind == AnnotatedCallableKind.PROPERTY) {
            return z(container, (ProtoBuf.Property) proto, a.f145654a);
        }
    ...
    public List<A> g(ProtoBuf.TypeParameter proto, NameResolver nameResolver) {
        Intrinsics.j(proto, "proto");
        Intrinsics.j(nameResolver, "nameResolver");
        Object objU = proto.u(JvmProtoBuf.f146467h);
        Intrinsics.i(objU, "getExtension(...)");
        Iterable<ProtoBuf.Annotation> iterable = (Iterable) objU;
        ArrayList arrayList = new ArrayList(CollectionsKt.x(iterable, 10));
        for (ProtoBuf.Annotation annotation : iterable) {
    ...
    public List<A> j(ProtoContainer container, ProtoBuf.Property proto) {
        Intrinsics.j(container, "container");
        Intrinsics.j(proto, "proto");
        return z(container, proto, a.f145655b);
    }
    ...
    public List<A> k(ProtoContainer container, MessageLite proto, AnnotatedCallableKind kind) {
        ...
        Intrinsics.j(kind, "kind");
        MemberSignature memberSignatureT = t(this, proto, container.b(), container.d(), kind, false, 16, null);
        return memberSignatureT != null ? o(this, container, MemberSignature.f145733b.e(memberSignatureT, 0), false, false, null, false, 60, null) : CollectionsKt.m();
    }
    ...
    public List<A> l(ProtoContainer container, ProtoBuf.Property proto) {
        Intrinsics.j(container, "container");
        Intrinsics.j(proto, "proto");
        return z(container, proto, a.f145656c);
    }
    ...
    protected final MemberSignature s(MessageLite proto, NameResolver nameResolver, TypeTable typeTable, AnnotatedCallableKind kind, boolean z10) {
        ...
        if (proto instanceof ProtoBuf.Constructor) {
            ...
            JvmMemberSignature.Method methodB = JvmProtoBufUtil.f146571a.b((ProtoBuf.Constructor) proto, nameResolver, typeTable);
            if (methodB == null) {
                return null;
            }
        ...
        if (proto instanceof ProtoBuf.Function) {
            MemberSignature.Companion companion2 = MemberSignature.f145733b;
            JvmMemberSignature.Method methodE = JvmProtoBufUtil.f146571a.e((ProtoBuf.Function) proto, nameResolver, typeTable);
            if (methodE == null) {
                return null;
            }
        ...
        if (proto instanceof ProtoBuf.Property) {
            ...
            if (i10 != 1) {
                ...
                MemberSignature.Companion companion3 = MemberSignature.f145733b;
            ...
            if (jvmPropertySignature.H()) {
                MemberSignature.Companion companion4 = MemberSignature.f145733b;
    ...
    protected final boolean w(ClassId classId) {
        ...
        Intrinsics.j(classId, "classId");
        return classId.e() != null && Intrinsics.e(classId.h().b(), "Container") && (kotlinJvmBinaryClassB = KotlinClassFinderKt.b(this.f145653a, classId, v())) != null && SpecialJvmAnnotations.f144136a.c(kotlinJvmBinaryClassB);
    }
    ...
    protected final KotlinJvmBinaryClass.AnnotationArgumentVisitor y(ClassId annotationClassId, SourceElement source, List<A> result) {
        ...
        if (SpecialJvmAnnotations.f144136a.b().contains(annotationClassId)) {
            return null;
        }
