...
public final class BuiltinMethodsWithDifferentJvmName extends SpecialGenericSignatures {
    ...
    public static final BuiltinMethodsWithDifferentJvmName f145068o = new BuiltinMethodsWithDifferentJvmName();

    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean l(SimpleFunctionDescriptor simpleFunctionDescriptor, CallableMemberDescriptor it) {
        Intrinsics.j(it, "it");
        return SpecialGenericSignatures.f145189a.j().containsKey(MethodSignatureMappingKt.d(simpleFunctionDescriptor));
    }

    public final Name j(SimpleFunctionDescriptor functionDescriptor) {
        Intrinsics.j(functionDescriptor, "functionDescriptor");
        Map<String, Name> mapJ = SpecialGenericSignatures.f145189a.j();
    ...
    public final boolean m(SimpleFunctionDescriptor simpleFunctionDescriptor) {
        ...
        return Intrinsics.e(simpleFunctionDescriptor.getName().b(), "removeAt") && Intrinsics.e(MethodSignatureMappingKt.d(simpleFunctionDescriptor), SpecialGenericSignatures.f145189a.h().d());
    }
