...
public final class ClassicBuiltinSpecialProperties {
    ...
    public static final ClassicBuiltinSpecialProperties f145076a = new ClassicBuiltinSpecialProperties();

    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean c(CallableMemberDescriptor it) {
        Intrinsics.j(it, "it");
        return f145076a.d(it);
    }

    private final boolean e(CallableMemberDescriptor callableMemberDescriptor) {
        if (CollectionsKt.h0(BuiltinSpecialProperties.f145070a.c(), DescriptorUtilsKt.k(callableMemberDescriptor)) && callableMemberDescriptor.h().isEmpty()) {
            return true;
        }
        ...
        for (CallableMemberDescriptor callableMemberDescriptor2 : collection) {
            ClassicBuiltinSpecialProperties classicBuiltinSpecialProperties = f145076a;
    ...
    public final String b(CallableMemberDescriptor callableMemberDescriptor) {
        ...
        CallableMemberDescriptor callableMemberDescriptorI = DescriptorUtilsKt.i(DescriptorUtilsKt.w(callableMemberDescriptor), false, e.f145284a, 1, null);
        if (callableMemberDescriptorI == null || (name = BuiltinSpecialProperties.f145070a.a().get(DescriptorUtilsKt.o(callableMemberDescriptorI))) == null) {
            return null;
        }
        return name.b();
    }
    ...
    public final boolean d(CallableMemberDescriptor callableMemberDescriptor) {
        ...
        if (BuiltinSpecialProperties.f145070a.d().contains(callableMemberDescriptor.getName())) {
