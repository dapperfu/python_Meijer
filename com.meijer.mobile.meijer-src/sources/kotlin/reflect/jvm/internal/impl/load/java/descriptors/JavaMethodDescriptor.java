...
public class JavaMethodDescriptor extends SimpleFunctionDescriptorImpl implements JavaCallableMemberDescriptor {
    ...
    public static final CallableDescriptor.UserDataKey<ValueParameterDescriptor> f145270G = new a();

    /* renamed from: H, reason: collision with root package name */
    public static final CallableDescriptor.UserDataKey<Boolean> f145271H = new b();

    /* renamed from: E, reason: collision with root package name */
    private c f145272E;

    /* renamed from: F, reason: collision with root package name */
    private final boolean f145273F;
    ...
    private enum c {
        ...
        public final boolean f145279a;

        /* renamed from: b, reason: collision with root package name */
        public final boolean f145280b;
    ...
    public boolean N0() {
        return this.f145272E.f145279a;
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.impl.FunctionDescriptorImpl, kotlin.reflect.jvm.internal.impl.descriptors.CallableDescriptor
    public boolean d0() {
        return this.f145272E.f145280b;
    }
    ...
    public SimpleFunctionDescriptorImpl l1(ReceiverParameterDescriptor receiverParameterDescriptor, ReceiverParameterDescriptor receiverParameterDescriptor2, List<ReceiverParameterDescriptor> list, List<? extends TypeParameterDescriptor> list2, List<ValueParameterDescriptor> list3, KotlinType kotlinType, Modality modality, DescriptorVisibility descriptorVisibility, Map<? extends CallableDescriptor.UserDataKey<?>, ?> map) {
        ...
        c1(OperatorChecks.f147983a.a(simpleFunctionDescriptorImplL1).a());
    ...
    public JavaMethodDescriptor I0(DeclarationDescriptor declarationDescriptor, FunctionDescriptor functionDescriptor, CallableMemberDescriptor.Kind kind, Name name, Annotations annotations, SourceElement sourceElement) {
        ...
        JavaMethodDescriptor javaMethodDescriptor = new JavaMethodDescriptor(declarationDescriptor, simpleFunctionDescriptor, annotations, name, kind, sourceElement, this.f145273F);
    ...
    public JavaMethodDescriptor Y(KotlinType kotlinType, List<KotlinType> list, KotlinType kotlinType2, Pair<CallableDescriptor.UserDataKey<?>, ?> pair) {
        ...
        JavaMethodDescriptor javaMethodDescriptor = (JavaMethodDescriptor) t().b(UtilKt.a(list, h(), this)).m(kotlinType2).e(kotlinType == null ? null : DescriptorFactory.i(this, kotlinType, Annotations.f144596s3.b())).a().l().build();
        if (pair != null) {
