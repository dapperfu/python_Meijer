...
public class JavaDescriptorVisibilities {
    ...
    public static final DescriptorVisibility f145093a;

    /* renamed from: b, reason: collision with root package name */
    public static final DescriptorVisibility f145094b;

    /* renamed from: c, reason: collision with root package name */
    public static final DescriptorVisibility f145095c;

    /* renamed from: d, reason: collision with root package name */
    private static final Map<Visibility, DescriptorVisibility> f145096d;
    ...
    public static boolean e(ReceiverValue receiverValue, DeclarationDescriptorWithVisibility declarationDescriptorWithVisibility, DeclarationDescriptor declarationDescriptor) {
        ...
        return DescriptorVisibilities.f144505c.e(receiverValue, declarationDescriptorWithVisibility, declarationDescriptor, false);
    }

    static {
        a aVar = new a(JavaVisibilities.PackageVisibility.f144938c);
        f145093a = aVar;
        b bVar = new b(JavaVisibilities.ProtectedStaticVisibility.f144940c);
        f145094b = bVar;
        c cVar = new c(JavaVisibilities.ProtectedAndPackage.f144939c);
        f145095c = cVar;
        f145096d = new HashMap();
        f(aVar);
        f(bVar);
        f(cVar);
    }
    ...
    private static void f(DescriptorVisibility descriptorVisibility) {
        f145096d.put(descriptorVisibility.b(), descriptorVisibility);
    }
    ...
    public static DescriptorVisibility g(Visibility visibility) {
        ...
        DescriptorVisibility descriptorVisibility = f145096d.get(visibility);
