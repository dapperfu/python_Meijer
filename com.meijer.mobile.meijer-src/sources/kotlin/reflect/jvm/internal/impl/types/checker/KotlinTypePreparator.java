...
public abstract class KotlinTypePreparator extends AbstractTypePreparator {
    ...
    public static final class Default extends KotlinTypePreparator {
        ...
        public static final Default f147724a = new Default();
    ...
    private final SimpleType c(SimpleType simpleType) {
        ...
        if (typeConstructorK0 instanceof CapturedTypeConstructorImpl) {
            ...
            TypeProjection typeProjectionH0 = capturedTypeConstructorImpl.h0();
            if (typeProjectionH0.c() != Variance.f147704f) {
                typeProjectionH0 = null;
            }
            if (typeProjectionH0 != null && (type = typeProjectionH0.getType()) != null) {
                unwrappedTypeN0 = type.N0();
            }
            UnwrappedType unwrappedType = unwrappedTypeN0;
            if (capturedTypeConstructorImpl.g() == null) {
                TypeProjection typeProjectionH02 = capturedTypeConstructorImpl.h0();
                ...
                capturedTypeConstructorImpl.i(new NewCapturedTypeConstructor(typeProjectionH02, arrayList, null, 4, null));
            }
            CaptureStatus captureStatus = CaptureStatus.f147915a;
