...
public final class AbstractTypeChecker {
    ...
    public static final AbstractTypeChecker f147577a = new AbstractTypeChecker();

    /* renamed from: b, reason: collision with root package name */
    @JvmField
    public static boolean f147578b;
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            try {
                iArr[TypeVariance.f147922d.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[TypeVariance.f147921c.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[TypeVariance.f147920b.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            $EnumSwitchMapping$0 = iArr;
            int[] iArr2 = new int[TypeCheckerState.LowerCapturedTypePolicy.values().length];
            try {
                iArr2[TypeCheckerState.LowerCapturedTypePolicy.f147661a.ordinal()] = 1;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                iArr2[TypeCheckerState.LowerCapturedTypePolicy.f147662b.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                iArr2[TypeCheckerState.LowerCapturedTypePolicy.f147663c.ordinal()] = 3;
    ...
    */
    ...
    public static final boolean y(TypeCheckerState typeCheckerState, TypeSystemContext typeSystemContext, RigidTypeMarker rigidTypeMarker, RigidTypeMarker rigidTypeMarker2) {
        return f147577a.s(typeCheckerState, typeSystemContext.q(rigidTypeMarker), rigidTypeMarker2);
    }
    ...
    public final TypeVariance l(TypeVariance declared, TypeVariance useSite) {
        ...
        TypeVariance typeVariance = TypeVariance.f147922d;
    ...
    public final boolean m(TypeCheckerState state, KotlinTypeMarker a10, KotlinTypeMarker b10) {
        ...
        AbstractTypeChecker abstractTypeChecker = f147577a;
    ...
    public final List<RigidTypeMarker> n(TypeCheckerState state, RigidTypeMarker subType, TypeConstructorMarker superConstructor) {
        ...
        if (typeSystemContextJ.R(subType)) {
            return f147577a.j(state, subType, superConstructor);
        }
        if (!typeSystemContextJ.v0(superConstructor) && !typeSystemContextJ.P(superConstructor)) {
            return f147577a.i(state, subType, superConstructor);
        }
        ...
        while (!arrayDequeH.isEmpty()) {
            ...
            if (setI.add(rigidTypeMarkerPop)) {
                if (typeSystemContextJ.R(rigidTypeMarkerPop)) {
                    ...
                    supertypesPolicy = TypeCheckerState.SupertypesPolicy.None.f147667a;
                } else {
                    supertypesPolicy = TypeCheckerState.SupertypesPolicy.LowerIfFlexible.f147666a;
                }
                if (Intrinsics.e(supertypesPolicy, TypeCheckerState.SupertypesPolicy.None.f147667a)) {
        ...
        for (KotlinTypeMarker kotlinTypeMarker : collectionD0) {
            if (!Intrinsics.e(typeSystemContext.h0(kotlinTypeMarker), typeSystemContext.f(rigidTypeMarker2))) {
                if (z10) {
                    ...
                    if (v(f147577a, typeCheckerState2, rigidTypeMarker3, kotlinTypeMarker, false, 8, null)) {
                        return true;
                    }
                } else {
                    typeCheckerState2 = typeCheckerState;
    ...
    */
    ...
    private final List<RigidTypeMarker> i(TypeCheckerState typeCheckerState, RigidTypeMarker rigidTypeMarker, TypeConstructorMarker typeConstructorMarker) {
        ...
        if (typeSystemContextJ.G0(typeConstructorMarker)) {
            if (typeSystemContextJ.K0(typeSystemContextJ.f(rigidTypeMarker), typeConstructorMarker)) {
                RigidTypeMarker rigidTypeMarkerL = typeSystemContextJ.l(rigidTypeMarker, CaptureStatus.f147915a);
        ...
        while (!arrayDequeH.isEmpty()) {
            ...
            Intrinsics.g(rigidTypeMarkerPop);
            if (setI.add(rigidTypeMarkerPop)) {
                RigidTypeMarker rigidTypeMarkerL2 = typeSystemContextJ.l(rigidTypeMarkerPop, CaptureStatus.f147915a);
                ...
                if (typeSystemContextJ.K0(typeSystemContextJ.f(rigidTypeMarkerL2), typeConstructorMarker)) {
                    ...
                    supertypesPolicyK0 = TypeCheckerState.SupertypesPolicy.None.f147667a;
                } else if (typeSystemContextJ.j(rigidTypeMarkerL2) == 0) {
                    supertypesPolicyK0 = TypeCheckerState.SupertypesPolicy.LowerIfFlexible.f147666a;
                } else {
                    supertypesPolicyK0 = typeCheckerState.j().k0(rigidTypeMarkerL2);
                }
                if (Intrinsics.e(supertypesPolicyK0, TypeCheckerState.SupertypesPolicy.None.f147667a)) {
    ...
    private final boolean k(TypeCheckerState typeCheckerState, KotlinTypeMarker kotlinTypeMarker, KotlinTypeMarker kotlinTypeMarker2, boolean z10) {
        ...
        AbstractTypeChecker abstractTypeChecker2 = f147577a;
    ...
    */
    ...
    private final boolean z(TypeSystemContext typeSystemContext, KotlinTypeMarker kotlinTypeMarker, KotlinTypeMarker kotlinTypeMarker2, TypeConstructorMarker typeConstructorMarker) {
        ...
        if (rigidTypeMarkerB instanceof CapturedTypeMarker) {
            ...
            if (typeSystemContext.e0(capturedTypeMarker) || !typeSystemContext.c(typeSystemContext.s0(typeSystemContext.I(capturedTypeMarker))) || typeSystemContext.q0(capturedTypeMarker) != CaptureStatus.f147915a) {
                return false;
            }
