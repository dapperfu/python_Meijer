...
public class ErrorScope implements MemberScope {
    ...
    private final ErrorScopeKind f147785b;

    /* renamed from: c, reason: collision with root package name */
    private final String f147786c;
    ...
    public ClassifierDescriptor f(Name name, LookupLocation location) {
        ...
        String str = String.format(ErrorEntity.f147767b.b(), Arrays.copyOf(new Object[]{name}, 1));
        Intrinsics.i(str, "format(...)");
    ...
    public Set<SimpleFunctionDescriptor> b(Name name, LookupLocation location) {
        Intrinsics.j(name, "name");
        Intrinsics.j(location, "location");
        return SetsKt.d(new ErrorFunctionDescriptor(ErrorUtils.f147897a.h()));
    }
    ...
    public String toString() {
        return "ErrorScope{" + this.f147786c + '}';
    }
