...
public final class TypeIntersector {
    ...
    public static final TypeIntersector f147748a = new TypeIntersector();
    ...
    private static final class a {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final a f147749a = new c("START", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final a f147750b = new C2279a("ACCEPT_NULL", 1);

        /* renamed from: c, reason: collision with root package name */
        public static final a f147751c = new d("UNKNOWN", 2);

        /* renamed from: d, reason: collision with root package name */
        public static final a f147752d = new b("NOT_NULL", 3);

        /* renamed from: e, reason: collision with root package name */
        private static final /* synthetic */ a[] f147753e;

        /* renamed from: f, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f147754f;
        ...
        static final class C2279a extends a {
            C2279a(String str, int i10) {
                super(str, i10, null);
            }
        ...
        static final class d extends a {
            ...
            public a b(UnwrappedType nextType) {
                Intrinsics.j(nextType, "nextType");
                a aVarE = e(nextType);
                return aVarE == a.f147750b ? this : aVarE;
            }
        }
        ...
        private static final /* synthetic */ a[] a() {
            return new a[]{f147749a, f147750b, f147751c, f147752d};
        }
        ...
        static {
            a[] aVarArrA = a();
            f147753e = aVarArrA;
            f147754f = EnumEntriesKt.a(aVarArrA);
        }
        ...
        public static a[] values() {
            return (a[]) f147753e.clone();
        }

        protected final a e(UnwrappedType unwrappedType) {
            Intrinsics.j(unwrappedType, "<this>");
            return unwrappedType.L0() ? f147750b : ((unwrappedType instanceof DefinitelyNotNullType) && (((DefinitelyNotNullType) unwrappedType).W0() instanceof StubTypeForBuilderInference)) ? f147752d : unwrappedType instanceof StubTypeForBuilderInference ? f147751c : NullabilityChecker.f147744a.a(unwrappedType) ? f147752d : f147751c;
        }
    }
    ...
    public final boolean g(KotlinType kotlinType, KotlinType kotlinType2) {
        NewKotlinTypeCheckerImpl newKotlinTypeCheckerImplA = NewKotlinTypeChecker.f147738b.a();
    ...
    private final SimpleType e(Set<? extends SimpleType> set) {
        ...
        collectionC.isEmpty();
        SimpleType simpleTypeB = IntegerLiteralTypeConstructor.f147087f.b(collectionC);
        if (simpleTypeB != null) {
            return simpleTypeB;
        }
        Collection<SimpleType> collectionC2 = c(collectionC, new c(NewKotlinTypeChecker.f147738b.a()));
