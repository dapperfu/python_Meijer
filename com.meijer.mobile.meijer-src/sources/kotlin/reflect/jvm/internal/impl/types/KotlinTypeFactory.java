...
public final class KotlinTypeFactory {
    ...
    public static final KotlinTypeFactory f147621a = new KotlinTypeFactory();

    /* renamed from: b, reason: collision with root package name */
    private static final Function1<KotlinTypeRefiner, SimpleType> f147622b = a.f147623a;

    static final class a implements Function1 {

        /* renamed from: a, reason: collision with root package name */
        public static final a f147623a = new a();
    ...
    private static final class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final SimpleType f147624a;

        /* renamed from: b, reason: collision with root package name */
        private final TypeConstructor f147625b;
        ...
        public b(SimpleType simpleType, TypeConstructor typeConstructor) {
            this.f147624a = simpleType;
            this.f147625b = typeConstructor;
        }
    }
    ...
    public static final SimpleType c(TypeAliasDescriptor typeAliasDescriptor, List<? extends TypeProjection> arguments) {
        ...
        Intrinsics.j(arguments, "arguments");
        return new TypeAliasExpander(TypeAliasExpansionReportStrategy.DO_NOTHING.f147646a, false).i(TypeAliasExpansion.f147641e.a(null, typeAliasDescriptor, arguments), TypeAttributes.f147647b.k());
    }
    ...
    public static final SimpleType f(TypeAttributes attributes, IntegerLiteralTypeConstructor constructor, boolean z10) {
        Intrinsics.j(attributes, "attributes");
        Intrinsics.j(constructor, "constructor");
        return m(attributes, constructor, CollectionsKt.m(), z10, ErrorUtils.a(ErrorScopeKind.f147788c, true, "unknown integer literal type"));
    }
    ...
    public static final SimpleType j(TypeAttributes attributes, TypeConstructor constructor, List<? extends TypeProjection> arguments, boolean z10, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        if (!attributes.isEmpty() || !arguments.isEmpty() || z10 || constructor.d() == null) {
            return n(attributes, constructor, arguments, z10, f147621a.d(constructor, arguments, kotlinTypeRefiner), new n(constructor, arguments, attributes, z10));
        }
    ...
    public static final SimpleType l(TypeConstructor typeConstructor, List list, TypeAttributes typeAttributes, boolean z10, KotlinTypeRefiner refiner) {
        ...
        b bVarG = f147621a.g(typeConstructor, refiner, list);
        if (bVarG == null) {
            return null;
        }
    ...
    public static final SimpleType o(TypeConstructor typeConstructor, List list, TypeAttributes typeAttributes, boolean z10, MemberScope memberScope, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        b bVarG = f147621a.g(typeConstructor, kotlinTypeRefiner, list);
        if (bVarG == null) {
            return null;
        }
        SimpleType simpleTypeA = bVarG.a();
    ...
    private final MemberScope d(TypeConstructor typeConstructor, List<? extends TypeProjection> list, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        if (classifierDescriptorD instanceof ClassDescriptor) {
            ...
            return ModuleAwareClassDescriptorKt.a((ClassDescriptor) classifierDescriptorD, TypeConstructorSubstitution.f147669c.b(typeConstructor, list), kotlinTypeRefiner);
        }
        if (classifierDescriptorD instanceof TypeAliasDescriptor) {
            return ErrorUtils.a(ErrorScopeKind.f147790e, true, ((TypeAliasDescriptor) classifierDescriptorD).getName().toString());
        }
