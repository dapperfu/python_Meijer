...
public class TypeSubstitutor {
    ...
    public static final TypeSubstitutor f147687b = g(TypeSubstitution.f147685b);

    /* renamed from: a, reason: collision with root package name */
    private final TypeSubstitution f147688a;
    ...
    static class a implements Function1<FqName, Boolean> {
        ...
        public Boolean invoke(FqName fqName) {
            ...
            return Boolean.valueOf(!fqName.equals(StandardNames.FqNames.f144259Q));
        }
    ...
    */
    ...
    static /* synthetic */ class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f147689a;
        ...
        static {
            ...
            try {
                f147689a[d.IN_IN_OUT_POSITION.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f147689a[d.NO_CONFLICT.ordinal()] = 3;
    ...
    protected TypeSubstitutor(TypeSubstitution typeSubstitution) {
        ...
        this.f147688a = typeSubstitution;
    }
    ...
    public static Variance c(Variance variance, TypeProjection typeProjection) {
        ...
        Variance variance2 = Variance.f147705g;
        if (variance2 == null) {
            a(37);
        }
        return variance2;
    ...
    private static d e(Variance variance, Variance variance2) {
        Variance variance3 = Variance.f147704f;
        return (variance == variance3 && variance2 == Variance.f147705g) ? d.OUT_IN_IN_POSITION : (variance == Variance.f147705g && variance2 == variance3) ? d.IN_IN_OUT_POSITION : d.NO_CONFLICT;
    }
    ...
    private static Annotations i(Annotations annotations) {
        ...
        return !annotations.p3(StandardNames.FqNames.f144259Q) ? annotations : new FilteredAnnotations(annotations, new a());
    }
    ...
    private static TypeProjection l(KotlinType kotlinType, TypeProjection typeProjection, TypeParameterDescriptor typeParameterDescriptor, TypeProjection typeProjection2) {
        ...
        if (!kotlinType.getAnnotations().p3(StandardNames.FqNames.f144259Q)) {
            if (typeProjection == null) {
                a(29);
            }
        ...
        TypeProjection typeProjectionH0 = ((NewCapturedTypeConstructor) typeConstructorK0).h0();
        Variance varianceC = typeProjectionH0.c();
        d dVarE = e(typeProjection2.c(), varianceC);
        d dVar = d.OUT_IN_IN_POSITION;
        return dVarE == dVar ? new TypeProjectionImpl(typeProjectionH0.getType()) : (typeParameterDescriptor != null && e(typeParameterDescriptor.k(), varianceC) == dVar) ? new TypeProjectionImpl(typeProjectionH0.getType()) : typeProjection;
    }
    ...
    private List<TypeProjection> s(List<TypeParameterDescriptor> list, List<TypeProjection> list2, int i10) throws c {
        ...
        for (int i11 = 0; i11 < list.size(); i11++) {
            ...
            int i12 = b.f147689a[e(typeParameterDescriptor.k(), typeProjectionU.c()).ordinal()];
            if (i12 == 1 || i12 == 2) {
    ...
    private TypeProjection u(TypeProjection typeProjection, TypeParameterDescriptor typeParameterDescriptor, int i10) throws c {
        ...
        b(i10, typeProjection, this.f147688a);
        if (!typeProjection.a()) {
            ...
            if (!DynamicTypesKt.a(type) && !(type.N0() instanceof RawType)) {
                TypeProjection typeProjectionE = this.f147688a.e(type);
                ...
                if (typeProjectionL == null && FlexibleTypesKt.b(type) && !TypeCapabilitiesKt.b(type)) {
                    ...
                    if (typeProjectionL != null) {
                        ...
                        if (!CapturedTypeConstructorKt.f(type)) {
                            int i12 = b.f147689a[dVarE.ordinal()];
                            if (i12 == 1) {
                                throw new c("Out-projection in in-position");
                            }
                            if (i12 == 2) {
                                return new TypeProjectionImpl(Variance.f147705g, type.K0().l().J());
                            }
                        }
                        ...
                        if (!type.getAnnotations().isEmpty()) {
                            kotlinTypeG0 = TypeUtilsKt.C(kotlinTypeG0, new CompositeAnnotations(kotlinTypeG0.getAnnotations(), i(this.f147688a.d(type.getAnnotations()))));
                        }
    ...
    public TypeSubstitution j() {
        TypeSubstitution typeSubstitution = this.f147688a;
        if (typeSubstitution == null) {
            a(8);
        }
    ...
    public boolean k() {
        return this.f147688a.f();
    }

    public TypeSubstitutor m() {
        TypeSubstitution typeSubstitution = this.f147688a;
        return ((typeSubstitution instanceof IndexedParametersSubstitution) && typeSubstitution.b()) ? new TypeSubstitutor(new IndexedParametersSubstitution(((IndexedParametersSubstitution) this.f147688a).j(), ((IndexedParametersSubstitution) this.f147688a).i(), false)) : this;
    }
    ...
    public KotlinType n(KotlinType kotlinType, Variance variance) {
        ...
        try {
            ...
            ErrorType errorTypeD = ErrorUtils.d(ErrorTypeKind.f147816D, e10.getMessage());
            if (errorTypeD == null) {
                a(13);
            }
            return errorTypeD;
    ...
    public TypeProjection q(TypeProjection typeProjection) {
        ...
        return (this.f147688a.a() || this.f147688a.b()) ? CapturedTypeApproximationKt.d(typeProjectionT, this.f147688a.b()) : typeProjectionT;
    }
    ...
    private TypeProjection r(TypeProjection typeProjection, int i10) throws c {
        ...
        if (simpleTypeB != null) {
            kotlinTypeP = m().p(simpleTypeB, Variance.f147703e);
        } else {
            kotlinTypeP = null;
        }
        KotlinType kotlinTypeB = TypeSubstitutionKt.b(type, s(type.K0().getParameters(), type.I0(), i10), this.f147688a.d(type.getAnnotations()));
