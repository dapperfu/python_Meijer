...
public final class AbbreviatedType extends DelegatingSimpleType {
    ...
    public SimpleType Q0(TypeAttributes newAttributes) {
        ...
        return new AbbreviatedType(T0().Q0(newAttributes), this.f147570c);
    }
    ...
    public AbbreviatedType R0(boolean z10) {
        return new AbbreviatedType(T0().R0(z10), this.f147570c.R0(z10));
    }
    ...
    public AbbreviatedType U0(KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        KotlinType kotlinTypeA2 = kotlinTypeRefiner.a(this.f147570c);
    ...
    public AbbreviatedType V0(SimpleType delegate) {
        Intrinsics.j(delegate, "delegate");
        return new AbbreviatedType(delegate, this.f147570c);
    }
