...
public final class ErrorFunctionDescriptor extends SimpleFunctionDescriptorImpl {
    ...
    public ErrorFunctionDescriptor(ClassDescriptor containingDeclaration) {
        super(containingDeclaration, null, Annotations.f144596s3.b(), Name.u(ErrorEntity.f147768c.b()), CallableMemberDescriptor.Kind.DECLARATION, SourceElement.f144554a);
        Intrinsics.j(containingDeclaration, "containingDeclaration");
        O0(null, null, CollectionsKt.m(), CollectionsKt.m(), CollectionsKt.m(), ErrorUtils.d(ErrorTypeKind.f147863k, new String[0]), Modality.f144528d, DescriptorVisibilities.f144507e);
    }
