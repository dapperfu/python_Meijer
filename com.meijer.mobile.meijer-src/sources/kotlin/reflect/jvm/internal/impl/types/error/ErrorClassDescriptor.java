...
public final class ErrorClassDescriptor extends ClassDescriptorImpl {
    ...
    public ErrorClassDescriptor(Name name) {
        ...
        Modality modality = Modality.f144528d;
        ClassKind classKind = ClassKind.f144492b;
        List listM = CollectionsKt.m();
        SourceElement sourceElement = SourceElement.f144554a;
        super(moduleDescriptorI, name, modality, classKind, listM, sourceElement, false, LockBasedStorageManager.f147540e);
        ClassConstructorDescriptorImpl classConstructorDescriptorImplK1 = ClassConstructorDescriptorImpl.k1(this, Annotations.f144596s3.b(), true, sourceElement);
        classConstructorDescriptorImplK1.n1(CollectionsKt.m(), DescriptorVisibilities.f144506d);
        Intrinsics.i(classConstructorDescriptorImplK1, "apply(...)");
        MemberScope memberScopeB = ErrorUtils.b(ErrorScopeKind.f147795j, classConstructorDescriptorImplK1.getName().toString(), "");
        ErrorTypeKind errorTypeKind = ErrorTypeKind.f147880s0;
    ...
    public MemberScope e0(TypeSubstitution typeSubstitution, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        return ErrorUtils.b(ErrorScopeKind.f147795j, getName().toString(), typeSubstitution.toString());
    }
