...
public final class IntersectionTypeConstructor implements TypeConstructor, IntersectionTypeConstructorMarker {
    ...
    private KotlinType f147616a;

    /* renamed from: b, reason: collision with root package name */
    private final LinkedHashSet<KotlinType> f147617b;

    /* renamed from: c, reason: collision with root package name */
    private final int f147618c;
    ...
    public IntersectionTypeConstructor(Collection<? extends KotlinType> typesToIntersect) {
        ...
        this.f147617b = linkedHashSet;
        this.f147618c = linkedHashSet.hashCode();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof IntersectionTypeConstructor) {
            return Intrinsics.e(this.f147617b, ((IntersectionTypeConstructor) obj).f147617b);
        }
        return false;
    }

    public int hashCode() {
        return this.f147618c;
    }

    public final MemberScope i() {
        return TypeIntersectionScope.f147211d.a("member scope for intersection type", this.f147617b);
    }

    public final SimpleType j() {
        return KotlinTypeFactory.n(TypeAttributes.f147647b.k(), this, CollectionsKt.m(), false, i(), new m(this));
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
    public KotlinBuiltIns l() {
        KotlinBuiltIns kotlinBuiltInsL = this.f147617b.iterator().next().K0().l();
        Intrinsics.i(kotlinBuiltInsL, "getBuiltIns(...)");
        return kotlinBuiltInsL;
    }

    public final KotlinType m() {
        return this.f147616a;
    }
    ...
    public final String n(final Function1<? super KotlinType, ? extends Object> getProperTypeRelatedToStringify) {
        ...
        return CollectionsKt.B0(CollectionsKt.Z0(this.f147617b, new Comparator() { // from class: kotlin.reflect.jvm.internal.impl.types.IntersectionTypeConstructor$makeDebugNameForIntersectionType$$inlined$sortedBy$1
            /* JADX WARN: Multi-variable type inference failed */
    ...
    public final IntersectionTypeConstructor s(KotlinType kotlinType) {
        return new IntersectionTypeConstructor(this.f147617b, kotlinType);
    }
