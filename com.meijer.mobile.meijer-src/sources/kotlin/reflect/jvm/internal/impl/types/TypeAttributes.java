...
public final class TypeAttributes extends AttributeArrayOwner<TypeAttribute<?>, TypeAttribute<?>> implements Iterable<TypeAttribute<?>>, KMappedMarker {
    ...
    public static final Companion f147647b = new Companion(null);

    /* renamed from: c, reason: collision with root package name */
    private static final TypeAttributes f147648c = new TypeAttributes((List<? extends TypeAttribute<?>>) CollectionsKt.m());
    ...
    public static final class Companion extends TypeRegistry<TypeAttribute<?>, TypeAttribute<?>> {
        ...
        public final TypeAttributes k() {
            return TypeAttributes.f147648c;
        }
    }
    ...
    public final TypeAttributes p(TypeAttributes other) {
        ...
        Iterator it = f147647b.h().iterator();
        while (it.hasNext()) {
    ...
    public final TypeAttributes s(TypeAttribute<?> attribute) {
        ...
        return f147647b.j(CollectionsKt.Q0(CollectionsKt.j1(this), attribute));
    }
