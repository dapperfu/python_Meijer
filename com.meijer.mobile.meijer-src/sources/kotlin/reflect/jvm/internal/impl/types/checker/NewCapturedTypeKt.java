...
public final class NewCapturedTypeKt {
    ...
    private static final List<TypeProjection> a(UnwrappedType unwrappedType, CaptureStatus captureStatus) {
        ...
        if (!(list instanceof Collection) || !list.isEmpty()) {
            ...
            while (it.hasNext()) {
                if (((TypeProjection) it.next()).c() != Variance.f147703e) {
                    ...
                    for (Pair pair : listU1) {
                        ...
                        if (typeProjectionD.c() != Variance.f147703e) {
                            if (!typeProjectionD.a() && typeProjectionD.c() == Variance.f147704f) {
                    ...
                    TypeSubstitutor typeSubstitutorC = TypeConstructorSubstitution.f147669c.b(unwrappedType.K0(), arrayList).c();
                    ...
                    for (int i10 = 0; i10 < size; i10++) {
                        ...
                        if (typeProjection.c() != Variance.f147703e) {
                            ...
                            while (it2.hasNext()) {
                                arrayList2.add(KotlinTypePreparator.Default.f147724a.a(typeSubstitutorC.n((KotlinType) it2.next(), Variance.f147703e).N0()));
                            }
                            if (!typeProjection.a() && typeProjection.c() == Variance.f147705g) {
                                arrayList2.add(KotlinTypePreparator.Default.f147724a.a(typeProjection.getType().N0()));
                            }
