...
public final class AbstractNullabilityChecker {
    ...
    public static final AbstractNullabilityChecker f147571a = new AbstractNullabilityChecker();
    ...
    public final boolean a(TypeCheckerState typeCheckerState, RigidTypeMarker type, TypeCheckerState.SupertypesPolicy supertypesPolicy) {
        ...
        while (!arrayDequeH.isEmpty()) {
            ...
            if (setI.add(rigidTypeMarkerPop)) {
                TypeCheckerState.SupertypesPolicy supertypesPolicy2 = typeSystemContextJ.E0(rigidTypeMarkerPop) ? TypeCheckerState.SupertypesPolicy.None.f147667a : supertypesPolicy;
                if (Intrinsics.e(supertypesPolicy2, TypeCheckerState.SupertypesPolicy.None.f147667a)) {
    ...
    public final boolean b(TypeCheckerState state, RigidTypeMarker start, TypeConstructorMarker end) {
        ...
        while (!arrayDequeH.isEmpty()) {
            ...
            Intrinsics.g(rigidTypeMarkerPop);
            if (setI.add(rigidTypeMarkerPop)) {
                TypeCheckerState.SupertypesPolicy supertypesPolicy = typeSystemContextJ.E0(rigidTypeMarkerPop) ? TypeCheckerState.SupertypesPolicy.None.f147667a : TypeCheckerState.SupertypesPolicy.LowerIfFlexible.f147666a;
                ...
                if (supertypesPolicy == null) {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (f147571a.c(state, rigidTypeMarkerA, end)) {
                            state.e();
                            return true;
                        }
                        arrayDequeH.add(rigidTypeMarkerA);
    ...
    private final boolean e(TypeCheckerState typeCheckerState, RigidTypeMarker rigidTypeMarker, RigidTypeMarker rigidTypeMarker2) {
        TypeSystemContext typeSystemContextJ = typeCheckerState.j();
        if (AbstractTypeChecker.f147578b) {
        ...
        AbstractNullabilityChecker abstractNullabilityChecker = f147571a;
        if (abstractNullabilityChecker.a(typeCheckerState, rigidTypeMarker, TypeCheckerState.SupertypesPolicy.LowerIfFlexible.f147666a)) {
            return true;
        }
        if (typeSystemContextJ.n(rigidTypeMarker2) || abstractNullabilityChecker.a(typeCheckerState, rigidTypeMarker2, TypeCheckerState.SupertypesPolicy.UpperIfFlexible.f147668a) || typeSystemContextJ.R(rigidTypeMarker)) {
            return false;
        }
