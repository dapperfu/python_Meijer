...
public final class FunctionTypesKt {
    public static final int a(KotlinType kotlinType) {
        ...
        AnnotationDescriptor annotationDescriptorI = kotlinType.getAnnotations().i(StandardNames.FqNames.f144233D);
        if (annotationDescriptorI == null) {
            return 0;
        }
        ConstantValue constantValue = (ConstantValue) MapsKt.l(annotationDescriptorI.a(), StandardNames.f144217q);
    ...
    public static final Name d(KotlinType kotlinType) {
        String strB;
        Intrinsics.j(kotlinType, "<this>");
        AnnotationDescriptor annotationDescriptorI = kotlinType.getAnnotations().i(StandardNames.FqNames.f144235E);
        if (annotationDescriptorI == null) {
            return null;
        }
    ...
    public static final List<TypeProjection> g(KotlinType kotlinType, List<? extends KotlinType> contextReceiverTypes, List<? extends KotlinType> parameterTypes, List<Name> list, KotlinType returnType, KotlinBuiltIns builtIns) {
        ...
        for (Object obj : parameterTypes) {
            ...
            if (name != null) {
                FqName fqName = StandardNames.FqNames.f144235E;
                Name name2 = StandardNames.f144213m;
                String strB = name.b();
                Intrinsics.i(strB, "asString(...)");
                Map mapG = MapsKt.g(TuplesKt.a(name2, new StringValue(strB)));
                kotlinBuiltIns = builtIns;
                kotlinTypeC = TypeUtilsKt.C(kotlinTypeC, Annotations.f144596s3.a(CollectionsKt.O0(kotlinTypeC.getAnnotations(), new BuiltInAnnotationDescriptor(kotlinBuiltIns, fqName, mapG, false, 8, null))));
            } else {
                kotlinBuiltIns = builtIns;
            }
    ...
    public static final boolean o(DeclarationDescriptor declarationDescriptor) {
        ...
        return Intrinsics.e(functionTypeKindH, FunctionTypeKind.Function.f144385f) || Intrinsics.e(functionTypeKindH, FunctionTypeKind.SuspendFunction.f144388f);
    }
    ...
    public static final boolean q(KotlinType kotlinType) {
        Intrinsics.j(kotlinType, "<this>");
        return Intrinsics.e(j(kotlinType), FunctionTypeKind.Function.f144385f);
    }

    public static final boolean r(KotlinType kotlinType) {
        Intrinsics.j(kotlinType, "<this>");
        return Intrinsics.e(j(kotlinType), FunctionTypeKind.SuspendFunction.f144388f);
    }

    public static final Annotations t(Annotations annotations, KotlinBuiltIns builtIns, int i10) {
        Intrinsics.j(annotations, "<this>");
        Intrinsics.j(builtIns, "builtIns");
        FqName fqName = StandardNames.FqNames.f144233D;
        return annotations.p3(fqName) ? annotations : Annotations.f144596s3.a(CollectionsKt.O0(annotations, new BuiltInAnnotationDescriptor(builtIns, fqName, MapsKt.g(TuplesKt.a(StandardNames.f144217q, new IntValue(i10))), false, 8, null)));
    }

    public static final Annotations u(Annotations annotations, KotlinBuiltIns builtIns) {
        Intrinsics.j(annotations, "<this>");
        Intrinsics.j(builtIns, "builtIns");
        FqName fqName = StandardNames.FqNames.f144231C;
        return annotations.p3(fqName) ? annotations : Annotations.f144596s3.a(CollectionsKt.O0(annotations, new BuiltInAnnotationDescriptor(builtIns, fqName, MapsKt.k(), false, 8, null)));
    }

    private static final FunctionTypeKind i(FqNameUnsafe fqNameUnsafe) {
        if (fqNameUnsafe.f() && !fqNameUnsafe.e()) {
            FunctionTypeKindExtractor functionTypeKindExtractorA = FunctionTypeKindExtractor.f144389c.a();
    ...
    private static final boolean s(KotlinType kotlinType) {
        if (kotlinType.getAnnotations().i(StandardNames.FqNames.f144231C) != null) {
            return true;
        }
        return false;
    }
