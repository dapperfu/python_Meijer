...
public final class JvmBuiltInsCustomizer implements AdditionalClassPartsProvider, PlatformDependentDeclarationFilter {
    ...
    static final /* synthetic */ KProperty<Object>[] f144439i = {Reflection.j(new PropertyReference1Impl(JvmBuiltInsCustomizer.class, "settings", "getSettings()Lorg/jetbrains/kotlin/builtins/jvm/JvmBuiltIns$Settings;", 0)), Reflection.j(new PropertyReference1Impl(JvmBuiltInsCustomizer.class, "cloneableType", "getCloneableType()Lorg/jetbrains/kotlin/types/SimpleType;", 0)), Reflection.j(new PropertyReference1Impl(JvmBuiltInsCustomizer.class, "notConsideredDeprecation", "getNotConsideredDeprecation()Lorg/jetbrains/kotlin/descriptors/annotations/Annotations;", 0))};

    /* renamed from: a, reason: collision with root package name */
    private final ModuleDescriptor f144440a;

    /* renamed from: b, reason: collision with root package name */
    private final JavaToKotlinClassMapper f144441b;

    /* renamed from: c, reason: collision with root package name */
    private final NotNullLazyValue f144442c;

    /* renamed from: d, reason: collision with root package name */
    private final KotlinType f144443d;

    /* renamed from: e, reason: collision with root package name */
    private final NotNullLazyValue f144444e;

    /* renamed from: f, reason: collision with root package name */
    private final CacheWithNotNullValues<FqName, ClassDescriptor> f144445f;

    /* renamed from: g, reason: collision with root package name */
    private final NotNullLazyValue f144446g;

    /* renamed from: h, reason: collision with root package name */
    private final MemoizedFunctionToNotNull<Pair<String, String>, Annotations> f144447h;
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            try {
                iArr[a.f144448a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[a.f144450c.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[a.f144451d.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[a.f144452e.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                iArr[a.f144449b.ordinal()] = 5;
    ...
    static final class a {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final a f144448a = new a("HIDDEN", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final a f144449b = new a("VISIBLE", 1);

        /* renamed from: c, reason: collision with root package name */
        public static final a f144450c = new a("DEPRECATED_LIST_METHODS", 2);

        /* renamed from: d, reason: collision with root package name */
        public static final a f144451d = new a("NOT_CONSIDERED", 3);

        /* renamed from: e, reason: collision with root package name */
        public static final a f144452e = new a("DROP", 4);

        /* renamed from: f, reason: collision with root package name */
        private static final /* synthetic */ a[] f144453f;

        /* renamed from: g, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f144454g;

        private static final /* synthetic */ a[] a() {
            return new a[]{f144448a, f144449b, f144450c, f144451d, f144452e};
        }

        static {
            a[] aVarArrA = a();
            f144453f = aVarArrA;
            f144454g = EnumEntriesKt.a(aVarArrA);
        }
    ...
    public JvmBuiltInsCustomizer(ModuleDescriptor moduleDescriptor, StorageManager storageManager, Function0<JvmBuiltIns.Settings> settingsComputation) {
        ...
        this.f144440a = moduleDescriptor;
        this.f144441b = JavaToKotlinClassMapper.f144419a;
        this.f144442c = storageManager.c(settingsComputation);
        this.f144443d = q(storageManager);
        this.f144444e = storageManager.c(new f(this, storageManager));
        this.f144445f = storageManager.a();
        this.f144446g = storageManager.c(new g(this));
        this.f144447h = storageManager.i(new h(this));
    }

    private final Annotations C() {
        return (Annotations) StorageKt.a(this.f144446g, this, f144439i[2]);
    }

    private final JvmBuiltIns.Settings D() {
        return (JvmBuiltIns.Settings) StorageKt.a(this.f144442c, this, f144439i[0]);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Annotations I(JvmBuiltInsCustomizer jvmBuiltInsCustomizer) {
        return Annotations.f144596s3.a(CollectionsKt.e(AnnotationUtilKt.c(jvmBuiltInsCustomizer.f144440a.l(), "This member is not fully supported by Kotlin compiler, so it may be absent or have different signature in next major version", null, null, true, 6, null)));
    }

    private final KotlinType q(StorageManager storageManager) {
        final ModuleDescriptor moduleDescriptor = this.f144440a;
        ...
        }, Name.o("Serializable"), Modality.f144529e, ClassKind.f144493c, CollectionsKt.e(new LazyWrappedType(storageManager, new i(this))), SourceElement.f144554a, false, storageManager);
        classDescriptorImpl.H0(MemberScope.Empty.f147200b, SetsKt.e(), null);
    ...
    public static final KotlinType r(JvmBuiltInsCustomizer jvmBuiltInsCustomizer) {
        SimpleType simpleTypeI = jvmBuiltInsCustomizer.f144440a.l().i();
    ...
    public static final Annotations s(JvmBuiltInsCustomizer jvmBuiltInsCustomizer, Pair pair) {
        ...
        return Annotations.f144596s3.a(CollectionsKt.e(AnnotationUtilKt.b(jvmBuiltInsCustomizer.f144440a.l(), '\'' + str + "()' member of List is redundant in Kotlin and might be removed soon. Please use '" + str2 + "()' stdlib extension instead", str2 + "()", "HIDDEN", false)));
    }
    ...
    private final SimpleType v() {
        return (SimpleType) StorageKt.a(this.f144444e, this, f144439i[1]);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Collection x(Name name, MemberScope it) {
        Intrinsics.j(it, "it");
        return it.b(name, NoLookupLocation.f145025d);
    }
    ...
    public Collection<SimpleFunctionDescriptor> a(Name name, ClassDescriptor classDescriptor) {
        ...
        if (Intrinsics.e(name, CloneableClassScope.f144395e.a()) && (classDescriptor instanceof DeserializedClassDescriptor) && KotlinBuiltIns.e0(classDescriptor)) {
            ...
            if (!(list instanceof Collection) || !list.isEmpty()) {
                ...
                while (it.hasNext()) {
                    if (Intrinsics.e(NameResolverUtilKt.b(deserializedClassDescriptor.a1().g(), ((ProtoBuf.Function) it.next()).i0()), CloneableClassScope.f144395e.a())) {
                        return CollectionsKt.m();
                    }
                }
            }
            return CollectionsKt.e(p(deserializedClassDescriptor, (SimpleFunctionDescriptor) CollectionsKt.T0(v().n().b(name, NoLookupLocation.f145025d))));
        }
        if (!D().b()) {
            return CollectionsKt.m();
        }
        ...
        for (SimpleFunctionDescriptor simpleFunctionDescriptor : collectionT) {
            ...
            if (i10 != 1) {
                if (i10 == 2) {
                    ...
                    if (Intrinsics.e(name2, JvmBuiltInsCustomizerKt.f144457a)) {
                        annotationsInvoke = this.f144447h.invoke(TuplesKt.a(simpleFunctionDescriptor.getName().b(), "first"));
                    } else {
                        if (!Intrinsics.e(name2, JvmBuiltInsCustomizerKt.f144458b)) {
                            throw new IllegalStateException(("Unexpected name: " + simpleFunctionDescriptor.getName()).toString());
                        }
                        annotationsInvoke = this.f144447h.invoke(TuplesKt.a(simpleFunctionDescriptor.getName().b(), "last"));
                    }
    ...
    public boolean b(ClassDescriptor classDescriptor, SimpleFunctionDescriptor functionDescriptor) {
        ...
        Collection<SimpleFunctionDescriptor> collectionB = lazyJavaClassMemberScopeR0.b(name, NoLookupLocation.f145025d);
    ...
    public Collection<ClassConstructorDescriptor> c(ClassDescriptor classDescriptor) {
        Intrinsics.j(classDescriptor, "classDescriptor");
        if (classDescriptor.f() != ClassKind.f144492b || !D().b()) {
            return CollectionsKt.m();
        }
        LazyJavaClassDescriptor lazyJavaClassDescriptorZ = z(classDescriptor);
        ...
        ClassDescriptor classDescriptorF = JavaToKotlinClassMapper.f(this.f144441b, DescriptorUtilsKt.o(lazyJavaClassDescriptorZ), FallbackBuiltIns.f144397h.a(), null, 4, null);
        ...
        for (Object obj : listO0) {
            ...
            if (classConstructorDescriptor.getVisibility().d()) {
                ...
                if (!H(classConstructorDescriptor, classDescriptor) && !KotlinBuiltIns.l0(classConstructorDescriptor) && !JvmBuiltInsSignatures.f144460a.e().contains(MethodSignatureBuildingUtilsKt.a(SignatureBuildingComponents.f145736a, lazyJavaClassDescriptorZ, MethodSignatureMappingKt.c(classConstructorDescriptor, false, false, 3, null)))) {
                    arrayList.add(obj);
                }
            }
        }
        ...
        for (ClassConstructorDescriptor classConstructorDescriptor3 : arrayList) {
            ...
            if (!JvmBuiltInsSignatures.f144460a.h().contains(MethodSignatureBuildingUtilsKt.a(SignatureBuildingComponents.f145736a, lazyJavaClassDescriptorZ, MethodSignatureMappingKt.c(classConstructorDescriptor3, false, false, 3, null)))) {
                copyBuilderT.s(C());
            }
            FunctionDescriptor functionDescriptorBuild = copyBuilderT.build();
    ...
    public Collection<KotlinType> d(ClassDescriptor classDescriptor) {
        ...
        JvmBuiltInsSignatures jvmBuiltInsSignatures = JvmBuiltInsSignatures.f144460a;
        return jvmBuiltInsSignatures.j(fqNameUnsafeP) ? CollectionsKt.p(v(), this.f144443d) : jvmBuiltInsSignatures.k(fqNameUnsafeP) ? CollectionsKt.e(this.f144443d) : CollectionsKt.m();
    }
    ...
    private final a A(FunctionDescriptor functionDescriptor) {
        ...
        Object objB = DFS.b(CollectionsKt.e((ClassDescriptor) declarationDescriptorB), new n(this), new DFS.AbstractNodeHandler<ClassDescriptor, a>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.jvm.JvmBuiltInsCustomizer$getJdkMethodStatus$2
            ...
            public boolean c(ClassDescriptor javaClassDescriptor) {
                ...
                String strA = MethodSignatureBuildingUtilsKt.a(SignatureBuildingComponents.f145736a, javaClassDescriptor, strC);
                JvmBuiltInsSignatures jvmBuiltInsSignatures = JvmBuiltInsSignatures.f144460a;
                if (jvmBuiltInsSignatures.f().contains(strA)) {
                    objectRef.f143742a = JvmBuiltInsCustomizer.a.f144448a;
                } else if (jvmBuiltInsSignatures.i().contains(strA)) {
                    objectRef.f143742a = JvmBuiltInsCustomizer.a.f144449b;
                } else if (jvmBuiltInsSignatures.c().contains(strA)) {
                    objectRef.f143742a = JvmBuiltInsCustomizer.a.f144450c;
                } else if (jvmBuiltInsSignatures.d().contains(strA)) {
                    objectRef.f143742a = JvmBuiltInsCustomizer.a.f144452e;
                }
                return objectRef.f143742a == null;
            }

            @Override // kotlin.reflect.jvm.internal.impl.utils.DFS.NodeHandler
            /* renamed from: e, reason: merged with bridge method [inline-methods] */
            public JvmBuiltInsCustomizer.a a() {
                JvmBuiltInsCustomizer.a aVar = objectRef.f143742a;
                return aVar == null ? JvmBuiltInsCustomizer.a.f144451d : aVar;
            }
        });
    ...
    private final boolean E(SimpleFunctionDescriptor simpleFunctionDescriptor, boolean z10) {
        ...
        if (z10 ^ JvmBuiltInsSignatures.f144460a.g().contains(MethodSignatureBuildingUtilsKt.a(SignatureBuildingComponents.f145736a, (ClassDescriptor) declarationDescriptorB, strC))) {
            return true;
        }
        Boolean boolE = DFS.e(CollectionsKt.e(simpleFunctionDescriptor), l.f144484a, new m(this));
    ...
    */
    public static final java.lang.Boolean G(kotlin.reflect.jvm.internal.impl.builtins.jvm.JvmBuiltInsCustomizer r2, kotlin.reflect.jvm.internal.impl.descriptors.CallableMemberDescriptor r3) {
        /*
            ...
            if (r0 != r1) goto L1d
            kotlin.reflect.jvm.internal.impl.builtins.jvm.JavaToKotlinClassMapper r2 = r2.f144441b
    ...
    public static final SimpleType o(JvmBuiltInsCustomizer jvmBuiltInsCustomizer, StorageManager storageManager) {
        return FindClassInModuleKt.d(jvmBuiltInsCustomizer.D().a(), JvmBuiltInClassDescriptorFactory.f144420d.a(), new NotFoundClasses(storageManager, jvmBuiltInsCustomizer.D().a())).o();
    }
    ...
    private final SimpleFunctionDescriptor p(DeserializedClassDescriptor deserializedClassDescriptor, SimpleFunctionDescriptor simpleFunctionDescriptor) {
        ...
        copyBuilderT.h(DescriptorVisibilities.f144507e);
    ...
    private final Collection<SimpleFunctionDescriptor> t(ClassDescriptor classDescriptor, Function1<? super MemberScope, ? extends Collection<? extends SimpleFunctionDescriptor>> function1) {
        ...
        Collection<ClassDescriptor> collectionG = this.f144441b.g(DescriptorUtilsKt.o(lazyJavaClassDescriptorZ), FallbackBuiltIns.f144397h.a());
        ...
        boolean zC = this.f144441b.c(classDescriptor);
        MemberScope memberScopeU = this.f144445f.a(DescriptorUtilsKt.o(lazyJavaClassDescriptorZ), new k(lazyJavaClassDescriptorZ, classDescriptor2)).U();
    ...
    private final LazyJavaClassDescriptor z(ClassDescriptor classDescriptor) {
        ...
        FqNameUnsafe fqNameUnsafeP = DescriptorUtilsKt.p(classDescriptor);
        if (fqNameUnsafeP.f() && (classIdN = JavaToKotlinClassMap.f144399a.n(fqNameUnsafeP)) != null && (fqNameA = classIdN.a()) != null) {
            ClassDescriptor classDescriptorD = DescriptorUtilKt.d(D().a(), fqNameA, NoLookupLocation.f145025d);
