...
public final class FunctionInvokeDescriptor extends SimpleFunctionDescriptorImpl {
    ...
    public static final Factory f144379E = new Factory(null);
    ...
    public static final class Factory {
        ...
        public final FunctionInvokeDescriptor a(FunctionClassDescriptor functionClass, boolean z10) {
            ...
            for (Object obj : listP) {
                if (((TypeParameterDescriptor) obj).k() != Variance.f147704f) {
                    break;
                }
                arrayList.add(obj);
            }
            ...
            for (IndexedValue indexedValue : iterableS1) {
                arrayList2.add(FunctionInvokeDescriptor.f144379E.b(functionInvokeDescriptor, indexedValue.c(), (TypeParameterDescriptor) indexedValue.d()));
            }
            functionInvokeDescriptor.O0(null, receiverParameterDescriptorG0, listM, listM2, arrayList2, ((TypeParameterDescriptor) CollectionsKt.D0(listP)).o(), Modality.f144529e, DescriptorVisibilities.f144507e);
    ...
    private FunctionInvokeDescriptor(DeclarationDescriptor declarationDescriptor, FunctionInvokeDescriptor functionInvokeDescriptor, CallableMemberDescriptor.Kind kind, boolean z10) {
        super(declarationDescriptor, functionInvokeDescriptor, Annotations.f144596s3.b(), OperatorNameConventions.f148026i, kind, SourceElement.f144554a);
        c1(true);
        e1(z10);
        V0(false);
    }
    ...
    private final FunctionDescriptor m1(List<Name> list) {
        ...
        FunctionDescriptorImpl.CopyConfiguration copyConfigurationP0 = P0(TypeSubstitutor.f147687b);
