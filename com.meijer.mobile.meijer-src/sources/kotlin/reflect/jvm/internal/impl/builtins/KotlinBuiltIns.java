...
public abstract class KotlinBuiltIns {
    ...
    public static final Name f144147g = Name.u("<built-ins module>");

    /* renamed from: a, reason: collision with root package name */
    private ModuleDescriptorImpl f144148a;

    /* renamed from: b, reason: collision with root package name */
    private NotNullLazyValue<ModuleDescriptorImpl> f144149b;

    /* renamed from: c, reason: collision with root package name */
    private final NotNullLazyValue<e> f144150c;

    /* renamed from: d, reason: collision with root package name */
    private final NotNullLazyValue<Collection<PackageViewDescriptor>> f144151d;

    /* renamed from: e, reason: collision with root package name */
    private final MemoizedFunctionToNotNull<Name, ClassDescriptor> f144152e;

    /* renamed from: f, reason: collision with root package name */
    private final StorageManager f144153f;
    ...
    class a implements Function0<Collection<PackageViewDescriptor>> {
        ...
        public Collection<PackageViewDescriptor> invoke() {
            return Arrays.asList(KotlinBuiltIns.this.s().i0(StandardNames.f144191A), KotlinBuiltIns.this.s().i0(StandardNames.f144193C), KotlinBuiltIns.this.s().i0(StandardNames.f144194D), KotlinBuiltIns.this.s().i0(StandardNames.f144192B));
        }
    }
    ...
    class c implements Function1<Name, ClassDescriptor> {
        ...
        public ClassDescriptor invoke(Name name) {
            ClassifierDescriptor classifierDescriptorF = KotlinBuiltIns.this.t().f(name, NoLookupLocation.f145025d);
            if (classifierDescriptorF == null) {
                throw new AssertionError("Built-in class " + StandardNames.f144191A.b(name) + " is not found");
            }
    ...
    class d implements Function0<Void> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ ModuleDescriptorImpl f144157a;

        d(ModuleDescriptorImpl moduleDescriptorImpl) {
            this.f144157a = moduleDescriptorImpl;
        }

        @Override // kotlin.jvm.functions.Function0
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public Void invoke() {
            if (KotlinBuiltIns.this.f144148a == null) {
                KotlinBuiltIns.this.f144148a = this.f144157a;
                return null;
            }
            throw new AssertionError("Built-ins module is already set: " + KotlinBuiltIns.this.f144148a + " (attempting to reset to " + this.f144157a + ")");
        }
    }
    ...
    private static class e {
        ...
        /* renamed from: a, reason: collision with root package name */
        public final Map<PrimitiveType, SimpleType> f144159a;

        /* renamed from: b, reason: collision with root package name */
        public final Map<KotlinType, SimpleType> f144160b;

        /* renamed from: c, reason: collision with root package name */
        public final Map<SimpleType, SimpleType> f144161c;
    ...
    */
    ...
    protected KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.f144153f = storageManager;
        this.f144151d = storageManager.c(new a());
        this.f144150c = storageManager.c(new b());
        this.f144152e = storageManager.i(new c());
    }
    ...
    public static boolean A0(KotlinType kotlinType) {
        ...
        return j0(kotlinType, StandardNames.FqNames.f144248K0.i());
    }
    ...
    private static KotlinType B(KotlinType kotlinType, ModuleDescriptor moduleDescriptor) {
        ...
        UnsignedTypes unsignedTypes = UnsignedTypes.f144345a;
    ...
    public static boolean B0(KotlinType kotlinType) {
        ...
        return j0(kotlinType, StandardNames.FqNames.f144244I0.i());
    }
    ...
    public static boolean C0(DeclarationDescriptor declarationDescriptor) {
        ...
        while (declarationDescriptor != null) {
            if (declarationDescriptor instanceof PackageFragmentDescriptor) {
                return ((PackageFragmentDescriptor) declarationDescriptor).e().h(StandardNames.f144226z);
            }
    ...
    public static boolean D0(KotlinType kotlinType) {
        ...
        return n0(kotlinType, StandardNames.FqNames.f144285f);
    }
    ...
    public static PrimitiveType Q(DeclarationDescriptor declarationDescriptor) {
        ...
        if (StandardNames.FqNames.f144266T0.contains(declarationDescriptor.getName())) {
            return StandardNames.FqNames.f144270V0.get(DescriptorUtils.m(declarationDescriptor));
        }
        return null;
    }
    ...
    public static PrimitiveType T(DeclarationDescriptor declarationDescriptor) {
        ...
        if (StandardNames.FqNames.f144264S0.contains(declarationDescriptor.getName())) {
            return StandardNames.FqNames.f144268U0.get(DescriptorUtils.m(declarationDescriptor));
        }
        return null;
    }
    ...
    public static boolean b0(ClassDescriptor classDescriptor) {
        ...
        return e(classDescriptor, StandardNames.FqNames.f144277b);
    }
    ...
    public static boolean c0(KotlinType kotlinType) {
        ...
        return i0(kotlinType, StandardNames.FqNames.f144277b);
    }
    ...
    public static boolean d0(KotlinType kotlinType) {
        ...
        return i0(kotlinType, StandardNames.FqNames.f144291i);
    }
    ...
    public static boolean e0(ClassDescriptor classDescriptor) {
        ...
        return e(classDescriptor, StandardNames.FqNames.f144291i) || Q(classDescriptor) != null;
    }
    ...
    public static boolean g0(KotlinType kotlinType) {
        ...
        return j0(kotlinType, StandardNames.FqNames.f144293j);
    }
    ...
    public static boolean l0(DeclarationDescriptor declarationDescriptor) {
        ...
        if (declarationDescriptor.H0().getAnnotations().p3(StandardNames.FqNames.f144323y)) {
            return true;
        }
    ...
    public static boolean m0(ClassDescriptor classDescriptor) {
        ...
        return e(classDescriptor, StandardNames.FqNames.f144298l0);
    }
    ...
    public static boolean p0(KotlinType kotlinType) {
        ...
        return i0(kotlinType, StandardNames.FqNames.f144279c);
    }
    ...
    private ClassDescriptor q(String str) {
        ...
        ClassDescriptor classDescriptorInvoke = this.f144152e.invoke(Name.o(str));
    ...
    public static boolean v0(ClassDescriptor classDescriptor) {
        ...
        return e(classDescriptor, StandardNames.FqNames.f144277b) || e(classDescriptor, StandardNames.FqNames.f144279c);
    }

    public static boolean w0(KotlinType kotlinType) {
        return kotlinType != null && n0(kotlinType, StandardNames.FqNames.f144289h);
    }
    ...
    public static boolean y0(KotlinType kotlinType) {
        ...
        return j0(kotlinType, StandardNames.FqNames.f144242H0.i());
    }
    ...
    public static boolean z0(KotlinType kotlinType) {
        ...
        return j0(kotlinType, StandardNames.FqNames.f144246J0.i());
    }

    public SimpleType A() {
        SimpleType simpleTypeS = S(PrimitiveType.f144171n);
        if (simpleTypeS == null) {
            a(62);
        }
        return simpleTypeS;
    ...
    public SimpleType C() {
        SimpleType simpleTypeS = S(PrimitiveType.f144169l);
        if (simpleTypeS == null) {
            a(61);
        }
        return simpleTypeS;
    ...
    public SimpleType E() {
        SimpleType simpleTypeS = S(PrimitiveType.f144168k);
        if (simpleTypeS == null) {
            a(59);
        }
        return simpleTypeS;
    ...
    public ClassDescriptor F() {
        ClassDescriptor classDescriptorP = p(StandardNames.FqNames.f144298l0.m());
    ...
    public void F0(ModuleDescriptorImpl moduleDescriptorImpl) {
        ...
        this.f144153f.d(new d(moduleDescriptorImpl));
    }

    public SimpleType G() {
        SimpleType simpleTypeS = S(PrimitiveType.f144170m);
        if (simpleTypeS == null) {
            a(60);
        }
        return simpleTypeS;
    ...
    protected PlatformDependentDeclarationFilter N() {
        PlatformDependentDeclarationFilter.NoPlatformDependent noPlatformDependent = PlatformDependentDeclarationFilter.NoPlatformDependent.f144687a;
    ...
    public SimpleType P(PrimitiveType primitiveType) {
        ...
        SimpleType simpleType = this.f144150c.invoke().f144159a.get(primitiveType);
        if (simpleType == null) {
            a(74);
        }
        return simpleType;
    ...
    public SimpleType U() {
        SimpleType simpleTypeS = S(PrimitiveType.f144167j);
        if (simpleTypeS == null) {
            a(58);
        }
        return simpleTypeS;
    ...
    protected StorageManager V() {
        StorageManager storageManager = this.f144153f;
        if (storageManager == null) {
            a(6);
        }
    ...
    public ClassDescriptor Y(int i10) {
        ClassDescriptor classDescriptorP = p(StandardNames.f144219s.b(Name.o(StandardNames.d(i10))));
        if (classDescriptorP == null) {
            a(18);
        }
        return classDescriptorP;
    ...
    protected void f(boolean z10) {
        ModuleDescriptorImpl moduleDescriptorImpl = new ModuleDescriptorImpl(f144147g, this.f144153f, this, null);
        this.f144148a = moduleDescriptorImpl;
        moduleDescriptorImpl.L0(BuiltInsLoader.f144140a.c().a(this.f144153f, this.f144148a, w(), N(), g(), z10));
        ModuleDescriptorImpl moduleDescriptorImpl2 = this.f144148a;
        moduleDescriptorImpl2.T0(moduleDescriptorImpl2);
    }

    protected AdditionalClassPartsProvider g() {
        AdditionalClassPartsProvider.None none = AdditionalClassPartsProvider.None.f144685a;
        if (none == null) {
            a(3);
        }
        return none;
    ...
    public KotlinType l(KotlinType kotlinType) {
        ...
        SimpleType simpleType = this.f144150c.invoke().f144161c.get(kotlinTypeN);
        if (simpleType != null) {
            return simpleType;
        }
    ...
    public SimpleType m(Variance variance, KotlinType kotlinType) {
        ...
        SimpleType simpleTypeN = n(variance, kotlinType, Annotations.f144596s3.b());
        if (simpleTypeN == null) {
            a(84);
        }
        return simpleTypeN;
    ...
    public SimpleType o() {
        SimpleType simpleTypeS = S(PrimitiveType.f144164g);
        if (simpleTypeS == null) {
            a(64);
        }
        return simpleTypeS;
    ...
    public ClassDescriptor p(FqName fqName) {
        ...
        ClassDescriptor classDescriptorD = DescriptorUtilKt.d(s(), fqName, NoLookupLocation.f145025d);
    ...
    public ModuleDescriptorImpl s() {
        if (this.f144148a == null) {
            this.f144148a = this.f144149b.invoke();
        }
        ModuleDescriptorImpl moduleDescriptorImpl = this.f144148a;
        if (moduleDescriptorImpl == null) {
            a(7);
        }
    ...
    public SimpleType u() {
        SimpleType simpleTypeS = S(PrimitiveType.f144166i);
        if (simpleTypeS == null) {
            a(57);
        }
        return simpleTypeS;
    ...
    public SimpleType v() {
        SimpleType simpleTypeS = S(PrimitiveType.f144165h);
        if (simpleTypeS == null) {
            a(63);
        }
        return simpleTypeS;
    ...
    protected Iterable<ClassDescriptorFactory> w() {
        List listSingletonList = Collections.singletonList(new BuiltInFictitiousFunctionClassFactory(this.f144153f, s()));
    ...
    public ClassDescriptor x() {
        ClassDescriptor classDescriptorP = p(StandardNames.FqNames.f144272X);
        if (classDescriptorP == null) {
            a(35);
        }
        return classDescriptorP;
    ...
    public MemberScope t() {
        MemberScope memberScopeN = s().i0(StandardNames.f144191A).n();
