...
public final class BuiltInFictitiousFunctionClassFactory implements ClassDescriptorFactory {
    ...
    private final StorageManager f144357a;

    /* renamed from: b, reason: collision with root package name */
    private final ModuleDescriptor f144358b;

    public BuiltInFictitiousFunctionClassFactory(StorageManager storageManager, ModuleDescriptor module) {
        Intrinsics.j(storageManager, "storageManager");
        Intrinsics.j(module, "module");
        this.f144357a = storageManager;
        this.f144358b = module;
    }
    ...
    public boolean b(FqName packageFqName, Name name) {
        ...
        return (StringsKt.W(strB, "Function", false, 2, null) || StringsKt.W(strB, "KFunction", false, 2, null) || StringsKt.W(strB, "SuspendFunction", false, 2, null) || StringsKt.W(strB, "KSuspendFunction", false, 2, null)) && FunctionTypeKindExtractor.f144389c.a().c(packageFqName, strB) != null;
    }
    ...
    public ClassDescriptor c(ClassId classId) {
        ...
        if (!StringsKt.d0(strA, "Function", false, 2, null) || (kindWithArityC = FunctionTypeKindExtractor.f144389c.a().c((fqNameF = classId.f()), strA)) == null) {
            return null;
        }
        FunctionTypeKind functionTypeKindA = kindWithArityC.a();
        int iB = kindWithArityC.b();
        List<PackageFragmentDescriptor> listF0 = this.f144358b.i0(fqNameF).f0();
        ...
        return new FunctionClassDescriptor(this.f144357a, packageFragmentDescriptor, functionTypeKindA, iB);
    }
}
