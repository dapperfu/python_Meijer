...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    private final DescriptorRendererOptionsImpl f146905m;

    /* renamed from: n, reason: collision with root package name */
    private final Lazy f146906n;
    ...
    private final class RenderDeclarationDescriptorVisitor implements DeclarationDescriptorVisitor<Unit, StringBuilder> {
        ...
        public /* synthetic */ class WhenMappings {
            ...
            static {
                ...
                try {
                    iArr[PropertyAccessorRenderingPolicy.f146994a.ordinal()] = 1;
                } catch (NoSuchFieldError unused) {
                }
                try {
                    iArr[PropertyAccessorRenderingPolicy.f146995b.ordinal()] = 2;
                } catch (NoSuchFieldError unused2) {
                }
                try {
                    iArr[PropertyAccessorRenderingPolicy.f146996c.ordinal()] = 3;
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            try {
                iArr[RenderingFormat.f146999a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[RenderingFormat.f147000b.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            $EnumSwitchMapping$0 = iArr;
            int[] iArr2 = new int[ParameterNameRenderingPolicy.values().length];
            try {
                iArr2[ParameterNameRenderingPolicy.f146989a.ordinal()] = 1;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr2[ParameterNameRenderingPolicy.f146990b.ordinal()] = 2;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                iArr2[ParameterNameRenderingPolicy.f146991c.ordinal()] = 3;
    ...
    */
    ...
    private final void K1(List<? extends ReceiverParameterDescriptor> list, StringBuilder sb2) {
        ...
        for (ReceiverParameterDescriptor receiverParameterDescriptor : list) {
            int i11 = i10 + 1;
            A1(sb2, receiverParameterDescriptor, AnnotationUseSiteTarget.f144584h);
    ...
    private final void L1(StringBuilder sb2, KotlinType kotlinType) {
        ...
        if (KotlinTypeKt.a(kotlinType)) {
            if (TypeUtilsKt.z(kotlinType) && P0()) {
                sb2.append(M1(ErrorUtils.f147897a.p(kotlinType)));
            } else {
    ...
    public Function1<ValueParameterDescriptor, String> A0() {
        return this.f146905m.B();
    }

    public boolean B0() {
        return this.f146905m.C();
    }

    public Set<FqName> C0() {
        return this.f146905m.D();
    }

    public boolean E0() {
        return this.f146905m.E();
    }

    public boolean F0() {
        return this.f146905m.F();
    }

    public boolean G0() {
        return this.f146905m.G();
    }

    public boolean H0() {
        return this.f146905m.H();
    }

    public boolean I0() {
        return this.f146905m.I();
    }

    public Set<DescriptorRendererModifier> J0() {
        return this.f146905m.J();
    }

    public boolean K0() {
        return this.f146905m.K();
    }

    public OverrideRenderingPolicy M0() {
        return this.f146905m.L();
    }

    public ParameterNameRenderingPolicy N0() {
        return this.f146905m.M();
    }

    public boolean O0() {
        return this.f146905m.N();
    }

    public boolean P0() {
        return this.f146905m.O();
    }

    public PropertyAccessorRenderingPolicy Q0() {
        return this.f146905m.P();
    }

    public boolean R0() {
        return this.f146905m.R();
    }

    public boolean S0() {
        return this.f146905m.S();
    }

    public boolean T0() {
        return this.f146905m.T();
    }

    public boolean U0() {
        return this.f146905m.U();
    }

    public boolean V0() {
        return this.f146905m.V();
    }

    public boolean W0() {
        return this.f146905m.W();
    }

    public boolean X0() {
        return this.f146905m.X();
    }

    public boolean Y0() {
        return this.f146905m.Y();
    }

    public boolean Z0() {
        return this.f146905m.Z();
    }
    ...
    public boolean a1() {
        return this.f146905m.a0();
    }

    @Override // kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererOptions
    public void b(ParameterNameRenderingPolicy parameterNameRenderingPolicy) {
        Intrinsics.j(parameterNameRenderingPolicy, "<set-?>");
        this.f146905m.b(parameterNameRenderingPolicy);
    }

    public boolean b1() {
        return this.f146905m.b0();
    }
    ...
    public void h(AnnotationArgumentsRenderingPolicy annotationArgumentsRenderingPolicy) {
        ...
        this.f146905m.h(annotationArgumentsRenderingPolicy);
    }

    public boolean h1() {
        return this.f146905m.h0();
    }
    ...
    public void setDebugMode(boolean z10) {
        this.f146905m.setDebugMode(z10);
    }
    ...
    public ClassifierNamePolicy z0() {
        return this.f146905m.A();
    }

    public DescriptorRendererImpl(DescriptorRendererOptionsImpl options) {
        Intrinsics.j(options, "options");
        this.f146905m = options;
        options.q0();
        this.f146906n = LazyKt.b(new l(this));
    }
    ...
    */
    ...
    private final DescriptorRendererImpl D0() {
        return (DescriptorRendererImpl) this.f146906n.getValue();
    }

    private final void E1(ClassDescriptor classDescriptor, StringBuilder sb2) {
        sb2.append(T1(DescriptorRenderer.f146892a.a(classDescriptor)));
    }

    private final String H1(ConstantValue<?> constantValue) {
        Function1<ConstantValue<?>, String> function1Q = this.f146905m.Q();
        if (function1Q != null) {
        ...
        if (constantValue instanceof AnnotationValue) {
            return StringsKt.K0(DescriptorRenderer.P(this, ((AnnotationValue) constantValue).b(), null, 2, null), "@");
        }
    ...
    private final void m2(StringBuilder sb2, SimpleType simpleType) {
        if (Intrinsics.e(simpleType, TypeUtils.f147699b) || TypeUtils.k(simpleType)) {
            sb2.append("???");
            return;
        }
    ...
    public static final DescriptorRendererImpl s0(DescriptorRendererImpl descriptorRendererImpl) {
        DescriptorRenderer descriptorRendererV = descriptorRendererImpl.V(q.f147019a);
    ...
    private final Modality s1(MemberDescriptor memberDescriptor) {
        if (memberDescriptor instanceof ClassDescriptor) {
            return ((ClassDescriptor) memberDescriptor).f() == ClassKind.f144493c ? Modality.f144529e : Modality.f144526b;
        }
        ...
        if (!collectionD.isEmpty() && classDescriptor.q() != Modality.f144526b) {
            return Modality.f144528d;
        }
        if (classDescriptor.f() != ClassKind.f144493c || Intrinsics.e(callableMemberDescriptor.getVisibility(), DescriptorVisibilities.f144503a)) {
            return Modality.f144526b;
        }
        Modality modalityQ = callableMemberDescriptor.q();
        Modality modality = Modality.f144529e;
        return modalityQ == modality ? modality : Modality.f144528d;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit t0(DescriptorRendererOptions withOptions) {
        Intrinsics.j(withOptions, "$this$withOptions");
        withOptions.l(SetsKt.l(withOptions.i(), CollectionsKt.p(StandardNames.FqNames.f144231C, StandardNames.FqNames.f144233D)));
        return Unit.f143329a;
    }
    ...
    public String Q(String lowerRendered, String upperRendered, KotlinBuiltIns builtIns) {
        ...
        String strW1 = StringsKt.w1(classifierNamePolicyZ0.a(classDescriptorX, this), "Collection", null, 2, null);
        String strD = RenderingUtilsKt.d(lowerRendered, strW1 + "Mutable", upperRendered, strW1, strW1 + "(Mutable)");
        if (strD != null) {
            return strD;
        }
        String strD2 = RenderingUtilsKt.d(lowerRendered, strW1 + "MutableMap.MutableEntry", upperRendered, strW1 + "Map.Entry", strW1 + "(Mutable)Map.(Mutable)Entry");
        if (strD2 != null) {
            return strD2;
        }
        ...
        String strW12 = StringsKt.w1(classifierNamePolicyZ02.a(classDescriptorJ, this), "Array", null, 2, null);
        String strD3 = RenderingUtilsKt.d(lowerRendered, strW12 + r0("Array<"), upperRendered, strW12 + r0("Array<out "), strW12 + r0("Array<(out) "));
        if (strD3 != null) {
            return strD3;
        }
    ...
    public String S(Name name, boolean z10) {
        ...
        if (!x0() || f1() != RenderingFormat.f147000b || !z10) {
            return strR0;
        }
        return "<b>" + strR0 + "</b>";
    }
    ...
    public String t2(TypeConstructor typeConstructor) {
        ...
        if (classifierDescriptorD == null) {
            return typeConstructor instanceof IntersectionTypeConstructor ? ((IntersectionTypeConstructor) typeConstructor).n(m.f147015a) : typeConstructor.toString();
        }
    ...
    private final void A1(StringBuilder sb2, Annotated annotated, AnnotationUseSiteTarget annotationUseSiteTarget) {
        Set<FqName> setC0;
        if (J0().contains(DescriptorRendererModifier.f146914h)) {
    ...
    public final void D1(ClassDescriptor classDescriptor, StringBuilder sb2) throws IOException {
        ...
        boolean z14;
        boolean z15;
        if (classDescriptor.f() == ClassKind.f144495e) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (!e1()) {
            ...
            if ((classDescriptor.f() != ClassKind.f144493c || classDescriptor.q() != Modality.f144529e) && (!classDescriptor.f().b() || classDescriptor.q() != Modality.f144526b)) {
            ...
            if (J0().contains(DescriptorRendererModifier.f146915i) && classDescriptor.y()) {
                z11 = true;
            } else {
                z11 = false;
            }
            Z1(sb2, z11, "inner");
            if (J0().contains(DescriptorRendererModifier.f146917k) && classDescriptor.F0()) {
                z12 = true;
            } else {
                z12 = false;
            }
            Z1(sb2, z12, "data");
            if (J0().contains(DescriptorRendererModifier.f146918l) && classDescriptor.isInline()) {
                z13 = true;
            } else {
                z13 = false;
            }
            Z1(sb2, z13, "inline");
            if (J0().contains(DescriptorRendererModifier.f146924r) && classDescriptor.r()) {
                z14 = true;
            } else {
                z14 = false;
            }
            Z1(sb2, z14, "value");
            if (J0().contains(DescriptorRendererModifier.f146923q) && classDescriptor.b0()) {
                z15 = true;
            } else {
                z15 = false;
            }
    ...
    private final boolean F2(DescriptorVisibility descriptorVisibility, StringBuilder sb2) {
        if (!J0().contains(DescriptorRendererModifier.f146911e)) {
            return false;
        }
        if (K0()) {
            descriptorVisibility = descriptorVisibility.f();
        }
        if (!Y0() && Intrinsics.e(descriptorVisibility, DescriptorVisibilities.f144514l)) {
            return false;
        }
    ...
    private final void G1(DeclarationDescriptor declarationDescriptor, StringBuilder sb2) {
        ...
        if (!k1() && Intrinsics.e(declarationDescriptor.getName(), SpecialNames.f146604d)) {
            return;
        }
        if (!e1()) {
            n2(sb2);
    ...
    private final void N1(StringBuilder sb2, AbbreviatedType abbreviatedType) {
        ...
        RenderingFormat renderingFormat = RenderingFormat.f147000b;
    ...
    private final void R1(StringBuilder sb2, KotlinType kotlinType) {
        ...
        if (z11) {
            if (zR) {
                ...
                if (z10) {
                    CharsKt.c(StringsKt.L1(sb2));
                    if (sb2.charAt(StringsKt.k0(sb2) - 1) != ')') {
                        sb2.insert(StringsKt.k0(sb2), "()");
                    }
                }
                sb2.append("(");
            }
    ...
    private final void U1(CallableMemberDescriptor callableMemberDescriptor, StringBuilder sb2) {
        if (J0().contains(DescriptorRendererModifier.f146916j) && k1() && callableMemberDescriptor.f() != CallableMemberDescriptor.Kind.DECLARATION) {
            sb2.append("/*");
    ...
    private final void V1(MemberDescriptor memberDescriptor, StringBuilder sb2) {
        ...
        boolean z11 = false;
        if (J0().contains(DescriptorRendererModifier.f146919m) && memberDescriptor.h0()) {
            z10 = true;
        } else {
            z10 = false;
        }
        Z1(sb2, z10, "expect");
        if (J0().contains(DescriptorRendererModifier.f146920n) && memberDescriptor.V()) {
            z11 = true;
        }
        Z1(sb2, z11, "actual");
    }
    ...
    private final void X1(Modality modality, StringBuilder sb2, Modality modality2) {
        ...
        Z1(sb2, J0().contains(DescriptorRendererModifier.f146912f), CapitalizeDecapitalizeKt.f(modality.name()));
    }

    private final void Y1(CallableMemberDescriptor callableMemberDescriptor, StringBuilder sb2) {
        if (!DescriptorUtils.J(callableMemberDescriptor) || callableMemberDescriptor.q() != Modality.f144526b) {
            if (M0() == OverrideRenderingPolicy.f146984a && callableMemberDescriptor.q() == Modality.f144528d && v1(callableMemberDescriptor)) {
                return;
            }
            Modality modalityQ = callableMemberDescriptor.q();
            Intrinsics.i(modalityQ, "getModality(...)");
    ...
    private final void d2(CallableMemberDescriptor callableMemberDescriptor, StringBuilder sb2) {
        if (J0().contains(DescriptorRendererModifier.f146913g) && v1(callableMemberDescriptor) && M0() != OverrideRenderingPolicy.f146985b) {
    ...
    public final void i2(PropertyDescriptor propertyDescriptor, StringBuilder sb2) throws IOException {
        ...
        if (!e1()) {
            if (!d1()) {
                ...
                F2(visibility, sb2);
                boolean z11 = false;
                if (J0().contains(DescriptorRendererModifier.f146921o) && propertyDescriptor.isConst()) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                ...
                if (J0().contains(DescriptorRendererModifier.f146922p) && propertyDescriptor.v0()) {
                    z11 = true;
                }
                Z1(sb2, z11, "lateinit");
    ...
    private final void j2(PropertyDescriptor propertyDescriptor, StringBuilder sb2) {
        if (J0().contains(DescriptorRendererModifier.f146914h)) {
            ...
            if (fieldDescriptorT0 != null) {
                A1(sb2, fieldDescriptorT0, AnnotationUseSiteTarget.f144579c);
            }
            FieldDescriptor fieldDescriptorO = propertyDescriptor.O();
            if (fieldDescriptorO != null) {
                A1(sb2, fieldDescriptorO, AnnotationUseSiteTarget.f144587k);
            }
            if (Q0() == PropertyAccessorRenderingPolicy.f146996c) {
                PropertyGetterDescriptor getter = propertyDescriptor.getGetter();
                if (getter != null) {
                    A1(sb2, getter, AnnotationUseSiteTarget.f144582f);
                }
                PropertySetterDescriptor setter = propertyDescriptor.getSetter();
                if (setter != null) {
                    A1(sb2, setter, AnnotationUseSiteTarget.f144583g);
                    ...
                    A1(sb2, valueParameterDescriptor, AnnotationUseSiteTarget.f144586j);
                }
            }
        }
    }
    ...
    private final void k2(CallableDescriptor callableDescriptor, StringBuilder sb2) {
        ...
        if (receiverParameterDescriptorN != null) {
            A1(sb2, receiverParameterDescriptorN, AnnotationUseSiteTarget.f144584h);
    ...
    private final boolean t1(AnnotationDescriptor annotationDescriptor) {
        return Intrinsics.e(annotationDescriptor.e(), StandardNames.FqNames.f144235E);
    }
