...
public final class ModuleByClassLoaderKt {
    ...
    private static final ConcurrentMap<C0, WeakReference<RuntimeModuleData>> f144034a = new ConcurrentHashMap();
    ...
    public static final RuntimeModuleData a(Class<?> cls) {
        ...
        ConcurrentMap<C0, WeakReference<RuntimeModuleData>> concurrentMap = f144034a;
        ...
        RuntimeModuleData runtimeModuleDataA = RuntimeModuleData.f144954c.a(classLoaderJ);
        while (true) {
            try {
                ConcurrentMap<C0, WeakReference<RuntimeModuleData>> concurrentMap2 = f144034a;
