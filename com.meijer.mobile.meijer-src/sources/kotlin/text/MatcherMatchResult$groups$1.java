...
public final class MatcherMatchResult$groups$1 extends AbstractCollection<MatchGroup> implements MatchNamedGroupCollection {
    ...
    final /* synthetic */ MatcherMatchResult f148364a;
    ...
    MatcherMatchResult$groups$1(MatcherMatchResult matcherMatchResult) {
        this.f148364a = matcherMatchResult;
    }
    ...
    /* renamed from: f */
    public int getSize() {
        return this.f148364a.f().groupCount() + 1;
    }

    @Override // kotlin.text.MatchGroupCollection
    public MatchGroup get(int index) {
        IntRange intRangeI = RegexKt.i(this.f148364a.f(), index);
        if (intRangeI.getStart().intValue() < 0) {
            return null;
        }
        String strGroup = this.f148364a.f().group(index);
    ...
    public Iterator<MatchGroup> iterator() {
        return SequencesKt.M(CollectionsKt.f0(CollectionsKt.n(this)), new Function1() { // from class: kv.b
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return MatcherMatchResult$groups$1.o(this.f148918a, ((Integer) obj).intValue());
            }
        }).iterator();
    }
