...
public class i extends e {
    ...
    public static final String i(String str, final String indent) {
        ...
        return SequencesKt.K(SequencesKt.M(StringsKt__StringsKt.z0(str), new Function1() { // from class: kotlin.text.f
    ...
    public static final String l(String str, String newIndent) {
        ...
        List<String> listA0 = StringsKt__StringsKt.A0(str);
        ...
        int length = str.length() + (newIndent.length() * listA0.size());
        Function1<String, String> function1E = e(newIndent);
        int iO = CollectionsKt.o(listA0);
        ...
        for (Object obj2 : listA0) {
            ...
            if ((i10 == 0 || i10 == iO) && StringsKt__StringsKt.s0(str2)) {
                str2 = null;
            } else {
                String strI1 = v.I1(str2, iIntValue);
                if (strI1 != null && (strInvoke = function1E.invoke(strI1)) != null) {
                    str2 = strInvoke;
                }
            }
            if (str2 != null) {
    ...
    public static final String m(String str, String newIndent, String marginPrefix) {
        ...
        if (StringsKt__StringsKt.s0(marginPrefix)) {
        ...
        for (Object obj : listA0) {
            ...
            if ((i10 == 0 || i10 == iO) && StringsKt__StringsKt.s0(str3)) {
                str2 = marginPrefix;
                str3 = null;
            } else {
