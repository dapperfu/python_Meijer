...
public abstract class Random {
    ...
    private static final Random f143787b = PlatformImplementationsKt.f143589a.b();
    ...
    public static final class Companion extends Random implements Serializable {
        ...
        public int b(int bitCount) {
            return Random.f143787b.b(bitCount);
        }

        @Override // kotlin.random.Random
        public double c() {
            return Random.f143787b.c();
        }

        @Override // kotlin.random.Random
        public double d(double until) {
            return Random.f143787b.d(until);
        }

        @Override // kotlin.random.Random
        public double e(double from, double until) {
            return Random.f143787b.e(from, until);
        }

        @Override // kotlin.random.Random
        public int f() {
            return Random.f143787b.f();
        }

        @Override // kotlin.random.Random
        public int g(int until) {
            return Random.f143787b.g(until);
        }

        @Override // kotlin.random.Random
        public int h(int from, int until) {
            return Random.f143787b.h(from, until);
        }
    }
