...
public final class C13913b {
    ...
    public static final C13913b f131136a = new C13913b();

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private static final InterfaceC6452i<Float> SnapAnimationSpec = C6453j.l(0, 0, null, 7, null);

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private static final Function1<Float, Float> PositionalThreshold = a.f131141f;

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    private static final InterfaceC6468y<Float> DecayAnimationSpec = C6414A.c(0.0f, 0.0f, 3, null);

    /* renamed from: e, reason: collision with root package name */
    public static final int f131140e = 8;
    ...
    static final class a extends Lambda implements Function1<Float, Float> {
        ...
        public static final a f131141f = new a();
    ...
    public final <T> InterfaceC13906N a(C13914c<T> c13914c, Function1<? super Float, Float> function1, InterfaceC6452i<Float> interfaceC6452i, Composer composer, int i10, int i11) {
        if ((i11 & 2) != 0) {
            function1 = PositionalThreshold;
        }
        if ((i11 & 4) != 0) {
            interfaceC6452i = SnapAnimationSpec;
        }
        if (ComposerKt.M()) {
        ...
        boolean zV = ((((i10 & 14) ^ 6) > 4 && composer.V(c13914c)) || (i10 & 6) == 4) | composer.V(dVar) | ((((i10 & 112) ^ 48) > 32 && composer.V(function1)) || (i10 & 48) == 32) | composer.V(interfaceC6452i);
        Object objB = composer.B();
        if (zV || objB == Composer.INSTANCE.a()) {
            objB = androidx.compose.foundation.gestures.a.n(c13914c, dVar, function1, interfaceC6452i);
            composer.t(objB);
        }
    ...
    public final InterfaceC6468y<Float> b() {
    ...
    public final InterfaceC6452i<Float> d() {
