...
public final class C6426M<T> implements InterfaceC6452i<T> {

    /* renamed from: d, reason: collision with root package name */
    public static final int f60705d = 8;

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC6415B<T> animation;
    ...
    public /* synthetic */ C6426M(InterfaceC6415B interfaceC6415B, EnumC6437Y enumC6437Y, long j10, DefaultConstructorMarker defaultConstructorMarker) {
        this(interfaceC6415B, enumC6437Y, j10);
    }

    private C6426M(InterfaceC6415B<T> interfaceC6415B, EnumC6437Y enumC6437Y, long j10) {
        this.animation = interfaceC6415B;
    ...
    public boolean equals(Object other) {
        if (other instanceof C6426M) {
            C6426M c6426m = (C6426M) other;
            if (Intrinsics.e(c6426m.animation, this.animation) && c6426m.repeatMode == this.repeatMode && g0.d(c6426m.initialStartOffset, this.initialStartOffset)) {
                return true;
            }
        }
        return false;
