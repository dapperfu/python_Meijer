...
final class C17794j implements InterfaceC17764C {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final AbstractC5623v selectableIdToInfoListIndex;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final List<C17799o> infoList;
    ...
    static final class b extends Lambda implements Function1<C17799o, Unit> {
        ...
        final /* synthetic */ O<Selection> f166746g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Selection f166747h;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(O<Selection> o10, Selection selection) {
            super(1);
            this.f166746g = o10;
            this.f166747h = selection;
        }

        public final void a(C17799o c17799o) {
            C17794j.this.n(this.f166746g, this.f166747h, c17799o, 0, c17799o.l());
        }
    ...
    public /* synthetic */ class a {
        ...
        static {
            int[] iArr = new int[EnumC17789e.values().length];
            try {
                iArr[EnumC17789e.f166724c.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[EnumC17789e.f166723b.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[EnumC17789e.f166722a.ordinal()] = 3;
    ...
    @Override // kotlin.InterfaceC17764C
    ...
    public String toString() {
        ...
        sb3.append("[\n\t");
        List<C17799o> list = this.infoList;
        int size = list.size();
        int i10 = 0;
        while (i10 < size) {
            C17799o c17799o = list.get(i10);
            if (z10) {
                z10 = false;
            } else {
                sb3.append(",\n\t");
    ...
    public C17794j(AbstractC5623v abstractC5623v, List<C17799o> list, int i10, int i11, boolean z10, Selection selection) {
        this.selectableIdToInfoListIndex = abstractC5623v;
        this.infoList = list;
        this.startSlot = i10;
        this.endSlot = i11;
        ...
        if (!(list.size() > 1)) {
            C14592e.c("MultiSelectionLayout requires an infoList size greater than 1, was " + list.size() + '.');
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void n(O<Selection> o10, Selection selection, C17799o c17799o, int i10, int i11) {
        Selection selectionM;
        boolean z10;
        if (selection.getHandlesCrossed()) {
            selectionM = c17799o.m(i11, i10);
        } else {
            selectionM = c17799o.m(i10, i11);
        }
        if (i10 <= i11) {
            z10 = true;
        } else {
        ...
        if (!z10) {
            C14592e.c("minOffset should be less than or equal to maxOffset: " + selectionM);
        }
        o10.n(c17799o.getSelectableId(), selectionM);
    }

    private final boolean q(C17794j other) {
    ...
    */
    private final int s(int r4, boolean r5) {
        /*
            r3 = this;
            w0.e r0 = r3.f()
            int[] r1 = kotlin.C17794j.a.$EnumSwitchMapping$0
            int r0 = r0.ordinal()
            r0 = r1[r0]
            r1 = 1
            if (r0 == r1) goto L17
        ...
        L21:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.C17794j.s(int, boolean):int");
    }

    @Override // kotlin.InterfaceC17764C
    /* renamed from: b */
    public C17799o getInfo() {
        if (getIsStartHandle()) {
            return j();
        }
        return i();
    ...
    @Override // kotlin.InterfaceC17764C
    public AbstractC5626y<Selection> d(Selection selection) {
        ...
        if (selection.getStart().getSelectableId() == selection.getEnd().getSelectableId()) {
            ...
            if (!z10) {
                C14592e.c("unexpectedly miss-crossed selection: " + selection);
            }
            return C5627z.b(selection.getStart().getSelectableId(), selection);
        }
        O<Selection> oC = C5627z.c();
        if (selection.getHandlesCrossed()) {
    ...
    @Override // kotlin.InterfaceC17764C
    public EnumC17789e f() {
        if (getStartSlot() < getEndSlot()) {
            return EnumC17789e.f166723b;
        }
        if (getStartSlot() > getEndSlot()) {
            return EnumC17789e.f166722a;
        }
        return this.infoList.get(getStartSlot() / 2).d();
    }

    @Override // kotlin.InterfaceC17764C
    public void g(Function1<? super C17799o, Unit> block) {
    ...
    @Override // kotlin.InterfaceC17764C
    public boolean l(InterfaceC17764C other) {
        if (getPreviousSelection() != null && other != null && (other instanceof C17794j) && getIsStartHandle() == other.getIsStartHandle() && getStartSlot() == other.getStartSlot() && getEndSlot() == other.getEndSlot() && !q((C17794j) other)) {
            return false;
        }
        return true;
    }
