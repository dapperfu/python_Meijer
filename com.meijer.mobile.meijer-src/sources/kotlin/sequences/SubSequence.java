...
public final class SubSequence<T> implements Sequence<T>, DropTakeSequence<T> {
    ...
    public static final class AnonymousClass1 implements Iterator<T>, KMappedMarker {
        ...
        final /* synthetic */ SubSequence<T> f148202c;
        ...
        AnonymousClass1(SubSequence<T> subSequence) {
            this.f148202c = subSequence;
            this.iterator = ((SubSequence) subSequence).sequence.iterator();
        }

        private final void a() {
            while (this.position < ((SubSequence) this.f148202c).startIndex && this.iterator.hasNext()) {
                this.iterator.next();
                this.position++;
            }
        }
        ...
        public boolean hasNext() {
            a();
            if (this.position < ((SubSequence) this.f148202c).endIndex && this.iterator.hasNext()) {
                return true;
            }
            return false;
        }
        ...
        public T next() {
            a();
            if (this.position < ((SubSequence) this.f148202c).endIndex) {
                this.position++;
