...
public final class TakeWhileSequence<T> implements Sequence<T> {
    ...
    public static final class AnonymousClass1 implements Iterator<T>, KMappedMarker {
        ...
        final /* synthetic */ TakeWhileSequence<T> f148212d;
        ...
        AnonymousClass1(TakeWhileSequence<T> takeWhileSequence) {
            this.f148212d = takeWhileSequence;
        ...
        private final void a() {
            if (this.iterator.hasNext()) {
                ...
                if (((Boolean) ((TakeWhileSequence) this.f148212d).predicate.invoke(next)).booleanValue()) {
                    this.nextState = 1;
                    this.nextItem = next;
                    return;
                }
