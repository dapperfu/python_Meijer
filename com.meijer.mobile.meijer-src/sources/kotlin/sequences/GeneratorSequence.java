...
final class GeneratorSequence<T> implements Sequence<T> {
    ...
    public static final class AnonymousClass1 implements Iterator<T>, KMappedMarker {
        ...
        final /* synthetic */ GeneratorSequence<T> f148169c;
        ...
        AnonymousClass1(GeneratorSequence<T> generatorSequence) {
            this.f148169c = generatorSequence;
        }

        private final void a() {
            T t10;
            if (this.nextState == -2) {
                t10 = (T) ((GeneratorSequence) this.f148169c).getInitialValue.invoke();
            } else {
                Function1 function1 = ((GeneratorSequence) this.f148169c).getNextValue;
                T t11 = this.nextItem;
                Intrinsics.g(t11);
