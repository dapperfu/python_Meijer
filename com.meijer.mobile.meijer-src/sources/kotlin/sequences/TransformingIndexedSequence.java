...
public final class TransformingIndexedSequence<T, R> implements Sequence<R> {
    ...
    public static final class AnonymousClass1 implements Iterator<R>, KMappedMarker {
        ...
        final /* synthetic */ TransformingIndexedSequence<T, R> f148217c;
        ...
        AnonymousClass1(TransformingIndexedSequence<T, R> transformingIndexedSequence) {
            this.f148217c = transformingIndexedSequence;
        ...
        @Override // java.util.Iterator
        public R next() {
            Function2 function2 = ((TransformingIndexedSequence) this.f148217c).transformer;
            int i10 = this.index;
            this.index = i10 + 1;
            if (i10 < 0) {
                CollectionsKt.w();
