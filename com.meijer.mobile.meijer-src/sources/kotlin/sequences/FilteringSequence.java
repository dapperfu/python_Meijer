...
public final class FilteringSequence<T> implements Sequence<T> {
    ...
    public static final class AnonymousClass1 implements Iterator<T>, KMappedMarker {
        ...
        final /* synthetic */ FilteringSequence<T> f148157d;
        ...
        AnonymousClass1(FilteringSequence<T> filteringSequence) {
            this.f148157d = filteringSequence;
        ...
        private final void a() {
            while (this.iterator.hasNext()) {
                ...
                if (((Boolean) ((FilteringSequence) this.f148157d).predicate.invoke(next)).booleanValue() == ((FilteringSequence) this.f148157d).sendWhen) {
                    this.nextItem = next;
                    this.nextState = 1;
                    return;
                }
