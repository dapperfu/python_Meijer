...
public final class SequencesKt___SequencesKt$minus$2 implements Sequence<Object> {
    ...
    final /* synthetic */ Sequence<Object> f148188a;

    /* renamed from: b, reason: collision with root package name */
    final /* synthetic */ Object[] f148189b;

    @Override // kotlin.sequences.Sequence
    public Iterator<Object> iterator() {
        Sequence<Object> sequence = this.f148188a;
        final Object[] objArr = this.f148189b;
        return SequencesKt___SequencesKt.C(sequence, new Function1() { // from class: jv.b
