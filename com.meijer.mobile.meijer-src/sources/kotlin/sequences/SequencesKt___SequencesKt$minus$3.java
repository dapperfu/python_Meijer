...
public final class SequencesKt___SequencesKt$minus$3 implements Sequence<Object> {
    ...
    final /* synthetic */ Iterable<Object> f148190a;

    /* renamed from: b, reason: collision with root package name */
    final /* synthetic */ Sequence<Object> f148191b;

    @Override // kotlin.sequences.Sequence
    public Iterator<Object> iterator() {
        final Collection collectionE = CollectionsKt.E(this.f148190a);
        return collectionE.isEmpty() ? this.f148191b.iterator() : SequencesKt___SequencesKt.C(this.f148191b, new Function1() { // from class: jv.c
