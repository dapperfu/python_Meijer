...
final class C15845D implements d0, d0.a, C15847F.a {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final Object key;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final C15847F pinnedItemList;
    ...
    private final InterfaceC5872l0 _parentPinnableContainer = t1.e(null, null, 2, null);
    ...
    public d0.a a() {
        if (this.isDisposed) {
            C14592e.c("Pin should not be called on an already disposed item ");
        }
        if (this.pinsCount == 0) {
    ...
    public void release() {
        ...
        if (!(this.pinsCount > 0)) {
            C14592e.c("Release should only be called once");
        }
    ...
    public C15845D(Object obj, C15847F c15847f) {
        this.key = obj;
        this.pinnedItemList = c15847f;
    }
