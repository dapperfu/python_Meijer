...
public final class C6428O {
    ...
    static final class a extends Lambda implements Function0<Unit> {
        ...
        final /* synthetic */ T f60740f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ C6427N.a<T, V> f60741g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ T f60742h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ C6426M<T> f60743i;
        ...
        a(T t10, C6427N.a<T, V> aVar, T t11, C6426M<T> c6426m) {
            super(0);
            this.f60740f = t10;
            this.f60741g = aVar;
            this.f60742h = t11;
        ...
        public final void invoke2() {
            if (Intrinsics.e(this.f60740f, this.f60741g.f()) && Intrinsics.e(this.f60742h, this.f60741g.k())) {
                return;
            }
            this.f60741g.w(this.f60740f, this.f60742h, this.f60743i);
        }
    }
    ...
    static final class b extends Lambda implements Function1<F, E> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ C6427N f60744f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ C6427N.a<T, V> f60745g;
        ...
        public static final class a implements E {
            ...
            final /* synthetic */ C6427N f60746a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ C6427N.a f60747b;

            public a(C6427N c6427n, C6427N.a aVar) {
                this.f60746a = c6427n;
                this.f60747b = aVar;
            }
            ...
            public void dispose() {
                this.f60746a.j(this.f60747b);
            }
        }

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(C6427N c6427n, C6427N.a<T, V> aVar) {
            super(1);
            this.f60744f = c6427n;
            this.f60745g = aVar;
        }
        ...
        public final E invoke(F f10) {
            this.f60744f.f(this.f60745g);
            return new a(this.f60744f, this.f60745g);
        }
    }

    public static final z1<Float> a(C6427N c6427n, float f10, float f11, C6426M<Float> c6426m, String str, Composer composer, int i10, int i11) {
        if ((i11 & 8) != 0) {
            str = "FloatAnimation";
        }
        String str2 = str;
        ...
        int i12 = i10 << 3;
        z1<Float> z1VarB = b(c6427n, Float.valueOf(f10), Float.valueOf(f11), q0.i(FloatCompanionObject.f143729a), c6426m, str2, composer, (i10 & 1022) | (57344 & i12) | (i12 & 458752), 0);
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        return z1VarB;
    ...
    public static final <T, V extends AbstractC6460q> z1<T> b(C6427N c6427n, T t10, T t11, o0<T, V> o0Var, C6426M<T> c6426m, String str, Composer composer, int i10, int i11) {
        C6427N c6427n2;
        Object obj;
        Object obj2;
        C6426M<T> c6426m2;
        ...
        if (objB == companion.a()) {
            ...
            obj2 = t11;
            c6426m2 = c6426m;
            C6427N.a aVar = c6427n2.new a(obj, obj2, o0Var, c6426m2, str2);
            composer.t(aVar);
            objB = aVar;
        } else {
            c6427n2 = c6427n;
    ...
    public static final C6427N c(String str, Composer composer, int i10, int i11) {
        if ((i11 & 1) != 0) {
