...
public final class C1 {
    ...
    public static final C1 f167869a = new C1();
    ...
    public static final int f167873e = 0;

    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    static final class a extends Lambda implements Function2<Composer, Integer, Unit> {

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Modifier f167875g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ float f167876h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ long f167877i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ int f167878j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ int f167879k;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(Modifier modifier, float f10, long j10, int i10, int i11) {
            super(2);
            this.f167875g = modifier;
            this.f167876h = f10;
            this.f167877i = j10;
            this.f167878j = i10;
            this.f167879k = i11;
        ...
        public final void a(Composer composer, int i10) {
            C1.this.a(this.f167875g, this.f167876h, this.f167877i, composer, J0.a(this.f167878j | 1), this.f167879k);
        }
    ...
    static final class b extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Modifier f167881g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ float f167882h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ long f167883i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ int f167884j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ int f167885k;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(Modifier modifier, float f10, long j10, int i10, int i11) {
            super(2);
            this.f167881g = modifier;
            this.f167882h = f10;
            this.f167883i = j10;
            this.f167884j = i10;
            this.f167885k = i11;
        ...
        public final void a(Composer composer, int i10) {
            C1.this.b(this.f167881g, this.f167882h, this.f167883i, composer, J0.a(this.f167884j | 1), this.f167885k);
        }
    ...
    public static final class c extends Lambda implements Function1<N0, Unit> {
        ...
        final /* synthetic */ TabPosition f167886f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public c(TabPosition tabPosition) {
            super(1);
            this.f167886f = tabPosition;
        }
    ...
    static final class d extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        ...
        static final class a extends Lambda implements Function1<H1.d, H1.n> {
            ...
            public final long a(H1.d dVar) {
                return o.a(dVar.E0(d.d(this.f167888f)), 0);
            }
        ...
        public final Modifier b(Modifier modifier, Composer composer, int i10) {
            ...
            z1<H1.h> z1VarC = C6443c.c(this.f167887f.getWidth(), C6453j.l(250, 0, C6418E.c(), 2, null), null, null, composer, 0, 12);
            z1<H1.h> z1VarC2 = C6443c.c(this.f167887f.getLeft(), C6453j.l(250, 0, C6418E.c(), 2, null), null, null, composer, 0, 12);
