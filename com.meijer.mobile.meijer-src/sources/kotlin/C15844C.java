...
public final class C15844C implements z1<IntRange> {

    /* renamed from: e, reason: collision with root package name */
    private static final a f151814e = new a(null);
    ...
    public final void l(int firstVisibleItem) {
        if (firstVisibleItem != this.lastFirstVisibleItem) {
            ...
            k(f151814e.b(firstVisibleItem, this.slidingWindowSize, this.extraItemCount));
        }
    }

    public C15844C(int i10, int i11, int i12) {
        this.slidingWindowSize = i11;
        this.extraItemCount = i12;
        this.value = o1.i(f151814e.b(i10, i11, i12), o1.r());
