...
public final class C6425L {
    ...
    @DebugMetadata(c = "androidx.compose.animation.core.InfiniteAnimationPolicyKt$withInfiniteAnimationFrameNanos$2", f = "InfiniteAnimationPolicy.kt", l = {l3.f93325e}, m = "invokeSuspend")
    /* renamed from: c0.L$a */
    static final class a<R> extends SuspendLambda implements Function1<Continuation<? super R>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.b(obj);
            Function1<Long, R> function1 = this.f60704b;
            this.f60703a = 1;
            Object objC = C5854d0.c(function1, this);
            if (objC == objF) {
                return objF;
            }
            return objC;
    ...
    public static final <R> Object a(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        I0 i02 = (I0) continuation.getF143270a().g(I0.INSTANCE);
        if (i02 == null) {
            return C5854d0.c(function1, continuation);
        }
