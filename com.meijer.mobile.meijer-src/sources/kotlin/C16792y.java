...
final class C16792y<T> implements Continuation<T>, CoroutineStackFrame {
    ...
    public C16792y(Continuation<? super T> continuation, CoroutineContext coroutineContext) {
