...
public final class n0<T> implements InterfaceC6415B<T> {
    ...
    public n0(int i10, int i11, InterfaceC6416C interfaceC6416C) {
    ...
    public <V extends AbstractC6460q> D0<V> a(o0<T, V> converter) {
    ...
    public /* synthetic */ n0(int i10, int i11, InterfaceC6416C interfaceC6416C, int i12, DefaultConstructorMarker defaultConstructorMarker) {
        this((i12 & 1) != 0 ? HttpResponseStatus.REDIRECTION_MULTIPLE_CHOICES : i10, (i12 & 2) != 0 ? 0 : i11, (i12 & 4) != 0 ? C6418E.c() : interfaceC6416C);
    }
}
