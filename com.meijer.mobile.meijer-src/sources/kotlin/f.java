...
public final class f {
    ...
    static final class a extends Lambda implements Function1<X0.f, Unit> {
        ...
        public final void a(X0.f drawBehind) {
            ...
            X0.f.O0(drawBehind, C5489q0.INSTANCE.k(), U0.g.a(0.0f, U0.k.g(drawBehind.b())), U0.g.a(U0.k.i(drawBehind.b()), U0.k.g(drawBehind.b())), 8.0f, 0, null, 0.0f, null, 0, 496, null);
        }
    ...
    static final class b extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ char f114f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f115g;
        ...
        public final void a(Composer composer, int i10) {
            f.a(this.f114f, composer, J0.a(this.f115g | 1));
        }
    ...
    static final class c extends Lambda implements Function1<TextFieldValue, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final c f116f = new c();
    ...
    static final class d extends Lambda implements Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit> {
        ...
        public final void a(Function2<? super Composer, ? super Integer, Unit> it, Composer composer, int i10) {
            ...
            for (int i11 = 0; i11 < 4; i11++) {
                Character chK1 = StringsKt.K1(str, i11);
                f.a(chK1 != null ? chK1.charValue() : ' ', composer, 0);
            }
            composer.U();
            composer.U();
            composer.v();
    ...
    static final class e extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ String f118f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f119g;
        ...
        public final void a(Composer composer, int i10) {
            f.b(this.f118f, composer, J0.a(this.f119g | 1));
        }
    ...
    public static final void a(char c10, Composer composer, int i10) {
        ...
        if ((i11 & 11) == 2 && composerStartRestartGroup.j()) {
            ...
            N1.b(strValueOf, androidx.compose.ui.draw.b.b(androidx.compose.foundation.b.d(modifierJ, companion.i(), null, 2, null), a.f113f), companion.k(), w.i(36), null, null, AbstractC18269l.INSTANCE.d(), 0L, null, F1.j.h(F1.j.INSTANCE.a()), 0L, 0, false, 0, 0, null, null, composer2, 3456, 0, 130480);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final void b(String input, Composer composer, int i10) {
        ...
        if ((i11 & 11) == 2 && composerStartRestartGroup.j()) {
            ...
            composer2 = composerStartRestartGroup;
            C5815e.b(new TextFieldValue(input, C17334A.a(input.length()), (y) null, 4, (DefaultConstructorMarker) null), c.f116f, null, false, false, null, null, null, false, 0, 0, null, null, null, null, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -411901195, true, new d(input)), composer2, 3120, 196608, 32756);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
