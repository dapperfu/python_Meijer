...
public final class C17765D {
    ...
    public /* synthetic */ C17765D(long j10, long j11, LayoutCoordinates layoutCoordinates, boolean z10, Selection selection, Comparator comparator, DefaultConstructorMarker defaultConstructorMarker) {
        this(j10, j11, layoutCoordinates, z10, selection, comparator);
    }

    private final int i(int slot, EnumC17790f xPositionDirection, EnumC17790f yPositionDirection) {
        if (slot == -1) {
            int i10 = a.$EnumSwitchMapping$0[C17766E.f(xPositionDirection, yPositionDirection).ordinal()];
            if (i10 == 1) {
    ...
    private C17765D(long j10, long j11, LayoutCoordinates layoutCoordinates, boolean z10, Selection selection, Comparator<Long> comparator) {
        ...
        this.selectableIdToInfoListIndex = C5624w.a();
    ...
    public final C17799o a(long selectableId, int rawStartHandleOffset, EnumC17790f startXHandleDirection, EnumC17790f startYHandleDirection, int rawEndHandleOffset, EnumC17790f endXHandleDirection, EnumC17790f endYHandleDirection, int rawPreviousHandleOffset, TextLayoutResult textLayoutResult) {
        this.currentSlot += 2;
        C17799o c17799o = new C17799o(selectableId, this.currentSlot, rawStartHandleOffset, rawEndHandleOffset, rawPreviousHandleOffset, textLayoutResult);
        ...
        this.infoList.add(c17799o);
        return c17799o;
    }

    public final InterfaceC17764C b() {
        ...
        if (size == 1) {
            C17799o c17799o = (C17799o) CollectionsKt.U0(this.infoList);
            int i11 = this.startSlot;
            int i12 = i11 == -1 ? i10 : i11;
            int i13 = this.endSlot;
            return new SingleSelectionLayout(this.isStartHandle, i12, i13 == -1 ? i10 : i13, this.previousSelection, c17799o);
        }
        ...
        return new C17794j(m10, list, i15, i16 == -1 ? i10 : i16, this.isStartHandle, this.previousSelection);
    }
