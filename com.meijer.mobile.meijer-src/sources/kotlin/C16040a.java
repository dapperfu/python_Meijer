...
final class C16040a implements InterfaceC13938a {
    ...
    public long E1(long available, int source) {
        if (!C13942e.f(source, C13942e.INSTANCE.d()) || Math.abs(this.state.w()) <= 1.0E-6d) {
        ...
        EnumC13937z enumC13937z2 = EnumC13937z.f131420b;
        float fIntBitsToFloat = -this.state.f(-RangesKt.n(Float.intBitsToFloat((int) (enumC13937z == enumC13937z2 ? available >> 32 : available & 4294967295L)), fW, pageSize));
        float fIntBitsToFloat2 = this.orientation == enumC13937z2 ? fIntBitsToFloat : Float.intBitsToFloat((int) (available >> 32));
        if (this.orientation != EnumC13937z.f131419a) {
    ...
    public long L0(long consumed, long available, int source) {
        if (!C13942e.f(source, C13942e.INSTANCE.c()) || b(available) == 0.0f) {
            return U0.f.INSTANCE.c();
        }
        throw new CancellationException("Scroll cancelled");
    }

    public final long a(long j10, EnumC13937z enumC13937z) {
        return enumC13937z == EnumC13937z.f131419a ? y.e(j10, 0.0f, 0.0f, 2, null) : y.e(j10, 0.0f, 0.0f, 1, null);
    }
    ...
    public C16040a(AbstractC16037C abstractC16037C, EnumC13937z enumC13937z) {
