...
public final class C17943E0 {

    /* renamed from: a, reason: collision with root package name */
    public static final C17943E0 f167967a = new C17943E0();

    /* renamed from: b, reason: collision with root package name */
    public static final int f167968b = 0;
    ...
    public final Colors a(Composer composer, int i10) {
        ...
        Colors colors = (Colors) composer.o(C17942E.e());
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        return colors;
    ...
    public final Shapes b(Composer composer, int i10) {
        ...
        Shapes shapes = (Shapes) composer.o(C18002f1.a());
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        return shapes;
