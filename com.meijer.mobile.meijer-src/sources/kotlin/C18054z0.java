...
public final class C18054z0 {

    /* renamed from: a, reason: collision with root package name */
    private static final Modifier f169985a = J.v(Modifier.INSTANCE, H1.h.p(24));
    ...
    static final class a extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ Z0.c f169986f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ String f169987g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Modifier f169988h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ long f169989i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ int f169990j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ int f169991k;
        ...
        public final void a(Composer composer, int i10) {
            C18054z0.a(this.f169986f, this.f169987g, this.f169988h, this.f169989i, composer, J0.a(this.f169990j | 1), this.f169991k);
        }
    ...
    static final class b extends Lambda implements Function1<u, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ String f169992f;
    ...
    */
    public static final void a(Z0.c r26, java.lang.String r27, androidx.compose.ui.Modifier r28, long r29, androidx.compose.runtime.Composer r31, int r32, int r33) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.C18054z0.a(Z0.c, java.lang.String, androidx.compose.ui.Modifier, long, androidx.compose.runtime.Composer, int, int):void");
    }

    public static final void b(a1.d dVar, String str, Modifier modifier, long j10, Composer composer, int i10, int i11) {
        Modifier modifier2 = (i11 & 4) != 0 ? Modifier.INSTANCE : modifier;
        long jQ = (i11 & 8) != 0 ? C5489q0.q(((C5489q0) composer.o(C17960N.a())).getValue(), ((Number) composer.o(C17958M.a())).floatValue(), 0.0f, 0.0f, 0.0f, 14, null) : j10;
        if (ComposerKt.M()) {
            ComposerKt.U(-800853103, i10, -1, "androidx.compose.material.Icon (Icon.kt:66)");
        }
        a(r.g(dVar, composer, i10 & 14), str, modifier2, jQ, composer, q.f44344n | (i10 & 112) | (i10 & 896) | (i10 & 7168), 0);
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
    }
