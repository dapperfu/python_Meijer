...
public final class D0<V extends AbstractC6460q> implements u0<V> {
    ...
    public D0(int i10, int i11, InterfaceC6416C interfaceC6416C) {
        this.durationMillis = i10;
        this.delayMillis = i11;
        this.easing = interfaceC6416C;
        this.anim = new w0<>(new C6424K(getDurationMillis(), getDelayMillis(), interfaceC6416C));
    }
}
