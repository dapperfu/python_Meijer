...
public final class C6440a0<T> implements InterfaceC6415B<T> {
    ...
    public C6440a0(int i10) {
        this.delay = i10;
    }

    @Override // kotlin.InterfaceC6452i
    public <V extends AbstractC6460q> u0<V> a(o0<T, V> converter) {
        return new B0(this.delay);
    }

    public boolean equals(Object other) {
        return (other instanceof C6440a0) && ((C6440a0) other).delay == this.delay;
    }
    ...
    public /* synthetic */ C6440a0(int i10, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this((i11 & 1) != 0 ? 0 : i10);
    }
}
