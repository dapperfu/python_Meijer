...
public final class C14682w {
    ...
    public C14682w(boolean z10, boolean z11, int i10, boolean z12, boolean z13, int i11, int i12, int i13, int i14) {
        this.singleTop = z10;
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof C14682w)) {
            C14682w c14682w = (C14682w) other;
            if (this.singleTop == c14682w.singleTop && this.restoreState == c14682w.restoreState && this.popUpToId == c14682w.popUpToId && Intrinsics.e(this.popUpToRoute, c14682w.popUpToRoute) && this.popUpToInclusive == c14682w.popUpToInclusive && this.popUpToSaveState == c14682w.popUpToSaveState && this.enterAnim == c14682w.enterAnim && this.exitAnim == c14682w.exitAnim && this.popEnterAnim == c14682w.popEnterAnim && this.popExitAnim == c14682w.popExitAnim) {
                return true;
            }
        }
        return false;
    ...
    public String toString() {
        ...
        sb2.append(C14682w.class.getSimpleName());
        sb2.append("(");
        if (this.singleTop) {
    ...
    public C14682w(boolean z10, boolean z11, String str, boolean z12, boolean z13, int i10, int i11, int i12, int i13) {
        this(z10, z11, C14675p.INSTANCE.a(str).hashCode(), z12, z13, i10, i11, i12, i13);
