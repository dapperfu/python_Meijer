...
/* renamed from: Li.p, reason: from Kotlin metadata */
    ...
    static final class a implements MeasurePolicy {
        ...
        public final J d(K Layout, List<? extends I> measurables, long j10) {
            ...
            while (true) {
                ...
                next = it.next();
                if (Intrinsics.e(C5937w.a((I) next), "QuantityInput")) {
                    break;
                }
            }
            I i11 = (I) next;
            ...
            while (true) {
                ...
                next2 = it2.next();
                if (Intrinsics.e(C5937w.a((I) next2), "Margin")) {
                    break;
                }
            }
            I i12 = (I) next2;
            ...
            while (true) {
                ...
                next3 = it3.next();
                if (Intrinsics.e(C5937w.a((I) next3), "InlineNotification")) {
                    break;
                }
            }
            I i13 = (I) next3;
            ...
            return K.G0(Layout, i10, iJ02, null, new Function1() { // from class: Li.o
