...
final class C17966Q implements InterfaceC17934A {
    ...
    public /* synthetic */ C17966Q(long j10, long j11, long j12, long j13, long j14, long j15, long j16, long j17, long j18, long j19, long j20, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public /* synthetic */ class a {
        ...
        static {
            ...
            try {
                iArr[EnumC17174a.f162167c.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[EnumC17174a.f162166b.ordinal()] = 3;
    ...
    private C17966Q(long j10, long j11, long j12, long j13, long j14, long j15, long j16, long j17, long j18, long j19, long j20) {
    ...
    @Override // kotlin.InterfaceC17934A
    public z1<C5489q0> a(EnumC17174a enumC17174a, Composer composer, int i10) {
        long j10;
        int i11;
        ...
        EnumC17174a enumC17174a2 = EnumC17174a.f162166b;
        if (enumC17174a == enumC17174a2) {
        ...
        z1<C5489q0> z1VarA = t.a(j11, C6453j.l(i11, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        composer.P();
    ...
    @Override // kotlin.InterfaceC17934A
    public z1<C5489q0> b(boolean z10, EnumC17174a enumC17174a, Composer composer, int i10) {
        long j10;
        Composer composer2;
        z1<C5489q0> z1VarP;
        int i11;
        ...
        if (z10) {
            int i12 = a.$EnumSwitchMapping$0[enumC17174a.ordinal()];
            if (i12 != 1 && i12 != 2) {
                if (i12 == 3) {
            ...
            int i13 = a.$EnumSwitchMapping$0[enumC17174a.ordinal()];
            if (i13 != 1) {
                if (i13 != 2) {
                    if (i13 == 3) {
        ...
        if (z10) {
            ...
            if (enumC17174a == EnumC17174a.f162166b) {
                i11 = 100;
            } else {
                i11 = 50;
            }
            composer2 = composer;
            z1VarP = t.a(j11, C6453j.l(i11, 0, null, 6, null), null, null, composer2, 0, 12);
            composer2.P();
        } else {
            composer2 = composer;
    ...
    @Override // kotlin.InterfaceC17934A
    public z1<C5489q0> c(boolean z10, EnumC17174a enumC17174a, Composer composer, int i10) {
        long j10;
        Composer composer2;
        z1<C5489q0> z1VarP;
        int i11;
