...
public final class C14664e {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof C14664e)) {
            C14664e c14664e = (C14664e) other;
            if (this.destinationId == c14664e.destinationId && Intrinsics.e(this.navOptions, c14664e.navOptions)) {
                if (!Intrinsics.e(this.defaultArguments, c14664e.defaultArguments)) {
                    ...
                    if (bundle != null && (setKeySet = bundle.keySet()) != null) {
                        ...
                        if (!(set instanceof Collection) || !set.isEmpty()) {
                            for (String str : set) {
                                ...
                                Bundle bundle3 = c14664e.defaultArguments;
    ...
    public final C14682w getNavOptions() {
    ...
    public int hashCode() {
        ...
        C14682w c14682w = this.navOptions;
        int iHashCode2 = iHashCode + (c14682w != null ? c14682w.hashCode() : 0);
        Bundle bundle = this.defaultArguments;
        if (bundle != null && (setKeySet = bundle.keySet()) != null) {
    ...
    public String toString() {
        ...
        sb2.append(C14664e.class.getSimpleName());
        sb2.append("(0x");
