...
public final class k0<S> {
    ...
    private final InterfaceC5872l0 segment;

    /* renamed from: f, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5870k0 _playTimeNanos;

    /* renamed from: g, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5870k0 startTimeNanos;

    /* renamed from: h, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5872l0 updateChildrenNeeded;
    ...
    private final InterfaceC5872l0 isSeeking;
    ...
    @SourceDebugExtension
    public final class a<T, V extends AbstractC6460q> {
        ...
        public final class C1213a<T, V extends AbstractC6460q> implements z1<T> {
            ...
            public final Function1<b<S>, InterfaceC6419F<T>> l() {
            ...
            public final void p(Function1<? super b<S>, ? extends InterfaceC6419F<T>> function1) {
                this.transitionSpec = function1;
            }
        ...
        public final k0<S>.C1213a<T, V>.C0935a<T, V> b() {
            return (C1213a) this.data.getValue();
        }

        public final void c(k0<S>.C1213a<T, V>.C0935a<T, V> c1213a) {
            this.data.setValue(c1213a);
        }

        public final z1<T> a(Function1<? super b<S>, ? extends InterfaceC6419F<T>> transitionSpec, Function1<? super S, ? extends T> targetValueByState) {
            k0<S>.C1213a<T, V>.C0935a<T, V> c1213aB = b();
            if (c1213aB == null) {
                k0<S> k0Var = k0.this;
                c1213aB = new C1213a<>(k0Var.new d(targetValueByState.invoke(k0Var.h()), C6455l.i(this.typeConverter, targetValueByState.invoke(k0.this.h())), this.typeConverter, this.label), transitionSpec, targetValueByState);
                k0<S> k0Var2 = k0.this;
                c(c1213aB);
                k0Var2.c(c1213aB.f());
            }
            k0<S> k0Var3 = k0.this;
            c1213aB.m(targetValueByState);
            c1213aB.p(transitionSpec);
            c1213aB.t(k0Var3.m());
            return c1213aB;
        }
        ...
        public final void d() {
            ...
            if (c1213aB != null) {
                k0<S> k0Var = k0.this;
                c1213aB.f().S(c1213aB.k().invoke(k0Var.m().b()), c1213aB.k().invoke(k0Var.m().a()), c1213aB.l().invoke(k0Var.m()));
            }
        }
    }
    ...
    public final class d<T, V extends AbstractC6460q> implements z1<T> {
        ...
        /* renamed from: d, reason: collision with root package name and from kotlin metadata */
        private final C6446d0<T> defaultSpring;

        /* renamed from: e, reason: collision with root package name and from kotlin metadata */
        private final InterfaceC5872l0 animationSpec;

        /* renamed from: f, reason: collision with root package name and from kotlin metadata */
        private final InterfaceC5872l0 animation;

        /* renamed from: g, reason: collision with root package name and from kotlin metadata */
        private j0<T, V> initialValueAnimation;

        /* renamed from: h, reason: collision with root package name and from kotlin metadata */
        private final InterfaceC5872l0 isFinished;

        /* renamed from: i, reason: collision with root package name and from kotlin metadata */
        private final InterfaceC5866i0 resetSnapValue;
        ...
        /* renamed from: m, reason: collision with root package name and from kotlin metadata */
        private final InterfaceC5870k0 durationNanos;

        /* renamed from: n, reason: collision with root package name and from kotlin metadata */
        private boolean isSeeking;

        /* renamed from: o, reason: collision with root package name and from kotlin metadata */
        private final InterfaceC6419F<T> interruptionSpec;

        public final C6438Z.b m() {
            return null;
        }
        ...
        public d(T t10, V v10, o0<T, V> o0Var, String str) {
            ...
            C6446d0<T> c6446d0J = C6453j.j(0.0f, 0.0f, null, 7, null);
            this.defaultSpring = c6446d0J;
            this.animationSpec = t1.e(c6446d0J, null, 2, null);
            this.animation = t1.e(new j0(k(), o0Var, t10, t(), v10), null, 2, null);
            ...
            this.interruptionSpec = C6453j.j(0.0f, 0.0f, tInvoke, 3, null);
        }
        ...
        private final void K(InterfaceC6419F<T> interfaceC6419F) {
            this.animationSpec.setValue(interfaceC6419F);
        }
        ...
        private final void Q(T initialValue, boolean isInterrupted) {
            ...
            if (Intrinsics.e(j0Var != null ? j0Var.g() : null, t())) {
                H(new j0<>(this.interruptionSpec, this.typeConverter, initialValue, initialValue, C6461r.g(this.velocityVector)));
                this.useOnlyInitialValue = true;
                L(f().getDurationNanos());
                return;
            }
            InterfaceC6452i interfaceC6452iK = (!isInterrupted || this.isSeeking || (k() instanceof C6446d0)) ? k() : this.interruptionSpec;
            if (k0.this.l() > 0) {
                interfaceC6452iK = C6453j.c(interfaceC6452iK, k0.this.l());
            }
            H(new j0<>(interfaceC6452iK, this.typeConverter, initialValue, t(), this.velocityVector));
            L(f().getDurationNanos());
        ...
        public final void T(T targetValue, InterfaceC6419F<T> animationSpec) {
            ...
            if (Intrinsics.e(t(), targetValue) && p() == -1.0f) {
                return;
            }
            O(targetValue);
            K(animationSpec);
            Q(p() == -3.0f ? targetValue : getValue(), !u());
            M(p() == -3.0f);
            if (p() >= 0.0f) {
        ...
        public final InterfaceC6419F<T> k() {
            return (InterfaceC6419F) this.animationSpec.getValue();
        }
        ...
        public final void S(T initialValue, T targetValue, InterfaceC6419F<T> animationSpec) {
            O(targetValue);
            K(animationSpec);
    ...
    static final class e extends Lambda implements Function1<F, E> {
        ...
        final /* synthetic */ InterfaceC15783O f60960f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ k0<S> f60961g;

        @Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0003\u001a\u00020\u0002\"\u0004\b\u0000\u0010\u0000*\u00020\u0001H\u008a@¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"S", "Lmv/O;", "", "<anonymous>", "(Lmv/O;)V"}, k = 3, mv = {1, 9, 0})
        ...
        static final class a extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
            ...
            private /* synthetic */ Object f60964c;

            /* renamed from: d, reason: collision with root package name */
            final /* synthetic */ k0<S> f60965d;

            @Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0004\u001a\u00020\u0003\"\u0004\b\u0000\u0010\u00002\u0006\u0010\u0002\u001a\u00020\u0001H\n¢\u0006\u0004\b\u0004\u0010\u0005"}, d2 = {"S", "", "it", "", "a", "(J)V"}, k = 3, mv = {1, 9, 0})
            /* renamed from: c0.k0$e$a$a, reason: collision with other inner class name */
            static final class C1214a extends Lambda implements Function1<Long, Unit> {

                /* renamed from: f, reason: collision with root package name */
                final /* synthetic */ k0<S> f60966f;

                /* renamed from: g, reason: collision with root package name */
                final /* synthetic */ float f60967g;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C1214a(k0<S> k0Var, float f10) {
                    super(1);
                    this.f60966f = k0Var;
                    this.f60967g = f10;
                }
                ...
                public final void a(long j10) {
                    ...
                    this.f60966f.w(j10, this.f60967g);
                }
            ...
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                a aVar = new a(this.f60965d, continuation);
                aVar.f60964c = obj;
                return aVar;
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i10 != 0) {
                    if (i10 == 1) {
                        fN = this.f60962a;
                        interfaceC15783O = (InterfaceC15783O) this.f60964c;
                        ResultKt.b(obj);
                    } else {
                    ...
                    ResultKt.b(obj);
                    InterfaceC15783O interfaceC15783O2 = (InterfaceC15783O) this.f60964c;
                    fN = i0.n(interfaceC15783O2.getCoroutineContext());
                    interfaceC15783O = interfaceC15783O2;
                }
                while (C15784P.i(interfaceC15783O)) {
                    C1214a c1214a = new C1214a(this.f60965d, fN);
                    this.f60964c = interfaceC15783O;
                    this.f60962a = fN;
                    this.f60963b = 1;
                    if (C5854d0.c(c1214a, this) == objF) {
                        return objF;
                    }
                }
                return Unit.f143329a;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        e(InterfaceC15783O interfaceC15783O, k0<S> k0Var) {
            super(1);
            this.f60960f = interfaceC15783O;
            this.f60961g = k0Var;
        }
        ...
        public final E invoke(F f10) {
            C15809k.d(this.f60960f, null, EnumC15785Q.f151688d, new a(this.f60961g, null), 1, null);
            return new b();
        }
    }
    ...
    static final class f extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ k0<S> f60968f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ S f60969g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f60970h;
        ...
        public final void a(Composer composer, int i10) {
            this.f60968f.e(this.f60969g, composer, J0.a(this.f60970h | 1));
        }
    ...
    static final class g extends Lambda implements Function0<Long> {
        ...
        public final Long invoke() {
            return Long.valueOf(this.f60971f.f());
        }
    }
    ...
    public final void A(k0<S>.a<?, ?> deferredAnimation) {
        k0<S>.d<?, ?> dVarF;
        k0<S>.C1213a<?, ?>.C0935a<?, V> c1213aB = deferredAnimation.b();
        if (c1213aB != 0 && (dVarF = c1213aB.f()) != null) {
            B(dVarF);
        }
    }
        ...
        if (composerStartRestartGroup.p(z10, i11 & 1)) {
            ...
            if (!t()) {
                ...
                if (Intrinsics.e(s10, h()) && !s() && !q()) {
                    ...
                    boolean zD2 = composerStartRestartGroup.D(interfaceC15783O);
                    int i14 = i11 & 112;
                    if (i14 == 32) {
                        z11 = true;
                    }
                    ...
                    if (z12 || objB2 == companion.a()) {
                        objB2 = new e(interfaceC15783O, this);
                        composerStartRestartGroup.t(objB2);
                    }
                    J.b(interfaceC15783O, this, (Function1) objB2, composerStartRestartGroup, i14);
                    composerStartRestartGroup.P();
                }
                composerStartRestartGroup.P();
            } else {
