    ...
    private static class a extends AbstractList<Integer> implements RandomAccess, Serializable {
        ...
        public boolean equals(Object obj) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                if (this.f15710a[this.f15711b + i10] != aVar.f15710a[aVar.f15711b + i10]) {
                    return false;
                }
            }
            return true;
        ...
        public boolean contains(Object obj) {
            return (obj instanceof Integer) && f.i(this.f15710a, ((Integer) obj).intValue(), this.f15711b, this.f15712c) != -1;
        }

        int[] f() {
            return Arrays.copyOfRange(this.f15710a, this.f15711b, this.f15712c);
        }

        @Override // java.util.AbstractList, java.util.Collection, java.util.List
        public int hashCode() {
            int iH = 1;
            for (int i10 = this.f15711b; i10 < this.f15712c; i10++) {
                iH = (iH * 31) + f.h(this.f15710a[i10]);
            }
            return iH;
        }
        ...
        public int indexOf(Object obj) {
            int i10;
            if (!(obj instanceof Integer) || (i10 = f.i(this.f15710a, ((Integer) obj).intValue(), this.f15711b, this.f15712c)) < 0) {
                return -1;
            }
            return i10 - this.f15711b;
        }

        @Override // java.util.AbstractList, java.util.List
        public int lastIndexOf(Object obj) {
            int iJ;
            if (!(obj instanceof Integer) || (iJ = f.j(this.f15710a, ((Integer) obj).intValue(), this.f15711b, this.f15712c)) < 0) {
                return -1;
            }
            return iJ - this.f15711b;
        }

        @Override // java.util.AbstractCollection, java.util.Collection, java.util.List
        public int size() {
            return this.f15712c - this.f15711b;
        }
        ...
        public String toString() {
            ...
            sb2.append('[');
            sb2.append(this.f15710a[this.f15711b]);
        ...
        public Integer get(int i10) {
            p.o(i10, size());
            return Integer.valueOf(this.f15710a[this.f15711b + i10]);
        }
