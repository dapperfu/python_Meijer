...
public final class z {
    ...
    private static final ArrayList<a> f45076a = new ArrayList<>();

    /* renamed from: b, reason: collision with root package name */
    private static final Pattern f45077b = Pattern.compile("^mp4a\\.([a-zA-Z0-9]{2})(?:\\.([0-9]{1,2}))?$");
    ...
    private static String e(String str) {
        int size = f45076a.size();
        for (int i10 = 0; i10 < size; i10++) {
            a aVar = f45076a.get(i10);
            if (str.startsWith(aVar.f45079b)) {
                return aVar.f45078a;
            }
        }
        return null;
