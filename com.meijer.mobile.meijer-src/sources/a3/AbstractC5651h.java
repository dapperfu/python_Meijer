...
public abstract class AbstractC5651h implements B {

    /* renamed from: a, reason: collision with root package name */
    protected final F.c f44649a = new F.c();
    ...
    public final boolean T() {
        F fY = y();
        if (!fY.q() && fY.n(W(), this.f44649a).f44440h) {
            return true;
        }
        return false;
    }
    ...
    public final boolean w() {
        F fY = y();
        if (!fY.q() && fY.n(W(), this.f44649a).f44441i) {
            return true;
        }
        return false;
    }
