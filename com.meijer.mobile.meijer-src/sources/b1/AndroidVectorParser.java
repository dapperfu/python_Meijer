...
public final /* data */ class AndroidVectorParser {
    ...
    public final boolean d(TypedArray typedArray, String attrName, int resId, boolean defaultValue) {
        boolean zE = C6330k.e(typedArray, this.xmlParser, attrName, resId, defaultValue);
        l(typedArray.getChangingConfigurations());
        return zE;
    }

    public final ColorStateList e(TypedArray typedArray, Resources.Theme theme, String attrName, int resId) {
        ColorStateList colorStateListG = C6330k.g(typedArray, this.xmlParser, theme, attrName, resId);
        l(typedArray.getChangingConfigurations());
        return colorStateListG;
    }

    public final C6323d f(TypedArray typedArray, Resources.Theme theme, String attrName, int resId, int defaultValue) {
        C6323d c6323dI = C6330k.i(typedArray, this.xmlParser, theme, attrName, resId, defaultValue);
        l(typedArray.getChangingConfigurations());
        return c6323dI;
    }

    public final float g(TypedArray typedArray, String attrName, int resId, float defaultValue) {
        float fJ = C6330k.j(typedArray, this.xmlParser, attrName, resId, defaultValue);
        l(typedArray.getChangingConfigurations());
        return fJ;
    }

    public final int h(TypedArray typedArray, String attrName, int resId, int defaultValue) {
        int iK = C6330k.k(typedArray, this.xmlParser, attrName, resId, defaultValue);
        l(typedArray.getChangingConfigurations());
        return iK;
    }
    ...
    public final TypedArray k(Resources res, Resources.Theme theme, AttributeSet set, int[] attrs) {
        TypedArray typedArrayQ = C6330k.q(res, theme, set, attrs);
