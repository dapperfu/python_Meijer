...
@Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0000\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u000f\u0010\u0007\u001a\u00020\u0006H\u0016¢\u0006\u0004\b\u0007\u0010\bR\u001a\u0010\u0003\u001a\u00020\u00028\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u0007\u0010\t\u001a\u0004\b\n\u0010\u000b¨\u0006\f"}, d2 = {"LRv/x;", "LRv/j;", "LRv/v;", "routePlanner", "<init>", "(LRv/v;)V", "LRv/p;", "a", "()LRv/p;", "LRv/v;", "b", "()LRv/v;", "okhttp"}, k = 1, mv = {2, 2, 0}, xi = 48)
...
public final class x implements j {
    ...
    public p a() throws Throwable {
        ...
        while (!getRoutePlanner().isCanceled()) {
            ...
            if (!bVarE.getIsReady()) {
                v.ConnectResult connectResultH = bVarE.h();
                if (connectResultH.f()) {
                    connectResultH = bVarE.getResult();
                }
                ...
                if (nextPlan != null) {
                    getRoutePlanner().d().addFirst(nextPlan);
                }
            }
            return bVarE.getConnection();
        }
