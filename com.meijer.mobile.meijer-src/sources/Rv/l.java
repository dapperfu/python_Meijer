...
@Metadata(d1 = {"\u0000P\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u000b\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0000\u0018\u00002\u00020\u0001B\u0017\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0006\u0010\u0007J\u0011\u0010\t\u001a\u0004\u0018\u00010\bH\u0002¢\u0006\u0004\b\t\u0010\nJ!\u0010\u000f\u001a\u0004\u0018\u00010\b2\u0006\u0010\f\u001a\u00020\u000b2\u0006\u0010\u000e\u001a\u00020\rH\u0002¢\u0006\u0004\b\u000f\u0010\u0010J\u000f\u0010\u0012\u001a\u00020\u0011H\u0002¢\u0006\u0004\b\u0012\u0010\u0013J\u000f\u0010\u0015\u001a\u00020\u0014H\u0016¢\u0006\u0004\b\u0015\u0010\u0016R\u001a\u0010\u0003\u001a\u00020\u00028\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u0015\u0010\u0017\u001a\u0004\b\u0018\u0010\u0019R\u0014\u0010\u0005\u001a\u00020\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0018\u0010\u001aR\u0014\u0010\u001d\u001a\u00020\u000b8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001b\u0010\u001cR\u0016\u0010\u001f\u001a\u00020\u000b8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u001e\u0010\u001cR\u001a\u0010#\u001a\b\u0012\u0004\u0012\u00020!0 8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u000f\u0010\"R\"\u0010'\u001a\u0010\u0012\f\u0012\n %*\u0004\u0018\u00010\b0\b0$8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0012\u0010&¨\u0006("}, d2 = {"LRv/l;", "LRv/j;", "LRv/v;", "routePlanner", "LQv/d;", "taskRunner", "<init>", "(LRv/v;LQv/d;)V", "LRv/v$a;", "g", "()LRv/v$a;", "", "timeout", "Ljava/util/concurrent/TimeUnit;", "unit", "e", "(JLjava/util/concurrent/TimeUnit;)LRv/v$a;", "", "f", "()V", "LRv/p;", "a", "()LRv/p;", "LRv/v;", "b", "()LRv/v;", "LQv/d;", "c", "J", "connectDelayNanos", "d", "nextTcpConnectAtNanos", "Ljava/util/concurrent/CopyOnWriteArrayList;", "LRv/v$b;", "Ljava/util/concurrent/CopyOnWriteArrayList;", "tcpConnectsInFlight", "Ljava/util/concurrent/BlockingQueue;", "kotlin.jvm.PlatformType", "Ljava/util/concurrent/BlockingQueue;", "connectResults", "okhttp"}, k = 1, mv = {2, 2, 0}, xi = 48)
...
public final class l implements j {
    ...
    @Metadata(d1 = {"\u0000\u0011\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\t\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u000f\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0003\u0010\u0004¨\u0006\u0005"}, d2 = {"Rv/l$a", "LQv/a;", "", "f", "()J", "okhttp"}, k = 1, mv = {2, 2, 0}, xi = 48)
    public static final class a extends Qv.a {

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ v.b f34130e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ l f34131f;
        ...
        public long f() throws InterruptedException {
            ...
            try {
                connectResult = this.f34130e.h();
            } catch (Throwable th2) {
                connectResult = new v.ConnectResult(this.f34130e, null, th2, 2, null);
            }
            if (!this.f34131f.tcpConnectsInFlight.contains(this.f34130e)) {
                return -1L;
            }
            this.f34131f.connectResults.put(connectResult);
            return -1L;
        }
    }
    ...
    public p a() throws IOException {
        ...
        while (true) {
            try {
                if (this.tcpConnectsInFlight.isEmpty() && !v.a(getRoutePlanner(), null, 1, null)) {
                    f();
                ...
                if (connectResultG != null || (connectResultG = e(j10, TimeUnit.NANOSECONDS)) != null) {
                    if (connectResultG.f()) {
                        ...
                        if (!connectResultG.getPlan().getIsReady()) {
                            connectResultG = connectResultG.getPlan().getResult();
                        }
                        if (connectResultG.f()) {
                    ...
                    if (bVarC != null) {
                        getRoutePlanner().d().addFirst(bVarC);
                    }
                }
            } finally {
                f();
    ...
    public l(v routePlanner, Qv.d taskRunner) {
    ...
    private final void f() {
        ...
        while (it.hasNext()) {
            ...
            v.b bVarG = next.g();
            if (bVarG != null) {
                getRoutePlanner().d().addLast(bVarG);
            }
        }
    ...
    private final v.ConnectResult g() throws IOException {
        v.b kVar;
        if (v.a(getRoutePlanner(), null, 1, null)) {
            try {
                kVar = getRoutePlanner().e();
            } catch (Throwable th2) {
                kVar = new k(th2);
            }
            if (kVar.getIsReady()) {
            ...
            Qv.c.m(this.taskRunner.k(), new a(Nv.k.f22782c + " connect " + getRoutePlanner().getAddress().getUrl().v(), kVar, this), 0L, 2, null);
        }
        return null;
    }
}
