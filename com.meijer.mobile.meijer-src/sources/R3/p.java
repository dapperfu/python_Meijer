...
public final class p {
    ...
    public static final class a {
        ...
        public final UUID[] f31807d;

        a(UUID uuid, int i10, byte[] bArr, UUID[] uuidArr) {
            this.f31804a = uuid;
            this.f31805b = i10;
            this.f31806c = bArr;
            this.f31807d = uuidArr;
        }
    }
    ...
    public static byte[] e(byte[] bArr, UUID uuid) {
        ...
        if (!uuid.equals(aVarD.f31804a)) {
            d3.r.i("PsshAtomUtil", "UUID mismatch. Expected: " + uuid + ", got: " + aVarD.f31804a + ".");
            return null;
        }
        return aVarD.f31806c;
    }
