...
public class n extends v {
    ...
    private static final Comparator<? super w> f36065j = new a();

    /* renamed from: e, reason: collision with root package name */
    private String f36066e;

    /* renamed from: f, reason: collision with root package name */
    private double[] f36067f;

    /* renamed from: g, reason: collision with root package name */
    private List<w> f36068g;

    /* renamed from: h, reason: collision with root package name */
    private List<w> f36069h;

    /* renamed from: i, reason: collision with root package name */
    private RectF f36070i;
    ...
    private void j(XmlPullParser xmlPullParser) {
        ...
        if (TextUtils.isEmpty(strA)) {
            this.f36067f = new double[0];
            return;
        }
        String[] strArrSplit = strA.split(" ");
        this.f36067f = new double[strArrSplit.length];
        for (int i10 = 0; i10 < strArrSplit.length; i10++) {
            this.f36067f[i10] = Double.parseDouble(strArrSplit[i10]);
        }
    }
    ...
    public float q() {
        return this.f36070i.width();
    }

    @Override // Ta.v, com.flipp.sfml.SFTag
    protected void b(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        super.b(xmlPullParser);
        j(xmlPullParser);
        g(xmlPullParser);
        this.f36070i = ((Ua.e) Sa.c.c(Ua.e.class)).g(d(xmlPullParser, "rect", true));
    }
        ...
        while (xmlPullParser.next() != 3) {
            if (xmlPullParser.getEventType() == 2) {
                ...
                if (!name.equals("area")) {
                    ...
                    this.f36068g.add(wVar);
                    this.f36069h.add(wVar);
                }
            }
        }
    }
