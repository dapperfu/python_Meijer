...
public final class F {
    ...
    public static final int f172211f = 8;

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private String text;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private C18432o buffer;
    ...
    public final void c(int start, int end, String text) {
        ...
        C18432o c18432o = this.buffer;
        if (c18432o != null) {
            int i10 = this.bufStart;
            int i11 = start - i10;
            int i12 = end - i10;
            if (i11 >= 0 && i12 <= c18432o.e()) {
                c18432o.g(i11, i12, text);
                return;
            }
            this.text = toString();
            this.buffer = null;
        ...
        int iMax = Math.max(l3.f93323c, text.length() + 128);
        char[] cArr = new char[iMax];
        int iMin = Math.min(start, 64);
        int iMin2 = Math.min(this.text.length() - end, 64);
        int i13 = start - iMin;
        C18434q.a(this.text, cArr, 0, i13, start);
        int i14 = iMax - iMin2;
        int i15 = iMin2 + end;
        C18434q.a(this.text, cArr, i14, end, i15);
        C18433p.b(text, cArr, iMin);
        this.buffer = new C18432o(cArr, iMin + text.length(), i14);
        this.bufStart = i13;
        this.bufEnd = i15;
    }
    ...
    public final char a(int index) {
        ...
        int iE = c18432o.e();
        int i10 = this.bufStart;
        return index < iE + i10 ? c18432o.d(index - i10) : this.text.charAt(index - ((iE - this.bufEnd) + i10));
    }

    public final int b() {
        C18432o c18432o = this.buffer;
        return c18432o == null ? this.text.length() : (this.text.length() - (this.bufEnd - this.bufStart)) + c18432o.e();
    }
