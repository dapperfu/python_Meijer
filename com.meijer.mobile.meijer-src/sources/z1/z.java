...
class z extends x {
    public z(InputConnection inputConnection, Function1<? super InterfaceInputConnectionC18438v, Unit> function1) {
        super(inputConnection, function1);
    }

    @Override // z1.C18439w, android.view.inputmethod.InputConnection
