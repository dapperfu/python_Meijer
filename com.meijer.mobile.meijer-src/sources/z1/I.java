...
public interface I {
    ...
    void d(TextFieldValue value, ImeOptions imeOptions, Function1<? super List<? extends InterfaceC18426i>, Unit> onEditCommand, Function1<? super androidx.compose.ui.text.input.a, Unit> onImeActionPerformed);

    void e(TextFieldValue oldValue, TextFieldValue newValue);

    void f();

    default void g(TextFieldValue textFieldValue, InterfaceC18417E offsetMapping, TextLayoutResult textLayoutResult, Function1<? super C5474k1, Unit> textFieldToRootTransform, Rect innerTextFieldBounds, Rect decorationBoxBounds) {
    }
