...
public final class DeleteSurroundingTextInCodePointsCommand implements InterfaceC18426i {
    ...
    public void a(C18429l buffer) {
        ...
        while (true) {
            if (i12 < i10) {
                ...
                if (buffer.getSelectionStart() <= i13) {
                    ...
                    selectionStart = C18427j.b(buffer.c((buffer.getSelectionStart() - i13) + (-1)), buffer.c(buffer.getSelectionStart() - i13)) ? selectionStart + 2 : i13;
                    i12++;
                }
            } else {
                break;
        ...
        while (true) {
            ...
            if (buffer.getSelectionEnd() + i15 >= buffer.h()) {
                ...
                iH = C18427j.b(buffer.c((buffer.getSelectionEnd() + i15) + (-1)), buffer.c(buffer.getSelectionEnd() + i15)) ? iH + 2 : i15;
                i11++;
            }
        }
