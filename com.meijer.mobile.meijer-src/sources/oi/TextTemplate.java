...
public final /* data */ class TextTemplate {
    ...
    public /* synthetic */ TextTemplate(Modifier modifier, long j10, long j11, C18280w c18280w, FontWeight fontWeight, AbstractC18269l abstractC18269l, long j12, F1.k kVar, F1.j jVar, long j13, int i10, boolean z10, int i11, Function1 function1, Function2 function2, DefaultConstructorMarker defaultConstructorMarker) {
        this(modifier, j10, j11, c18280w, fontWeight, abstractC18269l, j12, kVar, jVar, j13, i10, z10, i11, function1, function2);
    }
    ...
    public int hashCode() {
        int iHashCode = ((((this.modifier.hashCode() * 31) + C5489q0.y(this.color)) * 31) + H1.v.i(this.fontSize)) * 31;
        C18280w c18280w = this.fontStyle;
        int iG = (iHashCode + (c18280w == null ? 0 : C18280w.g(c18280w.getValue()))) * 31;
        FontWeight fontWeight = this.fontWeight;
        int iHashCode2 = (iG + (fontWeight == null ? 0 : fontWeight.hashCode())) * 31;
        AbstractC18269l abstractC18269l = this.fontFamily;
        int iHashCode3 = (((iHashCode2 + (abstractC18269l == null ? 0 : abstractC18269l.hashCode())) * 31) + H1.v.i(this.letterSpacing)) * 31;
    ...
    public String toString() {
        return "TextTemplate(modifier=" + this.modifier + ", color=" + ((Object) C5489q0.z(this.color)) + ", fontSize=" + ((Object) H1.v.j(this.fontSize)) + ", fontStyle=" + this.fontStyle + ", fontWeight=" + this.fontWeight + ", fontFamily=" + this.fontFamily + ", letterSpacing=" + ((Object) H1.v.j(this.letterSpacing)) + ", textDecoration=" + this.textDecoration + ", textAlign=" + this.textAlign + ", lineHeight=" + ((Object) H1.v.j(this.lineHeight)) + ", overflow=" + ((Object) F1.t.i(this.overflow)) + ", softWrap=" + this.softWrap + ", maxLines=" + this.maxLines + ", onTextLayout=" + this.onTextLayout + ", style=" + this.style + ')';
    }

    /* JADX WARN: Illegal instructions before constructor call */
    public /* synthetic */ TextTemplate(Modifier modifier, long j10, long j11, C18280w c18280w, FontWeight fontWeight, AbstractC18269l abstractC18269l, long j12, F1.k kVar, F1.j jVar, long j13, int i10, boolean z10, int i11, Function1 function1, Function2 function2, int i12, DefaultConstructorMarker defaultConstructorMarker) {
        Modifier modifier2 = (i12 & 1) != 0 ? Modifier.INSTANCE : modifier;
        long j14 = (i12 & 2) != 0 ? C5489q0.INSTANCE.j() : j10;
        long jA = (i12 & 4) != 0 ? H1.v.INSTANCE.a() : j11;
        C18280w c18280w2 = (i12 & 8) != 0 ? null : c18280w;
        FontWeight fontWeight2 = (i12 & 16) != 0 ? null : fontWeight;
        AbstractC18269l abstractC18269l2 = (i12 & 32) != 0 ? null : abstractC18269l;
        ...
        long j15 = jA2;
        F1.k kVar3 = kVar2;
        this(modifier3, j14, jA, c18280w2, fontWeight3, abstractC18269l3, j15, kVar3, jVar2, jA3, iA, z11, (i12 & RecyclerView.m.FLAG_APPEARED_IN_PRE_LAYOUT) != 0 ? a.e.API_PRIORITY_OTHER : i11, (i12 & 8192) != 0 ? new Function1() { // from class: oi.K1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return TextTemplate.b((TextLayoutResult) obj);
            }
        } : function1, (i12 & 16384) != 0 ? a.f153975a : function2, null);
    }
}
