...
public class k extends com.google.zxing.b {
    ...
    private static final byte[] f14537d = new byte[0];

    /* renamed from: b, reason: collision with root package name */
    private byte[] f14538b;
    ...
    private void h(int i10) {
        if (this.f14538b.length < i10) {
            this.f14538b = new byte[i10];
        }
    ...
    public k(com.google.zxing.h hVar) {
        super(hVar);
        this.f14538b = f14537d;
        this.f14539c = new int[32];
    }
    ...
    public b b() throws NotFoundException {
        ...
        for (int i10 = 1; i10 < 5; i10++) {
            byte[] bArrC = hVarE.c((iA * i10) / 5, this.f14538b);
            int i11 = (iD * 4) / 5;
    ...
    public a c(int i10, a aVar) throws NotFoundException {
        ...
        h(iD);
        byte[] bArrC = hVarE.c(i10, this.f14538b);
        int[] iArr = this.f14539c;
