...
public final class o {
    ...
    private final float f14554g;

    /* renamed from: h, reason: collision with root package name */
    private final float f14555h;

    /* renamed from: i, reason: collision with root package name */
    private final float f14556i;
    ...
    o a() {
        float f10 = this.f14552e;
        float f11 = this.f14556i;
        float f12 = this.f14553f;
        float f13 = this.f14555h;
        float f14 = (f10 * f11) - (f12 * f13);
        float f15 = this.f14554g;
        float f16 = this.f14551d;
        float f17 = (f12 * f15) - (f16 * f11);
        float f18 = (f16 * f13) - (f10 * f15);
        float f19 = this.f14550c;
        float f20 = this.f14549b;
        float f21 = (f19 * f13) - (f20 * f11);
        float f22 = this.f14548a;
        return new o(f14, f17, f18, f21, (f11 * f22) - (f19 * f15), (f15 * f20) - (f13 * f22), (f20 * f12) - (f19 * f10), (f19 * f16) - (f12 * f22), (f22 * f10) - (f20 * f16));
    }

    o e(o oVar) {
        float f10 = this.f14548a;
        float f11 = oVar.f14548a;
        float f12 = this.f14551d;
        float f13 = oVar.f14549b;
        float f14 = this.f14554g;
        float f15 = oVar.f14550c;
        float f16 = (f10 * f11) + (f12 * f13) + (f14 * f15);
        float f17 = oVar.f14551d;
        float f18 = oVar.f14552e;
        float f19 = oVar.f14553f;
        float f20 = (f10 * f17) + (f12 * f18) + (f14 * f19);
        float f21 = oVar.f14554g;
        float f22 = oVar.f14555h;
        float f23 = oVar.f14556i;
        float f24 = (f10 * f21) + (f12 * f22) + (f14 * f23);
        float f25 = this.f14549b;
        float f26 = this.f14552e;
        float f27 = (f25 * f11) + (f26 * f13);
        float f28 = this.f14555h;
        float f29 = f27 + (f28 * f15);
        float f30 = (f25 * f17) + (f26 * f18) + (f28 * f19);
        float f31 = (f25 * f21) + (f26 * f22) + (f28 * f23);
        float f32 = this.f14550c;
        float f33 = f11 * f32;
        float f34 = this.f14553f;
        float f35 = f33 + (f13 * f34);
        float f36 = this.f14556i;
        return new o(f16, f20, f24, f29, f30, f31, f35 + (f15 * f36), (f32 * f17) + (f18 * f34) + (f19 * f36), (f32 * f21) + (f34 * f22) + (f36 * f23));
    }

    public void f(float[] fArr) {
        float f10 = this.f14548a;
        float f11 = this.f14549b;
        float f12 = this.f14550c;
        float f13 = this.f14551d;
        float f14 = this.f14552e;
        float f15 = this.f14553f;
        float f16 = this.f14554g;
        float f17 = this.f14555h;
        float f18 = this.f14556i;
