...
public final class f {
    ...
    private static final List<e> f154651f;

    /* renamed from: g, reason: collision with root package name */
    private static final List<e> f154652g;

    /* renamed from: h, reason: collision with root package name */
    @JvmField
    public static final f f154653h;

    /* renamed from: i, reason: collision with root package name */
    @JvmField
    public static final f f154654i;

    /* renamed from: j, reason: collision with root package name */
    @JvmField
    public static final f f154655j;

    /* renamed from: k, reason: collision with root package name */
    @JvmField
    public static final f f154656k;
    ...
    static {
        ...
        f154651f = listP;
        List<e> listP2 = CollectionsKt.p(eVar, eVar2, eVar3, eVar4, eVar5, eVar6, eVar7, eVar8, eVar9, e.f154550L0, e.f154552M0, e.f154606j0, e.f154609k0, e.f154541H, e.f154549L, e.f154611l);
        f154652g = listP2;
        a aVar = new a(true);
        ...
        l lVar = l.f154730c;
        l lVar2 = l.f154731d;
        f154653h = aVarC.f(lVar, lVar2).d(true).a();
        a aVar2 = new a(true);
        e[] eVarArr2 = (e[]) listP2.toArray(new e[0]);
        f154654i = aVar2.c((e[]) Arrays.copyOf(eVarArr2, eVarArr2.length)).f(lVar, lVar2).d(true).a();
        a aVar3 = new a(true);
        e[] eVarArr3 = (e[]) listP2.toArray(new e[0]);
        f154655j = aVar3.c((e[]) Arrays.copyOf(eVarArr3, eVarArr3.length)).f(lVar, lVar2, l.f154732e, l.f154733f).d(true).a();
        f154656k = new a(false).a();
    }
    ...
    public final boolean e(SSLSocket socket) {
        ...
        if (strArr != null && !Nv.h.n(strArr, socket.getEnabledProtocols(), ComparisonsKt.f())) {
            return false;
        }
        String[] strArr2 = this.cipherSuitesAsString;
        return strArr2 == null || Nv.h.n(strArr2, socket.getEnabledCipherSuites(), e.INSTANCE.c());
    }
    ...
    private final f g(SSLSocket sslSocket, boolean isFallback) {
        ...
        String[] strArrC = Nv.a.c(this, enabledCipherSuites);
        if (this.tlsVersionsAsString != null) {
            String[] enabledProtocols2 = sslSocket.getEnabledProtocols();
            Intrinsics.i(enabledProtocols2, "getEnabledProtocols(...)");
            enabledProtocols = Nv.h.w(enabledProtocols2, this.tlsVersionsAsString, ComparisonsKt.f());
        } else {
            enabledProtocols = sslSocket.getEnabledProtocols();
        }
        String[] supportedCipherSuites = sslSocket.getSupportedCipherSuites();
        Intrinsics.g(supportedCipherSuites);
        int iO = Nv.h.o(supportedCipherSuites, "TLS_FALLBACK_SCSV", e.INSTANCE.c());
        if (isFallback && iO != -1) {
            String str = supportedCipherSuites[iO];
            Intrinsics.i(str, "get(...)");
            strArrC = Nv.h.g(strArrC, str);
        }
