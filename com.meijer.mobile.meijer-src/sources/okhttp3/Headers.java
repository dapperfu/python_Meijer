...
public final class Headers implements Iterable<Pair<? extends String, ? extends String>>, KMappedMarker {
    ...
    @JvmField
    public static final Headers f154305c = new Headers(new String[0]);
    ...
    public static final class a {
        ...
        public final a a(String name, String value) {
            ...
            return Nv.e.b(this, name, value);
        }

        public final a b(Headers headers) {
            Intrinsics.j(headers, "headers");
            return Nv.e.c(this, headers);
        }

        public final a c(String line) {
            Intrinsics.j(line, "line");
            int iP0 = StringsKt.p0(line, ':', 1, false, 4, null);
            if (iP0 != -1) {
                String strSubstring = line.substring(0, iP0);
                Intrinsics.i(strSubstring, "substring(...)");
                String strSubstring2 = line.substring(iP0 + 1);
        ...
        public final a i(String name) {
            Intrinsics.j(name, "name");
            return Nv.e.n(this, name);
        }

        public final a j(String name, String value) {
            Intrinsics.j(name, "name");
            Intrinsics.j(value, "value");
            return Nv.e.o(this, name, value);
        }
    ...
    public static final class Companion {
        ...
        public final Headers b(String... namesAndValues) {
            ...
            return Nv.e.j((String[]) Arrays.copyOf(namesAndValues, namesAndValues.length));
        }
    }
    ...
    public final String get(String name) {
        Intrinsics.j(name, "name");
        return Nv.e.i(this.namesAndValues, name);
    }

    public final Set<String> names() {
        TreeSet treeSet = new TreeSet(StringsKt.J(StringCompanionObject.f143748a));
        int size = size();
    ...
    public final Map<String, List<String>> o() {
        TreeMap treeMap = new TreeMap(StringsKt.J(StringCompanionObject.f143748a));
        int size = size();
        for (int i10 = 0; i10 < size; i10++) {
            String strH = h(i10);
            Locale US = Locale.US;
    ...
    public boolean equals(Object other) {
        return Nv.e.f(this, other);
    }

    public final String h(int index) {
        return Nv.e.l(this, index);
    }
