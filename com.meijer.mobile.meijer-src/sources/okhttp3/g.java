...
public abstract class g {
    ...
    public void k(d call, Mv.f connection) {
        Intrinsics.j(call, "call");
        Intrinsics.j(connection, "connection");
    }

    public void l(d call, Mv.f connection) {
        Intrinsics.j(call, "call");
        Intrinsics.j(connection, "connection");
    }
