...
public final class C18448e implements f0.c {
    ...
    public C18448e(String sessionId, EnumC6551h environment) {
    ...
    public <T extends c0> T create(Class<T> modelClass) {
        ...
        if (modelClass.isAssignableFrom(C18447d.class)) {
            return new C18447d(this.sessionId, this.environment);
        }
