...
public final class g {
    ...
    public static final Handler f34490b = new HandlerC6982Jd0(Looper.getMainLooper());

    /* renamed from: c, reason: collision with root package name */
    private static final String f34491c = AdView.class.getName();

    /* renamed from: d, reason: collision with root package name */
    private static final String f34492d = Tc.a.class.getName();

    /* renamed from: e, reason: collision with root package name */
    private static final String f34493e = AdManagerAdView.class.getName();

    /* renamed from: f, reason: collision with root package name */
    private static final String f34494f = Hc.b.class.getName();

    /* renamed from: g, reason: collision with root package name */
    private static final String f34495g = SearchAdView.class.getName();

    /* renamed from: h, reason: collision with root package name */
    private static final String f34496h = com.google.android.gms.ads.b.class.getName();

    /* renamed from: a, reason: collision with root package name */
    private float f34497a = -1.0f;
    ...
    public static final String s(StackTraceElement[] stackTraceElementArr, String str) {
        ...
        while (true) {
            ...
            if ("loadAd".equalsIgnoreCase(stackTraceElement.getMethodName()) && (f34491c.equalsIgnoreCase(className2) || f34492d.equalsIgnoreCase(className2) || f34493e.equalsIgnoreCase(className2) || f34494f.equalsIgnoreCase(className2) || f34495g.equalsIgnoreCase(className2) || f34496h.equalsIgnoreCase(className2))) {
                break;
            }
            i11 = i10;
        }
    ...
    private final void c(JSONObject jSONObject, String str, Object obj) throws JSONException {
        ...
        Double[] dArr;
        Integer[] numArr;
        if (((Boolean) A.c().a(C8784lf.f77285o)).booleanValue()) {
    ...
    public static final boolean t() {
        boolean zBooleanValue = ((Boolean) A.c().a(C8784lf.f77283nb)).booleanValue();
            ...
            synchronized (this) {
                try {
                    if (this.f34497a < 0.0f) {
                        ...
                        this.f34497a = displayMetrics.density;
                    }
                } finally {
                }
            }
        }
        return Math.round(i10 / this.f34497a);
    }
    ...
    public final void p(Context context, String str, String str2, Bundle bundle, boolean z10) {
        y(context, str, "gmob-apps", bundle, true, new f() { // from class: Sc.d
            @Override // Sc.f
            public final t zza(String str3) {
                new e(this.f34488a, str3).start();
                return t.SUCCESS;
            }
        });
    }
    ...
    private static final void d(ViewGroup viewGroup, d2 d2Var, String str, int i10, int i11) {
        ...
        int iZ = z(context, 3);
        frameLayout.addView(textView, new FrameLayout.LayoutParams(d2Var.f23405f - iZ, d2Var.f23402c - iZ, 17));
        viewGroup.addView(frameLayout, d2Var.f23405f, d2Var.f23402c);
    }
    ...
    public static boolean q(String str) {
        ...
        return str.startsWith((String) C9855vg.f79946d.e());
    }

    public static final boolean u(Context context, int i10) {
        if (C14724g.f().h(context, i10) == 0) {
            return true;
        }
        return false;
    }
    ...
    public static final void y(Context context, String str, String str2, Bundle bundle, boolean z10, f fVar) {
        ...
        if (str == null) {
            str = C14724g.f().a(context) + ".244410000";
        }
