...
public final class m {
    ...
    private static boolean f34507c;

    /* renamed from: d, reason: collision with root package name */
    private static boolean f34508d;

    /* renamed from: g, reason: collision with root package name */
    public static final /* synthetic */ int f34511g = 0;

    /* renamed from: a, reason: collision with root package name */
    private final List f34512a;

    /* renamed from: b, reason: collision with root package name */
    private static final Object f34506b = new Object();

    /* renamed from: e, reason: collision with root package name */
    private static final com.google.android.gms.common.util.f f34509e = com.google.android.gms.common.util.i.d();

    /* renamed from: f, reason: collision with root package name */
    private static final Set f34510f = new HashSet(Arrays.asList(new String[0]));
    ...
    private final void n(String str, l lVar) throws IOException {
        ...
        try {
            ...
            jsonWriter.name("timestamp").value(f34509e.a());
    ...
    private final void o(final String str) throws IOException {
        n("onNetworkRequestError", new l() { // from class: Sc.j
            @Override // Sc.l
    ...
    private final void p(final String str, final String str2, final Map map, final byte[] bArr) throws IOException {
        n("onNetworkRequest", new l() { // from class: Sc.h
            @Override // Sc.l
            public final void a(JsonWriter jsonWriter) throws IOException {
    ...
    private final void q(final Map map, final int i10) throws IOException {
        n("onNetworkResponse", new l() { // from class: Sc.k
            @Override // Sc.l
            public final void a(JsonWriter jsonWriter) throws IOException {
    ...
    public final void h(final byte[] bArr) throws IOException {
        n("onNetworkResponseBody", new l() { // from class: Sc.i
            @Override // Sc.l
            public final void a(JsonWriter jsonWriter) throws IOException {
                int i10 = m.f34511g;
                jsonWriter.name("params").beginObject();
