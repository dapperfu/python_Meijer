...
@Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\u001a-\u0010\u0007\u001a\u00020\u00062\b\u0010\u0001\u001a\u0004\u0018\u00010\u00002\u0006\u0010\u0003\u001a\u00020\u00022\n\b\u0002\u0010\u0005\u001a\u0004\u0018\u00010\u0004H\u0000¢\u0006\u0004\b\u0007\u0010\b¨\u0006\t"}, d2 = {"Lcom/radiusnetworks/flybuy/sdk/data/common/SdkError;", "sdkError", "LRn/K;", "flyBuyState", "LHl/b$c;", "flyBuyData", "", "a", "(Lcom/radiusnetworks/flybuy/sdk/data/common/SdkError;LRn/K;LHl/b$c;)V", "Meijer_playstoreRelease"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class J {
    ...
    public static final void a(SdkError sdkError, FlyBuyState flyBuyState, FlyBuyOrderDetail.FlyBuyOrder flyBuyOrder) {
        ...
        if (flyBuyOrder == null || (strC = I.f33493i.b(flyBuyOrder)) == null) {
            strC = I.f33493i.c(flyBuyState);
        }
        ResponseEventType type = sdkError != null ? sdkError.getType() : null;
        int i10 = type == null ? -1 : a.$EnumSwitchMapping$0[type.ordinal()];
        if (i10 == 1) {
            qw.a.INSTANCE.d("FlyBuy SDK Error: No Connection: " + sdkError.getType() + ": ErrorCode: " + sdkError.getCode() + " -> " + sdkError.userError() + ": " + strC, new Object[0]);
            return;
        }
        if (i10 != 2) {
        ...
        if (sdkError.getCode() == 425) {
            qw.a.INSTANCE.d("FlyBuy SDK Error: Upgrade your app!: " + sdkError.getType() + ": ErrorCode: " + sdkError.getCode() + " -> " + sdkError.userError() + ": " + strC, new Object[0]);
            return;
        }
        qw.a.INSTANCE.d("FlyBuy SDK Error: " + sdkError.getType() + " -> " + sdkError.userError() + ": : ErrorCode: " + sdkError.getCode() + ": " + strC, new Object[0]);
    }
