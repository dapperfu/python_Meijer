...
public abstract class AbstractC16070a {
    ...
    private static final class C2378a extends AbstractC16070a {

        /* renamed from: b, reason: collision with root package name and from kotlin metadata */
        private final u mTopicsManager;

        @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"Lmv/O;", "Landroidx/privacysandbox/ads/adservices/topics/h;", "<anonymous>", "(Lmv/O;)Landroidx/privacysandbox/ads/adservices/topics/h;"}, k = 3, mv = {1, 8, 0})
        ...
        static final class C2379a extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super h>, Object> {

            /* renamed from: a, reason: collision with root package name */
            int f153612a;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ C6245b f153614c;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C2379a(C6245b c6245b, Continuation<? super C2379a> continuation) {
                super(2, continuation);
                this.f153614c = c6245b;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return C2378a.this.new C2379a(this.f153614c, continuation);
            }

            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(InterfaceC15783O interfaceC15783O, Continuation<? super h> continuation) {
                return ((C2379a) create(interfaceC15783O, continuation)).invokeSuspend(Unit.f143329a);
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Object invokeSuspend(Object obj) {
                Object objF = IntrinsicsKt.f();
                int i10 = this.f153612a;
                if (i10 != 0) {
                    if (i10 == 1) {
                        ResultKt.b(obj);
                        return obj;
                ...
                ResultKt.b(obj);
                u uVar = C2378a.this.mTopicsManager;
                C6245b c6245b = this.f153614c;
                this.f153612a = 1;
                Object objA = uVar.a(c6245b, this);
                if (objA == objF) {
                    return objF;
                }
                return objA;
        ...
        public C2378a(u mTopicsManager) {
            Intrinsics.j(mTopicsManager, "mTopicsManager");
            this.mTopicsManager = mTopicsManager;
        }

        @Override // o4.AbstractC16070a
        public q<h> b(C6245b request) {
            Intrinsics.j(request, "request");
            return C15661b.c(C15809k.b(C15784P.a(C15800f0.c()), null, null, new C2379a(request, null), 3, null), null, 1, null);
        }
    }
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final AbstractC16070a a(Context context) {
            Intrinsics.j(context, "context");
            u uVarA = u.INSTANCE.a(context);
            if (uVarA != null) {
                return new C2378a(uVarA);
            }
            return null;
        }
    }
    ...
    @JvmStatic
    public static final AbstractC16070a a(Context context) {
        return INSTANCE.a(context);
    }

    public abstract q<h> b(C6245b request);
}
