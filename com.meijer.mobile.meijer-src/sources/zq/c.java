...
public final class c implements zq.d, BarcodeCaptureListener, InterfaceC15783O {
    ...
    static final class b extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f173184b = obj;
            this.f173186d |= Integer.MIN_VALUE;
    ...
    static final class C2795c extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {

        /* renamed from: a, reason: collision with root package name */
        int f173187a;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ BarcodeCapture f173189c;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C2795c(BarcodeCapture barcodeCapture, Continuation<? super C2795c> continuation) {
            super(2, continuation);
            this.f173189c = barcodeCapture;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return c.this.new C2795c(this.f173189c, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(InterfaceC15783O interfaceC15783O, Continuation<? super Unit> continuation) {
            return ((C2795c) create(interfaceC15783O, continuation)).invokeSuspend(Unit.f143329a);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Object invokeSuspend(Object obj) {
            Object objF = IntrinsicsKt.f();
            int i10 = this.f173187a;
            if (i10 != 0) {
                if (i10 == 1) {
                    ResultKt.b(obj);
                } else {
                ...
                ResultKt.b(obj);
                c cVar = c.this;
                BarcodeCapture barcodeCapture = this.f173189c;
                this.f173187a = 1;
    ...
    public static final class d implements Callback<Boolean> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f173190a;

        d(Function0<Unit> function0) {
            this.f173190a = function0;
        }

        public void a(boolean result) {
            Function0<Unit> function0 = this.f173190a;
            if (function0 != null) {
                function0.invoke();
            }
        }
    ...
    */
    public final java.lang.Object l(com.scandit.datacapture.barcode.capture.BarcodeCapture r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        ...
        L13:
            ...
            r0.<init>(r8)
        L18:
            java.lang.Object r8 = r0.f173184b
            java.lang.Object r1 = kotlin.coroutines.intrinsics.IntrinsicsKt.f()
            int r2 = r0.f173186d
            r3 = 1
            if (r2 == 0) goto L35
            if (r2 != r3) goto L2d
            java.lang.Object r7 = r0.f173183a
        ...
        L35:
            ...
            r0.f173183a = r7
            r0.f173186d = r3
            java.lang.Object r8 = mv.Z.b(r4, r0)
            if (r8 != r1) goto L49
            return r1
        L49:
            r7.setEnabled(r3)
    ...
    @Override // zq.d
    public void b(AbstractC18543a cameraLens) {
        CameraPosition cameraPosition;
        Intrinsics.j(cameraLens, "cameraLens");
        if (cameraLens instanceof AbstractC18543a.b) {
            cameraPosition = CameraPosition.WORLD_FACING;
        } else {
            if (!(cameraLens instanceof AbstractC18543a.C2794a)) {
    ...
    public void onBarcodeScanned(BarcodeCapture barcodeCapture, BarcodeCaptureSession session, FrameData data) {
        ...
        C15809k.d(C15784P.a(getCoroutineContext()), null, null, new C2795c(barcodeCapture, null), 3, null);
    }
    ...
    public c() {
        ...
        this.captureSound = new ResourceSound(com.meijer.mobile.shopandscan.d.f117725e);
    ...
    private final Xp.a r(Barcode barcode) {
        ...
        if (StringsKt.h1(data, '2', false, 2, null)) {
