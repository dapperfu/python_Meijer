...
@Metadata(d1 = {"\u0000d\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0002\u0010\u0000\n\u0002\b\u0004\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010!\n\u0002\b\f\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0002\b\u0005\u001aI\u0010\u000b\u001a\u0004\u0018\u00010\u00002\u0006\u0010\u0001\u001a\u00020\u00002\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0004\u001a\u00020\u00022\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00060\u00052\u0010\u0010\n\u001a\f\u0012\u0006\u0012\u0004\u0018\u00010\t\u0018\u00010\bH\u0000¢\u0006\u0004\b\u000b\u0010\f\u001a+\u0010\u0013\u001a\u00020\u00122\u0006\u0010\r\u001a\u00020\u00002\u0012\u0010\u0011\u001a\u000e\u0012\u0004\u0012\u00020\u000f\u0012\u0004\u0012\u00020\u00100\u000eH\u0000¢\u0006\u0004\b\u0013\u0010\u0014\u001a\u001d\u0010\u0017\u001a\b\u0012\u0004\u0012\u00020\u00100\u00162\u0006\u0010\u0015\u001a\u00020\u0000H\u0000¢\u0006\u0004\b\u0017\u0010\u0018\u001a\u0017\u0010\u001a\u001a\u00020\u00002\u0006\u0010\u0019\u001a\u00020\u0012H\u0000¢\u0006\u0004\b\u001a\u0010\u001b\u001a+\u0010\u001d\u001a\u00020\u00002\u0006\u0010\u0019\u001a\u00020\u00122\u0012\u0010\u001c\u001a\u000e\u0012\u0004\u0012\u00020\u000f\u0012\u0004\u0012\u00020\u00100\u000eH\u0000¢\u0006\u0004\b\u001d\u0010\u001e\u001a9\u0010!\u001a\u0004\u0018\u00010\u00122\u0006\u0010\u001f\u001a\u00020\u00122\u0010\u0010\n\u001a\f\u0012\u0006\u0012\u0004\u0018\u00010\t\u0018\u00010\b2\f\u0010 \u001a\b\u0012\u0004\u0012\u00020\u00060\u0005H\u0000¢\u0006\u0004\b!\u0010\"\u001a\u001d\u0010'\u001a\b\u0012\u0004\u0012\u00020&0%2\u0006\u0010$\u001a\u00020#H\u0000¢\u0006\u0004\b'\u0010(\u001a\u001d\u0010+\u001a\b\u0012\u0004\u0012\u00020&0%2\u0006\u0010*\u001a\u00020)H\u0000¢\u0006\u0004\b+\u0010,\u001a!\u0010/\u001a\u00020.*\b\u0012\u0004\u0012\u00020\u00100\u00162\u0006\u0010-\u001a\u00020\u0010H\u0002¢\u0006\u0004\b/\u00100\u001a\u0013\u00101\u001a\u00020.*\u00020\u0000H\u0000¢\u0006\u0004\b1\u00102¨\u00063"}, d2 = {"Lorg/json/JSONObject;", "rumEvent", "LM7/a;", "overridableAttributeAggregator", "protectedAttributeAggregator", "Ljava/util/concurrent/ConcurrentLinkedQueue;", "LL7/b;", "eventModifiers", "", "", "eventContext", "h", "(Lorg/json/JSONObject;LM7/a;LM7/a;Ljava/util/concurrent/ConcurrentLinkedQueue;[Ljava/lang/Object;)Lorg/json/JSONObject;", "inputJson", "", "", "LM7/g;", "enrichmentAttributes", "LM7/f;", "g", "(Lorg/json/JSONObject;Ljava/util/Map;)LM7/f;", "json", "", "j", "(Lorg/json/JSONObject;)Ljava/util/List;", "jsonContainer", "k", "(LM7/f;)Lorg/json/JSONObject;", "protectedAttributes", "l", "(LM7/f;Ljava/util/Map;)Lorg/json/JSONObject;", "enrichedJsonContainer", "modifiers", "c", "(LM7/f;[Ljava/lang/Object;Ljava/util/concurrent/ConcurrentLinkedQueue;)LM7/f;", "Lb8/d;", "metricsDataModel", "", "LM7/b;", "f", "(Lb8/d;)Ljava/util/List;", "LX7/b;", "metricsCache", "e", "(LX7/b;)Ljava/util/List;", "attribute", "", "b", "(Ljava/util/List;LM7/g;)V", "i", "(Lorg/json/JSONObject;)V", "com.dynatrace.agent_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
...
public final class i {
    ...
    */
    public static final M7.EnrichedJsonContainer c(M7.EnrichedJsonContainer r11, java.lang.Object[] r12, java.util.concurrent.ConcurrentLinkedQueue<L7.b> r13) throws org.json.JSONException {
        /*
        ...
        L44:
            ...
            org.json.JSONObject r12 = M7.j.c(r12)
        ...
        Ld9:
            return r11
        */
        throw new UnsupportedOperationException("Method not decompiled: M7.i.c(M7.f, java.lang.Object[], java.util.concurrent.ConcurrentLinkedQueue):M7.f");
    }
    ...
    public static final List<b> e(X7.b metricsCache) {
    ...
    public static final EnrichedJsonContainer g(JSONObject inputJson, Map<String, EnrichmentAttribute> enrichmentAttributes) throws JSONException {
        ...
        for (Map.Entry<String, EnrichmentAttribute> entry : enrichmentAttributes.entrySet()) {
            ...
            if (objOpt == null || objOpt.equals(value.getValue())) {
                ...
                z8.f.a("dtxEnrichment", "auto-enrichment value overwritten: " + value + " is overwritten with custom value: " + objOpt);
                if (O7.n.o().contains(key)) {
                    b(listJ, value);
                }
            }
        }
    ...
    public static final JSONObject h(JSONObject rumEvent, a overridableAttributeAggregator, a protectedAttributeAggregator, ConcurrentLinkedQueue<L7.b> eventModifiers, Object[] objArr) {
        ...
        z8.f.a("dtxEnrichment", "rum event: " + rumEvent);
        ...
        z8.f.a("dtxEnrichment", "rum event after basic enrichment: overridden attributes: " + enrichedJsonContainerG.d() + "; event: " + enrichedJsonContainerG.getEnrichedJson());
        ...
        z8.f.a("dtxEnrichment", "rum event after modifications: overridden attributes: " + enrichedJsonContainerC.d() + "; event: " + enrichedJsonContainerC.getEnrichedJson());
        JSONObject jSONObjectK = k(enrichedJsonContainerC);
        i(jSONObjectK);
        z8.f.a("dtxEnrichment", "rum event after full enrichment: " + jSONObjectK);
        return jSONObjectK;
    }
    ...
    public static final List<EnrichmentAttribute> j(JSONObject json) throws JSONException {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            if (jSONArrayOptJSONArray.get(i10) instanceof String) {
                ...
                z8.f.a("dtxEnrichment", "dropped existing overridden_key because it was no String: " + jSONArrayOptJSONArray.get(i10));
            }
        }
        return arrayList;
    }
    ...
    public static final JSONObject k(EnrichedJsonContainer jsonContainer) throws JSONException {
        ...
        if (enrichedJson.remove("dt.internal.api.overridden_fields") != null) {
            z8.f.a("dtxEnrichment", "protected attribute integration: encountered key 'dt.internal.api.overridden_fields' which is protected and will be removed");
        }
    ...
    public static final JSONObject l(EnrichedJsonContainer jsonContainer, Map<String, EnrichmentAttribute> protectedAttributes) throws JSONException {
        ...
        for (Map.Entry<String, EnrichmentAttribute> entry : protectedAttributes.entrySet()) {
            ...
            if (enrichedJson.has(key)) {
                z8.f.a("dtxEnrichment", "protected attribute integration: encountered key '" + key + "' which is protected and will be overwritten with " + value);
            }
    ...
    private static final void b(List<EnrichmentAttribute> list, EnrichmentAttribute enrichmentAttribute) {
        ...
        if (i10 >= 0) {
            z8.f.a("dtxEnrichment", "key '" + enrichmentAttribute.getKey() + "' already in overridden keys list. Replacing it.");
