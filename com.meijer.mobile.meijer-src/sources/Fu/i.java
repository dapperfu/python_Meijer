...
public abstract class i {
    ...
    private static final Logger f10948a = Logger.getLogger(i.class.getName());

    public abstract List<Double> c();

    public static final i a(List<Double> list) {
        Eu.c.c(list, "bucketBoundaries");
        ...
        if (arrayList.size() > 1) {
            ...
            while (i10 < arrayList.size()) {
                ...
                Eu.c.a(dDoubleValue < dDoubleValue2, "Bucket boundaries not sorted.");
                i10++;
    ...
    private static List<Double> b(List<Double> list) {
        ...
        if (i10 > 0) {
            f10948a.log(Level.WARNING, "Dropping " + i10 + " negative bucket boundaries, the values must be strictly > 0.");
        }
