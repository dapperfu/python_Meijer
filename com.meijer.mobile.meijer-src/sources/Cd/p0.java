...
public abstract class p0 extends m0 implements List, RandomAccess {
    ...
    private static final t0 f4275b = new n0(q0.f4277e, 0);
    ...
    public final boolean equals(Object obj) {
        ...
        if (list instanceof RandomAccess) {
            for (int i10 = 0; i10 < size; i10++) {
                if (!C3058i0.a(get(i10), list.get(i10))) {
                    return false;
                }
            }
            return true;
        ...
        while (it.hasNext()) {
            if (!it2.hasNext() || !C3058i0.a(it.next(), it2.next())) {
                return false;
            }
        }
        return !it2.hasNext();
    ...
    @Override // Cd.m0, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable
    ...
    static p0 q(Object[] objArr, int i10) {
        return i10 == 0 ? q0.f4277e : new q0(objArr, i10);
    }
