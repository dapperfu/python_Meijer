...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a\u0013\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u0000¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lcom/meijer/mobile/digitalshopping/api/orders/model/orderhistory/OrderHistoryResponse;", "Lol/a;", "a", "(Lcom/meijer/mobile/digitalshopping/api/orders/model/orderhistory/OrderHistoryResponse;)Lol/a;", "digitalshopping_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class c {
    public static final OrderHistory a(OrderHistoryResponse orderHistoryResponse) {
        ...
        while (it.hasNext()) {
            arrayList.add(C15962b.a((OrderHistoryItemDto) it.next()));
        }
