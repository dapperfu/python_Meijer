    ...
    protected final boolean K1(int i10, Parcel parcel, Parcel parcel2, int i11) throws RemoteException {
        switch (i10) {
            ...
            case 14:
                ...
                Zd.j jVar = (Zd.j) d.a(parcel, Zd.j.CREATOR);
                Bundle bundle6 = (Bundle) d.a(parcel, Bundle.CREATOR);
                d.b(parcel);
                P0(status2, jVar, bundle6);
                return true;
            case 15:
                d.b(parcel);
                return true;
            ...
            case 19:
                ...
                Zd.i iVar = (Zd.i) d.a(parcel, Zd.i.CREATOR);
                Bundle bundle7 = (Bundle) d.a(parcel, Bundle.CREATOR);
                d.b(parcel);
                P8(status3, iVar, bundle7);
                return true;
            case 20:
                d.b(parcel);
                return true;
