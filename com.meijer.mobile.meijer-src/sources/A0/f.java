...
final class f implements InterfaceC13938a {
    ...
    public long E1(long available, int source) {
        return !this.enabled ? U0.f.INSTANCE.c() : (!C13942e.f(source, C13942e.INSTANCE.d()) || U0.f.n(available) >= 0.0f) ? U0.f.INSTANCE.c() : U0.g.a(0.0f, this.onPull.invoke(Float.valueOf(U0.f.n(available))).floatValue());
    }
