...
public final class g {
    ...
    private final InterfaceC15783O animationScope;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final z1<Function0<Unit>> onRefreshState;

    /* renamed from: g, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5866i0 _threshold;

    /* renamed from: h, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5866i0 _refreshingOffset;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private final z1 adjustedDistancePulled = o1.e(new a());

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5872l0 _refreshing = t1.e(Boolean.FALSE, null, 2, null);

    /* renamed from: e, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5866i0 _position = A0.a(0.0f);

    /* renamed from: f, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5866i0 distancePulled = A0.a(0.0f);

    /* renamed from: i, reason: collision with root package name and from kotlin metadata */
    private final C13565F mutatorMutex = new C13565F();
    ...
    static final class b extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                ResultKt.b(obj);
                C13565F c13565f = g.this.mutatorMutex;
                a aVar = new a(g.this, this.f68c, null);
                this.f66a = 1;
                if (C13565F.e(c13565f, null, aVar, this, 1, null) == objF) {
                    return objF;
                }
            }
            return Unit.f143329a;
    ...
    private final C0 e(float offset) {
        return C15809k.d(this.animationScope, null, null, new b(offset, null), 3, null);
    }
    ...
    private final void s(float f10) {
        this.distancePulled.A(f10);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void w(float f10) {
        this._position.A(f10);
    }
    ...
    private final void y(float f10) {
        this._refreshingOffset.A(f10);
    }

    private final void z(float f10) {
        this._threshold.A(f10);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public g(InterfaceC15783O interfaceC15783O, z1<? extends Function0<Unit>> z1Var, float f10, float f11) {
        this.animationScope = interfaceC15783O;
