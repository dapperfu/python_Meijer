...
public final class h {
    ...
    static final class a extends Lambda implements Function0<Unit> {
        ...
        public final void invoke2() {
            ...
            this.f73f.v(this.f75h.f143739a);
            this.f73f.u(this.f76i.f143739a);
        }
    }
    ...
    public static final g a(boolean z10, Function0<Unit> function0, float f10, float f11, Composer composer, int i10, int i11) {
        ...
        floatRef.f143739a = dVar.I1(f10);
        floatRef2.f143739a = dVar.I1(f11);
        boolean zV = composer.V(interfaceC15783O);
        Object objB2 = composer.B();
        if (zV || objB2 == companion.a()) {
            objB2 = new g(interfaceC15783O, z1VarP, floatRef2.f143739a, floatRef.f143739a);
            composer.t(objB2);
        }
        g gVar = (g) objB2;
        boolean zD = composer.D(gVar) | ((((i10 & 14) ^ 6) > 4 && composer.a(z10)) || (i10 & 6) == 4) | composer.b(floatRef.f143739a) | composer.b(floatRef2.f143739a);
