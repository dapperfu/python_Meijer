...
public final class C5527d {
    ...
    public static /* synthetic */ AbstractC5526c d(AbstractC5526c abstractC5526c, WhitePoint whitePoint, AbstractC5524a abstractC5524a, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            abstractC5524a = AbstractC5524a.INSTANCE.a();
        }
        return c(abstractC5526c, whitePoint, abstractC5524a);
    }

    public static /* synthetic */ l i(AbstractC5526c abstractC5526c, AbstractC5526c abstractC5526c2, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            abstractC5526c2 = k.f40555a.G();
        }
        if ((i11 & 2) != 0) {
            i10 = r.INSTANCE.b();
        }
        return h(abstractC5526c, abstractC5526c2, i10);
    }

    private static final l j(AbstractC5526c abstractC5526c, AbstractC5526c abstractC5526c2, int i10) {
        if (abstractC5526c == abstractC5526c2) {
            return l.INSTANCE.c(abstractC5526c);
        }
        long jG = abstractC5526c.getModel();
        C5525b.Companion aVar = C5525b.INSTANCE;
        DefaultConstructorMarker defaultConstructorMarker = null;
        if (!C5525b.e(jG, aVar.b()) || !C5525b.e(abstractC5526c2.getModel(), aVar.b())) {
            return new l(abstractC5526c, abstractC5526c2, i10, defaultConstructorMarker);
        }
        Intrinsics.h(abstractC5526c, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
        Intrinsics.h(abstractC5526c2, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
        return new l.b((F) abstractC5526c, (F) abstractC5526c2, i10, defaultConstructorMarker);
    }
    ...
    @JvmOverloads
    public static final AbstractC5526c c(AbstractC5526c abstractC5526c, WhitePoint whitePoint, AbstractC5524a abstractC5524a) {
        if (C5525b.e(abstractC5526c.getModel(), C5525b.INSTANCE.b())) {
            Intrinsics.h(abstractC5526c, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
            F f10 = (F) abstractC5526c;
            if (!f(f10.getWhitePoint(), whitePoint)) {
                return new F(f10, l(e(abstractC5524a.getTransform(), f10.getWhitePoint().c(), whitePoint.c()), f10.getTransform()), whitePoint);
            }
        }
    ...
    public static final l h(AbstractC5526c abstractC5526c, AbstractC5526c abstractC5526c2, int i10) {
        int iD = abstractC5526c.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String();
        int iD2 = abstractC5526c2.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String();
        if ((iD | iD2) < 0) {
            return j(abstractC5526c, abstractC5526c2, i10);
        }
        K<l> kA = m.a();
        int i11 = iD | (iD2 << 6) | (i10 << 12);
        l lVarB = kA.b(i11);
        if (lVarB == null) {
            lVarB = j(abstractC5526c, abstractC5526c2, i10);
            kA.r(i11, lVarB);
        }
        return lVarB;
    }
