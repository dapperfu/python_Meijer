...
public final class q extends AbstractC5526c {

    /* renamed from: f, reason: collision with root package name */
    private static final float[] f40605f;

    /* renamed from: g, reason: collision with root package name */
    private static final float[] f40606g;

    /* renamed from: h, reason: collision with root package name */
    private static final float[] f40607h;

    /* renamed from: i, reason: collision with root package name */
    private static final float[] f40608i;
    ...
    static {
        float[] transform = AbstractC5524a.INSTANCE.a().getTransform();
        o oVar = o.f40592a;
        float[] fArrL = C5527d.l(new float[]{0.818933f, 0.032984544f, 0.0482003f, 0.36186674f, 0.9293119f, 0.26436627f, -0.12885971f, 0.03614564f, 0.6338517f}, C5527d.e(transform, oVar.b().c(), oVar.e().c()));
        f40605f = fArrL;
        float[] fArr = {0.21045426f, 1.9779985f, 0.025904037f, 0.7936178f, -2.4285922f, 0.78277177f, -0.004072047f, 0.4505937f, -0.80867577f};
        f40606g = fArr;
        f40607h = C5527d.k(fArrL);
        f40608i = C5527d.k(fArr);
    }
    ...
    public float[] b(float[] v10) {
        C5527d.n(f40605f, v10);
        v10[0] = J1.b.a(v10[0]);
        v10[1] = J1.b.a(v10[1]);
        v10[2] = J1.b.a(v10[2]);
        C5527d.n(f40606g, v10);
        return v10;
    }
    ...
    public long n(float x10, float y10, float z10, float a10, AbstractC5526c colorSpace) {
        ...
        float[] fArr2 = f40606g;
        return C5492s0.a((fArr2[0] * fA) + (fArr2[3] * fA2) + (fArr2[6] * fA3), (fArr2[1] * fA) + (fArr2[4] * fA2) + (fArr2[7] * fA3), (fArr2[2] * fA) + (fArr2[5] * fA2) + (fArr2[8] * fA3), a10, colorSpace);
    }
}
