...
public final class s {
    ...
    public final boolean c() {
        ...
        return this.address.getSslSocketFactory() != null || this.address.f().contains(r.f20504g);
    }
    ...
    public String toString() {
        ...
        String strK = (address == null || (hostAddress = address.getHostAddress()) == null) ? null : Nv.f.k(hostAddress);
        if (StringsKt.c0(host, ':', false, 2, null)) {
            sb2.append("[");
            sb2.append(host);
            sb2.append("]");
        } else {
        ...
        if (!Intrinsics.e(host, strK)) {
            ...
            } else if (StringsKt.c0(strK, ':', false, 2, null)) {
                sb2.append("[");
                sb2.append(strK);
                sb2.append("]");
            } else {
