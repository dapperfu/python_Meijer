...
public class b {
    public static void b(f fVar, M1.d dVar, ArrayList<e> arrayList, int i10) {
        int i11;
        c[] cVarArr;
        int i12;
        if (i10 == 0) {
            i11 = fVar.f27661V0;
            cVarArr = fVar.f27664Y0;
            i12 = 0;
        } else {
            i11 = fVar.f27662W0;
            cVarArr = fVar.f27663X0;
            i12 = 2;
        }
        for (int i13 = 0; i13 < i11; i13++) {
            c cVar = cVarArr[i13];
            cVar.a();
            if (arrayList == null || arrayList.contains(cVar.f27514a)) {
    ...
    /* JADX WARN: Type inference failed for: r14v2, types: [Q1.e] */
    /* JADX WARN: Type inference failed for: r14v24 */
    /* JADX WARN: Type inference failed for: r14v25 */
    /* JADX WARN: Type inference failed for: r14v26 */
    /* JADX WARN: Type inference failed for: r4v44, types: [Q1.e] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    static void a(Q1.f r37, M1.d r38, int r39, int r40, Q1.c r41) {
        /*
            Method dump skipped, instructions count: 1287
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: Q1.b.a(Q1.f, M1.d, int, int, Q1.c):void");
    }
}
