...
public final class C16345a0 {

    /* renamed from: a, reason: collision with root package name */
    private static Method f156033a;
    ...
    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f156033a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", null);
    ...
    private static float b(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f156033a) != null) {
            try {
