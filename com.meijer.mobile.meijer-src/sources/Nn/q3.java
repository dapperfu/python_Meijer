...
public class q3 extends p3 {
    ...
    private static final p.i f22229L = null;

    /* renamed from: M, reason: collision with root package name */
    private static final SparseIntArray f22230M;

    /* renamed from: K, reason: collision with root package name */
    private long f22231K;

    public q3(androidx.databinding.f fVar, View view) {
        this(fVar, view, androidx.databinding.p.r0(fVar, view, 11, f22229L, f22230M));
    }
    ...
    static {
        ...
        f22230M = sparseIntArray;
        sparseIntArray.put(com.meijer.mobile.meijer.T.f99644C5, 1);
        sparseIntArray.put(com.meijer.mobile.meijer.T.f99716J5, 2);
        sparseIntArray.put(com.meijer.mobile.meijer.T.f99755N4, 3);
        sparseIntArray.put(com.meijer.mobile.meijer.T.f99745M4, 4);
        sparseIntArray.put(com.meijer.mobile.meijer.T.f99731L0, 5);
        sparseIntArray.put(com.meijer.mobile.meijer.T.f99791R0, 6);
