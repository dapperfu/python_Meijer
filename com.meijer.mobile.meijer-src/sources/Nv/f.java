...
public final class f {
    ...
    private static final Regex f22774a = new Regex("([0-9a-fA-F]*:[0-9a-fA-F:.]*)|([\\d.]+)");
    ...
    public static final boolean c(String str) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            if (Intrinsics.k(cCharAt, 31) <= 0 || Intrinsics.k(cCharAt, l3.f93324d) >= 0 || StringsKt.p0(" #%/:?@[\\]", cCharAt, 0, false, 6, null) != -1) {
                return true;
            }
        }
        return false;
    ...
    public static final boolean d(String str) {
        ...
        if (1 <= length && length < 254) {
            ...
            while (true) {
                ...
                int length2 = iP0 == -1 ? str2.length() - i10 : iP0 - i10;
                if (1 > length2 || length2 >= 64) {
                    break;
                }
                if (iP0 == -1 || iP0 == str2.length() - 1) {
                    break;
                }
                i10 = iP0 + 1;
                str = str2;
    ...
    */
    public static final byte[] f(java.lang.String r16, int r17, int r18) {
        ...
        La6:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: Nv.f.f(java.lang.String, int, int):byte[]");
    }

    public static final String g(String host) throws EOFException {
        Intrinsics.j(host, "host");
        C14416e c14416eG0 = new C14416e().G0(host);
        C14416e c14416e = new C14416e();
        while (!c14416eG0.i2()) {
            if (!Wv.b.a().c(c14416eG0.K2(), c14416e)) {
                return null;
            }
        }
        c14416eG0.G0(g.a(c14416e.n3()));
        Wv.d dVar = Wv.d.f41471a;
        String strC = dVar.c(c14416eG0.n3());
    ...
    public static final String h(byte[] address) {
        Intrinsics.j(address, "address");
        if (address.length == 4) {
            return new C14416e().G1(h.b(address[0], l3.f93323c)).writeByte(46).G1(h.b(address[1], l3.f93323c)).writeByte(46).G1(h.b(address[2], l3.f93323c)).writeByte(46).G1(h.b(address[3], l3.f93323c)).n3();
        }
    ...
    public static final String i(byte[] address) {
        ...
        while (i11 < address.length) {
            if (i11 == i10) {
                ...
                c14416e.M2((h.b(address[i11], l3.f93323c) << 8) | h.b(address[i11 + 1], l3.f93323c));
                i11 += 2;
            }
        }
        return c14416e.n3();
