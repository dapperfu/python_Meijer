...
public final class k {
    ...
    @JvmField
    public static final TimeZone f22780a;
    ...
    @JvmField
    public static final String f22782c;
    ...
    static {
        ...
        f22782c = StringsKt.M0(StringsKt.K0(name, "okhttp3."), "Client");
    }

    public static final g.c c(final okhttp3.g gVar) {
        Intrinsics.j(gVar, "<this>");
        return new g.c() { // from class: Nv.i
    ...
    public static final void e(l lVar) {
        ...
        if (f22781b && Thread.holdsLock(lVar)) {
    ...
    public static final boolean i(K k10, int i10, TimeUnit timeUnit) {
        Intrinsics.j(k10, "<this>");
        Intrinsics.j(timeUnit, "timeUnit");
        try {
            return o(k10, i10, timeUnit);
    ...
    public static final boolean m(Socket socket, InterfaceC14418g source) throws SocketException {
        Intrinsics.j(socket, "<this>");
    ...
    public static final Charset n(InterfaceC14418g interfaceC14418g, Charset charset) throws IOException {
        Intrinsics.j(interfaceC14418g, "<this>");
        Intrinsics.j(charset, "default");
        int iI2 = interfaceC14418g.I2(h.m());
        if (iI2 == -1) {
            return charset;
        }
        if (iI2 == 0) {
        ...
        if (iI2 == 2) {
            return Charsets.f148296a.b();
        }
        if (iI2 == 3) {
            return Charsets.UTF_16LE;
        }
        if (iI2 == 4) {
            return Charsets.f148296a.a();
        }
        throw new AssertionError();
    }

    public static final boolean o(K k10, int i10, TimeUnit timeUnit) throws IOException {
        Intrinsics.j(k10, "<this>");
        Intrinsics.j(timeUnit, "timeUnit");
        long jNanoTime = System.nanoTime();
        long jC = k10.getF134544a().getHasDeadline() ? k10.getF134544a().c() - jNanoTime : Long.MAX_VALUE;
        k10.getF134544a().d(Math.min(jC, timeUnit.toNanos(i10)) + jNanoTime);
        try {
            C14416e c14416e = new C14416e();
            while (k10.read(c14416e, 8192L) != -1) {
                c14416e.a();
            }
            ...
            k10.getF134544a().d(jNanoTime + jC);
            return true;
    ...
    public static final ThreadFactory p(final String name, final boolean z10) {
        Intrinsics.j(name, "name");
        return new ThreadFactory() { // from class: Nv.j
    ...
    public static final List<Uv.c> r(Headers headers) {
        ...
        while (it.hasNext()) {
            ...
            arrayList.add(new Uv.c(headers.h(iNextInt), headers.p(iNextInt)));
        }
        return arrayList;
    }

    public static final Headers s(List<Uv.c> list) {
    ...
    public static final String v(HttpUrl httpUrl, boolean z10) {
        String host;
        Intrinsics.j(httpUrl, "<this>");
        if (StringsKt.d0(httpUrl.getHost(), ":", false, 2, null)) {
