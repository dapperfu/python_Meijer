...
public final class d {
    ...
    public static final okhttp3.c c(c.Companion companion) {
        ...
        return aVarM.j(DurationKt.s(a.e.API_PRIORITY_OTHER, DurationUnit.f148417e)).a();
    }
    ...
    */
    public static final okhttp3.c h(okhttp3.c.Companion r30, okhttp3.Headers r31) throws java.lang.NumberFormatException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: Nv.d.h(okhttp3.c$b, okhttp3.Headers):okhttp3.c");
    }
    ...
    private static final int j(String str, String str2, int i10) {
        ...
        while (i10 < length) {
            if (StringsKt.c0(str2, str.charAt(i10), false, 2, null)) {
                return i10;
            }
            i10++;
        }
