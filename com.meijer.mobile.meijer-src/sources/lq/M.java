...
@Metadata(d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0002\b\u0006\u001a%\u0010\u0006\u001a\u00020\u0005*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u00012\b\b\u0002\u0010\u0004\u001a\u00020\u0003H\u0001¢\u0006\u0004\b\u0006\u0010\u0007\u001a9\u0010\r\u001a\u00020\u0005*\u00020\u00002\b\b\u0002\u0010\u0004\u001a\u00020\u00032\u0006\u0010\t\u001a\u00020\b2\u0012\u0010\f\u001a\u000e\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\u00050\nH\u0003¢\u0006\u0004\b\r\u0010\u000e\u001a+\u0010\u0011\u001a\u00020\u0005*\u00020\u00002\b\b\u0002\u0010\u0004\u001a\u00020\u00032\f\u0010\u0010\u001a\b\u0012\u0004\u0012\u00020\u00050\u000fH\u0003¢\u0006\u0004\b\u0011\u0010\u0012\u001a9\u0010\u0013\u001a\u00020\u0005*\u00020\u00002\b\b\u0002\u0010\u0004\u001a\u00020\u00032\u0006\u0010\t\u001a\u00020\b2\u0012\u0010\f\u001a\u000e\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\u00050\nH\u0003¢\u0006\u0004\b\u0013\u0010\u000e\u001a1\u0010\u0018\u001a\u00020\u0005*\u00020\u00002\f\u0010\u0014\u001a\b\u0012\u0004\u0012\u00020\u00050\u000f2\u0006\u0010\u0016\u001a\u00020\u00152\u0006\u0010\u0017\u001a\u00020\u0015H\u0003¢\u0006\u0004\b\u0018\u0010\u0019¨\u0006\u001b²\u0006\f\u0010\t\u001a\u00020\b8\nX\u008a\u0084\u0002²\u0006\u000e\u0010\u001a\u001a\u00020\u00158\n@\nX\u008a\u008e\u0002"}, d2 = {"LKi/M;", "Llq/P;", "viewModel", "Landroidx/compose/ui/Modifier;", "modifier", "", "t", "(LKi/M;Llq/P;Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;II)V", "Llq/P$b;", "viewState", "Lkotlin/Function1;", "Llq/P$a;", "sendEvent", "r", "(LKi/M;Landroidx/compose/ui/Modifier;Llq/P$b;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;II)V", "Lkotlin/Function0;", "onBackPressed", "l", "(LKi/M;Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function0;Landroidx/compose/runtime/Composer;II)V", "x", "onDismissDialog", "", "dialogTitle", "dialogText", "p", "(LKi/M;Lkotlin/jvm/functions/Function0;Ljava/lang/String;Ljava/lang/String;Landroidx/compose/runtime/Composer;I)V", "pluNumber", "shopandscan_playstoreRelease"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class M {
    ...
    static final class a implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ LocalThemeScope f149988a;

        a(LocalThemeScope localThemeScope) {
            this.f149988a = localThemeScope;
        }
        ...
        public final void a(Composer composer, int i10) {
            ...
            M.n(this.f149988a, C16338g.c(com.meijer.mobile.shopandscan.e.f117958t1, composer, 0), composer, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class b implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f149989a;

        b(Function0<Unit> function0) {
            this.f149989a = function0;
        }
    ...
    static final class c implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f149990a;

        c(Function0<Unit> function0) {
            this.f149990a = function0;
        }
        ...
        public final void a(Composer composer, int i10) {
            ...
            C18049x.d(this.f149990a, null, false, null, null, null, null, null, null, C15576b.f150037a.b(), composer, 805306368, 510);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class d implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ LocalThemeScope f149992b;

        d(String str, LocalThemeScope localThemeScope) {
            this.f149991a = str;
            this.f149992b = localThemeScope;
        }
        ...
        public final void a(Composer composer, int i10) {
            ...
            N1.b(this.f149991a, null, 0L, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, this.f149992b.getAdsTypography().getHeadings().getSix().getStyle(), composer, 0, 0, 65534);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class e implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ String f149993a;
        ...
        public final void a(Composer composer, int i10) {
            ...
            N1.b(this.f149993a, null, 0L, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, null, composer, 0, 0, 131070);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class f implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f149994a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function1<P.a, Unit> f149995b;

        /* JADX WARN: Multi-variable type inference failed */
        f(LocalThemeScope localThemeScope, Function1<? super P.a, Unit> function1) {
            this.f149994a = localThemeScope;
            this.f149995b = function1;
        }
        ...
        public final void b(Composer composer, int i10) {
            ...
            LocalThemeScope localThemeScope = this.f149994a;
            composer.startReplaceGroup(5004770);
            boolean zV = composer.V(this.f149995b);
            final Function1<P.a, Unit> function1 = this.f149995b;
            ...
            composer.P();
            M.l(localThemeScope, null, (Function0) objB, composer, LocalThemeScope.f17314g, 1);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class g implements Function3<InterfaceC14882C, Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f149996a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ P.ViewState f149997b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Function1<P.a, Unit> f149998c;

        /* JADX WARN: Multi-variable type inference failed */
        g(LocalThemeScope localThemeScope, P.ViewState viewState, Function1<? super P.a, Unit> function1) {
            this.f149996a = localThemeScope;
            this.f149997b = viewState;
            this.f149998c = function1;
        }
        ...
        public final void a(InterfaceC14882C paddingValues, Composer composer, int i10) {
            ...
            M.x(this.f149996a, androidx.compose.foundation.layout.D.h(Modifier.INSTANCE, paddingValues), this.f149997b, this.f149998c, composer, LocalThemeScope.f17314g | (AbstractC6392a.f60445b << 6), 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class h extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new h(this.f150000b, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f149999a == 0) {
                ResultKt.b(obj);
                this.f150000b.u(P.a.b.f150008a);
                return Unit.f143329a;
            }
    ...
    static final class i implements Function3<InterfaceC14888I, Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f150001a;

        i(LocalThemeScope localThemeScope) {
            this.f150001a = localThemeScope;
        }
        ...
        public final void a(InterfaceC14888I Button, Composer composer, int i10) {
            ...
            N1.b(C16338g.c(com.meijer.mobile.shopandscan.e.f117943o1, composer, 0), null, this.f150001a.getAdsColors().getAdsColorInverse().getColor(), 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, this.f150001a.getAdsTypography().getHeadings().getSeven().getStyle(), composer, 0, 0, 65530);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
    static final class j implements Function3<InterfaceC14888I, Composer, Integer, Unit> {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f150002a;

        j(LocalThemeScope localThemeScope) {
            this.f150002a = localThemeScope;
        }
        ...
        public final void a(InterfaceC14888I TextButton, Composer composer, int i10) {
            ...
            N1.b(C16338g.c(com.meijer.mobile.shopandscan.e.f117940n1, composer, 0), null, this.f150002a.getAdsColors().getAdsColorBrandPrimary().getColor(), 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, this.f150002a.getAdsTypography().getHeadings().getSeven().getStyle(), composer, 0, 0, 65530);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final void t(final LocalThemeScope localThemeScope, final P viewModel, Modifier modifier, Composer composer, final int i10, final int i11) {
        ...
        if ((i12 & 147) == 146 && composerStartRestartGroup.j()) {
            ...
            r(localThemeScope, modifier4, viewStateU, (Function1) objB2, composerStartRestartGroup, (AbstractC6392a.f60445b << 6) | ((i12 >> 3) & 112) | LocalThemeScope.f17314g | (i12 & 14), 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
            modifier2 = modifier4;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit A(Function1 function1, InterfaceC5872l0 interfaceC5872l0) {
        function1.invoke(new P.a.LookupItem(D(interfaceC5872l0)));
        return Unit.f143329a;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit C(Function1 function1) {
        function1.invoke(P.a.C2313a.f150007a);
        return Unit.f143329a;
    }
    ...
    public static final void l(final LocalThemeScope localThemeScope, Modifier modifier, final Function0<Unit> function0, Composer composer, final int i10, final int i11) {
        ...
        if ((i12 & 131) == 130 && composerStartRestartGroup.j()) {
            ...
            C18009i.d(ComposableLambdaKt.c(-1515968969, true, new a(localThemeScope), composerStartRestartGroup, 54), Modifier.INSTANCE, ComposableLambdaKt.c(-1007190155, true, new b(function0), composerStartRestartGroup, 54), null, 0L, 0L, 0.0f, composerStartRestartGroup, 438, BinsView.TOTE_HEIGHT_DP);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
            modifier2 = modifier3;
    ...
    */
    private static final void r(final Ki.LocalThemeScope r33, androidx.compose.ui.Modifier r34, final lq.P.ViewState r35, final kotlin.jvm.functions.Function1<? super lq.P.a, kotlin.Unit> r36, androidx.compose.runtime.Composer r37, final int r38, final int r39) {
        /*
            Method dump skipped, instructions count: 267
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: lq.M.r(Ki.M, androidx.compose.ui.Modifier, lq.P$b, kotlin.jvm.functions.Function1, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void x(final Ki.LocalThemeScope r69, androidx.compose.ui.Modifier r70, final lq.P.ViewState r71, final kotlin.jvm.functions.Function1<? super lq.P.a, kotlin.Unit> r72, androidx.compose.runtime.Composer r73, final int r74, final int r75) {
        /*
            Method dump skipped, instructions count: 1377
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: lq.M.x(Ki.M, androidx.compose.ui.Modifier, lq.P$b, kotlin.jvm.functions.Function1, androidx.compose.runtime.Composer, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit y(int i10, Function1 function1, InterfaceC5872l0 interfaceC5872l0, InterfaceC5834y KeyboardActions) {
        Intrinsics.j(KeyboardActions, "$this$KeyboardActions");
        if (D(interfaceC5872l0).length() >= i10) {
            function1.invoke(new P.a.LookupItem(D(interfaceC5872l0)));
        }
        return Unit.f143329a;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit z(int i10, InterfaceC5872l0 interfaceC5872l0, String it) {
        Intrinsics.j(it, "it");
        if (it.length() <= i10) {
            int i11 = 0;
            while (true) {
                if (i11 >= it.length()) {
                    E(interfaceC5872l0, it);
                    break;
                }
    ...
    public static final void m(Function0<Unit> function0, Composer composer, int i10) {
        ...
        C18052y0.a(function0, null, false, null, C15576b.f150037a.a(), composer, 24576, 14);
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        composer.P();
