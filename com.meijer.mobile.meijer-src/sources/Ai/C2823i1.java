...
@Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0004\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0007\u001a'\u0010\u0005\u001a\u00020\u0004*\u000e\u0012\u0004\u0012\u00020\u0001\u0012\u0004\u0012\u00020\u00010\u00002\u0006\u0010\u0003\u001a\u00020\u0002H\u0001¢\u0006\u0004\b\u0005\u0010\u0006\u001a\u001d\u0010\t\u001a\u00020\u00022\u0006\u0010\u0007\u001a\u00020\u00022\u0006\u0010\b\u001a\u00020\u0001¢\u0006\u0004\b\t\u0010\n¨\u0006\u000b"}, d2 = {"LAi/g1;", "", "", "proposedValue", "", "b", "(LAi/g1;Ljava/lang/String;)V", "proposedStringFromInputDevice", "currentValue", "a", "(Ljava/lang/String;Ljava/lang/Number;)Ljava/lang/String;", "library_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* renamed from: Ai.i1, reason: case insensitive filesystem */
/* loaded from: classes8.dex */
public final class C2823i1 {
    public static final String a(String proposedStringFromInputDevice, Number currentValue) {
        ...
        try {
            if (!(currentValue instanceof Double)) {
                ...
                if (StringsKt.s0(proposedStringFromInputDevice)) {
                    return "0";
                }
    ...
    @Deprecated
    public static final void b(InterfaceC2817g1<Number, Number> interfaceC2817g1, String proposedValue) {
        Number value;
        String value2;
        Intrinsics.j(interfaceC2817g1, "<this>");
        Intrinsics.j(proposedValue, "proposedValue");
        Number value3 = interfaceC2817g1.getValue();
        int i10 = 0;
        if (value3 instanceof Integer) {
            if (interfaceC2817g1.getValue().intValue() == -1) {
            ...
            if (i12 > 1) {
                ...
                StringsKt.Q0(proposedValue, ".", "", null, 4, null);
                double d10 = Double.parseDouble(strS);
                if (!Intrinsics.e(Double.valueOf(d10), interfaceC2817g1.getValue())) {
                    String.valueOf(d10);
                }
            }
            MatchResult matchResultD = Regex.d(regex, (i12 >= 1 || !Intrinsics.e(StringsKt.Q(interfaceC2817g1.getValue().toString(), ".", "", false, 4, null), proposedValue)) ? proposedValue : String.valueOf(interfaceC2817g1.getValue()), 0, 2, null);
            value = Double.valueOf((matchResultD == null || (value2 = matchResultD.getValue()) == null) ? 0.0d : Double.parseDouble(value2));
        } else {
            value = interfaceC2817g1.getValue();
        }
        interfaceC2817g1.C().invoke(value, interfaceC2817g1.getValue());
    }
}
