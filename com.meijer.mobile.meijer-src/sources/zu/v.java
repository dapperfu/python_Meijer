...
public final class v {
    ...
    public static final v f173287a = new v();

    /* renamed from: f, reason: collision with root package name and from kotlin metadata */
    private static Ju.a disposable = new Ju.a();
    ...
    static final class b extends Lambda implements Function1<String, Unit> {
        ...
        public static final b f173298f = new b();
    ...
    private final ArrayList<Pair<String, String>> C(Integer groupIdInt, String groupId, String groupDisplayName, Integer page, Integer offset, Integer perPage, String sortBy, String sortOrder, String sectionName, List<String> hiddenFacets, String groupsSortBy, String groupsSortOrder, List<? extends Pair<String, ? extends List<String>>> facets, List<String> hiddenFields, VariationsMap variationsMap, Map<String, Integer> numResultsPerSection, String resultId, Integer numResults, String itemId, String term, List<String> itemIds, List<String> ids, Boolean showHiddenFacets, Integer groupsMaxDepth, String groupIdFilter, String preFilterExpression, Map<String, ? extends List<? extends Pair<String, ? extends List<String>>>> sectionFacets) {
        ...
        if (groupIdInt != null) {
            arrayList.add(TuplesKt.a(Cu.a.f("filters[group_id]"), String.valueOf(groupIdInt.intValue())));
        }
        if (facets != null) {
            ...
            while (it.hasNext()) {
                ...
                for (String str : (Iterable) pair.d()) {
                    ...
                    arrayList.add(TuplesKt.a(Cu.a.f(str2), Cu.a.f(str)));
                }
            }
        ...
        if (hiddenFields != null) {
            for (String str3 : hiddenFields) {
                ...
                arrayList.add(TuplesKt.a(Cu.a.f(str4), Cu.a.f(str3)));
            }
        ...
        if (variationsMap != null) {
            ...
            arrayList.add(TuplesKt.a(Cu.a.f("variations_map"), Cu.a.f(strQ)));
        ...
        if (page != null) {
            arrayList.add(TuplesKt.a(Cu.a.f("page"), Cu.a.f(page.toString())));
        }
        if (offset != null) {
            arrayList.add(TuplesKt.a(Cu.a.f("offset"), Cu.a.f(offset.toString())));
        }
        if (perPage != null) {
            arrayList.add(TuplesKt.a(Cu.a.f("num_results_per_page"), Cu.a.f(perPage.toString())));
        }
        if (sortBy != null) {
            arrayList.add(TuplesKt.a(Cu.a.f("sort_by"), Cu.a.f(sortBy)));
        }
        if (sortOrder != null) {
            arrayList.add(TuplesKt.a(Cu.a.f("sort_order"), Cu.a.f(sortOrder)));
        }
        if (sectionName != null) {
            arrayList.add(TuplesKt.a(Cu.a.f("section"), Cu.a.f(sectionName.toString())));
        }
        if (hiddenFacets != null) {
            for (String str6 : hiddenFacets) {
                ...
                arrayList.add(TuplesKt.a(Cu.a.f(str7), Cu.a.f(str6)));
            }
        ...
        if (showHiddenFacets != null) {
            ...
            arrayList.add(TuplesKt.a(Cu.a.f(str8), Cu.a.f(showHiddenFacets.toString())));
        }
        if (groupsSortBy != null) {
            ...
            arrayList.add(TuplesKt.a(Cu.a.f(str9), Cu.a.f(groupsSortBy)));
        }
        if (groupsSortOrder != null) {
            ...
            arrayList.add(TuplesKt.a(Cu.a.f(str10), Cu.a.f(groupsSortOrder)));
        }
        if (resultId != null) {
            arrayList.add(TuplesKt.a(Cu.a.f("result_id"), Cu.a.f(resultId)));
        }
        if (groupId != null) {
            arrayList.add(TuplesKt.a(Cu.a.f("group[group_id]"), groupId));
        }
        if (groupIdFilter != null) {
            arrayList.add(TuplesKt.a(Cu.a.f("filters[group_id]"), groupIdFilter));
        }
        if (groupsMaxDepth != null) {
            ...
            arrayList.add(TuplesKt.a(Cu.a.f(str11), Cu.a.f(String.valueOf(iIntValue))));
        }
        if (groupDisplayName != null) {
            arrayList.add(TuplesKt.a(Cu.a.f("group[display_name]"), Cu.a.f(groupDisplayName)));
        }
        if (numResults != null) {
            arrayList.add(TuplesKt.a(Cu.a.f("num_results"), Cu.a.f(numResults.toString())));
        }
        if (itemId != null) {
            arrayList.add(TuplesKt.a(Cu.a.f("item_id"), Cu.a.f(itemId.toString())));
        }
        if (term != null) {
            arrayList.add(TuplesKt.a(Cu.a.f("term"), Cu.a.f(term.toString())));
        }
        if (itemIds != null) {
            Iterator<T> it2 = itemIds.iterator();
            while (it2.hasNext()) {
                arrayList.add(TuplesKt.a(Cu.a.f("item_id"), Cu.a.f((String) it2.next())));
            }
        ...
        if (ids != null) {
            ...
            while (it3.hasNext()) {
                arrayList.add(TuplesKt.a(Cu.a.f("ids"), Cu.a.f((String) it3.next())));
            }
            Unit unit7 = Unit.f143329a;
        }
        if (preFilterExpression != null) {
            arrayList.add(TuplesKt.a(Cu.a.f("pre_filter_expression"), Cu.a.f(preFilterExpression)));
        }
        ...
        for (Pair pair2 : listF) {
            for (Pair pair3 : (Iterable) pair2.d()) {
                for (String str12 : (Iterable) pair3.d()) {
                    ...
                    arrayList.add(TuplesKt.a(Cu.a.f(str13), Cu.a.f(str12)));
                }
            }
        }
    ...
    @Metadata(d1 = {"\u0000\b\n\u0002\u0018\u0002\n\u0002\b\u0003\u0010\u0002\u001a\n \u0001*\u0004\u0018\u00010\u00000\u0000H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"LAu/a;", "kotlin.jvm.PlatformType", "<anonymous>", "()LAu/a;"}, k = 3, mv = {1, 5, 1})
    /* loaded from: classes4.dex */
    static final class a extends Lambda implements Function0<Au.a> {

        /* renamed from: f, reason: collision with root package name */
        public static final a f173297f = new a();
        ...
        public final Au.a invoke() {
            ...
            return aVarD.a(new Bu.c(context)).b();
        }
    }
    ...
    static {
        ...
        component = LazyKt.b(a.f173297f);
        sessionIncrementHandler = b.f173298f;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void C0(Throwable th2) {
        Cu.a.d(f173287a, "Session Start event error: " + th2.getMessage());
    }
    ...
    public static final void M(String searchTerm) {
        ...
        C18553a.Companion companion = C18553a.INSTANCE;
        Cu.a.c(context2, companion.a(), TuplesKt.a(companion.d(), searchTerm));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void N(Throwable th2) {
        Cu.a.d(f173287a, "Autocomplete Select error: " + th2.getMessage());
    }
    ...
    public static final void S(Throwable th2) {
        Cu.a.d(f173287a, "Browse Result Click error: " + th2.getMessage());
    }
    ...
    public static final void X(Throwable th2) {
        Cu.a.d(f173287a, "Browse Results Loaded error: " + th2.getMessage());
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void c0(Throwable th2) {
        Cu.a.d(f173287a, "Conversion error: " + th2.getMessage());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void g0(Throwable th2) {
        Cu.a.d(f173287a, "Input Focus event error: " + th2.getMessage());
    }
    ...
    public static final void l0(Throwable th2) {
        Cu.a.d(f173287a, "Purchase error: " + th2.getMessage());
    }
    ...
    public static final void q0(Throwable th2) {
        Cu.a.d(f173287a, "Search Result Click error: " + th2.getMessage());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void u0(Throwable th2) {
        Cu.a.d(f173287a, "Search Results Loaded error: " + th2.getMessage());
    }
    ...
    public static final void y0(Throwable th2) {
        Cu.a.d(f173287a, "Search Submit error: " + th2.getMessage());
    }
    ...
    public final void H(Context context2, ConstructorIoConfig constructorIoConfig) {
        ...
        if (configMemoryHolderC == null) {
            Intrinsics.x("configMemoryHolder");
    ...
    public final void K(final String searchTerm, String originalQuery, String sectionName, ResultGroup resultGroup, String resultID) {
        ...
        disposable.b(O(searchTerm, originalQuery, sectionName, resultGroup, resultID).i(C13889a.b()).g(new Lu.a() { // from class: zu.p
            @Override // Lu.a
            public final void run() {
                v.M(searchTerm);
            }
        }, new Lu.g() { // from class: zu.q
            @Override // Lu.g
    ...
    public final void P(String filterName, String filterValue, String customerId, int resultPositionOnPage, String sectionName, String resultID, Map<String, String> analyticsTags) {
        ...
        disposable.b(T(filterName, filterValue, customerId, null, resultPositionOnPage, sectionName, resultID, analyticsTags).i(C13889a.b()).g(new Lu.a() { // from class: zu.r
            @Override // Lu.a
            public final void run() {
                v.R();
            }
        }, new Lu.g() { // from class: zu.s
            @Override // Lu.g
            public final void accept(Object obj) {
                v.S((Throwable) obj);
            }
    ...
    public final void U(String filterName, String filterValue, String[] itemIds, int resultCount, String sectionName, String url, Map<String, String> analyticsTags) {
        ...
        disposable.b(Y(filterName, filterValue, itemIds, resultCount, sectionName, url, analyticsTags).i(C13889a.b()).g(new Lu.a() { // from class: zu.i
            @Override // Lu.a
            public final void run() {
                v.W();
            }
        }, new Lu.g() { // from class: zu.j
            @Override // Lu.g
            public final void accept(Object obj) {
                v.X((Throwable) obj);
            }
    ...
    public final void Z(String itemName, String customerId, Double revenue, String searchTerm, String sectionName, String conversionType, Boolean isCustomType, String displayName, Map<String, String> analyticsTags) {
        ...
        Intrinsics.j(customerId, "customerId");
        Intrinsics.j(searchTerm, "searchTerm");
        disposable.b(d0(itemName, customerId, null, revenue, searchTerm, sectionName, conversionType, isCustomType, displayName, analyticsTags).i(C13889a.b()).g(new Lu.a() { // from class: zu.t
            @Override // Lu.a
            public final void run() {
                v.b0();
            }
        }, new Lu.g() { // from class: zu.u
            @Override // Lu.g
            public final void accept(Object obj) {
                v.c0((Throwable) obj);
            }
    ...
    public final void i0(String[] customerIds, Double revenue, String orderID, String sectionName, Map<String, String> analyticsTags) {
        ...
        disposable.b(m0((PurchaseItem[]) array, revenue, orderID, sectionName, analyticsTags).i(C13889a.b()).g(new Lu.a() { // from class: zu.g
            @Override // Lu.a
            public final void run() {
                v.k0();
            }
        }, new Lu.g() { // from class: zu.h
            @Override // Lu.g
            public final void accept(Object obj) {
                v.l0((Throwable) obj);
            }
    ...
    public final void n0(String itemName, String customerId, String searchTerm, String sectionName, String resultID) {
        ...
        Intrinsics.j(customerId, "customerId");
        Intrinsics.j(searchTerm, "searchTerm");
        disposable.b(r0(itemName, customerId, null, searchTerm, sectionName, resultID).i(C13889a.b()).g(new Lu.a() { // from class: zu.e
            @Override // Lu.a
            public final void run() {
                v.p0();
            }
        }, new Lu.g() { // from class: zu.f
            @Override // Lu.g
            public final void accept(Object obj) {
                v.q0((Throwable) obj);
            }
    ...
    public final void s0(String term, int resultCount, String[] customerIds) {
        ...
        disposable.b(v0(term, resultCount, customerIds).i(C13889a.b()).g(new Lu.a() { // from class: zu.k
            @Override // Lu.a
            public final void run() {
                v.t0();
            }
        }, new Lu.g() { // from class: zu.l
            @Override // Lu.g
            public final void accept(Object obj) {
                v.u0((Throwable) obj);
            }
    ...
    public final void w0(final String searchTerm, String originalQuery, ResultGroup resultGroup) {
        Intrinsics.j(searchTerm, "searchTerm");
        Intrinsics.j(originalQuery, "originalQuery");
        disposable.b(z0(searchTerm, originalQuery, resultGroup).i(C13889a.b()).g(new Lu.a() { // from class: zu.b
            @Override // Lu.a
            public final void run() {
                v.x0(searchTerm);
            }
        }, new Lu.g() { // from class: zu.m
            @Override // Lu.g
            public final void accept(Object obj) {
                v.y0((Throwable) obj);
            }
    ...
    public final void A0() {
        disposable.b(D0().i(C13889a.b()).g(new Lu.a() { // from class: zu.n
            @Override // Lu.a
            public final void run() {
                v.B0();
            }
        }, new Lu.g() { // from class: zu.o
            @Override // Lu.g
            public final void accept(Object obj) {
                v.C0((Throwable) obj);
            }
    ...
    public final void e0(String term) {
        disposable.b(h0(term).i(C13889a.b()).g(new Lu.a() { // from class: zu.c
            @Override // Lu.a
            public final void run() {
                v.f0();
            }
        }, new Lu.g() { // from class: zu.d
            @Override // Lu.g
            public final void accept(Object obj) {
                v.g0((Throwable) obj);
            }
