...
@Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u000b\bÀ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u001f\u0010\u0007\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0006\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\u0007\u0010\bJ\u0017\u0010\n\u001a\u00020\u00042\u0006\u0010\t\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\n\u0010\u000bJ#\u0010\u000e\u001a\u00020\u00042\b\b\u0002\u0010\f\u001a\u00020\u00042\b\b\u0002\u0010\r\u001a\u00020\u0004H\u0000¢\u0006\u0004\b\u000e\u0010\b¨\u0006\u000f"}, d2 = {"Lt5/f;", "", "<init>", "()V", "", "mobileCoreVersion", "analyticsVersion", "d", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", "versionString", "c", "(Ljava/lang/String;)Ljava/lang/String;", "coreExtensionVersion", "analyticsExtensionVersion", "a", "analytics_phoneRelease"}, k = 1, mv = {1, 5, 1}, xi = 48)
@SourceDebugExtension
/* loaded from: classes4.dex */
public final class f {

    /* renamed from: a, reason: collision with root package name */
    public static final f f162267a = new f();
    ...
    private final String c(String versionString) {
        ...
        String str2;
        String str3;
        String[] strArr = (String[]) StringsKt.b1(versionString, new String[]{"."}, false, 0, 6, null).toArray(new String[0]);
        if (strArr.length != 3) {
            return "000000";
        }
    ...
    private final String d(String mobileCoreVersion, String analyticsVersion) {
        String str;
        String str2;
        String[] strArr = (String[]) StringsKt.b1(mobileCoreVersion, new String[]{"-"}, false, 0, 6, null).toArray(new String[0]);
        if (strArr.length == 2) {
