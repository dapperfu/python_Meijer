...
public final class C13954b extends Drawable implements Drawable.Callback, Animatable, FSDraw {
    ...
    @JvmOverloads
    public C13954b(Drawable drawable, Drawable drawable2, EnumC15911h enumC15911h, int i10, boolean z10, boolean z11) {
        Integer numValueOf;
        Integer numValueOf2;
        Integer numValueOf3;
        Integer numValueOf4;
    ...
    public final void c(Drawable drawable, Rect targetBounds) {
        ...
        if (intrinsicWidth > 0 && intrinsicHeight > 0) {
            ...
            double dC = C13625i.c(intrinsicWidth, intrinsicHeight, iWidth, iHeight, this.scale);
            double d10 = 2;
