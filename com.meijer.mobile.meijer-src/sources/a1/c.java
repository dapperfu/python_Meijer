...
public final class c extends l {
    ...
    public c() {
        ...
        this.tintColor = C5489q0.INSTANCE.j();
    ...
    private final void l(AbstractC5467i0 brush) {
    ...
    private final void y() {
        ...
        float[] fArr = fArrC;
        C5474k1.o(fArr, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        C5474k1.j(fArr, this.rotation);
        C5474k1.k(fArr, this.scaleX, this.scaleY, 1.0f);
        C5474k1.o(fArr, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void a(X0.f fVar) {
        ...
        try {
            ...
            if (fArr != null) {
                transform.a(C5474k1.a(fArr).getValues());
            }
