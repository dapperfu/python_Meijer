...
public final class m extends l {
    ...
    private final C5641a cacheDrawScope;

    /* renamed from: f, reason: collision with root package name and from kotlin metadata */
    private Function0<Unit> invalidateCallback;

    /* renamed from: g, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5872l0 intrinsicColorFilter;

    /* renamed from: h, reason: collision with root package name and from kotlin metadata */
    private C5490r0 tintFilter;

    /* renamed from: i, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5872l0 viewportSize;
    ...
    static final class c extends Lambda implements Function0<Unit> {
        ...
        public static final c f44326f = new c();
    ...
    public m(a1.c cVar) {
        ...
        this.name = "";
        this.isDirty = true;
        this.cacheDrawScope = new C5641a();
        this.invalidateCallback = c.f44326f;
    ...
    public final void i(X0.f fVar, float f10, C5490r0 c5490r0) {
        X0.f fVar2;
        int iA = (this.root.getIsTintable() && this.root.getTintColor() != 16 && o.f(k()) && o.f(c5490r0)) ? C5462g1.INSTANCE.a() : C5462g1.INSTANCE.b();
        if (!this.isDirty && U0.k.f(this.previousDrawSize, fVar.b()) && C5462g1.i(iA, j())) {
            fVar2 = fVar;
        } else {
            this.tintFilter = C5462g1.i(iA, C5462g1.INSTANCE.a()) ? C5490r0.Companion.c(C5490r0.INSTANCE, this.root.getTintColor(), 0, 2, null) : null;
        ...
        if (c5490r0 == null) {
            c5490r0 = k() != null ? k() : this.tintFilter;
        }
        this.cacheDrawScope.c(fVar2, f10, c5490r0);
    }

    public final int j() {
        InterfaceC5459f1 mCachedImage = this.cacheDrawScope.getMCachedImage();
        return mCachedImage != null ? mCachedImage.b() : C5462g1.INSTANCE.b();
    }

    /* JADX WARN: Multi-variable type inference failed */
    public final C5490r0 k() {
        return (C5490r0) this.intrinsicColorFilter.getValue();
    }
    ...
    public final void n(C5490r0 c5490r0) {
        this.intrinsicColorFilter.setValue(c5490r0);
    }
