...
public abstract class AbstractC15063a extends L {
    ...
    public final void x(int position) {
        InterfaceC15064b interfaceC15064b;
        InterfaceC18089i interfaceC18089iW = w(position);
        if (interfaceC18089iW instanceof InterfaceC15064b) {
            interfaceC15064b = (InterfaceC15064b) interfaceC18089iW;
        } else {
            interfaceC15064b = null;
        }
        if (interfaceC15064b != null) {
            interfaceC15064b.a(true);
        }
    }
}
