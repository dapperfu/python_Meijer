...
final /* synthetic */ class C17834l {
    public static final <K, V> void a(C5603a<K, V> map, boolean z10, Function1<? super C5603a<K, V>, Unit> fetchBlock) {
        Intrinsics.j(map, "map");
        Intrinsics.j(fetchBlock, "fetchBlock");
        C5603a c5603a = new C5603a(G.MAX_BIND_PARAMETER_CNT);
        int size = map.getSize();
        int i10 = 0;
        int i11 = 0;
        while (i10 < size) {
            if (z10) {
                c5603a.put(map.g(i10), map.k(i10));
            } else {
                c5603a.put(map.g(i10), null);
            }
            i10++;
            i11++;
            if (i11 == 999) {
                fetchBlock.invoke(c5603a);
                if (!z10) {
                    map.putAll(c5603a);
                }
                c5603a.clear();
