...
public final class C15685d {
    ...
    private final Context f150756a;

    private ApplicationInfo a() throws PackageManager.NameNotFoundException {
        return this.f150756a.getPackageManager().getApplicationInfo(this.f150756a.getPackageName(), 128);
    }
    ...
    public List<InterfaceC15683b> b() {
    ...
    public C15685d(Context context) {
        this.f150756a = context;
    }

    private static InterfaceC15683b c(String str) throws IllegalAccessException, InstantiationException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
        try {
            ...
            if (objNewInstance instanceof InterfaceC15683b) {
                return (InterfaceC15683b) objNewInstance;
            }
