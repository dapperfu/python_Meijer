...
@Metadata(d1 = {"\u0000\f\n\u0002\u0010\u000e\n\u0002\u0010\u0012\n\u0002\b\f\u001a\u0015\u0010\u0002\u001a\u0004\u0018\u00010\u0001*\u00020\u0000H\u0000¢\u0006\u0004\b\u0002\u0010\u0003\u001a\u001d\u0010\u0005\u001a\u00020\u0000*\u00020\u00012\b\b\u0002\u0010\u0004\u001a\u00020\u0001H\u0000¢\u0006\u0004\b\u0005\u0010\u0006\"\u001a\u0010\n\u001a\u00020\u00018\u0000X\u0080\u0004¢\u0006\f\n\u0004\b\u0002\u0010\u0007\u001a\u0004\b\b\u0010\t\"\u001a\u0010\f\u001a\u00020\u00018\u0000X\u0080\u0004¢\u0006\f\n\u0004\b\u0005\u0010\u0007\u001a\u0004\b\u000b\u0010\t¨\u0006\r"}, d2 = {"", "", "a", "(Ljava/lang/String;)[B", "map", "b", "([B[B)Ljava/lang/String;", "[B", "getBASE64", "()[B", "BASE64", "d", "BASE64_URL_SAFE", "okio"}, k = 2, mv = {2, 2, 0}, xi = 48)
@JvmName
...
public final class C14412a {
    ...
    private static final byte[] f134528a;

    /* renamed from: b, reason: collision with root package name */
    private static final byte[] f134529b;

    static {
        C14419h.Companion companion = C14419h.INSTANCE;
        f134528a = companion.d("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/").getData();
        f134529b = companion.d("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_").getData();
    }
    ...
    public static final String b(byte[] bArr, byte[] map) {
        ...
        while (i10 < length) {
            ...
            int i13 = i11 + 3;
            bArr2[i11 + 2] = map[((b11 & C14170dq.MULTIPLY) << 2) | ((b12 & 255) >> 6)];
            i11 += 4;
        ...
        if (length2 == 1) {
            ...
            bArr2[i11 + 2] = map[(b15 & C14170dq.MULTIPLY) << 2];
            bArr2[i11 + 3] = 61;
        }
        return O.c(bArr2);
    }
