...
@Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\u001a+\u0010\u0007\u001a\u00020\u0006*\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00012\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003H\u0007¢\u0006\u0004\b\u0007\u0010\b¨\u0006\t"}, d2 = {"LKi/M;", "Landroidx/compose/ui/Modifier;", "modifier", "", "Lts/a;", "oosProducts", "", "b", "(LKi/M;Landroidx/compose/ui/Modifier;Ljava/util/List;Landroidx/compose/runtime/Composer;II)V", "Meijer_playstoreRelease"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class p0 {
    ...
    static final class a implements Function3<InterfaceC14902f, Composer, Integer, Unit> {
        ...
        final /* synthetic */ List<ProductCardDecorator> f3485a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f3486b;

        a(List<ProductCardDecorator> list, LocalThemeScope localThemeScope) {
            this.f3485a = list;
            this.f3486b = localThemeScope;
        }
        ...
        public final void f(InterfaceC14902f AdsColumn, Composer composer, int i10) {
            ...
            int i11 = 0;
            for (ProductCardDecorator productCardDecorator : this.f3485a) {
                int i12 = i11 + 1;
                LocalThemeScope localThemeScope = this.f3486b;
                composer2.startReplaceGroup(1849434622);
                Object objB = composer2.B();
                Composer.Companion companion = Composer.INSTANCE;
                if (objB == companion.a()) {
                    objB = new Function0() { // from class: Bm.k0
                ...
                if (objB2 == companion.a()) {
                    objB2 = new Function0() { // from class: Bm.l0
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            return p0.a.k();
                        }
                ...
                if (objB3 == companion.a()) {
                    objB3 = new Function0() { // from class: Bm.m0
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            return p0.a.l();
                        }
                ...
                if (objB4 == companion.a()) {
                    objB4 = new Function0() { // from class: Bm.n0
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            return p0.a.o();
                        }
                ...
                if (objB5 == companion.a()) {
                    objB5 = new Function0() { // from class: Bm.o0
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            return p0.a.p();
                        }
                ...
                composer2.P();
                ss.v.C(localThemeScope, productCardDecorator, i11, null, false, null, function0, function02, function03, 11.0d, false, function04, (Function0) objB5, null, false, false, false, false, false, 0, false, false, false, false, null, composer, 920346624 | LocalThemeScope.f17314g | (ProductCardDecorator.f163361E << 3), 14156214, 54, 15101956);
                composer2 = composer;
                i11 = i12;
            }
            if (ComposerKt.M()) {
    ...
    public static final void b(final LocalThemeScope localThemeScope, Modifier modifier, final List<ProductCardDecorator> oosProducts, Composer composer, final int i10, final int i11) {
        ...
        if ((i12 & 147) == 146 && composerStartRestartGroup.j()) {
            ...
            C16453n.e(localThemeScope, new q1.Column(androidx.compose.foundation.layout.J.h(modifier, 0.0f, 1, null), null, null, 6, null), ComposableLambdaKt.c(1465597913, true, new a(oosProducts, localThemeScope), composerStartRestartGroup, 54), composerStartRestartGroup, (i12 & 14) | LocalThemeScope.f17314g | 384 | (q1.Column.f142240d << 3));
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
        ...
        if (t0L != null) {
            t0L.a(new Function2() { // from class: Bm.j0
