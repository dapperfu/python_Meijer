...
public final class C13746e implements p {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final long localPosition;

    public /* synthetic */ C13746e(long j10, DefaultConstructorMarker defaultConstructorMarker) {
        this(j10);
    }

    private C13746e(long j10) {
    ...
    public long a(H1.p anchorBounds, long windowSize, t layoutDirection, long popupContentSize) {
        ...
        if (layoutDirection == t.f13338a) {
            z10 = true;
        } else {
            z10 = false;
        }
        return n.f((C13747f.b(left, i10, i11, z10) << 32) | (C13747f.c(anchorBounds.getTop() + n.l(this.localPosition), (int) (popupContentSize & 4294967295L), (int) (windowSize & 4294967295L), false, 8, null) & 4294967295L));
    }
}
