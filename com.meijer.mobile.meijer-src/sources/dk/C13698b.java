...
@Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a\u0019\u0010\u0003\u001a\u00020\u00022\b\u0010\u0001\u001a\u0004\u0018\u00010\u0000H\u0007¢\u0006\u0004\b\u0003\u0010\u0004\u001a\u0019\u0010\u0005\u001a\u00020\u00022\b\u0010\u0001\u001a\u0004\u0018\u00010\u0000H\u0007¢\u0006\u0004\b\u0005\u0010\u0004\u001a\u000f\u0010\u0007\u001a\u00020\u0006H\u0003¢\u0006\u0004\b\u0007\u0010\b¨\u0006\t"}, d2 = {"Lbk/a;", "formattedString", "", "a", "(Lbk/a;Landroidx/compose/runtime/Composer;I)Ljava/lang/String;", "b", "Landroid/content/res/Resources;", "c", "(Landroidx/compose/runtime/Composer;I)Landroid/content/res/Resources;", "i18n_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* renamed from: dk.b, reason: case insensitive filesystem */
/* loaded from: classes8.dex */
public final class C13698b {
    public static final String a(AbstractC6392a abstractC6392a, Composer composer, int i10) {
        String strC;
        if (ComposerKt.M()) {
        ...
        if (abstractC6392a != null) {
            strC = abstractC6392a.c(resourcesC);
        } else {
            strC = null;
        }
        if (strC == null) {
    ...
    public static final String b(AbstractC6392a abstractC6392a, Composer composer, int i10) {
        String strC;
        if (ComposerKt.M()) {
        ...
        if (abstractC6392a != null && (strC = abstractC6392a.c(resourcesC)) != null) {
