...
public class C17668a {
    ...
    private final String f165812a;

    /* renamed from: b, reason: collision with root package name */
    private final Map<String, String> f165813b;

    /* renamed from: c, reason: collision with root package name */
    private final Map<String, String> f165814c = new HashMap();
    ...
    public C17668a d(String str, String str2) {
        this.f165814c.put(str, str2);
        return this;
    }

    public C17668a(String str, Map<String, String> map) {
        this.f165812a = str;
        this.f165813b = map;
    }
    ...
    public C17670c c() throws Throwable {
        ...
        inputStream = null;
        try {
            String strB = b(this.f165812a, this.f165813b);
            ...
            try {
                ...
                for (Map.Entry<String, String> entry : this.f165814c.entrySet()) {
                ...
                httpsURLConnection.disconnect();
                return new C17670c(responseCode, strE);
            } catch (Throwable th3) {
                th = th3;
            }
        } catch (Throwable th4) {
