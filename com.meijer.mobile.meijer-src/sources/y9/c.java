...
@Metadata(d1 = {"\u0000V\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0017\u0018\u0000 \u00192\u00020\u0001:\u0001!B\u001f\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0005\u001a\u00020\u0004\u0012\u0006\u0010\u0007\u001a\u00020\u0006¢\u0006\u0004\b\b\u0010\tJ\u001f\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\u0002H\u0012¢\u0006\u0004\b\u000e\u0010\u000fJ+\u0010\u0013\u001a\u00020\r2\u0006\u0010\u000b\u001a\u00020\n2\u0012\u0010\u0012\u001a\u000e\u0012\u0004\u0012\u00020\u0011\u0012\u0004\u0012\u00020\u00110\u0010H\u0012¢\u0006\u0004\b\u0013\u0010\u0014J\u001f\u0010\u0015\u001a\u00020\r2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\u0002H\u0012¢\u0006\u0004\b\u0015\u0010\u000fJ\u0019\u0010\u0017\u001a\u00020\u00162\b\u0010\u000b\u001a\u0004\u0018\u00010\nH\u0012¢\u0006\u0004\b\u0017\u0010\u0018J\u0019\u0010\u0019\u001a\u00020\u00112\b\u0010\u000b\u001a\u0004\u0018\u00010\nH\u0012¢\u0006\u0004\b\u0019\u0010\u001aJ\u0017\u0010\u001e\u001a\u00020\u001d2\u0006\u0010\u001c\u001a\u00020\u001bH\u0012¢\u0006\u0004\b\u001e\u0010\u001fJ\u0015\u0010!\u001a\b\u0012\u0004\u0012\u00020\u00160 H\u0016¢\u0006\u0004\b!\u0010\"R\u0014\u0010\u0003\u001a\u00020\u00028\u0012X\u0092\u0004¢\u0006\u0006\n\u0004\b!\u0010#R\u0014\u0010\u0005\u001a\u00020\u00048\u0012X\u0092\u0004¢\u0006\u0006\n\u0004\b\u000e\u0010$R\u0014\u0010\u0007\u001a\u00020\u00068\u0012X\u0092\u0004¢\u0006\u0006\n\u0004\b\u001e\u0010%¨\u0006&"}, d2 = {"Ly9/c;", "", "LA9/c;", "requestModel", "La9/b;", "connectionProvider", "Lu9/a;", "timestampProvider", "<init>", "(LA9/c;La9/b;Lu9/a;)V", "Ljavax/net/ssl/HttpsURLConnection;", "connection", "model", "", "b", "(Ljavax/net/ssl/HttpsURLConnection;LA9/c;)V", "", "", "headers", "g", "(Ljavax/net/ssl/HttpsURLConnection;Ljava/util/Map;)V", "f", "LD9/c;", "e", "(Ljavax/net/ssl/HttpsURLConnection;)LD9/c;", "d", "(Ljavax/net/ssl/HttpsURLConnection;)Ljava/lang/String;", "", "responseCode", "", "c", "(I)Z", "LX8/c;", "a", "()LX8/c;", "LA9/c;", "La9/b;", "Lu9/a;", "core_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public class c {
    ...
    public c(A9.c requestModel, C5670b connectionProvider, C17361a timestampProvider) {
    ...
    public X8.c<ResponseModel> a() {
        ...
        try {
            ...
            try {
                ...
                return new X8.c<>(responseModelE, exc);
            }
        } catch (Exception e12) {
            e = e12;
            responseModelE = null;
    ...
    private void b(HttpsURLConnection connection, A9.c model) throws ProtocolException {
        connection.setRequestMethod(model.getMethod().name());
        g(connection, model.a());
        connection.setConnectTimeout(30000);
        if (model.getMethod() != A9.b.GET && model.d() != null) {
    ...
    private void f(HttpsURLConnection connection, A9.c model) throws IOException {
        if (model.d() != null) {
            Map<String, Object> mapD = model.d();
            Intrinsics.g(mapD);
            String string = h.b(I9.j.a(mapD)).toString();
            Intrinsics.i(string, "toString(...)");
