...
class z implements A {
    ...
    private static final String f31951b = "z";

    /* renamed from: a, reason: collision with root package name */
    private final ExecutorService f31952a = new ThreadPoolExecutor(0, 32, 60, TimeUnit.SECONDS, new SynchronousQueue());

    private Map<String, String> d() {
        HashMap map = new HashMap();
        InterfaceC5123j interfaceC5123jE = K.f().e();
        if (interfaceC5123jE != null) {
            String strU = interfaceC5123jE.u();
            if (!e(strU)) {
                map.put(HttpHeaders.USER_AGENT, strU);
            }
            String strJ = interfaceC5123jE.j();
            if (!e(strJ)) {
    ...
    private o c(x xVar) {
        ...
        if (xVar.f() != null && xVar.f().contains(BuildConfig.SERVICE_SCHEME)) {
            ...
            try {
                ...
                t.f("Services", f31951b, String.format("Could not connect, invalid URL (%s) [%s]!!", xVar.f(), e11), new Object[0]);
                return null;
            }
        }
        t.f("Services", f31951b, String.format("Invalid URL (%s), only HTTPS protocol is supported", xVar.f()), new Object[0]);
        return null;
    }
    ...
    public void a(final x xVar, final w wVar) {
        ...
        if (connectivityManagerD != null) {
            if (!M5.l.a(connectivityManagerD)) {
                t.e("Services", f31951b, "The Android device is offline.", new Object[0]);
                wVar.a(null);
                return;
            }
        } else {
            t.a("Services", f31951b, "ConnectivityManager instance is null. Unable to the check the network condition.", new Object[0]);
        }
        try {
            this.f31952a.submit(new Runnable() { // from class: R5.y
                @Override // java.lang.Runnable
                public final void run() {
                    z.b(this.f31948a, xVar, wVar);
                }
            });
        } catch (Exception e10) {
            String str = f31951b;
