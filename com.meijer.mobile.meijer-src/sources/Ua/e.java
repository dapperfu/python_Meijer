...
public class e extends Sa.d {
    ...
    private View a(View view, int i10, int i11, double d10) {
        ...
        androidx.constraintlayout.widget.c cVar = (androidx.constraintlayout.widget.c) constraintLayout.getTag(Ta.g.f35993h);
        if (i10 == -3) {
    ...
    public a e(View view, float f10, float f11) {
        ...
        if (view instanceof SourceImageView) {
            ...
            Object tag = view.getTag(Ta.g.f35994i);
            if (tag instanceof List) {
                List list = (List) tag;
                if (list.size() == 1 && (list.get(0) instanceof Ta.b)) {
                    return new d(new RectF(view.getLeft() + f10, view.getTop() + f11, view.getRight() + f10, view.getBottom() + f11), (Ta.b) list.get(0));
                }
            }
    ...
    protected View i(Context context, RectF rectF) {
        ...
        constraintLayout.setTag(Ta.g.f35993h, cVar);
    ...
    protected View l(Context context, ZoomScrollView zoomScrollView, SourceImageView.c cVar, SourceImageView.d dVar, boolean z10) {
        View viewInflate = LayoutInflater.from(context).inflate(Ta.h.f35999b, (ViewGroup) null);
        SourceImageView sourceImageView = (SourceImageView) viewInflate.findViewById(Ta.g.f35988c);
        sourceImageView.setClipStateDelegate(cVar);
        sourceImageView.setMatchupDelegate(dVar);
        if (zoomScrollView != null) {
            zoomScrollView.i(sourceImageView);
        ...
        if (z10) {
            viewInflate.findViewById(Ta.g.f35992g).setLayerType(1, null);
            viewInflate.findViewById(Ta.g.f35991f).setLayerType(1, null);
            viewInflate.findViewById(Ta.g.f35989d).setLayerType(1, null);
            viewInflate.findViewById(Ta.g.f35990e).setLayerType(1, null);
        }
        return viewInflate;
    }

    public View o(Context context) {
        return LayoutInflater.from(context).inflate(Ta.h.f36000c, (ViewGroup) null);
    }
    ...
    protected void y(View view, l lVar) {
        List<Ta.b> listQ = q(lVar);
        if (listQ != null && !listQ.isEmpty()) {
            view.setTag(Ta.g.f35994i, listQ);
        }
    }
}
