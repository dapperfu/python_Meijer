...
public final class d {
    ...
    private static final String f31864a;

    static {
        String strI = AbstractC4373v.i("SystemJobScheduler");
    ...
    public static final String a(Context context, WorkDatabase workDatabase, androidx.work.a configuration) {
        ...
        int size = workDatabase.l().g().size();
    ...
    public static final List<JobInfo> b(JobScheduler jobScheduler) {
        ...
        try {
            return a.f31862a.a(jobScheduler);
        } catch (Throwable th2) {
            AbstractC4373v.e().d(f31864a, "getAllPendingJobs() is not reliable on this device.", th2);
            return null;
        }
    }
    ...
    public static final JobScheduler c(Context context) {
        ...
        return Build.VERSION.SDK_INT >= 34 ? c.f31863a.a(jobScheduler) : jobScheduler;
    }
}
