...
@Metadata(d1 = {"\u0000n\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\b\u0003\u001a+\u0010\u0007\u001a\u00020\u0006*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u00012\u0006\u0010\u0004\u001a\u00020\u00032\u0006\u0010\u0005\u001a\u00020\u0003H\u0000¢\u0006\u0004\b\u0007\u0010\b\u001a\u0019\u0010\f\u001a\b\u0012\u0004\u0012\u00020\u000b0\n*\u00020\tH\u0002¢\u0006\u0004\b\f\u0010\r\u001a\u0013\u0010\u000f\u001a\u00020\u000e*\u00020\tH\u0002¢\u0006\u0004\b\u000f\u0010\u0010\u001a\u0013\u0010\u0012\u001a\u00020\u0011*\u00020\tH\u0002¢\u0006\u0004\b\u0012\u0010\u0013\u001a\u001f\u0010\u0016\u001a\b\u0012\u0004\u0012\u00020\u00150\n*\b\u0012\u0004\u0012\u00020\u00140\nH\u0002¢\u0006\u0004\b\u0016\u0010\u0017\u001a\u001f\u0010\u001a\u001a\b\u0012\u0004\u0012\u00020\u00190\n*\b\u0012\u0004\u0012\u00020\u00180\nH\u0002¢\u0006\u0004\b\u001a\u0010\u0017\u001a\u001f\u0010\u001d\u001a\b\u0012\u0004\u0012\u00020\u001c0\n*\b\u0012\u0004\u0012\u00020\u001b0\nH\u0002¢\u0006\u0004\b\u001d\u0010\u0017\u001a\u0013\u0010\u001f\u001a\u00020\u001b*\u00020\u001eH\u0002¢\u0006\u0004\b\u001f\u0010 \u001a\u0013\u0010#\u001a\u00020\"*\u00020!H\u0002¢\u0006\u0004\b#\u0010$¨\u0006%"}, d2 = {"LSo/e$f;", "", "query", "", "currentPage", "pageSize", "LOo/b;", "h", "(LSo/e$f;Ljava/lang/String;II)LOo/b;", "LSo/e$j;", "", "LCo/h;", "f", "(LSo/e$j;)Ljava/util/List;", "Lcom/meijer/mobile/product/model/search/api/ResultSources;", "g", "(LSo/e$j;)Lcom/meijer/mobile/product/model/search/api/ResultSources;", "LPo/a;", "b", "(LSo/e$j;)LPo/a;", "LSo/e$g;", "LQo/a;", "c", "(Ljava/util/List;)Ljava/util/List;", "LSo/e$p;", "LQo/g;", "i", "LSo/e$h;", "LQo/e;", "d", "LSo/e$c;", "e", "(LSo/e$c;)LSo/e$h;", "LSo/e$q;", "", "a", "(LSo/e$q;)Z", "apollo_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* loaded from: classes12.dex */
public final class c {
    private static final List<FilterFacet> c(List<ProductDepartmentQuery.FilterOption> list) {
        ArrayList arrayList;
        List<ProductDepartmentQuery.FilterOption> list2 = list;
        ArrayList arrayList2 = new ArrayList(CollectionsKt.x(list2, 10));
        for (ProductDepartmentQuery.FilterOption filterOption : list2) {
            ...
            List<ProductDepartmentQuery.Option> listD = filterOption.d();
            if (listD != null) {
                List<ProductDepartmentQuery.Option> list3 = listD;
                arrayList = new ArrayList(CollectionsKt.x(list3, 10));
                for (ProductDepartmentQuery.Option option : list3) {
    ...
    private static final List<FilterGroup> d(List<ProductDepartmentQuery.GroupFilterOption> list) {
        List<ProductDepartmentQuery.GroupFilterOption> list2 = list;
        ArrayList arrayList = new ArrayList(CollectionsKt.x(list2, 10));
        for (ProductDepartmentQuery.GroupFilterOption groupFilterOption : list2) {
            String displayName = groupFilterOption.getDisplayName();
            if (displayName == null) {
                displayName = "";
            }
            String str = displayName;
            List<ProductDepartmentQuery.Child> listA = groupFilterOption.a();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.x(listA, 10));
            Iterator<T> it = listA.iterator();
            while (it.hasNext()) {
                arrayList2.add(e((ProductDepartmentQuery.Child) it.next()));
            }
    ...
    private static final ResultSources g(ProductDepartmentQuery.ItemConnection itemConnection) {
    ...
    public static final SearchResult h(ProductDepartmentQuery.Department department, String query, int i10, int i11) {
        Intrinsics.j(department, "<this>");
        Intrinsics.j(query, "query");
        return new SearchResult(g(department.getOnFilterableProductDisplayResult().getItemConnection()), query, new Query(null, null, 3, null), new Pagination(department.getOnFilterableProductDisplayResult().getItemConnection().getPageInfo().getEndCursor() == null ? 0 : i10, i11, (int) Math.ceil(department.getOnFilterableProductDisplayResult().getItemConnection().getTotalCount() / i11), department.getOnFilterableProductDisplayResult().getItemConnection().getTotalCount()), b(department.getOnFilterableProductDisplayResult().getItemConnection()), f(department.getOnFilterableProductDisplayResult().getItemConnection()), c(department.getOnFilterableProductDisplayResult().b()), i(department.getOnFilterableProductDisplayResult().e()), null, d(department.getOnFilterableProductDisplayResult().c()), 256, null);
    }

    private static final List<FilterSortOption> i(List<ProductDepartmentQuery.SortOption> list) {
        List<ProductDepartmentQuery.SortOption> list2 = list;
        ArrayList arrayList = new ArrayList(CollectionsKt.x(list2, 10));
        for (ProductDepartmentQuery.SortOption sortOption : list2) {
    ...
    private static final boolean a(ProductDepartmentQuery.Stock stock) {
    ...
    private static final Cursor b(ProductDepartmentQuery.ItemConnection itemConnection) {
    ...
    private static final ProductDepartmentQuery.GroupFilterOption e(ProductDepartmentQuery.Child child) {
        return new ProductDepartmentQuery.GroupFilterOption(child.getCount(), child.getDisplayName(), child.getGroupId(), CollectionsKt.m());
    }
    ...
    */
    private static final java.util.List<Co.ProductFullDetails> f(So.ProductDepartmentQuery.ItemConnection r76) {
        /*
            Method dump skipped, instructions count: 1096
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: Wo.c.f(So.e$j):java.util.List");
    }
}
