...
class A {
    ...
    private float[] f14147b = new float[20];

    /* renamed from: c, reason: collision with root package name */
    private int f14148c = 0;

    public void a(long j10, float f10) {
        int i10 = (this.f14148c + 1) % 20;
        this.f14148c = i10;
        this.f14146a[i10] = j10;
        this.f14147b[i10] = f10;
    }

    float b() {
        float fC;
        int i10 = this.f14148c;
        if (i10 == 0 && this.f14146a[i10] == Long.MIN_VALUE) {
            return 0.0f;
        }
        long j10 = this.f14146a[i10];
        int i11 = 0;
        long j11 = j10;
        while (true) {
            long j12 = this.f14146a[i10];
        ...
        if (i11 == 2) {
            int i12 = this.f14148c;
            int i13 = i12 == 0 ? 19 : i12 - 1;
            long[] jArr = this.f14146a;
            float f11 = jArr[i12] - jArr[i13];
            if (f11 == 0.0f) {
                return 0.0f;
            }
            float[] fArr = this.f14147b;
            fC = (fArr[i12] - fArr[i13]) / f11;
        } else {
            int i14 = this.f14148c;
            int i15 = ((i14 - i11) + 21) % 20;
            int i16 = (i14 + 21) % 20;
            long j13 = this.f14146a[i15];
            float f12 = this.f14147b[i15];
            int i17 = i15 + 1;
            float fC2 = 0.0f;
            for (int i18 = i17 % 20; i18 != i16; i18 = (i18 + 1) % 20) {
                long j14 = this.f14146a[i18];
                float f13 = j14 - j13;
                if (f13 != 0.0f) {
                    float f14 = this.f14147b[i18];
