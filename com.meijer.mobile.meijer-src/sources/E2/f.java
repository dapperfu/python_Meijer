...
public final class f extends AbstractC6098w<f, a> implements Q {
    private static final f DEFAULT_INSTANCE;
    private static volatile Y<f> PARSER = null;
    public static final int PREFERENCES_FIELD_NUMBER = 1;
    private J<String, h> preferences_ = J.d();

    public static final class a extends AbstractC6098w.a<f, a> implements Q {
        /* synthetic */ a(e eVar) {
            this();
        }
    ...
    private static final class b {
        ...
        static final I<String, h> f6996a = I.d(q0.b.f54581k, "", q0.b.f54583m, h.f0());
    }

    static {
        f fVar = new f();
        DEFAULT_INSTANCE = fVar;
        AbstractC6098w.Q(f.class, fVar);
    }
    ...
    public static f b0(InputStream inputStream) throws IOException {
        return (f) AbstractC6098w.O(DEFAULT_INSTANCE, inputStream);
    }
    ...
    protected final Object z(AbstractC6098w.f fVar, Object obj, Object obj2) {
        ...
        switch (e.f6995a[fVar.ordinal()]) {
            ...
            case 2:
                return new a(eVar);
            case 3:
                return AbstractC6098w.M(DEFAULT_INSTANCE, "\u0001\u0001\u0000\u0000\u0001\u0001\u0001\u0001\u0000\u0000\u00012", new Object[]{"preferences_", b.f6996a});
            case 4:
