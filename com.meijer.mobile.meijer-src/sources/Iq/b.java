...
public final class b {
    public static final ShoppingListItem a(ShoppingListItemWireModel shoppingListItemWireModel) {
        ...
        LocalDate localDateL = (promotionStart == null || (localDateTime2 = (LocalDateTime) d.b(promotionStart, C17898a.f167225a.s(), new j())) == null) ? null : localDateTime2.l();
        String promotionEnd = shoppingListItemWireModel.getPromotionEnd();
        LocalDate localDateL2 = (promotionEnd == null || (localDateTime = (LocalDateTime) d.b(promotionEnd, C17898a.f167225a.s(), new j())) == null) ? null : localDateTime.l();
    ...
    public static final ShoppingListItemWireModel b(ShoppingListItem shoppingListItem) {
        ...
        String str = null;
        String str2 = (promotionStart == null || (localDateTimeAtStartOfDay2 = promotionStart.atStartOfDay()) == null) ? null : localDateTimeAtStartOfDay2.format(C17898a.ISO_LOCAL_DATE_TIME);
        ...
        if (promotionEnd != null && (localDateTimeAtStartOfDay = promotionEnd.atStartOfDay()) != null) {
            str = localDateTimeAtStartOfDay.format(C17898a.ISO_LOCAL_DATE_TIME);
        }
