...
public class l0 {
    ...
    private final List<g0> f8750a;

    public static String d(l0 l0Var) {
        ArrayList arrayList = new ArrayList();
        Iterator<g0> it = l0Var.f8750a.iterator();
        while (it.hasNext()) {
    ...
    public boolean a(Class<? extends g0> cls) {
        Iterator<g0> it = this.f8750a.iterator();
        while (it.hasNext()) {
    ...
    public l0(List<g0> list) {
        this.f8750a = new ArrayList(list);
    }
}
