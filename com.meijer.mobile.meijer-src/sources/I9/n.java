...
public final class n {
    ...
    private static final Regex f14393a = new Regex("(?<=[a-zA-Z])[A-Z]");

    /* renamed from: b, reason: collision with root package name */
    private static final Regex f14394b = new Regex("_[a-zA-Z]");

    public static final String b(String str) {
        Intrinsics.j(str, "<this>");
        String strL = f14393a.l(str, new Function1() { // from class: I9.m
