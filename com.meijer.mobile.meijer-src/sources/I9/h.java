...
public final class h {
    ...
    public static final JSONObject c(JSONObject... jsonObjects) throws JSONException {
        ...
        f14391a.i((JSONObject[]) Arrays.copyOf(jsonObjects, jsonObjects.length));
        JSONObject jSONObject = new JSONObject();
