...
final class f {
    ...
    static String a(CharSequence charSequence, int i10) {
        ...
        for (int i11 = 0; i11 < length; i11++) {
            ...
            while (i12 >= 1) {
                cArr[i12] = (char) ((cArr[i12 - 1] + (929 - ((f43824a[i10][i12] * iCharAt) % 929))) % 929);
                i12--;
            }
            cArr[0] = (char) ((929 - ((iCharAt * f43824a[i10][0]) % 929)) % 929);
        }
