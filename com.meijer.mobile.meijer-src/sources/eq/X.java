...
@Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0003\u001a+\u0010\u0006\u001a\u00020\u0005*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u00012\u0006\u0010\u0003\u001a\u00020\u00012\u0006\u0010\u0004\u001a\u00020\u0001H\u0001¢\u0006\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"LKi/M;", "", "isWarning", "isError", "isItemSyncing", "", "b", "(LKi/M;ZZZLandroidx/compose/runtime/Composer;I)V", "shopandscan_playstoreRelease"}, k = 2, mv = {2, 1, 0}, xi = 48)
    ...
    public static final void b(final LocalThemeScope localThemeScope, final boolean z10, final boolean z11, final boolean z12, Composer composer, final int i10) {
        ...
        if ((i11 & 1171) == 1170 && composerStartRestartGroup.j()) {
            ...
            if (z12) {
                ...
                composer2 = composerStartRestartGroup;
                C17972T0.f(androidx.compose.foundation.layout.J.i(androidx.compose.foundation.layout.J.h(Modifier.INSTANCE, 0.0f, 1, null), H1.h.p(1)), localThemeScope.getAdsColors().getAdsColorSupportInformationalBg().getColor(), 0L, 0, composer2, 6, 12);
                composer2.P();
            } else {
                composerStartRestartGroup.startReplaceGroup(-57297797);
                C17983Z.a(null, z10 ? localThemeScope.getAdsColors().getAdsColorSupportWarning().getColor() : z11 ? localThemeScope.getAdsColors().getAdsColorSupportError().getColor() : localThemeScope.getAdsColors().getAdsColorUIBorder02().getColor(), 0.0f, 0.0f, composerStartRestartGroup, 0, 13);
                composer2 = composerStartRestartGroup;
                composer2.P();
            }
            if (ComposerKt.M()) {
