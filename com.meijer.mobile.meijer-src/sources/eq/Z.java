...
@Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a#\u0010\u0006\u001a\u00020\u0005*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u00012\u0006\u0010\u0004\u001a\u00020\u0003H\u0001¢\u0006\u0004\b\u0006\u0010\u0007\u001a\u0019\u0010\t\u001a\u0004\u0018\u00010\b2\u0006\u0010\u0004\u001a\u00020\u0003H\u0002¢\u0006\u0004\b\t\u0010\n¨\u0006\u000b"}, d2 = {"LKi/M;", "Landroidx/compose/ui/Modifier;", "modifier", "", "data", "", "b", "(LKi/M;Landroidx/compose/ui/Modifier;Ljava/lang/String;Landroidx/compose/runtime/Composer;I)V", "LIg/b;", "d", "(Ljava/lang/String;)LIg/b;", "shopandscan_playstoreRelease"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class Z {
    public static final void b(final LocalThemeScope localThemeScope, final Modifier modifier, final String data, Composer composer, final int i10) {
        ...
        if ((i11 & 131) == 130 && composerStartRestartGroup.j()) {
            ...
            if (bVarD == null) {
                ...
                Bitmap bitmapA = new C14366b().a(bVarD);
                Intrinsics.i(bitmapA, "createBitmap(...)");
                C13590y.b(V0.M.c(bitmapA), null, androidx.compose.foundation.layout.J.i(androidx.compose.foundation.layout.J.z(Modifier.INSTANCE, H1.h.p(272)), H1.h.p(72)), null, InterfaceC5926k.INSTANCE.e(), 0.0f, null, 0, composerStartRestartGroup, 25008, 232);
                unit = Unit.f143329a;
            }
            composerStartRestartGroup.P();
            if (unit == null) {
                si.j.h(localThemeScope, new q1.Label(null, localThemeScope.getAdsColors().getAdsColorBrandPrimary(), null, null, 0, false, 0, localThemeScope.getAdsTypography().getHeadings().getSeven(), null, 381, null), C16338g.c(com.meijer.mobile.shopandscan.e.f117867K, composerStartRestartGroup, 0), null, composerStartRestartGroup, (q1.Label.f142335j << 3) | (i11 & 14) | LocalThemeScope.f17314g, 4);
            }
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
    ...
    private static final Ig.b d(String str) {
        try {
            return new C14366b().b(str, com.google.zxing.a.PDF_417, 100, 100, MapsKt.r(TuplesKt.a(com.google.zxing.f.MARGIN, 0)));
