...
@Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0004\u001a/\u0010\u0007\u001a\u00020\u0005*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u00012\u0012\u0010\u0006\u001a\u000e\u0012\u0004\u0012\u00020\u0004\u0012\u0004\u0012\u00020\u00050\u0003H\u0007¢\u0006\u0004\b\u0007\u0010\b¨\u0006\u000f²\u0006\u0010\u0010\n\u001a\u0004\u0018\u00010\t8\n@\nX\u008a\u008e\u0002²\u0006\u000e\u0010\f\u001a\u00020\u000b8\n@\nX\u008a\u008e\u0002²\u0006\u000e\u0010\r\u001a\u00020\u000b8\n@\nX\u008a\u008e\u0002²\u0006\u000e\u0010\u000e\u001a\u00020\u000b8\n@\nX\u008a\u008e\u0002"}, d2 = {"LKi/M;", "LIh/o$a;", "viewState", "Lkotlin/Function1;", "LGh/a;", "", "onNavigationRequest", "b", "(LKi/M;LIh/o$a;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;I)V", "", "lastAction", "", "isLoading", "showEmptyState", "showPrimaryCard", "ux_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* renamed from: Lh.r0, reason: case insensitive filesystem */
/* loaded from: classes8.dex */
public final class C4084r0 {
    public static final void b(LocalThemeScope localThemeScope, o.PaymentsCardViewState viewState, Function1<? super Gh.a, Unit> onNavigationRequest, Composer composer, final int i10) {
        int i11;
        final LocalThemeScope localThemeScope2;
        final Function1<? super Gh.a, Unit> function1;
        ...
        if ((i11 & 147) == 146 && composerStartRestartGroup.j()) {
            ...
            if (viewState.getEmptyOrErrorCardMessage() != null) {
                ...
                localThemeScope2 = localThemeScope;
                function1 = onNavigationRequest;
                Oh.e0.i(localThemeScope2, viewState.getEmptyOrErrorCardMessage(), null, function1, composerStartRestartGroup, LocalThemeScope.f17314g | (i11 & 14) | (AbstractC6392a.f60445b << 3) | ((i11 << 3) & 7168), 2);
                ...
                paymentsCardViewState = viewState;
                Oh.j0.i(localThemeScope2, paymentsCardViewState, null, function1, composerStartRestartGroup, LocalThemeScope.f17314g | (i11 & 14) | (AbstractC6392a.f60445b << 3) | (i11 & 112) | ((i11 << 3) & 7168), 2);
                composerStartRestartGroup.P();
            }
            if (ComposerKt.M()) {
                ComposerKt.T();
        ...
        if (t0L != null) {
            t0L.a(new Function2() { // from class: Lh.q0
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return C4084r0.c(localThemeScope2, paymentsCardViewState, function1, i10, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
