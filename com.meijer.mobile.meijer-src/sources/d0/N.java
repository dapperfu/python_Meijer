...
public interface N {
    ...
    public static final Companion INSTANCE = Companion.f127682a;
    ...
    public static final class Companion {
        ...
        static final /* synthetic */ Companion f127682a = new Companion();

        public final N a() {
            if (C13563D.d(0, 1, null)) {
                return Build.VERSION.SDK_INT == 28 ? O.f127683b : P.f127686b;
            }
