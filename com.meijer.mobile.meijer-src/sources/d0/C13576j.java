...
public final class C13576j {
    ...
    static final class a extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ Modifier f127783f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function1<X0.f, Unit> f127784g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f127785h;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        a(Modifier modifier, Function1<? super X0.f, Unit> function1, int i10) {
            super(2);
            this.f127783f = modifier;
            this.f127784g = function1;
            this.f127785h = i10;
        }

        public final void a(Composer composer, int i10) {
            C13576j.a(this.f127783f, this.f127784g, composer, J0.a(this.f127785h | 1));
        }
    ...
    public static final void a(Modifier modifier, Function1<? super X0.f, Unit> function1, Composer composer, int i10) {
        ...
        if (composerStartRestartGroup.p(z10, i11 & 1)) {
            ...
            C14890K.a(androidx.compose.ui.draw.b.b(modifier, function1), composerStartRestartGroup, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        } else {
