...
public final class C13585t extends AbstractC5959m implements u0, InterfaceC5967v, InterfaceC5954h, i0, B0 {

    /* renamed from: y, reason: collision with root package name */
    private static final a f127808y = new a(null);

    /* renamed from: z, reason: collision with root package name */
    public static final int f127809z = 8;
    ...
    static final class b extends Lambda implements Function0<Boolean> {
        ...
        public final Boolean invoke() {
            return Boolean.valueOf(androidx.compose.ui.focus.G.u0(C13585t.this.focusTargetNode, 0, 1, null));
        }
    }
    ...
    static final class c extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        ...
        final /* synthetic */ h0.l f127820b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ h0.i f127821c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ InterfaceC15804h0 f127822d;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        c(h0.l lVar, h0.i iVar, InterfaceC15804h0 interfaceC15804h0, Continuation<? super c> continuation) {
            super(2, continuation);
            this.f127820b = lVar;
            this.f127821c = iVar;
            this.f127822d = interfaceC15804h0;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new c(this.f127820b, this.f127821c, this.f127822d, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                ResultKt.b(obj);
                h0.l lVar = this.f127820b;
                h0.i iVar = this.f127821c;
                this.f127819a = 1;
                if (lVar.c(iVar, this) == objF) {
                    return objF;
                }
            }
            InterfaceC15804h0 interfaceC15804h0 = this.f127822d;
    ...
    static final class d extends Lambda implements Function1<Throwable, Unit> {
        ...
        final /* synthetic */ h0.l f127823f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ h0.i f127824g;
    ...
    /* synthetic */ class e extends FunctionReferenceImpl implements Function2<androidx.compose.ui.focus.E, androidx.compose.ui.focus.E, Unit> {
        e(Object obj) {
            super(2, obj, C13585t.class, "onFocusStateChange", "onFocusStateChange(Landroidx/compose/ui/focus/FocusState;Landroidx/compose/ui/focus/FocusState;)V", 0);
        }

        public final void a(androidx.compose.ui.focus.E e10, androidx.compose.ui.focus.E e11) {
            ((C13585t) this.receiver).X2(e10, e11);
        }
    ...
    static final class f extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return C13585t.this.new f(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                ResultKt.b(obj);
                C13585t c13585t = C13585t.this;
                this.f127825a = 1;
                if (C16067b.b(c13585t, null, this, 1, null) == objF) {
                    return objF;
                }
            }
            return Unit.f143329a;
    ...
    static final class g extends Lambda implements Function0<Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Ref.ObjectRef<d0> f127827f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ C13585t f127828g;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        g(Ref.ObjectRef<d0> objectRef, C13585t c13585t) {
            super(0);
            this.f127827f = objectRef;
            this.f127828g = c13585t;
        }

        /* JADX WARN: Type inference failed for: r1v1, types: [T, java.lang.Object] */
        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final void invoke2() {
            this.f127827f.f143742a = C5955i.a(this.f127828g, e0.a());
        }
    }

    public /* synthetic */ C13585t(h0.l lVar, int i10, Function1 function1, DefaultConstructorMarker defaultConstructorMarker) {
        this(lVar, i10, function1);
    }

    public /* synthetic */ C13585t(h0.l lVar, int i10, Function1 function1, int i11, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    private final void W2() {
        ...
        if (layoutCoordinates != null) {
            ...
            if (!layoutCoordinates.isAttached() || (c13586uV2 = V2()) == null) {
                return;
            }
            c13586uV2.K2(this.globalLayoutCoordinates);
        }
    }
    ...
    private final void U2(h0.l lVar, h0.i iVar) {
        InterfaceC15804h0 interfaceC15804h0R;
        if (getIsAttached()) {
            C0 c02 = (C0) j2().getCoroutineContext().g(C0.INSTANCE);
            if (c02 != null) {
                interfaceC15804h0R = c02.R(new d(lVar, iVar));
            } else {
                interfaceC15804h0R = null;
            }
            C15809k.d(j2(), null, null, new c(lVar, iVar, interfaceC15804h0R, null), 3, null);
            return;
        }
        lVar.a(iVar);
    }

    private final C13586u V2() {
        if (getIsAttached()) {
            B0 b0A = androidx.compose.ui.node.C0.a(this, C13586u.INSTANCE);
            if (b0A instanceof C13586u) {
                return (C13586u) b0A;
            }
        }
        return null;
    ...
    private C13585t(h0.l lVar, int i10, Function1<? super Boolean, Unit> function1) {
