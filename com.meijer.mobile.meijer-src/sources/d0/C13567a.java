...
public final class C13567a implements J {
    ...
    private final InterfaceC5872l0<Unit> redrawSignal;
    ...
    static final class C1999a extends ContinuationImpl {
        ...
        /* synthetic */ Object f127732c;

        /* renamed from: e, reason: collision with root package name */
        int f127734e;

        C1999a(Continuation<? super C1999a> continuation) {
            super(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            this.f127732c = obj;
            this.f127734e |= Integer.MIN_VALUE;
            return C13567a.this.c(0L, null, this);
        }
    }
    ...
    static final class b implements PointerInputEventHandler {
        ...
        static final class C2000a extends RestrictedSuspendLambda implements Function2<InterfaceC14300c, Continuation<? super Unit>, Object> {

            /* renamed from: b, reason: collision with root package name */
            int f127736b;

            /* renamed from: c, reason: collision with root package name */
            private /* synthetic */ Object f127737c;

            /* renamed from: d, reason: collision with root package name */
            final /* synthetic */ C13567a f127738d;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C2000a(C13567a c13567a, Continuation<? super C2000a> continuation) {
                super(2, continuation);
                this.f127738d = c13567a;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C2000a c2000a = new C2000a(this.f127738d, continuation);
                c2000a.f127737c = obj;
                return c2000a;
            }
            ...
            public final Object invoke(InterfaceC14300c interfaceC14300c, Continuation<? super Unit> continuation) {
                return ((C2000a) create(interfaceC14300c, continuation)).invokeSuspend(Unit.f143329a);
            }
            ...
            */
            public final java.lang.Object invokeSuspend(java.lang.Object r15) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: d0.C13567a.b.C2000a.invokeSuspend(java.lang.Object):java.lang.Object");
            }
        }
        ...
        public final Object invoke(g1.J j10, Continuation<? super Unit> continuation) {
            Object objD = C13931t.d(j10, new C2000a(C13567a.this, null), continuation);
            return objD == IntrinsicsKt.f() ? objD : Unit.f143329a;
        }
    }

    public /* synthetic */ C13567a(Context context, H1.d dVar, long j10, InterfaceC14882C interfaceC14882C, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, dVar, j10, interfaceC14882C);
    }

    private C13567a(Context context, H1.d dVar, long j10, InterfaceC14882C interfaceC14882C) {
        this.density = dVar;
        this.pointerPosition = U0.f.INSTANCE.b();
        C13584s c13584s = new C13584s(context, C5492s0.j(j10));
        this.edgeEffectWrapper = c13584s;
        this.redrawSignal = o1.i(Unit.f143329a, o1.k());
        this.invalidationEnabled = true;
        this.containerSize = U0.k.INSTANCE.b();
        this.pointerId = C14296A.a(-1L);
        g1.W wA = g1.U.a(new b());
        this.pointerInputNode = wA;
        this.node = Build.VERSION.SDK_INT >= 31 ? new b0(wA, this, c13584s) : new C13588w(wA, this, c13584s, interfaceC14882C);
    }

    private final void g() {
        boolean z10;
        C13584s c13584s = this.edgeEffectWrapper;
        EdgeEffect edgeEffect = c13584s.topEffect;
        boolean z11 = true;
        if (edgeEffect != null) {
        ...
        EdgeEffect edgeEffect2 = c13584s.bottomEffect;
        if (edgeEffect2 != null) {
            edgeEffect2.onRelease();
            z10 = !edgeEffect2.isFinished() || z10;
        }
        EdgeEffect edgeEffect3 = c13584s.leftEffect;
        if (edgeEffect3 != null) {
            edgeEffect3.onRelease();
            z10 = !edgeEffect3.isFinished() || z10;
        }
        EdgeEffect edgeEffect4 = c13584s.rightEffect;
        if (edgeEffect4 != null) {
    ...
    */
    private final boolean o(long r11) {
        ...
        Lc2:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: d0.C13567a.o(long):boolean");
    }

    @Override // d0.J
    /* renamed from: A, reason: from getter */
    public InterfaceC5956j getNode() {
        return this.node;
    }
    ...
    public boolean a() {
        C13584s c13584s = this.edgeEffectWrapper;
        EdgeEffect edgeEffect = c13584s.topEffect;
        if (edgeEffect != null && C13583q.f127793a.c(edgeEffect) != 0.0f) {
            return true;
        }
        EdgeEffect edgeEffect2 = c13584s.bottomEffect;
        if (edgeEffect2 != null && C13583q.f127793a.c(edgeEffect2) != 0.0f) {
            return true;
        }
        EdgeEffect edgeEffect3 = c13584s.leftEffect;
        if (edgeEffect3 != null && C13583q.f127793a.c(edgeEffect3) != 0.0f) {
            return true;
        }
        EdgeEffect edgeEffect4 = c13584s.rightEffect;
        return (edgeEffect4 == null || C13583q.f127793a.c(edgeEffect4) == 0.0f) ? false : true;
    }
    ...
    */
    public long b(long r20, int r22, kotlin.jvm.functions.Function1<? super U0.f, U0.f> r23) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: d0.C13567a.b(long, int, kotlin.jvm.functions.Function1):long");
    }
    ...
    */
    public java.lang.Object c(long r12, kotlin.jvm.functions.Function2<? super H1.y, ? super kotlin.coroutines.Continuation<? super H1.y>, ? extends java.lang.Object> r14, kotlin.coroutines.Continuation<? super kotlin.Unit> r15) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: d0.C13567a.c(long, kotlin.jvm.functions.Function2, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public final InterfaceC5872l0<Unit> i() {
        return this.redrawSignal;
    }

    public final void j() {
        if (this.invalidationEnabled) {
            this.redrawSignal.setValue(Unit.f143329a);
        }
    }
    ...
    private final float k(long scroll) {
        ...
        float fIntBitsToFloat3 = (-c13583q.e(edgeEffectG, -fIntBitsToFloat2, 1 - fIntBitsToFloat)) * Float.intBitsToFloat((int) (this.containerSize & 4294967295L));
        if (c13583q.c(edgeEffectG) == 0.0f) {
    ...
    private final float l(long scroll) {
        ...
        C13583q c13583q = C13583q.f127793a;
        float fE = c13583q.e(edgeEffectI, fIntBitsToFloat2, 1 - fIntBitsToFloat) * Float.intBitsToFloat((int) (this.containerSize >> 32));
        if (c13583q.c(edgeEffectI) == 0.0f) {
            return fE;
        }
        return Float.intBitsToFloat(i10);
    }
    ...
    private final float m(long scroll) {
        ...
        C13583q c13583q = C13583q.f127793a;
        float fIntBitsToFloat3 = (-c13583q.e(edgeEffectK, -fIntBitsToFloat2, fIntBitsToFloat)) * Float.intBitsToFloat((int) (this.containerSize >> 32));
        if (c13583q.c(edgeEffectK) == 0.0f) {
            return fIntBitsToFloat3;
        }
        return Float.intBitsToFloat(i10);
    }
    ...
    private final float n(long scroll) {
        ...
        C13583q c13583q = C13583q.f127793a;
        float fE = c13583q.e(edgeEffectM, fIntBitsToFloat2, fIntBitsToFloat) * Float.intBitsToFloat((int) (this.containerSize & 4294967295L));
        if (c13583q.c(edgeEffectM) == 0.0f) {
            return fE;
        }
        return Float.intBitsToFloat(i10);
    }
