...
@Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0006\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0001\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u0013\u0010\b\u001a\u00020\u0007*\u00020\u0006H\u0017¢\u0006\u0004\b\b\u0010\tR\u001a\u0010\u0003\u001a\u00020\u00028\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\n\u0010\u000b\u001a\u0004\b\f\u0010\rR\u0014\u0010\u0011\u001a\u00020\u000e8VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\u000f\u0010\u0010¨\u0006\u0012"}, d2 = {"LQi/C2;", "LOi/c;", "LOi/l$h;", "state", "<init>", "(LOi/l$h;)V", "LKi/M;", "", "f", "(LKi/M;Landroidx/compose/runtime/Composer;I)V", "a", "LOi/l$h;", "k", "()LOi/l$h;", "", "getName", "()Ljava/lang/String;", "name", "library_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public final class C2 implements Oi.c {
    ...
    static final class a implements Function3<InterfaceC15433c, Composer, Integer, Unit> {
        ...
        final /* synthetic */ LocalThemeScope f28405a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ C2 f28406b;

        a(LocalThemeScope localThemeScope, C2 c22) {
            this.f28405a = localThemeScope;
            this.f28406b = c22;
        }
        ...
        public final void a(InterfaceC15433c item, Composer composer, int i10) {
            ...
            Si.b.b(this.f28405a, null, this.f28406b.c("Static"), "2.0", null, C5035v5.f30610a.a(), composer, 199680, 9);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class b implements Function3<InterfaceC15433c, Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f28407a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ C2 f28408b;

        b(LocalThemeScope localThemeScope, C2 c22) {
            this.f28407a = localThemeScope;
            this.f28408b = c22;
        }
        ...
        public final void a(InterfaceC15433c item, Composer composer, int i10) {
            ...
            Si.b.b(this.f28407a, null, this.f28408b.c("Multiline Support"), "2.0", null, C5035v5.f30610a.b(), composer, 199680, 9);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final Unit j(C2 c22, LocalThemeScope localThemeScope, int i10, Composer composer, int i11) {
        c22.f(localThemeScope, composer, androidx.compose.runtime.J0.a(i10 | 1));
        return Unit.f143329a;
    }
    ...
    public void f(final LocalThemeScope localThemeScope, Composer composer, final int i10) {
        ...
        if ((i11 & 19) == 18 && composerStartRestartGroup.j()) {
            ...
            if (z10 || objB == Composer.INSTANCE.a()) {
                objB = new Function1() { // from class: Qi.A2
        ...
        if (t0L != null) {
            t0L.a(new Function2() { // from class: Qi.B2
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return C2.j(this.f28380a, localThemeScope, i10, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
