...
public class h {
    ...
    static final String[] f11089c = {"", "BYTE", "STRING", "USHORT", "ULONG", "URATIONAL", "SBYTE", "UNDEFINED", "SSHORT", "SLONG", "SRATIONAL", "SINGLE", "DOUBLE", "IFD"};

    /* renamed from: d, reason: collision with root package name */
    private static final j[] f11090d;

    /* renamed from: e, reason: collision with root package name */
    private static final j[] f11091e;

    /* renamed from: f, reason: collision with root package name */
    private static final j[] f11092f;

    /* renamed from: g, reason: collision with root package name */
    static final j[] f11093g;

    /* renamed from: h, reason: collision with root package name */
    private static final j[] f11094h;

    /* renamed from: i, reason: collision with root package name */
    static final j[][] f11095i;

    /* renamed from: j, reason: collision with root package name */
    static final HashSet<String> f11096j;

    /* renamed from: a, reason: collision with root package name */
    private final List<Map<String, g>> f11097a;

    /* renamed from: b, reason: collision with root package name */
    private final ByteOrder f11098b;

    public static final class b {

        /* renamed from: c, reason: collision with root package name */
        private static final Pattern f11100c = Pattern.compile("^(\\d{2}):(\\d{2}):(\\d{2})$");

        /* renamed from: d, reason: collision with root package name */
        private static final Pattern f11101d = Pattern.compile("^(\\d{4}):(\\d{2}):(\\d{2})\\s(\\d{2}):(\\d{2}):(\\d{2})$");

        /* renamed from: e, reason: collision with root package name */
        private static final Pattern f11102e = Pattern.compile("^(\\d{4})-(\\d{2})-(\\d{2})\\s(\\d{2}):(\\d{2}):(\\d{2})$");

        /* renamed from: f, reason: collision with root package name */
        static final List<HashMap<String, j>> f11103f = Collections.list(new a());

        /* renamed from: a, reason: collision with root package name */
        final List<Map<String, g>> f11104a = Collections.list(new C0183b());
        ...
        class a implements Enumeration<HashMap<String, j>> {
            ...
            public HashMap<String, j> nextElement() {
                ...
                for (j jVar : h.f11095i[this.f11106a]) {
                    map.put(jVar.f11122b, jVar);
                }
                this.f11106a++;
                return map;
            }
            ...
            public boolean hasMoreElements() {
                return this.f11106a < h.f11095i.length;
            }
        ...
        class C0183b implements Enumeration<Map<String, g>> {
            ...
            @Override // java.util.Enumeration
            public boolean hasMoreElements() {
                return this.f11107a < h.f11095i.length;
            }
        }
        ...
        class c implements Enumeration<Map<String, g>> {
            ...
            /* renamed from: a, reason: collision with root package name */
            final Enumeration<Map<String, g>> f11109a;

            c() {
                this.f11109a = Collections.enumeration(b.this.f11104a);
            }

            @Override // java.util.Enumeration
            /* renamed from: a, reason: merged with bridge method [inline-methods] */
            public Map<String, g> nextElement() {
                return new HashMap(this.f11109a.nextElement());
            }

            @Override // java.util.Enumeration
            public boolean hasMoreElements() {
                return this.f11109a.hasMoreElements();
            }
        }
        ...
        public h a() throws NumberFormatException {
            ...
            return new h(this.f11105b, list);
        }

        public b c(String str, String str2) throws NumberFormatException {
            e(str, str2, this.f11104a);
            return this;
        }

        public b g(EnumC3282q enumC3282q) {
            int i10;
            if (enumC3282q == EnumC3282q.UNKNOWN) {
                return this;
            }
            int i11 = a.f11099a[enumC3282q.ordinal()];
            if (i11 == 1) {
                i10 = 0;
            } else if (i11 == 2) {
                i10 = 32;
                ...
                if (i11 != 3) {
                    P.l("ExifData", "Unknown flash state: " + enumC3282q);
                    return this;
                }
                i10 = 1;
            }
    ...
    static /* synthetic */ class a {
        ...
        static {
            int[] iArr = new int[EnumC3282q.values().length];
            f11099a = iArr;
            try {
                iArr[EnumC3282q.READY.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f11099a[EnumC3282q.NONE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f11099a[EnumC3282q.FIRED.ordinal()] = 3;
    ...
    static {
        ...
        f11092f = jVarArr3;
        f11093g = new j[]{new j("SubIFDPointer", 330, 4), new j("ExifIFDPointer", 34665, 4), new j("GPSInfoIFDPointer", 34853, 4), new j("InteroperabilityIFDPointer", 40965, 4)};
        j[] jVarArr4 = {new j("InteroperabilityIndex", 1, 2)};
        f11094h = jVarArr4;
        f11095i = new j[][]{jVarArr, jVarArr2, jVarArr3, jVarArr4};
        f11096j = new HashSet<>(Arrays.asList("FNumber", "ExposureTime", "GPSTimeStamp"));
    }
    ...
    Map<String, g> c(int i10) {
        o2.i.c(i10, 0, f11095i.length, "Invalid IFD index: " + i10 + ". Index should be between [0, EXIF_TAGS.length] ");
        return this.f11097a.get(i10);
    }
