...
public final class C14339c {
    ...
    public static final C14339c f134109a = new C14339c();

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private static final String LOG_TAG = x.f137411a + "RootDetector";
    ...
    public final boolean d() {
        String strA = C18128a.f170624a.a();
        boolean zD0 = strA != null ? StringsKt.d0(strA, "test-keys", false, 2, null) : false;
        if (zD0 && x.f137412b) {
    ...
    public final List<String> e() {
        ...
        for (String str2 : arrayList) {
            if (!StringsKt.G(str2, q2.f93563c, false, 2, null)) {
                str2 = str2 + '/';
            }
