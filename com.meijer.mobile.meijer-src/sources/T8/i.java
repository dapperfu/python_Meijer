...
public class i implements Application.ActivityLifecycleCallbacks {
    ...
    static final class a extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                if (i10 == 1) {
                    interfaceC15783O = (InterfaceC15783O) this.f35961b;
                    ResultKt.b(obj);
                } else {
                ...
                ResultKt.b(obj);
                InterfaceC15783O interfaceC15783O2 = (InterfaceC15783O) this.f35961b;
                this.f35961b = interfaceC15783O2;
                this.f35960a = 1;
                Object objA = N8.f.a(this);
                if (objA == objF) {
                    return objF;
                }
            ...
            if (activity == null) {
                K9.e.INSTANCE.c(new k(interfaceC15783O.getClass(), "TransitionSafeCurrentActivityWatchdog#register", MapsKt.g(TuplesKt.a("currentActivity", BuildConfig.TRAVIS)), null, 8, null));
            } else {
                i.this.currentActivityProvider.set(activity);
                this.f35963d.invoke(activity);
            }
            return Unit.f143329a;
        }
    }

    public i(n9.c handler, InterfaceC16614a<Activity> currentActivityProvider) {
        Intrinsics.j(handler, "handler");
        Intrinsics.j(currentActivityProvider, "currentActivityProvider");
        this.handler = handler;
        this.currentActivityProvider = currentActivityProvider;
        this.activityCallbacks = new ArrayList();
        this.callback = new Runnable() { // from class: T8.h
    ...
    public Activity d() throws InterruptedException {
        ...
        Function1<? super Activity, Unit> function1 = new Function1() { // from class: T8.g
    ...
    public void h(Function1<? super Activity, Unit> callback) {
        ...
        C15809k.d(C15784P.a(C15800f0.a()), null, null, new a(callback, null), 3, null);
    }
