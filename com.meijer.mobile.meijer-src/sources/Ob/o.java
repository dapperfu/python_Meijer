...
public class o {
    ...
    private static final C13784a f23291g = C13785b.a(o.class.getName());
    ...
    Db.m<String, h> f23294c;

    /* renamed from: d, reason: collision with root package name */
    d f23295d;

    /* renamed from: e, reason: collision with root package name */
    private Map<String, j> f23296e = new HashMap();
    ...
    public static final class c {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ int[] f23300b = {1, 2};
    }
    ...
    private synchronized void l() throws IOException {
        ...
        Db.m<String, h>.a aVarE = this.f23294c.e();
        try {
            ArrayList<h> arrayList = new ArrayList();
            Iterator<h> itB = this.f23294c.b();
            while (itB.hasNext()) {
                h next = itB.next();
    ...
    private boolean i() throws IOException {
        Ob.b bVarE = this.f23292a.e();
        if (bVarE == null || bVarE.k() < 2) {
            return false;
        }
        List<h> listF = f(this.f23294c.b(), bVarE);
        if (listF.size() == 0) {
            h hVar = new h();
            hVar.k(bVarE);
            this.f23294c.j(hVar);
            ...
            while (it.hasNext()) {
                this.f23294c.k(it.next().e());
            }
            this.f23294c.j(hVarC);
        }
        return true;
    }

    private void j() throws IOException {
        if (this.f23292a.a() != null && this.f23292a.a().l() >= 2) {
            Ob.a aVarA = this.f23292a.a();
            ArrayList arrayList = new ArrayList();
            for (j jVar : this.f23296e.values()) {
            ...
            if (arrayList.size() == 0) {
                j jVar2 = new j();
                this.f23296e.put(jVar2.e(), jVar2);
                jVar2.k(this.f23292a.a());
            } else if (arrayList.size() == 1) {
                ((j) arrayList.get(0)).k(this.f23292a.a());
            }
        }
        this.f23292a.b(null);
    }
    ...
    private boolean m(f fVar) throws IOException {
        Ob.b bVarE = this.f23292a.e();
        if (bVarE == null || this.f23292a.e().j().e(fVar) >= 120.0d) {
            return false;
        }
        bVarE.a(fVar);
        this.f23292a.c(bVarE);
        this.f23292a.e().f();
        return true;
    }
    ...
    */
    public final synchronized void g(Ob.f r20) throws java.io.IOException {
        /*
            Method dump skipped, instructions count: 558
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: Ob.o.g(Ob.f):void");
    }

    public o(Db.j jVar, Db.m<String, h> mVar, d dVar) {
        this.f23294c = mVar;
        this.f23292a = new n(jVar);
        this.f23295d = dVar;
    }
