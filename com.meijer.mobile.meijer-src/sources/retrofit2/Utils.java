...
final class Utils {
    ...
    static RuntimeException parameterError(Method method, Throwable th2, int i10, String str, Object... objArr) {
    ...
    static ResponseBody buffer(ResponseBody responseBody) throws IOException {
        ...
        responseBody.getF154459c().Q2(c14416e);
        return ResponseBody.create(responseBody.getF154457a(), responseBody.getF154458b(), c14416e);
    }
    ...
    static Type getParameterLowerBound(int i10, ParameterizedType parameterizedType) {
    ...
    static Type getParameterUpperBound(int i10, ParameterizedType parameterizedType) {
        Type[] actualTypeArguments = parameterizedType.getActualTypeArguments();
    ...
    static RuntimeException parameterError(Method method, int i10, String str, Object... objArr) {
