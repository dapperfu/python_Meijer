...
public final class a {
    ...
    public static final void e(Paint paint, AbstractC5467i0 abstractC5467i0, float f10, long j10, Function0<Unit> function0) {
        ...
        if (abstractC5467i0 instanceof SolidColor) {
            ...
            paint.setColor(C5492s0.j(((SolidColor) abstractC5467i0).getValue()));
            function0.invoke();
        ...
        if (abstractC5467i0 instanceof z1) {
            Shader shader = paint.getShader();
            if (!Float.isNaN(f10)) {
                numValueOf = Integer.valueOf(paint.getAlpha());
                paint.setAlpha((int) Math.rint(f10 * 255.0f));
            }
            paint.setShader(((z1) abstractC5467i0).b(j10));
            function0.invoke();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void d(AbstractC5480m1 abstractC5480m1, Canvas canvas, Paint paint, float f10, float f11, int i10) {
        if (abstractC5480m1 instanceof AbstractC5480m1.a) {
            canvas.save();
            Rect rect = abstractC5480m1.getRect();
            canvas.translate(f10, f11 - ((rect.i() - rect.getTop()) / 2.0f));
            q1 path = ((AbstractC5480m1.a) abstractC5480m1).getPath();
    ...
    public static final void f(Paint paint, g gVar) {
        if (Intrinsics.e(gVar, X0.j.f41494a)) {
