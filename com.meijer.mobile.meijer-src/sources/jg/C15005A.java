...
@Metadata(d1 = {"\u0000L\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0002\b\t\n\u0002\u0010\b\n\u0002\b\r\b\u0001\u0018\u00002\u00020\u0001B\u0019\b\u0007\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0006\u0010\u0007J\u0015\u0010\n\u001a\b\u0012\u0004\u0012\u00020\t0\bH\u0002¢\u0006\u0004\b\n\u0010\u000bJ\u001f\u0010\u0010\u001a\u00020\u000f2\u0006\u0010\f\u001a\u00020\t2\u0006\u0010\u000e\u001a\u00020\rH\u0002¢\u0006\u0004\b\u0010\u0010\u0011J#\u0010\u0015\u001a\u00020\u000f2\u0012\u0010\u0014\u001a\u000e\u0012\u0004\u0012\u00020\u0013\u0012\u0004\u0012\u00020\r0\u0012H\u0016¢\u0006\u0004\b\u0015\u0010\u0016J#\u0010\u0017\u001a\u00020\u000f2\u0012\u0010\u0014\u001a\u000e\u0012\u0004\u0012\u00020\u0013\u0012\u0004\u0012\u00020\r0\u0012H\u0016¢\u0006\u0004\b\u0017\u0010\u0016J\u000f\u0010\u0019\u001a\u00020\u0018H\u0016¢\u0006\u0004\b\u0019\u0010\u001aJ1\u0010\u001b\u001a\u000e\u0012\u0004\u0012\u00020\u0013\u0012\u0004\u0012\u00020\r0\u00122\u0014\u0010\u0014\u001a\u0010\u0012\u0004\u0012\u00020\u0013\u0012\u0004\u0012\u00020\r\u0018\u00010\u0012H\u0016¢\u0006\u0004\b\u001b\u0010\u001cR\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001d\u0010\u001eR\u001b\u0010!\u001a\u00020\u00138VX\u0096\u0084\u0002¢\u0006\f\n\u0004\b\u0017\u0010\u001f\u001a\u0004\b\u001d\u0010 R\u001a\u0010&\u001a\u00020\"8\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u001b\u0010#\u001a\u0004\b$\u0010%R\u001b\u0010(\u001a\u00020\u00138VX\u0096\u0084\u0002¢\u0006\f\n\u0004\b\u0019\u0010\u001f\u001a\u0004\b'\u0010 R\u001b\u0010+\u001a\u00020\t8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0015\u0010\u001f\u001a\u0004\b)\u0010*R\u0016\u0010.\u001a\u00020\u000f8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b,\u0010-¨\u0006/"}, d2 = {"Ljg/A;", "Ljg/w;", "Landroid/content/Context;", "appContext", "Ljg/Z;", "uuidGenerator", "<init>", "(Landroid/content/Context;Ljg/Z;)V", "", "Ljg/C;", "j", "()Ljava/util/List;", "processDetails", "Ljg/v;", "processData", "", "n", "(Ljg/C;Ljg/v;)Z", "", "", "processDataMap", "e", "(Ljava/util/Map;)Z", "b", "", "d", "()V", "c", "(Ljava/util/Map;)Ljava/util/Map;", "a", "Landroid/content/Context;", "Lkotlin/Lazy;", "()Ljava/lang/String;", "myProcessName", "", "I", "k", "()I", "myPid", "m", "myUuid", "l", "()Ljg/C;", "myProcessDetails", "f", "Z", "hasGeneratedSession", "com.google.firebase-firebase-sessions"}, k = 1, mv = {2, 0, 0}, xi = 48)
@SourceDebugExtension
/* renamed from: jg.A, reason: case insensitive filesystem */
/* loaded from: classes8.dex */
public final class C15005A implements InterfaceC15028w {
    ...
    @Override // jg.InterfaceC15028w
    public void d() {
        this.hasGeneratedSession = true;
    }

    public C15005A(Context appContext, final Z uuidGenerator) {
        Intrinsics.j(appContext, "appContext");
        Intrinsics.j(uuidGenerator, "uuidGenerator");
        this.appContext = appContext;
        this.myProcessName = LazyKt.b(new Function0() { // from class: jg.x
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return C15005A.p(this.f140640a);
            }
        });
        this.myPid = Process.myPid();
        this.myUuid = LazyKt.b(new Function0() { // from class: jg.y
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return C15005A.q(uuidGenerator);
            }
        });
        this.myProcessDetails = LazyKt.b(new Function0() { // from class: jg.z
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return C15005A.o(this.f140642a);
            }
        });
    }

    private final List<ProcessDetails> j() {
        return D.f140430a.a(this.appContext);
    }
    ...
    public static final ProcessDetails o(C15005A c15005a) {
        return D.f140430a.b(c15005a.appContext);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final String p(C15005A c15005a) {
        return c15005a.l().getProcessName();
    }
    ...
    public Map<String, ProcessData> f() {
        return InterfaceC15028w.a.a(this);
    }
}
