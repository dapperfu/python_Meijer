...
public final class C15623I implements InterfaceC13900H {

    /* renamed from: x, reason: collision with root package name and from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);

    /* renamed from: y, reason: collision with root package name */
    private static final L0.k<C15623I, ?> f150271y = L0.a.a(a.f150295f, b.f150296f);

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC15615A prefetchStrategy;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private boolean hasLookaheadOccurred;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private C15646u approachLayoutInfo;

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    private final C15618D scrollPosition;

    /* renamed from: e, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5872l0<C15646u> layoutInfoState;
    ...
    private final LazyLayoutItemAnimator<C15647v> itemAnimator;
    ...
    private final InterfaceC15651z prefetchScope;
    ...
    /* renamed from: m0.I$b */
    static final class b extends Lambda implements Function1<List<? extends Integer>, C15623I> {

        /* renamed from: f, reason: collision with root package name */
        public static final b f150296f = new b();
        ...
        public final C15623I invoke(List<Integer> list) {
            return new C15623I(list.get(0).intValue(), list.get(1).intValue());
        }
    }
    ...
    public static final class Companion {
        ...
        public final L0.k<C15623I, ?> a() {
            return C15623I.f150271y;
        }
    }
    ...
    @SourceDebugExtension
    /* renamed from: m0.I$d */
    public static final class d implements InterfaceC15651z {
        d() {
        }

        @Override // m0.InterfaceC15651z
        public List<d.b> a(int lineIndex) {
            ArrayList arrayList = new ArrayList();
            g.Companion companion = androidx.compose.runtime.snapshots.g.INSTANCE;
            C15623I c15623i = C15623I.this;
            ...
            try {
                C15646u approachLayoutInfo = c15623i.getHasLookaheadOccurred() ? c15623i.getApproachLayoutInfo() : (C15646u) c15623i.layoutInfoState.getValue();
                if (approachLayoutInfo != null) {
                    ...
                    for (int i10 = 0; i10 < size; i10++) {
                        ...
                        arrayList.add(c15623i.getPrefetchState().e(pair.c().intValue(), pair.d().getValue()));
                    }
    ...
    @SourceDebugExtension
    /* renamed from: m0.I$e */
    static final class e extends Lambda implements Function1<InterfaceC15859S, Unit> {

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f150299g;
        ...
        public final void a(InterfaceC15859S interfaceC15859S) {
            InterfaceC15615A interfaceC15615A = C15623I.this.prefetchStrategy;
            int i10 = this.f150299g;
            g.Companion companion = androidx.compose.runtime.snapshots.g.INSTANCE;
            androidx.compose.runtime.snapshots.g gVarD = companion.d();
            companion.l(gVarD, companion.e(gVarD), gVarD != null ? gVarD.g() : null);
            interfaceC15615A.a(interfaceC15859S, i10);
        }
    ...
    @Metadata(d1 = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0017\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, d2 = {"m0/I$f", "Landroidx/compose/ui/layout/i0;", "Landroidx/compose/ui/layout/h0;", "remeasurement", "", "o", "(Landroidx/compose/ui/layout/h0;)V", "foundation_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    /* renamed from: m0.I$f */
    public static final class f implements i0 {
        ...
        public void o(h0 remeasurement) {
            C15623I.this.remeasurement = remeasurement;
        }
    }
    ...
    static final class g extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f150304d = obj;
            this.f150306f |= Integer.MIN_VALUE;
            return C15623I.this.a(null, null, this);
        }
    }
    ...
    /* renamed from: m0.I$h */
    static final class h extends SuspendLambda implements Function2<InterfaceC13897E, Continuation<? super Unit>, Object> {

        /* renamed from: a, reason: collision with root package name */
        int f150307a;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ int f150309c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ int f150310d;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return C15623I.this.new h(this.f150309c, this.f150310d, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        /* renamed from: d, reason: merged with bridge method [inline-methods] */
        public final Object invoke(InterfaceC13897E interfaceC13897E, Continuation<? super Unit> continuation) {
            return ((h) create(interfaceC13897E, continuation)).invokeSuspend(Unit.f143329a);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f150307a == 0) {
                ResultKt.b(obj);
                C15623I.this.J(this.f150309c, this.f150310d, true);
                return Unit.f143329a;
            }
    ...
    static final class i extends Lambda implements Function1<Float, Float> {
        ...
        public final Float b(float f10) {
            return Float.valueOf(-C15623I.this.E(-f10));
        }
    ...
    public final float E(float distance) {
        ...
        if (Math.abs(f10) > 0.5f) {
            ...
            int iD = MathKt.d(f11);
            C15646u c15646uI = this.layoutInfoState.getValue().i(iD, !this.hasLookaheadOccurred);
            if (c15646uI != null && (c15646u = this.approachLayoutInfo) != null) {
                C15646u c15646uI2 = c15646u != null ? c15646u.i(iD, true) : null;
                if (c15646uI2 != null) {
                    this.approachLayoutInfo = c15646uI2;
                } else {
                    c15646uI = null;
                }
            }
            if (c15646uI != null) {
                k(c15646uI, this.hasLookaheadOccurred, true);
                C15860T.d(this.placementScopeInvalidator);
                D(f11 - this.scrollToBeConsumed, c15646uI);
            } else {
    ...
    /* renamed from: m0.I$a */
    static final class a extends Lambda implements Function2<L0.m, C15623I, List<? extends Integer>> {

        /* renamed from: f, reason: collision with root package name */
        public static final a f150295f = new a();
        ...
        @Override // kotlin.jvm.functions.Function2
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final List<Integer> invoke(L0.m mVar, C15623I c15623i) {
            return CollectionsKt.p(Integer.valueOf(c15623i.p()), Integer.valueOf(c15623i.q()));
        }
    }

    public C15623I(int i10, int i11, InterfaceC15615A interfaceC15615A) {
        this.prefetchStrategy = interfaceC15615A;
        C15618D c15618d = new C15618D(i10, i11);
        this.scrollPosition = c15618d;
        this.layoutInfoState = o1.i(C15624J.f150312a, o1.k());
        this.internalInteractionSource = h0.k.a();
        this.scrollableState = C13901I.a(new i());
        this.prefetchingEnabled = true;
        this.remeasurementModifier = new f();
        this.awaitLayoutModifier = new C15870c();
        this.itemAnimator = new LazyLayoutItemAnimator<>();
        this.beyondBoundsInfo = new C15876i();
        this.prefetchState = new androidx.compose.foundation.lazy.layout.d(interfaceC15615A.b(), new e(i10));
        this.prefetchScope = new d();
        this.pinnedItems = new C15847F();
        c15618d.getNearestRangeState();
    ...
    private final void D(float delta, InterfaceC15643r layoutInfo) {
        if (this.prefetchingEnabled) {
            this.prefetchStrategy.c(this.prefetchScope, delta, layoutInfo);
        }
    }

    public static /* synthetic */ Object G(C15623I c15623i, int i10, int i11, Continuation continuation, int i12, Object obj) {
        if ((i12 & 2) != 0) {
            i11 = 0;
        }
        return c15623i.F(i10, i11, continuation);
    }
    ...
    public static /* synthetic */ void l(C15623I c15623i, C15646u c15646u, boolean z10, boolean z11, int i10, Object obj) {
        if ((i10 & 4) != 0) {
            z11 = false;
        }
        c15623i.k(c15646u, z10, z11);
    }
    ...
    public final Object F(int i10, int i11, Continuation<? super Unit> continuation) {
        Object objC = InterfaceC13900H.c(this, null, new h(i10, i11, null), continuation, 1, null);
    ...
    public final int K(InterfaceC15636k itemProvider, int firstItemIndex) {
    ...
    */
    public java.lang.Object a(d0.EnumC13564E r6, kotlin.jvm.functions.Function2<? super kotlin.InterfaceC13897E, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            r5 = this;
            boolean r0 = r8 instanceof m0.C15623I.g
            if (r0 == 0) goto L13
            r0 = r8
            m0.I$g r0 = (m0.C15623I.g) r0
            int r1 = r0.f150306f
        ...
        L13:
            ...
            r0.<init>(r8)
        L18:
            java.lang.Object r8 = r0.f150304d
        ...
        L2c:
            ...
            throw r6
        L34:
            java.lang.Object r6 = r0.f150303c
            r7 = r6
            kotlin.jvm.functions.Function2 r7 = (kotlin.jvm.functions.Function2) r7
            java.lang.Object r6 = r0.f150302b
            d0.E r6 = (d0.EnumC13564E) r6
            java.lang.Object r2 = r0.f150301a
            m0.I r2 = (m0.C15623I) r2
            kotlin.ResultKt.b(r8)
            goto L5a
        L45:
            kotlin.ResultKt.b(r8)
        ...
        L6c:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: m0.C15623I.a(d0.E, kotlin.jvm.functions.Function2, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public final void k(C15646u result, boolean isLookingAhead, boolean visibleItemsStayedTheSame) {
    ...
    public final C15646u getApproachLayoutInfo() {
    ...
    public final LazyLayoutItemAnimator<C15647v> t() {
        return this.itemAnimator;
    }

    public final InterfaceC15643r u() {
        return this.layoutInfoState.getValue();
    }

    public final InterfaceC5872l0<Unit> v() {
    ...
    public /* synthetic */ C15623I(int i10, int i11, InterfaceC15615A interfaceC15615A, int i12, DefaultConstructorMarker defaultConstructorMarker) {
        this((i12 & 1) != 0 ? 0 : i10, (i12 & 2) != 0 ? 0 : i11, (i12 & 4) != 0 ? C15616B.b(0, 1, null) : interfaceC15615A);
    }

    public C15623I(int i10, int i11) {
        this(i10, i11, C15616B.b(0, 1, null));
    }
}
