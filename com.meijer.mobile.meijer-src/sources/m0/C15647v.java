...
public final class C15647v implements InterfaceC15635j, InterfaceC15892y {
    ...
    private final LazyLayoutItemAnimator<C15647v> animator;
    ...
    public /* synthetic */ C15647v(int i10, Object obj, boolean z10, int i11, int i12, boolean z11, H1.t tVar, int i13, int i14, List list, long j10, Object obj2, LazyLayoutItemAnimator lazyLayoutItemAnimator, long j11, int i15, int i16, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, obj, z10, i11, i12, z11, tVar, i13, i14, list, j10, obj2, lazyLayoutItemAnimator, j11, i15, i16);
    }

    @Override // kotlin.InterfaceC15892y
    ...
    private C15647v(int i10, Object obj, boolean z10, int i11, int i12, boolean z11, H1.t tVar, int i13, int i14, List<? extends f0> list, long j10, Object obj2, LazyLayoutItemAnimator<C15647v> lazyLayoutItemAnimator, long j11, int i15, int i16) {
        this.index = i10;
        this.key = obj;
        this.isVertical = z10;
    ...
    @Override // m0.InterfaceC15635j, kotlin.InterfaceC15892y
    public int getIndex() {
        return this.index;
    }
    ...
    public final void u(int mainAxisOffset, int crossAxisOffset, int layoutWidth, int layoutHeight, int row, int column) {
        ...
        if (getIsVertical() && this.layoutDirection == H1.t.f13339b) {
