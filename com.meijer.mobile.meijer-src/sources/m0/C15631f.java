...
public final class C15631f implements InterfaceC15878k {
    ...
    public int b() {
        ...
        int iA = C14287e.a(this.state.u());
        int iA2 = C15644s.a(this.state.u());
        if (iA2 == 0) {
            return 1;
        }
    ...
    @Override // kotlin.InterfaceC15878k
    public int e() {
        return ((InterfaceC15635j) CollectionsKt.D0(this.state.u().h())).getIndex();
    }

    public C15631f(C15623I c15623i) {
        this.state = c15623i;
    }
}
