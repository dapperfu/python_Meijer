...
public final class C15622H {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final C15634i gridContent;
    ...
    private List<C15628c> previousDefaultSpans;
    ...
    /* renamed from: m0.H$b */
    private static final class b implements InterfaceC15641p {

        /* renamed from: a, reason: collision with root package name */
        public static final b f150264a = new b();
    ...
    public static final class c {
        ...
        public final List<C15628c> b() {
            return this.spans;
        }

        public c(int i10, List<C15628c> list) {
            this.firstItemIndex = i10;
            this.spans = list;
        }
    }
    ...
    static final class d extends Lambda implements Function1<a, Integer> {
        ...
        public final Integer invoke(a aVar) {
            return Integer.valueOf(aVar.getFirstItemIndex() - this.f150269f);
        }
    }

    private final List<C15628c> b(int currentSlotsPerLine) {
        ...
        for (int i10 = 0; i10 < currentSlotsPerLine; i10++) {
            arrayList.add(C15628c.a(C15621G.a(1)));
        }
    ...
    */
    public final m0.C15622H.c c(int r11) {
        /*
            Method dump skipped, instructions count: 363
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: m0.C15622H.c(int):m0.H$c");
    }
    ...
    public final int i(int itemIndex, int maxSpan) {
        ...
        InterfaceC15872e.a<C15633h> aVar = this.gridContent.k().get(itemIndex);
        return C15628c.d(aVar.c().b().invoke(bVar, Integer.valueOf(itemIndex - aVar.getStartIndex())).getPackedValue());
    }

    public C15622H(C15634i c15634i) {
        this.gridContent = c15634i;
    ...
    public final int d(int itemIndex) {
        ...
        if (!z10) {
            C14592e.a("ItemIndex > total count");
        }
        ...
        if (!z11) {
            C14592e.a("currentItemIndex > itemIndex");
        }
        int i13 = 0;
