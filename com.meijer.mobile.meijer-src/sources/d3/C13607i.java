...
public final class C13607i {

    /* renamed from: a, reason: collision with root package name */
    private static final byte[] f127919a = {0, 0, 0, 1};

    /* renamed from: b, reason: collision with root package name */
    private static final String[] f127920b = {"", "A", "B", "C"};

    /* renamed from: c, reason: collision with root package name */
    private static final Pattern f127921c = Pattern.compile("^\\D?(\\d+)$");
    ...
    private static Pair<Integer, Integer> l(String str, String[] strArr, C5653j c5653j) throws NumberFormatException {
        int i10;
        if (strArr.length < 4) {
        ...
        try {
            ...
            int i14 = i13 != 8 ? (c5653j == null || !(c5653j.f44666d != null || (i10 = c5653j.f44665c) == 7 || i10 == 6)) ? 2 : RecyclerView.m.FLAG_APPEARED_IN_PRE_LAYOUT : 1;
            int iA = a(i12);
            if (iA != -1) {
    ...
    private static Pair<Integer, Integer> o(String str, String[] strArr) {
        ...
        Matcher matcher = f127921c.matcher(strArr[1]);
        if (!matcher.matches()) {
            r.i("CodecSpecificDataUtil", "Ignoring malformed Dolby Vision codec string: " + str);
            return null;
        }
    ...
    public static Pair<Integer, Integer> q(String str, String[] strArr, C5653j c5653j) {
        if (strArr.length < 4) {
        ...
        if (!"1".equals(strGroup)) {
            ...
            if ("2".equals(strGroup)) {
                i10 = (c5653j == null || c5653j.f44665c != 6) ? 2 : RecyclerView.m.FLAG_APPEARED_IN_PRE_LAYOUT;
    ...
    public static String f(int i10, boolean z10, int i11, int i12, int[] iArr, int i13) {
        StringBuilder sb2 = new StringBuilder(P.F("hvc1.%s%d.%X.%c%d", f127920b[i10], Integer.valueOf(i11), Integer.valueOf(i12), Character.valueOf(z10 ? 'H' : 'L'), Integer.valueOf(i13)));
    ...
    public static Ee.L<byte[]> h(byte b10, byte b11, byte b12, byte b13) {
        return Ee.L.y(new byte[]{1, 1, b10, 2, 1, b11, 3, 1, b12, 4, 1, b13});
    }
    ...
    */
    public static android.util.Pair<java.lang.Integer, java.lang.Integer> n(a3.t r6) {
        /*
            java.lang.String r0 = r6.f44763k
            r1 = 0
            if (r0 != 0) goto L6
            return r1
        L6:
            ...
            java.lang.String r3 = r6.f44767o
            boolean r2 = r2.equals(r3)
            if (r2 == 0) goto L1d
            java.lang.String r6 = r6.f44763k
        ...
        L95:
            ...
            return r6
        L9c:
            java.lang.String r1 = r6.f44763k
            a3.j r6 = r6.f44740C
        ...
        Lac:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: d3.C13607i.n(a3.t):android.util.Pair");
    }
