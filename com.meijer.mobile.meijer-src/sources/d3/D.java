...
public final class D {
    ...
    private static final char[] f127864d = {'\r', '\n'};

    /* renamed from: e, reason: collision with root package name */
    private static final char[] f127865e = {'\n'};

    /* renamed from: f, reason: collision with root package name */
    private static final Ee.O<Charset> f127866f = Ee.O.D(StandardCharsets.US_ASCII, StandardCharsets.UTF_8, StandardCharsets.UTF_16, StandardCharsets.UTF_16BE, StandardCharsets.UTF_16LE);

    /* renamed from: a, reason: collision with root package name */
    private byte[] f127867a;

    /* renamed from: b, reason: collision with root package name */
    private int f127868b;

    /* renamed from: c, reason: collision with root package name */
    private int f127869c;

    public D() {
        this.f127867a = P.f127893f;
    }
    ...
    */
    ...
    private int i(Charset charset) {
        ...
        if ((charset.equals(StandardCharsets.UTF_8) || charset.equals(StandardCharsets.US_ASCII)) && a() >= 1) {
            ...
            if ((charset.equals(StandardCharsets.UTF_16) || charset.equals(StandardCharsets.UTF_16BE)) && a() >= 2) {
                ...
                byte[] bArr2 = this.f127867a;
                int i11 = this.f127868b;
                b11 = bArr2[i11 + 1];
                b10 = bArr2[i11];
            }
            b12 = 2;
        }
        return Je.f.g(b11, b10, (byte) 0, b12);
    }
    ...
    public String C(int i10) {
        ...
        int i11 = this.f127868b;
        int i12 = (i11 + i10) - 1;
        String strH = P.H(this.f127867a, i11, (i12 >= this.f127869c || this.f127867a[i12] != 0) ? i10 : i10 - 1);
        this.f127868b += i10;
        return strH;
    }
    ...
    public String F(int i10, Charset charset) {
        String str = new String(this.f127867a, this.f127868b, i10, charset);
        this.f127868b += i10;
        return str;
    }
    ...
    public long N() {
        ...
        for (int i10 = 0; i10 < 9; i10++) {
            if (this.f127868b == this.f127869c) {
    ...
    public long Q() {
        int i10;
        int i11;
        long j10 = this.f127867a[this.f127868b];
        int i12 = 7;
        while (true) {
            if (i12 < 0) {
                break;
        ...
        for (i10 = 1; i10 < i11; i10++) {
            if ((this.f127867a[this.f127868b + i10] & 192) != 128) {
    ...
    public void V(int i10) {
        C13599a.a(i10 >= 0 && i10 <= this.f127867a.length);
        this.f127869c = i10;
    }

    public void W(int i10) {
        C13599a.a(i10 >= 0 && i10 <= this.f127869c);
        this.f127868b = i10;
    }
    ...
    public int a() {
        return this.f127869c - this.f127868b;
    }

    public int b() {
        return this.f127867a.length;
    }
    ...
    public char h(Charset charset) {
        C13599a.b(f127866f.contains(charset), "Unsupported charset: " + charset);
        return (char) (i(charset) >> 16);
    }

    public int j() {
        return this.f127867a[this.f127868b] & 255;
    }

    public void k(C c10, int i10) {
        l(c10.f127860a, 0, i10);
        c10.p(0);
    }

    public void l(byte[] bArr, int i10, int i11) {
        System.arraycopy(this.f127867a, this.f127868b, bArr, i10, i11);
        this.f127868b += i11;
    }
    ...
    public String t(Charset charset) {
        ...
        String strF = F(d(charset) - this.f127868b, charset);
        if (this.f127868b == this.f127869c) {
            return strF;
        }
        Y(charset);
    ...
    public void c(int i10) {
        if (i10 > b()) {
            this.f127867a = Arrays.copyOf(this.f127867a, i10);
        }
    }
    ...
    public String n(char c10) {
        ...
        int i10 = this.f127868b;
        while (i10 < this.f127869c && this.f127867a[i10] != c10) {
            i10++;
        }
        byte[] bArr = this.f127867a;
        int i11 = this.f127868b;
