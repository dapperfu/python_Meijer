...
public final class a {
    public static final AnnotatedString a(AbstractC6392a formattedString, Composer composer, int i10) {
        ...
        if (zD || objB == Composer.INSTANCE.a()) {
            Spanned spannedFromHtml = Html.fromHtml(ck.d.b(resourcesB, formattedString));
    ...
    private static final AnnotatedString c(CharSequence charSequence, d dVar) {
        ...
        for (Object obj : spans) {
            ...
            if (obj instanceof StyleSpan) {
                ...
                if (style == 0) {
                    bVar.a(new SpanStyle(0L, 0L, FontWeight.INSTANCE.e(), C18280w.c(C18280w.INSTANCE.b()), null, null, null, 0L, null, null, null, 0L, null, null, null, null, 65523, null), spanStart, spanEnd);
                } else if (style == 1) {
                    bVar.a(new SpanStyle(0L, 0L, FontWeight.INSTANCE.f(), C18280w.c(C18280w.INSTANCE.b()), null, null, null, 0L, null, null, null, 0L, null, null, null, null, 65523, null), spanStart, spanEnd);
                } else if (style == 2) {
                    bVar.a(new SpanStyle(0L, 0L, FontWeight.INSTANCE.e(), C18280w.c(C18280w.INSTANCE.a()), null, null, null, 0L, null, null, null, 0L, null, null, null, null, 65523, null), spanStart, spanEnd);
                } else if (style == 3) {
                    bVar.a(new SpanStyle(0L, 0L, FontWeight.INSTANCE.f(), C18280w.c(C18280w.INSTANCE.a()), null, null, null, 0L, null, null, null, 0L, null, null, null, null, 65523, null), spanStart, spanEnd);
                }
            } else if (obj instanceof TypefaceSpan) {
                String family = ((TypefaceSpan) obj).getFamily();
                AbstractC18269l.Companion companion = AbstractC18269l.INSTANCE;
                ...
                qw.a.INSTANCE.a("BulletSpan not supported yet", new Object[0]);
                ...
                bVar.a(new SpanStyle(C5492s0.b(((ForegroundColorSpan) obj).getForegroundColor()), 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, null, 65534, null), spanStart, spanEnd);
            } else {
                bVar.a(new SpanStyle(0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, null, 65535, null), spanStart, spanEnd);
            }
        }
