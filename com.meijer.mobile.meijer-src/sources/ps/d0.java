...
public final class d0 implements e0, NavigationView.d {
    ...
    public static final int f157222z = 8;
    ...
    private final Dl.e meijerDeepLinkParser;
    ...
    @Metadata(d1 = {"\u0000P\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\ba\u0018\u00002\u00020\u0001J\u000f\u0010\u0003\u001a\u00020\u0002H&¢\u0006\u0004\b\u0003\u0010\u0004J\u000f\u0010\u0006\u001a\u00020\u0005H&¢\u0006\u0004\b\u0006\u0010\u0007J\u000f\u0010\t\u001a\u00020\bH&¢\u0006\u0004\b\t\u0010\nJ\u000f\u0010\f\u001a\u00020\u000bH&¢\u0006\u0004\b\f\u0010\rJ\u000f\u0010\u000f\u001a\u00020\u000eH&¢\u0006\u0004\b\u000f\u0010\u0010J\u000f\u0010\u0012\u001a\u00020\u0011H&¢\u0006\u0004\b\u0012\u0010\u0013J\u000f\u0010\u0015\u001a\u00020\u0014H&¢\u0006\u0004\b\u0015\u0010\u0016J\u000f\u0010\u0018\u001a\u00020\u0017H&¢\u0006\u0004\b\u0018\u0010\u0019J\u000f\u0010\u001b\u001a\u00020\u001aH&¢\u0006\u0004\b\u001b\u0010\u001cø\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001¨\u0006\u001dÀ\u0006\u0001"}, d2 = {"Lps/d0$b;", "", "Lyo/k;", "c", "()Lyo/k;", "Lzl/k;", "b", "()Lzl/k;", "Lil/m;", "h", "()Lil/m;", "Lyo/f;", "r", "()Lyo/f;", "Lhi/a;", "a", "()Lhi/a;", "LDl/e;", "s", "()LDl/e;", "LDk/b;", "d", "()LDk/b;", "LTq/j;", "f", "()LTq/j;", "LKk/a;", "k", "()LKk/a;", "navigation_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public interface b {
        InterfaceC14523a a();
    ...
    public static final class g extends androidx.appcompat.app.b {
        ...
        final /* synthetic */ DrawerLayout f157247l;

        /* renamed from: m, reason: collision with root package name */
        final /* synthetic */ d0 f157248m;
        ...
        public void a(View drawerView) {
            ...
            super.a(drawerView);
            this.f157248m.v0();
            d0 d0Var = this.f157248m;
            d0Var.t0(d0Var.userManager.b());
            this.f157248m.g0();
            this.f157248m.c0();
            this.f157248m.h0();
            this.f157248m.I();
            d0 d0Var2 = this.f157248m;
            d0Var2.u0(d0Var2.appVersion.getIsDevMode());
            e eVar = this.f157248m.onDrawerOpenListener;
            if (eVar != null) {
                eVar.onNavigationDrawerOpen();
            }
            this.f157248m.onBackPressedCallback.setEnabled(true);
            NavigationView navigationView = this.f157248m.navigationView;
            if (navigationView == null || (menu = navigationView.getMenu()) == null || (menuItemFindItem = menu.findItem(g0.f157284H)) == null) {
                return;
            }
            d0 d0Var3 = this.f157248m;
        ...
        public void b(View drawerView) {
            Intrinsics.j(drawerView, "drawerView");
            super.b(drawerView);
            DrawerLayout drawerLayout = this.f157247l;
            if (drawerLayout != null) {
                drawerLayout.announceForAccessibility(this.f157248m.context.getString(j0.f157329f));
            }
            d0.x(this.f157248m);
            Intent intent = this.f157248m.activityIntentWaitingToStart;
            if (intent != null) {
                d0 d0Var = this.f157248m;
            ...
            this.f157248m.isStartActivityForResult = false;
            this.f157248m.activityIntentWaitingToStart = null;
            this.f157248m.onBackPressedCallback.setEnabled(false);
        }
    ...
    public final d0 i0(int checkedNavigationItem) {
        ...
        if (toolbar != null) {
            toolbar.setNavigationIcon(f0.f157263m);
        }
    ...
    private d0(Context context, NavigationView navigationView, Toolbar toolbar, AppCompatActivity appCompatActivity, DrawerLayout drawerLayout) {
        ...
        b bVar = (b) nu.d.a(context, b.class);
        yo.k kVarC = bVar.c();
    ...
    private final void K(DrawerLayout drawerLayout) {
        g gVar = new g(drawerLayout, this, this.activityContext, this.appBar, j0.f157327d, j0.f157326c);
        if (drawerLayout != null) {
            drawerLayout.c(gVar);
        }
    ...
    private final int N(MenuItem item) {
        return EnumC16503G.INSTANCE.b(item.getItemId()).getIntentCode();
    }
    ...
    private final void Q(int code) {
        ...
        if (code == 800) {
            i10 = code;
            intentE = Bl.k.f3130a.e(this.activityContext, false);
        } else if (code != 5100) {
            ...
            if (str != null) {
                this.analyticsEngine.b(C14756c.a(str), new Function1() { // from class: ps.S
            ...
            if (code == 268436157 && this.featureManager.e(AbstractC18503f.h0.f172881h)) {
                intentE = Bl.u.f3153a.a(this.context);
                i10 = code;
            } else {
                i10 = code;
                intentE = Dl.e.t(this.meijerDeepLinkParser, this.activityContext, i10, null, 4, null);
            }
        } else {
            i10 = code;
            Dl.e eVar = this.meijerDeepLinkParser;
            Context context = this.context;
            String string = context.getString(Bl.n.f3140f);
    ...
    */
    public static final kotlin.Unit a0(ps.d0 r4, android.widget.ImageView r5, android.widget.TextView r6, uk.c r7) {
        /*
        ...
        L48:
            ...
            bk.a r5 = r5.d(r0, r7)
            java.lang.String r4 = ck.d.a(r4, r5)
            r6.setText(r4)
            goto Lba
        L58:
            java.lang.Object r0 = r7.a()
        ...
        Lba:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: ps.d0.a0(ps.d0, android.widget.ImageView, android.widget.TextView, uk.c):kotlin.Unit");
    }
    ...
    private final void d0(int checkedNavigationItem) {
        ...
        DrawerLayout drawerLayout = this.drawer;
        if (drawerLayout == null) {
            throw new IllegalArgumentException(this.activityContext.getClass().getName() + " layout does not contain a DrawerLayout with id " + this.context.getResources().getResourceName(g0.f157283G) + '.');
        }
        NavigationView navigationView = this.navigationView;
        if (navigationView == null) {
            throw new IllegalArgumentException((this.activityContext.getClass().getName() + " must have a " + NavigationView.class.getCanonicalName() + " with id " + this.context.getResources().getResourceName(g0.f157282F) + '.').toString());
        }
        navigationView.setNavigationItemSelectedListener(this);
        Integer numValueOf = Integer.valueOf(EnumC16503G.INSTANCE.a(checkedNavigationItem).getResId());
    ...
    private final void f0(uk.c<ShoppingCart> cartResource) {
        Menu menu;
        MenuItem menuItemFindItem;
        NavigationView navigationView = this.navigationView;
        if (navigationView == null || (menu = navigationView.getMenu()) == null || (menuItemFindItem = menu.findItem(g0.f157292h)) == null) {
            return;
        }
        View actionView = menuItemFindItem.getActionView();
        TextView textView = actionView != null ? (TextView) actionView.findViewById(g0.f157286b) : null;
        ...
        if (shoppingCartA != null) {
            ...
            if (textView != null) {
                ck.d.g(textView, AbstractC6392a.INSTANCE.b(i0.f157322a, iIntValue, new Object[0]));
            }
        }
    ...
    private final void l0(int code) {
        if (code == 165) {
            this.analyticsEngine.b(C14756c.a("event: menu rewards"), new Function1() { // from class: ps.Z
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
        ...
        if (code == 180) {
            this.analyticsEngine.b(C14756c.a("shopDepartmentMenu"), new Function1() { // from class: ps.X
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
        ...
        if (code == 200) {
            this.analyticsEngine.b(C14756c.a("event: menu shopping List"), new Function1() { // from class: ps.b0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
        ...
        if (code == 1000) {
            this.analyticsEngine.b(C14756c.a("event: menu receipts & savings"), new Function1() { // from class: ps.a0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
        ...
        if (code == 1200) {
            this.analyticsEngine.b(C14756c.a("event: menu mcard"), new Function1() { // from class: ps.c0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
            ...
            this.analyticsEngine.b(C14756c.a("event: menu help"), new Function1() { // from class: ps.T
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
            ...
            this.analyticsEngine.b(C14756c.a("event: menu coupons"), new Function1() { // from class: ps.Y
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
    ...
    public final d0 H(String title, boolean isCentered) throws PackageManager.NameNotFoundException {
        ...
        a.C0968a c0968a = new a.C0968a(-1, -2, 17);
        ((ViewGroup.MarginLayoutParams) c0968a).rightMargin = (int) ((72 * this.context.getResources().getDisplayMetrics().density) + 0.5f);
        if (!isCentered) {
            c0968a = new a.C0968a(16);
        }
        fullWordEllipsisTextView.setLayoutParams(c0968a);
        Aj.c.a(fullWordEllipsisTextView, true);
        try {
            ...
            if (activityInfo.theme == Cj.p.f5108g) {
                C13804a.b(fullWordEllipsisTextView, k0.f157345b);
            } else {
                C13804a.b(fullWordEllipsisTextView, k0.f157344a);
            }
    ...
    public final void I() {
        ...
        EnumC16503G.Companion companion = EnumC16503G.INSTANCE;
        ...
        if (numValueOf != null) {
            ...
            if (navigationView != null && (menu2 = navigationView.getMenu()) != null && (menuItemFindItem2 = menu2.findItem(iIntValue)) != null) {
                menuItemFindItem2.setVisible(this.featureManager.e(AbstractC18503f.C18514l.f172888h));
            }
        }
        ...
        if (num != null) {
            ...
            menuItemFindItem.setVisible(this.featureManager.e(AbstractC18503f.p0.f172895h));
        }
    }
    ...
    public final void J() {
        ...
        if (drawerLayout2 != null) {
            drawerLayout2.announceForAccessibility(this.context.getString(j0.f157329f));
        }
    }
    ...
    public final void c0() {
        ...
        ImageButton imageButton = (ImageButton) navigationViewHeader.findViewById(g0.f157287c);
        if (imageButton != null) {
            imageButton.setOnClickListener(new View.OnClickListener() { // from class: ps.U
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    d0.Z(this.f157203a, view);
                }
            });
        }
        if (this.userManager.b()) {
            ConstraintLayout constraintLayout = (ConstraintLayout) navigationViewHeader.findViewById(g0.f157298n);
            final ImageView imageView = (ImageView) constraintLayout.findViewById(g0.f157289e);
            final TextView textView = (TextView) constraintLayout.findViewById(g0.f157288d);
            constraintLayout.setVisibility(0);
            io.reactivex.l<uk.c<ShoppingCart>> lVarObserveOn = this.cartRepository.b().distinctUntilChanged().subscribeOn(C13889a.b()).observeOn(Iu.a.a());
            final Function1 function1 = new Function1() { // from class: ps.V
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return d0.a0(this.f157204a, imageView, textView, (uk.c) obj);
                }
            };
            Dk.a.a(lVarObserveOn.subscribe(new Lu.g() { // from class: ps.W
                @Override // Lu.g
    ...
    public final void e0() {
        ...
        menu.findItem(g0.f157304t).setTitle(this.context.getString(Cj.o.f5048Y));
        menu.findItem(g0.f157309y).setTitle(this.context.getString(Cj.o.f5053b0));
    }
    ...
    public final void g0() {
        ...
        MenuItem menuItemFindItem2;
        NavigationView navigationView = this.navigationView;
        if (navigationView != null && (menu2 = navigationView.getMenu()) != null && (menuItemFindItem2 = menu2.findItem(g0.f157296l)) != null) {
            menuItemFindItem2.setVisible(this.userManager.b());
        }
        NavigationView navigationView2 = this.navigationView;
        if (navigationView2 == null || (menu = navigationView2.getMenu()) == null || (menuItemFindItem = menu.findItem(g0.f157279C)) == null) {
            return;
        }
        if (!this.featureManager.e(AbstractC18503f.O.f172854h)) {
            menuItemFindItem = null;
        }
        if (menuItemFindItem != null) {
            menuItemFindItem.setIcon(Cj.i.f4738S1);
        }
    }
    ...
    public final void h0() {
        Menu menu;
        MenuItem menuItemFindItem;
        Integer numValueOf = Integer.valueOf(EnumC16503G.INSTANCE.a(8266).getResId());
        if (numValueOf.intValue() == 0) {
            numValueOf = null;
        }
        if (numValueOf != null) {
            ...
            menuItemFindItem.setVisible(this.featureManager.e(AbstractC18503f.H.f172847h));
        }
    }
    ...
    public final void t0(boolean isLoggedIn) {
        ...
        MenuItem menuItemFindItem;
        NavigationView navigationView = this.navigationView;
        if (navigationView == null || (menu = navigationView.getMenu()) == null || (menuItemFindItem = menu.findItem(g0.f157280D)) == null) {
            return;
        }
    ...
    public final void u0(boolean isDevMode) {
        ...
        NavigationView navigationView = this.navigationView;
        if (navigationView != null && (menu3 = navigationView.getMenu()) != null && (menuItemFindItem3 = menu3.findItem(g0.f157297m)) != null) {
            menuItemFindItem3.setVisible(isDevMode);
        }
        NavigationView navigationView2 = this.navigationView;
        if (navigationView2 != null && (menu2 = navigationView2.getMenu()) != null && (menuItemFindItem2 = menu2.findItem(g0.f157285a)) != null) {
            menuItemFindItem2.setVisible(isDevMode);
        }
        NavigationView navigationView3 = this.navigationView;
        if (navigationView3 == null || (menu = navigationView3.getMenu()) == null || (menuItemFindItem = menu.findItem(g0.f157295k)) == null) {
            return;
        }
    ...
    public void a() {
        J();
        this.activityContext.startActivity(Bl.k.b(this.context, false, null, null, null, null, null, 126, null));
    }

    @Override // ps.e0
    public void b(int storeId, String storeName) {
        J();
        this.activityContext.startActivity(Bl.s.d(this.context, storeId, storeName, pk.i.f156744b, false, 16, null));
    }

    @Override // ps.e0
    public void c() {
        J();
        this.activityContext.startActivity(Bl.f.f3124a.a(this.context, this.featureManager.e(AbstractC18503f.h0.f172881h)));
    }
    ...
    public void g() {
        J();
        this.activityContext.startActivity(Bl.l.f3131a.c(this.context));
    }
