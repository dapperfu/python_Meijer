...
public final class C15430B {

    /* renamed from: a, reason: collision with root package name */
    private static final q f148985a;
    ...
    public static final class a implements J {
        ...
        public int getF51378b() {
            return this.height;
        }

        @Override // androidx.compose.ui.layout.J
        /* renamed from: getWidth, reason: from getter */
        public int getF51377a() {
            return this.width;
        }
    ...
    /* renamed from: l0.B$b */
    static final class b extends Lambda implements Function0<C15429A> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ int f148989f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f148990g;
        ...
        public final C15429A invoke() {
            return new C15429A(this.f148989f, this.f148990g);
        }
    }
    ...
    static {
        ...
        float f11 = 0.0f;
        boolean z11 = false;
        f148985a = new q(null, i10, z10, f10, aVar, f11, z11, C15784P.a(EmptyCoroutineContext.f143553a), H1.f.b(1.0f, 0.0f, 2, null), H1.c.b(0, 0, 0, 0, 15, null), listM, 0, 0, 0, false, enumC13937z, 0, 0, null);
    }

    public static final C15429A b(int i10, int i11, Composer composer, int i12, int i13) {
        if ((i13 & 1) != 0) {
            i10 = 0;
        }
        if ((i13 & 2) != 0) {
        ...
        L0.k<C15429A, ?> kVarA = C15429A.INSTANCE.a();
        ...
        C15429A c15429a = (C15429A) L0.c.c(objArr, kVarA, null, (Function0) objB, composer, 0, 4);
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        return c15429a;
