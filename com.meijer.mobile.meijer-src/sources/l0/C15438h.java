...
public final class C15438h extends AbstractC15880m<C15437g> implements w {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final C15857P<C15437g> intervals = new C15857P<>();
    ...
    static final class a extends Lambda implements Function1<Integer, Object> {
        ...
        final /* synthetic */ Object f149050f;
    ...
    static final class b extends Lambda implements Function1<Integer, Object> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Object f149051f;
    ...
    /* renamed from: l0.h$c */
    static final class c extends Lambda implements Function4<InterfaceC15433c, Integer, Composer, Integer, Unit> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function3<InterfaceC15433c, Composer, Integer, Unit> f149052f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        c(Function3<? super InterfaceC15433c, ? super Composer, ? super Integer, Unit> function3) {
            super(4);
            this.f149052f = function3;
        }

        public final void a(InterfaceC15433c interfaceC15433c, int i10, Composer composer, int i11) {
            if ((i11 & 6) == 0) {
                i11 |= composer.V(interfaceC15433c) ? 4 : 2;
            }
            ...
            this.f149052f.invoke(interfaceC15433c, composer, Integer.valueOf(i11 & 14));
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    /* renamed from: l0.h$d */
    static final class d extends Lambda implements Function3<InterfaceC15433c, Composer, Integer, Unit> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function4<InterfaceC15433c, Integer, Composer, Integer, Unit> f149053f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f149054g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        d(Function4<? super InterfaceC15433c, ? super Integer, ? super Composer, ? super Integer, Unit> function4, int i10) {
            super(3);
            this.f149053f = function4;
            this.f149054g = i10;
        }
        ...
        public final void a(InterfaceC15433c interfaceC15433c, Composer composer, int i10) {
            ...
            this.f149053f.invoke(interfaceC15433c, Integer.valueOf(this.f149054g), composer, Integer.valueOf(i10 & 14));
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    @Override // l0.w
    public void e(Object key, Object contentType, Function4<? super InterfaceC15433c, ? super Integer, ? super Composer, ? super Integer, Unit> content) {
    ...
    public C15857P<C15437g> k() {
        return this.intervals;
    }

    public C15438h(Function1<? super w, Unit> function1) {
        function1.invoke(this);
    }

    @Override // l0.w
    public void a(Object key, Object contentType, Function3<? super InterfaceC15433c, ? super Composer, ? super Integer, Unit> content) {
        a aVar;
        C15857P<C15437g> c15857pK = k();
        if (key != null) {
            aVar = new a(key);
        } else {
            aVar = null;
        }
        c15857pK.b(1, new C15437g(aVar, new b(contentType), ComposableLambdaKt.composableLambdaInstance(-1010194746, true, new c(content))));
    }

    @Override // l0.w
    public void i(int count, Function1<? super Integer, ? extends Object> key, Function1<? super Integer, ? extends Object> contentType, Function4<? super InterfaceC15433c, ? super Integer, ? super Composer, ? super Integer, Unit> itemContent) {
        k().b(count, new C15437g(key, contentType, itemContent));
    }
}
