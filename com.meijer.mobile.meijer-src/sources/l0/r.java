...
public final class r implements InterfaceC15439i, InterfaceC15892y {
    ...
    @Override // l0.InterfaceC15439i, kotlin.InterfaceC15892y
    public int getIndex() {
        return this.index;
    }
    ...
    public final void q(int mainAxisOffset, int layoutWidth, int layoutHeight) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (getIsVertical()) {
                ...
                if (bVar == null) {
                    C14592e.b("null horizontalAlignment when isVertical == true");
                ...
                if (cVar == null) {
                    C14592e.b("null verticalAlignment when isVertical == false");
                    throw new KotlinNothingValueException();
                }
