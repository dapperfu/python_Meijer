...
final class C15431a implements u {
    ...
    public void c(t tVar, n nVar) {
        ...
        if (this.indexToPrefetch != (this.wasScrollingForward ? ((InterfaceC15439i) CollectionsKt.D0(nVar.h())).getIndex() + 1 : ((InterfaceC15439i) CollectionsKt.s0(nVar.h())).getIndex() - 1)) {
    ...
    public void d(t tVar, float f10, n nVar) {
        ...
        if (!nVar.h().isEmpty()) {
            ...
            if (z10) {
                index = ((InterfaceC15439i) CollectionsKt.D0(nVar.h())).getIndex() + 1;
            } else {
                index = ((InterfaceC15439i) CollectionsKt.s0(nVar.h())).getIndex() - 1;
            }
            if (index >= 0 && index < nVar.f()) {
                ...
                if (z10) {
                    InterfaceC15439i interfaceC15439i = (InterfaceC15439i) CollectionsKt.D0(nVar.h());
                    if (((interfaceC15439i.getOffset() + interfaceC15439i.getSize()) + nVar.g()) - nVar.c() < (-f10) && (bVar2 = this.currentPrefetchHandle) != null) {
                        bVar2.a();
                        return;
                    }
                    return;
                }
                if (nVar.e() - ((InterfaceC15439i) CollectionsKt.s0(nVar.h())).getOffset() < f10 && (bVar = this.currentPrefetchHandle) != null) {
                    bVar.a();
                }
            }
        }
