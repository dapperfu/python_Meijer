...
public final class p {
    ...
    static final class a extends Lambda implements Function1<f0.a, Unit> {
        ...
        public static final a f149110f = new a();
    ...
    static final class b extends Lambda implements Function1<f0.a, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ InterfaceC5872l0<Unit> f149111f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ List<r> f149112g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ List<r> f149113h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ boolean f149114i;
        ...
        static final class a extends Lambda implements Function1<f0.a, Unit> {
            ...
            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ List<r> f149115f;

            /* renamed from: g, reason: collision with root package name */
            final /* synthetic */ List<r> f149116g;

            /* renamed from: h, reason: collision with root package name */
            final /* synthetic */ boolean f149117h;
            ...
            public final void a(f0.a aVar) {
                List<r> list = this.f149115f;
                boolean z10 = this.f149117h;
                int size = list.size();
                for (int i10 = 0; i10 < size; i10++) {
                    list.get(i10).p(aVar, z10);
                }
                List<r> list2 = this.f149116g;
                boolean z11 = this.f149117h;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(InterfaceC5872l0<Unit> interfaceC5872l0, List<r> list, List<r> list2, boolean z10) {
            super(1);
            this.f149111f = interfaceC5872l0;
            this.f149112g = list;
            this.f149113h = list2;
            this.f149114i = z10;
        }
        ...
        public final void a(f0.a aVar) {
            aVar.A(new a(this.f149112g, this.f149113h, this.f149114i));
            C15860T.a(this.f149111f);
        }
    ...
    static final class c extends Lambda implements Function1<Integer, r> {
        ...
        public final r a(int i10) {
            return s.e(this.f149118f, i10, 0L, 2, null);
        }
    ...
    private static final List<r> a(List<r> list, List<r> list2, List<r> list3, int i10, int i11, int i12, int i13, int i14, boolean z10, C5800d.m mVar, C5800d.e eVar, boolean z11, H1.d dVar) {
        int i15 = z10 ? i11 : i10;
        int i16 = 0;
        boolean z12 = i12 < Math.min(i15, i13);
        if (z12) {
            if (!(i14 == 0)) {
                C14592e.c("non-zero itemsScrollOffset");
            }
        }
        ArrayList arrayList = new ArrayList(list.size() + list2.size() + list3.size());
        if (z12) {
            if (!(list2.isEmpty() && list3.isEmpty())) {
                C14592e.a("no extra items");
            }
            int size = list.size();
    ...
    */
    public static final l0.q e(int r42, l0.s r43, int r44, int r45, int r46, int r47, int r48, int r49, float r50, long r51, boolean r53, androidx.compose.foundation.layout.C5800d.m r54, androidx.compose.foundation.layout.C5800d.e r55, boolean r56, H1.d r57, androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimator<l0.r> r58, int r59, java.util.List<java.lang.Integer> r60, boolean r61, boolean r62, l0.n r63, mv.InterfaceC15783O r64, androidx.compose.runtime.InterfaceC5872l0<kotlin.Unit> r65, V0.InterfaceC5453d1 r66, kotlin.InterfaceC15868a0 r67, kotlin.jvm.functions.Function3<? super java.lang.Integer, ? super java.lang.Integer, ? super kotlin.jvm.functions.Function1<? super androidx.compose.ui.layout.f0.a, kotlin.Unit>, ? extends androidx.compose.ui.layout.J> r68) {
        /*
            Method dump skipped, instructions count: 1119
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: l0.p.e(int, l0.s, int, int, int, int, int, int, float, long, boolean, androidx.compose.foundation.layout.d$m, androidx.compose.foundation.layout.d$e, boolean, H1.d, androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimator, int, java.util.List, boolean, boolean, l0.n, mv.O, androidx.compose.runtime.l0, V0.d1, n0.a0, kotlin.jvm.functions.Function3):l0.q");
    }
    ...
    private static final List<r> c(List<r> list, s sVar, int i10, int i11, List<Integer> list2, float f10, boolean z10, n nVar) {
        ...
        if (z10 && nVar != null && !nVar.h().isEmpty()) {
            List<InterfaceC15439i> listH = nVar.h();
            int size = listH.size();
            while (true) {
                size--;
                if (-1 >= size) {
            ...
            interfaceC15439i = listH.get(size);
            InterfaceC15439i interfaceC15439i2 = (InterfaceC15439i) CollectionsKt.D0(nVar.h());
            if (interfaceC15439i != null && (index = interfaceC15439i.getIndex()) <= (iMin = Math.min(interfaceC15439i2.getIndex(), i12))) {
                int i14 = index;
                while (true) {
                    if (arrayList != null) {
            ...
            float viewportEndOffset = ((nVar.getViewportEndOffset() - interfaceC15439i2.getOffset()) - interfaceC15439i2.getSize()) - f10;
            if (viewportEndOffset > 0.0f) {
                int index3 = interfaceC15439i2.getIndex() + 1;
                int i16 = 0;
