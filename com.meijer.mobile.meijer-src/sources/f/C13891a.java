...
public final class C13891a {
    ...
    private final Set<InterfaceC13892b> listeners = new CopyOnWriteArraySet();
    ...
    public final void a(InterfaceC13892b listener) {
    ...
    public final void c(Context context) {
        ...
        Iterator<InterfaceC13892b> it = this.listeners.iterator();
        while (it.hasNext()) {
            it.next().a(context);
        }
    }
    ...
    public final void e(InterfaceC13892b listener) {
        Intrinsics.j(listener, "listener");
