...
final class F {
    ...
    public static final Charset f16581a = Charset.forName("UTF-8");

    public static D.c a(C.c cVar) {
        return D.c.c0().A(cVar.c0().d0()).z(cVar.f0()).y(cVar.e0()).x(cVar.d0()).build();
    }

    public static We.D b(We.C c10) {
        D.b bVarY = We.D.c0().y(c10.f0());
    ...
    public static void c(C.c cVar) throws GeneralSecurityException {
        if (cVar.g0()) {
            if (cVar.e0() != I.UNKNOWN_PREFIX) {
                if (cVar.f0() != We.z.UNKNOWN_STATUS) {
                    return;
                } else {
    ...
    public static void d(We.C c10) throws GeneralSecurityException {
        int iF0 = c10.f0();
        int i10 = 0;
        boolean z10 = false;
        boolean z11 = true;
