...
public final class h0 implements Parcelable.Creator {
    ...
    public final /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < iE) {
            ...
            switch (SafeParcelReader.m(iU)) {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    c4458f = (C4458f) SafeParcelReader.f(parcel, iU, C4458f.CREATOR);
                    break;
                case 10:
                    c4458f2 = (C4458f) SafeParcelReader.f(parcel, iU, C4458f.CREATOR);
                    break;
                case 11:
                    iW2 = SafeParcelReader.w(parcel, iU);
                    break;
                case 12:
                    arrayListK2 = SafeParcelReader.k(parcel, iU, C4468p.CREATOR);
                    break;
                case 13:
        ...
        return new C4473v(arrayListK, fS, iW, fS2, zN, zN2, zN3, c4458f, c4458f2, iW2, arrayListK2, arrayListK3);
    }

    @Override // android.os.Parcelable.Creator
    public final /* synthetic */ Object[] newArray(int i10) {
        return new C4473v[i10];
    }
}
