...
public final class C6327h {
    ...
    private static final ThreadLocal<TypedValue> f59929a = new ThreadLocal<>();

    /* renamed from: b, reason: collision with root package name */
    private static final WeakHashMap<d, SparseArray<c>> f59930b = new WeakHashMap<>(0);

    /* renamed from: c, reason: collision with root package name */
    private static final Object f59931c = new Object();

    /* renamed from: b2.h$d */
    private static final class d {

        /* renamed from: a, reason: collision with root package name */
        final Resources f59935a;

        /* renamed from: b, reason: collision with root package name */
        final Resources.Theme f59936b;
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null && d.class == obj.getClass()) {
                d dVar = (d) obj;
                if (this.f59935a.equals(dVar.f59935a) && o2.c.a(this.f59936b, dVar.f59936b)) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            return o2.c.b(this.f59935a, this.f59936b);
        }

        d(Resources resources, Resources.Theme theme) {
            this.f59935a = resources;
            this.f59936b = theme;
        }
    }
    ...
    public static final class f {
        ...
        static class a {
            ...
            /* renamed from: a, reason: collision with root package name */
            private static final Object f59937a = new Object();

            /* renamed from: b, reason: collision with root package name */
            private static Method f59938b;

            /* renamed from: c, reason: collision with root package name */
            private static boolean f59939c;
            ...
            */
            static void a(android.content.res.Resources.Theme r6) {
                /*
                    java.lang.Object r0 = b2.C6327h.f.a.f59937a
                    monitor-enter(r0)
                    boolean r1 = b2.C6327h.f.a.f59939c     // Catch: java.lang.Throwable -> L17
                    r2 = 0
                    if (r1 != 0) goto L23
                    r1 = 1
                    ...
                    b2.C6327h.f.a.f59938b = r3     // Catch: java.lang.Throwable -> L17 java.lang.NoSuchMethodException -> L19
                ...
                L21:
                    b2.C6327h.f.a.f59939c = r1     // Catch: java.lang.Throwable -> L17
                L23:
                    java.lang.reflect.Method r1 = b2.C6327h.f.a.f59938b     // Catch: java.lang.Throwable -> L17
                    if (r1 == 0) goto L37
                ...
                L2e:
                    ...
                    b2.C6327h.f.a.f59938b = r2     // Catch: java.lang.Throwable -> L17
                L37:
                ...
                L39:
                    ...
                    throw r6
                */
                throw new UnsupportedOperationException("Method not decompiled: b2.C6327h.f.a.a(android.content.res.Resources$Theme):void");
            }
        }
    ...
    private static class c {
        ...
        /* renamed from: a, reason: collision with root package name */
        final ColorStateList f59932a;

        /* renamed from: b, reason: collision with root package name */
        final Configuration f59933b;
        ...
        c(ColorStateList colorStateList, Configuration configuration, Resources.Theme theme) {
            int iHashCode;
            this.f59932a = colorStateList;
            this.f59933b = configuration;
            if (theme == null) {
                iHashCode = 0;
            } else {
                iHashCode = theme.hashCode();
            }
            this.f59934c = iHashCode;
        }
    }

    private static void a(d dVar, int i10, ColorStateList colorStateList, Resources.Theme theme) {
        synchronized (f59931c) {
            try {
                WeakHashMap<d, SparseArray<c>> weakHashMap = f59930b;
                SparseArray<c> sparseArray = weakHashMap.get(dVar);
                if (sparseArray == null) {
                    sparseArray = new SparseArray<>();
                    weakHashMap.put(dVar, sparseArray);
                }
                sparseArray.append(i10, new c(colorStateList, dVar.f59935a.getConfiguration(), theme));
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x003c, code lost:
        ...
        if (r2.f59934c == r5.hashCode()) goto L22;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    private static android.content.res.ColorStateList b(b2.C6327h.d r5, int r6) {
        /*
            java.lang.Object r0 = b2.C6327h.f59931c
            monitor-enter(r0)
            java.util.WeakHashMap<b2.h$d, android.util.SparseArray<b2.h$c>> r1 = b2.C6327h.f59930b     // Catch: java.lang.Throwable -> L32
            ...
            b2.h$c r2 = (b2.C6327h.c) r2     // Catch: java.lang.Throwable -> L32
            if (r2 == 0) goto L45
            android.content.res.Configuration r3 = r2.f59933b     // Catch: java.lang.Throwable -> L32
            android.content.res.Resources r4 = r5.f59935a     // Catch: java.lang.Throwable -> L32
            android.content.res.Configuration r4 = r4.getConfiguration()     // Catch: java.lang.Throwable -> L32
            boolean r3 = r3.equals(r4)     // Catch: java.lang.Throwable -> L32
            if (r3 == 0) goto L42
            android.content.res.Resources$Theme r5 = r5.f59936b     // Catch: java.lang.Throwable -> L32
            if (r5 != 0) goto L34
            int r3 = r2.f59934c     // Catch: java.lang.Throwable -> L32
            if (r3 == 0) goto L3e
            goto L34
        L32:
            r5 = move-exception
        ...
        L34:
            ...
            if (r3 != r5) goto L42
        L3e:
            android.content.res.ColorStateList r5 = r2.f59932a     // Catch: java.lang.Throwable -> L32
        ...
        L48:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: b2.C6327h.b(b2.h$d, int):android.content.res.ColorStateList");
    }
    ...
    private static TypedValue k() {
        ThreadLocal<TypedValue> threadLocal = f59929a;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static android.graphics.Typeface o(android.content.Context r13, android.content.res.Resources r14, android.util.TypedValue r15, int r16, int r17, b2.C6327h.e r18, android.os.Handler r19, boolean r20, boolean r21) {
        /*
            Method dump skipped, instructions count: 230
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: b2.C6327h.o(android.content.Context, android.content.res.Resources, android.util.TypedValue, int, int, b2.h$e, android.os.Handler, boolean, boolean):android.graphics.Typeface");
    }
    ...
    private static ColorStateList l(Resources resources, int i10, Resources.Theme theme) {
        ...
        try {
            return C6322c.a(resources, resources.getXml(i10), theme);
        } catch (Exception e10) {
