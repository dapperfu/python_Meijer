...
final class n implements q {
    ...
    public static final class a extends f.AbstractC1120f {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ InterfaceC5872l0<Boolean> f4042a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ n f4043b;

        a(InterfaceC5872l0<Boolean> interfaceC5872l0, n nVar) {
            this.f4042a = interfaceC5872l0;
            this.f4043b = nVar;
        }

        @Override // androidx.emoji2.text.f.AbstractC1120f
        public void a(Throwable throwable) {
            this.f4043b.loadState = r.f4048a;
        }

        @Override // androidx.emoji2.text.f.AbstractC1120f
        public void b() {
            this.f4042a.setValue(Boolean.TRUE);
            this.f4043b.loadState = new s(true);
        }
    }
    ...
    private final z1<Boolean> c() {
        ...
        if (fVarC.g() != 1) {
            ...
            fVarC.v(new a(interfaceC5872l0E, this));
            return interfaceC5872l0E;
        }
        return new s(true);
    }
}
