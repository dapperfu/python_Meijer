...
public final class b {
    public static final void a(androidx.compose.ui.text.g gVar, Canvas canvas, AbstractC5467i0 abstractC5467i0, float f10, Shadow shadow, F1.k kVar, X0.g gVar2, int i10) {
        canvas.save();
        if (gVar.z().size() <= 1 || (abstractC5467i0 instanceof SolidColor)) {
            b(gVar, canvas, abstractC5467i0, f10, shadow, kVar, gVar2, i10);
            ...
            Shader shaderB = ((z1) abstractC5467i0).b(U0.k.d((Float.floatToRawIntBits(fMax) << 32) | (Float.floatToRawIntBits(height) & 4294967295L)));
            ...
            for (int i12 = 0; i12 < size2; i12++) {
                ...
                paragraphInfo2.getParagraph().y(canvas, C5470j0.a(shaderB), f10, shadow, kVar, gVar2, i10);
    ...
    private static final void b(androidx.compose.ui.text.g gVar, Canvas canvas, AbstractC5467i0 abstractC5467i0, float f10, Shadow shadow, F1.k kVar, X0.g gVar2, int i10) {
        List<ParagraphInfo> listZ = gVar.z();
        int size = listZ.size();
        for (int i11 = 0; i11 < size; i11++) {
            ParagraphInfo paragraphInfo = listZ.get(i11);
            paragraphInfo.getParagraph().y(canvas, abstractC5467i0, f10, shadow, kVar, gVar2, i10);
