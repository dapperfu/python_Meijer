...
final class k {
    ...
    private final Function0<A4.b> connectionFactory;
    ...
    private final C17018i[] connections;

    /* renamed from: g, reason: collision with root package name and from kotlin metadata */
    private final wv.h connectionPermits;

    /* renamed from: h, reason: collision with root package name and from kotlin metadata */
    private final C5607e<C17018i> availableConnections;
    ...
    static final class a extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f159998b = obj;
            this.f160000d |= Integer.MIN_VALUE;
    ...
    static final class b extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f160005e = obj;
            this.f160007g |= Integer.MIN_VALUE;
    ...
    static final class c extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Ref.ObjectRef<C17018i> f160010c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ k f160011d;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        c(Ref.ObjectRef<C17018i> objectRef, k kVar, Continuation<? super c> continuation) {
            super(2, continuation);
            this.f160010c = objectRef;
            this.f160011d = kVar;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new c(this.f160010c, this.f160011d, continuation);
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Object invokeSuspend(Object obj) {
            Ref.ObjectRef<C17018i> objectRef;
            T t10;
            Object objF = IntrinsicsKt.f();
            int i10 = this.f160009b;
            if (i10 != 0) {
                if (i10 == 1) {
                    objectRef = (Ref.ObjectRef) this.f160008a;
                    ResultKt.b(obj);
                    t10 = obj;
                } else {
                ...
                ResultKt.b(obj);
                Ref.ObjectRef<C17018i> objectRef2 = this.f160010c;
                k kVar = this.f160011d;
                this.f160008a = objectRef2;
                this.f160009b = 1;
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public k(int i10, Function0<? extends A4.b> connectionFactory) {
        Intrinsics.j(connectionFactory, "connectionFactory");
        this.capacity = i10;
        this.connectionFactory = connectionFactory;
        this.lock = new ReentrantLock();
        this.connections = new C17018i[i10];
        this.connectionPermits = wv.l.b(i10, 0, 2, null);
        this.availableConnections = new C5607e<>(i10);
    }
    ...
    private final void f() {
        ...
        C17018i c17018i = new C17018i(this.connectionFactory.invoke(), null, 2, 0 == true ? 1 : 0);
        C17018i[] c17018iArr = this.connections;
        int i10 = this.size;
        this.size = i10 + 1;
        c17018iArr[i10] = c17018i;
        this.availableConnections.a(c17018i);
    }
    ...
    */
    public final java.lang.Object a(kotlin.coroutines.Continuation<? super s4.C17018i> r5) {
        /*
            r4 = this;
        ...
        L13:
            ...
            r0.<init>(r5)
        L18:
            java.lang.Object r5 = r0.f159998b
            java.lang.Object r1 = kotlin.coroutines.intrinsics.IntrinsicsKt.f()
            int r2 = r0.f160000d
            r3 = 1
            if (r2 == 0) goto L35
            if (r2 != r3) goto L2d
            java.lang.Object r0 = r0.f159997a
            s4.k r0 = (s4.k) r0
        ...
        L5d:
            ...
            s4.i r1 = (s4.C17018i) r1     // Catch: java.lang.Throwable -> L5b
        ...
        L6b:
            ...
            r2 = 21
            A4.a.b(r2, r1)     // Catch: java.lang.Throwable -> L5b
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object b(long r9, kotlin.jvm.functions.Function0<kotlin.Unit> r11, kotlin.coroutines.Continuation<? super s4.C17018i> r12) {
        /*
            r8 = this;
        ...
        L13:
            ...
            r0.<init>(r12)
        L18:
            java.lang.Object r12 = r0.f160005e
            java.lang.Object r1 = kotlin.coroutines.intrinsics.IntrinsicsKt.f()
            int r2 = r0.f160007g
            r3 = 1
            r4 = 0
            ...
            if (r2 != r3) goto L3a
            long r9 = r0.f160004d
            java.lang.Object r11 = r0.f160003c
            kotlin.jvm.internal.Ref$ObjectRef r11 = (kotlin.jvm.internal.Ref.ObjectRef) r11
            java.lang.Object r2 = r0.f160002b
            kotlin.jvm.functions.Function0 r2 = (kotlin.jvm.functions.Function0) r2
            java.lang.Object r5 = r0.f160001a
            s4.k r5 = (s4.k) r5
        ...
        L46:
            ...
            r0.f160001a = r5     // Catch: java.lang.Throwable -> L68
            r0.f160002b = r11     // Catch: java.lang.Throwable -> L68
            r0.f160003c = r12     // Catch: java.lang.Throwable -> L68
            r0.f160004d = r9     // Catch: java.lang.Throwable -> L68
            r0.f160007g = r3     // Catch: java.lang.Throwable -> L68
            java.lang.Object r2 = mv.d1.d(r9, r2, r0)     // Catch: java.lang.Throwable -> L68
            if (r2 != r1) goto L61
            return r1
        L61:
            r2 = r11
        ...
        L7c:
            if (r0 != 0) goto L85
            T r12 = r12.f143742a     // Catch: java.lang.Throwable -> L7a
            if (r12 == 0) goto L83
            return r12
        L83:
            r0 = r2
    ...
    public final void c() {
        ...
        try {
            this.isClosed = true;
            for (C17018i c17018i : this.connections) {
                if (c17018i != null) {
                    c17018i.close();
                }
            }
    ...
    public final void d(StringBuilder builder) {
        ...
        try {
            ...
            builder.append('\n');
            C17018i[] c17018iArr = this.connections;
            int length = c17018iArr.length;
            int i11 = 0;
            for (int i12 = 0; i12 < length; i12++) {
                C17018i c17018i = c17018iArr[i12];
                i11++;
                StringBuilder sb2 = new StringBuilder();
                sb2.append("\t\t[");
                sb2.append(i11);
                sb2.append("] - ");
                sb2.append(c17018i != null ? c17018i.toString() : null);
    ...
    public final void e(C17018i connection) {
