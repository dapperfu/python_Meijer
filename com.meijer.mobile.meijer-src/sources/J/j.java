...
class j {
    ...
    private final Rational f15318c;

    /* renamed from: d, reason: collision with root package name */
    private final boolean f15319d;

    private Size d(q qVar) {
        return a(qVar.N(null), qVar.F(0), this.f15317b, this.f15316a);
    }
    ...
    j(InterfaceC3289y interfaceC3289y, Rational rational) {
        this.f15316a = interfaceC3289y.a();
        this.f15317b = interfaceC3289y.getLensFacing();
        this.f15318c = rational;
        boolean z10 = true;
    ...
    private Rational c(q qVar, List<Size> list) {
        if (qVar.z()) {
            return i.n(qVar.C(), this.f15319d);
        }
        Size sizeD = d(qVar);
        if (sizeD != null) {
            return b(sizeD, list);
    ...
    List<Size> f(List<Size> list, D<?> d10) {
        ...
        if (!arrayList2.isEmpty()) {
            ...
            if (rationalC == null) {
                ...
                Collections.sort(arrayList4, new a.C0182a(rationalC, this.f15318c));
