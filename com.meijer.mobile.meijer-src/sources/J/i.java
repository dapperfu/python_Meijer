...
public class i {
    ...
    private final InterfaceC3289y f15311a;
    ...
    private final Rational f15314d;

    /* renamed from: e, reason: collision with root package name */
    private final j f15315e;
    ...
    private static LinkedHashMap<Rational, List<Size>> b(Map<Rational, List<Size>> map, R.a aVar, Rational rational) {
        ...
        Collections.sort(arrayList, new a.C0182a(rationalN, rational));
    ...
    static Rational n(int i10, boolean z10) {
        ...
        if (i10 == 0) {
            return z10 ? G.a.f11062a : G.a.f11063b;
        }
        if (i10 == 1) {
            return z10 ? G.a.f11064c : G.a.f11065d;
        }
    ...
    public List<Size> m(D<?> d10) {
        ...
        if (cVarD == null) {
            return this.f15315e.f(listJ, d10);
        }
        ...
        return p(qVar.m(), listJ, sizeJ, iF, this.f15314d, this.f15312b, this.f15313c);
    }
    ...
    private Rational i(InterfaceC3289y interfaceC3289y) {
        List<Size> listE = interfaceC3289y.e(256);
        if (listE.isEmpty()) {
            return null;
        }
    ...
    static List<Rational> k(List<Size> list) {
        ...
        arrayList.add(G.a.f11062a);
        arrayList.add(G.a.f11064c);
        for (Size size : list) {
    ...
    public i(InterfaceC3289y interfaceC3289y, Size size) {
        Rational rationalI;
        this.f15311a = interfaceC3289y;
        this.f15312b = interfaceC3289y.a();
        this.f15313c = interfaceC3289y.getLensFacing();
        if (size != null) {
            rationalI = h(size);
        } else {
            rationalI = i(interfaceC3289y);
        }
        this.f15314d = rationalI;
        this.f15315e = new j(interfaceC3289y, rationalI);
    }
    ...
    private List<Size> c(List<Size> list, R.c cVar, int i10) {
        if (cVar.a() == 1) {
            ...
            arrayList.addAll(this.f15311a.c(i10));
