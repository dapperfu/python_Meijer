...
abstract class AbstractC3482q0 extends E0 {
    abstract Map a();

    @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
    public abstract boolean contains(Object obj);

    @Override // Fd.E0, java.util.AbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
    ...
    public final boolean retainAll(Collection collection) {
        ...
        try {
            ...
            return ((A) a()).f9177d.zzw().retainAll(hashSet);
        }
    }
