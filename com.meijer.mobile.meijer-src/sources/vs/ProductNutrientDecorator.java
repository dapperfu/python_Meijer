...
public final /* data */ class ProductNutrientDecorator {
    ...
    public ProductNutrientDecorator(String str, String str2, String str3, String str4) {
        ...
        this.amountWithUnit = LazyKt.b(new Function0() { // from class: vs.j
            ...
            public final Object invoke() {
                return ProductNutrientDecorator.b(this.f166291a);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final AbstractC6392a b(ProductNutrientDecorator productNutrientDecorator) {
        String str;
        String str2 = productNutrientDecorator.amount;
        if (str2 != null && !StringsKt.s0(str2) && (str = productNutrientDecorator.unitOfMeasure) != null && !StringsKt.s0(str) && !Intrinsics.e(productNutrientDecorator.unitOfMeasure, "Cal")) {
            return AbstractC6392a.INSTANCE.d(C17457C.f164385D, productNutrientDecorator.amount, productNutrientDecorator.unitOfMeasure);
        }
        ...
        if (str3 != null) {
            ...
            if (str3 != null) {
                return AbstractC6392a.INSTANCE.c(str3);
            }
        }
        return null;
    }
    ...
    public final AbstractC6392a c() {
        return (AbstractC6392a) this.amountWithUnit.getValue();
    }

    public final AbstractC6392a d() {
        String str = this.name;
        if (str != null && !StringsKt.s0(str) && c() != null) {
            AbstractC6392a.Companion companion = AbstractC6392a.INSTANCE;
            int i10 = C17457C.f164425v;
            String str2 = this.name;
            AbstractC6392a abstractC6392aC = c();
            Intrinsics.g(abstractC6392aC);
            return companion.d(i10, str2, abstractC6392aC);
        }
        String str3 = this.name;
        if (str3 == null || StringsKt.s0(str3)) {
            str3 = null;
        }
        if (str3 != null) {
            return AbstractC6392a.INSTANCE.c(str3);
    ...
    public final AbstractC6392a e() {
        ...
        if (str != null) {
            ...
            if (str != null) {
                return AbstractC6392a.INSTANCE.d(C17457C.f164384C, this.dailyPercentValue);
            }
        }
        return null;
    }
    ...
    public final AbstractC6392a f() {
        ...
        if (str != null) {
            ...
            if (str != null && (strK0 = StringsKt.K0(str, "Total ")) != null) {
                if (Intrinsics.e(strK0, "Carbohydrate")) {
                    strK0 = "Carbs";
                }
                return AbstractC6392a.INSTANCE.c(strK0);
            }
        }
        return null;
    }
