...
public final class m implements Ve.a {
    ...
    public static final b.EnumC0429b f42229d = b.EnumC0429b.f25764a;

    /* renamed from: e, reason: collision with root package name */
    private static final ThreadLocal<Cipher> f42230e = new a();

    /* renamed from: a, reason: collision with root package name */
    private final SecretKey f42231a;

    /* renamed from: b, reason: collision with root package name */
    private byte[] f42232b;

    /* renamed from: c, reason: collision with root package name */
    private byte[] f42233c;
    ...
    public byte[] a(byte[] bArr, int i10) throws GeneralSecurityException {
        ...
        Cipher cipherD = d();
        cipherD.init(1, this.f42231a);
        int iB = b(bArr.length);
        byte[] bArrD = iB * 16 == bArr.length ? f.d(bArr, (iB - 1) * 16, this.f42232b, 0, 16) : f.e(Ue.f.a(Arrays.copyOfRange(bArr, (iB - 1) * 16, bArr.length)), this.f42233c);
    ...
    public m(byte[] bArr) throws GeneralSecurityException {
        r.a(bArr.length);
        this.f42231a = new SecretKeySpec(bArr, "AES");
        c();
    }
    ...
    private void c() throws GeneralSecurityException {
        Cipher cipherD = d();
        cipherD.init(1, this.f42231a);
        byte[] bArrB = Ue.f.b(cipherD.doFinal(new byte[16]));
        this.f42232b = bArrB;
        this.f42233c = Ue.f.b(bArrB);
    }
}
