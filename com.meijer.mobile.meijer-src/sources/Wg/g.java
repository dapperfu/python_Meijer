...
class g {
    ...
    final int e(int i10) {
        return i10 - this.f41059a.g();
    }

    final void f(int i10, d dVar) {
        this.f41060b[e(i10)] = dVar;
    }
    ...
    g(c cVar) {
        this.f41059a = new c(cVar);
        this.f41060b = new d[(cVar.e() - cVar.g()) + 1];
    }
    ...
    final d c(int i10) {
        ...
        for (int i11 = 1; i11 < 5; i11++) {
            int iE = e(i10) - i11;
            if (iE >= 0 && (dVar2 = this.f41060b[iE]) != null) {
                return dVar2;
            }
            int iE2 = e(i10) + i11;
            d[] dVarArr = this.f41060b;
