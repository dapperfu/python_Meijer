...
final class e {
    ...
    private static final char[] f41044a = ";<>@[\\]_`~!\r\t,:\n-.$/\"|*()?{}'".toCharArray();

    /* renamed from: b, reason: collision with root package name */
    private static final char[] f41045b = "0123456789&\r\t,:#-.$/+%*=^".toCharArray();

    /* renamed from: c, reason: collision with root package name */
    private static final BigInteger[] f41046c;
    ...
    private static int a(int i10, int[] iArr, int i11, Ig.j jVar) throws FormatException {
        int i12;
        int i13;
        boolean z10 = false;
    ...
    private static int g(int[] iArr, int i10, Ig.j jVar) throws FormatException {
        int i11 = iArr[0];
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f41047a[b.LOWER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f41047a[b.MIXED.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f41047a[b.PUNCT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f41047a[b.ALPHA_SHIFT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f41047a[b.PUNCT_SHIFT.ordinal()] = 6;
    ...
    static {
        ...
        f41046c = bigIntegerArr;
        bigIntegerArr[0] = BigInteger.ONE;
        BigInteger bigIntegerValueOf = BigInteger.valueOf(900L);
        bigIntegerArr[1] = bigIntegerValueOf;
        int i10 = 2;
        while (true) {
            BigInteger[] bigIntegerArr2 = f41046c;
    ...
    static Ig.e b(int[] iArr, String str) throws FormatException {
        Ig.j jVar = new Ig.j(iArr.length * 2);
        ...
        Ig.e eVar = new Ig.e(null, jVar.toString(), null, str);
        eVar.p(cVar);
        return eVar;
    }
    ...
    private static String c(int[] iArr, int i10) throws FormatException {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            bigIntegerAdd = bigIntegerAdd.add(f41046c[(i10 - i11) - 1].multiply(BigInteger.valueOf(iArr[i11])));
        }
    ...
    static int d(int[] iArr, int i10, Vg.c cVar) throws FormatException {
        int i11;
        if (i10 + 2 > iArr[0]) {
            throw FormatException.a();
        }
    ...
    */
    private static Wg.e.b e(int[] r15, int[] r16, int r17, Ig.j r18, Wg.e.b r19) {
        /*
            Method dump skipped, instructions count: 298
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: Wg.e.e(int[], int[], int, Ig.j, Wg.e$b):Wg.e$b");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static int f(int[] r8, int r9, Ig.j r10) throws com.google.zxing.FormatException {
        /*
            r0 = 15
            int[] r0 = new int[r0]
            r1 = 0
        ...
        L47:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: Wg.e.f(int[], int, Ig.j):int");
    }
}
