...
public final class j {
    ...
    private static final Xg.a f41063a = new Xg.a();
    ...
    private static Ig.e h(int i10, int[] iArr, int[] iArr2, int[] iArr3, int[][] iArr4) throws ChecksumException, FormatException {
    ...
    private static Ig.e j(int[] iArr, int i10, int[] iArr2) throws ChecksumException, FormatException {
        if (iArr.length == 0) {
        ...
        w(iArr, i11);
        Ig.e eVarB = e.b(iArr, String.valueOf(i10));
    ...
    */
    private static int c(Ig.b r5, int r6, int r7, boolean r8, int r9, int r10) {
        /*
            if (r8 == 0) goto L4
            r0 = -1
            goto L5
        ...
        L28:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: Wg.j.c(Ig.b, int, int, boolean, int, int):int");
    }
    ...
    private static int e(int[] iArr, int[] iArr2, int i10) throws ChecksumException {
        if ((iArr2 == null || iArr2.length <= (i10 / 2) + 3) && i10 >= 0 && i10 <= 512) {
            return f41063a.a(iArr, i10, iArr2);
        }
        throw ChecksumException.a();
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static Ig.e i(Ig.b r17, com.google.zxing.o r18, com.google.zxing.o r19, com.google.zxing.o r20, com.google.zxing.o r21, int r22, int r23) throws com.google.zxing.NotFoundException, com.google.zxing.ChecksumException, com.google.zxing.FormatException {
        /*
            Method dump skipped, instructions count: 265
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: Wg.j.i(Ig.b, com.google.zxing.o, com.google.zxing.o, com.google.zxing.o, com.google.zxing.o, int, int):Ig.e");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static int[] q(Ig.b r7, int r8, int r9, boolean r10, int r11, int r12) {
        /*
            r0 = 8
            int[] r1 = new int[r0]
            r2 = 1
        ...
        L34:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: Wg.j.q(Ig.b, int, int, boolean, int, int):int[]");
    }

    private static h s(Ig.b bVar, c cVar, o oVar, boolean z10, int i10, int i11) {
    ...
    private static Ig.e g(f fVar) throws NotFoundException, ChecksumException, FormatException {
        b[][] bVarArrF = f(fVar);
        b(fVar, bVarArrF);
        ...
        return h(fVar.k(), iArr, Vg.a.b(arrayList), Vg.a.b(arrayList3), iArr2);
    }

    private static d k(Ig.b bVar, int i10, int i11, boolean z10, int i12, int i13, int i14, int i15) {
        int i16;
        int iD;
        int iA;
        ...
        if (!d(iD2, i14, i15) || (iA = Vg.a.a((iD = i.d(iArrQ)))) == -1) {
            return null;
        }
