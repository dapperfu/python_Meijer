...
public final class b {
    ...
    private final AbstractC5619q<LayoutNode> layoutNodes;
    ...
    private final C16991a rects = new C16991a();
    ...
    private final void b(NodeCoordinator nodeCoordinator, MutableRect mutableRect) {
        while (nodeCoordinator != null) {
            ...
            if (layer != null) {
                ...
                if (!C5477l1.a(fArrMo13getUnderlyingMatrixsQKQjiQ)) {
                    C5474k1.g(fArrMo13getUnderlyingMatrixsQKQjiQ, mutableRect);
                }
            }
        }
    }
    ...
    private final void f(LayoutNode layoutNode, long position, boolean firstPlacement) {
        ...
        if (firstPlacement || !this.rects.j(semanticsId, left, top, right, bottom)) {
            ...
            C16991a.e(this.rects, semanticsId, left, top, right, bottom, parent$ui_release != null ? parent$ui_release.getSemanticsId() : -1, false, false, 192, null);
        }
        h();
    }
        ...
        while (nodeCoordinator != null) {
            ...
            if (layer != null) {
                ...
                if (iC == 3) {
                    ...
                    jC = C5474k1.f(fArrMo13getUnderlyingMatrixsQKQjiQ, jC);
                }
            }
        }
        return o.d(jC);
    ...
    public b(AbstractC5619q<LayoutNode> abstractC5619q) {
        this.layoutNodes = abstractC5619q;
    }
    ...
    private final void e(LayoutNode layoutNode, boolean firstPlacement, int l10, int t10, int r10, int b10) {
        ...
        if (firstPlacement || !this.rects.g(semanticsId2, l10, t10, r10, b10)) {
            ...
            C16991a.e(this.rects, semanticsId2, l10, t10, r10, b10, semanticsId, false, false, 192, null);
        }
        h();
    }
    ...
    public final void c() {
        ...
        if (z11) {
            ...
            C16991a c16991a = this.rects;
            long[] jArr = c16991a.items;
            int i12 = c16991a.itemsSize;
