...
public final class C5730c {
    public static final void b(BottomSheetDialogFragment bottomSheetDialogFragment) {
        ...
        if (dialog != null) {
            dialog.setOnShowListener(new DialogInterface.OnShowListener() { // from class: an.b
                @Override // android.content.DialogInterface.OnShowListener
                public final void onShow(DialogInterface dialogInterface) {
                    C5730c.c(dialog, dialogInterface);
                }
            });
        }
    }
    ...
    public static final void c(Dialog dialog, DialogInterface dialogInterface) {
        View viewFindViewById = dialog.findViewById(ce.f.f61704h);
