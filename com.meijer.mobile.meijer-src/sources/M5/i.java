    ...
    */
    public static final /* synthetic */ java.util.Map a(java.util.List r7, java.lang.String r8) {
        ...
        L47:
            ...
            boolean r6 = M5.n.a(r6)
            if (r6 == 0) goto L62
            r3 = 2
            r6 = 0
            java.util.Map r2 = M5.j.b(r5, r2, r1, r3, r6)
            r0.putAll(r2)
            goto L81
        L62:
        ...
        L83:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: M5.i.a(java.util.List, java.lang.String):java.util.Map");
    }

    public static final /* synthetic */ Map b(Object[] objArr, String prefix) {
        Intrinsics.j(objArr, "<this>");
        Intrinsics.j(prefix, "prefix");
        return a(ArraysKt.h1(objArr), prefix);
    }
}
