...
@Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a)\u0010\u0006\u001a\u00020\u0004*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u00012\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003H\u0007¢\u0006\u0004\b\u0006\u0010\u0007\u001a\u0013\u0010\t\u001a\u00020\u0004*\u00020\bH\u0001¢\u0006\u0004\b\t\u0010\n¨\u0006\u000b"}, d2 = {"LKi/M;", "Lki/q1$i;", "template", "Lkotlin/Function0;", "", "content", "e", "(LKi/M;Lki/q1$i;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;I)V", "Lri/a;", "c", "(Lri/a;Landroidx/compose/runtime/Composer;I)V", "library_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class C16912d {
    ...
    static final class a implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ InterfaceC16909a f159560a;

        a(InterfaceC16909a interfaceC16909a) {
            this.f159560a = interfaceC16909a;
        }
        ...
        public final void a(Composer composer, int i10) {
            ...
            Modifier modifierJ = D.j(Modifier.INSTANCE, this.f159560a.c().getAdsSpacing().getFive().getDp(), this.f159560a.c().getAdsSpacing().getFour().getDp());
            InterfaceC16909a interfaceC16909a = this.f159560a;
            ...
            interfaceC16909a.getContent().invoke(composer, 0);
            composer.v();
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
    ...
    @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
    /* renamed from: ri.d$b */
    public static final class b implements Function1<C16913e, Unit> {

        /* renamed from: a, reason: collision with root package name */
        public static final b f159561a = new b();
    ...
    @SourceDebugExtension
    /* renamed from: ri.d$c */
    public static final class c extends Ji.c<Integer, C16913e, C16913e> {
        ...
        @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
        /* renamed from: ri.d$c$a */
        public static final class a implements Function0<C16913e> {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ h f159565a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ c f159566b;
            ...
            public final C16913e invoke() {
                ?? r02 = this.f159565a;
                this.f159566b.t().getValue().invoke(r02);
                return r02;
            }
        }
    ...
    public static final void e(final LocalThemeScope localThemeScope, final q1.InfoBlock template, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i10) {
        ...
        if ((i11 & 147) == 146 && composerStartRestartGroup.j()) {
            ...
            C16913e c16913e = new C16913e(template, localThemeScope, content);
            ...
            c cVar = new c((Function1) objB, composerStartRestartGroup, 0, objArrCopyOf, c16913e);
            composerStartRestartGroup.P();
        ...
        if (t0L != null) {
            t0L.a(new Function2() { // from class: ri.b
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return C16912d.f(localThemeScope, template, content, i10, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }

    public static final void c(final InterfaceC16909a interfaceC16909a, Composer composer, final int i10) {
        int i11;
        Intrinsics.j(interfaceC16909a, "<this>");
        Composer composerStartRestartGroup = composer.startRestartGroup(-1957793914);
        if ((i10 & 6) == 0) {
            i11 = ((i10 & 8) == 0 ? composerStartRestartGroup.V(interfaceC16909a) : composerStartRestartGroup.D(interfaceC16909a) ? 4 : 2) | i10;
        } else {
            i11 = i10;
        }
        if ((i11 & 3) == 2 && composerStartRestartGroup.j()) {
            ...
            C18051y.a(J.h(Modifier.INSTANCE, 0.0f, 1, null).then(interfaceC16909a.getTemplate().getModifier()), C16806i.c(interfaceC16909a.c().getAdsCornerRadii().getRadius04().getDp()), interfaceC16909a.getTemplate().getColor().getColor(), 0L, null, H1.h.p(0), ComposableLambdaKt.c(84614697, true, new a(interfaceC16909a), composerStartRestartGroup, 54), composerStartRestartGroup, 1769472, 24);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
        ...
        if (t0L != null) {
            t0L.a(new Function2() { // from class: ri.c
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return C16912d.d(interfaceC16909a, i10, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    public static final Unit d(InterfaceC16909a interfaceC16909a, int i10, Composer composer, int i11) {
        c(interfaceC16909a, composer, J0.a(i10 | 1));
        return Unit.f143329a;
    }
