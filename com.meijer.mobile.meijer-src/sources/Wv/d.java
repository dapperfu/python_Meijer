...
@Metadata(d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\n\n\u0002\u0010 \n\u0002\b\t\n\u0002\u0018\u0002\n\u0002\b\b\bÆ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J/\u0010\f\u001a\u00020\u000b2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\n\u001a\u00020\tH\u0002¢\u0006\u0004\b\f\u0010\rJ/\u0010\u000e\u001a\u00020\u000b2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\n\u001a\u00020\tH\u0002¢\u0006\u0004\b\u000e\u0010\rJ'\u0010\u0012\u001a\u00020\u00062\u0006\u0010\u000f\u001a\u00020\u00062\u0006\u0010\u0010\u001a\u00020\u00062\u0006\u0010\u0011\u001a\u00020\u000bH\u0002¢\u0006\u0004\b\u0012\u0010\u0013J#\u0010\u0014\u001a\u00020\u000b*\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\u0006H\u0002¢\u0006\u0004\b\u0014\u0010\u0015J)\u0010\u0017\u001a\b\u0012\u0004\u0012\u00020\u00060\u0016*\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\u0006H\u0002¢\u0006\u0004\b\u0017\u0010\u0018J\u0017\u0010\u0019\u001a\u0004\u0018\u00010\u00042\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0019\u0010\u001aJ\u0017\u0010\u001b\u001a\u0004\u0018\u00010\u00042\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u001b\u0010\u001aR\u001a\u0010\u001f\u001a\u00020\u00048\u0006X\u0086D¢\u0006\f\n\u0004\b\u0017\u0010\u001c\u001a\u0004\b\u001d\u0010\u001eR\u0017\u0010$\u001a\u00020 8\u0006¢\u0006\f\n\u0004\b\u001b\u0010!\u001a\u0004\b\"\u0010#R\u0018\u0010'\u001a\u00020\u0006*\u00020\u00068BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b%\u0010&¨\u0006("}, d2 = {"LWv/d;", "", "<init>", "()V", "", "string", "", "pos", "limit", "Lgw/e;", "result", "", "f", "(Ljava/lang/String;IILgw/e;)Z", "d", "delta", "numpoints", "first", "a", "(IIZ)I", "h", "(Ljava/lang/String;II)Z", "", "b", "(Ljava/lang/String;II)Ljava/util/List;", "e", "(Ljava/lang/String;)Ljava/lang/String;", "c", "Ljava/lang/String;", "getPREFIX_STRING", "()Ljava/lang/String;", "PREFIX_STRING", "Lgw/h;", "Lgw/h;", "getPREFIX", "()Lgw/h;", "PREFIX", "g", "(I)I", "punycodeDigit", "okhttp"}, k = 1, mv = {2, 2, 0}, xi = 48)
...
public final class d {
    ...
    private static final C14419h PREFIX = C14419h.INSTANCE.d("xn--");
    ...
    /* JADX WARN: Multi-variable type inference failed */
    private final boolean d(String string, int pos, int limit, C14416e result) {
        int i10;
        int i11;
        int i12 = 1;
        if (!StringsKt.K(string, pos, PREFIX_STRING, 0, 4, true)) {
            result.N0(string, pos, limit);
            return true;
        }
        int i13 = pos + 4;
        ArrayList arrayList = new ArrayList();
        int iW0 = StringsKt.w0(string, '-', limit, false, 4, null);
        char c10 = '0';
        char c11 = '[';
        char c12 = '{';
        boolean z10 = false;
    ...
    /* JADX WARN: Multi-variable type inference failed */
    private final boolean f(String string, int pos, int limit, C14416e result) {
        int i10;
        int i11;
        int i12;
        int i13 = 1;
    ...
    public final String c(String string) {
        ...
        while (i10 < length) {
            String str = string;
            int iP0 = StringsKt.p0(str, '.', i10, false, 4, null);
            if (iP0 == -1) {
                iP0 = length;
            }
            if (!d(str, i10, iP0, c14416e)) {
                return null;
            }
            if (iP0 >= length) {
                break;
            }
            c14416e.writeByte(46);
            i10 = iP0 + 1;
            string = str;
        }
        return c14416e.n3();
