...
public final class C16338g {
    public static final String a(int i10, int i11, Object[] objArr, Composer composer, int i12) throws Resources.NotFoundException {
        ...
        String quantityString = C16337f.a(composer, 0).getQuantityString(i10, i11, Arrays.copyOf(objArr, objArr.length));
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
    ...
    public static final String[] b(int i10, Composer composer, int i11) throws Resources.NotFoundException {
        ...
        String[] stringArray = C16337f.a(composer, 0).getStringArray(i10);
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        return stringArray;
    ...
    public static final String c(int i10, Composer composer, int i11) {
        ...
        String string = C16337f.a(composer, 0).getString(i10);
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        return string;
    ...
    public static final String d(int i10, Object[] objArr, Composer composer, int i11) throws Resources.NotFoundException {
        ...
        String string = C16337f.a(composer, 0).getString(i10, Arrays.copyOf(objArr, objArr.length));
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        return string;
