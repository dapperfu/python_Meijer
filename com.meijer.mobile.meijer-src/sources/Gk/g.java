...
public final class g {
    ...
    public final CharSequence e(String typeAheadText, String searchText) {
        ...
        int iQ0 = StringsKt.q0(typeAheadText, searchText, 0, false, 6, null);
        if (iQ0 >= 0 && !StringsKt.s0(typeAheadText) && !StringsKt.s0(searchText) && typeAheadText.length() >= searchText.length()) {
            spannableString.setSpan(typefaceSpan, 0, typeAheadText.length(), 18);
            spannableString.setSpan(new StyleSpan(1), iQ0, searchText.length() + iQ0, 18);
        }
    ...
    public final String f(String str) {
        ...
        return CollectionsKt.B0(StringsKt.b1(str, new String[]{" "}, false, 0, 6, null), " ", null, null, 0, null, new Function1() { // from class: Gk.f
