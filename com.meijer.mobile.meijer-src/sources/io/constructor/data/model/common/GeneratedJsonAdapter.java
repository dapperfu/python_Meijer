...
public final class GeneratedJsonAdapter extends h<Result> {
    ...
    public Result fromJson(k reader) throws IOException {
            ...
            switch (reader.z(this.options)) {
                ...
                case 0:
                    ...
                    if (resultDataFromJson == null) {
                        JsonDataException jsonDataExceptionW = C14410c.w("data_", "data", reader);
                ...
                case 4:
                    ...
                    if (strFromJson == null) {
                        JsonDataException jsonDataExceptionW2 = C14410c.w("value__", "value", reader);
        ...
        reader.d();
        if (resultDataFromJson == null) {
            JsonDataException jsonDataExceptionO = C14410c.o("data_", "data", reader);
        ...
        JsonDataException jsonDataExceptionO2 = C14410c.o("value__", "value", reader);
