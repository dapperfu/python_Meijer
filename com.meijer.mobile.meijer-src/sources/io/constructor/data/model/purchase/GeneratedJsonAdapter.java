...
public final class GeneratedJsonAdapter extends h<PurchaseRequestBody> {
    ...
    public GeneratedJsonAdapter(t moshi) {
        ...
        k.b bVarA = k.b.a("items", NotificationsManager.INTENT_EXTRA_ORDER_ID, "revenue", "c", "i", "s", "ui", "us", "analytics_tags", "key", "beacon", "_dt");
    ...
    public PurchaseRequestBody fromJson(k reader) throws IOException {
        ...
        while (true) {
            ...
            if (!reader.hasNext()) {
                ...
                reader.d();
                if (str == null) {
                    JsonDataException jsonDataExceptionO = C14410c.o("orderId", NotificationsManager.INTENT_EXTRA_ORDER_ID, reader);
                ...
                JsonDataException jsonDataExceptionO2 = C14410c.o("us", "us", reader);
            ...
            switch (reader.z(this.options)) {
                ...
                case 1:
                    ...
                    if (strFromJson == null) {
                        JsonDataException jsonDataExceptionW = C14410c.w("orderId", NotificationsManager.INTENT_EXTRA_ORDER_ID, reader);
                ...
                case 7:
                    ...
                    if (listFromJson2 == null) {
                        JsonDataException jsonDataExceptionW2 = C14410c.w("us", "us", reader);
    ...
    public void toJson(q writer, PurchaseRequestBody value_) throws IOException {
        ...
        writer.l(NotificationsManager.INTENT_EXTRA_ORDER_ID);
