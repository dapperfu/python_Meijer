...
public final class QuizRequest {
    ...
    public static final class Builder {
        ...
        public final void m131setAnswers(List<? extends List<String>> list) {
            this.answers = list;
        }

        /* renamed from: setFilters, reason: collision with other method in class */
        public final void m132setFilters(Map<String, ? extends List<String>> map) {
            this.filters = map;
        }
