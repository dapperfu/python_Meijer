...
public final class RecommendationsRequest {
    ...
    public static final class Builder {
        ...
        public final void m136setFilters(Map<String, ? extends List<String>> map) {
            this.filters = map;
        }

        /* renamed from: setItemIds, reason: collision with other method in class */
        public final void m137setItemIds(List<String> list) {
            this.itemIds = list;
        }
        ...
        public final Builder setVariationsMap(VariationsMap variationsMap) {
            ...
            m141setVariationsMap(variationsMap);
            return this;
        }
    }
