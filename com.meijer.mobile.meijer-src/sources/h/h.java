...
public final class h extends AbstractC14427a<String, Boolean> {
    @Override // h.AbstractC14427a
    /* renamed from: d, reason: merged with bridge method [inline-methods] */
    public Intent a(Context context, String input) {
        Intrinsics.j(context, "context");
        Intrinsics.j(input, "input");
        return C14433g.INSTANCE.a(new String[]{input});
    }

    @Override // h.AbstractC14427a
    /* renamed from: e, reason: merged with bridge method [inline-methods] */
    public AbstractC14427a.C2131a<Boolean> b(Context context, String input) {
        Intrinsics.j(context, "context");
        Intrinsics.j(input, "input");
        if (Z1.b.a(context, input) == 0) {
            return new AbstractC14427a.C2131a<>(Boolean.TRUE);
        }
        return null;
    }
