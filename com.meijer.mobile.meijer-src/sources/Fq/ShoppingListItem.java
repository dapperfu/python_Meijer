...
public final /* data */ class ShoppingListItem implements Parcelable {
    ...
    */
    ...
    public final boolean v() {
        String str = this.itemPartNumber;
        return !(str == null || StringsKt.s0(str));
    }
