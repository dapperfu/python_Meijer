...
public final class a {
    ...
    public static final class C0244a<T> implements Comparator {
        ...
        public final int compare(T t10, T t11) {
            String str = (String) CollectionsKt.u0(StringsKt.b1(((HybrisCategory) t11).getCode(), new String[]{"-"}, false, 0, 6, null));
            if (str == null) {
                str = "";
            }
            String str2 = (String) CollectionsKt.u0(StringsKt.b1(((HybrisCategory) t10).getCode(), new String[]{"-"}, false, 0, 6, null));
    ...
    public static final class b<T> implements Comparator {
        ...
        final /* synthetic */ Comparator f15212a;

        public b(Comparator comparator) {
            this.f15212a = comparator;
        }
        ...
        public final int compare(T t10, T t11) {
            ...
            int iCompare = this.f15212a.compare(t10, t11);
            if (iCompare != 0) {
                return iCompare;
            }
            String str = (String) CollectionsKt.F0(StringsKt.b1(((HybrisCategory) t10).getCode(), new String[]{"-"}, false, 0, 6, null));
            if (str == null || (numV = StringsKt.v(str)) == null) {
                numV = numValueOf;
            }
            String str2 = (String) CollectionsKt.F0(StringsKt.b1(((HybrisCategory) t11).getCode(), new String[]{"-"}, false, 0, 6, null));
    ...
    public static final String a(List<HybrisCategory> list) {
        ...
        for (Object obj : list) {
            if (!StringsKt.s0(((HybrisCategory) obj).getCode())) {
                arrayList.add(obj);
            }
        }
        HybrisCategory hybrisCategory = (HybrisCategory) CollectionsKt.u0(CollectionsKt.Z0(arrayList, new b(new C0244a())));
        String string = null;
        if (hybrisCategory != null && (url = hybrisCategory.getUrl()) != null && (listB1 = StringsKt.b1(url, new String[]{q2.f93563c}, false, 0, 6, null)) != null) {
