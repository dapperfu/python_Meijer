...
@Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u001d\u0010\n\u001a\u00020\t2\f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006H\u0002¢\u0006\u0004\b\n\u0010\u000bJ\u0017\u0010\u000f\u001a\u00020\u000e2\u0006\u0010\r\u001a\u00020\fH\u0016¢\u0006\u0004\b\u000f\u0010\u0010R\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\n\u0010\u0011¨\u0006\u0012"}, d2 = {"LSv/a;", "Lokhttp3/Interceptor;", "LMv/j;", "cookieJar", "<init>", "(LMv/j;)V", "", "LMv/i;", "cookies", "", "a", "(Ljava/util/List;)Ljava/lang/String;", "Lokhttp3/Interceptor$Chain;", "chain", "Lokhttp3/Response;", "intercept", "(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;", "LMv/j;", "okhttp"}, k = 1, mv = {2, 2, 0}, xi = 48)
...
public final class a implements Interceptor {
    ...
    public a(Mv.j cookieJar) {
        Intrinsics.j(cookieJar, "cookieJar");
        this.cookieJar = cookieJar;
    }

    private final String a(List<Mv.i> cookies) {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (request.d("Host") == null) {
            aVarG.m("Host", Nv.k.w(request.getUrl(), false, 1, null));
        }
        ...
        List<Mv.i> listA = this.cookieJar.a(request.getUrl());
        if (!listA.isEmpty()) {
        ...
        if (z10 && StringsKt.H("gzip", Response.j(responseProceed, "Content-Encoding", null, 2, null), true) && e.b(responseProceed) && (body = responseProceed.getBody()) != null) {
            ...
            aVarQ.b(new h(Response.j(responseProceed, "Content-Type", null, 2, null), -1L, w.c(qVar)));
        }
        return aVarQ.c();
    }
}
