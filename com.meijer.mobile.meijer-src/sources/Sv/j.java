...
@Metadata(d1 = {"\u0000P\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\u0018\u0000 \u00172\u00020\u0001:\u0001\u001bB\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J'\u0010\r\u001a\u00020\f2\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\b2\u0006\u0010\u000b\u001a\u00020\nH\u0002¢\u0006\u0004\b\r\u0010\u000eJ\u001f\u0010\u0007\u001a\u00020\f2\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u000b\u001a\u00020\nH\u0002¢\u0006\u0004\b\u0007\u0010\u000fJ\u001f\u0010\u0011\u001a\u00020\f2\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0010\u001a\u00020\fH\u0002¢\u0006\u0004\b\u0011\u0010\u0012J#\u0010\u0017\u001a\u0004\u0018\u00010\n2\u0006\u0010\u0014\u001a\u00020\u00132\b\u0010\u0016\u001a\u0004\u0018\u00010\u0015H\u0002¢\u0006\u0004\b\u0017\u0010\u0018J!\u0010\u001b\u001a\u0004\u0018\u00010\n2\u0006\u0010\u0014\u001a\u00020\u00132\u0006\u0010\u001a\u001a\u00020\u0019H\u0002¢\u0006\u0004\b\u001b\u0010\u001cJ\u001f\u0010\u001f\u001a\u00020\u001d2\u0006\u0010\u0014\u001a\u00020\u00132\u0006\u0010\u001e\u001a\u00020\u001dH\u0002¢\u0006\u0004\b\u001f\u0010 J\u0017\u0010#\u001a\u00020\u00132\u0006\u0010\"\u001a\u00020!H\u0016¢\u0006\u0004\b#\u0010$R\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001b\u0010%¨\u0006&"}, d2 = {"LSv/j;", "Lokhttp3/Interceptor;", "Lokhttp3/OkHttpClient;", "client", "<init>", "(Lokhttp3/OkHttpClient;)V", "Ljava/io/IOException;", "e", "LRv/o;", "call", "Lokhttp3/Request;", "userRequest", "", "d", "(Ljava/io/IOException;LRv/o;Lokhttp3/Request;)Z", "(Ljava/io/IOException;Lokhttp3/Request;)Z", "requestSendStarted", "c", "(Ljava/io/IOException;Z)Z", "Lokhttp3/Response;", "userResponse", "LRv/i;", "exchange", "b", "(Lokhttp3/Response;LRv/i;)Lokhttp3/Request;", "", "method", "a", "(Lokhttp3/Response;Ljava/lang/String;)Lokhttp3/Request;", "", "defaultDelay", "f", "(Lokhttp3/Response;I)I", "Lokhttp3/Interceptor$Chain;", "chain", "intercept", "(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;", "Lokhttp3/OkHttpClient;", "okhttp"}, k = 1, mv = {2, 2, 0}, xi = 48)
...
public final class j implements Interceptor {
    ...
    private final Request b(Response userResponse, Rv.i exchange) throws IOException {
        p pVarJ;
    ...
    private final Request a(Response userResponse, String method) {
        ...
        if (!Nv.k.f(userResponse.getRequest().getUrl(), httpUrlW)) {
    ...
    */
    public okhttp3.Response intercept(okhttp3.Interceptor.Chain r12) throws java.lang.Throwable {
        ...
        L19:
            ...
            if (r7 == 0) goto L39
            okhttp3.Response r6 = Nv.c.a(r7)     // Catch: java.lang.Throwable -> L35
            goto L3a
        L35:
            r12 = move-exception
            r3 = r5
        ...
        L3a:
            ...
            Rv.i r0 = r1.getInterceptorScopedExchange()     // Catch: java.lang.Throwable -> L35
        ...
        L7c:
            ...
            Nv.h.f(r0)     // Catch: java.lang.Throwable -> L35
            int r8 = r8 + 1
            r0 = 20
            if (r8 > r0) goto L95
        ...
        Lb3:
            ...
            goto L19
        Lcd:
            java.lang.Throwable r12 = Nv.h.G(r6, r2)     // Catch: java.lang.Throwable -> L35
            throw r12     // Catch: java.lang.Throwable -> L35
        Ld2:
        ...
        Lda:
            ...
            throw r12
        */
        throw new UnsupportedOperationException("Method not decompiled: Sv.j.intercept(okhttp3.Interceptor$Chain):okhttp3.Response");
    }
