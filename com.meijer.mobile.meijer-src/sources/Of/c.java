...
public class c {
    ...
    private static final Pattern f23707d = Pattern.compile("[0-9]+s");

    /* renamed from: e, reason: collision with root package name */
    private static final Charset f23708e = Charset.forName("UTF-8");

    /* renamed from: a, reason: collision with root package name */
    private final Context f23709a;

    /* renamed from: b, reason: collision with root package name */
    private final Kf.b<i> f23710b;

    /* renamed from: c, reason: collision with root package name */
    private final e f23711c = new e();
    ...
    private String f() {
        try {
            ...
            FS.log_e("ContentValues", "Could not get fingerprint hash for package: " + this.f23709a.getPackageName());
            return null;
        } catch (PackageManager.NameNotFoundException e10) {
            FS.log_e("ContentValues", "No such package: " + this.f23709a.getPackageName(), e10);
            return null;
        }
    }
    ...
    private HttpURLConnection l(URL url, String str) throws FirebaseInstallationsException {
        try {
            ...
            httpURLConnection.addRequestProperty(HttpHeaders.X_ANDROID_PACKAGE, this.f23709a.getPackageName());
            i iVar = this.f23710b.get();
            if (iVar != null) {
                try {
                    httpURLConnection.addRequestProperty("x-firebase-client", (String) C5519m.a(iVar.a()));
                } catch (InterruptedException e10) {
                    Thread.currentThread().interrupt();
                    FS.log_w("ContentValues", "Failed to get heartbeats header", e10);
                } catch (ExecutionException e11) {
                    FS.log_w("ContentValues", "Failed to get heartbeats header", e11);
                }
            }
            httpURLConnection.addRequestProperty(HttpHeaders.X_ANDROID_CERT, f());
    ...
    static long m(String str) {
        r.b(f23707d.matcher(str).matches(), "Invalid Expiration Timestamp.");
    ...
    public c(Context context, Kf.b<i> bVar) {
    ...
    private static void k(HttpURLConnection httpURLConnection, String str, String str2, String str3) throws IOException {
        ...
        if (!TextUtils.isEmpty(strO)) {
            FS.log_w("Firebase-Installations", strO);
            FS.log_w("Firebase-Installations", a(str, str2, str3));
        }
    }

    private d n(HttpURLConnection httpURLConnection) throws IOException, AssertionError {
        InputStream inputStream = httpURLConnection.getInputStream();
        JsonReader jsonReader = new JsonReader(new InputStreamReader(inputStream, f23708e));
        f.a aVarA = f.a();
        d.a aVarA2 = d.a();
    ...
    private static String o(HttpURLConnection httpURLConnection) throws IOException {
        ...
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(errorStream, f23708e));
        try {
            try {
