...
public final class O {
    ...
    private final float c() {
        ...
        int i10 = 0;
        lineInstance.setText(new C17594I(charSequence, 0, charSequence.length()));
    ...
    public final BoringLayout.Metrics e() {
        if (!this.boringMetricsIsInit) {
            this._boringMetrics = C17609k.f165399a.c(this.charSequence, this.textPaint, q0.k(this.textDirectionHeuristic));
