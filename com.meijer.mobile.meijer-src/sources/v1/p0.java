...
public final class p0 {
    ...
    public static final int[] d(o0 o0Var, Layout layout, C17598M c17598m, RectF rectF, int i10, Function2<? super RectF, ? super RectF, Boolean> function2) {
        int i11;
        InterfaceC17816f c17820j = i10 == 1 ? new C17820j(o0Var.G(), o0Var.I()) : C17817g.a(o0Var.G(), o0Var.getTextPaint());
        ...
        int iF = f(o0Var, layout, c17598m, i12, rectF, c17820j, function2, true);
        while (true) {
            i11 = i12;
            ...
            i12 = i11 + 1;
            iF = f(o0Var, layout, c17598m, i12, rectF, c17820j, function2, true);
        }
        if (iF == -1) {
            return null;
        }
        int iF2 = f(o0Var, layout, c17598m, lineForVertical2, rectF, c17820j, function2, false);
        while (iF2 == -1 && i11 < lineForVertical2) {
            int i13 = lineForVertical2 - 1;
            iF2 = f(o0Var, layout, c17598m, i13, rectF, c17820j, function2, false);
            lineForVertical2 = i13;
        }
        if (iF2 == -1) {
            return null;
        }
        return new int[]{c17820j.b(iF + 1), c17820j.c(iF2 - 1)};
    }

    private static final int f(o0 o0Var, Layout layout, C17598M c17598m, int i10, RectF rectF, InterfaceC17816f interfaceC17816f, Function2<? super RectF, ? super RectF, Boolean> function2, boolean z10) {
        ...
        o0Var.b(i10, fArr);
        C17598M.BidiRun[] bidiRunArrD = c17598m.d(i10);
        ...
        if ((step > 0 && first <= last) || (step < 0 && last <= first)) {
            int i11 = first;
            while (true) {
                C17598M.BidiRun bidiRun = bidiRunArrD[i11];
                ...
                int iE = z10 ? e(bidiRun, rectF, lineStart, lineTop, lineBottom, fA, fB, fArr, interfaceC17816f, function2) : c(bidiRun, rectF, lineStart, lineTop, lineBottom, fA, fB, fArr, interfaceC17816f, function2);
                if (iE < 0) {
                    if (i11 == last) {
                        break;
                    }
    ...
    private static final int c(C17598M.BidiRun bidiRun, RectF rectF, int i10, int i11, int i12, float f10, float f11, float[] fArr, InterfaceC17816f interfaceC17816f, Function2<? super RectF, ? super RectF, Boolean> function2) {
        int start;
        int iC;
        float fA;
        float fB;
        ...
        int iB = interfaceC17816f.b(start + 1);
        if (iB == -1 || (iC = interfaceC17816f.c(iB)) <= bidiRun.getStart()) {
            return -1;
        }
        ...
        while (true) {
            ...
            iK = interfaceC17816f.d(iK);
            if (iK == -1 || iK <= bidiRun.getStart()) {
                break;
            }
            iF = RangesKt.f(interfaceC17816f.b(iK), bidiRun.getStart());
        }
        return -1;
    }

    private static final int e(C17598M.BidiRun bidiRun, RectF rectF, int i10, int i11, int i12, float f10, float f11, float[] fArr, InterfaceC17816f interfaceC17816f, Function2<? super RectF, ? super RectF, Boolean> function2) {
        int start;
        int iB;
        float fA;
        float fB;
        ...
        int iC = interfaceC17816f.c(start);
        if (iC == -1 || (iB = interfaceC17816f.b(iC)) >= bidiRun.getEnd()) {
            return -1;
        }
        int iF = RangesKt.f(iB, bidiRun.getStart());
        int iK = RangesKt.k(iC, bidiRun.getEnd());
        ...
        while (true) {
            ...
            iF = interfaceC17816f.a(iF);
            if (iF == -1 || iF >= bidiRun.getEnd()) {
                break;
            }
            iK = RangesKt.k(interfaceC17816f.c(iF), bidiRun.getEnd());
        }
        return -1;
    }
}
