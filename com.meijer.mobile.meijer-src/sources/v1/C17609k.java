...
public final class C17609k {

    /* renamed from: a, reason: collision with root package name */
    public static final C17609k f165399a = new C17609k();
    ...
    public final BoringLayout a(CharSequence text, TextPaint paint, int width, BoringLayout.Metrics metrics, Layout.Alignment alignment, boolean includePadding, boolean useFallbackLineSpacing, TextUtils.TruncateAt ellipsize, int ellipsizedWidth) {
        ...
        return Build.VERSION.SDK_INT >= 33 ? C17608j.a(text, paint, width, alignment, 1.0f, 0.0f, metrics, includePadding, useFallbackLineSpacing, ellipsize, ellipsizedWidth) : C17610l.a(text, paint, width, alignment, 1.0f, 0.0f, metrics, includePadding, ellipsize, ellipsizedWidth);
    }

    public final boolean b(BoringLayout layout) {
        if (Build.VERSION.SDK_INT >= 33) {
            return C17608j.c(layout);
        }
        return false;
    }

    public final BoringLayout.Metrics c(CharSequence text, TextPaint paint, TextDirectionHeuristic textDir) {
        return Build.VERSION.SDK_INT >= 33 ? C17608j.b(text, paint, textDir) : C17610l.b(text, paint, textDir);
    }
