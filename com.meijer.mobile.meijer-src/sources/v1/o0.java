...
public final class o0 {
    ...
    private C17819i backingWordIterator;
    ...
    private C17598M backingLayoutHelper;
    ...
    public o0(CharSequence charSequence, float f10, TextPaint textPaint, int i10, TextUtils.TruncateAt truncateAt, int i11, float f11, float f12, boolean z10, boolean z11, int i12, int i13, int i14, int i15, int i16, int i17, int[] iArr, int[] iArr2, O o10) {
        ...
        Layout.Alignment alignmentA = m0.f165423a.a(i10);
        boolean z14 = (charSequence instanceof Spanned) && ((Spanned) charSequence).nextSpanTransition(-1, length, C18055a.class) < length;
        ...
        try {
            ...
            if (metricsE == null || o10.i() > f10 || z14) {
                ...
                layoutA = j0.f165396a.a(charSequence, textPaint2, iCeil, 0, charSequence.length(), textDirectionHeuristic, alignmentA, i18, truncateAt, (int) Math.ceil(d10), f11, f12, i17, z10, z11, i13, i14, i15, i16, iArr, iArr2);
            } else {
                z12 = true;
                this.isBoringLayout = true;
                layoutA = C17609k.f165399a.a(charSequence, textPaint, iCeil, metricsE, alignmentA, z10, z11, truncateAt, iCeil);
                textPaint2 = textPaint;
                i18 = i12;
                textDirectionHeuristic = textDirectionHeuristicK;
                z13 = false;
            ...
            long jI = hVarArrJ != null ? q0.i(hVarArrJ) : q0.f165447b;
    ...
    private final C17598M j() {
        C17598M c17598m = this.backingLayoutHelper;
        if (c17598m != null) {
            Intrinsics.g(c17598m);
            return c17598m;
        }
        C17598M c17598m2 = new C17598M(this.layout);
        this.backingLayoutHelper = c17598m2;
        return c17598m2;
    }

    public final int[] C(RectF rect, int granularity, Function2<? super RectF, ? super RectF, Boolean> inclusionStrategy) {
        return Build.VERSION.SDK_INT >= 34 ? C17604f.f165392a.c(this, rect, granularity, inclusionStrategy) : p0.d(this, this.layout, j(), rect, granularity, inclusionStrategy);
    }
    ...
    public final C17819i I() {
        C17819i c17819i = this.backingWordIterator;
        if (c17819i != null) {
            return c17819i;
        }
        C17819i c17819i2 = new C17819i(this.layout.getText(), 0, this.layout.getText().length(), this.textPaint.getTextLocale());
        this.backingWordIterator = c17819i2;
        return c17819i2;
    }

    public final boolean J() {
        if (this.isBoringLayout) {
            C17609k c17609k = C17609k.f165399a;
            Layout layout = this.layout;
            Intrinsics.h(layout, "null cannot be cast to non-null type android.text.BoringLayout");
            return c17609k.b((BoringLayout) layout);
        }
        j0 j0Var = j0.f165396a;
    ...
    public final void a(int startOffset, int endOffset, float[] array, int arrayStart) {
        ...
        C17595J c17595j = new C17595J(this);
        if (iQ > iQ2) {
            return;
        }
        int i10 = iQ;
