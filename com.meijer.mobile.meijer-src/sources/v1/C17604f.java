...
public final class C17604f {

    /* renamed from: a, reason: collision with root package name */
    public static final C17604f f165392a = new C17604f();
    ...
    public final int[] c(o0 layout, RectF rectF, int granularity, final Function2<? super RectF, ? super RectF, Boolean> inclusionStrategy) {
        ...
        if (granularity == 1) {
            segmentFinderA = C17811a.f166848a.a(new C17820j(layout.G(), layout.I()));
        } else {
            C17600b.a();
            segmentFinderA = C17601c.a(C17599a.a(layout.G(), layout.getTextPaint()));
        }
        return layout.getLayout().getRangeForRect(rectF, segmentFinderA, new Layout.TextInclusionStrategy() { // from class: v1.e
            ...
            public final boolean isSegmentInside(RectF rectF2, RectF rectF3) {
                return C17604f.b(inclusionStrategy, rectF2, rectF3);
            }
        });
    }
