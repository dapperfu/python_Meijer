...
public final class C17598M {
    ...
    public static /* synthetic */ int g(C17598M c17598m, int i10, boolean z10, int i11, Object obj) {
        if ((i11 & 2) != 0) {
            z10 = false;
        }
        return c17598m.f(i10, z10);
    }
    ...
    */
    public final java.text.Bidi a(int r11) {
        ...
        L73:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: v1.C17598M.a(int):java.text.Bidi");
    }
    ...
    public final float c(int offset, boolean usePrimaryDirection, boolean upstream) {
        ...
        int iA = C17597L.a(this.layout, iK, upstream);
    ...
    public C17598M(Layout layout) {
        int length;
        this.layout = layout;
        ArrayList arrayList = new ArrayList();
        int i10 = 0;
        do {
            int iP0 = StringsKt.p0(this.layout.getText(), '\n', i10, false, 4, null);
            if (iP0 < 0) {
