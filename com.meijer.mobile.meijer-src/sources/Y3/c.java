...
final class c {
    ...
    static final class b {
        ...
        /* renamed from: c, reason: collision with root package name */
        private static final Pattern f42913c = Pattern.compile("\\{([^}]*)\\}");

        /* renamed from: d, reason: collision with root package name */
        private static final Pattern f42914d = Pattern.compile(P.F("\\\\pos\\((%1$s),(%1$s)\\)", "\\s*\\d+(?:\\.\\d+)?\\s*"));

        /* renamed from: e, reason: collision with root package name */
        private static final Pattern f42915e = Pattern.compile(P.F("\\\\move\\(%1$s,%1$s,(%1$s),(%1$s)(?:,%1$s,%1$s)?\\)", "\\s*\\d+(?:\\.\\d+)?\\s*"));

        /* renamed from: f, reason: collision with root package name */
        private static final Pattern f42916f = Pattern.compile("\\\\an(\\d+)");

        /* renamed from: a, reason: collision with root package name */
        public final int f42917a;

        /* renamed from: b, reason: collision with root package name */
        public final PointF f42918b;

        private static int a(String str) {
            Matcher matcher = f42916f.matcher(str);
            if (matcher.find()) {
                return c.e((String) C13599a.e(matcher.group(1)));
            }
            return -1;
        }

        public static b b(String str) {
            Matcher matcher = f42913c.matcher(str);
            PointF pointF = null;
            int i10 = -1;
            while (matcher.find()) {
        ...
        private static PointF c(String str) {
            String strGroup;
            String strGroup2;
            Matcher matcher = f42914d.matcher(str);
            Matcher matcher2 = f42915e.matcher(str);
            ...
            return new PointF(Float.parseFloat(((String) C13599a.e(strGroup)).trim()), Float.parseFloat(((String) C13599a.e(strGroup2)).trim()));
        }

        public static String d(String str) {
            return f42913c.matcher(str).replaceAll("");
        }
    ...
    static final class a {
        ...
        /* renamed from: i, reason: collision with root package name */
        public final int f42910i;

        /* renamed from: j, reason: collision with root package name */
        public final int f42911j;

        /* renamed from: k, reason: collision with root package name */
        public final int f42912k;
    ...
    public static c b(String str, a aVar) {
        boolean z10;
        boolean z11;
        C13599a.a(str.startsWith("Style:"));
        String[] strArrSplit = TextUtils.split(str.substring(6), ",");
        int length = strArrSplit.length;
        int i10 = aVar.f42912k;
        if (length != i10) {
