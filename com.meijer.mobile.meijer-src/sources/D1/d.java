...
public final class d {
    ...
    private static final SpanStyle c(long j10, boolean z10, long j11, F1.a aVar) {
        ...
        boolean z13 = (C5489q0.s(j12, companion.j()) || C5489q0.s(j12, companion.i())) ? false : true;
        if (aVar != null) {
    ...
    public static final SpanStyle a(i iVar, SpanStyle spanStyle, Function4<? super AbstractC18269l, ? super FontWeight, ? super C18280w, ? super C18281x, ? extends Typeface> function4, H1.d dVar, boolean z10) {
        int iB;
        int iA;
        ...
        if (d(spanStyle)) {
            ...
            iVar.setTypeface(function4.invoke(fontFamily, fontWeight, c18280wC, C18281x.e(iA)));
        }
        if (spanStyle.getLocaleList() != null && !Intrinsics.e(spanStyle.getLocaleList(), LocaleList.INSTANCE.a())) {
            a.f5897a.b(iVar, spanStyle.getLocaleList());
        }
