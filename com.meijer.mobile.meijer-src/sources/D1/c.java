...
public final class c {
    ...
    static final class a extends Lambda implements Function3<SpanStyle, Integer, Integer, Unit> {
        ...
        final /* synthetic */ Spannable f5898f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function4<AbstractC18269l, FontWeight, C18280w, C18281x, Typeface> f5899g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        a(Spannable spannable, Function4<? super AbstractC18269l, ? super FontWeight, ? super C18280w, ? super C18281x, ? extends Typeface> function4) {
            super(3);
            this.f5898f = spannable;
            this.f5899g = function4;
        }

        public final void a(SpanStyle spanStyle, int i10, int i11) {
            Spannable spannable = this.f5898f;
            Function4<AbstractC18269l, FontWeight, C18280w, C18281x, Typeface> function4 = this.f5899g;
            ...
            C18280w c18280wC = C18280w.c(fontStyle != null ? fontStyle.getValue() : C18280w.INSTANCE.b());
            C18281x fontSynthesis = spanStyle.getFontSynthesis();
            spannable.setSpan(new o(function4.invoke(fontFamily, fontWeight, c18280wC, C18281x.e(fontSynthesis != null ? fontSynthesis.getValue() : C18281x.INSTANCE.a()))), i10, i11, 33);
        }
    ...
    public static final void i(Spannable spannable, long j10, int i10, int i11) {
        if (j10 != 16) {
            w(spannable, new BackgroundColorSpan(C5492s0.j(j10)), i10, i11);
        }
    }

    private static final void j(Spannable spannable, F1.a aVar, int i10, int i11) {
        if (aVar != null) {
            w(spannable, new C18055a(aVar.getMultiplier()), i10, i11);
        }
    }

    private static final void k(Spannable spannable, AbstractC5467i0 abstractC5467i0, float f10, int i10, int i11) {
        if (abstractC5467i0 != null) {
            if (abstractC5467i0 instanceof SolidColor) {
                m(spannable, ((SolidColor) abstractC5467i0).getValue(), i10, i11);
            } else if (abstractC5467i0 instanceof z1) {
                w(spannable, new E1.e((z1) abstractC5467i0, f10), i10, i11);
            }
        }
    }
    ...
    public static final void m(Spannable spannable, long j10, int i10, int i11) {
        if (j10 != 16) {
            w(spannable, new ForegroundColorSpan(C5492s0.j(j10)), i10, i11);
        }
    }
    ...
    private static final void o(Spannable spannable, TextStyle textStyle, List<? extends AnnotatedString.Range<? extends AnnotatedString.a>> list, Function4<? super AbstractC18269l, ? super FontWeight, ? super C18280w, ? super C18281x, ? extends Typeface> function4) {
    ...
    private static final void p(Spannable spannable, String str, int i10, int i11) {
        if (str != null) {
            w(spannable, new C18056b(str), i10, i11);
        }
    }
    ...
    public static final void u(Spannable spannable, LocaleList localeList, int i10, int i11) {
        if (localeList != null) {
            w(spannable, D1.a.f5897a.a(localeList), i10, i11);
        }
    }

    private static final void v(Spannable spannable, Shadow shadow, int i10, int i11) {
        if (shadow != null) {
            w(spannable, new l(C5492s0.j(shadow.getColor()), Float.intBitsToFloat((int) (shadow.getOffset() >> 32)), Float.intBitsToFloat((int) (shadow.getOffset() & 4294967295L)), d.b(shadow.getBlurRadius())), i10, i11);
        }
    }
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            ...
            if (i13 != iE0) {
                ...
                for (int i14 = 0; i14 < size3; i14++) {
                    ...
                    if (range2.h() != range2.f() && C6055b.i(iE0, i13, range2.h(), range2.f())) {
    ...
    public static final void s(Spannable spannable, long j10, float f10, H1.d dVar, LineHeightStyle lineHeightStyle) {
        ...
        if (!Float.isNaN(fH)) {
            if (spannable.length() == 0 || StringsKt.L1(spannable) == '\n') {
    ...
    public static final void y(Spannable spannable, TextStyle textStyle, List<? extends AnnotatedString.Range<? extends AnnotatedString.a>> list, H1.d dVar, Function4<? super AbstractC18269l, ? super FontWeight, ? super C18280w, ? super C18281x, ? extends Typeface> function4) {
