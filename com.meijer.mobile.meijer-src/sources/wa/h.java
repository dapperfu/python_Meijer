...
public class h implements Runnable {
    ...
    public void run() {
        try {
            ...
            e.Companion.b(companion, new L9.k(h.class, strA, MapsKt.o(TuplesKt.a("intent", getIntent()), TuplesKt.a("exception", e10)), null, 8, null), false, 2, null);
        }
    }
}
