...
@Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\t\u0018\u00002\u00020\u0001B\u001f\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0005\u001a\u00020\u0004\u0012\u0006\u0010\u0007\u001a\u00020\u0006¢\u0006\u0004\b\b\u0010\tJ\u000f\u0010\u000b\u001a\u00020\nH\u0016¢\u0006\u0004\b\u000b\u0010\fR\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\r\u0010\u000eR\u0014\u0010\u0005\u001a\u00020\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u000f\u0010\u0010R\u0014\u0010\u0007\u001a\u00020\u00068\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0011\u0010\u0012¨\u0006\u0013"}, d2 = {"Lwa/f;", "Ljava/lang/Runnable;", "Landroid/content/Intent;", "intent", "Landroid/content/Context;", "context", "Lva/c;", "launchActivityCommandLifecycleCallbacksFactory", "<init>", "(Landroid/content/Intent;Landroid/content/Context;Lva/c;)V", "", "run", "()V", "a", "Landroid/content/Intent;", "b", "Landroid/content/Context;", "c", "Lva/c;", "mobile-engage_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public final class f implements Runnable {
    ...
    private final va.c launchActivityCommandLifecycleCallbacksFactory;

    public f(Intent intent, Context context, va.c launchActivityCommandLifecycleCallbacksFactory) {
    ...
    public void run() {
        ...
        PendingIntent pendingIntentA = Ba.e.a(this.intent, this.context);
        if (pendingIntentA != null) {
            try {
                pendingIntentA.send();
                countDownLatch.await(5L, TimeUnit.SECONDS);
            } catch (PendingIntent.CanceledException e10) {
                K9.e.INSTANCE.c(new L9.b(e10, null));
                Unit unit = Unit.f143329a;
            } catch (InterruptedException e11) {
                K9.e.INSTANCE.c(new L9.b(e11, null));
                Unit unit2 = Unit.f143329a;
            } catch (Throwable th2) {
                K9.e.INSTANCE.c(new L9.b(th2, null));
