...
public final class f {
    ...
    public String a() {
        return this.f11337a.f23460f;
    }

    public String b() {
        return this.f11337a.f23462h;
    }

    public String c() {
        return this.f11337a.f23461g;
    }

    public String d() {
        return this.f11337a.f23459e;
    }

    public final JSONObject f() throws JSONException {
        JSONObject jSONObject = new JSONObject();
        jSONObject.put("Adapter", this.f11337a.f23455a);
        jSONObject.put("Latency", this.f11337a.f23456b);
        String strD = d();
        if (strD == null) {
        ...
        for (String str : this.f11337a.f23458d.keySet()) {
            jSONObject2.put(str, this.f11337a.f23458d.get(str));
        }
