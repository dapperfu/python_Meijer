...
public final class b {
    ...
    public static final int f14124e;
    ...
    private final a a(a start, a end, float interpolationPoint) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            fArr2[i10] = d.f14129a.b(start.b(f10), end.b(f10), interpolationPoint);
        }
    ...
    private final void g(float scaleKey, a fontScaleConverter) {
        synchronized (LookupTablesWriteLock) {
            ...
            f14120a.h(o0VarClone, scaleKey, fontScaleConverter);
    ...
    public final a b(float fontScale) {
        ...
        a aVarA = a(aVarN, sLookupTables.n(i10), d.f14129a.a(0.0f, 1.0f, fE, e(sLookupTables.i(i10)), fontScale));
        g(fontScale, aVarA);
        return aVarA;
    }
