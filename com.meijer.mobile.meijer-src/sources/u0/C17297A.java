...
public final class C17297A {
    ...
    public static final void b(EditorInfo editorInfo, CharSequence charSequence, long j10, ImeOptions imeOptions, String[] strArr) {
        ...
        imeOptions.g();
        t0.f163616a.a(editorInfo, imeOptions.getHintLocales());
        ...
        C16994c.f(editorInfo, charSequence);
        if (strArr != null) {
            C16994c.d(editorInfo, strArr);
        }
        editorInfo.imeOptions |= 33554432;
        if (C16990b.a() && !KeyboardType.n(imeOptions.getKeyboardType(), companion2.f()) && !KeyboardType.n(imeOptions.getKeyboardType(), companion2.e())) {
            C16994c.g(editorInfo, true);
            C17333z.f163629a.a(editorInfo);
        } else {
            C16994c.g(editorInfo, false);
        }
    }
}
