...
public final class C17315g extends AbstractC5959m implements androidx.compose.ui.node.u0 {
    ...
    static final class d extends Lambda implements Function1<AnnotatedString, Boolean> {
        ...
        public final Boolean invoke(AnnotatedString annotatedString) {
            C17315g.this.getState().I(true);
            C17315g.this.getState().C(true);
            C17315g c17315g = C17315g.this;
            c17315g.Z2(c17315g.getState(), annotatedString.getText(), C17315g.this.getReadOnly(), C17315g.this.getEnabled());
            return Boolean.TRUE;
        }
    }
    ...
    static final class e extends Lambda implements Function1<List<TextLayoutResult>, Boolean> {
        ...
        public final Boolean invoke(List<TextLayoutResult> list) {
            boolean z10;
            if (C17315g.this.getState().l() != null) {
                androidx.compose.foundation.text.h0 h0VarL = C17315g.this.getState().l();
                Intrinsics.g(h0VarL);
    ...
    static final class C2589g extends Lambda implements Function1<AnnotatedString, Boolean> {

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ r1.u f163545g;
        ...
        public final Boolean invoke(AnnotatedString annotatedString) {
            Unit unit;
            if (C17315g.this.getReadOnly() || !C17315g.this.getEnabled()) {
                return Boolean.FALSE;
            }
            z1.T inputSession = C17315g.this.getState().getInputSession();
            if (inputSession != null) {
                C17315g c17315g = C17315g.this;
                androidx.compose.foundation.text.T.INSTANCE.g(CollectionsKt.p(new C18431n(), new CommitTextCommand(annotatedString, 1)), c17315g.getState().getProcessor(), c17315g.getState().o(), inputSession);
                unit = Unit.f143329a;
            } else {
                unit = null;
            }
            if (unit == null) {
                C17315g c17315g2 = C17315g.this;
                c17315g2.getState().o().invoke(new TextFieldValue(StringsKt.V0(c17315g2.getValue().h(), androidx.compose.ui.text.y.n(c17315g2.getValue().getSelection()), androidx.compose.ui.text.y.i(c17315g2.getValue().getSelection()), annotatedString).toString(), C17334A.a(androidx.compose.ui.text.y.n(c17315g2.getValue().getSelection()) + annotatedString.length()), (androidx.compose.ui.text.y) null, 4, (DefaultConstructorMarker) null));
            }
            return Boolean.TRUE;
        }
    }
    ...
    static final class h extends Lambda implements Function3<Integer, Integer, Boolean, Boolean> {
        ...
        public final Boolean a(int i10, int i11, boolean z10) {
            if (!z10) {
                i10 = C17315g.this.getOffsetMapping().a(i10);
            }
            if (!z10) {
                i11 = C17315g.this.getOffsetMapping().a(i11);
            }
            boolean z11 = false;
            if (C17315g.this.getEnabled() && (i10 != androidx.compose.ui.text.y.n(C17315g.this.getValue().getSelection()) || i11 != androidx.compose.ui.text.y.i(C17315g.this.getValue().getSelection()))) {
                if (Math.min(i10, i11) < 0 || Math.max(i10, i11) > C17315g.this.getValue().getText().length()) {
                    C17315g.this.getManager().z();
                } else {
                    if (z10 || i10 == i11) {
                        C17315g.this.getManager().z();
                    } else {
                        C17778Q.y(C17315g.this.getManager(), false, 1, null);
                    }
                    C17315g.this.getState().o().invoke(new TextFieldValue(C17315g.this.getValue().getText(), C17334A.b(i10, i11), (androidx.compose.ui.text.y) null, 4, (DefaultConstructorMarker) null));
                    z11 = true;
                }
            }
    ...
    static final class i extends Lambda implements Function0<Boolean> {
        ...
        /* renamed from: c, reason: merged with bridge method [inline-methods] */
        public final Boolean invoke() {
            C17315g.this.getState().n().invoke(androidx.compose.ui.text.input.a.j(C17315g.this.getImeOptions().getImeAction()));
            return Boolean.TRUE;
        }
    }
    ...
    static final class j extends Lambda implements Function0<Boolean> {
        ...
        /* renamed from: c, reason: merged with bridge method [inline-methods] */
        public final Boolean invoke() {
            CoreTextFieldKt.q(C17315g.this.getState(), C17315g.this.getFocusRequester(), !C17315g.this.getReadOnly());
            return Boolean.TRUE;
        }
    }
    ...
    static final class l extends Lambda implements Function0<Boolean> {
        ...
        /* renamed from: c, reason: merged with bridge method [inline-methods] */
        public final Boolean invoke() {
            C17778Q.r(C17315g.this.getManager(), false, 1, null);
            return Boolean.TRUE;
        }
    }
    ...
    public final void a3(TransformedText transformedText, TextFieldValue value, androidx.compose.foundation.text.B state, boolean readOnly, boolean enabled, boolean isPassword, InterfaceC18417E offsetMapping, C17778Q manager, ImeOptions imeOptions, androidx.compose.ui.focus.y focusRequester) {
        boolean z10 = this.enabled;
        boolean z11 = false;
        boolean z12 = z10 && !this.readOnly;
        boolean z13 = this.isPassword;
        ImeOptions imeOptions2 = this.imeOptions;
        C17778Q c17778q = this.manager;
        if (enabled && !readOnly) {
            z11 = true;
        }
        ...
        if (Intrinsics.e(manager, c17778q)) {
            return;
        }
        manager.n0(new m());
    }
    ...
    public final void Z2(androidx.compose.foundation.text.B state, String text, boolean readOnly, boolean enabled) {
        ...
        if (inputSession != null) {
            androidx.compose.foundation.text.T.INSTANCE.g(CollectionsKt.p(new C18423f(), new CommitTextCommand(text, 1)), state.getProcessor(), state.o(), inputSession);
            unit = Unit.f143329a;
        } else {
            unit = null;
        }
        if (unit == null) {
            state.o().invoke(new TextFieldValue(text, C17334A.a(text.length()), (androidx.compose.ui.text.y) null, 4, (DefaultConstructorMarker) null));
        }
    }
    ...
    public void T1(r1.u uVar) {
        ...
        if (z10) {
            ...
            r1.s.z(uVar, null, new C2589g(uVar), 1, null);
        }
    ...
    public final C17778Q getManager() {
        return this.manager;
    }
    ...
    public C17315g(TransformedText transformedText, TextFieldValue textFieldValue, androidx.compose.foundation.text.B b10, boolean z10, boolean z11, boolean z12, InterfaceC18417E interfaceC18417E, C17778Q c17778q, ImeOptions imeOptions, androidx.compose.ui.focus.y yVar) {
        this.transformedText = transformedText;
