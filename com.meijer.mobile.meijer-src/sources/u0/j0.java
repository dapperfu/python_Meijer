...
public final class j0 {
    ...
    public static final class a implements InterfaceC18426i {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ InterfaceC18426i[] f163556a;

        a(InterfaceC18426i[] interfaceC18426iArr) {
            this.f163556a = interfaceC18426iArr;
        }

        @Override // z1.InterfaceC18426i
        public void a(C18429l buffer) {
            for (InterfaceC18426i interfaceC18426i : this.f163556a) {
                interfaceC18426i.a(buffer);
            }
        }
    }
    ...
    public static final long y(CharSequence charSequence, int i10) {
        int iCharCount = i10;
        while (iCharCount > 0) {
            int iC = C17314f.c(charSequence, iCharCount);
            if (!w(iC)) {
                break;
            }
        ...
        while (i10 < charSequence.length()) {
            int iB = C17314f.b(charSequence, i10);
            if (!w(iB)) {
                break;
            }
            i10 += C17314f.a(iB);
        }
        return C17334A.b(iCharCount, i10);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final InterfaceC18426i k(InterfaceC18426i... interfaceC18426iArr) {
        return new a(interfaceC18426iArr);
    }
    ...
    private static final long l(long j10, long j11) {
        return C17334A.b(Math.min(androidx.compose.ui.text.y.n(j10), androidx.compose.ui.text.y.n(j10)), Math.max(androidx.compose.ui.text.y.i(j11), androidx.compose.ui.text.y.i(j11)));
    }
