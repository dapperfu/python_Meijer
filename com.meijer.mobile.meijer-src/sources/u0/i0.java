...
public final class i0 {
    ...
    public static final i0 f163553a = new i0();
    ...
    static final class a extends Lambda implements Function1<MatchResult, CharSequence> {
        ...
        final /* synthetic */ Ref.IntRef f163554f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Ref.IntRef f163555g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(Ref.IntRef intRef, Ref.IntRef intRef2) {
            super(1);
            this.f163554f = intRef;
            this.f163555g = intRef2;
        }

        @Override // kotlin.jvm.functions.Function1
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final CharSequence invoke(MatchResult matchResult) {
            Ref.IntRef intRef = this.f163554f;
            if (intRef.f143740a == -1) {
                intRef.f143740a = matchResult.c().getFirst();
            }
            this.f163555g.f143740a = matchResult.c().getLast() + 1;
            return "";
        }
    }
    ...
    private final void e(long range, AnnotatedString text, boolean adjustRange, Function1<? super InterfaceC18426i, Unit> editCommandConsumer) {
        if (adjustRange) {
    ...
    private final int g(androidx.compose.foundation.text.B b10, InsertGesture insertGesture, Q1 q12, Function1<? super InterfaceC18426i, Unit> function1) {
    ...
    private final void h(int offset, String text, Function1<? super InterfaceC18426i, Unit> editCommandConsumer) {
        editCommandConsumer.invoke(j0.k(new SetSelectionCommand(offset, offset), new CommitTextCommand(text, 1)));
    }

    private final int i(androidx.compose.foundation.text.B b10, JoinOrSplitGesture joinOrSplitGesture, AnnotatedString annotatedString, Q1 q12, Function1<? super InterfaceC18426i, Unit> function1) {
        androidx.compose.foundation.text.h0 h0VarL;
        TextLayoutResult value;
        if (q12 == null) {
    ...
    private final void m(long range, C17778Q textSelectionManager, Function1<? super InterfaceC18426i, Unit> editCommandConsumer) {
    ...
    private final void n(androidx.compose.foundation.text.B b10, DeleteGesture deleteGesture, C17778Q c17778q) {
        if (c17778q != null) {
            c17778q.e0(j0.r(b10, w1.f(deleteGesture.getDeletionArea()), t(deleteGesture.getGranularity()), u1.t.INSTANCE.h()));
        }
    }

    private final void o(androidx.compose.foundation.text.B b10, DeleteRangeGesture deleteRangeGesture, C17778Q c17778q) {
        if (c17778q != null) {
            c17778q.e0(j0.s(b10, w1.f(deleteRangeGesture.getDeletionStartArea()), w1.f(deleteRangeGesture.getDeletionEndArea()), t(deleteRangeGesture.getGranularity()), u1.t.INSTANCE.h()));
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void q(C17778Q c17778q) {
        if (c17778q != null) {
            c17778q.p();
        }
    }

    private final void r(androidx.compose.foundation.text.B b10, SelectGesture selectGesture, C17778Q c17778q) {
        if (c17778q != null) {
            c17778q.o0(j0.r(b10, w1.f(selectGesture.getSelectionArea()), t(selectGesture.getGranularity()), u1.t.INSTANCE.h()));
        }
    }

    private final void s(androidx.compose.foundation.text.B b10, SelectRangeGesture selectRangeGesture, C17778Q c17778q) {
        if (c17778q != null) {
            c17778q.o0(j0.s(b10, w1.f(selectRangeGesture.getSelectionStartArea()), w1.f(selectRangeGesture.getSelectionEndArea()), t(selectRangeGesture.getGranularity()), u1.t.INSTANCE.h()));
        }
    }
    ...
    private final int b(HandwritingGesture gesture, Function1<? super InterfaceC18426i, Unit> editCommandConsumer) {
    ...
    private final int c(androidx.compose.foundation.text.B b10, DeleteGesture deleteGesture, AnnotatedString annotatedString, Function1<? super InterfaceC18426i, Unit> function1) {
        ...
        if (androidx.compose.ui.text.y.h(jR)) {
            return f163553a.b(S.a(deleteGesture), function1);
        }
        e(jR, annotatedString, u1.p.d(iT, u1.p.INSTANCE.b()), function1);
        return 1;
    }

    private final int d(androidx.compose.foundation.text.B b10, DeleteRangeGesture deleteRangeGesture, AnnotatedString annotatedString, Function1<? super InterfaceC18426i, Unit> function1) {
        ...
        if (androidx.compose.ui.text.y.h(jS)) {
            return f163553a.b(S.a(deleteRangeGesture), function1);
        }
        e(jS, annotatedString, u1.p.d(iT, u1.p.INSTANCE.b()), function1);
        return 1;
    }

    private final int j(androidx.compose.foundation.text.B b10, RemoveSpaceGesture removeSpaceGesture, AnnotatedString annotatedString, Q1 q12, Function1<? super InterfaceC18426i, Unit> function1) {
        TextLayoutResult value;
        ...
        if (androidx.compose.ui.text.y.h(jP)) {
            return f163553a.b(S.a(removeSpaceGesture), function1);
        }
        Ref.IntRef intRef = new Ref.IntRef();
        intRef.f143740a = -1;
        Ref.IntRef intRef2 = new Ref.IntRef();
        intRef2.f143740a = -1;
        String strL = new Regex("\\s+").l(C17334A.e(annotatedString, jP), new a(intRef, intRef2));
        if (intRef.f143740a != -1 && intRef2.f143740a != -1) {
            int iN = androidx.compose.ui.text.y.n(jP) + intRef.f143740a;
            int iN2 = androidx.compose.ui.text.y.n(jP) + intRef2.f143740a;
            String strSubstring = strL.substring(intRef.f143740a, strL.length() - (androidx.compose.ui.text.y.j(jP) - intRef2.f143740a));
    ...
    private final int k(androidx.compose.foundation.text.B b10, SelectGesture selectGesture, C17778Q c17778q, Function1<? super InterfaceC18426i, Unit> function1) {
        long jR = j0.r(b10, w1.f(selectGesture.getSelectionArea()), t(selectGesture.getGranularity()), u1.t.INSTANCE.h());
        if (androidx.compose.ui.text.y.h(jR)) {
            return f163553a.b(S.a(selectGesture), function1);
        }
        m(jR, c17778q, function1);
        return 1;
    }

    private final int l(androidx.compose.foundation.text.B b10, SelectRangeGesture selectRangeGesture, C17778Q c17778q, Function1<? super InterfaceC18426i, Unit> function1) {
        ...
        if (androidx.compose.ui.text.y.h(jS)) {
            return f163553a.b(S.a(selectRangeGesture), function1);
        }
        m(jS, c17778q, function1);
        return 1;
    }

    public final int f(androidx.compose.foundation.text.B b10, HandwritingGesture handwritingGesture, C17778Q c17778q, Q1 q12, Function1<? super InterfaceC18426i, Unit> function1) {
        ...
        if (C17298B.a(handwritingGesture)) {
            return k(b10, M.a(handwritingGesture), c17778q, function1);
        }
        if (Y.a(handwritingGesture)) {
            return c(b10, a0.a(handwritingGesture), untransformedText, function1);
        }
        if (b0.a(handwritingGesture)) {
            return l(b10, c0.a(handwritingGesture), c17778q, function1);
        }
        if (d0.a(handwritingGesture)) {
            return d(b10, e0.a(handwritingGesture), untransformedText, function1);
        }
        if (C17306J.a(handwritingGesture)) {
            return i(b10, C17307K.a(handwritingGesture), untransformedText, q12, function1);
        }
        if (C17302F.a(handwritingGesture)) {
            return g(b10, C17303G.a(handwritingGesture), q12, function1);
        }
        if (C17304H.a(handwritingGesture)) {
            return j(b10, C17305I.a(handwritingGesture), untransformedText, q12, function1);
        }
        return 2;
    }

    public final boolean p(androidx.compose.foundation.text.B b10, PreviewableHandwritingGesture previewableHandwritingGesture, final C17778Q c17778q, CancellationSignal cancellationSignal) {
        AnnotatedString text;
        TextLayoutResult value;
        TextLayoutInput layoutInput;
        AnnotatedString untransformedText = b10.getUntransformedText();
        ...
        if (C17298B.a(previewableHandwritingGesture)) {
            r(b10, M.a(previewableHandwritingGesture), c17778q);
        } else if (Y.a(previewableHandwritingGesture)) {
            n(b10, a0.a(previewableHandwritingGesture), c17778q);
        } else if (b0.a(previewableHandwritingGesture)) {
            s(b10, c0.a(previewableHandwritingGesture), c17778q);
        } else {
            if (!d0.a(previewableHandwritingGesture)) {
                return false;
            }
            o(b10, e0.a(previewableHandwritingGesture), c17778q);
        }
