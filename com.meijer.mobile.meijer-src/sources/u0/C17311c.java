...
final class C17311c {
    ...
    public static final C17311c f163526a = new C17311c();

    public final void b(androidx.compose.foundation.text.B legacyTextFieldState, C17778Q textFieldSelectionManager, HandwritingGesture gesture, Q1 viewConfiguration, Executor executor, final IntConsumer consumer, Function1<? super InterfaceC18426i, Unit> editCommandConsumer) {
        final int iF = legacyTextFieldState != null ? i0.f163553a.f(legacyTextFieldState, gesture, textFieldSelectionManager, viewConfiguration, editCommandConsumer) : 3;
        if (consumer == null) {
            return;
        }
        if (executor != null) {
    ...
    public final boolean d(androidx.compose.foundation.text.B legacyTextFieldState, C17778Q textFieldSelectionManager, PreviewableHandwritingGesture gesture, CancellationSignal cancellationSignal) {
        if (legacyTextFieldState != null) {
            return i0.f163553a.p(legacyTextFieldState, gesture, textFieldSelectionManager, cancellationSignal);
        }
        return false;
    }
