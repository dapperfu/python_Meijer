...
public final class C17324p {
    ...
    private final InterfaceC5866i0 cursorAlpha = A0.a(0.0f);

    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"Lmv/O;", "", "<anonymous>", "(Lmv/O;)Z"}, k = 3, mv = {1, 9, 0})
    ...
    static final class a extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Boolean>, Object> {
        ...
        private /* synthetic */ Object f163574b;
        ...
        static final class C2590a extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {

            /* renamed from: a, reason: collision with root package name */
            int f163576a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ C0 f163577b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ C17324p f163578c;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C2590a(C0 c02, C17324p c17324p, Continuation<? super C2590a> continuation) {
                super(2, continuation);
                this.f163577b = c02;
                this.f163578c = c17324p;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C2590a(this.f163577b, this.f163578c, continuation);
            }

            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(InterfaceC15783O interfaceC15783O, Continuation<? super Unit> continuation) {
                return ((C2590a) create(interfaceC15783O, continuation)).invokeSuspend(Unit.f143329a);
            }

            /* JADX WARN: Code restructure failed: missing block: B:34:0x0073, code lost:
            
                if (mv.Z.b(500, r10) != r0) goto L36;
             */
            ...
            */
            public final java.lang.Object invokeSuspend(java.lang.Object r11) {
                ...
                L33:
                    kotlin.ResultKt.b(r11)
                    mv.C0 r11 = r10.f163577b
                    if (r11 == 0) goto L43
                    r10.f163576a = r9
                    java.lang.Object r11 = mv.E0.g(r11, r10)
                    if (r11 != r0) goto L43
                    goto L75
                L43:
                    u0.p r11 = r10.f163578c     // Catch: java.lang.Throwable -> L1d
                    u0.C17324p.b(r11, r5)     // Catch: java.lang.Throwable -> L1d
                    u0.p r11 = r10.f163578c     // Catch: java.lang.Throwable -> L1d
                    boolean r11 = r11.getAnimate()     // Catch: java.lang.Throwable -> L1d
                    if (r11 != 0) goto L5f
                    r10.f163576a = r8     // Catch: java.lang.Throwable -> L1d
                    java.lang.Object r11 = mv.Z.a(r10)     // Catch: java.lang.Throwable -> L1d
                    if (r11 != r0) goto L59
                    goto L75
                L59:
                ...
                L5f:
                    r10.f163576a = r7     // Catch: java.lang.Throwable -> L1d
                    java.lang.Object r11 = mv.Z.b(r3, r10)     // Catch: java.lang.Throwable -> L1d
                    if (r11 != r0) goto L68
                    goto L75
                L68:
                    u0.p r11 = r10.f163578c     // Catch: java.lang.Throwable -> L1d
                    u0.C17324p.b(r11, r2)     // Catch: java.lang.Throwable -> L1d
                    r10.f163576a = r6     // Catch: java.lang.Throwable -> L1d
                    java.lang.Object r11 = mv.Z.b(r3, r10)     // Catch: java.lang.Throwable -> L1d
                    if (r11 != r0) goto L76
                L75:
                    return r0
                L76:
                    ...
                    goto L5f
                L7c:
                    u0.p r0 = r10.f163578c
                    u0.C17324p.b(r0, r2)
                    throw r11
                */
                throw new UnsupportedOperationException("Method not decompiled: u0.C17324p.a.C2590a.invokeSuspend(java.lang.Object):java.lang.Object");
            }
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            a aVar = C17324p.this.new a(continuation);
            aVar.f163574b = obj;
            return aVar;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f163573a == 0) {
                ResultKt.b(obj);
                return Boxing.a(U.d.a(C17324p.this.animationJob, null, C15809k.d((InterfaceC15783O) this.f163574b, null, null, new C2590a((C0) C17324p.this.animationJob.getAndSet(null), C17324p.this, null), 3, null)));
            }
    ...
    public final Object f(Continuation<? super Unit> continuation) {
        Object objG = C15784P.g(new a(null), continuation);
        return objG == IntrinsicsKt.f() ? objG : Unit.f143329a;
    }

    public C17324p(boolean z10) {
        this.animate = z10;
    }
}
