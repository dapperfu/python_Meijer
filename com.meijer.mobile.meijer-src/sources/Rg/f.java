...
public final class f extends s {
    ...
    */
    private static java.lang.String j(java.lang.String r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: Rg.f.j(java.lang.String):java.lang.String");
    }
    ...
    public boolean[] d(String str) {
        ...
        if (length <= 80) {
            ...
            for (int i11 = 0; i11 < length; i11++) {
                i(e.f32586e["0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%".indexOf(str.charAt(i11))], iArr);
