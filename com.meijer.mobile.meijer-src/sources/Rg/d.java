...
public final class d extends s {
    ...
    private static final class c {
        ...
        private static void b(Collection<int[]> collection, int i10, int[] iArr, int[] iArr2, int i11) {
            collection.add(Rg.c.f32565a[i10]);
            if (i11 != 0) {
                iArr2[0] = iArr2[0] + 1;
            }
        ...
        private int d(CharSequence charSequence, a aVar, int i10) {
            int iD;
            int iD2;
            int i11 = this.f32573a[aVar.ordinal()][i10];
            if (i11 > 0) {
                return i11;
            }
            b bVar = b.NONE;
            ...
            if (i14 != Integer.MAX_VALUE) {
                this.f32573a[aVar.ordinal()][i10] = i14;
                this.f32574b[aVar.ordinal()][i10] = bVar;
                return i14;
            }
        ...
        */
        public boolean[] e(java.lang.String r18) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: Rg.d.c.e(java.lang.String):boolean[]");
        }
        ...
        private boolean c(CharSequence charSequence, a aVar, int i10) {
            ...
            int i12 = a.f32567b[aVar.ordinal()];
            if (i12 != 1) {
                if (i12 != 2) {
                    if (i12 != 3) {
                        return false;
    ...
    private static int i(String str, Map<com.google.zxing.f, ?> map) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: Rg.d.i(java.lang.String, java.util.Map):int");
        }
        ...
        static /* synthetic */ class a {
            ...
            /* renamed from: b, reason: collision with root package name */
            static final /* synthetic */ int[] f32567b;
            ...
            static {
                ...
                try {
                    f32567b[c.a.B.ordinal()] = 2;
                } catch (NoSuchFieldError unused2) {
                }
                try {
                    f32567b[c.a.C.ordinal()] = 3;
                ...
                try {
                    f32566a[c.b.B.ordinal()] = 2;
                } catch (NoSuchFieldError unused5) {
                }
                try {
                    f32566a[c.b.C.ordinal()] = 3;
                } catch (NoSuchFieldError unused6) {
                }
                try {
                    f32566a[c.b.SHIFT.ordinal()] = 4;
        ...
        private static boolean[] k(String str, int i10) throws NumberFormatException {
            ...
            while (i12 < length) {
                ...
                arrayList.add(Rg.c.f32565a[iCharAt]);
                i13 += iCharAt * i15;
                if (i12 != 0) {
                    i15++;
                }
