...
public abstract class y extends r {
    ...
    static final int[] f32624d = {1, 1, 1};

    /* renamed from: e, reason: collision with root package name */
    static final int[] f32625e = {1, 1, 1, 1, 1};

    /* renamed from: f, reason: collision with root package name */
    static final int[] f32626f = {1, 1, 1, 1, 1, 1};

    /* renamed from: g, reason: collision with root package name */
    static final int[][] f32627g;

    /* renamed from: h, reason: collision with root package name */
    static final int[][] f32628h;

    /* renamed from: a, reason: collision with root package name */
    private final StringBuilder f32629a = new StringBuilder(20);

    /* renamed from: b, reason: collision with root package name */
    private final x f32630b = new x();

    /* renamed from: c, reason: collision with root package name */
    private final m f32631c = new m();
    ...
    static int[] n(Ig.a aVar, int i10, boolean z10, int[] iArr) throws NotFoundException {
        return o(aVar, i10, z10, iArr, new int[iArr.length]);
    }

    int[] k(Ig.a aVar, int i10) throws NotFoundException {
        return n(aVar, i10, false, f32624d);
    }

    protected abstract int l(Ig.a aVar, int[] iArr, StringBuilder sb2) throws NotFoundException;
    ...
    public com.google.zxing.m m(int i10, Ig.a aVar, int[] iArr, Map<com.google.zxing.d, ?> map) throws NotFoundException, ChecksumException, FormatException {
        ...
        StringBuilder sb2 = this.f32629a;
        sb2.setLength(0);
        ...
        try {
            com.google.zxing.m mVarA = this.f32630b.a(i10, aVar, iArrK[1]);
        ...
        if ((aVarQ == com.google.zxing.a.EAN_13 || aVarQ == com.google.zxing.a.UPC_A) && (strC = this.f32631c.c(string)) != null) {
    ...
    static int[] p(Ig.a aVar) throws NotFoundException {
        int[] iArr = new int[f32624d.length];
        int[] iArrO = null;
        boolean zN = false;
        int i10 = 0;
        while (!zN) {
    ...
    static int j(Ig.a aVar, int[] iArr, int i10, int[][] iArr2) throws NotFoundException {
        r.f(aVar, i10, iArr);
    ...
    private static int[] o(Ig.a aVar, int i10, boolean z10, int[] iArr, int[] iArr2) throws NotFoundException {
        int iJ;
        int iL = aVar.l();
        if (z10) {
            iJ = aVar.k(i10);
