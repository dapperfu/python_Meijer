...
public final class g extends r {
    ...
    private static final char[] f32591c = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".toCharArray();

    /* renamed from: d, reason: collision with root package name */
    static final int[] f32592d;

    /* renamed from: e, reason: collision with root package name */
    static final int f32593e;

    /* renamed from: a, reason: collision with root package name */
    private final StringBuilder f32594a = new StringBuilder(20);

    /* renamed from: b, reason: collision with root package name */
    private final int[] f32595b = new int[6];
    ...
    private static void i(CharSequence charSequence, int i10, int i11) throws ChecksumException {
        ...
        if (charSequence.charAt(i10) != f32591c[iIndexOf % 47]) {
    ...
    */
    private static java.lang.String j(java.lang.CharSequence r9) throws com.google.zxing.FormatException {
        ...
        Lb3:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: Rg.g.j(java.lang.CharSequence):java.lang.String");
    }

    private int[] k(Ig.a aVar) throws NotFoundException {
        int iL = aVar.l();
        int iJ = aVar.j(0);
        Arrays.fill(this.f32595b, 0);
    ...
    public com.google.zxing.m c(int i10, Ig.a aVar, Map<com.google.zxing.d, ?> map) throws NotFoundException, ChecksumException, FormatException {
        ...
        int[] iArr = this.f32595b;
        Arrays.fill(iArr, 0);
        StringBuilder sb2 = this.f32594a;
        sb2.setLength(0);
        while (true) {
            r.f(aVar, iJ, iArr);
            int iM = m(iArr);
