...
final class w {
    ...
    private static final int[] f32618c = {24, 20, 18, 17, 12, 6, 3, 10, 9, 5};

    /* renamed from: a, reason: collision with root package name */
    private final int[] f32619a = new int[4];

    /* renamed from: b, reason: collision with root package name */
    private final StringBuilder f32620b = new StringBuilder();
    ...
    */
    private static java.lang.String e(java.lang.String r5) throws java.lang.NumberFormatException {
        ...
        L79:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: Rg.w.e(java.lang.String):java.lang.String");
    }

    private int a(Ig.a aVar, int[] iArr, StringBuilder sb2) throws NotFoundException {
        int[] iArr2 = this.f32619a;
        iArr2[0] = 0;
        iArr2[1] = 0;
        iArr2[2] = 0;
        iArr2[3] = 0;
        ...
        for (int i11 = 0; i11 < 5 && iK < iL; i11++) {
            int iJ = y.j(aVar, iArr2, iK, y.f32628h);
    ...
    com.google.zxing.m b(int i10, Ig.a aVar, int[] iArr) throws NotFoundException {
        StringBuilder sb2 = this.f32620b;
        sb2.setLength(0);
