...
public class h extends s {
    ...
    public boolean[] d(String str) {
        ...
        if (length <= 80) {
            ...
            int i10 = i(zArr, 0, g.f32593e);
            for (int i11 = 0; i11 < length; i11++) {
                i10 += i(zArr, i10, g.f32592d["0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".indexOf(strK.charAt(i11))]);
            }
            int iJ = j(strK, 20);
            int[] iArr = g.f32592d;
            int i12 = i10 + i(zArr, i10, iArr[iJ]);
            int i13 = i12 + i(zArr, i12, iArr[j(strK + "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".charAt(iJ), 15)]);
            zArr[i13 + i(zArr, i13, g.f32593e)] = true;
            return zArr;
        }
