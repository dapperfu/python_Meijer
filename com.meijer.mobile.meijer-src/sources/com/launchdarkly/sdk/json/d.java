...
public abstract class d {
    ...
    static final List<Class<? extends c>> f92182a = new ArrayList();

    /* renamed from: b, reason: collision with root package name */
    private static final Gson f92183b = new com.google.gson.f().e().b();

    static <T> T b(a aVar, Type type) {
        return (T) f92183b.k(aVar, type);
    }
