...
final class EvaluationReasonTypeAdapter extends TypeAdapter<EvaluationReason> {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f91836a[EvaluationReason.Kind.FALLTHROUGH.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f91836a[EvaluationReason.Kind.TARGET_MATCH.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f91836a[EvaluationReason.Kind.RULE_MATCH.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f91836a[EvaluationReason.Kind.PREREQUISITE_FAILED.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f91836a[EvaluationReason.Kind.ERROR.ordinal()] = 6;
    ...
    */
    ...
    public void write(JsonWriter jsonWriter, EvaluationReason evaluationReason) throws IOException {
        ...
        int i10 = a.f91836a[evaluationReason.f().ordinal()];
        if (i10 != 2) {
            if (i10 != 4) {
                if (i10 != 5) {
                    if (i10 == 6) {
