...
@InterfaceC16126b(AttributeRefTypeAdapter.class)
...
public final class AttributeRef implements com.launchdarkly.sdk.json.c, Comparable<AttributeRef> {
    ...
    public static AttributeRef b(String str) {
        ...
        return new AttributeRef(q2.f93563c + str.replace("~", "~0").replace(q2.f93563c, "~1"), str, null);
    }

    public static AttributeRef e(String str) {
        if (str == null || str.isEmpty() || str.equals(q2.f93563c)) {
        ...
        String[] strArrSplit = str.substring(1).split(q2.f93563c);
