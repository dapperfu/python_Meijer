...
public class Question extends IncludedContentBase.ProductIncludedContentBase {
    ...
    @InterfaceC16127c("AnswerIds")
    private List<String> answerIds;
    private transient List<Answer> answers;

    @InterfaceC16127c("IsSyndicated")
    private boolean isSyndicated;

    @InterfaceC16127c("QuestionDetails")
    private String questionDetails;

    @InterfaceC16127c("QuestionSummary")
    private String questionSummary;

    @InterfaceC16127c(alternate = {"sourceClient"}, value = "SourceClient")
    private String sourceClient;

    @InterfaceC16127c("SyndicationSource")
    ...
    @InterfaceC16127c("TotalInappropriateFeedbackCount")
