...
class BasicRequestFactory implements RequestFactory {
    ...
    private Request createFromPhotoUploadRequest(PhotoUploadRequest photoUploadRequest) {
        ...
        aVar2.f(k.f154714k).a(kAPI_VERSION, API_VERSION).a(kPASS_KEY, this.convApiKey).a("contenttype", photoUpload.getContentType().getKey()).b("photo", "photo.jpg", RequestBody.create(MEDIA_TYPE_JPG, photoUpload.getPhotoFile()));
        k kVarE = aVar2.e();
        HttpUrl httpUrlG = aVarD.g();
        Headers.a aVar3 = new Headers.a();
        addCommonHeaders(aVar3, this.bvSdkUserAgent);
    ...
    private Request createFromVideoUploadRequest(VideoUploadRequest videoUploadRequest) {
        ...
        aVar2.f(k.f154714k).a(kAPI_VERSION, API_VERSION).a(kPASS_KEY, this.convApiKey).a("contenttype", videoUpload.getContentType().getKey()).b("video", "video.mp4", RequestBody.create(MEDIA_TYPE_VIDEO, videoUpload.getVideoFile()));
        k kVarE = aVar2.e();
        HttpUrl httpUrlG = aVarD.g();
        Headers.a aVar3 = new Headers.a();
        addCommonHeaders(aVar3, this.bvSdkUserAgent);
