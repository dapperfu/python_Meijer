...
class IncludedContentBase<ConversationsIncludeType extends ConversationsInclude> extends IncludeableContent<ConversationsIncludeType> {
    ...
    @InterfaceC16127c(alternate = {"additionalFields"}, value = "AdditionalFields")
    private Map<String, Object> additionalFields;

    @InterfaceC16127c(alternate = {"authorId"}, value = "AuthorId")
    private String authorId;

    @InterfaceC16127c(alternate = {"badges"}, value = "Badges")
    private Map<String, Badge> badges;

    @InterfaceC16127c(alternate = {"campaignId"}, value = "CampaignId")
    private String campaignId;

    @InterfaceC16127c(alternate = {"contentLocale"}, value = "ContentLocale")
    private String contentLocale;

    @InterfaceC16127c(alternate = {"contextDataValues"}, value = "ContextDataValues")
    ...
    private String f63853id;

    @InterfaceC16127c(alternate = {"isFeatured"}, value = "IsFeatured")
    private Boolean isFeatured;
    private transient Date lastModeratedDate;

    @InterfaceC16127c(alternate = {"lastModeratedTime"}, value = "LastModeratedTime")
    private String lastModeratedTime;
    private transient Date lastModificationDate;

    @InterfaceC16127c(alternate = {"lastModificationTime"}, value = "LastModificationTime")
    private String lastModificationTime;

    @InterfaceC16127c(alternate = {"moderationStatus"}, value = "ModerationStatus")
    private String moderationStatus;

    @InterfaceC16127c(alternate = {"photos"}, value = "Photos")
    private List<Photo> photos;

    @InterfaceC16127c(alternate = {"productRecommendationIds"}, value = "ProductRecommendationIds")
    private List<String> productRecommendationIds;
    private transient Date submissionDate;

    @InterfaceC16127c(alternate = {"submissionId", "submissionID"}, value = "SubmissionId")
    private String submissionId;

    @InterfaceC16127c(alternate = {"submissionTime"}, value = "SubmissionTime")
    private String submissionTime;

    @InterfaceC16127c(alternate = {"totalFeedbackCount"}, value = "TotalFeedbackCount")
    private Integer totalFeedbackCount;

    @InterfaceC16127c(alternate = {"totalNegativeFeedbackCount"}, value = "TotalNegativeFeedbackCount")
    private Integer totalNegativeFeedbackCount;

    @InterfaceC16127c(alternate = {"totalPositiveFeedbackCount"}, value = "TotalPositiveFeedbackCount")
    private Integer totalPositiveFeedbackCount;

    @InterfaceC16127c(alternate = {"userLocation"}, value = "UserLocation")
    private String userLocation;

    @InterfaceC16127c(alternate = {"userNickname"}, value = "UserNickname")
    private String userNickname;

    @InterfaceC16127c(alternate = {"videos"}, value = "Videos")
    private List<Videos> videos;

    static class ProductIncludedContentBase extends IncludedContentBase {
        private transient Product product;

        @InterfaceC16127c(alternate = {"productExternalID"}, value = "ProductId")
