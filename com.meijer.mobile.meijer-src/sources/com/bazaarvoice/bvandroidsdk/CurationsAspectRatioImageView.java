...
public final class CurationsAspectRatioImageView extends AppCompatImageView {
    ...
    public CurationsAspectRatioImageView(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, d.f25696u);
        this.widthRatio = typedArrayObtainStyledAttributes.getInteger(d.f25698w, 1);
        this.heightRatio = typedArrayObtainStyledAttributes.getInteger(d.f25697v, 1);
