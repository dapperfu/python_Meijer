...
class CurationsInfiniteAdapter extends RecyclerView.h<RecyclerView.F> {
    ...
    private static class CurationsInfiniteViewHolder extends RecyclerView.F {
        ...
        CurationsInfiniteViewHolder(View view) {
            ...
            this.imageView = (CurationsAspectRatioImageView) curationsView.findViewById(b.f25644c);
            this.brandImageView = (ImageView) this.container.findViewById(b.f25642a);
        }
    }
    ...
    public RecyclerView.F onCreateViewHolder(ViewGroup viewGroup, int i10) {
        ...
        int i12;
        int i13;
        CurationsView curationsView = (CurationsView) LayoutInflater.from(viewGroup.getContext()).inflate(c.f25645a, viewGroup, false);
        RelativeLayout relativeLayout = (RelativeLayout) curationsView.findViewById(b.f25643b);
        ((CurationsAspectRatioImageView) curationsView.findViewById(b.f25644c)).setRatio(this.viewProps.getCurationCellWidthRatio(), this.viewProps.getCurationCellHeightRatio());
