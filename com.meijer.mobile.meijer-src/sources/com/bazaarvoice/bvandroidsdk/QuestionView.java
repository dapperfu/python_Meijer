...
public final class QuestionView extends ConversationsUgcView {
    ...
    QuestionView(Context context, AttributeSet attributeSet) {
    ...
    QuestionView(Context context, AttributeSet attributeSet, int i10) {
    ...
    QuestionView(Context context, AttributeSet attributeSet, int i10, int i11) {
