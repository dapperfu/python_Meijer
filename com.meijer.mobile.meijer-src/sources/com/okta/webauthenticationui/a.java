...
public final class a implements InterfaceC13885i {
    ...
    private volatile InterfaceC13887k webAuthenticationProvider;
    ...
    static final class C1976a extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {

        /* renamed from: a, reason: collision with root package name */
        int f120850a;

        C1976a(Continuation<? super C1976a> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return a.this.new C1976a(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(InterfaceC15783O interfaceC15783O, Continuation<? super Unit> continuation) {
            return ((C1976a) create(interfaceC15783O, continuation)).invokeSuspend(Unit.f143329a);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Object invokeSuspend(Object obj) {
            Object objF = IntrinsicsKt.f();
            int i10 = this.f120850a;
            if (i10 != 0) {
                if (i10 == 1) {
                    ResultKt.b(obj);
                } else {
    ...
    static final class d extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f120855b = obj;
            this.f120857d |= Integer.MIN_VALUE;
    ...
    public a(InterfaceC15783O coroutineScope) {
    ...
    public void a(Uri uri) {
        ...
        if (uri == null) {
            this.emitErrorJob = C15809k.d(this.coroutineScope, null, null, new C1976a(null), 3, null);
            return;
        }
    ...
    public boolean c(Context context, HttpUrl url) {
        ...
        InterfaceC13887k interfaceC13887k = this.webAuthenticationProvider;
        this.webAuthenticationProvider = null;
        if (interfaceC13887k == null) {
            k(new IllegalStateException("RedirectListener has not been initialized."));
            return false;
        }
        Exception excA = interfaceC13887k.a(context, url);
        if (excA == null) {
            return true;
        }
        k(excA);
    ...
    */
    public java.lang.Object e(kotlin.coroutines.Continuation<? super com.okta.webauthenticationui.c<?>> r6) {
        ...
        L13:
            ...
            r0.<init>(r6)
        L18:
            java.lang.Object r6 = r0.f120855b
            ...
            if (r2 == 0) goto L36
            if (r2 != r4) goto L2e
            java.lang.Object r0 = r0.f120854a
    ...
    public Object b(Continuation<? super com.okta.webauthenticationui.d> continuation) {
        ...
        c15819p.C();
        c15819p.F(new c());
        this.redirectContinuation = c15819p;
    ...
    public <T> Object d(InterfaceC13887k interfaceC13887k, Context context, Function1<? super Continuation<? super com.okta.webauthenticationui.c<T>>, ? extends Object> function1, Continuation<? super com.okta.webauthenticationui.c<T>> continuation) {
        ...
        E0.i(continuation.getContext());
        this.webAuthenticationProvider = interfaceC13887k;
        this.initializer = function1;
        if ((context instanceof ComponentActivity) && !((ComponentActivity) context).getLifecycle().getState().b(AbstractC6165l.b.f55502d)) {
        ...
        c15819p.C();
        c15819p.F(new b());
        this.initializationContinuation = c15819p;
