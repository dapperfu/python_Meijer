...
abstract class e<C extends Collection<T>, T> extends h<C> {
    ...
    public static final h.e f127288b = new a();

    /* renamed from: a, reason: collision with root package name */
    private final h<T> f127289a;
    ...
    public String toString() {
        return this.f127289a + ".collection()";
    }
    ...
    public C a(k kVar) throws IOException {
        ...
        kVar.a();
        while (kVar.hasNext()) {
            c10.add(this.f127289a.fromJson(kVar));
        }
        kVar.c();
        return c10;
    }
    ...
    public void e(q qVar, C c10) throws IOException {
        ...
        while (it.hasNext()) {
            this.f127289a.toJson(qVar, (q) it.next());
        }
        qVar.d();
    }
}
