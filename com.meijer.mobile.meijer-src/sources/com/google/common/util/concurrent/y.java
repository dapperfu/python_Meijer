...
final class y implements Executor {
    ...
    private static final p f88953f = new p(y.class);

    /* renamed from: a, reason: collision with root package name */
    private final Executor f88954a;

    /* renamed from: b, reason: collision with root package name */
    private final Deque<Runnable> f88955b = new ArrayDeque();

    /* renamed from: c, reason: collision with root package name */
    private c f88956c = c.IDLE;

    /* renamed from: d, reason: collision with root package name */
    private long f88957d = 0;

    /* renamed from: e, reason: collision with root package name */
    private final b f88958e = new b(this, null);

    class a implements Runnable {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Runnable f88959a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ y f88960b;

        a(y yVar, Runnable runnable) {
            this.f88959a = runnable;
            this.f88960b = yVar;
        }
    ...
    private final class b implements Runnable {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:32:0x005d, code lost:
            ...
            com.google.common.util.concurrent.y.f88953f.a().log(java.util.logging.Level.SEVERE, "Exception while executing runnable " + r8.f88961a, (java.lang.Throwable) r3);
         */
        ...
        */
        private void a() {
            ...
            L2d:
                ...
                r8.f88961a = r3     // Catch: java.lang.Throwable -> L20
                if (r3 != 0) goto L49
                com.google.common.util.concurrent.y r0 = com.google.common.util.concurrent.y.this     // Catch: java.lang.Throwable -> L20
            ...
            L49:
                ...
                r1 = r1 | r2
                r2 = 0
                java.lang.Runnable r3 = r8.f88961a     // Catch: java.lang.Throwable -> L5a java.lang.Exception -> L5c
                r3.run()     // Catch: java.lang.Throwable -> L5a java.lang.Exception -> L5c
            L55:
                r8.f88961a = r2     // Catch: java.lang.Throwable -> L58
                goto L2
            L58:
                r0 = move-exception
                goto L83
            ...
            L5c:
                ...
                java.lang.Runnable r7 = r8.f88961a     // Catch: java.lang.Throwable -> L5a
                r6.append(r7)     // Catch: java.lang.Throwable -> L5a
        ...
        public String toString() {
            Runnable runnable = this.f88961a;
            if (runnable != null) {
                return "SequentialExecutorWorker{running=" + runnable + "}";
            }
            return "SequentialExecutorWorker{state=" + y.this.f88956c + "}";
        }
        ...
        public void run() {
            try {
                ...
                synchronized (y.this.f88955b) {
                    y.this.f88956c = c.IDLE;
                    throw e10;
                }
            }
        }
    ...
    static /* synthetic */ long d(y yVar) {
        long j10 = yVar.f88957d;
        yVar.f88957d = 1 + j10;
        return j10;
    }

    public String toString() {
        return "SequentialExecutor@" + System.identityHashCode(this) + "{" + this.f88954a + "}";
    }

    y(Executor executor) {
        this.f88954a = (Executor) De.p.q(executor);
    }
    ...
    */
    public void execute(java.lang.Runnable r8) {
        /*
            r7 = this;
            De.p.q(r8)
            java.util.Deque<java.lang.Runnable> r0 = r7.f88955b
            monitor-enter(r0)
            com.google.common.util.concurrent.y$c r1 = r7.f88956c     // Catch: java.lang.Throwable -> L6b
            ...
            goto L6d
        L11:
            long r3 = r7.f88957d     // Catch: java.lang.Throwable -> L6b
            ...
            java.util.Deque<java.lang.Runnable> r8 = r7.f88955b     // Catch: java.lang.Throwable -> L6b
            ...
            r7.f88956c = r8     // Catch: java.lang.Throwable -> L6b
            monitor-exit(r0)     // Catch: java.lang.Throwable -> L6b
            java.util.concurrent.Executor r0 = r7.f88954a     // Catch: java.lang.Throwable -> L44
            com.google.common.util.concurrent.y$b r5 = r7.f88958e     // Catch: java.lang.Throwable -> L44
            r0.execute(r5)     // Catch: java.lang.Throwable -> L44
            com.google.common.util.concurrent.y$c r0 = r7.f88956c
            if (r0 == r8) goto L2e
            return
        L2e:
            java.util.Deque<java.lang.Runnable> r0 = r7.f88955b
            monitor-enter(r0)
            long r5 = r7.f88957d     // Catch: java.lang.Throwable -> L3e
            int r1 = (r5 > r3 ? 1 : (r5 == r3 ? 0 : -1))
            if (r1 != 0) goto L40
            com.google.common.util.concurrent.y$c r1 = r7.f88956c     // Catch: java.lang.Throwable -> L3e
            if (r1 != r8) goto L40
            r7.f88956c = r2     // Catch: java.lang.Throwable -> L3e
            goto L40
        L3e:
            r8 = move-exception
            goto L42
        ...
        L44:
            r8 = move-exception
            java.util.Deque<java.lang.Runnable> r2 = r7.f88955b
            monitor-enter(r2)
            com.google.common.util.concurrent.y$c r0 = r7.f88956c     // Catch: java.lang.Throwable -> L53
        ...
        L53:
            ...
            goto L69
        L55:
            java.util.Deque<java.lang.Runnable> r0 = r7.f88955b     // Catch: java.lang.Throwable -> L53
        ...
        L6b:
            ...
            goto L74
        L6d:
            java.util.Deque<java.lang.Runnable> r1 = r7.f88955b     // Catch: java.lang.Throwable -> L6b
