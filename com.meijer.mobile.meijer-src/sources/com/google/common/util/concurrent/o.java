...
abstract class o<T> extends AtomicReference<Runnable> implements Runnable {
    ...
    private static final Runnable f88941a;

    /* renamed from: b, reason: collision with root package name */
    private static final Runnable f88942b;

    static final class b extends AbstractOwnableSynchronizer implements Runnable {

        /* renamed from: a, reason: collision with root package name */
        private final o<?> f88943a;
        ...
        if (compareAndSet(null, threadCurrentThread)) {
            ...
            if (!zF) {
                try {
                    ...
                    try {
                        x.a(th2);
                        if (!compareAndSet(threadCurrentThread, f88941a)) {
