...
public class PlaceDetailsRequest extends PendingResultBase<PlaceDetails, PlaceDetailsRequest, Response> {
    static final ApiConfig API_CONFIG = new ApiConfig("/maps/api/place/details/json").fieldNamingPolicy(com.google.gson.c.f90262e);
    ...
    public PlaceDetailsRequest reviewsNoTranslations(boolean z10) {
        return param("reviews_no_translations", String.valueOf(z10));
    }

    public PlaceDetailsRequest reviewsSort(String str) {
        return param("reviews_sort", str);
    }
