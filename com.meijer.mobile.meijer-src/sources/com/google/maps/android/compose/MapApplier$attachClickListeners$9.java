...
@Metadata(d1 = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0017\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0005\u0010\u0006J\u0017\u0010\u0007\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0007\u0010\u0006J\u0017\u0010\b\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\b\u0010\u0006¨\u0006\t"}, d2 = {"com/google/maps/android/compose/MapApplier$attachClickListeners$9", "LMd/c$q;", "LOd/n;", "marker", "", "onMarkerDragStart", "(LOd/n;)V", "onMarkerDrag", "onMarkerDragEnd", "maps-compose_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
@SourceDebugExtension
/* loaded from: classes8.dex */
public final class MapApplier$attachClickListeners$9 implements C4110c.q {
    ...
    public static final Unit onMarkerDrag$lambda$6$lambda$5(MarkerNode markerNode, C4466n it) {
        Intrinsics.j(it, "it");
        LatLng latLngB = it.b();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit onMarkerDragEnd$lambda$10$lambda$9(MarkerNode markerNode, C4466n it) {
        Intrinsics.j(it, "it");
        LatLng latLngB = it.b();
        Intrinsics.i(latLngB, "getPosition(...)");
        markerNode.getMarkerState().setDragging$maps_compose_release(true);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit onMarkerDragStart$lambda$2$lambda$1(MarkerNode markerNode, C4466n it) {
        Intrinsics.j(it, "it");
        LatLng latLngB = it.b();
        Intrinsics.i(latLngB, "getPosition(...)");
        markerNode.getMarkerState().setDragging$maps_compose_release(true);
    ...
    public void onMarkerDrag(C4466n marker) {
        ...
        for (MapNode mapNode : this.this$0.decorations) {
                ...
                if (Intrinsics.e(markerNode.getMarker(), marker)) {
                    if (Intrinsics.e(new Function1() { // from class: com.google.maps.android.compose.o0
                        ...
                        public final Object invoke(Object obj) {
                            return MapApplier$attachClickListeners$9.onMarkerDrag$lambda$6$lambda$5(markerNode, (C4466n) obj);
                        }
            ...
            if (mapNode instanceof InputHandlerNode) {
                Function1<C4466n, Unit> onMarkerDrag = ((InputHandlerNode) mapNode).getOnMarkerDrag();
    ...
    public void onMarkerDragEnd(C4466n marker) {
        ...
        for (MapNode mapNode : this.this$0.decorations) {
            if (mapNode instanceof MarkerNode) {
                ...
                if (Intrinsics.e(markerNode.getMarker(), marker)) {
                    if (Intrinsics.e(new Function1() { // from class: com.google.maps.android.compose.p0
                        @Override // kotlin.jvm.functions.Function1
                        public final Object invoke(Object obj) {
                            return MapApplier$attachClickListeners$9.onMarkerDragEnd$lambda$10$lambda$9(markerNode, (C4466n) obj);
                        }
                    }.invoke(marker), Boolean.TRUE)) {
                        return;
                    }
            ...
            if (mapNode instanceof InputHandlerNode) {
                Function1<C4466n, Unit> onMarkerDragEnd = ((InputHandlerNode) mapNode).getOnMarkerDragEnd();
    ...
    public void onMarkerDragStart(C4466n marker) {
        ...
        for (MapNode mapNode : this.this$0.decorations) {
            if (mapNode instanceof MarkerNode) {
                ...
                if (Intrinsics.e(markerNode.getMarker(), marker)) {
                    if (Intrinsics.e(new Function1() { // from class: com.google.maps.android.compose.q0
                        @Override // kotlin.jvm.functions.Function1
                        public final Object invoke(Object obj) {
                            return MapApplier$attachClickListeners$9.onMarkerDragStart$lambda$2$lambda$1(markerNode, (C4466n) obj);
                        }
                    }.invoke(marker), Boolean.TRUE)) {
                        return;
                    }
            ...
            if (mapNode instanceof InputHandlerNode) {
                Function1<C4466n, Unit> onMarkerDragStart = ((InputHandlerNode) mapNode).getOnMarkerDragStart();
