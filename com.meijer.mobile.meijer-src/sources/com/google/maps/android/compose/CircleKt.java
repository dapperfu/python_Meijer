...
public final class CircleKt {
    ...
    */
    public static final void m43CirclerQ_Q3OA(final com.google.android.gms.maps.model.LatLng r36, boolean r37, long r38, double r40, long r42, java.util.List<? extends Od.C4468p> r44, float r45, java.lang.Object r46, boolean r47, float r48, kotlin.jvm.functions.Function1<? super Od.C4459g, kotlin.Unit> r49, androidx.compose.runtime.Composer r50, final int r51, final int r52, final int r53) {
        /*
            Method dump skipped, instructions count: 922
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.maps.android.compose.CircleKt.m43CirclerQ_Q3OA(com.google.android.gms.maps.model.LatLng, boolean, long, double, long, java.util.List, float, java.lang.Object, boolean, float, kotlin.jvm.functions.Function1, androidx.compose.runtime.Composer, int, int, int):void");
    }
    ...
    public static final Unit Circle_rQ_Q3OA$lambda$15(LatLng latLng, boolean z10, long j10, double d10, long j11, List list, float f10, Object obj, boolean z11, float f11, Function1 function1, int i10, int i11, int i12, Composer composer, int i13) {
        m43CirclerQ_Q3OA(latLng, z10, j10, d10, j11, list, f10, obj, z11, f11, function1, composer, androidx.compose.runtime.J0.a(i10 | 1), androidx.compose.runtime.J0.a(i11), i12);
        return Unit.f143329a;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit Circle_rQ_Q3OA$lambda$1$lambda$0(C4459g it) {
        Intrinsics.j(it, "it");
        return Unit.f143329a;
    }
    ...
    public static final CircleNode Circle_rQ_Q3OA$lambda$4$lambda$3(MapApplier mapApplier, Object obj, Function1 function1, LatLng latLng, boolean z10, long j10, double d10, long j11, List list, float f10, boolean z11, float f11) {
        ...
        if (mapApplier != null && (map = mapApplier.getMap()) != null) {
            ...
            c4460h.B(latLng);
            c4460h.T(z10);
            c4460h.b0(C5492s0.j(j10));
            c4460h.c2(d10);
            c4460h.j2(C5492s0.j(j11));
            c4460h.H2(list);
            c4460h.L2(f10);
            c4460h.N2(z11);
            c4460h.U2(f11);
            C4459g c4459gA = map.a(c4460h);
            Intrinsics.i(c4459gA, "addCircle(...)");
            if (c4459gA != null) {
                c4459gA.i(obj);
                return new CircleNode(c4459gA, function1);
            }
        }
