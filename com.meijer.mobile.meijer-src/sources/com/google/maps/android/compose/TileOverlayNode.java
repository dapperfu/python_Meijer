...
final class TileOverlayNode implements MapNode {
    ...
    public final Function1<Od.F, Unit> getOnTileOverlayClick() {
        return this.onTileOverlayClick;
    }

    public final Od.F getTileOverlay() {
    ...
    public final void setOnTileOverlayClick(Function1<? super Od.F, Unit> function1) {
        Intrinsics.j(function1, "<set-?>");
        this.onTileOverlayClick = function1;
    }

    public final void setTileOverlay(Od.F f10) {
