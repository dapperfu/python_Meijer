...
public final class MapProperties {
    ...
    private final C4465m mapStyleOptions;
    ...
    public MapProperties(boolean z10, boolean z11, boolean z12, boolean z13, LatLngBounds latLngBounds, C4465m c4465m, MapType mapType, float f10, float f11) {
        ...
        this.mapStyleOptions = c4465m;
        this.mapType = mapType;
        this.maxZoomPreference = f10;
        this.minZoomPreference = f11;
    }

    public static /* synthetic */ MapProperties copy$default(MapProperties mapProperties, boolean z10, boolean z11, boolean z12, boolean z13, LatLngBounds latLngBounds, C4465m c4465m, MapType mapType, float f10, float f11, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        if ((i10 & 32) != 0) {
            c4465m = mapProperties.mapStyleOptions;
        }
        if ((i10 & 64) != 0) {
        ...
        float f12 = f10;
        float f13 = f11;
        C4465m c4465m2 = c4465m;
        MapType mapType2 = mapType;
        LatLngBounds latLngBounds2 = latLngBounds;
        boolean z14 = z12;
        return mapProperties.copy(z10, z11, z14, z13, latLngBounds2, c4465m2, mapType2, f12, f13);
    }

    public final MapProperties copy(boolean isBuildingEnabled, boolean isIndoorEnabled, boolean isMyLocationEnabled, boolean isTrafficEnabled, LatLngBounds latLngBoundsForCameraTarget, C4465m mapStyleOptions, MapType mapType, float maxZoomPreference, float minZoomPreference) {
        Intrinsics.j(mapType, "mapType");
    ...
    public final C4465m getMapStyleOptions() {
    ...
    public /* synthetic */ MapProperties(boolean z10, boolean z11, boolean z12, boolean z13, LatLngBounds latLngBounds, C4465m c4465m, MapType mapType, float f10, float f11, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this((i10 & 1) != 0 ? false : z10, (i10 & 2) != 0 ? false : z11, (i10 & 4) != 0 ? false : z12, (i10 & 8) != 0 ? false : z13, (i10 & 16) != 0 ? null : latLngBounds, (i10 & 32) != 0 ? null : c4465m, (i10 & 64) != 0 ? MapType.NORMAL : mapType, (i10 & 128) != 0 ? 21.0f : f10, (i10 & 256) != 0 ? 3.0f : f11);
    }
}
