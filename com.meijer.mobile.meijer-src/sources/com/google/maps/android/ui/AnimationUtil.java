...
public class AnimationUtil {
    ...
    interface LatLngInterpolator {
        ...
        public static class Linear implements LatLngInterpolator {
            ...
            public LatLng interpolate(float f10, LatLng latLng, LatLng latLng2) {
                ...
                double dSignum = latLng2.f85655b - latLng.f85655b;
                if (Math.abs(dSignum) > 180.0d) {
                    dSignum -= Math.signum(dSignum) * 360.0d;
                }
                return new LatLng(d13, (dSignum * d12) + latLng.f85655b);
            }
        }
    ...
    public static void animateMarkerTo(C4466n c4466n, LatLng latLng) {
        animateMarkerTo(c4466n, latLng, 2000L);
    }

    public static void animateMarkerTo(final C4466n c4466n, final LatLng latLng, final long j10) {
        final LatLngInterpolator.Linear linear = new LatLngInterpolator.Linear();
        final LatLng latLngB = c4466n.b();
        ...
        handler.post(new Runnable() { // from class: com.google.maps.android.ui.AnimationUtil.1
            ...
            public void run() {
                ...
                this.f91227v = interpolation;
                c4466n.n(linear.interpolate(interpolation, latLngB, latLng));
                if (this.f91226t < 1.0f) {
