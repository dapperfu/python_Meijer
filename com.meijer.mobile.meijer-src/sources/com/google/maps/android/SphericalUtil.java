...
public class SphericalUtil {
    ...
    static double computeAngleBetween(LatLng latLng, LatLng latLng2) {
        return distanceRadians(Math.toRadians(latLng.f85654a), Math.toRadians(latLng.f85655b), Math.toRadians(latLng2.f85654a), Math.toRadians(latLng2.f85655b));
    }
    ...
    public static double computeHeading(LatLng latLng, LatLng latLng2) {
        ...
        double radians4 = Math.toRadians(latLng2.f85655b) - radians2;
    ...
    public static LatLng computeOffsetOrigin(LatLng latLng, double d10, double d11) {
        ...
        double dSin3 = Math.sin(Math.toRadians(latLng.f85654a));
        ...
        return new LatLng(Math.toDegrees(dAtan2), Math.toDegrees(Math.toRadians(latLng.f85655b) - Math.atan2(dSin2, (dCos * Math.cos(dAtan2)) - (dSin * Math.sin(dAtan2)))));
    }
    ...
    static double computeSignedArea(List<LatLng> list, double d10) {
        ...
        double dTan = Math.tan((1.5707963267948966d - Math.toRadians(latLng.f85654a)) / 2.0d);
        double radians = Math.toRadians(latLng.f85655b);
        double d11 = dTan;
        double d12 = radians;
        for (LatLng latLng2 : list) {
            double dTan2 = Math.tan((1.5707963267948966d - Math.toRadians(latLng2.f85654a)) / 2.0d);
            double radians2 = Math.toRadians(latLng2.f85655b);
    ...
    public static LatLng interpolate(LatLng latLng, LatLng latLng2, double d10) {
        ...
        if (dSin < 1.0E-6d) {
            ...
            double d12 = d11 + ((latLng2.f85654a - d11) * d10);
            double d13 = latLng.f85655b;
            return new LatLng(d12, d13 + ((latLng2.f85655b - d13) * d10));
        }
    ...
    public static double computeLength(List<LatLng> list) {
        ...
        for (LatLng latLng2 : list) {
            if (latLng != null) {
                dDistanceRadians += distanceRadians(Math.toRadians(latLng.f85654a), Math.toRadians(latLng.f85655b), Math.toRadians(latLng2.f85654a), Math.toRadians(latLng2.f85655b));
            }
            latLng = latLng2;
        }
    ...
    public static LatLng computeOffset(LatLng latLng, double d10, double d11) {
        double d12 = d10 / 6371009.0d;
        double radians = Math.toRadians(d11);
        double radians2 = Math.toRadians(latLng.f85654a);
        double radians3 = Math.toRadians(latLng.f85655b);
        double dCos = Math.cos(d12);
