...
public class J {
    static void A(String str, Bundle bundle) {
        try {
            ...
            InterfaceC6375a interfaceC6375a = (InterfaceC6375a) com.google.firebase.f.l().j(InterfaceC6375a.class);
            if (interfaceC6375a != null) {
                interfaceC6375a.a("fcm", str, bundle2);
            } else {
    ...
    private static void B(Bundle bundle) {
        ...
        interfaceC6375a.b("fcm", "_ln", string);
        Bundle bundle2 = new Bundle();
        bundle2.putString("source", "Firebase");
        bundle2.putString("medium", "notification");
        bundle2.putString("campaign", string);
        interfaceC6375a.a("fcm", "_cmp", bundle2);
    }
    ...
    static Rf.a b(a.b bVar, Intent intent) {
        if (intent == null) {
            return null;
        }
        ...
        a.C0737a c0737aJ = Rf.a.p().n(s(extras)).e(bVar).f(f(extras)).i(o()).l(a.d.ANDROID).h(m(extras)).j(k(extras));
    ...
    static String f(Bundle bundle) {
        ...
        try {
            return (String) C5519m.a(com.google.firebase.installations.c.q(com.google.firebase.f.l()).getId());
    ...
    static a.c m(Bundle bundle) {
        return (bundle == null || !L.t(bundle)) ? a.c.DATA_MESSAGE : a.c.DISPLAY_NOTIFICATION;
    }
    ...
    private static void z(a.b bVar, Intent intent, InterfaceC16890j interfaceC16890j) {
        ...
        Rf.a aVarB = b(bVar, intent);
        if (aVarB == null) {
            return;
        }
        try {
            interfaceC16890j.a("FCM_CLIENT_EVENT_LOGGING", Rf.b.class, C16883c.b("proto"), new InterfaceC16888h() { // from class: com.google.firebase.messaging.I
                @Override // rc.InterfaceC16888h
                public final Object apply(Object obj) {
                    return ((Rf.b) obj).c();
                }
            }).b(AbstractC16884d.g(Rf.b.b().b(aVarB).a(), AbstractC16887g.b(Integer.valueOf(intent.getIntExtra("google.product_id", 111881503)))));
    ...
    public static void y(Intent intent) {
        ...
        if (C(intent)) {
            z(a.b.MESSAGE_DELIVERED, intent, FirebaseMessaging.u());
        }
    }
}
