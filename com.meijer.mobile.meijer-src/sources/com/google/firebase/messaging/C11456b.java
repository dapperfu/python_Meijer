...
final class C11456b {
    ...
    private static final class a extends FilterInputStream implements InputStreamRetargetInterface {
        ...
        private long f89727a;

        /* renamed from: b, reason: collision with root package name */
        private long f89728b;

        @Override // java.io.FilterInputStream, java.io.InputStream
        public synchronized void mark(int i10) {
            ((FilterInputStream) this).in.mark(i10);
            this.f89728b = this.f89727a;
        }
        ...
        public int available() throws IOException {
            return (int) Math.min(((FilterInputStream) this).in.available(), this.f89727a);
        }

        @Override // java.io.FilterInputStream, java.io.InputStream
        public long skip(long j10) throws IOException {
            long jSkip = ((FilterInputStream) this).in.skip(Math.min(j10, this.f89727a));
            this.f89727a -= jSkip;
            return jSkip;
        }
