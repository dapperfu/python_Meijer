...
public class ConfigFetchHttpClient {
    ...
    private static final Pattern f90023h = Pattern.compile("^[^:]+:([0-9]+):(android|ios|web):([0-9a-f]+)");

    /* renamed from: a, reason: collision with root package name */
    private final Context f90024a;
    ...
    private final long f90029f;

    /* renamed from: g, reason: collision with root package name */
    private final long f90030g;
    ...
    private void m(HttpURLConnection httpURLConnection, String str, String str2, Map<String, String> map) {
        ...
        httpURLConnection.setConnectTimeout((int) timeUnit.toMillis(this.f90029f));
        httpURLConnection.setReadTimeout((int) timeUnit.toMillis(this.f90030g));
    ...
    private JSONObject c(String str, String str2, Map<String, String> map, Long l10, Map<String, String> map2) throws PackageManager.NameNotFoundException, FirebaseRemoteConfigClientException {
        ...
        map3.put("appId", this.f90025b);
        Locale locale = this.f90024a.getResources().getConfiguration().locale;
        ...
        try {
            PackageInfo packageInfo = this.f90024a.getPackageManager().getPackageInfo(this.f90024a.getPackageName(), 0);
            if (packageInfo != null) {
                map3.put("appVersion", packageInfo.versionName);
                map3.put("appBuild", Long.toString(C5642a.a(packageInfo)));
            }
        } catch (PackageManager.NameNotFoundException unused) {
        }
        map3.put("packageName", this.f90024a.getPackageName());
    ...
    private static String f(String str) {
        Matcher matcher = f90023h.matcher(str);
        if (matcher.matches()) {
    ...
    private String i() {
        try {
            ...
            FS.log_e("FirebaseRemoteConfig", "Could not get fingerprint hash for package: " + this.f90024a.getPackageName());
            return null;
        } catch (PackageManager.NameNotFoundException e10) {
            FS.log_e("FirebaseRemoteConfig", "No such package: " + this.f90024a.getPackageName(), e10);
            return null;
        }
    }

    private void j(HttpURLConnection httpURLConnection, String str) {
        httpURLConnection.setRequestProperty("X-Goog-Api-Key", this.f90026c);
        httpURLConnection.setRequestProperty(HttpHeaders.X_ANDROID_PACKAGE, this.f90024a.getPackageName());
    ...
    HttpURLConnection d() throws FirebaseRemoteConfigException {
        try {
            return (HttpURLConnection) FS.urlconnection_wrapInstance(new URL(h(this.f90027d, this.f90028e)).openConnection());
