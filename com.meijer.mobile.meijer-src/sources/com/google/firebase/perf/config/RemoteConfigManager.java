...
public class RemoteConfigManager {
    ...
    private final ConcurrentHashMap<String, fg.j> allRcConfigMap;
    ...
    private Kf.b<com.google.firebase.remoteconfig.c> firebaseRemoteConfigProvider;
    ...
    public cg.g<Boolean> getBoolean(String str) {
        if (str == null) {
            logger.a("The key to get Remote Config boolean value is null.");
            return cg.g.a();
        }
        fg.j remoteConfigValue = getRemoteConfigValue(str);
        if (remoteConfigValue != null) {
            try {
                return cg.g.e(Boolean.valueOf(remoteConfigValue.asBoolean()));
    ...
    public cg.g<Double> getDouble(String str) {
        if (str == null) {
        ...
        if (remoteConfigValue != null) {
            try {
                return cg.g.e(Double.valueOf(remoteConfigValue.i()));
            } catch (IllegalArgumentException unused) {
                if (!remoteConfigValue.asString().isEmpty()) {
                    logger.b("Could not parse value: '%s' for key: '%s'.", remoteConfigValue.asString(), str);
                }
    ...
    public cg.g<Long> getLong(String str) {
        if (str == null) {
        ...
        if (remoteConfigValue != null) {
            try {
                return cg.g.e(Long.valueOf(remoteConfigValue.h()));
            } catch (IllegalArgumentException unused) {
                if (!remoteConfigValue.asString().isEmpty()) {
                    logger.b("Could not parse value: '%s' for key: '%s'.", remoteConfigValue.asString(), str);
                }
    ...
    public cg.g<String> getString(String str) {
        if (str == null) {
            logger.a("The key to get Remote Config String value is null.");
            return cg.g.a();
        }
        fg.j remoteConfigValue = getRemoteConfigValue(str);
        return remoteConfigValue != null ? cg.g.e(remoteConfigValue.asString()) : cg.g.a();
    }

    public boolean isFirebaseRemoteConfigAvailable() {
        Kf.b<com.google.firebase.remoteconfig.c> bVar;
    ...
    public void setFirebaseRemoteConfigProvider(Kf.b<com.google.firebase.remoteconfig.c> bVar) {
        this.firebaseRemoteConfigProvider = bVar;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public void syncConfigValues(Map<String, fg.j> map) {
        ...
        d dVarE = d.e();
        fg.j jVar = this.allRcConfigMap.get(dVarE.c());
        if (jVar == null) {
    ...
    private fg.j getRemoteConfigValue(String str) {
        triggerRemoteConfigFetchIfNecessary();
        if (isFirebaseRemoteConfigAvailable() && this.allRcConfigMap.containsKey(str)) {
            fg.j jVar = this.allRcConfigMap.get(str);
            if (jVar.g() == 2) {
    ...
    private void triggerFirebaseRemoteConfigFetchAndActivateOnSuccessfulFetch() {
        ...
        this.firebaseRemoteConfig.g().h(this.executor, new InterfaceC5513g() { // from class: com.google.firebase.perf.config.y
            @Override // Vd.InterfaceC5513g
            public final void onSuccess(Object obj) {
                RemoteConfigManager remoteConfigManager = this.f89886a;
                remoteConfigManager.syncConfigValues(remoteConfigManager.firebaseRemoteConfig.h());
            }
        }).f(this.executor, new InterfaceC5512f() { // from class: com.google.firebase.perf.config.z
            @Override // Vd.InterfaceC5512f
            public final void onFailure(Exception exc) {
                RemoteConfigManager.a(this.f89887a, exc);
            }
        });
    }
    ...
    RemoteConfigManager(x xVar, Executor executor, com.google.firebase.remoteconfig.a aVar, long j10, long j11) {
        ConcurrentHashMap<String, fg.j> concurrentHashMap;
