...
public final class z6 extends B3 {
    ...
    private static final String[] f86915i = {"firebase_", "google_", "ga_"};

    /* renamed from: j, reason: collision with root package name */
    private static final String[] f86916j = {"_err"};

    /* renamed from: k, reason: collision with root package name */
    public static final /* synthetic */ int f86917k = 0;

    /* renamed from: c, reason: collision with root package name */
    private SecureRandom f86918c;

    /* renamed from: d, reason: collision with root package name */
    private final AtomicLong f86919d;

    /* renamed from: e, reason: collision with root package name */
    private int f86920e;

    /* renamed from: f, reason: collision with root package name */
    private AbstractC15903a f86921f;

    /* renamed from: g, reason: collision with root package name */
    private Boolean f86922g;

    /* renamed from: h, reason: collision with root package name */
    private Integer f86923h;
    ...
    final boolean A0(String str, String str2, int i10, Object obj) {
        if (obj != null && !(obj instanceof Long) && !(obj instanceof Float) && !(obj instanceof Integer) && !(obj instanceof Byte) && !(obj instanceof Short) && !(obj instanceof Boolean) && !(obj instanceof Double)) {
            ...
            if (string.codePointCount(0, string.length()) > i10) {
                this.f85708a.a().r().d("Value is too long; discarded. Value kind, name, value length", str, str2, Integer.valueOf(string.length()));
                return false;
            }
        }
        return true;
    ...
    public final long W(long j10, long j11) {
        return (j10 + (j11 * l8.b.f93364b)) / l8.b.f93366d;
    }
    ...
    final boolean r0(String str, String str2) {
        if (str2 == null) {
            this.f85708a.a().o().b("Name is required and can't be null. Type", str);
            return false;
        }
        if (str2.length() == 0) {
            this.f85708a.a().o().b("Name is required and can't be empty. Type", str);
            return false;
        }
        int iCodePointAt = str2.codePointAt(0);
        if (!Character.isLetter(iCodePointAt)) {
            this.f85708a.a().o().c("Name must start with a letter. Type, name", str, str2);
            return false;
        }
        ...
        while (iCharCount < length) {
            ...
            if (iCodePointAt2 != 95 && !Character.isLetterOrDigit(iCodePointAt2)) {
                this.f85708a.a().o().c("Name must consist of letters, digits or _ (underscores). Type, name", str, str2);
                return false;
            }
    ...
    final boolean s0(String str, String str2) {
        ...
        if (!Character.isLetter(iCodePointAt)) {
            if (iCodePointAt != 95) {
                this.f85708a.a().o().c("Name must start with a letter or _ (underscore). Type, name", str, str2);
                return false;
            }
            iCodePointAt = 95;
        }
    ...
    final boolean t0(String str, String[] strArr, String[] strArr2, String str2) {
        ...
        String[] strArr3 = f86915i;
        for (int i10 = 0; i10 < 3; i10++) {
            if (str2.startsWith(strArr3[i10])) {
                this.f85708a.a().o().c("Name starts with reserved prefix. Type, name", str, str2);
                return false;
            }
        }
        ...
        this.f85708a.a().o().c("Name is reserved. Type, name", str, str2);
        return false;
    }
    ...
    final boolean u0(String str, int i10, String str2) {
        ...
        this.f85708a.a().o().d("Name is too long. Type, maximum supported length, name", str, Integer.valueOf(i10), str2);
        return false;
    }

    public static boolean S(String str) {
        return !f86916j[0].equals(str);
    }
    ...
    public static ArrayList f0(List list) {
        ...
        while (it.hasNext()) {
            C11282i c11282i = (C11282i) it.next();
            Bundle bundle = new Bundle();
            bundle.putString("app_id", c11282i.f86448a);
            bundle.putString("origin", c11282i.f86449b);
            bundle.putLong("creation_timestamp", c11282i.f86451d);
            bundle.putString("name", c11282i.f86450c.f86766b);
            Qd.t.a(bundle, com.google.android.gms.common.internal.r.l(c11282i.f86450c.B()));
            bundle.putBoolean("active", c11282i.f86452e);
            String str = c11282i.f86453f;
            if (str != null) {
                bundle.putString("trigger_event_name", str);
            }
            G g10 = c11282i.f86454g;
            if (g10 != null) {
                bundle.putString("timed_out_event_name", g10.f85861a);
                E e10 = g10.f85862b;
                if (e10 != null) {
                    bundle.putBundle("timed_out_event_params", e10.U0());
                }
            }
            bundle.putLong("trigger_timeout", c11282i.f86455h);
            G g11 = c11282i.f86456i;
            if (g11 != null) {
                bundle.putString("triggered_event_name", g11.f85861a);
                E e11 = g11.f85862b;
                if (e11 != null) {
                    bundle.putBundle("triggered_event_params", e11.U0());
                }
            }
            bundle.putLong("triggered_timestamp", c11282i.f86450c.f86767c);
            bundle.putLong("time_to_live", c11282i.f86457j);
            G g12 = c11282i.f86458k;
            if (g12 != null) {
                bundle.putString("expired_event_name", g12.f85861a);
                E e12 = g12.f85862b;
                if (e12 != null) {
                    bundle.putBundle("expired_event_params", e12.U0());
                }
            }
    ...
    public static void i0(E4 e42, Bundle bundle, boolean z10) {
        if (bundle != null && e42 != null) {
            if (!bundle.containsKey("_sc") || z10) {
                String str = e42.f85838a;
                if (str != null) {
                    bundle.putString("_sn", str);
                } else {
                    bundle.remove("_sn");
                }
                String str2 = e42.f85839b;
                if (str2 != null) {
                    bundle.putString("_sc", str2);
                } else {
                    bundle.remove("_sc");
                }
                bundle.putLong("_si", e42.f85840c);
                return;
            }
            z10 = false;
        }
    ...
    final void B0(String str, String str2, String str3, Bundle bundle, List list, boolean z10) {
        ...
        X2 x22 = this.f85708a;
        int i10 = true != x22.u().f85708a.A().T(231100000, true) ? 0 : 35;
        int i11 = 0;
        boolean z11 = false;
        for (String str5 : new TreeSet(bundle.keySet())) {
            ...
            if (iX0 != 0) {
                ...
                if (iP != 0 && !"_ev".equals(str5)) {
                    ...
                    bundle.remove(str5);
                } else if (p0(str5) && !M(str5, Qd.x.f28081d)) {
                    i11++;
                    if (!T(231100000, true)) {
                        ...
                        if (!x22.u().F(str4, C11245d2.f86307f1) || !z11) {
                            C11329o2 c11329o2O = x22.a().o();
                            ...
                            c11329o2O.c(sb2.toString(), x22.B().a(str2), x22.B().e(bundle));
                        }
                        k0(bundle, 28);
                        bundle.remove(str5);
                        list2 = list;
    ...
    final AbstractC15903a F() {
        if (this.f86921f == null) {
            this.f86921f = AbstractC15903a.a(this.f85708a.zzaY());
        }
        return this.f86921f;
    }
    ...
    final boolean I() throws ExecutionException, InterruptedException, TimeoutException {
        ...
        if (this.f86922g == null) {
            AbstractC15903a abstractC15903aF = F();
            boolean z10 = false;
            if (abstractC15903aF == null) {
                return false;
            }
            try {
                num = abstractC15903aF.b().get(10000L, TimeUnit.MILLISECONDS);
                if (num != null) {
                    try {
                        if (num.intValue() == 1) {
                            z10 = true;
                        ...
                        e10 = e11;
                        this.f85708a.a().p().b("Measurement manager api exception", e10);
                        this.f86922g = Boolean.FALSE;
                        this.f85708a.a().u().b("Measurement manager api status result", num);
                        return this.f86922g.booleanValue();
                ...
                this.f86922g = Boolean.valueOf(z10);
    ...
    final boolean J(String str) {
        String str2 = (String) C11245d2.f86339s0.b(null);
    ...
    final boolean Q(Context context, String str) {
        ...
        try {
            PackageInfo packageInfoF = C17067f.a(context).f(str, 64);
            ...
            this.f85708a.a().m().b("Package name not found", e10);
            return true;
        } catch (CertificateException e11) {
            this.f85708a.a().m().b("Error obtaining certificate", e11);
            return true;
        }
    }
    ...
    public final boolean T(int i10, boolean z10) {
        Boolean boolV = this.f85708a.H().v();
        if (U() < i10 / 1000) {
    ...
    public final int U() {
        if (this.f86923h == null) {
            this.f86923h = Integer.valueOf(C14724g.f().a(this.f85708a.zzaY()) / 1000);
        }
        return this.f86923h.intValue();
    }

    public final int V(int i10) {
        return C14724g.f().h(this.f85708a.zzaY(), 12451000);
    }

    final void X(Bundle bundle, long j10) {
        long j11 = bundle.getLong("_et");
        if (j11 != 0) {
            this.f85708a.a().p().b("Params already contained engagement", Long.valueOf(j11));
        } else {
            j11 = 0;
        }
    ...
    public final void Y(InterfaceC10695y0 interfaceC10695y0, String str) {
        Bundle bundle = new Bundle();
        bundle.putString("r", str);
        try {
            interfaceC10695y0.P(bundle);
        } catch (RemoteException e10) {
            this.f85708a.a().p().b("Error returning string value to wrapper", e10);
        }
    }

    public final void Z(InterfaceC10695y0 interfaceC10695y0, long j10) {
        Bundle bundle = new Bundle();
        bundle.putLong("r", j10);
        try {
            interfaceC10695y0.P(bundle);
        } catch (RemoteException e10) {
            this.f85708a.a().p().b("Error returning long value to wrapper", e10);
        }
    }

    public final void a0(InterfaceC10695y0 interfaceC10695y0, int i10) {
        Bundle bundle = new Bundle();
        bundle.putInt("r", i10);
        try {
            interfaceC10695y0.P(bundle);
        } catch (RemoteException e10) {
            this.f85708a.a().p().b("Error returning int value to wrapper", e10);
        }
    }

    public final void b0(InterfaceC10695y0 interfaceC10695y0, byte[] bArr) {
        Bundle bundle = new Bundle();
        bundle.putByteArray("r", bArr);
        try {
            interfaceC10695y0.P(bundle);
        } catch (RemoteException e10) {
            this.f85708a.a().p().b("Error returning byte array to wrapper", e10);
        }
    }

    public final void c0(InterfaceC10695y0 interfaceC10695y0, boolean z10) {
        Bundle bundle = new Bundle();
        bundle.putBoolean("r", z10);
        try {
            interfaceC10695y0.P(bundle);
        } catch (RemoteException e10) {
            this.f85708a.a().p().b("Error returning boolean value to wrapper", e10);
        }
    }

    public final void e0(InterfaceC10695y0 interfaceC10695y0, ArrayList arrayList) {
        Bundle bundle = new Bundle();
        bundle.putParcelableArrayList("r", arrayList);
        try {
            interfaceC10695y0.P(bundle);
        } catch (RemoteException e10) {
            this.f85708a.a().p().b("Error returning bundle list to wrapper", e10);
        }
    }
    ...
    public final long n0() {
        long andIncrement;
        long j10;
        AtomicLong atomicLong = this.f86919d;
        if (atomicLong.get() != 0) {
            AtomicLong atomicLong2 = this.f86919d;
        ...
        synchronized (atomicLong) {
            long jNextLong = new Random(System.nanoTime() ^ this.f85708a.zzaZ().a()).nextLong();
            int i10 = this.f86920e + 1;
            this.f86920e = i10;
            j10 = jNextLong + i10;
        }
        return j10;
    ...
    */
    ...
    final Object q(String str, Object obj) {
        if ("_ev".equals(str)) {
            return l0(this.f85708a.u().w(null, false), obj, true, true, null);
        }
        return l0(L(str) ? this.f85708a.u().w(null, false) : this.f85708a.u().v(null, false), obj, false, true, null);
    }
    ...
    final Bundle q0(Uri uri) {
        ...
        try {
            ...
            this.f85708a.a().p().b("Install referrer url isn't a hierarchical URI", e10);
            return null;
        }
    }
    ...
    final Bundle r(String str, String str2, Bundle bundle, List list, boolean z10) {
        int iX0;
        List list2 = list;
        boolean zM = M(str2, Qd.w.f28077d);
        if (bundle == null) {
            return null;
        }
        ...
        for (String str3 : new TreeSet(bundle.keySet())) {
            ...
            if (iX0 != 0) {
                ...
                if (p0(str3) && (i10 = i10 + 1) > iT) {
                    if (!x22.u().F(null, C11245d2.f86307f1) || !z11) {
    ...
    final void s(C11349r2 c11349r2, int i10) {
        Bundle bundle = c11349r2.f86670d;
        int i11 = 0;
        boolean z10 = false;
        for (String str : new TreeSet(bundle.keySet())) {
            if (p0(str) && (i11 = i11 + 1) > i10) {
                X2 x22 = this.f85708a;
                if (!x22.u().F(null, C11245d2.f86307f1) || !z10) {
                    StringBuilder sb2 = new StringBuilder(String.valueOf(i10).length() + 37);
                    sb2.append("Event can't contain more than ");
                    sb2.append(i10);
                    sb2.append(" params");
                    x22.a().o().c(sb2.toString(), x22.B().a(c11349r2.f86667a), x22.B().e(bundle));
                    k0(bundle, 5);
                }
                bundle.remove(str);
                z10 = true;
    ...
    final void u(Bundle bundle, Bundle bundle2) {
        ...
        for (String str : bundle2.keySet()) {
            if (!bundle.containsKey(str)) {
                this.f85708a.A().y(bundle, str, bundle2.get(str));
            }
        }
    }
    ...
    final int v0(String str) {
        ...
        if (!t0("event", Qd.w.f28074a, Qd.w.f28075b, str)) {
            return 13;
        }
        this.f85708a.u();
    ...
    final int w0(String str) {
        ...
        if (!t0("user property", Qd.y.f28082a, null, str)) {
            return 15;
        }
        this.f85708a.u();
    ...
    z6(X2 x22) {
        super(x22);
        this.f86923h = null;
        this.f86919d = new AtomicLong(0L);
    }
    ...
    final long H() {
        ...
        if (Build.VERSION.SDK_INT < 30) {
            ...
            int iG = G();
            x22.u();
            if (iG < ((Integer) C11245d2.f86327m0.b(null)).intValue()) {
                j10 = 16;
            } else {
                j10 = 0;
            }
    ...
    public final void d0(InterfaceC10695y0 interfaceC10695y0, Bundle bundle) {
        try {
            interfaceC10695y0.P(bundle);
        } catch (RemoteException e10) {
            this.f85708a.a().p().b("Error returning bundle value to wrapper", e10);
        }
    }
    ...
    public final URL g0(long j10, String str, String str2, long j11, String str3) {
        try {
            ...
            if (str.equals(this.f85708a.u().h())) {
            ...
            e = e10;
            this.f85708a.a().m().b("Failed to create BOW URL for Deferred Deep Link. exception", e.getMessage());
            return null;
    ...
    protected final void h() {
        ...
        if (jNextLong == 0) {
            ...
            if (jNextLong == 0) {
                this.f85708a.a().p().a("Utils falling back to Random for random id");
            }
        }
        this.f86919d.set(jNextLong);
    }
    ...
    final boolean m(String str) {
        if (!TextUtils.isEmpty(str)) {
            ...
            if (!str.matches("^1:\\d+:android:[a-f0-9]+$")) {
                this.f85708a.a().o().b("Invalid google_app_id. Firebase Analytics disabled. See https://goo.gl/NAOOOI. provided id", C11343q2.v(str));
                return false;
            }
            return true;
        }
        this.f85708a.a().o().a("Missing google_app_id. Firebase Analytics disabled. See https://goo.gl/NAOOOI");
        return false;
    }
    ...
    final void t(Parcelable[] parcelableArr, int i10) {
        ...
        for (Parcelable parcelable : parcelableArr) {
            ...
            boolean z10 = false;
            for (String str : new TreeSet(bundle.keySet())) {
                if (p0(str) && !M(str, Qd.x.f28081d) && (i11 = i11 + 1) > i10) {
                    X2 x22 = this.f85708a;
                    if (!x22.u().F(null, C11245d2.f86307f1) || !z10) {
                        C11329o2 c11329o2O = x22.a().o();
                        ...
                        c11329o2O.c(sb2.toString(), x22.B().b(str), x22.B().e(bundle));
                    }
                    k0(bundle, 28);
                    bundle.remove(str);
                    z10 = true;
