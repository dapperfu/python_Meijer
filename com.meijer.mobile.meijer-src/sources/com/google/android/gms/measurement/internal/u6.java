...
import com.google.android.gms.internal.measurement.C10705z1;
...
public final class u6 extends AbstractC11233b6 {
    ...
    final Parcelable L(byte[] bArr, Parcelable.Creator creator) {
        ...
        try {
            try {
                ...
                this.f85708a.a().m().a("Failed to load parcelable from buffer");
            }
            return parcelable;
        } finally {
    ...
    private static final void B(StringBuilder sb2, int i10, String str, C10528f3 c10528f3) {
        if (c10528f3 == null) {
            return;
        }
        w(sb2, 3);
        ...
        if (c10528f3.J() != 0) {
            ...
            int i15 = 0;
            for (com.google.android.gms.internal.measurement.M2 m22 : c10528f3.I()) {
                int i16 = i15 + 1;
                if (i15 != 0) {
                    sb2.append(", ");
                }
        ...
        if (c10528f3.L() != 0) {
            ...
            int i17 = 0;
            for (C10546h3 c10546h3 : c10528f3.K()) {
                int i18 = i17 + 1;
                if (i17 != 0) {
                    sb2.append(", ");
                }
                sb2.append(c10546h3.E() ? Integer.valueOf(c10546h3.F()) : null);
                sb2.append(": [");
                Iterator it = c10546h3.G().iterator();
                int i19 = 0;
                while (it.hasNext()) {
    ...
    private final void u(StringBuilder sb2, int i10, List list) {
        ...
        while (it.hasNext()) {
            ...
            if (s22 != null) {
                w(sb2, i11);
                sb2.append("param {\n");
                C(sb2, i11, "name", s22.E() ? this.f85708a.B().b(s22.F()) : null);
    ...
    private final void v(StringBuilder sb2, int i10, com.google.android.gms.internal.measurement.B1 b12) {
        ...
        if (b12.K()) {
            C(sb2, i10, "param_name", this.f85708a.B().b(b12.L()));
        }
        if (b12.E()) {
            int i11 = i10 + 1;
    ...
    final S5 G(String str, com.google.android.gms.internal.measurement.Z2 z22, com.google.android.gms.internal.measurement.N2 n22, String str2) {
        ...
        C10622p7.a();
        X2 x22 = this.f85708a;
        if (!x22.u().F(str, C11245d2.f86271Q0)) {
            return null;
        }
        long jA = x22.zzaZ().a();
        Set setA = Qd.L.a(x22.u().A(str, C11245d2.f86345v0).split(","));
        q6 q6Var = this.f86107b;
        C11249d6 c11249d6A0 = q6Var.A0();
        String strV = c11249d6A0.f86107b.B0().v(str);
        Uri.Builder builder = new Uri.Builder();
        X2 x23 = c11249d6A0.f85708a;
        builder.scheme(x23.u().A(str, C11245d2.f86331o0));
        if (TextUtils.isEmpty(strV)) {
            builder.authority(x23.u().A(str, C11245d2.f86333p0));
        } else {
            String strA = x23.u().A(str, C11245d2.f86333p0);
        ...
        builder.path(x23.u().A(str, C11245d2.f86335q0));
        x(builder, "gmp_app_id", z22.q0(), setA);
        x22.u().y();
        x(builder, "gmp_version", String.valueOf(133005L), setA);
        String strP = z22.P();
        C11312m c11312mU = x22.u();
        C11237c2 c11237c2 = C11245d2.f86277T0;
        if (c11312mU.F(str, c11237c2) && q6Var.B0().L(str)) {
            strP = "";
        }
        ...
        String strW = z22.w();
        if (x22.u().F(str, c11237c2) && q6Var.B0().I(str) && !TextUtils.isEmpty(strW) && (iIndexOf = strW.indexOf(".")) != -1) {
        ...
        A(builder, x22.u().A(str, C11245d2.f86343u0).split("\\|"), bundle, setA);
        List<C10635r3> listA1 = z22.a1();
        Bundle bundle2 = new Bundle();
        for (C10635r3 c10635r3 : listA1) {
            String strG = c10635r3.G();
            if (c10635r3.N()) {
                bundle2.putString(strG, String.valueOf(c10635r3.O()));
            } else if (c10635r3.L()) {
                bundle2.putString(strG, String.valueOf(c10635r3.M()));
            } else if (c10635r3.H()) {
                bundle2.putString(strG, c10635r3.I());
            } else if (c10635r3.J()) {
                bundle2.putString(strG, String.valueOf(c10635r3.K()));
            }
        }
        A(builder, x22.u().A(str, C11245d2.f86341t0).split("\\|"), bundle2, setA);
        x(builder, "dma", true != z22.Y() ? "0" : "1", setA);
        if (!z22.a0().isEmpty()) {
            x(builder, "dma_cps", z22.a0(), setA);
        }
        if (z22.h0()) {
            C10679w2 c10679w2I0 = z22.i0();
            if (!c10679w2I0.P().isEmpty()) {
                x(builder, "dl_gclid", c10679w2I0.P(), setA);
            }
            if (!c10679w2I0.R().isEmpty()) {
                x(builder, "dl_gbraid", c10679w2I0.R(), setA);
            }
            if (!c10679w2I0.T().isEmpty()) {
                x(builder, "dl_gs", c10679w2I0.T(), setA);
            }
            if (c10679w2I0.V() > 0) {
                x(builder, "dl_ss_ts", String.valueOf(c10679w2I0.V()), setA);
            }
            if (!c10679w2I0.X().isEmpty()) {
                x(builder, "mr_gclid", c10679w2I0.X(), setA);
            }
            if (!c10679w2I0.Z().isEmpty()) {
                x(builder, "mr_gbraid", c10679w2I0.Z(), setA);
            }
            if (!c10679w2I0.b0().isEmpty()) {
                x(builder, "mr_gs", c10679w2I0.b0(), setA);
            }
            if (c10679w2I0.d0() > 0) {
                x(builder, "mr_click_ts", String.valueOf(c10679w2I0.d0()), setA);
            }
        }
    ...
    final String I(com.google.android.gms.internal.measurement.Y2 y22) {
        ...
        for (C10483a3 c10483a3 : y22.E()) {
            if (c10483a3 != null) {
                w(sb2, 1);
                sb2.append("bundle {\n");
                if (c10483a3.e0()) {
                    C(sb2, 1, "protocol_version", Integer.valueOf(c10483a3.f1()));
                }
                C7.a();
                X2 x22 = this.f85708a;
                if (x22.u().F(c10483a3.E(), C11245d2.f86265N0) && c10483a3.L0()) {
                    C(sb2, 1, "session_stitching_token", c10483a3.M0());
                }
                C(sb2, 1, "platform", c10483a3.A2());
                if (c10483a3.G()) {
                    C(sb2, 1, "gmp_version", Long.valueOf(c10483a3.H()));
                }
                if (c10483a3.I()) {
                    C(sb2, 1, "uploading_gmp_version", Long.valueOf(c10483a3.J()));
                }
                if (c10483a3.H0()) {
                    C(sb2, 1, "dynamite_version", Long.valueOf(c10483a3.I0()));
                }
                if (c10483a3.a0()) {
                    C(sb2, 1, "config_version", Long.valueOf(c10483a3.b0()));
                }
                C(sb2, 1, "gmp_app_id", c10483a3.T());
                C(sb2, 1, "app_id", c10483a3.E());
                C(sb2, 1, "app_version", c10483a3.F());
                if (c10483a3.Y()) {
                    C(sb2, 1, "app_version_major", Integer.valueOf(c10483a3.Z()));
                }
                C(sb2, 1, "firebase_instance_id", c10483a3.X());
                if (c10483a3.O()) {
                    C(sb2, 1, "dev_cert_hash", Long.valueOf(c10483a3.P()));
                }
                C(sb2, 1, "app_store", c10483a3.G2());
                if (c10483a3.q2()) {
                    C(sb2, 1, "upload_timestamp_millis", Long.valueOf(c10483a3.r2()));
                }
                if (c10483a3.s2()) {
                    C(sb2, 1, "start_timestamp_millis", Long.valueOf(c10483a3.t2()));
                }
                if (c10483a3.u2()) {
                    C(sb2, 1, "end_timestamp_millis", Long.valueOf(c10483a3.v2()));
                }
                if (c10483a3.w2()) {
                    C(sb2, 1, "previous_bundle_start_timestamp_millis", Long.valueOf(c10483a3.x2()));
                }
                if (c10483a3.y2()) {
                    C(sb2, 1, "previous_bundle_end_timestamp_millis", Long.valueOf(c10483a3.z2()));
                }
                C(sb2, 1, "app_instance_id", c10483a3.N());
                C(sb2, 1, "resettable_device_id", c10483a3.K());
                C(sb2, 1, "ds_id", c10483a3.d0());
                if (c10483a3.L()) {
                    C(sb2, 1, "limited_ad_tracking", Boolean.valueOf(c10483a3.M()));
                }
                C(sb2, 1, "os_version", c10483a3.B2());
                C(sb2, 1, "device_model", c10483a3.C2());
                C(sb2, 1, "user_default_language", c10483a3.D2());
                if (c10483a3.E2()) {
                    C(sb2, 1, "time_zone_offset_minutes", Integer.valueOf(c10483a3.F2()));
                }
                if (c10483a3.Q()) {
                    C(sb2, 1, "bundle_sequential_index", Integer.valueOf(c10483a3.R()));
                }
                if (c10483a3.Z0()) {
                    C(sb2, 1, "delivery_index", Integer.valueOf(c10483a3.a1()));
                }
                if (c10483a3.U()) {
                    C(sb2, 1, "service_upload", Boolean.valueOf(c10483a3.V()));
                }
                C(sb2, 1, "health_monitor", c10483a3.S());
                if (c10483a3.F0()) {
                    C(sb2, 1, "retry_counter", Integer.valueOf(c10483a3.G0()));
                }
                if (c10483a3.J0()) {
                    C(sb2, 1, "consent_signals", c10483a3.K0());
                }
                if (c10483a3.S0()) {
                    C(sb2, 1, "is_dma_region", Boolean.valueOf(c10483a3.T0()));
                }
                if (c10483a3.U0()) {
                    C(sb2, 1, "core_platform_services", c10483a3.V0());
                }
                if (c10483a3.Q0()) {
                    C(sb2, 1, "consent_diagnostics", c10483a3.R0());
                }
                if (c10483a3.N0()) {
                    C(sb2, 1, "target_os_version", Long.valueOf(c10483a3.O0()));
                }
                C10622p7.a();
                if (x22.u().F(c10483a3.E(), C11245d2.f86271Q0)) {
                    C(sb2, 1, "ad_services_version", Integer.valueOf(c10483a3.W0()));
                    if (c10483a3.X0() && (a2Y0 = c10483a3.Y0()) != null) {
                        w(sb2, 2);
                ...
                if (c10483a3.b1()) {
                    C10679w2 c10679w2C1 = c10483a3.c1();
                    w(sb2, 2);
                    sb2.append("ad_campaign_info {\n");
                    if (c10679w2C1.O()) {
                        C(sb2, 2, "deep_link_gclid", c10679w2C1.P());
                    }
                    if (c10679w2C1.Q()) {
                        C(sb2, 2, "deep_link_gbraid", c10679w2C1.R());
                    }
                    if (c10679w2C1.S()) {
                        C(sb2, 2, "deep_link_gad_source", c10679w2C1.T());
                    }
                    if (c10679w2C1.U()) {
                        C(sb2, 2, "deep_link_session_millis", Long.valueOf(c10679w2C1.V()));
                    }
                    if (c10679w2C1.W()) {
                        C(sb2, 2, "market_referrer_gclid", c10679w2C1.X());
                    }
                    if (c10679w2C1.Y()) {
                        C(sb2, 2, "market_referrer_gbraid", c10679w2C1.Z());
                    }
                    if (c10679w2C1.a0()) {
                        C(sb2, 2, "market_referrer_gad_source", c10679w2C1.b0());
                    }
                    if (c10679w2C1.c0()) {
                        C(sb2, 2, "market_referrer_click_millis", Long.valueOf(c10679w2C1.d0()));
                    }
                    w(sb2, 2);
                    sb2.append("}\n");
                }
                if (c10483a3.f0()) {
                    C(sb2, 1, "batching_timestamp_millis", Long.valueOf(c10483a3.g0()));
                }
                if (c10483a3.d1()) {
                    C10618p3 c10618p3E1 = c10483a3.e1();
                    w(sb2, 2);
                    ...
                    C(sb2, 2, "client_upload_eligibility", c10618p3E1.E().name());
                    int iK = c10618p3E1.K();
                ...
                if (c10483a3.h0()) {
                    com.google.android.gms.internal.measurement.K2 k2I0 = c10483a3.i0();
                    w(sb2, 2);
                ...
                List<C10635r3> listN2 = c10483a3.n2();
                if (listN2 != null) {
                    for (C10635r3 c10635r3 : listN2) {
                        if (c10635r3 != null) {
                            w(sb2, 2);
                            sb2.append("user_property {\n");
                            C(sb2, 2, "set_timestamp_millis", c10635r3.E() ? Long.valueOf(c10635r3.F()) : null);
                            C(sb2, 2, "name", x22.B().c(c10635r3.G()));
                            C(sb2, 2, "string_value", c10635r3.I());
                            C(sb2, 2, "int_value", c10635r3.J() ? Long.valueOf(c10635r3.K()) : null);
                            C(sb2, 2, "double_value", c10635r3.N() ? Double.valueOf(c10635r3.O()) : null);
                            w(sb2, 2);
                            sb2.append("}\n");
                        }
                    }
                }
                List<com.google.android.gms.internal.measurement.C2> listW = c10483a3.W();
                if (listW != null) {
                ...
                List<com.google.android.gms.internal.measurement.O2> listH2 = c10483a3.h2();
                if (listH2 != null) {
    ...
    final String J(C10705z1 c10705z1) {
        if (c10705z1 == null) {
        ...
        sb2.append("\nevent_filter {\n");
        if (c10705z1.E()) {
            C(sb2, 0, "filter_id", Integer.valueOf(c10705z1.F()));
        }
        C(sb2, 0, NotificationsManager.INTENT_EXTRA_EVENT_NAME, this.f85708a.B().a(c10705z1.G()));
        String strY = y(c10705z1.M(), c10705z1.N(), c10705z1.P());
        if (!strY.isEmpty()) {
            C(sb2, 0, "filter_type", strY);
        }
        if (c10705z1.K()) {
            D(sb2, 1, "event_count_filter", c10705z1.L());
        }
        if (c10705z1.I() > 0) {
            sb2.append("  filters {\n");
            Iterator it = c10705z1.H().iterator();
            while (it.hasNext()) {
    ...
    final String K(com.google.android.gms.internal.measurement.H1 h12) {
        ...
        C(sb2, 0, "property_name", this.f85708a.B().c(h12.G()));
    ...
    final List P(List list, List list2) {
        ...
        while (it.hasNext()) {
            ...
            if (num.intValue() < 0) {
                this.f85708a.a().p().b("Ignoring negative bit index to be cleared", num);
            } else {
                int iIntValue = num.intValue() / 64;
                if (iIntValue >= arrayList.size()) {
                    this.f85708a.a().p().c("Ignoring bit index greater than bitSet size", num, Integer.valueOf(arrayList.size()));
                } else {
    ...
    final boolean Q(long j10, long j11) {
        return j10 == 0 || j11 <= 0 || Math.abs(this.f85708a.zzaZ().a() - j10) > j11;
    }
    ...
    final byte[] T(byte[] bArr) throws IOException {
        try {
            ...
            this.f85708a.a().m().b("Failed to gzip content", e10);
            throw e10;
        }
    }
    ...
    static final boolean n(G g10, B6 b62) {
        ...
        if (TextUtils.isEmpty(b62.f85744b)) {
            return false;
        }
        return true;
    }
    ...
    final void E(C10627q3 c10627q3, Object obj) {
        com.google.android.gms.common.internal.r.l(obj);
        c10627q3.w();
        c10627q3.y();
        c10627q3.A();
        if (obj instanceof String) {
            c10627q3.v((String) obj);
            return;
        }
        if (obj instanceof Long) {
            c10627q3.x(((Long) obj).longValue());
        } else if (obj instanceof Double) {
            c10627q3.z(((Double) obj).doubleValue());
        } else {
            this.f85708a.a().m().b("Ignoring invalid (type) user attribute value", obj);
        }
    }
    ...
    final void F(com.google.android.gms.internal.measurement.R2 r22, Object obj) {
        ...
        this.f85708a.a().m().b("Ignoring invalid (type) event param value", obj);
    }
    ...
    final G k(C10488b c10488b) {
        String string;
        Object obj;
        Bundle bundleL = l(c10488b.f(), true);
        ...
        String str = string;
        String strB = Qd.w.b(c10488b.b());
        if (strB == null) {
            strB = c10488b.b();
        }
        return new G(strB, new E(bundleL), str, c10488b.a());
    }
}
