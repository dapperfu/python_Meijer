...
public final class D5 {
    ...
    public final int c(final Intent intent, int i10, final int i11) throws IllegalStateException {
        ...
        final C11343q2 c11343q2A = x2M.a();
        String action = intent.getAction();
        x2M.c();
        c11343q2A.u().c("Local AppMeasurementService called. startId, action", Integer.valueOf(i11), action);
        if ("com.google.android.gms.measurement.UPLOAD".equals(action)) {
            k(q6.D(context), new Runnable() { // from class: com.google.android.gms.measurement.internal.C5
                @Override // java.lang.Runnable
                public final /* synthetic */ void run() {
                    this.f85789a.f(i11, c11343q2A, intent);
                }
            });
        }
        return 2;
    ...
    public final void a() {
        FS.log_v("FA", this.f85806a.getClass().getSimpleName().concat(" is starting up."));
    }

    public final void b() {
        FS.log_v("FA", this.f85806a.getClass().getSimpleName().concat(" is shutting down."));
    }
    ...
    public final IBinder d(Intent intent) {
        ...
        if ("com.google.android.gms.measurement.START".equals(action)) {
            return new BinderC11406z3(q6.D(this.f85806a), null);
        }
    ...
    final /* synthetic */ void f(int i10, C11343q2 c11343q2, Intent intent) {
        Context context = this.f85806a;
        Qd.I i11 = (Qd.I) context;
        if (i11.zza(i10)) {
            c11343q2.u().b("Local AppMeasurementService processed last upload request. StartId", Integer.valueOf(i10));
    ...
    final /* synthetic */ void h(JobParameters jobParameters) {
        ...
        ((Qd.I) this.f85806a).b(jobParameters, false);
    }
    ...
    private final void k(q6 q6Var, Runnable runnable) throws IllegalStateException {
        q6Var.b().r(new RunnableC11408z5(this, q6Var, runnable));
    }
    ...
    public final boolean e(final JobParameters jobParameters) throws IllegalStateException {
        ...
        if (Objects.equals(string, "com.google.android.gms.measurement.UPLOAD")) {
            ...
            q6 q6VarD = q6.D(this.f85806a);
            final C11343q2 c11343q2A = q6VarD.a();
            q6VarD.c();
            c11343q2A.u().b("Local AppMeasurementJobService called. action", str);
            k(q6VarD, new Runnable() { // from class: com.google.android.gms.measurement.internal.A5
                @Override // java.lang.Runnable
                public final /* synthetic */ void run() {
                    this.f85715a.g(c11343q2A, jobParameters);
                }
            });
        }
        if (Objects.equals(string, "com.google.android.gms.measurement.SCION_UPLOAD")) {
            C10669v1.r(this.f85806a, null).F(new Runnable() { // from class: com.google.android.gms.measurement.internal.B5
                @Override // java.lang.Runnable
                public final /* synthetic */ void run() {
                    this.f85736a.h(jobParameters);
                }
            });
            return true;
        }
    ...
    final /* synthetic */ void g(C11343q2 c11343q2, JobParameters jobParameters) {
        c11343q2.u().a("AppMeasurementJobService processed last upload request.");
        ((Qd.I) this.f85806a).b(jobParameters, false);
    }
}
