...
final class A4 implements Runnable {
    ...
    private final URL f85709a;

    /* renamed from: b, reason: collision with root package name */
    private final byte[] f85710b;

    /* renamed from: c, reason: collision with root package name */
    private final InterfaceC11400y4 f85711c;

    /* renamed from: d, reason: collision with root package name */
    private final String f85712d;

    /* renamed from: e, reason: collision with root package name */
    private final Map f85713e;

    /* renamed from: f, reason: collision with root package name */
    final /* synthetic */ B4 f85714f;

    private final void b(final int i10, final Exception exc, final byte[] bArr, final Map map) throws IllegalStateException {
        this.f85714f.f85708a.b().r(new Runnable() { // from class: com.google.android.gms.measurement.internal.z4
            @Override // java.lang.Runnable
            public final /* synthetic */ void run() {
                this.f86908a.a(i10, exc, bArr, map);
            }
        });
    }

    final /* synthetic */ void a(int i10, Exception exc, byte[] bArr, Map map) {
        this.f85711c.a(this.f85712d, i10, exc, bArr, map);
    }
    ...
    */
    ...
    public A4(B4 b42, String str, URL url, byte[] bArr, Map map, InterfaceC11400y4 interfaceC11400y4) {
        ...
        this.f85709a = url;
        this.f85710b = bArr;
        this.f85711c = interfaceC11400y4;
        this.f85712d = str;
        this.f85713e = map;
    }
}
