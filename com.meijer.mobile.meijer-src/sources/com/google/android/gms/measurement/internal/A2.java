...
public final class A2 {
    ...
    private final Bundle f85705b;

    /* renamed from: c, reason: collision with root package name */
    private Bundle f85706c;

    /* renamed from: d, reason: collision with root package name */
    final /* synthetic */ E2 f85707d;
    ...
    */
    ...
    public final void b(Bundle bundle) {
        ...
        if (bundle2.size() == 0) {
            editorEdit.remove(this.f85704a);
        } else {
            ...
            for (String str2 : bundle2.keySet()) {
                ...
                if (obj != null) {
                    try {
                        ...
                        this.f85707d.f85708a.a().m().b("Cannot serialize bundle value to SharedPreferences", e10);
                    }
                }
            }
