...
final class C11367u extends AbstractC11233b6 {

    /* renamed from: f, reason: collision with root package name */
    private static final String[] f86727f = {"last_bundled_timestamp", "ALTER TABLE events ADD COLUMN last_bundled_timestamp INTEGER;", "last_bundled_day", "ALTER TABLE events ADD COLUMN last_bundled_day INTEGER;", "last_sampled_complex_event_id", "ALTER TABLE events ADD COLUMN last_sampled_complex_event_id INTEGER;", "last_sampling_rate", "ALTER TABLE events ADD COLUMN last_sampling_rate INTEGER;", "last_exempt_from_sampling", "ALTER TABLE events ADD COLUMN last_exempt_from_sampling INTEGER;", "current_session_count", "ALTER TABLE events ADD COLUMN current_session_count INTEGER;"};

    /* renamed from: g, reason: collision with root package name */
    static final String[] f86728g = {"associated_row_id", "ALTER TABLE upload_queue ADD COLUMN associated_row_id INTEGER;", "last_upload_timestamp", "ALTER TABLE upload_queue ADD COLUMN last_upload_timestamp INTEGER;"};

    /* renamed from: h, reason: collision with root package name */
    private static final String[] f86729h = {"origin", "ALTER TABLE user_attributes ADD COLUMN origin TEXT;"};

    /* renamed from: i, reason: collision with root package name */
    private static final String[] f86730i = {"app_version", "ALTER TABLE apps ADD COLUMN app_version TEXT;", "app_store", "ALTER TABLE apps ADD COLUMN app_store TEXT;", "gmp_version", "ALTER TABLE apps ADD COLUMN gmp_version INTEGER;", "dev_cert_hash", "ALTER TABLE apps ADD COLUMN dev_cert_hash INTEGER;", "measurement_enabled", "ALTER TABLE apps ADD COLUMN measurement_enabled INTEGER;", "last_bundle_start_timestamp", "ALTER TABLE apps ADD COLUMN last_bundle_start_timestamp INTEGER;", "day", "ALTER TABLE apps ADD COLUMN day INTEGER;", "daily_public_events_count", "ALTER TABLE apps ADD COLUMN daily_public_events_count INTEGER;", "daily_events_count", "ALTER TABLE apps ADD COLUMN daily_events_count INTEGER;", "daily_conversions_count", "ALTER TABLE apps ADD COLUMN daily_conversions_count INTEGER;", "remote_config", "ALTER TABLE apps ADD COLUMN remote_config BLOB;", "config_fetched_time", "ALTER TABLE apps ADD COLUMN config_fetched_time INTEGER;", "failed_config_fetch_time", "ALTER TABLE apps ADD COLUMN failed_config_fetch_time INTEGER;", "app_version_int", "ALTER TABLE apps ADD COLUMN app_version_int INTEGER;", "firebase_instance_id", "ALTER TABLE apps ADD COLUMN firebase_instance_id TEXT;", "daily_error_events_count", "ALTER TABLE apps ADD COLUMN daily_error_events_count INTEGER;", "daily_realtime_events_count", "ALTER TABLE apps ADD COLUMN daily_realtime_events_count INTEGER;", "health_monitor_sample", "ALTER TABLE apps ADD COLUMN health_monitor_sample TEXT;", "android_id", "ALTER TABLE apps ADD COLUMN android_id INTEGER;", "adid_reporting_enabled", "ALTER TABLE apps ADD COLUMN adid_reporting_enabled INTEGER;", "ssaid_reporting_enabled", "ALTER TABLE apps ADD COLUMN ssaid_reporting_enabled INTEGER;", "admob_app_id", "ALTER TABLE apps ADD COLUMN admob_app_id TEXT;", "linked_admob_app_id", "ALTER TABLE apps ADD COLUMN linked_admob_app_id TEXT;", "dynamite_version", "ALTER TABLE apps ADD COLUMN dynamite_version INTEGER;", "safelisted_events", "ALTER TABLE apps ADD COLUMN safelisted_events TEXT;", "ga_app_id", "ALTER TABLE apps ADD COLUMN ga_app_id TEXT;", "config_last_modified_time", "ALTER TABLE apps ADD COLUMN config_last_modified_time TEXT;", "e_tag", "ALTER TABLE apps ADD COLUMN e_tag TEXT;", "session_stitching_token", "ALTER TABLE apps ADD COLUMN session_stitching_token TEXT;", "sgtm_upload_enabled", "ALTER TABLE apps ADD COLUMN sgtm_upload_enabled INTEGER;", "target_os_version", "ALTER TABLE apps ADD COLUMN target_os_version INTEGER;", "session_stitching_token_hash", "ALTER TABLE apps ADD COLUMN session_stitching_token_hash INTEGER;", "ad_services_version", "ALTER TABLE apps ADD COLUMN ad_services_version INTEGER;", "unmatched_first_open_without_ad_id", "ALTER TABLE apps ADD COLUMN unmatched_first_open_without_ad_id INTEGER;", "npa_metadata_value", "ALTER TABLE apps ADD COLUMN npa_metadata_value INTEGER;", "attribution_eligibility_status", "ALTER TABLE apps ADD COLUMN attribution_eligibility_status INTEGER;", "sgtm_preview_key", "ALTER TABLE apps ADD COLUMN sgtm_preview_key TEXT;", "dma_consent_state", "ALTER TABLE apps ADD COLUMN dma_consent_state INTEGER;", "daily_realtime_dcu_count", "ALTER TABLE apps ADD COLUMN daily_realtime_dcu_count INTEGER;", "bundle_delivery_index", "ALTER TABLE apps ADD COLUMN bundle_delivery_index INTEGER;", "serialized_npa_metadata", "ALTER TABLE apps ADD COLUMN serialized_npa_metadata TEXT;", "unmatched_pfo", "ALTER TABLE apps ADD COLUMN unmatched_pfo INTEGER;", "unmatched_uwa", "ALTER TABLE apps ADD COLUMN unmatched_uwa INTEGER;", "ad_campaign_info", "ALTER TABLE apps ADD COLUMN ad_campaign_info BLOB;", "daily_registered_triggers_count", "ALTER TABLE apps ADD COLUMN daily_registered_triggers_count INTEGER;", "client_upload_eligibility", "ALTER TABLE apps ADD COLUMN client_upload_eligibility INTEGER;", "gmp_version_for_remote_config", "ALTER TABLE apps ADD COLUMN gmp_version_for_remote_config INTEGER;"};

    /* renamed from: j, reason: collision with root package name */
    private static final String[] f86731j = {"realtime", "ALTER TABLE raw_events ADD COLUMN realtime INTEGER;"};

    /* renamed from: k, reason: collision with root package name */
    private static final String[] f86732k = {"has_realtime", "ALTER TABLE queue ADD COLUMN has_realtime INTEGER;", "retry_count", "ALTER TABLE queue ADD COLUMN retry_count INTEGER;"};

    /* renamed from: l, reason: collision with root package name */
    private static final String[] f86733l = {"session_scoped", "ALTER TABLE event_filters ADD COLUMN session_scoped BOOLEAN;"};

    /* renamed from: m, reason: collision with root package name */
    private static final String[] f86734m = {"session_scoped", "ALTER TABLE property_filters ADD COLUMN session_scoped BOOLEAN;"};

    /* renamed from: n, reason: collision with root package name */
    private static final String[] f86735n = {"previous_install_count", "ALTER TABLE app2 ADD COLUMN previous_install_count INTEGER;"};

    /* renamed from: o, reason: collision with root package name */
    private static final String[] f86736o = {"consent_source", "ALTER TABLE consent_settings ADD COLUMN consent_source INTEGER;", "dma_consent_settings", "ALTER TABLE consent_settings ADD COLUMN dma_consent_settings TEXT;", "storage_consent_at_bundling", "ALTER TABLE consent_settings ADD COLUMN storage_consent_at_bundling TEXT;"};

    /* renamed from: p, reason: collision with root package name */
    private static final String[] f86737p = {"idempotent", "CREATE INDEX IF NOT EXISTS trigger_uris_index ON trigger_uris (app_id);"};

    /* renamed from: d, reason: collision with root package name */
    private final C11360t f86738d;

    /* renamed from: e, reason: collision with root package name */
    private final R5 f86739e;
    ...
    final boolean F(String str, long j10) {
        try {
            ...
            this.f85708a.a().m().b("Error checking backfill conditions", e10);
            return false;
        }
    }

    public final C11340q J0(long j10, String str, boolean z10, boolean z11, boolean z12, boolean z13, boolean z14, boolean z15, boolean z16) {
    ...
    private final void L(String str, String str2, ContentValues contentValues) {
        try {
            ...
            if (contentValues.getAsString("app_id") == null) {
                this.f85708a.a().o().b("Value of the primary key is not set.", C11343q2.v("app_id"));
                return;
            }
            ...
            if (sQLiteDatabaseS0.update("consent_settings", contentValues, sb2.toString(), new String[]{r2}) == 0 && sQLiteDatabaseS0.insertWithOnConflict("consent_settings", null, contentValues, 5) == -1) {
                this.f85708a.a().m().c("Failed to insert/update table (got -1). key", C11343q2.v("consent_settings"), C11343q2.v("app_id"));
            }
        } catch (SQLiteException e10) {
            this.f85708a.a().m().d("Error storing into table. key", C11343q2.v("consent_settings"), C11343q2.v("app_id"), e10);
        }
    }
    ...
    */
    private final com.google.android.gms.measurement.internal.C M(java.lang.String r30, java.lang.String r31, java.lang.String r32) throws java.lang.Throwable {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11367u.M(java.lang.String, java.lang.String, java.lang.String):com.google.android.gms.measurement.internal.C");
    }

    private final t6 P(String str, long j10, byte[] bArr, String str2, String str3, int i10, int i11, long j11, long j12, long j13) {
        if (TextUtils.isEmpty(str2)) {
            this.f85708a.a().t().a("Upload uri is null or empty. Destination is unknown. Dropping batch. ");
            return null;
        }
        try {
            ...
            Qd.G gA = Qd.G.a(i10);
            if (gA != Qd.G.GOOGLE_SIGNAL && gA != Qd.G.GOOGLE_SIGNAL_PENDING && i11 > 0) {
                ArrayList arrayList = new ArrayList();
                Iterator it = v22.t().iterator();
                while (it.hasNext()) {
                    com.google.android.gms.internal.measurement.Z2 z22 = (com.google.android.gms.internal.measurement.Z2) ((C10483a3) it.next()).q();
                    z22.D0(i11);
                    arrayList.add((C10483a3) z22.q());
                }
                v22.z();
                v22.y(arrayList);
            }
            ...
            if (str3 != null) {
                ...
                while (true) {
                    ...
                    if (strArrSplit2.length != 2) {
                        this.f85708a.a().m().b("Invalid upload header: ", str4);
                        break;
                    }
            ...
            this.f85708a.a().m().c("Failed to queued MeasurementBatch from upload_queue. appId", str, e10);
            return null;
        }
    }
    ...
    private final String Q() {
        ...
        x22.u();
        String str2 = String.format(locale, "(upload_type != %d AND ABS(creation_timestamp - %d) > %d)", numValueOf2, lValueOf, Long.valueOf(C11312m.o()));
    ...
    */
    public final java.util.List B0(java.lang.String r23, java.lang.String r24, java.lang.String r25) throws java.lang.Throwable {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11367u.B0(java.lang.String, java.lang.String, java.lang.String):java.util.List");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final com.google.android.gms.measurement.internal.C11282i D0(java.lang.String r26, java.lang.String r27) throws java.lang.Throwable {
        /*
            Method dump skipped, instructions count: 293
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11367u.D0(java.lang.String, java.lang.String):com.google.android.gms.measurement.internal.i");
    }
    ...
    */
    public final void G(java.lang.String r25, java.lang.Long r26, java.lang.String r27, android.os.Bundle r28) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11367u.G(java.lang.String, java.lang.Long, java.lang.String, android.os.Bundle):void");
    }
    ...
    */
    public final java.util.List G0(java.lang.String r29, java.lang.String[] r30) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11367u.G0(java.lang.String, java.lang.String[]):java.util.List");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final com.google.android.gms.measurement.internal.C11384w2 H0(java.lang.String r52) {
        /*
            Method dump skipped, instructions count: 778
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11367u.H0(java.lang.String):com.google.android.gms.measurement.internal.w2");
    }

    public final void I0(C11384w2 c11384w2, boolean z10, boolean z11) {
        ...
        } else if (this.f86107b.e(strO0).o(Qd.v.ANALYTICS_STORAGE)) {
            contentValues.put("app_instance_id", c11384w2.p0());
        }
        contentValues.put("gmp_app_id", c11384w2.r0());
        q6 q6Var = this.f86107b;
        if (q6Var.e(strO0).o(Qd.v.AD_STORAGE)) {
            contentValues.put("resettable_device_id_hash", c11384w2.v0());
        }
        contentValues.put("last_bundle_index", Long.valueOf(c11384w2.g()));
        contentValues.put("last_bundle_start_timestamp", Long.valueOf(c11384w2.z0()));
        contentValues.put("last_bundle_end_timestamp", Long.valueOf(c11384w2.B0()));
        contentValues.put("app_version", c11384w2.D0());
        contentValues.put("app_store", c11384w2.H0());
        contentValues.put("gmp_version", Long.valueOf(c11384w2.J0()));
        contentValues.put("dev_cert_hash", Long.valueOf(c11384w2.L0()));
        contentValues.put("measurement_enabled", Boolean.valueOf(c11384w2.d()));
        contentValues.put("day", Long.valueOf(c11384w2.n()));
        contentValues.put("daily_public_events_count", Long.valueOf(c11384w2.p()));
        contentValues.put("daily_events_count", Long.valueOf(c11384w2.r()));
        contentValues.put("daily_conversions_count", Long.valueOf(c11384w2.t()));
        contentValues.put("config_fetched_time", Long.valueOf(c11384w2.h()));
        contentValues.put("failed_config_fetch_time", Long.valueOf(c11384w2.j()));
        contentValues.put("app_version_int", Long.valueOf(c11384w2.F0()));
        contentValues.put("firebase_instance_id", c11384w2.x0());
        contentValues.put("daily_error_events_count", Long.valueOf(c11384w2.x()));
        contentValues.put("daily_realtime_events_count", Long.valueOf(c11384w2.v()));
        contentValues.put("health_monitor_sample", c11384w2.z());
        contentValues.put("android_id", (Long) 0L);
        contentValues.put("adid_reporting_enabled", Boolean.valueOf(c11384w2.P()));
        contentValues.put("dynamite_version", Long.valueOf(c11384w2.b()));
        if (q6Var.e(strO0).o(Qd.v.ANALYTICS_STORAGE)) {
            contentValues.put("session_stitching_token", c11384w2.t0());
        }
        contentValues.put("sgtm_upload_enabled", Boolean.valueOf(c11384w2.V()));
        contentValues.put("target_os_version", Long.valueOf(c11384w2.X()));
        contentValues.put("session_stitching_token_hash", Long.valueOf(c11384w2.Z()));
        C10622p7.a();
        X2 x22 = this.f85708a;
        if (x22.u().F(strO0, C11245d2.f86271Q0)) {
            contentValues.put("ad_services_version", Integer.valueOf(c11384w2.b0()));
            contentValues.put("attribution_eligibility_status", Long.valueOf(c11384w2.j0()));
        }
        contentValues.put("unmatched_first_open_without_ad_id", Boolean.valueOf(c11384w2.d0()));
        contentValues.put("npa_metadata_value", c11384w2.R());
        contentValues.put("bundle_delivery_index", Long.valueOf(c11384w2.G()));
        contentValues.put("sgtm_preview_key", c11384w2.l0());
        contentValues.put("dma_consent_state", Integer.valueOf(c11384w2.B()));
        contentValues.put("daily_realtime_dcu_count", Integer.valueOf(c11384w2.D()));
        contentValues.put("serialized_npa_metadata", c11384w2.I());
        contentValues.put("client_upload_eligibility", Integer.valueOf(c11384w2.M()));
        List listT = c11384w2.T();
        if (listT != null) {
            if (listT.isEmpty()) {
        ...
        Q6.a();
        if (x22.u().F(null, C11245d2.f86261L0) && !contentValues.containsKey("safelisted_events")) {
            contentValues.put("safelisted_events", (String) null);
        }
        contentValues.put("unmatched_pfo", c11384w2.f0());
        contentValues.put("unmatched_uwa", c11384w2.h0());
        contentValues.put("ad_campaign_info", c11384w2.K());
        try {
            SQLiteDatabase sQLiteDatabaseS0 = s0();
            if (sQLiteDatabaseS0.update("apps", contentValues, "app_id = ?", new String[]{strO0}) == 0 && sQLiteDatabaseS0.insertWithOnConflict("apps", null, contentValues, 5) == -1) {
                x22.a().m().b("Failed to insert/update app (got -1). appId", C11343q2.v(strO0));
            }
        } catch (SQLiteException e10) {
            this.f85708a.a().m().c("Error storing app. appId", C11343q2.v(strO0), e10);
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:108:0x034f, code lost:
        ...
        r22.f85708a.a().m().b("Failed to insert property filter (got -1). appId", com.google.android.gms.measurement.internal.C11343q2.v(r23));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:113:0x036b, code lost:
        ...
        r22.f85708a.a().m().c("Error storing property filter. appId", com.google.android.gms.measurement.internal.C11343q2.v(r23), r0);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:56:0x0190, code lost:
        ...
        r22.f85708a.a().p().c("Property filter with no ID. Audience definition ignored. appId, audienceId", com.google.android.gms.measurement.internal.C11343q2.v(r23), java.lang.Integer.valueOf(r10));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:61:0x01c5, code lost:
        ...
        r12 = (com.google.android.gms.internal.measurement.C10705z1) r11.next();
        h();
        f();
        com.google.android.gms.common.internal.r.f(r23);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:63:0x01e1, code lost:
        ...
        r0 = r22.f85708a.a().p();
        r11 = com.google.android.gms.measurement.internal.C11343q2.v(r23);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:76:0x023b, code lost:
        ...
        r7.put("filter_id", r0);
        r7.put(com.radiusnetworks.flybuy.sdk.manager.NotificationsManager.INTENT_EXTRA_EVENT_NAME, r12.G());
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:83:0x026b, code lost:
        ...
        r22.f85708a.a().m().b("Failed to insert event filter (got -1). appId", com.google.android.gms.measurement.internal.C11343q2.v(r23));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:86:0x0287, code lost:
        ...
        r22.f85708a.a().m().c("Error storing event filter. appId", com.google.android.gms.measurement.internal.C11343q2.v(r23), r0);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:92:0x02c8, code lost:
        ...
        r0 = r22.f85708a.a().p();
        r9 = com.google.android.gms.measurement.internal.C11343q2.v(r23);
    ...
    */
    final void W(java.lang.String r23, java.util.List r24) throws java.lang.Throwable {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11367u.W(java.lang.String, java.util.List):void");
    }
    ...
    final C X(String str, com.google.android.gms.internal.measurement.O2 o22, String str2) throws Throwable {
        ...
        if (cM == null) {
            X2 x22 = this.f85708a;
            x22.a().p().c("Event aggregate wasn't created during raw event logging. appId, event", C11343q2.v(str), x22.B().a(str2));
            return new C(str, o22.H(), 1L, 1L, 1L, o22.J(), 0L, null, null, null, null);
        }
        long j10 = cM.f85773e + 1;
        long j11 = cM.f85772d + 1;
        return new C(cM.f85769a, cM.f85770b, cM.f85771c + 1, j11, j10, cM.f85774f, cM.f85775g, cM.f85776h, cM.f85777i, cM.f85778j, cM.f85779k);
    }
    ...
    public final long k(String str, com.google.android.gms.internal.measurement.Y2 y22, String str2, Map map, Qd.G g10, Long l10) {
        int iDelete;
        f();
        h();
        ...
        if (Y()) {
            q6 q6Var = this.f86107b;
            long jA = q6Var.J0().f86890f.a();
            X2 x22 = this.f85708a;
            long jC = x22.zzaZ().c();
            long jAbs = Math.abs(jC - jA);
            x22.u();
            if (jAbs > C11312m.p()) {
                q6Var.J0().f86890f.b(jC);
                f();
                h();
                ...
                h();
                try {
                    int iC = x22.u().C(str, C11245d2.f86238A);
                    if (iC > 0) {
                    ...
                    this.f85708a.a().m().c("Error deleting over the limit queued batches. appId", C11343q2.v(str), e10);
                }
            }
        }
        ArrayList arrayList = new ArrayList();
        ...
        try {
            ...
            this.f85708a.a().m().c("Error storing MeasurementBatch to upload_queue. appId", str, e11);
            return -1L;
        }
    }
    ...
    */
    public final void l0(java.lang.String r20, long r21, long r23, com.google.android.gms.measurement.internal.m6 r25) throws java.lang.Throwable {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11367u.l0(java.lang.String, long, long, com.google.android.gms.measurement.internal.m6):void");
    }

    public final boolean n(String str) {
        Qd.G[] gArr = {Qd.G.GOOGLE_SIGNAL};
    ...
    public final void v0(String str) {
        ...
        try {
            try {
                ...
                this.f85708a.a().m().c("Error creating snapshot. appId", C11343q2.v(str), e10);
            }
            if (cursorQuery != null) {
                cursorQuery.close();
            }
    ...
    */
    public final void w0(java.lang.String r20) throws java.lang.Throwable {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11367u.w0(java.lang.String):void");
    }
    ...
    C11367u(q6 q6Var) {
        super(q6Var);
        this.f86739e = new R5(this.f85708a.zzaZ());
        this.f85708a.u();
        this.f86738d = new C11360t(this, this.f85708a.zzaY(), "google_app_measurement.db");
    }
    ...
    private final String K(String str, String[] strArr, String str2) {
        ...
        try {
            try {
                ...
                this.f85708a.a().m().c("Database error", str, e10);
                throw e10;
            }
        } catch (Throwable th2) {
    ...
    private final void N(String str, C c10) {
        ...
        h();
        ContentValues contentValues = new ContentValues();
        String str2 = c10.f85769a;
        contentValues.put("app_id", str2);
        contentValues.put("name", c10.f85770b);
        contentValues.put("lifetime_count", Long.valueOf(c10.f85771c));
        contentValues.put("current_bundle_count", Long.valueOf(c10.f85772d));
        contentValues.put("last_fire_timestamp", Long.valueOf(c10.f85774f));
        contentValues.put("last_bundled_timestamp", Long.valueOf(c10.f85775g));
        contentValues.put("last_bundled_day", c10.f85776h);
        contentValues.put("last_sampled_complex_event_id", c10.f85777i);
        contentValues.put("last_sampling_rate", c10.f85778j);
        contentValues.put("current_session_count", Long.valueOf(c10.f85773e));
        Boolean bool = c10.f85779k;
        ...
        try {
            if (s0().insertWithOnConflict(str, null, contentValues, 5) == -1) {
                this.f85708a.a().m().b("Failed to insert/update event aggregates (got -1). appId", C11343q2.v(str2));
            }
        } catch (SQLiteException e10) {
            this.f85708a.a().m().c("Error storing event aggregates. appId", C11343q2.v(c10.f85769a), e10);
        }
    }
    ...
    private final void O(String str, String str2) {
        ...
        try {
            ...
            this.f85708a.a().m().c("Error deleting snapshot. appId", C11343q2.v(str2), e10);
        }
    }
    ...
    */
    public final java.util.List A0(java.lang.String r13) {
        /*
            ...
            com.google.android.gms.measurement.internal.X2 r11 = r12.f85708a     // Catch: java.lang.Throwable -> L4c android.database.sqlite.SQLiteException -> L85
        ...
        L52:
            ...
            java.lang.Object r3 = com.google.android.gms.measurement.internal.C11343q2.v(r13)     // Catch: java.lang.Throwable -> L4c android.database.sqlite.SQLiteException -> L4f
        ...
        L85:
            ...
            r13 = r0
        L88:
            com.google.android.gms.measurement.internal.X2 r13 = r12.f85708a     // Catch: java.lang.Throwable -> L4c
            ...
            java.lang.Object r2 = com.google.android.gms.measurement.internal.C11343q2.v(r3)     // Catch: java.lang.Throwable -> L4c
        ...
        La8:
            throw r13
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11367u.A0(java.lang.String):java.util.List");
    }
    ...
    public final boolean C0(C11282i c11282i) {
        com.google.android.gms.common.internal.r.l(c11282i);
        f();
        h();
        String str = c11282i.f86448a;
        com.google.android.gms.common.internal.r.l(str);
        if (z0(str, c11282i.f86450c.f86766b) == null) {
        ...
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", str);
        contentValues.put("origin", c11282i.f86449b);
        contentValues.put("name", c11282i.f86450c.f86766b);
        m0(contentValues, "value", com.google.android.gms.common.internal.r.l(c11282i.f86450c.B()));
        contentValues.put("active", Boolean.valueOf(c11282i.f86452e));
        contentValues.put("trigger_event_name", c11282i.f86453f);
        contentValues.put("trigger_timeout", Long.valueOf(c11282i.f86455h));
        X2 x22 = this.f85708a;
        contentValues.put("timed_out_event", x22.A().R(c11282i.f86454g));
        contentValues.put("creation_timestamp", Long.valueOf(c11282i.f86451d));
        contentValues.put("triggered_event", x22.A().R(c11282i.f86456i));
        contentValues.put("triggered_timestamp", Long.valueOf(c11282i.f86450c.f86767c));
        contentValues.put("time_to_live", Long.valueOf(c11282i.f86457j));
        contentValues.put("expired_event", x22.A().R(c11282i.f86458k));
        try {
            if (s0().insertWithOnConflict("conditional_properties", null, contentValues, 5) == -1) {
                x22.a().m().b("Failed to insert/update conditional user property (got -1)", C11343q2.v(str));
                return true;
            }
            return true;
        } catch (SQLiteException e10) {
            this.f85708a.a().m().c("Error storing conditional user property", C11343q2.v(str), e10);
            return true;
        }
    }
    ...
    public final boolean D(String str, Long l10, long j10, com.google.android.gms.internal.measurement.O2 o22) {
        ...
        try {
            if (s0().insertWithOnConflict("main_event_params", null, contentValues, 5) == -1) {
                x22.a().m().b("Failed to insert complex main event (got -1). appId", C11343q2.v(str));
                return false;
            }
            return true;
        } catch (SQLiteException e10) {
            this.f85708a.a().m().c("Error storing complex main event. appId", C11343q2.v(str), e10);
            return false;
        }
    }
    ...
    */
    public final android.os.Bundle E(java.lang.String r6) throws java.lang.Throwable {
        /*
            ...
            if (r2 != 0) goto L2f
            com.google.android.gms.measurement.internal.X2 r6 = r5.f85708a     // Catch: java.lang.Throwable -> L2b android.database.sqlite.SQLiteException -> L2d
        ...
        L2f:
            ...
            com.google.android.gms.measurement.internal.q6 r6 = r5.f86107b     // Catch: java.lang.Throwable -> L2b android.database.sqlite.SQLiteException -> L2d
        ...
        L55:
            r2 = move-exception
            com.google.android.gms.measurement.internal.X2 r3 = r5.f85708a     // Catch: java.lang.Throwable -> L2b android.database.sqlite.SQLiteException -> L2d
            ...
            java.lang.Object r6 = com.google.android.gms.measurement.internal.C11343q2.v(r6)     // Catch: java.lang.Throwable -> L2b android.database.sqlite.SQLiteException -> L2d
        ...
        L6e:
            ...
            r1 = r0
        L70:
            com.google.android.gms.measurement.internal.X2 r2 = r5.f85708a     // Catch: java.lang.Throwable -> L2b
        ...
        L8a:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11367u.E(java.lang.String):android.os.Bundle");
    }
    ...
    public final int E0(String str, String str2) {
        ...
        try {
            ...
            X2 x22 = this.f85708a;
            x22.a().m().d("Error deleting conditional property", C11343q2.v(str), x22.B().c(str2), e10);
            return 0;
        }
    }
    ...
    */
    public final com.google.android.gms.measurement.internal.E3 H(java.lang.String r5) {
        /*
            ...
            if (r0 != 0) goto L35
            com.google.android.gms.measurement.internal.X2 r0 = r4.f85708a     // Catch: java.lang.Throwable -> L31 android.database.sqlite.SQLiteException -> L33
        ...
        L49:
            ...
            r5 = r1
        L4c:
            com.google.android.gms.measurement.internal.X2 r2 = r4.f85708a     // Catch: java.lang.Throwable -> L31
        ...
        L5e:
            if (r1 != 0) goto L63
            com.google.android.gms.measurement.internal.E3 r5 = com.google.android.gms.measurement.internal.E3.f85835c
            return r5
        L63:
            return r1
        L64:
        ...
        L69:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11367u.H(java.lang.String):com.google.android.gms.measurement.internal.E3");
    }
    ...
    public final boolean I(String str, S5 s52) {
        ...
        long jLongValue = jA - ((Long) c11237c2.b(null)).longValue();
        long j10 = s52.f86060b;
        if (j10 < jLongValue || j10 > ((Long) c11237c2.b(null)).longValue() + jA) {
            x22.a().p().d("Storing trigger URI outside of the max retention time span. appId, now, timestamp", C11343q2.v(str), Long.valueOf(jA), Long.valueOf(j10));
        }
        x22.a().u().a("Saving trigger URI");
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", str);
        contentValues.put("trigger_uri", s52.f86059a);
        contentValues.put("source", Integer.valueOf(s52.f86061c));
        contentValues.put("timestamp_millis", Long.valueOf(j10));
        try {
            if (s0().insert("trigger_uris", null, contentValues) == -1) {
                x22.a().m().b("Failed to insert trigger URI (got -1). appId", C11343q2.v(str));
                return false;
            }
            return true;
        } catch (SQLiteException e10) {
            this.f85708a.a().m().c("Error storing trigger URI. appId", C11343q2.v(str), e10);
            return false;
        }
    }
    ...
    public final C11340q K0(long j10, String str, long j11, boolean z10, boolean z11, boolean z12, boolean z13, boolean z14, boolean z15, boolean z16) {
        com.google.android.gms.common.internal.r.f(str);
        f();
        h();
        String[] strArr = {str};
        C11340q c11340q = new C11340q();
        Cursor cursorQuery = null;
        try {
            try {
                SQLiteDatabase sQLiteDatabaseS0 = s0();
                ...
                if (!cursorQuery.moveToFirst()) {
                    this.f85708a.a().p().b("Not updating daily counts, app is not known. appId", C11343q2.v(str));
                } else {
                    if (cursorQuery.getLong(0) == j10) {
                        c11340q.f86597b = cursorQuery.getLong(1);
                        c11340q.f86596a = cursorQuery.getLong(2);
                        c11340q.f86598c = cursorQuery.getLong(3);
                        c11340q.f86599d = cursorQuery.getLong(4);
                        c11340q.f86600e = cursorQuery.getLong(5);
                        c11340q.f86601f = cursorQuery.getLong(6);
                        c11340q.f86602g = cursorQuery.getLong(7);
                    }
                    if (z10) {
                        c11340q.f86597b += j11;
                    }
                    ...
                    contentValues.put("daily_public_events_count", Long.valueOf(c11340q.f86596a));
                    contentValues.put("daily_events_count", Long.valueOf(c11340q.f86597b));
                    contentValues.put("daily_conversions_count", Long.valueOf(c11340q.f86598c));
                    contentValues.put("daily_error_events_count", Long.valueOf(c11340q.f86599d));
                    contentValues.put("daily_realtime_events_count", Long.valueOf(c11340q.f86600e));
                    contentValues.put("daily_realtime_dcu_count", Long.valueOf(c11340q.f86601f));
                    contentValues.put("daily_registered_triggers_count", Long.valueOf(c11340q.f86602g));
                    sQLiteDatabaseS0.update("apps", contentValues, "app_id=?", strArr);
                }
            } catch (SQLiteException e10) {
                this.f85708a.a().m().c("Error updating daily counts. appId", C11343q2.v(str), e10);
            }
            if (cursorQuery != null) {
                cursorQuery.close();
            }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final com.google.android.gms.measurement.internal.C11333p L0(java.lang.String r11) throws java.lang.Throwable {
        /*
            r10 = this;
        ...
        L2e:
            ...
            if (r5 == 0) goto L5c
            com.google.android.gms.measurement.internal.X2 r5 = r10.f85708a     // Catch: java.lang.Throwable -> L57 android.database.sqlite.SQLiteException -> L5a
            ...
            java.lang.Object r7 = com.google.android.gms.measurement.internal.C11343q2.v(r11)     // Catch: java.lang.Throwable -> L57 android.database.sqlite.SQLiteException -> L5a
        ...
        L6d:
            ...
            r2 = r1
        L6f:
            com.google.android.gms.measurement.internal.X2 r3 = r10.f85708a     // Catch: java.lang.Throwable -> L57
            ...
            java.lang.Object r11 = com.google.android.gms.measurement.internal.C11343q2.v(r11)     // Catch: java.lang.Throwable -> L57
        ...
        L8d:
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11367u.L0(java.lang.String):com.google.android.gms.measurement.internal.p");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final boolean M0(com.google.android.gms.internal.measurement.C10483a3 r8, boolean r9) {
        /*
            r7 = this;
            r7.f()
            r7.h()
            ...
            r7.s()
            com.google.android.gms.measurement.internal.X2 r0 = r7.f85708a
            com.google.android.gms.common.util.f r1 = r0.zzaZ()
            long r1 = r1.a()
            long r3 = r8.v2()
            r0.u()
            long r5 = com.google.android.gms.measurement.internal.C11312m.o()
            long r5 = r1 - r5
        ...
        L45:
            ...
            java.lang.Object r3 = com.google.android.gms.measurement.internal.C11343q2.v(r3)
        ...
        L66:
            byte[] r0 = r8.g()
            r1 = 0
            com.google.android.gms.measurement.internal.q6 r2 = r7.f86107b     // Catch: java.io.IOException -> L108
            ...
            com.google.android.gms.measurement.internal.X2 r2 = r7.f85708a
        ...
        Lc5:
            ...
            java.lang.Object r2 = com.google.android.gms.measurement.internal.C11343q2.v(r2)     // Catch: android.database.sqlite.SQLiteException -> Lec
        ...
        Lf0:
            ...
            java.lang.Object r8 = com.google.android.gms.measurement.internal.C11343q2.v(r8)
        ...
        L108:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11367u.M0(com.google.android.gms.internal.measurement.a3, boolean):boolean");
    }

    public final C11395y S(String str) {
        com.google.android.gms.common.internal.r.l(str);
        f();
        h();
        return C11395y.g(K("select dma_consent_settings from consent_settings where app_id=? limit 1;", new String[]{str}, ""));
    }

    public final void T(String str, C11395y c11395y) {
        com.google.android.gms.common.internal.r.l(str);
        com.google.android.gms.common.internal.r.l(c11395y);
        f();
        h();
        E3 e3H = H(str);
        E3 e32 = E3.f85835c;
        ...
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", str);
        contentValues.put("dma_consent_settings", c11395y.e());
        L("consent_settings", "app_id", contentValues);
    }
    ...
    */
    public final com.google.android.gms.measurement.internal.t6 l(long r19) {
        ...
        L96:
            ...
            goto L8c
        L98:
            com.google.android.gms.measurement.internal.X2 r4 = r3.f85708a     // Catch: java.lang.Throwable -> Lb1
        ...
        Lb8:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11367u.l(long):com.google.android.gms.measurement.internal.t6");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.util.List m(java.lang.String r19, Qd.J r20, int r21) {
        /*
            r18 = this;
            ...
            r6 = r20
            java.util.List r6 = r6.f28056a     // Catch: java.lang.Throwable -> Lb9 android.database.sqlite.SQLiteException -> Lbb
        ...
        Lc3:
            r3 = r18
            com.google.android.gms.measurement.internal.X2 r1 = r3.f85708a     // Catch: java.lang.Throwable -> Lde
        ...
        Le4:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11367u.m(java.lang.String, Qd.J, int):java.util.List");
    }
    ...
    public final void o(Long l10) {
        ...
        try {
            if (s0().delete("upload_queue", "rowid=?", new String[]{l10.toString()}) != 1) {
                this.f85708a.a().p().a("Deleted fewer rows from upload_queue than expected");
            }
        } catch (SQLiteException e10) {
            this.f85708a.a().m().b("Failed to delete a MeasurementBatch in a upload_queue table", e10);
            throw e10;
        }
    }
    ...
    */
    public final java.lang.String p() throws java.lang.Throwable {
        ...
        L24:
            ...
            r0 = r1
        L27:
            com.google.android.gms.measurement.internal.X2 r3 = r6.f85708a     // Catch: java.lang.Throwable -> L1a
        ...
        L41:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11367u.p():java.lang.String");
    }
    ...
    public final void r(long j10) {
        ...
        try {
            ...
            this.f85708a.a().m().b("Failed to delete a bundle in a queue table", e10);
            throw e10;
        }
    }
    ...
    final void s() {
        ...
        if (Y()) {
            q6 q6Var = this.f86107b;
            long jA = q6Var.J0().f86889e.a();
            X2 x22 = this.f85708a;
            long jC = x22.zzaZ().c();
            long jAbs = Math.abs(jC - jA);
            x22.u();
            if (jAbs > C11312m.p()) {
                q6Var.J0().f86889e.b(jC);
                f();
                h();
                if (Y()) {
                    SQLiteDatabase sQLiteDatabaseS0 = s0();
                    ...
                    x22.u();
                    int iDelete = sQLiteDatabaseS0.delete("queue", "abs(bundle_end_timestamp - ?) > cast(? as integer)", new String[]{strValueOf, String.valueOf(C11312m.o())});
                    if (iDelete > 0) {
    ...
    final SQLiteDatabase s0() {
        f();
        try {
            return this.f86738d.getWritableDatabase();
        } catch (SQLiteException e10) {
            this.f85708a.a().p().b("Error opening database", e10);
            throw e10;
        }
    }
    ...
    final void t(List list) throws SQLException {
        ...
        if (n0(sb3.toString(), null) > 0) {
            this.f85708a.a().p().a("The number of upload retries exceeds the limit. Will remain unchanged.");
        }
        try {
            SQLiteDatabase sQLiteDatabaseS0 = s0();
            StringBuilder sb4 = new StringBuilder(string.length() + com.medallia.digital.mobilesdk.l3.f93324d);
            sb4.append("UPDATE queue SET retry_count = IFNULL(retry_count, 0) + 1 WHERE rowid IN ");
            sb4.append(string);
            sb4.append(" AND (retry_count IS NULL OR retry_count < 2147483647)");
            sQLiteDatabaseS0.execSQL(sb4.toString());
        } catch (SQLiteException e10) {
            this.f85708a.a().m().b("Error incrementing retry count. error", e10);
        }
    }
    ...
    final Object v(Cursor cursor, int i10) {
        ...
        if (type != 0) {
            if (type != 1) {
                if (type != 2) {
                    if (type != 3) {
                        if (type != 4) {
                            this.f85708a.a().m().b("Loaded invalid unknown value type, ignoring it", Integer.valueOf(type));
                            return null;
                        }
                        this.f85708a.a().m().a("Loaded invalid blob type value, ignoring it");
                        return null;
                    }
        ...
        this.f85708a.a().m().a("Loaded invalid null value from database");
        return null;
    }
    ...
    */
    protected final long x(java.lang.String r14, java.lang.String r15) {
        /*
            ...
            if (r1 != 0) goto L78
            com.google.android.gms.measurement.internal.X2 r1 = r13.f85708a     // Catch: java.lang.Throwable -> L74 android.database.sqlite.SQLiteException -> L76
            ...
            java.lang.Object r7 = com.google.android.gms.measurement.internal.C11343q2.v(r14)     // Catch: java.lang.Throwable -> L74 android.database.sqlite.SQLiteException -> L76
        ...
        L79:
            ...
            if (r3 != 0) goto Lb0
            com.google.android.gms.measurement.internal.X2 r3 = r13.f85708a     // Catch: java.lang.Throwable -> L74 android.database.sqlite.SQLiteException -> Lae
            ...
            java.lang.Object r7 = com.google.android.gms.measurement.internal.C11343q2.v(r14)     // Catch: java.lang.Throwable -> L74 android.database.sqlite.SQLiteException -> Lae
        ...
        Lb5:
            ...
            r1 = r11
        Lb8:
            com.google.android.gms.measurement.internal.X2 r4 = r13.f85708a     // Catch: java.lang.Throwable -> L74
            ...
            java.lang.Object r14 = com.google.android.gms.measurement.internal.C11343q2.v(r14)     // Catch: java.lang.Throwable -> L74
        ...
        Ld0:
            ...
            throw r14
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11367u.x(java.lang.String, java.lang.String):long");
    }
    ...
    public final void x0(String str, String str2) {
        ...
        try {
            ...
            X2 x22 = this.f85708a;
            x22.a().m().d("Error deleting user property. appId", C11343q2.v(str), x22.B().c(str2), e10);
        }
    }
    ...
    public final boolean y0(x6 x6Var) {
        ...
        f();
        h();
        String str = x6Var.f86870a;
        String str2 = x6Var.f86872c;
        if (z0(str, str2) == null) {
            if (z6.p0(str2)) {
                if (n0("select count(1) from user_attributes where app_id=? and name not like '!_%' escape '!'", new String[]{str}) >= this.f85708a.u().D(str, C11245d2.f86282W, 25, 100)) {
                    return false;
                }
            } else if (!"_npa".equals(str2)) {
                long jN0 = n0("select count(1) from user_attributes where app_id=? and origin=? AND name like '!_%' escape '!'", new String[]{str, x6Var.f86871b});
                this.f85708a.u();
                if (jN0 >= 25) {
                    return false;
                }
        ...
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", str);
        contentValues.put("origin", x6Var.f86871b);
        contentValues.put("name", str2);
        contentValues.put("set_timestamp", Long.valueOf(x6Var.f86873d));
        m0(contentValues, "value", x6Var.f86874e);
        try {
            if (s0().insertWithOnConflict("user_attributes", null, contentValues, 5) == -1) {
                this.f85708a.a().m().b("Failed to insert/update user property (got -1). appId", C11343q2.v(str));
                return true;
            }
            return true;
        } catch (SQLiteException e10) {
            this.f85708a.a().m().c("Error storing user property. appId", C11343q2.v(x6Var.f86870a), e10);
            return true;
        }
    }
    ...
    */
    public final com.google.android.gms.measurement.internal.x6 z0(java.lang.String r11, java.lang.String r12) {
        ...
        L40:
            ...
            if (r11 == 0) goto L6c
            com.google.android.gms.measurement.internal.X2 r11 = r10.f85708a     // Catch: java.lang.Throwable -> L66 android.database.sqlite.SQLiteException -> L69
            ...
            java.lang.Object r0 = com.google.android.gms.measurement.internal.C11343q2.v(r4)     // Catch: java.lang.Throwable -> L66 android.database.sqlite.SQLiteException -> L69
        ...
        L79:
            ...
            r2 = r1
        L7e:
            com.google.android.gms.measurement.internal.X2 r12 = r10.f85708a     // Catch: java.lang.Throwable -> L66
            ...
            java.lang.Object r4 = com.google.android.gms.measurement.internal.C11343q2.v(r4)     // Catch: java.lang.Throwable -> L66
        ...
        La4:
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11367u.z0(java.lang.String, java.lang.String):com.google.android.gms.measurement.internal.x6");
    }
}
