...
public final class O5 {
    ...
    private final Map f85990a;

    private final int g() {
        try {
            String str = (String) this.f85990a.get("PolicyVersion");
    ...
    private final Bundle f() {
        ...
        if ("1".equals(map.get("GoogleConsent")) && (iG = g()) >= 0) {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                String str2 = "denied";
                if (str.length() > 0) {
                    bundle.putString(Qd.v.AD_STORAGE.f28073a, str.charAt(0) == '1' ? "granted" : "denied");
                }
                if (str.length() > 3) {
                    bundle.putString(Qd.v.AD_PERSONALIZATION.f28073a, (str.charAt(2) == '1' && str.charAt(3) == '1') ? "granted" : "denied");
                }
                if (str.length() > 6 && iG >= 4) {
                    String str3 = Qd.v.AD_USER_DATA.f28073a;
    ...
    */
    public final android.os.Bundle b() {
        /*
            r9 = this;
            com.google.android.gms.measurement.internal.c2 r0 = com.google.android.gms.measurement.internal.C11245d2.f86292a1
            r1 = 0
        ...
        L71:
            ...
            r1.<init>()
            Qd.v r2 = Qd.v.AD_STORAGE
            java.lang.String r2 = r2.f28073a
        ...
        L8e:
            r1.putString(r2, r4)
            Qd.v r2 = Qd.v.AD_PERSONALIZATION
            java.lang.String r2 = r2.f28073a
    ...
    public final String c() {
        String str = (String) this.f85990a.get("PurposeDiagnostics");
    ...
    public final String e() throws NumberFormatException {
        ...
        int i10 = -1;
        try {
            String str = (String) this.f85990a.get("CmpSdkID");
            if (!TextUtils.isEmpty(str)) {
