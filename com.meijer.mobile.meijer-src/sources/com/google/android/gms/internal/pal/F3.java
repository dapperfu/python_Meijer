...
public final class F3 {
    ...
    private static Cipher f83446a;

    /* renamed from: b, reason: collision with root package name */
    private static final Object f83447b = new Object();

    /* renamed from: c, reason: collision with root package name */
    private static final Object f83448c = new Object();

    public F3(SecureRandom secureRandom) {
    }
    ...
    private static final Cipher c() throws NoSuchPaddingException, NoSuchAlgorithmException {
        Cipher cipher;
        synchronized (f83448c) {
            try {
                if (f83446a == null) {
                    f83446a = Cipher.getInstance("AES/CBC/PKCS5Padding");
                }
                cipher = f83446a;
            } catch (Throwable th2) {
                throw th2;
