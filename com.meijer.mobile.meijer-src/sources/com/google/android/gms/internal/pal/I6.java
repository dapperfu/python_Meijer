...
public final class I6 {
    ...
    private final void d(int i10) {
        ...
        if (i11 > length) {
            ...
            this.f83496a = Arrays.copyOf(objArr, i12);
        }
    }
    ...
    public final J6 c() {
        ...
        Q6 q6N = Q6.n(this.f83497b, this.f83496a, this);
        H6 h63 = this.f83498c;
        if (h63 == null) {
            return q6N;
        }
    ...
    public final I6 b(Map map) {
        ...
        if (setEntrySet instanceof Collection) {
            d(this.f83497b + setEntrySet.size());
        }
