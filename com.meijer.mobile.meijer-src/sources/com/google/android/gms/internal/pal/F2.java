...
final class F2 implements E2 {
    ...
    private final InterfaceC10981q7 f83445a;

    F2(InterfaceC10981q7 interfaceC10981q7) {
        this.f83445a = interfaceC10981q7;
    }

    @Override // com.google.android.gms.internal.pal.E2
    public final String zza(String str) throws NonceLoaderException {
        try {
            return Base64.encodeToString(this.f83445a.zza(str.getBytes("UTF-8"), new byte[0]), 10);
