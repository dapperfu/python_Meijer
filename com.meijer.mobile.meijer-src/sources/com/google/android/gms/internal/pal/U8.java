...
public final class U8 implements InterfaceC10901l7 {

    /* renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f83750b = new T8();

    /* renamed from: a, reason: collision with root package name */
    private final SecretKey f83751a;
    ...
    public final byte[] zza(byte[] bArr, byte[] bArr2) throws GeneralSecurityException, ClassNotFoundException {
        ...
        ThreadLocal threadLocal = f83750b;
        ((Cipher) threadLocal.get()).init(1, this.f83751a, ivParameterSpec);
    ...
    public U8(byte[] bArr) throws GeneralSecurityException {
        Ye.a(bArr.length);
        this.f83751a = new SecretKeySpec(bArr, "AES");
    }
}
