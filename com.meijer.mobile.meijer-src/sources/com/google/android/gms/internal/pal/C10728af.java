...
public final class C10728af implements InterfaceC10901l7 {

    /* renamed from: a, reason: collision with root package name */
    private final R8 f83894a;
    ...
    public final byte[] zza(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ...
        this.f83894a.b(byteBufferAllocate, bArrA, bArr, bArr2);
        return byteBufferAllocate.array();
    }

    public C10728af(byte[] bArr) throws GeneralSecurityException {
        this.f83894a = new R8(bArr);
    }
}
