...
final class C10847i1 {
    static String a(InterfaceC10815g1 interfaceC10815g1, String str) throws SecurityException {
        StringBuilder sb2 = new StringBuilder();
        sb2.append("# ");
        sb2.append(str);
        d(interfaceC10815g1, sb2, 0);
        return sb2.toString();
    }
    ...
    static final void b(StringBuilder sb2, int i10, String str, Object obj) {
        ...
        if (obj instanceof String) {
            sb2.append(": \"");
            sb2.append(I1.a(AbstractC10730b0.u((String) obj)));
            sb2.append('\"');
            return;
        }
        if (obj instanceof AbstractC10730b0) {
            sb2.append(": \"");
            sb2.append(I1.a((AbstractC10730b0) obj));
            sb2.append('\"');
            return;
        }
    ...
    private static void d(InterfaceC10815g1 interfaceC10815g1, StringBuilder sb2, int i10) throws SecurityException {
        boolean zEquals;
        HashMap map = new HashMap();
        HashMap map2 = new HashMap();
        TreeSet<String> treeSet = new TreeSet();
        for (Method method : interfaceC10815g1.getClass().getDeclaredMethods()) {
        ...
        for (String str : treeSet) {
            ...
            if (strSubstring.endsWith("List") && !strSubstring.endsWith("OrBuilderList") && !strSubstring.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    b(sb2, i10, c(strConcat), B0.g(method2, interfaceC10815g1, new Object[0]));
                }
            }
            if (strSubstring.endsWith("Map") && !strSubstring.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    b(sb2, i10, c(strConcat2), B0.g(method3, interfaceC10815g1, new Object[0]));
                }
            }
            if (((Method) map2.get("set".concat(strSubstring))) != null && (!strSubstring.endsWith("Bytes") || !map.containsKey("get".concat(String.valueOf(strSubstring.substring(0, strSubstring.length() - 5)))))) {
                ...
                if (method4 != null) {
                    Object objG = B0.g(method4, interfaceC10815g1, new Object[0]);
                    if (method5 == null) {
                        if (objG instanceof Boolean) {
                            ...
                            if (objG instanceof String) {
                                zEquals = objG.equals("");
                            } else if (objG instanceof AbstractC10730b0) {
                                zEquals = objG.equals(AbstractC10730b0.f83895b);
                            } else if (objG instanceof InterfaceC10815g1) {
                                if (objG != ((InterfaceC10815g1) objG).C()) {
                                    b(sb2, i10, c(strConcat3), objG);
                                }
                    ...
                    } else if (((Boolean) B0.g(method5, interfaceC10815g1, new Object[0])).booleanValue()) {
                        b(sb2, i10, c(strConcat3), objG);
                    }
                }
            }
        }
        if (interfaceC10815g1 instanceof AbstractC11117z0) {
            throw null;
        }
        K1 k12 = ((B0) interfaceC10815g1).zzc;
        if (k12 != null) {
            k12.g(sb2, i10);
        }
    }
