...
public final class M0 extends L implements RandomAccess, N0 {
    ...
    private static final M0 f83596c;

    /* renamed from: d, reason: collision with root package name */
    public static final N0 f83597d;

    /* renamed from: b, reason: collision with root package name */
    private final List f83598b;
    ...
    public final boolean addAll(int i10, Collection collection) {
        ...
        boolean zAddAll = this.f83598b.addAll(i10, collection);
    ...
    public M0(int i10) {
        this.f83598b = new ArrayList(i10);
    }

    private static String e(Object obj) {
        return obj instanceof String ? (String) obj : obj instanceof AbstractC10730b0 ? ((AbstractC10730b0) obj).x(J0.f83517b) : J0.h((byte[]) obj);
    }

    @Override // java.util.AbstractList, java.util.List
    /* renamed from: a, reason: merged with bridge method [inline-methods] */
    public final String get(int i10) {
        Object obj = this.f83598b.get(i10);
        if (obj instanceof String) {
            return (String) obj;
        }
        if (obj instanceof AbstractC10730b0) {
            AbstractC10730b0 abstractC10730b0 = (AbstractC10730b0) obj;
            String strX = abstractC10730b0.x(J0.f83517b);
            if (abstractC10730b0.p()) {
                this.f83598b.set(i10, strX);
            }
            return strX;
        }
        byte[] bArr = (byte[]) obj;
    ...
    public final /* bridge */ /* synthetic */ void add(int i10, Object obj) {
        zza();
        this.f83598b.add(i10, (String) obj);
        ((AbstractList) this).modCount++;
    }
    ...
    public final /* bridge */ /* synthetic */ Object set(int i10, Object obj) {
        zza();
        return e(this.f83598b.set(i10, (String) obj));
    }

    @Override // java.util.AbstractCollection, java.util.Collection, java.util.List
    public final int size() {
        return this.f83598b.size();
    }

    @Override // com.google.android.gms.internal.pal.N0
    public final Object zzf(int i10) {
        return this.f83598b.get(i10);
    }

    @Override // com.google.android.gms.internal.pal.N0
    public final List zzh() {
        return Collections.unmodifiableList(this.f83598b);
    }

    @Override // com.google.android.gms.internal.pal.N0
    public final void X0(AbstractC10730b0 abstractC10730b0) {
        zza();
        this.f83598b.add(abstractC10730b0);
        ((AbstractList) this).modCount++;
    }
    ...
    public final /* bridge */ /* synthetic */ Object remove(int i10) {
        zza();
        Object objRemove = this.f83598b.remove(i10);
        ((AbstractList) this).modCount++;
        return e(objRemove);
    }
