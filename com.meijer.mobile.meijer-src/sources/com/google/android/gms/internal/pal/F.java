...
public final class F implements Closeable {
    ...
    private final Reader f83432a;

    /* renamed from: h, reason: collision with root package name */
    private long f83439h;
    ...
    private String[] f83443l;

    /* renamed from: m, reason: collision with root package name */
    private int[] f83444m;

    /* renamed from: b, reason: collision with root package name */
    private final char[] f83433b = new char[1024];

    /* renamed from: c, reason: collision with root package name */
    private int f83434c = 0;

    /* renamed from: d, reason: collision with root package name */
    private int f83435d = 0;

    /* renamed from: e, reason: collision with root package name */
    private int f83436e = 0;

    /* renamed from: f, reason: collision with root package name */
    private int f83437f = 0;

    /* renamed from: g, reason: collision with root package name */
    int f83438g = 0;

    /* renamed from: k, reason: collision with root package name */
    private int f83442k = 1;
    ...
    */
    ...
    private final void A(int i10) {
        int i11 = this.f83442k;
        int[] iArr = this.f83441j;
        if (i11 == iArr.length) {
            int i12 = i11 + i11;
            this.f83441j = Arrays.copyOf(iArr, i12);
            this.f83444m = Arrays.copyOf(this.f83444m, i12);
            this.f83443l = (String[]) Arrays.copyOf(this.f83443l, i12);
        }
        int[] iArr2 = this.f83441j;
        int i13 = this.f83442k;
        this.f83442k = i13 + 1;
        iArr2[i13] = i10;
    }
    ...
    private final boolean B(int i10) throws IOException {
        int i11;
        char[] cArr = this.f83433b;
        int i12 = this.f83437f;
        int i13 = this.f83434c;
        this.f83437f = i12 - i13;
        int i14 = this.f83435d;
        if (i14 != i13) {
            int i15 = i14 - i13;
            this.f83435d = i15;
        ...
        this.f83434c = 0;
        do {
            Reader reader = this.f83432a;
            int i16 = this.f83435d;
            int i17 = reader.read(cArr, i16, 1024 - i16);
            if (i17 == -1) {
                return false;
            }
            i11 = this.f83435d + i17;
            this.f83435d = i11;
            if (this.f83436e == 0 && this.f83437f == 0 && i11 > 0 && cArr[0] == 65279) {
                this.f83434c++;
                this.f83437f = 1;
                i10++;
            }
    ...
    private final int p(boolean z10) throws IOException {
        char[] cArr = this.f83433b;
        int i10 = this.f83434c;
        int i11 = this.f83435d;
        while (true) {
            if (i10 == i11) {
                this.f83434c = i10;
                if (!B(1)) {
    ...
    */
    ...
    final String b() {
        int i10 = this.f83436e;
        int i11 = this.f83434c;
        int i12 = this.f83437f;
        ...
        sb3.append('$');
        for (int i13 = 0; i13 < this.f83442k; i13++) {
            int i14 = this.f83441j[i13];
            if (i14 == 1 || i14 == 2) {
                int i15 = this.f83444m[i13];
                sb3.append('[');
                sb3.append(i15);
                sb3.append(']');
            } else if (i14 == 3 || i14 == 4 || i14 == 5) {
                sb3.append('.');
                String str = this.f83443l[i13];
                if (str != null) {
                    sb3.append(str);
                }
            }
    ...
    public final String c() throws IOException {
        ...
        this.f83438g = 0;
        this.f83443l[this.f83442k - 1] = strW;
        return strW;
    }
    ...
    public final void g() throws IOException {
        ...
        int i10 = this.f83442k;
        this.f83442k = i10 - 1;
        int[] iArr = this.f83444m;
        int i11 = i10 - 2;
        iArr[i11] = iArr[i11] + 1;
        this.f83438g = 0;
    }
    ...
    public final boolean l() throws IOException {
        ...
        if (iA == 6) {
            this.f83438g = 0;
            int[] iArr2 = this.f83444m;
            int i11 = this.f83442k - 1;
    ...
    public final String zzd() throws IOException {
        ...
        if (iA == 10) {
            ...
            str = Long.toString(this.f83439h);
        } else {
            if (iA != 16) {
                throw new IllegalStateException("Expected a string but was " + ((Object) G.a(m())) + b());
            }
            str = new String(this.f83433b, this.f83434c, this.f83440i);
            this.f83434c += this.f83440i;
        }
        this.f83438g = 0;
        int[] iArr = this.f83444m;
        int i10 = this.f83442k - 1;
    ...
    public F(Reader reader) {
        ...
        this.f83441j = iArr;
        iArr[0] = 6;
        this.f83443l = new String[32];
        this.f83444m = new int[32];
        this.f83432a = reader;
    }
}
