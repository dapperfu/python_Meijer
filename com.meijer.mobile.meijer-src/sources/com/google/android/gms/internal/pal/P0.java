...
final class P0 extends T0 {
    ...
    private static final Class f83666c = Collections.unmodifiableList(Collections.EMPTY_LIST).getClass();
    ...
    private static List f(Object obj, long j10, int i10) {
        ...
        if (list.isEmpty()) {
            ...
            } else if ((list instanceof InterfaceC10927n1) && (list instanceof I0)) {
        ...
        if (f83666c.isAssignableFrom(list.getClass())) {
        ...
        if ((list instanceof InterfaceC10927n1) && (list instanceof I0)) {
            I0 i02 = (I0) list;
            if (!i02.zzc()) {
    ...
    final void b(Object obj, long j10) {
        ...
        } else if (!f83666c.isAssignableFrom(list.getClass())) {
            if ((list instanceof InterfaceC10927n1) && (list instanceof I0)) {
                I0 i02 = (I0) list;
                if (i02.zzc()) {
                    i02.zzb();
