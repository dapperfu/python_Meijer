...
abstract class P8 {
    ...
    private final N8 f83676a;

    /* renamed from: b, reason: collision with root package name */
    private final N8 f83677b;
    ...
    public P8(byte[] bArr) throws GeneralSecurityException {
        if (W8.a(1)) {
            this.f83676a = a(bArr, 1);
            this.f83677b = a(bArr, 0);
            return;
        }
    ...
    public final void b(ByteBuffer byteBuffer, byte[] bArr, byte[] bArr2, byte[] bArr3) throws GeneralSecurityException {
        ...
        if (byteBuffer.remaining() >= bArr2.length + 16) {
            ...
            this.f83676a.d(byteBuffer, bArr, bArr2);
            byteBuffer.position(iPosition);
            byteBuffer.limit(byteBuffer.limit() - 16);
            byte[] bArr4 = new byte[32];
            this.f83677b.c(bArr, 0).get(bArr4);
