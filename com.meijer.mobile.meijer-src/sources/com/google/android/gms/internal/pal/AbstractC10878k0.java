...
public abstract class AbstractC10878k0 extends Q {

    /* renamed from: b, reason: collision with root package name */
    private static final Logger f84040b = Logger.getLogger(AbstractC10878k0.class.getName());

    /* renamed from: c, reason: collision with root package name */
    private static final boolean f84041c = T1.C();

    /* renamed from: a, reason: collision with root package name */
    C10894l0 f84042a;

    private AbstractC10878k0() {
    }
    ...
    public static AbstractC10878k0 c(byte[] bArr) {
        return new C10846i0(bArr, 0, bArr.length);
    }
    ...
    public abstract void j(int i10, AbstractC10730b0 abstractC10730b0) throws IOException;
    ...
    /* synthetic */ AbstractC10878k0(C10862j0 c10862j0) {
    }

    static int B(InterfaceC10815g1 interfaceC10815g1, InterfaceC11006s1 interfaceC11006s1) {
        K k10 = (K) interfaceC10815g1;
        int iC = k10.c();
        if (iC == -1) {
    ...
    @Deprecated
    static int y(int i10, InterfaceC10815g1 interfaceC10815g1, InterfaceC11006s1 interfaceC11006s1) {
        int iA = a(i10 << 3);
        int i11 = iA + iA;
        K k10 = (K) interfaceC10815g1;
        int iC = k10.c();
    ...
    final void e(String str, X1 x12) throws IOException {
        f84040b.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable) x12);
        byte[] bytes = str.getBytes(J0.f83517b);
        try {
    ...
    public static int C(String str) {
        ...
        try {
            ...
            length = str.getBytes(J0.f83517b).length;
        }
        return a(length) + length;
    }

    public static int x(AbstractC10730b0 abstractC10730b0) {
