...
public final class L8 {
    ...
    private static final ThreadLocal f83590c = new K8();

    /* renamed from: a, reason: collision with root package name */
    private final SecretKey f83591a;

    /* renamed from: b, reason: collision with root package name */
    private final boolean f83592b;
    ...
    public final byte[] a(byte[] bArr, byte[] bArr2, byte[] bArr3) throws GeneralSecurityException {
        ...
        ThreadLocal threadLocal = f83590c;
        ((Cipher) threadLocal.get()).init(1, this.f83591a, gCMParameterSpec);
        int iDoFinal = ((Cipher) threadLocal.get()).doFinal(bArr2, 0, length, bArr4, true != this.f83592b ? 0 : 12);
    ...
    public L8(byte[] bArr, boolean z10) throws GeneralSecurityException {
        if (W8.a(2)) {
            Ye.a(bArr.length);
            this.f83591a = new SecretKeySpec(bArr, "AES");
            this.f83592b = z10;
            return;
        }
