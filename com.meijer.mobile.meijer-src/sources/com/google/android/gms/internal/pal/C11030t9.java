...
final class C11030t9 {
    ...
    private final byte[] f(byte[] bArr, byte[] bArr2, int i10) throws IllegalStateException, GeneralSecurityException {
        Mac mac = (Mac) Ee.f83425f.a(this.f84890a);
        if (i10 > mac.getMacLength() * com.medallia.digital.mobilesdk.l3.f93323c) {
            throw new GeneralSecurityException("size too large");
        }
        byte[] bArr3 = new byte[i10];
        mac.init(new SecretKeySpec(bArr, this.f84890a));
    ...
    private final byte[] g(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ...
        if (bArr2 == null || bArr2.length == 0) {
            mac.init(new SecretKeySpec(new byte[mac.getMacLength()], this.f84890a));
        } else {
            mac.init(new SecretKeySpec(bArr2, this.f84890a));
        }
        return mac.doFinal(bArr);
    }

    final int a() throws GeneralSecurityException {
        return Mac.getInstance(this.f84890a).getMacLength();
    }
    ...
    */
    public final byte[] c() throws java.security.GeneralSecurityException {
        /*
            r5 = this;
            java.lang.String r0 = r5.f84890a
            int r1 = r0.hashCode()
        ...
        L37:
            ...
            if (r0 == r3) goto L48
            if (r0 != r4) goto L40
            byte[] r0 = com.google.android.gms.internal.pal.I9.f83507h
            return r0
        L40:
            ...
            throw r0
        L48:
            byte[] r0 = com.google.android.gms.internal.pal.I9.f83506g
            return r0
        L4b:
            byte[] r0 = com.google.android.gms.internal.pal.I9.f83505f
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.pal.C11030t9.c():byte[]");
    }
