...
public class I0<MessageType extends K0<MessageType, BuilderType>, BuilderType extends I0<MessageType, BuilderType>> extends AbstractC10328b0<MessageType, BuilderType> {

    /* renamed from: a, reason: collision with root package name */
    private final K0 f81671a;

    /* renamed from: b, reason: collision with root package name */
    protected K0 f81672b;

    /* renamed from: b, reason: merged with bridge method [inline-methods] */
    public final I0 clone() {
        I0 i02 = (I0) this.f81671a.e(5, null, null);
        i02.f81672b = zzk();
        return i02;
    }

    @Override // com.google.android.gms.internal.atv_ads_framework.InterfaceC10369o1
    /* renamed from: d, reason: merged with bridge method [inline-methods] */
    public MessageType zzk() {
        if (!this.f81672b.c()) {
            return (MessageType) this.f81672b;
        }
        this.f81672b.m();
        return (MessageType) this.f81672b;
    }
    ...
    protected void f() {
        K0 k0I = this.f81671a.i();
        C10395x1.a().b(k0I.getClass()).c(k0I, this.f81672b);
        this.f81672b = k0I;
    }

    protected I0(MessageType messagetype) {
        this.f81671a = messagetype;
        if (!messagetype.c()) {
            this.f81672b = messagetype.i();
            return;
        }
    ...
    */
    public final MessageType c() {
        ...
        L13:
            if (r3 == 0) goto L31
            com.google.android.gms.internal.atv_ads_framework.x1 r3 = com.google.android.gms.internal.atv_ads_framework.C10395x1.a()
