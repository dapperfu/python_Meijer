...
final class V extends J {
    ...
    public final boolean contains(Object obj) {
        return this.f81747c.equals(obj);
    }

    @Override // com.google.android.gms.internal.atv_ads_framework.J, com.google.android.gms.internal.atv_ads_framework.C
    public final F h() {
        Object obj = this.f81747c;
        int i10 = F.f81595c;
        Object[] objArr = {obj};
        L.b(objArr, 1);
        return F.o(objArr, 1);
    ...
    public final int hashCode() {
        return this.f81747c.hashCode();
    }

    @Override // java.util.AbstractCollection
    public final String toString() {
        return "[" + this.f81747c.toString() + "]";
    }
