...
final class C1 {
    ...
    private static final Class f81584a;

    /* renamed from: b, reason: collision with root package name */
    private static final Q1 f81585b;

    /* renamed from: c, reason: collision with root package name */
    private static final Q1 f81586c;

    /* renamed from: d, reason: collision with root package name */
    public static final /* synthetic */ int f81587d = 0;
    ...
    static int I(int i10, Object obj, InterfaceC10401z1 interfaceC10401z1) {
        if (!(obj instanceof U0)) {
            return AbstractC10394x0.y(i10 << 3) + AbstractC10394x0.w((InterfaceC10372p1) obj, interfaceC10401z1);
        }
        int i11 = AbstractC10394x0.f81914d;
        int iA = ((U0) obj).a();
        return AbstractC10394x0.y(i10 << 3) + AbstractC10394x0.y(iA) + iA;
    }

    public static void b(Class cls) {
        Class cls2;
        if (!K0.class.isAssignableFrom(cls) && (cls2 = f81584a) != null && !cls2.isAssignableFrom(cls)) {
    ...
    public static void j(int i10, List list, i2 i2Var, InterfaceC10401z1 interfaceC10401z1) throws IOException {
        if (list == null || list.isEmpty()) {
            return;
        }
        for (int i11 = 0; i11 < list.size(); i11++) {
            ((C10397y0) i2Var).j(i10, list.get(i11), interfaceC10401z1);
        }
    }
    ...
    public static void m(int i10, List list, i2 i2Var, InterfaceC10401z1 interfaceC10401z1) throws IOException {
        if (list == null || list.isEmpty()) {
            return;
        }
        for (int i11 = 0; i11 < list.size(); i11++) {
            ((C10397y0) i2Var).o(i10, list.get(i11), interfaceC10401z1);
        }
    }
    ...
    static int B(int i10, List list, boolean z10) {
        ...
        return size * (AbstractC10394x0.y(i10 << 3) + 8);
    }
    ...
    static int D(int i10, List list, InterfaceC10401z1 interfaceC10401z1) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
        ...
        for (int i11 = 0; i11 < size; i11++) {
            iU += AbstractC10394x0.u(i10, (InterfaceC10372p1) list.get(i11), interfaceC10401z1);
        }
        return iU;
    }
    ...
    static int E(int i10, List list, boolean z10) {
        ...
        return F(list) + (size * AbstractC10394x0.y(i10 << 3));
    }
    ...
    static int F(List list) {
        ...
        if (list instanceof L0) {
            ...
            int iV = 0;
            while (i10 < size) {
                iV += AbstractC10394x0.v(l02.a(i10));
                i10++;
            }
            return iV;
        }
        int iV2 = 0;
        while (i10 < size) {
            iV2 += AbstractC10394x0.v(((Integer) list.get(i10)).intValue());
            i10++;
        }
        return iV2;
    }
    ...
    static int G(int i10, List list, boolean z10) {
        ...
        return H(list) + (list.size() * AbstractC10394x0.y(i10 << 3));
    }
    ...
    static int H(List list) {
        ...
        if (list instanceof C10339e1) {
            C10339e1 c10339e1 = (C10339e1) list;
            int iZ = 0;
            while (i10 < size) {
                iZ += AbstractC10394x0.z(c10339e1.a(i10));
                i10++;
            }
            return iZ;
        }
        int iZ2 = 0;
        while (i10 < size) {
            iZ2 += AbstractC10394x0.z(((Long) list.get(i10)).longValue());
            i10++;
        }
        return iZ2;
    }

    static int J(int i10, List list, InterfaceC10401z1 interfaceC10401z1) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
        int iY = AbstractC10394x0.y(i10 << 3) * size;
        for (int i11 = 0; i11 < size; i11++) {
            Object obj = list.get(i11);
            if (obj instanceof U0) {
                int iA = ((U0) obj).a();
                iY += AbstractC10394x0.y(iA) + iA;
            } else {
                iY += AbstractC10394x0.w((InterfaceC10372p1) obj, interfaceC10401z1);
            }
        }
        return iY;
    }
    ...
    static int K(int i10, List list, boolean z10) {
        ...
        return L(list) + (size * AbstractC10394x0.y(i10 << 3));
    }
    ...
    static int L(List list) {
        ...
        if (list instanceof L0) {
            ...
            while (i10 < size) {
                int iA = l02.a(i10);
                iY += AbstractC10394x0.y((iA >> 31) ^ (iA + iA));
                i10++;
            }
            return iY;
        }
        ...
        while (i10 < size) {
            ...
            iY2 += AbstractC10394x0.y((iIntValue >> 31) ^ (iIntValue + iIntValue));
            i10++;
        }
        return iY2;
    }
    ...
    static int M(int i10, List list, boolean z10) {
        ...
        return N(list) + (size * AbstractC10394x0.y(i10 << 3));
    }
    ...
    static int N(List list) {
        ...
        if (list instanceof C10339e1) {
            ...
            int iZ = 0;
            while (i10 < size) {
                long jA = c10339e1.a(i10);
                iZ += AbstractC10394x0.z((jA >> 63) ^ (jA + jA));
                i10++;
            }
            return iZ;
        }
        ...
        while (i10 < size) {
            ...
            iZ2 += AbstractC10394x0.z((jLongValue >> 63) ^ (jLongValue + jLongValue));
            i10++;
        }
        return iZ2;
    }
    ...
    static int O(int i10, List list) {
        ...
        if (z10) {
            ...
            while (i11 < size) {
                ...
                if (objZze instanceof AbstractC10374q0) {
                    int iF = ((AbstractC10374q0) objZze).f();
                    iY += AbstractC10394x0.y(iF) + iF;
                } else {
                    iY += AbstractC10394x0.x((String) objZze);
                }
                i11++;
            }
            return iY;
        ...
        while (i11 < size) {
            ...
            if (obj instanceof AbstractC10374q0) {
                int iF2 = ((AbstractC10374q0) obj).f();
                iY += AbstractC10394x0.y(iF2) + iF2;
            } else {
                iY += AbstractC10394x0.x((String) obj);
            }
            i11++;
        }
        return iY;
    ...
    static int P(int i10, List list, boolean z10) {
        ...
        return Q(list) + (size * AbstractC10394x0.y(i10 << 3));
    }
    ...
    static int Q(List list) {
        ...
        if (list instanceof L0) {
            ...
            int iY = 0;
            while (i10 < size) {
                iY += AbstractC10394x0.y(l02.a(i10));
                i10++;
            }
            return iY;
        }
        int iY2 = 0;
        while (i10 < size) {
            iY2 += AbstractC10394x0.y(((Integer) list.get(i10)).intValue());
            i10++;
        }
        return iY2;
    }
    ...
    static int R(int i10, List list, boolean z10) {
        ...
        return S(list) + (size * AbstractC10394x0.y(i10 << 3));
    }
    ...
    static int v(int i10, List list, boolean z10) {
        ...
        return size * (AbstractC10394x0.y(i10 << 3) + 1);
    }
    ...
    static int w(int i10, List list) {
        ...
        int iY = size * AbstractC10394x0.y(i10 << 3);
        for (int i11 = 0; i11 < list.size(); i11++) {
            int iF = ((AbstractC10374q0) list.get(i11)).f();
            iY += AbstractC10394x0.y(iF) + iF;
        }
        return iY;
    }
    ...
    static int x(int i10, List list, boolean z10) {
        ...
        return y(list) + (size * AbstractC10394x0.y(i10 << 3));
    }
    ...
    static int z(int i10, List list, boolean z10) {
        ...
        return size * (AbstractC10394x0.y(i10 << 3) + 4);
    }
}
