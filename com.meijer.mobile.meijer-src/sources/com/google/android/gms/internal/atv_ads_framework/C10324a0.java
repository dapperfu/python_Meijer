...
public final class C10324a0 {

    /* renamed from: a, reason: collision with root package name */
    private static final J f81793a = J.r("http", BuildConfig.SERVICE_SCHEME, "mailto", "ftp");

    /* renamed from: b, reason: collision with root package name */
    private static final J f81794b = J.s("audio/3gpp2", "audio/3gpp", "audio/aac", "audio/midi", "audio/mp3", "audio/mp4", "audio/mpeg", "audio/oga", "audio/ogg", "audio/opus", "audio/x-m4a", "audio/x-matroska", "audio/x-wav", "audio/wav", "audio/webm", "image/bmp", "image/gif", "image/jpeg", "image/jpg", "image/png", "image/svg+xml", "image/tiff", "image/webp", "image/x-icon", "video/mpeg", "video/mp4", "video/ogg", "video/webm", "video/x-matroska");

    /* renamed from: c, reason: collision with root package name */
    private static final J f81795c = J.p();
    ...
    public static String a(String str, String str2) {
        ...
        char cCharAt3;
        J j10 = f81795c;
        String strA = C10343g.a(str);
        W it = f81793a.iterator();
        while (it.hasNext()) {
        ...
        if (!strA.startsWith("data:")) {
            ...
            while (it2.hasNext()) {
                if (strA.startsWith(String.valueOf(C10343g.a(((Z) it2.next()).name()).replace('_', '-')).concat(":"))) {
                    return str;
                }
            }
        ...
        String strA2 = C10343g.a(str);
        if (strA2.startsWith("data:") && strA2.length() > 5) {
            int i12 = 5;
            while (i12 < strA2.length() && (cCharAt3 = strA2.charAt(i12)) != ';' && cCharAt3 != ',') {
                i12++;
            }
            if (f81794b.contains(strA2.substring(5, i12)) && strA2.startsWith(";base64,", i12) && (i10 = i12 + 8) < strA2.length()) {
