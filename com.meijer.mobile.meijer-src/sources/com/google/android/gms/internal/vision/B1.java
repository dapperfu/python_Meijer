...
final class B1 {
    static String a(InterfaceC11208w1 interfaceC11208w1, String str) throws SecurityException {
        StringBuilder sb2 = new StringBuilder();
        sb2.append("# ");
        sb2.append(str);
        c(interfaceC11208w1, sb2, 0);
        return sb2.toString();
    }
    ...
    */
    private static void c(com.google.android.gms.internal.vision.InterfaceC11208w1 r13, java.lang.StringBuilder r14, int r15) throws java.lang.SecurityException {
        /*
    ...
    static final void d(StringBuilder sb2, int i10, String str, Object obj) throws SecurityException {
        ...
        if (obj instanceof String) {
            sb2.append(": \"");
            sb2.append(C11139b2.a(AbstractC11161h0.l((String) obj)));
            sb2.append('\"');
            return;
        }
        if (obj instanceof AbstractC11161h0) {
            sb2.append(": \"");
            sb2.append(C11139b2.a((AbstractC11161h0) obj));
            sb2.append('\"');
            return;
        }
