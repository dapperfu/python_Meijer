...
final class P1 {
    ...
    private static final Class<?> f85281a = F();

    /* renamed from: b, reason: collision with root package name */
    private static final AbstractC11155f2<?, ?> f85282b = g(false);

    /* renamed from: c, reason: collision with root package name */
    private static final AbstractC11155f2<?, ?> f85283c = g(true);

    /* renamed from: d, reason: collision with root package name */
    private static final AbstractC11155f2<?, ?> f85284d = new C11159g2();

    private static AbstractC11155f2<?, ?> g(boolean z10) {
        try {
            Class<?> clsJ = J();
            if (clsJ == null) {
                return null;
            }
            return (AbstractC11155f2) clsJ.getConstructor(Boolean.TYPE).newInstance(Boolean.valueOf(z10));
        } catch (Throwable unused) {
            return null;
        }
    }

    public static AbstractC11155f2<?, ?> B() {
        return f85284d;
    }
    ...
    static int a(int i10, Object obj, O1 o12) {
        return obj instanceof C11150e1 ? zzii.c(i10, (C11150e1) obj) : zzii.F(i10, (InterfaceC11208w1) obj, o12);
    }
    ...
    public static AbstractC11155f2<?, ?> f() {
        return f85282b;
    }

    static <UT, UB> UB h(int i10, int i11, UB ub2, AbstractC11155f2<UT, UB> abstractC11155f2) {
        if (ub2 == null) {
            ub2 = abstractC11155f2.a();
        }
        abstractC11155f2.b(ub2, i10, i11);
        return ub2;
    }

    static <UT, UB> UB i(int i10, List<Integer> list, T0 t02, UB ub2, AbstractC11155f2<UT, UB> abstractC11155f2) {
        if (t02 == null) {
            return ub2;
        }
        if (!(list instanceof RandomAccess)) {
            ...
            while (it.hasNext()) {
                ...
                if (!t02.zza(iIntValue)) {
                    ub2 = (UB) h(i10, iIntValue, ub2, abstractC11155f2);
                    it.remove();
                }
            }
            return ub2;
        ...
        for (int i12 = 0; i12 < size; i12++) {
            ...
            if (t02.zza(iIntValue2)) {
                ...
                ub2 = (UB) h(i10, iIntValue2, ub2, abstractC11155f2);
            }
        }
        if (i11 != size) {
    ...
    public static void p(Class<?> cls) {
        Class<?> cls2;
        if (!O0.class.isAssignableFrom(cls) && (cls2 = f85281a) != null && !cls2.isAssignableFrom(cls)) {
    ...
    public static AbstractC11155f2<?, ?> v() {
        return f85283c;
    }

    public static void w(int i10, List<AbstractC11161h0> list, C2 c22) throws IOException {
        if (list == null || list.isEmpty()) {
            return;
        }
        c22.q(i10, list);
    ...
    static int A(List<Long> list) {
        ...
        if (list instanceof C11170j1) {
            C11170j1 c11170j1 = (C11170j1) list;
            int iN0 = 0;
            while (i10 < size) {
                iN0 += zzii.n0(c11170j1.f(i10));
                i10++;
            }
            return iN0;
        }
    ...
    static int b(int i10, List<?> list) {
        ...
        if (list instanceof InterfaceC11158g1) {
            ...
            while (i11 < size) {
                ...
                if (objZzb instanceof AbstractC11161h0) {
                    iK2 = zzii.I((AbstractC11161h0) objZzb);
                } else {
        ...
        while (i11 < size) {
            ...
            if (obj instanceof AbstractC11161h0) {
                iK = zzii.I((AbstractC11161h0) obj);
            } else {
    ...
    static int c(int i10, List<?> list, O1 o12) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            if (obj instanceof C11150e1) {
                iE = zzii.d((C11150e1) obj);
            } else {
                iE = zzii.e((InterfaceC11208w1) obj, o12);
            }
            iG0 += iE;
        }
        return iG0;
    ...
    static <T, FT extends I0<FT>> void m(C0<FT> c02, T t10, T t11) {
        G0<T> g0B = c02.b(t11);
        if (!g0B.f85140a.isEmpty()) {
            c02.f(t10).f(g0B);
        }
    }

    static <T> void n(InterfaceC11199t1 interfaceC11199t1, T t10, T t11, long j10) {
        l2.j(t10, j10, interfaceC11199t1.b(l2.F(t10, j10), l2.F(t11, j10)));
    }

    static <T, UT, UB> void o(AbstractC11155f2<UT, UB> abstractC11155f2, T t10, T t11) {
        abstractC11155f2.e(t10, abstractC11155f2.i(abstractC11155f2.f(t10), abstractC11155f2.f(t11)));
    }

    static int r(int i10, List<AbstractC11161h0> list) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
    ...
    static int s(int i10, List<InterfaceC11208w1> list, O1 o12) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
