...
final class C8072ew0 extends AbstractC7965dw0 {
    C8072ew0() {
    }

    @Override // com.google.android.gms.internal.ads.AbstractC7965dw0
        ...
        while (i10 < i13) {
            ...
            if (C7859cw0.d(b11)) {
                ...
                if (C7859cw0.f(b11)) {
                    ...
                    i12 = i15 + 1;
                    i10 += 2;
                    C7859cw0.c(b11, bArr[i16], cArr, i15);
                } else if (C7859cw0.e(b11)) {
                    if (i16 >= i13 - 1) {
                        throw new zzgyg("Protocol message had invalid UTF-8.");
                    }
                    i12 = i15 + 1;
                    int i17 = i10 + 2;
                    i10 += 3;
                    C7859cw0.b(b11, bArr[i16], bArr[i17], cArr, i15);
                } else {
                    if (i16 >= i13 - 2) {
                        throw new zzgyg("Protocol message had invalid UTF-8.");
                    }
                    ...
                    byte b14 = bArr[i10 + 2];
                    i10 += 4;
                    C7859cw0.a(b11, b13, b14, bArr[i18], cArr, i15);
                    i15 += 2;
                }
                i15 = i12;
            }
    ...
    */
    final int a(int r12, byte[] r13, int r14, int r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.C8072ew0.a(int, byte[], int, int):int");
    }
}
