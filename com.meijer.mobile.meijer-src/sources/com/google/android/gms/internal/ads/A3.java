...
final class A3 {
    ...
    */
    public static com.google.android.gms.internal.ads.InterfaceC7009Ka a(com.google.android.gms.internal.ads.GQ r15) {
        /*
    ...
    private static int b(GQ gq2) {
        ...
        C10042xL.f("MetadataUtil", "Failed to parse data atom to int");
        return -1;
    }

    private static AbstractC8938n2 c(int i10, String str, GQ gq2, boolean z10, boolean z11) {
        int iB = b(gq2);
        if (z11) {
            iB = Math.min(1, iB);
        }
        if (iB >= 0) {
            if (z10) {
                return new C9900w2(str, null, AbstractC8042eh0.u(Integer.toString(iB)));
            }
            return new C8298h2("und", str, Integer.toString(iB));
        }
        C10042xL.f("MetadataUtil", "Failed to parse uint8 attribute: ".concat(XZ.a(i10)));
        return null;
    }

    private static C9900w2 d(int i10, String str, GQ gq2) {
        int iW = gq2.w();
        if (gq2.w() == 1684108385 && iW >= 22) {
            ...
            if (iG > 0) {
                ...
                int iG2 = gq2.G();
                if (iG2 > 0) {
                    string = string + com.medallia.digital.mobilesdk.q2.f93563c + iG2;
                }
                return new C9900w2(str, null, AbstractC8042eh0.u(string));
            }
        }
        C10042xL.f("MetadataUtil", "Failed to parse index/count attribute: ".concat(XZ.a(i10)));
        return null;
    }

    private static C9900w2 e(int i10, String str, GQ gq2) {
        int iW = gq2.w();
        if (gq2.w() == 1684108385) {
            gq2.m(8);
            return new C9900w2(str, null, AbstractC8042eh0.u(gq2.a(iW - 16)));
        }
        C10042xL.f("MetadataUtil", "Failed to parse text attribute: ".concat(XZ.a(i10)));
        return null;
    }
}
