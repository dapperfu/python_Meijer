...
public final class C10123y60 {

    /* renamed from: a, reason: collision with root package name */
    private final M9 f80814a;

    public C10123y60(M9 m92) {
        this.f80814a = m92;
    }
    ...
    public final Uri a(Uri uri, Context context, View view, Activity activity) throws zzavb {
        try {
            return b(uri, this.f80814a.c().zze(context, uri.getQueryParameter("ai"), view, activity));
