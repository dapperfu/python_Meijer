...
public final class M {
    ...
    private static final int[] f69319a = {96000, 88200, 64000, 48000, 44100, 32000, 24000, 22050, 16000, 12000, 11025, 8000, 7350};

    /* renamed from: b, reason: collision with root package name */
    private static final int[] f69320b = {0, 1, 2, 3, 4, 5, 6, 8, -1, -1, -1, 7, 8, -1, 8, -1};

    private static int c(C8124fQ c8124fQ) {
        int iD = c8124fQ.d(5);
        return iD == 31 ? c8124fQ.d(6) + 32 : iD;
    }

    private static int d(C8124fQ c8124fQ) throws zzbc {
        int iD = c8124fQ.d(4);
        if (iD == 15) {
            if (c8124fQ.a() >= 24) {
                return c8124fQ.d(24);
    ...
    public static K a(byte[] bArr) throws zzbc {
        return b(new C8124fQ(bArr, bArr.length), false);
    }
    ...
    */
    public static com.google.android.gms.internal.ads.K b(com.google.android.gms.internal.ads.C8124fQ r11, boolean r12) throws com.google.android.gms.internal.ads.zzbc {
        /*
            int r0 = c(r11)
            int r1 = d(r11)
            r2 = 4
        ...
        L65:
            ...
            com.google.android.gms.internal.ads.C10042xL.f(r2, r10)
        L72:
            boolean r2 = r11.p()
            if (r2 == 0) goto L7d
            r2 = 14
        ...
        Lce:
            ...
            throw r11
        Ld4:
            int[] r11 = com.google.android.gms.internal.ads.M.f69320b
            r11 = r11[r3]
            r12 = -1
            r0 = 0
            if (r11 == r12) goto Le2
