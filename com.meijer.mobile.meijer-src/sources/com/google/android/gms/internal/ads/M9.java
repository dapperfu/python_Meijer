...
public final class M9 {
    ...
    private static final String[] f69390d = {"/aclk", "/pcs/click", "/dbm/clk"};

    /* renamed from: a, reason: collision with root package name */
    private final String f69391a = "ad.doubleclick.net";

    /* renamed from: b, reason: collision with root package name */
    private final String[] f69392b = {".doubleclick.net", ".googleadservices.com", ".googlesyndication.com"};

    /* renamed from: c, reason: collision with root package name */
    private final G9 f69393c;
    ...
    private final Uri g(Uri uri, String str) throws zzavb {
        try {
            ...
            try {
                if (uri.getHost().equals(this.f69391a)) {
    ...
    public final Uri a(Uri uri, Context context, View view, Activity activity) throws zzavb {
        try {
            return g(uri, this.f69393c.zze(context, uri.getQueryParameter("ai"), view, activity));
    ...
    public final Uri b(Uri uri, Context context) throws zzavb {
        return g(uri, this.f69393c.zzf(context));
    }

    @Deprecated
    public final void d(MotionEvent motionEvent) {
        this.f69393c.zzk(motionEvent);
    }

    public final boolean e(Uri uri) {
        if (f(uri)) {
            String[] strArr = f69390d;
