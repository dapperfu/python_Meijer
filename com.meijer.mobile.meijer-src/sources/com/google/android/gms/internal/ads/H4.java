...
final class H4 {
    ...
    public final Integer f68179c;

    /* renamed from: d, reason: collision with root package name */
    public final Integer f68180d;

    /* renamed from: e, reason: collision with root package name */
    public final float f68181e;

    /* renamed from: f, reason: collision with root package name */
    public final boolean f68182f;

    /* renamed from: g, reason: collision with root package name */
    public final boolean f68183g;
    ...
    private static boolean e(String str) throws NumberFormatException {
        try {
            ...
            C10042xL.g("SsaStyle", "Failed to parse boolean value: '" + str + "'", e10);
            return false;
        }
    }
    ...
    public static H4 b(String str, F4 f42) throws NumberFormatException {
        ...
        boolean z10;
        int i10;
        C8211gC.d(str.startsWith("Style:"));
        String[] strArrSplit = TextUtils.split(str.substring(6), ",");
        int length = strArrSplit.length;
        int i11 = f42.f67553k;
        if (length != i11) {
            C10042xL.f("SsaStyle", String.format(Locale.US, "Skipping malformed 'Style:' line (expected %s values, found %s): '%s'", Integer.valueOf(i11), Integer.valueOf(length), str));
            return null;
        }
        try {
            String strTrim = strArrSplit[f42.f67543a].trim();
            int i12 = f42.f67544b;
            ...
            if (i15 != -1) {
                ...
                try {
                    ...
                    try {
                        ...
                        sb2.append(strTrim2);
                        sb2.append("'");
                        C10042xL.g("SsaStyle", sb2.toString(), e10);
                    } catch (RuntimeException e11) {
                        e = e11;
                        C10042xL.g("SsaStyle", "Skipping malformed 'Style:' line: '" + str + "'", e);
                        return h42;
                    }
                }
            } else {
            ...
            if (i20 != -1) {
                ...
                C10042xL.f("SsaStyle", "Ignoring unknown BorderStyle: ".concat(String.valueOf(strTrim3)));
                i10 = -1;
            } else {
                i10 = -1;
            }
    ...
    public static int d(String str) throws NumberFormatException {
        ...
        switch (i10) {
            ...
            case 9:
                return i10;
            default:
                C10042xL.f("SsaStyle", "Ignoring unknown alignment: ".concat(String.valueOf(str)));
                return -1;
        }
    }
}
