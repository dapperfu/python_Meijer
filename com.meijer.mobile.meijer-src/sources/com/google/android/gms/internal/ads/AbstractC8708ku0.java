...
public abstract class AbstractC8708ku0 extends Qt0 {

    /* renamed from: b, reason: collision with root package name */
    private static final Logger f76551b = Logger.getLogger(AbstractC8708ku0.class.getName());

    /* renamed from: c, reason: collision with root package name */
    private static final boolean f76552c = C7753bw0.a();

    /* renamed from: d, reason: collision with root package name */
    public static final /* synthetic */ int f76553d = 0;

    /* renamed from: a, reason: collision with root package name */
    C8815lu0 f76554a;

    private AbstractC8708ku0() {
        throw null;
    }
    ...
    abstract void u(int i10, InterfaceC9245pv0 interfaceC9245pv0, Hv0 hv0) throws IOException;

    public abstract void v(int i10, InterfaceC9245pv0 interfaceC9245pv0) throws IOException;
    ...
    /* synthetic */ AbstractC8708ku0(C8601ju0 c8601ju0) {
    }

    @Deprecated
    static int D(int i10, InterfaceC9245pv0 interfaceC9245pv0, Hv0 hv0) {
        int iE = e(i10 << 3);
        return iE + iE + ((Ht0) interfaceC9245pv0).e(hv0);
    }

    static int b(InterfaceC9245pv0 interfaceC9245pv0, Hv0 hv0) {
        int iE = ((Ht0) interfaceC9245pv0).e(hv0);
        return e(iE) + iE;
    }

    final void h(String str, C8179fw0 c8179fw0) throws IOException {
        f76551b.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable) c8179fw0);
        byte[] bytes = str.getBytes(Tu0.f71312a);
        try {
    ...
    public static int E(InterfaceC9245pv0 interfaceC9245pv0) {
        int iZzaY = interfaceC9245pv0.zzaY();
    ...
    public static int d(String str) {
        int length;
        try {
            length = C8286gw0.e(str);
        } catch (C8179fw0 unused) {
            length = str.getBytes(Tu0.f71312a).length;
        }
