...
public final class C8245gc {
    ...
    static String b(String[] strArr, int i10, int i11) {
        ...
        if (strArr.length < i12) {
            Sc.p.d("Unable to construct shingle");
            return "";
        }
    ...
    private static long e(String[] strArr, int i10, int i11) {
        long jA = (C7818cc.a(strArr[0]) + 2147483647L) % 1073807359;
        for (int i12 = 1; i12 < i11; i12++) {
            jA = (((jA * 16785407) % 1073807359) + ((C7818cc.a(strArr[i12]) + 2147483647L) % 1073807359)) % 1073807359;
        }
        return jA;
    }
    ...
    public static void c(String[] strArr, int i10, int i11, PriorityQueue priorityQueue) throws UnsupportedEncodingException {
        ...
        while (true) {
            ...
            long jA = C7818cc.a(strArr[i12 - 1]);
            long jA2 = C7818cc.a(strArr[i12 + 5]);
    ...
    static void d(int i10, long j10, String str, int i11, PriorityQueue priorityQueue) {
        C8138fc c8138fc = new C8138fc(j10, str, i11);
        if ((priorityQueue.size() != i10 || (((C8138fc) priorityQueue.peek()).f74969c <= c8138fc.f74969c && ((C8138fc) priorityQueue.peek()).f74967a <= c8138fc.f74967a)) && !priorityQueue.contains(c8138fc)) {
            priorityQueue.add(c8138fc);
