...
public final class Ii0 extends Ji0 {
    public static int b(long j10) {
        int i10 = (int) j10;
        C6782Df0.h(((long) i10) == j10, "Out of range: %s", j10);
        return i10;
    }

    public static int c(int i10, int i11, int i12) {
        C6782Df0.j(true, "min (%s) must be less than or equal to max (%s)", i11, 1073741823);
        int[] iArr = {i10, i11};
        int i13 = iArr[0];
    ...
    public static int d(byte[] bArr) {
        ...
        C6782Df0.j(length >= 4, "array too small: %s < %s", length, 4);
