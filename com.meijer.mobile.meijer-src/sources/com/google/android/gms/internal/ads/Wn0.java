...
public final class Wn0 implements InterfaceC9543sk0 {

    /* renamed from: a, reason: collision with root package name */
    private final byte[] f72001a;

    /* renamed from: b, reason: collision with root package name */
    private final byte[] f72002b;
    ...
    public final byte[] zza(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ...
        System.arraycopy(bArr, this.f72002b.length, bArr4, 0, 24);
        int[] iArrD = Gn0.d(Gn0.e(this.f72001a), Gn0.e(bArr4));
        ...
        return cipherB.doFinal(bArr, this.f72002b.length + 24, (r1 - r10) - 24);
    }
