        ...
        if (jSONArray != null && str != null) {
            for (int i10 = 0; i10 < jSONArray.length(); i10++) {
                ...
                try {
                    ...
                    Nc.v.s().x(e10, "RtbAdapterMap.hasAtleastOneRegexMatch");
                }
                if ((((Boolean) Oc.A.c().a(C8784lf.f76933Oa)).booleanValue() ? Pattern.compile(strOptString, 2) : Pattern.compile(strOptString)).matcher(str).lookingAt()) {
                    return true;
                }
            }
        }
