...
public abstract class Zt0 implements Iterable<Byte>, Serializable {
    ...
    public static final Zt0 f73122b = new Wt0(Tu0.f71313b);

    /* renamed from: a, reason: collision with root package name */
    private int f73123a = 0;
    ...
    public abstract AbstractC8068eu0 q();
    ...
    public static Zt0 B(String str) {
        return new Wt0(str.getBytes(Tu0.f71312a));
    }
    ...
    public static Zt0 y(Iterable iterable) {
        ...
        return size == 0 ? f73122b : h(iterable.iterator(), size);
    }
