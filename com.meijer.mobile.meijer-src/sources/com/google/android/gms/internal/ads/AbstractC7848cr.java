...
abstract class AbstractC7848cr {

    /* renamed from: a, reason: collision with root package name */
    private final WeakReference f74106a;
    ...
    protected final ViewTreeObserver c() {
        ...
        View view = (View) this.f74106a.get();
    ...
    public AbstractC7848cr(View view) {
        this.f74106a = new WeakReference(view);
    }
