...
public final class GQ {
    ...
    private static final char[] f68026d = {'\r', '\n'};

    /* renamed from: e, reason: collision with root package name */
    private static final char[] f68027e = {'\n'};

    /* renamed from: f, reason: collision with root package name */
    private static final AbstractC8575jh0 f68028f = AbstractC8575jh0.y(StandardCharsets.US_ASCII, StandardCharsets.UTF_8, StandardCharsets.UTF_16, StandardCharsets.UTF_16BE, StandardCharsets.UTF_16LE);

    /* renamed from: a, reason: collision with root package name */
    private byte[] f68029a;
    ...
    public final String b(int i10, Charset charset) {
        byte[] bArr = this.f68029a;
        int i11 = this.f68030b;
        String str = new String(bArr, i11, i10, charset);
        this.f68030b = i11 + i10;
        return str;
    }
    ...
    public final void k(int i10) {
        boolean z10 = false;
        if (i10 >= 0 && i10 <= this.f68029a.length) {
            z10 = true;
        }
        C8211gC.d(z10);
        this.f68031c = i10;
    ...
    public final int r() {
        return this.f68031c - this.f68030b;
    }
    ...
    */
    ...
    public final long N() {
        int i10;
        int i11;
        long j10 = this.f68029a[this.f68030b];
        int i12 = 7;
        while (true) {
            i10 = 0;
            if (i12 < 0) {
        ...
        for (i11 = 1; i11 < i10; i11++) {
            if ((this.f68029a[this.f68030b + i11] & 192) != 128) {
    ...
    public final String O(char c10) {
        int i10 = this.f68031c;
        int i11 = this.f68030b;
        if (i10 - i11 == 0) {
            return null;
        }
        while (i11 < this.f68031c && this.f68029a[i11] != 0) {
            i11++;
        }
        byte[] bArr = this.f68029a;
        int i12 = this.f68030b;
    ...
    */
    public final java.lang.String P(java.nio.charset.Charset r5) {
        /*
            r4 = this;
            com.google.android.gms.internal.ads.jh0 r0 = com.google.android.gms.internal.ads.GQ.f68028f
            boolean r0 = r0.contains(r5)
            java.lang.String r1 = java.lang.String.valueOf(r5)
            java.lang.String r2 = "Unsupported charset: "
            java.lang.String r1 = r2.concat(r1)
            com.google.android.gms.internal.ads.C8211gC.e(r0, r1)
            int r0 = r4.f68031c
            int r1 = r4.f68030b
            int r0 = r0 - r1
            if (r0 != 0) goto L1c
        ...
        Lbf:
            ...
            int r2 = r4.f68031c
            if (r1 == r2) goto Ldb
            char[] r1 = com.google.android.gms.internal.ads.GQ.f68026d
            char r1 = r4.o(r5, r1)
            r2 = 13
            if (r1 != r2) goto Ldb
            char[] r1 = com.google.android.gms.internal.ads.GQ.f68027e
            r4.o(r5, r1)
        Ldb:
            return r0
        */
    ...
    public final String a(int i10) {
        ...
        int i11 = this.f68030b;
        int i12 = (i11 + i10) - 1;
        String strC = OV.c(this.f68029a, i11, (i12 >= this.f68031c || this.f68029a[i12] != 0) ? i10 : i10 - 1);
        this.f68030b += i10;
        return strC;
    }
    ...
    public final void f(int i10) {
        byte[] bArr = this.f68029a;
        if (i10 > bArr.length) {
            this.f68029a = Arrays.copyOf(bArr, i10);
        }
    }

    public final void g(C8124fQ c8124fQ, int i10) {
        h(c8124fQ.f74940a, 0, i10);
        c8124fQ.l(0);
    }

    public final void h(byte[] bArr, int i10, int i11) {
        System.arraycopy(this.f68029a, this.f68030b, bArr, i10, i11);
        this.f68030b += i11;
    }
    ...
    public final char q(Charset charset) {
        C8211gC.e(f68028f.contains(charset), "Unsupported charset: ".concat(String.valueOf(charset)));
        return (char) (p(charset) >> 16);
    }

    public final int s() {
        return this.f68029a.length;
    }

    public final int v() {
        return this.f68029a[this.f68030b] & 255;
    }
