...
final class C8286gw0 {

    /* renamed from: a, reason: collision with root package name */
    private static final AbstractC7965dw0 f75389a;
    ...
    static String f(ByteBuffer byteBuffer, int i10, int i11) throws zzgyg {
        AbstractC7965dw0 abstractC7965dw0 = f75389a;
        if (byteBuffer.hasArray()) {
            return abstractC7965dw0.b(byteBuffer.array(), byteBuffer.arrayOffset() + i10, i11);
        }
        return byteBuffer.isDirect() ? AbstractC7965dw0.c(byteBuffer, i10, i11) : AbstractC7965dw0.c(byteBuffer, i10, i11);
    }

    static String g(byte[] bArr, int i10, int i11) throws zzgyg {
        return f75389a.b(bArr, i10, i11);
    }

    static boolean h(byte[] bArr, int i10, int i11) {
        return f75389a.a(0, bArr, i10, i11) == 0;
    }

    static {
        if (C7753bw0.a() && C7753bw0.b()) {
            int i10 = Lt0.f69290a;
        }
        f75389a = new C8072ew0();
    }
                    ...
                    if (cCharAt2 < 2048) {
                        ...
                        if (cCharAt2 >= 55296 && cCharAt2 <= 57343) {
                            if (Character.codePointAt(str, i11) >= 65536) {
                                ...
                                throw new C8179fw0(i11, length2);
                            }
                        }
                    }
                    i11++;
