...
abstract class Uj0 extends AtomicReference implements Runnable {
    ...
    private static final Runnable f71529a = new Sj0(null);

    /* renamed from: b, reason: collision with root package name */
    private static final Runnable f71530b = new Sj0(null);
        ...
        if (runnable instanceof Thread) {
            ...
            if (compareAndSet(runnable, rj0)) {
                try {
                    ...
                    thread.interrupt();
                    if (((Runnable) getAndSet(f71529a)) == f71530b) {
        ...
        if (compareAndSet(null, threadCurrentThread)) {
            ...
            if (!zF) {
                try {
                    ...
                    try {
                        C8262gk0.a(th2);
                        if (!compareAndSet(threadCurrentThread, f71529a)) {
