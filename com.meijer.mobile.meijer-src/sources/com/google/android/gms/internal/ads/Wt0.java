...
class Wt0 extends Vt0 {
    ...
    @Override // com.google.android.gms.internal.ads.Zt0
    public int k() {
        return this.f72036c.length;
    }

    @Override // com.google.android.gms.internal.ads.Zt0
    public byte e(int i10) {
        return this.f72036c[i10];
    }
    ...
    protected void l(byte[] bArr, int i10, int i11, int i12) {
        System.arraycopy(this.f72036c, i10, bArr, i11, i12);
    }

    @Override // com.google.android.gms.internal.ads.Zt0
    public final AbstractC8068eu0 q() {
        return AbstractC8068eu0.f(this.f72036c, F(), k(), true);
    }

    @Override // com.google.android.gms.internal.ads.Zt0
    public final ByteBuffer r() {
        return ByteBuffer.wrap(this.f72036c, F(), k()).asReadOnlyBuffer();
    }

    @Override // com.google.android.gms.internal.ads.Zt0
    final void s(Qt0 qt0) throws IOException {
        qt0.a(this.f72036c, F(), k());
    }
        ...
        if (i11 <= zt0.k()) {
            ...
            if (i12 <= zt0.k()) {
                if (zt0 instanceof Wt0) {
                    Wt0 wt0 = (Wt0) zt0;
                    byte[] bArr = this.f72036c;
                    byte[] bArr2 = wt0.f72036c;
                    int iF = F() + i11;
                    int iF2 = F();
                    int iF3 = wt0.F() + i10;
                    while (iF2 < iF) {
    ...
    protected final int o(int i10, int i11, int i12) {
        return Tu0.b(i10, this.f72036c, F() + i11, i12);
    }
    ...
    public final Zt0 p(int i10, int i11) {
        ...
        return new Tt0(this.f72036c, F() + i10, iT);
    }
}
