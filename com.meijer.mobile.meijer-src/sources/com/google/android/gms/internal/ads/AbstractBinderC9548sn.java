...
public abstract class AbstractBinderC9548sn extends BinderC8990nb implements InterfaceC9655tn {
    public AbstractBinderC9548sn() {
        super("com.google.android.gms.ads.internal.overlay.client.IAdOverlay");
    }

    public static InterfaceC9655tn B9(IBinder iBinder) {
        if (iBinder == null) {
            return null;
        }
        ...
        return iInterfaceQueryLocalInterface instanceof InterfaceC9655tn ? (InterfaceC9655tn) iInterfaceQueryLocalInterface : new C9441rn(iBinder);
    }
    ...
    protected final boolean A9(int i10, Parcel parcel, Parcel parcel2, int i11) throws RemoteException {
        switch (i10) {
            ...
            case 15:
                ...
                C9097ob.c(parcel);
                F2(i15, strArrCreateStringArray, iArrCreateIntArray);
                parcel2.writeNoException();
                return true;
            default:
                return false;
