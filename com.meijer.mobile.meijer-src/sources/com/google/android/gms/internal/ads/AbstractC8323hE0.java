...
public abstract class AbstractC8323hE0 extends Ly0 {

    /* renamed from: y0, reason: collision with root package name */
    private static final byte[] f75481y0 = {0, 0, 1, 103, 66, -64, C14170dq.DST_ATOP, -38, 37, -112, 0, 0, 1, 104, -50, C14170dq.MULTIPLY, 19, 32, 0, 0, 1, 101, -120, -124, C14170dq.DARKEN, -50, 113, 24, -96, 0, 47, -65, 28, 49, -61, 39, 93, 120};

    /* renamed from: A, reason: collision with root package name */
    private final C9282qD0 f75482A;
    ...
    private MediaCrypto f75486E;

    /* renamed from: F, reason: collision with root package name */
    private float f75487F;
    ...
    private MediaFormat f75491J;

    /* renamed from: K, reason: collision with root package name */
    private boolean f75492K;

    /* renamed from: L, reason: collision with root package name */
    private float f75493L;

    /* renamed from: M, reason: collision with root package name */
    private ArrayDeque f75494M;

    /* renamed from: N, reason: collision with root package name */
    private zzsj f75495N;

    /* renamed from: O, reason: collision with root package name */
    private C7683bE0 f75496O;

    /* renamed from: P, reason: collision with root package name */
    private int f75497P;

    /* renamed from: Q, reason: collision with root package name */
    private boolean f75498Q;

    /* renamed from: R, reason: collision with root package name */
    private boolean f75499R;

    /* renamed from: S, reason: collision with root package name */
    private boolean f75500S;

    /* renamed from: T, reason: collision with root package name */
    private boolean f75501T;

    /* renamed from: U, reason: collision with root package name */
    private boolean f75502U;

    /* renamed from: V, reason: collision with root package name */
    private boolean f75503V;

    /* renamed from: W, reason: collision with root package name */
    private long f75504W;

    /* renamed from: X, reason: collision with root package name */
    private long f75505X;
    ...
    private ByteBuffer f75508a0;

    /* renamed from: b0, reason: collision with root package name */
    private boolean f75509b0;

    /* renamed from: c0, reason: collision with root package name */
    private boolean f75510c0;

    /* renamed from: d0, reason: collision with root package name */
    private boolean f75511d0;

    /* renamed from: e0, reason: collision with root package name */
    private boolean f75512e0;

    /* renamed from: f0, reason: collision with root package name */
    private boolean f75513f0;

    /* renamed from: g0, reason: collision with root package name */
    private boolean f75514g0;

    /* renamed from: h0, reason: collision with root package name */
    private int f75515h0;

    /* renamed from: i0, reason: collision with root package name */
    private int f75516i0;

    /* renamed from: j0, reason: collision with root package name */
    private int f75517j0;

    /* renamed from: k0, reason: collision with root package name */
    private boolean f75518k0;

    /* renamed from: l0, reason: collision with root package name */
    private boolean f75519l0;

    /* renamed from: m0, reason: collision with root package name */
    private boolean f75520m0;

    /* renamed from: n0, reason: collision with root package name */
    private long f75521n0;

    /* renamed from: o0, reason: collision with root package name */
    private long f75522o0;

    /* renamed from: p0, reason: collision with root package name */
    private boolean f75523p0;

    /* renamed from: q0, reason: collision with root package name */
    private boolean f75524q0;

    /* renamed from: r, reason: collision with root package name */
    private final XD0 f75525r;

    /* renamed from: r0, reason: collision with root package name */
    private boolean f75526r0;

    /* renamed from: s, reason: collision with root package name */
    private final InterfaceC8535jE0 f75527s;

    /* renamed from: s0, reason: collision with root package name */
    protected My0 f75528s0;

    /* renamed from: t, reason: collision with root package name */
    private final float f75529t;

    /* renamed from: t0, reason: collision with root package name */
    private C8109fE0 f75530t0;

    /* renamed from: u, reason: collision with root package name */
    private final By0 f75531u;

    /* renamed from: u0, reason: collision with root package name */
    private long f75532u0;

    /* renamed from: v, reason: collision with root package name */
    private final By0 f75533v;

    /* renamed from: v0, reason: collision with root package name */
    private boolean f75534v0;

    /* renamed from: w, reason: collision with root package name */
    private final By0 f75535w;

    /* renamed from: w0, reason: collision with root package name */
    private CD0 f75536w0;

    /* renamed from: x, reason: collision with root package name */
    private final PD0 f75537x;

    /* renamed from: x0, reason: collision with root package name */
    private CD0 f75538x0;

    /* renamed from: y, reason: collision with root package name */
    private final MediaCodec.BufferInfo f75539y;

    /* renamed from: z, reason: collision with root package name */
    private final ArrayDeque f75540z;

    private final void E0() {
        this.f75506Y = -1;
        this.f75533v.f66471d = null;
    }
    ...
    private final void j0(C8109fE0 c8109fE0) {
        this.f75530t0 = c8109fE0;
        if (c8109fE0.f74906c != -9223372036854775807L) {
            this.f75534v0 = true;
        }
    }

    private final boolean m0() {
        return this.f75507Z >= 0;
    }
    ...
    protected final void Y() {
        try {
            ZD0 zd0 = this.f75489H;
            if (zd0 != null) {
                zd0.zzm();
                this.f75528s0.f69609b++;
                C7683bE0 c7683bE0 = this.f75496O;
                if (c7683bE0 == null) {
                    throw null;
                }
                C0(c7683bE0.f73607a);
    ...
    public boolean a() {
        return this.f75524q0;
    }

    protected final boolean d0() {
        return this.f75511d0;
    }

    protected boolean f0(C7683bE0 c7683bE0) {
        return true;
    }
    ...
    */
    public void m(long r19, long r21) throws com.google.android.gms.internal.ads.zzib {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.AbstractC8323hE0.m(long, long):void");
    }

    protected abstract int q0(InterfaceC8535jE0 interfaceC8535jE0, C c10) throws zzsu;

    protected abstract Ny0 r0(C7683bE0 c7683bE0, C c10, C c11);
    ...
    */
    protected com.google.android.gms.internal.ads.Ny0 s0(com.google.android.gms.internal.ads.Zz0 r12) throws com.google.android.gms.internal.ads.zzib {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.AbstractC8323hE0.s0(com.google.android.gms.internal.ads.Zz0):com.google.android.gms.internal.ads.Ny0");
    }

    protected abstract WD0 v0(C7683bE0 c7683bE0, C c10, MediaCrypto mediaCrypto, float f10);

    protected abstract List w0(InterfaceC8535jE0 interfaceC8535jE0, C c10, boolean z10) throws zzsu;
    ...
    protected static boolean h0(C c10) {
        return c10.f66488K == 0;
    }

    private final void k0() throws zzib {
        CD0 cd0 = this.f75538x0;
        cd0.getClass();
        this.f75536w0 = cd0;
        this.f75516i0 = 0;
        this.f75517j0 = 0;
    ...
    private final boolean n0(long j10, long j11) {
        ...
        C c10 = this.f75484C;
        return (c10 != null && Objects.equals(c10.f66504o, "audio/opus") && M0.f(j10, j11)) ? false : true;
    }

    private final boolean o0(int i10) throws zzib {
        By0 by0 = this.f75531u;
        Zz0 zz0L = L();
        by0.b();
        int iF = F(zz0L, this.f75531u, i10 | 4);
        if (iF == -5) {
            s0(zz0L);
            return true;
        }
        if (iF != -4 || !this.f75531u.f()) {
            return false;
        }
        this.f75523p0 = true;
        y0();
    ...
    private final boolean p0(C c10) throws zzib {
        if (OV.f69931a >= 23 && this.f75489H != null && this.f75517j0 != 3 && k() != 0) {
            float f10 = this.f75488G;
            c10.getClass();
            float fR = R(f10, c10, D());
            float f11 = this.f75493L;
            if (f11 != fR) {
                if (fR == -1.0f) {
                    u0();
                    return false;
                }
                if (f11 != -1.0f || fR > this.f75529t) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    protected void B(com.google.android.gms.internal.ads.C[] r13, long r14, long r16, com.google.android.gms.internal.ads.C7578aF0 r18) throws com.google.android.gms.internal.ads.zzib {
        /*
            r12 = this;
            com.google.android.gms.internal.ads.fE0 r13 = r12.f75530t0
            long r0 = r13.f74906c
            ...
            return
        L1e:
            java.util.ArrayDeque r13 = r12.f75540z
            boolean r13 = r13.isEmpty()
            if (r13 == 0) goto L52
            long r0 = r12.f75521n0
            int r13 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
            if (r13 == 0) goto L36
            long r4 = r12.f75532u0
        ...
        L52:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.AbstractC8323hE0.B(com.google.android.gms.internal.ads.C[], long, long, com.google.android.gms.internal.ads.aF0):void");
    }

    protected final long L0() {
        return this.f75530t0.f74906c;
    }

    protected final long M0() {
        return this.f75530t0.f74905b;
    }

    protected zzsf S(Throwable th2, C7683bE0 c7683bE0) {
        return new zzsf(th2, c7683bE0);
    }
    ...
    */
    protected final void U() throws com.google.android.gms.internal.ads.zzib {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.AbstractC8323hE0.U():void");
    }

    protected void V(long j10) {
        this.f75532u0 = j10;
        while (!this.f75540z.isEmpty() && j10 >= ((C8109fE0) this.f75540z.peek()).f74904a) {
            C8109fE0 c8109fE0 = (C8109fE0) this.f75540z.poll();
            c8109fE0.getClass();
            j0(c8109fE0);
            F0();
        }
    ...
    protected final boolean c0() {
        if (this.f75489H == null) {
            return false;
        }
        int i10 = this.f75517j0;
        if (i10 == 3 || ((this.f75498Q && !this.f75520m0) || (this.f75499R && this.f75519l0))) {
            Y();
            return true;
        }
        if (i10 == 2) {
            ...
            if (i11 >= 23) {
                try {
                    ...
                    C10042xL.g("MediaCodecRenderer", "Failed to update the DRM session, releasing the codec instead.", e10);
                    Y();
                    return true;
                }
            }
    ...
    protected final boolean e0(C c10) {
        return this.f75538x0 == null && I0(c10);
    }

    @Override // com.google.android.gms.internal.ads.IA0
    public final int g(C c10) throws zzib {
        try {
            return q0(this.f75527s, c10);
        } catch (zzsu e10) {
    ...
    @Override // com.google.android.gms.internal.ads.FA0
    public boolean o() {
        if (this.f75483B == null) {
            return false;
        }
        if (C() || m0()) {
            return true;
        }
        return this.f75505X != -9223372036854775807L && K().zzb() < this.f75505X;
    }
    ...
    public void v(int i10, Object obj) throws zzib {
        if (i10 == 11) {
            this.f75485D = (EA0) obj;
        }
    }

    public AbstractC8323hE0(int i10, XD0 xd0, InterfaceC8535jE0 interfaceC8535jE0, boolean z10, float f10) {
        super(i10);
        this.f75525r = xd0;
        this.f75527s = interfaceC8535jE0;
        this.f75529t = f10;
        this.f75531u = new By0(0, 0);
        this.f75533v = new By0(0, 0);
        this.f75535w = new By0(2, 0);
        PD0 pd0 = new PD0();
        this.f75537x = pd0;
        this.f75539y = new MediaCodec.BufferInfo();
        this.f75487F = 1.0f;
        this.f75488G = 1.0f;
        this.f75540z = new ArrayDeque();
        this.f75530t0 = C8109fE0.f74903e;
        pd0.j(0);
        pd0.f66471d.order(ByteOrder.nativeOrder());
        this.f75482A = new C9282qD0();
        this.f75493L = -1.0f;
        this.f75497P = 0;
        this.f75515h0 = 0;
        this.f75506Y = -1;
        this.f75507Z = -1;
        this.f75505X = -9223372036854775807L;
        this.f75521n0 = -9223372036854775807L;
        this.f75522o0 = -9223372036854775807L;
        this.f75532u0 = -9223372036854775807L;
        this.f75504W = -9223372036854775807L;
        this.f75516i0 = 0;
        this.f75517j0 = 0;
        this.f75528s0 = new My0();
    }
    ...
    protected void Z() {
        ...
        this.f75516i0 = 0;
        this.f75517j0 = 0;
        this.f75515h0 = this.f75514g0 ? 1 : 0;
    }
