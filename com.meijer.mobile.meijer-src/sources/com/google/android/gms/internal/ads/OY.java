...
public final class OY implements T10 {
    ...
    final /* synthetic */ PY a() throws Exception {
        int i10;
        int streamMaxVolume;
        AudioManager audioManager = (AudioManager) this.f69947b.getSystemService("audio");
        float fA = Nc.v.v().a();
        boolean zE = Nc.v.v().e();
    ...
    public final com.google.common.util.concurrent.q zzb() {
        return this.f69946a.k0(new Callable() { // from class: com.google.android.gms.internal.ads.NY
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f69740a.a();
            }
        });
    }
}
