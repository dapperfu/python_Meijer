...
public final class C7869d1 {
    ...
    public static C7549a1 c(GQ gq2, boolean z10, boolean z11) throws zzbc {
        if (z10) {
            d(3, gq2, false);
        }
        ...
        return new C7549a1(strB, strArr, length2 + 1);
    }

    public static C8776lb b(List list) {
        ...
        for (int i10 = 0; i10 < list.size(); i10++) {
            ...
            if (strArrSplit.length != 2) {
                C10042xL.f("VorbisUtil", "Failed to parse Vorbis comment: ".concat(str));
            } else if (strArrSplit[0].equals("METADATA_BLOCK_PICTURE")) {
                try {
                    arrayList.add(S1.a(new GQ(Base64.decode(strArrSplit[1], 0))));
                } catch (RuntimeException e10) {
                    C10042xL.g("VorbisUtil", "Failed to parse vorbis picture", e10);
                }
            } else {
