...
final class A1 extends B1 {
    ...
    private long f65882b;

    /* renamed from: c, reason: collision with root package name */
    private long[] f65883c;

    /* renamed from: d, reason: collision with root package name */
    private long[] f65884d;
    ...
    public A1() {
        super(new C8720l0());
        this.f65882b = -9223372036854775807L;
        this.f65883c = new long[0];
        this.f65884d = new long[0];
    }
        ...
        if (gq2.C() == 2 && "onMetaData".equals(i(gq2)) && gq2.r() != 0 && gq2.C() == 8) {
            ...
            if (obj instanceof Double) {
                ...
                if (dDoubleValue > 0.0d) {
                    this.f65882b = (long) (dDoubleValue * 1000000.0d);
                }
            }
            ...
            if (obj2 instanceof Map) {
                ...
                if ((obj3 instanceof List) && (obj4 instanceof List)) {
                    ...
                    int size = list2.size();
                    this.f65883c = new long[size];
                    this.f65884d = new long[size];
                    for (int i10 = 0; i10 < size; i10++) {
                        Object obj5 = list.get(i10);
                        Object obj6 = list2.get(i10);
                        if ((obj6 instanceof Double) && (obj5 instanceof Double)) {
                            this.f65883c[i10] = (long) (((Double) obj6).doubleValue() * 1000000.0d);
                            this.f65884d[i10] = ((Double) obj5).longValue();
                        } else {
                            this.f65883c = new long[0];
                            this.f65884d = new long[0];
                            break;
