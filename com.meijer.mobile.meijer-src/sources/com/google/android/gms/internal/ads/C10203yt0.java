...
public final class C10203yt0 implements Lq0 {

    /* renamed from: d, reason: collision with root package name */
    private static final ThreadLocal f81140d = new C10096xt0();

    /* renamed from: a, reason: collision with root package name */
    private final SecretKey f81141a;

    /* renamed from: b, reason: collision with root package name */
    private final byte[] f81142b;

    /* renamed from: c, reason: collision with root package name */
    private final byte[] f81143c;

    private static Cipher b() throws GeneralSecurityException {
        if (C8056eo0.a(1)) {
            return (Cipher) f81140d.get();
        }
    ...
    public final byte[] a(byte[] bArr, int i10) throws GeneralSecurityException {
        ...
        SecretKey secretKey = this.f81141a;
        Cipher cipherB = b();
        ...
        int i13 = i12 * 16;
        if (i11 * 16 == length) {
            bArrC = C8066et0.c(bArr, i13, this.f81142b, 0, 16);
        } else {
            ...
            byte[] bArr2 = this.f81143c;
            if (bArrCopyOf.length != 16) {
                throw new IllegalArgumentException("The lengths of x and y should match.");
            }
            bArrC = C8066et0.c(bArrCopyOf, 0, bArr2, 0, 16);
        }
    ...
    public C10203yt0(byte[] bArr) throws GeneralSecurityException {
        Ct0.a(bArr.length);
        SecretKeySpec secretKeySpec = new SecretKeySpec(bArr, "AES");
        this.f81141a = secretKeySpec;
        Cipher cipherB = b();
        cipherB.init(1, secretKeySpec);
        byte[] bArrA = Cq0.a(cipherB.doFinal(new byte[16]));
        this.f81142b = bArrA;
        this.f81143c = Cq0.a(bArrA);
    }
}
