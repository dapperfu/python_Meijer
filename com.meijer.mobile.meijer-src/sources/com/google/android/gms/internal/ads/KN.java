...
public final class KN {
    ...
    private final com.google.android.gms.common.util.f f68924a;
    ...
    public final void a(List list, String str, String str2, Object... objArr) throws IOException {
        if (((Boolean) C9107og.f78254a.e()).booleanValue()) {
            ...
            try {
                ...
                Sc.p.e("unable to log", e10);
            }
            Sc.p.f("AD-DBG ".concat(String.valueOf(stringWriter.toString())));
        }
    }
}
