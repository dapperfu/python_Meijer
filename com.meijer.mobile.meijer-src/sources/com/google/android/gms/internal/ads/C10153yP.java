...
public final class C10153yP {
    ...
    public static final void b(Context context, ViewGroup viewGroup, NativeAd nativeAd) {
        ...
        linearLayout.addView(c(context, resourcesF == null ? "Headline" : resourcesF.getString(Lc.d.f18094b), "headline_header_tag"));
        View viewD = d(context, C7392Vf0.c(nativeAd.b()), "headline_tag");
        nativeAdView.setHeadlineView(viewD);
        linearLayout.addView(viewD);
        linearLayout.addView(c(context, resourcesF == null ? "Body" : resourcesF.getString(Lc.d.f18093a), "body_header_tag"));
        View viewD2 = d(context, C7392Vf0.c(nativeAd.a()), "body_tag");
        nativeAdView.setBodyView(viewD2);
        linearLayout.addView(viewD2);
        linearLayout.addView(c(context, resourcesF == null ? "Media View" : resourcesF.getString(Lc.d.f18095c), "media_view_header_tag"));
