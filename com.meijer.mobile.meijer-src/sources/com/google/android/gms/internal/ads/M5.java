...
final class M5 {
    private static void d(C8124fQ c8124fQ) {
        c8124fQ.n(3);
        c8124fQ.n(8);
    ...
    private static void e(C8124fQ c8124fQ) {
        int iD;
        int iD2 = c8124fQ.d(2);
        if (iD2 == 0) {
            c8124fQ.n(6);
        ...
        if (iD2 == 2) {
            ...
            while (i13 < iC) {
                if (c8124fQ.p()) {
                    ...
                    if (c8124fQ.d(2) == 3 && c8124fQ.d(i11) * i10 != 0) {
                        c8124fQ.m();
                    }
                    iD = c8124fQ.d(i12) * i10;
                    if (iD != 0 && iD != 180) {
                        c8124fQ.m();
                    }
                    c8124fQ.m();
                }
                if (iD != 0 && iD != 180 && c8124fQ.p()) {
                    i13++;
                }
                i13++;
            }
    ...
    private static boolean f(C8124fQ c8124fQ) {
        c8124fQ.n(3);
        boolean zP = c8124fQ.p();
        if (zP) {
            c8124fQ.n(13);
    ...
    public static J5 a(C8124fQ c8124fQ) throws zzbc {
        int iD;
        int i10;
        char c10;
        int i11;
        ...
        while (true) {
            ...
            if (i15 < iD6 + 1) {
                int iD7 = c8124fQ.d(3);
                iC += c(c8124fQ, 5, 8, 16) + 1;
                if ((iD7 == 0 || iD7 == 2) && c8124fQ.p()) {
                    e(c8124fQ);
                }
                i15++;
            } else {
                int iC2 = c(c8124fQ, 4, 8, 16) + 1;
                c8124fQ.m();
                int i17 = 0;
                while (true) {
                    double d10 = 2.0d;
                    if (i17 >= iC2) {
                        ...
                        byte[] bArr = null;
                        if (c8124fQ.p()) {
                            int iC3 = c(c8124fQ, 2, 4, 8) + 1;
                            for (int i19 = 0; i19 < iC3; i19++) {
                                int iC4 = c(c8124fQ, 4, 8, 16);
                                int iC5 = c(c8124fQ, 4, 8, 16);
                                if (iC4 == 7) {
                                    int iD8 = c8124fQ.d(4) + 1;
                                    c8124fQ.n(4);
                                    byte[] bArr2 = new byte[iD8];
                                    for (int i20 = 0; i20 < iD8; i20++) {
                                        bArr2[i20] = (byte) c8124fQ.d(8);
                                    }
                                    bArr = bArr2;
                                } else {
                                    c8124fQ.n(iC5 * 8);
    ...
    */
    public static boolean b(com.google.android.gms.internal.ads.C8124fQ r18, com.google.android.gms.internal.ads.I5 r19) throws com.google.android.gms.internal.ads.zzbc {
        /*
            r0 = r18
            r1 = r19
            r0.b()
        ...
        L26:
            r6 = r4
        L27:
            com.google.android.gms.internal.ads.C8211gC.d(r6)
            r10 = 3
    ...
    private static int c(C8124fQ c8124fQ, int i10, int i11, int i12) {
        boolean z10;
        ...
        int iD = c8124fQ.d(i10);
        if (iD == i13) {
            if (c8124fQ.a() < i11) {
                return -1;
            }
            int iD2 = c8124fQ.d(i11);
            int i15 = iD + iD2;
            if (iD2 == i14) {
                if (c8124fQ.a() < i12) {
                    return -1;
                }
                return i15 + c8124fQ.d(i12);
            }
            return i15;
        }
        return iD;
