...
final class W4 {
    ...
    private static final Pattern f71840c = Pattern.compile("\\[voice=\"([^\"]*)\"\\]");

    /* renamed from: d, reason: collision with root package name */
    private static final Pattern f71841d = Pattern.compile("^((?:[0-9]*\\.)?[0-9]+)(px|em|%)$");

    /* renamed from: a, reason: collision with root package name */
    private final GQ f71842a = new GQ();

    /* renamed from: b, reason: collision with root package name */
    private final StringBuilder f71843b = new StringBuilder();
