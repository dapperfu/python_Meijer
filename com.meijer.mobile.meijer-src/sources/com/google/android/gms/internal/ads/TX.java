...
public final class TX implements InterfaceC7009Ka {
    ...
    /* synthetic */ TX(Parcel parcel, C9412rX c9412rX) {
        String string = parcel.readString();
        int i10 = OV.f69931a;
        this.f71240a = string;
        byte[] bArrCreateByteArray = parcel.createByteArray();
        this.f71241b = bArrCreateByteArray;
        this.f71242c = parcel.readInt();
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && TX.class == obj.getClass()) {
            TX tx = (TX) obj;
            if (this.f71240a.equals(tx.f71240a) && Arrays.equals(this.f71241b, tx.f71241b) && this.f71242c == tx.f71242c && this.f71243d == tx.f71243d) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        return ((((((this.f71240a.hashCode() + 527) * 31) + Arrays.hashCode(this.f71241b)) * 31) + this.f71242c) * 31) + this.f71243d;
    }
    ...
    */
    public final java.lang.String toString() throws java.io.IOException {
        ...
        L53:
            ...
            goto Lcb
        L5a:
            java.lang.String r0 = r5.f71240a
            ...
            com.google.android.gms.internal.ads.C8211gC.g(r0, r3)
            byte[] r0 = r5.f71241b
            r0 = r0[r2]
        ...
        L8a:
            ...
            r0.append(r1)
            java.lang.String r1 = ","
            com.google.android.gms.internal.ads.C9854vf0.b(r0, r2, r1)
        ...
        Lcb:
            java.lang.String r1 = r5.f71240a
            java.lang.StringBuilder r2 = new java.lang.StringBuilder
            r2.<init>()
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        parcel.writeString(this.f71240a);
        parcel.writeByteArray(this.f71241b);
        parcel.writeInt(this.f71242c);
        parcel.writeInt(this.f71243d);
    }
    ...
    */
    private static void a(java.lang.String r6, byte[] r7, int r8) {
        ...
        L59:
            r4 = r5
        L5a:
            com.google.android.gms.internal.ads.C8211gC.d(r4)
            return
        L5e:
            if (r8 != 0) goto L61
            goto L62
