...
final class L4 implements InterfaceC10656t6 {

    /* renamed from: a, reason: collision with root package name */
    private final K4 f82667a;

    @Override // com.google.android.gms.internal.measurement.InterfaceC10656t6
    public final void zzG(int i10, List list) throws IOException {
        for (int i11 = 0; i11 < list.size(); i11++) {
            this.f82667a.q(i10, (G4) list.get(i11));
        }
    }
    ...
    public final void zzA(int i10, List list, boolean z10) throws IOException {
        ...
        if (!(list instanceof C10700y5)) {
            if (!z10) {
                while (i11 < list.size()) {
                    this.f82667a.n(i10, ((Long) list.get(i11)).longValue());
                    i11++;
                }
                return;
            }
        ...
        if (!z10) {
            while (i11 < c10700y5.size()) {
                this.f82667a.n(i10, c10700y5.zzc(i11));
                i11++;
            }
            return;
        }
        ...
        k43.i(i10, 2);
        int i14 = 0;
        for (int i15 = 0; i15 < c10700y5.size(); i15++) {
            c10700y5.zzc(i15);
            i14 += 8;
        }
        k43.z(i14);
        while (i11 < c10700y5.size()) {
            k43.C(c10700y5.zzc(i11));
            i11++;
        }
    }
    ...
    public final void zzB(int i10, List list, boolean z10) throws IOException {
        ...
        if (!(list instanceof W4)) {
            if (!z10) {
                while (i11 < list.size()) {
                    this.f82667a.l(i10, Float.floatToRawIntBits(((Float) list.get(i11)).floatValue()));
                    i11++;
                }
                return;
            }
        ...
        if (!z10) {
            while (i11 < w42.size()) {
                this.f82667a.l(i10, Float.floatToRawIntBits(w42.f(i11)));
                i11++;
            }
            return;
        }
    ...
    public final void zzC(int i10, List list, boolean z10) throws IOException {
        ...
        if (!(list instanceof M4)) {
            if (!z10) {
                while (i11 < list.size()) {
                    this.f82667a.n(i10, Double.doubleToRawLongBits(((Double) list.get(i11)).doubleValue()));
                    i11++;
                }
                return;
            }
        ...
        if (!z10) {
            while (i11 < m42.size()) {
                this.f82667a.n(i10, Double.doubleToRawLongBits(m42.f(i11)));
                i11++;
            }
            return;
        }
    ...
    public final void zzD(int i10, List list, boolean z10) throws IOException {
        ...
        if (!(list instanceof C10530f5)) {
            if (!z10) {
                while (i11 < list.size()) {
                    this.f82667a.j(i10, ((Integer) list.get(i11)).intValue());
                    i11++;
                }
                return;
            }
        ...
        if (!z10) {
            while (i11 < c10530f5.size()) {
                this.f82667a.j(i10, c10530f5.f(i11));
                i11++;
            }
            return;
        }
        ...
        k43.i(i10, 2);
        int iA2 = 0;
        for (int i13 = 0; i13 < c10530f5.size(); i13++) {
            iA2 += K4.a(c10530f5.f(i13));
        }
        k43.z(iA2);
        while (i11 < c10530f5.size()) {
            k43.y(c10530f5.f(i11));
            i11++;
        }
    }
    ...
    public final void zzE(int i10, List list, boolean z10) throws IOException {
        int i11 = 0;
        if (!(list instanceof C10681w4)) {
            if (!z10) {
                while (i11 < list.size()) {
                    this.f82667a.o(i10, ((Boolean) list.get(i11)).booleanValue());
                    i11++;
                }
                return;
            }
        ...
        C10681w4 c10681w4 = (C10681w4) list;
        if (!z10) {
            while (i11 < c10681w4.size()) {
                this.f82667a.o(i10, c10681w4.f(i11));
                i11++;
            }
            return;
        }
        ...
        k43.i(i10, 2);
        int i14 = 0;
        for (int i15 = 0; i15 < c10681w4.size(); i15++) {
            c10681w4.f(i15);
            i14++;
        }
        k43.z(i14);
        while (i11 < c10681w4.size()) {
            k43.x(c10681w4.f(i11) ? (byte) 1 : (byte) 0);
            i11++;
        }
    }
    ...
    public final void zzF(int i10, List list) throws IOException {
        int i11 = 0;
        if (!(list instanceof InterfaceC10664u5)) {
            while (i11 < list.size()) {
                this.f82667a.p(i10, (String) list.get(i11));
                i11++;
            }
            return;
        }
        ...
        while (i11 < list.size()) {
            Object objZzc = interfaceC10664u5.zzc();
            if (objZzc instanceof String) {
                this.f82667a.p(i10, (String) objZzc);
            } else {
                this.f82667a.q(i10, (G4) objZzc);
            }
            i11++;
        }
    }
    ...
    public final void zzH(int i10, List list, boolean z10) throws IOException {
        ...
        if (!(list instanceof C10530f5)) {
            if (!z10) {
                while (i11 < list.size()) {
                    this.f82667a.k(i10, ((Integer) list.get(i11)).intValue());
                    i11++;
                }
                return;
            }
        ...
        if (!z10) {
            while (i11 < c10530f5.size()) {
                this.f82667a.k(i10, c10530f5.f(i11));
                i11++;
            }
            return;
        }
        ...
        int iG2 = 0;
        for (int i13 = 0; i13 < c10530f5.size(); i13++) {
            iG2 += K4.G(c10530f5.f(i13));
        }
        k43.z(iG2);
        while (i11 < c10530f5.size()) {
            k43.z(c10530f5.f(i11));
            i11++;
        }
    }
    ...
    public final void zzI(int i10, List list, boolean z10) throws IOException {
        ...
        if (!(list instanceof C10530f5)) {
            if (!z10) {
                while (i11 < list.size()) {
                    this.f82667a.l(i10, ((Integer) list.get(i11)).intValue());
                    i11++;
                }
                return;
            }
        ...
        if (!z10) {
            while (i11 < c10530f5.size()) {
                this.f82667a.l(i10, c10530f5.f(i11));
                i11++;
            }
            return;
        }
        ...
        k43.i(i10, 2);
        int i14 = 0;
        for (int i15 = 0; i15 < c10530f5.size(); i15++) {
            c10530f5.f(i15);
            i14 += 4;
        }
        k43.z(i14);
        while (i11 < c10530f5.size()) {
            k43.A(c10530f5.f(i11));
            i11++;
        }
    }
    ...
    public final void zzK(int i10, List list, boolean z10) throws IOException {
        ...
        int iG2 = 0;
        for (int i13 = 0; i13 < c10530f5.size(); i13++) {
            int iF2 = c10530f5.f(i13);
            iG2 += K4.G((iF2 >> 31) ^ (iF2 + iF2));
        }
        k45.z(iG2);
        while (i11 < c10530f5.size()) {
            int iF3 = c10530f5.f(i11);
    ...
    public final void zzL(int i10, List list, boolean z10) throws IOException {
        ...
        k45.i(i10, 2);
        int iA2 = 0;
        for (int i13 = 0; i13 < c10700y5.size(); i13++) {
            long jZzc2 = c10700y5.zzc(i13);
            iA2 += K4.a((jZzc2 >> 63) ^ (jZzc2 + jZzc2));
        }
        k45.z(iA2);
        while (i11 < c10700y5.size()) {
            long jZzc3 = c10700y5.zzc(i11);
    ...
    public final void zzy(int i10, List list, boolean z10) throws IOException {
        ...
        if (!(list instanceof C10700y5)) {
            if (!z10) {
                while (i11 < list.size()) {
                    this.f82667a.m(i10, ((Long) list.get(i11)).longValue());
                    i11++;
                }
                return;
            }
        ...
        if (!z10) {
            while (i11 < c10700y5.size()) {
                this.f82667a.m(i10, c10700y5.zzc(i11));
                i11++;
            }
            return;
        }
        ...
        int iA2 = 0;
        for (int i13 = 0; i13 < c10700y5.size(); i13++) {
            iA2 += K4.a(c10700y5.zzc(i13));
        }
        k43.z(iA2);
        while (i11 < c10700y5.size()) {
            k43.B(c10700y5.zzc(i11));
            i11++;
        }
    }
