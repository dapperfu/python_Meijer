...
public final class C10560j implements InterfaceC10623q {

    /* renamed from: a, reason: collision with root package name */
    private final Double f83055a;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C10560j) {
            return this.f83055a.equals(((C10560j) obj).f83055a);
        }
        return false;
    }
    ...
    public final String zzc() throws NumberFormatException {
        ...
        BigDecimal bigDecimalA = C10551i.a(BigDecimal.valueOf(d10.doubleValue()));
    ...
    public final InterfaceC10623q zzt() {
        return new C10560j(this.f83055a);
    }

    public C10560j(Double d10) {
        if (d10 == null) {
            this.f83055a = Double.valueOf(Double.NaN);
        } else {
            this.f83055a = d10;
        }
    }
