...
final class M5 {
    ...
    private static final char[] f82676a;
    ...
    static void b(StringBuilder sb2, int i10, String str, Object obj) throws SecurityException {
        ...
        if (obj instanceof String) {
            sb2.append(": \"");
            G4 g42 = G4.f82610b;
            sb2.append(C10531f6.a(new F4(((String) obj).getBytes(C10611o5.f83155a))));
            sb2.append('\"');
            return;
        }
        if (obj instanceof G4) {
            sb2.append(": \"");
            sb2.append(C10531f6.a((G4) obj));
            sb2.append('\"');
            return;
        }
        if (obj instanceof AbstractC10521e5) {
            sb2.append(" {");
            c((AbstractC10521e5) obj, sb2, i10 + 2);
            sb2.append("\n");
            d(i10, sb2);
            sb2.append("}");
            return;
