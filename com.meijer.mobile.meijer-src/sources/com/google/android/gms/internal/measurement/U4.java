...
final class U4 {
    ...
    private static final U4 f82844d = new U4(true);

    /* renamed from: a, reason: collision with root package name */
    final C10513d6 f82845a = new Z5();

    /* renamed from: b, reason: collision with root package name */
    private boolean f82846b;

    /* renamed from: c, reason: collision with root package name */
    private boolean f82847c;
    ...
    static void f(K4 k42, EnumC10638r6 enumC10638r6, int i10, Object obj) throws IOException {
        if (enumC10638r6 == EnumC10638r6.f83212l) {
            K5 k52 = (K5) obj;
            C10611o5.d(k52);
            k42.i(i10, 3);
            k52.c(k42);
        ...
        k42.i(i10, enumC10638r6.b());
        EnumC10647s6 enumC10647s6 = EnumC10647s6.INT;
        switch (enumC10638r6.ordinal()) {
            ...
            case 13:
                if (!(obj instanceof InterfaceC10557i5)) {
                    ...
                    k42.y(((InterfaceC10557i5) obj).zza());
                    break;
                }
            case 14:
                k42.A(((Integer) obj).intValue());
    ...
    static int h(EnumC10638r6 enumC10638r6, int i10, Object obj) {
        int iG = K4.G(i10 << 3);
        if (enumC10638r6 == EnumC10638r6.f83212l) {
            C10611o5.d((K5) obj);
            iG += iG;
        }
        return iG + i(enumC10638r6, obj);
    }

    static int i(EnumC10638r6 enumC10638r6, Object obj) {
        int iF;
        int iG;
        ...
        switch (enumC10638r6.ordinal()) {
            ...
            case 13:
                return obj instanceof InterfaceC10557i5 ? K4.a(((InterfaceC10557i5) obj).zza()) : K4.a(((Integer) obj).intValue());
            case 14:
                ((Integer) obj).getClass();
                int i19 = K4.f82656d;
                return 4;
    ...
    public final void b() {
        ...
        C10513d6 c10513d6 = this.f82845a;
        int iC = c10513d6.c();
        for (int i10 = 0; i10 < iC; i10++) {
            Object value = c10513d6.d(i10).getValue();
            if (value instanceof AbstractC10521e5) {
                ((AbstractC10521e5) value).o();
            }
        }
        Iterator it = c10513d6.f().iterator();
        while (it.hasNext()) {
            Object value2 = ((Map.Entry) it.next()).getValue();
            if (value2 instanceof AbstractC10521e5) {
                ((AbstractC10521e5) value2).o();
            }
        }
        c10513d6.a();
        this.f82846b = true;
    ...
    public final Iterator c() {
        C10513d6 c10513d6 = this.f82845a;
        return c10513d6.isEmpty() ? Collections.emptyIterator() : this.f82847c ? new C10637r5(c10513d6.entrySet().iterator()) : c10513d6.entrySet().iterator();
    }
    ...
    public final /* bridge */ /* synthetic */ Object clone() throws CloneNotSupportedException {
        ...
        int iC = c10513d6.c();
        for (int i10 = 0; i10 < iC; i10++) {
            Map.Entry entryD = c10513d6.d(i10);
            u42.d((T4) ((C10486a6) entryD).a(), entryD.getValue());
        }
        for (Map.Entry entry : c10513d6.f()) {
            u42.d((T4) entry.getKey(), entry.getValue());
        }
        u42.f82847c = this.f82847c;
        return u42;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof U4) {
            return this.f82845a.equals(((U4) obj).f82845a);
        }
        return false;
    }
    ...
    public static int j(T4 t42, Object obj) {
        EnumC10638r6 enumC10638r6Zzb = t42.zzb();
        int iZza = t42.zza();
        if (t42.zzd()) {
            List list = (List) obj;
            int size = list.size();
            ...
            if (t42.zze()) {
                ...
                int i11 = 0;
                while (i10 < size) {
                    i11 += i(enumC10638r6Zzb, list.get(i10));
                    i10++;
                }
            ...
            int iH = 0;
            while (i10 < size) {
                iH += h(enumC10638r6Zzb, iZza, list.get(i10));
                i10++;
            }
            return iH;
        }
        return h(enumC10638r6Zzb, iZza, obj);
    }

    private static boolean k(Map.Entry entry) {
        T4 t42 = (T4) entry.getKey();
        if (t42.zzc() == EnumC10647s6.MESSAGE) {
            if (t42.zzd()) {
    ...
    private static final int m(Map.Entry entry) {
        ...
        if (t42.zzc() == EnumC10647s6.MESSAGE && !t42.zzd() && !t42.zze()) {
            if (value instanceof C10646s5) {
                int iZza = ((T4) entry.getKey()).zza();
                int iG3 = K4.G(8);
                i10 = iG3 + iG3;
                iG = K4.G(16) + K4.G(iZza);
                int iG4 = K4.G(24);
                int iB = ((C10646s5) value).b();
                iG2 = iG4 + K4.G(iB) + iB;
            } else {
    ...
    */
    private static final void n(com.google.android.gms.internal.measurement.T4 r2, java.lang.Object r3) {
        /*
            ...
            byte[] r1 = com.google.android.gms.internal.measurement.C10611o5.f83156b
            r3.getClass()
            com.google.android.gms.internal.measurement.r6 r1 = com.google.android.gms.internal.measurement.EnumC10638r6.f83203c
            com.google.android.gms.internal.measurement.s6 r1 = com.google.android.gms.internal.measurement.EnumC10647s6.INT
        ...
        L19:
            ...
            if (r0 != 0) goto L21
            boolean r0 = r3 instanceof com.google.android.gms.internal.measurement.C10646s5
            if (r0 == 0) goto L48
        L21:
            return
        L22:
            ...
            if (r0 != 0) goto L2a
            boolean r0 = r3 instanceof com.google.android.gms.internal.measurement.InterfaceC10557i5
            if (r0 == 0) goto L48
        L2a:
            return
        L2b:
