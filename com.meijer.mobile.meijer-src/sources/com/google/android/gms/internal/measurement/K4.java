...
public abstract class K4 extends C10690x4 {

    /* renamed from: b, reason: collision with root package name */
    private static final Logger f82654b = Logger.getLogger(K4.class.getName());

    /* renamed from: c, reason: collision with root package name */
    private static final boolean f82655c = C10603n6.f();

    /* renamed from: d, reason: collision with root package name */
    public static final /* synthetic */ int f82656d = 0;
    ...
    static int d(K5 k52, V5 v52) {
        int iH = ((AbstractC10628q4) k52).h(v52);
        return G(iH) + iH;
    }
    ...
    static int g(int i10, K5 k52, V5 v52) {
        int iG = G(i10 << 3);
        return iG + iG + ((AbstractC10628q4) k52).h(v52);
    }

    final void f(String str, C10621p6 c10621p6) throws IOException {
        f82654b.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable) c10621p6);
        byte[] bytes = str.getBytes(C10611o5.f83155a);
        try {
    ...
    public static int b(String str) {
        int length;
        try {
            length = C10630q6.b(str);
        } catch (C10621p6 unused) {
            length = str.getBytes(C10611o5.f83155a).length;
        }
