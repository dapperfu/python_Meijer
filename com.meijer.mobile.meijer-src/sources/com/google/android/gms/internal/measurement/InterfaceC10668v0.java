...
public interface InterfaceC10668v0 extends IInterface {
    ...
    void generateEventId(InterfaceC10695y0 interfaceC10695y0) throws RemoteException;

    void getAppInstanceId(InterfaceC10695y0 interfaceC10695y0) throws RemoteException;

    void getCachedAppInstanceId(InterfaceC10695y0 interfaceC10695y0) throws RemoteException;

    void getConditionalUserProperties(String str, String str2, InterfaceC10695y0 interfaceC10695y0) throws RemoteException;

    void getCurrentScreenClass(InterfaceC10695y0 interfaceC10695y0) throws RemoteException;

    void getCurrentScreenName(InterfaceC10695y0 interfaceC10695y0) throws RemoteException;

    void getGmpAppId(InterfaceC10695y0 interfaceC10695y0) throws RemoteException;

    void getMaxUserProperties(String str, InterfaceC10695y0 interfaceC10695y0) throws RemoteException;

    void getSessionId(InterfaceC10695y0 interfaceC10695y0) throws RemoteException;

    void getTestFlag(InterfaceC10695y0 interfaceC10695y0, int i10) throws RemoteException;

    void getUserProperties(String str, String str2, boolean z10, InterfaceC10695y0 interfaceC10695y0) throws RemoteException;

    void initForTests(Map map) throws RemoteException;

    void initialize(com.google.android.gms.dynamic.b bVar, H0 h02, long j10) throws RemoteException;

    void isDataCollectionEnabled(InterfaceC10695y0 interfaceC10695y0) throws RemoteException;

    void logEvent(String str, String str2, Bundle bundle, boolean z10, boolean z11, long j10) throws RemoteException;

    void logEventAndBundle(String str, String str2, Bundle bundle, InterfaceC10695y0 interfaceC10695y0, long j10) throws RemoteException;
    ...
    void onActivitySaveInstanceState(com.google.android.gms.dynamic.b bVar, InterfaceC10695y0 interfaceC10695y0, long j10) throws RemoteException;

    void onActivitySaveInstanceStateByScionActivityInfo(J0 j02, InterfaceC10695y0 interfaceC10695y0, long j10) throws RemoteException;
    ...
    void performAction(Bundle bundle, InterfaceC10695y0 interfaceC10695y0, long j10) throws RemoteException;
