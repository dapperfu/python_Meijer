...
final class C10475y1 {

    /* renamed from: a, reason: collision with root package name */
    private static final Logger f82450a = Logger.getLogger(C10475y1.class.getName());

    /* renamed from: b, reason: collision with root package name */
    private static final Unsafe f82451b;

    /* renamed from: c, reason: collision with root package name */
    private static final Class<?> f82452c;

    /* renamed from: d, reason: collision with root package name */
    private static final boolean f82453d;

    /* renamed from: e, reason: collision with root package name */
    private static final boolean f82454e;

    /* renamed from: f, reason: collision with root package name */
    private static final d f82455f;

    /* renamed from: g, reason: collision with root package name */
    private static final boolean f82456g;

    /* renamed from: h, reason: collision with root package name */
    private static final boolean f82457h;

    /* renamed from: i, reason: collision with root package name */
    private static final long f82458i;

    /* renamed from: j, reason: collision with root package name */
    private static final long f82459j;

    /* renamed from: k, reason: collision with root package name */
    private static final long f82460k;

    /* renamed from: l, reason: collision with root package name */
    private static final long f82461l;

    /* renamed from: m, reason: collision with root package name */
    private static final long f82462m;

    /* renamed from: n, reason: collision with root package name */
    private static final long f82463n;

    /* renamed from: o, reason: collision with root package name */
    private static final long f82464o;

    /* renamed from: p, reason: collision with root package name */
    private static final long f82465p;

    /* renamed from: q, reason: collision with root package name */
    private static final long f82466q;

    /* renamed from: r, reason: collision with root package name */
    private static final long f82467r;

    /* renamed from: s, reason: collision with root package name */
    private static final long f82468s;

    /* renamed from: t, reason: collision with root package name */
    private static final long f82469t;

    /* renamed from: u, reason: collision with root package name */
    private static final long f82470u;

    /* renamed from: v, reason: collision with root package name */
    private static final long f82471v;

    /* renamed from: w, reason: collision with root package name */
    private static final long f82472w;

    /* renamed from: x, reason: collision with root package name */
    private static final boolean f82473x;
    ...
    static final class a extends d {
        ...
        @Override // com.google.android.gms.internal.clearcut.C10475y1.d
        ...
        public final void g(Object obj, long j10, boolean z10) {
            if (C10475y1.f82473x) {
                C10475y1.r(obj, j10, z10);
            } else {
                C10475y1.t(obj, j10, z10);
            }
        }
        ...
        public final void i(Object obj, long j10, byte b10) {
            if (C10475y1.f82473x) {
                C10475y1.d(obj, j10, b10);
            } else {
                C10475y1.q(obj, j10, b10);
            }
        }

        @Override // com.google.android.gms.internal.clearcut.C10475y1.d
        public final boolean l(Object obj, long j10) {
            return C10475y1.f82473x ? C10475y1.P(obj, j10) : C10475y1.Q(obj, j10);
        }
        ...
        public final byte o(Object obj, long j10) {
            return C10475y1.f82473x ? C10475y1.N(obj, j10) : C10475y1.O(obj, j10);
        }
    }
    ...
    static final class c extends d {
        ...
        @Override // com.google.android.gms.internal.clearcut.C10475y1.d
        public final void b(long j10, byte b10) {
            this.f82474a.putByte(j10, b10);
        }

        @Override // com.google.android.gms.internal.clearcut.C10475y1.d
        public final void c(Object obj, long j10, double d10) {
            this.f82474a.putDouble(obj, j10, d10);
        }

        @Override // com.google.android.gms.internal.clearcut.C10475y1.d
        public final void d(Object obj, long j10, float f10) {
            this.f82474a.putFloat(obj, j10, f10);
        }

        @Override // com.google.android.gms.internal.clearcut.C10475y1.d
        public final void g(Object obj, long j10, boolean z10) {
            this.f82474a.putBoolean(obj, j10, z10);
        }

        @Override // com.google.android.gms.internal.clearcut.C10475y1.d
        public final void h(byte[] bArr, long j10, long j11, long j12) {
            this.f82474a.copyMemory(bArr, C10475y1.f82458i + j10, (Object) null, j11, j12);
        }

        @Override // com.google.android.gms.internal.clearcut.C10475y1.d
        public final void i(Object obj, long j10, byte b10) {
            this.f82474a.putByte(obj, j10, b10);
        }

        @Override // com.google.android.gms.internal.clearcut.C10475y1.d
        public final boolean l(Object obj, long j10) {
            return this.f82474a.getBoolean(obj, j10);
        }

        @Override // com.google.android.gms.internal.clearcut.C10475y1.d
        public final float m(Object obj, long j10) {
            return this.f82474a.getFloat(obj, j10);
        }

        @Override // com.google.android.gms.internal.clearcut.C10475y1.d
        public final double n(Object obj, long j10) {
            return this.f82474a.getDouble(obj, j10);
        }

        @Override // com.google.android.gms.internal.clearcut.C10475y1.d
        public final byte o(Object obj, long j10) {
            return this.f82474a.getByte(obj, j10);
        }
    }
    ...
    static abstract class d {
        ...
        public final long a(Field field) {
            return this.f82474a.objectFieldOffset(field);
        }
        ...
        public final void e(Object obj, long j10, int i10) {
            this.f82474a.putInt(obj, j10, i10);
        }

        public final void f(Object obj, long j10, long j11) {
            this.f82474a.putLong(obj, j10, j11);
        }
        ...
        public final int j(Object obj, long j10) {
            return this.f82474a.getInt(obj, j10);
        }

        public final long k(Object obj, long j10) {
            return this.f82474a.getLong(obj, j10);
        }
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.clearcut.C10475y1.<clinit>():void");
    }
    ...
    private static Field C() {
        Field fieldP;
        if (C10461u.b() && (fieldP = p(Buffer.class, "effectiveDirectAddress")) != null) {
            return fieldP;
        }
    ...
    private static int E(Class<?> cls) {
        if (f82457h) {
            return f82455f.f82474a.arrayBaseOffset(cls);
        }
        return -1;
    }
    ...
    private static int F(Class<?> cls) {
        if (f82457h) {
            return f82455f.f82474a.arrayIndexScale(cls);
        }
        return -1;
    }
    ...
    static byte a(byte[] bArr, long j10) {
        return f82455f.o(bArr, f82458i + j10);
    }

    static long b(Field field) {
        return f82455f.a(field);
    }
    ...
    static long o(ByteBuffer byteBuffer) {
        return f82455f.k(byteBuffer, f82471v);
    }
    ...
    public static void q(Object obj, long j10, byte b10) {
        long j11 = (-4) & j10;
        int i10 = (((int) j10) & 3) << 3;
        g(obj, j11, ((255 & b10) << i10) | (H(obj, j11) & (~(l3.f93323c << i10))));
    }
    ...
    static Unsafe z() {
        try {
            return (Unsafe) AccessController.doPrivileged(new C10478z1());
        } catch (Throwable unused) {
            return null;
        }
    }
