...
public abstract class A implements Serializable, Iterable<Byte> {
    ...
    public static final A f81937b = new H(C10424h0.f82309c);

    /* renamed from: c, reason: collision with root package name */
    private static final E f81938c;

    /* renamed from: a, reason: collision with root package name */
    private int f81939a = 0;

    static {
        B b10 = null;
        f81938c = C10461u.b() ? new I(b10) : new C(b10);
    }
    ...
    public static A n(byte[] bArr, int i10, int i11) {
        return new H(f81938c.a(bArr, i10, i11));
    }

    public static A o(String str) {
        return new H(str.getBytes(C10424h0.f82307a));
    }
    ...
    abstract void h(AbstractC10476z abstractC10476z) throws IOException;
    ...
    public final String r() {
        return size() == 0 ? "" : f(C10424h0.f82307a);
    }
