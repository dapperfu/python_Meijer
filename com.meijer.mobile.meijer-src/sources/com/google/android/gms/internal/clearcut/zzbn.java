...
public abstract class zzbn extends AbstractC10476z {

    /* renamed from: b, reason: collision with root package name */
    private static final Logger f82475b = Logger.getLogger(zzbn.class.getName());

    /* renamed from: c, reason: collision with root package name */
    private static final boolean f82476c = C10475y1.x();
    ...
    static class a extends zzbn {
        ...
        private final byte[] f82478d;

        /* renamed from: e, reason: collision with root package name */
        private final int f82479e;

        /* renamed from: f, reason: collision with root package name */
        private final int f82480f;
        ...
        public final void A0(int i10) throws IOException {
            try {
                byte[] bArr = this.f82478d;
                int i11 = this.f82481g;
                int i12 = i11 + 1;
                this.f82481g = i12;
                bArr[i11] = (byte) i10;
                int i13 = i11 + 2;
                ...
                throw new zzc(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f82481g), Integer.valueOf(this.f82480f), 1), e10);
            }
        }
        ...
        public final int K0() {
            return this.f82481g - this.f82479e;
        }

        @Override // com.google.android.gms.internal.clearcut.zzbn
        public final void L(long j10) throws IOException {
            if (zzbn.f82476c && u() >= 10) {
                while ((j10 & (-128)) != 0) {
                    byte[] bArr = this.f82478d;
                    int i10 = this.f82481g;
                    this.f82481g = i10 + 1;
                    C10475y1.k(bArr, i10, (byte) ((((int) j10) & l3.f93324d) | 128));
                    j10 >>>= 7;
                }
                byte[] bArr2 = this.f82478d;
                int i11 = this.f82481g;
                this.f82481g = i11 + 1;
                C10475y1.k(bArr2, i11, (byte) j10);
                return;
            }
            while ((j10 & (-128)) != 0) {
                try {
                    byte[] bArr3 = this.f82478d;
                    int i12 = this.f82481g;
                    this.f82481g = i12 + 1;
            ...
            byte[] bArr4 = this.f82478d;
            int i13 = this.f82481g;
            this.f82481g = i13 + 1;
            bArr4[i13] = (byte) j10;
        }
        ...
        @Override // com.google.android.gms.internal.clearcut.AbstractC10476z
        ...
        public final void c(byte[] bArr, int i10, int i11) throws IOException {
            try {
                System.arraycopy(bArr, i10, this.f82478d, this.f82481g, i11);
                this.f82481g += i11;
            } catch (IndexOutOfBoundsException e10) {
                throw new zzc(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f82481g), Integer.valueOf(this.f82480f), Integer.valueOf(i11)), e10);
            }
        }
        ...
        public final void m0(String str) throws IOException {
            ...
            try {
                ...
                if (iD02 == iD0) {
                    int i11 = i10 + iD02;
                    this.f82481g = i11;
                    iB = A1.b(str, this.f82478d, i11, u());
                    this.f82481g = i10;
                    y0((iB - i10) - iD02);
                } else {
                    y0(A1.a(str));
                    iB = A1.b(str, this.f82478d, this.f82481g, u());
                }
                this.f82481g = iB;
            } catch (D1 e10) {
                this.f82481g = i10;
        ...
        @Override // com.google.android.gms.internal.clearcut.zzbn
        final void o(int i10, J0 j02, InterfaceC10404a1 interfaceC10404a1) throws IOException {
            G(i10, 2);
            AbstractC10450q abstractC10450q = (AbstractC10450q) j02;
            int iD = abstractC10450q.d();
            if (iD == -1) {
                iD = interfaceC10404a1.g(abstractC10450q);
                abstractC10450q.c(iD);
            }
            y0(iD);
            interfaceC10404a1.a(j02, this.f82477a);
        }
        ...
        @Override // com.google.android.gms.internal.clearcut.zzbn
        final void r(J0 j02, InterfaceC10404a1 interfaceC10404a1) throws IOException {
            AbstractC10450q abstractC10450q = (AbstractC10450q) j02;
            int iD = abstractC10450q.d();
            if (iD == -1) {
                iD = interfaceC10404a1.g(abstractC10450q);
        ...
        @Override // com.google.android.gms.internal.clearcut.zzbn
        public final int u() {
            return this.f82480f - this.f82481g;
        }
        ...
        public final void y0(int i10) throws IOException {
            if (zzbn.f82476c && u() >= 10) {
                while ((i10 & (-128)) != 0) {
                    ...
                    int i11 = this.f82481g;
                    this.f82481g = i11 + 1;
                    C10475y1.k(bArr, i11, (byte) ((i10 & l3.f93324d) | 128));
                    i10 >>>= 7;
                }
                byte[] bArr2 = this.f82478d;
                int i12 = this.f82481g;
                this.f82481g = i12 + 1;
                C10475y1.k(bArr2, i12, (byte) i10);
                return;
            }
            while ((i10 & (-128)) != 0) {
                try {
                    ...
                    int i13 = this.f82481g;
                    this.f82481g = i13 + 1;
                    bArr3[i13] = (byte) ((i10 & l3.f93324d) | 128);
                    i10 >>>= 7;
                } catch (IndexOutOfBoundsException e10) {
                    throw new zzc(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f82481g), Integer.valueOf(this.f82480f), 1), e10);
                }
    ...
    static final class b extends a {
        ...
        private final ByteBuffer f82482h;
    ...
    static final class c extends zzbn {
        ...
        /* renamed from: d, reason: collision with root package name */
        private final ByteBuffer f82484d;

        /* renamed from: e, reason: collision with root package name */
        private final ByteBuffer f82485e;

        /* renamed from: f, reason: collision with root package name */
        private final int f82486f;

        c(ByteBuffer byteBuffer) {
            super();
            this.f82484d = byteBuffer;
            this.f82485e = byteBuffer.duplicate().order(ByteOrder.LITTLE_ENDIAN);
            this.f82486f = byteBuffer.position();
        }

        private final void K0(String str) throws IOException {
            try {
                A1.c(str, this.f82485e);
            } catch (IndexOutOfBoundsException e10) {
                throw new zzc(e10);
            }
        }
        ...
        public final void L(long j10) throws IOException {
            while (((-128) & j10) != 0) {
                try {
                    this.f82485e.put((byte) ((((int) j10) & l3.f93324d) | 128));
                    j10 >>>= 7;
                } catch (BufferOverflowException e10) {
                    throw new zzc(e10);
                }
            }
            this.f82485e.put((byte) j10);
        }
        ...
        @Override // com.google.android.gms.internal.clearcut.zzbn
        public final void b() {
            this.f82484d.position(this.f82485e.position());
        }
        ...
        @Override // com.google.android.gms.internal.clearcut.zzbn
        public final void m0(String str) throws IOException {
            int iPosition = this.f82485e.position();
            try {
                int iD0 = zzbn.D0(str.length() * 3);
                int iD02 = zzbn.D0(str.length());
                if (iD02 != iD0) {
                ...
                int iPosition2 = this.f82485e.position() + iD02;
                this.f82485e.position(iPosition2);
                K0(str);
                int iPosition3 = this.f82485e.position();
                this.f82485e.position(iPosition);
                y0(iPosition3 - iPosition2);
                this.f82485e.position(iPosition3);
            } catch (D1 e10) {
                this.f82485e.position(iPosition);
                s(str, e10);
        ...
        public final void y0(int i10) throws IOException {
            while ((i10 & (-128)) != 0) {
                try {
                    this.f82485e.put((byte) ((i10 & l3.f93324d) | 128));
                    i10 >>>= 7;
                } catch (BufferOverflowException e10) {
                    throw new zzc(e10);
                }
            }
            this.f82485e.put((byte) i10);
        }
    }
    ...
    static final class d extends zzbn {
        ...
        /* renamed from: d, reason: collision with root package name */
        private final ByteBuffer f82487d;

        /* renamed from: e, reason: collision with root package name */
        private final ByteBuffer f82488e;

        /* renamed from: f, reason: collision with root package name */
        private final long f82489f;

        /* renamed from: g, reason: collision with root package name */
        private final long f82490g;

        /* renamed from: h, reason: collision with root package name */
        private final long f82491h;

        /* renamed from: i, reason: collision with root package name */
        private final long f82492i;
        ...
        d(ByteBuffer byteBuffer) {
            super();
            this.f82487d = byteBuffer;
            this.f82488e = byteBuffer.duplicate().order(ByteOrder.LITTLE_ENDIAN);
            long jO = C10475y1.o(byteBuffer);
            this.f82489f = jO;
            long jPosition = byteBuffer.position() + jO;
            this.f82490g = jPosition;
            long jLimit = jO + byteBuffer.limit();
            this.f82491h = jLimit;
            this.f82492i = jLimit - 10;
            this.f82493j = jPosition;
        }

        private final void K0(long j10) {
            this.f82488e.position((int) (j10 - this.f82489f));
        }

        @Override // com.google.android.gms.internal.clearcut.zzbn
        public final void A0(int i10) throws IOException {
            this.f82488e.putInt((int) (this.f82493j - this.f82489f), i10);
            this.f82493j += 4;
        }
        ...
        @Override // com.google.android.gms.internal.clearcut.zzbn
        public final void L(long j10) throws IOException {
            if (this.f82493j <= this.f82492i) {
                while ((j10 & (-128)) != 0) {
                    long j11 = this.f82493j;
                    this.f82493j = j11 + 1;
                    C10475y1.c(j11, (byte) ((((int) j10) & l3.f93324d) | 128));
                    j10 >>>= 7;
                }
                long j12 = this.f82493j;
                this.f82493j = 1 + j12;
                C10475y1.c(j12, (byte) j10);
                return;
            }
            while (true) {
                long j13 = this.f82493j;
                if (j13 >= this.f82491h) {
                    throw new zzc(String.format("Pos: %d, limit: %d, len: %d", Long.valueOf(this.f82493j), Long.valueOf(this.f82491h), 1));
                }
                if ((j10 & (-128)) == 0) {
                    this.f82493j = 1 + j13;
                    C10475y1.c(j13, (byte) j10);
                    return;
                } else {
                    this.f82493j = j13 + 1;
                    C10475y1.c(j13, (byte) ((((int) j10) & l3.f93324d) | 128));
                    j10 >>>= 7;
                }
            }
        }
        ...
        @Override // com.google.android.gms.internal.clearcut.zzbn
        public final void b() {
            this.f82487d.position((int) (this.f82493j - this.f82489f));
        }
        ...
        public final void c(byte[] bArr, int i10, int i11) throws IOException {
            if (bArr != null && i10 >= 0 && i11 >= 0 && bArr.length - i11 >= i10) {
                long j10 = i11;
                long j11 = this.f82491h - j10;
                long j12 = this.f82493j;
                if (j11 >= j12) {
                    C10475y1.l(bArr, i10, j12, j10);
                    this.f82493j += j10;
                    return;
                }
            }
            if (bArr != null) {
                throw new zzc(String.format("Pos: %d, limit: %d, len: %d", Long.valueOf(this.f82493j), Long.valueOf(this.f82491h), Integer.valueOf(i11)));
            }
        ...
        @Override // com.google.android.gms.internal.clearcut.zzbn
        public final void c0(long j10) throws IOException {
            this.f82488e.putLong((int) (this.f82493j - this.f82489f), j10);
            this.f82493j += 8;
        }

        @Override // com.google.android.gms.internal.clearcut.zzbn
        public final void g(byte b10) throws IOException {
            long j10 = this.f82493j;
            if (j10 >= this.f82491h) {
                throw new zzc(String.format("Pos: %d, limit: %d, len: %d", Long.valueOf(this.f82493j), Long.valueOf(this.f82491h), 1));
            }
            this.f82493j = 1 + j10;
        ...
        public final void m0(String str) throws IOException {
            ...
            try {
                ...
                if (iD02 != iD0) {
                    ...
                    y0(iA);
                    K0(this.f82493j);
                    A1.c(str, this.f82488e);
                    this.f82493j += iA;
                    return;
                }
                int i10 = ((int) (this.f82493j - this.f82489f)) + iD02;
                this.f82488e.position(i10);
                A1.c(str, this.f82488e);
                int iPosition = this.f82488e.position() - i10;
                y0(iPosition);
                this.f82493j += iPosition;
            } catch (D1 e10) {
                this.f82493j = j10;
                K0(j10);
                s(str, e10);
        ...
        @Override // com.google.android.gms.internal.clearcut.zzbn
        public final int u() {
            return (int) (this.f82491h - this.f82493j);
        }
        ...
        public final void y0(int i10) throws IOException {
            ...
            if (this.f82493j <= this.f82492i) {
                while (true) {
                    ...
                    this.f82493j = j10 + 1;
                    C10475y1.c(j10, (byte) ((i10 & l3.f93324d) | 128));
                    i10 >>>= 7;
                }
            } else {
                while (true) {
    ...
    public static int A(int i10, C10451q0 c10451q0) {
        return (B0(1) << 1) + n0(2, i10) + d(3, c10451q0);
    }

    static int B(int i10, J0 j02, InterfaceC10404a1 interfaceC10404a1) {
        return B0(i10) + E(j02, interfaceC10404a1);
    }
    ...
    static int E(J0 j02, InterfaceC10404a1 interfaceC10404a1) {
        AbstractC10450q abstractC10450q = (AbstractC10450q) j02;
        int iD = abstractC10450q.d();
        if (iD == -1) {
            iD = interfaceC10404a1.g(abstractC10450q);
    ...
    @Deprecated
    static int P(int i10, J0 j02, InterfaceC10404a1 interfaceC10404a1) {
        int iB0 = B0(i10) << 1;
        AbstractC10450q abstractC10450q = (AbstractC10450q) j02;
        int iD = abstractC10450q.d();
        if (iD == -1) {
    ...
    public static int d(int i10, C10451q0 c10451q0) {
        int iB0 = B0(i10);
        int iA = c10451q0.a();
        return iB0 + D0(iA) + iA;
    }
    ...
    public static int e(C10451q0 c10451q0) {
        int iA = c10451q0.a();
        return D0(iA) + iA;
    }
    ...
    public static zzbn f(ByteBuffer byteBuffer) {
        ...
        return C10475y1.y() ? new d(byteBuffer) : new c(byteBuffer);
    }
    ...
    public static int q0(String str) {
        ...
        try {
            ...
            length = str.getBytes(C10424h0.f82307a).length;
        }
        return D0(length) + length;
    }
    ...
    abstract void o(int i10, J0 j02, InterfaceC10404a1 interfaceC10404a1) throws IOException;

    public abstract void p(int i10, String str) throws IOException;

    public abstract void q(A a10) throws IOException;

    abstract void r(J0 j02, InterfaceC10404a1 interfaceC10404a1) throws IOException;

    final void s(String str, D1 d12) throws IOException {
        f82475b.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable) d12);
        byte[] bytes = str.getBytes(C10424h0.f82307a);
        try {
            y0(bytes.length);
