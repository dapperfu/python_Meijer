...
final class C10410c1 {

    /* renamed from: a, reason: collision with root package name */
    private static final Class<?> f82239a = C();

    /* renamed from: b, reason: collision with root package name */
    private static final AbstractC10454r1<?, ?> f82240b = w(false);

    /* renamed from: c, reason: collision with root package name */
    private static final AbstractC10454r1<?, ?> f82241c = w(true);

    /* renamed from: d, reason: collision with root package name */
    private static final AbstractC10454r1<?, ?> f82242d = new C10460t1();

    public static AbstractC10454r1<?, ?> A() {
        return f82241c;
    }

    public static AbstractC10454r1<?, ?> B() {
        return f82242d;
    }
    ...
    static int E(List<Integer> list) {
        ...
        C10421g0 c10421g0 = (C10421g0) list;
        int iC02 = 0;
        while (i10 < size) {
            iC02 += zzbn.C0(c10421g0.getInt(i10));
            i10++;
        }
        return iC02;
    }
    ...
    static int G(List<Integer> list) {
        ...
        int iD02 = 0;
        while (i10 < size) {
            iD02 += zzbn.D0(c10421g0.getInt(i10));
            i10++;
        }
        return iD02;
    }
    ...
    public static void I(Class<?> cls) {
        Class<?> cls2;
        if (!AbstractC10418f0.class.isAssignableFrom(cls) && (cls2 = f82239a) != null && !cls2.isAssignableFrom(cls)) {
    ...
    static int J(List<Integer> list) {
        ...
        int iE02 = 0;
        while (i10 < size) {
            iE02 += zzbn.E0(c10421g0.getInt(i10));
            i10++;
        }
        return iE02;
    }
    ...
    static int a(List<Long> list) {
        ...
        C10471x0 c10471x0 = (C10471x0) list;
        int iE02 = 0;
        while (i10 < size) {
            iE02 += zzbn.e0(c10471x0.e(i10));
            i10++;
        }
        return iE02;
    }
    ...
    private static <UT, UB> UB b(int i10, int i11, UB ub2, AbstractC10454r1<UT, UB> abstractC10454r1) {
        if (ub2 == null) {
            ub2 = abstractC10454r1.f();
        }
        abstractC10454r1.a(ub2, i10, i11);
        return ub2;
    }
    ...
    static <UT, UB> UB c(int i10, List<Integer> list, InterfaceC10430j0<?> interfaceC10430j0, UB ub2, AbstractC10454r1<UT, UB> abstractC10454r1) {
        if (interfaceC10430j0 == null) {
            return ub2;
        }
        if (!(list instanceof RandomAccess)) {
            ...
            while (it.hasNext()) {
                ...
                if (interfaceC10430j0.zzb(iIntValue) == null) {
                    ub2 = (UB) b(i10, iIntValue, ub2, abstractC10454r1);
                    it.remove();
                }
            }
            return ub2;
        ...
        for (int i12 = 0; i12 < size; i12++) {
            ...
            if (interfaceC10430j0.zzb(iIntValue2) != null) {
                if (i12 != i11) {
                    list.set(i11, num);
                }
                i11++;
            } else {
                ub2 = (UB) b(i10, iIntValue2, ub2, abstractC10454r1);
            }
        }
        if (i11 != size) {
    ...
    public static void e(int i10, List<?> list, M1 m12, InterfaceC10404a1 interfaceC10404a1) throws IOException {
        if (list == null || list.isEmpty()) {
            return;
        }
        m12.z(i10, list, interfaceC10404a1);
    }
    ...
    static <T> void h(E0 e02, T t10, T t11, long j10) {
        C10475y1.i(t10, j10, e02.zzb(C10475y1.M(t10, j10), C10475y1.M(t11, j10)));
    }

    static <T, UT, UB> void i(AbstractC10454r1<UT, UB> abstractC10454r1, T t10, T t11) {
        abstractC10454r1.g(t10, abstractC10454r1.i(abstractC10454r1.k(t10), abstractC10454r1.k(t11)));
    }
    ...
    public static void l(int i10, List<?> list, M1 m12, InterfaceC10404a1 interfaceC10404a1) throws IOException {
        if (list == null || list.isEmpty()) {
            return;
        }
        m12.y(i10, list, interfaceC10404a1);
    }
    ...
    static int n(int i10, Object obj, InterfaceC10404a1 interfaceC10404a1) {
        return obj instanceof C10451q0 ? zzbn.d(i10, (C10451q0) obj) : zzbn.B(i10, (J0) obj, interfaceC10404a1);
    }
    ...
    static int p(int i10, List<?> list, InterfaceC10404a1 interfaceC10404a1) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
        ...
        for (int i11 = 0; i11 < size; i11++) {
            Object obj = list.get(i11);
            iB0 += obj instanceof C10451q0 ? zzbn.e((C10451q0) obj) : zzbn.E((J0) obj, interfaceC10404a1);
        }
        return iB0;
    }
    ...
    static int u(int i10, List<J0> list, InterfaceC10404a1 interfaceC10404a1) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
        int iP = 0;
        for (int i11 = 0; i11 < size; i11++) {
            iP += zzbn.P(i10, list.get(i11), interfaceC10404a1);
        }
        return iP;
    }
    ...
    static int v(List<Integer> list) {
        ...
        int iH02 = 0;
        while (i10 < size) {
            iH02 += zzbn.H0(c10421g0.getInt(i10));
            i10++;
        }
        return iH02;
    }

    private static AbstractC10454r1<?, ?> w(boolean z10) {
        try {
            Class<?> clsD = D();
            if (clsD == null) {
                return null;
            }
            return (AbstractC10454r1) clsD.getConstructor(Boolean.TYPE).newInstance(Boolean.valueOf(z10));
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    public static AbstractC10454r1<?, ?> z() {
        return f82240b;
    }
}
