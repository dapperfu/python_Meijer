...
public class GoogleApiActivity extends Activity implements DialogInterface.OnCancelListener {
    ...
    protected final void onSaveInstanceState(Bundle bundle) {
        bundle.putInt("resolution", this.f65571a);
        ...
        if (pendingIntent != null) {
            try {
                ...
                try {
                    ...
                    googleApiActivity.f65571a = 1;
                } catch (ActivityNotFoundException e10) {
                    e = e10;
                    if (extras.getBoolean("notify_manager", true)) {
                        C14982e.t(this).F(new C14719b(22, null), getIntent().getIntExtra("failing_client_id", -1));
                    } else {
            ...
            C14723f.m().n(this, ((Integer) r.l(num)).intValue(), 2, this);
            this.f65571a = 1;
        }
    }
    ...
    protected final void onActivityResult(int i10, int i11, Intent intent) throws Resources.NotFoundException {
        ...
        if (i10 == 1) {
            ...
            if (booleanExtra) {
                C14982e c14982eT = C14982e.t(this);
                if (i11 != -1) {
                    if (i11 == 0) {
                        c14982eT.F(new C14719b(13, null), getIntent().getIntExtra("failing_client_id", -1));
                    }
                } else {
                    c14982eT.G();
                }
    ...
    protected final void onCreate(Bundle bundle) throws Resources.NotFoundException, IntentSender.SendIntentException {
        ...
        if (bundle != null) {
            this.f65571a = bundle.getInt("resolution");
        }
        if (this.f65571a != 1) {
            b();
        }
