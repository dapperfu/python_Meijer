...
public final class DynamiteModule {
    ...
    private static Boolean f65842h = null;

    /* renamed from: i, reason: collision with root package name */
    private static String f65843i = null;

    /* renamed from: j, reason: collision with root package name */
    private static boolean f65844j = false;

    /* renamed from: k, reason: collision with root package name */
    private static int f65845k = -1;

    /* renamed from: l, reason: collision with root package name */
    private static Boolean f65846l;

    /* renamed from: q, reason: collision with root package name */
    private static m f65851q;

    /* renamed from: r, reason: collision with root package name */
    private static n f65852r;

    /* renamed from: a, reason: collision with root package name */
    private final Context f65853a;

    /* renamed from: m, reason: collision with root package name */
    private static final ThreadLocal f65847m = new ThreadLocal();

    /* renamed from: n, reason: collision with root package name */
    private static final ThreadLocal f65848n = new b();

    /* renamed from: o, reason: collision with root package name */
    private static final a.InterfaceC1270a f65849o = new c();

    /* renamed from: b, reason: collision with root package name */
    public static final a f65836b = new d();

    /* renamed from: c, reason: collision with root package name */
    public static final a f65837c = new e();

    /* renamed from: d, reason: collision with root package name */
    public static final a f65838d = new f();

    /* renamed from: e, reason: collision with root package name */
    public static final a f65839e = new g();

    /* renamed from: f, reason: collision with root package name */
    public static final a f65840f = new h();

    /* renamed from: g, reason: collision with root package name */
    public static final a f65841g = new i();

    /* renamed from: p, reason: collision with root package name */
    public static final a f65850p = new j();
    ...
    public static class LoadingException extends Exception {
        /* synthetic */ LoadingException(String str, C17226e c17226e) {
            super(str);
        }

        /* synthetic */ LoadingException(String str, Throwable th2, C17226e c17226e) {
            super(str, th2);
        }
    }
    ...
    public interface a {
        ...
        public static class b {
            ...
            /* renamed from: a, reason: collision with root package name */
            public int f65854a = 0;

            /* renamed from: b, reason: collision with root package name */
            public int f65855b = 0;

            /* renamed from: c, reason: collision with root package name */
            public int f65856c = 0;
        }

        b a(Context context, String str, InterfaceC1270a interfaceC1270a) throws LoadingException;
    }
    ...
    */
    ...
    private static void i(ClassLoader classLoader) throws LoadingException {
        ...
        try {
            ...
            e = e10;
            throw new LoadingException("Failed to instantiate dynamite loader", e, c17226e);
    ...
    public static int a(Context context, String str) {
        try {
            ...
            if (C6660q.a(declaredField.get(null), str)) {
    ...
    */
    ...
    private static boolean j(Cursor cursor) {
        k kVar = (k) f65847m.get();
        if (kVar == null || kVar.f65857a != null) {
            return false;
        }
        kVar.f65857a = cursor;
        return true;
    ...
    private static boolean k(Context context) {
        ...
        if (bool.equals(null) || bool.equals(f65846l)) {
            return true;
        }
        boolean z10 = false;
        if (f65846l == null) {
            ...
            if (C14724g.f().h(context, 10000000) == 0 && providerInfoResolveContentProvider != null && "com.google.android.gms".equals(providerInfoResolveContentProvider.packageName)) {
                z10 = true;
            }
            f65846l = Boolean.valueOf(z10);
    ...
    public IBinder d(String str) throws LoadingException {
        try {
            return (IBinder) this.f65853a.getClassLoader().loadClass(str).newInstance();
