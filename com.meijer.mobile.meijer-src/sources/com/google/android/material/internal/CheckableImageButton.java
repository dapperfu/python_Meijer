...
public class CheckableImageButton extends AppCompatImageButton implements Checkable {
    ...
    private static final int[] f87909g = {R.attr.state_checked};

    /* renamed from: d, reason: collision with root package name */
    private boolean f87910d;

    /* renamed from: e, reason: collision with root package name */
    private boolean f87911e;

    /* renamed from: f, reason: collision with root package name */
    private boolean f87912f;
    ...
    static class b extends AbstractC17821a {
        ...
        public void writeToParcel(Parcel parcel, int i10) {
            ...
            parcel.writeInt(this.f87914c ? 1 : 0);
        }
    }
    ...
    public void setChecked(boolean z10) {
        if (!this.f87911e || this.f87910d == z10) {
            return;
        }
        this.f87910d = z10;
    ...
    @Override // android.widget.Checkable
    public void toggle() {
        setChecked(!this.f87910d);
    }

    @Override // android.view.View
    protected Parcelable onSaveInstanceState() {
        b bVar = new b(super.onSaveInstanceState());
        bVar.f87914c = this.f87910d;
        return bVar;
    }
}
