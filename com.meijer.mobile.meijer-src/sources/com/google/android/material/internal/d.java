...
public class d {
    ...
    private static final ThreadLocal<Matrix> f88031a = new ThreadLocal<>();

    /* renamed from: b, reason: collision with root package name */
    private static final ThreadLocal<RectF> f88032b = new ThreadLocal<>();

    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = f88031a;
        ...
        ThreadLocal<RectF> threadLocal2 = f88032b;
