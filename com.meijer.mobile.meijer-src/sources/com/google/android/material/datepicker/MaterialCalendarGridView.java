...
final class MaterialCalendarGridView extends GridView {
    ...
    private final Calendar f87665a;
    ...
    public MaterialCalendarGridView(Context context, AttributeSet attributeSet, int i10) {
        ...
        if (MaterialDatePicker.i1(getContext())) {
            setNextFocusLeftId(ce.f.f61699c);
            setNextFocusRightId(ce.f.f61702f);
        }
        this.f87666b = MaterialDatePicker.k1(getContext());
    ...
    protected final void onDraw(Canvas canvas) {
        ...
        d<?> dVar = adapter.f87757b;
        c cVar = adapter.f87759d;
        ...
        for (o2.d<Long, Long> dVar2 : dVar.W1()) {
            Long l10 = dVar2.f153583a;
            if (l10 == null) {
                materialCalendarGridView = this;
            } else if (dVar2.f153584b != null) {
                Long l11 = l10;
                long jLongValue = l11.longValue();
                Long l12 = dVar2.f153584b;
                ...
                if (!e(item, item2, l11, l12)) {
                    ...
                    if (jLongValue < item.longValue()) {
                        ...
                        materialCalendarGridView.f87665a.setTimeInMillis(jLongValue);
                        iA = adapter.a(materialCalendarGridView.f87665a.get(5));
                    ...
                    if (jLongValue2 > item2.longValue()) {
                        ...
                        materialCalendarGridView.f87665a.setTimeInMillis(jLongValue2);
                        iA2 = adapter.a(materialCalendarGridView.f87665a.get(5));
                    ...
                    while (itemId <= itemId2) {
                        ...
                        int top = viewC.getTop() + cVar.f87733a.c();
                        l lVar = adapter;
                        int bottom = viewC.getBottom() - cVar.f87733a.b();
                        if (zK) {
                        ...
                        canvas.drawRect(i10, top, width, bottom, cVar.f87740h);
                        itemId++;
                        materialCalendarGridView = this;
                        adapter = lVar;
                    }
