...
class RadialViewGroup extends ConstraintLayout {
    ...
    private final Runnable f88799x;

    /* renamed from: y, reason: collision with root package name */
    private int f88800y;

    /* renamed from: z, reason: collision with root package name */
    private C17234h f88801z;
    ...
    int D(int i10) {
        return i10 == 2 ? Math.round(this.f88800y * 0.66f) : this.f88800y;
    }

    public RadialViewGroup(Context context, AttributeSet attributeSet, int i10) {
        super(context, attributeSet, i10);
        LayoutInflater.from(context).inflate(h.f61745p, this);
        ViewCompat.q0(this, C());
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, l.f62325q6, i10, 0);
        this.f88800y = typedArrayObtainStyledAttributes.getDimensionPixelSize(l.f62337r6, 0);
        this.f88799x = new Runnable() { // from class: com.google.android.material.timepicker.c
    ...
    private Drawable C() {
        ...
        this.f88801z = c17234h;
        c17234h.Z(new C17237k(0.5f));
        this.f88801z.b0(ColorStateList.valueOf(-1));
        return this.f88801z;
    }
    ...
    protected void H() throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt.getId() != f.f61701e && !G(childAt)) {
                int i11 = (Integer) childAt.getTag(f.f61711o);
                if (i11 == null) {
                    i11 = 1;
                }
    ...
    public void setBackgroundColor(int i10) {
        this.f88801z.b0(ColorStateList.valueOf(i10));
    }
    ...
    private void B(List<View> list, androidx.constraintlayout.widget.c cVar, int i10) {
        ...
        float size = 0.0f;
        while (it.hasNext()) {
            cVar.j(it.next().getId(), f.f61701e, i10, size);
    ...
    private void I() {
        ...
        if (handler != null) {
            handler.removeCallbacks(this.f88799x);
            handler.post(this.f88799x);
        }
    }
