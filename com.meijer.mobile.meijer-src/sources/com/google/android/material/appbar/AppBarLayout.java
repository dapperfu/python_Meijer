...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.b, FSDraw, FSDispatchDraw {
    ...
    private static final int f87007z = k.f61809j;
    ...
    private List<b> f87015h;

    /* renamed from: i, reason: collision with root package name */
    private boolean f87016i;

    /* renamed from: j, reason: collision with root package name */
    private boolean f87017j;

    /* renamed from: k, reason: collision with root package name */
    private boolean f87018k;

    /* renamed from: l, reason: collision with root package name */
    private boolean f87019l;

    /* renamed from: m, reason: collision with root package name */
    private int f87020m;

    /* renamed from: n, reason: collision with root package name */
    private WeakReference<View> f87021n;

    /* renamed from: o, reason: collision with root package name */
    private final boolean f87022o;

    /* renamed from: p, reason: collision with root package name */
    private ValueAnimator f87023p;

    /* renamed from: q, reason: collision with root package name */
    private ValueAnimator.AnimatorUpdateListener f87024q;

    /* renamed from: r, reason: collision with root package name */
    private final List<f> f87025r;

    /* renamed from: s, reason: collision with root package name */
    private final long f87026s;

    /* renamed from: t, reason: collision with root package name */
    private final TimeInterpolator f87027t;

    /* renamed from: u, reason: collision with root package name */
    private int[] f87028u;

    /* renamed from: v, reason: collision with root package name */
    private Drawable f87029v;

    /* renamed from: w, reason: collision with root package name */
    private Integer f87030w;

    /* renamed from: x, reason: collision with root package name */
    private final float f87031x;

    /* renamed from: y, reason: collision with root package name */
    private Behavior f87032y;
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends com.google.android.material.appbar.d<T> {
        ...
        /* renamed from: m, reason: collision with root package name */
        private ValueAnimator f87035m;

        /* renamed from: n, reason: collision with root package name */
        private c f87036n;

        /* renamed from: o, reason: collision with root package name */
        private WeakReference<View> f87037o;

        class a implements ValueAnimator.AnimatorUpdateListener {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ CoordinatorLayout f87038a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ AppBarLayout f87039b;

            a(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout) {
                this.f87038a = coordinatorLayout;
                this.f87039b = appBarLayout;
            }

            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                BaseBehavior.this.T(this.f87038a, this.f87039b, ((Integer) valueAnimator.getAnimatedValue()).intValue());
            }
        }
        ...
        class b extends androidx.core.view.a {
            ...
            /* renamed from: d, reason: collision with root package name */
            final /* synthetic */ AppBarLayout f87041d;

            /* renamed from: e, reason: collision with root package name */
            final /* synthetic */ CoordinatorLayout f87042e;

            b(AppBarLayout appBarLayout, CoordinatorLayout coordinatorLayout) {
                this.f87041d = appBarLayout;
                this.f87042e = coordinatorLayout;
            }
            ...
            public boolean j(View view, int i10, Bundle bundle) {
                if (i10 == 4096) {
                    this.f87041d.setExpanded(false);
                    return true;
                }
                if (i10 != 8192) {
                ...
                if (BaseBehavior.this.Q() != 0) {
                    View viewJ0 = BaseBehavior.this.j0(this.f87042e);
                    if (!viewJ0.canScrollVertically(-1)) {
                        this.f87041d.setExpanded(true);
                        return true;
                    }
                    int i11 = -this.f87041d.getDownNestedPreScrollRange();
                    if (i11 != 0) {
                        BaseBehavior.this.u(this.f87042e, this.f87041d, viewJ0, 0, i11, new int[]{0, 0}, 1);
                        return true;
                    }
                }
                return false;
            ...
            public void g(View view, y yVar) {
                ...
                if (this.f87041d.getTotalScrollRange() != 0 && (viewJ0 = BaseBehavior.this.j0(this.f87042e)) != null && BaseBehavior.this.f0(this.f87041d)) {
                    if (BaseBehavior.this.Q() != (-this.f87041d.getTotalScrollRange())) {
                        yVar.b(y.a.f157849q);
                        yVar.R0(true);
                    }
                    if (BaseBehavior.this.Q() != 0) {
                        if (viewJ0.canScrollVertically(-1)) {
                            if ((-this.f87041d.getDownNestedPreScrollRange()) != 0) {
                                yVar.b(y.a.f157850r);
                                yVar.R0(true);
                                return;
                            }
        ...
        protected static class c extends AbstractC17821a {
            ...
            public c(Parcel parcel, ClassLoader classLoader) {
                ...
                this.f87044c = parcel.readByte() != 0;
                this.f87045d = parcel.readByte() != 0;
                this.f87046e = parcel.readInt();
                this.f87047f = parcel.readFloat();
                this.f87048g = parcel.readByte() != 0;
            }

            @Override // w2.AbstractC17821a, android.os.Parcelable
            public void writeToParcel(Parcel parcel, int i10) {
                super.writeToParcel(parcel, i10);
                parcel.writeByte(this.f87044c ? (byte) 1 : (byte) 0);
                parcel.writeByte(this.f87045d ? (byte) 1 : (byte) 0);
                parcel.writeInt(this.f87046e);
                parcel.writeFloat(this.f87047f);
                parcel.writeByte(this.f87048g ? (byte) 1 : (byte) 0);
            }
        ...
        public boolean L(T t10) {
            WeakReference<View> weakReference = this.f87037o;
        ...
        */
        ...
        public void B(CoordinatorLayout coordinatorLayout, T t10, Parcelable parcelable) {
            if (parcelable instanceof c) {
                ...
                super.B(coordinatorLayout, t10, this.f87036n.a());
            } else {
        ...
        public boolean E(CoordinatorLayout coordinatorLayout, T t10, View view, View view2, int i10, int i11) {
            ...
            if (z10 && (valueAnimator = this.f87035m) != null) {
        ...
        public void G(CoordinatorLayout coordinatorLayout, T t10, View view, int i10) {
            if (this.f87034l == 0 || i10 == 1) {
                A0(coordinatorLayout, t10);
                if (t10.q()) {
                    t10.A(t10.D(view));
                }
            }
            this.f87037o = new WeakReference<>(view);
        }

        void w0(c cVar, boolean z10) {
            if (this.f87036n == null || z10) {
                this.f87036n = cVar;
            }
        }
        ...
        private void A0(CoordinatorLayout coordinatorLayout, T t10) {
            ...
            if (iI0 >= 0) {
                ...
                if ((iC & 17) == 17) {
                    ...
                    Z(coordinatorLayout, t10, C14442a.b(b0(iQ, iA, topInset2) + topInset, -t10.getTotalScrollRange(), 0), 0.0f);
                }
            }
        }
        ...
        private void a0(CoordinatorLayout coordinatorLayout, T t10, int i10, int i11) {
            int iQ = Q();
            if (iQ == i10) {
                ValueAnimator valueAnimator = this.f87035m;
            ...
            ValueAnimator valueAnimator2 = this.f87035m;
            if (valueAnimator2 == null) {
                ValueAnimator valueAnimator3 = new ValueAnimator();
                this.f87035m = valueAnimator3;
                valueAnimator3.setInterpolator(C13661a.f128354e);
                this.f87035m.addUpdateListener(new a(coordinatorLayout, t10));
            } else {
                valueAnimator2.cancel();
            }
            this.f87035m.setDuration(Math.min(i11, 600));
            this.f87035m.setIntValues(iQ, i10);
            this.f87035m.start();
        }
        ...
        public boolean f0(AppBarLayout appBarLayout) {
            ...
            for (int i10 = 0; i10 < childCount; i10++) {
                if (((e) appBarLayout.getChildAt(i10).getLayoutParams()).f87052a != 0) {
                    return true;
                }
            }
            return false;
        ...
        private View g0(CoordinatorLayout coordinatorLayout) {
            ...
            for (int i10 = 0; i10 < childCount; i10++) {
                ...
                if ((childAt instanceof InterfaceC16341B) || (childAt instanceof AbsListView) || (childAt instanceof ScrollView)) {
                    return childAt;
                }
            }
            return null;
        ...
        public boolean p(CoordinatorLayout coordinatorLayout, T t10, int i10) {
            ...
            if (cVar != null && (pendingAction & 8) == 0) {
                ...
                } else if (cVar.f87045d) {
                    T(coordinatorLayout, t10, 0);
                } else {
                    View childAt = t10.getChildAt(cVar.f87046e);
                    int i11 = -childAt.getBottom();
                    if (this.f87036n.f87048g) {
                        iRound = ViewCompat.A(childAt) + t10.getTopInset();
                    } else {
                        iRound = Math.round(childAt.getHeight() * this.f87036n.f87047f);
                    }
            ...
            t10.w();
            this.f87036n = null;
            K(C14442a.b(I(), -t10.getTotalScrollRange(), 0));
        ...
        c x0(Parcelable parcelable, T t10) {
            ...
            for (int i10 = 0; i10 < childCount; i10++) {
                ...
                if (childAt.getTop() + I10 <= 0 && bottom >= 0) {
                    if (parcelable == null) {
                        parcelable = AbstractC17821a.f166862b;
                    }
                    ...
                    cVar.f87048g = z12;
                    cVar.f87047f = bottom / childAt.getHeight();
                    return cVar;
                }
            }
            return null;
    ...
    public static class ScrollingViewBehavior extends com.google.android.material.appbar.e {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, l.f62421y6);
            S(typedArrayObtainStyledAttributes.getDimensionPixelSize(l.f62433z6, 0));
        ...
        private void W(View view, View view2) {
            ...
            if (cVarF instanceof BaseBehavior) {
                ViewCompat.Y(view, (((view2.getBottom() - view.getTop()) + ((BaseBehavior) cVarF).f87033k) + Q()) - M(view2));
            }
        }
    ...
    public static class d extends c {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final Rect f87050a = new Rect();

        /* renamed from: b, reason: collision with root package name */
        private final Rect f87051b = new Rect();

        @Override // com.google.android.material.appbar.AppBarLayout.c
        public void a(AppBarLayout appBarLayout, View view, float f10) {
            b(this.f87050a, appBarLayout, view);
            float fAbs = this.f87050a.top - Math.abs(f10);
            if (fAbs > 0.0f) {
            ...
            float fA = 1.0f - C14442a.a(Math.abs(fAbs / this.f87050a.height()), 0.0f, 1.0f);
            float fHeight = (-fAbs) - ((this.f87050a.height() * 0.3f) * (1.0f - (fA * fA)));
            view.setTranslationY(fHeight);
            view.getDrawingRect(this.f87051b);
            this.f87051b.offset(0, (int) (-fHeight));
            if (fHeight >= this.f87051b.height()) {
                view.setVisibility(4);
            } else {
                view.setVisibility(0);
            }
            ViewCompat.t0(view, this.f87051b);
        }
    ...
    public static class e extends LinearLayout.LayoutParams {
        ...
        /* renamed from: c, reason: collision with root package name */
        Interpolator f87054c;

        public e(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            this.f87052a = 1;
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, l.f62378v);
            this.f87052a = typedArrayObtainStyledAttributes.getInt(l.f62402x, 0);
            f(typedArrayObtainStyledAttributes.getInt(l.f62390w, 0));
            if (typedArrayObtainStyledAttributes.hasValue(l.f62414y)) {
                this.f87054c = AnimationUtils.loadInterpolator(context, typedArrayObtainStyledAttributes.getResourceId(l.f62414y, 0));
            }
            typedArrayObtainStyledAttributes.recycle();
        }
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C6503b.f61522b);
    }
    ...
    public void setLiftOnScrollTargetView(View view) {
        ...
        if (view == null) {
            ...
            this.f87021n = new WeakReference<>(view);
        }
    }
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet, int i10) throws Resources.NotFoundException {
        ...
        TypedArray typedArrayI = s.i(context2, attributeSet, l.f62246k, i10, i11, new int[0]);
        ViewCompat.q0(this, __fsTypeCheck_7aed730c0cb897b271b15a3fca45c160(typedArrayI, l.f62258l));
        ColorStateList colorStateListA = C16634c.a(context2, typedArrayI, l.f62330r);
        this.f87022o = colorStateListA != null;
        ...
        if (colorStateListF != null) {
            ...
            if (colorStateListA != null) {
                n(c17234h, colorStateListF, colorStateListA);
            } else {
                o(context2, c17234h);
            }
        }
        this.f87026s = i.f(context2, C6503b.f61504K, getResources().getInteger(ce.g.f61723a));
        this.f87027t = i.g(context2, C6503b.f61515V, C13661a.f128350a);
        if (typedArrayI.hasValue(l.f62306p)) {
            y(typedArrayI.getBoolean(l.f62306p, false), false, false);
        }
        if (typedArrayI.hasValue(l.f62294o)) {
            h.b(this, typedArrayI.getDimensionPixelSize(l.f62294o, 0));
        }
        if (i12 >= 26) {
            if (typedArrayI.hasValue(l.f62282n)) {
                setKeyboardNavigationCluster(typedArrayI.getBoolean(l.f62282n, false));
            }
            if (typedArrayI.hasValue(l.f62270m)) {
                setTouchscreenBlocksFocus(typedArrayI.getBoolean(l.f62270m, false));
            }
        }
        this.f87031x = getResources().getDimension(ce.d.f61606a);
        this.f87019l = typedArrayI.getBoolean(l.f62318q, false);
        this.f87020m = typedArrayI.getResourceId(l.f62342s, -1);
        setStatusBarForeground(__fsTypeCheck_7aed730c0cb897b271b15a3fca45c160(typedArrayI, l.f62354t));
        typedArrayI.recycle();
        ViewCompat.A0(this, new a());
    }

    private boolean C() {
        return this.f87029v != null && getTopInset() > 0;
    }

    private void F(float f10, float f11) {
        ValueAnimator valueAnimator = this.f87023p;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(f10, f11);
        this.f87023p = valueAnimatorOfFloat;
        valueAnimatorOfFloat.setDuration(this.f87026s);
        this.f87023p.setInterpolator(this.f87027t);
        ValueAnimator.AnimatorUpdateListener animatorUpdateListener = this.f87024q;
        if (animatorUpdateListener != null) {
            this.f87023p.addUpdateListener(animatorUpdateListener);
        }
        this.f87023p.start();
    }

    private void e() {
        WeakReference<View> weakReference = this.f87021n;
        if (weakReference != null) {
            weakReference.clear();
        }
        this.f87021n = null;
    ...
    private Integer f() {
        Drawable drawable = this.f87029v;
        if (drawable instanceof C17234h) {
            return Integer.valueOf(((C17234h) drawable).A());
        }
    ...
    private View g(View view) {
        int i10;
        if (this.f87021n == null && (i10 = this.f87020m) != -1) {
            View viewFindViewById = view != null ? view.findViewById(i10) : null;
            if (viewFindViewById == null && (getParent() instanceof ViewGroup)) {
                viewFindViewById = ((ViewGroup) getParent()).findViewById(this.f87020m);
            }
            if (viewFindViewById != null) {
                this.f87021n = new WeakReference<>(viewFindViewById);
            }
        }
        WeakReference<View> weakReference = this.f87021n;
        if (weakReference != null) {
    ...
    private void p() {
        Behavior behavior = this.f87032y;
        BaseBehavior.c cVarX0 = (behavior == null || this.f87009b == -1 || this.f87013f != 0) ? null : behavior.x0(AbstractC17821a.f166862b, this);
        this.f87009b = -1;
        this.f87010c = -1;
        this.f87011d = -1;
        if (cVarX0 != null) {
            this.f87032y.w0(cVarX0, false);
        }
    }

    private void y(boolean z10, boolean z11, boolean z12) {
        this.f87013f = (z10 ? 1 : 2) | (z11 ? 4 : 0) | (z12 ? 8 : 0);
        requestLayout();
    }
    ...
    boolean A(boolean z10) {
        return B(z10, !this.f87016i);
    }

    boolean B(boolean z10, boolean z11) {
        if (!z11 || this.f87018k == z10) {
            return false;
        }
        this.f87018k = z10;
        refreshDrawableState();
        ...
        F(z10 ? 0.0f : this.f87031x, z10 ? this.f87031x : 0.0f);
        return true;
    }

    public void c(b bVar) {
        if (this.f87015h == null) {
            this.f87015h = new ArrayList();
        }
        if (bVar == null || this.f87015h.contains(bVar)) {
            return;
        }
        this.f87015h.add(bVar);
    }
    ...
    protected int[] onCreateDrawableState(int i10) {
        if (this.f87028u == null) {
            this.f87028u = new int[4];
        }
        int[] iArr = this.f87028u;
        int[] iArrOnCreateDrawableState = super.onCreateDrawableState(i10 + iArr.length);
        boolean z10 = this.f87017j;
        int i11 = C6503b.f61537i0;
        if (!z10) {
            i11 = -i11;
        }
        iArr[0] = i11;
        iArr[1] = (z10 && this.f87018k) ? C6503b.f61539j0 : -C6503b.f61539j0;
        int i12 = C6503b.f61529e0;
        if (!z10) {
            i12 = -i12;
        }
        iArr[2] = i12;
        iArr[3] = (z10 && this.f87018k) ? C6503b.f61527d0 : -C6503b.f61527d0;
    ...
    void s(int i10) {
        ...
        List<b> list = this.f87015h;
        if (list != null) {
            int size = list.size();
            for (int i11 = 0; i11 < size; i11++) {
                b bVar = this.f87015h.get(i11);
                if (bVar != null) {
                    bVar.a(this, i10);
                }
            }
    ...
    public void setStatusBarForeground(Drawable drawable) {
        Drawable drawable2 = this.f87029v;
        if (drawable2 != drawable) {
            if (drawable2 != null) {
                drawable2.setCallback(null);
            }
            this.f87029v = drawable != null ? drawable.mutate() : null;
            this.f87030w = f();
            Drawable drawable3 = this.f87029v;
            if (drawable3 != null) {
                if (drawable3.isStateful()) {
                    this.f87029v.setState(getDrawableState());
                }
                C13595a.m(this.f87029v, ViewCompat.z(this));
                this.f87029v.setVisible(getVisibility() == 0, false);
                this.f87029v.setCallback(this);
            }
            G();
            ViewCompat.d0(this);
        }
    ...
    public static /* synthetic */ void a(AppBarLayout appBarLayout, C17234h c17234h, ValueAnimator valueAnimator) {
        appBarLayout.getClass();
        float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        c17234h.a0(fFloatValue);
        Drawable drawable = appBarLayout.f87029v;
        if (drawable instanceof C17234h) {
            ((C17234h) drawable).a0(fFloatValue);
        }
        Iterator<f> it = appBarLayout.f87025r.iterator();
        while (it.hasNext()) {
            it.next().a(fFloatValue, c17234h.A());
        }
    }

    public static /* synthetic */ void b(AppBarLayout appBarLayout, ColorStateList colorStateList, ColorStateList colorStateList2, C17234h c17234h, Integer num, ValueAnimator valueAnimator) {
        Integer num2;
        appBarLayout.getClass();
        int iJ = C15121a.j(colorStateList.getDefaultColor(), colorStateList2.getDefaultColor(), ((Float) valueAnimator.getAnimatedValue()).floatValue());
        c17234h.b0(ColorStateList.valueOf(iJ));
        if (appBarLayout.f87029v != null && (num2 = appBarLayout.f87030w) != null && num2.equals(num)) {
            C13595a.n(appBarLayout.f87029v, iJ);
        }
        if (!appBarLayout.f87025r.isEmpty()) {
            for (f fVar : appBarLayout.f87025r) {
                if (c17234h.x() != null) {
                    fVar.a(0.0f, iJ);
                }
            }
    ...
    private void n(final C17234h c17234h, final ColorStateList colorStateList, final ColorStateList colorStateList2) {
        final Integer numF = C15121a.f(getContext(), C6503b.f61556s);
        this.f87024q = new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.appbar.b
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                AppBarLayout.b(this.f87099a, colorStateList, colorStateList2, c17234h, numF, valueAnimator);
            }
        };
        ViewCompat.q0(this, c17234h);
    }

    private void o(Context context, final C17234h c17234h) {
        c17234h.Q(context);
        this.f87024q = new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.appbar.c
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                AppBarLayout.a(this.f87104a, c17234h, valueAnimator);
            }
        };
        ViewCompat.q0(this, c17234h);
    }
    ...
    private boolean r() {
        return getBackground() instanceof C17234h;
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (C()) {
            ...
            canvas.translate(0.0f, -this.f87008a);
            this.f87029v.draw(canvas);
    ...
    public C17234h getMaterialShapeBackground() {
        Drawable background = getBackground();
        if (background instanceof C17234h) {
            return (C17234h) background;
        }
        return null;
    }
    ...
    protected void onMeasure(int i10, int i11) {
        ...
        if (mode != 1073741824 && ViewCompat.w(this) && E()) {
            ...
            if (mode != Integer.MIN_VALUE) {
                ...
                measuredHeight = C14442a.b(getMeasuredHeight() + getTopInset(), 0, View.MeasureSpec.getSize(i11));
            }
    ...
    public void setStatusBarForegroundResource(int i10) {
        setStatusBarForeground(C14879a.b(getContext(), i10));
    }
    ...
    protected boolean verifyDrawable(Drawable drawable) {
        if (!super.verifyDrawable(drawable) && drawable != this.f87029v) {
            return false;
        }
        return true;
    }
