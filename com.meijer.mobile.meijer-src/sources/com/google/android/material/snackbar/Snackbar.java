...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    private static final int[] f88400J;

    /* renamed from: K, reason: collision with root package name */
    private static final int[] f88401K;

    /* renamed from: H, reason: collision with root package name */
    private final AccessibilityManager f88402H;

    /* renamed from: I, reason: collision with root package name */
    private boolean f88403I;
    ...
    static {
        int i10 = C6503b.f61521a0;
        f88400J = new int[]{i10};
        f88401K = new int[]{i10, C6503b.f61525c0};
    }

    private SnackbarContentLayout n0() {
        return (SnackbarContentLayout) this.f88346i.getChildAt(0);
    }

    private static boolean p0(Context context) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(f88401K);
    ...
    public Snackbar w0(ColorStateList colorStateList) {
        this.f88346i.setBackgroundTintList(colorStateList);
        return this;
    }

    public Snackbar x0(PorterDuff.Mode mode) {
        this.f88346i.setBackgroundTintMode(mode);
        return this;
    }
    ...
    private Snackbar(Context context, ViewGroup viewGroup, View view, com.google.android.material.snackbar.a aVar) {
        ...
        this.f88402H = (AccessibilityManager) viewGroup.getContext().getSystemService("accessibility");
    }
    ...
    public int F() {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            return this.f88402H.getRecommendedTimeoutMillis(iF, i10 | 3);
        }
        if (this.f88403I && this.f88402H.isTouchExplorationEnabled()) {
            return -2;
        }
        return iF;
    }
        ...
        if (!TextUtils.isEmpty(charSequence) && onClickListener != null) {
            ...
            buttonM0.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.snackbar.c
                ...
                public final void onClick(View view) {
                    Snackbar.k0(this.f88408a, onClickListener, view);
                }
            });
            return this;
        }
