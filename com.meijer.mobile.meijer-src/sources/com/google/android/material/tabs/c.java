...
class c {
    ...
    void d(TabLayout tabLayout, View view, View view2, float f10, Drawable drawable) {
        ...
        drawable.setBounds(C13661a.c((int) rectFA.left, (int) rectFA2.left, f10), drawable.getBounds().top, C13661a.c((int) rectFA.right, (int) rectFA2.right, f10), drawable.getBounds().bottom);
    }
}
