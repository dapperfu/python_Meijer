...
public final class zzlk {
    ...
    public static String zzc(LatLng latLng) {
        ...
        return zzf(latLng.f85654a, latLng.f85655b);
    }
    ...
    private static String zzg(RectangularBounds rectangularBounds) {
        ...
        double d10 = southwest.f85654a;
        double d11 = southwest.f85655b;
        LatLng northeast = rectangularBounds.getNortheast();
        return String.format(Locale.US, "rectangle:%.15f,%.15f|%.15f,%.15f", Double.valueOf(d10), Double.valueOf(d11), Double.valueOf(northeast.f85654a), Double.valueOf(northeast.f85655b));
    }
}
