...
final class zzt extends SearchByTextRequest {
    private final AbstractC5507a zza;
    ...
    /* synthetic */ zzt(AbstractC5507a abstractC5507a, String str, LocationBias locationBias, LocationRestriction locationRestriction, Integer num, Double d10, boolean z10, List list, List list2, SearchByTextRequest.RankPreference rankPreference, String str2, boolean z11, String str3, EVSearchOptions eVSearchOptions, RoutingParameters routingParameters, SearchAlongRouteParameters searchAlongRouteParameters, boolean z12, boolean z13, byte[] bArr) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof SearchByTextRequest) {
            ...
            AbstractC5507a abstractC5507a = this.zza;
            if (abstractC5507a != null ? abstractC5507a.equals(searchByTextRequest.getCancellationToken()) : searchByTextRequest.getCancellationToken() == null) {
    ...
    public final int hashCode() {
        AbstractC5507a abstractC5507a = this.zza;
        int iHashCode = abstractC5507a == null ? 0 : abstractC5507a.hashCode();
        String str = this.zzb;
