...
final class zzq extends IsOpenRequest {
        ...
        if (obj instanceof IsOpenRequest) {
            ...
            if (place != null ? place.equals(isOpenRequest.getPlace()) : isOpenRequest.getPlace() == null) {
                ...
                if (str != null ? str.equals(isOpenRequest.getPlaceId()) : isOpenRequest.getPlaceId() == null) {
                    if (this.zzc == isOpenRequest.getUtcTimeMillis() && ((abstractC5507a = this.zzd) != null ? abstractC5507a.equals(isOpenRequest.getCancellationToken()) : isOpenRequest.getCancellationToken() == null)) {
                        return true;
                    }
                }
            }
    ...
    public final int hashCode() {
        ...
        return (((((i10 * 1000003) ^ iHashCode2) * 1000003) ^ ((int) (j10 ^ (j10 >>> 32)))) * 1000003) ^ (abstractC5507a != null ? abstractC5507a.hashCode() : 0);
    }
    ...
    /* synthetic */ zzq(Place place, String str, long j10, AbstractC5507a abstractC5507a, byte[] bArr) {
        this.zza = place;
        this.zzb = str;
        this.zzc = j10;
