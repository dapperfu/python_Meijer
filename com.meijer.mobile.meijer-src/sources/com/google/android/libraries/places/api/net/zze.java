...
final class zze extends FetchPlaceRequest {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof FetchPlaceRequest) {
            ...
            if (this.zza.equals(fetchPlaceRequest.getPlaceId()) && this.zzb.equals(fetchPlaceRequest.getPlaceFields()) && ((autocompleteSessionToken = this.zzc) != null ? autocompleteSessionToken.equals(fetchPlaceRequest.getSessionToken()) : fetchPlaceRequest.getSessionToken() == null) && ((abstractC5507a = this.zzd) != null ? abstractC5507a.equals(fetchPlaceRequest.getCancellationToken()) : fetchPlaceRequest.getCancellationToken() == null) && ((str = this.zze) != null ? str.equals(fetchPlaceRequest.getRegionCode()) : fetchPlaceRequest.getRegionCode() == null)) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        ...
        int iHashCode3 = (iHashCode2 ^ (abstractC5507a == null ? 0 : abstractC5507a.hashCode())) * 1000003;
        String str = this.zze;
    ...
    public final String toString() {
        ...
        String strValueOf2 = String.valueOf(abstractC5507a);
    ...
    /* synthetic */ zze(String str, List list, AutocompleteSessionToken autocompleteSessionToken, AbstractC5507a abstractC5507a, String str2, byte[] bArr) {
        this.zza = str;
        this.zzb = list;
