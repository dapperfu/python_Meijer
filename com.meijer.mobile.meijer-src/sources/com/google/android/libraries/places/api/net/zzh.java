...
final class zzh extends FetchResolvedPhotoUriRequest {
        ...
        if (obj instanceof FetchResolvedPhotoUriRequest) {
            ...
            if (num != null ? num.equals(fetchResolvedPhotoUriRequest.getMaxWidth()) : fetchResolvedPhotoUriRequest.getMaxWidth() == null) {
                ...
                if (num2 != null ? num2.equals(fetchResolvedPhotoUriRequest.getMaxHeight()) : fetchResolvedPhotoUriRequest.getMaxHeight() == null) {
                    if (this.zzc.equals(fetchResolvedPhotoUriRequest.getPhotoMetadata()) && ((abstractC5507a = this.zzd) != null ? abstractC5507a.equals(fetchResolvedPhotoUriRequest.getCancellationToken()) : fetchResolvedPhotoUriRequest.getCancellationToken() == null)) {
                        return true;
                    }
                }
            }
    ...
    /* synthetic */ zzh(Integer num, Integer num2, PhotoMetadata photoMetadata, AbstractC5507a abstractC5507a, byte[] bArr) {
        this.zza = num;
        this.zzb = num2;
