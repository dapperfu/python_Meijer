...
import androidx.view.AbstractC6166m;
...
public final class PlaceDetailsCompactFragment extends Fragment {
    ...
    private List zzp;
    private final ReadWriteProperty zzq = Delegates.f143781a.a();
    ...
    public static final /* synthetic */ void zza(@RecentlyNonNull PlaceDetailsCompactFragment placeDetailsCompactFragment, @RecentlyNonNull Place place) {
        ...
        if (zzarVar == null) {
            Intrinsics.x("compactViewController");
            zzarVar = null;
        }
    ...
    private final void zzh() {
        ...
        if (textView2 == null) {
            Intrinsics.x(PlaceTypes.ADDRESS);
            textView2 = null;
        }
        textView2.setVisibility(8);
        View view2 = this.zzh;
        if (view2 == null) {
            Intrinsics.x("openInMaps");
            view2 = null;
        }
    ...
    public final void onViewCreated(@RecentlyNonNull View view, Bundle savedInstanceState) throws Resources.NotFoundException {
        ...
        AbstractC6166m abstractC6166mA = C6173t.a(this);
        int iZzf2 = zzf();
        ...
        com.google.android.libraries.places.widget.internal.placedetails.zzar zzarVar = new com.google.android.libraries.places.widget.internal.placedetails.zzar(view, contextRequireContext3, zzoyVarZze2, abstractC6166mA, iZzf2, orientation);
        this.zzl = zzarVar;
        zzarVar.zza();
        zzh();
        ...
        ((AbstractC6127A) zzbiVar6.zzc().get(0)).i(getViewLifecycleOwner(), new zzq(new Function1() { // from class: com.google.android.libraries.places.widget.zzl
