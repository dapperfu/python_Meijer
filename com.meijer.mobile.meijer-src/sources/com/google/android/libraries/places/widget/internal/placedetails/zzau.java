...
final class zzau {
    ...
    private final C6130D zzc;

    public zzau(PhotoMetadata metadata, int i10, C6130D destination) {
    ...
    public final String toString() {
        ...
        C6130D c6130d = this.zzc;
        StringBuilder sb2 = new StringBuilder(length + 40 + length2 + 14 + String.valueOf(c6130d).length() + 1);
