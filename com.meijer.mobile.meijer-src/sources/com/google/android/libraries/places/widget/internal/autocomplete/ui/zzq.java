...
public final class zzq extends RecyclerView.F {
    ...
    public zzq(final zzp zzpVar, View view, zzng zzngVar) {
        super(view);
        this.zzh = new ForegroundColorSpan(C15121a.d(view, R.attr.placesColorOnSurfaceVariant));
        this.zzi = new ForegroundColorSpan(C15121a.d(view, R.attr.placesColorOnSurface));
