...
public final class PlaceSearchFragment extends Fragment {
    ...
    private final ReadWriteProperty zzm = Delegates.f143781a.a();
    ...
    static /* synthetic */ Unit zzd(final PlaceSearchFragment placeSearchFragment, final List list) throws Resources.NotFoundException {
        ...
        AbstractC6166m abstractC6166mA = C6173t.a(placeSearchFragment);
        ...
        placeSearchFragment.zze = new zzpi(abstractC6166mA, orientation3, iZzl, dimensionPixelSize, z10, z11, list, zzpwVar.zze(), new Function1() { // from class: com.google.android.libraries.places.widget.zzap
        ...
        if (orientation6 == Orientation.HORIZONTAL) {
            ...
            int iD = C15121a.d(placeSearchFragment.requireView(), R.attr.placesColorOutlineDecorative);
