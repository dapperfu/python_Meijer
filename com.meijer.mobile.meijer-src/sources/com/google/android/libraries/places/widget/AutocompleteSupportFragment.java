...
public class AutocompleteSupportFragment extends Fragment {
    ...
    public void onViewCreated(@RecentlyNonNull View view, Bundle bundle) {
        ...
        this.zza.i(getViewLifecycleOwner(), new InterfaceC6131E() { // from class: com.google.android.libraries.places.widget.zzg
            @Override // androidx.view.InterfaceC6131E
            public final /* synthetic */ void onChanged(Object obj) {
                this.zza.zzc(editText, viewFindViewById2, (CharSequence) obj);
            }
        });
        this.zzb.i(getViewLifecycleOwner(), new InterfaceC6131E() { // from class: com.google.android.libraries.places.widget.zzh
            @Override // androidx.view.InterfaceC6131E
            public final /* synthetic */ void onChanged(Object obj) {
    ...
    public void onCreate(Bundle bundle) throws Throwable {
        ...
        if (bundle != null) {
            try {
                ...
                if (zzngVar != null) {
                    C6130D c6130d = this.zza;
                    if (c6130d.e() == 0) {
                        c6130d.m(zzngVar.zzf());
                    }
                    C6130D c6130d2 = this.zzb;
                    if (c6130d2.e() == 0) {
                        c6130d2.m(zzngVar.zzg());
                    }
