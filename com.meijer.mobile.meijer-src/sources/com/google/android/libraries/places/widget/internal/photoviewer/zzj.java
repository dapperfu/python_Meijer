...
public final class zzj extends Fragment {
    ...
    public final void zzi(boolean z10) {
        ...
        View view2 = null;
        if (view == null) {
            Intrinsics.x("previousImageButton");
            view = null;
        }
        view.setEnabled(z10);
        View view3 = this.zzi;
        if (view3 == null) {
            Intrinsics.x("nextImageButton");
        } else {
            view2 = view3;
        }
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        if (zziVar == null) {
            Intrinsics.x("pageData");
            zziVar = null;
        }
        j<Drawable> jVarI = kVarT.i(zziVar.zzb());
        Context contextRequireContext = requireContext();
        Intrinsics.i(contextRequireContext, "requireContext(...)");
        j<Drawable> jVarA = jVarI.a(C16082g.p0(new zza(contextRequireContext, 25.0f, 0.125f)));
        ImageView imageView2 = this.zzd;
        if (imageView2 == null) {
            Intrinsics.x("blurredBackground");
        } else {
        ...
        requireView().post(new Runnable() { // from class: com.google.android.libraries.places.widget.internal.photoviewer.zze
            ...
            public final /* synthetic */ void run() {
                zzj zzjVar = this.zza;
                C15809k.d(C6173t.a(zzjVar), null, null, new zzi(zzjVar, null), 3, null);
            }
        });
    }
    ...
    public final zzc zzb() {
        ...
        Intrinsics.x("photoNavigationListener");
        return null;
    }
