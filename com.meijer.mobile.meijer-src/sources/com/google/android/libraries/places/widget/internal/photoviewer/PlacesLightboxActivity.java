...
public final class PlacesLightboxActivity extends AppCompatActivity implements zzc {
    ...
    private int zzg;
    private int zzh = -1;
    private final ReadWriteProperty zzi = Delegates.f143781a.a();
    private zzv zzj;
    ...
    protected void onCreate(Bundle savedInstanceState) throws Resources.NotFoundException {
        ...
        zzv zzvVar = this.zzj;
        if (zzvVar == null) {
            Intrinsics.x("themeDimensionHelper");
            zzvVar = null;
        }
        ...
        ViewCompat.A0(viewFindViewById4, new G() { // from class: com.google.android.libraries.places.widget.internal.photoviewer.zzq
            ...
            public final /* synthetic */ j onApplyWindowInsets(View view, j insets) {
                ...
                marginLayoutParams.setMargins(marginLayoutParams.leftMargin, marginLayoutParams.topMargin, marginLayoutParams.rightMargin, insets.f(j.n.i()).f61164d + ((int) fZzb));
                return insets;
            }
        });
    ...
    static /* synthetic */ j zzf(PlacesLightboxActivity placesLightboxActivity, float f10, View v10, j insets) {
        ...
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) layoutParams;
        marginLayoutParams.topMargin = dVarF.f61162b;
        int i10 = (int) f10;
    ...
    public final void zzj(int i10) {
        ...
        if (zziVar != null) {
            ...
            if (imageView2 == null) {
                Intrinsics.x("userProfileImageView");
            } else {
