...
public final class M {
    ...
    public static final Charset f89028a = Charset.forName("UTF-8");
    ...
    public static final Ye.a b(String str) throws GeneralSecurityException {
    ...
    public static final Ye.a h(String str) {
        byte[] bArr = new byte[str.length()];
        for (int i10 = 0; i10 < str.length(); i10++) {
