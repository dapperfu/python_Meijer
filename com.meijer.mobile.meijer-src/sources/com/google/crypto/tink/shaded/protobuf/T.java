...
final class T {
    ...
    private static final char[] f89125a;
    ...
    static void d(StringBuilder sb2, int i10, String str, Object obj) throws SecurityException {
        ...
        if (obj instanceof AbstractC11437h) {
            sb2.append(": \"");
            sb2.append(k0.a((AbstractC11437h) obj));
            sb2.append('\"');
            return;
        }
        if (obj instanceof AbstractC11452x) {
            sb2.append(" {");
            e((AbstractC11452x) obj, sb2, i10 + 2);
            sb2.append("\n");
            a(i10, sb2);
            sb2.append("}");
            return;
