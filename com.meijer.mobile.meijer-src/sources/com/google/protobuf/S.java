...
final class S {
    ...
    private static final char[] f91294a;
    ...
    static void d(StringBuilder sb2, int i10, String str, Object obj) throws SecurityException {
        ...
        if (obj instanceof AbstractC11646g) {
            sb2.append(": \"");
            sb2.append(k0.a((AbstractC11646g) obj));
            sb2.append('\"');
            return;
        }
        if (obj instanceof AbstractC11661w) {
            sb2.append(" {");
            e((AbstractC11661w) obj, sb2, i10 + 2);
            sb2.append("\n");
            a(i10, sb2);
            sb2.append("}");
            return;
