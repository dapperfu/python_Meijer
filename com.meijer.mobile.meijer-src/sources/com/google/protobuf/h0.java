...
final class h0 {
    ...
    private static final Class<?> f91370a = B();

    /* renamed from: b, reason: collision with root package name */
    private static final l0<?, ?> f91371b = C();

    /* renamed from: c, reason: collision with root package name */
    private static final l0<?, ?> f91372c = new n0();
    ...
    static <UT, UB> UB A(Object obj, int i10, List<Integer> list, C11663y.e eVar, UB ub2, l0<UT, UB> l0Var) {
        if (eVar == null) {
            return ub2;
        }
    ...
    public static void H(Class<?> cls) {
        Class<?> cls2;
        if (!AbstractC11661w.class.isAssignableFrom(cls) && (cls2 = f91370a) != null && !cls2.isAssignableFrom(cls)) {
    ...
    public static void N(int i10, List<AbstractC11646g> list, s0 s0Var) throws IOException {
        if (list == null || list.isEmpty()) {
            return;
        }
        s0Var.I(i10, list);
    ...
    static <UT, UB> UB z(Object obj, int i10, List<Integer> list, C11663y.d<?> dVar, UB ub2, l0<UT, UB> l0Var) {
        if (dVar == null) {
            return ub2;
        }
        if (!(list instanceof RandomAccess)) {
    ...
    static <T, FT extends C11657s.b<FT>> void E(AbstractC11654o<FT> abstractC11654o, T t10, T t11) {
        C11657s<T> c11657sC = abstractC11654o.c(t11);
        if (!c11657sC.n()) {
            abstractC11654o.d(t10).v(c11657sC);
        }
    }
    ...
    static int c(int i10, List<AbstractC11646g> list) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
    ...
    static int e(List<Integer> list) {
        ...
        if (list instanceof C11662x) {
            ...
            int iL = 0;
            while (i10 < size) {
                iL += CodedOutputStream.l(c11662x.getInt(i10));
                i10++;
            }
            return iL;
        }
    ...
    static int l(List<Integer> list) {
        ...
        if (list instanceof C11662x) {
            ...
            int iW = 0;
            while (i10 < size) {
                iW += CodedOutputStream.w(c11662x.getInt(i10));
                i10++;
            }
            return iW;
        }
    ...
    static int r(List<Integer> list) {
        ...
        if (list instanceof C11662x) {
            ...
            int iO = 0;
            while (i10 < size) {
                iO += CodedOutputStream.O(c11662x.getInt(i10));
                i10++;
            }
            return iO;
        }
    ...
    static int u(int i10, List<?> list) {
        ...
        if (list instanceof E) {
            ...
            while (i11 < size) {
                ...
                if (objC instanceof AbstractC11646g) {
                    iS2 = CodedOutputStream.h((AbstractC11646g) objC);
                } else {
        ...
        while (i11 < size) {
            ...
            if (obj instanceof AbstractC11646g) {
                iS = CodedOutputStream.h((AbstractC11646g) obj);
            } else {
    ...
    static int w(List<Integer> list) {
        ...
        if (list instanceof C11662x) {
            ...
            int iV = 0;
            while (i10 < size) {
                iV += CodedOutputStream.V(c11662x.getInt(i10));
                i10++;
            }
            return iV;
        }
