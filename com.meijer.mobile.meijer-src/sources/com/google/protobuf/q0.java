...
final class q0 {
    ...
    private static final b f91457a;
    ...
    private static class a {
        ...
        public static void j(byte b10, byte b11, byte b12, char[] cArr, int i10) throws InvalidProtocolBufferException {
            if (!m(b11) && ((b10 != -32 || b11 >= -96) && ((b10 != -19 || b11 < -96) && !m(b12)))) {
                cArr[i10] = (char) (((b10 & C14170dq.MULTIPLY) << 12) | (r(b11) << 6) | r(b12));
                return;
            }
            throw InvalidProtocolBufferException.d();
        }
    ...
    static final class e extends b {
        private static int g(byte[] bArr, long j10, int i10) {
            ...
            while (true) {
                int i13 = i11 + 8;
                if (i13 > i10 || (p0.A(bArr, p0.f91438h + j10) & (-9187201950435737472L)) != 0) {
                    break;
                }
                j10 += 8;
                i11 = i13;
        ...
        @Override // com.google.protobuf.q0.b
        String a(byte[] bArr, int i10, int i11) throws InvalidProtocolBufferException {
            Charset charset = C11663y.f91596b;
    ...
    static String e(byte[] bArr, int i10, int i11) throws InvalidProtocolBufferException {
        return f91457a.a(bArr, i10, i11);
    }

    static int f(CharSequence charSequence, byte[] bArr, int i10, int i11) {
        return f91457a.b(charSequence, bArr, i10, i11);
    }
    ...
    static boolean m(byte[] bArr) {
        return f91457a.c(bArr, 0, bArr.length);
    }

    static boolean n(byte[] bArr, int i10, int i11) {
        return f91457a.c(bArr, i10, i11);
    }
