...
class JsonElementTypeAdapter extends TypeAdapter<k> {
    ...
    static final JsonElementTypeAdapter f90366a = new JsonElementTypeAdapter();

    static /* synthetic */ class a {

        /* renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f90367a;
        ...
        static {
            ...
            try {
                f90367a[JsonToken.BEGIN_OBJECT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f90367a[JsonToken.STRING.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f90367a[JsonToken.NUMBER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f90367a[JsonToken.BOOLEAN.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f90367a[JsonToken.NULL.ordinal()] = 6;
    ...
    private k b(JsonReader jsonReader, JsonToken jsonToken) throws IOException {
        int i10 = a.f90367a[jsonToken.ordinal()];
        if (i10 == 3) {
