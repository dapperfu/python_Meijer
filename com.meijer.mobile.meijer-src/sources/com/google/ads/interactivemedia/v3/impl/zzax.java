...
public final class zzax extends ImageView implements View.OnClickListener {
    ...
    public static zzax zza(Context context, zzbi zzbiVar, com.google.ads.interactivemedia.v3.impl.data.zzbe zzbeVar, AbstractC5516j abstractC5516j, String str, List list, zzgi zzgiVar) {
        final zzax zzaxVar = new zzax(context, zzbiVar, zzbeVar, str, list, zzgiVar);
        zzaxVar.setOnClickListener(zzaxVar);
        abstractC5516j.c(new InterfaceC5511e() { // from class: com.google.ads.interactivemedia.v3.impl.zzaw
            @Override // Vd.InterfaceC5511e
            public final void onComplete(AbstractC5516j abstractC5516j2) {
                if (abstractC5516j2.r()) {
                    this.zza.setImageBitmap((Bitmap) abstractC5516j2.n());
                } else {
                    zzfk.zzb("Image companion error", abstractC5516j2.m());
                }
            }
        });
        return zzaxVar;
