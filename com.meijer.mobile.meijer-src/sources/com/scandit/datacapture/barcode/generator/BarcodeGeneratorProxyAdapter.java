...
public final class BarcodeGeneratorProxyAdapter implements BarcodeGeneratorProxy {
    ...
    private final NativeBarcodeGenerator f121983a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeDataCaptureComponent f121985c;
    ...
    public BarcodeGeneratorProxyAdapter(NativeBarcodeGenerator _NativeBarcodeGenerator, ProxyCache proxyCache) {
        ...
        this.f121983a = _NativeBarcodeGenerator;
        ...
        this.f121985c = nativeDataCaptureComponentAsDataCaptureComponent;
    }
    ...
    @Override // com.scandit.datacapture.barcode.generator.BarcodeGeneratorProxy
    public String getId() {
        String identifier = this.f121983a.getIdentifier();
