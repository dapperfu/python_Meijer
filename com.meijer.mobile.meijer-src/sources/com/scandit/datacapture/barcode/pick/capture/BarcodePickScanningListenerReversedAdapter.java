...
public final class BarcodePickScanningListenerReversedAdapter extends NativeBarcodePickScanningListener {
    ...
    private final BarcodePickScanningListener f124522a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final WeakReference f124524c;
    ...
    public void onObservationStarted(NativeBarcodePick mode) {
        ...
        if (((BarcodePickInternal) this.f124524c.get()) != null) {
            this.f124522a.onObservationStarted(BarcodeNativeTypeFactory.INSTANCE.convert(mode));
        }
    }
    ...
    public void onObservationStopped(NativeBarcodePick mode) {
        Intrinsics.j(mode, "mode");
        if (((BarcodePickInternal) this.f124524c.get()) != null) {
            this.f124522a.onObservationStopped(BarcodeNativeTypeFactory.INSTANCE.convert(mode));
        }
    }
    ...
    public void onScanningSessionCompleted(NativeBarcodePick mode, NativeBarcodePickScanningSession session) {
        ...
        BarcodePickInternal barcodePickInternal = (BarcodePickInternal) this.f124524c.get();
        if (barcodePickInternal != null) {
            this.f124522a.onScanningSessionCompleted(BarcodeNativeTypeFactory.INSTANCE.convert(mode), (BarcodePickScanningSession) this.proxyCache.getOrPut(Reflection.b(NativeBarcodePickScanningSession.class), null, session, new c(barcodePickInternal)));
        }
    }
    ...
    public void onScanningSessionUpdated(NativeBarcodePick mode, NativeBarcodePickScanningSession session) {
        ...
        BarcodePickInternal barcodePickInternal = (BarcodePickInternal) this.f124524c.get();
        if (barcodePickInternal != null) {
            this.f124522a.onScanningSessionUpdated(BarcodeNativeTypeFactory.INSTANCE.convert(mode), (BarcodePickScanningSession) this.proxyCache.getOrPut(Reflection.b(NativeBarcodePickScanningSession.class), null, session, new d(barcodePickInternal)));
        }
    }
    ...
    public BarcodePickScanningListenerReversedAdapter(BarcodePickScanningListener _BarcodePickScanningListener, BarcodePickInternal _BarcodePickInternal, ProxyCache proxyCache) {
        ...
        this.f124522a = _BarcodePickScanningListener;
        this.proxyCache = proxyCache;
        this.f124524c = new WeakReference(_BarcodePickInternal);
    }
}
