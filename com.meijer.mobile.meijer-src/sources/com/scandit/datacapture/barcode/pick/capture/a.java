...
public final class a implements BarcodePickStatusListenerInternal {
    ...
    public final WeakReference f124539a;

    public a(BarcodePick owner) {
        Intrinsics.j(owner, "owner");
        this.f124539a = new WeakReference(owner);
    }

    @Override // com.scandit.datacapture.barcode.internal.module.pick.capture.BarcodePickStatusListenerInternal
    public final void a() {
        CopyOnWriteArraySet copyOnWriteArraySet;
        BarcodePick barcodePick = (BarcodePick) this.f124539a.get();
        if (barcodePick == null || (copyOnWriteArraySet = barcodePick.f124512b) == null) {
            return;
        }
