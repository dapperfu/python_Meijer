...
public final class BarcodePickSessionProxyAdapter implements BarcodePickSessionProxy {
    ...
    private final NativeBarcodePickPublicSession f124532a;
    ...
    public Set<TrackedObject> getAddedObjects() {
        HashSet<NativeTrackedObject> addedObjects = this.f124532a.getAddedObjects();
    ...
    public Set<String> getTrackedItems() {
        HashSet<String> trackedItems = this.f124532a.getTrackedItems();
    ...
    public Set<TrackedObject> getTrackedObjects() {
        HashSet<NativeTrackedObject> trackedObjects = this.f124532a.getTrackedObjects();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
    ...
    public String toJson() {
        String json = this.f124532a.toJson();
        Intrinsics.g(json);
        return json;
    }
