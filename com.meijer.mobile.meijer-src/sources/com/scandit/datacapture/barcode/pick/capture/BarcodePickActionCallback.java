...
public final class BarcodePickActionCallback implements BarcodePickActionCallbackProxy {
    ...
    private final String f124514a;

    /* renamed from: b, reason: collision with root package name */
    private final /* synthetic */ BarcodePickActionCallbackProxyAdapter f124515b;
    ...
    public NativeBarcodePickActionCallback getF124516a() {
        return this.f124515b.getF124516a();
    }
    ...
    public BarcodePickActionCallback(NativeBarcodePickActionCallback impl, String itemData) {
        ...
        this.f124514a = itemData;
        this.f124515b = new BarcodePickActionCallbackProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    }

    public final void onFinish(boolean result) {
        getF124516a().onResponse(this.f124514a, result);
    }
}
