...
public final class BarcodePickAsyncMapperProductProvider implements BarcodePickProductProvider, BarcodePickAsyncMapperProductProviderProxy {
    ...
    private final /* synthetic */ BarcodePickAsyncMapperProductProviderProxyAdapter f124548a;

    /* JADX WARN: Multi-variable type inference failed */
    public BarcodePickAsyncMapperProductProvider(NativeAsyncMapperProductProvider impl) {
        Intrinsics.j(impl, "impl");
        this.f124548a = new BarcodePickAsyncMapperProductProviderProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    }
    ...
    public NativeAsyncMapperProductProvider getF124550a() {
        return this.f124548a.getF124550a();
    }
    ...
    public void _productIdentifierForItems(ArrayList<String> itemsData, BarcodePickProductProviderCallback callback) {
        ...
        this.f124548a._productIdentifierForItems(itemsData, callback);
    }
    ...
    public NativeProductProvider getF124552c() {
        return this.f124548a.getF124552c();
    }

    public final void updateProductList(Set<BarcodePickProduct> products) {
        Intrinsics.j(products, "products");
        NativeAsyncMapperProductProvider nativeAsyncMapperProductProvider_impl = getF124550a();
