...
public interface BarcodePickViewHighlightStyle {
    ...
    public static final class CustomView implements BarcodePickViewHighlightStyle, BarcodePickViewHighlightStyleCustomViewProxy {
        ...
        private final /* synthetic */ BarcodePickViewHighlightStyleCustomViewProxyAdapter f124620a;
        ...
        public CustomView(NativeBarcodePickViewHighlightStyleCustomView impl) {
            ...
            this.f124620a = new BarcodePickViewHighlightStyleCustomViewProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        }
        ...
        public void setMinimumHighlightHeight(int i10) {
            this.f124620a.setMinimumHighlightHeight(i10);
        }
        ...
        public void setMinimumHighlightWidth(int i10) {
            this.f124620a.setMinimumHighlightWidth(i10);
        }
        ...
        public final BarcodePickStatusIconSettings getStatusIconSettings() {
            NativeBarcodePickStatusIconSettings statusIconSettings = getF124630a().getStatusIconSettings();
        ...
        public final void setStatusIconSettings(BarcodePickStatusIconSettings value) {
            ...
            getF124630a().setStatusIconSettings(value.getF124596a());
        }
        ...
        public String toJson() {
            String json = getF124630a().toJson();
    ...
    public static final class DotWithIcons implements BarcodePickViewHighlightStyle, BarcodePickViewHighlightStyleDotWithIconsProxy {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final /* synthetic */ BarcodePickViewHighlightStyleDotWithIconsProxyAdapter f124623a;
        ...
        /* renamed from: _highlightStyleImpl */
        public NativeBarcodePickViewHighlightStyle getF124632c() {
            return this.f124623a.getF124640c();
        }
        ...
        public NativeBarcodePickViewHighlightStyleDotWithIcons getF124638a() {
            return this.f124623a.getF124638a();
        }
        ...
        public Brush getBrushForState(BarcodePickState state) {
            ...
            return this.f124623a.getBrushForState(state);
        }
        ...
        public Brush getSelectedBrushForState(BarcodePickState state) {
            Intrinsics.j(state, "state");
            return this.f124623a.getSelectedBrushForState(state);
        }
        ...
        public boolean getStyleResponseCacheEnabled() {
            return this.f124623a.getStyleResponseCacheEnabled();
        }
        ...
        public void setBrushForState(Brush brush, BarcodePickState state) {
            ...
            Intrinsics.j(state, "state");
            this.f124623a.setBrushForState(brush, state);
        }
        ...
        public void setSelectedBrushForState(Brush brush, BarcodePickState state) {
            Intrinsics.j(state, "state");
            this.f124623a.setSelectedBrushForState(brush, state);
        }
        ...
        public void setStyleResponseCacheEnabled(boolean z10) {
            this.f124623a.setStyleResponseCacheEnabled(z10);
        }
        ...
        public DotWithIcons(NativeBarcodePickViewHighlightStyleDotWithIcons impl, BarcodePickHighlightStyleIconsHolder iconsHolder) {
            ...
            this.f124623a = new BarcodePickViewHighlightStyleDotWithIconsProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        ...
        @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyle
        public String toJson() {
            return com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.b.a(this, getF124638a().toJson());
        }
    ...
    public static final class RectangularWithIcons implements BarcodePickViewHighlightStyle, BarcodePickViewHighlightStyleRectangularWithIconsProxy {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final /* synthetic */ BarcodePickViewHighlightStyleRectangularWithIconsProxyAdapter f124627a;
        ...
        /* renamed from: _highlightStyleImpl */
        public NativeBarcodePickViewHighlightStyle getF124632c() {
            return this.f124627a.getF124646c();
        }

        @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleRectangularWithIconsProxy
        @NativeImpl
        /* renamed from: _impl */
        public NativeBarcodePickViewHighlightStyleRectangularWithIcons getF124644a() {
            return this.f124627a.getF124644a();
        }
        ...
        public Brush getBrushForState(BarcodePickState state) {
            Intrinsics.j(state, "state");
            return this.f124627a.getBrushForState(state);
        }

        @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleRectangularWithIconsProxy
        @ProxyFunction(nativeName = "getMinimumHighlightHeight", property = "minimumHighlightHeight")
        public int getMinimumHighlightHeight() {
            return this.f124627a.getMinimumHighlightHeight();
        }

        @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleRectangularWithIconsProxy
        @ProxyFunction(nativeName = "getMinimumHighlightWidth", property = "minimumHighlightWidth")
        public int getMinimumHighlightWidth() {
            return this.f124627a.getMinimumHighlightWidth();
        }
        ...
        public Brush getSelectedBrushForState(BarcodePickState state) {
            Intrinsics.j(state, "state");
            return this.f124627a.getSelectedBrushForState(state);
        }

        @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleRectangularWithIconsProxy
        @ProxyFunction(nativeName = "getStyleResponseCacheEnabled", property = "styleResponseCacheEnabled")
        public boolean getStyleResponseCacheEnabled() {
            return this.f124627a.getStyleResponseCacheEnabled();
        }
        ...
        public void setBrushForState(Brush brush, BarcodePickState state) {
            Intrinsics.j(brush, "brush");
            Intrinsics.j(state, "state");
            this.f124627a.setBrushForState(brush, state);
        }
        ...
        @ProxyFunction(nativeName = "setMinimumHighlightHeight", property = "minimumHighlightHeight")
        public void setMinimumHighlightHeight(int i10) {
            this.f124627a.setMinimumHighlightHeight(i10);
        }

        @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleRectangularWithIconsProxy
        @ProxyFunction(nativeName = "setMinimumHighlightWidth", property = "minimumHighlightWidth")
        public void setMinimumHighlightWidth(int i10) {
            this.f124627a.setMinimumHighlightWidth(i10);
        }
        ...
        public void setSelectedBrushForState(Brush brush, BarcodePickState state) {
            Intrinsics.j(state, "state");
            this.f124627a.setSelectedBrushForState(brush, state);
        }
        ...
        @ProxyFunction(nativeName = "setStyleResponseCacheEnabled", property = "styleResponseCacheEnabled")
        public void setStyleResponseCacheEnabled(boolean z10) {
            this.f124627a.setStyleResponseCacheEnabled(z10);
        }
        ...
        public final BarcodePickStatusIconSettings getStatusIconSettings() {
            NativeBarcodePickStatusIconSettings statusIconSettings = getF124644a().getStatusIconSettings();
            Intrinsics.i(statusIconSettings, "getStatusIconSettings(...)");
            return new BarcodePickStatusIconSettings(statusIconSettings);
        }
        ...
        public final void setStatusIconSettings(BarcodePickStatusIconSettings value) {
            Intrinsics.j(value, "value");
            getF124644a().setStatusIconSettings(value.getF124596a());
        }
        ...
        public RectangularWithIcons(NativeBarcodePickViewHighlightStyleRectangularWithIcons impl, BarcodePickHighlightStyleIconsHolder iconsHolder) {
            Intrinsics.j(impl, "impl");
            Intrinsics.j(iconsHolder, "iconsHolder");
            this.f124627a = new BarcodePickViewHighlightStyleRectangularWithIconsProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
            this._iconsHolder = iconsHolder;
        }
        ...
        @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyle
        public String toJson() {
            return com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.b.a(this, getF124644a().toJson());
        }
    ...
    @NativeImpl
    /* renamed from: _highlightStyleImpl */
    NativeBarcodePickViewHighlightStyle getF124632c();
    ...
    public static final class Dot implements BarcodePickViewHighlightStyle, BarcodePickViewHighlightStyleDotProxy {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final /* synthetic */ BarcodePickViewHighlightStyleDotProxyAdapter f124622a;

        /* JADX WARN: Multi-variable type inference failed */
        public Dot(NativeBarcodePickViewHighlightStyleDot impl) {
            Intrinsics.j(impl, "impl");
            this.f124622a = new BarcodePickViewHighlightStyleDotProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        }
        ...
        /* renamed from: _highlightStyleImpl */
        public NativeBarcodePickViewHighlightStyle getF124632c() {
            return this.f124622a.getF124637c();
        }

        @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleDotProxy
        @NativeImpl
        /* renamed from: _impl */
        public NativeBarcodePickViewHighlightStyleDot getF124635a() {
            return this.f124622a.getF124635a();
        }
        ...
        public Brush getBrushForState(BarcodePickState state) {
            Intrinsics.j(state, "state");
            return this.f124622a.getBrushForState(state);
        }
        ...
        public Brush getSelectedBrushForState(BarcodePickState state) {
            Intrinsics.j(state, "state");
            return this.f124622a.getSelectedBrushForState(state);
        }
        ...
        public void setBrushForState(Brush brush, BarcodePickState state) {
            Intrinsics.j(brush, "brush");
            Intrinsics.j(state, "state");
            this.f124622a.setBrushForState(brush, state);
        }
        ...
        public void setSelectedBrushForState(Brush brush, BarcodePickState state) {
            Intrinsics.j(state, "state");
            this.f124622a.setSelectedBrushForState(brush, state);
        }
        ...
        @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyle
        public String toJson() {
            String json = getF124635a().toJson();
            Intrinsics.i(json, "toJson(...)");
            return json;
        }
    }
    ...
    public static final class Rectangular implements BarcodePickViewHighlightStyle, BarcodePickViewHighlightStyleRectangularProxy {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final /* synthetic */ BarcodePickViewHighlightStyleRectangularProxyAdapter f124626a;

        /* JADX WARN: Multi-variable type inference failed */
        public Rectangular(NativeBarcodePickViewHighlightStyleRectangular impl) {
            Intrinsics.j(impl, "impl");
            this.f124626a = new BarcodePickViewHighlightStyleRectangularProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        }
        ...
        /* renamed from: _highlightStyleImpl */
        public NativeBarcodePickViewHighlightStyle getF124632c() {
            return this.f124626a.getF124643c();
        }
        ...
        public NativeBarcodePickViewHighlightStyleRectangular getF124641a() {
            return this.f124626a.getF124641a();
        }
        ...
        public Brush getBrushForState(BarcodePickState state) {
            Intrinsics.j(state, "state");
            return this.f124626a.getBrushForState(state);
        }

        @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleRectangularProxy
        @ProxyFunction(nativeName = "getMinimumHighlightHeight", property = "minimumHighlightHeight")
        public int getMinimumHighlightHeight() {
            return this.f124626a.getMinimumHighlightHeight();
        }

        @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleRectangularProxy
        @ProxyFunction(nativeName = "getMinimumHighlightWidth", property = "minimumHighlightWidth")
        public int getMinimumHighlightWidth() {
            return this.f124626a.getMinimumHighlightWidth();
        }
        ...
        public Brush getSelectedBrushForState(BarcodePickState state) {
            Intrinsics.j(state, "state");
            return this.f124626a.getSelectedBrushForState(state);
        }
        ...
        public void setBrushForState(Brush brush, BarcodePickState state) {
            Intrinsics.j(brush, "brush");
            Intrinsics.j(state, "state");
            this.f124626a.setBrushForState(brush, state);
        }

        @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleRectangularProxy
        @ProxyFunction(nativeName = "setMinimumHighlightHeight", property = "minimumHighlightHeight")
        public void setMinimumHighlightHeight(int i10) {
            this.f124626a.setMinimumHighlightHeight(i10);
        }

        @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleRectangularProxy
        @ProxyFunction(nativeName = "setMinimumHighlightWidth", property = "minimumHighlightWidth")
        public void setMinimumHighlightWidth(int i10) {
            this.f124626a.setMinimumHighlightWidth(i10);
        }
        ...
        public void setSelectedBrushForState(Brush brush, BarcodePickState state) {
            Intrinsics.j(state, "state");
            this.f124626a.setSelectedBrushForState(brush, state);
        }
        ...
        @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyle
        public String toJson() {
            String json = getF124641a().toJson();
            Intrinsics.i(json, "toJson(...)");
            return json;
        }
    }
