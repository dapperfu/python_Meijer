...
public final class BarcodePickViewHighlightStyleDotProxyAdapter implements BarcodePickViewHighlightStyleDotProxy {
    ...
    private final NativeBarcodePickViewHighlightStyleDot f124635a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeBarcodePickViewHighlightStyle f124637c;
    ...
    public BarcodePickViewHighlightStyleDotProxyAdapter(NativeBarcodePickViewHighlightStyleDot _NativeBarcodePickViewHighlightStyleDot, ProxyCache proxyCache) {
        ...
        this.f124635a = _NativeBarcodePickViewHighlightStyleDot;
        ...
        this.f124637c = nativeBarcodePickViewHighlightStyleAsHighlightStyle;
    }
    ...
    public NativeBarcodePickViewHighlightStyle getF124637c() {
    ...
    public Brush getBrushForState(BarcodePickState state) {
        ...
        NativeBrush nativeBrushBrushForState = this.f124635a.brushForState(BarcodeNativeTypeFactory.INSTANCE.convert(state));
    ...
    public Brush getSelectedBrushForState(BarcodePickState state) {
        Intrinsics.j(state, "state");
        NativeBrush nativeBrushSelectedBrushForState = this.f124635a.selectedBrushForState(BarcodeNativeTypeFactory.INSTANCE.convert(state));
    ...
    public void setBrushForState(Brush brush, BarcodePickState state) {
        ...
        Intrinsics.j(state, "state");
        this.f124635a.setBrushForState(CoreNativeTypeFactory.INSTANCE.convert(brush), BarcodeNativeTypeFactory.INSTANCE.convert(state));
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleDotProxy
    public void setSelectedBrushForState(Brush brush, BarcodePickState state) {
        Intrinsics.j(state, "state");
        this.f124635a.setSelectedBrushForState(brush != null ? CoreNativeTypeFactory.INSTANCE.convert(brush) : null, BarcodeNativeTypeFactory.INSTANCE.convert(state));
    }
