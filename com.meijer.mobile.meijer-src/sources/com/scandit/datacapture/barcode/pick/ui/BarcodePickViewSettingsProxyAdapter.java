...
public final class BarcodePickViewSettingsProxyAdapter implements BarcodePickViewSettingsProxy {
    ...
    private final NativeBarcodePickViewSettings f124673a;
    ...
    public BarcodePickViewSettingsProxyAdapter(NativeBarcodePickViewSettings _NativeBarcodePickViewSettings, ProxyCache proxyCache) {
        ...
        this.f124673a = _NativeBarcodePickViewSettings;
        this.proxyCache = proxyCache;
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewSettingsProxy
    /* renamed from: _impl, reason: from getter */
    public NativeBarcodePickViewSettings getF124673a() {
        return this.f124673a;
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewSettingsProxy
    public boolean getHardwareTriggerEnabled() {
        return this.f124673a.getHardwareTriggerEnabled();
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewSettingsProxy
    public Integer getHardwareTriggerKeyCode() {
        return this.f124673a.getHardwareTriggerKeyCode();
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewSettingsProxy
    public String getInitialGuidelineText() {
        String initialGuidelineText = this.f124673a.getInitialGuidelineText();
    ...
    public String getLoadingDialogTextForPicking() {
        String loadingDialogTextForPicking = this.f124673a.getLoadingDialogTextForPicking();
    ...
    public String getLoadingDialogTextForUnpicking() {
        String loadingDialogTextForUnpicking = this.f124673a.getLoadingDialogTextForUnpicking();
    ...
    public String getMoveCloserGuidelineText() {
        String moveCloserGuidelineText = this.f124673a.getMoveCloserGuidelineText();
    ...
    public String getOnFirstItemPickCompletedHintText() {
        String onFirstItemPickCompletedHintText = this.f124673a.getOnFirstItemPickCompletedHintText();
    ...
    public String getOnFirstItemToPickFoundHintText() {
        String onFirstItemToPickFoundHintText = this.f124673a.getOnFirstItemToPickFoundHintText();
    ...
    public String getOnFirstItemUnpickCompletedHintText() {
        String onFirstItemUnpickCompletedHintText = this.f124673a.getOnFirstItemUnpickCompletedHintText();
    ...
    public String getOnFirstUnmarkedItemPickCompletedHintText() {
        String onFirstUnmarkedItemPickCompletedHintText = this.f124673a.getOnFirstUnmarkedItemPickCompletedHintText();
    ...
    public boolean getShowFinishButton() {
        return this.f124673a.getShowFinishButton();
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewSettingsProxy
    public boolean getShowGuidelines() {
        return this.f124673a.getShowGuidelines();
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewSettingsProxy
    public boolean getShowHints() {
        return this.f124673a.getShowHints();
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewSettingsProxy
    public boolean getShowLoadingDialog() {
        return this.f124673a.getShowLoadingDialog();
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewSettingsProxy
    public boolean getShowPauseButton() {
        return this.f124673a.getShowPauseButton();
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewSettingsProxy
    public boolean getShowTorchButton() {
        return this.f124673a.getShowTorchButton();
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewSettingsProxy
    public boolean getShowZoomButton() {
        return this.f124673a.getShowZoomButton();
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewSettingsProxy
    public String getTapShutterToPauseGuidelineText() {
        String tapShutterToPauseGuidelineText = this.f124673a.getTapShutterToPauseGuidelineText();
    ...
    public Anchor getTorchButtonPosition() {
        Anchor torchButtonPosition = this.f124673a.getTorchButtonPosition();
    ...
    public Anchor getZoomButtonPosition() {
        Anchor zoomButtonPosition = this.f124673a.getZoomButtonPosition();
