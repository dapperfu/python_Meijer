...
public final class BarcodePickViewHighlightStyleRectangularWithIconsProxyAdapter implements BarcodePickViewHighlightStyleRectangularWithIconsProxy {
    ...
    private final NativeBarcodePickViewHighlightStyleRectangularWithIcons f124644a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeBarcodePickViewHighlightStyle f124646c;
    ...
    public BarcodePickViewHighlightStyleRectangularWithIconsProxyAdapter(NativeBarcodePickViewHighlightStyleRectangularWithIcons _NativeBarcodePickViewHighlightStyleRectangularWithIcons, ProxyCache proxyCache) {
        ...
        this.f124644a = _NativeBarcodePickViewHighlightStyleRectangularWithIcons;
        ...
        this.f124646c = nativeBarcodePickViewHighlightStyleAsHighlightStyle;
    }
    ...
    public NativeBarcodePickViewHighlightStyle getF124646c() {
    ...
    public NativeBarcodePickViewHighlightStyleRectangularWithIcons getF124644a() {
        return this.f124644a;
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleRectangularWithIconsProxy
    public Brush getBrushForState(BarcodePickState state) {
        Intrinsics.j(state, "state");
        NativeBrush nativeBrushBrushForState = this.f124644a.brushForState(BarcodeNativeTypeFactory.INSTANCE.convert(state));
    ...
    public int getMinimumHighlightHeight() {
        return this.f124644a.getMinimumHighlightHeight();
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleRectangularWithIconsProxy
    public int getMinimumHighlightWidth() {
        return this.f124644a.getMinimumHighlightWidth();
    }
    ...
    public Brush getSelectedBrushForState(BarcodePickState state) {
        Intrinsics.j(state, "state");
        NativeBrush nativeBrushSelectedBrushForState = this.f124644a.selectedBrushForState(BarcodeNativeTypeFactory.INSTANCE.convert(state));
    ...
    public boolean getStyleResponseCacheEnabled() {
        return this.f124644a.getStyleResponseCacheEnabled();
    }
    ...
    public void setBrushForState(Brush brush, BarcodePickState state) {
        ...
        Intrinsics.j(state, "state");
        this.f124644a.setBrushForState(CoreNativeTypeFactory.INSTANCE.convert(brush), BarcodeNativeTypeFactory.INSTANCE.convert(state));
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleRectangularWithIconsProxy
    public void setMinimumHighlightHeight(int i10) {
        this.f124644a.setMinimumHighlightHeight(i10);
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleRectangularWithIconsProxy
    public void setMinimumHighlightWidth(int i10) {
        this.f124644a.setMinimumHighlightWidth(i10);
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleRectangularWithIconsProxy
    public void setSelectedBrushForState(Brush brush, BarcodePickState state) {
        Intrinsics.j(state, "state");
        this.f124644a.setSelectedBrushForState(brush != null ? CoreNativeTypeFactory.INSTANCE.convert(brush) : null, BarcodeNativeTypeFactory.INSTANCE.convert(state));
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleRectangularWithIconsProxy
    public void setStyleResponseCacheEnabled(boolean z10) {
        this.f124644a.setStyleResponseCacheEnabled(z10);
    }
