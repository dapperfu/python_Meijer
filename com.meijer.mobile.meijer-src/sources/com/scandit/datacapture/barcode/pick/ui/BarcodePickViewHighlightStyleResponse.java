...
public final class BarcodePickViewHighlightStyleResponse {
    ...
    public static final class Builder {
        ...
        private Brush f124655a;

        /* renamed from: b, reason: collision with root package name */
        private Brush f124656b;

        /* renamed from: c, reason: collision with root package name */
        private Bitmap f124657c;

        /* renamed from: d, reason: collision with root package name */
        private Bitmap f124658d;

        /* renamed from: e, reason: collision with root package name */
        private int f124659e;

        /* renamed from: f, reason: collision with root package name */
        private int f124660f;

        /* renamed from: g, reason: collision with root package name */
        private ScanditIcon f124661g;

        /* renamed from: h, reason: collision with root package name */
        private ScanditIcon f124662h;

        /* renamed from: i, reason: collision with root package name */
        private BarcodePickStatusIconStyle f124663i;
        ...
        public final Builder setIcon(Bitmap icon) {
            this.f124657c = icon;
            this.f124664j = A.f124590b;
            return this;
        }

        public final Builder setSelectedIcon(Bitmap selectedIcon) {
            this.f124658d = selectedIcon;
            this.f124665k = A.f124590b;
            return this;
        }
        ...
        public final BarcodePickViewHighlightStyleResponse build() {
            ...
            int iOrdinal = this.f124664j.ordinal();
            if (iOrdinal == 0) {
                barcodePickIconA = com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.l.f123732a;
            } else if (iOrdinal == 1) {
                barcodePickIconA = com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.i.a(this.f124657c, com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.l.f123732a);
            } else if (iOrdinal == 2) {
                barcodePickIconA = com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.i.a(this.f124659e, com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.l.f123732a);
            } else {
                if (iOrdinal != 3) {
                    throw new NoWhenBranchMatchedException();
                }
                barcodePickIconA = com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.i.a(this.f124661g, com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.l.f123732a);
            }
            BarcodePickIcon barcodePickIcon = barcodePickIconA;
            int iOrdinal2 = this.f124665k.ordinal();
            if (iOrdinal2 == 0) {
                barcodePickIconA2 = com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.m.f123733a;
            } else if (iOrdinal2 == 1) {
                barcodePickIconA2 = com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.i.a(this.f124658d, com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.m.f123733a);
            } else if (iOrdinal2 == 2) {
                barcodePickIconA2 = com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.i.a(this.f124660f, com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.m.f123733a);
            } else {
                if (iOrdinal2 != 3) {
                    throw new NoWhenBranchMatchedException();
                }
                barcodePickIconA2 = com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.i.a(this.f124662h, com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.m.f123733a);
            }
            BarcodePickIcon barcodePickIcon2 = barcodePickIconA2;
            Brush brush = this.f124655a;
            if (brush == null) {
                pVar = com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.k.f123731b;
            } else {
                Intrinsics.j(brush, "brush");
                pVar = new com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.p(brush);
            }
            Brush brush2 = this.f124656b;
            if (brush2 == null) {
                pVar2 = com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.k.f123731b;
            } else {
                Intrinsics.j(brush2, "brush");
                pVar2 = new com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.p(brush2);
            }
            return new BarcodePickViewHighlightStyleResponse(pVar, pVar2, barcodePickIcon, barcodePickIcon2, this.f124663i);
        }
        ...
        public final Builder setIcon(int iconResource) {
            this.f124659e = iconResource;
            this.f124664j = A.f124591c;
            return this;
        }

        public final Builder setSelectedIcon(int selectedIconResource) {
            this.f124660f = selectedIconResource;
            this.f124665k = A.f124591c;
            return this;
        }
        ...
        public final Builder setIcon(ScanditIcon icon) {
            ...
            this.f124661g = icon;
            this.f124664j = A.f124592d;
            return this;
        }

        public final Builder setSelectedIcon(ScanditIcon selectedIcon) {
            this.f124662h = selectedIcon;
            this.f124665k = A.f124592d;
            return this;
        }
    }
