...
public final class BarcodePickView extends RelativeLayout {
    ...
    private final BarcodePick f124605a;

    /* renamed from: b, reason: collision with root package name */
    private final CameraManager f124606b;

    /* renamed from: c, reason: collision with root package name */
    private final BarcodePickDrawer f124607c;

    /* renamed from: d, reason: collision with root package name */
    private final BarcodePickDataCaptureViewWrapper f124608d;

    /* renamed from: e, reason: collision with root package name */
    private final ShutterButtonWrapper f124609e;

    /* renamed from: f, reason: collision with root package name */
    private final ExitButtonWrapper f124610f;

    /* renamed from: g, reason: collision with root package name */
    private final BarcodePickGuidanceHandler f124611g;

    /* renamed from: h, reason: collision with root package name */
    private final BarcodePickBasicOverlay f124612h;
    ...
    private final BarcodePickView$_internalPropertyManager$1 f124615k;

    /* renamed from: l, reason: collision with root package name */
    private final MainThreadHelper f124616l;

    /* renamed from: m, reason: collision with root package name */
    private final com.scandit.datacapture.barcode.internal.module.shared.c f124617m;

    /* renamed from: n, reason: collision with root package name */
    private final com.scandit.datacapture.barcode.internal.module.pick.ui.highlightdrawer.f f124618n;
    ...
    public static final class Companion {
        ...
        public final BarcodePickView newInstance(ViewGroup parentView, DataCaptureContext dataCaptureContext, BarcodePick mode, BarcodePickViewSettings settings, CameraSettings cameraSettings) {
            ...
            if (highlightStyle instanceof BarcodePickViewHighlightStyle.DotWithIcons) {
                ...
                com.scandit.datacapture.barcode.internal.module.pick.ui.highlightdrawer.combined.a aVar2 = new com.scandit.datacapture.barcode.internal.module.pick.ui.highlightdrawer.combined.a(ArraysKt.h1(drawers));
                ...
                com.scandit.datacapture.barcode.internal.module.ui.viewpositioner.c cVar2 = com.scandit.datacapture.barcode.internal.module.ui.viewpositioner.c.f124379a;
            ...
            if (highlightStyle instanceof BarcodePickViewHighlightStyle.RectangularWithIcons) {
                ...
                com.scandit.datacapture.barcode.internal.module.pick.ui.highlightdrawer.a aVar3 = com.scandit.datacapture.barcode.internal.module.pick.ui.highlightdrawer.a.f123498a;
                ...
                com.scandit.datacapture.barcode.internal.module.pick.ui.highlightdrawer.combined.a aVar4 = new com.scandit.datacapture.barcode.internal.module.pick.ui.highlightdrawer.combined.a(ArraysKt.h1(drawers2));
                ...
                com.scandit.datacapture.barcode.internal.module.ui.viewpositioner.c cVar4 = com.scandit.datacapture.barcode.internal.module.ui.viewpositioner.c.f124379a;
            ...
            com.scandit.datacapture.barcode.internal.module.pick.ui.highlightdrawer.a aVar5 = com.scandit.datacapture.barcode.internal.module.pick.ui.highlightdrawer.a.f123498a;
            ...
            com.scandit.datacapture.barcode.internal.module.pick.ui.highlightdrawer.combined.a aVar6 = new com.scandit.datacapture.barcode.internal.module.pick.ui.highlightdrawer.combined.a(ArraysKt.h1(drawers3));
            ...
            com.scandit.datacapture.barcode.internal.module.ui.viewpositioner.c cVar5 = com.scandit.datacapture.barcode.internal.module.ui.viewpositioner.c.f124379a;
    ...
    public static final void a(BarcodePickView this$0) {
        ...
        this$0.f124606b.a(new l(this$0));
        this$0.f124609e.a();
        this$0.f124610f.a();
        com.scandit.datacapture.barcode.internal.module.shared.c cVar = this$0.f124617m;
        synchronized (cVar) {
            bVar = cVar.f123782g;
        }
        if (bVar == com.scandit.datacapture.barcode.internal.module.shared.b.f123774d) {
            com.scandit.datacapture.barcode.internal.module.pick.ui.highlightdrawer.f fVar = this$0.f124618n;
            NativeBarcodePickSession session = fVar.f123588a._impl$scandit_barcode_capture().getSession();
            if (session == null) {
                return;
            }
    ...
    public BarcodePickView(Context context, ViewGroup parentView, DataCaptureContext dataCaptureContext, BarcodePick mode, BarcodePickViewSettings viewSettings, CameraManager cameraManager, BarcodePickElementsCache elementsRequestor, BarcodePickDrawer highlightDrawer, BarcodePickDataCaptureViewWrapper captureViewWrapper, ShutterButtonWrapper shutterButtonWrapper, ExitButtonWrapper exitButtonWrapper, BarcodePickGuidanceHandler guidanceHandler, BarcodePickBasicOverlay barcodePickBasicOverlay) {
        ...
        this.f124605a = mode;
        this.f124606b = cameraManager;
        this.f124607c = highlightDrawer;
        this.f124608d = captureViewWrapper;
        this.f124609e = shutterButtonWrapper;
        this.f124610f = exitButtonWrapper;
        this.f124611g = guidanceHandler;
        this.f124612h = barcodePickBasicOverlay;
        this.f124615k = new InternalPropertyManager() { // from class: com.scandit.datacapture.barcode.pick.ui.BarcodePickView$_internalPropertyManager$1
            ...
            public void _setProperty(String key, Object value) {
                ...
                if (Intrinsics.e(key, "add_overlay") && (value instanceof DataCaptureOverlay)) {
                    this.f124619a.f124608d.b((DataCaptureOverlay) value);
                } else if (Intrinsics.e(key, "remove_overlay") && (value instanceof DataCaptureOverlay)) {
                    this.f124619a.f124608d.a((DataCaptureOverlay) value);
                }
            }
        };
        this.f124616l = new MainThreadHelper();
        ...
        com.scandit.datacapture.barcode.internal.module.shared.b initialScanState = com.scandit.datacapture.barcode.internal.module.shared.b.f123771a;
        ...
        this.f124617m = new com.scandit.datacapture.barcode.internal.module.shared.c(onStartScanning, onStopScanning, onFreezeScanning, onReleaseScanning, onResetScanning, initialScanState);
        ...
        this.f124618n = fVar;
        mode._addStatusListener$scandit_barcode_capture(new C13398a(this));
        ...
        shutterButtonWrapper.a(new C13399b(this));
    ...
    public static final void access$_freezeScanning(BarcodePickView barcodePickView) {
        barcodePickView.f124605a._freeze$scandit_barcode_capture();
    ...
    public static final void access$_releaseScanning(BarcodePickView barcodePickView) {
        barcodePickView.f124605a._stop$scandit_barcode_capture();
    ...
    public static final void access$_resetScanning(BarcodePickView barcodePickView) {
        barcodePickView.f124605a._reset$scandit_barcode_capture();
    ...
    public static final void access$_startScanning(BarcodePickView barcodePickView) {
        barcodePickView.f124605a._start$scandit_barcode_capture();
    ...
    public static final void access$_stopScanning(BarcodePickView barcodePickView) {
        barcodePickView.f124605a._pause$scandit_barcode_capture();
    ...
    public static final void access$freezeInternal(BarcodePickView barcodePickView) {
        barcodePickView.f124605a._notifyStatusShownWhilePausedUpdated$scandit_barcode_capture(barcodePickView.f124607c.a());
        barcodePickView.f124608d.a();
        barcodePickView.f124607c.b();
    }

    public static final void access$onDrawerDataUpdated(BarcodePickView barcodePickView, boolean z10) {
        com.scandit.datacapture.barcode.internal.module.shared.b bVar;
        com.scandit.datacapture.barcode.internal.module.shared.c cVar = barcodePickView.f124617m;
        synchronized (cVar) {
            bVar = cVar.f123782g;
        }
        bVar.getClass();
        if (bVar == com.scandit.datacapture.barcode.internal.module.shared.b.f123772b) {
            return;
        }
        barcodePickView.f124605a._notifyStatusShownWhilePausedUpdated$scandit_barcode_capture(z10);
    }
    ...
    public static final void access$releaseInternal(BarcodePickView barcodePickView) {
        barcodePickView.f124607c.stop();
        barcodePickView.removeView(barcodePickView.f124611g.getView());
        barcodePickView.f124608d.a(barcodePickView.f124612h);
        barcodePickView.f124605a._removeListener$scandit_barcode_capture(barcodePickView.f124618n);
        barcodePickView.f124606b.a(com.scandit.datacapture.barcode.internal.module.pick.capture.y.f123410a);
    }

    public static final void access$resetStateInternal(BarcodePickView barcodePickView) {
        com.scandit.datacapture.barcode.internal.module.pick.ui.highlightdrawer.f fVar = barcodePickView.f124618n;
        NativeBarcodePickSession session = fVar.f123588a._impl$scandit_barcode_capture().getSession();
        if (session == null) {
            return;
        }
    ...
    public static final void access$startInternal(BarcodePickView barcodePickView) {
        barcodePickView.f124608d.b();
        if (barcodePickView.f124611g.getView().getParent() == null) {
            barcodePickView.addView(barcodePickView.f124611g.getView(), new ViewGroup.LayoutParams(-1, -1));
        }
        barcodePickView.f124607c.start();
        barcodePickView.f124605a._notifyStatusShownWhilePausedUpdated$scandit_barcode_capture(false);
        barcodePickView.f124608d.b(barcodePickView.f124612h);
        barcodePickView.f124605a._addListener$scandit_barcode_capture(barcodePickView.f124618n);
    }
    ...
    public final void addActionListener(BarcodePickActionListener listener) {
        ...
        this.f124605a._addActionListener$scandit_barcode_capture(listener);
    }
    ...
    public final void onDestroy() {
        com.scandit.datacapture.barcode.internal.module.shared.c cVar = this.f124617m;
        synchronized (cVar) {
            try {
    ...
    protected void onSizeChanged(int w10, int h10, int oldw, int oldh) {
        ...
        post(new Runnable() { // from class: com.scandit.datacapture.barcode.pick.ui.B
            ...
            public final void run() {
                BarcodePickView.a(this.f124594a);
            }
        });
    }
