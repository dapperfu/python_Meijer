...
public final class TrackedBarcode implements TrackedBarcodeProxy {
    ...
    private final /* synthetic */ TrackedBarcodeProxyAdapter f121420a;
    ...
    public NativeTrackedBarcode getF121422a() {
        return this.f121420a.getF121422a();
    }
    ...
    public Point getAnchorPosition(Anchor anchor) {
        ...
        return this.f121420a.getAnchorPosition(anchor);
    }

    @Override // com.scandit.datacapture.barcode.batch.data.TrackedBarcodeProxy
    @ProxyFunction(property = "identifier")
    public int getIdentifier() {
        return this.f121420a.getIdentifier();
    }

    @Override // com.scandit.datacapture.barcode.batch.data.TrackedBarcodeProxy
    @ProxyFunction(property = "location")
    public Quadrilateral getLocation() {
        return this.f121420a.getLocation();
    }

    @Override // com.scandit.datacapture.barcode.batch.data.TrackedBarcodeProxy
    @ProxyFunction
    public String toJson() {
        return this.f121420a.toJson();
    }

    /* JADX WARN: Multi-variable type inference failed */
    public TrackedBarcode(NativeTrackedBarcode impl) {
        Intrinsics.j(impl, "impl");
        this.f121420a = new TrackedBarcodeProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    ...
    public final Quadrilateral getLocationIgnoringLicense$scandit_barcode_capture() {
        Quadrilateral locationIgnoringLicense = getF121422a().getLocationIgnoringLicense();
    ...
    public final float get_pixelsPerElement() {
        return getF121422a().getPixelsPerElement();
    }
}
