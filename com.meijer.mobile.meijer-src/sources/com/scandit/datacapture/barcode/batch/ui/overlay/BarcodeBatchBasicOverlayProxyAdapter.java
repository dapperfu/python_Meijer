...
public final class BarcodeBatchBasicOverlayProxyAdapter implements BarcodeBatchBasicOverlayProxy {
    ...
    private final NativeBarcodeTrackingBasicOverlay f121450a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeDataCaptureOverlay f121452c;
    ...
    public BarcodeBatchBasicOverlayProxyAdapter(NativeBarcodeTrackingBasicOverlay _NativeBarcodeTrackingBasicOverlay, ProxyCache proxyCache) {
        ...
        this.f121450a = _NativeBarcodeTrackingBasicOverlay;
        ...
        this.f121452c = nativeDataCaptureOverlayAsDataCaptureOverlay;
    }
    ...
    public void _setProfilingOverlay(ProfilingOverlay overlay) {
        ...
        NativeProfilingOverlay nativeProfilingOverlay_impl = overlay.getF126722a();
        this.proxyCache.put(Reflection.b(NativeProfilingOverlay.class), null, nativeProfilingOverlay_impl, overlay);
        this.f121450a.setProfilingOverlay(nativeProfilingOverlay_impl);
    }

    @Override // com.scandit.datacapture.barcode.batch.ui.overlay.BarcodeBatchBasicOverlayProxy
    public void clearTrackedBarcodeBrushes() {
        this.f121450a.clearTrackedBarcodeBrushes();
    }

    @Override // com.scandit.datacapture.barcode.batch.ui.overlay.BarcodeBatchBasicOverlayProxy
    public Brush getBrush() {
        NativeBrush defaultBrush = this.f121450a.getDefaultBrush();
    ...
    public boolean getShouldShowScanAreaGuides() {
        return this.f121450a.getShouldShowScanAreaGuides();
    }

    @Override // com.scandit.datacapture.barcode.batch.ui.overlay.BarcodeBatchBasicOverlayProxy
    public BarcodeBatchBasicOverlayStyle getStyle() {
        NativeBarcodeTrackingBasicOverlayStyle style = this.f121450a.getStyle();
    ...
    public void setBrush(Brush brush) {
        this.f121450a.setDefaultBrush(brush != null ? CoreNativeTypeFactory.INSTANCE.convert(brush) : null);
    }
    ...
    public void setBrushForTrackedBarcode(TrackedBarcode trackedBarcode, Brush brush) {
        ...
        NativeTrackedBarcode f121422a = trackedBarcode.getF121422a();
        this.proxyCache.put(Reflection.b(NativeTrackedBarcode.class), null, f121422a, trackedBarcode);
        this.f121450a.setTrackedBarcodeBrush(f121422a, brush != null ? CoreNativeTypeFactory.INSTANCE.convert(brush) : null);
    }

    @Override // com.scandit.datacapture.barcode.batch.ui.overlay.BarcodeBatchBasicOverlayProxy
    public void setShouldShowScanAreaGuides(boolean z10) {
        this.f121450a.setShouldShowScanAreaGuides(z10);
    }
