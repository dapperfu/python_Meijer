...
public final class BarcodeBatchDeserializerProxyAdapter implements BarcodeBatchDeserializerProxy {
    ...
    private final NativeBarcodeTrackingDeserializer f121370a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeDataCaptureModeDeserializer f121372c;

    /* renamed from: d, reason: collision with root package name */
    private BarcodeBatchDeserializer f121373d;
    ...
    public BarcodeBatchDeserializerProxyAdapter(NativeBarcodeTrackingDeserializer _NativeBarcodeTrackingDeserializer, ProxyCache proxyCache) {
        ...
        this.f121370a = _NativeBarcodeTrackingDeserializer;
        ...
        this.f121372c = nativeDataCaptureModeDeserializerAsDataCaptureModeDeserializer;
    }
    ...
    public BarcodeBatchAdvancedOverlay _advancedOverlayFromJson(BarcodeBatch mode, String jsonData) {
        ...
        NativeBarcodeTracking nativeBarcodeTracking_impl = mode.getF121378a();
        this.proxyCache.put(Reflection.b(NativeBarcodeTracking.class), null, nativeBarcodeTracking_impl, mode);
        NativeBarcodeTrackingAdvancedOverlay nativeBarcodeTrackingAdvancedOverlayBarcodeTrackingAdvancedOverlayFromJson = this.f121370a.barcodeTrackingAdvancedOverlayFromJson(nativeBarcodeTracking_impl, CoreNativeTypeFactory.INSTANCE.convert(jsonData));
    ...
    public BarcodeBatchBasicOverlay _basicOverlayFromJson(BarcodeBatch mode, String jsonData) {
        ...
        NativeBarcodeTracking nativeBarcodeTracking_impl = mode.getF121378a();
        this.proxyCache.put(Reflection.b(NativeBarcodeTracking.class), null, nativeBarcodeTracking_impl, mode);
        NativeBarcodeTrackingBasicOverlay nativeBarcodeTrackingBasicOverlayBarcodeTrackingBasicOverlayFromJson = this.f121370a.barcodeTrackingBasicOverlayFromJson(nativeBarcodeTracking_impl, CoreNativeTypeFactory.INSTANCE.convert(jsonData));
        ProxyCache proxyCache = this.proxyCache;
    ...
    public BarcodeBatchDeserializer _deserializer() {
        BarcodeBatchDeserializer barcodeBatchDeserializer = this.f121373d;
    ...
    public NativeBarcodeTrackingDeserializer getF121370a() {
    ...
    public BarcodeBatch _modeFromJson(DataCaptureContext dataCaptureContext, String jsonData) {
        ...
        NativeBarcodeTracking nativeBarcodeTrackingBarcodeTrackingFromJson = this.f121370a.barcodeTrackingFromJson(nativeDataCaptureContext_impl, CoreNativeTypeFactory.INSTANCE.convert(jsonData));
        ProxyCache proxyCache = this.proxyCache;
    ...
    public void _setDeserializer(BarcodeBatchDeserializer deserializer) {
        ...
        this.f121373d = deserializer;
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchDeserializerProxy
    public BarcodeBatchSettings _settingsFromJson(String jsonData) {
        Intrinsics.j(jsonData, "jsonData");
        NativeBarcodeTrackingSettings nativeBarcodeTrackingSettings = this.f121370a.settingsFromJson(CoreNativeTypeFactory.INSTANCE.convert(jsonData));
        ProxyCache proxyCache = this.proxyCache;
    ...
    public List<String> getWarnings() {
        ArrayList<String> warnings = this.f121370a.getWarnings();
    ...
    public BarcodeBatchDeserializerHelper get_helper() {
        return (BarcodeBatchDeserializerHelper) this.proxyCache.requireByValue(Reflection.b(BarcodeBatchDeserializerHelper.class), this.f121370a.getHelper());
    }
    ...
    public BarcodeBatchAdvancedOverlay updateAdvancedOverlayFromJson(BarcodeBatchAdvancedOverlay overlay, String jsonData) {
        ...
        Intrinsics.j(jsonData, "jsonData");
        NativeBarcodeTrackingAdvancedOverlay nativeBarcodeTrackingAdvancedOverlay_impl = overlay.getF121441a();
        ...
        NativeBarcodeTrackingAdvancedOverlay nativeBarcodeTrackingAdvancedOverlayUpdateBarcodeTrackingAdvancedOverlayFromJson = this.f121370a.updateBarcodeTrackingAdvancedOverlayFromJson(nativeBarcodeTrackingAdvancedOverlay_impl, CoreNativeTypeFactory.INSTANCE.convert(jsonData));
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeBarcodeTrackingAdvancedOverlay.class);
    ...
    public BarcodeBatchBasicOverlay updateBasicOverlayFromJson(BarcodeBatchBasicOverlay overlay, String jsonData) {
        Intrinsics.j(overlay, "overlay");
        Intrinsics.j(jsonData, "jsonData");
        NativeBarcodeTrackingBasicOverlay f121450a = overlay.getF121450a();
        this.proxyCache.put(Reflection.b(NativeBarcodeTrackingBasicOverlay.class), null, f121450a, overlay);
        NativeBarcodeTrackingBasicOverlay nativeBarcodeTrackingBasicOverlayUpdateBarcodeTrackingBasicOverlayFromJson = this.f121370a.updateBarcodeTrackingBasicOverlayFromJson(f121450a, CoreNativeTypeFactory.INSTANCE.convert(jsonData));
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeBarcodeTrackingBasicOverlay.class);
    ...
    public BarcodeBatch updateModeFromJson(BarcodeBatch mode, String jsonData) {
        ...
        NativeBarcodeTracking nativeBarcodeTracking_impl = mode.getF121378a();
        this.proxyCache.put(Reflection.b(NativeBarcodeTracking.class), null, nativeBarcodeTracking_impl, mode);
        NativeBarcodeTracking nativeBarcodeTrackingUpdateBarcodeTrackingFromJson = this.f121370a.updateBarcodeTrackingFromJson(nativeBarcodeTracking_impl, CoreNativeTypeFactory.INSTANCE.convert(jsonData));
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeBarcodeTracking.class);
    ...
    public BarcodeBatchSettings updateSettingsFromJson(BarcodeBatchSettings settings, String jsonData) {
        ...
        Intrinsics.j(jsonData, "jsonData");
        NativeBarcodeTrackingSettings nativeBarcodeTrackingSettings_impl = settings.getF121387a();
        this.proxyCache.put(Reflection.b(NativeBarcodeTrackingSettings.class), null, nativeBarcodeTrackingSettings_impl, settings);
        NativeBarcodeTrackingSettings nativeBarcodeTrackingSettingsUpdateSettingsFromJson = this.f121370a.updateSettingsFromJson(nativeBarcodeTrackingSettings_impl, CoreNativeTypeFactory.INSTANCE.convert(jsonData));
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeBarcodeTrackingSettings.class);
