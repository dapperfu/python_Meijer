...
public final class BarcodeBatchSessionProxyAdapter implements BarcodeBatchSessionProxy {
    ...
    private final NativeBarcodeTrackingSession f121383a;
    ...
    public BarcodeBatchSessionProxyAdapter(NativeBarcodeTrackingSession _NativeBarcodeTrackingSession, ProxyCache proxyCache) {
        ...
        this.f121383a = _NativeBarcodeTrackingSession;
    ...
    public List<TrackedBarcode> getAddedTrackedBarcodes() {
        ArrayList<NativeTrackedBarcode> addedTrackedBarcodes = this.f121383a.getAddedTrackedBarcodes();
    ...
    public long getFrameSequenceId() {
        return this.f121383a.getFrameSeqIdAndroid();
    }
    ...
    public List<Integer> getRemovedTrackedBarcodes() {
        ArrayList<Integer> removedTrackedBarcodes = this.f121383a.getRemovedTrackedBarcodes();
    ...
    public Map<Integer, TrackedBarcode> getTrackedBarcodes() {
        HashMap<Integer, NativeTrackedBarcode> trackedBarcodes = this.f121383a.getTrackedBarcodes();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
    ...
    public List<TrackedBarcode> getUnscannedTrackedBarcodes() {
        ArrayList<NativeTrackedBarcode> unscannedTrackedBarcodes = this.f121383a.getUnscannedTrackedBarcodes();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
    ...
    public List<TrackedBarcode> getUpdatedTrackedBarcodes() {
        ArrayList<NativeTrackedBarcode> updatedTrackedBarcodes = this.f121383a.getUpdatedTrackedBarcodes();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
    ...
    public String toJson() {
        String json = this.f121383a.toJson();
        Intrinsics.g(json);
        return json;
    }
