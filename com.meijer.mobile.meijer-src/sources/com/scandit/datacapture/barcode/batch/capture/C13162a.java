...
public final class C13162a extends Lambda implements Function0 {

    /* renamed from: a, reason: collision with root package name */
    public final /* synthetic */ NativeBarcodeTracking f121395a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C13162a(NativeBarcodeTracking nativeBarcodeTracking) {
        super(0);
        this.f121395a = nativeBarcodeTracking;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        NativeBarcodeTrackingSession session = this.f121395a.getSession();
