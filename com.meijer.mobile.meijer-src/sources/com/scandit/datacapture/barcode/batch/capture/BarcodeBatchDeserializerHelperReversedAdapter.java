...
public final class BarcodeBatchDeserializerHelperReversedAdapter extends NativeBarcodeTrackingDeserializerHelper {
    ...
    private final BarcodeBatchDeserializerHelper f121365a;
    ...
    public BarcodeBatchDeserializerHelperReversedAdapter(BarcodeBatchDeserializerHelper _BarcodeBatchDeserializerHelper, ProxyCache proxyCache) {
        ...
        this.f121365a = _BarcodeBatchDeserializerHelper;
    ...
    public void applySettings(NativeBarcodeTracking mode, NativeBarcodeTrackingSettings settings) {
        ...
        this.f121365a.applySettings((BarcodeBatch) this.proxyCache.require(Reflection.b(NativeBarcodeTracking.class), null, mode), (BarcodeBatchSettings) this.proxyCache.require(Reflection.b(NativeBarcodeTrackingSettings.class), null, settings));
    }
    ...
    public void changeAdvancedOverlayAddedToView(NativeBarcodeTrackingAdvancedOverlay overlay, NativeDataCaptureView view, boolean added) {
        ...
        this.f121365a.changeAdvancedOverlayAddedToView((BarcodeBatchAdvancedOverlay) this.proxyCache.require(Reflection.b(NativeBarcodeTrackingAdvancedOverlay.class), null, overlay), (DataCaptureView) this.proxyCache.require(Reflection.b(NativeDataCaptureView.class), null, view), added);
    }
    ...
    public void changeBasicOverlayAddedToView(NativeBarcodeTrackingBasicOverlay overlay, NativeDataCaptureView view, boolean added) {
        Intrinsics.j(overlay, "overlay");
        Intrinsics.j(view, "view");
        this.f121365a.changeBasicOverlayAddedToView((BarcodeBatchBasicOverlay) this.proxyCache.require(Reflection.b(NativeBarcodeTrackingBasicOverlay.class), null, overlay), (DataCaptureView) this.proxyCache.require(Reflection.b(NativeDataCaptureView.class), null, view), added);
    }

    @Override // com.scandit.datacapture.barcode.batch.internal.module.serialization.NativeBarcodeTrackingDeserializerHelper
    public NativeBarcodeTrackingAdvancedOverlay createAdvancedOverlay(NativeBarcodeTracking mode) {
        Intrinsics.j(mode, "mode");
        BarcodeBatchAdvancedOverlay barcodeBatchAdvancedOverlayCreateAdvancedOverlay = this.f121365a.createAdvancedOverlay((BarcodeBatch) this.proxyCache.require(Reflection.b(NativeBarcodeTracking.class), null, mode));
    ...
    public NativeBarcodeTrackingBasicOverlay createBasicOverlay(NativeBarcodeTracking mode, NativeBarcodeTrackingBasicOverlayStyle style) {
        ...
        BarcodeBatchBasicOverlay barcodeBatchBasicOverlayCreateBasicOverlay = this.f121365a.createBasicOverlay((BarcodeBatch) this.proxyCache.require(Reflection.b(NativeBarcodeTracking.class), null, mode), BarcodeNativeTypeFactory.INSTANCE.convert(style));
        this.proxyCache.put(Reflection.b(BarcodeBatchBasicOverlay.class), null, barcodeBatchBasicOverlayCreateBasicOverlay, barcodeBatchBasicOverlayCreateBasicOverlay.getF121450a());
        NativeBarcodeTrackingBasicOverlay f121450a = barcodeBatchBasicOverlayCreateBasicOverlay.getF121450a();
        this.proxyCache.put(Reflection.b(NativeBarcodeTrackingBasicOverlay.class), null, f121450a, barcodeBatchBasicOverlayCreateBasicOverlay);
        return f121450a;
    }
    ...
    public NativeBarcodeTracking createMode(NativeDataCaptureContext context) {
        ...
        BarcodeBatch barcodeBatchCreateMode = this.f121365a.createMode((DataCaptureContext) this.proxyCache.getOrPut(Reflection.b(NativeDataCaptureContext.class), null, context, new C13168g(context)));
    ...
    public NativeCameraSettings createRecommendedCameraSettings() {
        return CoreNativeTypeFactory.INSTANCE.convert(this.f121365a.createRecommendedCameraSettings());
    }

    @Override // com.scandit.datacapture.barcode.batch.internal.module.serialization.NativeBarcodeTrackingDeserializerHelper
    public NativeBarcodeTrackingSettings createSettings() {
        BarcodeBatchSettings barcodeBatchSettingsCreateSettings = this.f121365a.createSettings();
    ...
    public NativeBarcodeTrackingSettings createSettingsForScenario(NativeObjectTrackerScenario scenario) {
        ...
        BarcodeBatchSettings barcodeBatchSettingsCreateSettingsForScenario = this.f121365a.createSettingsForScenario(scenario);
    ...
    public void updateAdvancedOverlayFromJson(NativeBarcodeTrackingAdvancedOverlay overlay, NativeJsonValue json) {
        ...
        this.f121365a.updateAdvancedOverlayFromJson((BarcodeBatchAdvancedOverlay) this.proxyCache.require(Reflection.b(NativeBarcodeTrackingAdvancedOverlay.class), null, overlay), (JsonValue) this.proxyCache.getOrPut(Reflection.b(NativeJsonValue.class), null, json, new C13169h(json)));
    }
    ...
    public void updateBasicOverlayFromJson(NativeBarcodeTrackingBasicOverlay overlay, NativeJsonValue json) {
        Intrinsics.j(overlay, "overlay");
        Intrinsics.j(json, "json");
        this.f121365a.updateBasicOverlayFromJson((BarcodeBatchBasicOverlay) this.proxyCache.require(Reflection.b(NativeBarcodeTrackingBasicOverlay.class), null, overlay), (JsonValue) this.proxyCache.getOrPut(Reflection.b(NativeJsonValue.class), null, json, new i(json)));
    }
    ...
    public void updateModeFromJson(NativeBarcodeTracking mode, NativeJsonValue json) {
        Intrinsics.j(mode, "mode");
        Intrinsics.j(json, "json");
        this.f121365a.updateModeFromJson((BarcodeBatch) this.proxyCache.require(Reflection.b(NativeBarcodeTracking.class), null, mode), (JsonValue) this.proxyCache.getOrPut(Reflection.b(NativeJsonValue.class), null, json, new j(json)));
    }
    ...
    public void updateSettingsFromJson(NativeBarcodeTrackingSettings settings, NativeJsonValue json) {
        Intrinsics.j(settings, "settings");
        Intrinsics.j(json, "json");
        this.f121365a.updateSettingsFromJson((BarcodeBatchSettings) this.proxyCache.require(Reflection.b(NativeBarcodeTrackingSettings.class), null, settings), (JsonValue) this.proxyCache.getOrPut(Reflection.b(NativeJsonValue.class), null, json, new k(json)));
    }
