...
public final class BarcodeBatchProxyAdapter implements BarcodeBatchProxy {
    ...
    private final NativeBarcodeTracking f121378a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeDataCaptureMode f121380c;
    ...
    public BarcodeBatchProxyAdapter(NativeBarcodeTracking _NativeBarcodeTracking, ProxyCache proxyCache) {
        ...
        this.f121378a = _NativeBarcodeTracking;
        ...
        this.f121380c = nativeDataCaptureModeAsDataCaptureMode;
    }
    ...
    public void _activateState(String identifier) {
        ...
        this.f121378a.activateState(identifier);
    }
    ...
    public boolean isEnabled() {
        return this.f121378a.isEnabled();
    }
