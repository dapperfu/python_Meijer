...
public final class C13166e implements BarcodeBatchDeserializerListener {

    /* renamed from: a, reason: collision with root package name */
    public final WeakReference f121399a;

    public C13166e(BarcodeBatchDeserializer owner) {
        Intrinsics.j(owner, "owner");
        this.f121399a = new WeakReference(owner);
    }
    ...
    public final void onAdvancedOverlayDeserializationFinished(BarcodeBatchDeserializer deserializer, BarcodeBatchAdvancedOverlay overlay, JsonValue json) {
        ...
        BarcodeBatchDeserializer barcodeBatchDeserializer = (BarcodeBatchDeserializer) this.f121399a.get();
