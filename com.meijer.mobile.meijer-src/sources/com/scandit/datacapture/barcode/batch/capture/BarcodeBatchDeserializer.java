...
public final class BarcodeBatchDeserializer implements DataCaptureModeDeserializer, BarcodeBatchDeserializerProxy {
    ...
    private final BarcodeBatchDeserializerHelper f121362a;

    /* renamed from: b, reason: collision with root package name */
    private final /* synthetic */ BarcodeBatchDeserializerProxyAdapter f121363b;
    ...
    public BarcodeBatchAdvancedOverlay _advancedOverlayFromJson(BarcodeBatch mode, String jsonData) {
        ...
        return this.f121363b._advancedOverlayFromJson(mode, jsonData);
    }
    ...
    public BarcodeBatchBasicOverlay _basicOverlayFromJson(BarcodeBatch mode, String jsonData) {
        Intrinsics.j(mode, "mode");
        Intrinsics.j(jsonData, "jsonData");
        return this.f121363b._basicOverlayFromJson(mode, jsonData);
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchDeserializerProxy
    @ProxyGetter(ProxyGetterKind.WITH_SETTER)
    public BarcodeBatchDeserializer _deserializer() {
        return this.f121363b._deserializer();
    }
    ...
    public NativeBarcodeTrackingDeserializer getF121370a() {
        return this.f121363b.getF121370a();
    }
    ...
    public NativeDataCaptureModeDeserializer getF121372c() {
        return this.f121363b.getF121372c();
    }
    ...
    public BarcodeBatch _modeFromJson(DataCaptureContext dataCaptureContext, String jsonData) {
        ...
        Intrinsics.j(jsonData, "jsonData");
        return this.f121363b._modeFromJson(dataCaptureContext, jsonData);
    }
    ...
    public void _setDeserializer(BarcodeBatchDeserializer deserializer) {
        ...
        this.f121363b._setDeserializer(deserializer);
    }
    ...
    public BarcodeBatchAdvancedOverlay updateAdvancedOverlayFromJson(BarcodeBatchAdvancedOverlay overlay, String jsonData) {
        ...
        Intrinsics.j(jsonData, "jsonData");
        return this.f121363b.updateAdvancedOverlayFromJson(overlay, jsonData);
    }
    ...
    public BarcodeBatchBasicOverlay updateBasicOverlayFromJson(BarcodeBatchBasicOverlay overlay, String jsonData) {
        Intrinsics.j(overlay, "overlay");
        Intrinsics.j(jsonData, "jsonData");
        return this.f121363b.updateBasicOverlayFromJson(overlay, jsonData);
    }
    ...
    public BarcodeBatch updateModeFromJson(BarcodeBatch mode, String jsonData) {
        Intrinsics.j(mode, "mode");
        Intrinsics.j(jsonData, "jsonData");
        return this.f121363b.updateModeFromJson(mode, jsonData);
    }
    ...
    public BarcodeBatchSettings updateSettingsFromJson(BarcodeBatchSettings settings, String jsonData) {
        ...
        Intrinsics.j(jsonData, "jsonData");
        return this.f121363b.updateSettingsFromJson(settings, jsonData);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public BarcodeBatchDeserializer() {
        C13167f c13167f = new C13167f();
        int i10 = 2;
        BarcodeBatchDeserializerHelperReversedAdapter barcodeBatchDeserializerHelperReversedAdapter = new BarcodeBatchDeserializerHelperReversedAdapter(c13167f, null, i10, 0 == true ? 1 : 0);
        ...
        this.f121362a = c13167f;
        this.f121363b = new BarcodeBatchDeserializerProxyAdapter(nativeBarcodeTrackingDeserializerCreate, 0 == true ? 1 : 0, i10, 0 == true ? 1 : 0);
        ProxyCacheKt.getGlobalProxyCache().getOrPut(Reflection.b(BarcodeBatchDeserializerHelper.class), null, c13167f, new C13165d(barcodeBatchDeserializerHelperReversedAdapter));
        _setDeserializer(this);
        nativeBarcodeTrackingDeserializerCreate.setListener(new BarcodeBatchDeserializerListenerReversedAdapter(new C13166e(this), this, null, 4, null));
    }
