...
public final class BarcodeFilterHighlightSettingsBrush implements BarcodeFilterOverlaySettingsBrushProxy {
    ...
    private final /* synthetic */ BarcodeFilterOverlaySettingsBrushProxyAdapter f121876a;
    ...
    public NativeBarcodeFilterOverlaySettingsBrush getF121879a() {
        return this.f121876a.getF121879a();
    }

    public BarcodeFilterHighlightSettingsBrush(NativeBarcodeFilterOverlaySettingsBrush impl) {
        Intrinsics.j(impl, "impl");
        this.f121876a = new BarcodeFilterOverlaySettingsBrushProxyAdapter(impl, null, 2, null);
    }
}
