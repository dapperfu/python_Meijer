...
public final class BarcodeCaptureOverlay implements DataCaptureOverlay, BarcodeCaptureOverlayProxy {
    ...
    private final /* synthetic */ BarcodeCaptureOverlayProxyAdapter f124955a;

    /* renamed from: b, reason: collision with root package name */
    private final HashMap f124956b;
    ...
    public static final class Companion {
        ...
        public final BarcodeCaptureOverlay newInstance(BarcodeCapture mode, DataCaptureView view) {
            ...
            OverlayPreconditionsKt.checkAttachedToSameDataCaptureContext(mode, view, a.f124964a);
        ...
        public final BarcodeCaptureOverlay newInstance(BarcodeCapture mode, DataCaptureView view, BarcodeCaptureOverlayStyle style) {
            Intrinsics.j(mode, "mode");
            Intrinsics.j(style, "style");
            OverlayPreconditionsKt.checkAttachedToSameDataCaptureContext(mode, view, b.f124965a);
    ...
    public BarcodeCaptureOverlay(NativeBarcodeCaptureOverlay impl) {
        ...
        this.f124955a = new BarcodeCaptureOverlayProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        this.f124956b = new HashMap();
    }
    ...
    public NativeDataCaptureOverlay getF124960c() {
        return this.f124955a.getF124960c();
    }
    ...
    public void setBrush(Brush brush) {
        ...
        this.f124955a.setBrush(brush);
    }

    @Override // com.scandit.datacapture.barcode.ui.overlay.BarcodeCaptureOverlayProxy
    @ProxyFunction(property = "shouldShowScanAreaGuides")
    public void setShouldShowScanAreaGuides(boolean z10) {
        this.f124955a.setShouldShowScanAreaGuides(z10);
    }
    ...
    public final void setProperty(String name, Object value) {
        ...
        if (Intrinsics.e(name, "localizedOnlyBarcodeBrush")) {
            ...
            getF124958a().setBrushForLocalizedOnlyBarcodes(nativeBrushConvert);
            getF124958a().setShouldDrawLocalizedOnlyBarcodes(true);
        }
    }

    public final void setViewfinder(Viewfinder viewfinder) {
        this.viewfinder = viewfinder;
        getF124958a().setViewfinder(viewfinder != null ? viewfinder.getF127142c() : null);
    }
    ...
    public BarcodeCaptureOverlay(BarcodeCapture barcodeCapture, DefaultConstructorMarker defaultConstructorMarker) {
        NativeBarcodeCaptureOverlay nativeBarcodeCaptureOverlayCreateWithDefaultStyle = NativeBarcodeCaptureOverlay.createWithDefaultStyle(barcodeCapture.getF121491a());
    ...
    public BarcodeCaptureOverlay(BarcodeCapture barcodeCapture, BarcodeCaptureOverlayStyle barcodeCaptureOverlayStyle, DefaultConstructorMarker defaultConstructorMarker) {
        NativeBarcodeCaptureOverlay nativeBarcodeCaptureOverlayCreate = NativeBarcodeCaptureOverlay.create(barcodeCapture.getF121491a(), BarcodeCaptureOverlayStyleKt.toNative(barcodeCaptureOverlayStyle));
