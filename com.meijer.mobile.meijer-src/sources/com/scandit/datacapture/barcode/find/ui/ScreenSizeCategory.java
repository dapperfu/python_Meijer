...
public final class ScreenSizeCategory {
    ...
    private static final /* synthetic */ ScreenSizeCategory[] f121954b;

    /* renamed from: c, reason: collision with root package name */
    private static final /* synthetic */ EnumEntries f121955c;
    ...
    public static final class Companion {
        public final ScreenSizeCategory fromJson(String string) {
            ...
            for (ScreenSizeCategory screenSizeCategory : ScreenSizeCategory.values()) {
                if (Intrinsics.e(screenSizeCategory.f121956a, string)) {
    ...
    public static ScreenSizeCategory[] values() {
        return (ScreenSizeCategory[]) f121954b.clone();
    }
    ...
    static {
        ...
        f121954b = screenSizeCategoryArr;
        f121955c = EnumEntriesKt.a(screenSizeCategoryArr);
        INSTANCE = new Companion(null);
    }

    /* renamed from: toJson, reason: from getter */
    public final String getF121956a() {
