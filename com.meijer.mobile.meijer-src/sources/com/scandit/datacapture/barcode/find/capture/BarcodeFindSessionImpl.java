...
public final class BarcodeFindSessionImpl implements BarcodeFindSession {
    ...
    private final NativeBarcodeFindSession f121907a;
    ...
    public List<TrackedBarcode> getTrackedBarcodes() {
        Collection<NativeTrackedBarcode> collectionValues = this.f121907a.getTrackedBarcodes().values();
    ...
    public String toJson() {
        String publicJson = this.f121907a.toPublicJson();
