...
public final class BarcodeFindProxyAdapter implements BarcodeFindProxy {
    ...
    private final NativeBarcodeFind f121904a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeDataCaptureMode f121906c;
    ...
    public BarcodeFindProxyAdapter(NativeBarcodeFind _NativeBarcodeFind, ProxyCache proxyCache) {
        ...
        this.f121904a = _NativeBarcodeFind;
        ...
        this.f121906c = nativeDataCaptureModeAsDataCaptureMode;
    }
    ...
    public NativeDataCaptureMode getF121906c() {
    ...
    public boolean isEnabled() {
        return this.f121904a.isEnabled();
    }

    @Override // com.scandit.datacapture.barcode.find.capture.BarcodeFindProxy
    public void pause() {
        this.f121904a.pauseAsync();
    }

    @Override // com.scandit.datacapture.barcode.find.capture.BarcodeFindProxy
    public void setEnabled(boolean z10) {
        this.f121904a.setEnabled(z10);
    }

    @Override // com.scandit.datacapture.barcode.find.capture.BarcodeFindProxy
    public void start() {
        this.f121904a.startAsync();
    }

    @Override // com.scandit.datacapture.barcode.find.capture.BarcodeFindProxy
    public void stop() {
        this.f121904a.stopAsync();
    }
