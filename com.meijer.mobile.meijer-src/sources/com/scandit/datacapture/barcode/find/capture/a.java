...
public final class a implements InternalBarcodeFindListener {
    ...
    public final WeakReference f121912a;
    ...
    public final void a(BarcodeFind mode) {
        ...
        BarcodeFind barcodeFind = (BarcodeFind) this.f121912a.get();
        if (barcodeFind != null) {
            Iterator it = barcodeFind.f121891g.iterator();
            while (it.hasNext()) {
    ...
    public a(BarcodeFind owner) {
        ...
        this.f121912a = new WeakReference(owner);
    }
    ...
    public final void c(HashSet barcodes) {
        ...
        BarcodeFind barcodeFind = (BarcodeFind) this.f121912a.get();
        if (barcodeFind == null || barcodeFind.f121892h.isEmpty()) {
            return;
        }
        ...
        Iterator it3 = barcodeFind.f121892h.iterator();
        while (it3.hasNext()) {
