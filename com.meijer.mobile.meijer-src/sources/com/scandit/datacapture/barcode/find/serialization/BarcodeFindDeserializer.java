...
public final class BarcodeFindDeserializer implements DataCaptureModeDeserializer, BarcodeFindDeserializerProxy {
    ...
    private final BarcodeFindDeserializerHelper f121917a;

    /* renamed from: b, reason: collision with root package name */
    private final /* synthetic */ BarcodeFindDeserializerProxyAdapter f121918b;
    ...
    public NativeBarcodeFindDeserializer getF121920a() {
        return this.f121918b.getF121920a();
    }
    ...
    public NativeDataCaptureModeDeserializer getF121922c() {
        return this.f121918b.getF121922c();
    }
    ...
    public BarcodeFind _modeFromJson(String json) {
        ...
        return this.f121918b._modeFromJson(json);
    }
    ...
    public BarcodeFindSettings _settingsFromJson(String json) {
        Intrinsics.j(json, "json");
        return this.f121918b._settingsFromJson(json);
    }
    ...
    public BarcodeFind _updateModeFromJson(BarcodeFind mode, String json) {
        ...
        Intrinsics.j(json, "json");
        return this.f121918b._updateModeFromJson(mode, json);
    }
    ...
    public BarcodeFindDeserializer() {
        ...
        this.f121917a = aVar;
        this.f121918b = new BarcodeFindDeserializerProxyAdapter(nativeBarcodeFindDeserializerCreate, null, 2, 0 == true ? 1 : 0);
        ProxyCacheKt.getGlobalProxyCache().getOrPut(Reflection.b(BarcodeFindDeserializerHelper.class), null, aVar, new a(dVar));
        getF121920a().setListener(new n(new b(this), this));
    }
