...
public final class BarcodeFindDeserializerProxyAdapter implements BarcodeFindDeserializerProxy {
    ...
    private final NativeBarcodeFindDeserializer f121920a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeDataCaptureModeDeserializer f121922c;
    ...
    public BarcodeFindDeserializerProxyAdapter(NativeBarcodeFindDeserializer _NativeBarcodeFindDeserializer, ProxyCache proxyCache) {
        ...
        this.f121920a = _NativeBarcodeFindDeserializer;
        ...
        this.f121922c = nativeDataCaptureModeDeserializerAsDataCaptureModeDeserializer;
    }

    @Override // com.scandit.datacapture.barcode.find.serialization.BarcodeFindDeserializerProxy
    /* renamed from: _impl, reason: from getter */
    public NativeBarcodeFindDeserializer getF121920a() {
    ...
    public BarcodeFind _modeFromJson(String json) {
        ...
        NativeBarcodeFind nativeBarcodeFindBarcodeFindFromJson = this.f121920a.barcodeFindFromJson(CoreNativeTypeFactory.INSTANCE.convert(json));
    ...
    public BarcodeFindSettings _settingsFromJson(String json) {
        Intrinsics.j(json, "json");
        NativeBarcodeFindSettings nativeBarcodeFindSettings = this.f121920a.settingsFromJson(CoreNativeTypeFactory.INSTANCE.convert(json));
        ProxyCache proxyCache = this.proxyCache;
    ...
    public BarcodeFind _updateModeFromJson(BarcodeFind mode, String json) {
        ...
        Intrinsics.j(json, "json");
        NativeBarcodeFind nativeBarcodeFind_impl = mode.getF121904a();
        this.proxyCache.put(Reflection.b(NativeBarcodeFind.class), null, nativeBarcodeFind_impl, mode);
        NativeBarcodeFind nativeBarcodeFindUpdateBarcodeFindFromJson = this.f121920a.updateBarcodeFindFromJson(nativeBarcodeFind_impl, CoreNativeTypeFactory.INSTANCE.convert(json));
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeBarcodeFind.class);
    ...
    public BarcodeFindSettings _updateSettingsFromJson(BarcodeFindSettings settings, String json) {
        ...
        Intrinsics.j(json, "json");
        NativeBarcodeFindSettings nativeBarcodeFindSettings_impl = settings.getF121909a();
        this.proxyCache.put(Reflection.b(NativeBarcodeFindSettings.class), null, nativeBarcodeFindSettings_impl, settings);
        NativeBarcodeFindSettings nativeBarcodeFindSettingsUpdateSettingsFromJson = this.f121920a.updateSettingsFromJson(nativeBarcodeFindSettings_impl, CoreNativeTypeFactory.INSTANCE.convert(json));
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeBarcodeFindSettings.class);
    ...
    public BarcodeFindDeserializerHelper get_helper() {
        return (BarcodeFindDeserializerHelper) this.proxyCache.requireByValue(Reflection.b(BarcodeFindDeserializerHelper.class), this.f121920a.getHelper());
    }
