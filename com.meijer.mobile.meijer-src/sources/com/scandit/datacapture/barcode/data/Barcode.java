...
public final class Barcode implements BarcodeProxy {
    ...
    private final /* synthetic */ BarcodeProxyAdapter f121840a;

    /* renamed from: b, reason: collision with root package name */
    private final Lazy f121841b;

    @Override // com.scandit.datacapture.barcode.data.BarcodeProxy
    @NativeImpl
    /* renamed from: _impl */
    public NativeBarcode getF121842a() {
        return this.f121840a.getF121842a();
    }
    ...
    public StructuredAppendData getStructuredAppendData() {
        return this.f121840a.getStructuredAppendData();
    }

    @Override // com.scandit.datacapture.barcode.data.BarcodeProxy
    @ProxyFunction(nativeName = "toJson")
    public String toJson() {
        return this.f121840a.toJson();
    }

    /* JADX WARN: Multi-variable type inference failed */
    public Barcode(NativeBarcode impl) {
        Intrinsics.j(impl, "impl");
        this.f121840a = new BarcodeProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        this.f121841b = LazyKt.b(new a(this));
    }

    private final NativeBarcodeRecord a() {
        Object value = this.f121841b.getValue();
