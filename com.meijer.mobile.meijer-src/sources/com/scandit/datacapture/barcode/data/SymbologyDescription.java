...
public final class SymbologyDescription implements SymbologyDescriptionProxy {
    ...
    private final /* synthetic */ SymbologyDescriptionProxyAdapter f121865a;
    ...
    public final Set<String> getSupportedExtensions() {
        HashSet<String> publicExtensions = getF121866a().getPublicExtensions();
