...
public final class SparkScanViewDeserializer {
    ...
    private final SparkScanViewSettingsDeserializer f124869a;

    /* renamed from: b, reason: collision with root package name */
    private final Function0 f124870b;
    ...
    public SparkScanViewDeserializer(SparkScanViewSettingsDeserializer viewSettingsDeserializer, Function0<SparkScanViewSettings> settingsFactory) {
        ...
        this.f124869a = viewSettingsDeserializer;
        this.f124870b = settingsFactory;
    }
    ...
    public final SparkScanView viewFrom(View parentView, SparkScan mode, DataCaptureContext context, String json) {
        ...
        SparkScanViewSettings sparkScanViewSettings = (SparkScanViewSettings) this.f124870b.invoke();
        if (jsonValue.contains("viewSettings")) {
            this.f124869a.a(sparkScanViewSettings, jsonValue.requireByKeyAsObject("viewSettings"));
        }
    ...
    public SparkScanViewDeserializer() {
        this(new com.scandit.datacapture.barcode.internal.module.spark.serialization.c(), c.f124873a);
    }
}
