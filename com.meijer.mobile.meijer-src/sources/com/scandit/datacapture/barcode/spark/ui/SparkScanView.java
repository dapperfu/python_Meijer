...
import com.scandit.datacapture.barcode.internal.module.spark.data.C13327g;
...
public final class SparkScanView extends RelativeLayout {
    ...
    private final DataCaptureContext f124897a;

    /* renamed from: b, reason: collision with root package name */
    private final SparkScan f124898b;

    /* renamed from: c, reason: collision with root package name */
    private final SparkScanStateManager f124899c;

    /* renamed from: d, reason: collision with root package name */
    private final SparkScanViewCameraManager f124900d;

    /* renamed from: e, reason: collision with root package name */
    private final SparkScanViewMiniPreview f124901e;

    /* renamed from: f, reason: collision with root package name */
    private final SparkScanViewScanButtonTouchListener f124902f;

    /* renamed from: g, reason: collision with root package name */
    private final SparkScanViewScanButtonView f124903g;

    /* renamed from: h, reason: collision with root package name */
    private final SparkScanFeedbackManager f124904h;

    /* renamed from: i, reason: collision with root package name */
    private final SparkScanViewToastPresenter f124905i;

    /* renamed from: j, reason: collision with root package name */
    private final SparkScanAnalyticsManager f124906j;

    /* renamed from: k, reason: collision with root package name */
    private final PropertyPushSource f124907k;

    /* renamed from: l, reason: collision with root package name and from kotlin metadata */
    private SparkScanFeedbackDelegate feedbackDelegate;

    /* renamed from: m, reason: collision with root package name */
    private final SparkScanViewPresenter f124909m;

    /* renamed from: n, reason: collision with root package name */
    private final SparkScanView$sparkScanCameraStartListener$1 f124910n;

    /* renamed from: o, reason: collision with root package name */
    private final SparkScanView$sparkScanEnableListener$1 f124911o;

    /* renamed from: p, reason: collision with root package name */
    private int f124912p;

    /* renamed from: q, reason: collision with root package name */
    private final SparkScanView$orientationEventListener$1 f124913q;

    /* renamed from: r, reason: collision with root package name */
    private final SparkScanView$modeViewListener$1 f124914r;
    ...
    public /* synthetic */ SparkScanView(View view, DataCaptureContext dataCaptureContext, SparkScan sparkScan, SparkScanViewSettings sparkScanViewSettings, SparkScanStateManager sparkScanStateManager, SparkScanViewCameraManager sparkScanViewCameraManager, SparkScanViewMiniPreview sparkScanViewMiniPreview, SparkScanViewScanButtonTouchListener sparkScanViewScanButtonTouchListener, SparkScanViewScanButtonView sparkScanViewScanButtonView, SparkScanFeedbackManager sparkScanFeedbackManager, SparkScanViewToastPresenter sparkScanViewToastPresenter, SparkScanAnalyticsManager sparkScanAnalyticsManager, PropertyPushSource propertyPushSource, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        SparkScanAnalyticsManager c13327g = (i10 & RecyclerView.m.FLAG_MOVED) != 0 ? new C13327g(sparkScanStateManager2) : sparkScanAnalyticsManager;
        if ((i10 & RecyclerView.m.FLAG_APPEARED_IN_PRE_LAYOUT) != 0) {
            propertyPushSource2 = new PropertyPushSource(c13327g);
        ...
        this(view2, dataCaptureContext, sparkScan2, sparkScanViewSettings2, sparkScanStateManager3, sparkScanViewCameraManager2, f10, hVar, sparkScanViewScanButtonView2, sparkScanFeedbackManager2, sVar, c13327g, propertyPushSource2);
    }
    ...
    public static final boolean access$didRotate180Degrees(SparkScanView sparkScanView, int i10) {
        return Math.abs(i10 - sparkScanView.f124912p) == 2;
    }
    ...
    public final Integer getToolbarIconActiveTintColor() {
        return this.f124901e.u();
    }

    public final Integer getToolbarIconInactiveTintColor() {
        return this.f124901e.j();
    }

    public final boolean getTorchControlVisible() {
        return this.f124901e.r();
    }

    public final Integer getTriggerButtonAnimationColor() {
        return this.f124903g.b();
    }

    public final Integer getTriggerButtonCollapsedColor() {
        return this.f124903g.c();
    }

    public final Integer getTriggerButtonExpandedColor() {
        return this.f124903g.d();
    }

    public final Bitmap getTriggerButtonImage() {
        return this.f124903g.e();
    }

    public final Integer getTriggerButtonTintColor() {
        return this.f124903g.f();
    }

    public final boolean getTriggerButtonVisible() {
        return this.f124909m.c();
    }

    public final boolean getZoomSwitchControlVisible() {
        return this.f124901e.t();
    }

    public final void onPause() {
        this.f124909m.F();
        disable();
        this.f124898b._removeEnableDisableListener$scandit_barcode_capture(this.f124911o);
        this.f124898b.set_sparkScanModeViewListener$scandit_barcode_capture(null);
        this.f124898b.setDataCaptureContext$scandit_barcode_capture(null);
        this.f124898b.setPropertyPushSource$scandit_barcode_capture(null);
        this.f124900d.a((SparkScanView$sparkScanCameraStartListener$1) null);
    ...
    public final void onResume() {
        enable();
        this.f124898b.setDataCaptureContext$scandit_barcode_capture(this.f124897a);
        this.f124900d.a(this.f124910n);
        SparkScan sparkScan = this.f124898b;
        sparkScan._addEnableDisableListener$scandit_barcode_capture(this.f124911o);
        sparkScan.set_sparkScanModeViewListener$scandit_barcode_capture(this.f124914r);
        sparkScan._applyNewSettingsForScanningMode$scandit_barcode_capture(this.f124899c.p());
        sparkScan.setPropertyPushSource$scandit_barcode_capture(this.f124907k);
        setOnClickListener(new View.OnClickListener() { // from class: com.scandit.datacapture.barcode.spark.ui.c
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SparkScanView.a(this.f124947a, view);
            }
        });
        this.f124904h.a(this);
        this.f124903g.a((ViewGroup) this);
        this.f124903g.a(this.f124909m);
        this.f124901e.a(this);
        this.f124901e.a((A) this.f124909m);
        this.f124909m.b(this.f124898b.isEnabled() ? SparkScanViewState.ACTIVE : SparkScanViewState.IDLE);
    }
    ...
    public final void setTriggerButtonImage(int resourceId) {
        SparkScanViewScanButtonView sparkScanViewScanButtonView = this.f124903g;
    ...
    public static final void access$onHardwareKeyEvent(SparkScanView sparkScanView, HardwareKeyEvent hardwareKeyEvent) {
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    sparkScanView.f124909m.D();
                    return;
                }
                throw new NoWhenBranchMatchedException();
            }
            sparkScanView.f124909m.E();
            return;
        }
        sparkScanView.f124909m.A();
    }
    ...
    public SparkScanView(View parentView, DataCaptureContext dataCaptureContext, SparkScan sparkScan, SparkScanViewSettings settings, SparkScanStateManager stateManager, SparkScanViewCameraManager cameraManager, SparkScanViewMiniPreview miniPreview, SparkScanViewScanButtonTouchListener scanButtonTouchListener, SparkScanViewScanButtonView sparkCaptureViewScanButtonView, SparkScanFeedbackManager feedbackManager, SparkScanViewToastPresenter toastPresenter, SparkScanAnalyticsManager analyticsManager, PropertyPushSource propertyPushSource) {
        ...
        this.f124897a = dataCaptureContext;
        this.f124898b = sparkScan;
        this.f124899c = stateManager;
        this.f124900d = cameraManager;
        this.f124901e = miniPreview;
        this.f124902f = scanButtonTouchListener;
        this.f124903g = sparkCaptureViewScanButtonView;
        this.f124904h = feedbackManager;
        this.f124905i = toastPresenter;
        this.f124906j = analyticsManager;
        this.f124907k = propertyPushSource;
        ...
        NativeSparkScanStateMachine stateMachine = sparkScan.get_sparkScanInternal().a().getStateMachine();
        Intrinsics.i(stateMachine, "getStateMachine(...)");
        this.f124909m = new SparkScanViewPresenter(this, stateManager, sparkScan, settings, cameraManager, miniPreview, sparkCaptureViewScanButtonView, feedbackManager, toastPresenter, analyticsManager, stateMachine);
        this.f124910n = new SparkScanView$sparkScanCameraStartListener$1(this);
        this.f124911o = new SparkScanEnableDisableListener() { // from class: com.scandit.datacapture.barcode.spark.ui.SparkScanView$sparkScanEnableListener$1
            ...
            public void onEnabledChange(boolean isEnabled) {
                if (isEnabled) {
                    this.f124918a.startScanning();
                } else {
                    this.f124918a.pauseScanning();
                }
            }
        };
        final Context context = getContext();
        this.f124913q = new OrientationEventListener(context) { // from class: com.scandit.datacapture.barcode.spark.ui.SparkScanView$orientationEventListener$1
            @Override // android.view.OrientationEventListener
            public void onOrientationChanged(int orientation) {
                Context context2 = this.f124916a.getContext();
                Intrinsics.i(context2, "getContext(...)");
                int rotation = ContextExtensionsKt.getRotation(context2);
                if (SparkScanView.access$didRotate180Degrees(this.f124916a, rotation)) {
                    this.f124916a.f124909m.M();
                }
                this.f124916a.f124912p = rotation;
            }
        };
        this.f124914r = new SparkScanModeViewListener() { // from class: com.scandit.datacapture.barcode.spark.ui.SparkScanView$modeViewListener$1
            ...
            public SparkScanScanningMode getScanningMode() {
                return this.f124915a.f124899c.p();
            }

            @Override // com.scandit.datacapture.barcode.internal.module.spark.capture.SparkScanModeViewListener
            public void onApplySettings(SparkScanSettings settings2) {
                Intrinsics.j(settings2, "settings");
                this.f124915a.f124900d.setBatterySavingMode(settings2.getBatterySaving());
            }
        };
        ((ViewGroup) parentView).addView(this, new ViewGroup.LayoutParams(-1, -1));
        setElevation(((Number) E.f123932j.getValue()).floatValue());
