...
import com.scandit.datacapture.barcode.internal.module.spark.data.InterfaceC13328h;
...
public final class SparkScanView$sparkScanCameraStartListener$1 implements InterfaceC13328h {

    /* renamed from: a, reason: collision with root package name */
    final /* synthetic */ SparkScanView f124917a;

    SparkScanView$sparkScanCameraStartListener$1(SparkScanView sparkScanView) {
        this.f124917a = sparkScanView;
    }
    ...
    @Override // com.scandit.datacapture.barcode.internal.module.spark.data.InterfaceC13328h
    public void onCameraOnEnd() {
        final SparkScanView sparkScanView = this.f124917a;
