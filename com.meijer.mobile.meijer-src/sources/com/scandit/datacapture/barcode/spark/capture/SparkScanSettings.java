...
public final class SparkScanSettings implements SparkScanSettingsProxy {
    ...
    private final /* synthetic */ SparkScanSettingsProxyAdapter f124820a;
    ...
    public SparkScanSettings(NativeSparkScanSettings impl) {
        ...
        this.f124820a = new SparkScanSettingsProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    ...
    @NativeImpl
    /* renamed from: _impl */
    public NativeSparkScanSettings getF124822a() {
        return this.f124820a.getF124822a();
    }
    ...
    public void enableSymbologies(Set<? extends Symbology> symbologies) {
        ...
        this.f124820a.enableSymbologies(symbologies);
    }
    ...
    public SymbologySettings getSymbologySettings(Symbology symbology) {
        Intrinsics.j(symbology, "symbology");
        return this.f124820a.getSymbologySettings(symbology);
    }
    ...
    public void setScanIntention(ScanIntention scanIntention) {
        ...
        this.f124820a.setScanIntention(scanIntention);
    }
    ...
    public final /* synthetic */ void _applySettingsForScanningMode$scandit_barcode_capture(SparkScanScanningMode scanningMode) {
        ...
        getF124822a().updateForTargetModeEnabled(scanningMode instanceof SparkScanScanningMode.Target);
    }
    ...
    public final TimeInterval getCodeDuplicateFilter() {
        return TimeInterval.INSTANCE.millis(getF124822a().getCodeDuplicateFilterMilliseconds());
    }

    public final Object getProperty(String key) {
        Intrinsics.j(key, "key");
        Integer intProperty = getF124822a().getIntProperty(key);
        if (intProperty != null) {
            return intProperty;
        }
        Boolean boolProperty = getF124822a().getBoolProperty(key);
    ...
    public final void setCodeDuplicateFilter(TimeInterval value) {
        ...
        getF124822a().setCodeDuplicateFilterMilliseconds((int) value.asMillis());
    }
    ...
    public final void setProperty(String name, Object value) {
        ...
        if (value instanceof Float) {
            getF124822a().setFloatProperty(name, ((Number) value).floatValue());
            return;
        }
        if (value instanceof String) {
            getF124822a().setStringProperty(name, (String) value);
            return;
        }
        if (value instanceof Boolean) {
            getF124822a().setBoolProperty(name, ((Boolean) value).booleanValue());
            return;
        }
        Integer numIntFromAny = TypeConverter.INSTANCE.intFromAny(value);
        if (numIntFromAny != null) {
            getF124822a().setIntProperty(name, numIntFromAny.intValue());
        }
    }
