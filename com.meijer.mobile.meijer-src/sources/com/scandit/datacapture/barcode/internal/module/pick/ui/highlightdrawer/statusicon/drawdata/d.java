...
public final class d implements c {
    ...
    public final BarcodePickElementsCache f123638a;

    /* renamed from: b, reason: collision with root package name */
    public final Function1 f123639b;
    ...
    public d(com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.elementsprovider.f customViewCache, com.scandit.datacapture.barcode.internal.module.pick.ui.pickviewfactories.i quadrilateralMapper) {
        ...
        this.f123638a = customViewCache;
        this.f123639b = quadrilateralMapper;
    }
    ...
    public final a a(TrackedObject track, BarcodePickState pickState, BarcodePickState barcodePickState) {
        ...
        Quadrilateral quadrilateralBoundingBox = QuadrilateralUtilsKt.boundingBox((Quadrilateral) this.f123639b.invoke(track.getLocationIgnoringLicense$scandit_barcode_capture()));
        com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.elementsprovider.h hVar = (com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.elementsprovider.h) this.f123638a.a(track.getData(), pickState, barcodePickState);
        if (hVar == null || (view = hVar.f123720a) == null) {
