...
public final class x extends v {
    public x(Quadrilateral coordinates) {
        ...
        path.addCircle(center.getX(), center.getY(), ((Number) com.scandit.datacapture.barcode.internal.module.pick.ui.highlightdrawer.k.f123608b.getValue()).floatValue(), Path.Direction.CW);
