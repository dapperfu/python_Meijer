...
public final /* synthetic */ class l extends FunctionReferenceImpl implements Function2 {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        Iterator it = nVar.f123529e.keySet().iterator();
        boolean z10 = false;
        boolean z11 = false;
        while (true) {
            if (!it.hasNext()) {
            ...
            if (iIntValue2 != iIntValue) {
                if (z11 && (aVar = (a) nVar.f123529e.get(Integer.valueOf(iIntValue2))) != null && (vVar = aVar.f123501b) != null && (quadrilateral = vVar.f123542a) != null && QuadrilateralUtilsKt.contains(quadrilateral, p02)) {
                    break;
                }
            } else {
                z11 = true;
