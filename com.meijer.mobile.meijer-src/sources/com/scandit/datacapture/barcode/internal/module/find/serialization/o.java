...
public final class o {
    ...
    public final ArrayList f123102a = new ArrayList();
    ...
    public final BarcodeFindViewSettings a(JsonValue json) {
        ...
        NativeColor colorForKeyOrDefault = json.getF126782a().getColorForKeyOrDefault("inListItemColor", NativeColorExtensionsKt.toNativeColor(inListItemColor));
        ...
        NativeColor colorForKeyOrDefault2 = json.getF126782a().getColorForKeyOrDefault("notInListItemColor", NativeColorExtensionsKt.toNativeColor(notInListItemColor));
        ...
        NativeColor colorForKeyOrDefault3 = json.getF126782a().getColorForKeyOrDefault("progressBarStartColor", NativeColorExtensionsKt.toNativeColor(progressBarStartColor));
        ...
        NativeColor colorForKeyOrDefault4 = json.getF126782a().getColorForKeyOrDefault("progressBarFinishColor", NativeColorExtensionsKt.toNativeColor(progressBarFinishColor));
        ...
        if (screenSizeCategoryFromJson != null) {
            barcodeFindViewSettings2._setProperty("screenCategory", screenSizeCategoryFromJson.getF121956a());
        }
        this.f123102a.addAll(json._getWarnings());
