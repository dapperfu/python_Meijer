...
public final class j extends RelativeLayout {
    ...
    public final void a(int i10) {
        if (i10 <= 0) {
            this.f122640b.setText("0");
            this.f122640b.setVisibility(8);
            return;
        }
        this.f122640b.setVisibility(0);
        String strValueOf = String.valueOf(i10);
        if (strValueOf.length() > 3) {
            this.f122640b.setText(getResources().getString(R.string.sc_button_list_badge_max, Integer.valueOf(((int) Math.pow(10.0d, 3)) - 1)));
        } else {
            this.f122640b.setText(strValueOf);
        }
        ...
        TextView textView = this.f122640b;
        ...
        layoutParams.addRule(17, this.f122639a.getId());
        layoutParams.addRule(6, this.f122639a.getId());
