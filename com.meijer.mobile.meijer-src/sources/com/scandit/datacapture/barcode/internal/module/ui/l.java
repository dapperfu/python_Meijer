...
public final class l extends LinearLayout {
    ...
    public static final Lazy f124297e = LazyKt.b(k.f124296a);

    /* renamed from: a, reason: collision with root package name */
    public final ImageView f124298a;

    /* renamed from: b, reason: collision with root package name */
    public final s f124299b;

    /* renamed from: c, reason: collision with root package name */
    public final TextView f124300c;

    /* renamed from: d, reason: collision with root package name */
    public j f124301d;

    public final void a() {
        j userGuidanceState = j.f124291a;
    ...
    public l(Context context) {
        ...
        LinearLayout.LayoutParams layoutParams3 = new LinearLayout.LayoutParams(((Number) f124297e.getValue()).intValue(), -2);
        ...
        addView(textView);
        this.f124300c = textView;
    }

    public final void a(j userGuidanceState, String text) {
        Intrinsics.j(userGuidanceState, "userGuidanceState");
        Intrinsics.j(text, "text");
        this.f124301d = userGuidanceState;
        int iOrdinal = userGuidanceState.ordinal();
        if (iOrdinal == 0) {
            setVisibility(8);
        } else if (iOrdinal == 1) {
            setVisibility(0);
            this.f124298a.setVisibility(8);
            this.f124299b.setVisibility(0);
            int i10 = R.drawable.sc_ic_move_away_top;
            int i11 = R.drawable.sc_ic_move_away_mid;
            int i12 = R.drawable.sc_ic_move_away_bot;
            s sVar = this.f124299b;
            FS.Resources_setImageResource(sVar.f122733b, i10);
            FS.Resources_setImageResource(sVar.f122734c, i11);
            FS.Resources_setImageResource(sVar.f122735d, i12);
            s sVar2 = this.f124299b;
            r rVar = r.f122728b;
            sVar2.getClass();
            ...
            s sVar3 = this.f124299b;
            FS.Resources_setImageResource(sVar3.f122733b, i13);
            FS.Resources_setImageResource(sVar3.f122734c, i14);
            FS.Resources_setImageResource(sVar3.f122735d, i15);
            s sVar4 = this.f124299b;
            r rVar2 = r.f122727a;
            sVar4.getClass();
            Intrinsics.j(rVar2, "<set-?>");
            sVar4.f122732a = rVar2;
        } else if (iOrdinal == 3) {
            setVisibility(0);
            this.f124298a.setVisibility(8);
            this.f124299b.setVisibility(8);
        }
        this.f124300c.setText(text);
        this.f124299b.a();
    }
}
