...
public final class h implements j {
    ...
    public final WeakReference f123894a;

    public h(SparkScanInternal owner) {
        Intrinsics.j(owner, "owner");
        this.f123894a = new WeakReference(owner);
    }
    ...
    public final void onBarcodeScanned(SparkScanInternal sparkScan, SparkScanSession session, FrameData data) {
        ...
        SparkScanInternal sparkScanInternal = (SparkScanInternal) this.f123894a.get();
        if (sparkScanInternal == null || (copyOnWriteArraySet = sparkScanInternal.f123881c) == null) {
            return;
        }
