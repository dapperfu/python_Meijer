...
public final class C13213u extends FrameLayout {

    /* renamed from: a, reason: collision with root package name */
    public final ImageView f122435a;

    /* renamed from: b, reason: collision with root package name */
    public final Y f122436b;
    ...
    public final void a(Integer num, Integer num2, NativeBarcodeCountBasicOverlayColorScheme colorScheme) {
        ...
        if (num == null || num2 == null) {
            ImageView imageView = this.f122435a;
            if (imageView == null) {
                Intrinsics.x(BarcodePickDeserializer.FIELD_ICON);
                imageView = null;
            }
            imageView.setImageBitmap(null);
            ImageView imageView2 = this.f122435a;
            if (imageView2 == null) {
                Intrinsics.x(BarcodePickDeserializer.FIELD_ICON);
                imageView2 = null;
            }
            ...
            ImageView imageView3 = this.f122435a;
            if (imageView3 == null) {
                Intrinsics.x(BarcodePickDeserializer.FIELD_ICON);
                imageView3 = null;
            }
            FS.Resources_setImageResource(imageView3, num.intValue());
            ImageView imageView4 = this.f122435a;
            if (imageView4 == null) {
                Intrinsics.x(BarcodePickDeserializer.FIELD_ICON);
                imageView4 = null;
            }
    ...
    public C13213u(Context context) {
    ...
    public final void a(Integer num, NativeBarcodeCountBasicOverlayColorScheme colorScheme) {
        ...
        ImageView imageView5 = this.f122435a;
        if (imageView5 == null) {
            Intrinsics.x(BarcodePickDeserializer.FIELD_ICON);
            imageView5 = null;
        }
