...
public abstract class AbstractC13223f {
    public static boolean a(MotionEvent event, List items, Function1 onCluster) {
        ...
        while (it.hasNext()) {
            D d10 = (D) it.next();
            NativeCluster nativeCluster = d10.f122476a;
            if (nativeCluster != null) {
                float x10 = event.getX();
                float x11 = d10.f122479d.getX();
                Lazy lazy = j.f122490h;
                if (x10 >= x11 - ((Number) lazy.getValue()).intValue() && event.getX() <= d10.f122479d.getX() + ((Number) lazy.getValue()).intValue() && event.getY() >= d10.f122479d.getY() - ((Number) lazy.getValue()).intValue() && event.getY() <= d10.f122479d.getY() + ((Number) lazy.getValue()).intValue()) {
