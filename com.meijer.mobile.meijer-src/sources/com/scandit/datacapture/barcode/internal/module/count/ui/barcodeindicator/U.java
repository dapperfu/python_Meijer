...
public final class U implements S {
    ...
    public final DataCaptureView f122362b;

    /* renamed from: c, reason: collision with root package name */
    public final RectF f122363c = new RectF();
    ...
    public final V a(TrackedBarcode trackedBarcode) {
        ...
        DataCaptureView dataCaptureView = this.f122362b;
        ...
        DataCaptureView dataCaptureView2 = this.f122362b;
    ...
    public final float a(Quadrilateral quadrilateral) {
        ...
        S.f122360a.getClass();
        return RangesKt.n(fMin / ((Number) Q.f122359b.getValue()).floatValue(), 0.5f, 1.0f);
    }
}
