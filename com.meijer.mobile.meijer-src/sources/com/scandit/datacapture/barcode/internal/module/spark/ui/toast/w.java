...
public final class w extends FrameLayout {
    ...
    public final TextView f124233a;

    public final void a(String text, int i10, int i11) {
        Intrinsics.j(text, "text");
        this.f124233a.setText(text);
        ...
        this.f124233a.setTextColor(i11);
        if (getVisibility() == 4) {
            setAlpha(0.0f);
            setVisibility(0);
            a(1.0f, new v(this));
    ...
    public w(Context context) {
        ...
        for (int i10 = 0; i10 < 8; i10++) {
            fArr[i10] = ((Number) E.f123948z.getValue()).intValue();
        }
        ...
        this.f124233a = (TextView) viewFindViewById;
    }
