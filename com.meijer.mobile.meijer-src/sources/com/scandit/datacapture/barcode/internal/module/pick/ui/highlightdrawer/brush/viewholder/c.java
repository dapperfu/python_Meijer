...
public final class c implements b {
    ...
    public final a f123548a;

    /* renamed from: b, reason: collision with root package name */
    public com.scandit.datacapture.barcode.internal.module.pick.ui.highlightdrawer.brush.a f123549b;
    ...
    public c(View container, com.scandit.datacapture.barcode.internal.module.pick.ui.highlightdrawer.brush.a initialDrawData, j drawSettings, Paint tapPaint, Paint boundingBoxPaint) {
        ...
        this.f123548a = new a(context, initialDrawData, drawSettings, tapPaint, boundingBoxPaint);
        this.f123549b = initialDrawData;
    }
    ...
    public final void a(com.scandit.datacapture.barcode.internal.module.pick.ui.highlightdrawer.brush.a drawData) {
        ...
        BarcodePickState barcodePickState = this.f123549b.f123504e;
        this.f123549b = drawData;
        a aVar = this.f123548a;
        aVar.getClass();
        Intrinsics.j(drawData, "drawData");
        aVar.f123544a = drawData;
        aVar.invalidate();
        a aVar2 = this.f123548a;
        BarcodePickState barcodePickState2 = drawData.f123504e;
        Intrinsics.j(barcodePickState2, "<this>");
        aVar2.setElevation(PixelExtensionsKt.pxFromDp$default(g.f123604a[barcodePickState2.ordinal()] == 1 ? 6.0f : 5.0f, (Context) null, 1, (Object) null));
    }
}
