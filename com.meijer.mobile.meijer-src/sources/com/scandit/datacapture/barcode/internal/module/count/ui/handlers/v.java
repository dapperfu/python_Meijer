...
public final class v implements com.scandit.datacapture.barcode.internal.module.count.ui.cluster.r {
    ...
    public final WeakReference f122628a;

    public final void a(final int i10) {
        Handler handler;
        J j10 = (J) this.f122628a.get();
    ...
    public v(J owner) {
        ...
        this.f122628a = new WeakReference(owner);
    }
    ...
    public static final void a(v this$0, int i10) {
        ...
        J j10 = (J) this$0.f122628a.get();
        if (j10 == null || (tVar = j10.f122585s) == null || (barcodeCountView = (BarcodeCountView) ((com.scandit.datacapture.barcode.count.ui.view.i) tVar).f121810a.get()) == null || (barcodeIndicatorPresenter = barcodeCountView.f121789g) == null) {
            return;
        }
