...
public final class c implements BarcodePickElementsCache {
    ...
    public final BarcodePickViewHighlightStyleAsyncProvider f123698a;

    /* renamed from: b, reason: collision with root package name */
    public final com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.brushprovider.i f123699b;

    /* renamed from: c, reason: collision with root package name */
    public final com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.iconprovider.c f123700c;

    /* renamed from: d, reason: collision with root package name */
    public final boolean f123701d;

    /* renamed from: e, reason: collision with root package name */
    public final ReentrantReadWriteLock f123702e;

    /* renamed from: f, reason: collision with root package name */
    public final HashSet f123703f;

    /* renamed from: g, reason: collision with root package name */
    public final LinkedHashMap f123704g;

    /* renamed from: h, reason: collision with root package name */
    public final LinkedHashMap f123705h;

    /* renamed from: i, reason: collision with root package name */
    public final LinkedHashMap f123706i;
    ...
    public final i a(String str, BarcodePickState state, BarcodePickState barcodePickState) {
        ...
        ReentrantReadWriteLock.ReadLock lock = this.f123702e.readLock();
        lock.lock();
        try {
            if (str == null) {
                gVar = new g(this.f123700c.a(state), ((com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.brushprovider.j) this.f123699b).a(state), null);
            } else if (this.f123703f.contains(str)) {
                gVar = a(str, state);
            } else {
                gVar = (g) this.f123705h.get(new b(str, state));
                if (gVar == null) {
                    gVar = new g(this.f123700c.a(state), ((com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.brushprovider.j) this.f123699b).a(state), null);
                }
            }
    ...
    public c(BarcodePickViewHighlightStyleAsyncProvider barcodePickViewHighlightStyleAsyncProvider, com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.brushprovider.j brushProvider, com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.iconprovider.c iconProvider, boolean z10) {
        ...
        this.f123698a = barcodePickViewHighlightStyleAsyncProvider;
        this.f123699b = brushProvider;
        this.f123700c = iconProvider;
        this.f123701d = z10;
        this.f123702e = new ReentrantReadWriteLock(true);
        this.f123703f = new HashSet();
        this.f123704g = new LinkedHashMap();
        this.f123705h = new LinkedHashMap();
        this.f123706i = new LinkedHashMap();
    }

    /* JADX WARN: Finally extract failed */
    @Override // com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.elementsprovider.k
    public final void b(String str) {
        ReentrantReadWriteLock reentrantReadWriteLock = this.f123702e;
        ...
        writeLock.lock();
        try {
            if (CollectionsKt.h0(this.f123703f, str)) {
                a(str);
            } else if (str != null) {
                ReentrantReadWriteLock reentrantReadWriteLock2 = this.f123702e;
    ...
    public final void a(String itemData, String str, BarcodePickState state, com.scandit.datacapture.barcode.internal.module.pick.ui.highlightdrawer.c whenDone) {
        ...
        BarcodePickViewHighlightStyleAsyncProvider barcodePickViewHighlightStyleAsyncProvider = this.f123698a;
        ...
        try {
            ...
            if (this.f123701d && (this.f123705h.containsKey(bVar) || this.f123706i.containsKey(bVar))) {
                return;
            }
    ...
    public final g a(String str, BarcodePickState state) {
        ...
        g gVar = (g) this.f123704g.get(new b(str, state));
        if (gVar != null) {
            return gVar;
        }
        BarcodePickIcon barcodePickIconB = this.f123700c.b(state);
        if (Intrinsics.e(barcodePickIconB, m.f123733a)) {
            barcodePickIconB = this.f123700c.a(state);
        }
        com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.brushprovider.j jVar = (com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.brushprovider.j) this.f123699b;
        jVar.getClass();
        Intrinsics.j(state, "state");
        ...
        if (Intrinsics.e(pVar, com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.k.f123731b)) {
            pVar = ((com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.brushprovider.j) this.f123699b).a(state);
        }
