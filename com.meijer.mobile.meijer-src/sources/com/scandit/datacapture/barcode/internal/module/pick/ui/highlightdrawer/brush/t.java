...
public final class t extends v {
    public t(Quadrilateral coordinates) {
        ...
        path.addCircle(center.getX(), center.getY(), ((Number) com.scandit.datacapture.barcode.internal.module.pick.ui.highlightdrawer.k.f123607a.getValue()).floatValue(), Path.Direction.CW);
