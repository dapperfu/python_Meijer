...
public final class C13356c extends View {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C13356c(Context context) {
        super(context);
        ...
        gradientDrawable.setColor(com.scandit.datacapture.barcode.internal.module.spark.ui.E.f123922E);
