...
public final class InternalBarcodeCountSession {
    ...
    private final Function0 f122230a;

    /* renamed from: b, reason: collision with root package name */
    private final Lazy f122231b;

    public InternalBarcodeCountSession(Function0 getImpl) {
        Intrinsics.j(getImpl, "getImpl");
        this.f122230a = getImpl;
        this.f122231b = LazyKt.b(new l(this));
    }

    public final BarcodeSpatialGrid a(int i10, int i11) {
        NativeBarcodeSpatialGrid spatialMap = ((m) this.f122231b.getValue()).f122249a.getSpatialMap(i10, i11);
        if (spatialMap != null) {
    ...
    public final long b() {
        return ((m) this.f122231b.getValue()).f122249a.getFrameSeqIdAndroid();
    }

    public final boolean c() {
        return ((m) this.f122231b.getValue()).f122249a.hasScanningFailed();
    }

    public final Map d() {
        HashMap<Integer, NativeTrackedBarcode> trackedBarcodes = ((m) this.f122231b.getValue()).f122249a.getTrackedBarcodes();
    ...
    public final ArrayList e() {
        ArrayList<NativeBarcode> additionalBarcodes = ((NativeBarcodeCountSession) this.f122230a.invoke()).getAdditionalBarcodes();
    ...
    public final LinkedHashMap f() {
        HashMap<Integer, NativeTrackedBarcode> clearedBarcodes = ((NativeBarcodeCountSession) this.f122230a.invoke()).getClearedBarcodes();
    ...
    public final ArrayList g() {
        ArrayList<NativeCluster> clusters = ((NativeBarcodeCountSession) this.f122230a.invoke()).getClusters();
        ...
        for (NativeCluster nativeCluster : clusters) {
            ...
            Collection<NativeTrackedBarcode> collectionValues = ((NativeBarcodeCountSession) this.f122230a.invoke()).getTrackedBarcodes().values();
            Intrinsics.i(collectionValues, "<get-values>(...)");
            ArrayList<NativeTrackedBarcode> unscannedTrackedBarcodes = ((NativeBarcodeCountSession) this.f122230a.invoke()).getUnscannedTrackedBarcodes();
    ...
    public final ArrayList h() {
        Collection<NativeTrackedBarcode> collectionValues = ((NativeBarcodeCountSession) this.f122230a.invoke()).getFilteredTrackedBarcodes().values();
        Intrinsics.i(collectionValues, "<get-values>(...)");
    ...
    public final ArrayList j() {
        ArrayList<Integer> removedTrackedBarcodes = ((NativeBarcodeCountSession) this.f122230a.invoke()).getRemovedTrackedBarcodes();
        Intrinsics.i(removedTrackedBarcodes, "getRemovedTrackedBarcodes(...)");
        return removedTrackedBarcodes;
    }

    public final int k() {
        return ((NativeBarcodeCountSession) this.f122230a.invoke()).getScannedBarcodeCount();
    }
    ...
    public final void m() {
        ((m) this.f122231b.getValue()).f122249a.reset();
    }

    public final String n() {
        String json = ((m) this.f122231b.getValue()).f122249a.toJson();
        Intrinsics.g(json);
        return json;
    }

    public final NativeBarcodeCountSession a() {
        return (NativeBarcodeCountSession) this.f122230a.invoke();
    }
}
