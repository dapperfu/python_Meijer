...
public final class b implements d {
    ...
    public final Function0 f124376a;

    /* renamed from: b, reason: collision with root package name */
    public final Function0 f124377b;

    /* renamed from: c, reason: collision with root package name */
    public final Function0 f124378c;
    ...
    public b(Function0 referenceQuadGetter, Function0 anchorGetter, Function0 sizeGetter) {
        ...
        this.f124376a = referenceQuadGetter;
        this.f124377b = anchorGetter;
        this.f124378c = sizeGetter;
    }
    ...
    public final void a(View view, ViewGroup viewGroup) {
        ...
        Quadrilateral quadrilateral = (Quadrilateral) this.f124376a.invoke();
        if (quadrilateral == null) {
            return;
        }
        Anchor anchor = (Anchor) this.f124377b.invoke();
        Size2 size2 = (Size2) this.f124378c.invoke();
        if (size2 == null) {
            Intrinsics.j(view, "view");
