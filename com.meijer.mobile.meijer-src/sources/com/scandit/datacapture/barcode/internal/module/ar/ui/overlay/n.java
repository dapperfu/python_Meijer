...
public final class n extends Lambda implements Function1 {
    ...
    public final /* synthetic */ v f122177a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ TrackedBarcode f122178b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public n(v vVar, TrackedBarcode trackedBarcode) {
        super(1);
        this.f122177a = vVar;
        this.f122178b = trackedBarcode;
    }
    ...
    public final Object invoke(Object obj) {
        ...
        v vVar = this.f122177a;
        ReentrantReadWriteLock reentrantReadWriteLock = vVar.f122210k;
        TrackedBarcode trackedBarcode = this.f122178b;
