...
public final class e extends TrackedObjectAugmenter {
    ...
    public boolean f122222j;

    /* renamed from: k, reason: collision with root package name */
    public final d f122223k;
    ...
    public static void a(e eVar) {
        ...
        eVar.getHost().postDelayed(30L, eVar.f122223k);
    }
    ...
    public final void onHostAttachedToWindow() {
        this.f122222j = false;
        getHost().postDelayed(30L, this.f122223k);
    }
    ...
    public final void a(Augmentation augmentation) {
        ...
        Point anchorPositionIgnoringLicense = ((TrackedBarcode) augmentation.getTrackedObject()).getF121422a().getAnchorPositionIgnoringLicense(augmentation.getAnchor());
