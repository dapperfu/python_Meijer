...
public final class p extends LinearLayout {
    ...
    public static final Lazy f122056c = LazyKt.b(m.f122054a);

    /* renamed from: a, reason: collision with root package name */
    public final TextView f122057a;

    /* renamed from: b, reason: collision with root package name */
    public final ImageView f122058b;
    ...
    public p(Context context) {
        ...
        this.f122058b = imageView;
        TextView textView = new TextView(context);
        addView(textView, new LinearLayout.LayoutParams(-2, -2));
        this.f122057a = textView;
    }
    ...
    public final void a(final BarcodeArHeaderFooterElementDataHolder barcodeArHeaderFooterElementDataHolder) {
        ...
        TextView textView = this.f122057a;
        ...
        if (barcodeArHeaderFooterElementDataHolder.getIcon() != null) {
            ImageView imageView = this.f122058b;
            ...
            this.f122058b.setVisibility(0);
        } else {
            this.f122058b.setVisibility(8);
            this.f122058b.setImageDrawable(null);
        }
        ...
        ViewGroup.LayoutParams layoutParams = this.f122058b.getLayoutParams();
        ...
        if (!z10 && z11 && layoutParams2 != null) {
            int i10 = o.f122055a[barcodeArHeaderFooterElementDataHolder.getWidth().ordinal()];
            if (i10 == 1 || i10 == 2) {
