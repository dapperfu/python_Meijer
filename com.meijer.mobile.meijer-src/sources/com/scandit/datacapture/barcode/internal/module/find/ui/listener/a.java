...
public final class a extends Lambda implements Function1 {
    ...
    public final /* synthetic */ BarcodeFind f123183a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ NativeBarcodeFindSession f123184b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public a(BarcodeFind barcodeFind, NativeBarcodeFindSession nativeBarcodeFindSession) {
        super(1);
        this.f123183a = barcodeFind;
        this.f123184b = nativeBarcodeFindSession;
    }
    ...
    public final Object invoke(Object obj) {
        ...
        Intrinsics.j(it, "it");
        if (this.f123183a.getTransformer() == null) {
            return it;
        }
        NativeBarcodeFindSession nativeBarcodeFindSession = this.f123184b;
