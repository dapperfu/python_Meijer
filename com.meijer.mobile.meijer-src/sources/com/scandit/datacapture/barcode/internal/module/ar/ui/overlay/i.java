...
public final class i extends ViewBasedDataCaptureOverlay implements g, DataCaptureOverlay {
    ...
    public static final int f122162f = com.scandit.datacapture.barcode.internal.module.extensions.a.a(-16777216, (int) (RangesKt.n(0.3f, 0.0f, 1.0f) * l3.f93323c));

    /* renamed from: a, reason: collision with root package name */
    public final Function2 f122163a;

    /* renamed from: b, reason: collision with root package name */
    public final Function2 f122164b;

    /* renamed from: c, reason: collision with root package name */
    public final Function0 f122165c;

    /* renamed from: d, reason: collision with root package name */
    public final /* synthetic */ j f122166d;

    /* renamed from: e, reason: collision with root package name */
    public final View f122167e;
    ...
    public final void a() {
        setOnTouchListener(new View.OnTouchListener() { // from class: It.a
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return i.a(this.f15273a, view, motionEvent);
            }
        });
    }
    ...
    public i(Context context, com.scandit.datacapture.barcode.ar.ui.b onHighlightTap, com.scandit.datacapture.barcode.ar.ui.c onAnnotationOrElementTap, com.scandit.datacapture.barcode.ar.ui.d onOverlayTap) {
        ...
        this.f122163a = onHighlightTap;
        this.f122164b = onAnnotationOrElementTap;
        this.f122165c = onOverlayTap;
        ...
        this.f122166d = new j(nativeBarcodeArOverlayCreate);
        View view = new View(context);
        view.setBackgroundColor(f122162f);
    ...
    public static final boolean a(i this$0, View view, MotionEvent motionEvent) {
        ...
        return ((Boolean) this$0.f122165c.invoke()).booleanValue();
    }
    ...
    public final NativeDataCaptureOverlay getF121443c() {
        return this.f122166d.f122168a;
    }
    ...
    public final void a(final TrackedBarcode track, final BarcodeArAugmentation$Highlight highlightData) {
        ...
        viewB.setOnClickListener(new View.OnClickListener() { // from class: It.b
            ...
            public final void onClick(View view) {
                i.a(this.f15274a, track, highlightData, view);
            }
        });
        viewB.setZ(1.0f);
        addView(viewB);
    ...
    public static final void a(i this$0, TrackedBarcode track, BarcodeArAugmentation$Highlight highlightData, View view) {
        ...
        Intrinsics.j(track, "$track");
        Intrinsics.j(highlightData, "$highlightData");
        this$0.f122163a.invoke(track, highlightData);
    }
