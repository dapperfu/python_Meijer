...
public final class F implements A {
    ...
    public final BarcodeCountViewUiLayoutHelper f122820a;

    /* renamed from: b, reason: collision with root package name */
    public boolean f122821b;

    /* renamed from: c, reason: collision with root package name */
    public Function0 f122822c;

    /* renamed from: d, reason: collision with root package name */
    public com.scandit.datacapture.barcode.internal.module.count.ui.j f122823d;

    /* renamed from: e, reason: collision with root package name */
    public final z1 f122824e;

    public final void a(String value) {
        Intrinsics.j(value, "value");
        com.scandit.datacapture.barcode.internal.module.count.ui.j jVar = this.f122823d;
        if (jVar == null) {
            return;
        }
    ...
    public F(C13248h layoutHelper, RelativeLayout container) {
        Intrinsics.j(layoutHelper, "layoutHelper");
        Intrinsics.j(container, "container");
        this.f122820a = layoutHelper;
        BarcodeCountViewDefaults barcodeCountViewDefaults = BarcodeCountViewDefaults.INSTANCE;
        this.f122821b = barcodeCountViewDefaults.getShouldShowListButton();
        barcodeCountViewDefaults.getListButtonContentDescription();
        this.f122822c = D.f122812a;
        this.f122824e = new z1(container);
    }

    public static final void a(F this$0, View view) {
        Intrinsics.j(this$0, "this$0");
        this$0.f122822c.invoke();
    }

    @Override // com.scandit.datacapture.barcode.internal.module.count.ui.viewholders.InterfaceC13238c
    public final void b() {
        this.f122824e.b(this.f122823d, new C(this));
    }

    public final RelativeLayout.LayoutParams c() {
        Context context = ((RelativeLayout) this.f122824e.f123067a).getContext();
        Intrinsics.i(context, "getContext(...)");
        if (com.scandit.datacapture.barcode.internal.module.extensions.b.a(context)) {
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(AbstractC13236b.f122915a, -2);
            layoutParams.addRule(11);
            layoutParams.addRule(12);
            layoutParams.bottomMargin = this.f122820a.g();
            layoutParams.setMarginEnd(this.f122820a.a());
            return layoutParams;
        }
        ...
        layoutParams2.setMarginStart(this.f122820a.g());
        layoutParams2.bottomMargin = this.f122820a.a();
    ...
    public final void a() {
        com.scandit.datacapture.barcode.internal.module.count.ui.j jVar = this.f122823d;
        if (jVar != null) {
            jVar.setVisibility(this.f122821b ? 0 : 4);
        }
        com.scandit.datacapture.barcode.internal.module.count.ui.j jVar2 = this.f122823d;
        if (jVar2 == null) {
            return;
        }
    ...
    */
    public final void a(int r3, kotlin.jvm.functions.Function0 r4) {
        /*
            r2 = this;
            monitor-enter(r2)
            com.scandit.datacapture.barcode.internal.module.count.ui.j r0 = r2.f122823d     // Catch: java.lang.Throwable -> L1a
            if (r0 == 0) goto L23
            android.widget.TextView r0 = r0.f122640b     // Catch: java.lang.Throwable -> L1a
        ...
        L23:
            com.scandit.datacapture.barcode.internal.module.count.ui.j r0 = r2.f122823d     // Catch: java.lang.Throwable -> L1a
            if (r0 == 0) goto L34
            com.scandit.datacapture.barcode.internal.module.count.ui.viewholders.z1 r0 = r2.f122824e     // Catch: java.lang.Throwable -> L1a
            ...
            kotlin.Unit r3 = kotlin.Unit.f143329a     // Catch: java.lang.Throwable -> L1a
            goto L35
        L34:
            r3 = 0
        L35:
