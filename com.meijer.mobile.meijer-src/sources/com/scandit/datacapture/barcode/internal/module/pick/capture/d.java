...
public final class d implements com.scandit.datacapture.barcode.pick.capture.BarcodePickListener {
    ...
    public final WeakReference f123383a;

    public d(BarcodePickInternal owner) {
        Intrinsics.j(owner, "owner");
        this.f123383a = new WeakReference(owner);
    }
    ...
    public final void onObservationStarted(BarcodePick barcodePick) {
        ...
        BarcodePickInternal barcodePickInternal = (BarcodePickInternal) this.f123383a.get();
        if (barcodePickInternal == null || (copyOnWriteArraySet = barcodePickInternal.f123368h) == null) {
            return;
        }
