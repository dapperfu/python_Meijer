...
public final class S extends Lambda implements Function0 {
    ...
    public final /* synthetic */ SparkScanViewPresenter f123967a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ Function0 f123968b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public S(SparkScanViewPresenter sparkScanViewPresenter, U u10) {
        super(0);
        this.f123967a = sparkScanViewPresenter;
        this.f123968b = u10;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        SparkScanViewPresenter sparkScanViewPresenter = this.f123967a;
        SparkScanViewState sparkScanViewStateB = sparkScanViewPresenter.b();
        U u10 = (U) this.f123968b;
