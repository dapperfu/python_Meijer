...
public final class e extends Lambda implements Function4 {
    ...
    public final /* synthetic */ BarcodeCountBasicOverlay f122534a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(BarcodeCountBasicOverlay barcodeCountBasicOverlay) {
        super(4);
        this.f122534a = barcodeCountBasicOverlay;
    }
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3, Object obj4) {
        ...
        if (iOrdinal == 0) {
            ...
            if (iOrdinal2 == 0 || iOrdinal2 == 1) {
                this.f122534a.didTapScannedBarcode(barcode);
            } else if (iOrdinal2 == 2) {
                int i10 = d.f122533a[notInListStatus.ordinal()];
                if (i10 == 1) {
                    this.f122534a.didTapAcceptedBarcode(barcode);
                } else if (i10 != 2) {
                    this.f122534a.didTapNotInListBarcode(barcode);
                } else {
                    this.f122534a.didTapRejectedBarcode(barcode);
                }
            }
        } else if (iOrdinal == 1) {
            this.f122534a.didTapUnscannedBarcode(barcode);
        } else if (iOrdinal == 2) {
            this.f122534a.didTapFilteredBarcode(barcode);
        }
