...
public final class SubDrawable extends Drawable implements FSDraw {
    ...
    private final float f124446a;

    /* renamed from: b, reason: collision with root package name */
    private final float f124447b;

    /* renamed from: c, reason: collision with root package name */
    private final Path f124448c;

    /* renamed from: d, reason: collision with root package name */
    private final Paint f124449d;

    /* renamed from: e, reason: collision with root package name */
    private final Drawable f124450e;
    ...
    public SubDrawable(Context context) {
        ...
        this.f124446a = PixelExtensionsKt.pxFromDp(12.0f, context);
        this.f124447b = PixelExtensionsKt.pxFromDp(10.0f, context);
        this.f124448c = new Path();
        ...
        this.f124450e = drawableResources_getDrawable;
    }
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawPath(this.f124448c, this.f124449d);
        Drawable drawable = this.f124450e;
        if (drawable != null) {
            Rect bounds2 = drawable.getBounds();
            Intrinsics.i(bounds2, "getBounds(...)");
            float fWidth = bounds.width() - bounds2.width();
            float f10 = this.f124447b;
            canvas.save();
    ...
    public void getOutline(Outline outline) {
        ...
        outline.setRoundRect(0, 0, getBounds().width(), getBounds().height(), this.f124446a);
    }

    public final int getSubColor() {
        return this.f124449d.getColor();
    }
    ...
    protected void onBoundsChange(Rect bounds) {
        ...
        this.f124448c.rewind();
        Path path = this.f124448c;
        float f10 = this.f124446a;
