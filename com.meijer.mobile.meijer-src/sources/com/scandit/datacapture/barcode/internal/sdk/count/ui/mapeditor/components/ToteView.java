...
public final class ToteView extends FrameLayout {
    ...
    private final ToteDrawable f124464a;

    /* renamed from: b, reason: collision with root package name */
    private final TextView f124465b;

    /* renamed from: c, reason: collision with root package name */
    private final SubView f124466c;
    ...
    public final int getSubColor() {
        return this.f124466c.getColor();
    }

    public final int getToteColor() {
        return this.f124464a.getToteColor();
    }

    public final void hideSub() {
        this.f124466c.setAlpha(0.0f);
    }

    public final void setMainBarcode(String value) {
        Intrinsics.j(value, "value");
        this.mainBarcode = value;
        this.f124465b.setText(MapEditorUtils.INSTANCE.ellipsizeTextIfTooLong(value, 6));
    }

    public final void setSubBarcode(String str) {
        this.subBarcode = str;
        if (str == null || str.length() == 0) {
            this.f124466c.setText("");
            this.f124466c.setAlpha(0.0f);
        } else {
            this.f124466c.setText(str);
            this.f124466c.setAlpha(1.0f);
        }
    }

    public final void setSubColor(int i10) {
        this.f124466c.setColor(i10);
    }

    public final void setToteColor(int i10) {
        this.f124464a.setToteColor(i10);
        this.f124465b.setTextColor(MapEditorUtils.INSTANCE.uiElementColorOnBackground(i10));
    }
