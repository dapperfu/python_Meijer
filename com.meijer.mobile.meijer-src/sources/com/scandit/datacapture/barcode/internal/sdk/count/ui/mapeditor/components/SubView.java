...
public final class SubView extends FrameLayout {
    ...
    private final SubDrawable f124451a;

    /* renamed from: b, reason: collision with root package name */
    private final TextView f124452b;
    ...
    public final int getColor() {
        return this.f124451a.getSubColor();
    }
    ...
    public final void setColor(int i10) {
        this.f124451a.setSubColor(i10);
        this.f124452b.setTextColor(MapEditorUtils.INSTANCE.uiElementColorOnBackground(i10));
    }

    public final void setText(String value) {
        Intrinsics.j(value, "value");
        this.text = value;
        this.f124452b.setText(MapEditorUtils.INSTANCE.ellipsizeTextIfTooLong(value, 4));
    }
