...
public final class BinDrawable extends Drawable implements FSDraw {
    ...
    private final float f124400a;

    /* renamed from: b, reason: collision with root package name */
    private final float f124401b;

    /* renamed from: c, reason: collision with root package name */
    private final float f124402c;

    /* renamed from: d, reason: collision with root package name */
    private final float f124403d;

    /* renamed from: e, reason: collision with root package name */
    private final float f124404e;

    /* renamed from: f, reason: collision with root package name */
    private final Path f124405f;

    /* renamed from: g, reason: collision with root package name */
    private final Paint f124406g;
    ...
    public BinDrawable(Context context) {
        ...
        this.f124400a = fPxFromDp;
        this.f124401b = PixelExtensionsKt.pxFromDp(16.0f, context) - (fPxFromDp / 2.0f);
        this.f124402c = PixelExtensionsKt.pxFromDp(4.0f, context);
        this.f124403d = PixelExtensionsKt.pxFromDp(80.0f, context);
        this.f124404e = PixelExtensionsKt.pxFromDp(20.0f, context);
        this.f124405f = new Path();
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawPath(this.f124405f, this.f124406g);
    }
    ...
    protected void onBoundsChange(Rect bounds) {
        ...
        this.f124405f.rewind();
        Path path = this.f124405f;
        float f10 = this.f124400a / 2.0f;
        float f11 = iWidth;
        float f12 = iHeight - f10;
        float f13 = this.f124401b;
        path.addRoundRect(f10, f10, f11 - f10, f12, new float[]{f13, f13, f13, f13, f13, f13, f13, f13}, Path.Direction.CW);
        float f14 = (f11 - this.f124403d) / 2.0f;
        this.f124405f.moveTo(f14 - this.f124402c, this.f124400a);
        this.f124405f.lineTo(f14, this.f124404e);
        this.f124405f.lineTo(this.f124403d + f14, this.f124404e);
        this.f124405f.lineTo(f14 + this.f124403d + this.f124402c, this.f124400a);
    }
}
