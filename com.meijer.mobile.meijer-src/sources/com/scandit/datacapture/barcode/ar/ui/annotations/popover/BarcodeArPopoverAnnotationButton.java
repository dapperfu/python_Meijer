...
public final class BarcodeArPopoverAnnotationButton {
    ...
    private WeakReference f121308c;

    /* renamed from: d, reason: collision with root package name */
    private final BarcodeArPopoverAnnotationButton$special$$inlined$distinctObservable$1 f121309d;

    /* renamed from: e, reason: collision with root package name */
    private final BarcodeArPopoverAnnotationButton$special$$inlined$distinctObservable$2 f121310e;

    /* renamed from: f, reason: collision with root package name */
    private final BarcodeArPopoverAnnotationButton$special$$inlined$distinctObservable$3 f121311f;

    /* renamed from: g, reason: collision with root package name */
    private final BarcodeArPopoverAnnotationButton$special$$inlined$distinctObservable$4 f121312g;
    ...
    public BarcodeArPopoverAnnotationButton(ScanditIcon icon, String text) {
        ...
        this.icon = icon;
        this.text = text;
        this.f121308c = new WeakReference(a.f121317a);
        ...
        this.f121309d = new ObservableProperty<Float>(fValueOf) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.popover.BarcodeArPopoverAnnotationButton$special$$inlined$distinctObservable$1
        ...
        this.f121310e = new ObservableProperty<Typeface>(defaultBarcodeArPopoverAnnotationButtonTypeFace) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.popover.BarcodeArPopoverAnnotationButton$special$$inlined$distinctObservable$2
            @Override // kotlin.properties.ObservableProperty
        ...
        this.f121311f = new ObservableProperty<Integer>(numValueOf) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.popover.BarcodeArPopoverAnnotationButton$special$$inlined$distinctObservable$3
            @Override // kotlin.properties.ObservableProperty
        ...
        this.f121312g = new ObservableProperty<Boolean>(boolValueOf) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.popover.BarcodeArPopoverAnnotationButton$special$$inlined$distinctObservable$4
            @Override // kotlin.properties.ObservableProperty
    ...
    public static final void access$propertyChanged(BarcodeArPopoverAnnotationButton barcodeArPopoverAnnotationButton, Object obj) {
        Function0 function0 = (Function0) barcodeArPopoverAnnotationButton.f121308c.get();
        if (function0 != null) {
            function0.invoke();
        }
    }
    ...
    public final boolean getEnabled() {
        return getValue(this, f121305h[3]).booleanValue();
    }
    ...
    public final int getTextColor() {
        return getValue(this, f121305h[2]).intValue();
    }

    public final float getTextSize() {
        return getValue(this, f121305h[0]).floatValue();
    }

    public final Typeface getTypeface() {
        return getValue(this, f121305h[1]);
    }

    public final void setEnabled(boolean z10) {
        setValue(this, f121305h[3], Boolean.valueOf(z10));
    }

    public final void setPropertyChangedListener$scandit_barcode_capture(Function0<Unit> listener) {
        Intrinsics.j(listener, "listener");
        this.f121308c = new WeakReference(listener);
    }

    public final void setTextColor(int i10) {
        setValue(this, f121305h[2], Integer.valueOf(i10));
    }

    public final void setTextSize(float f10) {
        setValue(this, f121305h[0], Float.valueOf(f10));
    }

    public final void setTypeface(Typeface typeface) {
        Intrinsics.j(typeface, "<set-?>");
        setValue(this, f121305h[1], typeface);
    }
}
