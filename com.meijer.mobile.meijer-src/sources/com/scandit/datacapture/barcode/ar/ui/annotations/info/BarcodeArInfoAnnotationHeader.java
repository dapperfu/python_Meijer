...
public final class BarcodeArInfoAnnotationHeader {
    ...
    static final /* synthetic */ KProperty[] f121279h = {com.scandit.datacapture.barcode.ar.ui.annotations.a.a(BarcodeArInfoAnnotationHeader.class, "text", "getText()Ljava/lang/String;", 0), com.scandit.datacapture.barcode.ar.ui.annotations.a.a(BarcodeArInfoAnnotationHeader.class, BarcodePickDeserializer.FIELD_ICON, "getIcon()Lcom/scandit/datacapture/core/ui/icon/ScanditIcon;", 0), com.scandit.datacapture.barcode.ar.ui.annotations.a.a(BarcodeArInfoAnnotationHeader.class, "textSize", "getTextSize()F", 0), com.scandit.datacapture.barcode.ar.ui.annotations.a.a(BarcodeArInfoAnnotationHeader.class, "typeface", "getTypeface()Landroid/graphics/Typeface;", 0), com.scandit.datacapture.barcode.ar.ui.annotations.a.a(BarcodeArInfoAnnotationHeader.class, "textColor", "getTextColor()I", 0), com.scandit.datacapture.barcode.ar.ui.annotations.a.a(BarcodeArInfoAnnotationHeader.class, "backgroundColor", "getBackgroundColor()I", 0)};

    /* renamed from: a, reason: collision with root package name */
    private WeakReference f121280a = new WeakReference(c.f121297a);

    /* renamed from: b, reason: collision with root package name */
    private final BarcodeArInfoAnnotationHeader$special$$inlined$distinctObservable$1 f121281b;

    /* renamed from: c, reason: collision with root package name */
    private final BarcodeArInfoAnnotationHeader$special$$inlined$distinctObservable$2 f121282c;

    /* renamed from: d, reason: collision with root package name */
    private final BarcodeArInfoAnnotationHeader$special$$inlined$distinctObservable$3 f121283d;

    /* renamed from: e, reason: collision with root package name */
    private final BarcodeArInfoAnnotationHeader$special$$inlined$distinctObservable$4 f121284e;

    /* renamed from: f, reason: collision with root package name */
    private final BarcodeArInfoAnnotationHeader$special$$inlined$distinctObservable$5 f121285f;

    /* renamed from: g, reason: collision with root package name */
    private final BarcodeArInfoAnnotationHeader$special$$inlined$distinctObservable$6 f121286g;
    ...
    public static final void access$propertyChanged(BarcodeArInfoAnnotationHeader barcodeArInfoAnnotationHeader, Object obj) {
        Function0 function0 = (Function0) barcodeArInfoAnnotationHeader.f121280a.get();
        if (function0 != null) {
            function0.invoke();
        }
    }
    ...
    public final int getBackgroundColor() {
        return getValue(this, f121279h[5]).intValue();
    }

    public final ScanditIcon getIcon() {
        return getValue(this, f121279h[1]);
    }

    public final String getText() {
        return getValue(this, f121279h[0]);
    }

    public final int getTextColor() {
        return getValue(this, f121279h[4]).intValue();
    }

    public final float getTextSize() {
        return getValue(this, f121279h[2]).floatValue();
    }

    public final Typeface getTypeface() {
        return getValue(this, f121279h[3]);
    }

    public final void setBackgroundColor(int i10) {
        setValue(this, f121279h[5], Integer.valueOf(i10));
    }

    public final void setIcon(ScanditIcon scanditIcon) {
        setValue(this, f121279h[1], scanditIcon);
    }

    public final void setPropertyChangedListener$scandit_barcode_capture(Function0<Unit> listener) {
        Intrinsics.j(listener, "listener");
        this.f121280a = new WeakReference(listener);
    }

    public final void setText(String str) {
        setValue(this, f121279h[0], str);
    }

    public final void setTextColor(int i10) {
        setValue(this, f121279h[4], Integer.valueOf(i10));
    }

    public final void setTextSize(float f10) {
        setValue(this, f121279h[2], Float.valueOf(f10));
    }

    public final void setTypeface(Typeface typeface) {
        Intrinsics.j(typeface, "<set-?>");
        setValue(this, f121279h[3], typeface);
    }
    ...
    public BarcodeArInfoAnnotationHeader() {
        ...
        this.f121281b = new ObservableProperty<String>(defaultInfoAnnotationHeaderText) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.info.BarcodeArInfoAnnotationHeader$special$$inlined$distinctObservable$1
        ...
        this.f121282c = new ObservableProperty<ScanditIcon>(defaultInfoAnnotationHeaderIcon) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.info.BarcodeArInfoAnnotationHeader$special$$inlined$distinctObservable$2
            @Override // kotlin.properties.ObservableProperty
        ...
        this.f121283d = new ObservableProperty<Float>(fValueOf) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.info.BarcodeArInfoAnnotationHeader$special$$inlined$distinctObservable$3
            @Override // kotlin.properties.ObservableProperty
        ...
        this.f121284e = new ObservableProperty<Typeface>(defaultInfoAnnotationHeaderTypeface) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.info.BarcodeArInfoAnnotationHeader$special$$inlined$distinctObservable$4
            @Override // kotlin.properties.ObservableProperty
        ...
        this.f121285f = new ObservableProperty<Integer>(numValueOf) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.info.BarcodeArInfoAnnotationHeader$special$$inlined$distinctObservable$5
            @Override // kotlin.properties.ObservableProperty
        ...
        this.f121286g = new ObservableProperty<Integer>(numValueOf2) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.info.BarcodeArInfoAnnotationHeader$special$$inlined$distinctObservable$6
            @Override // kotlin.properties.ObservableProperty
            protected void afterChange(KProperty<?> property, Integer oldValue, Integer newValue) {
                Intrinsics.j(property, "property");
                if (Intrinsics.e(oldValue, newValue)) {
