...
public final class BarcodeArRectangleHighlight implements BarcodeArHighlight {
    ...
    private static final Lazy f121343f = LazyKt.b(d.f121354a);

    /* renamed from: g, reason: collision with root package name */
    private static final Lazy f121344g = LazyKt.b(c.f121353a);

    /* renamed from: h, reason: collision with root package name */
    private static final Lazy f121345h = LazyKt.b(b.f121352a);

    /* renamed from: a, reason: collision with root package name */
    private final Context f121346a;
    ...
    private GradientDrawable f121350e;
    ...
    public static final class Companion {
        ...
        public static final int access$getICON_SIZE(Companion companion) {
            companion.getClass();
            return ((Number) BarcodeArRectangleHighlight.f121345h.getValue()).intValue();
        }

        public final float getMIN_HEIGHT$scandit_barcode_capture() {
            return ((Number) BarcodeArRectangleHighlight.f121344g.getValue()).floatValue();
        }

        public final float getMIN_WIDTH$scandit_barcode_capture() {
            return ((Number) BarcodeArRectangleHighlight.f121343f.getValue()).floatValue();
        }
    }
    ...
    public BarcodeArRectangleHighlight(Context context, Barcode barcode) {
        ...
        this.f121350e = gradientDrawable;
    }

    @Override // com.scandit.datacapture.barcode.ar.ui.highlight.BarcodeArHighlight
    public View createView() {
        RelativeLayout relativeLayout = new RelativeLayout(this.f121346a);
        relativeLayout.setBackground(this.f121350e);
    ...
    public void update(View view, Quadrilateral barcodeLocation) {
        ...
        view.setBackground(this.f121350e);
        ScanditIcon scanditIcon = this.icon;
        if (scanditIcon != null) {
            ((ImageView) view.findViewById(R.id.sc_ar_rectangle_highlight_icon)).setImageDrawable(ScanditIconUtilsKt.getDrawable(scanditIcon, this.f121346a));
        }
