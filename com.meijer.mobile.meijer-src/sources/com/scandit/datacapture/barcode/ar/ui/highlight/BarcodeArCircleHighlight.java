...
public final class BarcodeArCircleHighlight implements BarcodeArHighlight {
    ...
    private final Context f121331a;
    ...
    private GradientDrawable f121337g;
    ...
    private static final Lazy f121330j = LazyKt.b(a.f121351a);
    ...
    public static final class Companion {
        ...
        public final int getADDED_PULSE_SIZE$scandit_barcode_capture() {
            return ((Number) BarcodeArCircleHighlight.f121330j.getValue()).intValue();
        }
    }
    ...
    public BarcodeArCircleHighlight(Context context, Barcode barcode, BarcodeArCircleHighlightPreset preset) {
        ...
        this.f121337g = gradientDrawable;
    ...
    public View createView() {
        FrameLayout container = new FrameLayout(this.f121331a);
        container.setBackground(this.f121337g);
    ...
    public void update(View view, Quadrilateral barcodeLocation) {
        ...
        view.setBackground(this.f121337g);
