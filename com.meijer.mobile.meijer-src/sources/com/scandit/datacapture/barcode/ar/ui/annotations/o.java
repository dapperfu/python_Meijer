...
public final class o extends Lambda implements Function0 {
    ...
    public final /* synthetic */ BarcodeArInfoAnnotation f121301a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o(BarcodeArInfoAnnotation barcodeArInfoAnnotation) {
        super(0);
        this.f121301a = barcodeArInfoAnnotation;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        Function0<Unit> onAnnotationOrElementTap$scandit_barcode_capture = this.f121301a.getOnAnnotationOrElementTap$scandit_barcode_capture();
