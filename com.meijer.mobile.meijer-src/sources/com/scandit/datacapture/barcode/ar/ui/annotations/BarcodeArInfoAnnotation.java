...
public final class BarcodeArInfoAnnotation implements BarcodeArAnnotation {
    ...
    static final /* synthetic */ KProperty[] f121167w = {a.a(BarcodeArInfoAnnotation.class, "body", "getBody()Ljava/util/List;", 0), a.a(BarcodeArInfoAnnotation.class, "backgroundColor", "getBackgroundColor()I", 0), a.a(BarcodeArInfoAnnotation.class, "width", "getWidth()Lcom/scandit/datacapture/barcode/ar/ui/annotations/info/BarcodeArInfoAnnotationWidthPreset;", 0), a.a(BarcodeArInfoAnnotation.class, "hasTip", "getHasTip()Z", 0), a.a(BarcodeArInfoAnnotation.class, "anchor", "getAnchor()Lcom/scandit/datacapture/barcode/ar/ui/annotations/info/BarcodeArInfoAnnotationAnchor;", 0), a.a(BarcodeArInfoAnnotation.class, "header", "getHeader()Lcom/scandit/datacapture/barcode/ar/ui/annotations/info/BarcodeArInfoAnnotationHeader;", 0), a.a(BarcodeArInfoAnnotation.class, "footer", "getFooter()Lcom/scandit/datacapture/barcode/ar/ui/annotations/info/BarcodeArInfoAnnotationFooter;", 0), a.a(BarcodeArInfoAnnotation.class, "isEntireAnnotationTappable", "isEntireAnnotationTappable()Z", 0)};

    /* renamed from: a, reason: collision with root package name */
    private final Context f121168a;
    ...
    private final BarcodeArInfoAnnotation$special$$inlined$distinctObservable$1 f121174g;

    /* renamed from: h, reason: collision with root package name */
    private final BarcodeArInfoAnnotation$special$$inlined$distinctObservable$2 f121175h;

    /* renamed from: i, reason: collision with root package name */
    private final BarcodeArInfoAnnotation$special$$inlined$distinctObservable$3 f121176i;

    /* renamed from: j, reason: collision with root package name */
    private final BarcodeArInfoAnnotation$special$$inlined$distinctObservable$4 f121177j;

    /* renamed from: k, reason: collision with root package name */
    private final BarcodeArInfoAnnotation$special$$inlined$distinctObservable$5 f121178k;

    /* renamed from: l, reason: collision with root package name */
    private final BarcodeArInfoAnnotation$special$$inlined$distinctObservable$6 f121179l;

    /* renamed from: m, reason: collision with root package name */
    private final BarcodeArInfoAnnotation$special$$inlined$distinctObservable$7 f121180m;

    /* renamed from: n, reason: collision with root package name */
    private final com.scandit.datacapture.barcode.internal.module.ar.ui.annotations.info.j f121181n;
    ...
    private final BarcodeArInfoAnnotation$special$$inlined$distinctObservable$8 f121184q;

    /* renamed from: r, reason: collision with root package name and from kotlin metadata */
    private BarcodeArAnnotationTrigger annotationTrigger;

    /* renamed from: s, reason: collision with root package name */
    private final i f121186s;

    /* renamed from: t, reason: collision with root package name */
    private final l f121187t;

    /* renamed from: u, reason: collision with root package name */
    private final k f121188u;

    /* renamed from: v, reason: collision with root package name */
    private final j f121189v;
    ...
    public BarcodeArInfoAnnotation(Context context, Barcode barcode) {
        ...
        this.f121168a = context;
        this.barcode = barcode;
        this.recreateCommon = true;
        final List listM = CollectionsKt.m();
        Delegates delegates = Delegates.f143781a;
        this.f121174g = new ObservableProperty<List<? extends BarcodeArInfoAnnotationBodyComponent>>(listM) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.BarcodeArInfoAnnotation$special$$inlined$distinctObservable$1
            ...
            protected void afterChange(KProperty<?> property, List<? extends BarcodeArInfoAnnotationBodyComponent> oldValue, List<? extends BarcodeArInfoAnnotationBodyComponent> newValue) {
                ...
                this.f121186s.invoke();
                Iterator<T> it = newValue.iterator();
                while (it.hasNext()) {
                    ((BarcodeArInfoAnnotationBodyComponent) it.next()).setPropertyChangedListener$scandit_barcode_capture(this.f121186s);
                }
            }
        };
        final Integer numValueOf = Integer.valueOf(BarcodeArViewDefaults.getDefaultInfoAnnotationBackgroundColor());
        this.f121175h = new ObservableProperty<Integer>(numValueOf) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.BarcodeArInfoAnnotation$special$$inlined$distinctObservable$2
            @Override // kotlin.properties.ObservableProperty
        ...
        this.f121176i = new ObservableProperty<BarcodeArInfoAnnotationWidthPreset>(defaultInfoAnnotationWidth) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.BarcodeArInfoAnnotation$special$$inlined$distinctObservable$3
            @Override // kotlin.properties.ObservableProperty
            protected void afterChange(KProperty<?> property, BarcodeArInfoAnnotationWidthPreset oldValue, BarcodeArInfoAnnotationWidthPreset newValue) {
                ...
                this.f121189v.invoke();
                this.f121186s.invoke();
                this.f121187t.invoke();
                this.f121188u.invoke();
            }
        };
        final Boolean boolValueOf = Boolean.valueOf(BarcodeArViewDefaults.getDefaultInfoAnnotationHasTip());
        this.f121177j = new ObservableProperty<Boolean>(boolValueOf) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.BarcodeArInfoAnnotation$special$$inlined$distinctObservable$4
            @Override // kotlin.properties.ObservableProperty
        ...
        this.f121178k = new ObservableProperty<BarcodeArInfoAnnotationAnchor>(defaultInfoAnnotationAnchor) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.BarcodeArInfoAnnotation$special$$inlined$distinctObservable$5
            @Override // kotlin.properties.ObservableProperty
        ...
        this.f121179l = new ObservableProperty<BarcodeArInfoAnnotationHeader>(obj) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.BarcodeArInfoAnnotation$special$$inlined$distinctObservable$6
            @Override // kotlin.properties.ObservableProperty
            protected void afterChange(KProperty<?> property, BarcodeArInfoAnnotationHeader oldValue, BarcodeArInfoAnnotationHeader newValue) {
                ...
                if (barcodeArInfoAnnotationHeader != null) {
                    barcodeArInfoAnnotationHeader.setPropertyChangedListener$scandit_barcode_capture(this.f121187t);
                }
            }
        };
        this.f121180m = new ObservableProperty<BarcodeArInfoAnnotationFooter>(obj) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.BarcodeArInfoAnnotation$special$$inlined$distinctObservable$7
            @Override // kotlin.properties.ObservableProperty
            protected void afterChange(KProperty<?> property, BarcodeArInfoAnnotationFooter oldValue, BarcodeArInfoAnnotationFooter newValue) {
                ...
                if (barcodeArInfoAnnotationFooter != null) {
                    barcodeArInfoAnnotationFooter.setPropertyChangedListener$scandit_barcode_capture(this.f121188u);
                }
            }
        };
        this.f121181n = new com.scandit.datacapture.barcode.internal.module.ar.ui.annotations.info.j(new MutablePropertyReference0Impl(this) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.n
        ...
        this.f121184q = new ObservableProperty<Boolean>(boolValueOf2) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.BarcodeArInfoAnnotation$special$$inlined$distinctObservable$8
            @Override // kotlin.properties.ObservableProperty
            protected void afterChange(KProperty<?> property, Boolean oldValue, Boolean newValue) {
                Intrinsics.j(property, "property");
                if (Intrinsics.e(oldValue, newValue)) {
        ...
        this.f121186s = new i(this);
        this.f121187t = new l(this);
        this.f121188u = new k(this);
        this.f121189v = new j(this);
    }
    ...
    public static final void access$bodyElementIconTapped(BarcodeArInfoAnnotation barcodeArInfoAnnotation, boolean z10, int i10, BarcodeArInfoAnnotationBodyComponent barcodeArInfoAnnotationBodyComponent) {
        if (z10) {
            barcodeArInfoAnnotation.f121181n.onInfoAnnotationLeftIconTapped(barcodeArInfoAnnotation, barcodeArInfoAnnotationBodyComponent, i10);
        } else {
            barcodeArInfoAnnotation.f121181n.onInfoAnnotationRightIconTapped(barcodeArInfoAnnotation, barcodeArInfoAnnotationBodyComponent, i10);
        }
    }
    ...
    public static final void access$headerOrFooterTapped(BarcodeArInfoAnnotation barcodeArInfoAnnotation, boolean z10) {
        if (z10) {
            barcodeArInfoAnnotation.f121181n.onInfoAnnotationHeaderTapped(barcodeArInfoAnnotation);
        } else {
            barcodeArInfoAnnotation.f121181n.onInfoAnnotationFooterTapped(barcodeArInfoAnnotation);
        }
    }

    @Override // com.scandit.datacapture.barcode.ar.ui.annotations.BarcodeArAnnotation
    public View createView() {
        Context context = this.f121168a;
        b bVar = new b(this);
        Context context2 = this.f121168a;
        ...
        Context context3 = this.f121168a;
        ...
        Context context4 = this.f121168a;
    ...
    public final BarcodeArInfoAnnotationAnchor getAnchor() {
        return getValue(this, f121167w[4]);
    }
    ...
    public final int getBackgroundColor() {
        return getValue(this, f121167w[1]).intValue();
    }
    ...
    public final List<BarcodeArInfoAnnotationBodyComponent> getBody() {
        return (List) getValue(this, f121167w[0]);
    }

    public final BarcodeArInfoAnnotationFooter getFooter() {
        return getValue(this, f121167w[6]);
    }

    public final boolean getHasTip() {
        return getValue(this, f121167w[3]).booleanValue();
    }

    public final BarcodeArInfoAnnotationHeader getHeader() {
        return getValue(this, f121167w[5]);
    }
    ...
    public final BarcodeArInfoAnnotationWidthPreset getWidth() {
        return getValue(this, f121167w[2]);
    }

    public final boolean isEntireAnnotationTappable() {
        return getValue(this, f121167w[7]).booleanValue();
    }
    ...
    public final void setAnchor(BarcodeArInfoAnnotationAnchor barcodeArInfoAnnotationAnchor) {
        ...
        setValue(this, f121167w[4], barcodeArInfoAnnotationAnchor);
    }
    ...
    public final void setWidth(BarcodeArInfoAnnotationWidthPreset barcodeArInfoAnnotationWidthPreset) {
        ...
        setValue(this, f121167w[2], barcodeArInfoAnnotationWidthPreset);
    }
    ...
    */
    public void update(com.scandit.datacapture.core.common.geometry.Quadrilateral r8, com.scandit.datacapture.core.common.geometry.Quadrilateral r9, android.view.View r10) {
        ...
        L5b:
            ...
            goto Lc8
        L5e:
            com.scandit.datacapture.barcode.internal.module.ui.viewpositioner.b r1 = r10.f122086p
            r1.a(r10, r8)
            com.scandit.datacapture.barcode.internal.module.ar.ui.annotations.tip.a r8 = r10.f122076f
            ...
            int[] r0 = com.scandit.datacapture.barcode.internal.module.ar.ui.annotations.tip.b.f122133a
            int r2 = r1.ordinal()
            r0 = r0[r2]
            r2 = 1
            if (r0 == r2) goto Lac
