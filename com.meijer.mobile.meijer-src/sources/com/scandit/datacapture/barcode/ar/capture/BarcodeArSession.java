...
public final class BarcodeArSession implements BarcodeArSessionProxy {
    ...
    private final Function0 f121047a;

    /* renamed from: b, reason: collision with root package name */
    private final Lazy f121048b;

    public BarcodeArSession(Function0<? extends NativeBarcodeArSession> getImpl) {
        Intrinsics.j(getImpl, "getImpl");
        this.f121047a = getImpl;
        this.f121048b = LazyKt.b(new c(this));
    }
    ...
    public List<TrackedBarcode> getAddedTrackedBarcodes() {
        return ((BarcodeArSessionProxyAdapter) this.f121048b.getValue()).getAddedTrackedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.ar.capture.BarcodeArSessionProxy
    public List<Integer> getRemovedTrackedBarcodes() {
        return ((BarcodeArSessionProxyAdapter) this.f121048b.getValue()).getRemovedTrackedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.ar.capture.BarcodeArSessionProxy
    public Map<Integer, TrackedBarcode> getTrackedBarcodes() {
        return ((BarcodeArSessionProxyAdapter) this.f121048b.getValue()).getTrackedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.ar.capture.BarcodeArSessionProxy
    public void reset() {
        ((BarcodeArSessionProxyAdapter) this.f121048b.getValue()).reset();
    }

    @Override // com.scandit.datacapture.barcode.ar.capture.BarcodeArSessionProxy
    public String toJson() {
        return ((BarcodeArSessionProxyAdapter) this.f121048b.getValue()).toJson();
    }
}
