...
public final class BarcodeArSettings implements BarcodeArSettingsProxy {
    ...
    private final /* synthetic */ BarcodeArSettingsProxyAdapter f121051a;
    ...
    public NativeBarcodeArSettings getF121052a() {
        return this.f121051a.getF121052a();
    }
    ...
    public void enableSymbologies(Set<? extends Symbology> symbologies) {
        ...
        this.f121051a.enableSymbologies(symbologies);
    }
    ...
    public void enableSymbology(Symbology symbology, boolean enabled) {
        ...
        this.f121051a.enableSymbology(symbology, enabled);
    }

    @Override // com.scandit.datacapture.barcode.ar.capture.BarcodeArSettingsProxy
    @ProxyFunction(property = "enabledSymbologies")
    public Set<Symbology> getEnabledSymbologies() {
        return this.f121051a.getEnabledSymbologies();
    }
    ...
    public boolean getExpectsOnlyUniqueBarcodes() {
        return this.f121051a.getExpectsOnlyUniqueBarcodes();
    }
    ...
    public SymbologySettings getSymbologySettings(Symbology symbology) {
        Intrinsics.j(symbology, "symbology");
        return this.f121051a.getSymbologySettings(symbology);
    }
    ...
    public void setExpectsOnlyUniqueBarcodes(boolean z10) {
        this.f121051a.setExpectsOnlyUniqueBarcodes(z10);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private BarcodeArSettings(NativeBarcodeArSettings nativeBarcodeArSettings) {
        this.f121051a = new BarcodeArSettingsProxyAdapter(nativeBarcodeArSettings, null, 2, 0 == true ? 1 : 0);
    }

    public final Object getProperty(String name) {
        Intrinsics.j(name, "name");
        Integer intProperty = getF121052a().getIntProperty(name);
        if (intProperty != null) {
            return intProperty;
        }
        Boolean boolProperty = getF121052a().getBoolProperty(name);
    ...
    public final void setProperty(String name, Object value) {
        ...
        if (value instanceof Boolean) {
            getF121052a().setBoolProperty(name, ((Boolean) value).booleanValue());
            return;
        }
        Integer numIntFromAny = TypeConverter.INSTANCE.intFromAny(value);
        if (numIntFromAny != null) {
            getF121052a().setIntProperty(name, numIntFromAny.intValue());
        }
    }
