...
public final class BarcodeArDeserializerProxyAdapter implements BarcodeArDeserializerProxy {
    ...
    private final NativeBarcodeArDeserializer f121066a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeDataCaptureModeDeserializer f121068c;
    ...
    public BarcodeArDeserializerProxyAdapter(NativeBarcodeArDeserializer _NativeBarcodeArDeserializer, ProxyCache proxyCache) {
        ...
        this.f121066a = _NativeBarcodeArDeserializer;
        ...
        this.f121068c = nativeDataCaptureModeDeserializerAsDataCaptureModeDeserializer;
    }

    @Override // com.scandit.datacapture.barcode.ar.serialization.BarcodeArDeserializerProxy
    /* renamed from: _impl, reason: from getter */
    public NativeBarcodeArDeserializer getF121066a() {
    ...
    public BarcodeAr _modeFromJson(DataCaptureContext context, String json) {
        ...
        NativeBarcodeAr nativeBarcodeArBarcodeArFromJson = this.f121066a.barcodeArFromJson(nativeDataCaptureContext_impl, CoreNativeTypeFactory.INSTANCE.convert(json));
    ...
    public BarcodeArSettings _settingsFromJson(String json) {
        Intrinsics.j(json, "json");
        NativeBarcodeArSettings nativeBarcodeArSettings = this.f121066a.settingsFromJson(CoreNativeTypeFactory.INSTANCE.convert(json));
    ...
    public BarcodeAr _updateModeFromJson(BarcodeAr mode, String json) {
        ...
        Intrinsics.j(json, "json");
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
        NativeBarcodeAr nativeBarcodeArUpdateBarcodeArFromJson = this.f121066a.updateBarcodeArFromJson(barcodeNativeTypeFactory.convert(mode), CoreNativeTypeFactory.INSTANCE.convert(json));
    ...
    public BarcodeArSettings _updateSettingsFromJson(BarcodeArSettings settings, String json) {
        ...
        Intrinsics.j(json, "json");
        NativeBarcodeArSettings f121052a = settings.getF121052a();
        this.proxyCache.put(Reflection.b(NativeBarcodeArSettings.class), null, f121052a, settings);
        NativeBarcodeArSettings nativeBarcodeArSettingsUpdateSettingsFromJson = this.f121066a.updateSettingsFromJson(f121052a, CoreNativeTypeFactory.INSTANCE.convert(json));
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeBarcodeArSettings.class);
    ...
    public BarcodeArDeserializerHelper get_helper() {
        return (BarcodeArDeserializerHelper) this.proxyCache.requireByValue(Reflection.b(BarcodeArDeserializerHelper.class), this.f121066a.getHelper());
    }
