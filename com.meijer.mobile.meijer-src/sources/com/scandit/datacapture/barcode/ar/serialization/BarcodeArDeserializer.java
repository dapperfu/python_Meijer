...
public final class BarcodeArDeserializer implements BarcodeArDeserializerProxy {
    ...
    private final BarcodeArDeserializerHelper f121060a;

    /* renamed from: b, reason: collision with root package name */
    private final /* synthetic */ BarcodeArDeserializerProxyAdapter f121061b;
    ...
    public NativeBarcodeArDeserializer getF121066a() {
        return this.f121061b.getF121066a();
    }
    ...
    public NativeDataCaptureModeDeserializer getF121068c() {
        return this.f121061b.getF121068c();
    }
    ...
    public BarcodeAr _modeFromJson(DataCaptureContext context, String json) {
        ...
        return this.f121061b._modeFromJson(context, json);
    }
    ...
    public BarcodeArSettings _settingsFromJson(String json) {
        Intrinsics.j(json, "json");
        return this.f121061b._settingsFromJson(json);
    }
    ...
    public BarcodeAr _updateModeFromJson(BarcodeAr mode, String json) {
        ...
        Intrinsics.j(json, "json");
        return this.f121061b._updateModeFromJson(mode, json);
    }
    ...
    public BarcodeArSettings _updateSettingsFromJson(BarcodeArSettings settings, String json) {
        ...
        Intrinsics.j(json, "json");
        return this.f121061b._updateSettingsFromJson(settings, json);
    }
    ...
    public BarcodeArDeserializerHelper get_helper() {
        return this.f121061b.get_helper();
    }
    ...
    public BarcodeArDeserializer() {
        ...
        this.f121060a = aVar;
        this.f121061b = new BarcodeArDeserializerProxyAdapter(nativeBarcodeArDeserializerCreate, null, 2, 0 == true ? 1 : 0);
        ProxyCacheKt.getGlobalProxyCache().getOrPut(Reflection.b(BarcodeArDeserializerHelper.class), null, aVar, new a(eVar));
        getF121066a().setListener(new BarcodeArDeserializerListenerReversedAdapter(new b(this), this, null, 4, null));
    }
