...
public final class BarcodeSelectionSessionProxyAdapter implements BarcodeSelectionSessionProxy {
    ...
    private final NativeBarcodeSelectionSession f124742a;
    ...
    public BarcodeSelectionSessionProxyAdapter(NativeBarcodeSelectionSession _NativeBarcodeSelectionSession, ProxyCache proxyCache) {
        ...
        this.f124742a = _NativeBarcodeSelectionSession;
    ...
    public int getCount(Barcode barcode) {
        ...
        NativeBarcode f121842a = barcode.getF121842a();
        this.proxyCache.put(Reflection.b(NativeBarcode.class), null, f121842a, barcode);
        return this.f124742a.getCount(f121842a);
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public long getFrameSequenceId() {
        return this.f124742a.getFrameSeqIdAndroid();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public int getLastProcessedFrameId() {
        return this.f124742a.getLastProcessedFrameId();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public List<Barcode> getNewlySelectedBarcodes() {
        ArrayList<NativeBarcode> newlySelectedBarcodes = this.f124742a.getNewlySelectedBarcodes();
    ...
    public List<Barcode> getNewlyUnselectedBarcodes() {
        ArrayList<NativeBarcode> newlyUnselectedBarcodes = this.f124742a.getNewlyUnselectedBarcodes();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
    ...
    public List<Barcode> getSelectedBarcodes() {
        ArrayList<NativeBarcode> selectedBarcodes = this.f124742a.getSelectedBarcodes();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
    ...
    public void selectUnselectedBarcodes() {
        this.f124742a.selectAllUnselectedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public String toJson() {
        String json = this.f124742a.toJson();
        Intrinsics.g(json);
        return json;
    }
