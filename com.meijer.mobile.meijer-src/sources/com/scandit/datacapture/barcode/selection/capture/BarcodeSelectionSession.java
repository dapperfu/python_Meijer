...
public final class BarcodeSelectionSession implements BarcodeSelectionSessionProxy {
    ...
    private final Function0 f124740a;

    /* renamed from: b, reason: collision with root package name */
    private final Lazy f124741b;

    public BarcodeSelectionSession(Function0<? extends NativeBarcodeSelectionSession> getImpl) {
        Intrinsics.j(getImpl, "getImpl");
        this.f124740a = getImpl;
        this.f124741b = LazyKt.b(new F(this));
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    /* renamed from: _impl */
    public NativeBarcodeSelectionSession getF124742a() {
        return (NativeBarcodeSelectionSession) this.f124740a.invoke();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public int getCount(Barcode barcode) {
        Intrinsics.j(barcode, "barcode");
        return ((BarcodeSelectionSessionProxyAdapter) this.f124741b.getValue()).getCount(barcode);
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public long getFrameSequenceId() {
        return ((BarcodeSelectionSessionProxyAdapter) this.f124741b.getValue()).getFrameSequenceId();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public int getLastProcessedFrameId() {
        return ((BarcodeSelectionSessionProxyAdapter) this.f124741b.getValue()).getLastProcessedFrameId();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public List<Barcode> getNewlySelectedBarcodes() {
        return ((BarcodeSelectionSessionProxyAdapter) this.f124741b.getValue()).getNewlySelectedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public List<Barcode> getNewlyUnselectedBarcodes() {
        return ((BarcodeSelectionSessionProxyAdapter) this.f124741b.getValue()).getNewlyUnselectedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public List<Barcode> getSelectedBarcodes() {
        return ((BarcodeSelectionSessionProxyAdapter) this.f124741b.getValue()).getSelectedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public void reset() {
        ((BarcodeSelectionSessionProxyAdapter) this.f124741b.getValue()).reset();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public void selectUnselectedBarcodes() {
        ((BarcodeSelectionSessionProxyAdapter) this.f124741b.getValue()).selectUnselectedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSessionProxy
    public String toJson() {
        return ((BarcodeSelectionSessionProxyAdapter) this.f124741b.getValue()).toJson();
    }
}
