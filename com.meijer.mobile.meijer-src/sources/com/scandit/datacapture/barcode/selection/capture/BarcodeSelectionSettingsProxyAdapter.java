...
public final class BarcodeSelectionSettingsProxyAdapter implements BarcodeSelectionSettingsProxy {
    ...
    private final NativeBarcodeSelectionSettings f124746a;
    ...
    public BarcodeSelectionSettingsProxyAdapter(NativeBarcodeSelectionSettings _NativeBarcodeSelectionSettings, ProxyCache proxyCache) {
        Intrinsics.j(_NativeBarcodeSelectionSettings, "_NativeBarcodeSelectionSettings");
        Intrinsics.j(proxyCache, "proxyCache");
        this.f124746a = _NativeBarcodeSelectionSettings;
    ...
    public void enableSymbologies(Set<? extends Symbology> symbologies) {
        ...
        this.f124746a.enableSymbologies(BarcodeNativeTypeFactory.INSTANCE.convertSymbologySetToHashSet(symbologies));
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSettingsProxy
    public void enableSymbology(Symbology symbology, boolean enabled) {
        Intrinsics.j(symbology, "symbology");
        this.f124746a.setSymbologyEnabled(symbology, enabled);
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSettingsProxy
    public Set<Symbology> getEnabledSymbologies() {
        HashSet<Symbology> enabledSymbologies = this.f124746a.getEnabledSymbologies();
    ...
    public boolean getSingleBarcodeAutoDetection() {
        return this.f124746a.getSingleBarcodeAutoDetectionEnabled();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSettingsProxy
    public boolean getSwipeGesturesEnabled() {
        return this.f124746a.getSwipeGesturesEnabled();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSettingsProxy
    public SymbologySettings getSymbologySettings(Symbology symbology) {
        Intrinsics.j(symbology, "symbology");
        NativeSymbologySettings symbologySettings = this.f124746a.getSymbologySettings(symbology);
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeSymbologySettings.class);
        Intrinsics.g(symbologySettings);
        return (SymbologySettings) proxyCache.getOrPut(kClassB, null, symbologySettings, new G(symbologySettings));
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSettingsProxy
    public boolean getTapGestureForSelectionEnabled() {
        return this.f124746a.getTapGestureForSelectionEnabled();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSettingsProxy
    public void setSingleBarcodeAutoDetection(boolean z10) {
        this.f124746a.setSingleBarcodeAutoDetectionEnabled(z10);
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSettingsProxy
    public void setSwipeGesturesEnabled(boolean z10) {
        this.f124746a.setSwipeGesturesEnabled(z10);
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSettingsProxy
    public void setTapGestureForSelectionEnabled(boolean z10) {
        this.f124746a.setTapGestureForSelectionEnabled(z10);
    }
