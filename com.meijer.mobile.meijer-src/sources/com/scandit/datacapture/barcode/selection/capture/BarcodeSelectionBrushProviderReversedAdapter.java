...
public final class BarcodeSelectionBrushProviderReversedAdapter extends NativeBarcodeSelectionBrushProvider {
    ...
    private final BarcodeSelectionBrushProvider f124712a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final WeakReference f124714c;
    ...
    public NativeBrush brushForBarcode(NativeBarcode barcode) {
        ...
        if (((BarcodeSelectionBasicOverlay) this.f124714c.get()) != null) {
            Brush brushBrushForBarcode = this.f124712a.brushForBarcode((Barcode) this.proxyCache.getOrPut(Reflection.b(NativeBarcode.class), null, barcode, new C13403d(barcode)));
    ...
    public BarcodeSelectionBrushProviderReversedAdapter(BarcodeSelectionBrushProvider _BarcodeSelectionBrushProvider, BarcodeSelectionBasicOverlay _BarcodeSelectionBasicOverlay, ProxyCache proxyCache) {
        ...
        this.f124712a = _BarcodeSelectionBrushProvider;
        this.proxyCache = proxyCache;
        this.f124714c = new WeakReference(_BarcodeSelectionBasicOverlay);
    }
}
