...
public final class BarcodeSelectionDeserializerProxyAdapter implements BarcodeSelectionDeserializerProxy {
    ...
    private final NativeBarcodeSelectionDeserializer f124724a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeDataCaptureModeDeserializer f124726c;

    /* renamed from: d, reason: collision with root package name */
    private BarcodeSelectionDeserializer f124727d;
    ...
    public BarcodeSelectionDeserializerProxyAdapter(NativeBarcodeSelectionDeserializer _NativeBarcodeSelectionDeserializer, ProxyCache proxyCache) {
        ...
        this.f124724a = _NativeBarcodeSelectionDeserializer;
        ...
        this.f124726c = nativeDataCaptureModeDeserializerAsDataCaptureModeDeserializer;
    }
    ...
    public BarcodeSelectionBasicOverlay _basicOverlayFromJson(BarcodeSelection mode, String jsonData) {
        ...
        NativeBarcodeSelection nativeBarcodeSelection_impl = mode.getF124737a();
        this.proxyCache.put(Reflection.b(NativeBarcodeSelection.class), null, nativeBarcodeSelection_impl, mode);
        NativeBarcodeSelectionBasicOverlay nativeBarcodeSelectionBasicOverlayBarcodeSelectionBasicOverlayFromJson = this.f124724a.barcodeSelectionBasicOverlayFromJson(nativeBarcodeSelection_impl, CoreNativeTypeFactory.INSTANCE.convert(jsonData));
    ...
    public BarcodeSelectionDeserializer _deserializer() {
        BarcodeSelectionDeserializer barcodeSelectionDeserializer = this.f124727d;
    ...
    public BarcodeSelection _modeFromJson(DataCaptureContext dataCaptureContext, String jsonData) {
        ...
        NativeBarcodeSelection nativeBarcodeSelectionBarcodeSelectionFromJson = this.f124724a.barcodeSelectionFromJson(nativeDataCaptureContext_impl, CoreNativeTypeFactory.INSTANCE.convert(jsonData));
        ProxyCache proxyCache = this.proxyCache;
    ...
    public void _setDeserializer(BarcodeSelectionDeserializer deserializer) {
        ...
        this.f124727d = deserializer;
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionDeserializerProxy
    public BarcodeSelectionSettings _settingsFromJson(String jsonData) {
        Intrinsics.j(jsonData, "jsonData");
        NativeBarcodeSelectionSettings nativeBarcodeSelectionSettings = this.f124724a.settingsFromJson(CoreNativeTypeFactory.INSTANCE.convert(jsonData));
        ProxyCache proxyCache = this.proxyCache;
    ...
    public List<String> getWarnings() {
        ArrayList<String> warnings = this.f124724a.getWarnings();
    ...
    public BarcodeSelectionDeserializerHelper get_helper() {
        return (BarcodeSelectionDeserializerHelper) this.proxyCache.requireByValue(Reflection.b(BarcodeSelectionDeserializerHelper.class), this.f124724a.getHelper());
    }
    ...
    public BarcodeSelectionBasicOverlay updateBasicOverlayFromJson(BarcodeSelectionBasicOverlay overlay, String jsonData) {
        ...
        Intrinsics.j(jsonData, "jsonData");
        NativeBarcodeSelectionBasicOverlay nativeBarcodeSelectionBasicOverlay_impl = overlay.getF124801a();
        ...
        NativeBarcodeSelectionBasicOverlay nativeBarcodeSelectionBasicOverlayUpdateBarcodeSelectionBasicOverlayFromJson = this.f124724a.updateBarcodeSelectionBasicOverlayFromJson(nativeBarcodeSelectionBasicOverlay_impl, CoreNativeTypeFactory.INSTANCE.convert(jsonData));
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeBarcodeSelectionBasicOverlay.class);
    ...
    public BarcodeSelection updateModeFromJson(BarcodeSelection mode, String jsonData) {
        ...
        NativeBarcodeSelection nativeBarcodeSelection_impl = mode.getF124737a();
        this.proxyCache.put(Reflection.b(NativeBarcodeSelection.class), null, nativeBarcodeSelection_impl, mode);
        NativeBarcodeSelection nativeBarcodeSelectionUpdateBarcodeSelectionFromJson = this.f124724a.updateBarcodeSelectionFromJson(nativeBarcodeSelection_impl, CoreNativeTypeFactory.INSTANCE.convert(jsonData));
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeBarcodeSelection.class);
    ...
    public BarcodeSelectionSettings updateSettingsFromJson(BarcodeSelectionSettings settings, String jsonData) {
        ...
        Intrinsics.j(jsonData, "jsonData");
        NativeBarcodeSelectionSettings nativeBarcodeSelectionSettings_impl = settings.getF124746a();
        this.proxyCache.put(Reflection.b(NativeBarcodeSelectionSettings.class), null, nativeBarcodeSelectionSettings_impl, settings);
        NativeBarcodeSelectionSettings nativeBarcodeSelectionSettingsUpdateSettingsFromJson = this.f124724a.updateSettingsFromJson(nativeBarcodeSelectionSettings_impl, CoreNativeTypeFactory.INSTANCE.convert(jsonData));
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeBarcodeSelectionSettings.class);
