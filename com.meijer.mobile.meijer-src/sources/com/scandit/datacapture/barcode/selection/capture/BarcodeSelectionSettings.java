...
public final class BarcodeSelectionSettings implements BarcodeSelectionSettingsProxy {
    ...
    private final /* synthetic */ BarcodeSelectionSettingsProxyAdapter f124744a;
    ...
    public BarcodeSelectionSettings(NativeBarcodeSelectionSettings impl) {
        ...
        this.f124744a = new BarcodeSelectionSettingsProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    ...
    @NativeImpl
    /* renamed from: _impl */
    public NativeBarcodeSelectionSettings getF124746a() {
        return this.f124744a.getF124746a();
    }
    ...
    public void enableSymbologies(Set<? extends Symbology> symbologies) {
        ...
        this.f124744a.enableSymbologies(symbologies);
    }
    ...
    public void enableSymbology(Symbology symbology, boolean enabled) {
        ...
        this.f124744a.enableSymbology(symbology, enabled);
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionSettingsProxy
    @ProxyFunction(property = "enabledSymbologies")
    public Set<Symbology> getEnabledSymbologies() {
        return this.f124744a.getEnabledSymbologies();
    }
    ...
    public SymbologySettings getSymbologySettings(Symbology symbology) {
        Intrinsics.j(symbology, "symbology");
        return this.f124744a.getSymbologySettings(symbology);
    }
    ...
    public boolean getTapGestureForSelectionEnabled() {
        return this.f124744a.getTapGestureForSelectionEnabled();
    }
    ...
    public void setSingleBarcodeAutoDetection(boolean z10) {
        this.f124744a.setSingleBarcodeAutoDetection(z10);
    }
    ...
    public void setSwipeGesturesEnabled(boolean z10) {
        this.f124744a.setSwipeGesturesEnabled(z10);
    }
    ...
    public void setTapGestureForSelectionEnabled(boolean z10) {
        this.f124744a.setTapGestureForSelectionEnabled(z10);
    }

    public final TimeInterval getCodeDuplicateFilter() {
        return TimeInterval.INSTANCE.millis(getF124746a().getCodeDuplicateFilterMilliseconds());
    }

    public final Object getProperty(String key) {
        Intrinsics.j(key, "key");
        Integer intProperty = getF124746a().getIntProperty(key);
        if (intProperty != null) {
            return intProperty;
        }
        Boolean boolProperty = getF124746a().getBoolProperty(key);
    ...
    public final void setCodeDuplicateFilter(TimeInterval value) {
        ...
        getF124746a().setCodeDuplicateFilterMilliseconds((int) value.asMillis());
    }
    ...
    public final void setProperty(String name, Object value) {
        ...
        if (value instanceof Float) {
            getF124746a().setFloatProperty(name, ((Number) value).floatValue());
            return;
        }
        if (value instanceof String) {
            getF124746a().setStringProperty(name, (String) value);
            return;
        }
        if (value instanceof Boolean) {
            getF124746a().setBoolProperty(name, ((Boolean) value).booleanValue());
            return;
        }
        Integer numIntFromAny = TypeConverter.INSTANCE.intFromAny(value);
        if (numIntFromAny != null) {
            getF124746a().setIntProperty(name, numIntFromAny.intValue());
        }
    }
    ...
    public final void setSelectionType(BarcodeSelectionType value) {
        ...
        getF124746a().setSelectionType(value.getF124707c());
    }
