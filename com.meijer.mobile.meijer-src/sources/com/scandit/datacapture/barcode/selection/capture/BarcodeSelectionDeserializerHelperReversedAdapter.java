...
public final class BarcodeSelectionDeserializerHelperReversedAdapter extends NativeBarcodeSelectionDeserializerHelper {
    ...
    private final BarcodeSelectionDeserializerHelper f124719a;
    ...
    public BarcodeSelectionDeserializerHelperReversedAdapter(BarcodeSelectionDeserializerHelper _BarcodeSelectionDeserializerHelper, ProxyCache proxyCache) {
        ...
        this.f124719a = _BarcodeSelectionDeserializerHelper;
    ...
    public void applySettings(NativeBarcodeSelection mode, NativeBarcodeSelectionSettings settings) {
        ...
        this.f124719a.applySettings((BarcodeSelection) this.proxyCache.require(Reflection.b(NativeBarcodeSelection.class), null, mode), (BarcodeSelectionSettings) this.proxyCache.require(Reflection.b(NativeBarcodeSelectionSettings.class), null, settings));
    }
    ...
    public void changeBasicOverlayAddedToView(NativeBarcodeSelectionBasicOverlay overlay, NativeDataCaptureView view, boolean added) {
        ...
        this.f124719a.changeBasicOverlayAddedToView((BarcodeSelectionBasicOverlay) this.proxyCache.require(Reflection.b(NativeBarcodeSelectionBasicOverlay.class), null, overlay), (DataCaptureView) this.proxyCache.require(Reflection.b(NativeDataCaptureView.class), null, view), added);
    }

    @Override // com.scandit.datacapture.barcode.selection.internal.module.serialization.NativeBarcodeSelectionDeserializerHelper
    public NativeAimerSelection createAimerSelection() {
        BarcodeSelectionAimerSelection barcodeSelectionAimerSelectionCreateAimerSelection = this.f124719a.createAimerSelection();
    ...
    public NativeAutoSelectionStrategy createAutoSelectionStrategy() {
        BarcodeSelectionAutoSelectionStrategy barcodeSelectionAutoSelectionStrategyCreateAutoSelectionStrategy = this.f124719a.createAutoSelectionStrategy();
        this.proxyCache.put(Reflection.b(BarcodeSelectionAutoSelectionStrategy.class), null, barcodeSelectionAutoSelectionStrategyCreateAutoSelectionStrategy, barcodeSelectionAutoSelectionStrategyCreateAutoSelectionStrategy.getF124709a());
        NativeAutoSelectionStrategy f124709a = barcodeSelectionAutoSelectionStrategyCreateAutoSelectionStrategy.getF124709a();
        this.proxyCache.put(Reflection.b(NativeAutoSelectionStrategy.class), null, f124709a, barcodeSelectionAutoSelectionStrategyCreateAutoSelectionStrategy);
        return f124709a;
    }
    ...
    public NativeBarcodeSelectionBasicOverlay createBasicOverlay(NativeBarcodeSelection mode, BarcodeSelectionBasicOverlayStyle style) {
        ...
        BarcodeSelectionBasicOverlay barcodeSelectionBasicOverlayCreateBasicOverlay = this.f124719a.createBasicOverlay((BarcodeSelection) this.proxyCache.require(Reflection.b(NativeBarcodeSelection.class), null, mode), style);
    ...
    public NativeManualSelectionStrategy createManualSelectionStrategy() {
        BarcodeSelectionManualSelectionStrategy barcodeSelectionManualSelectionStrategyCreateManualSelectionStrategy = this.f124719a.createManualSelectionStrategy();
        this.proxyCache.put(Reflection.b(BarcodeSelectionManualSelectionStrategy.class), null, barcodeSelectionManualSelectionStrategyCreateManualSelectionStrategy, barcodeSelectionManualSelectionStrategyCreateManualSelectionStrategy.getF124734a());
        NativeManualSelectionStrategy f124734a = barcodeSelectionManualSelectionStrategyCreateManualSelectionStrategy.getF124734a();
        this.proxyCache.put(Reflection.b(NativeManualSelectionStrategy.class), null, f124734a, barcodeSelectionManualSelectionStrategyCreateManualSelectionStrategy);
        return f124734a;
    }
    ...
    public NativeBarcodeSelection createMode(NativeDataCaptureContext context) {
        ...
        BarcodeSelection barcodeSelectionCreateMode = this.f124719a.createMode((DataCaptureContext) this.proxyCache.getOrPut(Reflection.b(NativeDataCaptureContext.class), null, context, new h(context)));
    ...
    public NativeCameraSettings createRecommendedCameraSettings() {
        return CoreNativeTypeFactory.INSTANCE.convert(this.f124719a.createRecommendedCameraSettings());
    }

    @Override // com.scandit.datacapture.barcode.selection.internal.module.serialization.NativeBarcodeSelectionDeserializerHelper
    public NativeBarcodeSelectionSettings createSettings() {
        BarcodeSelectionSettings barcodeSelectionSettingsCreateSettings = this.f124719a.createSettings();
    ...
    public NativeTapSelection createTapSelection() {
        BarcodeSelectionTapSelection barcodeSelectionTapSelectionCreateTapSelection = this.f124719a.createTapSelection();
    ...
    public void updateBasicOverlayFromJson(NativeBarcodeSelectionBasicOverlay overlay, NativeJsonValue json) {
        ...
        this.f124719a.updateBasicOverlayFromJson((BarcodeSelectionBasicOverlay) this.proxyCache.require(Reflection.b(NativeBarcodeSelectionBasicOverlay.class), null, overlay), (JsonValue) this.proxyCache.getOrPut(Reflection.b(NativeJsonValue.class), null, json, new i(json)));
    }
    ...
    public void updateModeFromJson(NativeBarcodeSelection mode, NativeJsonValue json) {
        Intrinsics.j(mode, "mode");
        Intrinsics.j(json, "json");
        this.f124719a.updateModeFromJson((BarcodeSelection) this.proxyCache.require(Reflection.b(NativeBarcodeSelection.class), null, mode), (JsonValue) this.proxyCache.getOrPut(Reflection.b(NativeJsonValue.class), null, json, new j(json)));
    }
    ...
    public void updateSettingsFromJson(NativeBarcodeSelectionSettings settings, NativeJsonValue json) {
        Intrinsics.j(settings, "settings");
        Intrinsics.j(json, "json");
        this.f124719a.updateSettingsFromJson((BarcodeSelectionSettings) this.proxyCache.require(Reflection.b(NativeBarcodeSelectionSettings.class), null, settings), (JsonValue) this.proxyCache.getOrPut(Reflection.b(NativeJsonValue.class), null, json, new k(json)));
    }
