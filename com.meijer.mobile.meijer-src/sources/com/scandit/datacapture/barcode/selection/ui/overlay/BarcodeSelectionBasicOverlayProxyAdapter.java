...
public final class BarcodeSelectionBasicOverlayProxyAdapter implements BarcodeSelectionBasicOverlayProxy {
    ...
    private final NativeBarcodeSelectionBasicOverlay f124801a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeDataCaptureOverlay f124803c;
    ...
    public BarcodeSelectionBasicOverlayProxyAdapter(NativeBarcodeSelectionBasicOverlay _NativeBarcodeSelectionBasicOverlay, ProxyCache proxyCache) {
        ...
        this.f124801a = _NativeBarcodeSelectionBasicOverlay;
        ...
        this.f124803c = nativeDataCaptureOverlayAsDataCaptureOverlay;
    }
    ...
    public void _setProfilingOverlay(ProfilingOverlay overlay) {
        ...
        this.f124801a.setProfilingOverlay(f126722a);
    }

    @Override // com.scandit.datacapture.barcode.selection.ui.overlay.BarcodeSelectionBasicOverlayProxy
    public void clearSelectedBarcodeBrushes() {
        this.f124801a.clearSelectedBarcodeBrushes();
    }

    @Override // com.scandit.datacapture.barcode.selection.ui.overlay.BarcodeSelectionBasicOverlayProxy
    public Brush getAimedBrush() {
        NativeBrush aimedBrush = this.f124801a.getAimedBrush();
    ...
    public int getFrozenBackgroundColor() {
        NativeColor freezeOverlayColor = this.f124801a.getFreezeOverlayColor();
        CoreNativeTypeFactory coreNativeTypeFactory = CoreNativeTypeFactory.INSTANCE;
    ...
    public Brush getSelectedBrush() {
        NativeBrush selectedBrush = this.f124801a.getSelectedBrush();
        CoreNativeTypeFactory coreNativeTypeFactory = CoreNativeTypeFactory.INSTANCE;
    ...
    public Brush getSelectingBrush() {
        NativeBrush selectingBrush = this.f124801a.getSelectingBrush();
        CoreNativeTypeFactory coreNativeTypeFactory = CoreNativeTypeFactory.INSTANCE;
    ...
    public boolean getShouldShowHints() {
        return this.f124801a.getShowHints();
    }

    @Override // com.scandit.datacapture.barcode.selection.ui.overlay.BarcodeSelectionBasicOverlayProxy
    public boolean getShouldShowScanAreaGuides() {
        return this.f124801a.getShouldShowScanAreaGuides();
    }

    @Override // com.scandit.datacapture.barcode.selection.ui.overlay.BarcodeSelectionBasicOverlayProxy
    public BarcodeSelectionBasicOverlayStyle getStyle() {
        BarcodeSelectionBasicOverlayStyle style = this.f124801a.getStyle();
        Intrinsics.g(style);
        return style;
    }
    ...
    public Brush getTrackedBrush() {
        NativeBrush trackedBrush = this.f124801a.getTrackedBrush();
        CoreNativeTypeFactory coreNativeTypeFactory = CoreNativeTypeFactory.INSTANCE;
    ...
    public void setAimedBrush(Brush p02) {
        Intrinsics.j(p02, "p0");
        this.f124801a.setAimedBrush(CoreNativeTypeFactory.INSTANCE.convert(p02));
    }

    @Override // com.scandit.datacapture.barcode.selection.ui.overlay.BarcodeSelectionBasicOverlayProxy
    public void setFrozenBackgroundColor(int i10) {
        this.f124801a.setFreezeOverlayColor(CoreNativeTypeFactory.INSTANCE.convert(i10));
    }

    @Override // com.scandit.datacapture.barcode.selection.ui.overlay.BarcodeSelectionBasicOverlayProxy
    public void setSelectedBrush(Brush p02) {
        Intrinsics.j(p02, "p0");
        this.f124801a.setSelectedBrush(CoreNativeTypeFactory.INSTANCE.convert(p02));
    }

    @Override // com.scandit.datacapture.barcode.selection.ui.overlay.BarcodeSelectionBasicOverlayProxy
    public void setSelectingBrush(Brush p02) {
        Intrinsics.j(p02, "p0");
        this.f124801a.setSelectingBrush(CoreNativeTypeFactory.INSTANCE.convert(p02));
    }

    @Override // com.scandit.datacapture.barcode.selection.ui.overlay.BarcodeSelectionBasicOverlayProxy
    public void setShouldShowHints(boolean z10) {
        this.f124801a.setShowHints(z10);
    }

    @Override // com.scandit.datacapture.barcode.selection.ui.overlay.BarcodeSelectionBasicOverlayProxy
    public void setShouldShowScanAreaGuides(boolean z10) {
        this.f124801a.setShouldShowScanAreaGuides(z10);
    }

    @Override // com.scandit.datacapture.barcode.selection.ui.overlay.BarcodeSelectionBasicOverlayProxy
    public void setTextForAimToSelectAutoHint(String text) {
        Intrinsics.j(text, "text");
        this.f124801a.setTextForAimToSelectAutoHint(text);
    }

    @Override // com.scandit.datacapture.barcode.selection.ui.overlay.BarcodeSelectionBasicOverlayProxy
    public void setTextForDoubleTapToUnfreezeHint(String text) {
        Intrinsics.j(text, "text");
        this.f124801a.setTextForDoubleTapToUnfreezeHint(text);
    }

    @Override // com.scandit.datacapture.barcode.selection.ui.overlay.BarcodeSelectionBasicOverlayProxy
    public void setTextForSelectOrDoubleTapToFreezeHint(String text) {
        Intrinsics.j(text, "text");
        this.f124801a.setTextForSelectOrDoubleTapToFreezeHint(text);
    }

    @Override // com.scandit.datacapture.barcode.selection.ui.overlay.BarcodeSelectionBasicOverlayProxy
    public void setTextForTapAnywhereToSelectHint(String text) {
        Intrinsics.j(text, "text");
        this.f124801a.setTextForTapAnywhereToSelectHint(text);
    }

    @Override // com.scandit.datacapture.barcode.selection.ui.overlay.BarcodeSelectionBasicOverlayProxy
    public void setTextForTapToSelectHint(String text) {
        Intrinsics.j(text, "text");
        this.f124801a.setTextForTapToSelectHint(text);
    }

    @Override // com.scandit.datacapture.barcode.selection.ui.overlay.BarcodeSelectionBasicOverlayProxy
    public void setTrackedBrush(Brush p02) {
        Intrinsics.j(p02, "p0");
        this.f124801a.setTrackedBrush(CoreNativeTypeFactory.INSTANCE.convert(p02));
    }
