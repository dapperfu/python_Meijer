...
public final class BarcodeCaptureSettings implements BarcodeCaptureSettingsProxy {
    ...
    private final /* synthetic */ BarcodeCaptureSettingsProxyAdapter f121497a;

    /* renamed from: b, reason: collision with root package name */
    private LocationSelection f121498b;
    ...
    public BarcodeCaptureSettings(NativeBarcodeCaptureSettings impl) {
        ...
        this.f121497a = new BarcodeCaptureSettingsProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    }
    ...
    @NativeImpl
    /* renamed from: _impl */
    public NativeBarcodeCaptureSettings getF121499a() {
        return this.f121497a.getF121499a();
    }
    ...
    public void enableSymbologies(EnumSet<CompositeType> compositeTypes) {
        ...
        this.f121497a.enableSymbologies(compositeTypes);
    }
    ...
    public SymbologySettings getSymbologySettings(Symbology symbology) {
        Intrinsics.j(symbology, "symbology");
        return this.f121497a.getSymbologySettings(symbology);
    }
    ...
    public void setArucoDictionary(ArucoDictionary dictionary) {
        ...
        this.f121497a.setArucoDictionary(dictionary);
    }
    ...
    public void setBatterySaving(BatterySavingMode batterySavingMode) {
        ...
        this.f121497a.setBatterySaving(batterySavingMode);
    }
    ...
    public void setEnabledCompositeTypes(EnumSet<CompositeType> enumSet) {
        ...
        this.f121497a.setEnabledCompositeTypes(enumSet);
    }
    ...
    public void setScanIntention(ScanIntention scanIntention) {
        ...
        this.f121497a.setScanIntention(scanIntention);
    }
    ...
    public void enableSymbologies(Set<? extends Symbology> symbologies) {
        ...
        this.f121497a.enableSymbologies(symbologies);
    }

    public final TimeInterval getCodeDuplicateFilter() {
        return TimeInterval.INSTANCE.millis(getF121499a().getCodeDuplicateFilterMilliseconds());
    }

    /* renamed from: getLocationSelection, reason: from getter */
    public final LocationSelection getF121498b() {
        return this.f121498b;
    }

    public final Object getProperty(String key) {
        Intrinsics.j(key, "key");
        Integer intProperty = getF121499a().getIntProperty(key);
        if (intProperty != null) {
            return intProperty;
        }
        Boolean boolProperty = getF121499a().getBoolProperty(key);
    ...
    public final void setCodeDuplicateFilter(TimeInterval value) {
        ...
        getF121499a().setCodeDuplicateFilterMilliseconds((int) value.asMillis());
    }

    public final void setLocationSelection(LocationSelection locationSelection) {
        this.f121498b = locationSelection;
        getF121499a().setLocationSelection(locationSelection != null ? locationSelection.getF124973c() : null);
    }
    ...
    public final void setProperty(String name, Object value) {
        ...
        if (value instanceof Float) {
            getF121499a().setFloatProperty(name, ((Number) value).floatValue());
            return;
        }
        if (value instanceof String) {
            getF121499a().setStringProperty(name, (String) value);
            return;
        }
        if (value instanceof Boolean) {
            getF121499a().setBoolProperty(name, ((Boolean) value).booleanValue());
            return;
        }
        Integer numIntFromAny = TypeConverter.INSTANCE.intFromAny(value);
        if (numIntFromAny != null) {
            getF121499a().setIntProperty(name, numIntFromAny.intValue());
        }
    }
