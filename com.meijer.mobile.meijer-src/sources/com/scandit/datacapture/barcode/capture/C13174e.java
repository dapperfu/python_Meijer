...
public final class C13174e implements BarcodeCaptureDeserializerListener {

    /* renamed from: a, reason: collision with root package name */
    public final WeakReference f121526a;

    public C13174e(BarcodeCaptureDeserializer owner) {
        Intrinsics.j(owner, "owner");
        this.f121526a = new WeakReference(owner);
    }
    ...
    public final void onModeDeserializationFinished(BarcodeCaptureDeserializer deserializer, BarcodeCapture mode, JsonValue json) {
        ...
        BarcodeCaptureDeserializer barcodeCaptureDeserializer = (BarcodeCaptureDeserializer) this.f121526a.get();
