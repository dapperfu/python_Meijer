...
public final class C13171b implements BarcodeCaptureListener {

    /* renamed from: a, reason: collision with root package name */
    public final WeakReference f121523a;

    public C13171b(BarcodeCapture owner) {
        Intrinsics.j(owner, "owner");
        this.f121523a = new WeakReference(owner);
    }
    ...
    public final void onBarcodeScanned(BarcodeCapture barcodeCapture, BarcodeCaptureSession session, FrameData data) {
        ...
        BarcodeCapture barcodeCapture2 = (BarcodeCapture) this.f121523a.get();
        if (barcodeCapture2 == null || (copyOnWriteArraySet = barcodeCapture2.f121469f) == null) {
            return;
        }
