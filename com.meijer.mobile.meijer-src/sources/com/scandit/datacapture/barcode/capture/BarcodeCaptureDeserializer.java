...
public final class BarcodeCaptureDeserializer implements DataCaptureModeDeserializer, BarcodeCaptureDeserializerProxy {
    ...
    private final C13175f f121475c;

    /* renamed from: d, reason: collision with root package name */
    private final /* synthetic */ BarcodeCaptureDeserializerProxyAdapter f121476d;
    ...
    public BarcodeCaptureDeserializer _deserializer() {
        return this.f121476d._deserializer();
    }
    ...
    public NativeBarcodeCaptureDeserializer getF121483a() {
        return this.f121476d.getF121483a();
    }
    ...
    public NativeDataCaptureModeDeserializer getF121485c() {
        return this.f121476d.getF121485c();
    }
    ...
    public BarcodeCapture _modeFromJson(DataCaptureContext dataCaptureContext, String jsonData) {
        ...
        return this.f121476d._modeFromJson(dataCaptureContext, jsonData);
    }
    ...
    public BarcodeCaptureOverlay _overlayFromJson(BarcodeCapture mode, String jsonData) {
        ...
        Intrinsics.j(jsonData, "jsonData");
        return this.f121476d._overlayFromJson(mode, jsonData);
    }
    ...
    public void _setDeserializer(BarcodeCaptureDeserializer deserializer) {
        ...
        this.f121476d._setDeserializer(deserializer);
    }
    ...
    public BarcodeCapture updateModeFromJson(BarcodeCapture mode, String jsonData) {
        Intrinsics.j(mode, "mode");
        Intrinsics.j(jsonData, "jsonData");
        return this.f121476d.updateModeFromJson(mode, jsonData);
    }
    ...
    public BarcodeCaptureOverlay updateOverlayFromJson(BarcodeCaptureOverlay overlay, String jsonData) {
        ...
        Intrinsics.j(jsonData, "jsonData");
        return this.f121476d.updateOverlayFromJson(overlay, jsonData);
    }
    ...
    public BarcodeCaptureSettings updateSettingsFromJson(BarcodeCaptureSettings settings, String jsonData) {
        ...
        Intrinsics.j(jsonData, "jsonData");
        return this.f121476d.updateSettingsFromJson(settings, jsonData);
    }
    ...
    public BarcodeCaptureDeserializer() {
        ...
        C13175f c13175f = new C13175f();
        BarcodeCaptureDeserializerHelperReversedAdapter barcodeCaptureDeserializerHelperReversedAdapter = new BarcodeCaptureDeserializerHelperReversedAdapter(c13175f, null, 2, null);
        ...
        this.f121475c = c13175f;
        this.f121476d = new BarcodeCaptureDeserializerProxyAdapter(nativeBarcodeCaptureDeserializerCreate, null, 2, 0 == true ? 1 : 0);
        ProxyCacheKt.getGlobalProxyCache().getOrPut(Reflection.b(BarcodeCaptureDeserializerHelper.class), null, c13175f, new C13173d(barcodeCaptureDeserializerHelperReversedAdapter));
        _setDeserializer(this);
        nativeBarcodeCaptureDeserializerCreate.setListener(new BarcodeCaptureDeserializerListenerReversedAdapter(new C13174e(this), this, null, 4, null));
        WeakReference weakReference = new WeakReference(this);
        Intrinsics.j(weakReference, "<set-?>");
        c13175f.f121527a = weakReference;
    }
