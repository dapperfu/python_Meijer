...
public final class BarcodeCaptureDeserializerHelperReversedAdapter extends NativeBarcodeCaptureDeserializerHelper {
    ...
    private final BarcodeCaptureDeserializerHelper f121478a;
    ...
    public BarcodeCaptureDeserializerHelperReversedAdapter(BarcodeCaptureDeserializerHelper _BarcodeCaptureDeserializerHelper, ProxyCache proxyCache) {
        ...
        this.f121478a = _BarcodeCaptureDeserializerHelper;
    ...
    public void applySettings(NativeBarcodeCapture mode, NativeBarcodeCaptureSettings settings) {
        ...
        this.f121478a.applySettings((BarcodeCapture) this.proxyCache.getOrPut(Reflection.b(NativeBarcodeCapture.class), null, mode, new C13176g(mode)), (BarcodeCaptureSettings) this.proxyCache.getOrPut(Reflection.b(NativeBarcodeCaptureSettings.class), null, settings, new C13177h(settings)));
    }
    ...
    public void changeOverlayAddedToView(NativeBarcodeCaptureOverlay overlay, NativeDataCaptureView view, boolean added) {
        ...
        this.f121478a.changeOverlayAddedToView((BarcodeCaptureOverlay) this.proxyCache.require(Reflection.b(NativeBarcodeCaptureOverlay.class), null, overlay), (DataCaptureView) this.proxyCache.require(Reflection.b(NativeDataCaptureView.class), null, view), added);
    }

    @Override // com.scandit.datacapture.barcode.internal.module.serialization.NativeBarcodeCaptureDeserializerHelper
    public NativeBarcodeCapture createMode(NativeDataCaptureContext context) {
        Intrinsics.j(context, "context");
        BarcodeCapture barcodeCaptureCreateMode = this.f121478a.createMode((DataCaptureContext) this.proxyCache.getOrPut(Reflection.b(NativeDataCaptureContext.class), null, context, new C13178i(context)));
    ...
    public NativeBarcodeCaptureOverlay createOverlay(NativeBarcodeCapture mode, NativeBarcodeCaptureOverlayStyle style) {
        ...
        BarcodeCaptureOverlay barcodeCaptureOverlayCreateOverlay = this.f121478a.createOverlay((BarcodeCapture) this.proxyCache.getOrPut(Reflection.b(NativeBarcodeCapture.class), null, mode, new C13179j(mode)), BarcodeNativeTypeFactory.INSTANCE.convert(style));
    ...
    public NativeCameraSettings createRecommendedCameraSettings() {
        return CoreNativeTypeFactory.INSTANCE.convert(this.f121478a.createRecommendedCameraSettings());
    }

    @Override // com.scandit.datacapture.barcode.internal.module.serialization.NativeBarcodeCaptureDeserializerHelper
    public NativeBarcodeCaptureSettings createSettings() {
        BarcodeCaptureSettings barcodeCaptureSettingsCreateSettings = this.f121478a.createSettings();
    ...
    public void updateModeFromJson(NativeBarcodeCapture mode, NativeJsonValue json) {
        ...
        this.f121478a.updateModeFromJson((BarcodeCapture) this.proxyCache.getOrPut(Reflection.b(NativeBarcodeCapture.class), null, mode, new C13180k(mode)), (JsonValue) this.proxyCache.getOrPut(Reflection.b(NativeJsonValue.class), null, json, new C13181l(json)));
    }
    ...
    public void updateOverlayFromJson(NativeBarcodeCaptureOverlay overlay, NativeJsonValue json) {
        Intrinsics.j(overlay, "overlay");
        Intrinsics.j(json, "json");
        this.f121478a.updateOverlayFromJson((BarcodeCaptureOverlay) this.proxyCache.require(Reflection.b(NativeBarcodeCaptureOverlay.class), null, overlay), (JsonValue) this.proxyCache.getOrPut(Reflection.b(NativeJsonValue.class), null, json, new C13182m(json)));
    }
    ...
    public void updateSettingsFromJson(NativeBarcodeCaptureSettings settings, NativeJsonValue json) {
        Intrinsics.j(settings, "settings");
        Intrinsics.j(json, "json");
        this.f121478a.updateSettingsFromJson((BarcodeCaptureSettings) this.proxyCache.getOrPut(Reflection.b(NativeBarcodeCaptureSettings.class), null, settings, new C13183n(settings)), (JsonValue) this.proxyCache.getOrPut(Reflection.b(NativeJsonValue.class), null, json, new C13184o(json)));
    }
