...
public final class BarcodeCaptureLicenseInfo {
    ...
    public final Set<Symbology> getLicensedSymbologies() {
        HashSet<Symbology> licensedSymbologies = this.f121487a.getLicensedSymbologies();
        Intrinsics.i(licensedSymbologies, "getLicensedSymbologies(...)");
        return licensedSymbologies;
    }

    public final String toJson() {
        String json = this.f121487a.toJson();
