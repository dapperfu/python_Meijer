...
public final class BarcodeCaptureDeserializerListenerReversedAdapter extends NativeBarcodeCaptureDeserializerListener {
    ...
    private final BarcodeCaptureDeserializerListener f121480a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final WeakReference f121482c;
    ...
    public void onModeDeserializationFinished(NativeBarcodeCaptureDeserializer deserializer, NativeBarcodeCapture mode, NativeJsonValue json) {
        ...
        BarcodeCaptureDeserializer barcodeCaptureDeserializer = (BarcodeCaptureDeserializer) this.f121482c.get();
        if (barcodeCaptureDeserializer != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.b(NativeBarcodeCaptureDeserializer.class), null, deserializer, new C13185p(barcodeCaptureDeserializer));
            Intrinsics.i(orPut, "getOrPut(...)");
            BarcodeCapture barcodeCapture = (BarcodeCapture) this.proxyCache.getOrPut(Reflection.b(NativeBarcodeCapture.class), null, mode, new C13186q(mode));
            JsonValue jsonValue = (JsonValue) this.proxyCache.getOrPut(Reflection.b(NativeJsonValue.class), null, json, new r(json));
            this.f121480a.onModeDeserializationFinished((BarcodeCaptureDeserializer) orPut, barcodeCapture, jsonValue);
        }
    }
    ...
    public void onModeDeserializationStarted(NativeBarcodeCaptureDeserializer deserializer, NativeBarcodeCapture mode, NativeJsonValue json) {
        ...
        BarcodeCaptureDeserializer barcodeCaptureDeserializer = (BarcodeCaptureDeserializer) this.f121482c.get();
        if (barcodeCaptureDeserializer != null) {
            Object orPut = this.proxyCache.getOrPut(Reflection.b(NativeBarcodeCaptureDeserializer.class), null, deserializer, new C13187s(barcodeCaptureDeserializer));
            Intrinsics.i(orPut, "getOrPut(...)");
            BarcodeCapture barcodeCapture = (BarcodeCapture) this.proxyCache.getOrPut(Reflection.b(NativeBarcodeCapture.class), null, mode, new C13188t(mode));
            JsonValue jsonValue = (JsonValue) this.proxyCache.getOrPut(Reflection.b(NativeJsonValue.class), null, json, new C13189u(json));
            this.f121480a.onModeDeserializationStarted((BarcodeCaptureDeserializer) orPut, barcodeCapture, jsonValue);
        }
    }
    ...
    public void onOverlayDeserializationFinished(NativeBarcodeCaptureDeserializer deserializer, NativeBarcodeCaptureOverlay overlay, NativeJsonValue json) {
        ...
        if (barcodeCaptureDeserializer != null) {
            ...
            this.f121480a.onOverlayDeserializationFinished((BarcodeCaptureDeserializer) orPut, barcodeCaptureOverlay, jsonValue);
        }
    }
    ...
    public void onOverlayDeserializationStarted(NativeBarcodeCaptureDeserializer deserializer, NativeBarcodeCaptureOverlay overlay, NativeJsonValue json) {
        ...
        if (barcodeCaptureDeserializer != null) {
            ...
            this.f121480a.onOverlayDeserializationStarted((BarcodeCaptureDeserializer) orPut, barcodeCaptureOverlay, jsonValue);
        }
    }
    ...
    public void onSettingsDeserializationFinished(NativeBarcodeCaptureDeserializer deserializer, NativeBarcodeCaptureSettings settings, NativeJsonValue json) {
        ...
        if (barcodeCaptureDeserializer != null) {
            ...
            this.f121480a.onSettingsDeserializationFinished((BarcodeCaptureDeserializer) orPut, barcodeCaptureSettings, jsonValue);
        }
    }
    ...
    public void onSettingsDeserializationStarted(NativeBarcodeCaptureDeserializer deserializer, NativeBarcodeCaptureSettings settings, NativeJsonValue json) {
        ...
        if (barcodeCaptureDeserializer != null) {
            ...
            this.f121480a.onSettingsDeserializationStarted((BarcodeCaptureDeserializer) orPut, barcodeCaptureSettings, jsonValue);
        }
    }
    ...
    public BarcodeCaptureDeserializerListenerReversedAdapter(BarcodeCaptureDeserializerListener _BarcodeCaptureDeserializerListener, BarcodeCaptureDeserializer _BarcodeCaptureDeserializer, ProxyCache proxyCache) {
        ...
        this.f121480a = _BarcodeCaptureDeserializerListener;
        this.proxyCache = proxyCache;
        this.f121482c = new WeakReference(_BarcodeCaptureDeserializer);
    }
}
