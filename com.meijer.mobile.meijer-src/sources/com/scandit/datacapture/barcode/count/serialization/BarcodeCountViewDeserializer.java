...
public final class BarcodeCountViewDeserializer {
    ...
    private final ArrayList f121689a;

    /* renamed from: b, reason: collision with root package name */
    private final ArrayList f121690b;
    ...
    public final void updateViewFromJson(BarcodeCountView view, String json) {
        ...
        if (jsonValue.contains("style")) {
            this.f121689a.add("Can't use while updating: \"style\"");
        }
        ...
        this.f121689a.addAll(jsonValue._getWarnings());
    }
    ...
    public BarcodeCountViewDeserializer() {
        ...
        this.f121689a = arrayList;
        this.f121690b = arrayList;
    }
