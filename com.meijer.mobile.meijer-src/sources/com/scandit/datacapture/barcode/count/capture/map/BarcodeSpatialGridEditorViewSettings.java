...
public final class BarcodeSpatialGridEditorViewSettings implements BarcodeSpatialGridEditorViewSettingsProxy {
    ...
    private final /* synthetic */ BarcodeSpatialGridEditorViewSettingsProxyAdapter f121637a;
    ...
    public String getCancelMappingButtonText() {
        return this.f121637a.getCancelMappingButtonText();
    }
    ...
    public void setCancelMappingButtonText(String str) {
        ...
        this.f121637a.setCancelMappingButtonText(str);
    }
    ...
    public void setFinishMappingButtonText(String str) {
        Intrinsics.j(str, "<set-?>");
        this.f121637a.setFinishMappingButtonText(str);
    }
    ...
    public void setToteTextFormat(String str) {
        Intrinsics.j(str, "<set-?>");
        this.f121637a.setToteTextFormat(str);
    }
    ...
    public BarcodeSpatialGridEditorViewSettings() {
        ...
        this.f121637a = new BarcodeSpatialGridEditorViewSettingsProxyAdapter(nativeBarcodeSpatialGridEditorViewSettingsCreate, null, 2, null);
    }
}
