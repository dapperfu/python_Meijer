...
public final class TargetBarcode implements TargetBarcodeProxy {
    ...
    private final /* synthetic */ TargetBarcodeProxyAdapter f121607a;
    ...
    @NativeImpl
    /* renamed from: _impl */
    public NativeTargetBarcode getF121608a() {
        return this.f121607a.getF121608a();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.list.TargetBarcodeProxy
    @ProxyFunction
    public String getData() {
        return this.f121607a.getData();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.list.TargetBarcodeProxy
    @ProxyFunction
    public int getQuantity() {
        return this.f121607a.getQuantity();
    }

    /* JADX WARN: Multi-variable type inference failed */
    public TargetBarcode(NativeTargetBarcode impl) {
        Intrinsics.j(impl, "impl");
        this.f121607a = new TargetBarcodeProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    }
}
