...
public final class BarcodeCountCaptureListSession implements BarcodeCountCaptureListSessionProxy {
    ...
    private final Function0 f121603a;

    /* renamed from: b, reason: collision with root package name */
    private final Lazy f121604b;
    ...
    public BarcodeCountCaptureListSession(Function0<? extends NativeBarcodeCountCaptureListSession> getImpl) {
        ...
        this.f121603a = getImpl;
        this.f121604b = LazyKt.b(new h(this));
    }
    ...
    public NativeBarcodeCountCaptureListSession getF121605a() {
        return (NativeBarcodeCountCaptureListSession) this.f121603a.invoke();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.list.BarcodeCountCaptureListSessionProxy
    public List<TrackedBarcode> getAcceptedBarcodes() {
        return ((BarcodeCountCaptureListSessionProxyAdapter) this.f121604b.getValue()).getAcceptedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.list.BarcodeCountCaptureListSessionProxy
    public List<Barcode> getAdditionalBarcodes() {
        return ((BarcodeCountCaptureListSessionProxyAdapter) this.f121604b.getValue()).getAdditionalBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.list.BarcodeCountCaptureListSessionProxy
    public List<TrackedBarcode> getCorrectBarcodes() {
        return ((BarcodeCountCaptureListSessionProxyAdapter) this.f121604b.getValue()).getCorrectBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.list.BarcodeCountCaptureListSessionProxy
    public List<TargetBarcode> getMissingBarcodes() {
        return ((BarcodeCountCaptureListSessionProxyAdapter) this.f121604b.getValue()).getMissingBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.list.BarcodeCountCaptureListSessionProxy
    public List<TrackedBarcode> getRejectedBarcodes() {
        return ((BarcodeCountCaptureListSessionProxyAdapter) this.f121604b.getValue()).getRejectedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.list.BarcodeCountCaptureListSessionProxy
    public List<TrackedBarcode> getWrongBarcodes() {
        return ((BarcodeCountCaptureListSessionProxyAdapter) this.f121604b.getValue()).getWrongBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.list.BarcodeCountCaptureListSessionProxy
    public String toJson() {
        return ((BarcodeCountCaptureListSessionProxyAdapter) this.f121604b.getValue()).toJson();
    }
}
