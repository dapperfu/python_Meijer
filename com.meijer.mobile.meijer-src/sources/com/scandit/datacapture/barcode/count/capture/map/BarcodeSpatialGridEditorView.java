...
public final class BarcodeSpatialGridEditorView extends FrameLayout {
    ...
    private static final Lazy f121626i = LazyKt.b(b.f121646a);

    /* renamed from: j, reason: collision with root package name */
    private static final Lazy f121627j = LazyKt.b(a.f121645a);

    /* renamed from: a, reason: collision with root package name */
    private final BarcodeSpatialGrid f121628a;

    /* renamed from: b, reason: collision with root package name */
    private final BarcodeSpatialGridEditorViewSettings f121629b;

    /* renamed from: c, reason: collision with root package name */
    private final BinsView f121630c;

    /* renamed from: d, reason: collision with root package name */
    private final Button f121631d;

    /* renamed from: e, reason: collision with root package name */
    private final Button f121632e;

    /* renamed from: f, reason: collision with root package name */
    private final HintHolderV2 f121633f;

    /* renamed from: g, reason: collision with root package name */
    private final HintPresenterV2 f121634g;
    ...
    public static final class Companion {
        ...
        public static final float access$getMIN_BIN_VIEWS_HEIGHT_PX(Companion companion) {
            companion.getClass();
            return ((Number) BarcodeSpatialGridEditorView.f121627j.getValue()).floatValue();
        }

        public static final float access$getSPACE_NEEDED_FOR_BUTTONS_PX(Companion companion) {
            companion.getClass();
            return ((Number) BarcodeSpatialGridEditorView.f121626i.getValue()).floatValue();
        }
    }
    ...
    public static final void a(BarcodeSpatialGridEditorView this$0, View view) {
        ...
        if (barcodeSpatialGridEditorViewListener != null) {
            barcodeSpatialGridEditorViewListener.onEditingFinished(this$0, this$0.f121628a);
        }
    }
    ...
    protected void onSizeChanged(int w10, int h10, int oldw, int oldh) {
        ...
        this.f121630c.setScaleX(fN);
        this.f121630c.setScaleY(fN);
    }
    ...
    private BarcodeSpatialGridEditorView(Context context, BarcodeSpatialGrid barcodeSpatialGrid, BarcodeSpatialGridEditorViewSettings barcodeSpatialGridEditorViewSettings) {
        super(context);
        this.f121628a = barcodeSpatialGrid;
        this.f121629b = barcodeSpatialGridEditorViewSettings;
        ...
        this.f121633f = hintHolderV2Implementation;
        this.f121634g = new HintPresenterV2(hintHolderV2Implementation);
        BinsView.EditListener editListener = new BinsView.EditListener() { // from class: com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridEditorView$editListener$1
            ...
            public void onSubSwapped(int fromIndex, int toIndex) {
                this.f121636a.f121628a.getF121643a().swapSubsAtCoordinates(fromIndex / this.f121636a.f121628a.columns(), fromIndex % this.f121636a.f121628a.columns(), toIndex / this.f121636a.f121628a.columns(), toIndex % this.f121636a.f121628a.columns());
            }

            @Override // com.scandit.datacapture.barcode.internal.sdk.count.ui.mapeditor.components.BinsView.EditListener
            public void onToteSwapped(int fromIndex, int toIndex) {
                this.f121636a.f121628a.getF121643a().swapElementsAtCoordinates(fromIndex / this.f121636a.f121628a.columns(), fromIndex % this.f121636a.f121628a.columns(), toIndex / this.f121636a.f121628a.columns(), toIndex % this.f121636a.f121628a.columns());
            }
        };
        int i10 = 0;
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: com.scandit.datacapture.barcode.count.capture.map.g
            ...
            public final void onClick(View view) {
                BarcodeSpatialGridEditorView.a(this.f121651a, view);
            }
        });
        Intrinsics.i(viewFindViewById2, "also(...)");
        this.f121631d = button;
        ...
        button2.setOnClickListener(new View.OnClickListener() { // from class: com.scandit.datacapture.barcode.count.capture.map.h
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                BarcodeSpatialGridEditorView.b(this.f121652a, view);
            }
        });
        Intrinsics.i(viewFindViewById3, "also(...)");
        this.f121632e = button2;
        ...
        BarcodeSpatialGridEditorViewSettings barcodeSpatialGridEditorViewSettings2 = this.f121629b;
        ...
        this.f121631d.setText(this.f121629b.getFinishMappingButtonText());
        this.f121632e.setText(this.f121629b.getCancelMappingButtonText());
        Object obj = this.f121633f;
    ...
    public static final void a(BarcodeSpatialGridEditorView this$0) {
        Intrinsics.j(this$0, "this$0");
        this$0.f121634g.showToast(new ToastHint(NativeToastHintStyle.SUCCESS, this$0.f121629b.getReorderHintText(), null, true, 4, null));
    }
    ...
    protected void onAttachedToWindow() {
        ...
        postDelayed(new Runnable() { // from class: com.scandit.datacapture.barcode.count.capture.map.f
            ...
            public final void run() {
                BarcodeSpatialGridEditorView.a(this.f121650a);
            }
        }, 50L);
    }
}
