...
public final class BarcodeCountSettings implements BarcodeCountSettingsProxy {
    ...
    private final /* synthetic */ BarcodeCountSettingsProxyAdapter f121572a;

    /* renamed from: b, reason: collision with root package name */
    private boolean f121573b;

    /* renamed from: c, reason: collision with root package name */
    private long f121574c;

    /* JADX WARN: Multi-variable type inference failed */
    public BarcodeCountSettings(NativeBarcodeCountSettings impl) {
        Intrinsics.j(impl, "impl");
        this.f121572a = new BarcodeCountSettingsProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        this.f121573b = true;
        this.f121574c = 100L;
    }
    ...
    @NativeImpl
    /* renamed from: _impl */
    public NativeBarcodeCountSettings getF121575a() {
        return this.f121572a.getF121575a();
    }
    ...
    public SymbologySettings getSymbologySettings(Symbology symbology) {
        ...
        return this.f121572a.getSymbologySettings(symbology);
    }
    ...
    public void setClusteringMode(ClusteringMode clusteringMode) {
        ...
        this.f121572a.setClusteringMode(clusteringMode);
    }
    ...
    public void setDisableModeWhenCaptureListCompleted(boolean z10) {
        this.f121572a.setDisableModeWhenCaptureListCompleted(z10);
    }
    ...
    public void setSymbologyEnabled(Symbology symbology, boolean enabled) {
        Intrinsics.j(symbology, "symbology");
        this.f121572a.setSymbologyEnabled(symbology, enabled);
    }
        ...
        if (iHashCode != -1145110768) {
            if (iHashCode != -371273613) {
                if (iHashCode == 1444281501 && name.equals(PROPERTY_TRIGGER_AUTO_FOCUS_ON_SHUTTER)) {
                    return Boolean.valueOf(this.f121573b);
                }
            } else if (name.equals(PROPERTY_TRIGGER_AUTO_FOCUS_DELAY)) {
                return Long.valueOf(this.f121574c);
            }
        } else if (name.equals(PROPERTY_USE_IMU_DATA)) {
            return Boolean.valueOf(getF121575a().getShouldUseIMUData());
        }
        Integer intProperty = getF121575a().getIntProperty(name);
        if (intProperty != null) {
            iIntValue = intProperty.intValue();
        } else {
            Boolean boolProperty = getF121575a().getBoolProperty(name);
    ...
    public final void setProperty(String name, Object value) {
        ...
        if (iHashCode != -1145110768) {
            if (iHashCode != -371273613) {
                if (iHashCode == 1444281501 && name.equals(PROPERTY_TRIGGER_AUTO_FOCUS_ON_SHUTTER)) {
                    ...
                    if (boolBooleanFromAny != null) {
                        this.f121573b = boolBooleanFromAny.booleanValue();
                        return;
                    }
                    return;
                }
                ...
                if (lLongFromAny != null) {
                    this.f121574c = lLongFromAny.longValue();
                    return;
                }
                return;
            }
            ...
            if (boolBooleanFromAny2 != null) {
                getF121575a().setShouldUseIMUData(boolBooleanFromAny2.booleanValue());
                return;
            }
            return;
        }
        if (value instanceof Boolean) {
            getF121575a().setBoolProperty(name, ((Boolean) value).booleanValue());
            return;
        }
        Integer numIntFromAny = TypeConverter.INSTANCE.intFromAny(value);
        if (numIntFromAny != null) {
            getF121575a().setIntProperty(name, numIntFromAny.intValue());
        }
    }
