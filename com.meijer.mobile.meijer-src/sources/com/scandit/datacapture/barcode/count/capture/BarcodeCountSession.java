...
public final class BarcodeCountSession {
    ...
    private final InternalBarcodeCountSessionCallback f121566a;
    ...
    public final BarcodeSpatialGrid getSpatialMap(int expectedNumberOfRows, int expectedNumberOfColumns) {
        return (BarcodeSpatialGrid) this.f121566a.a().invoke(Integer.valueOf(expectedNumberOfRows), Integer.valueOf(expectedNumberOfColumns));
    }
    ...
    public final BarcodeSpatialGrid getSpatialMap() {
        return (BarcodeSpatialGrid) this.f121566a.a().invoke(null, null);
    }
    ...
    public final void reset() {
        this.f121566a.b().invoke();
    }

    public final String toJson() {
        return (String) this.f121566a.c().invoke();
    }
}
