...
public final class BarcodeCount implements DataCaptureMode, BarcodeCountProxy {
    ...
    private final InternalBarcodeCountSession f121551a;

    /* renamed from: b, reason: collision with root package name */
    private final /* synthetic */ BarcodeCountProxyAdapter f121552b;

    /* renamed from: c, reason: collision with root package name */
    private DataCaptureContext f121553c;

    @Keep
    private BarcodeCountCaptureList captureList;

    /* renamed from: d, reason: collision with root package name */
    private BarcodeCountSettings f121554d;
    ...
    public BarcodeCount(NativeBarcodeCount impl, InternalBarcodeCountSession session) {
        ...
        this.f121551a = session;
        this.f121552b = new BarcodeCountProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        this.f121554d = new BarcodeCountSettings();
        ...
        getF121563a().setSuccessFeedback(new BarcodeCount$setNativeFeedback$1(barcodeCountFeedbackDefaultFeedback));
        getF121563a().setUnrecognizedFeedback(new BarcodeCount$setNativeFeedback$2(barcodeCountFeedbackDefaultFeedback));
        getF121563a().setFailureFeedback(new BarcodeCount$setNativeFeedback$3(barcodeCountFeedbackDefaultFeedback));
    ...
    public NativeDataCaptureMode getF121380c() {
        return this.f121552b.getF121565c();
    }
    ...
    public NativeBarcodeCount getF121563a() {
        return this.f121552b.getF121563a();
    }
    ...
    public void _setBarcodeCountCaptureList(BarcodeCountCaptureList list) {
        ...
        this.f121552b._setBarcodeCountCaptureList(list);
    }
    ...
    public boolean _shouldDisableModeWhenCaptureListCompleted() {
        return this.f121552b._shouldDisableModeWhenCaptureListCompleted();
    }
    ...
    public BarcodeClusterEditor beginClusterEditing() {
        return this.f121552b.beginClusterEditing();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.BarcodeCountProxy
    @ProxyFunction(nativeName = "clearAdditionalBarcodes")
    public void clearAdditionalBarcodes() {
        this.f121552b.clearAdditionalBarcodes();
    }

    @Override // com.scandit.datacapture.core.capture.DataCaptureMode, com.scandit.datacapture.barcode.batch.capture.BarcodeBatchProxy
    @ProxyFunction(property = "isEnabled")
    public boolean isEnabled() {
        return this.f121552b.isEnabled();
    }

    @Override // com.scandit.datacapture.core.capture.DataCaptureMode, com.scandit.datacapture.barcode.batch.capture.BarcodeBatchProxy
    @ProxyFunction(property = "isEnabled")
    public void setEnabled(boolean z10) {
        this.f121552b.setEnabled(z10);
    }
    ...
    public final void _enableImuDataIfNeeded() {
        ...
        DataCaptureContext dataCaptureContext2 = this.f121553c;
        if ((dataCaptureContext2 == null || dataCaptureContext2._isCameraTimestampsRealtime()) && (dataCaptureContext = this.f121553c) != null) {
            Object property = this.f121554d.getProperty(BarcodeCountSettings.PROPERTY_USE_IMU_DATA);
    ...
    public final BarcodeCountSettings getF121554d() {
        return this.f121554d;
    }

    /* renamed from: _session, reason: from getter */
    public final InternalBarcodeCountSession getF121551a() {
    ...
    public void _setDataCaptureContext(DataCaptureContext dataCaptureContext) {
        this.f121553c = dataCaptureContext;
    ...
    public final void _setStatusListener$scandit_barcode_capture(NativeBarcodeCountStatusListener viewHandler) {
        ...
        getF121563a().setStatusListener(viewHandler);
    }
    ...
    public final void applySettings(BarcodeCountSettings settings, Runnable whenDone) {
        Intrinsics.j(settings, "settings");
        NativeWrappedFuture nativeWrappedFutureApplySettingsWrapped = getF121563a().applySettingsWrapped(settings._impl());
    ...
    public final void didAcceptNotInListBarcode$scandit_barcode_capture(TrackedBarcode trackedBarcode) {
        ...
        getF121563a().didAcceptNotInListBarcode(trackedBarcode.getF121422a());
    }

    public final void didRejectNotInListBarcode$scandit_barcode_capture(TrackedBarcode trackedBarcode) {
        Intrinsics.j(trackedBarcode, "trackedBarcode");
        getF121563a().didRejectNotInListBarcode(trackedBarcode.getF121422a());
    }

    public final void endScanningPhase() {
        endScanningPhase$scandit_barcode_capture(h.f121590a);
    }
    ...
    public final void endScanningPhase$scandit_barcode_capture(Function1<? super Boolean, Unit> whenDone) {
        ...
        setEnabled(false);
        DataCaptureContext f121553c = getF124698c();
        if (f121553c != null && (frameSource = f121553c.get_frameSource()) != null) {
    ...
    public final ClusteringMode getClusteringMode$scandit_barcode_capture() {
        return this.f121554d.getClusteringMode();
    }
    ...
    public final long getTriggerAutoFocusDelay$scandit_barcode_capture() {
        BarcodeCountSettings barcodeCountSettings = this.f121554d;
    ...
    public final void setAdditionalBarcodes(List<Barcode> additionalBarcodes) {
        ...
        NativeBarcodeCount nativeBarcodeCount_impl = getF121563a();
    ...
    public final void setBarcodeCountCaptureList(BarcodeCountCaptureList list) {
        ...
        list.getF121601a().addListenerAsync(new BarcodeCountCaptureListListenerReversedAdapter(new g(this), list, null, 4, null));
    }

    public final void setFeedback(BarcodeCountFeedback value) {
        Intrinsics.j(value, "value");
        this.feedback = value;
        getF121563a().setSuccessFeedback(new BarcodeCount$setNativeFeedback$1(value));
        getF121563a().setUnrecognizedFeedback(new BarcodeCount$setNativeFeedback$2(value));
        getF121563a().setFailureFeedback(new BarcodeCount$setNativeFeedback$3(value));
    ...
    public final void setInternalStatusProvider$scandit_barcode_capture(NativeBarcodeCountStatusProvider statusProvider) {
        ...
        getF121563a().setStatusProvider(statusProvider);
    }

    public final void _stopImuDataStream() {
        DataCaptureContext f121553c = getF124698c();
        if (f121553c != null) {
            f121553c._setShouldUseImuData(false);
        }
    }
    ...
    public final void startScanningPhase() {
        getF121563a().activateState(BarcodeCountState.SCANNING);
    }
    ...
    public BarcodeCount(DataCaptureContext dataCaptureContext, BarcodeCountSettings barcodeCountSettings, DefaultConstructorMarker defaultConstructorMarker) {
        NativeBarcodeCount nativeBarcodeCountCreate = NativeBarcodeCount.create(dataCaptureContext != null ? dataCaptureContext.getF125005a() : null, barcodeCountSettings._impl());
        ...
        _enableImuDataIfNeeded();
        this.f121554d = barcodeCountSettings;
        _enableImuDataIfNeeded();
    }
}
