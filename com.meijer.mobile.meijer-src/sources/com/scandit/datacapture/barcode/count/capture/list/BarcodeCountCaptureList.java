...
public final class BarcodeCountCaptureList implements BarcodeCountCaptureListProxy {
    ...
    private final BarcodeCountCaptureListSession f121595a;

    /* renamed from: b, reason: collision with root package name */
    private final /* synthetic */ BarcodeCountCaptureListProxyAdapter f121596b;

    /* renamed from: c, reason: collision with root package name */
    private BarcodeDataTransformer f121597c;
    ...
    public static final class Companion {
        ...
        public final BarcodeCountCaptureList create(BarcodeCountCaptureListListener listener, List<TargetBarcode> targetBarcodes) {
            ...
            barcodeCountCaptureList.getF121601a().addListenerAsync(new BarcodeCountCaptureListListenerReversedAdapter(listener, barcodeCountCaptureList, null, 4, null));
    ...
    @NativeImpl
    /* renamed from: _impl */
    public NativeBarcodeCountCaptureList getF121601a() {
        return this.f121596b.getF121601a();
    }
    ...
    public BarcodeCountCaptureList(NativeBarcodeCountCaptureList impl, BarcodeCountCaptureListSession session) {
        ...
        this.f121595a = session;
        this.f121596b = new BarcodeCountCaptureListProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    }

    /* renamed from: _session, reason: from getter */
    public final BarcodeCountCaptureListSession getF121595a() {
    ...
    public final void setBarcodeDataTransformer(BarcodeDataTransformer transformer) {
        ...
        this.f121597c = transformer;
        getF121601a().setBarcodeCountTransformer(new com.scandit.datacapture.barcode.internal.module.common.a(transformer));
    }

    public final int getTargetBarcodesQuantity$scandit_barcode_capture() {
        return getF121601a().getTargetBarcodesQuantity();
    }
}
