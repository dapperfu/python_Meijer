...
public final class BarcodeCountCaptureListProxyAdapter implements BarcodeCountCaptureListProxy {
    ...
    private final NativeBarcodeCountCaptureList f121601a;
    ...
    public BarcodeCountCaptureListProxyAdapter(NativeBarcodeCountCaptureList _NativeBarcodeCountCaptureList, ProxyCache proxyCache) {
        Intrinsics.j(_NativeBarcodeCountCaptureList, "_NativeBarcodeCountCaptureList");
        Intrinsics.j(proxyCache, "proxyCache");
        this.f121601a = _NativeBarcodeCountCaptureList;
    ...
    public /* synthetic */ BarcodeCountCaptureListProxyAdapter(NativeBarcodeCountCaptureList nativeBarcodeCountCaptureList, ProxyCache proxyCache, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(nativeBarcodeCountCaptureList, (i10 & 2) != 0 ? ProxyCacheKt.getGlobalProxyCache() : proxyCache);
    }
}
