...
public final class a extends Lambda implements Function0 {
    ...
    public final /* synthetic */ NativeBarcodeCountCaptureList f121610a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public a(NativeBarcodeCountCaptureList nativeBarcodeCountCaptureList) {
        super(0);
        this.f121610a = nativeBarcodeCountCaptureList;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        NativeBarcodeCountCaptureListSession session = this.f121610a.getSession();
