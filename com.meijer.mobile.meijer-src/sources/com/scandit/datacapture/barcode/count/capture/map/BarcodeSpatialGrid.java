...
public final class BarcodeSpatialGrid implements BarcodeSpatialGridProxy {
    ...
    private final /* synthetic */ BarcodeSpatialGridProxyAdapter f121625a;
    ...
    public NativeBarcodeSpatialGrid getF121643a() {
        return this.f121625a.getF121643a();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridProxy
    @ProxyFunction
    public int columns() {
        return this.f121625a.columns();
    }
    ...
    public List<Coordinate2d> coordinatesForElement(BarcodeSpatialGridElement element) {
        ...
        return this.f121625a.coordinatesForElement(element);
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridProxy
    @ProxyFunction
    public BarcodeSpatialGridElement elementAt(int row, int column) {
        return this.f121625a.elementAt(row, column);
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridProxy
    @ProxyFunction
    public int rows() {
        return this.f121625a.rows();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridProxy
    @ProxyFunction
    public String toJson() {
        return this.f121625a.toJson();
    }

    /* JADX WARN: Multi-variable type inference failed */
    public BarcodeSpatialGrid(NativeBarcodeSpatialGrid impl) {
        Intrinsics.j(impl, "impl");
        this.f121625a = new BarcodeSpatialGridProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    }

    public final List<BarcodeSpatialGridElement> column(int index) {
        BarcodeSpatialGridElement barcodeSpatialGridElement;
        ArrayList<NativeBarcodeSpatialGridElement> arrayListColumn = getF121643a().column(index);
    ...
    public final List<BarcodeSpatialGridElement> row(int index) {
        BarcodeSpatialGridElement barcodeSpatialGridElement;
        ArrayList<NativeBarcodeSpatialGridElement> arrayListRow = getF121643a().row(index);
