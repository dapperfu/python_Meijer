...
public final class BarcodeSpatialGridProxyAdapter implements BarcodeSpatialGridProxy {
    ...
    private final NativeBarcodeSpatialGrid f121643a;
    ...
    public BarcodeSpatialGridProxyAdapter(NativeBarcodeSpatialGrid _NativeBarcodeSpatialGrid, ProxyCache proxyCache) {
        ...
        this.f121643a = _NativeBarcodeSpatialGrid;
        this.proxyCache = proxyCache;
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridProxy
    /* renamed from: _impl, reason: from getter */
    public NativeBarcodeSpatialGrid getF121643a() {
        return this.f121643a;
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridProxy
    public int columns() {
        return this.f121643a.columns();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridProxy
    public List<Coordinate2d> coordinatesForElement(BarcodeSpatialGridElement element) {
        Intrinsics.j(element, "element");
        NativeBarcodeSpatialGridElement f121641a = element.getF121641a();
        this.proxyCache.put(Reflection.b(NativeBarcodeSpatialGridElement.class), null, f121641a, element);
        ArrayList<Coordinate2d> arrayListCoordinatesForElement = this.f121643a.coordinatesForElement(f121641a);
    ...
    public BarcodeSpatialGridElement elementAt(int row, int column) {
        NativeBarcodeSpatialGridElement nativeBarcodeSpatialGridElementElementAt = this.f121643a.elementAt(row, column);
    ...
    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridProxy
    public int rows() {
        return this.f121643a.rows();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.map.BarcodeSpatialGridProxy
    public String toJson() {
        String json = this.f121643a.toJson();
        Intrinsics.g(json);
        return json;
    }
