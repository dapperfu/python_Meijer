...
public final class f implements InternalBarcodeCountListener {
    ...
    public final WeakReference f121588a;
    ...
    public f(BarcodeCount owner) {
        ...
        this.f121588a = new WeakReference(owner);
    }
    ...
    public final void a(BarcodeCount mode, InternalBarcodeCountSession session, FrameData data) {
        ...
        BarcodeCount barcodeCount = (BarcodeCount) this.f121588a.get();
        ...
        BarcodeCount barcodeCount2 = (BarcodeCount) this.f121588a.get();
