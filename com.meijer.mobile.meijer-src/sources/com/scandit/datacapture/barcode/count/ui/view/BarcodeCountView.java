...
public final class BarcodeCountView extends RelativeLayout {
    ...
    private final BarcodeCountViewLayerManager f121783a;

    /* renamed from: b, reason: collision with root package name */
    private final BarcodeCountDataCaptureViewHolder f121784b;

    /* renamed from: c, reason: collision with root package name */
    private final BarcodeCountBasicOverlay f121785c;

    /* renamed from: d, reason: collision with root package name */
    private final BarcodeCountViewUiLayoutHelper f121786d;

    /* renamed from: e, reason: collision with root package name */
    private final BarcodeCountUiPresenter f121787e;

    /* renamed from: f, reason: collision with root package name */
    private final BarcodeCountBrushHandler f121788f;

    /* renamed from: g, reason: collision with root package name */
    private final BarcodeIndicatorPresenter f121789g;

    /* renamed from: h, reason: collision with root package name */
    private final BarcodeCountInternalModePresenter f121790h;

    /* renamed from: i, reason: collision with root package name */
    private final BarcodeCountCameraHandler f121791i;

    /* renamed from: j, reason: collision with root package name */
    private final MainThreadHelper f121792j;

    /* renamed from: k, reason: collision with root package name */
    private final Handler f121793k;

    /* renamed from: l, reason: collision with root package name */
    private final WeakReference f121794l;
    ...
    public static final class Companion {
        ...
        public final BarcodeCountView newInstanceForMapping(Context context, DataCaptureView dataCaptureView, BarcodeCount mode, BarcodeCountViewStyle style, BarcodeCountMappingFlowSettings mappingFlowSettings) {
            ...
            return com.scandit.datacapture.barcode.internal.module.count.ui.f.a(context, dataCaptureView, mode, style, new com.scandit.datacapture.barcode.internal.module.count.ui.mode.b(mappingFlowSettings, com.scandit.datacapture.barcode.internal.module.count.ui.mappingflow.a.f122656a));
        }
        ...
        public final BarcodeCountView newInstance(Context context, DataCaptureView dataCaptureView, BarcodeCount mode, BarcodeCountViewStyle style) {
            ...
            Intrinsics.j(mode, "mode");
            Intrinsics.j(style, "style");
            return com.scandit.datacapture.barcode.internal.module.count.ui.f.a(context, dataCaptureView, mode, style, com.scandit.datacapture.barcode.internal.module.count.ui.mode.a.f122698a);
        }
        ...
        public final BarcodeCountView newInstanceForMapping(Context context, DataCaptureContext dataCaptureContext, BarcodeCount mode, BarcodeCountViewStyle style, BarcodeCountMappingFlowSettings mappingFlowSettings) {
            ...
            return com.scandit.datacapture.barcode.internal.module.count.ui.f.a(context, dataCaptureViewNewInstance, mode, style, new com.scandit.datacapture.barcode.internal.module.count.ui.mode.b(mappingFlowSettings, com.scandit.datacapture.barcode.internal.module.count.ui.mappingflow.a.f122656a));
        }
    ...
    public /* synthetic */ BarcodeCountView(Context context, BarcodeCount barcodeCount, BarcodeCountViewLayerManager barcodeCountViewLayerManager, BarcodeCountDataCaptureViewHolder barcodeCountDataCaptureViewHolder, BarcodeCountBasicOverlay barcodeCountBasicOverlay, BarcodeCountViewUiLayoutHelper barcodeCountViewUiLayoutHelper, BarcodeCountUiPresenter barcodeCountUiPresenter, BarcodeCountBrushHandler barcodeCountBrushHandler, BarcodeIndicatorPresenter barcodeIndicatorPresenter, BarcodeCountInternalModePresenter barcodeCountInternalModePresenter, BarcodeCountInternalMode barcodeCountInternalMode, BarcodeCountCameraHandler barcodeCountCameraHandler, MainThreadHelper mainThreadHelper, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        BarcodeCountInternalMode barcodeCountInternalMode2 = (i10 & 1024) != 0 ? com.scandit.datacapture.barcode.internal.module.count.ui.mode.a.f122698a : barcodeCountInternalMode;
    ...
    private final RelativeLayout.LayoutParams a(Size size) {
        BarcodeCountScreenRatioForUi barcodeCountScreenRatioForUiI = this.f121786d.i();
    ...
    public static final void b(BarcodeCountView this$0) {
        ...
        this$0.d();
        this$0.f121792j.runOnMainThread(new o(this$0));
    }
    ...
    public static final void access$hideActionPopup(BarcodeCountView barcodeCountView, NativeTrackedBarcode nativeTrackedBarcode) {
        if (barcodeCountView.f121789g.b() || nativeTrackedBarcode == null) {
            return;
        }
        barcodeCountView.f121787e.k();
        barcodeCountView.f121789g.a(new TrackedBarcode(nativeTrackedBarcode));
    }

    public static final void access$onBarcodeStatusesLoading(BarcodeCountView barcodeCountView) {
        barcodeCountView.f121789g.b(false, true);
        barcodeCountView.f121789g.a(true, true);
    }
    ...
    public static final void access$onToolbarColorSchemeChanged(BarcodeCountView barcodeCountView, NativeBarcodeCountBasicOverlayColorScheme nativeBarcodeCountBasicOverlayColorScheme) {
        barcodeCountView.f121789g.a(nativeBarcodeCountBasicOverlayColorScheme);
        barcodeCountView.f121789g.a(barcodeCountView.viewSettings);
    }

    public static final void access$setListUiEnabled(BarcodeCountView barcodeCountView, boolean z10, int i10) {
        barcodeCountView.f121797o = z10;
        barcodeCountView.f121787e.b(z10);
        BarcodeCountUiPresenter barcodeCountUiPresenter = barcodeCountView.f121787e;
        ...
        barcodeCountView.f121789g.a(z10);
        if (barcodeCountView.isAttachedToWindow()) {
            barcodeCountView.f121792j.runOnMainThread(new o(barcodeCountView));
            barcodeCountView.f121792j.runOnMainThread(new n(barcodeCountView, i10));
        }
    }
    ...
    public static final void access$showActionPopup(BarcodeCountView barcodeCountView, NativeTrackedBarcode nativeTrackedBarcode, NativeBarcodeCountNotInListStatus nativeBarcodeCountNotInListStatus) {
        if (barcodeCountView.f121789g.b() || nativeTrackedBarcode == null || nativeBarcodeCountNotInListStatus == null) {
            return;
        }
        barcodeCountView.f121787e.h();
        barcodeCountView.f121789g.a(new TrackedBarcode(nativeTrackedBarcode), nativeBarcodeCountNotInListStatus);
    }

    public static final void access$updateModeFeedback(BarcodeCountView barcodeCountView) {
        BarcodeCount barcodeCount = (BarcodeCount) barcodeCountView.f121794l.get();
        if (barcodeCount != null) {
            barcodeCountView.f121787e.a(barcodeCount);
        }
    }
    ...
    private final void c() {
        post(new Runnable() { // from class: com.scandit.datacapture.barcode.count.ui.view.p
            ...
            public final void run() {
                BarcodeCountView.b(this.f121817a);
            }
        });
    }
    ...
    private final void d() {
        Size sizeA = a();
        BarcodeCountUiPresenter barcodeCountUiPresenter = this.f121787e;
        ...
        this.f121784b.a(layoutParamsA);
        this.f121783a.a(layoutParamsA);
        Context context = getContext();
        Intrinsics.i(context, "getContext(...)");
        if (com.scandit.datacapture.barcode.internal.module.extensions.b.a(context) || this.f121786d.i() == BarcodeCountScreenRatioForUi.SMALL || get_forceAlignCameraPreviewToBottomInPortrait()) {
            this.f121783a.c().setLayoutParams(a(sizeA));
        }
        BarcodeCountUiPresenter barcodeCountUiPresenter2 = this.f121787e;
        boolean z10 = this.f121797o;
    ...
    private final void e() {
        this.f121787e.a(this.viewSettings);
        this.f121792j.runOnMainThread(new o(this));
    }
    ...
    public final void _setProfilingOverlay(ProfilingOverlay overlay) {
        ...
        this.f121785c._setProfilingOverlay(overlay);
    }

    public final void clearHighlights() {
        this.f121785c.clearHighlights();
    }

    public final void disableScanningAndResetBarcodeIndicators$scandit_barcode_capture() {
        BarcodeCount barcodeCount = (BarcodeCount) this.f121794l.get();
        if (barcodeCount != null) {
    ...
    public final BarcodeCountViewStyle getStyle() {
        return BarcodeCountViewStyleExtensionKt.toViewStyle(this.f121785c.getStyle());
    }
    ...
    public final BarcodeCountViewUiListener getUiListener() {
        BarcodeCountBasicOverlayUiListener uiListener = this.f121785c.getUiListener();
        d dVar = uiListener instanceof d ? (d) uiListener : null;
        if (dVar != null) {
            return dVar.f121804a;
        }
        return null;
    }
    ...
    public final void setUiListener(BarcodeCountViewUiListener barcodeCountViewUiListener) {
        this.f121785c.setUiListener(barcodeCountViewUiListener != null ? new d(this, barcodeCountViewUiListener) : null);
    }
    ...
    public final void set_internalUiListener(BarcodeCountViewInternalUiListener barcodeCountViewInternalUiListener) {
        this.f121787e.a(barcodeCountViewInternalUiListener);
    }
    ...
    public static final void access$onHardwareKeyEvent(BarcodeCountView barcodeCountView, HardwareKeyEvent hardwareKeyEvent) {
        ...
        if (WhenMappings.$EnumSwitchMapping$1[hardwareKeyEvent.ordinal()] == 1) {
            barcodeCountView.f121787e.i();
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void b() {
        this.f121793k.post(new Runnable() { // from class: com.scandit.datacapture.barcode.count.ui.view.q
            @Override // java.lang.Runnable
            public final void run() {
                BarcodeCountView.a(this.f121818a);
            }
        });
    }
    ...
    protected void onAttachedToWindow() {
        ...
        d();
        this.f121784b.b(this.f121785c);
        BarcodeCount barcodeCount = (BarcodeCount) this.f121794l.get();
        if (barcodeCount != null) {
            this.f121787e.a(barcodeCount);
        }
        setShouldShowFloatingShutterButton(this.f121787e.e());
        BarcodeIndicatorPresenter barcodeIndicatorPresenter = this.f121789g;
        barcodeIndicatorPresenter.a(this.f121785c.getColorScheme$scandit_barcode_capture());
        barcodeIndicatorPresenter.a(this.f121783a.d());
        barcodeIndicatorPresenter.a(this.viewSettings);
        BarcodeCount barcodeCount2 = (BarcodeCount) this.f121794l.get();
        if (barcodeCount2 != null && barcodeCount2.isCaptureListSet$scandit_barcode_capture()) {
            ...
            this.f121797o = true;
            this.f121787e.b(true);
            BarcodeCountUiPresenter barcodeCountUiPresenter = this.f121787e;
            Context context = getContext();
            Intrinsics.i(context, "getContext(...)");
            barcodeCountUiPresenter.a(true, com.scandit.datacapture.barcode.internal.module.extensions.b.a(context));
            this.f121789g.a(true);
            if (isAttachedToWindow()) {
                this.f121792j.runOnMainThread(new o(this));
                this.f121792j.runOnMainThread(new n(this, captureListTargetQuantity$scandit_barcode_capture));
                return;
            }
            return;
        }
        this.f121792j.runOnMainThread(new o(this));
        this.f121792j.runOnMainThread(new n(this, 0));
    }

    @Override // android.view.ViewGroup, android.view.View
    protected void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f121784b.a(this.f121785c);
        this.f121789g.reset();
    }
    ...
    public BarcodeCountView(Context context, BarcodeCount barcodeCount, BarcodeCountViewLayerManager layerManager, BarcodeCountDataCaptureViewHolder dataCaptureViewWrapper, BarcodeCountBasicOverlay overlay, BarcodeCountViewUiLayoutHelper layoutHelper, BarcodeCountUiPresenter uiHandler, BarcodeCountBrushHandler brushHandler, BarcodeIndicatorPresenter indicatorPresenter, BarcodeCountInternalModePresenter internalModePresenter, BarcodeCountInternalMode internalMode, BarcodeCountCameraHandler cameraHandler, MainThreadHelper mainThreadHelper) {
        ...
        this.f121783a = layerManager;
        this.f121784b = dataCaptureViewWrapper;
        this.f121785c = overlay;
        this.f121786d = layoutHelper;
        this.f121787e = uiHandler;
        this.f121788f = brushHandler;
        this.f121789g = indicatorPresenter;
        this.f121790h = internalModePresenter;
        this.f121791i = cameraHandler;
        this.f121792j = mainThreadHelper;
        this.f121793k = new Handler(Looper.getMainLooper());
        a aVar = new a(this);
        WeakReference weakReference = new WeakReference(barcodeCount);
        this.f121794l = weakReference;
    ...
    public final void a(boolean z10) {
        if (z10) {
            this.f121787e.d();
            this.f121789g.b(false, true);
            this.f121789g.a(true, true);
        } else if (this.viewSettings.w()) {
            this.f121789g.b(false, true);
            this.f121789g.a(true, true);
            this.f121789g.b(true);
        } else {
            this.f121789g.a(false, true);
            this.f121789g.b(true, true);
            this.f121787e.l();
        }
    }
}
