...
import com.scandit.datacapture.barcode.internal.module.count.ui.handlers.InterfaceC13224a;
...
public final class BarcodeCountBasicOverlay extends ViewBasedDataCaptureOverlay implements DataCaptureOverlay, InterfaceC13224a, BarcodeCountBasicOverlayProxy {

    /* renamed from: Companion, reason: from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);

    /* renamed from: a, reason: collision with root package name */
    private final /* synthetic */ BarcodeCountBasicOverlayProxyAdapter f121711a;
    ...
    private WeakReference f121720j;

    /* renamed from: k, reason: collision with root package name */
    private final C13190a f121721k;
    ...
    public static final class Companion {
        ...
        public final BarcodeCountBasicOverlay newInstance(BarcodeCount mode, DataCaptureView view) {
            ...
            OverlayPreconditionsKt.checkAttachedToSameDataCaptureContext(mode, view, C13191b.f121734a);
        ...
        public final BarcodeCountBasicOverlay newInstance(DataCaptureView view, BarcodeCount mode, NativeBarcodeCountBasicOverlayStyle style) {
            ...
            OverlayPreconditionsKt.checkAttachedToSameDataCaptureContext(mode, view, C13192c.f121735a);
    ...
    public BarcodeCountBasicOverlay(NativeBarcodeCountBasicOverlay impl, DataCaptureView dataCaptureView) {
        ...
        this.f121711a = new BarcodeCountBasicOverlayProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        ...
        this.f121720j = new WeakReference(dataCaptureView);
        this.f121721k = new C13190a(this);
        impl.setListener(new BarcodeCountBasicOverlayListenerReversedAdapter(new C13193d(this), this, null, 4, null));
        impl.setUiListener(new BarcodeCountBasicOverlayUiListenerReversedAdapter(new C13193d(this), this, null, 4, null));
    }
    ...
    public NativeDataCaptureOverlay getF121727c() {
        return this.f121711a.getF121727c();
    }
    ...
    public NativeBarcodeCountBasicOverlay getF121725a() {
        return this.f121711a.getF121725a();
    }
    ...
    public void _setProfilingOverlay(ProfilingOverlay overlay) {
        ...
        this.f121711a._setProfilingOverlay(overlay);
    }

    @Override // com.scandit.datacapture.barcode.count.ui.overlay.BarcodeCountBasicOverlayProxy
    @ProxyFunction
    public NativeBarcodeClusterLiveEditor beginClusterEditing() {
        return this.f121711a.beginClusterEditing();
    }
    ...
    public void didAcceptNotInListBarcode(TrackedBarcode barcode) {
        ...
        this.f121711a.didAcceptNotInListBarcode(barcode);
    }
    ...
    public void didCancelNotInListBarcode(TrackedBarcode barcode) {
        Intrinsics.j(barcode, "barcode");
        this.f121711a.didCancelNotInListBarcode(barcode);
    }
    ...
    public void didRejectNotInListBarcode(TrackedBarcode barcode) {
        Intrinsics.j(barcode, "barcode");
        this.f121711a.didRejectNotInListBarcode(barcode);
    }
    ...
    public void setFilterSettings(BarcodeFilterHighlightSettings barcodeFilterHighlightSettings) {
        this.f121711a.setFilterSettings(barcodeFilterHighlightSettings);
    }
    ...
    public void setShouldShowScanAreaGuides(boolean z10) {
        this.f121711a.setShouldShowScanAreaGuides(z10);
    }
    ...
    public void setShouldShowStatusIconsOnScan(boolean z10) {
        this.f121711a.setShouldShowStatusIconsOnScan(z10);
    }
    ...
    public void setTextForBarcodesNotInListDetectedHint(String text) {
        ...
        this.f121711a.setTextForBarcodesNotInListDetectedHint(text);
    }
    ...
    public void setTextForClusteringGestureHint(String text) {
        Intrinsics.j(text, "text");
        this.f121711a.setTextForClusteringGestureHint(text);
    }
    ...
    public void setTextForMoveCloserAndRescanHint(String text) {
        Intrinsics.j(text, "text");
        this.f121711a.setTextForMoveCloserAndRescanHint(text);
    }
    ...
    public void setTextForMoveFurtherAndRescanHint(String text) {
        Intrinsics.j(text, "text");
        this.f121711a.setTextForMoveFurtherAndRescanHint(text);
    }
    ...
    public void setTextForScanningHint(String text) {
        Intrinsics.j(text, "text");
        this.f121711a.setTextForScanningHint(text);
    }
    ...
    public void setTextForScreenCleanedUpHint(String text) {
        Intrinsics.j(text, "text");
        this.f121711a.setTextForScreenCleanedUpHint(text);
    }
    ...
    public void setTextForTapShutterToScanHint(String text) {
        Intrinsics.j(text, "text");
        this.f121711a.setTextForTapShutterToScanHint(text);
    }
    ...
    public void setTextForTapToUncountHint(String text) {
        Intrinsics.j(text, "text");
        this.f121711a.setTextForTapToUncountHint(text);
    }
    ...
    public void setTextForUnrecognizedBarcodesInClusterHint(String text) {
        Intrinsics.j(text, "text");
        this.f121711a.setTextForUnrecognizedBarcodesInClusterHint(text);
    }
    ...
    public void setTextForUnscannedBarcodesDetectedHint(String text) {
        Intrinsics.j(text, "text");
        this.f121711a.setTextForUnscannedBarcodesDetectedHint(text);
    }
    ...
    public void _setDataCaptureView(DataCaptureView view) {
        ...
        this.f121720j = new WeakReference(view);
        if (!isAttachedToWindow() || (dataCaptureView = (DataCaptureView) this.f121720j.get()) == null) {
            return;
        }
        dataCaptureView.addListener(this.f121721k);
        C13190a c13190a = this.f121721k;
        int width = dataCaptureView.getWidth();
        int height = dataCaptureView.getHeight();
        Context context = getContext();
        Intrinsics.i(context, "getContext(...)");
        c13190a.onSizeChanged(width, height, ContextExtensionsKt.getRotation(context));
    }
    ...
    public final void applyNotInListActionSettings$scandit_barcode_capture(BarcodeCountNotInListActionSettings settings) {
        ...
        getF121725a().applyNotInListActionSettings(settings.toNative$scandit_barcode_capture());
    }

    @Override // com.scandit.datacapture.barcode.internal.module.count.ui.handlers.InterfaceC13224a
    public Brush brushForAcceptedBarcodeNotInList(TrackedBarcode barcode) {
        Intrinsics.j(barcode, "barcode");
        NativeBrush nativeBrushBrushForAcceptedBarcode = getF121725a().brushForAcceptedBarcode(barcode.getF121422a());
    ...
    public Brush brushForRejectedBarcodeNotInList(TrackedBarcode barcode) {
        Intrinsics.j(barcode, "barcode");
        NativeBrush nativeBrushBrushForRejectedBarcode = getF121725a().brushForRejectedBarcode(barcode.getF121422a());
    ...
    public Brush brushForTrackedBarcode(TrackedBarcode barcode) {
        Intrinsics.j(barcode, "barcode");
        NativeBrush nativeBrushBrushForTrackedBarcode = getF121725a().brushForTrackedBarcode(barcode.getF121422a());
    ...
    public Brush brushForTrackedBarcodeNotInList(TrackedBarcode barcode) {
        Intrinsics.j(barcode, "barcode");
        NativeBrush nativeBrushBrushForTrackedBarcodeNotInList = getF121725a().brushForTrackedBarcodeNotInList(barcode.getF121422a());
    ...
    public Brush brushForUnscannedTrackedBarcode(TrackedBarcode barcode) {
        Intrinsics.j(barcode, "barcode");
        NativeBrush nativeBrushBrushForUnscannedTrackedBarcode = getF121725a().brushForUnscannedTrackedBarcode(barcode.getF121422a());
    ...
    public Brush getRejectedNotInListBrush() {
        Brush.Companion companion = Brush.INSTANCE;
        NativeBrush rejectedBrush = getF121725a().getRejectedBrush();
    ...
    public final void setColorScheme$scandit_barcode_capture(NativeBarcodeCountBasicOverlayColorScheme value) {
        ...
        getF121725a().setColorScheme(value);
    }
    ...
    public final void setGuidanceHandler$scandit_barcode_capture(NativeBarcodeCountGuidanceHandler guidanceHandler) {
        ...
        getF121725a().setGuidanceHandler(guidanceHandler);
    }
    ...
    public final void setViewHandler$scandit_barcode_capture(NativeBarcodeCountViewHandler viewHandler) {
        ...
        getF121725a().setViewHandler(viewHandler);
    }

    @Override // com.scandit.datacapture.barcode.internal.module.count.ui.handlers.InterfaceC13224a
    public Brush brushFromFilterSettings() {
        NativeBrush brush;
        NativeBarcodeFilterOverlaySettings filterSettings = getF121725a().getFilterSettings();
    ...
    public final void clearHighlights() {
        getF121725a().clearHighlightsButtonPressed();
    }

    public final void exitButtonPressed() {
        getF121725a().exitButtonPressed();
    }

    public final NativeBarcodeCountBasicOverlayColorScheme getColorScheme$scandit_barcode_capture() {
        NativeBarcodeCountBasicOverlayColorScheme colorScheme = getF121725a().getColorScheme();
    ...
    public Brush getNotInListBrush() {
        NativeBrush notInListBrush = getF121725a().getNotInListBrush();
    ...
    public Brush getRecognizedBrush() {
        NativeBrush scannedBrush = getF121725a().getScannedBrush();
    ...
    public final boolean getShouldShowHints() {
        return getF121725a().isHintsEnabled();
    }

    @Override // com.scandit.datacapture.barcode.internal.module.count.ui.handlers.InterfaceC13224a
    public Brush getUnrecognizedBrush() {
        NativeBrush unscannedBrush = getF121725a().getUnscannedBrush();
    ...
    protected void onAttachedToWindow() {
        ...
        if (this.f121720j.get() != null && (dataCaptureView = (DataCaptureView) this.f121720j.get()) != null) {
            dataCaptureView.addListener(this.f121721k);
            C13190a c13190a = this.f121721k;
            int width = dataCaptureView.getWidth();
            int height = dataCaptureView.getHeight();
    ...
    protected void onDetachedFromWindow() {
        ...
        DataCaptureView dataCaptureView = (DataCaptureView) this.f121720j.get();
        if (dataCaptureView != null) {
            dataCaptureView.removeListener(this.f121721k);
        }
    }

    public void setAcceptedNotInListBrush(Brush brush) {
        NativeBrush nativeBrushConvert;
        NativeBarcodeCountBasicOverlay nativeBarcodeCountBasicOverlay_impl = getF121725a();
        if (brush != null) {
    ...
    public final void shutterButtonPressed() {
        getF121725a().shutterButtonPressed();
    }
