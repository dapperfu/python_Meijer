...
public final class BarcodeCountStatusItem implements BarcodeCountStatusItemProxy {
    ...
    private final /* synthetic */ BarcodeCountStatusItemProxyAdapter f121821a;
    ...
    public static final class Companion {
        ...
        public final BarcodeCountStatusItem create(TrackedBarcode barcode, BarcodeCountStatus status) {
            ...
            NativeBarcodeCountStatusItem nativeBarcodeCountStatusItemCreate = NativeBarcodeCountStatusItem.create(barcode.getF121422a(), status);
    ...
    @NativeImpl
    /* renamed from: _impl */
    public NativeBarcodeCountStatusItem getF121824a() {
        return this.f121821a.getF121824a();
    }

    public BarcodeCountStatusItem(NativeBarcodeCountStatusItem impl) {
        Intrinsics.j(impl, "impl");
        this.f121821a = new BarcodeCountStatusItemProxyAdapter(impl, null, 2, null);
        NativeTrackedBarcode trackedBarcode = getF121824a().getTrackedBarcode();
        Intrinsics.i(trackedBarcode, "getTrackedBarcode(...)");
        this.barcode = new TrackedBarcode(trackedBarcode);
        BarcodeCountStatus status = getF121824a().getStatus();
