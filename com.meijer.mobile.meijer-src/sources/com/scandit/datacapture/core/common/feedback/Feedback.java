...
public final class Feedback {
    ...
    private final FeedbackEmitter f125070c;
    ...
    public final void loadSoundResourceInternal$scandit_capture_core() {
        this.f125070c.loadAsync();
    }

    public final void release() {
        this.f125070c.releaseAsync();
    }
    ...
    public Feedback(Vibration vibration, Sound sound) {
        ...
        this.sound = sound;
        this.f125070c = FeedbackEmitterFactoryHolder.INSTANCE.getInstance().create(vibration, sound, AppAndroidEnvironment.INSTANCE.getApplicationContext());
