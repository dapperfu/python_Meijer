...
public final class DataCaptureContextDeserializerProxyAdapter implements DataCaptureContextDeserializerProxy {
    ...
    private final NativeDataCaptureContextDeserializer f125040a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private DataCaptureContextDeserializer f125042c;
    ...
    public DataCaptureContextDeserializerProxyAdapter(NativeDataCaptureContextDeserializer _NativeDataCaptureContextDeserializer, ProxyCache proxyCache) {
        ...
        this.f125040a = _NativeDataCaptureContextDeserializer;
    ...
    public void _setHelper(DataCaptureContextDeserializerHelper helper) {
        this.f125040a.setHelper(helper != null ? (DataCaptureContextDeserializerHelperReversedAdapter) this.proxyCache.getOrPut(Reflection.b(DataCaptureContextDeserializerHelper.class), null, helper, new n(helper)) : null);
    }

    @Override // com.scandit.datacapture.core.capture.serialization.DataCaptureContextDeserializerProxy
    public DataCaptureContextDeserializer _deserializer() {
        DataCaptureContextDeserializer dataCaptureContextDeserializer = this.f125042c;
    ...
    public void _setDeserializer(DataCaptureContextDeserializer deserializer) {
        ...
        this.f125042c = deserializer;
    }

    @Override // com.scandit.datacapture.core.capture.serialization.DataCaptureContextDeserializerProxy
    public void _setListener(DataCaptureContextDeserializerListener listener) {
        this.f125040a.setListener(listener != null ? (DataCaptureContextDeserializerListenerReversedAdapter) this.proxyCache.getOrPut(Reflection.b(DataCaptureContextDeserializerListener.class), this, listener, new o(listener, this)) : null);
    }

    @Override // com.scandit.datacapture.core.capture.serialization.DataCaptureContextDeserializerProxy
    public boolean getAvoidThreadDependencies() {
        return this.f125040a.getAvoidThreadDependencies();
    }
    ...
    public void setAvoidThreadDependencies(boolean z10) {
        this.f125040a.setAvoidThreadDependencies(z10);
    }
