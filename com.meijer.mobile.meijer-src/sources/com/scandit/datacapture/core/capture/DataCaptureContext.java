...
public final class DataCaptureContext implements DataCaptureContextProxy {
    ...
    private static DataCaptureContext f124982k;

    /* renamed from: a, reason: collision with root package name */
    private final DataCaptureContextProxyAdapter f124983a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private FrameSource _frameSource;

    /* renamed from: c, reason: collision with root package name */
    private final ArrayList f124985c;

    /* renamed from: d, reason: collision with root package name */
    private DataCaptureMode f124986d;

    /* renamed from: e, reason: collision with root package name */
    private final Object f124987e;

    /* renamed from: f, reason: collision with root package name */
    private boolean f124988f;
    ...
    private final e f124991i;

    /* renamed from: j, reason: collision with root package name */
    private final ImuDataCollector f124992j;
    ...
    public static final class Companion {
        ...
        public final DataCaptureContext initialize(String licenseKey, String frameworkName, String frameworkVersion, String deviceName, String externalId, DataCaptureContextSettings settings) {
            ...
            NativeDataCaptureContext nativeDataCaptureContextInitialize = NativeDataCaptureContext.initialize(licenseKey, absolutePath, str, str2, frameworkVersion, str3, packageName, str4, str5, str6, arrayList, new AssetResourceLoader(assets), false, settings.getF125009a());
            DataCaptureContext dataCaptureContext = DataCaptureContext.f124982k;
            ...
            DataCaptureContext.f124982k = dataCaptureContext;
    ...
    public DataCaptureContext(NativeDataCaptureContext impl, DataCaptureContextProxyAdapter adapter) {
        ...
        this.f124983a = adapter;
        this.f124985c = new ArrayList();
        ...
        e eVar = new e(this);
        this.f124991i = eVar;
        this.f124992j = new ImuDataCollector(new c(this));
        _setContext(this);
        int i10 = 4;
        ...
        getF125005a().setDataTransports(CollectionsKt.g(new BluetoothDataTransport(appAndroidEnvironment.getApplicationContext())));
    }
    ...
    public static final void b(DataCaptureContext this$0, DataCaptureMode mode) {
        ...
        this$0.f124985c.remove(mode);
        if (Intrinsics.e(mode, this$0.f124986d)) {
            this$0.f124986d = null;
            if (this$0.f124985c.isEmpty()) {
                return;
            }
            this$0.f124986d = (DataCaptureMode) CollectionsKt.D0(this$0.f124985c);
        }
    }
    ...
    public NativeWrappedFuture _addModeAsyncWrapped(DataCaptureMode mode) {
        Intrinsics.j(mode, "mode");
        return this.f124983a._addModeAsyncWrapped(mode);
    }

    @Override // com.scandit.datacapture.core.capture.DataCaptureContextProxy
    @ProxyGetter(ProxyGetterKind.WITH_SETTER)
    public DataCaptureContext _context() {
        return this.f124983a._context();
    }
    ...
    public NativeWrappedFuture _removeModeAsyncWrapped(DataCaptureMode mode) {
        Intrinsics.j(mode, "mode");
        return this.f124983a._removeModeAsyncWrapped(mode);
    }
    ...
    public void _setContext(DataCaptureContext dataCaptureContext) {
        ...
        this.f124983a._setContext(dataCaptureContext);
    }
    ...
    public NativeWrappedFuture _setFrameSourceAsyncWrapped(FrameSource frameSource) {
        return this.f124983a._setFrameSourceAsyncWrapped(frameSource);
    }
    ...
    public NativeWrappedFuture _setModeAsyncWrapped(DataCaptureMode mode) {
        Intrinsics.j(mode, "mode");
        return this.f124983a._setModeAsyncWrapped(mode);
    }
    ...
    public void applySettings(DataCaptureContextSettings settings) {
        Intrinsics.j(settings, "settings");
        this.f124983a.applySettings(settings);
    }
    ...
    public static final void c(DataCaptureContext this$0, DataCaptureMode mode) {
        ...
        CollectionsKt.J(this$0.f124985c, new f(mode));
        this$0.f124986d = mode;
        this$0.f124985c.add(mode);
    }
    ...
    public final void _setShouldUseImuData(boolean enable) {
        this.f124992j.setEnabled(enable);
        getF125005a().setShouldUseImuDataAsync(enable);
    }
    ...
    public final void addListener(DataCaptureContextListener listener) {
        boolean z10;
        Intrinsics.j(listener, "listener");
        synchronized (this.f124987e) {
            z10 = this.listeners.add(listener) ? this.f124988f : false;
        }
        if (z10) {
            listener.onObservationStarted(this);
        }
    ...
    public final void addMode(final DataCaptureMode mode) {
        ...
        NativeExtensionsKt.andThen(_addModeAsyncWrapped(mode), new Runnable() { // from class: Zt.c
            ...
            public final void run() {
                DataCaptureContext.a(this.f44135a, mode);
            }
        });
    }
    ...
    public final /* synthetic */ DataCaptureMode getF124986d() {
    ...
    public final void release() {
        AppAndroidEnvironment.INSTANCE.getAppLifecycleListener().deregisterOnActivityStoppedCallback(this.f124991i);
        getF125005a().disposeAsync();
    }
    ...
    public final void removeListener(DataCaptureContextListener listener) {
        ...
        Intrinsics.j(listener, "listener");
        synchronized (this.f124987e) {
            z10 = this.listeners.remove(listener) ? this.f124988f : false;
        }
        if (z10) {
            listener.onObservationStopped(this);
        }
    ...
    public final void removeMode(final DataCaptureMode mode) {
        ...
        NativeExtensionsKt.andThen(_removeModeAsyncWrapped(mode), new Runnable() { // from class: Zt.f
            @Override // java.lang.Runnable
            public final void run() {
                DataCaptureContext.b(this.f44142a, mode);
            }
        });
    }
    ...
    public final void setFrameSource(final FrameSource frameSource, final Runnable whenDone) {
        NativeExtensionsKt.andThen(_setFrameSourceAsyncWrapped(frameSource), new Runnable() { // from class: Zt.d
            @Override // java.lang.Runnable
            public final void run() {
                DataCaptureContext.a(this.f44137a, frameSource, whenDone);
            }
        });
    }
    ...
    public final void setMode(final DataCaptureMode mode) {
        ...
        NativeExtensionsKt.andThen(_setModeAsyncWrapped(mode), new Runnable() { // from class: Zt.e
            @Override // java.lang.Runnable
            public final void run() {
                DataCaptureContext.c(this.f44140a, mode);
            }
        });
    }
    ...
    public final boolean _isCameraTimestampsRealtime() {
        ...
        if (camera != null && (nativeAndroidCamera_impl = camera.getF126823a()) != null && nativeAndroidCamera_impl.isTimestampRealtime()) {
            return true;
        }
        return false;
    }
    ...
    public final LicenseInfo getLicenseInfo() {
        NativeLicenseInfo licenseInfo = getF125005a().getLicenseInfo();
        if (licenseInfo != null) {
    ...
    public final void removeAllModes() {
        NativeExtensionsKt.andThen(_removeAllModesAsyncWrapped(), new Runnable() { // from class: Zt.b
            @Override // java.lang.Runnable
            public final void run() {
                DataCaptureContext.a(this.f44134a);
            }
        });
    }
    ...
    public final void removeCurrentMode() {
        NativeExtensionsKt.andThen(_removeCurrentModeAsyncWrapped(), new Runnable() { // from class: Zt.a
            @Override // java.lang.Runnable
            public final void run() {
                DataCaptureContext.b(this.f44133a);
            }
        });
    }
    ...
    public static final void a(DataCaptureContext this$0) {
        Intrinsics.j(this$0, "this$0");
        this$0.f124986d = null;
        Iterator it = this$0.f124985c.iterator();
        while (it.hasNext()) {
            ((DataCaptureMode) it.next())._setDataCaptureContext(null);
        }
        this$0.f124985c.clear();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void b(DataCaptureContext this$0) {
        Intrinsics.j(this$0, "this$0");
        DataCaptureMode dataCaptureMode = this$0.f124986d;
        if (dataCaptureMode != null) {
            dataCaptureMode._setDataCaptureContext(null);
            this$0.f124985c.remove(dataCaptureMode);
            if (Intrinsics.e(dataCaptureMode, this$0.f124986d)) {
                this$0.f124986d = null;
                if (this$0.f124985c.isEmpty()) {
                    return;
                }
    ...
    public DataCaptureContext(String str, String str2, String str3, String str4, String str5, DataCaptureContextSettings dataCaptureContextSettings, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        AssetManager assets = appAndroidEnvironment.getApplicationContext().getAssets();
        Intrinsics.i(assets, "getAssets(...)");
        NativeDataCaptureContext nativeDataCaptureContextCreateWithDeviceName = NativeDataCaptureContext.createWithDeviceName(str, absolutePath, str6, str7, str3, str8, packageName, strA, str9, str10, arrayList, new AssetResourceLoader(assets), false, dataCaptureContextSettings.getF125009a());
