...
public final class JsonValue implements JsonValueProxy {
    ...
    private final /* synthetic */ JsonValueProxyAdapter f126781a;

    /* JADX WARN: Multi-variable type inference failed */
    public JsonValue(NativeJsonValue impl) {
        Intrinsics.j(impl, "impl");
        this.f126781a = new JsonValueProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    }
    ...
    public ArrayList<String> _getWarnings() {
        return this.f126781a._getWarnings();
    }
    ...
    public NativeJsonValue getF126782a() {
        return this.f126781a.getF126782a();
    }
    ...
    public void _removeKeys(ArrayList<String> keys) {
        ...
        this.f126781a._removeKeys(keys);
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    @ProxyFunction
    public JsonValue asArray() {
        return this.f126781a.asArray();
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    @ProxyFunction(nativeName = "asBool")
    public boolean asBoolean() {
        return this.f126781a.asBoolean();
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    @ProxyFunction
    public Brush asBrush() {
        return this.f126781a.asBrush();
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    @ProxyFunction
    public int asColor() {
        return this.f126781a.asColor();
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    @ProxyFunction
    public float asFloat() {
        return this.f126781a.asFloat();
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    @ProxyFunction
    public FloatWithUnit asFloatWithUnit() {
        return this.f126781a.asFloatWithUnit();
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    @ProxyFunction
    public int asInt() {
        return this.f126781a.asInt();
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    @ProxyFunction
    public MarginsWithUnit asMarginsWithUnit() {
        return this.f126781a.asMarginsWithUnit();
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    @ProxyFunction
    public JsonValue asObject() {
        return this.f126781a.asObject();
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    @ProxyFunction
    public PointWithUnit asPointWithUnit() {
        return this.f126781a.asPointWithUnit();
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    @ProxyFunction
    public String asString() {
        return this.f126781a.asString();
    }
    ...
    public boolean contains(String key) {
        ...
        return this.f126781a.contains(key);
    }
    ...
    public boolean containsNull(String key) {
        Intrinsics.j(key, "key");
        return this.f126781a.containsNull(key);
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    @ProxyFunction(property = "absolutePath")
    public String getAbsolutePath() {
        return this.f126781a.getAbsolutePath();
    }
    ...
    public JsonValue getByKeyAsArray(String key, JsonValue defaultValue) {
        Intrinsics.j(key, "key");
        return this.f126781a.getByKeyAsArray(key, defaultValue);
    }
    ...
    public boolean getByKeyAsBoolean(String key, boolean defaultValue) {
        Intrinsics.j(key, "key");
        return this.f126781a.getByKeyAsBoolean(key, defaultValue);
    }
    ...
    public Brush getByKeyAsBrush(String key, Brush defaultValue) {
        ...
        return this.f126781a.getByKeyAsBrush(key, defaultValue);
    }
    ...
    public int getByKeyAsColor(String key, int defaultValue) {
        Intrinsics.j(key, "key");
        return this.f126781a.getByKeyAsColor(key, defaultValue);
    }
    ...
    public float getByKeyAsFloat(String key, float defaultValue) {
        Intrinsics.j(key, "key");
        return this.f126781a.getByKeyAsFloat(key, defaultValue);
    }
    ...
    public FloatWithUnit getByKeyAsFloatWithUnit(String key, FloatWithUnit defaultValue) {
        Intrinsics.j(key, "key");
        Intrinsics.j(defaultValue, "defaultValue");
        return this.f126781a.getByKeyAsFloatWithUnit(key, defaultValue);
    }
    ...
    public int getByKeyAsInt(String key, int defaultValue) {
        Intrinsics.j(key, "key");
        return this.f126781a.getByKeyAsInt(key, defaultValue);
    }
    ...
    public MarginsWithUnit getByKeyAsMarginsWithUnit(String key, MarginsWithUnit defaultValue) {
        Intrinsics.j(key, "key");
        Intrinsics.j(defaultValue, "defaultValue");
        return this.f126781a.getByKeyAsMarginsWithUnit(key, defaultValue);
    }
    ...
    public Integer getByKeyAsNullableColor(String key, Integer defaultValue) {
        Intrinsics.j(key, "key");
        return this.f126781a.getByKeyAsNullableColor(key, defaultValue);
    }
    ...
    public JsonValue getByKeyAsObject(String key, JsonValue defaultValue) {
        Intrinsics.j(key, "key");
        return this.f126781a.getByKeyAsObject(key, defaultValue);
    }
    ...
    public PointWithUnit getByKeyAsPointWithUnit(String key, PointWithUnit defaultValue) {
        Intrinsics.j(key, "key");
        Intrinsics.j(defaultValue, "defaultValue");
        return this.f126781a.getByKeyAsPointWithUnit(key, defaultValue);
    }
    ...
    public JsonValue requireByKey(String key) {
        Intrinsics.j(key, "key");
        return this.f126781a.requireByKey(key);
    }
    ...
    public JsonValue requireByKeyAsArray(String key) {
        Intrinsics.j(key, "key");
        return this.f126781a.requireByKeyAsArray(key);
    }
    ...
    public boolean requireByKeyAsBoolean(String key) {
        Intrinsics.j(key, "key");
        return this.f126781a.requireByKeyAsBoolean(key);
    }
    ...
    public Brush requireByKeyAsBrush(String key) {
        Intrinsics.j(key, "key");
        return this.f126781a.requireByKeyAsBrush(key);
    }
    ...
    public int requireByKeyAsColor(String key) {
        Intrinsics.j(key, "key");
        return this.f126781a.requireByKeyAsColor(key);
    }
    ...
    public float requireByKeyAsFloat(String key) {
        Intrinsics.j(key, "key");
        return this.f126781a.requireByKeyAsFloat(key);
    }
    ...
    public FloatWithUnit requireByKeyAsFloatWithUnit(String key) {
        Intrinsics.j(key, "key");
        return this.f126781a.requireByKeyAsFloatWithUnit(key);
    }
    ...
    public int requireByKeyAsInt(String key) {
        Intrinsics.j(key, "key");
        return this.f126781a.requireByKeyAsInt(key);
    }
    ...
    public MarginsWithUnit requireByKeyAsMarginsWithUnit(String key) {
        Intrinsics.j(key, "key");
        return this.f126781a.requireByKeyAsMarginsWithUnit(key);
    }
    ...
    public JsonValue requireByKeyAsObject(String key) {
        Intrinsics.j(key, "key");
        return this.f126781a.requireByKeyAsObject(key);
    }
    ...
    public PointWithUnit requireByKeyAsPointWithUnit(String key) {
        Intrinsics.j(key, "key");
        return this.f126781a.requireByKeyAsPointWithUnit(key);
    }
    ...
    public String requireByKeyAsString(String key) {
        Intrinsics.j(key, "key");
        return this.f126781a.requireByKeyAsString(key);
    }

    public final String getByKeyAsNullableString$scandit_capture_core(String key, String defaultValue) {
        Intrinsics.j(key, "key");
        return getF126782a().getOptionalStringForKeyOrDefault(key, defaultValue);
    }
