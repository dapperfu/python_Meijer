...
public final class a implements S {
    ...
    public final WeakReference f126861a;

    public a(BitmapFrameSource owner) {
        Intrinsics.j(owner, "owner");
        this.f126861a = new WeakReference(owner);
    }
    ...
    public final void onFrameOutput(FrameSource frameSource, FrameData frame) {
        ...
        BitmapFrameSource bitmapFrameSource = (BitmapFrameSource) this.f126861a.get();
        if (bitmapFrameSource == null || (copyOnWriteArraySet = bitmapFrameSource.f126828b) == null) {
            return;
        }
