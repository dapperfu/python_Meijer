...
public interface FrameSourceDeserializerProxy {
    ...
    public static final class DefaultImpls {
        public static CameraSettings updateCameraSettingsFromJson(FrameSourceDeserializerProxy frameSourceDeserializerProxy, CameraSettings settings, String jsonData) throws JSONException {
            ...
            NativeCameraSettings nativeCameraSettingsUpdateCameraSettingsFromJson = frameSourceDeserializerProxy.getF126879a().updateCameraSettingsFromJson(CoreNativeTypeFactory.INSTANCE.convert(settings), NativeJsonValue.fromString(jsonData));
    ...
    @NativeImpl
    /* renamed from: _impl */
    NativeFrameSourceDeserializer getF126879a();
