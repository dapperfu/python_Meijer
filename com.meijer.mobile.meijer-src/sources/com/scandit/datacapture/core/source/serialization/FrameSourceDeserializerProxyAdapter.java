...
public final class FrameSourceDeserializerProxyAdapter implements FrameSourceDeserializerProxy {
    ...
    private final NativeFrameSourceDeserializer f126879a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private FrameSourceDeserializer f126881c;
    ...
    public FrameSourceDeserializerProxyAdapter(NativeFrameSourceDeserializer _NativeFrameSourceDeserializer, ProxyCache proxyCache) {
        ...
        this.f126879a = _NativeFrameSourceDeserializer;
    ...
    public void _setHelper(FrameSourceDeserializerHelper helper) {
        this.f126879a.setHelper(helper != null ? (FrameSourceDeserializerHelperReversedAdapter) this.proxyCache.getOrPut(Reflection.b(FrameSourceDeserializerHelper.class), null, helper, new j(helper)) : null);
    }

    @Override // com.scandit.datacapture.core.source.serialization.FrameSourceDeserializerProxy
    public FrameSourceDeserializer _deserializer() {
        FrameSourceDeserializer frameSourceDeserializer = this.f126881c;
    ...
    public FrameSource _frameSourceFromJson(String jsonData) {
        ...
        NativeFrameSource nativeFrameSourceFrameSourceFromJson = this.f126879a.frameSourceFromJson(CoreNativeTypeFactory.INSTANCE.convert(jsonData));
    ...
    public FrameSource _frameSourceFromJsonValue(JsonValue json) {
        ...
        NativeFrameSource nativeFrameSourceFrameSourceFromJson = this.f126879a.frameSourceFromJson(f126782a);
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeFrameSource.class);
        Intrinsics.g(nativeFrameSourceFrameSourceFromJson);
        return (FrameSource) proxyCache.require(kClassB, null, nativeFrameSourceFrameSourceFromJson);
    ...
    public void _setDeserializer(FrameSourceDeserializer deserializer) {
        ...
        this.f126881c = deserializer;
    }

    @Override // com.scandit.datacapture.core.source.serialization.FrameSourceDeserializerProxy
    public void _setListener(FrameSourceDeserializerListener listener) {
        this.f126879a.setListener(listener != null ? (FrameSourceDeserializerListenerReversedAdapter) this.proxyCache.getOrPut(Reflection.b(FrameSourceDeserializerListener.class), this, listener, new k(listener, this)) : null);
    }
    ...
    public CameraSettings cameraSettingsFromJson(String jsonData) {
        ...
        NativeCameraSettings nativeCameraSettingsCameraSettingsFromJson = this.f126879a.cameraSettingsFromJson(coreNativeTypeFactory.convert(jsonData));
    ...
    public List<String> getWarnings() {
        ArrayList<String> warnings = this.f126879a.getWarnings();
    ...
    public FrameSource updateFrameSourceFromJson(FrameSource frameSource, String jsonData) {
        ...
        NativeFrameSource nativeFrameSourceUpdateFrameSourceFromJson = this.f126879a.updateFrameSourceFromJson(nativeFrameSource_frameSourceImpl, CoreNativeTypeFactory.INSTANCE.convert(jsonData));
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeFrameSource.class);
    ...
    public FrameSource updateFrameSourceFromJsonValue(FrameSource frameSource, JsonValue json) {
        ...
        NativeJsonValue f126782a = json.getF126782a();
        this.proxyCache.put(Reflection.b(NativeJsonValue.class), null, f126782a, json);
        NativeFrameSource nativeFrameSourceUpdateFrameSourceFromJson = this.f126879a.updateFrameSourceFromJson(nativeFrameSource_frameSourceImpl, f126782a);
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeFrameSource.class);
        Intrinsics.g(nativeFrameSourceUpdateFrameSourceFromJson);
        return (FrameSource) proxyCache.require(kClassB, null, nativeFrameSourceUpdateFrameSourceFromJson);
