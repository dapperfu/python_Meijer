...
public final class Camera implements FrameSource, AndroidCameraProxy {
    ...
    private static final CameraFactory f126832e = new CameraFactory((CameraProfile) com.scandit.datacapture.core.internal.module.device.profiles.camera.d.f125175a.getValue());

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final CameraBehaviorDelegate behaviorDelegate;

    /* renamed from: b, reason: collision with root package name */
    private final /* synthetic */ AndroidCameraProxy f126834b;

    /* renamed from: c, reason: collision with root package name */
    private final com.scandit.datacapture.core.internal.module.source.dynamicresolution.h f126835c;

    /* renamed from: d, reason: collision with root package name */
    private final CopyOnWriteArraySet f126836d;
    ...
    public static final class Companion {
        ...
        public final Camera getCamera(CameraPosition position, CameraSettings settings) {
            Intrinsics.j(position, "position");
            return Camera.f126832e.a(position, settings);
        }

        @JvmStatic
        @JvmOverloads
        public final Camera getDefaultCamera(CameraSettings settings) {
            CameraFactory cameraFactory = Camera.f126832e;
    ...
    public NativeWrappedFuture _applySettings(CameraSettings settings) {
        ...
        return this.f126834b._applySettings(settings);
    }
    ...
    public NativeWrappedFuture _applyTorchStateAsync(TorchState torchState) {
        ...
        return this.f126834b._applyTorchStateAsync(torchState);
    }
    ...
    public NativeFrameSource _frameSourceImpl() {
        return this.f126834b.getF126825c();
    }
    ...
    public NativeAndroidCamera getF126823a() {
        return this.f126834b.getF126823a();
    }
    ...
    public NativeWrappedFuture _switchToDesiredState(FrameSourceState desiredState) {
        ...
        return this.f126834b._switchToDesiredState(desiredState);
    }
    ...
    public final void applySettings(CameraSettings settings, Runnable whenDone) {
        ...
        Intrinsics.j(settings, "settings");
        com.scandit.datacapture.core.internal.module.source.dynamicresolution.h hVar = this.f126835c;
        hVar.getClass();
        ...
        if (dynamicResolutionSettings != null) {
            ...
            j.a("Enabled\n\tlow fps         -> " + dynamicResolutionSettings.f126010a + "\n\thigh offset     -> " + dynamicResolutionSettings.f126011b + "\n\tmonitoring time -> " + dynamicResolutionSettings.f126012c);
            String resolution = ((com.scandit.datacapture.core.internal.module.source.camera.c) hVar.f125999a).a();
            if (resolution != null) {
        ...
        if (cameraApi != null) {
            if (cameraApi != getApi$scandit_capture_core()) {
                NativeCameraDelegate nativeCameraDelegateA = f126832e.a(getPosition(), cameraApi, settings);
                if (nativeCameraDelegateA != null) {
                    NativeWrappedFuture delegateAsync = getF126823a().setDelegateAsync(nativeCameraDelegateA);
    ...
    public void removeListener(FrameSourceListener listener) {
        Intrinsics.j(listener, "listener");
        if (this.f126836d.remove(listener)) {
    ...
    public final void setDesiredTorchState(TorchState value) {
        ...
        this.behaviorDelegate.a(value, com.scandit.datacapture.core.internal.module.source.camera.behavior.a.f125973a);
    }
    ...
    public Camera(AndroidCameraProxy androidCameraProxy, CameraBehaviorDelegate cameraBehaviorDelegate, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        this.f126834b = androidCameraProxy;
        d applyResolution = new d(this);
        com.scandit.datacapture.core.internal.module.source.camera.c dynamicResolutionStore = com.scandit.datacapture.core.internal.module.source.camera.a.f125972a;
        if (dynamicResolutionStore == null) {
            ...
            com.scandit.datacapture.core.internal.module.source.camera.a.f125972a = dynamicResolutionStore;
        }
        ...
        this.f126835c = hVar;
        this.f126836d = new CopyOnWriteArraySet();
        getF126823a().addListenerAsync(new a0(new b(this), this));
        getF126823a().addListenerAsync(new a0(hVar, this));
    }

    public final NativeCameraApi getApi$scandit_capture_core() {
        NativeCameraApi api = getF126823a().getApi();
