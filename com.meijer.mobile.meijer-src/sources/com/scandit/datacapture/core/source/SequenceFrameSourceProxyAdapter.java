...
public final class SequenceFrameSourceProxyAdapter implements SequenceFrameSourceProxy {
    ...
    private final NativeFrameDataGeneratorFrameSource f126856a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeFrameSource f126858c;
    ...
    public SequenceFrameSourceProxyAdapter(NativeFrameDataGeneratorFrameSource _NativeFrameDataGeneratorFrameSource, ProxyCache proxyCache) {
        ...
        this.f126856a = _NativeFrameDataGeneratorFrameSource;
    ...
    public NativeWrappedFuture _switchToDesiredState(FrameSourceState desiredState) {
        ...
        NativeWrappedFuture nativeWrappedFutureSwitchToDesiredStateAsyncAndroid = this.f126856a.switchToDesiredStateAsyncAndroid(desiredState);
    ...
    public FrameSourceState getCurrentState() {
        FrameSourceState currentState = this.f126856a.getCurrentState();
    ...
    public FrameSourceState getDesiredState() {
        FrameSourceState desiredState = this.f126856a.getDesiredState();
