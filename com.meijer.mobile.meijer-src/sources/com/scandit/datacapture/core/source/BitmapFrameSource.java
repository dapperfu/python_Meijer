...
public final class BitmapFrameSource implements FrameSource, BitmapFrameSourceProxy {
    ...
    private final /* synthetic */ BitmapFrameSourceProxyAdapter f126827a;

    /* renamed from: b, reason: collision with root package name */
    private final CopyOnWriteArraySet f126828b;
    ...
    public NativeFrameSource getF126831c() {
        return this.f126827a.getF126831c();
    }
    ...
    public NativeFrameDataCollectionFrameSource getF126829a() {
        return this.f126827a.getF126829a();
    }
    ...
    public BitmapFrameSource(NativeFrameDataCollectionFrameSource impl, SingleBitmapFrameDataCollection frames) {
        ...
        this.frames = frames;
        this.f126827a = new BitmapFrameSourceProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        this.f126828b = new CopyOnWriteArraySet();
    ...
    public void removeListener(FrameSourceListener listener) {
        Intrinsics.j(listener, "listener");
        if (this.f126828b.remove(listener)) {
