...
public final class f implements S {
    ...
    public final WeakReference f126868a;

    public f(SequenceFrameSource owner) {
        Intrinsics.j(owner, "owner");
        this.f126868a = new WeakReference(owner);
    }
    ...
    public final void onFrameOutput(FrameSource frameSource, FrameData frame) {
        ...
        SequenceFrameSource sequenceFrameSource = (SequenceFrameSource) this.f126868a.get();
        if (sequenceFrameSource == null || (copyOnWriteArraySet = sequenceFrameSource.f126855h) == null) {
            return;
        }
