...
public final class CameraSettings {
    ...
    private final HashMap f126843e;
    ...
    public final NativeCameraSettings _impl$scandit_capture_core() {
        HashMap map = this.f126843e;
        LinkedHashMap linkedHashMap = new LinkedHashMap();
        for (Map.Entry entry : map.entrySet()) {
            if (!K.f125739a.contains(entry.getKey())) {
    ...
    public final void setProperty(String name, Object value) {
        ...
        if (Intrinsics.e(name, "focusStrategy") && Intrinsics.e(value, strFocusStrategyToString)) {
            this.f126843e.put("macroAutofocusMode", "off");
        }
    }
    ...
    private final Float a(String str) {
        Object obj = this.f126843e.get(str);
