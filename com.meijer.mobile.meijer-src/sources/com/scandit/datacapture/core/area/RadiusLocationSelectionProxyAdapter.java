...
public final class RadiusLocationSelectionProxyAdapter implements RadiusLocationSelectionProxy {
    ...
    private final NativeRadiusLocationSelection f124967a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeLocationSelection f124969c;
    ...
    public RadiusLocationSelectionProxyAdapter(NativeRadiusLocationSelection _NativeRadiusLocationSelection, ProxyCache proxyCache) {
        ...
        this.f124967a = _NativeRadiusLocationSelection;
    ...
    public FloatWithUnit getRadius() {
        FloatWithUnit radius = this.f124967a.getRadius();
        Intrinsics.g(radius);
        return radius;
    }
    ...
    public String toJson() {
        String json = this.f124967a.toJson();
        Intrinsics.g(json);
        return json;
    }
