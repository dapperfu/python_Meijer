...
public final class LocationSelectionDeserializerHelperReversedAdapter extends NativeLocationSelectionDeserializerHelper {
    ...
    private final LocationSelectionDeserializerHelper f124977a;
    ...
    public LocationSelectionDeserializerHelperReversedAdapter(LocationSelectionDeserializerHelper _LocationSelectionDeserializerHelper, ProxyCache proxyCache) {
        ...
        this.f124977a = _LocationSelectionDeserializerHelper;
    ...
    public NativeNoLocationSelection createNoLocationSelection() {
        NoLocationSelection noLocationSelectionCreateNoLocationSelectionFromJson = this.f124977a.createNoLocationSelectionFromJson();
    ...
    public NativeRadiusLocationSelection createRadiusLocationSelection() {
        RadiusLocationSelection radiusLocationSelectionCreateRadiusLocationSelectionFromJson = this.f124977a.createRadiusLocationSelectionFromJson();
    ...
    public NativeRectangularLocationSelection createRectangularLocationSelection() {
        RectangularLocationSelection rectangularLocationSelectionCreateRectangularLocationSelectionFromJson = this.f124977a.createRectangularLocationSelectionFromJson();
