...
public final class RectangularLocationSelectionProxyAdapter implements RectangularLocationSelectionProxy {
    ...
    private final NativeRectangularLocationSelection f124971a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeLocationSelection f124973c;
    ...
    public RectangularLocationSelectionProxyAdapter(NativeRectangularLocationSelection _NativeRectangularLocationSelection, ProxyCache proxyCache) {
        ...
        this.f124971a = _NativeRectangularLocationSelection;
        ...
        this.f124973c = nativeLocationSelectionAsLocationSelection;
    }
    ...
    public String toJson() {
        String json = this.f124971a.toJson();
        Intrinsics.g(json);
        return json;
    }
