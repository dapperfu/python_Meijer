...
public final class LinearControlGroup implements Control {
    ...
    private final Context f126984a;
    ...
    public <T extends Control> void _removeChildControl(Class<T> type) {
        ...
        Iterator it = CollectionsKt.Y(this.f126987d, type).iterator();
        while (it.hasNext()) {
    ...
    public void _onDataCaptureContextChanged(DataCaptureContext dataCaptureContext) {
        Iterator it = this.f126987d.iterator();
        while (it.hasNext()) {
    ...
    public LinearControlGroup(Context context, LinearControlGroupOrientation linearControlGroupOrientation, FloatWithUnit floatWithUnit, List list, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        this.f126987d = CollectionsKt.m1(list);
    }
    ...
    public static final ViewGroup access$createView(LinearControlGroup linearControlGroup) {
        ...
        LinearLayout linearLayout = new LinearLayout(linearControlGroup.f126984a);
        ...
        int i12 = 0;
        for (Object obj : linearControlGroup.f126987d) {
            int i13 = i12 + 1;
            if (i12 < 0) {
                CollectionsKt.w();
            }
            ...
            if (i12 != CollectionsKt.o(linearControlGroup.f126987d)) {
                ...
                if (i14 != 1) {
                    ...
                    pixels = (int) FloatWithUnitExtensionsKt.toPixels(linearControlGroup.spacing, control.get_view().getLayoutParams().width, ContextExtensionsKt.getDisplayDensity(linearControlGroup.f126984a));
                }
                ...
                if (i16 != 1) {
                    if (i16 == 2) {
                        pixels2 = (int) FloatWithUnitExtensionsKt.toPixels(linearControlGroup.spacing, control.get_view().getLayoutParams().height, ContextExtensionsKt.getDisplayDensity(linearControlGroup.f126984a));
                    } else {
                        throw new NoWhenBranchMatchedException();
                    }
                } else {
    ...
    public void _removeChildControl(Control control) {
        ...
        if (this.f126987d.remove(control)) {
