...
public final class DataCaptureViewDeserializerHelperReversedAdapter extends NativeDataCaptureViewDeserializerHelper {
    ...
    private final DataCaptureViewDeserializerHelper f127097a;
    ...
    public DataCaptureViewDeserializerHelperReversedAdapter(DataCaptureViewDeserializerHelper _DataCaptureViewDeserializerHelper, ProxyCache proxyCache) {
        ...
        this.f127097a = _DataCaptureViewDeserializerHelper;
    ...
    public NativeSwipeToZoom createSwipeToZoom() {
        SwipeToZoom swipeToZoomCreateSwipeToZoom = this.f127097a.createSwipeToZoom();
        NativeSwipeToZoom f127044a = swipeToZoomCreateSwipeToZoom.getF127044a();
        this.proxyCache.put(Reflection.b(NativeSwipeToZoom.class), null, f127044a, swipeToZoomCreateSwipeToZoom);
        return f127044a;
    }

    @Override // com.scandit.datacapture.core.internal.module.serialization.NativeDataCaptureViewDeserializerHelper
    public NativeTapToFocus createTapToFocus(boolean showUiIndicator) {
        TapToFocus tapToFocusCreateTapToFocus = this.f127097a.createTapToFocus(showUiIndicator);
        NativeTapToFocus f127049a = tapToFocusCreateTapToFocus.getF127049a();
        this.proxyCache.put(Reflection.b(NativeTapToFocus.class), null, f127049a, tapToFocusCreateTapToFocus);
        return f127049a;
    }
    ...
    public NativeDataCaptureView createView(NativeDataCaptureContext context) {
        ...
        DataCaptureView dataCaptureViewCreateView = this.f127097a.createView((DataCaptureContext) this.proxyCache.getOrPut(Reflection.b(NativeDataCaptureContext.class), null, context, new d(context)));
    ...
    public void createdNullFocusGesture() {
        this.f127097a.createdNullFocusGesture();
    }

    @Override // com.scandit.datacapture.core.internal.module.serialization.NativeDataCaptureViewDeserializerHelper
    public void createdNullZoomGesture() {
        this.f127097a.createdNullZoomGesture();
    }
    ...
    public void updateViewFromJson(NativeDataCaptureView view, NativeJsonValue json) {
        ...
        this.f127097a.updateViewFromJson((DataCaptureView) this.proxyCache.require(Reflection.b(NativeDataCaptureView.class), null, view), (JsonValue) this.proxyCache.getOrPut(Reflection.b(NativeJsonValue.class), null, json, new e(json)));
    }
