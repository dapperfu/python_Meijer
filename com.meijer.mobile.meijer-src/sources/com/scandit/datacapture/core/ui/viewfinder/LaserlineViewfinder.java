...
public final class LaserlineViewfinder implements Viewfinder, LaserlineViewfinderProxy {
    ...
    private final /* synthetic */ LaserlineViewfinderProxyAdapter f127130a;

    /* JADX WARN: Multi-variable type inference failed */
    public LaserlineViewfinder(NativeLaserlineViewfinder impl) {
        Intrinsics.j(impl, "impl");
        this.f127130a = new LaserlineViewfinderProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    }
    ...
    public NativeLaserlineViewfinder getF127131a() {
        return this.f127130a.getF127131a();
    }
    ...
    public NativeViewfinder getF127133c() {
        return this.f127130a.getF127133c();
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.LaserlineViewfinderProxy
    @ProxyFunction(property = "disabledColor")
    public int getDisabledColor() {
        return this.f127130a.getDisabledColor();
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.LaserlineViewfinderProxy
    @ProxyFunction(property = "enabledColor")
    public int getEnabledColor() {
        return this.f127130a.getEnabledColor();
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.LaserlineViewfinderProxy
    @ProxyFunction(property = "width")
    public FloatWithUnit getWidth() {
        return this.f127130a.getWidth();
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.LaserlineViewfinderProxy
    @ProxyFunction(property = "disabledColor")
    public void setDisabledColor(int i10) {
        this.f127130a.setDisabledColor(i10);
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.LaserlineViewfinderProxy
    @ProxyFunction(property = "enabledColor")
    public void setEnabledColor(int i10) {
        this.f127130a.setEnabledColor(i10);
    }
    ...
    public void setWidth(FloatWithUnit floatWithUnit) {
        ...
        this.f127130a.setWidth(floatWithUnit);
    }
