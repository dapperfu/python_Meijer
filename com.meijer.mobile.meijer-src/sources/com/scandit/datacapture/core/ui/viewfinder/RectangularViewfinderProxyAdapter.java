...
public final class RectangularViewfinderProxyAdapter implements RectangularViewfinderProxy {
    ...
    private final NativeRectangularViewfinder f127140a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeViewfinder f127142c;
    ...
    public RectangularViewfinderProxyAdapter(NativeRectangularViewfinder _NativeRectangularViewfinder, ProxyCache proxyCache) {
        ...
        this.f127140a = _NativeRectangularViewfinder;
        ...
        this.f127142c = nativeViewfinderAsViewfinder;
    }
    ...
    public void setAnimation(RectangularViewfinderAnimation rectangularViewfinderAnimation) {
        ...
        if (rectangularViewfinderAnimation != null) {
            NativeRectangularViewfinderAnimation f127136a = rectangularViewfinderAnimation.getF127136a();
            this.proxyCache.put(Reflection.b(NativeRectangularViewfinderAnimation.class), null, f127136a, rectangularViewfinderAnimation);
            nativeRectangularViewfinderAnimation = f127136a;
        }
        this.f127140a.setAnimation(nativeRectangularViewfinderAnimation);
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.RectangularViewfinderProxy
    /* renamed from: _impl, reason: from getter */
    public NativeRectangularViewfinder getF127140a() {
    ...
    public NativeViewfinder getF127142c() {
        return this.f127142c;
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.RectangularViewfinderProxy
    public RectangularViewfinderAnimation getAnimation() {
        NativeRectangularViewfinderAnimation animation = this.f127140a.getAnimation();
        if (animation != null) {
    ...
    @Override // com.scandit.datacapture.core.ui.viewfinder.RectangularViewfinderProxy
    public int getColor() {
        NativeColor color = this.f127140a.getColor();
    ...
    public float getDimming() {
        return this.f127140a.getDimming();
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.RectangularViewfinderProxy
    public int getDisabledColor() {
        NativeColor disabledColor = this.f127140a.getDisabledColor();
        CoreNativeTypeFactory coreNativeTypeFactory = CoreNativeTypeFactory.INSTANCE;
    ...
    public float getDisabledDimming() {
        return this.f127140a.getDisabledDimming();
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.RectangularViewfinderProxy
    public RectangularViewfinderLineStyle getLineStyle() {
        NativeRectangularViewfinderLineStyle lineStyle = this.f127140a.getLineStyle();
        CoreNativeTypeFactory coreNativeTypeFactory = CoreNativeTypeFactory.INSTANCE;
    ...
    public RectangularViewfinderStyle getStyle() {
        NativeRectangularViewfinderStyle style = this.f127140a.getStyle();
        CoreNativeTypeFactory coreNativeTypeFactory = CoreNativeTypeFactory.INSTANCE;
        Intrinsics.g(style);
    ...
    public void setColor(int i10) {
        this.f127140a.setColor(CoreNativeTypeFactory.INSTANCE.convert(i10));
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.RectangularViewfinderProxy
    public void setDimming(float f10) {
        this.f127140a.setDimming(f10);
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.RectangularViewfinderProxy
    public void setDisabledColor(int i10) {
        this.f127140a.setDisabledColor(CoreNativeTypeFactory.INSTANCE.convert(i10));
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.RectangularViewfinderProxy
    public void setDisabledDimming(float f10) {
        this.f127140a.setDisabledDimming(f10);
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.RectangularViewfinderProxy
    public void setHeightAndAspectRatio(FloatWithUnit height, float widthToHeightAspect) {
        Intrinsics.j(height, "height");
        this.f127140a.setHeightAndAspectRatio(height, widthToHeightAspect);
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.RectangularViewfinderProxy
    public void setShorterDimensionAndAspectRatio(float shorterDimension, float aspect) {
        this.f127140a.setShorterDimensionAndAspectRatio(shorterDimension, aspect);
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.RectangularViewfinderProxy
    public void setWidthAndAspectRatio(FloatWithUnit width, float heightToWidthAspect) {
        Intrinsics.j(width, "width");
        this.f127140a.setWidthAndAspectRatio(width, heightToWidthAspect);
    }
