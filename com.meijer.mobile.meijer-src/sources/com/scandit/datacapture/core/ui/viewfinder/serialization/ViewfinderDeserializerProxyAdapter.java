...
public final class ViewfinderDeserializerProxyAdapter implements ViewfinderDeserializerProxy {
    ...
    private final NativeViewfinderDeserializer f127155a;
    ...
    public ViewfinderDeserializerProxyAdapter(NativeViewfinderDeserializer _NativeViewfinderDeserializer, ProxyCache proxyCache) {
        ...
        this.f127155a = _NativeViewfinderDeserializer;
    ...
    public void _setHelper(ViewfinderDeserializerHelper helper) {
        this.f127155a.setHelper(helper != null ? (ViewfinderDeserializerHelperReversedAdapter) this.proxyCache.getOrPut(Reflection.b(ViewfinderDeserializerHelper.class), null, helper, new a(helper)) : null);
    }
    ...
    public List<String> getWarnings() {
        ArrayList<String> warnings = this.f127155a.getWarnings();
