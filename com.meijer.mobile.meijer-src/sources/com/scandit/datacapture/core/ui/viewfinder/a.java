...
public final class a extends Lambda implements Function0 {
    ...
    public final /* synthetic */ NativeRectangularViewfinderAnimation f127149a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public a(NativeRectangularViewfinderAnimation nativeRectangularViewfinderAnimation) {
        super(0);
        this.f127149a = nativeRectangularViewfinderAnimation;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        CoreNativeTypeFactory coreNativeTypeFactory = CoreNativeTypeFactory.INSTANCE;
        NativeRectangularViewfinderAnimation _0 = this.f127149a;
        Intrinsics.i(_0, "$_0");
