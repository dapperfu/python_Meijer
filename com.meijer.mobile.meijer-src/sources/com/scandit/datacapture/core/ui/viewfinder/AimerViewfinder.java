...
public final class AimerViewfinder implements Viewfinder, AimerViewfinderProxy {
    ...
    private final /* synthetic */ AimerViewfinderProxyAdapter f127126a;

    /* JADX WARN: Multi-variable type inference failed */
    public AimerViewfinder(NativeAimerViewfinder impl) {
        Intrinsics.j(impl, "impl");
        this.f127126a = new AimerViewfinderProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    }
    ...
    public NativeAimerViewfinder getF127127a() {
        return this.f127126a.getF127127a();
    }
    ...
    public NativeViewfinder getF127129c() {
        return this.f127126a.getF127129c();
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.AimerViewfinderProxy
    @ProxyFunction(property = "dotColor")
    public int getDotColor() {
        return this.f127126a.getDotColor();
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.AimerViewfinderProxy
    @ProxyFunction(property = "frameColor")
    public int getFrameColor() {
        return this.f127126a.getFrameColor();
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.AimerViewfinderProxy
    @ProxyFunction(property = "dotColor")
    public void setDotColor(int i10) {
        this.f127126a.setDotColor(i10);
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.AimerViewfinderProxy
    @ProxyFunction(property = "frameColor")
    public void setFrameColor(int i10) {
        this.f127126a.setFrameColor(i10);
    }
