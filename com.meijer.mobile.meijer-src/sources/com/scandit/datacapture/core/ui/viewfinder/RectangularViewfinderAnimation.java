...
public final class RectangularViewfinderAnimation implements RectangularViewfinderAnimationProxy {
    ...
    private final /* synthetic */ RectangularViewfinderAnimationProxyAdapter f127135a;

    public RectangularViewfinderAnimation(NativeRectangularViewfinderAnimation impl) {
        Intrinsics.j(impl, "impl");
        this.f127135a = new RectangularViewfinderAnimationProxyAdapter(impl, null, 2, null);
    }
    ...
    public NativeRectangularViewfinderAnimation getF127136a() {
        return this.f127135a.getF127136a();
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.RectangularViewfinderAnimationProxy
    @ProxyFunction(property = "isLooping")
    public boolean isLooping() {
        return this.f127135a.isLooping();
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.RectangularViewfinderAnimationProxy
    @ProxyFunction
    public String toJson() {
        return this.f127135a.toJson();
    }
