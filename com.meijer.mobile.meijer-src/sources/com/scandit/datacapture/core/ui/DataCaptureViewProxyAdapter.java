...
public final class DataCaptureViewProxyAdapter implements DataCaptureViewProxy {
    ...
    private final NativeDataCaptureView f126923a;
    ...
    public DataCaptureViewProxyAdapter(NativeDataCaptureView _NativeDataCaptureView, ProxyCache proxyCache) {
        ...
        this.f126923a = _NativeDataCaptureView;
    ...
    public void _addOverlay(DataCaptureOverlay overlay) {
        ...
        NativeDataCaptureOverlay f124803c = overlay.getF126718c();
        this.proxyCache.put(Reflection.b(NativeDataCaptureOverlay.class), null, f124803c, overlay);
        this.f126923a.addOverlay(f124803c);
    }
    ...
    public void _performUiTriggeredZoomIn() {
        this.f126923a.performUiTriggeredZoomIn();
    }

    @Override // com.scandit.datacapture.core.ui.DataCaptureViewProxy
    public void _performUiTriggeredZoomOut() {
        this.f126923a.performUiTriggeredZoomOut();
    }
    ...
    public void _removeOverlay(DataCaptureOverlay overlay) {
        ...
        NativeDataCaptureOverlay f124803c = overlay.getF126718c();
        this.proxyCache.put(Reflection.b(NativeDataCaptureOverlay.class), null, f124803c, overlay);
        this.f126923a.removeOverlay(f124803c);
    }

    @Override // com.scandit.datacapture.core.ui.DataCaptureViewProxy
    public void _setGestureRecognizer(GestureRecognizer recognizer) {
        Intrinsics.j(recognizer, "recognizer");
        this.f126923a.setGestureRecognizer((r) this.proxyCache.getOrPut(Reflection.b(GestureRecognizer.class), null, recognizer, new c(recognizer)));
    }

    @Override // com.scandit.datacapture.core.ui.DataCaptureViewProxy
    public void _setNeedsRedraw() {
        this.f126923a.setNeedsRedraw();
    }

    @Override // com.scandit.datacapture.core.ui.DataCaptureViewProxy
    public void _setNeedsRedrawListener(NeedsRedrawListener listener) {
        Intrinsics.j(listener, "listener");
        this.f126923a.setNeedsRedrawDelegate((NeedsRedrawListenerReversedAdapter) this.proxyCache.getOrPut(Reflection.b(NeedsRedrawListener.class), null, listener, new d(listener)));
    }

    @Override // com.scandit.datacapture.core.ui.DataCaptureViewProxy
    public Anchor getLogoAnchor() {
        Anchor logoAnchor = this.f126923a.getLogoAnchor();
    ...
    public PointWithUnit getLogoOffset() {
        PointWithUnit logoOffset = this.f126923a.getLogoOffset();
    ...
    public LogoStyle getLogoStyle() {
        LogoStyle logoStyle = this.f126923a.getLogoStyle();
    ...
    public PointWithUnit getPointOfInterest() {
        PointWithUnit pointOfInterest = this.f126923a.getPointOfInterest();
    ...
    public MarginsWithUnit getScanAreaMargins() {
        MarginsWithUnit scanAreaMargins = this.f126923a.getScanAreaMargins();
