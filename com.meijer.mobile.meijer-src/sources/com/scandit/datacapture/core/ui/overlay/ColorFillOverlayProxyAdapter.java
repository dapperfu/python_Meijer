...
public final class ColorFillOverlayProxyAdapter implements ColorFillOverlayProxy {
    ...
    private final NativeColorFillOverlay f127084a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeDataCaptureOverlay f127086c;
    ...
    public ColorFillOverlayProxyAdapter(NativeColorFillOverlay _NativeColorFillOverlay, ProxyCache proxyCache) {
        ...
        this.f127084a = _NativeColorFillOverlay;
        ...
        this.f127086c = nativeDataCaptureOverlayAsDataCaptureOverlay;
    }
    ...
    @Override // com.scandit.datacapture.core.ui.overlay.ColorFillOverlayProxy
    public int getColor() {
        NativeColor color = this.f127084a.getColor();
    ...
    public void setColor(int i10) {
        this.f127084a.setColor(CoreNativeTypeFactory.INSTANCE.convert(i10));
    }
