...
public final class TapToFocus implements FocusGesture, TapToFocusProxy {
    ...
    private final /* synthetic */ TapToFocusProxyAdapter f127047a;

    /* renamed from: b, reason: collision with root package name */
    private final CopyOnWriteArraySet f127048b;

    /* JADX WARN: Multi-variable type inference failed */
    public TapToFocus(NativeTapToFocus impl) {
        Intrinsics.j(impl, "impl");
        this.f127047a = new TapToFocusProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        this.f127048b = new CopyOnWriteArraySet();
        getF127049a().addListener(new FocusGestureListenerReversedAdapter(new c(this), this, null, 4, null));
    }
    ...
    public NativeFocusGesture getF127051c() {
        return this.f127047a.getF127051c();
    }

    @Override // com.scandit.datacapture.core.ui.gesture.TapToFocusProxy
    @NativeImpl
    /* renamed from: _impl */
    public NativeTapToFocus getF127049a() {
        return this.f127047a.getF127049a();
    }

    @Override // com.scandit.datacapture.core.ui.gesture.FocusGesture, com.scandit.datacapture.core.ui.gesture.TapToFocusProxy
    @ProxyFunction(nativeName = "toJson")
    public String toJson() {
        return this.f127047a.toJson();
    }
