...
public final class SwipeToZoom implements ZoomGesture, SwipeToZoomProxy {
    ...
    private final /* synthetic */ SwipeToZoomProxyAdapter f127042a;

    /* renamed from: b, reason: collision with root package name */
    private final CopyOnWriteArraySet f127043b;

    /* JADX WARN: Multi-variable type inference failed */
    public SwipeToZoom(NativeSwipeToZoom impl) {
        Intrinsics.j(impl, "impl");
        this.f127042a = new SwipeToZoomProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        this.f127043b = new CopyOnWriteArraySet();
        getF127044a().addListener(new ZoomGestureListenerReversedAdapter(new b(this), this, null, 4, null));
    }

    @Override // com.scandit.datacapture.core.ui.gesture.SwipeToZoomProxy
    @NativeImpl
    /* renamed from: _impl */
    public NativeSwipeToZoom getF127044a() {
        return this.f127042a.getF127044a();
    }
