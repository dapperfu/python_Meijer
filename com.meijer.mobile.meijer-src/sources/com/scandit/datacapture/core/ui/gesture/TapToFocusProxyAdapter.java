...
public final class TapToFocusProxyAdapter implements TapToFocusProxy {
    ...
    private final NativeTapToFocus f127049a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeFocusGesture f127051c;
    ...
    public TapToFocusProxyAdapter(NativeTapToFocus _NativeTapToFocus, ProxyCache proxyCache) {
        ...
        this.f127049a = _NativeTapToFocus;
        ...
        this.f127051c = nativeFocusGestureAsFocusGesture;
    }
    ...
    public String toJson() {
        String json = this.f127049a.toJson();
        Intrinsics.g(json);
        return json;
    }
    ...
    public void triggerFocus(PointWithUnit point) {
        ...
        this.f127049a.triggerFocus(point);
    }
