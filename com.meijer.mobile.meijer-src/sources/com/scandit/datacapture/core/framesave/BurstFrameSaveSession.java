...
public final class BurstFrameSaveSession implements FrameSaveSession, BurstFrameSaveSessionProxy {
    ...
    private final /* synthetic */ BurstFrameSaveSessionProxyAdapter f125103a;
    ...
    public static final class Companion {
        ...
        public static final class Builder {
            ...
            private File f125107c;

            /* renamed from: a, reason: collision with root package name */
            private int f125105a = 3;

            /* renamed from: b, reason: collision with root package name */
            private FileFormat f125106b = FileFormat.SC_RAW;

            /* renamed from: d, reason: collision with root package name */
            private final String f125108d = "";
            ...
            public final BurstFrameSaveSession build() {
                ...
                File file = this.f125107c;
                if (file == null || (nativeBurstFrameSaveConfigurationForRemoteStorage = NativeBurstFrameSaveConfiguration.forLocalStorage(file.getAbsolutePath(), this.f125105a, this.f125106b, this.f125108d)) == null) {
                    nativeBurstFrameSaveConfigurationForRemoteStorage = NativeBurstFrameSaveConfiguration.forRemoteStorage(this.f125105a, this.f125106b, this.f125108d);
                }
    ...
    public NativeFrameSaveSession getF125111c() {
        return this.f125103a.getF125111c();
    }
    ...
    public NativeBurstFrameSaveSession getF125109a() {
        return this.f125103a.getF125109a();
    }
    ...
    public void addToContext(DataCaptureContext dataCaptureContext) {
        ...
        this.f125103a.addToContext(dataCaptureContext);
    }

    @Override // com.scandit.datacapture.core.framesave.BurstFrameSaveSessionProxy
    @ProxyFunction
    public void disable() {
        this.f125103a.disable();
    }

    @Override // com.scandit.datacapture.core.framesave.BurstFrameSaveSessionProxy
    @ProxyFunction
    public void enable() {
        this.f125103a.enable();
    }
    ...
    public void removeFromContext(DataCaptureContext dataCaptureContext) {
        Intrinsics.j(dataCaptureContext, "dataCaptureContext");
        this.f125103a.removeFromContext(dataCaptureContext);
    }
    ...
    public BurstFrameSaveSession(NativeBurstFrameSaveSession nativeBurstFrameSaveSession, DefaultConstructorMarker defaultConstructorMarker) {
        this.f125103a = new BurstFrameSaveSessionProxyAdapter(nativeBurstFrameSaveSession, null, 2, 0 == true ? 1 : 0);
