...
public final class EngineSequenceFrameSaveSession implements FrameSaveSession, SequenceFrameSaveSessionProxy {
    ...
    private final /* synthetic */ SequenceFrameSaveSessionProxyAdapter f125119a;
    ...
    public static final class Companion {
        ...
        public static final class Builder {
            ...
            private File f125122b;

            /* renamed from: a, reason: collision with root package name */
            private FileFormat f125121a = FileFormat.SC_RAW;

            /* renamed from: c, reason: collision with root package name */
            private final String f125123c = "";
            ...
            public final EngineSequenceFrameSaveSession build() {
                ...
                File file = this.f125122b;
                if (file == null || (nativeSequenceFrameSaveConfigurationForRemoteStorage = NativeSequenceFrameSaveConfiguration.forLocalStorage(absolutePath, file.getAbsolutePath(), this.f125121a, this.f125123c)) == null) {
                    nativeSequenceFrameSaveConfigurationForRemoteStorage = NativeSequenceFrameSaveConfiguration.forRemoteStorage(absolutePath, this.f125121a, this.f125123c);
                }
    ...
    public NativeFrameSaveSession getF125130c() {
        return this.f125119a.getF125130c();
    }
    ...
    public FrameSaveSession _getFrameSaveSession() {
        return this.f125119a._getFrameSaveSession();
    }
    ...
    public NativeSequenceFrameSaveSession getF125128a() {
        return this.f125119a.getF125128a();
    }
    ...
    public void _setFrameSaveSession(FrameSaveSession frameSaveSession) {
        ...
        this.f125119a._setFrameSaveSession(frameSaveSession);
    }
    ...
    public void addToContext(DataCaptureContext dataCaptureContext) {
        ...
        this.f125119a.addToContext(dataCaptureContext);
    }
    ...
    public void removeFromContext(DataCaptureContext dataCaptureContext) {
        Intrinsics.j(dataCaptureContext, "dataCaptureContext");
        this.f125119a.removeFromContext(dataCaptureContext);
    }
    ...
    public EngineSequenceFrameSaveSession(NativeSequenceFrameSaveSession nativeSequenceFrameSaveSession, DefaultConstructorMarker defaultConstructorMarker) {
        this.f125119a = new SequenceFrameSaveSessionProxyAdapter(nativeSequenceFrameSaveSession, null, 2, 0 == true ? 1 : 0);
