...
public final class q extends Lambda implements Function0 {
    ...
    public final /* synthetic */ CardsCarouselView f126652a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ String f126653b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public q(CardsCarouselView cardsCarouselView, String str) {
        super(0);
        this.f126652a = cardsCarouselView;
        this.f126653b = str;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        CardsCarouselView cardsCarouselView = this.f126652a;
        List list = cardsCarouselView.f126531c;
        final String str = this.f126653b;
