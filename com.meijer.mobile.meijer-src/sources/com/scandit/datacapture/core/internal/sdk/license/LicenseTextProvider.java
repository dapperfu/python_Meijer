...
public final class LicenseTextProvider {
    ...
    private static final LinkedHashMap f126454a = new LinkedHashMap();

    public final void addLicenseTextProvider(ModuleLicenseTextProvider provider) {
        Intrinsics.j(provider, "provider");
        LinkedHashMap linkedHashMap = f126454a;
    ...
    public final String getLicenseText() {
        List listY0 = CollectionsKt.Y0(f126454a.keySet());
        ArrayList arrayList = new ArrayList();
        Iterator it = listY0.iterator();
        while (it.hasNext()) {
            ModuleLicenseTextProvider moduleLicenseTextProvider = (ModuleLicenseTextProvider) f126454a.get((String) it.next());
            if (moduleLicenseTextProvider != null) {
                arrayList.add(moduleLicenseTextProvider);
            }
        }
        return CollectionsKt.B0(arrayList, "\n\n", null, null, 0, null, a.f126455a, 30, null);
    }
