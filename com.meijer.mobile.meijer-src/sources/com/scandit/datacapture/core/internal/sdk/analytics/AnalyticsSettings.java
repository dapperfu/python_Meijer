...
public final class AnalyticsSettings implements AnalyticsSettingsProxy {
    ...
    private final /* synthetic */ AnalyticsSettingsProxyAdapter f126298a;
    ...
    public NativeAnalyticsSettings getF126299a() {
        return this.f126298a.getF126299a();
    }

    public AnalyticsSettings(NativeAnalyticsSettings impl) {
        Intrinsics.j(impl, "impl");
        this.f126298a = new AnalyticsSettingsProxyAdapter(impl, null, 2, null);
    }

    public final void setProperty(String key, Object value) {
        Intrinsics.j(key, "key");
        if (value == null) {
            getF126299a().setStringProperty(key, null);
        } else if (value instanceof Boolean) {
            getF126299a().setBoolProperty(key, ((Boolean) value).booleanValue());
        } else if (value instanceof String) {
            getF126299a().setStringProperty(key, (String) value);
        }
    }
}
