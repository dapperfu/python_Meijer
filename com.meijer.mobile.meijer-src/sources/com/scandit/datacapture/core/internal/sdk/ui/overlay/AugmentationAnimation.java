...
public final class AugmentationAnimation {
    ...
    private final SpringAnimation f126711a;

    /* renamed from: b, reason: collision with root package name */
    private final SpringAnimation f126712b;

    public AugmentationAnimation(View view, Point start) {
        Intrinsics.j(view, "view");
        Intrinsics.j(start, "start");
        SpringAnimation springAnimation = new SpringAnimation(view, DynamicAnimation.f126928X);
        springAnimation.setStartValue(start.getX());
        this.f126711a = springAnimation;
        SpringAnimation springAnimation2 = new SpringAnimation(view, DynamicAnimation.f126929Y);
        springAnimation2.setStartValue(start.getY());
        this.f126712b = springAnimation2;
    }

    public final void animateTo(Point point) {
        Intrinsics.j(point, "final");
        this.f126711a.animateToFinalPosition(point.getX());
        this.f126712b.animateToFinalPosition(point.getY());
    }
}
