...
public final class o extends Lambda implements Function0 {
    ...
    public final /* synthetic */ CardsCarouselView f126649a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o(CardsCarouselView cardsCarouselView) {
        super(0);
        this.f126649a = cardsCarouselView;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        CardsCarouselView.UiListener uiListener;
        if (this.f126649a.f126531c.size() > 1 && (uiListener = this.f126649a.getUiListener()) != null) {
