...
public final class AnimatedGradientTextView extends TextView implements Animatable {
    ...
    private final Paint f126502a;

    /* renamed from: b, reason: collision with root package name */
    private LinearGradient f126503b;

    /* renamed from: c, reason: collision with root package name */
    private float f126504c;

    /* renamed from: d, reason: collision with root package name */
    private final Matrix f126505d;

    /* renamed from: e, reason: collision with root package name */
    private long f126506e;

    /* renamed from: f, reason: collision with root package name */
    private boolean f126507f;

    /* renamed from: g, reason: collision with root package name */
    private final AnimatedGradientTextView$updater$1 f126508g;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (text == null || text.length() == 0 || this.f126503b == null) {
            return;
        }
        this.f126505d.reset();
        this.f126505d.setTranslate(this.f126504c * getWidth(), 0.0f);
        LinearGradient linearGradient = this.f126503b;
        if (linearGradient != null) {
            linearGradient.setLocalMatrix(this.f126505d);
        }
        canvas.drawText(getText().toString(), 0.0f, getBaseline(), this.f126502a);
    }
    ...
    public void start() {
        ...
        this.f126507f = true;
        this.f126506e = AnimationUtils.currentAnimationTimeMillis();
        this.f126508g.run();
    }
    ...
    protected void onSizeChanged(int w10, int h10, int oldw, int oldh) {
        ...
        int iArgb2 = Color.argb(l3.f93323c, Color.red(currentTextColor2), Color.green(currentTextColor2), Color.blue(currentTextColor2));
        ...
        this.f126503b = linearGradient;
        this.f126502a.setShader(linearGradient);
        this.f126502a.setTextSize(getTextSize());
        this.f126502a.setTypeface(getTypeface());
    }
    ...
    public AnimatedGradientTextView(Context context, AttributeSet attributeSet, int i10) {
        ...
        Intrinsics.j(context, "context");
        this.f126502a = new Paint(1);
        this.f126505d = new Matrix();
        setWillNotDraw(false);
        this.f126508g = new AnimatedGradientTextView$updater$1(this);
    }
}
