...
public abstract class TrackedObjectAugmenter<T> {
    ...
    private static final Anchor f126735h = Anchor.CENTER;

    /* renamed from: i, reason: collision with root package name */
    private static final PointWithUnit f126736i = PointWithUnitUtilsKt.PointWithUnit(0.0f, 0.0f, MeasureUnit.FRACTION);
    ...
    private final LinkedHashMap f126739c;

    /* renamed from: d, reason: collision with root package name */
    private final LinkedHashMap f126740d;

    /* renamed from: e, reason: collision with root package name */
    private final LinkedHashMap f126741e;

    /* renamed from: f, reason: collision with root package name */
    private final LinkedHashMap f126742f;
    ...
    public static final class Companion {
        ...
        public final Anchor getDEFAULT_ANCHOR() {
            return TrackedObjectAugmenter.f126735h;
        }

        public final PointWithUnit getDEFAULT_OFFSET() {
            return TrackedObjectAugmenter.f126736i;
        }
    }
    ...
    public TrackedObjectAugmenter(Host<T> host) {
        ...
        this.f126739c = new LinkedHashMap();
        this.f126740d = new LinkedHashMap();
        this.f126741e = new LinkedHashMap();
        this.f126742f = new LinkedHashMap();
        this.objectOverlayUtils = new ObjectOverlayUtils();
    }

    /* JADX WARN: Multi-variable type inference failed */
    private final void a(Object obj) {
        LinkedHashMap linkedHashMap = this.f126740d;
        ...
        Anchor anchorAnchorForTrackedObject = (Anchor) this.f126741e.get(getTrackingId(obj));
        if (anchorAnchorForTrackedObject == null) {
            anchorAnchorForTrackedObject = this.host.anchorForTrackedObject(obj);
            if (anchorAnchorForTrackedObject != null) {
                this.f126741e.put(getTrackingId(obj), anchorAnchorForTrackedObject);
            } else {
                anchorAnchorForTrackedObject = null;
            }
            if (anchorAnchorForTrackedObject == null) {
                anchorAnchorForTrackedObject = f126735h;
            }
        }
        PointWithUnit pointWithUnitOffsetForTrackedObject = (PointWithUnit) this.f126742f.get(getTrackingId(obj));
        if (pointWithUnitOffsetForTrackedObject == null) {
            pointWithUnitOffsetForTrackedObject = this.host.offsetForTrackedObject(obj, view);
            if (pointWithUnitOffsetForTrackedObject != null) {
                this.f126742f.put(getTrackingId(obj), pointWithUnitOffsetForTrackedObject);
            } else {
                pointWithUnitOffsetForTrackedObject = null;
            }
            if (pointWithUnitOffsetForTrackedObject == null) {
                pointWithUnitOffsetForTrackedObject = f126736i;
            }
        }
        Augmentation<T> augmentation = (Augmentation) this.f126739c.get(getTrackingId(obj));
        ...
        this.f126739c.put(getTrackingId(obj), augmentation2);
        onAugmentationAdded(augmentation2);
    }

    public final void clearAugmentations() {
        for (Augmentation<T> augmentation : this.f126739c.values()) {
            ViewGroup containerView = augmentation.getContainerView();
            if (containerView != null) {
                containerView.removeAllViews();
                this.host.removeAugmentedView(containerView);
    ...
    public final void setAnchorForTrackedObject(T trackedObject, Anchor anchor) {
        ...
        this.f126741e.put(getTrackingId(trackedObject), anchor);
        Augmentation augmentation = (Augmentation) this.f126739c.get(getTrackingId(trackedObject));
        if (augmentation == null) {
            return;
        }
    ...
    public final void setAugmentations(Iterable<? extends T> addedTrackedObjects, Iterable<? extends T> updatedTrackedObjects, Iterable<String> removedTrackedObjects) {
        ...
        for (String str : removedTrackedObjects) {
            Augmentation<T> augmentation = (Augmentation) this.f126739c.remove(str);
            if (augmentation != null) {
                ViewGroup containerView = augmentation.getContainerView();
                if (containerView != null) {
                    containerView.removeAllViews();
            ...
            this.f126741e.remove(str);
            this.f126742f.remove(str);
            this.f126740d.remove(str);
        }
        ...
        for (T t11 : updatedTrackedObjects) {
            Augmentation<T> augmentation2 = (Augmentation) this.f126739c.get(getTrackingId(t11));
    ...
    public final void setOffsetForTrackedObject(T trackedObject, PointWithUnit offset) {
        ...
        this.f126742f.put(getTrackingId(trackedObject), offset);
        Augmentation augmentation = (Augmentation) this.f126739c.get(getTrackingId(trackedObject));
        if (augmentation == null) {
            return;
        }
        ...
        synchronized (this.activeIdentifiers) {
            try {
                if (this.activeIdentifiers.contains(getTrackingId(trackedObject))) {
                    this.f126740d.put(getTrackingId(trackedObject), view);
                    a(trackedObject);
                }
