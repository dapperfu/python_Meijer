...
public final class DisposableResource<T> {
    ...
    private final Function0 f126391a;

    /* renamed from: b, reason: collision with root package name */
    private final Function1 f126392b;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private int counter;

    /* renamed from: d, reason: collision with root package name */
    private Object f126394d;

    /* renamed from: e, reason: collision with root package name */
    private final Object f126395e;

    public DisposableResource(Function0<? extends T> factory, Function1<? super T, Unit> tearDown) {
        Intrinsics.j(factory, "factory");
        Intrinsics.j(tearDown, "tearDown");
        this.f126391a = factory;
        this.f126392b = tearDown;
        this.f126395e = new Object();
    }
    ...
    public final Subscription<T> start() {
        synchronized (this.f126395e) {
            try {
                int i10 = this.counter + 1;
                this.counter = i10;
                if (i10 == 1) {
                    this.f126394d = this.f126391a.invoke();
                }
