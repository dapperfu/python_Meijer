...
public final class MainThreadHelper implements IMainThreadHelper {
    ...
    private final Handler f126355a = new Handler(Looper.getMainLooper());
    ...
    public void postDelayed(long delay, final Function0<Unit> block) {
        ...
        this.f126355a.postDelayed(new Runnable() { // from class: com.scandit.datacapture.core.internal.sdk.common.async.b
    ...
    public void runOnMainThread(final Function0<Unit> block) {
        ...
        if (Intrinsics.e(Looper.myLooper(), Looper.getMainLooper())) {
            ...
            this.f126355a.post(new Runnable() { // from class: com.scandit.datacapture.core.internal.sdk.common.async.c
                @Override // java.lang.Runnable
                public final void run() {
