...
public final class CardsCarouselView extends RelativeLayout {
    ...
    private static final Lazy f126525n = LazyKt.b(C13518d.f126636a);

    /* renamed from: o, reason: collision with root package name */
    private static final Lazy f126526o = LazyKt.b(C13517c.f126635a);

    /* renamed from: p, reason: collision with root package name */
    private static final Lazy f126527p = LazyKt.b(C13519e.f126637a);

    /* renamed from: q, reason: collision with root package name */
    private static final Lazy f126528q = LazyKt.b(C13520f.f126638a);
    ...
    private final ArrayList f126531c;

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    private ButtonBarSettings buttonBarSettings;

    /* renamed from: e, reason: collision with root package name */
    private final TextView f126533e;

    /* renamed from: f, reason: collision with root package name */
    private final ImageButton f126534f;

    /* renamed from: g, reason: collision with root package name */
    private final ImageButton f126535g;

    /* renamed from: h, reason: collision with root package name */
    private final ImageButton f126536h;

    /* renamed from: i, reason: collision with root package name */
    private final RelativeLayout f126537i;

    /* renamed from: j, reason: collision with root package name */
    private final ExpandedCardsView f126538j;

    /* renamed from: k, reason: collision with root package name */
    private final StackedCardsView f126539k;

    /* renamed from: l, reason: collision with root package name */
    private boolean f126540l;

    /* renamed from: m, reason: collision with root package name */
    private boolean f126541m;
    ...
    public static final class Companion {
        ...
        public static final int access$getBUTTON_BAR_HEIGHT(Companion companion) {
            companion.getClass();
            return ((Number) CardsCarouselView.f126526o.getValue()).intValue();
        }

        public static final int access$getCOLLAPSE_BUTTON_HEIGHT(Companion companion) {
            companion.getClass();
            return ((Number) CardsCarouselView.f126525n.getValue()).intValue();
        }

        public static final int access$getCOLLAPSE_BUTTON_PADDING(Companion companion) {
            companion.getClass();
            return ((Number) CardsCarouselView.f126527p.getValue()).intValue();
        }

        public final int getSEPARATOR_HEIGHT$scandit_capture_core() {
            return ((Number) CardsCarouselView.f126528q.getValue()).intValue();
        }
    }
    ...
    private final void a() {
        this.f126533e.setVisibility(!this.buttonBarSettings.getIsCollapseButtonVisible() ? 8 : 0);
        this.f126534f.setVisibility(!this.buttonBarSettings.getIsRestartScanButtonVisible() ? 8 : 0);
        this.f126535g.setVisibility(!this.buttonBarSettings.getIsCancelScanButtonVisible() ? 8 : 0);
        this.f126536h.setVisibility(this.buttonBarSettings.getIsAcceptScanButtonVisible() ? 0 : 8);
        if (this.buttonBarSettings.buttonBarVisibilityCanChange()) {
            return;
        }
        this.f126537i.setVisibility(this.buttonBarSettings.buttonBarVisibility(!this.f126540l));
    }
    ...
    public final List<CardData> getData() {
        return CollectionsKt.j1(this.f126531c);
    }
    ...
    public final void moveItemOnTopAndCollapse(String itemId) {
        ...
        } else if (this.f126540l) {
            this.f126539k.animateMoveItemOnTop(i10, new q(this, itemId));
        } else {
    ...
    public final void prepareButtonBar() {
        if (this.f126540l) {
            this.f126537i.setTranslationY(this.f126539k.getTargetOffsetWhenCollapsing$scandit_capture_core());
        } else {
            this.f126537i.setTranslationY(this.f126539k.getTargetOffsetWhenExpanding$scandit_capture_core());
        }
    }
    ...
    public final void setCardsFadingEdgeLength(int length) {
        this.f126538j.setFadingEdgeLength(length);
    }

    public final void setCollapseButtonText(CharSequence text) {
        TextView textView = this.f126533e;
        if (text == null) {
    ...
    public final void setCollapsed(boolean collapsed, boolean animated) {
        ...
        if (animated) {
            if (collapsed) {
                a(0, C13523i.f126641a);
                return;
            }
            if (this.buttonBarSettings.buttonBarVisibilityCanChange()) {
                this.f126537i.setVisibility(this.buttonBarSettings.buttonBarVisibility(true));
                this.f126537i.setAlpha(0.0f);
                this.f126537i.setTranslationY(getHeight() - (((CardData) CollectionsKt.v0(this.f126531c, 0)) != null ? r0.getCardHeight() : 0));
            }
            this.f126538j.setSelection(0);
            this.f126538j.scrollTo(0, 0);
            float targetOffsetWhenExpanding$scandit_capture_core = this.f126539k.getTargetOffsetWhenExpanding$scandit_capture_core();
            if (this.buttonBarSettings.buttonBarVisibilityCanChange()) {
                RelativeLayout relativeLayout = this.f126537i;
                ...
                RelativeLayout relativeLayout2 = this.f126537i;
            ...
            this.f126539k.expand(new C13526l(function1InterpolateWith), new m(this));
            return;
        }
        if (!collapsed) {
            this.f126540l = false;
            this.f126538j.setSelection(0);
            this.f126538j.scrollTo(0, 0);
            this.f126538j.setVisibility(0);
            this.f126539k.setVisibility(8);
            this.f126539k.setCollapsed(false);
            return;
        }
        this.f126540l = true;
        this.f126538j.setVisibility(4);
        this.f126538j.setSelection(0);
        this.f126538j.scrollTo(0, 0);
        this.f126539k.setVisibility(0);
        this.f126539k.setCollapsed(true);
        if (this.buttonBarSettings.buttonBarVisibilityCanChange()) {
            this.f126537i.setVisibility(this.buttonBarSettings.buttonBarVisibility(false));
        }
        this.f126537i.setTranslationY(getHeight() - (((CardData) CollectionsKt.v0(this.f126531c, 0)) != null ? r0.getCardHeight() : 0));
    }
    ...
    public final void setData(List<? extends CardData> newData) {
        ...
        this.f126531c.clear();
        this.f126531c.addAll(newData);
        this.f126539k.setData(newData);
        this.f126538j.setData(newData);
    }
    ...
    public CardsCarouselView(Context context, AttributeSet attributeSet, int i10) {
        ...
        textView.setOnClickListener(new View.OnClickListener() { // from class: com.scandit.datacapture.core.internal.sdk.ui.cardscarousel.B
            ...
            public final void onClick(View view) {
                CardsCarouselView.c(this.f126510a, view);
            }
        });
        this.f126533e = textView;
        ...
        imageButton.setOnClickListener(new View.OnClickListener() { // from class: com.scandit.datacapture.core.internal.sdk.ui.cardscarousel.C
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                CardsCarouselView.d(this.f126518a, view);
            }
        });
        this.f126534f = imageButton;
        ...
        imageButton2.setOnClickListener(new View.OnClickListener() { // from class: com.scandit.datacapture.core.internal.sdk.ui.cardscarousel.D
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                CardsCarouselView.b(this.f126561a, view);
            }
        });
        this.f126535g = imageButton2;
        ...
        imageButton3.setOnClickListener(new View.OnClickListener() { // from class: com.scandit.datacapture.core.internal.sdk.ui.cardscarousel.E
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                CardsCarouselView.a(this.f126562a, view);
            }
        });
        this.f126536h = imageButton3;
        RelativeLayout relativeLayout = new RelativeLayout(context);
        relativeLayout.setId(R.id.sc_carousel_button_bar);
        relativeLayout.setVisibility(4);
        this.f126537i = relativeLayout;
        ...
        expandedCardsView.setCardEventListener(new C13521g(this));
        this.f126538j = expandedCardsView;
        StackedCardsView stackedCardsView = new StackedCardsView(context, null, 0, 6, null);
        stackedCardsView.setCardEventListener(new C13522h(this));
        stackedCardsView.setOnScrolledUp(new r(this));
        stackedCardsView.setVisibility(0);
        this.f126539k = stackedCardsView;
        this.f126540l = true;
    ...
    private final void a(int i10, Function0 function0) {
        ...
        this.f126538j.scrollTo(0, 0);
        this.f126539k.setVisibility(0);
        int firstVisiblePosition = this.f126538j.getFirstVisiblePosition();
        int lastVisiblePosition = this.f126538j.getLastVisiblePosition();
        int offsetOfFirstVisiblePosition = this.f126538j.getOffsetOfFirstVisiblePosition();
        if (this.buttonBarSettings.buttonBarVisibilityCanChange()) {
            animationSpecCopy$default = AnimationSpec.copy$default(AnimationSpec.INSTANCE.fromView$scandit_capture_core(this.f126537i), 0.0f, 0.0f, 0.0f, getHeight() - (((CardData) CollectionsKt.v0(this.f126531c, 0)) != null ? r4.getCardHeight() : 0), 6, null);
        } else {
            animationSpecCopy$default = AnimationSpec.copy$default(AnimationSpec.INSTANCE.fromView$scandit_capture_core(this.f126537i), 0.0f, 0.0f, 0.0f, this.f126539k.getTargetOffsetWhenCollapsing$scandit_capture_core(), 7, null);
        }
        Function1<Float, Unit> function1InterpolateWith = AnimationSpecKt.interpolateWith(this.f126537i, animationSpecCopy$default);
        this.f126538j.fling(0);
        this.f126539k.collapse(new IntRange(firstVisiblePosition, lastVisiblePosition), offsetOfFirstVisiblePosition, i10, new C13524j(function1InterpolateWith), new C13525k(this, function0));
    }
}
