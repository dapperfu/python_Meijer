...
public final class ControlDeserializer {
    ...
    private static final PointWithUnit f126385a = PointWithUnitUtilsKt.PointWithUnit(-1.0f, -1.0f, MeasureUnit.PIXEL);
    ...
    public static final class ControlAction {
        ...
        /* renamed from: a, reason: collision with root package name */
        private static final /* synthetic */ ControlAction[] f126386a;

        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f126387b;
        ...
        public static ControlAction[] values() {
            return (ControlAction[]) f126386a.clone();
        }
        ...
        static {
            ...
            f126386a = controlActionArr;
            f126387b = EnumEntriesKt.a(controlActionArr);
        }
    ...
    public final void deserializeControl(Context context, JsonValue json, List<? extends Control> currentControls, Function4<? super Control, ? super ControlAction, ? super Anchor, ? super PointWithUnit, Unit> callback) {
        ...
        PointWithUnit pointWithUnit = f126385a;
