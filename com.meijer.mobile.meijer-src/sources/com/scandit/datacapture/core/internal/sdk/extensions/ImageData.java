...
public final class ImageData implements AutoCloseable {
    ...
    private final DirectByteBufferCache f126415d;

    /* renamed from: e, reason: collision with root package name */
    private final List f126416e;
    ...
    public ImageData(ImagePlane yPlane, ImagePlane uPlane, ImagePlane vPlane, DirectByteBufferCache directByteBufferCache, List<? extends ByteBuffer> list) {
        ...
        this.uPlane = uPlane;
        this.vPlane = vPlane;
        this.f126415d = directByteBufferCache;
        this.f126416e = list;
    }

    @Override // java.lang.AutoCloseable
    public void close() {
        List<ByteBuffer> list = this.f126416e;
        if (list != null) {
            for (ByteBuffer byteBuffer : list) {
                DirectByteBufferCache directByteBufferCache = this.f126415d;
