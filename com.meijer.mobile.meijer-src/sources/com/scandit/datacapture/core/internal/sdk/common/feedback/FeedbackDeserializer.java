...
public final class FeedbackDeserializer {
    ...
    private static final String[] f126362a = {"default", "selectionHaptic", "successHaptic", "impactHaptic", "impactHapticLight", "failureHaptic"};
    ...
    public static final Feedback fromJson(JsonValue json) {
        ...
        if (byKeyAsObject != null) {
            ...
            objectRef.f143742a = waveFormVibration;
        }
        ...
        if (byKeyAsObject2 != null) {
            if (byKeyAsObject2.contains("resource")) {
                ...
                if (StringsKt.s0(strRequireByKeyAsString)) {
            ...
            objectRef2.f143742a = tDefaultSound;
        }
        return new Feedback((Vibration) objectRef.f143742a, (Sound) objectRef2.f143742a);
    }
