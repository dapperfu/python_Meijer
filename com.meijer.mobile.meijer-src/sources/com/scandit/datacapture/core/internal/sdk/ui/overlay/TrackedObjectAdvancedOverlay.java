...
public abstract class TrackedObjectAdvancedOverlay<T> extends ViewBasedDataCaptureOverlay {
    ...
    private long f126725a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private WeakReference dataCaptureView;

    /* renamed from: c, reason: collision with root package name */
    private DataCaptureViewSize f126727c;

    /* renamed from: d, reason: collision with root package name */
    private DataCaptureViewSize f126728d;

    /* renamed from: e, reason: collision with root package name */
    private final Runnable f126729e;

    /* renamed from: f, reason: collision with root package name */
    private final TrackedObjectAdvancedOverlay$dataCaptureViewSizeChangedListener$1 f126730f;

    /* renamed from: g, reason: collision with root package name */
    private NativeFeatureAvailability f126731g;
    ...
    public TrackedObjectAdvancedOverlay(DataCaptureMode mode, DataCaptureView dataCaptureView, TrackedObjectAugmenter.Factory<T> augmenterFactory) {
        ...
        OverlayPreconditionsKt.checkAttachedToSameDataCaptureContext(mode, dataCaptureView, b.f126750a);
        this.dataCaptureView = new WeakReference(dataCaptureView);
        this.f126729e = new Runnable() { // from class: com.scandit.datacapture.core.internal.sdk.ui.overlay.g
            @Override // java.lang.Runnable
            public final void run() {
                TrackedObjectAdvancedOverlay.a(this.f126761a);
            }
        };
        this.f126730f = new DataCaptureViewListener() { // from class: com.scandit.datacapture.core.internal.sdk.ui.overlay.TrackedObjectAdvancedOverlay$dataCaptureViewSizeChangedListener$1
            ...
            public void onSizeChanged(int width, int height, int screenRotation) {
                TrackedObjectAdvancedOverlay.access$onDataCaptureViewSizeChanged(this.f126734a, width, height, screenRotation);
            }
        };
        this.f126731g = NativeFeatureAvailability.UNKNOWN;
    ...
    public void _setDataCaptureView(DataCaptureView view) {
        ...
        if (isAttachedToWindow()) {
            view.addListener(this.f126730f);
        }
    }
    ...
    protected final void setViewForTrackedObject(T trackedObject, View view) {
        if (this.f126731g == NativeFeatureAvailability.UNKNOWN) {
            this.f126731g = getRequireArFeatureAvailabilityFromContext();
        }
        if (this.f126731g == NativeFeatureAvailability.SUPPORTED) {
    ...
    public final void updateTrackedObjects(final long frameSequenceId, final Iterable<? extends T> addedTrackedObjects, final Iterable<? extends T> updatedTrackedObjects, final Iterable<String> removedTrackedObjects) {
        ...
        if (this.f126731g == NativeFeatureAvailability.SUPPORTED) {
            post(new Runnable() { // from class: com.scandit.datacapture.core.internal.sdk.ui.overlay.h
                @Override // java.lang.Runnable
                public final void run() {
                    TrackedObjectAdvancedOverlay.a(this.f126762a, frameSequenceId, addedTrackedObjects, updatedTrackedObjects, removedTrackedObjects);
                }
            });
            if (!Intrinsics.e(this.f126728d, this.f126727c)) {
                this.f126728d = this.f126727c;
            }
            removeCallbacks(this.f126729e);
        }
    }
    ...
    public static final void access$onDataCaptureViewSizeChanged(TrackedObjectAdvancedOverlay trackedObjectAdvancedOverlay, int i10, int i11, int i12) {
        ...
        trackedObjectAdvancedOverlay.f126727c = new DataCaptureViewSize(new Size2(i10, i11), i12);
        trackedObjectAdvancedOverlay.removeCallbacks(trackedObjectAdvancedOverlay.f126729e);
        trackedObjectAdvancedOverlay.postDelayed(trackedObjectAdvancedOverlay.f126729e, 100L);
    }
    ...
    protected void onAttachedToWindow() {
        ...
        if (dataCaptureView != null) {
            dataCaptureView.addListener(this.f126730f);
        }
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        DataCaptureView dataCaptureView = (DataCaptureView) this.dataCaptureView.get();
        if (dataCaptureView != null) {
            dataCaptureView.removeListener(this.f126730f);
        }
    ...
    public static final void a(TrackedObjectAdvancedOverlay this$0) {
        ...
        Intrinsics.j(this$0, "this$0");
        DataCaptureViewSize dataCaptureViewSize2 = this$0.f126728d;
        if (dataCaptureViewSize2 == null || (dataCaptureViewSize = this$0.f126727c) == null) {
            return;
        }
