...
public final class HintHolderV2Impl extends RelativeLayout implements HintHolderV2 {
    ...
    static final /* synthetic */ KProperty[] f126675h = {Reflection.f(new MutablePropertyReference1Impl(Reflection.b(HintHolderV2Impl.class), "viewFinderRect", "getViewFinderRect()Lcom/scandit/datacapture/core/common/geometry/Rect;"))};

    /* renamed from: a, reason: collision with root package name */
    private final HintHolderV2Impl$special$$inlined$distinctObservable$1 f126676a;

    /* renamed from: b, reason: collision with root package name */
    private final E f126677b;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private HideHintListener hideHintListener;

    /* renamed from: d, reason: collision with root package name */
    private final LinkedHashMap f126679d;

    /* renamed from: e, reason: collision with root package name */
    private final LinkedHashMap f126680e;

    /* renamed from: f, reason: collision with root package name */
    private final LinkedList f126681f;

    /* renamed from: g, reason: collision with root package name */
    private final Runnable f126682g;
    ...
    public HintHolderV2Impl(Context context) {
        ...
        this.f126676a = new ObservableProperty<Rect>(obj) { // from class: com.scandit.datacapture.core.internal.sdk.ui.hint.HintHolderV2Impl$special$$inlined$distinctObservable$1
        ...
        this.f126677b = new E(this);
        this.f126679d = new LinkedHashMap();
        this.f126680e = new LinkedHashMap();
        this.f126681f = new LinkedList();
        this.f126682g = new Runnable() { // from class: com.scandit.datacapture.core.internal.sdk.ui.hint.g
            @Override // java.lang.Runnable
            public final void run() {
                HintHolderV2Impl.a(this.f126705a);
            }
        };
    }

    private final void a(ToastHint toast) {
        LinkedHashMap linkedHashMap = this.f126679d;
    ...
    public final HintView anyToastView$scandit_capture_core() {
        return (HintView) CollectionsKt.t0(this.f126679d.values());
    }
    ...
    public Rect getViewFinderRect() {
        return getValue(this, f126675h[0]);
    }
    ...
    private final void a(GuidanceHint guidance) {
        Integer num;
        LinkedHashMap linkedHashMap = this.f126680e;
        ...
        if (obj == null) {
            ...
            Intrinsics.i(context, "getContext(...)");
            HintView hintView = new HintView(context);
            Iterator it = this.f126679d.values().iterator();
            if (it.hasNext()) {
        ...
        int i10 = p.f126231a;
        p.b(hintView2, zIsAnimatedIntoView, n.f126228a);
        hintView2.a(new c(this, guidance));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void a(Operation operation) {
        synchronized (this.f126681f) {
            this.f126681f.addLast(operation);
        ...
        if (Intrinsics.e(Looper.myLooper(), Looper.getMainLooper())) {
            ...
            Message messageObtain = Message.obtain(handler, this.f126682g);
    ...
    private final void a() {
        synchronized (this.f126681f) {
            while (!this.f126681f.isEmpty()) {
                try {
                    Operation operation = (Operation) this.f126681f.removeFirst();
                    if (operation instanceof Operation.ShowGuidance) {
                        ...
                        HintView hintView = (HintView) this.f126680e.get(guidance);
                        if (hintView != null) {
                        ...
                        HintView hintView2 = (HintView) this.f126679d.get(toast);
                        if (hintView2 != null) {
