...
public final class e implements b {
    ...
    public final TimeInterval f125668a;

    /* renamed from: b, reason: collision with root package name */
    public final Executor f125669b;

    /* renamed from: c, reason: collision with root package name */
    public final f f125670c;

    /* renamed from: d, reason: collision with root package name */
    public final Timer f125671d;

    /* renamed from: e, reason: collision with root package name */
    public final N f125672e;

    /* renamed from: f, reason: collision with root package name */
    public final Set f125673f;

    /* renamed from: g, reason: collision with root package name */
    public final Set f125674g;

    /* renamed from: h, reason: collision with root package name */
    public final c f125675h;

    public final void a(final I task) {
        Intrinsics.j(task, "task");
        this.f125669b.execute(new Runnable() { // from class: bu.a
            @Override // java.lang.Runnable
            public final void run() {
                e.a(this.f60643a, task);
            }
        });
    }
    ...
    public e(NativeHttpsSessionConfiguration config) {
        ...
        this.f125668a = timeout;
        this.f125669b = taskExecutor;
        this.f125670c = taskIdGenerator;
        this.f125671d = timeoutTimer;
        this.f125672e = sslSocketHandler;
        Set setSynchronizedSet = Collections.synchronizedSet(new LinkedHashSet());
        Intrinsics.i(setSynchronizedSet, "synchronizedSet(...)");
        this.f125673f = setSynchronizedSet;
        Set setSynchronizedSet2 = Collections.synchronizedSet(new LinkedHashSet());
        Intrinsics.i(setSynchronizedSet2, "synchronizedSet(...)");
        this.f125674g = setSynchronizedSet2;
        this.f125675h = new c(this);
    }

    public static final void a(e this$0, AbstractC13442k task) {
        Intrinsics.j(this$0, "this$0");
        Intrinsics.j(task, "$task");
        for (l lVar : this$0.f125674g) {
            this$0.f125675h.a(new U(task, lVar));
            ...
            aVar.getClass();
            Intrinsics.j(task, "task");
            com.scandit.datacapture.core.internal.module.https.a aVarA = ((com.scandit.datacapture.core.internal.module.https.d) aVar.f125688a).a();
            k jVar = aVarA == com.scandit.datacapture.core.internal.module.https.a.f125629a ? new j("No connection") : (aVarA != com.scandit.datacapture.core.internal.module.https.a.f125630b || aVar.f125689b) ? i.f125678a : new j("Cellular not allowed");
            this$0.f125675h.a(new T(task, lVar, jVar));
            if (jVar instanceof j) {
                task.a(((j) jVar).f125679a);
                return;
            }
        }
        Timer timer = this$0.f125671d;
        long jAsMillis = this$0.f125668a.asMillis();
        d dVar = new d(task);
