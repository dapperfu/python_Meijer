...
public final class CameraFactory {
    ...
    public static final F f125724d = new F();

    /* renamed from: a, reason: collision with root package name */
    private final CameraProfile f125725a;

    /* renamed from: b, reason: collision with root package name */
    private final Function1 f125726b;

    /* renamed from: c, reason: collision with root package name */
    private final D f125727c;

    public CameraFactory(CameraProfile cameraProfile) {
        C13508y cameraDelegateFactory = new C13508y();
        Intrinsics.j(cameraProfile, "cameraProfile");
        Intrinsics.j(cameraDelegateFactory, "cameraDelegateFactory");
        this.f125725a = cameraProfile;
        this.f125726b = cameraDelegateFactory;
        this.f125727c = new D();
    }
    ...
    */
    public final synchronized com.scandit.datacapture.core.source.Camera a(com.scandit.datacapture.core.source.CameraPosition r6, com.scandit.datacapture.core.source.CameraSettings r7) {
        /*
            ...
            int[] r0 = com.scandit.datacapture.core.internal.module.source.G.f125731a     // Catch: java.lang.Throwable -> L1f
        ...
        L1f:
            ...
            goto Ld3
        L22:
            com.scandit.datacapture.core.internal.module.source.D r0 = r5.f125727c     // Catch: java.lang.Throwable -> L1f
            r0.getClass()     // Catch: java.lang.Throwable -> L1f
            java.lang.String r1 = "position"
            kotlin.jvm.internal.Intrinsics.j(r6, r1)     // Catch: java.lang.Throwable -> L1f
            java.util.LinkedHashMap r0 = r0.f125728a     // Catch: java.lang.Throwable -> L1f
        ...
        L41:
            ...
            if (r1 == 0) goto L52
            com.scandit.datacapture.core.internal.module.device.profiles.camera.CameraProfile r1 = r5.f125725a     // Catch: java.lang.Throwable -> L1f
            ...
            goto L76
        L52:
            com.scandit.datacapture.core.internal.module.source.D r1 = r5.f125727c     // Catch: java.lang.Throwable -> L1f
            r1.getClass()     // Catch: java.lang.Throwable -> L1f
            java.lang.String r4 = "position"
            kotlin.jvm.internal.Intrinsics.j(r6, r4)     // Catch: java.lang.Throwable -> L1f
            java.util.LinkedHashMap r1 = r1.f125728a     // Catch: java.lang.Throwable -> L1f
        ...
        L86:
            ...
            goto Lae
        La7:
            com.scandit.datacapture.core.internal.sdk.source.NativeAndroidCamera r0 = r0.getF126823a()     // Catch: java.lang.Throwable -> L1f
        ...
        Lc4:
            if (r6 == 0) goto Ld1
            if (r7 == 0) goto Ld0
            com.scandit.datacapture.core.internal.module.device.profiles.camera.CameraProfile r0 = r5.f125725a     // Catch: java.lang.Throwable -> L1f
    ...
    public final NativeCameraDelegate a(CameraPosition position, NativeCameraApi api, CameraSettings cameraSettings) {
        ...
        InterfaceC13507x interfaceC13507x = (InterfaceC13507x) this.f125726b.invoke(api);
        if (interfaceC13507x != null) {
            return interfaceC13507x.a(position, cameraSettings, h10, i10);
        }
        return null;
    }
}
