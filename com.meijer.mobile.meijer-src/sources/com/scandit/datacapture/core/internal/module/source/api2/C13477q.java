...
import com.scandit.datacapture.core.internal.module.source.InterfaceC13507x;
...
public final class C13477q implements InterfaceC13507x {

    /* renamed from: a, reason: collision with root package name */
    public final CameraManager f125925a;

    /* renamed from: b, reason: collision with root package name */
    public final CameraProfile f125926b;

    /* renamed from: c, reason: collision with root package name */
    public final CameraApi2InfoProvider f125927c;

    public C13477q(CameraManager cameraManager) {
        ...
        this.f125925a = cameraManager;
        this.f125926b = cameraProfile;
        this.f125927c = cameraInfoProvider;
    }
    ...
    public final NativeCameraDelegate a(CameraPosition position, CameraSettings cameraSettings, com.scandit.datacapture.core.internal.module.source.H frameCallback, com.scandit.datacapture.core.internal.module.source.I priorityCameraSwitchStateCallback) {
        ...
        if (str != null) {
            Iterable<CameraApi2Info> iterableCameraInfos = this.f125927c.cameraInfos();
            ...
            int i10 = r.f125929a[position.ordinal()];
            int i11 = 1;
            if (i10 == 1) {
                i11 = 0;
            } else if (i10 != 2) {
            ...
            Iterable<CameraApi2Info> iterableCameraInfos2 = this.f125927c.cameraInfos();
        ...
        U u10 = new U(this.f125925a);
        D d10 = new D();
        O o10 = new O(this.f125926b, cameraApi2Info, cameraSettings);
        return new C13476p(o10, frameCallback, priorityCameraSwitchStateCallback, u10, new z0(), d10, new o0(), new h0(o10), C13460b.f125836a);
    }
}
