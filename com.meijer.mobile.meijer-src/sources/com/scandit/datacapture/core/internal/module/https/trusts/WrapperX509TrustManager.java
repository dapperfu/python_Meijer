...
public class WrapperX509TrustManager extends ExtendedX509TrustManager {
    ...
    private final X509TrustManager f125698a;
    ...
    public final void checkClientTrusted(X509Certificate[] chain, String authType) throws CertificateException {
        Intrinsics.j(chain, "chain");
        Intrinsics.j(authType, "authType");
        this.f125698a.checkClientTrusted(chain, authType);
    }
    ...
    public void checkServerTrusted(X509Certificate[] chain, String authType, String host) throws CertificateException {
        ...
        new X509TrustManagerExtensions(this.f125698a).checkServerTrusted(chain, authType, host);
    }

    @Override // javax.net.ssl.X509TrustManager
    public final X509Certificate[] getAcceptedIssuers() {
        X509Certificate[] acceptedIssuers = this.f125698a.getAcceptedIssuers();
