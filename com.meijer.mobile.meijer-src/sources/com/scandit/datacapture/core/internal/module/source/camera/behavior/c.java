...
public final class c implements com.scandit.datacapture.core.internal.module.source.camera.behavior.torch.a, CameraBehaviorDelegate {
    ...
    public final AndroidCameraProxy f125977a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ com.scandit.datacapture.core.internal.module.source.camera.behavior.torch.a f125978b;

    /* renamed from: c, reason: collision with root package name */
    public CameraSettings f125979c;

    /* renamed from: d, reason: collision with root package name */
    public TorchState f125980d;

    @Override // com.scandit.datacapture.core.internal.module.source.camera.behavior.torch.a
    public final Collection a() {
        return this.f125978b.a();
    }
    ...
    public c(AndroidCameraProxyAdapter nativeCameraProxy) {
        ...
        this.f125977a = nativeCameraProxy;
        this.f125978b = torchListenersHolder;
        TorchState torchState = TorchState.OFF;
        this.f125980d = torchState;
    ...
    public final Collection c() {
        return this.f125978b.c();
    }

    @Override // com.scandit.datacapture.core.internal.module.source.camera.behavior.CameraBehaviorDelegate
    public final void a(CameraSettings settings, Runnable runnable) {
        Intrinsics.j(settings, "settings");
        this.f125979c = settings;
        NativeExtensionsKt.andThen(this.f125977a._applySettings(settings), runnable);
    }
    ...
    public final void a(TorchState state, Function0 whenDone) {
        ...
        if (this.f125980d != state) {
            NativeWrappedFuture nativeWrappedFuture_applyTorchStateAsync = this.f125977a._applyTorchStateAsync(state);
    ...
    public final void a(String resolution) {
        ...
        CameraSettings settings = this.f125979c;
        if (settings == null) {
        ...
        Intrinsics.j(settings, "settings");
        this.f125979c = settings;
        NativeExtensionsKt.andThen(this.f125977a._applySettings(settings), (Runnable) null);
    }
}
