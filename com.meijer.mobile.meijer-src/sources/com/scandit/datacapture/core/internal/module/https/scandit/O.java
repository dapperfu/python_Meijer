...
public final class O implements N {
    ...
    public final J f125650a;

    public O() {
        J sslSocketFactoryCreator = (J) Q.f125652a.getValue();
        Intrinsics.j(sslSocketFactoryCreator, "sslSocketFactoryCreator");
        this.f125650a = sslSocketFactoryCreator;
    }

    public final void a(HttpsURLConnection connection) {
        Intrinsics.j(connection, "connection");
        Object value = ((M) this.f125650a).f125649b.getValue();
