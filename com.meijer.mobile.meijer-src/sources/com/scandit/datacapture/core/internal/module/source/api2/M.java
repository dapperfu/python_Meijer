...
public final class M implements CameraCharacteristicsWrapper {
    ...
    public static final Size[] f125802b = {new Size(1920, 1080), new Size(1280, 720)};

    /* renamed from: a, reason: collision with root package name */
    public final CameraCharacteristics f125803a;
    ...
    public final Size[] getAvailableHighResYuvResolutions() {
        ...
        try {
            ...
            StreamConfigurationMap streamConfigurationMap = (StreamConfigurationMap) this.f125803a.get(key);
    ...
    public List getAvailablePreviewResolution() {
        ...
        try {
            ...
            Intrinsics.j(key, "key");
            StreamConfigurationMap streamConfigurationMap = (StreamConfigurationMap) this.f125803a.get(key);
            objB = Result.b((streamConfigurationMap == null || (outputSizes = streamConfigurationMap.getOutputSizes(SurfaceHolder.class)) == null) ? null : ArraysKt.W0(outputSizes, new L()));
        } catch (Throwable th2) {
            Result.Companion companion2 = Result.INSTANCE;
            objB = Result.b(ResultKt.a(th2));
        }
        List list = (List) (Result.g(objB) ? null : objB);
        return list == null ? ArraysKt.h1(f125802b) : list;
    }
    ...
    public Size[] getAvailableYuvResolutions() {
        ...
        Size[] sizeArr = (Size[]) (Result.g(objB) ? null : objB);
        return sizeArr == null ? f125802b : sizeArr;
    }

    @Override // com.scandit.datacapture.core.internal.sdk.source.api2.CameraCharacteristicsWrapper
    public final Range getSensorSensitivityRange() {
        Range range = (Range) this.f125803a.get(CameraCharacteristics.SENSOR_INFO_SENSITIVITY_RANGE);
    ...
    public M(CameraCharacteristics cameraCharacteristics) {
        ...
        this.f125803a = cameraCharacteristics;
    }

    @Override // com.scandit.datacapture.core.internal.sdk.source.api2.CameraCharacteristicsWrapper
    public final Object get(CameraCharacteristics.Key key) {
        Intrinsics.j(key, "key");
        return this.f125803a.get(key);
    }
    ...
    public final Range[] getAutoExposureAvailableFrameRateRanges() {
        ...
        Intrinsics.j(key, "key");
        Range[] rangeArr = (Range[]) this.f125803a.get(key);
        return rangeArr == null ? new Range[0] : rangeArr;
    }

    @Override // com.scandit.datacapture.core.internal.sdk.source.api2.CameraCharacteristicsWrapper
    public final List getAvailableCaptureRequestKeys() {
        List<CaptureRequest.Key<?>> availableCaptureRequestKeys = this.f125803a.getAvailableCaptureRequestKeys();
    ...
    public final Range getAvailableExposureTimeRange() {
        ...
        Intrinsics.j(key, "key");
        Range range = (Range) this.f125803a.get(key);
    ...
    public final long getAvailableMaxFrameDuration() {
        ...
        Intrinsics.j(key, "key");
        Long l10 = (Long) this.f125803a.get(key);
        if (l10 != null) {
    ...
    public final Set getAvailablePhysicalCameraIds() {
        ...
        Set physicalCameraIds = this.f125803a.getPhysicalCameraIds();
    ...
    public final double getCalculatedFieldOfView() {
        float[] fArr = (float[]) this.f125803a.get(CameraCharacteristics.LENS_INFO_AVAILABLE_FOCAL_LENGTHS);
        if (fArr == null) {
            return 0.0d;
        }
        for (float f10 : fArr) {
            if (((SizeF) this.f125803a.get(CameraCharacteristics.SENSOR_INFO_PHYSICAL_SIZE)) != null) {
    ...
    public final Rational getControlAeCompensationStep() {
        ...
        Intrinsics.j(key, "key");
        Rational rational = (Rational) this.f125803a.get(key);
        if (rational != null) {
            return rational;
        }
    ...
    public final Integer getFocusCalibration() {
        ...
        Intrinsics.j(key, "key");
        return (Integer) this.f125803a.get(key);
    }
    ...
    public final int getLensFacing() {
        ...
        Intrinsics.j(key, "key");
        Integer num = (Integer) this.f125803a.get(key);
        if (num != null) {
            return num.intValue();
        }
        return 1;
