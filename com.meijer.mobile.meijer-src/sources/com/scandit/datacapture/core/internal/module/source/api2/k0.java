...
public final class k0 implements CameraApi2InfoProvider {
    ...
    public final CameraManager f125875a;
    ...
    public final Iterable cameraInfos() throws CameraAccessException {
        ...
        Object[] objArr = null;
        try {
            String[] cameraIdList = this.f125875a.getCameraIdList();
            ...
            for (String str : cameraIdList) {
                CameraCharacteristics cameraCharacteristics = this.f125875a.getCameraCharacteristics(str);
