...
public final class ImuDataCollector {
    ...
    private final Listener f125144a;

    /* renamed from: b, reason: collision with root package name */
    private final SensorManager f125145b;

    /* renamed from: c, reason: collision with root package name */
    private final List f125146c;

    /* renamed from: d, reason: collision with root package name */
    private final a f125147d;
    ...
    public ImuDataCollector(Listener listener) {
        ...
        this.f125146c = M10;
        this.f125147d = new a(this);
    }

    public final void setEnabled(boolean enable) {
        if (enable) {
            for (Sensor sensor : this.f125146c) {
                SensorManager sensorManager = this.f125145b;
                if (sensorManager != null) {
                    sensorManager.registerListener(this.f125147d, sensor, 10000, 0);
                }
            }
            return;
        }
        for (Sensor sensor2 : this.f125146c) {
            SensorManager sensorManager2 = this.f125145b;
            if (sensorManager2 != null) {
                sensorManager2.unregisterListener(this.f125147d, sensor2);
            }
        }
    }
    ...
    public static final void access$onSensorEvent(ImuDataCollector imuDataCollector, SensorEvent sensorEvent) {
        ...
        if (type != 1) {
            ...
            Listener listener3 = imuDataCollector.f125144a;
        ...
        Listener listener4 = imuDataCollector.f125144a;
