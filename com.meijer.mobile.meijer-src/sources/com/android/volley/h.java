...
public class h {
    ...
    public final byte[] f63753b;

    /* renamed from: c, reason: collision with root package name */
    public final Map<String, String> f63754c;

    /* renamed from: d, reason: collision with root package name */
    public final List<e> f63755d;

    /* renamed from: e, reason: collision with root package name */
    public final boolean f63756e;

    /* renamed from: f, reason: collision with root package name */
    public final long f63757f;
    ...
    private h(int i10, byte[] bArr, Map<String, String> map, List<e> list, boolean z10, long j10) {
        ...
        if (list == null) {
            ...
            this.f63755d = Collections.unmodifiableList(list);
        }
        this.f63756e = z10;
        this.f63757f = j10;
    }
