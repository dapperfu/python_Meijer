...
public class h extends com.android.volley.toolbox.a {
    ...
    private final SSLSocketFactory f63822a;
    ...
    static class a extends FilterInputStream implements InputStreamRetargetInterface {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final HttpURLConnection f63823a;
        ...
        a(HttpURLConnection httpURLConnection) {
            ...
            this.f63823a = httpURLConnection;
        }

        @Override // java.io.FilterInputStream, java.io.InputStream, java.io.Closeable, java.lang.AutoCloseable
        public void close() throws IOException {
            super.close();
            this.f63823a.disconnect();
        }
    }
    ...
    private HttpURLConnection k(URL url, com.android.volley.i<?> iVar) throws IOException {
        ...
        if (BuildConfig.SERVICE_SCHEME.equals(url.getProtocol()) && (sSLSocketFactory = this.f63822a) != null) {
