...
final class l {
    ...
    static class b {
        ...
        private final VolleyError f63825b;

        private b(String str, VolleyError volleyError) {
            this.f63824a = str;
            this.f63825b = volleyError;
        }
    }
    ...
    static void d(long j10, com.android.volley.i<?> iVar, byte[] bArr, int i10) {
        if (com.android.volley.n.f63782b || j10 > 3000) {
    ...
    static void a(com.android.volley.i<?> iVar, b bVar) throws VolleyError {
        ...
        try {
            retryPolicy.b(bVar.f63825b);
            iVar.addMarker(String.format("%s-retry [timeout=%s]", bVar.f63824a, Integer.valueOf(timeoutMs)));
        } catch (VolleyError e10) {
            iVar.addMarker(String.format("%s-timeout-giveup [timeout=%s]", bVar.f63824a, Integer.valueOf(timeoutMs)));
            throw e10;
        }
    }

    static com.android.volley.h b(com.android.volley.i<?> iVar, long j10, List<com.android.volley.e> list) {
        a.C1250a cacheEntry = iVar.getCacheEntry();
        if (cacheEntry == null) {
            return new com.android.volley.h(HttpResponseStatus.REDIRECTION_NOT_MODIFIED, (byte[]) null, true, j10, list);
        }
        return new com.android.volley.h(HttpResponseStatus.REDIRECTION_NOT_MODIFIED, cacheEntry.f63718a, true, j10, e.a(list, cacheEntry));
    }
}
