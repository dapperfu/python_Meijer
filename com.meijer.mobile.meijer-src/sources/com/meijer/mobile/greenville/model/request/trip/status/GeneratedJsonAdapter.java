    ...
    public TransactionHeaderRequest fromJson(k reader) throws IOException {
        ...
        while (true) {
            ...
            if (!reader.hasNext()) {
                reader.d();
                if (str == null) {
                    throw C14410c.o("transactionDateTime", "transactionDateTime", reader);
                }
                if (str2 == null) {
                    throw C14410c.o("transactionDateTimeUTC", "transactionDateTimeUTC", reader);
                }
                if (num == null) {
                    throw C14410c.o("storeId", "storeId", reader);
                }
                int iIntValue = num.intValue();
                if (num2 == null) {
                    throw C14410c.o("terminal", "terminal", reader);
                }
                int iIntValue2 = num2.intValue();
                if (str3 == null) {
                    throw C14410c.o("eventTimeStamp", "eventTimeStamp", reader);
                }
                if (str4 == null) {
                    throw C14410c.o("eventTimeStampUTC", "eventTimeStampUTC", reader);
                }
                if (str5 == null) {
                    throw C14410c.o("deviceId", "deviceId", reader);
                }
                if (str6 == null) {
                    throw C14410c.o("deviceOS", "deviceOS", reader);
                }
                if (str7 == null) {
                    throw C14410c.o("deviceAppVersion", "deviceAppVersion", reader);
                }
                if (str8 == null) {
                    throw C14410c.o("deviceOSVersion", "deviceOSVersion", reader);
                }
                if (str9 == null) {
                    throw C14410c.o("transactionStatus", "transactionStatus", reader);
                }
                if (str10 == null) {
                    throw C14410c.o("transactionId", "transactionId", reader);
                }
                if (strFromJson11 == null) {
                    throw C14410c.o("trackingId", "trackingId", reader);
                }
                if (num3 != null) {
                ...
                throw C14410c.o("transactionNumber", "transactionNumber", reader);
            }
            switch (reader.z(this.options)) {
                ...
                case 0:
                    ...
                    if (strFromJson == null) {
                        throw C14410c.w("transactionDateTime", "transactionDateTime", reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    strFromJson2 = str2;
                ...
                case 1:
                    ...
                    if (strFromJson2 == null) {
                        throw C14410c.w("transactionDateTimeUTC", "transactionDateTimeUTC", reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    strFromJson = str;
                ...
                case 3:
                    ...
                    if (numFromJson2 == null) {
                        throw C14410c.w("terminal", "terminal", reader);
                    }
                    numFromJson = num;
                    strFromJson = str;
                    strFromJson2 = str2;
                ...
                case 4:
                    ...
                    if (strFromJson3 == null) {
                        throw C14410c.w("eventTimeStamp", "eventTimeStamp", reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    strFromJson = str;
                ...
                case 5:
                    ...
                    if (strFromJson4 == null) {
                        throw C14410c.w("eventTimeStampUTC", "eventTimeStampUTC", reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    strFromJson = str;
                ...
                case 6:
                    ...
                    if (strFromJson5 == null) {
                        throw C14410c.w("deviceId", "deviceId", reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    strFromJson = str;
                ...
                case 7:
                    ...
                    if (strFromJson6 == null) {
                        throw C14410c.w("deviceOS", "deviceOS", reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    strFromJson = str;
                ...
                case 8:
                    ...
                    if (strFromJson7 == null) {
                        throw C14410c.w("deviceAppVersion", "deviceAppVersion", reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    strFromJson = str;
                ...
                case 9:
                    ...
                    if (strFromJson8 == null) {
                        throw C14410c.w("deviceOSVersion", "deviceOSVersion", reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    strFromJson = str;
                ...
                case 10:
                    ...
                    if (strFromJson9 == null) {
                        throw C14410c.w("transactionStatus", "transactionStatus", reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    strFromJson = str;
                ...
                case 12:
                    ...
                    if (strFromJson11 == null) {
                        throw C14410c.w("trackingId", "trackingId", reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    strFromJson = str;
                ...
                case 13:
                    ...
                    if (numFromJson3 == null) {
                        throw C14410c.w("transactionNumber", "transactionNumber", reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    strFromJson = str;
