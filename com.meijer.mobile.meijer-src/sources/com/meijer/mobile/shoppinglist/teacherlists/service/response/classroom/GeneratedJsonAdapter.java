    ...
    public ClassroomListResponse fromJson(k reader) throws IOException {
        ...
        while (true) {
            ...
            if (!reader.hasNext()) {
                reader.d();
                if (num == null) {
                    throw C14410c.o(PreferencesHelper.PREF_ID, PreferencesHelper.PREF_ID, reader);
                }
                int iIntValue = num.intValue();
                if (str == null) {
                    throw C14410c.o("schoolName", "school_name", reader);
                }
                if (str2 == null) {
                    throw C14410c.o(PlaceTypes.ADDRESS, PlaceTypes.ADDRESS, reader);
                }
                if (str4 == null) {
                    throw C14410c.o("city", "city", reader);
                }
                if (str5 == null) {
                    throw C14410c.o("state", "state", reader);
                }
                if (str6 == null) {
                    throw C14410c.o("zip", "zip", reader);
                }
                if (str7 == null) {
                    throw C14410c.o("lowestGrade", "lowest_grade", reader);
                }
                if (str8 == null) {
                    throw C14410c.o("highestGrade", "highest_grade", reader);
                }
                if (str10 == null) {
                    throw C14410c.o("ncesId", "nces_id", reader);
                }
                if (num2 == null) {
                    throw C14410c.o("hasDressCode", "has_dress_code", reader);
                }
                int iIntValue2 = num2.intValue();
                if (num3 == null) {
                    throw C14410c.o("hasUniformPolicy", "has_uniform_policy", reader);
                }
                ...
                throw C14410c.o("classroomsList", "lists", reader);
            }
            switch (reader.z(this.options)) {
                ...
                case 0:
                    ...
                    if (numFromJson == null) {
                        throw C14410c.w(PreferencesHelper.PREF_ID, PreferencesHelper.PREF_ID, reader);
                    }
                    numFromJson2 = num2;
                    numFromJson3 = num3;
                    strFromJson = str;
                ...
                case 1:
                    ...
                    if (strFromJson == null) {
                        throw C14410c.w("schoolName", "school_name", reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    numFromJson3 = num3;
                ...
                case 2:
                    ...
                    if (strFromJson2 == null) {
                        throw C14410c.w(PlaceTypes.ADDRESS, PlaceTypes.ADDRESS, reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    numFromJson3 = num3;
                ...
                case 4:
                    ...
                    if (strFromJson4 == null) {
                        throw C14410c.w("city", "city", reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    numFromJson3 = num3;
                ...
                case 5:
                    ...
                    if (strFromJson5 == null) {
                        throw C14410c.w("state", "state", reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    numFromJson3 = num3;
                ...
                case 6:
                    ...
                    if (strFromJson6 == null) {
                        throw C14410c.w("zip", "zip", reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    numFromJson3 = num3;
                ...
                case 7:
                    ...
                    if (strFromJson7 == null) {
                        throw C14410c.w("lowestGrade", "lowest_grade", reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    numFromJson3 = num3;
                ...
                case 8:
                    ...
                    if (strFromJson8 == null) {
                        throw C14410c.w("highestGrade", "highest_grade", reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    numFromJson3 = num3;
                ...
                case 11:
                    ...
                    if (strFromJson10 == null) {
                        throw C14410c.w("ncesId", "nces_id", reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    numFromJson3 = num3;
                ...
                case 12:
                    ...
                    if (numFromJson2 == null) {
                        throw C14410c.w("hasDressCode", "has_dress_code", reader);
                    }
                    numFromJson = num;
                    numFromJson3 = num3;
                    strFromJson = str;
                ...
                case 13:
                    ...
                    if (numFromJson3 == null) {
                        throw C14410c.w("hasUniformPolicy", "has_uniform_policy", reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    strFromJson = str;
                ...
                case 14:
                    ...
                    if (listFromJson == null) {
                        throw C14410c.w("classroomsList", "lists", reader);
                    }
                    numFromJson = num;
                    numFromJson2 = num2;
                    numFromJson3 = num3;
