    ...
    public SuppliesListResponse fromJson(k reader) throws IOException {
        ...
        while (true) {
            ...
            if (!reader.hasNext()) {
                reader.d();
                if (str == null) {
                    throw C14410c.o("classroomName", "class_name", reader);
                }
                if (str2 == null) {
                    throw C14410c.o("schoolYear", "school_year", reader);
                }
                if (str3 == null) {
                    throw C14410c.o("updatedTimestamp", "updated_at", reader);
                }
                if (str4 == null) {
                    throw C14410c.o("schoolName", "school_name", reader);
                }
                if (str5 == null) {
                    throw C14410c.o("gradeLevel", "grade", reader);
                }
                if (list2 == null) {
                    throw C14410c.o("availableItems", "available_items", reader);
                }
                if (list3 != null) {
                    return new SuppliesListResponse(str, str2, str3, str4, str5, list2, list3);
                }
                throw C14410c.o("unavailableItems", "unavailable_items", reader);
            }
            switch (reader.z(this.options)) {
                ...
                case 0:
                    ...
                    if (strFromJson == null) {
                        throw C14410c.w("classroomName", "class_name", reader);
                    }
                    strFromJson2 = str2;
                    strFromJson3 = str3;
                    strFromJson4 = str4;
                ...
                case 1:
                    ...
                    if (strFromJson2 == null) {
                        throw C14410c.w("schoolYear", "school_year", reader);
                    }
                    strFromJson = str;
                    strFromJson3 = str3;
                    strFromJson4 = str4;
                ...
                case 2:
                    ...
                    if (strFromJson3 == null) {
                        throw C14410c.w("updatedTimestamp", "updated_at", reader);
                    }
                    strFromJson = str;
                    strFromJson2 = str2;
                    strFromJson4 = str4;
                ...
                case 4:
                    ...
                    if (strFromJson5 == null) {
                        throw C14410c.w("gradeLevel", "grade", reader);
                    }
                    strFromJson = str;
                    strFromJson2 = str2;
                    strFromJson3 = str3;
                ...
                case 5:
                    ...
                    if (listFromJson == null) {
                        throw C14410c.w("availableItems", "available_items", reader);
                    }
                    strFromJson = str;
                    strFromJson2 = str2;
                    strFromJson3 = str3;
                ...
                case 6:
                    ...
                    if (listFromJson2 == null) {
                        throw C14410c.w("unavailableItems", "unavailable_items", reader);
                    }
                    list = listFromJson2;
                    strFromJson = str;
                    strFromJson2 = str2;
