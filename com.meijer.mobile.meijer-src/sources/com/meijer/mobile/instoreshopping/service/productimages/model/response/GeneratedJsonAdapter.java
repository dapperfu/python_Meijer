    ...
    public ProductImagesResponse fromJson(k reader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        while (reader.hasNext()) {
            switch (reader.z(this.options)) {
                ...
                case 0:
                    ...
                    if (strFromJson == null) {
                        throw C14410c.w("upc", "upc", reader);
                    }
                    i10 &= -2;
                    break;
                case 1:
                ...
                case 2:
                    ...
                    if (strFromJson3 == null) {
                        throw C14410c.w("version", "version", reader);
                    }
                    i10 &= -5;
                    break;
                case 3:
                ...
                case 4:
                    ...
                    if (strFromJson5 == null) {
                        throw C14410c.w("angle", "angle", reader);
                    }
                    i10 &= -17;
                    break;
                case 5:
                    ...
                    if (strFromJson6 == null) {
                        throw C14410c.w("format", "format", reader);
                    }
                    i10 &= -33;
                    break;
                case 6:
                ...
                case 7:
                    ...
                    if (strFromJson8 == null) {
                        throw C14410c.w("path", "path", reader);
                    }
                    i10 &= -129;
                    break;
            }
        ...
        if (i10 != -256) {
            ...
            if (declaredConstructor == null) {
                declaredConstructor = ProductImagesResponse.class.getDeclaredConstructor(String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, Integer.TYPE, C14410c.f134472c);
