...
abstract class Hilt_WeeklyAdSelectionActivity extends ComponentActivity implements InterfaceC17928c {

    /* renamed from: r, reason: collision with root package name */
    private tu.h f120111r;

    /* renamed from: s, reason: collision with root package name */
    private volatile C17287a f120112s;

    /* renamed from: t, reason: collision with root package name */
    private final Object f120113t = new Object();

    /* renamed from: u, reason: collision with root package name */
    private boolean f120114u = false;
    ...
    public final C17287a componentManager() {
        if (this.f120112s == null) {
            synchronized (this.f120113t) {
                try {
                    if (this.f120112s == null) {
                        this.f120112s = createComponentManager();
                    }
                } finally {
                }
            }
        }
        return this.f120112s;
    }
    ...
    protected void inject() {
        ...
        this.f120114u = true;
        ((r) generatedComponent()).V0((WeeklyAdSelectionActivity) wu.f.a(this));
    }
    ...
    private void initSavedStateHandleHolder() {
        if (getApplication() instanceof InterfaceC17927b) {
            ...
            this.f120111r = hVarB;
            if (hVarB.b()) {
                this.f120111r.c(getDefaultViewModelCreationExtras());
            }
        }
    }
