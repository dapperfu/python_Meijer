...
@Metadata(d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0001\u0018\u00002\u00020\u0001B'\b\u0007\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\n\b\u0002\u0010\u0005\u001a\u0004\u0018\u00010\u0004\u0012\b\b\u0002\u0010\u0007\u001a\u00020\u0006¢\u0006\u0004\b\b\u0010\tJ\u0017\u0010\r\u001a\u00020\f2\b\u0010\u000b\u001a\u0004\u0018\u00010\n¢\u0006\u0004\b\r\u0010\u000eJ\u0017\u0010\u000f\u001a\u00020\f2\b\u0010\u000b\u001a\u0004\u0018\u00010\n¢\u0006\u0004\b\u000f\u0010\u000eJ\u0017\u0010\u0012\u001a\u00020\f2\b\u0010\u0011\u001a\u0004\u0018\u00010\u0010¢\u0006\u0004\b\u0012\u0010\u0013R\u0014\u0010\u0017\u001a\u00020\u00148\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0015\u0010\u0016¨\u0006\u0018"}, d2 = {"Lcom/meijer/mobile/widget/UnauthContentView;", "Landroidx/constraintlayout/widget/ConstraintLayout;", "Landroid/content/Context;", "context", "Landroid/util/AttributeSet;", "attrs", "", "defStyleAttr", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "", "text", "", "setTitle", "(Ljava/lang/String;)V", "setDesc", "Landroid/graphics/drawable/Drawable;", "drawable", "setIcon", "(Landroid/graphics/drawable/Drawable;)V", "LNn/L2;", "x", "LNn/L2;", "binding", "Meijer_playstoreRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public final class UnauthContentView extends ConstraintLayout {
    ...
    public final void setDesc(String text) {
        this.binding.f21520z.setText(text);
    }

    public final void setIcon(Drawable drawable) {
        this.binding.f21518A.setImageDrawable(drawable);
    }

    public final void setTitle(String text) {
        this.binding.f21519B.setText(text);
    }
    ...
    public UnauthContentView(Context context, AttributeSet attributeSet, int i10) {
        ...
        Intrinsics.j(context, "context");
        L2 l2M0 = L2.M0(ej.c.a(context), this, true);
        Intrinsics.i(l2M0, "inflate(...)");
        this.binding = l2M0;
        int[] UnauthContentView = a0.f101784E;
        ...
        Drawable drawable__fsTypeCheck_7aed730c0cb897b271b15a3fca45c160 = __fsTypeCheck_7aed730c0cb897b271b15a3fca45c160(typedArrayObtainStyledAttributes, a0.f101785F);
        ...
        String string = typedArrayObtainStyledAttributes.getString(a0.f101787H);
        if (string != null) {
            string = StringsKt.s0(string) ? null : string;
            if (string != null) {
                setTitle(string);
            }
        }
        String string2 = typedArrayObtainStyledAttributes.getString(a0.f101786G);
        if (string2 != null) {
            String str = StringsKt.s0(string2) ? null : string2;
            if (str != null) {
                setDesc(str);
            }
        }
