...
public final class UnauthFooterViewNewHomeScreen extends Hilt_UnauthFooterViewNewHomeScreen {
    ...
    public static final void H(UnauthFooterViewNewHomeScreen unauthFooterViewNewHomeScreen, View view) {
        Qj.g gVar = unauthFooterViewNewHomeScreen.listener;
        if (gVar != null) {
            gVar.onSignIn();
        }
    }
    ...
    public final void setListener(Qj.g gVar) {
        this.listener = gVar;
    }
    ...
    private final void G() {
        P2 p2M0 = P2.M0(ej.c.b(this), this, true);
        p2M0.f21605z.setOnClickListener(new View.OnClickListener() { // from class: com.meijer.mobile.widget.k
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                UnauthFooterViewNewHomeScreen.H(this.f120555a, view);
            }
        });
        p2M0.f21603A.setOnClickListener(new View.OnClickListener() { // from class: com.meijer.mobile.widget.l
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                UnauthFooterViewNewHomeScreen.I(this.f120556a, view);
            }
        });
    }
}
