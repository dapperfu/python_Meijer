...
public final class AddOfferErrorType implements b {
    ...
    @g(name = "0")
    public static final AddOfferErrorType SUCCESS = new AddOfferErrorType("SUCCESS", 0, 0, f.f158514l);

    @g(name = "8")
    public static final AddOfferErrorType INVALID_ARGUMENTS = new AddOfferErrorType("INVALID_ARGUMENTS", 1, 8, a.f43850a);

    @g(name = "15")
    public static final AddOfferErrorType ALREADY_ENROLLED_ERROR = new AddOfferErrorType("ALREADY_ENROLLED_ERROR", 2, 15, f.f158519q);

    @g(name = "20")
    public static final AddOfferErrorType CLIPPED_COUPONS_LIMIT_ERROR = new AddOfferErrorType("CLIPPED_COUPONS_LIMIT_ERROR", 3, 20, a.f43859j);

    @g(name = "30")
    public static final AddOfferErrorType ALREADY_CLIPPED_ERROR = new AddOfferErrorType("ALREADY_CLIPPED_ERROR", 4, 30, a.f43869t);

    @g(name = "42")
    public static final AddOfferErrorType OFFER_NOT_FOUND = new AddOfferErrorType("OFFER_NOT_FOUND", 5, 42, a.f43872w);

    @g(name = "43")
    public static final AddOfferErrorType OFFER_EXPIRED_ERROR = new AddOfferErrorType("OFFER_EXPIRED_ERROR", 6, 43, a.f43870u);

    @g(name = "44")
    public static final AddOfferErrorType OFFER_NO_LONGER_AVAILABLE_ERROR = new AddOfferErrorType("OFFER_NO_LONGER_AVAILABLE_ERROR", 7, 44, a.f43871v);

    @g(name = "52")
    public static final AddOfferErrorType INSUFFICIENT_POINTS_ERROR = new AddOfferErrorType("INSUFFICIENT_POINTS_ERROR", 8, 52, a.f43874y);

    @g(name = "53")
    public static final AddOfferErrorType ALREADY_CLIPPED_REWARD_ERROR = new AddOfferErrorType("ALREADY_CLIPPED_REWARD_ERROR", 9, 53, a.f43873x);
    public static final AddOfferErrorType UNKNOWN_ERROR = new AddOfferErrorType("UNKNOWN_ERROR", 10, -1, a.f43850a);
