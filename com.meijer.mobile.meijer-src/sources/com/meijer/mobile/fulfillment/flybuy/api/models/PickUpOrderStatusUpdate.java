...
public final /* data */ class PickUpOrderStatusUpdate {
    ...
    public final PickUpOrderStatusUpdate copy(@g(name = "event_type") String eventType, @g(name = "customer_state") String customerState, @g(name = NotificationsManager.INTENT_EXTRA_ORDER_ID) Integer orderId, @g(name = "eta_seconds") Integer etaSeconds) {
    ...
    public PickUpOrderStatusUpdate(@g(name = "event_type") String str, @g(name = "customer_state") String str2, @g(name = NotificationsManager.INTENT_EXTRA_ORDER_ID) Integer num, @g(name = "eta_seconds") Integer num2) {
        this.eventType = str;
