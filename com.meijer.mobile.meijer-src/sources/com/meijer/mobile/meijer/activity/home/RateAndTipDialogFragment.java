...
public final class RateAndTipDialogFragment extends MeijerDialogFragment {
    ...
    public AbstractC4243h1 binding;
    ...
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0015\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0007\u0010\bR\u0014\u0010\n\u001a\u00020\t8\u0006X\u0086T¢\u0006\u0006\n\u0004\b\n\u0010\u000bR\u0014\u0010\f\u001a\u00020\t8\u0006X\u0086T¢\u0006\u0006\n\u0004\b\f\u0010\u000b¨\u0006\r"}, d2 = {"Lcom/meijer/mobile/meijer/activity/home/RateAndTipDialogFragment$Companion;", "", "<init>", "()V", "Lpl/a;", "tipData", "Lcom/meijer/mobile/meijer/activity/home/RateAndTipDialogFragment;", "newInstance", "(Lpl/a;)Lcom/meijer/mobile/meijer/activity/home/RateAndTipDialogFragment;", "", "TAG", "Ljava/lang/String;", "KEY_TIP_DATA", "Meijer_playstoreRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    static final class a implements Function2<Composer, Integer, Unit> {
        ...
        static final class C1674a implements Function3<LocalThemeScope, Composer, Integer, Unit> {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ RateAndTipDialogFragment f110586a;

            C1674a(RateAndTipDialogFragment rateAndTipDialogFragment) {
                this.f110586a = rateAndTipDialogFragment;
            }
            ...
            public final void d(LocalThemeScope AdsTheme, Composer composer, int i10) {
                ...
                AbstractC6392a shopperName = this.f110586a.getDecorator().getShopperName();
                composer.startReplaceGroup(5004770);
                boolean zD = composer.D(this.f110586a);
                final RateAndTipDialogFragment rateAndTipDialogFragment = this.f110586a;
                Object objB = composer.B();
                if (zD || objB == Composer.INSTANCE.a()) {
                    objB = new Function0() { // from class: com.meijer.mobile.meijer.activity.home.a1
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            return RateAndTipDialogFragment.a.C1674a.e(rateAndTipDialogFragment);
                        }
                    };
                    composer.t(objB);
                }
                ...
                composer.P();
                composer.startReplaceGroup(5004770);
                boolean zD2 = composer.D(this.f110586a);
                final RateAndTipDialogFragment rateAndTipDialogFragment2 = this.f110586a;
                Object objB2 = composer.B();
                if (zD2 || objB2 == Composer.INSTANCE.a()) {
                    objB2 = new Function0() { // from class: com.meijer.mobile.meijer.activity.home.b1
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            return RateAndTipDialogFragment.a.C1674a.f(rateAndTipDialogFragment2);
                        }
                    };
                    composer.t(objB2);
                }
                ...
                composer.P();
                composer.startReplaceGroup(5004770);
                boolean zD3 = composer.D(this.f110586a);
                final RateAndTipDialogFragment rateAndTipDialogFragment3 = this.f110586a;
                Object objB3 = composer.B();
                if (zD3 || objB3 == Composer.INSTANCE.a()) {
                    objB3 = new Function0() { // from class: com.meijer.mobile.meijer.activity.home.c1
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            return RateAndTipDialogFragment.a.C1674a.g(rateAndTipDialogFragment3);
                        }
                    };
                    composer.t(objB3);
                }
                composer.P();
                C15538s.e(AdsTheme, shopperName, null, function0, function02, (Function0) objB3, composer, (i10 & 14) | LocalThemeScope.f17314g | (AbstractC6392a.f60445b << 3), 2);
                if (ComposerKt.M()) {
                    ComposerKt.T();
                }
            }
        ...
        public final void a(Composer composer, int i10) {
            ...
            Ki.K.b(null, ComposableLambdaKt.c(487611666, true, new C1674a(RateAndTipDialogFragment.this), composer, 54), composer, 48, 1);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        setBinding(AbstractC4243h1.M0(inflater));
        getBinding().f21992z.setContent(ComposableLambdaKt.composableLambdaInstance(237811009, true, new a()));
        View root = getBinding().getRoot();
        Intrinsics.i(root, "getRoot(...)");
        return root;
    }

    public final void setBinding(AbstractC4243h1 abstractC4243h1) {
        Intrinsics.j(abstractC4243h1, "<set-?>");
        this.binding = abstractC4243h1;
    }
