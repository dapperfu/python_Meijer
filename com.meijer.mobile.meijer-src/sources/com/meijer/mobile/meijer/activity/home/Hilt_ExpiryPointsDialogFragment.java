...
abstract class Hilt_ExpiryPointsDialogFragment extends BottomSheetDialogFragment implements InterfaceC17928c {
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((ExpiryPointsDialogFragment_GeneratedInjector) generatedComponent()).injectExpiryPointsDialogFragment((ExpiryPointsDialogFragment) wu.f.a(this));
    }

    Hilt_ExpiryPointsDialogFragment() {
    }
