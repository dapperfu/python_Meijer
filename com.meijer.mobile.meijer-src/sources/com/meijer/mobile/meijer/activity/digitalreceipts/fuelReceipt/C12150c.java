...
public final class C12150c {
    public static final TransactionDetails a(FuelReceiptDecorator fuelReceiptDecorator) {
        ...
        LocalDate localDate = LocalDate.parse(fuelReceiptDecorator.getDate().c().e(), C17898a.MONTH_DAY_YEAR_SHORT);
        Intrinsics.i(localDate, "parse(...)");
        LocalTime localTime = LocalTime.parse(fuelReceiptDecorator.getTime().c().e(), C17898a.HOUR_MINUTE_SECOND_SHORT);
