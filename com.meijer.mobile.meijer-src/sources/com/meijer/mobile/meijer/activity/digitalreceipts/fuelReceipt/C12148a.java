...
public final class C12148a implements z1.W {
    ...
    public static final class C1581a implements InterfaceC18417E {

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ String f106569b;
        ...
        public int a(int offset) {
            return offset > this.f106569b.length() ? this.f106569b.length() : offset;
        }
    }

    public C12148a(String format, char c10) {
    ...
    public TransformedText a(AnnotatedString inputText) {
        ...
        int i10 = 0;
        String strK1 = inputText.getText().length() >= 6 ? StringsKt.k1(inputText.getText(), RangesKt.x(0, 6)) : inputText.getText();
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        spannableStringBuilder.append((CharSequence) strK1);
        ...
        return new TransformedText(bVar.q(), new C1581a(strK1));
    }
}
