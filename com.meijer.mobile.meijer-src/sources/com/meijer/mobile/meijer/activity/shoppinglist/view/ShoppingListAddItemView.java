...
public final class ShoppingListAddItemView extends LinearLayout implements View.OnTouchListener, l.a {
    ...
    private InterfaceC14523a analyticsEngine;

    /* renamed from: h, reason: collision with root package name and from kotlin metadata */
    private boolean isTrackingFavorites;

    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\bf\u0018\u00002\u00020\u0001J\u000f\u0010\u0003\u001a\u00020\u0002H&¢\u0006\u0004\b\u0003\u0010\u0004J\u0017\u0010\u0007\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0005H&¢\u0006\u0004\b\u0007\u0010\bJ\u000f\u0010\t\u001a\u00020\u0002H&¢\u0006\u0004\b\t\u0010\u0004J\u000f\u0010\n\u001a\u00020\u0002H&¢\u0006\u0004\b\n\u0010\u0004ø\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001¨\u0006\u000bÀ\u0006\u0001"}, d2 = {"Lcom/meijer/mobile/meijer/activity/shoppinglist/view/ShoppingListAddItemView$a;", "", "", "onScan", "()V", "LFq/c;", "shoppingListItem", "h", "(LFq/c;)V", "g0", "K", "Meijer_playstoreRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public interface a {
        void K();
    ...
    private final void k() {
        ...
        editText.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: com.meijer.mobile.meijer.activity.shoppinglist.view.f
            ...
            public final boolean onEditorAction(TextView textView, int i10, KeyEvent keyEvent) {
                return ShoppingListAddItemView.l(this.f113384a, textView, i10, keyEvent);
            }
        });
        ...
        editText2.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: com.meijer.mobile.meijer.activity.shoppinglist.view.g
            ...
            public final void onFocusChange(View view, boolean z10) {
                ShoppingListAddItemView.m(this.f113385a, view, z10);
            }
        });
    }
    ...
    public void b(String text) {
        ...
        Intrinsics.g(interfaceC14523a);
        interfaceC14523a.h(C14756c.a(this.isTrackingFavorites ? "event: shopping list favorites typeahead arrow" : "event: shopping list typeahead arrow"), C14756c.c("Shopping List"), C14756c.g("shopping list"));
        String str = text + ' ';
        EditText editText = this.addItemEditText;
        Intrinsics.g(editText);
    ...
    public final void f(Activity activity, boolean isTrackingFavorites, InterfaceC14523a analyticsEngine) {
        Intrinsics.j(activity, "activity");
        Intrinsics.j(analyticsEngine, "analyticsEngine");
        this.addItemEditText = (EditText) activity.findViewById(T.f100056q);
        k();
        activity.findViewById(T.f99817T6).setOnClickListener(new View.OnClickListener() { // from class: com.meijer.mobile.meijer.activity.shoppinglist.view.e
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ShoppingListAddItemView.g(this.f113383a, view);
            }
        });
        ...
        View viewFindViewById = findViewById(T.f99890a9);
        Intrinsics.g(viewFindViewById);
        RecyclerView recyclerView = (RecyclerView) viewFindViewById;
        recyclerView.setAdapter(this.typeAheadListAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.addItemDecoration(new j.a(getContext()).e(P.f99509e).d());
        this.typeAheadRecycleView = recyclerView;
        View viewFindViewById2 = findViewById(T.f99835V4);
