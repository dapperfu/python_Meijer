...
public final class ShoppingListUnauthenticatedFragment extends Hilt_ShoppingListUnauthenticatedFragment implements g {
    ...
    public static final int f113353h = 8;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        D1 d1M0 = D1.M0(inflater, container, false);
        Intrinsics.i(d1M0, "inflate(...)");
        d1M0.f21296G.setListener(this);
        View root = d1M0.getRoot();
    ...
    public void onSignIn() {
        Context contextRequireContext = requireContext();
        Intrinsics.i(contextRequireContext, "requireContext(...)");
        startActivity(Bl.k.b(contextRequireContext, false, null, Integer.valueOf(HttpResponseStatus.SUCCESS_OK), null, null, null, 118, null));
    }
}
