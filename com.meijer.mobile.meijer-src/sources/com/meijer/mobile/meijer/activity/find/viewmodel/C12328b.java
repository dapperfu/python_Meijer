...
public final class C12328b {
    ...
    public C12328b(List<String> clickBeaconsSent, List<String> viewBeaconsSent, List<String> loadBeaconsSent, List<String> stepperBeaconsSent, List<String> carouselCriteoProductTracking) {
    ...
    public /* synthetic */ C12328b(List list, List list2, List list3, List list4, List list5, int i10, DefaultConstructorMarker defaultConstructorMarker) {
