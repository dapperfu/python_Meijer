...
public final class FilterActivity extends Hilt_FilterActivity {
    ...
    public static final int f107548v = 8;
    ...
    private final Lazy key = LazyKt.b(new Function0() { // from class: com.meijer.mobile.meijer.activity.find.filter.c
        ...
        public final Object invoke() {
            return FilterActivity.N1(this.f107561a);
        }
    });
    ...
    public /* synthetic */ class b {
        ...
        static {
            ...
            try {
                iArr[h.f107565b.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[h.f107564a.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[h.f107566c.ordinal()] = 3;
    ...
    static final class c extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        ...
        static final class a<T> implements InterfaceC16562g {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ FilterActivity f107553a;

            a(FilterActivity filterActivity) {
                this.f107553a = filterActivity;
            }
            ...
            public final Object emit(i iVar, Continuation<? super Unit> continuation) {
                if (iVar instanceof i.FinishWithResult) {
                    this.f107553a.J1((i.FinishWithResult) iVar);
                    ...
                    this.f107553a.O1((i.ShowSaveChangesDialogEvent) iVar);
                }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                ResultKt.b(obj);
                InterfaceC16561f<i> interfaceC16561fP = FilterActivity.this.L1().p();
                a aVar = new a(FilterActivity.this);
                this.f107551a = 1;
                if (interfaceC16561fP.collect(aVar, this) == objF) {
                    return objF;
                }
            }
            return Unit.f143329a;
    ...
    static final class d implements Function2<Composer, Integer, Unit> {
        ...
        public final void a(Composer composer, int i10) {
            ...
            boolean z10 = FilterActivity.this.getFeatureManager().e(AbstractC18503f.C18519q.f172896h) && C13581o.a(composer, 0);
            composer.P();
            Vm.c.c(oVarL1, kVarB, z10, modifierFsUnmask, composer, 0, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final class e extends Lambda implements Function0<f0.c> {
        ...
        final /* synthetic */ ComponentActivity f107555f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public e(ComponentActivity componentActivity) {
            super(0);
            this.f107555f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final f0.c invoke() {
            return this.f107555f.getDefaultViewModelProviderFactory();
        }
    }
    ...
    public static final class f extends Lambda implements Function0<g0> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f107556f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public f(ComponentActivity componentActivity) {
            super(0);
            this.f107556f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final g0 invoke() {
            return this.f107556f.getCom.google.android.libraries.places.api.model.PlaceTypes.STORE java.lang.String();
        }
    }
    ...
    public static final class g extends Lambda implements Function0<CreationExtras> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function0 f107557f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f107558g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public g(Function0 function0, ComponentActivity componentActivity) {
            super(0);
            this.f107557f = function0;
            this.f107558g = componentActivity;
        }
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f107557f;
            return (function0 == null || (creationExtras = (CreationExtras) function0.invoke()) == null) ? this.f107558g.getDefaultViewModelCreationExtras() : creationExtras;
        }
    }
    ...
    public final void O1(i.ShowSaveChangesDialogEvent event) {
        new C15485b(this).setTitle(event.getTitle()).setMessage(event.getMessage()).setPositiveButton(event.getPositiveButtonText(), new DialogInterface.OnClickListener() { // from class: com.meijer.mobile.meijer.activity.find.filter.d
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i10) {
                FilterActivity.P1(this.f107562a, dialogInterface, i10);
            }
            ...
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i10) {
                FilterActivity.Q1(this.f107563a, dialogInterface, i10);
            }
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    ...
                    Intrinsics.g(obj3);
                    intentPutExtra = intent.putExtra(strName, l.BrowseCollection.v((l.BrowseCollection) obj3, null, 0, 0, null, null, 0, null, false, null, null, null, finishEvent.getQuery().F3(), finishEvent.getQuery().getSelectedSort(), null, null, 26623, null));
                } else {
                    throw new NoWhenBranchMatchedException();
                }
            } else {
                ...
                Intrinsics.g(obj2);
                intentPutExtra = intent3.putExtra(strName3, l.Search.v((l.Search) obj2, null, null, null, 0, 0, null, null, 0, null, false, null, null, finishEvent.getQuery().F3(), finishEvent.getQuery().getSelectedSort(), null, null, null, null, null, 511999, null));
            }
        } else {
            ...
            Intrinsics.g(obj);
            intentPutExtra = intent5.putExtra(strName5, l.Department.v((l.Department) obj, null, 0, 0, null, null, 0, null, false, null, null, null, null, finishEvent.getQuery().F3(), finishEvent.getQuery().getSelectedSort(), null, 20479, null));
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (parcelable != null) {
            ...
            if (kVar.getSelectedSort() == null) {
                kVar.q1((FilterSortOption) CollectionsKt.u0(kVar.u3()));
            }
            oVarL1.u(loadItems);
            L1().u(new j.SetQuery((Qo.l) parcelable));
        }
        C15809k.d(C6173t.a(this), null, null, new c(null), 3, null);
        C13737e.b(this, null, ComposableLambdaKt.composableLambdaInstance(-222552715, true, new d()), 1, null);
    }
}
