...
abstract class Hilt_ImageDetailActivity extends ComponentActivity implements InterfaceC17928c {

    /* renamed from: r, reason: collision with root package name */
    private tu.h f107322r;

    /* renamed from: s, reason: collision with root package name */
    private volatile C17287a f107323s;

    /* renamed from: t, reason: collision with root package name */
    private final Object f107324t = new Object();

    /* renamed from: u, reason: collision with root package name */
    private boolean f107325u = false;
    ...
    public final C17287a componentManager() {
        if (this.f107323s == null) {
            synchronized (this.f107324t) {
                try {
                    if (this.f107323s == null) {
                        this.f107323s = createComponentManager();
                    }
                } finally {
                }
            }
        }
        return this.f107323s;
    }
    ...
    protected void inject() {
        ...
        this.f107325u = true;
        ((InterfaceC12213h0) generatedComponent()).m((ImageDetailActivity) wu.f.a(this));
    }
    ...
    private void initSavedStateHandleHolder() {
        if (getApplication() instanceof InterfaceC17927b) {
            ...
            this.f107322r = hVarB;
            if (hVarB.b()) {
                this.f107322r.c(getDefaultViewModelCreationExtras());
            }
        }
    }
