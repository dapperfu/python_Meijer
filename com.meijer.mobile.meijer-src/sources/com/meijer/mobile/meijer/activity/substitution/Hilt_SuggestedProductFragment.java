...
abstract class Hilt_SuggestedProductFragment extends MeijerFragment implements InterfaceC17928c {

    /* renamed from: a, reason: collision with root package name */
    private ContextWrapper f113649a;

    /* renamed from: b, reason: collision with root package name */
    private boolean f113650b;

    /* renamed from: c, reason: collision with root package name */
    private volatile C17293g f113651c;

    /* renamed from: d, reason: collision with root package name */
    private final Object f113652d = new Object();

    /* renamed from: e, reason: collision with root package name */
    private boolean f113653e = false;
    ...
    private void initializeComponentContext() {
        if (this.f113649a == null) {
            this.f113649a = C17293g.b(super.getContext(), this);
            this.f113650b = C16547a.a(super.getContext());
        }
    }

    @Override // wu.InterfaceC17928c
    public final C17293g componentManager() {
        if (this.f113651c == null) {
            synchronized (this.f113652d) {
                try {
                    if (this.f113651c == null) {
                        this.f113651c = createComponentManager();
                    }
                } finally {
                }
            }
    ...
    protected void inject() {
        ...
        this.f113653e = true;
        ((L) generatedComponent()).d((SuggestedProductFragment) wu.f.a(this));
    }
    ...
    public Context getContext() {
        if (super.getContext() == null && !this.f113650b) {
            return null;
        }
        initializeComponentContext();
    ...
    public void onAttach(Activity activity) {
        ...
        ContextWrapper contextWrapper = this.f113649a;
