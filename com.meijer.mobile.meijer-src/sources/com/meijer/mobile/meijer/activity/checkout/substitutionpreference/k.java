...
@Metadata(d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0006\u001a?\u0010\t\u001a\u00020\u0007*\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00012\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u00032\u0014\b\u0002\u0010\b\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u00070\u0005H\u0001¢\u0006\u0004\b\t\u0010\n\u001aI\u0010\u000f\u001a\u00020\u0007*\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00012\n\b\u0002\u0010\f\u001a\u0004\u0018\u00010\u000b2\b\b\u0002\u0010\u000e\u001a\u00020\r2\u0014\b\u0002\u0010\b\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u00070\u0005H\u0003¢\u0006\u0004\b\u000f\u0010\u0010\u001a\u001f\u0010\u0011\u001a\u00020\u0007*\u00020\u00002\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u0003H\u0003¢\u0006\u0004\b\u0011\u0010\u0012¨\u0006\u0013"}, d2 = {"LKi/M;", "Landroidx/compose/ui/Modifier;", "modifier", "Lcom/meijer/mobile/meijer/activity/checkout/substitutionpreference/v$g;", "viewState", "Lkotlin/Function1;", "Lcom/meijer/mobile/meijer/activity/checkout/substitutionpreference/v$e;", "", "onAction", "n", "(LKi/M;Landroidx/compose/ui/Modifier;Lcom/meijer/mobile/meijer/activity/checkout/substitutionpreference/v$g;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;II)V", "Lfj/D;", "substitutionPreference", "", "isSelected", "j", "(LKi/M;Landroidx/compose/ui/Modifier;Lfj/D;ZLkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;II)V", "h", "(LKi/M;Lcom/meijer/mobile/meijer/activity/checkout/substitutionpreference/v$g;Landroidx/compose/runtime/Composer;II)V", "Meijer_playstoreRelease"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class k {
    ...
    static final class a implements Function3<InterfaceC15154X, Composer, Integer, Unit> {
        ...
        final /* synthetic */ LocalThemeScope f106124a;

        a(LocalThemeScope localThemeScope) {
            this.f106124a = localThemeScope;
        }
        ...
        public final void a(InterfaceC15154X Assemble, Composer composer, int i10) {
            ...
            Ci.m.d(this.f106124a, FullStoryAnnotationsKt.fsUnmask(J.f(Modifier.INSTANCE, 0.0f, 1, null)), largeLoading, oVar, null, null, null, composer, LocalThemeScope.f17314g | 3072 | (q1.k.Large.f142345f << 6), 56);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final class b extends Lambda implements Function1 {
        ...
        public static final b f106125f = new b();
    ...
    public static final class c extends Lambda implements Function1<Integer, Object> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function1 f106126f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ List f106127g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public c(Function1 function1, List list) {
            super(1);
            this.f106126f = function1;
            this.f106127g = list;
        }

        public final Object a(int i10) {
            return this.f106126f.invoke(this.f106127g.get(i10));
        }
    ...
    public static final class d extends Lambda implements Function4<InterfaceC15433c, Integer, Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ List f106128f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f106129g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ v.ViewState f106130h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ Function1 f106131i;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(List list, LocalThemeScope localThemeScope, v.ViewState gVar, Function1 function1) {
            super(4);
            this.f106128f = list;
            this.f106129g = localThemeScope;
            this.f106130h = gVar;
            this.f106131i = function1;
        }
        ...
        public final void a(InterfaceC15433c interfaceC15433c, int i10, Composer composer, int i11) {
            ...
            SubstitutePreference substitutePreference = (SubstitutePreference) this.f106128f.get(i10);
            composer.startReplaceGroup(1392378592);
            LocalThemeScope localThemeScope = this.f106129g;
            String name = substitutePreference.getName();
            SubstitutePreference substitutePreferenceC = this.f106130h.getSelectedOption();
            k.j(localThemeScope, null, substitutePreference, Intrinsics.e(name, substitutePreferenceC != null ? substitutePreferenceC.getName() : null), this.f106131i, composer, LocalThemeScope.f17314g, 1);
            composer.P();
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
    ...
    */
    public static final void j(final Ki.LocalThemeScope r34, androidx.compose.ui.Modifier r35, fj.SubstitutePreference r36, boolean r37, kotlin.jvm.functions.Function1<? super com.meijer.mobile.meijer.activity.checkout.substitutionpreference.v.e, kotlin.Unit> r38, androidx.compose.runtime.Composer r39, final int r40, final int r41) {
        /*
            Method dump skipped, instructions count: 830
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meijer.mobile.meijer.activity.checkout.substitutionpreference.k.j(Ki.M, androidx.compose.ui.Modifier, fj.D, boolean, kotlin.jvm.functions.Function1, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void n(final Ki.LocalThemeScope r36, androidx.compose.ui.Modifier r37, com.meijer.mobile.meijer.activity.checkout.substitutionpreference.v.ViewState r38, kotlin.jvm.functions.Function1<? super com.meijer.mobile.meijer.activity.checkout.substitutionpreference.v.e, kotlin.Unit> r39, androidx.compose.runtime.Composer r40, final int r41, final int r42) {
        /*
            Method dump skipped, instructions count: 660
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meijer.mobile.meijer.activity.checkout.substitutionpreference.k.n(Ki.M, androidx.compose.ui.Modifier, com.meijer.mobile.meijer.activity.checkout.substitutionpreference.v$g, kotlin.jvm.functions.Function1, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final Unit p(List list, LocalThemeScope localThemeScope, v.ViewState gVar, Function1 function1, l0.w LazyColumn) {
        ...
        LazyColumn.i(list.size(), null, new c(b.f106125f, list), ComposableLambdaKt.composableLambdaInstance(-632812321, true, new d(list, localThemeScope, gVar, function1)));
        return Unit.f143329a;
    }
    ...
    private static final void h(final LocalThemeScope localThemeScope, final v.ViewState gVar, Composer composer, final int i10, final int i11) {
        ...
        if ((i12 & 19) == 18 && composerStartRestartGroup.j()) {
            ...
            if (z10) {
                Q.e(localThemeScope, Q0.b.f141966a, ComposableLambdaKt.c(1933957901, true, new a(localThemeScope), composerStartRestartGroup, 54), composerStartRestartGroup, (i12 & 14) | LocalThemeScope.f17314g | 384 | (Q0.b.f141967b << 3));
            }
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
