...
@Metadata(d1 = {"\u0000d\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0001\u0018\u0000 -2\u00020\u00012\u00020\u0002:\u00010B\u0007¢\u0006\u0004\b\u0003\u0010\u0004J\u0017\u0010\b\u001a\u00020\u00072\u0006\u0010\u0006\u001a\u00020\u0005H\u0002¢\u0006\u0004\b\b\u0010\tJ%\u0010\u000f\u001a\u00020\u00072\u0006\u0010\u000b\u001a\u00020\n2\f\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\r0\fH\u0002¢\u0006\u0004\b\u000f\u0010\u0010J\u0019\u0010\u0013\u001a\u00020\u00072\b\u0010\u0012\u001a\u0004\u0018\u00010\u0011H\u0014¢\u0006\u0004\b\u0013\u0010\u0014R\u0016\u0010\u0018\u001a\u00020\u00158\u0002@\u0002X\u0082.¢\u0006\u0006\n\u0004\b\u0016\u0010\u0017R\u0018\u0010\u000b\u001a\u0004\u0018\u00010\n8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0019\u0010\u001aR\u0018\u0010\u001c\u001a\u0004\u0018\u00010\n8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u001b\u0010\u001aR\u0016\u0010 \u001a\u00020\u001d8\u0002@\u0002X\u0082.¢\u0006\u0006\n\u0004\b\u001e\u0010\u001fR\u001a\u0010%\u001a\b\u0012\u0004\u0012\u00020\"0!8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b#\u0010$R\u001b\u0010+\u001a\u00020&8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b'\u0010(\u001a\u0004\b)\u0010*R\u0014\u0010/\u001a\u00020,8VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b-\u0010.¨\u00061"}, d2 = {"Lcom/meijer/mobile/meijer/activity/checkout/outofstock/OutOfStockActivity;", "Lcom/meijer/mobile/meijer/activity/MeijerActivity;", "LBj/b;", "<init>", "()V", "Lg/a;", "result", "", "R1", "(Lg/a;)V", "", "cartId", "", "Lcom/meijer/mobile/meijer/activity/checkout/outofstock/l$b$b;", "itemStates", "X1", "(Ljava/lang/String;Ljava/util/List;)V", "Landroid/os/Bundle;", "savedInstanceState", "onCreate", "(Landroid/os/Bundle;)V", "LNn/C;", "s", "LNn/C;", "binding", "t", "Ljava/lang/String;", "u", "cartItemCount", "Lcom/meijer/mobile/meijer/activity/checkout/outofstock/j;", "v", "Lcom/meijer/mobile/meijer/activity/checkout/outofstock/j;", "adapter", "Lg/c;", "Landroid/content/Intent;", "w", "Lg/c;", "substitutionResultLauncher", "Lcom/meijer/mobile/meijer/activity/checkout/outofstock/o;", "x", "Lkotlin/Lazy;", "Q1", "()Lcom/meijer/mobile/meijer/activity/checkout/outofstock/o;", "outOfStockViewModel", "Landroidx/appcompat/widget/Toolbar;", "y", "()Landroidx/appcompat/widget/Toolbar;", "toolbar", "a", "Meijer_playstoreRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* loaded from: classes10.dex */
public final class OutOfStockActivity extends Hilt_OutOfStockActivity implements Bj.b {

    /* renamed from: y, reason: collision with root package name and from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);

    /* renamed from: z, reason: collision with root package name */
    public static final int f104319z = 8;
    ...
    private final AbstractC14276c<Intent> substitutionResultLauncher = registerForActivityResult(new h.i(), new f());
    ...
    static final class b extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        ...
        static final class a extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
            ...
            final /* synthetic */ OutOfStockActivity f104329b;
            ...
            static final class C1484a<T> implements InterfaceC16562g {

                /* renamed from: a, reason: collision with root package name */
                final /* synthetic */ OutOfStockActivity f104330a;

                C1484a(OutOfStockActivity outOfStockActivity) {
                    this.f104330a = outOfStockActivity;
                }
                ...
                public final Object emit(l lVar, Continuation<? super Unit> continuation) {
                    ...
                    if (lVar instanceof l.c) {
                        C c11 = this.f104330a.binding;
                        if (c11 == null) {
                            Intrinsics.x("binding");
                        } else {
                            c10 = c11;
                        }
                        c10.f21265I.X(true, true);
                    } else if (lVar instanceof l.a) {
                        this.f104330a.finish();
                        OutOfStockActivity outOfStockActivity = this.f104330a;
                        ...
                        if (bVar instanceof l.b.OutOfStockAdapterState) {
                            C c12 = this.f104330a.binding;
                            if (c12 == null) {
                                Intrinsics.x("binding");
                                c12 = null;
                            }
                            c12.f21265I.X(false, true);
                            j jVar2 = this.f104330a.adapter;
                            if (jVar2 == null) {
                            ...
                            this.f104330a.X1(outOfStockAdapterState.getCartId(), outOfStockAdapterState.b());
                        } else {
                            if (!(bVar instanceof l.b.OutOfStockItemState)) {
                                throw new NoWhenBranchMatchedException();
                            }
                            j jVar3 = this.f104330a.adapter;
                            if (jVar3 == null) {
                                Intrinsics.x("adapter");
                            } else {
                                jVar = jVar3;
                        ...
                        InterfaceC14523a analyticsEngine = this.f104330a.getAnalyticsEngine();
                        AbstractC14761h.Action actionA = C14756c.a("Items Out of Stock: Search New Item");
                        final OutOfStockActivity outOfStockActivity2 = this.f104330a;
                        analyticsEngine.b(actionA, new Function1() { // from class: com.meijer.mobile.meijer.activity.checkout.outofstock.h
                            @Override // kotlin.jvm.functions.Function1
                            public final Object invoke(Object obj) {
                                return OutOfStockActivity.b.a.C1484a.g(outOfStockActivity2, (TrackingData) obj);
                            }
                        });
                        this.f104330a.substitutionResultLauncher.a(t.e(t.f3152a, this.f104330a, ((l.OpenFindSubstitution) lVar).getItemToSubstitute().f(), Pp.c.f26246b, null, "Meijer:CartPage", 8, null));
                    }
                    return Unit.f143329a;
                }
            }
            ...
            a(OutOfStockActivity outOfStockActivity, Continuation<? super a> continuation) {
                ...
                this.f104329b = outOfStockActivity;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new a(this.f104329b, continuation);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i10 != 0) {
                    ...
                    ResultKt.b(obj);
                    P<l> pW = this.f104329b.Q1().w();
                    C1484a c1484a = new C1484a(this.f104329b);
                    this.f104328a = 1;
                    if (pW.collect(c1484a, this) == objF) {
                        return objF;
                    }
                }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                this.f104326a = 1;
                if (C6136J.b(outOfStockActivity, bVar, aVar, this) == objF) {
                    return objF;
                }
            }
            return Unit.f143329a;
    ...
    public static final class c extends Lambda implements Function0<f0.c> {
        ...
        final /* synthetic */ ComponentActivity f104331f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public c(ComponentActivity componentActivity) {
            super(0);
            this.f104331f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final f0.c invoke() {
            return this.f104331f.getDefaultViewModelProviderFactory();
        }
    }
    ...
    public static final class d extends Lambda implements Function0<g0> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f104332f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(ComponentActivity componentActivity) {
            super(0);
            this.f104332f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final g0 invoke() {
            return this.f104332f.getCom.google.android.libraries.places.api.model.PlaceTypes.STORE java.lang.String();
        }
    }
    ...
    public static final class e extends Lambda implements Function0<CreationExtras> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function0 f104333f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f104334g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public e(Function0 function0, ComponentActivity componentActivity) {
            super(0);
            this.f104333f = function0;
            this.f104334g = componentActivity;
        }
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f104333f;
            return (function0 == null || (creationExtras = (CreationExtras) function0.invoke()) == null) ? this.f104334g.getDefaultViewModelCreationExtras() : creationExtras;
        }
    }
    ...
    public static final Unit U1(final OutOfStockActivity outOfStockActivity, F addCallback) {
        ...
        outOfStockActivity.getAnalyticsEngine().b(C14756c.a("Items Out of Stock: Back"), new Function1() { // from class: com.meijer.mobile.meijer.activity.checkout.outofstock.f
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return OutOfStockActivity.V1(this.f104343a, (TrackingData) obj);
            }
        });
    ...
    public final void X1(final String cartId, List<l.b.OutOfStockItemState> itemStates) {
        ...
        getAnalyticsEngine().b(C14756c.h("Items Out of Stock"), new Function1() { // from class: com.meijer.mobile.meijer.activity.checkout.outofstock.g
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    public Toolbar y() {
        ...
        MaterialToolbar toolbar = c10.f21266J;
        Intrinsics.i(toolbar, "toolbar");
        return toolbar;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void R1(C14274a result) {
    ...
    public static final Unit S1(final OutOfStockActivity outOfStockActivity) {
        outOfStockActivity.getAnalyticsEngine().b(C14756c.a("Items Out of Stock: Back"), new Function1() { // from class: com.meijer.mobile.meijer.activity.checkout.outofstock.e
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return OutOfStockActivity.T1(this.f104342a, (TrackingData) obj);
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        C cM0 = C.M0(getLayoutInflater());
        this.binding = cM0;
        if (cM0 == null) {
            Intrinsics.x("binding");
            cM0 = null;
        }
        setContentView(Zr.a.j(cM0.getRoot(), false, 1, null));
        U0(C17284b.f163334m0);
        Drawable navigationIcon = y().getNavigationIcon();
        if (navigationIcon != null) {
            navigationIcon.setVisible(false, false);
        }
        this.adapter = new j(Q1());
        Bj.b.o(this, 0, 0, new Function0() { // from class: com.meijer.mobile.meijer.activity.checkout.outofstock.b
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return OutOfStockActivity.S1(this.f104339a);
            }
        }, 3, null);
        I.a(getOnBackPressedDispatcher(), this, true, new Function1() { // from class: com.meijer.mobile.meijer.activity.checkout.outofstock.c
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return OutOfStockActivity.U1(this.f104340a, (F) obj);
            }
        });
        C c10 = this.binding;
        if (c10 == null) {
        ...
        RecyclerView recyclerView = c10.f21264H;
        j jVar = this.adapter;
        if (jVar == null) {
            Intrinsics.x("adapter");
            jVar = null;
        ...
        c11.f21259C.setOnClickListener(new View.OnClickListener() { // from class: com.meijer.mobile.meijer.activity.checkout.outofstock.d
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                OutOfStockActivity.W1(this.f104341a, view);
            }
        });
        C c12 = this.binding;
        if (c12 == null) {
        ...
        c12.f21262F.setText(C17284b.f163324h0);
