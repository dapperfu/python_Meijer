...
public final class P extends Ek.b<DeliveryContactInformationViewState> {
    ...
    public DeliveryContactInformationViewState b(DeliveryContactInformationViewState oldState) {
        ...
        return DeliveryContactInformationViewState.i(oldState, new Validation(this.emailAddress, null, 2, null), new Validation(this.phoneNumber, null, 2, null), new Validation(Boolean.valueOf(this.agreedToTerms), null, 2, null), null, null, null, false, false, false, null, false, false, false, false, null, 32632, null).z();
    }
