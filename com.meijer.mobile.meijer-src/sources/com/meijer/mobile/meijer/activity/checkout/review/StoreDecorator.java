...
public final /* data */ class StoreDecorator {
    ...
    @Metadata(d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u001d\u0010\b\u001a\u00020\u00072\u000e\u0010\u0006\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00050\u0004¢\u0006\u0004\b\b\u0010\tJ#\u0010\r\u001a\u00020\u00072\b\u0010\n\u001a\u0004\u0018\u00010\u00052\n\b\u0002\u0010\f\u001a\u0004\u0018\u00010\u000b¢\u0006\u0004\b\r\u0010\u000eJ#\u0010\u0011\u001a\u00020\u00072\b\u0010\u0010\u001a\u0004\u0018\u00010\u000f2\n\b\u0002\u0010\f\u001a\u0004\u0018\u00010\u000b¢\u0006\u0004\b\u0011\u0010\u0012¨\u0006\u0013"}, d2 = {"Lcom/meijer/mobile/meijer/activity/checkout/review/X1$a;", "", "<init>", "()V", "LIk/b;", "LTq/c;", "validation", "Lcom/meijer/mobile/meijer/activity/checkout/review/X1;", "e", "(LIk/b;)Lcom/meijer/mobile/meijer/activity/checkout/review/X1;", "pointOfService", "", "error", "a", "(LTq/c;Ljava/lang/String;)Lcom/meijer/mobile/meijer/activity/checkout/review/X1;", "Lpk/h;", "storeDetails", "b", "(Lpk/h;Ljava/lang/String;)Lcom/meijer/mobile/meijer/activity/checkout/review/X1;", "Meijer_playstoreRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public static final class Companion {
        ...
        public final StoreDecorator a(PointOfService pointOfService, String error) {
            ...
            if (pointOfService == null) {
                return new StoreDecorator(null, null, null, null, null, null, null, null, null, 0.0d, 0.0d, Integer.valueOf(com.meijer.mobile.meijer.Y.f100707Ua), 2047, null);
            }
            ...
            if (address2 != null) {
                C17269a c17269a = C17269a.f163094a;
                ...
                strC = c17269a.c(town, isoCodeShort, address2.getPostalCode());
            } else {
                strC = null;
            }
            C17269a c17269a2 = C17269a.f163094a;
            StoreAddress address3 = pointOfService.getAddress();
            String strG = c17269a2.g(address3 != null ? address3.getPostalCode() : null);
            ...
            Integer numValueOf2 = Integer.valueOf(com.meijer.mobile.meijer.Y.f100707Ua);
        ...
        public final StoreDecorator b(StoreDetails storeDetails, String error) {
            if (storeDetails != null) {
                ...
                String strC = C17269a.f163094a.c(storeDetails.getCity(), storeDetails.getState(), storeDetails.getZipCode());
        ...
        public final StoreDecorator e(Validation<PointOfService> validation) {
            ...
            Ik.c cVar = (Ik.c) CollectionsKt.u0(validation.getResult().a());
            return a(pointOfServiceE, cVar != null ? cVar.getMessage() : null);
        }
    }

    public StoreDecorator() {
        this(null, null, null, null, null, null, null, null, null, 0.0d, 0.0d, null, l3.f93322b, null);
    }
