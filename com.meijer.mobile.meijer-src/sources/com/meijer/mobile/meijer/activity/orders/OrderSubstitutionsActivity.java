...
public final class OrderSubstitutionsActivity extends Hilt_OrderSubstitutionsActivity {
    ...
    private final Lazy viewModel = new androidx.view.e0(Reflection.b(sn.o0.class), new c(this), new b(this), new d(null, this));

    /* renamed from: u, reason: collision with root package name and from kotlin metadata */
    private String orderId = new String();

    @Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0001\u001a\u00020\u0000H\n¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"Lsn/o0$e;", "viewState", "", "<anonymous>", "(Lsn/o0$e;)V"}, k = 3, mv = {2, 1, 0})
    ...
    static final class a extends SuspendLambda implements Function2<o0.ViewState, Continuation<? super Unit>, Object> {
        ...
        /* synthetic */ Object f111195b;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ vo.b f111197d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ boolean f111198e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ String f111199f;
        ...
        static final class C1694a implements Function2<Composer, Integer, Unit> {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ OrderSubstitutionsActivity f111200a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ o0.ViewState f111201b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ vo.b f111202c;

            /* renamed from: d, reason: collision with root package name */
            final /* synthetic */ boolean f111203d;

            /* renamed from: e, reason: collision with root package name */
            final /* synthetic */ String f111204e;
            ...
            static final class C1695a implements Function3<LocalThemeScope, Composer, Integer, Unit> {

                /* renamed from: a, reason: collision with root package name */
                final /* synthetic */ OrderSubstitutionsActivity f111205a;

                /* renamed from: b, reason: collision with root package name */
                final /* synthetic */ o0.ViewState f111206b;

                /* renamed from: c, reason: collision with root package name */
                final /* synthetic */ vo.b f111207c;

                /* renamed from: d, reason: collision with root package name */
                final /* synthetic */ boolean f111208d;

                /* renamed from: e, reason: collision with root package name */
                final /* synthetic */ String f111209e;
                ...
                /* synthetic */ class C1696a extends FunctionReferenceImpl implements Function0<Unit> {
                    C1696a(Object obj) {
                ...
                C1695a(OrderSubstitutionsActivity orderSubstitutionsActivity, o0.ViewState viewState, vo.b bVar, boolean z10, String str) {
                    this.f111205a = orderSubstitutionsActivity;
                    this.f111206b = viewState;
                    this.f111207c = bVar;
                    this.f111208d = z10;
                    this.f111209e = str;
                }
                ...
                public final void b(LocalThemeScope AdsTheme, Composer composer, int i10) {
                    ...
                    String str = this.f111205a.orderId;
                    OrderSubstitutionsActivity orderSubstitutionsActivity = this.f111205a;
                    composer.startReplaceGroup(5004770);
                    boolean zD = composer.D(orderSubstitutionsActivity);
                    Object objB = composer.B();
                    if (zD || objB == Composer.INSTANCE.a()) {
                        objB = new C1696a(orderSubstitutionsActivity);
                        composer.t(objB);
                    }
                    KFunction kFunction = (KFunction) objB;
                    composer.P();
                    List<OrderSubstitutionsListDecorator> listD = this.f111206b.d();
                    List<OrderOutOfStockListDecorator> listC = this.f111206b.c();
                    OrderSubstitutionsActivity orderSubstitutionsActivity2 = this.f111205a;
                    composer.startReplaceGroup(5004770);
                    ...
                    composer.P();
                    OrderSubstitutionsActivity orderSubstitutionsActivity3 = this.f111205a;
                    composer.startReplaceGroup(5004770);
                    ...
                    composer.P();
                    OrderSubstitutionsActivity orderSubstitutionsActivity4 = this.f111205a;
                    composer.startReplaceGroup(5004770);
                    ...
                    boolean zD5 = composer.D(this.f111205a) | composer.d(this.f111207c.ordinal()) | composer.a(this.f111208d) | composer.V(this.f111209e);
                    final OrderSubstitutionsActivity orderSubstitutionsActivity5 = this.f111205a;
                    final vo.b bVar = this.f111207c;
                    final boolean z10 = this.f111208d;
                    final String str2 = this.f111209e;
                    Object objB5 = composer.B();
                    if (zD5 || objB5 == Composer.INSTANCE.a()) {
                        objB5 = new Function0() { // from class: com.meijer.mobile.meijer.activity.orders.b0
                            @Override // kotlin.jvm.functions.Function0
                            public final Object invoke() {
                                return OrderSubstitutionsActivity.a.C1694a.C1695a.c(orderSubstitutionsActivity5, bVar, z10, str2);
                            }
                        };
                        composer.t(objB5);
                    }
                    composer.P();
                    U.o(AdsTheme, companion, str, function0, (Function0) objB5, (Function0) kFunction2, listD, listC, this.f111207c, (Function1) kFunction3, (Function1) kFunction4, composer, LocalThemeScope.f17314g | 48 | (i12 & 14), 0, 0);
                    if (ComposerKt.M()) {
                        ComposerKt.T();
                    }
                }
            ...
            C1694a(OrderSubstitutionsActivity orderSubstitutionsActivity, o0.ViewState viewState, vo.b bVar, boolean z10, String str) {
                this.f111200a = orderSubstitutionsActivity;
                this.f111201b = viewState;
                this.f111202c = bVar;
                this.f111203d = z10;
                this.f111204e = str;
            }
            ...
            public final void a(Composer composer, int i10) {
                ...
                Ki.K.b(null, ComposableLambdaKt.c(-328569293, true, new C1695a(this.f111200a, this.f111201b, this.f111202c, this.f111203d, this.f111204e), composer, 54), composer, 48, 1);
                if (ComposerKt.M()) {
                    ComposerKt.T();
                }
            }
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            a aVar = OrderSubstitutionsActivity.this.new a(this.f111197d, this.f111198e, this.f111199f, continuation);
            aVar.f111195b = obj;
            return aVar;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f111194a == 0) {
                ResultKt.b(obj);
                o0.ViewState viewState = (o0.ViewState) this.f111195b;
                OrderSubstitutionsActivity.this.T1(this.f111197d);
                Nn.A a10 = OrderSubstitutionsActivity.this.binding;
                if (a10 == null) {
                    Intrinsics.x("binding");
                    a10 = null;
                }
                a10.f21210z.setContent(ComposableLambdaKt.composableLambdaInstance(-744042972, true, new C1694a(OrderSubstitutionsActivity.this, viewState, this.f111197d, this.f111198e, this.f111199f)));
    ...
    public static final class b extends Lambda implements Function0<f0.c> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f111210f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public b(ComponentActivity componentActivity) {
            super(0);
            this.f111210f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final f0.c invoke() {
            return this.f111210f.getDefaultViewModelProviderFactory();
        }
    }
    ...
    public static final class c extends Lambda implements Function0<androidx.view.g0> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f111211f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public c(ComponentActivity componentActivity) {
            super(0);
            this.f111211f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final androidx.view.g0 invoke() {
            return this.f111211f.getCom.google.android.libraries.places.api.model.PlaceTypes.STORE java.lang.String();
        }
    }
    ...
    public static final class d extends Lambda implements Function0<CreationExtras> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function0 f111212f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f111213g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(Function0 function0, ComponentActivity componentActivity) {
            super(0);
            this.f111212f = function0;
            this.f111213g = componentActivity;
        }
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f111212f;
            return (function0 == null || (creationExtras = (CreationExtras) function0.invoke()) == null) ? this.f111213g.getDefaultViewModelCreationExtras() : creationExtras;
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final sn.o0 U1() {
        return (sn.o0) this.viewModel.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void V1() {
        startActivity(Bl.l.b(Bl.l.f3131a, this, this.orderId, "", null, 8, null));
        finish();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void Y1(int title, int message, int positiveButton) {
        new C15485b(this).setTitle(title).setCancelable(false).setMessage(message).setPositiveButton(positiveButton, new DialogInterface.OnClickListener() { // from class: com.meijer.mobile.meijer.activity.orders.Y
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i10) {
                OrderSubstitutionsActivity.Z1(this.f111375a, dialogInterface, i10);
            }
        }).show();
    }
    ...
    public final void a2(int title, int positiveButton, int negativeButton) {
        new C15485b(this).setTitle(title).setCancelable(false).setPositiveButton(positiveButton, new DialogInterface.OnClickListener() { // from class: com.meijer.mobile.meijer.activity.orders.Z
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i10) {
            ...
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i10) {
                OrderSubstitutionsActivity.c2(this.f111376a, dialogInterface, i10);
            }
        }).show();
    }
    ...
    public final void d2(int title, int message, int positiveButton, int negativeButton) {
        new C15485b(this).setTitle(title).setCancelable(false).setMessage(message).setPositiveButton(positiveButton, new DialogInterface.OnClickListener() { // from class: com.meijer.mobile.meijer.activity.orders.W
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i10) {
                OrderSubstitutionsActivity.e2(this.f111374a, dialogInterface, i10);
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Nn.A aM0 = Nn.A.M0(getLayoutInflater());
        this.binding = aM0;
        ...
        setContentView(Zr.a.j(aM0.getRoot(), false, 1, null));
        ...
        if (booleanExtra) {
            a2(com.meijer.mobile.meijer.Y.f101175s5, yr.Q.f171761b, Cj.o.f5084r);
        }
        C16563h.J(C16563h.O(U1().E(), new a(bVar, booleanExtra, str, null)), C6173t.a(this));
    }
}
