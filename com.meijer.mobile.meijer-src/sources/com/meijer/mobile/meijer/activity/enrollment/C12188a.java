...
public final class C12188a {
    ...
    public C12188a(Ch.b accountRepository) {
    ...
    public final void d(String phoneNumber, String pinNumber, boolean isWeeklyAdSelected, boolean isTextAdSelected) {
        Intrinsics.j(phoneNumber, "phoneNumber");
        Intrinsics.j(pinNumber, "pinNumber");
        this.createAccountState.getMeijerAccount().E(Long.parseLong(StringsKt.C1(phoneNumber).toString()));
