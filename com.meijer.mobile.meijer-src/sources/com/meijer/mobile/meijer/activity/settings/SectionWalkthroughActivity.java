...
@Metadata(d1 = {"\u0000h\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0007\u0018\u00002\u00020\u00012\u00020\u0002B\u0007¢\u0006\u0004\b\u0003\u0010\u0004J\u0017\u0010\b\u001a\u00020\u00072\u0006\u0010\u0006\u001a\u00020\u0005H\u0002¢\u0006\u0004\b\b\u0010\tJ\u0017\u0010\f\u001a\u00020\u00072\u0006\u0010\u000b\u001a\u00020\nH\u0002¢\u0006\u0004\b\f\u0010\rJ\u0019\u0010\u0010\u001a\u00020\u00072\b\u0010\u000f\u001a\u0004\u0018\u00010\u000eH\u0014¢\u0006\u0004\b\u0010\u0010\u0011J\u001d\u0010\u0015\u001a\u00020\u0007*\u00020\u00122\b\b\u0002\u0010\u0014\u001a\u00020\u0013H\u0007¢\u0006\u0004\b\u0015\u0010\u0016J'\u0010\u001b\u001a\u00020\u00072\b\b\u0001\u0010\u0018\u001a\u00020\u00172\f\u0010\u001a\u001a\b\u0012\u0004\u0012\u00020\u00070\u0019H\u0007¢\u0006\u0004\b\u001b\u0010\u001cJ\u000f\u0010\u001d\u001a\u00020\u0007H\u0016¢\u0006\u0004\b\u001d\u0010\u0004R\u0016\u0010!\u001a\u00020\u001e8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u001f\u0010 R\u0018\u0010%\u001a\u0004\u0018\u00010\"8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b#\u0010$R\u0016\u0010)\u001a\u00020&8\u0002@\u0002X\u0082.¢\u0006\u0006\n\u0004\b'\u0010(R\u0014\u0010-\u001a\u00020*8VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b+\u0010,¨\u0006/²\u0006\u000e\u0010.\u001a\u00020\u001e8\n@\nX\u008a\u008e\u0002"}, d2 = {"Lcom/meijer/mobile/meijer/activity/settings/SectionWalkthroughActivity;", "Lcom/meijer/mobile/meijer/activity/MeijerActivity;", "LBj/b;", "<init>", "()V", "Lcom/meijer/mobile/core/design/widget/howTo/WalkThroughType;", "walkThroughType", "", "c2", "(Lcom/meijer/mobile/core/design/widget/howTo/WalkThroughType;)V", "Lii/i$c;", "page", "Z1", "(Lii/i$c;)V", "Landroid/os/Bundle;", "savedInstanceState", "onCreate", "(Landroid/os/Bundle;)V", "LKi/M;", "Landroidx/compose/ui/Modifier;", "modifier", "K1", "(LKi/M;Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;II)V", "", "stringRes", "Lkotlin/Function0;", "onClickAction", "S1", "(ILkotlin/jvm/functions/Function0;Landroidx/compose/runtime/Composer;I)V", "onPause", "", "s", "Z", "isRewardsFirstTimeOpened", "LJu/b;", "t", "LJu/b;", "disposable", "LNn/V;", "u", "LNn/V;", "binding", "Landroidx/appcompat/widget/Toolbar;", "y", "()Landroidx/appcompat/widget/Toolbar;", "toolbar", "showWalkThru", "Meijer_playstoreRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* loaded from: classes10.dex */
public final class SectionWalkthroughActivity extends Hilt_SectionWalkthroughActivity implements Bj.b {

    /* renamed from: s, reason: collision with root package name and from kotlin metadata */
    private boolean isRewardsFirstTimeOpened;

    /* renamed from: t, reason: collision with root package name and from kotlin metadata */
    private Ju.b disposable;
    ...
    static final class a implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ LocalThemeScope f112596b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ InterfaceC5872l0<Boolean> f112597c;

        a(LocalThemeScope localThemeScope, InterfaceC5872l0<Boolean> interfaceC5872l0) {
            this.f112596b = localThemeScope;
            this.f112597c = interfaceC5872l0;
        }
        ...
        public static final Unit g(SectionWalkthroughActivity sectionWalkthroughActivity, TrackingData track) {
            ...
            if (sectionWalkthroughActivity.isRewardsFirstTimeOpened) {
                track.p(sectionWalkthroughActivity.getString(Y.f101078n8));
        ...
        public final void d(Composer composer, int i10) {
            ...
            if (SectionWalkthroughActivity.Q1(this.f112597c)) {
                V v10 = SectionWalkthroughActivity.this.binding;
                if (v10 == null) {
                    Intrinsics.x("binding");
                    v10 = null;
                }
                v10.f21693E.setImportantForAccessibility(4);
                LocalThemeScope localThemeScope = this.f112596b;
                ...
                final InterfaceC5872l0<Boolean> interfaceC5872l0 = this.f112597c;
                Object objB = composer.B();
                if (zD || objB == Composer.INSTANCE.a()) {
                    objB = new Function0() { // from class: com.meijer.mobile.meijer.activity.settings.t
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            return SectionWalkthroughActivity.a.e(sectionWalkthroughActivity, interfaceC5872l0);
                        }
                    };
                    composer.t(objB);
                }
                ...
                composer.P();
                ns.q.l(localThemeScope, null, function0, (Function1) objB2, composer, LocalThemeScope.f17314g, 1);
            }
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final Unit e(SectionWalkthroughActivity sectionWalkthroughActivity, InterfaceC5872l0 interfaceC5872l0) {
            V v10 = sectionWalkthroughActivity.binding;
            if (v10 == null) {
                Intrinsics.x("binding");
                v10 = null;
            }
            v10.f21693E.setImportantForAccessibility(1);
            SectionWalkthroughActivity.R1(interfaceC5872l0, false);
            return Unit.f143329a;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Unit f(final SectionWalkthroughActivity sectionWalkthroughActivity, int i10) {
            InterfaceC14523a analyticsEngine = sectionWalkthroughActivity.getAnalyticsEngine();
            String string = sectionWalkthroughActivity.getString(i10);
            Intrinsics.i(string, "getString(...)");
            analyticsEngine.b(C14756c.h(string), new Function1() { // from class: com.meijer.mobile.meijer.activity.settings.v
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
    ...
    static final class b implements Function3<LocalThemeScope, Composer, Integer, Unit> {
        ...
        final /* synthetic */ Function0<Unit> f112598a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ int f112599b;
        ...
        public final void b(LocalThemeScope AdsTheme, Composer composer, int i10) {
            ...
            composer.startReplaceGroup(5004770);
            boolean zV = composer.V(this.f112598a);
            final Function0<Unit> function0 = this.f112598a;
            Object objB = composer.B();
            ...
            String string = ((Context) composer.o(AndroidCompositionLocals_androidKt.g())).getString(this.f112599b);
            Intrinsics.i(string, "getString(...)");
            si.j.h(AdsTheme, label, string, null, composer, (i11 & 14) | LocalThemeScope.f17314g | (q1.Label.f142335j << 3), 4);
            C17983Z.a(J.i(J.h(companion, 0.0f, 1, null), H1.h.p(1)), AdsTheme.getAdsColors().getAdsColorUIDivider().getColor(), 0.0f, 0.0f, composer, 6, 12);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class c implements Function2<Composer, Integer, Unit> {
        ...
        static final class a implements Function3<LocalThemeScope, Composer, Integer, Unit> {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ SectionWalkthroughActivity f112601a;

            a(SectionWalkthroughActivity sectionWalkthroughActivity) {
                this.f112601a = sectionWalkthroughActivity;
            }
            ...
            public final void a(LocalThemeScope AdsTheme, Composer composer, int i10) {
                ...
                this.f112601a.K1(AdsTheme, null, composer, LocalThemeScope.f17314g | (i10 & 14), 1);
                if (ComposerKt.M()) {
                    ComposerKt.T();
                }
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit N1(SectionWalkthroughActivity sectionWalkthroughActivity, InterfaceC5872l0 interfaceC5872l0, LocalThemeScope localThemeScope) {
        R1(interfaceC5872l0, true);
        ...
        v10.f21689A.setContent(ComposableLambdaKt.composableLambdaInstance(835168634, true, sectionWalkthroughActivity.new a(localThemeScope, interfaceC5872l0)));
        return Unit.f143329a;
    }
    ...
    public static final Unit M1(SectionWalkthroughActivity sectionWalkthroughActivity) {
        ...
        sectionWalkthroughActivity.Z1(C14756c.c("rewards: help: pharmacy"));
        return Unit.f143329a;
    }
    ...
    public static final Unit O1(SectionWalkthroughActivity sectionWalkthroughActivity) {
        ...
        sectionWalkthroughActivity.Z1(C14756c.c("rewards: help: mCard"));
        return Unit.f143329a;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit a2(AbstractC14762i.Page page, TrackingData track) {
        Intrinsics.j(track, "$this$track");
        track.v("rewards");
        track.c(page);
        return Unit.f143329a;
    ...
    */
    public final void K1(final Ki.LocalThemeScope r18, androidx.compose.ui.Modifier r19, androidx.compose.runtime.Composer r20, final int r21, final int r22) {
        /*
            Method dump skipped, instructions count: 506
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meijer.mobile.meijer.activity.settings.SectionWalkthroughActivity.K1(Ki.M, androidx.compose.ui.Modifier, androidx.compose.runtime.Composer, int, int):void");
    }
        ...
        if (t0L != null) {
            t0L.a(new Function2() { // from class: com.meijer.mobile.meijer.activity.settings.r
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return SectionWalkthroughActivity.T1(this.f113195a, i10, onClickAction, i11, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    public Toolbar y() {
        ...
        MaterialToolbar appBar = v10.f21694z;
        Intrinsics.i(appBar, "appBar");
        return appBar;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean Q1(InterfaceC5872l0<Boolean> interfaceC5872l0) {
        return interfaceC5872l0.getValue().booleanValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void R1(InterfaceC5872l0<Boolean> interfaceC5872l0, boolean z10) {
        interfaceC5872l0.setValue(Boolean.valueOf(z10));
    }

    private final void Z1(final AbstractC14762i.Page page) {
        getAnalyticsEngine().b(C14756c.a("event: walkthrough"), new Function1() { // from class: com.meijer.mobile.meijer.activity.settings.s
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(Zr.a.j(vM0.getRoot(), false, 1, null));
        V v11 = this.binding;
        if (v11 == null) {
            Intrinsics.x("binding");
        } else {
        ...
        v10.f21692D.setContent(ComposableLambdaKt.composableLambdaInstance(2051538070, true, new c()));
        Bj.b.o(this, 0, 0, new Function0() { // from class: com.meijer.mobile.meijer.activity.settings.l
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return SectionWalkthroughActivity.b2(this.f113183a);
            }
        }, 3, null);
    }
