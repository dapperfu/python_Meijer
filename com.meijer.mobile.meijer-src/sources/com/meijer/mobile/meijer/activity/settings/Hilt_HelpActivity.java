...
abstract class Hilt_HelpActivity extends ComponentActivity implements InterfaceC17928c {

    /* renamed from: r, reason: collision with root package name */
    private tu.h f112585r;

    /* renamed from: s, reason: collision with root package name */
    private volatile C17287a f112586s;

    /* renamed from: t, reason: collision with root package name */
    private final Object f112587t = new Object();

    /* renamed from: u, reason: collision with root package name */
    private boolean f112588u = false;
    ...
    public final C17287a componentManager() {
        if (this.f112586s == null) {
            synchronized (this.f112587t) {
                try {
                    if (this.f112586s == null) {
                        this.f112586s = createComponentManager();
                    }
                } finally {
                }
            }
        }
        return this.f112586s;
    }
    ...
    protected void inject() {
        ...
        this.f112588u = true;
        ((j) generatedComponent()).w0((HelpActivity) wu.f.a(this));
    }
    ...
    private void initSavedStateHandleHolder() {
        if (getApplication() instanceof InterfaceC17927b) {
            ...
            this.f112585r = hVarB;
            if (hVarB.b()) {
                this.f112585r.c(getDefaultViewModelCreationExtras());
            }
        }
    }
