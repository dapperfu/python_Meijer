    ...
    public UpdateTipNotificationRequest fromJson(k reader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        while (reader.hasNext()) {
            ...
            if (iZ == -1) {
                ...
                if (strFromJson == null) {
                    throw C14410c.w("externalShopperId", "externalShopperId", reader);
                }
            } else if (iZ == 1) {
                ...
                if (strFromJson3 == null) {
                    throw C14410c.w("modalState", "modalState", reader);
                }
                i10 = -5;
            } else {
                continue;
        ...
        if (i10 == -5) {
            if (strFromJson == null) {
                throw C14410c.o("externalShopperId", "externalShopperId", reader);
            }
            if (strFromJson2 == null) {
                throw C14410c.o("orderId", "orderId", reader);
            }
        ...
        if (declaredConstructor == null) {
            declaredConstructor = UpdateTipNotificationRequest.class.getDeclaredConstructor(String.class, String.class, String.class, Integer.TYPE, C14410c.f134472c);
