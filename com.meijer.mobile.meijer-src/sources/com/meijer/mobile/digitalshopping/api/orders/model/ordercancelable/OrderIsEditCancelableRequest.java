...
public final /* data */ class OrderIsEditCancelableRequest {
    ...
    public final OrderIsEditCancelableRequest copy(@g(name = "store_id") int storeId, @g(name = NotificationsManager.INTENT_EXTRA_ORDER_ID) String orderId) {
    ...
    public OrderIsEditCancelableRequest(@g(name = "store_id") int i10, @g(name = NotificationsManager.INTENT_EXTRA_ORDER_ID) String orderId) {
        Intrinsics.j(orderId, "orderId");
        this.storeId = i10;
