...
public abstract class q {
    ...
    public static final /* data */ class Empty extends q {
        ...
        public static final int f119806b = AbstractC6392a.f60445b;
        ...
        public /* synthetic */ Empty(SubscriptionEmptyErrorStateDecorator subscriptionEmptyErrorStateDecorator, int i10, DefaultConstructorMarker defaultConstructorMarker) {
            if ((i10 & 1) != 0) {
                ...
                subscriptionEmptyErrorStateDecorator = new SubscriptionEmptyErrorStateDecorator(companion.d(C15410d.f148773b0, new Object[0]), companion.d(C15410d.f148750I0, new Object[0]), Integer.valueOf(C15408b.f148725d));
            }
    ...
    public static final /* data */ class Error extends q {
        ...
        /* renamed from: b, reason: collision with root package name */
        public static final int f119808b = AbstractC6392a.f60445b;
        ...
        public /* synthetic */ Error(SubscriptionEmptyErrorStateDecorator subscriptionEmptyErrorStateDecorator, int i10, DefaultConstructorMarker defaultConstructorMarker) {
            if ((i10 & 1) != 0) {
                AbstractC6392a.Companion companion = AbstractC6392a.INSTANCE;
                subscriptionEmptyErrorStateDecorator = new SubscriptionEmptyErrorStateDecorator(companion.d(C15410d.f148738C0, new Object[0]), companion.d(C15410d.f148779e0, new Object[0]), Integer.valueOf(C15408b.f148726e));
            }
            this(subscriptionEmptyErrorStateDecorator);
        }
    ...
    public static final /* data */ class c extends q {
        ...
        public static final c f119810a = new c();
