...
public final class HowSubscriptionsWorksActivity extends ComponentActivity {
    ...
    static final class a implements Function2<Composer, Integer, Unit> {
        ...
        static final class C1930a implements Function3<LocalThemeScope, Composer, Integer, Unit> {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ HowSubscriptionsWorksActivity f119704a;

            C1930a(HowSubscriptionsWorksActivity howSubscriptionsWorksActivity) {
                this.f119704a = howSubscriptionsWorksActivity;
            }
            ...
            public final void b(LocalThemeScope AdsTheme, Composer composer, int i10) {
                ...
                boolean zD = composer.D(this.f119704a);
                final HowSubscriptionsWorksActivity howSubscriptionsWorksActivity = this.f119704a;
                Object objB = composer.B();
                if (zD || objB == Composer.INSTANCE.a()) {
                    objB = new Function0() { // from class: com.meijer.mobile.subscription.ux.howItWorks.a
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            return HowSubscriptionsWorksActivity.a.C1930a.c(howSubscriptionsWorksActivity);
                        }
                    };
                    composer.t(objB);
                }
                composer.P();
                C16015h.m(AdsTheme, null, (Function0) objB, composer, LocalThemeScope.f17314g | (i10 & 14), 1);
                if (ComposerKt.M()) {
                    ComposerKt.T();
                }
            }
        ...
        public final void a(Composer composer, int i10) {
            ...
            K.b(null, ComposableLambdaKt.c(569722961, true, new C1930a(HowSubscriptionsWorksActivity.this), composer, 54), composer, 48, 1);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        C13737e.b(this, null, ComposableLambdaKt.composableLambdaInstance(-1386065982, true, new a()), 1, null);
    }
}
