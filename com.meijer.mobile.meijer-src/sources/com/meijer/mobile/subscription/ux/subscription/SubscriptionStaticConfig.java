...
public final /* data */ class SubscriptionStaticConfig {
    ...
    public /* synthetic */ SubscriptionStaticConfig(String str, String str2, String str3, String str4, CustomerNameRequest customerNameRequest, CustomerDeliveryAddressRequest customerDeliveryAddressRequest, PaymentInfoRequest paymentInfoRequest, PreferredTimeslotRequest c13716e, ContactInfoRequest contactInfoRequest, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        PreferredTimeslotRequest c13716e2;
        ...
        if ((i10 & 128) != 0) {
            ...
            c13716e2 = new PreferredTimeslotRequest(dayOfWeek, localTimeOf, localTimeOf2);
        } else {
            c13716e2 = c13716e;
        }
        this(str, str5, str6, str7, customerNameRequest2, customerDeliveryAddressRequest2, paymentInfoRequest2, c13716e2, (i10 & 256) != 0 ? new ContactInfoRequest("user@example.com", "123-456-7890") : contactInfoRequest);
    }
}
