...
public abstract class Hilt_ProfileScreenActivity extends ComponentActivity implements InterfaceC17928c {

    /* renamed from: r, reason: collision with root package name */
    private tu.h f95547r;

    /* renamed from: s, reason: collision with root package name */
    private volatile C17287a f95548s;

    /* renamed from: t, reason: collision with root package name */
    private final Object f95549t = new Object();

    /* renamed from: u, reason: collision with root package name */
    private boolean f95550u = false;
    ...
    public final C17287a componentManager() {
        if (this.f95548s == null) {
            synchronized (this.f95549t) {
                try {
                    if (this.f95548s == null) {
                        this.f95548s = createComponentManager();
                    }
                } finally {
                }
            }
    ...
    protected void inject() {
        ...
        this.f95550u = true;
        ((j) generatedComponent()).I0((ProfileScreenActivity) wu.f.a(this));
    }
    ...
    private void initSavedStateHandleHolder() {
        if (getApplication() instanceof InterfaceC17927b) {
            ...
            this.f95547r = hVarB;
            if (hVarB.b()) {
                this.f95547r.c(getDefaultViewModelCreationExtras());
            }
        }
    }
