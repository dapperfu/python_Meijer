...
public final class PreferenceScreenActivity extends Hilt_PreferenceScreenActivity {
    ...
    static final class a implements Function2<Composer, Integer, Unit> {
        ...
        static final class C1345a implements Function3<LocalThemeScope, Composer, Integer, Unit> {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ PreferenceScreenActivity f95439a;
            ...
            C1345a(PreferenceScreenActivity preferenceScreenActivity) {
                this.f95439a = preferenceScreenActivity;
            }
            ...
            static final class C1346a extends SuspendLambda implements Function2<g.a, Continuation<? super Unit>, Object> {

                /* renamed from: a, reason: collision with root package name */
                int f95440a;

                /* renamed from: b, reason: collision with root package name */
                /* synthetic */ Object f95441b;

                /* renamed from: c, reason: collision with root package name */
                final /* synthetic */ PreferenceScreenActivity f95442c;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C1346a(PreferenceScreenActivity preferenceScreenActivity, Continuation<? super C1346a> continuation) {
                    super(2, continuation);
                    this.f95442c = preferenceScreenActivity;
                }

                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    C1346a c1346a = new C1346a(this.f95442c, continuation);
                    c1346a.f95441b = obj;
                    return c1346a;
                }
                ...
                public final Object invoke(g.a aVar, Continuation<? super Unit> continuation) {
                    return ((C1346a) create(aVar, continuation)).invokeSuspend(Unit.f143329a);
                }
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (this.f95440a == 0) {
                        ResultKt.b(obj);
                        this.f95442c.r1((g.a) this.f95441b);
                        return Unit.f143329a;
                    }
            ...
            public final void a(LocalThemeScope AdsTheme, Composer composer, int i10) {
                ...
                z1 z1VarB = o1.b(this.f95439a.q1().y(), null, composer, 0, 1);
                composer.startReplaceGroup(1849434622);
                PreferenceScreenActivity preferenceScreenActivity = this.f95439a;
                Object objB = composer.B();
                Composer.Companion companion = Composer.INSTANCE;
                if (objB == companion.a()) {
                    objB = C16563h.O(preferenceScreenActivity.q1().w(), new C1346a(preferenceScreenActivity, null));
                    composer.t(objB);
                }
                composer.P();
                o1.a((InterfaceC16561f) objB, this.f95439a, null, composer, 0, 2);
                Modifier modifierF = J.f(Modifier.INSTANCE, 0.0f, 1, null);
                boolean zE = this.f95439a.getFeatureManager().e(AbstractC18503f.C18504a.f172866h);
                g.PreferenceScreenViewState preferenceScreenViewStateB = b(z1VarB);
                PreferenceScreenActivity preferenceScreenActivity2 = this.f95439a;
                ...
                composer.P();
                n.b(AdsTheme, preferenceScreenViewStateB, zE, modifierF, (Function1) kFunction, (Function1) ((KFunction) objB3), composer, (i11 & 14) | LocalThemeScope.f17314g | 3072, 0);
                if (ComposerKt.M()) {
                    ComposerKt.T();
                }
            }
        ...
        public final void a(Composer composer, int i10) {
            ...
            K.b(null, ComposableLambdaKt.c(-1284448055, true, new C1345a(PreferenceScreenActivity.this), composer, 54), composer, 48, 1);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final class b extends Lambda implements Function0<f0.c> {
        ...
        final /* synthetic */ ComponentActivity f95443f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public b(ComponentActivity componentActivity) {
            super(0);
            this.f95443f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final f0.c invoke() {
            return this.f95443f.getDefaultViewModelProviderFactory();
        }
    }
    ...
    public static final class c extends Lambda implements Function0<g0> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f95444f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public c(ComponentActivity componentActivity) {
            super(0);
            this.f95444f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final g0 invoke() {
            return this.f95444f.getCom.google.android.libraries.places.api.model.PlaceTypes.STORE java.lang.String();
        }
    }
    ...
    public static final class d extends Lambda implements Function0<CreationExtras> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function0 f95445f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f95446g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(Function0 function0, ComponentActivity componentActivity) {
            super(0);
            this.f95445f = function0;
            this.f95446g = componentActivity;
        }
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f95445f;
            return (function0 == null || (creationExtras = (CreationExtras) function0.invoke()) == null) ? this.f95446g.getDefaultViewModelCreationExtras() : creationExtras;
        }
    }
    ...
    public final void r1(g.a event) {
        if (!(event instanceof g.a.C1348a)) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        C13737e.b(this, null, ComposableLambdaKt.composableLambdaInstance(630691256, true, new a()), 1, null);
    }
