...
public class DataBinderMapperImpl extends e {
    ...
    private static final SparseIntArray f120081a;

    @Override // androidx.databinding.e
    public p c(f fVar, View[] viewArr, int i10) {
        int i11;
        if (viewArr != null && viewArr.length != 0 && (i11 = f120081a.get(i10)) > 0) {
            ...
            if (i11 == 1) {
                if ("layout/merge_widget_progress_view_0".equals(tag)) {
                    return new C15765b(fVar, viewArr);
                }
    ...
    static {
        ...
        f120081a = sparseIntArray;
        sparseIntArray.put(C15607c.f150176a, 1);
    }
    ...
    public p b(f fVar, View view, int i10) {
        ...
        if ("layout/merge_widget_progress_view_0".equals(tag)) {
            return new C15765b(fVar, new View[]{view});
        }
        throw new IllegalArgumentException("The tag for merge_widget_progress_view is invalid. Received: " + tag);
    }
}
