...
public final /* data */ class GetMMAConfigResponse {
    ...
    public final C17897b k() {
        ...
        String str2 = this.updateAppMessageTitle;
        return new C17897b(z10, str, str2 != null ? str2 : "", this.currentAppVersion, this.forceAppVersionAndroid, this.enableRatingsPrompt, this.percentChanceOfLoggingRatingsPromptEvent, g());
    }
