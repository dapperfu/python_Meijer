...
public final class EnhancedTextInputLayoutView extends LinearLayout {
    ...
    public final void setError(AbstractC6392a formattedString) {
    ...
    public /* synthetic */ EnhancedTextInputLayoutView(Context context, AttributeSet attributeSet, int i10, int i11, int i12, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i12 & 2) != 0 ? null : attributeSet, (i12 & 4) != 0 ? f.f4651e : i10, (i12 & 8) != 0 ? p.f5114m : i11);
    }
    ...
    public final void b(int endIconMode, ColorStateList tint, Drawable drawable, CharSequence contentDescription, final Function1<? super View, Unit> action) {
        ...
        if (textInputLayout6 != null) {
            textInputLayout6.setEndIconOnClickListener(action != null ? new View.OnClickListener() { // from class: Uj.a
    ...
    public final void setError(CharSequence errorText) {
        ...
        } else if (StringsKt.s0(errorText)) {
            TextInputLayout textInputLayout3 = this.textInputLayout;
            if (textInputLayout3 != null) {
        ...
        TextInputLayout textInputLayout4 = this.textInputLayout;
        if (textInputLayout4 == null || (textView = (TextView) textInputLayout4.findViewById(ce.f.f61689T)) == null) {
            return;
        }
    ...
    public EnhancedTextInputLayoutView(Context context, AttributeSet attributeSet, int i10, int i11) {
        ...
        Intrinsics.j(context, "context");
        this.secondaryText = "";
        c.d(this, m.f4994s, true);
        setOrientation(1);
        this.textInputLayout = (TextInputLayout) findViewById(k.f4864G);
        this.hintText = (TextView) findViewById(k.f4886R);
        this.informationText = (TextView) findViewById(k.f4905a0);
        this.errorTextView = (TextView) findViewById(k.f4872K);
        this.successTextView = (TextView) findViewById(k.f4887R0);
        int[] EnhancedTextInputLayoutView = q.f5161l;
        ...
        TextView textView = this.hintText;
        if (textView != null) {
            textView.setText(typedArrayObtainStyledAttributes.getString(q.f5162m));
        }
        TextView textView2 = this.informationText;
        if (textView2 != null) {
            textView2.setText(typedArrayObtainStyledAttributes.getString(q.f5164o));
        }
        this.placeholderText = typedArrayObtainStyledAttributes.getText(q.f5165p);
        TextInputLayout textInputLayout = this.textInputLayout;
        if (textInputLayout != null) {
            textInputLayout.setEndIconMode(typedArrayObtainStyledAttributes.getInt(q.f5163n, 0));
        }
