...
public final class ProgressIndicatorView extends View {
    ...
    public ProgressIndicatorView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, f.f4655i);
    ...
    private final void a() {
        ...
        paint.setTypeface(C6327h.h(getContext(), this.textFont));
    ...
    private final void b(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        int[] ProgressIndicatorView = q.f5133L;
        ...
        this.circleDiameter = typedArrayObtainStyledAttributes.getDimensionPixelSize(q.f5136O, 0);
        this.borderCircleRadius = typedArrayObtainStyledAttributes.getDimensionPixelSize(q.f5135N, 0);
        this.circleStroke = typedArrayObtainStyledAttributes.getDimensionPixelSize(q.f5137P, 0);
        this.barThickness = typedArrayObtainStyledAttributes.getDimensionPixelSize(q.f5134M, 0);
        this.distanceBetweenIndicatorAndLabel = typedArrayObtainStyledAttributes.getDimensionPixelSize(q.f5142U, 0);
        this.textSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(q.f5138Q, 0);
        this.completeCircleColor = typedArrayObtainStyledAttributes.getResourceId(q.f5140S, R.color.white);
        this.inCompleteCircleColor = typedArrayObtainStyledAttributes.getResourceId(q.f5143V, R.color.white);
        this.borderLessCircleColor = typedArrayObtainStyledAttributes.getResourceId(q.f5139R, R.color.white);
        this.labelTextColor = typedArrayObtainStyledAttributes.getResourceId(q.f5145X, R.color.white);
        this.textFont = typedArrayObtainStyledAttributes.getResourceId(q.f5146Y, j.f4849b);
        this.completeIcon = __fsTypeCheck_7aed730c0cb897b271b15a3fca45c160(typedArrayObtainStyledAttributes, q.f5141T);
        this.inProgressIcon = __fsTypeCheck_7aed730c0cb897b271b15a3fca45c160(typedArrayObtainStyledAttributes, q.f5144W);
        typedArrayObtainStyledAttributes.recycle();
    }

    private final void c() {
        d.e(this, AbstractC6392a.INSTANCE.d(o.f5075m0, Integer.valueOf(this.currentStep + 1), Integer.valueOf(this.labels.size()), this.labels.get(this.currentStep)));
    }
    ...
    public ProgressIndicatorView(Context context, AttributeSet attributeSet, int i10) {
        this(context, attributeSet, i10, p.f5117p);
        Intrinsics.j(context, "context");
    }
