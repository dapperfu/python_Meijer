            ...
            switch (reader.z(this.options)) {
                ...
                case 0:
                    ...
                    if (boolFromJson == null) {
                        throw C14410c.w("forceUserAccountsToUpdate", "forceUserAccountsToUpdate", reader);
                    }
                    i10 &= -2;
                    break;
                case 1:
                ...
                case 3:
                    ...
                    if (boolFromJson2 == null) {
                        throw C14410c.w("enableRatingsPrompt", "enableRatingsPrompt", reader);
                    }
                    i10 &= -9;
                    break;
                case 4:
                    ...
                    if (numFromJson == null) {
                        throw C14410c.w("percentChanceOfLoggingRatingsPromptEvent", "percentChanceOfLoggingRatingsPromptEvent", reader);
                    }
                    i10 &= -17;
                    break;
                case 5:
                    ...
                    if (ratingsPromptCriteriaFromJson == null) {
                        throw C14410c.w("ratingsPromptCriteria", "ratingsPromptCriteria", reader);
                    }
                    i10 &= -33;
                    break;
                case 6:
                    ...
                    if (mMAConfigVersionInfoFromJson == null) {
                        throw C14410c.w("currentAppVersion", "currentAppVersionAndroid", reader);
                    }
                    i10 &= -65;
                    break;
                case 7:
                    ...
                    if (mMAConfigVersionInfoFromJson2 == null) {
                        throw C14410c.w("forceAppVersionAndroid", "forceAppVersionAndroid", reader);
                    }
                    i10 &= -129;
                    break;
                case 8:
