...
public final class FullWordEllipsisTextView extends AppCompatTextView {
    ...
    private static final CharSequence f96829t = "…";

    /* renamed from: u, reason: collision with root package name */
    private static final Pattern f96830u;
    ...
    private final class b extends g {
        ...
        protected CharSequence b(CharSequence fullText) {
            ...
            if (length2 < FullWordEllipsisTextView.f96829t.length()) {
                length2 = FullWordEllipsisTextView.f96829t.length();
            }
            ...
            while (true) {
                if (e(strG + ((Object) FullWordEllipsisTextView.f96829t)) || (iW0 = StringsKt.w0(string2, ' ', 0, false, 6, null)) == -1) {
                    break;
                }
                String strSubstring2 = string2.substring(0, iW0);
                Intrinsics.i(strSubstring2, "substring(...)");
                string2 = StringsKt.C1(strSubstring2).toString();
                strG = g(string2);
            }
            String str = strG + ((Object) FullWordEllipsisTextView.f96829t);
    ...
    private final class d extends g {
        ...
        protected CharSequence b(CharSequence fullText) {
            ...
            Intrinsics.i(strSubstring2, "substring(...)");
            String string2 = StringsKt.C1(strSubstring2).toString();
            String string3 = string;
            while (true) {
                if (e(string3 + ((Object) FullWordEllipsisTextView.f96829t) + string2)) {
                    str = string3;
                    break;
                }
                int iW0 = StringsKt.w0(string3, ' ', 0, false, 6, null);
                str = string3;
                int iP0 = StringsKt.p0(string2, ' ', 0, false, 6, null);
                if (iW0 == -1 || iP0 == -1) {
                    break;
                }
                String strSubstring3 = str.substring(0, iW0);
                Intrinsics.i(strSubstring3, "substring(...)");
                string3 = StringsKt.C1(strSubstring3).toString();
                String strSubstring4 = string2.substring(iP0);
                Intrinsics.i(strSubstring4, "substring(...)");
                string2 = StringsKt.C1(strSubstring4).toString();
            }
            ...
            return TextUtils.concat(spannableStringBuilder, FullWordEllipsisTextView.f96829t, spannableStringBuilder3);
        }
    }
    ...
    private final class f extends g {
        ...
        protected CharSequence b(CharSequence fullText) {
            ...
            String string = StringsKt.C1(strSubstring).toString();
            while (true) {
                if (e(((Object) FullWordEllipsisTextView.f96829t) + string) || (iP0 = StringsKt.p0(string, ' ', 0, false, 6, null)) == -1) {
                    break;
                }
                String strSubstring2 = string.substring(iP0);
                Intrinsics.i(strSubstring2, "substring(...)");
                string = StringsKt.C1(strSubstring2).toString();
            }
            String str = ((Object) FullWordEllipsisTextView.f96829t) + string;
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(str);
            if (fullText instanceof Spanned) {
    ...
    public FullWordEllipsisTextView(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.endPunctuationPattern = f96830u;
    }
