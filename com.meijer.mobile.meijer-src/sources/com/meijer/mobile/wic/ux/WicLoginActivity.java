...
public final class WicLoginActivity extends Hilt_WicLoginActivity {
    ...
    static final class a implements Function2<Composer, Integer, Unit> {
        ...
        static final class C1966a implements Function3<LocalThemeScope, Composer, Integer, Unit> {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ WicLoginActivity f120365a;

            @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
            /* renamed from: com.meijer.mobile.wic.ux.WicLoginActivity$a$a$a, reason: collision with other inner class name */
            /* synthetic */ class C1967a extends FunctionReferenceImpl implements Function1<y, Unit> {
                C1967a(Object obj) {
            ...
            C1966a(WicLoginActivity wicLoginActivity) {
                this.f120365a = wicLoginActivity;
            }
            ...
            public final void a(LocalThemeScope AdsTheme, Composer composer, int i10) {
                ...
                WicLoginActivity wicLoginActivity = this.f120365a;
                composer.startReplaceGroup(5004770);
                boolean zD = composer.D(wicLoginActivity);
                Object objB = composer.B();
                if (zD || objB == Composer.INSTANCE.a()) {
                    objB = new C1967a(wicLoginActivity);
                    composer.t(objB);
                }
                composer.P();
                m.t(AdsTheme, modifierFsUnmask, (Function1) ((KFunction) objB), composer, LocalThemeScope.f17314g | (i10 & 14), 0);
                if (ComposerKt.M()) {
                    ComposerKt.T();
                }
            }
        ...
        public final void a(Composer composer, int i10) {
            ...
            K.b(null, ComposableLambdaKt.c(529513984, true, new C1966a(WicLoginActivity.this), composer, 54), composer, 48, 1);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public final void o1(y wicNavigationRequest) {
        if (!Intrinsics.e(wicNavigationRequest, y.a.f120436a)) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        C13737e.b(this, null, ComposableLambdaKt.composableLambdaInstance(387986225, true, new a()), 1, null);
    }
}
