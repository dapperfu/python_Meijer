...
@Metadata(d1 = {"\u0000H\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\n\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J+\u0010\u000b\u001a\u00020\n*\u00020\u00042\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00060\u00052\b\b\u0002\u0010\t\u001a\u00020\bH\u0003¢\u0006\u0004\b\u000b\u0010\fJ\u0017\u0010\u000f\u001a\u00020\n2\u0006\u0010\u000e\u001a\u00020\rH\u0002¢\u0006\u0004\b\u000f\u0010\u0010J!\u0010\u0014\u001a\u00020\n2\u0006\u0010\u0011\u001a\u00020\u00062\b\u0010\u0013\u001a\u0004\u0018\u00010\u0012H\u0002¢\u0006\u0004\b\u0014\u0010\u0015J\u001d\u0010\u0016\u001a\u00020\n*\u00020\u00042\b\b\u0002\u0010\t\u001a\u00020\bH\u0003¢\u0006\u0004\b\u0016\u0010\u0017J\u0017\u0010\u001a\u001a\u00020\n2\u0006\u0010\u0019\u001a\u00020\u0018H\u0002¢\u0006\u0004\b\u001a\u0010\u001bJ\u0019\u0010\u001e\u001a\u00020\n2\b\u0010\u001d\u001a\u0004\u0018\u00010\u001cH\u0014¢\u0006\u0004\b\u001e\u0010\u001fR$\u0010\u0013\u001a\u0004\u0018\u00010\u00128\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b \u0010!\u001a\u0004\b\"\u0010#\"\u0004\b$\u0010%¨\u0006&"}, d2 = {"Lcom/meijer/mobile/mperks/ux/rewards/ViewAllRewardsActivity;", "Lcom/meijer/mobile/mperks/ux/MperksFeatureActivity;", "<init>", "()V", "LKi/M;", "", "Lco/e;", "rewards", "Landroidx/compose/ui/Modifier;", "modifier", "", "B1", "(LKi/M;Ljava/util/List;Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;II)V", "Lco/h;", "navigationRequest", "J1", "(Lco/h;)V", "reward", "", "mperksPoints", "L1", "(Lco/e;Ljava/lang/String;)V", "E1", "(LKi/M;Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;II)V", "Lco/k;", "rewardDetail", "K1", "(Lco/k;)V", "Landroid/os/Bundle;", "savedInstanceState", "onCreate", "(Landroid/os/Bundle;)V", "C", "Ljava/lang/String;", "getMperksPoints", "()Ljava/lang/String;", "setMperksPoints", "(Ljava/lang/String;)V", "ux_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public final class ViewAllRewardsActivity extends MperksFeatureActivity {
    ...
    public static final class b extends Lambda implements Function1 {
        ...
        public static final b f115570f = new b();
    ...
    public static final class c extends Lambda implements Function1<Integer, Object> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function1 f115571f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ List f115572g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public c(Function1 function1, List list) {
            super(1);
            this.f115571f = function1;
            this.f115572g = list;
        }

        public final Object a(int i10) {
            return this.f115571f.invoke(this.f115572g.get(i10));
        }
    ...
    public static final class d extends Lambda implements Function4<InterfaceC15433c, Integer, Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ List f115573f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f115574g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ ViewAllRewardsActivity f115575h;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(List list, LocalThemeScope localThemeScope, ViewAllRewardsActivity viewAllRewardsActivity) {
            super(4);
            this.f115573f = list;
            this.f115574g = localThemeScope;
            this.f115575h = viewAllRewardsActivity;
        }
        ...
        public final void a(InterfaceC15433c interfaceC15433c, int i10, Composer composer, int i11) {
            ...
            ClippedReward clippedReward = (ClippedReward) this.f115573f.get(i10);
            composer.startReplaceGroup(-102480332);
            LocalThemeScope localThemeScope = this.f115574g;
            Modifier modifierH = J.h(J.D(Modifier.INSTANCE, null, false, 3, null), 0.0f, 1, null);
            composer.startReplaceGroup(5004770);
            boolean zD = composer.D(this.f115575h);
            Object objB = composer.B();
            if (zD || objB == Composer.INSTANCE.a()) {
                objB = new a(this.f115575h);
                composer.t(objB);
            }
            composer.P();
            C16728c.c(localThemeScope, clippedReward, modifierH, false, (Function1) ((KFunction) objB), composer, LocalThemeScope.f17314g | 384, 4);
            composer.P();
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
    ...
    static final class e implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ LocalThemeScope f115576a;

        e(LocalThemeScope localThemeScope) {
            this.f115576a = localThemeScope;
        }
        ...
        public final void a(Composer composer, int i10) {
            ...
            LocalThemeScope localThemeScope = this.f115576a;
            j.h(localThemeScope, new q1.Label(null, this.f115576a.getAdsColors().getAdsColorInverse(), null, null, 0, false, 0, localThemeScope.getAdsTypography().getHeadings().getSix(), null, 381, null), C16338g.c(j0.f115076H1, composer, 0), null, composer, LocalThemeScope.f17314g | (q1.Label.f142335j << 3), 4);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class f implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f115577a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ ViewAllRewardsActivity f115578b;

        f(LocalThemeScope localThemeScope, ViewAllRewardsActivity viewAllRewardsActivity) {
            this.f115577a = localThemeScope;
            this.f115578b = viewAllRewardsActivity;
        }
        ...
        public final void b(Composer composer, int i10) {
            ...
            LocalThemeScope localThemeScope = this.f115577a;
            C.f.d dVar = C.f.d.f17051e;
            T adsColorInverse = localThemeScope.getAdsColors().getAdsColorInverse();
            Modifier.Companion companion = Modifier.INSTANCE;
            composer.startReplaceGroup(5004770);
            boolean zD = composer.D(this.f115578b);
            final ViewAllRewardsActivity viewAllRewardsActivity = this.f115578b;
            Object objB = composer.B();
            if (zD || objB == Composer.INSTANCE.a()) {
            ...
            composer.P();
            C16671b.b(localThemeScope, new q1.h.DrawableIcon(dVar, C16338g.c(j0.f115214w, composer, 0), null, null, 0.0f, adsColorInverse, D.m(ClickableKt.d(companion, false, null, null, (Function0) objB, 7, null), h.p(8), 0.0f, 0.0f, 0.0f, 14, null), 28, null), null, null, composer, LocalThemeScope.f17314g | (q1.h.DrawableIcon.f142322h << 3), 6);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class g implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ List<ClippedReward> f115580b;

        @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
        static final class a implements Function3<LocalThemeScope, Composer, Integer, Unit> {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ ViewAllRewardsActivity f115581a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ List<ClippedReward> f115582b;
            ...
            static final class C1825a implements Function2<Composer, Integer, Unit> {

                /* renamed from: a, reason: collision with root package name */
                final /* synthetic */ ViewAllRewardsActivity f115583a;

                /* renamed from: b, reason: collision with root package name */
                final /* synthetic */ LocalThemeScope f115584b;

                C1825a(ViewAllRewardsActivity viewAllRewardsActivity, LocalThemeScope localThemeScope) {
                    this.f115583a = viewAllRewardsActivity;
                    this.f115584b = localThemeScope;
                }
                ...
                public final void a(Composer composer, int i10) {
                    ...
                    this.f115583a.E1(this.f115584b, null, composer, LocalThemeScope.f17314g, 1);
                    if (ComposerKt.M()) {
                        ComposerKt.T();
                    }
                }
            ...
            static final class b implements Function3<InterfaceC14882C, Composer, Integer, Unit> {
                ...
                /* renamed from: a, reason: collision with root package name */
                final /* synthetic */ List<ClippedReward> f115585a;

                /* renamed from: b, reason: collision with root package name */
                final /* synthetic */ ViewAllRewardsActivity f115586b;

                /* renamed from: c, reason: collision with root package name */
                final /* synthetic */ LocalThemeScope f115587c;

                b(List<ClippedReward> list, ViewAllRewardsActivity viewAllRewardsActivity, LocalThemeScope localThemeScope) {
                    this.f115585a = list;
                    this.f115586b = viewAllRewardsActivity;
                    this.f115587c = localThemeScope;
                }
                ...
                public final void a(InterfaceC14882C paddingValues, Composer composer, int i10) {
                    ...
                    if (!this.f115585a.isEmpty()) {
                        this.f115586b.B1(this.f115587c, this.f115585a, D.h(J.f(Modifier.INSTANCE, 0.0f, 1, null), paddingValues), composer, LocalThemeScope.f17314g, 0);
                    }
                    if (ComposerKt.M()) {
                        ComposerKt.T();
                    }
            ...
            a(ViewAllRewardsActivity viewAllRewardsActivity, List<ClippedReward> list) {
                this.f115581a = viewAllRewardsActivity;
                this.f115582b = list;
            }
            ...
            public final void a(LocalThemeScope AdsTheme, Composer composer, int i10) {
                ...
                C17987a1.a(FullStoryAnnotationsKt.fsUnmask(Modifier.INSTANCE), null, ComposableLambdaKt.c(912973128, true, new C1825a(this.f115581a, AdsTheme), composer, 54), null, null, null, 0, false, null, false, null, 0.0f, 0L, 0L, 0L, 0L, 0L, ComposableLambdaKt.c(-974547345, true, new b(this.f115582b, this.f115581a, AdsTheme), composer, 54), composer, 384, 12582912, 131066);
                if (ComposerKt.M()) {
                    ComposerKt.T();
                }
            }
        ...
        public final void a(Composer composer, int i10) {
            ...
            K.b(null, ComposableLambdaKt.c(-1002689683, true, new a(ViewAllRewardsActivity.this, this.f115580b), composer, 54), composer, 48, 1);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    */
    public final void B1(final Ki.LocalThemeScope r20, final java.util.List<co.ClippedReward> r21, androidx.compose.ui.Modifier r22, androidx.compose.runtime.Composer r23, final int r24, final int r25) {
        /*
            Method dump skipped, instructions count: 301
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meijer.mobile.mperks.ux.rewards.ViewAllRewardsActivity.B1(Ki.M, java.util.List, androidx.compose.ui.Modifier, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final Unit C1(List list, LocalThemeScope localThemeScope, ViewAllRewardsActivity viewAllRewardsActivity, w LazyColumn) {
        ...
        LazyColumn.i(list.size(), null, new c(b.f115570f, list), ComposableLambdaKt.composableLambdaInstance(-632812321, true, new d(list, localThemeScope, viewAllRewardsActivity)));
        return Unit.f143329a;
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void E1(final Ki.LocalThemeScope r18, androidx.compose.ui.Modifier r19, androidx.compose.runtime.Composer r20, final int r21, final int r22) {
        /*
            r17 = this;
            r1 = r17
            r2 = r18
        ...
        Ld4:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meijer.mobile.mperks.ux.rewards.ViewAllRewardsActivity.E1(Ki.M, androidx.compose.ui.Modifier, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void J1(AbstractC6536h navigationRequest) {
        if (navigationRequest instanceof AbstractC6536h.OnClippedRewardCardClicked) {
            AbstractC6536h.OnClippedRewardCardClicked onClippedRewardCardClicked = (AbstractC6536h.OnClippedRewardCardClicked) navigationRequest;
    ...
    private final void K1(RewardDetail rewardDetail) {
        startActivity(f0.f114968a.e(this, rewardDetail, "MPERKS_REWARDS_TAB", false));
    }
    ...
    public static final Unit M1(ClippedReward clippedReward, String str, TrackingData track) {
        ...
        if (endDate != null) {
            track.h("rewardValidThroughDate", endDate.format(C17898a.DATE_FORMAT_MM_DD_YYYY).toString());
        }
    ...
    private final void L1(final ClippedReward reward, final String mperksPoints) {
        o1().b(C14756c.h("mPerks:Reward Details Page"), new Function1() { // from class: qo.Q
            @Override // kotlin.jvm.functions.Function1
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (zContainsKey) {
            ...
            if (parcelableArrayListExtra2 != null) {
                ...
                while (it.hasNext()) {
                    listM.add(no.e.a((HomeMperksClippedReward) it.next()));
                }
            } else {
                listM = null;
            }
        ...
        C13737e.b(this, null, ComposableLambdaKt.composableLambdaInstance(1027895068, true, new g(listM)), 1, null);
    }
}
