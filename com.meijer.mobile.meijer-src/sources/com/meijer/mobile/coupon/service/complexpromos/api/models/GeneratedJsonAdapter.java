        ...
        while (reader.hasNext()) {
            switch (reader.z(this.options)) {
                ...
                case 0:
                    ...
                    if (lFromJson == null) {
                        throw C14410c.w("promoId", "promoId", reader);
                    }
                    i10 &= -2;
                    break;
                case 1:
                ...
                case 2:
                    ...
                    if (numFromJson == null) {
                        throw C14410c.w("promoBuyMinQty", "promoBuyMinQty", reader);
                    }
                    i10 &= -5;
                    break;
                case 3:
                    ...
                    if (dFromJson == null) {
                        throw C14410c.w("promoValue", "promoValue", reader);
                    }
                    i10 &= -9;
                    break;
                case 4:
                    ...
                    if (dFromJson2 == null) {
                        throw C14410c.w("promoBuyMinSpend", "promoBuyMinSpend", reader);
                    }
                    i10 &= -17;
                    break;
                case 5:
                    ...
                    if (listFromJson == null) {
                        throw C14410c.w("buyProducts", "buyProducts", reader);
                    }
                    i10 &= -33;
                    break;
                case 6:
                    ...
                    if (listFromJson2 == null) {
                        throw C14410c.w("getProducts", "getProducts", reader);
                    }
                    i10 &= -65;
                    break;
            }
