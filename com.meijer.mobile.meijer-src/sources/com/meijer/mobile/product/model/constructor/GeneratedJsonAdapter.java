    ...
    public SponsoredProductsResponseInner fromJson(k reader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, SecurityException, IllegalArgumentException, InvocationTargetException {
            ...
            switch (reader.z(this.options)) {
                ...
                case 0:
                    ...
                    if (listFromJson == null) {
                        throw C14410c.w("facets", "facets", reader);
                    }
                    i10 &= -2;
                    break;
                case 1:
                    ...
                    if (listFromJson2 == null) {
                        throw C14410c.w("groups", "groups", reader);
                    }
                    i10 &= -3;
                    break;
                case 2:
                    ...
                    if (listFromJson3 == null) {
                        throw C14410c.w("results", "results", reader);
                    }
                    i10 &= -5;
                    break;
                case 3:
        ...
        if (i10 != -64) {
            ...
            if (declaredConstructor == null) {
                declaredConstructor = SponsoredProductsResponseInner.class.getDeclaredConstructor(List.class, List.class, List.class, String.class, String.class, String.class, Integer.TYPE, C14410c.f134472c);
