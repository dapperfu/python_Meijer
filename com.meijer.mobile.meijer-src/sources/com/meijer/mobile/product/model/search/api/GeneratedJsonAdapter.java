    ...
    public ResultSources fromJson(k reader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        while (reader.hasNext()) {
            ...
            if (iZ == -1) {
                ...
                if (numFromJson == null) {
                    throw C14410c.w("totalCount", "totalCount", reader);
                }
                i10 = -5;
            } else {
                continue;
        ...
        if (declaredConstructor == null) {
            ...
            declaredConstructor = ResultSources.class.getDeclaredConstructor(ResultSourcesData.class, ResultSourcesData.class, cls, cls, C14410c.f134472c);
