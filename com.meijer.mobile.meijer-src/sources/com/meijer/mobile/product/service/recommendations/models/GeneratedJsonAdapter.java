        ...
        while (reader.hasNext()) {
            switch (reader.z(this.options)) {
                ...
                case 0:
                    ...
                    if (numFromJson == null) {
                        throw C14410c.w("resultCode", "resultCode", reader);
                    }
                    i10 &= -2;
                    break;
                case 1:
                    ...
                    if (strFromJson == null) {
                        throw C14410c.w("resultDescription", "resultDescription", reader);
                    }
                    i10 &= -3;
                    break;
                case 2:
                    ...
                    if (numFromJson2 == null) {
                        throw C14410c.w("totalProducts", "totalProducts", reader);
                    }
                    i10 &= -5;
                    break;
                case 3:
