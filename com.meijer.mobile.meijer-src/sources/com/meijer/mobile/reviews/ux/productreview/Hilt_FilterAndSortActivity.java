...
public abstract class Hilt_FilterAndSortActivity extends AppCompatActivity implements InterfaceC17928c {

    /* renamed from: r, reason: collision with root package name */
    private tu.h f116418r;

    /* renamed from: s, reason: collision with root package name */
    private volatile C17287a f116419s;

    /* renamed from: t, reason: collision with root package name */
    private final Object f116420t = new Object();

    /* renamed from: u, reason: collision with root package name */
    private boolean f116421u = false;
    ...
    public final C17287a componentManager() {
        if (this.f116419s == null) {
            synchronized (this.f116420t) {
                try {
                    if (this.f116419s == null) {
                        this.f116419s = createComponentManager();
                    }
                } finally {
                }
            }
        }
        return this.f116419s;
    }
    ...
    protected void inject() {
        ...
        this.f116421u = true;
        ((InterfaceC12860n) generatedComponent()).W0((FilterAndSortActivity) wu.f.a(this));
    }
    ...
    private void initSavedStateHandleHolder() {
        if (getApplication() instanceof InterfaceC17927b) {
            ...
            this.f116418r = hVarB;
            if (hVarB.b()) {
                this.f116418r.c(getDefaultViewModelCreationExtras());
            }
        }
    }
