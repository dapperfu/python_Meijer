...
public final class FilterAndSortActivity extends Hilt_FilterAndSortActivity {
    ...
    public static final int f116370x = 8;
    ...
    static final class b implements Function2<Composer, Integer, Unit> {
        ...
        static final class a implements Function3<LocalThemeScope, Composer, Integer, Unit> {
            ...
            final /* synthetic */ FilterAndSortActivity f116373a;

            a(FilterAndSortActivity filterAndSortActivity) {
                this.f116373a = filterAndSortActivity;
            }
            ...
            public final void b(LocalThemeScope AdsTheme, Composer composer, int i10) {
                ...
                final T.FilterAndSortState filterAndSortState = (T.FilterAndSortState) androidx.compose.runtime.o1.b(this.f116373a.r1().o(), null, composer, 0, 1).getValue();
                T tR1 = this.f116373a.r1();
                composer.startReplaceGroup(-1633490746);
                boolean zD = composer.D(filterAndSortState) | composer.D(this.f116373a);
                final FilterAndSortActivity filterAndSortActivity = this.f116373a;
                ...
                composer.P();
                C12846g.d(AdsTheme, c14680uE, tR1, filterAndSortState, (Function0) objB, composer, LocalThemeScope.f17314g | (i10 & 14));
                if (ComposerKt.M()) {
                    ComposerKt.T();
                }
            }
        ...
        public final void a(Composer composer, int i10) {
            ...
            Ki.K.b(null, ComposableLambdaKt.c(904129085, true, new a(FilterAndSortActivity.this), composer, 54), composer, 48, 1);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final class c extends Lambda implements Function0<f0.c> {
        ...
        final /* synthetic */ ComponentActivity f116374f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public c(ComponentActivity componentActivity) {
            super(0);
            this.f116374f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final f0.c invoke() {
            return this.f116374f.getDefaultViewModelProviderFactory();
        }
    }
    ...
    public static final class d extends Lambda implements Function0<androidx.view.g0> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f116375f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(ComponentActivity componentActivity) {
            super(0);
            this.f116375f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final androidx.view.g0 invoke() {
            return this.f116375f.getCom.google.android.libraries.places.api.model.PlaceTypes.STORE java.lang.String();
        }
    }
    ...
    public static final class e extends Lambda implements Function0<CreationExtras> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function0 f116376f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f116377g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public e(Function0 function0, ComponentActivity componentActivity) {
            super(0);
            this.f116376f = function0;
            this.f116377g = componentActivity;
        }
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f116376f;
            return (function0 == null || (creationExtras = (CreationExtras) function0.invoke()) == null) ? this.f116377g.getDefaultViewModelCreationExtras() : creationExtras;
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tR1.p(new AbstractC12834a.SetFilterAndSort(setO1, bVar));
        getLifecycle().a(r1());
        C13737e.b(this, null, ComposableLambdaKt.composableLambdaInstance(-1590846482, true, new b()), 1, null);
    }
}
