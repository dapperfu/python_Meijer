...
public final /* data */ class PaymentCreditDetailInfoResponse {
    ...
    public final TransactionDetail f() {
        ...
        return new TransactionDetail(str, hA, str3 != null ? (OffsetDateTime) d.b(str3, C17898a.f167225a.s(), new r()) : null, this.amount);
    }
