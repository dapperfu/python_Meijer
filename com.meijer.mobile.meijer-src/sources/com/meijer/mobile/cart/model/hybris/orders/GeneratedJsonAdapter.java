    ...
    public HybrisOrderPrice fromJson(k reader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, SecurityException, IllegalArgumentException, InvocationTargetException {
            ...
            switch (reader.z(this.options)) {
                ...
                case 1:
                    ...
                    if (hybrisPriceFromJson2 == null) {
                        throw C14410c.w("billingTime", "billingTime", reader);
                    }
                    i10 &= -3;
                    break;
                case 2:
                ...
                case 8:
                    ...
                    if (listFromJson3 == null) {
                        throw C14410c.w("potentialProductPromotions", "potentialProductPromotions", reader);
                    }
                    i10 &= -257;
                    break;
                case 9:
                    ...
                    if (listFromJson4 == null) {
                        throw C14410c.w("potentialOrderPromotions", "potentialOrderPromotions", reader);
                    }
                    i10 &= -513;
                    break;
            }
        ...
        if (i10 != -1024) {
            ...
            if (declaredConstructor == null) {
                declaredConstructor = HybrisOrderPrice.class.getDeclaredConstructor(HybrisPrice.class, HybrisPrice.class, HybrisPrice.class, HybrisPrice.class, HybrisPrice.class, HybrisPrice.class, List.class, List.class, List.class, List.class, Integer.TYPE, C14410c.f134472c);
