...
public final class DigitalShoppingApiException extends RuntimeException implements InterfaceC17110a {

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC17110a details;
    ...
    public static final class Companion {
        ...
        public static final class C1829a implements InterfaceC17110a {
        ...
        private final Throwable b(String json, t moshi, Throwable throwable) {
            ServerError c17111bA;
            ServerErrorJson serverErrorJson = (ServerErrorJson) moshi.c(ServerErrorJson.class).fromJson(json);
            if (serverErrorJson == null || (c17111bA = C17112c.a(serverErrorJson)) == null) {
                return null;
            }
            return c17111bA.c(throwable);
        }
        ...
        public final Throwable a(Throwable throwable, t moshi) {
            ...
            if (thE != null) {
                try {
                    ...
                    objB = Result.b(new C1829a().c(throwable));
                } catch (Throwable th3) {
    ...
    public DigitalShoppingApiException(InterfaceC17110a details, Throwable th2) {
    ...
    public final InterfaceC17110a getDetails() {
        return this.details;
    }
    ...
    @Override // java.lang.Throwable, so.InterfaceC17110a
    public String getMessage() {
