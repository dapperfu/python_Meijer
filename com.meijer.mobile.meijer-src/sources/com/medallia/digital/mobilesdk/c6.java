...
class c6 extends w1<Long> {
    ...
    private final BroadcastReceiver f92574g;
    ...
    protected void l() {
        super.l();
        q4.a(i4.c().b()).a(this.f92574g, new IntentFilter("com.medallia.digital.mobilesdk.PROPERTY_ID_CHANGE"));
    }
