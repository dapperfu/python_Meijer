...
class c5 {
    ...
    private static final int f92538e = 7;

    /* renamed from: f, reason: collision with root package name */
    private static final int f92539f = 2;

    /* renamed from: g, reason: collision with root package name */
    private static final int f92540g = 3;

    /* renamed from: h, reason: collision with root package name */
    private static final String f92541h = "/media";

    /* renamed from: i, reason: collision with root package name */
    private static final String f92542i = "video/*";

    /* renamed from: j, reason: collision with root package name */
    private static final int f92543j = 1048576;

    /* renamed from: k, reason: collision with root package name */
    private static final int f92544k = 5;

    /* renamed from: l, reason: collision with root package name */
    private static c5 f92545l;

    /* renamed from: a, reason: collision with root package name */
    private MediaRecorder f92546a;

    /* renamed from: c, reason: collision with root package name */
    private ProgressDialog f92548c;

    /* renamed from: b, reason: collision with root package name */
    private g5 f92547b = null;

    /* renamed from: d, reason: collision with root package name */
    private final List<String> f92549d = new ArrayList();

    static /* synthetic */ class a {

        /* renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f92550a;

        /* renamed from: b, reason: collision with root package name */
        static final /* synthetic */ int[] f92551b;
        ...
        static {
            ...
            try {
                f92551b[z4.delete.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f92551b[z4.replace.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f92551b[z4.permission.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f92551b[z4.videoTimeLimitation.ordinal()] = 5;
            ...
            try {
                f92550a[j5.audio.ordinal()] = 2;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f92550a[j5.upload.ordinal()] = 3;
    ...
    class i extends v4 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ c.a f92563a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ j2 f92564b;
        ...
        public void a() {
            String str;
            androidx.appcompat.app.c cVarCreate = this.f92563a.create();
            try {
                Window window = cVarCreate.getWindow();
                if (window != null) {
                    j2 j2Var = this.f92564b;
    ...
    class j extends v4 {
        ...
        public void a() {
            ...
            c5.this.f92548c = new ProgressDialog(i4.c().d());
            c5.this.f92548c.setTitle(contextB.getString(R.string.progress_dialog_title));
            c5.this.f92548c.setMessage(contextB.getString(R.string.progress_dialog_body));
            c5.this.f92548c.setProgressStyle(0);
            c5.this.f92548c.setIndeterminate(false);
            c5.this.f92548c.setCancelable(false);
            c5.this.f92548c.show();
        }
    }
    ...
    protected void d() throws Exception {
        try {
            MediaRecorder mediaRecorder = this.f92546a;
            if (mediaRecorder != null) {
                mediaRecorder.stop();
                this.f92546a.release();
                this.f92546a = null;
    ...
    protected e5 a(g5 g5Var, j2 j2Var, boolean z10) {
        ...
        if (strD != null && !strD.isEmpty()) {
            int i10 = a.f92550a[j5.a(strD).ordinal()];
            if (i10 == 1) {
                int iA = Z1.b.a(activity, "android.permission.CAMERA");
                if (iA == 0 || this.f92549d.isEmpty() || !this.f92549d.contains("android.permission.CAMERA")) {
                    if (iA != 0) {
            ...
            if (i10 == 2) {
                ...
                if (iA2 == 0 || this.f92549d.isEmpty() || !this.f92549d.contains("android.permission.RECORD_AUDIO")) {
                    if (iA2 == 0) {
    ...
    protected void b(String str) {
        if (str == null || this.f92549d.contains(str)) {
            return;
        }
        this.f92549d.add(str);
    }

    protected e5 a(String str, String str2, String str3, String str4) throws IllegalStateException, IOException {
        File file = new File(g2.f(f92541h));
        String string = UUID.randomUUID().toString();
        String str5 = file + q2.f93563c + string + j5.c(str);
        if (!file.exists()) {
            file.mkdirs();
        }
        MediaRecorder mediaRecorder = new MediaRecorder();
        this.f92546a = mediaRecorder;
        mediaRecorder.setAudioSource(1);
        this.f92546a.setOutputFormat(1);
        this.f92546a.setAudioEncoder(4);
        this.f92546a.setOutputFile(str5);
        try {
            this.f92546a.prepare();
            this.f92546a.start();
    ...
    protected File a(String str, String str2) {
        File file = new File(g2.d(), f92541h);
        if (!file.exists()) {
            file.mkdir();
        }
    ...
    */
    ...
    protected void a() {
        ProgressDialog progressDialog = this.f92548c;
    ...
    protected void a(Activity activity) {
        try {
            ...
            intent.setDataAndType(MediaStore.Video.Media.EXTERNAL_CONTENT_URI, f92542i);
