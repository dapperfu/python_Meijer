...
class CollectorsConfigurationContract extends e0 {
    ...
    protected CollectorsConfigurationContract() {
        this.deviceModelCollector = s0.a.f93770b;
        this.deviceVendorCollector = s0.a.f93773e;
        this.deviceResolutionCollector = s0.a.f93771c;
        this.deviceUsedMemoryCollector = s0.a.f93772d;
        this.deviceFreeMemoryCollector = s0.a.f93769a;
        this.osNameCollector = s0.a.f93774f;
        this.osVersionCollector = s0.a.f93775g;
        this.networkProviderCollector = s0.a.f93776h;
        this.networkCarrierCollector = s0.a.f93777i;
        this.languageCollector = s0.a.f93778j;
        this.timezoneCollector = s0.a.f93779k;
        this.ipCollector = s0.a.f93780l;
        this.networkSpeedCollector = s0.a.f93781m;
        this.deviceIdCollector = s0.a.f93782n;
        this.appNameCollector = s0.a.f93783o;
        this.appIdCollector = s0.a.f93784p;
        this.appVersionCollector = s0.a.f93785q;
        this.sdkVersionCollector = s0.a.f93786r;
        this.sessionCalculatedPercentageCollector = s0.a.f93787s;
        this.sessionNumberCollector = s0.a.f93788t;
        this.networkTypeCollector = s0.a.f93790v;
        this.orientationCollector = s0.a.f93793y;
        this.lastDeclineTimestampCollector = s0.a.f93794z;
        this.lastSubmitTimestampCollector = s0.a.f93746A;
        this.invitationDisplayedCollector = s0.a.f93751F;
        this.npsCollector = s0.a.f93756K;
        this.csatCollector = s0.a.f93757L;
        this.appRatingLastDeclineTimestampCollector = s0.a.f93758M;
        this.promptDisplayedCollector = s0.a.f93759N;
        this.appRatingLastAcceptedTimestampCollector = s0.a.f93760O;
        this.appRatingLastTriggerTimestampCollector = s0.a.f93762Q;
        this.localNotificationsEnabledCollector = s0.a.f93763R;
        this.timeInBackgroundCollector = s0.a.f93752G;
        this.timeInForegroundCollector = s0.a.f93753H;
        this.timeInCurrentForegroundCollector = s0.a.f93764S;
        this.isOCQUserSetCollector = s0.a.f93765T;
        this.isOCQRulesValidCollector = s0.a.f93766U;
        this.isSessionSampledEventsCollector = s0.a.f93767V;
        this.sessionPercentageSampledEventsCollector = s0.a.f93768W;
        this.sdkFrameworkCollector = s0.a.f93761P;
        this.userIdCollector = s0.a.f93747B;
        this.userEmailCollector = s0.a.f93748C;
        this.userNameCollector = s0.a.f93749D;
        this.customParametersCollector = s0.a.f93750E;
        this.interceptEnabledCollector = s0.a.f93754I;
        this.interceptDisabledCollector = s0.a.f93755J;
    }
