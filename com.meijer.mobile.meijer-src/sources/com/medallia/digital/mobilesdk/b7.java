...
class b7 extends w1<Integer> {
    ...
    private final BroadcastReceiver f92501g;
    ...
    protected void l() {
        super.l();
        q4.a(i4.c().b()).a(this.f92501g, new IntentFilter("com.medallia.digital.mobilesdk.SESSION_STARTED"));
    }
