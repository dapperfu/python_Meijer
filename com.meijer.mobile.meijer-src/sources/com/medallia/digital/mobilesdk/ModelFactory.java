...
class ModelFactory {
    ...
    private boolean validate(C11691b c11691b) {
        h4.a aVar;
        if (c11691b.c() == null) {
            aVar = h4.a.f93003o;
        } else if (c11691b.d() == -1) {
    ...
    protected C11691b createAccessToken(String str) {
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                ...
                a4.c(h4.a.f93002n + e10.getMessage());
            }
            str = jSONObject.has("accessToken") ? jSONObject.get("accessToken").toString() : null;
            C11691b c11691b = new C11691b(str);
            c11691b.a(str);
            if (validate(c11691b)) {
                return c11691b;
            }
        }
        a4.c(h4.a.f93002n.toString());
        return null;
    }

    protected n createApiToken(String str) {
        if (TextUtils.isEmpty(str)) {
            a4.f(h4.a.f92987d.toString());
        } else {
            try {
                n nVar = new n(str);
                nVar.a(str);
                ...
                a4.c(h4.a.f92987d + e10.getMessage());
            }
        }
        return null;
    }
    ...
    protected ConfigurationContract createConfiguration(String str) {
        try {
            ...
            a4.c(h4.a.f93013y + e10.getMessage());
            return null;
        }
    }
    ...
    protected a2 createFeedback(String str) {
        try {
            ...
            a4.c(h4.a.f92965H + e10.getMessage());
            return null;
        }
    }
    ...
    protected b2 createFeedbackContract(String str) {
        try {
            ...
            a4.c(h4.a.f92969L + e10.getMessage());
            return null;
        }
    }
    ...
    protected ConfigurationUUID createUUID(String str) {
        try {
            ...
            a4.c(h4.a.f93009u + e10.getMessage());
            return null;
        }
    }
