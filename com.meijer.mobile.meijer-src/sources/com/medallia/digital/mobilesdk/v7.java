...
class v7 {
    ...
    private static v7 f94017a;

    static /* synthetic */ class a {

        /* renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f94018a;
        ...
        static {
            ...
            try {
                f94018a[MDAppearanceMode.light.ordinal()] = 2;
    ...
    protected int a(MDAppearanceMode mDAppearanceMode, MDAppearanceMode mDAppearanceMode2) {
        if (mDAppearanceMode != null && mDAppearanceMode != MDAppearanceMode.unknown) {
            int i10 = a.f94018a[mDAppearanceMode.ordinal()];
            if (i10 == 1) {
            ...
            int i11 = a.f94018a[mDAppearanceMode2.ordinal()];
            if (i11 == 1) {
                return R.style.MedalliaInvitationDarkDialog;
            }
            if (i11 == 2) {
    ...
    protected MDAppearanceMode b() {
        ...
        if (strA != null) {
            try {
                if (!strA.isEmpty()) {
                    int i10 = a.f94018a[MDAppearanceMode.fromString(strA).ordinal()];
                    if (i10 == 1) {
