...
public class p5 {
    ...
    private static p5 f93541b;

    /* renamed from: a, reason: collision with root package name */
    private ArrayList<String> f93542a;

    class a implements n6<f6> {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ MDResultCallback f93543a;

        a(MDResultCallback mDResultCallback) {
            this.f93543a = mDResultCallback;
        }

        @Override // com.medallia.digital.mobilesdk.n6
        public void a(f6 f6Var) {
            p5.this.a(f6Var);
            MDResultCallback mDResultCallback = this.f93543a;
        ...
        if (t0.c().a() != null) {
            if (t0.c().a().propertyConfiguration != null) {
                ...
                if (!zIsOCQEnabled) {
                    ...
                    this.f93542a = t0.c().a().propertyConfiguration.getOmniChannelRulesIds();
                    z10 = true;
                }
            } else {
                zIsOCQEnabled = false;
    ...
    public JSONObject c() throws JSONException {
        ...
        try {
            jSONObject.put("rulesIds", new JSONArray(ModelFactory.getInstance().getStringArrayAsJsonString(this.f93542a)));
