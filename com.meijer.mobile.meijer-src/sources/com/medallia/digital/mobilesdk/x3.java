...
class x3 {
    ...
    protected static final String f94068c = "Language not available. Language fallback logic applied";

    /* renamed from: d, reason: collision with root package name */
    protected static final String f94069d = "PreInit";

    /* renamed from: e, reason: collision with root package name */
    private static final String f94070e = "^[a-zA-Z]{2,3}";

    /* renamed from: f, reason: collision with root package name */
    private static final String f94071f = "^[a-zA-Z]{2,3}_[a-zA-Z]{2,3}";

    /* renamed from: g, reason: collision with root package name */
    private static final String f94072g = "^[a-zA-Z]{2,3}-[a-zA-Z]{2,3}";

    /* renamed from: h, reason: collision with root package name */
    private static x3 f94073h;

    /* renamed from: a, reason: collision with root package name */
    private boolean f94074a;

    /* renamed from: b, reason: collision with root package name */
    private Pair<Boolean, String> f94075b = new Pair<>(Boolean.FALSE, null);
    ...
    protected String c() {
        return (this.f94074a || !((Boolean) this.f94075b.first).booleanValue()) ? d7.b().a(d7.a.CUSTOM_LOCALE, (String) null) : (String) this.f94075b.second;
    }
    ...
    protected MDExternalError e(String str) {
        ...
        if (str.matches(f94070e)) {
            if (this.f94074a) {
                d7.b().b(d7.a.CUSTOM_LOCALE, str);
            } else {
                this.f94075b = new Pair<>(Boolean.TRUE, str);
            }
            return null;
        }
        if (str.matches(f94071f)) {
            str = str.replace("_", "-");
        }
        if (!str.matches(f94072g)) {
            if (this.f94074a) {
                d7.b().b(d7.a.CUSTOM_LOCALE, (String) null);
            } else {
                this.f94075b = new Pair<>(Boolean.TRUE, null);
            }
    ...
    protected String g() {
        return (String) this.f94075b.second;
    }
    ...
    protected boolean j() {
        return ((Boolean) this.f94075b.first).booleanValue();
    }
