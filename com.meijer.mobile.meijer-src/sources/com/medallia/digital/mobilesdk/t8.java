...
class t8 implements Observer, m8 {
    ...
    private static t8 f93900c;

    /* renamed from: a, reason: collision with root package name */
    private boolean f93901a;
    ...
    class a extends v4 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Object f93903a;
        ...
        public void a() {
            ...
            Object obj = this.f93903a;
            if (!(obj instanceof c0)) {
                if ((obj instanceof k) && s4.f().n()) {
                    k kVar = (k) this.f93903a;
    ...
    static /* synthetic */ class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f93905a;

        /* renamed from: b, reason: collision with root package name */
        static final /* synthetic */ int[] f93906b;
        ...
        static {
            ...
            try {
                f93906b[ValueType.TypeInteger.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f93906b[ValueType.TypeDouble.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f93906b[ValueType.TypeLong.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f93906b[ValueType.TypeBoolean.ordinal()] = 5;
            ...
            try {
                f93905a[c.DeviceId.ordinal()] = 2;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f93905a[c.SessionId.ordinal()] = 3;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f93905a[c.PropertyId.ordinal()] = 4;
    ...
    public t8() {
        ...
        this.f93901a = d7.b().a(d7.a.SDK_STOPPED, false);
    ...
    protected CustomParameter c(c0 c0Var) {
        ...
        try {
            ...
            int i10 = b.f93906b[c0Var.j().ordinal()];
    ...
    private JSONArray a(ArrayList<c> arrayList, JSONArray jSONArray, String str) {
        ...
        if (str != null) {
            if (arrayList == null || arrayList.isEmpty()) {
                ...
                boolean z13 = false;
                while (it.hasNext()) {
                    int i10 = b.f93905a[it.next().ordinal()];
                    if (i10 == 1) {
                        z13 = true;
                    } else if (i10 != 2) {
                        if (i10 == 3) {
    ...
    protected void a(ConfigurationContract configurationContract) {
        ...
        this.f93902b = configurationContract.getSdkConfiguration().getMedalliaDigitalBrain().isDistinct();
    }
