...
class k2 extends h1<j2> {
    ...
    private static final String f93237a = "formData";
    ...
    private static class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private static final String f93239a = "formId";

        /* renamed from: b, reason: collision with root package name */
        private static final String f93240b = "name";

        /* renamed from: c, reason: collision with root package name */
        private static final String f93241c = "fromJson";

        /* renamed from: d, reason: collision with root package name */
        private static final String f93242d = "templatePath";

        /* renamed from: e, reason: collision with root package name */
        private static final String f93243e = "templateId";

        /* renamed from: f, reason: collision with root package name */
        private static final String f93244f = "title";

        /* renamed from: g, reason: collision with root package name */
        private static final String f93245g = "titleTextColor";

        /* renamed from: h, reason: collision with root package name */
        private static final String f93246h = "titleBackgroundColor";

        /* renamed from: i, reason: collision with root package name */
        private static final String f93247i = "formType";

        /* renamed from: j, reason: collision with root package name */
        private static final String f93248j = "formStatus";

        /* renamed from: k, reason: collision with root package name */
        private static final String f93249k = "transitionType";

        /* renamed from: l, reason: collision with root package name */
        private static final String f93250l = "inviteData";

        /* renamed from: m, reason: collision with root package name */
        private static final String f93251m = "viewType";

        /* renamed from: n, reason: collision with root package name */
        private static final String f93252n = "isPreloaded";

        /* renamed from: o, reason: collision with root package name */
        private static final String f93253o = "formLanguage";

        /* renamed from: p, reason: collision with root package name */
        private static final String f93254p = "isRtl";

        /* renamed from: q, reason: collision with root package name */
        private static final String f93255q = "poweredBy";

        /* renamed from: r, reason: collision with root package name */
        private static final String f93256r = "thankYouData";

        /* renamed from: s, reason: collision with root package name */
        private static final String f93257s = "redirectLinks";

        /* renamed from: t, reason: collision with root package name */
        private static final String f93258t = "isBlockNetworkInForm";

        /* renamed from: u, reason: collision with root package name */
        private static final String f93259u = "templateDebugRemoteUrl";

        /* renamed from: v, reason: collision with root package name */
        private static final String f93260v = "urlVersion";

        /* renamed from: w, reason: collision with root package name */
        private static final String f93261w = "shouldDownloadDebugForm";

        /* renamed from: x, reason: collision with root package name */
        private static final String f93262x = "headerThemeName";

        /* renamed from: y, reason: collision with root package name */
        private static final String f93263y = "isDarkModeEnabled";
    ...
    protected long b() {
        try {
            return DatabaseUtils.queryNumEntries(f1.a().getWritableDatabase(), f93237a);
        } catch (Exception e10) {
            a4.c(e10.getMessage());
            return 0L;
        }
