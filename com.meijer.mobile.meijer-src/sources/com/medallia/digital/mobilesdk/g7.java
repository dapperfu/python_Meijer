...
class g7 extends k0<Void> {
    ...
    private final c2 f92944g;

    /* renamed from: h, reason: collision with root package name */
    private String f92945h;

    /* renamed from: i, reason: collision with root package name */
    private boolean f92946i;

    /* renamed from: j, reason: collision with root package name */
    private boolean f92947j;
    ...
    class a implements o6.a {
        ...
        public void a(i6 i6Var) throws JSONException {
            ...
            g7 g7Var = g7.this;
            g7Var.a(g7Var.f92944g, g7.this.f92947j);
            g7.this.b(i6Var);
        }
        ...
        */
        public void a(com.medallia.digital.mobilesdk.k6 r7) throws org.json.JSONException {
            ...
            L67:
                com.medallia.digital.mobilesdk.g7 r7 = com.medallia.digital.mobilesdk.g7.this
                com.medallia.digital.mobilesdk.n6<T> r7 = r7.f93233d
                if (r7 == 0) goto L71
                r0 = 0
                r7.a(r0)
            L71:
    ...
    protected h4 a(i6 i6Var) {
        s1 s1Var = i6.a.NO_CONNECTION.equals(i6Var.a()) ? new s1(h4.a.f92997i) : i6.a.TIMEOUT.equals(i6Var.a()) ? new s1(h4.a.f92964G) : new s1(h4.a.f92963F);
    ...
    protected h4 d() {
        ...
        if (TextUtils.isEmpty(this.f93231b.e())) {
            h4.a aVar2 = h4.a.f92966I;
            a4.c(aVar2.toString());
            return new s1(aVar2);
        }
        c2 c2Var = this.f92944g;
        if (c2Var != null && !TextUtils.isEmpty(c2Var.a())) {
            return null;
        }
        h4.a aVar3 = h4.a.f92967J;
        a4.c(aVar3.toString());
        return new s1(aVar3);
    }

    protected void e() {
        if (this.f92944g == null) {
            return;
        }
        f1.a().a(this.f92944g);
    ...
    */
    protected void b() throws org.json.JSONException {
        /*
            ...
            if (r1 == 0) goto L10
            com.medallia.digital.mobilesdk.n6<T> r0 = r9.f93233d
            if (r0 == 0) goto Lf
            r0.a(r1)
        Lf:
            return
        L10:
            boolean r1 = r9.f92946i
            if (r1 != 0) goto L1a
            boolean r1 = r9.f()
            r9.f92947j = r1
        L1a:
            org.json.JSONObject r1 = new org.json.JSONObject     // Catch: org.json.JSONException -> L3f
            com.medallia.digital.mobilesdk.c2 r2 = r9.f92944g     // Catch: org.json.JSONException -> L3f
        ...
        L41:
            ...
            goto L3d
        L49:
            boolean r0 = r9.f92946i
            if (r0 == 0) goto L55
            java.lang.String r0 = r9.f92945h
        ...
        L55:
            ...
            goto L53
        L5c:
            com.medallia.digital.mobilesdk.o6 r2 = r9.f93230a
            com.medallia.digital.mobilesdk.l0 r0 = r9.f93231b
