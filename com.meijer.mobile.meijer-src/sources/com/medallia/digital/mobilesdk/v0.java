...
class v0 {
    ...
    private static final Long f93998a = 604800000L;
    ...
    class a extends v4 {
        ...
        final /* synthetic */ String f94000b;
        ...
        public void a() {
            a4.e("Saving local configuration storage, timestamp, clear uuid = " + this.f93999a);
    ...
    class b extends v4 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ String f94001a;
    ...
    protected static boolean a(ConfigurationContract configurationContract) {
        ...
        if (offlineConfigurationExpirationTime == null) {
            offlineConfigurationExpirationTime = f93998a;
        }
        long jCurrentTimeMillis = System.currentTimeMillis();
