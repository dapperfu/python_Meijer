...
final class CollectorsInfrastructure implements p0, m8, LifeCycle.h {
    ...
    protected C11692c accountIdCollector;
    ...
    protected n1 deviceModelCollector = new n1(getPollType(s0.a.f93770b.getFrequency()), n0.DeviceModel);
    protected o1 deviceResolutionCollector = new o1(getPollType(s0.a.f93771c.getFrequency()), n0.DeviceResolution);
    protected p1 deviceUsedMemoryCollector = new p1(getPollType(s0.a.f93772d.getFrequency()), n0.DeviceUsedMemory);
    protected k1 deviceFreeMemoryCollector = new k1(getPollType(s0.a.f93769a.getFrequency()), n0.DeviceFreeMemoryCollector);
    protected r5 osNameCollector = new r5(getPollType(s0.a.f93774f.getFrequency()), n0.OsName);
    protected s5 osVersionCollector = new s5(getPollType(s0.a.f93775g.getFrequency()), n0.OsVersion);
    protected m5 networkProviderCollector = new m5(getPollType(s0.a.f93776h.getFrequency()), n0.NetworkProvider);
    protected k5 networkCarrierCollector = new k5(getPollType(s0.a.f93777i.getFrequency()), n0.NetworkCarrier);
    protected p3 languageCollector = new p3(getPollType(s0.a.f93778j.getFrequency()), n0.Language);
    protected b8 timezoneCollector = new b8(getPollType(s0.a.f93779k.getFrequency()), n0.Timezone);
    protected v2 ipCollector = new v2(getPollType(s0.a.f93780l.getFrequency()), n0.IP);
    protected q5 orientationCollector = new q5(n0.Orientation);
    protected l1 deviceIdCollector = new l1(getPollType(s0.a.f93782n.getFrequency()), n0.DeviceId);
    ...
    private CollectorsInfrastructure() {
        ...
        d1Var.a(true);
        this.appNameCollector = new p(getPollType(s0.a.f93783o.getFrequency()), n0.AppName);
        this.appIdCollector = new o(getPollType(s0.a.f93784p.getFrequency()), n0.AppId);
        this.appVersionCollector = new v(getPollType(s0.a.f93785q.getFrequency()), n0.AppVersion);
        this.sdkVersionCollector = new w6(getPollType(s0.a.f93786r.getFrequency()), n0.SdkVersion);
        this.sessionCalculatedPercentageCollector = new z6(getPollType(s0.a.f93787s.getFrequency()), n0.SessionCalculatedPercentage);
        ...
        this.deviceVendorCollector = new q1(getPollType(s0.a.f93773e.getFrequency()), n0.DeviceVendor);
        ...
        this.accountIdCollector = new C11692c(n0.AccountId);
        ...
        this.localNotificationsEnabledCollector = new w3(getPollType(s0.a.f93763R.getFrequency()), n0.LocalNotificationsEnabled);
