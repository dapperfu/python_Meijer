...
public class d2 extends h1<c2> {
    ...
    private static final int f92593a = 10;

    /* renamed from: b, reason: collision with root package name */
    private static final String f92594b = "feedbacks";
    ...
    private static class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private static final String f92596a = "feedbackData";

        /* renamed from: b, reason: collision with root package name */
        private static final String f92597b = "feedbackUUID";

        /* renamed from: c, reason: collision with root package name */
        private static final String f92598c = "formId";

        /* renamed from: d, reason: collision with root package name */
        private static final String f92599d = "submittedTimestamp";

        /* renamed from: e, reason: collision with root package name */
        private static final String f92600e = "formTriggerType";

        /* renamed from: f, reason: collision with root package name */
        private static final String f92601f = "numberOfRetries";
    ...
    protected long b() {
        try {
            return DatabaseUtils.queryNumEntries(f1.a().getWritableDatabase(), f92594b);
        } catch (Exception e10) {
            a4.c(e10.getMessage());
            return 0L;
        }
