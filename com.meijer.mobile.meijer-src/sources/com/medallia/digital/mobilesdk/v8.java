...
class v8 extends h1<c0> {
    ...
    private static final String f94019a = "userJourney";
    ...
    static /* synthetic */ class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f94021a;
        ...
        static {
            ...
            try {
                f94021a[d.ALL_DESC.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f94021a[d.SESSION.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f94021a[d.EVENTS_SESSION.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f94021a[d.DISTINCT_LATEST_NO_CP.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f94021a[d.DISTINCT_SESSION_COLLECTORS.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f94021a[d.CUSTOM_PARAMS_DESC.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f94021a[d.CUSTOM_PARAMS_SESSION.ordinal()] = 8;
    ...
    private static class c {
        ...
        /* renamed from: a, reason: collision with root package name */
        private static final String f94022a = "sessionId";

        /* renamed from: b, reason: collision with root package name */
        private static final String f94023b = "name";

        /* renamed from: c, reason: collision with root package name */
        private static final String f94024c = "value";

        /* renamed from: d, reason: collision with root package name */
        private static final String f94025d = "valueType";

        /* renamed from: e, reason: collision with root package name */
        private static final String f94026e = "lifetime";

        /* renamed from: f, reason: collision with root package name */
        private static final String f94027f = "timestamp";

        /* renamed from: g, reason: collision with root package name */
        private static final String f94028g = "groupType";
    ...
    protected long b() {
        try {
            return DatabaseUtils.queryNumEntries(f1.a().getWritableDatabase(), f94019a);
        } catch (Exception e10) {
            a4.c(e10.getMessage());
            return 0L;
        }
