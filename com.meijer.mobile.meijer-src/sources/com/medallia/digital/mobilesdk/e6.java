...
public class e6 extends k0<f6> {
    ...
    public static final String f92746g = "CUUID file does not exist";

    /* renamed from: h, reason: collision with root package name */
    public static final int f92747h = 403;
    ...
    class b implements o6.a {
        ...
        final /* synthetic */ String f92749a;

        class a implements o6.a {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ f6 f92751a;
            ...
            public void a(i6 i6Var) {
                ...
                a4.b(sb2.toString());
                if (i6Var != null && i6Var.b() == 403) {
                    this.f92751a.a(e6.f92746g);
                }
                e6.this.f93233d.a((n6<T>) this.f92751a);
            }
        ...
        public void a(k6 k6Var) {
            ...
            if (k6Var != null) {
                ...
                if (str == null) {
                    ...
                    e6.this.f93233d.a((n6<T>) f6VarCreateQuarantineValidation);
                }
            }
        }
    }
    ...
    protected h4 a(i6 i6Var) {
        s1 s1Var = new s1(h4.a.f92986c0);
        if (i6Var != null) {
            if (i6.a.NO_CONNECTION.equals(i6Var.a())) {
                s1Var = new s1(h4.a.f92994g0);
            } else if (i6.a.TIMEOUT.equals(i6Var.a())) {
                s1Var = new s1(h4.a.f92990e0);
            }
        }
    ...
    void c(String str) {
        String strE = this.f93231b.e();
        if (strE != null && !strE.isEmpty()) {
            this.f93230a.b(strE, null, a(s4.c.ACCESS_TOKEN), this.f93231b.a(), s4.f().i().g().a().intValue(), new b(str));
            return;
        }
        h4.a aVar = h4.a.f92988d0;
        a4.c(aVar.toString());
        this.f93233d.a((h4) new s1(aVar));
    }
    ...
    boolean d(String str) {
        ...
        if (e()) {
            ...
            if (arrayListC == null || arrayListC.isEmpty()) {
                ...
                if (g6Var == null || (l10 = g6Var.f92942b) == null || l10.longValue() == 0 || g6Var.f92942b.longValue() >= System.currentTimeMillis()) {
                    return false;
                }
                str2 = "Should validate quarantine - DB rules expired: " + g6Var.f92942b;
            }
        }
        a4.e(str2);
        return true;
    ...
    public void a(o6.a aVar) {
        ...
        if (strC != null && !strC.isEmpty()) {
            new k8(this.f93230a, strC).a(aVar);
        } else {
            a4.c(h4.a.f92992f0.b());
            aVar.a((i6) null);
        }
    }
}
