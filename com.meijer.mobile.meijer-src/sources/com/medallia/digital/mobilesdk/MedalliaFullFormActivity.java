...
public class MedalliaFullFormActivity extends n4 {
    ...
    private Toolbar f92401n;

    /* renamed from: o, reason: collision with root package name */
    private View f92402o;

    /* renamed from: p, reason: collision with root package name */
    private TextView f92403p;
    ...
    private String o() {
        ...
        try {
            ...
            if (accessibilityManager != null && accessibilityManager.isEnabled() && accessibilityManager.isTouchExplorationEnabled() && (localization = t0.c().a().getLocalization()) != null) {
                ...
                String strA = x3.e().a(resourceContractF != null ? resourceContractF.getLocalUrl() : null, this.f93433a.getFormLanguage(), x3.c.BACK, (x3.a) null);
    ...
    */
    private void p() {
        /*
            r5 = this;
            com.medallia.digital.mobilesdk.j2 r0 = r5.f93433a
            if (r0 == 0) goto Lae
            java.lang.String r0 = r0.getTitle()
            com.medallia.digital.mobilesdk.j2 r1 = r5.f93433a
            java.lang.String r1 = r1.getTitleTextColor()
            com.medallia.digital.mobilesdk.j2 r2 = r5.f93433a
            java.lang.String r2 = r2.getTitleBackgroundColor()
            com.medallia.digital.mobilesdk.j2 r3 = r5.f93433a     // Catch: java.lang.Exception -> L33
            boolean r3 = r3.isDarkModeEnabled()     // Catch: java.lang.Exception -> L33
            if (r3 == 0) goto L38
            com.medallia.digital.mobilesdk.v5 r3 = r5.f93442j     // Catch: java.lang.Exception -> L33
            if (r3 == 0) goto L38
        ...
        L38:
            com.medallia.digital.mobilesdk.j2 r3 = r5.f93433a
            boolean r3 = r3.isRtl()
            if (r3 == 0) goto L53
            androidx.appcompat.widget.Toolbar r3 = r5.f92401n     // Catch: java.lang.Exception -> L4d
            r4 = 1
        ...
        L4f:
            ...
            goto L63
        L53:
            androidx.appcompat.widget.Toolbar r3 = r5.f92401n     // Catch: java.lang.Exception -> L60
            r4 = 0
        ...
        L63:
            ...
            if (r3 != 0) goto L6e
            android.widget.TextView r3 = r5.f92403p
            r3.setText(r0)
        L6e:
            boolean r0 = android.text.TextUtils.isEmpty(r2)
            if (r0 != 0) goto L88
            int r0 = android.graphics.Color.parseColor(r2)     // Catch: java.lang.Exception -> L83
            androidx.appcompat.widget.Toolbar r2 = r5.f92401n     // Catch: java.lang.Exception -> L83
            r2.setBackgroundColor(r0)     // Catch: java.lang.Exception -> L83
            android.view.View r2 = r5.f92402o     // Catch: java.lang.Exception -> L83
            r2.setBackgroundColor(r0)     // Catch: java.lang.Exception -> L83
            goto L88
        L83:
        ...
        L88:
            ...
            if (r0 != 0) goto Lae
            android.widget.TextView r0 = r5.f92403p     // Catch: java.lang.Exception -> La9
            ...
            androidx.appcompat.widget.Toolbar r0 = r5.f92401n     // Catch: java.lang.Exception -> La9
    ...
    protected void j() {
        ...
        this.f92401n = (Toolbar) findViewById(R.id.medallia_toolbar);
        this.f92402o = findViewById(R.id.medallia_delimiter);
        setSupportActionBar(this.f92401n);
        if (getSupportActionBar() != null) {
            getSupportActionBar().t(false);
            getSupportActionBar().s(true);
            getSupportActionBar().w(o());
        }
        this.f92403p = (TextView) findViewById(R.id.medallia_title_text_view);
        p();
    }
