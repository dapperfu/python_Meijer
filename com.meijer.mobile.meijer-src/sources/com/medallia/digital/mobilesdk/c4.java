...
class c4 extends d0 {
    ...
    private MDFeedbackListener f92535a;

    /* renamed from: b, reason: collision with root package name */
    private final BroadcastReceiver f92536b = new a();
    ...
    class a extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            try {
                ...
                if (aVar == Broadcasts.d.a.feedbackPayload && c4.this.f92535a != null) {
                    c4.this.f92535a.onFeedbackSubmitted(new MDFeedbackListenerData(stringExtra3, longExtra, stringExtra2, stringExtra));
                }
                if (c4.this.f92535a != null) {
    ...
    protected void a(Object obj) {
        if (this.f92535a != null && obj == null) {
            e();
            this.f92535a = null;
        }
        if (obj instanceof MDFeedbackListener) {
            this.f92535a = (MDFeedbackListener) obj;
        }
    }
}
