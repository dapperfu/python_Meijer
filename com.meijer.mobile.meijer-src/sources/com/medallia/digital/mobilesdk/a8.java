...
class a8 extends w1<Long> implements LifeCycle.h, LifeCycle.g {
    ...
    private Long f92458g;

    protected a8(n0 n0Var) {
        super(n0Var);
        this.f92458g = Long.valueOf(System.currentTimeMillis());
    }

    private Long p() {
        if (this.f92458g == null || !h()) {
            return null;
        }
        return Long.valueOf(System.currentTimeMillis() - this.f92458g.longValue());
    }

    @Override // com.medallia.digital.mobilesdk.LifeCycle.g
    public void a(long j10) {
        this.f92458g = Long.valueOf(this.f92458g.longValue() + j10);
    }
