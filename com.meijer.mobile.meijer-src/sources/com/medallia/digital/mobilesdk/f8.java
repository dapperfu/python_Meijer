...
class f8<T> extends e8<T> implements x0 {
    ...
    private u1.f f92881h;

    /* renamed from: i, reason: collision with root package name */
    private ArrayList<e8<T>> f92882i;

    public f8(JSONObject jSONObject) {
        try {
            if (jSONObject.has("conjunction") && !jSONObject.isNull("conjunction")) {
                this.f92881h = u1.f.a(jSONObject.getString("conjunction"));
            }
            if (!jSONObject.has("childrenCriteria") || jSONObject.isNull("childrenCriteria")) {
                return;
            }
            this.f92882i = ModelFactory.getInstance().getTriggerChildesContract(jSONObject.getJSONArray("childrenCriteria"));
        } catch (Exception e10) {
            a4.c(e10.getMessage());
        }
    }
    ...
    private T c(ArrayList<c0> arrayList, ArrayList<c0> arrayList2, ArrayList<g6> arrayList3) {
        long jMin;
        Iterator<e8<T>> it = this.f92882i.iterator();
        Long lValueOf = null;
        while (it.hasNext()) {
    ...
    public T a(ArrayList<c0> arrayList, ArrayList<c0> arrayList2, ArrayList<g6> arrayList3) {
        ...
        if (this.f92882i == null || (fVar = this.f92881h) == null) {
            return null;
        }
    ...
    public String toJsonString() {
        try {
            ...
            sb2.append(ModelFactory.getInstance().getContractsAsJsonString(this.f92882i));
            sb2.append("}");
            return sb2.toString();
        } catch (Exception e10) {
            a4.c(e10.getMessage());
