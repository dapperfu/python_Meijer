...
class u3 extends h1<t3> {
    ...
    private static final String f93977a = "localNotificationData";

    /* renamed from: b, reason: collision with root package name */
    static final String f93978b = "getLNWithMinDelay";
    ...
    private static class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private static final String f93980a = "title";

        /* renamed from: b, reason: collision with root package name */
        private static final String f93981b = "body";

        /* renamed from: c, reason: collision with root package name */
        private static final String f93982c = "appIconPath";

        /* renamed from: d, reason: collision with root package name */
        private static final String f93983d = "expiration";

        /* renamed from: e, reason: collision with root package name */
        private static final String f93984e = "activityNameString";

        /* renamed from: f, reason: collision with root package name */
        private static final String f93985f = "formId";

        /* renamed from: g, reason: collision with root package name */
        private static final String f93986g = "delay";
    ...
    protected long b() {
        try {
            return DatabaseUtils.queryNumEntries(f1.a().getWritableDatabase(), f93977a);
        } catch (Exception e10) {
            a4.c(e10.getMessage());
            return 0L;
        }
    ...
    protected ArrayList<t3> c(Object... objArr) {
        ...
        if (objArr == null || objArr.length <= 0 || (obj = objArr[0]) == null || !(obj instanceof String) || !obj.equals(f93978b)) {
