...
public final /* data */ class NotifyCampaign {
    ...
    public int hashCode() {
        ...
        int iHashCode2 = (Boolean.hashCode(this.deferOnPickup) + ((this.content.hashCode() + ((iHashCode + (num == null ? 0 : num.hashCode())) * 31)) * 31)) * 31;
