...
public final /* data */ class CustomerData {
    ...
    @InterfaceC16127c("age_verification")
    ...
    @InterfaceC16127c("terms_of_service")
    ...
    public int hashCode() {
        ...
        return Boolean.hashCode(this.ageVerification) + ((Boolean.hashCode(this.termsOfService) + ((iHashCode4 + (str4 != null ? str4.hashCode() : 0)) * 31)) * 31);
    }
