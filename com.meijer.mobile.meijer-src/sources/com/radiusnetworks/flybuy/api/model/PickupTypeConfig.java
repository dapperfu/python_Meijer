...
public final /* data */ class PickupTypeConfig {
    ...
    public int hashCode() {
        return Boolean.hashCode(this.showHandoffVehicleLocations) + ((Boolean.hashCode(this.requireVehicleInfo) + ((Boolean.hashCode(this.showVehicleInfoFields) + a.a(this.pickupTypeLocalizedString, this.pickupType.hashCode() * 31, 31)) * 31)) * 31);
    }
}
