...
public final class a extends Lambda implements Function0 {
    ...
    public final /* synthetic */ AnalyticsEventsData f120890f;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public a(AnalyticsEventsData analyticsEventsData) {
        super(0);
        this.f120890f = analyticsEventsData;
    }
    ...
    public final Object invoke() {
        ...
        return ((w) retrofit.create(w.class)).a(new AnalyticsEventsRequest(this.f120890f));
    }
}
