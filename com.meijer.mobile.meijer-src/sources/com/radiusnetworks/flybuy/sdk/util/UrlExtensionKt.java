...
@Metadata(d1 = {"\u0000\u001a\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010$\n\u0000\u001a\u0018\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001*\u00020\u0002H\u0080@¢\u0006\u0002\u0010\u0003\u001a\u0018\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00040\u0001*\u00020\u0004H\u0080@¢\u0006\u0002\u0010\u0005\u001a\u0018\u0010\u0006\u001a\u000e\u0012\u0004\u0012\u00020\u0004\u0012\u0004\u0012\u00020\u00040\u0007*\u00020\u0002H\u0000¨\u0006\b"}, d2 = {"getRedirectUrl", "Lkotlin/Result;", "Ljava/net/URL;", "(Ljava/net/URL;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "", "(Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "queryParameters", "", "core_defaultRelease"}, k = 2, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes12.dex */
public final class UrlExtensionKt {

    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    @DebugMetadata(c = "com.radiusnetworks.flybuy.sdk.util.UrlExtensionKt", f = "UrlExtension.kt", l = {10}, m = "getRedirectUrl")
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001*\u00020\u0000H\u008a@¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"Lmv/O;", "Lkotlin/Result;", "", "<anonymous>", "(Lmv/O;)Lkotlin/Result;"}, k = 3, mv = {1, 9, 0})
    @DebugMetadata(c = "com.radiusnetworks.flybuy.sdk.util.UrlExtensionKt$getRedirectUrl$2", f = "UrlExtension.kt", l = {13}, m = "invokeSuspend")
    /* renamed from: com.radiusnetworks.flybuy.sdk.util.UrlExtensionKt$getRedirectUrl$2, reason: invalid class name */
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Result<? extends String>>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(InterfaceC15783O interfaceC15783O, Continuation<? super Result<? extends String>> continuation) {
            return invoke2(interfaceC15783O, (Continuation<? super Result<String>>) continuation);
        }

        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final Object invoke2(InterfaceC15783O interfaceC15783O, Continuation<? super Result<String>> continuation) {
    ...
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    @DebugMetadata(c = "com.radiusnetworks.flybuy.sdk.util.UrlExtensionKt", f = "UrlExtension.kt", l = {20}, m = "getRedirectUrl")
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001*\u00020\u0000H\u008a@¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"Lmv/O;", "Lkotlin/Result;", "Ljava/net/URL;", "<anonymous>", "(Lmv/O;)Lkotlin/Result;"}, k = 3, mv = {1, 9, 0})
    ...
    public static final class AnonymousClass4 extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Result<? extends URL>>, Object> {
        ...
        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(InterfaceC15783O interfaceC15783O, Continuation<? super Result<? extends URL>> continuation) {
            return invoke2(interfaceC15783O, (Continuation<? super Result<URL>>) continuation);
        }

        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final Object invoke2(InterfaceC15783O interfaceC15783O, Continuation<? super Result<URL>> continuation) {
            return ((AnonymousClass4) create(interfaceC15783O, continuation)).invokeSuspend(Unit.f143329a);
        }
        ...
        public final Object invokeSuspend(Object obj) throws IOException {
            ...
            if (this.label == 0) {
                ...
                try {
                    ...
                    for (Map.Entry<String, String> entry : SdkInfoInterceptor.INSTANCE.getHeaders().entrySet()) {
    ...
    */
    ...
    public static final Map<String, String> queryParameters(URL url) throws UnsupportedEncodingException {
        ...
        if (query != null && query.length() > 0) {
            Iterator it = StringsKt.b1(query, new String[]{"&"}, false, 0, 6, null).iterator();
            while (it.hasNext()) {
                List listB1 = StringsKt.b1((String) it.next(), new String[]{"="}, false, 0, 6, null);
                String strDecode = URLDecoder.decode((String) listB1.get(0), "UTF-8");
                String strDecode2 = listB1.size() > 1 ? URLDecoder.decode((String) listB1.get(1), "UTF-8") : "";
