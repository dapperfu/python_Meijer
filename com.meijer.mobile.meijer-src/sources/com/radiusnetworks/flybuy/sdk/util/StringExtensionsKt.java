...
public final class StringExtensionsKt {
    public static final String snakeCaseToTitleCaseUS(final String str) {
        ...
        return CollectionsKt.B0(StringsKt.b1(str, new String[]{"_"}, false, 0, 6, null), " ", null, null, 0, null, new Function1<String, CharSequence>() { // from class: com.radiusnetworks.flybuy.sdk.util.StringExtensionsKt.snakeCaseToTitleCaseUS.1
