...
@Metadata(d1 = {"\u00004\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u001ar\u0010\u0000\u001a\u0018\u0012\f\u0012\n\u0012\u0004\u0012\u0002H\u0003\u0018\u00010\u0002\u0012\u0006\u0012\u0004\u0018\u00010\u00040\u0001\"\u0004\b\u0000\u0010\u0005\"\u0004\b\u0001\u0010\u00032\u0012\u0010\u0006\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00050\u00020\u00072\u0012\u0010\b\u001a\u000e\u0012\u0004\u0012\u0002H\u0005\u0012\u0004\u0012\u0002H\u00030\t2\u0018\u0010\n\u001a\u0014\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00030\u0002\u0012\u0004\u0012\u00020\u000b0\tH\u0080@¢\u0006\u0002\u0010\f\u001a|\u0010\r\u001a\u00020\u000b\"\u0004\b\u0000\u0010\u0005\"\u0004\b\u0001\u0010\u0003*\u00020\u000e2\u0012\u0010\u0006\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00050\u00020\u00072\u0012\u0010\b\u001a\u000e\u0012\u0004\u0012\u0002H\u0005\u0012\u0004\u0012\u0002H\u00030\t2\u0018\u0010\n\u001a\u0014\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00030\u0002\u0012\u0004\u0012\u00020\u000b0\t2 \b\u0002\u0010\u000f\u001a\u001a\u0012\u0006\u0012\u0004\u0018\u0001H\u0003\u0012\u0006\u0012\u0004\u0018\u00010\u0004\u0012\u0004\u0012\u00020\u000b\u0018\u00010\u0010H\u0007¨\u0006\u0011"}, d2 = {"invokeApi", "Lkotlin/Pair;", "Lcom/radiusnetworks/flybuy/api/network/common/ApiResponse;", "R", "Lcom/radiusnetworks/flybuy/sdk/data/common/SdkError;", "T", "apiCall", "Lkotlin/Function0;", "dataConverter", "Lkotlin/Function1;", "onSuccess", "", "(Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "executeApi", "Landroid/content/Context;", "callback", "Lkotlin/Function2;", "core_defaultRelease"}, k = 2, mv = {1, 9, 0}, xi = 48)
...
public final class ApiExtensionsKt {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        ...
        public static final class C19831 extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
            final /* synthetic */ Function0<ApiResponse<T>> $apiCall;
            final /* synthetic */ Function2<R, SdkError, Unit> $callback;
            final /* synthetic */ Function1<T, R> $dataConverter;
            final /* synthetic */ Function1<ApiResponse<R>, Unit> $onSuccess;
            ...
            public C19831(Function0<? extends ApiResponse<T>> function0, Function1<? super T, ? extends R> function1, Function1<? super ApiResponse<R>, Unit> function12, Function2<? super R, ? super SdkError, Unit> function2, Continuation<? super C19831> continuation) {
            ...
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C19831(this.$apiCall, this.$dataConverter, this.$onSuccess, this.$callback, continuation);
            }

            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(InterfaceC15783O interfaceC15783O, Continuation<? super Unit> continuation) {
                return ((C19831) create(interfaceC15783O, continuation)).invokeSuspend(Unit.f143329a);
            }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                C19831 c19831 = new C19831(this.$apiCall, this.$dataConverter, this.$onSuccess, this.$callback, null);
                this.label = 1;
                if (C15805i.g(coroutineContext, c19831, this) == objF) {
                    return objF;
                }
            }
            return Unit.f143329a;
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0006\u001a\u0018\u0012\f\u0012\n\u0012\u0004\u0012\u00028\u0001\u0018\u00010\u0004\u0012\u0006\u0012\u0004\u0018\u00010\u00050\u0003\"\u0004\b\u0000\u0010\u0000\"\u0004\b\u0001\u0010\u0001*\u00020\u0002H\u008a@¢\u0006\u0004\b\u0006\u0010\u0007"}, d2 = {"T", "R", "Lmv/O;", "Lkotlin/Pair;", "Lcom/radiusnetworks/flybuy/api/network/common/ApiResponse;", "Lcom/radiusnetworks/flybuy/sdk/data/common/SdkError;", "<anonymous>", "(Lmv/O;)Lkotlin/Pair;"}, k = 3, mv = {1, 9, 0})
    ...
    public static final class AnonymousClass2<R> extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Pair<? extends ApiResponse<R>, ? extends SdkError>>, Object> {
        final /* synthetic */ Function0<ApiResponse<T>> $apiCall;
        final /* synthetic */ Function1<T, R> $dataConverter;
        final /* synthetic */ Function1<ApiResponse<R>, Unit> $onSuccess;
        private /* synthetic */ Object L$0;
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(InterfaceC15783O interfaceC15783O, Continuation<? super Pair<? extends ApiResponse<R>, ? extends SdkError>> continuation) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                try {
                    ...
                    LogExtensionsKt.loge$default(interfaceC15783O, true, e10, null, new Object[0], 4, null);
    ...
    public static final <T, R> void executeApi(Context context, Function0<? extends ApiResponse<T>> apiCall, Function1<? super T, ? extends R> dataConverter, Function1<? super ApiResponse<R>, Unit> onSuccess, Function2<? super R, ? super SdkError, Unit> function2) {
        ...
        if (NetworkUtilsKt.isNetworkConnected(applicationContext)) {
            ...
            C15809k.d(C15784P.a(C15800f0.a()), null, null, new AnonymousClass1(apiCall, dataConverter, onSuccess, function2, null), 3, null);
    ...
    public static final <T, R> Object invokeApi(Function0<? extends ApiResponse<T>> function0, Function1<? super T, ? extends R> function1, Function1<? super ApiResponse<R>, Unit> function12, Continuation<? super Pair<? extends ApiResponse<R>, ? extends SdkError>> continuation) {
        return C15805i.g(C15800f0.b(), new AnonymousClass2(function0, function1, function12, null), continuation);
    }
}
