...
public final /* data */ class PickupConfig {
    ...
    public int hashCode() {
        int iHashCode = (Boolean.hashCode(this.pickupTypeSelectionEnabled) + ((Boolean.hashCode(this.customerNameEditingEnabled) + ((Integer.hashCode(this.id) + (this.type.hashCode() * 31)) * 31)) * 31)) * 31;
        String str = this.askToAskImageUrl;
        int iHashCode2 = (this.projectAccentTextColor.hashCode() + ((this.projectAccentColor.hashCode() + ((iHashCode + (str == null ? 0 : str.hashCode())) * 31)) * 31)) * 31;
