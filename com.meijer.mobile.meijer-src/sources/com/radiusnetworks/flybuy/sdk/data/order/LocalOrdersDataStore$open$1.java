...
public final class LocalOrdersDataStore$open$1 extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super List<? extends Order>>, Object> {
    Object L$0;
    int label;
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ResultKt.b(obj);
                this.$orders.f143742a = this.this$0.db.orderDao$core_defaultRelease().open();
    ...
    public final Object invoke2(InterfaceC15783O interfaceC15783O, Continuation<? super List<Order>> continuation) {
        return ((LocalOrdersDataStore$open$1) create(interfaceC15783O, continuation)).invokeSuspend(Unit.f143329a);
    }
