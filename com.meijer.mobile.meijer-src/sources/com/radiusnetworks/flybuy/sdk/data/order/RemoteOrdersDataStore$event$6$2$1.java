...
public final class RemoteOrdersDataStore$event$6$2$1 extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
    ...
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"Lmv/O;", "", "<anonymous>", "(Lmv/O;)V"}, k = 3, mv = {1, 9, 0})
    @DebugMetadata(c = "com.radiusnetworks.flybuy.sdk.data.order.RemoteOrdersDataStore$event$6$2$1$1", f = "RemoteOrdersDataStore.kt", l = {262}, m = "invokeSuspend")
    ...
    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(InterfaceC15783O interfaceC15783O, Continuation<? super Unit> continuation) {
        return ((RemoteOrdersDataStore$event$6$2$1) create(interfaceC15783O, continuation)).invokeSuspend(Unit.f143329a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ResultKt.b(obj);
            C15809k.d((InterfaceC15783O) this.L$0, null, null, new AnonymousClass1(this.$this_run, this.$orderEventInfo, this.$callback, this.$sdkError, null), 3, null);
            return Unit.f143329a;
        }
        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    }
