...
public final class LocalOrdersDataStoreKt {
    public static final AbstractC6127A<List<Order>> open(AbstractC6127A<List<Order>> abstractC6127A) {
        Intrinsics.j(abstractC6127A, "<this>");
        return b0.d(abstractC6127A, new Function1<List<Order>, List<Order>>() { // from class: com.radiusnetworks.flybuy.sdk.data.order.LocalOrdersDataStoreKt.open.1
