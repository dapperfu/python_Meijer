...
public final class RemoteOrdersDataStore implements RemoteOrdersRepository {
    ...
    public static final class AnonymousClass5 extends Lambda implements Function1<ApiResponse<Unit>, Unit> {
        ...
        public static final void invoke$lambda$1(OrderEventInfo orderEventInfo, AppDatabase db2) {
            ...
            if (orderEventInfo.getEventType() == OrderEventType.PICKUP_TYPE_CHANGE) {
                Order orderFindOrderByOrderId = db2.orderDao$core_defaultRelease().findOrderByOrderId(orderEventInfo.getOrderId());
                String customerCarColor = orderEventInfo.getCustomerCarColor();
                if (customerCarColor != null) {
                    str = customerCarColor;
                } else if (orderFindOrderByOrderId == null || (customer3 = orderFindOrderByOrderId.getCustomer()) == null) {
                    str = null;
                } else {
                    customerCarColor = customer3.getCarColor();
                    str = customerCarColor;
                }
                String customerCarType = orderEventInfo.getCustomerCarType();
                if (customerCarType != null) {
                    str2 = customerCarType;
                } else if (orderFindOrderByOrderId == null || (customer2 = orderFindOrderByOrderId.getCustomer()) == null) {
                    str2 = null;
                } else {
                    customerCarType = customer2.getCarType();
                    str2 = customerCarType;
                }
                String customerLicensePlate = orderEventInfo.getCustomerLicensePlate();
                if (customerLicensePlate != null) {
                    str3 = customerLicensePlate;
                } else if (orderFindOrderByOrderId == null || (customer = orderFindOrderByOrderId.getCustomer()) == null) {
                    str3 = null;
                } else {
                    customerLicensePlate = customer.getLicensePlate();
                    str3 = customerLicensePlate;
                }
                String handoffVehicleLocation2 = orderEventInfo.getHandoffVehicleLocation();
                if (handoffVehicleLocation2 == null) {
                    handoffVehicleLocation = orderFindOrderByOrderId != null ? orderFindOrderByOrderId.getHandoffVehicleLocation() : null;
                } else {
                    handoffVehicleLocation = handoffVehicleLocation2;
                }
                db2.orderDao$core_defaultRelease().updatePickupType(orderEventInfo.getOrderId(), orderEventInfo.getPickupType(), str, str2, str3, handoffVehicleLocation);
            }
        }
    ...
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u0004\u0018\u00010\u0001*\u00020\u0000H\u008a@¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"Lmv/O;", "Lcom/radiusnetworks/flybuy/sdk/data/room/domain/Order;", "<anonymous>", "(Lmv/O;)Lcom/radiusnetworks/flybuy/sdk/data/room/domain/Order;"}, k = 3, mv = {1, 9, 0})
    ...
    public static final class C131512 extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Order>, Object> {
        final /* synthetic */ int $orderId;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C131512(int i10, Continuation<? super C131512> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return RemoteOrdersDataStore.this.new C131512(this.$orderId, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(InterfaceC15783O interfaceC15783O, Continuation<? super Order> continuation) {
            return ((C131512) create(interfaceC15783O, continuation)).invokeSuspend(Unit.f143329a);
        }
    ...
    public static final class C131561 extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        final /* synthetic */ String $token;
        int label;
        final /* synthetic */ RemoteOrdersDataStore this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C131561(String str, RemoteOrdersDataStore remoteOrdersDataStore, Continuation<? super C131561> continuation) {
            super(2, continuation);
            this.$token = str;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C131561(this.$token, this.this$0, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(InterfaceC15783O interfaceC15783O, Continuation<? super Unit> continuation) {
            return ((C131561) create(interfaceC15783O, continuation)).invokeSuspend(Unit.f143329a);
        }
    ...
    public final void sendPermissionState(int orderId) throws Exception {
        ...
        OrdersManager.event$default(FlyBuyCore.getOrders(), new OrderEventInfo(orderId, OrderEventType.PERMISSION_UPDATE, null, null, null, null, null, null, null, locationPermissionStateCurrentLocationPermissionState, null, null, null, null, null, null, null, null, null, null, null, null, 4193788, null), null, 2, null);
    ...
    */
    ...
    public void updatePushToken(String token) {
        ...
        C15809k.d(C15784P.a(C15800f0.b()), null, null, new C131561(token, this, null), 3, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final Object getOrder(int i10, Continuation<? super Order> continuation) {
        return C15805i.g(C15800f0.b(), new C131512(i10, null), continuation);
    }
}
