...
public interface LocalOrdersRepository {
    ...
    AbstractC6127A<List<Order>> getAllLiveData();

    AbstractC6127A<List<BeaconRegion>> getBeaconRegionsForOrder(int orderId);

    List<Order> getOpen();

    AbstractC6127A<List<Order>> getOpenLiveData();

    AbstractC6127A<Order> getOrder(int id2);

    AbstractC6127A<Order> getOrder(String redemptionCode);
