...
public final class CustomerDao_Impl implements CustomerDao {
    ...
    private final AbstractC6266j<Customer> __insertionAdapterOfCustomer;
    ...
    public List<Customer> currentUser() {
        ...
        try {
            ...
            int iE2 = C17823a.e(cursorG, "apiToken");
            int iE3 = C17823a.e(cursorG, "createdAt");
            int iE4 = C17823a.e(cursorG, "updatedAt");
            int iE5 = C17823a.e(cursorG, "deletedAt");
            int iE6 = C17823a.e(cursorG, "email");
            int iE7 = C17823a.e(cursorG, "name");
            int iE8 = C17823a.e(cursorG, "phone");
            int iE9 = C17823a.e(cursorG, "carType");
            int iE10 = C17823a.e(cursorG, "carColor");
            int iE11 = C17823a.e(cursorG, "licensePlate");
    ...
    @Override // com.radiusnetworks.flybuy.sdk.data.room.dao.CustomerDao
    public AbstractC6127A<List<Customer>> getAll() {
        ...
        return this.__db.getInvalidationTracker().m(new String[]{"customers"}, false, new Callable<List<Customer>>() { // from class: com.radiusnetworks.flybuy.sdk.data.room.dao.CustomerDao_Impl.3
            ...
            public List<Customer> call() throws Exception {
                Cursor cursorG = C17824b.g(CustomerDao_Impl.this.__db, nC, false, null);
                try {
                    int iE = C17823a.e(cursorG, PreferencesHelper.PREF_ID);
                    int iE2 = C17823a.e(cursorG, "apiToken");
                    int iE3 = C17823a.e(cursorG, "createdAt");
    ...
    public void insert(Customer customer) {
        ...
        this.__db.beginTransaction();
        try {
            this.__insertionAdapterOfCustomer.insert((AbstractC6266j<Customer>) customer);
            this.__db.setTransactionSuccessful();
        } finally {
            this.__db.endTransaction();
        }
    ...
    public CustomerDao_Impl(G g10) {
        this.__db = g10;
        this.__insertionAdapterOfCustomer = new AbstractC6266j<Customer>(g10) { // from class: com.radiusnetworks.flybuy.sdk.data.room.dao.CustomerDao_Impl.1
