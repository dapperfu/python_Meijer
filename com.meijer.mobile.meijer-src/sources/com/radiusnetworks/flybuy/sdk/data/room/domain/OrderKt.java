...
public final class OrderKt {
    ...
    public static final Order updateOrderWithCustomerInfo(Order order, Customer customer) {
        Intrinsics.j(order, "<this>");
        if (customer != null) {
            if (StringsKt.s0(order.getCustomer().getName())) {
                order.getCustomer().setName(customer.getName());
            }
            if (StringsKt.s0(order.getCustomer().getCarType()) && StringsKt.s0(order.getCustomer().getCarColor())) {
            ...
            if (StringsKt.s0(order.getCustomer().getLicensePlate()) && customer.getLicensePlate() != null) {
