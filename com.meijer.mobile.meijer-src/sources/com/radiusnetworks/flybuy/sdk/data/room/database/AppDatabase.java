...
@Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\b!\u0018\u0000 \u00182\u00020\u0001:\u0001\u0018B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u000f\u0010\u0007\u001a\u00020\u0004H ¢\u0006\u0004\b\u0005\u0010\u0006J\u000f\u0010\u000b\u001a\u00020\bH ¢\u0006\u0004\b\t\u0010\nJ\u000f\u0010\u000f\u001a\u00020\fH ¢\u0006\u0004\b\r\u0010\u000eJ\u000f\u0010\u0013\u001a\u00020\u0010H ¢\u0006\u0004\b\u0011\u0010\u0012J\u000f\u0010\u0017\u001a\u00020\u0014H ¢\u0006\u0004\b\u0015\u0010\u0016¨\u0006\u0019"}, d2 = {"Lcom/radiusnetworks/flybuy/sdk/data/room/database/AppDatabase;", "Landroidx/room/G;", "<init>", "()V", "Lcom/radiusnetworks/flybuy/sdk/data/room/dao/OrderDao;", "orderDao$core_defaultRelease", "()Lcom/radiusnetworks/flybuy/sdk/data/room/dao/OrderDao;", "orderDao", "Lcom/radiusnetworks/flybuy/sdk/data/room/dao/CustomerDao;", "customerDao$core_defaultRelease", "()Lcom/radiusnetworks/flybuy/sdk/data/room/dao/CustomerDao;", "customerDao", "Lcom/radiusnetworks/flybuy/sdk/data/room/dao/BeaconRegionDao;", "beaconRegionDao$core_defaultRelease", "()Lcom/radiusnetworks/flybuy/sdk/data/room/dao/BeaconRegionDao;", "beaconRegionDao", "Lcom/radiusnetworks/flybuy/sdk/data/room/dao/SiteDao;", "siteDao$core_defaultRelease", "()Lcom/radiusnetworks/flybuy/sdk/data/room/dao/SiteDao;", "siteDao", "Lcom/radiusnetworks/flybuy/sdk/data/room/dao/AnalyticsEventsDao;", "analyticsEventsDao$core_defaultRelease", "()Lcom/radiusnetworks/flybuy/sdk/data/room/dao/AnalyticsEventsDao;", "analyticsEventsDao", "Companion", "core_defaultRelease"}, k = 1, mv = {1, 9, 0}, xi = 48)
/* loaded from: classes12.dex */
public abstract class AppDatabase extends G {
    private static final String DB_NAME = "flybuy_core_db";
    private static final String OLD_DB_NAME = "app_db";
    private static AppDatabase instance;

    /* renamed from: Companion, reason: from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);
    private static final AbstractC17349b MIGRATION_10_11 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_10_11$1
    ...
    private static final AbstractC17349b MIGRATION_11_12 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_11_12$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
    ...
    private static final AbstractC17349b MIGRATION_12_13 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_12_13$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
            ...
            a.a(db2, "CREATE TABLE new_beacon_regions (id INTEGER NOT NULL PRIMARY KEY, uuid TEXT NOT NULL, major INTEGER, minor INTEGER, order_id INTEGER NOT NULL)", "INSERT INTO `new_beacon_regions` (`id`, `uuid`, `major`, `minor`, `order_id`) SELECT `id`, `uuid`, `major`, `minor`, `order_id` FROM `beacon_regions`", "DROP TABLE beacon_regions", "DROP TABLE orders");
            a.a(db2, "ALTER TABLE `new_orders_table` RENAME TO `orders`", "CREATE TABLE beacon_regions (id INTEGER NOT NULL PRIMARY KEY, uuid TEXT NOT NULL, major INTEGER, minor INTEGER, order_id INTEGER NOT NULL, FOREIGN KEY(order_id) REFERENCES orders(id) ON DELETE CASCADE)", "INSERT INTO `beacon_regions` (`id`, `uuid`, `major`, `minor`, `order_id`) SELECT `id`, `uuid`, `major`, `minor`, `order_id` FROM `new_beacon_regions`", "DROP TABLE new_beacon_regions");
        }
    };
    private static final AbstractC17349b MIGRATION_13_14 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_13_14$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
            ...
            a.a(db2, "INSERT INTO `new_beacon_regions` (`id`, `uuid`, `major`, `minor`, `order_id`) SELECT `id`, `uuid`, `major`, `minor`, `order_id` FROM `beacon_regions`", "DROP TABLE beacon_regions", "DROP TABLE orders", "ALTER TABLE `new_orders_table` RENAME TO `orders`");
            db2.S("CREATE TABLE beacon_regions (id INTEGER NOT NULL PRIMARY KEY, uuid TEXT NOT NULL, major INTEGER, minor INTEGER, order_id INTEGER NOT NULL, FOREIGN KEY(order_id) REFERENCES orders(id) ON DELETE CASCADE)");
    ...
    private static final AbstractC17349b MIGRATION_14_15 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_14_15$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
    ...
    private static final AbstractC17349b MIGRATION_15_16 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_15_16$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
    ...
    private static final AbstractC17349b MIGRATION_16_17 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_16_17$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
    ...
    private static final AbstractC17349b MIGRATION_17_18 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_17_18$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
    ...
    private static final AbstractC17349b MIGRATION_18_19 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_18_19$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
            ...
            db2.S("CREATE TABLE new_beacon_regions (id INTEGER NOT NULL PRIMARY KEY, uuid TEXT NOT NULL, major INTEGER, minor INTEGER, order_id INTEGER NOT NULL)");
            a.a(db2, "INSERT INTO `new_beacon_regions` (`id`, `uuid`, `major`, `minor`, `order_id`) SELECT `id`, `uuid`, `major`, `minor`, `order_id` FROM `beacon_regions`", "DROP TABLE beacon_regions", "DROP TABLE orders", "ALTER TABLE `new_orders_table` RENAME TO `orders`");
            a.a(db2, "CREATE TABLE beacon_regions (id INTEGER NOT NULL PRIMARY KEY, uuid TEXT NOT NULL, major INTEGER, minor INTEGER, order_id INTEGER NOT NULL, FOREIGN KEY(order_id) REFERENCES orders(id) ON DELETE CASCADE)", "INSERT INTO `beacon_regions` (`id`, `uuid`, `major`, `minor`, `order_id`) SELECT `id`, `uuid`, `major`, `minor`, `order_id` FROM `new_beacon_regions`", "DROP TABLE new_beacon_regions", "CREATE TABLE new_sites_table (id INTEGER NOT NULL PRIMARY KEY, name TEXT, phone TEXT, streetAddress TEXT, fullAddress TEXT, locality TEXT, region TEXT, country TEXT, postalCode TEXT, latitude TEXT, longitude TEXT, coverPhotoUrl TEXT, iconUrl TEXT, instructions TEXT, description TEXT, partnerIdentifier TEXT, geofence_latitude TEXT, geofence_longitude TEXT, geofence_radius REAL)");
    ...
    private static final AbstractC17349b MIGRATION_19_20 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_19_20$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
            ...
            a.a(db2, "UPDATE `orders` SET newCustomerState = CASE customerState WHEN 0 THEN 'created' WHEN 1 THEN 'en_route' WHEN 2 THEN 'nearby' WHEN 3 THEN 'arrived' WHEN 4 THEN 'waiting' ELSE 'completed' END", "CREATE TABLE `new_orders_table` (`id` INTEGER NOT NULL, `type` TEXT, `createdAt` TEXT NOT NULL, `arrivedAt` TEXT, `updatedAt` TEXT NOT NULL, `redeemedAt` TEXT, `customerState` TEXT NOT NULL DEFAULT 'created', `state` TEXT NOT NULL DEFAULT 'created', `etaAt` TEXT, `displayName` TEXT, `displayDetail` TEXT, `partnerIdentifier` TEXT, `redemptionCode` TEXT, `customerId` TEXT, `pickupType` TEXT, `customerRatingValue` INTEGER, `customerRatingComments` TEXT, `pushToken` TEXT, `alwaysShowVehicleInfoFields` INTEGER NOT NULL DEFAULT 0, `customerNameEditingEnabled` INTEGER NOT NULL DEFAULT 0, `pickupTypeSelectionEnabled` INTEGER NOT NULL DEFAULT 0, `requireVehicleInfoIfVisible` INTEGER NOT NULL DEFAULT 0, `curbsideLocalizedString` TEXT, `pickupLocalizedString` TEXT, `pickup_window_start` TEXT, `pickup_window_end` TEXT, `site_id` INTEGER NOT NULL, `site_name` TEXT, `site_phone` TEXT, `site_streetAddress` TEXT, `site_fullAddress` TEXT, `site_locality` TEXT, `site_region` TEXT, `site_country` TEXT, `site_postalCode` TEXT, `site_latitude` TEXT, `site_longitude` TEXT, `site_coverPhotoUrl` TEXT, `site_iconUrl` TEXT, `site_instructions` TEXT, `site_description` TEXT, `site_partnerIdentifier` TEXT, `site_geofence_latitude` REAL DEFAULT 0, `site_geofence_longitude` REAL DEFAULT 0, `site_geofence_radius` REAL DEFAULT 0, `customer_name` TEXT NOT NULL, `customer_phone` TEXT, `customer_carType` TEXT NOT NULL, `customer_carColor` TEXT NOT NULL, `customer_licensePlate` TEXT NOT NULL, PRIMARY KEY(`id`))", "INSERT INTO `new_orders_table` (`id`, `type`, `createdAt`, `arrivedAt`, `updatedAt`, `redeemedAt`, `customerState`, `state`, `etaAt`, `displayName`, `displayDetail`, `partnerIdentifier`, `redemptionCode`, `customerId`, `pickup_window_start`, `pickup_window_end`, `pickupType`, `site_id`, `site_name`, `site_phone`, `site_streetAddress`, `site_fullAddress`, `site_locality`, `site_region`, `site_country`, `site_postalCode`, `site_latitude`, `site_longitude`, `site_coverPhotoUrl`, `site_iconUrl`, `site_instructions`, `site_description`, `site_geofence_latitude`, `site_geofence_longitude`, `site_geofence_radius`, `customer_name`, `customer_phone`, `customer_carType`, `customer_carColor`, `customer_licensePlate`, `pushToken`, `alwaysShowVehicleInfoFields`, `customerNameEditingEnabled`, `pickupTypeSelectionEnabled`, `requireVehicleInfoIfVisible`, `curbsideLocalizedString`, `pickupLocalizedString`) SELECT `id`, `type`, `createdAt`, `arrivedAt`, `updatedAt`, `redeemedAt`, `newCustomerState`, `newState`, `etaAt`, `displayName`, `displayDetail`, `partnerIdentifier`, `redemptionCode`, `customerId`, `pickup_window_start`, `pickup_window_end`, `pickupType`, `site_id`, `site_name`, `site_phone`, `site_streetAddress`, `site_fullAddress`, `site_locality`, `site_region`, `site_country`, `site_postalCode`, `site_latitude`, `site_longitude`, `site_coverPhotoUrl`, `site_iconUrl`, `site_instructions`, `site_description`, `site_geofence_latitude`, `site_geofence_longitude`, `site_geofence_radius`, `customer_name`, `customer_phone`, `customer_carType`, `customer_carColor`, `customer_licensePlate`, `pushToken`, `alwaysShowVehicleInfoFields`, `customerNameEditingEnabled`, `pickupTypeSelectionEnabled`, `requireVehicleInfoIfVisible`, `curbsideLocalizedString`, `pickupLocalizedString` FROM `orders`", "CREATE TABLE new_beacon_regions (id INTEGER NOT NULL PRIMARY KEY, uuid TEXT NOT NULL, major INTEGER, minor INTEGER, order_id INTEGER NOT NULL)");
            a.a(db2, "INSERT INTO `new_beacon_regions` (`id`, `uuid`, `major`, `minor`, `order_id`) SELECT `id`, `uuid`, `major`, `minor`, `order_id` FROM `beacon_regions`", "DROP TABLE beacon_regions", "DROP TABLE orders", "ALTER TABLE `new_orders_table` RENAME TO `orders`");
    ...
    private static final AbstractC17349b MIGRATION_20_21 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_20_21$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
    ...
    private static final AbstractC17349b MIGRATION_21_22 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_21_22$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
    ...
    private static final AbstractC17349b MIGRATION_22_23 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_22_23$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
    ...
    private static final AbstractC17349b MIGRATION_23_24 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_23_24$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
    ...
    private static final AbstractC17349b MIGRATION_24_25 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_24_25$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
    ...
    private static final AbstractC17349b MIGRATION_25_26 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_25_26$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
    ...
    private static final AbstractC17349b MIGRATION_26_27 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_26_27$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
    ...
    private static final AbstractC17349b MIGRATION_27_28 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_27_28$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
    ...
    private static final AbstractC17349b MIGRATION_28_29 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_28_29$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
    ...
    private static final AbstractC17349b MIGRATION_29_30 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_29_30$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
    ...
    private static final AbstractC17349b MIGRATION_30_31 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_30_31$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
    ...
    private static final AbstractC17349b MIGRATION_31_32 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_31_32$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
    ...
    private static final AbstractC17349b MIGRATION_32_33 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_32_33$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
    ...
    private static final AbstractC17349b MIGRATION_33_34 = new AbstractC17349b() { // from class: com.radiusnetworks.flybuy.sdk.data.room.database.AppDatabase$Companion$MIGRATION_33_34$1
        @Override // u4.AbstractC17349b
        public void migrate(c db2) throws SQLException {
            Intrinsics.j(db2, "db");
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void getMIGRATION_34_35$annotations() {
        }

        private Companion() {
        }

        private final void renameOldDatabaseFilesIfExist(Context appContext) {
            if (appContext.getDatabasePath(AppDatabase.OLD_DB_NAME).exists()) {
                String[] strArrDatabaseList = appContext.databaseList();
                Intrinsics.i(strArrDatabaseList, "databaseList(...)");
                ArrayList<String> arrayList = new ArrayList();
                for (String str : strArrDatabaseList) {
                    Intrinsics.g(str);
                    if (StringsKt.W(str, AppDatabase.OLD_DB_NAME, false, 2, null)) {
                        arrayList.add(str);
                    }
                }
                for (String str2 : arrayList) {
                    File databasePath = appContext.getDatabasePath(str2);
                    if (databasePath.exists()) {
                        Intrinsics.g(str2);
                        databasePath.renameTo(new File(databasePath.getParent(), StringsKt.Q(str2, AppDatabase.OLD_DB_NAME, AppDatabase.DB_NAME, false, 4, null)));
                    }
                }
            }
        }
        ...
        public final AppDatabase init(Context context) {
            ...
            try {
                ...
                if (SQLiteDatabase.deleteDatabase(context.getDatabasePath(AppDatabase.OLD_DB_NAME))) {
                    AppDatabase.instance = buildDatabase(context);
                    AppDatabase appDatabase3 = AppDatabase.instance;
                    Intrinsics.g(appDatabase3);
                    appDatabase3.getOpenHelper().C2();
                }
            }
        ...
        private final AppDatabase buildDatabase(Context context) {
            renameOldDatabaseFilesIfExist(context);
            Context applicationContext = context.getApplicationContext();
            Intrinsics.i(applicationContext, "getApplicationContext(...)");
            return (AppDatabase) C6278w.a(applicationContext, AppDatabase.class, AppDatabase.DB_NAME).b(getMIGRATION_10_11()).b(getMIGRATION_11_12()).b(getMIGRATION_12_13()).b(getMIGRATION_13_14()).b(getMIGRATION_14_15()).b(getMIGRATION_15_16()).b(getMIGRATION_16_17()).b(getMIGRATION_17_18()).b(getMIGRATION_18_19()).b(getMIGRATION_19_20()).b(getMIGRATION_20_21()).b(getMIGRATION_21_22()).b(getMIGRATION_22_23()).b(getMIGRATION_23_24()).b(getMIGRATION_24_25()).b(getMIGRATION_25_26()).b(getMIGRATION_26_27()).b(getMIGRATION_27_28()).b(getMIGRATION_28_29()).b(getMIGRATION_29_30()).b(getMIGRATION_30_31()).b(getMIGRATION_31_32()).b(getMIGRATION_32_33()).b(getMIGRATION_33_34()).b(getMIGRATION_34_35()).e().d();
        }

        public final AbstractC17349b getMIGRATION_10_11() {
            return AppDatabase.MIGRATION_10_11;
        }

        public final AbstractC17349b getMIGRATION_11_12() {
            return AppDatabase.MIGRATION_11_12;
        }

        public final AbstractC17349b getMIGRATION_12_13() {
            return AppDatabase.MIGRATION_12_13;
        }

        public final AbstractC17349b getMIGRATION_13_14() {
            return AppDatabase.MIGRATION_13_14;
        }

        public final AbstractC17349b getMIGRATION_14_15() {
            return AppDatabase.MIGRATION_14_15;
        }

        public final AbstractC17349b getMIGRATION_15_16() {
            return AppDatabase.MIGRATION_15_16;
        }

        public final AbstractC17349b getMIGRATION_16_17() {
            return AppDatabase.MIGRATION_16_17;
        }

        public final AbstractC17349b getMIGRATION_17_18() {
            return AppDatabase.MIGRATION_17_18;
        }

        public final AbstractC17349b getMIGRATION_18_19() {
            return AppDatabase.MIGRATION_18_19;
        }

        public final AbstractC17349b getMIGRATION_19_20() {
            return AppDatabase.MIGRATION_19_20;
        }

        public final AbstractC17349b getMIGRATION_20_21() {
            return AppDatabase.MIGRATION_20_21;
        }

        public final AbstractC17349b getMIGRATION_21_22() {
            return AppDatabase.MIGRATION_21_22;
        }

        public final AbstractC17349b getMIGRATION_22_23() {
            return AppDatabase.MIGRATION_22_23;
        }

        public final AbstractC17349b getMIGRATION_23_24() {
            return AppDatabase.MIGRATION_23_24;
        }

        public final AbstractC17349b getMIGRATION_24_25() {
            return AppDatabase.MIGRATION_24_25;
        }

        public final AbstractC17349b getMIGRATION_25_26() {
            return AppDatabase.MIGRATION_25_26;
        }

        public final AbstractC17349b getMIGRATION_26_27() {
            return AppDatabase.MIGRATION_26_27;
        }

        public final AbstractC17349b getMIGRATION_27_28() {
            return AppDatabase.MIGRATION_27_28;
        }

        public final AbstractC17349b getMIGRATION_28_29() {
            return AppDatabase.MIGRATION_28_29;
        }

        public final AbstractC17349b getMIGRATION_29_30() {
            return AppDatabase.MIGRATION_29_30;
        }

        public final AbstractC17349b getMIGRATION_30_31() {
            return AppDatabase.MIGRATION_30_31;
        }

        public final AbstractC17349b getMIGRATION_31_32() {
            return AppDatabase.MIGRATION_31_32;
        }

        public final AbstractC17349b getMIGRATION_32_33() {
            return AppDatabase.MIGRATION_32_33;
        }

        public final AbstractC17349b getMIGRATION_33_34() {
            return AppDatabase.MIGRATION_33_34;
        }

        public final AbstractC17349b getMIGRATION_34_35() {
            return AppDatabase.MIGRATION_34_35;
        }
    }

    public abstract AnalyticsEventsDao analyticsEventsDao$core_defaultRelease();
