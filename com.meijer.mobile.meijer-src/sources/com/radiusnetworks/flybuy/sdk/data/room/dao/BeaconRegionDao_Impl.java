...
public final class BeaconRegionDao_Impl implements BeaconRegionDao {
    ...
    private final AbstractC6264h<BeaconRegion> __deletionAdapterOfBeaconRegion;
    private final AbstractC6266j<BeaconRegion> __insertionAdapterOfBeaconRegion;
    ...
    public List<BeaconRegion> findBeaconRegionsForOrder(int i10) {
        ...
        try {
            int iE = C17823a.e(cursorG, "uuid");
            int iE2 = C17823a.e(cursorG, "major");
            int iE3 = C17823a.e(cursorG, "minor");
            int iE4 = C17823a.e(cursorG, NotificationsManager.INTENT_EXTRA_ORDER_ID);
            int iE5 = C17823a.e(cursorG, PreferencesHelper.PREF_ID);
    ...
    @Override // com.radiusnetworks.flybuy.sdk.data.room.dao.BeaconRegionDao
    public AbstractC6127A<List<BeaconRegion>> getAll() {
        ...
        return this.__db.getInvalidationTracker().m(new String[]{"beacon_regions"}, false, new Callable<List<BeaconRegion>>() { // from class: com.radiusnetworks.flybuy.sdk.data.room.dao.BeaconRegionDao_Impl.4
            ...
            public List<BeaconRegion> call() throws Exception {
                Cursor cursorG = C17824b.g(BeaconRegionDao_Impl.this.__db, nC, false, null);
                try {
                    int iE = C17823a.e(cursorG, "uuid");
                    int iE2 = C17823a.e(cursorG, "major");
                    int iE3 = C17823a.e(cursorG, "minor");
    ...
    @Override // com.radiusnetworks.flybuy.sdk.data.room.dao.BeaconRegionDao
    public AbstractC6127A<List<BeaconRegion>> getBeaconRegionsForOrder(int i10) {
    ...
    @Override // com.radiusnetworks.flybuy.sdk.data.room.dao.BeaconRegionDao
    public AbstractC6127A<List<OrderAndBeaconRegions>> getOrderAndBeaconRegions() {
    ...
    public BeaconRegionDao_Impl(G g10) {
        this.__db = g10;
        this.__insertionAdapterOfBeaconRegion = new AbstractC6266j<BeaconRegion>(g10) { // from class: com.radiusnetworks.flybuy.sdk.data.room.dao.BeaconRegionDao_Impl.1
        ...
        this.__deletionAdapterOfBeaconRegion = new AbstractC6264h<BeaconRegion>(g10) { // from class: com.radiusnetworks.flybuy.sdk.data.room.dao.BeaconRegionDao_Impl.2
    ...
    public void __fetchRelationshipbeaconRegionsAscomRadiusnetworksFlybuySdkDataRoomDomainBeaconRegion(C<ArrayList<BeaconRegion>> c10) {
        ...
        if (c10.m() > 999) {
            C17832j.c(c10, true, new Function1() { // from class: com.radiusnetworks.flybuy.sdk.data.room.dao.a
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return this.f120939a.lambda$__fetchRelationshipbeaconRegionsAscomRadiusnetworksFlybuySdkDataRoomDomainBeaconRegion$0((C) obj);
                }
            });
            return;
        }
        ...
        Cursor cursorG = C17824b.g(this.__db, nC, false, null);
        try {
            int iD = C17823a.d(cursorG, NotificationsManager.INTENT_EXTRA_ORDER_ID);
            if (iD == -1) {
                cursorG.close();
                return;
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Unit lambda$__fetchRelationshipbeaconRegionsAscomRadiusnetworksFlybuySdkDataRoomDomainBeaconRegion$0(C c10) {
        __fetchRelationshipbeaconRegionsAscomRadiusnetworksFlybuySdkDataRoomDomainBeaconRegion(c10);
