...
public final class SiteDao_Impl implements SiteDao {
    ...
    private final AbstractC6266j<Site> __insertionAdapterOfSite;
    private final S __preparedStmtOfDeleteAll;
    private final RoomConverters __roomConverters = new RoomConverters();
    private final AbstractC6264h<Site> __updateAdapterOfSite;
    ...
    public List<Site> all() throws Throwable {
        ...
        try {
            ...
            int iE3 = C17823a.e(cursorG, "phone");
            int iE4 = C17823a.e(cursorG, "streetAddress");
            int iE5 = C17823a.e(cursorG, "fullAddress");
            int iE6 = C17823a.e(cursorG, PlaceTypes.LOCALITY);
            int iE7 = C17823a.e(cursorG, "region");
            int iE8 = C17823a.e(cursorG, PlaceTypes.COUNTRY);
            int iE9 = C17823a.e(cursorG, "postalCode");
            int iE10 = C17823a.e(cursorG, "latitude");
            int iE11 = C17823a.e(cursorG, "longitude");
            int iE12 = C17823a.e(cursorG, "coverPhotoUrl");
            int iE13 = C17823a.e(cursorG, "iconUrl");
            n10 = nC;
            try {
                int iE14 = C17823a.e(cursorG, "instructions");
                int iE15 = C17823a.e(cursorG, "description");
                int iE16 = C17823a.e(cursorG, "partnerIdentifier");
                int iE17 = C17823a.e(cursorG, "wrongSiteArrivalRadius");
                int iE18 = C17823a.e(cursorG, "operationalStatus");
                int iE19 = C17823a.e(cursorG, "prearrivalSeconds");
                int iE20 = C17823a.e(cursorG, "pickupConfig");
                int iE21 = C17823a.e(cursorG, "geofence_latitude");
                int iE22 = C17823a.e(cursorG, "geofence_longitude");
                int iE23 = C17823a.e(cursorG, "geofence_radius");
                int i18 = iE14;
    ...
    @Override // com.radiusnetworks.flybuy.sdk.data.room.dao.SiteDao
    public AbstractC6127A<List<Site>> allLiveData() {
        ...
        return this.__db.getInvalidationTracker().m(new String[]{"sites"}, false, new Callable<List<Site>>() { // from class: com.radiusnetworks.flybuy.sdk.data.room.dao.SiteDao_Impl.4
            ...
            public List<Site> call() throws Exception {
                ...
                int i17;
                CircularRegion circularRegion;
                Cursor cursorG = C17824b.g(SiteDao_Impl.this.__db, nC, false, null);
                try {
                    int iE = C17823a.e(cursorG, PreferencesHelper.PREF_ID);
                    int iE2 = C17823a.e(cursorG, "name");
                    int iE3 = C17823a.e(cursorG, "phone");
    ...
    public SiteDao_Impl(G g10) {
        this.__db = g10;
        this.__insertionAdapterOfSite = new AbstractC6266j<Site>(g10) { // from class: com.radiusnetworks.flybuy.sdk.data.room.dao.SiteDao_Impl.1
        ...
        this.__updateAdapterOfSite = new AbstractC6264h<Site>(g10) { // from class: com.radiusnetworks.flybuy.sdk.data.room.dao.SiteDao_Impl.2
