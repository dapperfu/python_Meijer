...
public interface OrderDao {
    ...
    AbstractC6127A<List<Order>> allLiveData();
    ...
    AbstractC6127A<Order> getOrderById(int orderId);

    AbstractC6127A<Order> getOrderByRedemptionCode(String redemptionCode);

    AbstractC6127A<List<Order>> getUnclaimed();
    ...
    AbstractC6127A<List<Order>> openLiveData();
    ...
    int updatePickupType(int orderId, String pickupType, String customerCarColor, String customerCarType, String customerLicensePlate, String handoffVehicleLocation);
