...
public final class LocationWithBeaconUpdateKt {
    ...
    public static final OrderEventInfo toApiOrderEvent(LocationWithBeaconUpdate locationWithBeaconUpdate, int i10, Integer num, Integer num2, String str) {
        ...
        return new OrderEventInfo(i10, orderEventType, Double.valueOf(longitude), Double.valueOf(latitude), Float.valueOf(accuracy), Float.valueOf(speed), num2, null, locationWithBeaconUpdate.getBeacons(), null, null, null, null, null, num, str, locationWithBeaconUpdate.getLocationAt(), null, null, null, null, null, 4079232, null);
    }
