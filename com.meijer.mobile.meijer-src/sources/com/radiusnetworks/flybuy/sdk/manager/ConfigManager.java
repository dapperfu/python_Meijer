...
public final class ConfigManager {
    ...
    public final void fetch(final FlybuyPushData pushData, final Function2<? super SdkConfig, ? super SdkError, Unit> callback) throws Exception {
        ...
        this.configOperation.getAppResponse$core_defaultRelease(Intrinsics.e(messageType, FlybuyPushData.MESSAGE_TYPE_BACKGROUND_SYNC) && Intrinsics.e(pushData.getForceSyncAppConfig(), Boolean.TRUE), new Function2<AppInstanceResponse, SdkError, Unit>() { // from class: com.radiusnetworks.flybuy.sdk.manager.ConfigManager$fetch$1$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(AppInstanceResponse appInstanceResponse, SdkError sdkError) {
                invoke2(appInstanceResponse, sdkError);
                return Unit.f143329a;
            }

            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(AppInstanceResponse appInstanceResponse, SdkError sdkError) {
                AppData data;
                ...
                synchronized (sdkConfig) {
                    if (sdkError == null && appInstanceResponse != null) {
                        try {
                            flyBuyCore.setSdkConfig$core_defaultRelease(SdkConfigKt.toSdkConfig(appInstanceResponse.getData()));
                            ...
                            if (pushToken != null) {
                                configManager.updateAppInstance$core_defaultRelease(pushToken);
                            }
                            ...
                            synchronized (configManager.configSubscribers) {
                                try {
                                    ...
                                    while (it.hasNext()) {
                                        ((InterfaceC6131E) it.next()).onChanged(new Pair(FlyBuyCore.INSTANCE.getSdkConfig(), flybuyPushData));
                                    }
                ...
                if (function2 != null) {
                    function2.invoke((appInstanceResponse == null || (data = appInstanceResponse.getData()) == null) ? null : SdkConfigKt.toSdkConfig(data), sdkError);
                }
            }
        });
    }
    ...
    public final void addConfigChangeListener(InterfaceC6131E<Pair<SdkConfig, FlybuyPushData>> observer) throws Exception {
    ...
    public final void removeConfigChangeListener(InterfaceC6131E<Pair<SdkConfig, FlybuyPushData>> observer) throws Exception {
        Intrinsics.j(observer, "observer");
        try {
            synchronized (this.configSubscribers) {
