...
public final class PickupManager {
    ...
    private final InterfaceC6131E<Object> locationPermissionRegisterObserver;
    private final InterfaceC6131E<Object> locationPermissionUnregisterObserver;
    ...
    private final InterfaceC6131E<List<Order>> ordersObserver;
    ...
    private PickupManager(Unit unit) {
        this.ordersObserver = new InterfaceC6131E() { // from class: com.radiusnetworks.flybuy.sdk.pickup.a
            @Override // androidx.view.InterfaceC6131E
            public final void onChanged(Object obj) {
                PickupManager.ordersObserver$lambda$0(this.f120961a, (List) obj);
            }
        };
        this.locationServicesStateReceiver = new l(this);
        this.locationPermissionRegisterObserver = new InterfaceC6131E() { // from class: com.radiusnetworks.flybuy.sdk.pickup.b
            @Override // androidx.view.InterfaceC6131E
            public final void onChanged(Object obj) {
                PickupManager.locationPermissionRegisterObserver$lambda$2(this.f120962a, obj);
            }
        };
        this.locationPermissionUnregisterObserver = new InterfaceC6131E() { // from class: com.radiusnetworks.flybuy.sdk.pickup.c
            @Override // androidx.view.InterfaceC6131E
            public final void onChanged(Object obj) {
                PickupManager.locationPermissionUnregisterObserver$lambda$4(this.f120963a, obj);
            }
        };
    ...
    public final void configure(Context context) throws Exception {
        ...
        try {
            synchronized (this) {
                ...
                ETACalculator.INSTANCE.configure(applicationInfo.metaData.getString("com.google.android.geo.API_KEY"), Clock.systemDefaultZone());
            ...
            FlyBuyCore flyBuyCore2 = FlyBuyCore.INSTANCE;
            flyBuyCore2.getCrashManager().log("catchAndThrow caught exception");
            flyBuyCore2.getCrashManager().reportCrash(e10);
            throw e10;
        }
    }
