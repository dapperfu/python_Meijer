...
public final class s {
    ...
    public static final s f63286a = new s();

    @JvmStatic
    public static final boolean a(String fileName) {
        try {
            File fileO = K.f().e().o();
            if (fileO != null && !g6.i.a(fileName)) {
                return SQLiteDatabase.deleteDatabase(new File(fileO, fileName));
            }
            return false;
        } catch (Exception e10) {
            R5.t.a("Campaign", "FileUtils", "Failed to delete (%s) in cache folder, exception occurred: (%s)", fileName, e10.getLocalizedMessage());
            return false;
        }
    }
    ...
    public static final boolean c(File zipFile, String outputDirectoryPath) {
        ...
        if (!file.exists() && !file.mkdir()) {
            R5.t.a("Campaign", "FileUtils", "Could not create the output directory " + outputDirectoryPath, new Object[0]);
            return false;
        }
        try {
            ...
            try {
                ...
                if (nextEntry == null) {
                    R5.t.a("Campaign", "FileUtils", "Zip file was invalid", new Object[0]);
                ...
                while (nextEntry != null && zD) {
                    ...
                    if (!StringsKt.W(canonicalPath, outputFolderCanonicalPath, false, 2, null)) {
                        R5.t.a("Campaign", "FileUtils", "The zip file contained an invalid path. Verify that your zip file is formatted correctly and has not been tampered with.", new Object[0]);
                        CloseableKt.a(zipInputStream, null);
                        return false;
                    }
                    if (nextEntry.isDirectory()) {
                        ...
                        if (parentFile == null || !(parentFile.exists() || parentFile.mkdirs())) {
                            R5.t.a("Campaign", "FileUtils", "Could not extract the file " + file2.getAbsolutePath(), new Object[0]);
                            CloseableKt.a(zipInputStream, null);
                            return false;
                        }
            ...
            R5.t.a("Campaign", "FileUtils", "Extraction failed - " + e10, new Object[0]);
            return false;
        }
    }
    ...
    public static final boolean d(File file, InputStream inputStream, boolean append) {
        ...
        try {
            ...
            sb2.append(e10);
            sb2.append(')');
            R5.t.a("Campaign", "FileUtils", sb2.toString(), new Object[0]);
            return false;
        }
    }
