...
public final class g {
    ...
    private D privacyStatus = a.C1236a.f62895a.a();
    ...
    private final void b(Map<String, ? extends Object> assuranceInfo) {
        this.isAssuranceSessionActive = !g6.i.a(C14328a.o(assuranceInfo, "sessionid", null));
    }

    private final void c(Map<String, ? extends Object> configuration) {
        this.host = C14328a.o(configuration, "analytics.server", null);
        this.rsids = C14328a.o(configuration, "analytics.rsids", null);
        this.isAnalyticsForwardingEnabled = C14328a.l(configuration, "analytics.aamForwardingEnabled", false);
        this.isOfflineTrackingEnabled = C14328a.l(configuration, "analytics.offlineEnabled", false);
        this.batchLimit = C14328a.m(configuration, "analytics.batchLimit", 0);
        int iM = C14328a.m(configuration, "analytics.launchHitDelay", 0);
        if (iM >= 0) {
            this.referrerTimeout = iM;
        }
        this.marketingCloudOrganizationID = C14328a.o(configuration, "experienceCloud.org", null);
        this.isBackdateSessionInfoEnabled = C14328a.l(configuration, "analytics.backdatePreviousSessionInfo", false);
        D dB = D.b(C14328a.o(configuration, "global.privacy", a.C1236a.f62895a.a().e()));
        Intrinsics.i(dB, "fromString(\n            …)\n            )\n        )");
        this.privacyStatus = dB;
        this.sessionTimeout = C14328a.m(configuration, "lifecycle.sessionTimeout", 300000);
    }

    private final void d(Map<String, ? extends Object> identityInfo) {
        this.marketingCloudId = C14328a.o(identityInfo, "mid", null);
        this.blob = C14328a.o(identityInfo, "blob", null);
        this.locationHint = C14328a.o(identityInfo, "locationhint", null);
        this.advertisingIdentifier = C14328a.o(identityInfo, "advertisingidentifier", null);
        if (identityInfo.containsKey("visitoridslist")) {
            try {
                this.serializedVisitorIDsList = f.INSTANCE.b(C14328a.i(Object.class, identityInfo, "visitoridslist"));
    ...
    private final void e(Map<String, ? extends Object> lifecycleData) {
        this.lifecycleSessionStartTimestamp = C14328a.n(lifecycleData, "starttimestampmillis", 0L);
        this.lifecycleMaxSessionLength = C14328a.n(lifecycleData, "maxsessionlength", 0L);
        Map mapT = C14328a.t(String.class, lifecycleData, "lifecyclecontextdata", null);
    ...
    private final void f(Map<String, ? extends Object> placesInfo) {
        Map mapT = C14328a.t(Object.class, placesInfo, "currentpoi", null);
        if (mapT == null) {
            return;
        }
    ...
    public final Map<String, String> g() {
        ...
        if (!g6.i.a(this.marketingCloudId)) {
    ...
    public final boolean s() {
        return (g6.i.a(this.rsids) || g6.i.a(this.host)) ? false : true;
    }
    ...
    public final boolean y() {
        return !g6.i.a(this.marketingCloudOrganizationID);
    }
