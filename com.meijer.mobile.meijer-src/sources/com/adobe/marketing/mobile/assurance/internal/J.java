...
public final class J {
    ...
    private final Map<String, List<C6555l>> queue;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC6543a<C6555l> notifier;
    ...
    public static final class Companion {
        ...
        public final boolean a(C6555l event) {
            ...
            Map<String, Object> map = event.f63117d;
            if (map == null) {
                return false;
            }
            return (((String) map.get("chunkId")) == null || ((Integer) event.f63117d.get("chunkSequenceNumber")) == null) ? false : true;
        }
    }
    ...
    public static final class b<T> implements Comparator {
        ...
        public final int compare(T t10, T t11) {
            Object obj = ((C6555l) t10).f63117d.get("chunkSequenceNumber");
            Intrinsics.h(obj, "null cannot be cast to non-null type kotlin.Int");
            Object obj2 = ((C6555l) t11).f63117d.get("chunkSequenceNumber");
    ...
    public J(InterfaceC6543a<C6555l> notifier) {
        this(new LinkedHashMap(), notifier);
        Intrinsics.j(notifier, "notifier");
    }

    public J(Map<String, List<C6555l>> queue, InterfaceC6543a<C6555l> notifier) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    @JvmName
    public final void a(C6555l event) {
        Integer num;
        Intrinsics.j(event, "event");
        if (!INSTANCE.a(event)) {
        ...
        String str = (String) event.f63117d.get("chunkId");
        if (str == null || (num = (Integer) event.f63117d.get("chunkTotal")) == null) {
            return;
        }
        int iIntValue = num.intValue();
        List<C6555l> arrayList = this.queue.get(str);
        if (arrayList == null) {
        ...
        W<C6555l, Exception> wB = b(arrayList);
        if (wB instanceof W.b) {
            this.notifier.a(((W.b) wB).a());
        } else if (wB instanceof W.a) {
            R5.t.b("Assurance", "EventStitcher", "Failed to stitch events for chunkId: " + str + " due to: " + ((Exception) ((W.a) wB).a()).getMessage(), new Object[0]);
        }
        this.queue.remove(str);
    }

    public final W<C6555l, Exception> b(List<C6555l> chunkedEvents) {
        Intrinsics.j(chunkedEvents, "chunkedEvents");
        if (chunkedEvents.isEmpty()) {
            return new W.a(new Exception("No events to stitch"));
        }
        R5.t.e("Assurance", "EventStitcher", "Stitching " + chunkedEvents.size() + " events", new Object[0]);
        if (chunkedEvents.size() > 1) {
            CollectionsKt.B(chunkedEvents, new b());
        }
        String strC = chunkedEvents.get(0).c();
        String str = chunkedEvents.get(0).f63115b;
        long j10 = chunkedEvents.get(0).f63119f;
        StringBuilder sb2 = new StringBuilder();
        Iterator<T> it = chunkedEvents.iterator();
        while (it.hasNext()) {
            String str2 = (String) ((C6555l) it.next()).f63118e.get("chunkData");
            if (str2 != null) {
        ...
        try {
            return new W.b(new C6555l(str, strC, null, C14330c.e(new JSONObject(sb2.toString())), j10));
