...
public final class D {
    ...
    private final AssuranceSharedState c() {
        R5.v vVar = this.assuranceDataStore;
        if (vVar == null) {
        ...
        R5.t.a("Assurance", "AssuranceSharedStateManager", "Assurance state loaded, sessionID : " + persistedSessionId + " and clientId " + persistedClientId + " from persistence.", new Object[0]);
    ...
    private final void d(AssuranceSharedState stateToPersist) {
        if (this.assuranceDataStore == null) {
            R5.t.f("Assurance", "AssuranceSharedStateManager", "Assurance datastore is null, unable to persist assurance state.", new Object[0]);
            return;
        }
        if (StringsKt.s0(stateToPersist.getClientId())) {
            this.assuranceDataStore.remove("clientid");
        } else {
            this.assuranceDataStore.d("clientid", stateToPersist.getClientId());
        }
        if (StringsKt.s0(stateToPersist.getSessionId())) {
    ...
    private final AssuranceSharedState a(AssuranceSharedState persistedState) {
        if (persistedState.getClientId().length() == 0) {
            R5.t.f("Assurance", "AssuranceSharedStateManager", "Assurance clientId persisted is empty, generating a new one.", new Object[0]);
