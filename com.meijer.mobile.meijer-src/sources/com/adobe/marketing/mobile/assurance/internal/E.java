...
public final class E {
    ...
    private C6574h lastSDKEvent;

    /* JADX WARN: Illegal instructions before constructor call */
    public E(AbstractC6579m extensionApi) {
        Intrinsics.j(extensionApi, "extensionApi");
        InterfaceC5121h interfaceC5121hD = R5.K.f().d();
        Intrinsics.i(interfaceC5121hD, "getInstance().dataStoreService");
        this(extensionApi, new D(interfaceC5121hD));
    }

    public E(AbstractC6579m extensionApi, D assuranceSharedStateManager) {
        Intrinsics.j(extensionApi, "extensionApi");
    ...
    private final List<C6555l> g(String stateOwner, String eventName) {
        ArrayList arrayList = new ArrayList();
        AbstractC6579m abstractC6579m = this.extensionApi;
        C6574h c6574h = this.lastSDKEvent;
        com.adobe.marketing.mobile.F f10 = com.adobe.marketing.mobile.F.ANY;
        com.adobe.marketing.mobile.H hE = abstractC6579m.e(stateOwner, c6574h, false, f10);
        if (h(hE)) {
    ...
    private final C6555l j(String owner, String eventName, Map<String, ? extends Object> stateContent, String stateType) {
    ...
    private final String l(String content) {
        try {
            ...
            R5.t.a("Assurance", "AssuranceStateManager", "Error while encoding the content. Error %s", e10.getLocalizedMessage());
            return "";
        }
    }
    ...
    public final void a() {
        ...
        R5.t.a("Assurance", "AssuranceStateManager", "Assurance shared state cleared", new Object[0]);
    }

    @JvmName
    public final List<C6555l> b() {
        ArrayList arrayList = new ArrayList();
        ...
        if (h(hE)) {
            ...
            if (mapB != null && !mapB.isEmpty()) {
                ...
                Map<String, ? extends Object> mapT = C14328a.t(Object.class, mapB, "extensions", null);
                if (mapT != null) {
    ...
    public final String e(boolean urlEncoded) {
        ...
        if (!h(hE)) {
            R5.t.b("Assurance", "AssuranceStateManager", "SDK configuration is not available to read OrgId", new Object[0]);
            return "";
        }
        Map<String, Object> mapB = hE != null ? hE.b() : null;
        if (mapB == null || mapB.isEmpty()) {
        ...
        String orgId = C14328a.o(mapB, "experienceCloud.org", "");
        if (orgId == null || orgId.length() == 0) {
            R5.t.a("Assurance", "AssuranceStateManager", "Org id is null or empty", new Object[0]);
            return "";
        }
        if (urlEncoded) {
    ...
    @JvmName
    public final void i(C6574h event) {
    ...
    public final void k(String sessionID) {
        ...
        R5.t.a("Assurance", "AssuranceStateManager", "Assurance shared state updated: \n " + mapA, new Object[0]);
