...
public final class C6553j {
    ...
    public static final C6553j f63106a = new C6553j();

    @JvmStatic
    public static final EnumC6550g a(int closeCode) {
        if (closeCode == 1006) {
            return EnumC6550g.GENERIC_ERROR;
        }
        if (closeCode == 4400) {
            return EnumC6550g.CLIENT_ERROR;
        }
        switch (closeCode) {
            case 4900:
                return EnumC6550g.ORG_ID_MISMATCH;
            case 4901:
                return EnumC6550g.CONNECTION_LIMIT;
            case 4902:
                return EnumC6550g.EVENT_LIMIT;
            case 4903:
                return EnumC6550g.SESSION_DELETED;
            default:
                return null;
        }
    }
