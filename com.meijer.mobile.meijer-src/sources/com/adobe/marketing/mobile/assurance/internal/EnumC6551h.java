...
public enum EnumC6551h {
    ...
    private static final Map<String, EnumC6551h> f63095c;
    ...
    public static final class Companion {
        ...
        @JvmStatic
        @JvmName
        public final EnumC6551h a(String stringValue) {
            Intrinsics.j(stringValue, "stringValue");
            EnumC6551h enumC6551h = (EnumC6551h) EnumC6551h.f63095c.get(stringValue);
            return enumC6551h == null ? EnumC6551h.PROD : enumC6551h;
        }
    }

    @JvmStatic
    @JvmName
    public static final EnumC6551h e(String str) {
        return INSTANCE.a(str);
    }

    static {
        EnumC6551h[] enumC6551hArrValues = values();
        LinkedHashMap linkedHashMap = new LinkedHashMap(RangesKt.f(MapsKt.f(enumC6551hArrValues.length), 16));
        for (EnumC6551h enumC6551h : enumC6551hArrValues) {
            linkedHashMap.put(enumC6551h.stringValue, enumC6551h);
        }
        f63095c = linkedHashMap;
    }

    EnumC6551h(String str) {
