...
public final class Y {
    ...
    public final void a() {
        R5.t.a("Assurance", "SessionUIOperationHandler", "On Cancel Clicked. Disconnecting session.", new Object[0]);
        this.orchestrator.g(true);
    }

    public final void c() {
        R5.t.a("Assurance", "SessionUIOperationHandler", "On Disconnect clicked. Disconnecting session.", new Object[0]);
        this.orchestrator.g(true);
    }
    ...
    public final void b(String sessionId, String token, EnumC6551h environment, B listener, X authorizingPresentationType) {
        ...
        C6567y c6567yD = this.orchestrator.d();
        if (c6567yD != null) {
            if (c6567yD.m() != authorizingPresentationType) {
                R5.t.f("Assurance", "SessionUIOperationHandler", "Cannot start " + authorizingPresentationType + " session. A " + c6567yD.m() + " session exists.", new Object[0]);
                listener.b(EnumC6550g.UNEXPECTED_ERROR);
            } else {
                R5.t.a("Assurance", "SessionUIOperationHandler", "Disconnecting active session of and recreating.", new Object[0]);
