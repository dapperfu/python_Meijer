...
public final class V {
    ...
    private final void f() {
        ...
        if (future != null) {
            future.cancel(true);
            R5.t.e("Assurance", "QuickConnectManager", "QuickConnect device creation task cancelled", new Object[0]);
        ...
        if (scheduledFuture != null) {
            ...
            R5.t.a("Assurance", "QuickConnectManager", "QuickConnect device status task cancelled", new Object[0]);
    ...
    private final QuickConnectSessionDetails g(String jsonString) {
        if (jsonString != null && jsonString.length() != 0) {
            try {
                ...
                if (!g6.i.a(sessionUUID) && !g6.i.a(token) && !StringsKt.H(BuildConfig.TRAVIS, sessionUUID, true) && !StringsKt.H(BuildConfig.TRAVIS, token, true)) {
    ...
    private final void h(String orgId, String clientId, W<R5.o, EnumC6550g> response) {
        if (!(response instanceof W.b)) {
            if (response instanceof W.a) {
                R5.t.e("Assurance", "QuickConnectManager", "Device status check request failed.", new Object[0]);
                this.quickConnectCallback.b((EnumC6550g) ((W.a) response).a());
                f();
                return;
            }
            return;
        }
        QuickConnectSessionDetails quickConnectSessionDetailsG = g(C14334g.a(((R5.o) ((W.b) response).a()).c()));
        if (quickConnectSessionDetailsG != null) {
            R5.t.e("Assurance", "QuickConnectManager", "Received session details.", new Object[0]);
            this.quickConnectCallback.a(quickConnectSessionDetailsG.getSessionId(), quickConnectSessionDetailsG.getToken());
            f();
        } else {
            if (!this.isActive) {
                R5.t.e("Assurance", "QuickConnectManager", "Will not retry. QuickConnect workflow already cancelled.", new Object[0]);
                return;
            }
            this.retryCount++;
            if (this.retryCount < 300) {
                R5.t.e("Assurance", "QuickConnectManager", "Will retry device status check.", new Object[0]);
                d(orgId, clientId);
            } else {
                R5.t.e("Assurance", "QuickConnectManager", "Will not retry. Maximum allowed retries for status check have been reached.", new Object[0]);
                this.quickConnectCallback.b(EnumC6550g.RETRY_LIMIT_REACHED);
                f();
            }
        }
    }
    ...
    public static final void j(V this$0, String orgId, String clientId, W w10) {
        ...
        if (w10 instanceof W.b) {
            ...
            this$0.quickConnectCallback.b((EnumC6550g) ((W.a) w10).a());
            this$0.f();
        }
    }
    ...
    public final void d(final String orgId, final String clientId) {
        Intrinsics.j(orgId, "orgId");
        Intrinsics.j(clientId, "clientId");
        this.deviceStatusTaskHandle = this.executorService.schedule(new S(orgId, clientId, new InterfaceC6543a() { // from class: com.adobe.marketing.mobile.assurance.internal.U
            @Override // com.adobe.marketing.mobile.InterfaceC6543a
            public final void a(Object obj) {
                V.e(this.f63034a, orgId, clientId, (W) obj);
            }
        }), C6552i.f63102a.c(), TimeUnit.MILLISECONDS);
    }
    ...
    public final void i() {
        ...
        String deviceName = R5.K.f().e().q();
        R5.t.e("Assurance", "QuickConnectManager", "Attempting to register device with deviceName:" + deviceName + ", orgId: " + strE + ", clientId: " + strC + '.', new Object[0]);
        Intrinsics.i(deviceName, "deviceName");
        this.deviceCreationTaskHandle = this.executorService.submit(new P(strE, strC, deviceName, new InterfaceC6543a() { // from class: com.adobe.marketing.mobile.assurance.internal.T
            @Override // com.adobe.marketing.mobile.InterfaceC6543a
            public final void a(Object obj) {
                V.j(this.f63031a, strE, strC, (W) obj);
            }
        }));
    }
