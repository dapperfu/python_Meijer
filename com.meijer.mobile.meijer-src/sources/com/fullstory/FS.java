...
public class FS {
    ...
    private static final InstrumentInjectorBridge f65167a;

    /* renamed from: b, reason: collision with root package name */
    private static final Field f65168b;

    /* renamed from: c, reason: collision with root package name */
    private static final boolean f65169c;
    ...
    public static Drawable Resources_getDrawable(Context context, int i10) {
        ...
        InstrumentInjectorBridge instrumentInjectorBridge = f65167a;
    ...
    private static int a(int i10, LogLevel logLevel, String str, String str2, Throwable th2) {
        ...
        if (i10 > 0 && (instrumentInjectorBridge = f65167a) != null) {
    ...
    public static boolean bitmap_isRecycled(Bitmap bitmap) {
        InstrumentInjectorBridge instrumentInjectorBridge;
        return (bitmap == null || (instrumentInjectorBridge = f65167a) == null) ? bitmap.isRecycled() : instrumentInjectorBridge.bitmap_isRecycled(bitmap);
    }

    public static void bitmap_recycle(Bitmap bitmap) {
        InstrumentInjectorBridge instrumentInjectorBridge;
        if (bitmap == null || (instrumentInjectorBridge = f65167a) == null) {
            bitmap.recycle();
        } else {
    ...
    public static WebViewClient getWebViewClient(WebView webView) {
        InstrumentInjectorBridge instrumentInjectorBridge;
        if (Build.VERSION.SDK_INT >= 26 && (instrumentInjectorBridge = f65167a) != null) {
            return instrumentInjectorBridge.getWebViewClient(webView);
        }
        return webView.getWebViewClient();
    }

    public static Window.Callback getWindowCallback(Window window) {
        InstrumentInjectorBridge instrumentInjectorBridge = f65167a;
        return instrumentInjectorBridge != null ? instrumentInjectorBridge.getWindowCallback(window) : window.getCallback();
    }
    ...
    public static void registerStatusListener(FSStatusListener fSStatusListener) {
        ...
        if (instrumentInjectorBridge != null) {
            ...
            fSStatusListener.onFSError(b.f133640b);
        } else {
            fSStatusListener.onFSDisabled(b.f133640b);
        }
    }
    ...
    public static void setWindowCallback(Window window, Window.Callback callback) {
        InstrumentInjectorBridge instrumentInjectorBridge = f65167a;
        if (instrumentInjectorBridge != null) {
            instrumentInjectorBridge.setWindowCallback(window, callback);
        } else {
