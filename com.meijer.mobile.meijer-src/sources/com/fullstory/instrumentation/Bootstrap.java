...
public class Bootstrap {
    ...
    private static FSStatusListener f65172c;

    /* renamed from: a, reason: collision with root package name */
    private static final A f65170a = new A();

    /* renamed from: b, reason: collision with root package name */
    private static final Object f65171b = new Object();

    /* renamed from: d, reason: collision with root package name */
    private static final Object f65173d = new Object();
    ...
    static void a(Application application, Context context) {
        synchronized (f65171b) {
            A a10 = f65170a;
            if (!a10.f132610a || a10.f132611b) {
                return;
            }
            try {
    ...
    static void a(Runnable runnable) {
        synchronized (f65171b) {
            ...
            if (a10.f132615f != null || a10.f132616g == null) {
                runnable.run();
            } else {
                a10.f132616g.add(runnable);
            }
        }
    }
    ...
    private static FSStatusListener c() {
        ...
        synchronized (f65173d) {
            fSStatusListener = f65172c;
        }
    ...
    public static C14091ar getCurrentSessionKnobs() {
        R rImpl = impl();
        if (rImpl == null) {
            return null;
        }
    ...
    public static void success(R r10) {
        synchronized (f65171b) {
            ...
            a10.f132615f = r10;
            List list = a10.f132616g;
            a10.f132616g = null;
            boolean z10 = a10.f132614e;
            if (!z10) {
                r10.shutdown();
            }
