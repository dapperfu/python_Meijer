...
public class WebViewTracker {
    ...
    private static final Set f65184a = Collections.synchronizedSet(Collections.newSetFromMap(new WeakHashMap()));

    /* renamed from: b, reason: collision with root package name */
    private static final String f65185b = null;

    /* renamed from: c, reason: collision with root package name */
    private final RustInterface f65186c;

    /* renamed from: d, reason: collision with root package name */
    private final boolean f65187d;

    /* renamed from: e, reason: collision with root package name */
    private final LongSparseArray f65188e = new LongSparseArray();

    /* renamed from: f, reason: collision with root package name */
    private final ReferenceQueue f65189f = new ReferenceQueue();

    /* renamed from: g, reason: collision with root package name */
    private final String f65190g;

    /* renamed from: h, reason: collision with root package name */
    private final String f65191h;

    /* renamed from: i, reason: collision with root package name */
    private final String f65192i;

    /* renamed from: j, reason: collision with root package name */
    private final String f65193j;

    /* renamed from: k, reason: collision with root package name */
    private final String f65194k;

    /* renamed from: l, reason: collision with root package name */
    private final String f65195l;

    /* renamed from: m, reason: collision with root package name */
    private final String f65196m;

    /* renamed from: n, reason: collision with root package name */
    private final String f65197n;

    /* renamed from: o, reason: collision with root package name */
    private boolean f65198o;

    /* renamed from: p, reason: collision with root package name */
    private final int f65199p;
    ...
    public WebViewTracker(RustInterface rustInterface, boolean z10, String str) {
        ...
        this.f65190g = strA;
        this.f65191h = rustInterface.a(str);
        this.f65192i = "window[window._fs_namespace]?._init_callback && window[window._fs_namespace]._init_callback()";
        String strA2 = rustInterface.a(str, true);
        this.f65193j = strA2;
        String strA3 = rustInterface.a(str, false);
        this.f65194k = strA3;
        this.f65195l = rustInterface.b(str, strA2);
        this.f65196m = rustInterface.b(str, strA3);
        this.f65199p = rustInterface.f();
    ...
    private void a(WebView webView, eM eMVar) {
        ...
        c(webView);
        a(webView, "snippet", this.f65190g);
    }
    ...
    private void a(WebView webView, String str, String str2) {
        ...
        if ("activate_capture_snippet".equals(str)) {
            C14091ar c14091arA = this.f65186c.a();
            a(webView, "init_consent", c14091arA != null ? c14091arA.e() : false ? this.f65195l : this.f65196m);
        }
    }
    ...
    private void c() {
        synchronized (this.f65188e) {
            while (true) {
                eN eNVar = (eN) this.f65189f.poll();
                if (eNVar != null) {
                    a(eNVar.f133348a, "lost", new Object[0]);
                    this.f65186c.b(eNVar.f133348a);
                    this.f65188e.remove(eNVar.f133348a);
                }
            }
        }
    }
    ...
    private boolean i(WebView webView) {
        return this.f65187d && !f65184a.contains(webView);
    }

    public int a(WebView webView) {
        synchronized (this.f65188e) {
            eN eNVar = (eN) this.f65188e.get(gd.c(webView));
            if (eNVar == null) {
                return 0;
            }
            return eNVar.f133349b;
        }
    }
    ...
    public void a() {
        b(-1L, "shutdown", this.f65191h);
    }

    void a(long j10) {
        b(j10, "signal fs.js to capture", this.f65192i);
    }
    ...
    public void a(long j10, int i10, int i11, String str) {
        ...
        synchronized (this.f65188e) {
            ...
            eN eNVar = (eN) this.f65188e.get(j10);
            if (eNVar != null) {
                eNVar.f133349b = i10;
            }
            this.f65186c.a(j10, i10, (byte) i11, str);
        }
    }

    public void a(long j10, String str, String str2) {
        if (this.f65197n.equals(str) && this.f65186c.c(str2)) {
            return;
        }
        a(j10);
    }
    ...
    public void a(boolean z10) {
        b(-1L, "set_consent", z10 ? this.f65193j : this.f65194k);
    }
    ...
    public boolean b(long j10, String str, String str2) {
        ...
        synchronized (this.f65188e) {
            ...
            for (int i10 = 0; i10 < this.f65188e.size(); i10++) {
                eN eNVar2 = (eN) this.f65188e.valueAt(i10);
    ...
    public void c(WebView webView) {
        ...
        if (!i(webView)) {
            ...
            this.f65186c.a(jC, 0, (short) 1);
            return;
        }
        synchronized (this.f65188e) {
            c();
            if (this.f65188e.indexOfKey(jC) < 0) {
                a(webView, "track: now tracking", new Object[0]);
                this.f65188e.put(jC, new eN(jC, webView, this.f65189f));
                if (h(webView)) {
