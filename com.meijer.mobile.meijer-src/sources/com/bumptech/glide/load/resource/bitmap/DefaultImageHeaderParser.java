...
public final class DefaultImageHeaderParser implements ImageHeaderParser {
    ...
    static final byte[] f64869a = "Exif\u0000\u0000".getBytes(Charset.forName("UTF-8"));

    /* renamed from: b, reason: collision with root package name */
    private static final int[] f64870b = {0, 1, 1, 2, 4, 8, 1, 1, 2, 4, 8, 4, 8};
    ...
    private static final class a implements Reader {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final ByteBuffer f64871a;

        @Override // com.bumptech.glide.load.resource.bitmap.DefaultImageHeaderParser.Reader
        public int b(byte[] bArr, int i10) {
            int iMin = Math.min(i10, this.f64871a.remaining());
            if (iMin == 0) {
                return -1;
            }
            this.f64871a.get(bArr, 0, iMin);
            return iMin;
        }

        @Override // com.bumptech.glide.load.resource.bitmap.DefaultImageHeaderParser.Reader
        public short c() throws Reader.EndOfFileException {
            if (this.f64871a.remaining() >= 1) {
                return (short) (this.f64871a.get() & 255);
            }
        ...
        public long skip(long j10) {
            int iMin = (int) Math.min(this.f64871a.remaining(), j10);
            ByteBuffer byteBuffer = this.f64871a;
            byteBuffer.position(byteBuffer.position() + iMin);
            return iMin;
        }

        a(ByteBuffer byteBuffer) {
            this.f64871a = byteBuffer;
    ...
    private static final class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final ByteBuffer f64872a;

        short a(int i10) {
            if (c(i10, 2)) {
                return this.f64872a.getShort(i10);
            }
            return (short) -1;
        }
        ...
        int b(int i10) {
            if (c(i10, 4)) {
                return this.f64872a.getInt(i10);
            }
            return -1;
        }

        private boolean c(int i10, int i11) {
            return this.f64872a.remaining() - i10 >= i11;
        }

        int d() {
            return this.f64872a.remaining();
        }

        void e(ByteOrder byteOrder) {
            this.f64872a.order(byteOrder);
        }

        b(byte[] bArr, int i10) {
            this.f64872a = (ByteBuffer) ByteBuffer.wrap(bArr).order(ByteOrder.BIG_ENDIAN).limit(i10);
        }
    }
    ...
    private static final class c implements Reader {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final InputStream f64873a;

        @Override // com.bumptech.glide.load.resource.bitmap.DefaultImageHeaderParser.Reader
        public int b(byte[] bArr, int i10) throws IOException {
            int i11 = 0;
            int i12 = 0;
            while (i11 < i10 && (i12 = this.f64873a.read(bArr, i11, i10 - i11)) != -1) {
                i11 += i12;
            }
            if (i11 == 0 && i12 == -1) {
                throw new Reader.EndOfFileException();
        ...
        public long skip(long j10) throws IOException {
            ...
            long j11 = j10;
            while (j11 > 0) {
                long jSkip = this.f64873a.skip(j11);
                if (jSkip <= 0) {
                    if (this.f64873a.read() == -1) {
                        break;
                    }
                    jSkip = 1;
                }
    ...
    private int f(Reader reader, InterfaceC5665b interfaceC5665b) throws IOException {
        try {
            int iA = reader.a();
            if (!h(iA)) {
            ...
            byte[] bArr = (byte[]) interfaceC5665b.c(iJ, byte[].class);
            try {
    ...
    private boolean i(byte[] bArr, int i10) {
        boolean z10 = bArr != null && i10 > f64869a.length;
        if (z10) {
            int i11 = 0;
            while (true) {
                byte[] bArr2 = f64869a;
    ...
    public int a(ByteBuffer byteBuffer, InterfaceC5665b interfaceC5665b) throws IOException {
        return f(new a((ByteBuffer) r7.k.d(byteBuffer)), (InterfaceC5665b) r7.k.d(interfaceC5665b));
    }

    @Override // com.bumptech.glide.load.ImageHeaderParser
    public int b(InputStream inputStream, InterfaceC5665b interfaceC5665b) throws IOException {
        return f(new c((InputStream) r7.k.d(inputStream)), (InterfaceC5665b) r7.k.d(interfaceC5665b));
    }

    @Override // com.bumptech.glide.load.ImageHeaderParser
    public ImageHeaderParser.ImageType c(ByteBuffer byteBuffer) throws IOException {
        return g(new a((ByteBuffer) r7.k.d(byteBuffer)));
    }

    @Override // com.bumptech.glide.load.ImageHeaderParser
    public ImageHeaderParser.ImageType d(InputStream inputStream) throws IOException {
        return g(new c((InputStream) r7.k.d(inputStream)));
    }
