...
public class I<T> implements X6.i<T, Bitmap> {

    /* renamed from: d, reason: collision with root package name */
    public static final X6.f<Long> f64884d = X6.f.a("com.bumptech.glide.load.resource.bitmap.VideoBitmapDecode.TargetFrame", -1L, new a());

    /* renamed from: e, reason: collision with root package name */
    public static final X6.f<Integer> f64885e = X6.f.a("com.bumptech.glide.load.resource.bitmap.VideoBitmapDecode.FrameOption", 2, new b());

    /* renamed from: f, reason: collision with root package name */
    private static final f f64886f = new f();

    /* renamed from: g, reason: collision with root package name */
    private static final List<String> f64887g = Collections.unmodifiableList(Arrays.asList("TP1A", "TD1A.220804.031"));

    /* renamed from: a, reason: collision with root package name */
    private final e<T> f64888a;

    /* renamed from: b, reason: collision with root package name */
    private final a7.d f64889b;

    /* renamed from: c, reason: collision with root package name */
    private final f f64890c;

    class b implements f.b<Integer> {

        /* renamed from: a, reason: collision with root package name */
        private final ByteBuffer f64892a = ByteBuffer.allocate(4);
        ...
        public void a(byte[] bArr, Integer num, MessageDigest messageDigest) {
            ...
            synchronized (this.f64892a) {
                this.f64892a.position(0);
                messageDigest.update(this.f64892a.putInt(num.intValue()).array());
            }
        }
    ...
    static final class d implements e<ByteBuffer> {
        ...
        class a extends MediaDataSource {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ ByteBuffer f64893a;
            ...
            a(ByteBuffer byteBuffer) {
                this.f64893a = byteBuffer;
            }

            @Override // android.media.MediaDataSource
            public long getSize() {
                return this.f64893a.limit();
            }

            @Override // android.media.MediaDataSource
            public int readAt(long j10, byte[] bArr, int i10, int i11) {
                if (j10 >= this.f64893a.limit()) {
                    return -1;
                }
                this.f64893a.position((int) j10);
                int iMin = Math.min(i11, this.f64893a.remaining());
                this.f64893a.get(bArr, i10, iMin);
                return iMin;
            }
        }
    ...
    I(a7.d dVar, e<T> eVar) {
        this(dVar, eVar, f64886f);
    }

    @Override // X6.i
    public boolean a(T t10, X6.g gVar) {
        return true;
    }
    ...
    class a implements f.b<Long> {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final ByteBuffer f64891a = ByteBuffer.allocate(8);
        ...
        public void a(byte[] bArr, Long l10, MessageDigest messageDigest) {
            messageDigest.update(bArr);
            synchronized (this.f64891a) {
                this.f64891a.position(0);
                messageDigest.update(this.f64891a.putLong(l10.longValue()).array());
            }
        }
    }
    ...
    I(a7.d dVar, e<T> eVar, f fVar) {
        this.f64889b = dVar;
        this.f64888a = eVar;
        this.f64890c = fVar;
    }

    public static X6.i<AssetFileDescriptor, Bitmap> c(a7.d dVar) {
        return new I(dVar, new c(null));
    }

    public static X6.i<ByteBuffer, Bitmap> d(a7.d dVar) {
    ...
    private static boolean k() {
        Iterator<String> it = f64887g.iterator();
        while (it.hasNext()) {
    ...
    private boolean l(T t10, MediaMetadataRetriever mediaMetadataRetriever) {
        ...
        try {
            this.f64888a.a(mediaExtractor2, t10);
    ...
    public static X6.i<ParcelFileDescriptor, Bitmap> m(a7.d dVar) {
        return new I(dVar, new g());
    }

    @Override // X6.i
    public Z6.c<Bitmap> b(T t10, int i10, int i11, X6.g gVar) throws Exception {
        long jLongValue = ((Long) gVar.a(f64884d)).longValue();
        if (jLongValue < 0 && jLongValue != -1) {
            throw new IllegalArgumentException("Requested frame must be non-negative, or DEFAULT_FRAME, given: " + jLongValue);
        }
        Integer num = (Integer) gVar.a(f64885e);
        if (num == null) {
            num = 2;
        }
        ...
        o oVar2 = oVar;
        MediaMetadataRetriever mediaMetadataRetrieverA = this.f64890c.a();
        try {
            this.f64888a.b(mediaMetadataRetrieverA, t10);
            try {
                ...
                return C6639g.e(bitmapF, this.f64889b);
            } catch (Throwable th2) {
                th = th2;
                Throwable th3 = th;
                if (Build.VERSION.SDK_INT >= 29) {
    ...
    private Bitmap f(T t10, MediaMetadataRetriever mediaMetadataRetriever, long j10, int i10, int i11, int i12, o oVar) {
        ...
        if (!l(t10, mediaMetadataRetriever)) {
            if (Build.VERSION.SDK_INT >= 27 && i11 != Integer.MIN_VALUE && i12 != Integer.MIN_VALUE && oVar != o.f64915f) {
