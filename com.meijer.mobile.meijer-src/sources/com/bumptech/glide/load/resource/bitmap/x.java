...
public final class x {
    ...
    public static final boolean f64940e;

    /* renamed from: f, reason: collision with root package name */
    public static final boolean f64941f;

    /* renamed from: g, reason: collision with root package name */
    private static final File f64942g;

    /* renamed from: h, reason: collision with root package name */
    private static volatile x f64943h;

    /* renamed from: b, reason: collision with root package name */
    private int f64945b;

    /* renamed from: c, reason: collision with root package name */
    private boolean f64946c = true;

    /* renamed from: d, reason: collision with root package name */
    private final AtomicBoolean f64947d = new AtomicBoolean(false);

    /* renamed from: a, reason: collision with root package name */
    private final int f64944a = 20000;

    private synchronized boolean d() {
        try {
            boolean z10 = true;
            int i10 = this.f64945b + 1;
            this.f64945b = i10;
            if (i10 >= 50) {
                this.f64945b = 0;
                int length = f64942g.list().length;
                long jC = c();
                if (length >= jC) {
                    z10 = false;
                }
    ...
    static {
        ...
        f64940e = i10 < 29;
        f64941f = i10 >= 28;
        f64942g = new File("/proc/self/fd");
    }

    private boolean a() {
        return f64940e && !this.f64947d.get();
    }
