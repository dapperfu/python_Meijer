...
public final class C4423p1 extends ContentProvider {
    ...
    public final void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        try {
            ...
            Sc.p.e("Failed to load metadata: Package name not found.", e10);
        } catch (NullPointerException e11) {
            Sc.p.e("Failed to load metadata: Null pointer exception.", e11);
        }
        C9651tl c9651tlA = C9651tl.a();
        if (bundle == null) {
            Sc.p.d("Metadata was null.");
        } else {
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        if (str != null) {
                            ...
                            Sc.p.b("Publisher provided Google AdMob App ID in manifest: ".concat(str));
                            if (bool == null || !bool.booleanValue()) {
                                c9651tlA.b(context, str);
                            }
                        } else {
                            if (TextUtils.isEmpty(str2)) {
                                throw new IllegalStateException("\n\n******************************************************************************\n* Missing application ID. AdMob publishers should follow the instructions    *\n* here:                                                                      *\n* https://googlemobileadssdk.page.link/admob-android-update-manifest         *\n* to add a valid App ID inside the AndroidManifest.                          *\n* Google Ad Manager publishers should follow instructions here:              *\n* https://googlemobileadssdk.page.link/ad-manager-android-update-manifest.   *\n******************************************************************************\n\n");
                            }
                            Sc.p.b("The Google Mobile Ads SDK is integrated by ".concat(String.valueOf(str2)));
                        }
        ...
        if (bundle != null) {
            ...
            if (z10) {
                Sc.p.b("com.google.android.gms.ads.flag.OPTIMIZE_INITIALIZATION is enabled");
            }
            if (z11) {
                Sc.p.b("com.google.android.gms.ads.flag.OPTIMIZE_AD_LOADING is enabled");
            }
        }
