...
final class g implements Executor {
    ...
    final Deque<Runnable> f13281a = new ArrayDeque();

    /* renamed from: c, reason: collision with root package name */
    private final b f13283c = new b();
    ...
    class a implements Runnable {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Runnable f13286a;
        ...
        */
        private void a() {
            ...
            L2:
                ...
                java.util.Deque<java.lang.Runnable> r2 = r2.f13281a     // Catch: java.lang.Throwable -> L49
                monitor-enter(r2)     // Catch: java.lang.Throwable -> L49
                if (r0 != 0) goto L28
                H.g r0 = H.g.this     // Catch: java.lang.Throwable -> L1c
                H.g$c r3 = r0.f13284d     // Catch: java.lang.Throwable -> L1c
            ...
            L1c:
                ...
                goto L63
            L1e:
                long r5 = r0.f13285e     // Catch: java.lang.Throwable -> L1c
                r7 = 1
                long r5 = r5 + r7
                r0.f13285e = r5     // Catch: java.lang.Throwable -> L1c
                r0.f13284d = r4     // Catch: java.lang.Throwable -> L1c
                r0 = 1
            L28:
                H.g r3 = H.g.this     // Catch: java.lang.Throwable -> L1c
                java.util.Deque<java.lang.Runnable> r3 = r3.f13281a     // Catch: java.lang.Throwable -> L1c
                ...
                r0.f13284d = r3     // Catch: java.lang.Throwable -> L1c
                monitor-exit(r2)     // Catch: java.lang.Throwable -> L1c
                if (r1 == 0) goto L3e
                goto L14
            L3e:
        ...
        public void run() {
            try {
                ...
                synchronized (g.this.f13281a) {
                    g.this.f13284d = c.IDLE;
                    throw e10;
                }
            }
        }
    ...
    g(Executor executor) {
        this.f13282b = (Executor) i.g(executor);
    }
    ...
    */
    public void execute(java.lang.Runnable r8) {
        /*
            r7 = this;
            o2.i.g(r8)
            java.util.Deque<java.lang.Runnable> r0 = r7.f13281a
            monitor-enter(r0)
            H.g$c r1 = r7.f13284d     // Catch: java.lang.Throwable -> L6d
            ...
            goto L6f
        L11:
            long r3 = r7.f13285e     // Catch: java.lang.Throwable -> L6d
            H.g$a r1 = new H.g$a     // Catch: java.lang.Throwable -> L6d
            r1.<init>(r8)     // Catch: java.lang.Throwable -> L6d
            java.util.Deque<java.lang.Runnable> r8 = r7.f13281a     // Catch: java.lang.Throwable -> L6d
            r8.add(r1)     // Catch: java.lang.Throwable -> L6d
            H.g$c r8 = H.g.c.QUEUING     // Catch: java.lang.Throwable -> L6d
            r7.f13284d = r8     // Catch: java.lang.Throwable -> L6d
            monitor-exit(r0)     // Catch: java.lang.Throwable -> L6d
            java.util.concurrent.Executor r0 = r7.f13282b     // Catch: java.lang.Error -> L44 java.lang.RuntimeException -> L46
            H.g$b r5 = r7.f13283c     // Catch: java.lang.Error -> L44 java.lang.RuntimeException -> L46
        ...
        L2e:
            java.util.Deque<java.lang.Runnable> r0 = r7.f13281a
            monitor-enter(r0)
            long r5 = r7.f13285e     // Catch: java.lang.Throwable -> L3e
            int r1 = (r5 > r3 ? 1 : (r5 == r3 ? 0 : -1))
            if (r1 != 0) goto L40
            H.g$c r1 = r7.f13284d     // Catch: java.lang.Throwable -> L3e
            if (r1 != r8) goto L40
            r7.f13284d = r2     // Catch: java.lang.Throwable -> L3e
            goto L40
        L3e:
            r8 = move-exception
            goto L42
        ...
        L46:
            r8 = move-exception
        L47:
            java.util.Deque<java.lang.Runnable> r2 = r7.f13281a
            monitor-enter(r2)
            H.g$c r0 = r7.f13284d     // Catch: java.lang.Throwable -> L55
        ...
        L55:
            ...
            goto L6b
        L57:
            java.util.Deque<java.lang.Runnable> r0 = r7.f13281a     // Catch: java.lang.Throwable -> L55
        ...
        L6d:
            ...
            goto L76
        L6f:
            java.util.Deque<java.lang.Runnable> r1 = r7.f13281a     // Catch: java.lang.Throwable -> L6d
