...
@Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0004\u001a:\u0010\t\u001a\u00020\u00072\u0006\u0010\u0001\u001a\u00020\u00002!\u0010\b\u001a\u001d\u0012\u0013\u0012\u00110\u0003¢\u0006\f\b\u0004\u0012\b\b\u0005\u0012\u0004\b\b(\u0006\u0012\u0004\u0012\u00020\u00070\u0002H\u0001¢\u0006\u0004\b\t\u0010\n¨\u0006\u000b"}, d2 = {"Lcom/adobe/marketing/mobile/assurance/internal/g;", "assuranceConnectionError", "Lkotlin/Function1;", "Lz5/a;", "Lkotlin/ParameterName;", "name", "action", "", "onAction", "a", "(Lcom/adobe/marketing/mobile/assurance/internal/g;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;I)V", "assurance_phoneRelease"}, k = 2, mv = {1, 5, 1}, xi = 48)
@SourceDebugExtension
/* loaded from: classes4.dex */
public final class e {

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    static final class a extends Lambda implements Function1<AbstractC18444a, Unit> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function1<AbstractC18444a, Unit> f2555f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        a(Function1<? super AbstractC18444a, Unit> function1) {
            super(1);
            this.f2555f = function1;
        }

        public final void a(AbstractC18444a action) {
            Intrinsics.j(action, "action");
            this.f2555f.invoke(action);
        }
    ...
    static final class b extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ EnumC6550g f2556f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function1<AbstractC18444a, Unit> f2557g;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        b(EnumC6550g enumC6550g, Function1<? super AbstractC18444a, Unit> function1, int i10) {
            super(2);
            this.f2556f = enumC6550g;
            this.f2557g = function1;
            this.f2558h = i10;
        }

        public final void a(Composer composer, int i10) {
            e.a(this.f2556f, this.f2557g, composer, J0.a(this.f2558h | 1));
        }
    ...
    public static final void a(EnumC6550g assuranceConnectionError, Function1<? super AbstractC18444a, Unit> onAction, Composer composer, int i10) {
        int i11;
        Composer composer2;
        ...
        if ((i11 & 91) == 18 && composerStartRestartGroup.j()) {
            ...
            Function3<V0<InterfaceC5953g>, Composer, Integer, Unit> function3C2 = A.c(modifierK);
            if (composerStartRestartGroup.k() == null) {
                C5859f.c();
            }
            composerStartRestartGroup.F();
            ...
            composerStartRestartGroup.U();
            composerStartRestartGroup.U();
            Modifier modifierA2 = F1.a(D.m(c5806j.g(J.h(companion, 0.0f, 1, null), companion2.d()), aVar.b().b().getXxLarge(), 0.0f, aVar.b().b().getXxLarge(), aVar.b().b().getMedium(), 2, null), "pinErrorActionButtonRow");
            ...
            composerStartRestartGroup.U();
            composer2 = composerStartRestartGroup;
            B5.a.a(modifierA2, assuranceConnectionError, (Function1) objB, composer2, (i11 << 3) & 112, 0);
            composer2.U();
            composer2.v();
            composer2.U();
            composer2.U();
