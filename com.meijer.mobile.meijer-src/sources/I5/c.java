...
@Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010$\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0005\b\u0000\u0018\u0000 \u00142\u00020\u0001:\u0001\u0014B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J1\u0010\t\u001a\u0012\u0012\u0004\u0012\u00020\u0004\u0012\u0006\u0012\u0004\u0018\u00010\u0001\u0018\u00010\b2\u0006\u0010\u0005\u001a\u00020\u00042\b\u0010\u0007\u001a\u0004\u0018\u00010\u0006H\u0002¢\u0006\u0004\b\t\u0010\nJI\u0010\r\u001a\u0012\u0012\u0004\u0012\u00020\u0004\u0012\u0006\u0012\u0004\u0018\u00010\u0001\u0018\u00010\b2\u0006\u0010\u0005\u001a\u00020\u00042\b\u0010\u0007\u001a\u0004\u0018\u00010\u000b2\u0016\u0010\f\u001a\u0012\u0012\u0004\u0012\u00020\u0004\u0012\u0006\u0012\u0004\u0018\u00010\u0004\u0018\u00010\bH\u0002¢\u0006\u0004\b\r\u0010\u000eJ9\u0010\u0012\u001a\u00020\u00102\u0006\u0010\u0005\u001a\u00020\u00042\"\u0010\u0011\u001a\u001e\u0012\u0014\u0012\u0012\u0012\u0004\u0012\u00020\u0004\u0012\u0006\u0012\u0004\u0018\u00010\u0001\u0018\u00010\b\u0012\u0004\u0012\u00020\u00100\u000f¢\u0006\u0004\b\u0012\u0010\u0013¨\u0006\u0015"}, d2 = {"LI5/c;", "", "<init>", "()V", "", "url", "LR5/o;", "response", "", "d", "(Ljava/lang/String;LR5/o;)Ljava/util/Map;", "Ljava/io/InputStream;", "metadata", "e", "(Ljava/lang/String;Ljava/io/InputStream;Ljava/util/Map;)Ljava/util/Map;", "Lkotlin/Function1;", "", "completionCallback", "b", "(Ljava/lang/String;Lkotlin/jvm/functions/Function1;)V", "a", "core_phoneRelease"}, k = 1, mv = {1, 5, 1}, xi = 48)
...
public final class c {
    private final Map<String, Object> d(String url, o response) throws ParseException {
        ...
        if (iD != 200) {
            ...
            S5.c cVarA = K.f().b().a("config", url);
            return e(url, cVarA != null ? cVarA.getData() : null, cVarA != null ? cVarA.k() : null);
        }
        ...
        Locale US = Locale.US;
        Intrinsics.i(US, "US");
        Date dateI = g6.j.i(strB, timeZone, US);
        if (dateI == null) {
            dateI = new Date(0L);
        }
    ...
    public final void b(final String url, final Function1<? super Map<String, ? extends Object>, Unit> completionCallback) throws NumberFormatException {
        ...
        if (cVarA != null) {
            Map<String, String> mapK = cVarA.k();
            if (mapK == null || (str = mapK.get("ETag")) == null) {
                str = "";
            }
            map.put("If-None-Match", str);
            Map<String, String> mapK2 = cVarA.k();
            ...
            Locale US = Locale.US;
            Intrinsics.i(US, "US");
            map.put("If-Modified-Since", g6.j.g(j10, timeZone, US));
        }
        K.f().h().a(new x(url, r.GET, null, map, 10, 10), new w() { // from class: I5.b
            @Override // R5.w
            public final void a(o oVar) throws ParseException {
                c.c(this.f14334a, url, completionCallback, oVar);
            }
        });
    }

    private final Map<String, Object> e(String url, InputStream response, Map<String, String> metadata) throws IOException {
        String strA = C14334g.a(response);
        if (strA == null) {
            return null;
        }
        if (strA.length() == 0) {
        ...
        try {
            Map<String, Object> mapC = M5.h.c(new JSONObject(new JSONTokener(strA)));
            byte[] bytes = strA.getBytes(Charsets.UTF_8);
            Intrinsics.i(bytes, "this as java.lang.String).getBytes(charset)");
            K.f().b().b("config", url, new S5.a(new ByteArrayInputStream(bytes), S5.b.d(), metadata));
            return mapC;
