...
public final class i {
    ...
    static final class b extends Lambda implements Function1<Map<String, ? extends Object>, Unit> {
        ...
        final /* synthetic */ Function1<Map<String, ? extends Object>, Unit> f14359h;
        ...
        public final void a(Map<String, ? extends Object> map) {
            if (map == null) {
                this.f14359h.invoke(null);
                return;
            }
            i.this.m(map);
            i.this.configDownloadMap.put(this.f14358g, new Date());
            this.f14359h.invoke(i.this.e());
        }
    ...
    private final Map<String, Object> j(String appId) throws IOException {
        ...
        S5.c cVarA = K.f().b().a("config", str);
        String strA = C14334g.a(cVarA != null ? cVarA.getData() : null);
        if (strA == null || strA.length() == 0) {
            t.e("Configuration", "ConfigurationStateManager", "Cached config is null/empty.", new Object[0]);
            return null;
        }
        try {
            return M5.h.c(new JSONObject(new JSONTokener(strA)));
    ...
    public final Map<String, Object> d(String filePath) {
        ...
        String strG = M5.g.g(new File(filePath));
        ...
        try {
            mapC = M5.h.c(new JSONObject(new JSONTokener(strG)));
    ...
    public final Map<String, Object> i(String bundledConfigFileName) throws IOException {
        ...
        String strA = C14334g.a(K.f().e().s(bundledConfigFileName));
        if (strA == null || strA.length() == 0) {
