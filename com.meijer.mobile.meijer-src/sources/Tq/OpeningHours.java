...
public final /* data */ class OpeningHours {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.e(this.code, openingHours.code) && this.is24Hrsand365Days == openingHours.is24Hrsand365Days && Intrinsics.e(this.weekDayOpeningList, openingHours.weekDayOpeningList);
    }

    public OpeningHours(String code, boolean z10, List<WeekDayOpening> weekDayOpeningList) {
    ...
    public String toString() {
        return "OpeningHours(code=" + this.code + ", is24Hrsand365Days=" + this.is24Hrsand365Days + ", weekDayOpeningList=" + this.weekDayOpeningList + ')';
    }
}
