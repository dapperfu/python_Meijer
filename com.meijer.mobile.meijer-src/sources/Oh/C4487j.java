...
public final class C4487j {
    ...
    @Metadata(d1 = {"\u0000\u001d\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J#\u0010\u0007\u001a\u00020\u00062\b\u0010\u0003\u001a\u0004\u0018\u00010\u00022\b\u0010\u0005\u001a\u0004\u0018\u00010\u0004H\u0016¢\u0006\u0004\b\u0007\u0010\b¨\u0006\t"}, d2 = {"Oh/j$a", "Landroid/webkit/WebViewClient;", "Landroid/webkit/WebView;", "view", "", "url", "", "onPageFinished", "(Landroid/webkit/WebView;Ljava/lang/String;)V", "ux_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    /* renamed from: Oh.j$a */
    public static final class a extends WebViewClient {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ HttpUrl f23963a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ String f23964b;

        a(HttpUrl httpUrl, String str) {
            this.f23963a = httpUrl;
            this.f23964b = str;
        }

        @Override // android.webkit.WebViewClient
        public void onPageFinished(WebView view, String url) {
            if (StringsKt.G(this.f23963a.getHost(), "meijer.com", false, 2, null) && Intrinsics.e(this.f23963a.c(), "/mma/mma-payment.html") && view != null) {
                view.evaluateJavascript(C4487j.i(this.f23964b), null);
            }
    ...
    public static final void d(Modifier modifier, final HttpUrl aurusUrl, final String accessToken, final Function1<? super String, Unit> onAction, Composer composer, final int i10, final int i11) {
        ...
        if ((i12 & 1171) == 1170 && composerStartRestartGroup.j()) {
            ...
            if (zD || objB == Composer.INSTANCE.a()) {
                objB = new Function1() { // from class: Oh.g
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
                        return C4487j.e(onAction, aurusUrl, accessToken, (Context) obj);
                    }
                };
            ...
            if (objB2 == Composer.INSTANCE.a()) {
                objB2 = new Function1() { // from class: Oh.h
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
                        return C4487j.f((WebView) obj);
                    }
                };
        ...
        if (t0L != null) {
            t0L.a(new Function2() { // from class: Oh.i
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return C4487j.g(modifier3, aurusUrl, accessToken, onAction, i10, i11, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    public static final WebView e(Function1 function1, HttpUrl httpUrl, String str, Context context) {
        ...
        webView.addJavascriptInterface(new C4483f(function1), "android-bridge");
