...
public class C14366b {
    public Ig.b b(String str, com.google.zxing.a aVar, int i10, int i11, Map<com.google.zxing.f, ?> map) throws WriterException {
        try {
