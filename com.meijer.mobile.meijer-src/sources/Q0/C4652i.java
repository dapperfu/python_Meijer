...
public final class C4652i {
    public static final void b(C4647d c4647d, ViewStructure viewStructure) {
        if (c4647d.getAutofillTree().a().isEmpty()) {
            return;
        }
        int iA = y.f27509a.a(viewStructure, c4647d.getAutofillTree().a().size());
        for (Map.Entry<Integer, I> entry : c4647d.getAutofillTree().a().entrySet()) {
            int iIntValue = entry.getKey().intValue();
            I value = entry.getValue();
            y yVar = y.f27509a;
            ViewStructure viewStructureG = yVar.g(viewStructure, iA);
            yVar.i(viewStructureG, c4647d.getRootAutofillId(), iIntValue);
            yVar.v(viewStructureG, iIntValue, c4647d.getView().getContext().getPackageName(), null, null);
            yVar.j(viewStructureG, M.b(L.INSTANCE.a()));
            List<K> listA = value.a();
            ArrayList arrayList = new ArrayList(listA.size());
            int size = listA.size();
            for (int i10 = 0; i10 < size; i10++) {
                arrayList.add(C4651h.a(listA.get(i10)));
            }
            ...
            if (boundingBox == null) {
                ...
                y.f27509a.r(viewStructureG, iRound, iRound2, 0, 0, iRound3 - iRound, Math.round(boundingBox.i()) - iRound2);
            }
            iA++;
        }
    }

    public static final void a(C4647d c4647d, SparseArray<AutofillValue> sparseArray) {
        if (!c4647d.getAutofillTree().a().isEmpty()) {
            int size = sparseArray.size();
            for (int i10 = 0; i10 < size; i10++) {
                int iKeyAt = sparseArray.keyAt(i10);
                AutofillValue autofillValueA = C4648e.a(sparseArray.get(iKeyAt));
                y yVar = y.f27509a;
                if (yVar.e(autofillValueA)) {
                    c4647d.getAutofillTree().b(iKeyAt, yVar.B(autofillValueA).toString());
