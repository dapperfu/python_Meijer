...
public final class h {
    ...
    public static final class a implements Function1<i, Unit> {
        ...
        public static final a f170791a = new a();
    ...
    @SourceDebugExtension
    public static final class b extends Ji.c<Integer, i, i> {
        ...
        public static final class a implements Function0<i> {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ Ji.h f170795a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ b f170796b;
            ...
            /* JADX WARN: Type inference failed for: r0v0, types: [Ji.h, java.lang.Object, xi.i] */
            @Override // kotlin.jvm.functions.Function0
            /* renamed from: a, reason: merged with bridge method [inline-methods] */
            public final i invoke() {
                ?? r02 = this.f170795a;
                this.f170796b.t().getValue().invoke(r02);
                return r02;
            }
        }
    ...
    static final class c implements Function3<LocalThemeScope, Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ int f170797a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ String f170798b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ boolean f170799c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f170800d;

        c(int i10, String str, boolean z10, Function0<Unit> function0) {
            this.f170797a = i10;
            this.f170798b = str;
            this.f170799c = z10;
            this.f170800d = function0;
        }
        ...
        public final void a(LocalThemeScope AdsTheme, Composer composer, int i10) {
            ...
            Ni.c.c(this.f170797a, this.f170798b, this.f170799c, this.f170800d, C15040a.f140849r, AdsTheme.getAdsColors().getAdsColorBrandPrimary().getColor(), AdsTheme.getAdsColors().getAdsColorBrandSecondary().getColor(), composer, 0, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class d implements Function3<LocalThemeScope, Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ int f170801a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ String f170802b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ boolean f170803c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f170804d;

        d(int i10, String str, boolean z10, Function0<Unit> function0) {
            this.f170801a = i10;
            this.f170802b = str;
            this.f170803c = z10;
            this.f170804d = function0;
        }
        ...
        public final void a(LocalThemeScope AdsTheme, Composer composer, int i10) {
            ...
            Ni.c.c(this.f170801a, this.f170802b, this.f170803c, this.f170804d, C15040a.f140831n1, AdsTheme.getAdsColors().getAdsColorBrandPrimary().getColor(), AdsTheme.getAdsColors().getAdsColorBrandSecondary().getColor(), composer, 0, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    */
    public static final void d(final Ki.LocalThemeScope r16, java.lang.Integer r17, int r18, final ki.q1.Badge r19, ki.q1.h.DrawableIcon r20, final kotlin.jvm.functions.Function0<kotlin.Unit> r21, androidx.compose.runtime.Composer r22, final int r23, final int r24) {
        /*
            Method dump skipped, instructions count: 386
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: xi.h.d(Ki.M, java.lang.Integer, int, ki.q1$b, ki.q1$h$b, kotlin.jvm.functions.Function0, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void f(final int i10, final String str, final boolean z10, final Function0<Unit> onClick, Composer composer, final int i11) {
        ...
        if (t0L != null) {
            t0L.a(new Function2() { // from class: xi.g
    ...
    public static final void h(final int i10, final String str, final boolean z10, final Function0<Unit> onClick, Composer composer, final int i11) {
        ...
        T0 t0L = composerStartRestartGroup.l();
        if (t0L != null) {
            t0L.a(new Function2() { // from class: xi.f
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
