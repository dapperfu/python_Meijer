...
public class d {
    ...
    private final Object f151999a;

    /* renamed from: b, reason: collision with root package name */
    private final View f152000b;
    ...
    public void a() {
        if (Build.VERSION.SDK_INT >= 29) {
            ContentCaptureSession contentCaptureSessionA = c.a(this.f151999a);
            b bVarA = e.a(this.f152000b);
    ...
    public f c(AutofillId autofillId, long j10) {
        if (Build.VERSION.SDK_INT >= 29) {
            return f.i(a.b(c.a(this.f151999a), autofillId, j10));
        }
        return null;
    }
