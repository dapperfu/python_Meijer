...
public final class i {
    ...
    static final class a extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        ...
        private /* synthetic */ Object f8190f;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ TransactionDetails f8192h;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(TransactionDetails transactionDetails, Continuation<? super a> continuation) {
            super(2, continuation);
            this.f8192h = transactionDetails;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            a aVar = i.this.new a(this.f8192h, continuation);
            aVar.f8190f = obj;
            return aVar;
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r8) {
            /*
                ...
                if (r1 == r3) goto L25
                if (r1 != r2) goto L1d
                java.lang.Object r0 = r7.f8185a
                mv.O r0 = (mv.InterfaceC15783O) r0
                java.lang.Object r0 = r7.f8190f
                mv.O r0 = (mv.InterfaceC15783O) r0
            ...
            L25:
                int r1 = r7.f8188d
                java.lang.Object r3 = r7.f8187c
                Bp.c r3 = (Bp.c) r3
                java.lang.Object r4 = r7.f8186b
                mv.O r4 = (mv.InterfaceC15783O) r4
                java.lang.Object r5 = r7.f8185a
                zp.i r5 = (zp.TransactionDetails) r5
                java.lang.Object r6 = r7.f8190f
                mv.O r6 = (mv.InterfaceC15783O) r6
                kotlin.ResultKt.b(r8)     // Catch: java.lang.Throwable -> L1a
                goto L68
            L3b:
                kotlin.ResultKt.b(r8)
                java.lang.Object r8 = r7.f8190f
                r4 = r8
                mv.O r4 = (mv.InterfaceC15783O) r4
                Ep.i r8 = Ep.i.this
                zp.i r5 = r7.f8192h
                ...
                Yi.a r8 = Ep.i.b(r8)     // Catch: java.lang.Throwable -> L1a
                r7.f8190f = r4     // Catch: java.lang.Throwable -> L1a
                r7.f8185a = r5     // Catch: java.lang.Throwable -> L1a
                r7.f8186b = r4     // Catch: java.lang.Throwable -> L1a
                r7.f8187c = r1     // Catch: java.lang.Throwable -> L1a
                r6 = 0
                r7.f8188d = r6     // Catch: java.lang.Throwable -> L1a
                r7.f8189e = r3     // Catch: java.lang.Throwable -> L1a
            ...
            L68:
                ...
                r7.f8190f = r6     // Catch: java.lang.Throwable -> L1a
                r7.f8185a = r4     // Catch: java.lang.Throwable -> L1a
                r4 = 0
                r7.f8186b = r4     // Catch: java.lang.Throwable -> L1a
                r7.f8187c = r4     // Catch: java.lang.Throwable -> L1a
                r7.f8188d = r1     // Catch: java.lang.Throwable -> L1a
                r7.f8189e = r2     // Catch: java.lang.Throwable -> L1a
            ...
            La8:
                ...
                kotlin.Unit r8 = kotlin.Unit.f143329a     // Catch: java.lang.Throwable -> Lbc
    ...
    static final class b extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: f, reason: collision with root package name */
        private /* synthetic */ Object f8198f;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            b bVar = i.this.new b(this.f8200h, continuation);
            bVar.f8198f = obj;
            return bVar;
        }
    ...
    public i(Yi.a userTokenGateway, Bp.c transactionsApi, AbstractC15779K ioDispatcher) {
    ...
    public final Object d(TransactionDetails transactionDetails, Continuation<? super Unit> continuation) {
        Object objG = C15805i.g(this.ioDispatcher, new a(transactionDetails, null), continuation);
        return objG == IntrinsicsKt.f() ? objG : Unit.f143329a;
    }

    public final Object e(String str, Continuation<? super Unit> continuation) {
        Object objG = C15805i.g(this.ioDispatcher, new b(str, null), continuation);
        return objG == IntrinsicsKt.f() ? objG : Unit.f143329a;
    }
}
