...
final /* synthetic */ class f {
    public static final <VM extends c0> VM a(Class<VM> cls, h0 h0Var, String str, f0.c cVar, CreationExtras creationExtras, Composer composer, int i10, int i11) {
        if ((i11 & 2) != 0 && (h0Var = b.f40696a.c(composer, 6)) == null) {
        ...
        if ((i11 & 16) != 0) {
            creationExtras = h0Var instanceof InterfaceC6162j ? ((InterfaceC6162j) h0Var).getDefaultViewModelCreationExtras() : CreationExtras.b.f39630c;
        }
        if (ComposerKt.M()) {
