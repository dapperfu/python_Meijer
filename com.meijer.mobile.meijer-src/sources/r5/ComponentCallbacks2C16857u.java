...
public final class ComponentCallbacks2C16857u implements ComponentCallbacks2, f.a {
    ...
    private final synchronized void d() {
        try {
            a5.k kVar = this.imageLoader.get();
            if (kVar == null) {
                e();
            } else if (this.networkObserver == null) {
                l5.f fVarA = kVar.getOptions().getNetworkObserverEnabled() ? l5.g.a(kVar.getContext(), this, kVar.getLogger()) : new l5.e();
    ...
    public synchronized void a(boolean isOnline) {
        try {
            a5.k kVar = this.imageLoader.get();
            if (kVar != null) {
                InterfaceC16855s logger = kVar.getLogger();
    ...
    public final synchronized void e() {
        try {
            ...
            l5.f fVar = this.networkObserver;
            if (fVar != null) {
                fVar.shutdown();
            }
    ...
    public ComponentCallbacks2C16857u(a5.k kVar) {
