...
public final class C16103a extends c implements N0 {
    ...
    static final class b extends Lambda implements Function0<C2382a> {
        ...
        public static final class C2382a implements Drawable.Callback {
            ...
            public void scheduleDrawable(Drawable d10, Runnable what, long time) {
                ...
                C16104b.d().postAtTime(what, time);
            }
            ...
            public void unscheduleDrawable(Drawable d10, Runnable what) {
                Intrinsics.j(d10, "d");
                Intrinsics.j(what, "what");
                C16104b.d().removeCallbacks(what);
            }
        }
        ...
        public final C2382a invoke() {
            return new C2382a(C16103a.this);
        }
    }
    ...
    public C16103a(Drawable drawable) {
        Intrinsics.j(drawable, "drawable");
        this.drawable = drawable;
        this.drawInvalidateTick = t1.e(0, null, 2, null);
        this.drawableIntrinsicSize = t1.e(k.c(C16104b.c(drawable)), null, 2, null);
    ...
    protected boolean a(float alpha) {
        this.drawable.setAlpha(RangesKt.o(MathKt.d(alpha * l3.f93323c), 0, l3.f93323c));
        return true;
    }
    ...
    protected boolean d(t layoutDirection) {
        ...
        int i10 = C2381a.$EnumSwitchMapping$0[layoutDirection.ordinal()];
        int i11 = 1;
        if (i10 == 1) {
            i11 = 0;
        } else if (i10 != 2) {
