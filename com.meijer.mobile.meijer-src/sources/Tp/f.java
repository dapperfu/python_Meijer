...
public final class f implements Tp.a {
    ...
    public static final int f36649d = 8;

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final G __db;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final AbstractC6265i<ShopAndScanItemEntity> __insertAdapterOfShopAndScanItemEntity;

    @Metadata(d1 = {"\u0000%\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001J\u000f\u0010\u0004\u001a\u00020\u0003H\u0014¢\u0006\u0004\b\u0004\u0010\u0005J\u001f\u0010\n\u001a\u00020\t2\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\u0002H\u0014¢\u0006\u0004\b\n\u0010\u000b¨\u0006\f"}, d2 = {"Tp/f$a", "Landroidx/room/i;", "Lcom/meijer/mobile/shopandscan/data/local/entity/ShopAndScanItemEntity;", "", "b", "()Ljava/lang/String;", "LA4/d;", "statement", "entity", "", "d", "(LA4/d;Lcom/meijer/mobile/shopandscan/data/local/entity/ShopAndScanItemEntity;)V", "shopandscan_playstoreRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class a extends AbstractC6265i<ShopAndScanItemEntity> {
        a() {
        }
        ...
        public void a(A4.d statement, ShopAndScanItemEntity entity) {
    ...
    public /* synthetic */ class c {
        ...
        static {
            ...
            try {
                iArr[ShopAndScanItemEntity.c.f117771a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[ShopAndScanItemEntity.c.f117772b.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[ShopAndScanItemEntity.c.f117773c.ordinal()] = 3;
            ...
            try {
                iArr4[ShopAndScanItemEntity.Barcode.a.f117760a.ordinal()] = 1;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                iArr4[ShopAndScanItemEntity.Barcode.a.f117761b.ordinal()] = 2;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                iArr4[ShopAndScanItemEntity.Barcode.a.f117762c.ordinal()] = 3;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                iArr4[ShopAndScanItemEntity.Barcode.a.f117763d.ordinal()] = 4;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                iArr4[ShopAndScanItemEntity.Barcode.a.f117764e.ordinal()] = 5;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                iArr4[ShopAndScanItemEntity.Barcode.a.f117765f.ordinal()] = 6;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                iArr4[ShopAndScanItemEntity.Barcode.a.f117766g.ordinal()] = 7;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                iArr4[ShopAndScanItemEntity.Barcode.a.f117767h.ordinal()] = 8;
            } catch (NoSuchFieldError unused18) {
            }
            try {
                iArr4[ShopAndScanItemEntity.Barcode.a.f117768i.ordinal()] = 9;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit u(String str, String str2, A4.b _connection) {
    ...
    */
    public static final com.meijer.mobile.shopandscan.data.local.entity.ShopAndScanItemEntity v(java.lang.String r57, java.lang.String r58, Tp.f r59, A4.b r60) {
        /*
            Method dump skipped, instructions count: 934
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: Tp.f.v(java.lang.String, java.lang.String, Tp.f, A4.b):com.meijer.mobile.shopandscan.data.local.entity.ShopAndScanItemEntity");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final com.meijer.mobile.shopandscan.data.local.entity.ShopAndScanItemEntity w(java.lang.String r56, java.lang.String r57, Tp.f r58, A4.b r59) {
        /*
            Method dump skipped, instructions count: 940
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: Tp.f.w(java.lang.String, java.lang.String, Tp.f, A4.b):com.meijer.mobile.shopandscan.data.local.entity.ShopAndScanItemEntity");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit x(f fVar, ShopAndScanItemEntity shopAndScanItemEntity, A4.b _connection) {
        Intrinsics.j(_connection, "_connection");
    ...
    public Object a(final String str, Continuation<? super ShopAndScanItemEntity> continuation) {
        ...
        return C17824b.f(this.__db, true, false, new Function1() { // from class: Tp.e
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return f.w(str2, str, this, (A4.b) obj);
            }
        }, continuation);
    }
    ...
    public Object b(final ShopAndScanItemEntity shopAndScanItemEntity, Continuation<? super Unit> continuation) {
        Object objF = C17824b.f(this.__db, false, true, new Function1() { // from class: Tp.b
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return f.x(this.f36638a, shopAndScanItemEntity, (A4.b) obj);
            }
        }, continuation);
    ...
    public Object c(final String str, Continuation<? super ShopAndScanItemEntity> continuation) {
        ...
        return C17824b.f(this.__db, true, false, new Function1() { // from class: Tp.c
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return f.v(str2, str, this, (A4.b) obj);
            }
        }, continuation);
    }
    ...
    public Object d(final String str, Continuation<? super Unit> continuation) {
        ...
        Object objF = C17824b.f(this.__db, false, true, new Function1() { // from class: Tp.d
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return f.u(str2, str, (A4.b) obj);
            }
        }, continuation);
        return objF == IntrinsicsKt.f() ? objF : Unit.f143329a;
    }
