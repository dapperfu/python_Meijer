...
public final /* data */ class Department implements Parcelable {
    ...
    public Department(String str, String str2, String id2, String name, String str3, boolean z10, String collectionId, List<Department> subcategories) {
        ...
        if (str5 == null || (listB1 = StringsKt.b1(str5, new String[]{"-"}, false, 0, 6, null)) == null || (str4 = (String) CollectionsKt.s0(listB1)) == null) {
    ...
    public final nk.l e() {
        return StringsKt.s0(this.collectionId) ? new l.Department(this.id, this.name) : new l.BrowseCollection(this.collectionId, this.name);
    }
