...
public class C13754a {

    /* renamed from: a, reason: collision with root package name */
    private final Context f129400a;

    /* renamed from: e2.a$a, reason: collision with other inner class name */
    class C2038a extends FingerprintManager.AuthenticationCallback {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ c f129401a;
        ...
        public void onAuthenticationError(int i10, CharSequence charSequence) {
            this.f129401a.a(i10, charSequence);
        }
        ...
        public void onAuthenticationHelp(int i10, CharSequence charSequence) {
            this.f129401a.c(i10, charSequence);
        }

        @Override // android.hardware.fingerprint.FingerprintManager.AuthenticationCallback
        public void onAuthenticationSucceeded(FingerprintManager.AuthenticationResult authenticationResult) {
            this.f129401a.d(new d(C13754a.g(b.b(authenticationResult))));
        }
    }
    ...
    public static class e {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final Signature f129403a;

        /* renamed from: b, reason: collision with root package name */
        private final Cipher f129404b;

        /* renamed from: c, reason: collision with root package name */
        private final Mac f129405c;

        public e(Signature signature) {
            this.f129403a = signature;
            this.f129404b = null;
            this.f129405c = null;
        }
    ...
    @Deprecated
    public void b(e eVar, int i10, C14924d c14924d, c cVar, Handler handler) {
        a(eVar, i10, c14924d != null ? (CancellationSignal) c14924d.b() : null, cVar, handler);
    }
    ...
    private C13754a(Context context) {
        this.f129400a = context;
    }
