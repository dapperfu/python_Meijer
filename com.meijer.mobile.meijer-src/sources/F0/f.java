...
public final class f<E> extends AbstractMutableList<E> implements e.a<E> {
    ...
    static final class a extends Lambda implements Function1<E, Boolean> {
        ...
        final /* synthetic */ Collection<E> f8860f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        a(Collection<? extends E> collection) {
            super(1);
            this.f8860f = collection;
        }

        @Override // kotlin.jvm.functions.Function1
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final Boolean invoke(E e10) {
            return Boolean.valueOf(this.f8860f.contains(e10));
        }
    }

    private final Object[] D(Object[] root, int index, int shift) {
        if (!(shift >= 0)) {
            C5899z0.a("shift should be positive");
        }
        if (shift == 0) {
            return root;
        }
    ...
    private final void X(Collection<? extends E> elements, int index, Object[] startBuffer, int startBufferSize, Object[][] buffers, int nullBuffers, Object[] nextBuffer) {
        Object[] objArrB;
        if (!(nullBuffers >= 1)) {
            C5899z0.a("requires at least one nullBuffer");
        }
        ...
        if (i11 < 32) {
            ArraysKt.o(objArrX, nextBuffer, size + 1, i10, startBufferSize);
        } else {
            int i12 = i11 - 31;
            if (nullBuffers == 1) {
                objArrB = objArrX;
            ...
            ArraysKt.o(objArrX, nextBuffer, 0, i13, startBufferSize);
            ArraysKt.o(objArrX, objArrB, size + 1, i10, i13);
            nextBuffer = objArrB;
        }
    ...
    public boolean addAll(Collection<? extends E> elements) {
        ...
        if (32 - iY >= elements.size()) {
            this.tail = k(x(this.tail), iY, it);
            this.size = size() + elements.size();
        } else {
            int size = ((elements.size() + iY) - 1) / 32;
            Object[][] objArr = new Object[size][];
            objArr[0] = k(x(this.tail), iY, it);
    ...
    private final Object[] W(int startLeafIndex, int rightShift, Object[][] buffers, int nullBuffers, Object[] nextBuffer) {
        ...
        ListIterator<Object[]> listIteratorV = v(U() >> 5);
        while (listIteratorV.previousIndex() != startLeafIndex) {
    ...
    private final Object[] x(Object[] buffer) {
        return buffer == null ? B() : u(buffer) ? buffer : ArraysKt.t(buffer, B(), 0, 0, RangesKt.k(buffer.length, 32), 6, null);
    }
    ...
    private final Object[] G(Object[] root, int rootSize, int shift, Iterator<Object[]> buffersIterator) {
        ...
        if (!buffersIterator.hasNext()) {
            C5899z0.a("invalid buffersIterator");
        }
        if (shift >= 0) {
            z10 = true;
        } else {
    ...
    private final Object[] H(Object[] root, int rootSize, Object[][] buffers) {
        ...
        int i11 = this.rootShift;
        if (i10 < (1 << i11)) {
            objArrX = G(root, rootSize, i11, itA);
        } else {
            objArrX = x(root);
        }
        while (itA.hasNext()) {
    ...
    private final Object[] K(Object[] root, Object[] tail, int shift) {
        ...
        objArrX[iA] = K((Object[]) objArrX[iA], tail, shift - 5);
        return objArrX;
    }
    ...
    private final boolean N(Function1<? super E, Boolean> predicate) {
        ...
        int iM = 32;
        while (iM == 32 && listIteratorV.hasNext()) {
            iM = M(predicate, listIteratorV.next(), 32, dVar);
        }
        if (iM == 32) {
            I0.a.a(!listIteratorV.hasNext());
        ...
        while (listIteratorV.hasNext()) {
            iL = L(predicate, listIteratorV.next(), 32, iL, dVar, arrayList2, arrayList);
        }
    ...
    private final Object[] R(Object[] root, int shift, int index, d tailCarry) {
        ...
        if (shift == 0) {
            Object obj = root[iA];
            Object[] objArrO = ArraysKt.o(root, x(root), iA, iA + 1, 32);
        ...
        if (i11 <= iA2) {
            while (true) {
                ...
                objArrX[iA2] = R((Object[]) obj2, i10, 0, tailCarry);
                if (iA2 == i11) {
                    break;
                }
                iA2--;
        ...
        objArrX[iA] = R((Object[]) obj3, i10, index, tailCarry);
        return objArrX;
    }
    ...
    private final Object S(Object[] root, int rootSize, int shift, int index) {
        ...
        Object[] objArrO = ArraysKt.o(objArr, x(objArr), index, index + 1, size);
        objArrO[size - 1] = null;
        this.root = root;
        this.tail = objArrO;
    ...
    private final Object[] V(Object[] root, int shift, int index, E e10, d oldElementCarry) {
        ...
        Intrinsics.h(obj, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
        objArrX[iA] = V((Object[]) obj, shift - 5, index, e10, oldElementCarry);
        return objArrX;
    }
    ...
    private final Object[] s(Object[] root, int shift, int index, Object element, d elementCarry) {
        ...
        if (shift == 0) {
            ...
            Object[] objArrO = ArraysKt.o(root, x(root), iA + 1, iA, 31);
            objArrO[iA] = element;
            return objArrO;
        }
        Object[] objArrX = x(root);
    ...
    private final void t(Object[] root, int index, E element) {
        ...
        Object[] objArrX = x(this.tail);
        if (iY < 32) {
            ArraysKt.o(this.tail, objArrX, index + 1, index, iY);
        ...
        ArraysKt.o(objArr, objArrX, index + 1, index, 31);
        objArrX[index] = element;
        I(root, objArrX, C(obj));
    }
    ...
    public boolean addAll(int index, Collection<? extends E> elements) {
        ...
        if (size == 0) {
            ...
            Object[] objArr2 = this.tail;
            Object[] objArrO2 = ArraysKt.o(objArr2, x(objArr2), size2 + 1, i11, Y());
        ...
        if (index >= U()) {
            ...
            if (iZ > iY) {
                int i12 = iZ - iY;
                Object[] objArrY = y(fVar.tail, i12);
                fVar.r(collection, index, i12, objArr3, size, objArrY);
                objArr = objArr3;
                objArrO = objArrY;
            } else {
                int i13 = iY - iZ;
                ...
                int i14 = 32 - i13;
                Object[] objArrY2 = y(fVar.tail, i14);
                int i15 = size - 1;
                objArr3[i15] = objArrY2;
                fVar.r(collection, index, i14, objArr3, i15, objArrY2);
