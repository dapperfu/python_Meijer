...
public final class e<E> extends b<E> implements E0.e<E> {
    ...
    public e(Object[] objArr, Object[] objArr2, int i10, int i11) {
        ...
        if (!z10) {
            C5899z0.a("Trie-based persistent vector should have at least 33 elements, got " + size());
        }
    ...
    */
    ...
    private final Object[] u(Object[] root, int shift, int index, d tailCarry) {
        Object[] objArrCopyOf;
        int iA = l.a(index, shift);
        int iA2 = 31;
        if (shift == 0) {
        ...
        if (i11 <= iA2) {
            while (true) {
                ...
                Intrinsics.h(obj, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
                objArrCopyOf2[iA2] = u((Object[]) obj, i10, 0, tailCarry);
                if (iA2 == i11) {
                    break;
                }
                iA2--;
        ...
        Intrinsics.h(obj2, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
        objArrCopyOf2[iA] = u((Object[]) obj2, i10, index, tailCarry);
        return objArrCopyOf2;
    }

    private final E0.e<E> v(Object[] root, int rootSize, int shift, int index) {
        boolean z10;
    ...
    private final Object[] y(Object[] root, int shift, int index, Object e10) {
        int iA = l.a(index, shift);
        Object[] objArrCopyOf = Arrays.copyOf(root, 32);
        Intrinsics.i(objArrCopyOf, "copyOf(...)");
        if (shift == 0) {
        ...
        Intrinsics.h(obj, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
        objArrCopyOf[iA] = y((Object[]) obj, shift - 5, index, e10);
        return objArrCopyOf;
    }
    ...
    public E0.e<E> set(int index, E element) {
        ...
        return new e(y(this.root, this.rootShift, index, element), this.tail, size(), this.rootShift);
    }
    ...
    public E0.e<E> v0(int index) {
        ...
        int iX = x();
        if (index >= iX) {
            return v(this.root, iX, this.rootShift, index - iX);
        }
        return v(u(this.root, this.rootShift, index, new d(this.tail[0])), iX, this.rootShift, 0);
    }
    ...
    public E0.e<E> add(int index, E element) {
        ...
        int iX = x();
        if (index >= iX) {
            return p(this.root, index - iX, element);
        }
        d dVar = new d(null);
