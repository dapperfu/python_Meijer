...
public final class d implements q {
    ...
    private static Ig.b b(byte[][] bArr, int i10) {
        int i11 = i10 * 2;
        Ig.b bVar = new Ig.b(bArr[0].length + i11, bArr.length + i11);
        bVar.b();
        int iJ = (bVar.j() - i10) - 1;
        int i12 = 0;
    ...
    public Ig.b a(String str, com.google.zxing.a aVar, int i10, int i11, Map<f, ?> map) throws WriterException {
        ...
        if (map != null) {
            ...
            if (map.containsKey(fVar2)) {
                eVar.i(Zg.c.valueOf(map.get(fVar2).toString()));
            }
            f fVar3 = f.PDF417_DIMENSIONS;
            if (map.containsKey(fVar3)) {
                Zg.d dVar = (Zg.d) map.get(fVar3);
    ...
    private static Ig.b c(e eVar, String str, int i10, int i11, int i12, int i13, boolean z10) throws WriterException {
        boolean z11;
        boolean z12;
        boolean z13;
        eVar.e(str, i10, z10);
