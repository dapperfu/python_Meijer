...
public final class C14274a implements Parcelable {
    ...
    @JvmField
    public static final Parcelable.Creator<C14274a> CREATOR = new C2111a();
    ...
    public static final class C2111a implements Parcelable.Creator<C14274a> {
        @Override // android.os.Parcelable.Creator
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public C14274a createFromParcel(Parcel parcel) {
            Intrinsics.j(parcel, "parcel");
            return new C14274a(parcel);
        }

        @Override // android.os.Parcelable.Creator
        /* renamed from: b, reason: merged with bridge method [inline-methods] */
        public C14274a[] newArray(int size) {
            return new C14274a[size];
        }
    ...
    public C14274a(int i10, Intent intent) {
        this.resultCode = i10;
        this.data = intent;
    }
