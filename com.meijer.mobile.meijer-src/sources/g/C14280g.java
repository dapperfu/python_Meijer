...
public final class C14280g implements Parcelable {
    ...
    @JvmField
    public static final Parcelable.Creator<C14280g> CREATOR = new b();
    ...
    public static final class a {
        ...
        public final C14280g a() {
            return new C14280g(this.intentSender, this.fillInIntent, this.flagsMask, this.flagsValues);
        }
    ...
    /* renamed from: g.g$b */
    public static final class b implements Parcelable.Creator<C14280g> {
        @Override // android.os.Parcelable.Creator
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public C14280g createFromParcel(Parcel inParcel) {
            Intrinsics.j(inParcel, "inParcel");
            return new C14280g(inParcel);
        }

        @Override // android.os.Parcelable.Creator
        /* renamed from: b, reason: merged with bridge method [inline-methods] */
        public C14280g[] newArray(int size) {
            return new C14280g[size];
        }
    ...
    public C14280g(IntentSender intentSender, Intent intent, int i10, int i11) {
        Intrinsics.j(intentSender, "intentSender");
        this.intentSender = intentSender;
