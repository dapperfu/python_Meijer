...
public final class u {
    ...
    private final LruCache<C17338c, TextLayoutResult> cache;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private C17338c singleSizeCacheInput;
    ...
    public final TextLayoutResult a(TextLayoutInput key) {
        ...
        C17338c c17338c = new C17338c(key);
        LruCache<C17338c, TextLayoutResult> lruCache = this.cache;
        if (lruCache != null) {
            textLayoutResultD = lruCache.d(c17338c);
        } else {
            if (!Intrinsics.e(this.singleSizeCacheInput, c17338c)) {
                return null;
            }
    ...
    public final void b(TextLayoutInput key, TextLayoutResult value) {
        LruCache<C17338c, TextLayoutResult> lruCache = this.cache;
        if (lruCache != null) {
            lruCache.f(new C17338c(key), value);
        } else {
            this.singleSizeCacheInput = new C17338c(key);
            this.singleSizeCacheResult = value;
        }
    }

    public u(int i10) {
        LruCache<C17338c, TextLayoutResult> lruCache;
        if (i10 != 1) {
