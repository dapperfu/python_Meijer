...
public final class a {
    ...
    static final class C0321a<Original> extends Lambda implements Function2<m, Original, Object> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function2<m, Original, List<Saveable>> f17724f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C0321a(Function2<? super m, ? super Original, ? extends List<? extends Saveable>> function2) {
            super(2);
            this.f17724f = function2;
        }

        @Override // kotlin.jvm.functions.Function2
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final Object invoke(m mVar, Original original) {
            List list = (List) this.f17724f.invoke(mVar, original);
            List list2 = list;
            int size = list2.size();
    ...
    public static final <Original, Saveable> k<Original, Object> a(Function2<? super m, ? super Original, ? extends List<? extends Saveable>> function2, Function1<? super List<? extends Saveable>, ? extends Original> function1) {
        C0321a c0321a = new C0321a(function2);
        ...
        return l.a(c0321a, (Function1) TypeIntrinsics.f(function1, 1));
    }
}
