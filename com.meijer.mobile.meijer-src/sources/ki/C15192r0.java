...
@Metadata(d1 = {"\u0000T\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0002\u0018\u00002\u00020\u0001B\u001b\u0012\u0012\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0001\u0012\u0004\u0012\u00020\u00010\u0002¢\u0006\u0004\b\u0004\u0010\u0005J!\u0010\u000b\u001a\u00020\n2\u0006\u0010\u0007\u001a\u00020\u00062\b\b\u0002\u0010\t\u001a\u00020\bH\u0007¢\u0006\u0004\b\u000b\u0010\fJ\u0017\u0010\r\u001a\u00020\n2\u0006\u0010\u0007\u001a\u00020\u0006H\u0007¢\u0006\u0004\b\r\u0010\u000eJ\u0017\u0010\u0010\u001a\u00020\u000f2\u0006\u0010\u0007\u001a\u00020\u0006H\u0007¢\u0006\u0004\b\u0010\u0010\u0011J\u0017\u0010\u0013\u001a\u00020\u00122\u0006\u0010\u0007\u001a\u00020\u0006H\u0007¢\u0006\u0004\b\u0013\u0010\u0014J\u0017\u0010\u0016\u001a\u00020\u00152\u0006\u0010\u0007\u001a\u00020\u0006H\u0007¢\u0006\u0004\b\u0016\u0010\u0017J\u0017\u0010\u0019\u001a\u00020\u00182\u0006\u0010\u0007\u001a\u00020\u0006H\u0007¢\u0006\u0004\b\u0019\u0010\u001aJ\u0017\u0010\u001b\u001a\u00020\u00182\u0006\u0010\u0007\u001a\u00020\u0006H\u0007¢\u0006\u0004\b\u001b\u0010\u001aJ\u0017\u0010\u001d\u001a\u00020\u001c2\u0006\u0010\u0007\u001a\u00020\u0006H\u0007¢\u0006\u0004\b\u001d\u0010\u001eJ\u000f\u0010 \u001a\u00020\u001fH\u0007¢\u0006\u0004\b \u0010!R#\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0001\u0012\u0004\u0012\u00020\u00010\u00028\u0006¢\u0006\f\n\u0004\b\"\u0010#\u001a\u0004\b$\u0010%¨\u0006&"}, d2 = {"Lki/r0;", "", "Lkotlin/Pair;", "dimensions", "<init>", "(Lkotlin/Pair;)V", "LKi/M;", "themeScope", "LH1/h;", "height", "Lki/q1$f$e;", "h", "(LKi/M;FLandroidx/compose/runtime/Composer;II)Lki/q1$f$e;", "j", "(LKi/M;Landroidx/compose/runtime/Composer;I)Lki/q1$f$e;", "Lki/q1$f$d;", "g", "(LKi/M;Landroidx/compose/runtime/Composer;I)Lki/q1$f$d;", "Lki/q1$f$c;", "e", "(LKi/M;Landroidx/compose/runtime/Composer;I)Lki/q1$f$c;", "Lki/q1$f$b;", "b", "(LKi/M;Landroidx/compose/runtime/Composer;I)Lki/q1$f$b;", "LAi/c1;", "i", "(LKi/M;Landroidx/compose/runtime/Composer;I)LAi/c1;", "k", "Lki/q1$j;", "d", "(LKi/M;Landroidx/compose/runtime/Composer;I)Lki/q1$j;", "Lki/q1$h$b;", "c", "(Landroidx/compose/runtime/Composer;I)Lki/q1$h$b;", "a", "Lkotlin/Pair;", "getDimensions", "()Lkotlin/Pair;", "library_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* renamed from: ki.r0, reason: case insensitive filesystem */
/* loaded from: classes8.dex */
final class C15192r0 {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final Pair<Object, Object> dimensions;

    public C15192r0(Pair<Object, Object> dimensions) {
    ...
    public final q1.f.Dropdown b(LocalThemeScope themeScope, Composer composer, int i10) {
        ...
        q1.f.Dropdown dropdown = new q1.f.Dropdown(null, false, null, themeScope.getAdsTypography().getBodyCompact().getOne(), null, null, null, false, 1, null, C16806i.c(themeScope.getAdsCornerRadii().getRadius04().getDp()), i(themeScope, composer, i10 & 126), 759, null);
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        composer.P();
    ...
    public final q1.f.QuantityInput e(LocalThemeScope themeScope, Composer composer, int i10) {
        ...
        Modifier modifierB = r1.b(androidx.compose.foundation.layout.x.a(androidx.compose.foundation.layout.J.k(companion, H1.h.p(this.dimensions.c() instanceof C15188p0 ? 40 : 32), 0.0f, 2, null), j0.x.f139749a), false, 1, null);
        AdsTextFieldColors adsTextFieldColorsI = i(themeScope, composer, i10 & 126);
        Ki.I one = this.dimensions.c() instanceof C15188p0 ? themeScope.getAdsTypography().getBodyCompact().getOne() : themeScope.getAdsTypography().getBodyCompact().getTwo();
        RoundedCornerShape roundedCornerShapeC = C16806i.c(themeScope.getAdsCornerRadii().getRadius04().getDp());
        ...
        final InterfaceC5914o interfaceC5914o = (InterfaceC5914o) composer.o(C6034t0.h());
        composer.startReplaceGroup(5004770);
        boolean zD = composer.D(interfaceC5914o);
        Object objB = composer.B();
        if (zD || objB == Composer.INSTANCE.a()) {
            objB = new Function1() { // from class: ki.l0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return C15192r0.f(interfaceC5914o, (InterfaceC5834y) obj);
                }
            };
            composer.t(objB);
        }
        composer.P();
        q1.f.QuantityInput quantityInput = new q1.f.QuantityInput(modifierB, false, null, one, null, keyboardOptions, new C5835z((Function1) objB, null, null, null, null, null, 62, null), false, 1, null, roundedCornerShapeC, adsTextFieldColorsI, null, ((this.dimensions.c() instanceof C15188p0) && (this.dimensions.d() instanceof C15186o0)) ? C15181m.f142151a : ((this.dimensions.c() instanceof C15190q0) && (this.dimensions.d() instanceof C15186o0)) ? C15189q.f142178a : ((this.dimensions.c() instanceof C15188p0) && (this.dimensions.d() instanceof C15182m0)) ? C15183n.f142165a : ((this.dimensions.c() instanceof C15190q0) && (this.dimensions.d() instanceof C15182m0)) ? C15191r.f142443a : this.dimensions.d() instanceof C15184n0 ? C15183n.f142165a : C15181m.f142151a, androidx.compose.foundation.layout.D.k(companion, H1.h.p(4), 0.0f, 2, null), this.dimensions.d() instanceof C15184n0, 4758, null);
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        composer.P();
    ...
    public final q1.f.TextArea g(LocalThemeScope themeScope, Composer composer, int i10) {
        ...
        q1.f.TextArea textArea = new q1.f.TextArea(androidx.compose.foundation.layout.J.h(androidx.compose.foundation.layout.J.i(Modifier.INSTANCE, H1.h.p(110)), 0.0f, 1, null), false, null, themeScope.getAdsTypography().getBodyCompact().getOne(), null, null, null, false, 0, null, C16806i.c(themeScope.getAdsCornerRadii().getRadius04().getDp()), i(themeScope, composer, i10 & 126), 1014, null);
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        composer.P();
    ...
    public final q1.f.TextInput h(LocalThemeScope themeScope, float f10, Composer composer, int i10, int i11) {
        ...
        q1.f.TextInput textInput = new q1.f.TextInput(androidx.compose.foundation.layout.J.h(androidx.compose.foundation.layout.J.i(Modifier.INSTANCE, fP), 0.0f, 1, null), false, null, themeScope.getAdsTypography().getBodyCompact().getOne(), null, null, null, false, 1, null, C16806i.c(themeScope.getAdsCornerRadii().getRadius04().getDp()), i(themeScope, composer, ((i10 >> 3) & 112) | (i10 & 14)), 758, null);
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        composer.P();
    ...
    public final q1.f.TextInput j(LocalThemeScope themeScope, Composer composer, int i10) {
        ...
        q1.f.TextInput textInput = new q1.f.TextInput(androidx.compose.foundation.layout.J.h(androidx.compose.foundation.layout.J.i(Modifier.INSTANCE, H1.h.p(40)), 0.0f, 1, null), false, null, themeScope.getAdsTypography().getBodyCompact().getOne(), null, null, null, false, 1, null, C16806i.c(themeScope.getAdsCornerRadii().getRadius04().getDp()), k(themeScope, composer, i10 & 126), 758, null);
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        composer.P();
    ...
    public final AdsTextFieldColors k(LocalThemeScope themeScope, Composer composer, int i10) {
        ...
        long color2 = T.a.C3937e.f17378c.getColor();
        long color3 = themeScope.getAdsColors().getAdsColorBrandPrimary().getColor();
        AdsTextFieldColors adsTextFieldColorsO = C2841r0.o(g12, color, 0L, color2, themeScope.getAdsColors().getAdsColorInverse().getColor(), 0L, 0L, 0L, themeScope.getAdsColors().getAdsColorBrandPrimary().getColor(), color3, themeScope.getAdsColors().getAdsColorsDisabled().getColor(), themeScope.getAdsColors().getAdsColorSupportError().getColor(), themeScope.getAdsColors().getAdsColorSupportWarning().getColor(), themeScope.getAdsColors().getAdsColorSupportSuccess().getColor(), 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, composer, 6, 0, 0, 0, 2147475570);
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        composer.P();
    ...
    public final q1.h.DrawableIcon c(Composer composer, int i10) {
        ...
        q1.h.DrawableIcon drawableIcon = new q1.h.DrawableIcon(C.d.f17039c, null, null, null, 0.0f, null, androidx.compose.foundation.layout.J.v(Modifier.INSTANCE, H1.h.p(24)), 62, null);
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        composer.P();
