...
public final class k {
    ...
    static final char[] f23741a = {'!', '\"', '#', '$', '%', '&', '\'', '(', ')', '*', '+', ',', '-', '.', '/', ':', ';', '<', '=', '>', '?', '@', '[', '\\', ']', '^', '_'};

    private static final class b {

        /* renamed from: g, reason: collision with root package name */
        private static final int[] f23744g = {3, 5, 8, 10, 12, 16, 18, 22, 30, 32, 36, 44, 49, 62, 86, 114, 144, 174, HttpResponseStatus.SUCCESS_NO_CONTENT, 280, 368, 456, 576, 696, 816, 1050, 1304, 1558};

        /* renamed from: h, reason: collision with root package name */
        private static final int[] f23745h = {3, 5, 8, 12, 18, 22, 30, 36, 44, 62, 86, 114, 144, 174, HttpResponseStatus.SUCCESS_NO_CONTENT, 280, 368, 456, 576, 696, 816, 1050, 1304, 1558};

        /* renamed from: i, reason: collision with root package name */
        private static final int[] f23746i = {5, 10, 16, 33, 32, 49};

        /* renamed from: a, reason: collision with root package name */
        private final c f23747a;

        /* renamed from: b, reason: collision with root package name */
        private final d f23748b;
        ...
        int g() {
            int i10 = 0;
            for (b bVar = this; bVar != null && bVar.f23748b == d.B256 && i10 <= 250; bVar = bVar.f23751e) {
                i10++;
            }
            return i10;
        }
        ...
        */
        private b(Og.k.c r6, Og.k.d r7, int r8, int r9, Og.k.b r10) {
            /*
                Method dump skipped, instructions count: 218
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: Og.k.b.<init>(Og.k$c, Og.k$d, int, int, Og.k$b):void");
        }
        ...
        static void y(byte[] bArr, int i10, int i11, int i12, int i13) {
            int i14 = ((i11 & l3.f93323c) * 1600) + ((i12 & l3.f93323c) * 40) + (i13 & l3.f93323c) + 1;
        ...
        byte[] k(boolean z10, int i10) {
            ...
            for (int i11 = 0; i11 < this.f23750d; i11++) {
                char cCharAt = this.f23747a.charAt(this.f23749c + i11);
        ...
        byte[] m() {
            switch (a.f23742a[this.f23748b.ordinal()]) {
                case 1:
                    return this.f23747a.a(this.f23749c) ? i(241, this.f23747a.b(this.f23749c) + 1) : k.k(this.f23747a.charAt(this.f23749c), this.f23747a.f()) ? i(235, this.f23747a.charAt(this.f23749c) - 127) : this.f23750d == 2 ? h(((this.f23747a.charAt(this.f23749c) - '0') * 10) + this.f23747a.charAt(this.f23749c + 1) + 82) : this.f23747a.h(this.f23749c) ? h(232) : h(this.f23747a.charAt(this.f23749c) + 1);
                case 2:
                    return h(this.f23747a.charAt(this.f23749c));
                case 3:
                    return k(true, this.f23747a.f());
                case 4:
                    return k(false, this.f23747a.f());
                case 5:
                    return x();
                case 6:
                    return n();
        ...
        byte[] n() {
            int iCeil = (int) Math.ceil(this.f23750d / 4.0d);
            byte[] bArr = new byte[iCeil * 3];
            int i10 = this.f23749c;
            int iMin = Math.min((this.f23750d + i10) - 1, this.f23747a.length() - 1);
            for (int i11 = 0; i11 < iCeil; i11 += 3) {
                int[] iArr = new int[4];
                for (int i12 = 0; i12 < 4; i12++) {
                    if (i10 <= iMin) {
                        iArr[i12] = this.f23747a.charAt(i10) & '?';
                        i10++;
                    } else {
                ...
                bArr[i11] = (byte) ((i13 >> 16) & l3.f93323c);
                bArr[i11 + 1] = (byte) ((i13 >> 8) & l3.f93323c);
                bArr[i11 + 2] = (byte) (i13 & l3.f93323c);
            }
            return bArr;
        }

        d o() {
            if (this.f23748b == d.EDF) {
                if (this.f23750d < 4) {
                    return d.ASCII;
                }
                int iP = p();
                if (iP > 0 && l(this.f23752f + iP) <= 2 - iP) {
                    return d.ASCII;
                }
            }
            d dVar = this.f23748b;
            if (dVar == d.C40 || dVar == d.TEXT || dVar == d.X12) {
                if (this.f23749c + this.f23750d >= this.f23747a.length() && l(this.f23752f) == 0) {
                    return d.ASCII;
                }
                if (p() == 1 && l(this.f23752f + 1) == 0) {
                    return d.ASCII;
                }
            }
            return this.f23748b;
        ...
        int p() {
            int length = this.f23747a.length();
            int i10 = this.f23749c + this.f23750d;
            int i11 = length - i10;
            if (i11 <= 4 && i10 < length) {
                if (i11 == 1) {
                    return k.k(this.f23747a.charAt(i10), this.f23747a.f()) ? 0 : 1;
                }
                if (i11 == 2) {
                    if (!k.k(this.f23747a.charAt(i10), this.f23747a.f())) {
                        int i12 = i10 + 1;
                        if (!k.k(this.f23747a.charAt(i12), this.f23747a.f())) {
                            return (j.f(this.f23747a.charAt(i10)) && j.f(this.f23747a.charAt(i12))) ? 1 : 2;
                        }
                    }
                    return 0;
                }
                if (i11 == 3) {
                    if (j.f(this.f23747a.charAt(i10)) && j.f(this.f23747a.charAt(i10 + 1)) && !k.k(this.f23747a.charAt(i10 + 2), this.f23747a.f())) {
                        return 2;
                    }
                    return (j.f(this.f23747a.charAt(i10 + 1)) && j.f(this.f23747a.charAt(i10 + 2)) && !k.k(this.f23747a.charAt(i10), this.f23747a.f())) ? 2 : 0;
                }
                if (j.f(this.f23747a.charAt(i10)) && j.f(this.f23747a.charAt(i10 + 1)) && j.f(this.f23747a.charAt(i10 + 2)) && j.f(this.f23747a.charAt(i10 + 3))) {
                    return 2;
                }
            }
            return 0;
        ...
        byte[] q() {
            ...
            switch (iArr[t().ordinal()]) {
                case 1:
                case 2:
                    int i10 = iArr[this.f23748b.ordinal()];
                    if (i10 == 2) {
                        return h(231);
                    }
                    if (i10 == 3) {
                ...
                case 5:
                    if (this.f23748b != t()) {
                        switch (iArr[this.f23748b.ordinal()]) {
                            case 1:
                                return h(254);
                            case 2:
                                return i(254, 231);
        ...
        int r(int i10) {
            int i11 = a.f23743b[this.f23747a.l().ordinal()];
            if (i11 == 1) {
                for (int i12 : f23745h) {
                    if (i12 >= i10) {
                        return i12;
        ...
        d u() {
            b bVar = this.f23751e;
            return bVar == null ? d.ASCII : bVar.f23748b;
        }

        byte[] x() {
            int i10 = (this.f23750d / 3) * 2;
            byte[] bArr = new byte[i10];
            for (int i11 = 0; i11 < i10; i11 += 2) {
                int i12 = (i11 / 2) * 3;
                y(bArr, i11, w(this.f23747a.charAt(this.f23749c + i12)), w(this.f23747a.charAt(this.f23749c + i12 + 1)), w(this.f23747a.charAt(this.f23749c + i12 + 2)));
            }
            return bArr;
        }
    ...
    private static final class c extends Ig.n {

        /* renamed from: c, reason: collision with root package name */
        private final m f23753c;
    ...
    private static final class e {
        ...
        static void a(List<Byte> list, int i10, int i11) {
            for (int i12 = 0; i12 < i11; i12++) {
                int i13 = i10 + i12;
                int iByteValue = (list.get(i13).byteValue() & 255) + (((i13 + 1) * 149) % l3.f93323c) + 1;
                if (iByteValue > 255) {
                    iByteValue -= 256;
                }
        ...
        e(b bVar) {
            ...
            int i11 = 0;
            if ((bVar.f23748b == d.C40 || bVar.f23748b == d.TEXT || bVar.f23748b == d.X12) && bVar.o() != d.ASCII) {
                iC = c(b.h(254), arrayList);
            } else {
                iC = 0;
            }
            for (b bVar2 = bVar; bVar2 != null; bVar2 = bVar2.f23751e) {
                iC += c(bVar2.m(), arrayList);
                if (bVar2.f23751e == null || bVar2.u() != bVar2.s()) {
                    if (bVar2.s() == d.B256) {
                        if (iC <= 249) {
            ...
            this.f23762a = new byte[arrayList.size()];
            while (true) {
                byte[] bArr = this.f23762a;
                if (i11 < bArr.length) {
    ...
    static /* synthetic */ class a {
        ...
        /* renamed from: b, reason: collision with root package name */
        static final /* synthetic */ int[] f23743b;
        ...
        static {
            ...
            try {
                f23743b[m.FORCE_RECTANGLE.ordinal()] = 2;
            ...
            try {
                f23742a[d.B256.ordinal()] = 2;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f23742a[d.C40.ordinal()] = 3;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f23742a[d.TEXT.ordinal()] = 4;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f23742a[d.X12.ordinal()] = 5;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f23742a[d.EDF.ordinal()] = 6;
    ...
    static void e(b[][] bVarArr, b bVar) {
        int i10 = bVar.f23749c + bVar.f23750d;
        if (bVarArr[i10][bVar.o().ordinal()] != null && bVarArr[i10][bVar.o().ordinal()].f23752f <= bVar.f23752f) {
            return;
        }
