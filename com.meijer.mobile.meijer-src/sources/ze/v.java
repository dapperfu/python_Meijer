...
public final class v {
    ...
    private static final i f172738a = new i("PhoneskyVerificationUtils");
        ...
        try {
            if (context.getPackageManager().getApplicationInfo("com.android.vending", 0).enabled) {
                ...
                if (signatureArr == null || (signatureArr.length) == 0) {
                    f172738a.e("Phonesky package is not signed -- possibly self-built package. Could not verify.", new Object[0]);
                } else {
