...
public abstract class O<E> extends J<E> implements Set<E> {
    ...
    public static class a<E> extends J.a<E> {
        ...
        public O<E> l() {
            ...
            if (i10 == 1) {
                Object obj = this.f7194a[0];
                Objects.requireNonNull(obj);
                return O.y(obj);
            }
            if (this.f7222d == null || O.q(i10) != this.f7222d.length) {
                oR = O.r(this.f7195b, this.f7194a);
                this.f7195b = oR.size();
            } else {
                Object[] objArrCopyOf = O.F(this.f7195b, this.f7194a.length) ? Arrays.copyOf(this.f7194a, this.f7195b) : this.f7194a;
                oR = new o0<>(objArrCopyOf, this.f7223e, this.f7222d, r5.length - 1, this.f7195b);
            }
            this.f7196c = true;
            this.f7222d = null;
            return oR;
        ...
        a<E> m(a<E> aVar) {
            ...
            for (int i10 = 0; i10 < aVar.f7195b; i10++) {
                Object obj = aVar.f7194a[i10];
                Objects.requireNonNull(obj);
                a(obj);
            }
            return this;
        ...
        public a<E> a(E e10) {
            De.p.q(e10);
            if (this.f7222d != null && O.q(this.f7195b) <= this.f7222d.length) {
                k(e10);
                return this;
            }
            this.f7222d = null;
    ...
    public static <E> O<E> E(E e10, E e11, E e12, E e13, E e14, E e15, E... eArr) {
        De.p.e(eArr.length <= 2147483641, "the total number of elements must fit in an int");
    ...
    static int q(int i10) {
        ...
        if (iMax >= 751619276) {
            De.p.e(iMax < 1073741824, "collection too large");
            return 1073741824;
        }
