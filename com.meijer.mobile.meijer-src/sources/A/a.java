...
public class a implements D.a {
    ...
    private final List<a.InterfaceC0103a> f3b = new ArrayList();

    /* renamed from: d, reason: collision with root package name */
    private List<InterfaceC3029n> f5d = new ArrayList();
    ...
    public String a(String str) {
        ...
        for (String str2 : this.f4c.get(str)) {
            Iterator<InterfaceC3029n> it = this.f5d.iterator();
            while (it.hasNext()) {
    ...
    public void d(int i10) {
        if (i10 != this.f7f) {
            Iterator<a.InterfaceC0103a> it = this.f3b.iterator();
            while (it.hasNext()) {
