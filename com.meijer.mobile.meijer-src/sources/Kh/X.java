...
@Metadata(d1 = {"\u0000L\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a9\u0010\t\u001a\u00020\u0007*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u00012\b\b\u0002\u0010\u0004\u001a\u00020\u00032\u0012\u0010\b\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u00070\u0005H\u0007¢\u0006\u0004\b\t\u0010\n\u001a;\u0010\u000f\u001a\u00020\u00072\u0006\u0010\f\u001a\u00020\u000b2\u0006\u0010\u000e\u001a\u00020\r2\u0012\u0010\b\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u00070\u00052\u0006\u0010\u0002\u001a\u00020\u0001H\u0002¢\u0006\u0004\b\u000f\u0010\u0010\u001a/\u0010\u0011\u001a\u00020\u0007*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u00012\u0012\u0010\b\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u00070\u0005H\u0003¢\u0006\u0004\b\u0011\u0010\u0012¨\u0006\u001c²\u0006\u0010\u0010\u0014\u001a\u0004\u0018\u00010\u00138\n@\nX\u008a\u008e\u0002²\u0006\u0014\u0010\u0017\u001a\b\u0012\u0004\u0012\u00020\u00160\u00158\n@\nX\u008a\u008e\u0002²\u0006\u000e\u0010\u0019\u001a\u00020\u00188\n@\nX\u008a\u008e\u0002²\u0006\u0010\u0010\u001b\u001a\u0004\u0018\u00010\u001a8\n@\nX\u008a\u008e\u0002"}, d2 = {"LKi/M;", "Lcom/meijer/mobile/accounts/ux/addresses/i$a;", "viewState", "Landroidx/compose/ui/Modifier;", "modifier", "Lkotlin/Function1;", "Lcom/meijer/mobile/accounts/ux/addresses/a;", "", "onResourceAction", "h", "(LKi/M;Lcom/meijer/mobile/accounts/ux/addresses/i$a;Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;II)V", "Lmv/O;", "coroutineScope", "Ld0/V;", "scrollState", "q", "(Lmv/O;Ld0/V;Lkotlin/jvm/functions/Function1;Lcom/meijer/mobile/accounts/ux/addresses/i$a;)V", "o", "(LKi/M;Lcom/meijer/mobile/accounts/ux/addresses/i$a;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;I)V", "", "lastAction", "", "LTh/c;", "addressSuggestions", "", "isLoading", "LTh/e;", "deleteAddressDecorator", "ux_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class X {
    ...
    public static final class b extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ L1.n f16738g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Function0 f16739h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ i.AddressesScreenViewState f16740i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f16741j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ Function1 f16742k;
        ...
        public b(L1.n nVar, int i10, Function0 function0, i.AddressesScreenViewState addressesScreenViewState, LocalThemeScope localThemeScope, Function1 function1) {
            super(2);
            this.f16738g = nVar;
            this.f16739h = function0;
            this.f16740i = addressesScreenViewState;
            this.f16741j = localThemeScope;
            this.f16742k = function1;
            this.f16737f = i10;
        }
        ...
        public final void a(Composer composer, int i10) {
            ...
            int helpersHashCode = this.f16738g.getHelpersHashCode();
            this.f16738g.i();
            L1.n nVar = this.f16738g;
            composer.startReplaceGroup(-1748284666);
            n.b bVarM = nVar.m();
            L1.h hVarA = bVarM.a();
            L1.h hVarC = bVarM.c();
            if (!this.f16740i.c().isEmpty()) {
                ...
                C3910t.g(this.f16741j, this.f16740i.c(), modifierK, this.f16742k, composer, LocalThemeScope.f17314g, 0);
                composer.P();
            } else if (this.f16740i.getDeleteAddressDecorator() != null) {
                composer.startReplaceGroup(-1747688661);
                O.b(this.f16741j, this.f16740i.getDeleteAddressDecorator(), null, composer, LocalThemeScope.f17314g, 2);
                composer.P();
            } else {
                ...
                composer.P();
                C3906o.l(this.f16741j, this.f16740i, nVar.k(companion2, hVarC, (Function1) objB2), this.f16742k, composer, LocalThemeScope.f17314g, 0);
                composer.P();
            }
            composer.P();
            if (this.f16738g.getHelpersHashCode() != helpersHashCode) {
                this.f16739h.invoke();
            }
        }
    ...
    static final class e extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new e(this.f16746b, continuation);
        }
    ...
    public static final Unit i(InterfaceC5914o interfaceC5914o) {
        InterfaceC5914o.l(interfaceC5914o, false, 1, null);
        return Unit.f143329a;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit m(InterfaceC5914o interfaceC5914o) {
        InterfaceC5914o.l(interfaceC5914o, false, 1, null);
        return Unit.f143329a;
    }
    ...
    */
    public static final void h(final Ki.LocalThemeScope r39, final com.meijer.mobile.accounts.ux.addresses.i.AddressesScreenViewState r40, androidx.compose.ui.Modifier r41, final kotlin.jvm.functions.Function1<? super com.meijer.mobile.accounts.ux.addresses.a, kotlin.Unit> r42, androidx.compose.runtime.Composer r43, final int r44, final int r45) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: Kh.X.h(Ki.M, com.meijer.mobile.accounts.ux.addresses.i$a, androidx.compose.ui.Modifier, kotlin.jvm.functions.Function1, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    private static final void o(final LocalThemeScope localThemeScope, i.AddressesScreenViewState addressesScreenViewState, Function1<? super com.meijer.mobile.accounts.ux.addresses.a, Unit> function1, Composer composer, final int i10) {
        ...
        if ((i11 & 147) == 146 && composerStartRestartGroup.j()) {
            ...
            Modifier modifierD = C16819m.d(modifierF, false, new a(a10), 1, null);
        ...
        if (t0L != null) {
            t0L.a(new Function2() { // from class: Kh.W
                @Override // kotlin.jvm.functions.Function2
    ...
    private static final void q(InterfaceC15783O interfaceC15783O, d0.V v10, Function1<? super com.meijer.mobile.accounts.ux.addresses.a, Unit> function1, i.AddressesScreenViewState addressesScreenViewState) {
        C15809k.d(interfaceC15783O, null, null, new e(v10, null), 3, null);
        function1.invoke(!addressesScreenViewState.c().isEmpty() ? a.h.f94908a : addressesScreenViewState.getDeleteAddressDecorator() != null ? a.d.f94904a : a.b.f94902a);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit j(InterfaceC15783O interfaceC15783O, d0.V v10, Function1 function1, i.AddressesScreenViewState addressesScreenViewState) {
        q(interfaceC15783O, v10, function1, addressesScreenViewState);
        return Unit.f143329a;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit l(InterfaceC15783O interfaceC15783O, d0.V v10, Function1 function1, i.AddressesScreenViewState addressesScreenViewState) {
        q(interfaceC15783O, v10, function1, addressesScreenViewState);
        return Unit.f143329a;
    }
}
