...
@Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0006\u0018\u0000 \u000f2\u00020\u0001:\u0001\bB\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u0017\u0010\b\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u0006H\u0002¢\u0006\u0004\b\b\u0010\tJ\u0017\u0010\f\u001a\u00020\u00062\u0006\u0010\u000b\u001a\u00020\nH\u0016¢\u0006\u0004\b\f\u0010\rR\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\b\u0010\u000e¨\u0006\u0010"}, d2 = {"LLl/b;", "Lokhttp3/Interceptor;", "LLl/c;", "hybrisResponseMonitor", "<init>", "(LLl/c;)V", "Lokhttp3/Response;", "response", "a", "(Lokhttp3/Response;)Lokhttp3/Response;", "Lokhttp3/Interceptor$Chain;", "chain", "intercept", "(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;", "LLl/c;", "b", "common_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    private final Response a(Response response) {
        ...
        if (list2 != null) {
            ...
            while (true) {
                ...
                if (it.hasNext()) {
                    next = it.next();
                    if (StringsKt.d0((String) next, "ROUTE=", false, 2, null)) {
                        break;
                    }
                } else {
                    next = null;
            ...
            if (str3 != null) {
                List listB12 = StringsKt.b1(str3, new String[]{";"}, false, 0, 6, null);
                if (listB12.isEmpty()) {
                    listB12 = null;
                }
                if (listB12 != null && (str = (String) listB12.get(0)) != null && (listB1 = StringsKt.b1(str, new String[]{"="}, false, 0, 6, null)) != null) {
                    if (listB1.size() >= 2) {
                        list = listB1;
                    }
