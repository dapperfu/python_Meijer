...
public final class C3126j {
    public static final C3125i a(C15429A c15429a, Function2<? super Integer, ? super Integer, Unit> onDragEnd, Function2<? super Integer, ? super Integer, Unit> onDrag, Composer composer, int i10, int i11) {
        Intrinsics.j(onDragEnd, "onDragEnd");
        Intrinsics.j(onDrag, "onDrag");
        composer.startReplaceGroup(2002916092);
        if ((i11 & 1) != 0) {
            c15429a = C15430B.b(0, 0, composer, 0, 3);
        }
        if (ComposerKt.M()) {
        ...
        if (objB == Composer.INSTANCE.a()) {
            objB = new C3125i(c15429a, onDragEnd, onDrag);
            composer.t(objB);
        }
        C3125i c3125i = (C3125i) objB;
        composer.P();
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
