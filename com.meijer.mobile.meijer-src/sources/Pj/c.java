...
@Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u00002\u00020\u0001B\u0015\u0012\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u0002¢\u0006\u0004\b\u0005\u0010\u0006B\t\b\u0017¢\u0006\u0004\b\u0005\u0010\u0007J\u0015\u0010\n\u001a\u00020\t2\u0006\u0010\b\u001a\u00020\u0003¢\u0006\u0004\b\n\u0010\u000bR \u0010\u000f\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00030\u00020\f8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\r\u0010\u000eR\u001d\u0010\u0012\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00030\u00020\u00108F¢\u0006\u0006\u001a\u0004\b\r\u0010\u0011¨\u0006\u0013"}, d2 = {"LPj/c;", "", "", "LPj/a;", "initialStates", "<init>", "(Ljava/util/List;)V", "()V", "state", "", "b", "(LPj/a;)V", "Lpv/B;", "a", "Lpv/B;", "loadingStatesStore", "Lpv/f;", "()Lpv/f;", "loadingStatesStream", "design_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* loaded from: classes8.dex */
public final class c {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC16549B<List<Pj.a>> loadingStatesStore;

    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0004\u001a\u00020\u00032\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00010\u0000H\n¢\u0006\u0004\b\u0004\u0010\u0005"}, d2 = {"", "LPj/a;", "states", "", "<anonymous>", "(Ljava/util/List;)V"}, k = 3, mv = {2, 1, 0})
    ...
    static final class a extends SuspendLambda implements Function2<List<? extends Pj.a>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f26110a == 0) {
                ResultKt.b(obj);
                qw.a.INSTANCE.q(CollectionsKt.B0((List) this.f26111b, "\n", null, null, 0, null, null, 62, null), new Object[0]);
    ...
    public c(List<? extends Pj.a> initialStates) {
        Intrinsics.j(initialStates, "initialStates");
        this.loadingStatesStore = S.a(initialStates);
    }

    public final InterfaceC16561f<List<Pj.a>> a() {
        return C16563h.O(C16563h.c(this.loadingStatesStore), new a(null));
    }

    public final void b(Pj.a state) {
        List<Pj.a> value;
        ArrayList arrayList;
        Intrinsics.j(state, "state");
        InterfaceC16549B<List<Pj.a>> interfaceC16549B = this.loadingStatesStore;
        do {
            value = interfaceC16549B.getValue();
            List<Pj.a> list = value;
            LinkedHashMap linkedHashMap = new LinkedHashMap(RangesKt.f(MapsKt.f(CollectionsKt.x(list, 10)), 16));
            for (Object obj : list) {
                linkedHashMap.put(((Pj.a) obj).getKey(), obj);
            }
            ...
            for (Object obj2 : collectionValues) {
                if (!(((Pj.a) obj2) instanceof a.NotLoading)) {
                    arrayList.add(obj2);
                }
            }
        } while (!interfaceC16549B.e(value, CollectionsKt.j1(arrayList)));
    }
