...
public final class r {
    ...
    private int f135330b;

    /* renamed from: c, reason: collision with root package name */
    private int f135331c = 0;

    public final synchronized int a() {
        PackageInfo packageInfoF;
        if (this.f135330b == 0) {
            try {
                packageInfoF = C17067f.a(this.f135329a).f("com.google.android.gms", 0);
            } catch (PackageManager.NameNotFoundException e10) {
                FS.log_w("Metadata", "Failed to find package ".concat(e10.toString()));
                packageInfoF = null;
            }
            if (packageInfoF != null) {
                this.f135330b = packageInfoF.versionCode;
            }
        }
        return this.f135330b;
    }
    ...
    */
    public final synchronized int b() {
        /*
            r5 = this;
            monitor-enter(r5)
            int r0 = r5.f135331c     // Catch: java.lang.Throwable -> L26
            if (r0 == 0) goto L7
            monitor-exit(r5)
            return r0
        L7:
            android.content.Context r0 = r5.f135329a     // Catch: java.lang.Throwable -> L26
            android.content.pm.PackageManager r1 = r0.getPackageManager()     // Catch: java.lang.Throwable -> L26
            sd.e r0 = sd.C17067f.a(r0)     // Catch: java.lang.Throwable -> L26
        ...
        L48:
            ...
            r2 = r1
        L62:
            r5.f135331c = r2     // Catch: java.lang.Throwable -> L26
            monitor-exit(r5)
            return r2
        L66:
            java.lang.String r0 = "Metadata"
        ...
        L79:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: hd.r.b():int");
    }
