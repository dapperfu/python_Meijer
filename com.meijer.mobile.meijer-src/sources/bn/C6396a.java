...
public final class C6396a {
    ...
    public /* synthetic */ class C1205a {
        ...
        static {
            ...
            try {
                iArr[d.f152478a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[d.f152479b.ordinal()] = 2;
    ...
    public static final FSPage a(l lVar) {
        ...
        if (z10) {
            ...
            int i10 = C1205a.$EnumSwitchMapping$0[((l.Personalized) lVar).getCategory().ordinal()];
            if (i10 == 1) {
        ...
        if (strS != null && !StringsKt.s0(strS)) {
            str2 = strS;
        }
