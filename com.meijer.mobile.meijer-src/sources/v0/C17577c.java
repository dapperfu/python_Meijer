...
public final class C17577c {

    /* renamed from: h, reason: collision with root package name and from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);

    /* renamed from: i, reason: collision with root package name */
    public static final int f165267i = 8;

    /* renamed from: j, reason: collision with root package name */
    private static C17577c f165268j;
    ...
    public static final class Companion {
        ...
        public final C17577c a(C17577c minMaxUtil, t layoutDirection, TextStyle paramStyle, H1.d density, AbstractC18269l.b fontFamilyResolver) {
            if (minMaxUtil != null && layoutDirection == minMaxUtil.getLayoutDirection() && Intrinsics.e(C17335B.d(paramStyle, layoutDirection), minMaxUtil.getInputTextStyle()) && density.getDensity() == minMaxUtil.getDensity().getDensity() && fontFamilyResolver == minMaxUtil.getFontFamilyResolver()) {
                return minMaxUtil;
            }
            C17577c c17577c = C17577c.f165268j;
            if (c17577c != null && layoutDirection == c17577c.getLayoutDirection() && Intrinsics.e(C17335B.d(paramStyle, layoutDirection), c17577c.getInputTextStyle()) && density.getDensity() == c17577c.getDensity().getDensity() && fontFamilyResolver == c17577c.getFontFamilyResolver()) {
                return c17577c;
            }
            C17577c c17577c2 = new C17577c(layoutDirection, C17335B.d(paramStyle, layoutDirection), H1.f.a(density.getDensity(), density.getFontScale()), fontFamilyResolver);
            C17577c.f165268j = c17577c2;
            return c17577c2;
        }
    }
    ...
    public final long c(long inConstraints, int minLines) {
        ...
        if (Float.isNaN(f10) || Float.isNaN(f11)) {
            ...
            float height2 = m.a(C17578d.f165277b, this.resolvedStyle, H1.c.b(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.m() : null, (64 & 64) != 0 ? CollectionsKt.m() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 2, (64 & 256) != 0 ? F1.t.INSTANCE.a() : companion.a()).getHeight() - height;
    ...
    public C17577c(H1.t tVar, TextStyle textStyle, H1.d dVar, AbstractC18269l.b bVar) {
        this.layoutDirection = tVar;
        this.inputTextStyle = textStyle;
        this.density = dVar;
        this.fontFamilyResolver = bVar;
        this.resolvedStyle = C17335B.d(textStyle, tVar);
    }
}
