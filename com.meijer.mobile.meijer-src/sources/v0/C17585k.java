...
public final class C17585k extends Modifier.c implements D, InterfaceC5965t, u0 {
    ...
    public static final /* data */ class TextSubstitution {
        ...
        private C17580f layoutCache;

        public TextSubstitution(String str, String str2, boolean z10, C17580f c17580f) {
            this.original = str;
            this.substitution = str2;
            this.isShowingSubstitution = z10;
            this.layoutCache = c17580f;
        }
        ...
        public final C17580f getLayoutCache() {
        ...
        public final void d(C17580f c17580f) {
            this.layoutCache = c17580f;
        }
        ...
        public int hashCode() {
            ...
            C17580f c17580f = this.layoutCache;
            return iHashCode + (c17580f == null ? 0 : c17580f.hashCode());
        }
        ...
        public /* synthetic */ TextSubstitution(String str, String str2, boolean z10, C17580f c17580f, int i10, DefaultConstructorMarker defaultConstructorMarker) {
            this(str, str2, (i10 & 4) != 0 ? false : z10, (i10 & 8) != 0 ? null : c17580f);
        }
    }
    ...
    static final class b extends Lambda implements Function1<List<TextLayoutResult>, Boolean> {
        ...
        public final Boolean invoke(List<TextLayoutResult> list) {
            C17580f c17580fT2 = C17585k.this.T2();
            TextStyle textStyle = C17585k.this.style;
            InterfaceC5502x0 interfaceC5502x0 = C17585k.this.overrideColor;
            TextLayoutResult textLayoutResultO = c17580fT2.o(textStyle.K((16609105 & 1) != 0 ? C5489q0.INSTANCE.j() : interfaceC5502x0 != null ? interfaceC5502x0.a() : C5489q0.INSTANCE.j(), (16609105 & 2) != 0 ? v.INSTANCE.a() : 0L, (16609105 & 4) != 0 ? null : null, (16609105 & 8) != 0 ? null : null, (16609105 & 16) != 0 ? null : null, (16609105 & 32) != 0 ? null : null, (16609105 & 64) != 0 ? null : null, (16609105 & 128) != 0 ? v.INSTANCE.a() : 0L, (16609105 & 256) != 0 ? null : null, (16609105 & 512) != 0 ? null : null, (16609105 & 1024) != 0 ? null : null, (16609105 & RecyclerView.m.FLAG_MOVED) != 0 ? C5489q0.INSTANCE.j() : 0L, (16609105 & RecyclerView.m.FLAG_APPEARED_IN_PRE_LAYOUT) != 0 ? null : null, (16609105 & 8192) != 0 ? null : null, (16609105 & 16384) != 0 ? null : null, (16609105 & 32768) != 0 ? F1.j.INSTANCE.g() : 0, (16609105 & 65536) != 0 ? l.INSTANCE.f() : 0, (16609105 & 131072) != 0 ? v.INSTANCE.a() : 0L, (16609105 & 262144) != 0 ? null : null, (16609105 & 524288) != 0 ? null : null, (16609105 & 1048576) != 0 ? F1.f.INSTANCE.b() : 0, (16609105 & 2097152) != 0 ? F1.e.INSTANCE.c() : 0, (16609105 & 4194304) != 0 ? null : null, (16609105 & 8388608) != 0 ? null : null));
    ...
    static final class c extends Lambda implements Function1<AnnotatedString, Boolean> {
        ...
        public final Boolean invoke(AnnotatedString annotatedString) {
            C17585k.this.X2(annotatedString.getText());
            C17585k.this.W2();
            return Boolean.TRUE;
        }
    }
    ...
    static final class d extends Lambda implements Function1<Boolean, Boolean> {
        ...
        public final Boolean a(boolean z10) {
            if (C17585k.this.textSubstitution == null) {
                return Boolean.FALSE;
            }
            TextSubstitution textSubstitution = C17585k.this.textSubstitution;
    ...
    static final class f extends Lambda implements Function1<f0.a, Unit> {
        ...
        public final void a(f0.a aVar) {
            f0.a.h(aVar, this.f165356f, 0, 0, 0.0f, 4, null);
        }
    ...
    public /* synthetic */ C17585k(String str, TextStyle textStyle, AbstractC18269l.b bVar, int i10, boolean z10, int i11, int i12, InterfaceC5502x0 interfaceC5502x0, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    private C17585k(String str, TextStyle textStyle, AbstractC18269l.b bVar, int i10, boolean z10, int i11, int i12, InterfaceC5502x0 interfaceC5502x0) {
        this.text = str;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final C17580f T2() {
        if (this._layoutCache == null) {
            this._layoutCache = new C17580f(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, null);
        }
        C17580f c17580f = this._layoutCache;
        Intrinsics.g(c17580f);
        return c17580f;
    }

    @JvmName
    private final C17580f V2() {
        C17580f layoutCache;
    ...
    public final boolean X2(String updatedText) {
        ...
        if (textSubstitution == null) {
            ...
            C17580f c17580f = new C17580f(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, null);
            c17580f.m(T2().getDensity());
            textSubstitution2.d(c17580f);
        ...
        C17580f layoutCache = textSubstitution.getLayoutCache();
        if (layoutCache != null) {
    ...
    public final boolean Y2(InterfaceC5502x0 color, TextStyle style) {
        boolean zE = Intrinsics.e(color, this.overrideColor);
        this.overrideColor = color;
        return (zE && style.F(this.style)) ? false : true;
    }

    public final boolean Z2(TextStyle style, int minLines, int maxLines, boolean softWrap, AbstractC18269l.b fontFamilyResolver, int overflow) {
    ...
    private final C17580f U2(InterfaceC5933s interfaceC5933s) {
        C17580f c17580fV2 = V2();
        c17580fV2.m(interfaceC5933s);
        return c17580fV2;
    }
    ...
    public int F(InterfaceC5933s interfaceC5933s, r rVar, int i10) {
        return U2(interfaceC5933s).f(i10, interfaceC5933s.getLayoutDirection());
    }
    ...
    public void I(X0.c cVar) {
        ...
        if (getIsAttached()) {
            C17580f c17580fV2 = V2();
            InterfaceC17341f paragraph = c17580fV2.getParagraph();
            if (paragraph != null) {
                Canvas canvasG = cVar.getDrawContext().g();
                boolean didOverflow = c17580fV2.getDidOverflow();
                if (didOverflow) {
                    float layoutSize = (int) (c17580fV2.getLayoutSize() >> 32);
                    float layoutSize2 = (int) (c17580fV2.getLayoutSize() & 4294967295L);
                    canvasG.save();
                ...
                try {
                    ...
                    if (abstractC5467i0G != null) {
                        InterfaceC17341f.C(paragraph, canvasG, abstractC5467i0G, this.style.d(), shadow, kVar, gVar, 0, 64, null);
                    } else {
                        InterfaceC5502x0 interfaceC5502x0 = this.overrideColor;
                        if (interfaceC5502x0 != null) {
                            j10 = interfaceC5502x0.a();
                        } else {
                        ...
                        if (j10 == 16) {
                            if (this.style.h() != 16) {
                                ...
                                j10 = C5489q0.INSTANCE.a();
                            }
                        }
                        InterfaceC17341f.q(paragraph, canvasG, j10, shadow, kVar, gVar, 0, 32, null);
                    }
                    if (didOverflow) {
                        canvasG.i();
                        return;
            ...
            C14592e.b("no paragraph (layoutCache=" + this._layoutCache + ", textSubstitution=" + this.textSubstitution + ')');
    ...
    public int J(InterfaceC5933s interfaceC5933s, r rVar, int i10) {
        return U2(interfaceC5933s).k(interfaceC5933s.getLayoutDirection());
    }
    ...
    public J a(K k10, I i10, long j10) {
        C17580f c17580fU2 = U2(k10);
        boolean zH = c17580fU2.h(j10, k10.getLayoutDirection());
        c17580fU2.d();
        InterfaceC17341f paragraph = c17580fU2.getParagraph();
        Intrinsics.g(paragraph);
        long layoutSize = c17580fU2.getLayoutSize();
        if (zH) {
            G.a(this);
            ...
            map.put(C5917b.a(), Integer.valueOf(Math.round(paragraph.l())));
            map.put(C5917b.b(), Integer.valueOf(Math.round(paragraph.w())));
        }
        int i11 = (int) (layoutSize >> 32);
        int i12 = (int) (layoutSize & 4294967295L);
        f0 f0VarK0 = i10.k0(H1.b.INSTANCE.b(i11, i11, i12, i12));
        Map<AbstractC5916a, Integer> map2 = this.baselineCache;
        Intrinsics.g(map2);
