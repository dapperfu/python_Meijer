...
public abstract class b {
    ...
    public static final c f139135a;
    ...
    static {
        ...
        if (a.f139133a) {
            ...
            aVar = fileSystemProviderProvider == null ? null : fileSystemProviderProvider instanceof j$.nio.file.spi.b ? ((j$.nio.file.spi.b) fileSystemProviderProvider).f139264a : new j$.nio.file.spi.a(fileSystemProviderProvider);
        } else {
            if (a.f139134b) {
