...
public final /* synthetic */ class g implements d {
    ...
    public final /* synthetic */ DosFileAttributeView f139216a;

    public /* synthetic */ g(DosFileAttributeView dosFileAttributeView) {
        this.f139216a = dosFileAttributeView;
    }
    ...
    public final /* synthetic */ void a(FileTime fileTime, FileTime fileTime2, FileTime fileTime3) throws IOException {
        this.f139216a.setTimes(j$.desugar.sun.nio.fs.g.e(fileTime), j$.desugar.sun.nio.fs.g.e(fileTime2), j$.desugar.sun.nio.fs.g.e(fileTime3));
    }

    public final /* synthetic */ boolean equals(Object obj) {
        DosFileAttributeView dosFileAttributeView = this.f139216a;
        if (obj instanceof g) {
            obj = ((g) obj).f139216a;
        }
    ...
    public final /* synthetic */ String name() {
        return this.f139216a.name();
    }

    @Override // j$.nio.file.attribute.d
    public final /* synthetic */ BasicFileAttributes readAttributes() {
        return e.a(this.f139216a.readAttributes());
    }
}
