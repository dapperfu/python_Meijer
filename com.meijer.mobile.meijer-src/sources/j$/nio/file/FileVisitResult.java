...
public final class FileVisitResult {
    ...
    public static final /* synthetic */ FileVisitResult[] f139192a;
    ...
    public static FileVisitResult[] values() {
        return (FileVisitResult[]) f139192a.clone();
    }
    ...
    static {
        ...
        f139192a = new FileVisitResult[]{fileVisitResult, fileVisitResult2, fileVisitResult3, fileVisitResult4};
    }
}
