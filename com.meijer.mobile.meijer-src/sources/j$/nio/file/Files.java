...
public final class Files {
    ...
    public static final /* synthetic */ int f139193a = 0;
    ...
    public static boolean exists(Path path, LinkOption... linkOptionArr) {
        ...
        try {
            ...
            if (z10) {
                b(path).a(path, new EnumC14854a[0]);
            } else {
    ...
    public static Path walkFileTree(Path path, Set<FileVisitOption> set, int i10, FileVisitor<? super Path> fileVisitor) {
        ...
        try {
            ...
            C14869m c14869mC = oVar.c(path, false);
            do {
                int[] iArr = p.f139257a;
                n nVar = (n) c14869mC.f139247b;
                BasicFileAttributes basicFileAttributes = (BasicFileAttributes) c14869mC.f139249d;
                Path path2 = (Path) c14869mC.f139248c;
                int i11 = iArr[nVar.ordinal()];
                if (i11 == 1) {
                    IOException iOException = (IOException) c14869mC.f139250e;
                    if (iOException == null) {
                    ...
                    if ((fileVisitResultVisitFile == FileVisitResult.SKIP_SUBTREE || fileVisitResultVisitFile == FileVisitResult.SKIP_SIBLINGS) && !oVar.f139255d.isEmpty()) {
                        try {
                            ((C14868l) oVar.f139255d.pop()).f139243c.close();
                        } catch (IOException unused) {
                        }
                    }
                } else if (i11 == 3) {
                    fileVisitResultVisitFile = fileVisitor.a(path2, (IOException) c14869mC.f139250e);
                ...
                if (fileVisitResultVisitFile != FileVisitResult.CONTINUE) {
                    ...
                    if (fileVisitResultVisitFile == FileVisitResult.SKIP_SIBLINGS && !oVar.f139255d.isEmpty()) {
                        ((C14868l) oVar.f139255d.peek()).f139245e = true;
                    }
                    c14869mC = oVar.b();
                } else {
                    c14869mC = oVar.b();
