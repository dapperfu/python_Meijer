...
public class URLEncoder {
    ...
    public static final BitSet f139182a = new BitSet(256);
        ...
        while (i11 < str.length()) {
            ...
            if (f139182a.get(cCharAt2)) {
                ...
                for (int i12 = 0; i12 < bytes.length; i12++) {
                    ...
                    char cForDigit2 = Character.forDigit(bytes[i12] & C14170dq.MULTIPLY, 16);
