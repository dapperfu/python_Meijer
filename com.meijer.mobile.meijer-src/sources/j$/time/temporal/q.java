...
public final class q implements TemporalField {
    ...
    public static final p f139557f = p.f(1, 7);

    /* renamed from: g, reason: collision with root package name */
    public static final p f139558g = p.g(0, 4, 6);

    /* renamed from: h, reason: collision with root package name */
    public static final p f139559h = p.g(0, 52, 54);

    /* renamed from: i, reason: collision with root package name */
    public static final p f139560i = p.g(1, 52, 53);

    /* renamed from: a, reason: collision with root package name */
    public final String f139561a;

    /* renamed from: b, reason: collision with root package name */
    public final WeekFields f139562b;

    /* renamed from: c, reason: collision with root package name */
    public final TemporalUnit f139563c;

    /* renamed from: d, reason: collision with root package name */
    public final TemporalUnit f139564d;

    /* renamed from: e, reason: collision with root package name */
    public final p f139565e;
    ...
    public final ChronoLocalDate e(Chronology chronology, int i10, int i11, int i12) {
        ...
        int i13 = i12 - 1;
        return chronoLocalDateA0.b(((Math.min(i11, a(iH, chronoLocalDateA0.e0() + this.f139562b.f139522b) - 1) - 1) * 7) + i13 + (-iH), (TemporalUnit) ChronoUnit.DAYS);
    }

    public q(String str, WeekFields weekFields, TemporalUnit temporalUnit, TemporalUnit temporalUnit2, p pVar) {
        this.f139561a = str;
        this.f139562b = weekFields;
        this.f139563c = temporalUnit;
        this.f139564d = temporalUnit2;
        this.f139565e = pVar;
    }
    ...
    public final long Z(TemporalAccessor temporalAccessor) {
        ...
        TemporalUnit temporalUnit = this.f139564d;
        if (temporalUnit == chronoUnit) {
            iC = b(temporalAccessor);
        } else if (temporalUnit != ChronoUnit.MONTHS) {
            if (temporalUnit != ChronoUnit.YEARS) {
                if (temporalUnit == WeekFields.f139520i) {
    ...
    public final int b(TemporalAccessor temporalAccessor) {
        return Math.floorMod(temporalAccessor.get(ChronoField.DAY_OF_WEEK) - this.f139562b.f139521a.getValue(), 7) + 1;
    }
    ...
    public final int c(TemporalAccessor temporalAccessor) {
        ...
        int iH = h(i11, iB);
        int iA = a(iH, i11);
        return iA == 0 ? i10 - 1 : iA >= a(iH, ((int) temporalAccessor.k(chronoField).f139556d) + this.f139562b.f139522b) ? i10 + 1 : i10;
    }
    ...
    public final int d(TemporalAccessor temporalAccessor) {
        ...
        return (iA2 <= 50 || iA2 < (iA = a(iH, ((int) temporalAccessor.k(chronoField).f139556d) + this.f139562b.f139522b))) ? iA2 : (iA2 - iA) + 1;
    }

    public final int h(int i10, int i11) {
        int iFloorMod = Math.floorMod(i10 - i11, 7);
        return iFloorMod + 1 > this.f139562b.f139522b ? 7 - iFloorMod : -iFloorMod;
    }
    ...
    public final Temporal f0(Temporal temporal, long j10) {
        if (this.f139565e.a(j10, this) == temporal.get(this)) {
            return temporal;
        }
        if (this.f139564d != ChronoUnit.FOREVER) {
            return temporal.b(r0 - r1, this.f139563c);
        }
        WeekFields weekFields = this.f139562b;
        return e(Chronology.q(temporal), (int) j10, temporal.get(weekFields.f139526f), temporal.get(weekFields.f139523c));
    }
    ...
    public final TemporalAccessor O(Map map, B b10, ResolverStyle resolverStyle) {
        ...
        ChronoUnit chronoUnit = ChronoUnit.WEEKS;
        p pVar = this.f139565e;
        WeekFields weekFields = this.f139562b;
        TemporalUnit temporalUnit = this.f139564d;
        if (temporalUnit == chronoUnit) {
            long jFloorMod = Math.floorMod((pVar.a(jLongValue, this) - 1) + (weekFields.f139521a.getValue() - 1), 7) + 1;
            map.remove(this);
        ...
        int iFloorMod = Math.floorMod(chronoField.f139516d.a(((Long) map.get(chronoField)).longValue(), chronoField) - weekFields.f139521a.getValue(), 7) + 1;
        Chronology chronologyQ = Chronology.q(b10);
        ChronoField chronoField2 = ChronoField.YEAR;
        if (!map.containsKey(chronoField2)) {
            if ((temporalUnit != WeekFields.f139520i && temporalUnit != ChronoUnit.FOREVER) || !map.containsKey(weekFields.f139527g) || !map.containsKey(weekFields.f139526f)) {
                return null;
            }
            q qVar = weekFields.f139527g;
            int iA = qVar.f139565e.a(((Long) map.get(qVar)).longValue(), weekFields.f139527g);
            if (resolverStyle == ResolverStyle.LENIENT) {
                chronoLocalDateB = e(chronologyQ, iA, 1, iFloorMod).b(Math.subtractExact(((Long) map.get(weekFields.f139526f)).longValue(), 1L), (TemporalUnit) chronoUnit);
            } else {
                q qVar2 = weekFields.f139526f;
                ChronoLocalDate chronoLocalDateE = e(chronologyQ, iA, qVar2.f139565e.a(((Long) map.get(qVar2)).longValue(), weekFields.f139526f), iFloorMod);
            ...
            map.remove(this);
            map.remove(weekFields.f139527g);
            map.remove(weekFields.f139526f);
            map.remove(chronoField);
            return chronoLocalDateB;
        }
        int iA2 = chronoField2.f139516d.a(((Long) map.get(chronoField2)).longValue(), chronoField2);
        ...
        if (temporalUnit == chronoUnit2) {
            ...
            if (map.containsKey(chronoField3)) {
                ...
                if (resolverStyle == ResolverStyle.LENIENT) {
                    ...
                    ChronoLocalDate chronoLocalDateA0 = chronologyQ.a0(iA2, chronoField3.f139516d.a(jLongValue2, chronoField3), 1);
    ...
    public final p f(TemporalAccessor temporalAccessor, ChronoField chronoField) {
        ...
        return p.f(a(iH, (int) pVarK.f139553a), a(iH, (int) pVarK.f139556d));
    }
    ...
    public final p g(TemporalAccessor temporalAccessor) {
        ...
        int iA = a(iH, i10);
        if (iA != 0) {
            if (iA >= a(iH, this.f139562b.f139522b + ((int) temporalAccessor.k(chronoField).f139556d))) {
    ...
    public final String toString() {
        return this.f139561a + "[" + this.f139562b.toString() + "]";
    }
}
