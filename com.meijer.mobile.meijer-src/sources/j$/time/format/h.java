...
public final class h implements e {
            ...
            case 0:
                ...
                if (lA != null) {
                    ...
                    if (intExact != 0) {
                        ...
                        if (((TextStyle) this.f139431b) == TextStyle.FULL) {
                            a(sb2, iAbs);
                            sb2.append(':');
                            a(sb2, iAbs2);
                            if (iAbs3 != 0) {
                ...
                break;
            default:
                sb2.append((String) this.f139431b);
                break;
        }
        return true;
    }
    ...
    public final int H(v vVar, CharSequence charSequence, int i10) {
        ...
        switch (this.f139430a) {
            case 0:
                ...
                return ~i10;
            default:
                String str = (String) this.f139431b;
    ...
    public final String toString() {
        switch (this.f139430a) {
            case 0:
                return "LocalizedOffset(" + ((TextStyle) this.f139431b) + ")";
            default:
                return "'" + ((String) this.f139431b).replace("'", "''") + "'";
        }
    }
