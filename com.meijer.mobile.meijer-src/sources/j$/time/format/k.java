...
public final class k implements e {
    ...
    public static final String[] f139440d = {"+HH", "+HHmm", "+HH:mm", "+HHMM", "+HH:MM", "+HHMMss", "+HH:MM:ss", "+HHMMSS", "+HH:MM:SS", "+HHmmss", "+HH:mm:ss", "+H", "+Hmm", "+H:mm", "+HMM", "+H:MM", "+HMMss", "+H:MM:ss", "+HMMSS", "+H:MM:SS", "+Hmmss", "+H:mm:ss"};

    /* renamed from: e, reason: collision with root package name */
    public static final k f139441e = new k("+HH:MM:ss", "Z");

    /* renamed from: f, reason: collision with root package name */
    public static final k f139442f = new k("+HH:MM:ss", "0");
    ...
    public final int f139445c;

    public k(String str, String str2) {
        Objects.requireNonNull(str, "pattern");
        for (int i10 = 0; i10 < 22; i10++) {
            if (f139440d[i10].equals(str)) {
                this.f139444b = i10;
                this.f139445c = i10 % 11;
                this.f139443a = str2;
                return;
            }
        }
    ...
    public final boolean C(w wVar, StringBuilder sb2) {
        ...
        if (this.f139444b < 11 || iAbs >= 10) {
            a(false, iAbs, sb2);
        } else {
            sb2.append((char) (iAbs + 48));
        }
        int i10 = this.f139445c;
    ...
    public final int H(v vVar, CharSequence charSequence, int i10) {
        ...
        int length2 = this.f139443a.length();
        if (length2 == 0) {
            if (i10 == length) {
            ...
            charSequence2 = charSequence;
            if (vVar.h(charSequence2, i10, this.f139443a, 0, length2)) {
        ...
        if (cCharAt == '+' || cCharAt == '-') {
            int i15 = cCharAt == '-' ? -1 : 1;
            int i16 = this.f139445c;
            boolean z10 = i16 > 0 && i16 % 2 == 0;
            int i17 = this.f139444b;
            boolean z11 = i17 < 11;
            int[] iArr = new int[4];
            iArr[0] = i10 + 1;
            if (!vVar.f139479c) {
    ...
    */
    ...
    public final String toString() {
        String strReplace = this.f139443a.replace("'", "''");
        return "Offset(" + f139440d[this.f139444b] + ",'" + strReplace + "')";
    }
}
