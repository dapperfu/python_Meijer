...
public class z {
    ...
    public static final ConcurrentMap f139487a = new ConcurrentHashMap(16, 0.75f, 2);

    /* renamed from: b, reason: collision with root package name */
    public static final x f139488b = new x();

    /* renamed from: c, reason: collision with root package name */
    public static final z f139489c = new z();
    ...
    public Iterator e(TemporalField temporalField, TextStyle textStyle, Locale locale) {
        List list;
        Object objA = a(temporalField, locale);
        if (!(objA instanceof y) || (list = (List) ((HashMap) ((y) objA).f139486b).get(textStyle)) == null) {
            return null;
        }
    ...
    public static Object a(TemporalField temporalField, Locale locale) {
        ...
        Object obj = ((ConcurrentHashMap) f139487a).get(simpleImmutableEntry);
        if (obj != null) {
            return obj;
        }
        ...
        ConcurrentHashMap concurrentHashMap = (ConcurrentHashMap) f139487a;
