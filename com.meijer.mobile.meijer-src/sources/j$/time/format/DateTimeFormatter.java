...
public final class DateTimeFormatter {
    ...
    public final d f139404a;

    /* renamed from: b, reason: collision with root package name */
    public final Locale f139405b;

    /* renamed from: c, reason: collision with root package name */
    public final A f139406c;

    /* renamed from: d, reason: collision with root package name */
    public final ResolverStyle f139407d;

    /* renamed from: e, reason: collision with root package name */
    public final Chronology f139408e;

    /* renamed from: f, reason: collision with root package name */
    public final ZoneId f139409f;
    ...
    static {
        ...
        j$.time.c cVar = DateTimeFormatterBuilder.f139410h;
        ...
        DateTimeFormatterBuilder dateTimeFormatterBuilderAppendLiteral7 = new DateTimeFormatterBuilder().parseCaseInsensitive().appendValue(j$.time.temporal.h.f139535c, 4, 10, signStyle).appendLiteral("-W").appendValue(j$.time.temporal.h.f139534b, 2).appendLiteral('-');
    ...
    public DateTimeFormatter(d dVar, Locale locale, A a10, ResolverStyle resolverStyle, Chronology chronology, ZoneId zoneId) {
        ...
        this.f139405b = locale;
        Objects.requireNonNull(a10, "decimalStyle");
        this.f139406c = a10;
        Objects.requireNonNull(resolverStyle, "resolverStyle");
        this.f139407d = resolverStyle;
        this.f139408e = chronology;
        this.f139409f = zoneId;
    }

    public DateTimeFormatter withLocale(Locale locale) {
        if (this.f139405b.equals(locale)) {
            return this;
        }
        return new DateTimeFormatter(this.f139404a, locale, this.f139406c, this.f139407d, this.f139408e, this.f139409f);
    }

    public DateTimeFormatter withChronology(Chronology chronology) {
        if (Objects.equals(this.f139408e, chronology)) {
            return this;
        }
        return new DateTimeFormatter(this.f139404a, this.f139405b, this.f139406c, this.f139407d, chronology, this.f139409f);
    }

    public DateTimeFormatter withZone(ZoneId zoneId) {
        if (Objects.equals(this.f139409f, zoneId)) {
            return this;
        }
        return new DateTimeFormatter(this.f139404a, this.f139405b, this.f139406c, this.f139407d, this.f139408e, zoneId);
    }

    public DateTimeFormatter withResolverStyle(ResolverStyle resolverStyle) {
        Objects.requireNonNull(resolverStyle, "resolverStyle");
        if (Objects.equals(this.f139407d, resolverStyle)) {
            return this;
        }
        return new DateTimeFormatter(this.f139404a, this.f139405b, this.f139406c, resolverStyle, this.f139408e, this.f139409f);
    }

    public String format(TemporalAccessor temporalAccessor) {
        StringBuilder sb2 = new StringBuilder(32);
        d dVar = this.f139404a;
    ...
    */
    ...
    public final String toString() {
        String string = this.f139404a.toString();
        return string.startsWith("[") ? string : string.substring(1, string.length() - 1);
    }

    public final d b() {
        d dVar = this.f139404a;
        return !dVar.f139428b ? dVar : new d(dVar.f139427a, false);
    }
}
