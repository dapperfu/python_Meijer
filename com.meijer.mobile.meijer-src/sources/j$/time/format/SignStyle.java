...
public final class SignStyle {
    ...
    public static final /* synthetic */ SignStyle[] f139421a;
    ...
    public static SignStyle[] values() {
        return (SignStyle[]) f139421a.clone();
    }
    ...
    static {
        ...
        f139421a = new SignStyle[]{signStyle, signStyle2, signStyle3, signStyle4, signStyle5};
    }
}
