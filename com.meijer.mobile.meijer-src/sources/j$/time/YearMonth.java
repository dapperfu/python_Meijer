...
public final class YearMonth implements Temporal, j$.time.temporal.k, Comparable<YearMonth>, Serializable {
    ...
    public static final /* synthetic */ int f139309c = 0;
    private static final long serialVersionUID = 4183400860270640070L;

    /* renamed from: a, reason: collision with root package name */
    public final int f139310a;

    /* renamed from: b, reason: collision with root package name */
    public final int f139311b;

    @Override // java.lang.Comparable
    public final int compareTo(YearMonth yearMonth) {
        YearMonth yearMonth2 = yearMonth;
        int i10 = this.f139310a - yearMonth2.f139310a;
        return i10 == 0 ? this.f139311b - yearMonth2.f139311b : i10;
    }
    ...
    public static YearMonth now(Clock clock) {
        ...
        Month monthO = Month.O(localDateK0.f139287b);
    ...
    public final YearMonth Q(int i10, int i11) {
        return (this.f139310a == i10 && this.f139311b == i11) ? this : new YearMonth(i10, i11);
    }
    ...
    public final long j(TemporalField temporalField) {
        ...
        int i11 = p.f139506a[((ChronoField) temporalField).ordinal()];
        if (i11 == 1) {
            i10 = this.f139311b;
        } else {
            if (i11 == 2) {
    ...
    public final long C() {
        return ((this.f139310a * 12) + this.f139311b) - 1;
    }
    ...
    public final YearMonth a(long j10, TemporalField temporalField) {
        ...
        chronoField.i0(j10);
        int i10 = p.f139506a[chronoField.ordinal()];
        if (i10 == 1) {
            int i11 = (int) j10;
            ChronoField.MONTH_OF_YEAR.i0(i11);
            return Q(this.f139310a, i11);
        }
        if (i10 == 2) {
        ...
        if (i10 == 3) {
            ...
            return Q(i12, this.f139311b);
        }
        if (i10 == 4) {
            int i13 = (int) j10;
            ChronoField.YEAR.i0(i13);
            return Q(i13, this.f139311b);
        }
        if (i10 != 5) {
            throw new j$.time.temporal.o(b.a("Unsupported field: ", temporalField));
        }
        ...
        int i14 = 1 - this.f139310a;
        ChronoField.YEAR.i0(i14);
        return Q(i14, this.f139311b);
    }
    ...
    public final YearMonth b(long j10, TemporalUnit temporalUnit) {
        ...
        switch (p.f139507b[((ChronoUnit) temporalUnit).ordinal()]) {
            case 1:
    ...
    public final YearMonth O(long j10) {
        ...
        return Q(chronoField.f139516d.a(this.f139310a + j10, chronoField), this.f139311b);
    }
    ...
    public YearMonth plusMonths(long j10) {
        ...
        long j11 = (this.f139310a * 12) + (this.f139311b - 1) + j10;
        ChronoField chronoField = ChronoField.YEAR;
        long j12 = 12;
        return Q(chronoField.f139516d.a(Math.floorDiv(j11, j12), chronoField), ((int) Math.floorMod(j11, j12)) + 1);
    }
    ...
    public LocalDate atDay(int i10) {
        return LocalDate.of(this.f139310a, this.f139311b, i10);
    }

    public boolean isAfter(YearMonth yearMonth) {
        int i10 = this.f139310a - yearMonth.f139310a;
        if (i10 == 0) {
            i10 = this.f139311b - yearMonth.f139311b;
        }
        return i10 > 0;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof YearMonth) {
            ...
            if (this.f139310a == yearMonth.f139310a && this.f139311b == yearMonth.f139311b) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return this.f139310a ^ (this.f139311b << 27);
    }

    public final String toString() {
        int iAbs = Math.abs(this.f139310a);
        StringBuilder sb2 = new StringBuilder(9);
        if (iAbs < 1000) {
            int i10 = this.f139310a;
            if (i10 < 0) {
            ...
            sb2.append(this.f139310a);
        }
        sb2.append(this.f139311b < 10 ? "-0" : "-");
        sb2.append(this.f139311b);
        return sb2.toString();
    }

    private Object writeReplace() {
        return new n(C14170dq.XOR, this);
    }
