...
public final class ZoneOffset extends ZoneId implements TemporalAccessor, j$.time.temporal.k, Comparable<ZoneOffset>, Serializable {
    ...
    public final int f139317b;

    /* renamed from: c, reason: collision with root package name */
    public final transient String f139318c;

    /* renamed from: d, reason: collision with root package name */
    public static final ConcurrentMap f139313d = new ConcurrentHashMap(16, 0.75f, 4);

    /* renamed from: e, reason: collision with root package name */
    public static final ConcurrentMap f139314e = new ConcurrentHashMap(16, 0.75f, 4);
    public static final ZoneOffset UTC = ofTotalSeconds(0);

    /* renamed from: f, reason: collision with root package name */
    public static final ZoneOffset f139315f = ofTotalSeconds(-64800);

    /* renamed from: g, reason: collision with root package name */
    public static final ZoneOffset f139316g = ofTotalSeconds(64800);

    @Override // java.lang.Comparable
    public final int compareTo(ZoneOffset zoneOffset) {
        return zoneOffset.f139317b - this.f139317b;
    }
    ...
    */
    public static j$.time.ZoneOffset j0(java.lang.String r7) {
        /*
            ...
            java.util.concurrent.ConcurrentMap r0 = j$.time.ZoneOffset.f139314e
    ...
    public static ZoneOffset i0(TemporalAccessor temporalAccessor) {
        ...
        ZoneOffset zoneOffset = (ZoneOffset) temporalAccessor.d(j$.time.temporal.n.f139549d);
        if (zoneOffset != null) {
            return zoneOffset;
        }
    ...
    public static ZoneOffset ofTotalSeconds(int i10) {
        ...
        if (i10 % 900 == 0) {
            ...
            ConcurrentMap concurrentMap = f139313d;
            ...
            ((ConcurrentHashMap) f139314e).putIfAbsent(zoneOffset2.f139318c, zoneOffset2);
            return zoneOffset2;
        }
    ...
    public final Object d(TemporalQuery temporalQuery) {
        return (temporalQuery == j$.time.temporal.n.f139549d || temporalQuery == j$.time.temporal.n.f139550e) ? this : super.d(temporalQuery);
    }

    @Override // j$.time.temporal.k
    public final Temporal f(Temporal temporal) {
        return temporal.a(this.f139317b, ChronoField.OFFSET_SECONDS);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof ZoneOffset) && this.f139317b == ((ZoneOffset) obj).f139317b;
    }
