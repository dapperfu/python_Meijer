...
public final class Instant implements Temporal, j$.time.temporal.k, Comparable<Instant>, Serializable {
    ...
    public final long f139282a;

    /* renamed from: b, reason: collision with root package name */
    public final int f139283b;

    /* renamed from: c, reason: collision with root package name */
    public static final Instant f139280c = new Instant(0, 0);
    public static final Instant MIN = ofEpochSecond(-31557014167219200L, 0);

    /* renamed from: d, reason: collision with root package name */
    public static final Instant f139281d = ofEpochSecond(31556889864403199L, 999999999);
    ...
    public final int get(TemporalField temporalField) {
        ...
        int i10 = d.f139383a[((ChronoField) temporalField).ordinal()];
        if (i10 == 1) {
            return this.f139283b;
        }
        if (i10 == 2) {
            return this.f139283b / 1000;
        }
        if (i10 == 3) {
            return this.f139283b / 1000000;
        }
        if (i10 == 4) {
            ChronoField chronoField = ChronoField.INSTANT_SECONDS;
            chronoField.f139516d.a(this.f139282a, chronoField);
        }
    ...
    public final long j(TemporalField temporalField) {
        ...
        int i11 = d.f139383a[((ChronoField) temporalField).ordinal()];
        if (i11 == 1) {
            i10 = this.f139283b;
        } else if (i11 == 2) {
            i10 = this.f139283b / 1000;
        } else {
            if (i11 != 3) {
                if (i11 == 4) {
    ...
    public final Temporal a(long j10, TemporalField temporalField) {
        ...
        chronoField.i0(j10);
        int i10 = d.f139383a[chronoField.ordinal()];
        if (i10 != 1) {
            if (i10 == 2) {
                int i11 = ((int) j10) * 1000;
                if (i11 != this.f139283b) {
                    return H(this.f139282a, i11);
                }
            } else if (i10 == 3) {
                int i12 = ((int) j10) * 1000000;
                if (i12 != this.f139283b) {
                    return H(this.f139282a, i12);
                }
            } else {
                if (i10 != 4) {
                    throw new j$.time.temporal.o(b.a("Unsupported field: ", temporalField));
                }
                if (j10 != this.f139282a) {
                    return H(j10, this.f139283b);
                }
            }
        } else if (j10 != this.f139283b) {
            return H(this.f139282a, (int) j10);
        }
        return this;
    }
    ...
    public final Instant b(long j10, TemporalUnit temporalUnit) {
        ...
        switch (d.f139384b[((ChronoUnit) temporalUnit).ordinal()]) {
            case 1:
                return O(0L, j10);
            case 2:
    ...
    public final Instant O(long j10, long j11) {
        ...
        return ofEpochSecond(Math.addExact(Math.addExact(this.f139282a, j10), j11 / 1000000000), this.f139283b + (j11 % 1000000000));
    }
    ...
    public final Object d(TemporalQuery temporalQuery) {
        ...
        if (temporalQuery == j$.time.temporal.n.f139547b || temporalQuery == j$.time.temporal.n.f139546a || temporalQuery == j$.time.temporal.n.f139550e || temporalQuery == j$.time.temporal.n.f139549d || temporalQuery == j$.time.temporal.n.f139551f || temporalQuery == j$.time.temporal.n.f139552g) {
            return null;
        }
    ...
    public final Temporal f(Temporal temporal) {
        return temporal.a(this.f139282a, ChronoField.INSTANT_SECONDS).a(this.f139283b, ChronoField.NANO_OF_SECOND);
    }
    ...
    public final long until(Temporal temporal, TemporalUnit temporalUnit) {
        ...
        switch (d.f139384b[((ChronoUnit) temporalUnit).ordinal()]) {
            case 1:
                return Math.addExact(Math.multiplyExact(Math.subtractExact(instantFrom.f139282a, this.f139282a), 1000000000L), instantFrom.f139283b - this.f139283b);
            case 2:
                return Math.addExact(Math.multiplyExact(Math.subtractExact(instantFrom.f139282a, this.f139282a), 1000000000L), instantFrom.f139283b - this.f139283b) / 1000;
            case 3:
    ...
    public final long Z(Instant instant) {
        long jSubtractExact = Math.subtractExact(instant.f139282a, this.f139282a);
        long j10 = instant.f139283b - this.f139283b;
    ...
    public long toEpochMilli() {
        long j10 = this.f139282a;
        return (j10 >= 0 || this.f139283b <= 0) ? Math.addExact(Math.multiplyExact(j10, 1000), this.f139283b / 1000000) : Math.addExact(Math.multiplyExact(j10 + 1, 1000), (this.f139283b / 1000000) - 1000);
    }

    @Override // java.lang.Comparable
    /* renamed from: C, reason: merged with bridge method [inline-methods] */
    public final int compareTo(Instant instant) {
        int iCompare = Long.compare(this.f139282a, instant.f139282a);
        return iCompare != 0 ? iCompare : this.f139283b - instant.f139283b;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Instant) {
            ...
            if (this.f139282a == instant.f139282a && this.f139283b == instant.f139283b) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        long j10 = this.f139282a;
        return (this.f139283b * 51) + ((int) (j10 ^ (j10 >>> 32)));
    }
