...
public final class y extends AbstractC14872c {
    private static final long serialVersionUID = 1300372329181994526L;

    /* renamed from: a, reason: collision with root package name */
    public final transient LocalDate f139381a;
    ...
    public final int hashCode() {
        w.f139379c.getClass();
        return this.f139381a.hashCode() ^ (-1990173233);
    }
    ...
    public final j$.time.temporal.p k(TemporalField temporalField) {
        ...
        int i10 = x.f139380a[chronoField.ordinal()];
        if (i10 == 1 || i10 == 2 || i10 == 3) {
            return this.f139381a.k(temporalField);
        }
        if (i10 != 4) {
            return w.f139379c.F(chronoField);
        }
        j$.time.temporal.p pVar = ChronoField.YEAR.f139516d;
        return j$.time.temporal.p.f(1L, f0() <= 0 ? (-pVar.f139553a) + 1912 : pVar.f139556d - 1911);
    }

    @Override // j$.time.temporal.TemporalAccessor
    public final long j(TemporalField temporalField) {
        if (temporalField instanceof ChronoField) {
            int i10 = x.f139380a[((ChronoField) temporalField).ordinal()];
            if (i10 == 4) {
                int iF0 = f0();
                if (iF0 < 1) {
                    iF0 = 1 - iF0;
            ...
            if (i10 == 5) {
                return ((f0() * 12) + this.f139381a.getMonthValue()) - 1;
            }
            if (i10 == 6) {
                return f0();
            }
            if (i10 != 7) {
                return this.f139381a.j(temporalField);
            }
            return f0() < 1 ? 0 : 1;
        }
    ...
    public final int f0() {
        return this.f139381a.getYear() - 1911;
    }
    ...
    */
    public final j$.time.chrono.y a(long r8, j$.time.temporal.TemporalField r10) {
        /*
            ...
            return r7
        L10:
            int[] r1 = j$.time.chrono.x.f139380a
            int r2 = r0.ordinal()
            r2 = r1[r2]
            r3 = 7
            r4 = 6
            ...
            goto L63
        L25:
            j$.time.chrono.w r10 = j$.time.chrono.w.f139379c
            ...
            r2 = 12
            long r0 = r0 * r2
            j$.time.LocalDate r10 = r7.f139381a
            ...
            return r8
        L4d:
            j$.time.chrono.w r2 = j$.time.chrono.w.f139379c
            ...
            if (r0 == r3) goto L6e
        L63:
            j$.time.LocalDate r0 = r7.f139381a
            j$.time.LocalDate r8 = r0.a(r8, r10)
            j$.time.chrono.y r8 = r7.j0(r8)
            return r8
        L6e:
            j$.time.LocalDate r8 = r7.f139381a
            int r9 = r7.f0()
            int r9 = 1912 - r9
    ...
    public final ChronoLocalDate Z(long j10) {
        return j0(this.f139381a.q0(j10));
    }

    @Override // j$.time.chrono.AbstractC14872c
    public final ChronoLocalDate Q(long j10) {
        return j0(this.f139381a.o0(j10));
    }

    @Override // j$.time.chrono.AbstractC14872c
    public final ChronoLocalDate O(long j10) {
        return j0(this.f139381a.plusDays(j10));
    }
    ...
    public final y j0(LocalDate localDate) {
        return localDate.equals(this.f139381a) ? this : new y(localDate);
    }

    @Override // j$.time.chrono.ChronoLocalDate
    public final long S() {
        return this.f139381a.S();
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof y) {
            return this.f139381a.equals(((y) obj).f139381a);
        }
        return false;
    }
