...
public final class w extends AbstractC14870a implements Serializable {

    /* renamed from: c, reason: collision with root package name */
    public static final w f139379c = new w();
    ...
    public final j$.time.temporal.p F(ChronoField chronoField) {
        int i10 = v.f139378a[chronoField.ordinal()];
        if (i10 == 1) {
            j$.time.temporal.p pVar = ChronoField.PROLEPTIC_MONTH.f139516d;
            return j$.time.temporal.p.f(pVar.f139553a - 22932, pVar.f139556d - 22932);
        }
        if (i10 == 2) {
            j$.time.temporal.p pVar2 = ChronoField.YEAR.f139516d;
            return j$.time.temporal.p.g(1L, pVar2.f139556d - 1911, (-pVar2.f139553a) + 1912);
        }
        if (i10 != 3) {
            return chronoField.f139516d;
        }
        j$.time.temporal.p pVar3 = ChronoField.YEAR.f139516d;
        return j$.time.temporal.p.f(pVar3.f139553a - 1911, pVar3.f139556d - 1911);
    }
