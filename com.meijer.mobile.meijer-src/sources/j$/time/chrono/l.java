...
public final class l extends AbstractC14870a implements Serializable {

    /* renamed from: l, reason: collision with root package name */
    public static final l f139349l;
    private static final long serialVersionUID = 3127340209035924785L;

    /* renamed from: c, reason: collision with root package name */
    public volatile transient boolean f139350c;

    /* renamed from: d, reason: collision with root package name */
    public transient int[] f139351d;

    /* renamed from: e, reason: collision with root package name */
    public transient int f139352e;

    /* renamed from: f, reason: collision with root package name */
    public transient int f139353f;

    /* renamed from: g, reason: collision with root package name */
    public transient int f139354g;

    /* renamed from: h, reason: collision with root package name */
    public transient int f139355h;

    /* renamed from: i, reason: collision with root package name */
    public transient int f139356i;

    /* renamed from: j, reason: collision with root package name */
    public transient int f139357j;

    /* renamed from: k, reason: collision with root package name */
    public transient int f139358k;
    ...
    static {
        l lVar = new l();
        f139349l = lVar;
        AbstractC14870a.H(lVar, "Hijrah");
        AbstractC14870a.H(lVar, "islamic");
    }
    ...
    public final void i0() {
        ...
        try {
            ...
            this.f139351d = iArrJ0;
            this.f139353f = iArrJ0[3612];
            for (int i11 = 1300; i11 < 1600; i11++) {
                int iO0 = o0(i11, 12);
                this.f139357j = Math.min(this.f139357j, iO0);
                this.f139358k = Math.max(this.f139358k, iO0);
            }
            this.f139350c = true;
        } catch (Exception e10) {
    ...
    public final boolean g0(long j10) {
        i0();
        return j10 >= ((long) k0(0)) && j10 <= ((long) (k0(this.f139351d.length - 1) - 1)) && o0((int) j10, 12) > 354;
    }
    ...
    public final j$.time.temporal.p F(ChronoField chronoField) {
        i0();
        if (chronoField != null) {
            switch (k.f139348a[chronoField.ordinal()]) {
                case 1:
                    return j$.time.temporal.p.g(1L, this.f139355h, this.f139356i);
                case 2:
                    return j$.time.temporal.p.f(1L, this.f139358k);
                case 3:
                    return j$.time.temporal.p.f(1L, 5L);
                case 4:
                case 5:
                    return j$.time.temporal.p.f(k0(0), k0(this.f139351d.length - 1) - 1);
                case 6:
    ...
    public final long l0(int i10, int i11, int i12) {
        ...
        int i13 = (i11 - 1) + ((i10 * 12) - this.f139354g);
        if (i13 < 0 || i13 >= this.f139351d.length) {
        ...
        return (i12 - 1) + this.f139351d[i13];
    }

    public final int k0(int i10) {
        return (i10 + this.f139354g) / 12;
    }

    public final int m0(int i10, int i11) {
        int i12 = (i11 - 1) + ((i10 * 12) - this.f139354g);
        if (i12 >= 0) {
            int[] iArr = this.f139351d;
            if (i12 < iArr.length) {
    ...
    public final int[] j0(int i10, Map map) {
        ...
        this.f139355h = a.e.API_PRIORITY_OTHER;
        this.f139356i = Integer.MIN_VALUE;
        int i11 = 0;
        for (int i12 = 1300; i12 <= 1600; i12++) {
            ...
            while (i13 < 12) {
                ...
                i10 += i14;
                this.f139355h = Math.min(this.f139355h, i14);
                this.f139356i = Math.max(this.f139356i, i14);
                i13++;
                i11 = i15;
            }
        }
