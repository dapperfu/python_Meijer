...
public final class IsoChronology extends AbstractC14870a implements Serializable {
    ...
    public final void Q(Map map, ResolverStyle resolverStyle) {
        ...
        if (l10 != null) {
            ...
            AbstractC14870a.C(map, ChronoField.MONTH_OF_YEAR, ((int) Math.floorMod(l10.longValue(), r4)) + 1);
            AbstractC14870a.C(map, ChronoField.YEAR, Math.floorDiv(l10.longValue(), 12));
        }
    }
    ...
    public final ChronoLocalDate f0(Map map, ResolverStyle resolverStyle) {
        ...
        if (l10 != null) {
            ...
            if (l11 != null) {
                if (l11.longValue() == 1) {
                    AbstractC14870a.C(map, ChronoField.YEAR, l10.longValue());
                    return null;
                }
                if (l11.longValue() == 0) {
                    AbstractC14870a.C(map, ChronoField.YEAR, Math.subtractExact(1L, l10.longValue()));
                    return null;
                }
            ...
            if (resolverStyle != ResolverStyle.STRICT) {
                AbstractC14870a.C(map, chronoField2, (l12 == null || l12.longValue() > 0) ? l10.longValue() : Math.subtractExact(1L, l10.longValue()));
                return null;
            }
            if (l12 != null) {
                ...
                AbstractC14870a.C(map, chronoField2, jLongValue2);
                return null;
            }
    ...
    public final ChronoLocalDate Z(Map map, ResolverStyle resolverStyle) {
        ...
        int iA = chronoField.f139516d.a(((Long) map.remove(chronoField)).longValue(), chronoField);
        boolean z10 = true;
        if (resolverStyle == ResolverStyle.LENIENT) {
        ...
        int iA2 = chronoField2.f139516d.a(((Long) map.remove(chronoField2)).longValue(), chronoField2);
        ChronoField chronoField3 = ChronoField.DAY_OF_MONTH;
        int iA3 = chronoField3.f139516d.a(((Long) map.remove(chronoField3)).longValue(), chronoField3);
