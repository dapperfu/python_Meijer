...
public final class E extends AbstractC14872c {
    private static final long serialVersionUID = -8722293800195731463L;

    /* renamed from: a, reason: collision with root package name */
    public final transient LocalDate f139330a;
    ...
    public final int hashCode() {
        C.f139328c.getClass();
        return this.f139330a.hashCode() ^ 146118545;
    }
    ...
    public final j$.time.temporal.p k(TemporalField temporalField) {
        ...
        int i10 = D.f139329a[chronoField.ordinal()];
        if (i10 == 1 || i10 == 2 || i10 == 3) {
            return this.f139330a.k(temporalField);
        }
        if (i10 != 4) {
            return C.f139328c.F(chronoField);
        }
        j$.time.temporal.p pVar = ChronoField.YEAR.f139516d;
        return j$.time.temporal.p.f(1L, f0() <= 0 ? (-(pVar.f139553a + 543)) + 1 : 543 + pVar.f139556d);
    }

    @Override // j$.time.temporal.TemporalAccessor
    public final long j(TemporalField temporalField) {
        if (temporalField instanceof ChronoField) {
            int i10 = D.f139329a[((ChronoField) temporalField).ordinal()];
            if (i10 == 4) {
                int iF0 = f0();
                if (iF0 < 1) {
                    iF0 = 1 - iF0;
            ...
            if (i10 == 5) {
                return ((f0() * 12) + this.f139330a.getMonthValue()) - 1;
            }
            if (i10 == 6) {
                return f0();
            }
            if (i10 != 7) {
                return this.f139330a.j(temporalField);
            }
            return f0() < 1 ? 0 : 1;
        }
    ...
    public final int f0() {
        return this.f139330a.getYear() + 543;
    }
    ...
    */
    public final j$.time.chrono.E a(long r8, j$.time.temporal.TemporalField r10) {
        /*
            ...
            return r7
        L10:
            int[] r1 = j$.time.chrono.D.f139329a
            int r2 = r0.ordinal()
            r2 = r1[r2]
            r3 = 7
            r4 = 6
            ...
            goto L63
        L25:
            j$.time.chrono.C r10 = j$.time.chrono.C.f139328c
            ...
            r2 = 12
            long r0 = r0 * r2
            j$.time.LocalDate r10 = r7.f139330a
            ...
            return r8
        L4d:
            j$.time.chrono.C r2 = j$.time.chrono.C.f139328c
            ...
            if (r0 == r3) goto L6e
        L63:
            j$.time.LocalDate r0 = r7.f139330a
            j$.time.LocalDate r8 = r0.a(r8, r10)
            j$.time.chrono.E r8 = r7.j0(r8)
            return r8
        L6e:
            j$.time.LocalDate r8 = r7.f139330a
            int r9 = r7.f0()
            int r9 = (-542) - r9
    ...
    public final ChronoLocalDate Z(long j10) {
        return j0(this.f139330a.q0(j10));
    }

    @Override // j$.time.chrono.AbstractC14872c
    public final ChronoLocalDate Q(long j10) {
        return j0(this.f139330a.o0(j10));
    }

    @Override // j$.time.chrono.AbstractC14872c
    public final ChronoLocalDate O(long j10) {
        return j0(this.f139330a.plusDays(j10));
    }
    ...
    public final E j0(LocalDate localDate) {
        return localDate.equals(this.f139330a) ? this : new E(localDate);
    }

    @Override // j$.time.chrono.ChronoLocalDate
    public final long S() {
        return this.f139330a.S();
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof E) {
            return this.f139330a.equals(((E) obj).f139330a);
        }
        return false;
    }
