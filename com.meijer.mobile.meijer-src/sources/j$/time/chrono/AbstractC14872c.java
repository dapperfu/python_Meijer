...
public abstract class AbstractC14872c implements ChronoLocalDate, Temporal, j$.time.temporal.k, Serializable {
    ...
    public ChronoLocalDate b(long j10, TemporalUnit temporalUnit) {
        ...
        switch (AbstractC14871b.f139334a[((ChronoUnit) temporalUnit).ordinal()]) {
            case 1:
                return O(j10);
            case 2:
    ...
    public final long H(ChronoLocalDate chronoLocalDate) {
        if (g().F(ChronoField.MONTH_OF_YEAR).f139556d != 12) {
