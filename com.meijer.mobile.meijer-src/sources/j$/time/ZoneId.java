...
public abstract class ZoneId implements Serializable {
    ...
    public static final Map f139312a;
    ...
    static {
        ...
        f139312a = Collections.unmodifiableMap(map);
    }

    public static ZoneId systemDefault() {
        return of(TimeZone.getDefault().getID(), f139312a);
    }
    ...
    public static ZoneId Q(String str, ZoneOffset zoneOffset) {
        ...
        if (zoneOffset.f139317b != 0) {
            str = str.concat(zoneOffset.f139318c);
        }
    ...
    public static ZoneId C(TemporalAccessor temporalAccessor) {
        ZoneId zoneId = (ZoneId) temporalAccessor.d(j$.time.temporal.n.f139550e);
        if (zoneId != null) {
            return zoneId;
        }
