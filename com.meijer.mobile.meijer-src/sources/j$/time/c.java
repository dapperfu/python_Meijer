...
public final /* synthetic */ class c implements TemporalQuery, j$.time.temporal.k {
    ...
    public final /* synthetic */ int f139324a;
    ...
    public Temporal f(Temporal temporal) {
        ...
        return temporal.a(temporal.k(chronoField).f139556d, chronoField);
    }

    @Override // j$.time.temporal.TemporalQuery
    public Object queryFrom(TemporalAccessor temporalAccessor) {
        int i10 = this.f139324a;
        c cVar = j$.time.temporal.n.f139546a;
        switch (i10) {
            case 0:
            ...
            case 6:
                c cVar2 = DateTimeFormatterBuilder.f139410h;
            ...
            case 9:
                return (Chronology) temporalAccessor.d(j$.time.temporal.n.f139547b);
            case 10:
                return (TemporalUnit) temporalAccessor.d(j$.time.temporal.n.f139548c);
            case 11:
            ...
            case 12:
                ...
                return zoneId2 != null ? zoneId2 : (ZoneId) temporalAccessor.d(j$.time.temporal.n.f139549d);
            case 13:
