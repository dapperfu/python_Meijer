...
public class W {
    ...
    class a implements I.c<d0> {
        ...
        public void onFailure(Throwable th2) {
            if (this.f22848a.t() == 2 && (th2 instanceof CancellationException)) {
                C.P.a("SurfaceProcessorNode", "Downstream VideoCapture failed to provide Surface.");
                return;
            }
            C.P.m("SurfaceProcessorNode", "Downstream node failed to provide Surface. Target: " + a0.b(this.f22848a.t()), th2);
        }
    ...
    private void h(N n10) {
        try {
            this.f22844a.c(n10.k(this.f22845b));
        } catch (ProcessingException e10) {
    ...
    void i(N n10, final Map<Q.f, N> map) {
        n10.f(new InterfaceC16068a() { // from class: O.U
    ...
    public W(InterfaceC3290z interfaceC3290z, S s10) {
        this.f22845b = interfaceC3290z;
        this.f22844a = s10;
    }
    ...
    public void d(N n10, Map.Entry<Q.f, N> entry) {
        ...
        if (n10.u()) {
            interfaceC3290z = this.f22845b;
        } else {
            interfaceC3290z = null;
        }
        I.n.j(value.j(entry.getKey().b(), d0.a.f(sizeE, rectA, interfaceC3290z, entry.getKey().c(), entry.getKey().g()), null), new a(value), H.a.d());
    }
    ...
    public c j(b bVar) {
        ...
        N nB = bVar.b();
        for (Q.f fVar : bVar.a()) {
            this.f22846c.put(fVar, k(nB, fVar));
        }
        h(nB);
        g(nB, this.f22846c);
        i(nB, this.f22846c);
