...
public final class C14321a {
    ...
    public static boolean f(Location location) {
        return Build.VERSION.SDK_INT >= 26 ? C2116a.d(location) : a(location, "bearingAccuracy");
    }

    public static boolean g(Location location) {
        return Build.VERSION.SDK_INT >= 26 ? C2116a.e(location) : a(location, "speedAccuracy");
    }

    public static boolean h(Location location) {
        return Build.VERSION.SDK_INT >= 26 ? C2116a.f(location) : a(location, "verticalAccuracy");
    }
