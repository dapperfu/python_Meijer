...
@Metadata(d1 = {"\u0000J\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0010\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0000\u0018\u00002\u00020\u0001BK\b\u0007\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0005\u001a\u00020\u0004\u0012\b\b\u0002\u0010\u0006\u001a\u00020\u0004\u0012\b\b\u0002\u0010\u0007\u001a\u00020\u0004\u0012\b\b\u0002\u0010\t\u001a\u00020\b\u0012\u0012\u0010\f\u001a\u000e\u0012\u0004\u0012\u00020\u0004\u0012\u0004\u0012\u00020\u000b0\n¢\u0006\u0004\b\r\u0010\u000eJ)\u0010\u0014\u001a\u00020\u000b*\b\u0012\u0004\u0012\u00020\u00100\u000f2\u0006\u0010\u0011\u001a\u00020\u00102\u0006\u0010\u0013\u001a\u00020\u0012H\u0002¢\u0006\u0004\b\u0014\u0010\u0015J\r\u0010\u0017\u001a\u00020\u0016¢\u0006\u0004\b\u0017\u0010\u0018R\u0017\u0010\u0003\u001a\u00020\u00028\u0006¢\u0006\f\n\u0004\b\u0017\u0010\u0019\u001a\u0004\b\u001a\u0010\u001bR\u0014\u0010\u0005\u001a\u00020\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001c\u0010\u001dR\u0014\u0010\u0006\u001a\u00020\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001e\u0010\u001dR\u0014\u0010\u0007\u001a\u00020\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001f\u0010\u001dR\u0014\u0010\t\u001a\u00020\b8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0014\u0010 R#\u0010\f\u001a\u000e\u0012\u0004\u0012\u00020\u0004\u0012\u0004\u0012\u00020\u000b0\n8\u0006¢\u0006\f\n\u0004\b!\u0010\"\u001a\u0004\b\u001f\u0010#R\u001a\u0010&\u001a\b\u0012\u0004\u0012\u00020\u00100\u000f8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b$\u0010%R\u0014\u0010*\u001a\u00020'8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b(\u0010)¨\u0006+"}, d2 = {"LL7/c;", "", "Ly7/a;", "timeProvider", "", "maxEventsPerWindow", "windowSizeSeconds", "summaryInterval", "Lmv/O;", "coroutineScope", "Lkotlin/Function1;", "", "summaryReceiver", "<init>", "(Ly7/a;IIILmv/O;Lkotlin/jvm/functions/Function1;)V", "Ljava/util/LinkedList;", "", "now", "Lkotlin/time/Duration;", "size", "e", "(Ljava/util/LinkedList;JJ)V", "", "a", "()Z", "Ly7/a;", "getTimeProvider", "()Ly7/a;", "b", "I", "c", "d", "Lmv/O;", "f", "Lkotlin/jvm/functions/Function1;", "()Lkotlin/jvm/functions/Function1;", "g", "Ljava/util/LinkedList;", "eventWindow", "Ljava/util/concurrent/atomic/AtomicInteger;", "h", "Ljava/util/concurrent/atomic/AtomicInteger;", "dropCounter", "com.dynatrace.agent_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
...
public final class c {
    ...
    static final class a extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                long jS = DurationKt.s(c.this.summaryInterval, DurationUnit.f148417e);
                this.f18056a = 1;
                if (Z.c(jS, this) == objF) {
                    return objF;
                }
    ...
    @JvmOverloads
    public c(InterfaceC18294a timeProvider, int i10, Function1<? super Integer, Unit> summaryReceiver) {
    ...
    @JvmOverloads
    public c(InterfaceC18294a timeProvider, int i10, int i11, int i12, InterfaceC15783O coroutineScope, Function1<? super Integer, Unit> summaryReceiver) {
        Intrinsics.j(timeProvider, "timeProvider");
    ...
    public final boolean a() throws Throwable {
        ...
        synchronized (this.eventWindow) {
            ...
            try {
                e(linkedList, jA, DurationKt.s(this.windowSizeSeconds, DurationUnit.f148417e));
                if (this.eventWindow.size() < this.maxEventsPerWindow) {
                    ...
                    if (this.dropCounter.getAndIncrement() == 0) {
                        C15809k.d(this.coroutineScope, null, null, new a(null), 3, null);
                    }
                    z10 = false;
                }
                return z10;
    ...
    public /* synthetic */ c(InterfaceC18294a interfaceC18294a, int i10, int i11, int i12, InterfaceC15783O interfaceC15783O, Function1 function1, int i13, DefaultConstructorMarker defaultConstructorMarker) {
        this(interfaceC18294a, i10, (i13 & 4) != 0 ? 60 : i11, (i13 & 8) != 0 ? 60 : i12, (i13 & 16) != 0 ? C15784P.a(C15800f0.b()) : interfaceC15783O, function1);
    }
}
