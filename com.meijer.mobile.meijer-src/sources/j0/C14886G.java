...
public final class C14886G {
    public static final androidx.compose.ui.layout.J a(InterfaceC14885F interfaceC14885F, int i10, int i11, int i12, int i13, int i14, androidx.compose.ui.layout.K k10, List<? extends androidx.compose.ui.layout.I> list, f0[] f0VarArr, int i15, int i16, int[] iArr, int i17) {
        int i18;
        char c10;
        char c11;
        int i19;
        int iMax;
        int iMax2;
        InterfaceC14885F interfaceC14885F2;
        int i20;
        long j10;
        int i21;
        int i22 = i13;
        ...
        while (true) {
            ...
            RowColumnParentData rowColumnParentDataC = C14884E.c(i33);
            float fE = C14884E.e(rowColumnParentDataC);
            if (i28 == 0 && !C14884E.f(rowColumnParentDataC)) {
                i32 = i24;
            }
            if (fE > 0.0f) {
                f10 += fE;
                ...
                if (f0VarK0 == null) {
                    ...
                    i20 = i25;
                    interfaceC14885F2 = interfaceC14885F;
                    j10 = j11;
                    i21 = i27;
                    f0VarK0 = i33.k0(InterfaceC14885F.l(interfaceC14885F2, 0, 0, i31, i22, false, 16, null));
                } else {
                    interfaceC14885F2 = interfaceC14885F;
                    i20 = i25;
                    j10 = j11;
                ...
                int iH = interfaceC14885F2.h(f0VarK0);
                int iK = interfaceC14885F2.k(f0VarK0);
                iArr2[i20 - i15] = iH;
                int i35 = i34 - iH;
                if (i35 < 0) {
                    i35 = 0;
        ...
        InterfaceC14885F interfaceC14885F3 = interfaceC14885F;
        long j12 = j11;
        int i36 = i27;
        if (i29 == 0) {
            i30 -= i26;
            ...
            for (int i37 = i15; i37 < i16; i37++) {
                jRound -= Math.round(C14884E.e(C14884E.c(list.get(i37))) * f11);
            }
            int i38 = i15;
            int i39 = 0;
            while (i38 < i16) {
                if (f0VarArr[i38] == null) {
                    ...
                    RowColumnParentData rowColumnParentDataC2 = C14884E.c(i40);
                    float fE2 = C14884E.e(rowColumnParentDataC2);
                    if (i22 != Integer.MAX_VALUE && rowColumnParentDataC2 != null) {
                        rowColumnParentDataC2.c();
                    }
                    if (!(fE2 > 0.0f)) {
                        C15077a.b("All weights <= 0 should have placeables");
                    }
                    int iB = MathKt.b(jRound);
                    long j14 = jRound - iB;
                    int iMax4 = Math.max(0, Math.round(fE2 * f11) + iB);
                    if (C14884E.b(rowColumnParentDataC2)) {
                        c10 = 65535;
                        if (iMax4 != Integer.MAX_VALUE) {
                            c11 = 65535;
                            i19 = iMax4;
                        }
                        interfaceC14885F3 = interfaceC14885F;
                        f0 f0VarK02 = i40.k0(interfaceC14885F3.a(i19, 0, iMax4, i22, true));
                        int iH2 = interfaceC14885F3.h(f0VarK02);
                        int iK2 = interfaceC14885F3.k(f0VarK02);
                        iArr2[i38 - i15] = iH2;
                        i39 += iH2;
                    ...
                    i19 = 0;
                    interfaceC14885F3 = interfaceC14885F;
                    f0 f0VarK022 = i40.k0(interfaceC14885F3.a(i19, 0, iMax4, i22, true));
                    int iH22 = interfaceC14885F3.h(f0VarK022);
                    int iK22 = interfaceC14885F3.k(f0VarK022);
                    iArr2[i38 - i15] = iH22;
                    i39 += iH22;
        ...
        if (i28 != 0) {
            ...
            for (int i43 = i15; i43 < i16; i43++) {
                ...
                Intrinsics.g(f0Var);
                AbstractC5809m abstractC5809mA = C14884E.a(C14884E.d(f0Var));
                Integer numB = abstractC5809mA != null ? abstractC5809mA.b(f0Var) : null;
                if (numB != null) {
                    int iIntValue = numB.intValue();
                    int iK3 = interfaceC14885F3.k(f0Var);
        ...
        interfaceC14885F3.c(iMax6, iArr2, iArr3, k10);
        return interfaceC14885F3.f(f0VarArr, k10, iMax, iArr3, iMax6, iMax7, iArr, i17, i15, i16);
    }
}
