...
final class C14892M implements InterfaceC14894O {

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC14894O first;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC14894O second;

    public boolean equals(Object other) {
        if (this == other) {
            return true;
        }
        if (!(other instanceof C14892M)) {
            return false;
        }
        C14892M c14892m = (C14892M) other;
        return Intrinsics.e(c14892m.first, this.first) && Intrinsics.e(c14892m.second, this.second);
    }
    ...
    public C14892M(InterfaceC14894O interfaceC14894O, InterfaceC14894O interfaceC14894O2) {
        this.first = interfaceC14894O;
        this.second = interfaceC14894O2;
    }
}
