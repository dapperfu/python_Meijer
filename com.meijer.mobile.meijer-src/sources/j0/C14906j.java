...
final class C14906j extends O0 implements androidx.compose.ui.layout.B, k1.d {
    ...
    static final class a extends Lambda implements Function1<f0.a, Unit> {
        ...
        public static final a f139709f = new a();
    ...
    static final class b extends Lambda implements Function1<f0.a, Unit> {
        ...
        public final void a(f0.a aVar) {
            f0.a.l(aVar, this.f139710f, 0, 0, 0.0f, 4, null);
        }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof C14906j)) {
            return false;
        }
        C14906j c14906j = (C14906j) other;
        return Intrinsics.e(this.insets, c14906j.insets) && this.heightCalc == c14906j.heightCalc;
    }

    private final InterfaceC14894O b() {
        return (InterfaceC14894O) this.unconsumedInsets.getValue();
    }

    private final void e(InterfaceC14894O interfaceC14894O) {
        this.unconsumedInsets.setValue(interfaceC14894O);
    }
    ...
    public androidx.compose.ui.layout.J a(androidx.compose.ui.layout.K k10, androidx.compose.ui.layout.I i10, long j10) {
        ...
        if (iIntValue == 0) {
            return androidx.compose.ui.layout.K.G0(k10, 0, 0, null, a.f139709f, 4, null);
        }
    ...
    public void m(k1.k scope) {
        e(C14896Q.f(this.insets, (InterfaceC14894O) scope.q(S.a())));
    }

    /* JADX WARN: Multi-variable type inference failed */
    public C14906j(InterfaceC14894O interfaceC14894O, Function1<? super N0, Unit> function1, Function2<? super InterfaceC14894O, ? super H1.d, Integer> function2) {
        super(function1);
        this.insets = interfaceC14894O;
        this.heightCalc = function2;
        this.unconsumedInsets = t1.e(interfaceC14894O, null, 2, null);
    }
}
