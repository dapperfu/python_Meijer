...
public interface InterfaceC14902f {
    Modifier a(Modifier modifier, float f10, boolean z10);

    Modifier c(Modifier modifier, e.b bVar);

    static /* synthetic */ Modifier b(InterfaceC14902f interfaceC14902f, Modifier modifier, float f10, boolean z10, int i10, Object obj) {
        if (obj != null) {
        ...
        return interfaceC14902f.a(modifier, f10, z10);
    }
}
