...
public final class f extends bw.c {
    ...
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0019\u0010\u0007\u001a\u0004\u0018\u00010\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0007¢\u0006\u0004\b\u0007\u0010\b¨\u0006\t"}, d2 = {"LYv/f$a;", "", "<init>", "()V", "Ljavax/net/ssl/X509TrustManager;", "trustManager", "LYv/f;", "a", "(Ljavax/net/ssl/X509TrustManager;)LYv/f;", "okhttp"}, k = 1, mv = {2, 2, 0}, xi = 48)
    /* renamed from: Yv.f$a, reason: from kotlin metadata */
    public static final class Companion {
        ...
        public final f a(X509TrustManager trustManager) {
            ...
            if (x509TrustManagerExtensions != null) {
                return new f(trustManager, x509TrustManagerExtensions);
            }
            return null;
        }
    }

    public f(X509TrustManager trustManager, X509TrustManagerExtensions x509TrustManagerExtensions) {
        Intrinsics.j(trustManager, "trustManager");
        Intrinsics.j(x509TrustManagerExtensions, "x509TrustManagerExtensions");
    ...
    public List<Certificate> a(List<? extends Certificate> chain, String hostname) throws CertificateException, SSLPeerUnverifiedException {
        ...
        try {
            ...
            Intrinsics.i(listCheckServerTrusted, "checkServerTrusted(...)");
    ...
    public boolean equals(Object other) {
        return (other instanceof f) && ((f) other).trustManager == this.trustManager;
    }
