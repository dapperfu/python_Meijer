...
class E0 {
    public static CaptureRequest e(androidx.camera.core.impl.i iVar, CameraDevice cameraDevice, Map<DeferrableSurface, Surface> map, boolean z10, C18409z c18409z) throws CameraAccessException {
        ...
        c(builderCreateCaptureRequest, iVar.k(), c18409z);
    ...
    public static CaptureRequest f(androidx.camera.core.impl.i iVar, CameraDevice cameraDevice, C18409z c18409z) throws CameraAccessException {
        if (cameraDevice == null) {
            return null;
        }
    ...
    private static void a(androidx.camera.core.impl.i iVar, CaptureRequest.Builder builder) {
        if (!iVar.e().equals(androidx.camera.core.impl.x.f47721a)) {
    ...
    private static void c(CaptureRequest.Builder builder, int i10, C18409z c18409z) {
        for (Map.Entry<CaptureRequest.Key<?>, Object> entry : c18409z.a(i10).entrySet()) {
