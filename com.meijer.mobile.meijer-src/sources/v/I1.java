...
final class I1 {
    ...
    private final String f164737i;

    /* renamed from: j, reason: collision with root package name */
    private final InterfaceC17513f f164738j;

    /* renamed from: k, reason: collision with root package name */
    private final w.B f164739k;

    /* renamed from: l, reason: collision with root package name */
    private final C18389f f164740l;

    /* renamed from: m, reason: collision with root package name */
    private final int f164741m;

    /* renamed from: n, reason: collision with root package name */
    private boolean f164742n;

    /* renamed from: o, reason: collision with root package name */
    private boolean f164743o;

    /* renamed from: p, reason: collision with root package name */
    private boolean f164744p;

    /* renamed from: q, reason: collision with root package name */
    private boolean f164745q;

    /* renamed from: r, reason: collision with root package name */
    private boolean f164746r;

    /* renamed from: s, reason: collision with root package name */
    private boolean f164747s;

    /* renamed from: t, reason: collision with root package name */
    F.w0 f164748t;

    /* renamed from: v, reason: collision with root package name */
    private final C17524i1 f164750v;

    /* renamed from: y, reason: collision with root package name */
    private final C17527j1 f164753y;

    /* renamed from: a, reason: collision with root package name */
    private final List<F.u0> f164729a = new ArrayList();

    /* renamed from: b, reason: collision with root package name */
    private final List<F.u0> f164730b = new ArrayList();

    /* renamed from: c, reason: collision with root package name */
    private final List<F.u0> f164731c = new ArrayList();

    /* renamed from: d, reason: collision with root package name */
    private final List<F.u0> f164732d = new ArrayList();

    /* renamed from: e, reason: collision with root package name */
    private final Map<b, List<F.u0>> f164733e = new HashMap();

    /* renamed from: f, reason: collision with root package name */
    private final List<F.u0> f164734f = new ArrayList();

    /* renamed from: g, reason: collision with root package name */
    private final List<F.u0> f164735g = new ArrayList();

    /* renamed from: h, reason: collision with root package name */
    private final List<F.u0> f164736h = new ArrayList();

    /* renamed from: u, reason: collision with root package name */
    List<Integer> f164749u = new ArrayList();

    /* renamed from: w, reason: collision with root package name */
    private final C18408y f164751w = new C18408y();

    /* renamed from: x, reason: collision with root package name */
    private final C18404u f164752x = new C18404u();
    ...
    static abstract class b {
        ...
        static b e(int i10, int i11, boolean z10, boolean z11) {
            return new C17510e(i10, i11, z10, z11);
        }
    ...
    private List<F.u0> B(b bVar) {
        if (this.f164733e.containsKey(bVar)) {
            return this.f164733e.get(bVar);
        }
        List<F.u0> arrayList = new ArrayList<>();
        if (bVar.d()) {
            if (bVar.a() == 0) {
                arrayList.addAll(this.f164735g);
            }
        } else if (bVar.b() == 8) {
            int iA = bVar.a();
            if (iA == 1) {
                arrayList = this.f164731c;
            } else if (iA != 2) {
                arrayList.addAll(bVar.c() ? this.f164732d : this.f164729a);
            } else {
                arrayList.addAll(this.f164730b);
                arrayList.addAll(this.f164729a);
            }
        } else if (bVar.b() == 10 && bVar.a() == 0) {
            arrayList.addAll(this.f164734f);
        }
        this.f164733e.put(bVar, arrayList);
        return arrayList;
    }

    private Pair<List<F.v0>, Integer> C(int i10, List<AbstractC5792a> list, List<Size> list2, List<androidx.camera.core.impl.D<?>> list3, List<Integer> list4, int i11, Map<Integer, AbstractC5792a> map, Map<Integer, androidx.camera.core.impl.D<?>> map2) {
        ArrayList arrayList = new ArrayList();
        for (AbstractC5792a abstractC5792a : list) {
            arrayList.add(abstractC5792a.g());
            if (map != null) {
                map.put(Integer.valueOf(arrayList.size() - 1), abstractC5792a);
            }
        }
    ...
    private int E(int i10, int i11, Size size) {
        return Math.min(i10, q(this.f164739k, i11, size));
    }
    ...
    private boolean K(b bVar, List<AbstractC5792a> list, Map<androidx.camera.core.impl.D<?>, List<Size>> map) {
        ArrayList arrayList = new ArrayList();
    ...
    private void L() throws NumberFormatException {
        this.f164750v.g();
        if (this.f164748t == null) {
            l();
        } else {
            this.f164748t = F.w0.a(this.f164748t.b(), this.f164748t.j(), this.f164750v.f(), this.f164748t.h(), this.f164748t.f(), this.f164748t.d(), this.f164748t.l());
        }
    }

    private void N(Map<Integer, Size> map, int i10) {
        Size sizeR = r(this.f164739k.b().d(), i10, true);
        if (sizeR != null) {
    ...
    private void O(Map<Integer, Size> map, Size size, int i10) {
        if (this.f164744p) {
            Size sizeR = r(this.f164739k.b().d(), i10, false);
    ...
    private void P(Map<Integer, Size> map, int i10) {
        ...
        if (Build.VERSION.SDK_INT < 31 || !this.f164746r || (streamConfigurationMap = (StreamConfigurationMap) this.f164739k.a(CameraCharacteristics.SCALER_STREAM_CONFIGURATION_MAP_MAXIMUM_RESOLUTION)) == null) {
            return;
        }
    ...
    private Map<androidx.camera.core.impl.D<?>, List<Size>> f(Map<androidx.camera.core.impl.D<?>, List<Size>> map, b bVar, Range<Integer> range) {
        ...
        for (androidx.camera.core.impl.D<?> d10 : map.keySet()) {
            ...
            for (Size size : map.get(d10)) {
                ...
                int iQ = range != null ? q(this.f164739k, iN, size) : a.e.API_PRIORITY_OTHER;
    ...
    private void g() {
        this.f164734f.addAll(C17556t1.b());
    }

    private void h() {
        this.f164731c.addAll(C17556t1.d());
    }

    private void i() {
        if (Build.VERSION.SDK_INT >= 33) {
            this.f164732d.addAll(C17556t1.i());
        }
    }

    private void j() {
        if (Build.VERSION.SDK_INT >= 33) {
            this.f164736h.addAll(C17556t1.k());
        }
    }

    private void k() {
        this.f164729a.addAll(C17556t1.a(this.f164741m, this.f164742n, this.f164743o));
        this.f164729a.addAll(this.f164740l.a(this.f164737i));
    }

    private void l() throws NumberFormatException {
        this.f164748t = F.w0.a(N.c.f20522c, new HashMap(), this.f164750v.f(), new HashMap(), w(), new HashMap(), new HashMap());
    }

    private void m() {
        this.f164735g.addAll(C17556t1.l());
    }

    private void n() {
        this.f164730b.addAll(C17556t1.m());
    }

    private Range<Integer> p(Range<Integer> range, int i10) {
        if (range != null) {
            Range<Integer> rangeD = androidx.camera.core.impl.x.f47721a;
            if (!range.equals(rangeD)) {
                Range<Integer>[] rangeArr = (Range[]) this.f164739k.a(CameraCharacteristics.CONTROL_AE_AVAILABLE_TARGET_FPS_RANGES);
                if (rangeArr == null) {
                    return rangeD;
                }
                ...
                for (Range<Integer> range3 : rangeArr) {
                    if (i10 >= ((Integer) range3.getLower()).intValue()) {
                        if (rangeD.equals(androidx.camera.core.impl.x.f47721a)) {
                            rangeD = range3;
                        }
        ...
        return androidx.camera.core.impl.x.f47721a;
    }
    ...
    private Size w() throws NumberFormatException {
        try {
            int i10 = Integer.parseInt(this.f164737i);
            CamcorderProfile camcorderProfileA = this.f164738j.b(i10, 1) ? this.f164738j.a(i10, 1) : null;
    ...
    private Size x(int i10) {
        Size size = N.c.f20523d;
        CamcorderProfile camcorderProfileA = this.f164738j.b(i10, 10) ? this.f164738j.a(i10, 10) : this.f164738j.b(i10, 8) ? this.f164738j.a(i10, 8) : this.f164738j.b(i10, 12) ? this.f164738j.a(i10, 12) : this.f164738j.b(i10, 6) ? this.f164738j.a(i10, 6) : this.f164738j.b(i10, 5) ? this.f164738j.a(i10, 5) : this.f164738j.b(i10, 4) ? this.f164738j.a(i10, 4) : null;
        return camcorderProfileA != null ? new Size(camcorderProfileA.videoFrameWidth, camcorderProfileA.videoFrameHeight) : size;
    }

    private Size y() {
        Size[] outputSizes = this.f164739k.b().d().getOutputSizes(MediaRecorder.class);
        if (outputSizes == null) {
            return N.c.f20523d;
        }
    ...
    Pair<Map<androidx.camera.core.impl.D<?>, androidx.camera.core.impl.x>, Map<AbstractC5792a, androidx.camera.core.impl.x>> A(int i10, List<AbstractC5792a> list, Map<androidx.camera.core.impl.D<?>, List<Size>> map, boolean z10, boolean z11) throws NumberFormatException {
        int i11;
        HashMap map2;
        HashMap map3;
        HashMap map4;
        ...
        Map<androidx.camera.core.impl.D<?>, C3037w> mapG = this.f164753y.g(list, arrayList, listH);
        ...
        if (!zK) {
            throw new IllegalArgumentException("No supported surface combination is found for camera device - Id : " + this.f164737i + ".  May be attempting to bind too many use cases. Existing surfaces: " + list + " New configs: " + arrayList);
        }
        ...
        list5 = list7;
        if (list4 == null) {
            throw new IllegalArgumentException(str2 + this.f164737i + " and Hardware level: " + this.f164741m + ". May be the specified resolution is too large and not supported. Existing surfaces: " + list + str + arrayList);
        }
        Range<Integer> rangeP = rangeD != null ? p(rangeD, i14) : null;
        for (androidx.camera.core.impl.D<?> d11 : arrayList) {
            x.a aVarF = androidx.camera.core.impl.x.a(list4.get(listH.indexOf(Integer.valueOf(arrayList.indexOf(d11))))).b((C3037w) o2.i.g(mapG.get(d11))).d(G1.e(d11)).f(z11);
            if (rangeP != null) {
                aVarF.c(rangeP);
            }
        ...
        map7 = map8;
        if (!G1.k(this.f164739k, list, map4, map7)) {
    ...
    F.w0 F(int i10) {
        if (!this.f164749u.contains(Integer.valueOf(i10))) {
            O(this.f164748t.j(), N.c.f20524e, i10);
            O(this.f164748t.h(), N.c.f20526g, i10);
            N(this.f164748t.d(), i10);
            P(this.f164748t.l(), i10);
            this.f164749u.add(Integer.valueOf(i10));
        }
        return this.f164748t;
    }

    List<Size> a(List<Size> list, int i10) {
        Rational rational;
        int iA = this.f164751w.a(this.f164737i, this.f164739k);
        if (iA == 0) {
            rational = G.a.f11062a;
        } else if (iA == 1) {
            rational = G.a.f11064c;
        } else if (iA != 2) {
            rational = null;
        } else {
        ...
        return this.f164752x.a(F.v0.e(i10), list);
    }

    I1(Context context, String str, w.O o10, InterfaceC17513f interfaceC17513f) throws CameraUnavailableException, NumberFormatException {
        int iIntValue;
        this.f164742n = false;
        this.f164743o = false;
        this.f164744p = false;
        ...
        this.f164737i = str2;
        this.f164738j = (InterfaceC17513f) o2.i.g(interfaceC17513f);
        this.f164740l = new C18389f();
        this.f164750v = C17524i1.c(context);
        try {
            w.B bC = o10.c(str2);
            this.f164739k = bC;
            ...
            boolean zH = G1.h(this.f164739k);
            this.f164745q = zH;
            if (zH) {
                j();
            }
            boolean zA = Y1.a(this.f164739k);
            this.f164747s = zA;
            if (zA) {
                i();
            }
    ...
    private Range<Integer> D(List<AbstractC5792a> list, List<androidx.camera.core.impl.D<?>> list2, List<Integer> list3) {
        Iterator<AbstractC5792a> it = list.iterator();
    ...
    private static boolean I(List<AbstractC5792a> list, Map<androidx.camera.core.impl.D<?>, List<Size>> map) {
        Iterator<AbstractC5792a> it = list.iterator();
        while (it.hasNext()) {
            if (it.next().d() == 4101) {
                return true;
    ...
    private b e(int i10, Map<androidx.camera.core.impl.D<?>, C3037w> map, boolean z10, boolean z11) {
        int iZ = z(map);
        if (i10 != 0 && z11) {
            throw new IllegalArgumentException(String.format("Camera device id is %s. Ultra HDR is not currently supported in %s camera mode.", this.f164737i, F.A.a(i10)));
        }
        if (i10 != 0 && iZ == 10) {
            throw new IllegalArgumentException(String.format("Camera device id is %s. 10 bit dynamic range is not currently supported in %s camera mode.", this.f164737i, F.A.a(i10)));
        }
    ...
    private int s(List<AbstractC5792a> list) {
        int iE = a.e.API_PRIORITY_OTHER;
        for (AbstractC5792a abstractC5792a : list) {
            iE = E(iE, abstractC5792a.d(), abstractC5792a.f());
        }
        return iE;
    }
    ...
    private static int z(Map<androidx.camera.core.impl.D<?>, C3037w> map) {
        Iterator<C3037w> it = map.values().iterator();
        while (it.hasNext()) {
            if (it.next().a() == 10) {
                return 10;
            }
    ...
    List<F.v0> t(b bVar, List<F.v0> list) {
        ...
        Iterator<F.u0> it = this.f164736h.iterator();
        while (it.hasNext()) {
