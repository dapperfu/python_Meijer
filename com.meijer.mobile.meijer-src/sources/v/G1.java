...
public final class G1 {
    ...
    public static final k.a<Long> f164710a = k.a.a("camera2.streamSpec.streamUseCase", Long.TYPE);

    /* renamed from: b, reason: collision with root package name */
    private static final Map<Long, Set<E.b>> f164711b;

    /* renamed from: c, reason: collision with root package name */
    private static final Map<Long, Set<E.b>> f164712c;

    public static boolean a(Map<Integer, AbstractC5792a> map, Map<Integer, androidx.camera.core.impl.D<?>> map2, List<F.v0> list) {
        for (int i10 = 0; i10 < list.size(); i10++) {
            long jF = list.get(i10).f();
            if (map.containsKey(Integer.valueOf(i10))) {
                AbstractC5792a abstractC5792a = map.get(Integer.valueOf(i10));
                if (!g(abstractC5792a.b().size() == 1 ? abstractC5792a.b().get(0) : E.b.STREAM_SHARING, jF, abstractC5792a.b())) {
                    return false;
                }
            } else {
    ...
    public static void l(Map<androidx.camera.core.impl.D<?>, androidx.camera.core.impl.x> map, Map<AbstractC5792a, androidx.camera.core.impl.x> map2, Map<Integer, AbstractC5792a> map3, Map<Integer, androidx.camera.core.impl.D<?>> map4, List<F.v0> list) {
        for (int i10 = 0; i10 < list.size(); i10++) {
            long jF = list.get(i10).f();
            if (map3.containsKey(Integer.valueOf(i10))) {
                AbstractC5792a abstractC5792a = map3.get(Integer.valueOf(i10));
                androidx.camera.core.impl.k kVarF = f(abstractC5792a.e(), jF);
                if (kVarF != null) {
                    map2.put(abstractC5792a, abstractC5792a.i(kVarF));
                }
            } else {
    ...
    private static boolean i(List<AbstractC5792a> list, List<androidx.camera.core.impl.D<?>> list2, Set<Long> set) {
        boolean z10;
        boolean z11;
        HashSet hashSet = new HashSet();
        Iterator<AbstractC5792a> it = list.iterator();
        if (it.hasNext()) {
            AbstractC5792a next = it.next();
            androidx.camera.core.impl.k kVarE = next.e();
            k.a<Long> aVar = C17296a.f163492K;
    ...
    private static boolean j(androidx.camera.core.impl.k kVar, E.b bVar) {
        if (((Boolean) kVar.h(androidx.camera.core.impl.D.f47546D, Boolean.FALSE)).booleanValue()) {
            return false;
        }
        k.a<Integer> aVar = androidx.camera.core.impl.o.f47659J;
        return kVar.c(aVar) && V1.b(bVar, ((Integer) kVar.a(aVar)).intValue()) == 5;
    }

    public static boolean k(w.B b10, List<AbstractC5792a> list, Map<androidx.camera.core.impl.D<?>, androidx.camera.core.impl.x> map, Map<AbstractC5792a, androidx.camera.core.impl.x> map2) {
        if (Build.VERSION.SDK_INT < 33) {
            return false;
        }
        ...
        if (jArr != null && jArr.length != 0) {
            ...
            if (i(list, arrayList, hashSet)) {
                for (AbstractC5792a abstractC5792a : list) {
                    androidx.camera.core.impl.k kVarE = abstractC5792a.e();
                    androidx.camera.core.impl.k kVarF = f(kVarE, ((Long) kVarE.a(C17296a.f163492K)).longValue());
                    if (kVarF != null) {
                        map2.put(abstractC5792a, abstractC5792a.i(kVarF));
                    }
                }
                for (androidx.camera.core.impl.D<?> d10 : arrayList) {
                    ...
                    androidx.camera.core.impl.k kVarF2 = f(kVarD, ((Long) kVarD.a(C17296a.f163492K)).longValue());
                    if (kVarF2 != null) {
                        map.put(d10, xVar.g().d(kVarF2).a());
                    }
                }
    ...
    public static boolean d(List<AbstractC5792a> list, List<androidx.camera.core.impl.D<?>> list2) {
        for (AbstractC5792a abstractC5792a : list) {
            if (j(abstractC5792a.e(), abstractC5792a.b().get(0))) {
                return true;
            }
        }
        for (androidx.camera.core.impl.D<?> d10 : list2) {
    ...
    public static C17296a e(androidx.camera.core.impl.D<?> d10) {
        androidx.camera.core.impl.s sVarB0 = androidx.camera.core.impl.s.b0();
        k.a<?> aVar = C17296a.f163492K;
        if (d10.c(aVar)) {
            sVarB0.r(aVar, (Long) d10.a(aVar));
        }
        k.a<?> aVar2 = androidx.camera.core.impl.D.f47546D;
        if (d10.c(aVar2)) {
            sVarB0.r(aVar2, (Boolean) d10.a(aVar2));
        }
        k.a<?> aVar3 = androidx.camera.core.impl.o.f47659J;
        if (d10.c(aVar3)) {
            sVarB0.r(aVar3, (Integer) d10.a(aVar3));
        }
        k.a<?> aVar4 = androidx.camera.core.impl.p.f47673l;
        if (d10.c(aVar4)) {
            sVarB0.r(aVar4, (Integer) d10.a(aVar4));
        }
        return new C17296a(sVarB0);
    }
