...
public class a {
    ...
    static final class C0184a extends Lambda implements Function0<String> {
        ...
        final /* synthetic */ Ref.IntRef f11173f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f11174g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C0184a(Ref.IntRef intRef, int i10) {
            super(0);
            this.f11173f = intRef;
            this.f11174g = i10;
        }
        ...
        public final String invoke() {
            List list = b.f11175a;
            Ref.IntRef intRef = this.f11173f;
            int i10 = intRef.f143740a;
            intRef.f143740a = i10 + 1;
            return (String) list.get(i10 % this.f11174g);
        }
    }

    private final String a(int words) {
        return SequencesKt.K(SequencesKt.U(SequencesKt.r(new C0184a(new Ref.IntRef(), b.f11175a.size())), words), " ", null, null, 0, null, null, 62, null);
    }
