...
public final class a {
    ...
    private static Function3<d, Composer, Integer, Unit> f13549b = ComposableLambdaKt.composableLambdaInstance(1634108956, false, C0210a.f13550a);

    @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
    /* renamed from: Hi.a$a, reason: collision with other inner class name */
    static final class C0210a implements Function3<d, Composer, Integer, Unit> {

        /* renamed from: a, reason: collision with root package name */
        public static final C0210a f13550a = new C0210a();
