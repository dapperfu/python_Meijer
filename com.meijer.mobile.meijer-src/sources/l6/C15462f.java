...
public final class C15462f extends Modifier.c implements D {
    ...
    static final class a extends Lambda implements Function1<f0.a, Unit> {
        ...
        public final void a(f0.a layout) {
            ...
            f0.a.l(layout, this.f149442f, 0, 0, 0.0f, 4, null);
        }
    ...
    public C15462f(int i10, int i11) {
        this.width = i10;
        this.height = i11;
    }
}
