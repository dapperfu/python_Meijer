...
public final class C14941a extends c0 {
    ...
    public C14941a(C6138L c6138l) {
        UUID uuidRandomUUID = (UUID) c6138l.b("SaveableStateHolder_BackStackEntryKey");
        if (uuidRandomUUID == null) {
            uuidRandomUUID = UUID.randomUUID();
            c6138l.f("SaveableStateHolder_BackStackEntryKey", uuidRandomUUID);
        }
