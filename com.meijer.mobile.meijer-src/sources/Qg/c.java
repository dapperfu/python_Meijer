...
public final class c {
    ...
    private final Kg.c f28127a = new Kg.c(Kg.a.f16622o);
    ...
    private int a(byte[] bArr, int i10, int i11, int i12, int i13) throws ChecksumException {
        ...
        try {
            int iA = this.f28127a.a(iArr, i12 / i15);
    ...
    public e b(Ig.b bVar, Map<d, ?> map) throws ChecksumException, FormatException {
        int iA;
        byte[] bArr;
        byte[] bArrA = new a(bVar).a();
        int iA2 = a(bArrA, 0, 10, 10, 0);
        int i10 = bArrA[0] & C14170dq.MULTIPLY;
