...
public final class C18288b {
    ...
    private static final a f171210i = new a(null);

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC18089i owner;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final Function0<Unit> onAttach;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private final C18289c lock;

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    private final Map<String, C18086f.b> keyToProviders;
    ...
    public C18288b(InterfaceC18089i owner, Function0<Unit> onAttach) {
        Intrinsics.j(owner, "owner");
        Intrinsics.j(onAttach, "onAttach");
        this.owner = owner;
        this.onAttach = onAttach;
        this.lock = new C18289c();
        this.keyToProviders = new LinkedHashMap();
        this.isAllowingSavingState = true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void g(C18288b c18288b, InterfaceC6172s interfaceC6172s, AbstractC6165l.a event) {
        Intrinsics.j(interfaceC6172s, "<unused var>");
        Intrinsics.j(event, "event");
        if (event == AbstractC6165l.a.ON_START) {
            c18288b.isAllowingSavingState = true;
        } else if (event == AbstractC6165l.a.ON_STOP) {
            c18288b.isAllowingSavingState = false;
        }
    }
    ...
    public final Bundle c(String key) {
        ...
        Bundle bundleA = C18083c.a(bundle);
        Bundle bundleC = C18083c.b(bundleA, key) ? C18083c.c(bundleA, key) : null;
    ...
    public final C18086f.b d(String key) {
        C18086f.b bVar;
        Intrinsics.j(key, "key");
        synchronized (this.lock) {
            ...
            do {
                ...
                C18086f.b bVar2 = (C18086f.b) entry.getValue();
    ...
    public final void f() {
        if (this.owner.getLifecycle().getState() != AbstractC6165l.b.f55500b) {
        ...
        this.owner.getLifecycle().a(new InterfaceC6169p() { // from class: y4.a
            ...
            public final void onStateChanged(InterfaceC6172s interfaceC6172s, AbstractC6165l.a aVar) {
                C18288b.g(this.f171209a, interfaceC6172s, aVar);
            }
        });
        this.attached = true;
    }
    ...
    public final void h(Bundle savedState) {
        ...
        if (this.owner.getLifecycle().getState().b(AbstractC6165l.b.f55502d)) {
        ...
        Bundle bundleC = null;
        if (savedState != null) {
            Bundle bundleA = C18083c.a(savedState);
            if (C18083c.b(bundleA, "androidx.lifecycle.BundlableSavedStateRegistry.key")) {
                bundleC = C18083c.c(bundleA, "androidx.lifecycle.BundlableSavedStateRegistry.key");
            }
        }
    ...
    public final void i(Bundle outBundle) {
        ...
        synchronized (this.lock) {
            try {
                for (Map.Entry entry2 : this.keyToProviders.entrySet()) {
                    C18090j.c(bundleA, (String) entry2.getKey(), ((C18086f.b) entry2.getValue()).saveState());
                }
        ...
        if (C18083c.f(C18083c.a(bundleB))) {
            return;
        }
        C18090j.c(C18090j.a(outBundle), "androidx.lifecycle.BundlableSavedStateRegistry.key", bundleB);
    }

    public final void j(String key, C18086f.b provider) {
        Intrinsics.j(key, "key");
