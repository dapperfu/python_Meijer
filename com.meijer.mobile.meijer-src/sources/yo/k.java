...
public final class k implements Cs.b {
    ...
    private final InterfaceC16549B<MeijerUser> userStateFlow;
    ...
    public k(SharedPreferences sharedPreferences) {
        ...
        InterfaceC16549B<MeijerUser> interfaceC16549BA = S.a(D());
        this.userStateFlow = interfaceC16549BA;
        this.userFlow = C16563h.c(interfaceC16549BA);
        SharedPreferences.OnSharedPreferenceChangeListener onSharedPreferenceChangeListener = new SharedPreferences.OnSharedPreferenceChangeListener() { // from class: yo.j
            ...
            public final void onSharedPreferenceChanged(SharedPreferences sharedPreferences2, String str) {
                k.h0(this.f171600a, sharedPreferences2, str);
            }
        };
    ...
    public static final void h0(k kVar, SharedPreferences sharedPreferences, String str) {
        ...
        InterfaceC16549B<MeijerUser> interfaceC16549B = kVar.userStateFlow;
        while (!interfaceC16549B.e(interfaceC16549B.getValue(), kVar.D())) {
        }
    }
    ...
    public final l<MeijerUser> F() {
        l<MeijerUser> lVarDistinctUntilChanged = tv.h.d(this.userFlow, null, 1, null).distinctUntilChanged();
    ...
    public final void O() {
        MeijerUser value;
        InterfaceC16549B<MeijerUser> interfaceC16549B = this.userStateFlow;
        do {
            value = interfaceC16549B.getValue();
        } while (!interfaceC16549B.e(value, MeijerUser.b(value, null, null, null, null, null, false, null, false, true, l3.f93323c, null)));
    }
    ...
    public final boolean i0() {
        ...
        if (string != null && string.length() != 0) {
            ...
            LocalDateTime localDateTime = string2 != null ? (LocalDateTime) wk.d.b(string2, C17898a.f167225a.s(), new uh.j()) : null;
    ...
    public final LocalDateTime t(LocalDateTime now) {
        ...
        if (strN != null) {
            if (StringsKt.s0(strN)) {
                strN = null;
            }
            if (strN != null) {
                C17898a c17898a = C17898a.f167225a;
                localDateTime = (LocalDateTime) wk.d.c(strN, CollectionsKt.p(c17898a.z(), c17898a.y(), C17898a.SQL_LOCAL_DATE_TIME_LOW_PRECISION), new uh.j());
            }
        }
    ...
    public final List<String> v() {
        ...
        String str = (string == null || StringsKt.s0(string)) ? null : string;
        List<String> listB1 = str != null ? StringsKt.b1(str, new String[]{","}, false, 0, 6, null) : null;
        return listB1 == null ? CollectionsKt.m() : listB1;
    }
    ...
    public final LocalDateTime w(LocalDateTime startOfYear) {
        ...
        if (string != null) {
            ...
            if (string != null) {
                localDateTime2 = (LocalDateTime) wk.d.b(string, C17898a.ISO_LOCAL_DATE_TIME, new uh.j());
            }
        }
