...
public final class c {
    public static final AddItemRequest a(AddItemRequest addItemRequest, ShopAndScanTripEntity.TransactionHeader header, String localID) {
        ...
        return new AddItemRequest(addItemRequest.getIsPicklist() ? "PICK_LIST_ITEM_SELECTED" : "BARCODE_SCANNED", com.meijer.mobile.shopandscan.data.local.entity.b.c(header), new AddItemRequestEventData(addItemRequest.getBarcode().getData(), Pl.g.f26207b.getType(), addItemRequest.getQuantity(), localID));
    }
}
