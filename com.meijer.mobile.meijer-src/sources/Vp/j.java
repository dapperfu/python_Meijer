...
public final class j {
    public static final UpdateItemRequest a(UpdateItemRequest updateItemRequest, ShopAndScanTripEntity.TransactionHeader header, String remoteID) {
        ...
        return new UpdateItemRequest("UPDATE_QUANTITY", com.meijer.mobile.shopandscan.data.local.entity.b.c(header), new UpdateItemRequestEventData(Integer.parseInt(remoteID), updateItemRequest.getQuantity(), Pl.g.f26207b.getType()));
    }
}
