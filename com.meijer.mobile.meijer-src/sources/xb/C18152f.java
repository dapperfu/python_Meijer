...
public class C18152f extends AbstractC18151e {

    /* renamed from: e, reason: collision with root package name */
    private static final C13784a f170674e = C13785b.a(C18152f.class.getName());

    /* renamed from: f, reason: collision with root package name */
    private static final Type[] f170675f = {Object.class, Object.class};

    /* renamed from: d, reason: collision with root package name */
    private final Map<Method, Type[]> f170676d;
    ...
    private synchronized Type[] n(Method method) throws JsonReadException {
        ...
        try {
            actualTypeArguments = this.f170676d.get(method);
            if (actualTypeArguments == null) {
                ...
                this.f170676d.put(method, actualTypeArguments);
            }
    ...
    public C18152f(boolean z10) {
        super(z10);
        this.f170676d = new HashMap();
    }
    ...
    private <X> X g(Class<X> cls, Object obj) throws JSONException, JsonReadException, NoSuchMethodException, SecurityException {
        ...
        if (obj instanceof JSONObject) {
            if (Map.class.isAssignableFrom(cls)) {
                return (X) i(cls, f170675f, (JSONObject) obj);
            }
            if (cls == Object.class) {
                return (X) i(HashMap.class, f170675f, (JSONObject) obj);
            }
            return (X) j(q(cls), (JSONObject) obj);
        }
        if (obj instanceof JSONArray) {
            if (Set.class.isAssignableFrom(cls)) {
                return (X) h(cls, f170675f, (JSONArray) obj);
            }
            if (List.class.isAssignableFrom(cls)) {
                return (X) p(cls, f170675f, (JSONArray) obj);
            }
            if (cls == Object.class) {
                return (X) p(ArrayList.class, f170675f, (JSONArray) obj);
            }
            if (cls.isArray()) {
    ...
    */
    private <X> X j(X r11, org.json.JSONObject r12) throws org.json.JSONException, java.lang.IllegalAccessException, com.gimbal.internal.json.JsonReadException, java.lang.NoSuchMethodException, java.lang.SecurityException, java.lang.IllegalArgumentException, java.lang.reflect.InvocationTargetException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: xb.C18152f.j(java.lang.Object, org.json.JSONObject):java.lang.Object");
    }
