...
public final class b {
    ...
    static final class a implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ LocalThemeScope f13149b;

        a(boolean z10, LocalThemeScope localThemeScope) {
            this.f13148a = z10;
            this.f13149b = localThemeScope;
        }
        ...
        public final void a(Composer composer, int i10) {
            ...
            C18054z0.a(C16335d.c((this.f13148a ? C.j.c.f17120d : C.j.C3930d.f17121d).getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String(), composer, 0), C16338g.c(this.f13148a ? Q.f171788v : Q.f171787u, composer, 0), null, this.f13149b.getAdsColors().getAdsColorEnabled01().getColor(), composer, 0, 4);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final void b(final LocalThemeScope localThemeScope, final boolean z10, final Function1<? super Boolean, Unit> onCheckedChange, Modifier modifier, Composer composer, final int i10, final int i11) {
        ...
        if ((i12 & 1171) == 1170 && composerStartRestartGroup.j()) {
            ...
            modifier2 = modifier3;
            C18052y0.b(z10, onCheckedChange, modifier2, false, null, ComposableLambdaKt.c(719190300, true, new a(z10, localThemeScope), composerStartRestartGroup, 54), composerStartRestartGroup, i15, 24);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
