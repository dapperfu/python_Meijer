...
@Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u000b\u0018\u0000 \u00112\u00020\u0001:\u0001\bB\u0017\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0004\u001a\u00020\u0002¢\u0006\u0004\b\u0005\u0010\u0006R\u0014\u0010\n\u001a\u00020\u00078\u0006X\u0087\u0004¢\u0006\u0006\n\u0004\b\b\u0010\tR\u0014\u0010\f\u001a\u00020\u00078\u0006X\u0087\u0004¢\u0006\u0006\n\u0004\b\u000b\u0010\tR\u0014\u0010\u000e\u001a\u00020\u00078\u0006X\u0087\u0004¢\u0006\u0006\n\u0004\b\r\u0010\tR\u0014\u0010\u0010\u001a\u00020\u00078\u0006X\u0087\u0004¢\u0006\u0006\n\u0004\b\u000f\u0010\t¨\u0006\u0012"}, d2 = {"Lrf/i;", "", "Ljava/util/concurrent/ExecutorService;", "backgroundExecutorService", "blockingExecutorService", "<init>", "(Ljava/util/concurrent/ExecutorService;Ljava/util/concurrent/ExecutorService;)V", "Lrf/e;", "a", "Lrf/e;", "common", "b", "diskWrite", "c", "dataCollect", "d", "network", "e", "com.google.firebase-firebase-crashlytics"}, k = 1, mv = {2, 0, 0}, xi = 48)
...
public final class i {
    ...
    private static boolean f159540f;
    ...
    public static final class Companion {
        ...
        /* synthetic */ class C2483a extends FunctionReferenceImpl implements Function0<Boolean> {
            C2483a(Object obj) {
        ...
        @JvmStatic
        public final void g() {
            m(new C2483a(this), new Function0() { // from class: rf.f
                @Override // kotlin.jvm.functions.Function0
        ...
        @JvmStatic
        public final void i() {
            m(new b(this), new Function0() { // from class: rf.h
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
        ...
        @JvmStatic
        public final void k() {
            m(new c(this), new Function0() { // from class: rf.g
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
        ...
        private final void m(Function0<Boolean> isCorrectThread, Function0<String> failureMessage) {
            if (!isCorrectThread.invoke().booleanValue()) {
                nf.g.f().b(failureMessage.invoke());
                n();
            }
        }
        ...
        public final boolean p() {
            ...
            return StringsKt.d0(strO, "Firebase Background Thread #", false, 2, null);
        }
        ...
        public final boolean q() {
            String strO = o();
            Intrinsics.i(strO, "<get-threadName>(...)");
            return StringsKt.d0(strO, "Firebase Blocking Thread #", false, 2, null);
        }
