...
public final class X {
    public static JSONObject c(String str, Context context, Point point, Point point2) throws JSONException {
        ...
        try {
            ...
            try {
                jSONObject3.put("x", C4447y.b().e(context, point2.x));
                jSONObject3.put("y", C4447y.b().e(context, point2.y));
                jSONObject3.put("start_x", C4447y.b().e(context, point.x));
                jSONObject3.put("start_y", C4447y.b().e(context, point.y));
                jSONObject2 = jSONObject3;
            } catch (JSONException e11) {
                Sc.p.e("Error occurred while putting signals into JSON object.", e11);
            }
            ...
            Sc.p.e("Error occurred while grabbing click signals.", e);
            return jSONObject2;
        }
    }
            ...
            while (it2.hasNext()) {
                ...
                if (view2 != null) {
                    ...
                    try {
                        it = it2;
                        try {
                            jSONObject4.put("width", C4447y.b().e(context, view2.getMeasuredWidth()));
                            jSONObject4.put("height", C4447y.b().e(context, view2.getMeasuredHeight()));
                            jSONObject4.put("x", C4447y.b().e(context, iArrJ2[0] - iArr[0]));
                            jSONObject4.put("y", C4447y.b().e(context, iArrJ2[1] - iArr[1]));
                            ...
                            if (view2.getLocalVisibleRect(rect)) {
                                ...
                                jSONObject.put("x", C4447y.b().e(context, iArrJ2[0] - iArr[0]));
                                jSONObject.put("y", C4447y.b().e(context, iArrJ2[1] - iArr[1]));
                                jSONObject.put(str4, str3);
                            }
                            jSONObject3.put("visible_bounds", jSONObject);
                            if (((String) entry.getKey()).equals("3010")) {
                                if (((Boolean) Oc.A.c().a(C8784lf.f76930O7)).booleanValue()) {
                                    jSONObject3.put("mediaview_graphics_matrix", view2.getMatrix().toShortString());
                                }
                                if (((Boolean) Oc.A.c().a(C8784lf.f76944P7)).booleanValue()) {
                                ...
                                if (((Boolean) Oc.A.c().a(C8784lf.f76958Q7)).booleanValue()) {
                                    ArrayList arrayList = new ArrayList();
                                    arrayList.add(Integer.valueOf(view2.getId()));
                                    for (ViewParent parent = view2.getParent(); parent instanceof View; parent = parent.getParent()) {
                                        arrayList.add(Integer.valueOf(((View) parent).getId()));
                                    }
                                    jSONObject3.put("view_path", TextUtils.join(q2.f93563c, arrayList));
                                }
                                if (scaleType != null) {
                            ...
                            if (view2 instanceof TextView) {
                                ...
                                try {
                                    ...
                                    Sc.p.g("Unable to get asset views information");
                                    it2 = it;
                                    iArrJ = iArr;
                                    str3 = str;
                                    str4 = str2;
    ...
    public static WindowManager.LayoutParams b() {
        ...
        layoutParams.flags = ((Integer) Oc.A.c().a(C8784lf.f77014U7)).intValue();
        layoutParams.type = 2;
    ...
    public static JSONObject e(Context context, View view) {
        ...
        if (view != null) {
            try {
                ...
                Sc.p.g("Unable to get lock screen information");
            }
        }
        return jSONObject;
    }
    ...
    public static JSONObject f(View view) {
        ...
        if (view != null) {
            try {
                if (((Boolean) Oc.A.c().a(C8784lf.f76916N7)).booleanValue()) {
                    Nc.v.t();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:55:0x016b, code lost:
        ...
        Sc.p.e("Could not log native template signal to JSON", r0);
     */
    ...
    */
    public static org.json.JSONObject g(android.content.Context r17, android.view.View r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: Rc.X.g(android.content.Context, android.view.View):org.json.JSONObject");
    }
    ...
    public static boolean h(Context context, Z50 z50) {
        ...
        if (((Boolean) Oc.A.c().a(C8784lf.f76972R7)).booleanValue()) {
            return ((Boolean) Oc.A.c().a(C8784lf.f77028V7)).booleanValue();
        }
        String str = (String) Oc.A.c().a(C8784lf.f76986S7);
        if (!str.isEmpty() && context != null) {
            String packageName = context.getPackageName();
            Iterator it = C7325Tf0.b(AbstractC9106of0.b(';')).d(str).iterator();
            while (it.hasNext()) {
    ...
    public static boolean i(int i10) {
        if (((Boolean) Oc.A.c().a(C8784lf.f76744B3)).booleanValue()) {
            return ((Boolean) Oc.A.c().a(C8784lf.f76758C3)).booleanValue() || i10 <= 15299999;
        }
        return true;
    }
    ...
    private static JSONObject k(Context context, Rect rect) throws JSONException {
        JSONObject jSONObject = new JSONObject();
        jSONObject.put("width", C4447y.b().e(context, rect.right - rect.left));
        jSONObject.put("height", C4447y.b().e(context, rect.bottom - rect.top));
        jSONObject.put("x", C4447y.b().e(context, rect.left));
        jSONObject.put("y", C4447y.b().e(context, rect.top));
