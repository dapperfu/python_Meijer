...
import com.google.android.gms.internal.ads.C7355Ud0;
...
public final class C5185e {
    public static void c(Context context) throws IOException {
        if (((Boolean) Oc.A.c().a(C8784lf.f77110b6)).booleanValue() && context != null) {
            context.deleteDatabase("OfflineUpload.db");
        }
        try {
            C7287Sd0 c7287Sd0K = C7287Sd0.k(context);
            C7321Td0 c7321Td0J = C7321Td0.j(context);
            C7355Ud0 c7355Ud0A = C7355Ud0.a(context);
            c7287Sd0K.l();
            c7287Sd0K.m();
            c7321Td0J.k();
            c7355Ud0A.b(null);
        } catch (IOException e10) {
            Nc.v.s().x(e10, "clearStorageOnIdlessMode");
        }
        try {
            ...
            Nc.v.s().x(e11, "clearStorageOnIdlessMode_scar");
        }
    }
    ...
    public static Bundle b(Context context, String str) {
        ...
        for (int i11 = 0; i11 < jSONArray.length(); i11++) {
            ...
            if (!TextUtils.isEmpty(strOptString) && !TextUtils.isEmpty(strOptString2) && i10 != 0) {
                List listF = C7325Tf0.b(AbstractC9106of0.b('/')).f(strOptString2);
