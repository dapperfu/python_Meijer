...
public final class C5202m0 {

    /* renamed from: b, reason: collision with root package name */
    private static List f32375b;

    /* renamed from: a, reason: collision with root package name */
    private static final Map f32374a = new HashMap();

    /* renamed from: c, reason: collision with root package name */
    private static final Object f32376c = new Object();
        ...
        synchronized (obj) {
            ...
            try {
                synchronized (obj) {
                    try {
                        if (f32375b == null) {
                            f32375b = Arrays.asList(new MediaCodecList(0).getCodecInfos());
                        }
                        arrayList = new ArrayList();
                        for (MediaCodecInfo mediaCodecInfo : f32375b) {
