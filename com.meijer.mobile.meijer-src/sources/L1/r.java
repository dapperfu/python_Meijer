...
final class r implements q, N0 {
    ...
    static final class a extends Lambda implements Function0<Unit> {
        ...
        final /* synthetic */ List<I> f17929f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ B f17930g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ r f17931h;
        ...
        public final void invoke2() {
            ...
            while (true) {
                ...
                if (mVar != null) {
                    C4010g c4010g = new C4010g(mVar.getRef().getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String());
                    mVar.a().invoke(c4010g);
                    c4010g.a(b10);
                }
    ...
    public void c(B state, List<? extends I> measurables) {
        ...
        this.observer.p(Unit.f143329a, this.onCommitAffectingConstrainLambdas, new a(measurables, state, this));
