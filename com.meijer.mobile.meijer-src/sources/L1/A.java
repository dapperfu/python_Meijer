...
public class A implements b.InterfaceC0733b, u {
    ...
    static final class b extends Lambda implements Function1<androidx.compose.ui.graphics.e, Unit> {
        ...
        public final void a(androidx.compose.ui.graphics.e eVar) {
            ...
            if (!Float.isNaN(this.f17785f.f23070f) || !Float.isNaN(this.f17785f.f23071g)) {
                eVar.F0(L1.a(Float.isNaN(this.f17785f.f23070f) ? 0.5f : this.f17785f.f23070f, Float.isNaN(this.f17785f.f23071g) ? 0.5f : this.f17785f.f23071g));
            }
            if (!Float.isNaN(this.f17785f.f23072h)) {
                eVar.j(this.f17785f.f23072h);
            }
            if (!Float.isNaN(this.f17785f.f23073i)) {
                eVar.k(this.f17785f.f23073i);
            }
            if (!Float.isNaN(this.f17785f.f23074j)) {
                eVar.l(this.f17785f.f23074j);
            }
            if (!Float.isNaN(this.f17785f.f23075k)) {
                eVar.n(this.f17785f.f23075k);
            }
            if (!Float.isNaN(this.f17785f.f23076l)) {
                eVar.e(this.f17785f.f23076l);
            }
            if (!Float.isNaN(this.f17785f.f23077m)) {
                eVar.H(this.f17785f.f23077m);
            }
            if (!Float.isNaN(this.f17785f.f23078n) || !Float.isNaN(this.f17785f.f23079o)) {
                eVar.h(Float.isNaN(this.f17785f.f23078n) ? 1.0f : this.f17785f.f23078n);
                eVar.m(Float.isNaN(this.f17785f.f23079o) ? 1.0f : this.f17785f.f23079o);
            }
            if (Float.isNaN(this.f17785f.f23080p)) {
                return;
            }
            eVar.d(this.f17785f.f23080p);
        }
    ...
    public final long l(long constraints, H1.t layoutDirection, q constraintSet, List<? extends I> measurables, int optimizationLevel, K measureScope) {
        ...
        if (l.f17902a) {
            ...
            for (Q1.e eVar : arrayListY0) {
                ...
                Object objA = i10 == null ? null : C5937w.a(i10);
                String str = "NOTAG";
        ...
        while (it2.hasNext()) {
            ...
            if (objN2 instanceof I) {
                ...
                if (l.f17902a) {
                    FS.log_d("CCL", "Final measurement for " + C5937w.a((I) objN2) + " to confirm size " + next.M() + ' ' + next.s());
                }
    ...
    private final void e(Integer[] numArr, b.a aVar) {
        numArr[0] = Integer.valueOf(aVar.f31565e);
        numArr[1] = Integer.valueOf(aVar.f31566f);
        numArr[2] = Integer.valueOf(aVar.f31567g);
    }
    ...
    private final boolean j(e.b dimensionBehaviour, int dimension, int matchConstraintDefaultDimension, int measureStrategy, boolean otherDimensionResolved, boolean currentDimensionResolved, int rootMaxConstraint, int[] outConstraints) {
        ...
        boolean z10 = currentDimensionResolved || ((measureStrategy == b.a.f31559l || measureStrategy == b.a.f31560m) && (measureStrategy == b.a.f31560m || matchConstraintDefaultDimension != 1 || otherDimensionResolved));
        if (l.f17902a) {
    ...
    */
    ...
    public void d() {
        ...
        while (it.hasNext()) {
            ...
            if (objN instanceof I) {
                O1.f fVar = null;
                if (next.f27620o == null) {
                    I i10 = (I) objN;
                    Object objA = C5937w.a(i10);
                    if (objA == null) {
                        objA = o.a(i10);
                    }
                    next.f27620o = objA == null ? null : objA.toString();
                }
                O1.f fVar2 = this.frameCache.get(objN);
                if (fVar2 != null && (eVar = fVar2.f23065a) != null) {
                    fVar = eVar.f27618n;
                }
                if (fVar != null) {
                    sb2.append(' ' + ((Object) next.f27620o) + ": {");
    ...
    public final void k(f0.a aVar, List<? extends I> measurables) {
        ...
        if (this.frameCache.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                Object objN = next.n();
                if (objN instanceof I) {
                    this.frameCache.put(objN, new O1.f(next.f27618n.h()));
                }
            }
        }
        ...
        if (size >= 0) {
            ...
            while (true) {
                ...
                if (fVar.c()) {
                    ...
                    Intrinsics.g(fVar2);
                    int i13 = fVar2.f23066b;
                    O1.f fVar3 = g().get(i12);
                    Intrinsics.g(fVar3);
                    int i14 = fVar3.f23067c;
                    f0 f0Var = h().get(i12);
                    if (f0Var != null) {
                    ...
                    Intrinsics.g(fVar4);
                    int i15 = fVar4.f23066b;
                    O1.f fVar5 = g().get(i12);
                    Intrinsics.g(fVar5);
                    int i16 = fVar5.f23067c;
                    float f10 = Float.isNaN(fVar.f23077m) ? 0.0f : fVar.f23077m;
                    f0 f0Var2 = h().get(i12);
                    if (f0Var2 != null) {
    ...
    public A() {
        ...
        this.state = LazyKt.a(LazyThreadSafetyMode.f143288c, new c());
