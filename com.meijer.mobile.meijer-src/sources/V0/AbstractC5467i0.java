...
public abstract class AbstractC5467i0 {
    ...
    public static final class Companion {
        ...
        public final AbstractC5467i0 e(List<C5489q0> colors, float startY, float endY, int tileMode) {
        ...
        public static /* synthetic */ AbstractC5467i0 b(Companion companion, List list, long j10, long j11, int i10, int i11, Object obj) {
            if ((i11 & 2) != 0) {
                j10 = U0.f.INSTANCE.c();
            }
            long j12 = j10;
        ...
        public static /* synthetic */ AbstractC5467i0 d(Companion companion, List list, long j10, int i10, Object obj) {
            if ((i10 & 2) != 0) {
                j10 = U0.f.INSTANCE.b();
            }
        ...
        public static /* synthetic */ AbstractC5467i0 f(Companion companion, List list, float f10, float f11, int i10, int i11, Object obj) {
            if ((i11 & 2) != 0) {
                f10 = 0.0f;
            }
            if ((i11 & 4) != 0) {
        ...
        public final AbstractC5467i0 a(List<C5489q0> colors, long start, long end, int tileMode) {
            return new C5471j1(colors, null, start, end, tileMode, null);
        }

        public final AbstractC5467i0 c(List<C5489q0> colors, long center) {
            return new H1(center, colors, null, null);
        }
    }

    public /* synthetic */ AbstractC5467i0(DefaultConstructorMarker defaultConstructorMarker) {
        this();
    }

    public abstract void a(long size, o1 p10, float alpha);

    private AbstractC5467i0() {
