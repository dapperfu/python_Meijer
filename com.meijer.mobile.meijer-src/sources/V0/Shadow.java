...
public final class Shadow {
    ...
    private static final Shadow f39252e = new Shadow(0, 0, 0.0f, 7, null);
    ...
    public boolean equals(Object other) {
        ...
        return C5489q0.s(this.color, shadow.color) && U0.f.j(this.offset, shadow.offset) && this.blurRadius == shadow.blurRadius;
    }
    ...
    public int hashCode() {
        return (((C5489q0.y(this.color) * 31) + U0.f.o(this.offset)) * 31) + Float.hashCode(this.blurRadius);
    }

    public String toString() {
        return "Shadow(color=" + ((Object) C5489q0.z(this.color)) + ", offset=" + ((Object) U0.f.s(this.offset)) + ", blurRadius=" + this.blurRadius + ')';
    }

    public /* synthetic */ Shadow(long j10, long j11, float f10, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this((i10 & 1) != 0 ? C5492s0.d(4278190080L) : j10, (i10 & 2) != 0 ? U0.f.INSTANCE.c() : j11, (i10 & 4) != 0 ? 0.0f : f10, null);
    }
}
