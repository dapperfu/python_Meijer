...
public final class C5496u0 extends C5490r0 {

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private float[] colorMatrix;

    public /* synthetic */ C5496u0(float[] fArr, ColorFilter colorFilter, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof C5496u0) && Arrays.equals(b(), ((C5496u0) other).b());
    }

    public /* synthetic */ C5496u0(float[] fArr, DefaultConstructorMarker defaultConstructorMarker) {
        this(fArr);
    }
    ...
    public String toString() {
        ...
        float[] fArr = this.colorMatrix;
        sb2.append((Object) (fArr == null ? BuildConfig.TRAVIS : C5494t0.e(fArr)));
        sb2.append(')');
        return sb2.toString();
    }

    private C5496u0(float[] fArr, ColorFilter colorFilter) {
        super(colorFilter);
        this.colorMatrix = fArr;
    }

    private C5496u0(float[] fArr) {
