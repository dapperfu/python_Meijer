...
public final class P {
    ...
    public static final void l(Paint paint, int i10) {
        if (Build.VERSION.SDK_INT >= 29) {
            N1.f39282a.a(paint, i10);
        } else {
            paint.setXfermode(new PorterDuffXfermode(D.b(i10)));
        }
    }

    public static final void n(Paint paint, C5490r0 c5490r0) {
        paint.setColorFilter(c5490r0 != null ? E.d(c5490r0) : null);
    }

    public static final void o(Paint paint, int i10) {
        paint.setFilterBitmap(!C5447b1.d(i10, C5447b1.INSTANCE.b()));
    }
    ...
    public static final long d(Paint paint) {
        return C5492s0.b(paint.getColor());
    }

    public static final int e(Paint paint) {
        if (!paint.isFilterBitmap()) {
            return C5447b1.INSTANCE.b();
        }
        return C5447b1.INSTANCE.a();
    }
