...
public final class C5443a0 {

    /* renamed from: a, reason: collision with root package name */
    public static final C5443a0 f39297a = new C5443a0();

    private C5443a0() {
    }

    @JvmStatic
    public static final Bitmap a(int width, int height, int bitmapConfig, boolean hasAlpha, AbstractC5526c colorSpace) {
