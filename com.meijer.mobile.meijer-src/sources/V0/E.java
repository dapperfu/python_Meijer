...
public final class E {
    ...
    public static final float[] b(ColorFilter colorFilter) {
        if ((colorFilter instanceof ColorMatrixColorFilter) && e()) {
            return C5500w0.f39410a.a((ColorMatrixColorFilter) colorFilter);
        }
        throw new IllegalArgumentException("Unable to obtain ColorMatrix from Android ColorMatrixColorFilter. This method was invoked on an unsupported Android version");
    }

    public static final ColorFilter c(long j10, int i10) {
        return Build.VERSION.SDK_INT >= 29 ? C5461g0.f39340a.a(j10, i10) : new PorterDuffColorFilter(C5492s0.j(j10), D.b(i10));
    }
    ...
    public static final ColorFilter d(C5490r0 c5490r0) {
        return c5490r0.getNativeColorFilter();
    }
}
