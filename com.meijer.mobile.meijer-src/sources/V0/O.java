...
public final class O implements o1 {
    ...
    private C5490r0 internalColorFilter;
    ...
    public O(Paint paint) {
        ...
        this._blendMode = C5449c0.INSTANCE.B();
    }
    ...
    public C5490r0 getInternalColorFilter() {
    ...
    public void s(int i10) {
        if (C5449c0.E(this._blendMode, i10)) {
            return;
        }
        this._blendMode = i10;
    ...
    @Override // V0.o1
    public void z(C5490r0 c5490r0) {
        this.internalColorFilter = c5490r0;
        P.n(this.internalPaint, c5490r0);
    }
