...
public final class BlendModeColorFilter extends C5490r0 {
    ...
    public boolean equals(Object other) {
        ...
        return C5489q0.s(this.color, blendModeColorFilter.color) && C5449c0.E(this.blendMode, blendModeColorFilter.blendMode);
    }
    ...
    public int hashCode() {
        return (C5489q0.y(this.color) * 31) + C5449c0.F(this.blendMode);
    }

    public String toString() {
        return "BlendModeColorFilter(color=" + ((Object) C5489q0.z(this.color)) + ", blendMode=" + ((Object) C5449c0.G(this.blendMode)) + ')';
    }
