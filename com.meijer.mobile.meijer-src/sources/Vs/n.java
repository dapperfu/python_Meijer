...
public final class n implements h {
    ...
    public static final class Companion {
        ...
        public final SharedPreferences a(Context applicationContext, KeyGenParameterSpec keyGenParameterSpec) throws GeneralSecurityException, IOException {
            ...
            String strC = z4.e.c(keyGenParameterSpec);
            Intrinsics.i(strC, "getOrCreate(...)");
            SharedPreferences sharedPreferencesB = SharedPreferencesC18442a.b("com.okta.authfoundation.storage", strC, applicationContext, SharedPreferencesC18442a.c.AES256_SIV, SharedPreferencesC18442a.d.AES256_GCM);
    ...
    static final class b extends SuspendLambda implements Function2<InterfaceC15783O, Continuation<? super Boolean>, Object> {

        /* renamed from: a, reason: collision with root package name */
        int f40397a;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Function1<List<h.a>, List<h.a>> f40399c;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        b(Function1<? super List<h.a>, ? extends List<h.a>> function1, Continuation<? super b> continuation) {
            super(2, continuation);
            this.f40399c = function1;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return n.this.new b(this.f40399c, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f40397a == 0) {
                ...
                n nVar = n.this;
                Function1<List<h.a>, List<h.a>> function1 = this.f40399c;
                synchronized (obj2) {
                    try {
                        ...
                        AbstractC3260b abstractC3260b = nVar.json;
                        o.Companion companion = o.INSTANCE;
                        String strC = abstractC3260b.c(companion.serializer(), companion.a(listInvoke));
    ...
    static final class c extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f40401b = obj;
            this.f40403d |= Integer.MIN_VALUE;
            return n.this.a(this);
        }
    }

    public n(AbstractC3260b json, CoroutineContext dispatcher, final C6295b eventCoordinator, Context context, final KeyGenParameterSpec keyGenParameterSpec) {
        ...
        this.sharedPreferences = LazyKt.b(new Function0() { // from class: Vs.m
            ...
            public final Object invoke() {
                return n.j(this.f40388a, keyGenParameterSpec, eventCoordinator);
            }
        });
    }

    private final Object g(Function1<? super List<h.a>, ? extends List<h.a>> function1, Continuation<? super Unit> continuation) {
        Object objG = C15805i.g(this.dispatcher, new b(function1, null), continuation);
    ...
    public static final List h(Ref.ObjectRef objectRef, List existingEntries) {
        ...
        objectRef.f143742a = existingEntries;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final SharedPreferences j(n nVar, KeyGenParameterSpec keyGenParameterSpec, C6295b c6295b) throws Exception {
        try {
    ...
    */
    public java.lang.Object a(kotlin.coroutines.Continuation<? super java.util.List<Vs.h.a>> r5) {
        ...
        L13:
            ...
            r0.<init>(r5)
        L18:
            java.lang.Object r5 = r0.f40401b
            java.lang.Object r1 = kotlin.coroutines.intrinsics.IntrinsicsKt.f()
            int r2 = r0.f40403d
            r3 = 1
            if (r2 == 0) goto L35
            if (r2 != r3) goto L2d
            java.lang.Object r0 = r0.f40400a
