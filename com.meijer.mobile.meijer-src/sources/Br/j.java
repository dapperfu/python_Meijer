...
public final class j {
    ...
    private final InterfaceC5872l0<Boolean> isSwiping = t1.e(Boolean.FALSE, null, 2, null);

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5868j0 firstVisibleItemIndex = C5844c1.a(0);

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5868j0 offsetInfo = C5844c1.a(0);

    public final Object d(C15429A c15429a, int i10, Continuation<? super Unit> continuation) {
        Object objL = C15429A.l(c15429a, i10, 0, continuation, 2, null);
        return objL == IntrinsicsKt.f() ? objL : Unit.f143329a;
    }

    /* renamed from: a, reason: from getter */
    public final InterfaceC5868j0 getFirstVisibleItemIndex() {
        return this.firstVisibleItemIndex;
    }

    /* renamed from: b, reason: from getter */
    public final InterfaceC5868j0 getOffsetInfo() {
    ...
    public final void e(InterfaceC15439i itemPos) {
        if (itemPos != null) {
            this.offsetInfo.i(itemPos.getOffset());
            this.firstVisibleItemIndex.i(itemPos.getIndex());
        }
    }
}
