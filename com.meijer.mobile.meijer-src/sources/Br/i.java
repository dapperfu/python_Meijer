...
public final class i implements InterfaceC13938a {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final j state;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final C15429A listState;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private final Function0<Unit> scrollTo;

    public i(j state, C15429A listState, Function0<Unit> scrollTo) {
    ...
    public long E1(long available, int source) {
        return C13942e.f(source, C13942e.INSTANCE.a()) ? a() : U0.f.INSTANCE.c();
    }
    ...
    public Object b0(long j10, long j11, Continuation<? super y> continuation) {
        ...
        if (this.state.c().getValue().booleanValue()) {
            this.state.e((InterfaceC15439i) CollectionsKt.u0(this.listState.x().h()));
