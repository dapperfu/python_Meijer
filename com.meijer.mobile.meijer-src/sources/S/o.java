...
public class o extends androidx.camera.core.impl.m {
    ...
    private int m(androidx.camera.core.impl.i iVar) {
        Integer num = (Integer) iVar.g().h(androidx.camera.core.impl.i.f47625j, 100);
        Objects.requireNonNull(num);
        return num.intValue();
    }

    private int n(androidx.camera.core.impl.i iVar) {
        Integer num = (Integer) iVar.g().h(androidx.camera.core.impl.i.f47624i, 0);
        Objects.requireNonNull(num);
        return num.intValue();
    }
    ...
    public q<List<Void>> b(final List<androidx.camera.core.impl.i> list, int i10, int i11) {
        ...
        return I.n.k(Collections.singletonList(I.d.a(qVarH).e(new I.a() { // from class: S.l
            ...
            public final q apply(Object obj) {
                o oVar = this.f34283a;
                List list2 = list;
                return oVar.f34286c.a(oVar.m((androidx.camera.core.impl.i) list2.get(0)), oVar.n((androidx.camera.core.impl.i) list2.get(0)));
            }
        }, H.a.a()).e(new I.a() { // from class: S.n
            @Override // I.a
            public final q apply(Object obj) {
                return ((InterfaceC3170j) qVarH.get()).b();
            }
        }, H.a.a())));
    }
}
