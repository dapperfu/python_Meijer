...
public final class C {
    ...
    private static final String f41539a;

    static {
        String strI = AbstractC4373v.i("ProcessUtils");
    ...
    private static final String a(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            return C5552a.f41583a.a();
        }
        try {
            Method declaredMethod = Class.forName("android.app.ActivityThread", false, O4.O.class.getClassLoader()).getDeclaredMethod("currentProcessName", null);
            ...
            AbstractC4373v.e().b(f41539a, "Unable to check ActivityThread for processName", th2);
        }
