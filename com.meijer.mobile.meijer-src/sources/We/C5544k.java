...
public final class C5544k extends AbstractC11452x<C5544k, b> implements S {
    private static final C5544k DEFAULT_INSTANCE;
    public static final int IV_SIZE_FIELD_NUMBER = 1;
    private static volatile Z<C5544k> PARSER;
    private int ivSize_;

    /* renamed from: We.k$b */
    public static final class b extends AbstractC11452x.a<C5544k, b> implements S {
        /* synthetic */ b(a aVar) {
            this();
        }

        private b() {
            super(C5544k.DEFAULT_INSTANCE);
        }
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f40979a[AbstractC11452x.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f40979a[AbstractC11452x.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f40979a[AbstractC11452x.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f40979a[AbstractC11452x.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f40979a[AbstractC11452x.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f40979a[AbstractC11452x.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    static {
        C5544k c5544k = new C5544k();
        DEFAULT_INSTANCE = c5544k;
        AbstractC11452x.U(C5544k.class, c5544k);
    }

    public static C5544k Z() {
