...
public final class C5535b extends AbstractC11452x<C5535b, C0883b> implements S {
    private static final C5535b DEFAULT_INSTANCE;
    public static final int KEY_SIZE_FIELD_NUMBER = 1;
    public static final int PARAMS_FIELD_NUMBER = 2;
    private static volatile Z<C5535b> PARSER;
    private int bitField0_;
    private int keySize_;
    private C5536c params_;

    /* renamed from: We.b$b, reason: collision with other inner class name */
    public static final class C0883b extends AbstractC11452x.a<C5535b, C0883b> implements S {
        /* synthetic */ C0883b(a aVar) {
            this();
        }

        private C0883b() {
            super(C5535b.DEFAULT_INSTANCE);
        }
        ...
        public C0883b x(int i10) {
            p();
            ((C5535b) this.f89411b).e0(i10);
            return this;
        }

        public C0883b y(C5536c c5536c) {
            p();
            ((C5535b) this.f89411b).f0(c5536c);
            return this;
        }
    }
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f40970a[AbstractC11452x.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f40970a[AbstractC11452x.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f40970a[AbstractC11452x.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f40970a[AbstractC11452x.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f40970a[AbstractC11452x.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f40970a[AbstractC11452x.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    static {
        ...
        DEFAULT_INSTANCE = c5535b;
        AbstractC11452x.U(C5535b.class, c5535b);
    }

    public static C0883b c0() {
        return DEFAULT_INSTANCE.v();
    }

    public static C5535b d0(AbstractC11437h abstractC11437h, C11444o c11444o) throws InvalidProtocolBufferException {
        return (C5535b) AbstractC11452x.O(DEFAULT_INSTANCE, abstractC11437h, c11444o);
    }
    ...
    protected final Object z(AbstractC11452x.f fVar, Object obj, Object obj2) {
        Z bVar;
        a aVar = null;
        switch (a.f40970a[fVar.ordinal()]) {
            case 1:
                return new C5535b();
            case 2:
                return new C0883b(aVar);
            case 3:
                return AbstractC11452x.M(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0001\u0001\u0002\u0002\u0000\u0000\u0000\u0001\u000b\u0002ဉ\u0000", new Object[]{"bitField0_", "keySize_", "params_"});
            case 4:
