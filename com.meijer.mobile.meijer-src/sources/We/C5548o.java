...
public final class C5548o extends AbstractC11452x<C5548o, b> implements S {
    private static final C5548o DEFAULT_INSTANCE;
    public static final int KEY_SIZE_FIELD_NUMBER = 2;
    private static volatile Z<C5548o> PARSER = null;
    public static final int VERSION_FIELD_NUMBER = 1;
    private int keySize_;
    private int version_;

    /* renamed from: We.o$b */
    public static final class b extends AbstractC11452x.a<C5548o, b> implements S {
        /* synthetic */ b(a aVar) {
            this();
        }

        private b() {
            super(C5548o.DEFAULT_INSTANCE);
        }
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f40983a[AbstractC11452x.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f40983a[AbstractC11452x.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f40983a[AbstractC11452x.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f40983a[AbstractC11452x.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f40983a[AbstractC11452x.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f40983a[AbstractC11452x.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    static {
        C5548o c5548o = new C5548o();
        DEFAULT_INSTANCE = c5548o;
        AbstractC11452x.U(C5548o.class, c5548o);
    }
    ...
    public static C5548o c0(AbstractC11437h abstractC11437h, C11444o c11444o) throws InvalidProtocolBufferException {
        return (C5548o) AbstractC11452x.O(DEFAULT_INSTANCE, abstractC11437h, c11444o);
    }
    ...
    protected final Object z(AbstractC11452x.f fVar, Object obj, Object obj2) {
        Z bVar;
        a aVar = null;
        switch (a.f40983a[fVar.ordinal()]) {
            case 1:
                return new C5548o();
            case 2:
                return new b(aVar);
            case 3:
                return AbstractC11452x.M(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001\u000b\u0002\u000b", new Object[]{"version_", "keySize_"});
            case 4:
