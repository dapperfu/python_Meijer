...
public class e extends AbstractC13637b<c> {
    public e(d9.c cVar, l9.b bVar) {
    ...
    public ContentValues c(c cVar) {
        ...
        contentValues.put("headers", L9.a.b(cVar.a()));
        contentValues.put("payload", L9.a.b(cVar.d()));
    ...
    public c d(Cursor cursor) {
        ...
        EnumC18191b enumC18191bValueOf = EnumC18191b.valueOf(cursor.getString(cursor.getColumnIndexOrThrow("method")));
        String string2 = cursor.getString(cursor.getColumnIndexOrThrow("url"));
        try {
            map = (Map) L9.a.a(cursor.getBlob(cursor.getColumnIndexOrThrow("headers")));
        } catch (SerializationException | ClassCastException unused) {
            map = new HashMap();
        }
        try {
            map2 = (Map) L9.a.a(cursor.getBlob(cursor.getColumnIndexOrThrow("payload")));
        } catch (SerializationException | ClassCastException unused2) {
            map2 = new HashMap();
        }
        return new c(string2, enumC18191bValueOf, map2, map, cursor.getLong(cursor.getColumnIndexOrThrow("timestamp")), cursor.getLong(cursor.getColumnIndexOrThrow("ttl")), string);
    }
}
