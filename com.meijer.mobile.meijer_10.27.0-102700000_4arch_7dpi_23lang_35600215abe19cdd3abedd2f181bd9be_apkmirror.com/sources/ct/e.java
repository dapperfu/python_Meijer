...
@Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0015\b\u0007\u0018\u0000*\b\b\u0000\u0010\u0002*\u00020\u00012\u00020\u0001BK\u0012\u001c\u0010\u0005\u001a\u0018\b\u0001\u0012\n\u0012\b\u0012\u0004\u0012\u00028\u00000\u0004\u0012\u0006\u0012\u0004\u0018\u00010\u00010\u0003\u0012\u0012\u0010\u0007\u001a\u000e\u0012\u0004\u0012\u00028\u0000\u0012\u0004\u0012\u00020\u00060\u0003\u0012\u0010\b\u0002\u0010\n\u001a\n\u0012\u0004\u0012\u00020\t\u0018\u00010\b¢\u0006\u0004\b\u000b\u0010\fJ\u001d\u0010\u0010\u001a\b\u0012\u0004\u0012\u00028\u00000\u000f2\u0006\u0010\u000e\u001a\u00020\rH\u0002¢\u0006\u0004\b\u0010\u0010\u0011J\u0010\u0010\u0012\u001a\u00028\u0000H\u0086P¢\u0006\u0004\b\u0012\u0010\u0013R*\u0010\u0005\u001a\u0018\b\u0001\u0012\n\u0012\b\u0012\u0004\u0012\u00028\u00000\u0004\u0012\u0006\u0012\u0004\u0018\u00010\u00010\u00038\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0014\u0010\u0015R \u0010\u0007\u001a\u000e\u0012\u0004\u0012\u00028\u0000\u0012\u0004\u0012\u00020\u00060\u00038\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0016\u0010\u0015R\u001c\u0010\n\u001a\n\u0012\u0004\u0012\u00020\t\u0018\u00010\b8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0017\u0010\u0018R\u0016\u0010\u001b\u001a\u00028\u00008\u0002@\u0002X\u0082.¢\u0006\u0006\n\u0004\b\u0019\u0010\u001aR\u0016\u0010\u001e\u001a\u00020\u00068\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u001c\u0010\u001dR\u001e\u0010!\u001a\n\u0012\u0004\u0012\u00028\u0000\u0018\u00010\u000f8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u001f\u0010 R\u0014\u0010#\u001a\u00020\u00018\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\"\u0010\u001a¨\u0006$"}, d2 = {"Lct/e;", "", "T", "Lkotlin/Function1;", "Lkotlin/coroutines/Continuation;", "factory", "", "keepDataInMemory", "Lkotlin/Function0;", "", "awaitListener", "<init>", "(Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function0;)V", "Lqv/O;", "scope", "Lqv/W;", "m", "(Lqv/O;)Lqv/W;", "l", "(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "a", "Lkotlin/jvm/functions/Function1;", "b", "c", "Lkotlin/jvm/functions/Function0;", "d", "Ljava/lang/Object;", "data", "e", "Z", "dataInitialized", "f", "Lqv/W;", "deferred", "g", "lock", "auth-foundation_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
...
public final class e<T> {
    ...
    static final class a extends ContinuationImpl {
        ...
        /* synthetic */ Object f126766b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ e<T> f126767c;
        ...
        public final Object invokeSuspend(Object obj) {
            this.f126766b = obj;
            this.f126768d |= Integer.MIN_VALUE;
            return this.f126767c.l(this);
        }
    }
    ...
    static final class b extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super T>, Object> {
        ...
        /* renamed from: b, reason: collision with root package name */
        private /* synthetic */ Object f126770b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Ref.ObjectRef<e<T>> f126771c;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(Ref.ObjectRef<e<T>> objectRef, Continuation<? super b> continuation) {
            super(2, continuation);
            this.f126771c = objectRef;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            b bVar = new b(this.f126771c, continuation);
            bVar.f126770b = obj;
            return bVar;
        }
        ...
        /* JADX WARN: Type inference failed for: r5v5, types: [T, qv.C0, qv.W] */
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Object invokeSuspend(Object obj) {
            Object objF = IntrinsicsKt.f();
            int i10 = this.f126769a;
            try {
                if (i10 != 0) {
                    if (i10 == 1) {
                        ResultKt.b(obj);
                ...
                ResultKt.b(obj);
                InterfaceC16622O interfaceC16622O = (InterfaceC16622O) this.f126770b;
                Ref.ObjectRef objectRef = new Ref.ObjectRef();
                Object obj2 = ((e) this.f126771c.f142835a).lock;
                Ref.ObjectRef<e<T>> objectRef2 = this.f126771c;
                synchronized (obj2) {
                    if (((e) objectRef2.f142835a).dataInitialized) {
                        Object obj3 = ((e) objectRef2.f142835a).data;
                        if (obj3 == null) {
                            Intrinsics.y("data");
                            obj3 = Unit.f142422a;
                        }
                    ...
                    ?? r52 = (T) ((e) objectRef2.f142835a).deferred;
                    if (r52 != 0 && !r52.isCancelled()) {
                        objectRef.f142835a = r52;
                    } else {
                        objectRef.f142835a = (T) objectRef2.f142835a.m(interfaceC16622O);
                    }
                    Unit unit = Unit.f142422a;
                    Function0 function0 = ((e) this.f126771c.f142835a).awaitListener;
                    if (function0 != null) {
                        function0.invoke();
                    }
                    W w10 = (W) objectRef.f142835a;
                    this.f126769a = 1;
    ...
    static final class c extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super T>, Object> {

        /* renamed from: a, reason: collision with root package name */
        int f126772a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ e<T> f126773b;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new c(this.f126773b, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                ResultKt.b(obj);
                Function1 function1 = ((e) this.f126773b).factory;
                this.f126772a = 1;
            ...
            Object obj2 = ((e) this.f126773b).lock;
            e<T> eVar = this.f126773b;
            synchronized (obj2) {
                try {
    ...
    public final W<T> m(InterfaceC16622O scope) {
        C16676y c16676y = (W<? extends T>) C16648k.b(scope, null, EnumC16624Q.f157612b, new c(this, null), 1, null);
        this.deferred = c16676y;
        return c16676y;
    }
    ...
    */
    public final java.lang.Object l(kotlin.coroutines.Continuation<? super T> r6) {
        ...
        L13:
            ...
            r0.<init>(r5, r6)
        L18:
            java.lang.Object r6 = r0.f126766b
            java.lang.Object r1 = kotlin.coroutines.intrinsics.IntrinsicsKt.f()
            int r2 = r0.f126768d
            r3 = 1
            if (r2 == 0) goto L35
            if (r2 != r3) goto L2d
            java.lang.Object r2 = r0.f126765a
        ...
        L58:
            ...
            r0.f126765a = r2
            r0.f126768d = r3
            java.lang.Object r6 = qv.C16623P.g(r6, r0)
            if (r6 != r1) goto L69
            return r1
        L69:
            if (r6 == 0) goto L6c
