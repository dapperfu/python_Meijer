...
public final class b {
    ...
    private static final Lazy<KeyGenParameterSpec> f126754c = LazyKt.b(new Function0() { // from class: ct.a
    ...
    public static final class Companion {
        ...
        public final KeyGenParameterSpec b() {
            return (KeyGenParameterSpec) b.f126754c.getValue();
        }
    }
    ...
    public final Object c(String encryptedString) {
        ...
        try {
            ...
            Key keyE = d.f126756a.e(this.encryptionKeySpec);
            List listA1 = StringsKt.a1(encryptedString, new String[]{","}, false, 2, 2, null);
