...
public final class C16200a0 {

    /* renamed from: a, reason: collision with root package name */
    private static Method f155359a;

    private static int a(Resources resources, int i10, o2.j<Integer> jVar, int i11) {
    ...
    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f155359a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", null);
            } catch (Exception unused) {
                FS.log_i("ViewConfigCompat", "Could not find method getScaledScrollFactor() on ViewConfiguration");
            }
        }
    }
    ...
    private static float b(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f155359a) != null) {
            try {
    ...
    public static int h(Context context, final ViewConfiguration viewConfiguration, int i10, int i11, int i12) {
        ...
        return a(resources, iD, new o2.j() { // from class: p2.Y
            @Override // o2.j
    ...
    public static int i(Context context, final ViewConfiguration viewConfiguration, int i10, int i11, int i12) {
        ...
        Objects.requireNonNull(viewConfiguration);
        return a(resources, iE, new o2.j() { // from class: p2.Z
            @Override // o2.j
            public final Object get() {
