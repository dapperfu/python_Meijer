...
public final class V {
    ...
    private static Map<VelocityTracker, W> f155348a = Collections.synchronizedMap(new WeakHashMap());
    ...
    private static W e(VelocityTracker velocityTracker) {
        return f155348a.get(velocityTracker);
    }

    public static void a(VelocityTracker velocityTracker, MotionEvent motionEvent) {
        velocityTracker.addMovement(motionEvent);
        if (Build.VERSION.SDK_INT < 34 && motionEvent.getSource() == 4194304) {
            if (!f155348a.containsKey(velocityTracker)) {
                f155348a.put(velocityTracker, new W());
            }
            f155348a.get(velocityTracker).a(motionEvent);
        }
    }
