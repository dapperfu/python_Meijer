...
public final class C16204c0 {
    ...
    public static final class a implements Sequence<View> {
        ...
        final /* synthetic */ ViewGroup f155376a;

        a(ViewGroup viewGroup) {
            this.f155376a = viewGroup;
        }

        @Override // kotlin.sequences.Sequence
        public Iterator<View> iterator() {
            return C16204c0.d(this.f155376a);
        }
    }
    ...
    static final class b extends Lambda implements Function1<View, Iterator<? extends View>> {
        ...
        public static final b f155377f = new b();
        ...
        public final Iterator<View> invoke(View view) {
            ...
            if (viewGroup == null || (sequenceB = C16204c0.b(viewGroup)) == null) {
                return null;
            }
    ...
    public static final class c implements Iterator<View>, KMutableIterator {
        ...
        final /* synthetic */ ViewGroup f155379b;

        c(ViewGroup viewGroup) {
            this.f155379b = viewGroup;
        }

        @Override // java.util.Iterator
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public View next() {
            ViewGroup viewGroup = this.f155379b;
            int i10 = this.index;
            this.index = i10 + 1;
        ...
        public boolean hasNext() {
            return this.index < this.f155379b.getChildCount();
        }
    ...
    public static final class d implements Sequence<View> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ ViewGroup f155380a;

        public d(ViewGroup viewGroup) {
            this.f155380a = viewGroup;
        }

        @Override // kotlin.sequences.Sequence
        public Iterator<View> iterator() {
            return new U(C16204c0.b(this.f155380a).iterator(), b.f155377f);
        }
    }
