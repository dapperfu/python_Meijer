...
public final class h implements RememberManager {
    ...
    private X<InterfaceC5719g> releasing;
    ...
    @Override // androidx.compose.runtime.RememberManager
    public void b(InterfaceC5719g instance, int endRelativeOrder, int priority, int endRelativeAfter) {
        X<InterfaceC5719g> xA = this.releasing;
        if (xA == null) {
            xA = k0.a();
            this.releasing = xA;
        }
    ...
    public final void h() {
        ...
        Object objA = o.f14530a.a("Compose:abandons");
        try {
    ...
    public final void j() {
        ...
        if (this.leaving.getSize() != 0) {
            objA = o.f14530a.a("Compose:onForgotten");
            try {
                ...
                for (int size = this.leaving.getSize() - 1; -1 < size; size--) {
                    ...
                    if (obj instanceof InterfaceC5719g) {
                        if (j0Var == null || !j0Var.a(obj)) {
                            ((InterfaceC5719g) obj).h();
                        } else {
                            ((InterfaceC5719g) obj).b();
                        }
                    }
                }
                Unit unit = Unit.f142422a;
    ...
    public final void k() {
        if (this.sideEffects.getSize() != 0) {
            Object objA = o.f14530a.a("Compose:sideeffects");
            try {
    ...
    @Override // androidx.compose.runtime.RememberManager
    public void g(InterfaceC5719g instance, int endRelativeOrder, int priority, int endRelativeAfter) {
        m(instance, endRelativeOrder, priority, endRelativeAfter);
    }
}
