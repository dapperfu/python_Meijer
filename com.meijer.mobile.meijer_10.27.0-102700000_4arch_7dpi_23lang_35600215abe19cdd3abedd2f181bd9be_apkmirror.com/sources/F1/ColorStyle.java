...
final /* data */ class ColorStyle implements n {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorStyle) && C5346q0.s(this.value, ((ColorStyle) other).value);
    }
    ...
    public String toString() {
        return "ColorStyle(value=" + ((Object) C5346q0.z(this.value)) + ')';
    }

    @Override // F1.n
    public float a() {
        return C5346q0.t(getValue());
    }
}
