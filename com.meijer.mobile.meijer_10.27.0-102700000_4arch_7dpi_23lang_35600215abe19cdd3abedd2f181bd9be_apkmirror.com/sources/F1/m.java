...
public final class m {
    public static final n b(n nVar, n nVar2, float f10) {
        ...
        return (z10 || (nVar2 instanceof BrushStyle)) ? (z10 && (nVar2 instanceof BrushStyle)) ? n.INSTANCE.a((AbstractC5324i0) u1.n.d(((BrushStyle) nVar).getBrush(), ((BrushStyle) nVar2).getBrush(), f10), J1.b.b(nVar.getAlpha(), nVar2.getAlpha(), f10)) : (n) u1.n.d(nVar, nVar2, f10) : n.INSTANCE.b(C5349s0.h(nVar.getValue(), nVar2.getValue(), f10));
    }
    ...
    public static final long c(long j10, float f10) {
        ...
        return C5346q0.q(j10, C5346q0.t(j10) * f10, 0.0f, 0.0f, 0.0f, 14, null);
    }
