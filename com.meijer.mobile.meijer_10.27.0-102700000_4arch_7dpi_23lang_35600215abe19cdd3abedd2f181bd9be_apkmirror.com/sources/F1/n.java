...
public interface n {
    ...
    public static final class Companion {
        ...
        public final n a(AbstractC5324i0 brush, float alpha) {
            if (brush == null) {
                return b.f10191b;
            }
        ...
        public final n b(long color) {
            return color != 16 ? new ColorStyle(color, null) : b.f10191b;
        }
    ...
    AbstractC5324i0 getBrush();

    default n c(Function0<? extends n> other) {
        return !Intrinsics.e(this, b.f10191b) ? this : other.invoke();
    }
