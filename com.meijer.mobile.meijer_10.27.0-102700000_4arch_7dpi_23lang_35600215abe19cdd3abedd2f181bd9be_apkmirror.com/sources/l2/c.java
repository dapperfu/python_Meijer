...
public final class c {
    ...
    private static final class b extends C2282c {
        ...
        public static final class a implements ViewGroup.OnHierarchyChangeListener {
            ...
            final /* synthetic */ Activity f148400b;
            ...
            public void onChildViewAdded(View parent, View child) {
                if (h.a(child)) {
                    ...
                    ((ViewGroup) this.f148400b.getWindow().getDecorView()).setOnHierarchyChangeListener(null);
                }
            }
        }
    ...
    private static class C2282c {
        ...
        public C2282c(Activity activity) {
            Intrinsics.j(activity, "activity");
        ...
        public void b() {
            ...
            if (currentTheme.resolveAttribute(C15355a.f148393d, typedValue, true)) {
                this.backgroundResId = Integer.valueOf(typedValue.resourceId);
                this.backgroundColor = Integer.valueOf(typedValue.data);
            }
            if (currentTheme.resolveAttribute(C15355a.f148392c, typedValue, true)) {
                this.icon = __fsTypeCheck_fd91eff810b5be82e24b662149d91569(currentTheme, typedValue.resourceId);
            }
            if (currentTheme.resolveAttribute(C15355a.f148391b, typedValue, true)) {
                this.hasBackground = typedValue.resourceId == C15356b.f148394a;
            }
        ...
        protected final void c(Resources.Theme currentTheme, TypedValue typedValue) {
            ...
            if (currentTheme.resolveAttribute(C15355a.f148390a, typedValue, true)) {
    ...
    private c(Activity activity) {
        this.impl = Build.VERSION.SDK_INT >= 31 ? new b(activity) : new C2282c(activity);
    }
