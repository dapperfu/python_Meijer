...
public final class C16706n {
    ...
    private C16706n fakeNodeParent;
    ...
    static final class a extends Lambda implements Function1<u, Unit> {
        ...
        public final void a(u uVar) {
            s.s0(uVar, this.f157790f.getValue());
        }
    ...
    static final class b extends Lambda implements Function1<u, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ String f157791f;
    ...
    public static final class c extends Modifier.c implements u0 {
        ...
        final /* synthetic */ Function1<u, Unit> f157792o;

        /* JADX WARN: Multi-variable type inference failed */
        c(Function1<? super u, Unit> function1) {
            this.f157792o = function1;
        }

        @Override // androidx.compose.ui.node.u0
        public void T1(u uVar) {
            this.f157792o.invoke(uVar);
        }
    }

    public final List<C16706n> k() {
        return m(this, false, false, false, 7, null);
    }

    public final List<C16706n> t() {
        return m(this, false, true, false, 4, null);
    }

    private final void B(List<C16706n> unmergedChildren, SemanticsConfiguration mergedConfig) {
        ...
        for (int size2 = unmergedChildren.size(); size2 < size; size2++) {
            C16706n c16706n = unmergedChildren.get(size2);
            if (!c16706n.y()) {
                mergedConfig.t(c16706n.unmergedConfig);
                c16706n.B(unmergedChildren, mergedConfig);
            }
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ List D(C16706n c16706n, List list, boolean z10, boolean z11, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            list = new ArrayList();
        }
        if ((i10 & 2) != 0) {
        ...
        return c16706n.C(list, z10, z11);
    }

    private final C16706n c(Role role, Function1<? super u, Unit> properties) {
        SemanticsConfiguration semanticsConfiguration = new SemanticsConfiguration();
        semanticsConfiguration.w(false);
        semanticsConfiguration.v(false);
        properties.invoke(semanticsConfiguration);
        C16706n c16706n = new C16706n(new c(properties), false, new LayoutNode(true, role != null ? C16707o.h(this) : C16707o.e(this)), semanticsConfiguration);
        c16706n.isFake = true;
        c16706n.fakeNodeParent = this;
        return c16706n;
    }

    /* JADX WARN: Multi-variable type inference failed */
    static /* synthetic */ List g(C16706n c16706n, List list, List list2, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            list2 = new ArrayList();
        }
        return c16706n.f(list, list2);
    }

    public static /* synthetic */ List m(C16706n c16706n, boolean z10, boolean z11, boolean z12, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            z10 = !c16706n.mergingEnabled;
        }
        if ((i10 & 2) != 0) {
            z11 = false;
        }
    ...
    public final List<C16706n> C(List<C16706n> unmergedChildren, boolean includeFakeNodes, boolean includeDeactivatedNodes) {
        if (this.isFake) {
    ...
    public final C16706n a() {
        return new C16706n(this.outerSemanticsNode, true, this.layoutNode, this.unmergedConfig);
    }
    ...
    public final NodeCoordinator e() {
        ...
        InterfaceC5814j interfaceC5814jF = C16707o.f(this.layoutNode);
        if (interfaceC5814jF == null) {
            interfaceC5814jF = this.outerSemanticsNode;
        }
        return C5815k.j(interfaceC5814jF, C5810f0.a(8));
    }

    public final List<C16706n> l(boolean includeReplacedSemantics, boolean includeFakeNodes, boolean includeDeactivatedNodes) {
    ...
    public final InterfaceC5798z p() {
    ...
    public final C16706n r() {
        LayoutNode parent$ui_release;
        C16706n c16706n = this.fakeNodeParent;
        if (c16706n != null) {
            return c16706n;
        }
        ...
        if (parent$ui_release == null) {
            ...
            while (true) {
                ...
                if (parent$ui_release.getNodes().p(C5810f0.a(8))) {
                    break;
                }
                parent$ui_release = parent$ui_release.getParent$ui_release();
            }
        ...
        return C16707o.a(parent$ui_release, this.mergingEnabled);
    }

    public final Rect v() {
        InterfaceC5814j interfaceC5814jF;
        if (!this.unmergedConfig.getIsMergingSemanticsOfDescendants() || (interfaceC5814jF = C16707o.f(this.layoutNode)) == null) {
            interfaceC5814jF = this.outerSemanticsNode;
        }
        return v0.c(interfaceC5814jF.getNode(), v0.a(this.unmergedConfig));
    }
    ...
    public C16706n(Modifier.c cVar, boolean z10, LayoutNode layoutNode, SemanticsConfiguration semanticsConfiguration) {
    ...
    private final void b(List<C16706n> unmergedChildren) {
        String str;
        Role roleG = C16707o.g(this);
    ...
    private final void d(LayoutNode layoutNode, List<C16706n> list, boolean z10) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (layoutNode2.isAttached() && (z10 || !layoutNode2.getIsDeactivated())) {
                if (layoutNode2.getNodes().p(C5810f0.a(8))) {
                    list.add(C16707o.a(layoutNode2, this.mergingEnabled));
                } else {
    ...
    private final List<C16706n> f(List<C16706n> unmergedChildren, List<C16706n> list) {
        D(this, unmergedChildren, false, false, 6, null);
        int size = unmergedChildren.size();
        for (int size2 = unmergedChildren.size(); size2 < size; size2++) {
            C16706n c16706n = unmergedChildren.get(size2);
            if (c16706n.y()) {
                list.add(c16706n);
            } else if (!c16706n.unmergedConfig.getIsClearingSemantics()) {
                c16706n.f(unmergedChildren, list);
            }
        }
        return list;
    }
    ...
    public final Rect h() {
        ...
        if (nodeCoordinatorE != null) {
            ...
            if (nodeCoordinatorE != null && (layoutCoordinatesQ1 = nodeCoordinatorE.q1()) != null) {
                return LayoutCoordinates.I(C5815k.j(c16706nR.outerSemanticsNode, C5810f0.a(8)), layoutCoordinatesQ1, false, 2, null);
            }
        }
        return Rect.INSTANCE.a();
    }
