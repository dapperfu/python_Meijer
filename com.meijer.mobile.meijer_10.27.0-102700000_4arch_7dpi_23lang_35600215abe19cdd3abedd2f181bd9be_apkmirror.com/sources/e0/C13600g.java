...
public final class C13600g {
    ...
    static final class a extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ ContextMenuColors f127711g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f127712h;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(ContextMenuColors contextMenuColors, int i10) {
            super(2);
            this.f127711g = contextMenuColors;
            this.f127712h = i10;
        }

        public final void a(Composer composer, int i10) {
            C13600g.this.a(this.f127711g, composer, J0.a(this.f127712h | 1));
        }
    ...
    static final class b extends Lambda implements Function3<ContextMenuColors, Composer, Integer, Unit> {
        ...
        final /* synthetic */ Function2<Composer, Integer, String> f127713f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ boolean f127714g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Modifier f127715h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ Function3<C5346q0, Composer, Integer, Unit> f127716i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f127717j;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        b(Function2<? super Composer, ? super Integer, String> function2, boolean z10, Modifier modifier, Function3<? super C5346q0, ? super Composer, ? super Integer, Unit> function3, Function0<Unit> function0) {
            super(3);
            this.f127713f = function2;
            this.f127714g = z10;
            this.f127715h = modifier;
            this.f127716i = function3;
            this.f127717j = function0;
        }
        ...
        public final void a(ContextMenuColors contextMenuColors, Composer composer, int i10) {
            ...
            String strInvoke = this.f127713f.invoke(composer, 0);
            if (StringsKt.r0(strInvoke)) {
                C14589e.c("Label must not be blank");
            }
            k.b(strInvoke, this.f127714g, contextMenuColors, this.f127715h, this.f127716i, this.f127717j, composer, (i10 << 6) & 896, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static /* synthetic */ void d(C13600g c13600g, Function2 function2, Modifier modifier, boolean z10, Function3 function3, Function0 function0, int i10, Object obj) {
        if ((i10 & 2) != 0) {
        ...
        c13600g.c(function2, modifier2, z11, function3, function0);
    }
    ...
    public final void c(Function2<? super Composer, ? super Integer, String> label, Modifier modifier, boolean enabled, Function3<? super C5346q0, ? super Composer, ? super Integer, Unit> leadingIcon, Function0<Unit> onClick) {
