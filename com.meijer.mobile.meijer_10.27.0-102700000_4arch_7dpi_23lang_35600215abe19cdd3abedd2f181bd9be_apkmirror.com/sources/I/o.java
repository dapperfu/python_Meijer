...
abstract class o<V> implements q<V> {
    ...
    static class a<V> extends o<V> {
        ...
        private final Throwable f13430a;

        @Override // I.o, java.util.concurrent.Future
        public V get() throws ExecutionException {
            throw new ExecutionException(this.f13430a);
        }

        public String toString() {
            return super.toString() + "[status=FAILURE, cause=[" + this.f13430a + "]]";
        }
    ...
    static final class c<V> extends o<V> {
        ...
        static final o<Object> f13431b = new c(null);
        ...
        public String toString() {
            return super.toString() + "[status=SUCCESS, result=[" + this.f13432a + "]]";
        }
