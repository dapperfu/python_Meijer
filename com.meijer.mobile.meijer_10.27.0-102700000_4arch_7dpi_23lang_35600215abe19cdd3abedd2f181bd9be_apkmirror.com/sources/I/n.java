...
public final class n {
    ...
    private static final InterfaceC16423a<?, ?> f13423a = new b();

    /* JADX INFO: Add missing generic type declarations: [I, O] */
    class a<I, O> implements I.a<I, O> {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ InterfaceC16423a f13424a;

        a(InterfaceC16423a interfaceC16423a) {
            this.f13424a = interfaceC16423a;
        }

        @Override // I.a
        public q<O> apply(I i10) {
            return n.p(this.f13424a.apply(i10));
        }
    }
    ...
    class c<I> implements I.c<I> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ c.a f13425a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ InterfaceC16423a f13426b;

        c(c.a aVar, InterfaceC16423a interfaceC16423a) {
            this.f13425a = aVar;
            this.f13426b = interfaceC16423a;
        }
        ...
        public void onSuccess(I i10) {
            try {
                this.f13425a.c(this.f13426b.apply(i10));
            } catch (Throwable th2) {
                this.f13425a.f(th2);
            }
        }
    ...
    private static final class e<V> implements Runnable {
        ...
        /* renamed from: a, reason: collision with root package name */
        final Future<V> f13428a;

        /* renamed from: b, reason: collision with root package name */
        final I.c<? super V> f13429b;

        @Override // java.lang.Runnable
        public void run() {
            try {
                this.f13429b.onSuccess(n.l(this.f13428a));
            } catch (Error e10) {
                e = e10;
                this.f13429b.onFailure(e);
                ...
                if (cause == null) {
                    this.f13429b.onFailure(e12);
                } else {
                    this.f13429b.onFailure(cause);
                }
            }
        }

        public String toString() {
            return e.class.getSimpleName() + "," + this.f13429b;
        }
    ...
    public static <I, O> void u(q<I> qVar, InterfaceC16423a<? super I, ? extends O> interfaceC16423a, c.a<O> aVar, Executor executor) {
        v(true, qVar, interfaceC16423a, aVar, executor);
    }

    class b implements InterfaceC16423a<Object, Object> {
    ...
    public static /* synthetic */ Object c(q qVar, c.a aVar) {
        v(false, qVar, f13423a, aVar, H.a.a());
    ...
    public static <V> q<V> q(final long j10, final ScheduledExecutorService scheduledExecutorService, final q<V> qVar) {
        return androidx.concurrent.futures.c.a(new c.InterfaceC1088c() { // from class: I.e
    ...
    public static <V> q<V> r(final long j10, final ScheduledExecutorService scheduledExecutorService, final V v10, final boolean z10, final q<V> qVar) {
        return androidx.concurrent.futures.c.a(new c.InterfaceC1088c() { // from class: I.i
            @Override // androidx.concurrent.futures.c.InterfaceC1088c
            public final Object a(c.a aVar) {
    ...
    public static <V> q<Void> z(final q<V> qVar) {
        return androidx.concurrent.futures.c.a(new c.InterfaceC1088c() { // from class: I.h
            @Override // androidx.concurrent.futures.c.InterfaceC1088c
            public final Object a(c.a aVar) {
    ...
    public static <V> q<V> s(final q<V> qVar) {
        ...
        return androidx.concurrent.futures.c.a(new c.InterfaceC1088c() { // from class: I.m
            @Override // androidx.concurrent.futures.c.InterfaceC1088c
            public final Object a(c.a aVar) {
    ...
    private static <I, O> void v(boolean z10, q<I> qVar, InterfaceC16423a<? super I, ? extends O> interfaceC16423a, c.a<O> aVar, Executor executor) {
        o2.i.g(qVar);
        o2.i.g(interfaceC16423a);
        o2.i.g(aVar);
        o2.i.g(executor);
        j(qVar, new c(aVar, interfaceC16423a), executor);
        if (z10) {
            aVar.a(new d(qVar), H.a.a());
        }
    }

    public static <I, O> q<O> x(q<I> qVar, InterfaceC16423a<? super I, ? extends O> interfaceC16423a, Executor executor) {
        o2.i.g(interfaceC16423a);
        return y(qVar, new a(interfaceC16423a), executor);
    }
}
