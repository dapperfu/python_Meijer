...
public final class ConstraintTrackingWorker extends CoroutineWorker {
    ...
    static final class b extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super c.a>, Object> {
    ...
    static final class c extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f59361a = obj;
            this.f59363c |= Integer.MIN_VALUE;
    ...
    @SourceDebugExtension
    static final class d extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super c.a>, Object> {
        ...
        private /* synthetic */ Object f59367d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ androidx.work.c f59368e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ i f59369f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ WorkSpec f59370g;
        ...
        static final class a extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ i f59372b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ WorkSpec f59373c;

            /* renamed from: d, reason: collision with root package name */
            final /* synthetic */ AtomicInteger f59374d;

            /* renamed from: e, reason: collision with root package name */
            final /* synthetic */ q<c.a> f59375e;

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new a(this.f59372b, this.f59373c, this.f59374d, this.f59375e, continuation);
            }
            ...
            a(i iVar, WorkSpec workSpec, AtomicInteger atomicInteger, q<c.a> qVar, Continuation<? super a> continuation) {
                super(2, continuation);
                this.f59372b = iVar;
                this.f59373c = workSpec;
                this.f59374d = atomicInteger;
                this.f59375e = qVar;
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i10 != 0) {
                    ...
                    ResultKt.b(obj);
                    i iVar = this.f59372b;
                    WorkSpec workSpec = this.f59373c;
                    this.f59371a = 1;
                    obj = Y4.a.c(iVar, workSpec, this);
                    if (obj == objF) {
                        return objF;
                    }
                }
                this.f59374d.set(((Number) obj).intValue());
                this.f59375e.cancel(true);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            d dVar = new d(this.f59368e, this.f59369f, this.f59370g, continuation);
            dVar.f59367d = obj;
            return dVar;
        }
        ...
        /* JADX WARN: Type inference failed for: r1v0, types: [int, qv.C0] */
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        /*
    ...
    static final class f extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super c.a>, Object> {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ androidx.work.c f59383c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ i f59384d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ WorkSpec f59385e;

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return ConstraintTrackingWorker.this.new f(this.f59383c, this.f59384d, this.f59385e, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.b(obj);
            ConstraintTrackingWorker constraintTrackingWorker = ConstraintTrackingWorker.this;
            androidx.work.c cVar = this.f59383c;
            i iVar = this.f59384d;
            WorkSpec workSpec = this.f59385e;
            this.f59381a = 1;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object i(androidx.work.c r5, R4.i r6, androidx.work.impl.model.WorkSpec r7, kotlin.coroutines.Continuation<? super androidx.work.c.a> r8) {
        /*
            r4 = this;
        ...
        L13:
            ...
            r0.<init>(r8)
        L18:
            java.lang.Object r8 = r0.f59361a
        ...
        L31:
            ...
            r8.<init>(r5, r6, r7, r2)
            r0.f59363c = r3
            java.lang.Object r8 = qv.C16623P.g(r8, r0)
            if (r8 != r1) goto L43
            return r1
        L43:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.work.impl.workers.ConstraintTrackingWorker.i(androidx.work.c, R4.i, androidx.work.impl.model.WorkSpec, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    */
    ...
    public Object b(Continuation<? super c.a> continuation) {
        ...
        return C16644i.g(C16669u0.b(backgroundExecutor), new b(null), continuation);
    }
}
