...
public final class d implements androidx.work.impl.model.c {
    ...
    private final AbstractC6124j<WorkSpec> f59314b;

    /* renamed from: c, reason: collision with root package name */
    private final AbstractC6122h<WorkSpec> f59315c;

    /* renamed from: d, reason: collision with root package name */
    private final S f59316d;

    /* renamed from: e, reason: collision with root package name */
    private final S f59317e;

    /* renamed from: f, reason: collision with root package name */
    private final S f59318f;

    /* renamed from: g, reason: collision with root package name */
    private final S f59319g;

    /* renamed from: h, reason: collision with root package name */
    private final S f59320h;

    /* renamed from: i, reason: collision with root package name */
    private final S f59321i;

    /* renamed from: j, reason: collision with root package name */
    private final S f59322j;

    /* renamed from: k, reason: collision with root package name */
    private final S f59323k;

    /* renamed from: l, reason: collision with root package name */
    private final S f59324l;

    /* renamed from: m, reason: collision with root package name */
    private final S f59325m;

    /* renamed from: n, reason: collision with root package name */
    private final S f59326n;

    /* renamed from: o, reason: collision with root package name */
    private final S f59327o;

    /* renamed from: p, reason: collision with root package name */
    private final S f59328p;

    /* renamed from: q, reason: collision with root package name */
    private final S f59329q;

    /* renamed from: r, reason: collision with root package name */
    private final S f59330r;
    ...
    class i extends AbstractC6124j<WorkSpec> {
        /* JADX INFO: Access modifiers changed from: protected */
        @Override // androidx.room.AbstractC6124j
        /* renamed from: b, reason: merged with bridge method [inline-methods] */
        public void bind(A4.g gVar, WorkSpec workSpec) {
            ...
            gVar.z2(5, androidx.work.b.h(workSpec.input));
            gVar.z2(6, androidx.work.b.h(workSpec.output));
            ...
            gVar.C(24, s.h(c4316d.getRequiredNetworkType()));
            gVar.z2(25, s.c(c4316d.getRequiredNetworkRequestCompat()));
            gVar.C(26, c4316d.getRequiresCharging() ? 1L : 0L);
            gVar.C(27, c4316d.getRequiresDeviceIdle() ? 1L : 0L);
            gVar.C(28, c4316d.getRequiresBatteryNotLow() ? 1L : 0L);
            gVar.C(29, c4316d.getRequiresStorageNotLow() ? 1L : 0L);
            gVar.C(30, c4316d.getContentTriggerUpdateDelayMillis());
            gVar.C(31, c4316d.getContentTriggerMaxDelayMillis());
            gVar.z2(32, s.j(c4316d.c()));
        }
    ...
    class j implements Callable<Boolean> {
        ...
        public Boolean call() throws Exception {
            Boolean boolValueOf;
            Cursor cursorG = C17754b.g(d.this.f59313a, this.f59340a, false, null);
            try {
    ...
    class k extends AbstractC6122h<WorkSpec> {
        /* JADX INFO: Access modifiers changed from: protected */
    ...
    public int A(String str) {
        this.f59313a.assertNotSuspendingTransaction();
        A4.g gVarAcquire = this.f59322j.acquire();
        gVarAcquire.S1(1, str);
        try {
            this.f59313a.beginTransaction();
            try {
                int iB0 = gVarAcquire.b0();
                this.f59313a.setTransactionSuccessful();
                return iB0;
            } finally {
                this.f59313a.endTransaction();
            }
        } finally {
            this.f59322j.release(gVarAcquire);
        }
    }
    ...
    public int B() {
        ...
        this.f59313a.assertNotSuspendingTransaction();
        Cursor cursorG = C17754b.g(this.f59313a, nC, false, null);
        try {
    ...
    public void C(String str, int i10) {
        this.f59313a.assertNotSuspendingTransaction();
        A4.g gVarAcquire = this.f59325m.acquire();
        gVarAcquire.S1(1, str);
        gVarAcquire.C(2, i10);
        try {
            this.f59313a.beginTransaction();
            ...
            this.f59325m.release(gVarAcquire);
        }
    }
    ...
    public void a(String str) {
        this.f59313a.assertNotSuspendingTransaction();
        A4.g gVarAcquire = this.f59316d.acquire();
        gVarAcquire.S1(1, str);
        try {
            this.f59313a.beginTransaction();
            try {
            ...
            this.f59316d.release(gVarAcquire);
        }
    }
    ...
    public void c(String str) {
        this.f59313a.assertNotSuspendingTransaction();
        A4.g gVarAcquire = this.f59319g.acquire();
        gVarAcquire.S1(1, str);
        try {
            this.f59313a.beginTransaction();
            try {
            ...
            this.f59319g.release(gVarAcquire);
        }
    }

    @Override // androidx.work.impl.model.c
    public int d(N.c cVar, String str) {
        this.f59313a.assertNotSuspendingTransaction();
        A4.g gVarAcquire = this.f59317e.acquire();
        ...
        try {
            ...
            this.f59317e.release(gVarAcquire);
        }
    }

    @Override // androidx.work.impl.model.c
    public List<WorkSpec> e(long j10) throws Throwable {
        androidx.room.N n10;
        int iE;
        int iE2;
        int iE3;
        ...
        int iE13;
        int iE14;
        androidx.room.N nC = androidx.room.N.c("SELECT * FROM workspec WHERE last_enqueue_time >= ? AND state IN (2, 3, 5) ORDER BY last_enqueue_time DESC", 1);
        nC.C(1, j10);
        this.f59313a.assertNotSuspendingTransaction();
        Cursor cursorG = C17754b.g(this.f59313a, nC, false, null);
        try {
            iE = C17753a.e(cursorG, PreferencesHelper.PREF_ID);
            iE2 = C17753a.e(cursorG, "state");
            iE3 = C17753a.e(cursorG, "worker_class_name");
            iE4 = C17753a.e(cursorG, "input_merger_class_name");
            iE5 = C17753a.e(cursorG, "input");
            iE6 = C17753a.e(cursorG, "output");
            iE7 = C17753a.e(cursorG, "initial_delay");
            iE8 = C17753a.e(cursorG, "interval_duration");
            iE9 = C17753a.e(cursorG, "flex_duration");
            iE10 = C17753a.e(cursorG, "run_attempt_count");
            iE11 = C17753a.e(cursorG, "backoff_policy");
            iE12 = C17753a.e(cursorG, "backoff_delay_duration");
            iE13 = C17753a.e(cursorG, "last_enqueue_time");
            iE14 = C17753a.e(cursorG, "minimum_retention_duration");
            n10 = nC;
        } catch (Throwable th2) {
            th = th2;
            n10 = nC;
        ...
        try {
            int iE15 = C17753a.e(cursorG, "schedule_requested_at");
            int iE16 = C17753a.e(cursorG, "run_in_foreground");
            int iE17 = C17753a.e(cursorG, "out_of_quota_policy");
            int iE18 = C17753a.e(cursorG, "period_count");
            int iE19 = C17753a.e(cursorG, "generation");
            int iE20 = C17753a.e(cursorG, "next_schedule_time_override");
            int iE21 = C17753a.e(cursorG, "next_schedule_time_override_generation");
            int iE22 = C17753a.e(cursorG, "stop_reason");
            int iE23 = C17753a.e(cursorG, "trace_tag");
            int iE24 = C17753a.e(cursorG, "required_network_type");
            int iE25 = C17753a.e(cursorG, "required_network_request");
            int iE26 = C17753a.e(cursorG, "requires_charging");
            int iE27 = C17753a.e(cursorG, "requires_device_idle");
            int iE28 = C17753a.e(cursorG, "requires_battery_not_low");
            int iE29 = C17753a.e(cursorG, "requires_storage_not_low");
            int iE30 = C17753a.e(cursorG, "trigger_content_update_delay");
            int iE31 = C17753a.e(cursorG, "trigger_max_content_delay");
            int iE32 = C17753a.e(cursorG, "content_uri_triggers");
            int i10 = iE14;
            ...
            while (cursorG.moveToNext()) {
                ...
                EnumC4313a enumC4313aD = s.d(cursorG.getInt(iE11));
                ...
                iE23 = i26;
                int i27 = iE24;
                EnumC4334w enumC4334wE = s.e(cursorG.getInt(i27));
                iE24 = i27;
                int i28 = iE25;
                ...
                int i35 = iE32;
                iE32 = i35;
                arrayList.add(new WorkSpec(string, cVarG, string2, string3, bVarB, bVarB2, j11, j12, j13, new C4316d(networkRequestCompatL, enumC4334wE, z11, z12, z13, z14, j19, j20, s.b(cursorG.getBlob(i35))), i11, enumC4313aD, j14, j15, j16, j17, z10, eF, i18, i20, j18, i23, i25, string4));
                iE = i13;
                i10 = i12;
            }
            cursorG.close();
    ...
    public void f(String str, int i10) {
        this.f59313a.assertNotSuspendingTransaction();
        A4.g gVarAcquire = this.f59330r.acquire();
        gVarAcquire.C(1, i10);
        gVarAcquire.S1(2, str);
        try {
            this.f59313a.beginTransaction();
            ...
            this.f59330r.release(gVarAcquire);
        }
    }
    ...
    public void g(WorkSpec workSpec) {
        ...
        this.f59313a.beginTransaction();
        try {
            this.f59314b.insert((AbstractC6124j<WorkSpec>) workSpec);
            this.f59313a.setTransactionSuccessful();
        } finally {
            this.f59313a.endTransaction();
        }
    ...
    @Override // androidx.work.impl.model.c
    public List<WorkSpec> h() throws Throwable {
        androidx.room.N n10;
        int iE;
        int iE2;
        int iE3;
        ...
        try {
            ...
            while (cursorG.moveToNext()) {
                ...
                int i35 = iE32;
                iE32 = i35;
                arrayList.add(new WorkSpec(string, cVarG, string2, string3, bVarB, bVarB2, j10, j11, j12, new C4316d(networkRequestCompatL, enumC4334wE, z11, z12, z13, z14, j18, j19, s.b(cursorG.getBlob(i35))), i11, enumC4313aD, j13, j14, j15, j16, z10, eF, i18, i20, j17, i23, i25, string4));
                iE = i13;
                i10 = i12;
            }
            cursorG.close();
    ...
    @Override // androidx.work.impl.model.c
    public WorkSpec k(String str) throws Throwable {
        androidx.room.N n10;
        int iE;
        int iE2;
        int iE3;
    ...
    public int l(String str) {
        this.f59313a.assertNotSuspendingTransaction();
        A4.g gVarAcquire = this.f59318f.acquire();
        gVarAcquire.S1(1, str);
        try {
            this.f59313a.beginTransaction();
            try {
            ...
            this.f59318f.release(gVarAcquire);
        }
    }
    ...
    @Override // androidx.work.impl.model.c
    public List<WorkSpec> o(int i10) throws Throwable {
        androidx.room.N n10;
        int iE;
        int iE2;
        int iE3;
        ...
        try {
            ...
            while (cursorG.moveToNext()) {
                ...
                iE23 = i27;
                int i28 = iE24;
                EnumC4334w enumC4334wE = s.e(cursorG.getInt(i28));
                iE24 = i28;
                int i29 = iE25;
                ...
                int i36 = iE32;
                iE32 = i36;
                arrayList.add(new WorkSpec(string, cVarG, string2, string3, bVarB, bVarB2, j10, j11, j12, new C4316d(networkRequestCompatL, enumC4334wE, z11, z12, z13, z14, j18, j19, s.b(cursorG.getBlob(i36))), i12, enumC4313aD, j13, j14, j15, j16, z10, eF, i19, i21, j17, i24, i26, string4));
                iE = i14;
                i11 = i13;
            }
            cursorG.close();
    ...
    public int p() {
        this.f59313a.assertNotSuspendingTransaction();
        A4.g gVarAcquire = this.f59327o.acquire();
        try {
            this.f59313a.beginTransaction();
            try {
                int iB0 = gVarAcquire.b0();
            ...
            this.f59327o.release(gVarAcquire);
        }
    }
    ...
    public int q(String str, long j10) {
        this.f59313a.assertNotSuspendingTransaction();
        A4.g gVarAcquire = this.f59326n.acquire();
        gVarAcquire.C(1, j10);
        gVarAcquire.S1(2, str);
        try {
            this.f59313a.beginTransaction();
            ...
            this.f59326n.release(gVarAcquire);
        }
    }
    ...
    @Override // androidx.work.impl.model.c
    public InterfaceC17152f<Boolean> s() {
        return C6118d.a(this.f59313a, false, new String[]{"workspec"}, new j(androidx.room.N.c("SELECT COUNT(*) > 0 FROM workspec WHERE state NOT IN (2, 3, 5) LIMIT 1", 0)));
    }

    @Override // androidx.work.impl.model.c
    public List<WorkSpec> t(int i10) throws Throwable {
        androidx.room.N n10;
        int iE;
        int iE2;
        int iE3;
    ...
    public void u(String str, androidx.work.b bVar) {
        this.f59313a.assertNotSuspendingTransaction();
        A4.g gVarAcquire = this.f59320h.acquire();
        gVarAcquire.z2(1, androidx.work.b.h(bVar));
        gVarAcquire.S1(2, str);
        try {
            this.f59313a.beginTransaction();
            try {
            ...
            this.f59320h.release(gVarAcquire);
        }
    }
    ...
    public void v(String str, long j10) {
        this.f59313a.assertNotSuspendingTransaction();
        A4.g gVarAcquire = this.f59321i.acquire();
        gVarAcquire.C(1, j10);
        gVarAcquire.S1(2, str);
        try {
            this.f59313a.beginTransaction();
            ...
            this.f59321i.release(gVarAcquire);
        }
    }

    @Override // androidx.work.impl.model.c
    public List<WorkSpec> w() throws Throwable {
        androidx.room.N n10;
        int iE;
        int iE2;
        int iE3;
    ...
    public int y(String str) {
        this.f59313a.assertNotSuspendingTransaction();
        A4.g gVarAcquire = this.f59323k.acquire();
        gVarAcquire.S1(1, str);
        try {
            this.f59313a.beginTransaction();
            try {
            ...
            this.f59323k.release(gVarAcquire);
        }
    }
    ...
    public List<WorkSpec.WorkInfoPojo> z(String str) {
        ...
        this.f59313a.beginTransaction();
        try {
            Cursor cursorG = C17754b.g(this.f59313a, nC, true, null);
            try {
    ...
    public d(G g10) {
        this.f59313a = g10;
        this.f59314b = new i(g10);
        this.f59315c = new k(g10);
        this.f59316d = new l(g10);
        this.f59317e = new m(g10);
        this.f59318f = new n(g10);
        this.f59319g = new o(g10);
        this.f59320h = new p(g10);
        this.f59321i = new q(g10);
        this.f59322j = new r(g10);
        this.f59323k = new a(g10);
        this.f59324l = new b(g10);
        this.f59325m = new c(g10);
        this.f59326n = new C1164d(g10);
        this.f59327o = new e(g10);
        this.f59328p = new f(g10);
        this.f59329q = new g(g10);
        this.f59330r = new h(g10);
    }
    ...
    private void F(HashMap<String, ArrayList<androidx.work.b>> map) {
        ...
        if (map.size() > 999) {
            C17762j.b(map, true, new Function1() { // from class: V4.o
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return androidx.work.impl.model.d.D(this.f36900a, (HashMap) obj);
                }
            });
            return;
        }
        ...
        Cursor cursorG = C17754b.g(this.f59313a, nC, false, null);
        try {
            int iD = C17753a.d(cursorG, "work_spec_id");
            if (iD == -1) {
                return;
            }
            while (cursorG.moveToNext()) {
    ...
    private void G(HashMap<String, ArrayList<String>> map) {
        ...
        if (map.size() > 999) {
            C17762j.b(map, true, new Function1() { // from class: V4.n
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return androidx.work.impl.model.d.E(this.f36899a, (HashMap) obj);
                }
            });
            return;
        }
