...
public class CameraAccessExceptionCompat extends Exception {
    ...
    static final Set<Integer> f47200c = Collections.unmodifiableSet(new HashSet(Arrays.asList(4, 5, 1, 2, 3)));

    /* renamed from: d, reason: collision with root package name */
    static final Set<Integer> f47201d = Collections.unmodifiableSet(new HashSet(Arrays.asList(10001, 10002)));

    /* renamed from: a, reason: collision with root package name */
    private final int f47202a;

    /* renamed from: b, reason: collision with root package name */
    private final CameraAccessException f47203b;

    public CameraAccessExceptionCompat(int i10, String str, Throwable th2) {
        super(a(i10, str), th2);
        this.f47202a = i10;
        this.f47203b = f47200c.contains(Integer.valueOf(i10)) ? new CameraAccessException(i10, str, th2) : null;
    }
    ...
    public CameraAccessExceptionCompat(int i10, Throwable th2) {
        super(b(i10), th2);
        this.f47202a = i10;
        this.f47203b = f47200c.contains(Integer.valueOf(i10)) ? new CameraAccessException(i10, null, th2) : null;
    }

    private CameraAccessExceptionCompat(CameraAccessException cameraAccessException) {
        super(cameraAccessException.getMessage(), cameraAccessException.getCause());
        this.f47202a = cameraAccessException.getReason();
        this.f47203b = cameraAccessException;
    }
}
