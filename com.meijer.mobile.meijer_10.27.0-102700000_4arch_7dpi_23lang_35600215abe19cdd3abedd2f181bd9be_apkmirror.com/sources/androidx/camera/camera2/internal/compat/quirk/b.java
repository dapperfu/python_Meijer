...
public class b {
    ...
    private static volatile l0 f47237a;

    public static /* synthetic */ void a(h0 h0Var) {
        f47237a = new l0(c.a(h0Var));
        P.a("DeviceQuirks", "camera2 DeviceQuirks = " + l0.d(f47237a));
    }

    public static <T extends g0> T b(Class<T> cls) {
        return (T) f47237a.b(cls);
    }
    ...
    static {
        i0.b().c(H.a.a(), new InterfaceC15993a() { // from class: y.a
