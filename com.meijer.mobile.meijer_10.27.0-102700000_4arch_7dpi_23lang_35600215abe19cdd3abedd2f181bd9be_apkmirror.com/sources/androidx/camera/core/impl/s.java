...
public final class s extends t implements r {
    ...
    private static final k.c f47461L = k.c.OPTIONAL;

    public static s b0() {
        return new s(new TreeMap(t.f47462J));
    }

    public static s c0(k kVar) {
        TreeMap treeMap = new TreeMap(t.f47462J);
        for (k.a<?> aVar : kVar.f()) {
    ...
    public <ValueT> ValueT d0(k.a<ValueT> aVar) {
        return (ValueT) this.f47464I.remove(aVar);
    }
    ...
    public <ValueT> void p(k.a<ValueT> aVar, k.c cVar, ValueT valuet) {
        ...
        if (map == null) {
            ArrayMap arrayMap = new ArrayMap();
            this.f47464I.put(aVar, arrayMap);
