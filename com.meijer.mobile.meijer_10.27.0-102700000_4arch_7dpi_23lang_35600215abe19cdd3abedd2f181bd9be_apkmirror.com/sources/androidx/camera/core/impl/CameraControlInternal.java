...
public interface CameraControlInternal {
    ...
    public static final CameraControlInternal f47314a = new b();

    class a implements InterfaceC3408j {
    ...
    public static final class CameraControlException extends Exception {
        ...
        /* renamed from: a, reason: collision with root package name */
        private C3613j f47315a;

        public CameraControlException(C3613j c3613j) {
            this.f47315a = c3613j;
        }
    }

    default com.google.common.util.concurrent.q<InterfaceC3408j> h(int i10, int i11) {
        return I.n.p(new a());
    }
}
