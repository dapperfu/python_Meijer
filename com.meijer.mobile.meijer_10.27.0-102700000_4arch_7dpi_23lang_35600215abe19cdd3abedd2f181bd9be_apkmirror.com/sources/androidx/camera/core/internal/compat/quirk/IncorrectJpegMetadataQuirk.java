...
public final class IncorrectJpegMetadataQuirk implements g0 {
    ...
    private static final Set<String> f47524a = new HashSet(Arrays.asList("A24"));
    ...
    private static boolean e() {
        return "Samsung".equalsIgnoreCase(Build.BRAND) && f47524a.contains(Build.DEVICE.toUpperCase(Locale.US));
    }
