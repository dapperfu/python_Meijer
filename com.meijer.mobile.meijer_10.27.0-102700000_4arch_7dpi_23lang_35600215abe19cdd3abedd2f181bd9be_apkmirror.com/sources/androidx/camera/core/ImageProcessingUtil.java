...
public final class ImageProcessingUtil {
    ...
    public static n g(final n nVar, S s10, ByteBuffer byteBuffer, int i10, boolean z10) {
        ...
        if (Log.isLoggable("MH", 3)) {
            P.a("ImageProcessingUtil", String.format(Locale.US, "Image processing performance profiling, duration: [%d], image count: %d", Long.valueOf(System.currentTimeMillis() - jCurrentTimeMillis), Integer.valueOf(f47240a)));
            f47240a++;
        }
        final n nVarB = s10.b();
        if (nVarB == null) {
