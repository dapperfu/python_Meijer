...
final class i {
    ...
    private final f.j f54610a;

    /* renamed from: b, reason: collision with root package name */
    private final n f54611b;

    /* renamed from: c, reason: collision with root package name */
    private f.e f54612c;

    /* renamed from: d, reason: collision with root package name */
    private final boolean f54613d;

    /* renamed from: e, reason: collision with root package name */
    private final int[] f54614e;
    ...
    private static class b implements c<r> {
        ...
        public boolean a(CharSequence charSequence, int i10, int i11, p pVar) {
            ...
            if (this.f54615a == null) {
                ...
                this.f54615a = new r(spannableString);
            }
            this.f54615a.setSpan(this.f54616b.a(pVar), i10, i11, 33);
            return true;
        }
    }
    ...
    static final class f {
        ...
        /* renamed from: a, reason: collision with root package name */
        private int f54621a = 1;

        /* renamed from: b, reason: collision with root package name */
        private final n.a f54622b;
        ...
        private boolean h() {
            if (this.f54623c.b().j() || d(this.f54625e)) {
                return true;
            }
            if (this.f54627g) {
                if (this.f54628h == null) {
                    return true;
                }
                if (Arrays.binarySearch(this.f54628h, this.f54623c.b().b(0)) < 0) {
                    return true;
                }
            }
            return false;
        ...
        int a(int i10) {
            ...
            if (this.f54621a != 2) {
                ...
                if (this.f54623c.b() != null) {
                    iG = 3;
                    if (this.f54626f != 1 || h()) {
                        this.f54624d = this.f54623c;
                        g();
                    } else {
                        iG = g();
                    }
        ...
        p b() {
            return this.f54623c.b();
        }

        p c() {
            return this.f54624d.b();
        }

        boolean e() {
            if (this.f54621a != 2 || this.f54623c.b() == null) {
                return false;
            }
            return this.f54626f > 1 || h();
        }
    ...
    private static class e implements c<e> {
        ...
        @Override // androidx.emoji2.text.i.c
        public boolean a(CharSequence charSequence, int i10, int i11, p pVar) {
            if (!TextUtils.equals(charSequence.subSequence(i10, i11), this.f54620a)) {
                return true;
            }
            pVar.l(true);
            return false;
    ...
    private <T> T k(CharSequence charSequence, int i10, int i11, int i12, boolean z10, c<T> cVar) {
        int iCharCount;
        f fVar = new f(this.f54611b.f(), this.f54613d, this.f54614e);
        int i13 = 0;
        boolean zA = true;
    ...
    int b(CharSequence charSequence, int i10) {
        ...
        return ((d) k(charSequence, Math.max(0, i10 - 16), Math.min(charSequence.length(), i10 + 16), a.e.API_PRIORITY_OTHER, true, new d(i10))).f54619c;
    }
    ...
    int c(CharSequence charSequence, int i10) {
        ...
        return ((d) k(charSequence, Math.max(0, i10 - 16), Math.min(charSequence.length(), i10 + 16), a.e.API_PRIORITY_OTHER, true, new d(i10))).f54618b;
    }
    ...
    */
    java.lang.CharSequence j(java.lang.CharSequence r11, int r12, int r13, int r14, boolean r15) throws java.lang.Throwable {
        ...
        L84:
            ...
            androidx.emoji2.text.f$j r12 = r10.f54610a     // Catch: java.lang.Throwable -> Lb0
    ...
    private boolean f(CharSequence charSequence, int i10, int i11, p pVar) {
        if (pVar.d() == 0) {
            pVar.m(this.f54612c.a(charSequence, i10, i11, pVar.h()));
        }
        if (pVar.d() == 2) {
            return true;
        }
