...
public class LruCache<K, V> {
    ...
    private final C5556c<K, V> map;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private final C5555b lock;
    ...
    */
    public void k(int r7) {
        ...
        L1a:
            ...
            a0.C5557d.b(r1)     // Catch: java.lang.Throwable -> L15
        L21:
            int r1 = r6.size     // Catch: java.lang.Throwable -> L15
            if (r1 <= r7) goto L61
            a0.c<K, V> r1 = r6.map     // Catch: java.lang.Throwable -> L15
    ...
    public LruCache(int i10) {
        ...
        this.map = new C5556c<>(0, 0.75f);
        this.lock = new C5555b();
    }
    ...
    private final int h(K key, V value) {
        ...
        if (!z10) {
            C5557d.b("Negative size: " + key + '=' + value);
        }
        return iJ;
    }
}
