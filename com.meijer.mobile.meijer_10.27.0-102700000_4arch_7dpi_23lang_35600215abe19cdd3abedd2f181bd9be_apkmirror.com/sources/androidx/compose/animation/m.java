...
final class m implements u {
    ...
    private final Function2<r, r, InterfaceC6293F<r>> sizeAnimationSpec;
    ...
    @Override // kotlin.u
    public InterfaceC6293F<r> b(long initialSize, long targetSize) {
        return this.sizeAnimationSpec.invoke(r.b(initialSize), r.b(targetSize));
    }

    /* JADX WARN: Multi-variable type inference failed */
    public m(boolean z10, Function2<? super r, ? super r, ? extends InterfaceC6293F<r>> function2) {
        this.clip = z10;
