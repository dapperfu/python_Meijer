...
final class l extends AbstractC6176q {

    /* renamed from: o, reason: collision with root package name and from kotlin metadata */
    private InterfaceC6326i<r> animationSpec;
    ...
    private final InterfaceC5730l0 animData = t1.e(null, null, 2, null);
    ...
    public static final /* data */ class AnimData {
        ...
        private final C6313a<r, C6331n> anim;

        /* renamed from: b, reason: collision with root package name and from kotlin metadata and from toString */
        private long startSize;

        public /* synthetic */ AnimData(C6313a c6313a, long j10, DefaultConstructorMarker defaultConstructorMarker) {
            this(c6313a, j10);
        }
        ...
        private AnimData(C6313a<r, C6331n> c6313a, long j10) {
            this.anim = c6313a;
            this.startSize = j10;
        }

        public final C6313a<r, C6331n> a() {
            return this.anim;
        }
    ...
    static final class b extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new b(this.f47891b, this.f47892c, this.f47893d, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                ResultKt.b(obj);
                C6313a<r, C6331n> c6313aA = this.f47891b.a();
                r rVarB = r.b(this.f47892c);
                InterfaceC6326i<r> interfaceC6326iN2 = this.f47893d.N2();
                this.f47890a = 1;
                bVar = this;
                obj = C6313a.f(c6313aA, rVarB, interfaceC6326iN2, null, null, bVar, 12, null);
                if (obj == objF) {
                    return objF;
                }
            }
            AnimationResult animationResult = (AnimationResult) obj;
            if (animationResult.getEndReason() == EnumC6321e.f61060b && (function2O2 = bVar.f47893d.O2()) != 0) {
                function2O2.invoke(r.b(bVar.f47891b.getStartSize()), animationResult.b().getValue());
            }
    ...
    static final class c extends Lambda implements Function1<f0.a, Unit> {
        ...
        final /* synthetic */ long f47895g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f47896h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ int f47897i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ K f47898j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ f0 f47899k;
        ...
        public final void a(f0.a aVar) {
            f0.a.j(aVar, this.f47899k, l.this.getAlignment().a(this.f47895g, r.c((this.f47896h << 32) | (this.f47897i & 4294967295L)), this.f47898j.getLayoutDirection()), 0.0f, 2, null);
        }
    ...
    public final InterfaceC6326i<r> N2() {
    ...
    public final void R2(InterfaceC6326i<r> interfaceC6326i) {
    ...
    public l(InterfaceC6326i<r> interfaceC6326i, P0.e eVar, Function2<? super r, ? super r, Unit> function2) {
        this.animationSpec = interfaceC6326i;
        this.alignment = eVar;
        this.listener = function2;
    }
    ...
    public final long K2(long targetSize) {
        ...
        if (animDataM2 != null) {
            ...
            if (!r.e(targetSize, animDataM2.a().k().getPackedValue()) || z10) {
                ...
                C16648k.d(j2(), null, null, new b(animDataM2, targetSize, this, null), 3, null);
            }
        } else {
            long j10 = 1;
            animDataM2 = new AnimData(new C6313a(r.b(targetSize), q0.e(r.INSTANCE), r.b(r.c((j10 & 4294967295L) | (j10 << 32))), null, 8, null), targetSize, null);
        }
        Q2(animDataM2);
