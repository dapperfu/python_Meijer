...
public final class L {
    ...
    public /* synthetic */ class a {
        ...
        static {
            ...
            try {
                iArr2[F.f50577b.ordinal()] = 2;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                iArr2[F.f50578c.ordinal()] = 3;
    ...
    */
    ...
    public static final Boolean e(FocusTargetNode focusTargetNode, int i10, H1.t tVar, Rect rect, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (C5763f.l(i10, companion.e()) ? true : C5763f.l(i10, companion.f())) {
            return Boolean.valueOf(O.f(focusTargetNode, i10, function1));
        }
        if (C5763f.l(i10, companion.d()) ? true : C5763f.l(i10, companion.g()) ? true : C5763f.l(i10, companion.h()) ? true : C5763f.l(i10, companion.a())) {
            return P.t(focusTargetNode, i10, rect, function1);
        }
        if (!C5763f.l(i10, companion.b())) {
            if (C5763f.l(i10, companion.c())) {
            ...
            throw new IllegalStateException(("Focus search invoked with invalid FocusDirection " + ((Object) C5763f.n(i10))).toString());
        }
    ...
    */
    public static final androidx.compose.ui.focus.FocusTargetNode f(androidx.compose.ui.focus.FocusTargetNode r10) {
        ...
        L21:
            ...
            androidx.compose.ui.node.C5815k.a(r2, r10, r5)
            goto L40
        L3d:
            r2.c(r4)
        L40:
        ...
        L8f:
            ...
            r7 = r7 & r0
            if (r7 == 0) goto Lcb
            boolean r7 = r10 instanceof androidx.compose.ui.node.AbstractC5817m
            if (r7 == 0) goto Lcb
            r7 = r10
            androidx.compose.ui.node.m r7 = (androidx.compose.ui.node.AbstractC5817m) r7
        ...
        Lc8:
            ...
            goto L67
        Lcb:
            androidx.compose.ui.Modifier$c r10 = androidx.compose.ui.node.C5815k.b(r6)
            goto L67
        Ld0:
