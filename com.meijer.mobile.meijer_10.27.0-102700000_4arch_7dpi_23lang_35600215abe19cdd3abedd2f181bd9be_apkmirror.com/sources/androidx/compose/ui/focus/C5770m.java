...
public final class C5770m {
    ...
    private final X<InterfaceC5766i> focusEventNodes = k0.a();

    /* renamed from: g, reason: collision with root package name and from kotlin metadata */
    private final List<FocusTargetNode> focusTargetNodesLegacy = new ArrayList();

    /* renamed from: h, reason: collision with root package name and from kotlin metadata */
    private final List<InterfaceC5766i> focusEventNodesLegacy = new ArrayList();
    ...
    /* synthetic */ class a extends FunctionReferenceImpl implements Function0<Unit> {
        a(Object obj) {
            super(0, obj, C5770m.class, "invalidateNodes", "invalidateNodes()V", 0);
        }

        public final void a() {
            ((C5770m) this.receiver).c();
        }
    ...
    private final void d() {
        ...
        if (!this.rootFocusStateFetcher.invoke().b()) {
            List<InterfaceC5766i> list = this.focusEventNodesLegacy;
            int size = list.size();
            for (int i14 = 0; i14 < size; i14++) {
                list.get(i14).U(F.f50579d);
            }
            ...
            if (wVar.getNode().getIsAttached()) {
                ...
                while (node != null) {
                    if (node instanceof FocusTargetNode) {
                        ...
                        int i17 = 0;
                        for (Modifier.c delegate = ((AbstractC5817m) node).getDelegate(); delegate != null; delegate = delegate.getChild()) {
                ...
                if (child == null) {
                    C5815k.c(cVar2, wVar.getNode(), false);
                } else {
                    cVar2.c(child);
                }
        ...
        this.focusPropertiesNodesLegacy.clear();
        List<InterfaceC5766i> list4 = this.focusEventNodesLegacy;
        int size4 = list4.size();
        int i19 = 0;
        while (i19 < size4) {
            InterfaceC5766i interfaceC5766i = list4.get(i19);
            if (interfaceC5766i.getNode().getIsAttached()) {
                int iA2 = C5810f0.a(i10);
                Modifier.c node2 = interfaceC5766i.getNode();
                int i20 = z14;
                int i21 = i12;
                ...
                while (node2 != null) {
                    if (node2 instanceof FocusTargetNode) {
                        ...
                        Modifier.c delegate3 = ((AbstractC5817m) node2).getDelegate();
                        int i22 = z14;
                ...
                Modifier.c child2 = interfaceC5766i.getNode().getChild();
                if (child2 == null) {
                    C5815k.c(cVar5, interfaceC5766i.getNode(), z14);
                } else {
                    cVar5.c(child2);
                }
                        ...
                        while (cVarH2 != null) {
                            if ((cVarH2.getKindSet() & iA2) != 0) {
                                ...
                                while (cVarH2 != null) {
                                    ...
                                    } else if ((cVarH2.getKindSet() & iA2) == 0 || !(cVarH2 instanceof AbstractC5817m)) {
                                        z11 = z14 == true ? 1 : 0;
                                    } else {
                                        Modifier.c delegate4 = ((AbstractC5817m) cVarH2).getDelegate();
                ...
                if (i21 != 0) {
                    if (i20 != 0) {
                        eD0 = C5767j.a(interfaceC5766i);
                    } else if (focusTargetNode2 == null || (eD0 = focusTargetNode2.d0()) == null) {
                        eD0 = F.f50579d;
                    }
                    interfaceC5766i.U(eD0);
                }
            } else {
                interfaceC5766i.U(F.f50579d);
                z10 = z14;
                i13 = i12;
            }
            i19++;
        ...
        if (!this.focusPropertiesNodesLegacy.isEmpty()) {
            C14832a.b("Unprocessed FocusProperties nodes");
        }
        if (!this.focusEventNodesLegacy.isEmpty()) {
            C14832a.b("Unprocessed FocusEvent nodes");
        }
        if (this.focusTargetNodesLegacy.isEmpty()) {
            return;
        }
        C14832a.b("Unprocessed FocusTarget nodes");
    }
    ...
    */
    private final void e() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.focus.C5770m.e():void");
    }
    ...
    public final void g(InterfaceC5766i node) {
        if (P0.h.isTrackFocusEnabled) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public C5770m(Function1<? super Function0<Unit>, Unit> function1, Function0<Unit> function0, Function0<? extends E> function02, Function0<FocusTargetNode> function03) {
