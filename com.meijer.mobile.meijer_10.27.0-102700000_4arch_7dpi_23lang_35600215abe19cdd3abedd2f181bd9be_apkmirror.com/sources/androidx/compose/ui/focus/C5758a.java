...
public final class C5758a {
    public static final <T> T a(FocusTargetNode focusTargetNode, int i10, Function1<? super InterfaceC5781h.a, ? extends T> function1) {
        Modifier.c cVarH;
        InterfaceC5781h interfaceC5781hS2;
        int iC;
        C5804c0 nodes;
        ...
        if ((focusTargetNode2 != null && Intrinsics.e(focusTargetNode2.S2(), focusTargetNode.S2())) || (interfaceC5781hS2 = focusTargetNode.S2()) == null) {
            return null;
        }
        C5763f.Companion companion = C5763f.INSTANCE;
        if (C5763f.l(i10, companion.h())) {
            iC = InterfaceC5781h.b.INSTANCE.a();
        } else if (C5763f.l(i10, companion.a())) {
            iC = InterfaceC5781h.b.INSTANCE.d();
        } else if (C5763f.l(i10, companion.d())) {
            iC = InterfaceC5781h.b.INSTANCE.e();
        } else if (C5763f.l(i10, companion.g())) {
            iC = InterfaceC5781h.b.INSTANCE.f();
        } else if (C5763f.l(i10, companion.e())) {
            iC = InterfaceC5781h.b.INSTANCE.b();
        } else {
            if (!C5763f.l(i10, companion.f())) {
                throw new IllegalStateException("Unsupported direction for beyond bounds layout");
            }
            iC = InterfaceC5781h.b.INSTANCE.c();
        }
        return (T) interfaceC5781hS2.k0(iC, function1);
    }
}
