...
public final class M {
    ...
    private static final int f50621b = e(1);

    /* renamed from: c, reason: collision with root package name */
    private static final int f50622c = e(0);

    /* renamed from: d, reason: collision with root package name */
    private static final int f50623d = e(2);
    ...
    public static final boolean d(int i10, InterfaceC5812h interfaceC5812h) {
        if (f(i10, f50621b)) {
            return true;
        }
        if (f(i10, f50622c)) {
            return !C13459a.f(((InterfaceC13460b) C5813i.a(interfaceC5812h, C5892t0.l())).a(), C13459a.INSTANCE.b());
        }
        if (f(i10, f50623d)) {
            return false;
        }
