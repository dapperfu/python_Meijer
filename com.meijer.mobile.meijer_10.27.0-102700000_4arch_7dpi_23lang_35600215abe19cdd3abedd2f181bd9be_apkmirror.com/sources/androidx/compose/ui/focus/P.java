...
public final class P {
    ...
    public /* synthetic */ class a {
        ...
        static {
            ...
            try {
                iArr[F.f50577b.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[F.f50576a.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[F.f50578c.ordinal()] = 3;
    ...
    static final class b extends Lambda implements Function1<InterfaceC5781h.a, Boolean> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ int f50632f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ J f50633g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ FocusTargetNode f50634h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ FocusTargetNode f50635i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ Rect f50636j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ int f50637k;

        /* renamed from: l, reason: collision with root package name */
        final /* synthetic */ Function1<FocusTargetNode, Boolean> f50638l;
        ...
        b(int i10, J j10, FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, Rect rect, int i11, Function1<? super FocusTargetNode, Boolean> function1) {
            ...
            this.f50632f = i10;
            this.f50633g = j10;
            this.f50634h = focusTargetNode;
            this.f50635i = focusTargetNode2;
            this.f50636j = rect;
            this.f50637k = i11;
            this.f50638l = function1;
        }

        @Override // kotlin.jvm.functions.Function1
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final Boolean invoke(InterfaceC5781h.a aVar) {
            if (this.f50632f != this.f50633g.getGeneration() || (P0.h.isTrackFocusEnabled && this.f50634h != C5815k.p(this.f50635i).getFocusOwner().h())) {
                return Boolean.TRUE;
            }
            boolean zR = P.r(this.f50635i, this.f50636j, this.f50637k, this.f50638l);
    ...
    private static final boolean d(Rect rect, int i10, Rect rect2) {
        ...
        if (C5763f.l(i10, companion.d()) ? true : C5763f.l(i10, companion.g())) {
            return rect.i() > rect2.getTop() && rect.getTop() < rect2.i();
        }
        if (C5763f.l(i10, companion.h()) ? true : C5763f.l(i10, companion.a())) {
    ...
    */
    private static final float f(androidx.compose.ui.geometry.Rect r2, int r3, androidx.compose.ui.geometry.Rect r4) {
        /*
            androidx.compose.ui.focus.f$a r0 = androidx.compose.ui.focus.C5763f.INSTANCE
            int r1 = r0.d()
            boolean r1 = androidx.compose.ui.focus.C5763f.l(r3, r1)
            if (r1 == 0) goto L16
            float r3 = r4.getLeft()
            float r2 = r2.l()
        L14:
        ...
        L3e:
            int r0 = r0.a()
            boolean r3 = androidx.compose.ui.focus.C5763f.l(r3, r0)
            if (r3 == 0) goto L58
            float r2 = r2.getTop()
            float r3 = r4.i()
            goto L28
    ...
    */
    ...
    private static final void i(InterfaceC5814j interfaceC5814j, D0.c<FocusTargetNode> cVar) {
        ...
        if (child == null) {
            C5815k.c(cVar2, interfaceC5814j.getNode(), false);
        } else {
            cVar2.c(child);
        }
                    ...
                    if ((cVarH.getKindSet() & iA) != 0) {
                        ...
                        while (cVarH != null) {
                            if (cVarH instanceof FocusTargetNode) {
                                ...
                                if (focusTargetNode.getIsAttached() && !C5815k.o(focusTargetNode).getIsDeactivated()) {
    ...
    private static final FocusTargetNode j(D0.c<FocusTargetNode> cVar, Rect rect, int i10) {
        ...
        } else if (C5763f.l(i10, companion.g())) {
            rectS = rect.s(-((rect.l() - rect.getLeft()) + 1), 0.0f);
        } else if (C5763f.l(i10, companion.h())) {
    ...
    public static final boolean k(FocusTargetNode focusTargetNode, int i10, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        C5763f.Companion companion = C5763f.INSTANCE;
        if (C5763f.l(i10, companion.b())) {
            i10 = companion.g();
        }
        if (C5763f.l(i10, companion.g()) ? true : C5763f.l(i10, companion.a())) {
            rectH = s(L.d(focusTargetNode));
        } else {
            if (!(C5763f.l(i10, companion.d()) ? true : C5763f.l(i10, companion.h()))) {
                throw new IllegalStateException("This function should only be used for 2-D focus search");
            }
    ...
    */
    ...
    public static final boolean r(FocusTargetNode focusTargetNode, Rect rect, int i10, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (child == null) {
            C5815k.c(cVar2, focusTargetNode.getNode(), false);
        } else {
            cVar2.c(child);
        }
        while (cVar2.getSize() != 0) {
    ...
    private static final boolean c(Rect rect, Rect rect2, Rect rect3, int i10) {
        ...
        C5763f.Companion companion = C5763f.INSTANCE;
        if (!C5763f.l(i10, companion.d()) && !C5763f.l(i10, companion.g()) && f(rect2, i10, rect) >= g(rect3, i10, rect)) {
            return false;
        }
        return true;
    }
    ...
    private static final boolean l(FocusTargetNode focusTargetNode, Rect rect, int i10, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        Boolean bool = (Boolean) C5758a.a(focusTargetNode, i10, new b(jC.getGeneration(), jC, C5815k.p(focusTargetNode).getFocusOwner().h(), focusTargetNode, rect, i10, function1));
        if (bool != null) {
