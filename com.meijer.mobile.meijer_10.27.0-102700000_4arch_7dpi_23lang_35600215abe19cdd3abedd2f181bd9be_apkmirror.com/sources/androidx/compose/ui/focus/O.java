...
public final class O {
    ...
    static final class b extends Lambda implements Function1<InterfaceC5781h.a, Boolean> {
        ...
        final /* synthetic */ J f50626g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ FocusTargetNode f50627h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ FocusTargetNode f50628i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ FocusTargetNode f50629j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ int f50630k;

        /* renamed from: l, reason: collision with root package name */
        final /* synthetic */ Function1<FocusTargetNode, Boolean> f50631l;
        ...
        b(int i10, J j10, FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, FocusTargetNode focusTargetNode3, int i11, Function1<? super FocusTargetNode, Boolean> function1) {
            ...
            this.f50625f = i10;
            this.f50626g = j10;
            this.f50627h = focusTargetNode;
            this.f50628i = focusTargetNode2;
            this.f50629j = focusTargetNode3;
            this.f50630k = i11;
            this.f50631l = function1;
        }

        @Override // kotlin.jvm.functions.Function1
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final Boolean invoke(InterfaceC5781h.a aVar) {
            if (this.f50625f != this.f50626g.getGeneration() || (P0.h.isTrackFocusEnabled && this.f50627h != C5815k.p(this.f50628i).getFocusOwner().getActiveFocusTargetNode())) {
                return Boolean.TRUE;
            }
            boolean zI = O.i(this.f50628i, this.f50629j, this.f50630k, this.f50631l);
    ...
    private static final boolean b(FocusTargetNode focusTargetNode, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (focusTargetNodeF != null) {
            ...
            if (i11 != 1) {
                ...
                return d(focusTargetNode, focusTargetNodeF, C5763f.INSTANCE.f(), function1);
            }
            if (!b(focusTargetNodeF, function1) && !d(focusTargetNode, focusTargetNodeF, C5763f.INSTANCE.f(), function1) && (!focusTargetNodeF.R2().getCanFocus() || !function1.invoke(focusTargetNodeF).booleanValue())) {
                return false;
            }
            return true;
        }
    ...
    private static final boolean c(FocusTargetNode focusTargetNode, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        FocusTargetNode focusTargetNodeF = L.f(focusTargetNode);
        if (focusTargetNodeF != null) {
            if (c(focusTargetNodeF, function1) || d(focusTargetNode, focusTargetNodeF, C5763f.INSTANCE.e(), function1)) {
                return true;
            }
            return false;
        }
    ...
    private static final boolean d(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i10, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        Boolean bool = (Boolean) C5758a.a(focusTargetNode, i10, new b(jC.getGeneration(), jC, C5815k.p(focusTargetNode).getFocusOwner().getActiveFocusTargetNode(), focusTargetNode, focusTargetNode2, i10, function1));
        if (bool != null) {
    ...
    public static final boolean i(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i10, Function1<? super FocusTargetNode, Boolean> function1) {
        if (focusTargetNode.d0() == F.f50577b) {
            ...
            } else if (C5763f.l(i10, companion.f())) {
            ...
            if (C5763f.l(i10, C5763f.INSTANCE.e()) || !focusTargetNode.R2().getCanFocus() || e(focusTargetNode)) {
                return false;
            }
            return function1.invoke(focusTargetNode).booleanValue();
        }
