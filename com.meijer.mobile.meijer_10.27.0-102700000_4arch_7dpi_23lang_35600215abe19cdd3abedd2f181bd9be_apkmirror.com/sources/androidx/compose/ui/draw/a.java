...
final class a extends Modifier.c implements T0.c, i0, T0.b {
    ...
    static final class C1046a extends Lambda implements Function0<InterfaceC5310d1> {
        C1046a() {
            super(0);
        }
    ...
    private final i M2(X0.c contentDrawScope) {
        if (!this.isCacheValid) {
            ...
            if (dVar.getDrawResult() == null) {
                C14832a.c("DrawResult not defined, did you forget to call onDraw?");
    ...
    public final InterfaceC5310d1 L2() {
    ...
    @Override // T0.b
    public long b() {
        return s.d(C5815k.j(this, C5810f0.a(128)).c());
    }
    ...
    public H1.d getDensity() {
        return C5815k.k(this);
    }

    @Override // T0.b
    public t getLayoutDirection() {
        return C5815k.n(this);
    }
