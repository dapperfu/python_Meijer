...
final class f implements InterfaceC5310d1 {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private T<GraphicsLayer> allocatedGraphicsLayers;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private InterfaceC5310d1 graphicsContext;

    @Override // V0.InterfaceC5310d1
    public GraphicsLayer a() {
        InterfaceC5310d1 interfaceC5310d1 = this.graphicsContext;
        if (!(interfaceC5310d1 != null)) {
            C14832a.b("GraphicsContext not provided");
        }
        GraphicsLayer graphicsLayerA = interfaceC5310d1.a();
    ...
    public void b(GraphicsLayer layer) {
        InterfaceC5310d1 interfaceC5310d1 = this.graphicsContext;
        if (interfaceC5310d1 != null) {
            interfaceC5310d1.b(layer);
        }
    }

    /* renamed from: c, reason: from getter */
    public final InterfaceC5310d1 getGraphicsContext() {
    ...
    public final void e(InterfaceC5310d1 interfaceC5310d1) {
        d();
