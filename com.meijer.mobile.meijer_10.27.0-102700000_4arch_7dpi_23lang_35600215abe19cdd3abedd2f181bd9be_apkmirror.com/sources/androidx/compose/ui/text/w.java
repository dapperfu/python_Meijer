...
public final class w {
    ...
    private final AbstractC18142l.b defaultFontFamilyResolver;
    ...
    public static final class Companion {
        ...
        public final TextLayoutResult b(TextLayoutInput textLayoutInput) {
            int iL;
            int maxLines;
            h hVar = new h(textLayoutInput.getText(), C17208B.d(textLayoutInput.getStyle(), textLayoutInput.getLayoutDirection()), textLayoutInput.g(), textLayoutInput.getDensity(), textLayoutInput.getFontFamilyResolver());
    ...
    public static /* synthetic */ TextLayoutResult b(w wVar, String str, TextStyle textStyle, int i10, boolean z10, int i11, long j10, H1.t tVar, H1.d dVar, AbstractC18142l.b bVar, boolean z11, int i12, Object obj) {
        if ((i12 & 2) != 0) {
    ...
    public static /* synthetic */ TextLayoutResult d(w wVar, AnnotatedString annotatedString, TextStyle textStyle, int i10, boolean z10, int i11, List list, long j10, H1.t tVar, H1.d dVar, AbstractC18142l.b bVar, boolean z11, int i12, Object obj) {
        if ((i12 & 2) != 0) {
            textStyle = TextStyle.INSTANCE.a();
        }
    ...
    public final TextLayoutResult a(String text, TextStyle style, int overflow, boolean softWrap, int maxLines, long constraints, H1.t layoutDirection, H1.d density, AbstractC18142l.b fontFamilyResolver, boolean skipCache) {
    ...
    public final TextLayoutResult c(AnnotatedString text, TextStyle style, int overflow, boolean softWrap, int maxLines, List<AnnotatedString.Range<Placeholder>> placeholders, long constraints, H1.t layoutDirection, H1.d density, AbstractC18142l.b fontFamilyResolver, boolean skipCache) {
        u1.u uVar;
    ...
    public w(AbstractC18142l.b bVar, H1.d dVar, H1.t tVar, int i10) {
        u1.u uVar;
