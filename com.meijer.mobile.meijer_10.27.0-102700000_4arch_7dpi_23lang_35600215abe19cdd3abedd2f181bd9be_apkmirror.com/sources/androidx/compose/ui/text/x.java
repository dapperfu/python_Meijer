...
public final class x {
    public static final void b(X0.f fVar, w wVar, String str, long j10, TextStyle textStyle, int i10, boolean z10, int i11, long j11, int i12) {
        ...
        try {
            ...
            textLayoutResultD.getMultiParagraph().F(fVar.getDrawContext().g(), (30 & 2) != 0 ? C5346q0.INSTANCE.j() : 0L, (30 & 4) != 0 ? null : null, (30 & 8) != 0 ? null : null, (30 & 16) == 0 ? null : null, (30 & 32) != 0 ? X0.f.INSTANCE.a() : i12);
        } finally {
            drawContext.g().i();
            drawContext.h(jB);
        }
