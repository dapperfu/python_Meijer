...
public final class h implements InterfaceC17216h {
    ...
    public h(AnnotatedString annotatedString, TextStyle textStyle, List<AnnotatedString.Range<Placeholder>> list, H1.d dVar, AbstractC18142l.b bVar) {
        ...
        List<AnnotatedString.Range<ParagraphStyle>> listJ = C5913b.j(annotatedString, paragraphStyle);
        ArrayList arrayList = new ArrayList(listJ.size());
        int size = listJ.size();
        for (int i10 = 0; i10 < size; i10++) {
            AnnotatedString.Range<ParagraphStyle> range = listJ.get(i10);
            AnnotatedString annotatedStringK = C5913b.k(annotatedString, range.h(), range.f());
