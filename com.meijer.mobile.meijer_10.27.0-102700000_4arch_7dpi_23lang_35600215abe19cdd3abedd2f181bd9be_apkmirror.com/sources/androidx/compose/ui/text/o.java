...
public final class o {
    ...
    private static final long f52563a = H1.v.INSTANCE.a();
    ...
    private static final PlatformParagraphStyle c(PlatformParagraphStyle platformParagraphStyle, PlatformParagraphStyle platformParagraphStyle2, float f10) {
        ...
        return C17210b.b(platformParagraphStyle, platformParagraphStyle2, f10);
    }
    ...
    public static final ParagraphStyle e(ParagraphStyle paragraphStyle, H1.t tVar) {
        ...
        int iE = C17208B.e(tVar, paragraphStyle.getTextDirection());
        long lineHeight = H1.v.f(paragraphStyle.getLineHeight()) == 0 ? f52563a : paragraphStyle.getLineHeight();
        TextIndent textIndent = paragraphStyle.getTextIndent();
        if (textIndent == null) {
            textIndent = TextIndent.INSTANCE.a();
        }
