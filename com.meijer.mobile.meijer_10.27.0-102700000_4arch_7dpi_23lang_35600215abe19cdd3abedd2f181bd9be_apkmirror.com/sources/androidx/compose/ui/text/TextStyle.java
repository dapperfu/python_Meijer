...
public final class TextStyle {
    ...
    private static final TextStyle f52686e = new TextStyle(0, 0, null, null, null, null, null, 0, null, null, null, 0, null, null, null, 0, 0, 0, null, null, null, 0, 0, null, 16777215, null);
    ...
    public static final class Companion {
        ...
        public final TextStyle a() {
            return TextStyle.f52686e;
        }
    }

    @Deprecated
    public /* synthetic */ TextStyle(long j10, long j11, FontWeight fontWeight, C18153w c18153w, C18154x c18154x, AbstractC18142l abstractC18142l, String str, long j12, F1.a aVar, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j13, F1.k kVar, Shadow b12, F1.j jVar, F1.l lVar, long j14, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, F1.f fVar, F1.e eVar, DefaultConstructorMarker defaultConstructorMarker) {
        this(j10, j11, fontWeight, c18153w, c18154x, abstractC18142l, str, j12, aVar, textGeometricTransform, localeList, j13, kVar, b12, jVar, lVar, j14, textIndent, platformTextStyle, lineHeightStyle, fVar, eVar);
    }

    public static /* synthetic */ TextStyle c(TextStyle textStyle, long j10, long j11, FontWeight fontWeight, C18153w c18153w, C18154x c18154x, AbstractC18142l abstractC18142l, String str, long j12, F1.a aVar, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j13, F1.k kVar, Shadow b12, X0.g gVar, int i10, int i11, long j14, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, int i12, int i13, F1.s sVar, int i14, Object obj) {
        F1.s sVarK;
        int i15;
        ...
        C18153w c18153wL = (i14 & 8) != 0 ? textStyle.spanStyle.getFontStyle() : c18153w;
        C18154x c18154xM = (i14 & 16) != 0 ? textStyle.spanStyle.getFontSynthesis() : c18154x;
        AbstractC18142l abstractC18142lI = (i14 & 32) != 0 ? textStyle.spanStyle.getFontFamily() : abstractC18142l;
        ...
        return textStyle.b(j15, jK, fontWeightN, c18153wL, c18154xM, abstractC18142lI, strJ, jO, aVarE, textGeometricTransformU, localeListP, jD, kVar2, b1R, gVarH, iH, i16, jE, textIndentJ, platformTextStyle2, lineHeightStyleF, iD, i15, sVarK);
    }

    public final TextStyle K(long color, long fontSize, FontWeight fontWeight, C18153w fontStyle, C18154x fontSynthesis, AbstractC18142l fontFamily, String fontFeatureSettings, long letterSpacing, F1.a baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long background, F1.k textDecoration, Shadow shadow, X0.g drawStyle, int textAlign, int textDirection, long lineHeight, TextIndent textIndent, LineHeightStyle lineHeightStyle, int lineBreak, int hyphens, PlatformTextStyle platformStyle, F1.s textMotion) {
    ...
    public final TextStyle b(long color, long fontSize, FontWeight fontWeight, C18153w fontStyle, C18154x fontSynthesis, AbstractC18142l fontFamily, String fontFeatureSettings, long letterSpacing, F1.a baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long background, F1.k textDecoration, Shadow shadow, X0.g drawStyle, int textAlign, int textDirection, long lineHeight, TextIndent textIndent, PlatformTextStyle platformStyle, LineHeightStyle lineHeightStyle, int lineBreak, int hyphens, F1.s textMotion) {
        return new TextStyle(new SpanStyle(C5346q0.s(color, this.spanStyle.g()) ? this.spanStyle.getTextForegroundStyle() : F1.n.INSTANCE.b(color), fontSize, fontWeight, fontStyle, fontSynthesis, fontFamily, fontFeatureSettings, letterSpacing, baselineShift, textGeometricTransform, localeList, background, textDecoration, shadow, platformStyle != null ? platformStyle.getSpanStyle() : null, drawStyle, (DefaultConstructorMarker) null), new ParagraphStyle(textAlign, textDirection, lineHeight, textIndent, platformStyle != null ? platformStyle.getParagraphSyle() : null, lineHeightStyle, lineBreak, hyphens, textMotion, null), platformStyle);
    }
    ...
    public /* synthetic */ TextStyle(long j10, long j11, FontWeight fontWeight, C18153w c18153w, C18154x c18154x, AbstractC18142l abstractC18142l, String str, long j12, F1.a aVar, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j13, F1.k kVar, Shadow b12, X0.g gVar, int i10, int i11, long j14, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, int i12, int i13, F1.s sVar, DefaultConstructorMarker defaultConstructorMarker) {
        this(j10, j11, fontWeight, c18153w, c18154x, abstractC18142l, str, j12, aVar, textGeometricTransform, localeList, j13, kVar, b12, gVar, i10, i11, j14, textIndent, platformTextStyle, lineHeightStyle, i12, i13, sVar);
    }
    ...
    public final TextStyle J(TextStyle other) {
        return (other == null || Intrinsics.e(other, f52686e)) ? this : new TextStyle(getSpanStyle().y(other.getSpanStyle()), getParagraphStyle().l(other.getParagraphStyle()));
    }
    ...
    public final AbstractC5324i0 g() {
    ...
    public final AbstractC18142l j() {
    ...
    public final C18153w m() {
        return this.spanStyle.getFontStyle();
    }

    public final C18154x n() {
    ...
    public String toString() {
        return "TextStyle(color=" + ((Object) C5346q0.z(h())) + ", brush=" + g() + ", alpha=" + d() + ", fontSize=" + ((Object) H1.v.j(l())) + ", fontWeight=" + o() + ", fontStyle=" + m() + ", fontSynthesis=" + n() + ", fontFamily=" + j() + ", fontFeatureSettings=" + k() + ", letterSpacing=" + ((Object) H1.v.j(q())) + ", baselineShift=" + f() + ", textGeometricTransform=" + C() + ", localeList=" + u() + ", background=" + ((Object) C5346q0.z(e())) + ", textDecoration=" + A() + ", shadow=" + x() + ", drawStyle=" + i() + ", textAlign=" + ((Object) F1.j.m(z())) + ", textDirection=" + ((Object) F1.l.l(B())) + ", lineHeight=" + ((Object) H1.v.j(s())) + ", textIndent=" + D() + ", platformStyle=" + this.platformStyle + ", lineHeightStyle=" + t() + ", lineBreak=" + ((Object) F1.f.k(r())) + ", hyphens=" + ((Object) F1.e.i(p())) + ", textMotion=" + E() + ')';
    }
    ...
    public TextStyle(SpanStyle sVar, ParagraphStyle nVar) {
        this(sVar, nVar, C17208B.b(sVar.getPlatformStyle(), nVar.getPlatformStyle()));
    }

    /* JADX WARN: Illegal instructions before constructor call */
    public /* synthetic */ TextStyle(long j10, long j11, FontWeight fontWeight, C18153w c18153w, C18154x c18154x, AbstractC18142l abstractC18142l, String str, long j12, F1.a aVar, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j13, F1.k kVar, Shadow b12, F1.j jVar, F1.l lVar, long j14, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, F1.f fVar, F1.e eVar, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        long j15 = (i10 & 1) != 0 ? C5346q0.INSTANCE.j() : j10;
        ...
        long j16 = (i10 & RecyclerView.m.FLAG_MOVED) != 0 ? C5346q0.INSTANCE.j() : j13;
        ...
        long j20 = j16;
        this(j17, j18, fontWeight3, c18153w3, c18154x3, abstractC18142l3, str3, j19, aVar3, textGeometricTransform3, localeList3, j20, kVar3, b13, jVar2, lVar2, jA3, textIndent2, platformTextStyle2, lineHeightStyle2, fVar2, (i10 & 2097152) != 0 ? null : eVar, null);
    }

    private TextStyle(long j10, long j11, FontWeight fontWeight, C18153w c18153w, C18154x c18154x, AbstractC18142l abstractC18142l, String str, long j12, F1.a aVar, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j13, F1.k kVar, Shadow b12, F1.j jVar, F1.l lVar, long j14, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, F1.f fVar, F1.e eVar) {
        SpanStyle sVar = new SpanStyle(j10, j11, fontWeight, c18153w, c18154x, abstractC18142l, str, j12, aVar, textGeometricTransform, localeList, j13, kVar, b12, platformTextStyle != null ? platformTextStyle.getSpanStyle() : null, null, 32768, null);
    ...
    public /* synthetic */ TextStyle(long j10, long j11, FontWeight fontWeight, C18153w c18153w, C18154x c18154x, AbstractC18142l abstractC18142l, String str, long j12, F1.a aVar, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j13, F1.k kVar, Shadow b12, X0.g gVar, int i10, int i11, long j14, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, int i12, int i13, F1.s sVar, int i14, DefaultConstructorMarker defaultConstructorMarker) {
        long j15 = (i14 & 1) != 0 ? C5346q0.INSTANCE.j() : j10;
        long jA = (i14 & 2) != 0 ? H1.v.INSTANCE.a() : j11;
        FontWeight fontWeight2 = (i14 & 4) != 0 ? null : fontWeight;
        C18153w c18153w2 = (i14 & 8) != 0 ? null : c18153w;
        C18154x c18154x2 = (i14 & 16) != 0 ? null : c18154x;
        AbstractC18142l abstractC18142l2 = (i14 & 32) != 0 ? null : abstractC18142l;
        ...
        long j16 = (i14 & RecyclerView.m.FLAG_MOVED) != 0 ? C5346q0.INSTANCE.j() : j13;
        ...
        LocaleList localeList3 = localeList2;
        long j20 = j16;
        this(j17, j18, fontWeight3, c18153w3, c18154x3, abstractC18142l3, str3, j19, aVar3, textGeometricTransform3, localeList3, j20, kVar3, b13, gVar2, iG, iF, jA3, textIndent2, platformTextStyle2, lineHeightStyle2, iB, iC, (i14 & 8388608) != 0 ? null : sVar, null);
    }

    private TextStyle(long j10, long j11, FontWeight fontWeight, C18153w c18153w, C18154x c18154x, AbstractC18142l abstractC18142l, String str, long j12, F1.a aVar, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j13, F1.k kVar, Shadow b12, X0.g gVar, int i10, int i11, long j14, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, int i12, int i13, F1.s sVar) {
        this(new SpanStyle(j10, j11, fontWeight, c18153w, c18154x, abstractC18142l, str, j12, aVar, textGeometricTransform, localeList, j13, kVar, b12, platformTextStyle != null ? platformTextStyle.getSpanStyle() : null, gVar, (DefaultConstructorMarker) null), new ParagraphStyle(i10, i11, j14, textIndent, platformTextStyle != null ? platformTextStyle.getParagraphSyle() : null, lineHeightStyle, i12, i13, sVar, null), platformTextStyle);
    }
}
