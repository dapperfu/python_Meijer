...
public final class g {
    ...
    static final class a extends Lambda implements Function1<ParagraphInfo, Unit> {
        ...
        final /* synthetic */ long f52472f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ float[] f52473g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Ref.IntRef f52474h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ Ref.FloatRef f52475i;
        ...
        a(long j10, float[] fArr, Ref.IntRef intRef, Ref.FloatRef floatRef) {
            ...
            this.f52473g = fArr;
            this.f52474h = intRef;
            this.f52475i = floatRef;
        }

        public final void a(ParagraphInfo paragraphInfo) {
            long j10 = this.f52472f;
            float[] fArr = this.f52473g;
            Ref.IntRef intRef = this.f52474h;
            Ref.FloatRef floatRef = this.f52475i;
            long jB = C17207A.b(paragraphInfo.r(paragraphInfo.getStartIndex() > y.l(j10) ? paragraphInfo.getStartIndex() : y.l(j10)), paragraphInfo.r(paragraphInfo.getEndIndex() < y.k(j10) ? paragraphInfo.getEndIndex() : y.k(j10)));
            paragraphInfo.getParagraph().v(jB, fArr, intRef.f142833a);
            int iJ = intRef.f142833a + (y.j(jB) * 4);
            for (int i10 = intRef.f142833a; i10 < iJ; i10 += 4) {
                int i11 = i10 + 1;
                float f10 = fArr[i11];
            ...
            intRef.f142833a = iJ;
            floatRef.f142832a += paragraphInfo.getParagraph().getHeight();
        }
    ...
    static final class b extends Lambda implements Function1<ParagraphInfo, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ q1 f52476f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f52477g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f52478h;
        ...
        public final void a(ParagraphInfo paragraphInfo) {
            q1.j(this.f52476f, paragraphInfo.i(paragraphInfo.getParagraph().t(paragraphInfo.r(this.f52477g), paragraphInfo.r(this.f52478h))), 0L, 2, null);
        }
    ...
    private g(h hVar, long j10, int i10, int i11) {
        ...
        while (i13 < size) {
            ...
            InterfaceC17214f interfaceC17214fC = m.c(paragraphIntrinsicInfo.getIntrinsics(), H1.c.b(0, H1.b.l(j10), 0, H1.b.g(j10) ? RangesKt.f(H1.b.k(j10) - m.d(f10), 0) : H1.b.k(j10), 5, null), this.maxLines - i12, i11);
            float height = f10 + interfaceC17214fC.getHeight();
            int iP = i12 + interfaceC17214fC.p();
            arrayList.add(new ParagraphInfo(interfaceC17214fC, paragraphIntrinsicInfo.getStartIndex(), paragraphIntrinsicInfo.getEndIndex(), i12, iP, f10, height));
            if (interfaceC17214fC.r() || (iP == this.maxLines && i13 != CollectionsKt.o(this.intrinsics.f()))) {
                i12 = iP;
                f10 = height;
                break;
            } else {
    ...
    public static /* synthetic */ void I(g gVar, Canvas canvas, AbstractC5324i0 abstractC5324i0, float f10, Shadow b12, F1.k kVar, X0.g gVar2, int i10, int i11, Object obj) {
        if ((i11 & 4) != 0) {
            f10 = Float.NaN;
        }
        gVar.H(canvas, abstractC5324i0, f10, (i11 & 8) != 0 ? null : b12, (i11 & 16) != 0 ? null : kVar, (i11 & 32) != 0 ? null : gVar2, (i11 & 64) != 0 ? X0.f.INSTANCE.a() : i10);
    }
    ...
    public final q1 A(int start, int end) {
        ...
        q1 q1VarA = W.a();
        C17213e.d(this.paragraphInfoList, C17207A.b(start, end), new b(q1VarA, start, end));
        return q1VarA;
    }
    ...
    public final long C(Rect rect, int granularity, u1.t inclusionStrategy) {
        ...
        int iC = C17213e.c(this.paragraphInfoList, rect.getTop());
        ...
        int iC2 = C17213e.c(this.paragraphInfoList, rect.i());
        ...
        return y.g(jA2, companion2.a()) ? jA : C17207A.b(y.n(jA), y.i(jA2));
    }
    ...
    public final int q(float vertical) {
        ParagraphInfo paragraphInfo = this.paragraphInfoList.get(C17213e.c(this.paragraphInfoList, vertical));
    ...
    public final int x(long position) {
        ParagraphInfo paragraphInfo = this.paragraphInfoList.get(C17213e.c(this.paragraphInfoList, Float.intBitsToFloat((int) (4294967295L & position))));
    ...
    public final long E(int offset) {
        ...
        if (offset == b().length()) {
            ...
            iA = C17213e.a(this.paragraphInfoList, offset);
        }
    ...
    public final void H(Canvas canvas, AbstractC5324i0 brush, float alpha, Shadow shadow, F1.k decoration, X0.g drawStyle, int blendMode) {
    ...
    public final float[] a(long range, float[] array, int arrayStart) {
        ...
        intRef.f142833a = arrayStart;
        C17213e.d(this.paragraphInfoList, range, new a(range, array, intRef, new Ref.FloatRef()));
        return array;
    }
    ...
    public final Rect d(int offset) {
        J(offset);
        ParagraphInfo paragraphInfo = this.paragraphInfoList.get(C17213e.a(this.paragraphInfoList, offset));
    ...
    public final float l(int lineIndex) {
        L(lineIndex);
        ParagraphInfo paragraphInfo = this.paragraphInfoList.get(C17213e.b(this.paragraphInfoList, lineIndex));
