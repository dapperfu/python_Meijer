...
public final class c implements InputConnection {
    ...
    public ExtractedText getExtractedText(ExtractedTextRequest request, int flags) {
        ...
        return C18374u.a(this.mTextFieldValue);
    }
    ...
    public final void g(TextFieldValue state, InterfaceC18372s inputMethodManager) {
        if (this.isActive) {
            f(state);
            if (this.extractedTextMonitorMode) {
                inputMethodManager.b(this.currentExtractedTextRequestToken, C18374u.a(state));
            }
    ...
    private final void b(InterfaceC18363i editCommand) {
        c();
        try {
