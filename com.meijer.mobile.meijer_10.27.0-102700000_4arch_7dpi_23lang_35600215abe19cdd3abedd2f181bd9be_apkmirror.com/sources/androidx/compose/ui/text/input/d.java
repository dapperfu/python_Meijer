...
public final class d implements I {
    ...
    private final InterfaceC18372s inputMethodManager;
    ...
    private Function1<? super List<? extends InterfaceC18363i>, Unit> onEditCommand;
    ...
    private final C18359e cursorAnchorInfoController;
    ...
    private static final class a {
        ...
        public static final a f52535a = new a("StartInput", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final a f52536b = new a("StopInput", 1);

        /* renamed from: c, reason: collision with root package name */
        public static final a f52537c = new a("ShowKeyboard", 2);

        /* renamed from: d, reason: collision with root package name */
        public static final a f52538d = new a("HideKeyboard", 3);

        /* renamed from: e, reason: collision with root package name */
        private static final /* synthetic */ a[] f52539e;

        /* renamed from: f, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f52540f;

        private static final /* synthetic */ a[] a() {
            return new a[]{f52535a, f52536b, f52537c, f52538d};
        }
        ...
        public static a[] values() {
            return (a[]) f52539e.clone();
        }

        static {
            a[] aVarArrA = a();
            f52539e = aVarArrA;
            f52540f = EnumEntriesKt.a(aVarArrA);
        }
    ...
    public /* synthetic */ class b {
        ...
        static {
            ...
            try {
                iArr[a.f52535a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[a.f52536b.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[a.f52537c.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[a.f52538d.ordinal()] = 4;
    ...
    public static final class C1074d implements r {
        C1074d() {
        }
        ...
        @Override // z1.r
        public void d(List<? extends InterfaceC18363i> editCommands) {
    ...
    static final class e extends Lambda implements Function1<List<? extends InterfaceC18363i>, Unit> {

        /* renamed from: f, reason: collision with root package name */
        public static final e f52543f = new e();
    ...
    static final class f extends Lambda implements Function1<androidx.compose.ui.text.input.a, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final f f52544f = new f();
    ...
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0004\u001a\u00020\u00032\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00010\u0000H\n¢\u0006\u0004\b\u0004\u0010\u0005"}, d2 = {"", "Lz1/i;", "it", "", "a", "(Ljava/util/List;)V"}, k = 3, mv = {1, 9, 0})
    static final class g extends Lambda implements Function1<List<? extends InterfaceC18363i>, Unit> {

        /* renamed from: f, reason: collision with root package name */
        public static final g f52545f = new g();
    ...
    static final class h extends Lambda implements Function1<androidx.compose.ui.text.input.a, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final h f52546f = new h();
    ...
    public d(View view, InterfaceC14176h interfaceC14176h, InterfaceC18372s interfaceC18372s, Executor executor) {
        this.view = view;
        this.inputMethodManager = interfaceC18372s;
        this.inputCommandProcessorExecutor = executor;
        this.onEditCommand = e.f52543f;
        this.onImeActionPerformed = f.f52544f;
        ...
        this.baseInputConnection = LazyKt.a(LazyThreadSafetyMode.f142381c, new c());
        this.cursorAnchorInfoController = new C18359e(interfaceC14176h, interfaceC18372s);
    ...
    public void b() {
        ...
        this.onEditCommand = g.f52545f;
        this.onImeActionPerformed = h.f52546f;
    ...
    private final void s() {
        ...
        this.textInputCommandQueue.k();
        if (Intrinsics.e(objectRef.f142835a, Boolean.TRUE)) {
            u();
        }
        Boolean bool = (Boolean) objectRef2.f142835a;
        if (bool != null) {
            x(bool.booleanValue());
        }
        if (Intrinsics.e(objectRef.f142835a, Boolean.FALSE)) {
            u();
        }
    }
    ...
    private static final void t(a aVar, Ref.ObjectRef<Boolean> objectRef, Ref.ObjectRef<Boolean> objectRef2) {
        ...
        if (i10 == 1) {
            ?? r32 = Boolean.TRUE;
            objectRef.f142835a = r32;
            objectRef2.f142835a = r32;
        } else if (i10 == 2) {
            ?? r33 = Boolean.FALSE;
            objectRef.f142835a = r33;
            objectRef2.f142835a = r33;
        } else if ((i10 == 3 || i10 == 4) && !Intrinsics.e(objectRef.f142835a, Boolean.FALSE)) {
            objectRef2.f142835a = Boolean.valueOf(aVar == a.f52537c);
        }
    }
        ...
        if (this.frameCallback == null) {
            Runnable runnable = new Runnable() { // from class: z1.P
                ...
                public final void run() {
                    androidx.compose.ui.text.input.d.w(this.f171436a);
                }
            };
    ...
    public void e(TextFieldValue oldValue, TextFieldValue newValue) {
        ...
        if (Intrinsics.e(oldValue, newValue)) {
            if (z10) {
                InterfaceC18372s interfaceC18372s = this.inputMethodManager;
                ...
                interfaceC18372s.c(iL, iK, iL2, composition2 != null ? y.k(composition2.getPackedValue()) : -1);
                return;
            }
            return;
        }
    ...
    @Override // z1.I
    public void g(TextFieldValue textFieldValue, InterfaceC18354E offsetMapping, TextLayoutResult textLayoutResult, Function1<? super C5331k1, Unit> textFieldToRootTransform, androidx.compose.ui.geometry.Rect innerTextFieldBounds, androidx.compose.ui.geometry.Rect decorationBoxBounds) {
    ...
    public final InputConnection o(EditorInfo outAttrs) {
        ...
        androidx.compose.ui.text.input.c cVar = new androidx.compose.ui.text.input.c(this.state, new C1074d(), this.imeOptions.getAutoCorrect());
    ...
    public /* synthetic */ d(View view, InterfaceC14176h interfaceC14176h, InterfaceC18372s interfaceC18372s, Executor executor, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(view, interfaceC14176h, interfaceC18372s, (i10 & 8) != 0 ? androidx.compose.ui.text.input.e.d(Choreographer.getInstance()) : executor);
    }

    public d(View view, InterfaceC14176h interfaceC14176h) {
        this(view, interfaceC14176h, new C18373t(view), null, 8, null);
    }
}
