...
public final class SpanStyle implements AnnotatedString.a {
    ...
    private final C18154x fontSynthesis;
    ...
    public /* synthetic */ SpanStyle(long j10, long j11, FontWeight fontWeight, C18153w c18153w, C18154x c18154x, AbstractC18142l abstractC18142l, String str, long j12, F1.a aVar, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j13, F1.k kVar, Shadow b12, u1.k kVar2, X0.g gVar, DefaultConstructorMarker defaultConstructorMarker) {
        this(j10, j11, fontWeight, c18153w, c18154x, abstractC18142l, str, j12, aVar, textGeometricTransform, localeList, j13, kVar, b12, kVar2, gVar);
    }
    ...
    public final boolean v(SpanStyle other) {
        ...
        return H1.v.e(this.fontSize, other.fontSize) && Intrinsics.e(this.fontWeight, other.fontWeight) && Intrinsics.e(this.fontStyle, other.fontStyle) && Intrinsics.e(this.fontSynthesis, other.fontSynthesis) && Intrinsics.e(this.fontFamily, other.fontFamily) && Intrinsics.e(this.fontFeatureSettings, other.fontFeatureSettings) && H1.v.e(this.letterSpacing, other.letterSpacing) && Intrinsics.e(this.baselineShift, other.baselineShift) && Intrinsics.e(this.textGeometricTransform, other.textGeometricTransform) && Intrinsics.e(this.localeList, other.localeList) && C5346q0.s(this.background, other.background) && Intrinsics.e(this.platformStyle, other.platformStyle);
    }

    public /* synthetic */ SpanStyle(F1.n nVar, long j10, FontWeight fontWeight, C18153w c18153w, C18154x c18154x, AbstractC18142l abstractC18142l, String str, long j11, F1.a aVar, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j12, F1.k kVar, Shadow b12, u1.k kVar2, X0.g gVar, DefaultConstructorMarker defaultConstructorMarker) {
        this(nVar, j10, fontWeight, c18153w, c18154x, abstractC18142l, str, j11, aVar, textGeometricTransform, localeList, j12, kVar, b12, kVar2, gVar);
    }

    public static /* synthetic */ SpanStyle b(SpanStyle spanStyle, long j10, long j11, FontWeight fontWeight, C18153w c18153w, C18154x c18154x, AbstractC18142l abstractC18142l, String str, long j12, F1.a aVar, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j13, F1.k kVar, Shadow b12, u1.k kVar2, X0.g gVar, int i10, Object obj) {
        long jG = (i10 & 1) != 0 ? spanStyle.g() : j10;
        return spanStyle.a(jG, (i10 & 2) != 0 ? spanStyle.fontSize : j11, (i10 & 4) != 0 ? spanStyle.fontWeight : fontWeight, (i10 & 8) != 0 ? spanStyle.fontStyle : c18153w, (i10 & 16) != 0 ? spanStyle.fontSynthesis : c18154x, (i10 & 32) != 0 ? spanStyle.fontFamily : abstractC18142l, (i10 & 64) != 0 ? spanStyle.fontFeatureSettings : str, (i10 & 128) != 0 ? spanStyle.letterSpacing : j12, (i10 & 256) != 0 ? spanStyle.baselineShift : aVar, (i10 & 512) != 0 ? spanStyle.textGeometricTransform : textGeometricTransform, (i10 & 1024) != 0 ? spanStyle.localeList : localeList, (i10 & RecyclerView.m.FLAG_MOVED) != 0 ? spanStyle.background : j13, (i10 & RecyclerView.m.FLAG_APPEARED_IN_PRE_LAYOUT) != 0 ? spanStyle.textDecoration : kVar, (i10 & 8192) != 0 ? spanStyle.shadow : b12, (i10 & 16384) != 0 ? spanStyle.platformStyle : kVar2, (i10 & 32768) != 0 ? spanStyle.drawStyle : gVar);
    }

    public final SpanStyle a(long color, long fontSize, FontWeight fontWeight, C18153w fontStyle, C18154x fontSynthesis, AbstractC18142l fontFamily, String fontFeatureSettings, long letterSpacing, F1.a baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long background, F1.k textDecoration, Shadow shadow, u1.k platformStyle, X0.g drawStyle) {
        return new SpanStyle(C5346q0.s(color, g()) ? this.textForegroundStyle : F1.n.INSTANCE.b(color), fontSize, fontWeight, fontStyle, fontSynthesis, fontFamily, fontFeatureSettings, letterSpacing, baselineShift, textGeometricTransform, localeList, background, textDecoration, shadow, platformStyle, drawStyle, (DefaultConstructorMarker) null);
    }
    ...
    public final AbstractC5324i0 f() {
    ...
    public final C18154x getFontSynthesis() {
    ...
    public String toString() {
        return "SpanStyle(color=" + ((Object) C5346q0.z(g())) + ", brush=" + f() + ", alpha=" + c() + ", fontSize=" + ((Object) H1.v.j(this.fontSize)) + ", fontWeight=" + this.fontWeight + ", fontStyle=" + this.fontStyle + ", fontSynthesis=" + this.fontSynthesis + ", fontFamily=" + this.fontFamily + ", fontFeatureSettings=" + this.fontFeatureSettings + ", letterSpacing=" + ((Object) H1.v.j(this.letterSpacing)) + ", baselineShift=" + this.baselineShift + ", textGeometricTransform=" + this.textGeometricTransform + ", localeList=" + this.localeList + ", background=" + ((Object) C5346q0.z(this.background)) + ", textDecoration=" + this.textDecoration + ", shadow=" + this.shadow + ", platformStyle=" + this.platformStyle + ", drawStyle=" + this.drawStyle + ')';
    }
    ...
    public final int x() {
        ...
        int iG = (iHashCode + (c18153w != null ? C18153w.g(c18153w.getValue()) : 0)) * 31;
        C18154x c18154x = this.fontSynthesis;
        int i11 = (iG + (c18154x != null ? C18154x.i(c18154x.getValue()) : 0)) * 31;
        AbstractC18142l abstractC18142l = this.fontFamily;
        int iHashCode2 = (i11 + (abstractC18142l != null ? abstractC18142l.hashCode() : 0)) * 31;
        ...
        int iHashCode5 = (((iHashCode4 + (localeList != null ? localeList.hashCode() : 0)) * 31) + C5346q0.y(this.background)) * 31;
    ...
    private SpanStyle(F1.n nVar, long j10, FontWeight fontWeight, C18153w c18153w, C18154x c18154x, AbstractC18142l abstractC18142l, String str, long j11, F1.a aVar, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j12, F1.k kVar, Shadow b12, u1.k kVar2, X0.g gVar) {
        this.textForegroundStyle = nVar;
        this.fontSize = j10;
        this.fontWeight = fontWeight;
        this.fontStyle = c18153w;
        this.fontSynthesis = c18154x;
    ...
    public int hashCode() {
        ...
        int iHashCode8;
        int iHashCode9;
        int iY = C5346q0.y(g()) * 31;
        AbstractC5324i0 abstractC5324i0F = f();
        int iHashCode10 = 0;
        if (abstractC5324i0F != null) {
            iHashCode = abstractC5324i0F.hashCode();
        } else {
            iHashCode = 0;
        }
        ...
        C18154x c18154x = this.fontSynthesis;
        if (c18154x != null) {
            i10 = C18154x.i(c18154x.getValue());
        } else {
            i10 = 0;
        }
        int i13 = (i12 + i10) * 31;
        AbstractC18142l abstractC18142l = this.fontFamily;
        if (abstractC18142l != null) {
            iHashCode3 = abstractC18142l.hashCode();
        } else {
            iHashCode3 = 0;
        }
        ...
        int iY2 = (((i17 + iHashCode6) * 31) + C5346q0.y(this.background)) * 31;
        ...
        Shadow b12 = this.shadow;
        if (b12 != null) {
            iHashCode8 = b12.hashCode();
        } else {
            iHashCode8 = 0;
        }
    ...
    public /* synthetic */ SpanStyle(long j10, long j11, FontWeight fontWeight, C18153w c18153w, C18154x c18154x, AbstractC18142l abstractC18142l, String str, long j12, F1.a aVar, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j13, F1.k kVar, Shadow b12, u1.k kVar2, X0.g gVar, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        long j14 = (i10 & 1) != 0 ? C5346q0.INSTANCE.j() : j10;
        long jA = (i10 & 2) != 0 ? H1.v.INSTANCE.a() : j11;
        FontWeight fontWeight2 = (i10 & 4) != 0 ? null : fontWeight;
        C18153w c18153w2 = (i10 & 8) != 0 ? null : c18153w;
        C18154x c18154x2 = (i10 & 16) != 0 ? null : c18154x;
        AbstractC18142l abstractC18142l2 = (i10 & 32) != 0 ? null : abstractC18142l;
        ...
        long j15 = (i10 & RecyclerView.m.FLAG_MOVED) != 0 ? C5346q0.INSTANCE.j() : j13;
        ...
        F1.k kVar5 = kVar3;
        C18153w c18153w3 = c18153w2;
        C18154x c18154x3 = c18154x2;
        ...
        long j19 = j15;
        this(j16, j17, fontWeight3, c18153w3, c18154x3, abstractC18142l3, str3, j18, aVar3, textGeometricTransform3, localeList3, j19, kVar5, b13, kVar4, (i10 & 32768) != 0 ? null : gVar, (DefaultConstructorMarker) null);
    }

    private SpanStyle(long j10, long j11, FontWeight fontWeight, C18153w c18153w, C18154x c18154x, AbstractC18142l abstractC18142l, String str, long j12, F1.a aVar, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j13, F1.k kVar, Shadow b12, u1.k kVar2, X0.g gVar) {
        this(F1.n.INSTANCE.b(j10), j11, fontWeight, c18153w, c18154x, abstractC18142l, str, j12, aVar, textGeometricTransform, localeList, j13, kVar, b12, kVar2, gVar, (DefaultConstructorMarker) null);
    }
}
