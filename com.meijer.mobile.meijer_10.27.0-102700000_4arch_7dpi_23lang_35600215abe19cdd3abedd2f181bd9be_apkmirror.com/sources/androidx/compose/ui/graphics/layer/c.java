...
public final class c implements b {
    ...
    private static boolean f50829G;
    ...
    private static final AtomicBoolean f50830H = new AtomicBoolean(true);

    public c(View view, long j10, C5330k0 c5330k0, X0.a aVar) {
        this.ownerId = j10;
    ...
    public void E(long j10) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            i.f50931a.d(this.renderNode, C5349s0.j(j10));
        }
    }
    ...
    public void x(H1.d density, t layoutDirection, GraphicsLayer layer, Function1<? super X0.f, Unit> block) {
        ...
        try {
            ...
            c5330k0.getAndroidCanvas().A(canvasStart);
    ...
    public void z(long j10) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            i.f50931a.c(this.renderNode, C5349s0.j(j10));
        }
    }

    private final boolean R() {
        if (!a.e(getCompositingStrategy(), a.INSTANCE.c()) && C5306c0.E(getBlendMode(), C5306c0.INSTANCE.B()) && getColorFilter() == null) {
            return false;
        }
        return true;
    }
    ...
    public /* synthetic */ c(View view, long j10, C5330k0 c5330k0, X0.a aVar, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(view, j10, (i10 & 4) != 0 ? new C5330k0() : c5330k0, (i10 & 8) != 0 ? new X0.a() : aVar);
    }
}
