...
public final class GraphicsLayer implements FSComposeGraphicsLayer {
    ...
    private static final y f50782y;
    ...
    private AbstractC5337m1 internalOutline;
    ...
    private Function1<? super X0.f, Unit> drawBlock = c.f50807f;
    ...
    static final class c extends Lambda implements Function1<X0.f, Unit> {
        ...
        public static final c f50807f = new c();
    ...
    static {
        f50782y = f.INSTANCE.a() ? z.f39960a : Build.VERSION.SDK_INT >= 28 ? B.f39956a : G.f39959a.a() ? A.f39955a : z.f39960a;
    }
    ...
    private final void f0(Canvas androidCanvas) {
        ...
        C5347r0 c5347r0M = m();
        int iK = k();
        if (fJ < 1.0f || !C5306c0.E(iK, C5306c0.INSTANCE.B()) || c5347r0M != null || a.e(n(), a.INSTANCE.c())) {
    ...
    */
    ...
    public final void K(long j10) {
        if (C5346q0.s(j10, this.impl.getAmbientShadowColor())) {
            return;
        }
        this.impl.z(j10);
    }
    ...
    public final void b0(long j10) {
        if (C5346q0.s(j10, this.impl.getSpotShadowColor())) {
            return;
        }
        this.impl.E(j10);
    }
    ...
    */
    ...
    public final void h(androidx.compose.ui.graphics.Canvas canvas, GraphicsLayer parentLayer) {
        ...
        if (z13) {
            canvas.save();
            AbstractC5337m1 abstractC5337m1O = o();
            if (abstractC5337m1O instanceof AbstractC5337m1.b) {
                androidx.compose.ui.graphics.Canvas.r(canvas, abstractC5337m1O.getRect(), 0, 2, null);
            } else if (abstractC5337m1O instanceof AbstractC5337m1.c) {
                ...
                q1.p(q1VarA, ((AbstractC5337m1.c) abstractC5337m1O).getRoundRect(), null, 2, null);
                androidx.compose.ui.graphics.Canvas.j(canvas, q1VarA, 0, 2, null);
            } else if (abstractC5337m1O instanceof AbstractC5337m1.a) {
                androidx.compose.ui.graphics.Canvas.j(canvas, ((AbstractC5337m1.a) abstractC5337m1O).getPath(), 0, 2, null);
            }
        }
        if (parentLayer != null) {
            parentLayer.d(this);
    ...
    public final AbstractC5337m1 o() {
        AbstractC5337m1 bVar;
        AbstractC5337m1 abstractC5337m1 = this.internalOutline;
        q1 q1Var = this.outlinePath;
        if (abstractC5337m1 != null) {
            return abstractC5337m1;
        }
        if (q1Var != null) {
            AbstractC5337m1.a aVar = new AbstractC5337m1.a(q1Var);
        ...
        if (this.roundRectCornerRadius > 0.0f) {
            bVar = new AbstractC5337m1.c(U0.j.e(fIntBitsToFloat, fIntBitsToFloat2, fIntBitsToFloat3, fIntBitsToFloat4, U0.a.b((Float.floatToRawIntBits(r0) << 32) | (4294967295L & Float.floatToRawIntBits(r0)))));
        } else {
            bVar = new AbstractC5337m1.b(new Rect(fIntBitsToFloat, fIntBitsToFloat2, fIntBitsToFloat3, fIntBitsToFloat4));
        }
