...
public final class e implements b {
    ...
    private static final boolean f50890L = !G.f39959a.a();

    /* renamed from: M, reason: collision with root package name */
    private static final Canvas f50891M = new a();
    ...
    private final C5330k0 pictureCanvasHolder;
    ...
    public e(DrawChildContainer drawChildContainer, long j10, C5330k0 c5330k0, X0.a aVar) {
        this.layerContainer = drawChildContainer;
        this.ownerId = j10;
        this.canvasHolder = c5330k0;
        ViewLayer viewLayer = new ViewLayer(drawChildContainer, c5330k0, aVar);
        ...
        this.pictureCanvasHolder = z10 ? new C5330k0() : null;
    ...
    public void E(long j10) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            j.f50932a.c(this.viewLayer, C5349s0.j(j10));
        }
    }
    ...
    public void g(y1 y1Var) {
        if (Build.VERSION.SDK_INT >= 31) {
            k.f50933a.a(this.viewLayer, y1Var);
        }
    }
    ...
    public void x(H1.d density, t layoutDirection, GraphicsLayer layer, Function1<? super X0.f, Unit> block) {
        ...
        if (this.viewLayer.isAttachedToWindow()) {
            ...
            if (picture != null) {
                ...
                try {
                    C5330k0 c5330k02 = this.pictureCanvasHolder;
                    if (c5330k02 != null) {
                        Canvas internalCanvas = c5330k02.getAndroidCanvas().getInternalCanvas();
                        c5330k02.getAndroidCanvas().A(canvasBeginRecording);
                        androidx.compose.ui.graphics.a androidCanvas = c5330k02.getAndroidCanvas();
    ...
    public void z(long j10) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            j.f50932a.b(this.viewLayer, C5349s0.j(j10));
        }
    }
    ...
    public /* synthetic */ e(DrawChildContainer drawChildContainer, long j10, C5330k0 c5330k0, X0.a aVar, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(drawChildContainer, j10, (i10 & 4) != 0 ? new C5330k0() : c5330k0, (i10 & 8) != 0 ? new X0.a() : aVar);
    }
}
