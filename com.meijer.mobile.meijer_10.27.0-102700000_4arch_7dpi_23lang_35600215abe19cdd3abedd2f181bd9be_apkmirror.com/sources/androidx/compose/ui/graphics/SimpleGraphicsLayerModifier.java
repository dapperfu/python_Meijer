...
final class SimpleGraphicsLayerModifier extends Modifier.c implements D {
    ...
    static final class b extends Lambda implements Function1<f0.a, Unit> {
        ...
        final /* synthetic */ f0 f50772f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ SimpleGraphicsLayerModifier f50773g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(f0 f0Var, SimpleGraphicsLayerModifier simpleGraphicsLayerModifier) {
            super(1);
            this.f50772f = f0Var;
            this.f50773g = simpleGraphicsLayerModifier;
        }

        public final void a(f0.a aVar) {
            f0.a.v(aVar, this.f50772f, 0, 0, 0.0f, this.f50773g.layerBlock, 4, null);
        }
    ...
    public final void T2() {
        NodeCoordinator wrapped = C5815k.j(this, C5810f0.a(2)).getWrapped();
        if (wrapped != null) {
