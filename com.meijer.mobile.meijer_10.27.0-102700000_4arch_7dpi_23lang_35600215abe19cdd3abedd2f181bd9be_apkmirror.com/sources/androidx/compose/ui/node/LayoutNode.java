...
public final class LayoutNode implements InterfaceC5719g, androidx.compose.ui.layout.h0, OwnerScope, InterfaceC5798z, InterfaceC16702j, InterfaceC5811g, Owner.b, FSComposeDraw, FSComposeLayoutNode {

    /* renamed from: R, reason: collision with root package name and from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);

    /* renamed from: S, reason: collision with root package name */
    public static final int f51192S = 8;

    /* renamed from: T, reason: collision with root package name */
    private static final f f51193T = new c();

    /* renamed from: U, reason: collision with root package name */
    private static final Function0<LayoutNode> f51194U = a.f51240f;

    /* renamed from: V, reason: collision with root package name */
    private static final Q1 f51195V = new b();

    /* renamed from: W, reason: collision with root package name */
    private static final Comparator<LayoutNode> f51196W = new Comparator() { // from class: androidx.compose.ui.node.H
    ...
    private InterfaceC5742s compositionLocalMap;
    ...
    /* renamed from: l, reason: collision with root package name and from kotlin metadata */
    private final C5800a0<LayoutNode> _foldedChildren;
    ...
    static final class a extends Lambda implements Function0<LayoutNode> {
        ...
        public static final a f51240f = new a();
    ...
    public static final class Companion {
        ...
        public final Function0<LayoutNode> a() {
            return LayoutNode.f51194U;
        }

        public final Comparator<LayoutNode> b() {
            return LayoutNode.f51196W;
        }
    }
    ...
    public static final class e {
        ...
        public static final e f51241a = new e("Measuring", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final e f51242b = new e("LookaheadMeasuring", 1);

        /* renamed from: c, reason: collision with root package name */
        public static final e f51243c = new e("LayingOut", 2);

        /* renamed from: d, reason: collision with root package name */
        public static final e f51244d = new e("LookaheadLayingOut", 3);

        /* renamed from: e, reason: collision with root package name */
        public static final e f51245e = new e("Idle", 4);

        /* renamed from: f, reason: collision with root package name */
        private static final /* synthetic */ e[] f51246f;

        /* renamed from: g, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f51247g;

        private static final /* synthetic */ e[] a() {
            return new e[]{f51241a, f51242b, f51243c, f51244d, f51245e};
        }
        ...
        public static e[] values() {
            return (e[]) f51246f.clone();
        }

        static {
            e[] eVarArrA = a();
            f51246f = eVarArrA;
            f51247g = EnumEntriesKt.a(eVarArrA);
        }
    ...
    public static abstract class f implements MeasurePolicy {
        ...
        public Void a(InterfaceC5791s interfaceC5791s, List<? extends androidx.compose.ui.layout.r> list, int i10) {
            throw new IllegalStateException(this.error.toString());
        }

        public Void b(InterfaceC5791s interfaceC5791s, List<? extends androidx.compose.ui.layout.r> list, int i10) {
            throw new IllegalStateException(this.error.toString());
        }

        public Void c(InterfaceC5791s interfaceC5791s, List<? extends androidx.compose.ui.layout.r> list, int i10) {
            throw new IllegalStateException(this.error.toString());
        }

        public Void f(InterfaceC5791s interfaceC5791s, List<? extends androidx.compose.ui.layout.r> list, int i10) {
            throw new IllegalStateException(this.error.toString());
        }
        ...
        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int e(InterfaceC5791s interfaceC5791s, List list, int i10) {
            return ((Number) b(interfaceC5791s, list, i10)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int g(InterfaceC5791s interfaceC5791s, List list, int i10) {
            return ((Number) c(interfaceC5791s, list, i10)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int i(InterfaceC5791s interfaceC5791s, List list, int i10) {
            return ((Number) f(interfaceC5791s, list, i10)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int j(InterfaceC5791s interfaceC5791s, List list, int i10) {
            return ((Number) a(interfaceC5791s, list, i10)).intValue();
        }
    }
    ...
    public static final class g {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final g f51249a = new g("InMeasureBlock", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final g f51250b = new g("InLayoutBlock", 1);

        /* renamed from: c, reason: collision with root package name */
        public static final g f51251c = new g("NotUsed", 2);

        /* renamed from: d, reason: collision with root package name */
        private static final /* synthetic */ g[] f51252d;

        /* renamed from: e, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f51253e;

        private static final /* synthetic */ g[] a() {
            return new g[]{f51249a, f51250b, f51251c};
        }
        ...
        public static g[] values() {
            return (g[]) f51252d.clone();
        }

        static {
            g[] gVarArrA = a();
            f51252d = gVarArrA;
            f51253e = EnumEntriesKt.a(gVarArrA);
        }
    ...
    static final class j extends Lambda implements Function0<Unit> {
        ...
        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Ref.ObjectRef<SemanticsConfiguration> f51256g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        j(Ref.ObjectRef<SemanticsConfiguration> objectRef) {
            super(0);
            this.f51256g = objectRef;
        }
        ...
        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final void invoke2() {
            C5804c0 nodes = LayoutNode.this.getNodes();
            int iA = C5810f0.a(8);
            Ref.ObjectRef<SemanticsConfiguration> objectRef = this.f51256g;
            if ((nodes.i() & iA) != 0) {
                for (Modifier.c tail = nodes.getTail(); tail != null; tail = tail.getParent()) {
                    if ((tail.getKindSet() & iA) != 0) {
                        AbstractC5817m abstractC5817mH = tail;
                        D0.c cVar = null;
                        while (abstractC5817mH != 0) {
                            if (abstractC5817mH instanceof u0) {
                                u0 u0Var = (u0) abstractC5817mH;
                                if (u0Var.getIsClearingSemantics()) {
                                    ?? semanticsConfiguration = new SemanticsConfiguration();
                                    objectRef.f142835a = semanticsConfiguration;
                                    semanticsConfiguration.v(true);
                                }
                                if (u0Var.getMergeDescendants()) {
                                    objectRef.f142835a.w(true);
                                }
                                u0Var.T1(objectRef.f142835a);
                            } else if ((abstractC5817mH.getKindSet() & iA) != 0 && (abstractC5817mH instanceof AbstractC5817m)) {
                                Modifier.c cVarL2 = abstractC5817mH.getDelegate();
                                int i10 = 0;
    ...
    public final void i1(int index, int count) {
        if (!(count >= 0)) {
            C14832a.a("count (" + count + ") must be greater than 0");
        }
    ...
    public LayoutNode(boolean z10, int i10) {
        ...
        this.outerToInnerOffsetDirty = true;
        this._foldedChildren = new C5800a0<>(new D0.c(new LayoutNode[16], 0), new i());
        this._zSortedChildren = new D0.c<>(new LayoutNode[16], 0);
        this.zSortedChildrenInvalidated = true;
        this.measurePolicy = f51193T;
        this.density = L.f51190a;
        this.layoutDirection = H1.t.f12006a;
        this.viewConfiguration = f51195V;
        this.compositionLocalMap = InterfaceC5742s.INSTANCE.a();
        g gVar = g.f51251c;
        this.intrinsicsUsageByParent = gVar;
        this.previousIntrinsicsUsageByParent = gVar;
        this.nodes = new C5804c0(this);
    ...
    private final void applyModifier(Modifier modifier) {
        ...
        if (this.lookaheadRoot == null && this.nodes.p(C5810f0.a(512))) {
            C1(this);
        }
    }
    ...
    public static /* synthetic */ void v0(LayoutNode layoutNode, long j10, C5826w c5826w, int i10, boolean z10, int i11, Object obj) {
        if ((i11 & 4) != 0) {
            i10 = g1.O.INSTANCE.e();
        }
        int i12 = i10;
        ...
        layoutNode.u0(j10, c5826w, i12, z10);
    }

    private final void x() {
        this.previousIntrinsicsUsageByParent = this.intrinsicsUsageByParent;
        this.intrinsicsUsageByParent = g.f51251c;
        D0.c<LayoutNode> cVarT0 = t0();
        LayoutNode[] layoutNodeArr = cVarT0.content;
        int iO = cVarT0.getSize();
        for (int i10 = 0; i10 < iO; i10++) {
            LayoutNode layoutNode = layoutNodeArr[i10];
            if (layoutNode.intrinsicsUsageByParent == g.f51250b) {
                layoutNode.x();
            }
        }
    }

    public static /* synthetic */ void x0(LayoutNode layoutNode, long j10, C5826w c5826w, int i10, boolean z10, int i11, Object obj) {
        if ((i11 & 4) != 0) {
            i10 = g1.O.INSTANCE.d();
        }
        int i12 = i10;
        ...
        layoutNode.w0(j10, c5826w, i12, z10);
    }
    ...
    public final void A() {
        ...
        if (!P0.h.isSemanticAutofillEnabled && this.nodes.p(C5810f0.a(8))) {
            E0();
        }
        this.nodes.z();
    ...
    public final boolean D() {
        InterfaceC5801b interfaceC5801bP;
        AbstractC5799a abstractC5799aR;
        M m10 = this.layoutDelegate;
        return m10.c().r().k() || !((interfaceC5801bP = m10.p()) == null || (abstractC5799aR = interfaceC5801bP.r()) == null || !abstractC5799aR.k());
    }
    ...
    public InterfaceC5742s getCompositionLocalMap() {
    ...
    public final void L0() {
        if (this.intrinsicsUsageByParent == g.f51251c) {
            x();
        }
        T tA0 = a0();
        Intrinsics.g(tA0);
    ...
    @Override // androidx.compose.ui.node.InterfaceC5811g
    ...
    @Override // androidx.compose.ui.layout.InterfaceC5798z
    ...
    public void i(Q1 q12) {
        ...
        C5804c0 c5804c0 = this.nodes;
        int iA = C5810f0.a(16);
        if ((c5804c0.i() & iA) != 0) {
            for (Modifier.c head = c5804c0.getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & iA) != 0) {
                    AbstractC5817m abstractC5817mH = head;
                    D0.c cVar = null;
                    while (abstractC5817mH != 0) {
                        if (abstractC5817mH instanceof q0) {
                            ((q0) abstractC5817mH).V1();
                        } else if ((abstractC5817mH.getKindSet() & iA) != 0 && (abstractC5817mH instanceof AbstractC5817m)) {
                            Modifier.c cVarL2 = abstractC5817mH.getDelegate();
                            int i10 = 0;
                            abstractC5817mH = abstractC5817mH;
    ...
    public final void n1(boolean forceRequest, boolean scheduleMeasureAndLayout, boolean invalidateIntrinsics) {
        if (!(this.lookaheadRoot != null)) {
            C14832a.b("Lookahead measure cannot be requested on a node that is not a part of theLookaheadScope");
        }
        Owner owner = this.owner;
    ...
    @Override // androidx.compose.ui.node.InterfaceC5811g
    public void o(InterfaceC5742s interfaceC5742s) {
        this.compositionLocalMap = interfaceC5742s;
        a((H1.d) interfaceC5742s.a(C5892t0.g()));
        d((H1.t) interfaceC5742s.a(C5892t0.m()));
        i((Q1) interfaceC5742s.a(C5892t0.t()));
        C5804c0 c5804c0 = this.nodes;
        int iA = C5810f0.a(32768);
        if ((c5804c0.i() & iA) != 0) {
            for (Modifier.c head = c5804c0.getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & iA) != 0) {
                    AbstractC5817m abstractC5817mH = head;
                    D0.c cVar = null;
                    while (abstractC5817mH != 0) {
                        if (abstractC5817mH instanceof InterfaceC5812h) {
                            Modifier.c node = ((InterfaceC5812h) abstractC5817mH).getNode();
    ...
    public final D0.c<LayoutNode> s0() {
        if (this.zSortedChildrenInvalidated) {
            ...
            this._zSortedChildren.A(f51196W);
    ...
    public void setModifier(Modifier modifier) {
        if (!(!this.isVirtual || get_modifier() == Modifier.INSTANCE)) {
            C14832a.a("Modifiers are not supported on virtual LayoutNodes");
        }
        if (getIsDeactivated()) {
            C14832a.a("modifier is updated when deactivated");
        }
        if (!isAttached()) {
    ...
    */
    ...
    public final void w() {
        ...
        for (int i10 = 0; i10 < iO; i10++) {
            LayoutNode layoutNode = layoutNodeArr[i10];
            if (layoutNode.intrinsicsUsageByParent != g.f51251c) {
                layoutNode.w();
            }
        }
    }
    ...
    /* JADX WARN: Type inference failed for: r4v9 */
    public final void B() {
        if (X() == e.f51245e && !W() && !e0() && !getIsDeactivated() && f()) {
            C5804c0 c5804c0 = this.nodes;
            int iA = C5810f0.a(256);
            if ((c5804c0.i() & iA) != 0) {
                for (Modifier.c head = c5804c0.getHead(); head != null; head = head.getChild()) {
                    if ((head.getKindSet() & iA) != 0) {
                        AbstractC5817m abstractC5817mH = head;
                        D0.c cVar = null;
                        while (abstractC5817mH != 0) {
                            if (abstractC5817mH instanceof InterfaceC5825v) {
                                InterfaceC5825v interfaceC5825v = (InterfaceC5825v) abstractC5817mH;
                                interfaceC5825v.O(C5815k.j(interfaceC5825v, C5810f0.a(256)));
                            } else if ((abstractC5817mH.getKindSet() & iA) != 0 && (abstractC5817mH instanceof AbstractC5817m)) {
                                Modifier.c cVarL2 = abstractC5817mH.getDelegate();
                                int i10 = 0;
                                abstractC5817mH = abstractC5817mH;
    ...
    @Override // r1.InterfaceC16702j
    public InterfaceC16702j g() {
    ...
    public SemanticsConfiguration getSemanticsConfiguration() {
        if (isAttached() && !getIsDeactivated() && this.nodes.p(C5810f0.a(8))) {
        ...
        if (zI || (cVarN2 = cVarN2.getParent()) != null) {
            for (Modifier.c cVarT2 = nodeCoordinatorP.T2(zI); cVarT2 != null && (cVarT2.getAggregateChildKindSet() & iA) != 0; cVarT2 = cVarT2.getChild()) {
                if ((cVarT2.getKindSet() & iA) != 0) {
                    AbstractC5817m abstractC5817mH = cVarT2;
                    D0.c cVar = null;
                    while (abstractC5817mH != 0) {
                        if (abstractC5817mH instanceof C) {
                            ((C) abstractC5817mH).s(P());
                        } else if ((abstractC5817mH.getKindSet() & iA) != 0 && (abstractC5817mH instanceof AbstractC5817m)) {
                            Modifier.c cVarL2 = abstractC5817mH.getDelegate();
                            int i10 = 0;
                            abstractC5817mH = abstractC5817mH;
    ...
    public void l() {
        if (!isAttached()) {
            C14832a.a("onReuse is only expected on attached node");
        }
        if (!P0.h.isRemoveFocusedViewFixEnabled) {
            AndroidViewHolder androidViewHolder = this.interopViewFactoryHolder;
            if (androidViewHolder != null) {
    ...
    @Override // r1.InterfaceC16702j
    public List<InterfaceC16702j> m() {
        return I();
    }
    ...
    public final void u0(long pointerPosition, C5826w hitTestResult, int pointerType, boolean isInLayer) {
    ...
    public final void w0(long pointerPosition, C5826w hitSemanticsEntities, int pointerType, boolean isInLayer) {
    ...
    public /* synthetic */ LayoutNode(boolean z10, int i10, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this((i11 & 1) != 0 ? false : z10, (i11 & 2) != 0 ? C16705m.b() : i10);
    }
}
