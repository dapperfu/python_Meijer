...
public final class T extends androidx.compose.ui.layout.f0 implements androidx.compose.ui.layout.I, InterfaceC5801b, Z {
    ...
    private a _placedState = a.f51400c;

    /* renamed from: t, reason: collision with root package name and from kotlin metadata */
    private final AbstractC5799a alignmentLines = new P(this);
    ...
    private static final class a {
        ...
        public static final a f51398a = new a("IsPlacedInLookahead", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final a f51399b = new a("IsPlacedInApproach", 1);

        /* renamed from: c, reason: collision with root package name */
        public static final a f51400c = new a("IsNotPlaced", 2);

        /* renamed from: d, reason: collision with root package name */
        private static final /* synthetic */ a[] f51401d;

        /* renamed from: e, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f51402e;

        private static final /* synthetic */ a[] a() {
            return new a[]{f51398a, f51399b, f51400c};
        }
        ...
        public static a[] values() {
            return (a[]) f51401d.clone();
        }

        static {
            a[] aVarArrA = a();
            f51401d = aVarArrA;
            f51402e = EnumEntriesKt.a(aVarArrA);
        }
    ...
    public /* synthetic */ class b {
        ...
        static {
            ...
            try {
                iArr[LayoutNode.e.f51241a.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[LayoutNode.e.f51243c.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[LayoutNode.e.f51244d.ordinal()] = 4;
    ...
    static final class c extends Lambda implements Function0<Unit> {
        ...
        static final class a extends Lambda implements Function1<InterfaceC5801b, Unit> {
            ...
            public static final a f51405f = new a();
        ...
        @Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0001\u001a\u00020\u0000H\n¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"Landroidx/compose/ui/node/b;", "child", "", "a", "(Landroidx/compose/ui/node/b;)V"}, k = 3, mv = {1, 9, 0})
        static final class b extends Lambda implements Function1<InterfaceC5801b, Unit> {
    ...
    static final class d extends Lambda implements Function0<Unit> {
        ...
        public final void invoke2() {
            ...
            lookaheadDelegate.k0(this.f51408g);
        }
    }
    ...
    static final class e extends Lambda implements Function0<Unit> {
        ...
        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Owner f51410g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ long f51411h;
        ...
        public final void invoke2() {
            ...
            if (placementScope == null) {
                placementScope = this.f51410g.getPlacementScope();
            }
            T t10 = T.this;
    ...
    static final class f extends Lambda implements Function1<InterfaceC5801b, Unit> {

        /* renamed from: f, reason: collision with root package name */
        public static final f f51412f = new f();
    ...
    public final void i2() {
        ...
        if ((this._placedState != a.f51398a && !s1()) || (this._placedState != a.f51399b && s1())) {
            Y1();
        ...
        if (parent$ui_release == null) {
            this.placeOrder = 0;
        } else if (!this.relayoutWithoutParentInProgress && (parent$ui_release.X() == LayoutNode.e.f51243c || parent$ui_release.X() == LayoutNode.e.f51244d)) {
    ...
    public final void m2() {
        ...
        try {
            ...
            if (!this.placedOnce) {
                C14832a.b("replace() called on item that was not placed");
            }
    ...
    private final void Y1() {
        ...
        if (s1()) {
            this._placedState = a.f51399b;
        } else {
            this._placedState = a.f51398a;
        }
        if (aVar != a.f51398a && this.layoutNodeLayoutDelegate.getLookaheadMeasurePending()) {
    ...
    public final void q1() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (tV.measuredByParent == LayoutNode.g.f51250b) {
                tV.measuredByParent = LayoutNode.g.f51251c;
            }
        }
    }
    ...
    public boolean getIsPlaced() {
        return this._placedState != a.f51400c;
    }

    public final void j2(long constraints) {
        q2(LayoutNode.e.f51242b);
        r2(false);
    ...
    private final void e2() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            LayoutNode layoutNode = layoutNodeArr[i10];
            if (layoutNode.Z() && layoutNode.h0() == LayoutNode.g.f51249a) {
    ...
    private final void k2(long position, float zIndex, Function1<? super androidx.compose.ui.graphics.e, Unit> layerBlock, GraphicsLayer layer) {
        ...
        LayoutNode.e eVar = LayoutNode.e.f51244d;
        if (eVarX == eVar) {
    ...
    public final boolean E1() {
        ...
        if (this._placedState == a.f51400c && !this.layoutNodeLayoutDelegate.getDetachedFromParentLookaheadPass()) {
    ...
    */
    public androidx.compose.ui.layout.f0 k0(long r4) {
        ...
        L10:
            r0 = r1
        L11:
            androidx.compose.ui.node.LayoutNode$e r2 = androidx.compose.ui.node.LayoutNode.e.f51242b
            if (r0 == r2) goto L27
            androidx.compose.ui.node.LayoutNode r0 = r3.S1()
            androidx.compose.ui.node.LayoutNode r0 = r0.getParent$ui_release()
            if (r0 == 0) goto L23
        ...
        L23:
            androidx.compose.ui.node.LayoutNode$e r0 = androidx.compose.ui.node.LayoutNode.e.f51244d
            if (r1 != r0) goto L2d
        L27:
        ...
        L2d:
            ...
            androidx.compose.ui.node.LayoutNode$g r1 = androidx.compose.ui.node.LayoutNode.g.f51251c
            if (r0 != r1) goto L47
            androidx.compose.ui.node.LayoutNode r0 = r3.S1()
            r0.w()
        L47:
    ...
    public int l0(AbstractC5774a alignmentLine) {
        ...
        if (eVarX == LayoutNode.e.f51242b) {
            ...
            if (eVarX2 == LayoutNode.e.f51244d) {
    ...
    public final boolean l2(long constraints) {
        ...
        if (!z11) {
            C14832a.b("Lookahead result from lookaheadRemeasure cannot be null");
        }
    ...
    public void o0(Function1<? super InterfaceC5801b, Unit> block) {
        ...
        int size = cVarT0.getSize();
        for (int i10 = 0; i10 < size; i10++) {
            InterfaceC5801b interfaceC5801bP = layoutNodeArr[i10].getLayoutDelegate().p();
            Intrinsics.g(interfaceC5801bP);
            block.invoke(interfaceC5801bP);
        }
    }
