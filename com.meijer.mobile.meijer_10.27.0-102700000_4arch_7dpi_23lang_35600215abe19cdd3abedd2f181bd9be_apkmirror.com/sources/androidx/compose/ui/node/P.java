...
public final class P extends AbstractC5799a {
    public P(InterfaceC5801b interfaceC5801b) {
        super(interfaceC5801b, null);
    }

    @Override // androidx.compose.ui.node.AbstractC5799a
    ...
    @Override // androidx.compose.ui.node.AbstractC5799a
    protected Map<AbstractC5774a, Integer> e(NodeCoordinator nodeCoordinator) {
        S lookaheadDelegate = nodeCoordinator.getLookaheadDelegate();
        Intrinsics.g(lookaheadDelegate);
    ...
    @Override // androidx.compose.ui.node.AbstractC5799a
    protected int i(NodeCoordinator nodeCoordinator, AbstractC5774a abstractC5774a) {
        S lookaheadDelegate = nodeCoordinator.getLookaheadDelegate();
        Intrinsics.g(lookaheadDelegate);
        return lookaheadDelegate.l0(abstractC5774a);
    }
}
