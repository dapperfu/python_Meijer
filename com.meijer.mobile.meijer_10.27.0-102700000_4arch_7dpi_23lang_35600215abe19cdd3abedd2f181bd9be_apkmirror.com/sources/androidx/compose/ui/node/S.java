...
public abstract class S extends Q implements androidx.compose.ui.layout.I {
    ...
    private Map<AbstractC5774a, Integer> oldAlignmentLines;
    ...
    private final Z.S<AbstractC5774a> cachedAlignmentLinesMap = Z.b0.b();
    ...
    @Override // androidx.compose.ui.node.Q, androidx.compose.ui.layout.InterfaceC5791s
    public boolean v0() {
        return true;
    }
    ...
    public final void q2(androidx.compose.ui.layout.J j10) {
        Unit unit;
        Map<AbstractC5774a, Integer> map;
        if (j10 != null) {
            Z0(H1.r.c((j10.getF50998b() & 4294967295L) | (j10.getF50997a() << 32)));
            unit = Unit.f142422a;
        } else {
            unit = null;
        }
    ...
    public InterfaceC5801b c2() {
        InterfaceC5801b interfaceC5801bP = this.coordinator.getLayoutNode().getLayoutDelegate().p();
        Intrinsics.g(interfaceC5801bP);
        return interfaceC5801bP;
    }

    public final int e2(AbstractC5774a alignmentLine) {
        return this.cachedAlignmentLinesMap.e(alignmentLine, Integer.MIN_VALUE);
    }

    protected final Z.S<AbstractC5774a> g2() {
    ...
    public androidx.compose.ui.layout.J s1() {
        ...
        C14832a.c("LookaheadDelegate has not been measured yet when measureResult is requested.");
