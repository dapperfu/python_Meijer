...
import androidx.compose.ui.platform.InterfaceC5852f1;
...
public interface Owner extends g1.P {
    ...
    public static final Companion INSTANCE = Companion.f51331a;
    ...
    public static final class Companion {
        ...
        static final /* synthetic */ Companion f51331a = new Companion();
    ...
    InterfaceC5856h getAccessibilityManager();

    InterfaceC5057l getAutofill();

    Q0.H getAutofillManager();

    Q0.J getAutofillTree();

    InterfaceC5884q0 getClipboard();

    InterfaceC5886r0 getClipboardManager();
    ...
    AbstractC18142l.b getFontFamilyResolver();

    InterfaceC18141k.b getFontLoader();

    InterfaceC5310d1 getGraphicsContext();

    InterfaceC6344a getHapticFeedBack();

    InterfaceC13460b getInputModeManager();
    ...
    Object w(Function2<? super InterfaceC5852f1, ? super Continuation<?>, ? extends Object> function2, Continuation<?> continuation);
