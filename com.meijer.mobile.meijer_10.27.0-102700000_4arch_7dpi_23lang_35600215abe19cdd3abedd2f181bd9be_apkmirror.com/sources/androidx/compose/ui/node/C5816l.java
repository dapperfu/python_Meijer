...
public final class C5816l {
    public static final View a(InterfaceC5814j interfaceC5814j) {
        if (!interfaceC5814j.getNode().getIsAttached()) {
            C14832a.b("Cannot get View because the Modifier node is not currently attached.");
        }
        Object objB = L.b(C5815k.o(interfaceC5814j));
