...
import androidx.compose.ui.focus.InterfaceC5765h;
...
public final class C5803c extends Modifier.c implements D, InterfaceC5823t, u0, q0, k1.h, k1.k, n0, C, InterfaceC5825v, InterfaceC5766i, androidx.compose.ui.focus.w, androidx.compose.ui.focus.B, OwnerScope, T0.b {
    ...
    private C15087a _providedValues;
    ...
    public static final class b implements Owner.b {
        ...
        public void j() {
            if (C5803c.this.lastOnPlacedCoordinates == null) {
                C5803c c5803c = C5803c.this;
                c5803c.s(C5815k.j(c5803c, C5810f0.a(128)));
            }
        }
    }
    ...
    static final class C1055c extends Lambda implements Function0<Unit> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Modifier.b f51487f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ C5803c f51488g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C1055c(Modifier.b bVar, C5803c c5803c) {
            super(0);
            this.f51487f = bVar;
            this.f51488g = c5803c;
        }
        ...
        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final void invoke2() {
            ((T0.g) this.f51487f).h(this.f51488g);
        }
    }
    ...
    private final void R2() {
        ...
        if (bVar instanceof T0.g) {
            C5815k.p(this).getSnapshotObserver().observeReads$ui_release(this, C5805d.f51505b, new C1055c(bVar, this));
        }
        this.invalidateCache = false;
    }

    private final void T2(k1.j<?> element) {
        C15087a c15087a = this._providedValues;
        if (c15087a != null && c15087a.a(element.getKey())) {
            c15087a.c(element);
            C5815k.p(this).getModifierLocalManager().f(this, element.getKey());
        } else {
            this._providedValues = new C15087a(element);
            if (C5805d.e(this)) {
                C5815k.p(this).getModifierLocalManager().a(this, element.getKey());
            }
        }
    }
    ...
    public int F(InterfaceC5791s interfaceC5791s, androidx.compose.ui.layout.r rVar, int i10) {
        ...
        return ((androidx.compose.ui.layout.B) bVar).F(interfaceC5791s, rVar, i10);
    }
    ...
    public int J(InterfaceC5791s interfaceC5791s, androidx.compose.ui.layout.r rVar, int i10) {
        Modifier.b bVar = this.element;
        Intrinsics.h(bVar, "null cannot be cast to non-null type androidx.compose.ui.layout.LayoutModifier");
        return ((androidx.compose.ui.layout.B) bVar).J(interfaceC5791s, rVar, i10);
    }
    ...
    public int N(InterfaceC5791s interfaceC5791s, androidx.compose.ui.layout.r rVar, int i10) {
        Modifier.b bVar = this.element;
        Intrinsics.h(bVar, "null cannot be cast to non-null type androidx.compose.ui.layout.LayoutModifier");
        return ((androidx.compose.ui.layout.B) bVar).N(interfaceC5791s, rVar, i10);
    }
    ...
    public void U(androidx.compose.ui.focus.E focusState) {
        Modifier.b bVar = this.element;
        if (!(bVar instanceof InterfaceC5765h)) {
            C14832a.b("onFocusEvent called on wrong node");
        }
        ((InterfaceC5765h) bVar).U(focusState);
    }
    ...
    @Override // T0.b
    public long b() {
        return H1.s.d(C5815k.j(this, C5810f0.a(128)).c());
    }
    ...
    public void j1(androidx.compose.ui.focus.u focusProperties) {
        ...
        if (!(bVar instanceof androidx.compose.ui.focus.r)) {
            C14832a.b("applyFocusProperties called on wrong node");
        }
        ((androidx.compose.ui.focus.r) bVar).t(new androidx.compose.ui.focus.q(focusProperties));
    }
                ...
                while (parent != null) {
                    if ((parent.getKindSet() & iA) != 0) {
                        ...
                        while (abstractC5817mH != 0) {
                            if (abstractC5817mH instanceof k1.h) {
                                k1.h hVar = (k1.h) abstractC5817mH;
                                if (hVar.t0().a(cVar)) {
    ...
    public int r(InterfaceC5791s interfaceC5791s, androidx.compose.ui.layout.r rVar, int i10) {
        Modifier.b bVar = this.element;
        Intrinsics.h(bVar, "null cannot be cast to non-null type androidx.compose.ui.layout.LayoutModifier");
        return ((androidx.compose.ui.layout.B) bVar).r(interfaceC5791s, rVar, i10);
    }
    ...
    public k1.g t0() {
        C15087a c15087a = this._providedValues;
        return c15087a != null ? c15087a : k1.i.a();
    }
    ...
    private final void N2(boolean duringAttach) {
        if (!getIsAttached()) {
            C14832a.b("initializeModifier called on unattached node");
        }
        Modifier.b bVar = this.element;
        if ((C5810f0.a(32) & getKindSet()) != 0) {
        ...
        if (bVar instanceof androidx.compose.ui.layout.i0) {
            ((androidx.compose.ui.layout.i0) bVar).m(C5815k.o(this));
        }
        if ((C5810f0.a(128) & getKindSet()) != 0) {
            if ((bVar instanceof androidx.compose.ui.layout.Y) && C5805d.e(this)) {
                C5815k.o(this).B0();
            }
            if (bVar instanceof androidx.compose.ui.layout.V) {
                this.lastOnPlacedCoordinates = null;
                if (C5805d.e(this)) {
                    C5815k.p(this).t(new b());
                }
            }
        }
        if ((C5810f0.a(256) & getKindSet()) != 0 && (bVar instanceof androidx.compose.ui.layout.S) && C5805d.e(this)) {
            C5815k.o(this).B0();
        }
        if (bVar instanceof androidx.compose.ui.focus.z) {
            ((androidx.compose.ui.focus.z) bVar).j().e().c(this);
        }
        if ((C5810f0.a(16) & getKindSet()) != 0 && (bVar instanceof g1.I)) {
            ((g1.I) bVar).getPointerInputFilter().f(getCoordinator());
        }
        if ((C5810f0.a(8) & getKindSet()) != 0) {
            C5815k.p(this).E();
        }
    }
    ...
    private final void Q2() {
        if (!getIsAttached()) {
            C14832a.b("unInitializeModifier called on unattached node");
        }
        Modifier.b bVar = this.element;
        if ((C5810f0.a(32) & getKindSet()) != 0) {
            if (bVar instanceof k1.j) {
                C5815k.p(this).getModifierLocalManager().d(this, ((k1.j) bVar).getKey());
            }
            if (bVar instanceof k1.d) {
                ((k1.d) bVar).l(C5805d.f51504a);
            }
        }
        if ((C5810f0.a(8) & getKindSet()) != 0) {
            C5815k.p(this).E();
    ...
    public final void S2() {
        if (getIsAttached()) {
            ...
            C5815k.p(this).getSnapshotObserver().observeReads$ui_release(this, C5805d.f51506c, new d());
        }
    }
    ...
    public H1.d getDensity() {
        return C5815k.o(this).getDensity();
    }

    @Override // T0.b
    public H1.t getLayoutDirection() {
        return C5815k.o(this).getLayoutDirection();
    }
