...
public final class C5804c0 {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final LayoutNode layoutNode;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final C5828y innerCoordinator;
    ...
    private final class a implements InterfaceC5821q {
        ...
        @Override // androidx.compose.ui.node.InterfaceC5821q
        public boolean a(int oldIndex, int newIndex) {
            D0.c<Modifier.b> cVar = this.before;
            int i10 = this.offset;
            return C5806d0.d(cVar.content[oldIndex + i10], this.after.content[i10 + newIndex]) != 0;
        }

        @Override // androidx.compose.ui.node.InterfaceC5821q
        public void b(int newIndex) {
            int i10 = this.offset + newIndex;
            this.node = C5804c0.this.g(this.after.content[i10], this.node);
            C5804c0.d(C5804c0.this);
            ...
            D d10 = C5815k.d(this.node);
            if (d10 != null) {
                E e10 = new E(C5804c0.this.getLayoutNode(), d10);
                this.node.J2(e10);
                C5804c0.this.v(this.node, e10);
        ...
        public void c(int oldIndex, int newIndex) {
            ...
            if (Intrinsics.e(bVar, bVar2)) {
                ...
                C5804c0.this.F(bVar, bVar2, this.node);
                C5804c0.d(C5804c0.this);
            }
        }
        ...
        public void remove(int atIndex, int oldIndex) {
            ...
            Intrinsics.g(child);
            C5804c0.d(C5804c0.this);
            if ((C5810f0.a(2) & child.getKindSet()) != 0) {
                NodeCoordinator coordinator = child.getCoordinator();
                Intrinsics.g(coordinator);
                ...
                C5804c0.this.v(this.node, nodeCoordinatorO2);
            }
            this.node = C5804c0.this.h(child);
        }
    }
    ...
    private final void A(int offset, D0.c<Modifier.b> before, D0.c<Modifier.b> after, Modifier.c tail, boolean shouldAttachOnInsert) {
        C5802b0.e(before.getSize() - offset, after.getSize() - offset, j(tail, offset, before, after, shouldAttachOnInsert));
        B();
    }

    private final void B() {
        int kindSet = 0;
        for (Modifier.c parent = this.tail.getParent(); parent != null && parent != C5806d0.f51509a; parent = parent.getParent()) {
    ...
    public final void F(Modifier.b prev, Modifier.b next, Modifier.c node) {
        ...
        if (!(node instanceof C5803c)) {
            C14832a.b("Unknown Modifier.Node type");
            return;
        }
        ((C5803c) node).P2(next);
        if (node.getIsAttached()) {
    ...
    public final Modifier.c g(Modifier.b element, Modifier.c parent) {
        ...
        if (element instanceof Y) {
            c5803c = ((Y) element).b();
            c5803c.E2(g0.h(c5803c));
        } else {
            c5803c = new C5803c(element);
        }
        if (c5803c.getIsAttached()) {
            C14832a.b("A ModifierNodeElement cannot return an already attached node from create() ");
        }
        c5803c.D2(true);
        return q(c5803c, parent);
    }
    ...
    private final Modifier.c u() {
        if (!(this.head != C5806d0.f51509a)) {
            C14832a.b("padChain called on already padded chain");
        }
        Modifier.c cVar = this.head;
        cVar.G2(C5806d0.f51509a);
        C5806d0.f51509a.B2(cVar);
        return C5806d0.f51509a;
    }
    ...
    public final C5828y getInnerCoordinator() {
    ...
    public final void y() {
        ...
        C5828y c5828y = this.innerCoordinator;
        while (nodeCoordinatorO2 != c5828y) {
    ...
    public C5804c0(LayoutNode layoutNode) {
        this.layoutNode = layoutNode;
        C5828y c5828y = new C5828y(layoutNode);
        this.innerCoordinator = c5828y;
        this.outerCoordinator = c5828y;
        x0 x0VarM3 = c5828y.N2();
        this.tail = x0VarM3;
        this.head = x0VarM3;
    }
    ...
    private final Modifier.c D(Modifier.c paddedHead) {
        boolean z10;
        boolean z11 = false;
        if (paddedHead == C5806d0.f51509a) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (!z10) {
            C14832a.b("trimChain called on already trimmed chain");
        }
        Modifier.c child = C5806d0.f51509a.getChild();
        if (child == null) {
            child = this.tail;
        }
        child.G2(null);
        C5806d0.f51509a.B2(null);
        C5806d0.f51509a.z2(-1);
        C5806d0.f51509a.J2(null);
        if (child != C5806d0.f51509a) {
            z11 = true;
        }
        if (!z11) {
            C14832a.b("trimChain did not update the head");
        }
        return child;
    }

    public static final /* synthetic */ b d(C5804c0 c5804c0) {
        c5804c0.getClass();
        return null;
    }
    ...
    public final void v(Modifier.c start, NodeCoordinator coordinator) {
        ...
        for (Modifier.c parent = start.getParent(); parent != null; parent = parent.getParent()) {
            ...
            if ((C5810f0.a(2) & parent.getKindSet()) != 0) {
                return;
            }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:30:0x0078, code lost:
        ...
        j1.C14832a.c("structuralUpdate requires a non-null tail");
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:32:0x0084, code lost:
        ...
        j1.C14832a.c("expected prior modifier list to be non-empty");
     */
    ...
    */
    public final void E(androidx.compose.ui.Modifier r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.C5804c0.E(androidx.compose.ui.Modifier):void");
    }
    ...
    public final boolean r() {
        if (C5806d0.f51509a.getChild() != null) {
            return true;
        }
        return false;
    }
