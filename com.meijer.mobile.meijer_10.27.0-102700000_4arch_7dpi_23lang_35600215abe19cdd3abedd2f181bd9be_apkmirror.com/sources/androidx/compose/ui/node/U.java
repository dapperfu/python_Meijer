...
public final class U {
    ...
    private final C5820p relayoutNodes;
    ...
    public /* synthetic */ class b {
        ...
        static {
            ...
            try {
                iArr[LayoutNode.e.f51244d.ordinal()] = 3;
    ...
    private final boolean f(LayoutNode layoutNode, H1.b constraints) {
        ...
        if (zF1 && parent$ui_release != null) {
            if (layoutNode.g0() == LayoutNode.g.f51249a) {
                LayoutNode.s1(parent$ui_release, false, false, false, 3, null);
                return zF1;
            }
            if (layoutNode.g0() == LayoutNode.g.f51250b) {
    ...
    public final void K(long constraints) {
        ...
        if (this.duringMeasureLayout) {
            C14832a.a("updateRootConstraints called while measuring");
        }
        ...
        this.root.P0();
        C5820p c5820p = this.relayoutNodes;
        LayoutNode layoutNode = this.root;
        c5820p.c(layoutNode, layoutNode.getLookaheadRoot() != null);
    }
    ...
    public final void i(LayoutNode layoutNode, boolean affectsLookahead) {
        if (!this.duringMeasureLayout) {
            C14832a.b("forceMeasureTheSubtree should be executed during the measureAndLayout pass");
        }
        if (w(layoutNode, affectsLookahead)) {
            C14832a.a("node not yet measured");
        }
    ...
    public final long s() {
        if (!this.duringMeasureLayout) {
            C14832a.a("measureIteration should be only used during the measure/layout pass");
        }
    ...
    public final boolean t(Function0<Unit> onLayout) throws Throwable {
        ...
        if (!this.root.isAttached()) {
            C14832a.a("performMeasureAndLayout called with unattached root");
        }
        if (!this.root.f()) {
            C14832a.a("performMeasureAndLayout called with unplaced root");
        }
        if (this.duringMeasureLayout) {
            C14832a.a("performMeasureAndLayout called during measure layout");
        }
        boolean z11 = false;
        if (this.rootConstraints != null) {
            ...
            try {
                if (this.relayoutNodes.h()) {
                    ...
                    z10 = false;
                    while (c5820p.h()) {
                        boolean zC = c5820p.lookaheadSet.c();
                        boolean z12 = !zC;
                        if (zC) {
                            layoutNodeD = c5820p.set.d();
                        } else {
                            try {
                                layoutNodeD = c5820p.lookaheadSet.d();
                            } catch (Throwable th3) {
                                th2 = th3;
                                u10 = this;
    ...
    public U(LayoutNode layoutNode) {
        ...
        C5820p c5820p = new C5820p(companion.a());
        this.relayoutNodes = c5820p;
        ...
        if (companion.a()) {
            o10 = new O(layoutNode, c5820p, cVar.i());
        } else {
            o10 = null;
        }
    ...
    private final boolean e(LayoutNode layoutNode, H1.b constraints) {
        ...
        if (zK0 && parent$ui_release != null) {
            ...
            if (layoutNode.h0() == LayoutNode.g.f51249a) {
                LayoutNode.o1(parent$ui_release, false, false, false, 3, null);
                return zK0;
            }
            if (layoutNode.h0() == LayoutNode.g.f51250b) {
    ...
    private final boolean p(LayoutNode layoutNode) {
        if (layoutNode.g0() != LayoutNode.g.f51249a && !layoutNode.getLayoutDelegate().c().getAlignmentLines().k()) {
            return false;
        }
        return true;
    }
    ...
    private final boolean q(LayoutNode layoutNode) {
        ...
        if (layoutNode.h0() == LayoutNode.g.f51249a || ((interfaceC5801bP = layoutNode.getLayoutDelegate().p()) != null && (abstractC5799aR = interfaceC5801bP.getAlignmentLines()) != null && abstractC5799aR.k())) {
            return true;
        }
        return false;
    }
    ...
    public final boolean F(LayoutNode layoutNode, boolean forced) {
        ...
        if (!z10) {
            C14832a.b("Error: requestLookaheadRemeasure cannot be called on a node outside LookaheadScope");
        }
        int i10 = b.$EnumSwitchMapping$0[layoutNode.X().ordinal()];
        if (i10 != 1) {
    ...
    public final void u(LayoutNode layoutNode, long constraints) {
        ...
        if (Intrinsics.e(layoutNode, this.root)) {
            C14832a.a("measureAndLayout called on root");
        }
        if (!this.root.isAttached()) {
            C14832a.a("performMeasureAndLayout called with unattached root");
        }
