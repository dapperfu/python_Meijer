...
import androidx.compose.ui.focus.C5767j;
...
public final class g0 {
    ...
    private static final Z.S<Object> f51532a = Z.b0.b();
    ...
    public static final int f(Modifier.b bVar) {
        ...
        if (bVar instanceof InterfaceC5765h) {
            iA |= C5810f0.a(RecyclerView.m.FLAG_APPEARED_IN_PRE_LAYOUT);
        }
        if (bVar instanceof androidx.compose.ui.focus.r) {
            iA |= C5810f0.a(RecyclerView.m.FLAG_MOVED);
        }
        ...
        return bVar instanceof InterfaceC15991a ? C5810f0.a(524288) | iA : iA;
    }
    ...
    public static final void b(Modifier.c cVar, int i10, int i11) {
        ...
        AbstractC5817m abstractC5817m = (AbstractC5817m) cVar;
        c(cVar, abstractC5817m.getSelfKindSet() & i10, i11);
        int i12 = (~abstractC5817m.getSelfKindSet()) & i10;
        for (Modifier.c cVarL2 = abstractC5817m.getDelegate(); cVarL2 != null; cVarL2 = cVarL2.getChild()) {
            b(cVarL2, i12, i11);
        }
    }
    ...
    private static final void c(Modifier.c cVar, int i10, int i11) {
        if (i11 != 0 || cVar.getShouldAutoInvalidate()) {
            if ((C5810f0.a(2) & i10) != 0 && (cVar instanceof D)) {
                G.b((D) cVar);
                if (i11 == 2) {
                    C5815k.j(cVar, C5810f0.a(2)).k3();
                }
            }
            if ((C5810f0.a(128) & i10) != 0 && (cVar instanceof C) && i11 != 2) {
                C5815k.o(cVar).B0();
            }
            if ((C5810f0.a(256) & i10) != 0 && (cVar instanceof InterfaceC5825v) && i11 != 2) {
                C5815k.o(cVar).C0();
            }
            if ((C5810f0.a(4) & i10) != 0 && (cVar instanceof InterfaceC5823t)) {
                C5824u.a((InterfaceC5823t) cVar);
            }
            if ((C5810f0.a(8) & i10) != 0 && (cVar instanceof u0)) {
                C5815k.o(cVar).K1(true);
            }
            if ((C5810f0.a(64) & i10) != 0 && (cVar instanceof n0)) {
                o0.a((n0) cVar);
            }
            if ((C5810f0.a(RecyclerView.m.FLAG_MOVED) & i10) != 0 && (cVar instanceof androidx.compose.ui.focus.w)) {
            ...
            if ((i10 & C5810f0.a(RecyclerView.m.FLAG_APPEARED_IN_PRE_LAYOUT)) == 0 || !(cVar instanceof InterfaceC5766i)) {
                return;
            }
            C5767j.b((InterfaceC5766i) cVar);
        }
    }
    ...
    public static final int h(Modifier.c cVar) {
        ...
        AbstractC5817m abstractC5817m = (AbstractC5817m) cVar;
        int iM2 = abstractC5817m.getSelfKindSet();
        for (Modifier.c cVarL2 = abstractC5817m.getDelegate(); cVarL2 != null; cVarL2 = cVarL2.getChild()) {
            iM2 |= h(cVarL2);
        }
        return iM2;
                    ...
                    if ((cVarH.getKindSet() & iA) != 0) {
                        ...
                        while (cVarH != null) {
                            if (cVarH instanceof FocusTargetNode) {
                                ...
                                int i10 = 0;
                                for (Modifier.c cVarL2 = ((AbstractC5817m) cVarH).getDelegate(); cVarL2 != null; cVarL2 = cVarL2.getChild()) {
    ...
    public static final void a(Modifier.c cVar) {
        if (!cVar.getIsAttached()) {
            C14832a.b("autoInvalidateInsertedNode called on unattached node");
        }
        b(cVar, -1, 1);
    }
    ...
    public static final void d(Modifier.c cVar) {
        if (!cVar.getIsAttached()) {
            C14832a.b("autoInvalidateRemovedNode called on unattached node");
        }
        b(cVar, -1, 2);
    }
    ...
    public static final void e(Modifier.c cVar) {
        if (!cVar.getIsAttached()) {
            C14832a.b("autoInvalidateUpdatedNode called on unattached node");
        }
        b(cVar, -1, 0);
    }
    ...
    public static final int g(Modifier.c cVar) {
        ...
        if (cVar instanceof InterfaceC5823t) {
            iA |= C5810f0.a(4);
        }
        ...
        if (cVar instanceof InterfaceC5825v) {
            iA |= C5810f0.a(256);
        }
        if (cVar instanceof InterfaceC5778e) {
            iA |= C5810f0.a(512);
        }
        ...
        if (cVar instanceof InterfaceC5766i) {
            iA |= C5810f0.a(RecyclerView.m.FLAG_APPEARED_IN_PRE_LAYOUT);
        }
        if (cVar instanceof InterfaceC13605e) {
            iA |= C5810f0.a(8192);
        }
        if (cVar instanceof InterfaceC14590a) {
            iA |= C5810f0.a(16384);
        }
        if (cVar instanceof InterfaceC5812h) {
            iA |= C5810f0.a(32768);
        }
        ...
        if (cVar instanceof InterfaceC15991a) {
            iA |= C5810f0.a(524288);
        }
        if (cVar instanceof m0) {
            iA |= C5810f0.a(1048576);
        }
        s10.u(objB, iA);
        return iA;
    }
