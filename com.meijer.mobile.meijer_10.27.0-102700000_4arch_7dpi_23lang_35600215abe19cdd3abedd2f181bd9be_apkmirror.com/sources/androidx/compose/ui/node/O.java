...
public final class O {
    ...
    public O(LayoutNode layoutNode, C5820p c5820p, List<U.a> list) {
    ...
    private final boolean b(LayoutNode layoutNode) {
        ...
        if (layoutNode.f() || (layoutNode.o0() != Integer.MAX_VALUE && parent$ui_release != null && parent$ui_release.f())) {
            ...
            if (layoutNode.e0()) {
                if (!this.relayoutNodes.d(layoutNode) && layoutNode.X() != LayoutNode.e.f51242b && ((parent$ui_release == null || !parent$ui_release.e0()) && ((parent$ui_release == null || !parent$ui_release.Z()) && eVarX != LayoutNode.e.f51241a))) {
                    return false;
                }
                return true;
            }
            if (layoutNode.W()) {
                if (!this.relayoutNodes.d(layoutNode) && parent$ui_release != null && !parent$ui_release.e0() && !parent$ui_release.W() && eVarX != LayoutNode.e.f51241a && eVarX != LayoutNode.e.f51243c) {
                    ...
                    while (true) {
                        if (i11 < size2) {
                            ...
                            if (layoutNode.X() == LayoutNode.e.f51241a) {
                                break;
                            }
                            return false;
                        }
        ...
        if (Intrinsics.e(layoutNode.H0(), Boolean.TRUE)) {
            ...
            if (layoutNode.Z()) {
                if (!this.relayoutNodes.e(layoutNode, true) && ((parent$ui_release == null || !parent$ui_release.Z()) && eVarX != LayoutNode.e.f51242b && (parent$ui_release == null || !parent$ui_release.e0() || !Intrinsics.e(layoutNode.getLookaheadRoot(), layoutNode)))) {
                    return false;
                }
                return true;
            }
            if (layoutNode.Y() && !this.relayoutNodes.e(layoutNode, true) && parent$ui_release != null && !parent$ui_release.Z() && !parent$ui_release.Y() && eVarX != LayoutNode.e.f51242b && eVarX != LayoutNode.e.f51244d && (!parent$ui_release.W() || !Intrinsics.e(layoutNode.getLookaheadRoot(), layoutNode))) {
                return false;
            }
        }
        return true;
