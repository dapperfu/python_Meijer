...
public abstract class AbstractC5817m extends Modifier.c {
    ...
    protected final void N2(InterfaceC5814j instance) {
        ...
        for (Modifier.c child = this.delegate; child != null; child = child.getChild()) {
            if (child == instance) {
                ...
                int iH = g0.h(this);
                O2(iH, true);
                if (getIsAttached() && (kindSet & C5810f0.a(2)) != 0 && (C5810f0.a(2) & iH) == 0) {
                    C5804c0 nodes = C5815k.o(this).getNodes();
                    getNode().J2(null);
                    nodes.C();
                    return;
                }
    ...
    private final void P2(int delegateKindSet, Modifier.c delegateNode) {
        int kindSet = getKindSet();
        if ((delegateKindSet & C5810f0.a(2)) != 0 && (C5810f0.a(2) & kindSet) != 0 && !(this instanceof D)) {
            C14832a.b("Delegating to multiple LayoutModifierNodes without the delegating node implementing LayoutModifierNode itself is not allowed.\nDelegating Node: " + this + "\nDelegate Node: " + delegateNode);
        }
    }
    ...
    protected final <T extends InterfaceC5814j> T K2(T delegatableNode) {
        Modifier.c cVar;
        ...
        if (node.getIsAttached()) {
            C14832a.b("Cannot delegate to an already attached node");
        }
        node.A2(getNode());
        int kindSet = getKindSet();
        int iH = g0.h(node);
        ...
        if (getIsAttached()) {
            if ((iH & C5810f0.a(2)) != 0 && (kindSet & C5810f0.a(2)) == 0) {
                C5804c0 nodes = C5815k.o(this).getNodes();
                getNode().J2(null);
                nodes.C();
            } else {
