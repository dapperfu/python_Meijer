...
public abstract class Q extends androidx.compose.ui.layout.f0 implements W, Z {
    ...
    private static final Function1<PlaceableResult, Unit> f51351o = a.f51360f;
    ...
    static final class a extends Lambda implements Function1<PlaceableResult, Unit> {
        ...
        public static final a f51360f = new a();
    ...
    static final class c extends Lambda implements Function0<Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ PlaceableResult f51361f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Q f51362g;
        ...
        public final void invoke2() {
            Function1<androidx.compose.ui.layout.l0, Unit> function1T = this.f51361f.getResult().t();
            if (function1T != null) {
                function1T.invoke(this.f51362g.x1());
            }
        }
    }
    ...
    public static final class d implements androidx.compose.ui.layout.J {
        ...
        final /* synthetic */ int f51363a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ int f51364b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Map<AbstractC5774a, Integer> f51365c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Function1<androidx.compose.ui.layout.l0, Unit> f51366d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ Function1<f0.a, Unit> f51367e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Q f51368f;

        /* JADX WARN: Multi-variable type inference failed */
        d(int i10, int i11, Map<AbstractC5774a, Integer> map, Function1<? super androidx.compose.ui.layout.l0, Unit> function1, Function1<? super f0.a, Unit> function12, Q q10) {
            this.f51363a = i10;
            this.f51364b = i11;
            this.f51365c = map;
            this.f51366d = function1;
            this.f51367e = function12;
            this.f51368f = q10;
        }
        ...
        @Override // androidx.compose.ui.layout.J
        public void s() {
            this.f51367e.invoke(this.f51368f.getPlacementScope());
        }
    ...
    public abstract int d1(AbstractC5774a alignmentLine);
    ...
    */
    ...
    public androidx.compose.ui.layout.J O1(int width, int height, Map<AbstractC5774a, Integer> alignmentLines, Function1<? super androidx.compose.ui.layout.l0, Unit> rulers, Function1<? super f0.a, Unit> placementBlock) {
    ...
    */
    ...
    public final int l0(AbstractC5774a alignmentLine) {
        int iD1;
    ...
    protected final void y1(NodeCoordinator nodeCoordinator) {
        ...
        InterfaceC5801b interfaceC5801bM = nodeCoordinator.C2().M();
        if (interfaceC5801bM != null && (abstractC5799aR = interfaceC5801bM.r()) != null) {
            abstractC5799aR.m();
        }
    }
}
