...
public final class b {
    ...
    static final class C1045b extends Lambda implements Function2<Modifier, Modifier.b, Modifier> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Composer f50532f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C1045b(Composer composer) {
            super(2);
            this.f50532f = composer;
        }
        ...
        public final Modifier invoke(Modifier modifier, Modifier.b bVar) {
            ...
            if (z10) {
                ...
                modifierD = b.d(this.f50532f, (Modifier) ((Function3) TypeIntrinsics.f(function3B, 3)).invoke(Modifier.INSTANCE, this.f50532f, 0));
            }
    ...
    public static final Modifier d(Composer composer, Modifier modifier) {
        if (modifier.all(a.f50531f)) {
            return modifier;
        }
        composer.startReplaceableGroup(1219399079);
        Modifier modifier2 = (Modifier) modifier.foldIn(Modifier.INSTANCE, new C1045b(composer));
        composer.U();
        return modifier2;
    }
