...
public final class F0 implements OwnedLayer {
    ...
    private final InterfaceC5310d1 context;
    ...
    public void destroy() {
        ...
        n(false);
        InterfaceC5310d1 interfaceC5310d1 = this.context;
        if (interfaceC5310d1 != null) {
            interfaceC5310d1.b(this.graphicsLayer);
    ...
    private final void p() {
        if (this.isMatrixDirty) {
            ...
            C5331k1.i(this.matrixCache, Float.intBitsToFloat((int) (jB >> 32)), Float.intBitsToFloat((int) (jB & 4294967295L)), graphicsLayer.y(), graphicsLayer.z(), 1.0f, graphicsLayer.q(), graphicsLayer.r(), graphicsLayer.s(), graphicsLayer.t(), graphicsLayer.u(), 1.0f);
            this.isMatrixDirty = false;
            this.isIdentity = C5334l1.a(this.matrixCache);
        }
    }

    private final void q() {
        Function0<Unit> function0;
        AbstractC5337m1 abstractC5337m1 = this.outline;
        if (abstractC5337m1 == null) {
            return;
        }
        C5425a.b(this.graphicsLayer, abstractC5337m1);
        if (!(abstractC5337m1 instanceof AbstractC5337m1.a) || Build.VERSION.SDK_INT >= 33 || (function0 = this.invalidateParentLayer) == null) {
            return;
        }
        function0.invoke();
    }
    ...
    public long c(long point, boolean inverse) {
        ...
        return this.isIdentity ? point : C5331k1.f(fArrM, point);
    }
    ...
    public void d(Function2<? super Canvas, ? super GraphicsLayer, Unit> drawBlock, Function0<Unit> invalidateParentLayer) {
        InterfaceC5310d1 interfaceC5310d1 = this.context;
        if (interfaceC5310d1 == null) {
            C14832a.c("currently reuse is only supported when we manage the layer lifecycle");
            throw new KotlinNothingValueException();
        }
        if (!this.graphicsLayer.getIsReleased()) {
            C14832a.a("layer should have been released before reuse");
        }
        this.graphicsLayer = interfaceC5310d1.a();
    ...
    public F0(GraphicsLayer graphicsLayer, InterfaceC5310d1 interfaceC5310d1, AndroidComposeView androidComposeView, Function2<? super Canvas, ? super GraphicsLayer, Unit> function2, Function0<Unit> function0) {
        this.graphicsLayer = graphicsLayer;
        this.context = interfaceC5310d1;
        this.ownerView = androidComposeView;
        this.drawBlock = function2;
        this.invalidateParentLayer = function0;
        long j10 = a.e.API_PRIORITY_OTHER;
        this.size = H1.r.c((j10 & 4294967295L) | (j10 << 32));
        this.matrixCache = C5331k1.c(null, 1, null);
    ...
    public void drawLayer(Canvas canvas, GraphicsLayer parentLayer) {
        ...
        C5425a.a(this.scope, this.graphicsLayer);
    }
