...
public final class RenderNodeLayer implements OwnedLayer, FSComposeRenderNodeLayer {
    ...
    public static final int f51908n = 8;

    /* renamed from: o, reason: collision with root package name */
    private static final Function2<InterfaceC5901w0, Matrix, Unit> f51909o = a.f51922f;
    ...
    private final InterfaceC5901w0 renderNode;
    ...
    private final R0<InterfaceC5901w0> matrixCache = new R0<>(f51909o);

    /* renamed from: i, reason: collision with root package name and from kotlin metadata */
    private final C5330k0 canvasHolder = new C5330k0();
    ...
    static final class a extends Lambda implements Function2<InterfaceC5901w0, Matrix, Unit> {

        /* renamed from: f, reason: collision with root package name */
        public static final a f51922f = new a();
        ...
        public /* bridge */ /* synthetic */ Unit invoke(InterfaceC5901w0 interfaceC5901w0, Matrix matrix) {
            a(interfaceC5901w0, matrix);
            return Unit.f142422a;
        }

        public final void a(InterfaceC5901w0 interfaceC5901w0, Matrix matrix) {
            interfaceC5901w0.B(matrix);
        }
    }
    ...
    static final class c extends Lambda implements Function1<Canvas, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function2<Canvas, GraphicsLayer, Unit> f51923f;
        ...
        public final void a(Canvas canvas) {
            this.f51923f.invoke(canvas, null);
        }
    ...
    public void a(float[] matrix) {
        C5331k1.l(matrix, this.matrixCache.b(this.renderNode));
    }
    ...
    public void e(long size) {
        ...
        InterfaceC5901w0 interfaceC5901w0 = this.renderNode;
        if (interfaceC5901w0.w(interfaceC5901w0.getLeft(), this.renderNode.getTop(), this.renderNode.getLeft() + i10, this.renderNode.getTop() + i11)) {
    ...
    public RenderNodeLayer(AndroidComposeView androidComposeView, Function2<? super Canvas, ? super GraphicsLayer, Unit> function2, Function0<Unit> function0) {
        InterfaceC5901w0 c5855g1;
        this.ownerView = androidComposeView;
        this.drawBlock = function2;
        this.invalidateParentLayer = function0;
        if (Build.VERSION.SDK_INT >= 29) {
            c5855g1 = new C5893t1(androidComposeView);
        } else {
            c5855g1 = new C5855g1(androidComposeView);
        }
        c5855g1.A(true);
        c5855g1.v(false);
        this.renderNode = c5855g1;
    }
    ...
    public void g(androidx.compose.ui.graphics.g scope) {
        ...
        if ((mutatedFields & 64) != 0) {
            this.renderNode.H(C5349s0.j(scope.getAmbientShadowColor()));
        }
        if ((mutatedFields & 128) != 0) {
            this.renderNode.J(C5349s0.j(scope.getSpotShadowColor()));
        }
        ...
        if ((mutatedFields & 24576) != 0) {
            ...
            interfaceC5901w0.v(z12);
        }
        if ((131072 & mutatedFields) != 0) {
            InterfaceC5901w0 interfaceC5901w02 = this.renderNode;
            scope.I();
            interfaceC5901w02.g(null);
        }
