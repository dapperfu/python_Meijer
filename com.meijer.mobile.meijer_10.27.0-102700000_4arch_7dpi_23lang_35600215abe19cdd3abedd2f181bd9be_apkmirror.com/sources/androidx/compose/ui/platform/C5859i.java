...
public final class C5859i implements InterfaceC5856h {

    /* renamed from: b, reason: collision with root package name */
    private static final a f52098b = new a(null);

    /* renamed from: c, reason: collision with root package name */
    public static final int f52099c = 8;
    ...
    @Override // androidx.compose.ui.platform.InterfaceC5856h
    public long a(long originalTimeoutMillis, boolean containsIcons, boolean containsText, boolean containsControls) {
        ...
        if (originalTimeoutMillis < 2147483647L) {
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                int iA = C5845d0.f52066a.a(this.accessibilityManager, (int) originalTimeoutMillis, i10);
