...
final class c2 implements InterfaceC5725j, InterfaceC6027p {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final AndroidComposeView owner;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5725j original;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private boolean disposed;

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    private AbstractC6023l addedToLifecycle;

    /* renamed from: e, reason: collision with root package name and from kotlin metadata */
    private Function2<? super Composer, ? super Integer, Unit> lastContent = C5889s0.f52142a.a();
    ...
    static final class a extends Lambda implements Function1<AndroidComposeView.C5831b, Unit> {

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function2<Composer, Integer, Unit> f52049g;

        @Metadata(d1 = {"\u0000\b\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0001\u001a\u00020\u0000H\u000b¢\u0006\u0004\b\u0001\u0010\u0002"}, d2 = {"", "a", "(Landroidx/compose/runtime/Composer;I)V"}, k = 3, mv = {1, 9, 0})
        @SourceDebugExtension
        /* renamed from: androidx.compose.ui.platform.c2$a$a, reason: collision with other inner class name */
        static final class C1063a extends Lambda implements Function2<Composer, Integer, Unit> {

            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ c2 f52050f;

            /* renamed from: g, reason: collision with root package name */
            final /* synthetic */ Function2<Composer, Integer, Unit> f52051g;
            ...
            static final class C1064a extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {

                /* renamed from: a, reason: collision with root package name */
                int f52052a;

                /* renamed from: b, reason: collision with root package name */
                final /* synthetic */ c2 f52053b;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C1064a(c2 c2Var, Continuation<? super C1064a> continuation) {
                ...
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return new C1064a(this.f52053b, continuation);
                }

                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(InterfaceC16622O interfaceC16622O, Continuation<? super Unit> continuation) {
                    return ((C1064a) create(interfaceC16622O, continuation)).invokeSuspend(Unit.f142422a);
                }
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i10 != 0) {
                        ...
                        ResultKt.b(obj);
                        AndroidComposeView owner = this.f52053b.getOwner();
                        this.f52052a = 1;
            ...
            static final class b extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return new b(this.f52055b, continuation);
                }
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i10 != 0) {
                        ...
                        ResultKt.b(obj);
                        AndroidComposeView owner = this.f52055b.getOwner();
                        this.f52054a = 1;
            ...
            static final class c extends Lambda implements Function2<Composer, Integer, Unit> {
                ...
                /* renamed from: f, reason: collision with root package name */
                final /* synthetic */ c2 f52056f;

                /* renamed from: g, reason: collision with root package name */
                final /* synthetic */ Function2<Composer, Integer, Unit> f52057g;
                ...
                public final void a(Composer composer, int i10) {
                    ...
                    AndroidCompositionLocals_androidKt.a(this.f52056f.getOwner(), this.f52057g, composer, 0);
                    if (ComposerKt.M()) {
                        ComposerKt.T();
                    }
                }
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C1063a(c2 c2Var, Function2<? super Composer, ? super Integer, Unit> function2) {
                super(2);
                this.f52050f = c2Var;
                this.f52051g = function2;
            }
            ...
            public final void a(Composer composer, int i10) {
                ...
                Object tag = this.f52050f.getOwner().getTag(P0.k.f24527K);
                Set<O0.a> set = TypeIntrinsics.q(tag) ? (Set) tag : null;
                if (set == null) {
                    Object parent = this.f52050f.getOwner().getParent();
                    View view = parent instanceof View ? (View) parent : null;
                    Object tag2 = view != null ? view.getTag(P0.k.f24527K) : null;
                ...
                AndroidComposeView owner = this.f52050f.getOwner();
                boolean zD = composer.D(this.f52050f);
                c2 c2Var = this.f52050f;
                Object objB = composer.B();
                if (zD || objB == Composer.INSTANCE.a()) {
                    objB = new C1064a(c2Var, null);
                    composer.t(objB);
                }
                androidx.compose.runtime.J.g(owner, (Function2) objB, composer, 0);
                AndroidComposeView owner2 = this.f52050f.getOwner();
                boolean zD2 = composer.D(this.f52050f);
                c2 c2Var2 = this.f52050f;
                ...
                androidx.compose.runtime.r.a(O0.e.a().d(set), ComposableLambdaKt.c(-1193460702, true, new c(this.f52050f, this.f52051g), composer, 54), composer, androidx.compose.runtime.G0.f49976i | 48);
                if (ComposerKt.M()) {
                    ComposerKt.T();
                }
            }
        ...
        a(Function2<? super Composer, ? super Integer, Unit> function2) {
            super(1);
            this.f52049g = function2;
        }

        public final void a(AndroidComposeView.C5831b c5831b) {
            if (c2.this.disposed) {
                return;
            }
            AbstractC6023l lifecycle = c5831b.getLifecycleOwner().getLifecycle();
            c2.this.lastContent = this.f52049g;
            if (c2.this.addedToLifecycle == null) {
                c2.this.addedToLifecycle = lifecycle;
                lifecycle.a(c2.this);
            } else if (lifecycle.getState().b(AbstractC6023l.b.f55277c)) {
                c2.this.getOriginal().d(ComposableLambdaKt.composableLambdaInstance(-2000640158, true, new C1063a(c2.this, this.f52049g)));
            }
        }

        @Override // kotlin.jvm.functions.Function1
        public /* bridge */ /* synthetic */ Unit invoke(AndroidComposeView.C5831b c5831b) {
            a(c5831b);
            return Unit.f142422a;
        }
    }
    ...
    public void dispose() {
        if (!this.disposed) {
            this.disposed = true;
            this.owner.getView().setTag(P0.k.f24528L, null);
            AbstractC6023l abstractC6023l = this.addedToLifecycle;
            if (abstractC6023l != null) {
                abstractC6023l.d(this);
            }
        }
    ...
    public void onStateChanged(InterfaceC6030s source, AbstractC6023l.a event) {
        if (event == AbstractC6023l.a.ON_DESTROY) {
            ...
            if (event != AbstractC6023l.a.ON_CREATE || this.disposed) {
                return;
            }
            d(this.lastContent);
        }
    ...
    public final InterfaceC5725j getOriginal() {
        return this.original;
    }

    public c2(AndroidComposeView androidComposeView, InterfaceC5725j interfaceC5725j) {
        this.owner = androidComposeView;
        this.original = interfaceC5725j;
    }
}
