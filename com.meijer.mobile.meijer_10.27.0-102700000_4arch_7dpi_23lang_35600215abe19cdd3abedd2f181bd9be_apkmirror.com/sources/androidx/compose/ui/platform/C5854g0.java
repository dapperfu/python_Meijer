...
final class C5854g0 implements InterfaceC5848e0 {

    /* renamed from: b, reason: collision with root package name */
    public static final C5854g0 f52084b = new C5854g0();
    ...
    public Rect a(Activity activity) throws Exception {
        ...
        if ((rect.width() < point.x || rect.height() < point.y) && !activity.isInMultiWindowMode() && (displayCutoutF = C5836a0.f(defaultDisplay)) != null) {
