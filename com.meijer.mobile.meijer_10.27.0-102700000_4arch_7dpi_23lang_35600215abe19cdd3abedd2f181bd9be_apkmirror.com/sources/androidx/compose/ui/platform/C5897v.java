...
import androidx.compose.ui.node.C5826w;
...
public final class C5897v extends androidx.core.view.a {
    ...
    private AbstractC5519q<A1> currentSemanticsNodes;
    ...
    private Z.K<C5911z1> previousSemanticsNodes;
    ...
    private final List<C5908y1> scrollObservationScopes;

    /* renamed from: P, reason: collision with root package name and from kotlin metadata */
    private final Function1<C5908y1, Unit> scheduleScrollEventIfNeededLambda;
    ...
    private final C5504b<LayoutNode> subtreeChangedLayoutNodes;
    ...
    public static final class a implements View.OnAttachStateChangeListener {
        ...
        public void onViewAttachedToWindow(View view) {
            AccessibilityManager accessibilityManager = C5897v.this.accessibilityManager;
            C5897v c5897v = C5897v.this;
            accessibilityManager.addAccessibilityStateChangeListener(c5897v.enabledStateListener);
            accessibilityManager.addTouchExplorationStateChangeListener(c5897v.touchExplorationStateListener);
        }

        @Override // android.view.View.OnAttachStateChangeListener
        public void onViewDetachedFromWindow(View view) {
            C5897v.this.handler.removeCallbacks(C5897v.this.semanticsChangeChecker);
            AccessibilityManager accessibilityManager = C5897v.this.accessibilityManager;
            C5897v c5897v = C5897v.this;
            accessibilityManager.removeAccessibilityStateChangeListener(c5897v.enabledStateListener);
            accessibilityManager.removeTouchExplorationStateChangeListener(c5897v.touchExplorationStateListener);
        }
    }
    ...
    private final class e extends q2.z {
        ...
        public q2.y d(int focus) {
            if (focus == 1) {
                if (C5897v.this.focusedVirtualViewId == Integer.MIN_VALUE) {
                    return null;
                }
                return b(C5897v.this.focusedVirtualViewId);
            }
            if (focus == 2) {
                return b(C5897v.this.accessibilityFocusedVirtualViewId);
            }
        ...
        public void a(int virtualViewId, q2.y info, String extraDataKey, Bundle arguments) {
            C5897v.this.M(virtualViewId, info, extraDataKey, arguments);
        }

        @Override // q2.z
        public q2.y b(int virtualViewId) {
            q2.y yVarU = C5897v.this.U(virtualViewId);
            C5897v c5897v = C5897v.this;
            if (c5897v.sendingFocusAffectingEvent) {
                if (virtualViewId == c5897v.accessibilityFocusedVirtualViewId) {
                    c5897v.currentlyAccessibilityFocusedANI = yVarU;
                }
                if (virtualViewId == c5897v.focusedVirtualViewId) {
                    c5897v.currentlyFocusedANI = yVarU;
                }
            }
            return yVarU;
        }
        ...
        public boolean f(int virtualViewId, int action, Bundle arguments) {
            return C5897v.this.r0(virtualViewId, action, arguments);
        }
    }
    ...
    private static final class f {
        ...
        public f(C16706n c16706n, int i10, int i11, int i12, int i13, long j10) {
            this.node = c16706n;
            this.action = i10;
    ...
    static final class g extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f52257d = obj;
            this.f52259f |= Integer.MIN_VALUE;
            return C5897v.this.O(this);
        }
    }
    ...
    static final class h extends Lambda implements Function1<AccessibilityEvent, Boolean> {
        ...
        public final Boolean invoke(AccessibilityEvent accessibilityEvent) {
            return Boolean.valueOf(C5897v.this.getView().getParent().requestSendAccessibilityEvent(C5897v.this.getView(), accessibilityEvent));
        }
    }
    ...
    static final class i extends Lambda implements Function0<Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ C5908y1 f52261f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ C5897v f52262g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        i(C5908y1 c5908y1, C5897v c5897v) {
            super(0);
            this.f52261f = c5908y1;
            this.f52262g = c5897v;
        }
        ...
        public final void invoke2() {
            ...
            ScrollAxisRange horizontalScrollAxisRange = this.f52261f.getHorizontalScrollAxisRange();
            ScrollAxisRange verticalScrollAxisRange = this.f52261f.getVerticalScrollAxisRange();
            Float oldXValue = this.f52261f.getOldXValue();
            Float oldYValue = this.f52261f.getOldYValue();
            ...
            if (fFloatValue != 0.0f || fFloatValue2 != 0.0f) {
                int iB0 = this.f52262g.B0(this.f52261f.getSemanticsNodeId());
                A1 a12 = (A1) this.f52262g.a0().b(this.f52262g.accessibilityFocusedVirtualViewId);
                if (a12 != null) {
                    C5897v c5897v = this.f52262g;
                    try {
                        q2.y yVar = c5897v.currentlyAccessibilityFocusedANI;
                        if (yVar != null) {
                            yVar.m0(c5897v.N(a12));
                ...
                A1 a13 = (A1) this.f52262g.a0().b(this.f52262g.focusedVirtualViewId);
                if (a13 != null) {
                    C5897v c5897v2 = this.f52262g;
                    try {
                        q2.y yVar2 = c5897v2.currentlyFocusedANI;
                        if (yVar2 != null) {
                            yVar2.m0(c5897v2.N(a13));
                ...
                this.f52262g.getView().invalidate();
                A1 a14 = (A1) this.f52262g.a0().b(iB0);
                if (a14 != null && (semanticsNode = a14.getSemanticsNode()) != null && (layoutNode = semanticsNode.getLayoutNode()) != null) {
                    C5897v c5897v3 = this.f52262g;
                    if (horizontalScrollAxisRange != null) {
                        c5897v3.pendingHorizontalScrollEvents.r(iB0, horizontalScrollAxisRange);
                    }
                    if (verticalScrollAxisRange != null) {
                        c5897v3.pendingVerticalScrollEvents.r(iB0, verticalScrollAxisRange);
                    }
                    c5897v3.o0(layoutNode);
                }
            }
            if (horizontalScrollAxisRange != null) {
                this.f52261f.g(horizontalScrollAxisRange.c().invoke());
            }
            if (verticalScrollAxisRange != null) {
                this.f52261f.h(verticalScrollAxisRange.c().invoke());
            }
        }
    }
    ...
    static final class j extends Lambda implements Function1<C5908y1, Unit> {
        j() {
            super(1);
        }

        public final void a(C5908y1 c5908y1) {
            C5897v.this.z0(c5908y1);
        }

        @Override // kotlin.jvm.functions.Function1
        public /* bridge */ /* synthetic */ Unit invoke(C5908y1 c5908y1) {
            a(c5908y1);
            return Unit.f142422a;
        }
    }

    private final RectF P0(C16706n textNode, Rect bounds) {
        if (textNode == null) {
            return null;
        }
    ...
    private final String f0(C16706n node) {
    ...
    private final InterfaceC5850f g0(C16706n node, int granularity) {
        String strF0;
        ...
        if (granularity == 1) {
            C5838b c5838bA = C5838b.INSTANCE.a(this.view.getContext().getResources().getConfiguration().locale);
            c5838bA.e(strF0);
            return c5838bA;
        }
        if (granularity == 2) {
            C5853g c5853gA = C5853g.INSTANCE.a(this.view.getContext().getResources().getConfiguration().locale);
            c5853gA.e(strF0);
            return c5853gA;
        }
        if (granularity != 4) {
            if (granularity == 8) {
                C5847e c5847eA = C5847e.INSTANCE.a();
                c5847eA.e(strF0);
                return c5847eA;
            }
            if (granularity != 16) {
        ...
        if (granularity == 4) {
            C5841c c5841cA = C5841c.INSTANCE.a();
            c5841cA.j(strF0, textLayoutResultE);
            return c5841cA;
        }
        C5844d c5844dA = C5844d.INSTANCE.a();
        c5844dA.j(strF0, textLayoutResultE, node);
        return c5844dA;
    }
    ...
    public final boolean r0(int r20, int r21, android.os.Bundle r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.platform.C5897v.r0(int, int, android.os.Bundle):boolean");
    }
    ...
    */
    private final void u0(int r17, q2.y r18, r1.C16706n r19) {
        /*
            Method dump skipped, instructions count: 2210
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.platform.C5897v.u0(int, q2.y, r1.n):void");
    }
    ...
    private static final class b {
        ...
        @JvmStatic
        public static final void a(q2.y info, C16706n semanticsNode) {
            AccessibilityAction accessibilityAction;
            if (C5903x.o(semanticsNode) && (accessibilityAction = (AccessibilityAction) SemanticsConfigurationKt.getOrNull(semanticsNode.getUnmergedConfig(), SemanticsActions.INSTANCE.x())) != null) {
    ...
    static final class k extends Lambda implements Function1<LayoutNode, Boolean> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final k f52264f = new k();
    ...
    static final class l extends Lambda implements Function1<LayoutNode, Boolean> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final l f52265f = new l();
        ...
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final Boolean invoke(LayoutNode layoutNode) {
            return Boolean.valueOf(layoutNode.getNodes().p(C5810f0.a(8)));
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void A0(C5897v c5897v) {
        Trace.beginSection("measureAndLayout");
        try {
            Owner.b(c5897v.view, false, 1, null);
            Unit unit = Unit.f142422a;
            Trace.endSection();
            ...
            try {
                c5897v.R();
                Trace.endSection();
                c5897v.checkingForSemanticsChanges = false;
            } finally {
            }
        } finally {
        }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private final void C0(r1.C16706n r17, androidx.compose.ui.platform.C5911z1 r18) {
        /*
            r16 = this;
            r0 = r16
            Z.L r1 = Z.C5521t.b()
        ...
        La5:
            ...
            androidx.compose.ui.platform.z1 r5 = (androidx.compose.ui.platform.C5911z1) r5
            r0.C0(r3, r5)
        Lcd:
            int r4 = r4 + 1
            goto La5
        Ld0:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.platform.C5897v.C0(r1.n, androidx.compose.ui.platform.z1):void");
    }
    ...
    static /* synthetic */ boolean F0(C5897v c5897v, int i10, int i11, Integer num, List list, int i12, Object obj) {
        if ((i12 & 4) != 0) {
            num = null;
        }
        if ((i12 & 8) != 0) {
        ...
        return c5897v.E0(i10, i11, num, list);
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private final void I0(Z.AbstractC5519q<androidx.compose.ui.platform.A1> r54) {
        /*
            Method dump skipped, instructions count: 1701
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.platform.C5897v.I0(Z.q):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private final boolean Q(Z.AbstractC5519q<androidx.compose.ui.platform.A1> r21, boolean r22, int r23, long r24) {
        /*
            Method dump skipped, instructions count: 265
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.platform.C5897v.Q(Z.q, boolean, int, long):boolean");
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void R0(C5897v c5897v, boolean z10) {
        c5897v.enabledServices = c5897v.accessibilityManager.getEnabledAccessibilityServiceList(-1);
    }
    ...
    public final q2.y U(int virtualViewId) {
        InterfaceC6030s lifecycleOwner;
        AbstractC6023l lifecycle;
        AndroidComposeView.C5831b viewTreeOwners = this.view.getViewTreeOwners();
        if (((viewTreeOwners == null || (lifecycleOwner = viewTreeOwners.getLifecycleOwner()) == null || (lifecycle = lifecycleOwner.getLifecycle()) == null) ? null : lifecycle.getState()) == AbstractC6023l.b.f55275a) {
            return null;
        }
        q2.y yVarB0 = q2.y.b0();
        ...
        C16706n semanticsNode = a1B.getSemanticsNode();
        if (virtualViewId == -1) {
            ViewParent parentForAccessibility = this.view.getParentForAccessibility();
            yVarB0.L0(parentForAccessibility instanceof View ? (View) parentForAccessibility : null);
        } else {
            C16706n c16706nR = semanticsNode.r();
            Integer numValueOf = c16706nR != null ? Integer.valueOf(c16706nR.getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String()) : null;
            if (numValueOf == null) {
                C14832a.c("semanticsNode " + virtualViewId + " has null parent");
    ...
    */
    private final void V0() {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.platform.C5897v.V0():void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void X(C5897v c5897v, boolean z10) {
        c5897v.enabledServices = z10 ? c5897v.accessibilityManager.getEnabledAccessibilityServiceList(-1) : CollectionsKt.m();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final AbstractC5519q<A1> a0() {
        if (this.currentSemanticsNodesInvalidated) {
            this.currentSemanticsNodesInvalidated = false;
            this.currentSemanticsNodes = B1.b(this.view.getSemanticsOwner());
            if (m0()) {
                C5903x.z(this.currentSemanticsNodes, this.idToBeforeMap, this.idToAfterMap, this.view.getContext().getResources());
            }
        }
    ...
    */
    public final java.lang.Object O(kotlin.coroutines.Continuation<? super kotlin.Unit> r12) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.platform.C5897v.O(kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public final int j0(float x10, float y10) {
        ...
        C5826w c5826w = new C5826w();
        LayoutNode.x0(this.view.getRoot(), U0.f.e((Float.floatToRawIntBits(y10) & 4294967295L) | (Float.floatToRawIntBits(x10) << 32)), c5826w, 0, false, 12, null);
        int iO = CollectionsKt.o(c5826w);
        while (true) {
            iB0 = Integer.MIN_VALUE;
            if (-1 >= iO) {
                break;
            }
            LayoutNode layoutNodeO = C5815k.o(c5826w.get(iO));
            if (this.view.getAndroidViewsHandler$ui_release().getLayoutNodeToHolder().get(layoutNodeO) != null) {
                return Integer.MIN_VALUE;
            }
            if (layoutNodeO.getNodes().p(C5810f0.a(8))) {
                iB0 = B0(layoutNodeO.getSemanticsId());
                C16706n c16706nA = C16707o.a(layoutNodeO, false);
                if (B1.g(c16706nA) && !c16706nA.n().contains(SemanticsProperties.INSTANCE.s())) {
                    break;
                }
            }
            iO--;
    ...
    public C5897v(AndroidComposeView androidComposeView) {
        ...
        this.subtreeChangedLayoutNodes = new C5504b<>(0, 1, null);
        this.boundsUpdateChannel = sv.j.b(1, null, null, 6, null);
        this.currentSemanticsNodesInvalidated = true;
        ...
        this.previousSemanticsRoot = new C5911z1(androidComposeView.getSemanticsOwner().d(), Z.r.b());
        androidComposeView.addOnAttachStateChangeListener(new a());
        this.semanticsChangeChecker = new Runnable() { // from class: androidx.compose.ui.platform.u
            @Override // java.lang.Runnable
            public final void run() {
                C5897v.A0(this.f52199a);
            }
        };
    ...
    private final void J0(LayoutNode layoutNode, Z.L subtreeChangedSemanticsNodesIds) {
        ...
        if (layoutNode.isAttached() && !this.view.getAndroidViewsHandler$ui_release().getLayoutNodeToHolder().containsKey(layoutNode)) {
            if (!layoutNode.getNodes().p(C5810f0.a(8))) {
                layoutNode = C5903x.q(layoutNode, l.f52265f);
            }
            if (layoutNode != null && (semanticsConfiguration = layoutNode.getSemanticsConfiguration()) != null) {
                if (!semanticsConfiguration.getIsMergingSemanticsOfDescendants() && (layoutNodeQ = C5903x.q(layoutNode, k.f52264f)) != null) {
                    layoutNode = layoutNodeQ;
                }
    ...
    private final boolean L0(C16706n node, int start, int end, boolean traversalMode) {
        String strF0;
        Integer numValueOf;
        Integer numValueOf2;
        SemanticsConfiguration unmergedConfig = node.getUnmergedConfig();
        SemanticsActions semanticsActions = SemanticsActions.INSTANCE;
        boolean z10 = false;
        if (unmergedConfig.contains(semanticsActions.y()) && C5903x.o(node)) {
    ...
    private final void M0(C16706n node, q2.y info) {
        SemanticsConfiguration unmergedConfig = node.getUnmergedConfig();
        SemanticsProperties semanticsProperties = SemanticsProperties.INSTANCE;
    ...
    private final void O0(C16706n node, q2.y info) {
        SpannableString spannableStringQ0;
        AnnotatedString annotatedStringU = C5903x.u(node);
    ...
    private final boolean S0(C16706n node, int granularity, boolean forward, boolean extendSelection) {
        int[] iArrB;
        int iZ;
        int i10;
        int i11;
        ...
        if (strF0 != null && strF0.length() != 0) {
            InterfaceC5850f interfaceC5850fG0 = g0(node, granularity);
            if (interfaceC5850fG0 == null) {
                return false;
            }
            int iY = Y(node);
            if (iY == -1) {
            ...
            if (forward) {
                iArrB = interfaceC5850fG0.a(iY);
            } else {
                iArrB = interfaceC5850fG0.b(iY);
            }
            if (iArrB == null) {
                return false;
            }
    ...
    private final int Y(C16706n node) {
        SemanticsConfiguration unmergedConfig = node.getUnmergedConfig();
        SemanticsProperties semanticsProperties = SemanticsProperties.INSTANCE;
    ...
    private final int Z(C16706n node) {
        SemanticsConfiguration unmergedConfig = node.getUnmergedConfig();
        SemanticsProperties semanticsProperties = SemanticsProperties.INSTANCE;
        if (!unmergedConfig.contains(semanticsProperties.getContentDescription()) && node.getUnmergedConfig().contains(semanticsProperties.A())) {
    ...
    private final boolean l0(C16706n node) {
        SemanticsConfiguration unmergedConfig = node.getUnmergedConfig();
        SemanticsProperties semanticsProperties = SemanticsProperties.INSTANCE;
    ...
    private final boolean x0(int id2, List<C5908y1> oldScrollObservationScopes) {
        boolean z10;
        C5908y1 c5908y1A = B1.a(oldScrollObservationScopes, id2);
        if (c5908y1A != null) {
            z10 = false;
        } else {
            C5908y1 c5908y1 = new C5908y1(id2, this.scrollObservationScopes, null, null, null, null);
            z10 = true;
            c5908y1A = c5908y1;
        }
        this.scrollObservationScopes.add(c5908y1A);
        return z10;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void z0(C5908y1 scrollObservationScope) {
