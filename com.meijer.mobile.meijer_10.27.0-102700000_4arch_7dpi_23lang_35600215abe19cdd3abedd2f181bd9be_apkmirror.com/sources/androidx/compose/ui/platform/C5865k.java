...
public final class C5865k implements InterfaceC5886r0 {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final ClipboardManager clipboardManager;

    public C5865k(ClipboardManager clipboardManager) {
        this.clipboardManager = clipboardManager;
    }

    @Override // androidx.compose.ui.platform.InterfaceC5886r0
    public void a(AnnotatedString annotatedString) {
        this.clipboardManager.setPrimaryClip(ClipData.newPlainText("plain text", C5868l.a(annotatedString)));
    }

    public C5881p0 b() {
        ClipData primaryClip = this.clipboardManager.getPrimaryClip();
        if (primaryClip != null) {
            return new C5881p0(primaryClip);
        }
        return null;
    }
