...
public final class Y0 {
    ...
    private final void i() {
        if (this.cacheIsDirty) {
            ...
            if (abstractC5337m1 == null || !this.outlineNeeded || Float.intBitsToFloat((int) (this.rectSize >> 32)) <= 0.0f || Float.intBitsToFloat((int) (this.rectSize & 4294967295L)) <= 0.0f) {
                this.cachedOutline.setEmpty();
                return;
            }
            this.isSupportedOutline = true;
            if (abstractC5337m1 instanceof AbstractC5337m1.b) {
                k(((AbstractC5337m1.b) abstractC5337m1).b());
            } else if (abstractC5337m1 instanceof AbstractC5337m1.c) {
                l(((AbstractC5337m1.c) abstractC5337m1).getRoundRect());
            } else if (abstractC5337m1 instanceof AbstractC5337m1.a) {
                j(((AbstractC5337m1.a) abstractC5337m1).getPath());
            }
        }
    }
    ...
    private final void j(V0.q1 composePath) {
        ...
        if (i10 > 28 || composePath.a()) {
            if (i10 >= 30) {
                Z0.f51991a.a(this.cachedOutline, composePath);
            } else {
    ...
    public final boolean f(long position) {
        ...
        if (this.outlineNeeded && (abstractC5337m1 = this.outline) != null) {
            return C1.b(abstractC5337m1, Float.intBitsToFloat((int) (position >> 32)), Float.intBitsToFloat((int) (position & 4294967295L)), this.tmpTouchPointPath, this.tmpOpPath);
        }
        return true;
    }

    public final boolean h(AbstractC5337m1 outline, float alpha, boolean clipToOutline, float elevation, long size) {
