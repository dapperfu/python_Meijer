...
public final class c extends Modifier.c {
    ...
    private InterfaceC5742s map;

    public final void K2(InterfaceC5742s interfaceC5742s) {
        this.map = interfaceC5742s;
        C5815k.o(this).o(interfaceC5742s);
    }

    public c(InterfaceC5742s interfaceC5742s) {
        this.map = interfaceC5742s;
    }

    @Override // androidx.compose.ui.Modifier.c
    public void t2() {
        C5815k.o(this).o(this.map);
    }
}
