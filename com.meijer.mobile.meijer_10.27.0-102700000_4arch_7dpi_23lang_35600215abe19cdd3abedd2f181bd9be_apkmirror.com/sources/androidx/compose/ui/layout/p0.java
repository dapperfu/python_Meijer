...
public final class p0 {
    ...
    static final class b extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ Modifier f51123f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function2<r0, H1.b, J> f51124g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f51125h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ int f51126i;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        b(Modifier modifier, Function2<? super r0, ? super H1.b, ? extends J> function2, int i10, int i11) {
            super(2);
            this.f51123f = modifier;
            this.f51124g = function2;
            this.f51125h = i10;
            this.f51126i = i11;
        }

        public final void a(Composer composer, int i10) {
            p0.a(this.f51123f, this.f51124g, composer, J0.a(this.f51125h | 1), this.f51126i);
        }
    ...
    static final class d extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ q0 f51128f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Modifier f51129g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Function2<r0, H1.b, J> f51130h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ int f51131i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ int f51132j;
        ...
        d(q0 q0Var, Modifier modifier, Function2<? super r0, ? super H1.b, ? extends J> function2, int i10, int i11) {
            super(2);
            this.f51128f = q0Var;
            this.f51129g = modifier;
            this.f51130h = function2;
            this.f51131i = i10;
            this.f51132j = i11;
        }

        public final void a(Composer composer, int i10) {
            p0.b(this.f51128f, this.f51129g, this.f51130h, composer, J0.a(this.f51131i | 1), this.f51132j);
        }
    ...
    public static final void b(q0 q0Var, Modifier modifier, Function2<? super r0, ? super H1.b, ? extends J> function2, Composer composer, int i10, int i11) {
        ...
        if (composerStartRestartGroup.p(z10, i12 & 1)) {
            ...
            AbstractC5727k abstractC5727kD = C5717f.d(composerStartRestartGroup, 0);
            ...
            D1.c(composerA, abstractC5727kD, q0Var.e());
