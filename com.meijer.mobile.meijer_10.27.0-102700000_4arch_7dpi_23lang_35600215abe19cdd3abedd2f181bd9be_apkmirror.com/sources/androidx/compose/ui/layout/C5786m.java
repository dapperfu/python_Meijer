...
public final class C5786m implements I {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final r measurable;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final EnumC5792t minMax;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private final EnumC5793u widthHeight;
    ...
    public f0 k0(long constraints) {
        if (this.widthHeight == EnumC5793u.f51147a) {
            return new C5789p(this.minMax == EnumC5792t.f51144b ? this.measurable.j0(H1.b.k(constraints)) : this.measurable.d0(H1.b.k(constraints)), H1.b.g(constraints) ? H1.b.k(constraints) : 32767);
        }
        return new C5789p(H1.b.h(constraints) ? H1.b.l(constraints) : 32767, this.minMax == EnumC5792t.f51144b ? this.measurable.A(H1.b.l(constraints)) : this.measurable.W(H1.b.l(constraints)));
    }

    public C5786m(r rVar, EnumC5792t enumC5792t, EnumC5793u enumC5793u) {
        this.measurable = rVar;
        this.minMax = enumC5792t;
        this.widthHeight = enumC5793u;
    }
}
