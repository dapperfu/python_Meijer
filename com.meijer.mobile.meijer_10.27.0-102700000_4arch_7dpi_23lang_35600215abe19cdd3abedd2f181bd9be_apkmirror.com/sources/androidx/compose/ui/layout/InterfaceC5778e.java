...
public interface InterfaceC5778e extends androidx.compose.ui.node.D {
    ...
    static final class a implements h0.a {
        ...
        public final J a(InterfaceC5779f interfaceC5779f, I i10, long j10) {
            return InterfaceC5778e.this.Q0(interfaceC5779f, i10, j10);
        }
    }
    ...
    static final class c extends Lambda implements Function1<f0.a, Unit> {
        ...
        public final void a(f0.a aVar) {
            f0.a.h(aVar, this.f51065f, 0, 0, 0.0f, 4, null);
        }
    ...
    static final class C1051e implements h0.a {
        C1051e() {
        }
    ...
    J Q0(InterfaceC5779f interfaceC5779f, I i10, long j10);
    ...
    default int A1(InterfaceC5776c interfaceC5776c, r rVar, int i10) {
        ...
        if (lookaheadDelegate.r1()) {
            return androidx.compose.ui.node.h0.f51533a.e(new d(), interfaceC5776c, rVar, i10);
        }
        return rVar.W(i10);
    }

    default int M0(InterfaceC5776c interfaceC5776c, r rVar, int i10) {
        NodeCoordinator coordinator = getNode().getCoordinator();
        Intrinsics.g(coordinator);
        androidx.compose.ui.node.S lookaheadDelegate = coordinator.getLookaheadDelegate();
        Intrinsics.g(lookaheadDelegate);
        if (lookaheadDelegate.r1()) {
            return androidx.compose.ui.node.h0.f51533a.g(new C1051e(), interfaceC5776c, rVar, i10);
        }
        return rVar.d0(i10);
    }
    ...
    default int l1(InterfaceC5776c interfaceC5776c, r rVar, int i10) {
        NodeCoordinator coordinator = getNode().getCoordinator();
        Intrinsics.g(coordinator);
        androidx.compose.ui.node.S lookaheadDelegate = coordinator.getLookaheadDelegate();
        Intrinsics.g(lookaheadDelegate);
        if (lookaheadDelegate.r1()) {
            return androidx.compose.ui.node.h0.f51533a.c(new b(), interfaceC5776c, rVar, i10);
        }
        return rVar.j0(i10);
    }

    default int q1(InterfaceC5776c interfaceC5776c, r rVar, int i10) {
        NodeCoordinator coordinator = getNode().getCoordinator();
        Intrinsics.g(coordinator);
        androidx.compose.ui.node.S lookaheadDelegate = coordinator.getLookaheadDelegate();
        Intrinsics.g(lookaheadDelegate);
        if (lookaheadDelegate.r1()) {
            return androidx.compose.ui.node.h0.f51533a.a(new a(), interfaceC5776c, rVar, i10);
        }
        return rVar.A(i10);
    }
}
