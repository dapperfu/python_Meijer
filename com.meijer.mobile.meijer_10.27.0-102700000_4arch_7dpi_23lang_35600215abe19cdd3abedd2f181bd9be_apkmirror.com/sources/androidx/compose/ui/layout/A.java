...
public final class A {
    ...
    static final class a extends Lambda implements Function1<LayoutNode, Unit> {
        ...
        public static final a f50959f = new a();
    ...
    static final class b extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Modifier f50960f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function2<Composer, Integer, Unit> f50961g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ MeasurePolicy f50962h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ int f50963i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ int f50964j;
        ...
        b(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, MeasurePolicy measurePolicy, int i10, int i11) {
            super(2);
            this.f50960f = modifier;
            this.f50961g = function2;
            this.f50962h = measurePolicy;
            this.f50963i = i10;
            this.f50964j = i11;
        }

        public final void a(Composer composer, int i10) {
            A.a(this.f50960f, this.f50961g, this.f50962h, composer, J0.a(this.f50963i | 1), this.f50964j);
        }
    ...
    static final class c extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ List<Function2<Composer, Integer, Unit>> f50965f;
        ...
        public final void a(Composer composer, int i10) {
            ...
            List<Function2<Composer, Integer, Unit>> list = this.f50965f;
            int size = list.size();
            for (int i11 = 0; i11 < size; i11++) {
                Function2<Composer, Integer, Unit> function2 = list.get(i11);
                int iA = C5717f.a(composer, 0);
                InterfaceC5811g.Companion companion = InterfaceC5811g.INSTANCE;
                Function0<InterfaceC5811g> function0I = companion.i();
                if (composer.k() == null) {
                    C5717f.c();
                }
                composer.F();
    ...
    @SourceDebugExtension
    static final class d extends Lambda implements Function3<V0<InterfaceC5811g>, Composer, Integer, Unit> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Modifier f50966f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        d(Modifier modifier) {
            super(3);
            this.f50966f = modifier;
        }

        @Override // kotlin.jvm.functions.Function3
        public /* bridge */ /* synthetic */ Unit invoke(V0<InterfaceC5811g> v02, Composer composer, Integer num) {
        ...
        public final void a(Composer composer, Composer composer2, int i10) {
            ...
            Modifier modifierE = androidx.compose.ui.b.e(composer2, this.f50966f);
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0003\u001a\u00020\u0002*\b\u0012\u0004\u0012\u00020\u00010\u0000H\u000b¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"Landroidx/compose/runtime/V0;", "Landroidx/compose/ui/node/g;", "", "a", "(Landroidx/compose/runtime/Composer;Landroidx/compose/runtime/Composer;I)V"}, k = 3, mv = {1, 9, 0})
    @SourceDebugExtension
    static final class e extends Lambda implements Function3<V0<InterfaceC5811g>, Composer, Integer, Unit> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Modifier f50967f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        e(Modifier modifier) {
            super(3);
            this.f50967f = modifier;
        }
        ...
        public final void a(Composer composer, Composer composer2, int i10) {
            ...
            int iA = C5717f.a(composer2, 0);
            Modifier modifierF = androidx.compose.ui.b.f(composer2, this.f50967f);
            composer.startReplaceableGroup(509942095);
            Composer composerA = D1.a(composer);
            InterfaceC5811g.Companion companion = InterfaceC5811g.INSTANCE;
    ...
    @PublishedApi
    @JvmName
    public static final Function3<V0<InterfaceC5811g>, Composer, Integer, Unit> c(Modifier modifier) {
        return ComposableLambdaKt.composableLambdaInstance(-55743822, true, new e(modifier));
    }

    @PublishedApi
    @JvmName
    public static final Function3<V0<InterfaceC5811g>, Composer, Integer, Unit> d(Modifier modifier) {
