...
public final class C5777d implements InterfaceC5779f, InterfaceC5776c {
    ...
    public static final class a implements J {
        ...
        final /* synthetic */ Map<AbstractC5774a, Integer> f51061c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Function1<l0, Unit> f51062d;
        ...
        a(int i10, int i11, Map<AbstractC5774a, Integer> map, Function1<? super l0, Unit> function1) {
            this.f51059a = i10;
            this.f51060b = i11;
            this.f51061c = map;
            this.f51062d = function1;
        }
    ...
    public int E0(float f10) {
        return this.f51058b.E0(f10);
    }

    @Override // H1.l
    /* renamed from: F1 */
    public float getFontScale() {
        return this.f51058b.getFontScale();
    }

    @Override // H1.d
    public float I1(float f10) {
        return this.f51058b.I1(f10);
    }

    @Override // H1.d
    public float K(int i10) {
        return this.f51058b.K(i10);
    }

    @Override // H1.d
    public float L(float f10) {
        return this.f51058b.L(f10);
    }

    @Override // H1.d
    public float N0(long j10) {
        return this.f51058b.N0(j10);
    }

    @Override // H1.d
    public int N1(long j10) {
        return this.f51058b.N1(j10);
    }
    ...
    public long T(long j10) {
        return this.f51058b.T(j10);
    }

    @Override // H1.d
    public float getDensity() {
        return this.f51058b.getDensity();
    }

    @Override // H1.l
    public long o(float f10) {
        return this.f51058b.o(f10);
    }

    @Override // H1.d
    public long p(long j10) {
        return this.f51058b.p(j10);
    }
    ...
    public boolean v0() {
        return this.f51058b.v0();
    }

    @Override // H1.d
    public long w(int i10) {
        return this.f51058b.w(i10);
    }

    @Override // H1.d
    public long x(float f10) {
        return this.f51058b.x(f10);
    }
    ...
    public C5777d(InterfaceC5776c interfaceC5776c, H1.t tVar) {
        this.layoutDirection = tVar;
        this.f51058b = interfaceC5776c;
    }
}
