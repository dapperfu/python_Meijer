...
public final class E implements InterfaceC5719g {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final LayoutNode root;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private AbstractC5727k compositionContext;
    ...
    private final class a implements r0, K {
        ...
        private final /* synthetic */ c f50985a;

        @Override // H1.d
        public int E0(float f10) {
            return this.f50985a.E0(f10);
        }

        @Override // H1.l
        /* renamed from: F1 */
        public float getFontScale() {
            return this.f50985a.getFontScale();
        }

        @Override // H1.d
        public float I1(float f10) {
            return this.f50985a.I1(f10);
        }

        @Override // H1.d
        public float K(int i10) {
            return this.f50985a.K(i10);
        }

        @Override // H1.d
        public float L(float f10) {
            return this.f50985a.L(f10);
        }

        @Override // H1.d
        public float N0(long j10) {
            return this.f50985a.N0(j10);
        }

        @Override // H1.d
        public int N1(long j10) {
            return this.f50985a.N1(j10);
        }

        @Override // androidx.compose.ui.layout.K
        public J O1(int width, int height, Map<AbstractC5774a, Integer> alignmentLines, Function1<? super l0, Unit> rulers, Function1<? super f0.a, Unit> placementBlock) {
            return this.f50985a.O1(width, height, alignmentLines, rulers, placementBlock);
        }

        @Override // H1.d
        public long T(long j10) {
            return this.f50985a.T(j10);
        }

        @Override // androidx.compose.ui.layout.K
        public J g1(int width, int height, Map<AbstractC5774a, Integer> alignmentLines, Function1<? super f0.a, Unit> placementBlock) {
            return this.f50985a.g1(width, height, alignmentLines, placementBlock);
        }

        @Override // H1.d
        public float getDensity() {
            return this.f50985a.getDensity();
        }

        @Override // H1.l
        public long o(float f10) {
            return this.f50985a.o(f10);
        }

        @Override // H1.d
        public long p(long j10) {
            return this.f50985a.p(j10);
        }
        ...
        public boolean v0() {
            return this.f50985a.v0();
        }

        @Override // H1.d
        public long w(int i10) {
            return this.f50985a.w(i10);
        }

        @Override // H1.d
        public long x(float f10) {
            return this.f50985a.x(f10);
        }

        public a() {
            this.f50985a = E.this.scope;
        }
        ...
        public H1.t getLayoutDirection() {
            return this.f50985a.getLayoutDirection();
        }
    }
    ...
    private static final class b {
        ...
        /* renamed from: f, reason: collision with root package name and from kotlin metadata */
        private InterfaceC5730l0<Boolean> activeState;
        ...
        public final void h(InterfaceC5730l0<Boolean> interfaceC5730l0) {
            this.activeState = interfaceC5730l0;
        }
    ...
    private final class c implements r0 {
        ...
        /* renamed from: a, reason: collision with root package name and from kotlin metadata */
        private H1.t layoutDirection = H1.t.f12007b;
        ...
        public static final class a implements J {
            ...
            final /* synthetic */ Map<AbstractC5774a, Integer> f50999c;

            /* renamed from: d, reason: collision with root package name */
            final /* synthetic */ Function1<l0, Unit> f51000d;

            /* renamed from: e, reason: collision with root package name */
            final /* synthetic */ c f51001e;

            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ E f51002f;

            /* renamed from: g, reason: collision with root package name */
            final /* synthetic */ Function1<f0.a, Unit> f51003g;

            /* JADX WARN: Multi-variable type inference failed */
            a(int i10, int i11, Map<AbstractC5774a, Integer> map, Function1<? super l0, Unit> function1, c cVar, E e10, Function1<? super f0.a, Unit> function12) {
                this.f50997a = i10;
                this.f50998b = i11;
                this.f50999c = map;
                this.f51000d = function1;
                this.f51001e = cVar;
                this.f51002f = e10;
                this.f51003g = function12;
            }
            ...
            public void s() {
                ...
                if (!this.f51001e.v0() || (lookaheadDelegate = this.f51002f.root.P().getLookaheadDelegate()) == null) {
                    this.f51003g.invoke(this.f51002f.root.P().getPlacementScope());
                } else {
                    this.f51003g.invoke(lookaheadDelegate.getPlacementScope());
                }
            }
        ...
        @Override // androidx.compose.ui.layout.InterfaceC5791s
        public boolean v0() {
            return E.this.root.X() == LayoutNode.e.f51244d || E.this.root.X() == LayoutNode.e.f51242b;
        }
    }
    ...
    public static final class d extends LayoutNode.f {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Function2<r0, H1.b, J> f51005c;
        ...
        public static final class a implements J {
            ...
            /* renamed from: a, reason: collision with root package name */
            private final /* synthetic */ J f51006a;
            ...
            /* renamed from: d, reason: collision with root package name */
            final /* synthetic */ J f51009d;

            @Override // androidx.compose.ui.layout.J
            public int getHeight() {
                return this.f51006a.getHeight();
            }

            @Override // androidx.compose.ui.layout.J
            public int getWidth() {
                return this.f51006a.getWidth();
            }

            @Override // androidx.compose.ui.layout.J
            public Map<AbstractC5774a, Integer> r() {
                return this.f51006a.r();
            }

            @Override // androidx.compose.ui.layout.J
            public Function1<l0, Unit> t() {
                return this.f51006a.t();
            }
            ...
            @Override // androidx.compose.ui.layout.J
            public void s() {
                this.f51007b.currentApproachIndex = this.f51008c;
                this.f51009d.s();
                this.f51007b.y();
            }
        }
        ...
        public static final class b implements J {
            ...
            /* renamed from: a, reason: collision with root package name */
            private final /* synthetic */ J f51010a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ E f51011b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ int f51012c;

            /* renamed from: d, reason: collision with root package name */
            final /* synthetic */ J f51013d;

            @Override // androidx.compose.ui.layout.J
            public int getHeight() {
                return this.f51010a.getHeight();
            }

            @Override // androidx.compose.ui.layout.J
            public int getWidth() {
                return this.f51010a.getWidth();
            }

            @Override // androidx.compose.ui.layout.J
            public Map<AbstractC5774a, Integer> r() {
                return this.f51010a.r();
            }

            @Override // androidx.compose.ui.layout.J
            public Function1<l0, Unit> t() {
                return this.f51010a.t();
            }
            ...
            @Override // androidx.compose.ui.layout.J
            public void s() {
                this.f51011b.currentIndex = this.f51012c;
                this.f51013d.s();
                E e10 = this.f51011b;
        ...
        public J d(K k10, List<? extends I> list, long j10) {
            ...
            if (k10.v0() || E.this.root.getLookaheadRoot() == null) {
                ...
                J jInvoke = this.f51005c.invoke(E.this.scope, H1.b.a(j10));
                return new b(jInvoke, E.this, E.this.currentIndex, jInvoke);
            }
            E.this.currentApproachIndex = 0;
            J jInvoke2 = this.f51005c.invoke(E.this.approachMeasureScope, H1.b.a(j10));
    ...
    public static final class f implements q0.a {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Object f51015b;
        ...
        public int a() {
            ...
            LayoutNode layoutNode = (LayoutNode) E.this.precomposeMap.e(this.f51015b);
        ...
        public void c(int index, long constraints) {
            ...
            if (index < 0 || index >= size) {
                C14832a.d("Index (" + index + ") is out of bound of [0, " + size + ')');
            }
            if (layoutNode.f()) {
                C14832a.a("Pre-measure called on node that is not placed");
            }
        ...
        public void dispose() {
            E.this.B();
            LayoutNode layoutNode = (LayoutNode) E.this.precomposeMap.u(this.f51015b);
            if (layoutNode != null) {
                if (!(E.this.precomposedCount > 0)) {
                    C14832a.b("No pre-composed items to dispose");
                }
                int iIndexOf = E.this.root.M().indexOf(layoutNode);
                if (!(iIndexOf >= E.this.root.M().size() - E.this.precomposedCount)) {
                    C14832a.b("Item is not in pre-composed item range");
                }
    ...
    static final class g extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ b f51016f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function2<Composer, Integer, Unit> f51017g;
        ...
        public final void a(Composer composer, int i10) {
            ...
            boolean zA = this.f51016f.a();
            Function2<Composer, Integer, Unit> function2 = this.f51017g;
    ...
    private final void K(LayoutNode node, b nodeState) {
        ...
        try {
            ...
            AbstractC5727k abstractC5727k = this.compositionContext;
            if (abstractC5727k == null) {
                C14832a.c("parent composition reference not set");
                throw new KotlinNothingValueException();
            }
            nodeState.i(M(composition, node, nodeState.getForceReuse(), abstractC5727k, ComposableLambdaKt.composableLambdaInstance(-1750409193, true, new g(nodeState, function2C))));
            nodeState.l(false);
            layoutNode.ignoreRemeasureRequests = false;
            Unit unit = Unit.f142422a;
            companion.l(gVarD, gVarE, function1G);
    ...
    private final void L(LayoutNode node, Object slotId, Function2<? super Composer, ? super Integer, Unit> content) {
        ...
        b bVarE = w10.e(node);
        if (bVarE == null) {
            b bVar = new b(slotId, C5783j.f51097a.a(), null, 4, null);
            w10.x(node, bVar);
            bVarE = bVar;
        }
        b bVar2 = bVarE;
    ...
    private final Q0 M(Q0 existing, LayoutNode container, boolean reuseContent, AbstractC5727k parent, Function2<? super Composer, ? super Integer, Unit> composable) {
    ...
    private final LayoutNode N(Object slotId) {
        ...
        if (i10 == -1) {
            while (i12 >= i11) {
                ...
                Intrinsics.g(bVarE);
                b bVar = bVarE;
                if (bVar.getSlotId() == p0.f51122a || this.slotReusePolicy.b(slotId, bVar.getSlotId())) {
                    bVar.m(slotId);
                    i13 = i12;
                    i10 = i13;
                    break;
    ...
    public final List<I> t(Object slotId, Function2<? super Composer, ? super Integer, Unit> content) {
        if (!(this.approachComposedSlotIds.getSize() >= this.currentApproachIndex)) {
            C14832a.a("Error: currentApproachIndex cannot be greater than the size of theapproachComposedSlotIds list.");
        }
        ...
        if (!this.precomposeMap.b(slotId)) {
            ...
            if (this.root.X() == LayoutNode.e.f51243c) {
                this.root.l1(true);
            } else {
    ...
    */
    ...
    public final void B() {
        ...
        if (!(this.nodeToNodeState.get_size() == size)) {
            C14832a.a("Inconsistency between the count of nodes tracked by the state (" + this.nodeToNodeState.get_size() + ") and the children count on the SubcomposeLayout (" + size + "). Are you trying to use the state of the disposed SubcomposeLayout?");
        }
        if (!((size - this.reusableCount) - this.precomposedCount >= 0)) {
            C14832a.a("Incorrect state. Total children " + size + ". Reusable children " + this.reusableCount + ". Precomposed children " + this.precomposedCount);
        }
        if (this.precomposeMap.get_size() == this.precomposedCount) {
            return;
        }
        C14832a.a("Incorrect state. Precomposed children " + this.precomposedCount + ". Map size " + this.precomposeMap.get_size());
    }
    ...
    public final void H(AbstractC5727k abstractC5727k) {
    ...
    */
    public final java.util.List<androidx.compose.ui.layout.I> J(java.lang.Object r13, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r14) {
        /*
            ...
            androidx.compose.ui.node.LayoutNode$e r1 = androidx.compose.ui.node.LayoutNode.e.f51241a
            r2 = 0
            r3 = 1
            if (r0 == r1) goto L1e
            androidx.compose.ui.node.LayoutNode$e r4 = androidx.compose.ui.node.LayoutNode.e.f51243c
            if (r0 == r4) goto L1e
            androidx.compose.ui.node.LayoutNode$e r4 = androidx.compose.ui.node.LayoutNode.e.f51242b
            if (r0 == r4) goto L1e
            androidx.compose.ui.node.LayoutNode$e r4 = androidx.compose.ui.node.LayoutNode.e.f51244d
            if (r0 != r4) goto L1c
            goto L1e
        L1c:
            r4 = r2
        ...
        La3:
            ...
            r12.L(r5, r13, r14)
            if (r0 == r1) goto Lb7
            androidx.compose.ui.node.LayoutNode$e r13 = androidx.compose.ui.node.LayoutNode.e.f51243c
            if (r0 != r13) goto Lb2
            goto Lb7
        Lb2:
