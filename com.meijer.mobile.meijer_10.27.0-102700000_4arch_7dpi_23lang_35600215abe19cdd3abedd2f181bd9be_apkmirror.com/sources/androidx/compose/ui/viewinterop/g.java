...
import androidx.compose.ui.focus.C5769l;
import androidx.compose.ui.focus.FocusTargetNode;
import androidx.compose.ui.focus.InterfaceC5764g;
...
final class g extends Modifier.c implements w, ViewTreeObserver.OnGlobalFocusChangeListener {
    ...
    private final Function1<InterfaceC5764g, Unit> onEnter = new a();

    /* renamed from: r, reason: collision with root package name and from kotlin metadata */
    private final Function1<InterfaceC5764g, Unit> onExit = new b();
    ...
    static final class a extends Lambda implements Function1<InterfaceC5764g, Unit> {
        ...
        public final void a(InterfaceC5764g interfaceC5764g) {
            ...
            if (C5769l.b(viewG, C5769l.c(interfaceC5764g.getRequestedFocusDirection()), f.f(C5815k.p(g.this).getFocusOwner(), C5816l.a(g.this), viewG))) {
                return;
            }
            interfaceC5764g.a();
        }
    ...
    static final class b extends Lambda implements Function1<InterfaceC5764g, Unit> {
        ...
        public final void a(InterfaceC5764g interfaceC5764g) {
            ...
            if (viewG.hasFocus()) {
                s focusOwner = C5815k.p(g.this).getFocusOwner();
                View viewA = C5816l.a(g.this);
                ...
                Integer numC = C5769l.c(interfaceC5764g.getRequestedFocusDirection());
    ...
    public void u2() {
        ...
        C5816l.a(this).getViewTreeObserver().removeOnGlobalFocusChangeListener(this);
    ...
    public void onGlobalFocusChanged(View oldFocus, View newFocus) {
        boolean z10;
        boolean z11;
        if (C5815k.o(this).getOwner() != null) {
            View viewG = f.g(this);
            s focusOwner = C5815k.p(this).getFocusOwner();
            Owner ownerP = C5815k.p(this);
            ...
            if (z10) {
                this.focusedChild = null;
                if (K2().d0().a()) {
                    focusOwner.n(false, true, false, C5763f.INSTANCE.c());
                    return;
                }
                return;
            }
    ...
    public void t2() {
        super.t2();
        ViewTreeObserver viewTreeObserver = C5816l.a(this).getViewTreeObserver();
