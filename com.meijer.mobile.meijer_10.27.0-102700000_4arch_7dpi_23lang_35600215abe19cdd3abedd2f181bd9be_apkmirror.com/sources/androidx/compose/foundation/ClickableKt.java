...
public final class ClickableKt {
    ...
    static final class a extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        ...
        final /* synthetic */ boolean f47916f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ String f47917g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Role f47918h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f47919i;
        ...
        public final Modifier a(Modifier modifier, Composer composer, int i10) {
            ...
            Modifier modifierM0clickableO2vRcR0 = ClickableKt.m0clickableO2vRcR0(Modifier.INSTANCE, lVar, interfaceC13458z, this.f47916f, this.f47917g, this.f47918h, this.f47919i);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
            composer.P();
    ...
    public static final class b extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ InterfaceC13458z f47920f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ boolean f47921g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ String f47922h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ Role f47923i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ Function0 f47924j;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public b(InterfaceC13458z interfaceC13458z, boolean z10, String str, Role role, Function0 function0) {
            super(3);
            this.f47920f = interfaceC13458z;
            this.f47921g = z10;
            this.f47922h = str;
            this.f47923i = role;
        ...
        public final Modifier a(Modifier modifier, Composer composer, int i10) {
            ...
            h0.l lVar = (h0.l) objB;
            Modifier modifierThen = j.b(Modifier.INSTANCE, lVar, this.f47920f).then(new ClickableElement(lVar, null, this.f47921g, this.f47922h, this.f47923i, this.f47924j, null));
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
            composer.P();
    ...
    public static final class c extends Lambda implements Function1<N0, Unit> {
        ...
        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ String f47926g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Role f47927h;
        ...
        public final void a(N0 n02) {
            n02.b("clickable");
            n02.getProperties().c("enabled", Boolean.valueOf(this.f47925f));
            n02.getProperties().c("onClickLabel", this.f47926g);
            n02.getProperties().c("role", this.f47927h);
            n02.getProperties().c("onClick", this.f47928i);
        }
    ...
    static final class d extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ boolean f47929f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ String f47930g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Role f47931h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ String f47932i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f47933j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f47934k;

        /* renamed from: l, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f47935l;
        ...
        d(boolean z10, String str, Role role, String str2, Function0<Unit> function0, Function0<Unit> function02, Function0<Unit> function03) {
            ...
            this.f47931h = role;
            this.f47932i = str2;
            this.f47933j = function0;
            this.f47934k = function02;
            this.f47935l = function03;
        }
        ...
        public final Modifier a(Modifier modifier, Composer composer, int i10) {
            ...
            Modifier modifierE = ClickableKt.e(Modifier.INSTANCE, lVar, interfaceC13458z, this.f47929f, this.f47930g, this.f47931h, this.f47932i, this.f47933j, this.f47934k, true, this.f47935l);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
            composer.P();
    ...
    public static final class e extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ InterfaceC13458z f47936f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ boolean f47937g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ String f47938h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ Role f47939i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ Function0 f47940j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ String f47941k;

        /* renamed from: l, reason: collision with root package name */
        final /* synthetic */ Function0 f47942l;

        /* renamed from: m, reason: collision with root package name */
        final /* synthetic */ Function0 f47943m;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public e(InterfaceC13458z interfaceC13458z, boolean z10, String str, Role role, Function0 function0, String str2, Function0 function02, Function0 function03) {
            super(3);
            this.f47936f = interfaceC13458z;
            this.f47937g = z10;
            this.f47938h = str;
            this.f47939i = role;
            this.f47940j = function0;
            this.f47941k = str2;
            this.f47942l = function02;
            this.f47943m = function03;
        }
        ...
        public final Modifier a(Modifier modifier, Composer composer, int i10) {
            ...
            h0.l lVar = (h0.l) objB;
            Modifier modifierThen = j.b(Modifier.INSTANCE, lVar, this.f47936f).then(new CombinedClickableElement(lVar, null, this.f47937g, this.f47938h, this.f47939i, this.f47940j, this.f47941k, this.f47942l, this.f47943m, true, null));
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
            composer.P();
    ...
    public static final class f extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ InterfaceC13458z f47944f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ boolean f47945g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ String f47946h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ Role f47947i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ Function0 f47948j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ String f47949k;

        /* renamed from: l, reason: collision with root package name */
        final /* synthetic */ Function0 f47950l;

        /* renamed from: m, reason: collision with root package name */
        final /* synthetic */ Function0 f47951m;

        /* renamed from: n, reason: collision with root package name */
        final /* synthetic */ boolean f47952n;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public f(InterfaceC13458z interfaceC13458z, boolean z10, String str, Role role, Function0 function0, String str2, Function0 function02, Function0 function03, boolean z11) {
            super(3);
            this.f47944f = interfaceC13458z;
            this.f47945g = z10;
            this.f47946h = str;
            this.f47947i = role;
            this.f47948j = function0;
            this.f47949k = str2;
            this.f47950l = function02;
            this.f47951m = function03;
            this.f47952n = z11;
        }
        ...
        public final Modifier a(Modifier modifier, Composer composer, int i10) {
            ...
            h0.l lVar = (h0.l) objB;
            Modifier modifierThen = j.b(Modifier.INSTANCE, lVar, this.f47944f).then(new CombinedClickableElement(lVar, null, this.f47945g, this.f47946h, this.f47947i, this.f47948j, this.f47949k, this.f47950l, this.f47951m, this.f47952n, null));
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
            composer.P();
    ...
    public static final class g extends Lambda implements Function1<N0, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ boolean f47953f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ String f47954g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Role f47955h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ Function0 f47956i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ Function0 f47957j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ Function0 f47958k;

        /* renamed from: l, reason: collision with root package name */
        final /* synthetic */ String f47959l;
        ...
        public g(boolean z10, String str, Role role, Function0 function0, Function0 function02, Function0 function03, String str2) {
            ...
            this.f47954g = str;
            this.f47955h = role;
            this.f47956i = function0;
            this.f47957j = function02;
            this.f47958k = function03;
            this.f47959l = str2;
        }

        public final void a(N0 n02) {
            n02.b("combinedClickable");
            n02.getProperties().c("enabled", Boolean.valueOf(this.f47953f));
            n02.getProperties().c("onClickLabel", this.f47954g);
            n02.getProperties().c("role", this.f47955h);
            n02.getProperties().c("onClick", this.f47956i);
            n02.getProperties().c("onDoubleClick", this.f47957j);
            n02.getProperties().c("onLongClick", this.f47958k);
            n02.getProperties().c("onLongClickLabel", this.f47959l);
        }
    ...
    static final class h extends Lambda implements Function1<B0, Boolean> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Ref.BooleanRef f47960f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        h(Ref.BooleanRef booleanRef) {
            super(1);
            this.f47960f = booleanRef;
        }
        ...
        */
        public final java.lang.Boolean invoke(androidx.compose.ui.node.B0 r4) {
            /*
                r3 = this;
                kotlin.jvm.internal.Ref$BooleanRef r0 = r3.f47960f
                boolean r1 = r0.f142828a
                r2 = 1
                if (r1 != 0) goto L17
            ...
            L18:
                r0.f142828a = r4
                kotlin.jvm.internal.Ref$BooleanRef r4 = r3.f47960f
                boolean r4 = r4.f142828a
                r4 = r4 ^ r2
    ...
    public static /* synthetic */ Modifier c(Modifier modifier, h0.l lVar, InterfaceC13458z interfaceC13458z, boolean z10, String str, Role role, Function0 function0, int i10, Object obj) {
        if ((i10 & 4) != 0) {
            z10 = true;
        }
        return m0clickableO2vRcR0(modifier, lVar, interfaceC13458z, z10, (i10 & 8) != 0 ? null : str, (i10 & 16) != 0 ? null : role, function0);
    }

    /* renamed from: clickable-O2vRcR0, reason: not valid java name */
    public static final Modifier m0clickableO2vRcR0(Modifier modifier, h0.l lVar, InterfaceC13458z interfaceC13458z, boolean z10, String str, Role role, Function0<Unit> function0) {
        Modifier modifierC;
        Modifier modifier__clickable7_Modifier = FullStoryAnnotationsKt.__clickable7_Modifier(modifier, lVar, interfaceC13458z, z10, str, role, function0);
        Function0<Unit> function0__clickable7_onClick = FullStoryAnnotationsKt.__clickable7_onClick(modifier__clickable7_Modifier, lVar, interfaceC13458z, z10, str, role, function0);
        if (interfaceC13458z instanceof InterfaceC13428B) {
            modifierC = new ClickableElement(lVar, (InterfaceC13428B) interfaceC13458z, z10, str, role, function0__clickable7_onClick, null);
        } else if (interfaceC13458z == null) {
            modifierC = new ClickableElement(lVar, null, z10, str, role, function0__clickable7_onClick, null);
        } else if (lVar != null) {
            modifierC = j.b(Modifier.INSTANCE, lVar, interfaceC13458z).then(new ClickableElement(lVar, null, z10, str, role, function0__clickable7_onClick, null));
        } else {
            modifierC = androidx.compose.ui.b.c(Modifier.INSTANCE, null, new b(interfaceC13458z, z10, str, role, function0__clickable7_onClick), 1, null);
        }
    ...
    public static final /* synthetic */ Modifier m2combinedClickableXVZzFYc(Modifier modifier, h0.l lVar, InterfaceC13458z interfaceC13458z, boolean z10, String str, Role role, String str2, Function0 function0, Function0 function02, Function0 function03) {
        Modifier modifierC;
        Modifier modifier__combinedClickable10_Modifier = FullStoryAnnotationsKt.__combinedClickable10_Modifier(modifier, lVar, interfaceC13458z, z10, str, role, str2, function0, function02, function03);
        Function0<Unit> function0__combinedClickable10_onLongClick = FullStoryAnnotationsKt.__combinedClickable10_onLongClick(modifier__combinedClickable10_Modifier, lVar, interfaceC13458z, z10, str, role, str2, function0, function02, function03);
        Function0<Unit> function0__combinedClickable10_onClick = FullStoryAnnotationsKt.__combinedClickable10_onClick(modifier__combinedClickable10_Modifier, lVar, interfaceC13458z, z10, str, role, str2, function0__combinedClickable10_onLongClick, function02, function03);
        if (interfaceC13458z instanceof InterfaceC13428B) {
            modifierC = new CombinedClickableElement(lVar, (InterfaceC13428B) interfaceC13458z, z10, str, role, function0__combinedClickable10_onClick, str2, function0__combinedClickable10_onLongClick, function02, true, null);
        } else if (interfaceC13458z == null) {
            ...
            modifierC = j.b(Modifier.INSTANCE, lVar, interfaceC13458z).then(new CombinedClickableElement(lVar, null, z10, str, role, function0__combinedClickable10_onClick, str2, function0__combinedClickable10_onLongClick, function02, true, null));
        } else {
            modifierC = androidx.compose.ui.b.c(Modifier.INSTANCE, null, new e(interfaceC13458z, z10, str, role, function0__combinedClickable10_onClick, str2, function0__combinedClickable10_onLongClick, function02), 1, null);
        }
    ...
    public static final Modifier e(Modifier modifier, h0.l lVar, InterfaceC13458z interfaceC13458z, boolean z10, String str, Role role, String str2, Function0<Unit> function0, Function0<Unit> function02, boolean z11, Function0<Unit> function03) {
        Modifier modifierC;
        if (interfaceC13458z instanceof InterfaceC13428B) {
            modifierC = new CombinedClickableElement(lVar, (InterfaceC13428B) interfaceC13458z, z10, str, role, function03, str2, function0, function02, z11, null);
        } else if (interfaceC13458z == null) {
            modifierC = new CombinedClickableElement(lVar, null, z10, str, role, function03, str2, function0, function02, z11, null);
        } else if (lVar != null) {
            modifierC = j.b(Modifier.INSTANCE, lVar, interfaceC13458z).then(new CombinedClickableElement(lVar, null, z10, str, role, function03, str2, function0, function02, z11, null));
        } else {
            modifierC = androidx.compose.ui.b.c(Modifier.INSTANCE, null, new f(interfaceC13458z, z10, str, role, function03, str2, function0, function02, z11), 1, null);
        }
        return modifier.then(modifierC);
    }

    public static /* synthetic */ Modifier f(Modifier modifier, h0.l lVar, InterfaceC13458z interfaceC13458z, boolean z10, String str, Role role, String str2, Function0 function0, Function0 function02, boolean z11, Function0 function03, int i10, Object obj) {
        if ((i10 & 4) != 0) {
            z10 = true;
        }
        if ((i10 & 8) != 0) {
        ...
        return e(modifier, lVar, interfaceC13458z, z10, str, role, str2, function0, function02, z11, function03);
    }

    public static final boolean g(B0 b02) {
        Ref.BooleanRef booleanRef = new Ref.BooleanRef();
        C0.c(b02, C13788F.INSTANCE, new h(booleanRef));
    ...
    public static final boolean h(KeyEvent keyEvent) {
        if (C13603c.e(C13604d.b(keyEvent), C13603c.INSTANCE.b()) && i(keyEvent)) {
            return true;
        }
        return false;
    }
    ...
    private static final boolean i(KeyEvent keyEvent) {
        ...
        if (C13601a.q(jA, companion.b())) {
            zQ = true;
        } else {
            zQ = C13601a.q(jA, companion.g());
        }
        if (zQ) {
            zQ2 = true;
        } else {
            zQ2 = C13601a.q(jA, companion.k());
        }
        if (zQ2) {
            return true;
        }
        return C13601a.q(jA, companion.n());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean j(KeyEvent keyEvent) {
        if (C13603c.e(C13604d.b(keyEvent), C13603c.INSTANCE.a()) && i(keyEvent)) {
            return true;
        }
        return false;
    }
