...
public final class WithAlignmentLineElement extends Y<I.a> {
    ...
    public void c(I.a node) {
        node.K2(this.alignmentLine);
    }

    public WithAlignmentLineElement(AbstractC5774a abstractC5774a) {
