...
public abstract class AbstractC5657c {
    ...
    public static final /* data */ class Value extends AbstractC5657c {

        /* renamed from: a, reason: collision with root package name and from kotlin metadata and from toString */
        private final AbstractC5774a alignmentLine;

        public Value(AbstractC5774a abstractC5774a) {
            super(null);
        ...
        @Override // androidx.compose.foundation.layout.AbstractC5657c
        public int a(f0 placeable) {
            return placeable.l0(this.alignmentLine);
        }
    }

    public /* synthetic */ AbstractC5657c(DefaultConstructorMarker defaultConstructorMarker) {
        this();
    }

    public abstract int a(f0 placeable);

    private AbstractC5657c() {
    }
}
