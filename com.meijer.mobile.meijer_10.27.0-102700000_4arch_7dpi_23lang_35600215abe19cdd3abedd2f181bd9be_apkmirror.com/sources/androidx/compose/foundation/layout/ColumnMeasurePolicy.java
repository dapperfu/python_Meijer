...
public final /* data */ class ColumnMeasurePolicy implements MeasurePolicy, InterfaceC14797F {
    ...
    static final class a extends Lambda implements Function1<f0.a, Unit> {
        ...
        final /* synthetic */ f0[] f48617f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ ColumnMeasurePolicy f48618g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f48619h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ int f48620i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ androidx.compose.ui.layout.K f48621j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ int[] f48622k;
        ...
        a(f0[] f0VarArr, ColumnMeasurePolicy columnMeasurePolicy, int i10, int i11, androidx.compose.ui.layout.K k10, int[] iArr) {
            super(1);
            this.f48617f = f0VarArr;
            this.f48618g = columnMeasurePolicy;
            this.f48619h = i10;
            this.f48620i = i11;
            this.f48621j = k10;
            this.f48622k = iArr;
        ...
        public final void a(f0.a aVar) {
            f0[] f0VarArr = this.f48617f;
            ColumnMeasurePolicy columnMeasurePolicy = this.f48618g;
            int i10 = this.f48619h;
            int i11 = this.f48620i;
            androidx.compose.ui.layout.K k10 = this.f48621j;
            int[] iArr = this.f48622k;
            ...
            while (i12 < length) {
                ...
                Intrinsics.g(f0Var);
                f0.a.h(aVar, f0Var, columnMeasurePolicy.v(f0Var, C14796E.d(f0Var), i10, i11, k10.getLayoutDirection()), iArr[i13], 0.0f, 4, null);
                i12++;
                i13++;
            }
        }
    ...
    public int e(InterfaceC5791s interfaceC5791s, List<? extends androidx.compose.ui.layout.r> list, int i10) {
        return C14831w.f139158a.f(list, i10, interfaceC5791s.E0(this.verticalArrangement.getSpacing()));
    }
    ...
    public int g(InterfaceC5791s interfaceC5791s, List<? extends androidx.compose.ui.layout.r> list, int i10) {
        return C14831w.f139158a.g(list, i10, interfaceC5791s.E0(this.verticalArrangement.getSpacing()));
    }

    @Override // androidx.compose.ui.layout.MeasurePolicy
    public int i(InterfaceC5791s interfaceC5791s, List<? extends androidx.compose.ui.layout.r> list, int i10) {
        return C14831w.f139158a.h(list, i10, interfaceC5791s.E0(this.verticalArrangement.getSpacing()));
    }

    @Override // androidx.compose.ui.layout.MeasurePolicy
    public int j(InterfaceC5791s interfaceC5791s, List<? extends androidx.compose.ui.layout.r> list, int i10) {
        return C14831w.f139158a.e(list, i10, interfaceC5791s.E0(this.verticalArrangement.getSpacing()));
    }

    public ColumnMeasurePolicy(C5658d.m mVar, e.b bVar) {
    ...
    public androidx.compose.ui.layout.J d(androidx.compose.ui.layout.K k10, List<? extends androidx.compose.ui.layout.I> list, long j10) {
        return C14798G.a(this, H1.b.m(j10), H1.b.n(j10), H1.b.k(j10), H1.b.l(j10), k10.E0(this.verticalArrangement.getSpacing()), k10, list, new f0[list.size()], 0, list.size(), (3072 & 1024) != 0 ? null : null, (3072 & RecyclerView.m.FLAG_MOVED) != 0 ? 0 : 0);
    }
