...
final class B extends Modifier.c implements androidx.compose.ui.node.D {
    ...
    static final class a extends Lambda implements Function1<f0.a, Unit> {
        ...
        final /* synthetic */ f0 f48401g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ androidx.compose.ui.layout.K f48402h;
        ...
        public final void a(f0.a aVar) {
            if (B.this.getRtlAware()) {
                f0.a.l(aVar, this.f48401g, this.f48402h.E0(B.this.getX()), this.f48402h.E0(B.this.getY()), 0.0f, 4, null);
            } else {
                f0.a.h(aVar, this.f48401g, this.f48402h.E0(B.this.getX()), this.f48402h.E0(B.this.getY()), 0.0f, 4, null);
            }
        }
