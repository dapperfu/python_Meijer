...
final class F extends Modifier.c implements androidx.compose.ui.node.D {
    ...
    private InterfaceC14794C paddingValues;

    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"Landroidx/compose/ui/layout/f0$a;", "", "a", "(Landroidx/compose/ui/layout/f0$a;)V"}, k = 3, mv = {1, 9, 0})
    static final class a extends Lambda implements Function1<f0.a, Unit> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ f0 f48429f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f48430g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f48431h;
        ...
        public final void a(f0.a aVar) {
            f0.a.h(aVar, this.f48429f, this.f48430g, this.f48431h, 0.0f, 4, null);
        }
    ...
    public final void K2(InterfaceC14794C interfaceC14794C) {
        this.paddingValues = interfaceC14794C;
    }

    public F(InterfaceC14794C interfaceC14794C) {
        this.paddingValues = interfaceC14794C;
    }
}
