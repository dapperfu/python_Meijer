...
public abstract class AbstractC5667m {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);

    /* renamed from: b, reason: collision with root package name */
    private static final AbstractC5667m f48624b = b.f48628e;

    /* renamed from: c, reason: collision with root package name */
    private static final AbstractC5667m f48625c = f.f48631e;

    /* renamed from: d, reason: collision with root package name */
    private static final AbstractC5667m f48626d = d.f48629e;
    ...
    private static final class a extends AbstractC5667m {

        /* renamed from: e, reason: collision with root package name and from kotlin metadata */
        private final AbstractC5657c alignmentLineProvider;

        public a(AbstractC5657c abstractC5657c) {
            super(null);
            this.alignmentLineProvider = abstractC5657c;
        }

        @Override // androidx.compose.foundation.layout.AbstractC5667m
        public boolean c() {
            return true;
        }
        ...
        public int a(int size, H1.t layoutDirection, f0 placeable, int beforeCrossAxisAlignmentLine) {
            ...
            return layoutDirection == H1.t.f12007b ? size - i10 : i10;
        }
    ...
    private static final class b extends AbstractC5667m {

        /* renamed from: e, reason: collision with root package name */
        public static final b f48628e = new b();
    ...
    public static final class Companion {
        ...
        public final AbstractC5667m a(AbstractC5657c alignmentLineProvider) {
            return new a(alignmentLineProvider);
        }

        public final AbstractC5667m b(e.b horizontal) {
            return new HorizontalCrossAxisAlignment(horizontal);
        }

        public final AbstractC5667m c(e.c vertical) {
    ...
    private static final class d extends AbstractC5667m {
        ...
        @Override // androidx.compose.foundation.layout.AbstractC5667m
        public int a(int size, H1.t layoutDirection, f0 placeable, int beforeCrossAxisAlignmentLine) {
            if (layoutDirection == H1.t.f12006a) {
                return size;
            }
            return 0;
        }
    ...
    private static final /* data */ class HorizontalCrossAxisAlignment extends AbstractC5667m {
    ...
    private static final class f extends AbstractC5667m {
    ...
    private static final /* data */ class VerticalCrossAxisAlignment extends AbstractC5667m {
    ...
    public /* synthetic */ AbstractC5667m(DefaultConstructorMarker defaultConstructorMarker) {
        this();
    }
