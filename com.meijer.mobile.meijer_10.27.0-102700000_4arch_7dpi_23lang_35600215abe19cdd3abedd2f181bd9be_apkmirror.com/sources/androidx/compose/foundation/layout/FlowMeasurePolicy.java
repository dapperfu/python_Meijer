...
final /* data */ class FlowMeasurePolicy implements androidx.compose.ui.layout.N, s {
    ...
    private final AbstractC5667m crossAxisAlignment;
    ...
    static final class a extends Lambda implements Function1<f0.a, Unit> {
        ...
        public static final a f48720f = new a();
    ...
    static final class b extends Lambda implements Function1<f0.a, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final b f48721f = new b();
    ...
    public /* synthetic */ FlowMeasurePolicy(boolean z10, C5658d.e eVar, C5658d.m mVar, float f10, AbstractC5667m abstractC5667m, float f11, int i10, int i11, FlowLayoutOverflowState flowLayoutOverflowState, DefaultConstructorMarker defaultConstructorMarker) {
        this(z10, eVar, mVar, f10, abstractC5667m, f11, i10, i11, flowLayoutOverflowState);
    }
    ...
    private FlowMeasurePolicy(boolean z10, C5658d.e eVar, C5658d.m mVar, float f10, AbstractC5667m abstractC5667m, float f11, int i10, int i11, FlowLayoutOverflowState flowLayoutOverflowState) {
    ...
    public androidx.compose.ui.layout.J d(androidx.compose.ui.layout.K k10, List<? extends List<? extends androidx.compose.ui.layout.I>> list, long j10) {
        if (this.maxLines == 0 || this.maxItemsInMainAxis == 0 || list.isEmpty() || (H1.b.k(j10) == 0 && this.overflow.getType() != q.a.f48678a)) {
            return androidx.compose.ui.layout.K.G0(k10, 0, 0, null, a.f48720f, 4, null);
        }
        List list2 = (List) CollectionsKt.s0(list);
        if (list2.isEmpty()) {
            return androidx.compose.ui.layout.K.G0(k10, 0, 0, null, b.f48721f, 4, null);
        }
        ...
        return p.d(k10, this, list2.iterator(), this.mainAxisSpacing, this.crossAxisArrangementSpacing, C14793B.c(j10, getIsHorizontal() ? j0.y.f139163a : j0.y.f139164b), this.maxItemsInMainAxis, this.maxLines, this.overflow);
    }

    @Override // androidx.compose.ui.layout.N
    public int e(InterfaceC5791s interfaceC5791s, List<? extends List<? extends androidx.compose.ui.layout.r>> list, int i10) {
        ...
        if (getIsHorizontal()) {
            ...
            return o(listM, i10, interfaceC5791s.E0(this.mainAxisSpacing));
        }
        List<? extends androidx.compose.ui.layout.r> listM2 = (List) CollectionsKt.u0(list);
        if (listM2 == null) {
            listM2 = CollectionsKt.m();
        }
        return n(listM2, i10, interfaceC5791s.E0(this.mainAxisSpacing), interfaceC5791s.E0(this.crossAxisArrangementSpacing), this.maxItemsInMainAxis, this.maxLines, this.overflow);
    }

    @Override // androidx.compose.ui.layout.N
    public int g(InterfaceC5791s interfaceC5791s, List<? extends List<? extends androidx.compose.ui.layout.r>> list, int i10) {
        FlowLayoutOverflowState flowLayoutOverflowState = this.overflow;
        List list2 = (List) CollectionsKt.v0(list, 1);
        androidx.compose.ui.layout.r rVar = list2 != null ? (androidx.compose.ui.layout.r) CollectionsKt.u0(list2) : null;
        List list3 = (List) CollectionsKt.v0(list, 2);
        ...
        if (getIsHorizontal()) {
            ...
            return n(listM, i10, interfaceC5791s.E0(this.mainAxisSpacing), interfaceC5791s.E0(this.crossAxisArrangementSpacing), this.maxItemsInMainAxis, this.maxLines, this.overflow);
        }
        List<? extends androidx.compose.ui.layout.r> listM2 = (List) CollectionsKt.u0(list);
        if (listM2 == null) {
            listM2 = CollectionsKt.m();
        }
        return u(listM2, i10, interfaceC5791s.E0(this.mainAxisSpacing), interfaceC5791s.E0(this.crossAxisArrangementSpacing), this.maxItemsInMainAxis, this.maxLines, this.overflow);
    }

    @Override // androidx.compose.ui.layout.N
    public int i(InterfaceC5791s interfaceC5791s, List<? extends List<? extends androidx.compose.ui.layout.r>> list, int i10) {
        FlowLayoutOverflowState flowLayoutOverflowState = this.overflow;
        List list2 = (List) CollectionsKt.v0(list, 1);
        androidx.compose.ui.layout.r rVar = list2 != null ? (androidx.compose.ui.layout.r) CollectionsKt.u0(list2) : null;
        List list3 = (List) CollectionsKt.v0(list, 2);
        ...
        if (getIsHorizontal()) {
            ...
            return u(listM, i10, interfaceC5791s.E0(this.mainAxisSpacing), interfaceC5791s.E0(this.crossAxisArrangementSpacing), this.maxItemsInMainAxis, this.maxLines, this.overflow);
        }
        List<? extends androidx.compose.ui.layout.r> listM2 = (List) CollectionsKt.u0(list);
        if (listM2 == null) {
            listM2 = CollectionsKt.m();
    ...
    @Override // androidx.compose.ui.layout.N
    public int j(InterfaceC5791s interfaceC5791s, List<? extends List<? extends androidx.compose.ui.layout.r>> list, int i10) {
        FlowLayoutOverflowState flowLayoutOverflowState = this.overflow;
        List list2 = (List) CollectionsKt.v0(list, 1);
        androidx.compose.ui.layout.r rVar = list2 != null ? (androidx.compose.ui.layout.r) CollectionsKt.u0(list2) : null;
        List list3 = (List) CollectionsKt.v0(list, 2);
        ...
        return o(listM2, i10, interfaceC5791s.E0(this.mainAxisSpacing));
    }

    @Override // androidx.compose.foundation.layout.s
    /* renamed from: m, reason: from getter */
    public AbstractC5667m getCrossAxisAlignment() {
    ...
    public final int n(List<? extends androidx.compose.ui.layout.r> measurables, int mainAxisAvailable, int mainAxisSpacing, int crossAxisSpacing, int maxItemsInMainAxis, int maxLines, FlowLayoutOverflowState overflow) {
        ...
        if (measurables.isEmpty()) {
            ...
            o oVar = new o(maxItemsInMainAxis, overflow, C14793B.a(0, mainAxisAvailable, 0, a.e.API_PRIORITY_OTHER), maxLines, mainAxisSpacing, crossAxisSpacing, null);
            ...
            int i11 = 0;
            if (oVar.b(measurables.size() > 1, 0, C5516n.b(mainAxisAvailable, a.e.API_PRIORITY_OTHER), rVar == null ? null : C5516n.a(C5516n.b(iV, iT)), 0, 0, 0, false, false).getIsLastItemInContainer()) {
                C5516n c5516nF = overflow.f(rVar != null, 0, 0);
                jB = C5516n.b(c5516nF != null ? C5516n.f(c5516nF.getPackedValue()) : 0, 0);
            } else {
                ...
                while (true) {
                    ...
                    int i22 = iV2;
                    int i23 = iT2;
                    o.b bVarB = oVar.b(z10, i20, C5516n.b(i18, a.e.API_PRIORITY_OTHER), rVar2 == null ? null : C5516n.a(C5516n.b(iV2, iT2)), i21, i11, iMax, false, false);
                        ...
                        if (bVarB.getIsLastItemInContainer()) {
                            if (aVarA != null) {
                                ...
                                if (!aVarA.getPlaceEllipsisOnLastContentLine()) {
                                    iF += C5516n.f(ellipsisSize) + crossAxisSpacing;
                                }
                            }
                            i11 = iF;
                            i14 = i19;
                ...
                jB = C5516n.b(i11 - crossAxisSpacing, i14);
            }
        }
        return C5516n.e(jB);
    }
    ...
    public C5658d.e getHorizontalArrangement() {
        return this.horizontalArrangement;
    }

    @Override // androidx.compose.foundation.layout.s
    /* renamed from: s, reason: from getter */
    public C5658d.m getVerticalArrangement() {
    ...
    public final int u(List<? extends androidx.compose.ui.layout.r> measurables, int crossAxisAvailable, int mainAxisSpacing, int crossAxisSpacing, int maxItemsInMainAxis, int maxLines, FlowLayoutOverflowState overflow) {
        ...
        int iMin = Math.min(i13 - (((i13 >= list.size() || !(overflow.getType() == q.a.f48680c || overflow.getType() == q.a.f48681d)) && (i13 < list.size() || i11 < overflow.getMinLinesToShowCollapse() || overflow.getType() != q.a.f48681d)) ? 0 : 1), list.size());
        int iY0 = ArraysKt.Y0(iArr) + ((list.size() - 1) * mainAxisSpacing);
        if (size2 == 0) {
