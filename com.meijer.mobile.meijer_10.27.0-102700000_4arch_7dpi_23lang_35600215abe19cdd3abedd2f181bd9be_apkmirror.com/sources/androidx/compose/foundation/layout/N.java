...
final class N extends Modifier.c implements androidx.compose.ui.node.D {
    ...
    static final class a extends Lambda implements Function1<f0.a, Unit> {
        ...
        final /* synthetic */ int f48503g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ f0 f48504h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ int f48505i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ androidx.compose.ui.layout.K f48506j;
        ...
        public final void a(f0.a aVar) {
            f0.a.j(aVar, this.f48504h, N.this.K2().invoke(H1.r.b(H1.r.c(((this.f48505i - this.f48504h.getHeight()) & 4294967295L) | ((this.f48503g - this.f48504h.getWidth()) << 32))), this.f48506j.getLayoutDirection()).getPackedValue(), 0.0f, 2, null);
        }
    ...
    public final void M2(EnumC14819k enumC14819k) {
    ...
    public androidx.compose.ui.layout.J a(androidx.compose.ui.layout.K k10, androidx.compose.ui.layout.I i10, long j10) {
        EnumC14819k enumC14819k = this.direction;
        EnumC14819k enumC14819k2 = EnumC14819k.f139121a;
        int iN = enumC14819k != enumC14819k2 ? 0 : H1.b.n(j10);
        EnumC14819k enumC14819k3 = this.direction;
        EnumC14819k enumC14819k4 = EnumC14819k.f139122b;
        int iM = enumC14819k3 == enumC14819k4 ? H1.b.m(j10) : 0;
        EnumC14819k enumC14819k5 = this.direction;
        int iK = a.e.API_PRIORITY_OTHER;
        int iL = (enumC14819k5 == enumC14819k2 || !this.unbounded) ? H1.b.l(j10) : Integer.MAX_VALUE;
        if (this.direction == enumC14819k4 || !this.unbounded) {
            iK = H1.b.k(j10);
        }
    ...
    public N(EnumC14819k enumC14819k, boolean z10, Function2<? super H1.r, ? super H1.t, H1.n> function2) {
        this.direction = enumC14819k;
        this.unbounded = z10;
        this.alignmentCallback = function2;
    }
