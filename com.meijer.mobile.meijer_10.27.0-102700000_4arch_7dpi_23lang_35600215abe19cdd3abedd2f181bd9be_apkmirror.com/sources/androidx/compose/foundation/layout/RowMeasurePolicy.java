...
public final /* data */ class RowMeasurePolicy implements MeasurePolicy, InterfaceC14797F {
    ...
    static final class a extends Lambda implements Function1<f0.a, Unit> {
        ...
        final /* synthetic */ f0[] f48439f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ RowMeasurePolicy f48440g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f48441h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ int f48442i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ int[] f48443j;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(f0[] f0VarArr, RowMeasurePolicy rowMeasurePolicy, int i10, int i11, int[] iArr) {
            super(1);
            this.f48439f = f0VarArr;
            this.f48440g = rowMeasurePolicy;
            this.f48441h = i10;
            this.f48442i = i11;
            this.f48443j = iArr;
        }
        ...
        public final void a(f0.a aVar) {
            f0[] f0VarArr = this.f48439f;
            RowMeasurePolicy rowMeasurePolicy = this.f48440g;
            int i10 = this.f48441h;
            int i11 = this.f48442i;
            int[] iArr = this.f48443j;
            ...
            while (i12 < length) {
                ...
                Intrinsics.g(f0Var);
                f0.a.h(aVar, f0Var, iArr[i13], rowMeasurePolicy.v(f0Var, C14796E.d(f0Var), i10, i11), 0.0f, 4, null);
                i12++;
                i13++;
            }
        }
    ...
    public final int v(f0 placeable, RowColumnParentData parentData, int crossAxisLayoutSize, int beforeCrossAxisAlignmentLine) {
        AbstractC5667m crossAxisAlignment = parentData != null ? parentData.getCrossAxisAlignment() : null;
        return crossAxisAlignment != null ? crossAxisAlignment.a(crossAxisLayoutSize - placeable.getHeight(), H1.t.f12006a, placeable, beforeCrossAxisAlignmentLine) : this.verticalAlignment.a(0, crossAxisLayoutSize - placeable.getHeight());
    }
    ...
    public int e(InterfaceC5791s interfaceC5791s, List<? extends androidx.compose.ui.layout.r> list, int i10) {
        return C14831w.f139158a.b(list, i10, interfaceC5791s.E0(this.horizontalArrangement.getSpacing()));
    }
    ...
    public int g(InterfaceC5791s interfaceC5791s, List<? extends androidx.compose.ui.layout.r> list, int i10) {
        return C14831w.f139158a.c(list, i10, interfaceC5791s.E0(this.horizontalArrangement.getSpacing()));
    }

    @Override // androidx.compose.ui.layout.MeasurePolicy
    public int i(InterfaceC5791s interfaceC5791s, List<? extends androidx.compose.ui.layout.r> list, int i10) {
        return C14831w.f139158a.d(list, i10, interfaceC5791s.E0(this.horizontalArrangement.getSpacing()));
    }

    @Override // androidx.compose.ui.layout.MeasurePolicy
    public int j(InterfaceC5791s interfaceC5791s, List<? extends androidx.compose.ui.layout.r> list, int i10) {
        return C14831w.f139158a.a(list, i10, interfaceC5791s.E0(this.horizontalArrangement.getSpacing()));
    }

    public RowMeasurePolicy(C5658d.e eVar, e.c cVar) {
    ...
    public androidx.compose.ui.layout.J d(androidx.compose.ui.layout.K k10, List<? extends androidx.compose.ui.layout.I> list, long j10) {
        return C14798G.a(this, H1.b.n(j10), H1.b.m(j10), H1.b.l(j10), H1.b.k(j10), k10.E0(this.horizontalArrangement.getSpacing()), k10, list, new f0[list.size()], 0, list.size(), (3072 & 1024) != 0 ? null : null, (3072 & RecyclerView.m.FLAG_MOVED) != 0 ? 0 : 0);
    }
