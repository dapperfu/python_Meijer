...
final class C extends Modifier.c implements androidx.compose.ui.node.D {
    ...
    static final class a extends Lambda implements Function1<f0.a, Unit> {
        ...
        final /* synthetic */ androidx.compose.ui.layout.K f48410g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ f0 f48411h;
        ...
        public final void a(f0.a aVar) {
            long packedValue = C.this.K2().invoke(this.f48410g).getPackedValue();
            if (C.this.getRtlAware()) {
                f0.a.p(aVar, this.f48411h, H1.n.k(packedValue), H1.n.l(packedValue), 0.0f, null, 12, null);
            } else {
                f0.a.v(aVar, this.f48411h, H1.n.k(packedValue), H1.n.l(packedValue), 0.0f, null, 12, null);
            }
        }
