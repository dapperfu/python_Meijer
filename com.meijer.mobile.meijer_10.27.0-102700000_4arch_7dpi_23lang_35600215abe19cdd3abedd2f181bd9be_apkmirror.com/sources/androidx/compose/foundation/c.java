...
final class c extends Modifier.c implements InterfaceC5823t, i0 {
    ...
    private AbstractC5337m1 lastOutline;

    /* renamed from: v, reason: collision with root package name and from kotlin metadata */
    private D1 lastShape;

    /* renamed from: w, reason: collision with root package name and from kotlin metadata */
    private AbstractC5337m1 tmpOutline;

    @Metadata(d1 = {"\u0000\b\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002"}, d2 = {"<anonymous>", "", "invoke"}, k = 3, mv = {1, 9, 0}, xi = 48)
    static final class a extends Lambda implements Function0<Unit> {

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ X0.c f48064g;
        ...
        public final void invoke2() {
            c cVar = c.this;
            cVar.tmpOutline = cVar.getShape().a(this.f48064g.b(), this.f48064g.getLayoutDirection(), this.f48064g);
        }
    }

    public /* synthetic */ c(long j10, AbstractC5324i0 abstractC5324i0, float f10, D1 d12, DefaultConstructorMarker defaultConstructorMarker) {
        this(j10, abstractC5324i0, f10, d12);
    }

    private c(long j10, AbstractC5324i0 abstractC5324i0, float f10, D1 d12) {
        this.color = j10;
    ...
    public final void P2(AbstractC5324i0 abstractC5324i0) {
        this.brush = abstractC5324i0;
    }
    ...
    private final void L2(X0.c cVar) {
        X0.c cVar2;
        AbstractC5337m1 abstractC5337m1N2 = N2(cVar);
        if (!C5346q0.s(this.color, C5346q0.INSTANCE.j())) {
            cVar2 = cVar;
            C5340n1.e(cVar2, abstractC5337m1N2, this.color, 0.0f, null, null, 0, 60, null);
        } else {
            cVar2 = cVar;
        }
        AbstractC5324i0 abstractC5324i0 = this.brush;
        if (abstractC5324i0 != null) {
            C5340n1.c(cVar2, abstractC5337m1N2, abstractC5324i0, this.alpha, null, null, 0, 56, null);
        }
    }

    private final AbstractC5337m1 N2(X0.c cVar) {
        AbstractC5337m1 abstractC5337m1;
        if (U0.k.f(cVar.b(), this.lastSize) && cVar.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.e(this.lastShape, this.shape)) {
            abstractC5337m1 = this.lastOutline;
            Intrinsics.g(abstractC5337m1);
        } else {
            j0.a(this, new a(cVar));
            abstractC5337m1 = this.tmpOutline;
            this.tmpOutline = null;
        }
        this.lastOutline = abstractC5337m1;
