...
public final class d {
    ...
    private final InterfaceC15737X prefetchScheduler;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final Function1<InterfaceC15732S, Unit> onNestedPrefetch;
    ...
    private final class a implements InterfaceC15732S {

        /* renamed from: a, reason: collision with root package name and from kotlin metadata */
        private final List<InterfaceC15735V> _requests = new ArrayList();

        public a() {
        }

        public final List<InterfaceC15735V> b() {
        ...
        @Override // kotlin.InterfaceC15732S
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public d(InterfaceC15737X interfaceC15737X, Function1<? super InterfaceC15732S, Unit> function1) {
        this.prefetchScheduler = interfaceC15737X;
        this.onNestedPrefetch = function1;
        this.prefetchMetrics = new C15734U();
    }

    public final List<InterfaceC15735V> b() {
        Function1<InterfaceC15732S, Unit> function1 = this.onNestedPrefetch;
        if (function1 == null) {
    ...
    public final InterfaceC15737X getPrefetchScheduler() {
    ...
    public final b e(int index, long constraints) {
        ...
        return (hVar == null || (bVarD = hVar.d(index, constraints, this.prefetchMetrics)) == null) ? androidx.compose.foundation.lazy.layout.a.f48782a : bVarD;
    }
    ...
    public /* synthetic */ d(InterfaceC15737X interfaceC15737X, Function1 function1, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this((i10 & 1) != 0 ? null : interfaceC15737X, (i10 & 2) != 0 ? null : function1);
    }
}
