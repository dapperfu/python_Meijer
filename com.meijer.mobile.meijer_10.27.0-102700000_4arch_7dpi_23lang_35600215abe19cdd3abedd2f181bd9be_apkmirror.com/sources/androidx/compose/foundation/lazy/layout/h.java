...
import kotlin.C15734U;
import kotlin.C15756p;
import kotlin.InterfaceC15735V;
import kotlin.InterfaceC15736W;
...
public final class h {
    ...
    private final C15756p itemContentFactory;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final q0 subcomposeLayoutState;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC15737X executor;
    ...
    private final class a implements d.b, InterfaceC15735V {
        ...
        /* renamed from: c, reason: collision with root package name and from kotlin metadata */
        private final C15734U prefetchMetrics;
        ...
        private C1001a nestedPrefetchController;
        ...
        private final class C1001a {

            /* renamed from: a, reason: collision with root package name and from kotlin metadata */
            private final List<d> states;

            /* renamed from: b, reason: collision with root package name and from kotlin metadata */
            private final List<InterfaceC15735V>[] requestsByState;
            ...
            public C1001a(List<d> list) {
                this.states = list;
                this.requestsByState = new List[list.size()];
                if (list.isEmpty()) {
                    C14589e.a("NestedPrefetchController shouldn't be created with no states");
                }
            }

            public final boolean a(InterfaceC15736W interfaceC15736W) {
                if (this.stateIndex >= this.states.size()) {
                    return false;
                }
                if (a.this.isCanceled) {
                    C14589e.c("Should not execute nested prefetch on canceled request");
                }
                Trace.beginSection("compose:lazy:prefetch:nested");
                while (this.stateIndex < this.states.size()) {
                    try {
                        if (this.requestsByState[this.stateIndex] == null) {
                            if (interfaceC15736W.a() <= 0) {
                                Trace.endSection();
                                return true;
                            }
                            List<InterfaceC15735V>[] listArr = this.requestsByState;
                            int i10 = this.stateIndex;
                            listArr[i10] = this.states.get(i10).b();
                        }
                        List<InterfaceC15735V> list = this.requestsByState[this.stateIndex];
                        Intrinsics.g(list);
                        while (this.requestIndex < list.size()) {
                            if (list.get(this.requestIndex).b(interfaceC15736W)) {
                                Trace.endSection();
                                return true;
                            }
                            this.requestIndex++;
        ...
        static final class b extends Lambda implements Function1<B0, A0> {
            ...
            final /* synthetic */ Ref.ObjectRef<List<d>> f48878f;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            b(Ref.ObjectRef<List<d>> objectRef) {
                super(1);
                this.f48878f = objectRef;
            }
            ...
            public final A0 invoke(B0 b02) {
                ...
                Ref.ObjectRef<List<d>> objectRef = this.f48878f;
                List<d> list = objectRef.f142835a;
                if (list != null) {
                    list.add(dVarK2);
                    tS = list;
                } else {
                ...
                objectRef.f142835a = tS;
                return A0.f51161b;
            }
        }

        public /* synthetic */ a(h hVar, int i10, long j10, C15734U c15734u, DefaultConstructorMarker defaultConstructorMarker) {
            this(i10, j10, c15734u);
        }
        ...
        private a(int i10, long j10, C15734U c15734u) {
            this.index = i10;
            this.constraints = j10;
            this.prefetchMetrics = c15734u;
            this.startTime = TimeSource.Monotonic.f147530a.a();
        }
        ...
        private final void e(InterfaceC15758r itemProvider, Object contentType) {
            if (!(this.precomposeHandle == null)) {
                C14589e.a("Request was already composed!");
            }
        ...
        private final void f(long constraints) {
            if (this.isCanceled) {
                C14589e.a("Callers should check whether the request is still valid before calling performMeasure()");
            }
            if (this.isMeasured) {
                C14589e.a("Request was already measured!");
            }
            this.isMeasured = true;
            q0.a aVar = this.precomposeHandle;
            if (aVar == null) {
                C14589e.b("performComposition() must be called before performMeasure()");
        ...
        private final C1001a h() {
            q0.a aVar = this.precomposeHandle;
            if (aVar == null) {
                C14589e.b("Should precompose before resolving nested prefetch states");
                throw new KotlinNothingValueException();
            }
        ...
        private final void j() {
            long jA = TimeSource.Monotonic.f147530a.a();
        ...
        @Override // kotlin.InterfaceC15735V
        public boolean b(InterfaceC15736W interfaceC15736W) {
            InterfaceC15758r interfaceC15758rInvoke = h.this.itemContentFactory.d().invoke();
            if (!this.isCanceled) {
                int iA = interfaceC15758rInvoke.a();
                int i10 = this.index;
                if (i10 >= 0 && i10 < iA) {
                    Object objF = interfaceC15758rInvoke.f(i10);
                    g(interfaceC15736W.a());
                    if (!d()) {
                    ...
                    if (!this.isUrgent) {
                        ...
                        C1001a c1001a = this.nestedPrefetchController;
                        if (c1001a != null ? c1001a.a(interfaceC15736W) : false) {
                            return true;
                        }
                        j();
                    }
    ...
    public final InterfaceC15735V c(int index, long constraints, C15734U prefetchMetrics) {
        return new a(this, index, constraints, prefetchMetrics, null);
    }

    public final d.b d(int index, long constraints, C15734U prefetchMetrics) {
        a aVar = new a(this, index, constraints, prefetchMetrics, null);
        this.executor.a(aVar);
        return aVar;
    }

    public h(C15756p c15756p, q0 q0Var, InterfaceC15737X interfaceC15737X) {
        this.itemContentFactory = c15756p;
        this.subcomposeLayoutState = q0Var;
        this.executor = interfaceC15737X;
    }
}
