...
final class l extends AbstractC5817m {

    /* renamed from: q, reason: collision with root package name and from kotlin metadata */
    private InterfaceC5814j indicationNode;

    public final void Q2(InterfaceC5814j indicationNode) {
        N2(this.indicationNode);
        this.indicationNode = indicationNode;
        K2(indicationNode);
    }

    public l(InterfaceC5814j interfaceC5814j) {
        this.indicationNode = interfaceC5814j;
        K2(interfaceC5814j);
    }
}
