...
public abstract class a extends AbstractC5817m implements q0, InterfaceC13605e, u0, B0 {

    /* renamed from: H, reason: collision with root package name and from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);

    /* renamed from: I, reason: collision with root package name */
    public static final int f47998I = 8;
    ...
    private InterfaceC13428B indicationNodeFactory;
    ...
    private final C13452t focusableNode;

    /* renamed from: y, reason: collision with root package name and from kotlin metadata */
    private W pointerInputNode;

    /* renamed from: z, reason: collision with root package name and from kotlin metadata */
    private InterfaceC5814j indicationNode;
    ...
    static final class c extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        final /* synthetic */ h0.l f48018b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ h0.g f48019c;

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new c(this.f48018b, this.f48019c, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                ResultKt.b(obj);
                h0.l lVar = this.f48018b;
                h0.g gVar = this.f48019c;
                this.f48017a = 1;
    ...
    static final class d extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ h0.l f48021b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ h0.h f48022c;

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new d(this.f48021b, this.f48022c, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                ResultKt.b(obj);
                h0.l lVar = this.f48021b;
                h0.h hVar = this.f48022c;
                this.f48020a = 1;
    ...
    static final class f extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: c, reason: collision with root package name */
        private /* synthetic */ Object f48025c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ InterfaceC13783A f48026d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ long f48027e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ h0.l f48028f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ a f48029g;
        ...
        static final class C0977a extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
            ...
            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ a f48032c;

            /* renamed from: d, reason: collision with root package name */
            final /* synthetic */ long f48033d;

            /* renamed from: e, reason: collision with root package name */
            final /* synthetic */ h0.l f48034e;

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C0977a(this.f48032c, this.f48033d, this.f48034e, continuation);
            }

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C0977a(a aVar, long j10, h0.l lVar, Continuation<? super C0977a> continuation) {
                super(2, continuation);
                this.f48032c = aVar;
                this.f48033d = j10;
                this.f48034e = lVar;
            ...
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(InterfaceC16622O interfaceC16622O, Continuation<? super Unit> continuation) {
                return ((C0977a) create(interfaceC16622O, continuation)).invokeSuspend(Unit.f142422a);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i10 != 0) {
                    if (i10 != 1) {
                        if (i10 == 2) {
                            bVar = (n.b) this.f48030a;
                            ResultKt.b(obj);
                            this.f48032c.pressInteraction = bVar;
                            return Unit.f142422a;
                        }
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                    }
                ...
                n.b bVar2 = new n.b(this.f48033d, null);
                h0.l lVar = this.f48034e;
                this.f48030a = bVar2;
                this.f48031b = 2;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            f fVar = new f(this.f48026d, this.f48027e, this.f48028f, this.f48029g, continuation);
            fVar.f48025c = obj;
            return fVar;
        }

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        f(InterfaceC13783A interfaceC13783A, long j10, h0.l lVar, a aVar, Continuation<? super f> continuation) {
            super(2, continuation);
            this.f48026d = interfaceC13783A;
            this.f48027e = j10;
            this.f48028f = lVar;
            this.f48029g = aVar;
        }
    ...
    static final class g extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ n.b f48037c;

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return a.this.new g(this.f48037c, continuation);
        }
    ...
    static final class h extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ n.b f48040c;

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return a.this.new h(this.f48040c, continuation);
        }
    ...
    static final class i extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ n.b f48043c;

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return a.this.new i(this.f48043c, continuation);
        }
    ...
    static final class l implements PointerInputEventHandler {
        ...
        public final Object invoke(J j10, Continuation<? super Unit> continuation) {
            ...
            return objY2 == IntrinsicsKt.f() ? objY2 : Unit.f142422a;
        }
    }

    public /* synthetic */ a(h0.l lVar, InterfaceC13428B interfaceC13428B, boolean z10, String str, Role role, Function0 function0, DefaultConstructorMarker defaultConstructorMarker) {
        this(lVar, interfaceC13428B, z10, str, role, function0);
    }
    ...
    private a(h0.l lVar, InterfaceC13428B interfaceC13428B, boolean z10, String str, Role role, Function0<Unit> function0) {
        ...
        this.focusableNode = new C13452t(this.interactionSource, M.INSTANCE.c(), new e(this), null);
        this.currentKeyPressInteractions = C5527z.c();
    ...
    public final void b3() {
        if (this.hoverInteraction == null) {
            ...
            if (lVar != null) {
                C16648k.d(j2(), null, null, new c(lVar, gVar, null), 3, null);
            }
    ...
    public final void c3() {
        ...
        if (gVar != null) {
            ...
            h0.l lVar = this.interactionSource;
            if (lVar != null) {
                C16648k.d(j2(), null, null, new d(lVar, hVar, null), 3, null);
            }
    ...
    private final void g3() {
        InterfaceC13428B interfaceC13428B;
        if (this.indicationNode == null && (interfaceC13428B = this.indicationNodeFactory) != null) {
            ...
            h0.l lVar = this.interactionSource;
            Intrinsics.g(lVar);
            InterfaceC5814j interfaceC5814jA = interfaceC13428B.a(lVar);
            K2(interfaceC5814jA);
            this.indicationNode = interfaceC5814jA;
        }
    }
    ...
    */
    public final void k3(boolean r19) {
        ...
        L33:
            ...
            r17 = 0
            r14 = 0
            qv.C16644i.d(r12, r13, r14, r15, r16, r17)
        L57:
            long r6 = r6 >> r9
            int r10 = r10 + 1
            goto L33
    ...
    */
    ...
    protected final Object f3(InterfaceC13783A interfaceC13783A, long j10, Continuation<? super Unit> continuation) {
        Object objG;
        h0.l lVar = this.interactionSource;
        return (lVar == null || (objG = C16623P.g(new f(interfaceC13783A, j10, lVar, this, null), continuation)) != IntrinsicsKt.f()) ? Unit.f142422a : objG;
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    protected final void n3(h0.l r3, d0.InterfaceC13428B r4, boolean r5, java.lang.String r6, androidx.compose.ui.semantics.Role r7, kotlin.jvm.functions.Function0<kotlin.Unit> r8) {
        /*
            r2 = this;
    ...
    public final boolean Z2() {
        if (!ClickableKt.g(this) && !C13445l.b(this)) {
            return false;
        }
        return true;
    }
    ...
    public final boolean r1(KeyEvent event) {
        ...
        if (this.enabled && ClickableKt.j(event)) {
            if (!this.currentKeyPressInteractions.a(jA)) {
                ...
                if (this.interactionSource != null) {
                    C16648k.d(j2(), null, null, new h(bVar, null), 3, null);
                }
                z10 = true;
            } else {
                z10 = false;
        ...
        if (this.enabled && ClickableKt.h(event)) {
            ...
            if (bVarO != null) {
                if (this.interactionSource != null) {
                    C16648k.d(j2(), null, null, new i(bVarO, null), 3, null);
                }
                j3(event);
            }
            if (bVarO != null) {
    ...
    public final void u2() {
        ...
        InterfaceC5814j interfaceC5814j = this.indicationNode;
