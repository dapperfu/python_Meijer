...
public final class w0 {
    ...
    private static final InterfaceC18354E f49790a = new v0(InterfaceC18354E.INSTANCE.a(), 0, 0);
    ...
    public static final void g(int i10, int i11, int i12) {
        ...
        C14589e.c("OffsetMapping.originalToTransformed returned invalid mapping: " + i12 + " -> " + i10 + " is not in range of transformed text [0, " + i11 + ']');
    }
    ...
    public static final void h(int i10, int i11, int i12) {
        ...
        C14589e.c("OffsetMapping.transformedToOriginal returned invalid mapping: " + i12 + " -> " + i10 + " is not in range of original text [0, " + i11 + ']');
    }

    public static final InterfaceC18354E d() {
        return f49790a;
    }
