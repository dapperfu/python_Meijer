...
public final class C5675g {
    ...
    static final class a extends Lambda implements Function1<TextLayoutResult, Unit> {
        ...
        public static final a f49516f = new a();
    ...
    static final class b extends Lambda implements Function1<TextLayoutResult, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ InterfaceC5730l0<TextLayoutResult> f49517f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function1<TextLayoutResult, Unit> f49518g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        b(InterfaceC5730l0<TextLayoutResult> interfaceC5730l0, Function1<? super TextLayoutResult, Unit> function1) {
            super(1);
            this.f49517f = interfaceC5730l0;
            this.f49518g = function1;
        }

        public final void a(TextLayoutResult textLayoutResult) {
            this.f49517f.setValue(textLayoutResult);
            this.f49518g.invoke(textLayoutResult);
        }
    ...
    static final class c extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ AnnotatedString f49519f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Modifier f49520g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ TextStyle f49521h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ boolean f49522i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ int f49523j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ int f49524k;

        /* renamed from: l, reason: collision with root package name */
        final /* synthetic */ Function1<TextLayoutResult, Unit> f49525l;

        /* renamed from: m, reason: collision with root package name */
        final /* synthetic */ Function1<Integer, Unit> f49526m;

        /* renamed from: n, reason: collision with root package name */
        final /* synthetic */ int f49527n;

        /* renamed from: o, reason: collision with root package name */
        final /* synthetic */ int f49528o;
        ...
        c(AnnotatedString annotatedString, Modifier modifier, TextStyle textStyle, boolean z10, int i10, int i11, Function1<? super TextLayoutResult, Unit> function1, Function1<? super Integer, Unit> function12, int i12, int i13) {
            super(2);
            this.f49519f = annotatedString;
            this.f49520g = modifier;
            this.f49521h = textStyle;
            this.f49522i = z10;
            this.f49523j = i10;
            this.f49524k = i11;
            this.f49525l = function1;
            this.f49526m = function12;
            this.f49527n = i12;
            this.f49528o = i13;
        }

        public final void a(Composer composer, int i10) {
            C5675g.a(this.f49519f, this.f49520g, this.f49521h, this.f49522i, this.f49523j, this.f49524k, this.f49525l, this.f49526m, composer, J0.a(this.f49527n | 1), this.f49528o);
        }
    ...
    static final class d implements PointerInputEventHandler {
        ...
        final /* synthetic */ InterfaceC5730l0<TextLayoutResult> f49529a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function1<Integer, Unit> f49530b;
        ...
        static final class a extends Lambda implements Function1<U0.f, Unit> {
            ...
            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ InterfaceC5730l0<TextLayoutResult> f49531f;

            /* renamed from: g, reason: collision with root package name */
            final /* synthetic */ Function1<Integer, Unit> f49532g;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            a(InterfaceC5730l0<TextLayoutResult> interfaceC5730l0, Function1<? super Integer, Unit> function1) {
                super(1);
                this.f49531f = interfaceC5730l0;
                this.f49532g = function1;
            }

            public final void a(long j10) {
                TextLayoutResult value = this.f49531f.getValue();
                if (value != null) {
                    this.f49532g.invoke(Integer.valueOf(value.x(j10)));
                }
            }
        ...
        /* JADX WARN: Multi-variable type inference failed */
        d(InterfaceC5730l0<TextLayoutResult> interfaceC5730l0, Function1<? super Integer, Unit> function1) {
            this.f49529a = interfaceC5730l0;
            this.f49530b = function1;
        }

        @Override // androidx.compose.ui.input.pointer.PointerInputEventHandler
        public final Object invoke(g1.J j10, Continuation<? super Unit> continuation) {
            Object objM = C13794L.m(j10, null, null, null, new a(this.f49529a, this.f49530b), continuation, 7, null);
            return objM == IntrinsicsKt.f() ? objM : Unit.f142422a;
        }
    }
    ...
    */
    public static final void a(androidx.compose.ui.text.AnnotatedString r27, androidx.compose.ui.Modifier r28, androidx.compose.ui.text.TextStyle r29, boolean r30, int r31, int r32, kotlin.jvm.functions.Function1<? super u1.TextLayoutResult, kotlin.Unit> r33, kotlin.jvm.functions.Function1<? super java.lang.Integer, kotlin.Unit> r34, androidx.compose.runtime.Composer r35, int r36, int r37) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.C5675g.a(androidx.compose.ui.text.AnnotatedString, androidx.compose.ui.Modifier, androidx.compose.ui.text.z, boolean, int, int, kotlin.jvm.functions.Function1, kotlin.jvm.functions.Function1, androidx.compose.runtime.Composer, int, int):void");
    }
}
