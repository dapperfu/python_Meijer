...
public final class b extends Modifier.c implements D, InterfaceC5823t, u0 {
    ...
    private C17442g selectionController;
    ...
    public static final /* data */ class TextSubstitutionValue {
        ...
        private C17440e layoutCache;

        public TextSubstitutionValue(AnnotatedString annotatedString, AnnotatedString annotatedString2, boolean z10, C17440e c17440e) {
            this.original = annotatedString;
            this.substitution = annotatedString2;
            this.isShowingSubstitution = z10;
            this.layoutCache = c17440e;
        }
        ...
        public int hashCode() {
            ...
            C17440e c17440e = this.layoutCache;
            return iHashCode + (c17440e == null ? 0 : c17440e.hashCode());
        }
        ...
        public final C17440e getLayoutCache() {
        ...
        public final void e(C17440e c17440e) {
            this.layoutCache = c17440e;
        }
        ...
        public /* synthetic */ TextSubstitutionValue(AnnotatedString annotatedString, AnnotatedString annotatedString2, boolean z10, C17440e c17440e, int i10, DefaultConstructorMarker defaultConstructorMarker) {
            this(annotatedString, annotatedString2, (i10 & 4) != 0 ? false : z10, (i10 & 8) != 0 ? null : c17440e);
        }
    }
    ...
    static final class C1031b extends Lambda implements Function1<List<TextLayoutResult>, Boolean> {
        C1031b() {
            super(1);
        }
        ...
        */
        public final java.lang.Boolean invoke(java.util.List<u1.TextLayoutResult> r38) {
            /*
                ...
                goto L31
            L2b:
                V0.q0$a r1 = V0.C5346q0.INSTANCE
                long r6 = r1.j()
            L31:
            ...
            Lbd:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.modifiers.b.C1031b.invoke(java.util.List):java.lang.Boolean");
        }
    }
    ...
    static final class f extends Lambda implements Function1<f0.a, Unit> {
        ...
        public final void a(f0.a aVar) {
            f0.a.h(aVar, this.f49689f, 0, 0, 0.0f, 4, null);
        }
    ...
    public /* synthetic */ b(AnnotatedString annotatedString, TextStyle textStyle, AbstractC18142l.b bVar, Function1 function1, int i10, boolean z10, int i11, int i12, List list, Function1 function12, C17442g c17442g, InterfaceC5359x0 interfaceC5359x0, L l10, Function1 function13, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, bVar, function1, i10, z10, i11, i12, list, function12, c17442g, interfaceC5359x0, l10, function13);
    }
    ...
    private b(AnnotatedString annotatedString, TextStyle textStyle, AbstractC18142l.b bVar, Function1<? super TextLayoutResult, Unit> function1, int i10, boolean z10, int i11, int i12, List<AnnotatedString.Range<Placeholder>> list, Function1<? super List<Rect>, Unit> function12, C17442g c17442g, InterfaceC5359x0 interfaceC5359x0, L l10, Function1<? super TextSubstitutionValue, Unit> function13) {
        ...
        this.selectionController = c17442g;
        this.overrideColor = interfaceC5359x0;
        this.onShowTranslation = function13;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final C17440e T2() {
        if (this._layoutCache == null) {
            this._layoutCache = new C17440e(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders, null, null);
        }
        C17440e c17440e = this._layoutCache;
        Intrinsics.g(c17440e);
        return c17440e;
    }

    private final C17440e U2(H1.d density) {
        C17440e layoutCache;
    ...
    public final boolean c3(AnnotatedString updatedText) {
        ...
        if (textSubstitutionValue == null) {
            ...
            C17440e c17440e = new C17440e(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, CollectionsKt.m(), null, null);
            c17440e.l(T2().getDensity());
            textSubstitutionValue2.e(c17440e);
        ...
        C17440e layoutCache = textSubstitutionValue.getLayoutCache();
        if (layoutCache != null) {
    ...
    public void I(X0.c cVar) {
        if (getIsAttached()) {
            C17442g c17442g = this.selectionController;
            if (c17442g != null) {
                c17442g.c(cVar);
            }
            ...
            try {
                ...
                if (abstractC5324i0G != null) {
                    g.I(multiParagraph, canvasG, abstractC5324i0G, this.style.d(), shadow, kVar, gVar, 0, 64, null);
                } else {
                    InterfaceC5359x0 interfaceC5359x0 = this.overrideColor;
                    long jA = interfaceC5359x0 != null ? interfaceC5359x0.a() : C5346q0.INSTANCE.j();
                    if (jA == 16) {
                        jA = this.style.h() != 16 ? this.style.h() : C5346q0.INSTANCE.a();
                    }
                    multiParagraph.F(canvasG, (30 & 2) != 0 ? C5346q0.INSTANCE.j() : jA, (30 & 4) != 0 ? null : shadow, (30 & 8) != 0 ? null : kVar, (30 & 16) == 0 ? gVar : null, (30 & 32) != 0 ? X0.f.INSTANCE.a() : 0);
                }
                if (z11) {
                    canvasG.i();
                }
                TextSubstitutionValue textSubstitutionValue = this.textSubstitution;
                if (!((textSubstitutionValue == null || !textSubstitutionValue.getIsShowingSubstitution()) ? C17445j.a(this.text) : false)) {
    ...
    public void T1(u uVar) {
        Function1 c1031b = this.semanticsTextLayoutResult;
        if (c1031b == null) {
            c1031b = new C1031b();
            this.semanticsTextLayoutResult = c1031b;
        }
        s.z0(uVar, this.text);
        TextSubstitutionValue textSubstitutionValue = this.textSubstitution;
        if (textSubstitutionValue != null) {
    ...
    public final boolean d3(Function1<? super TextLayoutResult, Unit> onTextLayout, Function1<? super List<Rect>, Unit> onPlaceholderLayout, C17442g selectionController, Function1<? super TextSubstitutionValue, Unit> onShowTranslation) {
        boolean z10;
    ...
    public final boolean e3(InterfaceC5359x0 color, TextStyle style) {
        boolean zE = Intrinsics.e(color, this.overrideColor);
        this.overrideColor = color;
        return (zE && style.F(this.style)) ? false : true;
    }

    public final boolean f3(TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int minLines, int maxLines, boolean softWrap, AbstractC18142l.b fontFamilyResolver, int overflow, L autoSize) {
    ...
    public int F(InterfaceC5791s interfaceC5791s, r rVar, int i10) {
        return U2(interfaceC5791s).d(i10, interfaceC5791s.getLayoutDirection());
    }
    ...
    public int N(InterfaceC5791s interfaceC5791s, r rVar, int i10) {
        return U2(interfaceC5791s).i(interfaceC5791s.getLayoutDirection());
    }
    ...
    public final int X2(InterfaceC5791s intrinsicMeasureScope, r measurable, int width) {
        return r(intrinsicMeasureScope, measurable, width);
    }

    public final int Y2(InterfaceC5791s intrinsicMeasureScope, r measurable, int height) {
    ...
    public J a(K k10, I i10, long j10) {
        C17440e c17440eU2 = U2(k10);
        boolean zF = c17440eU2.f(j10, k10.getLayoutDirection());
        TextLayoutResult textLayoutResultC = c17440eU2.c();
        ...
        if (zF) {
            ...
            C17442g c17442g = this.selectionController;
            if (c17442g != null) {
                c17442g.h(textLayoutResultC);
            }
            Map<AbstractC5774a, Integer> linkedHashMap = this.baselineCache;
            if (linkedHashMap == null) {
                linkedHashMap = new LinkedHashMap<>(2);
            }
            linkedHashMap.put(C5775b.a(), Integer.valueOf(Math.round(textLayoutResultC.getFirstBaseline())));
            linkedHashMap.put(C5775b.b(), Integer.valueOf(Math.round(textLayoutResultC.getLastBaseline())));
        ...
        Map<AbstractC5774a, Integer> map = this.baselineCache;
        Intrinsics.g(map);
        return k10.g1(size, size2, map, new f(f0VarK0));
    }

    public final int a3(InterfaceC5791s intrinsicMeasureScope, r measurable, int width) {
        return F(intrinsicMeasureScope, measurable, width);
    }

    public final int b3(InterfaceC5791s intrinsicMeasureScope, r measurable, int height) {
