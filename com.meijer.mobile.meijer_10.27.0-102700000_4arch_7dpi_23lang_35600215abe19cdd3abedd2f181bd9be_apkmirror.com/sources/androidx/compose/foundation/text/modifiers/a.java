...
public final class a extends AbstractC5817m implements D, InterfaceC5823t, InterfaceC5825v {
    ...
    public /* synthetic */ a(AnnotatedString annotatedString, TextStyle textStyle, AbstractC18142l.b bVar, Function1 function1, int i10, boolean z10, int i11, int i12, List list, Function1 function12, C17442g c17442g, InterfaceC5359x0 interfaceC5359x0, L l10, Function1 function13, int i13, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, bVar, (i13 & 8) != 0 ? null : function1, (i13 & 16) != 0 ? t.INSTANCE.a() : i10, (i13 & 32) != 0 ? true : z10, (i13 & 64) != 0 ? Integer.MAX_VALUE : i11, (i13 & 128) != 0 ? 1 : i12, (i13 & 256) != 0 ? null : list, (i13 & 512) != 0 ? null : function12, (i13 & 1024) != 0 ? null : c17442g, (i13 & RecyclerView.m.FLAG_MOVED) != 0 ? null : interfaceC5359x0, (i13 & RecyclerView.m.FLAG_APPEARED_IN_PRE_LAYOUT) != 0 ? null : l10, (i13 & 8192) != 0 ? null : function13, null);
    }

    @Override // androidx.compose.ui.node.D
    public int F(InterfaceC5791s interfaceC5791s, r rVar, int i10) {
        return this.textAnnotatedStringNode.a3(interfaceC5791s, rVar, i10);
    }
    ...
    public int J(InterfaceC5791s interfaceC5791s, r rVar, int i10) {
        return this.textAnnotatedStringNode.b3(interfaceC5791s, rVar, i10);
    }

    @Override // androidx.compose.ui.node.D
    public int N(InterfaceC5791s interfaceC5791s, r rVar, int i10) {
        return this.textAnnotatedStringNode.Y2(interfaceC5791s, rVar, i10);
    }
    ...
    public void O(LayoutCoordinates coordinates) {
        ...
        if (c17442g != null) {
            c17442g.g(coordinates);
        }
    }

    public final void Q2(AnnotatedString text, TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int minLines, int maxLines, boolean softWrap, AbstractC18142l.b fontFamilyResolver, int overflow, Function1<? super TextLayoutResult, Unit> onTextLayout, Function1<? super List<Rect>, Unit> onPlaceholderLayout, C17442g selectionController, InterfaceC5359x0 color, L autoSize) {
    ...
    public int r(InterfaceC5791s interfaceC5791s, r rVar, int i10) {
        return this.textAnnotatedStringNode.X2(interfaceC5791s, rVar, i10);
    }
    ...
    private a(AnnotatedString annotatedString, TextStyle textStyle, AbstractC18142l.b bVar, Function1<? super TextLayoutResult, Unit> function1, int i10, boolean z10, int i11, int i12, List<AnnotatedString.Range<Placeholder>> list, Function1<? super List<Rect>, Unit> function12, C17442g c17442g, InterfaceC5359x0 interfaceC5359x0, L l10, Function1<? super b.TextSubstitutionValue, Unit> function13) {
        ...
        this.textAnnotatedStringNode = (b) K2(new b(annotatedString, textStyle, bVar, function1, i10, z10, i11, i12, list, function12, this.selectionController, interfaceC5359x0, l10, this.onShowTranslation, null));
        if (this.selectionController != null) {
            return;
        }
        C14589e.b("Do not use SelectionCapableStaticTextModifier unless selectionController != null");
