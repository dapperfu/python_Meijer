...
public final class d0 {
    ...
    private static final L0.k<d0, Object> f49370h = L0.a.a(a.f49377f, b.f49378f);

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5724i0 offset;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5724i0 maximum;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5726j0 viewportSize;
    ...
    private final InterfaceC5730l0 orientation;
    ...
    static final class b extends Lambda implements Function1<List<? extends Object>, d0> {
        ...
        public static final b f49378f = new b();
        ...
        public final d0 invoke(List<? extends Object> list) {
            ...
            EnumC13827z enumC13827z = ((Boolean) obj).booleanValue() ? EnumC13827z.f130585a : EnumC13827z.f130586b;
            Object obj2 = list.get(0);
            Intrinsics.h(obj2, "null cannot be cast to non-null type kotlin.Float");
            return new d0(enumC13827z, ((Float) obj2).floatValue());
        }
    }
    ...
    public d0(EnumC13827z enumC13827z, float f10) {
        this.offset = A0.a(f10);
        this.maximum = A0.a(0.0f);
        this.viewportSize = C5702c1.a(0);
        this.previousCursorRect = Rect.INSTANCE.a();
        this.previousSelection = androidx.compose.ui.text.y.INSTANCE.a();
        this.orientation = o1.i(enumC13827z, o1.r());
    }

    public final void k(EnumC13827z orientation, Rect cursorRect, int containerSize, int textFieldSize) {
        ...
        if (cursorRect.getLeft() != this.previousCursorRect.getLeft() || cursorRect.getTop() != this.previousCursorRect.getTop()) {
            boolean z10 = orientation == EnumC13827z.f130585a;
    ...
    static final class a extends Lambda implements Function2<L0.m, d0, List<? extends Object>> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final a f49377f = new a();
        ...
        public final List<Object> invoke(L0.m mVar, d0 d0Var) {
            ...
            if (d0Var.f() == EnumC13827z.f130585a) {
                z10 = true;
            } else {
                z10 = false;
            }
    ...
    public final EnumC13827z f() {
        return (EnumC13827z) this.orientation.getValue();
    }
    ...
    public /* synthetic */ d0(EnumC13827z enumC13827z, float f10, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(enumC13827z, (i10 & 2) != 0 ? 0.0f : f10);
    }

    public d0() {
        this(EnumC13827z.f130585a, 0.0f, 2, null);
    }
}
