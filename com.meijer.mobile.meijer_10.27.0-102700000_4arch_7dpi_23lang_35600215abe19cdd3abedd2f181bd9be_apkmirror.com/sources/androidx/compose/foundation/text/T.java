...
public final class T {
    ...
    public static final class Companion {
        ...
        static final class C1012a extends Lambda implements Function1<List<? extends InterfaceC18363i>, Unit> {

            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ C18365k f49264f;

            /* renamed from: g, reason: collision with root package name */
            final /* synthetic */ Function1<TextFieldValue, Unit> f49265g;

            /* renamed from: h, reason: collision with root package name */
            final /* synthetic */ Ref.ObjectRef<z1.T> f49266h;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C1012a(C18365k c18365k, Function1<? super TextFieldValue, Unit> function1, Ref.ObjectRef<z1.T> objectRef) {
                super(1);
                this.f49264f = c18365k;
                this.f49265g = function1;
                this.f49266h = objectRef;
            }

            public final void a(List<? extends InterfaceC18363i> list) {
                T.INSTANCE.g(list, this.f49264f, this.f49265g, this.f49266h.f142835a);
            }

            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(List<? extends InterfaceC18363i> list) {
                a(list);
        ...
        static final class b extends Lambda implements Function1<C5331k1, Unit> {

            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ LayoutCoordinates f49267f;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            b(LayoutCoordinates layoutCoordinates) {
                super(1);
                this.f49267f = layoutCoordinates;
            }

            public final void a(float[] fArr) {
                if (this.f49267f.isAttached()) {
                    LayoutCoordinatesKt.c(this.f49267f).O(this.f49267f, fArr);
                }
            }
        ...
        @JvmStatic
        public final void j(long position, h0 textLayoutResult, C18365k editProcessor, InterfaceC18354E offsetMapping, Function1<? super TextFieldValue, Unit> onValueChange) {
            onValueChange.invoke(TextFieldValue.c(editProcessor.getMBufferState(), null, C17207A.a(offsetMapping.a(h0.e(textLayoutResult, position, false, 2, null))), null, 5, null));
        }
        ...
        @JvmStatic
        public final void e(TextFieldValue value, N textDelegate, TextLayoutResult textLayoutResult, LayoutCoordinates layoutCoordinates, z1.T textInputSession, boolean hasFocus, InterfaceC18354E offsetMapping) {
            if (hasFocus) {
        ...
        @JvmStatic
        public final z1.T i(z1.O textInputService, TextFieldValue value, C18365k editProcessor, ImeOptions imeOptions, Function1<? super TextFieldValue, Unit> onValueChange, Function1<? super androidx.compose.ui.text.input.a, Unit> onImeActionPerformed) {
            Ref.ObjectRef objectRef = new Ref.ObjectRef();
            ?? D10 = textInputService.d(value, imeOptions, new C1012a(editProcessor, onValueChange, objectRef), onImeActionPerformed);
            objectRef.f142835a = D10;
            return D10;
        }

        private final void c(Canvas canvas, long range, InterfaceC18354E offsetMapping, TextLayoutResult textLayoutResult, o1 paint) {
        ...
        @JvmStatic
        public final void b(Canvas canvas, TextFieldValue value, long selectionPreviewHighlightRange, long deletionPreviewHighlightRange, InterfaceC18354E offsetMapping, TextLayoutResult textLayoutResult, o1 highlightPaint, long selectionBackgroundColor) {
            long jA;
            if (!androidx.compose.ui.text.y.h(selectionPreviewHighlightRange)) {
                ...
                C5346q0 c5346q0M = C5346q0.m(textLayoutResult.getLayoutInput().getStyle().h());
                if (c5346q0M.getValue() == 16) {
                    c5346q0M = null;
                }
                if (c5346q0M != null) {
                    jA = c5346q0M.getValue();
                } else {
                    jA = C5346q0.INSTANCE.a();
                }
                long j10 = jA;
                highlightPaint.x(C5346q0.q(j10, C5346q0.t(j10) * 0.2f, 0.0f, 0.0f, 0.0f, 14, null));
            ...
            u1.z.f162642a.a(canvas, textLayoutResult);
        }
        ...
        @JvmStatic
        public final void f(z1.T textInputSession, C18365k editProcessor, Function1<? super TextFieldValue, Unit> onValueChange) {
            onValueChange.invoke(TextFieldValue.c(editProcessor.getMBufferState(), null, 0L, null, 3, null));
            textInputSession.a();
        }

        @JvmStatic
        public final void g(List<? extends InterfaceC18363i> ops, C18365k editProcessor, Function1<? super TextFieldValue, Unit> onValueChange, z1.T session) {
        ...
        @JvmStatic
        public final z1.T h(z1.O textInputService, TextFieldValue value, C18365k editProcessor, ImeOptions imeOptions, Function1<? super TextFieldValue, Unit> onValueChange, Function1<? super androidx.compose.ui.text.input.a, Unit> onImeActionPerformed) {
            return i(textInputService, value, editProcessor, imeOptions, onValueChange, onImeActionPerformed);
        }

        @JvmStatic
        public final void k(z1.T textInputSession, TextFieldValue textFieldValue, InterfaceC18354E offsetMapping, h0 textLayoutResult) {
            ...
            if (innerTextFieldCoordinates != null && innerTextFieldCoordinates.isAttached() && (decorationBoxCoordinates = textLayoutResult.getDecorationBoxCoordinates()) != null) {
                textInputSession.e(textFieldValue, offsetMapping, textLayoutResult.getValue(), new b(innerTextFieldCoordinates), C17699H.i(innerTextFieldCoordinates), innerTextFieldCoordinates.b0(decorationBoxCoordinates, false));
            }
        }
    }
}
