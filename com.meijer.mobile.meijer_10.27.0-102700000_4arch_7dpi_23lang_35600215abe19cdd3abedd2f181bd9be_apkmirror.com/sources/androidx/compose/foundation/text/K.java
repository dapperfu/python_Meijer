...
final class K {
    ...
    static final class a extends Lambda implements Function1<AnnotatedString.Range<? extends AnnotatedString.a>, AnnotatedString.Range<? extends AnnotatedString.a>> {
        ...
        final /* synthetic */ Ref.BooleanRef f49228f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ AnnotatedString.Range<androidx.compose.ui.text.f> f49229g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ SpanStyle f49230h;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(Ref.BooleanRef booleanRef, AnnotatedString.Range<androidx.compose.ui.text.f> range, SpanStyle spanStyle) {
            super(1);
            this.f49228f = booleanRef;
            this.f49229g = range;
            this.f49230h = spanStyle;
        }
        ...
        public final AnnotatedString.Range<? extends AnnotatedString.a> invoke(AnnotatedString.Range<? extends AnnotatedString.a> range) {
            ...
            if (this.f49228f.f142828a && (range.g() instanceof SpanStyle) && range.h() == this.f49229g.h() && range.f() == this.f49229g.f()) {
                SpanStyle spanStyle = this.f49230h;
                if (spanStyle == null) {
            ...
            this.f49228f.f142828a = Intrinsics.e(this.f49229g, range);
            return range2;
        }
    }
