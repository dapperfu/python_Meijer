...
public final class b0 {
    ...
    public static final class b extends Lambda implements Function1<N0, Unit> {
        ...
        final /* synthetic */ d0 f49355f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ h0.l f49356g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ boolean f49357h;
        ...
        public final void a(N0 n02) {
            ...
            n02.getProperties().c("scrollerPosition", this.f49355f);
            n02.getProperties().c("interactionSource", this.f49356g);
            n02.getProperties().c("enabled", Boolean.valueOf(this.f49357h));
        }
    ...
    static final class c extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        ...
        static final class a extends Lambda implements Function1<Float, Float> {
            ...
            public final Float b(float f10) {
                float fD = this.f49361f.d() + f10;
                if (fD > this.f49361f.c()) {
                    f10 = this.f49361f.c() - this.f49361f.d();
                } else if (fD < 0.0f) {
                    f10 = -this.f49361f.d();
                }
                d0 d0Var = this.f49361f;
                d0Var.h(d0Var.d() + f10);
        ...
        @SourceDebugExtension
        public static final class b implements InterfaceC13790H {

            /* renamed from: a, reason: collision with root package name */
            private final /* synthetic */ InterfaceC13790H f49362a;
            ...
            static final class a extends Lambda implements Function0<Boolean> {
                ...
                public final Boolean invoke() {
                    return Boolean.valueOf(this.f49365f.d() > 0.0f);
                }
            }

            @Metadata(d1 = {"\u0000\b\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0001\u001a\u00020\u0000H\n¢\u0006\u0004\b\u0001\u0010\u0002"}, d2 = {"", "c", "()Ljava/lang/Boolean;"}, k = 3, mv = {1, 9, 0})
            /* renamed from: androidx.compose.foundation.text.b0$c$b$b, reason: collision with other inner class name */
            static final class C1026b extends Lambda implements Function0<Boolean> {

                /* renamed from: f, reason: collision with root package name */
                final /* synthetic */ d0 f49366f;
                ...
                /* renamed from: c, reason: merged with bridge method [inline-methods] */
                public final Boolean invoke() {
                    return Boolean.valueOf(this.f49366f.d() < this.f49366f.c());
                }
            }
            ...
            public Object a(EnumC13431E enumC13431E, Function2<? super InterfaceC13787E, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) {
                return this.f49362a.a(enumC13431E, function2, continuation);
            }
            ...
            b(InterfaceC13790H interfaceC13790H, d0 d0Var) {
                this.f49362a = interfaceC13790H;
                this.canScrollForward = o1.e(new C1026b(d0Var));
        ...
        public final Modifier a(Modifier modifier, Composer composer, int i10) {
            ...
            if (composer.o(C5892t0.m()) == H1.t.f12007b) {
                z10 = true;
            } else {
                z10 = false;
            }
            if (this.f49358f.f() != EnumC13827z.f130585a && z10) {
                z11 = false;
            } else {
                z11 = true;
            }
            boolean zV = composer.V(this.f49358f);
            d0 d0Var = this.f49358f;
            Object objB = composer.B();
            if (zV || objB == Composer.INSTANCE.a()) {
                objB = new a(d0Var);
                composer.t(objB);
            }
            InterfaceC13790H interfaceC13790HB = C13791I.b((Function1) objB, composer, 0);
            boolean zV2 = composer.V(interfaceC13790HB) | composer.V(this.f49358f);
            d0 d0Var2 = this.f49358f;
            Object objB2 = composer.B();
            if (zV2 || objB2 == Composer.INSTANCE.a()) {
                objB2 = new b(interfaceC13790HB, d0Var2);
                composer.t(objB2);
            }
            b bVar = (b) objB2;
            Modifier.Companion companion = Modifier.INSTANCE;
            EnumC13827z enumC13827zF = this.f49358f.f();
            if (this.f49359g && this.f49358f.c() != 0.0f) {
                z12 = true;
            } else {
                z12 = false;
            }
            Modifier modifierK = androidx.compose.foundation.gestures.g.k(companion, bVar, enumC13827zF, z12, z11, null, this.f49360h, 16, null);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
            composer.P();
    ...
    public static final Modifier b(Modifier modifier, d0 d0Var, TextFieldValue textFieldValue, z1.W w10, Function0<h0> function0) {
        Modifier x0Var;
        EnumC13827z enumC13827zF = d0Var.f();
        ...
        int i10 = a.$EnumSwitchMapping$0[enumC13827zF.ordinal()];
        if (i10 != 1) {
            if (i10 == 2) {
                x0Var = new C5685q(d0Var, iE, transformedTextC, function0);
            } else {
