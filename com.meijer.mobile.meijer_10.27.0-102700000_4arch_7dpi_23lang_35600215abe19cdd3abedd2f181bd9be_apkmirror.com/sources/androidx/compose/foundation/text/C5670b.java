...
public final class C5670b {
    ...
    private static final Pair<List<AnnotatedString.Range<Placeholder>>, List<AnnotatedString.Range<Function3<String, Composer, Integer, Unit>>>> f49349a = new Pair<>(CollectionsKt.m(), CollectionsKt.m());
    ...
    static final class a implements MeasurePolicy {
        ...
        static final class C1024a extends Lambda implements Function1<f0.a, Unit> {

            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ List<androidx.compose.ui.layout.f0> f49351f;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C1024a(List<? extends androidx.compose.ui.layout.f0> list) {
                super(1);
                this.f49351f = list;
            }

            public final void a(f0.a aVar) {
                List<androidx.compose.ui.layout.f0> list = this.f49351f;
                int size = list.size();
        ...
        public final androidx.compose.ui.layout.J d(androidx.compose.ui.layout.K k10, List<? extends androidx.compose.ui.layout.I> list, long j10) {
            ...
            return androidx.compose.ui.layout.K.G0(k10, H1.b.l(j10), H1.b.k(j10), null, new C1024a(arrayList), 4, null);
        }
    }

    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    /* renamed from: androidx.compose.foundation.text.b$b, reason: collision with other inner class name */
    static final class C1025b extends Lambda implements Function2<Composer, Integer, Unit> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ AnnotatedString f49352f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ List<AnnotatedString.Range<Function3<String, Composer, Integer, Unit>>> f49353g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f49354h;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C1025b(AnnotatedString annotatedString, List<AnnotatedString.Range<Function3<String, Composer, Integer, Unit>>> list, int i10) {
            super(2);
            this.f49352f = annotatedString;
            this.f49353g = list;
            this.f49354h = i10;
        }

        public final void a(Composer composer, int i10) {
            C5670b.a(this.f49352f, this.f49353g, composer, J0.a(this.f49354h | 1));
        }
    ...
    public static final void a(AnnotatedString annotatedString, List<AnnotatedString.Range<Function3<String, Composer, Integer, Unit>>> list, Composer composer, int i10) {
        ...
        if (composerStartRestartGroup.p((i11 & 19) != 18, i11 & 1)) {
            ...
            while (i13 < size) {
                ...
                int iA = C5717f.a(composerStartRestartGroup, i12);
        ...
        if (t0L != null) {
            t0L.a(new C1025b(annotatedString, list, i10));
        }
    }
