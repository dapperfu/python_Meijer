...
public final class N {
    ...
    public /* synthetic */ N(AnnotatedString annotatedString, TextStyle textStyle, int i10, int i11, boolean z10, int i12, H1.d dVar, AbstractC18142l.b bVar, List list, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, i10, i11, z10, i12, dVar, bVar, list);
    }

    private N(AnnotatedString annotatedString, TextStyle textStyle, int i10, int i11, boolean z10, int i12, H1.d dVar, AbstractC18142l.b bVar, List<AnnotatedString.Range<Placeholder>> list) {
        ...
        if (!(i10 > 0)) {
            C14589e.a("no maxLines");
        }
        if (!(i11 > 0)) {
            C14589e.a("no minLines");
        }
        if (i11 <= i10) {
            return;
        }
        C14589e.a("minLines greater than maxLines");
    }
    ...
    public final void m(H1.t layoutDirection) {
        ...
        if (hVar == null || layoutDirection != this.intrinsicsLayoutDirection || hVar.a()) {
            ...
            hVar = new androidx.compose.ui.text.h(this.text, C17208B.d(this.style, layoutDirection), this.placeholders, this.density, this.fontFamilyResolver);
        }
    ...
    public /* synthetic */ N(AnnotatedString annotatedString, TextStyle textStyle, int i10, int i11, boolean z10, int i12, H1.d dVar, AbstractC18142l.b bVar, List list, int i13, DefaultConstructorMarker defaultConstructorMarker) {
