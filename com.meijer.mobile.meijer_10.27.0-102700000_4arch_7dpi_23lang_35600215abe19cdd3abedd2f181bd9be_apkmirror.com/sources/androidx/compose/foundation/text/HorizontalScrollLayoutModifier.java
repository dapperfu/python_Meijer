...
final /* data */ class HorizontalScrollLayoutModifier implements androidx.compose.ui.layout.B {
    ...
    static final class a extends Lambda implements Function1<f0.a, Unit> {
        ...
        final /* synthetic */ androidx.compose.ui.layout.K f49715f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ HorizontalScrollLayoutModifier f49716g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ androidx.compose.ui.layout.f0 f49717h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ int f49718i;
        ...
        a(androidx.compose.ui.layout.K k10, HorizontalScrollLayoutModifier horizontalScrollLayoutModifier, androidx.compose.ui.layout.f0 f0Var, int i10) {
            super(1);
            this.f49715f = k10;
            this.f49716g = horizontalScrollLayoutModifier;
            this.f49717h = f0Var;
            this.f49718i = i10;
        }

        public final void a(f0.a aVar) {
            androidx.compose.ui.layout.K k10 = this.f49715f;
            int cursorOffset = this.f49716g.getCursorOffset();
            TransformedText transformedText = this.f49716g.getTransformedText();
            h0 h0VarInvoke = this.f49716g.n().invoke();
            this.f49716g.getScrollerPosition().k(EnumC13827z.f130586b, b0.c(k10, cursorOffset, transformedText, h0VarInvoke != null ? h0VarInvoke.getValue() : null, this.f49715f.getLayoutDirection() == H1.t.f12007b, this.f49717h.getWidth()), this.f49718i, this.f49717h.getWidth());
            f0.a.l(aVar, this.f49717h, Math.round(-this.f49716g.getScrollerPosition().d()), 0, 0.0f, 4, null);
        }
