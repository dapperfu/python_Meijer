...
final class m0 implements MeasurePolicy {
    ...
    static final class a extends Lambda implements Function1<f0.a, Unit> {
        ...
        final /* synthetic */ List<Pair<androidx.compose.ui.layout.f0, H1.n>> f49626f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ List<Pair<androidx.compose.ui.layout.f0, Function0<H1.n>>> f49627g;
        ...
        public final void a(f0.a aVar) {
            List<Pair<androidx.compose.ui.layout.f0, H1.n>> list = this.f49626f;
            if (list != null) {
                int size = list.size();
            ...
            List<Pair<androidx.compose.ui.layout.f0, Function0<H1.n>>> list2 = this.f49627g;
            if (list2 != null) {
    ...
    public androidx.compose.ui.layout.J d(androidx.compose.ui.layout.K k10, List<? extends androidx.compose.ui.layout.I> list, long j10) {
        ...
        return androidx.compose.ui.layout.K.G0(k10, H1.b.l(j10), H1.b.k(j10), null, new a(arrayList, C5674f.k(arrayList4, this.shouldMeasureLinks)), 4, null);
    }
