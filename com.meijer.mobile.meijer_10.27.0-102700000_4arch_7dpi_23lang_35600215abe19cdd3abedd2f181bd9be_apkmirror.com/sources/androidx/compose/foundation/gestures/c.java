...
public final class c<T> implements InterfaceC13816o<T> {
    ...
    @Override // kotlin.InterfaceC13816o
    ...
    public float c(T anchor) {
        ...
        float[] fArr = this.anchors;
        return (iIndexOf < 0 || iIndexOf > ArraysKt.j0(fArr)) ? ((Number) a.f48132b.invoke(Integer.valueOf(iIndexOf))).floatValue() : fArr[iIndexOf];
    }
    ...
    public float i(int index) {
        float[] fArr = this.anchors;
        return (index < 0 || index > ArraysKt.j0(fArr)) ? ((Number) a.f48132b.invoke(Integer.valueOf(index))).floatValue() : fArr[index];
    }
