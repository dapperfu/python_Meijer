...
@Metadata(d1 = {"\u0000:\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\"\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0003\u001a/\u0010\u0005\u001a\b\u0012\u0004\u0012\u00028\u00000\u0004\"\u0004\b\u0000\u0010\u0000*\b\u0012\u0004\u0012\u00028\u00000\u00012\b\b\u0002\u0010\u0003\u001a\u00020\u0002H\u0007¢\u0006\u0004\b\u0005\u0010\u0006\u001aA\u0010\n\u001a\b\u0012\u0004\u0012\u00028\u00010\u0004\"\b\b\u0000\u0010\u0000*\u00028\u0001\"\u0004\b\u0001\u0010\u0007*\b\u0012\u0004\u0012\u00028\u00000\b2\u0006\u0010\t\u001a\u00028\u00012\b\b\u0002\u0010\u0003\u001a\u00020\u0002H\u0007¢\u0006\u0004\b\n\u0010\u000b\u001a'\u0010\u000e\u001a\b\u0012\u0004\u0012\u00028\u00000\b\"\u0004\b\u0000\u0010\u00002\f\u0010\r\u001a\b\u0012\u0004\u0012\u00028\u00000\f¢\u0006\u0004\b\u000e\u0010\u000f\u001a'\u0010\u0015\u001a\u00020\u0014*\b\u0012\u0004\u0012\u00020\u00110\u00102\f\u0010\u0013\u001a\b\u0012\u0004\u0012\u00020\u00110\u0012H\u0002¢\u0006\u0004\b\u0015\u0010\u0016¨\u0006\u0017"}, d2 = {"T", "Ltv/P;", "Lkotlin/coroutines/CoroutineContext;", "context", "Landroidx/compose/runtime/z1;", "c", "(Ltv/P;Lkotlin/coroutines/CoroutineContext;Landroidx/compose/runtime/Composer;II)Landroidx/compose/runtime/z1;", "R", "Ltv/f;", "initial", "b", "(Ltv/f;Ljava/lang/Object;Lkotlin/coroutines/CoroutineContext;Landroidx/compose/runtime/Composer;II)Landroidx/compose/runtime/z1;", "Lkotlin/Function0;", "block", "e", "(Lkotlin/jvm/functions/Function0;)Ltv/f;", "LZ/X;", "", "", "set", "", "d", "(LZ/X;Ljava/util/Set;)Z", "runtime_release"}, k = 5, mv = {1, 9, 0}, xi = 48, xs = "androidx/compose/runtime/SnapshotStateKt")
...
final /* synthetic */ class r1 {
    ...
    static final class a<R> extends SuspendLambda implements Function2<D0<R>, Continuation<? super Unit>, Object> {
        ...
        private /* synthetic */ Object f50351b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ CoroutineContext f50352c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ InterfaceC17152f<T> f50353d;
        ...
        static final class C1040a<T> implements InterfaceC17153g {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ D0<R> f50354a;
            ...
            public final Object emit(T t10, Continuation<? super Unit> continuation) {
                this.f50354a.setValue(t10);
                return Unit.f142422a;
            }
        }

        @Metadata(d1 = {"\u0000\u0010\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0004\u001a\u00020\u0003\"\b\b\u0000\u0010\u0000*\u00028\u0001\"\u0004\b\u0001\u0010\u0001*\u00020\u0002H\u008a@¢\u0006\u0004\b\u0004\u0010\u0005"}, d2 = {"T", "R", "Lqv/O;", "", "<anonymous>", "(Lqv/O;)V"}, k = 3, mv = {1, 9, 0})
        ...
        static final class b extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ InterfaceC17152f<T> f50356b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ D0<R> f50357c;

            @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\u0010\u0000\u001a\u00020\u0001\"\b\b\u0000\u0010\u0002*\u0002H\u0003\"\u0004\b\u0001\u0010\u00032\u0006\u0010\u0004\u001a\u0002H\u0002H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, d2 = {"<anonymous>", "", "T", "R", "it", "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, k = 3, mv = {1, 9, 0}, xi = 48)
            /* renamed from: androidx.compose.runtime.r1$a$b$a, reason: collision with other inner class name */
            static final class C1041a<T> implements InterfaceC17153g {

                /* renamed from: a, reason: collision with root package name */
                final /* synthetic */ D0<R> f50358a;
            ...
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new b(this.f50356b, this.f50357c, continuation);
            }

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            b(InterfaceC17152f<? extends T> interfaceC17152f, D0<R> d02, Continuation<? super b> continuation) {
                super(2, continuation);
                this.f50356b = interfaceC17152f;
                this.f50357c = d02;
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i10 != 0) {
                    ...
                    ResultKt.b(obj);
                    InterfaceC17152f<T> interfaceC17152f = this.f50356b;
                    C1041a c1041a = new C1041a(this.f50357c);
                    this.f50355a = 1;
                    if (interfaceC17152f.collect(c1041a, this) == objF) {
                        return objF;
                    }
                }
                return Unit.f142422a;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            a aVar = new a(this.f50352c, this.f50353d, continuation);
            aVar.f50351b = obj;
            return aVar;
        }
        ...
        public final Object invoke(D0<R> d02, Continuation<? super Unit> continuation) {
            return ((a) create(d02, continuation)).invokeSuspend(Unit.f142422a);
        }

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        a(CoroutineContext coroutineContext, InterfaceC17152f<? extends T> interfaceC17152f, Continuation<? super a> continuation) {
            super(2, continuation);
            this.f50352c = coroutineContext;
            this.f50353d = interfaceC17152f;
        }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:16:0x004c, code lost:
            ...
            if (qv.C16644i.g(r1, r3, r6) == r0) goto L17;
         */
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r7) {
            ...
            L1b:
                kotlin.ResultKt.b(r7)
                java.lang.Object r7 = r6.f50351b
                androidx.compose.runtime.D0 r7 = (androidx.compose.runtime.D0) r7
                kotlin.coroutines.CoroutineContext r1 = r6.f50352c
                kotlin.coroutines.EmptyCoroutineContext r4 = kotlin.coroutines.EmptyCoroutineContext.f142646a
                boolean r1 = kotlin.jvm.internal.Intrinsics.e(r1, r4)
                if (r1 == 0) goto L3c
                tv.f<T> r1 = r6.f50353d
            ...
            L3c:
                ...
                tv.f<T> r4 = r6.f50353d
                r5 = 0
                r3.<init>(r4, r7, r5)
                r6.f50350a = r2
                java.lang.Object r7 = qv.C16644i.g(r1, r3, r6)
                if (r7 != r0) goto L4f
            L4e:
                return r0
            L4f:
    ...
    @Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0003\u001a\u00020\u0002\"\u0004\b\u0000\u0010\u0000*\b\u0012\u0004\u0012\u00028\u00000\u0001H\u008a@¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"T", "Ltv/g;", "", "<anonymous>", "(Ltv/g;)V"}, k = 3, mv = {1, 9, 0})
    ...
    @SourceDebugExtension
    static final class b<T> extends SuspendLambda implements Function2<InterfaceC17153g<? super T>, Continuation<? super Unit>, Object> {
        ...
        private /* synthetic */ Object f50366h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ Function0<T> f50367i;
        ...
        static final class a extends Lambda implements Function1<Object, Unit> {
            ...
            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ Z.X<Object> f50368f;
        ...
        static final class C1042b extends Lambda implements Function2<Set<? extends Object>, androidx.compose.runtime.snapshots.g, Unit> {

            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ sv.g<Set<Object>> f50369f;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C1042b(sv.g<Set<Object>> gVar) {
                super(2);
                this.f50369f = gVar;
            }
        ...
        b(Function0<? extends T> function0, Continuation<? super b> continuation) {
            super(2, continuation);
            this.f50367i = function0;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            b bVar = new b(this.f50367i, continuation);
            bVar.f50366h = obj;
            return bVar;
        }
        ...
        /* JADX WARN: Type inference failed for: r10v1, types: [java.lang.Object, tv.g] */
        ...
        /* JADX WARN: Type inference failed for: r11v1, types: [java.lang.Object, tv.g] */
    ...
    public static final <T extends R, R> z1<R> b(InterfaceC17152f<? extends T> interfaceC17152f, R r10, CoroutineContext coroutineContext, Composer composer, int i10, int i11) {
        if ((i11 & 2) != 0) {
        ...
        boolean zD = composer.D(coroutineContext2) | composer.D(interfaceC17152f);
        Object objB = composer.B();
        if (zD || objB == Composer.INSTANCE.a()) {
            objB = new a(coroutineContext2, interfaceC17152f, null);
            composer.t(objB);
        }
        z1<R> z1VarL = o1.l(r10, interfaceC17152f, coroutineContext2, (Function2) objB, composer, ((i10 >> 3) & 14) | ((i10 << 3) & 112) | (i10 & 896));
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        return z1VarL;
    ...
    public static final <T> z1<T> c(tv.P<? extends T> p10, CoroutineContext coroutineContext, Composer composer, int i10, int i11) {
        if ((i11 & 1) != 0) {
            coroutineContext = EmptyCoroutineContext.f142646a;
        }
        CoroutineContext coroutineContext2 = coroutineContext;
    ...
    */
    ...
    public static final <T> InterfaceC17152f<T> e(Function0<? extends T> function0) {
        return C17154h.E(new b(function0, null));
    }
}
