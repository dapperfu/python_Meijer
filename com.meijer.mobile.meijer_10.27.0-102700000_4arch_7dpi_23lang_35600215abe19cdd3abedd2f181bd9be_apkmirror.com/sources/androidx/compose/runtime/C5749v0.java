...
final class C5749v0<T> extends MutableState<T> implements Parcelable {

    @JvmField
    public static final Parcelable.Creator<C5749v0<Object>> CREATOR = new a();
    ...
    public static final class a implements Parcelable.ClassLoaderCreator<C5749v0<Object>> {
        @Override // android.os.Parcelable.Creator
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public C5749v0<Object> createFromParcel(Parcel parcel) {
            return createFromParcel(parcel, null);
        }

        @Override // android.os.Parcelable.ClassLoaderCreator
        /* renamed from: b, reason: merged with bridge method [inline-methods] */
        public C5749v0<Object> createFromParcel(Parcel parcel, ClassLoader loader) {
            n1 n1VarK;
            if (loader == null) {
            ...
            return new C5749v0<>(value, n1VarK);
        }

        @Override // android.os.Parcelable.Creator
        /* renamed from: c, reason: merged with bridge method [inline-methods] */
        public C5749v0<Object>[] newArray(int size) {
            return new C5749v0[size];
        }
    ...
    public C5749v0(T t10, n1<T> n1Var) {
        super(t10, n1Var);
    }
