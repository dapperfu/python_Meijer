...
public final class W {
    ...
    static final class a extends Lambda implements Function1<Throwable, Unit> {
        ...
        final /* synthetic */ InterfaceC16654n<Unit> f50171g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        a(InterfaceC16654n<? super Unit> interfaceC16654n) {
            super(1);
            this.f50171g = interfaceC16654n;
        }

        public final void a(Throwable th2) {
            Object obj = W.this.lock;
            W w10 = W.this;
            InterfaceC16654n<Unit> interfaceC16654n = this.f50171g;
            synchronized (obj) {
                w10.awaiters.remove(interfaceC16654n);
    ...
    public final Object c(Continuation<? super Unit> continuation) {
        ...
        c16658p.C();
        synchronized (this.lock) {
            this.awaiters.add(c16658p);
        }
        c16658p.F(new a(c16658p));
