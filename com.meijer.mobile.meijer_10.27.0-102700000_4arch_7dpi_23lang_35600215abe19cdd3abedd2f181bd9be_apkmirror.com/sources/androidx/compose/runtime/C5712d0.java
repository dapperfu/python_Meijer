...
public final class C5712d0 {
    public static final InterfaceC5698b0 a(CoroutineContext coroutineContext) {
        InterfaceC5698b0 interfaceC5698b0 = (InterfaceC5698b0) coroutineContext.g(InterfaceC5698b0.INSTANCE);
        if (interfaceC5698b0 != null) {
            return interfaceC5698b0;
        }
    ...
    public static final <R> Object b(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        return a(continuation.getF142644a()).J(new C5701c0(function1), continuation);
    }

    public static final <R> Object c(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        return a(continuation.getF142644a()).J(function1, continuation);
    }
}
