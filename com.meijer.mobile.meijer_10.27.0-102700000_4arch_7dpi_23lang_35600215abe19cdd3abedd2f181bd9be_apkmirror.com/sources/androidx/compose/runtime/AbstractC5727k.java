...
public abstract class AbstractC5727k {
    public abstract void a(InterfaceC5756z composition, Function2<? super Composer, ? super Integer, Unit> content);

    public abstract void b(C5720g0 reference);
    ...
    public abstract void j(C5720g0 reference);

    public abstract void k(InterfaceC5756z composition);

    public abstract void l(C5720g0 reference, C5718f0 data, Applier<?> applier);
    ...
    public abstract void p(InterfaceC5756z composition);
    ...
    public abstract void s(InterfaceC5756z composition);

    public InterfaceC5755y0 f() {
        return C5729l.f50286a;
    }
}
