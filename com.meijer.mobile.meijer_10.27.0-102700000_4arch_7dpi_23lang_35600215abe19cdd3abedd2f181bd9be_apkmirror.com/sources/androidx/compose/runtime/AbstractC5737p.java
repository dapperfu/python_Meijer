...
public abstract class AbstractC5737p<T> {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final E1<T> defaultValueHolder;

    public /* synthetic */ AbstractC5737p(Function0 function0, DefaultConstructorMarker defaultConstructorMarker) {
        this(function0);
    }

    public abstract E1<T> b(G0<T> value, E1<T> previous);

    private AbstractC5737p(Function0<? extends T> function0) {
