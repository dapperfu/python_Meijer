...
public final class r {
    ...
    static final class a extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ G0<?>[] f50343f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function2<Composer, Integer, Unit> f50344g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f50345h;
        ...
        a(G0<?>[] g0Arr, Function2<? super Composer, ? super Integer, Unit> function2, int i10) {
            super(2);
            this.f50343f = g0Arr;
            this.f50344g = function2;
            this.f50345h = i10;
        }

        public final void a(Composer composer, int i10) {
            G0<?>[] g0Arr = this.f50343f;
            r.b((G0[]) Arrays.copyOf(g0Arr, g0Arr.length), this.f50344g, composer, J0.a(this.f50345h | 1));
        }
    ...
    static final class b extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ G0<?> f50346f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function2<Composer, Integer, Unit> f50347g;
        ...
        b(G0<?> g02, Function2<? super Composer, ? super Integer, Unit> function2, int i10) {
            super(2);
            this.f50346f = g02;
            this.f50347g = function2;
            this.f50348h = i10;
        }

        public final void a(Composer composer, int i10) {
            r.a(this.f50346f, this.f50347g, composer, J0.a(this.f50348h | 1));
        }
    ...
    public static final <T> F0<T> e(Function1<? super InterfaceC5739q, ? extends T> function1) {
        return new C5752x(function1);
    }
