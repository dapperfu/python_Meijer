...
public class b extends g {
    ...
    private static final a f50378p = new a(null);

    /* renamed from: q, reason: collision with root package name */
    public static final int f50379q = 8;

    /* renamed from: r, reason: collision with root package name */
    private static final int[] f50380r = new int[0];
    ...
    public b(long j10, i iVar, Function1<Object, Unit> function1, Function1<Object, Unit> function12) {
        ...
        this.previousPinnedSnapshots = f50380r;
        this.snapshots = 1;
    }
    ...
    */
    ...
    private final void S() {
        if (this.applied) {
            C5757z0.b("Unsupported operation on a snapshot that has been applied");
        }
    }
    ...
    private final void T() {
        ...
        C5757z0.b("Unsupported operation on a disposed or applied snapshot");
    }
    ...
    */
    ...
    public b R(Function1<Object, Unit> readObserver, Function1<Object, Unit> writeObserver) {
        ...
        if (!getApplied() && !getDisposed()) {
            ...
            synchronized (j.J()) {
                ...
                j.f50422f++;
                v(j11);
                j.f50421e = j.f50421e.t(getSnapshotId());
                Unit unit = Unit.f142422a;
            }
    ...
    public void n(g snapshot) {
        if (!(this.snapshots > 0)) {
            C5757z0.a("no pending nested snapshots");
        }
    ...
    @Override // androidx.compose.runtime.snapshots.g
    public void c() {
        j.f50421e = j.f50421e.p(getSnapshotId()).o(this.previousIds);
    }
