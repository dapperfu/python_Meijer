...
public final class j {
    ...
    private static final long f50418b = 0;

    /* renamed from: e, reason: collision with root package name */
    private static i f50421e;

    /* renamed from: f, reason: collision with root package name */
    private static long f50422f;

    /* renamed from: g, reason: collision with root package name */
    private static final M0.e f50423g;

    /* renamed from: h, reason: collision with root package name */
    private static final q<w> f50424h;

    /* renamed from: i, reason: collision with root package name */
    private static List<? extends Function2<? super Set<? extends Object>, ? super g, Unit>> f50425i;

    /* renamed from: j, reason: collision with root package name */
    private static List<? extends Function1<Object, Unit>> f50426j;

    /* renamed from: k, reason: collision with root package name */
    private static final androidx.compose.runtime.snapshots.a f50427k;

    /* renamed from: l, reason: collision with root package name */
    private static final g f50428l;

    /* renamed from: m, reason: collision with root package name */
    private static J0.a f50429m;

    /* renamed from: a, reason: collision with root package name */
    private static final Function1<i, Unit> f50417a = a.f50430f;

    /* renamed from: c, reason: collision with root package name */
    private static final J0.j<g> f50419c = new J0.j<>();

    /* renamed from: d, reason: collision with root package name */
    private static final Object f50420d = new Object();
    ...
    static final class a extends Lambda implements Function1<i, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final a f50430f = new a();
    ...
    static final class b extends Lambda implements Function1<Object, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function1<Object, Unit> f50431f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function1<Object, Unit> f50432g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(Function1<Object, Unit> function1, Function1<Object, Unit> function12) {
            super(1);
            this.f50431f = function1;
            this.f50432g = function12;
        }
        ...
        public final void invoke2(Object obj) {
            this.f50431f.invoke(obj);
            this.f50432g.invoke(obj);
        }
    }
    ...
    static final class c extends Lambda implements Function1<Object, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function1<Object, Unit> f50433f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function1<Object, Unit> f50434g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        c(Function1<Object, Unit> function1, Function1<Object, Unit> function12) {
            super(1);
            this.f50433f = function1;
            this.f50434g = function12;
        }
        ...
        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final void invoke2(Object obj) {
            this.f50433f.invoke(obj);
            this.f50434g.invoke(obj);
        }
    }
    ...
    static final class d<T> extends Lambda implements Function1<i, T> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function1<i, T> f50435f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        d(Function1<? super i, ? extends T> function1) {
            super(1);
            this.f50435f = function1;
        }
        ...
        public final g invoke(i iVar) {
            g gVar = (g) this.f50435f.invoke(iVar);
            synchronized (j.J()) {
                j.f50421e = j.f50421e.t(gVar.getSnapshotId());
    ...
    */
    public static final <T> T B(kotlin.jvm.functions.Function1<? super androidx.compose.runtime.snapshots.i, ? extends T> r15) {
        /*
            androidx.compose.runtime.snapshots.a r0 = androidx.compose.runtime.snapshots.j.f50427k
            java.lang.Object r1 = J()
            monitor-enter(r1)
            Z.X r2 = r0.E()     // Catch: java.lang.Throwable -> L14
            if (r2 == 0) goto L17
            J0.a r3 = androidx.compose.runtime.snapshots.j.f50429m     // Catch: java.lang.Throwable -> L14
            r4 = 1
        ...
        L17:
            ...
            if (r2 == 0) goto L4a
            r3 = -1
            java.util.List<? extends kotlin.jvm.functions.Function2<? super java.util.Set<? extends java.lang.Object>, ? super androidx.compose.runtime.snapshots.g, kotlin.Unit>> r4 = androidx.compose.runtime.snapshots.j.f50425i     // Catch: java.lang.Throwable -> L3c
            r5 = r4
        ...
        L3c:
            ...
            goto L44
        L3e:
            J0.a r0 = androidx.compose.runtime.snapshots.j.f50429m
            r0.a(r3)
            goto L4a
        L44:
            J0.a r0 = androidx.compose.runtime.snapshots.j.f50429m
        ...
        L96:
            ...
            goto L5e
        L9b:
            kotlin.Unit r1 = kotlin.Unit.f142422a     // Catch: java.lang.Throwable -> L8e
        L9d:
            monitor-exit(r0)
            return r15
        L9f:
    ...
    public static final g I() {
        g gVarA = f50419c.a();
        return gVarA == null ? f50427k : gVarA;
    }
            ...
            if ((((~j12) << 7) & j12 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i14 < i13) {
                    if ((255 & j12) < 128) {
                        ...
                        map2 = map3;
                        y yVarV = wVar.getFirstStateRecord();
                        i10 = i12;
                        y yVarW = W(yVarV, j11, iVar);
                        if (yVarW == null) {
                            jArr2 = jArr3;
                        } else {
                            jArr2 = jArr3;
                            y yVarW2 = W(yVarV, j11, iVarS);
                            if (yVarW2 != null && !Intrinsics.e(yVarW, yVarW2)) {
                                iVar3 = iVarS;
                                y yVarW3 = W(yVarV, bVar.getSnapshotId(), bVar.getInvalid());
                                if (yVarW3 == null) {
                                    V();
                                    throw new KotlinNothingValueException();
                                }
    ...
    public static final <T extends y> T X(T t10, w wVar) {
        ...
        synchronized (J()) {
            g gVarC2 = companion.c();
            y yVarV = wVar.getFirstStateRecord();
            Intrinsics.h(yVarV, "null cannot be cast to non-null type T of androidx.compose.runtime.snapshots.SnapshotKt.readable");
            t11 = (T) W(yVarV, gVarC2.getSnapshotId(), gVarC2.getInvalid());
            if (t11 == null) {
                V();
                throw new KotlinNothingValueException();
            }
    ...
    private static final boolean e0(long j10, long j11, i iVar) {
        return (j11 == f50418b || j11 > j10 || iVar.q(j11)) ? false : true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void g0(g gVar) {
        long jE;
        if (f50421e.q(gVar.getSnapshotId())) {
            return;
        }
    ...
    private static final boolean T(w wVar) {
        y yVar;
        long jE = f50423g.e(f50422f);
        y yVar2 = null;
        y yVarV = null;
        int i10 = 0;
        for (y yVarV2 = wVar.getFirstStateRecord(); yVarV2 != null; yVarV2 = yVarV2.getNext()) {
            long jG = yVarV2.getSnapshotId();
            if (jG != f50418b) {
                if (jG < jE) {
                    if (yVar2 == null) {
                        i10++;
                        ...
                        if (yVarV2.getSnapshotId() < yVar2.getSnapshotId()) {
                            yVar = yVar2;
                            yVar2 = yVarV2;
                        } else {
                            yVar = yVarV2;
                        ...
                        if (yVarV == null) {
                            yVarV = wVar.getFirstStateRecord();
                            y yVar3 = yVarV;
                            while (true) {
                                if (yVarV != null) {
                                    if (yVarV.getSnapshotId() >= jE) {
                                        break;
                                    }
                                    if (yVar3.getSnapshotId() < yVarV.getSnapshotId()) {
                                        yVar3 = yVarV;
                                    }
                                    yVarV = yVarV.getNext();
                                } else {
    ...
    public static final <T> T a0(androidx.compose.runtime.snapshots.a aVar, Function1<? super i, ? extends T> function1) {
        ...
        T tInvoke = function1.invoke(f50421e.p(snapshotId));
        long j10 = f50422f;
        f50422f = 1 + j10;
        f50421e = f50421e.p(snapshotId);
        aVar.v(j10);
        aVar.u(f50421e);
        aVar.w(0);
        aVar.Q(null);
        aVar.q();
        f50421e = f50421e.t(j10);
        return tInvoke;
    }
    ...
    private static final y d0(w wVar) {
        long jE = f50423g.e(f50422f) - 1;
        i iVarA = i.INSTANCE.a();
        y yVar = null;
        for (y yVarV = wVar.getFirstStateRecord(); yVarV != null; yVarV = yVarV.getNext()) {
            if (yVarV.getSnapshotId() != f50418b) {
                if (f0(yVarV, jE, iVarA)) {
                    if (yVar == null) {
                        yVar = yVarV;
                    } else if (yVarV.getSnapshotId() >= yVar.getSnapshotId()) {
                        return yVar;
                    }
                }
            }
