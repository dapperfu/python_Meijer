...
public final class k {
    ...
    public static final int f50436l = 8;
    ...
    private static final class a {
        ...
        /* renamed from: i, reason: collision with root package name and from kotlin metadata */
        private final C derivedStateObserver = new C1044a();
        ...
        public static final class C1044a implements C {
            C1044a() {
            }
    ...
    public final <T> void p(T scope, Function1<? super T, Unit> onValueChangedForScope, Function0<Unit> block) {
        ...
        if (j10 != -1) {
            if (!(j10 == n.a())) {
                C5757z0.a("Detected multithreaded access to SnapshotStateObserver: previousThreadId=" + j10 + "), currentThread={id=" + n.a() + ", name=" + n.b() + "}. Note that observation on multiple threads in layout/draw is not supported. Make sure your measure/layout/draw for each Owner (AndroidComposeView) is executed on the same thread.");
            }
        }
        try {
            this.isPaused = false;
