...
final class C5747u0 extends MutableLongState implements Parcelable {

    @JvmField
    public static final Parcelable.Creator<C5747u0> CREATOR = new a();
    ...
    public static final class a implements Parcelable.Creator<C5747u0> {
        @Override // android.os.Parcelable.Creator
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public C5747u0 createFromParcel(Parcel parcel) {
            return new C5747u0(parcel.readLong());
        }

        @Override // android.os.Parcelable.Creator
        /* renamed from: b, reason: merged with bridge method [inline-methods] */
        public C5747u0[] newArray(int size) {
            return new C5747u0[size];
        }
