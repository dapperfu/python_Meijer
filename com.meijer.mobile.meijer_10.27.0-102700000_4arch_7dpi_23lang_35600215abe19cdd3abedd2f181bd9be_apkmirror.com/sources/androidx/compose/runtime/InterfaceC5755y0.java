...
public interface InterfaceC5755y0 extends E0.f<AbstractC5737p<Object>, E1<Object>>, InterfaceC5742s, InterfaceC5739q {
    ...
    public interface a extends f.a<AbstractC5737p<Object>, E1<Object>> {
        @Override // E0.f.a
        E0.f<AbstractC5737p<Object>, E1<Object>> build();
    }

    @Override // E0.f
    f.a<AbstractC5737p<Object>, E1<Object>> builder();

    InterfaceC5755y0 l(AbstractC5737p<Object> key, E1<Object> value);

    @Override // androidx.compose.runtime.InterfaceC5739q
    default <T> T e(AbstractC5737p<T> abstractC5737p) {
        return (T) C5744t.b(this, abstractC5737p);
    }
}
