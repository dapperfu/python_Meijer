...
public abstract class F0<T> extends AbstractC5737p<T> {
    ...
    @Override // androidx.compose.runtime.AbstractC5737p
    /*
    ...
    */
    ...
    private final E1<T> f(G0<T> value) {
        if (value.getIsDynamic()) {
            InterfaceC5730l0<T> interfaceC5730l0F = value.f();
            if (interfaceC5730l0F == null) {
                T tG = value.g();
                n1<T> n1VarE = value.e();
                if (n1VarE == null) {
                    n1VarE = o1.r();
                }
                interfaceC5730l0F = o1.i(tG, n1VarE);
            }
            return new DynamicValueHolder(interfaceC5730l0F);
        }
        if (value.c() != null) {
