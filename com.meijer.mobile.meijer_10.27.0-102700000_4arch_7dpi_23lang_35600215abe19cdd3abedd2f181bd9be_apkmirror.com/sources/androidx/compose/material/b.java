...
final class b<T> extends Modifier.c implements D {
    ...
    private C17931e<T> state;

    /* renamed from: p, reason: collision with root package name and from kotlin metadata */
    private Function2<? super r, ? super H1.b, ? extends Pair<? extends InterfaceC17920a0<T>, ? extends T>> anchors;
    ...
    static final class a extends Lambda implements Function1<f0.a, Unit> {
        ...
        final /* synthetic */ K f49852f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ b<T> f49853g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ f0 f49854h;
        ...
        public final void a(f0.a aVar) {
            float fC = this.f49852f.v0() ? this.f49853g.L2().o().c(this.f49853g.L2().x()) : this.f49853g.L2().A();
            float f10 = this.f49853g.getOrientation() == EnumC13827z.f130586b ? fC : 0.0f;
            if (this.f49853g.getOrientation() != EnumC13827z.f130585a) {
                fC = 0.0f;
            }
            f0.a.h(aVar, this.f49854h, MathKt.d(f10), MathKt.d(fC), 0.0f, 4, null);
        }
    ...
    public final EnumC13827z getOrientation() {
        return this.orientation;
    }

    public final C17931e<T> L2() {
        return this.state;
    }

    public final void M2(Function2<? super r, ? super H1.b, ? extends Pair<? extends InterfaceC17920a0<T>, ? extends T>> function2) {
        this.anchors = function2;
    }

    public final void N2(EnumC13827z enumC13827z) {
        this.orientation = enumC13827z;
    }

    public final void O2(C17931e<T> c17931e) {
        this.state = c17931e;
    }

    public b(C17931e<T> c17931e, Function2<? super r, ? super H1.b, ? extends Pair<? extends InterfaceC17920a0<T>, ? extends T>> function2, EnumC13827z enumC13827z) {
        this.state = c17931e;
        this.anchors = function2;
        this.orientation = enumC13827z;
    }
    ...
    public J a(K k10, I i10, long j10) {
        ...
        if (!k10.v0() || !this.didLookahead) {
            Pair<? extends InterfaceC17920a0<T>, ? extends T> pairInvoke = this.anchors.invoke(r.b(s.a(f0VarK0.getWidth(), f0VarK0.getHeight())), H1.b.a(j10));
