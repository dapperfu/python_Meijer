...
public final class RippleHostView extends View implements FSDraw {
    ...
    public static final int f49862g = 8;

    /* renamed from: h, reason: collision with root package name */
    private static final int[] f49863h = {R.attr.state_pressed, R.attr.state_enabled};

    /* renamed from: i, reason: collision with root package name */
    private static final int[] f49864i = new int[0];
        ...
        if (!pressed && j10 < 5) {
            Runnable runnable2 = new Runnable() { // from class: B0.e
                ...
                public final void run() {
                    RippleHostView.setRippleState$lambda$2(this.f1676a);
                }
            };
