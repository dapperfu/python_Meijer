...
class b extends e {
    ...
    private static final Class<?> f53871b;

    /* renamed from: c, reason: collision with root package name */
    private static final Constructor<?> f53872c;

    /* renamed from: d, reason: collision with root package name */
    private static final Method f53873d;

    /* renamed from: e, reason: collision with root package name */
    private static final Method f53874e;
    ...
    private static Typeface j(Object obj) throws ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
        try {
            Object objNewInstance = Array.newInstance(f53871b, 1);
            Array.set(objNewInstance, 0, obj);
            return (Typeface) f53874e.invoke(null, objNewInstance);
    ...
    private static Object l() {
        try {
            return f53872c.newInstance(null);
    ...
    private static boolean i(Object obj, ByteBuffer byteBuffer, int i10, int i11, boolean z10) {
        try {
            return ((Boolean) f53873d.invoke(obj, byteBuffer, Integer.valueOf(i10), null, Integer.valueOf(i11), Boolean.valueOf(z10))).booleanValue();
        } catch (IllegalAccessException | InvocationTargetException unused) {
            return false;
        }
    }
    ...
    public Typeface a(Context context, C6184e.c cVar, Resources resources, int i10) {
        Object objL = l();
        if (objL == null) {
            return null;
        }
