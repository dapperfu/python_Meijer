...
public class FileProvider extends ContentProvider {
    ...
    private static final String[] f53855e = {"_display_name", "_size"};

    /* renamed from: f, reason: collision with root package name */
    private static final File f53856f = new File(q2.f92724c);

    /* renamed from: g, reason: collision with root package name */
    private static final HashMap<String, b> f53857g = new HashMap<>();

    /* renamed from: a, reason: collision with root package name */
    private final Object f53858a;
    ...
    static class c implements b {
        ...
        /* renamed from: b, reason: collision with root package name */
        private final HashMap<String, File> f53863b = new HashMap<>();
        ...
        public Uri a(File file) throws IOException {
            ...
            try {
                ...
                for (Map.Entry<String, File> entry2 : this.f53863b.entrySet()) {
                ...
                if (entry != null) {
                    ...
                    if (path2.endsWith(q2.f92724c)) {
                        strSubstring = canonicalPath.substring(path2.length());
                    } else {
                        strSubstring = canonicalPath.substring(path2.length() + 1);
                    }
                    return new Uri.Builder().scheme("content").authority(this.f53862a).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(strSubstring, q2.f92724c)).build();
                }
        ...
        public File b(Uri uri) throws IOException {
            ...
            if (iIndexOf != -1) {
                ...
                File file = this.f53863b.get(strDecode);
                if (file != null) {
        ...
        void c(String str, File file) throws IOException {
            if (!TextUtils.isEmpty(str)) {
                try {
                    this.f53863b.put(str, file.getCanonicalFile());
                    return;
    ...
    private b f() {
        ...
        synchronized (this.f53858a) {
            try {
                o2.c.d(this.f53860c, "mAuthority is null. Did you override attachInfo and did not call super.attachInfo()?");
                if (this.f53861d == null) {
                    this.f53861d = g(getContext(), this.f53860c, this.f53859b);
                }
                bVar = this.f53861d;
            } catch (Throwable th2) {
                throw th2;
        ...
        while (true) {
            ...
            if (next == 2) {
                ...
                if ("root-path".equals(name)) {
                    externalStorageDirectory = f53856f;
