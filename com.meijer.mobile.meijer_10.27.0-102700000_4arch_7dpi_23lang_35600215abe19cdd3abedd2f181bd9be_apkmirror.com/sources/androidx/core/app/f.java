...
public class f {
    ...
    private static final Object f53686a = new Object();

    public static void a(Context context, String str) {
        synchronized (f53686a) {
            if (str.equals("")) {
            ...
            try {
                ...
                try {
                    ...
                    FS.log_w("AppLocalesStorageHelper", "Storing App Locales : Failed to persist app-locales in storage ", e10);
                    if (fileOutputStreamOpenFileOutput != null) {
                    }
                }
                if (fileOutputStreamOpenFileOutput != null) {
                ...
                FS.log_w("AppLocalesStorageHelper", String.format("Storing App Locales : FileNotFoundException: Cannot open file %s for writing ", "androidx.appcompat.app.AppCompatDelegate.application_locales_record_file"));
            }
        }
    }
    ...
    */
    public static java.lang.String b(android.content.Context r8) {
        /*
            java.lang.Object r0 = androidx.core.app.f.f53686a
            monitor-enter(r0)
            java.lang.String r1 = ""
        ...
        L4c:
            ...
            com.fullstory.FS.log_w(r3, r4)     // Catch: java.lang.Throwable -> L29
            if (r2 == 0) goto L56
            goto L46
        L56:
