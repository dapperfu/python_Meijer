...
public abstract class x {
    ...
    public Parcelable b(View view, Matrix matrix, RectF rectF) {
        ...
        if (this.f53852a == null) {
            this.f53852a = new Matrix();
        }
        this.f53852a.set(matrix);
        this.f53852a.postTranslate(-rectF.left, -rectF.top);
        this.f53852a.postScale(fMin, fMin);
        Bitmap bitmapCreateBitmap = Bitmap.createBitmap(i10, i11, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(bitmapCreateBitmap);
        canvas.concat(this.f53852a);
        view.draw(canvas);
