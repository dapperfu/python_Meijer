...
public class b extends Z1.b {
    ...
    static class f extends SharedElementCallback {
        ...
        private final x f53664a;

        @Override // android.app.SharedElementCallback
        public Parcelable onCaptureSharedElementSnapshot(View view, Matrix matrix, RectF rectF) {
            return this.f53664a.b(view, matrix, rectF);
        }

        @Override // android.app.SharedElementCallback
        public View onCreateSnapshotView(Context context, Parcelable parcelable) {
            return this.f53664a.c(context, parcelable);
        }

        @Override // android.app.SharedElementCallback
        public void onMapSharedElements(List<String> list, Map<String, View> map) {
            this.f53664a.d(list, map);
        }
        ...
        public void onSharedElementEnd(List<String> list, List<View> list2, List<View> list3) {
            this.f53664a.f(list, list2, list3);
        }

        @Override // android.app.SharedElementCallback
        public void onSharedElementStart(List<String> list, List<View> list2, List<View> list3) {
            this.f53664a.g(list, list2, list3);
        }

        @Override // android.app.SharedElementCallback
        public void onSharedElementsArrived(List<String> list, List<View> list2, final SharedElementCallback.OnSharedElementsReadyListener onSharedElementsReadyListener) {
            this.f53664a.h(list, list2, new x.a() { // from class: androidx.core.app.c
                @Override // androidx.core.app.x.a
                public final void onSharedElementsReady() {
                    b.C1092b.a(onSharedElementsReadyListener);
                }
            });
        }
    ...
    public static boolean y(Activity activity, String str) {
        ...
        if (i10 >= 33 || !TextUtils.equals("android.permission.POST_NOTIFICATIONS", str)) {
            return i10 >= 32 ? d.a(activity, str) : i10 == 31 ? c.a(activity, str) : C1092b.c(activity, str);
        }
        return false;
    }
