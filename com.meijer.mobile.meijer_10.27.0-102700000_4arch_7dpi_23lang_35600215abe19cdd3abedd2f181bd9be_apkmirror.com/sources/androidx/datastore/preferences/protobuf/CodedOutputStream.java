...
public abstract class CodedOutputStream extends AbstractC5940f {

    /* renamed from: c, reason: collision with root package name */
    private static final Logger f54147c = Logger.getLogger(CodedOutputStream.class.getName());

    /* renamed from: d, reason: collision with root package name */
    private static final boolean f54148d = o0.B();
    ...
    private static abstract class b extends CodedOutputStream {
        ...
        b(int i10) {
            ...
            this.f54151e = bArr;
            this.f54152f = bArr.length;
        }

        final void a1(byte b10) {
            byte[] bArr = this.f54151e;
            int i10 = this.f54153g;
            this.f54153g = i10 + 1;
            bArr[i10] = b10;
            this.f54154h++;
        }
        ...
        final void f1(int i10) {
            if (CodedOutputStream.f54148d) {
                long j10 = this.f54153g;
                while ((i10 & (-128)) != 0) {
                    byte[] bArr = this.f54151e;
                    int i11 = this.f54153g;
                    this.f54153g = i11 + 1;
                    o0.H(bArr, i11, (byte) ((i10 | 128) & l3.f92484c));
                    i10 >>>= 7;
                }
                byte[] bArr2 = this.f54151e;
                int i12 = this.f54153g;
                this.f54153g = i12 + 1;
                o0.H(bArr2, i12, (byte) i10);
                this.f54154h += (int) (this.f54153g - j10);
                return;
            }
            while ((i10 & (-128)) != 0) {
                byte[] bArr3 = this.f54151e;
                int i13 = this.f54153g;
                this.f54153g = i13 + 1;
                bArr3[i13] = (byte) ((i10 | 128) & l3.f92484c);
                this.f54154h++;
                i10 >>>= 7;
            }
            byte[] bArr4 = this.f54151e;
            int i14 = this.f54153g;
            this.f54153g = i14 + 1;
            bArr4[i14] = (byte) i10;
            this.f54154h++;
        }
        ...
        final void g1(long j10) {
            if (CodedOutputStream.f54148d) {
                long j11 = this.f54153g;
                while ((j10 & (-128)) != 0) {
                    byte[] bArr = this.f54151e;
                    int i10 = this.f54153g;
                    this.f54153g = i10 + 1;
                    o0.H(bArr, i10, (byte) ((((int) j10) | 128) & l3.f92484c));
                    j10 >>>= 7;
                }
                byte[] bArr2 = this.f54151e;
                int i11 = this.f54153g;
                ...
                this.f54154h += (int) (this.f54153g - j11);
                return;
            }
            while ((j10 & (-128)) != 0) {
                byte[] bArr3 = this.f54151e;
                int i12 = this.f54153g;
                this.f54153g = i12 + 1;
                bArr3[i12] = (byte) ((((int) j10) | 128) & l3.f92484c);
                this.f54154h++;
                j10 >>>= 7;
            }
            byte[] bArr4 = this.f54151e;
    ...
    private static class c extends CodedOutputStream {
        ...
        /* renamed from: e, reason: collision with root package name */
        private final byte[] f54155e;

        /* renamed from: f, reason: collision with root package name */
        private final int f54156f;
        ...
        final void H0(int i10, P p10, f0 f0Var) throws IOException {
            V0(i10, 2);
            X0(((AbstractC5935a) p10).l(f0Var));
            f0Var.i(p10, this.f54149a);
        }
        ...
        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream
        public final void K0(int i10, AbstractC5941g abstractC5941g) throws IOException {
            V0(1, 3);
            W0(2, i10);
            n0(3, abstractC5941g);
            V0(1, 4);
        ...
        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream
        public final void n0(int i10, AbstractC5941g abstractC5941g) throws IOException {
            V0(i10, 2);
            o0(abstractC5941g);
        }
        ...
        public final void U0(String str) throws IOException {
            int i10 = this.f54158h;
            try {
                int iW = CodedOutputStream.W(str.length() * 3);
                int iW2 = CodedOutputStream.W(str.length());
                if (iW2 != iW) {
                    X0(p0.c(str));
                    this.f54158h = p0.b(str, this.f54155e, this.f54158h, h0());
                    return;
                }
                int i11 = i10 + iW2;
                this.f54158h = i11;
                int iB = p0.b(str, this.f54155e, i11, h0());
                this.f54158h = i10;
                X0((iB - i10) - iW2);
                this.f54158h = iB;
            } catch (p0.d e10) {
        ...
        public final void X0(int i10) throws IOException {
            while ((i10 & (-128)) != 0) {
                try {
                    byte[] bArr = this.f54155e;
                    int i11 = this.f54158h;
                    this.f54158h = i11 + 1;
                    bArr[i11] = (byte) ((i10 | 128) & l3.f92484c);
                    i10 >>>= 7;
                } catch (IndexOutOfBoundsException e10) {
                    throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f54158h), Integer.valueOf(this.f54157g), 1), e10);
                }
            }
            byte[] bArr2 = this.f54155e;
            int i12 = this.f54158h;
            this.f54158h = i12 + 1;
            bArr2[i12] = (byte) i10;
        }
        ...
        public final void a1(byte[] bArr, int i10, int i11) throws IOException {
            try {
                System.arraycopy(bArr, i10, this.f54155e, this.f54158h, i11);
                this.f54158h += i11;
            } catch (IndexOutOfBoundsException e10) {
                throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f54158h), Integer.valueOf(this.f54157g), Integer.valueOf(i11)), e10);
            }
        }

        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream
        public final int h0() {
            return this.f54157g - this.f54158h;
        }
        ...
        public final void Z0(long j10) throws IOException {
            if (CodedOutputStream.f54148d && h0() >= 10) {
                while ((j10 & (-128)) != 0) {
                    byte[] bArr = this.f54155e;
                    int i10 = this.f54158h;
                    this.f54158h = i10 + 1;
            ...
            byte[] bArr4 = this.f54155e;
            int i13 = this.f54158h;
            this.f54158h = i13 + 1;
            bArr4[i13] = (byte) j10;
        }

        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream, androidx.datastore.preferences.protobuf.AbstractC5940f
        ...
        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream
        public final void o0(AbstractC5941g abstractC5941g) throws IOException {
            X0(abstractC5941g.size());
            abstractC5941g.C(this);
        }
    }
    ...
    private static final class d extends b {
        ...
        private final OutputStream f54159i;
        ...
        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream
        public void K0(int i10, AbstractC5941g abstractC5941g) throws IOException {
            V0(1, 3);
            W0(2, i10);
            n0(3, abstractC5941g);
            V0(1, 4);
        ...
        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream
        public void n0(int i10, AbstractC5941g abstractC5941g) throws IOException {
            V0(i10, 2);
            o0(abstractC5941g);
        }
        ...
        private void h1() throws IOException {
            this.f54159i.write(this.f54151e, 0, this.f54153g);
            this.f54153g = 0;
        }

        private void i1(int i10) throws IOException {
            if (this.f54152f - this.f54153g < i10) {
                h1();
            }
        }
        ...
        public void j1(byte[] bArr, int i10, int i11) throws IOException {
            int i12 = this.f54152f;
            int i13 = this.f54153g;
            if (i12 - i13 >= i11) {
                System.arraycopy(bArr, i10, this.f54151e, i13, i11);
                this.f54153g += i11;
                this.f54154h += i11;
                return;
            }
            int i14 = i12 - i13;
            System.arraycopy(bArr, i10, this.f54151e, i13, i14);
            int i15 = i10 + i14;
            int i16 = i11 - i14;
            this.f54153g = this.f54152f;
            this.f54154h += i14;
            h1();
            if (i16 <= this.f54152f) {
                System.arraycopy(bArr, i15, this.f54151e, 0, i16);
                this.f54153g = i16;
            } else {
                this.f54159i.write(bArr, i15, i16);
            }
            this.f54154h += i16;
        }
            ...
            try {
                ...
                try {
                    if (iW2 == iW) {
                        int i13 = i12 + iW2;
                        this.f54153g = i13;
                        int iB2 = p0.b(str, this.f54151e, i13, this.f54152f - i13);
                        this.f54153g = i12;
                        iC = (iB2 - i12) - iW2;
                        f1(iC);
                        this.f54153g = iB2;
                        ...
                        iC = p0.c(str);
                        f1(iC);
                        this.f54153g = p0.b(str, this.f54151e, this.f54153g, iC);
                    }
                    this.f54154h += iC;
                } catch (p0.d e10) {
                    this.f54154h -= this.f54153g - i12;
                    this.f54153g = i12;
                    throw e10;
        ...
        @Override // androidx.datastore.preferences.protobuf.CodedOutputStream
        public void o0(AbstractC5941g abstractC5941g) throws IOException {
            X0(abstractC5941g.size());
            abstractC5941g.C(this);
        }
    }
    ...
    public static int J(int i10, AbstractC5941g abstractC5941g) {
        return (U(1) * 2) + V(2, i10) + g(3, abstractC5941g);
    }
    ...
    public abstract void K0(int i10, AbstractC5941g abstractC5941g) throws IOException;
    ...
    @Override // androidx.datastore.preferences.protobuf.AbstractC5940f
    ...
    public abstract void n0(int i10, AbstractC5941g abstractC5941g) throws IOException;

    public abstract void o0(AbstractC5941g abstractC5941g) throws IOException;
    ...
    static int H(P p10, f0 f0Var) {
        return C(((AbstractC5935a) p10).l(f0Var));
    }
    ...
    static int u(P p10, f0 f0Var) {
        return ((AbstractC5935a) p10).l(f0Var);
    }
    ...
    final void c0(String str, p0.d dVar) throws IOException {
        f54147c.log(Level.WARNING, "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable) dVar);
        byte[] bytes = str.getBytes(C5958y.f54482b);
        try {
            X0(bytes.length);
    ...
    public static int T(String str) {
        ...
        try {
            ...
            length = str.getBytes(C5958y.f54482b).length;
        }
        return C(length);
    }
    ...
    public static int g(int i10, AbstractC5941g abstractC5941g) {
        return U(i10) + h(abstractC5941g);
    }

    public static int h(AbstractC5941g abstractC5941g) {
        return C(abstractC5941g.size());
    }
