...
import androidx.datastore.preferences.protobuf.AbstractC5935a.AbstractC1102a;
...
public abstract class AbstractC5935a<MessageType extends AbstractC5935a<MessageType, BuilderType>, BuilderType extends AbstractC1102a<MessageType, BuilderType>> implements P {
    protected int memoizedHashCode = 0;

    /* renamed from: androidx.datastore.preferences.protobuf.a$a, reason: collision with other inner class name */
    public static abstract class AbstractC1102a<MessageType extends AbstractC5935a<MessageType, BuilderType>, BuilderType extends AbstractC1102a<MessageType, BuilderType>> implements P.a {
            ...
            if (iterable instanceof C) {
                ...
                for (Object obj : listG) {
                    ...
                    if (obj instanceof AbstractC5941g) {
                        c10.p2((AbstractC5941g) obj);
                    } else if (obj instanceof byte[]) {
                        c10.p2(AbstractC5941g.k((byte[]) obj));
                    } else {
                        c10.add((String) obj);
                    }
                }
        ...
        public BuilderType T(P p10) {
            if (e().getClass().isInstance(p10)) {
                return (BuilderType) l((AbstractC5935a) p10);
            }
    ...
    protected static <T> void j(Iterable<T> iterable, List<? super T> list) {
        AbstractC1102a.j(iterable, list);
    }

    @Override // androidx.datastore.preferences.protobuf.P
    public AbstractC5941g g() {
        try {
            AbstractC5941g.h hVarQ = AbstractC5941g.q(c());
            i(hVarQ.b());
            return hVarQ.a();
