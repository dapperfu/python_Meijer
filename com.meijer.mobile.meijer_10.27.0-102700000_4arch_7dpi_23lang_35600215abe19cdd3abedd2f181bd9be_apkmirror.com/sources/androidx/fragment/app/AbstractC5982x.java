...
public abstract class AbstractC5982x<H> extends AbstractC5979u {
    ...
    public AbstractC5982x(Activity activity, Context context, Handler handler, int i10) {
    ...
    public AbstractC5982x(FragmentActivity activity) {
