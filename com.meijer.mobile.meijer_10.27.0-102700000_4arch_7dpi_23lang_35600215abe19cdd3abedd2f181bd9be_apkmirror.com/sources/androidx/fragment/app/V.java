...
public abstract class V {
    ...
    class a implements Runnable {
        ...
        final /* synthetic */ int f54952a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ ArrayList f54953b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ ArrayList f54954c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ ArrayList f54955d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ ArrayList f54956e;

        @Override // java.lang.Runnable
        public void run() {
            for (int i10 = 0; i10 < this.f54952a; i10++) {
                ViewCompat.G0((View) this.f54953b.get(i10), (String) this.f54954c.get(i10));
                ViewCompat.G0((View) this.f54955d.get(i10), (String) this.f54956e.get(i10));
            }
        }

        a(int i10, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4) {
            this.f54952a = i10;
            this.f54953b = arrayList;
            this.f54954c = arrayList2;
            this.f54955d = arrayList3;
            this.f54956e = arrayList4;
        }
    }
    ...
    public void x(Fragment fragment, Object obj, C14836d c14836d, Runnable runnable, Runnable runnable2) {
        runnable2.run();
    }
