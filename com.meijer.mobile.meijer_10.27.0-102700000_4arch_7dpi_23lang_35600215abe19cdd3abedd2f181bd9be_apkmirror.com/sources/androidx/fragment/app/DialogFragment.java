...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    private InterfaceC5989E<InterfaceC6030s> mObserver;
    ...
    class d implements InterfaceC5989E<InterfaceC6030s> {
        d() {
        }

        @Override // androidx.view.InterfaceC5989E
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public void onChanged(InterfaceC6030s interfaceC6030s) {
            if (interfaceC6030s == null || !DialogFragment.this.mShowsDialog) {
                return;
            }
    ...
    class e extends AbstractC5979u {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ AbstractC5979u f54766a;

        e(AbstractC5979u abstractC5979u) {
            this.f54766a = abstractC5979u;
        }

        @Override // androidx.fragment.app.AbstractC5979u
        public View c(int i10) {
            return this.f54766a.d() ? this.f54766a.c(i10) : DialogFragment.this.y0(i10);
        }

        @Override // androidx.fragment.app.AbstractC5979u
        public boolean d() {
            return this.f54766a.d() || DialogFragment.this.z0();
        }
    }
    ...
    public void onStart() {
        ...
        if (dialog != null) {
            ...
            C6021j0.b(decorView, this);
            x4.m.b(decorView, this);
        }
    }
