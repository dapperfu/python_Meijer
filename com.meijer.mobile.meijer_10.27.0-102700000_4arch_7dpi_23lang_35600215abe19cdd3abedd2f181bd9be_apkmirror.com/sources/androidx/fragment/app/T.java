...
public final class T {
    ...
    private final V c() {
        try {
            Intrinsics.h(C3658e.class, "null cannot be cast to non-null type java.lang.Class<androidx.fragment.app.FragmentTransitionImpl>");
            return (V) C3658e.class.getDeclaredConstructor(null).newInstance(null);
    ...
    @JvmStatic
    public static final void a(Fragment inFragment, Fragment outFragment, boolean isPop, C5503a<String, View> sharedElements, boolean isStart) {
    ...
    @JvmStatic
    public static final String b(C5503a<String, String> c5503a, String value) {
        Intrinsics.j(c5503a, "<this>");
        Intrinsics.j(value, "value");
        LinkedHashMap linkedHashMap = new LinkedHashMap();
        for (Map.Entry<String, String> entry : c5503a.entrySet()) {
    ...
    @JvmStatic
    public static final void d(C5503a<String, String> c5503a, C5503a<String, View> namedViews) {
        Intrinsics.j(c5503a, "<this>");
        ...
        while (true) {
            ...
            if (!namedViews.containsKey(c5503a.k(size))) {
                c5503a.i(size);
            }
        }
    }
