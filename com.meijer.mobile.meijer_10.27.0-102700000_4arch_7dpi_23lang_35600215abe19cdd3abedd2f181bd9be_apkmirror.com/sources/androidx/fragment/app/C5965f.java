...
import androidx.fragment.app.C5965f;
import androidx.fragment.app.C5978t;
...
public final class C5965f extends b0 {
    ...
    static final class a extends b0.b {
        ...
        public static final class AnimationAnimationListenerC1111a implements Animation.AnimationListener {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ b0.d f55029a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ ViewGroup f55030b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ View f55031c;

            /* renamed from: d, reason: collision with root package name */
            final /* synthetic */ a f55032d;
            ...
            AnimationAnimationListenerC1111a(b0.d dVar, ViewGroup viewGroup, View view, a aVar) {
                this.f55029a = dVar;
                this.f55030b = viewGroup;
                this.f55031c = view;
                this.f55032d = aVar;
            }
            ...
            public void onAnimationEnd(Animation animation) {
                Intrinsics.j(animation, "animation");
                final ViewGroup viewGroup = this.f55030b;
                final View view = this.f55031c;
                final a aVar = this.f55032d;
                viewGroup.post(new Runnable() { // from class: androidx.fragment.app.e
                    @Override // java.lang.Runnable
                    public final void run() {
                        C5965f.a.AnimationAnimationListenerC1111a.b(viewGroup, view, aVar);
                    }
                });
                if (FragmentManager.isLoggingEnabled(2)) {
                    FS.log_v(FragmentManager.TAG, "Animation from operation " + this.f55029a + " has ended.");
                }
            }
            ...
            public void onAnimationStart(Animation animation) {
                Intrinsics.j(animation, "animation");
                if (FragmentManager.isLoggingEnabled(2)) {
                    FS.log_v(FragmentManager.TAG, "Animation from operation " + this.f55029a + " has reached onAnimationStart.");
                }
            }
        }
        ...
        public void d(ViewGroup container) throws Resources.NotFoundException {
            ...
            C5978t.a aVarC = bVar.c(context);
            if (aVarC == null) {
                throw new IllegalStateException("Required value was null.");
            }
            Animation animation = aVarC.f55105a;
            if (animation == null) {
                throw new IllegalStateException("Required value was null.");
            }
            ...
            C5978t.b bVar2 = new C5978t.b(animation, container, view);
            bVar2.setAnimationListener(new AnimationAnimationListenerC1111a(operation, container, view, this));
    ...
    private static final class b extends C1112f {
        ...
        public final C5978t.a c(Context context) throws Resources.NotFoundException {
            Intrinsics.j(context, "context");
            if (this.isAnimLoaded) {
                return this.animation;
            }
            C5978t.a aVarB = C5978t.b(context, getOperation().getFragment(), getOperation().getFinalState() == b0.d.b.VISIBLE, this.isPop);
    ...
    private static final class c extends b0.b {
        ...
        public static final class a extends AnimatorListenerAdapter {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ ViewGroup f55038a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ View f55039b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ boolean f55040c;

            /* renamed from: d, reason: collision with root package name */
            final /* synthetic */ b0.d f55041d;

            /* renamed from: e, reason: collision with root package name */
            final /* synthetic */ c f55042e;

            a(ViewGroup viewGroup, View view, boolean z10, b0.d dVar, c cVar) {
                this.f55038a = viewGroup;
                this.f55039b = view;
                this.f55040c = z10;
                this.f55041d = dVar;
                this.f55042e = cVar;
            ...
            public void onAnimationEnd(Animator anim) {
                ...
                this.f55038a.endViewTransition(this.f55039b);
                if (this.f55040c) {
                    b0.d.b finalState = this.f55041d.getFinalState();
                    View viewToAnimate = this.f55039b;
                    Intrinsics.i(viewToAnimate, "viewToAnimate");
                    finalState.b(viewToAnimate, this.f55038a);
                }
                this.f55042e.getAnimatorInfo().getOperation().e(this.f55042e);
                if (FragmentManager.isLoggingEnabled(2)) {
                    FS.log_v(FragmentManager.TAG, "Animator from operation " + this.f55041d + " has ended.");
                }
            }
        }
        ...
        @Override // androidx.fragment.app.b0.b
        public void e(C5614b backEvent, ViewGroup container) {
            ...
            long jA = d.f55043a.a(animatorSet);
            ...
            e.f55044a.b(animatorSet, progress);
        }
        ...
        public void f(ViewGroup container) throws Resources.NotFoundException {
            ...
            Intrinsics.i(context, "context");
            C5978t.a aVarC = bVar.c(context);
            this.animator = aVarC != null ? aVarC.f55106b : null;
            b0.d operation = this.animatorInfo.getOperation();
    ...
    public static final class d {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final d f55043a = new d();
    ...
    static final class g extends b0.b {
        ...
        private final C5503a<String, String> sharedElementNameMapping;
        ...
        private final C5503a<String, View> firstOutViews;

        /* renamed from: o, reason: collision with root package name and from kotlin metadata */
        private final C5503a<String, View> lastInViews;

        /* renamed from: p, reason: collision with root package name and from kotlin metadata */
        private final boolean isPop;

        /* renamed from: q, reason: collision with root package name and from kotlin metadata */
        private final C14836d transitionSignal;
        ...
        static final class a extends Lambda implements Function0<Unit> {
            ...
            final /* synthetic */ ViewGroup f55063g;

            /* renamed from: h, reason: collision with root package name */
            final /* synthetic */ Object f55064h;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            a(ViewGroup viewGroup, Object obj) {
                super(0);
                this.f55063g = viewGroup;
                this.f55064h = obj;
            }
            ...
            public final void invoke2() {
                g.this.getTransitionImpl().e(this.f55063g, this.f55064h);
            }
        }
        ...
        static final class b extends Lambda implements Function0<Unit> {
            ...
            /* renamed from: g, reason: collision with root package name */
            final /* synthetic */ ViewGroup f55066g;

            /* renamed from: h, reason: collision with root package name */
            final /* synthetic */ Object f55067h;

            /* renamed from: i, reason: collision with root package name */
            final /* synthetic */ Ref.ObjectRef<Function0<Unit>> f55068i;
            ...
            static final class a extends Lambda implements Function0<Unit> {
                ...
                final /* synthetic */ g f55069f;

                /* renamed from: g, reason: collision with root package name */
                final /* synthetic */ Object f55070g;

                /* renamed from: h, reason: collision with root package name */
                final /* synthetic */ ViewGroup f55071h;
                ...
                public final void invoke2() {
                    ...
                    if (!(listW instanceof Collection) || !listW.isEmpty()) {
                        ...
                        while (it.hasNext()) {
                            if (!((h) it.next()).getOperation().getIsSeeking()) {
                                ...
                                C14836d c14836d = new C14836d();
                                V transitionImpl = this.f55069f.getTransitionImpl();
                                Fragment fragment = this.f55069f.w().get(0).getOperation().getFragment();
                                Object obj = this.f55070g;
                                final g gVar = this.f55069f;
                                transitionImpl.w(fragment, obj, c14836d, new Runnable() { // from class: androidx.fragment.app.n
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        C5965f.g.b.a.d(gVar);
                                    }
                    ...
                    V transitionImpl2 = this.f55069f.getTransitionImpl();
                    Object controller = this.f55069f.getController();
                    Intrinsics.g(controller);
                    final g gVar2 = this.f55069f;
                    final ViewGroup viewGroup = this.f55071h;
                    transitionImpl2.d(controller, new Runnable() { // from class: androidx.fragment.app.m
                        @Override // java.lang.Runnable
                        public final void run() {
                            C5965f.g.b.a.c(gVar2, viewGroup);
                        }
                    });
                }
            }
            ...
            b(ViewGroup viewGroup, Object obj, Ref.ObjectRef<Function0<Unit>> objectRef) {
                super(0);
                this.f55066g = viewGroup;
                this.f55067h = obj;
                this.f55068i = objectRef;
            }
            ...
            public final void invoke2() {
                ...
                g gVar = g.this;
                gVar.C(gVar.getTransitionImpl().j(this.f55066g, this.f55067h));
                ...
                this.f55068i.f142835a = new a(g.this, this.f55067h, this.f55066g);
                if (FragmentManager.isLoggingEnabled(2)) {
        ...
        public g(List<h> transitionInfos, b0.d dVar, b0.d dVar2, V transitionImpl, Object obj, ArrayList<View> sharedElementFirstOutViews, ArrayList<View> sharedElementLastInViews, C5503a<String, String> sharedElementNameMapping, ArrayList<String> enteringNames, ArrayList<String> exitingNames, C5503a<String, View> firstOutViews, C5503a<String, View> lastInViews, boolean z10) {
            ...
            this.isPop = z10;
            this.transitionSignal = new C14836d();
        }
        ...
        public static final void z(Ref.ObjectRef seekCancelLambda) {
            ...
            Function0 function0 = (Function0) seekCancelLambda.f142835a;
            if (function0 != null) {
                function0.invoke();
            }
        }
    ...
    private static final class h extends C1112f {
    ...
    static final class i extends Lambda implements Function1<Map.Entry<String, View>, Boolean> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Collection<String> f55075f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        i(Collection<String> collection) {
            super(1);
            this.f55075f = collection;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Boolean invoke(Map.Entry<String, View> entry) {
            Intrinsics.j(entry, "entry");
            return Boolean.valueOf(CollectionsKt.h0(this.f55075f, ViewCompat.I(entry.getValue())));
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C5965f(ViewGroup container) {
        super(container);
        Intrinsics.j(container, "container");
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void G(C5965f this$0, b0.d operation) {
        Intrinsics.j(this$0, "this$0");
        Intrinsics.j(operation, "$operation");
        this$0.c(operation);
    }
    ...
    private final void H(List<h> transitionInfos, boolean isPop, b0.d firstOut, b0.d lastIn) {
        ...
        C5503a<String, View> c5503a2 = new C5503a<>();
        C5503a<String, View> c5503a3 = new C5503a<>();
        ...
        while (it2.hasNext()) {
            ...
            if (!hVar2.g() || firstOut == null || lastIn == null) {
                ...
                if (xVar != null) {
                    ...
                    if (size3 >= 0) {
                        while (true) {
                            ...
                            String str4 = str3;
                            View view2 = c5503a2.get(str4);
                            if (view2 == null) {
                                c5503a.remove(str4);
                            } else if (!Intrinsics.e(str4, ViewCompat.I(view2))) {
                                c5503a.put(ViewCompat.I(view2), (String) c5503a.remove(str4));
                            }
                            if (i14 < 0) {
                                break;
                            } else {
                ...
                if (xVar2 != null) {
                    ...
                    if (size4 >= 0) {
                        while (true) {
                            ...
                            String str6 = str5;
                            View view4 = c5503a3.get(str6);
                            if (view4 == null) {
                                String strB2 = T.b(c5503a, str6);
                                if (strB2 != null) {
                                    c5503a.remove(strB2);
                                }
                            } else if (!Intrinsics.e(str6, ViewCompat.I(view4)) && (strB = T.b(c5503a, str6)) != null) {
                                c5503a.put(strB, ViewCompat.I(view4));
                            }
                            if (i15 < 0) {
                                break;
                            } else {
                ...
                Collection<String> collectionKeySet = c5503a.keySet();
                Intrinsics.i(collectionKeySet, "sharedElementNameMapping.keys");
                J(c5503a2, collectionKeySet);
                Collection<String> collectionValues = c5503a.values();
                Intrinsics.i(collectionValues, "sharedElementNameMapping.values");
                J(c5503a3, collectionValues);
                if (c5503a.isEmpty()) {
        ...
        g gVar = new g(arrayList11, firstOut, lastIn, v13, obj4, arrayList12, arrayList13, c5503a, sharedElementTargetNames, sharedElementSourceNames, c5503a2, c5503a3, isPop);
    ...
    */
    public void d(java.util.List<? extends androidx.fragment.app.b0.d> r11, boolean r12) throws android.content.res.Resources.NotFoundException {
        ...
        Ldb:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.C5965f.d(java.util.List, boolean):void");
    }
    ...
    private final void J(C5503a<String, View> c5503a, Collection<String> collection) {
        Set<Map.Entry<String, View>> entries = c5503a.entrySet();
    ...
    private final void K(List<? extends b0.d> operations) {
        ...
        for (b0.d dVar : operations) {
            dVar.getFragment().mAnimationInfo.f54790c = fragment.mAnimationInfo.f54790c;
            dVar.getFragment().mAnimationInfo.f54791d = fragment.mAnimationInfo.f54791d;
            dVar.getFragment().mAnimationInfo.f54792e = fragment.mAnimationInfo.f54792e;
            dVar.getFragment().mAnimationInfo.f54793f = fragment.mAnimationInfo.f54793f;
        }
    }
}
