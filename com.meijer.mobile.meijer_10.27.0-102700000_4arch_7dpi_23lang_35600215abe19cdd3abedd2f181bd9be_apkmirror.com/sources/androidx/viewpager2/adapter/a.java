...
public abstract class a extends RecyclerView.h<androidx.viewpager2.adapter.b> implements androidx.viewpager2.adapter.c {
    ...
    final AbstractC6023l mLifecycle;
    private final C<Fragment.m> mSavedStates;

    /* renamed from: androidx.viewpager2.adapter.a$a, reason: collision with other inner class name */
    class C1155a implements InterfaceC6027p {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ androidx.viewpager2.adapter.b f58999a;

        C1155a(androidx.viewpager2.adapter.b bVar) {
            this.f58999a = bVar;
        }
        ...
        public void onStateChanged(InterfaceC6030s interfaceC6030s, AbstractC6023l.a aVar) {
            ...
            if (this.f58999a.c().isAttachedToWindow()) {
                a.this.placeFragmentInViewHolder(this.f58999a);
            }
        }
    }
    ...
    class b extends FragmentManager.FragmentLifecycleCallbacks {
        ...
        final /* synthetic */ FrameLayout f59002b;

        b(Fragment fragment, FrameLayout frameLayout) {
            this.f59001a = fragment;
            this.f59002b = frameLayout;
        }

        @Override // androidx.fragment.app.FragmentManager.FragmentLifecycleCallbacks
        public void onFragmentViewCreated(FragmentManager fragmentManager, Fragment fragment, View view, Bundle bundle) {
            if (fragment == this.f59001a) {
                fragmentManager.unregisterFragmentLifecycleCallbacks(this);
                a.this.addViewToContainer(view, this.f59002b);
            }
        }
    }
    ...
    class d implements InterfaceC6027p {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Handler f59005a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Runnable f59006b;

        d(Handler handler, Runnable runnable) {
            this.f59005a = handler;
            this.f59006b = runnable;
        }

        @Override // androidx.view.InterfaceC6027p
        public void onStateChanged(InterfaceC6030s interfaceC6030s, AbstractC6023l.a aVar) {
            if (aVar == AbstractC6023l.a.ON_DESTROY) {
                this.f59005a.removeCallbacks(this.f59006b);
                interfaceC6030s.getLifecycle().d(this);
            }
        }
    }
    ...
    static class f {
        ...
        /* renamed from: a, reason: collision with root package name */
        private List<h> f59008a = new CopyOnWriteArrayList();

        public List<h.b> a(Fragment fragment, AbstractC6023l.b bVar) {
            ArrayList arrayList = new ArrayList();
            Iterator<h> it = this.f59008a.iterator();
            while (it.hasNext()) {
        ...
        public void f(h hVar) {
            this.f59008a.add(hVar);
        }

        public void g(h hVar) {
            this.f59008a.remove(hVar);
        }
    ...
    class g {
        ...
        /* renamed from: a, reason: collision with root package name */
        private ViewPager2.i f59009a;

        /* renamed from: b, reason: collision with root package name */
        private RecyclerView.j f59010b;

        /* renamed from: c, reason: collision with root package name */
        private InterfaceC6027p f59011c;

        /* renamed from: d, reason: collision with root package name */
        private ViewPager2 f59012d;

        /* renamed from: e, reason: collision with root package name */
        private long f59013e = -1;

        /* renamed from: androidx.viewpager2.adapter.a$g$a, reason: collision with other inner class name */
        class C1156a extends ViewPager2.i {
            C1156a() {
            }
        ...
        class c implements InterfaceC6027p {
            c() {
            }
        ...
        void d(boolean z10) {
            int currentItem;
            Fragment fragmentD;
            if (a.this.shouldDelayFragmentTransactions() || this.f59012d.getScrollState() != 0 || a.this.mFragments.f() || a.this.getItemCount() == 0 || (currentItem = this.f59012d.getCurrentItem()) >= a.this.getItemCount()) {
                return;
            }
            long itemId = a.this.getItemId(currentItem);
            if ((itemId != this.f59013e || z10) && (fragmentD = a.this.mFragments.d(itemId)) != null && fragmentD.isAdded()) {
                this.f59013e = itemId;
                ...
                for (int i10 = 0; i10 < a.this.mFragments.m(); i10++) {
                    ...
                    if (fragmentN.isAdded()) {
                        ...
                        fragmentN.setMenuVisibility(jG == this.f59013e);
                    }
                }
                if (fragment != null) {
                    AbstractC6023l.b bVar2 = AbstractC6023l.b.f55279e;
        ...
        void b(RecyclerView recyclerView) {
            this.f59012d = a(recyclerView);
            C1156a c1156a = new C1156a();
            this.f59009a = c1156a;
            this.f59012d.g(c1156a);
            b bVar = new b();
            this.f59010b = bVar;
        ...
        void c(RecyclerView recyclerView) {
            a(recyclerView).n(this.f59009a);
            a.this.unregisterAdapterDataObserver(this.f59010b);
            a.this.mLifecycle.d(this.f59011c);
            this.f59012d = null;
        }
    }
    ...
    public static abstract class h {
        ...
        /* renamed from: a, reason: collision with root package name */
        private static final b f59018a = new C1157a();
        ...
        public b a(Fragment fragment, AbstractC6023l.b bVar) {
            return f59018a;
        }
        ...
        if (!this.mIsInGracePeriod) {
            ...
            for (int i11 = 0; i11 < this.mFragments.m(); i11++) {
                ...
                if (!isFragmentViewBound(jG2)) {
                    c5504b.add(Long.valueOf(jG2));
                }
            }
        }
        Iterator<E> it = c5504b.iterator();
        while (it.hasNext()) {
    ...
    void placeFragmentInViewHolder(androidx.viewpager2.adapter.b bVar) {
        ...
        if (shouldDelayFragmentTransactions()) {
            ...
            this.mLifecycle.a(new C1155a(bVar));
            return;
        }
        scheduleViewAttach(fragmentD, frameLayoutC);
        ...
        try {
            ...
            this.mFragmentManager.beginTransaction().e(fragmentD, "f" + bVar.getItemId()).w(fragmentD, AbstractC6023l.b.f55278d).j();
    ...
    public a(FragmentManager fragmentManager, AbstractC6023l abstractC6023l) {
        ...
        this.mLifecycle = abstractC6023l;
