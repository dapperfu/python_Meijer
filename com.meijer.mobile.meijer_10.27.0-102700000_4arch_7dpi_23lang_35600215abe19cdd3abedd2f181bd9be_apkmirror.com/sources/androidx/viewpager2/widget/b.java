...
final class b extends ViewPager2.i {
    ...
    private final List<ViewPager2.i> f59064a;
    ...
    void a(ViewPager2.i iVar) {
        this.f59064a.add(iVar);
    }

    void b(ViewPager2.i iVar) {
        this.f59064a.remove(iVar);
    }

    @Override // androidx.viewpager2.widget.ViewPager2.i
    public void onPageScrollStateChanged(int i10) {
        try {
            Iterator<ViewPager2.i> it = this.f59064a.iterator();
            while (it.hasNext()) {
    ...
    b(int i10) {
        this.f59064a = new ArrayList(i10);
    }
}
