...
class n implements m {
    ...
    public void a(View view) {
        Object tag = view.getTag(C16447c.f156765a);
        if (tag instanceof Float) {
            ViewCompat.u0(view, ((Float) tag).floatValue());
        }
        view.setTag(C16447c.f156765a, null);
