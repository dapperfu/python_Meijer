...
public class RecyclerView extends ViewGroup implements InterfaceC16196B, FSDraw, FSDispatchDraw {
    ...
    private C16197C mScrollingChildHelper;
    final B mState;
    ...
    public static abstract class A {
        ...
        private boolean f57903e;

        /* renamed from: f, reason: collision with root package name */
        private View f57904f;

        /* renamed from: h, reason: collision with root package name */
        private boolean f57906h;

        /* renamed from: a, reason: collision with root package name */
        private int f57899a = -1;

        /* renamed from: g, reason: collision with root package name */
        private final a f57905g = new a(0, 0);
        ...
        public static class a {
            ...
            /* renamed from: e, reason: collision with root package name */
            private Interpolator f57911e;

            /* renamed from: f, reason: collision with root package name */
            private boolean f57912f;
            ...
            public a(int i10, int i11, int i12, Interpolator interpolator) {
                ...
                this.f57908b = i11;
                this.f57909c = i12;
                this.f57911e = interpolator;
            }

            private void e() {
                if (this.f57911e != null && this.f57909c < 1) {
            ...
            void c(RecyclerView recyclerView) {
                ...
                if (i10 >= 0) {
                    ...
                    e();
                    recyclerView.mViewFlinger.g(this.f57907a, this.f57908b, this.f57909c, this.f57911e);
                    int i11 = this.f57913g + 1;
                    this.f57913g = i11;
                    if (i11 > 10) {
        ...
        public View b(int i10) {
            return this.f57900b.mLayout.U(i10);
        }

        public int c() {
            return this.f57900b.mLayout.b0();
        }

        public int d(View view) {
            return this.f57900b.getChildLayoutPosition(view);
        }
        ...
        void j(int i10, int i11) {
            PointF pointFA;
            RecyclerView recyclerView = this.f57900b;
            if (this.f57899a == -1 || recyclerView == null) {
                r();
            }
            if (this.f57902d && this.f57904f == null && this.f57901c != null && (pointFA = a(this.f57899a)) != null) {
                float f10 = pointFA.x;
            ...
            this.f57902d = false;
            View view = this.f57904f;
            if (view != null) {
                if (d(view) == this.f57899a) {
                    o(this.f57904f, recyclerView.mState, this.f57905g);
                    this.f57905g.c(recyclerView);
                    r();
                } else {
            ...
            if (this.f57903e) {
                l(i10, i11, recyclerView.mState, this.f57905g);
                boolean zA = this.f57905g.a();
                this.f57905g.c(recyclerView);
                if (zA && this.f57903e) {
                    this.f57902d = true;
        ...
        void q(RecyclerView recyclerView, p pVar) {
            ...
            this.f57900b = recyclerView;
            this.f57901c = pVar;
            int i10 = this.f57899a;
            if (i10 == -1) {
                throw new IllegalArgumentException("Invalid target position");
            }
            recyclerView.mState.f57914a = i10;
            this.f57903e = true;
            this.f57902d = true;
            this.f57904f = b(f());
            m();
            this.f57900b.mViewFlinger.f();
            this.f57906h = true;
        }
        ...
        protected final void r() {
            if (this.f57903e) {
                this.f57903e = false;
                n();
                this.f57900b.mState.f57914a = -1;
                this.f57904f = null;
                this.f57899a = -1;
                this.f57902d = false;
                this.f57901c.v1(this);
                this.f57901c = null;
                this.f57900b = null;
            }
        }
    ...
    public static class B {
        ...
        /* renamed from: b, reason: collision with root package name */
        private SparseArray<Object> f57915b;
        ...
        /* renamed from: g, reason: collision with root package name */
        boolean f57920g = false;

        /* renamed from: h, reason: collision with root package name */
        boolean f57921h = false;

        /* renamed from: i, reason: collision with root package name */
        boolean f57922i = false;

        /* renamed from: j, reason: collision with root package name */
        boolean f57923j = false;

        /* renamed from: k, reason: collision with root package name */
        boolean f57924k = false;

        /* renamed from: l, reason: collision with root package name */
        boolean f57925l = false;

        void f(h hVar) {
            this.f57918e = 1;
            this.f57919f = hVar.getItemCount();
            this.f57921h = false;
            this.f57922i = false;
            this.f57923j = false;
        }
        ...
        void a(int i10) {
            if ((this.f57918e & i10) != 0) {
                return;
            }
            throw new IllegalStateException("Layout state should be one of " + Integer.toBinaryString(i10) + " but it is " + Integer.toBinaryString(this.f57918e));
        }

        public int b() {
            return this.f57921h ? this.f57916c - this.f57917d : this.f57919f;
        }
        ...
        public String toString() {
            return "State{mTargetPosition=" + this.f57914a + ", mData=" + this.f57915b + ", mItemCount=" + this.f57919f + ", mIsMeasuring=" + this.f57923j + ", mPreviousLayoutItemCount=" + this.f57916c + ", mDeletedInvisibleItemCountSincePreviousLayout=" + this.f57917d + ", mStructureChanged=" + this.f57920g + ", mInPreLayout=" + this.f57921h + ", mRunSimpleAnimations=" + this.f57924k + ", mRunPredictiveAnimations=" + this.f57925l + '}';
        }
    }
    ...
    class E implements Runnable {
        ...
        /* renamed from: c, reason: collision with root package name */
        OverScroller f57933c;

        /* renamed from: d, reason: collision with root package name */
        Interpolator f57934d;

        /* renamed from: e, reason: collision with root package name */
        private boolean f57935e;

        /* renamed from: f, reason: collision with root package name */
        private boolean f57936f;

        E() {
            Interpolator interpolator = RecyclerView.sQuinticInterpolator;
            this.f57934d = interpolator;
            this.f57935e = false;
            this.f57936f = false;
            this.f57933c = new OverScroller(RecyclerView.this.getContext(), interpolator);
        }
        ...
        public void b(int i10, int i11) {
            ...
            this.f57932b = 0;
            this.f57931a = 0;
            Interpolator interpolator = this.f57934d;
            Interpolator interpolator2 = RecyclerView.sQuinticInterpolator;
            if (interpolator != interpolator2) {
                this.f57934d = interpolator2;
                this.f57933c = new OverScroller(RecyclerView.this.getContext(), interpolator2);
            }
            this.f57933c.fling(0, 0, i10, i11, Integer.MIN_VALUE, a.e.API_PRIORITY_OTHER, Integer.MIN_VALUE, a.e.API_PRIORITY_OTHER);
            f();
        }
        ...
        public void g(int i10, int i11, int i12, Interpolator interpolator) {
            ...
            this.f57931a = 0;
            RecyclerView.this.setScrollState(2);
            this.f57933c.startScroll(0, 0, i10, i11, i13);
            f();
        }

        public void h() {
            RecyclerView.this.removeCallbacks(this);
            this.f57933c.abortAnimation();
        }
        ...
        public void run() {
            ...
            OverScroller overScroller = this.f57933c;
            if (overScroller.computeScrollOffset()) {
                int currX = overScroller.getCurrX();
                int currY = overScroller.getCurrY();
                int i12 = currX - this.f57931a;
                int i13 = currY - this.f57932b;
                this.f57931a = currX;
                this.f57932b = currY;
                ...
                if (recyclerView3.mAdapter != null) {
                    ...
                    A a10 = recyclerView4.mLayout.f57959g;
                ...
                A a11 = RecyclerView.this.mLayout.f57959g;
            ...
            A a12 = RecyclerView.this.mLayout.f57959g;
            if (a12 != null && a12.g()) {
                a12.j(0, 0);
            }
            this.f57935e = false;
    ...
    public static abstract class F {
        ...
        void offsetPosition(int i10, boolean z10) {
            ...
            if (this.itemView.getLayoutParams() != null) {
                ((q) this.itemView.getLayoutParams()).f57979c = true;
            }
        }
    ...
    class RunnableC6108a implements Runnable {
        RunnableC6108a() {
        }
    ...
    class RunnableC6109b implements Runnable {
        RunnableC6109b() {
        }
    ...
    class C6113f implements C6114a.InterfaceC1135a {
        C6113f() {
        }

        @Override // androidx.recyclerview.widget.C6114a.InterfaceC1135a
        ...
        public void h(int i10, int i11) {
            ...
            recyclerView.mState.f57917d += i11;
        }

        void i(C6114a.b bVar) {
            int i10 = bVar.f58062a;
            if (i10 == 1) {
                RecyclerView recyclerView = RecyclerView.this;
                recyclerView.mLayout.h1(recyclerView, bVar.f58063b, bVar.f58065d);
                return;
            }
            if (i10 == 2) {
                RecyclerView recyclerView2 = RecyclerView.this;
                recyclerView2.mLayout.k1(recyclerView2, bVar.f58063b, bVar.f58065d);
            } else if (i10 == 4) {
                RecyclerView recyclerView3 = RecyclerView.this;
                recyclerView3.mLayout.m1(recyclerView3, bVar.f58063b, bVar.f58065d, bVar.f58064c);
            } else {
                if (i10 != 8) {
                    return;
                }
                RecyclerView recyclerView4 = RecyclerView.this;
                recyclerView4.mLayout.j1(recyclerView4, bVar.f58063b, bVar.f58065d, 1);
            }
        }

        @Override // androidx.recyclerview.widget.C6114a.InterfaceC1135a
        public void b(C6114a.b bVar) {
            i(bVar);
        }

        @Override // androidx.recyclerview.widget.C6114a.InterfaceC1135a
        public void c(C6114a.b bVar) {
            i(bVar);
        }
    }
    ...
    public static abstract class h<VH extends F> {
        ...
        boolean canRestoreState() {
            int i10 = g.f57943a[this.mStateRestorationPolicy.ordinal()];
    ...
    public static abstract class m {
        ...
        public static class c {
            ...
            public c b(F f10, int i10) {
                ...
                this.f57948a = view.getLeft();
                this.f57949b = view.getTop();
                this.f57950c = view.getRight();
                this.f57951d = view.getBottom();
                return this;
            }
        }
    ...
    public static abstract class p {
        ...
        /* renamed from: b, reason: collision with root package name */
        RecyclerView f57954b;

        /* renamed from: c, reason: collision with root package name */
        private final z.b f57955c;

        /* renamed from: d, reason: collision with root package name */
        private final z.b f57956d;

        /* renamed from: e, reason: collision with root package name */
        androidx.recyclerview.widget.z f57957e;

        /* renamed from: f, reason: collision with root package name */
        androidx.recyclerview.widget.z f57958f;
        ...
        */
        ...
        public static d w0(Context context, AttributeSet attributeSet, int i10, int i11) {
            d dVar = new d();
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C16448d.f156766a, i10, i11);
            dVar.f57973a = typedArrayObtainStyledAttributes.getInt(C16448d.f156767b, 1);
            dVar.f57974b = typedArrayObtainStyledAttributes.getInt(C16448d.f156777l, 1);
            dVar.f57975c = typedArrayObtainStyledAttributes.getBoolean(C16448d.f156776k, false);
            dVar.f57976d = typedArrayObtainStyledAttributes.getBoolean(C16448d.f156778m, false);
            typedArrayObtainStyledAttributes.recycle();
            return dVar;
        }

        public void A(View view, Rect rect) {
            RecyclerView recyclerView = this.f57954b;
            if (recyclerView == null) {
                rect.set(0, 0, 0, 0);
            } else {
        ...
        public void B0(View view, boolean z10, Rect rect) {
            Matrix matrix;
            if (z10) {
                Rect rect2 = ((q) view.getLayoutParams()).f57978b;
                rect.set(-rect2.left, -rect2.top, view.getWidth() + rect2.right, view.getHeight() + rect2.bottom);
            } else {
                rect.set(0, 0, view.getWidth(), view.getHeight());
            }
            if (this.f57954b != null && (matrix = view.getMatrix()) != null && !matrix.isIdentity()) {
                RectF rectF = this.f57954b.mTempRectF;
                rectF.set(rect);
        ...
        public boolean O0(View view, boolean z10, boolean z11) {
            boolean z12 = this.f57957e.b(view, 24579) && this.f57958f.b(view, 24579);
            return z10 ? z12 : !z12;
        }
        ...
        public void S1(int i10, int i11) {
            this.f57954b.setMeasuredDimension(i10, i11);
        }

        public View T(View view) {
            View viewFindContainingItemView;
            RecyclerView recyclerView = this.f57954b;
            if (recyclerView == null || (viewFindContainingItemView = recyclerView.findContainingItemView(view)) == null || this.f57953a.n(viewFindContainingItemView)) {
                return null;
            }
        ...
        void V1(RecyclerView recyclerView) {
            if (recyclerView == null) {
                ...
                this.f57954b = recyclerView;
                this.f57953a = recyclerView.mChildHelper;
                this.f57969q = recyclerView.getWidth();
                this.f57970r = recyclerView.getHeight();
            }
            this.f57967o = 1073741824;
            this.f57968p = 1073741824;
        }
        ...
        boolean Y1(View view, int i10, int i11, q qVar) {
            return (this.f57963k && M0(view.getMeasuredWidth(), i10, ((ViewGroup.MarginLayoutParams) qVar).width) && M0(view.getMeasuredHeight(), i11, ((ViewGroup.MarginLayoutParams) qVar).height)) ? false : true;
        }
        ...
        public void b1(w wVar, B b10, AccessibilityEvent accessibilityEvent) {
            ...
            boolean z10 = true;
            if (!recyclerView.canScrollVertically(1) && !this.f57954b.canScrollVertically(-1) && !this.f57954b.canScrollHorizontally(-1) && !this.f57954b.canScrollHorizontally(1)) {
                z10 = false;
            }
            accessibilityEvent.setScrollable(z10);
            h hVar = this.f57954b.mAdapter;
            if (hVar != null) {
        ...
        public void c1(w wVar, B b10, q2.y yVar) {
            if (this.f57954b.canScrollVertically(-1) || this.f57954b.canScrollHorizontally(-1)) {
                yVar.a(8192);
                yVar.R0(true);
            }
            if (this.f57954b.canScrollVertically(1) || this.f57954b.canScrollHorizontally(1)) {
        ...
        public View n0() {
            View focusedChild;
            RecyclerView recyclerView = this.f57954b;
            if (recyclerView == null || (focusedChild = recyclerView.getFocusedChild()) == null || this.f57953a.n(focusedChild)) {
                return null;
            }
            return focusedChild;
        }
        ...
        public void p1(w wVar, B b10, int i10, int i11) {
            this.f57954b.defaultOnMeasure(i10, i11);
        }

        public int r0() {
            return ViewCompat.z(this.f57954b);
        }

        public int t0() {
            return ViewCompat.A(this.f57954b);
        }

        public int u0() {
            return ViewCompat.B(this.f57954b);
        }
        ...
        public boolean x1(w wVar, B b10, int i10, Bundle bundle) {
            ...
            int iC0 = C0();
            Rect rect = new Rect();
            if (this.f57954b.getMatrix().isIdentity() && this.f57954b.getGlobalVisibleRect(rect)) {
                iO0 = rect.height();
                iC0 = rect.width();
            }
            if (i10 == 4096) {
                paddingTop = this.f57954b.canScrollVertically(1) ? (iO0 - getPaddingTop()) - getPaddingBottom() : 0;
                if (this.f57954b.canScrollHorizontally(1)) {
            ...
            this.f57954b.smoothScrollBy(i12, i11, null, Integer.MIN_VALUE, true);
            return true;
        }
        ...
        public p() {
            ...
            b bVar = new b();
            this.f57956d = bVar;
            this.f57957e = new androidx.recyclerview.widget.z(aVar);
            this.f57958f = new androidx.recyclerview.widget.z(bVar);
            this.f57960h = false;
            this.f57961i = false;
            this.f57962j = false;
            this.f57963k = true;
        ...
        private boolean I0(RecyclerView recyclerView, int i10, int i11) {
            ...
            Rect rect = this.f57954b.mTempRect;
        ...
        private void M1(w wVar, int i10, View view) {
            ...
            if (childViewHolderInt.isInvalid() && !childViewHolderInt.isRemoved() && !this.f57954b.mAdapter.hasStableIds()) {
                H1(i10);
                wVar.I(childViewHolderInt);
            } else {
                P(i10);
                wVar.J(view);
                this.f57954b.mViewInfoStore.k(childViewHolderInt);
            }
        }
        ...
        private void v(View view, int i10, boolean z10) {
            ...
            if (!z10 && !childViewHolderInt.isRemoved()) {
                this.f57954b.mViewInfoStore.p(childViewHolderInt);
            } else {
                this.f57954b.mViewInfoStore.b(childViewHolderInt);
            }
            q qVar = (q) view.getLayoutParams();
            if (!childViewHolderInt.wasReturnedFromScrap() && !childViewHolderInt.isScrap()) {
                if (view.getParent() == this.f57954b) {
                    int iM = this.f57953a.m(view);
                    if (i10 == -1) {
                        i10 = this.f57953a.g();
                    }
                    if (iM != -1) {
                        if (iM != i10) {
                            this.f57954b.mLayout.R0(iM, i10);
                        }
                    } else {
                        throw new IllegalStateException("Added View has RecyclerView as parent but view is not a real child. Unfiltered index:" + this.f57954b.indexOfChild(view) + this.f57954b.exceptionLabel());
                    }
                } else {
                    this.f57953a.a(view, i10, false);
                    qVar.f57979c = true;
                    A a10 = this.f57959g;
                    if (a10 != null && a10.h()) {
                        this.f57959g.k(view);
                ...
                this.f57953a.c(view, i10, view.getLayoutParams(), false);
            }
            if (qVar.f57980d) {
                if (RecyclerView.sVerboseLoggingEnabled) {
                    FS.log_d(RecyclerView.TAG, "consuming pending invalidate on child " + qVar.f57977a);
                }
        ...
        public int A0(View view) {
            return ((q) view.getLayoutParams()).f57978b.top;
        }
            ...
            for (int i10 = iK - 1; i10 >= 0; i10--) {
                ...
                if (!childViewHolderInt.shouldIgnore()) {
                    ...
                    if (childViewHolderInt.isTmpDetached()) {
                        this.f57954b.removeDetachedView(viewO, false);
                    }
                    m mVar = this.f57954b.mItemAnimator;
                    if (mVar != null) {
        ...
        public void F0(View view) {
            ...
            if (parent == recyclerView && recyclerView.indexOfChild(view) != -1) {
                ...
                this.f57954b.mViewInfoStore.q(childViewHolderInt);
            } else {
                throw new IllegalArgumentException("View should be fully attached to be ignored" + this.f57954b.exceptionLabel());
            }
        }
        ...
        public void Q0(View view, int i10, int i11) {
            q qVar = (q) view.getLayoutParams();
            Rect itemDecorInsetsForChild = this.f57954b.getItemDecorInsetsForChild(view);
        ...
        public void R0(int i10, int i11) {
            ...
            if (viewA0 != null) {
                ...
                throw new IllegalArgumentException("Cannot move a child from non-existing index:" + i10 + this.f57954b.toString());
            }
        }

        void R1(int i10, int i11) {
            this.f57969q = View.MeasureSpec.getSize(i10);
            int mode = View.MeasureSpec.getMode(i10);
            this.f57967o = mode;
            if (mode == 0 && !RecyclerView.ALLOW_SIZE_IN_UNSPECIFIED_SPEC) {
                this.f57969q = 0;
            }
            this.f57970r = View.MeasureSpec.getSize(i11);
        ...
        public View U(int i10) {
            ...
            for (int i11 = 0; i11 < iB0; i11++) {
                ...
                if (childViewHolderInt != null && childViewHolderInt.getLayoutPosition() == i10 && !childViewHolderInt.shouldIgnore() && (this.f57954b.mState.e() || !childViewHolderInt.isRemoved())) {
                    return viewA0;
                }
            }
            return null;
        ...
        void U1(int i10, int i11) {
            ...
            this.f57954b.mTempRect.set(i15, i13, i12, i14);
            T1(this.f57954b.mTempRect, i10, i11);
        }

        boolean W1(View view, int i10, int i11, q qVar) {
            if (!view.isLayoutRequested() && this.f57963k && M0(view.getWidth(), i10, ((ViewGroup.MarginLayoutParams) qVar).width) && M0(view.getHeight(), i11, ((ViewGroup.MarginLayoutParams) qVar).height)) {
                return false;
            }
            return true;
        }
        ...
        public int Z(View view) {
            return ((q) view.getLayoutParams()).f57978b.bottom;
        }
        ...
        void e1(View view, q2.y yVar) {
            F childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
            if (childViewHolderInt != null && !childViewHolderInt.isRemoved() && !this.f57953a.n(childViewHolderInt.itemView)) {
                RecyclerView recyclerView = this.f57954b;
        ...
        public int j0(View view) {
            Rect rect = ((q) view.getLayoutParams()).f57978b;
        ...
        public int s0(View view) {
            return ((q) view.getLayoutParams()).f57978b.left;
        }
        ...
        public int x0(View view) {
            return ((q) view.getLayoutParams()).f57978b.right;
        }
        ...
        public void z(View view, int i10, q qVar) {
            ...
            this.f57953a.c(view, i10, qVar, childViewHolderInt.isRemoved());
        }
    }
    ...
    public static class q extends ViewGroup.MarginLayoutParams {
        ...
        @Deprecated
        public int a() {
            return this.f57977a.getBindingAdapterPosition();
        }

        public int b() {
            return this.f57977a.getLayoutPosition();
        }

        public boolean c() {
            return this.f57977a.isUpdated();
        }

        public boolean d() {
            return this.f57977a.isRemoved();
        }

        public boolean e() {
            return this.f57977a.isInvalid();
        }
    ...
    public static class v {
        ...
        /* renamed from: a, reason: collision with root package name */
        SparseArray<a> f57981a = new SparseArray<>();

        /* renamed from: b, reason: collision with root package name */
        int f57982b = 0;

        /* renamed from: c, reason: collision with root package name */
        Set<h<?>> f57983c = Collections.newSetFromMap(new IdentityHashMap());

        public void c() {
            for (int i10 = 0; i10 < this.f57981a.size(); i10++) {
                a aVarValueAt = this.f57981a.valueAt(i10);
                Iterator<F> it = aVarValueAt.f57984a.iterator();
                while (it.hasNext()) {
                    C17485a.b(it.next().itemView);
                }
                aVarValueAt.f57984a.clear();
            }
        }
        ...
        static class a {
            ...
            /* renamed from: a, reason: collision with root package name */
            final ArrayList<F> f57984a = new ArrayList<>();
        ...
        private a i(int i10) {
            a aVar = this.f57981a.get(i10);
            if (aVar != null) {
                return aVar;
            }
            a aVar2 = new a();
            this.f57981a.put(i10, aVar2);
            return aVar2;
        }
        ...
        void e(h<?> hVar, boolean z10) {
            this.f57983c.remove(hVar);
            if (this.f57983c.size() != 0 || z10) {
                return;
            }
            for (int i10 = 0; i10 < this.f57981a.size(); i10++) {
                SparseArray<a> sparseArray = this.f57981a;
                ArrayList<F> arrayList = sparseArray.get(sparseArray.keyAt(i10)).f57984a;
                for (int i11 = 0; i11 < arrayList.size(); i11++) {
                    C17485a.b(arrayList.get(i11).itemView);
                }
            }
        }
        ...
        public F h(int i10) {
            a aVar = this.f57981a.get(i10);
            if (aVar == null || aVar.f57984a.isEmpty()) {
                return null;
            }
            ArrayList<F> arrayList = aVar.f57984a;
        ...
        void f(int i10, long j10) {
            a aVarI = i(i10);
            aVarI.f57987d = l(aVarI.f57987d, j10);
        }

        void g(int i10, long j10) {
            a aVarI = i(i10);
            aVarI.f57986c = l(aVarI.f57986c, j10);
        }

        public void k(F f10) {
            int itemViewType = f10.getItemViewType();
            ArrayList<F> arrayList = i(itemViewType).f57984a;
            if (this.f57981a.get(itemViewType).f57985b <= arrayList.size()) {
                C17485a.b(f10.itemView);
            } else {
    ...
    public final class w {
        ...
        /* renamed from: a, reason: collision with root package name */
        final ArrayList<F> f57988a;

        /* renamed from: b, reason: collision with root package name */
        ArrayList<F> f57989b;

        /* renamed from: c, reason: collision with root package name */
        final ArrayList<F> f57990c;

        /* renamed from: d, reason: collision with root package name */
        private final List<F> f57991d;
        ...
        private boolean N(F f10, int i10, int i11, long j10) {
            ...
            boolean z10 = false;
            if (j10 != RecyclerView.FOREVER_NS && !this.f57994g.m(itemViewType, nanoTime, j10)) {
                return false;
            }
            ...
            this.f57994g.f(f10.getItemViewType(), RecyclerView.this.getNanoTime() - nanoTime);
            b(f10);
        ...
        void B() {
            for (int i10 = 0; i10 < this.f57990c.size(); i10++) {
                C17485a.b(this.f57990c.get(i10).itemView);
            }
        ...
        void S(int i10, int i11) {
            int i12;
            int i13 = i11 + i10;
            for (int size = this.f57990c.size() - 1; size >= 0; size--) {
                F f10 = this.f57990c.get(size);
        ...
        public w() {
            ...
            this.f57989b = null;
            this.f57990c = new ArrayList<>();
            this.f57991d = Collections.unmodifiableList(arrayList);
            this.f57992e = 2;
            this.f57993f = 2;
        }
        ...
        private void v() {
            if (this.f57994g != null) {
                ...
                this.f57994g.b(RecyclerView.this.mAdapter);
            }
        }
        ...
        void G(int i10) {
            ...
            F f10 = this.f57990c.get(i10);
            if (RecyclerView.sVerboseLoggingEnabled) {
                FS.log_d(RecyclerView.TAG, "CachedViewHolder to be recycled: " + f10);
            }
            a(f10, true);
            this.f57990c.remove(i10);
        }

        void K(v vVar) {
            C(RecyclerView.this.mAdapter);
            v vVar2 = this.f57994g;
            if (vVar2 != null) {
                vVar2.d();
            }
            this.f57994g = vVar;
        ...
        */
        ...
        void P(F f10) {
            if (f10.mInChangeScrap) {
                this.f57989b.remove(f10);
            } else {
                this.f57988a.remove(f10);
            }
        ...
        void Q() {
            ...
            this.f57993f = this.f57992e + (pVar != null ? pVar.f57965m : 0);
            for (int size = this.f57990c.size() - 1; size >= 0 && this.f57990c.size() > this.f57993f; size--) {
                G(size);
            }
        }
        ...
        void e() {
            int size = this.f57990c.size();
            for (int i10 = 0; i10 < size; i10++) {
                this.f57990c.get(i10).clearOldPosition();
            }
            int size2 = this.f57988a.size();
            for (int i11 = 0; i11 < size2; i11++) {
                this.f57988a.get(i11).clearOldPosition();
            }
            ArrayList<F> arrayList = this.f57989b;
            if (arrayList != null) {
                int size3 = arrayList.size();
                for (int i12 = 0; i12 < size3; i12++) {
                    this.f57989b.get(i12).clearOldPosition();
                }
            }
        }
        ...
        F m(long j10, int i10, boolean z10) {
            for (int size = this.f57988a.size() - 1; size >= 0; size--) {
                F f10 = this.f57988a.get(size);
                if (f10.getItemId() == j10 && !f10.wasReturnedFromScrap()) {
                    ...
                    if (!z10) {
                        this.f57988a.remove(size);
                        RecyclerView.this.removeDetachedView(f10.itemView, false);
                        E(f10.itemView);
                    }
                }
            }
            int size2 = this.f57990c.size();
            while (true) {
                size2--;
                if (size2 < 0) {
                    return null;
                }
                F f11 = this.f57990c.get(size2);
                if (f11.getItemId() == j10 && !f11.isAttachedToTransitionOverlay()) {
                    if (i10 == f11.getItemViewType()) {
                        if (!z10) {
                            this.f57990c.remove(size2);
                        }
                        return f11;
                    }
                    if (!z10) {
        ...
        F n(int i10, boolean z10) {
            View viewE;
            int size = this.f57988a.size();
            for (int i11 = 0; i11 < size; i11++) {
                F f10 = this.f57988a.get(i11);
                if (!f10.wasReturnedFromScrap() && f10.getLayoutPosition() == i10 && !f10.isInvalid() && (RecyclerView.this.mState.f57921h || !f10.isRemoved())) {
                    f10.addFlags(32);
                    return f10;
                }
            }
        ...
        View o(int i10) {
            return this.f57988a.get(i10).itemView;
        }

        void t() {
            int size = this.f57990c.size();
            for (int i10 = 0; i10 < size; i10++) {
                q qVar = (q) this.f57990c.get(i10).itemView.getLayoutParams();
                if (qVar != null) {
                    qVar.f57979c = true;
                }
            }
            ...
            if (!f10.isScrap() && f10.itemView.getParent() == null) {
                if (!f10.isTmpDetached()) {
                    if (!f10.shouldIgnore()) {
                        ...
                        if (RecyclerView.sDebugAssertionsEnabled && this.f57990c.contains(f10)) {
                        ...
                        if (!z10 && !f10.isRecyclable()) {
                            ...
                            if (this.f57993f > 0 && !f10.hasAnyOfTheFlags(526)) {
                                int size = this.f57990c.size();
                                if (size >= this.f57993f && size > 0) {
                                    G(0);
                                    size--;
                                }
                                if (RecyclerView.ALLOW_THREAD_GAP_WORK && size > 0 && !RecyclerView.this.mPrefetchRegistry.d(f10.mPosition)) {
                                    int i10 = size - 1;
                                    while (i10 >= 0) {
                                        if (!RecyclerView.this.mPrefetchRegistry.d(this.f57990c.get(i10).mPosition)) {
                                            break;
                                        } else {
                                            i10--;
                                        }
        ...
        void J(View view) {
            ...
            if (!childViewHolderInt.hasAnyOfTheFlags(12) && childViewHolderInt.isUpdated() && !RecyclerView.this.canReuseUpdatedViewHolder(childViewHolderInt)) {
                if (this.f57989b == null) {
                    this.f57989b = new ArrayList<>();
                }
                childViewHolderInt.setScrapContainer(this, true);
                this.f57989b.add(childViewHolderInt);
                return;
            }
            ...
            this.f57988a.add(childViewHolderInt);
        }
        ...
        public void c(View view, int i10) {
            ...
            if (childViewHolderInt != null) {
                ...
                if (iM >= 0 && iM < RecyclerView.this.mAdapter.getItemCount()) {
                    ...
                    boolean z10 = true;
                    qVar.f57979c = true;
                    qVar.f57977a = childViewHolderInt;
    ...
    private class y extends j {
        ...
        public void a() {
            ...
            RecyclerView recyclerView = RecyclerView.this;
            recyclerView.mState.f57920g = true;
    ...
    public static class z extends AbstractC17751a {
        ...
        z(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f57997c = parcel.readParcelable(classLoader == null ? p.class.getClassLoader() : classLoader);
        }

        void b(z zVar) {
            this.f57997c = zVar.f57997c;
        }

        @Override // w2.AbstractC17751a, android.os.Parcelable
        public void writeToParcel(Parcel parcel, int i10) {
            super.writeToParcel(parcel, i10);
            parcel.writeParcelable(this.f57997c, 0);
        }
    ...
    */
    ...
    void recordAnimationInfoIfBouncedHiddenView(F f10, m.c cVar) {
        f10.setFlags(0, 8192);
        if (this.mState.f57922i && f10.isUpdated() && !f10.isRemoved() && !f10.shouldIgnore()) {
    ...
    class InterpolatorC6110c implements Interpolator {
    ...
    static /* synthetic */ class g {
        ...
        /* renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f57943a;
        ...
        static {
            ...
            try {
                f57943a[h.a.PREVENT_WHEN_EMPTY.ordinal()] = 2;
    ...
    public RecyclerView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C16445a.f156758a);
    }
    ...
    private void dispatchContentChangedIfNecessary() {
        ...
        C16440b.b(accessibilityEventObtain, i10);
    ...
    private void dispatchLayoutStep1() {
        ...
        saveFocusInfo();
        B b10 = this.mState;
        b10.f57922i = b10.f57924k && this.mItemsChanged;
        this.mItemsChanged = false;
        this.mItemsAddedOrRemoved = false;
        b10.f57921h = b10.f57925l;
        b10.f57919f = this.mAdapter.getItemCount();
        findMinMaxChildLayoutPositions(this.mMinMaxLayoutPositions);
        if (this.mState.f57924k) {
            ...
            for (int i10 = 0; i10 < iG; i10++) {
                ...
                if (!childViewHolderInt.shouldIgnore() && (!childViewHolderInt.isInvalid() || this.mAdapter.hasStableIds())) {
                    ...
                    if (this.mState.f57922i && childViewHolderInt.isUpdated() && !childViewHolderInt.isRemoved() && !childViewHolderInt.shouldIgnore() && !childViewHolderInt.isInvalid()) {
                        this.mViewInfoStore.c(getChangedHolderKey(childViewHolderInt), childViewHolderInt);
                    }
                }
            }
        }
        if (this.mState.f57925l) {
            saveOldPositions();
            B b11 = this.mState;
            boolean z10 = b11.f57920g;
            b11.f57920g = false;
            this.mLayout.n1(this.mRecycler, b11);
            this.mState.f57920g = z10;
    ...
    private void dispatchLayoutStep3() {
        ...
        b11.f57916c = b11.f57919f;
        recyclerView.mDataSetHasChangedAfterLayout = false;
        recyclerView.mDispatchItemsChangedEvent = false;
        b11.f57924k = false;
        b11.f57925l = false;
        recyclerView.mLayout.f57960h = false;
        ArrayList<F> arrayList = recyclerView.mRecycler.f57989b;
        if (arrayList != null) {
            arrayList.clear();
        }
    ...
    static F getChildViewHolderInt(View view) {
        ...
        return ((q) view.getLayoutParams()).f57977a;
    }

    private C16197C getScrollingChildHelper() {
        if (this.mScrollingChildHelper == null) {
            this.mScrollingChildHelper = new C16197C(this);
        }
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new f(new C6112e());
    }
    ...
    private void processAdapterUpdatesAndSetAnimationFlags() {
        ...
        this.mState.f57924k = this.mFirstLayoutComplete && this.mItemAnimator != null && ((z10 = this.mDataSetHasChangedAfterLayout) || z11 || this.mLayout.f57960h) && (!z10 || this.mAdapter.hasStableIds());
        B b10 = this.mState;
        b10.f57925l = b10.f57924k && z11 && !this.mDataSetHasChangedAfterLayout && predictiveItemAnimationsEnabled();
    }
    ...
    private void recoverFocusFromState() {
        ...
        F fFindViewHolderForItemId = (this.mState.f57927n == -1 || !this.mAdapter.hasStableIds()) ? null : findViewHolderForItemId(this.mState.f57927n);
    ...
    private void saveFocusInfo() {
        ...
        this.mState.f57927n = this.mAdapter.hasStableIds() ? fFindContainingViewHolder.getItemId() : -1L;
        this.mState.f57926m = this.mDataSetHasChangedAfterLayout ? -1 : fFindContainingViewHolder.isRemoved() ? fFindContainingViewHolder.mOldPosition : fFindContainingViewHolder.getAbsoluteAdapterPosition();
        this.mState.f57928o = getDeepestFocusedViewWithId(fFindContainingViewHolder.itemView);
    }
    ...
    */
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new C6114a(new C6113f());
    }

    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable != null && drawable != null && stateListDrawable2 != null && drawable2 != null) {
            Resources resources = getContext().getResources();
            new androidx.recyclerview.widget.j(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C16446b.f156759a), resources.getDimensionPixelSize(C16446b.f156761c), resources.getDimensionPixelOffset(C16446b.f156760b));
        } else {
    ...
    void markItemDecorInsetsDirty() {
        int iJ = this.mChildHelper.j();
        for (int i10 = 0; i10 < iJ; i10++) {
            ((q) this.mChildHelper.i(i10).getLayoutParams()).f57979c = true;
        }
        this.mRecycler.t();
    }
    ...
    protected void onMeasure(int i10, int i11) {
        ...
        if (this.mAdapterUpdateDuringMeasure) {
            ...
            if (b10.f57925l) {
                ...
                this.mAdapterHelper.j();
                this.mState.f57921h = false;
            }
            this.mAdapterUpdateDuringMeasure = false;
            stopInterceptRequestLayout(false);
        } else if (this.mState.f57925l) {
            setMeasuredDimension(getMeasuredWidth(), getMeasuredHeight());
            return;
        }
        h hVar = this.mAdapter;
        if (hVar != null) {
            this.mState.f57919f = hVar.getItemCount();
        } else {
            this.mState.f57919f = 0;
        }
        startInterceptRequestLayout();
        this.mLayout.p1(this.mRecycler, this.mState, i10, i11);
        stopInterceptRequestLayout(false);
    ...
    */
    ...
    boolean scrollByInternal(int i10, int i11, MotionEvent motionEvent, int i12) {
        ...
        if (getOverScrollMode() != 2) {
            if (motionEvent != null && !C16195A.a(motionEvent, 8194)) {
    ...
    public void setLayoutManager(p pVar) {
        ...
        this.mLayout = pVar;
        if (pVar != null) {
            if (pVar.f57954b != null) {
                throw new IllegalArgumentException("LayoutManager " + pVar + " is already attached to a RecyclerView:" + pVar.f57954b.exceptionLabel());
            }
            pVar.V1(this);
            if (this.mIsAttached) {
                this.mLayout.R(this);
    ...
    void viewRangeUpdate(int i10, int i11, Object obj) {
        ...
        for (int i14 = 0; i14 < iJ; i14++) {
            ...
            if (childViewHolderInt != null && !childViewHolderInt.shouldIgnore() && (i12 = childViewHolderInt.mPosition) >= i10 && i12 < i13) {
                ...
                ((q) viewI.getLayoutParams()).f57979c = true;
            }
        }
    ...
    static {
        ...
        sQuinticInterpolator = new InterpolatorC6110c();
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i10) throws NoSuchMethodException, SecurityException {
        ...
        this.mUpdateChildViewsRunnable = new RunnableC6108a();
        ...
        this.mItemAnimatorRunner = new RunnableC6109b();
        this.mLastAutoMeasureNonExactMeasuredWidth = 0;
        this.mLastAutoMeasureNonExactMeasuredHeight = 0;
        this.mViewInfoProcessCallback = new C6111d();
        setScrollContainer(true);
        setFocusableInTouchMode(true);
        ViewConfiguration viewConfiguration = ViewConfiguration.get(context);
        this.mTouchSlop = viewConfiguration.getScaledTouchSlop();
        this.mScaledHorizontalScrollFactor = C16200a0.f(viewConfiguration, context);
        this.mScaledVerticalScrollFactor = C16200a0.j(viewConfiguration, context);
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C16448d.f156766a, i10, 0);
        ViewCompat.k0(this, context, C16448d.f156766a, attributeSet, typedArrayObtainStyledAttributes, i10, 0);
        String string = typedArrayObtainStyledAttributes.getString(C16448d.f156775j);
        if (typedArrayObtainStyledAttributes.getInt(C16448d.f156769d, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = typedArrayObtainStyledAttributes.getBoolean(C16448d.f156768c, true);
        boolean z10 = typedArrayObtainStyledAttributes.getBoolean(C16448d.f156770e, false);
        this.mEnableFastScroller = z10;
        if (z10) {
            initFastScroller((StateListDrawable) __fsTypeCheck_7aed730c0cb897b271b15a3fca45c160(typedArrayObtainStyledAttributes, C16448d.f156773h), __fsTypeCheck_7aed730c0cb897b271b15a3fca45c160(typedArrayObtainStyledAttributes, C16448d.f156774i), (StateListDrawable) __fsTypeCheck_7aed730c0cb897b271b15a3fca45c160(typedArrayObtainStyledAttributes, C16448d.f156771f), __fsTypeCheck_7aed730c0cb897b271b15a3fca45c160(typedArrayObtainStyledAttributes, C16448d.f156772g));
        }
        typedArrayObtainStyledAttributes.recycle();
    ...
    private void dispatchLayoutStep2() {
        ...
        this.mState.a(6);
        this.mAdapterHelper.j();
        this.mState.f57919f = this.mAdapter.getItemCount();
        this.mState.f57917d = 0;
        if (this.mPendingSavedState != null && this.mAdapter.canRestoreState()) {
            Parcelable parcelable = this.mPendingSavedState.f57997c;
            if (parcelable != null) {
        ...
        B b11 = this.mState;
        b11.f57920g = false;
        if (b11.f57924k && this.mItemAnimator != null) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    final void fillRemainingScrollValues(B b10) {
        if (getScrollState() == 2) {
            OverScroller overScroller = this.mViewFlinger.f57933c;
            b10.f57929p = overScroller.getFinalX() - overScroller.getCurrX();
            b10.f57930q = overScroller.getFinalY() - overScroller.getCurrY();
        } else {
            b10.f57929p = 0;
            b10.f57930q = 0;
        }
    ...
    */
    protected void onAttachedToWindow() {
        ...
        L23:
            ...
            if (r0 == 0) goto L66
            java.lang.ThreadLocal<androidx.recyclerview.widget.k> r0 = androidx.recyclerview.widget.k.f58208e
    ...
    boolean shouldDeferAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        if (accessibilityEvent != null) {
            iA = C16440b.a(accessibilityEvent);
        } else {
            iA = 0;
        }
        if (iA != 0) {
