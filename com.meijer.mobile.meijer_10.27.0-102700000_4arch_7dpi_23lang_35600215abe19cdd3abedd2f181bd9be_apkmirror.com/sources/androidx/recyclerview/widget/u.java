...
public class u extends y {
    ...
    class a extends p {
        ...
        protected void o(View view, RecyclerView.B b10, RecyclerView.A.a aVar) {
            u uVar = u.this;
            int[] iArrC = uVar.c(uVar.f58311a.getLayoutManager(), view);
            int i10 = iArrC[0];
            int i11 = iArrC[1];
            int iW = w(Math.max(Math.abs(i10), Math.abs(i11)));
            if (iW > 0) {
                aVar.d(i10, i11, iW, this.f58292j);
            }
        }
    ...
    private t m(RecyclerView.p pVar) {
        t tVar = this.f58305e;
        if (tVar == null || tVar.f58301a != pVar) {
            this.f58305e = t.a(pVar);
        }
        return this.f58305e;
    }
    ...
    protected RecyclerView.A d(RecyclerView.p pVar) {
        if (pVar instanceof RecyclerView.A.b) {
            return new a(this.f58311a.getContext());
        }
        return null;
    }
