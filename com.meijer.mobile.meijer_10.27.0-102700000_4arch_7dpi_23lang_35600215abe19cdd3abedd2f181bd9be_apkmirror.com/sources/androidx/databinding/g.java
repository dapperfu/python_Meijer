...
public class g {
    ...
    private static e f54096a = new DataBinderMapperImpl();

    /* renamed from: b, reason: collision with root package name */
    private static f f54097b = null;
    ...
    static <T extends p> T a(f fVar, View view, int i10) {
        return (T) f54096a.b(fVar, view, i10);
    }

    static <T extends p> T b(f fVar, View[] viewArr, int i10) {
        return (T) f54096a.c(fVar, viewArr, i10);
    }
    ...
    public static <T extends p> T e(LayoutInflater layoutInflater, int i10, ViewGroup viewGroup, boolean z10) {
        return (T) f(layoutInflater, i10, viewGroup, z10, f54097b);
    }
