...
public class r {
    ...
    private static final Class<?>[] f45976b = {Context.class, AttributeSet.class};

    /* renamed from: c, reason: collision with root package name */
    private static final int[] f45977c = {R.attr.onClick};

    /* renamed from: d, reason: collision with root package name */
    private static final int[] f45978d = {R.attr.accessibilityHeading};

    /* renamed from: e, reason: collision with root package name */
    private static final int[] f45979e = {R.attr.accessibilityPaneTitle};

    /* renamed from: f, reason: collision with root package name */
    private static final int[] f45980f = {R.attr.screenReaderFocusable};

    /* renamed from: g, reason: collision with root package name */
    private static final String[] f45981g = {"android.widget.", "android.view.", "android.webkit."};

    /* renamed from: h, reason: collision with root package name */
    private static final n0<String, Constructor<? extends View>> f45982h = new n0<>();

    /* renamed from: a, reason: collision with root package name */
    private final Object[] f45983a = new Object[2];

    private static class a implements View.OnClickListener {

        /* renamed from: a, reason: collision with root package name */
        private final View f45984a;

        /* renamed from: b, reason: collision with root package name */
        private final String f45985b;

        /* renamed from: c, reason: collision with root package name */
        private Method f45986c;

        /* renamed from: d, reason: collision with root package name */
        private Context f45987d;
        ...
        private void a(Context context) {
            ...
            while (context != null) {
                try {
                    if (!context.isRestricted() && (method = context.getClass().getMethod(this.f45985b, View.class)) != null) {
                        this.f45986c = method;
                        this.f45987d = context;
                        return;
                    }
            ...
            int id2 = this.f45984a.getId();
            if (id2 == -1) {
                str = "";
            } else {
                str = " with id '" + this.f45984a.getContext().getResources().getResourceEntryName(id2) + "'";
            }
            throw new IllegalStateException("Could not find method " + this.f45985b + "(View) in a parent or ancestor Context for android:onClick attribute defined on view " + this.f45984a.getClass() + str);
        }

        @Override // android.view.View.OnClickListener
        public void onClick(View view) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            if (this.f45986c == null) {
                a(this.f45984a.getContext());
            }
            try {
                this.f45986c.invoke(this.f45987d, view);
    ...
    private void a(Context context, View view, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f45978d);
        if (typedArrayObtainStyledAttributes.hasValue(0)) {
            ViewCompat.n0(view, typedArrayObtainStyledAttributes.getBoolean(0, false));
        }
        typedArrayObtainStyledAttributes.recycle();
        TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, f45979e);
        if (typedArrayObtainStyledAttributes2.hasValue(0)) {
            ViewCompat.p0(view, typedArrayObtainStyledAttributes2.getString(0));
        }
        typedArrayObtainStyledAttributes2.recycle();
        TypedArray typedArrayObtainStyledAttributes3 = context.obtainStyledAttributes(attributeSet, f45980f);
    ...
    private View s(Context context, String str, String str2) throws InflateException, NoSuchMethodException, SecurityException, ClassNotFoundException {
        String str3;
        n0<String, Constructor<? extends View>> n0Var = f45982h;
        ...
        if (constructor == null) {
            ...
            constructor = Class.forName(str3, false, context.getClassLoader()).asSubclass(View.class).getConstructor(f45976b);
            n0Var.put(str, constructor);
        }
        constructor.setAccessible(true);
        return constructor.newInstance(this.f45983a);
    }
    ...
    private static Context u(Context context, AttributeSet attributeSet, boolean z10, boolean z11) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C14584j.f136923y3, 0, 0);
        int resourceId = z10 ? typedArrayObtainStyledAttributes.getResourceId(C14584j.f136928z3, 0) : 0;
        if (z11 && resourceId == 0 && (resourceId = typedArrayObtainStyledAttributes.getResourceId(C14584j.f136690A3, 0)) != 0) {
    ...
    private void b(View view, AttributeSet attributeSet) {
        ...
        if ((context instanceof ContextWrapper) && view.hasOnClickListeners()) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f45977c);
