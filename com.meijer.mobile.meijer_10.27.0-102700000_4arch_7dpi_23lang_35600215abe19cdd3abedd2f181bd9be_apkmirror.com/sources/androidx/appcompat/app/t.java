...
class t {
    ...
    private final Deque<WeakReference<XmlPullParser>> f45988a = new ArrayDeque();
    ...
    boolean a(AttributeSet attributeSet) {
        ...
        XmlPullParser xmlPullParserC = c(this.f45988a);
        this.f45988a.push(new WeakReference<>(xmlPullParser));
