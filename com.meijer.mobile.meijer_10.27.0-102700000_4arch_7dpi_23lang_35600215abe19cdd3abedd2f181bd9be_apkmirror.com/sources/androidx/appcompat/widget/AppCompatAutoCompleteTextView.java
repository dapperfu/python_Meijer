...
public class AppCompatAutoCompleteTextView extends AutoCompleteTextView {
    ...
    private static final int[] f46482d = {R.attr.popupBackground};

    /* renamed from: a, reason: collision with root package name */
    private final C5626b f46483a;

    /* renamed from: b, reason: collision with root package name */
    private final C5639o f46484b;

    /* renamed from: c, reason: collision with root package name */
    private final C5630f f46485c;
    ...
    public AppCompatAutoCompleteTextView(Context context, AttributeSet attributeSet, int i10) {
        ...
        H.a(this, getContext());
        M mV = M.v(getContext(), attributeSet, f46482d, i10, 0);
        if (mV.s(0)) {
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f46484b.j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f46484b.k();
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f46485c.a(keyListener));
    }
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f46485c.d(C5632h.a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
