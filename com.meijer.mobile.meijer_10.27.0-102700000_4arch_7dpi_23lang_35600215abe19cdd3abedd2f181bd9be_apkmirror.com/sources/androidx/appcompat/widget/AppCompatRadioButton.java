...
public class AppCompatRadioButton extends RadioButton implements androidx.core.widget.m {
    ...
    private final C5628d f46508a;

    /* renamed from: b, reason: collision with root package name */
    private final C5626b f46509b;

    /* renamed from: c, reason: collision with root package name */
    private final C5639o f46510c;

    /* renamed from: d, reason: collision with root package name */
    private C5631g f46511d;

    public AppCompatRadioButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C14575a.f136514K);
    }

    @Override // android.widget.CompoundButton
    public void setButtonDrawable(Drawable drawable) {
        super.setButtonDrawable(drawable);
        C5628d c5628d = this.f46508a;
        if (c5628d != null) {
            c5628d.e();
        }
    }
    ...
    private C5631g getEmojiTextViewHelper() {
        if (this.f46511d == null) {
            this.f46511d = new C5631g(this);
        }
        return this.f46511d;
    }

    public ColorStateList getSupportBackgroundTintList() {
        C5626b c5626b = this.f46509b;
        if (c5626b != null) {
            return c5626b.c();
        }
        return null;
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f46510c.j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f46510c.k();
    }
