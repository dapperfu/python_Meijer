...
public abstract class u {
    ...
    public static final class Companion {
        ...
        static final class C1132a extends Lambda implements Function1<Context, w> {

            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ Context f57785f;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C1132a(Context context) {
                super(1);
                this.f57785f = context;
            }
        ...
        static final class b extends Lambda implements Function1<Context, x> {
            ...
            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ Context f57786f;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            b(Context context) {
                super(1);
                this.f57786f = context;
            }
        ...
        public final u a(Context context) {
            ...
            if (c15363a.b() >= 11) {
                return (u) C15364b.f148507a.a(context, "TopicsManager", new C1132a(context));
            }
            if (c15363a.b() >= 9) {
                return (u) C15364b.f148507a.a(context, "TopicsManager", new b(context));
            }
            return null;
        }
    }

    public abstract Object a(C6103b c6103b, Continuation<? super h> continuation);
}
