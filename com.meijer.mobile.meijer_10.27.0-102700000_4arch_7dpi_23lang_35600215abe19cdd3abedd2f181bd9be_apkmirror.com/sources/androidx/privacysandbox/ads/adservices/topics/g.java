...
public final class g {
    ...
    public static final g f57777a = new g();

    public final GetTopicsRequest a(C6103b request) {
        Intrinsics.j(request, "request");
        GetTopicsRequest getTopicsRequestBuild = C6104c.a().setAdsSdkName(request.getAdsSdkName()).setShouldRecordObservation(request.getShouldRecordObservation()).build();
        Intrinsics.i(getTopicsRequestBuild, "Builder()\n            .s…ion)\n            .build()");
        return getTopicsRequestBuild;
    }

    public final GetTopicsRequest b(C6103b request) {
        Intrinsics.j(request, "request");
        GetTopicsRequest getTopicsRequestBuild = C6104c.a().setAdsSdkName(request.getAdsSdkName()).build();
        Intrinsics.i(getTopicsRequestBuild, "Builder()\n            .s…ame)\n            .build()");
        return getTopicsRequestBuild;
    }
