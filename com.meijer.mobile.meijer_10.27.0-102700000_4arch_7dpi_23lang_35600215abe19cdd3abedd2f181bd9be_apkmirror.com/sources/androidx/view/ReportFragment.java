...
public class ReportFragment extends Fragment {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final void a(Activity activity, AbstractC6023l.a event) {
            Intrinsics.j(activity, "activity");
            Intrinsics.j(event, "event");
            if (activity instanceof InterfaceC6034w) {
                ((InterfaceC6034w) activity).getLifecycle().i(event);
            } else if (activity instanceof InterfaceC6030s) {
                AbstractC6023l lifecycle = ((InterfaceC6030s) activity).getLifecycle();
                if (lifecycle instanceof C6032u) {
                    ((C6032u) lifecycle).i(event);
                }
            }
        }
    ...
    public static final class c implements Application.ActivityLifecycleCallbacks {
        ...
        public void onActivityPostCreated(Activity activity, Bundle savedInstanceState) {
            Intrinsics.j(activity, "activity");
            ReportFragment.INSTANCE.a(activity, AbstractC6023l.a.ON_CREATE);
        }

        @Override // android.app.Application.ActivityLifecycleCallbacks
        public void onActivityPostResumed(Activity activity) {
            Intrinsics.j(activity, "activity");
            ReportFragment.INSTANCE.a(activity, AbstractC6023l.a.ON_RESUME);
        }

        @Override // android.app.Application.ActivityLifecycleCallbacks
        public void onActivityPostStarted(Activity activity) {
            Intrinsics.j(activity, "activity");
            ReportFragment.INSTANCE.a(activity, AbstractC6023l.a.ON_START);
        }

        @Override // android.app.Application.ActivityLifecycleCallbacks
        public void onActivityPreDestroyed(Activity activity) {
            Intrinsics.j(activity, "activity");
            ReportFragment.INSTANCE.a(activity, AbstractC6023l.a.ON_DESTROY);
        }

        @Override // android.app.Application.ActivityLifecycleCallbacks
        public void onActivityPrePaused(Activity activity) {
            Intrinsics.j(activity, "activity");
            ReportFragment.INSTANCE.a(activity, AbstractC6023l.a.ON_PAUSE);
        }

        @Override // android.app.Application.ActivityLifecycleCallbacks
        public void onActivityPreStopped(Activity activity) {
            Intrinsics.j(activity, "activity");
            ReportFragment.INSTANCE.a(activity, AbstractC6023l.a.ON_STOP);
        }
    }

    private final void a(AbstractC6023l.a event) {
        if (Build.VERSION.SDK_INT < 29) {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        a(AbstractC6023l.a.ON_CREATE);
    }

    @Override // android.app.Fragment
    public void onDestroy() {
        super.onDestroy();
        a(AbstractC6023l.a.ON_DESTROY);
    ...
    public void onStart() {
        ...
        a(AbstractC6023l.a.ON_START);
    }

    @Override // android.app.Fragment
    public void onStop() {
        super.onStop();
        a(AbstractC6023l.a.ON_STOP);
    }
}
