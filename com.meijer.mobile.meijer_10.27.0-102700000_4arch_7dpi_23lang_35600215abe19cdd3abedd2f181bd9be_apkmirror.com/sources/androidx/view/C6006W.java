...
public class C6006W {
    ...
    public static final class a implements Runnable {
        ...
        /* renamed from: b, reason: collision with root package name and from kotlin metadata */
        private final AbstractC6023l.a event;

        /* renamed from: c, reason: collision with root package name and from kotlin metadata */
        private boolean wasExecuted;

        public a(C6032u registry, AbstractC6023l.a event) {
    ...
    public C6006W(InterfaceC6030s provider) {
        Intrinsics.j(provider, "provider");
        this.registry = new C6032u(provider);
        this.handler = new Handler();
    }

    private final void f(AbstractC6023l.a event) {
    ...
    public void b() {
        f(AbstractC6023l.a.ON_START);
    }

    public void c() {
        f(AbstractC6023l.a.ON_CREATE);
    }

    public void d() {
        f(AbstractC6023l.a.ON_STOP);
        f(AbstractC6023l.a.ON_DESTROY);
    }
