...
public class f0 {
    ...
    @JvmField
    public static final CreationExtras.c<String> f55257c;
    ...
    public static class a extends d {
        ...
        private static a f55260g;

        /* renamed from: h, reason: collision with root package name */
        @JvmField
        public static final CreationExtras.c<Application> f55261h;
        ...
        public <T extends c0> T create(Class<T> modelClass, CreationExtras extras) {
            ...
            Application application = (Application) extras.a(f55261h);
            if (application != null) {
                return (T) e(modelClass, application);
            }
            if (C6011b.class.isAssignableFrom(modelClass)) {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ f0 c(Companion companion, h0 h0Var, c cVar, CreationExtras creationExtras, int i10, Object obj) {
            if ((i10 & 2) != 0) {
                cVar = j.f39101a.b(h0Var);
            }
            if ((i10 & 4) != 0) {
                creationExtras = j.f39101a.a(h0Var);
            }
    ...
    public interface c {
        ...
        /* renamed from: a, reason: collision with root package name and from kotlin metadata */
        public static final Companion INSTANCE = Companion.f55264a;

        default <T extends c0> T create(Class<T> modelClass) {
            Intrinsics.j(modelClass, "modelClass");
            return (T) j.f39101a.d();
        }
        ...
        public static final class Companion {
            ...
            static final /* synthetic */ Companion f55264a = new Companion();
    ...
    public static class d implements c {
        ...
        @JvmField
        public static final CreationExtras.c<String> f55267d = f0.f55257c;
        ...
        public <T extends c0> T create(Class<T> modelClass) {
            Intrinsics.j(modelClass, "modelClass");
            return (T) X2.d.f39096a.a(modelClass);
        }
    ...
    public /* synthetic */ f0(g0 g0Var, c cVar, CreationExtras creationExtras, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(g0Var, cVar, (i10 & 4) != 0 ? CreationExtras.b.f36770c : creationExtras);
    }
    ...
    public f0(h0 owner, c factory) {
        this(owner.getViewModelStore(), factory, j.f39101a.a(owner));
        Intrinsics.j(owner, "owner");
        Intrinsics.j(factory, "factory");
    }
}
