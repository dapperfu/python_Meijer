...
public final class C5992H implements InterfaceC6030s {

    /* renamed from: i, reason: collision with root package name and from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);

    /* renamed from: j, reason: collision with root package name */
    private static final C5992H f55153j = new C5992H();
    ...
    public static final class Companion {
        ...
        public final void b(Context context) {
            ...
            C5992H.f55153j.h(context);
        }

        @JvmStatic
        public final InterfaceC6030s a() {
            return C5992H.f55153j;
        }
    }
    ...
    public static final class c extends C6017h {
        ...
        public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
            ...
            if (Build.VERSION.SDK_INT < 29) {
                ReportFragment.INSTANCE.b(activity).e(C5992H.this.initializationListener);
            }
        }
        ...
        public void onActivityPreCreated(Activity activity, Bundle savedInstanceState) {
            Intrinsics.j(activity, "activity");
            a.a(activity, new a(C5992H.this));
        }
    ...
    @JvmStatic
    public static final InterfaceC6030s l() {
        return INSTANCE.a();
    }
    ...
    public final void e() {
        ...
        if (i10 == 1) {
            if (this.pauseSent) {
                this.registry.i(AbstractC6023l.a.ON_RESUME);
    ...
    public final void f() {
        ...
        if (i10 == 1 && this.stopSent) {
            this.registry.i(AbstractC6023l.a.ON_START);
            this.stopSent = false;
        }
    }
    ...
    public final void h(Context context) {
        ...
        this.registry.i(AbstractC6023l.a.ON_CREATE);
    ...
    public final void j() {
        if (this.resumedCounter == 0) {
            this.pauseSent = true;
            this.registry.i(AbstractC6023l.a.ON_PAUSE);
        }
    }

    public final void k() {
        if (this.startedCounter == 0 && this.pauseSent) {
            this.registry.i(AbstractC6023l.a.ON_STOP);
            this.stopSent = true;
        }
    }
    ...
    public static final void i(C5992H c5992h) {
        c5992h.j();
        c5992h.k();
    }
}
