...
public final class C5996L {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final C5996L a(Bundle restoredState, Bundle defaultState) {
            ...
            ClassLoader classLoader = C5996L.class.getClassLoader();
            Intrinsics.g(classLoader);
            restoredState.setClassLoader(classLoader);
            return new C5996L(C18017c.g(C18017c.a(restoredState)));
        }
    ...
    public static final class b<T> extends C5988D<T> {

        /* renamed from: l, reason: collision with root package name and from kotlin metadata */
        private String key;

        /* renamed from: m, reason: collision with root package name and from kotlin metadata */
        private C5996L handle;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public b(C5996L c5996l, String key, T t10) {
            super(t10);
        ...
        public void o(T value) {
            T2.b bVar;
            C5996L c5996l = this.handle;
            if (c5996l != null && (bVar = c5996l.impl) != null) {
                bVar.h(this.key, value);
            }
            super.o(value);
        }

        public b(C5996L c5996l, String key) {
            Intrinsics.j(key, "key");
            this.key = key;
            this.handle = c5996l;
        }
    ...
    public C5996L(Map<String, ? extends Object> initialState) {
        Intrinsics.j(initialState, "initialState");
        this.liveDatas = new LinkedHashMap();
        this.impl = new T2.b(initialState);
    }

    private final <T> C5988D<T> d(String key, boolean hasInitialValue, T initialValue) {
        b<?> bVar;
        if (this.impl.c().containsKey(key)) {
            throw new IllegalArgumentException(C6000P.b(key).toString());
        }
    ...
    public final <T> C5988D<T> c(String key, T initialValue) {
        Intrinsics.j(key, "key");
    ...
    public final <T> void f(String key, T value) {
        ...
        if (INSTANCE.b(value)) {
            ...
            b<?> bVar2 = bVar instanceof C5988D ? bVar : null;
            if (bVar2 != null) {
                bVar2.o(value);
            }
