...
public final class C6002S implements f.b {
    ...
    public C6002S(f savedStateRegistry, final h0 viewModelStoreOwner) {
        ...
        this.viewModel = LazyKt.b(new Function0() { // from class: androidx.lifecycle.Q
            ...
            public final Object invoke() {
                return C6002S.e(viewModelStoreOwner);
            }
        });
    }

    private final C6003T c() {
        return (C6003T) this.viewModel.getValue();
    }
    ...
    public final Bundle b(String key) {
        ...
        if (bundle == null || !C18017c.b(C18017c.a(bundle), key)) {
            return null;
        }
        Bundle bundleD = C18017c.d(C18017c.a(bundle), key);
        if (bundleD == null) {
            Map mapK = MapsKt.k();
            if (mapK.isEmpty()) {
                pairArr = new Pair[0];
            ...
            bundleD = C14835c.b((Pair[]) Arrays.copyOf(pairArr, pairArr.length));
            j.a(bundleD);
        }
        j.e(j.a(bundle), key);
    ...
    public final void d() {
        ...
        Bundle bundleA2 = j.a(bundleB);
        Bundle bundle = this.restoredState;
        if (bundle != null) {
            j.b(bundleA2, bundle);
        }
        if (bundleA != null) {
            j.b(bundleA2, bundleA);
        }
    ...
    public Bundle saveState() {
        ...
        for (Map.Entry<String, C5996L> entry2 : c().m().entrySet()) {
            String key = entry2.getKey();
            Bundle bundleSaveState = entry2.getValue().e().saveState();
            if (!C18017c.f(C18017c.a(bundleSaveState))) {
                j.c(bundleA, key, bundleSaveState);
            }
        }
        this.restored = false;
        return bundleB;
