...
public final class C6004U extends f0.e implements f0.c {
    ...
    public final <T extends c0> T b(String key, Class<T> modelClass) {
        ...
        boolean zIsAssignableFrom = C6011b.class.isAssignableFrom(modelClass);
        Constructor constructorC = (!zIsAssignableFrom || this.application == null) ? C6005V.c(modelClass, C6005V.f55223b) : C6005V.c(modelClass, C6005V.f55222a);
        ...
        if (!zIsAssignableFrom || (application = this.application) == null) {
            t10 = (T) C6005V.d(modelClass, constructorC, c5998nB.getHandle());
        } else {
            Intrinsics.g(application);
            t10 = (T) C6005V.d(modelClass, constructorC, application, c5998nB.getHandle());
        }
    ...
    public <T extends c0> T create(Class<T> modelClass, CreationExtras extras) {
        Intrinsics.j(modelClass, "modelClass");
        Intrinsics.j(extras, "extras");
        String str = (String) extras.a(f0.f55257c);
        if (str == null) {
            throw new IllegalStateException("VIEW_MODEL_KEY must always be provided by ViewModelProvider");
        }
        if (extras.a(C5999O.f55206a) == null || extras.a(C5999O.f55207b) == null) {
            if (this.lifecycle != null) {
                return (T) b(str, modelClass);
            }
            throw new IllegalStateException("SAVED_STATE_REGISTRY_OWNER_KEY andVIEW_MODEL_STORE_OWNER_KEY must be provided in the creation extras tosuccessfully create a ViewModel.");
        }
        Application application = (Application) extras.a(f0.a.f55261h);
        boolean zIsAssignableFrom = C6011b.class.isAssignableFrom(modelClass);
        Constructor constructorC = (!zIsAssignableFrom || application == null) ? C6005V.c(modelClass, C6005V.f55223b) : C6005V.c(modelClass, C6005V.f55222a);
        return constructorC == null ? (T) this.factory.create(modelClass, extras) : (!zIsAssignableFrom || application == null) ? (T) C6005V.d(modelClass, constructorC, C5999O.a(extras)) : (T) C6005V.d(modelClass, constructorC, application, C5999O.a(extras));
    }

    @SuppressLint({"LambdaLast"})
    public C6004U(Application application, i owner, Bundle bundle) {
        f0.a aVar;
