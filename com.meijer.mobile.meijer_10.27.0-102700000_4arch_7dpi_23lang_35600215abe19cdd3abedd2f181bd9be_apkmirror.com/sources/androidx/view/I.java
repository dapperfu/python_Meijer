...
public final class I {
    ...
    public static final class a extends F {
        ...
        final /* synthetic */ Function1<F, Unit> f45691a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        a(boolean z10, Function1<? super F, Unit> function1) {
            super(z10);
            this.f45691a = function1;
        }

        @Override // androidx.view.F
        public void handleOnBackPressed() {
            this.f45691a.invoke(this);
        }
    }

    public static final F a(G g10, InterfaceC6030s interfaceC6030s, boolean z10, Function1<? super F, Unit> onBackPressed) {
        Intrinsics.j(g10, "<this>");
        Intrinsics.j(onBackPressed, "onBackPressed");
        a aVar = new a(z10, onBackPressed);
        if (interfaceC6030s != null) {
            g10.i(interfaceC6030s, aVar);
            return aVar;
        }
        g10.h(aVar);
        return aVar;
    ...
    public static /* synthetic */ F b(G g10, InterfaceC6030s interfaceC6030s, boolean z10, Function1 function1, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            interfaceC6030s = null;
        }
        if ((i10 & 2) != 0) {
            z10 = true;
        }
        return a(g10, interfaceC6030s, z10, function1);
    }
}
