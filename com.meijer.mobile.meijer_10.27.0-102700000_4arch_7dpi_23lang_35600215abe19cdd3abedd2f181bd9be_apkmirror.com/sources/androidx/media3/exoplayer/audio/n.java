...
final class n extends androidx.media3.common.audio.b {
    ...
    private static final int f56000i = Float.floatToIntBits(Float.NaN);

    @Override // androidx.media3.common.audio.b
    public AudioProcessor.a h(AudioProcessor.a aVar) throws AudioProcessor.UnhandledAudioFormatException {
        int i10 = aVar.f55346c;
        if (P.B0(i10)) {
            return i10 != 4 ? new AudioProcessor.a(aVar.f55344a, aVar.f55345b, 4) : AudioProcessor.a.f55343e;
        }
