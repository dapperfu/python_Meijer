...
@Metadata(d1 = {"\u0000>\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0019\n\u0002\b\u0003\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0010\f\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0010\u0005\n\u0002\b\u0006\b\u0000\u0018\u00002\u00020\u0001B\u0017\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0006\u0010\u0007J#\u0010\f\u001a\u000e\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\u000b0\n2\u0006\u0010\t\u001a\u00020\bH\u0002¢\u0006\u0004\b\f\u0010\rJ\u0017\u0010\u000e\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\bH\u0002¢\u0006\u0004\b\u000e\u0010\u000fJ\u0017\u0010\u0013\u001a\u00020\u00122\u0006\u0010\u0011\u001a\u00020\u0010H\u0016¢\u0006\u0004\b\u0013\u0010\u0014J\u000f\u0010\u0015\u001a\u00020\u000bH\u0016¢\u0006\u0004\b\u0015\u0010\u0016J\u000f\u0010\u0018\u001a\u00020\u0017H\u0016¢\u0006\u0004\b\u0018\u0010\u0019J\u000f\u0010\u001a\u001a\u00020\u0017H\u0016¢\u0006\u0004\b\u001a\u0010\u0019J\u000f\u0010\u001b\u001a\u00020\bH\u0016¢\u0006\u0004\b\u001b\u0010\u001c¨\u0006\u001d"}, d2 = {"LJv/P;", "LJv/N;", "LJv/v;", "reader", "", "buffer", "<init>", "(LJv/v;[C)V", "", "position", "Lkotlin/Pair;", "", "W", "(I)Lkotlin/Pair;", "X", "(I)I", "", "expected", "", "l", "(C)V", "e", "()Z", "", "j", "()B", "G", "K", "()I", "kotlinx-serialization-json"}, k = 1, mv = {2, 0, 0}, xi = 48)
@SourceDebugExtension
/* loaded from: classes13.dex */
public final class P extends N {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public P(InterfaceC3938v reader, char[] buffer) {
        super(reader, buffer);
    ...
    private final Pair<Integer, Boolean> W(int position) {
        ...
        if (cCharAt != '*') {
            ...
            int I10 = i10;
            while (position != -1) {
                int iO0 = StringsKt.o0(getSource(), '\n', I10, false, 4, null);
                if (iO0 != -1) {
                    return TuplesKt.a(Integer.valueOf(iO0 + 1), Boolean.TRUE);
                }
        ...
        int iX = i10;
        while (position != -1) {
            int iP0 = StringsKt.p0(getSource(), "*/", iX, false, 4, null);
            if (iP0 != -1) {
                return TuplesKt.a(Integer.valueOf(iP0 + 2), Boolean.TRUE);
            }
    ...
    public byte G() {
        u();
        C3921d source = getSource();
        int iK = K();
        if (iK < source.length() && iK != -1) {
            this.currentPosition = iK;
            return C3919b.a(source.charAt(iK));
        }
        return (byte) 10;
    }
