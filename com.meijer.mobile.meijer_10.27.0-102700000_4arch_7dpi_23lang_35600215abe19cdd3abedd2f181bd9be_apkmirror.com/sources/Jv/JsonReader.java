...
public abstract class JsonReader {
    ...
    public final void A(String key) {
        ...
        w("Encountered an unknown key '" + key + '\'', StringsKt.w0(L(0, this.currentPosition), key, 0, false, 6, null), "Use 'ignoreUnknownKeys = true' in 'Json {}' builder to ignore unknown keys.");
        throw new KotlinNothingValueException();
    }
    ...
    protected final void Q(char expected) {
        ...
        z(this, C3919b.a(expected), false, 2, null);
        throw new KotlinNothingValueException();
    }
    ...
    */
    public final long m() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: Jv.JsonReader.m():long");
    }
    ...
    public final boolean O(boolean doConsume) {
        ...
        if (length > 4 && C3919b.a(D().charAt(I10 + 4)) == 0) {
            return false;
        }
        if (doConsume) {
    ...
    public final Void y(byte expectedToken, boolean wasConsumed) {
        int i10;
        String strValueOf;
        String strC = C3919b.c(expectedToken);
        if (wasConsumed) {
