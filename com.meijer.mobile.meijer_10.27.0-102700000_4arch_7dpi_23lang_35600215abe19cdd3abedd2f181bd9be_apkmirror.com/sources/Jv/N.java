...
public class N extends JsonReader {
    ...
    public N(InterfaceC3938v reader, char[] buffer) {
        Intrinsics.j(reader, "reader");
        Intrinsics.j(buffer, "buffer");
        this.reader = reader;
        this.buffer = buffer;
        this.threshold = 128;
        this.source = new C3921d(buffer);
        U(0);
    }
    ...
    public C3921d getSource() {
        return this.source;
    }

    public final void V() {
        C3925h.f16247c.c(this.buffer);
    }
    ...
    public byte j() {
        ...
        while (true) {
            ...
            if (I10 != -1) {
                int i11 = I10 + 1;
                byte bA = C3919b.a(source.charAt(I10));
                if (bA != 3) {
