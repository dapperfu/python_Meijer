...
public final class a {
    ...
    private static final double f10392a = Math.log(2.0d);

    /* renamed from: b, reason: collision with root package name */
    static final double[] f10393b = {1.0d, 2.0922789888E13d, 2.631308369336935E35d, 1.2413915592536073E61d, 1.2688693218588417E89d, 7.156945704626381E118d, 9.916779348709496E149d, 1.974506857221074E182d, 3.856204823625804E215d, 5.5502938327393044E249d, 4.7147236359920616E284d};
    ...
    static /* synthetic */ class C0146a {
        ...
        static {
            ...
            try {
                f10394a[RoundingMode.FLOOR.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f10394a[RoundingMode.CEILING.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f10394a[RoundingMode.DOWN.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f10394a[RoundingMode.UP.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f10394a[RoundingMode.HALF_EVEN.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f10394a[RoundingMode.HALF_UP.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f10394a[RoundingMode.HALF_DOWN.ordinal()] = 8;
    ...
    */
    public static int d(double r5, java.math.RoundingMode r7) {
        ...
        L6b:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: Fe.a.d(double, java.math.RoundingMode):int");
    }
    ...
    static double e(double d10, RoundingMode roundingMode) {
        int i10;
        if (b.b(d10)) {
            switch (C0146a.f10394a[roundingMode.ordinal()]) {
                case 1:
                    e.g(b(d10));
                    return d10;
                case 2:
