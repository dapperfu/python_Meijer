...
final class C14166m implements InterfaceC14155b<Float, C6330m> {
    ...
    public Object b(InterfaceC13787E interfaceC13787E, float f10, float f11, Function1<? super Float, Unit> function1, Continuation<? super C14154a<Float, C6330m>> continuation) {
        Object objH = C14162i.h(interfaceC13787E, Math.abs(f10) * Math.signum(f11), f10, C6329l.c(0.0f, f11, 0L, 0L, false, 28, null), this.animationSpec, function1, continuation);
        return objH == IntrinsicsKt.f() ? objH : (C14154a) objH;
    }

    public C14166m(InterfaceC6326i<Float> interfaceC6326i) {
