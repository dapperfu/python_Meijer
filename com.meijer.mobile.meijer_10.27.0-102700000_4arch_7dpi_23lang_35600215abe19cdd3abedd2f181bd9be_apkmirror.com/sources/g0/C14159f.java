...
public final class C14159f {
    public static final int a(H1.d dVar, float f10) {
        if (Math.abs(f10) < dVar.I1(C14162i.k())) {
            return C14157d.INSTANCE.a();
        }
        if (f10 > 0.0f) {
            return C14157d.INSTANCE.b();
        }
        return C14157d.INSTANCE.c();
    }

    public static final int b(n nVar) {
        long jA;
        if (nVar.getOrientation() == EnumC13827z.f130585a) {
