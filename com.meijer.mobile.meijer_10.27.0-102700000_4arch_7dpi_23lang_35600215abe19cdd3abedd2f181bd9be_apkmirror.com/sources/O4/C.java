...
final class C<T> implements Runnable {
    ...
    public C(com.google.common.util.concurrent.q<T> futureToObserve, InterfaceC16654n<? super T> continuation) {
    ...
    public void run() {
        ...
        try {
            ...
            interfaceC16654n.resumeWith(Result.b(X.e(this.futureToObserve)));
        } catch (ExecutionException e10) {
            InterfaceC16654n<T> interfaceC16654n2 = this.continuation;
            Result.Companion companion2 = Result.INSTANCE;
            interfaceC16654n2.resumeWith(Result.b(ResultKt.a(X.f(e10))));
        }
    }
}
