...
public final class b implements Rs.a {
    ...
    static final class a extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Boolean>, Object> {
        ...
        final /* synthetic */ C6283a f60751b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ b f60752c;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(C6283a c6283a, b bVar, Continuation<? super a> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new a(this.f60751b, this.f60752c, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) throws InvalidKeySpecException, NoSuchAlgorithmException, SignatureException, InvalidKeyException {
            ...
            if (this.f60750a == 0) {
                ResultKt.b(obj);
                List<C6283a.C1194a> listA = this.f60751b.a();
                b bVar = this.f60752c;
                Iterator<T> it = listA.iterator();
                while (true) {
                    if (it.hasNext()) {
                        next = it.next();
                        if (Intrinsics.e(((C6283a.C1194a) next).getKeyId(), bVar.getKeyId())) {
                            break;
                        }
                    } else {
                        next = null;
                ...
                C6283a.C1194a c1194a = (C6283a.C1194a) next;
                if (c1194a == null) {
                    return Boxing.a(false);
                }
                if (!Intrinsics.e(c1194a.getUse(), "sig")) {
                    return Boxing.a(false);
                }
                if (!Intrinsics.e(c1194a.getKeyType(), "RSA")) {
                    return Boxing.a(false);
                }
                if (!Intrinsics.e(c1194a.getAlgorithm(), "RS256")) {
                    return Boxing.a(false);
                }
                String modulus = c1194a.getModulus();
                if (modulus != null && (c15331hA = (companion = C15331h.INSTANCE).a(modulus)) != null && (bArrB0 = c15331hA.b0()) != null) {
                    BigInteger bigInteger = new BigInteger(1, bArrB0);
                    String exponent = c1194a.getExponent();
                    if (exponent != null && (c15331hA2 = companion.a(exponent)) != null && (bArrB02 = c15331hA2.b0()) != null) {
                        BigInteger bigInteger2 = new BigInteger(1, bArrB02);
                        byte[] bytes = StringsKt.v1(this.f60752c.getRawValue(), '.', null, 2, null).getBytes(Charsets.UTF_8);
                        ...
                        try {
                            ...
                            C15331h c15331hA3 = companion.a(this.f60752c.getSignature());
                            if (c15331hA3 != null && (bArrB03 = c15331hA3.b0()) != null) {
    ...
    @Override // Rs.a
    public <T> T a(Dv.a<? extends T> deserializationStrategy) {
        Intrinsics.j(deserializationStrategy, "deserializationStrategy");
        return (T) this.f60744a.a(deserializationStrategy);
    }
    ...
    public final Object f(C6283a c6283a, Continuation<? super Boolean> continuation) {
        return C16644i.g(this.computeDispatcher, new a(c6283a, this, null), continuation);
    }
