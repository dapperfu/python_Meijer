...
@Metadata(d1 = {"\u0000T\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0007\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010!\n\u0002\b\u0007\b\u0002\u0018\u00002\u00020\u0001B\u001d\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\u0004\b\u0007\u0010\bJ\u001f\u0010\u000e\u001a\u00020\r2\u0006\u0010\n\u001a\u00020\t2\u0006\u0010\f\u001a\u00020\u000bH\u0000¢\u0006\u0004\b\u000e\u0010\u000fJ$\u0010\u0015\u001a\u00020\r*\u00020\u00102\u0006\u0010\u0012\u001a\u00020\u00112\u0006\u0010\u0014\u001a\u00020\u0013ø\u0001\u0000¢\u0006\u0004\b\u0015\u0010\u0016R\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0017\u0010\u0018R\u001a\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0015\u0010\u0019R \u0010\u001d\u001a\u000e\u0012\u0004\u0012\u00020\u0011\u0012\u0004\u0012\u00020\u001b0\u001a8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u000e\u0010\u001cR\u001a\u0010!\u001a\b\u0012\u0004\u0012\u00020\t0\u001e8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001f\u0010 R\u0018\u0010$\u001a\u0004\u0018\u00010\t8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\"\u0010#\u0082\u0002\u0007\n\u0005\b¡\u001e0\u0001¨\u0006%"}, d2 = {"LB0/i;", "", "", "bounded", "Lkotlin/Function0;", "LB0/b;", "rippleAlpha", "<init>", "(ZLkotlin/jvm/functions/Function0;)V", "Lh0/i;", "interaction", "Lqv/O;", "scope", "", "c", "(Lh0/i;Lqv/O;)V", "LX0/f;", "", "radius", "LV0/q0;", "color", "b", "(LX0/f;FJ)V", "a", "Z", "Lkotlin/jvm/functions/Function0;", "Lc0/a;", "Lc0/m;", "Lc0/a;", "animatedAlpha", "", "d", "Ljava/util/List;", "interactions", "e", "Lh0/i;", "currentInteraction", "material-ripple_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
final class i {
    ...
    private final C6313a<Float, C6330m> animatedAlpha = C6315b.b(0.0f, 0.0f, 2, null);
    ...
    static final class a extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        final /* synthetic */ float f1701c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ InterfaceC6326i<Float> f1702d;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(float f10, InterfaceC6326i<Float> interfaceC6326i, Continuation<? super a> continuation) {
            super(2, continuation);
            this.f1701c = f10;
            this.f1702d = interfaceC6326i;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return i.this.new a(this.f1701c, this.f1702d, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                ResultKt.b(obj);
                C6313a c6313a = i.this.animatedAlpha;
                Float fC = Boxing.c(this.f1701c);
                InterfaceC6326i<Float> interfaceC6326i = this.f1702d;
                this.f1699a = 1;
    ...
    static final class b extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ InterfaceC6326i<Float> f1705c;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(InterfaceC6326i<Float> interfaceC6326i, Continuation<? super b> continuation) {
            super(2, continuation);
            this.f1705c = interfaceC6326i;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return i.this.new b(this.f1705c, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                InterfaceC6326i<Float> interfaceC6326i = this.f1705c;
                this.f1703a = 1;
                if (C6313a.f(c6313a, fC, interfaceC6326i, null, null, this, 12, null) == objF) {
                    return objF;
                }
    ...
    public final void b(X0.f fVar, float f10, long j10) throws Throwable {
        ...
        long jQ = C5346q0.q(j10, fFloatValue, 0.0f, 0.0f, 0.0f, 14, null);
        if (!this.bounded) {
    ...
    public final void c(h0.i interaction, InterfaceC16622O scope) {
        ...
        } else if (interaction instanceof C14322b) {
            this.interactions.add(interaction);
        } else if (interaction instanceof C14323c) {
            this.interactions.remove(((C14323c) interaction).getStart());
        } else if (!(interaction instanceof C14321a)) {
            return;
        } else {
            this.interactions.remove(((C14321a) interaction).getStart());
        }
        ...
        if (iVar != null) {
            ...
            C16648k.d(scope, null, null, new a(z10 ? rippleAlphaInvoke.getHoveredAlpha() : interaction instanceof h0.d ? rippleAlphaInvoke.getFocusedAlpha() : interaction instanceof C14322b ? rippleAlphaInvoke.getDraggedAlpha() : 0.0f, f.d(iVar), null), 3, null);
        } else {
            C16648k.d(scope, null, null, new b(f.e(this.currentInteraction), null), 3, null);
        }
