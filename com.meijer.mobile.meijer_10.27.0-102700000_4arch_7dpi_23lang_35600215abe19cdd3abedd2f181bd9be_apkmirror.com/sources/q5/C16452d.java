...
public final class C16452d {
    public static final AbstractC6023l c(Context context) {
        Object baseContext = context;
        while (!(baseContext instanceof InterfaceC6030s)) {
            if (!(baseContext instanceof ContextWrapper)) {
                return null;
            }
            baseContext = ((ContextWrapper) baseContext).getBaseContext();
        }
        return ((InterfaceC6030s) baseContext).getLifecycle();
    }
    ...
    public static final Drawable b(Resources resources, int i10, Resources.Theme theme) throws Resources.NotFoundException {
        Drawable drawableF = C6187h.f(resources, i10, theme);
        if (drawableF != null) {
            return drawableF;
        }
        throw new IllegalStateException(("Invalid resource ID: " + i10).toString());
