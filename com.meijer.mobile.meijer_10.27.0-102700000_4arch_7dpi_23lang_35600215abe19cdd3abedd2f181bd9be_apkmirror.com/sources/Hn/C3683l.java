...
@Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0006\u001a/\u0010\b\u001a\u00020\u0007*\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00012\u0006\u0010\u0004\u001a\u00020\u00032\b\b\u0002\u0010\u0006\u001a\u00020\u0005H\u0001¢\u0006\u0004\b\b\u0010\t\u001a%\u0010\n\u001a\u00020\u0007*\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00012\u0006\u0010\u0004\u001a\u00020\u0003H\u0001¢\u0006\u0004\b\n\u0010\u000b\u001a%\u0010\f\u001a\u00020\u0007*\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00012\u0006\u0010\u0004\u001a\u00020\u0003H\u0001¢\u0006\u0004\b\f\u0010\u000b¨\u0006\r²\u0006\u000e\u0010\u0006\u001a\u00020\u00058\n@\nX\u008a\u008e\u0002"}, d2 = {"LJi/M;", "Landroidx/compose/ui/Modifier;", "modifier", "LIn/j;", "pharmacyGasStationHours", "", "isNewAddressQualifierEnabled", "", "h", "(LJi/M;Landroidx/compose/ui/Modifier;LIn/j;ZLandroidx/compose/runtime/Composer;II)V", "f", "(LJi/M;Landroidx/compose/ui/Modifier;LIn/j;Landroidx/compose/runtime/Composer;II)V", "d", "Meijer_playstoreRelease"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class C3683l {
    ...
    static final class a implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ StoreHoursPresenter f13011a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f13012b;

        a(StoreHoursPresenter storeHoursPresenter, LocalThemeScope localThemeScope) {
            this.f13011a = storeHoursPresenter;
            this.f13012b = localThemeScope;
        }
        ...
        public final void a(Composer composer, int i10) {
            ...
            List<DailySchedule> listA = this.f13011a.a();
            LocalThemeScope localThemeScope = this.f13012b;
            for (DailySchedule dailySchedule : listA) {
                ...
                AbstractC5607a weekdays = dailySchedule.getWeekdays();
                int i11 = AbstractC5607a.f45514b;
                String strA = C6408b.a(weekdays, composer2, i11);
                int i12 = LocalThemeScope.f15770g;
                int i13 = q1.Label.f140080j;
                ri.j.h(localThemeScope, label, strA, null, composer2, i12 | (i13 << 3), 4);
                C14802K.a(androidx.compose.foundation.layout.J.z(Modifier.INSTANCE, H1.h.p(10)), composer2, 6);
                ri.j.h(localThemeScope, new q1.Label(null, localThemeScope.getAdsColors().getAdsColorText02(), null, null, 0, false, 0, localThemeScope.getAdsTypography().getBody().getOne(), null, 381, null), C6408b.a(dailySchedule.getTimes(), composer2, i11), null, composer2, i12 | (i13 << 3), 4);
                composer2 = composer;
            }
            if (ComposerKt.M()) {
                ComposerKt.T();
        ...
        if (t0L != null) {
            t0L.a(new Function2() { // from class: Hn.j
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return C3683l.e(localThemeScope, modifier2, pharmacyGasStationHours, i10, i11, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    */
    public static final void f(final Ji.LocalThemeScope r35, androidx.compose.ui.Modifier r36, final In.StoreHoursPresenter r37, androidx.compose.runtime.Composer r38, final int r39, final int r40) {
        /*
            Method dump skipped, instructions count: 621
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: Hn.C3683l.f(Ji.M, androidx.compose.ui.Modifier, In.j, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void h(final LocalThemeScope localThemeScope, Modifier modifier, final StoreHoursPresenter pharmacyGasStationHours, boolean z10, Composer composer, final int i10, final int i11) {
        ...
        if ((i12 & 1171) == 1170 && composerStartRestartGroup.j()) {
            ...
            if (z10) {
                ...
                f(localThemeScope, modifier3, pharmacyGasStationHours, composerStartRestartGroup, LocalThemeScope.f15770g | (i12 & 14) | (i12 & 112) | (i12 & 896), 0);
                composerStartRestartGroup.P();
            } else {
                composerStartRestartGroup.startReplaceGroup(-498644510);
                d(localThemeScope, modifier3, pharmacyGasStationHours, composerStartRestartGroup, LocalThemeScope.f15770g | (i12 & 14) | (i12 & 112) | (i12 & 896), 0);
                composerStartRestartGroup.P();
            }
            if (ComposerKt.M()) {
                ComposerKt.T();
        ...
        T0 t0L = composerStartRestartGroup.l();
        if (t0L != null) {
            t0L.a(new Function2() { // from class: Hn.i
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return C3683l.i(localThemeScope, modifier2, pharmacyGasStationHours, z11, i10, i11, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
