...
public class f {
    ...
    public String e(final String path, int retryCount) throws InterruptedException {
        ...
        if (URLUtil.isHttpsUrl(path)) {
            l.f11293a.a(retryCount, 3000L, new Function0() { // from class: G9.e
