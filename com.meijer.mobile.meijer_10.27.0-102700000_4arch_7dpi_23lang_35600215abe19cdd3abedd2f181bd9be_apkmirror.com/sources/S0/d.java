...
public final class d extends Modifier.c implements B0, InterfaceC5814j, f, C {

    /* renamed from: u, reason: collision with root package name */
    private static final a f33114u = new a(null);

    /* renamed from: v, reason: collision with root package name */
    public static final int f33115v = 8;
    ...
    private static final class a {
        ...
        private static final class C0739a {
            ...
            public static final C0739a f33122a = new C0739a();
    ...
    static final class b extends Lambda implements Function1<d, A0> {
        ...
        final /* synthetic */ S0.b f33123f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ d f33124g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Ref.BooleanRef f33125h;
        ...
        public final A0 invoke(d dVar) {
            ...
            if (!z10) {
                C14832a.b("DragAndDropTarget self reference must be null at the start of a drag and drop session");
            }
            Function1 function1 = dVar.onDropTargetValidate;
            if (function1 != null) {
                fVar = (f) function1.invoke(this.f33123f);
            } else {
                fVar = null;
            }
            ...
            if (z11) {
                this.f33124g.Q2().a(dVar);
            }
            Ref.BooleanRef booleanRef = this.f33125h;
            if (booleanRef.f142828a || z11) {
                z12 = true;
            }
            booleanRef.f142828a = z12;
            return A0.f51160a;
        }
    }
    ...
    public static final class C0740d extends Lambda implements Function1<d, A0> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Ref.ObjectRef f33127f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ d f33128g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ S0.b f33129h;
        ...
        public final A0 invoke(d dVar) {
            d dVar2 = dVar;
            if (!this.f33128g.Q2().b(dVar2) || !e.d(dVar2, h.a(this.f33129h))) {
                return A0.f51160a;
            }
            this.f33127f.f142835a = dVar;
            return A0.f51162c;
        }

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C0740d(Ref.ObjectRef objectRef, d dVar, S0.b bVar) {
            super(1);
            this.f33127f = objectRef;
            this.f33128g = dVar;
            this.f33129h = bVar;
        }
    }
    ...
    public void r0(S0.b event) {
        ...
        if (dVar2 == null || !e.d(dVar2, h.a(event))) {
            if (getNode().getIsAttached()) {
                ...
                C0.f(this, new C0740d(objectRef, this, event));
                b02 = (B0) objectRef.f142835a;
            } else {
                b02 = null;
            }
            dVar = (d) b02;
    ...
    public d(Function2<Object, ? super U0.f, Unit> function2, Function1<? super S0.b, ? extends f> function1) {
        ...
        this.traverseKey = a.C0739a.f33122a;
        this.size = r.INSTANCE.a();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final S0.c Q2() {
        return C5815k.p(this).getDragAndDropManager();
    }
}
