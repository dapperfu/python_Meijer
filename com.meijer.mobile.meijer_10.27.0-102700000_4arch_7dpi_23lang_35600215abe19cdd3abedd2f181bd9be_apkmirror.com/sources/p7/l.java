...
public final class l {
    ...
    private static final char[] f155670a = "0123456789abcdef".toCharArray();

    /* renamed from: b, reason: collision with root package name */
    private static final char[] f155671b = new char[64];

    /* renamed from: c, reason: collision with root package name */
    private static volatile Handler f155672c;
    ...
    static /* synthetic */ class a {
        ...
        /* renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f155673a;
        ...
        static {
            ...
            try {
                f155673a[Bitmap.Config.RGB_565.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f155673a[Bitmap.Config.ARGB_4444.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f155673a[Bitmap.Config.RGBA_F16.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f155673a[Bitmap.Config.ARGB_8888.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
        }
    }

    public static boolean b(AbstractC15566a<?> abstractC15566a, AbstractC15566a<?> abstractC15566a2) {
        return abstractC15566a == null ? abstractC15566a2 == null : abstractC15566a.F(abstractC15566a2);
    }
    ...
    public static int i(Bitmap.Config config) {
        ...
        int i10 = a.f155673a[config.ordinal()];
        int i11 = 1;
        if (i10 != 1) {
            i11 = 2;
            if (i10 != 2 && i10 != 3) {
    ...
    private static Handler k() {
        if (f155672c == null) {
            synchronized (l.class) {
                try {
                    if (f155672c == null) {
                        f155672c = new Handler(Looper.getMainLooper());
                    }
                } finally {
                }
            }
