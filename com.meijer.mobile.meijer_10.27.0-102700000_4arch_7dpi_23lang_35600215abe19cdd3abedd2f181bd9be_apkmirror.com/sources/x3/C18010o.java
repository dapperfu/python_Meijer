...
public final class C18010o {

    /* renamed from: a, reason: collision with root package name */
    private static final int[] f169238a = {1, 2, 2, 2, 2, 3, 3, 4, 4, 5, 6, 6, 6, 7, 8, 8};

    /* renamed from: b, reason: collision with root package name */
    private static final int[] f169239b = {-1, 8000, 16000, 32000, -1, -1, 11025, 22050, 44100, -1, -1, 12000, 24000, 48000, -1, -1};

    /* renamed from: c, reason: collision with root package name */
    private static final int[] f169240c = {64, 112, 128, 192, 224, 256, 384, 448, 512, 640, 768, 896, 1024, 1152, 1280, 1536, 1920, RecyclerView.m.FLAG_MOVED, 2304, 2560, 2688, 2816, 2823, 2944, 3072, 3840, RecyclerView.m.FLAG_APPEARED_IN_PRE_LAYOUT, 6144, 7680};

    /* renamed from: d, reason: collision with root package name */
    private static final int[] f169241d = {8000, 16000, 32000, 64000, 128000, 22050, 44100, 88200, 176400, 352800, 12000, 24000, 48000, 96000, 192000, 384000};

    /* renamed from: e, reason: collision with root package name */
    private static final int[] f169242e = {5, 8, 10, 12};

    /* renamed from: f, reason: collision with root package name */
    private static final int[] f169243f = {6, 9, 12, 15};

    /* renamed from: g, reason: collision with root package name */
    private static final int[] f169244g = {2, 4, 6, 8};

    /* renamed from: h, reason: collision with root package name */
    private static final int[] f169245h = {9, 11, 13, 16};

    /* renamed from: i, reason: collision with root package name */
    private static final int[] f169246i = {5, 8, 10, 12};

    /* renamed from: x3.o$b */
    public static final class b {

        /* renamed from: a, reason: collision with root package name */
        public final String f169247a;

        /* renamed from: b, reason: collision with root package name */
        public final int f169248b;

        /* renamed from: c, reason: collision with root package name */
        public final int f169249c;

        /* renamed from: d, reason: collision with root package name */
        public final int f169250d;

        /* renamed from: e, reason: collision with root package name */
        public final long f169251e;

        /* renamed from: f, reason: collision with root package name */
        public final int f169252f;
    ...
    */
    public static int b(byte[] r7) {
        ...
        L64:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: x3.C18010o.b(byte[]):int");
    }
    ...
    public static a3.t h(byte[] bArr, String str, String str2, int i10, String str3, a3.o oVar) {
        ...
        d3.C cD = d(bArr);
        cD.r(60);
        int i13 = f169238a[cD.h(6)];
        int i14 = f169239b[cD.h(4)];
        int iH = cD.h(5);
        int[] iArr = f169240c;
        if (iH >= iArr.length) {
            i11 = -1;
    ...
    public static b k(byte[] bArr, AtomicInteger atomicInteger) throws ParserException {
        ...
        for (int i14 = 0; i14 < i10; i14++) {
            iM3 += m(cD, f169243f, true);
        }
        if (i10 != 0) {
            atomicInteger2 = atomicInteger;
            atomicInteger2.set(m(cD, f169244g, true));
        } else {
            atomicInteger2 = atomicInteger;
        }
        if (atomicInteger2.get() != 0) {
            iM = m(cD, f169245h, true);
        }
