...
public final class v {
    ...
    public static final class a {
        ...
        public long f169255a;
    }

    private static boolean f(int i10, y yVar) {
        return i10 == 0 || i10 == yVar.f169267i;
    }

    private static boolean g(int i10, y yVar) {
        return i10 <= 7 ? i10 == yVar.f169265g - 1 : i10 <= 10 && yVar.f169265g == 2;
    }
    ...
    private static boolean e(d3.D d10, y yVar, int i10) {
        int i11 = yVar.f169263e;
        if (i10 == 0) {
            return true;
        }
        if (i10 <= 11) {
            return i10 == yVar.f169264f;
        }
        if (i10 == 12) {
    ...
    public static boolean h(InterfaceC18012q interfaceC18012q, y yVar, int i10, a aVar) throws IOException {
        long jG = interfaceC18012q.g();
        byte[] bArr = new byte[2];
        interfaceC18012q.m(bArr, 0, 2);
        if ((((bArr[0] & 255) << 8) | (bArr[1] & 255)) != i10) {
            interfaceC18012q.d();
            interfaceC18012q.i((int) (jG - interfaceC18012q.getPosition()));
            return false;
        }
        d3.D d10 = new d3.D(16);
        System.arraycopy(bArr, 0, d10.e(), 0, 2);
        d10.V(C18013s.c(interfaceC18012q, d10.e(), 2, 14));
        interfaceC18012q.d();
        interfaceC18012q.i((int) (jG - interfaceC18012q.getPosition()));
        return d(d10, yVar, i10, aVar);
    }

    public static long i(InterfaceC18012q interfaceC18012q, y yVar) throws IOException {
        int i10;
        interfaceC18012q.d();
        boolean z10 = true;
        interfaceC18012q.i(1);
        byte[] bArr = new byte[1];
        interfaceC18012q.m(bArr, 0, 1);
        if ((bArr[0] & 1) != 1) {
            z10 = false;
        }
        ...
        d10.V(C18013s.c(interfaceC18012q, d10.e(), 0, i10));
        interfaceC18012q.d();
        a aVar = new a();
        if (c(d10, yVar, z10, aVar)) {
            return aVar.f169255a;
        }
