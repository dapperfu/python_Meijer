...
public final class C17998c {

    /* renamed from: a, reason: collision with root package name */
    private static final int[] f169144a = {2002, 2000, 1920, 1601, 1600, 1001, 1000, 960, 800, 800, 480, HttpResponseStatus.ERROR_BAD_REQUEST, HttpResponseStatus.ERROR_BAD_REQUEST, RecyclerView.m.FLAG_MOVED};

    /* renamed from: x3.c$b */
    private static final class b {

        /* renamed from: a, reason: collision with root package name */
        public boolean f169145a;
    ...
    public static final class C2708c {
        ...
        /* renamed from: a, reason: collision with root package name */
        public final int f169151a;

        /* renamed from: b, reason: collision with root package name */
        public final int f169152b;

        /* renamed from: c, reason: collision with root package name */
        public final int f169153c;

        /* renamed from: d, reason: collision with root package name */
        public final int f169154d;

        /* renamed from: e, reason: collision with root package name */
        public final int f169155e;

        private C2708c(int i10, int i11, int i12, int i13, int i14) {
            this.f169151a = i10;
            this.f169153c = i11;
            this.f169152b = i12;
            this.f169154d = i13;
    ...
    public static void a(int i10, d3.D d10) {
        ...
        bArrE[2] = -1;
        bArrE[3] = -1;
        bArrE[4] = (byte) ((i10 >> 16) & l3.f92484c);
        bArrE[5] = (byte) ((i10 >> 8) & l3.f92484c);
        bArrE[6] = (byte) (i10 & l3.f92484c);
    }
    ...
    private static void h(d3.C c10, b bVar) throws ParserException {
        ...
        if (c10.g()) {
            int iH2 = c10.h(3);
            if (bVar.f169146b == -1 && iH >= 0 && iH <= 15 && (iH2 == 0 || iH2 == 1)) {
                bVar.f169146b = iH;
            }
            if (c10.g()) {
                l(c10);
    ...
    */
    public static a3.t d(d3.D r19, java.lang.String r20, java.lang.String r21, a3.o r22) throws androidx.media3.common.ParserException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: x3.C17998c.d(d3.D, java.lang.String, java.lang.String, a3.o):a3.t");
    }
    ...
    public static int e(ByteBuffer byteBuffer) {
        ...
        return f(new d3.C(bArr)).f169155e;
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static x3.C17998c.C2708c f(d3.C r11) {
        /*
            r0 = 16
            int r1 = r11.h(r0)
            int r0 = r11.h(r0)
        ...
        L95:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: x3.C17998c.f(d3.C):x3.c$c");
    }
