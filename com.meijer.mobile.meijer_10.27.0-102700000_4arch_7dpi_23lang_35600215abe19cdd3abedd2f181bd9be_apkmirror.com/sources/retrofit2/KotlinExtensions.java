...
public final class KotlinExtensions {
    ...
    public static final <T> Object await(final Call<T> call, Continuation<? super T> continuation) {
        final C16658p c16658p = new C16658p(IntrinsicsKt.c(continuation), 1);
        c16658p.C();
        c16658p.F(new Function1<Throwable, Unit>() { // from class: retrofit2.KotlinExtensions$await$2$1
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$await$2$2
            ...
            public void onFailure(Call<T> call2, Throwable t10) {
                ...
                Intrinsics.j(t10, "t");
                InterfaceC16654n<T> interfaceC16654n = c16658p;
                Result.Companion companion = Result.INSTANCE;
                interfaceC16654n.resumeWith(Result.b(ResultKt.a(t10)));
            }
            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                ...
                if (!response.isSuccessful()) {
                    InterfaceC16654n<T> interfaceC16654n = c16658p;
                    Result.Companion companion = Result.INSTANCE;
                    interfaceC16654n.resumeWith(Result.b(ResultKt.a(new HttpException(response))));
                    return;
                }
                T tBody = response.body();
                if (tBody != null) {
                    c16658p.resumeWith(Result.b(tBody));
                    return;
                }
                ...
                InterfaceC16654n<T> interfaceC16654n2 = c16658p;
                Result.Companion companion2 = Result.INSTANCE;
                interfaceC16654n2.resumeWith(Result.b(ResultKt.a(kotlinNullPointerException)));
            }
        });
    ...
    public static final <T> Object awaitNullable(final Call<T> call, Continuation<? super T> continuation) {
        final C16658p c16658p = new C16658p(IntrinsicsKt.c(continuation), 1);
        c16658p.C();
        c16658p.F(new Function1<Throwable, Unit>() { // from class: retrofit2.KotlinExtensions$await$4$1
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(Throwable th2) {
                invoke2(th2);
                return Unit.f142422a;
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$await$4$2
            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                ...
                if (response.isSuccessful()) {
                    InterfaceC16654n<T> interfaceC16654n = c16658p;
                    Result.Companion companion = Result.INSTANCE;
                    interfaceC16654n.resumeWith(Result.b(response.body()));
                } else {
                    InterfaceC16654n<T> interfaceC16654n2 = c16658p;
                    Result.Companion companion2 = Result.INSTANCE;
                    interfaceC16654n2.resumeWith(Result.b(ResultKt.a(new HttpException(response))));
                }
            }
        });
        Object objV = c16658p.v();
    ...
    public static final <T> Object awaitResponse(final Call<T> call, Continuation<? super Response<T>> continuation) {
        final C16658p c16658p = new C16658p(IntrinsicsKt.c(continuation), 1);
        c16658p.C();
        c16658p.F(new Function1<Throwable, Unit>() { // from class: retrofit2.KotlinExtensions$awaitResponse$2$1
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(Throwable th2) {
                invoke2(th2);
                return Unit.f142422a;
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$awaitResponse$2$2
            ...
            public void onFailure(Call<T> call2, Throwable t10) {
                Intrinsics.j(call2, "call");
                Intrinsics.j(t10, "t");
                InterfaceC16654n<Response<T>> interfaceC16654n = c16658p;
                Result.Companion companion = Result.INSTANCE;
                interfaceC16654n.resumeWith(Result.b(ResultKt.a(t10)));
            }
            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                Intrinsics.j(call2, "call");
                Intrinsics.j(response, "response");
                c16658p.resumeWith(Result.b(response));
            }
        });
        Object objV = c16658p.v();
        if (objV == IntrinsicsKt.f()) {
