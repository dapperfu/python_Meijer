...
final class RequestBuilder {
    ...
    private static class ContentTypeOverridingRequestBody extends RequestBody {
        ...
        public void writeTo(InterfaceC15329f interfaceC15329f) throws IOException {
            this.delegate.writeTo(interfaceC15329f);
        }
    ...
    private static String canonicalizeForPath(String str, boolean z10) throws EOFException {
        ...
        while (iCharCount < length) {
            ...
            if (iCodePointAt < 32 || iCodePointAt >= 127 || PATH_SEGMENT_ALWAYS_ENCODE_SET.indexOf(iCodePointAt) != -1 || (!z10 && (iCodePointAt == 47 || iCodePointAt == 37))) {
                ...
                c15328e.Q0(str, 0, iCharCount);
                canonicalizeForPath(c15328e, str, iCharCount, length, z10);
                return c15328e.n3();
            }
    ...
    private static void canonicalizeForPath(C15328e c15328e, String str, int i10, int i11, boolean z10) throws EOFException {
        ...
        while (i10 < i11) {
            ...
            if (!z10 || (iCodePointAt != 9 && iCodePointAt != 10 && iCodePointAt != 12 && iCodePointAt != 13)) {
                if (iCodePointAt >= 32 && iCodePointAt < 127 && PATH_SEGMENT_ALWAYS_ENCODE_SET.indexOf(iCodePointAt) == -1 && (z10 || (iCodePointAt != 47 && iCodePointAt != 37))) {
                    ...
                    long size = c15328e2.getSize();
                    for (long j10 = 0; j10 < size; j10++) {
                        byte bL = c15328e2.l(j10);
                        c15328e.writeByte(37);
                        char[] cArr = HEX_DIGITS;
                        c15328e.writeByte(cArr[((bL & 255) >> 4) & 15]);
                        c15328e.writeByte(cArr[bL & C14045dq.MULTIPLY]);
                    }
                    c15328e2.a();
                }
            }
