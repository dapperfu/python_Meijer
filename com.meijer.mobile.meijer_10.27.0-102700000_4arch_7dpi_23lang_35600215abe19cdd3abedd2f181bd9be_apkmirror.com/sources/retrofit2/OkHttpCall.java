...
final class OkHttpCall<T> implements Call<T> {
    ...
    static final class ExceptionCatchingResponseBody extends ResponseBody {
        ...
        private final InterfaceC15330g delegateSource;
        ...
        ExceptionCatchingResponseBody(ResponseBody responseBody) {
            ...
            this.delegateSource = w.d(new o(responseBody.getSource()) { // from class: retrofit2.OkHttpCall.ExceptionCatchingResponseBody.1
                @Override // kw.o, kw.J
                public long read(C15328e c15328e, long j10) throws IOException {
                    try {
                        return super.read(c15328e, j10);
    ...
    public void enqueue(final Callback<T> callback) {
        ...
        FirebasePerfOkHttpClient.enqueue(dVar, new Qv.b() { // from class: retrofit2.OkHttpCall.1
