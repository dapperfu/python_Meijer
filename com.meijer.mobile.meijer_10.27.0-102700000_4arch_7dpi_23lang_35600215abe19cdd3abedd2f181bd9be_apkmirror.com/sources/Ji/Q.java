...
@Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\u001aJ\u0010\b\u001a\u00020\u0005\"\b\b\u0000\u0010\u0001*\u00020\u0000*\u00020\u00022\u0012\u0010\u0004\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00028\u00000\u00032\u0017\u0010\u0007\u001a\u0013\u0012\u0004\u0012\u00028\u0000\u0012\u0004\u0012\u00020\u00050\u0003¢\u0006\u0002\b\u0006H\u0007¢\u0006\u0004\b\b\u0010\t\u001aD\u0010\u000b\u001a\u00020\u0005\"\b\b\u0000\u0010\u0001*\u00020\u0000*\u00020\u00022\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00028\u00000\n2\u0017\u0010\u0007\u001a\u0013\u0012\u0004\u0012\u00028\u0000\u0012\u0004\u0012\u00020\u00050\u0003¢\u0006\u0002\b\u0006H\u0007¢\u0006\u0004\b\u000b\u0010\f\u001aH\u0010\r\u001a\u00020\u0005\"\u0012\b\u0000\u0010\u0001*\u00020\u0000*\b\u0012\u0004\u0012\u00028\u00000\n*\u00020\u00022\u0006\u0010\u0004\u001a\u00028\u00002\u0017\u0010\u0007\u001a\u0013\u0012\u0004\u0012\u00028\u0000\u0012\u0004\u0012\u00020\u00050\u0003¢\u0006\u0002\b\u0006H\u0007¢\u0006\u0004\b\r\u0010\u000e¨\u0006\u000f"}, d2 = {"Lji/f;", "T", "LJi/M;", "Lkotlin/Function1;", "variant", "", "Lkotlin/ExtensionFunctionType;", "content", "f", "(LJi/M;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function3;Landroidx/compose/runtime/Composer;I)V", "Lji/w1;", "e", "(LJi/M;Lji/w1;Lkotlin/jvm/functions/Function3;Landroidx/compose/runtime/Composer;I)V", "d", "(LJi/M;Lji/f;Lkotlin/jvm/functions/Function3;Landroidx/compose/runtime/Composer;I)V", "library_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes7.dex */
public final class Q {

    /* JADX INFO: Add missing generic type declarations: [T] */
    @Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0004\u001a\u00028\u0000\"\b\b\u0000\u0010\u0001*\u00020\u00002\u0006\u0010\u0003\u001a\u00020\u0002H\n"}, d2 = {"Lji/f;", "T", "LJi/M;", "it", "<anonymous>"}, k = 3, mv = {2, 1, 0})
    static final class a<T> implements w1<T> {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function1<LocalThemeScope, T> f15789a;

        /* JADX WARN: Multi-variable type inference failed */
        a(Function1<? super LocalThemeScope, ? extends T> function1) {
            this.f15789a = function1;
        }

        /* JADX WARN: Incorrect return type in method signature: (LJi/M;Landroidx/compose/runtime/Composer;I)TT; */
        @Override // ji.w1
        public final InterfaceC14933f q(LocalThemeScope it, Composer composer, int i10) {
            Intrinsics.j(it, "it");
            ...
            InterfaceC14933f interfaceC14933f = (InterfaceC14933f) this.f15789a.invoke(it);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
            composer.P();
            return interfaceC14933f;
        }
    }

    public static final <T extends InterfaceC14933f & w1<T>> void d(final LocalThemeScope localThemeScope, final T variant, final Function3<? super T, ? super Composer, ? super Integer, Unit> content, Composer composer, final int i10) {
        int i11;
        ...
        if (t0L != null) {
            t0L.a(new Function2() { // from class: Ji.P
    ...
    public static final <T extends InterfaceC14933f> void e(final LocalThemeScope localThemeScope, final w1<T> variant, final Function3<? super T, ? super Composer, ? super Integer, Unit> content, Composer composer, final int i10) {
        int i11;
        Intrinsics.j(localThemeScope, "<this>");
        Intrinsics.j(variant, "variant");
        Intrinsics.j(content, "content");
        ...
        T0 t0L = composerStartRestartGroup.l();
        if (t0L != null) {
            t0L.a(new Function2() { // from class: Ji.N
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
    ...
    public static final <T extends InterfaceC14933f> void f(final LocalThemeScope localThemeScope, final Function1<? super LocalThemeScope, ? extends T> variant, final Function3<? super T, ? super Composer, ? super Integer, Unit> content, Composer composer, final int i10) {
        int i11;
        Intrinsics.j(localThemeScope, "<this>");
        Intrinsics.j(variant, "variant");
        Intrinsics.j(content, "content");
        ...
        T0 t0L = composerStartRestartGroup.l();
        if (t0L != null) {
            t0L.a(new Function2() { // from class: Ji.O
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit i(LocalThemeScope localThemeScope, InterfaceC14933f interfaceC14933f, Function3 function3, int i10, Composer composer, int i11) {
        d(localThemeScope, interfaceC14933f, function3, composer, J0.a(i10 | 1));
        return Unit.f142422a;
    }
}
