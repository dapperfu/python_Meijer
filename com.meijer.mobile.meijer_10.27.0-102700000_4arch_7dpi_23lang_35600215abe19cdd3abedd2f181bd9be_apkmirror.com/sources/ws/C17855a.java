...
public final class C17855a implements W {
    ...
    private static final class C2646a implements InterfaceC18354E {
        ...
        public C2646a(int i10, int i11) {
            this.unmaskedTextLength = i10;
            this.maskedTextLength = i11;
        }
    }

    public C17855a(NumberFormat currencyFormat, int i10) {
    ...
    public TransformedText a(AnnotatedString text) {
        ...
        return new TransformedText(annotatedString, new C2646a(text.getText().length(), annotatedString.getText().length()));
    }

    public /* synthetic */ C17855a(NumberFormat numberFormat, int i10, int i11, DefaultConstructorMarker defaultConstructorMarker) {
