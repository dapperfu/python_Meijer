...
@Metadata(d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\n\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0000\u0018\u0000*\u0004\b\u0000\u0010\u00012\u00020\u0002Be\u0012\u0006\u0010\u0004\u001a\u00020\u0003\u0012\u0014\u0010\b\u001a\u0010\u0012\u0006\u0012\u0004\u0018\u00010\u0006\u0012\u0004\u0012\u00020\u00070\u0005\u0012\u001a\u0010\n\u001a\u0016\u0012\u0004\u0012\u00028\u0000\u0012\u0006\u0012\u0004\u0018\u00010\u0006\u0012\u0004\u0012\u00020\u00070\t\u0012\"\u0010\f\u001a\u001e\b\u0001\u0012\u0004\u0012\u00028\u0000\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00070\u000b\u0012\u0006\u0012\u0004\u0018\u00010\u00020\t¢\u0006\u0004\b\r\u0010\u000eJ\u0015\u0010\u0010\u001a\u00020\u00072\u0006\u0010\u000f\u001a\u00028\u0000¢\u0006\u0004\b\u0010\u0010\u0011R\u0014\u0010\u0004\u001a\u00020\u00038\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0012\u0010\u0013R0\u0010\f\u001a\u001e\b\u0001\u0012\u0004\u0012\u00028\u0000\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00070\u000b\u0012\u0006\u0012\u0004\u0018\u00010\u00020\t8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0014\u0010\u0015R\u001a\u0010\u0019\u001a\b\u0012\u0004\u0012\u00028\u00000\u00168\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0017\u0010\u0018R\u0014\u0010\u001d\u001a\u00020\u001a8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001b\u0010\u001c¨\u0006\u001e"}, d2 = {"LB2/F;", "T", "", "Lqv/O;", "scope", "Lkotlin/Function1;", "", "", "onComplete", "Lkotlin/Function2;", "onUndeliveredElement", "Lkotlin/coroutines/Continuation;", "consumeMessage", "<init>", "(Lqv/O;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;)V", "msg", "e", "(Ljava/lang/Object;)V", "a", "Lqv/O;", "b", "Lkotlin/jvm/functions/Function2;", "Lsv/g;", "c", "Lsv/g;", "messageQueue", "LB2/b;", "d", "LB2/b;", "remainingMessages", "datastore-core_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
...
public final class F<T> {
    ...
    private final sv.g<T> messageQueue;

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    private final C2937b remainingMessages;

    @Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0003\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0004\u001a\u00020\u0003\"\u0004\b\u0000\u0010\u00002\b\u0010\u0002\u001a\u0004\u0018\u00010\u0001H\n¢\u0006\u0004\b\u0004\u0010\u0005"}, d2 = {"T", "", "ex", "", "a", "(Ljava/lang/Throwable;)V"}, k = 3, mv = {1, 8, 0})
    static final class a extends Lambda implements Function1<Throwable, Unit> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function1<Throwable, Unit> f1732f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ F<T> f1733g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Function2<T, Throwable, Unit> f1734h;
        ...
        a(Function1<? super Throwable, Unit> function1, F<T> f10, Function2<? super T, ? super Throwable, Unit> function2) {
            super(1);
            this.f1732f = function1;
            this.f1733g = f10;
            this.f1734h = function2;
        }

        public final void a(Throwable th2) {
            Unit unit;
            this.f1732f.invoke(th2);
            ((F) this.f1733g).messageQueue.q(th2);
            do {
                Object objF = sv.k.f(((F) this.f1733g).messageQueue.n());
                if (objF != null) {
                    this.f1734h.invoke(objF, th2);
                    unit = Unit.f142422a;
                } else {
                    unit = null;
                }
    ...
    static final class b extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new b(this.f1737c, continuation);
        }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public F(InterfaceC16622O scope, Function1<? super Throwable, Unit> onComplete, Function2<? super T, ? super Throwable, Unit> onUndeliveredElement, Function2<? super T, ? super Continuation<? super Unit>, ? extends Object> consumeMessage) {
        ...
        this.messageQueue = sv.j.b(a.e.API_PRIORITY_OTHER, null, null, 6, null);
        this.remainingMessages = new C2937b(0);
        C0 c02 = (C0) scope.getCoroutineContext().g(C0.INSTANCE);
        if (c02 != null) {
            c02.K(new a(onComplete, this, onUndeliveredElement));
        }
    }
    ...
    public final void e(T msg) throws Throwable {
        ...
        if (this.remainingMessages.c() == 0) {
            C16648k.d(this.scope, null, null, new b(this, null), 3, null);
        }
    }
}
