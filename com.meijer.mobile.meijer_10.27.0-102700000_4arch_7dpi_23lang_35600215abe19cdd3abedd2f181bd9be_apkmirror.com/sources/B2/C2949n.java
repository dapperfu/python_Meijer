...
public final class C2949n<T> implements I<T> {

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);

    /* renamed from: e, reason: collision with root package name */
    private static final Set<String> f1946e = new LinkedHashSet();

    /* renamed from: f, reason: collision with root package name */
    private static final Object f1947f = new Object();
    ...
    public static final class a extends Lambda implements Function1<File, s> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final a f1951f = new a();
    ...
    public static final class Companion {
        ...
        public final Set<String> a() {
            return C2949n.f1946e;
        }

        public final Object b() {
            return C2949n.f1947f;
        }
    }
    ...
    static final class c extends Lambda implements Function0<Unit> {
        ...
        public final void invoke2() {
            Companion companion = C2949n.INSTANCE;
            Object objB = companion.b();
            File file = this.f1952f;
            synchronized (objB) {
    ...
    public C2949n(D<T> serializer, Function1<? super File, ? extends s> coordinatorProducer, Function0<? extends File> produceFile) {
    ...
    public J<T> a() throws IOException {
        ...
        return new C2950o(file, this.serializer, this.coordinatorProducer.invoke(file), new c(file));
    }

    public /* synthetic */ C2949n(D d10, Function1 function1, Function0 function0, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(d10, (i10 & 2) != 0 ? a.f1951f : function1, function0);
    }
}
