...
public final class N implements CoroutineContext.Element {
    ...
    private static final String f1759d = "Calling updateData inside updateData on the same DataStore instance is not supported\nsince updates made in the parent updateData call will not be visible to the nested\nupdateData call. See https://issuetracker.google.com/issues/241760537 for details.";

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final N parent;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final C2945j<?> instance;

    public N(N n10, C2945j<?> instance) {
        Intrinsics.j(instance, "instance");
        this.parent = n10;
        this.instance = instance;
    }

    public final void e(InterfaceC2943h<?> candidate) {
        Intrinsics.j(candidate, "candidate");
        if (this.instance == candidate) {
            throw new IllegalStateException(f1759d.toString());
        }
        N n10 = this.parent;
        if (n10 != null) {
            n10.e(candidate);
    ...
    public CoroutineContext.Key<?> getKey() {
        return Companion.C0030a.f1762a;
    }
