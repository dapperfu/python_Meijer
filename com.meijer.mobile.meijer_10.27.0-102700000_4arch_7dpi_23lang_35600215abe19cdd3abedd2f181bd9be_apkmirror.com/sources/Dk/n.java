...
@Deprecated
@Metadata(d1 = {"\u0000^\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u0003\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\b\n\u0002\u0018\u0002\n\u0002\b\t\b\u0017\u0018\u0000*\b\b\u0000\u0010\u0002*\u00020\u00012\b\u0012\u0004\u0012\u00028\u00000\u0003B\u0011\b\u0007\u0012\u0006\u0010\u0004\u001a\u00028\u0000¢\u0006\u0004\b\u0005\u0010\u0006J\u001d\u0010\n\u001a\u00020\t2\f\u0010\b\u001a\b\u0012\u0004\u0012\u00028\u00000\u0007H\u0002¢\u0006\u0004\b\n\u0010\u000bJ\u0017\u0010\u000e\u001a\u00020\t2\u0006\u0010\r\u001a\u00020\fH\u0002¢\u0006\u0004\b\u000e\u0010\u000fJ#\u0010\u0013\u001a\b\u0012\u0004\u0012\u00028\u00000\u00122\f\u0010\u0011\u001a\b\u0012\u0004\u0012\u00028\u00000\u0010H\u0017¢\u0006\u0004\b\u0013\u0010\u0014J\u0015\u0010\u0016\u001a\b\u0012\u0004\u0012\u00028\u00000\u0015H\u0017¢\u0006\u0004\b\u0016\u0010\u0017R.\u0010\u001c\u001a\u001c\u0012\u0018\u0012\u0016\u0012\u0004\u0012\u00028\u0000 \u0019*\n\u0012\u0004\u0012\u00028\u0000\u0018\u00010\u00100\u00100\u00188\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001a\u0010\u001bR\u0014\u0010\u001f\u001a\u00020\u001d8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0013\u0010\u001eR\u001a\u0010#\u001a\b\u0012\u0004\u0012\u00028\u00000 8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b!\u0010\"R\u001a\u0010%\u001a\b\u0012\u0004\u0012\u00020\u001d0 8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b$\u0010\"R \u0010(\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00028\u00000\u00070\u00158\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b&\u0010'R\u001c\u0010,\u001a\n \u0019*\u0004\u0018\u00010)0)8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b*\u0010+R\u001a\u00101\u001a\u00028\u00008VX\u0097\u0004¢\u0006\f\u0012\u0004\b/\u00100\u001a\u0004\b-\u0010.¨\u00062"}, d2 = {"LDk/n;", "", "S", "LDk/a;", "startingState", "<init>", "(Ljava/lang/Object;)V", "LDk/b$a;", "state", "", "s", "(LDk/b$a;)V", "", "throwable", "o", "(Ljava/lang/Throwable;)V", "LDk/b;", "reducer", "Lio/reactivex/u;", "b", "(LDk/b;)Lio/reactivex/u;", "Lio/reactivex/l;", "t", "()Lio/reactivex/l;", "Ldh/c;", "kotlin.jvm.PlatformType", "a", "Ldh/c;", "reducers", "Ljava/util/UUID;", "Ljava/util/UUID;", "startUuid", "Ldh/b;", "c", "Ldh/b;", PlaceTypes.STORE, "d", "processed", "e", "Lio/reactivex/l;", "processor", "LNu/b;", "f", "LNu/b;", "internalDisposable", "p", "()Ljava/lang/Object;", "getValue$annotations", "()V", "value", "util_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* loaded from: classes7.dex */
public class n<S> implements Dk.a<S> {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final C13522c<Dk.b<S>> reducers;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final UUID startUuid;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private final C13521b<S> store;

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    private final C13521b<UUID> processed;

    /* renamed from: e, reason: collision with root package name and from kotlin metadata */
    private final io.reactivex.l<b.Reduction<S>> processor;

    /* renamed from: f, reason: collision with root package name and from kotlin metadata */
    private final Nu.b internalDisposable;
    ...
    public final void s(b.Reduction<S> state) {
        ...
        try {
            ...
            uw.a.INSTANCE.q(String.valueOf(state), new Object[0]);
        ...
        if (thE != null) {
            uw.a.INSTANCE.r(thE, "Failed logging state", new Object[0]);
        }
    }
    ...
    public n(S startingState) {
        ...
        C13522c<Dk.b<S>> c13522cD = C13522c.d();
        Intrinsics.i(c13522cD, "create(...)");
        this.reducers = c13522cD;
        UUID uuidRandomUUID = UUID.randomUUID();
        Intrinsics.i(uuidRandomUUID, "randomUUID(...)");
        this.startUuid = uuidRandomUUID;
        C13521b<S> c13521bD = C13521b.d(startingState);
        Intrinsics.i(c13521bD, "createDefault(...)");
        this.store = c13521bD;
        C13521b<UUID> c13521bD2 = C13521b.d(uuidRandomUUID);
        Intrinsics.i(c13521bD2, "createDefault(...)");
        this.processed = c13521bD2;
        io.reactivex.l<Dk.b<S>> lVarObserveOn = c13522cD.observeOn(C14764a.c());
        b.Reduction reduction = new b.Reduction(uuidRandomUUID, startingState);
        final Function2 function2 = new Function2() { // from class: Dk.h
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return n.u((b.Reduction) obj, (b) obj2);
            }
        };
        io.reactivex.l<R> lVarScan = lVarObserveOn.scan(reduction, new Pu.c() { // from class: Dk.i
            @Override // Pu.c
            public final Object apply(Object obj, Object obj2) {
                return n.v(function2, (b.Reduction) obj, obj2);
            }
        });
        final Function1 function1 = new Function1() { // from class: Dk.j
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return n.w(this.f6714a, (b.Reduction) obj);
            }
        };
        io.reactivex.l<b.Reduction<S>> lVarDoOnNext = lVarScan.doOnNext(new Pu.g() { // from class: Dk.k
            @Override // Pu.g
        ...
        Pu.g<? super b.Reduction<S>> gVar = new Pu.g() { // from class: Dk.l
            @Override // Pu.g
            public final void accept(Object obj) {
                n.r(aVar, obj);
            }
        ...
        this.internalDisposable = lVarDoOnNext.subscribe(gVar, new Pu.g() { // from class: Dk.m
            @Override // Pu.g
            public final void accept(Object obj) {
                n.q(bVar, obj);
            }
    ...
    public static final b.Reduction u(b.Reduction oldState, Dk.b reducer) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean y(Dk.b bVar, UUID uuid) {
    ...
    @Override // Dk.a
    public u<S> b(final Dk.b<S> reducer) {
        Intrinsics.j(reducer, "reducer");
        C13521b<UUID> c13521b = this.processed;
        final Function1 function1 = new Function1() { // from class: Dk.d
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return Boolean.valueOf(n.y(reducer, (UUID) obj));
            }
        };
        io.reactivex.l<UUID> lVarTake = c13521b.filter(new Pu.q() { // from class: Dk.e
            @Override // Pu.q
            public final boolean test(Object obj) {
                return n.z(function1, obj);
            }
        }).take(1L);
        final Function1 function12 = new Function1() { // from class: Dk.f
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return n.A(this.f6711a, (UUID) obj);
            }
        };
        u<S> uVarQ = lVarTake.switchMap(new o() { // from class: Dk.g
            @Override // Pu.o
            public final Object apply(Object obj) {
                return n.B(function12, obj);
            }
        }).firstOrError().q(C14764a.a());
