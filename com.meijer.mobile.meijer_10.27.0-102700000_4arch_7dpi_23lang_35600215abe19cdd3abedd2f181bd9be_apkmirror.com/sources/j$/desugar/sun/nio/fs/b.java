...
public final class b implements j$.nio.file.attribute.d {
    ...
    public static final Set f138550b;

    /* renamed from: a, reason: collision with root package name */
    public final Path f138551a;

    @Override // j$.nio.file.attribute.d
    public final BasicFileAttributes readAttributes() {
        boolean z10;
        Path path = this.f138551a;
        path.getFileSystem().i().a(path, new EnumC14766a[0]);
    ...
    public final void a(FileTime fileTime, FileTime fileTime2, FileTime fileTime3) {
        ...
        Path path = this.f138551a;
        path.getFileSystem().i().a(path, EnumC14766a.WRITE);
        File file = path.toFile();
        TimeUnit timeUnit = TimeUnit.MILLISECONDS;
        fileTime.getClass();
        Objects.requireNonNull(timeUnit, "unit");
        if (timeUnit != null) {
            jConvert = timeUnit.convert(fileTime.f138619a, timeUnit);
        } else {
            long jConvert2 = timeUnit.convert(fileTime.f138620b.getEpochSecond(), TimeUnit.SECONDS);
            if (jConvert2 == Long.MIN_VALUE || jConvert2 == Long.MAX_VALUE) {
                jConvert = jConvert2;
            } else {
                long jConvert3 = timeUnit.convert(fileTime.f138620b.getNano(), TimeUnit.NANOSECONDS);
