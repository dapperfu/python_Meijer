...
public abstract class g {
    ...
    public static /* synthetic */ String n(Iterable iterable) {
        ...
        if (it.hasNext()) {
            while (true) {
                ...
                sb2.append((CharSequence) q2.f92724c);
            }
        }
        return sb2.toString();
    }
    ...
    public static /* synthetic */ CopyOption[] t(j$.nio.file.CopyOption[] copyOptionArr) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            if (copyOption == null) {
                c14771c = null;
            } else if (copyOption instanceof C14770b) {
                c14771c = ((C14770b) copyOption).f138644a;
            } else if (copyOption instanceof LinkOption) {
                c14771c = java.nio.file.LinkOption.NOFOLLOW_LINKS;
            } else if (copyOption instanceof StandardCopyOption) {
                StandardCopyOption standardCopyOption = (StandardCopyOption) copyOption;
                c14771c = standardCopyOption == StandardCopyOption.REPLACE_EXISTING ? java.nio.file.StandardCopyOption.REPLACE_EXISTING : standardCopyOption == StandardCopyOption.COPY_ATTRIBUTES ? java.nio.file.StandardCopyOption.COPY_ATTRIBUTES : java.nio.file.StandardCopyOption.ATOMIC_MOVE;
            } else {
                c14771c = new C14771c(copyOption);
            }
            copyOptionArr2[i10] = c14771c;
        }
    ...
    public static WatchEvent.Kind[] v(J[] jArr) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            J j10 = jArr[i10];
            kindArr[i10] = j10 == null ? null : j10 == G.f138606b ? StandardWatchEventKinds.ENTRY_CREATE : j10 == G.f138607c ? StandardWatchEventKinds.ENTRY_DELETE : j10 == G.f138608d ? StandardWatchEventKinds.ENTRY_MODIFY : j10 == G.f138605a ? StandardWatchEventKinds.OVERFLOW : j10 instanceof H ? ((H) j10).f138609a : new I(j10);
        }
        return kindArr;
    }
    ...
    public static j$.nio.file.attribute.k[] s(FileAttribute[] fileAttributeArr) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            kVarArr[i10] = fileAttribute == null ? null : m(fileAttribute.value()) ? new h(fileAttribute) : fileAttribute instanceof j$.nio.file.attribute.j ? ((j$.nio.file.attribute.j) fileAttribute).f138630a : new j$.nio.file.attribute.i(fileAttribute);
        }
        return kVarArr;
    }
    ...
    public static J[] r(WatchEvent.Kind[] kindArr) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            jArr[i10] = kind == null ? null : kind == StandardWatchEventKinds.ENTRY_CREATE ? G.f138606b : kind == StandardWatchEventKinds.ENTRY_DELETE ? G.f138607c : kind == StandardWatchEventKinds.ENTRY_MODIFY ? G.f138608d : kind == StandardWatchEventKinds.OVERFLOW ? G.f138605a : kind instanceof I ? ((I) kind).f138610a : new H(kind);
        }
        return jArr;
    }
    ...
    public static FileAttribute[] w(j$.nio.file.attribute.k[] kVarArr) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            fileAttributeArr[i10] = kVar == null ? null : m(kVar.value()) ? new j$.nio.file.attribute.l(kVar) : kVar instanceof j$.nio.file.attribute.i ? ((j$.nio.file.attribute.i) kVar).f138629a : new j$.nio.file.attribute.j(kVar);
        }
