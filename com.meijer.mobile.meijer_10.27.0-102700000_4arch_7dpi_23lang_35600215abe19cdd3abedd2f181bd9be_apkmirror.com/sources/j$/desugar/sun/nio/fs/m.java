...
public final class m extends j$.nio.file.spi.c {
    ...
    public final String f138579c = q2.f92724c;

    /* renamed from: d, reason: collision with root package name */
    public volatile i f138580d;
    ...
    @Override // j$.nio.file.spi.c
    public final AbstractC14776h u(URI uri, Map map) {
        B(uri);
        throw new FileSystemAlreadyExistsException();
    }

    @Override // j$.nio.file.spi.c
    public final AbstractC14776h j(URI uri) {
        i iVar;
        B(uri);
        i iVar2 = this.f138580d;
        if (iVar2 != null) {
            return iVar2;
        }
        synchronized (this) {
            try {
                iVar = this.f138580d;
                if (iVar == null) {
                    iVar = new i(this, this.f138578b, this.f138579c);
                    this.f138580d = iVar;
                }
            } catch (Throwable th2) {
                throw th2;
    ...
    public final Path k(URI uri) {
        ...
        if (rawPath.endsWith(q2.f92724c) && length > 1) {
            length--;
        }
        ...
        return new o(iVar, new String(bArrCopyOf, q.f138592a), str, str2);
    }

    @Override // j$.nio.file.spi.c
    public final DirectoryStream r(Path path, DirectoryStream.Filter filter) {
        k kVar = new k();
        kVar.f138573a = new l(this, path, filter);
        return kVar;
    }
    ...
    public final Path z(Path path) {
        return new o(this.f138580d, path.toFile().getCanonicalPath(), this.f138578b, this.f138579c);
    }
    ...
    @Override // j$.nio.file.spi.c
    public final C14772d i(Path path) {
    ...
    @Override // j$.nio.file.spi.c
    public final void a(Path path, EnumC14766a... enumC14766aArr) throws IOException {
        boolean zCanRead;
        File file = path.toFile();
        if (!file.exists()) {
            throw new NoSuchFileException(path.toString());
        ...
        boolean z10 = true;
        for (EnumC14766a enumC14766a : enumC14766aArr) {
            int i10 = j.f138572a[enumC14766a.ordinal()];
            if (i10 == 1) {
    ...
    public final Map y(Path path, String str, LinkOption... linkOptionArr) {
        ...
        Set set = b.f138550b;
        a aVar = new a();
        aVar.f138547a = new HashSet();
        aVar.f138548b = new HashMap();
        for (String str2 : strArrSplit) {
            if (str2.equals("*")) {
                ...
                ((HashSet) aVar.f138547a).add(str2);
            }
        }
        ...
        return Collections.unmodifiableMap(aVar.f138548b);
    }
