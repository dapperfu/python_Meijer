...
public final class q extends ZoneId {
    ...
    public static final /* synthetic */ int f138918d = 0;
    ...
    public final transient j$.time.zone.f f138920c;
    ...
    public final j$.time.zone.f H() {
        j$.time.zone.f fVar = this.f138920c;
        return fVar != null ? fVar : j$.time.zone.i.a(this.f138919b);
    }
    ...
    public final void f0(DataOutput dataOutput) throws IOException {
        ...
        dataOutput.writeUTF(this.f138919b);
    }
}
