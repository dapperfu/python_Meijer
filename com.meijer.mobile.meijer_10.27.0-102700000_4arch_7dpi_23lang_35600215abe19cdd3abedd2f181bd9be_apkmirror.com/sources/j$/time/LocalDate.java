...
public final class LocalDate implements Temporal, j$.time.temporal.k, ChronoLocalDate, Serializable {
    ...
    public static final LocalDate f138695d = of(-999999999, 1, 1);

    /* renamed from: e, reason: collision with root package name */
    public static final LocalDate f138696e = of(999999999, 12, 31);
    private static final long serialVersionUID = 2942565459149668126L;

    /* renamed from: a, reason: collision with root package name */
    public final int f138697a;

    /* renamed from: b, reason: collision with root package name */
    public final short f138698b;

    /* renamed from: c, reason: collision with root package name */
    public final short f138699c;
    ...
    public static LocalDate k0(Clock clock) {
        ...
        return l0(Math.floorDiv(instantA.getEpochSecond() + zone.H().d(instantA).f138727b, 86400));
    }
    ...
    public static LocalDate m0(int i10, int i11) {
        ...
        if (i11 > (monthO.H(zG0) + monthO.C(zG0)) - 1) {
            monthO = Month.f138708a[((((int) 1) + 12) + monthO.ordinal()) % 12];
        }
    ...
    public static LocalDate l0(long j10) {
        ...
        return new LocalDate(chronoField.f138926d.a(j16, chronoField), i12, i13);
    }

    public static LocalDate from(TemporalAccessor temporalAccessor) {
        Objects.requireNonNull(temporalAccessor, "temporal");
        LocalDate localDate = (LocalDate) temporalAccessor.d(j$.time.temporal.n.f138961f);
        if (localDate != null) {
            return localDate;
        }
    ...
    public LocalDate(int i10, int i11, int i12) {
        this.f138697a = i10;
        this.f138698b = (short) i11;
        this.f138699c = (short) i12;
    }
    ...
    public final j$.time.temporal.p k(TemporalField temporalField) {
        ...
        int i10 = e.f138795a[chronoField.ordinal()];
        if (i10 == 1) {
        ...
        if (i10 != 3) {
            return i10 != 4 ? ((ChronoField) temporalField).f138926d : getYear() <= 0 ? j$.time.temporal.p.f(1L, 1000000000L) : j$.time.temporal.p.f(1L, 999999999L);
        }
        return j$.time.temporal.p.f(1L, (Month.O(this.f138698b) != Month.FEBRUARY || E()) ? 5L : 4L);
    }
    ...
    public final int O(TemporalField temporalField) {
        switch (e.f138795a[((ChronoField) temporalField).ordinal()]) {
            case 1:
                return this.f138699c;
            case 2:
                return Q();
            case 3:
                return ((this.f138699c - 1) / 7) + 1;
            case 4:
                int i10 = this.f138697a;
    ...
    public final long Z() {
        return ((this.f138697a * 12) + this.f138698b) - 1;
    }
    ...
    public final int Q() {
        return (Month.O(this.f138698b).C(E()) + this.f138699c) - 1;
    }
    ...
    public final boolean E() {
        return IsoChronology.INSTANCE.g0(this.f138697a);
    }

    public final int f0() {
        short s10 = this.f138698b;
    ...
    public final LocalDate a(long j10, TemporalField temporalField) {
        ...
        ChronoField chronoField = (ChronoField) temporalField;
        chronoField.i0(j10);
        switch (e.f138795a[chronoField.ordinal()]) {
            case 1:
                int i10 = (int) j10;
                if (this.f138699c != i10) {
                    return of(this.f138697a, this.f138698b, i10);
                }
                return this;
            case 2:
                int i11 = (int) j10;
                if (Q() != i11) {
                    return m0(this.f138697a, i11);
                }
                return this;
            case 3:
            ...
            case 10:
                int i12 = (int) j10;
                if (this.f138698b != i12) {
                    ChronoField.MONTH_OF_YEAR.i0(i12);
                    return r0(this.f138697a, i12, this.f138699c);
                }
                return this;
            case 11:
                return o0(j10 - Z());
    ...
    public final LocalDate u0(int i10) {
        if (this.f138697a == i10) {
            return this;
        }
        ChronoField.YEAR.i0(i10);
        return r0(i10, this.f138698b, this.f138699c);
    }
    ...
    public final ChronoLocalDate b0(j$.time.temporal.m mVar) {
        if (mVar != null) {
            ...
            return o0((period.f138714a * 12) + period.f138715b).plusDays(period.getDays());
        }
    ...
    public final LocalDate b(long j10, TemporalUnit temporalUnit) {
        ...
        switch (e.f138796b[((ChronoUnit) temporalUnit).ordinal()]) {
            case 1:
                return plusDays(j10);
            case 2:
                return p0(j10);
    ...
    public final LocalDate q0(long j10) {
        ...
        ChronoField chronoField = ChronoField.YEAR;
        return r0(chronoField.f138926d.a(this.f138697a + j10, chronoField), this.f138698b, this.f138699c);
    }
    ...
    public final LocalDate o0(long j10) {
        ...
        long j11 = (this.f138697a * 12) + (this.f138698b - 1) + j10;
        ChronoField chronoField = ChronoField.YEAR;
        long j12 = 12;
        return r0(chronoField.f138926d.a(Math.floorDiv(j11, j12), chronoField), ((int) Math.floorMod(j11, j12)) + 1, this.f138699c);
    }
    ...
    public LocalDate plusDays(long j10) {
        ...
        long j11 = this.f138699c + j10;
        if (j11 > 0) {
            if (j11 <= 28) {
                return new LocalDate(this.f138697a, this.f138698b, (int) j11);
            }
            if (j11 <= 59) {
                long jF0 = f0();
                if (j11 <= jF0) {
                ...
                short s10 = this.f138698b;
                if (s10 < 12) {
                    return new LocalDate(this.f138697a, s10 + 1, (int) (j11 - jF0));
                }
                ChronoField.YEAR.i0(this.f138697a + 1);
                return new LocalDate(this.f138697a + 1, 1, (int) (j11 - jF0));
            }
        }
    ...
    public final Object d(TemporalQuery temporalQuery) {
        return temporalQuery == j$.time.temporal.n.f138961f ? this : super.d(temporalQuery);
    }
    ...
    public Period until(ChronoLocalDate chronoLocalDate) {
        ...
        int iF0 = localDateFrom.f138699c - this.f138699c;
        if (jZ > 0 && iF0 < 0) {
            jZ--;
    ...
    public LocalDateTime atTime(int i10, int i11, int i12) {
        ...
        if ((i11 | i12) == 0) {
            localTime = LocalTime.f138703e[i10];
        } else {
    ...
    public ZonedDateTime atStartOfDay(ZoneId zoneId) {
        ...
        LocalDateTime localDateTimeT = T(LocalTime.MIDNIGHT);
        if (!(zoneId instanceof ZoneOffset)) {
            Object objE = zoneId.H().e(localDateTimeT);
            j$.time.zone.b bVar = objE instanceof j$.time.zone.b ? (j$.time.zone.b) objE : null;
            if (bVar != null && bVar.C()) {
                localDateTimeT = bVar.f138980b.Q(bVar.f138982d.f138727b - bVar.f138981c.f138727b);
            }
        }
    ...
    @Override // j$.time.chrono.ChronoLocalDate
    public final long S() {
        long j10 = this.f138697a;
        long j11 = this.f138698b;
        long j12 = 365 * j10;
        long j13 = (((367 * j11) - 362) / 12) + (j10 >= 0 ? ((j10 + 399) / 400) + (((3 + j10) / 4) - ((99 + j10) / 100)) + j12 : j12 - ((j10 / (-400)) + ((j10 / (-4)) - (j10 / (-100))))) + (this.f138699c - 1);
        if (j11 > 2) {
            j13 = !E() ? j13 - 2 : j13 - 1;
        }
        return j13 - 719528;
    ...
    public final int C(LocalDate localDate) {
        int i10 = this.f138697a - localDate.f138697a;
        if (i10 != 0) {
            return i10;
        }
        int i11 = this.f138698b - localDate.f138698b;
        return i11 == 0 ? this.f138699c - localDate.f138699c : i11;
    }
    ...
    public int hashCode() {
        int i10 = this.f138697a;
        return (((i10 << 11) + (this.f138698b << 6)) + this.f138699c) ^ (i10 & (-2048));
    }
