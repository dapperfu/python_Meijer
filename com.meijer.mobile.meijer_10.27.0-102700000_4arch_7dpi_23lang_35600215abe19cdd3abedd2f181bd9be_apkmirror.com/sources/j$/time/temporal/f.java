...
public abstract class f implements TemporalField {
    ...
    public static final int[] f138939a;

    /* renamed from: b, reason: collision with root package name */
    public static final /* synthetic */ f[] f138940b;
    ...
    static {
        f fVar = new f() { // from class: j$.time.temporal.b
            ...
            public final long Z(TemporalAccessor temporalAccessor) {
                ...
                return temporalAccessor.get(ChronoField.DAY_OF_YEAR) - f.f138939a[((temporalAccessor.get(ChronoField.MONTH_OF_YEAR) - 1) / 3) + (IsoChronology.INSTANCE.g0(temporalAccessor.j(ChronoField.YEAR)) ? 4 : 0)];
            }
            ...
            public final TemporalAccessor O(Map map, B b10, ResolverStyle resolverStyle) {
                ...
                int iA = chronoField.f138926d.a(l10.longValue(), chronoField);
        ...
        f fVar3 = new f() { // from class: j$.time.temporal.d
            ...
            public final TemporalAccessor O(Map map, B b10, ResolverStyle resolverStyle) {
                ...
                if (resolverStyle == ResolverStyle.LENIENT) {
                    ...
                    int iA2 = chronoField.f138926d.a(l11.longValue(), chronoField);
        ...
        f fVar4 = new f() { // from class: j$.time.temporal.e
            ...
            public final Temporal f0(Temporal temporal, long j10) {
                ...
                int iA = ChronoField.YEAR.f138926d.a(j10, f.WEEK_BASED_YEAR);
        ...
        f138940b = new f[]{fVar, fVar2, fVar3, fVar4};
        f138939a = new int[]{0, 90, 181, 273, 0, 91, 182, 274};
    }
    ...
    public static int i0(LocalDate localDate) {
        ...
        if (localDate.Q() != 180) {
            localDate = LocalDate.m0(localDate.f138697a, 180);
        }
        return (int) l0(localDate.minusYears(1L)).f138966d;
    }
