...
public final class Year implements Temporal, j$.time.temporal.k, Comparable<Year>, Serializable {
    ...
    public static final /* synthetic */ int f138717b = 0;
    ...
    public final int compareTo(Year year) {
        return this.f138718a - year.f138718a;
    }
    ...
    public final j$.time.temporal.p k(TemporalField temporalField) {
        if (temporalField == ChronoField.YEAR_OF_ERA) {
            return j$.time.temporal.p.f(1L, this.f138718a <= 0 ? 1000000000L : 999999999L);
        }
    ...
    public final long j(TemporalField temporalField) {
        ...
        int i10 = o.f138914a[((ChronoField) temporalField).ordinal()];
        if (i10 == 1) {
            int i11 = this.f138718a;
            if (i11 < 1) {
                i11 = 1 - i11;
            }
            return i11;
    ...
    public final Year a(long j10, TemporalField temporalField) {
        ...
        chronoField.i0(j10);
        int i10 = o.f138914a[chronoField.ordinal()];
        if (i10 == 1) {
            if (this.f138718a < 1) {
                j10 = 1 - j10;
            }
        ...
        if (i10 == 3) {
            return j(ChronoField.ERA) == j10 ? this : of(1 - this.f138718a);
        }
        throw new j$.time.temporal.o(b.a("Unsupported field: ", temporalField));
    }
    ...
    public final Year b(long j10, TemporalUnit temporalUnit) {
        ...
        int i10 = o.f138915b[((ChronoUnit) temporalUnit).ordinal()];
        if (i10 == 1) {
            return H(j10);
        }
        if (i10 == 2) {
    ...
    public final Year H(long j10) {
        ...
        return of(chronoField.f138926d.a(this.f138718a + j10, chronoField));
    }
    ...
    public final Temporal f(Temporal temporal) {
        ...
        return temporal.a(this.f138718a, ChronoField.YEAR);
    }
    ...
    public final long until(Temporal temporal, TemporalUnit temporalUnit) {
        ...
        if (temporalUnit instanceof ChronoUnit) {
            long j10 = yearFrom.f138718a - this.f138718a;
            int i10 = o.f138915b[((ChronoUnit) temporalUnit).ordinal()];
            if (i10 == 1) {
                return j10;
            }
    ...
    public LocalDate atDay(int i10) {
        return LocalDate.m0(this.f138718a, i10);
    }

    public YearMonth atMonth(Month month) {
        int i10 = this.f138718a;
        int i11 = YearMonth.f138719c;
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof Year) && this.f138718a == ((Year) obj).f138718a;
    }
    ...
    public String toString() {
        return Integer.toString(this.f138718a);
    }

    private Object writeReplace() {
        return new n(C14045dq.DST_ATOP, this);
    }
