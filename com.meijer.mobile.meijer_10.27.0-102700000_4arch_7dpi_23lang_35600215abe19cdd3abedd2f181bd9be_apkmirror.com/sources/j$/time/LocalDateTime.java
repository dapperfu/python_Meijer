...
public final class LocalDateTime implements Temporal, j$.time.temporal.k, ChronoLocalDateTime<LocalDate>, Serializable {
    public static final LocalDateTime MIN = of(LocalDate.f138695d, LocalTime.MIN);

    /* renamed from: c, reason: collision with root package name */
    public static final LocalDateTime f138700c = of(LocalDate.f138696e, LocalTime.MAX);
    private static final long serialVersionUID = 6207766400415563566L;

    /* renamed from: a, reason: collision with root package name */
    public final LocalDate f138701a;

    /* renamed from: b, reason: collision with root package name */
    public final LocalTime f138702b;
    ...
    public static LocalDateTime H(long j10, int i10, ZoneOffset zoneOffset) {
        ...
        return new LocalDateTime(LocalDate.l0(Math.floorDiv(j10 + zoneOffset.f138727b, 86400)), LocalTime.Z((((int) Math.floorMod(r5, r7)) * 1000000000) + j11));
    }
    ...
    public LocalDateTime(LocalDate localDate, LocalTime localTime) {
        this.f138701a = localDate;
        this.f138702b = localTime;
    }

    public final LocalDateTime i0(LocalDate localDate, LocalTime localTime) {
        return (this.f138701a == localDate && this.f138702b == localTime) ? this : new LocalDateTime(localDate, localTime);
    }
    ...
    public final j$.time.temporal.p k(TemporalField temporalField) {
        if (temporalField instanceof ChronoField) {
            return ((ChronoField) temporalField).j0() ? this.f138702b.k(temporalField) : this.f138701a.k(temporalField);
        }
    ...
    public final int get(TemporalField temporalField) {
        if (temporalField instanceof ChronoField) {
            return ((ChronoField) temporalField).j0() ? this.f138702b.get(temporalField) : this.f138701a.get(temporalField);
        }
    ...
    public final long j(TemporalField temporalField) {
        if (temporalField instanceof ChronoField) {
            return ((ChronoField) temporalField).j0() ? this.f138702b.j(temporalField) : this.f138701a.j(temporalField);
        }
    ...
    public LocalDate l() {
        return this.f138701a;
    }

    public int getYear() {
        return this.f138701a.getYear();
    }

    public Month getMonth() {
        return Month.O(this.f138701a.f138698b);
    }

    public int getDayOfYear() {
        return this.f138701a.Q();
    }

    public DayOfWeek getDayOfWeek() {
        return this.f138701a.getDayOfWeek();
    }

    @Override // j$.time.chrono.ChronoLocalDateTime
    public LocalTime toLocalTime() {
        return this.f138702b;
    }
    ...
    public final LocalDateTime i(j$.time.temporal.k kVar) {
        if (kVar instanceof LocalDate) {
            return i0((LocalDate) kVar, this.f138702b);
        }
        if (kVar instanceof LocalTime) {
            return i0(this.f138701a, (LocalTime) kVar);
        }
    ...
    public final LocalDateTime a(long j10, TemporalField temporalField) {
        if (temporalField instanceof ChronoField) {
            if (((ChronoField) temporalField).j0()) {
                return i0(this.f138701a, this.f138702b.a(j10, temporalField));
            }
            return i0(this.f138701a.a(j10, temporalField), this.f138702b);
        }
    ...
    public final LocalDateTime b(long j10, TemporalUnit temporalUnit) {
        ...
        switch (f.f138797a[((ChronoUnit) temporalUnit).ordinal()]) {
            case 1:
                return Z(this.f138701a, 0L, 0L, 0L, j10);
            case 2:
                LocalDateTime localDateTimePlusDays = plusDays(j10 / 86400000000L);
                return localDateTimePlusDays.Z(localDateTimePlusDays.f138701a, 0L, 0L, 0L, (j10 % 86400000000L) * 1000);
            case 3:
                LocalDateTime localDateTimePlusDays2 = plusDays(j10 / l8.b.f92527d);
                return localDateTimePlusDays2.Z(localDateTimePlusDays2.f138701a, 0L, 0L, 0L, (j10 % l8.b.f92527d) * 1000000);
            case 4:
                return Q(j10);
            case 5:
                return Z(this.f138701a, 0L, j10, 0L, 0L);
            case 6:
                return Z(this.f138701a, j10, 0L, 0L, 0L);
            case 7:
                LocalDateTime localDateTimePlusDays3 = plusDays(j10 / 256);
                return localDateTimePlusDays3.Z(localDateTimePlusDays3.f138701a, (j10 % 256) * 12, 0L, 0L, 0L);
            default:
                return i0(this.f138701a.b(j10, temporalUnit), this.f138702b);
        }
    }

    public LocalDateTime minusYears(long j10) {
        if (j10 != Long.MIN_VALUE) {
            return i0(this.f138701a.q0(-j10), this.f138702b);
        }
        LocalDateTime localDateTimeI0 = i0(this.f138701a.q0(Long.MAX_VALUE), this.f138702b);
        return localDateTimeI0.i0(localDateTimeI0.f138701a.q0(1L), localDateTimeI0.f138702b);
    }

    public LocalDateTime plusDays(long j10) {
        return i0(this.f138701a.plusDays(j10), this.f138702b);
    }

    public final LocalDateTime Q(long j10) {
        return Z(this.f138701a, 0L, 0L, j10, 0L);
    }
    ...
    public final LocalDateTime Z(LocalDate localDate, long j10, long j11, long j12, long j13) {
        if ((j10 | j11 | j12 | j13) == 0) {
            return i0(localDate, this.f138702b);
        }
        long j14 = 1;
        long jN0 = this.f138702b.n0();
        ...
        return i0(localDate.plusDays(jFloorDiv), jFloorMod == jN0 ? this.f138702b : LocalTime.Z(jFloorMod));
    }
    ...
    public final long until(Temporal temporal, TemporalUnit temporalUnit) {
        ...
        if (((ChronoUnit) temporalUnit).compareTo(ChronoUnit.DAYS) >= 0) {
            LocalDate localDatePlusDays = localDateTimeFrom.f138701a;
            if (localDatePlusDays.isAfter(this.f138701a) && localDateTimeFrom.f138702b.isBefore(this.f138702b)) {
                localDatePlusDays = localDatePlusDays.minusDays(1L);
            } else if (localDatePlusDays.isBefore(this.f138701a) && localDateTimeFrom.f138702b.isAfter(this.f138702b)) {
                localDatePlusDays = localDatePlusDays.plusDays(1L);
            }
            return this.f138701a.until(localDatePlusDays, temporalUnit);
        }
        LocalDate localDate = this.f138701a;
        LocalDate localDate2 = localDateTimeFrom.f138701a;
        localDate.getClass();
        long jS = localDate2.S() - localDate.S();
        if (jS == 0) {
            return this.f138702b.until(localDateTimeFrom.f138702b, temporalUnit);
        }
        long jN0 = localDateTimeFrom.f138702b.n0() - this.f138702b.n0();
        if (jS > 0) {
            jMultiplyExact = jS - 1;
        ...
        switch (f.f138797a[((ChronoUnit) temporalUnit).ordinal()]) {
            ...
            case 2:
                ...
                break;
            case 3:
                jMultiplyExact = Math.multiplyExact(jMultiplyExact, l8.b.f92527d);
                j10 /= 1000000;
                break;
            case 4:
    ...
    public final int C(LocalDateTime localDateTime) {
        int iC = this.f138701a.C(localDateTime.l());
        return iC == 0 ? this.f138702b.compareTo(localDateTime.toLocalTime()) : iC;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof LocalDateTime) {
            ...
            if (this.f138701a.equals(localDateTime.f138701a) && this.f138702b.equals(localDateTime.f138702b)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return this.f138701a.hashCode() ^ this.f138702b.hashCode();
    }

    public String toString() {
        return this.f138701a.toString() + "T" + this.f138702b.toString();
    }
