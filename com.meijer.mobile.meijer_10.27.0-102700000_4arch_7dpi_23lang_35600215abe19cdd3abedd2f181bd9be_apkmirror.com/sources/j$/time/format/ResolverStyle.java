...
public final class ResolverStyle {
    ...
    public static final /* synthetic */ ResolverStyle[] f138830a;
    ...
    public static ResolverStyle[] values() {
        return (ResolverStyle[]) f138830a.clone();
    }
    ...
    static {
        ...
        f138830a = new ResolverStyle[]{resolverStyle, resolverStyle2, resolverStyle3};
    }
}
