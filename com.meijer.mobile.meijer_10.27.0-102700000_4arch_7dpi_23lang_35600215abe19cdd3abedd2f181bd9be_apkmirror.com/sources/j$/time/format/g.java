...
public final class g implements e {
    ...
    public final boolean C(w wVar, StringBuilder sb2) {
        ...
        TemporalAccessor temporalAccessor = wVar.f138892a;
        ...
        int iA = chronoField.f138926d.a(lValueOf != null ? lValueOf.longValue() : 0L, chronoField);
        if (jLongValue >= -62167219200L) {
            ...
            if (localDateTimeH.f138702b.f138706c == 0) {
                sb2.append(":00");
            }
        } else {
            ...
            if (localDateTimeH2.f138702b.f138706c == 0) {
                sb2.append(":00");
            }
            if (j12 < 0) {
