...
public final class l extends AbstractC14782a implements Serializable {

    /* renamed from: l, reason: collision with root package name */
    public static final l f138759l;
    private static final long serialVersionUID = 3127340209035924785L;

    /* renamed from: c, reason: collision with root package name */
    public volatile transient boolean f138760c;

    /* renamed from: d, reason: collision with root package name */
    public transient int[] f138761d;

    /* renamed from: e, reason: collision with root package name */
    public transient int f138762e;

    /* renamed from: f, reason: collision with root package name */
    public transient int f138763f;

    /* renamed from: g, reason: collision with root package name */
    public transient int f138764g;

    /* renamed from: h, reason: collision with root package name */
    public transient int f138765h;

    /* renamed from: i, reason: collision with root package name */
    public transient int f138766i;

    /* renamed from: j, reason: collision with root package name */
    public transient int f138767j;

    /* renamed from: k, reason: collision with root package name */
    public transient int f138768k;

    @Override // j$.time.chrono.Chronology
    public final ChronoLocalDate a0(int i10, int i11, int i12) {
        return new n(this, i10, i11, i12);
    }

    @Override // j$.time.chrono.Chronology
    public final ChronoLocalDate y(int i10, int i11) {
        n nVar = new n(this, i10, 1, 1);
        if (i11 > nVar.e0()) {
    ...
    static {
        l lVar = new l();
        f138759l = lVar;
        AbstractC14782a.H(lVar, "Hijrah");
        AbstractC14782a.H(lVar, "islamic");
    }
    ...
    public final void i0() {
        ...
        try {
            ...
            int[][] iArrN0 = n0();
            int iS = (int) LocalDate.of(1882, 11, 12).S();
            for (int i10 = 1300; i10 <= 1600; i10++) {
                int[] iArr = iArrN0[i10 - 1300];
                if (iArr.length != 12) {
            ...
            this.f138764g = 15600;
            this.f138762e = iS;
            int[] iArrJ0 = j0(iS, map);
            this.f138761d = iArrJ0;
            this.f138763f = iArrJ0[3612];
            for (int i11 = 1300; i11 < 1600; i11++) {
                int iO0 = o0(i11, 12);
                this.f138767j = Math.min(this.f138767j, iO0);
                this.f138768k = Math.max(this.f138768k, iO0);
            }
            this.f138760c = true;
        } catch (Exception e10) {
            throw new DateTimeException("Unable to initialize HijrahCalendar: Hijrah-umalqura", e10);
        }
    }
    ...
    public final ChronoLocalDate U() {
        return new n(this, LocalDate.k0(Clock.systemDefaultZone()).j(ChronoField.EPOCH_DAY));
    }

    @Override // j$.time.chrono.Chronology
    public final ChronoLocalDate P(TemporalAccessor temporalAccessor) {
        if (!(temporalAccessor instanceof n)) {
            return new n(this, temporalAccessor.j(ChronoField.EPOCH_DAY));
        }
    ...
    public final boolean g0(long j10) {
        i0();
        return j10 >= ((long) k0(0)) && j10 <= ((long) (k0(this.f138761d.length - 1) - 1)) && o0((int) j10, 12) > 354;
    }
    ...
    public final j$.time.temporal.p F(ChronoField chronoField) {
        i0();
        if (chronoField != null) {
            switch (k.f138758a[chronoField.ordinal()]) {
                case 1:
                    return j$.time.temporal.p.g(1L, this.f138765h, this.f138766i);
                case 2:
                    return j$.time.temporal.p.f(1L, this.f138768k);
                case 3:
                    return j$.time.temporal.p.f(1L, 5L);
                case 4:
                case 5:
                    return j$.time.temporal.p.f(k0(0), k0(this.f138761d.length - 1) - 1);
                case 6:
    ...
    public final ChronoLocalDate c0(Map map, ResolverStyle resolverStyle) {
        return (n) super.c0(map, resolverStyle);
    }
    ...
    public final long l0(int i10, int i11, int i12) {
        ...
        int i13 = (i11 - 1) + ((i10 * 12) - this.f138764g);
        if (i13 < 0 || i13 >= this.f138761d.length) {
            throw new DateTimeException("Invalid Hijrah date, year: " + i10 + ", month: " + i11);
        }
        if (i12 < 1 || i12 > m0(i10, i11)) {
            throw new DateTimeException("Invalid Hijrah day of month: " + i12);
        }
        return (i12 - 1) + this.f138761d[i13];
    }

    public final int k0(int i10) {
        return (i10 + this.f138764g) / 12;
    }

    public final int m0(int i10, int i11) {
        int i12 = (i11 - 1) + ((i10 * 12) - this.f138764g);
        if (i12 >= 0) {
            int[] iArr = this.f138761d;
            if (i12 < iArr.length) {
    ...
    public final int[] j0(int i10, Map map) {
        int[] iArr = new int[3613];
        this.f138765h = a.e.API_PRIORITY_OTHER;
        this.f138766i = Integer.MIN_VALUE;
        int i11 = 0;
        for (int i12 = 1300; i12 <= 1600; i12++) {
            ...
            while (i13 < 12) {
                ...
                i10 += i14;
                this.f138765h = Math.min(this.f138765h, i14);
                this.f138766i = Math.max(this.f138766i, i14);
                i13++;
                i11 = i15;
            }
        }
