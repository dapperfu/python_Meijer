...
public abstract class AbstractC14782a implements Chronology {

    /* renamed from: a, reason: collision with root package name */
    public static final ConcurrentHashMap f138742a = new ConcurrentHashMap();

    /* renamed from: b, reason: collision with root package name */
    public static final ConcurrentHashMap f138743b = new ConcurrentHashMap();
    ...
    public static Chronology H(Chronology chronology, String str) {
        String strV;
        Chronology chronology2 = (Chronology) f138742a.putIfAbsent(str, chronology);
        if (chronology2 == null && (strV = chronology.v()) != null) {
            f138743b.putIfAbsent(strV, chronology);
        }
        return chronology2;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof AbstractC14782a) && compareTo((AbstractC14782a) obj) == 0;
    }
