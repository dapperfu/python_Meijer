...
public final class C extends AbstractC14782a implements Serializable {

    /* renamed from: c, reason: collision with root package name */
    public static final C f138738c = new C();
    ...
    public final j$.time.temporal.p F(ChronoField chronoField) {
        int i10 = B.f138737a[chronoField.ordinal()];
        if (i10 == 1) {
            j$.time.temporal.p pVar = ChronoField.PROLEPTIC_MONTH.f138926d;
            return j$.time.temporal.p.f(pVar.f138963a + 6516, pVar.f138966d + 6516);
        }
        if (i10 == 2) {
            j$.time.temporal.p pVar2 = ChronoField.YEAR.f138926d;
            return j$.time.temporal.p.g(1L, (-(pVar2.f138963a + 543)) + 1, pVar2.f138966d + 543);
        }
        if (i10 != 3) {
            return chronoField.f138926d;
        }
        j$.time.temporal.p pVar3 = ChronoField.YEAR.f138926d;
        return j$.time.temporal.p.f(pVar3.f138963a + 543, pVar3.f138966d + 543);
    }
