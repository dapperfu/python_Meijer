...
public interface ChronoZonedDateTime<D extends ChronoLocalDate> extends Temporal, Comparable<ChronoZonedDateTime<?>> {
    ...
    default int get(TemporalField temporalField) {
        if (temporalField instanceof ChronoField) {
            int i10 = g.f138753a[((ChronoField) temporalField).ordinal()];
            if (i10 == 1) {
    ...
    default Object d(TemporalQuery temporalQuery) {
        if (temporalQuery == j$.time.temporal.n.f138960e || temporalQuery == j$.time.temporal.n.f138956a) {
            return R();
        }
    ...
    default Instant toInstant() {
        return Instant.ofEpochSecond(h0(), toLocalTime().f138707d);
    }

    default long h0() {
        return ((l().S() * 86400) + toLocalTime().o0()) - m().f138727b;
    }
    ...
    default int compareTo(ChronoZonedDateTime chronoZonedDateTime) {
        ...
        return (iCompare == 0 && (iCompare = toLocalTime().f138707d - chronoZonedDateTime.toLocalTime().f138707d) == 0 && (iCompare = D().compareTo(chronoZonedDateTime.D())) == 0 && (iCompare = R().getId().compareTo(chronoZonedDateTime.R().getId())) == 0) ? g().compareTo(chronoZonedDateTime.g()) : iCompare;
    }
    ...
    default boolean isBefore(ChronoZonedDateTime<?> chronoZonedDateTime) {
        ...
        if (jH0 >= jH02) {
            return jH0 == jH02 && toLocalTime().f138707d < chronoZonedDateTime.toLocalTime().f138707d;
        }
        return true;
    }
