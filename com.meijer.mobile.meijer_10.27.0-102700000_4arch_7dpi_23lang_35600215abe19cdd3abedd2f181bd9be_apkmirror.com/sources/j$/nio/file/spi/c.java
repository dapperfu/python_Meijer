...
public abstract class c {
    ...
    public static final Set f138676a = g.p(new Object[]{E.CREATE, E.TRUNCATE_EXISTING, E.WRITE});

    public abstract void A(Path path, String str, Object obj, LinkOption... linkOptionArr);

    public abstract void a(Path path, EnumC14766a... enumC14766aArr);
    ...
    public abstract C14772d i(Path path);

    public abstract AbstractC14776h j(URI uri);
    ...
    public abstract AbstractC14776h u(URI uri, Map map);
    ...
    public AbstractC14776h t(Path path, Map map) {
