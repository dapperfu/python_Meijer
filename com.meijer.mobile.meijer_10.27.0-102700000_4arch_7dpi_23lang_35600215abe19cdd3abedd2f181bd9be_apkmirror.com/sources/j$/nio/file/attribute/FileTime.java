...
public final class FileTime implements Comparable<FileTime> {
    ...
    public final long f138619a;

    /* renamed from: b, reason: collision with root package name */
    public Instant f138620b;

    /* renamed from: c, reason: collision with root package name */
    public String f138621c;
    ...
    public long toMillis() {
        TimeUnit timeUnit = TimeUnit.MILLISECONDS;
        if (timeUnit != null) {
            return timeUnit.toMillis(this.f138619a);
        }
        long epochSecond = this.f138620b.getEpochSecond();
        int nano = this.f138620b.getNano();
    ...
    */
    public final j$.time.Instant toInstant() {
        /*
            r12 = this;
            j$.time.Instant r0 = r12.f138620b
            if (r0 != 0) goto La6
            int[] r0 = j$.nio.file.attribute.s.f138636a
        ...
        L91:
            ...
            int r3 = (r0 > r3 ? 1 : (r0 == r3 ? 0 : -1))
            if (r3 < 0) goto L9f
            j$.time.Instant r0 = j$.time.Instant.f138692d
            r12.f138620b = r0
            goto La6
        L9f:
            long r2 = (long) r2
    ...
    public final long Q(long j10) {
        TimeUnit timeUnit = TimeUnit.MILLISECONDS;
        if (timeUnit != null) {
            return timeUnit.toNanos(this.f138619a - timeUnit.convert(j10, TimeUnit.DAYS));
        }
    ...
    public final int compareTo(FileTime fileTime) {
        ...
        if (timeUnit != null) {
            fileTime.getClass();
            return Long.compare(this.f138619a, fileTime.f138619a);
        }
        ...
        if (timeUnit != null) {
            days = timeUnit.toDays(this.f138619a);
        } else {
            days = TimeUnit.SECONDS.toDays(toInstant().getEpochSecond());
        }
        if (timeUnit != null) {
            days2 = timeUnit.toDays(fileTime.f138619a);
        } else {
