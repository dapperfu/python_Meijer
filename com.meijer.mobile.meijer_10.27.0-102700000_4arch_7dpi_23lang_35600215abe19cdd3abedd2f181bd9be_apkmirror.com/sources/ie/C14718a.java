...
public class C14718a {
    ...
    public static int a(int i10, int i11) {
        return c.k(i10, (Color.alpha(i10) * i11) / l3.f92484c);
    }
    ...
    public static int c(Context context, int i10, String str) {
        return l(context, C16025b.e(context, i10, str));
    }

    public static int d(View view, int i10) {
        return l(view.getContext(), C16025b.f(view, i10));
    }
    ...
    public static Integer f(Context context, int i10) {
        TypedValue typedValueA = C16025b.a(context, i10);
        if (typedValueA != null) {
