...
import androidx.compose.ui.node.C5803c;
...
public final class f {
    ...
    private final D0.c<C5803c> inserted = new D0.c<>(new C5803c[16], 0);
    ...
    public final void e() {
        ...
        this.removed.k();
        this.removedLocal.k();
        D0.c<C5803c> cVar3 = this.inserted;
        C5803c[] c5803cArr = cVar3.content;
        int size2 = cVar3.getSize();
        for (int i11 = 0; i11 < size2; i11++) {
            C5803c c5803c = c5803cArr[i11];
            c<?> cVar4 = this.insertedLocal.content[i11];
            if (c5803c.getIsAttached()) {
                c(c5803c, cVar4, hashSet);
            }
        }
        this.inserted.k();
    ...
    private final void c(Modifier.c node, c<?> key, Set<C5803c> set) {
        int iA = C5810f0.a(32);
        ...
        if (child == null) {
            C5815k.c(cVar, node.getNode(), false);
        } else {
            cVar.c(child);
        }
                    ...
                    if ((child2.getKindSet() & iA) != 0) {
                        ...
                        while (abstractC5817mH != 0) {
                            if (abstractC5817mH instanceof h) {
                                ...
                                if (hVar instanceof C5803c) {
                                    C5803c c5803c = (C5803c) hVar;
                                    if ((c5803c.getElement() instanceof d) && c5803c.M2().contains(key)) {
                                        set.add(hVar);
                                    }
                                }
                                if (hVar.t0().a(key)) {
    ...
    public final void a(C5803c node, c<?> key) {
    ...
    public final void d(C5803c node, c<?> key) {
        this.removed.c(C5815k.o(node));
        this.removedLocal.c(key);
        b();
    }

    public final void f(C5803c node, c<?> key) {
        this.inserted.c(node);
        this.insertedLocal.c(key);
        b();
    }
