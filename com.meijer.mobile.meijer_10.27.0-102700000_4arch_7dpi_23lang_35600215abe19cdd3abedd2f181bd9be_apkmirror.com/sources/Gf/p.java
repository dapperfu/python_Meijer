...
class p {
    ...
    private static final f.a<Long> f11373b = F2.i.f("fire-global");

    /* renamed from: c, reason: collision with root package name */
    private static final f.a<Long> f11374c = F2.i.f("fire-count");

    /* renamed from: d, reason: collision with root package name */
    private static final f.a<String> f11375d = F2.i.g("last-used-date");

    /* renamed from: a, reason: collision with root package name */
    private final C18210b f11376a;

    private synchronized long e(F2.c cVar) {
        long j10;
        try {
            long jLongValue = ((Long) C18211c.a(cVar, f11374c, 0L)).longValue();
            String name = "";
            ...
            j10 = jLongValue - 1;
            cVar.i(f11374c, Long.valueOf(j10));
        } catch (Throwable th2) {
            throw th2;
        }
        return j10;
    ...
    private synchronized void l(F2.c cVar, String str) {
        try {
            ...
            HashSet hashSet = new HashSet((Collection) C18211c.a(cVar, aVarI, new HashSet()));
            hashSet.remove(str);
            if (hashSet.isEmpty()) {
                cVar.h(aVarI);
            } else {
    ...
    private synchronized void q(F2.c cVar, f.a<Set<String>> aVar, String str) {
        l(cVar, str);
        HashSet hashSet = new HashSet((Collection) C18211c.a(cVar, aVar, new HashSet()));
        hashSet.add(str);
        cVar.i(aVar, hashSet);
    }

    synchronized void f() {
        this.f11376a.e(new Function1() { // from class: Gf.n
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return p.c(this.f11371a, (F2.c) obj);
            }
        });
    }
    ...
    synchronized List<q> g() {
        ...
        try {
            ...
            for (Map.Entry<f.a<?>, Object> entry : this.f11376a.f().entrySet()) {
                if (entry.getValue() instanceof Set) {
    ...
    synchronized void k() {
        ...
        this.f11376a.e(new Function1() { // from class: Gf.m
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return p.d(this.f11369a, strH, (F2.c) obj);
            }
        });
    }

    synchronized boolean m(long j10) {
        return n(f11373b, j10);
    }

    synchronized boolean n(f.a<Long> aVar, long j10) {
        if (j(((Long) this.f11376a.h(aVar, -1L)).longValue(), j10)) {
            return false;
        }
        this.f11376a.i(aVar, Long.valueOf(j10));
        return true;
    }
    ...
    synchronized void o(long j10, final String str) {
        ...
        this.f11376a.e(new Function1() { // from class: Gf.l
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return p.b(this.f11365a, strH, str, aVarH, (F2.c) obj);
            }
        });
    }

    synchronized void p(final long j10) {
        this.f11376a.e(new Function1() { // from class: Gf.o
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    public static /* synthetic */ Unit a(long j10, F2.c cVar) {
        cVar.i(f11373b, Long.valueOf(j10));
        return null;
    }

    public p(Context context, String str) {
        this.f11376a = new C18210b(context, "FirebaseHeartBeat" + str);
    }

    public static /* synthetic */ Unit b(p pVar, String str, String str2, f.a aVar, F2.c cVar) {
        pVar.getClass();
        f.a<String> aVar2 = f11375d;
        if (((String) C18211c.a(cVar, aVar2, "")).equals(str)) {
        ...
        f.a<Long> aVar3 = f11374c;
        long jLongValue = ((Long) C18211c.a(cVar, aVar3, 0L)).longValue();
        if (jLongValue + 1 == 30) {
