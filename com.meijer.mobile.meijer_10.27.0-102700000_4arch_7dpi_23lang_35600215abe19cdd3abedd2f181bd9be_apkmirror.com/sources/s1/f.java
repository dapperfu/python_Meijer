...
public final class f {
    public static final d a(InterfaceC5814j interfaceC5814j, long j10, long j11, long j12, long j13, float[] fArr) {
        NodeCoordinator nodeCoordinatorJ = C5815k.j(interfaceC5814j, C5810f0.a(2));
        LayoutNode layoutNodeO = C5815k.o(interfaceC5814j);
        if (!layoutNodeO.f()) {
            return null;
        }
        if (layoutNodeO.getOuterCoordinator$ui_release() == nodeCoordinatorJ) {
            return new d(j10, j11, j12, j13, fArr, interfaceC5814j, null);
        }
        long jF = n.f(j10);
        float fK = n.k(jF);
        float fL = n.l(jF);
        ...
        return new d(o.d(layoutNodeO.getOuterCoordinator$ui_release().q1().J(nodeCoordinatorJ, jE)), n.f(((n.k(r0) + ((int) (jC >> 32))) << 32) | ((n.l(r0) + ((int) (jC & 4294967295L))) & 4294967295L)), j12, j13, fArr, interfaceC5814j, null);
    }
}
