...
@Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u000b\b\u0000\u0018\u0000 \u000b2\u00020\u0001:\u0001\u000eB\u0017\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0006\u0010\u0007J\u0019\u0010\u000b\u001a\u0004\u0018\u00010\n2\u0006\u0010\t\u001a\u00020\bH\u0002¢\u0006\u0004\b\u000b\u0010\fJ\u0019\u0010\r\u001a\u0004\u0018\u00010\n2\u0006\u0010\t\u001a\u00020\bH\u0002¢\u0006\u0004\b\r\u0010\fJ\u001a\u0010\u000e\u001a\u0004\u0018\u00010\n2\u0006\u0010\t\u001a\u00020\bH\u0096\u0002¢\u0006\u0004\b\u000e\u0010\fR\u0017\u0010\u0003\u001a\u00020\u00028\u0006¢\u0006\f\n\u0004\b\u000e\u0010\u000f\u001a\u0004\b\u0010\u0010\u0011R\u0017\u0010\u0005\u001a\u00020\u00048\u0006¢\u0006\f\n\u0004\b\r\u0010\u0012\u001a\u0004\b\u0013\u0010\u0014¨\u0006\u0015"}, d2 = {"LM5/l;", "LP5/x;", "Lcom/adobe/marketing/mobile/h;", "event", "Lcom/adobe/marketing/mobile/m;", "extensionApi", "<init>", "(Lcom/adobe/marketing/mobile/h;Lcom/adobe/marketing/mobile/m;)V", "", "key", "", "c", "(Ljava/lang/String;)Ljava/lang/Object;", "b", "a", "Lcom/adobe/marketing/mobile/h;", "getEvent", "()Lcom/adobe/marketing/mobile/h;", "Lcom/adobe/marketing/mobile/m;", "getExtensionApi", "()Lcom/adobe/marketing/mobile/m;", "core_phoneRelease"}, k = 1, mv = {1, 5, 1}, xi = 48)
/* loaded from: classes4.dex */
public final class l implements x {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final C6449h event;
    ...
    private final Object c(String key) {
        ...
        if (StringsKt.r0(strSubstring) || !StringsKt.c0(strSubstring, q2.f92724c, false, 2, null)) {
            return null;
        }
        List listA1 = StringsKt.a1(strSubstring, new String[]{q2.f92724c}, false, 0, 6, null);
        String str = (String) listA1.get(0);
        String str2 = (String) listA1.get(1);
        H hE = this.extensionApi.e(str, this.event, false, F.ANY);
        Map mapB2 = (hE == null || (mapB = hE.b()) == null) ? null : L5.j.b(mapB, null, false, 3, null);
        if (mapB2 == null || mapB2.isEmpty() || StringsKt.r0(str2) || !mapB2.containsKey(str2)) {
            return null;
        }
        return mapB2.get(str2);
    }

    public l(C6449h event, AbstractC6454m extensionApi) {
    ...
    private final Object b(String key) {
        ...
        return L5.j.b(mapO, null, false, 3, null).get(key);
    }
    ...
    public Object a(String key) {
        ...
        String string = StringsKt.y1(key).toString();
        switch (string.hashCode()) {
            case -1368656616:
                if (string.equals("~timestampp")) {
                    return f6.j.f(null, 1, null);
                }
                break;
            case -1368656611:
                if (string.equals("~timestampu")) {
                    return String.valueOf(f6.j.h());
                }
                break;
            case -1368656606:
                if (string.equals("~timestampz")) {
                    return f6.j.d(null, 1, null);
                }
                break;
            case -750644441:
            ...
            case -361051245:
                if (string.equals("~all_url")) {
                    if (this.event.o() != null) {
                        Map<String, Object> mapO = this.event.o();
                        Intrinsics.i(mapO, "event.eventData");
                        return L5.j.i(L5.j.b(mapO, null, false, 1, null));
                    }
