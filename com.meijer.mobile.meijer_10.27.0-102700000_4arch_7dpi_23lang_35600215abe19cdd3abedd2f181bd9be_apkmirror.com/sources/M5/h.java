...
@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\bÀ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0017\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\u0007\u0010\bJ\u0017\u0010\t\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\t\u0010\bJ\r\u0010\u000b\u001a\u00020\n¢\u0006\u0004\b\u000b\u0010\f¨\u0006\r"}, d2 = {"LM5/h;", "", "<init>", "()V", "LP5/y;", "transformer", "", "f", "(LP5/y;)V", "h", "LP5/A;", "m", "()LP5/A;", "core_phoneRelease"}, k = 1, mv = {1, 5, 1}, xi = 48)
/* loaded from: classes4.dex */
public final class h {

    /* renamed from: a, reason: collision with root package name */
    public static final h f19014a = new h();

    private final void f(y transformer) {
        transformer.b("urlenc", new z() { // from class: M5.g
            @Override // P5.z
    ...
    private final void h(y transformer) {
        transformer.b("int", new z() { // from class: M5.c
            @Override // P5.z
            public final Object a(Object obj) {
                return h.i(obj);
            }
        });
        transformer.b("string", new z() { // from class: M5.d
            @Override // P5.z
            public final Object a(Object obj) {
                return h.j(obj);
            }
        });
        transformer.b("double", new z() { // from class: M5.e
            @Override // P5.z
            public final Object a(Object obj) {
                return h.k(obj);
            }
        });
        transformer.b("bool", new z() { // from class: M5.f
            @Override // P5.z
            public final Object a(Object obj) {
                return h.l(obj);
            }
