...
public final class l {
    ...
    static final class a implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f60698a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ List<ProductListDecorator> f60699b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ boolean f60700c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ boolean f60701d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ boolean f60702e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ EnumC14984a f60703f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ boolean f60704g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Function2<ProductFullDetails, String, Unit> f60705h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ Function3<Integer, EnumC14984a, Boolean, Unit> f60706i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ Function3<ProductFullDetails, com.meijer.mobile.core.design.widget.stepperview.a, EnumC14984a, Unit> f60707j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f60708k;

        /* renamed from: l, reason: collision with root package name */
        final /* synthetic */ Function2<Ok.c, EnumC14984a, Unit> f60709l;

        /* renamed from: m, reason: collision with root package name */
        final /* synthetic */ Function1<AbstractC13947a, Unit> f60710m;

        /* renamed from: n, reason: collision with root package name */
        final /* synthetic */ String f60711n;

        /* renamed from: o, reason: collision with root package name */
        final /* synthetic */ String f60712o;

        /* renamed from: p, reason: collision with root package name */
        final /* synthetic */ InterfaceC5730l0<Boolean> f60713p;

        /* renamed from: q, reason: collision with root package name */
        final /* synthetic */ InterfaceC5730l0<Boolean> f60714q;

        /* renamed from: r, reason: collision with root package name */
        final /* synthetic */ InterfaceC5730l0<Boolean> f60715r;

        /* renamed from: s, reason: collision with root package name */
        final /* synthetic */ InterfaceC5730l0<Boolean> f60716s;

        /* JADX WARN: Multi-variable type inference failed */
        a(LocalThemeScope localThemeScope, List<ProductListDecorator> list, boolean z10, boolean z11, boolean z12, EnumC14984a enumC14984a, boolean z13, Function2<? super ProductFullDetails, ? super String, Unit> function2, Function3<? super Integer, ? super EnumC14984a, ? super Boolean, Unit> function3, Function3<? super ProductFullDetails, ? super com.meijer.mobile.core.design.widget.stepperview.a, ? super EnumC14984a, Unit> function32, Function0<Unit> function0, Function2<? super Ok.c, ? super EnumC14984a, Unit> function22, Function1<? super AbstractC13947a, Unit> function1, String str, String str2, InterfaceC5730l0<Boolean> interfaceC5730l0, InterfaceC5730l0<Boolean> interfaceC5730l02, InterfaceC5730l0<Boolean> interfaceC5730l03, InterfaceC5730l0<Boolean> interfaceC5730l04) {
            this.f60698a = localThemeScope;
            this.f60699b = list;
            this.f60700c = z10;
            this.f60701d = z11;
            this.f60702e = z12;
            this.f60703f = enumC14984a;
            this.f60704g = z13;
            this.f60705h = function2;
            this.f60706i = function3;
            this.f60707j = function32;
            this.f60708k = function0;
            this.f60709l = function22;
            this.f60710m = function1;
            this.f60711n = str;
            this.f60712o = str2;
            this.f60713p = interfaceC5730l0;
            this.f60714q = interfaceC5730l02;
            this.f60715r = interfaceC5730l03;
            this.f60716s = interfaceC5730l04;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Unit e(Function3 function3, EnumC14984a enumC14984a, Function3 function32, int i10, ProductFullDetails productFullDetails, com.meijer.mobile.core.design.widget.stepperview.a controlState) {
            Intrinsics.j(productFullDetails, "productFullDetails");
            Intrinsics.j(controlState, "controlState");
            if (function3 != null) {
                function3.invoke(Integer.valueOf(i10 + 1), enumC14984a, Boolean.valueOf(productFullDetails.getIsSponsoredCriteo()));
            }
            function32.invoke(productFullDetails, controlState, enumC14984a);
            return Unit.f142422a;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Unit f(Function1 function1, List list, EnumC14984a enumC14984a, SponsoredData criteoSponsoredData) {
            Object next;
            ...
            function1.invoke(new AbstractC13947a.OnViewBeacon(listG, productListDecorator != null ? productListDecorator.getProduct() : null, false, enumC14984a));
            return Unit.f142422a;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Unit g(Function1 function1, List list, EnumC14984a enumC14984a, SponsoredData criteoSponsoredData) {
            Object next;
            Intrinsics.j(criteoSponsoredData, "criteoSponsoredData");
            ...
            ProductListDecorator productListDecorator = (ProductListDecorator) next;
            function1.invoke(new AbstractC13947a.OnLoadBeacon(onLoadBeacon, productListDecorator != null ? productListDecorator.getProduct() : null, false, enumC14984a));
            return Unit.f142422a;
        }
    ...
    static final class b extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: n, reason: collision with root package name */
        final /* synthetic */ List<EnumC14984a> f60730n;

        /* renamed from: o, reason: collision with root package name */
        final /* synthetic */ boolean f60731o;

        /* renamed from: p, reason: collision with root package name */
        final /* synthetic */ List<InterfaceC17607c> f60732p;

        /* renamed from: q, reason: collision with root package name */
        final /* synthetic */ boolean f60733q;

        /* renamed from: r, reason: collision with root package name */
        final /* synthetic */ String f60734r;

        /* renamed from: s, reason: collision with root package name */
        final /* synthetic */ Function1<AbstractC13947a, Unit> f60735s;

        /* renamed from: t, reason: collision with root package name */
        final /* synthetic */ String f60736t;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        b(List<? extends EnumC14984a> list, boolean z10, List<? extends InterfaceC17607c> list2, boolean z11, String str, Function1<? super AbstractC13947a, Unit> function1, String str2, Continuation<? super b> continuation) {
            ...
            this.f60733q = z11;
            this.f60734r = str;
            this.f60735s = function1;
            this.f60736t = str2;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new b(this.f60730n, this.f60731o, this.f60732p, this.f60733q, this.f60734r, this.f60735s, this.f60736t, continuation);
        }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void d(final Ji.LocalThemeScope r38, final java.util.List<vs.ProductListDecorator> r39, final boolean r40, final ak.AbstractC5607a r41, final Oj.a r42, final jk.EnumC14984a r43, final boolean r44, final boolean r45, androidx.compose.ui.Modifier r46, boolean r47, java.lang.String r48, java.lang.Integer r49, java.lang.String r50, java.lang.String r51, final kotlin.jvm.functions.Function0<kotlin.Unit> r52, final kotlin.jvm.functions.Function0<kotlin.Unit> r53, final kotlin.jvm.functions.Function2<? super Co.ProductFullDetails, ? super java.lang.String, kotlin.Unit> r54, final kotlin.jvm.functions.Function3<? super Co.ProductFullDetails, ? super com.meijer.mobile.core.design.widget.stepperview.a, ? super jk.EnumC14984a, kotlin.Unit> r55, final kotlin.jvm.functions.Function2<? super Ok.c, ? super jk.EnumC14984a, kotlin.Unit> r56, final kotlin.jvm.functions.Function1<? super fs.AbstractC13947a, kotlin.Unit> r57, kotlin.jvm.functions.Function0<kotlin.Unit> r58, kotlin.jvm.functions.Function3<? super java.lang.Integer, ? super jk.EnumC14984a, ? super java.lang.Boolean, kotlin.Unit> r59, androidx.compose.runtime.Composer r60, final int r61, final int r62, final int r63, final int r64) {
        /*
            Method dump skipped, instructions count: 1402
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: bs.l.d(Ji.M, java.util.List, boolean, ak.a, Oj.a, jk.a, boolean, boolean, androidx.compose.ui.Modifier, boolean, java.lang.String, java.lang.Integer, java.lang.String, java.lang.String, kotlin.jvm.functions.Function0, kotlin.jvm.functions.Function0, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function3, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function1, kotlin.jvm.functions.Function0, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit i(LocalThemeScope localThemeScope, List list, boolean z10, AbstractC5607a abstractC5607a, Oj.a aVar, EnumC14984a enumC14984a, boolean z11, boolean z12, Modifier modifier, boolean z13, String str, Integer num, String str2, String str3, Function0 function0, Function0 function02, Function2 function2, Function3 function3, Function2 function22, Function1 function1, Function0 function03, Function3 function32, int i10, int i11, int i12, int i13, Composer composer, int i14) {
        d(localThemeScope, list, z10, abstractC5607a, aVar, enumC14984a, z11, z12, modifier, z13, str, num, str2, str3, function0, function02, function2, function3, function22, function1, function03, function32, composer, J0.a(i10 | 1), J0.a(i11), J0.a(i12), i13);
        return Unit.f142422a;
    }

    static {
        mk.b bVarE = Co.l.e("USD", null, 3.79d, "$3.79", 0.0d, null);
        f60696a = bVarE;
        ...
        f60697b = new ProductListDecorator("id_1", false, "2772918", "Cinnamon Chex", false, null, null, null, null, null, false, false, false, companion.c("$3.79"), companion.c("$3.79"), null, null, companion.c("2"), null, false, 0, null, productFullDetails, null, null, null, false, false, null, null, null, null, false, false, null, null, false, 0, null, false, null, -4349968, 511, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit h(float f10, EnumC14984a enumC14984a, InterfaceC5730l0 interfaceC5730l0, InterfaceC5730l0 interfaceC5730l02, InterfaceC5730l0 interfaceC5730l03, InterfaceC5730l0 interfaceC5730l04, LayoutCoordinates coordinates) {
        Intrinsics.j(coordinates, "coordinates");
        Pair<Boolean, Boolean> pairV = v(coordinates, f10, enumC14984a, EnumC14984a.f140312a);
        boolean zBooleanValue = pairV.a().booleanValue();
        boolean zBooleanValue2 = pairV.b().booleanValue();
        Pair<Boolean, Boolean> pairV2 = v(coordinates, f10, enumC14984a, EnumC14984a.f140313b);
        boolean zBooleanValue3 = pairV2.a().booleanValue();
        boolean zBooleanValue4 = pairV2.b().booleanValue();
        j(interfaceC5730l0, zBooleanValue);
        l(interfaceC5730l02, zBooleanValue2);
        n(interfaceC5730l03, zBooleanValue3);
        g(interfaceC5730l04, zBooleanValue4);
        return Unit.f142422a;
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void o(final java.util.List<? extends vs.InterfaceC17607c> r22, boolean r23, boolean r24, boolean r25, boolean r26, java.lang.String r27, java.lang.String r28, final kotlin.jvm.functions.Function1<? super fs.AbstractC13947a, kotlin.Unit> r29, final java.util.List<? extends jk.EnumC14984a> r30, androidx.compose.runtime.Composer r31, final int r32, final int r33) {
        /*
    ...
    private static final void j(InterfaceC5730l0<Boolean> interfaceC5730l0, boolean z10) {
        interfaceC5730l0.setValue(Boolean.valueOf(z10));
    }
    ...
    private static final Pair<Boolean, Boolean> v(LayoutCoordinates layoutCoordinates, float f10, EnumC14984a enumC14984a, EnumC14984a enumC14984a2) {
        boolean z10;
        long jF = LayoutCoordinatesKt.f(layoutCoordinates);
        int iC = (int) (layoutCoordinates.c() & 4294967295L);
        int i10 = (int) (jF & 4294967295L);
        boolean z11 = false;
        if (Float.intBitsToFloat(i10) >= 0.0f && Float.intBitsToFloat(i10) < f10 && (enumC14984a == EnumC14984a.f140312a || enumC14984a == EnumC14984a.f140313b)) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (Float.intBitsToFloat(i10) >= 0.0f && Float.intBitsToFloat(i10) < f10 && Float.intBitsToFloat(i10) + (iC / 2) < f10 && enumC14984a == enumC14984a2) {
            z11 = true;
        }
