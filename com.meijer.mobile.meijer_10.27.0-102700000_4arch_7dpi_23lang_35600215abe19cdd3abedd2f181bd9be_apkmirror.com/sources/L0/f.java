...
final class f implements L0.e {
    ...
    private static final k<f, ?> f17596f = l.a(a.f17601f, b.f17602f);
    ...
    static final class b extends Lambda implements Function1<Map<Object, Map<String, ? extends List<? extends Object>>>, f> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final b f17602f = new b();
    ...
    static final class d extends Lambda implements Function1<F, E> {
        ...
        final /* synthetic */ Object f17604g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ h f17605h;
        ...
        public static final class a implements E {
            ...
            public void dispose() {
                Object objU = this.f17606a.registries.u(this.f17607b);
                h hVar = this.f17608c;
                if (objU == hVar) {
                    f fVar = this.f17606a;
                    fVar.j(hVar, fVar.savedStates, this.f17607b);
                }
            }
        }
        ...
        public final E invoke(F f10) {
            boolean zB = f.this.registries.b(this.f17604g);
            Object obj = this.f17604g;
            if (!zB) {
                f.this.savedStates.remove(this.f17604g);
                f.this.registries.x(this.f17604g, this.f17605h);
                return new a(f.this, this.f17604g, this.f17605h);
            }
    ...
    static final class a extends Lambda implements Function2<m, f, Map<Object, Map<String, ? extends List<? extends Object>>>> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final a f17601f = new a();
    ...
    */
    ...
    public void d(Object obj, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i10) {
        ...
        h hVar = (h) objB;
        r.a(j.e().d(hVar), function2, composer, (i10 & 112) | G0.f49976i);
