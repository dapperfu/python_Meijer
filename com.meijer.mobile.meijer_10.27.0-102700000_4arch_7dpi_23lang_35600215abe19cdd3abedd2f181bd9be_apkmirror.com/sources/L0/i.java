...
final class i implements h {
    ...
    public static final class a implements h.a {
        ...
        final /* synthetic */ W<String, List<Function0<Object>>> f17614a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ String f17615b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Function0<Object> f17616c;
        ...
        public void unregister() {
            List<Function0<Object>> listU = this.f17614a.u(this.f17615b);
            if (listU != null) {
                listU.remove(this.f17616c);
            }
            List<Function0<Object>> list = listU;
            if (list == null || list.isEmpty()) {
                return;
            }
            this.f17614a.x(this.f17615b, listU);
        }
    }
