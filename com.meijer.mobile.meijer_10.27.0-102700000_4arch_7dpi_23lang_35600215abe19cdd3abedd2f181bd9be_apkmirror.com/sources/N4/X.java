...
public final class X {
    ...
    public static final <T> com.google.common.util.concurrent.q<T> e(final Executor executor, final Function0<? extends T> function0) {
        com.google.common.util.concurrent.q<T> qVarA = androidx.concurrent.futures.c.a(new c.InterfaceC1088c() { // from class: N4.U
    ...
    public static final Unit f(Executor executor, final Function0 function0, final c.a it) {
        ...
        it.a(new Runnable() { // from class: N4.V
            @Override // java.lang.Runnable
            public final void run() {
                X.g(atomicBoolean);
            }
        }, EnumC4319g.INSTANCE);
        executor.execute(new Runnable() { // from class: N4.W
            @Override // java.lang.Runnable
            public final void run() {
