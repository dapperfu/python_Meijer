...
public final /* data */ class SettingsPreferences implements Cs.c {
    ...
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u001b\u0010\b\u001a\u00020\u00072\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\u0004\b\b\u0010\t¨\u0006\n"}, d2 = {"LDh/y$a;", "", "<init>", "()V", "", "LDh/k;", "preferenceList", "LDh/y;", "a", "(Ljava/util/List;)LDh/y;", "service_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    @SourceDebugExtension
    /* renamed from: Dh.y$a, reason: from kotlin metadata */
    public static final class Companion {
        ...
        public final SettingsPreferences a(List<CustomerPreference> preferenceList) {
            ...
            SettingsPreferences settingsPreferences = new SettingsPreferences(false, false, null, null, false, false, false, false, l3.f92484c, null);
            for (CustomerPreference customerPreference : preferenceList) {
                ...
                if (Intrinsics.e(preferenceTypeName, r.f6567c.getPreferenceTypeName())) {
                    settingsPreferences.e(Boolean.parseBoolean(customerPreference.getPreferenceValue()));
                } else if (Intrinsics.e(preferenceTypeName, r.f6570f.getPreferenceTypeName())) {
                    settingsPreferences.f(Boolean.parseBoolean(customerPreference.getPreferenceValue()));
                } else if (Intrinsics.e(preferenceTypeName, r.f6568d.getPreferenceTypeName())) {
                    settingsPreferences.g(customerPreference.getPreferenceValue());
                } else if (Intrinsics.e(preferenceTypeName, r.f6569e.getPreferenceTypeName())) {
    ...
    public SettingsPreferences() {
        this(false, false, null, null, false, false, false, false, l3.f92484c, null);
    }
