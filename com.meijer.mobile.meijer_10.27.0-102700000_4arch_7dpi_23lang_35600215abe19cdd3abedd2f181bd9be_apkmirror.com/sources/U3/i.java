...
public class i {
    ...
    */
    public static void c(U3.k r11, U3.r.b r12, d3.InterfaceC13477l<U3.e> r13) {
        /*
            long r0 = r12.f35730a
            int r0 = a(r11, r0)
            long r1 = r12.f35730a
    ...
    private static void b(k kVar, int i10, InterfaceC13477l<e> interfaceC13477l) {
        long jE = kVar.e(i10);
        List<C6350a> listB = kVar.b(jE);
        if (!listB.isEmpty()) {
            if (i10 != kVar.l() - 1) {
                long jE2 = kVar.e(i10 + 1) - kVar.e(i10);
                if (jE2 > 0) {
                    interfaceC13477l.accept(new e(listB, jE, jE2));
                    return;
                }
                return;
            }
