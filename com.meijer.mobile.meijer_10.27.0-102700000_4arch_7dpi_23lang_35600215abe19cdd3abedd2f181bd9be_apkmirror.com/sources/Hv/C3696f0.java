...
@Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0011\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\u001a!\u0010\u0004\u001a\u00020\u0003*\u00020\u00002\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00000\u0001H\u0000¢\u0006\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"LFv/f;", "", "typeParams", "", "a", "(LFv/f;[LFv/f;)I", "kotlinx-serialization-core"}, k = 2, mv = {2, 0, 0}, xi = 48)
@SourceDebugExtension
/* renamed from: Hv.f0, reason: case insensitive filesystem */
/* loaded from: classes13.dex */
public final class C3696f0 {
    public static final int a(Fv.f fVar, Fv.f[] typeParams) {
        ...
        Iterable<Fv.f> iterableA = Fv.j.a(fVar);
        Iterator<Fv.f> it = iterableA.iterator();
        int iHashCode2 = 1;
        int i10 = 1;
        while (true) {
            int iHashCode3 = 0;
        ...
        Iterator<Fv.f> it2 = iterableA.iterator();
        while (it2.hasNext()) {
            int i12 = iHashCode2 * 31;
            Fv.m mVarF = it2.next().f();
