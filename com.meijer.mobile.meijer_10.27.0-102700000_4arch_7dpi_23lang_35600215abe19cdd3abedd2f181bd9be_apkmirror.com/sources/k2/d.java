...
class d {
    ...
    private static final LruCache<c, ProviderInfo> f141164a = new LruCache<>(2);

    /* renamed from: b, reason: collision with root package name */
    private static final Comparator<byte[]> f141165b = new Comparator() { // from class: k2.c
    ...
    private static class b implements a {
        ...
        b(Context context, Uri uri) {
            this.f141166a = context.getContentResolver().acquireUnstableContentProviderClient(uri);
        }
    }
    ...
    private static class c {
        ...
        public boolean equals(Object obj) {
            ...
            c cVar = (c) obj;
            return Objects.equals(this.f141167a, cVar.f141167a) && Objects.equals(this.f141168b, cVar.f141168b) && Objects.equals(this.f141169c, cVar.f141169c);
        }

        public int hashCode() {
            return Objects.hash(this.f141167a, this.f141168b, this.f141169c);
        }
    ...
    static g.a e(Context context, List<e> list, CancellationSignal cancellationSignal) throws PackageManager.NameNotFoundException {
        G4.a.c("FontProvider.getFontFamilyResult");
        try {
            ArrayList arrayList = new ArrayList();
    ...
    static ProviderInfo f(PackageManager packageManager, e eVar, Resources resources) throws PackageManager.NameNotFoundException {
        G4.a.c("FontProvider.getProvider");
        try {
            List<List<byte[]>> listD = d(eVar, resources);
            c cVar = new c(eVar.e(), eVar.f(), listD);
            ProviderInfo providerInfoD = f141164a.d(cVar);
            ...
            Collections.sort(listB, f141165b);
            for (int i10 = 0; i10 < listD.size(); i10++) {
                ArrayList arrayList = new ArrayList(listD.get(i10));
                Collections.sort(arrayList, f141165b);
                if (c(listB, arrayList)) {
                    f141164a.f(cVar, providerInfoResolveContentProvider);
    ...
    */
    ...
    private static List<List<byte[]>> d(e eVar, Resources resources) {
        ...
        return C6184e.c(resources, eVar.c());
    }
}
