...
public final class d {
    ...
    static final class a implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ LocalThemeScope f11840b;

        a(boolean z10, LocalThemeScope localThemeScope) {
            this.f11839a = z10;
            this.f11840b = localThemeScope;
        }
        ...
        public final void a(Composer composer, int i10) {
            ...
            C17988z0.a(C16190d.c((this.f11839a ? C.j.t.f15595d : C.j.s.f15594d).getIo.constructor.data.local.PreferencesHelper.PREF_ID java.lang.String(), composer, 0), C16193g.c(this.f11839a ? Q.f170982Y : Q.f170981X, composer, 0), null, this.f11839a ? C5346q0.INSTANCE.j() : this.f11840b.getAdsColors().getAdsColorEnabled01().getColor(), composer, 0, 4);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final void b(final LocalThemeScope localThemeScope, final boolean z10, final Function1<? super Boolean, Unit> onCheckedChange, Modifier modifier, Composer composer, final int i10, final int i11) {
        ...
        if ((i12 & 1171) == 1170 && composerStartRestartGroup.j()) {
            ...
            modifier2 = modifier3;
            C17986y0.b(z10, onCheckedChange, modifier2, false, null, ComposableLambdaKt.c(-647518712, true, new a(z10, localThemeScope), composerStartRestartGroup, 54), composerStartRestartGroup, i15, 24);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
