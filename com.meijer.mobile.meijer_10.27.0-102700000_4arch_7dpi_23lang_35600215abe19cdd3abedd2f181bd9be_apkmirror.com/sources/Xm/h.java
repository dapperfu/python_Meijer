...
public final class h {
    public static final void c(final s.HeaderItem item, Composer composer, final int i10) {
        ...
        if ((i11 & 3) == 2 && composerStartRestartGroup.j()) {
            ...
            e(bk.d.a((Context) composerStartRestartGroup.o(AndroidCompositionLocals_androidKt.g()), item.getTextItem()), composerStartRestartGroup, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
        ...
        if (t0L != null) {
            t0L.a(new Function2() { // from class: Xm.f
    ...
    public static final void e(final String text, Composer composer, final int i10) {
        ...
        if ((i11 & 3) == 2 && composerStartRestartGroup.j()) {
            ...
            composer2 = composerStartRestartGroup;
            N1.b(text, D.i(companion, H1.h.p(16)), 0L, 0L, null, FontWeight.INSTANCE.f(), null, 0L, null, null, 0L, 0, false, 0, 0, null, C17877E0.f166879a.c(composerStartRestartGroup, C17877E0.f166880b).getH6(), composer2, (i11 & 14) | 196656, 0, 65500);
            composer2.v();
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
