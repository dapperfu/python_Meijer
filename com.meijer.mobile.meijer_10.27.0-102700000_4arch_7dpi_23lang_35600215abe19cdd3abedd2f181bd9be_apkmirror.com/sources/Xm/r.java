...
import j0.C14801J;
import kotlin.C17870B;
import kotlin.C17872C;
...
public final class r {
    ...
    static final class a implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ Number f39510b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ boolean f39511c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Function1<Boolean, Unit> f39512d;
        ...
        public final void a(Composer composer, int i10) {
            ...
            String str = this.f39509a + " (" + this.f39510b + ')';
            ...
            Function1<Boolean, Unit> function1 = this.f39512d;
            ...
            C17872C.a(z10, function1, D.i(companion, H1.h.p(f10)), false, null, C17870B.f166725a.a(c17877e0.a(composer, i11).j(), 0L, 0L, 0L, 0L, composer, C17870B.f166726b << 15, 30), composer, 384, 24);
            composer.v();
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
    ...
    public static final void e(final com.meijer.mobile.meijer.activity.find.filter.o filterViewModel, final s.SimpleFilterItem item, Composer composer, final int i10) {
        ...
        if ((i11 & 19) == 18 && composerStartRestartGroup.j()) {
            ...
            if (zD || objB == Composer.INSTANCE.a()) {
                objB = new Function1() { // from class: Xm.n
        ...
        if (t0L != null) {
            t0L.a(new Function2() { // from class: Xm.o
                @Override // kotlin.jvm.functions.Function2
    ...
    public static final void h(final Function1<? super Boolean, Unit> onClick, final String text, final boolean z10, final Number quantity, Composer composer, final int i10) {
        ...
        if ((i11 & 1171) == 1170 && composerStartRestartGroup.j()) {
            ...
            if (z11 || objB == Composer.INSTANCE.a()) {
                objB = new Function0() { // from class: Xm.p
        ...
        T0 t0L = composerStartRestartGroup.l();
        if (t0L != null) {
            t0L.a(new Function2() { // from class: Xm.q
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
