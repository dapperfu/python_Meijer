...
public final class c<T> implements RandomAccess {
    ...
    public static final int f4990d = 8;
    ...
    private static final class C0091c<T> implements ListIterator<T>, KMutableListIterator {
        ...
        public C0091c(List<T> list, int i10) {
            this.list = list;
            this.index = i10;
        }
    }
