...
public final class C13831d {
    ...
    static final class a<T> extends Lambda implements Function1<T, Boolean> {
        ...
        final /* synthetic */ Ref.ObjectRef<T> f130616f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(Ref.ObjectRef<T> objectRef) {
            super(1);
            this.f130616f = objectRef;
        }
    ...
    public static final <T extends B0> T b(T t10) {
        ...
        return (T) objectRef.f142835a;
    }

    public static final InterfaceC5814j c(InterfaceC13828a interfaceC13828a, C13829b c13829b) {
        return new C13830c(interfaceC13828a, c13829b);
    }
}
