...
final class c extends ConnectivityManager.NetworkCallback {
    ...
    public static final class Companion {
        ...
        static final class C0717a extends Lambda implements Function0<Unit> {

            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ Ref.BooleanRef f31864f;

            /* renamed from: g, reason: collision with root package name */
            final /* synthetic */ ConnectivityManager f31865g;

            /* renamed from: h, reason: collision with root package name */
            final /* synthetic */ c f31866h;
            ...
            C0717a(Ref.BooleanRef booleanRef, ConnectivityManager connectivityManager, c cVar) {
                super(0);
                this.f31864f = booleanRef;
                this.f31865g = connectivityManager;
                this.f31866h = cVar;
            }

            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2() {
                if (this.f31864f.f142828a) {
                    AbstractC4333v.e().a(j.f31896a, "NetworkRequestConstraintController unregister callback");
                    this.f31865g.unregisterNetworkCallback(this.f31866h);
                }
            }
        }
        ...
        public final Function0<Unit> a(ConnectivityManager connManager, NetworkRequest networkRequest, Function1<? super b, Unit> onConstraintState) {
            ...
            try {
                AbstractC4333v.e().a(j.f31896a, "NetworkRequestConstraintController register callback");
                ...
                AbstractC4333v.e().b(j.f31896a, "NetworkRequestConstraintController couldn't register callback", e10);
                onConstraintState.invoke(new b.ConstraintsNotMet(7));
            }
            return new C0717a(booleanRef, connManager, cVar);
        }
    }
    ...
    public void onCapabilitiesChanged(Network network, NetworkCapabilities networkCapabilities) {
        ...
        this.onConstraintState.invoke(b.a.f31860a);
    }
