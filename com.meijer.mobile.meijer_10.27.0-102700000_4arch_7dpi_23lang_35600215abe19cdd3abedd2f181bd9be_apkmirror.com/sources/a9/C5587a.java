...
@Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0010\u000e\n\u0002\b\u000b\b\u0017\u0018\u00002\u00020\u0001B'\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0005\u001a\u00020\u0004\u0012\u000e\u0010\b\u001a\n\u0012\u0004\u0012\u00020\u0007\u0018\u00010\u0006¢\u0006\u0004\b\t\u0010\nJ\u0011\u0010\u000b\u001a\u0004\u0018\u00010\u0007H\u0016¢\u0006\u0004\b\u000b\u0010\fR\u0014\u0010\u0003\u001a\u00020\u00028\u0012X\u0092\u0004¢\u0006\u0006\n\u0004\b\u000b\u0010\rR\u0014\u0010\u0005\u001a\u00020\u00048\u0012X\u0092\u0004¢\u0006\u0006\n\u0004\b\u000e\u0010\u000fR\u001c\u0010\b\u001a\n\u0012\u0004\u0012\u00020\u0007\u0018\u00010\u00068\u0012X\u0092\u0004¢\u0006\u0006\n\u0004\b\u0010\u0010\u0011¨\u0006\u0012"}, d2 = {"La9/a;", "", "LZ8/a;", "emarsysContentResolver", "Lb9/a;", "crypto", "", "", "sharedPackageNames", "<init>", "(LZ8/a;Lb9/a;Ljava/util/List;)V", "a", "()Ljava/lang/String;", "LZ8/a;", "b", "Lb9/a;", "c", "Ljava/util/List;", "core_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* renamed from: a9.a, reason: case insensitive filesystem */
/* loaded from: classes4.dex */
public class C5587a {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final Z8.a emarsysContentResolver;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final C6212a crypto;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private final List<String> sharedPackageNames;

    public C5587a(Z8.a emarsysContentResolver, C6212a crypto, List<String> list) {
    ...
    public String a() {
        ...
        for (int i10 = 0; string == null && i10 < this.sharedPackageNames.size(); i10++) {
            Cursor cursorA = this.emarsysContentResolver.a(b.f61662a.a(this.sharedPackageNames.get(i10)), new String[]{"encrypted_hardware_id", "salt", "iv"}, null, null, null);
            if (cursorA != null && cursorA.moveToFirst()) {
                ...
                C6212a c6212a = this.crypto;
                Intrinsics.g(string);
                Intrinsics.g(string2);
                Intrinsics.g(string3);
                strA = c6212a.a(string, string2, string3);
                cursorA.close();
            }
        }
        return strA;
