...
public class C18457c {

    /* renamed from: a, reason: collision with root package name */
    private static final C18457c f171829a = new C18457c();

    public static C18457c c() {
        return f171829a;
    }

    public ByteBuffer b(C18212a c18212a, boolean z10) throws MlKitException {
        int iE = c18212a.e();
        if (iE != -1) {
            if (iE == 17) {
                return z10 ? a((ByteBuffer) r.l(c18212a.c())) : (ByteBuffer) r.l(c18212a.c());
            }
            if (iE == 35) {
                return d((Image.Plane[]) r.l(c18212a.h()), c18212a.j(), c18212a.f());
            }
            if (iE == 842094169) {
                return e((ByteBuffer) r.l(c18212a.c()), z10);
            }
            throw new MlKitException("Unsupported image format", 13);
        }
        Bitmap bitmapCopy = (Bitmap) r.l(c18212a.b());
        ...
        for (int i13 = 0; i13 < height; i13++) {
            ...
            while (i14 < width) {
                ...
                int i16 = i15 >> 16;
                int i17 = i15 >> 8;
                int i18 = i15 & l3.f92484c;
                int i19 = i11 + 1;
                int i20 = i16 & l3.f92484c;
                int i21 = i17 & l3.f92484c;
                byteBufferAllocate.put(i11, (byte) Math.min(l3.f92484c, (((((i20 * 66) + (i21 * 129)) + (i18 * 25)) + 128) >> 8) + 16));
                if (i13 % 2 == 0 && i12 % 2 == 0) {
                    int i22 = ((((i20 * 112) - (i21 * 94)) - (i18 * 18)) + 128) >> 8;
                    int i23 = (((((i20 * (-38)) - (i21 * 74)) + (i18 * 112)) + 128) >> 8) + 128;
                    int i24 = i10 + 1;
                    byteBufferAllocate.put(i10, (byte) Math.min(l3.f92484c, i22 + 128));
                    i10 += 2;
                    byteBufferAllocate.put(i24, (byte) Math.min(l3.f92484c, i23));
                }
                i12++;
                i14++;
                i11 = i19;
