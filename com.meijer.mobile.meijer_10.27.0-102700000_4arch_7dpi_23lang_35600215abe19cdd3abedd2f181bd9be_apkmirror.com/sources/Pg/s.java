...
public abstract class s implements com.google.zxing.q {
    ...
    private static final Pattern f25399a = Pattern.compile("[0-9]+");
    ...
    private static Gg.b h(boolean[] zArr, int i10, int i11, int i12) {
    ...
    public Gg.b a(String str, com.google.zxing.a aVar, int i10, int i11, Map<com.google.zxing.f, ?> map) throws NumberFormatException {
        if (!str.isEmpty()) {
            if (i10 >= 0 && i11 >= 0) {
