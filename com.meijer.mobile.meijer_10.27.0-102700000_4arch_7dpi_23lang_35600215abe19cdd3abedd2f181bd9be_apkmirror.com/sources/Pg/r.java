...
public abstract class r implements com.google.zxing.l {
    ...
    protected static void f(Gg.a aVar, int i10, int[] iArr) throws NotFoundException {
        int length = iArr.length;
        int i11 = 0;
    ...
    protected static void g(Gg.a aVar, int i10, int[] iArr) throws NotFoundException {
        int length = iArr.length;
    ...
    public abstract com.google.zxing.m c(int i10, Gg.a aVar, Map<com.google.zxing.d, ?> map) throws NotFoundException, ChecksumException, FormatException;
