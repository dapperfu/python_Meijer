...
final class m {
    ...
    private final List<int[]> f25385a = new ArrayList();

    /* renamed from: b, reason: collision with root package name */
    private final List<String> f25386b = new ArrayList();
    ...
    private void a(int[] iArr, String str) {
        this.f25385a.add(iArr);
        this.f25386b.add(str);
    }
    ...
    String c(String str) throws NumberFormatException {
        ...
        for (int i12 = 0; i12 < size && i11 >= (i10 = (iArr = this.f25385a.get(i12))[0]); i12++) {
            if (iArr.length != 1) {
                i10 = iArr[1];
            }
            if (i11 <= i10) {
                return this.f25386b.get(i12);
            }
        }
        return null;
    }
