...
public final class A extends y {
    ...
    private static final int[] f25338j = {1, 1, 1, 1, 1, 1};

    /* renamed from: k, reason: collision with root package name */
    static final int[][] f25339k = {new int[]{56, 52, 50, 49, 44, 38, 35, 42, 41, 37}, new int[]{7, 11, 13, 14, 19, 25, 28, 21, 22, 26}};

    /* renamed from: i, reason: collision with root package name */
    private final int[] f25340i = new int[4];
    ...
    @Override // Pg.y
    protected int[] k(Gg.a aVar, int i10) throws NotFoundException {
        return y.n(aVar, i10, true, f25338j);
    }

    @Override // Pg.y
    protected int l(Gg.a aVar, int[] iArr, StringBuilder sb2) throws NotFoundException {
        int[] iArr2 = this.f25340i;
        iArr2[0] = 0;
        iArr2[1] = 0;
        iArr2[2] = 0;
        iArr2[3] = 0;
