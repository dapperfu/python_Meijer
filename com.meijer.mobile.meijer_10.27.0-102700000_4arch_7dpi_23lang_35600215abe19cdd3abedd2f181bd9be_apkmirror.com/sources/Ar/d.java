...
public final class d {
    ...
    public static final class a implements E {
        ...
        public void dispose() {
            for (InterfaceC15369e interfaceC15369e : this.f1512a) {
                if (!interfaceC15369e.isDisposed()) {
                    interfaceC15369e.dispose();
                }
            }
        }
    }
    ...
    public static final void e(final String[] urls, Composer composer, final int i10) {
        ...
        if ((i11 & 3) == 2 && composerStartRestartGroup.j()) {
            ...
            d(ArraysKt.i1(urls), composerStartRestartGroup, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final E g(Context context, List list, F DisposableEffect) {
        ...
        while (it.hasNext()) {
            arrayList.add(Z4.a.a(context).b(C13531c.f127431a.d(context, (String) it.next())));
        }
    ...
    */
    private static final boolean i(android.content.Context r5, java.lang.String r6) {
        ...
        L11:
            if (r5 == 0) goto L20
            kw.B r6 = r5.getData()     // Catch: java.lang.Throwable -> L1e
            if (r6 == 0) goto L20
        ...
        L20:
            r6 = r0
        L21:
            uw.a$a r1 = uw.a.INSTANCE     // Catch: java.lang.Throwable -> L1e
