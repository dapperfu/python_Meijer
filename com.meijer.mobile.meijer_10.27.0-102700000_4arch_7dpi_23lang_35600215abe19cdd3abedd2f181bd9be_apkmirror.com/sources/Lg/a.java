...
public final class a {
    ...
    private int j(o oVar, o oVar2) {
        ...
        int iD = (int) oVar.d();
        int iC2 = (int) oVar2.c();
        int iMin = Math.min(this.f18100a.j() - 1, (int) oVar2.d());
        int i10 = 0;
        ...
        int i12 = iD < iMin ? 1 : -1;
        int i13 = iC >= iC2 ? -1 : 1;
        boolean zF = this.f18100a.f(z10 ? iD : iC, z10 ? iC : iD);
        while (iC != iC2) {
            boolean zF2 = this.f18100a.f(z10 ? iD : iC, z10 ? iC : iD);
            if (zF2 != zF) {
                i10++;
                zF = zF2;
            }
    ...
    public g b() throws NotFoundException {
        ...
        return new g(g(this.f18100a, oVar, oVar2, oVar3, oVar4, iMax, i11), new o[]{oVar, oVar2, oVar3, oVar4});
    }

    public a(b bVar) throws NotFoundException {
        this.f18100a = bVar;
        this.f18101b = new Hg.b(bVar);
    }

    private boolean e(o oVar) {
        if (oVar.c() >= 0.0f && oVar.c() <= this.f18100a.m() - 1 && oVar.d() > 0.0f && oVar.d() <= this.f18100a.j() - 1) {
            return true;
        }
        return false;
    }
