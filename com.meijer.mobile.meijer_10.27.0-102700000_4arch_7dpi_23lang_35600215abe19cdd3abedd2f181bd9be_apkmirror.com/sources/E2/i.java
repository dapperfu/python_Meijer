...
public final class i {
    ...
    private static final Set<String> f7601a = new LinkedHashSet();
    ...
    static final class a extends SuspendLambda implements Function3<D2.c, F2.f, Continuation<? super F2.f>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f7602a == 0) {
                ResultKt.b(obj);
                D2.c cVar = (D2.c) this.f7603b;
                F2.f fVar = (F2.f) this.f7604c;
    ...
    static final class b extends SuspendLambda implements Function2<F2.f, Continuation<? super Boolean>, Object> {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Set<String> f7607c;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            b bVar = new b(this.f7607c, continuation);
            bVar.f7606b = obj;
            return bVar;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f7605a == 0) {
                ResultKt.b(obj);
                Set<f.a<?>> setKeySet = ((F2.f) this.f7606b).a().keySet();
                ArrayList arrayList = new ArrayList(CollectionsKt.x(setKeySet, 10));
                Iterator<T> it = setKeySet.iterator();
                while (it.hasNext()) {
                    arrayList.add(((f.a) it.next()).getName());
    ...
    public static final D2.a<F2.f> a(Context context, String sharedPreferencesName, Set<String> keysToMigrate) {
        ...
        return keysToMigrate == f7601a ? new D2.a<>(context, sharedPreferencesName, null, e(keysToMigrate), d(), 4, null) : new D2.a<>(context, sharedPreferencesName, keysToMigrate, e(keysToMigrate), d());
    }
