...
public abstract class AbstractC5514l<T> implements Iterator<T>, KMutableIterator {
    ...
    public void remove() {
        if (!this.canRemove) {
            C5557d.b("Call next() before removing an element.");
        }
