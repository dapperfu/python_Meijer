...
public final class d0 {
    ...
    private static final Object[] f42108a = new Object[0];

    /* renamed from: b, reason: collision with root package name */
    private static final c0<Object> f42109b = new T(0);

    public static final <E> c0<E> f() {
        c0<E> c0Var = (c0<E>) f42109b;
    ...
    public static final void d(List<?> list, int i10) {
        ...
        C5557d.c("Index " + i10 + " is out of bounds. The list has " + size + " elements.");
    }
    ...
    public static final void e(List<?> list, int i10, int i11) {
        int size = list.size();
        if (i10 > i11) {
            C5557d.a("Indices are out of order. fromIndex (" + i10 + ") is greater than toIndex (" + i11 + ").");
        }
        if (i10 < 0) {
            C5557d.c("fromIndex (" + i10 + ") is less than 0.");
        }
        if (i11 > size) {
            C5557d.c("toIndex (" + i11 + ") is more than than the list size (" + size + ')');
        }
    }
