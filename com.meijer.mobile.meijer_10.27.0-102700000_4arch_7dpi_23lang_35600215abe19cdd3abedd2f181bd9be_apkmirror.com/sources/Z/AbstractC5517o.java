...
public abstract class AbstractC5517o {
    ...
    public /* synthetic */ AbstractC5517o(int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10);
    }

    private AbstractC5517o(int i10) {
        this.content = i10 == 0 ? C5521t.a() : new int[i10];
    }

    public static /* synthetic */ int b(AbstractC5517o abstractC5517o, int i10, int i11, int i12, int i13, Object obj) {
        if (obj != null) {
        ...
        if ((i13 & 4) != 0) {
            i12 = abstractC5517o._size;
        }
        return abstractC5517o.a(i10, i11, i12);
    }

    public static /* synthetic */ String h(AbstractC5517o abstractC5517o, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, int i11, Object obj) {
        if (obj != null) {
        ...
        return abstractC5517o.g(charSequence, charSequence2, charSequence6, i10, charSequence5);
    }
    ...
    public boolean equals(Object other) {
        if (other instanceof AbstractC5517o) {
            AbstractC5517o abstractC5517o = (AbstractC5517o) other;
            int i10 = abstractC5517o._size;
            int i11 = this._size;
            if (i10 == i11) {
                int[] iArr = this.content;
                int[] iArr2 = abstractC5517o.content;
