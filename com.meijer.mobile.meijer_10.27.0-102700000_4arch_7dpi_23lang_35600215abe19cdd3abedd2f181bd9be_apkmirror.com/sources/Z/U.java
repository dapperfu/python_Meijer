...
public final class U<E> extends e0<E> {
    ...
    */
    ...
    private final void s(int initialCapacity) {
        ...
        this._capacity = iMax;
        r(iMax);
        this.elements = iMax == 0 ? C5554a.f43343c : new Object[iMax];
        if (iMax == 0) {
            jArrA = m0.a();
        } else {
        ...
        while (i16 != i11) {
            ...
            if (j12 != 128 && j12 == 254) {
                ...
                if (((iN - i20) & i11) / 8 == ((i16 - i20) & i11) / 8) {
                    jArr[i17] = ((r11 & l3.f92485d) << i18) | (jArr[i17] & (~(255 << i18)));
                    if (jArr3[i16] == j13) {
                        long j14 = i16;
                    ...
                    if (((j15 >> i22) & 255) == 128) {
                        int i24 = i16;
                        jArr[i21] = (j15 & (~(255 << i22))) | ((r11 & l3.f92485d) << i22);
                        ...
                        jArr[i21] = ((r11 & l3.f92485d) << i22) | (j15 & (~(255 << i22)));
