...
public final class C5504b<E> implements Collection<E>, Set<E>, KMutableCollection, KMutableSet {
    ...
    /* renamed from: Z.b$a */
    private final class a extends AbstractC5514l<E> {
        public a() {
            super(C5504b.this.n());
        }
    ...
    public boolean add(E element) {
        ...
        if (element == null) {
            ...
            i10 = iHashCode;
            iC = C5506d.c(this, element, iHashCode);
        }
        if (iC >= 0) {
            return false;
        }
    ...
    public final int indexOf(Object key) {
        return key == null ? C5506d.d(this) : C5506d.c(this, key, key.hashCode());
    }
    ...
    public final <T> T[] toArray(T[] array) {
        ...
        T[] tArr = (T[]) C5505c.a(array, this._size);
    ...
    public /* synthetic */ C5504b(int i10, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this((i11 & 1) != 0 ? 0 : i10);
    }
}
