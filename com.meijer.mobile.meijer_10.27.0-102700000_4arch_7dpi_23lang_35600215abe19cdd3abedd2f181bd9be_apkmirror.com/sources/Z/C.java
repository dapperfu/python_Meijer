...
public class C<E> implements Cloneable {
    ...
    public E d(long key) {
        int iB = C5554a.b(this.keys, this.size, key);
        if (iB < 0 || this.values[iB] == D.f42024a) {
            return null;
        }
    ...
    public int e(long key) {
        ...
        return C5554a.b(this.keys, this.size, key);
    }
    ...
    public void i(long key, E value) {
        ...
        int i10 = ~iB;
        if (i10 < this.size && this.values[i10] == D.f42024a) {
            this.keys[i10] = key;
        ...
        if (this.garbage) {
            ...
            if (i11 >= jArr.length) {
                ...
                this.garbage = false;
                this.size = i12;
                i10 = ~C5554a.b(this.keys, i12, key);
            }
        }
        int i14 = this.size;
        if (i14 >= this.keys.length) {
            int iF = C5554a.f(i14 + 1);
    ...
    public void k(long key) {
        ...
        this.values[iB] = D.f42024a;
        this.garbage = true;
    }

    public void l(int index) {
        if (this.values[index] != D.f42024a) {
            this.values[index] = D.f42024a;
            this.garbage = true;
        }
    }
