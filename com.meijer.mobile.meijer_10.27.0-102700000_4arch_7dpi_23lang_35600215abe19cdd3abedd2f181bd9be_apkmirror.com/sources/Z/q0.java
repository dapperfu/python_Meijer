...
public final class q0 {
    ...
    public static final class a extends IntIterator {
        ...
        public boolean hasNext() {
            return this.index < this.f42203b.m();
        }

        @Override // kotlin.collections.IntIterator
        public int nextInt() {
            o0<T> o0Var = this.f42203b;
            int i10 = this.index;
            this.index = i10 + 1;
            return o0Var.i(i10);
        }
    ...
    public static final class b<T> implements Iterator<T>, KMappedMarker {
        ...
        @Override // java.util.Iterator
        public boolean hasNext() {
            return this.index < this.f42205b.m();
        }

        @Override // java.util.Iterator
        public T next() {
            o0<T> o0Var = this.f42205b;
            int i10 = this.index;
            this.index = i10 + 1;
            return o0Var.n(i10);
        }
