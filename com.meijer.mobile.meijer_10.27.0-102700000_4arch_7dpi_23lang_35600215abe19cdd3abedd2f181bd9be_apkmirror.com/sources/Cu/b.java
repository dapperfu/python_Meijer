...
@Metadata(d1 = {"\u0000H\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u0007\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0013\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0007\u0018\u00002\u00020\u0001BG\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u00126\u0010\u000b\u001a2\u0012\u0013\u0012\u00110\u0001¢\u0006\f\b\u0005\u0012\b\b\u0006\u0012\u0004\b\b(\u0007\u0012\u0013\u0012\u00110\b¢\u0006\f\b\u0005\u0012\b\b\u0006\u0012\u0004\b\b(\t\u0012\u0004\u0012\u00020\n0\u0004¢\u0006\u0004\b\f\u0010\rJ\u000f\u0010\u000e\u001a\u00020\nH\u0002¢\u0006\u0004\b\u000e\u0010\u000fJ\u000f\u0010\u0011\u001a\u00020\u0010H\u0002¢\u0006\u0004\b\u0011\u0010\u0012J\u0017\u0010\u0014\u001a\u00020\n2\u0006\u0010\u0013\u001a\u00020\nH\u0016¢\u0006\u0004\b\u0014\u0010\u0015J\u000f\u0010\u0017\u001a\u00020\u0016H\u0016¢\u0006\u0004\b\u0017\u0010\u0018J\u000f\u0010\u0019\u001a\u00020\u0016H\u0016¢\u0006\u0004\b\u0019\u0010\u0018J-\u0010\u001e\u001a\u00020\n2\u0006\u0010\u001a\u001a\u00020\u00102\f\u0010\u001c\u001a\b\u0012\u0004\u0012\u00020\u00100\u001b2\u0006\u0010\u001d\u001a\u00020\u0010H\u0016¢\u0006\u0004\b\u001e\u0010\u001fR\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0019\u0010 RD\u0010\u000b\u001a2\u0012\u0013\u0012\u00110\u0001¢\u0006\f\b\u0005\u0012\b\b\u0006\u0012\u0004\b\b(\u0007\u0012\u0013\u0012\u00110\b¢\u0006\f\b\u0005\u0012\b\b\u0006\u0012\u0004\b\b(\t\u0012\u0004\u0012\u00020\n0\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0017\u0010!R\u001a\u0010$\u001a\u00020\n8\u0016X\u0096D¢\u0006\f\n\u0004\b\u001e\u0010\"\u001a\u0004\b#\u0010\u000fR\u001d\u0010(\u001a\u0004\u0018\u00010\b8VX\u0096\u0084\u0002¢\u0006\f\n\u0004\b\u0014\u0010%\u001a\u0004\b&\u0010'R\u0014\u0010*\u001a\u00020\n8BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b)\u0010\u000fR\u0014\u0010,\u001a\u00020\n8VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b+\u0010\u000fR\u0014\u0010.\u001a\u00020\n8VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b-\u0010\u000fR\u001a\u00102\u001a\b\u0012\u0004\u0012\u00020\b0/8VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b0\u00101¨\u00063"}, d2 = {"LCu/b;", "LCu/h;", "Ll0/A;", "lazyListState", "Lkotlin/Function2;", "Lkotlin/ParameterName;", "name", "layoutInfo", "LCu/i;", "item", "", "snapOffsetForItem", "<init>", "(Ll0/A;Lkotlin/jvm/functions/Function2;)V", "j", "()I", "", "k", "()F", "index", "d", "(I)I", "", "b", "()Z", "a", "velocity", "Lc0/y;", "decayAnimationSpec", "maximumFlingDistance", "c", "(FLc0/y;F)I", "Ll0/A;", "Lkotlin/jvm/functions/Function2;", "I", "g", "startScrollOffset", "Landroidx/compose/runtime/z1;", "e", "()LCu/i;", "currentItem", "l", "itemCount", "f", "endScrollOffset", "h", "totalItemsCount", "Lkotlin/sequences/Sequence;", "m", "()Lkotlin/sequences/Sequence;", "visibleItems", "lib_release"}, k = 1, mv = {1, 6, 0}, xi = 48)
...
public final class b extends h {
    ...
    @Metadata(d1 = {"\u0000\b\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0001\u001a\u0004\u0018\u00010\u0000H\n¢\u0006\u0004\b\u0001\u0010\u0002"}, d2 = {"LCu/i;", "c", "()LCu/i;"}, k = 3, mv = {1, 6, 0})
    ...
    /* synthetic */ class C0087b extends FunctionReferenceImpl implements Function1<InterfaceC15349i, c> {

        /* renamed from: b, reason: collision with root package name */
        public static final C0087b f4919b = new C0087b();
        ...
        public final c invoke(InterfaceC15349i p02) {
            Intrinsics.j(p02, "p0");
            return new c(p02);
        }
    }
    ...
    public b(C15339A lazyListState, Function2<? super h, ? super SnapperLayoutItemInfo, Integer> snapOffsetForItem) {
    ...
    private final int j() {
        ...
        InterfaceC15349i interfaceC15349i = nVarX.h().get(0);
        return nVarX.h().get(1).getOffset() - (interfaceC15349i.getSize() + interfaceC15349i.getOffset());
    }
    ...
    private final float k() {
        ...
        if (it.hasNext()) {
            next = it.next();
            if (it.hasNext()) {
                int offset = ((InterfaceC15349i) next).getOffset();
                do {
                    Object next3 = it.next();
                    int offset2 = ((InterfaceC15349i) next3).getOffset();
                    if (offset > offset2) {
                        next = next3;
                        offset = offset2;
                    }
        ...
        if (it2.hasNext()) {
            ...
            if (it2.hasNext()) {
                ...
                int offset3 = interfaceC15349i2.getOffset() + interfaceC15349i2.getSize();
                do {
                    Object next4 = it2.next();
                    InterfaceC15349i interfaceC15349i3 = (InterfaceC15349i) next4;
                    int offset4 = interfaceC15349i3.getOffset() + interfaceC15349i3.getSize();
                    if (offset3 < offset4) {
                        next2 = next4;
                        offset3 = offset4;
                    }
        ...
        InterfaceC15349i interfaceC15349i4 = (InterfaceC15349i) next2;
        if (interfaceC15349i4 == null) {
            return -1.0f;
        }
        if (Math.max(interfaceC15349i.getOffset() + interfaceC15349i.getSize(), interfaceC15349i4.getOffset() + interfaceC15349i4.getSize()) - Math.min(interfaceC15349i.getOffset(), interfaceC15349i4.getOffset()) == 0) {
            return -1.0f;
        }
    ...
    @Override // Cu.h
    public boolean a() {
        InterfaceC15349i interfaceC15349i = (InterfaceC15349i) CollectionsKt.F0(this.lazyListState.x().h());
        if (interfaceC15349i != null) {
            return interfaceC15349i.getIndex() < l() - 1 || interfaceC15349i.getOffset() + interfaceC15349i.getSize() > f();
        }
        return false;
    }
    ...
    @Override // Cu.h
    public boolean b() {
        InterfaceC15349i interfaceC15349i = (InterfaceC15349i) CollectionsKt.u0(this.lazyListState.x().h());
        if (interfaceC15349i != null) {
            return interfaceC15349i.getIndex() > 0 || interfaceC15349i.getOffset() < getStartScrollOffset();
        }
        return false;
    }

    @Override // Cu.h
    public int c(float velocity, InterfaceC6342y<Float> decayAnimationSpec, float maximumFlingDistance) {
        ...
        float fN = RangesKt.n(C6288A.a(decayAnimationSpec, 0.0f, velocity), -maximumFlingDistance, maximumFlingDistance);
        double d10 = fK;
    ...
    public Sequence<SnapperLayoutItemInfo> m() {
        return SequencesKt.M(CollectionsKt.f0(this.lazyListState.x().h()), C0087b.f4919b);
    }
