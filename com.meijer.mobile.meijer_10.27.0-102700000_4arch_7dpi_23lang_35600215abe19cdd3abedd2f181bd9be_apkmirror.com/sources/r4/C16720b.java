...
public final class C16720b {

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);

    /* renamed from: d, reason: collision with root package name */
    private static final Map<String, ReentrantLock> f157836d = new LinkedHashMap();

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final ReentrantLock threadLock;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final C16721c fileLock;
    ...
    public static final class Companion {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public final C16721c c(String key) {
            return new C16721c(key);
        }
    }

    public C16720b(String filename, boolean z10) {
    ...
    public final <T> T b(Function0<? extends T> onLocked, Function1 onLockError) {
        ...
        try {
            ...
            try {
                ...
                C16721c c16721c2 = this.fileLock;
                if (c16721c2 != null) {
                    c16721c2.b();
                }
            }
