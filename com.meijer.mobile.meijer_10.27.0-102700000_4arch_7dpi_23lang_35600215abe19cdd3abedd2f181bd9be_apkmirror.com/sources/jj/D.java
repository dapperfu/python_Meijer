...
@Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a\u0017\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001*\u00020\u0000¢\u0006\u0004\b\u0003\u0010\u0004\u001a\u0011\u0010\u0006\u001a\u00020\u0005*\u00020\u0000¢\u0006\u0004\b\u0006\u0010\u0007\u001a%\u0010\f\u001a\u0004\u0018\u00010\u000b2\b\u0010\t\u001a\u0004\u0018\u00010\b2\b\u0010\n\u001a\u0004\u0018\u00010\bH\u0002¢\u0006\u0004\b\f\u0010\r\u001a\u0011\u0010\u000f\u001a\u00020\u000e*\u00020\u0000¢\u0006\u0004\b\u000f\u0010\u0010¨\u0006\u0011"}, d2 = {"Lcom/meijer/mobile/cart/model/hybris/PaymentDetails;", "", "Lej/F;", "d", "(Lcom/meijer/mobile/cart/model/hybris/PaymentDetails;)Ljava/util/List;", "Lgk/f;", "c", "(Lcom/meijer/mobile/cart/model/hybris/PaymentDetails;)Lgk/f;", "", "month", "year", "j$/time/YearMonth", "a", "(Ljava/lang/String;Ljava/lang/String;)Lj$/time/YearMonth;", "Lej/u;", "b", "(Lcom/meijer/mobile/cart/model/hybris/PaymentDetails;)Lej/u;", "hybris_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* loaded from: classes7.dex */
public final class D {
    private static final YearMonth a(String str, String str2) {
        Year year = str2 != null ? (Year) vk.d.b(str2, C17590a.f164803a.i(), new C()) : null;
        Month month = str != null ? (Month) vk.d.b(str, C17590a.f164803a.g(), new C14976B()) : null;
    ...
    public static final PaymentDetailItem b(PaymentDetails paymentDetails) {
        ...
        CustomerAddress customerAddressA = billingAddress != null ? C13525b.a(billingAddress) : null;
        ...
        Month month = expiryMonth != null ? (Month) vk.d.b(expiryMonth, C17590a.f164803a.x(), new C14976B()) : null;
        String expiryYear = paymentDetails.getExpiryYear();
        Year year = expiryYear != null ? (Year) vk.d.b(expiryYear, C17590a.f164803a.G(), new C()) : null;
        ...
        Month month2 = startMonth != null ? (Month) vk.d.b(startMonth, C17590a.f164803a.x(), new C14976B()) : null;
        String startYear = paymentDetails.getStartYear();
        Year year2 = startYear != null ? (Year) vk.d.b(startYear, C17590a.f164803a.G(), new C()) : null;
        String subscriptionId = paymentDetails.getSubscriptionId();
        String paymentStatus = paymentDetails.getPaymentStatus();
        return new PaymentDetailItem(accountHolderName, customerAddressA, cardNumber, cardTypeA, defaultPayment, month, year, null, id2, issueNumber, saved, month2, year2, null, subscriptionId, paymentStatus != null ? ej.x.valueOf(paymentStatus) : null, false, 73856, null);
    }
    ...
    public static final PaymentOption c(PaymentDetails paymentDetails) {
        ...
        String cardNumber = paymentDetails.getCardNumber();
        EnumEntries<gk.h> enumEntriesM = gk.h.m();
        LinkedHashMap linkedHashMap = new LinkedHashMap(RangesKt.f(MapsKt.f(CollectionsKt.x(enumEntriesM, 10)), 16));
        for (gk.h hVar : enumEntriesM) {
            linkedHashMap.put(hVar.getCodeName(), hVar);
        }
        HybrisCardType cardType = paymentDetails.getCardType();
        return new PaymentOption(cardHolderName, billingAddress9, cardNumber, (gk.h) linkedHashMap.get(cardType != null ? cardType.getCode() : null), null, paymentDetails.getDefaultPayment(), a(paymentDetails.getExpiryMonth(), paymentDetails.getExpiryYear()), null, paymentDetails.getId(), paymentDetails.getIssueNumber(), false, null, null, 7312, null);
    }
