...
@Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a\u001d\u0010\u0004\u001a\u00020\u0003*\u00020\u00002\n\b\u0002\u0010\u0002\u001a\u0004\u0018\u00010\u0001¢\u0006\u0004\b\u0004\u0010\u0005\u001a\u001d\u0010\t\u001a\u00020\u0000*\u00020\u00002\n\u0010\b\u001a\u00060\u0006j\u0002`\u0007¢\u0006\u0004\b\t\u0010\n\u001a\u0011\u0010\f\u001a\u00020\u0000*\u00020\u000b¢\u0006\u0004\b\f\u0010\r¨\u0006\u000e"}, d2 = {"Lcom/meijer/mobile/cart/model/hybris/Cart;", "", "promoCodeMessage", "Lej/C;", "c", "(Lcom/meijer/mobile/cart/model/hybris/Cart;Ljava/lang/String;)Lej/C;", "", "Lcom/meijer/mobile/core/model/common/StoreId;", "storeId", "b", "(Lcom/meijer/mobile/cart/model/hybris/Cart;I)Lcom/meijer/mobile/cart/model/hybris/Cart;", "Lej/f;", "a", "(Lej/f;)Lcom/meijer/mobile/cart/model/hybris/Cart;", "hybris_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* renamed from: jj.b, reason: case insensitive filesystem */
/* loaded from: classes7.dex */
public final class C14978b {
    /* JADX WARN: Multi-variable type inference failed */
    public static final Cart a(InterfaceC13678f interfaceC13678f) {
        Intrinsics.j(interfaceC13678f, "<this>");
        Cart cart = interfaceC13678f instanceof Cart ? (Cart) interfaceC13678f : null;
        if (cart != null) {
            return cart;
        }
        boolean z10 = false;
        boolean z11 = false;
        String str = null;
        return new Cart(interfaceC13678f.getCode(), null, null, false, 0 == true ? 1 : 0, null, new HybrisPointOfService(interfaceC13678f.u(), null, null, false, 0.0d, null, null, false, 0.0d, null, null, z10, z11, null, null, str, null, null, null, false, false, false, 4194302, null), null, 0 == true ? 1 : 0, 0 == true ? 1 : 0, null, 0, null, 0 == true ? 1 : 0, false, z10, z11, 0 == true ? 1 : 0, false, str, false, 0 == true ? 1 : 0, 0 == true ? 1 : 0, null, null, null, null, 0, null, false, null, null, null, null, null, null, null, null, false, null, null, null, 0, null, null, null, null, null, null, null, 0, null, null, null, null, null, null, null, null, null, null, null, -66, 1073741823, null);
    }
    ...
    public static final Cart b(Cart cart, int i10) {
        ...
        while (it.hasNext()) {
            arrayList.add(C14983g.a((EntryJson) it.next(), i10));
        }
    ...
    public static final ShoppingCart c(Cart cart, String str) {
        ...
        Iterator<T> it = listV.iterator();
        while (it.hasNext()) {
            arrayList.add(C14983g.b((EntryJson) it.next()));
        }
        ...
        while (it2.hasNext()) {
            arrayList4.add(C14983g.b((EntryJson) it2.next()));
        }
        ...
        CustomerData c13679gA = customerData != null ? C14982f.a(customerData) : null;
        ...
        DeliveryMode c13680hA = deliveryMode != null ? p.a(deliveryMode) : null;
        HybrisCustomerAddress deliveryAddress = cart.getDeliveryAddress();
        CustomerAddress c6395cA = deliveryAddress != null ? C13525b.a(deliveryAddress) : null;
        HybrisPrice extendedDeliveryCost = cart.getExtendedDeliveryCost();
        mk.b bVarA = extendedDeliveryCost != null ? Lo.b.a(extendedDeliveryCost) : null;
        ...
        PickupPerson c13911bA = pickUpPerson != null ? C15169b.a(pickUpPerson) : null;
        HybrisPickupSlotInfo pickUpSlotInfo = cart.getPickUpSlotInfo();
        FulfillmentSlot cVarA2 = pickUpSlotInfo != null ? C16533a.a(pickUpSlotInfo, cart.getPointOfService().getStoreId()) : null;
        ...
        mk.b bVarA2 = Lo.b.a(cart.getProductDiscounts());
        mk.b bVarA3 = Lo.b.a(cart.getOrderDiscounts());
        mk.b bVarA4 = Lo.b.a(cart.getDepositPrice());
        mk.b bVarA5 = Lo.b.a(cart.getDeliveryCost());
        mk.b bVarA6 = Lo.b.a(cart.getSubTotal());
        mk.b bVarA7 = Lo.b.a(cart.getTotalDiscounts());
        mk.b bVarA8 = Lo.b.a(cart.getTotalPrice());
        mk.b bVarA9 = Lo.b.a(cart.getItemsTotal());
        mk.b bVarA10 = Lo.b.a(cart.getTotalCosts());
        mk.b bVarA11 = Lo.b.a(cart.getTotalTax());
        mk.b bVarA12 = Lo.b.a(cart.getTotalPriceWithTax());
        HybrisPrice creditTransactionAmount = cart.getCreditTransactionAmount();
        mk.b bVarA13 = creditTransactionAmount != null ? Lo.b.a(creditTransactionAmount) : null;
