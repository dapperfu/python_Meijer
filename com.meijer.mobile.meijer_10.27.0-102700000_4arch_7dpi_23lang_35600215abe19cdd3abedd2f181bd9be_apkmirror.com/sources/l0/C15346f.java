...
public final class C15346f implements InterfaceC15751k {
    ...
    public C15346f(C15339A c15339a, int i10) {
        this.state = c15339a;
    ...
    @Override // kotlin.InterfaceC15751k
    public int e() {
        return Math.min(a() - 1, ((InterfaceC15349i) CollectionsKt.D0(this.state.x().h())).getIndex() + this.beyondBoundsItemCount);
    }
}
