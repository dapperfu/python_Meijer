...
public final class C6214c {
    ...
    private final void e(String value, String methodName, Exception exception) {
        e.Companion.b(e.INSTANCE, new k(C6214c.class, methodName, MapsKt.o(TuplesKt.a("reason", "Failed to decrypt value: " + value), TuplesKt.a("exception", exception.getMessage())), null, 8, null), false, 2, null);
    }
    ...
    public final String b(String value) throws BadPaddingException, NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        try {
            ...
            if (message == null || !StringsKt.c0(message, "bad base-64", false, 2, null)) {
                value = null;
            }
            return value;
