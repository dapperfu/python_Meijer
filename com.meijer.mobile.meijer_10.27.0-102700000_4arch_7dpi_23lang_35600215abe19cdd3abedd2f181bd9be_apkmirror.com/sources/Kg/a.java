...
final class a {
    ...
    private final Gg.b f16519a;

    /* renamed from: b, reason: collision with root package name */
    private final Gg.b f16520b;

    /* renamed from: c, reason: collision with root package name */
    private final e f16521c;

    private Gg.b a(Gg.b bVar) {
        int iF = this.f16521c.f();
        int iE = this.f16521c.e();
        if (bVar.j() != iF) {
            throw new IllegalArgumentException("Dimension of bitMatrix must match the version size");
        }
        int iC = this.f16521c.c();
        int iB = this.f16521c.b();
        int i10 = iF / iC;
        int i11 = iE / iB;
        Gg.b bVar2 = new Gg.b(i11 * iB, i10 * iC);
    ...
    private boolean h(int i10, int i11, int i12, int i13) {
        ...
        this.f16520b.q(i11, i10);
        return this.f16519a.f(i11, i10);
    }
    ...
    byte[] c() throws FormatException {
        byte[] bArr = new byte[this.f16521c.g()];
        int iJ = this.f16519a.j();
        int iM = this.f16519a.m();
        int i10 = 0;
        boolean z10 = false;
        int i11 = 0;
        boolean z11 = false;
        ...
        while (true) {
            if (i12 == iJ && i10 == 0 && !z10) {
                ...
                if (i12 == i13 && i10 == 0 && (iM & 3) != 0 && !z11) {
                    ...
                    while (true) {
                        if (i12 < iJ && i10 >= 0 && !this.f16520b.f(i10, i12)) {
                    ...
                    int i17 = i10 + 5;
                    while (true) {
                        if (i16 >= 0 && i17 < iM && !this.f16520b.f(i17, i16)) {
    ...
    a(Gg.b bVar) throws FormatException {
        ...
        if (iJ >= 8 && iJ <= 144 && (iJ & 1) == 0) {
            ...
            Gg.b bVarA = a(bVar);
            this.f16519a = bVarA;
            this.f16520b = new Gg.b(bVarA.m(), bVarA.j());
            return;
        }
        throw FormatException.a();
    }

    private static e j(Gg.b bVar) throws FormatException {
