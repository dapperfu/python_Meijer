...
public final class e {
    ...
    private static final e[] f16540h = a();
    ...
    static final class c {
        ...
        private c(int i10, b bVar) {
            this.f16550a = i10;
            this.f16551b = new b[]{bVar};
        }

        private c(int i10, b bVar, b bVar2) {
            this.f16550a = i10;
            this.f16551b = new b[]{bVar, bVar2};
        }
    }
    ...
    public static e h(int i10, int i11) throws FormatException {
        ...
        for (e eVar : f16540h) {
            if (eVar.f16542b == i10 && eVar.f16543c == i11) {
                return eVar;
            }
        }
        throw FormatException.a();
    ...
    public String toString() {
        return String.valueOf(this.f16541a);
    }
