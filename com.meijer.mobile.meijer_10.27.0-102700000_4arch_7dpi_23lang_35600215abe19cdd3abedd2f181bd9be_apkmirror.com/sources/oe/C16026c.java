...
public class C16026c {
    ...
    public static ColorStateList a(Context context, TypedArray typedArray, int i10) {
        ...
        if (typedArray.hasValue(i10) && (resourceId = typedArray.getResourceId(i10, 0)) != 0 && (colorStateListA = C14791a.a(context, resourceId)) != null) {
    ...
    public static ColorStateList b(Context context, M m10, int i10) {
        int iN;
        ColorStateList colorStateListA;
        if (m10.s(i10) && (iN = m10.n(i10, 0)) != 0 && (colorStateListA = C14791a.a(context, iN)) != null) {
            return colorStateListA;
        }
        return m10.c(i10);
    }
    ...
    public static Drawable d(Context context, TypedArray typedArray, int i10) {
        int resourceId;
        Drawable drawableB;
        if (typedArray.hasValue(i10) && (resourceId = typedArray.getResourceId(i10, 0)) != 0 && (drawableB = C14791a.b(context, resourceId)) != null) {
            return drawableB;
        }
    ...
    public static C16027d g(Context context, TypedArray typedArray, int i10) {
        int resourceId;
        if (typedArray.hasValue(i10) && (resourceId = typedArray.getResourceId(i10, 0)) != 0) {
            return new C16027d(context, resourceId);
        }
        return null;
    }
