...
public final class e extends a {
    ...
    private static final int[] f30036i = {1, 10, 34, 70, 126};

    /* renamed from: j, reason: collision with root package name */
    private static final int[] f30037j = {4, 20, 48, 81};

    /* renamed from: k, reason: collision with root package name */
    private static final int[] f30038k = {0, 161, 961, 2015, 2715};

    /* renamed from: l, reason: collision with root package name */
    private static final int[] f30039l = {0, 336, 1036, 1516};

    /* renamed from: m, reason: collision with root package name */
    private static final int[] f30040m = {8, 6, 4, 3, 1};

    /* renamed from: n, reason: collision with root package name */
    private static final int[] f30041n = {2, 4, 6, 8};

    /* renamed from: o, reason: collision with root package name */
    private static final int[][] f30042o = {new int[]{3, 8, 2, 1}, new int[]{3, 5, 5, 1}, new int[]{3, 3, 7, 1}, new int[]{3, 1, 9, 1}, new int[]{2, 7, 4, 1}, new int[]{2, 5, 6, 1}, new int[]{2, 3, 8, 1}, new int[]{1, 5, 7, 1}, new int[]{1, 3, 9, 1}};

    /* renamed from: g, reason: collision with root package name */
    private final List<d> f30043g = new ArrayList();

    /* renamed from: h, reason: collision with root package name */
    private final List<d> f30044h = new ArrayList();

    private d w(Gg.a aVar, boolean z10, int i10, Map<com.google.zxing.d, ?> map) {
        try {
    ...
    private c y(Gg.a aVar, int i10, boolean z10, int[] iArr) throws NotFoundException {
        int i11;
    ...
    @Override // Pg.r
    public m c(int i10, Gg.a aVar, Map<com.google.zxing.d, ?> map) throws NotFoundException {
        r(this.f30043g, w(aVar, false, i10, map));
        aVar.p();
        r(this.f30044h, w(aVar, true, i10, map));
        aVar.p();
        for (d dVar : this.f30043g) {
            if (dVar.c() > 1) {
                for (d dVar2 : this.f30044h) {
    ...
    */
    private void s(boolean r10, int r11) throws com.google.zxing.NotFoundException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: Qg.e.s(boolean, int):void");
    }
    ...
    private b v(Gg.a aVar, c cVar, boolean z10) throws NotFoundException {
        int i10;
        int[] iArrI = i();
        Arrays.fill(iArrI, 0);
        if (z10) {
        ...
        if (z10) {
            if ((i17 & 1) == 0 && i17 <= 12 && i17 >= 4) {
                ...
                int i24 = f30040m[i23];
                int i25 = 9 - i24;
                return new b((f.b(iArrM, i24, false) * f30036i[i23]) + f.b(iArrK, i25, true) + f30038k[i23], i22);
            }
            throw NotFoundException.a();
        }
        if ((i20 & 1) == 0 && i20 <= 10 && i20 >= 4) {
            int i26 = (10 - i20) / 2;
            int i27 = f30041n[i26];
            return new b((f.b(iArrK, 9 - i27, false) * f30037j[i26]) + f.b(iArrM, i27, true) + f30039l[i26], i22);
        }
        throw NotFoundException.a();
    }

    private int[] x(Gg.a aVar, boolean z10) throws NotFoundException {
        int[] iArrJ = j();
        iArrJ[0] = 0;
        iArrJ[1] = 0;
        iArrJ[2] = 0;
