...
public final class C16190d {
    private static final InterfaceC5316f1 a(CharSequence charSequence, Resources resources, int i10) {
        try {
            return C16188b.a(InterfaceC5316f1.INSTANCE, resources, i10);
        } catch (Exception e10) {
    ...
    private static final a1.d b(Resources.Theme theme, Resources resources, int i10, int i11, Composer composer, int i12) throws XmlPullParserException, Resources.NotFoundException, IOException {
        ...
        C16189c c16189c = (C16189c) composer.o(AndroidCompositionLocals_androidKt.h());
        C16189c.Key key = new C16189c.Key(theme, i10);
        C16189c.ImageVectorEntry imageVectorEntryB = c16189c.b(key);
        if (imageVectorEntryB == null) {
            XmlResourceParser xml = resources.getXml(i10);
            if (Intrinsics.e(C6179c.j(xml).getName(), "vector")) {
                imageVectorEntryB = C16194h.a(theme, resources, xml, i11);
                c16189c.d(key, imageVectorEntryB);
            } else {
    ...
    public static final Z0.c c(int i10, Composer composer, int i11) {
        ...
        TypedValue typedValueB = ((C16191e) composer.o(AndroidCompositionLocals_androidKt.i())).b(resources, i10);
        ...
        if (charSequence != null && StringsKt.g0(charSequence, ".xml", false, 2, null)) {
            ...
            BitmapPainter bitmapPainter = new BitmapPainter((InterfaceC5316f1) objB, 0L, 0L, 6, null);
            composer.P();
            cVarG = bitmapPainter;
        }
        if (ComposerKt.M()) {
