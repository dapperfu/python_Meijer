...
public final class C16194h {
    ...
    public static final C16189c.ImageVectorEntry a(Resources.Theme theme, Resources resources, XmlResourceParser xmlResourceParser, int i10) throws XmlPullParserException, IOException {
        AttributeSet attributeSetAsAttributeSet = Xml.asAttributeSet(xmlResourceParser);
        AndroidVectorParser androidVectorParser = new AndroidVectorParser(xmlResourceParser, 0, 2, null);
        d.a aVarA = C6179c.a(androidVectorParser, resources, theme, attributeSetAsAttributeSet);
        int iG = 0;
        while (!C6179c.d(xmlResourceParser)) {
            iG = C6179c.g(androidVectorParser, resources, attributeSetAsAttributeSet, theme, aVarA, iG);
            xmlResourceParser.next();
        }
        return new C16189c.ImageVectorEntry(aVarA.f(), i10);
    }
    ...
    public static final a1.d b(d.Companion companion, int i10, Composer composer, int i11) throws XmlPullParserException, Resources.NotFoundException {
        ...
        boolean z10 = false;
        Resources resourcesA = C16192f.a(composer, 0);
