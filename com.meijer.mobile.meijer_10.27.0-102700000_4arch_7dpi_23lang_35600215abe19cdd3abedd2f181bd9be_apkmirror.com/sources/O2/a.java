...
public final class a {
    ...
    public static final f0.c a(h0 h0Var, Composer composer, int i10) {
        ...
        if (h0Var instanceof InterfaceC6020j) {
            cVarA = N2.a.a((Context) composer.o(AndroidCompositionLocals_androidKt.g()), ((InterfaceC6020j) h0Var).getDefaultViewModelProviderFactory());
        } else {
            cVarA = null;
        }
        composer.U();
