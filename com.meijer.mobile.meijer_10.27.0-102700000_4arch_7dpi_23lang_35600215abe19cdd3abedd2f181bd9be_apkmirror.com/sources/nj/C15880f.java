...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a\u0011\u0010\u0002\u001a\u00020\u0001*\u00020\u0000¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lcom/meijer/mobile/cart/model/hybris/orders/HybrisPromotionResult;", "Lgj/j;", "a", "(Lcom/meijer/mobile/cart/model/hybris/orders/HybrisPromotionResult;)Lgj/j;", "hybris_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* renamed from: nj.f, reason: case insensitive filesystem */
/* loaded from: classes7.dex */
public final class C15880f {
    public static final PromotionResult a(HybrisPromotionResult hybrisPromotionResult) {
        ...
        if (listA != null) {
            ...
            while (it.hasNext()) {
                arrayList.add(C15878d.a((HybrisPromotionOrderEntryConsumed) it.next()));
            }
        } else {
            arrayList = null;
        }
        ...
        return new PromotionResult(arrayList, description, promotion != null ? C15877c.a(promotion) : null);
    }
}
