...
public final class j {
    ...
    public static Function3<B, Composer, Integer, Unit> f59849b = ComposableLambdaKt.composableLambdaInstance(-1783408023, false, a.f59850a);

    @Metadata(k = 3, mv = {2, 0, 0}, xi = 48)
    static final class a implements Function3<B, Composer, Integer, Unit> {

        /* renamed from: a, reason: collision with root package name */
        public static final a f59850a = new a();
        ...
        public final void a(B b10, Composer composer, int i10) {
            ...
            if ((i11 & 91) == 18 && composer.j()) {
                ...
                z.e(b10, null, null, null, null, null, 0.0f, null, false, composer, i11 & 14, l3.f92484c);
            }
        }
