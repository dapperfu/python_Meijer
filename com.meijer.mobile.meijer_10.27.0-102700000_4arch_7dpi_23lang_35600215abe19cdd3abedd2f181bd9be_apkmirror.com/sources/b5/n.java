...
public final class n extends Modifier.c implements InterfaceC5823t, androidx.compose.ui.node.D {
    ...
    public final void Q2(C5347r0 c5347r0) {
        this.colorFilter = c5347r0;
    }

    public final void R2(InterfaceC5784k interfaceC5784k) {
    ...
    public n(Z0.c cVar, P0.e eVar, InterfaceC5784k interfaceC5784k, float f10, C5347r0 c5347r0) {
        this.painter = cVar;
        this.alignment = eVar;
        this.contentScale = interfaceC5784k;
        this.alpha = f10;
    ...
    public J a(K k10, I i10, long j10) {
        ...
        return K.G0(k10, f0VarK0.getWidth(), f0VarK0.getHeight(), null, new Function1() { // from class: b5.m
