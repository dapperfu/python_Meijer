...
public final class o extends Z0.c {
    ...
    private final InterfaceC5726j0 invalidateTick = C5702c1.a(0);

    /* renamed from: n, reason: collision with root package name and from kotlin metadata */
    private long startTimeMillis = -1;

    /* renamed from: p, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5724i0 maxAlpha = A0.a(1.0f);
    ...
    private final void t(C5347r0 c5347r0) {
        this.colorFilter.setValue(c5347r0);
    }

    private final void u(int i10) {
        this.invalidateTick.j(i10);
    }
    ...
    public o(Z0.c cVar, Z0.c cVar2, InterfaceC5784k interfaceC5784k, int i10, boolean z10, boolean z11) {
        this.start = cVar;
        this.end = cVar2;
