...
import com.google.android.gms.internal.ads.C6770Go;
...
import com.google.android.gms.internal.ads.C7648c60;
import com.google.android.gms.internal.ads.C8263hu;
...
import com.google.android.gms.internal.ads.InterfaceC7148Rt;
import com.google.android.gms.internal.ads.InterfaceC7940et;
...
public final class D0 {
    ...
    public static final HandlerC6857Jd0 f25081l = new q0(Looper.getMainLooper());

    /* renamed from: g, reason: collision with root package name */
    private String f25088g;

    /* renamed from: h, reason: collision with root package name */
    private volatile String f25089h;

    /* renamed from: a, reason: collision with root package name */
    private final AtomicReference f25082a = new AtomicReference(null);

    /* renamed from: b, reason: collision with root package name */
    private final AtomicReference f25083b = new AtomicReference(null);

    /* renamed from: c, reason: collision with root package name */
    private final AtomicReference f25084c = new AtomicReference(new Bundle());

    /* renamed from: d, reason: collision with root package name */
    private final AtomicBoolean f25085d = new AtomicBoolean();

    /* renamed from: e, reason: collision with root package name */
    private boolean f25086e = true;

    /* renamed from: f, reason: collision with root package name */
    private final Object f25087f = new Object();

    /* renamed from: i, reason: collision with root package name */
    private boolean f25090i = false;

    /* renamed from: j, reason: collision with root package name */
    private boolean f25091j = false;

    /* renamed from: k, reason: collision with root package name */
    private final Executor f25092k = Executors.newSingleThreadExecutor();
    ...
    public static final T a(Context context) throws IllegalAccessException, InstantiationException, IllegalArgumentException, InvocationTargetException {
        try {
            ...
            if (!(objNewInstance instanceof IBinder)) {
                Qc.p.d("Instantiated WorkManagerUtil not instance of IBinder.");
                return null;
            }
            ...
            Lc.v.s().x(e10, "Failed to instantiate WorkManagerUtil");
            return null;
        }
    }
    ...
    public static final boolean f(Context context) {
        try {
            ...
            Qc.p.e("Error loading class.", th2);
            Lc.v.s().x(th2, "AdUtil.isLiteSdk");
            return false;
        }
    }
    ...
    public static int A(int i10) {
        ...
        Qc.p.g("HTTP timeout too low: " + i10 + " milliseconds. Reverting to default timeout: 60000 milliseconds.");
        return 60000;
    }
    ...
    private static final String F(final Context context, String str) {
        ...
        try {
            C4575j0 c4575j0A = C4575j0.a();
            if (TextUtils.isEmpty(c4575j0A.f25149a)) {
                if (com.google.android.gms.common.util.e.a()) {
                    str2 = (String) C4569g0.a(context, new Callable() { // from class: Pc.h0
                    ...
                    final Context contextC = C14250i.c(context);
                    str2 = (String) C4569g0.a(context, new Callable() { // from class: Pc.i0
                        @Override // java.util.concurrent.Callable
                        public final Object call() {
                ...
                c4575j0A.f25149a = str2;
            }
            strW = c4575j0A.f25149a;
        ...
        try {
            if (C16519f.a(context).g()) {
                str3 = str3 + ";aia";
            }
        } catch (Exception e10) {
            Lc.v.s().x(e10, "AdUtil.getUserAgent");
        }
        return str3.concat(")");
    }
    ...
    public static List I() {
        ...
        while (it.hasNext()) {
            Iterator it2 = C7200Tf0.b(AbstractC8981of0.b(',')).d((String) it.next()).iterator();
            while (it2.hasNext()) {
                try {
    ...
    public static final Map b0(String str) {
        ...
        try {
            ...
            Lc.v.s().x(e10, "AdUtil.getMapOfFileNamesToKeysFromJsonString");
            return map;
        }
    }
    ...
    public static final WebResourceResponse d0(Context context, String str, String str2) {
        try {
            HashMap map = new HashMap();
            map.put(HttpHeaders.USER_AGENT, Lc.v.t().H(context, str));
            ...
            Qc.p.h("Could not fetch MRAID JS.", e10);
        }
        return null;
    }
    ...
    public static final void k(View view, int i10, MotionEvent motionEvent) {
        ...
        try {
            ...
            int i13 = iArr[1];
            String str2 = "none";
            if (!(childAt instanceof InterfaceC7148Rt) || (c7648c60H = ((InterfaceC7148Rt) childAt).h()) == null) {
                str = "none";
            } else {
                str = c7648c60H.f73103b;
                childAt.setContentDescription(str + ":" + childAt.hashCode());
            }
            if ((childAt instanceof InterfaceC7940et) && (z50E = ((InterfaceC7940et) childAt).e()) != null) {
                strA = Z50.a(z50E.f72023b);
                i11 = z50E.f72029e;
                str2 = z50E.f71999E;
            }
            Qc.p.f(String.format(Locale.US, "<Ad hashCode=%d, package=%s, adNetCls=%s, gwsQueryId=%s, format=%s, impType=%d, class=%s, x=%d, y=%d, width=%d, height=%d, vWidth=%d, vHeight=%d, alpha=%d, state=%s>", Integer.valueOf(childAt.hashCode()), packageName, str2, str, strA, Integer.valueOf(i11), childAt.getClass().getName(), Integer.valueOf(i12), Integer.valueOf(i13), Integer.valueOf(childAt.getWidth()), Integer.valueOf(childAt.getHeight()), Integer.valueOf(iWidth), Integer.valueOf(iHeight), Long.valueOf(jC0), Integer.toString(i10, 2)));
        } catch (Exception e10) {
            Qc.p.e("Failure getting view location.", e10);
        }
    }
    ...
    public static final void n(Context context, Throwable th2) {
        ...
        try {
            if (((Boolean) C9730vg.f79104b.e()).booleanValue()) {
    ...
    public static final Map p(Uri uri) {
        ...
        if (!((Boolean) Mc.A.c().a(C8659lf.f76459p)).booleanValue()) {
            HashMap map = new HashMap();
    ...
    public static final void t(Context context, Intent intent) {
        if (!((Boolean) Mc.A.c().a(C8659lf.f76163Ta)).booleanValue()) {
            E(context, intent);
            return;
        }
        try {
            ...
            Qc.p.h("", e10);
            Lc.v.s().x(e10, "AdUtil.startActivityWithUnknownContext");
        }
    }
    ...
    public static final void u(Context context, Uri uri) {
        try {
            ...
            context.startActivity(intent);
            Qc.p.b("Opening " + uri.toString() + " in a new browser.");
        } catch (ActivityNotFoundException e10) {
            Qc.p.e("No browser is found.", e10);
        }
    }

    public static final void x(Context context, Intent intent, C9812wN c9812wN, String str) {
        if (!((Boolean) Mc.A.c().a(C8659lf.f76193Vc)).booleanValue() || !(context instanceof C8263hu)) {
            t(context, intent);
            return;
        }
        try {
            ...
            if (data != null && data.toString() != null) {
                if (data.toString().matches((String) Mc.A.c().a(C8659lf.f76221Xc))) {
                    ((C8263hu) context).c(intent, 236);
                    if (!((Boolean) Mc.A.c().a(C8659lf.f76207Wc)).booleanValue() || c9812wN == null) {
                        return;
                    }
                    C9705vN c9705vNA = c9812wN.a();
                    c9705vNA.b("action", "hila");
                    c9705vNA.b("gqi", C7267Vf0.c(str));
                    c9705vNA.f();
                    return;
                }
            }
            ...
            e = e10;
            Qc.p.e("Error occurred while starting activity for result", e);
            Lc.v.s().x(e, "AdUtil.startActivityForResult");
            t(context, intent);
            ...
            Qc.p.e("Error occurred while starting activity for result", e12);
            Lc.v.s().x(e12, "AdUtil.startActivityForResult");
            t(context, intent);
        }
    }
    ...
    public final com.google.common.util.concurrent.q G(final Uri uri) {
        return Mj0.j(new Callable() { // from class: Pc.y0
            @Override // java.util.concurrent.Callable
            public final Object call() {
    ...
    public final String H(Context context, String str) {
        if (((Boolean) Mc.A.c().a(C8659lf.f76331fb)).booleanValue()) {
            if (this.f25089h != null) {
                return this.f25089h;
            }
            this.f25089h = F(context, str);
            return this.f25089h;
        }
        synchronized (this.f25087f) {
            try {
                String str2 = this.f25088g;
                if (str2 != null) {
                    return str2;
                }
    ...
    final /* synthetic */ void L(Context context, String str, SharedPreferences sharedPreferences, String str2) {
        this.f25084c.set(C4564e.b(context, str));
    }

    public final boolean O(String str) {
        return C(str, this.f25082a, (String) Mc.A.c().a(C8659lf.f76446o0));
    }

    public final boolean P(String str) {
        return C(str, this.f25083b, (String) Mc.A.c().a(C8659lf.f76460p0));
    }
    ...
    public final int S(Context context, Uri uri) {
        ...
        if (((Boolean) Mc.A.c().a(C8659lf.f75975G4)).booleanValue()) {
            androidx.browser.customtabs.d dVarA = new d.C0965d(Lc.v.i().c()).a();
            dVarA.f47181a.setPackage(C10195zy0.a(context));
            dVarA.a(context, uri);
            return 5;
        }
        if (!((Boolean) Mc.A.c().a(C8659lf.f75947E4)).booleanValue()) {
            D(context, uri);
            return 9;
        }
        C6961Mf c6961Mf = new C6961Mf();
        c6961Mf.e(new z0(this, c6961Mf, context, uri));
        c6961Mf.b((Activity) context);
        return 5;
    }
    ...
    public static void M(Runnable runnable) {
        if (Looper.getMainLooper().getThread() != Thread.currentThread()) {
            ...
            C6908Kq.f68174a.execute(runnable);
        }
    }
    ...
    */
    public static final boolean T(android.view.View r2) {
        ...
        L2d:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: Pc.D0.T(android.view.View):boolean");
    }
    ...
    public static final boolean b(Context context, String str) {
        ...
        if (C16519f.a(contextA).b(str, contextA.getPackageName()) == 0) {
            return true;
        }
        return false;
    }
    ...
    public static final boolean d(String str) {
        ...
        if (!((Boolean) Mc.A.c().a(C8659lf.f76227Y4)).booleanValue()) {
            return false;
        }
        String str2 = (String) Mc.A.c().a(C8659lf.f76255a5);
        if (!str2.isEmpty()) {
        ...
        String str4 = (String) Mc.A.c().a(C8659lf.f76241Z4);
        if (str4.isEmpty()) {
            return true;
        }
    ...
    public static final String e0() {
        ...
        if (resourcesF != null) {
            return resourcesF.getString(Jc.d.f14775t);
        }
        return "Test Ad";
    }
    ...
    public static final int o(String str) {
        try {
            ...
            Qc.p.g("Could not parse value:".concat(e10.toString()));
            return 0;
        }
    }
    ...
    public static final int[] r(Activity activity) {
        ...
        return new int[]{C4169y.b().e(activity, iArrA0[0]), C4169y.b().e(activity, iArrA0[1])};
    }

    public static final boolean s(View view, PowerManager powerManager, KeyguardManager keyguardManager) {
        boolean z10;
        if (Lc.v.t().f25086e || keyguardManager == null || !keyguardManager.inKeyguardRestrictedInputMode() || T(view)) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (((Boolean) Mc.A.c().a(C8659lf.f76531u1)).booleanValue() && !view.getLocalVisibleRect(new Rect()) && !view.getGlobalVisibleRect(new Rect())) {
            return false;
        }
        if (((Boolean) Mc.A.c().a(C8659lf.f76568wa)).booleanValue()) {
    ...
    public static final int[] v(Activity activity) {
        ...
        return new int[]{C4169y.b().e(activity, iArrQ[0]), C4169y.b().e(activity, iArrQ[1])};
    }
    ...
    private static Bundle z(Context context) throws RemoteException {
        try {
            return C16519f.a(context).c(context.getPackageName(), 128).metaData;
    ...
    public final void K(Context context, String str, boolean z10, HttpURLConnection httpURLConnection, boolean z11, int i10) {
        int iA = A(i10);
        Qc.p.f("HTTP timeout: " + iA + " milliseconds.");
    ...
    public final void N(final Context context, final String str, String str2, Bundle bundle, boolean z10) {
        ...
        AbstractC7593bf abstractC7593bf = C8659lf.f76249a;
        bundle.putString("eids", TextUtils.join(",", Mc.A.a().a()));
        if (bundle.isEmpty()) {
            Qc.p.b("Empty or null bundle.");
        } else {
            final String str3 = (String) Mc.A.c().a(C8659lf.f76540ua);
            if (!this.f25085d.getAndSet(true)) {
                this.f25084c.set(C4564e.a(context, str3, new SharedPreferences.OnSharedPreferenceChangeListener() { // from class: Pc.x0
                    @Override // android.content.SharedPreferences.OnSharedPreferenceChangeListener
                    public final void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String str4) {
                        this.f25240a.L(context, str3, sharedPreferences, str4);
                    }
                }));
            }
            bundle.putAll((Bundle) this.f25084c.get());
        }
        C4169y.b();
        Qc.g.y(context, str, "gmob-apps", bundle, true, new Qc.f() { // from class: Pc.w0
            @Override // Qc.f
            public final Qc.t zza(String str4) {
                HandlerC6857Jd0 handlerC6857Jd0 = D0.f25081l;
                Lc.v.t();
