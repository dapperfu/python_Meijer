...
import com.google.android.gms.internal.ads.C7755d60;
...
public final class U {
            ...
            if (objOpt != null) {
                if (objOpt instanceof Boolean) {
                    ...
                    if (jSONArray.length() != 0) {
                        ...
                        if (objOpt2 == null) {
                            Qc.p.g("Expected JSONArray with at least 1 non-null element for key:".concat(String.valueOf(next)));
                            ...
                            Qc.p.g(String.format("JSONArray with unsupported type %s for key:%s", objOpt2.getClass().getCanonicalName(), next));
                        }
                    }
                } else if (objOpt instanceof JSONObject) {
                    bundle.putBundle(next, a((JSONObject) objOpt));
                } else {
                    Qc.p.g("Unsupported type for key:".concat(String.valueOf(next)));
                }
            }
        }
        return bundle;
    ...
    public static String m(C7755d60 c7755d60) throws JSONException, IOException {
        if (c7755d60 == null) {
            return null;
        }
        ...
        try {
            ...
            o(jsonWriter, c7755d60);
            jsonWriter.close();
            return stringWriter.toString();
        } catch (IOException e10) {
            Qc.p.e("Error when writing JSON.", e10);
            return null;
        }
    }
    ...
    private static void o(JsonWriter jsonWriter, Object obj) throws JSONException, IOException {
        ...
        if (obj instanceof C7755d60) {
            k(jsonWriter, ((C7755d60) obj).f73366d);
            return;
        }
