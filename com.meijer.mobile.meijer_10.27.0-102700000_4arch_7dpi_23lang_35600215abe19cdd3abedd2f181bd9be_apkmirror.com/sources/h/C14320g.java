...
public final class C14320g extends AbstractC14314a<String[], Map<String, Boolean>> {
    ...
    public AbstractC14314a.C2118a<Map<String, Boolean>> b(Context context, String[] input) {
        Intrinsics.j(context, "context");
        Intrinsics.j(input, "input");
        if (input.length == 0) {
            return new AbstractC14314a.C2118a<>(MapsKt.k());
        }
        ...
        return new AbstractC14314a.C2118a<>(linkedHashMap);
    }
}
