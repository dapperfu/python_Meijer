...
public final class x {
    public static boolean d(Type type, Type type2) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            return d(parameterizedType.getOwnerType(), parameterizedType2.getOwnerType()) && parameterizedType.getRawType().equals(parameterizedType2.getRawType()) && Arrays.equals(parameterizedType instanceof c.b ? ((c.b) parameterizedType).f134105c : parameterizedType.getActualTypeArguments(), parameterizedType2 instanceof c.b ? ((c.b) parameterizedType2).f134105c : parameterizedType2.getActualTypeArguments());
        }
    ...
    public static WildcardType l(Type type) {
        return new c.C2117c(type instanceof WildcardType ? ((WildcardType) type).getUpperBounds() : new Type[]{type}, gu.c.f134098b);
    }

    public static WildcardType m(Type type) {
        return new c.C2117c(new Type[]{Object.class}, type instanceof WildcardType ? ((WildcardType) type).getLowerBounds() : new Type[]{type});
    }

    static Type f(Type type) {
        Class<?> clsG = g(type);
        return gu.c.q(type, clsG, clsG.getGenericSuperclass());
    }

    static Type h(Type type, Class<?> cls, Class<?> cls2) {
        if (cls2.isAssignableFrom(cls)) {
            return gu.c.q(type, cls, gu.c.e(type, cls, cls2));
        }
