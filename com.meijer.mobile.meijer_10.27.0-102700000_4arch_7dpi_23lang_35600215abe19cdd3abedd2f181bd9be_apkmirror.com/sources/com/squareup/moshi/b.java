...
final class b extends h<Object> {
    ...
    public static final h.e f126316c = new a();

    /* renamed from: a, reason: collision with root package name */
    private final Class<?> f126317a;

    /* renamed from: b, reason: collision with root package name */
    private final h<Object> f126318b;
    ...
    public Object fromJson(k kVar) throws IOException, ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
        ...
        kVar.a();
        while (kVar.hasNext()) {
            arrayList.add(this.f126318b.fromJson(kVar));
        }
        kVar.c();
        Object objNewInstance = Array.newInstance(this.f126317a, arrayList.size());
    ...
    public void toJson(q qVar, Object obj) throws IOException {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            this.f126318b.toJson(qVar, (q) Array.get(obj, i10));
        }
        qVar.d();
    }
}
