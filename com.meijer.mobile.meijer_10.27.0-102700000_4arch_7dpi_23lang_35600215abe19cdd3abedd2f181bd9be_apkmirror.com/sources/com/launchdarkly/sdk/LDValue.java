...
public abstract class LDValue implements com.launchdarkly.sdk.json.c {
    ...
    class a<T> implements f<LDValue, T> {
        ...
        public T apply(LDValue lDValue) {
            return (T) this.f91000a.a(lDValue);
        }
    }
    ...
    public static abstract class c {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final d<Boolean> f91003a = new a();

        /* renamed from: b, reason: collision with root package name */
        public static final d<Integer> f91004b = new b();

        /* renamed from: c, reason: collision with root package name */
        public static final d<Long> f91005c = new C1300c();

        /* renamed from: d, reason: collision with root package name */
        public static final d<Float> f91006d = new d();

        /* renamed from: e, reason: collision with root package name */
        public static final d<Double> f91007e = new e();

        /* renamed from: f, reason: collision with root package name */
        public static final d<String> f91008f = new f();
        ...
        static class C1300c extends d<Long> {
            C1300c() {
            }
    ...
    static /* synthetic */ class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f91002a;
        ...
        static {
            ...
            try {
                f91002a[i.NUMBER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f91002a[i.BOOLEAN.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f91002a[i.STRING.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f91002a[i.ARRAY.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f91002a[i.OBJECT.ordinal()] = 6;
