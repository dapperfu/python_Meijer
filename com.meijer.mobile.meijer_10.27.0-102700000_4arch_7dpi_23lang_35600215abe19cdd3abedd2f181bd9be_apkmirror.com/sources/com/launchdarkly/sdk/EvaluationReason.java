...
@InterfaceC15616b(EvaluationReasonTypeAdapter.class)
...
public final class EvaluationReason implements com.launchdarkly.sdk.json.c {
    ...
    static /* synthetic */ class a {
        ...
        static final /* synthetic */ int[] f90995a;

        /* renamed from: b, reason: collision with root package name */
        static final /* synthetic */ int[] f90996b;
        ...
        static {
            ...
            try {
                f90996b[ErrorKind.EXCEPTION.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f90996b[ErrorKind.FLAG_NOT_FOUND.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f90996b[ErrorKind.MALFORMED_FLAG.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f90996b[ErrorKind.USER_NOT_SPECIFIED.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f90996b[ErrorKind.WRONG_TYPE.ordinal()] = 6;
            ...
            try {
                f90995a[Kind.PREREQUISITE_FAILED.ordinal()] = 2;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f90995a[Kind.ERROR.ordinal()] = 3;
    ...
    public static EvaluationReason a(ErrorKind errorKind) {
        switch (a.f90996b[errorKind.ordinal()]) {
            case 1:
    ...
    public String toString() {
        int i10 = a.f90995a[this.kind.ordinal()];
        String str = "";
        if (i10 == 1) {
