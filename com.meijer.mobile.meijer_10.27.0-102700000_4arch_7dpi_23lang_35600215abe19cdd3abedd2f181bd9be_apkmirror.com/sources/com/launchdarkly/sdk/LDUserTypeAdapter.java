...
final class LDUserTypeAdapter extends TypeAdapter<h> {
    ...
    static final LDUserTypeAdapter f90999a = new LDUserTypeAdapter();
            ...
            switch (strNextName) {
                ...
                case "custom":
                    if (jsonReader.peek() != JsonToken.NULL) {
                        jsonReader.beginObject();
                        while (jsonReader.peek() != JsonToken.END_OBJECT) {
                            aVar.q(jsonReader.nextName(), LDValueTypeAdapter.f91009a.read(jsonReader));
                        }
    ...
    public void write(JsonWriter jsonWriter, h hVar) throws IOException {
        ...
        for (UserAttribute userAttribute : UserAttribute.f91020l.values()) {
            if (userAttribute != UserAttribute.f91019k || hVar.d()) {
                LDValue lDValueA = hVar.a(userAttribute);
                if (!lDValueA.k()) {
                    jsonWriter.name(userAttribute.b());
                    LDValueTypeAdapter.f91009a.write(jsonWriter, lDValueA);
                }
            }
        }
        boolean z10 = false;
        ...
        for (UserAttribute userAttribute2 : hVar.b()) {
            ...
            LDValueTypeAdapter.f91009a.write(jsonWriter, hVar.a(userAttribute2));
        }
        if (z11) {
