...
final class J {
    ...
    class a implements Comparator<b> {
        ...
        public int compare(b bVar, b bVar2) {
            return Long.compare(bVar.f91076b, bVar2.f91076b);
        }
    }
    ...
    J(List<b> list) {
        this.f91073a = list == null ? new ArrayList<>() : list;
    }
    ...
    public J b(int i10, List<String> list) {
        if (this.f91073a.size() <= i10 || i10 < 0) {
            return this;
        }
        List<b> list2 = this.f91073a;
        ...
        for (int i11 = 0; i11 < size; i11++) {
            list.add(((b) arrayList.get(0)).f91075a);
            arrayList.remove(0);
        }
        return new J(arrayList);
    }
    ...
    public String c() {
        ...
        try {
            ...
            for (b bVar : this.f91073a) {
                jsonWriter.beginArray();
                jsonWriter.value(bVar.f91075a);
                jsonWriter.value(bVar.f91076b);
                jsonWriter.endArray();
            }
            jsonWriter.endArray();
            jsonWriter.flush();
