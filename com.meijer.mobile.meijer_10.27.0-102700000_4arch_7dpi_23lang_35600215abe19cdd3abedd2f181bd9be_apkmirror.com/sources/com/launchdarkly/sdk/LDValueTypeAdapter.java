...
final class LDValueTypeAdapter extends TypeAdapter<LDValue> {
    ...
    static final LDValueTypeAdapter f91009a = new LDValueTypeAdapter();

    static /* synthetic */ class a {

        /* renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f91010a;
        ...
        static {
            ...
            try {
                f91010a[JsonToken.BEGIN_OBJECT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f91010a[JsonToken.BOOLEAN.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f91010a[JsonToken.NULL.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f91010a[JsonToken.NUMBER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f91010a[JsonToken.STRING.ordinal()] = 6;
    ...
    public LDValue read(JsonReader jsonReader) throws IOException {
        switch (a.f91010a[jsonReader.peek().ordinal()]) {
            case 1:
