...
public class e {
    static List<com.android.volley.e> a(List<com.android.volley.e> list, a.C1240a c1240a) {
        ...
        List<com.android.volley.e> list2 = c1240a.f62886h;
        if (list2 != null) {
            if (!list2.isEmpty()) {
                for (com.android.volley.e eVar : c1240a.f62886h) {
                    if (!treeSet.contains(eVar.a())) {
                        arrayList.add(eVar);
                    }
                }
            }
        } else if (!c1240a.f62885g.isEmpty()) {
            for (Map.Entry<String, String> entry : c1240a.f62885g.entrySet()) {
    ...
    static Map<String, String> c(a.C1240a c1240a) {
        if (c1240a == null) {
            return Collections.EMPTY_MAP;
        }
        HashMap map = new HashMap();
        String str = c1240a.f62880b;
        if (str != null) {
            map.put("If-None-Match", str);
        }
        long j10 = c1240a.f62882d;
        if (j10 > 0) {
    ...
    public static a.C1240a e(com.android.volley.h hVar) throws NumberFormatException {
        long j10;
        boolean z10;
        long j11;
        long j12;
        ...
        Map<String, String> map = hVar.f62915c;
        if (map == null) {
            return null;
        }
