...
public abstract class i<T> implements Comparable<i<T>> {
    ...
    class a implements Runnable {
        ...
        final /* synthetic */ String f62919a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ long f62920b;
        ...
        public void run() {
            i.this.mEventLog.a(this.f62919a, this.f62920b);
    ...
    public i(int i10, String str, k.a aVar) {
        this.mEventLog = n.a.f62945c ? new n.a() : null;
    ...
    public i<?> setCacheEntry(a.C1240a c1240a) {
        this.mCacheEntry = c1240a;
        return this;
    }
