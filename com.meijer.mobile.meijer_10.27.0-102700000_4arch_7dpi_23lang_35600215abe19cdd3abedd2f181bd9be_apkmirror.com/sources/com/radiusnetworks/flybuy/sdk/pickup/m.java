    ...
    public static final void a(PickupManager pickupManager) {
        ...
        if (locationPermissionStateCurrentLocationPermissionState != FlyBuyCore.INSTANCE.getLastLocationPermissionState() && !arrayList.isEmpty()) {
            ...
            while (it2.hasNext()) {
                ...
                OrdersManager.event$default(FlyBuyCore.getOrders(), new OrderEventInfo(((Order) it2.next()).getId(), OrderEventType.PERMISSION_UPDATE, null, null, null, null, null, null, null, locationPermissionState, null, null, null, null, null, null, null, null, 261628, null), null, 2, null);
