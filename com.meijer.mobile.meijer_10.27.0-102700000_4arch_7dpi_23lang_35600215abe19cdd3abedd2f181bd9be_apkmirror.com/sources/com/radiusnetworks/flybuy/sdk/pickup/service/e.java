...
public final class e extends Lambda implements Function0 {
    ...
    public final /* synthetic */ t f120033f;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(LocationService locationService) {
        super(0);
        this.f120033f = locationService;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        Context applicationContext = this.f120033f.getApplicationContext();
        Intrinsics.i(applicationContext, "getApplicationContext(...)");
        if (!PermissionExtensionsKt.hasBluetoothScanPermission(applicationContext)) {
            return null;
        }
        Object systemService = this.f120033f.getSystemService("bluetooth");
