...
public final class PlacesManager {
    ...
    public static final void suggest$lambda$1$lambda$0(PlacesManager this$0, String query, PlaceSuggestionOptions placeSuggestionOptions, Function2 callback) {
        PlaceType placeType;
        Intrinsics.j(this$0, "this$0");
        Intrinsics.j(query, "$query");
        Intrinsics.j(callback, "$callback");
        PlacesOperation placesOperation = this$0.getPlacesOperation();
        if (placeSuggestionOptions == null || (placeType = placeSuggestionOptions.getPlaceType()) == null) {
            placeType = PlaceType.ADDRESS;
        }
        placesOperation.suggest(query, placeType, placeSuggestionOptions != null ? placeSuggestionOptions.getLatitude() : null, placeSuggestionOptions != null ? placeSuggestionOptions.getLongitude() : null, callback);
    }
    ...
    public final void suggest(final String query, final PlaceSuggestionOptions options, final Function2<? super List<Place>, ? super SdkError, Unit> callback) throws Exception {
        ...
        try {
            ...
            Runnable runnable = new Runnable() { // from class: com.radiusnetworks.flybuy.sdk.manager.b
                @Override // java.lang.Runnable
                public final void run() {
                    PlacesManager.suggest$lambda$1$lambda$0(this.f119980a, query, options, callback);
                }
            };
