...
public final class OrdersOperation {
    ...
    public final AbstractC5985A<Order> getOrder(String redemptionCode) {
    ...
    public final AbstractC5985A<List<Order>> getAllLiveData() {
        return this.localOrdersRepository.getAllLiveData();
    }

    public final AbstractC5985A<List<BeaconRegion>> getBeaconRegionsForOrder(int orderId) {
    ...
    public final AbstractC5985A<List<Order>> getOpenLiveData() {
        return this.localOrdersRepository.getOpenLiveData();
    }

    public final AbstractC5985A<Order> getOrder(int id2) {
