...
public final class CustomerOperation {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        public static final class C19781 extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
            final /* synthetic */ Ref.ObjectRef<Customer> $user;
            int label;
            final /* synthetic */ CustomerOperation this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C19781(Ref.ObjectRef<Customer> objectRef, CustomerOperation customerOperation, Continuation<? super C19781> continuation) {
            ...
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C19781(this.$user, this.this$0, continuation);
            }

            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(InterfaceC16622O interfaceC16622O, Continuation<? super Unit> continuation) {
                return ((C19781) create(interfaceC16622O, continuation)).invokeSuspend(Unit.f142422a);
            }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                ResultKt.b(obj);
                C0 c0D = C16648k.d(C16623P.a(C16639f0.b()), null, null, new C19781(this.$user, this.this$0, null), 3, null);
                this.label = 1;
                if (c0D.n0(this) == objF) {
                    return objF;
                }
    ...
    public final Customer currentUser() throws InterruptedException {
        ...
        C16646j.b(null, new AnonymousClass1(objectRef, this, null), 1, null);
        return (Customer) objectRef.f142835a;
    }

    public final AbstractC5985A<List<Customer>> getCustomers() {
