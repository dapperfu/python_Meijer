...
public final class LocalOrdersDataStore$all$1 extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super List<? extends Order>>, Object> {
    Object L$0;
    int label;
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ResultKt.b(obj);
                this.$orders.f142835a = this.this$0.db.orderDao$core_defaultRelease().all();
    ...
    public final Object invoke2(InterfaceC16622O interfaceC16622O, Continuation<? super List<Order>> continuation) {
        return ((LocalOrdersDataStore$all$1) create(interfaceC16622O, continuation)).invokeSuspend(Unit.f142422a);
    }
