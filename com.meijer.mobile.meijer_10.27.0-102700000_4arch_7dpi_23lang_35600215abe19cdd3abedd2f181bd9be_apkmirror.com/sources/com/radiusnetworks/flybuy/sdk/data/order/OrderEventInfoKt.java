...
public final class OrderEventInfoKt {
    ...
    public static final OrderEventRequestData toApiOrderEvent(OrderEventInfo orderEventInfo) {
        ...
        return new OrderEventRequestData(orderId, apiOrderEventType, longitude, latitude, accuracy, speed, etaSeconds, customerState, arrayList, apiLocationPermissionState, state, customerRatingValue, customerRatingComments, spotIdentifier, possibleWrongSiteId, etaSource, locationAt != null ? locationAt.toString() : null, orderEventInfo.getPickupType());
    }
}
