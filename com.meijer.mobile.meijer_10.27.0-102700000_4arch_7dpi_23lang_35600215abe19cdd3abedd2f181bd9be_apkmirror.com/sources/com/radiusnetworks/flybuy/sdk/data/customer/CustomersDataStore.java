...
public final class CustomersDataStore implements CustomersRepository {
    ...
    public static final class C129902 extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super CustomerError>, Object> {
        int label;

        public C129902(Continuation<? super C129902> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return CustomersDataStore.this.new C129902(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(InterfaceC16622O interfaceC16622O, Continuation<? super CustomerError> continuation) {
            return ((C129902) create(interfaceC16622O, continuation)).invokeSuspend(Unit.f142422a);
        }
    ...
    public static final class C129951 extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        public static final class C19751 extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
            final /* synthetic */ Function1<SdkError, Unit> $callback;
            int label;
            ...
            public C19751(CustomersDataStore customersDataStore, Function1<? super SdkError, Unit> function1, Continuation<? super C19751> continuation) {
                super(2, continuation);
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C19751(this.this$0, this.$callback, continuation);
            }

            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(InterfaceC16622O interfaceC16622O, Continuation<? super Unit> continuation) {
                return ((C19751) create(interfaceC16622O, continuation)).invokeSuspend(Unit.f142422a);
            }
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C129951(Function1<? super SdkError, Unit> function1, Continuation<? super C129951> continuation) {
            super(2, continuation);
            this.$callback = function1;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C129951 c129951 = CustomersDataStore.this.new C129951(this.$callback, continuation);
            c129951.L$0 = obj;
            return c129951;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(InterfaceC16622O interfaceC16622O, Continuation<? super Unit> continuation) {
            return ((C129951) create(interfaceC16622O, continuation)).invokeSuspend(Unit.f142422a);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                C19751 c19751 = new C19751(CustomersDataStore.this, this.$callback, null);
                this.label = 1;
                if (C16644i.g(coroutineContext, c19751, this) == objF) {
                    return objF;
                }
            }
            return Unit.f142422a;
    ...
    @Override // com.radiusnetworks.flybuy.sdk.data.customer.CustomersRepository
    public AbstractC5985A<List<Customer>> getCustomers() {
        ...
        create(customerInfo, customerConsent, new Function2<Customer, SdkError, Unit>() { // from class: com.radiusnetworks.flybuy.sdk.data.customer.CustomersDataStore.signUp.1
            ...
            public final void invoke2(Customer customer, SdkError sdkError) {
                ...
                ApiExtensionsKt.executeApi(context, function0, anonymousClass2, function1, new Function2<Customer, SdkError, Unit>() { // from class: com.radiusnetworks.flybuy.sdk.data.customer.CustomersDataStore.signUp.1.4
                    ...
                    public static final class C19771 extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
                        int label;
                        final /* synthetic */ CustomersDataStore this$0;

                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        public C19771(CustomersDataStore customersDataStore, Continuation<? super C19771> continuation) {
                            super(2, continuation);
                            this.this$0 = customersDataStore;
                        }
                        ...
                        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                            return new C19771(this.this$0, continuation);
                        }

                        @Override // kotlin.jvm.functions.Function2
                        public final Object invoke(InterfaceC16622O interfaceC16622O, Continuation<? super Unit> continuation) {
                            return ((C19771) create(interfaceC16622O, continuation)).invokeSuspend(Unit.f142422a);
                        }
                    ...
                    public final void invoke2(Customer customer2, SdkError sdkError2) {
                        if (sdkError2 != null) {
                            C16648k.d(C16623P.a(C16639f0.b()), null, null, new C19771(customersDataStore2, null), 3, null);
                        }
    ...
    public final Object invokeLogout(Continuation<? super SdkError> continuation) {
        return C16644i.g(C16639f0.b(), new C129902(null), continuation);
    }

    @Override // com.radiusnetworks.flybuy.sdk.data.customer.CustomersRepository
    public void logout(Function1<? super SdkError, Unit> callback) {
        C16648k.d(C16623P.a(C16639f0.a()), null, null, new C129951(callback, null), 3, null);
    }
}
