...
public final class m extends Lambda implements Function0 {
    ...
    public final /* synthetic */ NotifyEventData f119943f;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public m(NotifyEventData notifyEventData) {
        super(0);
        this.f119943f = notifyEventData;
    }
    ...
    public final Object invoke() {
        ...
        return ((v) retrofit.create(v.class)).n(new NotifyEventRequest(this.f119943f));
    }
}
