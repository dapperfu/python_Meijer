...
public final /* data */ class ApiErrorResponse<T> extends ApiResponse<T> {
    ...
    public ApiErrorResponse(int i10, Map<String, ? extends List<String>> map, String str) {
        ...
        if (map == null || map.isEmpty()) {
            map = MapsKt.g(i10 != 401 ? i10 != 404 ? i10 != 422 ? i10 != 425 ? new Pair(zzbz.UNKNOWN_CONTENT_TYPE, CollectionsKt.e("Unknown error")) : new Pair("app_update", CollectionsKt.e("Please update to the latest version of the app")) : new Pair("unprocessable", CollectionsKt.e("Error processing input")) : new Pair("not_found", CollectionsKt.e("Not found")) : new Pair("unauthorized", CollectionsKt.e("Not authorized")));
        }
