...
public final /* data */ class Order {
    ...
    @InterfaceC15617c("arrived_at")
    private final String arrivedAt;

    @InterfaceC15617c("created_at")
    private final String createdAt;

    @InterfaceC15617c("curbside_localized_string")
    ...
    @InterfaceC15617c("customer_state_v2")
    private final String customerState;

    @InterfaceC15617c("display_detail")
    private final String displayDetail;

    @InterfaceC15617c("display_name")
    private final String displayName;

    @InterfaceC15617c("distance_filtering_disabled")
    private final boolean distanceFilteringDisabled;

    @InterfaceC15617c("estimated_ready_at")
    private final String estimatedReadyAt;

    @InterfaceC15617c("eta_at")
    ...
    @InterfaceC15617c("location_tracking_enabled")
    private final boolean locationTrackingEnabled;

    @InterfaceC15617c("order_fired_at")
    private final String orderFiredAt;

    @InterfaceC15617c("state_v2")
    ...
    @InterfaceC15617c("pickup_config_id")
    private final Integer pickupConfigId;

    @InterfaceC15617c("pickup_localized_string")
    ...
    @InterfaceC15617c("project_accent_text_color")
    private final String projectAccentTextColor;

    @InterfaceC15617c("project_logo_url")
    private final String projectLogoURL;

    @InterfaceC15617c("project_mobile_flow_always_show_vehicle_info_fields")
    ...
    public int hashCode() {
        ...
        boolean z10 = this.projectMobileFlowAlwaysShowVehicleInfoFields;
        int i10 = z10;
        if (z10 != 0) {
            i10 = 1;
        }
        int i11 = (iHashCode38 + i10) * 31;
        boolean z11 = this.projectMobileFlowCustomerNameEditingEnabled;
        int i12 = z11;
        if (z11 != 0) {
            i12 = 1;
        }
        int i13 = (i11 + i12) * 31;
        boolean z12 = this.projectMobileFlowPickupTypeSelectionEnabled;
        int i14 = z12;
        if (z12 != 0) {
            i14 = 1;
        }
        int i15 = (i13 + i14) * 31;
        boolean z13 = this.projectMobileFlowRequireVehicleInfoIfVisible;
        int i16 = z13;
        if (z13 != 0) {
            i16 = 1;
        }
        ...
        int iHashCode39 = (i17 + (str38 == null ? 0 : str38.hashCode())) * 31;
        String str39 = this.pickupLocalizedString;
        int iHashCode40 = (iHashCode39 + (str39 == null ? 0 : str39.hashCode())) * 31;
        boolean z14 = this.locationTrackingEnabled;
        int i18 = z14;
        if (z14 != 0) {
            i18 = 1;
        }
        int i19 = (iHashCode40 + i18) * 31;
        String str40 = this.spotIdentifier;
        int iHashCode41 = (i19 + (str40 == null ? 0 : str40.hashCode())) * 31;
        boolean z15 = this.spotIdentifierEntryEnabled;
        int i20 = z15;
        if (z15 != 0) {
            i20 = 1;
        }
        int i21 = (iHashCode41 + i20) * 31;
        String str41 = this.spotIdentifierInputType;
        int iHashCode42 = (i21 + (str41 == null ? 0 : str41.hashCode())) * 31;
        boolean z16 = this.wrongSiteDetectionEnabled;
        int i22 = z16;
        if (z16 != 0) {
            i22 = 1;
        }
        int i23 = (iHashCode42 + i22) * 31;
        boolean z17 = this.distanceFilteringDisabled;
        int i24 = (i23 + (z17 ? 1 : z17 ? 1 : 0)) * 31;
        Double d11 = this.wrongSiteSearchRadius;
        int iHashCode43 = (i24 + (d11 == null ? 0 : d11.hashCode())) * 31;
