...
public final /* data */ class Site {
    ...
    @InterfaceC15617c(PlaceTypes.COUNTRY)
    private final String country;

    @InterfaceC15617c("cover_photo_url")
    ...
    @InterfaceC15617c("geofence")
    private final Geofence geofence;
    private final int id;

    @InterfaceC15617c("instructions")
    private final String instructions;

    @InterfaceC15617c("latitude")
    private final String latitude;

    @InterfaceC15617c(PlaceTypes.LOCALITY)
    ...
    @InterfaceC15617c("region")
    private final String region;

    @InterfaceC15617c(PlaceTypes.STREET_ADDRESS)
    private final String streetAddress;
    private final String type;

    @InterfaceC15617c("wrong_site_arrival_radius")
