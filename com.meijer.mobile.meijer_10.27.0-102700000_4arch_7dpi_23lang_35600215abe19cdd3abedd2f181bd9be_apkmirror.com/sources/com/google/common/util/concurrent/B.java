...
class B<V> extends f.a<V> implements RunnableFuture<V> {
    ...
    private volatile o<?> f88055a;

    private final class a extends o<V> {

        /* renamed from: c, reason: collision with root package name */
        private final Callable<V> f88056c;

        a(Callable<V> callable) {
            this.f88056c = (Callable) Be.p.q(callable);
        }
        ...
        V g() throws Exception {
            return this.f88056c.call();
        }

        @Override // com.google.common.util.concurrent.o
        String h() {
            return this.f88056c.toString();
        }
    }
    ...
    protected void afterDone() {
        o<?> oVar;
        super.afterDone();
        if (wasInterrupted() && (oVar = this.f88055a) != null) {
            oVar.e();
        }
        this.f88055a = null;
    }
