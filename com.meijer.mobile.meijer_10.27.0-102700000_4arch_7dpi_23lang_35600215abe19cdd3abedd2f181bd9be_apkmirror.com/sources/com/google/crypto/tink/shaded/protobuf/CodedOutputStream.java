...
public abstract class CodedOutputStream extends AbstractC11311g {

    /* renamed from: c, reason: collision with root package name */
    private static final Logger f88262c = Logger.getLogger(CodedOutputStream.class.getName());

    /* renamed from: d, reason: collision with root package name */
    private static final boolean f88263d = o0.E();

    /* renamed from: a, reason: collision with root package name */
    C11315k f88264a;

    /* renamed from: b, reason: collision with root package name */
    private boolean f88265b;
    ...
    private static class b extends CodedOutputStream {
        ...
        @Override // com.google.crypto.tink.shaded.protobuf.CodedOutputStream
        public final void B0(int i10, AbstractC11312h abstractC11312h) throws IOException {
            L0(1, 3);
            M0(2, i10);
            i0(3, abstractC11312h);
            L0(1, 4);
        }
        ...
        @Override // com.google.crypto.tink.shaded.protobuf.CodedOutputStream
        public final void i0(int i10, AbstractC11312h abstractC11312h) throws IOException {
            L0(i10, 2);
            R0(abstractC11312h);
        }
        ...
        final void z0(int i10, Q q10, f0 f0Var) throws IOException {
            L0(i10, 2);
            N0(((AbstractC11305a) q10).k(f0Var));
            f0Var.j(q10, this.f88264a);
        }
        ...
        public final void N0(int i10) throws IOException {
            while ((i10 & (-128)) != 0) {
                try {
                    byte[] bArr = this.f88266e;
                    int i11 = this.f88269h;
                    this.f88269h = i11 + 1;
                    bArr[i11] = (byte) ((i10 | 128) & l3.f92484c);
                    i10 >>>= 7;
                } catch (IndexOutOfBoundsException e10) {
                    throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f88269h), Integer.valueOf(this.f88268g), 1), e10);
                }
            }
            byte[] bArr2 = this.f88266e;
            int i12 = this.f88269h;
            this.f88269h = i12 + 1;
            bArr2[i12] = (byte) i10;
        }
        ...
        public final void Q0(byte[] bArr, int i10, int i11) throws IOException {
            try {
                System.arraycopy(bArr, i10, this.f88266e, this.f88269h, i11);
                this.f88269h += i11;
            } catch (IndexOutOfBoundsException e10) {
                throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f88269h), Integer.valueOf(this.f88268g), Integer.valueOf(i11)), e10);
            }
        }

        public final void U0(String str) throws IOException {
            int i10 = this.f88269h;
            try {
                int iV = CodedOutputStream.V(str.length() * 3);
                int iV2 = CodedOutputStream.V(str.length());
                if (iV2 != iV) {
                    N0(p0.g(str));
                    this.f88269h = p0.f(str, this.f88266e, this.f88269h, e0());
                    return;
                }
                int i11 = i10 + iV2;
                this.f88269h = i11;
                int iF = p0.f(str, this.f88266e, i11, e0());
                this.f88269h = i10;
                N0((iF - i10) - iV2);
                this.f88269h = iF;
            } catch (p0.d e10) {
        ...
        @Override // com.google.crypto.tink.shaded.protobuf.CodedOutputStream
        public final int e0() {
            return this.f88268g - this.f88269h;
        }
        ...
        public final void P0(long j10) throws IOException {
            if (CodedOutputStream.f88263d && e0() >= 10) {
                while ((j10 & (-128)) != 0) {
                    byte[] bArr = this.f88266e;
                    int i10 = this.f88269h;
                    this.f88269h = i10 + 1;
                    o0.K(bArr, i10, (byte) ((((int) j10) | 128) & l3.f92484c));
                    j10 >>>= 7;
                }
                byte[] bArr2 = this.f88266e;
                int i11 = this.f88269h;
            ...
            byte[] bArr4 = this.f88266e;
            int i13 = this.f88269h;
            this.f88269h = i13 + 1;
            bArr4[i13] = (byte) j10;
        }

        public final void R0(AbstractC11312h abstractC11312h) throws IOException {
            N0(abstractC11312h.size());
            abstractC11312h.C(this);
        }
        ...
        @Override // com.google.crypto.tink.shaded.protobuf.CodedOutputStream, com.google.crypto.tink.shaded.protobuf.AbstractC11311g
    ...
    public static int I(int i10, AbstractC11312h abstractC11312h) {
        return (T(1) * 2) + U(2, i10) + g(3, abstractC11312h);
    }
    ...
    public abstract void B0(int i10, AbstractC11312h abstractC11312h) throws IOException;
    ...
    @Override // com.google.crypto.tink.shaded.protobuf.AbstractC11311g
    ...
    public abstract void i0(int i10, AbstractC11312h abstractC11312h) throws IOException;
    ...
    static int H(Q q10, f0 f0Var) {
        return C(((AbstractC11305a) q10).k(f0Var));
    }
    ...
    static int u(Q q10, f0 f0Var) {
        return ((AbstractC11305a) q10).k(f0Var);
    }

    final void a0(String str, p0.d dVar) throws IOException {
        f88262c.log(Level.WARNING, "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable) dVar);
        byte[] bytes = str.getBytes(C11329z.f88592b);
        try {
            N0(bytes.length);
    ...
    public static int S(String str) {
        ...
        try {
            ...
            length = str.getBytes(C11329z.f88592b).length;
        }
        return C(length);
    }
    ...
    public static int g(int i10, AbstractC11312h abstractC11312h) {
        return T(i10) + h(abstractC11312h);
    }

    public static int h(AbstractC11312h abstractC11312h) {
        return C(abstractC11312h.size());
    }
