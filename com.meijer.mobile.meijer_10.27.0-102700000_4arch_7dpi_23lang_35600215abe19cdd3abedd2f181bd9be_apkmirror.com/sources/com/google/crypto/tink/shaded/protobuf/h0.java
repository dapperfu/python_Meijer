...
final class h0 {
    ...
    private static final Class<?> f88354a = B();

    /* renamed from: b, reason: collision with root package name */
    private static final l0<?, ?> f88355b = C();

    /* renamed from: c, reason: collision with root package name */
    private static final l0<?, ?> f88356c = new n0();
    ...
    static <UT, UB> UB A(Object obj, int i10, List<Integer> list, C11329z.e eVar, UB ub2, l0<UT, UB> l0Var) {
        if (eVar == null) {
            return ub2;
        }
    ...
    public static void H(Class<?> cls) {
        Class<?> cls2;
        if (!AbstractC11327x.class.isAssignableFrom(cls) && !b0.f88318d && (cls2 = f88354a) != null && !cls2.isAssignableFrom(cls)) {
    ...
    public static void N(int i10, List<AbstractC11312h> list, r0 r0Var) throws IOException {
        if (list == null || list.isEmpty()) {
            return;
        }
        r0Var.I(i10, list);
    ...
    static <UT, UB> UB z(Object obj, int i10, List<Integer> list, C11329z.d<?> dVar, UB ub2, l0<UT, UB> l0Var) {
        if (dVar == null) {
            return ub2;
        }
        if (!(list instanceof RandomAccess)) {
    ...
    static <T, FT extends C11323t.b<FT>> void E(AbstractC11320p<FT> abstractC11320p, T t10, T t11) {
        C11323t<T> c11323tC = abstractC11320p.c(t11);
        if (!c11323tC.m()) {
            abstractC11320p.d(t10).u(c11323tC);
        }
    }
    ...
    static int c(int i10, List<AbstractC11312h> list) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
    ...
    static int e(List<Integer> list) {
        ...
        if (list instanceof C11328y) {
            ...
            int iL = 0;
            while (i10 < size) {
                iL += CodedOutputStream.l(c11328y.getInt(i10));
                i10++;
            }
            return iL;
        }
    ...
    static int l(List<Integer> list) {
        ...
        if (list instanceof C11328y) {
            ...
            int iW = 0;
            while (i10 < size) {
                iW += CodedOutputStream.w(c11328y.getInt(i10));
                i10++;
            }
            return iW;
        }
    ...
    static int r(List<Integer> list) {
        ...
        if (list instanceof C11328y) {
            ...
            int iO = 0;
            while (i10 < size) {
                iO += CodedOutputStream.O(c11328y.getInt(i10));
                i10++;
            }
            return iO;
        }
    ...
    static int u(int i10, List<?> list) {
        ...
        if (list instanceof D) {
            ...
            while (i11 < size) {
                ...
                if (objC instanceof AbstractC11312h) {
                    iS2 = CodedOutputStream.h((AbstractC11312h) objC);
                } else {
        ...
        while (i11 < size) {
            ...
            if (obj instanceof AbstractC11312h) {
                iS = CodedOutputStream.h((AbstractC11312h) obj);
            } else {
    ...
    static int w(List<Integer> list) {
        ...
        if (list instanceof C11328y) {
            ...
            int iV = 0;
            while (i10 < size) {
                iV += CodedOutputStream.V(c11328y.getInt(i10));
                i10++;
            }
            return iV;
        }
