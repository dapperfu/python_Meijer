...
final class U<T> implements f0<T> {
    ...
    private static final int[] f88286r = new int[0];

    /* renamed from: s, reason: collision with root package name */
    private static final Unsafe f88287s = o0.D();

    /* renamed from: a, reason: collision with root package name */
    private final int[] f88288a;

    /* renamed from: b, reason: collision with root package name */
    private final Object[] f88289b;
    ...
    private final Q f88292e;

    /* renamed from: f, reason: collision with root package name */
    private final boolean f88293f;

    /* renamed from: g, reason: collision with root package name */
    private final boolean f88294g;

    /* renamed from: h, reason: collision with root package name */
    private final a0 f88295h;

    /* renamed from: i, reason: collision with root package name */
    private final boolean f88296i;

    /* renamed from: j, reason: collision with root package name */
    private final int[] f88297j;

    /* renamed from: k, reason: collision with root package name */
    private final int f88298k;

    /* renamed from: l, reason: collision with root package name */
    private final int f88299l;

    /* renamed from: m, reason: collision with root package name */
    private final W f88300m;

    /* renamed from: n, reason: collision with root package name */
    private final E f88301n;

    /* renamed from: o, reason: collision with root package name */
    private final l0<?, ?> f88302o;

    /* renamed from: p, reason: collision with root package name */
    private final AbstractC11320p<?> f88303p;

    /* renamed from: q, reason: collision with root package name */
    private final L f88304q;
    ...
    public void h(T t10, byte[] bArr, int i10, int i11, C11309e.b bVar) throws IOException {
        d0(t10, bArr, i10, i11, 0, bVar);
    }

    private boolean F(T t10, int i10, int i11) {
        if (this.f88304q.e(o0.C(t10, W(i10))).isEmpty()) {
            return true;
        }
        this.f88304q.b(u(i11));
        throw null;
    }
    ...
    /*  JADX ERROR: Type inference failed
        ...
        */
    private <UT, UB, ET extends com.google.crypto.tink.shaded.protobuf.C11323t.b<ET>> void L(com.google.crypto.tink.shaded.protobuf.l0<UT, UB> r18, com.google.crypto.tink.shaded.protobuf.AbstractC11320p<ET> r19, T r20, com.google.crypto.tink.shaded.protobuf.e0 r21, com.google.crypto.tink.shaded.protobuf.C11319o r22) throws java.io.IOException {
        /*
    ...
    static <T> U<T> S(Class<T> cls, O o10, W w10, E e10, l0<?, ?> l0Var, AbstractC11320p<?> abstractC11320p, L l10) {
        return o10 instanceof d0 ? U((d0) o10, w10, e10, l0Var, abstractC11320p, l10) : T((j0) o10, w10, e10, l0Var, abstractC11320p, l10);
    }

    private int V(int i10) {
        return this.f88288a[i10];
    }

    private <K, V> int c0(T t10, byte[] bArr, int i10, int i11, int i12, long j10, C11309e.b bVar) throws IOException {
        Unsafe unsafe = f88287s;
        Object objU = u(i12);
        Object object = unsafe.getObject(t10, j10);
        if (this.f88304q.h(object)) {
            Object objD = this.f88304q.d(objU);
            this.f88304q.a(objD, object);
            unsafe.putObject(t10, j10, objD);
            object = objD;
        }
        this.f88304q.b(objU);
        return n(bArr, i10, i11, null, this.f88304q.c(object), bVar);
    }

    private int e0(T t10, byte[] bArr, int i10, int i11, int i12, int i13, int i14, int i15, int i16, long j10, int i17, C11309e.b bVar) throws IOException {
        Unsafe unsafe = f88287s;
        long j11 = this.f88288a[i17 + 2] & 1048575;
        switch (i16) {
            case 51:
                if (i14 != 1) {
                    return i10;
                }
                unsafe.putObject(t10, j10, Double.valueOf(C11309e.e(bArr, i10)));
                int i18 = i10 + 8;
            ...
            case 52:
                ...
                unsafe.putObject(t10, j10, Float.valueOf(C11309e.m(bArr, i10)));
                int i19 = i10 + 4;
                unsafe.putInt(t10, j11, i13);
                return i19;
            case 53:
            case 54:
                ...
                int iM = C11309e.M(bArr, i10, bVar);
                unsafe.putObject(t10, j10, Long.valueOf(bVar.f88335b));
                unsafe.putInt(t10, j11, i13);
                return iM;
            case 55:
            case 62:
                ...
                int iJ = C11309e.J(bArr, i10, bVar);
                unsafe.putObject(t10, j10, Integer.valueOf(bVar.f88334a));
                unsafe.putInt(t10, j11, i13);
                return iJ;
            case 56:
            case 65:
                ...
                unsafe.putObject(t10, j10, Long.valueOf(C11309e.k(bArr, i10)));
                int i20 = i10 + 8;
                unsafe.putInt(t10, j11, i13);
                return i20;
            case 57:
            case 64:
                ...
                unsafe.putObject(t10, j10, Integer.valueOf(C11309e.i(bArr, i10)));
                int i21 = i10 + 4;
                unsafe.putInt(t10, j11, i13);
                return i21;
            case 58:
                ...
                int iM2 = C11309e.M(bArr, i10, bVar);
                unsafe.putObject(t10, j10, Boolean.valueOf(bVar.f88335b != 0));
                unsafe.putInt(t10, j11, i13);
                return iM2;
            case 59:
                if (i14 != 2) {
                ...
                int iJ2 = C11309e.J(bArr, i10, bVar);
                int i22 = bVar.f88334a;
                if (i22 == 0) {
                    ...
                    unsafe.putObject(t10, j10, new String(bArr, iJ2, i22, C11329z.f88592b));
                    iJ2 += i22;
                }
                unsafe.putInt(t10, j11, i13);
                return iJ2;
            case 60:
                ...
                int iP = C11309e.P(objR, v(i17), bArr, i10, i11, bVar);
                s0(t10, i13, i17, objR);
                return iP;
            case 61:
                if (i14 != 2) {
                ...
                int iC = C11309e.c(bArr, i10, bVar);
                unsafe.putObject(t10, j10, bVar.f88336c);
                unsafe.putInt(t10, j11, i13);
                return iC;
            case 63:
                if (i14 != 0) {
                ...
                int iJ3 = C11309e.J(bArr, i10, bVar);
                int i23 = bVar.f88334a;
                C11329z.e eVarT = t(i17);
            ...
            case 66:
                ...
                int iJ4 = C11309e.J(bArr, i10, bVar);
                unsafe.putObject(t10, j10, Integer.valueOf(AbstractC11313i.c(bVar.f88334a)));
                unsafe.putInt(t10, j11, i13);
                return iJ4;
            case 67:
                if (i14 != 0) {
                ...
                int iM3 = C11309e.M(bArr, i10, bVar);
                unsafe.putObject(t10, j10, Long.valueOf(AbstractC11313i.d(bVar.f88335b)));
                unsafe.putInt(t10, j11, i13);
                return iM3;
            case 68:
                if (i14 == 3) {
                    Object objR2 = R(t10, i13, i17);
                    int iO = C11309e.O(objR2, v(i17), bArr, i10, i11, (i12 & (-8)) | 4, bVar);
    ...
    private int f0(T t10, byte[] bArr, int i10, int i11, int i12, int i13, int i14, int i15, long j10, int i16, long j11, C11309e.b bVar) throws IOException {
        int iK;
        Unsafe unsafe = f88287s;
        C11329z.i iVarB = (C11329z.i) unsafe.getObject(t10, j11);
        if (!iVarB.j()) {
            int size = iVarB.size();
            iVarB = iVarB.b(size == 0 ? 10 : size * 2);
            unsafe.putObject(t10, j11, iVarB);
        }
        C11329z.i iVar = iVarB;
        switch (i16) {
            case 18:
            case 35:
                if (i14 == 2) {
                    return C11309e.t(bArr, i10, iVar, bVar);
                }
                if (i14 == 1) {
                    return C11309e.f(i12, bArr, i10, i11, iVar, bVar);
                }
                return i10;
            case 19:
            case 36:
                if (i14 == 2) {
                    return C11309e.w(bArr, i10, iVar, bVar);
                }
                if (i14 == 5) {
                    return C11309e.n(i12, bArr, i10, i11, iVar, bVar);
                }
                return i10;
            case 20:
            case 21:
            ...
            case 38:
                if (i14 == 2) {
                    return C11309e.A(bArr, i10, iVar, bVar);
                }
                if (i14 == 0) {
                    return C11309e.N(i12, bArr, i10, i11, iVar, bVar);
                }
            ...
            case 43:
                if (i14 == 2) {
                    return C11309e.z(bArr, i10, iVar, bVar);
                }
                if (i14 == 0) {
                    return C11309e.K(i12, bArr, i10, i11, iVar, bVar);
                }
                return i10;
            case 23:
            case l3.f92486e /* 32 */:
            ...
            case 46:
                if (i14 == 2) {
                    return C11309e.v(bArr, i10, iVar, bVar);
                }
                if (i14 == 1) {
                    return C11309e.l(i12, bArr, i10, i11, iVar, bVar);
                }
                return i10;
            case 24:
            case 31:
            ...
            case 45:
                if (i14 == 2) {
                    return C11309e.u(bArr, i10, iVar, bVar);
                }
                if (i14 == 5) {
                    return C11309e.j(i12, bArr, i10, i11, iVar, bVar);
                }
                return i10;
            case 25:
            case 42:
                if (i14 == 2) {
                    return C11309e.s(bArr, i10, iVar, bVar);
                }
                if (i14 == 0) {
                    return C11309e.b(i12, bArr, i10, i11, iVar, bVar);
                }
                return i10;
            case 26:
                if (i14 == 2) {
                    return (j10 & 536870912) == 0 ? C11309e.E(i12, bArr, i10, i11, iVar, bVar) : C11309e.F(i12, bArr, i10, i11, iVar, bVar);
                }
                return i10;
            case 27:
                if (i14 == 2) {
                    return C11309e.r(v(i15), i12, bArr, i10, i11, iVar, bVar);
                }
                return i10;
            case 28:
                if (i14 == 2) {
                    return C11309e.d(i12, bArr, i10, i11, iVar, bVar);
                }
                return i10;
            case 30:
            case 44:
                if (i14 != 2) {
                    if (i14 == 0) {
                        iK = C11309e.K(i12, bArr, i10, i11, iVar, bVar);
                    }
                    return i10;
                }
                iK = C11309e.z(bArr, i10, iVar, bVar);
                h0.A(t10, i13, iVar, t(i15), null, this.f88302o);
                return iK;
            case 33:
            case 47:
                if (i14 == 2) {
                    return C11309e.x(bArr, i10, iVar, bVar);
                }
                if (i14 == 0) {
                    return C11309e.B(i12, bArr, i10, i11, iVar, bVar);
                }
            ...
            case 48:
                if (i14 == 2) {
                    return C11309e.y(bArr, i10, iVar, bVar);
                }
                if (i14 == 0) {
                    return C11309e.C(i12, bArr, i10, i11, iVar, bVar);
                }
                return i10;
            case 49:
                if (i14 == 3) {
                    return C11309e.p(v(i15), i12, bArr, i10, i11, iVar, bVar);
                }
                return i10;
            default:
                return i10;
    ...
    private int g0(int i10) {
        if (i10 < this.f88290c || i10 > this.f88291d) {
            return -1;
        }
        return q0(i10, 0);
    }
    ...
    private int i0(int i10) {
        return this.f88288a[i10 + 2];
    }

    private <E> void j0(Object obj, long j10, e0 e0Var, f0<E> f0Var, C11319o c11319o) throws IOException {
        e0Var.P(this.f88301n.c(obj, j10), f0Var, c11319o);
    }

    private int q0(int i10, int i11) {
        int length = (this.f88288a.length / 3) - 1;
        while (i11 <= length) {
    ...
    private <K, V, UT, UB> UB r(int i10, int i11, Map<K, V> map, C11329z.e eVar, UB ub2, l0<UT, UB> l0Var, Object obj) {
        this.f88304q.b(u(i10));
        ...
        while (it.hasNext()) {
            ...
            if (!eVar.a(((Integer) next.getValue()).intValue())) {
                ...
                AbstractC11312h.C1280h c1280hQ = AbstractC11312h.q(J.b(null, next.getKey(), next.getValue()));
                try {
                    J.d(c1280hQ.b(), null, next.getKey(), next.getValue());
                    l0Var.d(ub2, i11, c1280hQ.a());
                    it.remove();
    ...
    private void r0(T t10, int i10, Object obj) {
        f88287s.putObject(t10, W(u0(i10)), obj);
        o0(t10, i10);
    }

    private void s0(T t10, int i10, int i11, Object obj) {
        f88287s.putObject(t10, W(u0(i11)), obj);
        p0(t10, i10, i11);
    }

    private C11329z.e t(int i10) {
        return (C11329z.e) this.f88289b[((i10 / 3) * 2) + 1];
    }

    private Object u(int i10) {
        return this.f88289b[(i10 / 3) * 2];
    }

    private int u0(int i10) {
        return this.f88288a[i10 + 1];
    }

    private f0 v(int i10) {
        int i11 = (i10 / 3) * 2;
        f0 f0Var = (f0) this.f88289b[i11];
        if (f0Var != null) {
            return f0Var;
        }
        f0<T> f0VarC = b0.a().c((Class) this.f88289b[i11 + 1]);
        this.f88289b[i11] = f0VarC;
        return f0VarC;
    }
    ...
    */
    ...
    static m0 w(Object obj) {
        AbstractC11327x abstractC11327x = (AbstractC11327x) obj;
        m0 m0Var = abstractC11327x.unknownFields;
        if (m0Var != m0.c()) {
            return m0Var;
        }
        m0 m0VarK = m0.k();
        abstractC11327x.unknownFields = m0VarK;
        return m0VarK;
    }
    ...
    */
    ...
    private <K, V> void x0(r0 r0Var, int i10, Object obj, int i11) throws IOException {
        if (obj != null) {
            this.f88304q.b(u(i11));
            r0Var.J(i10, null, this.f88304q.e(obj));
        }
    }
    ...
    private void y0(int i10, Object obj, r0 r0Var) throws IOException {
        if (obj instanceof String) {
            ...
            r0Var.M(i10, (AbstractC11312h) obj);
        }
    }
    ...
    public int b(T t10) {
        int i10;
        int iF;
        int length = this.f88288a.length;
        int i11 = 0;
        for (int i12 = 0; i12 < length; i12 += 3) {
            ...
            switch (t0(iU0)) {
                case 0:
                    i10 = i11 * 53;
                    iF = C11329z.f(Double.doubleToLongBits(o0.x(t10, jW)));
                    i11 = i10 + iF;
                    break;
                case 1:
                    i10 = i11 * 53;
                ...
                case 51:
                    if (I(t10, iV, i12)) {
                        i10 = i11 * 53;
                        iF = C11329z.f(Double.doubleToLongBits(Y(t10, jW)));
                        i11 = i10 + iF;
                        break;
                    } else {
                        break;
        ...
        int iHashCode2 = (i11 * 53) + this.f88302o.g(t10).hashCode();
        return this.f88293f ? (iHashCode2 * 53) + this.f88303p.c(t10).hashCode() : iHashCode2;
    }
    ...
    public boolean c(T t10, T t11) {
        ...
        if (!this.f88302o.g(t10).equals(this.f88302o.g(t11))) {
            return false;
        }
        if (this.f88293f) {
            return this.f88303p.c(t10).equals(this.f88303p.c(t11));
        }
        return true;
    }
    ...
    @Override // com.google.crypto.tink.shaded.protobuf.f0
    public T d() {
        return (T) this.f88300m.a(this.f88292e);
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    int d0(T r27, byte[] r28, int r29, int r30, int r31, com.google.crypto.tink.shaded.protobuf.C11309e.b r32) throws java.io.IOException {
        /*
    ...
    public int g(T t10) {
        ...
        int i16 = 0;
        int i17 = 1048575;
        while (i14 < u10.f88288a.length) {
            int iU0 = u10.u0(i14);
            int iT0 = t0(iU0);
            int iV2 = u10.V(i14);
            int i18 = u10.f88288a[i14 + 2];
            int i19 = i18 & i13;
            if (iT0 <= 17) {
                if (i19 != i17) {
            ...
            int i20 = i16;
            long jW = W(iU0);
            if (iT0 < EnumC11324u.f88513O.a() || iT0 > EnumC11324u.f88526b0.a()) {
                i19 = 0;
            }
            switch (iT0) {
                case 0:
                ...
                case 8:
                    if (u10.B(t11, i14, i17, i15, i10)) {
                        ...
                        iX = object instanceof AbstractC11312h ? CodedOutputStream.g(iV2, (AbstractC11312h) object) : CodedOutputStream.R(iV2, (String) object);
                        i16 = i20 + iX;
                        u10 = this;
                        break;
                    }
                ...
                case 10:
                    if (u10.B(t11, i14, i17, i15, i10)) {
                        iX = CodedOutputStream.g(iV2, (AbstractC11312h) unsafe.getObject(t11, jW));
                        i16 = i20 + iX;
                        u10 = this;
                        break;
                    }
                ...
                case 49:
                    ...
                    break;
                case 50:
                    i11 = u10.f88304q.g(iV2, unsafe.getObject(t11, jW), u10.u(i14));
                    i16 = i20 + i11;
                    break;
                case 51:
                ...
                case 59:
                    if (u10.I(t11, iV2, i14)) {
                        ...
                        i11 = object2 instanceof AbstractC11312h ? CodedOutputStream.g(iV2, (AbstractC11312h) object2) : CodedOutputStream.R(iV2, (String) object2);
                        i16 = i20 + i11;
                        break;
                    }
                    i16 = i20;
                ...
                case 61:
                    if (u10.I(t11, iV2, i14)) {
                        i11 = CodedOutputStream.g(iV2, (AbstractC11312h) unsafe.getObject(t11, jW));
                        i16 = i20 + i11;
                        break;
                    }
                    i16 = i20;
        ...
        int iX2 = i16 + u10.x(u10.f88302o, t11);
        return u10.f88293f ? iX2 + u10.f88303p.c(t11).l() : iX2;
    }

    private U(int[] iArr, Object[] objArr, int i10, int i11, Q q10, a0 a0Var, boolean z10, int[] iArr2, int i12, int i13, W w10, E e10, l0<?, ?> l0Var, AbstractC11320p<?> abstractC11320p, L l10) {
        boolean z11;
        this.f88288a = iArr;
        this.f88289b = objArr;
        this.f88290c = i10;
        this.f88291d = i11;
        this.f88294g = q10 instanceof AbstractC11327x;
        this.f88295h = a0Var;
        if (abstractC11320p != null && abstractC11320p.e(q10)) {
            z11 = true;
        } else {
            z11 = false;
        }
            ...
            switch (t0(iU0)) {
                ...
                case 8:
                    ...
                    if (objC instanceof String) {
                        ...
                        break;
                    } else if (objC instanceof AbstractC11312h) {
                        zEquals = AbstractC11312h.f88342b.equals(objC);
                        break;
                    } else {
                ...
                case 9:
                    ...
                    return true;
                case 10:
                    zEquals = AbstractC11312h.f88342b.equals(o0.C(t10, jW));
                    break;
                case 11:
                    if (o0.z(t10, jW) == 0) {
                        return false;
    ...
    private final <K, V> void M(Object obj, int i10, Object obj2, C11319o c11319o, e0 e0Var) throws IOException {
        long jW = W(u0(i10));
        Object objC = o0.C(obj, jW);
        if (objC == null) {
            objC = this.f88304q.d(obj2);
            o0.R(obj, jW, objC);
        } else if (this.f88304q.h(objC)) {
            Object objD = this.f88304q.d(obj2);
            this.f88304q.a(objD, objC);
            o0.R(obj, jW, objD);
            objC = objD;
        }
        Map<?, ?> mapC = this.f88304q.c(objC);
        this.f88304q.b(obj2);
        e0Var.L(mapC, null, c11319o);
    }
    ...
    private void P(T t10, T t11, int i10) {
        ...
        switch (t0(iU0)) {
            ...
            case 48:
            case 49:
                this.f88301n.b(t10, t11, jW);
                break;
            case 50:
                h0.F(this.f88304q, t10, t11, jW);
                break;
            case 51:
            case 52:
            case 53:
    ...
    private Object Q(T t10, int i10) {
        ...
        Object object = f88287s.getObject(t10, jW);
        if (G(object)) {
            return object;
        }
        Object objD = f0VarV.d();
    ...
    private Object R(T t10, int i10, int i11) {
        ...
        Object object = f88287s.getObject(t10, W(u0(i11)));
        if (G(object)) {
            return object;
        }
        Object objD = f0VarV.d();
    ...
    static <T> U<T> T(j0 j0Var, W w10, E e10, l0<?, ?> l0Var, AbstractC11320p<?> abstractC11320p, L l10) {
        C11322s[] c11322sArrE = j0Var.e();
        if (c11322sArrE.length == 0) {
            int length = c11322sArrE.length;
            ...
            if (c11322sArrE.length <= 0) {
                ...
                if (c11322sArrE.length <= 0) {
                    ...
                    return new U<>(iArr, objArr, 0, 0, j0Var.b(), j0Var.c(), true, iArr4, iArrD.length, iArrD.length + iArr2.length, w10, e10, l0Var, abstractC11320p, l10);
                }
                C11322s c11322s = c11322sArrE[0];
                throw null;
            }
            C11322s c11322s2 = c11322sArrE[0];
            throw null;
        }
        C11322s c11322s3 = c11322sArrE[0];
        throw null;
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    static <T> com.google.crypto.tink.shaded.protobuf.U<T> U(com.google.crypto.tink.shaded.protobuf.d0 r33, com.google.crypto.tink.shaded.protobuf.W r34, com.google.crypto.tink.shaded.protobuf.E r35, com.google.crypto.tink.shaded.protobuf.l0<?, ?> r36, com.google.crypto.tink.shaded.protobuf.AbstractC11320p<?> r37, com.google.crypto.tink.shaded.protobuf.L r38) {
        /*
    ...
    private <E> void k0(Object obj, int i10, e0 e0Var, f0<E> f0Var, C11319o c11319o) throws IOException {
        e0Var.N(this.f88301n.c(obj, W(i10)), f0Var, c11319o);
    }
    ...
    private void m0(Object obj, int i10, e0 e0Var) throws IOException {
        if (z(i10)) {
            e0Var.n(this.f88301n.c(obj, W(i10)));
        } else {
            e0Var.B(this.f88301n.c(obj, W(i10)));
        }
    }

    private <K, V> int n(byte[] bArr, int i10, int i11, J.a<K, V> aVar, Map<K, V> map, C11309e.b bVar) throws IOException {
        int iJ = C11309e.J(bArr, i10, bVar);
        int i12 = bVar.f88334a;
        if (i12 >= 0 && i12 <= i11 - iJ) {
            throw null;
        }
    ...
    private <UT, UB> UB q(Object obj, int i10, UB ub2, l0<UT, UB> l0Var, Object obj2) {
        ...
        return (UB) r(i10, iV, this.f88304q.c(objC), eVarT, ub2, l0Var, obj2);
    }
    ...
    public void a(T t10, T t11) {
        m(t10);
        t11.getClass();
        for (int i10 = 0; i10 < this.f88288a.length; i10 += 3) {
            P(t10, t11, i10);
        }
        h0.G(this.f88302o, t10, t11);
        if (this.f88293f) {
            h0.E(this.f88303p, t10, t11);
        }
    }
    ...
    */
    public void e(T r8) {
        /*
            ...
            goto L8e
        L8:
            boolean r0 = r8 instanceof com.google.crypto.tink.shaded.protobuf.AbstractC11327x
            if (r0 == 0) goto L18
            r0 = r8
            com.google.crypto.tink.shaded.protobuf.x r0 = (com.google.crypto.tink.shaded.protobuf.AbstractC11327x) r0
            r0.s()
            r0.r()
            r0.J()
        L18:
        ...
        L39:
            goto L7d
        L3a:
            sun.misc.Unsafe r2 = com.google.crypto.tink.shaded.protobuf.U.f88287s
            java.lang.Object r5 = r2.getObject(r8, r3)
            if (r5 == 0) goto L7d
            com.google.crypto.tink.shaded.protobuf.L r6 = r7.f88304q
            java.lang.Object r5 = r6.f(r5)
            r2.putObject(r8, r3, r5)
            goto L7d
        L4c:
            com.google.crypto.tink.shaded.protobuf.E r2 = r7.f88301n
            r2.a(r8, r3)
            goto L7d
        L52:
            int r2 = r7.V(r1)
            ...
            sun.misc.Unsafe r5 = com.google.crypto.tink.shaded.protobuf.U.f88287s
        ...
        L7d:
            ...
            goto L1c
        L80:
            com.google.crypto.tink.shaded.protobuf.l0<?, ?> r0 = r7.f88302o
            r0.j(r8)
            boolean r0 = r7.f88293f
            if (r0 == 0) goto L8e
            com.google.crypto.tink.shaded.protobuf.p<?> r0 = r7.f88303p
            r0.f(r8)
        L8e:
            return
        */
    ...
    */
    public final boolean f(T r15) {
        ...
        L7:
            ...
            if (r8 == r3) goto L32
            if (r8 == r0) goto L2f
            sun.misc.Unsafe r3 = com.google.crypto.tink.shaded.protobuf.U.f88287s
            long r6 = (long) r8
        ...
        L9b:
            r7 = r14
            r8 = r15
            boolean r15 = r7.f88293f
            if (r15 == 0) goto Lae
            com.google.crypto.tink.shaded.protobuf.p<?> r15 = r7.f88303p
    ...
    @Override // com.google.crypto.tink.shaded.protobuf.f0
    public void i(T t10, e0 e0Var, C11319o c11319o) throws IOException {
        c11319o.getClass();
        m(t10);
        L(this.f88302o, this.f88303p, t10, e0Var, c11319o);
    }
