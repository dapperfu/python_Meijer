...
interface r0 {
    ...
    void I(int i10, List<AbstractC11312h> list) throws IOException;

    <K, V> void J(int i10, J.a<K, V> aVar, Map<K, V> map) throws IOException;

    @Deprecated
    void K(int i10, Object obj, f0 f0Var) throws IOException;

    void L(int i10, List<?> list, f0 f0Var) throws IOException;

    void M(int i10, AbstractC11312h abstractC11312h) throws IOException;
