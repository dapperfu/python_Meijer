...
final class C11321q extends AbstractC11320p<AbstractC11327x.d> {

    /* renamed from: com.google.crypto.tink.shaded.protobuf.q$a */
    static /* synthetic */ class a {

        /* renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f88451a;
        ...
        static {
            ...
            try {
                f88451a[q0.b.f88457d.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f88451a[q0.b.f88458e.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f88451a[q0.b.f88459f.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f88451a[q0.b.f88460g.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f88451a[q0.b.f88461h.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f88451a[q0.b.f88462i.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f88451a[q0.b.f88463j.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f88451a[q0.b.f88468o.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f88451a[q0.b.f88470q.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f88451a[q0.b.f88471r.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f88451a[q0.b.f88472s.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f88451a[q0.b.f88473t.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f88451a[q0.b.f88469p.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f88451a[q0.b.f88467n.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f88451a[q0.b.f88464k.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f88451a[q0.b.f88465l.ordinal()] = 17;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f88451a[q0.b.f88466m.ordinal()] = 18;
            } catch (NoSuchFieldError unused18) {
            }
        }
    }

    @Override // com.google.crypto.tink.shaded.protobuf.AbstractC11320p
    C11323t<AbstractC11327x.d> c(Object obj) {
        return ((AbstractC11327x.c) obj).extensions;
    }

    @Override // com.google.crypto.tink.shaded.protobuf.AbstractC11320p
    C11323t<AbstractC11327x.d> d(Object obj) {
        return ((AbstractC11327x.c) obj).X();
    }

    @Override // com.google.crypto.tink.shaded.protobuf.AbstractC11320p
    boolean e(Q q10) {
        return q10 instanceof AbstractC11327x.c;
    }

    @Override // com.google.crypto.tink.shaded.protobuf.AbstractC11320p
    <UT, UB> UB g(Object obj, e0 e0Var, Object obj2, C11319o c11319o, C11323t<AbstractC11327x.d> c11323t, UB ub2, l0<UT, UB> l0Var) throws IOException {
        Object objValueOf;
        Object objI;
        ArrayList arrayList;
        AbstractC11327x.e eVar = (AbstractC11327x.e) obj2;
        int iC = eVar.c();
        if (eVar.f88579b.h() && eVar.f88579b.k()) {
            switch (a.f88451a[eVar.a().ordinal()]) {
                case 1:
                ...
                case 14:
                    arrayList = new ArrayList();
                    e0Var.j(arrayList);
                    ub2 = (UB) h0.z(obj, iC, arrayList, eVar.f88579b.b(), ub2, l0Var);
                    break;
                default:
                    throw new IllegalStateException("Type cannot be packed: " + eVar.f88579b.i());
            }
            c11323t.x(eVar.f88579b, arrayList);
            return ub2;
        }
            ...
            switch (a.f88451a[eVar.a().ordinal()]) {
                ...
                case 17:
                    if (!eVar.d()) {
                        ...
                        if (objI2 instanceof AbstractC11327x) {
                            f0 f0VarD = b0.a().d(objI2);
                            if (!((AbstractC11327x) objI2).H()) {
                                Object objD = f0VarD.d();
                                f0VarD.a(objD, objI2);
                                c11323t.x(eVar.f88579b, objD);
                                objI2 = objD;
                            }
                            e0Var.J(objI2, f0VarD, c11319o);
                            return ub2;
                        }
                    }
                    objValueOf = e0Var.K(eVar.b().getClass(), c11319o);
                    break;
                case 18:
                    if (!eVar.d()) {
                        Object objI3 = c11323t.i(eVar.f88579b);
                        if (objI3 instanceof AbstractC11327x) {
                            f0 f0VarD2 = b0.a().d(objI3);
                            if (!((AbstractC11327x) objI3).H()) {
                                Object objD2 = f0VarD2.d();
                                f0VarD2.a(objD2, objI3);
                                c11323t.x(eVar.f88579b, objD2);
                                objI3 = objD2;
                            }
                            e0Var.M(objI3, f0VarD2, c11319o);
                            return ub2;
                        }
                    }
                    objValueOf = e0Var.O(eVar.b().getClass(), c11319o);
                    break;
                default:
                    objValueOf = null;
                    break;
        ...
        int i10 = a.f88451a[eVar.a().ordinal()];
        if ((i10 == 17 || i10 == 18) && (objI = c11323t.i(eVar.f88579b)) != null) {
            objValueOf = C11329z.g(objI, objValueOf);
        }
    ...
    @Override // com.google.crypto.tink.shaded.protobuf.AbstractC11320p
    void h(e0 e0Var, Object obj, C11319o c11319o, C11323t<AbstractC11327x.d> c11323t) throws IOException {
        AbstractC11327x.e eVar = (AbstractC11327x.e) obj;
        c11323t.x(eVar.f88579b, e0Var.O(eVar.b().getClass(), c11319o));
    }

    @Override // com.google.crypto.tink.shaded.protobuf.AbstractC11320p
    void i(AbstractC11312h abstractC11312h, Object obj, C11319o c11319o, C11323t<AbstractC11327x.d> c11323t) throws IOException {
        AbstractC11327x.e eVar = (AbstractC11327x.e) obj;
        Q.a aVarD = eVar.b().d();
        AbstractC11313i abstractC11313iR = abstractC11312h.r();
        aVarD.l2(abstractC11313iR, c11319o);
        c11323t.x(eVar.f88579b, aVarD.h());
    ...
    int a(Map.Entry<?, ?> entry) {
        return ((AbstractC11327x.d) entry.getKey()).g();
    }

    @Override // com.google.crypto.tink.shaded.protobuf.AbstractC11320p
    Object b(C11319o c11319o, Q q10, int i10) {
        return c11319o.a(q10, i10);
    }
    ...
    void j(r0 r0Var, Map.Entry<?, ?> entry) throws IOException {
        AbstractC11327x.d dVar = (AbstractC11327x.d) entry.getKey();
        if (dVar.h()) {
            switch (a.f88451a[dVar.i().ordinal()]) {
                case 1:
        ...
        switch (a.f88451a[dVar.i().ordinal()]) {
            ...
            case 14:
                ...
                break;
            case 15:
                r0Var.M(dVar.g(), (AbstractC11312h) entry.getValue());
                break;
            case 16:
