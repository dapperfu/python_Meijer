...
abstract class e extends f<View> {
    ...
    public e() {
        this.f86276d = new Rect();
        this.f86277e = new Rect();
        this.f86278f = 0;
    }
    ...
    final int M(View view) {
        ...
        float fN = N(view);
        int i10 = this.f86279g;
        return C14329a.b((int) (fN * i10), 0, i10);
    }
    ...
    protected void J(CoordinatorLayout coordinatorLayout, View view, int i10) {
        ...
        if (viewL != null) {
            ...
            Rect rect2 = this.f86277e;
            r.a(R(fVar.f53633c), view.getMeasuredWidth(), view.getMeasuredHeight(), rect, rect2, i10);
            int iM = M(viewL);
            view.layout(rect2.left, rect2.top - iM, rect2.right, rect2.bottom - iM);
            this.f86278f = rect2.top - viewL.getBottom();
            return;
        }
