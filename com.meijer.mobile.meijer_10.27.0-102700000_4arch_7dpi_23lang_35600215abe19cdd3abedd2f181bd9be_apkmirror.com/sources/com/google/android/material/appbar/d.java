...
abstract class d<V extends View> extends f<V> {
    ...
    private Runnable f86266d;

    /* renamed from: e, reason: collision with root package name */
    OverScroller f86267e;

    /* renamed from: f, reason: collision with root package name */
    private boolean f86268f;
    ...
    private VelocityTracker f86272j;

    private class a implements Runnable {

        /* renamed from: a, reason: collision with root package name */
        private final CoordinatorLayout f86273a;

        /* renamed from: b, reason: collision with root package name */
        private final V f86274b;

        a(CoordinatorLayout coordinatorLayout, V v10) {
            this.f86273a = coordinatorLayout;
            this.f86274b = v10;
        }
        ...
        public void run() {
            ...
            if (this.f86274b == null || (overScroller = d.this.f86267e) == null) {
                return;
            }
            if (!overScroller.computeScrollOffset()) {
                d.this.R(this.f86273a, this.f86274b);
                return;
            }
            d dVar = d.this;
            dVar.T(this.f86273a, this.f86274b, dVar.f86267e.getCurrY());
            ViewCompat.e0(this.f86274b, this);
        }
    }
    ...
    private void M() {
        if (this.f86272j == null) {
            this.f86272j = VelocityTracker.obtain();
        }
    }

    final boolean N(CoordinatorLayout coordinatorLayout, V v10, int i10, int i11, float f10) {
        Runnable runnable = this.f86266d;
        if (runnable != null) {
            v10.removeCallbacks(runnable);
            this.f86266d = null;
        }
        if (this.f86267e == null) {
            this.f86267e = new OverScroller(v10.getContext());
        }
        this.f86267e.fling(0, I(), 0, Math.round(f10), 0, 0, i10, i11);
        if (!this.f86267e.computeScrollOffset()) {
    ...
    public boolean o(CoordinatorLayout coordinatorLayout, V v10, MotionEvent motionEvent) {
        ...
        if (this.f86271i < 0) {
            this.f86271i = ViewConfiguration.get(coordinatorLayout.getContext()).getScaledTouchSlop();
        }
        if (motionEvent.getActionMasked() == 2 && this.f86268f) {
            int i10 = this.f86269g;
            if (i10 == -1 || (iFindPointerIndex = motionEvent.findPointerIndex(i10)) == -1) {
                return false;
            }
            int y10 = (int) motionEvent.getY(iFindPointerIndex);
            if (Math.abs(y10 - this.f86270h) > this.f86271i) {
                this.f86270h = y10;
                return true;
            }
        }
        if (motionEvent.getActionMasked() == 0) {
            ...
            if (z10) {
                this.f86270h = y11;
                this.f86269g = motionEvent.getPointerId(0);
                M();
                OverScroller overScroller = this.f86267e;
                if (overScroller != null && !overScroller.isFinished()) {
                    this.f86267e.abortAnimation();
                    return true;
                }
            }
        }
        VelocityTracker velocityTracker = this.f86272j;
    ...
    */
    public boolean H(androidx.coordinatorlayout.widget.CoordinatorLayout r10, V r11, android.view.MotionEvent r12) {
        ...
        L4b:
            ...
            goto L80
        L4d:
            android.view.VelocityTracker r1 = r9.f86272j
            if (r1 == 0) goto L71
            r1.addMovement(r12)
            android.view.VelocityTracker r1 = r9.f86272j
        ...
        L72:
            r9.f86268f = r7
            r9.f86269g = r6
            android.view.VelocityTracker r2 = r9.f86272j
            if (r2 == 0) goto L80
            r2.recycle()
            r2 = 0
            r9.f86272j = r2
    ...
    int U(CoordinatorLayout coordinatorLayout, V v10, int i10, int i11, int i12) {
        int iB;
        int I10 = I();
        if (i11 != 0 && I10 >= i11 && I10 <= i12 && I10 != (iB = C14329a.b(i10, i11, i12))) {
            K(iB);
            return I10 - iB;
        }
        return 0;
