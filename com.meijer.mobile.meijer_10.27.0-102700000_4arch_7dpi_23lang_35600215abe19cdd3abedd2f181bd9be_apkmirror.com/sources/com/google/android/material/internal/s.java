...
public final class s {
    ...
    private static final int[] f87269a = {C5597b.f44537q};

    /* renamed from: b, reason: collision with root package name */
    private static final int[] f87270b = {C5597b.f44539r};

    public static void a(Context context) {
        e(context, f87269a, "Theme.AppCompat");
    }

    private static void b(Context context, AttributeSet attributeSet, int i10, int i11) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, ae.l.f45338sa, i10, i11);
        boolean z10 = typedArrayObtainStyledAttributes.getBoolean(ae.l.f45362ua, false);
        typedArrayObtainStyledAttributes.recycle();
        if (z10) {
            TypedValue typedValue = new TypedValue();
            if (!context.getTheme().resolveAttribute(C5597b.f44479A, typedValue, true) || (typedValue.type == 18 && typedValue.data == 0)) {
                c(context);
            }
        }
        a(context);
    ...
    public static void c(Context context) {
        e(context, f87270b, "Theme.MaterialComponents");
    }

    private static void d(Context context, AttributeSet attributeSet, int[] iArr, int i10, int i11, int... iArr2) {
        boolean zF;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, ae.l.f45338sa, i10, i11);
        if (!typedArrayObtainStyledAttributes.getBoolean(ae.l.f45374va, false)) {
            typedArrayObtainStyledAttributes.recycle();
            return;
        }
        if (iArr2 == null || iArr2.length == 0) {
            zF = typedArrayObtainStyledAttributes.getResourceId(ae.l.f45350ta, -1) != -1;
        } else {
    ...
    public static boolean g(Context context) {
        return C16025b.b(context, C5597b.f44549z, false);
    }
