...
public class d {
    ...
    private static final ThreadLocal<Matrix> f87191a = new ThreadLocal<>();

    /* renamed from: b, reason: collision with root package name */
    private static final ThreadLocal<RectF> f87192b = new ThreadLocal<>();

    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = f87191a;
        ...
        ThreadLocal<RectF> threadLocal2 = f87192b;
