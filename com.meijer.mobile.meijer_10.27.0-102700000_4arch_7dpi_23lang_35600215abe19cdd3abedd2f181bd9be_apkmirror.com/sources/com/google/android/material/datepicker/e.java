...
class e {
    static String a(Context context, long j10, boolean z10, boolean z11, boolean z12) {
        String strD = d(j10);
        if (z10) {
            strD = String.format(context.getString(ae.j.f44771y), strD);
        }
        if (z11) {
            return String.format(context.getString(ae.j.f44770x), strD);
        }
        if (z12) {
            return String.format(context.getString(ae.j.f44767u), strD);
        }
        return strD;
    }
    ...
    static String e(Context context, int i10) {
        if (q.g().get(1) == i10) {
            return String.format(context.getString(ae.j.f44768v), Integer.valueOf(i10));
        }
        return String.format(context.getString(ae.j.f44769w), Integer.valueOf(i10));
    }
