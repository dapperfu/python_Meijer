...
public class FabTransformationScrimBehavior extends ExpandableTransformationBehavior {
    ...
    private final C6238i f88009c;

    /* renamed from: d, reason: collision with root package name */
    private final C6238i f88010d;

    class a extends AnimatorListenerAdapter {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ boolean f88011a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ View f88012b;
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            this.f88012b.setVisibility(4);
        }

        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public void onAnimationStart(Animator animator) {
            if (this.f88011a) {
                this.f88012b.setVisibility(0);
            }
        }
    }

    public FabTransformationScrimBehavior() {
        this.f88009c = new C6238i(75L, 150L);
        this.f88010d = new C6238i(0L, 150L);
    }

    private void O(View view, boolean z10, boolean z11, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ObjectAnimator objectAnimatorOfFloat;
        C6238i c6238i = z10 ? this.f88009c : this.f88010d;
        if (z10) {
            if (!z11) {
                view.setAlpha(0.0f);
            }
