...
final class a extends d {
    ...
    final SideSheetBehavior<? extends View> f87394a;
    ...
    @Override // com.google.android.material.sidesheet.d
    int d() {
        return Math.max(0, this.f87394a.m0() + this.f87394a.k0());
    }

    @Override // com.google.android.material.sidesheet.d
    int e() {
        return (-this.f87394a.d0()) - this.f87394a.k0();
    }

    @Override // com.google.android.material.sidesheet.d
    int f() {
        return this.f87394a.k0();
    }

    @Override // com.google.android.material.sidesheet.d
    int g() {
        return -this.f87394a.d0();
    }
    ...
    <V extends View> int h(V v10) {
        return v10.getRight() + this.f87394a.k0();
    }
    ...
    boolean m(float f10, float f11) {
        if (e.a(f10, f11) && Math.abs(f10) > this.f87394a.o0()) {
            return true;
        }
        return false;
    }
    ...
    boolean n(View view, float f10) {
        if (Math.abs(view.getLeft() + (f10 * this.f87394a.i0())) > this.f87394a.j0()) {
            return true;
        }
        return false;
    }
