...
final class b extends d {
    ...
    final SideSheetBehavior<? extends View> f87395a;
    ...
    b(SideSheetBehavior<? extends View> sideSheetBehavior) {
        this.f87395a = sideSheetBehavior;
    }
    ...
    @Override // com.google.android.material.sidesheet.d
    int d() {
        return Math.max(0, (e() - this.f87395a.d0()) - this.f87395a.k0());
    }
    ...
    <V extends View> int h(V v10) {
        return v10.getLeft() - this.f87395a.k0();
    }
    ...
    boolean m(float f10, float f11) {
        if (e.a(f10, f11) && Math.abs(f10) > this.f87395a.o0()) {
            return true;
        }
        return false;
    }
    ...
    boolean n(View view, float f10) {
        if (Math.abs(view.getRight() + (f10 * this.f87395a.i0())) > this.f87395a.j0()) {
            return true;
        }
        return false;
    }
