...
abstract class c {
    ...
    class a extends c {
        ...
        final /* synthetic */ CarouselLayoutManager f86614b;
        ...
        a(int i10, CarouselLayoutManager carouselLayoutManager) {
            super(i10, null);
            this.f86614b = carouselLayoutManager;
        }
        ...
        @Override // com.google.android.material.carousel.c
        int g() {
            return this.f86614b.o0();
        }

        @Override // com.google.android.material.carousel.c
        int i() {
            return this.f86614b.getPaddingLeft();
        }

        @Override // com.google.android.material.carousel.c
        int j() {
            return this.f86614b.C0() - this.f86614b.getPaddingRight();
        }
        ...
        public void m(View view, int i10, int i11) {
            int i12 = i();
            this.f86614b.P0(view, i12, i10, i12 + p(view), i11);
        }

        int p(View view) {
            RecyclerView.q qVar = (RecyclerView.q) view.getLayoutParams();
            return this.f86614b.k0(view) + ((ViewGroup.MarginLayoutParams) qVar).leftMargin + ((ViewGroup.MarginLayoutParams) qVar).rightMargin;
        }
    }
    ...
    class b extends c {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ CarouselLayoutManager f86615b;
        ...
        b(int i10, CarouselLayoutManager carouselLayoutManager) {
            super(i10, null);
            this.f86615b = carouselLayoutManager;
        }
        ...
        @Override // com.google.android.material.carousel.c
        int g() {
            return this.f86615b.o0() - this.f86615b.getPaddingBottom();
        }

        @Override // com.google.android.material.carousel.c
        int h() {
            return this.f86615b.T2() ? i() : j();
        }

        @Override // com.google.android.material.carousel.c
        int j() {
            return this.f86615b.C0();
        }

        @Override // com.google.android.material.carousel.c
        int k() {
            return this.f86615b.T2() ? j() : i();
        }

        @Override // com.google.android.material.carousel.c
        int l() {
            return this.f86615b.getPaddingTop();
        }
        ...
        public void m(View view, int i10, int i11) {
            int iL = l();
            this.f86615b.P0(view, i10, iL, i11, iL + p(view));
        }

        int p(View view) {
            RecyclerView.q qVar = (RecyclerView.q) view.getLayoutParams();
            return this.f86615b.j0(view) + ((ViewGroup.MarginLayoutParams) qVar).topMargin + ((ViewGroup.MarginLayoutParams) qVar).bottomMargin;
        }
    }
