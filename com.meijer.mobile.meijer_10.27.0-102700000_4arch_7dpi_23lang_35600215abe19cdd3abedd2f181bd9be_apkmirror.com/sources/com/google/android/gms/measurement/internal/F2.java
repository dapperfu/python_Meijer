...
final class F2 implements Runnable {
    ...
    final /* synthetic */ com.google.android.gms.internal.measurement.U f85009a;

    /* renamed from: b, reason: collision with root package name */
    final /* synthetic */ ServiceConnection f85010b;

    /* renamed from: c, reason: collision with root package name */
    final /* synthetic */ G2 f85011c;

    F2(G2 g22, com.google.android.gms.internal.measurement.U u10, ServiceConnection serviceConnection) {
        this.f85009a = u10;
        this.f85010b = serviceConnection;
    ...
    public final void run() throws IllegalStateException {
        ...
        try {
            bundleX6 = this.f85009a.x6(bundle);
        } catch (Exception e10) {
            h22.f85045a.a().m().b("Exception occurred while retrieving the Install Referrer", e10.getMessage());
        }
        if (bundleX6 == null) {
        ...
        X2.o();
        if (bundleX6 != null) {
            long j10 = bundleX6.getLong("install_begin_timestamp_seconds", 0L) * 1000;
            if (j10 == 0) {
                x23.a().p().a("Service response is missing Install Referrer install timestamp");
            } else {
                String string = bundleX6.getString("install_referrer");
                if (string == null || string.isEmpty()) {
                    ...
                    if (bundleQ0 == null) {
                        ...
                        List listAsList = Arrays.asList(((String) C11120d2.f85473h1.b(null)).split(","));
                        ...
                        while (true) {
                            ...
                            if (listAsList.contains(it.next())) {
                                long j11 = bundleX6.getLong("referrer_click_timestamp_server_seconds", 0L) * 1000;
                                if (j11 > 0) {
                                    bundleQ0.putLong("click_timestamp", j11);
                                }
                            }
                        }
                        if (j10 == x23.v().f84975g.a()) {
        ...
        C16023b.b().c(x23.zzaY(), this.f85010b);
    }
}
