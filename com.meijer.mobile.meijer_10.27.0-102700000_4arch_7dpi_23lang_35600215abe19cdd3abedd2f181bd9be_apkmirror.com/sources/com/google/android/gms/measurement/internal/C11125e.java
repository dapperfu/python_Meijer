...
final class C11125e extends AbstractC11108b6 {

    /* renamed from: d, reason: collision with root package name */
    private String f85522d;
    ...
    private Long f85525g;

    /* renamed from: h, reason: collision with root package name */
    private Long f85526h;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:405:0x0969, code lost:
        ...
        r0 = r13.a().p();
        r2 = com.google.android.gms.measurement.internal.C11218q2.v(r34.f85522d);
     */
    ...
    */
    final java.util.List k(java.lang.String r35, java.util.List r36, java.util.List r37, java.lang.Long r38, java.lang.Long r39, boolean r40) throws java.lang.Throwable {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11125e.k(java.lang.String, java.util.List, java.util.List, java.lang.Long, java.lang.Long, boolean):java.util.List");
    }

    private final I6 l(Integer num) {
        if (this.f85524f.containsKey(num)) {
            return (I6) this.f85524f.get(num);
        }
        I6 i62 = new I6(this, this.f85522d, null);
        this.f85524f.put(num, i62);
        return i62;
    }

    private final boolean m(int i10, int i11) {
        I6 i62 = (I6) this.f85524f.get(Integer.valueOf(i10));
        if (i62 == null) {
            return false;
        }
