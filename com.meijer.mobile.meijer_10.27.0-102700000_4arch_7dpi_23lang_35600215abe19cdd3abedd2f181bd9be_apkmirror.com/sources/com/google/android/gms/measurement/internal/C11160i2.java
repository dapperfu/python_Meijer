...
public final class C11160i2 extends AbstractC11136f2 {

    /* renamed from: e, reason: collision with root package name */
    private static final String[] f85621e = {"app_version", "ALTER TABLE messages ADD COLUMN app_version TEXT;", "app_version_int", "ALTER TABLE messages ADD COLUMN app_version_int INTEGER;"};

    /* renamed from: c, reason: collision with root package name */
    private final C11152h2 f85622c;

    /* renamed from: d, reason: collision with root package name */
    private boolean f85623d;
    ...
    */
    private final boolean x(int r19, byte[] r20) throws java.lang.Throwable {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11160i2.x(int, byte[]):boolean");
    }

    public final boolean p(C11157i c11157i) {
        X2 x22 = this.f84868a;
        byte[] bArrR = x22.A().R(c11157i);
    ...
    */
    public final java.util.List r(int r30) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11160i2.r(int):java.util.List");
    }
    ...
    */
    public final boolean t() {
        ...
        L15:
            ...
            if (r5 != 0) goto L23
            r10.f85623d = r6     // Catch: java.lang.Throwable -> L40 android.database.sqlite.SQLiteException -> L42 android.database.sqlite.SQLiteDatabaseLockedException -> L60 android.database.sqlite.SQLiteFullException -> L6c
            goto L97
        L23:
        ...
        L4e:
            com.google.android.gms.measurement.internal.X2 r8 = r10.f84868a     // Catch: java.lang.Throwable -> L40
            ...
            r10.f85623d = r6     // Catch: java.lang.Throwable -> L40
            if (r5 == 0) goto L7f
            goto L68
        L60:
        ...
        L87:
            throw r0
        L88:
            com.google.android.gms.measurement.internal.X2 r0 = r10.f84868a
        ...
        L97:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11160i2.t():boolean");
    }
    ...
    final SQLiteDatabase u() throws SQLiteException {
        ...
        SQLiteDatabase writableDatabase = this.f85622c.getWritableDatabase();
    ...
    C11160i2(X2 x22) {
        ...
        this.f84868a.u();
        this.f85622c = new C11152h2(this, contextZzaY, "google_app_measurement_local.db");
    }
    ...
    public final void m() {
        ...
        try {
            ...
            if (sQLiteDatabaseU != null && (iDelete = sQLiteDatabaseU.delete("messages", null, null)) > 0) {
                this.f84868a.a().u().b("Reset local analytics data. records", Integer.valueOf(iDelete));
            }
        } catch (SQLiteException e10) {
            this.f84868a.a().m().b("Error resetting local analytics data. error", e10);
        }
    }
    ...
    public final boolean n(G g10) {
        ...
        if (bArrMarshall.length > 131072) {
            this.f84868a.a().n().a("Event is too long for local database. Sending event directly to service");
            return false;
        }
    ...
    public final boolean o(v6 v6Var) {
        ...
        parcelObtain.recycle();
        if (bArrMarshall.length > 131072) {
            this.f84868a.a().n().a("User property too long for local database. Sending directly to service");
            return false;
        }
