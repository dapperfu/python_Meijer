...
public final class C11249v {
    ...
    */
    static void a(com.google.android.gms.measurement.internal.C11218q2 r10, android.database.sqlite.SQLiteDatabase r11, java.lang.String r12, java.lang.String r13, java.lang.String r14, java.lang.String[] r15) throws java.lang.Throwable {
        /*
            Method dump skipped, instructions count: 263
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C11249v.a(com.google.android.gms.measurement.internal.q2, android.database.sqlite.SQLiteDatabase, java.lang.String, java.lang.String, java.lang.String, java.lang.String[]):void");
    }

    static void b(C11218q2 c11218q2, SQLiteDatabase sQLiteDatabase) {
        if (c11218q2 == null) {
        ...
        if (!file.setReadable(false, false)) {
            c11218q2.p().a("Failed to turn off database read permission");
        }
        if (!file.setWritable(false, false)) {
            c11218q2.p().a("Failed to turn off database write permission");
        }
        if (!file.setReadable(true, true)) {
            c11218q2.p().a("Failed to turn on database read permission for owner");
        }
        if (file.setWritable(true, true)) {
            return;
        }
        c11218q2.p().a("Failed to turn on database write permission for owner");
    }
}
