...
final class C8294i9 {
    ...
    static boolean f74893a;

    /* renamed from: b, reason: collision with root package name */
    private static MessageDigest f74894b;

    /* renamed from: c, reason: collision with root package name */
    private static final Object f74895c = new Object();

    /* renamed from: d, reason: collision with root package name */
    private static final Object f74896d = new Object();

    /* renamed from: e, reason: collision with root package name */
    static final CountDownLatch f74897e = new CountDownLatch(1);
    ...
    static Vector c(byte[] bArr, int i10) {
        ...
        for (int i12 = 0; i12 < i11 / com.medallia.digital.mobilesdk.l3.f92484c; i12++) {
    ...
    private static byte[] h(byte[] bArr, String str, boolean z10) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        InterfaceC8399j9[] interfaceC8399j9Arr = new C10003y9().f80005G2;
        int length3 = interfaceC8399j9Arr.length;
        for (int i12 = 0; i12 < 12; i12++) {
            interfaceC8399j9Arr[i12].zza(bArrArray, bArr3);
        }
    ...
    static W8 a(byte[] bArr, String str) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        Vector vectorC = c(bArr, com.medallia.digital.mobilesdk.l3.f92484c);
    ...
    static void e() {
        synchronized (f74896d) {
            try {
                if (!f74893a) {
                    f74893a = true;
                    new Thread(new RunnableC8080g9(null)).start();
                }
            } catch (Throwable th2) {
                throw th2;
            }
    ...
    public static byte[] f(byte[] bArr) throws NoSuchAlgorithmException {
        ...
        synchronized (f74895c) {
            try {
                e();
                MessageDigest messageDigest2 = null;
                try {
                    if (f74897e.await(2L, TimeUnit.SECONDS) && (messageDigest = f74894b) != null) {
