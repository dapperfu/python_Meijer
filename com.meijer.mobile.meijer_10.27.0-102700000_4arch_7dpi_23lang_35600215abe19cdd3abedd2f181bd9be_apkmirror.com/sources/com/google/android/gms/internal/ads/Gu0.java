...
public abstract class Gu0<MessageType extends Gu0<MessageType, BuilderType>, BuilderType extends Au0<MessageType, BuilderType>> extends Ht0<MessageType, BuilderType> {
    ...
    protected static <T extends Gu0<T, ?>> T M(T t10, byte[] bArr) throws zzgyg {
        ...
        C9225qu0 c9225qu0 = C9225qu0.f77865c;
        int i10 = C10082yv0.f80309d;
        T t11 = (T) Z(t10, bArr, 0, length, C9225qu0.f77865c);
        X(t11);
        return t11;
    }

    protected static <T extends Gu0<T, ?>> T P(T t10, byte[] bArr, C9225qu0 c9225qu0) throws zzgyg {
        T t11 = (T) Z(t10, bArr, 0, bArr.length, c9225qu0);
        X(t11);
        return t11;
    }
    ...
    protected static <T extends Gu0<T, ?>> T L(T t10, Zt0 zt0) throws zzgyg {
        C9225qu0 c9225qu0 = C9225qu0.f77865c;
        int i10 = C10082yv0.f80309d;
        T t11 = (T) N(t10, zt0, C9225qu0.f77865c);
        X(t11);
        return t11;
    }

    protected static <T extends Gu0<T, ?>> T O(T t10, InputStream inputStream, C9225qu0 c9225qu0) throws zzgyg {
        T t11 = (T) Q(t10, AbstractC7943eu0.e(inputStream, RecyclerView.m.FLAG_APPEARED_IN_PRE_LAYOUT), c9225qu0);
        X(t11);
        return t11;
    }
    ...
    private int R(Hv0<?> hv0) {
        ...
        return C10082yv0.a().b(getClass()).zza(this);
    }
    ...
    private static <T extends Gu0<T, ?>> T Z(T t10, byte[] bArr, int i10, int i11, C9225qu0 c9225qu0) throws zzgyg {
        if (i11 == 0) {
            return t10;
        }
        T t11 = (T) t10.K();
        try {
            Hv0 hv0B = C10082yv0.a().b(t11.getClass());
            hv0B.a(t11, bArr, i10, i10 + i11, new Mt0(c9225qu0));
            hv0B.zzf(t11);
            return t11;
        } catch (zzgyg e10) {
            if (e10.b()) {
    ...
    public static final <T extends Gu0<T, ?>> boolean a0(T t10, boolean z10) {
        ...
        boolean zZzl = C10082yv0.a().b(t10.getClass()).zzl(t10);
        if (z10) {
    ...
    protected static Object x(InterfaceC9120pv0 interfaceC9120pv0, String str, Object[] objArr) {
        return new Av0(interfaceC9120pv0, str, objArr);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C10082yv0.a().b(getClass()).zzk(this, (Gu0) obj);
    }
    ...
    public final InterfaceC9868wv0<MessageType> u() {
        return (InterfaceC9868wv0) W(Fu0.GET_PARSER, null, null);
    }
    ...
    protected static <T extends Gu0<T, ?>> T N(T t10, Zt0 zt0, C9225qu0 c9225qu0) throws zzgyg {
        T t11 = (T) Y(t10, zt0, c9225qu0);
        X(t11);
        return t11;
    }

    static <T extends Gu0<T, ?>> T Q(T t10, AbstractC7943eu0 abstractC7943eu0, C9225qu0 c9225qu0) throws zzgyg {
        T t11 = (T) t10.K();
        try {
            Hv0 hv0B = C10082yv0.a().b(t11.getClass());
            hv0B.b(t11, C8050fu0.l(abstractC7943eu0), c9225qu0);
            hv0B.zzf(t11);
            return t11;
        } catch (zzgyg e10) {
            if (e10.b()) {
    ...
    private static <T extends Gu0<T, ?>> T Y(T t10, Zt0 zt0, C9225qu0 c9225qu0) throws zzgyg {
        AbstractC7943eu0 abstractC7943eu0Q = zt0.q();
        T t11 = (T) Q(t10, abstractC7943eu0Q, c9225qu0);
        abstractC7943eu0Q.z(0);
        return t11;
    }
    ...
    protected void B() {
        C10082yv0.a().b(getClass()).zzf(this);
        D();
    }
    ...
    @Override // com.google.android.gms.internal.ads.InterfaceC9120pv0
    public void c(AbstractC8583ku0 abstractC8583ku0) throws IOException {
        C10082yv0.a().b(getClass()).c(this, C8690lu0.d(abstractC8583ku0));
    }
    ...
    int l() {
        return C10082yv0.a().b(getClass()).zzb(this);
    }

    public String toString() {
        return C9333rv0.a(this, super.toString());
    }
