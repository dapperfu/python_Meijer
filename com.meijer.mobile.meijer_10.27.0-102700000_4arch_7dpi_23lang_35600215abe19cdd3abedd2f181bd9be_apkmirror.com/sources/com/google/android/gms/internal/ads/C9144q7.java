...
public final class C9144q7 {
    public static long a(String str) {
        try {
            return d("EEE, dd MMM yyyy HH:mm:ss zzz").parse(str).getTime();
        } catch (ParseException e10) {
            if ("0".equals(str) || "-1".equals(str)) {
                C7862e7.d("Unable to parse dateStr: %s, falling back to 0", str);
                return 0L;
            }
            C7862e7.c(e10, "Unable to parse dateStr: %s, falling back to 0", str);
            return 0L;
        }
    }
