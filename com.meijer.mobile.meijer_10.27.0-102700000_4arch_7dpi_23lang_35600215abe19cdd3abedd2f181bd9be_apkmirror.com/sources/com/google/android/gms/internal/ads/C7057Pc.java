...
public final class C7057Pc {

    /* renamed from: a, reason: collision with root package name */
    private static final ArrayList f69378a = new ArrayList();

    /* renamed from: b, reason: collision with root package name */
    private static final Pattern f69379b = Pattern.compile("^mp4a\\.([a-zA-Z0-9]{2})(?:\\.([0-9]{1,2}))?$");

    /* renamed from: c, reason: collision with root package name */
    public static final /* synthetic */ int f69380c = 0;
    ...
    */
    public static boolean f(java.lang.String r3, java.lang.String r4) {
        ...
        L9c:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.C7057Pc.f(java.lang.String, java.lang.String):boolean");
    }

    static C8974oc c(String str) {
        Matcher matcher = f69379b.matcher(str);
        if (!matcher.matches()) {
            return null;
        }
        ...
        try {
            return new C8974oc(Integer.parseInt(strGroup, 16), strGroup2 != null ? Integer.parseInt(strGroup2) : 0);
    ...
    */
    public static java.lang.String e(java.lang.String r6) {
        /*
            ...
            return r6
        L4:
            java.lang.String r6 = com.google.android.gms.internal.ads.C8446jf0.a(r6)
            int r0 = r6.hashCode()
            r1 = 3
            r2 = 2
            r3 = 4
        ...
        L6e:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.C7057Pc.e(java.lang.String):java.lang.String");
    }
    ...
    */
    public static int a(java.lang.String r7, java.lang.String r8) {
        ...
        Lb5:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.C7057Pc.a(java.lang.String, java.lang.String):int");
    }
            ...
            if (!"text".equals(j(str)) && !"application/x-media3-cues".equals(str) && !"application/cea-608".equals(str) && !"application/cea-708".equals(str) && !"application/x-mp4-cea-608".equals(str) && !"application/x-subrip".equals(str) && !"application/ttml+xml".equals(str) && !"application/x-quicktime-tx3g".equals(str) && !"application/x-mp4-vtt".equals(str) && !"application/x-rawcc".equals(str) && !"application/vobsub".equals(str) && !"application/pgs".equals(str) && !"application/dvbsubs".equals(str)) {
                ...
                if (!"application/id3".equals(str) && !"application/x-emsg".equals(str) && !"application/x-scte35".equals(str) && !"application/x-icy".equals(str) && !"application/vnd.dvb.ait".equals(str)) {
                    if (!"application/x-camera-motion".equals(str)) {
                        int size = f69378a.size();
                        for (int i10 = 0; i10 < size; i10++) {
                            String str2 = ((C6953Mb) f69378a.get(i10)).f68673a;
                            if (str.equals(null)) {
                                return 0;
                            }
                        }
