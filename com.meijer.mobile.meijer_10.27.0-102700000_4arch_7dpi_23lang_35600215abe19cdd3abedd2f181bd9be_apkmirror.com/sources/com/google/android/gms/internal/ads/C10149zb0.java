...
public final class C10149zb0 {

    /* renamed from: a, reason: collision with root package name */
    private static WindowManager f80452a;

    /* renamed from: b, reason: collision with root package name */
    private static final String[] f80453b = {"x", "y", "width", "height"};

    /* renamed from: c, reason: collision with root package name */
    static float f80454c = Resources.getSystem().getDisplayMetrics().density;
    ...
    */
    public static boolean g(org.json.JSONObject r9, org.json.JSONObject r10) {
        ...
        L7:
            ...
            goto Lc3
        Le:
            java.lang.String[] r2 = com.google.android.gms.internal.ads.C10149zb0.f80453b
            r3 = r1
        L11:
            r4 = 4
            if (r3 >= r4) goto L27
        ...
        Lc3:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.C10149zb0.g(org.json.JSONObject, org.json.JSONObject):boolean");
    }
    ...
    public static JSONObject a(int i10, int i11, int i12, int i13) throws JSONException {
        ...
        try {
            jSONObject.put("x", i10 / f80454c);
            jSONObject.put("y", i11 / f80454c);
            jSONObject.put("width", i12 / f80454c);
            jSONObject.put("height", i13 / f80454c);
            return jSONObject;
        } catch (JSONException e10) {
            C6547Ab0.a("Error with creating viewStateObject", e10);
            return jSONObject;
        }
    }
    ...
    public static void b(JSONObject jSONObject, String str) throws JSONException {
        try {
            ...
            C6547Ab0.a("Error with setting ad session id", e10);
        }
    }
    ...
    public static void d(Context context) {
        if (context != null) {
            f80454c = context.getResources().getDisplayMetrics().density;
            f80452a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void f(JSONObject jSONObject) throws JSONException {
        ...
        if (f80452a != null) {
            ...
            f80452a.getDefaultDisplay().getRealSize(point);
            float f12 = point.x;
            float f13 = f80454c;
            f10 = f12 / f13;
            f11 = point.y / f13;
    ...
    public static void e(JSONObject jSONObject, String str, Object obj) throws JSONException {
        try {
            ...
            C6547Ab0.a("JSONException during JSONObject.put for name [" + str + "]", e10);
        }
    }
}
