    ...
    public final byte[] d(byte[] bArr, ByteBuffer byteBuffer) throws GeneralSecurityException {
        ...
        if (bArr.length == a()) {
            ...
            for (int i11 = 0; i11 < i10 + 1; i11++) {
                ByteBuffer byteBufferC = c(bArr, this.f67681b + i11);
                if (i11 == i10) {
                    C7941et0.a(byteBufferAllocate, byteBuffer, byteBufferC, iRemaining % 64);
                } else {
                    C7941et0.a(byteBufferAllocate, byteBuffer, byteBufferC, 64);
                }
            }
