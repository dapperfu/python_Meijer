...
public abstract class AbstractBinderC7072Pl extends BinderC8865nb implements InterfaceC7106Ql {
    public AbstractBinderC7072Pl() {
        super("com.google.android.gms.ads.internal.mediation.client.IUnifiedNativeAdMapper");
    }

    public static InterfaceC7106Ql B9(IBinder iBinder) {
        if (iBinder == null) {
            return null;
        }
        ...
        return iInterfaceQueryLocalInterface instanceof InterfaceC7106Ql ? (InterfaceC7106Ql) iInterfaceQueryLocalInterface : new C7038Ol(iBinder);
    }
    ...
    protected final boolean A9(int i10, Parcel parcel, Parcel parcel2, int i11) throws RemoteException {
        switch (i10) {
            ...
            case 4:
                ...
                return true;
            case 5:
                InterfaceC7334Xg interfaceC7334XgZzl = zzl();
                parcel2.writeNoException();
                C8972ob.f(parcel2, interfaceC7334XgZzl);
                return true;
            case 6:
                String strZzr = zzr();
                parcel2.writeNoException();
            ...
            case 15:
                ...
                parcel2.writeNoException();
                C8972ob.f(parcel2, bVarZzo);
                return true;
            case 16:
                Bundle bundleZzi = zzi();
                parcel2.writeNoException();
                C8972ob.e(parcel2, bundleZzi);
                return true;
            case 17:
                boolean zR = r();
                parcel2.writeNoException();
