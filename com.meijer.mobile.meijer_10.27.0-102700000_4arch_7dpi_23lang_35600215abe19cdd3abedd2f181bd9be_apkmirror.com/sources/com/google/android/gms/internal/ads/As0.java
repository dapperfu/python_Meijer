...
public final class As0 extends Gu0 implements InterfaceC9227qv0 {
    ...
    public static C10076ys0 c0() {
        return (C10076ys0) zza.n();
    }

    public static As0 e0(Zt0 zt0, C9225qu0 c9225qu0) throws zzgyg {
        return (As0) Gu0.N(zza, zt0, c9225qu0);
    }
        ...
        if (iOrdinal != 0) {
            if (iOrdinal != 2) {
                if (iOrdinal != 3) {
                    ...
                    return new C10076ys0(c10183zs0);
                }
                return new As0();
            }
