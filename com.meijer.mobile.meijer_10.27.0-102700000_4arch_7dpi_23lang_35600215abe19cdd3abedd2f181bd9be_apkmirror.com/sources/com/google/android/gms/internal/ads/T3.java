...
final class T3 extends AbstractC7643c4 {
    ...
    protected final boolean c(GQ gq2, long j10, Z3 z32) {
        ...
        if (b02 == null) {
            ...
            this.f70281n = b03;
            z32.f71980a = b03.c(Arrays.copyOfRange(bArrN, 9, gq2.u()), null);
            return true;
        }
        if ((bArrN[0] & Byte.MAX_VALUE) == 3) {
            A0 a0B = C9985y0.b(gq2);
            B0 b0F = b02.f(a0B);
            this.f70281n = b0F;
            this.f70282o = new S3(b0F, a0B);
            return true;
        }
        if (!j(bArrN)) {
            return true;
