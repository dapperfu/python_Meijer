...
public final class E6 {
    ...
    private static void g(int i10, byte[] bArr, int i11) {
        bArr[1] = (byte) (i10 & com.medallia.digital.mobilesdk.l3.f92484c);
        bArr[2] = (byte) ((i10 >>> 8) & com.medallia.digital.mobilesdk.l3.f92484c);
        bArr[3] = (byte) ((i10 >>> 16) & com.medallia.digital.mobilesdk.l3.f92484c);
        bArr[4] = (byte) (i10 >> 24);
    }

    private static byte[][] k(int[] iArr, InterfaceC9997y6[] interfaceC9997y6Arr) throws DigestException {
        long j10;
        int i10;
        int length;
        char c10;
        ...
        while (true) {
            ...
            jZza += (interfaceC9997y6Arr[i13].zza() + 1048575) / 1048576;
            i13++;
        }
        if (jZza >= 2097151) {
        ...
        int i18 = 0;
        while (i17 < i10) {
            InterfaceC9997y6 interfaceC9997y6 = interfaceC9997y6Arr[i17];
            int i19 = i17;
            long jZza2 = interfaceC9997y6.zza();
            byte[][] bArr4 = bArr;
            long j11 = 0;
            while (jZza2 > 0) {
                int i20 = i18;
                ...
                try {
                    interfaceC9997y6.zzb(messageDigestArr, j11, iMin);
                    int i22 = 0;
    ...
    private static X509Certificate[][] l(FileChannel fileChannel, A6 a62) throws SecurityException, CertificateException {
        ...
        try {
            ...
            try {
                ByteBuffer byteBufferF = f(a62.f65079a);
                int i10 = 0;
                ...
                h(map, fileChannel, a62.f65080b, a62.f65081c, a62.f65082d, a62.f65083e);
    ...
    private static void h(Map map, FileChannel fileChannel, long j10, long j11, long j12, ByteBuffer byteBuffer) throws SecurityException {
        if (!map.isEmpty()) {
            C10104z6 c10104z6 = new C10104z6(fileChannel, 0L, j10);
            C10104z6 c10104z62 = new C10104z6(fileChannel, j11, j12 - j11);
            ByteBuffer byteBufferDuplicate = byteBuffer.duplicate();
            byteBufferDuplicate.order(ByteOrder.LITTLE_ENDIAN);
            F6.d(byteBufferDuplicate, j10);
            C9890x6 c9890x6 = new C9890x6(byteBufferDuplicate);
            int size = map.size();
            ...
            try {
                byte[][] bArrK = k(iArr, new InterfaceC9997y6[]{c10104z6, c10104z62, c9890x6});
