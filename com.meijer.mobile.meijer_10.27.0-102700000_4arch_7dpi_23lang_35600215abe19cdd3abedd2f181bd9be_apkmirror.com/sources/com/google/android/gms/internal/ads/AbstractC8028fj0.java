...
public abstract class AbstractC8028fj0 extends AbstractExecutorService implements Xj0 {
    @Override // java.util.concurrent.AbstractExecutorService
    protected final RunnableFuture newTaskFor(Runnable runnable, Object obj) {
        return RunnableFutureC8991ok0.E(runnable, obj);
    }
    ...
    protected final RunnableFuture newTaskFor(Callable callable) {
        return new RunnableFutureC8991ok0(callable);
    }
    ...
    public final com.google.common.util.concurrent.q i0(Callable callable) {
