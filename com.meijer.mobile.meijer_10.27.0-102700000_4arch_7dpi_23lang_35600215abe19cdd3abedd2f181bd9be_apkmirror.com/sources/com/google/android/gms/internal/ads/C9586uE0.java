...
public final class C9586uE0 {

    /* renamed from: a, reason: collision with root package name */
    private static final HashMap f78776a = new HashMap();

    /* renamed from: b, reason: collision with root package name */
    public static final /* synthetic */ int f78777b = 0;

    public static C7558bE0 a() throws zzsu {
        List listD = d("audio/raw", false, false);
        if (listD.isEmpty()) {
            return null;
        }
        return (C7558bE0) listD.get(0);
    }

    public static String b(C c10) {
        Pair pairA;
        if ("audio/eac3-joc".equals(c10.f65664o)) {
            return "audio/eac3";
        }
        if ("video/dolby-vision".equals(c10.f65664o) && (pairA = C8302iD.a(c10)) != null) {
        ...
        if ("video/mv-hevc".equals(c10.f65664o)) {
            return "video/hevc";
        }
        return null;
    }
    ...
    public static synchronized List d(String str, boolean z10, boolean z11) throws zzsu {
        try {
            C8838nE0 c8838nE0 = new C8838nE0(str, z10, z11);
            HashMap map = f78776a;
            List list = (List) map.get(c8838nE0);
            if (list != null) {
                return list;
            }
            ArrayList arrayListG = g(c8838nE0, new C9159qE0(z10, z11));
            if (z10 && arrayListG.isEmpty() && OV.f69091a <= 23) {
                arrayListG = g(c8838nE0, new C9052pE0(null));
                if (!arrayListG.isEmpty()) {
                    C9917xL.f("MediaCodecUtil", "MediaCodecList API didn't list secure decoder for: " + str + ". Assuming: " + ((C7558bE0) arrayListG.get(0)).f72767a);
                }
            }
            if ("audio/raw".equals(str)) {
                if (OV.f69091a < 26 && OV.f69092b.equals("R9") && arrayListG.size() == 1 && ((C7558bE0) arrayListG.get(0)).f72767a.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
                    arrayListG.add(C7558bE0.c("OMX.google.raw.decoder", "audio/raw", "audio/raw", null, false, true, false, false, false));
                }
                h(arrayListG, new InterfaceC9265rE0() { // from class: com.google.android.gms.internal.ads.lE0
                    @Override // com.google.android.gms.internal.ads.InterfaceC9265rE0
                    public final int zza(Object obj) {
                        int i10 = C9586uE0.f78777b;
                        String str2 = ((C7558bE0) obj).f72767a;
                        if (str2.startsWith("OMX.google") || str2.startsWith("c2.android")) {
                            return 1;
                        }
                        return (OV.f69091a >= 26 || !str2.equals("OMX.MTK.AUDIO.DECODER.RAW")) ? 0 : -1;
                    }
                });
            }
            if (OV.f69091a < 32 && arrayListG.size() > 1 && "OMX.qti.audio.decoder.flac".equals(((C7558bE0) arrayListG.get(0)).f72767a)) {
                arrayListG.add((C7558bE0) arrayListG.remove(0));
            }
            AbstractC7917eh0 abstractC7917eh0R = AbstractC7917eh0.r(arrayListG);
            map.put(c8838nE0, abstractC7917eh0R);
            return abstractC7917eh0R;
        } catch (Throwable th2) {
            throw th2;
        }
    }

    public static List e(InterfaceC8410jE0 interfaceC8410jE0, C c10, boolean z10, boolean z11) throws zzsu {
        List listA = interfaceC8410jE0.a(c10.f65664o, z10, z11);
        List listC = c(interfaceC8410jE0, c10, z10, z11);
    ...
    public static List f(List list, final C c10) {
        ...
        h(arrayList, new InterfaceC9265rE0() { // from class: com.google.android.gms.internal.ads.mE0
            @Override // com.google.android.gms.internal.ads.InterfaceC9265rE0
            public final int zza(Object obj) {
                int i10 = C9586uE0.f78777b;
                return ((C7558bE0) obj).d(c10) ? 1 : 0;
            }
        });
        return arrayList;
    }
    ...
    */
    private static java.util.ArrayList g(com.google.android.gms.internal.ads.C8838nE0 r23, com.google.android.gms.internal.ads.InterfaceC8945oE0 r24) throws java.lang.Exception {
        /*
            Method dump skipped, instructions count: 655
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.C9586uE0.g(com.google.android.gms.internal.ads.nE0, com.google.android.gms.internal.ads.oE0):java.util.ArrayList");
    }

    private static void h(List list, final InterfaceC9265rE0 interfaceC9265rE0) {
        Collections.sort(list, new Comparator() { // from class: com.google.android.gms.internal.ads.kE0
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                int i10 = C9586uE0.f78777b;
                InterfaceC9265rE0 interfaceC9265rE02 = interfaceC9265rE0;
                return interfaceC9265rE02.zza(obj2) - interfaceC9265rE02.zza(obj);
            }
        });
    }
    ...
    private static boolean i(MediaCodecInfo mediaCodecInfo, String str) {
        ...
        String strA = C8446jf0.a(mediaCodecInfo.getName());
    ...
    public static List c(InterfaceC8410jE0 interfaceC8410jE0, C c10, boolean z10, boolean z11) throws zzsu {
        String strB = b(c10);
        if (strB == null) {
            return AbstractC7917eh0.t();
        }
        return interfaceC8410jE0.a(strB, z10, z11);
    }
}
