...
final class Nt0 {
    ...
    private static volatile int f68960a = 100;

    /* renamed from: b, reason: collision with root package name */
    public static final /* synthetic */ int f68961b = 0;
    ...
    static int g(int i10, byte[] bArr, int i11, int i12, Vv0 vv0, Mt0 mt0) throws zzgyg {
        ...
        if (i13 == 0) {
            ...
            vv0.j(i10, Long.valueOf(mt0.f68750b));
            return iK;
        }
        if (i13 == 1) {
    ...
    static int i(int i10, byte[] bArr, int i11, Mt0 mt0) {
        ...
        byte b11 = bArr[i12];
        if (b11 >= 0) {
            mt0.f68749a = i14 | (b11 << C14045dq.LIGHTEN);
            return i15;
        }
    ...
    static int l(Object obj, Hv0 hv0, byte[] bArr, int i10, int i11, int i12, Mt0 mt0) throws IOException {
        int i13 = mt0.f68753e + 1;
        mt0.f68753e = i13;
        o(i13);
        int iX = ((C9440sv0) hv0).x(obj, bArr, i10, i11, i12, mt0);
        mt0.f68753e--;
        mt0.f68751c = obj;
        return iX;
    }
    ...
    static int a(byte[] bArr, int i10, Mt0 mt0) throws zzgyg {
        ...
        if (i11 >= 0) {
            if (i11 <= bArr.length - iH) {
                if (i11 == 0) {
                    mt0.f68751c = Zt0.f72282b;
                    return iH;
                }
                mt0.f68751c = Zt0.z(bArr, iH, i11);
                return iH + i11;
            }
            throw new zzgyg("While parsing a protocol message, the input ended unexpectedly in the middle of a field.  This could mean either that the input has been truncated or that an embedded message misreported its own length.");
        }
