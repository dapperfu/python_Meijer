...
public final class C8678lo0 {

    /* renamed from: c, reason: collision with root package name */
    private static final Logger f76654c = Logger.getLogger(C8678lo0.class.getName());

    /* renamed from: d, reason: collision with root package name */
    private static final C8678lo0 f76655d = new C8678lo0();

    /* renamed from: a, reason: collision with root package name */
    private final ConcurrentMap f76656a = new ConcurrentHashMap();

    /* renamed from: b, reason: collision with root package name */
    private final ConcurrentMap f76657b = new ConcurrentHashMap();

    public static C8678lo0 c() {
        return f76655d;
    }

    private final synchronized Dk0 g(String str) throws GeneralSecurityException {
        if (!this.f76656a.containsKey(str)) {
            throw new GeneralSecurityException("No key manager found for key type ".concat(String.valueOf(str)));
        }
        return (Dk0) this.f76656a.get(str);
    }

    private final synchronized void h(Dk0 dk0, boolean z10, boolean z11) throws GeneralSecurityException {
        try {
            String str = ((C9747vo0) dk0).f79129a;
            if (this.f76657b.containsKey(str) && !((Boolean) this.f76657b.get(str)).booleanValue()) {
                throw new GeneralSecurityException("New keys are already disallowed for key type ".concat(str));
            }
            Dk0 dk02 = (Dk0) this.f76656a.get(str);
            if (dk02 != null && !dk02.getClass().equals(dk0.getClass())) {
                f76654c.logp(Level.WARNING, "com.google.crypto.tink.internal.KeyManagerRegistry", "insertKeyManager", "Attempted overwrite of a registered key manager for key type ".concat(str));
            ...
            this.f76656a.putIfAbsent(str, dk0);
            this.f76657b.put(str, Boolean.TRUE);
        } catch (Throwable th2) {
            throw th2;
        }
    }
    ...
    public final boolean e(String str) {
        return ((Boolean) this.f76657b.get(str)).booleanValue();
    }
