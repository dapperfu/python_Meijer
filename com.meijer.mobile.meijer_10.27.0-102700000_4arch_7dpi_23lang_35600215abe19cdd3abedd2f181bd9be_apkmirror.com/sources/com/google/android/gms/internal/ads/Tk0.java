...
public final class Tk0 {
    ...
    public static final /* synthetic */ int f70447a = 0;
    ...
    static {
        ...
        hashSet.add(InterfaceC9418sk0.class);
        hashSet.add(InterfaceC10060yk0.class);
        hashSet.add(Vk0.class);
        hashSet.add(Ak0.class);
        hashSet.add(InterfaceC10167zk0.class);
    ...
    public static Object b(Zr0 zr0, Class cls) throws GeneralSecurityException {
        String strG0 = zr0.g0();
        return C8678lo0.c().a(strG0, cls).b(zr0.f0());
    }
}
