...
public final class At0 implements Lq0 {
    ...
    private final ThreadLocal f65231a;

    /* renamed from: b, reason: collision with root package name */
    private final String f65232b;

    /* renamed from: c, reason: collision with root package name */
    private final Key f65233c;

    /* renamed from: d, reason: collision with root package name */
    private final int f65234d;
    ...
    public final byte[] a(byte[] bArr, int i10) throws IllegalStateException, GeneralSecurityException {
        ...
        ((Mac) this.f65231a.get()).update(bArr);
        return Arrays.copyOf(((Mac) this.f65231a.get()).doFinal(), i10);
    }
    ...
    */
    public At0(java.lang.String r6, java.security.Key r7) throws java.security.GeneralSecurityException {
        /*
            ...
            r5.f65231a = r0
            r1 = 2
            boolean r2 = com.google.android.gms.internal.ads.C7931eo0.a(r1)
            if (r2 == 0) goto L8e
            r5.f65232b = r6
            r5.f65233c = r7
