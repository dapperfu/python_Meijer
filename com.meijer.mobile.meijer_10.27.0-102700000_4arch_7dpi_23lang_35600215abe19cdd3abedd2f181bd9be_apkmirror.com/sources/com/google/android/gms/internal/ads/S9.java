...
public final class S9 {
    ...
    private static Cipher f70038a;

    /* renamed from: b, reason: collision with root package name */
    private static final Object f70039b = new Object();

    /* renamed from: c, reason: collision with root package name */
    private static final Object f70040c = new Object();
    ...
    public final byte[] b(byte[] bArr, String str) throws zzavh {
        ...
        int length = bArr.length;
        try {
            byte[] bArrB = C7547b9.b(str, false);
    ...
    private static final Cipher c() throws NoSuchPaddingException, NoSuchAlgorithmException {
        Cipher cipher;
        synchronized (f70040c) {
            try {
                if (f70038a == null) {
                    f70038a = Cipher.getInstance("AES/CBC/PKCS5Padding");
                }
                cipher = f70038a;
            } catch (Throwable th2) {
                throw th2;
