...
public final class C8595l0 implements X0 {

    /* renamed from: a, reason: collision with root package name */
    private final byte[] f75733a = new byte[RecyclerView.m.FLAG_APPEARED_IN_PRE_LAYOUT];
    ...
    public final int f(InterfaceC9685vA0 interfaceC9685vA0, int i10, boolean z10, int i11) throws IOException {
        int iZza = interfaceC9685vA0.zza(this.f75733a, 0, Math.min(RecyclerView.m.FLAG_APPEARED_IN_PRE_LAYOUT, i10));
        if (iZza != -1) {
            return iZza;
        }
        if (z10) {
