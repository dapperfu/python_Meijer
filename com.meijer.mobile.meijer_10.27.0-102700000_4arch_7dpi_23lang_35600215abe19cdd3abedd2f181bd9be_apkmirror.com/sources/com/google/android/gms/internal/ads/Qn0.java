...
public final class Qn0 implements InterfaceC9418sk0 {

    /* renamed from: a, reason: collision with root package name */
    private final byte[] f69645a;

    /* renamed from: b, reason: collision with root package name */
    private final int f69646b;

    /* renamed from: c, reason: collision with root package name */
    private final Lq0 f69647c;

    public static InterfaceC9418sk0 a(Pm0 pm0) throws GeneralSecurityException {
    ...
    public final byte[] zza(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ...
        byte[] bArr3 = this.f69645a;
        int i10 = this.f69646b;
        ...
        System.arraycopy(this.f69647c.a(bArr5, 16), 0, bArr7, 0, 16);
        System.arraycopy(this.f69647c.a(bArr6, 16), 0, bArr7, 16, 16);
        if (!C7931eo0.a(2)) {
            throw new GeneralSecurityException("Can not use AES-GCM in FIPS-mode, as BoringCrypto module is not available.");
        }
        SecretKey secretKeyC = C8997on0.c(bArr7);
        int i13 = i12 + 12;
        ...
        AlgorithmParameterSpec algorithmParameterSpecA = C8997on0.a(bArrCopyOfRange2, 0, 12);
    ...
    private Qn0(byte[] bArr, Et0 et0, int i10) throws GeneralSecurityException {
        this.f69647c = new C10078yt0(bArr);
        this.f69645a = et0.c();
        this.f69646b = i10;
    }
}
