...
public final class OV {
    ...
    public static final int f69091a;

    /* renamed from: b, reason: collision with root package name */
    public static final String f69092b;

    /* renamed from: c, reason: collision with root package name */
    public static final String f69093c;

    /* renamed from: d, reason: collision with root package name */
    public static final String f69094d;

    /* renamed from: e, reason: collision with root package name */
    public static final String f69095e;

    /* renamed from: f, reason: collision with root package name */
    public static final byte[] f69096f;

    /* renamed from: g, reason: collision with root package name */
    private static final Pattern f69097g;

    /* renamed from: h, reason: collision with root package name */
    private static HashMap f69098h;

    /* renamed from: i, reason: collision with root package name */
    private static final String[] f69099i;

    /* renamed from: j, reason: collision with root package name */
    private static final String[] f69100j;

    /* renamed from: k, reason: collision with root package name */
    private static final int[] f69101k;

    /* renamed from: l, reason: collision with root package name */
    private static final int[] f69102l;

    /* renamed from: m, reason: collision with root package name */
    private static final int[] f69103m;
    ...
    */
    ...
    public static int w(byte[] bArr, int i10, int i11, int i12) {
        ...
        for (int i13 = 0; i13 < i11; i13++) {
            byte b10 = bArr[i13];
            iO = o(b10 & C14045dq.MULTIPLY, o((b10 & 255) >> 4, iO));
        }
        return iO;
    }
    ...
    static {
        ...
        f69094d = str3;
        f69095e = str + ", " + str3 + ", " + str2 + ", " + i10;
        f69096f = new byte[0];
        f69097g = Pattern.compile("(?:.*\\.)?isml?(?:/(manifest(.*))?)?", 2);
        f69099i = new String[]{"alb", "sq", "arm", "hy", "baq", "eu", "bur", "my", "tib", "bo", "chi", "zh", "cze", "cs", "dut", "nl", "ger", "de", "gre", "el", "fre", "fr", "geo", "ka", "ice", "is", "mac", "mk", "mao", "mi", "may", "ms", "per", "fa", "rum", "ro", "scc", "hbs-srp", "slo", "sk", "wel", "cy", PreferencesHelper.PREF_ID, "ms-ind", "iw", "he", "heb", "he", "ji", "yi", "arb", "ar-arb", "in", "ms-ind", "ind", "ms-ind", "nb", "no-nob", "nob", "no-nob", "nn", "no-nno", "nno", "no-nno", "tw", "ak-twi", "twi", "ak-twi", "bs", "hbs-bos", "bos", "hbs-bos", "hr", "hbs-hrv", "hrv", "hbs-hrv", "sr", "hbs-srp", "srp", "hbs-srp", "cmn", "zh-cmn", "hak", "zh-hak", "nan", "zh-nan", "hsn", "zh-hsn"};
        f69100j = new String[]{"i-lux", "lb", "i-hak", "zh-hak", "i-navajo", "nv", "no-bok", "no-nob", "no-nyn", "no-nno", "zh-guoyu", "zh-cmn", "zh-hakka", "zh-hak", "zh-min-nan", "zh-nan", "zh-xiang", "zh-hsn"};
    ...
    public static Point O(Context context) throws NumberFormatException {
        ...
        if (display.getDisplayId() == 0 && m(context)) {
            String strQ = f69091a < 28 ? q("sys.display-size") : q("vendor.display-size");
            if (!TextUtils.isEmpty(strQ)) {
                ...
                C9917xL.c("Util", "Invalid display size: ".concat(String.valueOf(strQ)));
            }
            if ("Sony".equals(f69093c) && f69094d.startsWith("BRAVIA") && context.getPackageManager().hasSystemFeature("com.sony.dtv.hardware.panel.qfhd")) {
    ...
    public static String e(String str) {
        ...
        String strA = C8446jf0.a(str);
        int i10 = 0;
        String str2 = strA.split("-", 2)[0];
        if (f69098h == null) {
            f69098h = r();
        }
        String str3 = (String) f69098h.get(str2);
        if (str3 != null) {
    ...
    public static boolean i(Context context) {
        return f69091a >= 23 && context.getPackageManager().hasSystemFeature("android.hardware.type.automotive");
    }
    ...
    public static boolean k(Context context) {
        ...
        if (i10 == 30) {
            String str = f69094d;
            if (C8446jf0.c(str, "moto g(20)") || C8446jf0.c(str, "rmx3231")) {
                return true;
            }
        }
        return i10 == 34 && C8446jf0.c(f69094d, "sm-x200");
    }

    private static int o(int i10, int i11) {
        return (char) (f69102l[i10 ^ (i11 >> 12)] ^ ((char) (i11 << 4)));
    }
    ...
    private static String q(String str) throws ClassNotFoundException {
        try {
            ...
            C9917xL.d("Util", "Failed to read system property ".concat(str), e10);
            return null;
        }
    }
    ...
    public static int x(byte[] bArr, int i10, int i11, int i12) {
        while (i10 < i11) {
            i12 = f69101k[(i12 >>> 24) ^ (bArr[i10] & com.medallia.digital.mobilesdk.l3.f92484c)] ^ (i12 << 8);
            i10++;
        }
        return i12;
    }
    ...
    */
    public static int G(android.net.Uri r7) {
        /*
            ...
            boolean r0 = com.google.android.gms.internal.ads.C8446jf0.c(r2, r0)
            if (r0 != 0) goto L10
            goto L11
        L10:
            return r1
        ...
        L19:
            ...
            java.lang.String r0 = com.google.android.gms.internal.ads.C8446jf0.a(r0)
            int r3 = r0.hashCode()
            switch(r3) {
        ...
        L70:
            return r0
        L71:
            java.util.regex.Pattern r0 = com.google.android.gms.internal.ads.OV.f69097g
