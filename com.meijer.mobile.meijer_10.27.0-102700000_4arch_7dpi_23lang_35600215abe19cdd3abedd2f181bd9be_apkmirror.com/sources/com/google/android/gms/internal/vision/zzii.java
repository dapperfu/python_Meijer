...
public abstract class zzii extends AbstractC11024e0 {

    /* renamed from: b, reason: collision with root package name */
    private static final Logger f84696b = Logger.getLogger(zzii.class.getName());

    /* renamed from: c, reason: collision with root package name */
    private static final boolean f84697c = l2.m();
    ...
    private static class a extends zzii {
        ...
        private final byte[] f84699d;

        /* renamed from: e, reason: collision with root package name */
        private final int f84700e;
        ...
        @Override // com.google.android.gms.internal.vision.zzii
        public final void R(int i10, AbstractC11036h0 abstractC11036h0) throws IOException {
            m(1, 3);
            X(2, i10);
            o(3, abstractC11036h0);
            m(1, 4);
        }
        ...
        @Override // com.google.android.gms.internal.vision.zzii
        public final void o(int i10, AbstractC11036h0 abstractC11036h0) throws IOException {
            m(i10, 2);
            u(abstractC11036h0);
        }

        @Override // com.google.android.gms.internal.vision.zzii
        public final void p(int i10, InterfaceC11083w1 interfaceC11083w1) throws IOException {
            m(1, 3);
            X(2, i10);
            m(3, 2);
            v(interfaceC11083w1);
        ...
        @Override // com.google.android.gms.internal.vision.zzii
        final void q(int i10, InterfaceC11083w1 interfaceC11083w1, O1 o12) throws IOException {
            m(i10, 2);
            X x10 = (X) interfaceC11083w1;
            int iE = x10.e();
            if (iE == -1) {
                iE = o12.zzb(x10);
                x10.c(iE);
            ...
            O(iE);
            o12.c(interfaceC11083w1, this.f84698a);
        }
        ...
        private final void F0(byte[] bArr, int i10, int i11) throws IOException {
            try {
                System.arraycopy(bArr, i10, this.f84699d, this.f84702g, i11);
                this.f84702g += i11;
            } catch (IndexOutOfBoundsException e10) {
                throw new zzb(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f84702g), Integer.valueOf(this.f84701f), Integer.valueOf(i11)), e10);
            }
        }
        ...
        public final void Z(long j10) throws IOException {
            try {
                byte[] bArr = this.f84699d;
                int i10 = this.f84702g;
                int i11 = i10 + 1;
                this.f84702g = i11;
                bArr[i10] = (byte) j10;
                int i12 = i10 + 2;
                ...
                throw new zzb(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f84702g), Integer.valueOf(this.f84701f), 1), e10);
            }
        }

        @Override // com.google.android.gms.internal.vision.zzii
        public final int b() {
            return this.f84701f - this.f84702g;
        }
        ...
        public final void w(String str) throws IOException {
            ...
            try {
                ...
                if (iO02 != iO0) {
                    O(o2.d(str));
                    this.f84702g = o2.e(str, this.f84699d, this.f84702g, b());
                    return;
                }
                int i11 = i10 + iO02;
                this.f84702g = i11;
                int iE = o2.e(str, this.f84699d, i11, b());
                this.f84702g = i10;
                O((iE - i10) - iO02);
                this.f84702g = iE;
            } catch (r2 e10) {
        ...
        public final void O(int i10) throws IOException {
            if (zzii.f84697c && !Z.b() && b() >= 5) {
                ...
                byte[] bArr2 = this.f84699d;
                int i12 = this.f84702g;
                this.f84702g = i12 + 1;
                l2.l(bArr2, i12, (byte) (i10 | 128));
                int i13 = i10 >>> 7;
                if ((i13 & (-128)) == 0) {
                    byte[] bArr3 = this.f84699d;
                    int i14 = this.f84702g;
                    this.f84702g = i14 + 1;
                    l2.l(bArr3, i14, (byte) i13);
                    return;
                }
                byte[] bArr4 = this.f84699d;
                int i15 = this.f84702g;
                this.f84702g = i15 + 1;
                l2.l(bArr4, i15, (byte) (i13 | 128));
                int i16 = i10 >>> 14;
                if ((i16 & (-128)) == 0) {
                    byte[] bArr5 = this.f84699d;
                    int i17 = this.f84702g;
                    this.f84702g = i17 + 1;
                    l2.l(bArr5, i17, (byte) i16);
                    return;
                }
                byte[] bArr6 = this.f84699d;
                int i18 = this.f84702g;
                this.f84702g = i18 + 1;
                l2.l(bArr6, i18, (byte) (i16 | 128));
                int i19 = i10 >>> 21;
                if ((i19 & (-128)) == 0) {
                    byte[] bArr7 = this.f84699d;
                    int i20 = this.f84702g;
                    this.f84702g = i20 + 1;
                    l2.l(bArr7, i20, (byte) i19);
                    return;
                }
                byte[] bArr8 = this.f84699d;
                int i21 = this.f84702g;
                this.f84702g = i21 + 1;
                l2.l(bArr8, i21, (byte) (i19 | 128));
                byte[] bArr9 = this.f84699d;
                int i22 = this.f84702g;
                this.f84702g = i22 + 1;
            ...
            while ((i10 & (-128)) != 0) {
                try {
                    byte[] bArr10 = this.f84699d;
                    int i23 = this.f84702g;
                    this.f84702g = i23 + 1;
                    bArr10[i23] = (byte) ((i10 & l3.f92485d) | 128);
                    i10 >>>= 7;
                } catch (IndexOutOfBoundsException e10) {
                    throw new zzb(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f84702g), Integer.valueOf(this.f84701f), 1), e10);
                }
            }
            byte[] bArr11 = this.f84699d;
            int i24 = this.f84702g;
            this.f84702g = i24 + 1;
            bArr11[i24] = (byte) i10;
        }

        @Override // com.google.android.gms.internal.vision.AbstractC11024e0
        ...
        public final void t(long j10) throws IOException {
            if (zzii.f84697c && b() >= 10) {
                while ((j10 & (-128)) != 0) {
                    byte[] bArr = this.f84699d;
                    int i10 = this.f84702g;
                    this.f84702g = i10 + 1;
                    l2.l(bArr, i10, (byte) ((((int) j10) & l3.f92485d) | 128));
                    j10 >>>= 7;
                }
                byte[] bArr2 = this.f84699d;
                int i11 = this.f84702g;
            ...
            byte[] bArr4 = this.f84699d;
            int i13 = this.f84702g;
            this.f84702g = i13 + 1;
            bArr4[i13] = (byte) j10;
        }

        @Override // com.google.android.gms.internal.vision.zzii
        public final void u(AbstractC11036h0 abstractC11036h0) throws IOException {
            O(abstractC11036h0.e());
            abstractC11036h0.o(this);
        }

        @Override // com.google.android.gms.internal.vision.zzii
        public final void v(InterfaceC11083w1 interfaceC11083w1) throws IOException {
            O(interfaceC11083w1.zzm());
            interfaceC11083w1.a(this);
        }
    }
    ...
    public abstract void R(int i10, AbstractC11036h0 abstractC11036h0) throws IOException;
    ...
    public abstract void o(int i10, AbstractC11036h0 abstractC11036h0) throws IOException;

    public abstract void p(int i10, InterfaceC11083w1 interfaceC11083w1) throws IOException;

    abstract void q(int i10, InterfaceC11083w1 interfaceC11083w1, O1 o12) throws IOException;
    ...
    public abstract void u(AbstractC11036h0 abstractC11036h0) throws IOException;

    public abstract void v(InterfaceC11083w1 interfaceC11083w1) throws IOException;
    ...
    public static int D(int i10, C11025e1 c11025e1) {
        return (o0(8) << 1) + p0(2, i10) + c(3, c11025e1);
    }

    public static int E(int i10, InterfaceC11083w1 interfaceC11083w1) {
        return (o0(8) << 1) + p0(2, i10) + o0(24) + J(interfaceC11083w1);
    }

    static int F(int i10, InterfaceC11083w1 interfaceC11083w1, O1 o12) {
        return o0(i10 << 3) + e(interfaceC11083w1, o12);
    }
    ...
    public static int T(int i10, AbstractC11036h0 abstractC11036h0) {
        int iO0 = o0(i10 << 3);
    ...
    @Deprecated
    static int U(int i10, InterfaceC11083w1 interfaceC11083w1, O1 o12) {
        int iO0 = o0(i10 << 3) << 1;
        X x10 = (X) interfaceC11083w1;
        int iE = x10.e();
        if (iE == -1) {
    ...
    public static int c(int i10, C11025e1 c11025e1) {
        int iO0 = o0(i10 << 3);
        int iB = c11025e1.b();
        return iO0 + o0(iB) + iB;
    }

    public static int c0(int i10, AbstractC11036h0 abstractC11036h0) {
        return (o0(8) << 1) + p0(2, i10) + T(3, abstractC11036h0);
    }

    static int e(InterfaceC11083w1 interfaceC11083w1, O1 o12) {
        X x10 = (X) interfaceC11083w1;
        int iE = x10.e();
        if (iE == -1) {
            iE = o12.zzb(x10);
    ...
    final void x(String str, r2 r2Var) throws IOException {
        f84696b.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable) r2Var);
        byte[] bytes = str.getBytes(S0.f84465a);
        try {
            O(bytes.length);
    ...
    public static int I(AbstractC11036h0 abstractC11036h0) {
        int iE = abstractC11036h0.e();
        return o0(iE) + iE;
    }

    public static int J(InterfaceC11083w1 interfaceC11083w1) {
        int iZzm = interfaceC11083w1.zzm();
        return o0(iZzm) + iZzm;
    }
    ...
    public static int K(String str) {
        ...
        try {
            ...
            length = str.getBytes(S0.f84465a).length;
        }
        return o0(length) + length;
    }

    @Deprecated
    public static int V(InterfaceC11083w1 interfaceC11083w1) {
        return interfaceC11083w1.zzm();
    }

    public static int d(C11025e1 c11025e1) {
        int iB = c11025e1.b();
        return o0(iB) + iB;
    }
