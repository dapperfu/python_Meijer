...
final class C11037h1 extends AbstractC11029f1 {

    /* renamed from: c, reason: collision with root package name */
    private static final Class<?> f84549c = Collections.unmodifiableList(Collections.EMPTY_LIST).getClass();
    ...
    private static <L> List<L> e(Object obj, long j10, int i10) {
        ...
        if (listF.isEmpty()) {
            if (listF instanceof InterfaceC11033g1) {
                arrayList = new C11021d1(i10);
        ...
        if (f84549c.isAssignableFrom(listF.getClass())) {
        ...
        if (listF instanceof j2) {
            C11021d1 c11021d1 = new C11021d1(listF.size() + i10);
            c11021d1.addAll((j2) listF);
            l2.j(obj, j10, c11021d1);
            return c11021d1;
        }
    ...
    @Override // com.google.android.gms.internal.vision.AbstractC11029f1
    ...
    final void d(Object obj, long j10) {
        ...
        if (list instanceof InterfaceC11033g1) {
            objUnmodifiableList = ((InterfaceC11033g1) list).zze();
        } else if (!f84549c.isAssignableFrom(list.getClass())) {
