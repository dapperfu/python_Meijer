...
final class G0<T extends I0<T>> {
    ...
    private static final G0 f84299d = new G0(true);

    /* renamed from: a, reason: collision with root package name */
    final S1<T, Object> f84300a;
    ...
    private G0() {
        this.f84300a = S1.b(16);
    }

    public final void f(G0<T> g02) {
        for (int i10 = 0; i10 < g02.f84300a.k(); i10++) {
            k(g02.f84300a.i(i10));
        }
        Iterator it = g02.f84300a.r().iterator();
        while (it.hasNext()) {
            k((Map.Entry) it.next());
        }
    }
    ...
    public final boolean r() {
        for (int i10 = 0; i10 < this.f84300a.k(); i10++) {
            if (!h(this.f84300a.i(i10))) {
                return false;
            }
        }
        Iterator it = this.f84300a.r().iterator();
        while (it.hasNext()) {
    ...
    private static int b(w2 w2Var, Object obj) {
        switch (F0.f84295b[w2Var.ordinal()]) {
            case 1:
            ...
            case 9:
                return zzii.V((InterfaceC11083w1) obj);
            case 10:
                return obj instanceof C11009a1 ? zzii.d((C11009a1) obj) : zzii.J((InterfaceC11083w1) obj);
            case 11:
                return obj instanceof AbstractC11036h0 ? zzii.I((AbstractC11036h0) obj) : zzii.K((String) obj);
            case 12:
                return obj instanceof AbstractC11036h0 ? zzii.I((AbstractC11036h0) obj) : zzii.M((byte[]) obj);
            case 13:
    ...
    public final /* synthetic */ Object clone() throws CloneNotSupportedException {
        G0 g02 = new G0();
        for (int i10 = 0; i10 < this.f84300a.k(); i10++) {
            Map.Entry<K, Object> entryI = this.f84300a.i(i10);
        ...
        g02.f84302c = this.f84302c;
        return g02;
    }

    public final Object d(T t10) {
        Object obj = this.f84300a.get(t10);
        return obj instanceof C11009a1 ? C11009a1.e() : obj;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof G0) {
            return this.f84300a.equals(((G0) obj).f84300a);
        }
        return false;
    }
    ...
    public final Iterator<Map.Entry<T, Object>> o() {
        return this.f84302c ? new C11013b1(this.f84300a.entrySet().iterator()) : this.f84300a.entrySet().iterator();
    }

    final Iterator<Map.Entry<T, Object>> q() {
        return this.f84302c ? new C11013b1(this.f84300a.v().iterator()) : this.f84300a.v().iterator();
    }
    ...
    private static <T extends I0<T>> boolean h(Map.Entry<T, Object> entry) {
        ...
        if (key.zzc() == z2.MESSAGE) {
            if (key.zzd()) {
                ...
                while (it.hasNext()) {
                    if (!((InterfaceC11083w1) it.next()).zzk()) {
                        return false;
                    }
                }
            } else {
                Object value = entry.getValue();
                if (value instanceof InterfaceC11083w1) {
                    if (!((InterfaceC11083w1) value).zzk()) {
                        return false;
                    }
                } else {
                    if (value instanceof C11009a1) {
                        return true;
                    }
    ...
    private final void k(Map.Entry<T, Object> entry) {
        InterfaceC11083w1 interfaceC11083w1Zzf;
        T key = entry.getKey();
        Object value = entry.getValue();
        if (value instanceof C11009a1) {
            value = C11009a1.e();
        ...
        if (key.zzd()) {
            ...
            this.f84300a.put(key, objD);
            return;
        }
        if (key.zzc() == z2.MESSAGE) {
            Object objD2 = d(key);
            if (objD2 == null) {
                this.f84300a.put(key, e(value));
                return;
            }
            if (objD2 instanceof E1) {
                interfaceC11083w1Zzf = key.n((E1) objD2, (E1) value);
            } else {
                interfaceC11083w1Zzf = key.A(((InterfaceC11083w1) objD2).zzp(), (InterfaceC11083w1) value).zzf();
            }
            this.f84300a.put(key, interfaceC11083w1Zzf);
            return;
        }
        this.f84300a.put(key, e(value));
    }
    ...
    private static int m(Map.Entry<T, Object> entry) {
        ...
        if (key.zzc() == z2.MESSAGE && !key.zzd() && !key.zze()) {
            if (value instanceof C11009a1) {
                return zzii.D(entry.getKey().zza(), (C11009a1) value);
            }
            return zzii.E(entry.getKey().zza(), (InterfaceC11083w1) value);
        }
        return l(key, value);
    }
    ...
    */
    private static void p(T r3, java.lang.Object r4) {
        /*
            ...
            int[] r1 = com.google.android.gms.internal.vision.F0.f84294a
        ...
        L18:
            ...
            goto L46
        L1a:
            boolean r0 = r4 instanceof com.google.android.gms.internal.vision.InterfaceC11083w1
            if (r0 != 0) goto L46
            boolean r0 = r4 instanceof com.google.android.gms.internal.vision.C11009a1
            if (r0 == 0) goto L18
            goto L46
        L23:
            ...
            goto L46
        L2c:
            boolean r0 = r4 instanceof com.google.android.gms.internal.vision.AbstractC11036h0
            if (r0 != 0) goto L46
    ...
    public final void g(T t10, Object obj) {
        ...
        if (obj instanceof C11009a1) {
            this.f84302c = true;
        }
        this.f84300a.put(t10, obj);
    }
    ...
    public final void j(T t10, Object obj) {
        ...
        if (t10.zzd()) {
            ...
            if (objD == null) {
                ...
                this.f84300a.put(t10, arrayList);
            } else {
                arrayList = (List) objD;
            }
            arrayList.add(obj);
