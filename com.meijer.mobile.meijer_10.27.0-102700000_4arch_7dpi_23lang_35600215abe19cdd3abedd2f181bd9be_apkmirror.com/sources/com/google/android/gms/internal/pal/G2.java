...
public final class G2 extends K2 {
            ...
            try {
                ...
                try {
                    try {
                        ...
                        try {
                            F7 f7B = F7.b(C10871r7.a(inputStream));
                            if (inputStream != null) {
                                inputStream.close();
                            }
    ...
    final AbstractC10870r6 a() throws NonceLoaderException {
        try {
            C10746j9.a();
            return AbstractC10870r6.f(new F2((InterfaceC10856q7) g().c(InterfaceC10856q7.class)));
