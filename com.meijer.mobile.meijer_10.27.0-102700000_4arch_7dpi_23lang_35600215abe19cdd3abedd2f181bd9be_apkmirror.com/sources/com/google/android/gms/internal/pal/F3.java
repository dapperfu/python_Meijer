...
public final class F3 {
    ...
    private static Cipher f82606a;

    /* renamed from: b, reason: collision with root package name */
    private static final Object f82607b = new Object();

    /* renamed from: c, reason: collision with root package name */
    private static final Object f82608c = new Object();
    ...
    private static final Cipher c() throws NoSuchPaddingException, NoSuchAlgorithmException {
        Cipher cipher;
        synchronized (f82608c) {
            try {
                if (f82606a == null) {
                    f82606a = Cipher.getInstance("AES/CBC/PKCS5Padding");
                }
                cipher = f82606a;
            } catch (Throwable th2) {
                throw th2;
