...
public final class C10815ne implements InterfaceC10776l7 {

    /* renamed from: e, reason: collision with root package name */
    private static final ThreadLocal f83244e = new C10783le();

    /* renamed from: f, reason: collision with root package name */
    private static final ThreadLocal f83245f = new C10799me();

    /* renamed from: a, reason: collision with root package name */
    private final byte[] f83246a;

    /* renamed from: b, reason: collision with root package name */
    private final byte[] f83247b;

    /* renamed from: c, reason: collision with root package name */
    private final SecretKeySpec f83248c;

    /* renamed from: d, reason: collision with root package name */
    private final int f83249d;
    ...
    private final byte[] b(Cipher cipher, int i10, byte[] bArr, int i11, int i12) throws BadPaddingException, IllegalBlockSizeException {
        ...
        bArr2[15] = (byte) i10;
        if (i12 == 0) {
            return cipher.doFinal(c(bArr2, this.f83246a));
        }
        ...
        if (bArrCopyOfRange.length == 16) {
            bArrC = c(bArrCopyOfRange, this.f83246a);
        } else {
            byte[] bArrCopyOf = Arrays.copyOf(this.f83247b, 16);
            while (true) {
    ...
    public final byte[] zza(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        int length = bArr.length;
        int i10 = this.f83249d;
        if (length > 2147483631 - i10) {
            throw new GeneralSecurityException("plaintext too long");
        }
        byte[] bArr3 = new byte[i10 + length + 16];
        byte[] bArrA = We.a(i10);
        System.arraycopy(bArrA, 0, bArr3, 0, this.f83249d);
        Cipher cipher = (Cipher) f83244e.get();
        cipher.init(1, this.f83248c);
        byte[] bArrB = b(cipher, 0, bArrA, 0, bArrA.length);
        byte[] bArrB2 = b(cipher, 1, bArr2, 0, 0);
        Cipher cipher2 = (Cipher) f83245f.get();
        cipher2.init(1, this.f83248c, new IvParameterSpec(bArrB));
        cipher2.doFinal(bArr, 0, length, bArr3, this.f83249d);
        byte[] bArrB3 = b(cipher, 2, bArr3, this.f83249d, length);
        int i11 = length + this.f83249d;
    ...
    public C10815ne(byte[] bArr, int i10) throws GeneralSecurityException {
        if (W8.a(1)) {
            if (i10 != 12 && i10 != 16) {
            ...
            this.f83248c = secretKeySpec;
            Cipher cipher = (Cipher) f83244e.get();
            cipher.init(1, secretKeySpec);
            byte[] bArrA = a(cipher.doFinal(new byte[16]));
            this.f83246a = bArrA;
            this.f83247b = a(bArrA);
            return;
        }
