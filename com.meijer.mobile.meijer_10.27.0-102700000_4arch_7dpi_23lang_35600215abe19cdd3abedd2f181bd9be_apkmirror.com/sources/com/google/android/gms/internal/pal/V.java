...
final class V extends Y {
    ...
    @Override // com.google.android.gms.internal.pal.Y, com.google.android.gms.internal.pal.AbstractC10605b0
    public final int f() {
        return this.f82919f;
    }
    ...
    V(byte[] bArr, int i10, int i11) {
        super(bArr);
        AbstractC10605b0.q(0, i11, bArr.length);
        this.f82919f = i11;
    }
}
