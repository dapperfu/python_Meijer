...
final class Oe {
    ...
    private static final int[] f82819a = {0, 3, 6, 9, 12, 16, 19, 22, 25, 28};

    /* renamed from: b, reason: collision with root package name */
    private static final int[] f82820b = {0, 2, 3, 5, 6, 0, 1, 3, 4, 6};

    /* renamed from: c, reason: collision with root package name */
    private static final int[] f82821c = {67108863, 33554431};

    /* renamed from: d, reason: collision with root package name */
    private static final int[] f82822d = {26, 25};
    ...
    static byte[] j(long[] jArr) {
        ...
        while (true) {
            ...
            while (i12 < 9) {
                ...
                int i13 = -((int) (((j10 >> 31) & j10) >> f82822d[i12 & 1]));
        ...
        for (int i15 = 0; i15 < 2; i15++) {
            ...
            while (i16 < 9) {
                ...
                int i17 = f82822d[i16 & 1];
                jArrCopyOf[i16] = f82821c[r11] & j13;
                i16++;
        ...
        for (int i19 = 1; i19 < 10; i19++) {
            int i20 = ~(((int) jArrCopyOf[i19]) ^ f82821c[i19 & 1]);
            int i21 = i20 & (i20 << 16);
            int i22 = i21 & (i21 << 8);
            int i23 = i22 & (i22 << 4);
            int i24 = i23 & (i23 << 2);
        ...
        for (int i26 = 0; i26 < 10; i26++) {
            jArrCopyOf[i26] = jArrCopyOf[i26] << f82820b[i26];
        }
    ...
    static long[] k(byte[] bArr) {
        ...
        for (int i10 = 0; i10 < 10; i10++) {
            int i11 = f82819a[i10];
            jArr[i10] = (((((bArr[i11] & 255) | ((bArr[i11 + 1] & 255) << 8)) | ((bArr[i11 + 2] & 255) << 16)) | ((bArr[i11 + 3] & 255) << 24)) >> f82820b[i10]) & f82821c[i10 & 1];
        }
        return jArr;
    }
