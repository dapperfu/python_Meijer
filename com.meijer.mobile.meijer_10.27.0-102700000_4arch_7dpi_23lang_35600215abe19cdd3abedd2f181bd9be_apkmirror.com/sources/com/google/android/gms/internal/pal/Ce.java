...
public final class Ce {
    public static KeyPair c(ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        KeyPairGenerator keyPairGenerator = (KeyPairGenerator) Ee.f82589j.a("EC");
    ...
    public static byte[] g(ECPrivateKey eCPrivateKey, ECPublicKey eCPublicKey) throws IllegalStateException, GeneralSecurityException {
        ...
        PublicKey publicKeyGeneratePublic = ((KeyFactory) Ee.f82590k.a("EC")).generatePublic(new ECPublicKeySpec(w10, eCPrivateKey.getParams()));
        KeyAgreement keyAgreement = (KeyAgreement) Ee.f82588i.a("ECDH");
    ...
    public static ECPrivateKey h(int i10, byte[] bArr) throws GeneralSecurityException {
        return (ECPrivateKey) ((KeyFactory) Ee.f82590k.a("EC")).generatePrivate(new ECPrivateKeySpec(new BigInteger(1, bArr), k(i10)));
    }
    ...
    public static ECPublicKey i(int i10, byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ...
        return (ECPublicKey) ((KeyFactory) Ee.f82590k.a("EC")).generatePublic(new ECPublicKeySpec(eCPoint, eCParameterSpecK));
    }
    ...
    public static ECPublicKey j(ECParameterSpec eCParameterSpec, int i10, byte[] bArr) throws GeneralSecurityException {
        ...
        if (length == iA + iA + 1) {
            if (bArr[0] == 4) {
                ...
                d(eCPoint, curve);
                return (ECPublicKey) ((KeyFactory) Ee.f82590k.a("EC")).generatePublic(new ECPublicKeySpec(eCPoint, eCParameterSpec));
            }
