...
public final class Te implements InterfaceC10732ib {

    /* renamed from: a, reason: collision with root package name */
    private final ThreadLocal f82892a;

    /* renamed from: b, reason: collision with root package name */
    private final String f82893b;

    /* renamed from: c, reason: collision with root package name */
    private final Key f82894c;
    ...
    public final byte[] a(byte[] bArr, int i10) throws IllegalStateException, GeneralSecurityException {
        ...
        ((Mac) this.f82892a.get()).update(bArr);
        return Arrays.copyOf(((Mac) this.f82892a.get()).doFinal(), i10);
    }
