        ...
        if (byteBuffer.remaining() >= bArr2.length) {
            ...
            if (bArr.length == a()) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    ByteBuffer byteBufferC = c(bArr, this.f82796b + i12);
                    if (i12 == i10) {
                        C10910te.a(byteBuffer, byteBufferWrap, byteBufferC, iRemaining % 64);
                    } else {
                        C10910te.a(byteBuffer, byteBufferWrap, byteBufferC, 64);
                    }
                }
                return;
            }
