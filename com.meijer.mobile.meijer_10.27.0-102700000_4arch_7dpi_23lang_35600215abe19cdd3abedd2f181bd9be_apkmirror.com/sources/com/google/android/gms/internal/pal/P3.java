...
final class P3 implements Application.ActivityLifecycleCallbacks {
    ...
    private final Application f82827a;

    /* renamed from: b, reason: collision with root package name */
    private final WeakReference f82828b;

    /* renamed from: c, reason: collision with root package name */
    private boolean f82829c = false;

    protected final void a(O3 o32) {
        try {
            Application.ActivityLifecycleCallbacks activityLifecycleCallbacks = (Application.ActivityLifecycleCallbacks) this.f82828b.get();
            if (activityLifecycleCallbacks != null) {
                ...
                this.f82827a.unregisterActivityLifecycleCallbacks(this);
                this.f82829c = true;
            }
    ...
    public P3(Application application, Application.ActivityLifecycleCallbacks activityLifecycleCallbacks) {
        this.f82828b = new WeakReference(activityLifecycleCallbacks);
