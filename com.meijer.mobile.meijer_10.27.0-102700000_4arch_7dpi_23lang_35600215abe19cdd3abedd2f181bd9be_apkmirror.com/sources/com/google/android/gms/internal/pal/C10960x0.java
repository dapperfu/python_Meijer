...
final class C10960x0 implements InterfaceC10657e1 {

    /* renamed from: a, reason: collision with root package name */
    private static final C10960x0 f84197a = new C10960x0();

    private C10960x0() {
    }

    public static C10960x0 a() {
        return f84197a;
    }
    ...
    public final InterfaceC10640d1 zzb(Class cls) {
        ...
        try {
            return (InterfaceC10640d1) B0.m(cls.asSubclass(B0.class)).r(3, null, null);
        } catch (Exception e10) {
