...
public final class N7 {
    ...
    private final Class f82791a;

    /* renamed from: c, reason: collision with root package name */
    private O7 f82793c;

    /* renamed from: b, reason: collision with root package name */
    private ConcurrentMap f82792b = new ConcurrentHashMap();

    /* renamed from: d, reason: collision with root package name */
    private C10599ab f82794d = C10599ab.f83052b;
    ...
    private final N7 e(Object obj, Ed ed2, boolean z10) throws GeneralSecurityException {
        ...
        ConcurrentMap concurrentMap = this.f82792b;
        Integer numValueOf = Integer.valueOf(ed2.t());
        if (ed2.G() == 5) {
            numValueOf = null;
        }
        AbstractC10903t7 abstractC10903t7A = C10715ha.b().a(C10859qa.e(ed2.u().z(), ed2.u().y(), ed2.u().u(), ed2.G(), numValueOf), C10596a8.a());
        L7 s72 = abstractC10903t7A instanceof C10598aa ? new S7(ed2.u().z(), ed2.G(), null) : abstractC10903t7A.a();
        int iG = ed2.G() - 2;
        if (iG == 1) {
            ...
            bArrArray = C10808n7.f83239a;
        }
        O7 o72 = new O7(obj, bArrArray, ed2.E(), ed2.G(), ed2.t(), abstractC10903t7A, s72);
    ...
    public final N7 c(C10599ab c10599ab) {
        if (this.f82792b == null) {
            throw new IllegalStateException("setAnnotations cannot be called after build");
        }
        this.f82794d = c10599ab;
        return this;
    }
    ...
    public final V7 d() throws GeneralSecurityException {
        ...
        V7 v72 = new V7(concurrentMap, this.f82793c, this.f82794d, this.f82791a, null);
        this.f82792b = null;
        return v72;
    }
