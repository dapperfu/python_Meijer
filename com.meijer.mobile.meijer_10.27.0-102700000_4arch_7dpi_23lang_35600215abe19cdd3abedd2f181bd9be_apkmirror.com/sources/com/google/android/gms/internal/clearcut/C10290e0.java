...
final class C10290e0 implements I0 {

    /* renamed from: a, reason: collision with root package name */
    private static final C10290e0 f81414a = new C10290e0();

    private C10290e0() {
    }

    public static C10290e0 a() {
        return f81414a;
    }

    @Override // com.google.android.gms.internal.clearcut.I0
    public final boolean zza(Class<?> cls) {
        return AbstractC10293f0.class.isAssignableFrom(cls);
    }
    ...
    public final H0 zzb(Class<?> cls) {
        ...
        try {
            return (H0) AbstractC10293f0.p(cls.asSubclass(AbstractC10293f0.class)).f(AbstractC10293f0.e.f81436c, null, null);
        } catch (Exception e10) {
