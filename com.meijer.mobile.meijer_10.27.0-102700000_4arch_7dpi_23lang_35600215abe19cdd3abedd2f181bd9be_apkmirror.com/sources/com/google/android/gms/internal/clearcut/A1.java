...
final class A1 {
    ...
    private static final B1 f81101a;

    static {
        f81101a = (C10350y1.x() && C10350y1.y()) ? new E1() : new C1();
    }
    ...
    static int b(CharSequence charSequence, byte[] bArr, int i10, int i11) {
        return f81101a.b(charSequence, bArr, i10, i11);
    }
    ...
    public static boolean h(byte[] bArr) {
        return f81101a.e(bArr, 0, bArr.length);
    }

    public static boolean i(byte[] bArr, int i10, int i11) {
        return f81101a.e(bArr, i10, i11);
    }
