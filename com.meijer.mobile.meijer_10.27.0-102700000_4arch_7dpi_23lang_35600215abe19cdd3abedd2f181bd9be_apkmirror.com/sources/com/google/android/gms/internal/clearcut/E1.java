...
final class E1 extends B1 {
    ...
    private static int f(byte[] bArr, int i10, long j10, int i11) {
        ...
        if (i11 == 1) {
            return A1.l(i10, C10350y1.a(bArr, j10));
        }
        if (i11 == 2) {
            return A1.f(i10, C10350y1.a(bArr, j10), C10350y1.a(bArr, j10 + 1));
        }
    ...
    */
    ...
    final int b(CharSequence charSequence, byte[] bArr, int i10, int i11) {
        ...
        while (true) {
            ...
            C10350y1.k(bArr, j13, (byte) cCharAt);
            i13++;
            j13 = 1 + j13;
        }
        if (i13 == length) {
        ...
        while (i13 < length) {
            ...
            if (cCharAt3 < 128 && j13 < j14) {
                C10350y1.k(bArr, j13, (byte) cCharAt3);
                j12 = j14;
                j11 = j10;
                j13 += j10;
                ...
                if ((cCharAt3 >= 55296 && 57343 >= cCharAt3) || j13 > j14 - 3) {
                    ...
                    if (i14 != length) {
                        ...
                        if (Character.isSurrogatePair(cCharAt3, cCharAt4)) {
                            ...
                            C10350y1.k(bArr, j13, (byte) ((codePoint >>> 18) | 240));
                            C10350y1.k(bArr, j13 + j11, (byte) (((codePoint >>> 12) & 63) | 128));
                            long j15 = j13 + 3;
                            C10350y1.k(bArr, j13 + 2, (byte) (((codePoint >>> 6) & 63) | 128));
                            j13 += 4;
                            C10350y1.k(bArr, j15, (byte) ((codePoint & 63) | 128));
                            i13 = i14;
                        } else {
                            i13 = i14;
                        }
                ...
                C10350y1.k(bArr, j13, (byte) ((cCharAt3 >>> '\f') | 480));
                long j16 = j13 + 2;
                j12 = j14;
                C10350y1.k(bArr, j13 + j11, (byte) (((cCharAt3 >>> 6) & 63) | 128));
                j13 += 3;
                C10350y1.k(bArr, j16, (byte) ((cCharAt3 & '?') | 128));
            } else {
                j11 = j10;
                long j17 = j13 + j11;
                C10350y1.k(bArr, j13, (byte) ((cCharAt3 >>> 6) | 960));
                j13 += 2;
                C10350y1.k(bArr, j17, (byte) ((cCharAt3 & '?') | 128));
                j12 = j14;
            }
            i13++;
            j10 = j11;
    ...
    final void c(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        while (true) {
            ...
            C10350y1.c(jPosition, (byte) cCharAt);
            i11++;
            ...
            while (i11 < length) {
                ...
                if (cCharAt3 >= c10 || jPosition >= jLimit) {
                    ...
                    if (cCharAt3 < 2048 && jPosition <= jLimit - 2) {
                        ...
                        C10350y1.c(jPosition, (byte) ((cCharAt3 >>> 6) | 960));
                        jPosition += 2;
                        C10350y1.c(j15, (byte) ((cCharAt3 & '?') | 128));
                        j13 = jO;
                        j14 = jLimit;
                    } else {
                        if ((cCharAt3 >= 55296 && 57343 >= cCharAt3) || jPosition > jLimit - 3) {
                            ...
                            if (i12 != length) {
                                ...
                                if (Character.isSurrogatePair(cCharAt3, cCharAt4)) {
                                    int codePoint = Character.toCodePoint(cCharAt3, cCharAt4);
                                    C10350y1.c(jPosition, (byte) ((codePoint >>> 18) | 240));
                                    c11 = 128;
                                    C10350y1.c(jPosition + j12, (byte) (((codePoint >>> 12) & 63) | 128));
                                    long j16 = jPosition + 3;
                                    C10350y1.c(jPosition + 2, (byte) (((codePoint >>> 6) & 63) | 128));
                                    jPosition += 4;
                                    C10350y1.c(j16, (byte) ((codePoint & 63) | 128));
                                    i11 = i12;
                                } else {
                                    i11 = i12;
                                }
                        ...
                        C10350y1.c(jPosition, (byte) ((cCharAt3 >>> '\f') | 480));
                        j13 = jO;
                        long j17 = jPosition + 2;
                        j14 = jLimit;
                        C10350y1.c(jPosition + j12, (byte) (((cCharAt3 >>> 6) & 63) | 128));
                        jPosition += 3;
                        C10350y1.c(j17, (byte) ((cCharAt3 & '?') | 128));
                    }
                    c11 = 128;
                } else {
                    C10350y1.c(jPosition, (byte) cCharAt3);
                    j13 = jO;
                    j14 = jLimit;
                    c11 = c10;
                    jPosition += j10;
