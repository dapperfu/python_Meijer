...
public final class N1 {
    ...
    private final ByteBuffer f81176a;

    /* renamed from: b, reason: collision with root package name */
    private zzbn f81177b;

    /* renamed from: c, reason: collision with root package name */
    private int f81178c;

    private N1(ByteBuffer byteBuffer) {
        this.f81176a = byteBuffer;
    ...
    private final void e(int i10) throws IOException {
        byte b10 = (byte) i10;
        if (!this.f81176a.hasRemaining()) {
            throw new zzft(this.f81176a.position(), this.f81176a.limit());
        }
        this.f81176a.put(b10);
    }

    private final void f(int i10) throws IOException {
        while ((i10 & (-128)) != 0) {
            e((i10 & l3.f92485d) | 128);
            i10 >>>= 7;
        }
        e(i10);
    }
    ...
    public final void c(int i10, String str) throws IOException {
        ...
        try {
            ...
            int iPosition = this.f81176a.position();
            if (this.f81176a.remaining() < iA) {
                throw new zzft(iPosition + iA, this.f81176a.limit());
            }
            this.f81176a.position(iPosition + iA);
            n(str, this.f81176a);
            int iPosition2 = this.f81176a.position();
            this.f81176a.position(iPosition);
            f((iPosition2 - iPosition) - iA);
            this.f81176a.position(iPosition2);
        } catch (BufferOverflowException e10) {
            zzft zzftVar = new zzft(this.f81176a.position(), this.f81176a.limit());
    ...
    public final void d(int i10, byte[] bArr) throws IOException {
        ...
        if (this.f81176a.remaining() < length) {
            throw new zzft(this.f81176a.position(), this.f81176a.limit());
        }
        this.f81176a.put(bArr, 0, length);
    }
    ...
    public final void o(int i10, J0 j02) throws IOException {
        if (this.f81177b != null) {
            if (this.f81178c != this.f81176a.position()) {
                this.f81177b.c(this.f81176a.array(), this.f81178c, this.f81176a.position() - this.f81178c);
            }
            zzbn zzbnVar = this.f81177b;
            zzbnVar.n(i10, j02);
            zzbnVar.b();
            this.f81178c = this.f81176a.position();
        }
        this.f81177b = zzbn.f(this.f81176a);
        this.f81178c = this.f81176a.position();
        zzbn zzbnVar2 = this.f81177b;
        zzbnVar2.n(i10, j02);
        zzbnVar2.b();
        this.f81178c = this.f81176a.position();
    }
    ...
    public final void p() {
        if (this.f81176a.remaining() != 0) {
            throw new IllegalStateException(String.format("Did not write as much data as expected, %s bytes remaining.", Integer.valueOf(this.f81176a.remaining())));
        }
    }
