...
final class C10310l extends AbstractC10292f<String> {
    C10310l(C10322p c10322p, String str, String str2) {
        super(c10322p, str, str2, null);
    }
    ...
    public final String f(SharedPreferences sharedPreferences) {
        try {
            return sharedPreferences.getString(this.f81422b, null);
