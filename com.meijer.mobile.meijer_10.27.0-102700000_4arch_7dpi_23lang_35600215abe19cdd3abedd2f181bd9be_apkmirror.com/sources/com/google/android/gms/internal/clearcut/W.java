...
final class W<FieldDescriptorType extends Z<FieldDescriptorType>> {
    ...
    private static final W f81218d = new W(true);

    /* renamed from: b, reason: collision with root package name */
    private boolean f81220b;

    /* renamed from: c, reason: collision with root package name */
    private boolean f81221c = false;

    /* renamed from: a, reason: collision with root package name */
    private final C10288d1<FieldDescriptorType, Object> f81219a = C10288d1.g(16);
    ...
    private final Object g(FieldDescriptorType fielddescriptortype) {
        Object obj = this.f81219a.get(fielddescriptortype);
        return obj instanceof C10314m0 ? C10314m0.e() : obj;
    }
    ...
    private final void i(FieldDescriptorType fielddescriptortype, Object obj) {
        ...
        if (obj instanceof C10314m0) {
            this.f81221c = true;
        }
        this.f81219a.put(fielddescriptortype, obj);
    }
    ...
    */
    private static void j(com.google.android.gms.internal.clearcut.G1 r2, java.lang.Object r3) {
        /*
            com.google.android.gms.internal.clearcut.C10299h0.a(r3)
            int[] r0 = com.google.android.gms.internal.clearcut.X.f81224a
        ...
        L15:
            ...
            if (r2 != 0) goto L28
            boolean r2 = r3 instanceof com.google.android.gms.internal.clearcut.C10314m0
            if (r2 == 0) goto L27
            goto L28
        L1e:
            boolean r2 = r3 instanceof java.lang.Integer
            if (r2 != 0) goto L28
            boolean r2 = r3 instanceof com.google.android.gms.internal.clearcut.InterfaceC10302i0
            if (r2 == 0) goto L27
            goto L28
        L27:
            r0 = r1
    ...
    private static int o(G1 g12, Object obj) {
        switch (X.f81225b[g12.ordinal()]) {
            ...
            case 10:
                return obj instanceof C10314m0 ? zzbn.e((C10314m0) obj) : zzbn.R((J0) obj);
            case 11:
            ...
            case 18:
                return obj instanceof InterfaceC10302i0 ? zzbn.H0(((InterfaceC10302i0) obj).zzc()) : zzbn.H0(((Integer) obj).intValue());
            default:
    ...
    private final void q(Map.Entry<FieldDescriptorType, Object> entry) {
        ...
        if (key.s()) {
            ...
            this.f81219a.put(key, objG);
            return;
        }
        if (key.q() != L1.MESSAGE) {
            this.f81219a.put(key, s(value));
            return;
        }
        Object objG2 = g(key);
        if (objG2 == null) {
            ...
            this.f81219a.put(key, objG2 instanceof P0 ? key.v((P0) objG2, (P0) value) : key.y(((J0) objG2).j(), (J0) value).c0());
        }
    }
    ...
    private static int r(Map.Entry<FieldDescriptorType, Object> entry) {
        ...
        boolean z10 = value instanceof C10314m0;
        int iZzc = entry.getKey().zzc();
        return z10 ? zzbn.A(iZzc, (C10314m0) value) : zzbn.Y(iZzc, (J0) value);
    }
    ...
    final Iterator<Map.Entry<FieldDescriptorType, Object>> a() {
        return this.f81221c ? new C10323p0(this.f81219a.s().iterator()) : this.f81219a.s().iterator();
    }

    final boolean b() {
        return this.f81219a.isEmpty();
    }
    ...
    public final /* synthetic */ Object clone() throws CloneNotSupportedException {
        W w10 = new W();
        for (int i10 = 0; i10 < this.f81219a.q(); i10++) {
            Map.Entry<K, Object> entryH = this.f81219a.h(i10);
            w10.i((Z) entryH.getKey(), entryH.getValue());
        }
        Iterator it = this.f81219a.r().iterator();
        while (it.hasNext()) {
            Map.Entry entry = (Map.Entry) it.next();
            w10.i((Z) entry.getKey(), entry.getValue());
        }
        w10.f81221c = this.f81221c;
        return w10;
    }

    public final boolean d() {
        for (int i10 = 0; i10 < this.f81219a.q(); i10++) {
            if (!p(this.f81219a.h(i10))) {
                return false;
            }
        }
        Iterator it = this.f81219a.r().iterator();
    ...
    public final Iterator<Map.Entry<FieldDescriptorType, Object>> e() {
        return this.f81221c ? new C10323p0(this.f81219a.entrySet().iterator()) : this.f81219a.entrySet().iterator();
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof W) {
            return this.f81219a.equals(((W) obj).f81219a);
        }
        return false;
    }

    public final void h(W<FieldDescriptorType> w10) {
        for (int i10 = 0; i10 < w10.f81219a.q(); i10++) {
            q(w10.f81219a.h(i10));
        }
        Iterator it = w10.f81219a.r().iterator();
        while (it.hasNext()) {
            q((Map.Entry) it.next());
        }
    }
