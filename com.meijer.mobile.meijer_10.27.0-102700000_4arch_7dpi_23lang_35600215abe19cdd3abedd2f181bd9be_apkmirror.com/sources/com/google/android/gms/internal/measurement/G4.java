...
public abstract class G4 implements Iterable, Serializable {
    ...
    public static final G4 f81770b = new F4(C10486o5.f82316b);

    /* renamed from: a, reason: collision with root package name */
    private int f81771a = 0;
    ...
    abstract void k(C10565x4 c10565x4) throws IOException;
    ...
    public final /* synthetic */ Iterator iterator() {
        return new C10583z4(this);
    }

    public final String toString() {
        return String.format(Locale.ROOT, "<ByteString@%s size=%d contents=\"%s\">", Integer.toHexString(System.identityHashCode(this)), Integer.valueOf(f()), f() <= 50 ? C10406f6.a(this) : C10406f6.a(h(0, 47)).concat("..."));
    }
}
