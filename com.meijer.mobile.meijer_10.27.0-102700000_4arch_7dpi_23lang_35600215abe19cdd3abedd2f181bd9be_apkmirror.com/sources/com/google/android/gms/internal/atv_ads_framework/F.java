...
public abstract class F extends C implements List, RandomAccess {
    ...
    private static final X f80754b = new D(M.f80844f, 0);

    /* renamed from: c, reason: collision with root package name */
    public static final /* synthetic */ int f80755c = 0;
    ...
    public final boolean equals(Object obj) {
        ...
        if (list instanceof RandomAccess) {
            for (int i10 = 0; i10 < size; i10++) {
                if (!C10239n.a(get(i10), list.get(i10))) {
                    return false;
                }
            }
            return true;
        ...
        while (it.hasNext()) {
            if (!it2.hasNext() || !C10239n.a(it.next(), it2.next())) {
                return false;
            }
        }
        return !it2.hasNext();
    ...
    static F o(Object[] objArr, int i10) {
        return i10 == 0 ? M.f80844f : new M(objArr, i10);
    }
