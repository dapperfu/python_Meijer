...
public abstract class AbstractC10269x0 extends C10219g0 {

    /* renamed from: b, reason: collision with root package name */
    private static final Logger f81072b = Logger.getLogger(AbstractC10269x0.class.getName());

    /* renamed from: c, reason: collision with root package name */
    private static final boolean f81073c = C10201a2.C();

    /* renamed from: d, reason: collision with root package name */
    public static final /* synthetic */ int f81074d = 0;

    /* renamed from: a, reason: collision with root package name */
    C10272y0 f81075a;

    private AbstractC10269x0() {
    }
    ...
    public abstract void g(int i10, AbstractC10249q0 abstractC10249q0) throws IOException;
    ...
    /* synthetic */ AbstractC10269x0(C10266w0 c10266w0) {
    }

    public static AbstractC10269x0 A(byte[] bArr, int i10, int i11) {
        return new C10263v0(bArr, 0, i11);
    }

    @Deprecated
    static int u(int i10, InterfaceC10247p1 interfaceC10247p1, InterfaceC10276z1 interfaceC10276z1) {
        int iB = ((AbstractC10210d0) interfaceC10247p1).b(interfaceC10276z1);
        int iY = y(i10 << 3);
        return iY + iY + iB;
    }

    static int w(InterfaceC10247p1 interfaceC10247p1, InterfaceC10276z1 interfaceC10276z1) {
        int iB = ((AbstractC10210d0) interfaceC10247p1).b(interfaceC10276z1);
        return y(iB) + iB;
    }

    final void b(String str, e2 e2Var) throws IOException {
        f81072b.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable) e2Var);
        byte[] bytes = str.getBytes(S0.f80873b);
        try {
    ...
    public static int x(String str) {
        ...
        try {
            ...
            length = str.getBytes(S0.f80873b).length;
        }
