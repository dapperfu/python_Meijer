...
final class n0 implements Handler.Callback {
    ...
    public final boolean handleMessage(Message message) {
        ...
        if (i10 == 0) {
            synchronized (this.f64906a.f64919g) {
                try {
                    l0 l0Var = (l0) message.obj;
                    m0 m0Var = (m0) this.f64906a.f64919g.get(l0Var);
                    if (m0Var != null && m0Var.i()) {
                        if (m0Var.j()) {
                            m0Var.g("GmsClientSupervisor");
                        }
                        this.f64906a.f64919g.remove(l0Var);
                    }
                } finally {
                }
            }
        ...
        synchronized (this.f64906a.f64919g) {
            try {
                ...
                m0 m0Var2 = (m0) this.f64906a.f64919g.get(l0Var2);
