...
import com.google.android.gms.internal.vision.C11027f;
...
public class VisionClearcutLogger {
    private final C13642a zza;
    private boolean zzb = true;

    public VisionClearcutLogger(@RecentlyNonNull Context context) {
        this.zza = new C13642a(context, "VISION", null);
    }

    public final void zza(int i10, C11084x c11084x) {
        byte[] bArrD = c11084x.d();
        if (i10 >= 0 && i10 <= 3) {
            try {
                if (this.zzb) {
