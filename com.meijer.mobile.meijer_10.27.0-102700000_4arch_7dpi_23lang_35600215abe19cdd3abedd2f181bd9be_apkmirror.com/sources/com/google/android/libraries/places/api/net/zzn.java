...
final class zzn extends FindCurrentPlaceRequest {
    ...
    private final AbstractC5223a zzb;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof FindCurrentPlaceRequest) {
            ...
            if (this.zza.equals(findCurrentPlaceRequest.getPlaceFields()) && ((abstractC5223a = this.zzb) != null ? abstractC5223a.equals(findCurrentPlaceRequest.getCancellationToken()) : findCurrentPlaceRequest.getCancellationToken() == null)) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        ...
        AbstractC5223a abstractC5223a = this.zzb;
        return (iHashCode * 1000003) ^ (abstractC5223a == null ? 0 : abstractC5223a.hashCode());
    }
    ...
    /* synthetic */ zzn(List list, AbstractC5223a abstractC5223a, byte[] bArr) {
        this.zza = list;
