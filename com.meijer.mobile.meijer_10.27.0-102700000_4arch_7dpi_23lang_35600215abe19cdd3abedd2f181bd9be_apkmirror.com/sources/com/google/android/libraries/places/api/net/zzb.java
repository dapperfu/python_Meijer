...
final class zzb extends FetchPhotoRequest {
        ...
        if (obj instanceof FetchPhotoRequest) {
            ...
            if (num != null ? num.equals(fetchPhotoRequest.getMaxWidth()) : fetchPhotoRequest.getMaxWidth() == null) {
                ...
                if (num2 != null ? num2.equals(fetchPhotoRequest.getMaxHeight()) : fetchPhotoRequest.getMaxHeight() == null) {
                    if (this.zzc.equals(fetchPhotoRequest.getPhotoMetadata()) && ((abstractC5223a = this.zzd) != null ? abstractC5223a.equals(fetchPhotoRequest.getCancellationToken()) : fetchPhotoRequest.getCancellationToken() == null)) {
                        return true;
                    }
                }
            }
    ...
    /* synthetic */ zzb(Integer num, Integer num2, PhotoMetadata photoMetadata, AbstractC5223a abstractC5223a, byte[] bArr) {
        this.zza = num;
        this.zzb = num2;
