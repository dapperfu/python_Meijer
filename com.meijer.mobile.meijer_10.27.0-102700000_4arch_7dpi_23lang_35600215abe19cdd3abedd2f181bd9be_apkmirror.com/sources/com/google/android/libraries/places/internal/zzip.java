...
public final class zzip {
    ...
    public final AbstractC5232j zzd(final FetchResolvedPhotoUriRequest fetchResolvedPhotoUriRequest, final zzmo zzmoVar) {
        if (zzmoVar == zzmo.PLACES_UI_KIT && this.zzk.zzc == null) {
            return C5235m.e(new ApiException(new Status(PlacesStatusCodes.INVALID_REQUEST, "Get Photo Media for Places UI Kit but widget type is null")));
        }
        ...
        AbstractC5223a cancellationToken = fetchResolvedPhotoUriRequest.getCancellationToken();
        if (cancellationToken != null) {
            cancellationToken.b(new InterfaceC5230h() { // from class: com.google.android.libraries.places.internal.zzhz
        ...
        return zzeg.zza(qVarE).s(zzhx.zza).k(new InterfaceC5225c() { // from class: com.google.android.libraries.places.internal.zzhy
            @Override // Td.InterfaceC5225c
            public final /* synthetic */ Object then(AbstractC5232j abstractC5232j) {
                this.zza.zzt(jZzb, zzmoVar, qVarZzy, abstractC5232j);
    ...
    final /* synthetic */ AbstractC5232j zzk(SearchByTextRequest searchByTextRequest, zzayk zzaykVar) {
    ...
    final /* synthetic */ AbstractC5232j zzn(zzato zzatoVar) {
        C5233k c5233k = new C5233k();
        ArrayList arrayList = new ArrayList();
        ...
        c5233k.c(FindAutocompletePredictionsResponse.newInstance(arrayList));
        return c5233k.a();
    }
    ...
    final /* synthetic */ AbstractC5232j zzq(zzaww zzawwVar) {
        C5233k c5233k = new C5233k();
        c5233k.c(FetchPlaceResponse.newInstance(this.zzi.zza(zzawwVar)));
        return c5233k.a();
    }
    ...
    final /* synthetic */ AbstractC5232j zzw(SearchNearbyRequest searchNearbyRequest, zzaxy zzaxyVar) {
        C5233k c5233k = new C5233k();
    ...
    public final AbstractC5232j zza(final SearchByTextRequest searchByTextRequest, final zzmo zzmoVar) {
        List<Place.Field> placeFields = searchByTextRequest.getPlaceFields();
        if (placeFields.isEmpty()) {
            return C5235m.e(new ApiException(new Status(PlacesStatusCodes.INVALID_REQUEST, "Place fields must not be empty.")));
        }
        if (searchByTextRequest.getTextQuery().isEmpty()) {
            return C5235m.e(new ApiException(new Status(PlacesStatusCodes.INVALID_REQUEST, "Text query must not be an empty string.")));
        }
        String includedType = searchByTextRequest.getIncludedType();
        if (includedType != null && includedType.isEmpty()) {
            return C5235m.e(new ApiException(new Status(PlacesStatusCodes.INVALID_REQUEST, "Included type must not be an empty string.")));
        }
        String regionCode = searchByTextRequest.getRegionCode();
        if (regionCode != null && regionCode.isEmpty()) {
            return C5235m.e(new ApiException(new Status(PlacesStatusCodes.INVALID_REQUEST, "Region code must not be an empty string.")));
        }
        final long jZzb = this.zze.zzb();
        ArrayList arrayList = new ArrayList();
        ...
        AbstractC5223a cancellationToken = searchByTextRequest.getCancellationToken();
        if (cancellationToken != null) {
            cancellationToken.b(new InterfaceC5230h() { // from class: com.google.android.libraries.places.internal.zzig
                @Override // Td.InterfaceC5230h
                public final /* synthetic */ void onCanceled() {
                    qVarE.cancel(true);
                }
        ...
        return zzeg.zza(qVarE).s(new InterfaceC5231i() { // from class: com.google.android.libraries.places.internal.zzhu
        ...
        }).k(new InterfaceC5225c() { // from class: com.google.android.libraries.places.internal.zzif
            @Override // Td.InterfaceC5225c
            public final /* synthetic */ Object then(AbstractC5232j abstractC5232j) {
                this.zza.zzl(searchByTextRequest, jZzb, zzmoVar, qVarZzy, abstractC5232j);
                return abstractC5232j;
            }
        });
    }

    public final AbstractC5232j zzb(final FindAutocompletePredictionsRequest findAutocompletePredictionsRequest, final zzmo zzmoVar) {
        String regionCode = findAutocompletePredictionsRequest.getRegionCode();
        if (regionCode != null && regionCode.isEmpty()) {
            return C5235m.e(new ApiException(new Status(PlacesStatusCodes.INVALID_REQUEST, "Region code must not be an empty string.")));
        }
        ...
        if (query == null) {
            return C5235m.e(new ApiException(new Status(PlacesStatusCodes.INVALID_REQUEST, "Query must not be null.")));
        }
        if (TextUtils.isEmpty(query.trim())) {
            return C5235m.f(FindAutocompletePredictionsResponse.newInstance(L.x()));
        }
        final long jZzb = this.zze.zzb();
        final q qVarZzy = zzy();
        ...
        AbstractC5223a cancellationToken = findAutocompletePredictionsRequest.getCancellationToken();
        if (cancellationToken != null) {
            cancellationToken.b(new InterfaceC5230h() { // from class: com.google.android.libraries.places.internal.zzik
                @Override // Td.InterfaceC5230h
                public final /* synthetic */ void onCanceled() {
                    qVarE.cancel(true);
                }
        ...
        return zzeg.zza(qVarE).s(new InterfaceC5231i() { // from class: com.google.android.libraries.places.internal.zzii
            @Override // Td.InterfaceC5231i
            public final /* synthetic */ AbstractC5232j then(Object obj) {
                return this.zza.zzn((zzato) obj);
            }
        }).k(new InterfaceC5225c() { // from class: com.google.android.libraries.places.internal.zzij
            @Override // Td.InterfaceC5225c
            public final /* synthetic */ Object then(AbstractC5232j abstractC5232j) {
                this.zza.zzo(jZzb, zzmoVar, qVarZzy, abstractC5232j);
                return abstractC5232j;
            }
        });
    }

    public final AbstractC5232j zzc(final FetchPlaceRequest fetchPlaceRequest, final zzmo zzmoVar) {
        if (fetchPlaceRequest.getPlaceId().isEmpty()) {
            return C5235m.e(new ApiException(new Status(PlacesStatusCodes.INVALID_REQUEST, "Place id must not be an empty string.")));
        }
        ...
        AbstractC5223a cancellationToken = fetchPlaceRequest.getCancellationToken();
        if (cancellationToken != null) {
            cancellationToken.b(new InterfaceC5230h() { // from class: com.google.android.libraries.places.internal.zzhv
                @Override // Td.InterfaceC5230h
                public final /* synthetic */ void onCanceled() {
                    qVarE.cancel(true);
                }
        ...
        return zzeg.zza(qVarE).s(new InterfaceC5231i() { // from class: com.google.android.libraries.places.internal.zzim
            @Override // Td.InterfaceC5231i
            public final /* synthetic */ AbstractC5232j then(Object obj) {
                return this.zza.zzq((zzaww) obj);
            }
        }).k(new InterfaceC5225c() { // from class: com.google.android.libraries.places.internal.zzin
            @Override // Td.InterfaceC5225c
            public final /* synthetic */ Object then(AbstractC5232j abstractC5232j) {
                this.zza.zzr(jZzb, zzmoVar, qVarZzy, abstractC5232j);
                return abstractC5232j;
            }
        });
    }

    public final AbstractC5232j zze(final LatLng latLng) {
    ...
    public final AbstractC5232j zzf(final SearchNearbyRequest searchNearbyRequest, final zzmo zzmoVar) {
        ...
        AbstractC5223a cancellationToken = searchNearbyRequest.getCancellationToken();
        if (cancellationToken != null) {
            cancellationToken.b(new InterfaceC5230h() { // from class: com.google.android.libraries.places.internal.zzie
                @Override // Td.InterfaceC5230h
                public final /* synthetic */ void onCanceled() {
                    qVarE.cancel(true);
                }
        ...
        return zzeg.zza(qVarE).s(new InterfaceC5231i() { // from class: com.google.android.libraries.places.internal.zzic
            @Override // Td.InterfaceC5231i
            public final /* synthetic */ AbstractC5232j then(Object obj) {
                return this.zza.zzw(searchNearbyRequest, (zzaxy) obj);
            }
        }).k(new InterfaceC5225c() { // from class: com.google.android.libraries.places.internal.zzid
            @Override // Td.InterfaceC5225c
            public final /* synthetic */ Object then(AbstractC5232j abstractC5232j) {
                this.zza.zzx(searchNearbyRequest, jZzb, zzmoVar, qVarZzy, abstractC5232j);
                return abstractC5232j;
            }
        });
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    final /* synthetic */ AbstractC5232j zzl(SearchByTextRequest searchByTextRequest, long j10, zzmo zzmoVar, q qVar, AbstractC5232j abstractC5232j) {
        if (!abstractC5232j.p()) {
            this.zzd.zzf(searchByTextRequest, abstractC5232j, j10, this.zze.zzb(), zzmoVar, (com.google.android.libraries.places.api.auth.zzb) qVar.get());
        }
        return abstractC5232j;
    }

    /* JADX WARN: Multi-variable type inference failed */
    final /* synthetic */ AbstractC5232j zzo(long j10, zzmo zzmoVar, q qVar, AbstractC5232j abstractC5232j) {
        if (!abstractC5232j.p()) {
            this.zzd.zzl(abstractC5232j, j10, this.zze.zzb(), 3, zzmoVar, (com.google.android.libraries.places.api.auth.zzb) qVar.get());
            return abstractC5232j;
        }
        return abstractC5232j;
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    final /* synthetic */ AbstractC5232j zzr(long j10, zzmo zzmoVar, q qVar, AbstractC5232j abstractC5232j) {
        if (!abstractC5232j.p()) {
            this.zzd.zzn(abstractC5232j, j10, this.zze.zzb(), 3, zzmoVar, (com.google.android.libraries.places.api.auth.zzb) qVar.get());
            return abstractC5232j;
        }
        return abstractC5232j;
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    final /* synthetic */ AbstractC5232j zzt(long j10, zzmo zzmoVar, q qVar, AbstractC5232j abstractC5232j) {
        if (!abstractC5232j.p()) {
            this.zzd.zzh(abstractC5232j, j10, this.zze.zzb(), zzmoVar, (com.google.android.libraries.places.api.auth.zzb) qVar.get());
            return abstractC5232j;
        }
        return abstractC5232j;
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    final /* synthetic */ AbstractC5232j zzx(SearchNearbyRequest searchNearbyRequest, long j10, zzmo zzmoVar, q qVar, AbstractC5232j abstractC5232j) {
        if (!abstractC5232j.p()) {
            this.zzd.zzj(searchNearbyRequest, abstractC5232j, j10, this.zze.zzb(), zzmoVar, (com.google.android.libraries.places.api.auth.zzb) qVar.get());
        }
        return abstractC5232j;
    }
}
