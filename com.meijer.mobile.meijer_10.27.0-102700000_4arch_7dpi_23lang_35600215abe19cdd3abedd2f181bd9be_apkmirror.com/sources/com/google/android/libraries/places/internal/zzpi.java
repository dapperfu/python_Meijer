...
public final class zzpi extends RecyclerView.h {
    private final InterfaceC16622O zza;
    ...
    public zzpi(InterfaceC16622O lifecycleScope, Orientation placeDetailsFragmentOrientation, int i10, int i11, boolean z10, boolean z11, List places, zzoy zzoyVar, Function1 onItemClick) {
    ...
    public final void onBindViewHolder(zzph holder, final int i10, List payloads) {
        ...
        InterfaceC16622O interfaceC16622O = this.zza;
        int i11 = this.zzc;
        Orientation orientation = this.zzb;
        final com.google.android.libraries.places.widget.internal.placedetails.zzar zzarVar = new com.google.android.libraries.places.widget.internal.placedetails.zzar(itemView, context, zzoyVar, interfaceC16622O, i11, orientation);
