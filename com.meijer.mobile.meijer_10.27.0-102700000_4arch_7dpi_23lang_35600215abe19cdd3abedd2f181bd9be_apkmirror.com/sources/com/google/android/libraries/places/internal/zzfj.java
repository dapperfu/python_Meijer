...
public final class zzfj implements zzme {
    ...
    static final int zzp(AbstractC5232j abstractC5232j) {
        ApiException apiException;
        if (abstractC5232j.r()) {
            return 2;
        }
        Exception exc = (Exception) p.q(abstractC5232j.m());
    ...
    public final void zza(FindCurrentPlaceRequest findCurrentPlaceRequest, AbstractC5232j abstractC5232j, long j10, long j11, zzmo zzmoVar) {
        int i10 = 1;
        if (true == abstractC5232j.r()) {
            i10 = 2;
        }
    ...
    @Override // com.google.android.libraries.places.internal.zzme
    public final void zzb(AbstractC5232j abstractC5232j, long j10, long j11, zzmo zzmoVar) {
        int size;
        if (abstractC5232j.r()) {
            size = ((FindCurrentPlaceResponse) abstractC5232j.n()).getPlaceLikelihoods().size();
        } else {
            size = 0;
        }
        ...
        zzaikVarZza.zzg(zzp(abstractC5232j));
    ...
    @Override // com.google.android.libraries.places.internal.zzme
    public final void zzd(AbstractC5232j abstractC5232j, long j10, long j11, zzmo zzmoVar) {
        zzaik zzaikVarZza = zzaip.zza();
        zzaikVarZza.zzf(15);
        zzaikVarZza.zzg(zzp(abstractC5232j));
        zzaikVarZza.zza((int) (j11 - j10));
    ...
    @Override // com.google.android.libraries.places.internal.zzme
    public final void zzf(SearchByTextRequest searchByTextRequest, AbstractC5232j abstractC5232j, long j10, long j11, zzmo zzmoVar, com.google.android.libraries.places.api.auth.zzb zzbVar) {
        int size;
        int size2;
        List<RoutingSummary> routingSummaries;
        int iIntValue = 0;
        if (abstractC5232j.r()) {
            size = ((SearchByTextResponse) abstractC5232j.n()).getPlaces().size();
        } else {
            size = 0;
        }
        if (searchByTextRequest.isRoutingSummariesIncluded() && abstractC5232j.r() && (routingSummaries = ((SearchByTextResponse) abstractC5232j.n()).getRoutingSummaries()) != null) {
    ...
    @Override // com.google.android.libraries.places.internal.zzme
    public final void zzh(AbstractC5232j abstractC5232j, long j10, long j11, zzmo zzmoVar, com.google.android.libraries.places.api.auth.zzb zzbVar) {
        zzaik zzaikVarZza = zzaip.zza();
        zzaikVarZza.zzf(15);
        zzaikVarZza.zzg(zzp(abstractC5232j));
        zzaikVarZza.zza((int) (j11 - j10));
    ...
    @Override // com.google.android.libraries.places.internal.zzme
    public final void zzj(SearchNearbyRequest searchNearbyRequest, AbstractC5232j abstractC5232j, long j10, long j11, zzmo zzmoVar, com.google.android.libraries.places.api.auth.zzb zzbVar) {
        int size;
        int size2;
        List<RoutingSummary> routingSummaries;
        int iIntValue = 0;
        if (abstractC5232j.r()) {
            size = ((SearchNearbyResponse) abstractC5232j.n()).getPlaces().size();
        } else {
            size = 0;
        }
        if (searchNearbyRequest.isRoutingSummariesIncluded() && abstractC5232j.r() && (routingSummaries = ((SearchNearbyResponse) abstractC5232j.n()).getRoutingSummaries()) != null) {
            size2 = routingSummaries.size();
        } else {
            size2 = 0;
        }
    ...
    @Override // com.google.android.libraries.places.internal.zzme
    public final void zzl(AbstractC5232j abstractC5232j, long j10, long j11, int i10, zzmo zzmoVar, com.google.android.libraries.places.api.auth.zzb zzbVar) {
        int size;
        if (abstractC5232j.r()) {
            size = ((FindAutocompletePredictionsResponse) abstractC5232j.n()).getAutocompletePredictions().size();
        } else {
            size = 0;
        }
    ...
    @Override // com.google.android.libraries.places.internal.zzme
    public final void zzn(AbstractC5232j abstractC5232j, long j10, long j11, int i10, zzmo zzmoVar, com.google.android.libraries.places.api.auth.zzb zzbVar) {
        boolean zR = abstractC5232j.r();
