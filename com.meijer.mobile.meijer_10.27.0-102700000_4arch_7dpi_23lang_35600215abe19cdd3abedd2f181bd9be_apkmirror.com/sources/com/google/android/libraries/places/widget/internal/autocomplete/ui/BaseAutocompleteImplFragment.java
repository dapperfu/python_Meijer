...
public final class BaseAutocompleteImplFragment extends Fragment {
        ...
        try {
            ...
            switch (iZzg) {
                ...
                case 9:
                    ...
                    if (statusZzf == null || statusZzf.equals(Status.f64739j)) {
                        return;
                    }
    ...
    public final void onViewCreated(@RecentlyNonNull final View view, Bundle bundle) throws Throwable {
        try {
            ...
            this.zzg.zza().i(getViewLifecycleOwner(), new InterfaceC5989E() { // from class: com.google.android.libraries.places.widget.internal.autocomplete.ui.zzaa
