...
public class ClusterRendererMultipleItems<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    private final SparseArray<C4177c> mIcons = new SparseArray<>();
    ...
    class AnimationTask extends AnimatorListenerAdapter implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            this.markerWithPosition.position = this.f89719to;
            this.lock.lock();
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            if (this.f89719to == null || this.from == null || this.marker == null) {
                return;
            }
            float animatedFraction = valueAnimator.getAnimatedFraction();
            LatLng latLng = this.f89719to;
            ...
            LatLng latLng3 = new LatLng(d13, (dSignum * d12) + this.from.f84815b);
    ...
    private class CreateMarkerTask {
        ...
        public void perform(ClusterRendererMultipleItems<T>.MarkerModifier markerModifier) {
            ...
            if (ClusterRendererMultipleItems.this.shouldRenderAsCluster(this.cluster)) {
                ...
                C4188n c4188nAddMarker = ClusterRendererMultipleItems.this.mClusterMarkerCache.get((MarkerCache) this.cluster);
                if (c4188nAddMarker == null) {
                    ...
                    ClusterRendererMultipleItems.this.onBeforeClusterRendered(this.cluster, c4189oU3);
                    c4188nAddMarker = ClusterRendererMultipleItems.this.mClusterManager.getClusterMarkerCollection().addMarker(c4189oU3);
                    ClusterRendererMultipleItems.this.mClusterMarkerCache.put(this.cluster, c4188nAddMarker);
                    markerWithPosition = new MarkerWithPosition(c4188nAddMarker, iVar);
                    ...
                    ClusterRendererMultipleItems.this.onClusterUpdated(this.cluster, c4188nAddMarker);
                }
                ClusterRendererMultipleItems.this.onClusterRendered(this.cluster, c4188nAddMarker);
            ...
            for (T t10 : this.cluster.getItems()) {
                C4188n c4188nAddMarker2 = ClusterRendererMultipleItems.this.mMarkerCache.get((MarkerCache) t10);
                ...
                if (c4188nAddMarker2 == null) {
                    ...
                    ClusterRendererMultipleItems.this.onBeforeClusterItemRendered(t10, c4189o2);
                    c4188nAddMarker2 = ClusterRendererMultipleItems.this.mClusterManager.getMarkerCollection().addMarker(c4189o2);
                    markerWithPosition2 = new MarkerWithPosition(c4188nAddMarker2, t10);
                    ClusterRendererMultipleItems.this.mMarkerCache.put(t10, c4188nAddMarker2);
                    ...
                    markerWithPosition2 = new MarkerWithPosition(c4188nAddMarker2, t10);
                    markerModifier.animate(markerWithPosition2, c4188nAddMarker2.b(), t10.getPosition());
                    RendererLogger.d("ClusterRenderer", "Animating existing marker from " + c4188nAddMarker2.b() + " to " + t10.getPosition());
                    if (!markerWithPosition2.position.equals(t10.getPosition())) {
                        ...
                        ClusterRendererMultipleItems.this.onClusterItemUpdated(t10, c4188nAddMarker2);
                    }
                }
                ClusterRendererMultipleItems.this.onClusterItemRendered(t10, c4188nAddMarker2);
    ...
    private static class MarkerCache<T> {
        private final Map<T, C4188n> mCache;
        private final Map<C4188n, T> mCacheReverse;
    ...
    private class MarkerModifier extends Handler implements MessageQueue.IdleHandler {
        ...
        private final Queue<C4188n> mOnScreenRemoveMarkerTasks;
        private final Queue<C4188n> mRemoveMarkerTasks;
        ...
        private void removeMarker(C4188n c4188n) {
            ClusterRendererMultipleItems.this.mMarkerCache.remove(c4188n);
            ClusterRendererMultipleItems.this.mClusterMarkerCache.remove(c4188n);
            ClusterRendererMultipleItems.this.mClusterManager.getMarkerManager().remove(c4188n);
        }
    ...
    private static class MarkerWithPosition<T> {
        ...
        private MarkerWithPosition(C4188n c4188n, T t10) {
            this.marker = c4188n;
    ...
    class ViewModifier extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            C3952j c3952jK = ClusterRendererMultipleItems.this.mMap.k();
            synchronized (this) {
            ...
            renderTask.setCallback(new Runnable() { // from class: com.google.maps.android.clustering.view.h
                @Override // java.lang.Runnable
                public final void run() {
                    this.f89729a.lambda$handleMessage$0();
                }
            });
            renderTask.setProjection(c3952jK);
            renderTask.setMapZoom(ClusterRendererMultipleItems.this.mMap.j().f84807b);
    ...
    public /* synthetic */ boolean lambda$onAdd$0(C4188n c4188n) {
        RendererLogger.d("ClusterRenderer", "Marker clicked: " + c4188n);
    ...
    public /* synthetic */ void lambda$onAdd$1(C4188n c4188n) {
        RendererLogger.d("ClusterRenderer", "Info window clicked for marker: " + c4188n);
    ...
    public /* synthetic */ void lambda$onAdd$2(C4188n c4188n) {
        RendererLogger.d("ClusterRenderer", "Info window long-clicked for marker: " + c4188n);
    ...
    public /* synthetic */ void lambda$onAdd$4(C4188n c4188n) {
        RendererLogger.d("ClusterRenderer", "Info window clicked for cluster marker: " + c4188n);
    ...
    public /* synthetic */ void lambda$onAdd$5(C4188n c4188n) {
        RendererLogger.d("ClusterRenderer", "Info window long-clicked for cluster marker: " + c4188n);
    ...
    public void onAdd() {
        ...
        this.mClusterManager.getMarkerCollection().setOnMarkerClickListener(new C3945c.p() { // from class: com.google.maps.android.clustering.view.a
            @Override // Kd.C3945c.p
            public final boolean onMarkerClick(C4188n c4188n) {
                return this.f89722a.lambda$onAdd$0(c4188n);
            }
        });
        this.mClusterManager.getMarkerCollection().setOnInfoWindowClickListener(new C3945c.j() { // from class: com.google.maps.android.clustering.view.b
            @Override // Kd.C3945c.j
            public final void onInfoWindowClick(C4188n c4188n) {
                this.f89723a.lambda$onAdd$1(c4188n);
            }
        });
        this.mClusterManager.getMarkerCollection().setOnInfoWindowLongClickListener(new C3945c.l() { // from class: com.google.maps.android.clustering.view.c
            @Override // Kd.C3945c.l
            public final void onInfoWindowLongClick(C4188n c4188n) {
                this.f89724a.lambda$onAdd$2(c4188n);
            }
        });
        RendererLogger.d("ClusterRenderer", "Setting up ClusterMarkerCollection listeners");
        this.mClusterManager.getClusterMarkerCollection().setOnMarkerClickListener(new C3945c.p() { // from class: com.google.maps.android.clustering.view.d
            @Override // Kd.C3945c.p
            public final boolean onMarkerClick(C4188n c4188n) {
                return this.f89725a.lambda$onAdd$3(c4188n);
            }
        });
        this.mClusterManager.getClusterMarkerCollection().setOnInfoWindowClickListener(new C3945c.j() { // from class: com.google.maps.android.clustering.view.e
            @Override // Kd.C3945c.j
            public final void onInfoWindowClick(C4188n c4188n) {
                this.f89726a.lambda$onAdd$4(c4188n);
            }
        });
        this.mClusterManager.getClusterMarkerCollection().setOnInfoWindowLongClickListener(new C3945c.l() { // from class: com.google.maps.android.clustering.view.f
            @Override // Kd.C3945c.l
            public final void onInfoWindowLongClick(C4188n c4188n) {
                this.f89727a.lambda$onAdd$5(c4188n);
            }
        });
    }
    ...
    public ClusterRendererMultipleItems(Context context, C3945c c3945c, ClusterManager<T> clusterManager) {
