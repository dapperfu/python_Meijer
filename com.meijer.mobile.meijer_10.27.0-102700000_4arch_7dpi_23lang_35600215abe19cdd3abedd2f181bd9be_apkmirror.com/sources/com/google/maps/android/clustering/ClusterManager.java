...
public class ClusterManager<T extends ClusterItem> implements C3945c.InterfaceC0283c, C3945c.p, C3945c.j {
    ...
    public ClusterManager(Context context, C3945c c3945c) {
        this(context, c3945c, new MarkerManager(c3945c));
    }
    ...
    public ClusterManager(Context context, C3945c c3945c, MarkerManager markerManager) {
        ...
        this.mRenderer = new DefaultClusterRenderer(context, c3945c, this);
    ...
    public void cluster() {
        ...
        try {
            ...
            clusterTask.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, Float.valueOf(this.mMap.j().f84807b));
        } finally {
    ...
    public void onCameraIdle() {
        ...
        if (clusterRenderer instanceof C3945c.InterfaceC0283c) {
            ((C3945c.InterfaceC0283c) clusterRenderer).onCameraIdle();
        }
        ...
        if (cameraPosition == null || cameraPosition.f84807b != this.mMap.j().f84807b) {
    ...
    public void onInfoWindowClick(C4188n c4188n) {
        getMarkerManager().onInfoWindowClick(c4188n);
    }

    @Override // Kd.C3945c.p
    public boolean onMarkerClick(C4188n c4188n) {
        return getMarkerManager().onMarkerClick(c4188n);
    }
