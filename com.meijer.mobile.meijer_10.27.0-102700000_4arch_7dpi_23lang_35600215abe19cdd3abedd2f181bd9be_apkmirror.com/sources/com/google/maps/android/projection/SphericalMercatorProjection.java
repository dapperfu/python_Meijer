...
public class SphericalMercatorProjection {
    ...
    public LatLng toLatLng(com.google.maps.android.geometry.Point point) {
        ...
        return new LatLng(90.0d - Math.toDegrees(Math.atan(Math.exp(((-(0.5d - (point.f90337y / d11))) * 2.0d) * 3.141592653589793d)) * 2.0d), ((d10 / d11) - 0.5d) * 360.0d);
    }

    public Point toPoint(LatLng latLng) {
        double d10 = (latLng.f84815b / 360.0d) + 0.5d;
        double dSin = Math.sin(Math.toRadians(latLng.f84814a));
