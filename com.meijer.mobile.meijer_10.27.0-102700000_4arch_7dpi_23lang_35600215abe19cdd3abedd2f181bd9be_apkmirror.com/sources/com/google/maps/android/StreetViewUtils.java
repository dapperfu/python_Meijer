...
public final class StreetViewUtils {
    ...
    public static final class Companion {
        ...
        public final Object fetchStreetViewData(LatLng latLng, String str, Source source, Continuation<? super Status> continuation) {
            ...
            sb2.append("?location=" + latLng.f84814a + "," + latLng.f84815b);
            StringBuilder sb3 = new StringBuilder();
            sb3.append("&key=");
            sb3.append(str);
            sb2.append(sb3.toString());
            sb2.append("&source=" + source.getValue());
            return C16644i.g(C16639f0.b(), new StreetViewUtils$Companion$fetchStreetViewData$2(sb2.toString(), null), continuation);
        }
    }
}
