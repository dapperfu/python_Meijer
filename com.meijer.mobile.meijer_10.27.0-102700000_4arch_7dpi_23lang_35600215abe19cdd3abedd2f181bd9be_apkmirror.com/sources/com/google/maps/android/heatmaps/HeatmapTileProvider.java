...
public class HeatmapTileProvider implements H {
    ...
    static {
        int[] iArr = {Color.rgb(102, 225, 0), Color.rgb(l3.f92484c, 0, 0)};
    ...
    static double getMaxValue(Collection<WeightedLatLng> collection, Bounds bounds, int i10, int i11) {
        ...
        for (WeightedLatLng weightedLatLng : collection) {
            double d17 = weightedLatLng.getPoint().f90336x;
            int i12 = (int) ((weightedLatLng.getPoint().f90337y - d12) * d15);
    ...
    public E getTile(int i10, int i11, int i12) {
        ...
        for (T t10 : collectionSearch) {
            ...
            int i14 = (int) ((point.f90336x - d13) / d12);
            int i15 = (int) ((point.f90337y - d15) / d12);
        ...
        for (WeightedLatLng weightedLatLng : arrayList) {
            ...
            int i16 = (int) (((point2.f90336x + d10) - d13) / d12);
            int i17 = (int) ((point2.f90337y - d15) / d12);
    ...
    static Bounds getBounds(Collection<WeightedLatLng> collection) {
        ...
        double d10 = next.getPoint().f90336x;
        double d11 = next.getPoint().f90336x;
        double d12 = d10;
        double d13 = d11;
        double d14 = next.getPoint().f90337y;
        double d15 = next.getPoint().f90337y;
        while (it.hasNext()) {
            WeightedLatLng next2 = it.next();
            double d16 = next2.getPoint().f90336x;
            double d17 = next2.getPoint().f90337y;
            if (d16 < d12) {
                d12 = d16;
            }
            if (d16 > d13) {
