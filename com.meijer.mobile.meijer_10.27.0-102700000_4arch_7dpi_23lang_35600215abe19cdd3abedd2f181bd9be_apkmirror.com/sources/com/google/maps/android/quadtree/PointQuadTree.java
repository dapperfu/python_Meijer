...
public class PointQuadTree<T extends Item> {
    ...
    public boolean remove(T t10) {
        ...
        if (this.mBounds.contains(point.f90336x, point.f90337y)) {
            return remove(point.f90336x, point.f90337y, t10);
        }
        return false;
    }
    ...
    private void split() {
        ...
        this.mItems = null;
        for (T t10 : set) {
            insert(t10.getPoint().f90336x, t10.getPoint().f90337y, t10);
        }
    }
    ...
    public void add(T t10) {
        Point point = t10.getPoint();
        if (this.mBounds.contains(point.f90336x, point.f90337y)) {
            insert(point.f90336x, point.f90337y, t10);
        }
    }
