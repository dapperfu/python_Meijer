...
public class KmlContainer {
    ...
    private final HashMap<KmlGroundOverlay, C4184j> mGroundOverlays;
    ...
    HashMap<KmlGroundOverlay, C4184j> getGroundOverlayHashMap() {
    ...
    KmlContainer(HashMap<String, String> map, HashMap<String, KmlStyle> map2, HashMap<KmlPlacemark, Object> map3, HashMap<String, String> map4, ArrayList<KmlContainer> arrayList, HashMap<KmlGroundOverlay, C4184j> map5, String str) {
