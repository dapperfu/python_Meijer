...
public class KmlRenderer extends Renderer {
    ...
    private void addGroundOverlays(HashMap<KmlGroundOverlay, C4184j> map, Iterable<KmlContainer> iterable) {
    ...
    private void addIconToMarker(String str, KmlStyle kmlStyle, KmlStyle kmlStyle2, C4188n c4188n) {
        boolean z10 = false;
        ...
        if (z11) {
            scaleBitmap(kmlStyle2, c4188n);
        } else if (z10) {
            scaleBitmap(kmlStyle, c4188n);
        }
    }
    ...
    private void addIconToGeometry(String str, KmlStyle kmlStyle, KmlStyle kmlStyle2, Geometry geometry, Object obj) {
        ...
        if ("Point".equals(geometry.getGeometryType())) {
            addIconToMarker(str, kmlStyle, kmlStyle2, (C4188n) obj);
    ...
    KmlRenderer(C3945c c3945c, Context context, MarkerManager markerManager, PolygonManager polygonManager, PolylineManager polylineManager, GroundOverlayManager groundOverlayManager, Renderer.ImagesCache imagesCache) {
        super(c3945c, context, markerManager, polygonManager, polylineManager, groundOverlayManager, imagesCache);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void addGroundOverlayToMap(String str, HashMap<KmlGroundOverlay, C4184j> map, boolean z10) {
        C4177c cachedGroundOverlayImage = getCachedGroundOverlayImage(str);
        for (KmlGroundOverlay kmlGroundOverlay : map.keySet()) {
            if (kmlGroundOverlay.getImageUrl().equals(str)) {
                C4184j c4184jAttachGroundOverlay = attachGroundOverlay(kmlGroundOverlay.getGroundOverlayOptions().d2(cachedGroundOverlayImage));
                if (!z10) {
                    c4184jAttachGroundOverlay.k(false);
                }
                map.put(kmlGroundOverlay, c4184jAttachGroundOverlay);
            }
        }
    }
    ...
    private void scaleBitmap(KmlStyle kmlStyle, C4188n c4188n) {
        c4188n.l(getCachedMarkerImage(kmlStyle.getIconUrl(), kmlStyle.getIconScale()));
    }
    ...
    void storeKmlData(HashMap<String, KmlStyle> map, HashMap<String, String> map2, HashMap<KmlPlacemark, Object> map3, ArrayList<KmlContainer> arrayList, HashMap<KmlGroundOverlay, C4184j> map4) {
        storeData(map, map2, map3, arrayList, map4);
    }

    void storeKmzData(HashMap<String, KmlStyle> map, HashMap<String, String> map2, HashMap<KmlPlacemark, Object> map3, ArrayList<KmlContainer> arrayList, HashMap<KmlGroundOverlay, C4184j> map4, HashMap<String, Bitmap> map5) {
        storeData(map, map2, map3, arrayList, map4);
    ...
    private void addGroundOverlays(HashMap<KmlGroundOverlay, C4184j> map) {
        for (KmlGroundOverlay kmlGroundOverlay : map.keySet()) {
