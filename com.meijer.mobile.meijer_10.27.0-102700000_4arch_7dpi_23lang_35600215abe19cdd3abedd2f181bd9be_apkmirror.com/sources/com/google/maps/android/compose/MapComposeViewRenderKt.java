...
public final class MapComposeViewRenderKt {
    ...
    public static final void renderComposeViewOnce(MapView mapView, AbstractComposeView view, Function1<? super View, Unit> function1, AbstractC5727k parentContext) {
    ...
    public static /* synthetic */ void renderComposeViewOnce$default(MapView mapView, AbstractComposeView abstractComposeView, Function1 function1, AbstractC5727k abstractC5727k, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            function1 = null;
        }
        renderComposeViewOnce(mapView, abstractComposeView, function1, abstractC5727k);
    }

    public static final ComposeUiViewRenderer.RenderHandle startRenderingComposeView(MapView mapView, final AbstractComposeView view, AbstractC5727k parentContext) {
        Intrinsics.j(mapView, "<this>");
        Intrinsics.j(view, "view");
        Intrinsics.j(parentContext, "parentContext");
    ...
    public static final ComposeUiViewRenderer rememberComposeUiViewRenderer(Composer composer, int i10) {
        ...
        boolean zV = composer.V(abstractC5727kD);
        Object objB = composer.B();
        if (zV || objB == Composer.INSTANCE.a()) {
            objB = new MapComposeViewRenderKt$rememberComposeUiViewRenderer$1$1(mapView, abstractC5727kD);
            composer.t(objB);
        }
