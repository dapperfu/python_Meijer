...
public final class StreetViewPanoramaUpdaterKt$StreetViewUpdater$2$3 implements Function2<StreetViewPanoramaPropertiesNode, Boolean, Unit> {
    ...
    public final void invoke(StreetViewPanoramaPropertiesNode set, boolean z10) {
        ...
        set.getPanorama().m(this.$isUserNavigationEnabled);
    }
}
