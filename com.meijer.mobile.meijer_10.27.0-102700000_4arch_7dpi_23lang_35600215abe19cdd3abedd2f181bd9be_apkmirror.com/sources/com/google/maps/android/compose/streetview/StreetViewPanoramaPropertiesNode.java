...
public final class StreetViewPanoramaPropertiesNode implements MapNode {
    ...
    private final C3954l panorama;

    public StreetViewPanoramaPropertiesNode(StreetViewCameraPositionState cameraPositionState, C3954l panorama, StreetViewPanoramaEventListeners eventListeners) {
    ...
    public void onAttached() {
        super.onAttached();
        this.panorama.e(new C3954l.c() { // from class: com.google.maps.android.compose.streetview.m
            @Override // Kd.C3954l.c
            public final void a(com.google.android.gms.maps.model.a aVar) {
                StreetViewPanoramaPropertiesNode.onAttached$lambda$0(this.f90264a, aVar);
            }
        });
        this.panorama.f(new C3954l.d() { // from class: com.google.maps.android.compose.streetview.n
            @Override // Kd.C3954l.d
            public final void a(com.google.android.gms.maps.model.a aVar) {
                StreetViewPanoramaPropertiesNode.onAttached$lambda$1(this.f90265a, aVar);
            }
        });
        this.panorama.c(new C3954l.a() { // from class: com.google.maps.android.compose.streetview.o
            @Override // Kd.C3954l.a
            public final void a(StreetViewPanoramaCamera streetViewPanoramaCamera) {
                StreetViewPanoramaPropertiesNode.onAttached$lambda$2(this.f90266a, streetViewPanoramaCamera);
            }
        });
        this.panorama.d(new C3954l.b() { // from class: com.google.maps.android.compose.streetview.p
            @Override // Kd.C3954l.b
            public final void a(A a10) {
                StreetViewPanoramaPropertiesNode.onAttached$lambda$3(this.f90267a, a10);
            }
        });
    }
}
