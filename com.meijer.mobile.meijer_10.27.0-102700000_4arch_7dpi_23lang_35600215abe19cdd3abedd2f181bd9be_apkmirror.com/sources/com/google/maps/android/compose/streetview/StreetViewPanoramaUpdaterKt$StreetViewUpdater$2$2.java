...
public final class StreetViewPanoramaUpdaterKt$StreetViewUpdater$2$2 implements Function2<StreetViewPanoramaPropertiesNode, Boolean, Unit> {
    ...
    public final void invoke(StreetViewPanoramaPropertiesNode set, boolean z10) {
        ...
        set.getPanorama().l(this.$isStreetNamesEnabled);
    }
}
