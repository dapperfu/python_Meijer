...
public final class MarkerState {
    ...
    private final InterfaceC5730l0 dragState;

    /* renamed from: isDragging$delegate, reason: from kotlin metadata */
    private final InterfaceC5730l0 isDragging;
    private final InterfaceC5730l0<C4188n> markerState;

    /* renamed from: position$delegate, reason: from kotlin metadata */
    private final InterfaceC5730l0 position;
    ...
    public final C4188n getMarker$maps_compose_release() {
    ...
    public final void setMarker$maps_compose_release(C4188n c4188n) {
        if (this.markerState.getValue() == null && c4188n == null) {
            return;
        }
        if (this.markerState.getValue() != null && c4188n != null) {
            throw new IllegalStateException("MarkerState may only be associated with one Marker at a time.");
        }
        this.markerState.setValue(c4188n);
    }
    ...
    public final void hideInfoWindow() {
        C4188n marker$maps_compose_release = getMarker$maps_compose_release();
