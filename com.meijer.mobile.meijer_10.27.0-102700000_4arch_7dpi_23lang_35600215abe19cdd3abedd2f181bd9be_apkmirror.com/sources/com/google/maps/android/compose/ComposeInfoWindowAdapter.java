...
@Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0001\u0018\u00002\u00020\u0001B%\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0014\u0010\u0007\u001a\u0010\u0012\u0004\u0012\u00020\u0005\u0012\u0006\u0012\u0004\u0018\u00010\u00060\u0004¢\u0006\u0004\b\b\u0010\tJ\u0019\u0010\f\u001a\u0004\u0018\u00010\u000b2\u0006\u0010\n\u001a\u00020\u0005H\u0016¢\u0006\u0004\b\f\u0010\rJ\u0019\u0010\u000e\u001a\u0004\u0018\u00010\u000b2\u0006\u0010\n\u001a\u00020\u0005H\u0016¢\u0006\u0004\b\u000e\u0010\rR\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0003\u0010\u000fR\"\u0010\u0007\u001a\u0010\u0012\u0004\u0012\u00020\u0005\u0012\u0006\u0012\u0004\u0018\u00010\u00060\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0007\u0010\u0010¨\u0006\u0011"}, d2 = {"Lcom/google/maps/android/compose/ComposeInfoWindowAdapter;", "LKd/c$b;", "Lcom/google/android/gms/maps/MapView;", "mapView", "Lkotlin/Function1;", "LMd/n;", "Lcom/google/maps/android/compose/MarkerNode;", "markerNodeFinder", "<init>", "(Lcom/google/android/gms/maps/MapView;Lkotlin/jvm/functions/Function1;)V", "marker", "Landroid/view/View;", "getInfoContents", "(LMd/n;)Landroid/view/View;", "getInfoWindow", "Lcom/google/android/gms/maps/MapView;", "Lkotlin/jvm/functions/Function1;", "maps-compose_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
/* loaded from: classes7.dex */
public final class ComposeInfoWindowAdapter implements C3945c.b {
    public static final int $stable = 8;
    private final MapView mapView;
    private final Function1<C4188n, MarkerNode> markerNodeFinder;

    /* JADX WARN: Multi-variable type inference failed */
    public ComposeInfoWindowAdapter(MapView mapView, Function1<? super C4188n, MarkerNode> markerNodeFinder) {
    ...
    public static final Unit getInfoContents$lambda$1$lambda$0(Function3 function3, C4188n c4188n, Composer composer, int i10) {
        if ((i10 & 3) == 2 && composer.j()) {
            ...
            function3.invoke(c4188n, composer, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit getInfoWindow$lambda$3$lambda$2(Function3 function3, C4188n c4188n, Composer composer, int i10) {
        if ((i10 & 3) == 2 && composer.j()) {
            composer.K();
        } else {
            if (ComposerKt.M()) {
    ...
    public View getInfoContents(final C4188n marker) {
        final Function3<C4188n, Composer, Integer, Unit> infoContent;
    ...
    @Override // Kd.C3945c.b
    public View getInfoWindow(final C4188n marker) {
        final Function3<C4188n, Composer, Integer, Unit> infoWindow;
        Intrinsics.j(marker, "marker");
        MarkerNode markerNodeInvoke = this.markerNodeFinder.invoke(marker);
