...
final class MapLifecycleEventObserver implements InterfaceC6027p {
    private AbstractC6023l.b currentLifecycleState;
    ...
    public static final /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            try {
                iArr[AbstractC6023l.a.ON_DESTROY.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[AbstractC6023l.a.ON_CREATE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[AbstractC6023l.a.ON_START.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[AbstractC6023l.a.ON_RESUME.ordinal()] = 4;
            ...
            try {
                iArr[AbstractC6023l.a.ON_STOP.ordinal()] = 6;
    ...
    public MapLifecycleEventObserver(MapView mapView) {
        ...
        this.currentLifecycleState = AbstractC6023l.b.f55276b;
    }

    private final void invokeEvent(AbstractC6023l.a event) {
    ...
    private final void moveDown() {
        AbstractC6023l.a aVarA = AbstractC6023l.a.INSTANCE.a(this.currentLifecycleState);
        if (aVarA != null) {
            invokeEvent(aVarA);
            return;
        }
    ...
    private final void moveToLifecycleState(AbstractC6023l.b targetState) {
        while (true) {
            AbstractC6023l.b bVar = this.currentLifecycleState;
            if (bVar == targetState) {
                return;
            }
    ...
    private final void moveUp() {
        AbstractC6023l.a aVarB = AbstractC6023l.a.INSTANCE.b(this.currentLifecycleState);
        if (aVarB != null) {
            invokeEvent(aVarB);
            return;
        }
    ...
    public final void moveToDestroyedState() {
        if (this.currentLifecycleState.compareTo(AbstractC6023l.b.f55276b) > 0) {
            moveToLifecycleState(AbstractC6023l.b.f55275a);
        }
    }
