...
public final class MapClickListenersKt {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void MapClickListenerUpdater$lambda$26$lambda$25$lambda$24$lambda$23(KMutableProperty0 kMutableProperty0, Md.r it) {
        Intrinsics.j(it, "it");
        Function1 function1 = (Function1) kMutableProperty0.invoke();
        if (function1 != null) {
            function1.invoke(it);
    ...
    public static final void MapClickListenerUpdater(Composer composer, final int i10) {
        ...
        if (i10 == 0 && composerStartRestartGroup.j()) {
            ...
            MapClickListenerComposeNode(mutablePropertyReference0Impl, (Function2) ((KFunction) objB), new C3945c.i() { // from class: com.google.maps.android.compose.MapClickListenersKt$MapClickListenerUpdater$1$2$2
                ...
                @Override // Kd.C3945c.i
                public void onIndoorLevelActivated(C4186l building) {
            ...
            if (zD || objB3 == companion.a()) {
                objB3 = new C3945c.m() { // from class: com.google.maps.android.compose.s0
            ...
            MapClickListenerComposeNode(mutablePropertyReference0Impl2, function2, (C3945c.m) objB3, composerStartRestartGroup, 48);
            composerStartRestartGroup.P();
            ...
            if (zD2 || objB5 == companion.a()) {
                objB5 = new C3945c.o() { // from class: com.google.maps.android.compose.t0
            ...
            MapClickListenerComposeNode(mutablePropertyReference0Impl3, function22, (C3945c.o) objB5, composerStartRestartGroup, 48);
            composerStartRestartGroup.P();
            ...
            if (zD3 || objB7 == companion.a()) {
                objB7 = new C3945c.n() { // from class: com.google.maps.android.compose.u0
            ...
            MapClickListenerComposeNode(mutablePropertyReference0Impl4, function23, (C3945c.n) objB7, composerStartRestartGroup, 48);
            composerStartRestartGroup.P();
            ...
            if (zD4 || objB9 == companion.a()) {
                objB9 = new C3945c.r() { // from class: com.google.maps.android.compose.v0
            ...
            MapClickListenerComposeNode(mutablePropertyReference0Impl5, function24, (C3945c.r) objB9, composerStartRestartGroup, 48);
            composerStartRestartGroup.P();
            ...
            if (zD5 || objB11 == companion.a()) {
                objB11 = new C3945c.s() { // from class: com.google.maps.android.compose.w0
            ...
            MapClickListenerComposeNode(mutablePropertyReference0Impl6, function25, (C3945c.s) objB11, composerStartRestartGroup, 48);
            composerStartRestartGroup.P();
            ...
            if (zD6 || objB13 == companion.a()) {
                objB13 = new C3945c.t() { // from class: com.google.maps.android.compose.x0
            ...
            MapClickListenerComposeNode(mutablePropertyReference0Impl7, function26, (C3945c.t) objB13, composerStartRestartGroup, 48);
            composerStartRestartGroup.P();
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
