...
public class PolyUtil {
    ...
    public static boolean containsLocation(LatLng latLng, List<LatLng> list, boolean z10) {
        return containsLocation(latLng.f84814a, latLng.f84815b, list, z10);
    }
    ...
    public static String encode(List<LatLng> list) {
        ...
        for (LatLng latLng : list) {
            long jRound = Math.round(latLng.f84814a * 100000.0d);
            long jRound2 = Math.round(latLng.f84815b * 100000.0d);
    ...
    public static boolean containsLocation(double d10, double d11, List<LatLng> list, boolean z10) {
        ...
        double radians3 = Math.toRadians(latLng.f84814a);
        double radians4 = Math.toRadians(latLng.f84815b);
        int i10 = 0;
        double d12 = radians3;
        for (LatLng latLng2 : list) {
            ...
            boolean z12 = z11;
            double radians5 = Math.toRadians(latLng2.f84814a);
            double radians6 = Math.toRadians(latLng2.f84815b);
    ...
    public static double distanceToLine(LatLng latLng, LatLng latLng2, LatLng latLng3) {
        ...
        double radians5 = Math.toRadians(latLng3.f84814a);
        double radians6 = Math.toRadians(latLng3.f84815b);
        ...
        double d13 = latLng2.f84814a;
        double d14 = d13 + ((latLng3.f84814a - d13) * d12);
        double d15 = latLng2.f84815b;
        return SphericalUtil.computeDistanceBetween(latLng, new LatLng(d14, d15 + (d12 * (latLng3.f84815b - d15))));
    }
    ...
    public static int locationIndexOnEdgeOrPath(LatLng latLng, List<LatLng> list, boolean z10, boolean z11, double d10) {
        ...
        if (z11) {
            ...
            while (it.hasNext()) {
                ...
                int i15 = i11;
                double d17 = d16;
                double radians7 = Math.toRadians(next.f84814a);
                double dMercator3 = MathUtil.mercator(radians7);
                int i16 = i12;
                Iterator<LatLng> it2 = it;
                double radians8 = Math.toRadians(next.f84815b);
    ...
    public static List<LatLng> simplify(List<LatLng> list, double d10) {
        ...
        if (zIsClosedPolygon) {
            ...
            list.add(new LatLng(latLng.f84814a + 1.0E-11d, latLng.f84815b + 1.0E-11d));
        } else {
            latLng = null;
        }
