...
public class OkHttpPendingResult<T, R extends ApiResponse<T>> implements PendingResult<T>, b {
    private static final c LOG = d.j(OkHttpPendingResult.class.getName());
    ...
    private class QueuedResponse {
        ...
        private final IOException f90392e;
    ...
    private T retry() throws InterruptedException, ApiException, IOException {
        this.retryCounter++;
        LOG.p("Retrying request. Retry #" + this.retryCounter);
    ...
    public T await() throws InterruptedException, IOException, ApiException {
        ...
        this.metrics.endRequest(queuedResponse.f90392e, 0, this.retryCounter);
        throw queuedResponse.f90392e;
    }
