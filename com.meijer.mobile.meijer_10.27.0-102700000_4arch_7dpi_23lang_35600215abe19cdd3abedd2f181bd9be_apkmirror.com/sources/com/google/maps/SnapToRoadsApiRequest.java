...
public class SnapToRoadsApiRequest extends PendingResultBase<SnappedPoint[], SnapToRoadsApiRequest, RoadsApi.RoadsResponse> {
    private static final ApiConfig SNAP_TO_ROADS_API_CONFIG = new ApiConfig("/v1/snapToRoads").hostName("https://roads.googleapis.com").supportsClientId(false).fieldNamingPolicy(com.google.gson.c.f89416a);
