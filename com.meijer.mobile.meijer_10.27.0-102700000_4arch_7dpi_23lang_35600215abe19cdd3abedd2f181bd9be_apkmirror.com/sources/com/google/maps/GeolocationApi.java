...
public class GeolocationApi {
    ...
    static final ApiConfig GEOLOCATION_API_CONFIG = new ApiConfig("/geolocation/v1/geolocate").hostName(API_BASE_URL).supportsClientId(false).fieldNamingPolicy(com.google.gson.c.f89416a).requestVerb("POST");
