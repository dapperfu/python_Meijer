...
class C11346q implements Application.ActivityLifecycleCallbacks {

    /* renamed from: a, reason: collision with root package name */
    private final Queue<String> f88968a = new ArrayDeque(10);
    ...
    public void b(Intent intent) {
        ...
        try {
            ...
            if (extras != null) {
                String strH = H.h(extras);
                if (!TextUtils.isEmpty(strH)) {
                    if (this.f88968a.contains(strH)) {
                        return;
                    } else {
                        this.f88968a.add(strH);
                    }
                }
