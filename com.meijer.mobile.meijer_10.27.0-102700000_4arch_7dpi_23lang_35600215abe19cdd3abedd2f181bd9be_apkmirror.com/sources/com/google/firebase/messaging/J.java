...
public class J {
    ...
    private String w(String str) {
        if (!this.f88808a.containsKey(str) && str.startsWith("gcm.n.")) {
            String strV = v(str);
            if (this.f88808a.containsKey(strV)) {
                return strV;
            }
        }
        return str;
    ...
    public String p(String str) {
        return this.f88808a.getString(w(str));
    }
    ...
    public Bundle x() {
        Bundle bundle = new Bundle(this.f88808a);
        for (String str : this.f88808a.keySet()) {
            if (!s(str)) {
                bundle.remove(str);
            }
        }
    ...
    public J(Bundle bundle) {
        if (bundle != null) {
            this.f88808a = new Bundle(bundle);
            return;
        }
