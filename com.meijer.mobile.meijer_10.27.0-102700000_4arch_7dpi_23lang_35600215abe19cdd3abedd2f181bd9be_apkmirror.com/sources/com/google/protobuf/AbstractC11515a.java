...
import com.google.protobuf.AbstractC11515a.AbstractC1296a;
...
public abstract class AbstractC11515a<MessageType extends AbstractC11515a<MessageType, BuilderType>, BuilderType extends AbstractC1296a<MessageType, BuilderType>> implements P {
    protected int memoizedHashCode = 0;

    /* renamed from: com.google.protobuf.a$a, reason: collision with other inner class name */
    public static abstract class AbstractC1296a<MessageType extends AbstractC11515a<MessageType, BuilderType>, BuilderType extends AbstractC1296a<MessageType, BuilderType>> implements P.a {
        ...
        public BuilderType W0(P p10) {
            if (e().getClass().isInstance(p10)) {
                return (BuilderType) r((AbstractC11515a) p10);
            }
    ...
    protected static <T> void p(Iterable<T> iterable, List<? super T> list) {
        AbstractC1296a.p(iterable, list);
    }

    @Override // com.google.protobuf.P
    public AbstractC11521g g() {
        try {
            AbstractC11521g.h hVarP = AbstractC11521g.p(c());
            l(hVarP.b());
            return hVarP.a();
