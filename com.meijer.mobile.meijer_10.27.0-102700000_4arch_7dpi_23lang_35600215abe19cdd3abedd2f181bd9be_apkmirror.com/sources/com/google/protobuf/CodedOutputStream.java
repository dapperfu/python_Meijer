...
public abstract class CodedOutputStream extends AbstractC11520f {

    /* renamed from: c, reason: collision with root package name */
    private static final Logger f90421c = Logger.getLogger(CodedOutputStream.class.getName());

    /* renamed from: d, reason: collision with root package name */
    private static final boolean f90422d = p0.E();

    /* renamed from: a, reason: collision with root package name */
    C11524j f90423a;

    /* renamed from: b, reason: collision with root package name */
    private boolean f90424b;
    ...
    private static class b extends CodedOutputStream {
        ...
        private final byte[] f90425e;

        /* renamed from: f, reason: collision with root package name */
        private final int f90426f;

        /* renamed from: g, reason: collision with root package name */
        private final int f90427g;
        ...
        final void E0(int i10, P p10, f0 f0Var) throws IOException {
            S0(i10, 2);
            U0(((AbstractC11515a) p10).r(f0Var));
            f0Var.h(p10, this.f90423a);
        }
        ...
        @Override // com.google.protobuf.CodedOutputStream
        public final void H0(int i10, AbstractC11521g abstractC11521g) throws IOException {
            S0(1, 3);
            T0(2, i10);
            k0(3, abstractC11521g);
            S0(1, 4);
        }
        ...
        @Override // com.google.protobuf.CodedOutputStream
        public final void k0(int i10, AbstractC11521g abstractC11521g) throws IOException {
            S0(i10, 2);
            l0(abstractC11521g);
        }
        ...
        public final void R0(String str) throws IOException {
            int i10 = this.f90428h;
            try {
                int iV = CodedOutputStream.V(str.length() * 3);
                int iV2 = CodedOutputStream.V(str.length());
                if (iV2 != iV) {
                    U0(q0.g(str));
                    this.f90428h = q0.f(str, this.f90425e, this.f90428h, e0());
                    return;
                }
                int i11 = i10 + iV2;
                this.f90428h = i11;
                int iF = q0.f(str, this.f90425e, i11, e0());
                this.f90428h = i10;
                U0((iF - i10) - iV2);
                this.f90428h = iF;
            } catch (q0.d e10) {
        ...
        public final void U0(int i10) throws IOException {
            while ((i10 & (-128)) != 0) {
                try {
                    byte[] bArr = this.f90425e;
                    int i11 = this.f90428h;
                    this.f90428h = i11 + 1;
                    bArr[i11] = (byte) ((i10 & l3.f92485d) | 128);
                    i10 >>>= 7;
                } catch (IndexOutOfBoundsException e10) {
                    throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f90428h), Integer.valueOf(this.f90427g), 1), e10);
                }
            }
            byte[] bArr2 = this.f90425e;
            int i12 = this.f90428h;
            this.f90428h = i12 + 1;
            bArr2[i12] = (byte) i10;
        }
        ...
        public final void X0(byte[] bArr, int i10, int i11) throws IOException {
            try {
                System.arraycopy(bArr, i10, this.f90425e, this.f90428h, i11);
                this.f90428h += i11;
            } catch (IndexOutOfBoundsException e10) {
                throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f90428h), Integer.valueOf(this.f90427g), Integer.valueOf(i11)), e10);
            }
        }

        @Override // com.google.protobuf.CodedOutputStream
        public final int e0() {
            return this.f90427g - this.f90428h;
        }
        ...
        public final void W0(long j10) throws IOException {
            if (CodedOutputStream.f90422d && e0() >= 10) {
                while ((j10 & (-128)) != 0) {
                    byte[] bArr = this.f90425e;
                    int i10 = this.f90428h;
                    this.f90428h = i10 + 1;
                    p0.K(bArr, i10, (byte) ((((int) j10) & l3.f92485d) | 128));
                    j10 >>>= 7;
                }
                byte[] bArr2 = this.f90425e;
                int i11 = this.f90428h;
            ...
            byte[] bArr4 = this.f90425e;
            int i13 = this.f90428h;
            this.f90428h = i13 + 1;
            bArr4[i13] = (byte) j10;
        }

        @Override // com.google.protobuf.CodedOutputStream, com.google.protobuf.AbstractC11520f
        ...
        @Override // com.google.protobuf.CodedOutputStream
        public final void l0(AbstractC11521g abstractC11521g) throws IOException {
            U0(abstractC11521g.size());
            abstractC11521g.D(this);
        }
    }
    ...
    public static int I(int i10, AbstractC11521g abstractC11521g) {
        return (T(1) * 2) + U(2, i10) + g(3, abstractC11521g);
    }
    ...
    public abstract void H0(int i10, AbstractC11521g abstractC11521g) throws IOException;
    ...
    @Override // com.google.protobuf.AbstractC11520f
    ...
    public abstract void k0(int i10, AbstractC11521g abstractC11521g) throws IOException;

    public abstract void l0(AbstractC11521g abstractC11521g) throws IOException;
    ...
    static int H(P p10, f0 f0Var) {
        return C(((AbstractC11515a) p10).r(f0Var));
    }
    ...
    static int u(P p10, f0 f0Var) {
        return ((AbstractC11515a) p10).r(f0Var);
    }
    ...
    final void a0(String str, q0.d dVar) throws IOException {
        f90421c.log(Level.WARNING, "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable) dVar);
        byte[] bytes = str.getBytes(C11538y.f90757b);
        try {
            U0(bytes.length);
    ...
    public static int S(String str) {
        ...
        try {
            ...
            length = str.getBytes(C11538y.f90757b).length;
        }
        return C(length);
    }
    ...
    public static int g(int i10, AbstractC11521g abstractC11521g) {
        return T(i10) + h(abstractC11521g);
    }

    public static int h(AbstractC11521g abstractC11521g) {
        return C(abstractC11521g.size());
    }
