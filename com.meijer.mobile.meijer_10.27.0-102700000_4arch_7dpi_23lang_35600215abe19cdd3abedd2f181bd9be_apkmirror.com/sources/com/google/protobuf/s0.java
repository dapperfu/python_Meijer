...
interface s0 {
    ...
    void I(int i10, List<AbstractC11521g> list) throws IOException;

    void J(int i10, List<?> list, f0 f0Var) throws IOException;

    @Deprecated
    void K(int i10, Object obj, f0 f0Var) throws IOException;

    void L(int i10, AbstractC11521g abstractC11521g) throws IOException;

    @Deprecated
    void M(int i10, List<?> list, f0 f0Var) throws IOException;

    void N(int i10, Object obj, f0 f0Var) throws IOException;

    <K, V> void O(int i10, I.a<K, V> aVar, Map<K, V> map) throws IOException;
