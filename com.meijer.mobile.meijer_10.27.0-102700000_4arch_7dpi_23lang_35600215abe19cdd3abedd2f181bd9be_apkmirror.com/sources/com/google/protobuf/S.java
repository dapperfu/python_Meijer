...
final class S {
    ...
    private static final char[] f90455a;
    ...
    static void d(StringBuilder sb2, int i10, String str, Object obj) throws SecurityException {
        ...
        if (obj instanceof AbstractC11521g) {
            sb2.append(": \"");
            sb2.append(k0.a((AbstractC11521g) obj));
            sb2.append('\"');
            return;
        }
        if (obj instanceof AbstractC11536w) {
            sb2.append(" {");
            e((AbstractC11536w) obj, sb2, i10 + 2);
            sb2.append("\n");
            a(i10, sb2);
            sb2.append("}");
            return;
    ...
    */
    private static void e(com.google.protobuf.P r17, java.lang.StringBuilder r18, int r19) throws java.lang.SecurityException {
        /*
