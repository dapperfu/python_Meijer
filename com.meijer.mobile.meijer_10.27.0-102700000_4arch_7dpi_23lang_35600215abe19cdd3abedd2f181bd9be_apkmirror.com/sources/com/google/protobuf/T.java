...
import com.google.protobuf.AbstractC11521g;
...
final class T<T> implements f0<T> {
    ...
    private static final int[] f90456r = new int[0];

    /* renamed from: s, reason: collision with root package name */
    private static final Unsafe f90457s = p0.D();

    /* renamed from: a, reason: collision with root package name */
    private final int[] f90458a;

    /* renamed from: b, reason: collision with root package name */
    private final Object[] f90459b;

    /* renamed from: c, reason: collision with root package name */
    private final int f90460c;

    /* renamed from: d, reason: collision with root package name */
    private final int f90461d;

    /* renamed from: e, reason: collision with root package name */
    private final P f90462e;

    /* renamed from: f, reason: collision with root package name */
    private final boolean f90463f;

    /* renamed from: g, reason: collision with root package name */
    private final boolean f90464g;

    /* renamed from: h, reason: collision with root package name */
    private final a0 f90465h;

    /* renamed from: i, reason: collision with root package name */
    private final boolean f90466i;

    /* renamed from: j, reason: collision with root package name */
    private final int[] f90467j;

    /* renamed from: k, reason: collision with root package name */
    private final int f90468k;

    /* renamed from: l, reason: collision with root package name */
    private final int f90469l;

    /* renamed from: m, reason: collision with root package name */
    private final V f90470m;

    /* renamed from: n, reason: collision with root package name */
    private final F f90471n;

    /* renamed from: o, reason: collision with root package name */
    private final l0<?, ?> f90472o;

    /* renamed from: p, reason: collision with root package name */
    private final AbstractC11529o<?> f90473p;

    /* renamed from: q, reason: collision with root package name */
    private final K f90474q;
    ...
    private boolean B(T t10, int i10, int i11) {
        Map<?, ?> mapE = this.f90474q.e(p0.C(t10, S(i10)));
        if (mapE.isEmpty()) {
            return true;
        }
        if (this.f90474q.b(s(i11)).f90447c.a() != r0.c.MESSAGE) {
            return true;
        }
        ?? C10 = 0;
    ...
    private static boolean C(Object obj) {
        ...
        if (obj instanceof AbstractC11536w) {
            return ((AbstractC11536w) obj).N();
        }
        return true;
    }
    ...
    /*  JADX ERROR: Type inference failed
        ...
        */
    private <UT, UB, ET extends com.google.protobuf.C11532s.b<ET>> void H(com.google.protobuf.l0<UT, UB> r18, com.google.protobuf.AbstractC11529o<ET> r19, T r20, com.google.protobuf.e0 r21, com.google.protobuf.C11528n r22) throws java.io.IOException {
        /*
    ...
    static <T> T<T> O(Class<T> cls, N n10, V v10, F f10, l0<?, ?> l0Var, AbstractC11529o<?> abstractC11529o, K k10) {
        return n10 instanceof d0 ? Q((d0) n10, v10, f10, l0Var, abstractC11529o, k10) : P((j0) n10, v10, f10, l0Var, abstractC11529o, k10);
    }

    private int R(int i10) {
        return this.f90458a[i10];
    }

    private int Y(int i10) {
        if (i10 < this.f90460c || i10 > this.f90461d) {
            return -1;
        }
        return h0(i10, 0);
    }
    ...
    private int Z(int i10) {
        return this.f90458a[i10 + 2];
    }

    private <E> void a0(Object obj, long j10, e0 e0Var, f0<E> f0Var, C11528n c11528n) throws IOException {
        e0Var.J(this.f90471n.e(obj, j10), f0Var, c11528n);
    }

    private int h0(int i10, int i11) {
        int length = (this.f90458a.length / 3) - 1;
        while (i11 <= length) {
    ...
    private void i0(T t10, int i10, Object obj) {
        f90457s.putObject(t10, S(l0(i10)), obj);
        f0(t10, i10);
    }

    private void j0(T t10, int i10, int i11, Object obj) {
        f90457s.putObject(t10, S(l0(i11)), obj);
        g0(t10, i10, i11);
    }

    private int l0(int i10) {
        return this.f90458a[i10 + 1];
    }
    ...
    */
    ...
    private <K, V> void o0(s0 s0Var, int i10, Object obj, int i11) throws IOException {
        if (obj != null) {
            s0Var.O(i10, this.f90474q.b(s(i11)), this.f90474q.e(obj));
        }
    }

    private <K, V, UT, UB> UB p(int i10, int i11, Map<K, V> map, C11538y.e eVar, UB ub2, l0<UT, UB> l0Var, Object obj) {
        I.a<?, ?> aVarB = this.f90474q.b(s(i10));
        ...
        while (it.hasNext()) {
            ...
            if (!eVar.a(((Integer) next.getValue()).intValue())) {
                ...
                AbstractC11521g.h hVarP = AbstractC11521g.p(I.b(aVarB, next.getKey(), next.getValue()));
                try {
    ...
    private void p0(int i10, Object obj, s0 s0Var) throws IOException {
        if (obj instanceof String) {
            ...
            s0Var.L(i10, (AbstractC11521g) obj);
        }
    }

    private C11538y.e r(int i10) {
        return (C11538y.e) this.f90459b[((i10 / 3) * 2) + 1];
    }

    private Object s(int i10) {
        return this.f90459b[(i10 / 3) * 2];
    }

    private f0 t(int i10) {
        int i11 = (i10 / 3) * 2;
        f0 f0Var = (f0) this.f90459b[i11];
        if (f0Var != null) {
            return f0Var;
        }
        f0<T> f0VarC = b0.a().c((Class) this.f90459b[i11 + 1]);
        this.f90459b[i11] = f0VarC;
        return f0VarC;
    }
    ...
    public int b(T t10) {
        int i10;
        int iF;
        int length = this.f90458a.length;
        int i11 = 0;
        for (int i12 = 0; i12 < length; i12 += 3) {
            ...
            switch (k0(iL0)) {
                case 0:
                    i10 = i11 * 53;
                    iF = C11538y.f(Double.doubleToLongBits(p0.x(t10, jS)));
                    i11 = i10 + iF;
                    break;
                case 1:
                    i10 = i11 * 53;
                ...
                case 51:
                    if (E(t10, iR, i12)) {
                        i10 = i11 * 53;
                        iF = C11538y.f(Double.doubleToLongBits(U(t10, jS)));
                        i11 = i10 + iF;
                        break;
                    } else {
                        break;
        ...
        int iHashCode2 = (i11 * 53) + this.f90472o.g(t10).hashCode();
        return this.f90463f ? (iHashCode2 * 53) + this.f90473p.c(t10).hashCode() : iHashCode2;
    }
    ...
    public boolean c(T t10, T t11) {
        ...
        if (!this.f90472o.g(t10).equals(this.f90472o.g(t11))) {
            return false;
        }
        if (this.f90463f) {
            return this.f90473p.c(t10).equals(this.f90473p.c(t11));
        }
        return true;
    }
    ...
    @Override // com.google.protobuf.f0
    public T d() {
        return (T) this.f90470m.a(this.f90462e);
    }
    ...
    public int g(T t10) {
        ...
        T<T> t11 = this;
        T t12 = t10;
        Unsafe unsafe = f90457s;
        int i13 = 1048575;
        int i14 = 0;
        int i15 = 0;
        int i16 = 0;
        int i17 = 1048575;
        while (i14 < t11.f90458a.length) {
            int iL0 = t11.l0(i14);
            int iK0 = k0(iL0);
            int iR = t11.R(i14);
            int i18 = t11.f90458a[i14 + 2];
            int i19 = i18 & i13;
            if (iK0 <= 17) {
                if (i19 != i17) {
            ...
            int i20 = i16;
            long jS = S(iL0);
            if (iK0 < EnumC11533t.f90678O.a() || iK0 > EnumC11533t.f90691b0.a()) {
                i19 = 0;
            }
            switch (iK0) {
                case 0:
                ...
                case 8:
                    if (t11.y(t12, i14, i17, i15, i10)) {
                        ...
                        iX = object instanceof AbstractC11521g ? CodedOutputStream.g(iR, (AbstractC11521g) object) : CodedOutputStream.R(iR, (String) object);
                        i16 = i20 + iX;
                        t11 = this;
                        break;
                    }
                ...
                case 10:
                    if (t11.y(t12, i14, i17, i15, i10)) {
                        iX = CodedOutputStream.g(iR, (AbstractC11521g) unsafe.getObject(t12, jS));
                        i16 = i20 + iX;
                        t11 = this;
                        break;
                    }
                ...
                case 49:
                    ...
                    break;
                case 50:
                    i11 = t11.f90474q.g(iR, unsafe.getObject(t12, jS), t11.s(i14));
                    i16 = i20 + i11;
                    break;
                case 51:
                    if (t11.E(t12, iR, i14)) {
                ...
                case 59:
                    if (t11.E(t12, iR, i14)) {
                        ...
                        i11 = object2 instanceof AbstractC11521g ? CodedOutputStream.g(iR, (AbstractC11521g) object2) : CodedOutputStream.R(iR, (String) object2);
                        i16 = i20 + i11;
                        break;
                    }
                    i16 = i20;
                ...
                case 61:
                    if (t11.E(t12, iR, i14)) {
                        i11 = CodedOutputStream.g(iR, (AbstractC11521g) unsafe.getObject(t12, jS));
                        i16 = i20 + i11;
                        break;
                    }
                    i16 = i20;
        ...
        int iU = i16 + t11.u(t11.f90472o, t12);
        return t11.f90463f ? iU + t11.f90473p.c(t12).l() : iU;
    }

    private T(int[] iArr, Object[] objArr, int i10, int i11, P p10, a0 a0Var, boolean z10, int[] iArr2, int i12, int i13, V v10, F f10, l0<?, ?> l0Var, AbstractC11529o<?> abstractC11529o, K k10) {
        boolean z11;
        this.f90458a = iArr;
        this.f90459b = objArr;
        this.f90460c = i10;
        this.f90461d = i11;
        this.f90464g = p10 instanceof AbstractC11536w;
        this.f90465h = a0Var;
        if (abstractC11529o != null && abstractC11529o.e(p10)) {
            z11 = true;
        } else {
            z11 = false;
        }
    ...
    private final <K, V> void I(Object obj, int i10, Object obj2, C11528n c11528n, e0 e0Var) throws IOException {
        long jS = S(l0(i10));
        Object objC = p0.C(obj, jS);
        if (objC == null) {
            objC = this.f90474q.d(obj2);
            p0.R(obj, jS, objC);
        } else if (this.f90474q.h(objC)) {
            Object objD = this.f90474q.d(obj2);
            this.f90474q.a(objD, objC);
            p0.R(obj, jS, objD);
            objC = objD;
        }
        e0Var.M(this.f90474q.c(objC), this.f90474q.b(obj2), c11528n);
    }
    ...
    private void L(T t10, T t11, int i10) {
        ...
        switch (k0(iL0)) {
            ...
            case 48:
            case 49:
                this.f90471n.d(t10, t11, jS);
                break;
            case 50:
                h0.F(this.f90474q, t10, t11, jS);
                break;
            case 51:
            case 52:
            case 53:
    ...
    private Object M(T t10, int i10) {
        ...
        Object object = f90457s.getObject(t10, jS);
        if (C(object)) {
            return object;
        }
        Object objD = f0VarT.d();
    ...
    private Object N(T t10, int i10, int i11) {
        ...
        Object object = f90457s.getObject(t10, S(l0(i11)));
        if (C(object)) {
            return object;
        }
        Object objD = f0VarT.d();
    ...
    static <T> T<T> P(j0 j0Var, V v10, F f10, l0<?, ?> l0Var, AbstractC11529o<?> abstractC11529o, K k10) {
        r[] rVarArrE = j0Var.e();
        if (rVarArrE.length == 0) {
            ...
            if (rVarArrE.length <= 0) {
                ...
                if (rVarArrE.length <= 0) {
                    ...
                    return new T<>(iArr, objArr, 0, 0, j0Var.b(), j0Var.c(), true, iArr4, iArrD.length, iArrD.length + iArr2.length, v10, f10, l0Var, abstractC11529o, k10);
                }
                r rVar = rVarArrE[0];
                throw null;
            }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    static <T> com.google.protobuf.T<T> Q(com.google.protobuf.d0 r33, com.google.protobuf.V r34, com.google.protobuf.F r35, com.google.protobuf.l0<?, ?> r36, com.google.protobuf.AbstractC11529o<?> r37, com.google.protobuf.K r38) {
        /*
    ...
    private <E> void b0(Object obj, int i10, e0 e0Var, f0<E> f0Var, C11528n c11528n) throws IOException {
        e0Var.K(this.f90471n.e(obj, S(i10)), f0Var, c11528n);
    }

    private void c0(Object obj, int i10, e0 e0Var) throws IOException {
        if (w(i10)) {
            p0.R(obj, S(i10), e0Var.I());
        } else if (this.f90464g) {
    ...
    private void d0(Object obj, int i10, e0 e0Var) throws IOException {
        if (w(i10)) {
            e0Var.n(this.f90471n.e(obj, S(i10)));
        } else {
            e0Var.B(this.f90471n.e(obj, S(i10)));
        }
    }
    ...
    private <UT, UB> UB o(Object obj, int i10, UB ub2, l0<UT, UB> l0Var, Object obj2) {
        ...
        return (UB) p(i10, iR, this.f90474q.c(objC), eVarR, ub2, l0Var, obj2);
    }
            ...
            switch (k0(iL0)) {
                ...
                case 8:
                    ...
                    if (objC instanceof String) {
                        ...
                        break;
                    } else if (objC instanceof AbstractC11521g) {
                        zEquals = AbstractC11521g.f90504b.equals(objC);
                        break;
                    } else {
                ...
                case 9:
                    ...
                    return true;
                case 10:
                    zEquals = AbstractC11521g.f90504b.equals(p0.C(t10, jS));
                    break;
                case 11:
                    if (p0.z(t10, jS) == 0) {
                        return false;
    ...
    public void a(T t10, T t11) {
        l(t10);
        t11.getClass();
        for (int i10 = 0; i10 < this.f90458a.length; i10 += 3) {
            L(t10, t11, i10);
        }
        h0.G(this.f90472o, t10, t11);
        if (this.f90463f) {
            h0.E(this.f90473p, t10, t11);
        }
    }
    ...
    */
    public void e(T r8) {
        /*
            ...
            goto L8e
        L8:
            boolean r0 = r8 instanceof com.google.protobuf.AbstractC11536w
            if (r0 == 0) goto L18
            r0 = r8
            com.google.protobuf.w r0 = (com.google.protobuf.AbstractC11536w) r0
            r0.y()
            r0.x()
            r0.P()
        L18:
        ...
        L39:
            goto L7d
        L3a:
            sun.misc.Unsafe r2 = com.google.protobuf.T.f90457s
            java.lang.Object r5 = r2.getObject(r8, r3)
            if (r5 == 0) goto L7d
            com.google.protobuf.K r6 = r7.f90474q
            java.lang.Object r5 = r6.f(r5)
            r2.putObject(r8, r3, r5)
            goto L7d
        L4c:
            com.google.protobuf.F r2 = r7.f90471n
            r2.c(r8, r3)
            goto L7d
        L52:
            int r2 = r7.R(r1)
            ...
            sun.misc.Unsafe r5 = com.google.protobuf.T.f90457s
        ...
        L7d:
            ...
            goto L1c
        L80:
            com.google.protobuf.l0<?, ?> r0 = r7.f90472o
            r0.j(r8)
            boolean r0 = r7.f90463f
            if (r0 == 0) goto L8e
            com.google.protobuf.o<?> r0 = r7.f90473p
            r0.f(r8)
        L8e:
            return
        */
    ...
    */
    public final boolean f(T r15) {
        ...
        L7:
            ...
            if (r8 == r3) goto L32
            if (r8 == r0) goto L2f
            sun.misc.Unsafe r3 = com.google.protobuf.T.f90457s
            long r6 = (long) r8
        ...
        L9b:
            r7 = r14
            r8 = r15
            boolean r15 = r7.f90463f
            if (r15 == 0) goto Lae
            com.google.protobuf.o<?> r15 = r7.f90473p
    ...
    @Override // com.google.protobuf.f0
    public void i(T t10, e0 e0Var, C11528n c11528n) throws IOException {
        c11528n.getClass();
        l(t10);
        H(this.f90472o, this.f90473p, t10, e0Var, c11528n);
    }
}
