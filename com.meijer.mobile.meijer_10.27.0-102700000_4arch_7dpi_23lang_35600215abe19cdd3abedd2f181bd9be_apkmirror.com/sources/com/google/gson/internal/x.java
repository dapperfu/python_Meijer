...
public final class x {
    ...
    private static final class a implements GenericArrayType, Serializable {
        ...
        public String toString() {
            return x.u(this.f89687a) + "[]";
        }

        public a(Type type) {
            Objects.requireNonNull(type);
            this.f89687a = x.b(type);
        }
    }
    ...
    private static final class b implements ParameterizedType, Serializable {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final Type f89688a;

        /* renamed from: b, reason: collision with root package name */
        private final Type f89689b;

        /* renamed from: c, reason: collision with root package name */
        private final Type[] f89690c;
        ...
        public Type[] getActualTypeArguments() {
            return (Type[]) this.f89690c.clone();
        }
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.f89690c) ^ this.f89689b.hashCode()) ^ a(this.f89688a);
        }

        public String toString() {
            int length = this.f89690c.length;
            if (length == 0) {
                return x.u(this.f89689b);
            }
            StringBuilder sb2 = new StringBuilder((length + 1) * 30);
            sb2.append(x.u(this.f89689b));
            sb2.append("<");
            sb2.append(x.u(this.f89690c[0]));
            for (int i10 = 1; i10 < length; i10++) {
                sb2.append(", ");
                sb2.append(x.u(this.f89690c[i10]));
            }
            sb2.append(">");
            return sb2.toString();
        }
        ...
        public b(Type type, Class<?> cls, Type... typeArr) {
            ...
            this.f89688a = typeB;
            this.f89689b = x.b(cls);
            Type[] typeArr2 = (Type[]) typeArr.clone();
            this.f89690c = typeArr2;
            int length = typeArr2.length;
            for (int i10 = 0; i10 < length; i10++) {
                Objects.requireNonNull(this.f89690c[i10]);
                x.c(this.f89690c[i10]);
                Type[] typeArr3 = this.f89690c;
    ...
    private static final class c implements WildcardType, Serializable {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final Type f89691a;

        /* renamed from: b, reason: collision with root package name */
        private final Type f89692b;
        ...
        public Type[] getLowerBounds() {
            Type type = this.f89692b;
            return type != null ? new Type[]{type} : x.f89686a;
        }

        @Override // java.lang.reflect.WildcardType
        public Type[] getUpperBounds() {
            return new Type[]{this.f89691a};
        }

        public int hashCode() {
            Type type = this.f89692b;
            return (type != null ? type.hashCode() + 31 : 1) ^ (this.f89691a.hashCode() + 31);
        }

        public String toString() {
            if (this.f89692b != null) {
                return "? super " + x.u(this.f89692b);
            }
            if (this.f89691a == Object.class) {
                return "?";
            }
            return "? extends " + x.u(this.f89691a);
        }
        ...
        public c(Type[] typeArr, Type[] typeArr2) {
            ...
            if (typeArr2.length == 1) {
                ...
                this.f89692b = x.b(typeArr2[0]);
                this.f89691a = Object.class;
                return;
            }
            Objects.requireNonNull(typeArr[0]);
            x.c(typeArr[0]);
            this.f89692b = null;
            this.f89691a = x.b(typeArr[0]);
        }
    }
    ...
    */
    ...
    public static WildcardType s(Type type) {
        return new c(type instanceof WildcardType ? ((WildcardType) type).getUpperBounds() : new Type[]{type}, f89686a);
    }
