...
public final class ObjectTypeAdapter extends TypeAdapter<Object> {
    ...
    private static final v f89536c = b(t.f89713a);

    /* renamed from: a, reason: collision with root package name */
    private final Gson f89537a;

    /* renamed from: b, reason: collision with root package name */
    private final u f89538b;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f89540a[JsonToken.BEGIN_OBJECT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f89540a[JsonToken.STRING.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f89540a[JsonToken.NUMBER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f89540a[JsonToken.BOOLEAN.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f89540a[JsonToken.NULL.ordinal()] = 6;
    ...
    public static v a(u uVar) {
        return uVar == t.f89713a ? f89536c : b(uVar);
    }
    ...
    private Object c(JsonReader jsonReader, JsonToken jsonToken) throws IOException {
        int i10 = a.f89540a[jsonToken.ordinal()];
        if (i10 == 3) {
            return jsonReader.nextString();
        }
        if (i10 == 4) {
            return this.f89538b.a(jsonReader);
        }
        if (i10 == 5) {
    ...
    public void write(JsonWriter jsonWriter, Object obj) throws IOException {
        ...
        TypeAdapter typeAdapterR = this.f89537a.r(obj.getClass());
