...
public class DataBinderMapperImpl extends e {
    ...
    private static final SparseIntArray f96160a = new SparseIntArray(0);

    @Override // androidx.databinding.e
    public p c(f fVar, View[] viewArr, int i10) {
        if (viewArr == null || viewArr.length == 0 || f96160a.get(i10) <= 0 || viewArr[0].getTag() != null) {
            return null;
        }
    ...
    public p b(f fVar, View view, int i10) {
        if (f96160a.get(i10) <= 0 || view.getTag() != null) {
            return null;
        }
        throw new RuntimeException("view must have a tag");
    }
