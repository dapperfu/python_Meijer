...
public final class UniversalLinkBypassActivity extends Hilt_UniversalLinkBypassActivity {
    ...
    static final class a implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ UniversalLinkBypassActivity f100982b;
        ...
        static final class C1408a implements Function3<LocalThemeScope, Composer, Integer, Unit> {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ String f100983a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ UniversalLinkBypassActivity f100984b;

            C1408a(String str, UniversalLinkBypassActivity universalLinkBypassActivity) {
                this.f100983a = str;
                this.f100984b = universalLinkBypassActivity;
            }
            ...
            public final void b(LocalThemeScope AdsTheme, Composer composer, int i10) {
                ...
                final String str = this.f100983a;
                final UniversalLinkBypassActivity universalLinkBypassActivity = this.f100984b;
                ...
                if (zV || objB == Composer.INSTANCE.a()) {
                    objB = new Function1() { // from class: com.meijer.mobile.meijer.activity.u
                        ...
                        public final Object invoke(Object obj) {
                            return UniversalLinkBypassActivity.a.C1408a.c(str, universalLinkBypassActivity, (Context) obj);
                        }
                    };
                    composer.t(objB);
                }
        ...
        a(String str, UniversalLinkBypassActivity universalLinkBypassActivity) {
            this.f100981a = str;
            this.f100982b = universalLinkBypassActivity;
        }
        ...
        public final void a(Composer composer, int i10) {
            ...
            K.b(null, ComposableLambdaKt.c(1408918268, true, new C1408a(this.f100981a, this.f100982b), composer, 54), composer, 48, 1);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (stringExtra != null) {
            C13589e.b(this, null, ComposableLambdaKt.composableLambdaInstance(-1317637973, true, new a(stringExtra, this)), 1, null);
        } else {
