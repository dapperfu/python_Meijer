...
import b5.C6197c;
import com.meijer.mobile.meijer.activity.checkout.confirmation.C11799u;
...
public final class C11799u {
    ...
    static final class a implements Function1<C4039g, Unit> {
        ...
        public static final a f102284a = new a();
    ...
    static final class b implements Function1<C4039g, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final b f102285a = new b();
    ...
    static final class c implements Function3<j1, Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f102286a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Context f102287b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ OrderConfirmationDecorator f102288c;
        ...
        static final class a implements Function3<InterfaceC14800I, Composer, Integer, Unit> {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ LocalThemeScope f102289a;

            a(LocalThemeScope localThemeScope) {
                this.f102289a = localThemeScope;
            }
            ...
            public final void a(InterfaceC14800I AdsButton, Composer composer, int i10) {
                ...
                LocalThemeScope localThemeScope = this.f102289a;
                q1.Label label = new q1.Label(null, this.f102289a.getAdsColors().getAdsColorEnabled01(), null, null, 0, false, 0, localThemeScope.getAdsTypography().getHeadings().getSeven(), null, 381, null);
        ...
        c(LocalThemeScope localThemeScope, Context context, OrderConfirmationDecorator orderConfirmationDecorator) {
            this.f102286a = localThemeScope;
            this.f102287b = context;
            this.f102288c = orderConfirmationDecorator;
        }
        ...
        public static final Unit c(Context context, OrderConfirmationDecorator orderConfirmationDecorator) {
            ...
            context.startActivity(Al.l.b(lVar, context, orderNumber, null, null, 12, null));
            return Unit.f142422a;
        }
        ...
        public final void b(j1 Assemble, Composer composer, int i10) {
            ...
            LocalThemeScope localThemeScope = this.f102286a;
            q1.d.StandardButton enabledButton = Assemble.getButtons().getEnabledButton();
            composer.startReplaceGroup(-1633490746);
            boolean zD = composer.D(this.f102287b) | composer.D(this.f102288c);
            final Context context = this.f102287b;
            final OrderConfirmationDecorator orderConfirmationDecorator = this.f102288c;
            Object objB = composer.B();
            if (zD || objB == Composer.INSTANCE.a()) {
                objB = new Function0() { // from class: com.meijer.mobile.meijer.activity.checkout.confirmation.v
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        return C11799u.c.c(context, orderConfirmationDecorator);
                    }
                };
                composer.t(objB);
            }
            composer.P();
            E0.b(localThemeScope, enabledButton, (Function0) objB, ComposableLambdaKt.c(1605477520, true, new a(this.f102286a), composer, 54), composer, LocalThemeScope.f15770g | 3072 | (q1.d.StandardButton.f139974k << 3));
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final class d extends Lambda implements Function1<r1.u, Unit> {
        ...
        public final void a(r1.u semantics) {
            ...
            L1.C.a(semantics, this.f102290f);
        }
    ...
    public static final class e extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ int f102291f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ L1.n f102292g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Function0 f102293h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ CartItemsDecorator f102294i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f102295j;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public e(L1.n nVar, int i10, Function0 function0, CartItemsDecorator cartItemsDecorator, LocalThemeScope localThemeScope) {
            super(2);
            this.f102292g = nVar;
            this.f102293h = function0;
            this.f102294i = cartItemsDecorator;
            this.f102295j = localThemeScope;
            this.f102291f = i10;
        }
        ...
        public final void a(Composer composer, int i10) {
            ...
            int helpersHashCode = this.f102292g.getHelpersHashCode();
            this.f102292g.i();
            L1.n nVar = this.f102292g;
            ...
            int i11 = 0;
            MeasurePolicy measurePolicyB = androidx.compose.foundation.layout.G.b(C5658d.f48555a.g(), P0.e.INSTANCE.l(), composer2, 0);
            ...
            for (EntryDecorator entryDecorator : CollectionsKt.b1(this.f102294i.d(), this.f102294i.c().size())) {
                C15372h c15372hC = new C15372h.a((Context) composer2.o(AndroidCompositionLocals_androidKt.g())).f(entryDecorator.getImageUrl()).c();
                ...
                Z0.c cVarC = C16190d.c(Bj.i.f2681O1, composer2, i11);
                Z0.c cVarC2 = C16190d.c(Bj.i.f2681O1, composer2, i11);
                Modifier.Companion companion3 = Modifier.INSTANCE;
                C6197c.d(c15372hC, name, hVarA2, androidx.compose.foundation.layout.J.v(companion3, H1.h.p(75)), null, cVarC2, cVarC, null, null, null, null, interfaceC5784kB, 0.0f, null, 0, false, null, composer, 3072, 48, 128912);
                composer2 = composer;
                C14802K.a(androidx.compose.foundation.layout.J.z(companion3, H1.h.p(6)), composer2, 6);
                i11 = i11;
            ...
            composer2.P();
            composer2.v();
            String extraItemCount = this.f102294i.getExtraItemCount();
            composer2.startReplaceGroup(-1914391784);
            if (extraItemCount != null) {
                LocalThemeScope localThemeScope = this.f102295j;
                ...
                composer2.P();
                ri.j.h(localThemeScope, new q1.Label(nVar2.k(companion4, hVar, (Function1) objB2), null, null, null, 0, false, 0, one, null, 382, null), extraItemCount, null, composer2, (q1.Label.f140080j << 3) | LocalThemeScope.f15770g, 4);
            }
            composer.P();
            composer.P();
            if (this.f102292g.getHelpersHashCode() != i12) {
                this.f102293h.invoke();
            }
        }
    ...
    public static final void e(LocalThemeScope localThemeScope, final OrderConfirmationDecorator orderConfirmationDecorator, Composer composer, final int i10) {
        ...
        if ((i11 & 19) == 18 && composerStartRestartGroup.j()) {
            ...
            if (numValueOf == null) {
                ...
                f10 = f12;
                i12 = 1;
                C13457y.a(C16190d.c(numValueOf.intValue(), composerStartRestartGroup, 0), null, null, null, null, 0.0f, null, composerStartRestartGroup, 48, 124);
                composerStartRestartGroup = composerStartRestartGroup;
                Unit unit = Unit.f142422a;
            }
            composerStartRestartGroup.P();
            C14802K.a(androidx.compose.foundation.layout.J.z(companion2, H1.h.p(f10)), composerStartRestartGroup, 6);
            Modifier modifierB = InterfaceC14800I.b(c14801j, companion2, 1.0f, false, 2, null);
            MeasurePolicy measurePolicyA = C5665k.a(c5658d.h(), companion3.k(), composerStartRestartGroup, 0);
            ...
            Ji.I iF = localThemeScope2.getAdsTypography().getBodyCompact().getTwo().f(FontWeight.INSTANCE.f());
            ...
            if (objB == companion5.a()) {
                objB = new Function1() { // from class: com.meijer.mobile.meijer.activity.checkout.confirmation.q
                    ...
                    public final Object invoke(Object obj) {
                        return C11799u.g((r1.u) obj);
                    }
                };
                composerStartRestartGroup.t(objB);
            }
            composerStartRestartGroup.P();
            q1.Label label = new q1.Label(C16705m.d(companion2, false, (Function1) objB, i12, null), null, null, null, 0, false, 0, iF, null, 382, null);
            String strC = C16193g.c(com.meijer.mobile.meijer.Y.f99692M9, composerStartRestartGroup, 0);
            int i17 = LocalThemeScope.f15770g;
            int i18 = i11 & 14;
            int i19 = i11;
            Composer composer2 = composerStartRestartGroup;
            float f13 = f10;
            ri.j.h(localThemeScope2, label, strC, null, composer2, i17 | i18 | (q1.Label.f140080j << 3), 4);
            final AbstractC5607a abstractC5607aG = orderConfirmationDecorator != null ? orderConfirmationDecorator.g() : null;
            composer2.startReplaceGroup(-144753782);
            if (abstractC5607aG == null) {
                i15 = 4;
                i14 = i17;
                context = context2;
                i13 = i18;
                ...
                boolean zD = composer2.D(abstractC5607aG) | (i18 == 4 || ((i19 & 8) != 0 && composer2.D(localThemeScope2)));
                Object objB2 = composer2.B();
                if (zD || objB2 == companion5.a()) {
                    objB2 = new Function1() { // from class: com.meijer.mobile.meijer.activity.checkout.confirmation.r
                        @Override // kotlin.jvm.functions.Function1
                        public final Object invoke(Object obj) {
                            return C11799u.h(abstractC5607aG, localThemeScope2, (Context) obj);
                        }
                    };
                    composer2.t(objB2);
                }
            ...
            composerStartRestartGroup.P();
            final AbstractC5607a abstractC5607aF = orderConfirmationDecorator != null ? orderConfirmationDecorator.f() : r42;
            composerStartRestartGroup.startReplaceGroup(-144737566);
            if (abstractC5607aF == null) {
                z10 = true;
                f11 = 0.0f;
            } else {
                composerStartRestartGroup.startReplaceGroup(-1633490746);
                boolean zD2 = composerStartRestartGroup.D(abstractC5607aF) | (i13 == i15 || ((i19 & 8) != 0 && composerStartRestartGroup.D(localThemeScope2)));
                ...
                if (zD2 || objB3 == companion5.a()) {
                    objB3 = new Function1() { // from class: com.meijer.mobile.meijer.activity.checkout.confirmation.s
                        @Override // kotlin.jvm.functions.Function1
                        public final Object invoke(Object obj) {
                            return C11799u.f(abstractC5607aF, localThemeScope2, (Context) obj);
                        }
                    };
            ...
            if (cartItems == null) {
                ...
                Pair<MeasurePolicy, Function0<Unit>> pairH = L1.l.h(257, nVar, (InterfaceC5730l0) objB6, a10, composer3, 4544);
                composerStartRestartGroup = composer3;
                MeasurePolicy measurePolicyA2 = pairH.a();
                Function0<Unit> function0B = pairH.b();
                Modifier modifierD = C16705m.d(modifierH, false, new d(a10), z10 ? 1 : 0, r42);
                boolean z11 = z10 ? 1 : 0;
                i16 = i13;
                ...
                if (error == null) {
                    ...
                    companion = companion2;
                    N1.b(C16193g.c(error.intValue(), composerStartRestartGroup, 0), androidx.compose.foundation.b.d(androidx.compose.foundation.layout.J.h(androidx.compose.foundation.layout.D.i(companion2, H1.h.p(f13)), 0.0f, z10 ? 1 : 0, null), localThemeScope2.getAdsColors().getAdsColorSupportError().getColor(), null, 2, null), 0L, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, null, composerStartRestartGroup, 0, 0, 131068);
                    composerStartRestartGroup = composerStartRestartGroup;
            ...
            C14802K.a(androidx.compose.foundation.layout.J.z(companion, H1.h.p(f13)), composerStartRestartGroup, 6);
            Ji.Q.e(localThemeScope2, C14898A.f139596a, ComposableLambdaKt.c(1471719267, z10, new c(localThemeScope2, context, orderConfirmationDecorator), composerStartRestartGroup, 54), composerStartRestartGroup, i14 | 384 | i16 | (C14898A.f139597b << 3));
            composerStartRestartGroup.v();
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        ...
        if (t0L != null) {
            t0L.a(new Function2() { // from class: com.meijer.mobile.meijer.activity.checkout.confirmation.t
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return C11799u.i(localThemeScope2, orderConfirmationDecorator, i10, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final TextView f(AbstractC5607a abstractC5607a, LocalThemeScope localThemeScope, Context context) {
        Intrinsics.j(context, "context");
        TextView textView = new TextView(context);
        bk.d.f(textView, abstractC5607a);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final TextView h(AbstractC5607a abstractC5607a, LocalThemeScope localThemeScope, Context context) {
        Intrinsics.j(context, "context");
        TextView textView = new TextView(context);
        bk.d.f(textView, abstractC5607a);
        textView.setTextSize(H1.v.h(localThemeScope.getAdsTypography().getBodyCompact().getTwo().getStyle().l()));
