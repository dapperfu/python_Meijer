...
public final class j extends androidx.recyclerview.widget.q<l.b.OutOfStockItemState, b> {
    ...
    @Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0007\b\u0007\u0018\u00002\u00020\u0001B\u0017\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0006\u0010\u0007J\u0015\u0010\u000b\u001a\u00020\n2\u0006\u0010\t\u001a\u00020\b¢\u0006\u0004\b\u000b\u0010\fR\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\r\u0010\u000eR\u0014\u0010\u0005\u001a\u00020\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u000f\u0010\u0010¨\u0006\u0011"}, d2 = {"Lcom/meijer/mobile/meijer/activity/checkout/outofstock/j$b;", "Landroidx/recyclerview/widget/RecyclerView$F;", "LMn/n3;", "binding", "Lcom/meijer/mobile/meijer/activity/checkout/outofstock/o;", "outOfStockViewModel", "<init>", "(LMn/n3;Lcom/meijer/mobile/meijer/activity/checkout/outofstock/o;)V", "Lcom/meijer/mobile/meijer/activity/checkout/outofstock/l$b$b;", "item", "", "c", "(Lcom/meijer/mobile/meijer/activity/checkout/outofstock/l$b$b;)V", "a", "LMn/n3;", "b", "Lcom/meijer/mobile/meijer/activity/checkout/outofstock/o;", "Meijer_playstoreRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class b extends RecyclerView.F {
        ...
        public final void c(final l.b.OutOfStockItemState item) {
            ...
            this.binding.f20817C.setOnClickListener(new View.OnClickListener() { // from class: com.meijer.mobile.meijer.activity.checkout.outofstock.k
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    j.b.d(this.f103496a, item, view);
                }
            });
            n3 n3Var = this.binding;
            TextView textView = n3Var.f20819E;
            textView.setText(n3Var.getRoot().getResources().getString(C17135b.f162032l0, item.getOldQuantity()));
            ViewGroup.LayoutParams layoutParams = textView.getLayoutParams();
            Intrinsics.h(layoutParams, "null cannot be cast to non-null type androidx.constraintlayout.widget.ConstraintLayout.LayoutParams");
            ConstraintLayout.b bVar = (ConstraintLayout.b) layoutParams;
            ((ViewGroup.MarginLayoutParams) bVar).bottomMargin = 8;
            textView.setLayoutParams(bVar);
            ImageView productImage = this.binding.f20820F;
            Intrinsics.i(productImage, "productImage");
            C13530b.f(productImage, item.getImageUrl(), null, null, 6, null);
            this.binding.f20821G.setText(item.getName());
            this.binding.f20818D.setText(item.getFullDetails().getPrice().getFormattedValue());
        }
    }
    ...
    public b onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        n3 n3VarK0 = n3.K0(LayoutInflater.from(parent.getContext()), parent, false);
        Intrinsics.g(n3VarK0);
        return new b(n3VarK0, this.outOfStockViewModel);
    }
}
