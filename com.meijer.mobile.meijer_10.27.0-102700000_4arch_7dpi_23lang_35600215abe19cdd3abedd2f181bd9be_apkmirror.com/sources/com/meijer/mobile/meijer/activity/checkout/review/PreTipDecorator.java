...
public final /* data */ class PreTipDecorator {
    ...
    public PreTipDecorator() {
        this(null, 0.0d, null, null, 0.0d, null, false, l3.f92485d, null);
    }
    ...
    public PreTipDecorator(W1 preTipStatus, double d10, EnumC18092b selectedTipOption, List<TipSuggestionButtonDecorator> preTipButtonDecorators, double d11, ConfirmedTipInfo confirmedTipInfo, boolean z10) {
    ...
    public static /* synthetic */ PreTipDecorator b(PreTipDecorator preTipDecorator, W1 w12, double d10, EnumC18092b enumC18092b, List list, double d11, ConfirmedTipInfo confirmedTipInfo, boolean z10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        if ((i10 & 4) != 0) {
            enumC18092b = preTipDecorator.selectedTipOption;
        }
        if ((i10 & 8) != 0) {
        ...
        double d12 = d11;
        EnumC18092b enumC18092b2 = enumC18092b;
        return preTipDecorator.a(w12, d10, enumC18092b2, list, d12, confirmedTipInfo, z10);
    }

    public final PreTipDecorator a(W1 preTipStatus, double orderTotalPrice, EnumC18092b selectedTipOption, List<TipSuggestionButtonDecorator> preTipButtonDecorators, double customTipAmount, ConfirmedTipInfo confirmedTipInfo, boolean isSpc) {
        Intrinsics.j(preTipStatus, "preTipStatus");
        Intrinsics.j(selectedTipOption, "selectedTipOption");
        Intrinsics.j(preTipButtonDecorators, "preTipButtonDecorators");
        Intrinsics.j(confirmedTipInfo, "confirmedTipInfo");
    ...
    public final boolean i() {
        if (this.selectedTipOption != EnumC18092b.f169908l) {
            return false;
        }
    ...
    public final boolean j() {
        return this.selectedTipOption == EnumC18092b.f169908l && this.customTipAmount < 1.0d;
    }

    public final boolean k() {
        return this.selectedTipOption == EnumC18092b.f169908l && this.customTipAmount >= 1000.0d;
    }
    ...
    public final double m() {
        ...
        if (tipSuggestionButtonDecorator != null) {
            EnumC18092b tipOption = tipSuggestionButtonDecorator.getTipOption();
            return tipOption.getHasFormatArgs() ? tipOption.getValue() * this.orderTotalPrice : tipOption.getValue() == EnumC18092b.f169908l.getValue() ? this.customTipAmount : tipOption.getValue();
        }
        if (this.selectedTipOption == EnumC18092b.f169908l && this.isSpc) {
            return this.customTipAmount;
        }
        return 0.0d;
    }
    ...
    public /* synthetic */ PreTipDecorator(W1 w12, double d10, EnumC18092b enumC18092b, List list, double d11, ConfirmedTipInfo confirmedTipInfo, boolean z10, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this((i10 & 1) != 0 ? W1.f104662a : w12, (i10 & 2) != 0 ? 0.0d : d10, (i10 & 4) != 0 ? EnumC18092b.f169911o : enumC18092b, (i10 & 8) != 0 ? CollectionsKt.m() : list, (i10 & 16) == 0 ? d11 : 0.0d, (i10 & 32) != 0 ? new ConfirmedTipInfo(0.0d, null, 3, null) : confirmedTipInfo, (i10 & 64) != 0 ? false : z10);
    }
}
