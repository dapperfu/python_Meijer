...
public final class OrderConfirmationActivity extends Hilt_OrderConfirmationActivity {
    ...
    public static final int f102066y = 8;
    ...
    private final Lazy orderId = LazyKt.b(new Function0() { // from class: com.meijer.mobile.meijer.activity.checkout.confirmation.f
        ...
        public final Object invoke() {
            return OrderConfirmationActivity.W1(this.f102165a);
        }
    });
    ...
    private final Lazy information = LazyKt.b(new Function0() { // from class: com.meijer.mobile.meijer.activity.checkout.confirmation.g
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            return OrderConfirmationActivity.R1(this.f102167a);
        }
    });
    ...
    private final Lazy isBopasEligibleCart = LazyKt.b(new Function0() { // from class: com.meijer.mobile.meijer.activity.checkout.confirmation.h
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            return Boolean.valueOf(OrderConfirmationActivity.T1(this.f102170a));
        }
    });
    ...
    private final Lazy sendPreTipAnalytics = LazyKt.b(new Function0() { // from class: com.meijer.mobile.meijer.activity.checkout.confirmation.i
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            return Boolean.valueOf(OrderConfirmationActivity.X1(this.f102174a));
        }
    });
    ...
    static final class b implements Function2<Composer, Integer, Unit> {
        ...
        public static final Unit k(OrderConfirmationActivity orderConfirmationActivity, String orderNumber) {
            ...
            orderConfirmationActivity.startActivity(Al.l.b(Al.l.f673a, orderConfirmationActivity, orderNumber, null, null, 12, null));
            return Unit.f142422a;
        }
        ...
        public final void d(Composer composer, int i10) {
            ...
            composer.P();
            androidx.compose.runtime.z1 z1VarC = S2.a.c((tv.P) objB, null, null, null, composer, 0, 7);
    ...
    public static final class c extends Lambda implements Function0<f0.c> {
        ...
        final /* synthetic */ ComponentActivity f102073f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public c(ComponentActivity componentActivity) {
            super(0);
            this.f102073f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final f0.c invoke() {
            return this.f102073f.getDefaultViewModelProviderFactory();
        }
    }
    ...
    public static final class d extends Lambda implements Function0<androidx.view.g0> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f102074f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(ComponentActivity componentActivity) {
            super(0);
            this.f102074f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final androidx.view.g0 invoke() {
            return this.f102074f.getCom.google.android.libraries.places.api.model.PlaceTypes.STORE java.lang.String();
        }
    }
    ...
    public static final class e extends Lambda implements Function0<CreationExtras> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function0 f102075f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f102076g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public e(Function0 function0, ComponentActivity componentActivity) {
            super(0);
            this.f102075f = function0;
            this.f102076g = componentActivity;
        }
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f102075f;
            return (function0 == null || (creationExtras = (CreationExtras) function0.invoke()) == null) ? this.f102076g.getDefaultViewModelCreationExtras() : creationExtras;
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Q1().w(Y.a.b.f102101a);
        C13589e.b(this, null, ComposableLambdaKt.composableLambdaInstance(-1716638943, true, new b()), 1, null);
        androidx.view.I.b(getOnBackPressedDispatcher(), null, false, new Function1() { // from class: com.meijer.mobile.meijer.activity.checkout.confirmation.j
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return OrderConfirmationActivity.V1(this.f102175a, (androidx.view.F) obj);
            }
        }, 3, null);
    }
