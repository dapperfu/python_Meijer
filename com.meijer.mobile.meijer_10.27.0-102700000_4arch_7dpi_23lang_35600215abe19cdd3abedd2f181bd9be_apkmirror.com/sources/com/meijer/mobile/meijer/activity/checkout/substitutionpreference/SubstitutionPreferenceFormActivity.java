...
public final class SubstitutionPreferenceFormActivity extends Hilt_SubstitutionPreferenceFormActivity {
    ...
    public static final int f105223v = 8;
    ...
    static final class c implements Function2<Composer, Integer, Unit> {
        ...
        static final class a implements Function3<LocalThemeScope, Composer, Integer, Unit> {
            ...
            final /* synthetic */ SubstitutionPreferenceFormActivity f105230a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ z1<v.ViewState> f105231b;
            ...
            static final class C1532a implements Function2<Composer, Integer, Unit> {

                /* renamed from: a, reason: collision with root package name */
                final /* synthetic */ LocalThemeScope f105232a;

                /* renamed from: b, reason: collision with root package name */
                final /* synthetic */ SubstitutionPreferenceFormActivity f105233b;

                C1532a(LocalThemeScope localThemeScope, SubstitutionPreferenceFormActivity substitutionPreferenceFormActivity) {
                    this.f105232a = localThemeScope;
                    this.f105233b = substitutionPreferenceFormActivity;
                }
                ...
                public final void b(Composer composer, int i10) {
                    ...
                    LocalThemeScope localThemeScope = this.f105232a;
                    Modifier modifierH = J.h(Modifier.INSTANCE, 0.0f, 1, null);
                    String strC = C16193g.c(Y.f100224ng, composer, 0);
                    composer.startReplaceGroup(5004770);
                    boolean zD = composer.D(this.f105233b);
                    final SubstitutionPreferenceFormActivity substitutionPreferenceFormActivity = this.f105233b;
                    Object objB = composer.B();
                    if (zD || objB == Composer.INSTANCE.a()) {
                        objB = new Function0() { // from class: com.meijer.mobile.meijer.activity.checkout.substitutionpreference.a
                            @Override // kotlin.jvm.functions.Function0
                            public final Object invoke() {
                                return SubstitutionPreferenceFormActivity.c.a.C1532a.c(substitutionPreferenceFormActivity);
                            }
                        };
                        composer.t(objB);
                    }
            ...
            static final class b implements Function2<Composer, Integer, Unit> {
                ...
                /* renamed from: a, reason: collision with root package name */
                final /* synthetic */ LocalThemeScope f105234a;

                /* renamed from: b, reason: collision with root package name */
                final /* synthetic */ SubstitutionPreferenceFormActivity f105235b;

                /* renamed from: c, reason: collision with root package name */
                final /* synthetic */ z1<v.ViewState> f105236c;
                ...
                b(LocalThemeScope localThemeScope, SubstitutionPreferenceFormActivity substitutionPreferenceFormActivity, z1<v.ViewState> z1Var) {
                    this.f105234a = localThemeScope;
                    this.f105235b = substitutionPreferenceFormActivity;
                    this.f105236c = z1Var;
                }
                ...
                public final void b(Composer composer, int i10) {
                    ...
                    LocalThemeScope localThemeScope = this.f105234a;
                    Modifier modifierH = J.h(D.i(Modifier.INSTANCE, H1.h.p(16)), 0.0f, 1, null);
                    composer.startReplaceGroup(5004770);
                    boolean zD = composer.D(this.f105235b);
                    final SubstitutionPreferenceFormActivity substitutionPreferenceFormActivity = this.f105235b;
                    Object objB = composer.B();
                    if (zD || objB == Composer.INSTANCE.a()) {
                    ...
                    composer.P();
                    String strC = C16193g.c(Y.f100046eh, composer, 0);
                    String str = this.f105235b.activityExtra;
                    SubstitutePreference selectedOption = c.c(this.f105236c).getSelectedOption();
                    C2908x.b(localThemeScope, modifierH, function0, strC, (Intrinsics.e(str, selectedOption != null ? selectedOption.getName() : null) || c.c(this.f105236c).getIsLoading()) ? false : true, null, null, false, composer, LocalThemeScope.f15770g | 48, 112);
                    if (ComposerKt.M()) {
                        ComposerKt.T();
                    }
                }
                ...
                /* JADX INFO: Access modifiers changed from: private */
                public static final Unit c(SubstitutionPreferenceFormActivity substitutionPreferenceFormActivity) {
                    substitutionPreferenceFormActivity.F1().E(v.e.b.f105296a);
                    return Unit.f142422a;
                }
            }
            ...
            static final class C1533c implements Function3<InterfaceC14794C, Composer, Integer, Unit> {

                /* renamed from: a, reason: collision with root package name */
                final /* synthetic */ LocalThemeScope f105237a;

                /* renamed from: b, reason: collision with root package name */
                final /* synthetic */ SubstitutionPreferenceFormActivity f105238b;

                /* renamed from: c, reason: collision with root package name */
                final /* synthetic */ z1<v.ViewState> f105239c;
                ...
                /* synthetic */ class C1534a extends FunctionReferenceImpl implements Function1<v.e, Unit> {
                    C1534a(Object obj) {
                ...
                /* synthetic */ class b extends AdaptedFunctionReference implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object>, SuspendFunction {
                    b(Object obj) {
                    ...
                    public final Object invoke(InterfaceC16622O interfaceC16622O, Continuation<? super Unit> continuation) {
                        return C1533c.c((SubstitutionPreferenceFormActivity) this.f142801a, interfaceC16622O, continuation);
                    }
                }

                C1533c(LocalThemeScope localThemeScope, SubstitutionPreferenceFormActivity substitutionPreferenceFormActivity, z1<v.ViewState> z1Var) {
                    this.f105237a = localThemeScope;
                    this.f105238b = substitutionPreferenceFormActivity;
                    this.f105239c = z1Var;
                }
                ...
                public final void b(InterfaceC14794C paddingValues, Composer composer, int i10) {
                    ...
                    LocalThemeScope localThemeScope = this.f105237a;
                    Modifier modifierH = D.h(Modifier.INSTANCE, paddingValues);
                    v.ViewState viewStateC = c.c(this.f105239c);
                    v vVarF1 = this.f105238b.F1();
                    composer.startReplaceGroup(5004770);
                    boolean zD = composer.D(vVarF1);
                    Object objB = composer.B();
                    if (zD || objB == Composer.INSTANCE.a()) {
                        objB = new C1534a(vVarF1);
                        composer.t(objB);
                    }
                    composer.P();
                    k.n(localThemeScope, modifierH, viewStateC, (Function1) ((KFunction) objB), composer, LocalThemeScope.f15770g, 0);
                    Unit unit = Unit.f142422a;
                    SubstitutionPreferenceFormActivity substitutionPreferenceFormActivity = this.f105238b;
                    composer.startReplaceGroup(5004770);
                ...
                /* JADX INFO: Access modifiers changed from: private */
                public static final /* synthetic */ Object c(SubstitutionPreferenceFormActivity substitutionPreferenceFormActivity, InterfaceC16622O interfaceC16622O, Continuation continuation) {
                    substitutionPreferenceFormActivity.G1(interfaceC16622O);
                    return Unit.f142422a;
                }
            }

            a(SubstitutionPreferenceFormActivity substitutionPreferenceFormActivity, z1<v.ViewState> z1Var) {
                this.f105230a = substitutionPreferenceFormActivity;
                this.f105231b = z1Var;
            }
            ...
            public final void a(LocalThemeScope AdsTheme, Composer composer, int i10) {
                ...
                C17921a1.a(FullStoryAnnotationsKt.fsUnmask(Modifier.INSTANCE), null, ComposableLambdaKt.c(539614854, true, new C1532a(AdsTheme, this.f105230a), composer, 54), ComposableLambdaKt.c(1592651621, true, new b(AdsTheme, this.f105230a, this.f105231b), composer, 54), null, null, 0, false, null, false, null, 0.0f, 0L, 0L, 0L, 0L, 0L, ComposableLambdaKt.c(-1566780307, true, new C1533c(AdsTheme, this.f105230a, this.f105231b), composer, 54), composer, 3456, 12582912, 131058);
                if (ComposerKt.M()) {
                    ComposerKt.T();
                }
            }
    ...
    public static final class d extends Lambda implements Function0<f0.c> {
        ...
        final /* synthetic */ ComponentActivity f105240f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(ComponentActivity componentActivity) {
            super(0);
            this.f105240f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final f0.c invoke() {
            return this.f105240f.getDefaultViewModelProviderFactory();
        }
    }
    ...
    public static final class e extends Lambda implements Function0<g0> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f105241f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public e(ComponentActivity componentActivity) {
            super(0);
            this.f105241f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final g0 invoke() {
            return this.f105241f.getCom.google.android.libraries.places.api.model.PlaceTypes.STORE java.lang.String();
        }
    }
    ...
    public static final class f extends Lambda implements Function0<CreationExtras> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function0 f105242f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f105243g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public f(Function0 function0, ComponentActivity componentActivity) {
            super(0);
            this.f105242f = function0;
            this.f105243g = componentActivity;
        }
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f105242f;
            return (function0 == null || (creationExtras = (CreationExtras) function0.invoke()) == null) ? this.f105243g.getDefaultViewModelCreationExtras() : creationExtras;
        }
    }
    ...
    static final class b extends SuspendLambda implements Function2<v.f, Continuation<? super Unit>, Object> {
        ...
        public final Object invoke(v.f fVar, Continuation<? super Unit> continuation) {
            return ((b) create(fVar, continuation)).invokeSuspend(Unit.f142422a);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f105226a == 0) {
                ResultKt.b(obj);
                if (Intrinsics.e((v.f) this.f105227b, v.f.a.f105297a)) {
                    if (SubstitutionPreferenceFormActivity.this.getFeatureManager().e(AbstractC18227f.i0.f170583h)) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final C0 G1(InterfaceC16622O coroutineScope) {
        return C17154h.J(C17154h.O(F1().D().b(), new b(null)), coroutineScope);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        H1();
        C13589e.b(this, null, ComposableLambdaKt.composableLambdaInstance(-396146342, true, new c()), 1, null);
    }
}
