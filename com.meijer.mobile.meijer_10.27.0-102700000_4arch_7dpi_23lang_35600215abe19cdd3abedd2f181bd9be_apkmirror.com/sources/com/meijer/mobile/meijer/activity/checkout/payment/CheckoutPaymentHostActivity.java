...
public final class CheckoutPaymentHostActivity extends Hilt_CheckoutPaymentHostActivity {
    ...
    public static final int f103544x = 8;

    /* renamed from: s, reason: collision with root package name and from kotlin metadata */
    private final Lazy viewModel = new androidx.view.e0(Reflection.b(C11894c.class), new e(this), new d(this), new f(null, this));
    ...
    static final class c implements Function2<Composer, Integer, Unit> {
        ...
        static final class a implements Function3<LocalThemeScope, Composer, Integer, Unit> {
            ...
            final /* synthetic */ CheckoutPaymentHostActivity f103553a;
            ...
            static final class C1478a implements Function2<Composer, Integer, Unit> {

                /* renamed from: a, reason: collision with root package name */
                final /* synthetic */ LocalThemeScope f103554a;

                /* renamed from: b, reason: collision with root package name */
                final /* synthetic */ z1<C11894c.CheckoutPaymentHostViewState> f103555b;
                ...
                static final class C1479a implements Function3<InterfaceC14920X, Composer, Integer, Unit> {

                    /* renamed from: a, reason: collision with root package name */
                    final /* synthetic */ LocalThemeScope f103556a;

                    C1479a(LocalThemeScope localThemeScope) {
                        this.f103556a = localThemeScope;
                    }
                    ...
                    public final void a(InterfaceC14920X Assemble, Composer composer, int i10) {
                        ...
                        Bi.m.d(this.f103556a, FullStoryAnnotationsKt.fsUnmask(androidx.compose.foundation.layout.J.f(Modifier.INSTANCE, 0.0f, 1, null)), largeLoading, oVar, null, null, null, composer, LocalThemeScope.f15770g | 3072 | (q1.k.Large.f140090f << 6), 56);
                        if (ComposerKt.M()) {
                            ComposerKt.T();
                        }
                    }
                ...
                C1478a(LocalThemeScope localThemeScope, z1<C11894c.CheckoutPaymentHostViewState> z1Var) {
                    this.f103554a = localThemeScope;
                    this.f103555b = z1Var;
                }
                ...
                public final void a(Composer composer, int i10) {
                    ...
                    if (a.c(this.f103555b).getIsLoading()) {
                        LocalThemeScope localThemeScope = this.f103554a;
                        Ji.Q.e(localThemeScope, Q0.b.f139711a, ComposableLambdaKt.c(-813447233, true, new C1479a(localThemeScope), composer, 54), composer, LocalThemeScope.f15770g | 384 | (Q0.b.f139712b << 3));
                    }
                    if (ComposerKt.M()) {
                        ComposerKt.T();
                    }
            ...
            a(CheckoutPaymentHostActivity checkoutPaymentHostActivity) {
                this.f103553a = checkoutPaymentHostActivity;
            }
            ...
            public final void b(LocalThemeScope AdsTheme, Composer composer, int i10) {
                ...
                t1.a(androidx.compose.foundation.layout.J.f(Modifier.INSTANCE, 0.0f, 1, null), null, C5346q0.q(AdsTheme.getAdsColors().getAdsColorUIBackground01().getColor(), 0.6f, 0.0f, 0.0f, 0.0f, 14, null), 0L, null, 0.0f, ComposableLambdaKt.c(-1531989239, true, new C1478a(AdsTheme, o1.b(this.f103553a.F1().o(), null, composer, 0, 1)), composer, 54), composer, 1572870, 58);
                if (ComposerKt.M()) {
                    ComposerKt.T();
                }
            }
            ...
            public static final C11894c.CheckoutPaymentHostViewState c(z1<C11894c.CheckoutPaymentHostViewState> z1Var) {
        ...
        public final void a(Composer composer, int i10) {
            ...
            Ji.K.b(null, ComposableLambdaKt.c(1553347021, true, new a(CheckoutPaymentHostActivity.this), composer, 54), composer, 48, 1);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final class d extends Lambda implements Function0<f0.c> {
        ...
        final /* synthetic */ ComponentActivity f103557f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(ComponentActivity componentActivity) {
            super(0);
            this.f103557f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final f0.c invoke() {
            return this.f103557f.getDefaultViewModelProviderFactory();
        }
    }
    ...
    public static final class e extends Lambda implements Function0<androidx.view.g0> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f103558f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public e(ComponentActivity componentActivity) {
            super(0);
            this.f103558f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final androidx.view.g0 invoke() {
            return this.f103558f.getCom.google.android.libraries.places.api.model.PlaceTypes.STORE java.lang.String();
        }
    }
    ...
    public static final class f extends Lambda implements Function0<CreationExtras> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function0 f103559f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f103560g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public f(Function0 function0, ComponentActivity componentActivity) {
            super(0);
            this.f103559f = function0;
            this.f103560g = componentActivity;
        }
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f103559f;
            return (function0 == null || (creationExtras = (CreationExtras) function0.invoke()) == null) ? this.f103560g.getDefaultViewModelCreationExtras() : creationExtras;
        }
    }
    ...
    static final class b extends SuspendLambda implements Function2<C11894c.b, Continuation<? super Unit>, Object> {

        /* renamed from: a, reason: collision with root package name */
        int f103549a;

        /* renamed from: b, reason: collision with root package name */
        /* synthetic */ Object f103550b;
        ...
        public final Object invoke(C11894c.b bVar, Continuation<? super Unit> continuation) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f103549a == 0) {
                ResultKt.b(obj);
                C11894c.b bVar = (C11894c.b) this.f103550b;
                if (bVar instanceof C11894c.b.LaunchPaymentScreen) {
                    CheckoutPaymentHostActivity checkoutPaymentHostActivity = CheckoutPaymentHostActivity.this;
                    if (((C11894c.b.LaunchPaymentScreen) bVar).getIsPaymentOptionsAvailable()) {
                        ...
                        intentC = Al.g.c(CheckoutPaymentHostActivity.this.getFeatureEntryPoint(), EnumC14271a.f133708b, false, true, CheckoutPaymentHostActivity.this.isOrderReviewFlow, false, null, 50, null);
                    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final C11894c F1() {
        return (C11894c) this.viewModel.getValue();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        C17154h.J(C17154h.O(F1().n(), new b(null)), C6031t.a(this));
        C13589e.b(this, null, ComposableLambdaKt.composableLambdaInstance(-1059118850, true, new c()), 1, null);
    }
