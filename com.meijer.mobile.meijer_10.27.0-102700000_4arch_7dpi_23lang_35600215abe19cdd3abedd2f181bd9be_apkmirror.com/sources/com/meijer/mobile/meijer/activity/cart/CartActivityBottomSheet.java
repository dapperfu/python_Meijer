...
public final class CartActivityBottomSheet extends BottomSheetDialogFragment {
    ...
    static final class a implements Function3<LocalThemeScope, Composer, Integer, Unit> {
        ...
        final /* synthetic */ boolean f101095b;
        ...
        public final void k(LocalThemeScope AdsTheme, Composer composer, int i10) {
            ...
            if (CartActivityBottomSheet.this.getIsDisplayPinPadScreen()) {
                ...
                composer.P();
                Hm.h.e(AdsTheme, null, isShowTimer, ebtTimerText, false, function0, function1, acculynkPostBody, (Function0) objB3, composer, LocalThemeScope.f15770g | 24576 | (i11 & 14), 1);
                composer.P();
            } else if (this.f101095b) {
                composer.startReplaceGroup(-202709015);
                float f10 = 10;
                Modifier modifierD = androidx.compose.foundation.b.d(T0.e.a(Modifier.INSTANCE, C16692i.e(H1.h.p(f10), H1.h.p(f10), 0.0f, 0.0f, 12, null)), AdsTheme.getAdsColors().getAdsColorUIBackground01().getColor(), null, 2, null);
                ...
                composer.P();
                C11953f.c(AdsTheme, modifierD, adjustEbtPaymentDecorator, function02, function03, (Function1) objB6, composer, (i11 & 14) | LocalThemeScope.f15770g | (AbstractC5607a.f45514b << 6), 0);
                composer.P();
            } else if (CartActivityBottomSheet.this.getIsEZCDEnabled()) {
                composer.startReplaceGroup(-201920592);
                float f11 = 10;
                Modifier modifierD2 = androidx.compose.foundation.b.d(T0.e.a(Modifier.INSTANCE, C16692i.e(H1.h.p(f11), H1.h.p(f11), 0.0f, 0.0f, 12, null)), AdsTheme.getAdsColors().getAdsColorUIBackground01().getColor(), null, 2, null);
                ...
                composer.P();
                C2880b0.g(AdsTheme, modifierD2, strC, strC2, null, (Function0) objB7, composer, LocalThemeScope.f15770g | (i11 & 14), 8);
                composer.P();
            } else {
        ...
        public static final Unit l(CartActivityBottomSheet cartActivityBottomSheet) {
            cartActivityBottomSheet.getListener().z();
            return Unit.f142422a;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Unit o(CartActivityBottomSheet cartActivityBottomSheet, double d10) {
            cartActivityBottomSheet.getListener().t0(d10);
            cartActivityBottomSheet.getListener().o0();
            return Unit.f142422a;
        }
        ...
        public static final Unit q(CartActivityBottomSheet cartActivityBottomSheet, String str) {
            cartActivityBottomSheet.getListener().e0(str);
            return Unit.f142422a;
        }
        ...
        public static final Unit r(CartActivityBottomSheet cartActivityBottomSheet) {
            if (cartActivityBottomSheet.getIsShowTimer()) {
                cartActivityBottomSheet.getListener().K();
            } else {
                cartActivityBottomSheet.getListener().u();
            }
            return Unit.f142422a;
        }
        ...
        public static final Unit t(CartActivityBottomSheet cartActivityBottomSheet) {
            cartActivityBottomSheet.getListener().L0();
            return Unit.f142422a;
        }
    }

    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u0006\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0002\b\u0006\bf\u0018\u00002\u00020\u0001J\u000f\u0010\u0003\u001a\u00020\u0002H&¢\u0006\u0004\b\u0003\u0010\u0004J\u0017\u0010\u0007\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0005H&¢\u0006\u0004\b\u0007\u0010\bJ\u000f\u0010\t\u001a\u00020\u0002H&¢\u0006\u0004\b\t\u0010\u0004J\u000f\u0010\n\u001a\u00020\u0002H&¢\u0006\u0004\b\n\u0010\u0004J\u0019\u0010\r\u001a\u00020\u00022\b\u0010\f\u001a\u0004\u0018\u00010\u000bH&¢\u0006\u0004\b\r\u0010\u000eJ\u000f\u0010\u000f\u001a\u00020\u0002H&¢\u0006\u0004\b\u000f\u0010\u0004J\u000f\u0010\u0010\u001a\u00020\u0002H&¢\u0006\u0004\b\u0010\u0010\u0004ø\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001¨\u0006\u0011À\u0006\u0001"}, d2 = {"Lcom/meijer/mobile/meijer/activity/cart/CartActivityBottomSheet$b;", "", "", "L0", "()V", "", "amount", "t0", "(D)V", "o0", "u", "", "results", "e0", "(Ljava/lang/String;)V", "z", "K", "Meijer_playstoreRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public interface b {
        void K();

        void L0();

        void e0(String results);

        void o0();

        void t0(double amount);
    ...
    static final class d implements Function2<Composer, Integer, Unit> {
        ...
        public final void a(Composer composer, int i10) {
            ...
            cartActivityBottomSheet.E0(cartActivityBottomSheet.getIsAdjustEbt(), composer, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit F0(CartActivityBottomSheet cartActivityBottomSheet, boolean z10, int i10, Composer composer, int i11) {
        cartActivityBottomSheet.E0(z10, composer, androidx.compose.runtime.J0.a(i10 | 1));
        return Unit.f142422a;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View viewInflate = inflater.inflate(com.meijer.mobile.meijer.V.f99325H, container, false);
        ((ComposeView) viewInflate.findViewById(com.meijer.mobile.meijer.T.f98770B)).setContent(ComposableLambdaKt.composableLambdaInstance(1099507488, true, new d()));
        return viewInflate;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void E0(final boolean z10, Composer composer, final int i10) {
        int i11;
        int i12;
        int i13;
        ...
        if ((i11 & 19) == 18 && composerStartRestartGroup.j()) {
            ...
            Ji.K.b(null, ComposableLambdaKt.c(2138033681, true, new a(z10), composerStartRestartGroup, 54), composerStartRestartGroup, 48, 1);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
        ...
        if (t0L != null) {
            t0L.a(new Function2() { // from class: com.meijer.mobile.meijer.activity.cart.L
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return CartActivityBottomSheet.F0(this.f101614a, z10, i10, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    public final void g1() {
        ...
        View view = getView();
        if (view != null && (composeView = (ComposeView) view.findViewById(com.meijer.mobile.meijer.T.f98770B)) != null) {
