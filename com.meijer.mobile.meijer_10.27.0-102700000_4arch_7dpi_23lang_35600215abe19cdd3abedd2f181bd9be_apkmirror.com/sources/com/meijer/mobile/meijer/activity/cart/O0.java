...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a\u0015\u0010\u0002\u001a\u0004\u0018\u00010\u0001*\u00020\u0000H\u0002¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"LCo/h;", "Lmk/g;", "b", "(LCo/h;)Lmk/g;", "Meijer_playstoreRelease"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class O0 {
    ...
    public static final class c<T> implements Comparator {
        ...
        final /* synthetic */ Comparator f101630a;

        public c(Comparator comparator) {
            this.f101630a = comparator;
        }

        @Override // java.util.Comparator
        public final int compare(T t10, T t11) {
            int iCompare = this.f101630a.compare(t10, t11);
            return iCompare != 0 ? iCompare : ComparisonsKt.d(((mk.g) t10).a1(), ((mk.g) t11).a1());
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final mk.g b(ProductFullDetails productFullDetails) {
