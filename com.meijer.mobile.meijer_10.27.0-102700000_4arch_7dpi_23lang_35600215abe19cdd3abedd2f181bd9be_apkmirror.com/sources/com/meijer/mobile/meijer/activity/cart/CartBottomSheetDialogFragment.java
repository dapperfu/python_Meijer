...
public final class CartBottomSheetDialogFragment extends Hilt_CartBottomSheetDialogFragment {
    ...
    public static final int f101099j = 8;

    /* renamed from: f, reason: collision with root package name and from kotlin metadata */
    private CartEntryActionDecorator cartEntryActionDecorator;

    /* renamed from: g, reason: collision with root package name and from kotlin metadata */
    private AbstractC4279r1 binding;

    /* renamed from: h, reason: collision with root package name and from kotlin metadata */
    private a listener;

    @Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\bf\u0018\u00002\u00020\u0001J\u0017\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H&¢\u0006\u0004\b\u0005\u0010\u0006J#\u0010\u000b\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u00072\n\b\u0002\u0010\n\u001a\u0004\u0018\u00010\tH&¢\u0006\u0004\b\u000b\u0010\fø\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001¨\u0006\rÀ\u0006\u0001"}, d2 = {"Lcom/meijer/mobile/meijer/activity/cart/CartBottomSheetDialogFragment$a;", "", "Lmk/f;", "product", "", "i0", "(Lmk/f;)V", "", "entryNumber", "", "note", "b", "(ILjava/lang/String;)V", "Meijer_playstoreRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public interface a {
        void b(int entryNumber, String note);

        void i0(mk.f product);

        static /* synthetic */ void H0(a aVar, int i10, String str, int i11, Object obj) {
            if (obj != null) {
    ...
    public static final void H0(CartBottomSheetDialogFragment cartBottomSheetDialogFragment, View view) {
        if (cartBottomSheetDialogFragment.cartEntryActionDecorator == null) {
            Intrinsics.y("cartEntryActionDecorator");
        }
        ...
        if (aVar != null) {
            ...
            aVar.i0(cartEntryActionDecorator.getProduct());
        }
    ...
    public static final void J0(CartBottomSheetDialogFragment cartBottomSheetDialogFragment, View view) {
        ...
        if (aVar != null) {
            ...
            a.H0(aVar, cartEntryActionDecorator.getEntryNumber(), null, 2, null);
        }
        cartBottomSheetDialogFragment.dismiss();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        AbstractC4279r1 abstractC4279r1K0 = AbstractC4279r1.K0(inflater, container, false);
        this.binding = abstractC4279r1K0;
        AbstractC4279r1 abstractC4279r1 = null;
        if (abstractC4279r1K0 == null) {
            Intrinsics.y("binding");
            abstractC4279r1K0 = null;
        }
        TableRow addNoteSection = abstractC4279r1K0.f20909A;
        ...
        AbstractC4279r1 abstractC4279r12 = this.binding;
        if (abstractC4279r12 == null) {
            Intrinsics.y("binding");
            abstractC4279r12 = null;
        }
        abstractC4279r12.f20916H.setOnClickListener(new View.OnClickListener() { // from class: com.meijer.mobile.meijer.activity.cart.g0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                CartBottomSheetDialogFragment.H0(this.f101836a, view);
            }
        });
        AbstractC4279r1 abstractC4279r13 = this.binding;
        if (abstractC4279r13 == null) {
            Intrinsics.y("binding");
            abstractC4279r13 = null;
        }
        abstractC4279r13.f20909A.setOnClickListener(new View.OnClickListener() { // from class: com.meijer.mobile.meijer.activity.cart.h0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                CartBottomSheetDialogFragment.J0(this.f101840a, view);
            }
        });
        AbstractC4279r1 abstractC4279r14 = this.binding;
        if (abstractC4279r14 == null) {
            Intrinsics.y("binding");
            abstractC4279r14 = null;
        }
        abstractC4279r14.f20912D.setOnClickListener(new View.OnClickListener() { // from class: com.meijer.mobile.meijer.activity.cart.i0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                CartBottomSheetDialogFragment.K0(this.f101842a, view);
            }
        });
        AbstractC4279r1 abstractC4279r15 = this.binding;
        if (abstractC4279r15 == null) {
            Intrinsics.y("binding");
        } else {
            abstractC4279r1 = abstractC4279r15;
        }
        View root = abstractC4279r1.getRoot();
