...
public final class EditBackUpItemBottomSheet extends BottomSheetDialogFragment {
    ...
    public static final int f101563d = 8;
    ...
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\bf\u0018\u00002\u00020\u0001J\u0017\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H&¢\u0006\u0004\b\u0005\u0010\u0006J\u0017\u0010\u0007\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H&¢\u0006\u0004\b\u0007\u0010\u0006ø\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001¨\u0006\bÀ\u0006\u0001"}, d2 = {"Lcom/meijer/mobile/meijer/activity/cart/EditBackUpItemBottomSheet$b;", "", "Lvs/b;", "item", "", "k", "(Lvs/b;)V", "m", "Meijer_playstoreRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public interface b {
        void k(CartProductListDecorator item);

        void m(CartProductListDecorator item);
    }
    ...
    public static final void K0(EditBackUpItemBottomSheet editBackUpItemBottomSheet, View view) {
        editBackUpItemBottomSheet.listener.m(editBackUpItemBottomSheet.item);
        Dialog dialog = editBackUpItemBottomSheet.getDialog();
        if (dialog != null) {
            dialog.dismiss();
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View viewInflate = inflater.inflate(com.meijer.mobile.meijer.V.f99382g0, container, false);
        View viewFindViewById = viewInflate.findViewById(com.meijer.mobile.meijer.T.f99278x0);
        Intrinsics.i(viewFindViewById, "findViewById(...)");
        View viewFindViewById2 = viewInflate.findViewById(com.meijer.mobile.meijer.T.f98851I6);
        Intrinsics.i(viewFindViewById2, "findViewById(...)");
        View viewFindViewById3 = viewInflate.findViewById(com.meijer.mobile.meijer.T.f99026a1);
        ...
        ((Button) viewFindViewById).setOnClickListener(new View.OnClickListener() { // from class: com.meijer.mobile.meijer.activity.cart.W0
            ...
            public final void onClick(View view) {
                EditBackUpItemBottomSheet.H0(this.f101714a, view);
            }
        });
        ((Button) viewFindViewById2).setOnClickListener(new View.OnClickListener() { // from class: com.meijer.mobile.meijer.activity.cart.X0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                EditBackUpItemBottomSheet.J0(this.f101733a, view);
            }
        });
        ((Button) viewFindViewById3).setOnClickListener(new View.OnClickListener() { // from class: com.meijer.mobile.meijer.activity.cart.Y0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                EditBackUpItemBottomSheet.K0(this.f101735a, view);
            }
        });
        return viewInflate;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void H0(EditBackUpItemBottomSheet editBackUpItemBottomSheet, View view) {
        Dialog dialog = editBackUpItemBottomSheet.getDialog();
        if (dialog != null) {
            dialog.dismiss();
        }
