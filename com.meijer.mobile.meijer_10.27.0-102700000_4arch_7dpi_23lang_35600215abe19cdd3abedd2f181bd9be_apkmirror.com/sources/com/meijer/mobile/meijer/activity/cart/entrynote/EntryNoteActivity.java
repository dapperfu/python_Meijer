...
public final class EntryNoteActivity extends Hilt_EntryNoteActivity implements Aj.b {
    ...
    private final Lazy toolbar = LazyKt.b(new Function0() { // from class: com.meijer.mobile.meijer.activity.cart.entrynote.e
        ...
        public final Object invoke() {
            return EntryNoteActivity.U1(this.f101790a);
        }
    });
    ...
    public static final class b implements TextWatcher {
        ...
        final /* synthetic */ String f101770b;
    ...
    public static final class e extends Lambda implements Function0<f0.c> {
        ...
        final /* synthetic */ ComponentActivity f101777f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public e(ComponentActivity componentActivity) {
            super(0);
            this.f101777f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final f0.c invoke() {
            return this.f101777f.getDefaultViewModelProviderFactory();
        }
    }
    ...
    public static final class f extends Lambda implements Function0<g0> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f101778f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public f(ComponentActivity componentActivity) {
            super(0);
            this.f101778f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final g0 invoke() {
            return this.f101778f.getCom.google.android.libraries.places.api.model.PlaceTypes.STORE java.lang.String();
        }
    }
    ...
    public static final class g extends Lambda implements Function0<CreationExtras> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function0 f101779f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f101780g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public g(Function0 function0, ComponentActivity componentActivity) {
            super(0);
            this.f101779f = function0;
            this.f101780g = componentActivity;
        }
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f101779f;
            return (function0 == null || (creationExtras = (CreationExtras) function0.invoke()) == null) ? this.f101780g.getDefaultViewModelCreationExtras() : creationExtras;
        }
    }
    ...
    static final class c extends SuspendLambda implements Function2<i.EntryNoteViewState, Continuation<? super Unit>, Object> {
        ...
        public final Object invoke(i.EntryNoteViewState entryNoteViewState, Continuation<? super Unit> continuation) {
            return ((c) create(entryNoteViewState, continuation)).invokeSuspend(Unit.f142422a);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f101771a == 0) {
                ResultKt.b(obj);
                i.EntryNoteViewState entryNoteViewState = (i.EntryNoteViewState) this.f101772b;
                ...
                MaterialButton materialButton = k10.f20163I;
                boolean z11 = false;
                ...
                MaterialButton materialButton2 = k12.f20165z;
                if (entryNoteViewState.getIsEntryNoteValid() && !entryNoteViewState.getLoadingState().getIsLoading()) {
                    z11 = true;
                }
                ...
                k11.f20159E.W(entryNoteViewState.getLoadingState().getIsLoading());
    ...
    private final void R1(int count, String noteType) {
        ...
        if (Intrinsics.e(noteType, "com.meijer.intent.extra.EXTRA_ENTRY_NOTE_TYPE")) {
            ...
            k10.f20157C.announceForAccessibility(getString(C17135b.f162004V, Integer.valueOf(count), 99));
            return;
        }
        if (Intrinsics.e(noteType, "com.meijer.intent.extra.EXTRA_DELIVERY_NOTE_TYPE")) {
            K k12 = this.binding;
            ...
            k10.f20157C.announceForAccessibility(getString(C17135b.f162004V, Integer.valueOf(count), 250));
        }
    }
    ...
    public static final void O1(EntryNoteActivity entryNoteActivity, String str, View view) {
        ...
        if (Intrinsics.e(str, "com.meijer.intent.extra.EXTRA_ENTRY_NOTE_TYPE")) {
            ...
            entryNoteActivity.T1(String.valueOf(k10.f20157C.getText()));
            return;
        }
        if (Intrinsics.e(str, "com.meijer.intent.extra.EXTRA_DELIVERY_NOTE_TYPE")) {
            ...
            entryNoteActivity.S1(String.valueOf(k10.f20157C.getText()));
        }
    }
    ...
    private final void V1(String initialEntryNote, String noteType) {
        ...
        if (initialEntryNote.length() > 0) {
            v().setTitle(getString(C17135b.f161980J));
            K k11 = this.binding;
            if (k11 == null) {
                Intrinsics.y("binding");
                k11 = null;
            }
            MaterialButton addNoteButton = k11.f20165z;
            ...
            ConstraintLayout noteEditionSection = k12.f20158D;
            ...
            k13.f20157C.setText(initialEntryNote);
        }
        K k14 = this.binding;
        if (k14 == null) {
            Intrinsics.y("binding");
        ...
        MaterialToolbar toolbar = k10.f20162H;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        K k10 = null;
        K k11 = (K) Fs.a.a(layoutInflater, V.f99417s, null, false);
        this.binding = k11;
        if (k11 == null) {
            Intrinsics.y("binding");
            k11 = null;
        ...
        Aj.b.O0(this, 0, 0, new Function0() { // from class: com.meijer.mobile.meijer.activity.cart.entrynote.a
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return EntryNoteActivity.N1(this.f101783a);
            }
        }, 3, null);
        getLifecycle().a(L1());
        ...
        if (Intrinsics.e(stringExtra2, "com.meijer.intent.extra.EXTRA_ENTRY_NOTE_TYPE")) {
            ...
            k12.f20161G.setCounterMaxLength(99);
        } else if (Intrinsics.e(stringExtra2, "com.meijer.intent.extra.EXTRA_DELIVERY_NOTE_TYPE")) {
            v().setTitle(getString(C17135b.f162013c));
            K k13 = this.binding;
            if (k13 == null) {
                Intrinsics.y("binding");
                k13 = null;
            }
            k13.f20161G.setCounterMaxLength(250);
        }
        String str = "";
        if (stringExtra == null) {
            stringExtra = "";
        ...
        V1(stringExtra, str);
        C17154h.J(C17154h.O(L1().x(), new c(null)), C6031t.a(this));
        K k14 = this.binding;
        if (k14 == null) {
            Intrinsics.y("binding");
            k14 = null;
        }
        TextInputEditText note = k14.f20157C;
        Intrinsics.i(note, "note");
        note.addTextChangedListener(new b(stringExtra2));
        C17154h.J(C17154h.O(L1().getEvents(), new d(null)), C6031t.a(this));
        K k15 = this.binding;
        if (k15 == null) {
            Intrinsics.y("binding");
            k15 = null;
        }
        k15.f20165z.setOnClickListener(new View.OnClickListener() { // from class: com.meijer.mobile.meijer.activity.cart.entrynote.b
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                EntryNoteActivity.O1(this.f101784a, stringExtra2, view);
            }
        });
        K k16 = this.binding;
        if (k16 == null) {
        ...
        k16.f20163I.setOnClickListener(new View.OnClickListener() { // from class: com.meijer.mobile.meijer.activity.cart.entrynote.c
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                EntryNoteActivity.P1(this.f101786a, stringExtra2, view);
            }
        });
        K k17 = this.binding;
        if (k17 == null) {
        ...
        k10.f20156B.setOnClickListener(new View.OnClickListener() { // from class: com.meijer.mobile.meijer.activity.cart.entrynote.d
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                EntryNoteActivity.Q1(this.f101788a, stringExtra2, view);
            }
        });
    }
}
