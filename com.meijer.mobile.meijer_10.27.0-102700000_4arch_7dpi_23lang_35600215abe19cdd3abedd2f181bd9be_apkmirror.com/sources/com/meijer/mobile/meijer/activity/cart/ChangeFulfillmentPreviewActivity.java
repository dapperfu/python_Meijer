...
public final class ChangeFulfillmentPreviewActivity extends Hilt_ChangeFulfillmentPreviewActivity {
    ...
    public static final int f101104u = 8;
    ...
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u001f\u0010\t\u001a\u00020\b2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0006H\u0007¢\u0006\u0004\b\t\u0010\n¨\u0006\u000b"}, d2 = {"Lcom/meijer/mobile/meijer/activity/cart/ChangeFulfillmentPreviewActivity$a;", "", "<init>", "()V", "Landroid/content/Context;", "context", "Lej/e;", "cartChanges", "Landroid/content/Intent;", "a", "(Landroid/content/Context;Lej/e;)Landroid/content/Intent;", "Meijer_playstoreRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    static final class b implements Function2<Composer, Integer, Unit> {
        ...
        static final class a implements Function3<LocalThemeScope, Composer, Integer, Unit> {
            ...
            final /* synthetic */ ChangeFulfillmentPreviewActivity f101107a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ z1<S0.ViewState> f101108b;

            a(ChangeFulfillmentPreviewActivity changeFulfillmentPreviewActivity, z1<S0.ViewState> z1Var) {
                this.f101107a = changeFulfillmentPreviewActivity;
                this.f101108b = z1Var;
            }

            /* JADX INFO: Access modifiers changed from: private */
            public static final Unit e(ChangeFulfillmentPreviewActivity changeFulfillmentPreviewActivity, mk.f product) {
                Intrinsics.j(product, "product");
                changeFulfillmentPreviewActivity.startActivity(Al.g.t(changeFulfillmentPreviewActivity.getFeatureEntryPoint(), product, true, false, "PDP accessed from Fulfillment Change Preview", 4, null));
            ...
            public final void d(LocalThemeScope AdsTheme, Composer composer, int i10) {
                ...
                Modifier modifierB = C18299z.b(Modifier.INSTANCE, true);
                S0.ViewState viewStateC = b.c(this.f101108b);
                composer.startReplaceGroup(5004770);
                boolean zD = composer.D(this.f101107a);
                final ChangeFulfillmentPreviewActivity changeFulfillmentPreviewActivity = this.f101107a;
                Object objB = composer.B();
                if (zD || objB == Composer.INSTANCE.a()) {
                    objB = new Function1() { // from class: com.meijer.mobile.meijer.activity.cart.J0
                        @Override // kotlin.jvm.functions.Function1
                        public final Object invoke(Object obj) {
                            return ChangeFulfillmentPreviewActivity.b.a.e(changeFulfillmentPreviewActivity, (mk.f) obj);
                        }
                    };
                    composer.t(objB);
                }
                ...
                composer.P();
                composer.startReplaceGroup(5004770);
                boolean zD2 = composer.D(this.f101107a);
                final ChangeFulfillmentPreviewActivity changeFulfillmentPreviewActivity2 = this.f101107a;
                ...
                composer.P();
                composer.startReplaceGroup(5004770);
                boolean zD3 = composer.D(this.f101107a);
                final ChangeFulfillmentPreviewActivity changeFulfillmentPreviewActivity3 = this.f101107a;
                ...
                composer.P();
                ym.m.l(AdsTheme, modifierB, viewStateC, function1, function0, (Function0) objB3, composer, LocalThemeScope.f15770g | (i10 & 14));
                if (ComposerKt.M()) {
                    ComposerKt.T();
                }
            }
            ...
            public static final Unit f(ChangeFulfillmentPreviewActivity changeFulfillmentPreviewActivity) {
                changeFulfillmentPreviewActivity.D1().y(S0.a.c.f101653a);
                changeFulfillmentPreviewActivity.setResult(3132);
                changeFulfillmentPreviewActivity.finish();
                return Unit.f142422a;
            }
        ...
        public final void b(Composer composer, int i10) {
            ...
            Ji.K.b(null, ComposableLambdaKt.c(887315497, true, new a(ChangeFulfillmentPreviewActivity.this, S2.a.c(ChangeFulfillmentPreviewActivity.this.D1().x(), null, null, null, composer, 0, 7)), composer, 54), composer, 48, 1);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final class d extends Lambda implements Function0<f0.c> {
        ...
        final /* synthetic */ ComponentActivity f101112f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(ComponentActivity componentActivity) {
            super(0);
            this.f101112f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final f0.c invoke() {
            return this.f101112f.getDefaultViewModelProviderFactory();
        }
    }
    ...
    public static final class e extends Lambda implements Function0<androidx.view.g0> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f101113f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public e(ComponentActivity componentActivity) {
            super(0);
            this.f101113f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final androidx.view.g0 invoke() {
            return this.f101113f.getCom.google.android.libraries.places.api.model.PlaceTypes.STORE java.lang.String();
        }
    }
    ...
    public static final class f extends Lambda implements Function0<CreationExtras> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function0 f101114f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f101115g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public f(Function0 function0, ComponentActivity componentActivity) {
            super(0);
            this.f101114f = function0;
            this.f101115g = componentActivity;
        }
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f101114f;
            return (function0 == null || (creationExtras = (CreationExtras) function0.invoke()) == null) ? this.f101115g.getDefaultViewModelCreationExtras() : creationExtras;
        }
    }
    ...
    static final class c extends SuspendLambda implements Function2<S0.c, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f101109a == 0) {
                ResultKt.b(obj);
                S0.c cVar = (S0.c) this.f101110b;
                if (cVar instanceof S0.c.InitialLoad) {
                    uw.a.INSTANCE.a(ChangeFulfillmentPreviewActivity.this.getText(((S0.c.InitialLoad) cVar).getInitialLoadMsg()).toString(), new Object[0]);
                    return Unit.f142422a;
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        C13589e.b(this, null, ComposableLambdaKt.composableLambdaInstance(-1068473446, true, new b()), 1, null);
        C17154h.J(C17154h.O(D1().getEvents(), new c(null)), C6031t.a(this));
    }
}
