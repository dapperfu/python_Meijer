...
abstract class Hilt_UniversalDeepLinkRedirectActivity extends AppCompatActivity implements Au.c {

    /* renamed from: r, reason: collision with root package name */
    private xu.h f100966r;

    /* renamed from: s, reason: collision with root package name */
    private volatile C18095a f100967s;

    /* renamed from: t, reason: collision with root package name */
    private final Object f100968t = new Object();

    /* renamed from: u, reason: collision with root package name */
    private boolean f100969u = false;
    ...
    public final C18095a componentManager() {
        if (this.f100967s == null) {
            synchronized (this.f100968t) {
                try {
                    if (this.f100967s == null) {
                        this.f100967s = createComponentManager();
                    }
                } finally {
                }
            }
    ...
    protected void inject() {
        ...
        this.f100969u = true;
        ((s) generatedComponent()).f1((UniversalDeepLinkRedirectActivity) Au.f.a(this));
    }
    ...
    private void initSavedStateHandleHolder() {
        if (getApplication() instanceof Au.b) {
            ...
            this.f100966r = hVarB;
            if (hVarB.b()) {
                this.f100966r.c(getDefaultViewModelCreationExtras());
            }
        }
    }
