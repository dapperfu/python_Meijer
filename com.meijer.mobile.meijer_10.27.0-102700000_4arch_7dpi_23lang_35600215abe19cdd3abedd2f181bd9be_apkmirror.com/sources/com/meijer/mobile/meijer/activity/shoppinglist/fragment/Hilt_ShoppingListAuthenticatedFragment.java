...
abstract class Hilt_ShoppingListAuthenticatedFragment extends Fragment implements c {

    /* renamed from: a, reason: collision with root package name */
    private ContextWrapper f112459a;

    /* renamed from: b, reason: collision with root package name */
    private boolean f112460b;

    /* renamed from: c, reason: collision with root package name */
    private volatile C18101g f112461c;

    /* renamed from: d, reason: collision with root package name */
    private final Object f112462d = new Object();

    /* renamed from: e, reason: collision with root package name */
    private boolean f112463e = false;
    ...
    private void initializeComponentContext() {
        if (this.f112459a == null) {
            this.f112459a = C18101g.b(super.getContext(), this);
            this.f112460b = C17138a.a(super.getContext());
        }
    }

    @Override // Au.c
    public final C18101g componentManager() {
        if (this.f112461c == null) {
            synchronized (this.f112462d) {
                try {
                    if (this.f112461c == null) {
                        this.f112461c = createComponentManager();
                    }
                } finally {
                }
            }
    ...
    public Context getContext() {
        if (super.getContext() == null && !this.f112460b) {
            return null;
        }
        initializeComponentContext();
    ...
    public void onAttach(Activity activity) {
        ...
        ContextWrapper contextWrapper = this.f112459a;
