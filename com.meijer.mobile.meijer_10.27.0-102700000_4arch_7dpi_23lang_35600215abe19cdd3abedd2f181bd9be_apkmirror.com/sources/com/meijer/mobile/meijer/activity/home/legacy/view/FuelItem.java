...
public final /* data */ class FuelItem {
    ...
    public final AnnotatedString m61annotatedFuelPriceR2X_6o(long regularTextSize) {
        ...
        String strD = g.f10897a.d(d10);
        AnnotatedString.b bVar = new AnnotatedString.b(strD);
        float fC = a.INSTANCE.c();
        w.b(regularTextSize);
        bVar.a(new SpanStyle(0L, w.k(v.f(regularTextSize), v.h(regularTextSize) * 0.625f), null, null, null, null, null, 0L, a.d(fC), null, null, 0L, null, null, null, null, 65277, null), StringsKt.j0(strD), strD.length());
        return bVar.q();
    }
    ...
    public final SpannableString getSuperscriptFuelPrice() {
        ...
        spannableString.setSpan(new SuperscriptSpan(), StringsKt.j0(strD), spannableString.length(), 17);
        spannableString.setSpan(new RelativeSizeSpan(0.625f), StringsKt.j0(strD), spannableString.length(), 17);
