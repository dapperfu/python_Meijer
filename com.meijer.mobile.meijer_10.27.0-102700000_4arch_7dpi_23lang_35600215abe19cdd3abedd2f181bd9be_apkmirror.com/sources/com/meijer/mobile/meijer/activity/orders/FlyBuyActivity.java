...
@Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\n\b\u0001\u0018\u0000 \u00152\u00020\u0001:\u0001\u0016B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0013\u0010\u0005\u001a\u00020\u0004*\u00020\u0004H\u0003¢\u0006\u0004\b\u0005\u0010\u0006J\u0019\u0010\n\u001a\u00020\t2\b\u0010\b\u001a\u0004\u0018\u00010\u0007H\u0014¢\u0006\u0004\b\n\u0010\u000bJ\u000f\u0010\f\u001a\u00020\tH\u0014¢\u0006\u0004\b\f\u0010\u0003R\"\u0010\u0014\u001a\u00020\r8\u0006@\u0006X\u0087.¢\u0006\u0012\n\u0004\b\u000e\u0010\u000f\u001a\u0004\b\u0010\u0010\u0011\"\u0004\b\u0012\u0010\u0013¨\u0006\u0017"}, d2 = {"Lcom/meijer/mobile/meijer/activity/orders/FlyBuyActivity;", "Lcom/meijer/mobile/meijer/activity/MeijerActivity;", "<init>", "()V", "Li4/u;", "E1", "(Li4/u;Landroidx/compose/runtime/Composer;I)Li4/u;", "Landroid/os/Bundle;", "savedInstanceState", "", "onCreate", "(Landroid/os/Bundle;)V", "onDestroy", "Ljn/b;", "s", "Ljn/b;", "D1", "()Ljn/b;", "setNavigationCommandManager", "(Ljn/b;)V", "navigationCommandManager", "t", "a", "Meijer_playstoreRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public final class FlyBuyActivity extends Hilt_FlyBuyActivity {
    ...
    public static final int f110228u = 8;

    /* renamed from: s, reason: collision with root package name and from kotlin metadata */
    public C15063b navigationCommandManager;

    @Metadata(d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\b\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J=\u0010\u000e\u001a\u00020\r2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u00062\n\u0010\t\u001a\u00060\u0006j\u0002`\b2\u0006\u0010\n\u001a\u00020\u00062\b\u0010\f\u001a\u0004\u0018\u00010\u000bH\u0007¢\u0006\u0004\b\u000e\u0010\u000fR\u0014\u0010\u0010\u001a\u00020\u00068\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u0010\u0010\u0011R\u0014\u0010\u0012\u001a\u00020\u00068\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u0012\u0010\u0011R\u0014\u0010\u0013\u001a\u00020\u00068\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u0013\u0010\u0011R\u0014\u0010\u0014\u001a\u00020\u00068\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u0014\u0010\u0011¨\u0006\u0015"}, d2 = {"Lcom/meijer/mobile/meijer/activity/orders/FlyBuyActivity$a;", "", "<init>", "()V", "Landroid/content/Context;", "context", "", "startDestination", "Lcom/meijer/mobile/core/model/common/ResourceId;", "orderId", "orderType", "Lok/h;", "storeAddress", "Landroid/content/Intent;", "a", "(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lok/h;)Landroid/content/Intent;", "START_DESTINATION", "Ljava/lang/String;", "ORDER_ID", "ORDER_TYPE", "STORE_DETAILS", "Meijer_playstoreRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    static final class b implements Function2<Composer, Integer, Unit> {
        ...
        static final class a implements Function3<LocalThemeScope, Composer, Integer, Unit> {
            ...
            final /* synthetic */ FlyBuyActivity f110231a;

            a(FlyBuyActivity flyBuyActivity) {
                this.f110231a = flyBuyActivity;
            }
            ...
            public final void b(LocalThemeScope AdsTheme, Composer composer, int i10) throws Resources.NotFoundException {
                ...
                C14677u c14677uE1 = this.f110231a.E1(j4.j.e(new AbstractC14653B[0], composer, 0), composer, 0);
                String stringExtra = this.f110231a.getIntent().getStringExtra("START_DESTINATION");
                if (stringExtra == null) {
                    stringExtra = "im_here";
                }
                String str = stringExtra;
                FlyBuyActivity flyBuyActivity = this.f110231a;
                String string = flyBuyActivity.getString(com.meijer.mobile.meijer.Y.f99598Ha, flyBuyActivity.getIntent().getStringExtra("ORDER_TYPE"), this.f110231a.getIntent().getStringExtra("ORDER_ID"));
                Intrinsics.i(string, "getString(...)");
                Intent intent = this.f110231a.getIntent();
                ...
                boolean zD = composer.D(this.f110231a);
                final FlyBuyActivity flyBuyActivity2 = this.f110231a;
                ...
                composer.P();
                nn.P.c(AdsTheme, c14677uE1, str, string, storeDetails, (Function0) objB, composer, LocalThemeScope.f15770g | (i10 & 14));
                if (ComposerKt.M()) {
                    ComposerKt.T();
                }
            }
        ...
        public final void a(Composer composer, int i10) {
            ...
            Ji.K.b(null, ComposableLambdaKt.c(-716829660, true, new a(FlyBuyActivity.this), composer, 54), composer, 48, 1);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public final C15063b D1() {
        C15063b c15063b = this.navigationCommandManager;
        if (c15063b != null) {
            return c15063b;
        }
        Intrinsics.y("navigationCommandManager");
        return null;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final C14677u E1(C14677u c14677u, Composer composer, int i10) throws Resources.NotFoundException {
        C14677u c14677u2;
        ...
        InterfaceC15062a interfaceC15062a = (InterfaceC15062a) K0.a.a(D1().c(), C15063b.INSTANCE.a(), composer, 0).getValue();
        if (interfaceC15062a.a().length() > 0) {
            if (Intrinsics.e(interfaceC15062a.a(), "exitFlyBuy")) {
                finish();
                c14677u2 = c14677u;
            } else {
                c14677u2 = c14677u;
                C14667k.T(c14677u2, interfaceC15062a.a(), null, null, 6, null);
                D1().b();
            }
        } else {
            c14677u2 = c14677u;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        C13589e.b(this, null, ComposableLambdaKt.composableLambdaInstance(2112045013, true, new b()), 1, null);
    }
