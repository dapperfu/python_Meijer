...
public final class GeoFenceTransitionsIntentService extends a {
    ...
    private final void f() {
        this.disposables.a(d().t());
    }

    public final C17838h d() {
    ...
    protected void onHandleIntent(Intent intent) {
        C3774h c3774hA;
        if (intent == null || (c3774hA = C3774h.a(intent)) == null) {
            return;
        }
        if (c3774hA.d()) {
            uw.a.INSTANCE.d("Received error from geofence transition intent", new Object[0]);
            return;
        }
        int iB = c3774hA.b();
        if (iB != 1) {
            if (iB != 2) {
                uw.a.INSTANCE.a("Received a GeoFence event GEOFENCE_TRANSITION_DWELL, ignoring", new Object[0]);
                return;
            } else {
                g();
                return;
