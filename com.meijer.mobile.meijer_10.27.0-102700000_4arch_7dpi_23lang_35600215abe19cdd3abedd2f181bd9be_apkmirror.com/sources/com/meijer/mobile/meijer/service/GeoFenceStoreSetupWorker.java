...
@Metadata(d1 = {"\u0000T\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0017\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0001\u0018\u0000 32\u00020\u0001:\u00014BI\b\u0007\u0012\b\b\u0001\u0010\u0003\u001a\u00020\u0002\u0012\b\b\u0001\u0010\u0005\u001a\u00020\u0004\u0012\u0006\u0010\u0007\u001a\u00020\u0006\u0012\u0006\u0010\t\u001a\u00020\b\u0012\u0006\u0010\u000b\u001a\u00020\n\u0012\b\u0010\r\u001a\u0004\u0018\u00010\f\u0012\b\b\u0001\u0010\u000f\u001a\u00020\u000e¢\u0006\u0004\b\u0010\u0010\u0011J\u000f\u0010\u0013\u001a\u00020\u0012H\u0002¢\u0006\u0004\b\u0013\u0010\u0014J\u0010\u0010\u0016\u001a\u00020\u0015H\u0097@¢\u0006\u0004\b\u0016\u0010\u0017R\u0016\u0010\u0007\u001a\u00020\u00068\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0018\u0010\u0019R\"\u0010\t\u001a\u00020\b8\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u0013\u0010\u001a\u001a\u0004\b\u001b\u0010\u001c\"\u0004\b\u001d\u0010\u001eR\"\u0010\u000b\u001a\u00020\n8\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u001f\u0010 \u001a\u0004\b!\u0010\"\"\u0004\b#\u0010$R$\u0010\r\u001a\u0004\u0018\u00010\f8\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b%\u0010&\u001a\u0004\b'\u0010(\"\u0004\b)\u0010*R\u0014\u0010\u000f\u001a\u00020\u000e8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b+\u0010,R&\u00102\u001a\u0012\u0012\u0004\u0012\u00020.0-j\b\u0012\u0004\u0012\u00020.`/8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b0\u00101¨\u00065"}, d2 = {"Lcom/meijer/mobile/meijer/service/GeoFenceStoreSetupWorker;", "Landroidx/work/CoroutineWorker;", "Landroid/content/Context;", "context", "Landroidx/work/WorkerParameters;", "workerParams", "LZq/b;", "storeInfoRepository", "LTq/j;", "storeProvider", "LCk/b;", "bus", "Landroid/location/LocationManager;", "locationManager", "Lqv/K;", "ioDispatcher", "<init>", "(Landroid/content/Context;Landroidx/work/WorkerParameters;LZq/b;LTq/j;LCk/b;Landroid/location/LocationManager;Lqv/K;)V", "", "i", "()V", "Landroidx/work/c$a;", "b", "(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "h", "LZq/b;", "LTq/j;", "getStoreProvider", "()LTq/j;", "setStoreProvider", "(LTq/j;)V", "j", "LCk/b;", "getBus", "()LCk/b;", "setBus", "(LCk/b;)V", "k", "Landroid/location/LocationManager;", "getLocationManager", "()Landroid/location/LocationManager;", "setLocationManager", "(Landroid/location/LocationManager;)V", "l", "Lqv/K;", "Ljava/util/ArrayList;", "Lik/c;", "Lkotlin/collections/ArrayList;", "m", "Ljava/util/ArrayList;", "stores", "n", "a", "Meijer_playstoreRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public final class GeoFenceStoreSetupWorker extends CoroutineWorker {
    ...
    public static final int f113470o = 8;
    ...
    private ArrayList<C14737c> stores;
    ...
    public static final class Companion {
        ...
        public final void a(Context context) {
            ...
            O.INSTANCE.a(context).f("store worker", EnumC4321i.REPLACE, new y.a(GeoFenceStoreSetupWorker.class).b());
        }
    }
    ...
    static final class c extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: d, reason: collision with root package name */
        private /* synthetic */ Object f113488d;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ int f113490f;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            c cVar = GeoFenceStoreSetupWorker.this.new c(this.f113490f, continuation);
            cVar.f113488d = obj;
            return cVar;
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            int i10 = this.f113487c;
            try {
                if (i10 != 0) {
                    if (i10 == 1) {
                        ?? r13 = (InterfaceC16622O) this.f113488d;
                        ResultKt.b(obj);
                        i10 = r13;
                    } else {
            ...
            if (Result.h(objB)) {
                ...
                arrayList.add(new C14737c(dDoubleValue, dDoubleValue2, storeDetailsA.getStoreId()));
            }
            Throwable thE = Result.e(objB);
            if (thE != null) {
                E0.i(r12.getCoroutineContext());
                if (!(thE instanceof Error)) {
                    uw.a.INSTANCE.f(thE, "Failed to load home store!", new Object[0]);
                } else {
                    throw thE;
                }
            }
    ...
    static final class d extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: d, reason: collision with root package name */
        private /* synthetic */ Object f113494d;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Location f113496f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        d(Location location, Continuation<? super d> continuation) {
            super(2, continuation);
            this.f113496f = location;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            d dVar = GeoFenceStoreSetupWorker.this.new d(this.f113496f, continuation);
            dVar.f113494d = obj;
            return dVar;
        }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GeoFenceStoreSetupWorker(Context context, WorkerParameters workerParams, Zq.b storeInfoRepository, j storeProvider, Ck.b bus, LocationManager locationManager, AbstractC16618K ioDispatcher) {
    ...
    private final void i() {
        if (this.stores.isEmpty()) {
            uw.a.INSTANCE.s("No stores to add fences for!", new Object[0]);
        } else {
            this.bus.a(new AddStoreGeoFencesEvent(this.stores));
            uw.a.INSTANCE.a("adding %s stores to the geofence list", Integer.valueOf(this.stores.size()));
        }
    }

    /* JADX WARN: Code restructure failed: missing block: B:41:0x00cc, code lost:
    
        if (qv.C16644i.g(r2, r7, r0) == r1) goto L42;
     */
