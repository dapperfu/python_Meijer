        ...
        while (true) {
            ...
            if (!reader.hasNext()) {
                ...
                if (i11 == -3132) {
                    ...
                    if (num == null) {
                        throw c.o("deliveryFrequency", "deliveryFrequency", reader);
                    }
                    ...
                    if (storeInfoRequestJson == null) {
                        throw c.o("storeInfo", "storeInfo", reader);
                    }
                    if (productInfoRequestJson == null) {
                        throw c.o("productInfo", "productInfo", reader);
                    }
                    if (paymentInfoRequestJson == null) {
                        throw c.o("paymentInfo", "paymentInfo", reader);
                    }
                    if (customerDeliveryAddressRequestJsonFromJson == null) {
                        throw c.o("customerDeliveryAddress", "customerDeliveryAddress", reader);
                    }
                    if (preferredTimeslotRequestJsonFromJson == null) {
                        throw c.o("preferredTimeslot", "preferredTimeslot", reader);
                    }
            ...
            switch (reader.z(this.options)) {
                ...
                case 1:
                    ...
                    if (strFromJson2 == null) {
                        throw c.w("baseSite", "baseSite", reader);
                    }
                    i11 &= -3;
                    paymentInfoRequestJsonFromJson = paymentInfoRequestJson2;
                    strFromJson = str;
                ...
                case 2:
                    ...
                    if (numFromJson == null) {
                        throw c.w("deliveryFrequency", "deliveryFrequency", reader);
                    }
                    paymentInfoRequestJsonFromJson = paymentInfoRequestJson2;
                    strFromJson = str;
                    storeInfoRequestJsonFromJson = storeInfoRequestJson;
                ...
                case 3:
                    ...
                    if (strFromJson3 == null) {
                        throw c.w("deliveryFrequencyUnit", "deliveryFrequencyUnit", reader);
                    }
                    i11 &= -9;
                    paymentInfoRequestJsonFromJson = paymentInfoRequestJson2;
                    strFromJson = str;
                ...
                case 4:
                    ...
                    if (strFromJson4 == null) {
                        throw c.w("fulfillmentPartner", "fulfillmentPartner", reader);
                    }
                    i11 &= -17;
                    paymentInfoRequestJsonFromJson = paymentInfoRequestJson2;
                    strFromJson = str;
                ...
                case 5:
                    ...
                    if (strFromJson5 == null) {
                        throw c.w("fulfillmentType", "fulfillmentType", reader);
                    }
                    i11 &= -33;
                    paymentInfoRequestJsonFromJson = paymentInfoRequestJson2;
                    strFromJson = str;
                ...
                case 6:
                    ...
                    if (storeInfoRequestJsonFromJson == null) {
                        throw c.w("storeInfo", "storeInfo", reader);
                    }
                    paymentInfoRequestJsonFromJson = paymentInfoRequestJson2;
                    strFromJson = str;
                    numFromJson = num;
                ...
                case 7:
                    ...
                    if (productInfoRequestJsonFromJson == null) {
                        throw c.w("productInfo", "productInfo", reader);
                    }
                    paymentInfoRequestJsonFromJson = paymentInfoRequestJson2;
                    strFromJson = str;
                    numFromJson = num;
                ...
                case 8:
                    ...
                    if (paymentInfoRequestJsonFromJson == null) {
                        throw c.w("paymentInfo", "paymentInfo", reader);
                    }
                    strFromJson = str;
                    numFromJson = num;
                    storeInfoRequestJsonFromJson = storeInfoRequestJson;
                ...
                case 9:
                    ...
                    if (customerDeliveryAddressRequestJsonFromJson == null) {
                        throw c.w("customerDeliveryAddress", "customerDeliveryAddress", reader);
                    }
                    paymentInfoRequestJsonFromJson = paymentInfoRequestJson2;
                    strFromJson = str;
                    numFromJson = num;
                ...
                case 12:
                    ...
                    if (preferredTimeslotRequestJsonFromJson == null) {
                        throw c.w("preferredTimeslot", "preferredTimeslot", reader);
                    }
                    paymentInfoRequestJsonFromJson = paymentInfoRequestJson2;
                    strFromJson = str;
                    numFromJson = num;
