        ...
        while (reader.hasNext()) {
            switch (reader.z(this.options)) {
                ...
                case 0:
                    ...
                    if (lFromJson == null) {
                        throw c.w("listItemId", "listItemId", reader);
                    }
                    i10 &= -2;
                    break;
                case 1:
                    ...
                    if (numFromJson == null) {
                        throw c.w("listItemTypeId", "listItemTypeId", reader);
                    }
                    i10 &= -3;
                    break;
                case 2:
                    ...
                    if (numFromJson2 == null) {
                        throw c.w("itemDisplayOrder", "itemDisplayOrder", reader);
                    }
                    i10 &= -5;
                    break;
                case 3:
                ...
                case 5:
                    ...
                    if (boolFromJson == null) {
                        throw c.w("isItemInActiveList", "isItemInActiveList", reader);
                    }
                    i10 &= -33;
                    break;
            }
