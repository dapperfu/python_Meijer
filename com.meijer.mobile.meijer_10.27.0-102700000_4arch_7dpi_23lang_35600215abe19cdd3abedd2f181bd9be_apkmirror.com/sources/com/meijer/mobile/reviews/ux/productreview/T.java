...
@Metadata(d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\"\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\f\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0007\u0018\u0000 &2\u00020\u00012\u00020\u0002:\u0002!\u001dB\u0007¢\u0006\u0004\b\u0003\u0010\u0004J-\u0010\u000b\u001a\u00020\n2\u0010\b\u0002\u0010\u0007\u001a\n\u0012\u0004\u0012\u00020\u0006\u0018\u00010\u00052\n\b\u0002\u0010\t\u001a\u0004\u0018\u00010\bH\u0002¢\u0006\u0004\b\u000b\u0010\fJ\u000f\u0010\r\u001a\u00020\nH\u0002¢\u0006\u0004\b\r\u0010\u0004J\u000f\u0010\u000e\u001a\u00020\nH\u0002¢\u0006\u0004\b\u000e\u0010\u0004J\u001d\u0010\u0010\u001a\u00020\n2\f\u0010\u000f\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005H\u0002¢\u0006\u0004\b\u0010\u0010\u0011J\u0017\u0010\u0013\u001a\u00020\n2\u0006\u0010\u0012\u001a\u00020\bH\u0002¢\u0006\u0004\b\u0013\u0010\u0014J\u0017\u0010\u0015\u001a\u00020\n2\u0006\u0010\u000f\u001a\u00020\u0006H\u0002¢\u0006\u0004\b\u0015\u0010\u0016J\u0015\u0010\u0019\u001a\u00020\n2\u0006\u0010\u0018\u001a\u00020\u0017¢\u0006\u0004\b\u0019\u0010\u001aR\u001a\u0010\u001f\u001a\b\u0012\u0004\u0012\u00020\u001c0\u001b8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001d\u0010\u001eR\u001d\u0010%\u001a\b\u0012\u0004\u0012\u00020\u001c0 8\u0006¢\u0006\f\n\u0004\b!\u0010\"\u001a\u0004\b#\u0010$¨\u0006'"}, d2 = {"Lcom/meijer/mobile/reviews/ux/productreview/T;", "Landroidx/lifecycle/c0;", "Landroidx/lifecycle/f;", "<init>", "()V", "", "LJp/a;", "initFilters", "LJp/b;", "initSortBy", "", "v", "(Ljava/util/Set;LJp/b;)V", "s", "r", "filter", "q", "(Ljava/util/Set;)V", "sortBy", "u", "(LJp/b;)V", "t", "(LJp/a;)V", "Lcom/meijer/mobile/reviews/ux/productreview/a;", "action", "p", "(Lcom/meijer/mobile/reviews/ux/productreview/a;)V", "Ltv/B;", "Lcom/meijer/mobile/reviews/ux/productreview/T$b;", "a", "Ltv/B;", "_filterAndSortFlow", "Ltv/P;", "b", "Ltv/P;", "o", "()Ltv/P;", "filterAndSortFlow", "c", "ux_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* loaded from: classes11.dex */
public final class T extends androidx.view.c0 implements InterfaceC6015f {

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);

    /* renamed from: d, reason: collision with root package name */
    public static final int f115625d = 8;

    /* renamed from: e, reason: collision with root package name */
    private static final Set<Filter> f115626e;

    /* renamed from: f, reason: collision with root package name */
    private static final Set<Filter> f115627f;

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC17140B<FilterAndSortState> _filterAndSortFlow;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final tv.P<FilterAndSortState> filterAndSortFlow;
    ...
    static {
        ...
        f115626e = SetsKt.i(new Filter(filter, equalityOperator, "1", Lp.c.f18673x), new Filter(filter, equalityOperator, "2", Lp.c.f18616T0), new Filter(filter, equalityOperator, "3", Lp.c.f18612R0), new Filter(filter, equalityOperator, "4", Lp.c.f18651m), new Filter(filter, equalityOperator, "5", Lp.c.f18649l));
        f115627f = SetsKt.d(new Filter(ReviewOptions.Filter.ContentLocale, equalityOperator, "en_US", Lp.c.f18657p));
    }
    ...
    private final void q(Set<Filter> filter) {
        ...
        ArrayList arrayList;
        InterfaceC17140B<FilterAndSortState> interfaceC17140B = this._filterAndSortFlow;
        do {
        ...
        } while (!interfaceC17140B.e(value, FilterAndSortState.b(filterAndSortState, null, CollectionsKt.o1(arrayList), 1, null)));
    }
    ...
    private final void r() {
        ...
        do {
            value = interfaceC17140B.getValue();
        } while (!interfaceC17140B.e(value, FilterAndSortState.b(value, U.f115632a, null, 2, null)));
    }
    ...
    private final void s() {
        ...
        do {
            value = interfaceC17140B.getValue();
        } while (!interfaceC17140B.e(value, value.a(U.f115632a, SetsKt.e())));
    }
    ...
    private final void t(Filter filter) {
        ...
        do {
            value = interfaceC17140B.getValue();
            filterAndSortState = value;
        } while (!interfaceC17140B.e(value, FilterAndSortState.b(filterAndSortState, null, filterAndSortState.c().contains(filter) ? SetsKt.k(filterAndSortState.c(), filter) : SetsKt.m(filterAndSortState.c(), filter), 1, null)));
    }
    ...
    private final void u(Jp.b sortBy) {
        ...
        do {
            value = interfaceC17140B.getValue();
        } while (!interfaceC17140B.e(value, FilterAndSortState.b(value, sortBy, null, 2, null)));
    }
    ...
    private final void v(Set<Filter> initFilters, Jp.b initSortBy) {
        ...
        do {
            value = interfaceC17140B.getValue();
        } while (!interfaceC17140B.e(value, value.a(initSortBy == null ? U.f115632a : initSortBy, initFilters == null ? SetsKt.e() : initFilters)));
    }

    public final tv.P<FilterAndSortState> o() {
        return this.filterAndSortFlow;
    }

    public final void p(AbstractC12708a action) {
        Intrinsics.j(action, "action");
        if (action instanceof AbstractC12708a.SetFilterAndSort) {
            AbstractC12708a.SetFilterAndSort setFilterAndSort = (AbstractC12708a.SetFilterAndSort) action;
            v(setFilterAndSort.a(), setFilterAndSort.getInitSortBy());
            return;
        }
        if (action instanceof AbstractC12708a.ResetFilter) {
            q(((AbstractC12708a.ResetFilter) action).a());
            return;
        }
        if (action instanceof AbstractC12708a.b) {
            r();
            return;
        }
        if (action instanceof AbstractC12708a.c) {
            s();
        } else if (action instanceof AbstractC12708a.SelectFilter) {
            t(((AbstractC12708a.SelectFilter) action).getFilter());
        } else {
            if (!(action instanceof AbstractC12708a.SelectSortBy)) {
                throw new NoWhenBranchMatchedException();
            }
            u(((AbstractC12708a.SelectSortBy) action).getSortBy());
        }
    }

    public T() {
        InterfaceC17140B<FilterAndSortState> interfaceC17140BA = tv.S.a(new FilterAndSortState(U.f115632a, SetsKt.e()));
        this._filterAndSortFlow = interfaceC17140BA;
        this.filterAndSortFlow = C17154h.c(interfaceC17140BA);
    }
}
