...
public final class g1 {
    ...
    static final class a implements Function3<ji.j1, Composer, Integer, Unit> {
        ...
        final /* synthetic */ LocalThemeScope f115786a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f115787b;

        @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
        /* renamed from: com.meijer.mobile.reviews.ux.productreview.g1$a$a, reason: collision with other inner class name */
        static final class C1859a implements Function3<InterfaceC14800I, Composer, Integer, Unit> {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ LocalThemeScope f115788a;

            C1859a(LocalThemeScope localThemeScope) {
                this.f115788a = localThemeScope;
            }
            ...
            public final void a(InterfaceC14800I AdsButton, Composer composer, int i10) {
                ...
                C16307b.b(this.f115788a, new q1.h.DrawableIcon(C.f.o.f15522e, null, null, null, 0.0f, null, null, 126, null), null, null, composer, LocalThemeScope.f15770g | (q1.h.DrawableIcon.f140067h << 3), 6);
                if (ComposerKt.M()) {
                    ComposerKt.T();
                }
            }
        ...
        a(LocalThemeScope localThemeScope, Function0<Unit> function0) {
            this.f115786a = localThemeScope;
            this.f115787b = function0;
        }
        ...
        public final void a(ji.j1 Assemble, Composer composer, int i10) {
            ...
            ni.E0.b(this.f115786a, Assemble.getButtons().getEnabledButton(), this.f115787b, ComposableLambdaKt.c(-586534770, true, new C1859a(this.f115786a), composer, 54), composer, LocalThemeScope.f15770g | 3072 | (q1.d.StandardButton.f139974k << 3));
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
    static final class b implements Function4<InterfaceC15985u, Integer, Composer, Integer, Unit> {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ ArrayList<String> f115789a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ InterfaceC5730l0<Boolean> f115790b;

        b(ArrayList<String> arrayList, InterfaceC5730l0<Boolean> interfaceC5730l0) {
            this.f115789a = arrayList;
            this.f115790b = interfaceC5730l0;
        }
        ...
        public final void a(InterfaceC15985u HorizontalPager, int i10, Composer composer, int i11) {
            ...
            String str = this.f115789a.get(i10);
            Intrinsics.i(str, "get(...)");
            g1.q(modifierFsExclude, str, "", 0.0f, 0.0f, null, false, this.f115790b, composer, 12583296, BinsView.TOTE_HEIGHT_DP);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class c extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ AbstractC15962C f115792b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ int f115793c;

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new c(this.f115792b, this.f115793c, continuation);
        }

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        c(AbstractC15962C abstractC15962C, int i10, Continuation<? super c> continuation) {
            super(2, continuation);
            this.f115792b = abstractC15962C;
            this.f115793c = i10;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                ResultKt.b(obj);
                AbstractC15962C abstractC15962C = this.f115792b;
                int i11 = this.f115793c;
                this.f115791a = 1;
    ...
    static final class d implements PointerInputEventHandler {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ boolean f115794a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ InterfaceC5724i0 f115795b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ InterfaceC5730l0<Boolean> f115796c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ InterfaceC5724i0 f115797d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ InterfaceC5724i0 f115798e;

        d(boolean z10, InterfaceC5724i0 interfaceC5724i0, InterfaceC5730l0<Boolean> interfaceC5730l0, InterfaceC5724i0 interfaceC5724i02, InterfaceC5724i0 interfaceC5724i03) {
            this.f115794a = z10;
            this.f115795b = interfaceC5724i0;
            this.f115796c = interfaceC5730l0;
            this.f115797d = interfaceC5724i02;
            this.f115798e = interfaceC5724i03;
        }
        ...
        static final class a extends RestrictedSuspendLambda implements Function2<InterfaceC14171c, Continuation<? super Unit>, Object> {
            ...
            /* renamed from: c, reason: collision with root package name */
            private /* synthetic */ Object f115800c;

            /* renamed from: d, reason: collision with root package name */
            final /* synthetic */ InterfaceC5724i0 f115801d;

            /* renamed from: e, reason: collision with root package name */
            final /* synthetic */ InterfaceC5730l0<Boolean> f115802e;

            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ InterfaceC5724i0 f115803f;

            /* renamed from: g, reason: collision with root package name */
            final /* synthetic */ InterfaceC5724i0 f115804g;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            a(InterfaceC5724i0 interfaceC5724i0, InterfaceC5730l0<Boolean> interfaceC5730l0, InterfaceC5724i0 interfaceC5724i02, InterfaceC5724i0 interfaceC5724i03, Continuation<? super a> continuation) {
                super(2, continuation);
                this.f115801d = interfaceC5724i0;
                this.f115802e = interfaceC5730l0;
                this.f115803f = interfaceC5724i02;
                this.f115804g = interfaceC5724i03;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                a aVar = new a(this.f115801d, this.f115802e, this.f115803f, this.f115804g, continuation);
                aVar.f115800c = obj;
                return aVar;
            }
        ...
        public final Object invoke(g1.J j10, Continuation<? super Unit> continuation) {
            ...
            Object objD = C13821t.d(j10, new a(this.f115795b, this.f115796c, this.f115797d, this.f115798e, null), continuation);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void j(final Ji.LocalThemeScope r36, androidx.compose.ui.Modifier r37, final int r38, final java.util.ArrayList<java.lang.String> r39, final kotlin.jvm.functions.Function0<kotlin.Unit> r40, androidx.compose.runtime.Composer r41, final int r42, final int r43) {
        /*
            Method dump skipped, instructions count: 1147
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meijer.mobile.reviews.ux.productreview.g1.j(Ji.M, androidx.compose.ui.Modifier, int, java.util.ArrayList, kotlin.jvm.functions.Function0, androidx.compose.runtime.Composer, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit u(Modifier modifier, String str, String str2, float f10, float f11, InterfaceC5784k interfaceC5784k, boolean z10, InterfaceC5730l0 interfaceC5730l0, int i10, int i11, Composer composer, int i12) {
        q(modifier, str, str2, f10, f11, interfaceC5784k, z10, interfaceC5730l0, composer, androidx.compose.runtime.J0.a(i10 | 1), i11);
        return Unit.f142422a;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit m(InterfaceC16622O interfaceC16622O, AbstractC15962C abstractC15962C, int i10) {
        C16648k.d(interfaceC16622O, null, null, new c(abstractC15962C, i10, null), 3, null);
        return Unit.f142422a;
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void q(androidx.compose.ui.Modifier r40, final java.lang.String r41, final java.lang.String r42, float r43, float r44, androidx.compose.ui.layout.InterfaceC5784k r45, boolean r46, final androidx.compose.runtime.InterfaceC5730l0<java.lang.Boolean> r47, androidx.compose.runtime.Composer r48, final int r49, final int r50) {
        /*
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit t(boolean z10, float f10, float f11, InterfaceC5724i0 interfaceC5724i0, InterfaceC5724i0 interfaceC5724i02, InterfaceC5724i0 interfaceC5724i03, androidx.compose.ui.graphics.e graphicsLayer) {
        Intrinsics.j(graphicsLayer, "$this$graphicsLayer");
        if (z10) {
            graphicsLayer.h(Math.max(f10, Math.min(f11, interfaceC5724i0.b())));
            graphicsLayer.m(Math.max(f10, Math.min(f11, interfaceC5724i0.b())));
            graphicsLayer.n(interfaceC5724i02.b());
            graphicsLayer.e(interfaceC5724i03.b());
        }
        return Unit.f142422a;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit r(InterfaceC5724i0 interfaceC5724i0, InterfaceC5724i0 interfaceC5724i02, InterfaceC5724i0 interfaceC5724i03) {
        if (interfaceC5724i0.b() > 1.0f) {
            interfaceC5724i0.B(1.0f);
            interfaceC5724i02.B(1.0f);
            interfaceC5724i03.B(1.0f);
        } else {
            interfaceC5724i0.B(3.0f);
        }
        return Unit.f142422a;
    }
}
