...
public final /* data */ class PaymentUpdateDTO {
    ...
    @Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J1\u0010\r\u001a\u00020\f2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\b2\n\b\u0002\u0010\u000b\u001a\u0004\u0018\u00010\n¢\u0006\u0004\b\r\u0010\u000e¨\u0006\u000f"}, d2 = {"Lcom/meijer/mobile/accounts/payments/api/models/network/PaymentUpdateDTO$a;", "", "<init>", "()V", "Luh/a;", "creditCard", "", "saveCardEnabled", "j$/time/LocalDateTime", "currentTime", "", "cartCode", "Lcom/meijer/mobile/accounts/payments/api/models/network/PaymentUpdateDTO;", "a", "(Luh/a;ZLj$/time/LocalDateTime;Ljava/lang/String;)Lcom/meijer/mobile/accounts/payments/api/models/network/PaymentUpdateDTO;", "payments_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public static final class Companion {
        ...
        public final PaymentUpdateDTO a(AccountCreditCard creditCard, boolean saveCardEnabled, LocalDateTime currentTime, String cartCode) {
            ...
            String str = !StringsKt.r0(cardCVV) ? cardCVV : null;
            ...
            String str2 = creditCard.getExpirationDate().format(C17590a.NUMERIC_MONTH_YEAR_FULL);
            ...
            DateTimeFormatter dateTimeFormatter = C17590a.ISO_LOCAL_DATE_TIME;
            ...
            EnumC17261c enumC17261c = EnumC17261c.f162964c;
            return new PaymentUpdateDTO(cardId, digitalAccountId, cardName, cardLastFourDigits, str, saveCardEnabled, value, cardTypeName, str2, cardDescription, cardGuid, cardAuthToken, mperksFlag, linkToMPerks, isPrimary, phoneNumber, str3, strValueOf, str4, strValueOf2, str5, addressId, addressName, addressLine1, addressLine2, addressCity, addressState, addressZipCode, enumC17261c.getTypeName(), Integer.valueOf(enumC17261c.getTypeId()), creditCard.getAddressContactFirstName(), creditCard.getAddressContactLastName(), creditCard.getAddressContactNickname(), cartCode, creditCard.getProviderType());
        }
    }
