...
public final class a {
    ...
    private static Function2<Composer, Integer, Unit> f95009b = ComposableLambdaKt.composableLambdaInstance(-1167526948, false, C1347a.f95010a);

    @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
    /* renamed from: com.meijer.mobile.accounts.ux.unauthenticated.a$a, reason: collision with other inner class name */
    static final class C1347a implements Function2<Composer, Integer, Unit> {

        /* renamed from: a, reason: collision with root package name */
        public static final C1347a f95010a = new C1347a();
