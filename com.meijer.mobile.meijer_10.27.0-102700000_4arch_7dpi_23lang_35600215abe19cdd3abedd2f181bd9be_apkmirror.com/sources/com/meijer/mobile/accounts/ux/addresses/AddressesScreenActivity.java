...
public final class AddressesScreenActivity extends Hilt_AddressesScreenActivity {
    ...
    static final class a implements Function2<Composer, Integer, Unit> {
        ...
        static final class C1317a implements Function3<LocalThemeScope, Composer, Integer, Unit> {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ AddressesScreenActivity f94050a;
            ...
            /* synthetic */ class C1318a extends FunctionReferenceImpl implements Function1<com.meijer.mobile.accounts.ux.addresses.a, Unit> {
                C1318a(Object obj) {
            ...
            C1317a(AddressesScreenActivity addressesScreenActivity) {
                this.f94050a = addressesScreenActivity;
            }

            /* JADX INFO: Access modifiers changed from: private */
            public static final Unit d(AddressesScreenActivity addressesScreenActivity, Fh.a accountNavigationRequest) {
            ...
            public final void b(LocalThemeScope AdsTheme, Composer composer, int i10) {
                ...
                if (ComposerKt.M()) {
                    ComposerKt.U(1476577067, i10, -1, "com.meijer.mobile.accounts.ux.addresses.AddressesScreenActivity.onCreate.<anonymous>.<anonymous> (AddressesScreenActivity.kt:29)");
                }
                ...
                c0 c0VarB = W2.d.b(i.class, h0VarC, null, cVarA, h0VarC instanceof InterfaceC6020j ? ((InterfaceC6020j) h0VarC).getDefaultViewModelCreationExtras() : CreationExtras.b.f36770c, composer, 36936, 0);
                composer.U();
                composer.U();
                i iVar = (i) c0VarB;
                i.AddressesScreenViewState addressesScreenViewStateC = c(o1.b(iVar.F(), null, composer, 0, 1));
                composer.startReplaceGroup(5004770);
                boolean zD = composer.D(iVar);
                Object objB = composer.B();
                if (zD || objB == Composer.INSTANCE.a()) {
                    objB = new C1318a(iVar);
                    composer.t(objB);
                }
                composer.P();
                Function1 function1 = (Function1) ((KFunction) objB);
                composer.startReplaceGroup(5004770);
                boolean zD2 = composer.D(this.f94050a);
                final AddressesScreenActivity addressesScreenActivity = this.f94050a;
                Object objB2 = composer.B();
                if (zD2 || objB2 == Composer.INSTANCE.a()) {
                    objB2 = new Function1() { // from class: com.meijer.mobile.accounts.ux.addresses.b
                        @Override // kotlin.jvm.functions.Function1
                        public final Object invoke(Object obj) {
                            return AddressesScreenActivity.a.C1317a.d(addressesScreenActivity, (Fh.a) obj);
                        }
                    };
                    composer.t(objB2);
                }
                composer.P();
                G.b(AdsTheme, addressesScreenViewStateC, null, function1, (Function1) objB2, composer, LocalThemeScope.f15770g | (i10 & 14), 2);
                if (ComposerKt.M()) {
                    ComposerKt.T();
                }
            }
        ...
        public final void a(Composer composer, int i10) {
            ...
            if (ComposerKt.M()) {
                ComposerKt.U(1441745818, i10, -1, "com.meijer.mobile.accounts.ux.addresses.AddressesScreenActivity.onCreate.<anonymous> (AddressesScreenActivity.kt:28)");
            }
            K.b(null, ComposableLambdaKt.c(1476577067, true, new C1317a(AddressesScreenActivity.this), composer, 54), composer, 48, 1);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        C13589e.b(this, null, ComposableLambdaKt.composableLambdaInstance(1441745818, true, new a()), 1, null);
    }
}
