...
public class DataBinderMapperImpl extends e {
    ...
    private static final SparseIntArray f119106a;

    @Override // androidx.databinding.e
    public p c(f fVar, View[] viewArr, int i10) {
        if (viewArr == null || viewArr.length == 0 || f119106a.get(i10) <= 0 || viewArr[0].getTag() != null) {
            return null;
        }
    ...
    static {
        ...
        f119106a = sparseIntArray;
        sparseIntArray.put(Nr.e.f22676a, 1);
        sparseIntArray.put(Nr.e.f22677b, 2);
        sparseIntArray.put(Nr.e.f22678c, 3);
        sparseIntArray.put(Nr.e.f22679d, 4);
        sparseIntArray.put(Nr.e.f22680e, 5);
    }
