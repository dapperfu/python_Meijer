...
public final class RateAppDialogFragment extends MeijerDialogFragment {
    ...
    public static final int f119091c = 8;
    ...
    public static final void F0(RateAppDialogFragment rateAppDialogFragment, DialogInterface dialogInterface, int i10) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        c cVarCreate = new c.a(requireActivity(), p.f3061e).setTitle(Q.f170971N).setMessage(Q.f170968K).setPositiveButton(Q.f170975R, new DialogInterface.OnClickListener() { // from class: Lr.a
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i10) {
                RateAppDialogFragment.F0(this.f18692a, dialogInterface, i10);
            }
        }).setNegativeButton(Q.f170974Q, new DialogInterface.OnClickListener() { // from class: Lr.b
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i10) {
                RateAppDialogFragment.H0(this.f18693a, dialogInterface, i10);
            }
        }).setNeutralButton(Q.f170976S, new DialogInterface.OnClickListener() { // from class: Lr.c
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i10) {
                RateAppDialogFragment.J0(this.f18694a, dialogInterface, i10);
            }
        }).create();
