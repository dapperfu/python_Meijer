...
@Metadata(d1 = {"\u0000B\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0007\u0018\u00002\u00020\u00012\u00020\u0002B\u0007¢\u0006\u0004\b\u0003\u0010\u0004J\u0019\u0010\b\u001a\u00020\u00072\b\u0010\u0006\u001a\u0004\u0018\u00010\u0005H\u0014¢\u0006\u0004\b\b\u0010\tR\u0016\u0010\r\u001a\u00020\n8\u0002@\u0002X\u0082.¢\u0006\u0006\n\u0004\b\u000b\u0010\fR\u001a\u0010\u0012\u001a\b\u0012\u0004\u0012\u00020\u000f0\u000e8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0010\u0010\u0011R\u001b\u0010\u0018\u001a\u00020\u00138VX\u0096\u0084\u0002¢\u0006\f\n\u0004\b\u0014\u0010\u0015\u001a\u0004\b\u0016\u0010\u0017R\u001b\u0010\u001d\u001a\u00020\u00198BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u001a\u0010\u0015\u001a\u0004\b\u001b\u0010\u001c¨\u0006\u001e"}, d2 = {"Lcom/meijer/mobile/core/design/ThemeCatalogActivity;", "Landroidx/appcompat/app/AppCompatActivity;", "LAj/b;", "<init>", "()V", "Landroid/os/Bundle;", "savedInstanceState", "", "onCreate", "(Landroid/os/Bundle;)V", "LNj/a;", "r", "LNj/a;", "binding", "Lnu/d;", "Lnu/g;", "s", "Lnu/d;", "pagerAdapter", "Lcom/google/android/material/appbar/MaterialToolbar;", "t", "Lkotlin/Lazy;", "x1", "()Lcom/google/android/material/appbar/MaterialToolbar;", "toolbar", "Lce/a;", "u", "w1", "()Lce/a;", "closeBadge", "design_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public final class ThemeCatalogActivity extends AppCompatActivity implements b {
    ...
    private final C15949d<g> pagerAdapter = new C15949d<>();

    /* renamed from: t, reason: collision with root package name and from kotlin metadata */
    private final Lazy toolbar = LazyKt.b(new Function0() { // from class: Bj.v
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            return ThemeCatalogActivity.B1(this.f3133a);
        }
    });

    /* renamed from: u, reason: collision with root package name and from kotlin metadata */
    private final Lazy closeBadge = LazyKt.b(new Function0() { // from class: Bj.w
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            return ThemeCatalogActivity.v1(this.f3134a);
        }
    });
    ...
    public static final MaterialToolbar B1(ThemeCatalogActivity themeCatalogActivity) {
        return (MaterialToolbar) themeCatalogActivity.findViewById(k.f2885i1);
    }

    private final C6386a w1() {
        return (C6386a) this.closeBadge.getValue();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final C6386a v1(ThemeCatalogActivity themeCatalogActivity) {
        return C6386a.e(themeCatalogActivity);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.O0(this, 0, 0, new Function0() { // from class: Bj.s
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return ThemeCatalogActivity.y1(this.f3131a);
            }
        }, 3, null);
        v().setOnMenuItemClickListener(new Toolbar.h() { // from class: Bj.t
            @Override // androidx.appcompat.widget.Toolbar.h
            public final boolean onMenuItemClick(MenuItem menuItem) {
                return ThemeCatalogActivity.z1(this.f3132a, menuItem);
            }
        });
        this.pagerAdapter.c(new J());
        this.pagerAdapter.c(new Cj.k());
        ...
        aVar2.f22073d.setAdapter(this.pagerAdapter);
        a aVar3 = this.binding;
        if (aVar3 == null) {
            Intrinsics.y("binding");
            aVar3 = null;
        }
        TabLayout tabLayout = aVar3.f22071b;
        ...
        new d(tabLayout, aVar.f22073d, new d.b() { // from class: Bj.u
