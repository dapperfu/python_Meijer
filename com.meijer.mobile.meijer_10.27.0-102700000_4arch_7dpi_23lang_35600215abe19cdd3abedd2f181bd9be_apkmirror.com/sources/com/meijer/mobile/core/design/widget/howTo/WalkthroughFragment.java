...
public final class WalkthroughFragment extends Fragment {
    ...
    public static final int f96067d = 8;
    ...
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\bf\u0018\u00002\u00020\u0001J\u0017\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H&¢\u0006\u0004\b\u0005\u0010\u0006J\u0017\u0010\t\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u0007H&¢\u0006\u0004\b\t\u0010\nø\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001¨\u0006\u000bÀ\u0006\u0001"}, d2 = {"Lcom/meijer/mobile/core/design/widget/howTo/WalkthroughFragment$a;", "", "", "url", "", "i0", "(Ljava/lang/String;)V", "Landroid/widget/TextView;", "textView", "G", "(Landroid/widget/TextView;)V", "design_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public interface a {
    ...
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0017\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0007¢\u0006\u0004\b\u0007\u0010\b¨\u0006\t"}, d2 = {"Lcom/meijer/mobile/core/design/widget/howTo/WalkthroughFragment$b;", "", "<init>", "()V", "LUj/e;", "walkthroughPage", "Lcom/meijer/mobile/core/design/widget/howTo/WalkthroughFragment;", "a", "(LUj/e;)Lcom/meijer/mobile/core/design/widget/howTo/WalkthroughFragment;", "design_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        q qVarK0 = q.K0(inflater, container, false);
        this.binding = qVarK0;
        q qVar = null;
        if (qVarK0 == null) {
        ...
        TextView textView = qVar2.f22162D;
        ...
        TextView textView2 = qVar3.f22159A;
        ...
        if (walkthroughPage4.getLearnMoreLink() != 0) {
            ...
            qVar4.f22161C.setVisibility(0);
            q qVar5 = this.binding;
            if (qVar5 == null) {
                Intrinsics.y("binding");
                qVar5 = null;
            }
            qVar5.f22161C.setOnClickListener(new View.OnClickListener() { // from class: Uj.d
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    WalkthroughFragment.s0(this.f36091a, view);
                }
            });
        }
        ...
        if (walkthroughPage5.getHasLinkifiedDesc()) {
            ...
            if (aVar != null) {
                ...
                TextView walkthroughDescr = qVar6.f22159A;
                Intrinsics.i(walkthroughDescr, "walkthroughDescr");
                aVar.G(walkthroughDescr);
            }
        }
    ...
    public static final void s0(WalkthroughFragment walkthroughFragment, View view) {
        a aVar;
        i parentFragment = walkthroughFragment.getParentFragment();
