...
public final class StepperView extends ConstraintLayout implements n {
    ...
    private final class a implements Runnable {
        ...
        public void run() {
            ...
            Wj.a actionListener = StepperView.this.getActionListener();
    ...
    public StepperView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, f.f2612k);
    ...
    private final void H(int defStyleRes) {
        LayoutInflater.from(new ContextThemeWrapper(getContext(), defStyleRes)).inflate(m.f2930B, this);
        this.progressTextView = (TextView) findViewById(k.f2814D0);
        this.updateLoadingView = findViewById(k.f2902o0);
        this.addButton = (MaterialButton) findViewById(k.f2865c);
        ...
        materialButton.setOnClickListener(new View.OnClickListener() { // from class: Wj.p
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                StepperView.I(this.f38687a, view2);
            }
        });
        ...
        view2.setOnClickListener(new View.OnClickListener() { // from class: Wj.q
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                StepperView.J(this.f38688a, view3);
            }
        });
        ...
        imageButton.setOnClickListener(new View.OnClickListener() { // from class: Wj.r
            @Override // android.view.View.OnClickListener
            public final void onClick(View view3) {
                StepperView.K(this.f38689a, view3);
            }
        });
        ...
        view.setOnClickListener(new View.OnClickListener() { // from class: Wj.s
            @Override // android.view.View.OnClickListener
            public final void onClick(View view4) {
                StepperView.L(this.f38690a, view4);
            }
        });
    }
    ...
    public void f() {
        ...
        if (StringsKt.a0(getValueState().getUnitOfMeasure(), "pound", true)) {
            ...
            textView2.setText(getResources().getString(o.f3042s0));
        }
        super.f();
    }
    ...
    public StepperView(Context context, AttributeSet attributeSet, int i10) {
        this(context, attributeSet, i10, p.f3073q);
        Intrinsics.j(context, "context");
    }
    ...
    private final void M(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        setLoadingText(typedArrayObtainStyledAttributes.getString(q.f3106b0));
        setAddButtonText(typedArrayObtainStyledAttributes.getString(q.f3104a0));
        typedArrayObtainStyledAttributes.recycle();
        G();
    }
    ...
    private final void N() {
        ...
        if (handler != null) {
            ...
            handler.postDelayed(this.debounceRunnable, Wj.o.a());
        }
    }
