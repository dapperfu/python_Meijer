...
public final class CheckableImageButton extends AppCompatImageButton implements Checkable {
    ...
    public static final int f96010m = 8;

    /* renamed from: n, reason: collision with root package name */
    private static final int[] f96011n = {R.attr.state_checked};
    ...
    public static final class a extends androidx.core.view.a {
        ...
        public void g(View host, y info) {
            ...
            if (charSequenceC == null || StringsKt.r0(charSequenceC)) {
    ...
    public static final class d extends AbstractC17751a {

        /* renamed from: c, reason: collision with root package name and from kotlin metadata */
        private boolean checked;

        /* renamed from: e, reason: collision with root package name */
        public static final int f96022e = 8;
    ...
    public static final class e implements c {
        ...
        final /* synthetic */ Function2<CheckableImageButton, Boolean, Unit> f96024a;

        /* JADX WARN: Multi-variable type inference failed */
        e(Function2<? super CheckableImageButton, ? super Boolean, Unit> function2) {
            this.f96024a = function2;
        }
        ...
        public void a(CheckableImageButton buttonView, boolean isChecked) {
            ...
            this.f96024a.invoke(buttonView, Boolean.valueOf(isChecked));
        }
    }
    ...
    public /* synthetic */ CheckableImageButton(Context context, AttributeSet attributeSet, int i10, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i11 & 2) != 0 ? null : attributeSet, (i11 & 4) != 0 ? f.f2603b : i10);
    }

    private final void a(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        int[] CheckableImageButton = q.f3110f;
        ...
        setChecked(typedArrayObtainStyledAttributes.getBoolean(q.f3112h, false));
        this.checkedFromResource = true;
        setEnabled(typedArrayObtainStyledAttributes.getBoolean(q.f3111g, true));
        this._textOn = typedArrayObtainStyledAttributes.getText(q.f3113i);
        this._textOff = typedArrayObtainStyledAttributes.getText(q.f3114j);
    ...
    public void setChecked(boolean checked) {
        if (this._isChecked != checked) {
            ...
            if (Build.VERSION.SDK_INT >= 26) {
                ...
                AutofillManager autofillManagerA = C5047b.a(b.j(context, C5046a.a()));
    ...
    public CheckableImageButton(Context context, AttributeSet attributeSet, int i10) {
        this(context, attributeSet, i10, p.f3070n);
        Intrinsics.j(context, "context");
    }
