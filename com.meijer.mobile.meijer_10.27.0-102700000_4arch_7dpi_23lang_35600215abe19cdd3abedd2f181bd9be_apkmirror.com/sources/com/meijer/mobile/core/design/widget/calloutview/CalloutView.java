...
public final class CalloutView extends MaterialCardView {
    ...
    public final void setBody(CharSequence charSequence) {
        ...
        materialTextView2.setVisibility(charSequence == null || StringsKt.r0(charSequence) ? 8 : 0);
    }
    ...
    private final void k(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        c.d(this, m.f2951u, true);
        this.titleTextView = (MaterialTextView) findViewById(k.f2895m);
        this.bodyTextView = (MaterialTextView) findViewById(k.f2889k);
        this.iconView = (ImageView) findViewById(k.f2892l);
        Context context = getContext();
        Intrinsics.i(context, "getContext(...)");
        int[] CalloutView = q.f3103a;
        ...
        setTitle(typedArrayObtainStyledAttributes.getString(q.f3109e));
        setBody(typedArrayObtainStyledAttributes.getString(q.f3105b));
        setIcon(__fsTypeCheck_7aed730c0cb897b271b15a3fca45c160(typedArrayObtainStyledAttributes, q.f3107c));
        setIconContentDescription(typedArrayObtainStyledAttributes.getString(q.f3108d));
