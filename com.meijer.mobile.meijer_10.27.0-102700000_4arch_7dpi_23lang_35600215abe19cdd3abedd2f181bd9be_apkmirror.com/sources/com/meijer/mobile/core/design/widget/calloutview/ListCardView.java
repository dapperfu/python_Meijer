...
public final class ListCardView extends MaterialCardView {
    ...
    public final void setSubtitle(CharSequence charSequence) {
        ...
        getSubtitleTextView().setVisibility(charSequence == null || StringsKt.r0(charSequence) ? 8 : 0);
    }
    ...
    public ListCardView(Context context, AttributeSet attrs) {
        ...
        this.titleTextView = LazyKt.b(new Function0() { // from class: Rj.a
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return ListCardView.w(this.f32254a);
            }
        });
        this.subtitleTextView = LazyKt.b(new Function0() { // from class: Rj.b
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return ListCardView.v(this.f32255a);
            }
        });
        this.iconView = LazyKt.b(new Function0() { // from class: Rj.c
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return ListCardView.r(this.f32256a);
            }
        });
        this.contentView = LazyKt.b(new Function0() { // from class: Rj.d
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return ListCardView.q(this.f32257a);
            }
        });
        this.actionButton = LazyKt.b(new Function0() { // from class: Rj.e
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return ListCardView.p(this.f32258a);
            }
        });
        this.internalIds = CollectionsKt.p(Integer.valueOf(k.f2898n), Integer.valueOf(k.f2887j0), Integer.valueOf(k.f2884i0), Integer.valueOf(k.f2881h0), Integer.valueOf(k.f2875f0), Integer.valueOf(k.f2878g0));
        t(this, attrs, 0, 0, 4, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final MaterialButton p(ListCardView listCardView) {
        return (MaterialButton) listCardView.findViewById(k.f2875f0);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final FrameLayout q(ListCardView listCardView) {
        return (FrameLayout) listCardView.findViewById(k.f2878g0);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final ImageView r(ListCardView listCardView) {
        return (ImageView) listCardView.findViewById(k.f2881h0);
    }

    private final void s(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        c.d(this, m.f2929A, true);
        Context context = getContext();
        Intrinsics.i(context, "getContext(...)");
        int[] ListCardView = q.f3129y;
        ...
        setCardElevation(typedArrayObtainStyledAttributes.getDimension(q.f3080D, 0.0f));
        setRadius(typedArrayObtainStyledAttributes.getDimension(q.f3079C, 0.0f));
        setTitle(typedArrayObtainStyledAttributes.getString(q.f3086J));
        setSubtitle(typedArrayObtainStyledAttributes.getString(q.f3085I));
        setIcon(__fsTypeCheck_7aed730c0cb897b271b15a3fca45c160(typedArrayObtainStyledAttributes, q.f3081E));
        setIconContentDescription(typedArrayObtainStyledAttributes.getString(q.f3082F));
        getActionButton().setText(typedArrayObtainStyledAttributes.getString(q.f3078B));
        if (typedArrayObtainStyledAttributes.getBoolean(q.f3084H, true)) {
            int i10 = q.f3083G;
            Context context2 = getContext();
            Intrinsics.i(context2, "getContext(...)");
            setIconTint(Integer.valueOf(typedArrayObtainStyledAttributes.getColor(i10, r.b(context2, C5597b.f44537q, null, false, 6, null))));
        } else {
            setIconTint(null);
        }
        setTitleTextStyle(typedArrayObtainStyledAttributes.getResourceId(q.f3087K, p.f3076t));
        u(__fsTypeCheck_7aed730c0cb897b271b15a3fca45c160(typedArrayObtainStyledAttributes, q.f3077A), typedArrayObtainStyledAttributes.getString(q.f3130z));
    ...
    public static final MaterialTextView v(ListCardView listCardView) {
        return (MaterialTextView) listCardView.findViewById(k.f2884i0);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final MaterialTextView w(ListCardView listCardView) {
        return (MaterialTextView) listCardView.findViewById(k.f2887j0);
    }
    ...
    private final void u(Drawable actionButtonIcon, String actionButtonContentDescription) {
        ...
        Context context = getContext();
        Intrinsics.i(context, "getContext(...)");
        actionButton.setIconTint(ColorStateList.valueOf(r.b(context, C5597b.f44537q, null, false, 6, null)));
