...
public class DataBinderMapperImpl extends e {
    ...
    private static final SparseIntArray f95989a;

    @Override // androidx.databinding.e
    public p c(f fVar, View[] viewArr, int i10) {
        if (viewArr == null || viewArr.length == 0 || f95989a.get(i10) <= 0 || viewArr[0].getTag() != null) {
            return null;
        }
    ...
    static {
        ...
        f95989a = sparseIntArray;
        sparseIntArray.put(m.f2948r, 1);
        sparseIntArray.put(m.f2950t, 2);
        sparseIntArray.put(m.f2956z, 3);
    }
