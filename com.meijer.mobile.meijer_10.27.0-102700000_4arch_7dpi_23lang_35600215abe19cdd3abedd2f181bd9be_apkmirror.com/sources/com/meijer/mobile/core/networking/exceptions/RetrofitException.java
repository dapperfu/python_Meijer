...
@Metadata(d1 = {"\u0000L\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0010\b\n\u0002\b\u000e\b\u0016\u0018\u0000 #2\u00060\u0001j\u0002`\u0002:\u0002$!BG\b\u0016\u0012\b\u0010\u0004\u001a\u0004\u0018\u00010\u0003\u0012\b\u0010\u0005\u001a\u0004\u0018\u00010\u0003\u0012\f\u0010\u0007\u001a\b\u0012\u0002\b\u0003\u0018\u00010\u0006\u0012\u0006\u0010\t\u001a\u00020\b\u0012\b\u0010\u000b\u001a\u0004\u0018\u00010\n\u0012\b\u0010\r\u001a\u0004\u0018\u00010\f¢\u0006\u0004\b\u000e\u0010\u000fB\u001b\b\u0016\u0012\u0006\u0010\u0010\u001a\u00020\b\u0012\b\u0010\u0011\u001a\u0004\u0018\u00010\n¢\u0006\u0004\b\u000e\u0010\u0012J\u0017\u0010\u0015\u001a\u00020\u00032\u0006\u0010\u0014\u001a\u00020\u0013H\u0016¢\u0006\u0004\b\u0015\u0010\u0016J\u001a\u0010\u001a\u001a\u00020\u00192\b\u0010\u0018\u001a\u0004\u0018\u00010\u0017H\u0096\u0002¢\u0006\u0004\b\u001a\u0010\u001bJ\u000f\u0010\u001c\u001a\u00020\u0003H\u0016¢\u0006\u0004\b\u001c\u0010\u001dJ\u000f\u0010\u001f\u001a\u00020\u001eH\u0016¢\u0006\u0004\b\u001f\u0010 R\u0019\u0010\u0005\u001a\u0004\u0018\u00010\u00038\u0006¢\u0006\f\n\u0004\b!\u0010\"\u001a\u0004\b#\u0010\u001dR\u001d\u0010\u0007\u001a\b\u0012\u0002\b\u0003\u0018\u00010\u00068\u0006¢\u0006\f\n\u0004\b$\u0010%\u001a\u0004\b&\u0010'R\u0017\u0010\t\u001a\u00020\b8\u0006¢\u0006\f\n\u0004\b\u0015\u0010(\u001a\u0004\b$\u0010)R\u0019\u0010\r\u001a\u0004\u0018\u00010\f8\u0006¢\u0006\f\n\u0004\b&\u0010*\u001a\u0004\b!\u0010+¨\u0006,"}, d2 = {"Lcom/meijer/mobile/core/networking/exceptions/RetrofitException;", "Ljava/lang/RuntimeException;", "Lkotlin/RuntimeException;", "", "message", "url", "Lretrofit2/Response;", "response", "Lcom/meijer/mobile/core/networking/exceptions/RetrofitException$b;", "exceptionKind", "", "exception", "Lrk/b;", "errorType", "<init>", "(Ljava/lang/String;Ljava/lang/String;Lretrofit2/Response;Lcom/meijer/mobile/core/networking/exceptions/RetrofitException$b;Ljava/lang/Throwable;Lrk/b;)V", "kind", "throwable", "(Lcom/meijer/mobile/core/networking/exceptions/RetrofitException$b;Ljava/lang/Throwable;)V", "Landroid/content/Context;", "context", "c", "(Landroid/content/Context;)Ljava/lang/String;", "", "other", "", "equals", "(Ljava/lang/Object;)Z", "toString", "()Ljava/lang/String;", "", "hashCode", "()I", "a", "Ljava/lang/String;", "e", "b", "Lretrofit2/Response;", "d", "()Lretrofit2/Response;", "Lcom/meijer/mobile/core/networking/exceptions/RetrofitException$b;", "()Lcom/meijer/mobile/core/networking/exceptions/RetrofitException$b;", "Lrk/b;", "()Lrk/b;", "networking_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public class RetrofitException extends RuntimeException {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        @JvmOverloads
        public final RetrofitException d(rk.b bVar) {
        ...
        public static /* synthetic */ RetrofitException f(Companion companion, rk.b bVar, Throwable th2, int i10, Object obj) {
            if ((i10 & 2) != 0) {
                th2 = null;
            }
        ...
        public final RetrofitException a(UserNotAuthenticatedException exception) {
            ...
            return new RetrofitException(exception.getMessage(), null, null, b.f96148h, exception, null);
        }
        ...
        public final RetrofitException b(HttpException httpException) {
            ...
            return new RetrofitException(strMessage, response != null ? response.raw().getRequest().getUrl().getUrl() : "", response, b.f96143c, httpException, null);
        }

        public final RetrofitException c(IOException exception) {
            Intrinsics.j(exception, "exception");
            return new RetrofitException(exception.getMessage(), null, null, b.f96142b, exception, null);
        }

        @JvmStatic
        @JvmOverloads
        public final RetrofitException e(rk.b errorType, Throwable cause) {
            return new RetrofitException(null, null, null, b.f96144d, cause, errorType);
        }

        public final RetrofitException g(Throwable exception) {
            Intrinsics.j(exception, "exception");
            return new RetrofitException(exception.getMessage(), null, null, b.f96149i, exception, null);
        }
    }
    ...
    public static final class b {
        ...
        public static final b f96142b = new b("NETWORK", 0, f.f155801o);

        /* renamed from: c, reason: collision with root package name */
        public static final b f96143c = new b("HTTP", 1, 0);

        /* renamed from: d, reason: collision with root package name */
        public static final b f96144d = new b("SERVER", 2, 0);

        /* renamed from: e, reason: collision with root package name */
        public static final b f96145e = new b("CONNECT_EXCEPTION", 3, f.f155805s);

        /* renamed from: f, reason: collision with root package name */
        public static final b f96146f = new b("AMBIGUOUS_CASE_UNKNOWN_HOST_EXCEPTION", 4, f.f155789c);

        /* renamed from: g, reason: collision with root package name */
        public static final b f96147g = new b("REQUEST_TIMED_OUT", 5, f.f155806t);

        /* renamed from: h, reason: collision with root package name */
        public static final b f96148h = new b("UNAUTHENTICATED", 6, f.f155792f);

        /* renamed from: i, reason: collision with root package name */
        public static final b f96149i = new b("UNEXPECTED", 7, f.f155808v);

        /* renamed from: j, reason: collision with root package name */
        private static final /* synthetic */ b[] f96150j;

        /* renamed from: k, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f96151k;

        /* renamed from: a, reason: collision with root package name and from kotlin metadata */
        private final int messageResourceId;

        private static final /* synthetic */ b[] a() {
            return new b[]{f96142b, f96143c, f96144d, f96145e, f96146f, f96147g, f96148h, f96149i};
        }

        static {
            b[] bVarArrA = a();
            f96150j = bVarArrA;
            f96151k = EnumEntriesKt.a(bVarArrA);
        }
    ...
    public RetrofitException(String str, String str2, Response<?> response, b exceptionKind, Throwable th2, rk.b bVar) {
        super(str, th2);
    ...
    @JvmStatic
    @JvmOverloads
    public static final RetrofitException f(rk.b bVar) {
        return INSTANCE.d(bVar);
    }

    @JvmStatic
    @JvmOverloads
    public static final RetrofitException g(rk.b bVar, Throwable th2) {
        return INSTANCE.e(bVar, th2);
    }

    /* renamed from: a, reason: from getter */
    public final rk.b getErrorType() {
    ...
    */
    public boolean equals(java.lang.Object r5) {
        ...
        La:
            ...
            rk.b r2 = r5.errorType
            if (r2 != 0) goto L18
            rk.b r2 = r4.errorType
            if (r2 != 0) goto L16
            r2 = r0
            goto L1e
        L16:
