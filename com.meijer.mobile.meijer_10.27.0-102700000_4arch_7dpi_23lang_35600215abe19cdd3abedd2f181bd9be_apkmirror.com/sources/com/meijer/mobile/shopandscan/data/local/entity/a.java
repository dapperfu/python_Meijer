...
public final class a {
    ...
    public /* synthetic */ class C1890a {
        ...
        static {
            ...
            try {
                iArr[ShopAndScanItemEntity.Barcode.a.f116815a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[ShopAndScanItemEntity.Barcode.a.f116816b.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[ShopAndScanItemEntity.Barcode.a.f116817c.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[ShopAndScanItemEntity.Barcode.a.f116818d.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                iArr[ShopAndScanItemEntity.Barcode.a.f116819e.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                iArr[ShopAndScanItemEntity.Barcode.a.f116820f.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                iArr[ShopAndScanItemEntity.Barcode.a.f116821g.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                iArr[ShopAndScanItemEntity.Barcode.a.f116822h.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                iArr[ShopAndScanItemEntity.Barcode.a.f116823i.ordinal()] = 9;
    ...
    public static final ShopAndScanItemEntity a(String tripId, Xp.a barcode, int i10) {
        ...
        ShopAndScanItemEntity.h hVar = ShopAndScanItemEntity.h.f116843a;
        ShopAndScanItemEntity.a aVar = ShopAndScanItemEntity.a.f116810d;
        String string = UUID.randomUUID().toString();
        Intrinsics.i(string, "toString(...)");
        ShopAndScanItemEntity.Barcode barcode2 = new ShopAndScanItemEntity.Barcode(barcode.getData(), C17846a.a(barcode));
    ...
    private static final ShopAndScanItem.a b(ShopAndScanItemEntity.a aVar) {
        int i10 = C1890a.$EnumSwitchMapping$2[aVar.ordinal()];
        if (i10 == 1) {
            return ShopAndScanItem.a.f39558a;
        }
        if (i10 == 2) {
            return ShopAndScanItem.a.f39559b;
        }
        if (i10 == 3) {
            return ShopAndScanItem.a.f39560c;
        }
        if (i10 == 4) {
            return ShopAndScanItem.a.f39561d;
        }
    ...
    private static final ShopAndScanItem.f i(ShopAndScanItemEntity.h hVar) {
        int i10 = C1890a.$EnumSwitchMapping$1[hVar.ordinal()];
        if (i10 == 1) {
            return ShopAndScanItem.f.f39576a;
        }
        if (i10 == 2) {
            return ShopAndScanItem.f.f39577b;
        }
        if (i10 == 3) {
            return ShopAndScanItem.f.f39578c;
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    private static final Xp.a c(ShopAndScanItemEntity.Barcode barcode) {
        switch (C1890a.$EnumSwitchMapping$0[barcode.getType().ordinal()]) {
            case 1:
