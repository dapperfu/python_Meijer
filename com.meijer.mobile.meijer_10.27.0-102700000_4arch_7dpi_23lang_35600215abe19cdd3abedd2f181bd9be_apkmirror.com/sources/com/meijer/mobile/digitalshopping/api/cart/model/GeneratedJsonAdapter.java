...
public final class GeneratedJsonAdapter extends h<AvailablePartnerStoreLocationOmsResponse> {
    ...
    public AvailablePartnerStoreLocationOmsResponse fromJson(k reader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        while (reader.hasNext()) {
            ...
            if (iZ == -1) {
                ...
                if (boolFromJson == null) {
                    throw c.w("addressAllowsAlcohol", "addressAllowsAlcohol", reader);
                }
                i10 &= -3;
            } else if (iZ == 2) {
                strFromJson = this.stringAdapter.fromJson(reader);
                if (strFromJson == null) {
                    throw c.w("partnerEligibility", "partnerEligibility", reader);
                }
                i10 &= -5;
            } else if (iZ == 3) {
        ...
        if (declaredConstructor == null) {
            declaredConstructor = AvailablePartnerStoreLocationOmsResponse.class.getDeclaredConstructor(Facility.class, Boolean.TYPE, String.class, List.class, Integer.TYPE, c.f134099c);
