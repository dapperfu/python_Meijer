...
public final class GeneratedJsonAdapter extends h<HybrisPickupSlotInfo> {
    ...
    public HybrisPickupSlotInfo fromJson(k reader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        while (reader.hasNext()) {
            ...
            switch (reader.z(this.options)) {
                ...
                case 0:
                    ...
                    if (strFromJson == null) {
                        throw c.w("activeSlotTransactionId", "activeSlotTransactionId", reader);
                    }
                    continue;
                case 1:
                    strFromJson2 = this.stringAdapter.fromJson(reader);
                    if (strFromJson2 == null) {
                        throw c.w("pickUpSlotId", "pickUpSlotId", reader);
                    }
                    break;
                case 2:
                ...
                case 6:
                    ...
                    if (boolFromJson == null) {
                        throw c.w("pickUpSlotIsAvailable", "pickUpSlotIsAvailable", reader);
                    }
                    break;
                case 7:
                    strFromJson7 = this.stringAdapter.fromJson(reader);
                    if (strFromJson7 == null) {
                        throw c.w("scheduleTypeId", "scheduleTypeId", reader);
                    }
                    break;
                case 8:
        ...
        if (i11 == -317) {
            if (str2 == null) {
                throw c.o("activeSlotTransactionId", "activeSlotTransactionId", reader);
            }
            if (strFromJson2 == null) {
                throw c.o("pickUpSlotId", "pickUpSlotId", reader);
            }
            if (boolFromJson == null) {
                throw c.o("pickUpSlotIsAvailable", "pickUpSlotIsAvailable", reader);
            }
            String str3 = strFromJson8;
            String str4 = strFromJson7;
            boolean zBooleanValue = boolFromJson.booleanValue();
            if (str4 == null) {
                throw c.o("scheduleTypeId", "scheduleTypeId", reader);
            }
        ...
        if (declaredConstructor == null) {
            i10 = i11;
            declaredConstructor = HybrisPickupSlotInfo.class.getDeclaredConstructor(String.class, String.class, String.class, String.class, String.class, String.class, Boolean.TYPE, String.class, String.class, Integer.TYPE, c.f134099c);
