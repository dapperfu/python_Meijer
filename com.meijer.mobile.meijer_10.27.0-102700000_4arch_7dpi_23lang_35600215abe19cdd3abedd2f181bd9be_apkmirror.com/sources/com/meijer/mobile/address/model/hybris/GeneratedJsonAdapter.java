...
public final class GeneratedJsonAdapter extends h<HybrisCustomerAddress> {
    ...
    public HybrisCustomerAddress fromJson(k reader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IOException, SecurityException, IllegalArgumentException, InvocationTargetException {
            ...
            switch (reader.z(this.options)) {
                ...
                case 10:
                    ...
                    if (strFromJson7 == null) {
                        throw c.w("postalCode", "postalCode", reader);
                    }
                    strFromJson = str;
                case 11:
                ...
                case 13:
                    ...
                    if (hybrisCountryFromJson == null) {
                        throw c.w(PlaceTypes.COUNTRY, PlaceTypes.COUNTRY, reader);
                    }
                    strFromJson = str;
                case 14:
                    boolFromJson = this.booleanAdapter.fromJson(reader);
                    if (boolFromJson == null) {
                        throw c.w("isShippingAddress", "shippingAddress", reader);
                    }
                    i12 &= -16385;
                    strFromJson = str;
                case 15:
                    ...
                    if (boolFromJson2 == null) {
                        throw c.w("isBillingAddress", "billingAddress", reader);
                    }
                    i11 = -32769;
                    i12 &= i11;
                    strFromJson = str;
                case 16:
                    ...
                    if (boolFromJson3 == null) {
                        throw c.w("isDefault", "defaultAddress", reader);
                    }
                    i11 = -65537;
                    i12 &= i11;
                    strFromJson = str;
                case 17:
                    ...
                    if (boolFromJson4 == null) {
                        throw c.w("isVisibleInAddressBook", "visibleInAddressBook", reader);
                    }
                    i11 = -131073;
                    i12 &= i11;
                    strFromJson = str;
        ...
        if (i12 == -252096) {
            if (strFromJson10 == null) {
                throw c.o("line1", "line1", reader);
            }
            if (strFromJson12 == null) {
                throw c.o("town", "town", reader);
            }
            if (hybrisRegionFromJson == null) {
                throw c.o("region", "region", reader);
            }
            if (strFromJson7 == null) {
                throw c.o("postalCode", "postalCode", reader);
            }
            if (hybrisCountryFromJson == null) {
                throw c.o(PlaceTypes.COUNTRY, PlaceTypes.COUNTRY, reader);
            }
