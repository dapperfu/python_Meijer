...
public final class SpannableTextView extends AppCompatTextView {
    ...
    public SpannableTextView(Context context, AttributeSet attributeSet) {
        ...
        int[] SpannableTextView = a0.f100954u;
        ...
        this.clickableText = typedArrayObtainStyledAttributes.getString(a0.f100955v);
        this.clickableTextTypeface = typedArrayObtainStyledAttributes.getInt(a0.f100956w, 0);
        this.underlineClickableText = typedArrayObtainStyledAttributes.getBoolean(a0.f100957x, true);
    ...
    private final void v(String msgText, int msgId, int clickableTextId) {
        ...
        if (str == null || StringsKt.r0(str) || msgText == null || StringsKt.r0(msgText)) {
            return;
        }
        ...
        int iP0 = StringsKt.p0(lowerCase, lowerCase2, 0, false, 6, null);
        if (iP0 < 0) {
            setText(msgText);
            return;
        }
        ...
        Intrinsics.g(str3);
        int length = str3.length() + iP0;
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(msgText);
        spannableStringBuilder.setSpan(new StyleSpan(this.textTypeface), 0, iP0 - 1, 33);
        spannableStringBuilder.setSpan(new StyleSpan(this.clickableTextTypeface), iP0, length, 33);
        spannableStringBuilder.setSpan(new c(), iP0, length, 33);
