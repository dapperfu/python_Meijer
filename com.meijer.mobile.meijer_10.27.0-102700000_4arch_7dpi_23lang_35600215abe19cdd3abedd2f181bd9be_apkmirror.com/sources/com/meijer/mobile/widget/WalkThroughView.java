...
public class WalkThroughView extends MeijerDialogFragment implements TabLayout.d {
    ...
    public static final int f119529o = 8;

    /* renamed from: p, reason: collision with root package name */
    @JvmField
    public static String f119530p = "com.meijer.mobile.widget.WalkThroughView";
    ...
    public static final class WalkThroughFragment extends Fragment {
        ...
        public static final int f119545f = 8;
        ...
        public static final class Companion {
            ...
            public final Bundle b(String title, String description, int imageResource) {
                Intrinsics.j(title, "title");
                Intrinsics.j(description, "description");
                return C14835c.b(TuplesKt.a("argument.walkthrough.title.id", title), TuplesKt.a("argument.walkthrough.descr.id", description), TuplesKt.a("argument.walkthrough.photo.id", Integer.valueOf(imageResource)));
            }
        }
        ...
        private final Nj.q r0() {
            Nj.q qVar = this._binding;
            Intrinsics.g(qVar);
            return qVar;
        }
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) throws Resources.NotFoundException {
            ...
            this._binding = Nj.q.K0(inflater, container, false);
            Resources resources = getResources();
            Intrinsics.i(resources, "getResources(...)");
            int dimensionPixelOffset = resources.getDimensionPixelOffset(Q.f98665k);
            r0().getRoot().setPadding(dimensionPixelOffset, resources.getDimensionPixelOffset(Q.f98666l), dimensionPixelOffset, resources.getDimensionPixelOffset(Q.f98664j));
            TextView textView = r0().f22162D;
            textView.setText(this.title);
            Intrinsics.g(textView);
            zj.c.a(textView, true);
            r0().f22159A.setText(this.description);
            FS.Resources_setImageResource(r0().f22160B, this.imageResource);
    ...
    private final void r1(View rootView) {
        ...
        rootView.setOnKeyListener(new View.OnKeyListener() { // from class: com.meijer.mobile.widget.w
            ...
            public final boolean onKey(View view, int i10, KeyEvent keyEvent) {
                return WalkThroughView.s1(this.f119599a, view, i10, keyEvent);
            }
        });
    }
    ...
    public static final void k1(WalkThroughView walkThroughView, b bVar, WalkThroughType type, boolean z10, boolean z11) {
        ...
        if (type.shouldMarkSeenOnComplete() && (!type.isRequired() || walkThroughView.isCompleted)) {
            C18264a appPrefManager = walkThroughView.getAppPrefManager();
            String strB = type.getTutorialEnum().b();
            Intrinsics.i(strB, "getValue(...)");
            appPrefManager.M(strB, true);
        }
        if (bVar != null) {
            bVar.s(type, walkThroughView.isCompleted, z11);
        }
    }
    ...
    private final void p1(View rootView) {
        rootView.setOnTouchListener(new View.OnTouchListener() { // from class: com.meijer.mobile.widget.v
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return WalkThroughView.q1(this.f119598a, view, motionEvent);
            }
        });
    }
    ...
    public final void K0() {
        ...
        if (this.onDismissWalkThroughListener != null) {
            ...
            bVar.s(walkThroughType, this.isCompleted, z10);
        }
        dismiss();
    }

    public final void L0(boolean isCompleted) {
        this.isCompleted = isCompleted;
        K0();
    }

    protected final Nj.w O0() {
        Nj.w wVar = this._binding;
        Intrinsics.g(wVar);
        return wVar;
    }
    ...
    protected void h1() throws Resources.NotFoundException {
        if (!this.canDismissEarly && !this.fromSectionWalkThrough && O0().f22203E.getCurrentItem() != Y0().d() - 1) {
            O0().f22203E.N(O0().f22203E.getCurrentItem() + 1, true);
        } else {
    ...
    public final void j1(final b listener) {
        this.onDismissWalkThroughListener = new b() { // from class: com.meijer.mobile.widget.t
            ...
            public final void s(WalkThroughType walkThroughType, boolean z10, boolean z11) {
                WalkThroughView.k1(this.f119595a, listener, walkThroughType, z10, z11);
            }
        };
    }
    ...
    protected void n1() throws Resources.NotFoundException {
        ...
        TabLayout tutorialPageIndicator = O0().f22202D;
    ...
    public void onAttach(Context context) {
        ...
        c.a aVarB = Ln.a.a().b(context);
        Context applicationContext = context.getApplicationContext();
        Intrinsics.i(applicationContext, "getApplicationContext(...)");
        aVarB.a((Ln.d) ru.d.a(applicationContext, Ln.d.class)).build().a(this);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) throws Resources.NotFoundException {
        Intrinsics.j(inflater, "inflater");
        this._binding = Nj.w.K0(inflater, container, false);
        O0().f22203E.setPageMargin(0);
        n1();
        O0().f22203E.c(new f());
        O0().f22202D.h(this);
        i1(0);
        ...
        o1();
        O0().f22201C.setNavigationOnClickListener(new View.OnClickListener() { // from class: com.meijer.mobile.widget.r
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                WalkThroughView.Z0(this.f119593a, view);
            }
        });
        O0().f22201C.setNavigationIcon(S.f98692H);
        O0().f22199A.setOnClickListener(new View.OnClickListener() { // from class: com.meijer.mobile.widget.s
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) throws Resources.NotFoundException {
                WalkThroughView.g1(this.f119594a, view);
            }
        });
        View root3 = O0().getRoot();
        Intrinsics.i(root3, "getRoot(...)");
        return root3;
    }

    private final d[] X0(int titleResourceId, int descrResourceId, int imageResourceId) throws Resources.NotFoundException {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void Z0(WalkThroughView walkThroughView, View view) {
        walkThroughView.K0();
    }
    ...
    private final void o1() {
        TabLayout.f fVarD;
        int tabCount = O0().f22202D.getTabCount();
        List<String> list = this.titlesForContentDesc;
        ...
        if (list != null) {
            ...
            for (Object obj : list2) {
                ...
                TabLayout.f fVarB = O0().f22202D.B(i10);
                if (fVarB != null) {
                    fVarD = bk.d.d(fVarB, AbstractC5607a.INSTANCE.d(Y.f99833Th, str, Integer.valueOf(i11), Integer.valueOf(tabCount)));
                } else {
                    fVarD = null;
                }
                arrayList.add(fVarD);
    ...
    protected void i1(int position) {
        int i10;
        O0().f22199A.setText(getResources().getString(Bj.o.f3055z));
        O0().f22199A.setTextColor(Z1.b.c(O0().f22199A.getContext(), com.meijer.mobile.meijer.P.f98654g));
        boolean z10 = true;
        int i11 = 0;
        if (position != Y0().d() - 1) {
            z10 = false;
