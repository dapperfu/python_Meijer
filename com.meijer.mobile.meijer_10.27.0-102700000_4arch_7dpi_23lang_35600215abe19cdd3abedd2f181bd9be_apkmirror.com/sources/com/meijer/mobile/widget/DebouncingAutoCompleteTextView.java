...
public class DebouncingAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    public static final class a extends TimerTask {
        ...
        final /* synthetic */ CharSequence f119498b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ int f119499c;

        a(CharSequence charSequence, int i10) {
            this.f119498b = charSequence;
            this.f119499c = i10;
        }

        @Override // java.util.TimerTask, java.lang.Runnable
        public void run() {
            DebouncingAutoCompleteTextView.super.performFiltering(this.f119498b, this.f119499c);
        }
    }
    ...
    public /* synthetic */ DebouncingAutoCompleteTextView(Context context, AttributeSet attributeSet, int i10, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i11 & 2) != 0 ? null : attributeSet, (i11 & 4) != 0 ? C5597b.f44509c : i10);
    }
    ...
    public DebouncingAutoCompleteTextView(Context context, AttributeSet attributeSet, int i10) {
        ...
        int[] DebouncingAutoCompleteTextView = a0.f100941h;
        ...
        this.suggestionDelayMillis = typedArrayObtainStyledAttributes.getInt(a0.f100942i, HttpResponseStatus.REDIRECTION_MULTIPLE_CHOICES);
