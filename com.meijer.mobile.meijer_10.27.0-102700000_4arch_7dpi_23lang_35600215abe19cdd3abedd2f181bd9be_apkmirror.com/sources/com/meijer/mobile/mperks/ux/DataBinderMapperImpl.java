...
public class DataBinderMapperImpl extends androidx.databinding.e {
    ...
    private static final SparseIntArray f113591a = new SparseIntArray(0);

    @Override // androidx.databinding.e
    public androidx.databinding.p c(androidx.databinding.f fVar, View[] viewArr, int i10) {
        if (viewArr == null || viewArr.length == 0 || f113591a.get(i10) <= 0 || viewArr[0].getTag() != null) {
            return null;
        }
    ...
    public androidx.databinding.p b(androidx.databinding.f fVar, View view, int i10) {
        if (f113591a.get(i10) <= 0 || view.getTag() != null) {
            return null;
        }
        throw new RuntimeException("view must have a tag");
    }
