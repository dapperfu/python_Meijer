...
public class z extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (extras == null) {
            Q5.t.a("Campaign", "LocalNotificationHandler", "Failed to load extras from local notification intent", new Object[0]);
            return;
        }
        ...
        if (i10 != 750183) {
            Q5.t.e("Campaign", "LocalNotificationHandler", "Request code does not match", new Object[0]);
            return;
        }
        if (string == null) {
            Q5.t.a("Campaign", "LocalNotificationHandler", "%s (local notification message)", "Unexpected Null Value");
            return;
        }
        ...
        try {
            ...
            if (activity == null) {
                Q5.t.a("Campaign", "LocalNotificationHandler", "Failed to retrieve sender from broadcast, unable to post notification", new Object[0]);
                return;
            }
            String strC = Q5.K.f().e().c();
            ...
            Q5.t.f("Campaign", "LocalNotificationHandler", "unexpected error posting notification (%s)", e10);
        }
    }
}
