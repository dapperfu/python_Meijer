...
public final class L {
    ...
    public static final class c implements C13850f.c<C6430l> {
        ...
        public boolean a(C6430l item) {
            Intrinsics.j(item, "item");
            if (J.INSTANCE.a(item) || item.b() != null) {
                try {
                    this.eventStitcher.a(item);
                } catch (Exception e10) {
                    Q5.t.a("Assurance", "InboundEventQueueWorker", "Error while processing inbound event", e10.getLocalizedMessage());
                }
                return true;
            }
            ...
            Q5.t.f("Assurance", "InboundEventQueueWorker", str, new Object[0]);
            return true;
        }
    }
    ...
    public L(final b listener) {
        this((C13850f<C6430l>) new C13850f("InboundEventQueueWorker", new c(new J(new InterfaceC6418a() { // from class: com.adobe.marketing.mobile.assurance.internal.K
            @Override // com.adobe.marketing.mobile.InterfaceC6418a
            public final void a(Object obj) {
                listener.a((C6430l) obj);
            }
        }))));
    ...
    public final boolean a(C6430l event) {
        ...
        if (this.workDispatcher.getState() != C13850f.b.SHUTDOWN) {
            return this.workDispatcher.o(event);
        }
        Q5.t.e("Assurance", "InboundEventQueueWorker", "Cannot queue event. Work dispatcher was shutdown.", new Object[0]);
        return false;
    }

    public final void b() {
        C13850f.b bVarK = this.workDispatcher.getState();
        if (bVarK == C13850f.b.NOT_STARTED) {
            this.workDispatcher.x();
            return;
        }
        Q5.t.e("Assurance", "InboundEventQueueWorker", "Work dispatcher was already started and is in " + bVarK + " state.", new Object[0]);
    }
    ...
    public L(C13850f<C6430l> workDispatcher) {
