...
public class v3 implements LifeCycle.h {
    ...
    private static final String f93167c = "Medallia Digital Notifications Tag";

    /* renamed from: d, reason: collision with root package name */
    public static final int f93168d = 1000;

    /* renamed from: e, reason: collision with root package name */
    private static v3 f93169e;

    /* renamed from: f, reason: collision with root package name */
    protected static String f93170f;

    /* renamed from: g, reason: collision with root package name */
    private static final BroadcastReceiver f93171g = new a();

    /* renamed from: a, reason: collision with root package name */
    private boolean f93172a;

    /* renamed from: b, reason: collision with root package name */
    private boolean f93173b;
    ...
    private static void c() {
        ...
        if (f93170f == null) {
            f93170f = "com.medallia.digital.mobilesdk.LocalNotificationDeclineBroadcastFilter" + packageName;
        }
        a4.b("delete LN filter: " + f93170f);
        i4.c().b().registerReceiver(f93171g, new IntentFilter(f93170f), 4);
    }
    ...
    void d() {
        try {
            i4.c().b().unregisterReceiver(f93171g);
        } catch (Exception e10) {
            a4.c(e10.getMessage());
        }
    ...
    public void onBackground() {
        a4.e("LocalNotificationService onBackground, isInitForResults:" + this.f93173b);
        if (this.f93173b) {
            d();
    ...
    private PendingIntent b(t3 t3Var) {
        ...
        Intent intent = new Intent(f93170f);
    ...
    void b(t3 t3Var, Intent intent) {
        ...
        qVarF.k(f93167c, Integer.parseInt(t3Var.getFormId()), notificationA);
    }
}
