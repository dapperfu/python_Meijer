...
public class l6 extends h1<ResourceContract> {
    ...
    private static final String f92505a = "ResourceData";
    ...
    private static class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private static final String f92507a = "formId";

        /* renamed from: b, reason: collision with root package name */
        private static final String f92508b = "remoteUrl";

        /* renamed from: c, reason: collision with root package name */
        private static final String f92509c = "localUrl";

        /* renamed from: d, reason: collision with root package name */
        private static final String f92510d = "checksum";

        /* renamed from: e, reason: collision with root package name */
        private static final String f92511e = "isGlobal";
    ...
    protected long b() {
        try {
            return DatabaseUtils.queryNumEntries(f1.a().getWritableDatabase(), f92505a);
        } catch (Exception e10) {
            a4.c(e10.getMessage());
            return 0L;
        }
