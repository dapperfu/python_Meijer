...
class o7 {
    ...
    private ArrayList<c0> f92685a = new ArrayList<>();

    /* renamed from: b, reason: collision with root package name */
    private ArrayList<c0> f92686b = new ArrayList<>();

    /* renamed from: c, reason: collision with root package name */
    private ArrayList<g6> f92687c = new ArrayList<>();
    ...
    protected boolean c(l7 l7Var) {
        ...
        Boolean boolA = f8VarE.a(this.f92686b, this.f92685a, this.f92687c);
        if (boolA == null) {
            return false;
        }
    ...
    protected List<EvaluationResult> a(ArrayList<v1<Boolean>> arrayList, u1.d dVar) {
        ...
        while (true) {
            ...
            if (next.b().a(this.f92686b, this.f92685a, this.f92687c).booleanValue()) {
    ...
    protected EvaluationResult b(ArrayList<v1<Long>> arrayList, u1.d dVar) {
        ...
        while (it.hasNext()) {
            ...
            if (!dVar2.equals(dVar) || next == null || next.d() == null) {
                ...
                zBooleanValue = next.d().a(this.f92686b, this.f92685a, this.f92687c).booleanValue();
                a4.b("BE evaluation shouldEvalute: " + zBooleanValue);
            }
            if (zBooleanValue && (lA = next.b().a(this.f92686b, this.f92685a, this.f92687c)) != null) {
                if (u1.d.FOREGROUND.equals(dVar)) {
    ...
    protected void a() {
        ...
        this.f92685a = t8.g().e();
        this.f92686b = t8.g().f();
        this.f92687c = f1.a().c(b0.a.QuarantineRule, new Object[0]);
    }
}
