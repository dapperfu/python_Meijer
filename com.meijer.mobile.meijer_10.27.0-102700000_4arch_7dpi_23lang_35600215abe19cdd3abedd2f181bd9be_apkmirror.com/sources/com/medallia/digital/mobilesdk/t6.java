...
public class t6 implements x0 {
    ...
    private ArrayList<String> f93056a;

    /* renamed from: b, reason: collision with root package name */
    private HashMap<String, String> f93057b;
    ...
    public String toJsonString() {
        try {
            ...
            if (this.f93056a != null) {
                stringArrayAsJsonString = ModelFactory.getInstance().getStringArrayAsJsonString(this.f93056a);
            }
            sb2.append(stringArrayAsJsonString);
            sb2.append(",\"messages\":");
            sb2.append(ModelFactory.getInstance().getStringMapAsJsonString(this.f93057b));
    ...
    t6(JSONObject jSONObject) {
        ...
        try {
            if (jSONObject.has("versions") && !jSONObject.isNull("versions")) {
                this.f93056a = ModelFactory.getInstance().getStringArray(jSONObject.getJSONArray("versions"));
            }
            if (jSONObject.has("messages") && !jSONObject.isNull("messages")) {
                this.f93057b = ModelFactory.getInstance().getStringMap(jSONObject.getJSONObject("messages"));
            }
            if (jSONObject.has("maxSupportedIndex") && !jSONObject.isNull("maxSupportedIndex")) {
                this.f93058c = jSONObject.getInt("maxSupportedIndex");
            }
            if (!jSONObject.has("maxDeprecatedIndex") || jSONObject.isNull("maxDeprecatedIndex")) {
                return;
            }
            this.f93059d = jSONObject.getInt("maxDeprecatedIndex");
