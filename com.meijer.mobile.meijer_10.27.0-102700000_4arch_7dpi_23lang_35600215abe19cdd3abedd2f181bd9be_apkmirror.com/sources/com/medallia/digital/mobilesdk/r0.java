...
class r0 extends k0<u0> {
    ...
    protected h4 a(i6 i6Var) {
        s1 s1Var = i6.a.NO_CONNECTION.equals(i6Var.a()) ? new s1(h4.a.f92158i) : i6.a.TIMEOUT.equals(i6Var.a()) ? new s1(h4.a.f92173x) : new s1(h4.a.f92172w);
    ...
    protected void b() {
        if (d() == null) {
            new k8(this.f92391a, this.f92392b.e()).a(new a());
        } else {
    ...
    protected h4 d() {
        ...
        h4.a aVar2 = h4.a.f92164o;
        a4.c(aVar2.toString());
        return new s1(aVar2);
    }

    public void e() {
        new s3().a(this.f92394d);
    }
    ...
    public void f() {
        ...
        new h6(this.f92391a, this.f92392b.e(), this.f92392b.c(), a(s4.c.ACCESS_TOKEN)).a((n6<u0>) this.f92394d);
    }
}
