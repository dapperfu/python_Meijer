...
class w {
    ...
    private static final String f93199b = "sdkVersion";

    /* renamed from: c, reason: collision with root package name */
    private static final String f93200c = "osType";

    /* renamed from: a, reason: collision with root package name */
    private final o6 f93201a;

    class a implements o6.a {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ n6 f93202a;
    ...
    public h4 a(i6 i6Var) {
        s1 s1Var = i6.a.NO_CONNECTION.equals(i6Var.a()) ? new s1(h4.a.f92159j) : i6.a.TIMEOUT.equals(i6Var.a()) ? new s1(h4.a.f92160k) : new s1(h4.a.f92154g);
    ...
    private HashMap<String, String> a() {
        ...
        try {
            map.put(f93199b, URLEncoder.encode("4.8.1", "UTF-8"));
        } catch (Exception e10) {
            a4.c(e10.getMessage());
        }
        try {
            map.put(f93200c, URLEncoder.encode("android", "UTF-8"));
        } catch (Exception e11) {
            a4.c(e11.getMessage());
        }
        return map;
    ...
    protected void a(n6<Void> n6Var) {
        ...
        if (!TextUtils.isEmpty(w2.c().b().b())) {
            ...
            this.f93201a.b(w2.c().b().b(), a(), a(s4.c.API_TOKEN), null, s4.f().i().a().a().intValue(), new a(n6Var));
        } else if (n6Var != null) {
            n6Var.a(new s1(h4.a.f92156h));
        }
    }
}
