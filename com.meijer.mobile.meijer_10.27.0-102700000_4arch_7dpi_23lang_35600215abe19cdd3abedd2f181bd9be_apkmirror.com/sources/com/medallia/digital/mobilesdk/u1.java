...
public class u1 {
    ...
    static /* synthetic */ class a {
        ...
        static final /* synthetic */ int[] f93079a;

        /* renamed from: b, reason: collision with root package name */
        static final /* synthetic */ int[] f93080b;
        ...
        static {
            ...
            try {
                f93080b[b.updateConfiguration.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f93080b[b.backToForeground.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f93080b[b.customParameters.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f93080b[b.evaluationTimerFG.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f93080b[b.enableIntercept.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f93080b[b.evaluationTimerBG.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f93080b[b.declineInvitation.ordinal()] = 8;
            ...
            try {
                f93079a[ValueType.TypeLong.ordinal()] = 2;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f93079a[ValueType.TypeString.ordinal()] = 3;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f93079a[ValueType.TypeDouble.ordinal()] = 4;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f93079a[ValueType.TypeBoolean.ordinal()] = 5;
    ...
    enum k {
        ...
        protected static k a(ValueType valueType) {
            ...
            int i10 = a.f93079a[valueType.ordinal()];
            if (i10 == 1 || i10 == 2) {
                return INTEGER;
            }
            if (i10 == 3) {
