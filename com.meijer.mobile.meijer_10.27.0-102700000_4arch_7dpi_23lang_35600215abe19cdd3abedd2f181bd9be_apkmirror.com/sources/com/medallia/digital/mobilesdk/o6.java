...
class o6 {
    ...
    private static final int f92675d = 10;

    /* renamed from: e, reason: collision with root package name */
    private static final int f92676e = 2;

    /* renamed from: f, reason: collision with root package name */
    private static final int f92677f = 5000;

    /* renamed from: g, reason: collision with root package name */
    private static final long f92678g = 3600000;

    /* renamed from: a, reason: collision with root package name */
    private int f92679a;

    /* renamed from: b, reason: collision with root package name */
    private long f92680b = 3600000;

    /* renamed from: c, reason: collision with root package name */
    private final ExecutorService f92681c = b();
    ...
    private void a(b bVar, f0.d dVar, String str, HashMap<String, String> map, HashMap<String, String> map2, JSONObject jSONObject, int i10, a aVar) {
        new j6(this.f92681c, bVar, dVar, a(str, map2), map, jSONObject, i10, this.f92679a, aVar, this.f92680b);
    }
    ...
    private void a(b bVar, f0.d dVar, String str, HashMap<String, String> map, HashMap<String, String> map2, JSONObject jSONObject, String str2, int i10, a aVar) {
        new j6(this.f92681c, bVar, dVar, a(str, map2), map, jSONObject, str2, i10, this.f92679a, aVar, this.f92680b);
    }
