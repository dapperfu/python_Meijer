...
class h6 implements q0 {
    ...
    private static final String f92196h = "uuid";

    /* renamed from: a, reason: collision with root package name */
    private final w f92197a;

    /* renamed from: b, reason: collision with root package name */
    private final o6 f92198b;

    /* renamed from: c, reason: collision with root package name */
    private final String f92199c;

    /* renamed from: d, reason: collision with root package name */
    private final HashMap<String, String> f92200d;

    /* renamed from: e, reason: collision with root package name */
    private final HashMap<String, String> f92201e;

    /* renamed from: f, reason: collision with root package name */
    private int f92202f;

    /* renamed from: g, reason: collision with root package name */
    private n6<u0> f92203g;
    ...
    class a implements o6.a {
        ...
        public void a(k6 k6Var) throws JSONException {
            ...
            h6.this.f92203g.a((n6) new u0(configurationContractCreateConfiguration, true));
        }
    }

    h6(o6 o6Var, String str, HashMap<String, String> map, HashMap<String, String> map2) {
        this.f92198b = o6Var;
        this.f92197a = new w(o6Var);
        this.f92199c = str;
        this.f92200d = map;
        this.f92201e = map2;
    }
    ...
    class b implements n6<Void> {
        ...
        public void a(h4 h4Var) {
            h6.this.a(this.f92205a);
        }

        @Override // com.medallia.digital.mobilesdk.n6
        public void a(Void r22) {
            h6 h6Var = h6.this;
            h6Var.a(h6Var.f92203g);
        }
    }

    public void a(i6 i6Var) {
        int i10;
        if (i6Var.b() == 401 && (i10 = this.f92202f) < 2) {
            this.f92202f = i10 + 1;
            this.f92197a.a(new b(i6Var));
        } else {
            n6<u0> n6Var = this.f92203g;
            if (n6Var != null) {
                n6Var.a(new h4(h4.a.f92122D));
            }
        }
    }
    ...
    public void a(n6<u0> n6Var) {
        ...
        if (j8.b(bVar) != null) {
            try {
                this.f92200d.put(f92196h, URLEncoder.encode(j8.b(bVar), "UTF-8"));
            } catch (Exception e10) {
                a4.c(e10.getMessage());
            }
        }
        this.f92198b.a(this.f92199c, this.f92200d, this.f92201e, s4.f().i().c().a().intValue(), new a());
    }

    public void a(boolean z10) {
        (z10 ? new s3(true, new h4(h4.a.f92138T)) : new s3()).a(this.f92203g);
    }
}
