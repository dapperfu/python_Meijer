...
public class s8 implements m8 {
    ...
    private static s8 f93023c;

    /* renamed from: a, reason: collision with root package name */
    private String f93024a = null;
    ...
    private void a(String str) {
        ...
        t4.e().a(d7.a.OCQ_USER_ID, this.f93024a);
        CollectorsInfrastructure.getInstance().isOCQUserSetCollector.a(Boolean.valueOf(!this.f93025b));
    }
    ...
    protected void a(boolean z10, boolean z11) {
        String str;
        if ((this.f93025b || !((str = this.f93024a) == null || str.isEmpty())) && CollectorsInfrastructure.getInstance() != null && CollectorsInfrastructure.getInstance().isInitialized() && d7.b().d() && z10) {
            String str2 = this.f93024a;
