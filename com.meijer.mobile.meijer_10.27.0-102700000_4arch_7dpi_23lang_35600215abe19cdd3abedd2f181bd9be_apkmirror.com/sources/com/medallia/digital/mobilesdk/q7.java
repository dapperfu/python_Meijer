...
class q7 extends h1<p7> {
    ...
    private static final String f92764a = "templateData";
    ...
    private static class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private static final String f92766a = "templateUrl";

        /* renamed from: b, reason: collision with root package name */
        private static final String f92767b = "templatePath";
    ...
    protected long b() {
        try {
            return DatabaseUtils.queryNumEntries(f1.a().getWritableDatabase(), f92764a);
        } catch (Exception e10) {
            a4.c(e10.getMessage());
            return 0L;
        }
