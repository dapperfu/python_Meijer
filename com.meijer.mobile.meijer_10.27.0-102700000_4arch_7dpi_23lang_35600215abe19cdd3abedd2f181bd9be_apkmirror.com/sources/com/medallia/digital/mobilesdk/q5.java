...
class q5 extends w1<b> {
    ...
    private ComponentCallbacks2 f92745g;
    ...
    public b o() {
        try {
            Display displayF = this.f93208f.f();
    ...
    protected void l() {
        ...
        if (h()) {
            this.f92745g = new a();
            i4.c().b().registerComponentCallbacks(this.f92745g);
        }
    }
    ...
    protected void m() {
        super.m();
        try {
            if (this.f92745g != null) {
                i4.c().b().unregisterComponentCallbacks(this.f92745g);
            }
        } catch (Exception e10) {
            a4.c(e10.getMessage());
        }
