...
class u2 extends k0<String> {
    ...
    protected void b() {
        h4 h4VarD = d();
        if (h4VarD == null) {
            this.f92391a.a(this.f93136g, this.f92392b.c(), null, s4.f().i().f().a().intValue(), new a());
            return;
        }
    ...
    @Override // com.medallia.digital.mobilesdk.k0
    protected h4 d() {
        if (!TextUtils.isEmpty(this.f93136g)) {
            return null;
        }
