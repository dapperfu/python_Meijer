...
class C11571g extends h1<k> {

    /* renamed from: c, reason: collision with root package name */
    private static final String f92044c = "analyticsEvents";

    /* renamed from: d, reason: collision with root package name */
    private static final int f92045d = 5000;

    /* renamed from: e, reason: collision with root package name */
    private static final int f92046e = 50;

    /* renamed from: a, reason: collision with root package name */
    private int f92047a = 0;

    /* renamed from: b, reason: collision with root package name */
    private boolean f92048b = false;
    ...
    private static class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private static final String f92050a = "sessionId";

        /* renamed from: b, reason: collision with root package name */
        private static final String f92051b = "name";

        /* renamed from: c, reason: collision with root package name */
        private static final String f92052c = "lifetime";

        /* renamed from: d, reason: collision with root package name */
        private static final String f92053d = "timestamp";

        /* renamed from: e, reason: collision with root package name */
        private static final String f92054e = "groupType";

        /* renamed from: f, reason: collision with root package name */
        private static final String f92055f = "event";
    ...
    protected long b() {
        try {
            return DatabaseUtils.queryNumEntries(f1.a().getWritableDatabase(), f92044c);
        } catch (Exception e10) {
            a4.c(e10.getMessage());
            return 0L;
        }
    ...
    */
    protected java.util.ArrayList<com.medallia.digital.mobilesdk.k> c(java.lang.Object... r18) {
        ...
        Lf0:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.medallia.digital.mobilesdk.C11571g.c(java.lang.Object[]):java.util.ArrayList");
    }
    ...
    protected void f() throws SQLException {
        ...
        if (this.f92047a >= f92046e) {
            ...
            if (numValueOf == null) {
                numValueOf = Integer.valueOf(f92045d);
            }
            if (f1.a().a(maxDbFileSizeInMb)) {
                a4.b("DB file max size reached");
                if (b() < numValueOf.intValue() || this.f92048b || (strA = d7.b().a(d7.a.SESSION_ID, (String) null)) == null) {
                    return;
                }
    ...
    public boolean d(k kVar) {
        return f1.a().getWritableDatabase().update(d(), b(kVar), "name=?", new String[]{kVar.a()}) > 0 || super.c((C11571g) kVar);
    }
    ...
    public boolean c(k kVar) throws SQLException {
        ...
        boolean zC = super.c((C11571g) kVar);
        if (zC) {
            this.f92047a++;
        } else {
            this.f92047a = 0;
