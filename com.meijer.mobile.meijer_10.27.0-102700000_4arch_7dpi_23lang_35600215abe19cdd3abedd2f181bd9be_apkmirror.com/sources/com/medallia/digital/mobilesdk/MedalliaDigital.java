...
public class MedalliaDigital {
    ...
    class a extends v4 {
        ...
        public void a() {
            if (MedalliaDigital.isBelowApi28()) {
                this.f91557a.onError(new MDExternalError(MDExternalError.ExternalError.OS_VERSION_IS_NOT_SUPPORTED));
                return;
            }
            if (this.f91558b == null) {
                this.f91557a.onError(new MDExternalError(MDExternalError.ExternalError.APPLICATION_IS_NULL));
                return;
            }
            if (i4.c().b() == null) {
                i4.a(this.f91558b);
                if (MedalliaDigital.isSdkStopped()) {
                    this.f91557a.onError(new MDExternalError(MDExternalError.ExternalError.SDK_WAS_STOPPED));
                    return;
                } else {
                    LifeCycle.b();
                    d7.b().a(this.f91558b);
            ...
            MedalliaDigital.medalliaDigitalBrain.b(this.f91559c, this.f91557a);
        }
    }
    ...
    class b extends v4 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ String f91560a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ MDResultCallback f91561b;

        b(String str, MDResultCallback mDResultCallback) {
            this.f91560a = str;
            this.f91561b = mDResultCallback;
        }

        @Override // com.medallia.digital.mobilesdk.v4
        public void a() {
            MedalliaDigital.medalliaDigitalBrain.c(this.f91560a, this.f91561b);
        }
    }
