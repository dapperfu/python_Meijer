...
class t2 extends k0<File> {
    ...
    class a implements o6.a {
        ...
        public void a(k6 k6Var) {
            ...
            File fileA = g2.a(t2.this.f93039h, k6Var.a());
            n6<T> n6Var = t2.this.f92394d;
            if (n6Var != 0) {
                n6Var.a((n6<T>) fileA);
            }
        }
    ...
    protected h4 a(i6 i6Var) {
        s1 s1Var = i6.a.NO_CONNECTION.equals(i6Var.a()) ? new s1(h4.a.f92158i) : i6.a.TIMEOUT.equals(i6Var.a()) ? new s1(h4.a.f92137S) : new s1(h4.a.f92136R);
    ...
    protected void b() {
        h4 h4VarD = d();
        if (h4VarD == null) {
            this.f92391a.a(l3.a(this.f92392b.e(), true), this.f93038g ? a(s4.c.ACCESS_TOKEN) : null, s4.f().i().h().a().intValue(), new a());
            return;
        }
