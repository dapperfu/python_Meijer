...
class f7 extends k0<Void> {
    ...
    protected h4 a(i6 i6Var) {
        s1 s1Var = i6.a.NO_CONNECTION.equals(i6Var.a()) ? new s1(h4.a.f92158i) : i6.a.TIMEOUT.equals(i6Var.a()) ? new s1(h4.a.f92134P) : new s1(h4.a.f92134P);
    ...
    protected void b() {
        ...
        HashMap<String, String> mapB = this.f92392b.b();
        mapB.putAll(a(s4.c.ACCESS_TOKEN));
        a4.b("Submitting digital analytics with body: " + this.f92392b.a().toString());
        this.f92391a.b(this.f92392b.e(), this.f92392b.c(), mapB, this.f92392b.a(), s4.f().i().d().a().intValue(), new a());
    }
