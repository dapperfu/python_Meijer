...
public abstract class BaseFormCommunicator implements LifeCycle.h {
    ...
    class a extends v4 {
        ...
        final /* synthetic */ String f91381a;
        ...
        public void a() {
            Toast.makeText(i4.c().b(), this.f91381a, 0).show();
        }
    }
    ...
    class b extends v4 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ ArrayList f91383a;

        b(ArrayList arrayList) {
            this.f91383a = arrayList;
        }

        @Override // com.medallia.digital.mobilesdk.v4
        public void a() throws JSONException {
            a4.e("List of Permissions Granted : " + this.f91383a);
            Activity activity = (Activity) i4.c().d().getBaseContext();
            String strD = BaseFormCommunicator.this.mediaDataFromJS.d();
            if (this.f91383a.isEmpty() || strD == null) {
                int i10 = c.f91386b[j5.a(strD).ordinal()];
            ...
            int i11 = c.f91386b[j5.a(strD).ordinal()];
            if (i11 == 1) {
                if (this.f91383a.contains("android.permission.CAMERA")) {
                    c5.b().a(activity, BaseFormCommunicator.this.mediaDataFromJS.e());
                }
            } else if (i11 == 2 && this.f91383a.contains("android.permission.RECORD_AUDIO")) {
    ...
    static /* synthetic */ class c {
        ...
        /* renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f91385a;

        /* renamed from: b, reason: collision with root package name */
        static final /* synthetic */ int[] f91386b;
    ...
    class e extends v4 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ String f91388a;
        ...
        public void a() throws JSONException {
            ...
            a4.e("FormId: " + BaseFormCommunicator.this.formId + " sendFeedbackToMobileSdk was called - feedbackData = " + this.f91388a);
            BaseFormCommunicator baseFormCommunicator = BaseFormCommunicator.this;
            ...
            if (str == null || str.equals("undefined") || this.f91388a.isEmpty()) {
                a4.e("Submit feedback data - null");
                return;
            }
            try {
                JSONObject jSONObject = new JSONObject(this.f91388a);
    ...
    class k extends v4 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ z4 f91395a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ a5 f91396b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ j2 f91397c;
        ...
        @Override // com.medallia.digital.mobilesdk.v4
        public void a() {
            c5.b().a(this.f91395a, this.f91396b, this.f91397c, BaseFormCommunicator.this.isPreviewApp());
        }
    }
    ...
    class l extends v4 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Intent f91399a;
        ...
        class b extends v4 {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ String f91402a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ String f91403b;
            ...
            class a implements a5<z4> {
                ...
                @Override // com.medallia.digital.mobilesdk.a5
                public void a(z4 z4Var) {
                    if (b.this.f91402a.equals(j5.upload.toString())) {
                        g2.c(b.this.f91403b);
        ...
        public void a() throws JSONException {
            ...
            try {
                boolean zA = c5.b().a(this.f91399a.getData(), BaseFormCommunicator.this.unSupportedVideoFormats);
                String strA = c5.b().a(this.f91399a.getData(), string, strD);
                if (c5.b().a(this.f91399a.getData(), BaseFormCommunicator.this.mediaDataFromJS.e())) {
    ...
    public void mediaCaptureSelected(String str, String str2) throws JSONException {
        ...
        try {
            g5 g5Var = new g5(new JSONObject(str2));
            this.mediaDataFromJS = g5Var;
            int i10 = c.f91385a[z4.valueOf(g5Var.a()).ordinal()];
            if (i10 == 1) {
                if (zA) {
