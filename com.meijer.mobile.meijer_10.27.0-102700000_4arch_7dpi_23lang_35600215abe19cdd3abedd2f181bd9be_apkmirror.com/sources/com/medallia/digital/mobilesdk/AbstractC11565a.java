...
public abstract class AbstractC11565a<T> extends e0 {
    ...
    protected AbstractC11565a(String str, String str2, List<ResourceContract> list, List<T> list2, HashMap<String, Boolean> map, List<AppRatingContract> list3) {
    ...
    AbstractC11565a(JSONObject jSONObject) {
        try {
