...
class f1 extends SQLiteOpenHelper implements m8 {
    ...
    private static final String f91964b = "MedalliaDigitalDB";

    /* renamed from: c, reason: collision with root package name */
    private static final int f91965c = b();

    /* renamed from: d, reason: collision with root package name */
    private static f1 f91966d = null;

    /* renamed from: e, reason: collision with root package name */
    private static final double f91967e = 10.0d;

    /* renamed from: a, reason: collision with root package name */
    private final HashMap<String, h1> f91968a;

    static /* synthetic */ class a {

        /* renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f91969a;
        ...
        static {
            ...
            try {
                f91969a[b0.a.FormData.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f91969a[b0.a.Resource.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f91969a[b0.a.Template.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f91969a[b0.a.Feedback.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f91969a[b0.a.AnalyticsData.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f91969a[b0.a.MediaFeedback.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f91969a[b0.a.WorkerManager.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f91969a[b0.a.LocalNotification.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f91969a[b0.a.QuarantineRule.ordinal()] = 10;
    ...
    protected f1() {
        super(i4.c().b(), f91964b, (SQLiteDatabase.CursorFactory) null, f91965c);
        ...
        map.put(C11571g.class.getSimpleName(), new C11571g());
    ...
    protected double c() {
        return m1.a(i4.c().b().getDatabasePath(f91964b).length());
    }

    @Override // com.medallia.digital.mobilesdk.m8
    public void clearAndDisconnect() {
        a4.a("Database");
        i4.c().b().deleteDatabase(f91964b);
        f91966d = null;
    }

    @Override // android.database.sqlite.SQLiteOpenHelper
    public void onCreate(SQLiteDatabase sQLiteDatabase) throws SQLException {
        for (h1 h1Var : this.f91968a.values()) {
    ...
    public void onUpgrade(SQLiteDatabase sQLiteDatabase, int i10, int i11) throws SQLException {
        ...
        if (i10 < b.V9.ordinal()) {
            a(sQLiteDatabase, C11571g.class);
        }
    ...
    private void a(SQLiteDatabase sQLiteDatabase, Class cls) throws SQLException {
        h1 h1Var = this.f91968a.get(cls.getSimpleName());
        if (h1Var == null) {
            return;
        }
    ...
    protected boolean a(Double d10) {
        return ((double) i4.c().b().getDatabasePath(f91964b).length()) > a(d10 != null ? d10.doubleValue() : f91967e);
    }
}
