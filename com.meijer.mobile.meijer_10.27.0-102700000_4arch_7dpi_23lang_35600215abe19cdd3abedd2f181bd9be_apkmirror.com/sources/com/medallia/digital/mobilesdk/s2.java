...
class s2 {
    ...
    protected Queue<j2> f92965a = new LinkedList();

    /* renamed from: b, reason: collision with root package name */
    protected Queue<j2> f92966b = new LinkedList();

    /* renamed from: c, reason: collision with root package name */
    protected n2 f92967c;

    /* renamed from: d, reason: collision with root package name */
    private boolean f92968d;
    ...
    public void b(String str) {
        Queue<j2> queue;
        if (!this.f92966b.isEmpty() && ((this.f92966b.element().getFormId() != null && this.f92966b.element().getFormId().equals(str)) || this.f92965a.isEmpty())) {
            queue = this.f92966b;
        } else if (this.f92965a.isEmpty()) {
            return;
        } else {
            queue = this.f92965a;
        }
    ...
    j2 a() {
        Queue<j2> queue;
        if (!this.f92966b.isEmpty()) {
            queue = this.f92966b;
        } else {
            if (this.f92965a.isEmpty()) {
                return null;
            }
            queue = this.f92965a;
        }
    ...
    protected boolean b(j2 j2Var) throws JSONException {
        if (j2Var == null || b() || !this.f92965a.contains(j2Var)) {
            return false;
        }
        j2 j2VarElement = this.f92965a.element();
        if (j2VarElement == null || j2VarElement.getFormId().equals(j2Var.getFormId())) {
            return true;
        }
        this.f92965a.remove(j2Var);
        this.f92966b.add(j2Var);
        ...
        while (it.hasNext()) {
            new l2((j2) it.next(), new n2() { // from class: com.medallia.digital.mobilesdk.E
                ...
                public final void a(j2 j2Var2) throws JSONException {
                    this.f91525a.a(map2, i10, map, j2Var2);
                }
            }).a();
            i10++;
        }
