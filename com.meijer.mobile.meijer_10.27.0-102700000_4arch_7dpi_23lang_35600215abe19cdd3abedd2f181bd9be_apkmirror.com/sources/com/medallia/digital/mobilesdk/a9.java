...
class a9 extends h1<z8> {
    ...
    private static final String f91620a = "workerManager";

    /* renamed from: b, reason: collision with root package name */
    private static final int f91621b = 7;
    ...
    private static class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private static final String f91623a = "mediaCaptureClientCorrelationId";

        /* renamed from: b, reason: collision with root package name */
        private static final String f91624b = "requestId";
    ...
    protected long b() {
        try {
            return DatabaseUtils.queryNumEntries(f1.a().getWritableDatabase(), f91620a);
        } catch (Exception e10) {
            a4.c(e10.getMessage());
            return 0L;
        }
