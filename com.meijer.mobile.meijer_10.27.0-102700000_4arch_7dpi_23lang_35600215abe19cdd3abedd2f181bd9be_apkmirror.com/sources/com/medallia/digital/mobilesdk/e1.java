...
public final class e1 implements m8 {
    ...
    private static boolean f91861c;

    /* renamed from: a, reason: collision with root package name */
    public static final e1 f91859a = new e1();

    /* renamed from: b, reason: collision with root package name */
    private static final ArrayList<CustomParameter> f91860b = new ArrayList<>();

    /* renamed from: d, reason: collision with root package name */
    private static List<? extends c1> f91862d = new ArrayList();
    ...
    */
    private final void c() {
        /*
            r7 = this;
            java.util.ArrayList<com.medallia.digital.mobilesdk.CustomParameter> r0 = com.medallia.digital.mobilesdk.e1.f91860b
        ...
        L47:
            ...
            if (r2 == 0) goto L63
            com.medallia.digital.mobilesdk.e1 r2 = com.medallia.digital.mobilesdk.e1.f91859a
            java.lang.String r5 = r1.b()
        ...
        L63:
            r2 = 0
        L64:
            boolean r5 = com.medallia.digital.mobilesdk.e1.f91861c
            if (r5 == 0) goto L79
            boolean r5 = r7.b(r1)
            if (r5 != 0) goto L79
    ...
    private final void d() {
        ...
        sb2.append("Set ");
        ArrayList<CustomParameter> arrayList = f91860b;
        sb2.append(arrayList.size());
        sb2.append(" custom parameters successfully\n");
        StringBuilder sb3 = new StringBuilder(sb2.toString());
        int size = arrayList.size();
        for (int i10 = 0; i10 < size; i10++) {
            sb3.append(f91860b.get(i10).e());
            sb3.append("\n");
        }
        a4.e(sb3.toString());
    }
    ...
    private final void a(CustomParameter customParameter) {
        Object next;
        Iterator<T> it = f91860b.iterator();
        while (true) {
            if (!it.hasNext()) {
                next = null;
                break;
    ...
    private final void a(o8 o8Var) throws JSONException {
        if (o8Var instanceof o8.b) {
            CustomParameter customParameter = (CustomParameter) CollectionsKt.u0(f91860b);
        ...
        if (o8Var instanceof o8.c ? true : Intrinsics.e(o8Var, o8.a.f92688a)) {
            ArrayList<CustomParameter> arrayList = f91860b;
            ...
            AnalyticsBridge.getInstance().reportSetCustomParametersEvent(linkedHashMap, Intrinsics.e(o8Var, o8.a.f92688a));
        }
    }

    private final boolean b(CustomParameter customParameter) {
        Object next;
        Iterator<T> it = f91862d.iterator();
        while (true) {
            if (!it.hasNext()) {
                next = null;
                break;
