...
public class MDExternalError extends MedalliaDigitalError implements Serializable {
    ...
    private static final String f91556a = "Unspecified configuration error";
    ...
    public enum ExternalError {
        ...
        UNSPECIFIED_CONFIGURATION_ERROR_13(10013, MDExternalError.f91556a),
        UNSPECIFIED_CONFIGURATION_ERROR_14(10014, MDExternalError.f91556a),
        UNSPECIFIED_CONFIGURATION_ERROR_15(10015, MDExternalError.f91556a),
        UNSPECIFIED_CONFIGURATION_ERROR_16(10016, MDExternalError.f91556a),
