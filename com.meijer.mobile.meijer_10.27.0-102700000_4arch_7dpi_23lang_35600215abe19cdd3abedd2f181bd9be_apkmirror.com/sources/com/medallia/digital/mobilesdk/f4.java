...
class f4 extends d0 {
    ...
    private MDTouchListener f92030a;

    /* renamed from: b, reason: collision with root package name */
    private final BroadcastReceiver f92031b = new a();
    ...
    class a extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            try {
                ...
                if (f4.this.f92030a != null && Broadcasts.j.a.TouchEvent == aVar) {
                    f4.this.f92030a.onMDTouchEvent(new MDTouchListenerData(intExtra));
    ...
    class b extends v4 {
        ...
        public void a() throws JSONException {
            if (f4.this.f92030a != null) {
                a4.e("reportTouchEventCallbackEvent");
                AnalyticsBridge.getInstance().reportTouchEventCallbackEvent(this.f92033a);
            }
        }
    }
    ...
    protected void a(Object obj) {
        if (this.f92030a != null && obj == null) {
            e();
            this.f92030a = null;
        }
        if (obj instanceof MDTouchListener) {
            this.f92030a = (MDTouchListener) obj;
        }
        d();
    }
}
