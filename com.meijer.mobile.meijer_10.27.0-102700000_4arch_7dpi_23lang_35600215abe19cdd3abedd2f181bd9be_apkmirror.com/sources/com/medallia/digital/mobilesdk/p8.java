...
class p8 extends k0<String> {
    ...
    private final e5 f92712g;

    /* renamed from: h, reason: collision with root package name */
    private final d5 f92713h;
    ...
    class a implements o6.a {
        ...
        public void a(k6 k6Var) {
            ...
            p8.this.f92394d.a((n6<T>) k6Var.b());
        }
    }
    ...
    protected void b() {
        ...
        try {
            this.f92391a.a(this.f92713h.b(), (HashMap<String, String>) null, (HashMap<String, String>) null, (JSONObject) null, this.f92712g.e(), s4.f().i().f().a().intValue(), new a());
        } catch (Exception e10) {
            a4.c(e10.getMessage());
        }
    }
    ...
    @Override // com.medallia.digital.mobilesdk.k0
    protected h4 d() {
        if (TextUtils.isEmpty(this.f92713h.b())) {
            h4.a aVar = h4.a.f92139U;
            a4.c(aVar.toString());
            return new s1(aVar);
        }
        if (this.f92712g != null) {
            return null;
        }
        h4.a aVar2 = h4.a.f92140V;
        a4.c(aVar2.toString());
        return new s1(aVar2);
    }
}
