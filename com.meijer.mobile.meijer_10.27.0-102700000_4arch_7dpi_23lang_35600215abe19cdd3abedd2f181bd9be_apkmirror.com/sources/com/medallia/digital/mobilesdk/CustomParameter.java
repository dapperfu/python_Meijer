...
public class CustomParameter implements Comparable {
    ...
    private static final int f91518d = 89;

    /* renamed from: a, reason: collision with root package name */
    private String f91519a;

    /* renamed from: b, reason: collision with root package name */
    private Object f91520b;

    /* renamed from: c, reason: collision with root package name */
    private CustomParameterType f91521c;
    ...
    public int compareTo(Object obj) {
        ...
        String str = this.f91519a;
        if (str == null) {
            return -1;
        }
        String str2 = customParameter.f91519a;
        if (str2 == null) {
            return 1;
        }
    ...
    protected JSONObject d() throws JSONException {
        ...
        try {
            jSONObject.put("name", l3.a((Object) this.f91519a));
            jSONObject.put(d7.f91808c, l3.a(this.f91521c));
            jSONObject.put("value", l3.a(this.f91520b));
            return jSONObject;
        } catch (Exception e10) {
            a4.c(e10.getMessage());
            return jSONObject;
    ...
    protected String e() {
        return "Name: " + this.f91519a + " Value: " + this.f91520b;
    }
    ...
    public boolean equals(Object obj) {
        ...
        CustomParameter customParameter = (CustomParameter) obj;
        String str2 = this.f91519a;
        return (str2 == null || (str = customParameter.f91519a) == null || this.f91520b == null || customParameter.f91520b == null || !str2.equals(str) || !this.f91520b.equals(customParameter.f91520b)) ? false : true;
    }

    protected CustomParameter f() {
        this.f91520b = this.f91521c.validateValueFromType(this.f91520b);
        return this;
    }

    public int hashCode() {
        int iHashCode = super.hashCode() * f91518d;
        String str = this.f91519a;
        int iHashCode2 = (iHashCode + (str != null ? str.hashCode() : 0)) * f91518d;
        Object obj = this.f91520b;
    ...
    public CustomParameter(JSONObject jSONObject) {
        try {
            if (jSONObject.has("name") && !jSONObject.isNull("name")) {
                this.f91519a = jSONObject.getString("name");
            }
            if (jSONObject.has(d7.f91808c) && !jSONObject.isNull(d7.f91808c)) {
                this.f91521c = CustomParameterType.fromString(jSONObject.getString(d7.f91808c));
            }
            if (!jSONObject.has("value") || jSONObject.isNull("value")) {
                return;
            }
            this.f91520b = jSONObject.get("value");
