...
final class s7 implements LifeCycle.f, o4.e, o4.d, DialogInterface.OnCancelListener {
    ...
    private static final long f93005m = 300;

    /* renamed from: n, reason: collision with root package name */
    private static final int f93006n = 1;

    /* renamed from: o, reason: collision with root package name */
    private static s7 f93007o;
    ...
    private boolean f93012e;

    /* renamed from: f, reason: collision with root package name */
    private boolean f93013f;
    ...
    private MDAppearanceMode f93019l;

    /* renamed from: d, reason: collision with root package name */
    private Handler f93011d = new Handler(Looper.getMainLooper());

    /* renamed from: g, reason: collision with root package name */
    private boolean f93014g = false;

    /* renamed from: h, reason: collision with root package name */
    private final ArrayList<d> f93015h = new ArrayList<>();

    /* renamed from: i, reason: collision with root package name */
    private final ArrayList<e> f93016i = new ArrayList<>();
    ...
    class a extends v4 {
        ...
        public void a() {
            s7.this.k();
            if (s7.this.f93010c == null || s7.this.f93010c.s()) {
                return;
            }
            s7 s7Var = s7.this;
            s7Var.a(s7Var.f93010c.k());
        }
    }
    ...
    class c extends v4 {
        ...
        public void a() {
            s7.this.a(false);
            s7.this.f93008a = new o4(i4.c().d(), s7.this.f93009b, s7.this.f93013f, s7.this.f93017j, s7.this.f93018k, s7.this.f93019l);
            s7.this.f93008a.setOnCancelListener(s7.this);
            s7.this.f93008a.a((o4.e) s7.this);
            s7.this.f93008a.a((o4.d) s7.this);
            WindowManager.LayoutParams layoutParams = new WindowManager.LayoutParams();
            layoutParams.copyFrom(s7.this.f93008a.getWindow().getAttributes());
            layoutParams.width = -1;
            s7.this.f93008a.show();
            a4.e("Thank You Prompt was presented");
            s7.this.f93012e = true;
            s7.this.f93008a.getWindow().setAttributes(layoutParams);
        }
    }
    ...
    public void k() {
        try {
            ...
            ArrayList<e> arrayList = this.f93016i;
            if (arrayList != null) {
    ...
    private boolean c() {
        o4 o4Var = this.f93008a;
        if (o4Var == null || !o4Var.isShowing()) {
            return false;
        }
        this.f93008a.dismiss();
    ...
    public void b() {
        try {
            o4 o4Var = this.f93008a;
            if (o4Var != null && o4Var.isShowing() && this.f93012e) {
                i();
    ...
    protected boolean d() {
        ...
        AnalyticsBridge.getInstance().reportCloseEngagementEvent(MDEngagementType.form.toString(), z2.THANK_YOU_PROMPT.toString(), this.f93009b.getFormId());
    ...
    void a(j2 j2Var, boolean z10, v5 v5Var, v5 v5Var2, MDAppearanceMode mDAppearanceMode) {
        ...
        this.f93011d.postDelayed(new a(), 300L);
        if (z10) {
            return;
        }
        ...
        boolean zP = this.f93010c.p();
        boolean zQ = this.f93010c.q();
    ...
    protected void a(d dVar) {
        this.f93015h.add(dVar);
    }

    protected void a(e eVar) {
        this.f93016i.add(eVar);
    }
    ...
    public void a(boolean z10) {
        ...
        c();
        if (z10 && (arrayList = this.f93015h) != null) {
        ...
        if (!this.f93014g || this.f93013f) {
            return;
        }
        Broadcasts.d.a(Broadcasts.d.a.formClosed, this.f93009b.getFormId(), this.f93009b.getFormType(), this.f93009b.getFormViewType(), -1L, x3.e().b(), this.f93009b.getFormLanguage(), null, null);
        this.f93014g = false;
    }

    @Override // com.medallia.digital.mobilesdk.o4.d
    public boolean a(String str) {
        return q2.a(str, f(), g(), this.f93009b.getFormId(), this.f93009b.getFormType());
    }
}
