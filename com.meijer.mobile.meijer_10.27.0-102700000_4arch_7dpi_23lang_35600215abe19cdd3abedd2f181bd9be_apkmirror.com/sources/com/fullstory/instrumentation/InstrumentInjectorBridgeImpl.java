...
import fsimpl.C13957ai;
import fsimpl.C13974az;
...
public class InstrumentInjectorBridgeImpl implements InstrumentInjectorBridge {
    ...
    private static final String f64334a = FSBuildConfig.class.getSimpleName();

    /* renamed from: b, reason: collision with root package name */
    private static final String f64335b = FSRuntimeConfig.class.getSimpleName();

    /* renamed from: c, reason: collision with root package name */
    private static final ArrayList f64336c = new ArrayList();

    /* renamed from: d, reason: collision with root package name */
    private static FSReason f64337d;
    ...
    public static /* synthetic */ String a(FSRuntimeConfigEditor.Applier applier) {
        return String.format("%s.reconfigure(configurator: %s)", f64335b, fK.b(applier));
    }
    ...
    public boolean compose_shouldDraw(Object obj, Object obj2, Canvas canvas, Object obj3, boolean z10) {
        if (canvas instanceof C13957ai) {
            return C13974az.a(obj, (C13957ai) canvas, obj3, z10);
        }
        return true;
    }
    ...
    public boolean compose_shouldDrawAndroidView(Object obj, View view, Canvas canvas) {
        ...
        C13974az.a(obj, view, (C13957ai) canvas);
        return false;
    }
    ...
    public boolean compose_shouldDrawLayer(Object obj, Object obj2, Canvas canvas, Object obj3, boolean z10) {
        ...
        C13974az.a((FSComposeRenderNodeLayer) obj, obj2, obj3, z10);
        return false;
    }

    @Override // com.fullstory.instrumentation.InstrumentInjectorBridge
    public boolean compose_shouldObserveReads(Canvas canvas) {
        return !(canvas instanceof C13957ai);
    }
    ...
    public void exclude(final View view) {
        fK.b(new Supplier() { // from class: com.fullstory.instrumentation.InstrumentInjectorBridgeImpl$$ExternalSyntheticLambda68
            @Override // java.util.function.Supplier
            public final Object get() {
    ...
    public void logcat(final FS.LogLevel logLevel, final String str, final String str2, final Throwable th2) {
        Bootstrap.a(new Runnable() { // from class: com.fullstory.instrumentation.InstrumentInjectorBridgeImpl$$ExternalSyntheticLambda69
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void resetIdleTimer() {
        fK.a(new Supplier() { // from class: com.fullstory.instrumentation.InstrumentInjectorBridgeImpl$$ExternalSyntheticLambda75
            @Override // java.util.function.Supplier
            public final Object get() {
                return InstrumentInjectorBridgeImpl.e();
            }
        });
        Bootstrap.a(new Runnable() { // from class: com.fullstory.instrumentation.InstrumentInjectorBridgeImpl$$ExternalSyntheticLambda76
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void setReadyListener(final FSOnReadyListener fSOnReadyListener) {
        Q q10;
        fK.a(new Supplier() { // from class: com.fullstory.instrumentation.InstrumentInjectorBridgeImpl$$ExternalSyntheticLambda70
            @Override // java.util.function.Supplier
            public final Object get() {
        ...
        ArrayList arrayList = f64336c;
        synchronized (arrayList) {
            arrayList.removeIf(new Predicate() { // from class: com.fullstory.instrumentation.InstrumentInjectorBridgeImpl$$ExternalSyntheticLambda71
