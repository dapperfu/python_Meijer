...
public final class C6502x implements InterfaceC6498v {
    ...
    public C6502x(Context context, Function2<? super Boolean, ? super String, Unit> function2) {
        InterfaceC6498v c6500w;
        ConnectivityManager connectivityManagerB = C6504y.b(context);
        this.cm = connectivityManagerB;
        if (connectivityManagerB == null) {
            c6500w = g1.f63437a;
        } else {
            c6500w = new C6500w(connectivityManagerB, function2);
        }
        this.connectivity = c6500w;
    }
}
