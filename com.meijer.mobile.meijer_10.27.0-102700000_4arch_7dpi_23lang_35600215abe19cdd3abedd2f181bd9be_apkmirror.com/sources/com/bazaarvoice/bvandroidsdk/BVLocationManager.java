...
public class BVLocationManager {
    ...
    private final L6.a<BVLocationListener> visitListeners;
    ...
    static class LocationListener extends l {
        ...
        LocationListener(BVLocationManager bVLocationManager, L6.a<BVLocationListener> aVar, Gson gson) {
    ...
    BVVisit attributesToVisit(Va.a aVar, long j10) {
    ...
    private BVLocationManager() {
        ...
        L6.a<BVLocationListener> aVar = new L6.a<>();
        this.visitListeners = aVar;
