...
public class CurationsInfiniteRecyclerView extends BVRecyclerView {
    ...
    private void parseAttributes(Context context, AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, d.f23359x);
        int integer = typedArrayObtainStyledAttributes.getInteger(d.f23308C, 100);
        int integer2 = typedArrayObtainStyledAttributes.getInteger(d.f23361z, 1);
        int integer3 = typedArrayObtainStyledAttributes.getInteger(d.f23360y, 1);
        int integer4 = typedArrayObtainStyledAttributes.getInteger(d.f23310E, 1);
        int integer5 = typedArrayObtainStyledAttributes.getInteger(d.f23307B, 1);
        boolean z10 = typedArrayObtainStyledAttributes.getBoolean(d.f23309D, false);
        int integer6 = typedArrayObtainStyledAttributes.getInteger(d.f23306A, DEFAULT_MAX_FEED_ITEM_COUNT);
