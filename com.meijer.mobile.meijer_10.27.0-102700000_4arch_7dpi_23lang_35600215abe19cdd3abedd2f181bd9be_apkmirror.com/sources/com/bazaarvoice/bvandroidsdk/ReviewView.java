...
public final class ReviewView extends ConversationsUgcView {
    ...
    ReviewView(Context context, AttributeSet attributeSet) {
    ...
    ReviewView(Context context, AttributeSet attributeSet, int i10) {
    ...
    ReviewView(Context context, AttributeSet attributeSet, int i10, int i11) {
