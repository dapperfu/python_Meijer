...
public class C6510c implements V6.j<Bitmap> {

    /* renamed from: b, reason: collision with root package name */
    public static final V6.f<Integer> f64059b = V6.f.f("com.bumptech.glide.load.resource.bitmap.BitmapEncoder.CompressionQuality", 90);

    /* renamed from: c, reason: collision with root package name */
    public static final V6.f<Bitmap.CompressFormat> f64060c = V6.f.e("com.bumptech.glide.load.resource.bitmap.BitmapEncoder.CompressionFormat");

    /* renamed from: a, reason: collision with root package name */
    private final Y6.b f64061a;

    private Bitmap.CompressFormat d(Bitmap bitmap, V6.g gVar) {
        Bitmap.CompressFormat compressFormat = (Bitmap.CompressFormat) gVar.a(f64060c);
        return compressFormat != null ? compressFormat : bitmap.hasAlpha() ? Bitmap.CompressFormat.PNG : Bitmap.CompressFormat.JPEG;
    }

    @Override // V6.j
    public V6.c a(V6.g gVar) {
        return V6.c.TRANSFORMED;
    }
    ...
    */
    public boolean b(X6.c<android.graphics.Bitmap> r8, java.io.File r9, V6.g r10) {
        /*
            r7 = this;
            ...
            q7.b.d(r4, r2, r3, r1)
            long r2 = p7.g.b()     // Catch: java.lang.Throwable -> L56
            V6.f<java.lang.Integer> r4 = com.bumptech.glide.load.resource.bitmap.C6510c.f64059b     // Catch: java.lang.Throwable -> L56
            ...
            Y6.b r9 = r7.f64061a     // Catch: java.lang.Throwable -> L44 java.io.IOException -> L48
            if (r9 == 0) goto L4b
            ...
            Y6.b r5 = r7.f64061a     // Catch: java.lang.Throwable -> L44 java.io.IOException -> L48
        ...
        L6f:
            ...
            r4.append(r1)     // Catch: java.lang.Throwable -> L56
            int r1 = p7.l.h(r8)     // Catch: java.lang.Throwable -> L56
            r4.append(r1)     // Catch: java.lang.Throwable -> L56
            java.lang.String r1 = " in "
            r4.append(r1)     // Catch: java.lang.Throwable -> L56
            double r1 = p7.g.a(r2)     // Catch: java.lang.Throwable -> L56
            r4.append(r1)     // Catch: java.lang.Throwable -> L56
            java.lang.String r1 = ", options format: "
            r4.append(r1)     // Catch: java.lang.Throwable -> L56
            V6.f<android.graphics.Bitmap$CompressFormat> r1 = com.bumptech.glide.load.resource.bitmap.C6510c.f64060c     // Catch: java.lang.Throwable -> L56
        ...
        Lc6:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.resource.bitmap.C6510c.b(X6.c, java.io.File, V6.g):boolean");
    }

    public C6510c(Y6.b bVar) {
        this.f64061a = bVar;
    }
}
