...
public final class ForegroundActivity extends AppCompatActivity {
    ...
    private final C6154b eventCoordinator = p.f31384a.A();

    /* renamed from: t, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5989E<b.c> stateObserver = new InterfaceC5989E() { // from class: et.b
        @Override // androidx.view.InterfaceC5989E
        public final void onChanged(Object obj) {
            ForegroundActivity.t1(this.f130049a, (b.c) obj);
        }
    };
    ...
    public static final class b extends Lambda implements Function0<f0.c> {
        ...
        final /* synthetic */ ComponentActivity f119840f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public b(ComponentActivity componentActivity) {
            super(0);
            this.f119840f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final f0.c invoke() {
            return this.f119840f.getDefaultViewModelProviderFactory();
        }
    }
    ...
    public static final class c extends Lambda implements Function0<g0> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f119841f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public c(ComponentActivity componentActivity) {
            super(0);
            this.f119841f = componentActivity;
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // kotlin.jvm.functions.Function0
        public final g0 invoke() {
            return this.f119841f.getCom.google.android.libraries.places.api.model.PlaceTypes.STORE java.lang.String();
        }
    }
    ...
    public static final class d extends Lambda implements Function0<CreationExtras> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function0 f119842f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ ComponentActivity f119843g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(Function0 function0, ComponentActivity componentActivity) {
            super(0);
            this.f119842f = function0;
            this.f119843g = componentActivity;
        }
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f119842f;
            return (function0 == null || (creationExtras = (CreationExtras) function0.invoke()) == null) ? this.f119843g.getDefaultViewModelCreationExtras() : creationExtras;
        }
    }
    ...
    public static final void t1(ForegroundActivity foregroundActivity, b.c state) {
        ...
        if (Intrinsics.e(state, b.c.C1973c.f119893a)) {
        ...
        } else if (!Intrinsics.e(state, b.c.C1972b.f119892a) && !Intrinsics.e(state, b.c.a.f119891a)) {
    ...
    protected void onNewIntent(Intent intent) {
        ...
        this.eventCoordinator.a(C13773f.f130053a);
        s1(intent);
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        this.eventCoordinator.a(C13770c.f130050a);
        r1().o();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.eventCoordinator.a(C13771d.f130051a);
    ...
    protected void onDestroy() {
        super.onDestroy();
        this.eventCoordinator.a(C13772e.f130052a);
    }

    @Override // androidx.fragment.app.FragmentActivity, android.app.Activity
    protected void onPause() {
        super.onPause();
        this.eventCoordinator.a(C13774g.f130054a);
    ...
    protected void onResume() {
        super.onResume();
        this.eventCoordinator.a(C13775h.f130055a);
        r1().s(this);
