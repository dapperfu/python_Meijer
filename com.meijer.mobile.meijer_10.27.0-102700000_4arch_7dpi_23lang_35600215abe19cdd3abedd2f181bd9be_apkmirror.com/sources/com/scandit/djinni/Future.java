...
public class Future<T> implements java.util.concurrent.Future<T> {
    ...
    public Future<Void> then(final FutureHandler<T> futureHandler) {
        ...
        SharedState.Continuation<T> continuation = new SharedState.Continuation() { // from class: com.scandit.djinni.a
            @Override // com.scandit.djinni.SharedState.Continuation
            public final void handleResult(SharedState sharedState) {
                Future.b(futureHandler, promise, sharedState);
            }
        };
    ...
    public static /* synthetic */ void a(Promise promise, FutureHandlerWithReturn futureHandlerWithReturn, SharedState sharedState) {
        try {
    ...
    public static /* synthetic */ void b(FutureHandler futureHandler, Promise promise, SharedState sharedState) {
        try {
    ...
    public <R> Future<R> then(final FutureHandlerWithReturn<T, R> futureHandlerWithReturn) {
        ...
        SharedState.Continuation<T> continuation = new SharedState.Continuation() { // from class: com.scandit.djinni.b
            @Override // com.scandit.djinni.SharedState.Continuation
            public final void handleResult(SharedState sharedState) {
                Future.a(promise, futureHandlerWithReturn, sharedState);
            }
        };
        SharedState<T> sharedState = null;
        SharedState<T> andSet = this._sharedState.getAndSet(null);
