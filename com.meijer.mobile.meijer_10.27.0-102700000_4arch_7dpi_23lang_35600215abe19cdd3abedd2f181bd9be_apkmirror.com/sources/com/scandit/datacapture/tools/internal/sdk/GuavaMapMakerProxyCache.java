...
import com.scandit.datacapture.tools.internal.module.mapmaker.C13399f;
import com.scandit.datacapture.tools.internal.module.mapmaker.C13400g;
import com.scandit.datacapture.tools.internal.module.mapmaker.C13411s;
...
public final class GuavaMapMakerProxyCache implements ProxyCache {
    ...
    private final LinkedHashMap f126266a = new LinkedHashMap();

    /* renamed from: b, reason: collision with root package name */
    private final LinkedHashMap f126267b = new LinkedHashMap();

    private final synchronized ConcurrentMap a(KClass kClass, Object obj) {
        ConcurrentMap concurrentMap;
        try {
            if (obj == null) {
                LinkedHashMap linkedHashMap = this.f126266a;
                ...
                WeakHashMap weakHashMap = (WeakHashMap) this.f126267b.get(kClass);
                if (weakHashMap == null) {
                    weakHashMap = new WeakHashMap();
                    this.f126267b.put(kClass, weakHashMap);
                }
    ...
    private static N a() {
        N n10;
        C13399f c13399f = new C13399f();
        t tVar = u.f126260b;
        u uVar = c13399f.f126235a;
        S.a(uVar == null, "Key strength was already set to %s", (t) uVar);
        c13399f.f126235a = tVar;
        u uVar2 = c13399f.f126236b;
        S.a(uVar2 == null, "Value strength was already set to %s", (t) uVar2);
        c13399f.f126236b = tVar;
        C13400g c13400g = N.f126219j;
        u uVar3 = c13399f.f126235a;
        C13411s c13411s = u.f126259a;
        if (((u) P.a(uVar3, c13411s)) == c13411s && ((u) P.a(c13399f.f126236b, c13411s)) == c13411s) {
            n10 = new N(c13399f, v.f126262a);
        } else if (((u) P.a(c13399f.f126235a, c13411s)) == c13411s && ((u) P.a(c13399f.f126236b, c13411s)) == tVar) {
            n10 = new N(c13399f, y.f126264a);
        } else if (((u) P.a(c13399f.f126235a, c13411s)) == tVar && ((u) P.a(c13399f.f126236b, c13411s)) == c13411s) {
            n10 = new N(c13399f, D.f126208a);
        } else if (((u) P.a(c13399f.f126235a, c13411s)) == tVar && ((u) P.a(c13399f.f126236b, c13411s)) == tVar) {
            n10 = new N(c13399f, G.f126211a);
        } else {
