...
public final class a implements BarcodeSelectionBrushProvider {
    ...
    public final WeakReference f123853a;

    public a(BarcodeSelectionBasicOverlay owner) {
        Intrinsics.j(owner, "owner");
        this.f123853a = new WeakReference(owner);
    }
    ...
    public final Brush brushForBarcode(Barcode barcode) {
        ...
        BarcodeSelectionBasicOverlay barcodeSelectionBasicOverlay = (BarcodeSelectionBasicOverlay) this.f123853a.get();
