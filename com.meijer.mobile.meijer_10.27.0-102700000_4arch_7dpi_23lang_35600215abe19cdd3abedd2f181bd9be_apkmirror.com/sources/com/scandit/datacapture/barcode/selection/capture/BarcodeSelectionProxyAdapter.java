...
public final class BarcodeSelectionProxyAdapter implements BarcodeSelectionProxy {
    ...
    private final NativeBarcodeSelection f123785a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeDataCaptureMode f123787c;
    ...
    public BarcodeSelectionProxyAdapter(NativeBarcodeSelection _NativeBarcodeSelection, ProxyCache proxyCache) {
        ...
        this.f123785a = _NativeBarcodeSelection;
        ...
        this.f123787c = nativeDataCaptureModeAsDataCaptureMode;
    }
    ...
    public NativeDataCaptureMode getF123787c() {
    ...
    public void freezeCamera() {
        this.f123785a.freezeCamera();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionProxy
    public PointWithUnit getPointOfInterest() {
        return this.f123785a.getPointOfInterest();
    }
    ...
    public void increaseCountForBarcodesFromJsonString(String json) {
        ...
        this.f123785a.increaseCountForBarcodesFromJsonString(json);
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionProxy
    public boolean isEnabled() {
        return this.f123785a.isEnabled();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionProxy
    public void selectAimedBarcode() {
        this.f123785a.selectAimedBarcode();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionProxy
    public void selectUnselectedBarcodes() {
        this.f123785a.selectAllUnselectedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionProxy
    public void setEnabled(boolean z10) {
        this.f123785a.setEnabled(z10);
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionProxy
    public void setPointOfInterest(PointWithUnit pointWithUnit) {
        this.f123785a.setPointOfInterest(pointWithUnit);
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionProxy
    public void setSelectBarcodeEnabledFromJsonString(String json, boolean enabled) {
        Intrinsics.j(json, "json");
        this.f123785a.setSelectBarcodeEnabledFromJsonString(json, enabled);
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionProxy
    public void unfreezeCamera() {
        this.f123785a.unfreezeCamera();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionProxy
    public void unselectBarcodesFromJsonString(String json) {
        Intrinsics.j(json, "json");
        this.f123785a.unselectBarcodesFromJsonString(json);
    }
