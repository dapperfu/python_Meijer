...
public final class BarcodeSelectionListenerReversedAdapter extends NativeBarcodeSelectionListener {
    ...
    private final BarcodeSelectionListener f123778a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final WeakReference f123780c;
    ...
    public void onObservationStarted(NativeBarcodeSelection mode) {
        ...
        BarcodeSelection barcodeSelection = (BarcodeSelection) this.f123780c.get();
        if (barcodeSelection != null) {
            ...
            this.f123778a.onObservationStarted((BarcodeSelection) orPut);
        }
    }
    ...
    public void onObservationStopped(NativeBarcodeSelection mode) {
        ...
        if (barcodeSelection != null) {
            ...
            Intrinsics.i(orPut, "getOrPut(...)");
            this.f123778a.onObservationStopped((BarcodeSelection) orPut);
        }
    }
    ...
    public void onSelectionUpdated(NativeBarcodeSelection mode, NativeBarcodeSelectionSession session, NativeFrameData data) {
        ...
        if (barcodeSelection != null) {
            ...
            Intrinsics.i(orPut, "getOrPut(...)");
            this.f123778a.onSelectionUpdated((BarcodeSelection) orPut, (BarcodeSelectionSession) this.proxyCache.getOrPut(Reflection.b(NativeBarcodeSelectionSession.class), null, session, new B(barcodeSelection)), data != null ? (FrameData) this.proxyCache.getOrPut(Reflection.b(NativeFrameData.class), null, data, new z(data)) : null);
        }
    }
    ...
    public void onSessionUpdated(NativeBarcodeSelection mode, NativeBarcodeSelectionSession session, NativeFrameData data) {
        ...
        if (barcodeSelection != null) {
            ...
            Intrinsics.i(orPut, "getOrPut(...)");
            this.f123778a.onSessionUpdated((BarcodeSelection) orPut, (BarcodeSelectionSession) this.proxyCache.getOrPut(Reflection.b(NativeBarcodeSelectionSession.class), null, session, new E(barcodeSelection)), data != null ? (FrameData) this.proxyCache.getOrPut(Reflection.b(NativeFrameData.class), null, data, new C(data)) : null);
        }
    }
    ...
    public BarcodeSelectionListenerReversedAdapter(BarcodeSelectionListener listener, BarcodeSelection barcodeSelection, ProxyCache proxyCache) {
        ...
        this.f123778a = listener;
        this.proxyCache = proxyCache;
        this.f123780c = new WeakReference(barcodeSelection);
    }
}
