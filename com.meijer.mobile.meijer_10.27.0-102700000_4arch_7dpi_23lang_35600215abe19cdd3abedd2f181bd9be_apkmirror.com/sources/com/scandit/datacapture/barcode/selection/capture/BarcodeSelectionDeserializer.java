...
public final class BarcodeSelectionDeserializer implements DataCaptureModeDeserializer, BarcodeSelectionDeserializerProxy {
    ...
    private final C13273g f123764b;

    /* renamed from: c, reason: collision with root package name */
    private final /* synthetic */ BarcodeSelectionDeserializerProxyAdapter f123765c;
    ...
    public BarcodeSelectionBasicOverlay _basicOverlayFromJson(BarcodeSelection mode, String jsonData) {
        ...
        return this.f123765c._basicOverlayFromJson(mode, jsonData);
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionDeserializerProxy
    @ProxyGetter(ProxyGetterKind.WITH_SETTER)
    public BarcodeSelectionDeserializer _deserializer() {
        return this.f123765c._deserializer();
    }
    ...
    public NativeBarcodeSelectionDeserializer getF123772a() {
        return this.f123765c.getF123772a();
    }
    ...
    public NativeDataCaptureModeDeserializer getF123774c() {
        return this.f123765c.getF123774c();
    }
    ...
    public BarcodeSelection _modeFromJson(DataCaptureContext dataCaptureContext, String jsonData) {
        ...
        Intrinsics.j(jsonData, "jsonData");
        return this.f123765c._modeFromJson(dataCaptureContext, jsonData);
    }
    ...
    public void _setDeserializer(BarcodeSelectionDeserializer deserializer) {
        ...
        this.f123765c._setDeserializer(deserializer);
    }
    ...
    public BarcodeSelectionBasicOverlay updateBasicOverlayFromJson(BarcodeSelectionBasicOverlay overlay, String jsonData) {
        ...
        Intrinsics.j(jsonData, "jsonData");
        return this.f123765c.updateBasicOverlayFromJson(overlay, jsonData);
    }
    ...
    public BarcodeSelection updateModeFromJson(BarcodeSelection mode, String jsonData) {
        Intrinsics.j(mode, "mode");
        Intrinsics.j(jsonData, "jsonData");
        return this.f123765c.updateModeFromJson(mode, jsonData);
    }
    ...
    public BarcodeSelectionSettings updateSettingsFromJson(BarcodeSelectionSettings settings, String jsonData) {
        ...
        Intrinsics.j(jsonData, "jsonData");
        return this.f123765c.updateSettingsFromJson(settings, jsonData);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public BarcodeSelectionDeserializer() {
        ViewfinderDeserializer viewfinderDeserializer = new ViewfinderDeserializer();
        C13273g c13273g = new C13273g();
        BarcodeSelectionDeserializerHelperReversedAdapter barcodeSelectionDeserializerHelperReversedAdapter = new BarcodeSelectionDeserializerHelperReversedAdapter(c13273g, null, 2, null);
        ...
        this.f123764b = c13273g;
        this.f123765c = new BarcodeSelectionDeserializerProxyAdapter(nativeBarcodeSelectionDeserializerCreate, null, 2, 0 == true ? 1 : 0);
        ProxyCacheKt.getGlobalProxyCache().getOrPut(Reflection.b(BarcodeSelectionDeserializerHelper.class), null, c13273g, new C13271e(barcodeSelectionDeserializerHelperReversedAdapter));
        _setDeserializer(this);
        nativeBarcodeSelectionDeserializerCreate.setListener(new BarcodeSelectionDeserializerListenerReversedAdapter(new C13272f(this), this, null, 4, null));
        WeakReference weakReference = new WeakReference(this);
        Intrinsics.j(weakReference, "<set-?>");
        c13273g.f123812a = weakReference;
    }
    ...
    public final BarcodeSelectionBasicOverlay basicOverlayFromJson(BarcodeSelection mode, String jsonData) {
        ...
        C13273g c13273g = this.f123764b;
        c13273g.f123813b = null;
        c13273g.f123814c = null;
