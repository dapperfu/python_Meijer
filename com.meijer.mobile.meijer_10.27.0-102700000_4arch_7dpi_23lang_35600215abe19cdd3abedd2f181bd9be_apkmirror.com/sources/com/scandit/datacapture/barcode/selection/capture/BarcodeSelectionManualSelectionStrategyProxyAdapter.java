...
public final class BarcodeSelectionManualSelectionStrategyProxyAdapter implements BarcodeSelectionManualSelectionStrategyProxy {
    ...
    private final NativeManualSelectionStrategy f123782a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeSelectionStrategy f123784c;
    ...
    public BarcodeSelectionManualSelectionStrategyProxyAdapter(NativeManualSelectionStrategy _NativeManualSelectionStrategy, ProxyCache proxyCache) {
        ...
        this.f123782a = _NativeManualSelectionStrategy;
        ...
        this.f123784c = nativeSelectionStrategyAsSelectionStrategy;
    }
    ...
    public NativeSelectionStrategy getF123784c() {
    ...
    public String toJson() {
        String json = this.f123782a.toJson();
        Intrinsics.g(json);
        return json;
    }
