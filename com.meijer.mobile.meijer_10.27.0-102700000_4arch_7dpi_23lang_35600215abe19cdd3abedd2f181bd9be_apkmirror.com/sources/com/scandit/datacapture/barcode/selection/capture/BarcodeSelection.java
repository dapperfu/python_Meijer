...
public final class BarcodeSelection implements DataCaptureMode, BarcodeSelectionProxy {
    ...
    private final BarcodeSelectionSession f123744a;

    /* renamed from: b, reason: collision with root package name */
    private final /* synthetic */ BarcodeSelectionProxyAdapter f123745b;

    /* renamed from: c, reason: collision with root package name */
    private DataCaptureContext f123746c;

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    private BarcodeSelectionFeedback feedback;

    /* renamed from: e, reason: collision with root package name */
    private final CopyOnWriteArraySet f123748e;
    ...
    public static final class Companion {
        ...
        public final BarcodeSelection forDataCaptureContext(DataCaptureContext dataCaptureContext, BarcodeSelectionSettings settings) {
            ...
            ProxyCacheKt.getGlobalProxyCache().getOrPut(Reflection.b(BarcodeSelection.class), null, barcodeSelection, new C13268b(barcodeSelection));
    ...
    public BarcodeSelection(NativeBarcodeSelection impl, BarcodeSelectionSession session) {
        ...
        this.f123744a = session;
        this.f123745b = new BarcodeSelectionProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        BarcodeSelectionFeedback barcodeSelectionFeedbackDefaultFeedback = BarcodeSelectionFeedback.INSTANCE.defaultFeedback();
        getF123785a().setSelectionFeedback(new BarcodeSelection$setNativeFeedback$1(barcodeSelectionFeedbackDefaultFeedback));
        this.feedback = barcodeSelectionFeedbackDefaultFeedback;
        this.f123748e = new CopyOnWriteArraySet();
        getF123785a().addListenerAsync(new BarcodeSelectionListenerReversedAdapter(new C13269c(this), this, null, 4, null));
    }
    ...
    public NativeDataCaptureMode getF120428c() {
        return this.f123745b.getF123787c();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionProxy
    @NativeImpl
    /* renamed from: _impl */
    public NativeBarcodeSelection getF123785a() {
        return this.f123745b.getF123785a();
    }
    ...
    public void increaseCountForBarcodesFromJsonString(String json) {
        ...
        this.f123745b.increaseCountForBarcodesFromJsonString(json);
    }

    @Override // com.scandit.datacapture.core.capture.DataCaptureMode, com.scandit.datacapture.barcode.batch.capture.BarcodeBatchProxy
    @ProxyFunction(property = "isEnabled")
    public boolean isEnabled() {
        return this.f123745b.isEnabled();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionProxy
    @ProxyFunction
    public void selectAimedBarcode() {
        this.f123745b.selectAimedBarcode();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionProxy
    @ProxyFunction(nativeName = "selectAllUnselectedBarcodes")
    public void selectUnselectedBarcodes() {
        this.f123745b.selectUnselectedBarcodes();
    }

    @Override // com.scandit.datacapture.core.capture.DataCaptureMode, com.scandit.datacapture.barcode.batch.capture.BarcodeBatchProxy
    @ProxyFunction(property = "isEnabled")
    public void setEnabled(boolean z10) {
        this.f123745b.setEnabled(z10);
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionProxy
    @ProxyFunction(property = "pointOfInterest")
    public void setPointOfInterest(PointWithUnit pointWithUnit) {
        this.f123745b.setPointOfInterest(pointWithUnit);
    }
    ...
    public void setSelectBarcodeEnabledFromJsonString(String json, boolean enabled) {
        Intrinsics.j(json, "json");
        this.f123745b.setSelectBarcodeEnabledFromJsonString(json, enabled);
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionProxy
    @ProxyFunction
    public void unfreezeCamera() {
        this.f123745b.unfreezeCamera();
    }
    ...
    public void unselectBarcodesFromJsonString(String json) {
        Intrinsics.j(json, "json");
        this.f123745b.unselectBarcodesFromJsonString(json);
    }
    ...
    public final BarcodeSelectionSession getF123744a() {
    ...
    public final void applySettings(BarcodeSelectionSettings settings, Runnable whenDone) {
        Intrinsics.j(settings, "settings");
        NativeWrappedFuture nativeWrappedFutureApplySettingsWrapped = getF123785a().applySettingsWrapped(settings._impl());
    ...
    public final void increaseCountForBarcodes(List<Barcode> barcodes) {
        ...
        NativeBarcodeSelection nativeBarcodeSelection_impl = getF123785a();
    ...
    public final void removeListener(BarcodeSelectionListener listener) {
        Intrinsics.j(listener, "listener");
        if (this.f123748e.remove(listener)) {
    ...
    public final void setFeedback(BarcodeSelectionFeedback value) {
        ...
        this.feedback = value;
        getF123785a().setSelectionFeedback(new BarcodeSelection$setNativeFeedback$1(value));
    }

    public final void setSelectBarcodeEnabled(Barcode barcode, boolean enabled) {
        Intrinsics.j(barcode, "barcode");
        getF123785a().setSelectBarcodeEnabled(barcode.getF120890a(), enabled);
    }
    ...
    public final BarcodeSelectionLicenseInfo getBarcodeSelectionLicenseInfo() {
        NativeBarcodeSelectionLicenseInfo barcodeSelectionLicenseInfo = getF123785a().getBarcodeSelectionLicenseInfo();
    ...
    public BarcodeSelection(DataCaptureContext dataCaptureContext, BarcodeSelectionSettings barcodeSelectionSettings, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        this(nativeBarcodeSelectionCreate, new BarcodeSelectionSession(new C13267a(nativeBarcodeSelectionCreate)));
    }
}
