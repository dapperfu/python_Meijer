...
public final class BarcodeSelectionTapSelectionProxyAdapter implements BarcodeSelectionTapSelectionProxy {
    ...
    private final NativeTapSelection f123798a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeSelectionType f123800c;
    ...
    public BarcodeSelectionTapSelectionProxyAdapter(NativeTapSelection _NativeTapSelection, ProxyCache proxyCache) {
        ...
        this.f123798a = _NativeTapSelection;
        ...
        this.f123800c = nativeSelectionTypeAsSelectionType;
    }
    ...
    public NativeSelectionType getF123800c() {
        return this.f123800c;
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionTapSelectionProxy
    public BarcodeSelectionFreezeBehavior getFreezeBehavior() {
        BarcodeSelectionFreezeBehavior freezeBehavior = this.f123798a.getFreezeBehavior();
    ...
    public boolean getShouldFreezeOnDoubleTap() {
        return this.f123798a.getShouldFreezeOnDoubleTap();
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionTapSelectionProxy
    public BarcodeSelectionTapBehavior getTapBehavior() {
        BarcodeSelectionTapBehavior tapBehavior = this.f123798a.getTapBehavior();
    ...
    public void setFreezeBehavior(BarcodeSelectionFreezeBehavior p02) {
        Intrinsics.j(p02, "p0");
        this.f123798a.setFreezeBehavior(p02);
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionTapSelectionProxy
    public void setShouldFreezeOnDoubleTap(boolean z10) {
        this.f123798a.setShouldFreezeOnDoubleTap(z10);
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionTapSelectionProxy
    public void setTapBehavior(BarcodeSelectionTapBehavior p02) {
        Intrinsics.j(p02, "p0");
        this.f123798a.setTapBehavior(p02);
    }

    @Override // com.scandit.datacapture.barcode.selection.capture.BarcodeSelectionTapSelectionProxy
    public String toJson() {
        String json = this.f123798a.toJson();
        Intrinsics.g(json);
        return json;
    }
