...
public final class BarcodeCaptureSession implements BarcodeCaptureSessionProxy {
    ...
    private final Lazy f120542a;

    public BarcodeCaptureSession(Function0<? extends NativeBarcodeCaptureSession> getImpl) {
        Intrinsics.j(getImpl, "getImpl");
        this.f120542a = LazyKt.b(new S(getImpl));
    }

    @Override // com.scandit.datacapture.barcode.capture.BarcodeCaptureSessionProxy
    public long getFrameSequenceId() {
        return ((BarcodeCaptureSessionProxyAdapter) this.f120542a.getValue()).getFrameSequenceId();
    }

    @Override // com.scandit.datacapture.barcode.capture.BarcodeCaptureSessionProxy
    public List<LocalizedOnlyBarcode> getNewlyLocalizedBarcodes() {
        return ((BarcodeCaptureSessionProxyAdapter) this.f120542a.getValue()).getNewlyLocalizedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.capture.BarcodeCaptureSessionProxy
    public Barcode getNewlyRecognizedBarcode() {
        return ((BarcodeCaptureSessionProxyAdapter) this.f120542a.getValue()).getNewlyRecognizedBarcode();
    }

    @Override // com.scandit.datacapture.barcode.capture.BarcodeCaptureSessionProxy
    public List<Barcode> get_newlyRecognizedBarcodes() {
        return ((BarcodeCaptureSessionProxyAdapter) this.f120542a.getValue()).get_newlyRecognizedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.capture.BarcodeCaptureSessionProxy
    public void reset() {
        ((BarcodeCaptureSessionProxyAdapter) this.f120542a.getValue()).reset();
    }

    @Override // com.scandit.datacapture.barcode.capture.BarcodeCaptureSessionProxy
    public String toJson() {
        return ((BarcodeCaptureSessionProxyAdapter) this.f120542a.getValue()).toJson();
    }
}
