...
public final class BarcodeCapture implements DataCaptureMode, BarcodeCaptureProxy {
    ...
    private final BatterySavingHandler f120512a;

    /* renamed from: b, reason: collision with root package name */
    private final /* synthetic */ BarcodeCaptureProxyAdapter f120513b;

    /* renamed from: c, reason: collision with root package name */
    private DataCaptureContext f120514c;

    /* renamed from: d, reason: collision with root package name */
    private final BarcodeCapture$dataCaptureContextListener$1 f120515d;

    /* renamed from: e, reason: collision with root package name and from kotlin metadata */
    private BarcodeCaptureFeedback feedback;

    /* renamed from: f, reason: collision with root package name */
    private final CopyOnWriteArraySet f120517f;

    /* renamed from: g, reason: collision with root package name */
    private final BarcodeCaptureSession f120518g;
    ...
    public BarcodeCapture(NativeBarcodeCapture impl, BatterySavingHandler batterySavingHandler) {
        ...
        this.f120512a = batterySavingHandler;
        this.f120513b = new BarcodeCaptureProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        batterySavingHandler.setListener(new C13037a(this));
        this.f120515d = new DataCaptureContextListener() { // from class: com.scandit.datacapture.barcode.capture.BarcodeCapture$dataCaptureContextListener$1
            ...
            public void onFrameSourceChanged(DataCaptureContext dataCaptureContext, FrameSource frameSource) {
                Intrinsics.j(dataCaptureContext, "dataCaptureContext");
                BarcodeCapture barcodeCapture = this.f120519a;
                BarcodeCapture.access$applyBatterySavingMode(barcodeCapture, dataCaptureContext, barcodeCapture.f120512a.getShouldSaveBattery());
            }
        ...
        getF120539a().setSuccessFeedback(new BarcodeCapture$setNativeFeedback$1(barcodeCaptureFeedbackDefaultFeedback));
        this.feedback = barcodeCaptureFeedbackDefaultFeedback;
        this.f120517f = new CopyOnWriteArraySet();
        getF120539a().addListenerAsync(new BarcodeCaptureListenerReversedAdapter(new C13038b(this), this, null, 4, null));
        BatterySavingMode batterySavingMode = getF120539a().getSettings().getBatterySavingMode();
        Intrinsics.i(batterySavingMode, "getBatterySavingMode(...)");
        batterySavingHandler.setBatterySavingMode(batterySavingMode);
        this.f120518g = new BarcodeCaptureSession(new C13039c(impl));
    }
    ...
    private static void a(DataCaptureContext dataCaptureContext, boolean z10) {
        ...
        NativeAndroidCamera nativeAndroidCamera_impl = camera != null ? camera.getF125871a() : null;
    ...
    public NativeDataCaptureMode getF120428c() {
        return this.f120513b.getF120541c();
    }
    ...
    public NativeBarcodeCapture getF120539a() {
        return this.f120513b.getF120539a();
    }
    ...
    public PointWithUnit getPointOfInterest() {
        return this.f120513b.getPointOfInterest();
    }

    @Override // com.scandit.datacapture.core.capture.DataCaptureMode, com.scandit.datacapture.barcode.batch.capture.BarcodeBatchProxy
    @ProxyFunction(property = "isEnabled")
    public boolean isEnabled() {
        return this.f120513b.isEnabled();
    }

    @Override // com.scandit.datacapture.core.capture.DataCaptureMode, com.scandit.datacapture.barcode.batch.capture.BarcodeBatchProxy
    @ProxyFunction(property = "isEnabled")
    public void setEnabled(boolean z10) {
        this.f120513b.setEnabled(z10);
    }

    @Override // com.scandit.datacapture.barcode.capture.BarcodeCaptureProxy
    @ProxyFunction(property = "pointOfInterest")
    public void setPointOfInterest(PointWithUnit pointWithUnit) {
        this.f120513b.setPointOfInterest(pointWithUnit);
    }
    ...
    public final BarcodeCaptureSession getF120518g() {
        return this.f120518g;
    }
    ...
    public void _setDataCaptureContext(DataCaptureContext dataCaptureContext) {
        a(this.f120514c, false);
        DataCaptureContext dataCaptureContext2 = this.f120514c;
        if (dataCaptureContext2 != null) {
            dataCaptureContext2.removeListener(this.f120515d);
        }
        this.f120514c = dataCaptureContext;
        if (dataCaptureContext != null) {
            dataCaptureContext.addListener(this.f120515d);
        }
        a(dataCaptureContext, this.f120512a.getShouldSaveBattery());
    }

    public final void addListener(BarcodeCaptureListener listener) {
        Intrinsics.j(listener, "listener");
        if (this.f120517f.add(listener)) {
    ...
    public final void applySettings(BarcodeCaptureSettings settings, Runnable whenDone) {
        Intrinsics.j(settings, "settings");
        this.f120512a.setBatterySavingMode(settings.getBatterySaving());
        NativeWrappedFuture nativeWrappedFutureApplySettingsWrapped = getF120539a().applySettingsWrapped(settings._impl());
    ...
    public DataCaptureContext getF120935c() {
    ...
    public final void removeListener(BarcodeCaptureListener listener) {
        Intrinsics.j(listener, "listener");
        if (this.f120517f.remove(listener)) {
    ...
    public final void setFeedback(BarcodeCaptureFeedback value) {
        ...
        this.feedback = value;
        getF120539a().setSuccessFeedback(new BarcodeCapture$setNativeFeedback$1(value));
    }
    ...
    public final BarcodeCaptureLicenseInfo getBarcodeCaptureLicenseInfo() {
        NativeBarcodeCaptureLicenseInfo barcodeCaptureLicenseInfo = getF120539a().getBarcodeCaptureLicenseInfo();
