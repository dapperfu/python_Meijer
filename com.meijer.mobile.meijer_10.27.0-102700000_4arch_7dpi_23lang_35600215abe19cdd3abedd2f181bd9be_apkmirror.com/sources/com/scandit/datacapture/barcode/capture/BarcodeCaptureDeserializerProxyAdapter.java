...
public final class BarcodeCaptureDeserializerProxyAdapter implements BarcodeCaptureDeserializerProxy {
    ...
    private final NativeBarcodeCaptureDeserializer f120531a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeDataCaptureModeDeserializer f120533c;

    /* renamed from: d, reason: collision with root package name */
    private BarcodeCaptureDeserializer f120534d;
    ...
    public BarcodeCaptureDeserializerProxyAdapter(NativeBarcodeCaptureDeserializer _NativeBarcodeCaptureDeserializer, ProxyCache proxyCache) {
        ...
        this.f120531a = _NativeBarcodeCaptureDeserializer;
        ...
        this.f120533c = nativeDataCaptureModeDeserializerAsDataCaptureModeDeserializer;
    }
    ...
    public BarcodeCaptureDeserializer _deserializer() {
        BarcodeCaptureDeserializer barcodeCaptureDeserializer = this.f120534d;
    ...
    public BarcodeCapture _modeFromJson(DataCaptureContext dataCaptureContext, String jsonData) {
        ...
        NativeBarcodeCapture nativeBarcodeCaptureBarcodeCaptureFromJson = this.f120531a.barcodeCaptureFromJson(nativeDataCaptureContext_impl, CoreNativeTypeFactory.INSTANCE.convert(jsonData));
    ...
    public BarcodeCaptureOverlay _overlayFromJson(BarcodeCapture mode, String jsonData) {
        ...
        Intrinsics.j(jsonData, "jsonData");
        NativeBarcodeCapture nativeBarcodeCapture_impl = mode.getF120539a();
        this.proxyCache.put(Reflection.b(NativeBarcodeCapture.class), null, nativeBarcodeCapture_impl, mode);
        NativeBarcodeCaptureOverlay nativeBarcodeCaptureOverlayBarcodeCaptureOverlayFromJson = this.f120531a.barcodeCaptureOverlayFromJson(nativeBarcodeCapture_impl, CoreNativeTypeFactory.INSTANCE.convert(jsonData));
        ProxyCache proxyCache = this.proxyCache;
    ...
    public void _setDeserializer(BarcodeCaptureDeserializer deserializer) {
        ...
        this.f120534d = deserializer;
    }

    @Override // com.scandit.datacapture.barcode.capture.BarcodeCaptureDeserializerProxy
    public BarcodeCaptureSettings _settingsFromJson(String jsonData) {
        Intrinsics.j(jsonData, "jsonData");
        NativeBarcodeCaptureSettings nativeBarcodeCaptureSettings = this.f120531a.settingsFromJson(CoreNativeTypeFactory.INSTANCE.convert(jsonData));
        ProxyCache proxyCache = this.proxyCache;
    ...
    public List<String> getWarnings() {
        ArrayList<String> warnings = this.f120531a.getWarnings();
    ...
    public BarcodeCaptureDeserializerHelper get_helper() {
        return (BarcodeCaptureDeserializerHelper) this.proxyCache.requireByValue(Reflection.b(BarcodeCaptureDeserializerHelper.class), this.f120531a.getHelper());
    }
    ...
    public BarcodeCapture updateModeFromJson(BarcodeCapture mode, String jsonData) {
        ...
        NativeBarcodeCapture nativeBarcodeCapture_impl = mode.getF120539a();
        this.proxyCache.put(Reflection.b(NativeBarcodeCapture.class), null, nativeBarcodeCapture_impl, mode);
        NativeBarcodeCapture nativeBarcodeCaptureUpdateBarcodeCaptureFromJson = this.f120531a.updateBarcodeCaptureFromJson(nativeBarcodeCapture_impl, CoreNativeTypeFactory.INSTANCE.convert(jsonData));
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeBarcodeCapture.class);
    ...
    public BarcodeCaptureOverlay updateOverlayFromJson(BarcodeCaptureOverlay overlay, String jsonData) {
        ...
        Intrinsics.j(jsonData, "jsonData");
        NativeBarcodeCaptureOverlay nativeBarcodeCaptureOverlay_impl = overlay.getF124006a();
        this.proxyCache.put(Reflection.b(NativeBarcodeCaptureOverlay.class), null, nativeBarcodeCaptureOverlay_impl, overlay);
        NativeBarcodeCaptureOverlay nativeBarcodeCaptureOverlayUpdateBarcodeCaptureOverlayFromJson = this.f120531a.updateBarcodeCaptureOverlayFromJson(nativeBarcodeCaptureOverlay_impl, CoreNativeTypeFactory.INSTANCE.convert(jsonData));
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeBarcodeCaptureOverlay.class);
    ...
    public BarcodeCaptureSettings updateSettingsFromJson(BarcodeCaptureSettings settings, String jsonData) {
        ...
        Intrinsics.j(jsonData, "jsonData");
        NativeBarcodeCaptureSettings nativeBarcodeCaptureSettings_impl = settings.getF120547a();
        this.proxyCache.put(Reflection.b(NativeBarcodeCaptureSettings.class), null, nativeBarcodeCaptureSettings_impl, settings);
        NativeBarcodeCaptureSettings nativeBarcodeCaptureSettingsUpdateSettingsFromJson = this.f120531a.updateSettingsFromJson(nativeBarcodeCaptureSettings_impl, CoreNativeTypeFactory.INSTANCE.convert(jsonData));
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeBarcodeCaptureSettings.class);
