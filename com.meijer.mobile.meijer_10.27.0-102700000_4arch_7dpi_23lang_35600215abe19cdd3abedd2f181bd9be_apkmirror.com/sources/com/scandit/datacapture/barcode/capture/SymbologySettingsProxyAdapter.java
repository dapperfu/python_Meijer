...
public final class SymbologySettingsProxyAdapter implements SymbologySettingsProxy {
    ...
    private final NativeSymbologySettings f120566a;
    ...
    public SymbologySettingsProxyAdapter(NativeSymbologySettings _NativeSymbologySettings, ProxyCache proxyCache) {
        ...
        this.f120566a = _NativeSymbologySettings;
    ...
    public Set<Short> getActiveSymbolCounts() {
        HashSet<Short> activeSymbolCounts = this.f120566a.getActiveSymbolCounts();
    ...
    public Set<String> getEnabledExtensions() {
        HashSet<String> enabledExtensions = this.f120566a.getEnabledExtensions();
    ...
    public String getOcrFallbackRegex() {
        return this.f120566a.getOcrFallbackRegex();
    }
    ...
    public Symbology getSymbology() {
        Symbology symbology = this.f120566a.getSymbology();
    ...
    public boolean isColorInvertedEnabled() {
        return this.f120566a.isColorInvertedEnabled();
    }

    @Override // com.scandit.datacapture.barcode.capture.SymbologySettingsProxy
    public boolean isEnabled() {
        return this.f120566a.isEnabled();
    }

    @Override // com.scandit.datacapture.barcode.capture.SymbologySettingsProxy
    public boolean isExtensionEnabled(String extension) {
        Intrinsics.j(extension, "extension");
        return this.f120566a.isExtensionEnabled(extension);
    }

    @Override // com.scandit.datacapture.barcode.capture.SymbologySettingsProxy
    public void setActiveSymbolCounts(Set<Short> p02) {
        Intrinsics.j(p02, "p0");
        this.f120566a.setActiveSymbolCounts(BarcodeNativeTypeFactory.INSTANCE.convert(p02));
    }

    @Override // com.scandit.datacapture.barcode.capture.SymbologySettingsProxy
    public void setColorInvertedEnabled(boolean z10) {
        this.f120566a.setColorInvertedEnabled(z10);
    }

    @Override // com.scandit.datacapture.barcode.capture.SymbologySettingsProxy
    public void setEnabled(boolean z10) {
        this.f120566a.setEnabled(z10);
    }

    @Override // com.scandit.datacapture.barcode.capture.SymbologySettingsProxy
    public void setExtensionEnabled(String extension, boolean enabled) {
        Intrinsics.j(extension, "extension");
        this.f120566a.setExtensionEnabled(extension, enabled);
    }

    @Override // com.scandit.datacapture.barcode.capture.SymbologySettingsProxy
    public void setOcrFallbackRegex(String str) {
        this.f120566a.setOcrFallbackRegex(str);
    }

    @Override // com.scandit.datacapture.barcode.capture.SymbologySettingsProxy
    public String toJson() {
        String json = this.f120566a.toJson();
        Intrinsics.g(json);
        return json;
    }
