...
public final class BarcodeFindView extends RelativeLayout {
    ...
    private final DataCaptureContext f120974a;

    /* renamed from: b, reason: collision with root package name */
    private final BarcodeFind f120975b;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private final BarcodeFindViewSettings settings;

    /* renamed from: d, reason: collision with root package name */
    private final DataCaptureView f120977d;

    /* renamed from: e, reason: collision with root package name */
    private final BarcodeFindViewLayout f120978e;

    /* renamed from: f, reason: collision with root package name */
    private final BarcodeFindViewPresenter f120979f;

    /* renamed from: g, reason: collision with root package name */
    private final BarcodeFindBasicOverlay f120980g;

    /* renamed from: h, reason: collision with root package name and from kotlin metadata */
    private final BarcodeFindCameraManager cameraManager;

    /* renamed from: i, reason: collision with root package name */
    private final com.scandit.datacapture.barcode.internal.module.find.ui.listener.c f120982i;
    ...
    public final Anchor getTorchControlPosition() {
        return this.f120978e.i();
    }

    public final void onPause() {
        this.f120977d.removeListener(this.f120982i);
        this.f120975b.removeSearchedItemsUpdateListener$scandit_barcode_capture(this.f120979f);
        this.f120975b.removeOverlayListener$scandit_barcode_capture(this.f120982i);
        this.f120979f.d();
        this.f120974a.removeMode(this.f120975b);
        this.f120977d.removeOverlay(this.f120980g);
    }

    public final void onResume() {
        this.f120977d.addOverlay(this.f120980g);
        this.f120974a.setMode(this.f120975b);
        this.f120979f.f();
        this.f120975b.addOverlayListener$scandit_barcode_capture(this.f120982i);
        this.f120975b.addSearchedItemsUpdateListener$scandit_barcode_capture(this.f120979f);
        this.f120977d.addListener(this.f120982i);
    }
    ...
    public final void setShouldShowHints(boolean z10) {
        this.f120978e.setShouldShowHints(z10);
    }
    ...
    public final void setTextForAllItemsFoundSuccessfullyHint(String str) {
        ...
        BarcodeFindBasicOverlay barcodeFindBasicOverlay = this.f120980g;
        if (str == null) {
    ...
    public BarcodeFindView(Context context, DataCaptureContext dataCaptureContext, BarcodeFind barcodeFind, BarcodeFindViewSettings barcodeFindViewSettings, DataCaptureView dataCaptureView, BarcodeFindViewLayout barcodeFindViewLayout, BarcodeFindViewPresenter barcodeFindViewPresenter, BarcodeFindGuidanceHandler barcodeFindGuidanceHandler, BarcodeFindBasicOverlay barcodeFindBasicOverlay, BarcodeFindCameraManager barcodeFindCameraManager, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        super(context);
        this.f120974a = dataCaptureContext;
        this.f120975b = barcodeFind;
        this.settings = barcodeFindViewSettings;
        this.f120977d = dataCaptureView;
        this.f120978e = barcodeFindViewLayout;
        this.f120979f = barcodeFindViewPresenter;
        this.f120980g = barcodeFindBasicOverlay;
        this.cameraManager = barcodeFindCameraManager;
        this.f120982i = new com.scandit.datacapture.barcode.internal.module.find.ui.listener.c(barcodeFind, barcodeFindViewPresenter);
        setBackgroundColor(d.f121011a);
    ...
    protected void onSizeChanged(int w10, int h10, int oldw, int oldh) {
        ...
        post(new Runnable() { // from class: com.scandit.datacapture.barcode.find.ui.i
            ...
            public final void run() {
                BarcodeFindView.a(this.f121019a);
            }
        });
    }
