...
public final class BarcodeFind implements DataCaptureMode, BarcodeFindProxy {
    ...
    private final /* synthetic */ BarcodeFindProxy f120933a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private BarcodeFindFeedback feedback;

    /* renamed from: c, reason: collision with root package name */
    private DataCaptureContext f120935c;

    /* renamed from: d, reason: collision with root package name */
    private Map f120936d;

    /* renamed from: e, reason: collision with root package name */
    private final Object f120937e;

    /* renamed from: f, reason: collision with root package name */
    private final CopyOnWriteArraySet f120938f;

    /* renamed from: g, reason: collision with root package name */
    private final CopyOnWriteArraySet f120939g;

    /* renamed from: h, reason: collision with root package name */
    private final CopyOnWriteArraySet f120940h;
    ...
    public static final class InternalTransformer extends NativeBarcodeFindTransformer {
        ...
        public String transformBarcodeData(String transformBarcodeData) {
            return this.f120942a.transformBarcodeData(transformBarcodeData);
        }
    }
    ...
    public NativeDataCaptureMode getF120428c() {
        return this.f120933a.getF120954c();
    }
    ...
    public NativeBarcodeFind getF120952a() {
        return this.f120933a.getF120952a();
    }

    @Override // com.scandit.datacapture.core.capture.DataCaptureMode, com.scandit.datacapture.barcode.batch.capture.BarcodeBatchProxy
    @ProxyFunction(property = "isEnabled")
    public boolean isEnabled() {
        return this.f120933a.isEnabled();
    }
    ...
    private BarcodeFind(BarcodeFindProxy barcodeFindProxy) {
        this.f120933a = barcodeFindProxy;
        BarcodeFindFeedback barcodeFindFeedbackDefaultFeedback = BarcodeFindFeedback.INSTANCE.defaultFeedback();
        getF120952a().setFeedback(new BarcodeFind$setNativeFeedback$1(barcodeFindFeedbackDefaultFeedback));
        getF120952a().setItemListUpdatedFeedback(new BarcodeFind$setNativeFeedback$2(barcodeFindFeedbackDefaultFeedback));
        this.feedback = barcodeFindFeedbackDefaultFeedback;
        this.f120936d = MapsKt.k();
        this.f120937e = new Object();
        this.f120938f = new CopyOnWriteArraySet();
        this.f120939g = new CopyOnWriteArraySet();
        this.f120940h = new CopyOnWriteArraySet();
        getF120952a().addListenerAsync(new h(new b(this), this), NativeDataCaptureContext.getListenerPriorityUser());
        getF120952a().addListenerAsync(new h(new a(this), this), NativeDataCaptureContext.getListenerPriorityOverlay());
    }

    private final void a(LinkedHashMap linkedHashMap) {
        synchronized (this.f120937e) {
            this.f120936d = linkedHashMap;
    ...
    public static final Map access$getSearchedItems(BarcodeFind barcodeFind) {
        Map map;
        synchronized (barcodeFind.f120937e) {
            map = barcodeFind.f120936d;
        }
        return map;
    }
    ...
    public final void addSearchedItemsUpdateListener$scandit_barcode_capture(SearchedItemsUpdateListener searchedItemsUpdateListener) {
        ...
        if (this.f120940h.add(searchedItemsUpdateListener)) {
            synchronized (this.f120937e) {
                map = this.f120936d;
            }
    ...
    public final void applySettings(BarcodeFindSettings settings) {
        ...
        getF120952a().applySettingsWrapped(settings._impl());
    }

    @Override // com.scandit.datacapture.core.capture.DataCaptureMode
    /* renamed from: getDataCaptureContext, reason: from getter */
    public DataCaptureContext getF120407c() {
    ...
    public final void removeSearchedItemsUpdateListener$scandit_barcode_capture(SearchedItemsUpdateListener searchedItemsUpdateListener) {
        Intrinsics.j(searchedItemsUpdateListener, "searchedItemsUpdateListener");
        this.f120940h.remove(searchedItemsUpdateListener);
    }

    public final void setFeedback(BarcodeFindFeedback value) {
        Intrinsics.j(value, "value");
        this.feedback = value;
        getF120952a().setFeedback(new BarcodeFind$setNativeFeedback$1(value));
        getF120952a().setItemListUpdatedFeedback(new BarcodeFind$setNativeFeedback$2(value));
    }
    ...
    public final void setItemList(Set<BarcodeFindItem> items) {
        ...
        synchronized (this.f120937e) {
            try {
                NativeBarcodeFind nativeBarcodeFind_impl = getF120952a();
    ...
    public final void setTransformer$scandit_barcode_capture(BarcodeFindTransformer barcodeFindTransformer) {
        ...
        if (barcodeFindTransformer != null) {
            getF120952a().setBarcodeFindTransformerAsync(new InternalTransformer(barcodeFindTransformer));
        }
    }
