...
public final class BarcodeFindSettings implements BarcodeFindSettingsProxy {
    ...
    private final /* synthetic */ BarcodeFindSettingsProxyAdapter f120956a;
    ...
    public static final class Companion {
        ...
        public final BarcodeFindSettings fromJson(String jsonData) {
            ...
            NativeBarcodeFindSettings nativeBarcodeFindSettingsFromJson = NativeBarcodeFindSettings.fromJson(new JsonValue(jsonData).getF125830a());
    ...
    public NativeBarcodeFindSettings getF120957a() {
        return this.f120956a.getF120957a();
    }
    ...
    public void enableSymbologies(Set<? extends Symbology> symbologies) {
        ...
        this.f120956a.enableSymbologies(symbologies);
    }

    @Override // com.scandit.datacapture.barcode.find.capture.BarcodeFindSettingsProxy
    @ProxyFunction(property = "enabledSymbologies")
    public Set<Symbology> getEnabledSymbologies() {
        return this.f120956a.getEnabledSymbologies();
    }
    ...
    public SymbologySettings getSymbologySettings(Symbology symbology) {
        ...
        return this.f120956a.getSymbologySettings(symbology);
    }
    ...
    public void setSymbologyEnabled(Symbology symbology, boolean enabled) {
        Intrinsics.j(symbology, "symbology");
        this.f120956a.setSymbologyEnabled(symbology, enabled);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private BarcodeFindSettings(NativeBarcodeFindSettings nativeBarcodeFindSettings) {
        this.f120956a = new BarcodeFindSettingsProxyAdapter(nativeBarcodeFindSettings, null, 2, 0 == true ? 1 : 0);
    }

    public final Object getProperty(String name) {
        Intrinsics.j(name, "name");
        Integer intProperty = getF120957a().getIntProperty(name);
        if (intProperty != null) {
            return intProperty;
        }
        Boolean boolProperty = getF120957a().getBoolProperty(name);
    ...
    public final void setProperty(String name, Object value) {
        ...
        if (value instanceof Boolean) {
            getF120957a().setBoolProperty(name, ((Boolean) value).booleanValue());
            return;
        }
        Integer numIntFromAny = TypeConverter.INSTANCE.intFromAny(value);
        if (numIntFromAny != null) {
            getF120957a().setIntProperty(name, numIntFromAny.intValue());
        }
    }
