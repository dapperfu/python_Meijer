...
public final class a implements InternalBarcodeFindListener {
    ...
    public final WeakReference f120960a;
    ...
    public final void a(BarcodeFind mode) {
        ...
        BarcodeFind barcodeFind = (BarcodeFind) this.f120960a.get();
        if (barcodeFind != null) {
            Iterator it = barcodeFind.f120939g.iterator();
            while (it.hasNext()) {
    ...
    public a(BarcodeFind owner) {
        ...
        this.f120960a = new WeakReference(owner);
    }
    ...
    public final void c(HashSet barcodes) {
        ...
        BarcodeFind barcodeFind = (BarcodeFind) this.f120960a.get();
        if (barcodeFind == null || barcodeFind.f120940h.isEmpty()) {
            return;
        }
        ...
        Iterator it3 = barcodeFind.f120940h.iterator();
        while (it3.hasNext()) {
