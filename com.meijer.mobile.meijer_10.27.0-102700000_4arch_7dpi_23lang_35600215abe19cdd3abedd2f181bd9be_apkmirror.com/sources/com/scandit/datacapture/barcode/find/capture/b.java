...
public final class b implements InternalBarcodeFindListener {
    ...
    public final WeakReference f120961a;
    ...
    public b(BarcodeFind owner) {
        ...
        this.f120961a = new WeakReference(owner);
    }
    ...
    public final void a(BarcodeFind mode, NativeBarcodeFindSession session, FrameData data) {
        ...
        BarcodeFind barcodeFind = (BarcodeFind) this.f120961a.get();
        if (barcodeFind != null) {
            Iterator it = barcodeFind.f120938f.iterator();
            while (it.hasNext()) {
    ...
    public final void b(HashSet barcodes) {
        Intrinsics.j(barcodes, "barcodes");
        BarcodeFind barcodeFind = (BarcodeFind) this.f120961a.get();
        if (barcodeFind == null || barcodeFind.f120938f.isEmpty()) {
            return;
        }
        ...
        Iterator it2 = barcodeFind.f120938f.iterator();
        while (it2.hasNext()) {
