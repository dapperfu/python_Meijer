...
public final class ArucoMarker implements ArucoMarkerProxy {
    ...
    private final /* synthetic */ ArucoMarkerProxyAdapter f120885a;
    ...
    public NativeArucoMarker getF120886a() {
        return this.f120885a.getF120886a();
    }

    @Override // com.scandit.datacapture.barcode.data.ArucoMarkerProxy
    @ProxyFunction(nativeName = "getBits", property = "data")
    public byte[] getData() {
        return this.f120885a.getData();
    }

    @Override // com.scandit.datacapture.barcode.data.ArucoMarkerProxy
    @ProxyFunction(property = "size")
    public int getSize() {
        return this.f120885a.getSize();
    }

    public ArucoMarker(NativeArucoMarker impl) {
        Intrinsics.j(impl, "impl");
        this.f120885a = new ArucoMarkerProxyAdapter(impl, null, 2, null);
    }
}
