...
public final class b extends Lambda implements Function0 {
    ...
    public final /* synthetic */ NativeAbstractStructuredAppendData f120917a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public b(NativeAbstractStructuredAppendData nativeAbstractStructuredAppendData) {
        super(0);
        this.f120917a = nativeAbstractStructuredAppendData;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
        NativeAbstractStructuredAppendData _0 = this.f120917a;
        Intrinsics.i(_0, "$_0");
