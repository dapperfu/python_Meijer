...
public final class SymbologyDescriptionProxyAdapter implements SymbologyDescriptionProxy {
    ...
    private final NativeSymbologyDescription f120914a;
    ...
    public SymbologyDescriptionProxyAdapter(NativeSymbologyDescription _NativeSymbologyDescription, ProxyCache proxyCache) {
        ...
        this.f120914a = _NativeSymbologyDescription;
    ...
    public Range getActiveSymbolCountRange() {
        Range activeSymbolCountRange = this.f120914a.getActiveSymbolCountRange();
    ...
    public Range getDefaultSymbolCountRange() {
        Range defaultSymbolCountRange = this.f120914a.getDefaultSymbolCountRange();
    ...
    public String getIdentifier() {
        String identifier = this.f120914a.getIdentifier();
    ...
    public String getReadableName() {
        String readableName = this.f120914a.getReadableName();
    ...
    public Symbology getSymbology() {
        Symbology symbology = this.f120914a.getSymbology();
    ...
    public boolean isAvailable() {
        return this.f120914a.isAvailable();
    }

    @Override // com.scandit.datacapture.barcode.data.SymbologyDescriptionProxy
    public boolean isColorInvertible() {
        return this.f120914a.isColorInvertible();
    }

    @Override // com.scandit.datacapture.barcode.data.SymbologyDescriptionProxy
    public String toJson() {
        String json = this.f120914a.toJson();
        Intrinsics.g(json);
        return json;
    }
