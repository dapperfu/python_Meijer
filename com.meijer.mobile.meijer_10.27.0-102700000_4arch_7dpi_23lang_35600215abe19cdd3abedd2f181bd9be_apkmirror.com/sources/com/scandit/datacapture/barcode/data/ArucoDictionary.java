...
public final class ArucoDictionary implements ArucoDictionaryProxy {
    ...
    private final /* synthetic */ ArucoDictionaryProxyAdapter f120881a;
    ...
    public static final class Companion {
        ...
        public final ArucoDictionary createWithMarkers(int markerSize, List<ArucoMarker> markers) {
            ...
            while (it.hasNext()) {
                arrayList.add(((ArucoMarker) it.next()).getF120886a());
            }
    ...
    public NativeArucoDictionary getF120883a() {
        return this.f120881a.getF120883a();
    }

    public ArucoDictionary(NativeArucoDictionary impl) {
        Intrinsics.j(impl, "impl");
        this.f120881a = new ArucoDictionaryProxyAdapter(impl, null, 2, null);
    }
}
