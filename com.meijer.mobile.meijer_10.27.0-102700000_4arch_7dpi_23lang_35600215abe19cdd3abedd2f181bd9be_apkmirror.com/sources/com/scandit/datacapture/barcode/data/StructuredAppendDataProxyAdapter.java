...
public final class StructuredAppendDataProxyAdapter implements StructuredAppendDataProxy {
    ...
    private final NativeAbstractStructuredAppendData f120910a;
    ...
    public StructuredAppendDataProxyAdapter(NativeAbstractStructuredAppendData _NativeAbstractStructuredAppendData, ProxyCache proxyCache) {
        ...
        this.f120910a = _NativeAbstractStructuredAppendData;
    ...
    public String getBarcodeSetId() {
        String barcodeSetId = this.f120910a.getBarcodeSetId();
    ...
    public String getCompleteData() {
        return this.f120910a.getCompleteDataUtf8String();
    }

    @Override // com.scandit.datacapture.barcode.data.StructuredAppendDataProxy
    public List<EncodingRange> getEncodingRanges() {
        ArrayList<EncodingRange> completeDataEncodings = this.f120910a.getCompleteDataEncodings();
    ...
    public byte[] getRawCompleteData() {
        byte[] completeDataRaw = this.f120910a.getCompleteDataRaw();
    ...
    public int getScannedSegmentCount() {
        return this.f120910a.getScannedSegmentCount();
    }

    @Override // com.scandit.datacapture.barcode.data.StructuredAppendDataProxy
    public int getTotalSegmentCount() {
        return this.f120910a.getTotalSegmentCount();
    }

    @Override // com.scandit.datacapture.barcode.data.StructuredAppendDataProxy
    public boolean isComplete() {
        return this.f120910a.isComplete();
    }
