...
public final class BarcodeProxyAdapter implements BarcodeProxy {
    ...
    private final NativeBarcode f120890a;
    ...
    public StructuredAppendData getStructuredAppendData() {
        NativeAbstractStructuredAppendData structuredAppendData = this.f120890a.getStructuredAppendData();
    ...
    public String toJson() {
        String json = this.f120890a.toJson();
        Intrinsics.g(json);
        return json;
    }
}
