...
public final class LocalizedOnlyBarcode implements LocalizedOnlyBarcodeProxy {
    ...
    private final /* synthetic */ LocalizedOnlyBarcodeProxyAdapter f120906a;

    @Override // com.scandit.datacapture.barcode.data.LocalizedOnlyBarcodeProxy
    @NativeImpl
    /* renamed from: _impl */
    public NativeLocalizedOnlyBarcode getF120907a() {
        return this.f120906a.getF120907a();
    }

    @Override // com.scandit.datacapture.barcode.data.LocalizedOnlyBarcodeProxy
    @ProxyFunction(property = "frameId")
    public int getFrameId() {
        return this.f120906a.getFrameId();
    }

    @Override // com.scandit.datacapture.barcode.data.LocalizedOnlyBarcodeProxy
    @ProxyFunction(property = "location")
    public Quadrilateral getLocation() {
        return this.f120906a.getLocation();
    }

    @Override // com.scandit.datacapture.barcode.data.LocalizedOnlyBarcodeProxy
    @ProxyFunction(nativeName = "toJson")
    public String toJson() {
        return this.f120906a.toJson();
    }

    /* JADX WARN: Multi-variable type inference failed */
    public LocalizedOnlyBarcode(NativeLocalizedOnlyBarcode impl) {
        Intrinsics.j(impl, "impl");
        this.f120906a = new LocalizedOnlyBarcodeProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    }
}
