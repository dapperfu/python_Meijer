...
public final class SparkScanSession implements SparkScanSessionProxy {
    ...
    private final Lazy f123865a;

    public SparkScanSession(Function0<? extends NativeSparkScanSession> getImpl) {
        Intrinsics.j(getImpl, "getImpl");
        this.f123865a = LazyKt.b(new a(getImpl));
    }

    @Override // com.scandit.datacapture.barcode.spark.capture.SparkScanSessionProxy
    public long getFrameSequenceId() {
        return ((SparkScanSessionProxyAdapter) this.f123865a.getValue()).getFrameSequenceId();
    }

    @Override // com.scandit.datacapture.barcode.spark.capture.SparkScanSessionProxy
    public Barcode getNewlyRecognizedBarcode() {
        return ((SparkScanSessionProxyAdapter) this.f123865a.getValue()).getNewlyRecognizedBarcode();
    }

    @Override // com.scandit.datacapture.barcode.spark.capture.SparkScanSessionProxy
    public void reset() {
        ((SparkScanSessionProxyAdapter) this.f123865a.getValue()).reset();
    }

    @Override // com.scandit.datacapture.barcode.spark.capture.SparkScanSessionProxy
    public String toJson() {
        return ((SparkScanSessionProxyAdapter) this.f123865a.getValue()).toJson();
    }
}
