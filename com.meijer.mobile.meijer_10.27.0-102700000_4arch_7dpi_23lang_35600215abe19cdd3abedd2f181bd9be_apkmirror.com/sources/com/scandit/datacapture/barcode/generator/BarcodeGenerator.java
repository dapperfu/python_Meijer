...
public final class BarcodeGenerator implements DataCaptureComponent, BarcodeGeneratorProxy {
    ...
    private final /* synthetic */ BarcodeGeneratorProxyAdapter f121020a;
    ...
    public static abstract class BarcodeGeneratorBuilder<BuilderType extends BarcodeGeneratorBuilder<? extends BuilderType>> {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final DataCaptureContext f121021a;

        /* renamed from: b, reason: collision with root package name */
        private final NativeBarcodeGeneratorSymbology f121022b;
        ...
        public BarcodeGeneratorBuilder(DataCaptureContext dataCaptureContext, NativeBarcodeGeneratorSymbology symbology) {
            ...
            this.f121021a = dataCaptureContext;
            this.f121022b = symbology;
        ...
        public final BarcodeGenerator build() {
            return Companion.access$create(BarcodeGenerator.INSTANCE, this.f121021a, this.f121022b, this.options);
        }
    ...
    public static final class Companion {
        ...
        public static final BarcodeGenerator access$create(Companion companion, DataCaptureContext dataCaptureContext, NativeBarcodeGeneratorSymbology nativeBarcodeGeneratorSymbology, BarcodeGeneratorOptions barcodeGeneratorOptions) {
            companion.getClass();
            NativeBarcodeGeneratorFactoryResult nativeBarcodeGeneratorFactoryResultCreate = NativeBarcodeGenerator.create(dataCaptureContext.getF124053a(), nativeBarcodeGeneratorSymbology, BarcodeGeneratorKt.toNativeOptions(barcodeGeneratorOptions));
    ...
    public NativeDataCaptureComponent getF121033c() {
        return this.f121020a.getF121033c();
    }
    ...
    public NativeBarcodeGenerator getF121031a() {
        return this.f121020a.getF121031a();
    }

    public final Bitmap generate(byte[] data, int imageWidth) {
        Intrinsics.j(data, "data");
        NativeBarcodeGeneratorGenerateResult nativeBarcodeGeneratorGenerateResultGenerate = getF121031a().generate(data, CollectionsExtensionsKt.toArrayList(CollectionsKt.m()));
        if (!nativeBarcodeGeneratorGenerateResultGenerate.ok()) {
            ...
            if (StringsKt.a0(strError, "Invalid input", true)) {
    ...
    public String getId() {
        return this.f121020a.getId();
    }

    public BarcodeGenerator(NativeBarcodeGenerator impl) {
        Intrinsics.j(impl, "impl");
        this.f121020a = new BarcodeGeneratorProxyAdapter(impl, null, 2, null);
    }
