...
public final class BarcodeGeneratorKt {
    ...
    public static final Bitmap access$toBitmap(ImageBuffer imageBuffer, int i10, int i11) {
        ...
        bitmapCreateBitmap.reconfigure(imageBuffer.getF124144a().getWidth(), imageBuffer.getF124144a().getHeight(), config);
        bitmapCreateBitmap.copyPixelsFromBuffer(ByteBuffer.wrap(imageBuffer.getF124144a().toBitmap()));
