...
public final class BinsView extends FrameLayout {
    ...
    private final int f123455a;

    /* renamed from: b, reason: collision with root package name */
    private final int f123456b;

    /* renamed from: c, reason: collision with root package name */
    private final int f123457c;

    /* renamed from: d, reason: collision with root package name */
    private final int f123458d;

    /* renamed from: e, reason: collision with root package name */
    private final int f123459e;

    /* renamed from: f, reason: collision with root package name */
    private final float f123460f;

    /* renamed from: g, reason: collision with root package name */
    private final float f123461g;

    /* renamed from: h, reason: collision with root package name */
    private final float f123462h;

    /* renamed from: i, reason: collision with root package name */
    private final RectF f123463i;

    /* renamed from: j, reason: collision with root package name */
    private final RectF f123464j;

    /* renamed from: k, reason: collision with root package name */
    private final BinDrawable f123465k;

    /* renamed from: l, reason: collision with root package name */
    private List f123466l;

    /* renamed from: m, reason: collision with root package name */
    private final SparseArray f123467m;

    /* renamed from: n, reason: collision with root package name */
    private final SparseArray f123468n;

    /* renamed from: o, reason: collision with root package name */
    private Grid f123469o;

    /* renamed from: p, reason: collision with root package name and from kotlin metadata */
    private EditListener onEditListener;

    /* renamed from: q, reason: collision with root package name */
    private TouchedElement f123471q;

    /* renamed from: r, reason: collision with root package name */
    private Integer f123472r;

    /* renamed from: s, reason: collision with root package name */
    private float f123473s;

    /* renamed from: t, reason: collision with root package name */
    private float f123474t;
    ...
    public static final class Grid {
        ...
        public final void swapSub(int fromIndex, int toIndex) {
            Item item;
            Item item2 = (Item) this.f123477c.get(fromIndex);
            if (item2 == null || (item = (Item) this.f123477c.get(toIndex)) == null) {
                return;
            }
            this.f123477c.set(fromIndex, new Item(item2.getToteText(), item.getSubText()));
            this.f123477c.set(toIndex, new Item(item.getToteText(), item2.getSubText()));
        }

        public final void swapTote(int fromIndex, int toIndex) {
            Item item = (Item) this.f123477c.get(fromIndex);
            List list = this.f123477c;
            list.set(fromIndex, list.get(toIndex));
            this.f123477c.set(toIndex, item);
        }
    }
    ...
    private final void a(final SubView subView, int i10, final Function0 function0) {
        int columns = i10 % this.f123469o.getColumns();
        int columns2 = i10 / this.f123469o.getColumns();
        float x10 = subView.getX();
        float y10 = subView.getY();
        int i11 = this.f123455a;
        int i12 = this.f123457c;
        float f10 = ((i11 + i12) * columns) + this.f123460f;
        float f11 = ((this.f123456b + i12) * columns2) + this.f123461g;
    ...
    public static final void access$displayToteSubs(BinsView binsView) {
        com.scandit.datacapture.barcode.internal.module.extensions.c.a(binsView.f123468n, d.f123521a);
        com.scandit.datacapture.barcode.internal.module.extensions.c.a(binsView.f123467m, e.f123522a);
    }

    public static final void access$swapSubIndex(BinsView binsView, int i10, int i11) {
        ToteView toteView = (ToteView) binsView.f123467m.get(i10);
        ToteView toteView2 = (ToteView) binsView.f123467m.get(i11);
        String subBarcode = toteView.getSubBarcode();
        toteView.setSubBarcode(toteView2.getSubBarcode());
        toteView2.setSubBarcode(subBarcode);
        SubView subView = (SubView) binsView.f123468n.get(i10);
        SubView subView2 = (SubView) binsView.f123468n.get(i11);
        binsView.f123468n.put(i11, subView);
        binsView.f123468n.put(i10, subView2);
        binsView.f123469o.swapSub(i10, i11);
    ...
    public static final void access$swapToteIndex(BinsView binsView, int i10, int i11) {
        ToteView toteView = (ToteView) binsView.f123467m.get(i10);
        ToteView toteView2 = (ToteView) binsView.f123467m.get(i11);
        binsView.f123467m.put(i11, toteView);
        binsView.f123467m.put(i10, toteView2);
        SubView subView = (SubView) binsView.f123468n.get(i10);
        SubView subView2 = (SubView) binsView.f123468n.get(i11);
        binsView.f123468n.put(i11, subView);
        binsView.f123468n.put(i10, subView2);
        binsView.f123469o.swapTote(i10, i11);
        EditListener editListener = binsView.onEditListener;
        if (editListener != null) {
    ...
    public final void initialize(Grid grid, Settings settings) {
        ...
        this.f123469o = grid;
        Iterator it = this.f123466l.iterator();
        while (it.hasNext()) {
        ...
        int i11 = (this.f123455a - iPxFromDp) / 2;
        ...
        while (it2.hasNext()) {
            ...
            int columns = iNextInt % this.f123469o.getColumns();
            int columns2 = iNextInt / this.f123469o.getColumns();
            TextView textView = new TextView(getContext());
            textView.setGravity(17);
            int i13 = this.f123459e;
            ...
            textView.setText(StringsKt.c0(toteTextFormat, POSITION_TOKEN, z10, 2, null) ? StringsKt.y1(StringsKt.Q(toteTextFormat, POSITION_TOKEN, strValueOf, false, 4, null)).toString() : StringsKt.y1(toteTextFormat).toString() + ' ' + strValueOf);
            ViewGroup.LayoutParams layoutParams = new FrameLayout.LayoutParams(iPxFromDp, iPxFromDp2);
            textView.setX(((this.f123455a + this.f123457c) * columns) + i10);
            textView.setY((this.f123456b + this.f123457c) * columns2);
        ...
        int i15 = i12;
        this.f123466l = arrayList;
        com.scandit.datacapture.barcode.internal.module.extensions.c.a(this.f123467m, new h(this));
        com.scandit.datacapture.barcode.internal.module.extensions.c.a(this.f123468n, new i(this));
        this.f123467m.clear();
        this.f123468n.clear();
        int iA = a();
        for (int i16 = i15; i16 < iA; i16++) {
            int columns3 = i16 % this.f123469o.getColumns();
            int columns4 = i16 / this.f123469o.getColumns();
            Item itemItemAtIndex = this.f123469o.itemAtIndex(i16);
            if (itemItemAtIndex != null) {
                SparseArray sparseArray = this.f123467m;
                ...
                ViewGroup.LayoutParams layoutParams2 = new FrameLayout.LayoutParams(this.f123455a, this.f123456b);
                toteView.setX((this.f123455a + this.f123457c) * columns3);
                toteView.setY((this.f123456b + this.f123457c) * columns4);
        ...
        for (int i17 = i15; i17 < iA2; i17++) {
            Item itemItemAtIndex2 = this.f123469o.itemAtIndex(i17);
            if (itemItemAtIndex2 != null && (subText = itemItemAtIndex2.getSubText()) != null && subText.length() != 0) {
                SparseArray sparseArray2 = this.f123468n;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i10 = 0; i10 < iA; i10++) {
            ...
            int i11 = this.f123455a;
            int i12 = this.f123457c;
            canvas.translate(columns * (i11 + i12), columns2 * (this.f123456b + i12));
            this.f123465k.draw(canvas);
            canvas.restore();
        }
    }
    ...
    */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(((this.f123469o.getColumns() - 1) * this.f123457c) + (this.f123469o.getColumns() * this.f123455a), ((this.f123469o.getRows() - 1) * this.f123457c) + (this.f123469o.getRows() * this.f123456b));
    }
    ...
    public BinsView(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.f123455a = iPxFromDp;
        int iPxFromDp2 = PixelExtensionsKt.pxFromDp(TOTE_HEIGHT_DP, context);
        this.f123456b = iPxFromDp2;
        this.f123457c = PixelExtensionsKt.pxFromDp(20, context);
        int iPxFromDp3 = (int) PixelExtensionsKt.pxFromDp(66.0f, context);
        this.f123458d = iPxFromDp3;
        this.f123459e = PixelExtensionsKt.pxFromDp(8, context);
        float fPxFromDp = PixelExtensionsKt.pxFromDp(16.0f, context);
        this.f123460f = fPxFromDp;
        float fPxFromDp2 = PixelExtensionsKt.pxFromDp(30.0f, context);
        this.f123461g = fPxFromDp2;
        this.f123462h = PixelExtensionsKt.pxFromDp(4.0f, context);
        this.f123463i = new RectF(0.0f, 0.0f, iPxFromDp, iPxFromDp2);
        float f10 = iPxFromDp3;
        this.f123464j = new RectF(fPxFromDp, fPxFromDp2, fPxFromDp + f10, f10 + fPxFromDp2);
        BinDrawable binDrawable = new BinDrawable(context);
        binDrawable.setBounds(0, 0, iPxFromDp, iPxFromDp2);
        this.f123465k = binDrawable;
        this.f123466l = CollectionsKt.m();
        this.f123467m = new SparseArray();
        this.f123468n = new SparseArray();
        this.f123469o = Grid.INSTANCE.emptyGrid();
        setWillNotDraw(false);
        setClipChildren(false);
        setClipToPadding(false);
        this.f123471q = TouchedElement.Nothing.INSTANCE;
    }
    ...
    private final void a(final ToteView toteView, int i10, final Function0 function0) {
        ...
        float f11 = (this.f123456b + i12) * columns2;
        final a aVar = new a(x10, f10);
        final a aVar2 = new a(y10, f11);
    ...
    private final int a() {
        return this.f123469o.getColumns() * this.f123469o.getRows();
    }
    ...
    private final Integer a(FrameLayout frameLayout) {
        ...
        int i10 = this.f123457c;
        int i11 = i10 / 2;
        int i12 = (width + i11) / (this.f123455a + i10);
        int i13 = (i11 + height) / (this.f123456b + i10);
        if (i12 < 0 || i12 >= this.f123469o.getColumns() || i13 < 0 || i13 >= this.f123469o.getRows()) {
            return null;
        }
        return Integer.valueOf((this.f123469o.getColumns() * i13) + i12);
    }
