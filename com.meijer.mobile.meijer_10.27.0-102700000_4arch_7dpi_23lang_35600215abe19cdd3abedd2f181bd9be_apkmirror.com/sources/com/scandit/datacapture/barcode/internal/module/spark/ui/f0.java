...
public final class f0 extends Handler implements e0 {
    ...
    public final WeakReference f123122a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f0(SparkScanViewPresenter parent) {
        super(Looper.getMainLooper());
        Intrinsics.j(parent, "parent");
        this.f123122a = new WeakReference(parent);
    }

    @Override // android.os.Handler
    public final void handleMessage(Message msg) {
        Intrinsics.j(msg, "msg");
        SparkScanViewPresenter sparkScanViewPresenter = (SparkScanViewPresenter) this.f123122a.get();
