...
public final class C13223c extends View {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C13223c(Context context) {
        super(context);
        ...
        gradientDrawable.setColor(com.scandit.datacapture.barcode.internal.module.spark.ui.E.f122970E);
