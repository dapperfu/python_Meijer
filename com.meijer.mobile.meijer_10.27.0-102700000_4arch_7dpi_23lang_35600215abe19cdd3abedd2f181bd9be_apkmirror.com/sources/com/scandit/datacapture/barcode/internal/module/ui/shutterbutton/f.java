...
public final class f extends FrameLayout implements Animatable {
    ...
    public static final Lazy f123414b = LazyKt.b(e.f123413a);

    /* renamed from: a, reason: collision with root package name */
    public final PulsingView f123415a;
    ...
    public f(Context context) {
        ...
        int iIntValue = ((Number) f123414b.getValue()).intValue();
        ...
        this.f123415a = pulsingView;
    }

    @Override // android.graphics.drawable.Animatable
    public final boolean isRunning() {
        return this.f123415a.isRunning();
    }
