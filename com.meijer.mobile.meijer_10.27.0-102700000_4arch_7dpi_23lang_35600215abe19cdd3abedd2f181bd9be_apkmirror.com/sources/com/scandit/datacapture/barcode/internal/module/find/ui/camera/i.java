...
public final class i extends Button {
    ...
    public static final int f122203c = Color.parseColor("#40000000");

    /* renamed from: d, reason: collision with root package name */
    public static final int f122204d = Color.parseColor("#FFFBC02C");

    /* renamed from: e, reason: collision with root package name */
    public static final int f122205e = Color.parseColor("#FFFFFFFF");

    /* renamed from: f, reason: collision with root package name */
    public static final Lazy f122206f = LazyKt.b(f.f122201a);

    /* renamed from: g, reason: collision with root package name */
    public static final Lazy f122207g = LazyKt.b(g.f122202a);

    /* renamed from: a, reason: collision with root package name */
    public final DecimalFormat f122208a;

    /* renamed from: b, reason: collision with root package name */
    public float f122209b;
    ...
    public i(Context context) {
        ...
        this.f122208a = decimalFormat;
        setPadding(0, 0, 0, 0);
        GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setColor(f122203c);
    ...
    public final void a(float f10) {
        String str = this.f122208a.format(Float.valueOf(f10));
        if (!isSelected()) {
            setText(str);
            return;
        }
