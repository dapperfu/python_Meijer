...
public final class f implements BarcodePickListener {
    ...
    public final WeakReference f122433a;
    ...
    public f(BarcodePickInternal owner) {
        ...
        this.f122433a = new WeakReference(owner);
    }
    ...
    public final void a(BarcodePickInternal mode, Map requestedData) {
        ...
        BarcodePickInternal barcodePickInternal = (BarcodePickInternal) this.f122433a.get();
        if (barcodePickInternal == null || (copyOnWriteArraySet = barcodePickInternal.f122413e) == null) {
            return;
        }
