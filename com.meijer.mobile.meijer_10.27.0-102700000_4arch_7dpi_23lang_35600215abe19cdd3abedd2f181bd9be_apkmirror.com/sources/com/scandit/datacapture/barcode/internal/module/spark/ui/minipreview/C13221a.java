...
public final class C13221a extends RelativeLayout {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C13221a(Context context) {
        super(context);
        ...
        setId(com.scandit.datacapture.barcode.internal.module.spark.ui.E.f122974d);
