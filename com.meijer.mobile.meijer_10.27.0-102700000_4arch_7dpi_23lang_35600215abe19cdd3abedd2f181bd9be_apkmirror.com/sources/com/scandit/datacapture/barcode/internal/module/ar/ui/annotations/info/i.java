...
public final class i extends RelativeLayout {
    ...
    public final h f121094a;

    /* renamed from: b, reason: collision with root package name */
    public final ImageView f121095b;

    /* renamed from: c, reason: collision with root package name */
    public final ImageView f121096c;

    /* renamed from: d, reason: collision with root package name */
    public final TextView f121097d;

    /* renamed from: f, reason: collision with root package name */
    public static final /* synthetic */ KProperty[] f121091f = {com.scandit.datacapture.barcode.ar.ui.annotations.a.a(i.class, "data", "getData()Lcom/scandit/datacapture/barcode/ar/ui/annotations/BarcodeArBodyElementRowDataHolder;", 0)};

    /* renamed from: e, reason: collision with root package name */
    public static final f f121090e = new f();

    /* renamed from: g, reason: collision with root package name */
    public static final Lazy f121092g = LazyKt.b(d.f121086a);

    /* renamed from: h, reason: collision with root package name */
    public static final Lazy f121093h = LazyKt.b(e.f121087a);

    public final BarcodeArBodyElementRowDataHolder a() {
        return (BarcodeArBodyElementRowDataHolder) this.f121094a.getValue(this, f121091f[0]);
    }
    ...
    public final void b() {
        ...
        if (styledText == null || styledText.length() == 0) {
            this.f121097d.setText(bodyElement.getText());
            this.f121097d.setTextColor(bodyElement.getTextColor());
            this.f121097d.setTypeface(bodyElement.getTypeface());
            this.f121097d.setTextSize(bodyElement.getTextSize());
            this.f121097d.setTextAlignment(bodyElement.getTextAlignment());
        } else {
            this.f121097d.setText(bodyElement.getStyledText());
        }
        a(a().getBodyElement());
        b(a().getBodyElement());
        ...
        ViewGroup.LayoutParams layoutParams = this.f121095b.getLayoutParams();
        ...
        ViewGroup.LayoutParams layoutParams3 = this.f121096c.getLayoutParams();
        ...
        ViewGroup.LayoutParams layoutParams5 = this.f121097d.getLayoutParams();
        ...
        if (z12) {
            ...
            int i11 = g.f121088a[a().getWidth().ordinal()];
            if (i11 == 1 || i11 == 2) {
                i10 = 8;
            } else {
                if (i11 != 3) {
        ...
        ImageView imageView = this.f121095b;
        ...
        ImageView imageView2 = this.f121096c;
        if (barcodeArBodyElementRowDataHolderA.isEntireAnnotationTappable()) {
        ...
        TextView textView = this.f121097d;
        if (barcodeArBodyElementRowDataHolderA.isEntireAnnotationTappable()) {
    ...
    public final void a(BarcodeArInfoAnnotationBodyComponent barcodeArInfoAnnotationBodyComponent) {
        this.f121095b.setVisibility(barcodeArInfoAnnotationBodyComponent.getLeftIcon() == null ? 8 : 0);
        ...
        this.f121095b.setOnClickListener(new View.OnClickListener() { // from class: Gt.b
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                i.a(this.f11925a, view);
            }
        });
        this.f121095b.setClickable(z10);
    }
    ...
    public final void b(BarcodeArInfoAnnotationBodyComponent barcodeArInfoAnnotationBodyComponent) {
        this.f121096c.setVisibility(barcodeArInfoAnnotationBodyComponent.getRightIcon() == null ? 8 : 0);
        ...
        if (rightIcon != null) {
            ImageView imageView = this.f121096c;
            ColorStateList colorStateListValueOf = ColorStateList.valueOf(z10 ? getContext().getColor(com.scandit.datacapture.core.R.color.sc_default_ripple) : 0);
            Context context = getContext();
            Intrinsics.i(context, "getContext(...)");
        ...
        this.f121096c.setOnClickListener(new View.OnClickListener() { // from class: Gt.a
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                i.b(this.f11924a, view);
            }
        });
        this.f121096c.setClickable(z10);
    }
