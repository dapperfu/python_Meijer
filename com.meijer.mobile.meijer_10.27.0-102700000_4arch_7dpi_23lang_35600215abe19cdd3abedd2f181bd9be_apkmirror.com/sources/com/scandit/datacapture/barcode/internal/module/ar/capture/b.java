...
public final class b implements BarcodeArListener {
    ...
    public final WeakReference f121059a;

    public b(BarcodeArInternal owner) {
        Intrinsics.j(owner, "owner");
        this.f121059a = new WeakReference(owner);
    }
    ...
    public final void onSessionUpdated(BarcodeAr barcodeAr, BarcodeArSession session, FrameData frameData) {
        ...
        BarcodeArInternal barcodeArInternal = (BarcodeArInternal) this.f121059a.get();
        if (barcodeArInternal == null || (copyOnWriteArraySet = barcodeArInternal.f121054g) == null) {
            return;
        }
