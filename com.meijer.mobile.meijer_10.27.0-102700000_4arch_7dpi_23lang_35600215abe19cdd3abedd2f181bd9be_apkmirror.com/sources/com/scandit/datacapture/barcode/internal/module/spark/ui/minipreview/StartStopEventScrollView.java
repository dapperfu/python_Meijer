...
public final class StartStopEventScrollView extends HorizontalScrollView {
    ...
    private InterfaceC13224d f123189a;

    /* renamed from: b, reason: collision with root package name */
    private Function1 f123190b;

    /* renamed from: c, reason: collision with root package name */
    private boolean f123191c;
    ...
    public static final void a(StartStopEventScrollView this$0, View view, int i10, int i11, int i12, int i13) {
        ...
        Function1 function1 = this$0.f123190b;
        if (function1 != null) {
    ...
    public StartStopEventScrollView(Context context, AttributeSet attributeSet, int i10) {
        ...
        setOnScrollChangeListener(new View.OnScrollChangeListener() { // from class: Ut.i
            ...
            public final void onScrollChange(View view, int i11, int i12, int i13, int i14) {
                StartStopEventScrollView.a(this.f36323a, view, i11, i12, i13, i14);
            }
        });
        setOnTouchListener(new View.OnTouchListener() { // from class: Ut.j
            @Override // android.view.View.OnTouchListener
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return StartStopEventScrollView.a(this.f36324a, view, motionEvent);
            }
        });
    }
    ...
    */
    public static final boolean a(com.scandit.datacapture.barcode.internal.module.spark.ui.minipreview.StartStopEventScrollView r3, android.view.View r4, android.view.MotionEvent r5) {
        ...
        L19:
            ...
            if (r4 == 0) goto L5c
        L29:
            com.scandit.datacapture.barcode.internal.module.spark.ui.minipreview.d r4 = r3.f123189a
            if (r4 == 0) goto L3a
            ...
            com.scandit.datacapture.barcode.internal.module.spark.ui.minipreview.N r4 = r4.f123168a
            com.scandit.datacapture.barcode.internal.module.spark.ui.minipreview.A r4 = r4.f123174b
            if (r4 == 0) goto L3a
