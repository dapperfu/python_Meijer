...
public final class p extends NativeSparkScanToastPresenterDelegate {
    ...
    public final CameraPosition getCameraPosition() {
        ...
        SparkScanViewPresenter sparkScanViewPresenter = (SparkScanViewPresenter) ((K) this.f123268a).f123003a.get();
        return (sparkScanViewPresenter == null || (cameraPositionB = SparkScanViewPresenter.b(sparkScanViewPresenter)) == null) ? d0.f123118a : cameraPositionB;
    }
    ...
    public final TorchState getTorchState() {
        ...
        SparkScanViewPresenter sparkScanViewPresenter = (SparkScanViewPresenter) ((K) this.f123268a).f123003a.get();
        return (sparkScanViewPresenter == null || (torchStateG = SparkScanViewPresenter.g(sparkScanViewPresenter)) == null) ? d0.f123119b : torchStateG;
    }
    ...
    public final void showToast(NativeSparkScanToastType toast) {
        ...
        K k10 = (K) this.f123268a;
        k10.getClass();
        Intrinsics.j(toast, "toast");
        SparkScanViewPresenter sparkScanViewPresenter = (SparkScanViewPresenter) k10.f123003a.get();
        if (sparkScanViewPresenter != null) {
    ...
    public p(K _SparkScanToastPresenterDelegate) {
        ...
        this.f123268a = _SparkScanToastPresenterDelegate;
    }
}
