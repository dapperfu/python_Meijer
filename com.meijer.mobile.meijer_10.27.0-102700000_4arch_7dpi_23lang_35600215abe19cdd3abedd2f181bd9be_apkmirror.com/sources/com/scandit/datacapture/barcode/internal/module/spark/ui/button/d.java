...
public final class d extends Lambda implements Function1 {
    ...
    public final /* synthetic */ e f123078a;
        ...
        if (iOrdinal != 0) {
            switch (iOrdinal) {
                case 6:
                    ...
                    break;
                case 7:
                    k kVar2 = this.f123078a.f123081c;
                    if (kVar2 != null) {
                    ...
                    break;
                case 8:
                    k kVar3 = this.f123078a.f123081c;
                    if (kVar3 != null) {
                    ...
                    break;
                case 9:
                    k kVar4 = this.f123078a.f123081c;
                    if (kVar4 != null) {
                    ...
                    break;
                case 10:
                    k kVar5 = this.f123078a.f123081c;
                    if (kVar5 != null) {
            ...
            k kVar6 = this.f123078a.f123081c;
            if (kVar6 != null) {
