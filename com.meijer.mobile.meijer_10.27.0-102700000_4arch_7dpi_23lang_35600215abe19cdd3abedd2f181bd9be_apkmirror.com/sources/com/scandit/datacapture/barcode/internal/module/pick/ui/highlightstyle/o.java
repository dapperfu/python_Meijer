...
public final class o implements BarcodePickIcon {
    ...
    public final boolean equals(Object obj) {
        ...
        return this.f122783a == ((o) obj).f122783a;
    }

    @Override // com.scandit.datacapture.barcode.internal.module.pick.ui.highlightstyle.BarcodePickIcon
    public final Drawable a(Context context) {
        Intrinsics.j(context, "context");
        Drawable drawable = this.f122784b;
        if (drawable != null) {
            return drawable;
        }
        Drawable drawableResources_getDrawable = FS.Resources_getDrawable(context, this.f122783a);
        this.f122784b = drawableResources_getDrawable;
