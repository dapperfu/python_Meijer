...
public final class m extends FrameLayout {
    ...
    public static final Lazy f121734c = LazyKt.b(l.f121733a);

    /* renamed from: d, reason: collision with root package name */
    public static final Lazy f121735d = LazyKt.b(k.f121732a);

    /* renamed from: a, reason: collision with root package name */
    public final View f121736a;

    /* renamed from: b, reason: collision with root package name */
    public final TextView f121737b;
    ...
    public m(Context context) {
        ...
        addView(viewInflate, new FrameLayout.LayoutParams(((Number) f121734c.getValue()).intValue(), ((Number) f121735d.getValue()).intValue()));
        this.f121736a = viewInflate;
        this.f121737b = (TextView) findViewById(R.id.sc_textview);
    }

    public final void a(Size previewSize, int i10) {
        Intrinsics.j(previewSize, "previewSize");
        View view = this.f121736a;
        Intrinsics.i(view, "subview");
        Size viewDesiredSize = new Size(((Number) f121734c.getValue()).intValue(), ((Number) f121735d.getValue()).intValue());
