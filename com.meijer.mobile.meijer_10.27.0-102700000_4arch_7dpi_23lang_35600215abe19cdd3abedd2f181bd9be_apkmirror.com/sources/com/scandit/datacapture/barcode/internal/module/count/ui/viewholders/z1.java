...
public final class z1 {
    ...
    public z1(ViewGroup container) {
        ...
        this.f122115a = container;
        this.f122116b = new Handler(Looper.getMainLooper());
    }
    ...
    public final void b(View view, Function0 creator) {
        ...
        this.f122115a.addView(view);
    }

    public final void a(final Function1 action) {
        Intrinsics.j(action, "action");
        this.f122116b.post(new Runnable() { // from class: Pt.k
