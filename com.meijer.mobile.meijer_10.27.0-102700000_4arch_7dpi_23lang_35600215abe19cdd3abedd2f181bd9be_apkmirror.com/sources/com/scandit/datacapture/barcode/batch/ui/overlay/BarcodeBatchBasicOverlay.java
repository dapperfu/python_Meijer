...
public final class BarcodeBatchBasicOverlay implements DataCaptureOverlay, BarcodeBatchBasicOverlayProxy {
    ...
    private final /* synthetic */ BarcodeBatchBasicOverlayProxyAdapter f120492a;

    /* renamed from: b, reason: collision with root package name */
    private final HashMap f120493b;
    ...
    public static final class Companion {
        ...
        public final BarcodeBatchBasicOverlay newInstance(BarcodeBatch mode, DataCaptureView view) {
            ...
            OverlayPreconditionsKt.checkAttachedToSameDataCaptureContext(mode, view, a.f120503a);
        ...
        public final BarcodeBatchBasicOverlay newInstance(BarcodeBatch mode, DataCaptureView view, BarcodeBatchBasicOverlayStyle style) {
            Intrinsics.j(mode, "mode");
            Intrinsics.j(style, "style");
            OverlayPreconditionsKt.checkAttachedToSameDataCaptureContext(mode, view, b.f120504a);
    ...
    public BarcodeBatchBasicOverlay(NativeBarcodeTrackingBasicOverlay impl) {
        ...
        this.f120492a = new BarcodeBatchBasicOverlayProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        this.f120493b = new HashMap();
    ...
    public NativeDataCaptureOverlay getF120500c() {
        return this.f120492a.getF120500c();
    }
    ...
    public NativeBarcodeTrackingBasicOverlay getF120498a() {
        return this.f120492a.getF120498a();
    }
    ...
    public void setBrushForTrackedBarcode(TrackedBarcode trackedBarcode, Brush brush) {
        ...
        this.f120492a.setBrushForTrackedBarcode(trackedBarcode, brush);
    }

    @Override // com.scandit.datacapture.barcode.batch.ui.overlay.BarcodeBatchBasicOverlayProxy
    @ProxyFunction(property = "shouldShowScanAreaGuides")
    public void setShouldShowScanAreaGuides(boolean z10) {
        this.f120492a.setShouldShowScanAreaGuides(z10);
    }
    ...
    public final Object getProperty(String name) {
        ...
        Object obj = this.f120493b.get(name);
        if (obj != null) {
            return obj;
        }
        try {
            return Boolean.valueOf(getF120498a().getBoolProperty(name));
    ...
    public final void setProperty(String name, Object value) {
        Intrinsics.j(name, "name");
        this.f120493b.put(name, value);
        if (value instanceof Boolean) {
            getF120498a().setBoolProperty(name, ((Boolean) value).booleanValue());
        }
    }
