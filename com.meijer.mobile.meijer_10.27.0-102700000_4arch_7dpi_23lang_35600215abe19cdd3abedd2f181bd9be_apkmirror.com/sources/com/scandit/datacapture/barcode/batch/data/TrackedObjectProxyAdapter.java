...
public final class TrackedObjectProxyAdapter implements TrackedObjectProxy {
    ...
    private final NativeTrackedObject f120473a;
    ...
    public TrackedObjectProxyAdapter(NativeTrackedObject _NativeTrackedObject, ProxyCache proxyCache) {
        ...
        this.f120473a = _NativeTrackedObject;
    ...
    public String getData() {
        return this.f120473a.getUtf8String();
    }

    @Override // com.scandit.datacapture.barcode.batch.data.TrackedObjectProxy
    public int getIdentifier() {
        return this.f120473a.getIdentifier();
    }

    @Override // com.scandit.datacapture.barcode.batch.data.TrackedObjectProxy
    public Quadrilateral getLocation() {
        Quadrilateral location = this.f120473a.getLocation();
    ...
    public String toJson() {
        String json = this.f120473a.toJson();
        Intrinsics.g(json);
        return json;
    }
