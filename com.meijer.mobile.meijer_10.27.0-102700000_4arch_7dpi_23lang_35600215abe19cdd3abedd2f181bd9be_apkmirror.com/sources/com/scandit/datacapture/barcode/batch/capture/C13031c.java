...
public final class C13031c implements BarcodeBatchListener {

    /* renamed from: a, reason: collision with root package name */
    public final WeakReference f120445a;

    public C13031c(BarcodeBatch owner) {
        Intrinsics.j(owner, "owner");
        this.f120445a = new WeakReference(owner);
    }
    ...
    public final void onSessionUpdated(BarcodeBatch mode, BarcodeBatchSession session, FrameData data) {
        ...
        BarcodeBatch barcodeBatch = (BarcodeBatch) this.f120445a.get();
