...
public final class BarcodeBatchSettings implements BarcodeBatchSettingsProxy {
    ...
    private final /* synthetic */ BarcodeBatchSettingsProxyAdapter f120433a;

    /* renamed from: b, reason: collision with root package name */
    private com.scandit.datacapture.barcode.internal.module.batch.capture.a f120434b;
    ...
    public BarcodeBatchSettings(NativeBarcodeTrackingSettings impl) {
        ...
        this.f120433a = new BarcodeBatchSettingsProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    }
    ...
    @NativeImpl
    /* renamed from: _impl */
    public NativeBarcodeTrackingSettings getF120435a() {
        return this.f120433a.getF120435a();
    }
    ...
    public void enableSymbologies(Set<? extends Symbology> symbologies) {
        ...
        this.f120433a.enableSymbologies(symbologies);
    }
    ...
    public void enableSymbology(Symbology symbology, boolean enabled) {
        ...
        this.f120433a.enableSymbology(symbology, enabled);
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSettingsProxy
    @ProxyFunction(property = "enabledSymbologies")
    public Set<Symbology> getEnabledSymbologies() {
        return this.f120433a.getEnabledSymbologies();
    }
    ...
    public boolean getExpectsOnlyUniqueBarcodes() {
        return this.f120433a.getExpectsOnlyUniqueBarcodes();
    }
        ...
        if (iHashCode != -1372984747) {
            if (iHashCode != -272164569) {
                if (iHashCode == 670080312 && name.equals("freezeIndicator")) {
                    com.scandit.datacapture.barcode.internal.module.batch.capture.a aVar = this.f120434b;
                    if (aVar == null) {
                        return -1;
                    }
                    return aVar;
                ...
                com.scandit.datacapture.barcode.internal.module.batch.capture.a aVar2 = this.f120434b;
                if (aVar2 == null || (runnable = aVar2.f121263a) == null) {
                    return -1;
                }
                return runnable;
            }
        } else if (name.equals("freezeIndicationWaitTime")) {
            com.scandit.datacapture.barcode.internal.module.batch.capture.a aVar3 = this.f120434b;
            return Integer.valueOf(aVar3 != null ? (int) aVar3.f121264b : -1);
        }
        Integer intProperty = getF120435a().getIntProperty(name);
        if (intProperty != null) {
            iIntValue = intProperty.intValue();
        } else {
            Boolean boolProperty = getF120435a().getBoolProperty(name);
    ...
    public SymbologySettings getSymbologySettings(Symbology symbology) {
        Intrinsics.j(symbology, "symbology");
        return this.f120433a.getSymbologySettings(symbology);
    }
    ...
    public void setArucoDictionary(ArucoDictionary dictionary) {
        ...
        this.f120433a.setArucoDictionary(dictionary);
    }
    ...
    public void setExpectsOnlyUniqueBarcodes(boolean z10) {
        this.f120433a.setExpectsOnlyUniqueBarcodes(z10);
    }
    ...
    public final void setProperty(String name, Object value) {
        ...
        if (Intrinsics.e(name, "freezeIndicationWaitTime") && (value instanceof Integer)) {
            ...
            aVar2.f121264b = ((Number) value).intValue();
            this.f120434b = aVar2;
            return;
        }
        if (value instanceof Boolean) {
            getF120435a().setBoolProperty(name, ((Boolean) value).booleanValue());
            return;
        }
        Integer numIntFromAny = TypeConverter.INSTANCE.intFromAny(value);
        if (numIntFromAny != null) {
            getF120435a().setIntProperty(name, numIntFromAny.intValue());
        }
    }
