...
public final class BarcodeBatch implements DataCaptureMode, BarcodeBatchProxy {
    ...
    private final BarcodeBatchSession f120405a;

    /* renamed from: b, reason: collision with root package name */
    private final /* synthetic */ BarcodeBatchProxyAdapter f120406b;

    /* renamed from: c, reason: collision with root package name */
    private DataCaptureContext f120407c;

    /* renamed from: d, reason: collision with root package name */
    private com.scandit.datacapture.barcode.internal.module.batch.capture.a f120408d;
    ...
    public static final class Companion {
        ...
        public final BarcodeBatch forDataCaptureContext(DataCaptureContext dataCaptureContext, BarcodeBatchSettings settings) {
            ...
            ProxyCacheKt.getGlobalProxyCache().getOrPut(Reflection.b(BarcodeBatch.class), null, barcodeBatch, new C13030b(barcodeBatch));
    ...
    public BarcodeBatch(NativeBarcodeTracking impl, BarcodeBatchSession session) {
        ...
        this.f120405a = session;
        this.f120406b = new BarcodeBatchProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        this.listeners = new CopyOnWriteArrayList();
        impl.addListenerAsync(new BarcodeBatchListenerReversedAdapter(new C13031c(this), this, null, 4, null), 1);
    }
    ...
    public void _activateState(String identifier) {
        ...
        this.f120406b._activateState(identifier);
    }
    ...
    public NativeDataCaptureMode getF120428c() {
        return this.f120406b.getF120428c();
    }
    ...
    public NativeBarcodeTracking getF120426a() {
        return this.f120406b.getF120426a();
    }
    ...
    public boolean isEnabled() {
        return this.f120406b.isEnabled();
    }
    ...
    public static final void access$updateFreezeIndicator(BarcodeBatch barcodeBatch, BarcodeBatchSettings barcodeBatchSettings) {
        com.scandit.datacapture.barcode.internal.module.batch.capture.a aVar = barcodeBatch.f120408d;
        if (aVar != null) {
    ...
    public final BarcodeBatchSession getF120405a() {
    ...
    public void _setDataCaptureContext(DataCaptureContext dataCaptureContext) {
        this.f120407c = dataCaptureContext;
    }
    ...
    public final void applySettings(BarcodeBatchSettings settings, Runnable whenDone) {
        Intrinsics.j(settings, "settings");
        NativeWrappedFuture nativeWrappedFutureApplySettingsWrapped = getF120426a().applySettingsWrapped(settings._impl());
        ...
        com.scandit.datacapture.barcode.internal.module.batch.capture.a aVar = this.f120408d;
        if (aVar != null) {
            removeListener(aVar);
        }
    ...
    public final BarcodeBatchLicenseInfo getBarcodeBatchLicenseInfo() {
        NativeBarcodeTrackingLicenseInfo barcodeTrackingLicenseInfo = getF120426a().getBarcodeTrackingLicenseInfo();
    ...
    public BarcodeBatch(DataCaptureContext dataCaptureContext, BarcodeBatchSettings barcodeBatchSettings, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        this(nativeBarcodeTrackingCreate, new BarcodeBatchSession(new C13029a(nativeBarcodeTrackingCreate)));
    }
}
