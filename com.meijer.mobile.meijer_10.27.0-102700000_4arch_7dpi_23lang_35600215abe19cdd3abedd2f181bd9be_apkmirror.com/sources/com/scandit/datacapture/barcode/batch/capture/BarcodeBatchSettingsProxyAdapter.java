...
public final class BarcodeBatchSettingsProxyAdapter implements BarcodeBatchSettingsProxy {
    ...
    private final NativeBarcodeTrackingSettings f120435a;
    ...
    public BarcodeBatchSettingsProxyAdapter(NativeBarcodeTrackingSettings _NativeBarcodeTrackingSettings, ProxyCache proxyCache) {
        Intrinsics.j(_NativeBarcodeTrackingSettings, "_NativeBarcodeTrackingSettings");
        Intrinsics.j(proxyCache, "proxyCache");
        this.f120435a = _NativeBarcodeTrackingSettings;
    ...
    public void enableSymbologies(Set<? extends Symbology> symbologies) {
        ...
        this.f120435a.enableSymbologies(BarcodeNativeTypeFactory.INSTANCE.convertSymbologySetToHashSet(symbologies));
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSettingsProxy
    public void enableSymbology(Symbology symbology, boolean enabled) {
        Intrinsics.j(symbology, "symbology");
        this.f120435a.setSymbologyEnabled(symbology, enabled);
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSettingsProxy
    public Set<Symbology> getEnabledSymbologies() {
        HashSet<Symbology> enabledSymbologies = this.f120435a.getEnabledSymbologies();
    ...
    public boolean getExpectsOnlyUniqueBarcodes() {
        return this.f120435a.expectsOnlyUniqueBarcodes();
    }
    ...
    public SymbologySettings getSymbologySettings(Symbology symbology) {
        Intrinsics.j(symbology, "symbology");
        NativeSymbologySettings symbologySettings = this.f120435a.getSymbologySettings(symbology);
    ...
    public void setArucoDictionary(ArucoDictionary dictionary) {
        ...
        this.f120435a.setArucoDictionary(f120883a);
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSettingsProxy
    public void setExpectsOnlyUniqueBarcodes(boolean z10) {
        this.f120435a.setExpectsOnlyUniqueBarcodes(z10);
    }

    public /* synthetic */ BarcodeBatchSettingsProxyAdapter(NativeBarcodeTrackingSettings nativeBarcodeTrackingSettings, ProxyCache proxyCache, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(nativeBarcodeTrackingSettings, (i10 & 2) != 0 ? ProxyCacheKt.getGlobalProxyCache() : proxyCache);
    }
}
