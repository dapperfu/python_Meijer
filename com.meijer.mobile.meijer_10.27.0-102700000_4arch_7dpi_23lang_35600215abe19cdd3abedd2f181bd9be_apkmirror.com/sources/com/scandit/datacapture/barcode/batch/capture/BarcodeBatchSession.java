...
public final class BarcodeBatchSession implements BarcodeBatchSessionProxy {
    ...
    public NativeBarcodeTrackingSession getF120431a() {
        return (NativeBarcodeTrackingSession) this.f120429a.invoke();
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSessionProxy
    public List<TrackedBarcode> getAddedTrackedBarcodes() {
        return ((BarcodeBatchSessionProxyAdapter) this.f120430b.getValue()).getAddedTrackedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSessionProxy
    public long getFrameSequenceId() {
        return ((BarcodeBatchSessionProxyAdapter) this.f120430b.getValue()).getFrameSequenceId();
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSessionProxy
    public List<Integer> getRemovedTrackedBarcodes() {
        return ((BarcodeBatchSessionProxyAdapter) this.f120430b.getValue()).getRemovedTrackedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSessionProxy
    public Map<Integer, TrackedBarcode> getTrackedBarcodes() {
        return ((BarcodeBatchSessionProxyAdapter) this.f120430b.getValue()).getTrackedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSessionProxy
    public List<TrackedBarcode> getUnscannedTrackedBarcodes() {
        return ((BarcodeBatchSessionProxyAdapter) this.f120430b.getValue()).getUnscannedTrackedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSessionProxy
    public List<TrackedBarcode> getUpdatedTrackedBarcodes() {
        return ((BarcodeBatchSessionProxyAdapter) this.f120430b.getValue()).getUpdatedTrackedBarcodes();
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSessionProxy
    public void reset() {
        ((BarcodeBatchSessionProxyAdapter) this.f120430b.getValue()).reset();
    }

    @Override // com.scandit.datacapture.barcode.batch.capture.BarcodeBatchSessionProxy
    public String toJson() {
        return ((BarcodeBatchSessionProxyAdapter) this.f120430b.getValue()).toJson();
    }
}
