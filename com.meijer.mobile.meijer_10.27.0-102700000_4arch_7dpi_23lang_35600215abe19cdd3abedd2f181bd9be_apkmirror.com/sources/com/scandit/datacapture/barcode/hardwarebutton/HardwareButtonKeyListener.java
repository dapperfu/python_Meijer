...
public final class HardwareButtonKeyListener implements View$OnUnhandledKeyEventListener {
    ...
    private static final long f121037i = ViewConfiguration.getLongPressTimeout();

    /* renamed from: a, reason: collision with root package name */
    private final int f121038a;

    /* renamed from: b, reason: collision with root package name */
    private final Function1 f121039b;

    /* renamed from: c, reason: collision with root package name */
    private final int f121040c;

    /* renamed from: d, reason: collision with root package name */
    private final int f121041d;

    /* renamed from: e, reason: collision with root package name */
    private final Handler f121042e;

    /* renamed from: f, reason: collision with root package name */
    private boolean f121043f;

    /* renamed from: g, reason: collision with root package name */
    private boolean f121044g;

    /* renamed from: h, reason: collision with root package name */
    private final Runnable f121045h;
    ...
    public HardwareButtonKeyListener(int i10, Function1<? super HardwareKeyEvent, Unit> onEvent, int i11, int i12, Handler handler) {
        ...
        this.f121038a = i10;
        this.f121039b = onEvent;
        this.f121040c = i11;
        this.f121041d = i12;
        this.f121042e = handler;
        this.f121045h = new Runnable() { // from class: Ft.b
            @Override // java.lang.Runnable
            public final void run() {
                HardwareButtonKeyListener.a(this.f11073a);
            }
        };
    }
    ...
    public static final class Companion {
        ...
        public final long getLONG_PRESS_THRESHOLD_MS() {
            return HardwareButtonKeyListener.f121037i;
        }
    }
    ...
    public static final void a(HardwareButtonKeyListener this$0) {
        ...
        this$0.f121044g = true;
        this$0.f121039b.invoke(HardwareKeyEvent.LONG_PRESS_START);
    }

    public boolean onUnhandledKeyEvent(View v10, KeyEvent event) {
        Intrinsics.j(v10, "v");
        Intrinsics.j(event, "event");
        if (event.getKeyCode() == this.f121038a && event.getAction() == this.f121040c && !this.f121043f) {
            this.f121043f = true;
            this.f121044g = false;
            event.getEventTime();
            this.f121042e.removeCallbacksAndMessages(null);
            this.f121042e.postDelayed(this.f121045h, f121037i);
            return true;
        }
        if (event.getKeyCode() != this.f121038a || event.getAction() != this.f121041d || !this.f121043f) {
            return false;
        }
        if (this.f121044g) {
            this.f121039b.invoke(HardwareKeyEvent.LONG_PRESS_END);
        } else {
            this.f121042e.removeCallbacksAndMessages(null);
            this.f121039b.invoke(HardwareKeyEvent.CLICK);
        }
        this.f121043f = false;
        return true;
    }
