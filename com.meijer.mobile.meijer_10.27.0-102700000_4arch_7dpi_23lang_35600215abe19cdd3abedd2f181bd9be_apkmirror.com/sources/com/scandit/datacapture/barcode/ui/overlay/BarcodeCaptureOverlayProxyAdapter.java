...
public final class BarcodeCaptureOverlayProxyAdapter implements BarcodeCaptureOverlayProxy {
    ...
    private final NativeBarcodeCaptureOverlay f124006a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeDataCaptureOverlay f124008c;
    ...
    public BarcodeCaptureOverlayProxyAdapter(NativeBarcodeCaptureOverlay _NativeBarcodeCaptureOverlay, ProxyCache proxyCache) {
        ...
        this.f124006a = _NativeBarcodeCaptureOverlay;
        ...
        this.f124008c = nativeDataCaptureOverlayAsDataCaptureOverlay;
    }
    ...
    public Brush getBrush() {
        NativeBrush brushForRecognizedBarcodes = this.f124006a.getBrushForRecognizedBarcodes();
    ...
    public boolean getShouldShowScanAreaGuides() {
        return this.f124006a.getShouldShowScanAreaGuides();
    }

    @Override // com.scandit.datacapture.barcode.ui.overlay.BarcodeCaptureOverlayProxy
    public BarcodeCaptureOverlayStyle getStyle() {
        NativeBarcodeCaptureOverlayStyle style = this.f124006a.getStyle();
    ...
    public void setBrush(Brush p02) {
        Intrinsics.j(p02, "p0");
        this.f124006a.setBrushForRecognizedBarcodes(CoreNativeTypeFactory.INSTANCE.convert(p02));
    }

    @Override // com.scandit.datacapture.barcode.ui.overlay.BarcodeCaptureOverlayProxy
    public void setShouldShowScanAreaGuides(boolean z10) {
        this.f124006a.setShouldShowScanAreaGuides(z10);
    }
