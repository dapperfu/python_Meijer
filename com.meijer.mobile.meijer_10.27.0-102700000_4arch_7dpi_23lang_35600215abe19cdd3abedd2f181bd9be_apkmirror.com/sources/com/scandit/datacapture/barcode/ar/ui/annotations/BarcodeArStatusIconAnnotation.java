...
public final class BarcodeArStatusIconAnnotation implements BarcodeArAnnotation {
    ...
    private final Context f120269a;
    ...
    private boolean f120272d;

    /* renamed from: e, reason: collision with root package name */
    private final BarcodeArStatusIconAnnotation$special$$inlined$distinctObservable$1 f120273e;
    ...
    private final BarcodeArStatusIconAnnotation$special$$inlined$distinctObservable$2 f120278j;

    /* renamed from: k, reason: collision with root package name and from kotlin metadata */
    private /* synthetic */ Function0 onAnnotationOrElementTap;

    /* renamed from: l, reason: collision with root package name */
    static final /* synthetic */ KProperty[] f120268l = {a.a(BarcodeArStatusIconAnnotation.class, "hasTip", "getHasTip()Z", 0), a.a(BarcodeArStatusIconAnnotation.class, "anchor", "getAnchor()Lcom/scandit/datacapture/barcode/ar/ui/annotations/statusicon/BarcodeArStatusIconAnnotationAnchor;", 0)};
    ...
    public BarcodeArStatusIconAnnotation(Context context, Barcode barcode) {
        ...
        this.f120273e = new ObservableProperty<Boolean>(boolValueOf) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.BarcodeArStatusIconAnnotation$special$$inlined$distinctObservable$1
        ...
        this.f120278j = new ObservableProperty<BarcodeArStatusIconAnnotationAnchor>(defaultStatusIconAnnotationAnchor) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.BarcodeArStatusIconAnnotation$special$$inlined$distinctObservable$2
            @Override // kotlin.properties.ObservableProperty
    ...
    public View createView() {
        final com.scandit.datacapture.barcode.internal.module.ar.ui.annotations.statusicon.s sVar = new com.scandit.datacapture.barcode.internal.module.ar.ui.annotations.statusicon.s(this.f120269a, this.barcode);
    ...
    public final BarcodeArStatusIconAnnotationAnchor getAnchor() {
        return getValue(this, f120268l[1]);
    }
    ...
    public final boolean getHasTip() {
        return getValue(this, f120268l[0]).booleanValue();
    }
    ...
    public final void setAnchor(BarcodeArStatusIconAnnotationAnchor barcodeArStatusIconAnnotationAnchor) {
        ...
        setValue(this, f120268l[1], barcodeArStatusIconAnnotationAnchor);
    }
    ...
    public final void setHasTip(boolean z10) {
        setValue(this, f120268l[0], Boolean.valueOf(z10));
    }
    ...
    public final void setText(String str) {
        if (str != null) {
            ...
            List<String> listZ0 = StringsKt.z0(str);
            if (listZ0.size() > 1) {
                str = CollectionsKt.B0(CollectionsKt.b1(listZ0, 1), "\n", null, "…", 0, null, null, 58, null);
            }
            if (str.length() > 20) {
                str = StringsKt.y1(StringsKt.J1(str, 20)).toString() + (char) 8230;
            }
        } else {
            str = null;
        }
    ...
    public void update(Quadrilateral barcodeLocation, Quadrilateral highlightViewLocation, final View view) {
        ...
        if (sVar != null) {
            ...
            com.scandit.datacapture.barcode.internal.module.ar.ui.annotations.statusicon.a aVar = sVar.f121176b;
            aVar.getClass();
            Intrinsics.j(icon, "icon");
            ...
            ImageView imageView = aVar.f121145b;
            Context context = aVar.getContext();
            Intrinsics.i(context, "getContext(...)");
            imageView.setImageDrawable(ScanditIconUtilsKt.getDrawable(icon, context));
            aVar.f121144a.setText(str);
            aVar.f121144a.setTextColor(i10);
            com.scandit.datacapture.barcode.internal.module.ar.ui.annotations.tip.a aVar2 = sVar.f121175a;
            aVar2.getClass();
            aVar2.setVisibility(hasTip ? 0 : 8);
            aVar2.setColorFilter(i11, PorterDuff.Mode.SRC_IN);
            sVar.setLayoutParams(new FrameLayout.LayoutParams(-2, hasTip ? ((Number) com.scandit.datacapture.barcode.internal.module.ar.ui.annotations.statusicon.l.f121166j.getValue()).intValue() : ((Number) com.scandit.datacapture.barcode.internal.module.ar.ui.annotations.statusicon.l.f121165i.getValue()).intValue()));
