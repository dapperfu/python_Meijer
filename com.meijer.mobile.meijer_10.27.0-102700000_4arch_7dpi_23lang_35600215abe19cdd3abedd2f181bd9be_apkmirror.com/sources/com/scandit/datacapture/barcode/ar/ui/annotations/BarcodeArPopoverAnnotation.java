...
public final class BarcodeArPopoverAnnotation implements BarcodeArAnnotation {
    ...
    private final Context f120255a;
    ...
    private boolean f120260f;

    /* renamed from: g, reason: collision with root package name */
    private final BarcodeArPopoverAnnotation$special$$inlined$distinctObservable$1 f120261g;

    /* renamed from: h, reason: collision with root package name */
    private boolean f120262h;
    ...
    private com.scandit.datacapture.barcode.internal.module.ar.ui.annotations.popover.e f120265k;

    /* renamed from: l, reason: collision with root package name */
    private final s f120266l;

    /* renamed from: m, reason: collision with root package name */
    static final /* synthetic */ KProperty[] f120253m = {a.a(BarcodeArPopoverAnnotation.class, "anchor", "getAnchor()Lcom/scandit/datacapture/barcode/ar/ui/annotations/popover/BarcodeArPopoverAnnotationAnchor;", 0)};

    /* renamed from: Companion, reason: from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);

    /* renamed from: n, reason: collision with root package name */
    private static final Lazy f120254n = LazyKt.b(p.f120350a);
    ...
    public static final class Companion {
        ...
        public final int getMARGIN$scandit_barcode_capture() {
            return ((Number) BarcodeArPopoverAnnotation.f120254n.getValue()).intValue();
        }
    }
    ...
    public BarcodeArPopoverAnnotation(Context context, Barcode barcode, List<BarcodeArPopoverAnnotationButton> buttons) {
        ...
        this.f120261g = new ObservableProperty<BarcodeArPopoverAnnotationAnchor>(defaultPopoverAnnotationAnchor) { // from class: com.scandit.datacapture.barcode.ar.ui.annotations.BarcodeArPopoverAnnotation$special$$inlined$distinctObservable$1
        ...
        this.f120266l = new s(this);
        Iterator<T> it = buttons.iterator();
        while (it.hasNext()) {
            ((BarcodeArPopoverAnnotationButton) it.next()).setPropertyChangedListener$scandit_barcode_capture(this.f120266l);
        }
    }
    ...
    public View createView() {
        EnumC13257j enumC13257j;
        FrameLayout frameLayout = new FrameLayout(this.f120255a);
        ...
        C13260m c13260m = new C13260m(this.f120255a);
        c13260m.setId(R.id.sc_ar_linear_popover_view);
        c13260m.setLayoutParams(new LinearLayout.LayoutParams(-2, -2));
        r rVar = new r(this);
        Intrinsics.j(rVar, "<set-?>");
        c13260m.f123404c = rVar;
        boolean z10 = this.isEntirePopoverTappable;
        if (c13260m.f123403b != z10) {
            c13260m.f123403b = z10;
            c13260m.a();
        }
        int i10 = 0;
        c13260m.setVisibility(0);
        for (Object obj : this.buttons) {
            ...
            c13260m.a(barcodeArPopoverAnnotationButton.getButtonSettings$scandit_barcode_capture(i10, this.isEntirePopoverTappable, this.f120255a), new q(this, barcodeArPopoverAnnotationButton, i10));
            c13260m.a(i10, true);
            i10 = i11;
        }
        this.f120265k = new com.scandit.datacapture.barcode.internal.module.ar.ui.annotations.popover.e(c13260m);
        BarcodeArPopoverAnnotationAnchor anchor = getAnchor();
        Intrinsics.j(anchor, "anchor");
        int i12 = com.scandit.datacapture.barcode.internal.module.ar.ui.annotations.popover.a.f121135a[anchor.ordinal()];
        if (i12 == 1 || i12 == 2) {
            enumC13257j = EnumC13257j.f123397b;
        } else {
            if (i12 != 3 && i12 != 4) {
                throw new NoWhenBranchMatchedException();
            }
            enumC13257j = EnumC13257j.f123396a;
        }
        c13260m.a(enumC13257j);
        frameLayout.addView(c13260m);
        return frameLayout;
    }

    public final BarcodeArPopoverAnnotationAnchor getAnchor() {
        return getValue(this, f120253m[0]);
    }
    ...
    public final void setAnchor(BarcodeArPopoverAnnotationAnchor barcodeArPopoverAnnotationAnchor) {
        ...
        setValue(this, f120253m[0], barcodeArPopoverAnnotationAnchor);
    }
