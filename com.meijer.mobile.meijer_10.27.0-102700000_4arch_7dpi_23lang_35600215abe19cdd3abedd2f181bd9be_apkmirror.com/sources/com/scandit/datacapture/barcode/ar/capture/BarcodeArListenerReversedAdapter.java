...
public final class BarcodeArListenerReversedAdapter extends NativeBarcodeArListener {
    ...
    private final BarcodeArListener f120092a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final WeakReference f120094c;
    ...
    public void onObservationStarted(NativeBarcodeAr barcodeAr) {
        ...
        if (((BarcodeArInternal) this.f120094c.get()) != null) {
            this.f120092a.onObservationStarted(BarcodeNativeTypeFactory.INSTANCE.convert(barcodeAr));
        }
    }
    ...
    public void onObservationStopped(NativeBarcodeAr barcodeAr) {
        Intrinsics.j(barcodeAr, "barcodeAr");
        if (((BarcodeArInternal) this.f120094c.get()) != null) {
            this.f120092a.onObservationStopped(BarcodeNativeTypeFactory.INSTANCE.convert(barcodeAr));
        }
    }
    ...
    public void onSessionUpdated(NativeBarcodeAr barcodeAr, NativeBarcodeArSession session, NativeFrameData data) {
        ...
        BarcodeArInternal barcodeArInternal = (BarcodeArInternal) this.f120094c.get();
        if (barcodeArInternal != null) {
            this.f120092a.onSessionUpdated(BarcodeNativeTypeFactory.INSTANCE.convert(barcodeAr), (BarcodeArSession) this.proxyCache.getOrPut(Reflection.b(NativeBarcodeArSession.class), null, session, new a(barcodeArInternal)), (FrameData) this.proxyCache.getOrPut(Reflection.b(NativeFrameData.class), null, data, new b(data)));
        }
    }
    ...
    public BarcodeArListenerReversedAdapter(BarcodeArListener _BarcodeArListener, BarcodeArInternal _BarcodeArInternal, ProxyCache proxyCache) {
        ...
        this.f120092a = _BarcodeArListener;
        this.proxyCache = proxyCache;
        this.f120094c = new WeakReference(_BarcodeArInternal);
    }
}
