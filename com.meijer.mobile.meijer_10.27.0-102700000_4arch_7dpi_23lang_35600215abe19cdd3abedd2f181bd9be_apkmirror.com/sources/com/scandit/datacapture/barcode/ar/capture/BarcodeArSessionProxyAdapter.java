...
public final class BarcodeArSessionProxyAdapter implements BarcodeArSessionProxy {
    ...
    private final NativeBarcodeArSession f120097a;
    ...
    public BarcodeArSessionProxyAdapter(NativeBarcodeArSession _NativeBarcodeArSession, ProxyCache proxyCache) {
        ...
        this.f120097a = _NativeBarcodeArSession;
    ...
    public List<TrackedBarcode> getAddedTrackedBarcodes() {
        ArrayList<NativeTrackedBarcode> addedTrackedBarcodes = this.f120097a.getAddedTrackedBarcodes();
    ...
    public List<Integer> getRemovedTrackedBarcodes() {
        ArrayList<Integer> removedTrackedBarcodes = this.f120097a.getRemovedTrackedBarcodes();
    ...
    public Map<Integer, TrackedBarcode> getTrackedBarcodes() {
        HashMap<Integer, NativeTrackedBarcode> trackedBarcodes = this.f120097a.getTrackedBarcodes();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
    ...
    public String toJson() {
        String json = this.f120097a.toJson();
        Intrinsics.g(json);
        return json;
    }
