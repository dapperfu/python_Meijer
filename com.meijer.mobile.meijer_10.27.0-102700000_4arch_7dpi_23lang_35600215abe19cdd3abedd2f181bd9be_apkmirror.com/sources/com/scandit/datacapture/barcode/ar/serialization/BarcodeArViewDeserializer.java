...
public final class BarcodeArViewDeserializer {
    ...
    private final BarcodeArViewSettingsDeserializer f120117a;

    /* renamed from: b, reason: collision with root package name */
    private final BarcodeCameraSettingsDeserializer f120118b;

    /* renamed from: c, reason: collision with root package name */
    private final Function0 f120119c;

    /* renamed from: d, reason: collision with root package name */
    private final Function0 f120120d;
    ...
    public BarcodeArViewDeserializer(BarcodeArViewSettingsDeserializer viewSettingsDeserializer, BarcodeCameraSettingsDeserializer cameraSettingsDeserializer, Function0<BarcodeArViewSettings> settingsFactory, Function0<CameraSettings> cameraSettingsFactory) {
        ...
        this.f120117a = viewSettingsDeserializer;
        this.f120118b = cameraSettingsDeserializer;
        this.f120119c = settingsFactory;
        this.f120120d = cameraSettingsFactory;
    }
    ...
    public final BarcodeArView viewFromJson(ViewGroup parentView, BarcodeAr mode, DataCaptureContext context, String json) {
        ...
        BarcodeArViewSettings barcodeArViewSettings = (BarcodeArViewSettings) this.f120119c.invoke();
        CameraSettings cameraSettingsA = (CameraSettings) this.f120120d.invoke();
        if (jsonValue.contains("viewSettings")) {
            this.f120117a.a(barcodeArViewSettings, jsonValue.requireByKeyAsObject("viewSettings"));
        }
        if (jsonValue.contains("cameraSettings")) {
            cameraSettingsA = this.f120118b.a(jsonValue.requireByKeyAsObject("cameraSettings"));
        }
    ...
    public BarcodeArViewDeserializer() {
        this(new com.scandit.datacapture.barcode.internal.module.ar.serialization.f(), new BarcodeCameraSettingsDeserializer(BarcodeAr.INSTANCE.createRecommendedCameraSettings()), k.f120131a, l.f120132a);
    }
}
