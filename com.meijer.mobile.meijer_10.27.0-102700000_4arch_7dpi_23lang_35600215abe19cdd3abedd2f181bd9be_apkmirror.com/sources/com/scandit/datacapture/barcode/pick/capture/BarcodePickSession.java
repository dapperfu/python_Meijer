...
public final class BarcodePickSession implements BarcodePickSessionProxy {
    ...
    private final Function0 f123578a;

    /* renamed from: b, reason: collision with root package name */
    private final Lazy f123579b;

    public BarcodePickSession(Function0<? extends NativeBarcodePickPublicSession> getImpl) {
        Intrinsics.j(getImpl, "getImpl");
        this.f123578a = getImpl;
        this.f123579b = LazyKt.b(new f(this));
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSessionProxy
    public Set<String> getAddedItems() {
        return ((BarcodePickSessionProxyAdapter) this.f123579b.getValue()).getAddedItems();
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSessionProxy
    public Set<TrackedObject> getAddedObjects() {
        return ((BarcodePickSessionProxyAdapter) this.f123579b.getValue()).getAddedObjects();
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSessionProxy
    public Set<String> getTrackedItems() {
        return ((BarcodePickSessionProxyAdapter) this.f123579b.getValue()).getTrackedItems();
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSessionProxy
    public Set<TrackedObject> getTrackedObjects() {
        return ((BarcodePickSessionProxyAdapter) this.f123579b.getValue()).getTrackedObjects();
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSessionProxy
    public String toJson() {
        return ((BarcodePickSessionProxyAdapter) this.f123579b.getValue()).toJson();
    }
}
