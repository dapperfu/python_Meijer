...
public final class BarcodePickSettingsProxyAdapter implements BarcodePickSettingsProxy {
    ...
    private final NativeBarcodePickSettings f123583a;
    ...
    public void _updateFromJson(JsonValue json) {
        ...
        this.f123583a.updateFromJson(f125830a);
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSettingsProxy
    public void enableSymbologies(Set<? extends Symbology> symbologies) {
        Intrinsics.j(symbologies, "symbologies");
        this.f123583a.enableSymbologies(BarcodeNativeTypeFactory.INSTANCE.convertSymbologySetToHashSet(symbologies));
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSettingsProxy
    public void enableSymbology(Symbology symbology, boolean enabled) {
        Intrinsics.j(symbology, "symbology");
        this.f123583a.setSymbologyEnabled(symbology, enabled);
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSettingsProxy
    public boolean getCachingEnabled() {
        return this.f123583a.getShouldEnableCaching();
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSettingsProxy
    public Set<Symbology> getEnabledSymbologies() {
        HashSet<Symbology> enabledSymbologies = this.f123583a.getEnabledSymbologies();
    ...
    public BarcodeFilterSettings getFilterSettings() {
        NativeBarcodeFilterSettings filterSettings = this.f123583a.getFilterSettings();
    ...
    public boolean getHapticsEnabled() {
        return this.f123583a.getHapticEnabled();
    }
    ...
    public boolean getSoundEnabled() {
        return this.f123583a.getSoundEnabled();
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSettingsProxy
    public SymbologySettings getSymbologySettings(Symbology symbology) {
        Intrinsics.j(symbology, "symbology");
        NativeSymbologySettings symbologySettings = this.f123583a.getSymbologySettings(symbology);
        ProxyCache proxyCache = this.proxyCache;
    ...
    public void setArucoDictionary(ArucoDictionary dictionary) {
        ...
        this.f123583a.setArucoDictionary(f120883a);
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSettingsProxy
    public void setCachingEnabled(boolean z10) {
        this.f123583a.setShouldEnableCaching(z10);
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSettingsProxy
    public void setFilterSettings(BarcodeFilterSettings p02) {
        Intrinsics.j(p02, "p0");
        NativeBarcodeFilterSettings f120920a = p02.getF120920a();
        this.proxyCache.put(Reflection.b(NativeBarcodeFilterSettings.class), null, f120920a, p02);
        this.f123583a.setFilterSettings(f120920a);
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSettingsProxy
    public void setHapticsEnabled(boolean z10) {
        this.f123583a.setHapticEnabled(z10);
    }

    @Override // com.scandit.datacapture.barcode.pick.capture.BarcodePickSettingsProxy
    public void setSoundEnabled(boolean z10) {
        this.f123583a.setSoundEnabled(z10);
    }
