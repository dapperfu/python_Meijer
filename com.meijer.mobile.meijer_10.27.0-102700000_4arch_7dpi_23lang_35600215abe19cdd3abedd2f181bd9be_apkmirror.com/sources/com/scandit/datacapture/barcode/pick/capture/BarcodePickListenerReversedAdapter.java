...
public final class BarcodePickListenerReversedAdapter extends NativeBarcodePickPublicListener {
    ...
    private final BarcodePickListener f123567a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final WeakReference f123569c;
    ...
    public void onObservationStarted(NativeBarcodePick mode) {
        ...
        if (((BarcodePickInternal) this.f123569c.get()) != null) {
            this.f123567a.onObservationStarted(BarcodeNativeTypeFactory.INSTANCE.convert(mode));
        }
    }
    ...
    public void onObservationStopped(NativeBarcodePick mode) {
        Intrinsics.j(mode, "mode");
        if (((BarcodePickInternal) this.f123569c.get()) != null) {
            this.f123567a.onObservationStopped(BarcodeNativeTypeFactory.INSTANCE.convert(mode));
        }
    }
    ...
    public void onSessionUpdated(NativeBarcodePick mode, NativeBarcodePickPublicSession session) {
        ...
        BarcodePickInternal barcodePickInternal = (BarcodePickInternal) this.f123569c.get();
        if (barcodePickInternal != null) {
            this.f123567a.onSessionUpdated(BarcodeNativeTypeFactory.INSTANCE.convert(mode), (BarcodePickSession) this.proxyCache.getOrPut(Reflection.b(NativeBarcodePickPublicSession.class), null, session, new b(barcodePickInternal)));
        }
    }
    ...
    public BarcodePickListenerReversedAdapter(BarcodePickListener _BarcodePickListener, BarcodePickInternal _BarcodePickInternal, ProxyCache proxyCache) {
        ...
        this.f123567a = _BarcodePickListener;
        this.proxyCache = proxyCache;
        this.f123569c = new WeakReference(_BarcodePickInternal);
    }
}
