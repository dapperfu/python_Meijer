...
public final class BarcodePick {
    ...
    private final BarcodePickInternal f123559a;

    /* renamed from: b, reason: collision with root package name */
    private final CopyOnWriteArraySet f123560b;
    ...
    public BarcodePick(BarcodePickInternal barcodePickInternal) {
        ...
        this.f123559a = barcodePickInternal;
        this.f123560b = new CopyOnWriteArraySet();
    ...
    public final /* synthetic */ void _addActionListener$scandit_barcode_capture(BarcodePickActionListener actionListener) {
        ...
        this.f123559a.a(actionListener);
    }
    ...
    public final /* synthetic */ void _applySettings$scandit_barcode_capture(BarcodePickSettings settings, final Function0 whenDone) {
        ...
        this.f123559a.a(settings, whenDone != null ? new Runnable() { // from class: com.scandit.datacapture.barcode.pick.capture.i
    ...
    public final /* synthetic */ BarcodePickInternal getF123559a() {
    ...
    public final void selectItemWithData(String data, BarcodePickSelectItemActionCallback callback) {
        Object next;
        Intrinsics.j(data, "data");
        HashMap<Integer, NativeTrackedObject> trackedObjects = ((w) this.f123559a.c().f122454b.getValue()).f122455a.getTrackedObjects();
