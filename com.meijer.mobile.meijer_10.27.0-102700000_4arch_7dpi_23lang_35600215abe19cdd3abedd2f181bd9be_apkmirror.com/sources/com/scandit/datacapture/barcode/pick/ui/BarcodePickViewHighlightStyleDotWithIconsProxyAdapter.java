...
public final class BarcodePickViewHighlightStyleDotWithIconsProxyAdapter implements BarcodePickViewHighlightStyleDotWithIconsProxy {
    ...
    private final NativeBarcodePickViewHighlightStyleDotWithIcons f123686a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeBarcodePickViewHighlightStyle f123688c;
    ...
    public BarcodePickViewHighlightStyleDotWithIconsProxyAdapter(NativeBarcodePickViewHighlightStyleDotWithIcons _NativeBarcodePickViewHighlightStyleDotWithIcons, ProxyCache proxyCache) {
        ...
        this.f123686a = _NativeBarcodePickViewHighlightStyleDotWithIcons;
        ...
        this.f123688c = nativeBarcodePickViewHighlightStyleAsHighlightStyle;
    }
    ...
    public NativeBarcodePickViewHighlightStyle getF123688c() {
        return this.f123688c;
    }
    ...
    public Brush getBrushForState(BarcodePickState state) {
        ...
        NativeBrush nativeBrushBrushForState = this.f123686a.brushForState(BarcodeNativeTypeFactory.INSTANCE.convert(state));
    ...
    public Brush getSelectedBrushForState(BarcodePickState state) {
        Intrinsics.j(state, "state");
        NativeBrush nativeBrushSelectedBrushForState = this.f123686a.selectedBrushForState(BarcodeNativeTypeFactory.INSTANCE.convert(state));
    ...
    public boolean getStyleResponseCacheEnabled() {
        return this.f123686a.getStyleResponseCacheEnabled();
    }
    ...
    public void setBrushForState(Brush brush, BarcodePickState state) {
        ...
        Intrinsics.j(state, "state");
        this.f123686a.setBrushForState(CoreNativeTypeFactory.INSTANCE.convert(brush), BarcodeNativeTypeFactory.INSTANCE.convert(state));
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleDotWithIconsProxy
    public void setSelectedBrushForState(Brush brush, BarcodePickState state) {
        Intrinsics.j(state, "state");
        this.f123686a.setSelectedBrushForState(brush != null ? CoreNativeTypeFactory.INSTANCE.convert(brush) : null, BarcodeNativeTypeFactory.INSTANCE.convert(state));
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleDotWithIconsProxy
    public void setStyleResponseCacheEnabled(boolean z10) {
        this.f123686a.setStyleResponseCacheEnabled(z10);
    }
