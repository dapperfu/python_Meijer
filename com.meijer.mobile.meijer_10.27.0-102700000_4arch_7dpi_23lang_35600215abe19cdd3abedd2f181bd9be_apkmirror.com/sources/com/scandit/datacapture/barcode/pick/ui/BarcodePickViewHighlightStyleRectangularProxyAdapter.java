...
public final class BarcodePickViewHighlightStyleRectangularProxyAdapter implements BarcodePickViewHighlightStyleRectangularProxy {
    ...
    private final NativeBarcodePickViewHighlightStyleRectangular f123689a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeBarcodePickViewHighlightStyle f123691c;
    ...
    public BarcodePickViewHighlightStyleRectangularProxyAdapter(NativeBarcodePickViewHighlightStyleRectangular _NativeBarcodePickViewHighlightStyleRectangular, ProxyCache proxyCache) {
        ...
        this.f123689a = _NativeBarcodePickViewHighlightStyleRectangular;
        ...
        this.f123691c = nativeBarcodePickViewHighlightStyleAsHighlightStyle;
    }
    ...
    public NativeBarcodePickViewHighlightStyle getF123691c() {
    ...
    public Brush getBrushForState(BarcodePickState state) {
        ...
        NativeBrush nativeBrushBrushForState = this.f123689a.brushForState(BarcodeNativeTypeFactory.INSTANCE.convert(state));
    ...
    public int getMinimumHighlightHeight() {
        return this.f123689a.getMinimumHighlightHeight();
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleRectangularProxy
    public int getMinimumHighlightWidth() {
        return this.f123689a.getMinimumHighlightWidth();
    }
    ...
    public Brush getSelectedBrushForState(BarcodePickState state) {
        Intrinsics.j(state, "state");
        NativeBrush nativeBrushSelectedBrushForState = this.f123689a.selectedBrushForState(BarcodeNativeTypeFactory.INSTANCE.convert(state));
    ...
    public void setBrushForState(Brush brush, BarcodePickState state) {
        ...
        Intrinsics.j(state, "state");
        this.f123689a.setBrushForState(CoreNativeTypeFactory.INSTANCE.convert(brush), BarcodeNativeTypeFactory.INSTANCE.convert(state));
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleRectangularProxy
    public void setMinimumHighlightHeight(int i10) {
        this.f123689a.setMinimumHighlightHeight(i10);
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleRectangularProxy
    public void setMinimumHighlightWidth(int i10) {
        this.f123689a.setMinimumHighlightWidth(i10);
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleRectangularProxy
    public void setSelectedBrushForState(Brush brush, BarcodePickState state) {
        Intrinsics.j(state, "state");
        this.f123689a.setSelectedBrushForState(brush != null ? CoreNativeTypeFactory.INSTANCE.convert(brush) : null, BarcodeNativeTypeFactory.INSTANCE.convert(state));
    }
