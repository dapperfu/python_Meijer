...
public final class k implements BarcodePickDeserializerHelper, DataCaptureDeserializerHelper {
    ...
    public BarcodePickSettings f123628a;
    ...
    public final void a(BarcodePickViewSettings viewSettings, JsonValue json) {
        ...
        NativeBarcodePickViewHighlightType highlightStyleType = viewSettings.getF123721a().getHighlightStyleType();
        ...
        if (i10 != 1) {
            if (i10 == 2) {
                NativeBarcodePickViewHighlightStyleRectangularWithIcons highlightStyleAsRectangularWithIcons = viewSettings.getF123721a().getHighlightStyleAsRectangularWithIcons();
                ...
                a(rectangularWithIcons, byKeyAsObject, BarcodePickDeserializer.FIELD_ICONS_FOR_STATE, c.f123620a, d.f123621a, e.f123622a, f.f123623a);
                a(rectangularWithIcons, byKeyAsObject, BarcodePickDeserializer.FIELD_SELECTED_ICONS_FOR_STATE, g.f123624a, h.f123625a, i.f123626a, j.f123627a);
            } else if (i10 == 3) {
                NativeBarcodePickViewHighlightStyleDot highlightStyleAsDot = viewSettings.getF123721a().getHighlightStyleAsDot();
                ...
                NativeBarcodePickViewHighlightStyleDotWithIcons highlightStyleAsDotWithIcons = viewSettings.getF123721a().getHighlightStyleAsDotWithIcons();
                ...
                NativeBarcodePickViewHighlightStyleCustomView highlightStyleAsCustomView = viewSettings.getF123721a().getHighlightStyleAsCustomView();
            ...
            NativeBarcodePickViewHighlightStyleRectangular highlightStyleAsRectangular = viewSettings.getF123721a().getHighlightStyleAsRectangular();
