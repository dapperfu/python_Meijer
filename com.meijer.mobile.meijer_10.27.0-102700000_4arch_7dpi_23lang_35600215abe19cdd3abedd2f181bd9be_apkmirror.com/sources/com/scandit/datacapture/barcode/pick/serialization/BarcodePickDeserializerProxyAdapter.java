...
public final class BarcodePickDeserializerProxyAdapter implements BarcodePickDeserializerProxy {
    ...
    private final NativeBarcodePickDeserializer f123614a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeDataCaptureModeDeserializer f123616c;

    /* renamed from: d, reason: collision with root package name */
    private BarcodePickDeserializer f123617d;
    ...
    public BarcodePickDeserializerProxyAdapter(NativeBarcodePickDeserializer _NativeBarcodePickDeserializer, ProxyCache proxyCache) {
        ...
        this.f123614a = _NativeBarcodePickDeserializer;
        ...
        this.f123616c = nativeDataCaptureModeDeserializerAsDataCaptureModeDeserializer;
    }
    ...
    public BarcodePickDeserializer _deserializer() {
        BarcodePickDeserializer barcodePickDeserializer = this.f123617d;
    ...
    public NativeBarcodePickDeserializer getF123614a() {
    ...
    public BarcodePick _modeFromJson(DataCaptureContext context, BarcodePickProductProvider productProvider, String json) {
        ...
        NativeProductProvider nativeProductProvider_productProviderImpl = productProvider.getF123600c();
        ...
        NativeBarcodePick nativeBarcodePickBarcodePickFromJson = this.f123614a.barcodePickFromJson(nativeDataCaptureContext_impl, nativeProductProvider_productProviderImpl, CoreNativeTypeFactory.INSTANCE.convert(json));
    ...
    public BarcodePickBasicOverlay _overlayFromJson(BarcodePick mode, JsonValue json) {
        ...
        NativeDataCaptureOverlay nativeDataCaptureOverlayOverlayFromJson = this.f123614a.overlayFromJson(nativeBarcodePickConvert, f125830a);
    ...
    public List<BarcodePickProduct> _productsFromJson(JsonValue json) {
        ...
        NativeJsonValue f125830a = json.getF125830a();
        this.proxyCache.put(Reflection.b(NativeJsonValue.class), null, f125830a, json);
        ArrayList<NativeBarcodePickProduct> arrayListBarcodePickProductsFromJson = this.f123614a.barcodePickProductsFromJson(f125830a);
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
    ...
    public void _setDeserializer(BarcodePickDeserializer deserializerProxy) {
        ...
        this.f123617d = deserializerProxy;
    }

    @Override // com.scandit.datacapture.barcode.pick.serialization.BarcodePickDeserializerProxy
    public BarcodePickSettings _settingsFromJson(String json) {
        Intrinsics.j(json, "json");
        NativeBarcodePickSettings nativeBarcodePickSettings = this.f123614a.settingsFromJson(CoreNativeTypeFactory.INSTANCE.convert(json));
        ProxyCache proxyCache = this.proxyCache;
    ...
    public BarcodePickBasicOverlay _updateOverlayFromJson(BarcodePickBasicOverlay overlay, JsonValue json) {
        ...
        Intrinsics.j(json, "json");
        NativeDataCaptureOverlay f120491c = overlay.getF124008c();
        this.proxyCache.put(Reflection.b(NativeDataCaptureOverlay.class), null, f120491c, overlay);
        NativeJsonValue f125830a = json.getF125830a();
        this.proxyCache.put(Reflection.b(NativeJsonValue.class), null, f125830a, json);
        NativeDataCaptureOverlay nativeDataCaptureOverlayUpdateOverlayFromJson = this.f123614a.updateOverlayFromJson(f120491c, f125830a);
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeDataCaptureOverlay.class);
    ...
    public BarcodePickViewSettings _updateViewSettingsFromJson(BarcodePickViewSettings settings, String json) {
        ...
        Intrinsics.j(json, "json");
        NativeBarcodePickViewSettings f123721a = settings.getF123721a();
        this.proxyCache.put(Reflection.b(NativeBarcodePickViewSettings.class), null, f123721a, settings);
        NativeBarcodePickViewSettings nativeBarcodePickViewSettingsUpdateViewSettingsFromJson = this.f123614a.updateViewSettingsFromJson(f123721a, CoreNativeTypeFactory.INSTANCE.convert(json));
        ProxyCache proxyCache = this.proxyCache;
    ...
    public BarcodePickViewSettings _viewSettingsFromJson(String json) {
        Intrinsics.j(json, "json");
        NativeBarcodePickViewSettings nativeBarcodePickViewSettingsViewSettingsFromJson = this.f123614a.viewSettingsFromJson(CoreNativeTypeFactory.INSTANCE.convert(json));
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeBarcodePickViewSettings.class);
    ...
    public BarcodePickDeserializerHelper get_helper() {
        return (BarcodePickDeserializerHelper) this.proxyCache.requireByValue(Reflection.b(BarcodePickDeserializerHelper.class), this.f123614a.getHelper());
    }
    ...
    public BarcodePick updateModeFromJson(BarcodePick mode, String json) {
        ...
        Intrinsics.j(json, "json");
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
        NativeBarcodePick nativeBarcodePickUpdateBarcodePickFromJson = this.f123614a.updateBarcodePickFromJson(barcodeNativeTypeFactory.convert(mode), CoreNativeTypeFactory.INSTANCE.convert(json));
    ...
    public BarcodePickSettings updateSettingsFromJson(BarcodePickSettings settings, String json) {
        Intrinsics.j(settings, "settings");
        Intrinsics.j(json, "json");
        NativeBarcodePickSettings nativeBarcodePickSettings_impl = settings.getF123583a();
        this.proxyCache.put(Reflection.b(NativeBarcodePickSettings.class), null, nativeBarcodePickSettings_impl, settings);
        NativeBarcodePickSettings nativeBarcodePickSettingsUpdateSettingsFromJson = this.f123614a.updateSettingsFromJson(nativeBarcodePickSettings_impl, CoreNativeTypeFactory.INSTANCE.convert(json));
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeBarcodePickSettings.class);
