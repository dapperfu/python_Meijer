...
public final class BarcodeCountStatusResult implements BarcodeCountStatusResultProxy {
    ...
    private final /* synthetic */ BarcodeCountStatusResultProxyAdapter f120877a;
    ...
    public NativeBarcodeCountStatusResult getF120878a() {
        return this.f120877a.getF120878a();
    }

    /* JADX WARN: Multi-variable type inference failed */
    public BarcodeCountStatusResult(NativeBarcodeCountStatusResult impl) {
        Intrinsics.j(impl, "impl");
        this.f120877a = new BarcodeCountStatusResultProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    }
}
