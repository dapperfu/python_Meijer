...
public final class BarcodeCountStatusProviderCallback implements BarcodeCountStatusProviderCallbackProxy {
    ...
    private final /* synthetic */ BarcodeCountStatusProviderCallbackProxyAdapter f120874a;
    ...
    public NativeBarcodeCountStatusProviderCallback getF120875a() {
        return this.f120874a.getF120875a();
    }
    ...
    public void onStatusReady(BarcodeCountStatusResult statusResult) {
        ...
        this.f120874a.onStatusReady(statusResult);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public BarcodeCountStatusProviderCallback(NativeBarcodeCountStatusProviderCallback impl) {
        Intrinsics.j(impl, "impl");
        this.f120874a = new BarcodeCountStatusProviderCallbackProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    }
}
