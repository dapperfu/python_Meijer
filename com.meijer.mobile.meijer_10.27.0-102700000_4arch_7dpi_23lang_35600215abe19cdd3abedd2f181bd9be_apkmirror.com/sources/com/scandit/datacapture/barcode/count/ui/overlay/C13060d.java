...
public final class C13060d implements BarcodeCountBasicOverlayListener, BarcodeCountBasicOverlayUiListener {

    /* renamed from: a, reason: collision with root package name */
    public final WeakReference f120784a;

    public C13060d(BarcodeCountBasicOverlay owner) {
        Intrinsics.j(owner, "owner");
        this.f120784a = new WeakReference(owner);
    }
    ...
    public final Brush brushForAcceptedBarcode(BarcodeCountBasicOverlay overlay, TrackedBarcode trackedBarcode) {
        ...
        BarcodeCountBasicOverlay barcodeCountBasicOverlay = (BarcodeCountBasicOverlay) this.f120784a.get();
        ...
        NativeBrush acceptedBrush = overlay.getF120773a().getAcceptedBrush();
    ...
    public final Brush brushForRecognizedBarcode(BarcodeCountBasicOverlay overlay, TrackedBarcode trackedBarcode) {
        ...
        NativeBrush scannedBrush = overlay.getF120773a().getScannedBrush();
    ...
    public final Brush brushForRecognizedBarcodeNotInList(BarcodeCountBasicOverlay overlay, TrackedBarcode trackedBarcode) {
        ...
        NativeBrush notInListBrush = overlay.getF120773a().getNotInListBrush();
    ...
    public final Brush brushForRejectedBarcode(BarcodeCountBasicOverlay overlay, TrackedBarcode trackedBarcode) {
        ...
        NativeBrush rejectedBrush = overlay.getF120773a().getRejectedBrush();
    ...
    public final Brush brushForUnrecognizedBarcode(BarcodeCountBasicOverlay overlay, TrackedBarcode trackedBarcode) {
        ...
        NativeBrush unscannedBrush = overlay.getF120773a().getUnscannedBrush();
