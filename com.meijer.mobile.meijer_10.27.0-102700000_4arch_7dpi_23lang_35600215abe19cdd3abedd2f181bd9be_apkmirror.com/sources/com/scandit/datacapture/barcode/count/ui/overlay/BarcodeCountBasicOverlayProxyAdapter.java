...
public final class BarcodeCountBasicOverlayProxyAdapter implements BarcodeCountBasicOverlayProxy {
    ...
    private final NativeBarcodeCountBasicOverlay f120773a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeDataCaptureOverlay f120775c;
    ...
    public BarcodeCountBasicOverlayProxyAdapter(NativeBarcodeCountBasicOverlay _NativeBarcodeCountBasicOverlay, ProxyCache proxyCache) {
        ...
        this.f120773a = _NativeBarcodeCountBasicOverlay;
        ...
        this.f120775c = nativeDataCaptureOverlayAsDataCaptureOverlay;
    }
    ...
    public void setFilterSettings(BarcodeFilterHighlightSettings barcodeFilterHighlightSettings) {
        ...
        if (barcodeFilterHighlightSettings != null) {
            NativeBarcodeFilterOverlaySettings nativeBarcodeFilterOverlaySettings_impl = barcodeFilterHighlightSettings.getF120929a();
        ...
        this.f120773a.setFilterSettings(nativeBarcodeFilterOverlaySettings);
    }
    ...
    public void _setProfilingOverlay(ProfilingOverlay overlay) {
        ...
        this.f120773a.setProfilingOverlay(f125770a);
    }

    @Override // com.scandit.datacapture.barcode.count.ui.overlay.BarcodeCountBasicOverlayProxy
    public NativeBarcodeClusterLiveEditor beginClusterEditing() {
        return this.f120773a.beginClusterEditing();
    }

    @Override // com.scandit.datacapture.barcode.count.ui.overlay.BarcodeCountBasicOverlayProxy
    public void didAcceptNotInListBarcode(TrackedBarcode barcode) {
        Intrinsics.j(barcode, "barcode");
        NativeTrackedBarcode f120470a = barcode.getF120470a();
        this.proxyCache.put(Reflection.b(NativeTrackedBarcode.class), null, f120470a, barcode);
        this.f120773a.didAcceptNotInListBarcode(f120470a);
    }
    ...
    public void didCancelNotInListBarcode(TrackedBarcode barcode) {
        ...
        NativeTrackedBarcode f120470a = barcode.getF120470a();
        this.proxyCache.put(Reflection.b(NativeTrackedBarcode.class), null, f120470a, barcode);
        this.f120773a.didCancelNotInListBarcode(f120470a);
    }
    ...
    public void didRejectNotInListBarcode(TrackedBarcode barcode) {
        ...
        NativeTrackedBarcode f120470a = barcode.getF120470a();
        this.proxyCache.put(Reflection.b(NativeTrackedBarcode.class), null, f120470a, barcode);
        this.f120773a.didRejectNotInListBarcode(f120470a);
    }

    @Override // com.scandit.datacapture.barcode.count.ui.overlay.BarcodeCountBasicOverlayProxy
    public BarcodeFilterHighlightSettings getFilterSettings() {
        NativeBarcodeFilterOverlaySettings filterSettings = this.f120773a.getFilterSettings();
    ...
    public boolean getShouldShowScanAreaGuides() {
        return this.f120773a.shouldShowScanAreaGuides();
    }

    @Override // com.scandit.datacapture.barcode.count.ui.overlay.BarcodeCountBasicOverlayProxy
    public boolean getShouldShowStatusIconsOnScan() {
        return this.f120773a.shouldShowStatusIconsOnScan();
    }

    @Override // com.scandit.datacapture.barcode.count.ui.overlay.BarcodeCountBasicOverlayProxy
    public NativeBarcodeCountBasicOverlayStyle getStyle() {
        NativeBarcodeCountBasicOverlayStyle style = this.f120773a.getStyle();
        Intrinsics.g(style);
        return style;
    }
    ...
    public String getTextForBarcodesNotInListDetectedHint() {
        String textForWrongBarcodesDetectedHint = this.f120773a.getTextForWrongBarcodesDetectedHint();
    ...
    public String getTextForMoveCloserAndRescanHint() {
        String textForMoveCloserAndRescanHint = this.f120773a.getTextForMoveCloserAndRescanHint();
    ...
    public String getTextForMoveFurtherAndRescanHint() {
        String textForMoveFurtherAndRescanHint = this.f120773a.getTextForMoveFurtherAndRescanHint();
    ...
    public String getTextForScanningHint() {
        String textForScanningHint = this.f120773a.getTextForScanningHint();
    ...
    public String getTextForScreenCleanedUpHint() {
        String textForScreenCleanedUpHint = this.f120773a.getTextForScreenCleanedUpHint();
    ...
    public String getTextForTapShutterToScanHint() {
        String textForTapShutterToScanHint = this.f120773a.getTextForTapShutterToScanHint();
    ...
    public String getTextForTapToUncountHint() {
        String textForTapToUncountHint = this.f120773a.getTextForTapToUncountHint();
    ...
    public String getTextForUnscannedBarcodesDetectedHint() {
        String textForUnscannedBarcodesDetectedHint = this.f120773a.getTextForUnscannedBarcodesDetectedHint();
