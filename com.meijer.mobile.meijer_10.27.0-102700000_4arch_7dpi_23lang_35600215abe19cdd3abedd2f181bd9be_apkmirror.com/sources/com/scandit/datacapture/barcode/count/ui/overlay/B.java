...
public final class B extends Lambda implements Function0 {
    ...
    public final /* synthetic */ NativeBarcodeFilterOverlaySettings f120758a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public B(NativeBarcodeFilterOverlaySettings nativeBarcodeFilterOverlaySettings) {
        super(0);
        this.f120758a = nativeBarcodeFilterOverlaySettings;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
        NativeBarcodeFilterOverlaySettings _0 = this.f120758a;
        Intrinsics.i(_0, "$_0");
