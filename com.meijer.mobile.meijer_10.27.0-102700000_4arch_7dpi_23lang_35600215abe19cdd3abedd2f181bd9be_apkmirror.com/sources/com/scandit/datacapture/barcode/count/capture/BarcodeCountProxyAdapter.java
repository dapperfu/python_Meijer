...
public final class BarcodeCountProxyAdapter implements BarcodeCountProxy {
    ...
    private final NativeBarcodeCount f120611a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeDataCaptureMode f120613c;
    ...
    public BarcodeCountProxyAdapter(NativeBarcodeCount _NativeBarcodeCount, ProxyCache proxyCache) {
        ...
        this.f120611a = _NativeBarcodeCount;
        ...
        this.f120613c = nativeDataCaptureModeAsDataCaptureMode;
    }
    ...
    public NativeDataCaptureMode getF120613c() {
    ...
    public void _setBarcodeCountCaptureList(BarcodeCountCaptureList list) {
        ...
        NativeBarcodeCountCaptureList f120649a = list.getF120649a();
        this.proxyCache.put(Reflection.b(NativeBarcodeCountCaptureList.class), null, f120649a, list);
        this.f120611a.setBarcodeCountCaptureList(f120649a);
    }

    @Override // com.scandit.datacapture.barcode.count.capture.BarcodeCountProxy
    public boolean _shouldDisableModeWhenCaptureListCompleted() {
        return this.f120611a.shouldDisableModeWhenCaptureListCompleted();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.BarcodeCountProxy
    public BarcodeClusterEditor beginClusterEditing() {
        NativeBarcodeClusterEditor nativeBarcodeClusterEditorBeginClusterEditing = this.f120611a.beginClusterEditing();
    ...
    public void clearAdditionalBarcodes() {
        this.f120611a.clearAdditionalBarcodes();
    }
    ...
    public boolean isEnabled() {
        return this.f120611a.isEnabled();
    }

    @Override // com.scandit.datacapture.barcode.count.capture.BarcodeCountProxy
    public void setEnabled(boolean z10) {
        this.f120611a.setEnabled(z10);
    }
