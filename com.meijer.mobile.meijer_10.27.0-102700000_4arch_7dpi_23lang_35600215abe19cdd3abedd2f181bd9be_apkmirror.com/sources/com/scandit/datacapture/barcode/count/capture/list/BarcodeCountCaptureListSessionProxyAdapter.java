...
public final class BarcodeCountCaptureListSessionProxyAdapter implements BarcodeCountCaptureListSessionProxy {
    ...
    private final NativeBarcodeCountCaptureListSession f120653a;
    ...
    public BarcodeCountCaptureListSessionProxyAdapter(NativeBarcodeCountCaptureListSession _NativeBarcodeCountCaptureListSession, ProxyCache proxyCache) {
        ...
        this.f120653a = _NativeBarcodeCountCaptureListSession;
    ...
    public List<TrackedBarcode> getAcceptedBarcodes() {
        ArrayList<NativeTrackedBarcode> acceptedBarcodesList = this.f120653a.getAcceptedBarcodesList();
    ...
    public List<Barcode> getAdditionalBarcodes() {
        ArrayList<NativeBarcode> additionalBarcodes = this.f120653a.getAdditionalBarcodes();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
    ...
    public List<TrackedBarcode> getCorrectBarcodes() {
        ArrayList<NativeTrackedBarcode> correctBarcodes = this.f120653a.getCorrectBarcodes();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
    ...
    public List<TargetBarcode> getMissingBarcodes() {
        ArrayList<NativeTargetBarcode> missingBarcodes = this.f120653a.getMissingBarcodes();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
    ...
    public List<TrackedBarcode> getRejectedBarcodes() {
        ArrayList<NativeTrackedBarcode> rejectedBarcodesList = this.f120653a.getRejectedBarcodesList();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
    ...
    public List<TrackedBarcode> getWrongBarcodes() {
        ArrayList<NativeTrackedBarcode> wrongBarcodes = this.f120653a.getWrongBarcodes();
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
    ...
    public String toJson() {
        String json = this.f120653a.toJson();
        Intrinsics.g(json);
        return json;
    }
