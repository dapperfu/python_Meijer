...
public final class e extends Lambda implements Function0 {
    ...
    public final /* synthetic */ NativeBarcodeSpatialGridElement f120697a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e(NativeBarcodeSpatialGridElement nativeBarcodeSpatialGridElement) {
        super(0);
        this.f120697a = nativeBarcodeSpatialGridElement;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        BarcodeNativeTypeFactory barcodeNativeTypeFactory = BarcodeNativeTypeFactory.INSTANCE;
        NativeBarcodeSpatialGridElement _0 = this.f120697a;
        Intrinsics.i(_0, "$_0");
