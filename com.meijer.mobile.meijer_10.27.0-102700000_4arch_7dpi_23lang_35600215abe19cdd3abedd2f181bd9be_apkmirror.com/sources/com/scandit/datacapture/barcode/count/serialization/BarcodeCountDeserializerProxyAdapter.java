...
public final class BarcodeCountDeserializerProxyAdapter implements BarcodeCountDeserializerProxy {
    ...
    private final NativeBarcodeCountDeserializer f120733a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeDataCaptureModeDeserializer f120735c;

    /* renamed from: d, reason: collision with root package name */
    private BarcodeCountDeserializer f120736d;
    ...
    public BarcodeCountDeserializerProxyAdapter(NativeBarcodeCountDeserializer _NativeBarcodeCountDeserializer, ProxyCache proxyCache) {
        ...
        this.f120733a = _NativeBarcodeCountDeserializer;
        ...
        this.f120735c = nativeDataCaptureModeDeserializerAsDataCaptureModeDeserializer;
    }
    ...
    public BarcodeCountDeserializer _deserializer() {
        BarcodeCountDeserializer barcodeCountDeserializer = this.f120736d;
    ...
    public BarcodeCount _modeFromJson(DataCaptureContext dataCaptureContext, String json) {
        ...
        NativeBarcodeCount nativeBarcodeCountBarcodeCountFromJson = this.f120733a.barcodeCountFromJson(nativeDataCaptureContext_impl, CoreNativeTypeFactory.INSTANCE.convert(json));
    ...
    public BarcodeCountBasicOverlay _overlayFromJson(BarcodeCount mode, String jsonData) {
        ...
        NativeBarcodeCount nativeBarcodeCount_impl = mode.getF120611a();
        this.proxyCache.put(Reflection.b(NativeBarcodeCount.class), null, nativeBarcodeCount_impl, mode);
        NativeBarcodeCountBasicOverlay nativeBarcodeCountBasicOverlayBarcodeCountBasicOverlayFromJson = this.f120733a.barcodeCountBasicOverlayFromJson(nativeBarcodeCount_impl, CoreNativeTypeFactory.INSTANCE.convert(jsonData));
        ProxyCache proxyCache = this.proxyCache;
    ...
    public void _setDeserializer(BarcodeCountDeserializer deserializer) {
        ...
        this.f120736d = deserializer;
    }

    @Override // com.scandit.datacapture.barcode.count.serialization.BarcodeCountDeserializerProxy
    public BarcodeCountSettings _settingsFromJson(String json) {
        Intrinsics.j(json, "json");
        NativeBarcodeCountSettings nativeBarcodeCountSettings = this.f120733a.settingsFromJson(CoreNativeTypeFactory.INSTANCE.convert(json));
        ProxyCache proxyCache = this.proxyCache;
    ...
    public BarcodeCountBasicOverlay _updateOverlayFromJson(BarcodeCountBasicOverlay overlay, String jsonData) {
        ...
        Intrinsics.j(jsonData, "jsonData");
        NativeBarcodeCountBasicOverlay nativeBarcodeCountBasicOverlay_impl = overlay.getF120773a();
        this.proxyCache.put(Reflection.b(NativeBarcodeCountBasicOverlay.class), null, nativeBarcodeCountBasicOverlay_impl, overlay);
        NativeBarcodeCountBasicOverlay nativeBarcodeCountBasicOverlayUpdateBarcodeCountBasicOverlayFromJson = this.f120733a.updateBarcodeCountBasicOverlayFromJson(nativeBarcodeCountBasicOverlay_impl, CoreNativeTypeFactory.INSTANCE.convert(jsonData));
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeBarcodeCountBasicOverlay.class);
    ...
    public CameraSettings createRecommendedCameraSettings() {
        NativeCameraSettings nativeCameraSettingsCreateRecommendedCameraSettings = this.f120733a.createRecommendedCameraSettings();
    ...
    public List<String> getWarnings() {
        ArrayList<String> warnings = this.f120733a.getWarnings();
    ...
    public BarcodeCountDeserializerHelper get_helper() {
        return (BarcodeCountDeserializerHelper) this.proxyCache.requireByValue(Reflection.b(BarcodeCountDeserializerHelper.class), this.f120733a.getHelper());
    }
    ...
    public BarcodeCount updateModeFromJson(BarcodeCount mode, String json) {
        ...
        NativeBarcodeCount nativeBarcodeCount_impl = mode.getF120611a();
        this.proxyCache.put(Reflection.b(NativeBarcodeCount.class), null, nativeBarcodeCount_impl, mode);
        NativeBarcodeCount nativeBarcodeCountUpdateBarcodeCountFromJson = this.f120733a.updateBarcodeCountFromJson(nativeBarcodeCount_impl, CoreNativeTypeFactory.INSTANCE.convert(json));
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeBarcodeCount.class);
    ...
    public BarcodeCountSettings updateSettingsFromJson(BarcodeCountSettings settings, String json) {
        ...
        Intrinsics.j(json, "json");
        NativeBarcodeCountSettings nativeBarcodeCountSettings_impl = settings.getF120623a();
        this.proxyCache.put(Reflection.b(NativeBarcodeCountSettings.class), null, nativeBarcodeCountSettings_impl, settings);
        NativeBarcodeCountSettings nativeBarcodeCountSettingsUpdateSettingsFromJson = this.f120733a.updateSettingsFromJson(nativeBarcodeCountSettings_impl, CoreNativeTypeFactory.INSTANCE.convert(json));
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeBarcodeCountSettings.class);
