...
public final class BarcodeCountDeserializerHelperReversedAdapter extends NativeBarcodeCountDeserializerHelper {
    ...
    private final BarcodeCountDeserializerHelper f120728a;
    ...
    public BarcodeCountDeserializerHelperReversedAdapter(BarcodeCountDeserializerHelper _BarcodeCountDeserializerHelper, ProxyCache proxyCache) {
        ...
        this.f120728a = _BarcodeCountDeserializerHelper;
    ...
    public void applySettings(NativeBarcodeCount mode, NativeBarcodeCountSettings settings) {
        ...
        this.f120728a.applySettings((BarcodeCount) this.proxyCache.require(Reflection.b(NativeBarcodeCount.class), null, mode), (BarcodeCountSettings) this.proxyCache.require(Reflection.b(NativeBarcodeCountSettings.class), null, settings));
    }
    ...
    public void changeBasicOverlayAddedToView(NativeBarcodeCountBasicOverlay overlay, NativeDataCaptureView view, boolean added) {
        ...
        this.f120728a.changeBasicOverlayAddedToView((BarcodeCountBasicOverlay) this.proxyCache.require(Reflection.b(NativeBarcodeCountBasicOverlay.class), null, overlay), (DataCaptureView) this.proxyCache.require(Reflection.b(NativeDataCaptureView.class), null, view), added);
    }
    ...
    public NativeBarcodeCountBasicOverlay createBasicOverlay(NativeBarcodeCount mode, NativeBarcodeCountBasicOverlayStyle style) {
        ...
        BarcodeCountBasicOverlay barcodeCountBasicOverlayCreateBasicOverlay = this.f120728a.createBasicOverlay((BarcodeCount) this.proxyCache.require(Reflection.b(NativeBarcodeCount.class), null, mode), BarcodeNativeTypeFactory.INSTANCE.convert(style));
    ...
    public NativeBarcodeCount createMode(NativeDataCaptureContext context) {
        ...
        BarcodeCount barcodeCountCreateMode = this.f120728a.createMode((DataCaptureContext) this.proxyCache.getOrPut(Reflection.b(NativeDataCaptureContext.class), null, context, new d(context)));
    ...
    public NativeBarcodeCountSettings createSettings() {
        BarcodeCountSettings barcodeCountSettingsCreateSettings = this.f120728a.createSettings();
    ...
    public void updateBasicOverlayFromJson(NativeBarcodeCountBasicOverlay overlay, NativeJsonValue json) {
        ...
        this.f120728a.updateBasicOverlayFromJson((BarcodeCountBasicOverlay) this.proxyCache.require(Reflection.b(NativeBarcodeCountBasicOverlay.class), null, overlay), (JsonValue) this.proxyCache.getOrPut(Reflection.b(NativeJsonValue.class), null, json, new e(json)));
    }
    ...
    public void updateModeFromJson(NativeBarcodeCount mode, NativeJsonValue json) {
        Intrinsics.j(mode, "mode");
        Intrinsics.j(json, "json");
        this.f120728a.updateModeFromJson((BarcodeCount) this.proxyCache.require(Reflection.b(NativeBarcodeCount.class), null, mode), (JsonValue) this.proxyCache.getOrPut(Reflection.b(NativeJsonValue.class), null, json, new f(json)));
    }
    ...
    public void updateSettingsFromJson(NativeBarcodeCountSettings settings, NativeJsonValue json) {
        Intrinsics.j(settings, "settings");
        Intrinsics.j(json, "json");
        this.f120728a.updateSettingsFromJson((BarcodeCountSettings) this.proxyCache.require(Reflection.b(NativeBarcodeCountSettings.class), null, settings), (JsonValue) this.proxyCache.getOrPut(Reflection.b(NativeJsonValue.class), null, json, new g(json)));
    }
