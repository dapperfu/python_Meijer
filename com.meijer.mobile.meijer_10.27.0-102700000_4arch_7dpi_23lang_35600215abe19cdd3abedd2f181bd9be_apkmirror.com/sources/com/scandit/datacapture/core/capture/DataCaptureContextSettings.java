...
public final class DataCaptureContextSettings implements DataCaptureContextSettingsProxy {
    ...
    private final /* synthetic */ DataCaptureContextSettingsProxyAdapter f124056a;

    public DataCaptureContextSettings(NativeDataCaptureContextSettings impl) {
        Intrinsics.j(impl, "impl");
        this.f124056a = new DataCaptureContextSettingsProxyAdapter(impl, null, 2, null);
    }

    @Override // com.scandit.datacapture.core.capture.DataCaptureContextSettingsProxy
    @NativeImpl
    /* renamed from: _impl */
    public NativeDataCaptureContextSettings getF124057a() {
        return this.f124056a.getF124057a();
    }
    ...
    */
    public final java.lang.Object getProperty(java.lang.String r3) {
        ...
        L19:
            ...
            goto L49
        L22:
            com.scandit.datacapture.core.internal.sdk.capture.NativeDataCaptureContextSettings r3 = r2.getF124057a()
    ...
    public final void setProperty(String name, Object value) {
        ...
        if (Intrinsics.e(name, "analyticsSettings") && (value instanceof AnalyticsSettings)) {
            getF124057a().setAnalyticsSettings(((AnalyticsSettings) value).getF125347a());
            return;
        }
        if (Intrinsics.e(name, "numberOfEngineThreads") && (value instanceof Integer)) {
            getF124057a().setNumberOfEngineThreads(((Number) value).intValue());
            return;
        }
        if (Intrinsics.e(name, "enabledCpusBitset") && (value instanceof String)) {
            getF124057a().setEnabledCpusBitset((String) value);
            return;
        }
        if (value instanceof Boolean) {
            getF124057a().setBoolProperty(name, ((Boolean) value).booleanValue());
            return;
        }
        if (value instanceof Integer) {
            getF124057a().setIntProperty(name, ((Number) value).intValue());
        } else if (value instanceof Float) {
            getF124057a().setFloatProperty(name, ((Number) value).floatValue());
        } else if (value instanceof String) {
            getF124057a().setStringProperty(name, (String) value);
        }
    }
