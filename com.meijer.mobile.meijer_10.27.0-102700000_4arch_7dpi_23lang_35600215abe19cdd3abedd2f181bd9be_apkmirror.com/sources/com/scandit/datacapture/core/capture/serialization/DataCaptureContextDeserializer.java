...
public final class DataCaptureContextDeserializer implements DataCaptureContextDeserializerProxy {
    ...
    private final FrameSourceDeserializer f124076a;

    /* renamed from: b, reason: collision with root package name */
    private final DataCaptureViewDeserializer f124077b;

    /* renamed from: c, reason: collision with root package name */
    private final List f124078c;

    /* renamed from: d, reason: collision with root package name */
    private final List f124079d;

    /* renamed from: e, reason: collision with root package name */
    private final /* synthetic */ DataCaptureContextDeserializerProxyAdapter f124080e;

    /* renamed from: f, reason: collision with root package name */
    private final b f124081f;
    ...
    public DataCaptureContextDeserializer(FrameSourceDeserializer frameSourceDeserializer, DataCaptureViewDeserializer viewDeserializer, List<? extends DataCaptureModeDeserializer> modeDeserializers, List<? extends DataCaptureComponentDeserializer> componentDeserializers, NativeDataCaptureContextDeserializer impl) {
        ...
        this.f124076a = frameSourceDeserializer;
        this.f124077b = viewDeserializer;
        this.f124078c = modeDeserializers;
        this.f124079d = componentDeserializers;
        this.f124080e = new DataCaptureContextDeserializerProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    ...
    public DataCaptureContextDeserializer _deserializer() {
        return this.f124080e._deserializer();
    }
    ...
    public NativeDataCaptureContextDeserializer getF124088a() {
        return this.f124080e.getF124088a();
    }
    ...
    public void _setDeserializer(DataCaptureContextDeserializer deserializer) {
        ...
        this.f124080e._setDeserializer(deserializer);
    }

    @Override // com.scandit.datacapture.core.capture.serialization.DataCaptureContextDeserializerProxy
    @ProxyFunction(nativeName = "setHelper")
    public void _setHelper(DataCaptureContextDeserializerHelper helper) {
        this.f124080e._setHelper(helper);
    }

    @Override // com.scandit.datacapture.core.capture.serialization.DataCaptureContextDeserializerProxy
    @ProxyFunction(nativeName = "setListener")
    public void _setListener(DataCaptureContextDeserializerListener listener) {
        this.f124080e._setListener(listener);
    }

    @Override // com.scandit.datacapture.core.capture.serialization.DataCaptureContextDeserializerProxy
    @ProxyFunction(property = "avoidThreadDependencies")
    public boolean getAvoidThreadDependencies() {
        return this.f124080e.getAvoidThreadDependencies();
    }

    @Override // com.scandit.datacapture.core.capture.serialization.DataCaptureContextDeserializerProxy
    @ProxyFunction(property = "avoidThreadDependencies")
    public void setAvoidThreadDependencies(boolean z10) {
        this.f124080e.setAvoidThreadDependencies(z10);
    }

    public final DataCaptureContextDeserializerResult contextFromJson(String jsonData) {
        Intrinsics.j(jsonData, "jsonData");
        NativeDataCaptureContextDeserializerResult nativeDataCaptureContextDeserializerResultContextFromJson = getF124088a().contextFromJson(new JsonValue(jsonData).getF125830a());
        DataCaptureContext dataCaptureContext = this.f124081f.f124097a;
        DataCaptureView deserializedView = this.f124077b.get_helper().getDeserializedView();
        ...
        this.f124081f.f124097a = null;
        this.f124076a.get_helper().clear();
        this.f124077b.get_helper().clear();
        Iterator it = this.f124078c.iterator();
        while (it.hasNext()) {
            ((DataCaptureModeDeserializer) it.next()).get_helper().clear();
        }
        Iterator it2 = this.f124079d.iterator();
        while (it2.hasNext()) {
    ...
    public final DataCaptureContextDeserializerResult updateContextFromJson(DataCaptureContext dataCaptureContext, DataCaptureView view, List<? extends DataCaptureComponent> components, String jsonData) {
        ...
        NativeDataCaptureContextDeserializer f124088a = getF124088a();
        ...
        NativeDataCaptureContextDeserializerResult nativeDataCaptureContextDeserializerResultUpdateContextFromJson = f124088a.updateContextFromJson(nativeDataCaptureContext_impl, nativeDataCaptureView_impl, new ArrayList<>(arrayList), new JsonValue(jsonData).getF125830a());
        if (view == null) {
            view = this.f124077b.get_helper().getDeserializedView();
        }
        ...
        this.f124076a.get_helper().clear();
        this.f124077b.get_helper().clear();
        Iterator it2 = this.f124078c.iterator();
        while (it2.hasNext()) {
            ((DataCaptureModeDeserializer) it2.next()).get_helper().clear();
        }
        Iterator it3 = this.f124079d.iterator();
        while (it3.hasNext()) {
    ...
    public DataCaptureContextDeserializer(FrameSourceDeserializer frameSourceDeserializer, DataCaptureViewDeserializer viewDeserializer, List<? extends DataCaptureModeDeserializer> modeDeserializers, List<? extends DataCaptureComponentDeserializer> componentDeserializers) {
        ...
        Intrinsics.j(modeDeserializers, "modeDeserializers");
        Intrinsics.j(componentDeserializers, "componentDeserializers");
        NativeFrameSourceDeserializer f125927a = frameSourceDeserializer.getF125927a();
        ...
        NativeDataCaptureContextDeserializer nativeDataCaptureContextDeserializerCreate = NativeDataCaptureContextDeserializer.create(f125927a, nativeDataCaptureViewDeserializer_impl, arrayList2, new ArrayList(arrayList3));
