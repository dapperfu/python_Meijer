...
public final class DataCaptureContextDeserializerHelperReversedAdapter extends NativeDataCaptureContextDeserializerHelper {
    ...
    private final DataCaptureContextDeserializerHelper f124083a;
    ...
    public void removeModeFromContext(NativeDataCaptureContext c10, NativeDataCaptureMode m10) {
        Intrinsics.j(c10, "c");
        Intrinsics.j(m10, "m");
        this.f124083a.removeModeFromContext((DataCaptureContext) this.proxyCache.getOrPut(Reflection.b(NativeDataCaptureContext.class), null, c10, new d(c10)), (DataCaptureMode) this.proxyCache.require(Reflection.b(NativeDataCaptureMode.class), null, m10));
    }

    @Override // com.scandit.datacapture.core.internal.module.serialization.NativeDataCaptureContextDeserializerHelper
    public void setFrameSourceOnContext(NativeDataCaptureContext c10, NativeFrameSource f10) {
        Intrinsics.j(c10, "c");
        this.f124083a.setFrameSourceOnContext((DataCaptureContext) this.proxyCache.getOrPut(Reflection.b(NativeDataCaptureContext.class), null, c10, new e(c10)), f10 != null ? (FrameSource) this.proxyCache.require(Reflection.b(NativeFrameSource.class), null, f10) : null);
    }
    ...
    public void updateContextFromJson(NativeDataCaptureContext context, NativeJsonValue json) {
        ...
        this.f124083a.updateContextFromJson((DataCaptureContext) this.proxyCache.getOrPut(Reflection.b(NativeDataCaptureContext.class), null, context, new f(context)), (JsonValue) this.proxyCache.getOrPut(Reflection.b(NativeJsonValue.class), null, json, new g(json)));
    }
    ...
    public DataCaptureContextDeserializerHelperReversedAdapter(DataCaptureContextDeserializerHelper dataCaptureContextDeserializerHelper, ProxyCache proxyCache) {
        ...
        this.f124083a = dataCaptureContextDeserializerHelper;
