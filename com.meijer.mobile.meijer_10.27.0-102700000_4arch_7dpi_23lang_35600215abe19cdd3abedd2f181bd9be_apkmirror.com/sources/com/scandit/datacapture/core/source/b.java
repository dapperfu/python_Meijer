...
public final class b implements S {
    ...
    public final WeakReference f125910a;

    public b(Camera owner) {
        Intrinsics.j(owner, "owner");
        this.f125910a = new WeakReference(owner);
    }
    ...
    public final void onFrameOutput(FrameSource frameSource, FrameData frame) {
        ...
        Camera camera = (Camera) this.f125910a.get();
        if (camera == null || (copyOnWriteArraySet = camera.f125884d) == null) {
            return;
        }
