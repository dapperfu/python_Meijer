...
public final class BitmapFrameSourceProxyAdapter implements BitmapFrameSourceProxy {
    ...
    private final NativeFrameDataCollectionFrameSource f125877a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeFrameSource f125879c;
    ...
    public BitmapFrameSourceProxyAdapter(NativeFrameDataCollectionFrameSource _NativeFrameDataCollectionFrameSource, ProxyCache proxyCache) {
        ...
        this.f125877a = _NativeFrameDataCollectionFrameSource;
        ...
        this.f125879c = nativeFrameSourceAsFrameSource;
    }
    ...
    public NativeWrappedFuture _switchToDesiredState(FrameSourceState desiredState) {
        ...
        NativeWrappedFuture nativeWrappedFutureSwitchToDesiredStateAsyncAndroid = this.f125877a.switchToDesiredStateAsyncAndroid(desiredState);
    ...
    public FrameSourceState getCurrentState() {
        FrameSourceState currentState = this.f125877a.getCurrentState();
    ...
    public FrameSourceState getDesiredState() {
        FrameSourceState desiredState = this.f125877a.getDesiredState();
