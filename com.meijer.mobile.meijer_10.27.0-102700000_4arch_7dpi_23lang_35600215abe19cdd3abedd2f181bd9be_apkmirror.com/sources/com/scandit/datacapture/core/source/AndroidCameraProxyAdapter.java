...
public final class AndroidCameraProxyAdapter implements AndroidCameraProxy {
    ...
    private final NativeAndroidCamera f125871a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeFrameSource f125873c;
    ...
    public AndroidCameraProxyAdapter(NativeAndroidCamera _NativeAndroidCamera, ProxyCache proxyCache) {
        ...
        this.f125871a = _NativeAndroidCamera;
        ...
        this.f125873c = nativeFrameSourceAsFrameSource;
    }
    ...
    public NativeWrappedFuture _applySettings(CameraSettings settings) {
        ...
        NativeWrappedFuture nativeWrappedFutureApplySettingsAsyncAndroid = this.f125871a.applySettingsAsyncAndroid(CoreNativeTypeFactory.INSTANCE.convert(settings));
    ...
    public NativeWrappedFuture _applyTorchStateAsync(TorchState torchState) {
        ...
        NativeWrappedFuture nativeWrappedFutureApplyTorchStateAsyncWrapped = this.f125871a.applyTorchStateAsyncWrapped(torchState);
    ...
    public NativeFrameSource getF125873c() {
    ...
    public NativeWrappedFuture _switchToDesiredState(FrameSourceState desiredState) {
        ...
        NativeWrappedFuture nativeWrappedFutureSwitchToDesiredStateAsyncAndroid = this.f125871a.switchToDesiredStateAsyncAndroid(desiredState);
    ...
    public FrameSourceState getCurrentState() {
        FrameSourceState currentState = this.f125871a.getCurrentState();
    ...
    public FrameSourceState getDesiredState() {
        FrameSourceState desiredState = this.f125871a.getDesiredState();
    ...
    public CameraPosition getPosition() {
        CameraPosition position = this.f125871a.getPosition();
    ...
    public boolean isTorchAvailable() {
        return this.f125871a.isTorchAvailable();
    }
