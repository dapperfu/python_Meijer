...
public final class SequenceFrameSource implements FrameSource, SequenceFrameSourceProxy {
    ...
    private final CameraPosition f125896a;

    /* renamed from: b, reason: collision with root package name */
    private final int f125897b;

    /* renamed from: c, reason: collision with root package name */
    private final BufferStack f125898c;

    /* renamed from: d, reason: collision with root package name */
    private final Function1 f125899d;

    /* renamed from: e, reason: collision with root package name */
    private final /* synthetic */ SequenceFrameSourceProxyAdapter f125900e;

    /* renamed from: f, reason: collision with root package name */
    private final LinkedHashMap f125901f;

    /* renamed from: g, reason: collision with root package name */
    private final g f125902g;

    /* renamed from: h, reason: collision with root package name */
    private final CopyOnWriteArraySet f125903h;
    ...
    public SequenceFrameSource(NativeFrameDataGeneratorFrameSource impl, CameraPosition captureDevicePosition, int i10, BufferStack buffers, Function1<? super byte[], Unit> bufferProcessingFinished) {
        ...
        this.f125896a = captureDevicePosition;
        this.f125897b = i10;
        this.f125898c = buffers;
        this.f125899d = bufferProcessingFinished;
        this.f125900e = new SequenceFrameSourceProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        this.f125901f = new LinkedHashMap();
        this.f125902g = new g(this);
        this.f125903h = new CopyOnWriteArraySet();
    ...
    public NativeFrameSource _frameSourceImpl() {
        return this.f125900e.getF125906c();
    }
    ...
    public NativeFrameDataGeneratorFrameSource getF125904a() {
        return this.f125900e.getF125904a();
    }
    ...
    public NativeWrappedFuture _switchToDesiredState(FrameSourceState desiredState) {
        ...
        return this.f125900e._switchToDesiredState(desiredState);
    }
    ...
    public final void addFrame(int width, int height, byte[] buffer) {
        ...
        NativeCameraFrameData nativeCameraFrameDataCreate = NativeCameraFrameData.create(width, height, buffer, this.f125902g, this.f125897b, this.f125896a == CameraPosition.USER_FACING ? NativeAxis.X : NativeAxis.NONE, NativeCameraCaptureParameters.create(), null);
        Intrinsics.i(nativeCameraFrameDataCreate, "create(...)");
        LinkedHashMap linkedHashMap = this.f125901f;
    ...
    public static final void access$returnToPool(SequenceFrameSource sequenceFrameSource, NativeCameraFrameData nativeCameraFrameData) {
        sequenceFrameSource.f125901f.remove(nativeCameraFrameData);
        byte[] bArrTakeBuffer = nativeCameraFrameData.takeBuffer();
        if (bArrTakeBuffer != null) {
            sequenceFrameSource.f125899d.invoke(bArrTakeBuffer);
            sequenceFrameSource.f125898c.a(bArrTakeBuffer);
        }
    }
    ...
    public void removeListener(FrameSourceListener listener) {
        Intrinsics.j(listener, "listener");
        if (this.f125903h.remove(listener)) {
    ...
    public final void addFrame(Image frame) {
        ...
        if (frame.getFormat() == 35) {
            NativeCameraFrameData nativeCameraFrameDataConvertToFrameData$default = ImageExtensionsKt.convertToFrameData$default(frame, this.f125898c, this.f125902g, this.f125897b, this.f125896a == CameraPosition.USER_FACING, false, null, 32, null);
            if (nativeCameraFrameDataConvertToFrameData$default != null) {
                ...
                getF125904a().addFrame((NativeFrameData) this.f125901f.get(nativeCameraFrameDataConvertToFrameData$default));
                return;
            }
            return;
        }
