...
public final class ImageBuffer implements ImageBufferProxy {
    ...
    private final /* synthetic */ ImageBufferProxyAdapter f124143a;
    ...
    public ImageBuffer(NativeImageBuffer impl) {
        ...
        this.f124143a = new ImageBufferProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    }
    ...
    public NativeImageBuffer getF124144a() {
        return this.f124143a.getF124144a();
    }

    @Override // com.scandit.datacapture.core.common.graphic.ImageBufferProxy
    @ProxyFunction(property = "height")
    public int getHeight() {
        return this.f124143a.getHeight();
    }

    @Override // com.scandit.datacapture.core.common.graphic.ImageBufferProxy
    @ProxyFunction(property = "planes")
    public List<ImagePlane> getPlanes() {
        return this.f124143a.getPlanes();
    }

    @Override // com.scandit.datacapture.core.common.graphic.ImageBufferProxy
    @ProxyFunction(property = "width")
    public int getWidth() {
        return this.f124143a.getWidth();
    }

    public final ImageBuffer deepCopy() {
        NativeImageBuffer nativeImageBufferDeepCopy = getF124144a().deepCopy();
    ...
    public final Bitmap toBitmap() {
        int i10 = WhenMappings.$EnumSwitchMapping$0[ImageBufferUtilsKt.getFormat(getF124144a()).ordinal()];
        if (i10 != 1) {
            if (i10 == 2) {
                YuvImage yuvImage = new YuvImage(getF124144a().toBitmap(), 17, getWidth(), getHeight(), null);
        ...
        bitmapCreateBitmap.copyPixelsFromBuffer(ByteBuffer.wrap(getF124144a().toBitmap()));
