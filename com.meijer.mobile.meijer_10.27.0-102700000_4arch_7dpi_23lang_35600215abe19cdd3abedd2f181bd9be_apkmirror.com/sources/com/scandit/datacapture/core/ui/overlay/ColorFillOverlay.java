...
public final class ColorFillOverlay implements DataCaptureOverlay, ColorFillOverlayProxy {
    ...
    private static final NativeColor f126130b = NativeColorExtensionsKt.toNativeColor(0);

    /* renamed from: a, reason: collision with root package name */
    private final /* synthetic */ ColorFillOverlayProxyAdapter f126131a;

    public ColorFillOverlay(NativeColorFillOverlay impl) {
        Intrinsics.j(impl, "impl");
        this.f126131a = new ColorFillOverlayProxyAdapter(impl, null, 2, null);
    }
    ...
    public NativeDataCaptureOverlay getF126134c() {
        return this.f126131a.getF126134c();
    }
    ...
    public NativeColorFillOverlay getF126132a() {
        return this.f126131a.getF126132a();
    }

    @Override // com.scandit.datacapture.core.ui.overlay.ColorFillOverlayProxy
    @ProxyFunction(property = "color")
    public int getColor() {
        return this.f126131a.getColor();
    }

    @Override // com.scandit.datacapture.core.ui.overlay.ColorFillOverlayProxy
    @ProxyFunction(property = "color")
    public void setColor(int i10) {
        this.f126131a.setColor(i10);
    }

    /* JADX WARN: Illegal instructions before constructor call */
    public ColorFillOverlay() {
        NativeColorFillOverlay nativeColorFillOverlayCreate = NativeColorFillOverlay.create(f126130b);
