...
public final class DataCaptureView extends RelativeLayout implements DataCaptureViewProxy {
    ...
    private final ContextStatusPresenter f125944a;

    /* renamed from: b, reason: collision with root package name */
    private final float f125945b;

    /* renamed from: c, reason: collision with root package name */
    private final /* synthetic */ DataCaptureViewProxyAdapter f125946c;

    /* renamed from: d, reason: collision with root package name */
    private final CopyOnWriteArraySet f125947d;

    /* renamed from: e, reason: collision with root package name */
    private final CopyOnWriteArraySet f125948e;

    /* renamed from: f, reason: collision with root package name */
    private final CopyOnWriteArraySet f125949f;

    /* renamed from: g, reason: collision with root package name */
    private final DataCaptureTextureView f125950g;

    /* renamed from: h, reason: collision with root package name */
    private final FrameLayout f125951h;
    ...
    private boolean f125952i;

    /* renamed from: j, reason: collision with root package name and from kotlin metadata */
    private final ControlLayout controlLayout;

    /* renamed from: k, reason: collision with root package name */
    private HintHolderV2 f125954k;

    /* renamed from: l, reason: collision with root package name */
    private final ErrorOverlay f125955l;

    /* renamed from: m, reason: collision with root package name */
    private final DataCaptureView$contextStatusView$1 f125956m;

    /* renamed from: n, reason: collision with root package name */
    private final DataCaptureView$orientationEventListener$1 f125957n;

    /* renamed from: o, reason: collision with root package name */
    private int f125958o;

    /* renamed from: p, reason: collision with root package name */
    private final DataCaptureView$special$$inlined$distinctObservable$1 f125959p;

    /* renamed from: q, reason: collision with root package name */
    private final DataCaptureView$dataCaptureContextListener$1 f125960q;
    ...
    static final /* synthetic */ KProperty[] f125943v = {Reflection.f(new MutablePropertyReference1Impl(Reflection.b(DataCaptureView.class), "currentSize", "getCurrentSize$scandit_capture_core()Lcom/scandit/datacapture/core/internal/module/ui/ViewSizeAndRotation;"))};
    ...
    public void _addOverlay(DataCaptureOverlay overlay) {
        ...
        this.f125946c._addOverlay(overlay);
    }
    ...
    public void _removeOverlay(DataCaptureOverlay overlay) {
        Intrinsics.j(overlay, "overlay");
        this.f125946c._removeOverlay(overlay);
    }
    ...
    public void _setGestureRecognizer(GestureRecognizer recognizer) {
        ...
        this.f125946c._setGestureRecognizer(recognizer);
    }

    @Override // com.scandit.datacapture.core.ui.DataCaptureViewProxy
    @ProxyFunction(nativeName = "setNeedsRedraw")
    public void _setNeedsRedraw() {
        this.f125946c._setNeedsRedraw();
    }
    ...
    public void _setNeedsRedrawListener(NeedsRedrawListener listener) {
        ...
        this.f125946c._setNeedsRedrawListener(listener);
    }
    ...
    public final synchronized void onSurfaceTextureAvailable$scandit_capture_core() {
        try {
            ...
            if (dataCaptureContext != null) {
                if (!this.f125952i) {
                    dataCaptureContext.addListener(this.f125960q);
                }
                getF125971a().setDataCaptureContext(dataCaptureContext.getF124053a());
    ...
    public final synchronized void onSurfaceTextureDestroyed$scandit_capture_core() {
        ...
        DataCaptureContext dataCaptureContext = this.dataCaptureContext;
        if (dataCaptureContext != null) {
            dataCaptureContext.removeListener(this.f125960q);
        }
    }

    public final synchronized void onSurfaceTextureUpdated$scandit_capture_core() {
        try {
            if (getF125971a().isDisplayingViewfinder()) {
                this.f125954k.setViewFinderRect(getF125971a().getViewfinderRect());
            } else {
                this.f125954k.setViewFinderRect(null);
            }
        } catch (Throwable th2) {
            throw th2;
        }
    ...
    public final void setDataCaptureContext(DataCaptureContext dataCaptureContext) {
        synchronized (this) {
            try {
                ...
                if (dataCaptureContext2 != null && this.f125952i) {
                    dataCaptureContext2.removeListener(this.f125960q);
                }
                ...
                if (dataCaptureContext != null) {
                    ...
                    NativeDataCaptureView nativeDataCaptureView_impl = getF125971a();
                    DataCaptureContext dataCaptureContext3 = this.dataCaptureContext;
                    nativeDataCaptureView_impl.setDataCaptureContext(dataCaptureContext3 != null ? dataCaptureContext3.getF124053a() : null);
                }
    ...
    public void setLogoAnchor(Anchor anchor) {
        ...
        this.f125946c.setLogoAnchor(anchor);
    }
    ...
    public void setLogoOffset(PointWithUnit pointWithUnit) {
        ...
        this.f125946c.setLogoOffset(pointWithUnit);
    }
    ...
    public void setLogoStyle(LogoStyle logoStyle) {
        ...
        this.f125946c.setLogoStyle(logoStyle);
    }
    ...
    public void setPointOfInterest(PointWithUnit pointWithUnit) {
        Intrinsics.j(pointWithUnit, "<set-?>");
        this.f125946c.setPointOfInterest(pointWithUnit);
    }
    ...
    public void setScanAreaMargins(MarginsWithUnit marginsWithUnit) {
        ...
        this.f125946c.setScanAreaMargins(marginsWithUnit);
    }

    public final void _overrideHintHolderV2(HintHolderV2 hintHolder) {
        Intrinsics.j(hintHolder, "hintHolder");
        ViewExtensionsKt.removeFromSuperview(this.f125954k.asView());
        this.f125954k = hintHolder;
        this.hintPresenterV2 = new HintPresenterV2(hintHolder);
        getF125971a().setHintPresenterV2(this.hintPresenterV2.get_impl());
    }

    public final void addListener(DataCaptureViewSizeListener listener) {
        Intrinsics.j(listener, "listener");
        this.f125948e.add(listener);
    }
    ...
    public final void addOverlay(DataCaptureOverlay overlay) {
        Intrinsics.j(overlay, "overlay");
        _addOverlay(overlay);
        if (this.f125949f.add(overlay) && (overlay instanceof ViewBasedDataCaptureOverlay)) {
            View view = (View) overlay;
            if (this.f125951h.indexOfChild(view) == -1) {
                this.f125951h.addView(view, new RelativeLayout.LayoutParams(-1, -1));
    ...
    public final ViewSizeAndRotation getCurrentSize$scandit_capture_core() {
        return getValue(this, f125943v[0]);
    }
    ...
    public final Point mapFramePointToView(Point point) {
        ...
        Point pointMapFramePointToView = getF125971a().mapFramePointToView(point);
        return new Point(pointMapFramePointToView.getX() * this.f125945b, pointMapFramePointToView.getY() * this.f125945b);
    }
    ...
    protected void onDetachedFromWindow() {
        disable();
        this.f125944a.setView(null);
        getF125971a().setContextStatusListener(null);
        getF125971a().detachFromWindow();
    ...
    public final void removeOverlay(DataCaptureOverlay overlay) {
        ...
        this.f125949f.remove(overlay);
        if (overlay instanceof ViewBasedDataCaptureOverlay) {
            this.f125951h.removeView((View) overlay);
    ...
    public final void setCurrentSize$scandit_capture_core(ViewSizeAndRotation viewSizeAndRotation) {
        ...
        setValue(this, f125943v[0], viewSizeAndRotation);
    }

    public final void setFocusGesture(FocusGesture focusGesture) {
        this.focusGesture = focusGesture;
        getF125971a().setFocusGesture(focusGesture != null ? focusGesture.getF126099c() : null);
    }
    ...
    public final void setProperty(String name, Object value) {
        ...
        if (Intrinsics.e(name, "logoHidden")) {
            ...
            if (bool != null) {
                getF125971a().setLogoHidden(bool.booleanValue());
                return;
            }
            return;
        }
    ...
    public final void setZoomGesture(ZoomGesture zoomGesture) {
        ...
        getF125971a().setZoomGesture(zoomGesture != null ? zoomGesture.getF126094c() : null);
        Iterator<T> it = getControls$scandit_capture_core().iterator();
        while (it.hasNext()) {
    ...
    public static final void access$updateFrameOfReferenceViewSizeAndOrientation(DataCaptureView dataCaptureView, int i10, int i11, int i12) {
        ...
        dataCaptureView.getF125971a().setPreviewOrientation(angle);
        NativeDataCaptureContext dataCaptureContext = dataCaptureView.getF125971a().getDataCaptureContext();
        if (dataCaptureContext != null) {
            dataCaptureContext.setFrameOfReferenceViewSizeAndOrientation(sizeWithUnit, dataCaptureView.f125945b, angle);
        }
        Iterator it = dataCaptureView.f125947d.iterator();
        while (it.hasNext()) {
            ((DataCaptureViewListener) it.next()).onSizeChanged(i10, i11, i12);
        }
        Iterator it2 = dataCaptureView.f125948e.iterator();
        while (it2.hasNext()) {
    ...
    protected void onAttachedToWindow() throws Resources.NotFoundException {
        ...
        this.f125944a.setView(this.f125956m);
        enable();
        getF125971a().setContextStatusListener(new NativeContextStatusListener() { // from class: com.scandit.datacapture.core.ui.DataCaptureView.onAttachedToWindow.1
            ...
            public void onStatusChanged(NativeContextStatus status) {
                ...
                DataCaptureView.this.f125944a.onStatusChanged(new ContextStatus(status));
            }

            @Override // com.scandit.datacapture.core.internal.module.ui.NativeContextStatusListener
            public void onWarningsChanged(ArrayList<NativeError> warnings) {
                Intrinsics.j(warnings, "warnings");
                DataCaptureView.this.f125944a.onWarningsChanged(warnings);
            }
        });
        getF125971a().attachToWindow();
    ...
    public DataCaptureView(final Context context, DataCaptureContext dataCaptureContext, NativeVideoPreview videoPreview, ContextStatusPresenter contextStatusPresenter, float f10) {
        ...
        this.f125944a = contextStatusPresenter;
        this.f125945b = f10;
        ...
        this.f125946c = new DataCaptureViewProxyAdapter(nativeDataCaptureViewCreate, null, 2, 0 == true ? 1 : 0);
        this.f125947d = new CopyOnWriteArraySet();
        this.f125948e = new CopyOnWriteArraySet();
        this.f125949f = new CopyOnWriteArraySet();
        DataCaptureTextureView dataCaptureTextureView = new DataCaptureTextureView(context, this, videoPreview);
        this.f125950g = dataCaptureTextureView;
        FrameLayout frameLayout = new FrameLayout(context);
        frameLayout.setId(R.id.sc_overlay_container);
        this.f125951h = frameLayout;
        ...
        this.f125954k = hintHolderV2Implementation;
        ...
        this.f125955l = errorOverlay;
        this.f125956m = new DataCaptureView$contextStatusView$1(this);
        this.f125957n = new OrientationEventListener(context, this) { // from class: com.scandit.datacapture.core.ui.DataCaptureView$orientationEventListener$1

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ Context f125969a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ DataCaptureView f125970b;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(context);
                this.f125969a = context;
                this.f125970b = this;
            }

            @Override // android.view.OrientationEventListener
            public void onOrientationChanged(int orientation) {
                int rotation = ContextExtensionsKt.getRotation(this.f125969a);
                if (rotation != this.f125970b.f125958o) {
                    DataCaptureView dataCaptureView = this.f125970b;
                    dataCaptureView.setCurrentSize$scandit_capture_core(new ViewSizeAndRotation(dataCaptureView.getMeasuredWidth(), this.f125970b.getMeasuredHeight(), rotation));
                    this.f125970b.f125958o = rotation;
                }
            }
        };
        this.f125958o = ContextExtensionsKt.getRotation(context);
        ...
        this.f125959p = new ObservableProperty<ViewSizeAndRotation>(viewSizeAndRotation) { // from class: com.scandit.datacapture.core.ui.DataCaptureView$special$$inlined$distinctObservable$1
        ...
        this.f125960q = new DataCaptureContextListener() { // from class: com.scandit.datacapture.core.ui.DataCaptureView$dataCaptureContextListener$1
            ...
            public void onFrameSourceChanged(DataCaptureContext dataCaptureContext2, FrameSource frameSource) {
                ...
                this.f125967a.f125950g.a(frameSource);
                Iterator<T> it = this.f125967a.getControls$scandit_capture_core().iterator();
                while (it.hasNext()) {
            ...
            public void onObservationStarted(DataCaptureContext dataCaptureContext2) {
                Intrinsics.j(dataCaptureContext2, "dataCaptureContext");
                this.f125967a.f125950g.a(dataCaptureContext2.get_frameSource());
                Iterator<T> it = this.f125967a.getControls$scandit_capture_core().iterator();
                while (it.hasNext()) {
            ...
            public void onObservationStopped(DataCaptureContext dataCaptureContext2) {
                Intrinsics.j(dataCaptureContext2, "dataCaptureContext");
                this.f125967a.f125950g.a((FrameSource) null);
                Iterator<T> it = this.f125967a.getControls$scandit_capture_core().iterator();
                while (it.hasNext()) {
        ...
        addView(this.f125954k.asView(), layoutParams);
        ...
        getF125971a().setHintPresenter(this.hintPresenter);
        getF125971a().setHintPresenterV2(this.hintPresenterV2.get_impl());
