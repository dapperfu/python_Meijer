...
public final class LinearControlGroupBuilder {
    ...
    private final Context f126038a;

    /* renamed from: b, reason: collision with root package name */
    private LinearControlGroupOrientation f126039b;

    /* renamed from: c, reason: collision with root package name */
    private FloatWithUnit f126040c;

    /* renamed from: d, reason: collision with root package name */
    private List f126041d;

    public LinearControlGroupBuilder(Context context, LinearControlGroup.Defaults defaults) {
        Intrinsics.j(context, "context");
        Intrinsics.j(defaults, "defaults");
        this.f126038a = context;
        this.f126039b = defaults.getOrientation();
        this.f126040c = defaults.getSpacing();
        this.f126041d = defaults.getControls();
    }

    public final LinearControlGroup build() {
        return LinearControlGroup.INSTANCE._fromBuilderProperties(this.f126038a, this.f126039b, this.f126040c, this.f126041d);
    }
