...
public final class CameraSwitchControl implements Control {
    ...
    private final CameraControlIconsHandler f126023a;

    /* renamed from: b, reason: collision with root package name */
    private final ToggleImageButton f126024b;

    /* renamed from: c, reason: collision with root package name */
    private WeakReference f126025c;

    /* renamed from: d, reason: collision with root package name */
    private volatile Camera f126026d;
    ...
    public CameraSwitchControl(Camera primaryCamera, Camera secondaryCamera, CameraControlIconsHandler iconsHandler, ToggleImageButton view) {
        ...
        this.f126023a = iconsHandler;
        this.f126024b = view;
        this.f126025c = new WeakReference(null);
        this.f126026d = primaryCamera;
        ...
        iconsHandler.a((AnonymousClass1) new com.scandit.datacapture.core.internal.module.ui.control.camera.b() { // from class: com.scandit.datacapture.core.ui.control.CameraSwitchControl.1
            ...
            public void onIconsChanged(Camera camera, Bitmap image, boolean pressed) {
                ...
                if (Intrinsics.e(CameraSwitchControl.this.f126026d, camera) && CameraSwitchControl.this.f126024b.b() == pressed) {
    ...
    public final synchronized void a() {
        try {
            Bitmap bitmapA = this.f126023a.a(this.f126026d, this.f126024b.b());
            if (bitmapA != null) {
                ToggleImageButton toggleImageButton = this.f126024b;
            ...
            this.f126024b.setContentDescription(WhenMappings.$EnumSwitchMapping$0[this.f126026d.getPosition().ordinal()] == 1 ? this.contentDescriptionWhenUserFacing : this.contentDescriptionWhenWorldFacing);
        } catch (Throwable th2) {
            throw th2;
        }
    }
    ...
    public static final void access$toggleCamera(CameraSwitchControl cameraSwitchControl) {
        ...
        DataCaptureContext dataCaptureContext = (DataCaptureContext) cameraSwitchControl.f126025c.get();
    ...
    public void _onDataCaptureContextChanged(DataCaptureContext dataCaptureContext) {
        this.f126025c = new WeakReference(dataCaptureContext);
        if (dataCaptureContext != null) {
            Camera camera = this.f126026d;
            FrameSource frameSource = dataCaptureContext.get_frameSource();
    ...
    public final void setPrimaryCameraImage(int resId) {
        CameraControlIconsHandler cameraControlIconsHandler = this.f126023a;
