...
public final class TorchSwitchControl implements Control {
    ...
    private final TorchControlIconsHandler f126044a;

    /* renamed from: b, reason: collision with root package name */
    private final ToggleImageButton f126045b;
    ...
    private final TorchSwitchControl$torchListener$1 f126048e;

    /* renamed from: f, reason: collision with root package name */
    private Camera f126049f;
    ...
    public TorchSwitchControl(TorchControlIconsHandler iconsHandler, ToggleImageButton view) {
        ...
        this.f126048e = new TorchListener() { // from class: com.scandit.datacapture.core.ui.control.TorchSwitchControl$torchListener$1
            @Override // com.scandit.datacapture.core.source.TorchListener
            public void onTorchStateChanged(TorchState state) {
                Intrinsics.j(state, "state");
                this.f126051a.a(state);
            }
        };
        iconsHandler.a((AnonymousClass1) new com.scandit.datacapture.core.internal.module.ui.control.torch.c() { // from class: com.scandit.datacapture.core.ui.control.TorchSwitchControl.1
            ...
            public void onIconsChanged(TorchState torchState, Bitmap image, boolean pressed) {
                ...
                Camera camera = TorchSwitchControl.this.f126049f;
                if ((camera != null ? camera.getDesiredTorchState() : null) == torchState && TorchSwitchControl.this.f126045b.b() == pressed) {
    ...
    public final void a(TorchState torchState) {
        ...
        this.f126045b.setContentDescription(WhenMappings.$EnumSwitchMapping$0[torchState.ordinal()] == 1 ? this.contentDescriptionWhenOn : this.contentDescriptionWhenOff);
    }
    ...
    */
    public static final void access$onFrameSourceStarted(com.scandit.datacapture.core.ui.control.TorchSwitchControl r2, com.scandit.datacapture.core.source.FrameSource r3) {
        /*
            com.scandit.datacapture.core.internal.module.ui.control.ToggleImageButton r0 = r2.f126045b
        ...
        L15:
            ...
            com.scandit.datacapture.core.source.Camera r3 = r2.f126049f
            if (r3 == 0) goto L2d
    ...
    public static final void access$showImageForCurrentTorchState(TorchSwitchControl torchSwitchControl) {
        ...
        Camera camera = torchSwitchControl.f126049f;
    ...
    public void _onFrameSourceChanged(FrameSource frameSource) {
        ...
        if (!Intrinsics.e(this.f126049f, camera)) {
            Camera camera2 = this.f126049f;
            if (camera2 != null) {
                camera2._removeWeakTorchListener$scandit_capture_core(this.f126048e);
            }
            this.f126049f = camera;
            if (camera != null) {
                k action = new k(this);
            ...
            Camera camera3 = this.f126049f;
            if (camera3 != null) {
                camera3._addWeakTorchListener$scandit_capture_core(this.f126048e);
            }
        }
        Camera camera4 = this.f126049f;
    ...
    public final void setTorchOffImage(int resId) {
        TorchControlIconsHandler torchControlIconsHandler = this.f126044a;
