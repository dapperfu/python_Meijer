...
public final class ZoomSwitchControl implements Control {
    ...
    private final ZoomControlIconsHandler f126052a;

    /* renamed from: b, reason: collision with root package name */
    private final ToggleImageButton f126053b;
    ...
    private volatile ZoomGesture f126057f;

    /* renamed from: g, reason: collision with root package name */
    private WeakReference f126058g;

    /* renamed from: h, reason: collision with root package name */
    private WeakReference f126059h;

    /* renamed from: i, reason: collision with root package name */
    private AnonymousClass2 f126060i;

    /* renamed from: j, reason: collision with root package name */
    private final ZoomSwitchControl$zoomGestureListener$1 f126061j;
    ...
    public ZoomSwitchControl(ZoomControlIconsHandler iconsHandler, ToggleImageButton view) {
        ...
        this.f126052a = iconsHandler;
        this.f126053b = view;
        String string = view.getContext().getString(R.string.sc_cd_zoom_off);
        Intrinsics.i(string, "getString(...)");
        this.f126054c = string;
        String string2 = view.getContext().getString(R.string.sc_cd_zoom_on);
        Intrinsics.i(string2, "getString(...)");
        this.f126055d = string2;
        this.currentZoomState = ZoomState.ZoomedOut.INSTANCE;
        this.f126058g = new WeakReference(null);
        this.f126059h = new WeakReference(null);
        this.f126061j = new ZoomGestureListener() { // from class: com.scandit.datacapture.core.ui.control.ZoomSwitchControl$zoomGestureListener$1
            ...
            public void onZoomInGesture(ZoomGesture zoomGesture) {
                ...
                this.f126064a.currentZoomState = ZoomSwitchControl.ZoomState.ZoomedIn.INSTANCE;
                this.f126064a.a();
            }
            ...
            public void onZoomOutGesture(ZoomGesture zoomGesture) {
                Intrinsics.j(zoomGesture, "zoomGesture");
                this.f126064a.currentZoomState = ZoomSwitchControl.ZoomState.ZoomedOut.INSTANCE;
                this.f126064a.a();
            }
        };
        iconsHandler.a((AnonymousClass1) new com.scandit.datacapture.core.internal.module.ui.control.zoom.b() { // from class: com.scandit.datacapture.core.ui.control.ZoomSwitchControl.1
            ...
            public void onIconsChanged(ZoomState state, boolean pressed) {
                ...
                if (Intrinsics.e(ZoomSwitchControl.this.getCurrentZoomState(), state) && ZoomSwitchControl.this.f126053b.b() == pressed) {
    ...
    public final synchronized void a() {
        String str;
        try {
            Bitmap bitmapA = this.f126052a.a(this.currentZoomState, this.f126053b.b());
            if (bitmapA != null) {
                ToggleImageButton toggleImageButton = this.f126053b;
            ...
            ToggleImageButton toggleImageButton2 = this.f126053b;
    ...
    public static final void access$toggleZoom(ZoomSwitchControl zoomSwitchControl) {
        ...
        if (zoomState2 instanceof ZoomState.ZoomedOut) {
            DataCaptureView dataCaptureView = (DataCaptureView) zoomSwitchControl.f126058g.get();
            ...
            DataCaptureView dataCaptureView2 = (DataCaptureView) zoomSwitchControl.f126058g.get();
    ...
    public void _onDataCaptureViewChanged(DataCaptureView dataCaptureView) {
        this.f126058g = new WeakReference(dataCaptureView);
        ZoomGesture zoomGesture = dataCaptureView != null ? dataCaptureView.getZoomGesture() : null;
        if (Intrinsics.e(this.f126057f, zoomGesture)) {
            return;
        }
        ZoomGesture zoomGesture2 = this.f126057f;
        if (zoomGesture2 != null) {
            zoomGesture2.removeListener(this.f126061j);
        }
        this.f126057f = zoomGesture;
        ZoomGesture zoomGesture3 = this.f126057f;
        if (zoomGesture3 != null) {
            zoomGesture3.addListener(this.f126061j);
        }
        ZoomGesture zoomGesture4 = this.f126057f;
    ...
    public void _onFrameSourceChanged(FrameSource frameSource) {
        ...
        DataCaptureView dataCaptureView = (DataCaptureView) this.f126058g.get();
        if (dataCaptureView != null) {
            dataCaptureView._performUiTriggeredZoomOut();
        }
        this.currentZoomState = ZoomState.ZoomedOut.INSTANCE;
        a();
        AnonymousClass2 anonymousClass2 = this.f126060i;
        if (anonymousClass2 != null && (frameSource2 = (FrameSource) this.f126059h.get()) != null) {
            frameSource2.removeListener(anonymousClass2);
        }
        WeakReference weakReference = new WeakReference(frameSource);
        this.f126059h = weakReference;
    ...
    public void _onRemoveControl() {
        ...
        AnonymousClass2 anonymousClass2 = this.f126060i;
        if (anonymousClass2 != null && (frameSource = (FrameSource) this.f126059h.get()) != null) {
