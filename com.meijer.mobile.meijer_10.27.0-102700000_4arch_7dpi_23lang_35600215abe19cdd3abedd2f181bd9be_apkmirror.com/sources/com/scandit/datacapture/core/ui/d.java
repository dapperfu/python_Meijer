...
public final class d extends Lambda implements Function0 {
    ...
    public final /* synthetic */ NeedsRedrawListener f126084a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(NeedsRedrawListener needsRedrawListener) {
        super(0);
        this.f126084a = needsRedrawListener;
    }

    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        return new NeedsRedrawListenerReversedAdapter(this.f126084a, null, 2, null);
    }
}
