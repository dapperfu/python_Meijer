...
public final class LaserlineViewfinderProxyAdapter implements LaserlineViewfinderProxy {
    ...
    private final NativeLaserlineViewfinder f126179a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeViewfinder f126181c;
    ...
    public LaserlineViewfinderProxyAdapter(NativeLaserlineViewfinder _NativeLaserlineViewfinder, ProxyCache proxyCache) {
        ...
        this.f126179a = _NativeLaserlineViewfinder;
        ...
        this.f126181c = nativeViewfinderAsViewfinder;
    }
    ...
    public int getDisabledColor() {
        NativeColor disabledColor = this.f126179a.getDisabledColor();
    ...
    public int getEnabledColor() {
        NativeColor enabledColor = this.f126179a.getEnabledColor();
        CoreNativeTypeFactory coreNativeTypeFactory = CoreNativeTypeFactory.INSTANCE;
    ...
    public FloatWithUnit getWidth() {
        FloatWithUnit width = this.f126179a.getWidth();
        Intrinsics.g(width);
        return width;
    }
    ...
    public void setDisabledColor(int i10) {
        this.f126179a.setDisabledColor(CoreNativeTypeFactory.INSTANCE.convert(i10));
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.LaserlineViewfinderProxy
    public void setEnabledColor(int i10) {
        this.f126179a.setEnabledColor(CoreNativeTypeFactory.INSTANCE.convert(i10));
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.LaserlineViewfinderProxy
    public void setWidth(FloatWithUnit p02) {
        Intrinsics.j(p02, "p0");
        this.f126179a.setWidth(p02);
    }
