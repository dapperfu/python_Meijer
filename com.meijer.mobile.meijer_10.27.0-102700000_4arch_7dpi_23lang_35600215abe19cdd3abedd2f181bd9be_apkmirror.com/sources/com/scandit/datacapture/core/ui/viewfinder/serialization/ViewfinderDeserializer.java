...
public final class ViewfinderDeserializer implements ViewfinderDeserializerProxy {
    ...
    private final /* synthetic */ ViewfinderDeserializerProxyAdapter f126198a;

    /* renamed from: b, reason: collision with root package name */
    private final Helper f126199b;
    ...
    public ViewfinderDeserializer(NativeViewfinderDeserializer impl) {
        ...
        this.f126198a = new ViewfinderDeserializerProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        Helper helper = new Helper();
        this.f126199b = helper;
        _setHelper(helper);
    }
    ...
    public NativeViewfinderDeserializer getF126203a() {
        return this.f126198a.getF126203a();
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.serialization.ViewfinderDeserializerProxy
    @ProxyFunction(nativeName = "setHelper")
    public void _setHelper(ViewfinderDeserializerHelper helper) {
        this.f126198a._setHelper(helper);
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.serialization.ViewfinderDeserializerProxy
    @ProxyFunction(property = "warnings")
    public List<String> getWarnings() {
        return this.f126198a.getWarnings();
    }

    public final Viewfinder _getAndResetLastViewfinder() {
        Viewfinder viewfinder = this.f126199b.getViewfinder();
        this.f126199b.setViewfinder(null);
        return viewfinder;
    }
    ...
    public final Viewfinder viewfinderFromJson(String jsonData) {
        ...
        getF126203a().viewfinderFromJson(CoreNativeTypeFactory.INSTANCE.convert(jsonData));
