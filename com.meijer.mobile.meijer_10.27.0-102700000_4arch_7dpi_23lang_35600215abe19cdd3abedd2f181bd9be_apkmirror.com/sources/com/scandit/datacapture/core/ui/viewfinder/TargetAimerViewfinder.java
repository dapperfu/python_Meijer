...
public final class TargetAimerViewfinder implements Viewfinder, TargetAimerViewfinderProxy {
    ...
    private final /* synthetic */ TargetAimerViewfinderProxyAdapter f126193a;

    /* JADX WARN: Multi-variable type inference failed */
    public TargetAimerViewfinder(NativeTargetAimerViewfinder impl) {
        Intrinsics.j(impl, "impl");
        this.f126193a = new TargetAimerViewfinderProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    }
    ...
    public NativeTargetAimerViewfinder getF126194a() {
        return this.f126193a.getF126194a();
    }
    ...
    public NativeViewfinder getF126196c() {
        return this.f126193a.getF126196c();
    }
