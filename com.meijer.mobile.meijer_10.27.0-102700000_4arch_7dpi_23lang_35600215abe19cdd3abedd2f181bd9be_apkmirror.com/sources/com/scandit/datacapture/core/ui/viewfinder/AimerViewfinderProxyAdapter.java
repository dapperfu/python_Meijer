...
public final class AimerViewfinderProxyAdapter implements AimerViewfinderProxy {
    ...
    private final NativeAimerViewfinder f126175a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private final NativeViewfinder f126177c;
    ...
    public AimerViewfinderProxyAdapter(NativeAimerViewfinder _NativeAimerViewfinder, ProxyCache proxyCache) {
        ...
        this.f126175a = _NativeAimerViewfinder;
        ...
        this.f126177c = nativeViewfinderAsViewfinder;
    }
    ...
    public int getDotColor() {
        NativeColor dotColor = this.f126175a.getDotColor();
    ...
    public int getFrameColor() {
        NativeColor frameColor = this.f126175a.getFrameColor();
        CoreNativeTypeFactory coreNativeTypeFactory = CoreNativeTypeFactory.INSTANCE;
    ...
    public void setDotColor(int i10) {
        this.f126175a.setDotColor(CoreNativeTypeFactory.INSTANCE.convert(i10));
    }

    @Override // com.scandit.datacapture.core.ui.viewfinder.AimerViewfinderProxy
    public void setFrameColor(int i10) {
        this.f126175a.setFrameColor(CoreNativeTypeFactory.INSTANCE.convert(i10));
    }
