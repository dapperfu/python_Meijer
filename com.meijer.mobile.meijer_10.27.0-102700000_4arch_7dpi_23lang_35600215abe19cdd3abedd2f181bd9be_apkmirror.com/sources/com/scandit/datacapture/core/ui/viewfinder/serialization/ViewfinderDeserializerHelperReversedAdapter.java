...
public final class ViewfinderDeserializerHelperReversedAdapter extends NativeViewfinderDeserializerHelper {
    ...
    private final ViewfinderDeserializerHelper f126201a;
    ...
    public ViewfinderDeserializerHelperReversedAdapter(ViewfinderDeserializerHelper _ViewfinderDeserializerHelper, ProxyCache proxyCache) {
        ...
        this.f126201a = _ViewfinderDeserializerHelper;
    ...
    public NativeAimerViewfinder createAimerViewfinder() {
        AimerViewfinder aimerViewfinderCreateAimerViewfinder = this.f126201a.createAimerViewfinder();
    ...
    public NativeLaserlineViewfinder createLaserlineViewfinder() {
        LaserlineViewfinder laserlineViewfinderCreateLaserlineViewfinder = this.f126201a.createLaserlineViewfinder();
    ...
    public NativeNoViewfinder createNoViewfinder() {
        NoViewfinder noViewfinderCreateNoViewfinder = this.f126201a.createNoViewfinder();
        NativeNoViewfinder f125826a = noViewfinderCreateNoViewfinder.getF125826a();
        this.proxyCache.put(Reflection.b(NativeNoViewfinder.class), null, f125826a, noViewfinderCreateNoViewfinder);
        return f125826a;
    }
    ...
    public NativeRectangularViewfinder createRectangularViewfinder(NativeRectangularViewfinderStyle style, NativeRectangularViewfinderLineStyle lineStyle) {
        ...
        RectangularViewfinder rectangularViewfinderCreateRectangularViewfinder = this.f126201a.createRectangularViewfinder(coreNativeTypeFactory.convert(style), coreNativeTypeFactory.convert(lineStyle));
    ...
    public NativeTargetAimerViewfinder createTargetAimerViewfinder() {
        TargetAimerViewfinder targetAimerViewfinderCreateTargetAimerViewfinder = this.f126201a.createTargetAimerViewfinder();
        NativeTargetAimerViewfinder f126194a = targetAimerViewfinderCreateTargetAimerViewfinder.getF126194a();
        this.proxyCache.put(Reflection.b(NativeTargetAimerViewfinder.class), null, f126194a, targetAimerViewfinderCreateTargetAimerViewfinder);
        return f126194a;
    }
