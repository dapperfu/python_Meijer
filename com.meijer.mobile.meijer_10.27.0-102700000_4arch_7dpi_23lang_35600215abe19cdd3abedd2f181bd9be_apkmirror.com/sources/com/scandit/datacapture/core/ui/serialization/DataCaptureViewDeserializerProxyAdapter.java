...
public final class DataCaptureViewDeserializerProxyAdapter implements DataCaptureViewDeserializerProxy {
    ...
    private final NativeDataCaptureViewDeserializer f126150a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final ProxyCache proxyCache;

    /* renamed from: c, reason: collision with root package name */
    private DataCaptureViewDeserializer f126152c;
    ...
    public DataCaptureViewDeserializerProxyAdapter(NativeDataCaptureViewDeserializer _NativeDataCaptureViewDeserializer, ProxyCache proxyCache) {
        ...
        this.f126150a = _NativeDataCaptureViewDeserializer;
    ...
    public void _setHelper(DataCaptureViewDeserializerHelper helper) {
        this.f126150a.setHelper(helper != null ? (DataCaptureViewDeserializerHelperReversedAdapter) this.proxyCache.getOrPut(Reflection.b(DataCaptureViewDeserializerHelper.class), null, helper, new j(helper)) : null);
    }

    @Override // com.scandit.datacapture.core.ui.serialization.DataCaptureViewDeserializerProxy
    public DataCaptureViewDeserializer _deserializer() {
        DataCaptureViewDeserializer dataCaptureViewDeserializer = this.f126152c;
    ...
    public void _setDeserializer(DataCaptureViewDeserializer deserializer) {
        ...
        this.f126152c = deserializer;
    }

    @Override // com.scandit.datacapture.core.ui.serialization.DataCaptureViewDeserializerProxy
    public void _setListener(DataCaptureViewDeserializerListener listener) {
        this.f126150a.setListener(listener != null ? (DataCaptureViewDeserializerListenerReversedAdapter) this.proxyCache.getOrPut(Reflection.b(DataCaptureViewDeserializerListener.class), this, listener, new k(listener, this)) : null);
    }
    ...
    public DataCaptureView _updateViewFromJson(DataCaptureView view, JsonValue json) {
        ...
        NativeDataCaptureView nativeDataCaptureView_impl = view.getF125971a();
        ...
        NativeDataCaptureView nativeDataCaptureViewUpdateViewFromJson = this.f126150a.updateViewFromJson(nativeDataCaptureView_impl, f125830a);
    ...
    public DataCaptureView _viewFromJson(DataCaptureContext dataCaptureContext, JsonValue json) {
        ...
        NativeJsonValue f125830a = json.getF125830a();
        this.proxyCache.put(Reflection.b(NativeJsonValue.class), null, f125830a, json);
        NativeDataCaptureView nativeDataCaptureViewViewFromJson = this.f126150a.viewFromJson(nativeDataCaptureContext_impl, f125830a);
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeDataCaptureView.class);
    ...
    public List<String> getWarnings() {
        ArrayList<String> warnings = this.f126150a.getWarnings();
