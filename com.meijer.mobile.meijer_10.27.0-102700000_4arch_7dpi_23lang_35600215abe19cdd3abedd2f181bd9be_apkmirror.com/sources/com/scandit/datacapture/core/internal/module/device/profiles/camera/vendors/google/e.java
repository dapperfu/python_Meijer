...
public final class e extends com.scandit.datacapture.core.internal.module.device.profiles.camera.e {
    ...
    public static final e f124296c;

    /* renamed from: d, reason: collision with root package name */
    public static final String f124297d;

    /* renamed from: e, reason: collision with root package name */
    public static final com.scandit.datacapture.core.internal.module.device.profiles.camera.f f124298e;

    @Override // com.scandit.datacapture.core.internal.module.device.profiles.camera.e, com.scandit.datacapture.core.internal.module.device.profiles.camera.CameraProfile
    public final void a(Camera.Parameters camParams) {
        Intrinsics.j(camParams, "camParams");
        com.scandit.datacapture.core.internal.module.device.profiles.camera.e.a(camParams, Math.max(f124298e.f124229d, -1.0f));
    }

    static {
        e eVar = new e();
        f124296c = eVar;
        f124297d = "nexus 5|nexus 6p";
        f124298e = com.scandit.datacapture.core.internal.module.device.profiles.camera.f.a(eVar.f124224a, false, 0.0f, false, false, 0, 123);
    }
