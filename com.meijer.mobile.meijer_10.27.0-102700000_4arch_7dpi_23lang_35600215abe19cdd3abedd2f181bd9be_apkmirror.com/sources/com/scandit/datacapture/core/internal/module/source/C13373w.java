...
public final class C13373w {

    /* renamed from: a, reason: collision with root package name */
    public Camera f125126a;

    /* renamed from: b, reason: collision with root package name */
    public final AtomicBoolean f125127b = new AtomicBoolean(false);

    /* renamed from: c, reason: collision with root package name */
    public Camera.Parameters f125128c;

    public final boolean a(SurfaceTexture texture) throws IOException {
        Intrinsics.j(texture, "texture");
        Camera camera = this.f125126a;
        if (camera == null) {
            return false;
        }
        try {
