...
public final class c extends Lambda implements Function1 {
    ...
    public final /* synthetic */ X509Certificate[] f124751a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ String f124752b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ String f124753c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(X509Certificate[] x509CertificateArr, String str, String str2) {
        super(1);
        this.f124751a = x509CertificateArr;
        this.f124752b = str;
        this.f124753c = str2;
    }
    ...
    public final Object invoke(Object obj) throws CertificateException {
        ...
        new X509TrustManagerExtensions(trust).checkServerTrusted(this.f124751a, this.f124752b, this.f124753c);
