...
public final class O implements N {
    ...
    public final CameraProfile f124852a;

    /* renamed from: b, reason: collision with root package name */
    public final CameraApi2Info f124853b;

    /* renamed from: c, reason: collision with root package name */
    public final CameraSettings f124854c;

    /* renamed from: d, reason: collision with root package name */
    public final CameraCharacteristicsWrapper f124855d;
    ...
    public O(CameraProfile cameraProfile, CameraApi2Info cameraApi2Info, CameraSettings cameraSettings) {
        ...
        this.f124852a = cameraProfile;
        this.f124853b = cameraApi2Info;
        this.f124854c = cameraSettings;
        this.f124855d = cameraApi2Info.getCharacteristics();
    }

    public final int[] a() {
        CameraCharacteristicsWrapper cameraCharacteristicsWrapper = this.f124855d;
    ...
    */
    public final kotlin.ranges.ClosedRange b() {
        /*
            ...
            r1 = 30
            if (r0 < r1) goto L24
            com.scandit.datacapture.core.internal.sdk.source.api2.CameraCharacteristicsWrapper r0 = r3.f124855d
            android.hardware.camera2.CameraCharacteristics$Key r1 = v.C17359a.a()
    ...
    public final ArrayList c() {
        try {
            Size[] availableYuvResolutions = this.f124855d.getAvailableYuvResolutions();
            if (this.f124852a.c()) {
                availableYuvResolutions = (Size[]) ArraysKt.K(availableYuvResolutions, this.f124855d.getAvailableHighResYuvResolutions());
            }
            ArrayList arrayList = new ArrayList();
            for (Size size : availableYuvResolutions) {
                if (size.getWidth() * size.getHeight() <= this.f124852a.b()) {
                    arrayList.add(size);
                }
            }
            return arrayList;
    ...
    public final List g() throws Exception {
        try {
            return this.f124855d.getAvailablePreviewResolution();
        } catch (Exception e10) {
            com.scandit.datacapture.core.internal.module.utils.i.a("Exception caught in listener method. Rethrowing...", e10);
            throw e10;
        }
    ...
    public final boolean i() {
        ...
        CameraSettings cameraSettings = this.f124854c;
        Integer num = null;
        ...
        if (d() == 1 && this.f124852a.h()) {
            return true;
        }
        CameraCharacteristicsWrapper cameraCharacteristicsWrapper2 = this.f124855d;
