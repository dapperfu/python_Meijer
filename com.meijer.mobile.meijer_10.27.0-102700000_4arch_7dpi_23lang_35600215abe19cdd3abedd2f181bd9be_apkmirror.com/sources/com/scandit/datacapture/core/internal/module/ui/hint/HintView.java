...
public final class HintView extends RelativeLayout {
    ...
    private final TextView f125245a;

    /* renamed from: b, reason: collision with root package name */
    private final ImageView f125246b;

    /* renamed from: c, reason: collision with root package name */
    private Function0 f125247c;

    /* renamed from: d, reason: collision with root package name */
    private boolean f125248d;

    /* renamed from: e, reason: collision with root package name */
    private float f125249e;

    /* renamed from: f, reason: collision with root package name */
    private boolean f125250f;

    public final void a(Function0 function0) {
        this.f125247c = function0;
    }
    ...
    public final void c(NativeHintStyle hintStyle, Rect rect, boolean z10) {
        ...
        TextView textView = this.f125245a;
        ...
        int i13 = A.f125233a[textAlignment.ordinal()];
        if (i13 == 1) {
            i10 = 8388627;
        } else if (i13 == 2) {
            i10 = 17;
        ...
        int i14 = hintIcon != null ? A.f125234b[hintIcon.ordinal()] : -1;
        if (i14 == 1) {
            this.f125246b.setVisibility(8);
        } else if (i14 != 2) {
            this.f125246b.setVisibility(0);
            NativeHintIcon hintIcon2 = hintStyle.getHintIcon();
            Intrinsics.i(hintIcon2, "getHintIcon(...)");
            int i15 = C.f125237a[hintIcon2.ordinal()];
            if (i15 == 1) {
                i11 = 0;
                FS.Resources_setImageResource(this.f125246b, i11);
                ImageView imageView = this.f125246b;
                ...
                FS.Resources_setImageResource(this.f125246b, i11);
                ImageView imageView2 = this.f125246b;
            ...
            ImageView iconView = this.f125246b;
        ...
        if (A.f125234b[hintIcon3.ordinal()] != 1) {
            this.f125245a.onPreDraw();
            iF = RangesKt.f(this.f125245a.getLayout().getTopPadding() + ((PixelExtensionsKt.pxFromDp$default(24, (Context) null, 1, (Object) null) - this.f125245a.getLayout().getLineBaseline(0)) / 2), 0);
        }
        ViewGroup.LayoutParams layoutParams2 = this.f125245a.getLayoutParams();
        ViewGroup.MarginLayoutParams marginLayoutParams = layoutParams2 instanceof ViewGroup.MarginLayoutParams ? (ViewGroup.MarginLayoutParams) layoutParams2 : null;
        if (marginLayoutParams != null) {
            marginLayoutParams.topMargin = iF;
            marginLayoutParams.bottomMargin = iF;
            this.f125245a.setLayoutParams(marginLayoutParams);
        }
        this.f125248d = hintStyle.getCanBeDismissed();
    }
    ...
    */
    public final boolean onTouchEvent(android.view.MotionEvent r6) {
        /*
            ...
            goto L6c
        L16:
            boolean r0 = r5.f125250f
            if (r0 == 0) goto L6c
            float r6 = r6.getRawX()
            float r0 = r5.f125249e
            float r6 = r6 - r0
    ...
    public static final void a(HintView this$0) {
        ...
        Function0 function0 = this$0.f125247c;
        if (function0 != null) {
            function0.invoke();
        }
    }
