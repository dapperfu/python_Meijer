...
public abstract class N {
    ...
    public static final Comparator f124797a = new Comparator() { // from class: com.scandit.datacapture.core.internal.module.source.d0
    ...
    public static final Comparator f124798b = new Comparator() { // from class: com.scandit.datacapture.core.internal.module.source.e0
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
    ...
    public static final Range c(Range[] frameRateRanges, float f10) {
        ...
        return (Range) CollectionsKt.u0(CollectionsKt.Z0(arrayList, f124798b));
    }
    ...
    public static final Range b(Range[] frameRateRanges, float f10) {
        ...
        return (Range) CollectionsKt.u0(CollectionsKt.Z0(arrayList, f124797a));
    }
}
