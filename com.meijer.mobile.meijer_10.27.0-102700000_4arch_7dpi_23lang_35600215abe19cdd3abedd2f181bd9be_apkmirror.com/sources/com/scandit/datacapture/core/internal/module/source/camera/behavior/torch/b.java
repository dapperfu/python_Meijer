...
public final class b implements a {
    ...
    public final CopyOnWriteArraySet f125029a = new CopyOnWriteArraySet();

    /* renamed from: b, reason: collision with root package name */
    public final CopyOnWriteArraySet f125030b = new CopyOnWriteArraySet();
    ...
    public final void a(TorchListener listener) {
        ...
        CopyOnWriteArraySet copyOnWriteArraySet = this.f125030b;
        ...
        while (it.hasNext()) {
            this.f125030b.remove((WeakReference) it.next());
        }
    }
    ...
    public final void b(TorchListener listener) {
        ...
        this.f125030b.add(new WeakReference(listener));
    }
