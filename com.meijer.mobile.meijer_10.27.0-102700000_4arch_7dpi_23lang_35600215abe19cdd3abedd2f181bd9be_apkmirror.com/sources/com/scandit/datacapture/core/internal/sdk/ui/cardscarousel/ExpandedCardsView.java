...
public final class ExpandedCardsView extends ListView implements AbsListView.OnScrollListener {
    ...
    private final ArrayList f125637c;

    /* renamed from: d, reason: collision with root package name */
    private final w f125638d;

    /* renamed from: e, reason: collision with root package name and from kotlin metadata */
    private CardsCarouselView.Listener cardEventListener;

    /* renamed from: f, reason: collision with root package name */
    private final CardListenerForwarder f125640f;

    /* renamed from: g, reason: collision with root package name */
    private boolean f125641g;

    /* renamed from: h, reason: collision with root package name */
    private final ExpandedCardsView$gestureListener$1 f125642h;

    /* renamed from: i, reason: collision with root package name */
    private final Lazy f125643i;
    ...
    */
    ...
    public final void setData(List<? extends CardData> newData) {
        ...
        this.f125637c.clear();
        this.f125637c.addAll(newData);
        this.f125638d.notifyDataSetChanged();
    }
    ...
    public ExpandedCardsView(Context context, AttributeSet attributeSet, int i10) {
        ...
        Intrinsics.j(context, "context");
        this.f125637c = new ArrayList();
        w wVar = new w(this);
        this.f125638d = wVar;
        this.f125640f = new CardListenerForwarder();
        ...
        this.f125642h = new GestureDetector.SimpleOnGestureListener() { // from class: com.scandit.datacapture.core.internal.sdk.ui.cardscarousel.ExpandedCardsView$gestureListener$1
            ...
            public boolean onFling(MotionEvent e12, MotionEvent e22, float velocityX, float velocityY) {
                ...
                if (e12 != null) {
                    ...
                    if (Math.abs(y10) > Math.abs(x10 * 2) && y10 > 0.0f && this.f125645a.f125641g && (onSwipeDownFromTop = this.f125645a.getOnSwipeDownFromTop()) != null) {
        ...
        this.f125643i = LazyKt.b(new x(context, this));
    }
}
