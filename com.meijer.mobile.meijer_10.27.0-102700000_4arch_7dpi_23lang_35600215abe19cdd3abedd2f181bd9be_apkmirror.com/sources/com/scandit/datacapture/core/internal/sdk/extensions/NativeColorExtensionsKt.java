...
public final class NativeColorExtensionsKt {
    ...
    public static final NativeColor toNativeColor(int i10) {
        d dVar = d.f125473a;
        return new NativeColor(((Number) dVar.invoke(Integer.valueOf((16711680 & i10) >>> 16))).floatValue(), ((Number) dVar.invoke(Integer.valueOf((65280 & i10) >>> 8))).floatValue(), ((Number) dVar.invoke(Integer.valueOf(i10 & l3.f92484c))).floatValue(), ((Number) dVar.invoke(Integer.valueOf(((-16777216) & i10) >>> 24))).floatValue());
    }
}
