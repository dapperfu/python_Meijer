...
public final class BluetoothDataTransport extends DataTransport {
    ...
    private static final List f125531f;

    /* renamed from: b, reason: collision with root package name */
    private final Context f125532b;

    /* renamed from: c, reason: collision with root package name */
    private final BluetoothManager f125533c;

    /* renamed from: d, reason: collision with root package name */
    private BluetoothClient f125534d;

    /* renamed from: e, reason: collision with root package name */
    private final AtomicBoolean f125535e;

    static {
        f125531f = Build.VERSION.SDK_INT >= 31 ? CollectionsKt.p("android.permission.BLUETOOTH_SCAN", "android.permission.BLUETOOTH_CONNECT") : CollectionsKt.e("android.permission.ACCESS_FINE_LOCATION");
    }
    ...
    public void connect(final NativeDataTransportConnectionOptions options) {
        ...
        BluetoothAdapter adapter = this.f125533c.getAdapter();
        ...
        ScanCallback scanCallback = new ScanCallback() { // from class: com.scandit.datacapture.core.internal.sdk.transport.ble.BluetoothDataTransport$connect$scanCallback$1
            ...
            public void onScanResult(int callbackType, ScanResult result) {
                ...
                if (this.f125536a.f125535e.get()) {
                    return;
                }
                this.f125536a.f125535e.set(true);
                BluetoothDataTransport bluetoothDataTransport = this.f125536a;
                BluetoothClient bluetoothClient = new BluetoothClient(this.f125536a.f125532b, this.f125536a.getListener(), new BleUuids(options));
                BluetoothDevice device = result.getDevice();
                Intrinsics.i(device, "getDevice(...)");
                bluetoothClient.connect(device);
                bluetoothDataTransport.f125534d = bluetoothClient;
            }

            @Override // android.bluetooth.le.ScanCallback
            public void onScanFailed(int errorCode) {
                super.onScanFailed(errorCode);
                this.f125536a.getListener().onError(NativeDataTransportError.CONNECTION_FAILED);
            }
        };
        try {
    ...
    public boolean isAvailable() {
        boolean z10;
        boolean zHasSystemFeature = this.f125532b.getPackageManager().hasSystemFeature("android.hardware.bluetooth_le");
        BluetoothAdapter adapter = this.f125533c.getAdapter();
        ...
        if ((list instanceof Collection) && list.isEmpty()) {
            ...
            while (it.hasNext()) {
                if (this.f125532b.checkSelfPermission((String) it.next()) != 0) {
                    z10 = false;
                    break;
                }
            }
    ...
    public void write(byte[] data) {
        ...
        BluetoothClient bluetoothClient = this.f125534d;
