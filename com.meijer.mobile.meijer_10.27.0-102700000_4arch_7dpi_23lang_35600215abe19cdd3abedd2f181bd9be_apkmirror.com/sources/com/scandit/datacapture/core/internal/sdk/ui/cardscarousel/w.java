...
public final class w extends BaseAdapter {
    ...
    public final /* synthetic */ ExpandedCardsView f125716a;
    ...
    public w(ExpandedCardsView expandedCardsView) {
        this.f125716a = expandedCardsView;
    }
    ...
    public static final void a(ExpandedCardsView this$0, View view) {
        ...
        cardEventListener.onCardTapped((CardData) this$0.f125637c.get(positionForView));
    }

    @Override // android.widget.Adapter
    public final int getCount() {
        return this.f125716a.f125637c.size();
    }

    @Override // android.widget.Adapter
    public final Object getItem(int i10) {
        return this.f125716a.f125637c.get(i10);
    }
    ...
    public final View getView(int i10, View view, ViewGroup container) {
        ...
        Object obj = this.f125716a.f125637c.get(i10);
        ...
        if (cardView == null) {
            ...
            Context context2 = this.f125716a.getContext();
            ...
            textCardView.setListener(this.f125716a.f125640f);
            CardView cardView2 = new CardView(context, textCardView);
            final ExpandedCardsView expandedCardsView = this.f125716a;
        ...
        ExpandedCardsView.access$bind(this.f125716a, cardView, cardData);
        return cardView;
    }
}
