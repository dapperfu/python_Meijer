...
public final class CardView extends FrameLayout {
    ...
    private static final Lazy f125568d = LazyKt.b(C13383b.f125682a);

    /* renamed from: e, reason: collision with root package name */
    private static final Lazy f125569e = LazyKt.b(C13382a.f125681a);

    /* renamed from: a, reason: collision with root package name */
    private CardSubView f125570a;

    /* renamed from: b, reason: collision with root package name */
    private CardData f125571b;

    /* renamed from: c, reason: collision with root package name */
    private final FrameLayout.LayoutParams f125572c;
    ...
    public static final class Companion {
        ...
        public final int getBORDER_WIDTH$scandit_capture_core() {
            return ((Number) CardView.f125569e.getValue()).intValue();
        }

        public final float getELEVATION$scandit_capture_core() {
            return ((Number) CardView.f125568d.getValue()).floatValue();
        }
    }
    ...
    public CardView(Context context, CardSubView<CardData> cardSubView) {
        ...
        this.f125570a = cardSubView;
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-1, -1);
        this.f125572c = layoutParams;
        setBackgroundResource(R.drawable.sc_item_card_background);
        Object obj = this.f125570a;
    ...
    public final void setCardData(CardData cardData) {
        ...
        CardSubView cardSubView = this.f125570a;
        if (cardSubView != null) {
    ...
    public final void updateSubView(CardSubView<CardData> subView) {
        ...
        this.f125570a = subView;
        View view = subView instanceof View ? (View) subView : null;
        if (view != null) {
            addView(view, this.f125572c);
        }
        CardData cardData = this.f125571b;
