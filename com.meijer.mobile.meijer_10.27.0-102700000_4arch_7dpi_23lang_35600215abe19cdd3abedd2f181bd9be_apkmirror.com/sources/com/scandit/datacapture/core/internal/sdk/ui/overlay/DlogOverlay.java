...
public final class DlogOverlay implements DataCaptureOverlay, DlogOverlayProxy {
    ...
    private final /* synthetic */ DlogOverlayProxyAdapter f125763a;
    ...
    public static final class Companion {
        ...
        public final DlogOverlay create(DataCaptureContext dataCaptureContext) {
            ...
            NativeDlogOverlay nativeDlogOverlayCreate = NativeDlogOverlay.create(dataCaptureContext.getF124053a());
    ...
    public NativeDataCaptureOverlay getF125766c() {
        return this.f125763a.getF125766c();
    }

    @Override // com.scandit.datacapture.core.internal.sdk.ui.overlay.DlogOverlayProxy
    @NativeImpl
    /* renamed from: _impl */
    public NativeDlogOverlay getF125764a() {
        return this.f125763a.getF125764a();
    }
    ...
    public void setGlobFilter(String globFilter) {
        ...
        this.f125763a.setGlobFilter(globFilter);
    }

    public DlogOverlay(NativeDlogOverlay impl) {
        Intrinsics.j(impl, "impl");
        this.f125763a = new DlogOverlayProxyAdapter(impl, null, 2, null);
    }
}
