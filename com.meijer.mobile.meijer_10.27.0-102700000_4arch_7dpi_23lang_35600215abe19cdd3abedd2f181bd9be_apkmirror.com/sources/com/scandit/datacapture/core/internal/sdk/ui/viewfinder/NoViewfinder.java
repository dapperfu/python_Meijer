...
public final class NoViewfinder implements NoViewfinderProxy {
    ...
    private final /* synthetic */ NoViewfinderProxyAdapter f125825a;

    /* JADX WARN: Multi-variable type inference failed */
    public NoViewfinder(NativeNoViewfinder impl) {
        Intrinsics.j(impl, "impl");
        this.f125825a = new NoViewfinderProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    }

    @Override // com.scandit.datacapture.core.internal.sdk.ui.viewfinder.NoViewfinderProxy
    @NativeImpl
    /* renamed from: _impl */
    public NativeNoViewfinder getF125826a() {
        return this.f125825a.getF125826a();
    }
    ...
    public NativeViewfinder getF125828c() {
        return this.f125825a.getF125828c();
    }
