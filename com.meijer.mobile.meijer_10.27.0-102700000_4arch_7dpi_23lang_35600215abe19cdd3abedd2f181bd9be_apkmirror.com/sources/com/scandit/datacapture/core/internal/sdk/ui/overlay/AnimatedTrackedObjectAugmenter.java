...
public abstract class AnimatedTrackedObjectAugmenter<T> extends TrackedObjectAugmenter<T> {
    ...
    private final LinkedHashMap f125754j;
    ...
    public AnimatedTrackedObjectAugmenter(TrackedObjectAugmenter.Host<T> host) {
        ...
        this.f125754j = new LinkedHashMap();
    }
    ...
    protected void onAugmentationRemoved(Augmentation<T> augmentation) {
        Intrinsics.j(augmentation, "augmentation");
        this.f125754j.remove(augmentation);
    }
    ...
    public final void a(Augmentation augmentation, Transformation transformation) {
        ...
        if (containerView != null) {
            if (this.f125754j.get(augmentation) == null) {
                this.f125754j.put(augmentation, new AugmentationAnimation(containerView, getObjectOverlayUtils().getObjectOverlayPosition(getViewLocation(augmentation.getTrackedObject(), transformation), ObjectOverlayUtilsKt.getSize(augmentation.getContainerView()), augmentation.getAnchor(), augmentation.getOffset())));
            }
            AugmentationAnimation augmentationAnimation = (AugmentationAnimation) this.f125754j.get(augmentation);
