...
public final class Transformation {
    ...
    private static final Transformation f125792d = new Transformation(1.0f, PointUtilsKt.getPOINT_ZERO(), 0);

    /* renamed from: a, reason: collision with root package name */
    private final float f125793a;

    /* renamed from: b, reason: collision with root package name */
    private final Point f125794b;

    /* renamed from: c, reason: collision with root package name */
    private final int f125795c;
    ...
    public static final class Companion {
        ...
        public final Transformation getID() {
            return Transformation.f125792d;
        }
    }

    public final Quadrilateral transform(Quadrilateral quadrilateral) {
        Intrinsics.j(quadrilateral, "quadrilateral");
        int i10 = this.f125795c;
        if (i10 != 0) {
            quadrilateral = QuadrilateralUtilsKt.rotatedDegrees(quadrilateral, this.f125794b, i10);
        }
        float f10 = this.f125793a;
    ...
    public final Point transform(Point point) {
        ...
        int i10 = this.f125795c;
        if (i10 != 0) {
            point = com.scandit.datacapture.core.common.geometry.PointUtilsKt.rotatedDegrees(point, this.f125794b, i10);
        }
        float f10 = this.f125793a;
