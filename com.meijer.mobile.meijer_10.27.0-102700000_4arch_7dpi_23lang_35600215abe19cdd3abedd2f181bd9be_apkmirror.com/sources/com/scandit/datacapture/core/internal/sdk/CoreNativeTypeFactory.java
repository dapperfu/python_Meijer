...
public final class CoreNativeTypeFactory {
    ...
    public final FrameData convert(NativeFrameData source) {
        ...
        return new FrameData(source) { // from class: com.scandit.datacapture.core.internal.sdk.CoreNativeTypeFactory.convert.1
            ...
            private final NativeFrameData f125342a;

            @Override // com.scandit.datacapture.core.data.FrameData
            /* renamed from: _impl, reason: from getter */
            public NativeFrameData getF125342a() {
            ...
            public boolean equals(Object other) {
                if (other instanceof FrameData) {
                    return Intrinsics.e(this.f125342a, ((FrameData) other).getF125342a());
                }
                return false;
            }
            ...
            public ImageBuffer getImageBuffer() {
                NativeImageBuffer imageBuffer = this.f125342a.getImageBuffer();
            ...
            public int getOrientation() {
                return this.f125342a.getOrientation();
            }

            @Override // com.scandit.datacapture.core.data.FrameData
            public long getTimestamp() {
                return this.f125342a.getTimestampForAndroid();
            }

            @Override // com.scandit.datacapture.core.data.FrameData
            public int hashCode() {
                return this.f125342a.hashCode();
            }

            @Override // com.scandit.datacapture.core.data.FrameData
            public void release() {
                this.f125342a.release();
            }

            @Override // com.scandit.datacapture.core.data.FrameData
            public void retain() {
                this.f125342a.retain();
            }

            {
                this.f125342a = source;
            }
        };
    }
    ...
    public final NativeAbstractCamera convert(Camera camera) {
        ...
        NativeAbstractCamera nativeAbstractCameraAsAbstractCamera = camera.getF125871a().asAbstractCamera();
