...
public final class JsonValueProxyAdapter implements JsonValueProxy {
    ...
    private final NativeJsonValue f125830a;
    ...
    public JsonValueProxyAdapter(NativeJsonValue _NativeJsonValue, ProxyCache proxyCache) {
        ...
        this.f125830a = _NativeJsonValue;
    ...
    public ArrayList<String> _getWarnings() {
        ArrayList<String> warnings = this.f125830a.getWarnings();
    ...
    public void _removeKeys(ArrayList<String> keys) {
        ...
        this.f125830a.removeKeys(keys);
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    public JsonValue asArray() {
        NativeJsonValue nativeJsonValueAsArray = this.f125830a.asArray();
    ...
    public boolean asBoolean() {
        return this.f125830a.asBool();
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    public Brush asBrush() {
        NativeBrush nativeBrushAsBrush = this.f125830a.asBrush();
    ...
    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    public int asColor() {
        NativeColor nativeColorAsColor = this.f125830a.asColor();
        CoreNativeTypeFactory coreNativeTypeFactory = CoreNativeTypeFactory.INSTANCE;
    ...
    public float asFloat() {
        return this.f125830a.asFloat();
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    public FloatWithUnit asFloatWithUnit() {
        FloatWithUnit floatWithUnitAsFloatWithUnit = this.f125830a.asFloatWithUnit();
    ...
    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    public int asInt() {
        return this.f125830a.asInt();
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    public MarginsWithUnit asMarginsWithUnit() {
        MarginsWithUnit marginsWithUnitAsMarginsWithUnit = this.f125830a.asMarginsWithUnit();
    ...
    public JsonValue asObject() {
        NativeJsonValue nativeJsonValueAsObject = this.f125830a.asObject();
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeJsonValue.class);
    ...
    public PointWithUnit asPointWithUnit() {
        PointWithUnit pointWithUnitAsPointWithUnit = this.f125830a.asPointWithUnit();
    ...
    public String asString() {
        String strAsString = this.f125830a.asString();
    ...
    public boolean contains(String key) {
        ...
        return this.f125830a.contains(key);
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    public boolean containsNull(String key) {
        Intrinsics.j(key, "key");
        return this.f125830a.containsNull(key);
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    public String getAbsolutePath() {
        String absolutePath = this.f125830a.getAbsolutePath();
    ...
    public JsonValue getByKeyAsArray(String key, JsonValue defaultValue) {
        NativeJsonValue f125830a;
        Intrinsics.j(key, "key");
        if (defaultValue != null) {
            f125830a = defaultValue.getF125830a();
            this.proxyCache.put(Reflection.b(NativeJsonValue.class), null, f125830a, defaultValue);
        } else {
            f125830a = null;
        }
        NativeJsonValue arrayForKeyOrDefault = this.f125830a.getArrayForKeyOrDefault(key, f125830a);
    ...
    public boolean getByKeyAsBoolean(String key, boolean defaultValue) {
        Intrinsics.j(key, "key");
        return this.f125830a.getBoolForKeyOrDefault(key, defaultValue);
    }
    ...
    public Brush getByKeyAsBrush(String key, Brush defaultValue) {
        ...
        CoreNativeTypeFactory coreNativeTypeFactory = CoreNativeTypeFactory.INSTANCE;
        NativeBrush brushForKeyOrDefault = this.f125830a.getBrushForKeyOrDefault(key, coreNativeTypeFactory.convert(defaultValue));
    ...
    public int getByKeyAsColor(String key, int defaultValue) {
        Intrinsics.j(key, "key");
        CoreNativeTypeFactory coreNativeTypeFactory = CoreNativeTypeFactory.INSTANCE;
        NativeColor colorForKeyOrDefault = this.f125830a.getColorForKeyOrDefault(key, coreNativeTypeFactory.convert(defaultValue));
    ...
    public float getByKeyAsFloat(String key, float defaultValue) {
        Intrinsics.j(key, "key");
        return this.f125830a.getFloatForKeyOrDefault(key, defaultValue);
    }
    ...
    public FloatWithUnit getByKeyAsFloatWithUnit(String key, FloatWithUnit defaultValue) {
        Intrinsics.j(key, "key");
        Intrinsics.j(defaultValue, "defaultValue");
        FloatWithUnit floatWithUnitForKeyOrDefault = this.f125830a.getFloatWithUnitForKeyOrDefault(key, defaultValue);
    ...
    public int getByKeyAsInt(String key, int defaultValue) {
        Intrinsics.j(key, "key");
        return this.f125830a.getIntForKeyOrDefault(key, defaultValue);
    }
    ...
    public MarginsWithUnit getByKeyAsMarginsWithUnit(String key, MarginsWithUnit defaultValue) {
        Intrinsics.j(key, "key");
        Intrinsics.j(defaultValue, "defaultValue");
        MarginsWithUnit marginsWithUnitForKeyOrDefault = this.f125830a.getMarginsWithUnitForKeyOrDefault(key, defaultValue);
    ...
    public Integer getByKeyAsNullableColor(String key, Integer defaultValue) {
        ...
        NativeColor optionalColorForKeyOrDefault = this.f125830a.getOptionalColorForKeyOrDefault(key, nativeColorConvert);
    ...
    public JsonValue getByKeyAsObject(String key, JsonValue defaultValue) {
        ...
        NativeJsonValue objectForKeyOrDefault = this.f125830a.getObjectForKeyOrDefault(key, f125830a);
    ...
    public PointWithUnit getByKeyAsPointWithUnit(String key, PointWithUnit defaultValue) {
        Intrinsics.j(key, "key");
        Intrinsics.j(defaultValue, "defaultValue");
        PointWithUnit pointWithUnitForKeyOrDefault = this.f125830a.getPointWithUnitForKeyOrDefault(key, defaultValue);
    ...
    public String getByKeyAsString(String key, String defaultValue) {
        Intrinsics.j(key, "key");
        Intrinsics.j(defaultValue, "defaultValue");
        String stringForKeyOrDefault = this.f125830a.getStringForKeyOrDefault(key, defaultValue);
    ...
    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    public long getSize() {
        return this.f125830a.size();
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    public boolean getUsed() {
        return this.f125830a.isUsed();
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    public String jsonString() {
        String string = this.f125830a.toString();
    ...
    public JsonValue requireByIndex(int index) {
        NativeJsonValue forIndex = this.f125830a.getForIndex(index);
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeJsonValue.class);
    ...
    public JsonValue requireByKey(String key) {
        Intrinsics.j(key, "key");
        NativeJsonValue forKey = this.f125830a.getForKey(key);
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeJsonValue.class);
        Intrinsics.g(forKey);
    ...
    public JsonValue requireByKeyAsArray(String key) {
        Intrinsics.j(key, "key");
        NativeJsonValue arrayForKey = this.f125830a.getArrayForKey(key);
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeJsonValue.class);
    ...
    public boolean requireByKeyAsBoolean(String key) {
        Intrinsics.j(key, "key");
        return this.f125830a.getBoolForKey(key);
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    public Brush requireByKeyAsBrush(String key) {
        Intrinsics.j(key, "key");
        NativeBrush brushForKey = this.f125830a.getBrushForKey(key);
        CoreNativeTypeFactory coreNativeTypeFactory = CoreNativeTypeFactory.INSTANCE;
    ...
    public int requireByKeyAsColor(String key) {
        Intrinsics.j(key, "key");
        NativeColor colorForKey = this.f125830a.getColorForKey(key);
        CoreNativeTypeFactory coreNativeTypeFactory = CoreNativeTypeFactory.INSTANCE;
    ...
    public float requireByKeyAsFloat(String key) {
        Intrinsics.j(key, "key");
        return this.f125830a.getFloatForKey(key);
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    public FloatWithUnit requireByKeyAsFloatWithUnit(String key) {
        Intrinsics.j(key, "key");
        FloatWithUnit floatWithUnitForKey = this.f125830a.getFloatWithUnitForKey(key);
    ...
    public int requireByKeyAsInt(String key) {
        Intrinsics.j(key, "key");
        return this.f125830a.getIntForKey(key);
    }

    @Override // com.scandit.datacapture.core.json.JsonValueProxy
    public MarginsWithUnit requireByKeyAsMarginsWithUnit(String key) {
        Intrinsics.j(key, "key");
        MarginsWithUnit marginsWithUnitForKey = this.f125830a.getMarginsWithUnitForKey(key);
    ...
    public JsonValue requireByKeyAsObject(String key) {
        Intrinsics.j(key, "key");
        NativeJsonValue objectForKey = this.f125830a.getObjectForKey(key);
        ProxyCache proxyCache = this.proxyCache;
        KClass kClassB = Reflection.b(NativeJsonValue.class);
    ...
    public PointWithUnit requireByKeyAsPointWithUnit(String key) {
        Intrinsics.j(key, "key");
        PointWithUnit pointWithUnitForKey = this.f125830a.getPointWithUnitForKey(key);
    ...
    public String requireByKeyAsString(String key) {
        Intrinsics.j(key, "key");
        String stringForKey = this.f125830a.getStringForKey(key);
