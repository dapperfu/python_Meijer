...
public final class LocationSelectionDeserializerProxyAdapter implements LocationSelectionDeserializerProxy {
    ...
    private final NativeLocationSelectionDeserializer f124027a;
    ...
    public LocationSelectionDeserializerProxyAdapter(NativeLocationSelectionDeserializer _NativeLocationSelectionDeserializer, ProxyCache proxyCache) {
        ...
        this.f124027a = _NativeLocationSelectionDeserializer;
    ...
    public void _setHelper(LocationSelectionDeserializerHelper helper) {
        this.f124027a.setHelper(helper != null ? (LocationSelectionDeserializerHelperReversedAdapter) this.proxyCache.getOrPut(Reflection.b(LocationSelectionDeserializerHelper.class), null, helper, new a(helper)) : null);
    }
    ...
    public List<String> getWarnings() {
        ArrayList<String> warnings = this.f124027a.getWarnings();
