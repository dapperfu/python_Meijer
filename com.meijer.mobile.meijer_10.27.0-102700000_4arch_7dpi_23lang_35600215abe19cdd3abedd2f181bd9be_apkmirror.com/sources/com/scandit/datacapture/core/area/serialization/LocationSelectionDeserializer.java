...
public final class LocationSelectionDeserializer implements LocationSelectionDeserializerProxy {
    ...
    private final /* synthetic */ LocationSelectionDeserializerProxyAdapter f124022a;

    /* renamed from: b, reason: collision with root package name */
    private final Helper f124023b;
    ...
    public LocationSelectionDeserializer(NativeLocationSelectionDeserializer impl) {
        ...
        this.f124022a = new LocationSelectionDeserializerProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
        Helper helper = new Helper();
        this.f124023b = helper;
        _setHelper(helper);
    }
    ...
    @NativeImpl
    /* renamed from: _impl */
    public NativeLocationSelectionDeserializer getF124027a() {
        return this.f124022a.getF124027a();
    }

    @Override // com.scandit.datacapture.core.area.serialization.LocationSelectionDeserializerProxy
    @ProxyFunction(nativeName = "setHelper")
    public void _setHelper(LocationSelectionDeserializerHelper helper) {
        this.f124022a._setHelper(helper);
    }

    @Override // com.scandit.datacapture.core.area.serialization.LocationSelectionDeserializerProxy
    @ProxyFunction(property = "warnings")
    public List<String> getWarnings() {
        return this.f124022a.getWarnings();
    }

    public final LocationSelection _getAndResetLastLocationSelection() {
        LocationSelection locationSelection = this.f124023b.getLocationSelection();
        this.f124023b.setLocationSelection(null);
    ...
    public final LocationSelection locationSelectionFromJson(String jsonData) {
        ...
        getF124027a().locationSelectionFromJson(CoreNativeTypeFactory.INSTANCE.convert(jsonData));
