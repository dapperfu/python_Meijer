...
public final class RectangularLocationSelection implements LocationSelection, RectangularLocationSelectionProxy {
    ...
    private final /* synthetic */ RectangularLocationSelectionProxyAdapter f124018a;
    ...
    public NativeRectangularLocationSelection getF124019a() {
        return this.f124018a.getF124019a();
    }
    ...
    public NativeLocationSelection getF124021c() {
        return this.f124018a.getF124021c();
    }

    @Override // com.scandit.datacapture.core.area.LocationSelection, com.scandit.datacapture.core.area.RadiusLocationSelectionProxy
    @ProxyFunction(nativeName = "toJson")
    public String toJson() {
        return this.f124018a.toJson();
    }

    /* JADX WARN: Multi-variable type inference failed */
    public RectangularLocationSelection(NativeRectangularLocationSelection impl) {
        Intrinsics.j(impl, "impl");
        this.f124018a = new RectangularLocationSelectionProxyAdapter(impl, null, 2, 0 == true ? 1 : 0);
    }

    public final SizeWithUnitAndAspect getSizeWithUnitAndAspect() {
        NativeSizeWithUnitAndAspect sizeWithUnitAndAspect = getF124019a().getSizeWithUnitAndAspect();
