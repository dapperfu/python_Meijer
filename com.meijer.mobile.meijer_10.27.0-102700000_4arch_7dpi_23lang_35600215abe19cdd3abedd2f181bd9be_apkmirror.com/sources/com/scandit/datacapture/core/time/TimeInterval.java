...
public final class TimeInterval {
    ...
    public static final class Companion {
        ...
        public final TimeInterval millis(long duration) {
            ...
            return new TimeInterval(DurationKt.t(duration, DurationUnit.f147508d), null);
        }

        @JvmStatic
        public final TimeInterval seconds(float duration) {
            Duration.Companion companion = Duration.INSTANCE;
            return new TimeInterval(DurationKt.t((long) (duration * 1000.0f), DurationUnit.f147508d), null);
        }
    ...
    public final long asMillis() {
        return Duration.F(this.f125942a);
    }

    public final float asSeconds() {
        return (float) Duration.X(this.f125942a, DurationUnit.f147509e);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof TimeInterval) {
            return Duration.z(this.f125942a, ((TimeInterval) other).f125942a);
        }
        return false;
    }

    public int hashCode() {
        return Duration.O(this.f125942a);
    }

    public String toString() {
        return "TimeInterval{duration=" + ((Object) Duration.a0(this.f125942a)) + '}';
    }
