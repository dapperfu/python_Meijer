...
final class RunnableC14827s extends i.b implements Runnable, p2.G, View.OnAttachStateChangeListener {

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private final C14807P composeInsets;
    ...
    public void b(androidx.core.view.i animation) {
        ...
        if (animation.a() != 0 && jVar != null) {
            ...
            C14807P.l(this.composeInsets, jVar, 0, 2, null);
        }
    ...
    public androidx.core.view.j d(androidx.core.view.j insets, List<androidx.core.view.i> runningAnimations) {
        C14807P.l(this.composeInsets, insets, 0, 2, null);
        return this.composeInsets.getConsumes() ? androidx.core.view.j.f53969b : insets;
    }
    ...
    public RunnableC14827s(C14807P c14807p) {
        super(!c14807p.getConsumes() ? 1 : 0);
        this.composeInsets = c14807p;
    }
