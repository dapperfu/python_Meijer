...
public final class C14809a implements InterfaceC14806O {
    ...
    private final InterfaceC5730l0 insets = t1.e(c2.d.f61361e, null, 2, null);

    /* renamed from: e, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5730l0 isVisible = t1.e(Boolean.TRUE, null, 2, null);

    public boolean equals(Object other) {
        if (this == other) {
            return true;
        }
        return (other instanceof C14809a) && this.type == ((C14809a) other).type;
    }
    ...
    public String toString() {
        return this.name + '(' + e().f61362a + ", " + e().f61363b + ", " + e().f61364c + ", " + e().f61365d + ')';
    }

    public C14809a(int i10, String str) {
        this.type = i10;
        this.name = str;
    }
