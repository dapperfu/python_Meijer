...
public final class C14796E {
    public static final AbstractC5667m a(RowColumnParentData rowColumnParentData) {
    ...
    public static final boolean f(RowColumnParentData rowColumnParentData) {
        AbstractC5667m abstractC5667mA = a(rowColumnParentData);
        if (abstractC5667mA != null) {
            return abstractC5667mA.c();
        }
        return false;
    }
}
