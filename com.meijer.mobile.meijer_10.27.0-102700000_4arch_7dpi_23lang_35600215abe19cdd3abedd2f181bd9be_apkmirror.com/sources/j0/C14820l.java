...
final class C14820l implements InterfaceC14806O {

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC14806O included;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC14806O excluded;

    public boolean equals(Object other) {
        if (this == other) {
            return true;
        }
        if (!(other instanceof C14820l)) {
            return false;
        }
        C14820l c14820l = (C14820l) other;
        return Intrinsics.e(c14820l.included, this.included) && Intrinsics.e(c14820l.excluded, this.excluded);
    }
    ...
    public C14820l(InterfaceC14806O interfaceC14806O, InterfaceC14806O interfaceC14806O2) {
        this.included = interfaceC14806O;
        this.excluded = interfaceC14806O2;
    }
}
