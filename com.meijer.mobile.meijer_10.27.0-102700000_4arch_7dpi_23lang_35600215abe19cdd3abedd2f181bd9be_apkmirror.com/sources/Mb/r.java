...
public final class r {
    ...
    public static Pb.b a(h hVar) {
        ...
        bVar.c(hVar.e());
        d dVarI = hVar.i();
        bVar.b(dVarI == null ? null : new Pb.a(dVarI.a(), dVarI.b(), dVarI.o()));
        ...
        for (m mVar : hVar.j()) {
            ...
            if (mVar == null) {
                ...
                eVar.c(fVar);
                eVar.a(Integer.valueOf((int) (mVar.e() / l8.b.f92525b)));
                eVar.b(null);
            }
            arrayList.add(eVar);
        }
    ...
    public static void c(List<Pb.b> list) {
        if (list.size() > 0) {
            ArrayList arrayList = new ArrayList();
            Iterator<Pb.b> it = list.iterator();
            while (it.hasNext()) {
                Iterator<Pb.e> it2 = it.next().a().iterator();
                while (it2.hasNext()) {
