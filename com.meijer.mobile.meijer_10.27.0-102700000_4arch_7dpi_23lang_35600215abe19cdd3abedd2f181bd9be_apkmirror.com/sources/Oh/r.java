...
@Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0002\u001a/\u0010\u0006\u001a\u00020\u0004*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u00012\u0012\u0010\u0005\u001a\u000e\u0012\u0004\u0012\u00020\u0001\u0012\u0004\u0012\u00020\u00040\u0003H\u0007¢\u0006\u0004\b\u0006\u0010\u0007¨\u0006\n²\u0006\u0010\u0010\t\u001a\u0004\u0018\u00010\b8\n@\nX\u008a\u008e\u0002"}, d2 = {"LJi/M;", "LWh/b;", "preferenceItem", "Lkotlin/Function1;", "", "onPreferenceCheckChange", "b", "(LJi/M;LWh/b;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;I)V", "", "lastAction", "ux_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class r {
    ...
    static final class a implements Function3<InterfaceC14932e0, Composer, Integer, Unit> {
        ...
        final /* synthetic */ LocalThemeScope f23742a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ PreferenceItem f23743b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Function1<PreferenceItem, Unit> f23744c;

        /* JADX WARN: Multi-variable type inference failed */
        a(LocalThemeScope localThemeScope, PreferenceItem preferenceItem, Function1<? super PreferenceItem, Unit> function1) {
            this.f23742a = localThemeScope;
            this.f23743b = preferenceItem;
            this.f23744c = function1;
        }
        ...
        public final void b(InterfaceC14932e0 Assemble, Composer composer, int i10) {
            ...
            LocalThemeScope localThemeScope = this.f23742a;
            q1.s.Switch trailingToggleButton = Assemble.getToggleButtons().getTrailingToggleButton();
            boolean checked = this.f23743b.getChecked();
            boolean enabled = this.f23743b.getEnabled();
            composer.startReplaceGroup(-1633490746);
            boolean zV = composer.V(this.f23744c) | composer.D(this.f23743b);
            final Function1<PreferenceItem, Unit> function1 = this.f23744c;
            final PreferenceItem preferenceItem = this.f23743b;
            Object objB = composer.B();
            if (zV || objB == Composer.INSTANCE.a()) {
                objB = new Function1() { // from class: Oh.q
            ...
            composer.P();
            vi.s.b(localThemeScope, trailingToggleButton, checked, enabled, false, (Function1) objB, composer, LocalThemeScope.f15770g | (q1.s.Switch.f140183e << 3), 8);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final void b(final LocalThemeScope localThemeScope, final PreferenceItem preferenceItem, final Function1<? super PreferenceItem, Unit> onPreferenceCheckChange, Composer composer, final int i10) {
        ...
        if ((i11 & 147) == 146 && composerStartRestartGroup.j()) {
            ...
            Q.e(localThemeScope, s1.i.f140227a, ComposableLambdaKt.c(-886717784, true, new a(localThemeScope, preferenceItem, onPreferenceCheckChange), composerStartRestartGroup, 54), composerStartRestartGroup, (i11 & 14) | LocalThemeScope.f15770g | 384 | (s1.i.f140228b << 3));
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
        ...
        if (t0L != null) {
            t0L.a(new Function2() { // from class: Oh.p
