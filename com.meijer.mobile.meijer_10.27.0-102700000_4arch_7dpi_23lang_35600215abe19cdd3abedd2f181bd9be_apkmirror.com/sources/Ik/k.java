...
public abstract class k<T> {
    ...
    public k(KProperty0<Validation<T>> field, String fieldName) {
        ...
        this.validation = LazyKt.b(new Function0() { // from class: Ik.h
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return k.k(this.f14091a);
            }
        });
        this.errors = LazyKt.b(new Function0() { // from class: Ik.i
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return k.e(this.f14092a);
            }
        });
        this.value = LazyKt.b(new Function0() { // from class: Ik.j
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return k.l(this.f14093a);
            }
        });
    }

    public abstract List<Hk.c> d();
    ...
    public final Validation<T> j() {
        ...
        if (!(listF instanceof Collection) || !listF.isEmpty()) {
            ...
            while (it.hasNext()) {
                if (((Hk.c) it.next()) instanceof c.Pending) {
                    return h().g();
                }
            }
        }
        Validation<T> validationH = h();
        Hk.c[] cVarArr = (Hk.c[]) f().toArray(new Hk.c[0]);
        return validationH.l((Hk.c[]) Arrays.copyOf(cVarArr, cVarArr.length));
    }
