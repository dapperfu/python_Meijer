...
public final class d {
    ...
    public static final int[] f29355a = {12344};

    /* renamed from: b, reason: collision with root package name */
    public static final int[] f29356b = {12445, 13632, 12344};
    ...
    private static final C f29359e;

    /* renamed from: f, reason: collision with root package name */
    private static final C f29360f;

    /* renamed from: g, reason: collision with root package name */
    private static final C f29361g;

    /* renamed from: h, reason: collision with root package name */
    public static final float[] f29362h;

    /* renamed from: i, reason: collision with root package name */
    public static final FloatBuffer f29363i;

    /* renamed from: j, reason: collision with root package name */
    public static final float[] f29364j;

    /* renamed from: k, reason: collision with root package name */
    public static final FloatBuffer f29365k;

    /* renamed from: l, reason: collision with root package name */
    public static final Q.g f29366l;
    ...
    public static class C0683d extends f {
        public C0683d() {
    ...
    public static abstract class f {
        ...
        /* renamed from: a, reason: collision with root package name */
        protected int f29371a;

        /* renamed from: b, reason: collision with root package name */
        protected int f29372b = -1;

        /* renamed from: c, reason: collision with root package name */
        protected int f29373c = -1;

        /* renamed from: d, reason: collision with root package name */
        protected int f29374d = -1;
        ...
        */
        protected f(java.lang.String r7, java.lang.String r8) throws java.lang.Throwable {
            /*
                ...
                if (r3 != r0) goto L4a
                r6.f29371a = r2     // Catch: java.lang.IllegalArgumentException -> L46 java.lang.IllegalStateException -> L48
                r6.c()
                return
            L46:
                r0 = move-exception
        ...
        public void c() {
            int iGlGetAttribLocation = GLES20.glGetAttribLocation(this.f29371a, "aPosition");
            this.f29374d = iGlGetAttribLocation;
            d.j(iGlGetAttribLocation, "aPosition");
            int iGlGetUniformLocation = GLES20.glGetUniformLocation(this.f29371a, "uTransMatrix");
            this.f29372b = iGlGetUniformLocation;
            d.j(iGlGetUniformLocation, "uTransMatrix");
            int iGlGetUniformLocation2 = GLES20.glGetUniformLocation(this.f29371a, "uAlphaScale");
            this.f29373c = iGlGetUniformLocation2;
            d.j(iGlGetUniformLocation2, "uAlphaScale");
        }

        public void b() {
            GLES20.glDeleteProgram(this.f29371a);
        }

        public void d(float f10) {
            GLES20.glUniform1f(this.f29373c, f10);
            d.g("glUniform1f");
        }

        public void e(float[] fArr) {
            GLES20.glUniformMatrix4fv(this.f29372b, 1, false, fArr, 0);
            d.g("glUniformMatrix4fv");
        }

        public void f() {
            GLES20.glUseProgram(this.f29371a);
            d.g("glUseProgram");
            GLES20.glEnableVertexAttribArray(this.f29374d);
            d.g("glEnableVertexAttribArray");
            GLES20.glVertexAttribPointer(this.f29374d, 2, 5126, false, 0, (Buffer) d.f29363i);
    ...
    public static class g extends f {
        ...
        public g(C2979w c2979w, e eVar) {
            this(c2979w, g(c2979w, eVar));
        }

        public g(C2979w c2979w, C c10) {
            super(c2979w.d() ? d.f29358d : d.f29357c, d.v(c10));
            this.f29375e = -1;
            this.f29376f = -1;
            this.f29377g = -1;
            c();
        ...
        public void h(float[] fArr) {
            GLES20.glUniformMatrix4fv(this.f29376f, 1, false, fArr, 0);
            d.g("glUniformMatrix4fv");
        }

        private void c() {
            c();
            int iGlGetUniformLocation = GLES20.glGetUniformLocation(this.f29371a, "sTexture");
            this.f29375e = iGlGetUniformLocation;
            d.j(iGlGetUniformLocation, "sTexture");
            int iGlGetAttribLocation = GLES20.glGetAttribLocation(this.f29371a, "aTextureCoord");
            this.f29377g = iGlGetAttribLocation;
            d.j(iGlGetAttribLocation, "aTextureCoord");
            int iGlGetUniformLocation2 = GLES20.glGetUniformLocation(this.f29371a, "uTexMatrix");
            this.f29376f = iGlGetUniformLocation2;
            d.j(iGlGetUniformLocation2, "uTexMatrix");
        }

        private static C g(C2979w c2979w, e eVar) {
            boolean z10;
            if (!c2979w.d()) {
                return d.f29359e;
            }
            ...
            return eVar == e.YUV ? d.f29361g : d.f29360f;
        }

        @Override // Q.d.f
        public void f() {
            super.f();
            GLES20.glUniform1i(this.f29375e, 0);
            GLES20.glEnableVertexAttribArray(this.f29377g);
            d.g("glEnableVertexAttribArray");
            GLES20.glVertexAttribPointer(this.f29377g, 2, 5126, false, 0, (Buffer) d.f29365k);
            d.g("glVertexAttribPointer");
        }
    }
    ...
    static {
        ...
        f29357c = String.format(locale, "uniform mat4 uTexMatrix;\nuniform mat4 uTransMatrix;\nattribute vec4 aPosition;\nattribute vec4 aTextureCoord;\nvarying vec2 %s;\nvoid main() {\n    gl_Position = uTransMatrix * aPosition;\n    %s = (uTexMatrix * aTextureCoord).xy;\n}\n", "vTextureCoord", "vTextureCoord");
        f29358d = String.format(locale, "#version 300 es\nin vec4 aPosition;\nin vec4 aTextureCoord;\nuniform mat4 uTexMatrix;\nuniform mat4 uTransMatrix;\nout vec2 %s;\nvoid main() {\n  gl_Position = uTransMatrix * aPosition;\n  %s = (uTexMatrix * aTextureCoord).xy;\n}\n", "vTextureCoord", "vTextureCoord");
        f29359e = new a();
        f29360f = new b();
        f29361g = new c();
        ...
        f29364j = fArr2;
        f29365k = m(fArr2);
        f29366l = Q.g.d(EGL14.EGL_NO_SURFACE, 0, 0);
    }
    ...
    public static int[] k(String str, C2979w c2979w) {
        int[] iArr = f29355a;
        if (c2979w.b() == 3) {
    ...
    public static Map<e, f> o(C2979w c2979w, Map<e, C> map) {
        Object gVar;
        e eVar;
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            C c10 = map.get(eVar2);
            if (c10 != null) {
                gVar = new g(c2979w, c10);
            } else if (eVar2 == e.YUV || eVar2 == (eVar = e.DEFAULT)) {
                gVar = new g(c2979w, eVar2);
            } else {
                ...
                if (c2979w.d()) {
                    ...
                    C c11 = map.get(eVar);
                    gVar = c11 != null ? new g(c2979w, c11) : new g(c2979w, eVar);
                }
            }
