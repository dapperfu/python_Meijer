...
@Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0003\bf\u0018\u0000*\u0004\b\u0000\u0010\u00012\u00020\u0002R$\u0010\u0007\u001a\u0012\u0012\u000e\u0012\f\u0012\b\b\u0001\u0012\u0004\u0018\u00010\u00020\u00040\u00038&X¦\u0004¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006R\u001a\u0010\n\u001a\b\u0012\u0004\u0012\u00020\b0\u00038VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\t\u0010\u0006R\u0014\u0010\f\u001a\u00020\u000b8VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\f\u0010\rø\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001¨\u0006\u000eÀ\u0006\u0001"}, d2 = {"LHk/a;", "T", "", "", "LHk/b;", "a", "()Ljava/util/List;", "validations", "LHk/c;", "d", "errors", "", "isValid", "()Z", "util_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public interface a<T> {
    ...
    default List<c> d() {
        ...
        while (it.hasNext()) {
            d dVarD = ((Validation) it.next()).getResult();
            if (dVarD instanceof d.Failures) {
                aVar = (d.Failures) dVarD;
            } else {
                aVar = null;
            }
            if (aVar != null) {
