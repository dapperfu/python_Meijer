        ...
        for (int i15 = 0; i15 < charSequence.length(); i15++) {
            ...
            while (i16 > 0) {
                if (iCharAt == 0 || (i12 = iArr2[i16]) == 0) {
                    ...
                    int[] iArr3 = f19553d;
                    int[] iArr4 = f19552c;
                    cArr[i16] = (char) (iArr3[(iArr4[iCharAt] + iArr4[i12]) % l3.f92484c] ^ c10);
                }
                i16--;
            }
            if (iCharAt == 0 || (i11 = iArr2[0]) == 0) {
                ...
                int[] iArr5 = f19553d;
                int[] iArr6 = f19552c;
                cArr[0] = (char) iArr5[(iArr6[iCharAt] + iArr6[i11]) % l3.f92484c];
            }
        }
