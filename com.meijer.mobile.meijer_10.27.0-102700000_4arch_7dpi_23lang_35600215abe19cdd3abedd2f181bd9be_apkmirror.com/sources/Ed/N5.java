...
public abstract class N5 extends M4 implements List, RandomAccess {
    ...
    private static final AbstractC3445d f8251b = new L5(S5.f8296e, 0);
    ...
    static N5 m(Object[] objArr, int i10) {
        return i10 == 0 ? S5.f8296e : new S5(objArr, i10);
    }
    ...
    public N5 subList(int i10, int i11) {
        ...
        return new M5(this, i10, i12);
    }

    @Override // java.util.List
    /* renamed from: o, reason: merged with bridge method [inline-methods] */
    public final AbstractC3445d listIterator(int i10) {
        G1.b(i10, size(), "index");
        if (isEmpty()) {
            return f8251b;
        }
        return new L5(this, i10);
    }
}
