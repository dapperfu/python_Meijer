...
public final class d extends Qg.a {
    ...
    private Qg.c E(Gg.a aVar, int i10, boolean z10, List<b> list) {
        ...
        try {
            ...
            return new Qg.c(iQ, new int[]{i11, i16}, i11, i16, i10);
    ...
    private void I(int i10) {
        ...
        boolean zC2 = false;
        while (true) {
            if (i11 >= this.f32236h.size()) {
                break;
            }
            c cVar = this.f32236h.get(i11);
            if (cVar.b() > i10) {
                zC = cVar.c(this.f32235g);
                break;
            } else {
                zC2 = cVar.c(this.f32235g);
                i11++;
            }
        }
        if (zC || zC2 || B(this.f32235g, this.f32236h)) {
            return;
        }
        this.f32236h.add(i11, new c(this.f32235g, i10));
        F(this.f32235g, this.f32236h);
    }

    @Override // Pg.r
    public m c(int i10, Gg.a aVar, Map<com.google.zxing.d, ?> map) throws NotFoundException, FormatException {
        this.f32238j = false;
        try {
            return v(x(i10, aVar));
        } catch (NotFoundException unused) {
    ...
    */
    private static boolean C(java.util.List<Rg.b> r8, boolean r9) {
        /*
            int[][] r0 = Rg.d.f32234p
            int r1 = r0.length
            r2 = 0
        ...
        L37:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: Rg.d.C(java.util.List, boolean):boolean");
    }

    private boolean s() {
        b bVar = this.f32235g.get(0);
        Qg.b bVarB = bVar.b();
        Qg.b bVarC = bVar.c();
        if (bVarC == null) {
            return false;
        ...
        int iA = bVarC.a();
        int i10 = 2;
        for (int i11 = 1; i11 < this.f32235g.size(); i11++) {
            b bVar2 = this.f32235g.get(i11);
            iA += bVar2.b().a();
            int i12 = i10 + 1;
            Qg.b bVarC2 = bVar2.c();
            if (bVarC2 != null) {
    ...
    private List<b> t(List<c> list, int i10) throws NotFoundException {
        while (i10 < this.f32236h.size()) {
            c cVar = this.f32236h.get(i10);
            this.f32235g.clear();
            Iterator<c> it = list.iterator();
            while (it.hasNext()) {
                this.f32235g.addAll(it.next().a());
            }
            this.f32235g.addAll(cVar.a());
            if (C(this.f32235g, false)) {
                if (s()) {
                    return this.f32235g;
                }
    ...
    private List<b> u(boolean z10) {
        List<b> listT = null;
        if (this.f32236h.size() > 25) {
            this.f32236h.clear();
            return null;
        }
        this.f32235g.clear();
        if (z10) {
            Collections.reverse(this.f32236h);
        }
        try {
    ...
    Qg.b w(Gg.a aVar, Qg.c cVar, boolean z10, boolean z11) throws NotFoundException {
        int[] iArrI = i();
        Arrays.fill(iArrI, 0);
        if (z11) {
        ...
        for (int length2 = iArrM.length - 1; length2 >= 0; length2--) {
            if (A(cVar, z10, z11)) {
                i15 += iArrM[length2] * f32233o[iC][length2 * 2];
            }
            i16 += iArrM[length2];
        }
        int i17 = 0;
        for (int length3 = iArrK.length - 1; length3 >= 0; length3--) {
            if (A(cVar, z10, z11)) {
                i17 += iArrK[length3] * f32233o[iC][(length3 * 2) + 1];
            }
        }
        int i18 = i15 + i17;
        ...
        int i19 = (13 - i16) / 2;
        int i20 = f32229k[i19];
        return new Qg.b((f.b(iArrM, i20, true) * f32230l[i19]) + f.b(iArrK, 9 - i20, false) + f32231m[i19], i18);
    }

    List<b> x(int i10, Gg.a aVar) throws NotFoundException {
        this.f32235g.clear();
        boolean z10 = false;
        while (!z10) {
            try {
                ...
                if (this.f32235g.isEmpty()) {
                    throw e10;
                }
                z10 = true;
            }
        }
        if (s() && C(this.f32235g, true)) {
            return this.f32235g;
        }
        boolean zIsEmpty = this.f32236h.isEmpty();
        I(i10);
        if (!zIsEmpty) {
    ...
    private static boolean A(Qg.c cVar, boolean z10, boolean z11) {
        if (cVar.c() == 0 && z10 && z11) {
            return false;
        }
        return true;
    ...
    private void y(Gg.a aVar, List<b> list, int i10) throws NotFoundException {
        boolean z10;
        int[] iArrJ = j();
        iArrJ[0] = 0;
        iArrJ[1] = 0;
    ...
    private static int z(Gg.a aVar, int i10) {
        if (aVar.g(i10)) {
    ...
    b G(Gg.a aVar, List<b> list, int i10) throws NotFoundException {
        boolean z10;
        Qg.c cVarE;
        if (list.size() % 2 == 0) {
            z10 = true;
