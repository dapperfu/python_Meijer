...
public final class C18269b {
    ...
    static final class a implements Function4<InterfaceC6163b, C14664h, Composer, Integer, Unit> {
        ...
        final /* synthetic */ C14667k f170853a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f170854b;

        a(C14667k c14667k, LocalThemeScope localThemeScope) {
            this.f170853a = c14667k;
            this.f170854b = localThemeScope;
        }
        ...
        public final void a(InterfaceC6163b composable, C14664h screen, Composer composer, int i10) {
            ...
            if (str == null) {
                ...
                composer2 = composer;
                c0VarB = W2.d.b(h.class, h0VarC, null, cVarA, h0VarC instanceof InterfaceC6020j ? ((InterfaceC6020j) h0VarC).getDefaultViewModelCreationExtras() : CreationExtras.b.f36770c, composer2, 36936, 0);
                composer2.U();
                composer2.U();
                composer2.P();
                composer2.P();
                ...
                c0VarB = W2.d.b(h.class, c14664h, null, cVarA2, c14664h != null ? c14664h.getDefaultViewModelCreationExtras() : CreationExtras.b.f36770c, composer2, 36936, 0);
                composer2.U();
                composer2.U();
                composer2.P();
            }
            g.r(this.f170854b, (h) c0VarB, modifierFsUnmask, composer2, LocalThemeScope.f15770g, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final void b(C14675s c14675s, final C14667k navController, final LocalThemeScope localThemeScope) {
        ...
        i.f(c14675s, C18085d.a.b.f169851b.getCom.google.android.libraries.places.api.model.PlaceTypes.ROUTE java.lang.String(), "checkout", null, null, null, null, null, null, new Function1() { // from class: yq.a
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return C18269b.c(navController, localThemeScope, (C14675s) obj);
            }
        }, 252, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit c(C14667k c14667k, LocalThemeScope localThemeScope, C14675s navigation) {
        Intrinsics.j(navigation, "$this$navigation");
        i.c(navigation, C18085d.a.b.f169851b.getCom.google.android.libraries.places.api.model.PlaceTypes.ROUTE java.lang.String(), null, null, null, null, null, null, ComposableLambdaKt.composableLambdaInstance(21635379, true, new a(c14667k, localThemeScope)), 126, null);
        return Unit.f142422a;
    }
}
