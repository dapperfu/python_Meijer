...
public final class a {
    public static final Discount a(HybrisDiscount hybrisDiscount) {
        ...
        if (priceGoodThroughString == null || StringsKt.r0(priceGoodThroughString)) {
            priceGoodThroughString = null;
        }
        return new Discount(map, priceGoodThroughString != null ? (OffsetDateTime) d.a(priceGoodThroughString, C17590a.f164803a.s(), new r()) : null, hybrisDiscount.getSalePriceText(), hybrisDiscount.getSalePriceType(), hybrisDiscount.getSalePriceValue(), hybrisDiscount.getSavingsText(), hybrisDiscount.getUnit(), hybrisDiscount.getUnitFactor(), hybrisDiscount.getValue());
    }
}
