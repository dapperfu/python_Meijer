...
public abstract class B {
    ...
    private static final B f3837a = new a();

    /* renamed from: b, reason: collision with root package name */
    private static final B f3838b = new b(-1);

    /* renamed from: c, reason: collision with root package name */
    private static final B f3839c = new b(1);
    ...
    class a extends B {
        ...
        B l(int i10) {
            return i10 < 0 ? B.f3838b : i10 > 0 ? B.f3839c : B.f3837a;
        }
