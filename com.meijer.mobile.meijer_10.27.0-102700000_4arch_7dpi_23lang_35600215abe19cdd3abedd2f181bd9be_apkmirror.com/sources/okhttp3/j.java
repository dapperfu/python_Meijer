...
public final class j {
    ...
    private static final Regex f154395f = new Regex("([a-zA-Z0-9-!#$%&'*+.^_`{|}~]+)/([a-zA-Z0-9-!#$%&'*+.^_`{|}~]+)");

    /* renamed from: g, reason: collision with root package name */
    private static final Regex f154396g = new Regex(";\\s*(?:([a-zA-Z0-9-!#$%&'*+.^_`{|}~]+)=(?:([a-zA-Z0-9-!#$%&'*+.^_`{|}~]+)|\"([^\"]*)\"))?");
    ...
    public static final class Companion {
        ...
        public final j a(String str) {
            ...
            MatchResult matchResultH = j.f154395f.h(str, 0);
            ...
            while (true) {
                ...
                MatchResult matchResultH2 = j.f154396g.h(str, i10);
                ...
                if (strB == null) {
                    ...
                    } else if (StringsKt.d1(strB2, '\'', false, 2, null) && StringsKt.f0(strB2, '\'', false, 2, null) && strB2.length() > 2) {
