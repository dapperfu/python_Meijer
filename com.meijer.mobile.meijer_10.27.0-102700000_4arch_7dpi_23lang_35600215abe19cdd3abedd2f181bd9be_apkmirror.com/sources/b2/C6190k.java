...
public class C6190k {
    ...
    public static ColorStateList g(TypedArray typedArray, XmlPullParser xmlPullParser, Resources.Theme theme, String str, int i10) {
        if (p(xmlPullParser, str)) {
            ...
            if (i11 != 2) {
                ...
                return C6182c.d(typedArray.getResources(), typedArray.getResourceId(i10, 0), theme);
            }
    ...
    public static C6183d i(TypedArray typedArray, XmlPullParser xmlPullParser, Resources.Theme theme, String str, int i10, int i11) {
        if (p(xmlPullParser, str)) {
            TypedValue typedValue = new TypedValue();
            typedArray.getValue(i10, typedValue);
            int i12 = typedValue.type;
            if (i12 >= 28 && i12 <= 31) {
                return C6183d.b(typedValue.data);
            }
            C6183d c6183dG = C6183d.g(typedArray.getResources(), typedArray.getResourceId(i10, 0), theme);
            if (c6183dG != null) {
                return c6183dG;
            }
        }
