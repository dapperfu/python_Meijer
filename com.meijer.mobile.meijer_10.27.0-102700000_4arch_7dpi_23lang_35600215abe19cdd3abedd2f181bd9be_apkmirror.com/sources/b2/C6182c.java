...
public final class C6182c {
    ...
    private static final ThreadLocal<TypedValue> f59704a = new ThreadLocal<>();
    ...
    private static int g(int i10, float f10, float f11) {
        ...
        int iB = C14329a.b((int) ((Color.alpha(i10) * f10) + 0.5f), 0, l3.f92484c);
        if (z10) {
            C6180a c6180aC = C6180a.c(i10);
            i10 = C6180a.m(c6180aC.j(), c6180aC.i(), f11);
        }
        return (i10 & 16777215) | (iB << 24);
    }

    private static TypedValue c() {
        ThreadLocal<TypedValue> threadLocal = f59704a;
    ...
    private static ColorStateList e(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                TypedArray typedArrayH = h(resources2, theme, attributeSet, Y1.g.f40042b);
                int resourceId = typedArrayH.getResourceId(Y1.g.f40043c, -1);
                if (resourceId == -1 || f(resources2, resourceId)) {
                    color = typedArrayH.getColor(Y1.g.f40043c, -65281);
                } else {
                    try {
                ...
                float f10 = 1.0f;
                if (typedArrayH.hasValue(Y1.g.f40044d)) {
                    f10 = typedArrayH.getFloat(Y1.g.f40044d, 1.0f);
                } else if (typedArrayH.hasValue(Y1.g.f40046f)) {
                    f10 = typedArrayH.getFloat(Y1.g.f40046f, 1.0f);
                }
                float f11 = (Build.VERSION.SDK_INT < 31 || !typedArrayH.hasValue(Y1.g.f40045e)) ? typedArrayH.getFloat(Y1.g.f40047g, -1.0f) : typedArrayH.getFloat(Y1.g.f40045e, -1.0f);
                typedArrayH.recycle();
                ...
                for (int i13 = 0; i13 < attributeCount; i13++) {
                    ...
                    if (attributeNameResource != 16843173 && attributeNameResource != 16843551 && attributeNameResource != Y1.a.f39961a && attributeNameResource != Y1.a.f39962b) {
                        int i14 = i12 + 1;
                ...
                iArrA = C6186g.a(iArrA, i11, g(color, f10, f11));
                iArr = (int[][]) C6186g.b(iArr, i11, iArrTrimStateSet);
                i11++;
            }
            i10 = 1;
