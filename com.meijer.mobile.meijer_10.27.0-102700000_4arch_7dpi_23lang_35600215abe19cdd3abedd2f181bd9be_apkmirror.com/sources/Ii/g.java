...
@Metadata(d1 = {"\u0000L\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010%\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0007\b!\u0018\u0000*\u0004\b\u0000\u0010\u0001*\b\b\u0001\u0010\u0003*\u00020\u0002*\b\b\u0002\u0010\u0005*\u00020\u00042\u000e\u0012\u0004\u0012\u00028\u0000\u0012\u0004\u0012\u00028\u00020\u0006B\u0007¢\u0006\u0004\b\u0007\u0010\bJ\u001b\u0010\n\u001a\u00028\u00022\n\b\u0002\u0010\t\u001a\u0004\u0018\u00018\u0000H\u0002¢\u0006\u0004\b\n\u0010\u000bJ'\u0010\u0010\u001a\b\u0012\u0004\u0012\u00020\u000f0\u000e2\u0006\u0010\t\u001a\u00028\u00002\b\b\u0002\u0010\r\u001a\u00020\fH\u0016¢\u0006\u0004\b\u0010\u0010\u0011J\u000f\u0010\u0012\u001a\u00028\u0001H\u0016¢\u0006\u0004\b\u0012\u0010\u0013J6\u0010\u0017\u001a\u00020\u000f2\u0006\u0010\t\u001a\u00028\u00002\u001d\u0010\u0016\u001a\u0019\u0012\u0004\u0012\u00028\u0002\u0012\u0004\u0012\u00028\u0000\u0012\u0004\u0012\u00020\u000f0\u0014¢\u0006\u0002\b\u0015H\u0016¢\u0006\u0004\b\u0017\u0010\u0018J\u001d\u0010\u001a\u001a\u00020\u000f2\u0006\u0010\t\u001a\u00028\u00002\u0006\u0010\u0019\u001a\u00028\u0002¢\u0006\u0004\b\u001a\u0010\u001bRI\u0010\"\u001a1\u0012\u0004\u0012\u00028\u0000\u0012'\u0012%\u0012\u0004\u0012\u00028\u0002\u0012\u0004\u0012\u00028\u0001\u0012\u0010\u0012\u000e\u0012\u0004\u0012\u00020\f\u0012\u0004\u0012\u00020\u000f0\u001d0\u0014¢\u0006\u0002\b\u00150\u001c8\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u001e\u0010\u001f\u001a\u0004\b \u0010!R@\u0010)\u001a(\u0012\u0004\u0012\u00028\u0002\u0012\u0013\u0012\u00118\u0000¢\u0006\f\b#\u0012\b\b$\u0012\u0004\b\b(\t\u0012\u0004\u0012\u00028\u00020\u0014¢\u0006\u0002\b\u00158\u0016X\u0096\u0004¢\u0006\f\n\u0004\b%\u0010&\u001a\u0004\b'\u0010(¨\u0006*"}, d2 = {"LIi/g;", "KEY", "LIi/b;", "COMPOSER", "LIi/h;", "SCOPE", "LIi/i;", "<init>", "()V", "key", "g", "(Ljava/lang/Object;)LIi/h;", "Landroidx/compose/ui/Modifier;", "modifier", "Lkotlin/Function0;", "", "k", "(Ljava/lang/Object;Landroidx/compose/ui/Modifier;)Lkotlin/jvm/functions/Function2;", "f", "()LIi/b;", "Lkotlin/Function2;", "Lkotlin/ExtensionFunctionType;", "block", "m", "(Ljava/lang/Object;Lkotlin/jvm/functions/Function2;)V", "scope", "p", "(Ljava/lang/Object;LIi/h;)V", "", "Lkotlin/Function1;", "a", "Ljava/util/Map;", "i", "()Ljava/util/Map;", "providerMap", "Lkotlin/ParameterName;", "name", "b", "Lkotlin/jvm/functions/Function2;", "j", "()Lkotlin/jvm/functions/Function2;", "scopeFactory", "library_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public abstract class g<KEY, COMPOSER extends b, SCOPE extends h> implements i<KEY, SCOPE> {
    ...
    private final Function2<SCOPE, KEY, SCOPE> scopeFactory = new Function2() { // from class: Ii.d
    ...
    static final class a implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ g<KEY, COMPOSER, SCOPE> f14069a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ KEY f14070b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Modifier f14071c;

        a(g<KEY, COMPOSER, SCOPE> gVar, KEY key, Modifier modifier) {
            this.f14069a = gVar;
            this.f14070b = key;
            this.f14071c = modifier;
        }
        ...
        public final void a(Composer composer, int i10) {
            ...
            Function2 function2 = this.f14069a.i().get(this.f14070b);
            if (function2 == null || (function3A = (Function3) function2.invoke(this.f14069a.g(this.f14070b), this.f14069a.f())) == null) {
                function3A = Ii.a.f14057a.a();
            }
            function3A.invoke(this.f14071c, composer, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public void m(final KEY key, final Function2<? super SCOPE, ? super KEY, Unit> block) {
        ...
        i().put(key, new Function2() { // from class: Ii.f
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
    ...
    public final void p(KEY key, final SCOPE scope) {
        ...
        i().put(key, new Function2() { // from class: Ii.e
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
