...
public final class c {
    ...
    private static final ThreadLocal<double[]> f61360a = new ThreadLocal<>();
    ...
    private static int f(int i10, int i11) {
        return 255 - (((255 - i11) * (255 - i10)) / l3.f92484c);
    }
    ...
    private static int h(int i10, int i11, int i12, int i13, int i14) {
        ...
        return (((i10 * l3.f92484c) * i11) + ((i12 * i13) * (255 - i11))) / (i14 * l3.f92484c);
    }
    ...
    private static double[] j() {
        ThreadLocal<double[]> threadLocal = f61360a;
    ...
    public static int b(double d10, double d11, double d12) {
        ...
        return Color.rgb(i((int) Math.round(dPow * 255.0d), 0, l3.f92484c), i((int) Math.round(dPow2 * 255.0d), 0, l3.f92484c), i((int) Math.round(dPow3 * 255.0d), 0, l3.f92484c));
    }
}
