...
public final class f {
    ...
    public static class b {
        ...
        private char f61369a;

        /* renamed from: b, reason: collision with root package name */
        private final float[] f61370b;
        ...
        b(b bVar) {
            this.f61369a = bVar.f61369a;
            float[] fArr = bVar.f61370b;
            this.f61370b = f.c(fArr, 0, fArr.length);
        }
    }
    ...
    public static boolean b(b[] bVarArr, b[] bVarArr2) {
        ...
        for (int i10 = 0; i10 < bVarArr.length; i10++) {
            if (bVarArr[i10].f61369a != bVarArr2[i10].f61369a || bVarArr[i10].f61370b.length != bVarArr2[i10].f61370b.length) {
                return false;
            }
        }
        return true;
    ...
    */
    ...
    public static void j(b[] bVarArr, Path path) {
        ...
        char c10 = 'm';
        for (b bVar : bVarArr) {
            b.e(path, fArr, c10, bVar.f61369a, bVar.f61370b);
            c10 = bVar.f61369a;
        }
    }
    ...
    public static void k(b[] bVarArr, b[] bVarArr2) {
        for (int i10 = 0; i10 < bVarArr2.length; i10++) {
            bVarArr[i10].f61369a = bVarArr2[i10].f61369a;
            for (int i11 = 0; i11 < bVarArr2[i10].f61370b.length; i11++) {
                bVarArr[i10].f61370b[i11] = bVarArr2[i10].f61370b[i11];
            }
        }
    }
