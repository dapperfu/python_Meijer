...
public final class b {
    public static final void a(AbstractC14147c<Intent> abstractC14147c, Intent intent, Activity activity, List<? extends View> transitionViews) {
        Intrinsics.j(abstractC14147c, "<this>");
        ...
        abstractC14147c.b(intentPutExtra, dVarA);
    }

    public static final void b(AbstractC14147c<Intent> abstractC14147c, Intent intent, Fragment fragment, List<? extends View> transitionViews) {
        Intrinsics.j(abstractC14147c, "<this>");
        Intrinsics.j(intent, "intent");
        Intrinsics.j(fragment, "fragment");
        Intrinsics.j(transitionViews, "transitionViews");
        if (!fragment.isAdded()) {
            abstractC14147c.a(intent);
            return;
        }
