...
final class C17142D<T> implements P<T>, InterfaceC17152f, InterfaceC17347o<T> {
    ...
    public Object collect(InterfaceC17153g<? super T> interfaceC17153g, Continuation<?> continuation) {
        return this.f162103a.collect(interfaceC17153g, continuation);
    }

    @Override // tv.P
    public T getValue() {
        return this.f162103a.getValue();
    }

    /* JADX WARN: Multi-variable type inference failed */
    public C17142D(P<? extends T> p10, C0 c02) {
        this.f162103a = p10;
        this.job = c02;
    }
