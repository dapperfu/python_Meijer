...
@Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\f\b\u0087\b\u0018\u00002\u00020\u0001B%\u0012\b\b\u0002\u0010\u0003\u001a\u00020\u0002\u0012\b\b\u0002\u0010\u0005\u001a\u00020\u0004\u0012\b\b\u0002\u0010\u0006\u001a\u00020\u0004¢\u0006\u0004\b\u0007\u0010\bJ\u0010\u0010\n\u001a\u00020\tHÖ\u0001¢\u0006\u0004\b\n\u0010\u000bJ\u0010\u0010\r\u001a\u00020\fHÖ\u0001¢\u0006\u0004\b\r\u0010\u000eJ\u001a\u0010\u0010\u001a\u00020\u00022\b\u0010\u000f\u001a\u0004\u0018\u00010\u0001HÖ\u0003¢\u0006\u0004\b\u0010\u0010\u0011R\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0012\u0010\u0013R\u0017\u0010\u0005\u001a\u00020\u00048\u0006¢\u0006\f\n\u0004\b\u0014\u0010\u0015\u001a\u0004\b\u0014\u0010\u0016R\u0017\u0010\u0006\u001a\u00020\u00048\u0006¢\u0006\f\n\u0004\b\u0017\u0010\u0015\u001a\u0004\b\u0012\u0010\u0016¨\u0006\u0018"}, d2 = {"LVh/a;", "", "", "isMperksQuickIDEnabled", "Lak/a;", "heading", "description", "<init>", "(ZLak/a;Lak/a;)V", "", "toString", "()Ljava/lang/String;", "", "hashCode", "()I", "other", "equals", "(Ljava/lang/Object;)Z", "a", "Z", "b", "Lak/a;", "()Lak/a;", "c", "ux_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* renamed from: Vh.a, reason: from toString */
/* loaded from: classes7.dex */
public final /* data */ class MperksQuickIDFooterDecorator {

    /* renamed from: d, reason: collision with root package name */
    public static final int f37564d = AbstractC5607a.f45514b;

    /* renamed from: a, reason: collision with root package name and from kotlin metadata and from toString */
    private final boolean isMperksQuickIDEnabled;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata and from toString */
    private final AbstractC5607a heading;
    ...
    public MperksQuickIDFooterDecorator(boolean z10, AbstractC5607a heading, AbstractC5607a description) {
    ...
    public final AbstractC5607a getHeading() {
        return this.heading;
    }
    ...
    public /* synthetic */ MperksQuickIDFooterDecorator(boolean z10, AbstractC5607a abstractC5607a, AbstractC5607a abstractC5607a2, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        z10 = (i10 & 1) != 0 ? false : z10;
        if ((i10 & 2) != 0) {
            if (z10) {
                abstractC5607a = AbstractC5607a.INSTANCE.d(h.f10589Q3, new Object[0]);
            } else {
                abstractC5607a = AbstractC5607a.INSTANCE.d(h.f10575O3, new Object[0]);
            }
        }
        if ((i10 & 4) != 0) {
            if (z10) {
                abstractC5607a2 = AbstractC5607a.INSTANCE.d(h.f10582P3, new Object[0]);
            } else {
                abstractC5607a2 = AbstractC5607a.INSTANCE.d(h.f10568N3, new Object[0]);
            }
        }
        this(z10, abstractC5607a, abstractC5607a2);
    }
}
