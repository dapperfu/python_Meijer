...
class e {
    ...
    private static final a f38569f = new a();

    /* renamed from: a, reason: collision with root package name */
    private final a f38570a;

    /* renamed from: b, reason: collision with root package name */
    private final d f38571b;

    /* renamed from: c, reason: collision with root package name */
    private final Y6.b f38572c;

    /* renamed from: d, reason: collision with root package name */
    private final ContentResolver f38573d;

    /* renamed from: e, reason: collision with root package name */
    private final List<ImageHeaderParser> f38574e;

    e(List<ImageHeaderParser> list, d dVar, Y6.b bVar, ContentResolver contentResolver) {
        this(list, f38569f, dVar, bVar, contentResolver);
    }

    e(List<ImageHeaderParser> list, a aVar, d dVar, Y6.b bVar, ContentResolver contentResolver) {
        this.f38570a = aVar;
        this.f38571b = dVar;
        this.f38572c = bVar;
        this.f38573d = contentResolver;
        this.f38574e = list;
    }
    ...
    */
    private java.lang.String b(android.net.Uri r7) throws java.lang.Throwable {
        /*
            ...
            r1 = 0
            W6.d r2 = r6.f38571b     // Catch: java.lang.Throwable -> L25 java.lang.SecurityException -> L27
        ...
        L4f:
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: W6.e.b(android.net.Uri):java.lang.String");
    }

    private boolean c(File file) {
        return this.f38570a.a(file) && 0 < this.f38570a.c(file);
    }
    ...
    int a(Uri uri) throws IOException {
        ...
        try {
            try {
                inputStreamOpenInputStream = this.f38573d.openInputStream(uri);
                int iB = com.bumptech.glide.load.a.b(this.f38574e, inputStreamOpenInputStream, this.f38572c);
    ...
    public InputStream d(Uri uri) throws Throwable {
        ...
        File fileB = this.f38570a.b(strB);
        if (!c(fileB)) {
            return null;
        }
        Uri uriFromFile = Uri.fromFile(fileB);
        try {
            return this.f38573d.openInputStream(uriFromFile);
