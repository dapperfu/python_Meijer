...
public final class C13946p {
    public static final SubscriptionProductRequestJson a(SubscriptionProductRequest subscriptionProductRequest) {
        ...
        StoreInfoRequestJson storeInfoRequestJsonA = C13943m.a(subscriptionProductRequest.getStoreInfo());
        ProductInfoRequestJson productInfoRequestJsonA = C13941k.a(subscriptionProductRequest.getProductInfo());
        PaymentInfoRequestJson paymentInfoRequestJsonA = C13937g.a(subscriptionProductRequest.getPaymentInfo());
        CustomerDeliveryAddressRequestJson customerDeliveryAddressRequestJsonA = C13933c.a(subscriptionProductRequest.getCustomerDeliveryAddress());
        CustomerNameRequest customerName = subscriptionProductRequest.getCustomerName();
        CustomerNameRequestJson customerNameRequestJsonA = customerName != null ? C13935e.a(customerName) : null;
        ContactInfoRequest contactInfo = subscriptionProductRequest.getContactInfo();
        return new SubscriptionProductRequestJson(name, baseSite, deliveryFrequency, deliveryFrequencyUnit, fulfillmentPartner, fulfillmentType, storeInfoRequestJsonA, productInfoRequestJsonA, paymentInfoRequestJsonA, customerDeliveryAddressRequestJsonA, customerNameRequestJsonA, contactInfo != null ? C13931a.a(contactInfo) : null, C13939i.a(subscriptionProductRequest.getPreferredTimeslot()));
    }
}
