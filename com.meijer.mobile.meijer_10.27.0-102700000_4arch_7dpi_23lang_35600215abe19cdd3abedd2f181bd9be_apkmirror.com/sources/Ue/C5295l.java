...
public final class C5295l extends AbstractC11327x<C5295l, b> implements S {
    private static final C5295l DEFAULT_INSTANCE;
    public static final int KEY_VALUE_FIELD_NUMBER = 3;
    private static volatile Z<C5295l> PARSER = null;
    public static final int VERSION_FIELD_NUMBER = 1;
    private AbstractC11312h keyValue_ = AbstractC11312h.f88342b;
    private int version_;

    /* renamed from: Ue.l$b */
    public static final class b extends AbstractC11327x.a<C5295l, b> implements S {
        /* synthetic */ b(a aVar) {
            this();
        }

        private b() {
            super(C5295l.DEFAULT_INSTANCE);
        }
        ...
        public b x(AbstractC11312h abstractC11312h) {
            p();
            ((C5295l) this.f88571b).e0(abstractC11312h);
            return this;
        }
    }
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f35955a[AbstractC11327x.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f35955a[AbstractC11327x.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f35955a[AbstractC11327x.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f35955a[AbstractC11327x.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f35955a[AbstractC11327x.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f35955a[AbstractC11327x.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    static {
        C5295l c5295l = new C5295l();
        DEFAULT_INSTANCE = c5295l;
        AbstractC11327x.U(C5295l.class, c5295l);
    }
    ...
    public static C5295l c0(AbstractC11312h abstractC11312h, C11319o c11319o) throws InvalidProtocolBufferException {
        return (C5295l) AbstractC11327x.O(DEFAULT_INSTANCE, abstractC11312h, c11319o);
    }

    public static Z<C5295l> d0() {
