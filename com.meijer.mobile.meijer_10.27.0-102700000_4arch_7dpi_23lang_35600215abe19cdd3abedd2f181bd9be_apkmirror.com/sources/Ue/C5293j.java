...
public final class C5293j extends AbstractC11327x<C5293j, b> implements S {
    private static final C5293j DEFAULT_INSTANCE;
    public static final int KEY_SIZE_FIELD_NUMBER = 2;
    public static final int PARAMS_FIELD_NUMBER = 1;
    private static volatile Z<C5293j> PARSER;
    private int bitField0_;
    private int keySize_;
    private C5294k params_;

    /* renamed from: Ue.j$b */
    public static final class b extends AbstractC11327x.a<C5293j, b> implements S {
        /* synthetic */ b(a aVar) {
            this();
        }

        private b() {
            super(C5293j.DEFAULT_INSTANCE);
        }
        ...
        public b x(int i10) {
            p();
            ((C5293j) this.f88571b).e0(i10);
            return this;
        }

        public b y(C5294k c5294k) {
            p();
            ((C5293j) this.f88571b).f0(c5294k);
            return this;
        }
    }
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f35953a[AbstractC11327x.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f35953a[AbstractC11327x.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f35953a[AbstractC11327x.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f35953a[AbstractC11327x.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f35953a[AbstractC11327x.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f35953a[AbstractC11327x.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    static {
        C5293j c5293j = new C5293j();
        DEFAULT_INSTANCE = c5293j;
        AbstractC11327x.U(C5293j.class, c5293j);
    }
    ...
    public static C5293j d0(AbstractC11312h abstractC11312h, C11319o c11319o) throws InvalidProtocolBufferException {
        return (C5293j) AbstractC11327x.O(DEFAULT_INSTANCE, abstractC11312h, c11319o);
    }
