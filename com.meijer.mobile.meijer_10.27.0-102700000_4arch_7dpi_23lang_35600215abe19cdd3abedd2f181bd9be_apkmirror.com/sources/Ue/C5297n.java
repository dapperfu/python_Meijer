...
public final class C5297n extends AbstractC11327x<C5297n, b> implements S {
    private static final C5297n DEFAULT_INSTANCE;
    public static final int KEY_VALUE_FIELD_NUMBER = 3;
    private static volatile Z<C5297n> PARSER = null;
    public static final int VERSION_FIELD_NUMBER = 1;
    private AbstractC11312h keyValue_ = AbstractC11312h.f88342b;
    private int version_;

    /* renamed from: Ue.n$b */
    public static final class b extends AbstractC11327x.a<C5297n, b> implements S {
        /* synthetic */ b(a aVar) {
            this();
        }

        private b() {
            super(C5297n.DEFAULT_INSTANCE);
        }
        ...
        public b x(AbstractC11312h abstractC11312h) {
            p();
            ((C5297n) this.f88571b).e0(abstractC11312h);
            return this;
        }
    }
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f35957a[AbstractC11327x.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f35957a[AbstractC11327x.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f35957a[AbstractC11327x.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f35957a[AbstractC11327x.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f35957a[AbstractC11327x.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f35957a[AbstractC11327x.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    static {
        C5297n c5297n = new C5297n();
        DEFAULT_INSTANCE = c5297n;
        AbstractC11327x.U(C5297n.class, c5297n);
    }
    ...
    public static C5297n c0(AbstractC11312h abstractC11312h, C11319o c11319o) throws InvalidProtocolBufferException {
        return (C5297n) AbstractC11327x.O(DEFAULT_INSTANCE, abstractC11312h, c11319o);
    }

    public static Z<C5297n> d0() {
