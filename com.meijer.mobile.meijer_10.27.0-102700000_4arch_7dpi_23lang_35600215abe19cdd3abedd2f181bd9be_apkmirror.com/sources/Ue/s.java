...
public final class s extends AbstractC11327x<s, b> implements S {
    private static final s DEFAULT_INSTANCE;
    private static volatile Z<s> PARSER;

    public static final class b extends AbstractC11327x.a<s, b> implements S {
        /* synthetic */ b(a aVar) {
            this();
        }
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f35962a[AbstractC11327x.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f35962a[AbstractC11327x.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f35962a[AbstractC11327x.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f35962a[AbstractC11327x.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f35962a[AbstractC11327x.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f35962a[AbstractC11327x.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    static {
        ...
        AbstractC11327x.U(s.class, sVar);
    }
    ...
    public static s Z(AbstractC11312h abstractC11312h, C11319o c11319o) throws InvalidProtocolBufferException {
        return (s) AbstractC11327x.O(DEFAULT_INSTANCE, abstractC11312h, c11319o);
    }
    ...
    protected final Object z(AbstractC11327x.f fVar, Object obj, Object obj2) {
        Z bVar;
        a aVar = null;
        switch (a.f35962a[fVar.ordinal()]) {
            case 1:
                return new s();
            case 2:
                return new b(aVar);
            case 3:
                return AbstractC11327x.M(DEFAULT_INSTANCE, "\u0000\u0000", null);
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                Z<s> z10 = PARSER;
