...
public final class C5291h extends AbstractC11327x<C5291h, b> implements S {
    private static final C5291h DEFAULT_INSTANCE;
    public static final int IV_SIZE_FIELD_NUMBER = 1;
    private static volatile Z<C5291h> PARSER;
    private int ivSize_;

    /* renamed from: Ue.h$b */
    public static final class b extends AbstractC11327x.a<C5291h, b> implements S {
        /* synthetic */ b(a aVar) {
            this();
        }

        private b() {
            super(C5291h.DEFAULT_INSTANCE);
        }
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f35951a[AbstractC11327x.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f35951a[AbstractC11327x.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f35951a[AbstractC11327x.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f35951a[AbstractC11327x.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f35951a[AbstractC11327x.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f35951a[AbstractC11327x.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    static {
        C5291h c5291h = new C5291h();
        DEFAULT_INSTANCE = c5291h;
        AbstractC11327x.U(C5291h.class, c5291h);
    }

    public static C5291h Z() {
