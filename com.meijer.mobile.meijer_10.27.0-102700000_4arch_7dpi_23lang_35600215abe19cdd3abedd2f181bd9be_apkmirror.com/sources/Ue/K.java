...
public final class K extends AbstractC11327x<K, b> implements S {
    ...
    public static final class b extends AbstractC11327x.a<K, b> implements S {
        /* synthetic */ b(a aVar) {
            this();
        }
        ...
        public b x(AbstractC11312h abstractC11312h) {
            p();
            ((K) this.f88571b).f0(abstractC11312h);
            return this;
        }

        public b y(M m10) {
            p();
            ((K) this.f88571b).g0(m10);
            return this;
        }
    }
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f35939a[AbstractC11327x.f.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f35939a[AbstractC11327x.f.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f35939a[AbstractC11327x.f.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f35939a[AbstractC11327x.f.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f35939a[AbstractC11327x.f.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f35939a[AbstractC11327x.f.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static K e0(AbstractC11312h abstractC11312h, C11319o c11319o) throws InvalidProtocolBufferException {
        return (K) AbstractC11327x.O(DEFAULT_INSTANCE, abstractC11312h, c11319o);
    }
