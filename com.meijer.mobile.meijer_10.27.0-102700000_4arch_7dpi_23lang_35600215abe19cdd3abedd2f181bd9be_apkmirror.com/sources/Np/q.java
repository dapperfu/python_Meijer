...
@Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0006\u001aG\u0010\b\u001a\u00020\u0004*\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00012\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00040\u00032\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00040\u00032\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003H\u0001¢\u0006\u0004\b\b\u0010\t¨\u0006\n"}, d2 = {"LJi/M;", "Landroidx/compose/ui/Modifier;", "modifier", "Lkotlin/Function0;", "", "onCancelClicked", "onDiscardClicked", "onSaveClicked", "b", "(LJi/M;Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;Landroidx/compose/runtime/Composer;II)V", "ux_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class q {
    ...
    static final class a implements Function3<R0, Composer, Integer, Unit> {
        ...
        final /* synthetic */ LocalThemeScope f22627a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Modifier f22628b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f22629c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f22630d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f22631e;

        @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
        @SourceDebugExtension
        /* renamed from: Np.q$a$a, reason: collision with other inner class name */
        static final class C0369a implements Function2<Composer, Integer, Unit> {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ Modifier f22632a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ LocalThemeScope f22633b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ Function0<Unit> f22634c;

            /* renamed from: d, reason: collision with root package name */
            final /* synthetic */ Function0<Unit> f22635d;

            /* renamed from: e, reason: collision with root package name */
            final /* synthetic */ Function0<Unit> f22636e;

            C0369a(Modifier modifier, LocalThemeScope localThemeScope, Function0<Unit> function0, Function0<Unit> function02, Function0<Unit> function03) {
                this.f22632a = modifier;
                this.f22633b = localThemeScope;
                this.f22634c = function0;
                this.f22635d = function02;
                this.f22636e = function03;
            }
            ...
            public final void a(Composer composer, int i10) {
                ...
                Modifier modifierI = D.i(this.f22632a, this.f22633b.getAdsSpacing().getSix().getDp());
                e.Companion companion = P0.e.INSTANCE;
                e.b bVarK = companion.k();
                LocalThemeScope localThemeScope = this.f22633b;
                Function0<Unit> function0 = this.f22634c;
                Function0<Unit> function02 = this.f22635d;
                Function0<Unit> function03 = this.f22636e;
                ...
                String strC = C16193g.c(Mp.j.f21199i, composer, 0);
                int i11 = LocalThemeScope.f15770g;
                int i12 = q1.Label.f140080j;
                ri.j.h(localThemeScope, label, strC, null, composer, i11 | (i12 << 3), 4);
                Modifier.Companion companion3 = Modifier.INSTANCE;
                C14802K.a(J.i(companion3, localThemeScope.getAdsSpacing().getFour().getDp()), composer, 0);
                ri.j.h(localThemeScope, new q1.Label(null, localThemeScope.getAdsColors().getAdsColorText02(), null, null, 0, false, 0, localThemeScope.getAdsTypography().getBody().getOne(), null, 381, null), C16193g.c(Mp.j.f21198h, composer, 0), null, composer, i11 | (i12 << 3), 4);
                ...
                String strC2 = C16193g.c(Mp.j.f21192b, composer, 0);
                Locale locale = Locale.ROOT;
                String upperCase = strC2.toUpperCase(locale);
                Intrinsics.i(upperCase, "toUpperCase(...)");
                int i13 = C15874z0.f151827b;
                P0.k(localThemeScope, c15874z0, upperCase, function0, null, null, false, 0L, false, composer, i11 | (i13 << 3), 248);
                C14802K.a(InterfaceC14800I.b(c14801j, companion3, 1.0f, false, 2, null), composer, 0);
                String upperCase2 = C16193g.c(Mp.j.f21194d, composer, 0).toUpperCase(locale);
                Intrinsics.i(upperCase2, "toUpperCase(...)");
                P0.k(localThemeScope, c15874z0, upperCase2, function02, null, null, false, 0L, false, composer, i11 | (i13 << 3), 248);
                C14802K.a(J.z(companion3, localThemeScope.getAdsSpacing().getThree().getDp()), composer, 0);
                String upperCase3 = C16193g.c(Mp.j.f21201k, composer, 0).toUpperCase(locale);
                Intrinsics.i(upperCase3, "toUpperCase(...)");
                P0.k(localThemeScope, c15874z0, upperCase3, function03, null, null, false, 0L, false, composer, i11 | (i13 << 3), 248);
                composer.v();
                composer.v();
                if (ComposerKt.M()) {
                    ComposerKt.T();
        ...
        a(LocalThemeScope localThemeScope, Modifier modifier, Function0<Unit> function0, Function0<Unit> function02, Function0<Unit> function03) {
            this.f22627a = localThemeScope;
            this.f22628b = modifier;
            this.f22629c = function0;
            this.f22630d = function02;
            this.f22631e = function03;
        }
        ...
        public final void b(R0 Assemble, Composer composer, int i10) {
            ...
            LocalThemeScope localThemeScope = this.f22627a;
            ...
            composer.P();
            C16977b.b(localThemeScope, modalTemplateP, (Function0) objB, null, ComposableLambdaKt.c(2071478937, true, new C0369a(this.f22628b, this.f22627a, this.f22629c, this.f22630d, this.f22631e), composer, 54), composer, LocalThemeScope.f15770g | 24960 | (q1.ModalTemplate.f140108d << 3), 4);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final void b(final LocalThemeScope localThemeScope, Modifier modifier, final Function0<Unit> onCancelClicked, final Function0<Unit> onDiscardClicked, final Function0<Unit> onSaveClicked, Composer composer, final int i10, final int i11) {
        ...
        if ((i14 & 9363) == 9362 && composerStartRestartGroup.j()) {
            ...
            Q.e(localThemeScope, C14924a0.f139754a, ComposableLambdaKt.c(1863136934, true, new a(localThemeScope, modifier2, onCancelClicked, onDiscardClicked, onSaveClicked), composerStartRestartGroup, 54), composerStartRestartGroup, LocalThemeScope.f15770g | 384 | (i14 & 14) | (C14924a0.f139755b << 3));
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
