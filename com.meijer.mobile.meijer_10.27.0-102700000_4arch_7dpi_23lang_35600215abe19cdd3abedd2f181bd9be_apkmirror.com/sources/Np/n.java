...
@Metadata(d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\b\n\u0002\u0010\u000b\n\u0002\b\u0002\u001aA\u0010\u000b\u001a\u00020\t*\u00020\u00002\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00020\u00012\u0006\u0010\u0005\u001a\u00020\u00042\b\b\u0002\u0010\u0007\u001a\u00020\u00062\f\u0010\n\u001a\b\u0012\u0004\u0012\u00020\t0\bH\u0001¢\u0006\u0004\b\u000b\u0010\f\u001a%\u0010\u000e\u001a\u00020\t*\u00020\u00002\u0006\u0010\r\u001a\u00020\u00022\b\b\u0002\u0010\u0007\u001a\u00020\u0006H\u0001¢\u0006\u0004\b\u000e\u0010\u000f¨\u0006\u0014²\u0006\u000e\u0010\u0010\u001a\u00020\u00048\n@\nX\u008a\u008e\u0002²\u0006\u0014\u0010\u0011\u001a\b\u0012\u0004\u0012\u00020\u00020\u00018\n@\nX\u008a\u008e\u0002²\u0006\u000e\u0010\u0013\u001a\u00020\u00128\n@\nX\u008a\u008e\u0002"}, d2 = {"LJi/M;", "", "LMp/h;", "productList", "", "headerLabel", "Landroidx/compose/ui/Modifier;", "modifier", "Lkotlin/Function0;", "", "onDoneClicked", "d", "(LJi/M;Ljava/util/List;Ljava/lang/String;Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function0;Landroidx/compose/runtime/Composer;II)V", "product", "g", "(LJi/M;LMp/h;Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;II)V", "lastAction", "items", "", "noProductQuantity", "ux_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class n {
    ...
    static final class a implements Function4<InterfaceC15343c, Integer, Composer, Integer, Unit> {
        ...
        final /* synthetic */ LocalThemeScope f22612a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ String f22613b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f22614c;

        a(LocalThemeScope localThemeScope, String str, Function0<Unit> function0) {
            this.f22612a = localThemeScope;
            this.f22613b = str;
            this.f22614c = function0;
        }
        ...
        public final void a(InterfaceC15343c stickyHeader, int i10, Composer composer, int i11) {
            ...
            Modifier modifierD = androidx.compose.foundation.b.d(J.k(companion, H1.h.p(56), 0.0f, 2, null), this.f22612a.getAdsColors().getAdsColorBrandPrimary().getColor(), null, 2, null);
            e.c cVarI = P0.e.INSTANCE.i();
            LocalThemeScope localThemeScope = this.f22612a;
            String str = this.f22613b;
            Function0<Unit> function0 = this.f22614c;
            ...
            ri.j.h(localThemeScope, label, str, null, composer, i12 | (q1.Label.f140080j << 3), 4);
            C14802K.a(InterfaceC14800I.b(c14801j, companion, 1.0f, false, 2, null), composer, 0);
            C15862t0 c15862t0 = C15862t0.f151797a;
            String upperCase = C16193g.c(Mp.j.f21196f, composer, 0).toUpperCase(Locale.ROOT);
            Intrinsics.i(upperCase, "toUpperCase(...)");
            P0.k(localThemeScope, c15862t0, upperCase, function0, null, null, false, 0L, false, composer, (C15862t0.f151798b << 3) | i12, 248);
            C14802K.a(J.z(companion, localThemeScope.getAdsSpacing().getThree().getDp()), composer, 0);
            composer.v();
            if (ComposerKt.M()) {
                ComposerKt.T();
    ...
    public static final class b extends Lambda implements Function1 {
        ...
        public static final b f22615f = new b();
    ...
    public static final class c extends Lambda implements Function1<Integer, Object> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function1 f22616f;
        ...
        public c(Function1 function1, List list) {
            super(1);
            this.f22616f = function1;
            this.f22617g = list;
        }

        public final Object a(int i10) {
            return this.f22616f.invoke(this.f22617g.get(i10));
        }
    ...
    public static final class d extends Lambda implements Function4<InterfaceC15343c, Integer, Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ List f22618f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f22619g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(List list, LocalThemeScope localThemeScope) {
            super(4);
            this.f22618f = list;
            this.f22619g = localThemeScope;
        }
        ...
        public final void a(InterfaceC15343c interfaceC15343c, int i10, Composer composer, int i11) {
            ...
            ProductScanItem productScanItem = (ProductScanItem) this.f22618f.get(i10);
            composer.startReplaceGroup(-329837339);
            n.g(this.f22619g, productScanItem, null, composer, LocalThemeScope.f15770g, 2);
            composer.P();
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
    ...
    */
    public static final void d(final Ji.LocalThemeScope r20, final java.util.List<Mp.ProductScanItem> r21, final java.lang.String r22, androidx.compose.ui.Modifier r23, final kotlin.jvm.functions.Function0<kotlin.Unit> r24, androidx.compose.runtime.Composer r25, final int r26, final int r27) {
        /*
            Method dump skipped, instructions count: 346
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: Np.n.d(Ji.M, java.util.List, java.lang.String, androidx.compose.ui.Modifier, kotlin.jvm.functions.Function0, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final Unit e(List list, LocalThemeScope localThemeScope, String str, Function0 function0, w LazyColumn) {
        ...
        LazyColumn.i(list.size(), null, new c(b.f22615f, list), ComposableLambdaKt.composableLambdaInstance(-632812321, true, new d(list, localThemeScope)));
        return Unit.f142422a;
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void g(final Ji.LocalThemeScope r30, final Mp.ProductScanItem r31, androidx.compose.ui.Modifier r32, androidx.compose.runtime.Composer r33, final int r34, final int r35) {
        /*
            Method dump skipped, instructions count: 824
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: Np.n.g(Ji.M, Mp.h, androidx.compose.ui.Modifier, androidx.compose.runtime.Composer, int, int):void");
    }
