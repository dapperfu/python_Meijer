...
public final class n0 extends Canvas {
    ...
    public boolean clipOutRect(RectF rect) {
        C17477s c17477s = C17477s.f164414a;
        Canvas canvas = this.nativeCanvas;
        if (canvas == null) {
            Intrinsics.y("nativeCanvas");
            canvas = null;
        }
        return c17477s.e(canvas, rect);
    }
    ...
    public void drawDoubleRoundRect(RectF outer, float outerRx, float outerRy, RectF inner, float innerRx, float innerRy, Paint paint) {
        C17484z c17484z = C17484z.f164415a;
        Canvas canvas = this.nativeCanvas;
        if (canvas == null) {
            Intrinsics.y("nativeCanvas");
            canvas = null;
        }
        c17484z.e(canvas, outer, outerRx, outerRy, inner, innerRx, innerRy, paint);
    }
    ...
    public void drawPatch(NinePatch patch, Rect dst, Paint paint) {
        C17454H c17454h = C17454H.f164324a;
        Canvas canvas = this.nativeCanvas;
        if (canvas == null) {
            Intrinsics.y("nativeCanvas");
            canvas = null;
        }
        c17454h.b(canvas, patch, dst, paint);
    }
    ...
    public void drawTextRun(char[] text, int index, int count, int contextIndex, int contextCount, float x10, float y10, boolean isRtl, Paint paint) {
        C17472m c17472m = C17472m.f164388a;
        Canvas canvas = this.nativeCanvas;
        if (canvas == null) {
            Intrinsics.y("nativeCanvas");
            canvas = null;
        }
        c17472m.b(canvas, text, index, count, contextIndex, contextCount, x10, y10, isRtl, paint);
    }
    ...
    public void drawGlyphs(int[] glyphIds, int glyphIdOffset, float[] positions, int positionOffset, int glyphCount, Font font, Paint paint) {
        ...
        c17454h.a(canvas, glyphIds, glyphIdOffset, positions, positionOffset, glyphCount, font, paint);
    }
    ...
    public void drawPatch(NinePatch patch, RectF dst, Paint paint) {
        ...
        c17454h.c(canvas, patch, dst, paint);
    }
    ...
    public boolean quickReject(RectF rect) {
        C17450D c17450d = C17450D.f164323a;
        Canvas canvas = this.nativeCanvas;
        if (canvas == null) {
            Intrinsics.y("nativeCanvas");
            canvas = null;
        }
        return c17450d.c(canvas, rect);
    }
    ...
    public boolean clipOutRect(float left, float top, float right, float bottom) {
        ...
        return c17477s.b(canvas, left, top, right, bottom);
    }
    ...
    public boolean clipOutRect(int left, int top, int right, int bottom) {
        ...
        return c17477s.c(canvas, left, top, right, bottom);
    }
    ...
    public void drawDoubleRoundRect(RectF outer, float[] outerRadii, RectF inner, float[] innerRadii, Paint paint) {
        ...
        c17484z.f(canvas, outer, outerRadii, inner, innerRadii, paint);
    }
    ...
    public void drawTextRun(CharSequence text, int start, int end, int contextStart, int contextEnd, float x10, float y10, boolean isRtl, Paint paint) {
        ...
        c17472m.a(canvas, text, start, end, contextStart, contextEnd, x10, y10, isRtl, paint);
    }
    ...
    public boolean quickReject(float left, float top, float right, float bottom) {
        ...
        return c17450d.a(canvas, left, top, right, bottom);
    }
    ...
    public void drawTextRun(MeasuredText text, int start, int end, int contextStart, int contextEnd, float x10, float y10, boolean isRtl, Paint paint) {
        ...
        c17484z.h(canvas, text, start, end, contextStart, contextEnd, x10, y10, isRtl, paint);
    }
}
