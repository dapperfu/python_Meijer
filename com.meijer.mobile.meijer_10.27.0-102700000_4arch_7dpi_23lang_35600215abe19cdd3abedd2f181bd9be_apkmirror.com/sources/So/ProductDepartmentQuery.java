...
public final /* data */ class ProductDepartmentQuery implements InterfaceC18171E<Data> {
    ...
    public ProductDepartmentQuery(String groupId, int i10, int i11, String after, AbstractC18169C<? extends List<ProductFilterInput>> filters, AbstractC18169C<ProductSortInput> sort, ProductQueryContextInput context) {
        Intrinsics.j(groupId, "groupId");
    ...
    public InterfaceC18173a<Data> a() {
        return C18174b.d(N.f35156a, false, 1, null);
    }
    ...
    public void d(C6.g writer, p customScalarAdapters, boolean withDefaultValues) throws IOException {
        ...
        C5247d0.f35201a.a(writer, this, customScalarAdapters, withDefaultValues);
    }
