...
public final class a {
    ...
    public static final String a(l lVar) {
        ...
        Map<FilterFacet, List<FilterFacetOption>> mapG3 = ((l.k) lVar).G3();
        if (mapG3 != null) {
            if (!c(mapG3)) {
                return null;
            }
            int i10 = 0;
            for (Object obj : mapG3.entrySet()) {
                int i11 = i10 + 1;
                if (i10 < 0) {
                    CollectionsKt.w();
                }
                ...
                for (Object obj2 : (Iterable) entry.getValue()) {
                    ...
                    if (Intrinsics.e(lowerCase, "price")) {
                        ...
                        if (value != null && StringsKt.c0(value, "-inf-5", false, 2, null)) {
                            value = "0-5";
                        }
                    }
                    sb3.append(value);
                    if (C18063a.a((List) entry.getValue(), i12)) {
                        sb3.append(",");
                    }
                    i12 = i13;
                }
                sb2.append('(' + b(((FilterFacet) entry.getKey()).getDisplayName()) + ",in," + ((Object) sb3) + ')');
                if (C18063a.b(mapG3, i10)) {
                    sb2.append(",");
                }
                i10 = i11;
            }
