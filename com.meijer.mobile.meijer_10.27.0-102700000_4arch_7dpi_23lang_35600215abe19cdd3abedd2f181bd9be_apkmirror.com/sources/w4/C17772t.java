...
public final class C17772t {
    ...
    public static final class a<T> implements Comparator {
        ...
        public final int compare(T t10, T t11) {
            return ComparisonsKt.d(((C17771s.a) t10).name, ((C17771s.a) t11).name);
        }
    }
    ...
    public static final class b<T> implements Comparator {
        ...
        @Override // java.util.Comparator
        public final int compare(T t10, T t11) {
            return ComparisonsKt.d(((C17771s.d) t10).name, ((C17771s.d) t11).name);
        }
    }
    ...
    public static final boolean b(String current, String str) {
        ...
        return Intrinsics.e(StringsKt.y1(strSubstring).toString(), str);
    }

    public static final boolean c(C17771s.a aVar, Object obj) {
        Intrinsics.j(aVar, "<this>");
        if (aVar == obj) {
            return true;
        }
        if (!(obj instanceof C17771s.a)) {
            return false;
        }
        C17771s.a aVar2 = (C17771s.a) obj;
    ...
    public static final boolean d(C17771s.c cVar, Object obj) {
        Intrinsics.j(cVar, "<this>");
        if (cVar == obj) {
            return true;
        }
        if (!(obj instanceof C17771s.c)) {
            return false;
        }
        C17771s.c cVar2 = (C17771s.c) obj;
    ...
    public static final boolean e(C17771s.d dVar, Object obj) {
        Intrinsics.j(dVar, "<this>");
        if (dVar == obj) {
            return true;
        }
        if (!(obj instanceof C17771s.d)) {
            return false;
        }
        C17771s.d dVar2 = (C17771s.d) obj;
    ...
    public static final boolean f(C17771s c17771s, Object obj) {
        Set<C17771s.d> set;
        Intrinsics.j(c17771s, "<this>");
        if (c17771s == obj) {
            return true;
        }
        if (!(obj instanceof C17771s)) {
            return false;
        }
        C17771s c17771s2 = (C17771s) obj;
        if (!Intrinsics.e(c17771s.name, c17771s2.name) || !Intrinsics.e(c17771s.columns, c17771s2.columns) || !Intrinsics.e(c17771s.foreignKeys, c17771s2.foreignKeys)) {
            return false;
        }
        Set<C17771s.d> set2 = c17771s.indices;
        if (set2 == null || (set = c17771s2.indices) == null) {
            return true;
        }
    ...
    public static final int j(C17771s.d dVar) {
        Intrinsics.j(dVar, "<this>");
    ...
    public static final int k(C17771s c17771s) {
        Intrinsics.j(c17771s, "<this>");
        return (((c17771s.name.hashCode() * 31) + c17771s.columns.hashCode()) * 31) + c17771s.foreignKeys.hashCode();
    }

    public static final String n(C17771s.a aVar) {
        Intrinsics.j(aVar, "<this>");
    ...
    public static final String o(C17771s.c cVar) {
        Intrinsics.j(cVar, "<this>");
        StringBuilder sb2 = new StringBuilder();
        sb2.append("\n            |ForeignKey {\n            |   referenceTable = '");
    ...
    public static final String p(C17771s.d dVar) {
        Intrinsics.j(dVar, "<this>");
        StringBuilder sb2 = new StringBuilder();
        sb2.append("\n            |Index {\n            |   name = '");
    ...
    public static final String q(C17771s c17771s) {
        List listM;
        Intrinsics.j(c17771s, "<this>");
        StringBuilder sb2 = new StringBuilder();
        sb2.append("\n            |TableInfo {\n            |    name = '");
        sb2.append(c17771s.name);
        sb2.append("',\n            |    columns = {");
        sb2.append(g(CollectionsKt.Z0(c17771s.columns.values(), new a())));
        sb2.append("\n            |    foreignKeys = {");
        sb2.append(g(c17771s.foreignKeys));
        sb2.append("\n            |    indices = {");
        Set<C17771s.d> set = c17771s.indices;
