...
public final class C17771s {
    ...
    public static final class a {
        ...
        public boolean equals(Object other) {
            return C17772t.c(this, other);
        }

        public int hashCode() {
            return C17772t.h(this);
        }

        public String toString() {
            return C17772t.n(this);
        }
    }

    @Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u001f\u0010\t\u001a\u00020\b2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0006H\u0007¢\u0006\u0004\b\t\u0010\nJ\u001f\u0010\r\u001a\u00020\b2\u0006\u0010\f\u001a\u00020\u000b2\u0006\u0010\u0007\u001a\u00020\u0006H\u0007¢\u0006\u0004\b\r\u0010\u000eR\u0014\u0010\u0010\u001a\u00020\u000f8\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0010\u0010\u0011R\u0014\u0010\u0012\u001a\u00020\u000f8\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0012\u0010\u0011R\u0014\u0010\u0013\u001a\u00020\u000f8\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0013\u0010\u0011¨\u0006\u0014"}, d2 = {"Lw4/s$b;", "", "<init>", "()V", "LA4/c;", "database", "", "tableName", "Lw4/s;", "a", "(LA4/c;Ljava/lang/String;)Lw4/s;", "Lz4/b;", "connection", "b", "(Lz4/b;Ljava/lang/String;)Lw4/s;", "", "CREATED_FROM_UNKNOWN", "I", "CREATED_FROM_ENTITY", "CREATED_FROM_DATABASE", "room-runtime_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
    ...
    public static final class Companion {
        ...
        @Deprecated
        @JvmStatic
        public final C17771s a(A4.c database, String tableName) {
            Intrinsics.j(database, "database");
            Intrinsics.j(tableName, "tableName");
            return b(new C17059a(database), tableName);
        }

        @JvmStatic
        public final C17771s b(InterfaceC18380b connection, String tableName) {
            Intrinsics.j(connection, "connection");
            Intrinsics.j(tableName, "tableName");
            return C17769q.g(connection, tableName);
        }
    }
    ...
    public static final class c {
        ...
        public boolean equals(Object other) {
            return C17772t.d(this, other);
        }

        public int hashCode() {
            return C17772t.i(this);
        }

        public String toString() {
            return C17772t.o(this);
        }
    }
    ...
    public static final class d {
        ...
        public boolean equals(Object other) {
            return C17772t.e(this, other);
        }

        public int hashCode() {
            return C17772t.j(this);
        }

        public String toString() {
            return C17772t.p(this);
        }
    }

    @Deprecated
    @JvmStatic
    public static final C17771s a(A4.c cVar, String str) {
        return INSTANCE.a(cVar, str);
    }

    public C17771s(String name, Map<String, a> columns, Set<c> foreignKeys, Set<d> set) {
        Intrinsics.j(name, "name");
        Intrinsics.j(columns, "columns");
    ...
    public boolean equals(Object other) {
        return C17772t.f(this, other);
    }

    public int hashCode() {
        return C17772t.k(this);
    }

    public String toString() {
        return C17772t.q(this);
    }
}
