...
public final class C6174n {
    ...
    public static final /* data */ class FlingInfo {
        ...
        public final float a(long time) {
            ...
            return this.distance * Math.signum(this.initialVelocity) * C6162a.f59513a.b(j10 > 0 ? time / j10 : 1.0f).getDistanceCoefficient();
        }

        public final float b(long time) {
            long j10 = this.duration;
            return (((C6162a.f59513a.b(j10 > 0 ? time / j10 : 1.0f).getVelocityCoefficient() * Math.signum(this.initialVelocity)) * this.distance) / this.duration) * 1000.0f;
        }
    ...
    private final double e(float velocity) {
        return C6162a.f59513a.a(velocity, this.friction * this.magicPhysicalCoefficient);
    }

    public C6174n(float f10, H1.d dVar) {
        this.friction = f10;
        this.density = dVar;
    ...
    private final float a(H1.d density) {
        return C6175o.c(0.84f, density.getDensity());
    }

    public final float b(float velocity) {
        return (float) (this.friction * this.magicPhysicalCoefficient * Math.exp((C6175o.f59634a / (C6175o.f59634a - 1.0d)) * e(velocity)));
    }

    public final long c(float velocity) {
        return (long) (Math.exp(e(velocity) / (C6175o.f59634a - 1.0d)) * 1000.0d);
    }

    public final FlingInfo d(float velocity) {
        double dE = e(velocity);
        double d10 = C6175o.f59634a - 1.0d;
        return new FlingInfo(velocity, (float) (this.friction * this.magicPhysicalCoefficient * Math.exp((C6175o.f59634a / d10) * dE)), (long) (Math.exp(dE / d10) * 1000.0d));
    }
}
