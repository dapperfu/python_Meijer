...
public final class FontListFontFamily extends AbstractC18140j implements List<InterfaceC18141k>, KMappedMarker {

    /* renamed from: h, reason: collision with root package name and from kotlin metadata and from toString */
    private final List<InterfaceC18141k> fonts;

    /* JADX WARN: Multi-variable type inference failed */
    public FontListFontFamily(List<? extends InterfaceC18141k> list) {
        super(null);
        this.fonts = list;
        if (list.isEmpty()) {
    ...
    public /* bridge */ /* synthetic */ void add(int i10, InterfaceC18141k interfaceC18141k) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }

    @Override // java.util.List
    public boolean addAll(int i10, Collection<? extends InterfaceC18141k> collection) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    @Override // java.util.List
    public ListIterator<InterfaceC18141k> listIterator() {
        return this.fonts.listIterator();
    }

    @Override // java.util.List
    public /* bridge */ /* synthetic */ InterfaceC18141k remove(int i10) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    @Override // java.util.List, java.util.Collection
    public boolean addAll(Collection<? extends InterfaceC18141k> collection) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof InterfaceC18141k) {
            return o((InterfaceC18141k) obj);
        }
        return false;
    }
    ...
    public Iterator<InterfaceC18141k> iterator() {
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof InterfaceC18141k) {
            return t((InterfaceC18141k) obj);
        }
        return -1;
    }

    @Override // java.util.List
    public ListIterator<InterfaceC18141k> listIterator(int index) {
        return this.fonts.listIterator(index);
    }

    public boolean o(InterfaceC18141k element) {
        return this.fonts.contains(element);
    }

    @Override // java.util.List
    /* renamed from: p, reason: merged with bridge method [inline-methods] */
    public InterfaceC18141k get(int index) {
        return this.fonts.get(index);
    }

    public final List<InterfaceC18141k> q() {
        return this.fonts;
    }
    ...
    @Override // java.util.List
    public void replaceAll(UnaryOperator<InterfaceC18141k> unaryOperator) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public int s(InterfaceC18141k element) {
        return this.fonts.indexOf(element);
    }

    @Override // java.util.List
    public /* bridge */ /* synthetic */ InterfaceC18141k set(int i10, InterfaceC18141k interfaceC18141k) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }

    @Override // java.util.List
    public void sort(Comparator<? super InterfaceC18141k> comparator) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }

    @Override // java.util.List
    public List<InterfaceC18141k> subList(int fromIndex, int toIndex) {
        return this.fonts.subList(fromIndex, toIndex);
    }

    public int t(InterfaceC18141k element) {
