...
public final class C6304Q<T> implements InterfaceC6289B<T> {
    ...
    /* renamed from: c0.Q$a */
    public static final class a<T> extends AbstractC6303P<T> {

        /* renamed from: c, reason: collision with root package name and from kotlin metadata */
        private int arcMode;

        public /* synthetic */ a(Object obj, InterfaceC6290C interfaceC6290C, int i10, DefaultConstructorMarker defaultConstructorMarker) {
            this(obj, interfaceC6290C, i10);
        }
        ...
        public boolean equals(Object other) {
            ...
            a aVar = (a) other;
            return Intrinsics.e(aVar.b(), b()) && Intrinsics.e(aVar.getEasing(), getEasing()) && C6337t.c(aVar.arcMode, this.arcMode);
        }

        public /* synthetic */ a(Object obj, InterfaceC6290C interfaceC6290C, int i10, int i11, DefaultConstructorMarker defaultConstructorMarker) {
            this(obj, (i11 & 2) != 0 ? C6292E.d() : interfaceC6290C, (i11 & 4) != 0 ? C6337t.INSTANCE.a() : i10, null);
        }
        ...
        public int hashCode() {
            ...
            return (((iHashCode * 31) + C6337t.d(this.arcMode)) * 31) + getEasing().hashCode();
        }

        private a(T t10, InterfaceC6290C interfaceC6290C, int i10) {
            super(t10, interfaceC6290C, null);
            this.arcMode = i10;
        }
    }
    ...
    @SourceDebugExtension
    /* renamed from: c0.Q$b */
    public static final class b<T> extends AbstractC6305S<T, a<T>> {
        public b() {
            super(null);
        }
    ...
    public <V extends AbstractC6334q> A0<V> a(o0<T, V> converter) {
        long[] jArr;
        int[] iArr;
        long[] jArr2;
        int[] iArr2;
        ...
        j10.q();
        return new A0<>(j10, k10, this.config.getDurationMillis(), this.config.getDelayMillis(), C6292E.d(), C6337t.INSTANCE.a(), null);
    }

    public C6304Q(b<T> bVar) {
        this.config = bVar;
    }
}
