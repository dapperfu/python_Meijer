...
public class IntrinsicsKt__IntrinsicsJvmKt {
    ...
    public static <R, T> Continuation<Unit> a(final Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, final R r10, Continuation<? super T> completion) {
        ...
        final CoroutineContext context = continuationA.getF142363a();
        return context == EmptyCoroutineContext.f142646a ? new RestrictedContinuationImpl(continuationA, function2, r10) { // from class: kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnintercepted$$inlined$createCoroutineFromSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt$3

            /* renamed from: a, reason: collision with root package name and from kotlin metadata */
            private int label;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ Function2 f142660b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ Object f142661c;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(continuationA);
                this.f142660b = function2;
                this.f142661c = r10;
            ...
            protected Object invokeSuspend(Object result) {
                ...
                if (i10 == 0) {
                    this.label = 1;
                    ResultKt.b(result);
                    Intrinsics.h(this.f142660b, "null cannot be cast to non-null type kotlin.Function2<R of kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnintercepted, kotlin.coroutines.Continuation<T of kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnintercepted>, kotlin.Any?>");
                    return ((Function2) TypeIntrinsics.f(this.f142660b, 2)).invoke(this.f142661c, this);
                }
                if (i10 != 1) {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ Function2 f142663b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ Object f142664c;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(continuationA, context);
                this.f142663b = function2;
                this.f142664c = r10;
                Intrinsics.h(continuationA, "null cannot be cast to non-null type kotlin.coroutines.Continuation<kotlin.Any?>");
            }
            ...
            protected Object invokeSuspend(Object result) {
                ...
                if (i10 == 0) {
                    this.label = 1;
                    ResultKt.b(result);
                    Intrinsics.h(this.f142663b, "null cannot be cast to non-null type kotlin.Function2<R of kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnintercepted, kotlin.coroutines.Continuation<T of kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnintercepted>, kotlin.Any?>");
                    return ((Function2) TypeIntrinsics.f(this.f142663b, 2)).invoke(this.f142664c, this);
                }
                if (i10 != 1) {
                    throw new IllegalStateException("This coroutine had already completed");
                }
    ...
    private static final <T> Continuation<T> b(final Continuation<? super T> continuation) {
        final CoroutineContext context = continuation.getF142363a();
        if (context == EmptyCoroutineContext.f142646a) {
