...
public interface CoroutineContext {
    ...
    public static final class DefaultImpls {
        public static CoroutineContext b(CoroutineContext coroutineContext, CoroutineContext context) {
            ...
            return context == EmptyCoroutineContext.f142646a ? coroutineContext : (CoroutineContext) context.b(coroutineContext, new Function2() { // from class: lv.b
        ...
        public static CoroutineContext c(CoroutineContext acc, Element element) {
            ...
            CoroutineContext coroutineContextF0 = acc.F0(element.getKey());
            EmptyCoroutineContext emptyCoroutineContext = EmptyCoroutineContext.f142646a;
            if (coroutineContextF0 == emptyCoroutineContext) {
                return element;
            }
            ContinuationInterceptor.Companion key = ContinuationInterceptor.INSTANCE;
            ContinuationInterceptor continuationInterceptor = (ContinuationInterceptor) coroutineContextF0.g(key);
            if (continuationInterceptor == null) {
                return new CombinedContext(coroutineContextF0, element);
            }
            CoroutineContext coroutineContextF02 = coroutineContextF0.F0(key);
            return coroutineContextF02 == emptyCoroutineContext ? new CombinedContext(element, continuationInterceptor) : new CombinedContext(new CombinedContext(coroutineContextF02, element), continuationInterceptor);
        }
    }
    ...
    public interface Element extends CoroutineContext {
        ...
        public static final class DefaultImpls {
            ...
            public static CoroutineContext c(Element element, Key<?> key) {
                Intrinsics.j(key, "key");
                return Intrinsics.e(element.getKey(), key) ? EmptyCoroutineContext.f142646a : element;
            }
    ...
    CoroutineContext m0(CoroutineContext context);
}
