...
public final class CombinedContext implements CoroutineContext, Serializable {
    ...
    public CoroutineContext F0(CoroutineContext.Key<?> key) {
        ...
        CoroutineContext coroutineContextF0 = this.left.F0(key);
        return coroutineContextF0 == this.left ? this : coroutineContextF0 == EmptyCoroutineContext.f142646a ? this.element : new CombinedContext(coroutineContextF0, this.element);
    }
    ...
    public String toString() {
        return '[' + ((String) b("", new Function2() { // from class: lv.a
