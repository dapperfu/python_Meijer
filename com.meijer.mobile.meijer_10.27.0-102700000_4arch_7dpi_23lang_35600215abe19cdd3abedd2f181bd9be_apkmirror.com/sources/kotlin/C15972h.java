...
public final class C15972h {
    public static final InterfaceC15751k a(AbstractC15962C abstractC15962C, int i10, Composer composer, int i11) {
        boolean z10;
        if (ComposerKt.M()) {
        ...
        boolean z11 = false;
        if ((((i11 & 14) ^ 6) > 4 && composer.V(abstractC15962C)) || (i11 & 6) == 4) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (z12 || objB == Composer.INSTANCE.a()) {
            objB = new C15973i(abstractC15962C, i10);
            composer.t(objB);
        }
        C15973i c15973i = (C15973i) objB;
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        return c15973i;
