...
public final class C15738Y {

    /* renamed from: a, reason: collision with root package name */
    private static final a f150867a;

    @Metadata(d1 = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0017\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, d2 = {"n0/Y$a", "Ln0/X;", "Ln0/V;", "prefetchRequest", "", "a", "(Ln0/V;)V", "foundation_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    /* renamed from: n0.Y$a */
    public static final class a implements InterfaceC15737X {
    ...
    static {
        ...
        f150867a = Intrinsics.e(lowerCase, "robolectric") ? new a() : null;
    }

    public static final InterfaceC15737X a(Composer composer, int i10) {
        if (ComposerKt.M()) {
        ...
        InterfaceC15737X interfaceC15737X = f150867a;
        if (interfaceC15737X != null) {
            ...
            if (zV || objB == Composer.INSTANCE.a()) {
                objB = new RunnableC15740a(view);
                composer.t(objB);
            }
            interfaceC15737X = (RunnableC15740a) objB;
            composer.P();
        }
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        return interfaceC15737X;
    }
}
