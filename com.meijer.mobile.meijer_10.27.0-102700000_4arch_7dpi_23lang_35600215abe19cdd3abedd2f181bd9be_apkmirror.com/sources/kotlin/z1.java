...
public final class z1 {
    ...
    private static final float f168905a;

    /* renamed from: b, reason: collision with root package name */
    private static final float f168906b;

    /* renamed from: c, reason: collision with root package name */
    private static final float f168907c;

    /* renamed from: d, reason: collision with root package name */
    private static final float f168908d;

    /* renamed from: e, reason: collision with root package name */
    private static final float f168909e;

    /* renamed from: f, reason: collision with root package name */
    private static final float f168910f;

    /* renamed from: g, reason: collision with root package name */
    private static final float f168911g;

    /* renamed from: h, reason: collision with root package name */
    private static final float f168912h;

    /* renamed from: i, reason: collision with root package name */
    private static final n0<Float> f168913i;

    /* renamed from: j, reason: collision with root package name */
    private static final float f168914j;

    /* renamed from: k, reason: collision with root package name */
    private static final float f168915k;

    /* renamed from: l, reason: collision with root package name */
    private static final float f168916l;
    ...
    static final class a extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ C17931e<Boolean> f168918b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ androidx.compose.runtime.z1<Boolean> f168919c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ androidx.compose.runtime.z1<Function1<Boolean, Unit>> f168920d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ InterfaceC5730l0<Boolean> f168921e;

        @Metadata(d1 = {"\u0000\b\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0001\u001a\u00020\u0000H\n¢\u0006\u0004\b\u0001\u0010\u0002"}, d2 = {"", "c", "()Ljava/lang/Boolean;"}, k = 3, mv = {1, 9, 0})
        /* renamed from: x0.z1$a$a, reason: collision with other inner class name */
        static final class C2702a extends Lambda implements Function0<Boolean> {

            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ C17931e<Boolean> f168922f;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C2702a(C17931e<Boolean> c17931e) {
                super(0);
                this.f168922f = c17931e;
            }

            @Override // kotlin.jvm.functions.Function0
            /* renamed from: c, reason: merged with bridge method [inline-methods] */
            public final Boolean invoke() {
                return this.f168922f.s();
            }
        }
        ...
        static final class b extends SuspendLambda implements Function2<Boolean, Continuation<? super Unit>, Object> {
            ...
            /* renamed from: b, reason: collision with root package name */
            /* synthetic */ boolean f168924b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ androidx.compose.runtime.z1<Boolean> f168925c;

            /* renamed from: d, reason: collision with root package name */
            final /* synthetic */ androidx.compose.runtime.z1<Function1<Boolean, Unit>> f168926d;

            /* renamed from: e, reason: collision with root package name */
            final /* synthetic */ InterfaceC5730l0<Boolean> f168927e;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            b(androidx.compose.runtime.z1<Boolean> z1Var, androidx.compose.runtime.z1<? extends Function1<? super Boolean, Unit>> z1Var2, InterfaceC5730l0<Boolean> interfaceC5730l0, Continuation<? super b> continuation) {
                super(2, continuation);
                this.f168925c = z1Var;
                this.f168926d = z1Var2;
                this.f168927e = interfaceC5730l0;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                b bVar = new b(this.f168925c, this.f168926d, this.f168927e, continuation);
                bVar.f168924b = ((Boolean) obj).booleanValue();
                return bVar;
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (this.f168923a == 0) {
                    ResultKt.b(obj);
                    boolean z10 = this.f168924b;
                    if (z1.e(this.f168925c) != z10) {
                        Function1 function1D = z1.d(this.f168926d);
                        if (function1D != null) {
                            function1D.invoke(Boxing.a(z10));
                        }
                        z1.c(this.f168927e, !z1.b(r2));
                    }
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        a(C17931e<Boolean> c17931e, androidx.compose.runtime.z1<Boolean> z1Var, androidx.compose.runtime.z1<? extends Function1<? super Boolean, Unit>> z1Var2, InterfaceC5730l0<Boolean> interfaceC5730l0, Continuation<? super a> continuation) {
            super(2, continuation);
            this.f168918b = c17931e;
            this.f168919c = z1Var;
            this.f168920d = z1Var2;
            this.f168921e = interfaceC5730l0;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new a(this.f168918b, this.f168919c, this.f168920d, this.f168921e, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                ResultKt.b(obj);
                InterfaceC17152f interfaceC17152fQ = o1.q(new C2702a(this.f168918b));
                b bVar = new b(this.f168919c, this.f168920d, this.f168921e, null);
                this.f168917a = 1;
                if (C17154h.k(interfaceC17152fQ, bVar, this) == objF) {
                    return objF;
                }
            }
            return Unit.f142422a;
    ...
    static final class b extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ boolean f168929b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ C17931e<Boolean> f168930c;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(boolean z10, C17931e<Boolean> c17931e, Continuation<? super b> continuation) {
            super(2, continuation);
            this.f168929b = z10;
            this.f168930c = c17931e;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new b(this.f168929b, this.f168930c, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                ResultKt.b(obj);
                if (this.f168929b != this.f168930c.s().booleanValue()) {
                    C17931e<Boolean> c17931e = this.f168930c;
                    Boolean boolA = Boxing.a(this.f168929b);
                    this.f168928a = 1;
                    if (androidx.compose.material.a.g(c17931e, boolA, 0.0f, this, 2, null) == objF) {
                        return objF;
                    }
                }
            }
    ...
    static final class c extends Lambda implements Function0<Float> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ C17931e<Boolean> f168931f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        c(C17931e<Boolean> c17931e) {
            super(0);
            this.f168931f = c17931e;
        }

        @Override // kotlin.jvm.functions.Function0
        /* renamed from: c, reason: merged with bridge method [inline-methods] */
        public final Float invoke() {
            return Float.valueOf(this.f168931f.A());
        }
    }
    ...
    static final class d extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ boolean f168932f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function1<Boolean, Unit> f168933g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Modifier f168934h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ boolean f168935i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ h0.l f168936j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ x1 f168937k;

        /* renamed from: l, reason: collision with root package name */
        final /* synthetic */ int f168938l;

        /* renamed from: m, reason: collision with root package name */
        final /* synthetic */ int f168939m;
        ...
        d(boolean z10, Function1<? super Boolean, Unit> function1, Modifier modifier, boolean z11, h0.l lVar, x1 x1Var, int i10, int i11) {
            super(2);
            this.f168932f = z10;
            this.f168933g = function1;
            this.f168934h = modifier;
            this.f168935i = z11;
            this.f168936j = lVar;
            this.f168937k = x1Var;
            this.f168938l = i10;
        ...
        public final void a(Composer composer, int i10) {
            z1.a(this.f168932f, this.f168933g, this.f168934h, this.f168935i, this.f168936j, this.f168937k, composer, J0.a(this.f168938l | 1), this.f168939m);
        }
    ...
    static final class e extends Lambda implements Function1<C17923b0<Boolean>, Unit> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ float f168940f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ float f168941g;
        ...
        public final void a(C17923b0<Boolean> c17923b0) {
            c17923b0.a(Boolean.FALSE, this.f168940f);
            c17923b0.a(Boolean.TRUE, this.f168941g);
        }

        @Override // kotlin.jvm.functions.Function1
        public /* bridge */ /* synthetic */ Unit invoke(C17923b0<Boolean> c17923b0) {
            a(c17923b0);
            return Unit.f142422a;
        }
    }
    ...
    static final class f extends Lambda implements Function1<Float, Float> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final f f168942f = new f();
    ...
    static final class g extends Lambda implements Function0<Float> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ float f168943f;
        ...
        /* renamed from: c, reason: merged with bridge method [inline-methods] */
        public final Float invoke() {
            return Float.valueOf(this.f168943f);
        }
    }
    ...
    static final class h extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ h0.j f168945b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ SnapshotStateList<h0.i> f168946c;
        ...
        static final class a<T> implements InterfaceC17153g {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ SnapshotStateList<h0.i> f168947a;

            a(SnapshotStateList<h0.i> snapshotStateList) {
                this.f168947a = snapshotStateList;
            }
            ...
            public final Object emit(h0.i iVar, Continuation<? super Unit> continuation) {
                if (iVar instanceof n.b) {
                    this.f168947a.add(iVar);
                } else if (iVar instanceof n.c) {
                    this.f168947a.remove(((n.c) iVar).getPress());
                } else if (iVar instanceof n.a) {
                    this.f168947a.remove(((n.a) iVar).getPress());
                } else if (iVar instanceof C14322b) {
                    this.f168947a.add(iVar);
                } else if (iVar instanceof C14323c) {
                    this.f168947a.remove(((C14323c) iVar).getStart());
                } else if (iVar instanceof C14321a) {
                    this.f168947a.remove(((C14321a) iVar).getStart());
                }
                return Unit.f142422a;
            }
        }
        ...
        h(h0.j jVar, SnapshotStateList<h0.i> snapshotStateList, Continuation<? super h> continuation) {
            super(2, continuation);
            this.f168945b = jVar;
            this.f168946c = snapshotStateList;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new h(this.f168945b, this.f168946c, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                ResultKt.b(obj);
                InterfaceC17152f<h0.i> interfaceC17152fB = this.f168945b.b();
                a aVar = new a(this.f168946c);
                this.f168944a = 1;
    ...
    static final class i extends Lambda implements Function1<X0.f, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ androidx.compose.runtime.z1<C5346q0> f168948f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        i(androidx.compose.runtime.z1<C5346q0> z1Var) {
            super(1);
            this.f168948f = z1Var;
        }

        public final void a(X0.f fVar) {
            z1.q(fVar, z1.g(this.f168948f), fVar.I1(z1.s()), fVar.I1(z1.r()));
        }
    ...
    static final class j extends Lambda implements Function1<H1.d, H1.n> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function0<Float> f168949f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        j(Function0<Float> function0) {
            super(1);
            this.f168949f = function0;
        }

        public final long a(H1.d dVar) {
            return o.a(MathKt.d(this.f168949f.invoke().floatValue()), 0);
        }
    ...
    static final class k extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ InterfaceC14810b f168950f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ boolean f168951g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ boolean f168952h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ x1 f168953i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ Function0<Float> f168954j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ h0.j f168955k;

        /* renamed from: l, reason: collision with root package name */
        final /* synthetic */ int f168956l;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        k(InterfaceC14810b interfaceC14810b, boolean z10, boolean z11, x1 x1Var, Function0<Float> function0, h0.j jVar, int i10) {
            super(2);
            this.f168950f = interfaceC14810b;
            this.f168951g = z10;
            this.f168952h = z11;
            this.f168953i = x1Var;
            this.f168954j = function0;
            this.f168955k = jVar;
            this.f168956l = i10;
        }

        public final void a(Composer composer, int i10) {
            z1.f(this.f168950f, this.f168951g, this.f168952h, this.f168953i, this.f168954j, this.f168955k, composer, J0.a(this.f168956l | 1));
        }
    ...
    static {
        ...
        f168910f = fP;
        f168911g = fP2;
        f168912h = H1.h.p(fP - fP2);
        f168913i = new n0<>(100, 0, null, 6, null);
        f168914j = H1.h.p(1);
        f168915k = H1.h.p(6);
        f168916l = H1.h.p(125);
    }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void f(InterfaceC14810b interfaceC14810b, boolean z10, boolean z11, x1 x1Var, Function0<Float> function0, h0.j jVar, Composer composer, int i10) {
        int i11;
        ...
        if (composerStartRestartGroup.p((74899 & i12) != 74898, i12 & 1)) {
            ...
            float f10 = !snapshotStateList.isEmpty() ? f168915k : f168914j;
            int i13 = ((i12 >> 6) & 14) | (i12 & 112) | ((i12 >> 3) & 896);
            androidx.compose.runtime.z1<C5346q0> z1VarA = x1Var.a(z11, z10, composerStartRestartGroup, i13);
            Modifier.Companion companion3 = Modifier.INSTANCE;
            e.Companion companion4 = P0.e.INSTANCE;
            Modifier modifierF = androidx.compose.foundation.layout.J.f(interfaceC14810b.g(companion3, companion4.e()), 0.0f, 1, null);
            ...
            C13443j.a(modifierF, (Function1) objB3, composerStartRestartGroup, 0);
            androidx.compose.runtime.z1<C5346q0> z1VarB = x1Var.b(z11, z10, composerStartRestartGroup, i13);
            InterfaceC17947j0 interfaceC17947j0 = (InterfaceC17947j0) composerStartRestartGroup.o(C17950k0.d());
            float fP = H1.h.p(((H1.h) composerStartRestartGroup.o(C17950k0.c())).getValue() + f10);
            if (!C5346q0.s(h(z1VarB), C17877E0.f166879a.a(composerStartRestartGroup, 6).n()) || interfaceC17947j0 == null) {
                ...
                companion = companion3;
                z12 = true;
                jH = interfaceC17947j0.a(h(z1VarB), fP, composerStartRestartGroup, 0);
                composerStartRestartGroup.P();
            }
            androidx.compose.runtime.z1<C5346q0> z1VarA2 = t.a(jH, null, null, null, composerStartRestartGroup, 0, 14);
            composerStartRestartGroup = composerStartRestartGroup;
            Modifier modifierG = interfaceC14810b.g(companion, companion4.h());
            ...
            C14802K.a(androidx.compose.foundation.b.c(T0.l.b(androidx.compose.foundation.layout.J.o(androidx.compose.foundation.j.b(A.a(modifierG, (Function1) objB4), jVar, C17916Y0.f(false, f168908d, 0L, 4, null)), f168907c), f10, C16692i.f(), false, 0L, 0L, 24, null), i(z1VarA2), C16692i.f()), composerStartRestartGroup, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        } else {
        ...
        if (t0L != null) {
            t0L.a(new k(interfaceC14810b, z10, z11, x1Var, function0, jVar, i10));
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final long g(androidx.compose.runtime.z1<C5346q0> z1Var) {
        return z1Var.getValue().getValue();
    }

    private static final long h(androidx.compose.runtime.z1<C5346q0> z1Var) {
        return z1Var.getValue().getValue();
    }

    private static final long i(androidx.compose.runtime.z1<C5346q0> z1Var) {
        return z1Var.getValue().getValue();
    }
}
