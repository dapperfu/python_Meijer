...
public class p extends o {
    ...
    public static String O(String str, String oldValue, String newValue, boolean z10) {
        ...
        int i10 = 0;
        int iL0 = StringsKt__StringsKt.l0(str, oldValue, 0, z10);
        if (iL0 < 0) {
            return str;
        }
        ...
        do {
            sb2.append((CharSequence) str, i10, iL0);
            sb2.append(newValue);
            i10 = iL0 + length;
            if (iL0 >= str.length()) {
                break;
            }
            iL0 = StringsKt__StringsKt.l0(str, oldValue, iL0 + iF, z10);
        } while (iL0 > 0);
    ...
    public static final String R(String str, String oldValue, String newValue, boolean z10) {
        ...
        Intrinsics.j(oldValue, "oldValue");
        Intrinsics.j(newValue, "newValue");
        int iP0 = StringsKt__StringsKt.p0(str, oldValue, 0, z10, 2, null);
        return iP0 < 0 ? str : StringsKt__StringsKt.U0(str, iP0, oldValue.length() + iP0, newValue).toString();
    }
