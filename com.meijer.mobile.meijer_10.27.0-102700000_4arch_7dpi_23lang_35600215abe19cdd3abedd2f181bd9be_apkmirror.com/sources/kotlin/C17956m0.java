...
public final class C17956m0 {
    ...
    static final class a extends Lambda implements Function1<F, E> {
        ...
        final /* synthetic */ View f168337f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f168338g;
        ...
        public static final class C2687a implements E {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ ViewOnAttachStateChangeListenerC17899P0 f168339a;

            public C2687a(ViewOnAttachStateChangeListenerC17899P0 viewOnAttachStateChangeListenerC17899P0) {
                this.f168339a = viewOnAttachStateChangeListenerC17899P0;
            }
        ...
        a(View view, Function0<Unit> function0) {
            super(1);
            this.f168337f = view;
            this.f168338g = function0;
        }

        @Override // kotlin.jvm.functions.Function1
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final E invoke(F f10) {
            return new C2687a(new ViewOnAttachStateChangeListenerC17899P0(this.f168337f, this.f168338g));
        }
    }
    ...
    static final class b extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f168340f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f168341g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(Function0<Unit> function0, int i10) {
            super(2);
            this.f168340f = function0;
            this.f168341g = i10;
        }

        public final void a(Composer composer, int i10) {
            C17956m0.a(this.f168340f, composer, J0.a(this.f168341g | 1));
        }
