...
public final class ArraysKt___ArraysJvmKt$asList$3 extends AbstractList<Integer> implements RandomAccess {
    ...
    public boolean isEmpty() {
        return this.f142477b.length == 0;
    }

    public boolean k(int element) {
        return ArraysKt___ArraysKt.W(this.f142477b, element);
    }
    ...
    public Integer get(int index) {
        return Integer.valueOf(this.f142477b[index]);
    }

    public int o(int element) {
        return ArraysKt___ArraysKt.r0(this.f142477b, element);
    }

    public int p(int element) {
        return ArraysKt___ArraysKt.G0(this.f142477b, element);
    }
}
