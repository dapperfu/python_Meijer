...
public final class ArraysKt___ArraysJvmKt$asList$8 extends AbstractList<Character> implements RandomAccess {
    ...
    public boolean isEmpty() {
        return this.f142482b.length == 0;
    }

    public boolean k(char element) {
        return ArraysKt___ArraysKt.V(this.f142482b, element);
    }
    ...
    public Character get(int index) {
        return Character.valueOf(this.f142482b[index]);
    }

    public int o(char element) {
        return ArraysKt___ArraysKt.q0(this.f142482b, element);
    }

    public int p(char element) {
        return ArraysKt___ArraysKt.F0(this.f142482b, element);
    }
}
