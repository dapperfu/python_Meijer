...
public final class ArrayDeque<E> extends AbstractMutableList<E> {
    ...
    public <T> T[] toArray(T[] array) {
        ...
        if (array.length < size()) {
            array = (T[]) C15210d.a(array, size());
        }
        T[] tArr = array;
        int iV = v(this.head + size());
        int i10 = this.head;
        if (i10 < iV) {
            ArraysKt___ArraysJvmKt.t(this.elementData, tArr, 0, i10, iV, 2, null);
        } else if (!isEmpty()) {
            Object[] objArr = this.elementData;
            ArraysKt___ArraysJvmKt.o(objArr, tArr, 0, this.head, objArr.length);
            Object[] objArr2 = this.elementData;
            ArraysKt___ArraysJvmKt.o(objArr2, tArr, objArr2.length - this.head, 0, iV);
        }
    ...
    private final void B(int fromIndex, int toIndex) {
        ...
        while (fromIndex > 0) {
            int i10 = iV + 1;
            int iMin = Math.min(fromIndex, Math.min(i10, iV2 + 1));
            Object[] objArr = this.elementData;
            int i11 = iV2 - iMin;
            int i12 = iV - iMin;
    ...
    private final void C(int fromIndex, int toIndex) {
        ...
        while (true) {
            ...
            Object[] objArr2 = this.elementData;
            int i10 = iV + toIndex;
            ArraysKt___ArraysJvmKt.o(objArr2, objArr2, iV2, iV, i10);
            iV = v(i10);
            iV2 = v(iV2 + toIndex);
        }
    }
    ...
    public void add(int index, E element) {
        ...
        if (index < ((size() + 1) >> 1)) {
            ...
            if (iV < iV2) {
                ...
                ArraysKt___ArraysJvmKt.o(objArr4, objArr4, iV + 1, iV, iV2);
            } else {
                Object[] objArr5 = this.elementData;
                ArraysKt___ArraysJvmKt.o(objArr5, objArr5, 1, 0, iV2);
                Object[] objArr6 = this.elementData;
                objArr6[0] = objArr6[objArr6.length - 1];
                ArraysKt___ArraysJvmKt.o(objArr6, objArr6, iV + 1, iV, objArr6.length - 1);
            }
    ...
    public E f(int index) {
        ...
        x();
        int iV = v(this.head + index);
        E e10 = (E) this.elementData[iV];
        if (index < (size() >> 1)) {
            int i10 = this.head;
            if (iV >= i10) {
                Object[] objArr = this.elementData;
                ArraysKt___ArraysJvmKt.o(objArr, objArr, i10 + 1, i10, iV);
            } else {
                Object[] objArr2 = this.elementData;
                ArraysKt___ArraysJvmKt.o(objArr2, objArr2, 1, 0, iV);
                Object[] objArr3 = this.elementData;
            ...
            int iV2 = v(this.head + i.o(this));
            if (iV <= iV2) {
                Object[] objArr5 = this.elementData;
                ArraysKt___ArraysJvmKt.o(objArr5, objArr5, iV, iV + 1, iV2 + 1);
            } else {
                Object[] objArr6 = this.elementData;
                ArraysKt___ArraysJvmKt.o(objArr6, objArr6, iV, iV + 1, objArr6.length);
                Object[] objArr7 = this.elementData;
                objArr7[objArr7.length - 1] = objArr7[0];
                ArraysKt___ArraysJvmKt.o(objArr7, objArr7, 0, 1, iV2 + 1);
            }
    ...
    public boolean removeAll(Collection<?> elements) {
        ...
        if (!isEmpty() && this.elementData.length != 0) {
            ...
            if (i10 < iV2) {
                ...
                ArraysKt___ArraysJvmKt.B(this.elementData, null, iV, iV2);
            } else {
    ...
    public final E last() {
        if (!isEmpty()) {
            return (E) this.elementData[v(this.head + i.o(this))];
        }
        throw new NoSuchElementException("ArrayDeque is empty.");
    }
    ...
    public boolean addAll(int index, Collection<? extends E> elements) {
        ...
        if (index < ((size() + 1) >> 1)) {
            ...
            if (iV2 < i10) {
                ...
                if (size >= iV2) {
                    Object[] objArr2 = this.elementData;
                    ArraysKt___ArraysJvmKt.o(objArr2, objArr2, objArr2.length - size, 0, iV2);
                } else {
                    Object[] objArr3 = this.elementData;
                    ArraysKt___ArraysJvmKt.o(objArr3, objArr3, objArr3.length - size, 0, size);
                    Object[] objArr4 = this.elementData;
                    ArraysKt___ArraysJvmKt.o(objArr4, objArr4, 0, size, iV2);
                }
            } else if (length >= 0) {
                Object[] objArr5 = this.elementData;
                ArraysKt___ArraysJvmKt.o(objArr5, objArr5, length, i10, iV2);
            } else {
                Object[] objArr6 = this.elementData;
                ...
                if (length2 >= i11) {
                    ArraysKt___ArraysJvmKt.o(objArr6, objArr6, length, i10, iV2);
                } else {
                    ArraysKt___ArraysJvmKt.o(objArr6, objArr6, length, i10, i10 + length2);
                    Object[] objArr7 = this.elementData;
                    ArraysKt___ArraysJvmKt.o(objArr7, objArr7, 0, this.head + length2, iV2);
                }
            }
            this.head = length;
            h(s(iV2 - size), elements);
        } else {
            int i12 = iV2 + size;
            if (iV2 < iV) {
                int i13 = size + iV;
                ...
                if (i13 <= objArr8.length) {
                    ArraysKt___ArraysJvmKt.o(objArr8, objArr8, i12, iV2, iV);
                } else if (i12 >= objArr8.length) {
                    ArraysKt___ArraysJvmKt.o(objArr8, objArr8, i12 - objArr8.length, iV2, iV);
                } else {
                    int length3 = iV - (i13 - objArr8.length);
                    ArraysKt___ArraysJvmKt.o(objArr8, objArr8, 0, length3, iV);
                    Object[] objArr9 = this.elementData;
                    ArraysKt___ArraysJvmKt.o(objArr9, objArr9, i12, iV2, length3);
                }
            } else {
                Object[] objArr10 = this.elementData;
                ArraysKt___ArraysJvmKt.o(objArr10, objArr10, size, 0, iV);
                Object[] objArr11 = this.elementData;
                if (i12 >= objArr11.length) {
                    ArraysKt___ArraysJvmKt.o(objArr11, objArr11, i12 - objArr11.length, iV2, objArr11.length);
                } else {
                    ArraysKt___ArraysJvmKt.o(objArr11, objArr11, 0, objArr11.length - size, objArr11.length);
                    Object[] objArr12 = this.elementData;
                    ArraysKt___ArraysJvmKt.o(objArr12, objArr12, i12, iV2, objArr12.length - size);
                }
            }
            h(iV2, elements);
        }
