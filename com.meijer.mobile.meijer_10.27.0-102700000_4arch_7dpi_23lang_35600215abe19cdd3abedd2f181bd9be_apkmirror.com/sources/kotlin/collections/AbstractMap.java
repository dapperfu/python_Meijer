    ...
    public Set<K> f() {
        if (this._keys == null) {
            this._keys = new AbstractSet<K>(this) { // from class: kotlin.collections.AbstractMap$keys$1
                ...
                final /* synthetic */ AbstractMap<K, V> f142465b;
                ...
                public boolean contains(Object element) {
                    return this.f142465b.containsKey(element);
                }

                @Override // kotlin.collections.AbstractCollection
                /* renamed from: f */
                public int getSize() {
                    return this.f142465b.size();
                }

                @Override // kotlin.collections.AbstractSet, java.util.Collection, java.lang.Iterable, java.util.Set
                public Iterator<K> iterator() {
                    return new AbstractMap$keys$1$iterator$1(this.f142465b.entrySet().iterator());
                }
            };
        }
    ...
    public Collection<V> h() {
        if (this._values == null) {
            this._values = new AbstractCollection<V>(this) { // from class: kotlin.collections.AbstractMap.values.1
                ...
                final /* synthetic */ AbstractMap<K, V> f142467a;
                ...
                @Override // kotlin.collections.AbstractCollection, java.util.Collection, java.util.List
                public boolean contains(Object element) {
                    return this.f142467a.containsValue(element);
                }

                @Override // kotlin.collections.AbstractCollection
                /* renamed from: f */
                public int getSize() {
                    return this.f142467a.size();
                }

                @Override // java.util.Collection, java.lang.Iterable
                public Iterator<V> iterator() {
                    return new AbstractMap$values$1$iterator$1(this.f142467a.entrySet().iterator());
                }
            };
        }
    ...
    public String toString() {
        return CollectionsKt___CollectionsKt.B0(entrySet(), ", ", "{", "}", 0, null, new Function1() { // from class: kotlin.collections.b
            ...
            public final Object invoke(Object obj) {
                return AbstractMap.q(this.f142546a, (Map.Entry) obj);
            }
        }, 24, null);
    }
