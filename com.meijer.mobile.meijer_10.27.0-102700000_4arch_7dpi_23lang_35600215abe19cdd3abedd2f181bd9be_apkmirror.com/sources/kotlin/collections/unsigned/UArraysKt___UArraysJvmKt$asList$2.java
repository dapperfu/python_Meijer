...
public final class UArraysKt___UArraysJvmKt$asList$2 extends AbstractList<ULong> implements RandomAccess {
    ...
    /* renamed from: f */
    public int getSize() {
        return ULongArray.s(this.f142603b);
    }
    ...
    public boolean isEmpty() {
        return ULongArray.v(this.f142603b);
    }

    public boolean k(long element) {
        return ULongArray.n(this.f142603b, element);
    }
    ...
    public long n(int index) {
        return ULongArray.q(this.f142603b, index);
    }

    public int o(long element) {
        return ArraysKt.s0(this.f142603b, element);
    }

    public int p(long element) {
        return ArraysKt.H0(this.f142603b, element);
    }
