...
public final class UArraysKt___UArraysJvmKt$asList$3 extends AbstractList<UByte> implements RandomAccess {
    ...
    /* renamed from: f */
    public int getSize() {
        return UByteArray.s(this.f142604b);
    }
    ...
    public boolean isEmpty() {
        return UByteArray.v(this.f142604b);
    }

    public boolean k(byte element) {
        return UByteArray.n(this.f142604b, element);
    }
    ...
    public byte n(int index) {
        return UByteArray.q(this.f142604b, index);
    }

    public int o(byte element) {
        return ArraysKt.p0(this.f142604b, element);
    }

    public int p(byte element) {
        return ArraysKt.E0(this.f142604b, element);
    }
