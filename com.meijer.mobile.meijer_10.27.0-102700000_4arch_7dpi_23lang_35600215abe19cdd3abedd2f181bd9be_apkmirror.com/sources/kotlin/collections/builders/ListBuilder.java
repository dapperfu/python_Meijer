...
public final class ListBuilder<E> extends AbstractMutableList<E> implements List<E>, RandomAccess, Serializable, KMutableList {
    ...
    public static final class BuilderSubList<E> extends AbstractMutableList<E> implements List<E>, RandomAccess, Serializable, KMutableList {
        ...
        private final E z(int i10) {
            ...
            BuilderSubList<E> builderSubList = this.parent;
            if (builderSubList == null) {
                eZ = (E) this.root.G(i10);
            } else {
                eZ = builderSubList.z(i10);
            }
            this.length--;
            return eZ;
        }
        ...
        public boolean equals(Object other) {
            s();
            if (other != this) {
                if (!(other instanceof List) || !v((List) other)) {
                    return false;
                }
                return true;
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void v(int i10, Collection<? extends E> elements, int n10) {
        F();
        E(i10, n10);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void x(int i10, E element) {
        F();
        E(i10, 1);
