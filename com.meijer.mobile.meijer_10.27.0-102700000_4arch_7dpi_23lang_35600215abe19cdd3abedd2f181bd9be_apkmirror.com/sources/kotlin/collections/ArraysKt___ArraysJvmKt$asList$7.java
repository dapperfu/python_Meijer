...
public final class ArraysKt___ArraysJvmKt$asList$7 extends AbstractList<Boolean> implements RandomAccess {
    ...
    final /* synthetic */ boolean[] f142481b;
    ...
    public boolean isEmpty() {
        return this.f142481b.length == 0;
    }

    public boolean k(boolean element) {
        return ArraysKt___ArraysKt.a0(this.f142481b, element);
    }
    ...
    public Boolean get(int index) {
        return Boolean.valueOf(this.f142481b[index]);
    }

    public int o(boolean element) {
        return ArraysKt___ArraysKt.v0(this.f142481b, element);
    }

    public int p(boolean element) {
        return ArraysKt___ArraysKt.K0(this.f142481b, element);
    }
}
