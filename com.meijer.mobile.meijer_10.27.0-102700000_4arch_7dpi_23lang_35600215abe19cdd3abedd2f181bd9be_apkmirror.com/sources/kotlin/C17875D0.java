...
public final class C17875D0 {
    ...
    private static final float c(long j10, float f10, long j11, long j12) {
        long jG = C5349s0.g(C5346q0.q(j10, f10, 0.0f, 0.0f, 0.0f, 14, null), j12);
        return b(C5349s0.g(j11, jG), jG);
    }
    ...
    public static final SelectionColors e(Colors colors, Composer composer, int i10) {
        ...
        long jA = C17876E.a(colors, jC);
        if (jA == 16) {
            jA = ((C5346q0) composer.o(C17894N.a())).getValue();
        }
        long j11 = jA;
        composer.P();
        long jQ = C5346q0.q(j11, C17890L.f167124a.d(composer, 6), 0.0f, 0.0f, 0.0f, 14, null);
    ...
    public static final float b(long j10, long j11) {
        float fI = C5349s0.i(j10) + 0.05f;
        float fI2 = C5349s0.i(j11) + 0.05f;
    ...
    public static final long d(long j10, long j11, long j12) {
        ...
        return C5346q0.q(j10, fA, 0.0f, 0.0f, 0.0f, 14, null);
    }
}
