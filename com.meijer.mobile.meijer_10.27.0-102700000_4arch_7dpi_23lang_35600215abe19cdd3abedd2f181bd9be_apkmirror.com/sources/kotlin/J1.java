...
public final class J1 {
    ...
    private static final float f167082a = H1.h.p(20);

    /* renamed from: b, reason: collision with root package name */
    private static final float f167083b = H1.h.p(10);

    /* renamed from: c, reason: collision with root package name */
    private static final float f167084c = H1.h.p(2);

    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    static final class a extends Lambda implements Function2<Composer, Integer, Unit> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Modifier f167085f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Function2<Composer, Integer, Unit> f167086g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Function2<Composer, Integer, Unit> f167087h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ Function3<Modifier, Composer, Integer, Unit> f167088i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ Function2<Composer, Integer, Unit> f167089j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ Function2<Composer, Integer, Unit> f167090k;

        /* renamed from: l, reason: collision with root package name */
        final /* synthetic */ boolean f167091l;

        /* renamed from: m, reason: collision with root package name */
        final /* synthetic */ float f167092m;

        /* renamed from: n, reason: collision with root package name */
        final /* synthetic */ InterfaceC14794C f167093n;

        /* renamed from: o, reason: collision with root package name */
        final /* synthetic */ int f167094o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        a(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function3<? super Modifier, ? super Composer, ? super Integer, Unit> function3, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24, boolean z10, float f10, InterfaceC14794C interfaceC14794C, int i10) {
            super(2);
            this.f167085f = modifier;
            this.f167086g = function2;
            this.f167087h = function22;
            this.f167088i = function3;
            this.f167089j = function23;
            this.f167090k = function24;
            this.f167091l = z10;
            this.f167092m = f10;
            this.f167093n = interfaceC14794C;
            this.f167094o = i10;
        }

        public final void a(Composer composer, int i10) {
            J1.a(this.f167085f, this.f167086g, this.f167087h, this.f167088i, this.f167089j, this.f167090k, this.f167091l, this.f167092m, this.f167093n, composer, J0.a(this.f167094o | 1));
        }
    ...
    public static final void a(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, Function3<? super Modifier, ? super Composer, ? super Integer, Unit> function3, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24, boolean z10, float f10, InterfaceC14794C interfaceC14794C, Composer composer, int i10) {
        int i11;
        int i12;
        ...
        if ((100663296 & i10) == 0) {
            i11 |= composerStartRestartGroup.V(interfaceC14794C) ? 67108864 : 33554432;
        }
        if (composerStartRestartGroup.p((38347923 & i11) != 38347922, i11 & 1)) {
            ...
            if (z11 || objB == Composer.INSTANCE.a()) {
                objB = new K1(z10, f10, interfaceC14794C);
            ...
            if (function3 != null) {
                ...
                function3.invoke(C5795w.b(companion2, "Hint").then(modifierM), composerStartRestartGroup, Integer.valueOf((i11 >> 6) & 112));
                composerStartRestartGroup.P();
            } else {
            ...
            if (function22 != null) {
                ...
                Modifier modifierThen = C5795w.b(companion2, "Label").then(modifierM);
                MeasurePolicy measurePolicyG3 = C5662h.g(P0.e.INSTANCE.o(), false);
                ...
                Function0<InterfaceC5811g> function0A4 = companion.a();
                if (composerStartRestartGroup.k() == null) {
                    C5717f.c();
                }
                composerStartRestartGroup.F();
                ...
                D1.c(composerA4, interfaceC5742sR4, companion.g());
            ...
            Modifier modifierThen2 = C5795w.b(companion2, "TextField").then(modifierM);
            MeasurePolicy measurePolicyG4 = C5662h.g(P0.e.INSTANCE.o(), true);
            ...
            Function0<InterfaceC5811g> function0A5 = companion.a();
            if (composerStartRestartGroup.k() == null) {
                C5717f.c();
            }
            composerStartRestartGroup.F();
            ...
            D1.c(composerA5, interfaceC5742sR5, companion.g());
        ...
        if (t0L != null) {
            t0L.a(new a(modifier, function2, function22, function3, function23, function24, z10, f10, interfaceC14794C, i10));
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final int g(int i10, boolean z10, int i11, int i12, int i13, int i14, long j10, float f10, InterfaceC14794C interfaceC14794C) {
        float f11 = f167084c * f10;
        float top = interfaceC14794C.getTop() * f10;
        float bottom = interfaceC14794C.getBottom() * f10;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void k(f0.a aVar, int i10, int i11, f0 f0Var, f0 f0Var2, f0 f0Var3, f0 f0Var4, boolean z10, float f10, InterfaceC14794C interfaceC14794C) {
        int iD = MathKt.d(interfaceC14794C.getTop() * f10);
        if (f0Var3 != null) {
