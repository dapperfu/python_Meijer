...
final class C6322e0<T> implements InterfaceC6326i<T> {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC6326i<T> animationSpec;
    ...
    public boolean equals(Object other) {
        if (!(other instanceof C6322e0)) {
            return false;
        }
        C6322e0 c6322e0 = (C6322e0) other;
        return c6322e0.startDelayNanos == this.startDelayNanos && Intrinsics.e(c6322e0.animationSpec, this.animationSpec);
    }
    ...
    public C6322e0(InterfaceC6326i<T> interfaceC6326i, long j10) {
