...
public final class C15981q implements InterfaceC15758r {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final AbstractC15962C state;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final AbstractC15753m<C15976l> intervalContent;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC15761u keyIndexMap;

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    private final C15986v pagerScopeImpl = C15986v.f153127a;
    ...
    static final class a extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        public final void a(Composer composer, int i10) {
            ...
            AbstractC15753m abstractC15753m = C15981q.this.intervalContent;
            int i11 = this.f153067g;
            C15981q c15981q = C15981q.this;
            InterfaceC15745e.a aVar = abstractC15753m.k().get(i11);
            ((C15976l) aVar.c()).a().invoke(c15981q.pagerScopeImpl, Integer.valueOf(i11 - aVar.getStartIndex()), composer, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof C15981q) {
            return Intrinsics.e(this.intervalContent, ((C15981q) other).intervalContent);
        }
        return false;
    }
    ...
    public C15981q(AbstractC15962C abstractC15962C, AbstractC15753m<C15976l> abstractC15753m, InterfaceC15761u interfaceC15761u) {
        this.state = abstractC15962C;
        this.intervalContent = abstractC15753m;
    ...
    public void h(int i10, Object obj, Composer composer, int i11) {
        ...
        C15719E.a(obj, i10, this.state.getPinnedPages(), ComposableLambdaKt.c(1142237095, true, new a(i10), composer, 54), composer, ((i11 >> 3) & 14) | 3072 | ((i11 << 3) & 112));
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        composer.P();
