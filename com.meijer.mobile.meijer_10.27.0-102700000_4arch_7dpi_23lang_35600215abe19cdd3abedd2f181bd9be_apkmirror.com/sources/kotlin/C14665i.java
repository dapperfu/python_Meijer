...
public final class C14665i implements Parcelable {
    ...
    @JvmField
    public static final Parcelable.Creator<C14665i> CREATOR = new a();
    ...
    /* renamed from: i4.i$a */
    public static final class a implements Parcelable.Creator<C14665i> {
        @Override // android.os.Parcelable.Creator
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public C14665i createFromParcel(Parcel inParcel) {
            Intrinsics.j(inParcel, "inParcel");
            return new C14665i(inParcel);
        }

        @Override // android.os.Parcelable.Creator
        /* renamed from: b, reason: merged with bridge method [inline-methods] */
        public C14665i[] newArray(int size) {
            return new C14665i[size];
        }
    ...
    public final C14664h c(Context context, C14672p destination, AbstractC6023l.b hostLifecycleState, C14668l viewModel) {
        ...
        return C14664h.INSTANCE.a(context, destination, bundle, hostLifecycleState, viewModel, this.id, this.savedState);
    }
    ...
    public C14665i(Parcel inParcel) {
        Intrinsics.j(inParcel, "inParcel");
        String string = inParcel.readString();
        Intrinsics.g(string);
        this.id = string;
        this.destinationId = inParcel.readInt();
        this.args = inParcel.readBundle(C14665i.class.getClassLoader());
        Bundle bundle = inParcel.readBundle(C14665i.class.getClassLoader());
        Intrinsics.g(bundle);
        this.savedState = bundle;
    }
}
