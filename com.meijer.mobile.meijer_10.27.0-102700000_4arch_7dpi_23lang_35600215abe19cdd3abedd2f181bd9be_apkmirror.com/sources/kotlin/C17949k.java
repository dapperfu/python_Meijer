...
public final class C17949k {
    ...
    public static final C17949k f168167a = new C17949k();
    ...
    public static final int f168172f = 8;
    ...
    public final long c(Composer composer, int i10) {
        ...
        long jQ = C5346q0.q(C17877E0.f166879a.a(composer, 6).n(), 0.6f, 0.0f, 0.0f, 0.0f, 14, null);
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        return jQ;
    ...
    public final D1 d(Composer composer, int i10) {
        ...
        float f10 = 16;
        AbstractC16684a abstractC16684aD = AbstractC16684a.d(large, C16686c.b(H1.h.p(f10)), C16686c.b(H1.h.p(f10)), null, null, 12, null);
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        return abstractC16684aD;
    }
}
