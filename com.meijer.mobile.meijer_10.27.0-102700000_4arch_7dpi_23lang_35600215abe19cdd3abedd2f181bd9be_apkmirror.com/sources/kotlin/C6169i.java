...
public final class C6169i {
    ...
    private final InterfaceC5724i0 targetContentZIndex;

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    private u sizeTransform;

    public C6169i(androidx.compose.animation.h hVar, androidx.compose.animation.j jVar, float f10, u uVar) {
    ...
    public /* synthetic */ C6169i(androidx.compose.animation.h hVar, androidx.compose.animation.j jVar, float f10, u uVar, int i10, DefaultConstructorMarker defaultConstructorMarker) {
