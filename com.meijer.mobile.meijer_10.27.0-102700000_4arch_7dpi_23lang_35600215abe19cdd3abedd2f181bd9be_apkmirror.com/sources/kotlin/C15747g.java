...
final class C15747g extends CancellationException {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final int itemOffset;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final AnimationState<Float, C6330m> previousAnimation;
    ...
    public final AnimationState<Float, C6330m> b() {
        return this.previousAnimation;
    }

    public C15747g(int i10, AnimationState<Float, C6330m> animationState) {
        this.itemOffset = i10;
