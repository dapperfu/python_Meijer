...
final class SafePublicationLazyImpl<T> implements Lazy<T>, Serializable {
    ...
    private static final AtomicReferenceFieldUpdater<SafePublicationLazyImpl<?>, Object> f142394e = AtomicReferenceFieldUpdater.newUpdater(SafePublicationLazyImpl.class, Object.class, "b");
    ...
    public T getValue() {
        ...
        if (function0 != null) {
            ...
            if (androidx.concurrent.futures.b.a(f142394e, this, uninitialized_value, tInvoke)) {
