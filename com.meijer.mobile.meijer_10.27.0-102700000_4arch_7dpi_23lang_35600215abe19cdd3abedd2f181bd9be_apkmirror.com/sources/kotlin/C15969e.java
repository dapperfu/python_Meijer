...
public final class C15969e implements InterfaceC15970f {
    ...
    public /* synthetic */ C15969e(int i10, int i11, List list, long j10, Object obj, EnumC13827z enumC13827z, e.b bVar, e.c cVar, t tVar, boolean z10, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, i11, list, j10, obj, enumC13827z, bVar, cVar, tVar, z10);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private C15969e(int i10, int i11, List<? extends f0> list, long j10, Object obj, EnumC13827z enumC13827z, e.b bVar, e.c cVar, t tVar, boolean z10) {
        this.index = i10;
        this.size = i11;
        ...
        this.isVertical = enumC13827z == EnumC13827z.f130585a;
        int size = list.size();
        int iMax = 0;
    ...
    @Override // kotlin.InterfaceC15970f
    public int getIndex() {
        return this.index;
    }
    ...
    public final void h(int offset, int layoutWidth, int layoutHeight) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (this.isVertical) {
                ...
                if (bVar == null) {
                    C14589e.b("null horizontalAlignment");
                ...
                if (cVar == null) {
                    C14589e.b("null verticalAlignment");
                    throw new KotlinNothingValueException();
                }
