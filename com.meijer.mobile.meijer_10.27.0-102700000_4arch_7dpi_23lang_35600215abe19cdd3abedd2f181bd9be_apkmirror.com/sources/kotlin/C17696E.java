...
public final class C17696E {
    ...
    static final class b extends Lambda implements Function1<C17729o, Unit> {
        ...
        final /* synthetic */ Ref.BooleanRef f165259f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(Ref.BooleanRef booleanRef) {
            super(1);
            this.f165259f = booleanRef;
        }
        ...
        public final void a(C17729o c17729o) {
            if (c17729o.c().length() > 0) {
                this.f165259f.f142828a = false;
            }
        }
    }

    public static final InterfaceC17694C c(TextLayoutResult textLayoutResult, int i10, int i11, int i12, long j10, boolean z10, boolean z11) {
        return new SingleSelectionLayout(z11, 1, 1, z10 ? null : new Selection(new Selection.AnchorInfo(b(textLayoutResult, y.n(j10)), y.n(j10), 1L), new Selection.AnchorInfo(b(textLayoutResult, y.i(j10)), y.i(j10), 1L), y.m(j10)), new C17729o(1L, 1, i10, i11, i12, textLayoutResult));
    }

    public static final boolean d(Selection selection, InterfaceC17694C interfaceC17694C) {
        if (selection == null || interfaceC17694C == null) {
            return true;
        }
        ...
        if (interfaceC17694C.c().l() != (selection.getHandlesCrossed() ? selection.getEnd() : selection.getStart()).getOffset()) {
            return false;
        }
        Ref.BooleanRef booleanRef = new Ref.BooleanRef();
        booleanRef.f142828a = true;
        interfaceC17694C.g(new b(booleanRef));
    ...
    public static final EnumC17720f f(EnumC17720f enumC17720f, EnumC17720f enumC17720f2) {
        int[] iArr = a.$EnumSwitchMapping$0;
        int i10 = iArr[enumC17720f2.ordinal()];
        if (i10 == 1) {
        ...
        int i11 = iArr[enumC17720f.ordinal()];
        if (i11 == 1) {
            return EnumC17720f.f165516a;
        }
        if (i11 == 2) {
