...
public final class C17881G0 {
    ...
    static final class a extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ Function2<Composer, Integer, Unit> f166903f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f166904g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        a(Function2<? super Composer, ? super Integer, Unit> function2, int i10) {
            super(2);
            this.f166903f = function2;
            this.f166904g = i10;
        }

        public final void a(Composer composer, int i10) {
            C17881G0.a(this.f166903f, composer, J0.a(this.f166904g | 1));
        }
