...
public final class C15973i implements InterfaceC15751k {
    ...
    public C15973i(AbstractC15962C abstractC15962C, int i10) {
    ...
    @Override // kotlin.InterfaceC15751k
    public int e() {
        return Math.min(a() - 1, ((InterfaceC15970f) CollectionsKt.D0(this.state.C().h())).getIndex() + this.beyondViewportPageCount);
    }
}
