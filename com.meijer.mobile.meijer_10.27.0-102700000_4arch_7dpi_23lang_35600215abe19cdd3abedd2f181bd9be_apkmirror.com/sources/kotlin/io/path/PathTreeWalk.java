...
public final class PathTreeWalk implements Sequence<Path> {
    ...
    static final class a extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Path>, Continuation<? super Unit>, Object> {
        ...
        private /* synthetic */ Object f142778h;
    ...
    static final class b extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Path>, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: h, reason: collision with root package name */
        private /* synthetic */ Object f142786h;
        ...
        /* renamed from: d, reason: merged with bridge method [inline-methods] */
        public final Object invoke(SequenceScope<? super Path> sequenceScope, Continuation<? super Unit> continuation) {
            return ((b) create(sequenceScope, continuation)).invokeSuspend(Unit.f142422a);
        }
    ...
    public final boolean i() {
        return ArraysKt.Y(this.options, PathWalkOption.f142790c);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final boolean j() {
        return ArraysKt.Y(this.options, PathWalkOption.f142788a);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final LinkOption[] k() {
        return LinkFollowing.f142761a.a(i());
    }

    private final boolean l() {
        return ArraysKt.Y(this.options, PathWalkOption.f142789b);
    }
