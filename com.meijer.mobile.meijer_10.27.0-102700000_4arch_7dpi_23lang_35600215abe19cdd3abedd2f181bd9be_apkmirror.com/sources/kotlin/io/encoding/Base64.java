...
public class Base64 {
    ...
    private static final byte[] f142740e = {C14045dq.DARKEN, 10};

    /* renamed from: f, reason: collision with root package name */
    private static final Base64 f142741f;

    /* renamed from: g, reason: collision with root package name */
    private static final Base64 f142742g;
    ...
    public static final class PaddingOption {
        ...
        public static final PaddingOption f142746a = new PaddingOption("PRESENT", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final PaddingOption f142747b = new PaddingOption("ABSENT", 1);

        /* renamed from: c, reason: collision with root package name */
        public static final PaddingOption f142748c = new PaddingOption("PRESENT_OPTIONAL", 2);

        /* renamed from: d, reason: collision with root package name */
        public static final PaddingOption f142749d = new PaddingOption("ABSENT_OPTIONAL", 3);

        /* renamed from: e, reason: collision with root package name */
        private static final /* synthetic */ PaddingOption[] f142750e;

        /* renamed from: f, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f142751f;

        private static final /* synthetic */ PaddingOption[] a() {
            return new PaddingOption[]{f142746a, f142747b, f142748c, f142749d};
        }

        static {
            PaddingOption[] paddingOptionArrA = a();
            f142750e = paddingOptionArrA;
            f142751f = EnumEntriesKt.a(paddingOptionArrA);
        }
        ...
        public static PaddingOption[] values() {
            return (PaddingOption[]) f142750e.clone();
        }
    ...
    static {
        PaddingOption paddingOption = PaddingOption.f142746a;
        f142741f = new Base64(true, false, paddingOption);
        f142742g = new Base64(false, true, paddingOption);
    }
