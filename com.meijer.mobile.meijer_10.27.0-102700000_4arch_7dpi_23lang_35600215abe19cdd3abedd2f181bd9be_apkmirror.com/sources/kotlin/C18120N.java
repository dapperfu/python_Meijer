...
final class C18120N implements InterfaceC18117K {
    ...
    private final Typeface c(String genericFontFamily, FontWeight fontWeight, int fontStyle) {
        if (C18153w.f(fontStyle, C18153w.INSTANCE.b()) && Intrinsics.e(fontWeight, FontWeight.INSTANCE.e()) && (genericFontFamily == null || genericFontFamily.length() == 0)) {
            return Typeface.DEFAULT;
        }
        int iC = C18136f.c(fontWeight, fontStyle);
    ...
    private final Typeface d(String familyName, FontWeight weight, int style) {
        ...
        if (Intrinsics.e(typefaceC, FS.typefaceCreateDerived(Typeface.DEFAULT, C18136f.c(weight, style))) || Intrinsics.e(typefaceC, c(null, weight, style))) {
            return null;
        }
        return typefaceC;
    }
    ...
    public Typeface a(C18112F name, FontWeight fontWeight, int fontStyle) {
        Typeface typefaceD = d(C18121O.b(name.getName(), fontWeight), fontWeight, fontStyle);
        if (typefaceD == null) {
