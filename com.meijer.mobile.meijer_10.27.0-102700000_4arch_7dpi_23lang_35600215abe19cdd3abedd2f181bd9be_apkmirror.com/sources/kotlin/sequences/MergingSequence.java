...
public final class MergingSequence<T1, T2, V> implements Sequence<V> {
    ...
    public static final class AnonymousClass1 implements Iterator<V>, KMappedMarker {
        ...
        final /* synthetic */ MergingSequence<T1, T2, V> f147271c;
        ...
        @Override // java.util.Iterator
        public V next() {
            return (V) ((MergingSequence) this.f147271c).transform.invoke(this.iterator1.next(), this.iterator2.next());
        }
    }
