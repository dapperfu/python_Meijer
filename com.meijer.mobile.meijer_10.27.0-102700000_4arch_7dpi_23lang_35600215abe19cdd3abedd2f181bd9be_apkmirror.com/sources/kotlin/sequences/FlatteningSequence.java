...
public final class FlatteningSequence<T, R, E> implements Sequence<E> {
    ...
    public static final class AnonymousClass1 implements Iterator<E>, KMappedMarker {
        ...
        final /* synthetic */ FlatteningSequence<T, R, E> f147257d;
        ...
        AnonymousClass1(FlatteningSequence<T, R, E> flatteningSequence) {
            this.f147257d = flatteningSequence;
        ...
        private final boolean a() {
            ...
            while (this.iterator.hasNext()) {
                Iterator<? extends E> it2 = (Iterator) ((FlatteningSequence) this.f147257d).iterator.invoke(((FlatteningSequence) this.f147257d).transformer.invoke(this.iterator.next()));
                if (it2.hasNext()) {
