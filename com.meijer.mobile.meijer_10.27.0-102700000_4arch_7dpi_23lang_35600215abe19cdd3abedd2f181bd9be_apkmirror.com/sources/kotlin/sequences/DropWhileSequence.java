...
public final class DropWhileSequence<T> implements Sequence<T> {
    ...
    public static final class AnonymousClass1 implements Iterator<T>, KMappedMarker {
        ...
        final /* synthetic */ DropWhileSequence<T> f147243d;
        ...
        AnonymousClass1(DropWhileSequence<T> dropWhileSequence) {
            this.f147243d = dropWhileSequence;
        ...
        private final void a() {
            while (this.iterator.hasNext()) {
                ...
                if (!((Boolean) ((DropWhileSequence) this.f147243d).predicate.invoke(next)).booleanValue()) {
                    this.nextItem = next;
                    this.dropState = 1;
                    return;
                }
