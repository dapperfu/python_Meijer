...
public final class C15728N {
    ...
    static final class a extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ Function3<L0.e, Composer, Integer, Unit> f150847f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ C15727M f150848g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        a(Function3<? super L0.e, ? super Composer, ? super Integer, Unit> function3, C15727M c15727m) {
            super(2);
            this.f150847f = function3;
            this.f150848g = c15727m;
        }
        ...
        public final void a(Composer composer, int i10) {
            ...
            this.f150847f.invoke(this.f150848g, composer, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class b extends Lambda implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function3<L0.e, Composer, Integer, Unit> f150849f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f150850g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        b(Function3<? super L0.e, ? super Composer, ? super Integer, Unit> function3, int i10) {
            super(2);
            this.f150849f = function3;
            this.f150850g = i10;
        }

        public final void a(Composer composer, int i10) {
            C15728N.a(this.f150849f, composer, J0.a(this.f150850g | 1));
        }
    ...
    /* renamed from: n0.N$c */
    static final class c extends Lambda implements Function0<C15727M> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ L0.h f150851f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ L0.e f150852g;
        ...
        public final C15727M invoke() {
            return new C15727M(this.f150851f, MapsKt.k(), this.f150852g);
        }
    }
    ...
    public static final void a(Function3<? super L0.e, ? super Composer, ? super Integer, Unit> function3, Composer composer, int i10) {
        ...
        if (composerStartRestartGroup.p(z10, i11 & 1)) {
            ...
            Object[] objArr = {hVar};
            L0.k<C15727M, Map<String, List<Object>>> kVarA = C15727M.INSTANCE.a(hVar, eVarA);
            ...
            C15727M c15727m = (C15727M) L0.c.c(objArr, kVarA, null, (Function0) objB, composerStartRestartGroup, 0, 4);
            r.a(L0.j.e().d(c15727m), ComposableLambdaKt.c(1863926504, true, new a(function3, c15727m), composerStartRestartGroup, 54), composerStartRestartGroup, G0.f49976i | 48);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        } else {
