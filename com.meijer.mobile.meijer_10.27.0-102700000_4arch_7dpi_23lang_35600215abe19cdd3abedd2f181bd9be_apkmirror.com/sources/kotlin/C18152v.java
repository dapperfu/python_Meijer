...
public final class C18152v {
    public final List<InterfaceC18141k> a(List<? extends InterfaceC18141k> fontList, FontWeight fontWeight, int fontStyle) {
        ArrayList arrayList = new ArrayList(fontList.size());
        List<? extends InterfaceC18141k> list = fontList;
        int size = list.size();
        int i10 = 0;
        for (int i11 = 0; i11 < size; i11++) {
            InterfaceC18141k interfaceC18141k = fontList.get(i11);
            InterfaceC18141k interfaceC18141k2 = interfaceC18141k;
            if (Intrinsics.e(interfaceC18141k2.a(), fontWeight) && C18153w.f(interfaceC18141k2.c(), fontStyle)) {
                arrayList.add(interfaceC18141k);
            }
        }
        ...
        for (int i12 = 0; i12 < size2; i12++) {
            InterfaceC18141k interfaceC18141k3 = fontList.get(i12);
            if (C18153w.f(interfaceC18141k3.c(), fontStyle)) {
                arrayList2.add(interfaceC18141k3);
            }
        }
        if (!arrayList2.isEmpty()) {
            fontList = arrayList2;
        }
        List<? extends InterfaceC18141k> list2 = fontList;
        FontWeight.Companion companion = FontWeight.INSTANCE;
        FontWeight fontWeight2 = null;
        if (fontWeight.compareTo(companion.h()) < 0) {
            List<? extends InterfaceC18141k> list3 = list2;
            ...
            while (i10 < size4) {
                InterfaceC18141k interfaceC18141k4 = list2.get(i10);
                if (Intrinsics.e(interfaceC18141k4.a(), fontWeight2)) {
                    arrayList3.add(interfaceC18141k4);
                }
                i10++;
            }
            return arrayList3;
        ...
        if (fontWeight.compareTo(companion.i()) > 0) {
            List<? extends InterfaceC18141k> list4 = list2;
            ...
            while (i10 < size6) {
                InterfaceC18141k interfaceC18141k5 = list2.get(i10);
                if (Intrinsics.e(interfaceC18141k5.a(), fontWeight2)) {
                    arrayList4.add(interfaceC18141k5);
                }
                i10++;
            }
            return arrayList4;
        ...
        List<? extends InterfaceC18141k> list5 = list2;
        ...
        for (int i16 = 0; i16 < size8; i16++) {
            InterfaceC18141k interfaceC18141k6 = list2.get(i16);
            if (Intrinsics.e(interfaceC18141k6.a(), fontWeight5)) {
                arrayList5.add(interfaceC18141k6);
            }
        }
        ...
        while (i10 < size10) {
            InterfaceC18141k interfaceC18141k7 = list2.get(i10);
            if (Intrinsics.e(interfaceC18141k7.a(), fontWeight2)) {
                arrayList6.add(interfaceC18141k7);
            }
            i10++;
        }
        return arrayList6;
