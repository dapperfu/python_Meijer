...
public final class C14680x {
    ...
    private final C14679w.a builder = new C14679w.a();
    ...
    /* renamed from: i4.x$a */
    public static final class a extends Lambda implements Function1<C14656E, Unit> {

        /* renamed from: f, reason: collision with root package name */
        public static final a f137447f = new a();

        a() {
            super(1);
        }

        public final void a(C14656E c14656e) {
            Intrinsics.j(c14656e, "$this$null");
        }
    ...
    public static /* synthetic */ void e(C14680x c14680x, String str, Function1 function1, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            function1 = a.f137447f;
        }
        c14680x.d(str, function1);
    }
    ...
    public final void a(Function1<? super C14658b, Unit> animBuilder) {
        Intrinsics.j(animBuilder, "animBuilder");
        C14658b c14658b = new C14658b();
        animBuilder.invoke(c14658b);
        this.builder.b(c14658b.getEnter()).c(c14658b.getExit()).e(c14658b.getPopEnter()).f(c14658b.getPopExit());
    }

    public final C14679w b() {
        C14679w.a aVar = this.builder;
    ...
    public final void c(int id2, Function1<? super C14656E, Unit> popUpToBuilder) {
        Intrinsics.j(popUpToBuilder, "popUpToBuilder");
        g(id2);
        h(null);
        C14656E c14656e = new C14656E();
        popUpToBuilder.invoke(c14656e);
        this.inclusive = c14656e.getInclusive();
        this.saveState = c14656e.getSaveState();
    }

    public final void d(String route, Function1<? super C14656E, Unit> popUpToBuilder) {
