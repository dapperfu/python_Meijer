...
public final class C17703L implements InterfaceC17701J {

    /* renamed from: m, reason: collision with root package name and from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);

    /* renamed from: n, reason: collision with root package name */
    public static final int f165339n = 8;

    /* renamed from: o, reason: collision with root package name */
    private static final L0.k<C17703L, Long> f165340o = L0.l.a(a.f165353f, b.f165354f);

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private boolean sorted;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final List<InterfaceC17728n> _selectables;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private final O<InterfaceC17728n> _selectableMap;
    ...
    private Function4<? super Boolean, ? super LayoutCoordinates, ? super U0.f, ? super InterfaceC17736v, Unit> onSelectionUpdateStartCallback;

    /* renamed from: g, reason: collision with root package name and from kotlin metadata */
    private Function2<? super Boolean, ? super Long, Unit> onSelectionUpdateSelectAll;

    /* renamed from: h, reason: collision with root package name and from kotlin metadata */
    private Function6<? super Boolean, ? super LayoutCoordinates, ? super U0.f, ? super U0.f, ? super Boolean, ? super InterfaceC17736v, Boolean> onSelectionUpdateCallback;
    ...
    private final InterfaceC5730l0 subselections;

    @Metadata(d1 = {"\u0000\u000e\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0003\u001a\u0004\u0018\u00010\u00022\u0006\u0010\u0001\u001a\u00020\u0000H\n¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"", "it", "Lw0/L;", "a", "(J)Lw0/L;"}, k = 3, mv = {1, 9, 0})
    /* renamed from: w0.L$b */
    static final class b extends Lambda implements Function1<Long, C17703L> {

        /* renamed from: f, reason: collision with root package name */
        public static final b f165354f = new b();

        b() {
            super(1);
        }

        public final C17703L a(long j10) {
            return new C17703L(j10, null);
        }

        @Override // kotlin.jvm.functions.Function1
        public /* bridge */ /* synthetic */ C17703L invoke(Long l10) {
    ...
    public static final class Companion {
        ...
        public final L0.k<C17703L, Long> a() {
            return C17703L.f165340o;
        }
    }
    ...
    @SourceDebugExtension
    /* renamed from: w0.L$d */
    static final class d extends Lambda implements Function2<InterfaceC17728n, InterfaceC17728n, Integer> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ LayoutCoordinates f165355f;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        d(LayoutCoordinates layoutCoordinates) {
            super(2);
            this.f165355f = layoutCoordinates;
        }

        @Override // kotlin.jvm.functions.Function2
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final Integer invoke(InterfaceC17728n interfaceC17728n, InterfaceC17728n interfaceC17728n2) {
            long jC;
            long jC2;
            int iD;
            LayoutCoordinates layoutCoordinatesB = interfaceC17728n.B();
            LayoutCoordinates layoutCoordinatesB2 = interfaceC17728n2.B();
            if (layoutCoordinatesB != null) {
                jC = this.f165355f.J(layoutCoordinatesB, U0.f.INSTANCE.c());
            } else {
                jC = U0.f.INSTANCE.c();
            }
            if (layoutCoordinatesB2 != null) {
                jC2 = this.f165355f.J(layoutCoordinatesB2, U0.f.INSTANCE.c());
            } else {
                jC2 = U0.f.INSTANCE.c();
            }
    ...
    public /* synthetic */ C17703L(long j10, DefaultConstructorMarker defaultConstructorMarker) {
        this(j10);
    }

    @Override // kotlin.InterfaceC17701J
    ...
    @Override // kotlin.InterfaceC17701J
    public boolean h(LayoutCoordinates layoutCoordinates, long newPosition, long previousPosition, boolean isStartHandle, InterfaceC17736v adjustment, boolean isInTouchMode) {
        Function6<? super Boolean, ? super LayoutCoordinates, ? super U0.f, ? super U0.f, ? super Boolean, ? super InterfaceC17736v, Boolean> function6 = this.onSelectionUpdateCallback;
        if (function6 != null) {
    ...
    /* renamed from: w0.L$a */
    static final class a extends Lambda implements Function2<L0.m, C17703L, Long> {

        /* renamed from: f, reason: collision with root package name */
        public static final a f165353f = new a();
        ...
        @Override // kotlin.jvm.functions.Function2
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final Long invoke(L0.m mVar, C17703L c17703l) {
            return Long.valueOf(c17703l.incrementId.get());
        }
    }

    private C17703L(long j10) {
        this._selectables = new ArrayList();
        this._selectableMap = C5527z.c();
        this.incrementId = new AtomicLong(j10);
        this.subselections = t1.e(C5527z.a(), null, 2, null);
    }
    ...
    @Override // kotlin.InterfaceC17701J
    public void c(LayoutCoordinates layoutCoordinates, long startPosition, InterfaceC17736v adjustment, boolean isInTouchMode) {
        Function4<? super Boolean, ? super LayoutCoordinates, ? super U0.f, ? super InterfaceC17736v, Unit> function4 = this.onSelectionUpdateStartCallback;
        if (function4 != null) {
    ...
    @Override // kotlin.InterfaceC17701J
    public AbstractC5526y<Selection> d() {
        return (AbstractC5526y) this.subselections.getValue();
    }

    @Override // kotlin.InterfaceC17701J
    public void e(InterfaceC17728n selectable) {
    ...
    public final AbstractC5526y<InterfaceC17728n> m() {
        return this._selectableMap;
    }

    public final List<InterfaceC17728n> n() {
    ...
    public final void r(Function6<? super Boolean, ? super LayoutCoordinates, ? super U0.f, ? super U0.f, ? super Boolean, ? super InterfaceC17736v, Boolean> function6) {
    ...
    public final void u(Function4<? super Boolean, ? super LayoutCoordinates, ? super U0.f, ? super InterfaceC17736v, Unit> function4) {
        this.onSelectionUpdateStartCallback = function4;
    }

    public void v(AbstractC5526y<Selection> abstractC5526y) {
        this.subselections.setValue(abstractC5526y);
    }

    public final List<InterfaceC17728n> w(LayoutCoordinates containerLayoutCoordinates) {
        if (!this.sorted) {
            List<InterfaceC17728n> list = this._selectables;
            final d dVar = new d(containerLayoutCoordinates);
            CollectionsKt.B(list, new Comparator() { // from class: w0.K
                @Override // java.util.Comparator
                public final int compare(Object obj, Object obj2) {
                    return C17703L.x(dVar, obj, obj2);
                }
            });
            this.sorted = true;
        }
    ...
    @Override // kotlin.InterfaceC17701J
    public InterfaceC17728n b(InterfaceC17728n selectable) {
        boolean z10;
        if (selectable.i() != 0) {
            z10 = true;
        } else {
        ...
        if (!z10) {
            C14589e.a("The selectable contains an invalid id: " + selectable.i());
        }
        if (this._selectableMap.a(selectable.i())) {
            C14589e.a("Another selectable with the id: " + selectable + ".selectableId has already subscribed.");
        }
