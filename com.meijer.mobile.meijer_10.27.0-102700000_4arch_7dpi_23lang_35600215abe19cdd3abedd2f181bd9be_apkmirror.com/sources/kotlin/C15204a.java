...
final class C15204a<T, R> extends DeepRecursiveScope<T, R> implements Continuation<R> {
    ...
    public C15204a(Function3<? super DeepRecursiveScope<T, R>, ? super T, ? super Continuation<? super R>, ? extends Object> block, T t10) {
        super(null);
        ...
        this.cont = this;
        this.result = DeepRecursiveKt.f142362a;
    }
    ...
    public final R f() {
        while (true) {
            ...
            if (Result.d(DeepRecursiveKt.f142362a, r10)) {
                try {
