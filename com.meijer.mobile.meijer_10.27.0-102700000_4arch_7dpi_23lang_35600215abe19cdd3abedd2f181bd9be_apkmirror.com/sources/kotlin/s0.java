...
public final class s0 {
    ...
    private static final int[] f61251a = new int[0];

    /* renamed from: b, reason: collision with root package name */
    private static final float[] f61252b = new float[0];

    /* renamed from: c, reason: collision with root package name */
    private static final C6338u f61253c = new C6338u(new int[2], new float[2], new float[][]{new float[2], new float[2]});
    ...
    public static final class a implements InterfaceC6336s {
        ...
        private final C6297J[] anims;

        @Override // kotlin.InterfaceC6336s
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public C6297J get(int index) {
            return this.anims[index];
        }

        /* JADX WARN: Incorrect types in method signature: (TV;FF)V */
        a(AbstractC6334q abstractC6334q, float f10, float f11) {
            int size = abstractC6334q.getSize();
            C6297J[] c6297jArr = new C6297J[size];
            for (int i10 = 0; i10 < size; i10++) {
                c6297jArr[i10] = new C6297J(f10, f11, abstractC6334q.a(i10));
            }
            this.anims = c6297jArr;
        }
    }

    @Metadata(d1 = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0018\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0096\u0002¢\u0006\u0004\b\u0005\u0010\u0006R\u0014\u0010\b\u001a\u00020\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0005\u0010\u0007¨\u0006\t"}, d2 = {"c0/s0$b", "Lc0/s;", "", "index", "Lc0/J;", "a", "(I)Lc0/J;", "Lc0/J;", "anim", "animation-core_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    public static final class b implements InterfaceC6336s {

        /* renamed from: a, reason: collision with root package name and from kotlin metadata */
        private final C6297J anim;
        ...
        b(float f10, float f11) {
            this.anim = new C6297J(f10, f11, 0.0f, 4, null);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final <V extends AbstractC6334q> InterfaceC6336s f(V v10, float f10, float f11) {
    ...
    public static final <V extends AbstractC6334q> V g(r0<V> r0Var, long j10, V v10, V v11, V v12) {
