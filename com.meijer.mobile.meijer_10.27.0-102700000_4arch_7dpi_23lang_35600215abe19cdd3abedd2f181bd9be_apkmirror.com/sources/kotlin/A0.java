...
public final class A0<V extends AbstractC6334q> implements u0<V> {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final AbstractC5517o timestamps;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final AbstractC5519q<VectorizedKeyframeSpecElementInfo<V>> keyframes;
    ...
    private final InterfaceC6290C defaultEasing;
    ...
    private C6338u arcSpline;

    public /* synthetic */ A0(AbstractC5517o abstractC5517o, AbstractC5519q abstractC5519q, int i10, int i11, InterfaceC6290C interfaceC6290C, int i12, DefaultConstructorMarker defaultConstructorMarker) {
        this(abstractC5517o, abstractC5519q, i10, i11, interfaceC6290C, i12);
    }

    private A0(AbstractC5517o abstractC5517o, AbstractC5519q<VectorizedKeyframeSpecElementInfo<V>> abstractC5519q, int i10, int i11, InterfaceC6290C interfaceC6290C, int i12) {
        this.timestamps = abstractC5517o;
        this.keyframes = abstractC5519q;
        this.durationMillis = i10;
        this.delayMillis = i11;
        this.defaultEasing = interfaceC6290C;
        this.initialArcMode = i12;
        this.modes = s0.f61251a;
        this.times = s0.f61252b;
        this.posArray = s0.f61252b;
        this.slopeArray = s0.f61252b;
        this.arcSpline = s0.f61253c;
    }

    private final int h(int timeMillis) {
        int iB = AbstractC5517o.b(this.timestamps, timeMillis, 0, 0, 6, null);
        return iB < -1 ? -(iB + 2) : iB;
    }

    private final float j(int index, int timeMillis, boolean asFraction) {
        InterfaceC6290C easing;
        float f10;
        AbstractC5517o abstractC5517o = this.timestamps;
        if (index >= abstractC5517o._size - 1) {
            f10 = timeMillis;
        } else {
            int iE = abstractC5517o.e(index);
    ...
    private final void k(V initialValue, V targetValue, V initialVelocity) {
        float[] fArr;
        boolean z10 = this.arcSpline != s0.f61253c;
        if (this.valueVector == null) {
            ...
            for (int i13 = 0; i13 < i12; i13++) {
                ...
                if (!C6337t.c(arcMode, C6337t.INSTANCE.a())) {
                    z10 = true;
                }
                iArr[i13] = arcMode;
            }
        ...
        if (z10) {
            if (this.arcSpline != s0.f61253c && Intrinsics.e(this.lastInitialValue, initialValue) && Intrinsics.e(this.lastTargetValue, targetValue)) {
                return;
            }
            ...
            for (int i15 = 0; i15 < i14; i15++) {
                ...
                if (iE == 0 && vectorizedKeyframeSpecElementInfoB2 == null) {
                    ...
                    AbstractC6334q abstractC6334qC = vectorizedKeyframeSpecElementInfoB2.c();
                    float[] fArr4 = new float[size];
                    for (int i18 = 0; i18 < size; i18++) {
                        fArr4[i18] = abstractC6334qC.a(i18);
                    }
                    fArr = fArr4;
                }
                fArr3[i15] = fArr;
            }
            this.arcSpline = new C6338u(this.modes, this.times, fArr3);
        }
    }
    ...
    public V f(long playTimeNanos, V initialValue, V targetValue, V initialVelocity) {
        ...
        if (this.arcSpline != s0.f61253c) {
            ...
            AbstractC6334q abstractC6334qG = s0.g(this, jE - 1, initialValue, targetValue, initialVelocity);
            AbstractC6334q abstractC6334qG2 = s0.g(this, jE, initialValue, targetValue, initialVelocity);
            int size = abstractC6334qG.getSize();
            while (i10 < size) {
                v10.e(i10, (abstractC6334qG.a(i10) - abstractC6334qG2.a(i10)) * 1000.0f);
                i10++;
            }
        }
        return v10;
