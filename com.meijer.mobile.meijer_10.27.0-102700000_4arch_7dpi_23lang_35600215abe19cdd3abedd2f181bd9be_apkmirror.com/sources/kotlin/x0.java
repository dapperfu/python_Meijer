...
final class x0<V extends AbstractC6334q> implements t0<V> {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC6295H floatDecaySpec;
    ...
    public V c(V initialValue, V initialVelocity) {
        if (this.targetVector == null) {
            this.targetVector = (V) C6335r.g(initialValue);
        }
    ...
    public V d(long playTimeNanos, V initialValue, V initialVelocity) {
        if (this.velocityVector == null) {
            this.velocityVector = (V) C6335r.g(initialValue);
        }
    ...
    public x0(InterfaceC6295H interfaceC6295H) {
        this.floatDecaySpec = interfaceC6295H;
        this.absVelocityThreshold = interfaceC6295H.getAbsVelocityThreshold();
    }
}
