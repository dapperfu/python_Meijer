...
public final class C13799Q {
    public static final long c(C14185q c14185q) {
        long jA = a(c14185q, true);
        f.Companion companion = U0.f.INSTANCE;
        return U0.f.j(jA, companion.b()) ? companion.c() : U0.f.p(jA, a(c14185q, false));
    }

    public static final float d(C14185q c14185q) {
        float fB = b(c14185q, true);
        float fB2 = b(c14185q, false);
        if (fB == 0.0f || fB2 == 0.0f) {
            return 1.0f;
        }
        return fB / fB2;
    ...
    public static final long a(C14185q c14185q, boolean z10) {
    ...
    public static final float b(C14185q c14185q, boolean z10) {
        long previousPosition;
        long jA = a(c14185q, z10);
        float fK = 0.0f;
