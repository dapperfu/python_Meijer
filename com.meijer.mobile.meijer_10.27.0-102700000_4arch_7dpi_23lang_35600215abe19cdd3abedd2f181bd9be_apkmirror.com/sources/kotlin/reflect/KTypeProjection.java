...
public final /* data */ class KTypeProjection {
    ...
    @JvmField
    public static final KTypeProjection f142948d = new KTypeProjection(null, null);
    ...
    public static final class Companion {
        ...
        public final KTypeProjection a(KType type) {
            ...
            return new KTypeProjection(KVariance.f142952b, type);
        }

        @JvmStatic
        public final KTypeProjection b(KType type) {
            Intrinsics.j(type, "type");
            return new KTypeProjection(KVariance.f142953c, type);
        }

        public final KTypeProjection c() {
            return KTypeProjection.f142948d;
        }

        @JvmStatic
        public final KTypeProjection d(KType type) {
            Intrinsics.j(type, "type");
            return new KTypeProjection(KVariance.f142951a, type);
        }
    }
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            try {
                iArr[KVariance.f142951a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[KVariance.f142952b.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[KVariance.f142953c.ordinal()] = 3;
