...
public interface KParameter extends KAnnotatedElement {
    ...
    public static final class Kind {
        ...
        public static final Kind f142942a = new Kind("INSTANCE", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final Kind f142943b = new Kind("EXTENSION_RECEIVER", 1);

        /* renamed from: c, reason: collision with root package name */
        public static final Kind f142944c = new Kind("VALUE", 2);

        /* renamed from: d, reason: collision with root package name */
        private static final /* synthetic */ Kind[] f142945d;

        /* renamed from: e, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f142946e;

        private static final /* synthetic */ Kind[] a() {
            return new Kind[]{f142942a, f142943b, f142944c};
        }

        static {
            Kind[] kindArrA = a();
            f142945d = kindArrA;
            f142946e = EnumEntriesKt.a(kindArrA);
        }
