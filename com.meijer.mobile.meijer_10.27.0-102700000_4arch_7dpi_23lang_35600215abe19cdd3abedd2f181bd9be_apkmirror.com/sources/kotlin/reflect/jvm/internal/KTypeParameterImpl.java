...
public final class KTypeParameterImpl implements KTypeParameter, KClassifierImpl {
    ...
    static final /* synthetic */ KProperty<Object>[] f143120d = {Reflection.j(new PropertyReference1Impl(KTypeParameterImpl.class, "upperBounds", "getUpperBounds()Ljava/util/List;", 0))};
    ...
    public KTypeParameterImpl(KTypeParameterOwnerImpl kTypeParameterOwnerImpl, TypeParameterDescriptor descriptor) {
        ...
        if (kTypeParameterOwnerImpl == null) {
            ...
            if (declarationDescriptorB instanceof ClassDescriptor) {
                ...
                objX = declarationDescriptorB.x(new CreateKCallableVisitor(kClassImplE), Unit.f142422a);
            }
    ...
    public List<KType> getUpperBounds() {
        T tB = this.upperBounds.b(this, f143120d[0]);
    ...
    public KVariance getVariance() {
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    return KVariance.f142953c;
                }
                throw new NoWhenBranchMatchedException();
            }
            return KVariance.f142952b;
        }
        return KVariance.f142951a;
    }
}
