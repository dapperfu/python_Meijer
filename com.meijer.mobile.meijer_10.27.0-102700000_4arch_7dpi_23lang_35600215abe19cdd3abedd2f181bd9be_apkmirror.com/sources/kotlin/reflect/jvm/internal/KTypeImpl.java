...
public final class KTypeImpl implements KTypeBase {
    ...
    static final /* synthetic */ KProperty<Object>[] f143115e = {Reflection.j(new PropertyReference1Impl(KTypeImpl.class, "classifier", "getClassifier()Lkotlin/reflect/KClassifier;", 0)), Reflection.j(new PropertyReference1Impl(KTypeImpl.class, "arguments", "getArguments()Ljava/util/List;", 0))};
    ...
    public static final List k(KTypeImpl kTypeImpl, Function0 function0) {
        ...
        Lazy lazyA = LazyKt.a(LazyThreadSafetyMode.f142380b, new v0(kTypeImpl));
    ...
    public KClassifier c() {
        return (KClassifier) this.classifier.b(this, f143115e[0]);
    }

    @Override // kotlin.reflect.KType
    public List<KTypeProjection> d() {
        T tB = this.arguments.b(this, f143115e[1]);
    ...
    public String toString() {
        return ReflectionObjectRenderer.f143135a.l(this.type);
    }
