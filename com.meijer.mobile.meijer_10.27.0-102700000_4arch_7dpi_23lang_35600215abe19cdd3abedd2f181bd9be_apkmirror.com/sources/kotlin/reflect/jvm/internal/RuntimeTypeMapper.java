...
public final class RuntimeTypeMapper {
    ...
    public static final RuntimeTypeMapper f143137a = new RuntimeTypeMapper();

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private static final ClassId JAVA_LANG_VOID = ClassId.f145674d.c(new FqName("java.lang.Void"));
    ...
    public final ClassId c(Class<?> klass) {
        ...
        if (klass.isArray()) {
            ...
            return primitiveTypeA != null ? new ClassId(StandardNames.f143284A, primitiveTypeA.o()) : ClassId.f145674d.c(StandardNames.FqNames.f143384i.m());
        }
        ...
        if (primitiveTypeA2 != null) {
            return new ClassId(StandardNames.f143284A, primitiveTypeA2.t());
        }
        ClassId classIdE = ReflectClassUtilKt.e(klass);
        return (classIdE.i() || (classIdM = JavaToKotlinClassMap.f143492a.m(classIdE.a())) == null) ? classIdE : classIdM;
    }
    ...
    public final JvmFunctionSignature g(FunctionDescriptor possiblySubstitutedFunction) {
        ...
        if ((messageLiteC0 instanceof ProtoBuf.Function) && (methodE = JvmProtoBufUtil.f145664a.e((ProtoBuf.Function) messageLiteC0, deserializedMemberDescriptor.G(), deserializedMemberDescriptor.D())) != null) {
            return new JvmFunctionSignature.KotlinFunction(methodE);
        }
        if (!(messageLiteC0 instanceof ProtoBuf.Constructor) || (methodB = JvmProtoBufUtil.f145664a.b((ProtoBuf.Constructor) messageLiteC0, deserializedMemberDescriptor.G(), deserializedMemberDescriptor.D())) == null) {
            return d(functionDescriptorA);
        }
        ...
        if (constructorDescriptor.z()) {
            ...
            if (StringsKt.G(methodB.d(), ")V", false, 2, null)) {
                methodB = JvmMemberSignature.Method.c(methodB, null, StringsKt.L0(methodB.d(), "V") + strU, 1, null);
    ...
    private final boolean b(FunctionDescriptor descriptor) {
        ...
        if (Intrinsics.e(descriptor.getName(), CloneableClassScope.f143488e.a()) && descriptor.h().isEmpty()) {
            return true;
        }
        return false;
    }
