...
public final class AnnotationConstructorCaller implements Caller {
    ...
    public static final class CallMode {
        ...
        public static final CallMode f143163a = new CallMode("CALL_BY_NAME", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final CallMode f143164b = new CallMode("POSITIONAL_CALL", 1);

        /* renamed from: c, reason: collision with root package name */
        private static final /* synthetic */ CallMode[] f143165c;

        /* renamed from: d, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f143166d;

        private static final /* synthetic */ CallMode[] a() {
            return new CallMode[]{f143163a, f143164b};
        }

        static {
            CallMode[] callModeArrA = a();
            f143165c = callModeArrA;
            f143166d = EnumEntriesKt.a(callModeArrA);
        }
        ...
        public static CallMode[] values() {
            return (CallMode[]) f143165c.clone();
        }
    ...
    public static final class Origin {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final Origin f143167a = new Origin("JAVA", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final Origin f143168b = new Origin("KOTLIN", 1);

        /* renamed from: c, reason: collision with root package name */
        private static final /* synthetic */ Origin[] f143169c;

        /* renamed from: d, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f143170d;

        private static final /* synthetic */ Origin[] a() {
            return new Origin[]{f143167a, f143168b};
        }

        static {
            Origin[] originArrA = a();
            f143169c = originArrA;
            f143170d = EnumEntriesKt.a(originArrA);
        }
    ...
    public AnnotationConstructorCaller(Class<?> jClass, List<String> parameterNames, CallMode callMode, Origin origin, List<Method> methods) {
        ...
        if (this.callMode == CallMode.f143164b && origin == Origin.f143167a && !CollectionsKt.M0(this.parameterNames, "value").isEmpty()) {
    ...
    public Object call(Object[] args) {
        ...
        while (i10 < length) {
            Object obj = args[i10];
            int i12 = i11 + 1;
            Object objQ = (obj == null && this.callMode == CallMode.f143163a) ? this.defaultValues.get(i11) : AnnotationConstructorCallerKt.q(obj, this.erasedParameterTypes.get(i11));
            if (objQ == null) {
