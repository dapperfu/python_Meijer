...
public final class AnnotationConstructorCallerKt {
    ...
    */
    ...
    public static final String l(Class cls, Map map) throws IOException {
        ...
        CollectionsKt___CollectionsKt.y0(map.entrySet(), sb2, (124 & 2) != 0 ? ", " : ", ", (124 & 4) != 0 ? "" : "(", (124 & 8) == 0 ? ")" : "", (124 & 16) != 0 ? -1 : 0, (124 & 32) != 0 ? "..." : null, (124 & 64) != 0 ? null : d.f143213a);
        return sb2.toString();
    }
    ...
    public static final int j(Map map) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            iHashCode2 += iHashCode ^ (str.hashCode() * l3.f92485d);
        }
        return iHashCode2;
    }
