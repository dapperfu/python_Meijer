    ...
    public static final class KotlinProperty extends JvmPropertySignature {
        ...
        public KotlinProperty(PropertyDescriptor descriptor, ProtoBuf.Property proto, JvmProtoBuf.JvmPropertySignature signature, NameResolver nameResolver, TypeTable typeTable) {
            ...
            if (signature.H()) {
                ...
                JvmMemberSignature.Field fieldD = JvmProtoBufUtil.d(JvmProtoBufUtil.f145664a, proto, nameResolver, typeTable, false, 8, null);
                if (fieldD == null) {
        ...
        private final String c() {
            ...
            if (Intrinsics.e(this.descriptor.getVisibility(), DescriptorVisibilities.f143599d) && (declarationDescriptorB instanceof DeserializedClassDescriptor)) {
                ProtoBuf.Class classB1 = ((DeserializedClassDescriptor) declarationDescriptorB).b1();
                GeneratedMessageLite.GeneratedExtension<ProtoBuf.Class, Integer> classModuleName = JvmProtoBuf.f145561i;
            ...
            if (!Intrinsics.e(this.descriptor.getVisibility(), DescriptorVisibilities.f143596a) || !(declarationDescriptorB instanceof PackageFragmentDescriptor)) {
                return "";
            }
