...
public final class KParameterImpl implements KParameter {
    ...
    static final /* synthetic */ KProperty<Object>[] f143084f = {Reflection.j(new PropertyReference1Impl(KParameterImpl.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/ParameterDescriptor;", 0)), Reflection.j(new PropertyReference1Impl(KParameterImpl.class, "annotations", "getAnnotations()Ljava/util/List;", 0))};
    ...
    private final ParameterDescriptor o() {
        T tB = this.descriptor.b(this, f143084f[0]);
    ...
    public String toString() {
        return ReflectionObjectRenderer.f143135a.j(this);
    }
