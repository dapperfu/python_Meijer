...
public final class ClassMapperLite {
    ...
    public static final ClassMapperLite f145645a = new ClassMapperLite();

    /* renamed from: b, reason: collision with root package name */
    private static final String f145646b = CollectionsKt.B0(CollectionsKt.p('k', 'o', 't', 'l', 'i', 'n'), "", null, null, 0, null, null, 62, null);

    /* renamed from: c, reason: collision with root package name */
    private static final Map<String, String> f145647c;
    ...
    static {
        ...
        linkedHashMap.put(f145646b + "/Unit", "V");
        ...
        for (String str5 : CollectionsKt.p("Char", "Byte", "Short", "Int", "Float", "Long", "Double", "String", "Enum")) {
            a(linkedHashMap, str5 + ".Companion", f145646b + "/jvm/internal/" + str5 + "CompanionObject");
        }
        f145647c = linkedHashMap;
    }

    private static final void a(Map<String, String> map, String str, String str2) {
        map.put(f145646b + '/' + str, 'L' + str2 + ';');
    }

    @JvmStatic
    public static final String b(String classId) {
        Intrinsics.j(classId, "classId");
        String str = f145647c.get(classId);
        if (str != null) {
            return str;
        }
