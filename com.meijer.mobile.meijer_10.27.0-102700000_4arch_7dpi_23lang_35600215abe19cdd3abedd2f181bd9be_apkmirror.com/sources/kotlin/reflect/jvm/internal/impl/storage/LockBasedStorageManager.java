...
public class LockBasedStorageManager implements StorageManager {
    ...
    private static final String f146632d = StringsKt.u1(LockBasedStorageManager.class.getCanonicalName(), ".", "");

    /* renamed from: e, reason: collision with root package name */
    public static final StorageManager f146633e = new a("NO_LOCKS", ExceptionHandlingStrategy.f146637a, EmptySimpleLock.f146631b);

    /* renamed from: a, reason: collision with root package name */
    protected final SimpleLock f146634a;

    /* renamed from: b, reason: collision with root package name */
    private final ExceptionHandlingStrategy f146635b;

    /* renamed from: c, reason: collision with root package name */
    private final String f146636c;

    public interface ExceptionHandlingStrategy {

        /* renamed from: a, reason: collision with root package name */
        public static final ExceptionHandlingStrategy f146637a = new a();
    ...
    class b<T> extends i<T> {
        ...
        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Object f146638d;
    ...
    class c<T> extends j<T> {
        ...
        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ Function1 f146640e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Function1 f146641f;
        ...
        c(LockBasedStorageManager lockBasedStorageManager, Function0 function0, Function1 function1, Function1 function12) {
            super(lockBasedStorageManager, function0);
            this.f146640e = function1;
            this.f146641f = function12;
        }

        @Override // kotlin.reflect.jvm.internal.impl.storage.LockBasedStorageManager.g
        protected n<T> c(boolean z10) {
            Function1 function1 = this.f146640e;
            if (function1 == null) {
    ...
    private static class e<K, V> extends k<f<K, V>, V> implements CacheWithNullableValues<K, V> {
        ...
        class a implements Function1<f<K, V>, V> {
            ...
            public V invoke(f<K, V> fVar) {
                return (V) ((f) fVar).f146644b.invoke();
            }
        }
    ...
    private static class f<K, V> {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final K f146643a;

        /* renamed from: b, reason: collision with root package name */
        private final Function0<? extends V> f146644b;

        public boolean equals(Object obj) {
            if (this == obj) {
                return true;
            }
            return obj != null && getClass() == obj.getClass() && this.f146643a.equals(((f) obj).f146643a);
        }

        public int hashCode() {
            return this.f146643a.hashCode();
        }

        public f(K k10, Function0<? extends V> function0) {
            this.f146643a = k10;
            this.f146644b = function0;
        }
    }
    ...
    private static class g<T> implements NullableLazyValue<T> {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final LockBasedStorageManager f146645a;

        /* renamed from: b, reason: collision with root package name */
        private final Function0<? extends T> f146646b;

        /* renamed from: c, reason: collision with root package name */
        private volatile Object f146647c;
        ...
        public g(LockBasedStorageManager lockBasedStorageManager, Function0<? extends T> function0) {
            ...
            this.f146647c = m.NOT_COMPUTED;
            this.f146645a = lockBasedStorageManager;
            this.f146646b = function0;
        }

        protected n<T> c(boolean z10) {
            n<T> nVarP = this.f146645a.p("in a lazy value", null);
            if (nVarP == null) {
                a(2);
            }
            return nVarP;
        ...
        public boolean i() {
            return (this.f146647c == m.NOT_COMPUTED || this.f146647c == m.COMPUTING) ? false : true;
        }
        ...
        */
        public T invoke() {
            /*
                r4 = this;
                java.lang.Object r0 = r4.f146647c
                ...
                return r0
            Lb:
                kotlin.reflect.jvm.internal.impl.storage.LockBasedStorageManager r0 = r4.f146645a
                kotlin.reflect.jvm.internal.impl.storage.SimpleLock r0 = r0.f146634a
                r0.lock()
                java.lang.Object r0 = r4.f146647c     // Catch: java.lang.Throwable -> L24
            ...
            L1c:
                kotlin.reflect.jvm.internal.impl.storage.LockBasedStorageManager r1 = r4.f146645a
                kotlin.reflect.jvm.internal.impl.storage.SimpleLock r1 = r1.f146634a
                r1.unlock()
                return r0
            L24:
                r0 = move-exception
            ...
            L26:
                ...
                r4.f146647c = r2     // Catch: java.lang.Throwable -> L24
                r2 = 1
            ...
            L3e:
                ...
                goto L1c
            L52:
                r4.f146647c = r1     // Catch: java.lang.Throwable -> L24
                kotlin.jvm.functions.Function0<? extends T> r0 = r4.f146646b     // Catch: java.lang.Throwable -> L60
                java.lang.Object r0 = r0.invoke()     // Catch: java.lang.Throwable -> L60
                r4.b(r0)     // Catch: java.lang.Throwable -> L60
                r4.f146647c = r0     // Catch: java.lang.Throwable -> L60
                goto L1c
            L60:
                r0 = move-exception
                boolean r1 = kotlin.reflect.jvm.internal.impl.utils.ExceptionUtilsKt.a(r0)     // Catch: java.lang.Throwable -> L24
                if (r1 != 0) goto L7e
                java.lang.Object r1 = r4.f146647c     // Catch: java.lang.Throwable -> L24
                ...
                r4.f146647c = r1     // Catch: java.lang.Throwable -> L24
            L73:
                kotlin.reflect.jvm.internal.impl.storage.LockBasedStorageManager r1 = r4.f146645a     // Catch: java.lang.Throwable -> L24
    ...
    private static abstract class h<T> extends g<T> {
        ...
        /* renamed from: d, reason: collision with root package name */
        private volatile kotlin.reflect.jvm.internal.impl.storage.a<T> f146648d;
        ...
        protected final void b(T t10) {
            this.f146648d = new kotlin.reflect.jvm.internal.impl.storage.a<>(t10);
            try {
                d(t10);
            } finally {
                this.f146648d = null;
        ...
        public T invoke() {
            kotlin.reflect.jvm.internal.impl.storage.a<T> aVar = this.f146648d;
    ...
    private static class k<K, V> implements MemoizedFunctionToNullable<K, V> {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final LockBasedStorageManager f146649a;

        /* renamed from: b, reason: collision with root package name */
        private final ConcurrentMap<K, Object> f146650b;

        /* renamed from: c, reason: collision with root package name */
        private final Function1<? super K, ? extends V> f146651c;
        ...
        public k(LockBasedStorageManager lockBasedStorageManager, ConcurrentMap<K, Object> concurrentMap, Function1<? super K, ? extends V> function1) {
            ...
            this.f146649a = lockBasedStorageManager;
            this.f146650b = concurrentMap;
            this.f146651c = function1;
        }

        private AssertionError c(K k10, Object obj) {
            return (AssertionError) LockBasedStorageManager.q(new AssertionError("Inconsistent key detected. " + m.COMPUTING + " is expected, was: " + obj + ", most probably race condition detected on input " + k10 + " under " + this.f146649a));
        }

        private AssertionError d(K k10, Object obj) {
            AssertionError assertionError = (AssertionError) LockBasedStorageManager.q(new AssertionError("Race condition detected on input " + k10 + ". Old value is " + obj + " under " + this.f146649a));
        ...
        private AssertionError f(K k10, Throwable th2) {
            return (AssertionError) LockBasedStorageManager.q(new AssertionError("Unable to remove " + k10 + " under " + this.f146649a, th2));
        }

        protected n<V> e(K k10, boolean z10) {
            n<V> nVarP = this.f146649a.p("", k10);
            if (nVarP == null) {
                b(3);
            }
            return nVarP;
        ...
        */
        public V invoke(K r6) {
            /*
                r5 = this;
                java.util.concurrent.ConcurrentMap<K, java.lang.Object> r0 = r5.f146650b
                ...
                return r6
            L11:
                kotlin.reflect.jvm.internal.impl.storage.LockBasedStorageManager r0 = r5.f146649a
                kotlin.reflect.jvm.internal.impl.storage.SimpleLock r0 = r0.f146634a
                r0.lock()
                java.util.concurrent.ConcurrentMap<K, java.lang.Object> r0 = r5.f146650b     // Catch: java.lang.Throwable -> L3b
            ...
            L59:
                r0 = 0
                java.util.concurrent.ConcurrentMap<K, java.lang.Object> r2 = r5.f146650b     // Catch: java.lang.Throwable -> L7e
                r2.put(r6, r1)     // Catch: java.lang.Throwable -> L7e
                kotlin.jvm.functions.Function1<? super K, ? extends V> r2 = r5.f146651c     // Catch: java.lang.Throwable -> L7e
                java.lang.Object r2 = r2.invoke(r6)     // Catch: java.lang.Throwable -> L7e
                java.util.concurrent.ConcurrentMap<K, java.lang.Object> r3 = r5.f146650b     // Catch: java.lang.Throwable -> L7e
                ...
                if (r3 != r1) goto L79
                kotlin.reflect.jvm.internal.impl.storage.LockBasedStorageManager r6 = r5.f146649a
                kotlin.reflect.jvm.internal.impl.storage.SimpleLock r6 = r6.f146634a
                r6.unlock()
                return r2
            L79:
            ...
            L7e:
                ...
                if (r2 == 0) goto L9d
                java.util.concurrent.ConcurrentMap<K, java.lang.Object> r0 = r5.f146650b     // Catch: java.lang.Throwable -> L97
            ...
            L9d:
                ...
                throw r6     // Catch: java.lang.Throwable -> L3b
            Lb2:
                kotlin.reflect.jvm.internal.impl.storage.LockBasedStorageManager r6 = r5.f146649a     // Catch: java.lang.Throwable -> L3b
                ...
                throw r6     // Catch: java.lang.Throwable -> L3b
            Lbd:
                java.util.concurrent.ConcurrentMap<K, java.lang.Object> r0 = r5.f146650b     // Catch: java.lang.Throwable -> Lcd
        ...
        public boolean j(K k10) {
            Object obj = this.f146650b.get(k10);
    ...
    private static class n<T> {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final T f146656a;

        /* renamed from: b, reason: collision with root package name */
        private final boolean f146657b;
        ...
        public String toString() {
            ...
            return String.valueOf(this.f146656a);
        }
    }
    ...
    */
    ...
    private LockBasedStorageManager(String str, ExceptionHandlingStrategy exceptionHandlingStrategy, SimpleLock simpleLock) {
        ...
        this.f146634a = simpleLock;
        this.f146635b = exceptionHandlingStrategy;
        this.f146636c = str;
    }
    ...
    public static <T extends Throwable> T q(T t10) {
        ...
        while (true) {
            ...
            if (!stackTrace[i10].getClassName().startsWith(f146632d)) {
                break;
            }
            i10++;
        }
    ...
    public String toString() {
        return getClass().getSimpleName() + "@" + Integer.toHexString(hashCode()) + " (" + this.f146636c + ")";
    }
    ...
    public LockBasedStorageManager(String str, Runnable runnable, Function1<InterruptedException, Unit> function1) {
        this(str, ExceptionHandlingStrategy.f146637a, SimpleLock.f146658a.a(runnable, function1));
    }
}
