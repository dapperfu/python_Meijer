...
public final class DeserializedClassDataFinder implements ClassDataFinder {
    ...
    private final PackageFragmentProvider f146402a;
    ...
    public DeserializedClassDataFinder(PackageFragmentProvider packageFragmentProvider) {
        ...
        this.f146402a = packageFragmentProvider;
    }
    ...
    public ClassData a(ClassId classId) {
        ...
        for (PackageFragmentDescriptor packageFragmentDescriptor : PackageFragmentProviderKt.c(this.f146402a, classId.f())) {
