...
public final class ProtoEnumFlagsUtilsKt {
    ...
    public static final DescriptorVisibility a(ProtoEnumFlags protoEnumFlags, ProtoBuf.Visibility visibility) {
        ...
        switch (visibility == null ? -1 : WhenMappings.$EnumSwitchMapping$2[visibility.ordinal()]) {
            case 1:
                DescriptorVisibility INTERNAL = DescriptorVisibilities.f143599d;
                Intrinsics.i(INTERNAL, "INTERNAL");
                return INTERNAL;
            case 2:
                DescriptorVisibility PRIVATE = DescriptorVisibilities.f143596a;
                Intrinsics.i(PRIVATE, "PRIVATE");
                return PRIVATE;
            case 3:
                DescriptorVisibility PRIVATE_TO_THIS = DescriptorVisibilities.f143597b;
                Intrinsics.i(PRIVATE_TO_THIS, "PRIVATE_TO_THIS");
                return PRIVATE_TO_THIS;
            case 4:
                DescriptorVisibility PROTECTED = DescriptorVisibilities.f143598c;
            ...
            case 6:
                ...
                return LOCAL;
            default:
                DescriptorVisibility PRIVATE2 = DescriptorVisibilities.f143596a;
