...
public final class BuiltInsLoaderImpl implements BuiltInsLoader {
    ...
    private final BuiltInsResourceLoader f146452b = new BuiltInsResourceLoader();
    ...
    public PackageFragmentProvider a(StorageManager storageManager, ModuleDescriptor builtInsModule, Iterable<? extends ClassDescriptorFactory> classDescriptorFactories, PlatformDependentDeclarationFilter platformDependentDeclarationFilter, AdditionalClassPartsProvider additionalClassPartsProvider, boolean z10) {
        ...
        return b(storageManager, builtInsModule, StandardNames.f143293J, classDescriptorFactories, platformDependentDeclarationFilter, additionalClassPartsProvider, z10, new a(this.f146452b));
    }
    ...
    public final PackageFragmentProvider b(StorageManager storageManager, ModuleDescriptor moduleDescriptor, Set<FqName> packageFqNames, Iterable<? extends ClassDescriptorFactory> classDescriptorFactories, PlatformDependentDeclarationFilter platformDependentDeclarationFilter, AdditionalClassPartsProvider additionalClassPartsProvider, boolean z10, Function1<? super String, ? extends InputStream> loadResource) {
        ...
        for (FqName fqName : packageFqNames) {
            InputStream inputStreamInvoke = loadResource.invoke(BuiltInSerializerProtocol.f146451r.r(fqName));
            if (inputStreamInvoke != null) {
                ModuleDescriptor moduleDescriptor2 = module;
                builtInsPackageFragmentImplA = BuiltInsPackageFragmentImpl.f146453o.a(fqName, storageManager, moduleDescriptor2, inputStreamInvoke, z10);
        ...
        DeserializationConfiguration.Default r32 = DeserializationConfiguration.Default.f146392a;
        ...
        DeserializationComponents deserializationComponents = new DeserializationComponents(storageManager2, moduleDescriptor, r32, deserializedClassDataFinder, annotationAndConstantLoaderImpl, packageFragmentProviderImpl, r72, DO_NOTHING, LookupTracker.DO_NOTHING.f144114a, FlexibleTypeDeserializer.ThrowException.f146412a, classDescriptorFactories, notFoundClasses, ContractDeserializer.f146368a.a(), additionalClassPartsProvider, platformDependentDeclarationFilter, builtInSerializerProtocol.e(), null, new SamConversionResolverImpl(storageManager2, CollectionsKt.m()), null, null, 851968, null);
