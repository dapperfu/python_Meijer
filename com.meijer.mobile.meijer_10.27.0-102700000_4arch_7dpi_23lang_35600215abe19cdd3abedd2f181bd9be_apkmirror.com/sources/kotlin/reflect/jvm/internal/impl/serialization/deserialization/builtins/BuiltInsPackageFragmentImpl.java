...
public final class BuiltInsPackageFragmentImpl extends DeserializedPackageFragmentImpl implements BuiltInsPackageFragment {
    ...
    public static final Companion f146453o = new Companion(null);

    /* renamed from: n, reason: collision with root package name */
    private final boolean f146454n;
    ...
    public static final class Companion {
        ...
        public final BuiltInsPackageFragmentImpl a(FqName fqName, StorageManager storageManager, ModuleDescriptor module, InputStream inputStream, boolean z10) {
            ...
            throw new UnsupportedOperationException("Kotlin built-in definition format version is not supported: expected " + BuiltInsBinaryVersion.f145477h + ", actual " + builtInsBinaryVersionB + ". Please update Kotlin");
        }
    }
