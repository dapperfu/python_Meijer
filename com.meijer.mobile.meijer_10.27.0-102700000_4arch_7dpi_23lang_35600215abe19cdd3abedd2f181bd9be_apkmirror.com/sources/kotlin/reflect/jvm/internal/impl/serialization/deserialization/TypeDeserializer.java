...
public final class TypeDeserializer {
    ...
    private final DeserializationContext f146440a;

    /* renamed from: b, reason: collision with root package name */
    private final TypeDeserializer f146441b;

    /* renamed from: c, reason: collision with root package name */
    private final String f146442c;

    /* renamed from: d, reason: collision with root package name */
    private final String f146443d;

    /* renamed from: e, reason: collision with root package name */
    private final Function1<Integer, ClassifierDescriptor> f146444e;

    /* renamed from: f, reason: collision with root package name */
    private final Function1<Integer, ClassifierDescriptor> f146445f;

    /* renamed from: g, reason: collision with root package name */
    private final Map<Integer, TypeParameterDescriptor> f146446g;
    ...
    public TypeDeserializer(DeserializationContext c10, TypeDeserializer typeDeserializer, List<ProtoBuf.TypeParameter> typeParameterProtos, String debugName, String containerPresentableName) {
        ...
        this.f146440a = c10;
        this.f146441b = typeDeserializer;
        this.f146442c = debugName;
        this.f146443d = containerPresentableName;
        this.f146444e = c10.h().g(new m(this));
        this.f146445f = c10.h().g(new n(this));
        if (typeParameterProtos.isEmpty()) {
            ...
            for (ProtoBuf.TypeParameter typeParameter : typeParameterProtos) {
                linkedHashMap.put(Integer.valueOf(typeParameter.N()), new DeserializedTypeParameterDescriptor(this.f146440a, typeParameter, i10));
                i10++;
            }
        }
        this.f146446g = linkedHashMap;
    }
    ...
    private final ClassifierDescriptor g(int i10) {
        ClassId classIdA = NameResolverUtilKt.a(this.f146440a.g(), i10);
        return classIdA.i() ? this.f146440a.c().b(classIdA) : FindClassInModuleKt.c(this.f146440a.c().q(), classIdA);
    }

    private final SimpleType h(int i10) {
        if (NameResolverUtilKt.a(this.f146440a.g(), i10).i()) {
            return this.f146440a.c().o().a();
        }
        return null;
    }
    ...
    private final ClassifierDescriptor i(int i10) {
        ...
        return FindClassInModuleKt.f(this.f146440a.c().q(), classIdA);
    }
    ...
    private final TypeParameterDescriptor n(int i10) {
        TypeParameterDescriptor typeParameterDescriptor = this.f146446g.get(Integer.valueOf(i10));
        if (typeParameterDescriptor != null) {
            return typeParameterDescriptor;
        }
        TypeDeserializer typeDeserializer = this.f146441b;
    ...
    public static final List r(TypeDeserializer typeDeserializer, ProtoBuf.Type type) {
        return typeDeserializer.f146440a.c().d().c(type, typeDeserializer.f146440a.g());
    }
    ...
    private final TypeAttributes s(List<? extends TypeAttributeTranslator> list, Annotations annotations, TypeConstructor typeConstructor, DeclarationDescriptor declarationDescriptor) {
        ...
        return TypeAttributes.f146740b.j(CollectionsKt.z(arrayList));
    }

    private static final ClassDescriptor y(TypeDeserializer typeDeserializer, ProtoBuf.Type type, int i10) {
        ClassId classIdA = NameResolverUtilKt.a(typeDeserializer.f146440a.g(), i10);
        List<Integer> listX = SequencesKt.X(SequencesKt.M(SequencesKt.q(type, new p(typeDeserializer)), q.f146627a));
        ...
        return typeDeserializer.f146440a.c().r().d(classIdA, listX);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final ProtoBuf.Type z(TypeDeserializer typeDeserializer, ProtoBuf.Type it) {
        Intrinsics.j(it, "it");
        return ProtoTypeTableUtilKt.j(it, typeDeserializer.f146440a.j());
    }

    public final List<TypeParameterDescriptor> m() {
        return CollectionsKt.j1(this.f146446g.values());
    }
    ...
    public final SimpleType o(ProtoBuf.Type proto, boolean z10) {
        ...
        if (ErrorUtils.m(typeConstructorX.d())) {
            return ErrorUtils.f146990a.c(ErrorTypeKind.f146975t0, typeConstructorX, typeConstructorX.toString());
        }
        DeserializedAnnotations deserializedAnnotations = new DeserializedAnnotations(this.f146440a.h(), new o(this, proto));
        TypeAttributes typeAttributesS = s(this.f146440a.c().v(), deserializedAnnotations, typeConstructorX, this.f146440a.e());
        ...
        if (z10 && (classifierDescriptorD instanceof TypeAliasDescriptor)) {
            ...
            simpleTypeC = simpleTypeC2.R0(KotlinTypeKt.b(simpleTypeC2) || proto.e0()).Q0(s(this.f146440a.c().v(), Annotations.f143689s3.a(CollectionsKt.N0(deserializedAnnotations, simpleTypeC2.getAnnotations())), typeConstructorX, this.f146440a.e()));
        } else if (Flags.f145513a.d(proto.a0()).booleanValue()) {
            ...
            if (Flags.f145514b.d(proto.a0()).booleanValue()) {
                simpleTypeC = DefinitelyNotNullType.Companion.c(DefinitelyNotNullType.f146687d, simpleTypeK, true, false, 4, null);
                if (simpleTypeC == null) {
        ...
        ProtoBuf.Type typeA = ProtoTypeTableUtilKt.a(proto, this.f146440a.j());
    ...
    public String toString() {
        ...
        sb2.append(this.f146442c);
        if (this.f146441b == null) {
            str = "";
        } else {
            str = ". Child of " + this.f146441b.f146442c;
        }
        sb2.append(str);
        return sb2.toString();
    }
    ...
    public final KotlinType u(ProtoBuf.Type proto) {
        ...
        String string = this.f146440a.g().getString(proto.b0());
        SimpleType simpleTypeQ = q(this, proto, false, 2, null);
        ProtoBuf.Type typeF = ProtoTypeTableUtilKt.f(proto, this.f146440a.j());
        Intrinsics.g(typeF);
        return this.f146440a.c().m().a(proto, string, simpleTypeQ, q(this, typeF, false, 2, null));
    }
    ...
    private final SimpleType k(TypeAttributes typeAttributes, TypeConstructor typeConstructor, List<? extends TypeProjection> list, boolean z10) {
        ...
        if (simpleTypeL == null) {
            return ErrorUtils.f146990a.f(ErrorTypeKind.f146926O, list2, typeConstructor, new String[0]);
        }
        return simpleTypeL;
    }
    ...
    private static final List<ProtoBuf.Type.Argument> p(ProtoBuf.Type type, TypeDeserializer typeDeserializer) {
        ...
        ProtoBuf.Type typeJ = ProtoTypeTableUtilKt.j(type, typeDeserializer.f146440a.j());
        if (typeJ != null) {
    ...
    private final SimpleType t(KotlinType kotlinType) {
        ...
        if (type.I0().size() == 1 && (Intrinsics.e(fqNameO, StandardNames.f143315v) || Intrinsics.e(fqNameO, TypeDeserializerKt.f146448a))) {
            KotlinType type2 = ((TypeProjection) CollectionsKt.U0(type.I0())).getType();
            Intrinsics.i(type2, "getType(...)");
            DeclarationDescriptor declarationDescriptorE = this.f146440a.e();
            ...
            if (Intrinsics.e(fqNameK, SuspendFunctionTypeUtilKt.f146438a)) {
    ...
    private final TypeProjection w(TypeParameterDescriptor typeParameterDescriptor, ProtoBuf.Type.Argument argument) {
        if (argument.y() == ProtoBuf.Type.Argument.Projection.STAR) {
            if (typeParameterDescriptor == null) {
                return new StarProjectionForAbsentTypeParameter(this.f146440a.c().q().l());
            }
        ...
        ProtoBuf.Type typeP = ProtoTypeTableUtilKt.p(argument, this.f146440a.j());
        if (typeP == null) {
            return new TypeProjectionImpl(ErrorUtils.d(ErrorTypeKind.f146985y0, argument.toString()));
        }
    ...
    private final TypeConstructor x(ProtoBuf.Type type) {
        ...
        Object next;
        if (type.m0()) {
            classifierDescriptorInvoke = this.f146444e.invoke(Integer.valueOf(type.X()));
            ...
            if (classifierDescriptorInvoke == null) {
                return ErrorUtils.f146990a.e(ErrorTypeKind.f146924M, String.valueOf(type.i0()), this.f146443d);
            }
        } else if (type.x0()) {
            String string = this.f146440a.g().getString(type.j0());
            ...
            if (classifierDescriptorInvoke == null) {
                return ErrorUtils.f146990a.e(ErrorTypeKind.f146925N, string, this.f146440a.e().toString());
            }
        } else if (type.v0()) {
            classifierDescriptorInvoke = this.f146445f.invoke(Integer.valueOf(type.h0()));
            if (classifierDescriptorInvoke == null) {
                classifierDescriptorInvoke = y(this, type, type.h0());
            }
        } else {
            return ErrorUtils.f146990a.e(ErrorTypeKind.f146928Q, new String[0]);
        }
