...
public abstract class AbstractAnnotationLoader<A> implements AnnotationLoader<A> {
    ...
    private final SerializerExtensionProtocol f146344a;
    ...
    public List<A> a(ProtoContainer container, MessageLite callableProto, AnnotatedCallableKind kind, int i10, ProtoBuf.ValueParameter proto) {
        ...
        List listM = (List) proto.u(this.f146344a.h());
        if (listM == null) {
    ...
    public List<A> b(ProtoContainer.Class container) {
        Intrinsics.j(container, "container");
        List listM = (List) container.f().u(this.f146344a.a());
        if (listM == null) {
            listM = CollectionsKt.m();
        }
        List list = listM;
    ...
    public List<A> c(ProtoBuf.Type proto, NameResolver nameResolver) {
        ...
        List listM = (List) proto.u(this.f146344a.o());
        if (listM == null) {
            listM = CollectionsKt.m();
        }
        List list = listM;
    ...
    public List<A> d(ProtoContainer container, ProtoBuf.EnumEntry proto) {
        Intrinsics.j(container, "container");
        Intrinsics.j(proto, "proto");
        List listM = (List) proto.u(this.f146344a.d());
        if (listM == null) {
            listM = CollectionsKt.m();
        }
        List list = listM;
    ...
    public List<A> e(ProtoContainer container, MessageLite proto, AnnotatedCallableKind kind) {
        ...
        if (proto instanceof ProtoBuf.Constructor) {
            listM = (List) ((ProtoBuf.Constructor) proto).u(this.f146344a.c());
        } else if (proto instanceof ProtoBuf.Function) {
            listM = (List) ((ProtoBuf.Function) proto).u(this.f146344a.f());
        } else {
            ...
            if (i10 == 1) {
                listM = (List) ((ProtoBuf.Property) proto).u(this.f146344a.i());
            } else if (i10 == 2) {
                listM = (List) ((ProtoBuf.Property) proto).u(this.f146344a.m());
            } else {
                if (i10 != 3) {
                    throw new IllegalStateException("Unsupported callable kind with property proto");
                }
                listM = (List) ((ProtoBuf.Property) proto).u(this.f146344a.n());
            }
        }
        if (listM == null) {
            listM = CollectionsKt.m();
    ...
    public List<A> g(ProtoBuf.TypeParameter proto, NameResolver nameResolver) {
        Intrinsics.j(proto, "proto");
        Intrinsics.j(nameResolver, "nameResolver");
        List listM = (List) proto.u(this.f146344a.p());
        if (listM == null) {
            listM = CollectionsKt.m();
        }
        List list = listM;
    ...
    public List<A> j(ProtoContainer container, ProtoBuf.Property proto) {
        Intrinsics.j(container, "container");
        Intrinsics.j(proto, "proto");
        GeneratedMessageLite.GeneratedExtension<ProtoBuf.Property, List<ProtoBuf.Annotation>> generatedExtensionJ = this.f146344a.j();
    ...
    public List<A> k(ProtoContainer container, MessageLite proto, AnnotatedCallableKind kind) {
        ...
        if (proto instanceof ProtoBuf.Function) {
            GeneratedMessageLite.GeneratedExtension<ProtoBuf.Function, List<ProtoBuf.Annotation>> generatedExtensionG = this.f146344a.g();
            ...
            GeneratedMessageLite.GeneratedExtension<ProtoBuf.Property, List<ProtoBuf.Annotation>> generatedExtensionL = this.f146344a.l();
    ...
    public List<A> l(ProtoContainer container, ProtoBuf.Property proto) {
        Intrinsics.j(container, "container");
        Intrinsics.j(proto, "proto");
        GeneratedMessageLite.GeneratedExtension<ProtoBuf.Property, List<ProtoBuf.Annotation>> generatedExtensionK = this.f146344a.k();
