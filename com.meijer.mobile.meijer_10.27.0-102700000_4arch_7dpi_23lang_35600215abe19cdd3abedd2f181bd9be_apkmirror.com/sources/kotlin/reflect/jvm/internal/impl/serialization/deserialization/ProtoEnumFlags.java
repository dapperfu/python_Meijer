...
public final class ProtoEnumFlags {
    ...
    public static final ProtoEnumFlags f146437a = new ProtoEnumFlags();
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            try {
                iArr2[Modality.f143619b.ordinal()] = 1;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                iArr2[Modality.f143621d.ordinal()] = 2;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                iArr2[Modality.f143622e.ordinal()] = 3;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                iArr2[Modality.f143620c.ordinal()] = 4;
            ...
            try {
                iArr5[ClassKind.f143585b.ordinal()] = 1;
            } catch (NoSuchFieldError unused22) {
            }
            try {
                iArr5[ClassKind.f143586c.ordinal()] = 2;
            } catch (NoSuchFieldError unused23) {
            }
            try {
                iArr5[ClassKind.f143587d.ordinal()] = 3;
            } catch (NoSuchFieldError unused24) {
            }
            try {
                iArr5[ClassKind.f143588e.ordinal()] = 4;
            } catch (NoSuchFieldError unused25) {
            }
            try {
                iArr5[ClassKind.f143589f.ordinal()] = 5;
            } catch (NoSuchFieldError unused26) {
            }
            try {
                iArr5[ClassKind.f143590g.ordinal()] = 6;
            ...
            try {
                iArr8[Variance.f146797f.ordinal()] = 1;
            } catch (NoSuchFieldError unused35) {
            }
            try {
                iArr8[Variance.f146798g.ordinal()] = 2;
            } catch (NoSuchFieldError unused36) {
            }
            try {
                iArr8[Variance.f146796e.ordinal()] = 3;
    ...
    public final ClassKind a(ProtoBuf.Class.Kind kind) {
        switch (kind == null ? -1 : WhenMappings.$EnumSwitchMapping$3[kind.ordinal()]) {
            ...
            case 3:
                return ClassKind.f143587d;
            case 4:
                return ClassKind.f143588e;
            case 5:
                return ClassKind.f143589f;
            case 6:
            case 7:
                return ClassKind.f143590g;
            default:
                return ClassKind.f143585b;
        }
    }
    ...
    public final Modality b(ProtoBuf.Modality modality) {
        ...
        return i10 != 1 ? i10 != 2 ? i10 != 3 ? i10 != 4 ? Modality.f143619b : Modality.f143620c : Modality.f143622e : Modality.f143621d : Modality.f143619b;
    }
