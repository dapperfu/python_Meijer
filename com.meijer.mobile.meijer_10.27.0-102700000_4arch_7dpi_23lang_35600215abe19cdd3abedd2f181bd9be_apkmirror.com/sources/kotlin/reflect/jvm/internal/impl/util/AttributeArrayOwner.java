...
public abstract class AttributeArrayOwner<K, T> extends AbstractArrayMapOwner<K, T> {
    ...
    protected final void h(String keyQualifiedName, T value) {
        ...
        int iA = this.f147054a.a();
        if (iA == 0) {
            ArrayMap<T> arrayMap = this.f147054a;
            if (!(arrayMap instanceof EmptyArrayMap)) {
                throw new IllegalStateException(n(arrayMap, 0, "EmptyArrayMap"));
            }
            this.f147054a = new OneElementArrayMap(value, iE);
            return;
        }
        if (iA == 1) {
            ArrayMap<T> arrayMap2 = this.f147054a;
            try {
                ...
                if (oneElementArrayMap.h() == iE) {
                    ...
                    this.f147054a = arrayMapImpl;
                }
            } catch (ClassCastException e10) {
                throw new IllegalStateException(n(arrayMap2, 1, "OneElementArrayMap"), e10);
            }
        }
        this.f147054a.f(iE, value);
    }

    /* JADX WARN: Illegal instructions before constructor call */
    public AttributeArrayOwner() {
        EmptyArrayMap emptyArrayMap = EmptyArrayMap.f147067a;
