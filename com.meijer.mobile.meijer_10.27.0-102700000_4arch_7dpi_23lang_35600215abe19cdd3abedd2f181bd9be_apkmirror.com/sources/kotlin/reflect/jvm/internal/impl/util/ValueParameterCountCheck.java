...
public abstract class ValueParameterCountCheck implements Check {
    ...
    private final String f147145a;

    public static final class AtLeast extends ValueParameterCountCheck {

        /* renamed from: b, reason: collision with root package name */
        private final int f147146b;
        ...
        public boolean b(FunctionDescriptor functionDescriptor) {
            ...
            return functionDescriptor.h().size() >= this.f147146b;
        }
    }
    ...
    public static final class Equals extends ValueParameterCountCheck {
        ...
        public boolean b(FunctionDescriptor functionDescriptor) {
            Intrinsics.j(functionDescriptor, "functionDescriptor");
            return functionDescriptor.h().size() == this.f147147b;
        }
    }
    ...
    public static final class NoValueParameters extends ValueParameterCountCheck {
        ...
        /* renamed from: b, reason: collision with root package name */
        public static final NoValueParameters f147148b = new NoValueParameters();
    ...
    public static final class SingleValueParameter extends ValueParameterCountCheck {
        ...
        /* renamed from: b, reason: collision with root package name */
        public static final SingleValueParameter f147149b = new SingleValueParameter();
