...
public final class Checks {
    ...
    private final Name f147059a;

    /* renamed from: b, reason: collision with root package name */
    private final Regex f147060b;

    /* renamed from: c, reason: collision with root package name */
    private final Collection<Name> f147061c;

    /* renamed from: d, reason: collision with root package name */
    private final Function1<FunctionDescriptor, String> f147062d;

    /* renamed from: e, reason: collision with root package name */
    private final Check[] f147063e;
    ...
    static final class b implements Function1 {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final b f147065a = new b();
    ...
    static final class c implements Function1 {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final c f147066a = new c();
    ...
    private Checks(Name name, Regex regex, Collection<Name> collection, Function1<? super FunctionDescriptor, String> function1, Check... checkArr) {
        this.f147059a = name;
        this.f147060b = regex;
        this.f147061c = collection;
        this.f147062d = function1;
        this.f147063e = checkArr;
    }

    public final CheckResult a(FunctionDescriptor functionDescriptor) {
        Intrinsics.j(functionDescriptor, "functionDescriptor");
        for (Check check : this.f147063e) {
            String strA = check.a(functionDescriptor);
            if (strA != null) {
                return new CheckResult.IllegalSignature(strA);
            }
        }
        String strInvoke = this.f147062d.invoke(functionDescriptor);
        return strInvoke != null ? new CheckResult.IllegalSignature(strInvoke) : CheckResult.SuccessCheck.f147058b;
    }

    public final boolean b(FunctionDescriptor functionDescriptor) {
        Intrinsics.j(functionDescriptor, "functionDescriptor");
        if (this.f147059a != null && !Intrinsics.e(functionDescriptor.getName(), this.f147059a)) {
            return false;
        }
        if (this.f147060b != null) {
            String strB = functionDescriptor.getName().b();
            Intrinsics.i(strB, "asString(...)");
            if (!this.f147060b.j(strB)) {
                return false;
            }
        }
        Collection<Name> collection = this.f147061c;
    ...
    public /* synthetic */ Checks(Name name, Check[] checkArr, Function1 function1, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(name, checkArr, (Function1<? super FunctionDescriptor, String>) ((i10 & 4) != 0 ? a.f147064a : function1));
    }
    ...
    public /* synthetic */ Checks(Regex regex, Check[] checkArr, Function1 function1, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(regex, checkArr, (Function1<? super FunctionDescriptor, String>) ((i10 & 4) != 0 ? b.f147065a : function1));
    }
    ...
    public /* synthetic */ Checks(Collection collection, Check[] checkArr, Function1 function1, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this((Collection<Name>) collection, checkArr, (Function1<? super FunctionDescriptor, String>) ((i10 & 4) != 0 ? c.f147066a : function1));
    }
