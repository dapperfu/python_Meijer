...
public final class JvmPackageScope implements MemberScope {
    ...
    static final /* synthetic */ KProperty<Object>[] f144453f = {Reflection.j(new PropertyReference1Impl(JvmPackageScope.class, "kotlinScopes", "getKotlinScopes()[Lorg/jetbrains/kotlin/resolve/scopes/MemberScope;", 0))};

    /* renamed from: b, reason: collision with root package name */
    private final LazyJavaResolverContext f144454b;

    /* renamed from: c, reason: collision with root package name */
    private final LazyJavaPackageFragment f144455c;

    /* renamed from: d, reason: collision with root package name */
    private final LazyJavaPackageScope f144456d;

    /* renamed from: e, reason: collision with root package name */
    private final NotNullLazyValue f144457e;
    ...
    public JvmPackageScope(LazyJavaResolverContext c10, JavaPackage jPackage, LazyJavaPackageFragment packageFragment) {
        ...
        this.f144454b = c10;
        this.f144455c = packageFragment;
        this.f144456d = new LazyJavaPackageScope(c10, jPackage, packageFragment);
        this.f144457e = c10.e().c(new C15237b(this));
    }

    private final MemberScope[] j() {
        return (MemberScope[]) StorageKt.a(this.f144457e, this, f144453f[0]);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final MemberScope[] k(JvmPackageScope jvmPackageScope) {
        Collection<KotlinJvmBinaryClass> collectionValues = jvmPackageScope.f144455c.L0().values();
        ArrayList arrayList = new ArrayList();
        Iterator<T> it = collectionValues.iterator();
        while (it.hasNext()) {
            MemberScope memberScopeC = jvmPackageScope.f144454b.a().b().c(jvmPackageScope.f144455c, (KotlinJvmBinaryClass) it.next());
    ...
    public Collection<SimpleFunctionDescriptor> b(Name name, LookupLocation location) {
        ...
        l(name, location);
        LazyJavaPackageScope lazyJavaPackageScope = this.f144456d;
    ...
    public ClassifierDescriptor f(Name name, LookupLocation location) {
        ...
        Intrinsics.j(location, "location");
        l(name, location);
        ClassDescriptor classDescriptorL0 = this.f144456d.f(name, location);
    ...
    public final LazyJavaPackageScope i() {
        return this.f144456d;
    }

    public void l(Name name, LookupLocation location) {
        Intrinsics.j(name, "name");
        Intrinsics.j(location, "location");
        UtilsKt.b(this.f144454b.a().l(), location, this.f144455c, name);
    }

    public String toString() {
        return "scope for " + this.f144455c;
    }
    ...
    public Set<Name> a() {
        ...
        linkedHashSet.addAll(this.f144456d.a());
    ...
    public Set<Name> d() {
        ...
        linkedHashSet.addAll(this.f144456d.d());
        return linkedHashSet;
    }
