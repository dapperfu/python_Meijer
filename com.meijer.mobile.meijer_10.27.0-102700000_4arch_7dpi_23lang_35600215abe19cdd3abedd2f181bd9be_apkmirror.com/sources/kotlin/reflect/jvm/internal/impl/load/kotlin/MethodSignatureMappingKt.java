...
public final class MethodSignatureMappingKt {
    ...
    public static final boolean e(CallableDescriptor f10) {
        ...
        if (Intrinsics.e(functionDescriptor.getName().b(), "remove") && functionDescriptor.h().size() == 1 && !SpecialBuiltinMembers.n((CallableMemberDescriptor) f10)) {
            ...
            if (Intrinsics.e(DescriptorUtilsKt.p(declarationDescriptorB), StandardNames.FqNames.f143379f0.i()) && (jvmTypeG2 instanceof JvmType.Object) && Intrinsics.e(((JvmType.Object) jvmTypeG2).i(), "java/lang/Object")) {
                return true;
            }
        }
        return false;
    ...
    public static final String f(ClassDescriptor classDescriptor) {
        ...
        ClassId classIdN = JavaToKotlinClassMap.f143492a.n(DescriptorUtilsKt.o(classDescriptor).i());
        if (classIdN == null) {
    ...
    public static final JvmType g(KotlinType kotlinType) {
        ...
        return (JvmType) DescriptorBasedTypeSignatureMappingKt.e(kotlinType, JvmTypeFactoryImpl.f144817a, TypeMappingMode.f144835o, TypeMappingConfigurationImpl.f144830a, null, null, 32, null);
    }
