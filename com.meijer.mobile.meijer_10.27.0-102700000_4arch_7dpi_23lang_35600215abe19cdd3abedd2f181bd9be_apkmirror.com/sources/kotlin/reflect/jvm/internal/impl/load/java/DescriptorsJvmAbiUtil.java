...
public final class DescriptorsJvmAbiUtil {
    ...
    public static boolean b(CallableMemberDescriptor callableMemberDescriptor) {
        ...
        if ((callableMemberDescriptor instanceof PropertyDescriptor) && (fieldDescriptorT0 = ((PropertyDescriptor) callableMemberDescriptor).t0()) != null && fieldDescriptorT0.getAnnotations().p3(JvmAbi.f144217b)) {
            return true;
        }
        return callableMemberDescriptor.getAnnotations().p3(JvmAbi.f144217b);
    }
    ...
    public static boolean d(ClassDescriptor classDescriptor) {
        ...
        return CompanionObjectMappingUtilsKt.a(CompanionObjectMapping.f143236a, classDescriptor);
    }
}
