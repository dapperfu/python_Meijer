...
public class JavaPropertyDescriptor extends PropertyDescriptorImpl implements JavaCallableMemberDescriptor {
    ...
    private final boolean f144374C;

    /* renamed from: D, reason: collision with root package name */
    private final Pair<CallableDescriptor.UserDataKey<?>, ?> f144375D;

    /* renamed from: E, reason: collision with root package name */
    private KotlinType f144376E;
    ...
    protected PropertyDescriptorImpl N0(DeclarationDescriptor declarationDescriptor, Modality modality, DescriptorVisibility descriptorVisibility, PropertyDescriptor propertyDescriptor, CallableMemberDescriptor.Kind kind, Name name, SourceElement sourceElement) {
        ...
        return new JavaPropertyDescriptor(declarationDescriptor, getAnnotations(), modality, descriptorVisibility, L(), name, sourceElement, propertyDescriptor, kind, this.f144374C, this.f144375D);
    }
    ...
    public JavaCallableMemberDescriptor Y(KotlinType kotlinType, List<KotlinType> list, KotlinType kotlinType2, Pair<CallableDescriptor.UserDataKey<?>, ?> pair) {
        ...
        JavaPropertyDescriptor javaPropertyDescriptor = new JavaPropertyDescriptor(b(), getAnnotations(), q(), getVisibility(), L(), getName(), g(), propertyDescriptorH0, f(), this.f144374C, pair);
        ...
        Function0<NullableLazyValue<ConstantValue<?>>> function0 = this.f144017h;
        if (function0 != null) {
            javaPropertyDescriptor.I0(this.f144016g, function0);
        }
        javaPropertyDescriptor.A0(d());
        javaPropertyDescriptor.Z0(kotlinType2, getTypeParameters(), J(), kotlinType != null ? DescriptorFactory.i(this, kotlinType, Annotations.f143689s3.b()) : null, CollectionsKt.m());
    ...
    public <V> V r0(CallableDescriptor.UserDataKey<V> userDataKey) {
        Pair<CallableDescriptor.UserDataKey<?>, ?> pair = this.f144375D;
        if (pair == null || !pair.c().equals(userDataKey)) {
            return null;
        }
        return (V) this.f144375D.d();
    }
    ...
    public boolean isConst() {
        ...
        if (this.f144374C && ConstUtil.a(type)) {
