...
public final class SignatureBuildingComponents {
    ...
    public static final SignatureBuildingComponents f144829a = new SignatureBuildingComponents();

    /* JADX INFO: Access modifiers changed from: private */
    public static final CharSequence l(String it) {
        Intrinsics.j(it, "it");
        return f144829a.c(it);
    }
    ...
    public final String k(String name, List<String> parameters, String ret) {
        ...
        return name + '(' + CollectionsKt.B0(parameters, "", null, null, 0, null, e.f144855a, 30, null) + ')' + c(ret);
    }
