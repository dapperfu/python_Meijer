...
public final class JavaTypeResolver {
    ...
    private final LazyJavaResolverContext f144591a;

    /* renamed from: b, reason: collision with root package name */
    private final TypeParameterResolver f144592b;

    /* renamed from: c, reason: collision with root package name */
    private final RawProjectionComputer f144593c;

    /* renamed from: d, reason: collision with root package name */
    private final TypeParameterUpperBoundEraser f144594d;
    ...
    public JavaTypeResolver(LazyJavaResolverContext c10, TypeParameterResolver typeParameterResolver) {
        ...
        this.f144591a = c10;
        this.f144592b = typeParameterResolver;
        RawProjectionComputer rawProjectionComputer = new RawProjectionComputer();
        this.f144593c = rawProjectionComputer;
        this.f144594d = new TypeParameterUpperBoundEraser(rawProjectionComputer, null, 2, 0 == true ? 1 : 0);
    }
    ...
    private final List<TypeProjection> d(JavaClassifierType javaClassifierType, List<? extends TypeParameterDescriptor> list, TypeConstructor typeConstructor, JavaTypeAttributes javaTypeAttributes) {
        ...
        for (TypeParameterDescriptor typeParameterDescriptor : list2) {
            if (TypeUtilsKt.q(typeParameterDescriptor, null, javaTypeAttributes.c())) {
                ...
                typeConstructor2 = typeConstructor;
                javaTypeAttributes2 = javaTypeAttributes;
                typeProjectionA = this.f144593c.a(typeParameterDescriptor, javaTypeAttributes2.j(javaClassifierType2.t()), this.f144594d, new LazyWrappedType(this.f144591a.e(), new a(this, typeParameterDescriptor, javaTypeAttributes2, typeConstructor2, javaClassifierType2)));
            }
    ...
    public static final KotlinType e(JavaTypeResolver javaTypeResolver, TypeParameterDescriptor typeParameterDescriptor, JavaTypeAttributes javaTypeAttributes, TypeConstructor typeConstructor, JavaClassifierType javaClassifierType) {
        TypeParameterUpperBoundEraser typeParameterUpperBoundEraser = javaTypeResolver.f144594d;
    ...
    private final SimpleType f(JavaClassifierType javaClassifierType, JavaTypeAttributes javaTypeAttributes, SimpleType simpleType) {
        ...
        if (simpleType == null || (typeAttributesB = simpleType.J0()) == null) {
            javaClassifierType2 = javaClassifierType;
            typeAttributesB = TypeAttributesKt.b(new LazyJavaAnnotations(this.f144591a, javaClassifierType2, false, 4, null));
        } else {
            javaClassifierType2 = javaClassifierType;
        }
    ...
    private final TypeConstructor h(JavaClassifierType javaClassifierType) {
        TypeConstructor typeConstructorI = this.f144591a.a().b().f().r().d(ClassId.f145674d.c(new FqName(javaClassifierType.I())), CollectionsKt.e(0)).i();
    ...
    private static final ErrorType o(JavaClassifierType javaClassifierType) {
        return ErrorUtils.d(ErrorTypeKind.f146946f, javaClassifierType.F());
    }
    ...
    private final TypeProjection q(JavaType javaType, JavaTypeAttributes javaTypeAttributes, TypeParameterDescriptor typeParameterDescriptor) {
        if (!(javaType instanceof JavaWildcardType)) {
            return new TypeProjectionImpl(Variance.f146796e, p(javaType, javaTypeAttributes));
        }
        JavaWildcardType javaWildcardType = (JavaWildcardType) javaType;
        JavaType javaTypeX = javaWildcardType.x();
        Variance variance = javaWildcardType.M() ? Variance.f146798g : Variance.f146797f;
        ...
        AnnotationDescriptor annotationDescriptorA = UtilsKt.a(this.f144591a, javaWildcardType);
        KotlinType kotlinTypeP = p(javaTypeX, JavaTypeAttributesKt.b(TypeUsage.f146788b, false, false, null, 7, null));
        if (annotationDescriptorA != null) {
            kotlinTypeP = TypeUtilsKt.C(kotlinTypeP, Annotations.f143689s3.a(CollectionsKt.O0(kotlinTypeP.getAnnotations(), annotationDescriptorA)));
        }
    ...
    public final KotlinType l(JavaArrayType arrayType, JavaTypeAttributes attr, boolean z10) {
        ...
        LazyJavaAnnotations lazyJavaAnnotations = new LazyJavaAnnotations(this.f144591a, arrayType, true);
        if (type != null) {
            SimpleType simpleTypeP = this.f144591a.d().l().P(type);
        ...
        KotlinType kotlinTypeP = p(javaTypeN, JavaTypeAttributesKt.b(TypeUsage.f146788b, attr.h(), false, null, 6, null));
        if (attr.h()) {
            SimpleType simpleTypeN = this.f144591a.d().l().n(z10 ? Variance.f146798g : Variance.f146796e, kotlinTypeP, lazyJavaAnnotations);
            Intrinsics.i(simpleTypeN, "getArrayType(...)");
            return simpleTypeN;
        }
        SimpleType simpleTypeN2 = this.f144591a.d().l().n(Variance.f146796e, kotlinTypeP, lazyJavaAnnotations);
        Intrinsics.i(simpleTypeN2, "getArrayType(...)");
        return KotlinTypeFactory.e(simpleTypeN2, this.f144591a.d().l().n(Variance.f146798g, kotlinTypeP, lazyJavaAnnotations).R0(true));
    }
    ...
    public final KotlinType p(JavaType javaType, JavaTypeAttributes attr) {
        ...
        if (javaType instanceof JavaPrimitiveType) {
            ...
            SimpleType simpleTypeS = type != null ? this.f144591a.d().l().S(type) : this.f144591a.d().l().a0();
        ...
        if (javaType instanceof JavaWildcardType) {
            ...
            SimpleType simpleTypeZ = this.f144591a.d().l().z();
            Intrinsics.i(simpleTypeZ, "getDefaultBound(...)");
            return simpleTypeZ;
        }
        if (javaType == null) {
            SimpleType simpleTypeZ2 = this.f144591a.d().l().z();
    ...
    private final boolean b(JavaClassifierType javaClassifierType, ClassDescriptor classDescriptor) {
        ...
        List<TypeParameterDescriptor> parameters = JavaToKotlinClassMapper.f143512a.b(classDescriptor).i().getParameters();
        ...
        if (typeParameterDescriptor == null || (varianceK = typeParameterDescriptor.k()) == null || varianceK == Variance.f146798g) {
            return false;
        }
        return true;
    }
    ...
    */
    private final java.util.List<kotlin.reflect.jvm.internal.impl.types.TypeProjection> c(kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClassifierType r10, kotlin.reflect.jvm.internal.impl.load.java.lazy.types.JavaTypeAttributes r11, kotlin.reflect.jvm.internal.impl.types.TypeConstructor r12) {
        ...
        L52:
            ...
            kotlin.reflect.jvm.internal.impl.types.error.ErrorTypeKind r1 = kotlin.reflect.jvm.internal.impl.types.error.ErrorTypeKind.f146933V
        ...
        L95:
            ...
            kotlin.reflect.jvm.internal.impl.types.TypeUsage r3 = kotlin.reflect.jvm.internal.impl.types.TypeUsage.f146788b
            r7 = 7
            r8 = 0
            r4 = 0
            r5 = 0
    ...
    private final TypeConstructor g(JavaClassifierType javaClassifierType, JavaTypeAttributes javaTypeAttributes) {
        ...
        if (javaClassifierC instanceof JavaClass) {
            ...
            if (fqNameE != null) {
                ...
                if (classDescriptorK == null) {
                    classDescriptorK = this.f144591a.a().n().a(javaClass);
                }
        ...
        if (javaClassifierC instanceof JavaTypeParameter) {
            TypeParameterDescriptor typeParameterDescriptorA = this.f144592b.a((JavaTypeParameter) javaClassifierC);
    ...
    private final boolean i(Variance variance, TypeParameterDescriptor typeParameterDescriptor) {
        if (typeParameterDescriptor.k() == Variance.f146796e || variance == typeParameterDescriptor.k()) {
            return false;
        }
        return true;
    }
    ...
    private final boolean j(JavaTypeAttributes javaTypeAttributes) {
        if (javaTypeAttributes.g() == JavaTypeFlexibility.f144588c || javaTypeAttributes.h() || javaTypeAttributes.b() == TypeUsage.f146787a) {
            return false;
        }
        return true;
    }
    ...
    private final ClassDescriptor k(JavaClassifierType javaClassifierType, JavaTypeAttributes javaTypeAttributes, FqName fqName) {
        if (javaTypeAttributes.h() && Intrinsics.e(fqName, JavaTypeResolverKt.f144595a)) {
            return this.f144591a.a().p().d();
        }
        JavaToKotlinClassMapper javaToKotlinClassMapper = JavaToKotlinClassMapper.f143512a;
        ClassDescriptor classDescriptorF = JavaToKotlinClassMapper.f(javaToKotlinClassMapper, fqName, this.f144591a.d().l(), null, 4, null);
        if (classDescriptorF == null) {
            return null;
        }
        if (javaToKotlinClassMapper.d(classDescriptorF) && (javaTypeAttributes.g() == JavaTypeFlexibility.f144588c || javaTypeAttributes.b() == TypeUsage.f146787a || b(javaClassifierType, classDescriptorF))) {
    ...
    private final KotlinType n(JavaClassifierType javaClassifierType, JavaTypeAttributes javaTypeAttributes) {
        boolean z10;
        if (!javaTypeAttributes.h() && javaTypeAttributes.b() != TypeUsage.f146787a) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        SimpleType simpleTypeF2 = f(javaClassifierType, javaTypeAttributes.l(JavaTypeFlexibility.f144588c), null);
        if (simpleTypeF2 == null) {
            return o(javaClassifierType);
        }
        SimpleType simpleTypeF3 = f(javaClassifierType, javaTypeAttributes.l(JavaTypeFlexibility.f144587b), simpleTypeF2);
