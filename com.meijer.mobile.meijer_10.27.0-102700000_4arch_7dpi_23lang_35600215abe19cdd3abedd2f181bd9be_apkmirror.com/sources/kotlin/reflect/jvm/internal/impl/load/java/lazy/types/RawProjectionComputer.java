...
public final class RawProjectionComputer extends ErasureProjectionComputer {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            try {
                iArr[JavaTypeFlexibility.f144588c.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[JavaTypeFlexibility.f144587b.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[JavaTypeFlexibility.f144586a.ordinal()] = 3;
    ...
    public TypeProjection a(TypeParameterDescriptor parameter, ErasureTypeAttributes typeAttr, TypeParameterUpperBoundEraser typeParameterUpperBoundEraser, KotlinType erasedUpperBound) {
        ...
        if (!javaTypeAttributesL.i()) {
            javaTypeAttributesL = javaTypeAttributesL.l(JavaTypeFlexibility.f144586a);
        }
        int i10 = WhenMappings.$EnumSwitchMapping$0[javaTypeAttributesL.g().ordinal()];
        if (i10 == 1) {
            return new TypeProjectionImpl(Variance.f146796e, erasedUpperBound);
        }
        if (i10 != 2 && i10 != 3) {
            throw new NoWhenBranchMatchedException();
        }
        if (!parameter.k().b()) {
            return new TypeProjectionImpl(Variance.f146796e, DescriptorUtilsKt.m(parameter).I());
        }
