...
public interface SignaturePropagator {
    ...
    public static final SignaturePropagator f144344a = new a();

    public static class PropagatedSignature {

        /* renamed from: a, reason: collision with root package name */
        private final KotlinType f144345a;

        /* renamed from: b, reason: collision with root package name */
        private final KotlinType f144346b;

        /* renamed from: c, reason: collision with root package name */
        private final List<ValueParameterDescriptor> f144347c;

        /* renamed from: d, reason: collision with root package name */
        private final List<TypeParameterDescriptor> f144348d;

        /* renamed from: e, reason: collision with root package name */
        private final List<String> f144349e;

        /* renamed from: f, reason: collision with root package name */
        private final boolean f144350f;
        ...
        public PropagatedSignature(KotlinType kotlinType, KotlinType kotlinType2, List<ValueParameterDescriptor> list, List<TypeParameterDescriptor> list2, List<String> list3, boolean z10) {
            ...
            this.f144345a = kotlinType;
            this.f144346b = kotlinType2;
            this.f144347c = list;
            this.f144348d = list2;
            this.f144349e = list3;
            this.f144350f = z10;
        ...
        public List<String> b() {
            List<String> list = this.f144349e;
            if (list == null) {
                a(7);
            }
            return list;
        ...
        public KotlinType d() {
            KotlinType kotlinType = this.f144345a;
            if (kotlinType == null) {
                a(4);
            }
            return kotlinType;
        ...
        public List<TypeParameterDescriptor> e() {
            List<TypeParameterDescriptor> list = this.f144348d;
            if (list == null) {
                a(6);
            }
            return list;
        ...
        public List<ValueParameterDescriptor> f() {
            List<ValueParameterDescriptor> list = this.f144347c;
            if (list == null) {
                a(5);
            }
            return list;
