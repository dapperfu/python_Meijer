...
public class JavaClassConstructorDescriptor extends ClassConstructorDescriptorImpl implements JavaCallableMemberDescriptor {
    ...
    private Boolean f144358F;

    /* renamed from: G, reason: collision with root package name */
    private Boolean f144359G;
    ...
    public boolean N0() {
        return this.f144358F.booleanValue();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.impl.FunctionDescriptorImpl, kotlin.reflect.jvm.internal.impl.descriptors.CallableDescriptor
    public boolean d0() {
        return this.f144359G.booleanValue();
    }
    ...
    protected JavaClassConstructorDescriptor p1(ClassDescriptor classDescriptor, JavaClassConstructorDescriptor javaClassConstructorDescriptor, CallableMemberDescriptor.Kind kind, SourceElement sourceElement, Annotations annotations) {
        ...
        return new JavaClassConstructorDescriptor(classDescriptor, javaClassConstructorDescriptor, annotations, this.f143817E, kind, sourceElement);
    }
    ...
    public JavaClassConstructorDescriptor Y(KotlinType kotlinType, List<KotlinType> list, KotlinType kotlinType2, Pair<CallableDescriptor.UserDataKey<?>, ?> pair) {
        ...
        javaClassConstructorDescriptorI0.O0(kotlinType == null ? null : DescriptorFactory.i(javaClassConstructorDescriptorI0, kotlinType, Annotations.f143689s3.b()), J(), CollectionsKt.m(), getTypeParameters(), UtilKt.a(list, h(), javaClassConstructorDescriptorI0), kotlinType2, q(), getVisibility());
        if (pair != null) {
    ...
    public void V0(boolean z10) {
        this.f144358F = Boolean.valueOf(z10);
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.impl.FunctionDescriptorImpl
    public void W0(boolean z10) {
        this.f144359G = Boolean.valueOf(z10);
    }
}
