...
public class JavaAnnotationDescriptor implements PossiblyExternalAnnotationDescriptor {
    ...
    static final /* synthetic */ KProperty<Object>[] f144322f = {Reflection.j(new PropertyReference1Impl(JavaAnnotationDescriptor.class, "type", "getType()Lorg/jetbrains/kotlin/types/SimpleType;", 0))};

    /* renamed from: a, reason: collision with root package name */
    private final FqName f144323a;

    /* renamed from: b, reason: collision with root package name */
    private final SourceElement f144324b;

    /* renamed from: c, reason: collision with root package name */
    private final NotNullLazyValue f144325c;

    /* renamed from: d, reason: collision with root package name */
    private final JavaAnnotationArgument f144326d;

    /* renamed from: e, reason: collision with root package name */
    private final boolean f144327e;
    ...
    public JavaAnnotationDescriptor(LazyJavaResolverContext c10, JavaAnnotation javaAnnotation, FqName fqName) {
        ...
        this.f144323a = fqName;
        if (javaAnnotation == null || (NO_SOURCE = c10.a().t().a(javaAnnotation)) == null) {
            NO_SOURCE = SourceElement.f143647a;
            Intrinsics.i(NO_SOURCE, "NO_SOURCE");
        }
        this.f144324b = NO_SOURCE;
        this.f144325c = c10.e().c(new a(c10, this));
        this.f144326d = (javaAnnotation == null || (collectionD = javaAnnotation.d()) == null) ? null : (JavaAnnotationArgument) CollectionsKt.t0(collectionD);
        boolean z10 = false;
    ...
    protected final JavaAnnotationArgument c() {
        return this.f144326d;
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.annotations.AnnotationDescriptor
    /* renamed from: d, reason: merged with bridge method [inline-methods] */
    public SimpleType getType() {
        return (SimpleType) StorageKt.a(this.f144325c, this, f144322f[0]);
    }
