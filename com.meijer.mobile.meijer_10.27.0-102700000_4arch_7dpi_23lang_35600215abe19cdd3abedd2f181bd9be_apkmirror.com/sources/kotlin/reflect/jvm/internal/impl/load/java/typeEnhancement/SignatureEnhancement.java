...
public final class SignatureEnhancement {
    ...
    private final KotlinType i(d0 d0Var, KotlinType kotlinType, List<? extends KotlinType> list, TypeEnhancementInfo typeEnhancementInfo, boolean z10) {
        return this.f144670a.a(kotlinType, d0Var.d(kotlinType, list, typeEnhancementInfo, z10), d0Var.z());
    }
    ...
    */
    ...
    public final KotlinType q(KotlinType type, LazyJavaResolverContext context) {
        ...
        KotlinType kotlinTypeK = k(this, new d0(null, false, context, AnnotationQualifierApplicabilityType.f144155e, true), type, CollectionsKt.m(), null, false, 12, null);
    ...
    public final List<KotlinType> r(TypeParameterDescriptor typeParameter, List<? extends KotlinType> bounds, LazyJavaResolverContext context) {
        ...
        for (KotlinType kotlinType2 : list) {
            if (TypeUtilsKt.e(kotlinType2, b0.f144699a)) {
                kotlinType = kotlinType2;
            } else {
                kotlinType = kotlinType2;
                kotlinTypeK = k(this, new d0(typeParameter, false, context, AnnotationQualifierApplicabilityType.f144156f, false, 16, null), kotlinType, CollectionsKt.m(), null, false, 12, null);
                if (kotlinTypeK == null) {
                }
    ...
    private final <D extends CallableMemberDescriptor> Annotations u(D d10, LazyJavaResolverContext lazyJavaResolverContext) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            return Annotations.f143689s3.a(CollectionsKt.N0(d10.getAnnotations(), arrayList));
        }
        return d10.getAnnotations();
    }
}
