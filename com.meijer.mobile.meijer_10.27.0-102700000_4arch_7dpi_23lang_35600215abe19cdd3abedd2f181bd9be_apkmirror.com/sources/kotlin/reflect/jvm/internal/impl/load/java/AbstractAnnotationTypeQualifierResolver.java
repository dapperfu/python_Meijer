...
public abstract class AbstractAnnotationTypeQualifierResolver<TAnnotation> {
    ...
    private static final a f144148c = new a(null);

    /* renamed from: d, reason: collision with root package name */
    private static final Map<String, AnnotationQualifierApplicabilityType> f144149d;

    /* renamed from: a, reason: collision with root package name */
    private final JavaTypeEnhancementState f144150a;

    /* renamed from: b, reason: collision with root package name */
    private final ConcurrentHashMap<Object, TAnnotation> f144151b;
    ...
    public AbstractAnnotationTypeQualifierResolver(JavaTypeEnhancementState javaTypeEnhancementState) {
        ...
        this.f144150a = javaTypeEnhancementState;
        this.f144151b = new ConcurrentHashMap<>();
    }

    /* JADX WARN: Multi-variable type inference failed */
    private final Set<AnnotationQualifierApplicabilityType> b(Set<? extends AnnotationQualifierApplicabilityType> set) {
        return set.contains(AnnotationQualifierApplicabilityType.f144155e) ? SetsKt.l(SetsKt.k(ArraysKt.u1(AnnotationQualifierApplicabilityType.values()), AnnotationQualifierApplicabilityType.f144156f), set) : set;
    }

    private final ReportLevel t(TAnnotation tannotation) {
        Iterable<String> iterableC;
        String str;
        ReportLevel reportLevel = this.f144150a.d().e().get(k(tannotation));
        if (reportLevel != null) {
            return reportLevel;
        }
        ...
        ReportLevel reportLevelD = this.f144150a.d().d();
        ...
        if (iHashCode != -2137067054) {
            if (iHashCode != -1838656823) {
                if (iHashCode == 2656902 && str.equals("WARN")) {
                    return ReportLevel.f144277d;
                }
            } else if (str.equals("STRICT")) {
                return ReportLevel.f144278e;
            }
        } else if (str.equals("IGNORE")) {
            return ReportLevel.f144276c;
        }
        return null;
    }
    ...
    private final JavaDefaultQualifiers u(TAnnotation tannotation) {
        ...
        if (this.f144150a.b() || (javaDefaultQualifiers = JavaDefaultQualifiersKt.a().get(k(tannotation))) == null) {
            return null;
        }
        ReportLevel reportLevelR = r(tannotation);
        if (reportLevelR == ReportLevel.f144276c) {
            reportLevelR = null;
        }
    ...
    private final Pair<TAnnotation, Set<AnnotationQualifierApplicabilityType>> w(TAnnotation tannotation) {
        ...
        TAnnotation next;
        if (this.f144150a.d().f() || (tannotationJ = j(tannotation, JvmAnnotationNamesKt.g())) == null) {
            return null;
        }
        ...
        while (it2.hasNext()) {
            AnnotationQualifierApplicabilityType annotationQualifierApplicabilityType = f144149d.get(it2.next());
    ...
    public final boolean p(TAnnotation annotation) {
        ...
        TAnnotation tannotationJ = j(annotation, StandardNames.FqNames.f143334H);
    ...
    public final TAnnotation v(TAnnotation annotation) {
        ...
        ConcurrentHashMap<Object, TAnnotation> concurrentHashMap = this.f144151b;
    ...
    private final JavaDefaultQualifiers e(TAnnotation tannotation) {
        ...
        if (reportLevelT.e() || (nullabilityQualifierWithMigrationStatusI = i(tannotationA, kotlin.reflect.jvm.internal.impl.load.java.a.f144315a)) == null) {
            return null;
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:37:0x0088, code lost:
        ...
        r6 = kotlin.reflect.jvm.internal.impl.load.java.typeEnhancement.NullabilityQualifier.f144652b;
     */
    ...
    */
    private final kotlin.reflect.jvm.internal.impl.load.java.typeEnhancement.NullabilityQualifierWithMigrationStatus q(TAnnotation r6, boolean r7) {
        /*
            ...
            return r1
        L8:
            kotlin.reflect.jvm.internal.impl.load.java.JavaTypeEnhancementState r2 = r5.f144150a
        ...
        L1b:
            ...
            r4 = 0
            if (r3 == 0) goto L29
            kotlin.reflect.jvm.internal.impl.load.java.typeEnhancement.NullabilityQualifier r6 = kotlin.reflect.jvm.internal.impl.load.java.typeEnhancement.NullabilityQualifier.f144653c
            goto L8d
        L29:
            java.util.Set r3 = kotlin.reflect.jvm.internal.impl.load.java.JvmAnnotationNamesKt.n()
            boolean r3 = r3.contains(r0)
            if (r3 == 0) goto L36
            kotlin.reflect.jvm.internal.impl.load.java.typeEnhancement.NullabilityQualifier r6 = kotlin.reflect.jvm.internal.impl.load.java.typeEnhancement.NullabilityQualifier.f144652b
            goto L8d
        L36:
            java.util.Set r3 = kotlin.reflect.jvm.internal.impl.load.java.JvmAnnotationNamesKt.b()
            boolean r3 = r3.contains(r0)
            if (r3 == 0) goto L43
            kotlin.reflect.jvm.internal.impl.load.java.typeEnhancement.NullabilityQualifier r6 = kotlin.reflect.jvm.internal.impl.load.java.typeEnhancement.NullabilityQualifier.f144651a
            goto L8d
        L43:
    ...
    private final ReportLevel r(TAnnotation tannotation) {
        ...
        if (fqNameK != null && JavaDefaultQualifiersKt.b().containsKey(fqNameK)) {
            return this.f144150a.c().invoke(fqNameK);
        }
