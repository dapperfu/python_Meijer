...
public final class PropertiesConventionUtilKt {
    public static final List<Name> a(Name name) {
        ...
        return JvmAbi.c(strB) ? CollectionsKt.q(b(name)) : JvmAbi.d(strB) ? f(name) : BuiltinSpecialProperties.f144163a.b(name);
    }
    ...
    private static final Name d(Name name, String str, boolean z10, String str2) {
        ...
        if (str2 != null) {
            return Name.o(str2 + StringsKt.J0(strL, str));
        }
        if (!z10) {
            return name;
        }
        String strC = CapitalizeDecapitalizeKt.c(StringsKt.J0(strL, str), true);
        if (!Name.t(strC)) {
            return null;
        }
        return Name.o(strC);
