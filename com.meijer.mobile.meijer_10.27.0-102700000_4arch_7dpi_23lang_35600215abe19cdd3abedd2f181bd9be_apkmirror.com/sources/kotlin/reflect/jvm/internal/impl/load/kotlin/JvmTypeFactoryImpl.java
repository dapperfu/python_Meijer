...
final class JvmTypeFactoryImpl implements JvmTypeFactory<JvmType> {
    ...
    public static final JvmTypeFactoryImpl f144817a = new JvmTypeFactoryImpl();
    ...
    public JvmType a(String representation) {
        ...
        if (cCharAt == 'L') {
            StringsKt.f0(representation, ';', false, 2, null);
        }
    ...
    public JvmType c(PrimitiveType primitiveType) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[primitiveType.ordinal()]) {
            case 1:
                return JvmType.f144805a.a();
            case 2:
                return JvmType.f144805a.c();
            case 3:
                return JvmType.f144805a.b();
            case 4:
                return JvmType.f144805a.h();
            case 5:
                return JvmType.f144805a.f();
            case 6:
                return JvmType.f144805a.e();
            case 7:
                return JvmType.f144805a.g();
            case 8:
                return JvmType.f144805a.d();
            default:
