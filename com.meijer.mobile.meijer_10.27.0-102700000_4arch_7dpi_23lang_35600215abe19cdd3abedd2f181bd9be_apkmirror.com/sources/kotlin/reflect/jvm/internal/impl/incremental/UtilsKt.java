...
public final class UtilsKt {
    public static final void a(LookupTracker lookupTracker, LookupLocation from, ClassDescriptor scopeOwner, Name name) {
        ...
        if (lookupTracker == LookupTracker.DO_NOTHING.f144114a || (location = from.getLocation()) == null) {
            return;
        }
        Position position = lookupTracker.a() ? location.getPosition() : Position.f144140c.a();
        String strA = location.a();
        String strA2 = DescriptorUtils.m(scopeOwner).a();
        ScopeKind scopeKind = ScopeKind.f144145b;
        String strB = name.b();
    ...
    public static final void c(LookupTracker lookupTracker, LookupLocation from, String packageFqName, String name) {
        ...
        lookupTracker.b(location.a(), lookupTracker.a() ? location.getPosition() : Position.f144140c.a(), packageFqName, ScopeKind.f144144a, name);
    }
}
