...
public final class SmartSet<T> extends AbstractMutableSet<T> {
    ...
    public static final Companion f147178c = new Companion(null);

    /* renamed from: a, reason: collision with root package name */
    private Object f147179a;

    /* renamed from: b, reason: collision with root package name */
    private int f147180b;
    ...
    private static final class a<T> implements Iterator<T>, KMutableIterator {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final Iterator<T> f147181a;

        public a(T[] array) {
            Intrinsics.j(array, "array");
            this.f147181a = ArrayIteratorKt.a(array);
        }
        ...
        public boolean hasNext() {
            return this.f147181a.hasNext();
        }

        @Override // java.util.Iterator
        public T next() {
            return this.f147181a.next();
        }
    }
    ...
    private static final class b<T> implements Iterator<T>, KMutableIterator {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final T f147182a;

        /* renamed from: b, reason: collision with root package name */
        private boolean f147183b = true;
    ...
    public boolean add(T t10) {
        ...
        if (size() == 0) {
            ...
            if (Intrinsics.e(this.f147179a, t10)) {
                return false;
            }
            this.f147179a = new Object[]{this.f147179a, t10};
        } else if (size() < 5) {
            Object obj = this.f147179a;
            ...
            this.f147179a = objArr;
        } else {
            Object obj2 = this.f147179a;
    ...
    public boolean contains(Object obj) {
        ...
        if (size() == 1) {
            return Intrinsics.e(this.f147179a, obj);
        }
        if (size() < 5) {
            Object obj2 = this.f147179a;
