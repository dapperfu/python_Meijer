...
public final class FunctionClassScope extends GivenFunctionsMemberScope {
    ...
    protected List<FunctionDescriptor> j() {
        ...
        if (Intrinsics.e(functionTypeKindR0, FunctionTypeKind.Function.f143478f)) {
            return CollectionsKt.e(FunctionInvokeDescriptor.f143472E.a((FunctionClassDescriptor) m(), false));
        }
        if (Intrinsics.e(functionTypeKindR0, FunctionTypeKind.SuspendFunction.f143481f)) {
            return CollectionsKt.e(FunctionInvokeDescriptor.f143472E.a((FunctionClassDescriptor) m(), true));
        }
