...
public final class JavaToKotlinClassMapper {
    ...
    public static final JavaToKotlinClassMapper f143512a = new JavaToKotlinClassMapper();
    ...
    public final ClassDescriptor a(ClassDescriptor mutable) {
        ...
        FqName fqNameO = JavaToKotlinClassMap.f143492a.o(DescriptorUtils.m(mutable));
        if (fqNameO != null) {
    ...
    public final ClassDescriptor b(ClassDescriptor readOnly) {
        ...
        FqName fqNameP = JavaToKotlinClassMap.f143492a.p(DescriptorUtils.m(readOnly));
        if (fqNameP != null) {
    ...
    public final boolean c(ClassDescriptor mutable) {
        Intrinsics.j(mutable, "mutable");
        return JavaToKotlinClassMap.f143492a.k(DescriptorUtils.m(mutable));
    }

    public final boolean d(ClassDescriptor readOnly) {
        Intrinsics.j(readOnly, "readOnly");
        return JavaToKotlinClassMap.f143492a.l(DescriptorUtils.m(readOnly));
    }

    public final ClassDescriptor e(FqName fqName, KotlinBuiltIns builtIns, Integer num) {
        Intrinsics.j(fqName, "fqName");
        Intrinsics.j(builtIns, "builtIns");
        ClassId classIdM = (num == null || !Intrinsics.e(fqName, JavaToKotlinClassMap.f143492a.h())) ? JavaToKotlinClassMap.f143492a.m(fqName) : StandardNames.a(num.intValue());
        if (classIdM != null) {
    ...
    public final Collection<ClassDescriptor> g(FqName fqName, KotlinBuiltIns builtIns) {
        ...
        FqName fqNameP = JavaToKotlinClassMap.f143492a.p(DescriptorUtilsKt.p(classDescriptorF));
