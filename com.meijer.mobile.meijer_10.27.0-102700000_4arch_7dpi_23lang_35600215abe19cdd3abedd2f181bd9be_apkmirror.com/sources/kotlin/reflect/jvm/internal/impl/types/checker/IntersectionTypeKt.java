...
public final class IntersectionTypeKt {
    public static final UnwrappedType a(Collection<? extends UnwrappedType> types) {
        ...
        if (z10) {
            return ErrorUtils.d(ErrorTypeKind.f146977u0, types.toString());
        }
        if (!z11) {
            return TypeIntersector.f146841a.d(arrayList);
        }
        ...
        TypeIntersector typeIntersector = TypeIntersector.f146841a;
