...
public abstract class FlexibleType extends UnwrappedType implements FlexibleTypeMarker {
    ...
    private final SimpleType f146699b;

    /* renamed from: c, reason: collision with root package name */
    private final SimpleType f146700c;
    ...
    public FlexibleType(SimpleType lowerBound, SimpleType upperBound) {
        ...
        this.f146699b = lowerBound;
        this.f146700c = upperBound;
    }
    ...
    public String toString() {
        return DescriptorRenderer.f145995k.T(this);
    }
