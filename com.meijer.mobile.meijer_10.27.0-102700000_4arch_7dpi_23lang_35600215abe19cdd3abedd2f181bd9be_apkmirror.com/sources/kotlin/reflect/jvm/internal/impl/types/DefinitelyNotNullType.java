...
public final class DefinitelyNotNullType extends DelegatingSimpleType implements CustomTypeParameter, DefinitelyNotNullTypeMarker {
    ...
    public static final Companion f146687d = new Companion(null);

    /* renamed from: b, reason: collision with root package name */
    private final SimpleType f146688b;

    /* renamed from: c, reason: collision with root package name */
    private final boolean f146689c;
    ...
    public static final class Companion {
        ...
        private final boolean d(UnwrappedType unwrappedType, boolean z10) {
            ...
            return !NullabilityChecker.f146837a.a(unwrappedType);
        }
    }
    ...
    public SimpleType Q0(TypeAttributes newAttributes) {
        ...
        return new DefinitelyNotNullType(T0().Q0(newAttributes), this.f146689c);
    }
    ...
    public DefinitelyNotNullType V0(SimpleType delegate) {
        ...
        return new DefinitelyNotNullType(delegate, this.f146689c);
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.CustomTypeParameter
    public KotlinType g0(KotlinType replacement) {
        Intrinsics.j(replacement, "replacement");
        return SpecialTypesKt.e(replacement.N0(), this.f146689c);
    }
