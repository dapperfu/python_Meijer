...
public class ClassTypeConstructorImpl extends AbstractClassTypeConstructor {
    ...
    private final ClassDescriptor f146682d;

    /* renamed from: e, reason: collision with root package name */
    private final List<TypeParameterDescriptor> f146683e;

    /* renamed from: f, reason: collision with root package name */
    private final Collection<KotlinType> f146684f;
    ...
    public ClassTypeConstructorImpl(ClassDescriptor classDescriptor, List<? extends TypeParameterDescriptor> list, Collection<KotlinType> collection, StorageManager storageManager) {
        ...
        this.f146682d = classDescriptor;
        this.f146683e = Collections.unmodifiableList(new ArrayList(list));
        this.f146684f = Collections.unmodifiableCollection(collection);
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.AbstractClassTypeConstructor, kotlin.reflect.jvm.internal.impl.types.ClassifierBasedTypeConstructor, kotlin.reflect.jvm.internal.impl.types.TypeConstructor
    /* renamed from: I */
    public ClassDescriptor d() {
        ClassDescriptor classDescriptor = this.f146682d;
        if (classDescriptor == null) {
            H(5);
        }
    ...
    public List<TypeParameterDescriptor> getParameters() {
        List<TypeParameterDescriptor> list = this.f146683e;
        if (list == null) {
            H(4);
        }
        return list;
    ...
    protected Collection<KotlinType> r() {
        Collection<KotlinType> collection = this.f146684f;
        if (collection == null) {
            H(6);
        }
        return collection;
    ...
    public String toString() {
        return DescriptorUtils.m(this.f146682d).a();
    }
