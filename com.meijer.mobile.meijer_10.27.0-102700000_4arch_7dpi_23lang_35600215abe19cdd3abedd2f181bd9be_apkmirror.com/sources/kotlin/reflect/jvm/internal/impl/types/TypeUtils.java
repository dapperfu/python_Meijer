...
public class TypeUtils {
    ...
    public static final SimpleType f146791a = ErrorUtils.d(ErrorTypeKind.f146911E, new String[0]);

    /* renamed from: b, reason: collision with root package name */
    public static final SimpleType f146792b = ErrorUtils.d(ErrorTypeKind.f146982x, new String[0]);

    /* renamed from: c, reason: collision with root package name */
    public static final SimpleType f146793c = new SpecialType("NO_EXPECTED_TYPE");

    /* renamed from: d, reason: collision with root package name */
    public static final SimpleType f146794d = new SpecialType("UNIT_EXPECTED_TYPE");
    ...
    public static class SpecialType extends DelegatingSimpleType {
        ...
        */
        ...
        public SimpleType R0(boolean z10) {
            throw new IllegalStateException(this.f146795b);
        }
    ...
    */
    ...
    public static boolean w(KotlinType kotlinType) {
        ...
        return kotlinType == f146793c || kotlinType == f146794d;
    }
    ...
    public static KotlinType e(KotlinType kotlinType, KotlinType kotlinType2, TypeSubstitutor typeSubstitutor) {
        ...
        KotlinType kotlinTypeP = typeSubstitutor.p(kotlinType2, Variance.f146796e);
        if (kotlinTypeP != null) {
    ...
    public static boolean k(KotlinType kotlinType) {
        return kotlinType != null && kotlinType.K0() == f146791a.K0();
    }
    ...
    public static TypeProjection t(TypeParameterDescriptor typeParameterDescriptor, ErasureTypeAttributes erasureTypeAttributes) {
        ...
        return erasureTypeAttributes.b() == TypeUsage.f146787a ? new TypeProjectionImpl(StarProjectionImplKt.b(typeParameterDescriptor)) : new StarProjectionImpl(typeParameterDescriptor);
    }
    ...
    public static SimpleType v(TypeConstructor typeConstructor, MemberScope memberScope, Function1<KotlinTypeRefiner, SimpleType> function1) {
        ...
        SimpleType simpleTypeN = KotlinTypeFactory.n(TypeAttributes.f146740b.k(), typeConstructor, g(typeConstructor.getParameters()), false, memberScope, function1);
        if (simpleTypeN == null) {
            a(15);
        }
        return simpleTypeN;
    ...
    public static SimpleType u(ClassifierDescriptor classifierDescriptor, MemberScope memberScope, Function1<KotlinTypeRefiner, SimpleType> function1) {
        if (ErrorUtils.m(classifierDescriptor)) {
            ErrorType errorTypeD = ErrorUtils.d(ErrorTypeKind.f146909D, classifierDescriptor.toString());
            if (errorTypeD == null) {
                a(11);
            }
            return errorTypeD;
