...
public abstract class AbstractTypeConstructor extends ClassifierBasedTypeConstructor {
    ...
    private final NotNullLazyValue<b> f146672b;

    /* renamed from: c, reason: collision with root package name */
    private final boolean f146673c;

    /* JADX INFO: Access modifiers changed from: private */
    final class a implements TypeConstructor {

        /* renamed from: a, reason: collision with root package name */
        private final KotlinTypeRefiner f146674a;

        /* renamed from: b, reason: collision with root package name */
        private final Lazy f146675b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ AbstractTypeConstructor f146676c;

        public a(AbstractTypeConstructor abstractTypeConstructor, KotlinTypeRefiner kotlinTypeRefiner) {
            Intrinsics.j(kotlinTypeRefiner, "kotlinTypeRefiner");
            this.f146676c = abstractTypeConstructor;
            this.f146674a = kotlinTypeRefiner;
            this.f146675b = LazyKt.a(LazyThreadSafetyMode.f142380b, new j(this, abstractTypeConstructor));
        }

        private final List<KotlinType> g() {
            return (List) this.f146675b.getValue();
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final List i(a aVar, AbstractTypeConstructor abstractTypeConstructor) {
            return KotlinTypeRefinerKt.b(aVar.f146674a, abstractTypeConstructor.a());
        }

        @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
        public TypeConstructor b(KotlinTypeRefiner kotlinTypeRefiner) {
            Intrinsics.j(kotlinTypeRefiner, "kotlinTypeRefiner");
            return this.f146676c.b(kotlinTypeRefiner);
        }

        @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
        public ClassifierDescriptor d() {
            return this.f146676c.d();
        }

        @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
        public boolean e() {
            return this.f146676c.e();
        }

        public boolean equals(Object obj) {
            return this.f146676c.equals(obj);
        }

        @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
        public List<TypeParameterDescriptor> getParameters() {
            List<TypeParameterDescriptor> parameters = this.f146676c.getParameters();
            Intrinsics.i(parameters, "getParameters(...)");
            return parameters;
        }

        public int hashCode() {
            return this.f146676c.hashCode();
        }

        @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
        public KotlinBuiltIns l() {
            KotlinBuiltIns kotlinBuiltInsL = this.f146676c.l();
            Intrinsics.i(kotlinBuiltInsL, "getBuiltIns(...)");
            return kotlinBuiltInsL;
        }

        public String toString() {
            return this.f146676c.toString();
        }
    ...
    static final class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final Collection<KotlinType> f146677a;

        /* renamed from: b, reason: collision with root package name */
        private List<? extends KotlinType> f146678b;

        /* JADX WARN: Multi-variable type inference failed */
        public b(Collection<? extends KotlinType> allSupertypes) {
            Intrinsics.j(allSupertypes, "allSupertypes");
            this.f146677a = allSupertypes;
            this.f146678b = CollectionsKt.e(ErrorUtils.f146990a.l());
        }
    ...
    public AbstractTypeConstructor(StorageManager storageManager) {
        ...
        this.f146672b = storageManager.f(new c(this), d.f146858a, new e(this));
    }
    ...
    public static final b B(boolean z10) {
        return new b(CollectionsKt.e(ErrorUtils.f146990a.l()));
    }
    ...
    private final Collection<KotlinType> q(TypeConstructor typeConstructor, boolean z10) {
        ...
        if (abstractTypeConstructor != null && (listP0 = CollectionsKt.P0(abstractTypeConstructor.f146672b.invoke().a(), abstractTypeConstructor.t(z10))) != null) {
            return listP0;
        }
