...
public final class SpecialTypesKt {
    ...
    public static final UnwrappedType e(UnwrappedType unwrappedType, boolean z10) {
        ...
        DefinitelyNotNullType definitelyNotNullTypeC = DefinitelyNotNullType.Companion.c(DefinitelyNotNullType.f146687d, unwrappedType, z10, false, 4, null);
    ...
    public static final SimpleType h(SimpleType simpleType, boolean z10) {
        ...
        DefinitelyNotNullType definitelyNotNullTypeC = DefinitelyNotNullType.Companion.c(DefinitelyNotNullType.f146687d, simpleType, z10, false, 4, null);
        if (definitelyNotNullTypeC != null) {
            return definitelyNotNullTypeC;
        }
