...
public final class IndexedParametersSubstitution extends TypeSubstitution {
    ...
    private final TypeParameterDescriptor[] f146706c;

    /* renamed from: d, reason: collision with root package name */
    private final TypeProjection[] f146707d;

    /* renamed from: e, reason: collision with root package name */
    private final boolean f146708e;
    ...
    public IndexedParametersSubstitution(TypeParameterDescriptor[] parameters, TypeProjection[] arguments, boolean z10) {
        ...
        this.f146706c = parameters;
        this.f146707d = arguments;
        this.f146708e = z10;
    ...
    public TypeProjection e(KotlinType key) {
        ...
        TypeParameterDescriptor[] typeParameterDescriptorArr = this.f146706c;
        if (index >= typeParameterDescriptorArr.length || !Intrinsics.e(typeParameterDescriptorArr[index].i(), typeParameterDescriptor.i())) {
            return null;
        }
        return this.f146707d[index];
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.TypeSubstitution
    public boolean f() {
        return this.f146707d.length == 0;
    }
