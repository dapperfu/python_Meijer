...
public final class ErrorPropertyDescriptor implements PropertyDescriptor {
    ...
    private final /* synthetic */ PropertyDescriptorImpl f146877a;

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.VariableDescriptorWithAccessors
    public boolean A() {
        return this.f146877a.A();
    }
    ...
    public void A0(Collection<? extends CallableMemberDescriptor> overriddenDescriptors) {
        ...
        this.f146877a.A0(overriddenDescriptors);
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.CallableDescriptor
    public ReceiverParameterDescriptor J() {
        return this.f146877a.J();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.VariableDescriptor
    public boolean L() {
        return this.f146877a.L();
    }
    ...
    public CallableMemberDescriptor M(DeclarationDescriptor declarationDescriptor, Modality modality, DescriptorVisibility descriptorVisibility, CallableMemberDescriptor.Kind kind, boolean z10) {
        PropertyDescriptor propertyDescriptorL0 = this.f146877a.M(declarationDescriptor, modality, descriptorVisibility, kind, z10);
    ...
    public ReceiverParameterDescriptor N() {
        return this.f146877a.N();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.PropertyDescriptor
    public FieldDescriptor O() {
        return this.f146877a.O();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.MemberDescriptor
    public boolean V() {
        return this.f146877a.V();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.DeclarationDescriptor
    /* renamed from: a */
    public PropertyDescriptor H0() {
        PropertyDescriptor propertyDescriptorH0 = this.f146877a.H0();
    ...
    public DeclarationDescriptor b() {
        DeclarationDescriptor declarationDescriptorB = this.f146877a.b();
    ...
    public PropertyDescriptor c(TypeSubstitutor substitutor) {
        ...
        return this.f146877a.c(substitutor);
    }
    ...
    public Collection<? extends PropertyDescriptor> d() {
        Collection<? extends PropertyDescriptor> collectionD = this.f146877a.d();
    ...
    @Override // kotlin.reflect.jvm.internal.impl.descriptors.CallableDescriptor
    public boolean d0() {
        return this.f146877a.d0();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.CallableMemberDescriptor
    public CallableMemberDescriptor.Kind f() {
        CallableMemberDescriptor.Kind kindF = this.f146877a.f();
    ...
    public SourceElement g() {
        SourceElement sourceElementG = this.f146877a.g();
    ...
    public Annotations getAnnotations() {
        Annotations annotations = this.f146877a.getAnnotations();
    ...
    public PropertyGetterDescriptor getGetter() {
        return this.f146877a.getGetter();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.Named
    public Name getName() {
        Name name = this.f146877a.getName();
    ...
    public KotlinType getReturnType() {
        return this.f146877a.getReturnType();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.PropertyDescriptor
    public PropertySetterDescriptor getSetter() {
        return this.f146877a.getSetter();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ValueDescriptor
    public KotlinType getType() {
        KotlinType type = this.f146877a.getType();
    ...
    public List<TypeParameterDescriptor> getTypeParameters() {
        List<TypeParameterDescriptor> typeParameters = this.f146877a.getTypeParameters();
    ...
    public DescriptorVisibility getVisibility() {
        DescriptorVisibility visibility = this.f146877a.getVisibility();
    ...
    public List<ValueParameterDescriptor> h() {
        List<ValueParameterDescriptor> listH = this.f146877a.h();
    ...
    @Override // kotlin.reflect.jvm.internal.impl.descriptors.MemberDescriptor
    public boolean h0() {
        return this.f146877a.h0();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.VariableDescriptor
    public boolean isConst() {
        return this.f146877a.isConst();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.MemberDescriptor
    public boolean isExternal() {
        return this.f146877a.isExternal();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.VariableDescriptor
    public ConstantValue<?> l0() {
        return this.f146877a.l0();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.MemberDescriptor
    public Modality q() {
        Modality modalityQ = this.f146877a.q();
    ...
    public <V> V r0(CallableDescriptor.UserDataKey<V> userDataKey) {
        return (V) this.f146877a.r0(userDataKey);
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.PropertyDescriptor
    public FieldDescriptor t0() {
        return this.f146877a.t0();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.PropertyDescriptor
    public List<PropertyAccessorDescriptor> u() {
        List<PropertyAccessorDescriptor> listU = this.f146877a.u();
    ...
    public List<ReceiverParameterDescriptor> u0() {
        List<ReceiverParameterDescriptor> listU0 = this.f146877a.u0();
    ...
    @Override // kotlin.reflect.jvm.internal.impl.descriptors.VariableDescriptor
    public boolean v0() {
        return this.f146877a.v0();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.DeclarationDescriptor
    public <R, D> R x(DeclarationDescriptorVisitor<R, D> declarationDescriptorVisitor, D d10) {
        return (R) this.f146877a.x(declarationDescriptorVisitor, d10);
    }

    public ErrorPropertyDescriptor() {
        ErrorUtils errorUtils = ErrorUtils.f146990a;
        PropertyDescriptorImpl propertyDescriptorImplM0 = PropertyDescriptorImpl.M0(errorUtils.h(), Annotations.f143689s3.b(), Modality.f143621d, DescriptorVisibilities.f143600e, true, Name.u(ErrorEntity.f146864f.b()), CallableMemberDescriptor.Kind.DECLARATION, SourceElement.f143647a, false, false, false, false, false, false);
        propertyDescriptorImplM0.Z0(errorUtils.k(), CollectionsKt.m(), null, null, CollectionsKt.m());
        this.f146877a = propertyDescriptorImplM0;
    }
}
