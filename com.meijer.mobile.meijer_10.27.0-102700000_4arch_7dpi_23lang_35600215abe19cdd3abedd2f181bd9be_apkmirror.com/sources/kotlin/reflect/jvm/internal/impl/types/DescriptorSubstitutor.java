...
public class DescriptorSubstitutor {
    ...
    public static TypeSubstitutor c(List<TypeParameterDescriptor> list, TypeSubstitution typeSubstitution, DeclarationDescriptor declarationDescriptor, List<TypeParameterDescriptor> list2, boolean[] zArr) {
        ...
        for (TypeParameterDescriptor typeParameterDescriptor : list) {
            TypeParameterDescriptorImpl typeParameterDescriptorImplN0 = TypeParameterDescriptorImpl.N0(declarationDescriptor, typeParameterDescriptor.getAnnotations(), typeParameterDescriptor.v(), typeParameterDescriptor.k(), typeParameterDescriptor.getName(), i10, SourceElement.f143647a, typeParameterDescriptor.K());
        ...
        for (TypeParameterDescriptor typeParameterDescriptor2 : list) {
            ...
            for (KotlinType kotlinType : typeParameterDescriptor2.getUpperBounds()) {
                ...
                KotlinType kotlinTypeP = (((classifierDescriptorD instanceof TypeParameterDescriptor) && TypeUtilsKt.p((TypeParameterDescriptor) classifierDescriptorD)) ? typeSubstitutorH : typeSubstitutorH2).p(kotlinType, Variance.f146798g);
                if (kotlinTypeP == null) {
                    return null;
                }
