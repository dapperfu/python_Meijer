...
public final class TypeAliasExpander {
    ...
    public static final Companion f146730c = new Companion(null);

    /* renamed from: d, reason: collision with root package name */
    private static final TypeAliasExpander f146731d = new TypeAliasExpander(TypeAliasExpansionReportStrategy.DO_NOTHING.f146739a, false);

    /* renamed from: a, reason: collision with root package name */
    private final TypeAliasExpansionReportStrategy f146732a;

    /* renamed from: b, reason: collision with root package name */
    private final boolean f146733b;
    ...
    private final void a(Annotations annotations, Annotations annotations2) {
        ...
        for (AnnotationDescriptor annotationDescriptor : annotations2) {
            if (hashSet.contains(annotationDescriptor.e())) {
                this.f146732a.c(annotationDescriptor);
            }
        }
    }
    ...
    private final SimpleType k(TypeAliasExpansion typeAliasExpansion, TypeAttributes typeAttributes, boolean z10, int i10, boolean z11) {
        TypeProjection typeProjectionL = l(new TypeProjectionImpl(Variance.f146796e, typeAliasExpansion.b().q0()), typeAliasExpansion, null, i10);
    ...
    private final TypeProjection l(TypeProjection typeProjection, TypeAliasExpansion typeAliasExpansion, TypeParameterDescriptor typeParameterDescriptor, int i10) {
        ...
        Variance variance;
        Variance variance2;
        f146730c.b(i10, typeAliasExpansion.b());
        if (typeProjection.a()) {
        ...
        if (varianceC2 != varianceC && varianceC2 != (variance2 = Variance.f146796e)) {
            if (varianceC == variance2) {
                varianceC = varianceC2;
            } else {
                this.f146732a.d(typeAliasExpansion.b(), typeParameterDescriptor, unwrappedTypeN0);
            }
        }
        if (typeParameterDescriptor == null || (varianceK = typeParameterDescriptor.k()) == null) {
            varianceK = Variance.f146796e;
        }
        if (varianceK != varianceC && varianceK != (variance = Variance.f146796e)) {
        ...
        for (Object obj : kotlinType2.I0()) {
            ...
            if (!typeProjection.a()) {
                ...
                if (!TypeUtilsKt.g(type)) {
                    ...
                    if (this.f146733b) {
                        TypeAliasExpansionReportStrategy typeAliasExpansionReportStrategy = this.f146732a;
    ...
    private final SimpleType g(TypeAliasExpansion typeAliasExpansion, TypeAttributes typeAttributes, boolean z10) {
        ...
        return KotlinTypeFactory.m(typeAttributes, typeConstructorI, typeAliasExpansion.a(), z10, MemberScope.Empty.f146293b);
    }
                ...
                if (!(classifierDescriptorD instanceof TypeParameterDescriptor)) {
                    if (classifierDescriptorD instanceof TypeAliasDescriptor) {
                        ...
                        if (typeAliasExpansion.d(typeAliasDescriptor)) {
                            this.f146732a.b(typeAliasDescriptor);
                            return new TypeProjectionImpl(Variance.f146796e, ErrorUtils.d(ErrorTypeKind.f146972s, typeAliasDescriptor.getName().toString()));
                        }
                        ...
                        SimpleType simpleTypeK = k(TypeAliasExpansion.f146734e.a(typeAliasExpansion, typeAliasDescriptor, arrayList), simpleTypeA.J0(), simpleTypeA.L0(), i10 + 1, false);
