...
public final class ReflectClassUtilKt {
    ...
    private static final List<KClass<? extends Object>> f144068a;

    /* renamed from: b, reason: collision with root package name */
    private static final Map<Class<? extends Object>, Class<? extends Object>> f144069b;

    /* renamed from: c, reason: collision with root package name */
    private static final Map<Class<? extends Object>, Class<? extends Object>> f144070c;

    /* renamed from: d, reason: collision with root package name */
    private static final Map<Class<? extends Function<?>>, Integer> f144071d;
    ...
    static {
        ...
        f144069b = MapsKt.y(arrayList);
        List<KClass<? extends Object>> list2 = f144068a;
    ...
    public static final ClassId e(Class<?> cls) {
        ...
        return new ClassId(fqName.d(), FqName.f145678c.a(fqName.f()), true);
    }
    ...
    public static final List<Type> h(Type type) {
        ...
        if (parameterizedType.getOwnerType() != null) {
            return SequencesKt.W(SequencesKt.G(SequencesKt.q(type, a.f144109a), b.f144110a));
        }
        Type[] actualTypeArguments = parameterizedType.getActualTypeArguments();
        Intrinsics.i(actualTypeArguments, "getActualTypeArguments(...)");
        return ArraysKt.i1(actualTypeArguments);
    }

    public static final Class<?> i(Class<?> cls) {
        Intrinsics.j(cls, "<this>");
        return f144069b.get(cls);
    }
