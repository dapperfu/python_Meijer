...
public final class ReflectJavaTypeParameter extends ReflectJavaElement implements ReflectJavaAnnotationOwner, JavaTypeParameter {
    ...
    private final TypeVariable<?> f144101a;
    ...
    public boolean equals(Object obj) {
        return (obj instanceof ReflectJavaTypeParameter) && Intrinsics.e(this.f144101a, ((ReflectJavaTypeParameter) obj).f144101a);
    }
    ...
    public Name getName() {
        Name nameO = Name.o(this.f144101a.getName());
        Intrinsics.i(nameO, "identifier(...)");
        return nameO;
    }

    public int hashCode() {
        return this.f144101a.hashCode();
    }
    ...
    public AnnotatedElement s() {
        TypeVariable<?> typeVariable = this.f144101a;
    ...
    public String toString() {
        return ReflectJavaTypeParameter.class.getName() + ": " + this.f144101a;
    }
}
