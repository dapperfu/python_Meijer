...
public class LazyPackageViewDescriptorImpl extends DeclarationDescriptorImpl implements PackageViewDescriptor {
    ...
    static final /* synthetic */ KProperty<Object>[] f143904h = {Reflection.j(new PropertyReference1Impl(LazyPackageViewDescriptorImpl.class, "fragments", "getFragments()Ljava/util/List;", 0)), Reflection.j(new PropertyReference1Impl(LazyPackageViewDescriptorImpl.class, "empty", "getEmpty()Z", 0))};

    /* renamed from: c, reason: collision with root package name */
    private final ModuleDescriptorImpl f143905c;

    /* renamed from: d, reason: collision with root package name */
    private final FqName f143906d;

    /* renamed from: e, reason: collision with root package name */
    private final NotNullLazyValue f143907e;

    /* renamed from: f, reason: collision with root package name */
    private final NotNullLazyValue f143908f;

    /* renamed from: g, reason: collision with root package name */
    private final MemberScope f143909g;
    ...
    public LazyPackageViewDescriptorImpl(ModuleDescriptorImpl module, FqName fqName, StorageManager storageManager) {
        super(Annotations.f143689s3.b(), fqName.g());
        Intrinsics.j(module, "module");
        Intrinsics.j(fqName, "fqName");
        Intrinsics.j(storageManager, "storageManager");
        this.f143905c = module;
        this.f143906d = fqName;
        this.f143907e = storageManager.c(new d(this));
        this.f143908f = storageManager.c(new e(this));
        this.f143909g = new LazyScopeAdapter(storageManager, new f(this));
    }

    protected final boolean L0() {
        return ((Boolean) StorageKt.a(this.f143908f, this, f143904h[1])).booleanValue();
    }
    ...
    public List<PackageFragmentDescriptor> f0() {
        return (List) StorageKt.a(this.f143907e, this, f143904h[0]);
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.PackageViewDescriptor
    public MemberScope n() {
        return this.f143909g;
    }
    ...
    public static final MemberScope N0(LazyPackageViewDescriptorImpl lazyPackageViewDescriptorImpl) {
        ...
        return ChainedMemberScope.f146249d.a("package view scope for " + lazyPackageViewDescriptorImpl.e() + " in " + lazyPackageViewDescriptorImpl.y0().getName(), listQ0);
    }
