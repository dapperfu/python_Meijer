...
public final class InvalidModuleExceptionKt {
    ...
    private static final ModuleCapability<InvalidModuleNotifier> f143617a = new ModuleCapability<>("InvalidModuleNotifier");

    public static final void a(ModuleDescriptor moduleDescriptor) {
        Intrinsics.j(moduleDescriptor, "<this>");
        InvalidModuleNotifier invalidModuleNotifier = (InvalidModuleNotifier) moduleDescriptor.E0(f143617a);
