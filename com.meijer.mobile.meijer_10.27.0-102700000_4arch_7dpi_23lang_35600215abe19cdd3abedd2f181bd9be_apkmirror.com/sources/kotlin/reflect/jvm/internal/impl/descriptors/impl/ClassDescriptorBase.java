...
public abstract class ClassDescriptorBase extends AbstractClassDescriptor {
    ...
    private final DeclarationDescriptor f143818f;

    /* renamed from: g, reason: collision with root package name */
    private final SourceElement f143819g;

    /* renamed from: h, reason: collision with root package name */
    private final boolean f143820h;
    ...
    protected ClassDescriptorBase(StorageManager storageManager, DeclarationDescriptor declarationDescriptor, Name name, SourceElement sourceElement, boolean z10) {
        ...
        this.f143818f = declarationDescriptor;
        this.f143819g = sourceElement;
        this.f143820h = z10;
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor, kotlin.reflect.jvm.internal.impl.descriptors.DeclarationDescriptorNonRoot, kotlin.reflect.jvm.internal.impl.descriptors.DeclarationDescriptor
    public DeclarationDescriptor b() {
        DeclarationDescriptor declarationDescriptor = this.f143818f;
        if (declarationDescriptor == null) {
            B0(4);
        }
    ...
    public SourceElement g() {
        SourceElement sourceElement = this.f143819g;
        if (sourceElement == null) {
            B0(5);
        }
