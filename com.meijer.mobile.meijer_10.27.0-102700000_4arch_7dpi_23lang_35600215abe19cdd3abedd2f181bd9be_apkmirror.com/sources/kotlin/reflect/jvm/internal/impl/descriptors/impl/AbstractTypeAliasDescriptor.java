...
public abstract class AbstractTypeAliasDescriptor extends DeclarationDescriptorNonRootImpl implements TypeAliasDescriptor {
    ...
    static final /* synthetic */ KProperty<Object>[] f143796j = {Reflection.j(new PropertyReference1Impl(AbstractTypeAliasDescriptor.class, "constructors", "getConstructors()Ljava/util/Collection;", 0))};

    /* renamed from: e, reason: collision with root package name */
    private final StorageManager f143797e;

    /* renamed from: f, reason: collision with root package name */
    private final DescriptorVisibility f143798f;

    /* renamed from: g, reason: collision with root package name */
    private final NotNullLazyValue f143799g;

    /* renamed from: h, reason: collision with root package name */
    private List<? extends TypeParameterDescriptor> f143800h;

    /* renamed from: i, reason: collision with root package name */
    private final AbstractTypeAliasDescriptor$typeConstructor$1 f143801i;
    ...
    public AbstractTypeAliasDescriptor(StorageManager storageManager, DeclarationDescriptor containingDeclaration, Annotations annotations, Name name, SourceElement sourceElement, DescriptorVisibility visibilityImpl) {
        ...
        this.f143797e = storageManager;
        this.f143798f = visibilityImpl;
        this.f143799g = storageManager.c(new a(this));
        this.f143801i = new TypeConstructor() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$typeConstructor$1
    ...
    public final void P0(List<? extends TypeParameterDescriptor> declaredTypeParameters) {
        ...
        this.f143800h = declaredTypeParameters;
    }
    ...
    */
    ...
    protected final SimpleType J0() {
        ...
        if (classDescriptorS == null || (memberScopeU = classDescriptorS.U()) == null) {
            memberScopeU = MemberScope.Empty.f146293b;
        }
    ...
    public final Collection<TypeAliasConstructorDescriptor> N0() {
        ...
        for (ClassConstructorDescriptor classConstructorDescriptor : collectionJ) {
            TypeAliasConstructorDescriptorImpl.Companion companion = TypeAliasConstructorDescriptorImpl.f143997I;
            StorageManager storageManager = this.f143797e;
