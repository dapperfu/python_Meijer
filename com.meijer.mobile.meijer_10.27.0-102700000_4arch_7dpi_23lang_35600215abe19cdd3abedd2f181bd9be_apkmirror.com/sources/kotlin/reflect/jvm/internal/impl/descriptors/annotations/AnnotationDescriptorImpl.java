...
public class AnnotationDescriptorImpl implements AnnotationDescriptor {
    ...
    private final KotlinType f143668a;

    /* renamed from: b, reason: collision with root package name */
    private final Map<Name, ConstantValue<?>> f143669b;

    /* renamed from: c, reason: collision with root package name */
    private final SourceElement f143670c;
    ...
    public AnnotationDescriptorImpl(KotlinType kotlinType, Map<Name, ConstantValue<?>> map, SourceElement sourceElement) {
        ...
        this.f143668a = kotlinType;
        this.f143669b = map;
        this.f143670c = sourceElement;
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.annotations.AnnotationDescriptor
    public Map<Name, ConstantValue<?>> a() {
        Map<Name, ConstantValue<?>> map = this.f143669b;
        if (map == null) {
            b(4);
        }
        return map;
    ...
    public SourceElement g() {
        SourceElement sourceElement = this.f143670c;
        if (sourceElement == null) {
            b(5);
        }
    ...
    public KotlinType getType() {
        KotlinType kotlinType = this.f143668a;
        if (kotlinType == null) {
            b(3);
        }
        return kotlinType;
    ...
    public String toString() {
        return DescriptorRenderer.f145992h.O(this, null);
    }
