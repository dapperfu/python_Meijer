...
public final class CompositeAnnotations implements Annotations {
    ...
    public AnnotationDescriptor i(FqName fqName) {
        ...
        return (AnnotationDescriptor) SequencesKt.F(SequencesKt.N(CollectionsKt.f0(this.f143698a), new c(fqName)));
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.annotations.Annotations
    public boolean isEmpty() {
        List<Annotations> list = this.f143698a;
    ...
    public Iterator<AnnotationDescriptor> iterator() {
        return SequencesKt.G(CollectionsKt.f0(this.f143698a), d.f143774a).iterator();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.annotations.Annotations
    public boolean p3(FqName fqName) {
        Intrinsics.j(fqName, "fqName");
        Iterator it = CollectionsKt.f0(this.f143698a).iterator();
        while (it.hasNext()) {
    ...
    public CompositeAnnotations(Annotations... delegates) {
        this((List<? extends Annotations>) ArraysKt.i1(delegates));
        Intrinsics.j(delegates, "delegates");
    }
}
