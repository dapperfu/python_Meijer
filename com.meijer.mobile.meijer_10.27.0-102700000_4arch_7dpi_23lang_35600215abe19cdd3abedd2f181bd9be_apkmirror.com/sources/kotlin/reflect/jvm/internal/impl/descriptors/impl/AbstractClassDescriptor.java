...
public abstract class AbstractClassDescriptor extends ModuleAwareClassDescriptor {
    ...
    private final Name f143788b;

    /* renamed from: c, reason: collision with root package name */
    protected final NotNullLazyValue<SimpleType> f143789c;

    /* renamed from: d, reason: collision with root package name */
    private final NotNullLazyValue<MemberScope> f143790d;

    /* renamed from: e, reason: collision with root package name */
    private final NotNullLazyValue<ReceiverParameterDescriptor> f143791e;
    ...
    class a implements Function0<SimpleType> {
        ...
        class C2262a implements Function1<KotlinTypeRefiner, SimpleType> {
            C2262a() {
            }
        ...
        public SimpleType invoke() {
            ...
            return TypeUtils.u(abstractClassDescriptor, abstractClassDescriptor.U(), new C2262a());
        }
    }
    ...
    public AbstractClassDescriptor(StorageManager storageManager, Name name) {
        ...
        this.f143788b = name;
        this.f143789c = storageManager.c(new a());
        this.f143790d = storageManager.c(new b());
        this.f143791e = storageManager.c(new c());
    }
    ...
    public ReceiverParameterDescriptor G0() {
        ReceiverParameterDescriptor receiverParameterDescriptorInvoke = this.f143791e.invoke();
    ...
    public MemberScope R() {
        MemberScope memberScopeInvoke = this.f143790d.invoke();
    ...
    public SimpleType o() {
        SimpleType simpleTypeInvoke = this.f143789c.invoke();
