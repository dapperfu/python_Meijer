...
public class ClassDescriptorImpl extends ClassDescriptorBase {
    ...
    private final Modality f143821i;

    /* renamed from: j, reason: collision with root package name */
    private final ClassKind f143822j;

    /* renamed from: k, reason: collision with root package name */
    private final TypeConstructor f143823k;

    /* renamed from: l, reason: collision with root package name */
    private MemberScope f143824l;

    /* renamed from: m, reason: collision with root package name */
    private Set<ClassConstructorDescriptor> f143825m;

    /* renamed from: n, reason: collision with root package name */
    private ClassConstructorDescriptor f143826n;
    ...
    public ClassDescriptorImpl(DeclarationDescriptor declarationDescriptor, Name name, Modality modality, ClassKind classKind, Collection<KotlinType> collection, SourceElement sourceElement, boolean z10, StorageManager storageManager) {
        ...
        this.f143821i = modality;
        this.f143822j = classKind;
        this.f143823k = new ClassTypeConstructorImpl(this, Collections.EMPTY_LIST, collection, storageManager);
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    public ClassConstructorDescriptor C() {
        return this.f143826n;
    }
    ...
    public final void H0(MemberScope memberScope, Set<ClassConstructorDescriptor> set, ClassConstructorDescriptor classConstructorDescriptor) {
        ...
        this.f143824l = memberScope;
        this.f143825m = set;
        this.f143826n = classConstructorDescriptor;
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    public ClassKind f() {
        ClassKind classKind = this.f143822j;
        if (classKind == null) {
            B0(15);
        }
        return classKind;
    ...
    public MemberScope g0(KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        MemberScope memberScope = this.f143824l;
        if (memberScope == null) {
            B0(13);
        }
        return memberScope;
    ...
    public TypeConstructor i() {
        TypeConstructor typeConstructor = this.f143823k;
    ...
    public Collection<ClassConstructorDescriptor> j() {
        Set<ClassConstructorDescriptor> set = this.f143825m;
        if (set == null) {
            B0(11);
        }
        return set;
    ...
    public Modality q() {
        Modality modality = this.f143821i;
        if (modality == null) {
            B0(16);
        }
        return modality;
