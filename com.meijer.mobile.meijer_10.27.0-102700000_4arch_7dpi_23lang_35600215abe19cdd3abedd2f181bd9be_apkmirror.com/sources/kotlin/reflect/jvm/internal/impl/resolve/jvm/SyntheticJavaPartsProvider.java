...
public interface SyntheticJavaPartsProvider {
    ...
    public static final Companion f146244a = Companion.f146245a;

    public static final class Companion {

        /* renamed from: a, reason: collision with root package name */
        static final /* synthetic */ Companion f146245a = new Companion();

        /* renamed from: b, reason: collision with root package name */
        private static final CompositeSyntheticJavaPartsProvider f146246b = new CompositeSyntheticJavaPartsProvider(CollectionsKt.m());
