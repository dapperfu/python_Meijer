...
public class OverridingUtil {
    ...
    private static final List<ExternalOverridabilityCondition> f146131e = CollectionsKt.j1(ServiceLoader.load(ExternalOverridabilityCondition.class, ExternalOverridabilityCondition.class.getClassLoader()));

    /* renamed from: f, reason: collision with root package name */
    public static final OverridingUtil f146132f;

    /* renamed from: g, reason: collision with root package name */
    private static final KotlinTypeChecker.TypeConstructorEquality f146133g;

    /* renamed from: a, reason: collision with root package name */
    private final KotlinTypeRefiner f146134a;

    /* renamed from: b, reason: collision with root package name */
    private final KotlinTypePreparator f146135b;

    /* renamed from: c, reason: collision with root package name */
    private final KotlinTypeChecker.TypeConstructorEquality f146136c;

    /* renamed from: d, reason: collision with root package name */
    private final Function2<KotlinType, KotlinType, Boolean> f146137d;

    public static class OverrideCompatibilityInfo {

        /* renamed from: c, reason: collision with root package name */
        private static final OverrideCompatibilityInfo f146138c = new OverrideCompatibilityInfo(Result.OVERRIDABLE, "SUCCESS");

        /* renamed from: a, reason: collision with root package name */
        private final Result f146139a;

        /* renamed from: b, reason: collision with root package name */
        private final String f146140b;
        ...
        */
        ...
        public static OverrideCompatibilityInfo e() {
            OverrideCompatibilityInfo overrideCompatibilityInfo = f146138c;
        ...
        public String toString() {
            return this.f146139a + ": " + this.f146140b;
        }
    }
    ...
    static class c implements Function1<CallableMemberDescriptor, Boolean> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ DeclarationDescriptor f146145a;

        c(DeclarationDescriptor declarationDescriptor) {
            this.f146145a = declarationDescriptor;
        }
        ...
        public Boolean invoke(CallableMemberDescriptor callableMemberDescriptor) {
            boolean z10;
            if (callableMemberDescriptor.b() == this.f146145a) {
                z10 = true;
            } else {
                z10 = false;
            }
    ...
    static class e implements Function1<CallableMemberDescriptor, Boolean> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ ClassDescriptor f146146a;

        e(ClassDescriptor classDescriptor) {
            this.f146146a = classDescriptor;
        }
        ...
        public Boolean invoke(CallableMemberDescriptor callableMemberDescriptor) {
            boolean z10 = false;
            if (!DescriptorVisibilities.g(callableMemberDescriptor.getVisibility()) && DescriptorVisibilities.h(callableMemberDescriptor, this.f146146a, false)) {
                z10 = true;
            }
            return Boolean.valueOf(z10);
        }
    ...
    static class g implements Function1<CallableMemberDescriptor, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ OverridingStrategy f146147a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ CallableMemberDescriptor f146148b;

        g(OverridingStrategy overridingStrategy, CallableMemberDescriptor callableMemberDescriptor) {
            this.f146147a = overridingStrategy;
            this.f146148b = callableMemberDescriptor;
        }

        @Override // kotlin.jvm.functions.Function1
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public Unit invoke(CallableMemberDescriptor callableMemberDescriptor) {
            this.f146147a.b(this.f146148b, callableMemberDescriptor);
    ...
    */
    ...
    static /* synthetic */ class h {
        ...
        /* renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f146149a;

        /* renamed from: b, reason: collision with root package name */
        static final /* synthetic */ int[] f146150b;

        /* renamed from: c, reason: collision with root package name */
        static final /* synthetic */ int[] f146151c;

        static {
            int[] iArr = new int[Modality.values().length];
            f146151c = iArr;
            try {
                iArr[Modality.f143619b.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f146151c[Modality.f143620c.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f146151c[Modality.f143621d.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f146151c[Modality.f143622e.ordinal()] = 4;
            ...
            try {
                f146150b[OverrideCompatibilityInfo.Result.CONFLICT.ordinal()] = 2;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f146150b[OverrideCompatibilityInfo.Result.INCOMPATIBLE.ordinal()] = 3;
            ...
            try {
                f146149a[ExternalOverridabilityCondition.Result.INCOMPATIBLE.ordinal()] = 2;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f146149a[ExternalOverridabilityCondition.Result.UNKNOWN.ordinal()] = 3;
    ...
    static {
        a aVar = new a();
        f146133g = aVar;
        f146132f = new OverridingUtil(aVar, KotlinTypeRefiner.Default.f146818a, KotlinTypePreparator.Default.f146817a, null);
    }
    ...
    private OverridingUtil(KotlinTypeChecker.TypeConstructorEquality typeConstructorEquality, KotlinTypeRefiner kotlinTypeRefiner, KotlinTypePreparator kotlinTypePreparator, Function2<KotlinType, KotlinType, Boolean> function2) {
        ...
        this.f146136c = typeConstructorEquality;
        this.f146134a = kotlinTypeRefiner;
        this.f146135b = kotlinTypePreparator;
        this.f146137d = function2;
    }
    ...
    public static boolean B(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2) {
        ...
        TypeCheckerState typeCheckerStateL = f146132f.l(callableDescriptor.getTypeParameters(), callableDescriptor2.getTypeParameters());
        ...
        if (A(propertyDescriptor.getSetter(), propertyDescriptor2.getSetter())) {
            return (propertyDescriptor.L() && propertyDescriptor2.L()) ? AbstractTypeChecker.f146670a.m(typeCheckerStateL, returnType.N0(), returnType2.N0()) : (propertyDescriptor.L() || !propertyDescriptor2.L()) && G(callableDescriptor, returnType, callableDescriptor2, returnType2, typeCheckerStateL);
        }
        return false;
    }
    ...
    private static boolean G(CallableDescriptor callableDescriptor, KotlinType kotlinType, CallableDescriptor callableDescriptor2, KotlinType kotlinType2, TypeCheckerState typeCheckerState) {
        ...
        return AbstractTypeChecker.f146670a.t(typeCheckerState, kotlinType.N0(), kotlinType2.N0());
    }
    ...
    public static <D extends CallableDescriptor> boolean J(D d10, D d11, boolean z10, boolean z11) {
        ...
        if (!d10.equals(d11) && DescriptorEquivalenceForOverrides.f146116a.k(d10.a(), d11.a(), z10, z11)) {
            return true;
        }
        CallableDescriptor callableDescriptorA = d11.a();
        Iterator it = DescriptorUtils.d(d10).iterator();
        while (it.hasNext()) {
            if (DescriptorEquivalenceForOverrides.f146116a.k(callableDescriptorA, (CallableDescriptor) it.next(), z10, z11)) {
                return true;
            }
        }
        return false;
    ...
    public static void K(CallableMemberDescriptor callableMemberDescriptor, Function1<CallableMemberDescriptor, Unit> function1) {
        ...
        for (CallableMemberDescriptor callableMemberDescriptor2 : callableMemberDescriptor.d()) {
            if (callableMemberDescriptor2.getVisibility() == DescriptorVisibilities.f143602g) {
                K(callableMemberDescriptor2, function1);
            }
        }
        if (callableMemberDescriptor.getVisibility() != DescriptorVisibilities.f143602g) {
            return;
        }
        ...
        if (descriptorVisibilityH == null) {
            ...
            descriptorVisibility = DescriptorVisibilities.f143600e;
        } else {
    ...
    */
    ...
    private static boolean d(KotlinType kotlinType, KotlinType kotlinType2, TypeCheckerState typeCheckerState) {
        ...
        return AbstractTypeChecker.f146670a.m(typeCheckerState, kotlinType.N0(), kotlinType2.N0());
    }
    ...
    private static DescriptorVisibility h(CallableMemberDescriptor callableMemberDescriptor) {
        ...
        for (CallableMemberDescriptor callableMemberDescriptor2 : collectionD) {
            if (callableMemberDescriptor2.q() != Modality.f143622e && !callableMemberDescriptor2.getVisibility().equals(descriptorVisibilityU)) {
                return null;
            }
        }
    ...
    public static OverridingUtil i(KotlinTypeRefiner kotlinTypeRefiner, KotlinTypeChecker.TypeConstructorEquality typeConstructorEquality) {
        ...
        return new OverridingUtil(typeConstructorEquality, kotlinTypeRefiner, KotlinTypePreparator.Default.f146817a, null);
    }
    ...
    private static void j(Collection<CallableMemberDescriptor> collection, ClassDescriptor classDescriptor, OverridingStrategy overridingStrategy) {
        ...
        CallableMemberDescriptor callableMemberDescriptorM = ((CallableMemberDescriptor) L(collection, new d())).M(classDescriptor, n(collection, classDescriptor), zIsEmpty ? DescriptorVisibilities.f143603h : DescriptorVisibilities.f143602g, CallableMemberDescriptor.Kind.FAKE_OVERRIDE, false);
    ...
    private TypeCheckerState l(List<TypeParameterDescriptor> list, List<TypeParameterDescriptor> list2) {
        ...
        if (list.isEmpty()) {
            TypeCheckerState typeCheckerStateH0 = new OverridingUtilTypeSystemContext(null, this.f146136c, this.f146134a, this.f146135b, this.f146137d).H0(true, true, false);
        ...
        TypeCheckerState typeCheckerStateH02 = new OverridingUtilTypeSystemContext(map, this.f146136c, this.f146134a, this.f146135b, this.f146137d).H0(true, true, false);
    ...
    public static OverridingUtil m(KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        return new OverridingUtil(f146133g, kotlinTypeRefiner, KotlinTypePreparator.Default.f146817a, null);
    }
    ...
    private static Modality n(Collection<CallableMemberDescriptor> collection, ClassDescriptor classDescriptor) {
        ...
        for (CallableMemberDescriptor callableMemberDescriptor : collection) {
            int i10 = h.f146151c[callableMemberDescriptor.q().ordinal()];
            if (i10 == 1) {
        ...
        if (classDescriptor.h0() && classDescriptor.q() != Modality.f143622e && classDescriptor.q() != Modality.f143620c) {
            z10 = true;
        }
        if (z11 && !z12) {
            Modality modality2 = Modality.f143621d;
            if (modality2 == null) {
                a(89);
            }
            return modality2;
        ...
        if (!z11 && z12) {
            Modality modalityQ = z10 ? classDescriptor.q() : Modality.f143622e;
            if (modalityQ == null) {
                a(90);
            }
            return modalityQ;
    ...
    private Collection<CallableMemberDescriptor> o(CallableMemberDescriptor callableMemberDescriptor, Collection<? extends CallableMemberDescriptor> collection, ClassDescriptor classDescriptor, OverridingStrategy overridingStrategy) {
        ...
        for (CallableMemberDescriptor callableMemberDescriptor2 : collection) {
            ...
            int i10 = h.f146150b[resultC.ordinal()];
            if (i10 == 1) {
                if (zI) {
    ...
    public static DescriptorVisibility u(Collection<? extends CallableMemberDescriptor> collection) {
        ...
        if (collection.isEmpty()) {
            return DescriptorVisibilities.f143607l;
        }
    ...
    public static OverrideCompatibilityInfo.Result x(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2) {
        OverridingUtil overridingUtil = f146132f;
    ...
    private static Modality y(Collection<CallableMemberDescriptor> collection, boolean z10, Modality modality) {
        ...
        Modality modality2 = Modality.f143622e;
        for (CallableMemberDescriptor callableMemberDescriptor : collection) {
            Modality modalityQ = (z10 && callableMemberDescriptor.q() == Modality.f143622e) ? modality : callableMemberDescriptor.q();
    ...
    public OverrideCompatibilityInfo E(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2, ClassDescriptor classDescriptor, boolean z10) {
        ...
        for (ExternalOverridabilityCondition externalOverridabilityCondition : f146131e) {
            if (externalOverridabilityCondition.a() != ExternalOverridabilityCondition.Contract.CONFLICTS_ONLY && (!z11 || externalOverridabilityCondition.a() != ExternalOverridabilityCondition.Contract.SUCCESS_ONLY)) {
                int i10 = h.f146149a[externalOverridabilityCondition.b(callableDescriptor, callableDescriptor2, classDescriptor).ordinal()];
                if (i10 == 1) {
                    z11 = true;
                } else if (i10 == 2) {
        ...
        for (ExternalOverridabilityCondition externalOverridabilityCondition2 : f146131e) {
            if (externalOverridabilityCondition2.a() == ExternalOverridabilityCondition.Contract.CONFLICTS_ONLY) {
                int i11 = h.f146149a[externalOverridabilityCondition2.b(callableDescriptor, callableDescriptor2, classDescriptor).ordinal()];
                if (i11 == 1) {
    ...
    public OverrideCompatibilityInfo F(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2, boolean z10) {
        ...
        if (typeParameters.size() != typeParameters2.size()) {
            while (i10 < listG.size()) {
                if (!KotlinTypeChecker.f146816a.b(listG.get(i10), listG2.get(i10))) {
        ...
        if (z10) {
            KotlinType returnType = callableDescriptor.getReturnType();
            KotlinType returnType2 = callableDescriptor2.getReturnType();
            if (returnType != null && returnType2 != null && ((!KotlinTypeKt.a(returnType2) || !KotlinTypeKt.a(returnType)) && !AbstractTypeChecker.f146670a.t(typeCheckerStateL, returnType2.N0(), returnType.N0()))) {
