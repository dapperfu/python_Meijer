...
public final class InnerClassesScopeWrapper extends MemberScopeImpl {
    ...
    private final MemberScope f146288b;

    public InnerClassesScopeWrapper(MemberScope workerScope) {
        Intrinsics.j(workerScope, "workerScope");
        this.f146288b = workerScope;
    }

    @Override // kotlin.reflect.jvm.internal.impl.resolve.scopes.MemberScopeImpl, kotlin.reflect.jvm.internal.impl.resolve.scopes.MemberScope
    public Set<Name> a() {
        return this.f146288b.a();
    }

    @Override // kotlin.reflect.jvm.internal.impl.resolve.scopes.MemberScopeImpl, kotlin.reflect.jvm.internal.impl.resolve.scopes.MemberScope
    public Set<Name> d() {
        return this.f146288b.d();
    }

    @Override // kotlin.reflect.jvm.internal.impl.resolve.scopes.MemberScopeImpl, kotlin.reflect.jvm.internal.impl.resolve.scopes.MemberScope
    public Set<Name> e() {
        return this.f146288b.e();
    }
    ...
    public ClassifierDescriptor f(Name name, LookupLocation location) {
        ...
        ClassifierDescriptor classifierDescriptorF = this.f146288b.f(name, location);
    ...
    public List<ClassifierDescriptor> g(DescriptorKindFilter kindFilter, Function1<? super Name, Boolean> nameFilter) {
        ...
        DescriptorKindFilter descriptorKindFilterN = kindFilter.n(DescriptorKindFilter.f146255c.c());
        if (descriptorKindFilterN == null) {
            return CollectionsKt.m();
        }
        Collection<DeclarationDescriptor> collectionG = this.f146288b.g(descriptorKindFilterN, nameFilter);
    ...
    public String toString() {
        return "Classes from " + this.f146288b;
    }
}
