...
public abstract class GivenFunctionsMemberScope extends MemberScopeImpl {
    ...
    static final /* synthetic */ KProperty<Object>[] f146283d = {Reflection.j(new PropertyReference1Impl(GivenFunctionsMemberScope.class, "allDescriptors", "getAllDescriptors()Ljava/util/List;", 0))};

    /* renamed from: b, reason: collision with root package name */
    private final ClassDescriptor f146284b;

    /* renamed from: c, reason: collision with root package name */
    private final NotNullLazyValue f146285c;
    ...
    public GivenFunctionsMemberScope(StorageManager storageManager, ClassDescriptor containingClass) {
        ...
        this.f146284b = containingClass;
        this.f146285c = storageManager.c(new a(this));
    }
    ...
    private final List<DeclarationDescriptor> k(List<? extends FunctionDescriptor> list) {
        ...
        Collection<KotlinType> collectionA = this.f146284b.i().a();
        ...
        for (Map.Entry entry : linkedHashMap.entrySet()) {
            ...
            for (Map.Entry entry2 : linkedHashMap2.entrySet()) {
                ...
                OverridingUtil overridingUtil = OverridingUtil.f146132f;
                List list4 = list3;
                if (zBooleanValue) {
                ...
                overridingUtil.v(name2, list4, collectionM, this.f146284b, new NonReportingOverrideStrategy() { // from class: kotlin.reflect.jvm.internal.impl.resolve.scopes.GivenFunctionsMemberScope$createFakeOverrides$4
    ...
    private final List<DeclarationDescriptor> l() {
        return (List) StorageKt.a(this.f146285c, this, f146283d[0]);
    }
    ...
    public Collection<DeclarationDescriptor> g(DescriptorKindFilter kindFilter, Function1<? super Name, Boolean> nameFilter) {
        ...
        return !kindFilter.a(DescriptorKindFilter.f146268p.m()) ? CollectionsKt.m() : l();
    }
