...
public final class CapturedType extends SimpleType implements CapturedTypeMarker {
    ...
    private final TypeProjection f146163b;

    /* renamed from: c, reason: collision with root package name */
    private final CapturedTypeConstructor f146164c;

    /* renamed from: d, reason: collision with root package name */
    private final boolean f146165d;

    /* renamed from: e, reason: collision with root package name */
    private final TypeAttributes f146166e;
    ...
    public /* synthetic */ CapturedType(TypeProjection typeProjection, CapturedTypeConstructor capturedTypeConstructor, boolean z10, TypeAttributes typeAttributes, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(typeProjection, (i10 & 2) != 0 ? new CapturedTypeConstructorImpl(typeProjection) : capturedTypeConstructor, (i10 & 4) != 0 ? false : z10, (i10 & 8) != 0 ? TypeAttributes.f146740b.k() : typeAttributes);
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.KotlinType
    public TypeAttributes J0() {
        return this.f146166e;
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.KotlinType
    public boolean L0() {
        return this.f146165d;
    }
    ...
    public SimpleType Q0(TypeAttributes newAttributes) {
        ...
        return new CapturedType(this.f146163b, K0(), L0(), newAttributes);
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.KotlinType
    /* renamed from: T0, reason: merged with bridge method [inline-methods] */
    public CapturedTypeConstructor K0() {
        return this.f146164c;
    }
    ...
    public CapturedType U0(KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        TypeProjection typeProjectionB = this.f146163b.b(kotlinTypeRefiner);
    ...
    public CapturedType R0(boolean z10) {
        ...
        return new CapturedType(this.f146163b, K0(), z10, J0());
    }
    ...
    public CapturedType(TypeProjection typeProjection, CapturedTypeConstructor constructor, boolean z10, TypeAttributes attributes) {
        ...
        this.f146163b = typeProjection;
        this.f146164c = constructor;
        this.f146165d = z10;
        this.f146166e = attributes;
    }
}
