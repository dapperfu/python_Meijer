...
public final class OverridingUtilTypeSystemContext implements ClassicTypeSystemContext {
    ...
    private final Map<TypeConstructor, TypeConstructor> f146152a;

    /* renamed from: b, reason: collision with root package name */
    private final KotlinTypeChecker.TypeConstructorEquality f146153b;

    /* renamed from: c, reason: collision with root package name */
    private final KotlinTypeRefiner f146154c;

    /* renamed from: d, reason: collision with root package name */
    private final KotlinTypePreparator f146155d;

    /* renamed from: e, reason: collision with root package name */
    private final Function2<KotlinType, KotlinType, Boolean> f146156e;
    ...
    public OverridingUtilTypeSystemContext(Map<TypeConstructor, ? extends TypeConstructor> map, KotlinTypeChecker.TypeConstructorEquality equalityAxioms, KotlinTypeRefiner kotlinTypeRefiner, KotlinTypePreparator kotlinTypePreparator, Function2<? super KotlinType, ? super KotlinType, Boolean> function2) {
        ...
        this.f146152a = map;
        this.f146153b = equalityAxioms;
        this.f146154c = kotlinTypeRefiner;
        this.f146155d = kotlinTypePreparator;
        this.f146156e = function2;
    }

    private final boolean N0(TypeConstructor typeConstructor, TypeConstructor typeConstructor2) {
        if (this.f146153b.a(typeConstructor, typeConstructor2)) {
            return true;
        }
        Map<TypeConstructor, TypeConstructor> map = this.f146152a;
        if (map == null) {
            return false;
        }
        TypeConstructor typeConstructor3 = map.get(typeConstructor);
        TypeConstructor typeConstructor4 = this.f146152a.get(typeConstructor2);
    ...
    public TypeCheckerState H0(final boolean z10, final boolean z11, final boolean z12) {
        if (this.f146156e == null) {
            return ClassicTypeCheckerStateKt.a(z10, z11, this, this.f146155d, this.f146154c);
        }
        final KotlinTypePreparator kotlinTypePreparator = this.f146155d;
        final KotlinTypeRefiner kotlinTypeRefiner = this.f146154c;
        return new TypeCheckerState(z10, z11, z12, this, kotlinTypePreparator, kotlinTypeRefiner) { // from class: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtilTypeSystemContext$newTypeCheckerState$1
            ...
            final /* synthetic */ OverridingUtilTypeSystemContext f146157l;
            ...
            public boolean f(KotlinTypeMarker subType, KotlinTypeMarker superType) {
                ...
                if (superType instanceof KotlinType) {
                    return ((Boolean) this.f146157l.f146156e.invoke(subType, superType)).booleanValue();
                }
                throw new IllegalArgumentException("Failed requirement.");
            }
        };
