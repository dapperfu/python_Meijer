...
public final class ConstantValueFactory {
    ...
    public static final ConstantValueFactory f146175a = new ConstantValueFactory();
    ...
    public final ConstantValue<?> e(Object obj, ModuleDescriptor moduleDescriptor) {
        ...
        if (obj instanceof byte[]) {
            return b(ArraysKt.c1((byte[]) obj), moduleDescriptor, PrimitiveType.f143259i);
        }
        if (obj instanceof short[]) {
            return b(ArraysKt.j1((short[]) obj), moduleDescriptor, PrimitiveType.f143260j);
        }
        if (obj instanceof int[]) {
            return b(ArraysKt.g1((int[]) obj), moduleDescriptor, PrimitiveType.f143261k);
        }
        if (obj instanceof long[]) {
            return b(ArraysKt.h1((long[]) obj), moduleDescriptor, PrimitiveType.f143263m);
        }
        if (obj instanceof char[]) {
            return b(ArraysKt.d1((char[]) obj), moduleDescriptor, PrimitiveType.f143258h);
        }
        if (obj instanceof float[]) {
            return b(ArraysKt.f1((float[]) obj), moduleDescriptor, PrimitiveType.f143262l);
        }
        if (obj instanceof double[]) {
            return b(ArraysKt.e1((double[]) obj), moduleDescriptor, PrimitiveType.f143264n);
        }
        if (obj instanceof boolean[]) {
            return b(ArraysKt.k1((boolean[]) obj), moduleDescriptor, PrimitiveType.f143257g);
        }
        if (obj == null) {
