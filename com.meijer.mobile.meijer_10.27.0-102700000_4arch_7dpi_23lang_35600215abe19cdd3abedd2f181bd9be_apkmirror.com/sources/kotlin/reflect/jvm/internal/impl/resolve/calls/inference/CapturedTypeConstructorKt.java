...
public final class CapturedTypeConstructorKt {
    ...
    public static final TypeProjection c(TypeProjection typeProjection, TypeParameterDescriptor typeParameterDescriptor) {
        if (typeParameterDescriptor == null || typeProjection.c() == Variance.f146796e) {
        ...
        StorageManager NO_LOCKS = LockBasedStorageManager.f146633e;
    ...
    public static final TypeSubstitution g(final TypeSubstitution typeSubstitution, final boolean z10) {
        ...
        List<Pair> listY1 = ArraysKt.y1(indexedParametersSubstitution.i(), indexedParametersSubstitution.j());
        ArrayList arrayList = new ArrayList(CollectionsKt.x(listY1, 10));
        for (Pair pair : listY1) {
