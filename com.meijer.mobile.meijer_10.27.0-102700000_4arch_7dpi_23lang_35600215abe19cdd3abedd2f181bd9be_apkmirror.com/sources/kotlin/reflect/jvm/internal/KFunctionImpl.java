...
public final class KFunctionImpl extends KCallableImpl<Object> implements FunctionBase<Object>, KFunction<Object>, FunctionWithAllInvokes {
    ...
    static final /* synthetic */ KProperty<Object>[] f143061m = {Reflection.j(new PropertyReference1Impl(KFunctionImpl.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/FunctionDescriptor;", 0))};
    ...
    public static final Caller a0(KFunctionImpl kFunctionImpl) throws NoSuchMethodException, SecurityException {
        Object objD;
        Caller<?> callerC0;
        JvmFunctionSignature jvmFunctionSignatureG = RuntimeTypeMapper.f143137a.g(kFunctionImpl.X());
        if (jvmFunctionSignatureG instanceof JvmFunctionSignature.KotlinConstructor) {
            if (kFunctionImpl.U()) {
                ...
                return new AnnotationConstructorCaller(clsH, arrayList, AnnotationConstructorCaller.CallMode.f143164b, AnnotationConstructorCaller.Origin.f143168b, null, 16, null);
            }
            ...
            if (!(jvmFunctionSignatureG instanceof JvmFunctionSignature.JavaConstructor)) {
                ...
                return new AnnotationConstructorCaller(clsH2, arrayList2, AnnotationConstructorCaller.CallMode.f143164b, AnnotationConstructorCaller.Origin.f143167a, listD);
            }
    ...
    */
    ...
    public FunctionDescriptor X() {
        T tB = this.descriptor.b(this, f143061m[0]);
    ...
    public String toString() {
        return ReflectionObjectRenderer.f143135a.f(X());
    }
    ...
    */
    ...
    public KFunctionImpl(KDeclarationContainerImpl container, FunctionDescriptor descriptor) {
        ...
        Intrinsics.i(strB, "asString(...)");
        this(container, strB, RuntimeTypeMapper.f143137a.g(descriptor).get_signature(), descriptor, null, 16, null);
    }
}
