...
public abstract class KCallableImpl<R> implements KCallable<R>, KTypeParameterOwnerImpl {
    ...
    public final R L(Map<KParameter, ? extends Object> args, Continuation<?> continuationArgument) throws IllegalCallableAccessException {
        ...
        for (KParameter kParameter : parameters) {
            ...
            if (kParameter.getKind() == KParameter.Kind.f142944c) {
                i10 += iT;
            }
        }
        if (!z10) {
    ...
    public KCallableImpl() {
        ReflectProperties.LazySoftVal<List<Annotation>> lazySoftValC = ReflectProperties.c(new C15235i(this));
        Intrinsics.i(lazySoftValC, "lazySoft(...)");
        this._annotations = lazySoftValC;
        ReflectProperties.LazySoftVal<ArrayList<KParameter>> lazySoftValC2 = ReflectProperties.c(new C15281j(this));
        Intrinsics.i(lazySoftValC2, "lazySoft(...)");
        this._parameters = lazySoftValC2;
        ReflectProperties.LazySoftVal<KTypeImpl> lazySoftValC3 = ReflectProperties.c(new C15282k(this));
        Intrinsics.i(lazySoftValC3, "lazySoft(...)");
        this._returnType = lazySoftValC3;
        ReflectProperties.LazySoftVal<List<KTypeParameterImpl>> lazySoftValC4 = ReflectProperties.c(new C15283l(this));
        Intrinsics.i(lazySoftValC4, "lazySoft(...)");
        this._typeParameters = lazySoftValC4;
        ReflectProperties.LazySoftVal<Object[]> lazySoftValC5 = ReflectProperties.c(new C15284m(this));
        Intrinsics.i(lazySoftValC5, "lazySoft(...)");
        this._absentArguments = lazySoftValC5;
        this.parametersNeedMFVCFlattening = LazyKt.a(LazyThreadSafetyMode.f142380b, new C15285n(this));
    }
    ...
    public static final Object[] k(KCallableImpl kCallableImpl) {
        ...
        if (kCallableImpl.parametersNeedMFVCFlattening.getValue().booleanValue()) {
            ...
            if ((list instanceof Collection) && list.isEmpty()) {
                ...
                i10 = 0;
                while (it.hasNext()) {
                    if (((KParameter) it.next()).getKind() == KParameter.Kind.f142944c && (i10 = i10 + 1) < 0) {
                        CollectionsKt.v();
                    }
                }
            }
    ...
    public static final ArrayList p(KCallableImpl kCallableImpl) {
        ...
        if (!kCallableImpl.V()) {
            ...
            if (receiverParameterDescriptorI != null) {
                arrayList.add(new KParameterImpl(kCallableImpl, 0, KParameter.Kind.f142942a, new C15286o(receiverParameterDescriptorI)));
                i10 = 1;
            } else {
                i10 = 0;
            }
            ...
            if (receiverParameterDescriptorN != null) {
                arrayList.add(new KParameterImpl(kCallableImpl, i10, KParameter.Kind.f142943b, new C15287p(receiverParameterDescriptorN)));
                i10++;
            }
        } else {
            i10 = 0;
        ...
        while (i11 < size) {
            arrayList.add(new KParameterImpl(kCallableImpl, i10, KParameter.Kind.f142944c, new C15288q(callableMemberDescriptorS, i11)));
            i11++;
            i10++;
        }
