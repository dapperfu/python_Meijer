...
public final class KClassImpl<T> extends KDeclarationContainerImpl implements KClass<T>, KClassifierImpl, KTypeParameterOwnerImpl {
    ...
    public final class Data extends KDeclarationContainerImpl.Data {
        ...
        public Data() {
            super();
            this.descriptor = ReflectProperties.c(new C15290t(KClassImpl.this));
            ...
            this.objectInstance = LazyKt.a(LazyThreadSafetyMode.f142380b, new J(this, KClassImpl.this));
            ...
            this.declaredNonStaticMembers = ReflectProperties.c(new C15291u(KClassImpl.this));
            this.declaredStaticMembers = ReflectProperties.c(new C15292v(KClassImpl.this));
            this.inheritedNonStaticMembers = ReflectProperties.c(new C15293w(KClassImpl.this));
            this.inheritedStaticMembers = ReflectProperties.c(new C15294x(KClassImpl.this));
            this.allNonStaticMembers = ReflectProperties.c(new C15295y(this));
            this.allStaticMembers = ReflectProperties.c(new C15296z(this));
        ...
        private final Collection<KCallableImpl<?>> K() {
            T tB = this.declaredStaticMembers.b(this, f143028w[10]);
            Intrinsics.i(tB, "getValue(...)");
            return (Collection) tB;
        }

        private final Collection<KCallableImpl<?>> M() {
            T tB = this.inheritedNonStaticMembers.b(this, f143028w[11]);
            Intrinsics.i(tB, "getValue(...)");
            return (Collection) tB;
        }

        private final Collection<KCallableImpl<?>> N() {
            T tB = this.inheritedStaticMembers.b(this, f143028w[12]);
            Intrinsics.i(tB, "getValue(...)");
            return (Collection) tB;
        }
        ...
        public final Collection<KCallableImpl<?>> H() {
            T tB = this.allNonStaticMembers.b(this, f143028w[13]);
            Intrinsics.i(tB, "getValue(...)");
            return (Collection) tB;
        }

        public final Collection<KCallableImpl<?>> I() {
            T tB = this.allStaticMembers.b(this, f143028w[14]);
            Intrinsics.i(tB, "getValue(...)");
            return (Collection) tB;
        }

        public final Collection<KCallableImpl<?>> J() {
            T tB = this.declaredNonStaticMembers.b(this, f143028w[9]);
            Intrinsics.i(tB, "getValue(...)");
            return (Collection) tB;
        }

        public final ClassDescriptor L() {
            T tB = this.descriptor.b(this, f143028w[0]);
            Intrinsics.i(tB, "getValue(...)");
            return (ClassDescriptor) tB;
        }

        public final String O() {
            return (String) this.qualifiedName.b(this, f143028w[3]);
        }

        public final String P() {
            return (String) this.simpleName.b(this, f143028w[2]);
        }
        ...
        private final String B(Class<?> jClass) {
            ...
            if (enclosingMethod != null) {
                ...
                return StringsKt.k1(simpleName, enclosingMethod.getName() + '$', null, 2, null);
            }
            Constructor<?> enclosingConstructor = jClass.getEnclosingConstructor();
            if (enclosingConstructor != null) {
                Intrinsics.g(simpleName);
                return StringsKt.k1(simpleName, enclosingConstructor.getName() + '$', null, 2, null);
            }
            Intrinsics.g(simpleName);
            return StringsKt.j1(simpleName, '$', null, 2, null);
        }
        ...
        public static final Collection E(KClassImpl kClassImpl) {
            return kClassImpl.I(kClassImpl.Z(), KDeclarationContainerImpl.MemberBelonginess.f143055a);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Collection F(KClassImpl kClassImpl) {
            return kClassImpl.I(kClassImpl.a0(), KDeclarationContainerImpl.MemberBelonginess.f143055a);
        }
        ...
        public static final Collection Q(KClassImpl kClassImpl) {
            return kClassImpl.I(kClassImpl.Z(), KDeclarationContainerImpl.MemberBelonginess.f143056b);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Collection R(KClassImpl kClassImpl) {
            return kClassImpl.I(kClassImpl.a0(), KDeclarationContainerImpl.MemberBelonginess.f143056b);
        }
        ...
        public static final Object T(Data data, KClassImpl kClassImpl) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
            ...
            if (classDescriptorL.f() != ClassKind.f143590g) {
                return null;
            }
            if (classDescriptorL.Z() && !CompanionObjectMappingUtilsKt.a(CompanionObjectMapping.f143236a, classDescriptorL)) {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            try {
                iArr[KotlinClassHeader.Kind.f144869f.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[KotlinClassHeader.Kind.f144871h.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[KotlinClassHeader.Kind.f144872i.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[KotlinClassHeader.Kind.f144870g.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                iArr[KotlinClassHeader.Kind.f144867d.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                iArr[KotlinClassHeader.Kind.f144868e.ordinal()] = 6;
    ...
    /* synthetic */ class a extends FunctionReferenceImpl implements Function2<MemberDeserializer, ProtoBuf.Property, PropertyDescriptor> {
        ...
        public static final a f143048b = new a();
    ...
    public KClassImpl(Class<T> jClass) {
        ...
        this.jClass = jClass;
        this.data = LazyKt.a(LazyThreadSafetyMode.f142380b, new C15289s(this));
    }

    private final ClassDescriptor T(ClassId classId, RuntimeModuleData moduleData) {
        final ClassDescriptorImpl classDescriptorImpl = new ClassDescriptorImpl(new EmptyPackageFragmentDescriptor(moduleData.b(), classId.f()), classId.h(), Modality.f143619b, ClassKind.f143585b, CollectionsKt.e(moduleData.b().l().h().o()), SourceElement.f143647a, false, moduleData.a().u());
    ...
    public final ClassId W() {
        return RuntimeTypeMapper.f143137a.c(h());
    }
    ...
    public Collection<FunctionDescriptor> G(Name name) {
        ...
        NoLookupLocation noLookupLocation = NoLookupLocation.f144122h;
    ...
    public final ClassDescriptor U(ClassId classId, RuntimeModuleData moduleData) {
        ...
        ReflectKotlinClass reflectKotlinClassA = ReflectKotlinClass.f144040c.a(h());
    ...
    public Collection<ConstructorDescriptor> F() {
        ...
        if (classDescriptorA.f() != ClassKind.f143586c && classDescriptorA.f() != ClassKind.f143590g) {
    ...
    public PropertyDescriptor H(int index) {
        ...
        if (deserializedClassDescriptor != null) {
            ...
            GeneratedMessageLite.GeneratedExtension<ProtoBuf.Class, List<ProtoBuf.Property>> classLocalVariable = JvmProtoBuf.f145562j;
            ...
            if (property != null) {
                return (PropertyDescriptor) UtilKt.h(h(), property, deserializedClassDescriptor.a1().g(), deserializedClassDescriptor.a1().j(), deserializedClassDescriptor.d1(), a.f143048b);
            }
        }
        return null;
    }
