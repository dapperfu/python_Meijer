...
public final class KClassifiers {
    ...
    public static final KType b(KClassifier kClassifier, List<KTypeProjection> arguments, boolean z10, List<? extends Annotation> annotations) {
        ...
        if (parameters.size() == arguments.size()) {
            return new KTypeImpl(a(annotations.isEmpty() ? TypeAttributes.f146740b.k() : TypeAttributes.f146740b.k(), typeConstructorI, arguments, z10), function0, 2, objArr == true ? 1 : 0);
        }
        ...
        for (Object obj : list2) {
            ...
            if (i10 != -1) {
                if (i10 != 1) {
                    if (i10 != 2) {
                        if (i10 == 3) {
                            Variance variance = Variance.f146798g;
                        ...
                        Variance variance2 = Variance.f146797f;
                        Intrinsics.g(kotlinTypeW);
