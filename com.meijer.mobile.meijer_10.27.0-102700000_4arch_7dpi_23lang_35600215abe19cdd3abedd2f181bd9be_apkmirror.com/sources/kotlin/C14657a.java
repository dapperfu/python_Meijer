...
@AbstractC14653B.b("activity")
@SourceDebugExtension
/* renamed from: i4.a, reason: case insensitive filesystem */
/* loaded from: classes4.dex */
public class C14657a extends AbstractC14653B<b> {
    ...
    @SourceDebugExtension
    /* renamed from: i4.a$b */
    public static class b extends C14672p {
        ...
        public b(AbstractC14653B<? extends b> activityNavigator) {
    ...
    /* renamed from: i4.a$c */
    public static final class c implements AbstractC14653B.a {
    ...
    static final class d extends Lambda implements Function1<Context, Context> {
        ...
        public static final d f137218f = new d();
    ...
    public C14657a(Context context) {
        Object next;
        Intrinsics.j(context, "context");
        this.context = context;
        Iterator it = SequencesKt.q(context, d.f137218f).iterator();
        while (true) {
            if (!it.hasNext()) {
                next = null;
                break;
    ...
    public C14672p d(b destination, Bundle args, C14679w navOptions, AbstractC14653B.a navigatorExtras) {
