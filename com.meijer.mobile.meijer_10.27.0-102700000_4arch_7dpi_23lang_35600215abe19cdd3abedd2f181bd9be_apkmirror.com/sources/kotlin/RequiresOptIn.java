...
public @interface RequiresOptIn {
    ...
    public static final class Level {
        ...
        public static final Level f142386a = new Level("WARNING", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final Level f142387b = new Level("ERROR", 1);

        /* renamed from: c, reason: collision with root package name */
        private static final /* synthetic */ Level[] f142388c;

        /* renamed from: d, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f142389d;

        private static final /* synthetic */ Level[] a() {
            return new Level[]{f142386a, f142387b};
        }

        static {
            Level[] levelArrA = a();
            f142388c = levelArrA;
            f142389d = EnumEntriesKt.a(levelArrA);
        }
