...
public final class DurationKt {
    ...
    public static final long p(String str, boolean z10) {
        ...
        boolean z13 = z12 && StringsKt.d1(str, '-', false, 2, null);
        if (length <= length2) {
        ...
        if (str.charAt(length2) == 'P') {
                ...
                if (str.charAt(i12) != 'T') {
                    ...
                    while (true) {
                        ...
                        if (c11 > cCharAt4 || cCharAt4 >= c10) {
                            i11 = length;
                            if (!StringsKt.b0("+-.", cCharAt4, false, 2, null)) {
                                break;
                            }
                        } else {
                            i11 = length;
                    ...
                    int iO0 = StringsKt.o0(strSubstring, '.', 0, false, 6, null);
                    if (durationUnitD != DurationUnit.f147509e || iO0 <= 0) {
                        z11 = z14;
                        ...
                        String strSubstring2 = strSubstring.substring(0, iO0);
                        Intrinsics.i(strSubstring2, "substring(...)");
                        z11 = z14;
                        long jW = Duration.W(jC, t(q(strSubstring2), durationUnitD));
                        Intrinsics.h(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring3 = strSubstring.substring(iO0);
            ...
            if (StringsKt.K(str, length2, "Infinity", 0, Math.max(length - length2, 8), true)) {
                ...
                boolean z15 = !z12;
                if (z12 && str.charAt(length2) == '(' && StringsKt.H1(str) == ')') {
                    length2++;
                    int i14 = length - 1;
                    if (length2 == i14) {
                        throw new IllegalArgumentException("No components");
    ...
    public static final long r(double d10, DurationUnit unit) {
        ...
        double dA = DurationUnitKt__DurationUnitJvmKt.a(d10, unit, DurationUnit.f147506b);
        if (Double.isNaN(dA)) {
            throw new IllegalArgumentException("Duration value cannot be NaN.");
        }
        long jE = MathKt.e(dA);
        return (-4611686018426999999L > jE || jE >= 4611686018427000000L) ? k(MathKt.e(DurationUnitKt__DurationUnitJvmKt.a(d10, unit, DurationUnit.f147508d))) : l(jE);
    }
    ...
    public static final long s(int i10, DurationUnit unit) {
        Intrinsics.j(unit, "unit");
        return unit.compareTo(DurationUnit.f147509e) <= 0 ? l(DurationUnitKt__DurationUnitJvmKt.c(i10, unit, DurationUnit.f147506b)) : t(i10, unit);
    }
    ...
    public static final long t(long j10, DurationUnit unit) {
        Intrinsics.j(unit, "unit");
        DurationUnit durationUnit = DurationUnit.f147506b;
        long jC = DurationUnitKt__DurationUnitJvmKt.c(4611686018426999999L, durationUnit, unit);
        return ((-jC) > j10 || j10 > jC) ? j(RangesKt.p(DurationUnitKt__DurationUnitJvmKt.b(j10, unit, DurationUnit.f147508d), -4611686018427387903L, 4611686018427387903L)) : l(DurationUnitKt__DurationUnitJvmKt.c(j10, unit, durationUnit));
    }
    ...
    private static final long q(String str) {
        ...
        char cCharAt;
        int length = str.length();
        if (length > 0 && StringsKt.b0("+-", str.charAt(0), false, 2, null)) {
            i10 = 1;
        } else {
            i10 = 0;
        }
        ...
        if (StringsKt.W(str, "+", false, 2, null) && length > 1 && '0' <= (cCharAt = str.charAt(1)) && cCharAt < ':') {
            return Long.parseLong(StringsKt.E1(str, 1));
        }
