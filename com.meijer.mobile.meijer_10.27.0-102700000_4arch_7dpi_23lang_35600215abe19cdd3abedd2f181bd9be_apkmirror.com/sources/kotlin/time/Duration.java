...
public final class Duration implements Comparable<Duration> {
    ...
    private static final long f147500c = u(0);

    /* renamed from: d, reason: collision with root package name */
    private static final long f147501d = DurationKt.j(4611686018427387903L);

    /* renamed from: e, reason: collision with root package name */
    private static final long f147502e = DurationKt.j(-4611686018427387903L);
    ...
    public static final class Companion {
        ...
        public final long a() {
            return Duration.f147501d;
        }

        public final long b() {
            return Duration.f147502e;
        }

        public final long c() {
            return Duration.f147500c;
        }
    }
    ...
    public static final long D(long j10) {
        return Z(j10, DurationUnit.f147512h);
    }

    public static final long E(long j10) {
        return Z(j10, DurationUnit.f147511g);
    }

    public static final long G(long j10) {
        return Z(j10, DurationUnit.f147510f);
    }

    public static final long I(long j10) {
        return Z(j10, DurationUnit.f147509e);
    }

    public static final boolean S(long j10) {
        return j10 == f147501d || j10 == f147502e;
    }
    ...
    public static final long F(long j10) {
        ...
        return Z(j10, DurationUnit.f147508d);
    }
    ...
    private static final void m(long j10, StringBuilder sb2, int i10, int i11, int i12, String str, boolean z10) {
        ...
        if (i11 != 0) {
            sb2.append('.');
            String strB0 = StringsKt.B0(String.valueOf(i11), i12, '0');
            int i13 = -1;
            ...
            int i15 = i13 + 1;
            if (!z10 && i15 < 3) {
                sb2.append((CharSequence) strB0, 0, i15);
                Intrinsics.i(sb2, "append(...)");
            } else {
                sb2.append((CharSequence) strB0, 0, ((i13 + 3) / 3) * 3);
                Intrinsics.i(sb2, "append(...)");
            }
        }
        sb2.append(str);
