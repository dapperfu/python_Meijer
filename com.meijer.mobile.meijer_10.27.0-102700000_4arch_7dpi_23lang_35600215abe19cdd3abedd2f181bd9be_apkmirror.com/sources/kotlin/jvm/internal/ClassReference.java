...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    private static final Map<Class<? extends Function<?>>, Integer> f142813c;

    /* renamed from: d, reason: collision with root package name */
    private static final HashMap<String, String> f142814d;

    /* renamed from: e, reason: collision with root package name */
    private static final HashMap<String, String> f142815e;

    /* renamed from: f, reason: collision with root package name */
    private static final HashMap<String, String> f142816f;

    /* renamed from: g, reason: collision with root package name */
    private static final Map<String, String> f142817g;
    ...
    public static final class Companion {
        ...
        public final String a(Class<?> jClass) {
            ...
            if (!jClass.isArray()) {
                String str3 = (String) ClassReference.f142816f.get(jClass.getName());
                return str3 == null ? jClass.getCanonicalName() : str3;
            }
            Class<?> componentType = jClass.getComponentType();
            if (componentType.isPrimitive() && (str = (String) ClassReference.f142816f.get(componentType.getName())) != null) {
                str2 = str + "Array";
            }
        ...
        public final String b(Class<?> jClass) {
            ...
            if (!jClass.isLocalClass()) {
                if (!jClass.isArray()) {
                    String str3 = (String) ClassReference.f142817g.get(jClass.getName());
                    return str3 == null ? jClass.getSimpleName() : str3;
                }
                Class<?> componentType = jClass.getComponentType();
                if (componentType.isPrimitive() && (str = (String) ClassReference.f142817g.get(componentType.getName())) != null) {
                    str2 = str + "Array";
                }
            ...
            if (enclosingMethod != null) {
                ...
                String strK1 = StringsKt.k1(simpleName, enclosingMethod.getName() + '$', null, 2, null);
                if (strK1 != null) {
                    return strK1;
                }
            }
        ...
        public final boolean c(Object value, Class<?> jClass) {
            Intrinsics.j(jClass, "jClass");
            Map map = ClassReference.f142813c;
    ...
    static {
        ...
        for (String str : collectionValues) {
            ...
            Intrinsics.g(str);
            sb2.append(StringsKt.n1(str, '.', null, 2, null));
            sb2.append("CompanionObject");
            Pair pairA = TuplesKt.a(sb2.toString(), str + ".Companion");
            map3.put(pairA.c(), pairA.d());
        }
        for (Map.Entry<Class<? extends Function<?>>, Integer> entry : f142813c.entrySet()) {
        ...
        for (Map.Entry entry2 : map3.entrySet()) {
            ...
            Intrinsics.g(str2);
            linkedHashMap.put(key, StringsKt.n1(str2, '.', null, 2, null));
        }
        f142817g = linkedHashMap;
    }
