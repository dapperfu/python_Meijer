...
final /* data */ class BottomAppBarCutoutShape implements D1 {
    ...
    private final C17962o0 fabPlacement;
    ...
    private final void c(q1 q1Var, float f10, float f11, float f12, float f13, float f14) {
        ...
        float f17 = f10 + f16;
        float f18 = f11 - f16;
        Pair<Float, Float> pairL = C17943i.l(f15 - 1.0f, f14, f12);
    ...
    public BottomAppBarCutoutShape(D1 d12, C17962o0 c17962o0) {
        this.cutoutShape = d12;
        this.fabPlacement = c17962o0;
    }

    private final void b(q1 q1Var, t tVar, H1.d dVar) {
        float fI1 = dVar.I1(C17943i.f167932e);
        float f10 = 2 * fI1;
        ...
        C5340n1.a(q1Var, this.cutoutShape.a(jA, tVar, dVar));
        q1Var.k(U0.g.a(left, -fG));
        if (Intrinsics.e(this.cutoutShape, C16692i.f())) {
            c(q1Var, left, fI, fG, dVar.I1(C17943i.f167933f), 0.0f);
        }
    }

    @Override // V0.D1
    public AbstractC5337m1 a(long size, t layoutDirection, H1.d density) {
        q1 q1VarA = W.a();
        ...
        return new AbstractC5337m1.a(q1VarA2);
    }
}
