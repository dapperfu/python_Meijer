...
public final class C13791I {
    ...
    static final class a extends Lambda implements Function1<Float, Float> {
        ...
        final /* synthetic */ z1<Function1<Float, Float>> f130138f;
        ...
        public final Float b(float f10) {
            return this.f130138f.getValue().invoke(Float.valueOf(f10));
        }
    ...
    public static final InterfaceC13790H a(Function1<? super Float, Float> function1) {
        return new C13813l(function1);
    }

    public static final InterfaceC13790H b(Function1<? super Float, Float> function1, Composer composer, int i10) {
        if (ComposerKt.M()) {
        ...
        InterfaceC13790H interfaceC13790H = (InterfaceC13790H) objB;
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        return interfaceC13790H;
    }
}
