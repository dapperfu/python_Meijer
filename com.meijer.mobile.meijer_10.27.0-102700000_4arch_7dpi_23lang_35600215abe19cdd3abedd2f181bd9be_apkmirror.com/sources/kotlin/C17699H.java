...
public final class C17699H {

    /* renamed from: a, reason: collision with root package name */
    private static final Rect f165322a = new Rect(Float.POSITIVE_INFINITY, Float.POSITIVE_INFINITY, Float.NEGATIVE_INFINITY, Float.NEGATIVE_INFINITY);
    ...
    public /* synthetic */ class a {
        ...
        static {
            ...
            try {
                iArr[EnumC5682n.f49691b.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[EnumC5682n.f49692c.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[EnumC5682n.f49690a.ordinal()] = 3;
    ...
    public static final Rect g(List<? extends Pair<? extends InterfaceC17728n, Selection>> list, LayoutCoordinates layoutCoordinates) {
        LayoutCoordinates layoutCoordinatesB;
        int[] iArr;
        List<? extends Pair<? extends InterfaceC17728n, Selection>> list2 = list;
        if (list2.isEmpty()) {
            return f165322a;
        }
        Rect rect = f165322a;
        ...
        int i10 = 0;
        while (i10 < size) {
            Pair<? extends InterfaceC17728n, Selection> pair = list2.get(i10);
            InterfaceC17728n interfaceC17728nA = pair.a();
            Selection selectionB = pair.b();
            int offset = selectionB.getStart().getOffset();
            int offset2 = selectionB.getEnd().getOffset();
            if (offset != offset2 && (layoutCoordinatesB = interfaceC17728nA.B()) != null) {
                ...
                while (i11 < length) {
                    int i12 = i11;
                    Rect rectF = interfaceC17728nA.f(iArr[i12]);
    ...
    public static final long c(C17698G c17698g, long j10) {
        int i10;
        Selection selectionD = c17698g.D();
        if (selectionD == null) {
            return U0.f.INSTANCE.b();
        }
        EnumC5682n enumC5682nV = c17698g.v();
        if (enumC5682nV == null) {
            i10 = -1;
        } else {
            i10 = a.$EnumSwitchMapping$0[enumC5682nV.ordinal()];
        }
        if (i10 != -1) {
            if (i10 != 1) {
                if (i10 != 2) {
                ...
                return f(c17698g, j10, selectionD.getEnd());
            }
            return f(c17698g, j10, selectionD.getStart());
        }
        return U0.f.INSTANCE.b();
    }
    ...
    private static final long f(C17698G c17698g, long j10, Selection.AnchorInfo anchorInfo) {
        float fN;
        InterfaceC17728n interfaceC17728nP = c17698g.p(anchorInfo);
        if (interfaceC17728nP == null) {
            return U0.f.INSTANCE.b();
        }
        LayoutCoordinates layoutCoordinatesQ = c17698g.q();
        if (layoutCoordinatesQ == null) {
            return U0.f.INSTANCE.b();
        }
        LayoutCoordinates layoutCoordinatesB = interfaceC17728nP.B();
        if (layoutCoordinatesB == null) {
            return U0.f.INSTANCE.b();
        }
        int offset = anchorInfo.getOffset();
        if (offset > interfaceC17728nP.g()) {
            return U0.f.INSTANCE.b();
        }
        U0.f fVarS = c17698g.s();
        Intrinsics.g(fVarS);
        float fIntBitsToFloat = Float.intBitsToFloat((int) (layoutCoordinatesB.J(layoutCoordinatesQ, fVarS.getPackedValue()) >> 32));
        long jK = interfaceC17728nP.k(offset);
        if (y.h(jK)) {
            fN = interfaceC17728nP.d(offset);
        } else {
            float fD = interfaceC17728nP.d(y.n(jK));
            float fA = interfaceC17728nP.a(y.i(jK) - 1);
        ...
        if (interfaceC17728nP.h(offset) == -1.0f) {
            return U0.f.INSTANCE.b();
        }
