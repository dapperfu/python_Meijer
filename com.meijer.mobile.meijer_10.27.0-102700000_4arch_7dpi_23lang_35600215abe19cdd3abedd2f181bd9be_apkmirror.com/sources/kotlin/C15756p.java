...
public final class C15756p {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final L0.e saveableStateHolder;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final Function0<InterfaceC15758r> itemProvider;
    ...
    private final class a {
        ...
        static final class C2328a extends Lambda implements Function2<Composer, Integer, Unit> {

            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ C15756p f150927f;

            /* renamed from: g, reason: collision with root package name */
            final /* synthetic */ a f150928g;
            ...
            static final class C2329a extends Lambda implements Function1<F, E> {

                /* renamed from: f, reason: collision with root package name */
                final /* synthetic */ a f150929f;
                ...
                public static final class C2330a implements E {

                    /* renamed from: a, reason: collision with root package name */
                    final /* synthetic */ a f150930a;

                    public C2330a(a aVar) {
                        this.f150930a = aVar;
                    }

                    @Override // androidx.compose.runtime.E
                    public void dispose() {
                        this.f150930a._content = null;
                    }
                }
                ...
                public final E invoke(F f10) {
                    return new C2330a(this.f150929f);
                }
            }

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C2328a(C15756p c15756p, a aVar) {
                super(2);
                this.f150927f = c15756p;
                this.f150928g = aVar;
            }
            ...
            public final void a(Composer composer, int i10) {
                ...
                InterfaceC15758r interfaceC15758rInvoke = this.f150927f.d().invoke();
                int index = this.f150928g.getIndex();
                if ((index >= interfaceC15758rInvoke.a() || !Intrinsics.e(interfaceC15758rInvoke.d(index), this.f150928g.getKey())) && (index = interfaceC15758rInvoke.c(this.f150928g.getKey())) != -1) {
                    this.f150928g.index = index;
                }
                int i11 = index;
                if (i11 != -1) {
                    composer.startReplaceGroup(-660404355);
                    composer2 = composer;
                    C15757q.a(interfaceC15758rInvoke, C15739Z.a(this.f150927f.saveableStateHolder), i11, C15739Z.a(this.f150928g.getKey()), composer2, 0);
                    composer2.P();
                } else {
                    composer2 = composer;
                ...
                Object key = this.f150928g.getKey();
                boolean zD = composer2.D(this.f150928g);
                a aVar = this.f150928g;
                Object objB = composer2.B();
                if (zD || objB == Composer.INSTANCE.a()) {
                    objB = new C2329a(aVar);
                    composer2.t(objB);
                }
        ...
        private final Function2<Composer, Integer, Unit> c() {
            return ComposableLambdaKt.composableLambdaInstance(1403994769, true, new C2328a(C15756p.this, this));
        }
    ...
    public final Object c(Object key) {
        ...
        InterfaceC15758r interfaceC15758rInvoke = this.itemProvider.invoke();
        int iC = interfaceC15758rInvoke.c(key);
        if (iC != -1) {
            return interfaceC15758rInvoke.f(iC);
        }
        return null;
    }
    ...
    public final Function0<InterfaceC15758r> d() {
        return this.itemProvider;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public C15756p(L0.e eVar, Function0<? extends InterfaceC15758r> function0) {
