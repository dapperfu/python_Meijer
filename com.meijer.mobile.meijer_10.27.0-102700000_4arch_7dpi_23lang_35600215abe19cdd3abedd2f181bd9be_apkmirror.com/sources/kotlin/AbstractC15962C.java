...
import kotlin.InterfaceC15737X;
...
public abstract class AbstractC15962C implements InterfaceC13790H {

    /* renamed from: A, reason: collision with root package name and from kotlin metadata */
    private final C15743c awaitLayoutModifier;

    /* renamed from: B, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5730l0 remeasurement;
    ...
    private final C15720F pinnedPages;
    ...
    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private C15984t approachLayoutInfo;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5730l0 upDownDifference;

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    private final C15987w scrollPosition;
    ...
    private InterfaceC5730l0<C15984t> pagerLayoutInfoState;
    ...
    private final InterfaceC5726j0 programmaticScrollTargetPage;

    /* renamed from: v, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5726j0 settledPageState;
    ...
    static final class a extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f152906e = obj;
            this.f152908g |= Integer.MIN_VALUE;
            return AbstractC15962C.this.m(0, 0.0f, null, this);
        }
    }
    ...
    static final class b extends SuspendLambda implements Function2<InterfaceC13787E, Continuation<? super Unit>, Object> {
        ...
        /* renamed from: b, reason: collision with root package name */
        private /* synthetic */ Object f152910b;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ int f152912d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ float f152913e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ InterfaceC6326i<Float> f152914f;

        @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0004\u001a\u00020\u0003*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u0001H\n¢\u0006\u0004\b\u0004\u0010\u0005"}, d2 = {"Lf0/E;", "", "it", "", "a", "(Lf0/E;I)V"}, k = 3, mv = {1, 9, 0})
        /* renamed from: o0.C$b$a */
        static final class a extends Lambda implements Function2<InterfaceC13787E, Integer, Unit> {

            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ AbstractC15962C f152915f;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            a(AbstractC15962C abstractC15962C) {
                super(2);
                this.f152915f = abstractC15962C;
            }

            public final void a(InterfaceC13787E interfaceC13787E, int i10) {
                this.f152915f.o0(interfaceC13787E, i10);
            }

            @Override // kotlin.jvm.functions.Function2
            public /* bridge */ /* synthetic */ Unit invoke(InterfaceC13787E interfaceC13787E, Integer num) {
                a(interfaceC13787E, num.intValue());
                return Unit.f142422a;
            }
        }

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(int i10, float f10, InterfaceC6326i<Float> interfaceC6326i, Continuation<? super b> continuation) {
            super(2, continuation);
            this.f152912d = i10;
            this.f152913e = f10;
            this.f152914f = interfaceC6326i;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            b bVar = AbstractC15962C.this.new b(this.f152912d, this.f152913e, this.f152914f, continuation);
            bVar.f152910b = obj;
            return bVar;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                ResultKt.b(obj);
                InterfaceC15723I interfaceC15723IA = C15989y.a(AbstractC15962C.this, (InterfaceC13787E) this.f152910b);
                int i11 = this.f152912d;
                float f10 = this.f152913e;
                InterfaceC6326i<Float> interfaceC6326i = this.f152914f;
                a aVar = new a(AbstractC15962C.this);
                this.f152909a = 1;
                if (C15963D.d(interfaceC15723IA, i11, f10, interfaceC6326i, aVar, this) == objF) {
                    return objF;
                }
            }
            return Unit.f142422a;
    ...
    @SourceDebugExtension
    /* renamed from: o0.C$c */
    static final class c extends Lambda implements Function1<InterfaceC15732S, Unit> {
        c() {
            super(1);
        }
        ...
        public final void a(InterfaceC15732S interfaceC15732S) {
            ...
            AbstractC15962C abstractC15962C = AbstractC15962C.this;
            ...
            try {
                interfaceC15732S.a(abstractC15962C.getFirstVisiblePage());
    ...
    @Metadata(d1 = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0017\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, d2 = {"o0/C$d", "Landroidx/compose/ui/layout/i0;", "Landroidx/compose/ui/layout/h0;", "remeasurement", "", "m", "(Landroidx/compose/ui/layout/h0;)V", "foundation_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    /* renamed from: o0.C$d */
    public static final class d implements i0 {
        ...
        public void m(h0 remeasurement) {
            AbstractC15962C.this.j0(remeasurement);
        }
    }
    ...
    static final class e extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return AbstractC15962C.this.new e(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                AbstractC15962C abstractC15962C = AbstractC15962C.this;
                this.f152918a = 1;
                if (C13786D.e(abstractC15962C, null, this, 1, null) == objF) {
                    return objF;
                }
            }
            return Unit.f142422a;
    ...
    static final class f extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f152923d = obj;
            this.f152925f |= Integer.MIN_VALUE;
            return AbstractC15962C.b0(AbstractC15962C.this, null, null, this);
        }
    }
    ...
    @SourceDebugExtension
    /* renamed from: o0.C$g */
    static final class g extends SuspendLambda implements Function2<InterfaceC13787E, Continuation<? super Unit>, Object> {

        /* renamed from: a, reason: collision with root package name */
        int f152926a;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ float f152928c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ int f152929d;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return AbstractC15962C.this.new g(this.f152928c, this.f152929d, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        /* renamed from: d, reason: merged with bridge method [inline-methods] */
        public final Object invoke(InterfaceC13787E interfaceC13787E, Continuation<? super Unit> continuation) {
            return ((g) create(interfaceC13787E, continuation)).invokeSuspend(Unit.f142422a);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Object invokeSuspend(Object obj) {
            Object objF = IntrinsicsKt.f();
            int i10 = this.f152926a;
            if (i10 != 0) {
                if (i10 == 1) {
                    ResultKt.b(obj);
                } else {
                ...
                AbstractC15962C abstractC15962C = AbstractC15962C.this;
                this.f152926a = 1;
                if (abstractC15962C.q(this) == objF) {
                    return objF;
                }
            }
            float f10 = this.f152928c;
            double d10 = f10;
            boolean z10 = false;
            ...
            if (!z10) {
                C14589e.a("pageOffsetFraction " + f10 + " is not within the range -0.5 to 0.5");
            }
            AbstractC15962C.this.m0(AbstractC15962C.this.s(this.f152929d), this.f152928c, true);
            return Unit.f142422a;
        }
    }
    ...
    static final class h extends Lambda implements Function1<Float, Float> {
        ...
        public final Float b(float f10) {
            return Float.valueOf(AbstractC15962C.this.Y(f10));
        }
    ...
    static final class i extends Lambda implements Function0<Integer> {
        ...
        public final Integer invoke() {
            return Integer.valueOf(AbstractC15962C.this.b() ? AbstractC15962C.this.S() : AbstractC15962C.this.v());
        }
    }
    ...
    static final class j extends Lambda implements Function0<Integer> {
        ...
        /* renamed from: c, reason: merged with bridge method [inline-methods] */
        public final Integer invoke() {
            return Integer.valueOf(AbstractC15962C.this.s(!AbstractC15962C.this.b() ? AbstractC15962C.this.v() : AbstractC15962C.this.P() != -1 ? AbstractC15962C.this.P() : Math.abs(AbstractC15962C.this.w()) >= Math.abs(AbstractC15962C.this.N()) ? AbstractC15962C.this.B() ? AbstractC15962C.this.getFirstVisiblePage() + 1 : AbstractC15962C.this.getFirstVisiblePage() : AbstractC15962C.this.v()));
        }
    }

    public AbstractC15962C() {
        this(0, 0.0f, null, 7, null);
    }

    public abstract int H();

    public AbstractC15962C(int i10, float f10, InterfaceC15737X interfaceC15737X) {
        double d10 = f10;
        boolean z10 = false;
        if (-0.5d <= d10 && d10 <= 0.5d) {
            z10 = true;
        ...
        if (!z10) {
            C14589e.a("currentPageOffsetFraction " + f10 + " is not within the range -0.5 to 0.5");
        }
        this.upDownDifference = t1.e(U0.f.d(U0.f.INSTANCE.c()), null, 2, null);
        C15987w c15987w = new C15987w(i10, f10, this);
        this.scrollPosition = c15987w;
        this.firstVisiblePage = i10;
        this.maxScrollOffset = Long.MAX_VALUE;
        this.scrollableState = C13791I.a(new h());
        this.prefetchingEnabled = true;
        this.indexToPrefetch = -1;
        this.pagerLayoutInfoState = o1.i(C15963D.j(), o1.k());
        this.density = C15963D.f152935c;
        this.internalInteractionSource = h0.k.a();
        this.programmaticScrollTargetPage = C5702c1.a(-1);
        this.settledPageState = C5702c1.a(i10);
        this.settledPage = o1.d(o1.r(), new i());
        this.targetPage = o1.d(o1.r(), new j());
        this.prefetchState = new androidx.compose.foundation.lazy.layout.d(interfaceC15737X, new c());
        ...
        this.pinnedPages = new C15720F();
        c15987w.getNearestRangeState();
    ...
    private final void X(float delta, InterfaceC15978n info) {
        d.b bVar;
        d.b bVar2;
        d.b bVar3;
        if (this.prefetchingEnabled && !info.h().isEmpty()) {
            boolean z10 = delta > 0.0f;
            int index = z10 ? ((InterfaceC15970f) CollectionsKt.D0(info.h())).getIndex() + info.getBeyondViewportPageCount() + 1 : (((InterfaceC15970f) CollectionsKt.s0(info.h())).getIndex() - info.getBeyondViewportPageCount()) - 1;
            if (index < 0 || index >= H()) {
                return;
            }
            ...
            if (z10) {
                if ((((InterfaceC15970f) CollectionsKt.D0(info.h())).getOffset() + (info.getPageSize() + info.getPageSpacing())) - info.getViewportEndOffset() >= delta || (bVar2 = this.currentPrefetchHandle) == null) {
                    return;
                }
                bVar2.a();
                return;
            }
            if (info.getViewportStartOffset() - ((InterfaceC15970f) CollectionsKt.s0(info.h())).getOffset() >= (-delta) || (bVar = this.currentPrefetchHandle) == null) {
                return;
            }
            bVar.a();
        }
    ...
    public static /* synthetic */ void a0(AbstractC15962C abstractC15962C, int i10, float f10, int i11, Object obj) {
        if (obj != null) {
    ...
    */
    static /* synthetic */ java.lang.Object b0(kotlin.AbstractC15962C r5, d0.EnumC13431E r6, kotlin.jvm.functions.Function2<? super kotlin.InterfaceC13787E, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            boolean r0 = r8 instanceof kotlin.AbstractC15962C.f
            if (r0 == 0) goto L13
            r0 = r8
            o0.C$f r0 = (kotlin.AbstractC15962C.f) r0
            int r1 = r0.f152925f
        ...
        L13:
            ...
            r0.<init>(r8)
        L18:
            java.lang.Object r8 = r0.f152923d
            ...
            if (r2 == r4) goto L38
            if (r2 != r3) goto L30
            java.lang.Object r5 = r0.f152920a
            o0.C r5 = (kotlin.AbstractC15962C) r5
        ...
        L30:
            ...
            throw r5
        L38:
            java.lang.Object r5 = r0.f152922c
            r7 = r5
            kotlin.jvm.functions.Function2 r7 = (kotlin.jvm.functions.Function2) r7
            java.lang.Object r5 = r0.f152921b
            r6 = r5
        ...
        L7b:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.AbstractC15962C.b0(o0.C, d0.E, kotlin.jvm.functions.Function2, kotlin.coroutines.Continuation):java.lang.Object");
    }

    public static /* synthetic */ Object d0(AbstractC15962C abstractC15962C, int i10, float f10, Continuation continuation, int i11, Object obj) {
        if (obj != null) {
        ...
        return abstractC15962C.c0(i10, f10, continuation);
    }
    ...
    private final void i0(int i10) {
        this.programmaticScrollTargetPage.j(i10);
    }
    ...
    private final void k0(int i10) {
        this.settledPageState.j(i10);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ Object n(AbstractC15962C abstractC15962C, int i10, float f10, InterfaceC6326i interfaceC6326i, Continuation continuation, int i11, Object obj) {
        if (obj != null) {
        ...
        return abstractC15962C.m(i10, f10, interfaceC6326i, continuation);
    }

    private final void n0(C15984t result) {
        g.Companion companion = androidx.compose.runtime.snapshots.g.INSTANCE;
        androidx.compose.runtime.snapshots.g gVarD = companion.d();
        Function1<Object, Unit> function1G = gVarD != null ? gVarD.g() : null;
        androidx.compose.runtime.snapshots.g gVarE = companion.e(gVarD);
    ...
    public static /* synthetic */ void p(AbstractC15962C abstractC15962C, C15984t c15984t, boolean z10, boolean z11, int i10, Object obj) {
        if (obj != null) {
        ...
        abstractC15962C.o(c15984t, z10, z11);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final Object q(Continuation<? super Unit> continuation) {
        Object objC = this.awaitLayoutModifier.c(continuation);
        return objC == IntrinsicsKt.f() ? objC : Unit.f142422a;
    }

    private final void r(InterfaceC15978n info) {
        if (this.indexToPrefetch == -1 || info.h().isEmpty()) {
            return;
        }
        if (this.indexToPrefetch != (this.wasPrefetchingForward ? ((InterfaceC15970f) CollectionsKt.D0(info.h())).getIndex() + info.getBeyondViewportPageCount() + 1 : (((InterfaceC15970f) CollectionsKt.s0(info.h())).getIndex() - info.getBeyondViewportPageCount()) - 1)) {
            this.indexToPrefetch = -1;
    ...
    public final InterfaceC15978n C() {
    ...
    public final InterfaceC5730l0<Unit> E() {
    ...
    public final C15720F getPinnedPages() {
        return this.pinnedPages;
    }

    public final InterfaceC5730l0<Unit> M() {
        return this.placementScopeInvalidator;
    }

    public final float N() {
        return Math.min(this.density.I1(C15963D.i()), I() / 2.0f) / I();
    }
    ...
    public final int W(C15981q itemProvider, int currentPage) {
    ...
    public final Object c0(int i10, float f10, Continuation<? super Unit> continuation) {
        Object objC = InterfaceC13790H.c(this, null, new g(f10, i10, null), continuation, 1, null);
        return objC == IntrinsicsKt.f() ? objC : Unit.f142422a;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:40:0x00c2, code lost:
        ...
        if (kotlin.InterfaceC13790H.c(r1, null, r3, r4, 1, null) == r0) goto L41;
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object m(int r12, float r13, kotlin.InterfaceC6326i<java.lang.Float> r14, kotlin.coroutines.Continuation<? super kotlin.Unit> r15) {
        /*
            r11 = this;
            boolean r0 = r15 instanceof kotlin.AbstractC15962C.a
            if (r0 == 0) goto L14
            r0 = r15
            o0.C$a r0 = (kotlin.AbstractC15962C.a) r0
            int r1 = r0.f152908g
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r3 = r1 & r2
            if (r3 == 0) goto L14
        ...
        L14:
            ...
            goto L12
        L1a:
            java.lang.Object r15 = r4.f152906e
        ...
        L2f:
            ...
            throw r12
        L37:
            float r13 = r4.f152905d
            int r12 = r4.f152904c
            java.lang.Object r14 = r4.f152903b
            c0.i r14 = (kotlin.InterfaceC6326i) r14
            java.lang.Object r1 = r4.f152902a
            o0.C r1 = (kotlin.AbstractC15962C) r1
            kotlin.ResultKt.b(r15)
        L46:
            r9 = r14
            goto L76
        ...
        La1:
            ...
            r5 = 1
            r6 = 0
            java.lang.Object r12 = kotlin.InterfaceC13790H.c(r1, r2, r3, r4, r5, r6)
            if (r12 != r0) goto Lc5
        Lc4:
            return r0
        Lc5:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.AbstractC15962C.m(int, float, c0.i, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public final void o(C15984t result, boolean isLookingAhead, boolean visibleItemsStayedTheSame) {
        ...
        e0(result.m());
        C15969e c15969eU = result.getFirstVisiblePage();
        if (c15969eU != null) {
            this.firstVisiblePage = c15969eU.getIndex();
        }
        this.firstVisiblePageOffset = result.getFirstVisiblePageScrollOffset();
        n0(result);
        this.maxScrollOffset = C15963D.g(result, H());
        this.minScrollOffset = C15963D.h(result, H());
    }
    ...
    private final boolean U(float scrollDelta) {
        if (C().getOrientation() == EnumC13827z.f130585a) {
    ...
    public final float Y(float delta) {
        ...
        if (Math.abs(j11) != 0) {
            InterfaceC5730l0<Boolean> interfaceC5730l0 = this.isLastScrollForwardState;
            if (f11 > 0.0f) {
                z11 = true;
            } else {
                z11 = false;
            }
            interfaceC5730l0.setValue(Boolean.valueOf(z11));
            InterfaceC5730l0<Boolean> interfaceC5730l02 = this.isLastScrollBackwardState;
            if (f11 < 0.0f) {
                z12 = true;
            }
            interfaceC5730l02.setValue(Boolean.valueOf(z12));
        }
        int i10 = (int) j11;
        int i11 = -i10;
        C15984t c15984tL2 = this.pagerLayoutInfoState.getValue().l(i11);
        if (c15984tL2 != null && (c15984t = this.approachLayoutInfo) != null) {
            if (c15984t != null) {
                c15984tL = c15984t.l(i11);
            } else {
                c15984tL = null;
            }
            if (c15984tL != null) {
                this.approachLayoutInfo = c15984tL;
            } else {
                c15984tL2 = null;
            }
        }
        if (c15984tL2 != null) {
            o(c15984tL2, this.hasLookaheadOccurred, true);
    ...
    public final void Z(int page, float pageOffsetFraction) {
        if (b()) {
            C16648k.d(this.pagerLayoutInfoState.getValue().getCoroutineScope(), null, null, new e(null), 3, null);
        }
    ...
    public Object a(EnumC13431E enumC13431E, Function2<? super InterfaceC13787E, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        return b0(this, enumC13431E, function2, continuation);
    }

    public final void o0(InterfaceC13787E interfaceC13787E, int i10) {
        i0(s(i10));
    }

    public /* synthetic */ AbstractC15962C(int i10, float f10, InterfaceC15737X interfaceC15737X, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this((i11 & 1) != 0 ? 0 : i10, (i11 & 2) != 0 ? 0.0f : f10, (i11 & 4) != 0 ? null : interfaceC15737X);
    }

    public AbstractC15962C(int i10, float f10) {
        this(i10, f10, null);
    }
}
