...
public final class C17343k implements CoroutineContext {
    ...
    public CoroutineContext F0(CoroutineContext.Key<?> key) {
        return this.f163593a.F0(key);
    }

    @Override // kotlin.coroutines.CoroutineContext
    public <R> R b(R initial, Function2<? super R, ? super CoroutineContext.Element, ? extends R> operation) {
        return (R) this.f163593a.b(initial, operation);
    }

    @Override // kotlin.coroutines.CoroutineContext
    public <E extends CoroutineContext.Element> E g(CoroutineContext.Key<E> key) {
        return (E) this.f163593a.g(key);
    }

    @Override // kotlin.coroutines.CoroutineContext
    public CoroutineContext m0(CoroutineContext context) {
        return this.f163593a.m0(context);
    }

    public C17343k(Throwable th2, CoroutineContext coroutineContext) {
        this.f163593a = coroutineContext;
        this.e = th2;
    }
}
