...
public final class C6332o extends AbstractC6334q {
    ...
    public C6332o(float f10, float f11, float f12) {
        super(null);
        this.v1 = f10;
        this.v2 = f11;
        this.v3 = f12;
    ...
    public boolean equals(Object other) {
        if (!(other instanceof C6332o)) {
            return false;
        }
        C6332o c6332o = (C6332o) other;
        return c6332o.v1 == this.v1 && c6332o.v2 == this.v2 && c6332o.v3 == this.v3;
    }

    @Override // kotlin.AbstractC6334q
    /* renamed from: f, reason: merged with bridge method [inline-methods] */
    public C6332o c() {
        return new C6332o(0.0f, 0.0f, 0.0f);
    }
