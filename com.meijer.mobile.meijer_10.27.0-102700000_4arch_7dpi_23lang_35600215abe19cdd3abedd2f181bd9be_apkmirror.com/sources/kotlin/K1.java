...
final class K1 implements MeasurePolicy {
    ...
    static final class a extends Lambda implements Function2<r, Integer, Integer> {
        ...
        public static final a f167107f = new a();
    ...
    static final class b extends Lambda implements Function2<r, Integer, Integer> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final b f167108f = new b();
    ...
    static final class c extends Lambda implements Function1<f0.a, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ f0 f167109f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ int f167110g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f167111h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ int f167112i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ int f167113j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ f0 f167114k;

        /* renamed from: l, reason: collision with root package name */
        final /* synthetic */ f0 f167115l;

        /* renamed from: m, reason: collision with root package name */
        final /* synthetic */ f0 f167116m;

        /* renamed from: n, reason: collision with root package name */
        final /* synthetic */ f0 f167117n;

        /* renamed from: o, reason: collision with root package name */
        final /* synthetic */ K1 f167118o;

        /* renamed from: p, reason: collision with root package name */
        final /* synthetic */ int f167119p;

        /* renamed from: q, reason: collision with root package name */
        final /* synthetic */ int f167120q;

        /* renamed from: r, reason: collision with root package name */
        final /* synthetic */ K f167121r;
        ...
        c(f0 f0Var, int i10, int i11, int i12, int i13, f0 f0Var2, f0 f0Var3, f0 f0Var4, f0 f0Var5, K1 k12, int i14, int i15, K k10) {
            ...
            this.f167112i = i12;
            this.f167113j = i13;
            this.f167114k = f0Var2;
            this.f167115l = f0Var3;
            this.f167116m = f0Var4;
            this.f167117n = f0Var5;
            this.f167118o = k12;
            this.f167119p = i14;
            this.f167120q = i15;
            this.f167121r = k10;
        ...
        public final void a(f0.a aVar) {
            if (this.f167109f == null) {
                J1.k(aVar, this.f167112i, this.f167113j, this.f167114k, this.f167115l, this.f167116m, this.f167117n, this.f167118o.singleLine, this.f167121r.getDensity(), this.f167118o.paddingValues);
            } else {
                J1.j(aVar, this.f167112i, this.f167113j, this.f167114k, this.f167109f, this.f167115l, this.f167116m, this.f167117n, this.f167118o.singleLine, RangesKt.f(this.f167110g - this.f167111h, 0), this.f167119p + this.f167120q, this.f167118o.animationProgress, this.f167121r.getDensity());
            }
        }
    ...
    static final class d extends Lambda implements Function2<r, Integer, Integer> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final d f167122f = new d();
    ...
    static final class e extends Lambda implements Function2<r, Integer, Integer> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final e f167123f = new e();
    ...
    private final int f(InterfaceC5791s interfaceC5791s, List<? extends r> list, int i10, Function2<? super r, ? super Integer, Integer> function2) {
        ...
        for (int i15 = 0; i15 < size4; i15++) {
            ...
            if (Intrinsics.e(I1.e(rVar8), "TextField")) {
                ...
                r rVar10 = rVar;
                return J1.g(iIntValue4, iIntValue3 > 0, iIntValue3, iIntValue, iIntValue2, rVar10 != null ? function2.invoke(rVar10, Integer.valueOf(iL)).intValue() : 0, H1.c.b(0, 0, 0, 0, 15, null), interfaceC5791s.getDensity(), this.paddingValues);
            }
        }
