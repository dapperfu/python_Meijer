...
public final class C6278b {
    ...
    public C6278b(Context applicationContext) {
        Intrinsics.j(applicationContext, "applicationContext");
        this.applicationContext = applicationContext;
    }

    public final Object b(String str, boolean z10, Continuation<? super Result<? extends EnumC6277a>> continuation) {
        Object objB;
        try {
            Result.Companion companion = Result.INSTANCE;
            uw.a.INSTANCE.x("ShopAndScan").k(C6278b.class.getSimpleName() + ".kt:1", new Object[0]);
            boolean z11 = Z1.b.a(this.applicationContext, str) == 0;
            objB = Result.b((z11 || z10) ? (z11 || !z10) ? EnumC6277a.f60612c : EnumC6277a.f60611b : EnumC6277a.f60610a);
        } catch (Exception e10) {
        ...
        if (Result.h(objB)) {
            uw.a.INSTANCE.x("ShopAndScan").a(StringsKt.n("\n                    Checking Permission...\n                        Permission: " + str + "\n                        Permission Action: " + ((EnumC6277a) objB) + "\n                "), new Object[0]);
        }
        Throwable thE = Result.e(objB);
        if (thE != null) {
            uw.a.INSTANCE.x("ShopAndScan").e(thE);
        }
        return objB;
    }
}
