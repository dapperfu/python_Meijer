...
public final class C14326c {
    ...
    public static final class a {
        ...
        public static final a f134176a = new a("Lsq2", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final a f134177b = new a("Impulse", 1);

        /* renamed from: c, reason: collision with root package name */
        private static final /* synthetic */ a[] f134178c;

        /* renamed from: d, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f134179d;

        static {
            a[] aVarArrA = a();
            f134178c = aVarArrA;
            f134179d = EnumEntriesKt.a(aVarArrA);
        }

        private static final /* synthetic */ a[] a() {
            return new a[]{f134176a, f134177b};
        }
    ...
    public C14326c(boolean z10, a aVar) {
        this.isDataDifferential = z10;
        this.strategy = aVar;
        if (z10 && aVar.equals(a.f134176a)) {
    ...
    public final float d(float maximumVelocity) {
        if (!(maximumVelocity > 0.0f)) {
            C14832a.b("maximumVelocity should be a positive value. You specified=" + maximumVelocity);
        }
        float fC = c();
    ...
    public /* synthetic */ class b {
        ...
        static {
            ...
            try {
                iArr[a.f134177b.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[a.f134176a.ordinal()] = 2;
    ...
    private final float b(float[] dataPoints, float[] time, int sampleCount) {
        try {
            return C14328e.i(time, dataPoints, sampleCount, 2, this.reusableVelocityCoefficients)[1];
    ...
    public final void a(long timeMillis, float dataPoint) {
        ...
        this.index = i10;
        C14328e.j(this.samples, i10, timeMillis, dataPoint);
    }
    ...
    public final float c() {
        ...
        while (true) {
            ...
            DataPointAtTime dataPointAtTime4 = (this.strategy == a.f134176a || this.isDataDifferential) ? dataPointAtTime3 : dataPointAtTime;
        ...
        if (i12 == 1) {
            f10 = C14328e.f(fArr, fArr2, i11, this.isDataDifferential);
        } else {
            if (i12 != 2) {
                throw new NoWhenBranchMatchedException();
            }
    ...
    public /* synthetic */ C14326c(boolean z10, a aVar, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this((i10 & 1) != 0 ? false : z10, (i10 & 2) != 0 ? a.f134176a : aVar);
    }

    public C14326c(boolean z10) {
        this(z10, a.f134177b);
    }
}
