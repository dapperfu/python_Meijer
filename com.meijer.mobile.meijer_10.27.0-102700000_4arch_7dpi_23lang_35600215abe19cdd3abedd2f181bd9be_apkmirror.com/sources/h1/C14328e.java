...
public final class C14328e {
    ...
    private static boolean f134185a = true;

    /* renamed from: b, reason: collision with root package name */
    private static boolean f134186b;
    ...
    public static final void c(C14327d c14327d, PointerInputChange pointerInputChange) {
        if (f134185a) {
            e(c14327d, pointerInputChange);
        } else {
            d(c14327d, pointerInputChange);
        }
    }
    ...
    public static final float[] i(float[] fArr, float[] fArr2, int i10, int i11, float[] fArr3) {
        int i12 = i11;
        if (i12 < 1) {
            C14832a.a("The degree must be at positive integer");
        }
        if (i10 == 0) {
            C14832a.a("At least one point must be provided");
        }
        if (i12 >= i10) {
            i12 = i10 - 1;
        }
    ...
    private static final void d(C14327d c14327d, PointerInputChange pointerInputChange) {
        if (r.b(pointerInputChange)) {
            c14327d.f(pointerInputChange.getPosition());
            c14327d.e();
        }
        ...
        while (i10 < size) {
            ...
            c14327d.f(f.q(c14327d.getCurrentPointerPositionAccumulator(), jP));
            c14327d.a(historicalChange.getUptimeMillis(), c14327d.getCurrentPointerPositionAccumulator());
            i10++;
            previousPosition = position;
        }
        c14327d.f(f.q(c14327d.getCurrentPointerPositionAccumulator(), f.p(pointerInputChange.getPosition(), previousPosition)));
        c14327d.a(pointerInputChange.getUptimeMillis(), c14327d.getCurrentPointerPositionAccumulator());
    }

    private static final void e(C14327d c14327d, PointerInputChange pointerInputChange) {
        if (r.b(pointerInputChange)) {
            c14327d.e();
        }
        if (!r.d(pointerInputChange)) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                HistoricalChange historicalChange = listE.get(i10);
                c14327d.a(historicalChange.getUptimeMillis(), historicalChange.getOriginalEventPosition());
            }
            c14327d.a(pointerInputChange.getUptimeMillis(), pointerInputChange.getOriginalEventPosition());
        }
        if (r.d(pointerInputChange) && pointerInputChange.getUptimeMillis() - c14327d.getLastMoveEventTimeStamp() > 40) {
            c14327d.e();
        }
        c14327d.g(pointerInputChange.getUptimeMillis());
    }
}
