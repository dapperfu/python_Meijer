...
public final class C14327d {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final C14326c.a strategy;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final C14326c xVelocityTracker;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private final C14326c yVelocityTracker;
    ...
    public C14327d() {
        C14326c.a aVar;
        if (C14328e.h()) {
            aVar = C14326c.a.f134177b;
        } else {
            aVar = C14326c.a.f134176a;
        }
        this.strategy = aVar;
        this.xVelocityTracker = new C14326c(false, aVar, 1, null);
        this.yVelocityTracker = new C14326c(false, aVar, 1, null);
    ...
    public final long b(long maximumVelocity) {
        ...
        if (!z10) {
            C14832a.b("maximumVelocity should be a positive value. You specified=" + ((Object) y.n(maximumVelocity)));
        }
