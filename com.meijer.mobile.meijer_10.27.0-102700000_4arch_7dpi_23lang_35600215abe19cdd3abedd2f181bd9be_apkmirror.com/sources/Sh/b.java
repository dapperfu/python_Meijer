...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\u001a\u0011\u0010\u0002\u001a\u00020\u0001*\u00020\u0000¢\u0006\u0004\b\u0002\u0010\u0003\u001a\u0011\u0010\u0004\u001a\u00020\u0000*\u00020\u0001¢\u0006\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"LDh/a;", "LSh/a;", "b", "(LDh/a;)LSh/a;", "a", "(LSh/a;)LDh/a;", "ux_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class b {
    public static final AccountAddress a(AddressDecorator addressDecorator) {
        ...
        String strE3 = addressDecorator.getPhoneNumber().c().e();
        String strE4 = addressDecorator.getStreetAddress().c().e();
        String information = addressDecorator.getApartment().getInformation();
        if (information.length() == 0) {
            information = null;
        }
        return new AccountAddress(id2, 0L, null, strE4, information, addressDecorator.getCity().c().e(), addressDecorator.getState().c().e(), addressDecorator.getZipCode().c().e(), null, null, 0L, strE, strE2, null, strE3, addressDecorator.getIsPrimaryAddress(), null, null, null, null, 993030, null);
    }
    ...
    public static final AddressDecorator b(AccountAddress accountAddress) {
        ...
        a.PhoneNumber phoneNumber2 = new a.PhoneNumber(new Validation(phoneNumber, null, 2, null));
        ...
        sb3.append(zipCode3);
        return new AddressDecorator(id2, firstName2, lastName2, phoneNumber2, streetAddress, apartment, city2, state2, zipCode2, isPrimary, string, sb3.toString(), false, null, 12288, null);
    }
}
