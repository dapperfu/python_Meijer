...
@Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a\u0019\u0010\u0003\u001a\u00020\u0001*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u0001¢\u0006\u0004\b\u0003\u0010\u0004\u001a#\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u00000\b2\u0006\u0010\u0006\u001a\u00020\u00052\u0006\u0010\u0007\u001a\u00020\u0001¢\u0006\u0004\b\t\u0010\n\u001a\u0017\u0010\f\u001a\b\u0012\u0004\u0012\u00020\u00000\b*\u00020\u000b¢\u0006\u0004\b\f\u0010\r¨\u0006\u000e"}, d2 = {"LSh/c;", "LDh/a;", "previousAccountAddress", "b", "(LSh/c;LDh/a;)LDh/a;", "Lresponses/PostalAddress;", "postalAddress", "accountAddress", "", "a", "(Lresponses/PostalAddress;LDh/a;)Ljava/util/List;", "LDh/d$a;", "c", "(LDh/d$a;)Ljava/util/List;", "ux_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class d {
    public static final List<AddressSuggestionDecorator> a(PostalAddress postalAddress, AccountAddress accountAddress) {
        ...
        String str = postalAddress.getCity() + ", " + postalAddress.getMainDivision() + ", " + ((postalCode == null || (strQ = StringsKt.Q(postalCode, " ", "", false, 4, null)) == null) ? null : C16981a.CANADIAN_POSTAL_CODE_RAW_REGEX.matcher(strQ).matches() ? StringsKt.J1(strQ, 6) : StringsKt.J1(strQ, 5));
        ...
        AddressSuggestionDecorator addressSuggestionDecorator = new AddressSuggestionDecorator(companion.d(h.f10807v4, new Object[0]), MapsKt.n(TuplesKt.a(streetAddress1, Boolean.valueOf(!StringsKt.H(streetAddress1, addressLine1, true))), TuplesKt.a(addressLine2, Boolean.valueOf(!StringsKt.H(addressLine2, addressLine22, true))), TuplesKt.a(str, Boolean.valueOf(!StringsKt.H(str, str2, true)))), true, EnumC17262d.f162975f);
        AbstractC5607a abstractC5607aD = companion.d(h.f10706h1, new Object[0]);
        Boolean bool = Boolean.FALSE;
        return CollectionsKt.p(addressSuggestionDecorator, new AddressSuggestionDecorator(abstractC5607aD, MapsKt.n(TuplesKt.a(addressLine1, bool), TuplesKt.a(addressLine22, bool), TuplesKt.a(str2, bool)), false, null, 8, null));
    }
    ...
    public static final AccountAddress b(AddressSuggestionDecorator addressSuggestionDecorator, AccountAddress previousAccountAddress) {
        ...
        Intrinsics.g(objL0);
        List listA1 = StringsKt.a1((CharSequence) objL0, new String[]{", "}, false, 0, 6, null);
        return AccountAddress.b(previousAccountAddress, 0L, 0L, null, (String) CollectionsKt.l0(addressSuggestionDecorator.c().keySet(), 0), (String) CollectionsKt.l0(addressSuggestionDecorator.c().keySet(), 1), (String) listA1.get(0), (String) listA1.get(1), (String) listA1.get(2), null, addressSuggestionDecorator.getAddressValidationType(), 0L, null, null, null, null, false, null, null, null, null, 1047815, null);
    }

    public static final List<AddressSuggestionDecorator> c(AbstractC3371d.Select select) {
        ...
        AbstractC5607a.Companion companion = AbstractC5607a.INSTANCE;
        AddressSuggestionDecorator addressSuggestionDecorator = new AddressSuggestionDecorator(companion.d(h.f10807v4, new Object[0]), MapsKt.n(TuplesKt.a(addressLine1, Boolean.valueOf(!StringsKt.H(addressLine1, addressLine12, true))), TuplesKt.a(addressLine2, Boolean.valueOf(!StringsKt.H(addressLine2, addressLine22, true))), TuplesKt.a(str, Boolean.valueOf(true ^ StringsKt.H(str, str2, true)))), true, null, 8, null);
        AbstractC5607a abstractC5607aD = companion.d(h.f10706h1, new Object[0]);
        Boolean bool = Boolean.FALSE;
        return CollectionsKt.p(addressSuggestionDecorator, new AddressSuggestionDecorator(abstractC5607aD, MapsKt.n(TuplesKt.a(addressLine12, bool), TuplesKt.a(addressLine22, bool), TuplesKt.a(str2, bool)), false, null, 8, null));
    }
}
