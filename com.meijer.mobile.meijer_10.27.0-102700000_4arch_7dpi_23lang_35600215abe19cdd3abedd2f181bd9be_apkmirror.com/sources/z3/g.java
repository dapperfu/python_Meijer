...
final class g implements InterfaceC18378a {

    /* renamed from: a, reason: collision with root package name */
    public final t f171544a;
    ...
    private static InterfaceC18378a c(D d10) {
        d10.X(4);
        int iU = d10.u();
        int iU2 = d10.u();
        d10.X(4);
    ...
    public static InterfaceC18378a d(int i10, D d10) {
        if (i10 == 2) {
            return c(d10);
        }
        if (i10 == 1) {
    ...
    private static InterfaceC18378a e(D d10) {
        int iZ;
        int iZ2 = d10.z();
        String strB = b(iZ2);
        if (strB == null) {
