...
public final class a extends AbstractCoroutineContextElement implements InterfaceC16619L {
    ...
    private a() {
        super(InterfaceC16619L.INSTANCE);
    }
    ...
    public final boolean L0(Throwable exception) {
        synchronized (lock) {
            if (!enabled) {
                return false;
            }
            if (f4970b.N0(exception)) {
                return true;
            }
    ...
    public boolean equals(Object other) {
        return (other instanceof a) || (other instanceof b);
    }
    ...
    public void l0(CoroutineContext context, Throwable exception) {
        if (!L0(exception)) {
            ...
            throw ExceptionSuccessfullyProcessed.f147551a;
        }
    }
}
