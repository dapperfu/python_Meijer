...
public final class C13585a<I> {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private AbstractC14147c<I> launcher;

    public final void a(I input, androidx.core.app.d options) {
        Unit unit;
        AbstractC14147c<I> abstractC14147c = this.launcher;
        if (abstractC14147c != null) {
            abstractC14147c.b(input, options);
            unit = Unit.f142422a;
        } else {
            unit = null;
        }
    ...
    public final void b(AbstractC14147c<I> abstractC14147c) {
        this.launcher = abstractC14147c;
    }
