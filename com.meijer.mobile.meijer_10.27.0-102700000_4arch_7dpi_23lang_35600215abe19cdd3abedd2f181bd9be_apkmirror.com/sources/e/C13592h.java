...
public final class C13592h {

    /* renamed from: a, reason: collision with root package name */
    public static final C13592h f127666a = new C13592h();

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private static final F0<J> LocalOnBackPressedDispatcherOwner = r.d(null, a.f127668f, 1, null);
    ...
    static final class a extends Lambda implements Function0<J> {
        ...
        public static final a f127668f = new a();
    ...
    public final J a(Composer composer, int i10) {
        ...
        if (jA == null) {
            ...
            jA = C5612N.a((View) composer.o(AndroidCompositionLocals_androidKt.k()));
            composer.P();
        } else {
