...
@Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0017\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J%\u0010\f\u001a\b\u0012\u0004\u0012\u00020\u000b0\n2\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\bH\u0016¢\u0006\u0004\b\f\u0010\rR\u0014\u0010\u0003\u001a\u00020\u00028\u0012X\u0092\u0004¢\u0006\u0006\n\u0004\b\f\u0010\u000e¨\u0006\u000f"}, d2 = {"Lga/m;", "", "", "limit", "<init>", "(I)V", "Landroid/location/Location;", "currentLocation", "Lha/b;", "geofenceResponse", "", "LX9/a;", "a", "(Landroid/location/Location;Lha/b;)Ljava/util/List;", "I", "mobile-engage_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public class m {
    ...
    public static final class a<T> implements Comparator {
        ...
        final /* synthetic */ Location f133253a;

        public a(Location location) {
            this.f133253a = location;
        }
        ...
        public final int compare(T t10, T t11) {
            ...
            Double dValueOf = Double.valueOf(location.distanceTo(this.f133253a) - geofence.getRadius());
            Geofence geofence2 = (Geofence) t11;
            Location location2 = new Location("gps");
            location2.setLongitude(geofence2.getLon());
            location2.setLatitude(geofence2.getLat());
            return ComparisonsKt.d(dValueOf, Double.valueOf(location2.distanceTo(this.f133253a) - geofence2.getRadius()));
        }
    }
