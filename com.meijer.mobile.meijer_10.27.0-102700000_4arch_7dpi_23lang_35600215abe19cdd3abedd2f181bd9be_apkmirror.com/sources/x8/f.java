...
public class f {
    ...
    private static final String f169480a = x.f133195a + "Utility";

    /* renamed from: b, reason: collision with root package name */
    private static AtomicInteger f169481b = new AtomicInteger(1);

    /* renamed from: c, reason: collision with root package name */
    private static AtomicLong f169482c = new AtomicLong(0);
    ...
    public static int f() {
        return f169481b.getAndIncrement();
    }

    public static long g() {
        return f169482c.incrementAndGet();
    }
    ...
    public static boolean j() {
        ...
        try {
            ...
            v(f169480a, "Error occurred determining process isolation state", e10);
            return true;
        }
    }
    ...
    public static int m(String str, String str2, int i10, int i11, int i12, boolean z10) throws NumberFormatException {
        if (str2 != null && !str2.isEmpty()) {
            try {
                ...
                if (i13 < i10) {
                    if (x.f133196b) {
                        u(f169480a, String.format("%s value of %s is not within the range of %s and %s", str, str2, Integer.valueOf(i10), Integer.valueOf(i11)));
                    }
                    if (!z10) {
                        return i10;
                    }
