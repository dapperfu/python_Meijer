...
public class c {
    ...
    private File a() {
        if (this.f18091a == null) {
            synchronized (this) {
                try {
                    if (this.f18091a == null) {
                        this.f18091a = new File(this.f18092b.k().getFilesDir(), "PersistedInstallation." + this.f18092b.o() + ".json");
                    }
                } finally {
                }
            }
    ...
    public d b(d dVar) throws JSONException, IOException {
        ...
        try {
            ...
            fileCreateTempFile = File.createTempFile("PersistedInstallation", "tmp", this.f18092b.k().getFilesDir());
