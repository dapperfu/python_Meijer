...
public final class e {
    ...
    public static final Pattern f127197a = Pattern.compile("^(\\S+)\\s+-->\\s+(\\S+)(.*)?$");

    /* renamed from: b, reason: collision with root package name */
    private static final Pattern f127198b = Pattern.compile("(\\S+?):(\\S+)");

    /* renamed from: c, reason: collision with root package name */
    private static final Map<String, Integer> f127199c;

    /* renamed from: d, reason: collision with root package name */
    private static final Map<String, Integer> f127200d;

    /* JADX INFO: Access modifiers changed from: private */
    static class b {

        /* renamed from: c, reason: collision with root package name */
        private static final Comparator<b> f127201c = new Comparator() { // from class: d4.f
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return Integer.compare(((e.b) obj).f127202a.f127205b, ((e.b) obj2).f127202a.f127205b);
            }
        };

        /* renamed from: a, reason: collision with root package name */
        private final c f127202a;

        /* renamed from: b, reason: collision with root package name */
        private final int f127203b;
    ...
    static final class c {
        ...
        /* renamed from: c, reason: collision with root package name */
        public final String f127206c;

        /* renamed from: d, reason: collision with root package name */
        public final Set<String> f127207d;
    ...
    private static final class d implements Comparable<d> {
        ...
        /* renamed from: a, reason: collision with root package name */
        public final int f127208a;

        /* renamed from: b, reason: collision with root package name */
        public final d4.c f127209b;

        @Override // java.lang.Comparable
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public int compareTo(d dVar) {
            return Integer.compare(this.f127208a, dVar.f127208a);
        }
    ...
    private static final class C2000e {

        /* renamed from: c, reason: collision with root package name */
        public CharSequence f127212c;

        /* renamed from: a, reason: collision with root package name */
        public long f127210a = 0;

        /* renamed from: b, reason: collision with root package name */
        public long f127211b = 0;

        /* renamed from: d, reason: collision with root package name */
        public int f127213d = 2;

        /* renamed from: e, reason: collision with root package name */
        public float f127214e = -3.4028235E38f;

        /* renamed from: f, reason: collision with root package name */
        public int f127215f = 1;

        /* renamed from: g, reason: collision with root package name */
        public int f127216g = 0;

        /* renamed from: h, reason: collision with root package name */
        public float f127217h = -3.4028235E38f;

        /* renamed from: i, reason: collision with root package name */
        public int f127218i = Integer.MIN_VALUE;

        /* renamed from: j, reason: collision with root package name */
        public float f127219j = 1.0f;

        /* renamed from: k, reason: collision with root package name */
        public int f127220k = Integer.MIN_VALUE;
        ...
        public d4.d a() {
            return new d4.d(g().a(), this.f127210a, this.f127211b);
        }

        public C6350a.b g() {
            float fE = this.f127217h;
            if (fE == -3.4028235E38f) {
                fE = e(this.f127213d);
            }
            int iF = this.f127218i;
            if (iF == Integer.MIN_VALUE) {
                iF = f(this.f127213d);
            }
            C6350a.b bVarR = new C6350a.b().p(c(this.f127213d)).h(b(this.f127214e, this.f127215f), this.f127215f).i(this.f127216g).k(fE).l(iF).n(Math.min(this.f127219j, d(iF, fE))).r(this.f127220k);
            CharSequence charSequence = this.f127212c;
    ...
    static {
        ...
        map.put("white", Integer.valueOf(Color.rgb(l3.f92484c, l3.f92484c, l3.f92484c)));
        map.put("lime", Integer.valueOf(Color.rgb(0, l3.f92484c, 0)));
        map.put("cyan", Integer.valueOf(Color.rgb(0, l3.f92484c, l3.f92484c)));
        map.put("red", Integer.valueOf(Color.rgb(l3.f92484c, 0, 0)));
        map.put("yellow", Integer.valueOf(Color.rgb(l3.f92484c, l3.f92484c, 0)));
        map.put("magenta", Integer.valueOf(Color.rgb(l3.f92484c, 0, l3.f92484c)));
        map.put("blue", Integer.valueOf(Color.rgb(0, 0, l3.f92484c)));
        map.put("black", Integer.valueOf(Color.rgb(0, 0, 0)));
        f127199c = Collections.unmodifiableMap(map);
        HashMap map2 = new HashMap();
        map2.put("bg_white", Integer.valueOf(Color.rgb(l3.f92484c, l3.f92484c, l3.f92484c)));
        map2.put("bg_lime", Integer.valueOf(Color.rgb(0, l3.f92484c, 0)));
        map2.put("bg_cyan", Integer.valueOf(Color.rgb(0, l3.f92484c, l3.f92484c)));
        map2.put("bg_red", Integer.valueOf(Color.rgb(l3.f92484c, 0, 0)));
        map2.put("bg_yellow", Integer.valueOf(Color.rgb(l3.f92484c, l3.f92484c, 0)));
        map2.put("bg_magenta", Integer.valueOf(Color.rgb(l3.f92484c, 0, l3.f92484c)));
        map2.put("bg_blue", Integer.valueOf(Color.rgb(0, 0, l3.f92484c)));
        map2.put("bg_black", Integer.valueOf(Color.rgb(0, 0, 0)));
        f127200d = Collections.unmodifiableMap(map2);
    }
    ...
    private static void d(String str, c cVar, List<b> list, SpannableStringBuilder spannableStringBuilder, List<d4.c> list2) {
        ...
        switch (str2) {
            ...
            case "b":
                ...
                break;
            case "c":
                a(spannableStringBuilder, cVar.f127207d, i10, length);
                break;
            case "i":
            ...
            case "u":
                ...
                break;
            case "v":
                f(spannableStringBuilder, cVar.f127206c, i10, length);
                break;
            case "ruby":
        ...
        for (int i11 = 0; i11 < listI.size(); i11++) {
            e(spannableStringBuilder, listI.get(i11).f127209b, i10, length);
        }
    }
    ...
    private static void e(SpannableStringBuilder spannableStringBuilder, d4.c cVar, int i10, int i11) {
        ...
        if (cVar.b()) {
            spannableStringBuilder.setSpan(new C6353d(), i10, i11, 33);
        }
    }
    ...
    private static List<d> i(List<d4.c> list, String str, c cVar) {
        ...
        for (int i10 = 0; i10 < list.size(); i10++) {
            ...
            int iH = cVar2.h(str, cVar.f127204a, cVar.f127207d, cVar.f127206c);
            if (iH > 0) {
    ...
    public static C6350a m(CharSequence charSequence) {
        C2000e c2000e = new C2000e();
        c2000e.f127212c = charSequence;
        return c2000e.g().a();
    }
    ...
    private static d4.d o(String str, Matcher matcher, D d10, List<d4.c> list) {
        C2000e c2000e = new C2000e();
        try {
            c2000e.f127210a = h.c((String) C13466a.e(matcher.group(1)));
            c2000e.f127211b = h.c((String) C13466a.e(matcher.group(2)));
            q((String) C13466a.e(matcher.group(3)), c2000e);
            ...
            c2000e.f127212c = r(str, sb2.toString(), list);
            return c2000e.a();
    ...
    static C6350a.b p(String str) {
        C2000e c2000e = new C2000e();
        q(str, c2000e);
        return c2000e.g();
    }

    private static void q(String str, C2000e c2000e) {
        Matcher matcher = f127198b.matcher(str);
        while (matcher.find()) {
            String str2 = (String) C13466a.e(matcher.group(1));
            String str3 = (String) C13466a.e(matcher.group(2));
            try {
                if ("line".equals(str2)) {
                    t(str3, c2000e);
                } else if ("align".equals(str2)) {
                    c2000e.f127213d = w(str3);
                } else if ("position".equals(str2)) {
                    v(str3, c2000e);
                } else if ("size".equals(str2)) {
                    c2000e.f127219j = h.b(str3);
                } else if ("vertical".equals(str2)) {
                    c2000e.f127220k = x(str3);
                } else {
    ...
    private static void t(String str, C2000e c2000e) {
        int iIndexOf = str.indexOf(44);
        if (iIndexOf != -1) {
            c2000e.f127216g = s(str.substring(iIndexOf + 1));
            str = str.substring(0, iIndexOf);
        }
        if (str.endsWith("%")) {
            c2000e.f127214e = h.b(str);
            c2000e.f127215f = 0;
        } else {
            c2000e.f127214e = Integer.parseInt(str);
            c2000e.f127215f = 1;
        }
    }

    private static void v(String str, C2000e c2000e) {
        int iIndexOf = str.indexOf(44);
        if (iIndexOf != -1) {
            c2000e.f127218i = u(str.substring(iIndexOf + 1));
            str = str.substring(0, iIndexOf);
        }
        c2000e.f127217h = h.b(str);
    }

    private static void a(SpannableStringBuilder spannableStringBuilder, Set<String> set, int i10, int i11) {
        for (String str : set) {
            Map<String, Integer> map = f127199c;
            if (map.containsKey(str)) {
                spannableStringBuilder.setSpan(new ForegroundColorSpan(map.get(str).intValue()), i10, i11, 33);
            } else {
                Map<String, Integer> map2 = f127200d;
    ...
    private static void c(SpannableStringBuilder spannableStringBuilder, String str, c cVar, List<b> list, List<d4.c> list2) {
        ...
        Collections.sort(arrayList, b.f127201c);
        int i10 = cVar.f127205b;
        int length = 0;
        for (int i11 = 0; i11 < arrayList.size(); i11++) {
            if ("rt".equals(((b) arrayList.get(i11)).f127202a.f127204a)) {
                b bVar = (b) arrayList.get(i11);
                int iH = h(j(list2, str, bVar.f127202a), iJ, 1);
                int i12 = bVar.f127202a.f127205b - length;
                int i13 = bVar.f127203b - length;
    ...
    private static int j(List<d4.c> list, String str, c cVar) {
        ...
        for (int i10 = 0; i10 < listI.size(); i10++) {
            d4.c cVar2 = listI.get(i10).f127209b;
            if (cVar2.g() != -1) {
                return cVar2.g();
            }
        }
