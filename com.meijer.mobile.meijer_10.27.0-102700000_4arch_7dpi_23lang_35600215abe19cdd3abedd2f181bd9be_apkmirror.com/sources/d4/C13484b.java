...
final class C13484b {
    ...
    private static final Pattern f127173c = Pattern.compile("\\[voice=\"([^\"]*)\"\\]");

    /* renamed from: d, reason: collision with root package name */
    private static final Pattern f127174d = Pattern.compile("^((?:[0-9]*\\.)?[0-9]+)(px|em|%)$");

    /* renamed from: a, reason: collision with root package name */
    private final D f127175a = new D();

    /* renamed from: b, reason: collision with root package name */
    private final StringBuilder f127176b = new StringBuilder();
    ...
    private void a(c cVar, String str) {
        ...
        if (iIndexOf != -1) {
            Matcher matcher = f127173c.matcher(str.substring(iIndexOf));
            if (matcher.matches()) {
                cVar.z((String) C13466a.e(matcher.group(1)));
            }
    ...
    private static void e(String str, c cVar) {
        Matcher matcher = f127174d.matcher(C2957c.e(str));
        if (!matcher.matches()) {
            r.i("WebvttCssParser", "Invalid font-size: '" + str + "'.");
            return;
        }
        String str2 = (String) C13466a.e(matcher.group(2));
        str2.getClass();
        switch (str2) {
            case "%":
                cVar.t(3);
        ...
        cVar.s(Float.parseFloat((String) C13466a.e(matcher.group(1))));
    }
    ...
    public List<c> d(D d10) {
        this.f127176b.setLength(0);
        int iF = d10.f();
        m(d10);
        this.f127175a.U(d10.e(), d10.f());
        this.f127175a.W(iF);
        ArrayList arrayList = new ArrayList();
        while (true) {
            String strI = i(this.f127175a, this.f127176b);
            if (strI == null || !"{".equals(g(this.f127175a, this.f127176b))) {
                break;
            }
            c cVar = new c();
            a(cVar, strI);
            ...
            boolean z10 = false;
            while (!z10) {
                int iF2 = this.f127175a.f();
                String strG = g(this.f127175a, this.f127176b);
                boolean z11 = strG == null || "}".equals(strG);
                if (!z11) {
                    this.f127175a.W(iF2);
                    j(this.f127175a, cVar, this.f127176b);
                }
                str = strG;
                z10 = z11;
            }
        ...
        if (!"".equals(strF) && ":".equals(g(d10, sb2))) {
            ...
            if (strH != null && !"".equals(strH)) {
                ...
                if ("color".equals(strF)) {
                    cVar.q(C13475j.b(strH));
                    return;
                }
                if ("background-color".equals(strF)) {
                    cVar.n(C13475j.b(strH));
                    return;
                }
                boolean z10 = true;
