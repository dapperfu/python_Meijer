...
public final class C3396h {
    public static final int a(InterfaceC15349i interfaceC15349i) {
        Intrinsics.j(interfaceC15349i, "<this>");
        return interfaceC15349i.getOffset() + interfaceC15349i.getSize();
    }

    public static final InterfaceC15349i b(C15339A c15339a, int i10) {
        Intrinsics.j(c15339a, "<this>");
        return (InterfaceC15349i) CollectionsKt.v0(c15339a.x().h(), i10 - ((InterfaceC15349i) CollectionsKt.s0(c15339a.x().h())).getIndex());
    }
