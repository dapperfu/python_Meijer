...
public final class C3397i {
    ...
    private final InterfaceC5724i0 draggedDistance;

    /* renamed from: e, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5730l0 initiallyDraggedElement;

    /* renamed from: f, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5730l0 currentIndexOfDraggedItem;

    /* renamed from: g, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5730l0 overScrollJob;
    ...
    public C3397i(C15339A lazyListState, Function2<? super Integer, ? super Integer, Unit> onDragEnd, Function2<? super Integer, ? super Integer, Unit> onDrag) {
    ...
    private final InterfaceC15349i g() {
        return (InterfaceC15349i) this.initiallyDraggedElement.getValue();
    }
    ...
    private final void o(float f10) {
        this.draggedDistance.B(f10);
    }

    private final void p(InterfaceC15349i interfaceC15349i) {
        this.initiallyDraggedElement.setValue(interfaceC15349i);
    }
    ...
    public final void m(long offset, int sizeOfList) {
        ...
        while (true) {
            ...
            int offset2 = interfaceC15349i.getOffset();
            int offset3 = interfaceC15349i.getOffset() + interfaceC15349i.getSize();
            int iIntBitsToFloat = (int) Float.intBitsToFloat((int) (4294967295L & offset));
            if (offset2 <= iIntBitsToFloat && iIntBitsToFloat <= offset3) {
                break;
            }
        }
        InterfaceC15349i interfaceC15349i2 = (InterfaceC15349i) next;
        if (interfaceC15349i2 == null || (index = interfaceC15349i2.getIndex()) < 0 || index >= sizeOfList) {
            return;
        }
        n(Integer.valueOf(interfaceC15349i2.getIndex()));
        p(interfaceC15349i2);
    }
    ...
    private final InterfaceC15349i b() {
        Integer numC = c();
        if (numC != null) {
            return C3396h.b(this.lazyListState, numC.intValue());
        }
        return null;
    }

    private final Pair<Integer, Integer> f() {
        InterfaceC15349i interfaceC15349iG = g();
        if (interfaceC15349iG != null) {
            return new Pair<>(Integer.valueOf(interfaceC15349iG.getOffset()), Integer.valueOf(C3396h.a(interfaceC15349iG)));
        }
        return null;
    }
    ...
    */
    public final float a() {
        ...
        L66:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: Dq.C3397i.a():float");
    }
    ...
    public final Float e() {
        ...
        Integer numC = c();
        if (numC != null) {
            if (C3396h.b(this.lazyListState, numC.intValue()) != null) {
                InterfaceC15349i interfaceC15349iG = g();
                if (interfaceC15349iG != null) {
                    numberValueOf = Integer.valueOf(interfaceC15349iG.getOffset());
                } else {
    ...
    public final void j(long offset) {
        ...
        if (pairF != null) {
            ...
            InterfaceC15349i interfaceC15349iB = b();
            if (interfaceC15349iB != null) {
                List<InterfaceC15349i> listH = this.lazyListState.x().h();
                ArrayList arrayList = new ArrayList();
                for (Object obj : listH) {
                    InterfaceC15349i interfaceC15349i = (InterfaceC15349i) obj;
                    if (C3396h.a(interfaceC15349i) >= fD && interfaceC15349i.getOffset() <= fD2 && interfaceC15349iB.getIndex() != interfaceC15349i.getIndex()) {
                        arrayList.add(obj);
                    }
                }
                ...
                while (true) {
                    if (it.hasNext()) {
                        next = it.next();
                        InterfaceC15349i interfaceC15349i2 = (InterfaceC15349i) next;
                        if (fD - interfaceC15349iB.getOffset() > 0.0f) {
                            if (fD2 > C3396h.a(interfaceC15349i2)) {
                                break;
                            }
                        } else if (fD < interfaceC15349i2.getOffset()) {
                            break;
                        }
                    } else {
                        next = null;
                ...
                InterfaceC15349i interfaceC15349i3 = (InterfaceC15349i) next;
                if (interfaceC15349i3 != null) {
                    Integer numC = c();
                    if (numC != null) {
                        this.onDrag.invoke(Integer.valueOf(numC.intValue()), Integer.valueOf(interfaceC15349i3.getIndex()));
                    }
                    n(Integer.valueOf(interfaceC15349i3.getIndex()));
                }
            }
        }
    }
    ...
    public final void k() {
        InterfaceC15349i interfaceC15349iG;
        InterfaceC15349i interfaceC15349iB = b();
        if (interfaceC15349iB != null && (interfaceC15349iG = g()) != null) {
            this.onDragEnd.invoke(Integer.valueOf(interfaceC15349iG.getIndex()), Integer.valueOf(interfaceC15349iB.getIndex()));
        }
        l();
    }
}
