...
public final class a implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof a) {
            a aVar = (a) obj;
            if (l.a(this.f11339a, aVar.f11339a) && this.f11340b == aVar.f11340b) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return l.b(this.f11339a, Integer.valueOf(this.f11340b));
    }

    public String toString() {
        StringBuilder sb2 = new StringBuilder(this.f11339a.length() + 8);
        if (this.f11339a.indexOf(58) >= 0) {
            sb2.append('[');
    ...
    */
    public static Ge.a a(java.lang.String r7) throws java.lang.NumberFormatException {
        /*
            Be.p.q(r7)
            java.lang.String r0 = "["
        ...
        L80:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: Ge.a.a(java.lang.String):Ge.a");
    }
}
