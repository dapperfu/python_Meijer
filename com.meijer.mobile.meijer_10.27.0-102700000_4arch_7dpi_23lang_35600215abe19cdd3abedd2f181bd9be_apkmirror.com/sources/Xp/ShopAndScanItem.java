...
public final /* data */ class ShopAndScanItem {
    ...
    public static final class a {
        ...
        public static final a f39558a = new a("ADD", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final a f39559b = new a("REMOVE", 1);

        /* renamed from: c, reason: collision with root package name */
        public static final a f39560c = new a("UPDATE", 2);

        /* renamed from: d, reason: collision with root package name */
        public static final a f39561d = new a("IDLE", 3);

        /* renamed from: e, reason: collision with root package name */
        private static final /* synthetic */ a[] f39562e;

        /* renamed from: f, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f39563f;

        static {
            a[] aVarArrA = a();
            f39562e = aVarArrA;
            f39563f = EnumEntriesKt.a(aVarArrA);
        }

        private static final /* synthetic */ a[] a() {
            return new a[]{f39558a, f39559b, f39560c, f39561d};
        }
    ...
    public static final class f {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final f f39576a = new f("SYNCING", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final f f39577b = new f("SYNCED", 1);

        /* renamed from: c, reason: collision with root package name */
        public static final f f39578c = new f("ERROR", 2);

        /* renamed from: d, reason: collision with root package name */
        private static final /* synthetic */ f[] f39579d;

        /* renamed from: e, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f39580e;

        static {
            f[] fVarArrA = a();
            f39579d = fVarArrA;
            f39580e = EnumEntriesKt.a(fVarArrA);
        }

        private static final /* synthetic */ f[] a() {
            return new f[]{f39576a, f39577b, f39578c};
        }
