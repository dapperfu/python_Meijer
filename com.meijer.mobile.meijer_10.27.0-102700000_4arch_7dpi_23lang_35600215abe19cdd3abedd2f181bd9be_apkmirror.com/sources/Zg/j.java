...
public final class j {
    ...
    private static final int[] f42746e = {31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017};

    /* renamed from: f, reason: collision with root package name */
    private static final j[] f42747f = b();
    ...
    public static j i(int i10) {
        ...
        return f42747f[i10 - 1];
    }

    public static j g(int i10) throws FormatException {
        if (i10 % 4 != 1) {
    ...
    public int e() {
        return (this.f42748a * 4) + 17;
    }

    public b f(f fVar) {
        return this.f42750c[fVar.ordinal()];
    }
    ...
    public String toString() {
        return String.valueOf(this.f42748a);
    }

    private j(int i10, int[] iArr, b... bVarArr) {
        this.f42748a = i10;
        this.f42749b = iArr;
        this.f42750c = bVarArr;
        int iB = bVarArr[0].b();
        int iA = 0;
    ...
    Gg.b a() {
        int iE = e();
        Gg.b bVar = new Gg.b(iE);
        bVar.r(0, 0, 9, 9);
        int i10 = iE - 8;
        bVar.r(i10, 0, 8, 9);
        bVar.r(0, i10, 9, 8);
        int length = this.f42749b.length;
        for (int i11 = 0; i11 < length; i11++) {
            int i12 = this.f42749b[i11] - 2;
            for (int i13 = 0; i13 < length; i13++) {
                if ((i11 != 0 || (i13 != 0 && i13 != length - 1)) && (i11 != length - 1 || i13 != 0)) {
                    bVar.r(this.f42749b[i13] - 2, i12, 5, 5);
                }
            }
        }
        int i14 = iE - 17;
