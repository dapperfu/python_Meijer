...
public final class C15143b implements o {
    ...
    public C15143b(Context appContext) {
    ...
    public Duration b() {
        if (this.metadata.containsKey("firebase_sessions_sessions_restart_timeout")) {
            return Duration.o(DurationKt.s(this.metadata.getInt("firebase_sessions_sessions_restart_timeout"), DurationUnit.f147509e));
        }
        return null;
    }
