...
public final class k {
    ...
    public static void b(pw.b<?> bVar, AtomicInteger atomicInteger, c cVar) {
        if (atomicInteger.getAndIncrement() == 0) {
            Throwable thB = cVar.b();
            if (thB != null) {
                bVar.onError(thB);
    ...
    public static void d(pw.b<?> bVar, Throwable th2, AtomicInteger atomicInteger, c cVar) {
        if (cVar.a(th2)) {
            if (atomicInteger.getAndIncrement() == 0) {
                bVar.onError(cVar.b());
                return;
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static <T> void f(pw.b<? super T> bVar, T t10, AtomicInteger atomicInteger, c cVar) {
        if (atomicInteger.get() == 0 && atomicInteger.compareAndSet(0, 1)) {
            bVar.onNext(t10);
            if (atomicInteger.decrementAndGet() != 0) {
                Throwable thB = cVar.b();
