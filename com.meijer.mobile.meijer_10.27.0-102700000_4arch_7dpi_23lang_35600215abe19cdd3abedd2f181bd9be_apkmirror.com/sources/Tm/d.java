...
@Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\u001a%\u0010\u0006\u001a\u00020\u0005*\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00012\u0006\u0010\u0004\u001a\u00020\u0003H\u0001¢\u0006\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"LJi/M;", "Landroidx/compose/ui/Modifier;", "modifier", "LRm/w$b;", "viewState", "", "b", "(LJi/M;Landroidx/compose/ui/Modifier;LRm/w$b;Landroidx/compose/runtime/Composer;II)V", "Meijer_playstoreRelease"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class d {
    ...
    static final class a extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        final /* synthetic */ w.ViewState f35077n;

        /* renamed from: o, reason: collision with root package name */
        final /* synthetic */ List<C6313a<Float, C6330m>> f35078o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(w.ViewState viewState, List<C6313a<Float, C6330m>> list, Continuation<? super a> continuation) {
            super(2, continuation);
            this.f35077n = viewState;
            this.f35078o = list;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new a(this.f35077n, this.f35078o, continuation);
        }
    ...
    static final class b implements Function3<InterfaceC14812d, Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ w.ViewState f35079a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ List<C6313a<Float, C6330m>> f35080b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f35081c;
        ...
        b(w.ViewState viewState, List<C6313a<Float, C6330m>> list, LocalThemeScope localThemeScope) {
            this.f35079a = viewState;
            this.f35080b = list;
            this.f35081c = localThemeScope;
        }
        ...
        public static final Unit d(w.ViewState viewState, List list, LocalThemeScope localThemeScope, X0.f Canvas) {
            ...
            if (viewState.getTotal() == 0.0d) {
                X0.f.k1(Canvas, localThemeScope.getAdsColors().getAdsColorPlaceholder().getColor(), 0.0f, ((Number) ((C6313a) CollectionsKt.s0(list)).m()).floatValue(), false, 0L, 0L, 0.0f, new Stroke(200.0f, 0.0f, 0, 0, null, 30, null), null, 0, 880, null);
            } else {
                ...
                while (it.hasNext()) {
                    ...
                    X0.f.k1(Canvas, g.a(localThemeScope, ((ChartData) next).getType()).getColor(), r3.getStartAngle(), ((Number) ((C6313a) list.get(i10)).m()).floatValue(), false, 0L, 0L, 0.0f, new Stroke(200.0f, 0.0f, 0, 0, null, 30, null), null, 0, 880, null);
        ...
        public final void c(InterfaceC14812d BoxWithConstraints, Composer composer, int i10) {
            int i11;
            ...
            boolean zD = composer2.D(this.f35079a) | composer2.D(this.f35080b) | composer2.D(this.f35081c);
            final w.ViewState viewState = this.f35079a;
            final List<C6313a<Float, C6330m>> list = this.f35080b;
            final LocalThemeScope localThemeScope = this.f35081c;
            Object objB = composer2.B();
            if (zD || objB == Composer.INSTANCE.a()) {
                objB = new Function1() { // from class: Tm.e
            ...
            composer2.P();
            C13443j.a(modifierG, (Function1) objB, composer2, 0);
            Modifier modifierV = J.v(companion, H1.h.p(0));
            composer2.startReplaceGroup(1849434622);
            Object objB2 = composer2.B();
            if (objB2 == Composer.INSTANCE.a()) {
                objB2 = new Function1() { // from class: Tm.f
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
                        return d.b.e((u) obj);
                    }
            ...
            composer2.P();
            Modifier modifierD = C16705m.d(modifierV, false, (Function1) objB2, 1, null);
            List<C6313a<Float, C6330m>> list2 = this.f35080b;
            LocalThemeScope localThemeScope2 = this.f35081c;
            MeasurePolicy measurePolicyB = G.b(C5658d.f48555a.g(), companion2.l(), composer2, 0);
            ...
            while (it.hasNext()) {
                ...
                ri.j.h(localThemeScope3, new q1.Label(null, null, null, null, 0, false, 0, localThemeScope2.getAdsTypography().getDetail().getOne(), null, 383, null), String.valueOf(((Number) ((C6313a) it.next()).m()).floatValue()), null, composer, LocalThemeScope.f15770g | (q1.Label.f140080j << 3), 4);
                composer2 = composer;
            ...
            w.ViewState viewState2 = this.f35079a;
            LocalThemeScope localThemeScope4 = this.f35081c;
            ...
            if (i12 == 1) {
                ...
                ri.j.g(localThemeScope4, label, annotatedStringB, null, null, composer, i13 | (i14 << 3), 12);
                C14802K.a(J.i(companion4, H1.h.p(4)), composer, 6);
                ri.j.h(localThemeScope4, new q1.Label(null, localThemeScope4.getAdsColors().getAdsColorText02(), null, null, 0, false, 0, localThemeScope4.getAdsTypography().getBody().getOne(), null, 381, null), C16193g.d(Y.f99791Rd, new Object[]{Integer.valueOf(viewState2.g())}, composer, 0), null, composer, i13 | (i14 << 3), 4);
                ri.j.h(localThemeScope4, new q1.Label(null, localThemeScope4.getAdsColors().getAdsColorText02(), null, null, 0, false, 0, localThemeScope4.getAdsTypography().getDetail().getOne(), null, 381, null), C16193g.c(Y.f99810Sd, composer, 0), null, composer, i13 | (i14 << 3), 4);
                composer.P();
            } else {
                ...
                ri.j.h(localThemeScope4, new q1.Label(J.B(companion4, 0.0f, H1.h.p(HttpResponseStatus.SUCCESS_OK), 1, null), localThemeScope4.getAdsColors().getAdsColorText01(), null, F1.j.h(F1.j.INSTANCE.a()), t.INSTANCE.b(), false, 3, one, null, 292, null), C16193g.c(viewState2.k(), composer2, 0), null, composer2, LocalThemeScope.f15770g | (q1.Label.f140080j << 3), 4);
                composer2.P();
            }
            composer.v();
            if (ComposerKt.M()) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void b(final Ji.LocalThemeScope r16, androidx.compose.ui.Modifier r17, final Rm.w.ViewState r18, androidx.compose.runtime.Composer r19, final int r20, final int r21) {
        /*
            Method dump skipped, instructions count: 357
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: Tm.d.b(Ji.M, androidx.compose.ui.Modifier, Rm.w$b, androidx.compose.runtime.Composer, int, int):void");
    }
