...
public final class d implements InterfaceC17216h {
    ...
    static final class a extends Lambda implements Function4<AbstractC18142l, FontWeight, C18153w, C18154x, Typeface> {
        a() {
            super(4);
        }

        public final Typeface a(AbstractC18142l abstractC18142l, FontWeight fontWeight, int i10, int i11) {
            z1<Object> z1VarB = d.this.getFontFamilyResolver().b(abstractC18142l, fontWeight, i10, i11);
            if (z1VarB instanceof InterfaceC18130Y.b) {
        ...
        public /* bridge */ /* synthetic */ Typeface invoke(AbstractC18142l abstractC18142l, FontWeight fontWeight, C18153w c18153w, C18154x c18154x) {
            return a(abstractC18142l, fontWeight, c18153w.getValue(), c18154x.getValue());
        }
    }

    @Override // u1.InterfaceC17216h
    public boolean a() {
        u uVar = this.resolvedTypefaces;
        if (uVar != null ? uVar.b() : false) {
            return true;
        }
        return !this.emojiCompatProcessed && e.c(this.style) && p.f3587a.a().getValue().booleanValue();
    }
    ...
    public d(String str, TextStyle textStyle, List<? extends AnnotatedString.Range<? extends AnnotatedString.a>> list, List<AnnotatedString.Range<Placeholder>> list2, AbstractC18142l.b bVar, H1.d dVar) {
        ...
        if (!e.c(textStyle)) {
            ...
            zBooleanValue = p.f3587a.a().getValue().booleanValue();
        }
