...
public final class a {
    private static final void a(SpannableString spannableString, SpanStyle spanStyle, int i10, int i11, H1.d dVar, AbstractC18142l.b bVar) {
        ...
        if (spanStyle.getFontWeight() != null || spanStyle.getFontStyle() != null) {
            ...
            spannableString.setSpan(new StyleSpan(C18136f.c(fontWeight, fontStyle != null ? fontStyle.getValue() : C18153w.INSTANCE.b())), i10, i11, 33);
        }
        if (spanStyle.getFontFamily() != null) {
            if (spanStyle.getFontFamily() instanceof C18112F) {
                spannableString.setSpan(new TypefaceSpan(((C18112F) spanStyle.getFontFamily()).getName()), i10, i11, 33);
            } else if (Build.VERSION.SDK_INT >= 28) {
                AbstractC18142l fontFamily = spanStyle.getFontFamily();
                C18154x fontSynthesis = spanStyle.getFontSynthesis();
                Object value = AbstractC18142l.b.a(bVar, fontFamily, null, 0, fontSynthesis != null ? fontSynthesis.getValue() : C18154x.INSTANCE.a(), 6, null).getValue();
                Intrinsics.h(value, "null cannot be cast to non-null type android.graphics.Typeface");
                spannableString.setSpan(l.f3581a.a((Typeface) value), i10, i11, 33);
            }
        }
    ...
    public static final SpannableString b(AnnotatedString annotatedString, H1.d dVar, AbstractC18142l.b bVar, v vVar) {
