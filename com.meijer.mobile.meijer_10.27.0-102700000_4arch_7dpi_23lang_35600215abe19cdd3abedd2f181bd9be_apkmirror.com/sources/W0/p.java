...
public final class p extends AbstractC5391c {
    ...
    public float m(float v02, float v12, float v22) {
        ...
        return (f10 > 0.20689656f ? f10 * f10 * f10 : 0.12841855f * (f10 - 0.13793103f)) * o.f38304a.c()[2];
    }
    ...
    public long n(float x10, float y10, float z10, float a10, AbstractC5391c colorSpace) {
        ...
        return C5349s0.a(f13, f14, fCbrt3 <= 128.0f ? fCbrt3 : 128.0f, a10, colorSpace);
    }
}
