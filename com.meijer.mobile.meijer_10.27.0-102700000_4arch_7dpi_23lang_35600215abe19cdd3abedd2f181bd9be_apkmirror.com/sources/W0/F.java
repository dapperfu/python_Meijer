...
public final class F extends AbstractC5391c {

    /* renamed from: t, reason: collision with root package name and from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);

    /* renamed from: u, reason: collision with root package name */
    private static final n f38223u = new n() { // from class: W0.u
        @Override // W0.n
    ...
    public static final class Companion {
        ...
        public final boolean C(float[] primaries, WhitePoint whitePoint, n OETF, n EOTF, float min, float max, int id2) {
            ...
            k kVar = k.f38267a;
            if (!C5392d.g(primaries, kVar.H()) || !C5392d.f(whitePoint, o.f38304a.e()) || min != 0.0f || max != 1.0f) {
                return false;
            }
            F fG = kVar.G();
        ...
        public static final double t(TransferParameters transferParameters, double d10) {
            return k.f38267a.J(transferParameters, d10);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final double u(TransferParameters transferParameters, double d10) {
            return k.f38267a.L(transferParameters, d10);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final double y(TransferParameters transferParameters, double d10) {
            return k.f38267a.K(transferParameters, d10);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final double z(TransferParameters transferParameters, double d10) {
            return k.f38267a.M(transferParameters, d10);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final double A(TransferParameters transferParameters, double d10) {
            return C5392d.o(d10, transferParameters.getA(), transferParameters.getB(), transferParameters.getC(), transferParameters.getD(), transferParameters.getGamma());
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final double B(TransferParameters transferParameters, double d10) {
            return C5392d.p(d10, transferParameters.getA(), transferParameters.getB(), transferParameters.getC(), transferParameters.getD(), transferParameters.getE(), transferParameters.getF(), transferParameters.getGamma());
        }
        ...
        public static final double v(TransferParameters transferParameters, double d10) {
            return C5392d.q(d10, transferParameters.getA(), transferParameters.getB(), transferParameters.getC(), transferParameters.getD(), transferParameters.getGamma());
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final double w(TransferParameters transferParameters, double d10) {
            return C5392d.r(d10, transferParameters.getA(), transferParameters.getB(), transferParameters.getC(), transferParameters.getD(), transferParameters.getE(), transferParameters.getF(), transferParameters.getGamma());
        }
    ...
    public F(String str, float[] fArr, WhitePoint whitePoint, float[] fArr2, n nVar, n nVar2, float f10, float f11, TransferParameters transferParameters, int i10) {
        super(str, C5390b.INSTANCE.b(), i10, null);
        ...
        this.inverseTransform = C5392d.k(this.transform);
    ...
    public float[] l(float[] v10) {
        ...
        return C5392d.n(this.transform, v10);
    }
    ...
    public float[] b(float[] v10) {
        C5392d.n(this.inverseTransform, v10);
        if (v10.length < 3) {
            return v10;
        }
    ...
    public long n(float x10, float y10, float z10, float a10, AbstractC5391c colorSpace) {
        ...
        return C5349s0.a((float) this.oetfFunc.a((fArr[0] * x10) + (fArr[3] * y10) + (fArr[6] * z10)), (float) this.oetfFunc.a((fArr[1] * x10) + (fArr[4] * y10) + (fArr[7] * z10)), (float) this.oetfFunc.a((fArr[2] * x10) + (fArr[5] * y10) + (fArr[8] * z10)), a10, colorSpace);
    }
