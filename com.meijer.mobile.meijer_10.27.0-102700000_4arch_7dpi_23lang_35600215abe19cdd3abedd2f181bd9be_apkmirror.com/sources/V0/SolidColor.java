...
public final class SolidColor extends AbstractC5324i0 {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SolidColor) && C5346q0.s(this.value, ((SolidColor) other).value);
    }
    ...
    public void a(long size, o1 p10, float alpha) {
        ...
        if (alpha == 1.0f) {
            ...
            long j10 = this.value;
            jQ = C5346q0.q(j10, C5346q0.t(j10) * alpha, 0.0f, 0.0f, 0.0f, 14, null);
        }
        p10.x(jQ);
        if (p10.E() != null) {
            p10.D(null);
    ...
    public int hashCode() {
        return C5346q0.y(this.value);
    }

    public String toString() {
        return "SolidColor(value=" + ((Object) C5346q0.z(this.value)) + ')';
    }
}
