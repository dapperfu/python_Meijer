...
public class C14027cy {

    /* renamed from: a, reason: collision with root package name */
    private final aL f132010a;

    public C14027cy(aL aLVar) {
        this.f132010a = aLVar;
    }

    private View a(PopupMenu popupMenu, String str, boolean z10) {
        Object objA = C14026cx.a(popupMenu);
        if (objA == null) {
            a(str, z10);
            return null;
        }
        Object objA2 = C14026cx.a(objA);
        if (objA2 == null) {
            b(str, z10);
            return null;
        }
        View viewB = C14026cx.b(objA2);
        if (viewB != null) {
            return viewB;
        }
        a(str, z10);
    ...
    private View a(Object obj, String str, boolean z10) {
        ...
        if (C14108fz.f132302l != null && C14108fz.f132302l.isAssignableFrom(cls)) {
    ...
    private View b(Object obj, String str, boolean z10) {
        Object objA = C14025cw.a(obj);
        if (objA == null) {
            a(str, z10);
            return null;
        }
        Object objB = C14025cw.b(objA);
        if (objB == null) {
            b(str, z10);
            return null;
        }
        View viewC = C14025cw.c(objB);
        if (viewC != null) {
            return viewC;
        }
        a(str, z10);
