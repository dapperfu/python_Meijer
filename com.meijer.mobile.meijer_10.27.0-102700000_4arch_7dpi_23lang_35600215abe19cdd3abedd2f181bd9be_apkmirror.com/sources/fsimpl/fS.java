...
public class fS {
    ...
    public static void a(RustInterface rustInterface, HttpURLConnection httpURLConnection, long j10, long j11, int i10) {
        if (C13993br.d()) {
            rustInterface.a(new C14093fk(httpURLConnection.getURL().toString(), httpURLConnection.getRequestMethod(), a(j11), i10, j10, httpURLConnection.getContentLengthLong(), 1));
        }
    }
}
