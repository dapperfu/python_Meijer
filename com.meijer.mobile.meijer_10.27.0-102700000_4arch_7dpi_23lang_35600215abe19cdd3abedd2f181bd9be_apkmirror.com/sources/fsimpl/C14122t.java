...
public class C14122t {
    ...
    public static int a(Context context, gh ghVar, C14013ck c14013ck) throws ClassNotFoundException {
        ...
        int iC2 = c(ghVar);
        int iE = e(ghVar);
        byte b10 = c14013ck.x() > 0 ? (byte) 2 : (byte) 1;
        cE.a(ghVar);
        cE.a(ghVar, iA2);
        cE.b(ghVar, iA4);
        cE.c(ghVar, iA3);
    ...
    public static int a(gh ghVar, boolean z10, C14013ck c14013ck) {
    ...
    private static int b(Context context, gh ghVar) throws ClassNotFoundException {
        ...
        try {
            ...
            C14028cz.a(ghVar);
            C14028cz.a(ghVar, iA);
            C14028cz.b(ghVar, iA2);
            return C14028cz.b(ghVar);
        } catch (Throwable th2) {
    ...
    private static int c(gh ghVar) {
        ...
        cA.c(ghVar, C14043dn.a(ghVar, displayMetricsA.xdpi, displayMetricsA.ydpi));
