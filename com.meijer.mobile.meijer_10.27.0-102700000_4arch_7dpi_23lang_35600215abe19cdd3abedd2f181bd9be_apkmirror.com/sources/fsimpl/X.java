...
public class X {
    ...
    private Context f131442a;

    public X(Context context) {
        this.f131442a = context;
    }

    public String a(String str) {
        String strA = dO.a(this.f131442a, "FS_PREFS", str);
        Log.v(String.format("readKey: %s='%s'", str, strA));
        return strA;
    }

    public void a(String str, Boolean bool) {
        boolean zA = dO.a(this.f131442a, "FS_PREFS", str, bool);
        if (!zA) {
    ...
    public void a(String str, Long l10) {
        boolean zA = dO.a(this.f131442a, "FS_PREFS", str, l10);
        if (!zA) {
    ...
    public void a(String str, String str2) {
        boolean zA = dO.a(this.f131442a, "FS_PREFS", str, str2);
        if (!zA) {
    ...
    public Boolean b(String str) {
        Boolean boolB = dO.b(this.f131442a, "FS_PREFS", str);
        Log.v(String.format("readKeyBool: %s='%b'", str, boolB));
        return boolB;
    }

    public Long c(String str) {
        Long lC = dO.c(this.f131442a, "FS_PREFS", str);
