...
public class aV {
    ...
    private final aP f131547a;

    /* renamed from: b, reason: collision with root package name */
    private final bV f131548b;

    /* renamed from: c, reason: collision with root package name */
    private final bU f131549c;

    /* renamed from: d, reason: collision with root package name */
    private final C13984bi f131550d;

    /* renamed from: e, reason: collision with root package name */
    private final Rect f131551e = new Rect();

    /* renamed from: f, reason: collision with root package name */
    private final bS f131552f;

    public aV(aP aPVar, bV bVVar, bU bUVar, C13984bi c13984bi, bS bSVar) {
        this.f131547a = aPVar;
        this.f131548b = bVVar;
        this.f131549c = bUVar;
        this.f131550d = c13984bi;
        this.f131552f = bSVar;
    }
    ...
    private static int a(Bitmap bitmap) {
        ...
        try {
            ...
            if (C14106fx.a(bitmap) && (bitmapB = C14106fx.b(bitmapCreateScaledBitmap)) != bitmapCreateScaledBitmap) {
                C14106fx.a(bitmapCreateScaledBitmap, bitmap);
    ...
    private int a(gh ghVar, Bitmap bitmap) {
        ...
        if (!aP.a(bitmap)) {
            return C14035df.a(ghVar, bitmap.getWidth(), bitmap.getHeight(), 0, 0, 0, 0, bitmap.getDensity(), a(bitmap), 1);
        }
    ...
    private int a(gh ghVar, Bitmap bitmap, boolean z10) {
        ...
        try {
            ...
            if (!aP.a(bitmap)) {
                ...
                String strA2 = z10 ? null : this.f131548b.a(bitmap);
                ...
                if (strA2 != null) {
                    ...
                    strA = z10 ? this.f131547a.a(bitmap, width, height) : this.f131547a.b(bitmap, width, height);
                    if (strA == null) {
                    }
                }
                int iA = ghVar.a(strA);
                ...
                return C14035df.a(ghVar, width, height, 0, iA, 0, ninePatchChunk != null ? C14035df.a(ghVar, ninePatchChunk) : 0, density, 0, 0);
            }
            Log.w("bitmap recycled after canvas checks and made it through to encoding, discarding from uploads");
        } finally {
            try {
    ...
    private int a(gh ghVar, String str, int i10, int i11, int i12) {
        return C14035df.a(ghVar, i10, i11, 0, ghVar.a(str), 0, 0, i12, 0, 2);
    }
