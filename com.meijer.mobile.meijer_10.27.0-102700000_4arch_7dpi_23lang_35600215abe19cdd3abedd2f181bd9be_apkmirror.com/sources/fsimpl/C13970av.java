...
public class C13970av {

    /* renamed from: a, reason: collision with root package name */
    private static boolean f131718a;

    /* renamed from: b, reason: collision with root package name */
    private static final Map f131719b = new WeakHashMap();

    /* renamed from: c, reason: collision with root package name */
    private final InterfaceC13976ba f131720c;

    /* renamed from: d, reason: collision with root package name */
    private final boolean f131721d;

    public C13970av(InterfaceC13976ba interfaceC13976ba, C13966ar c13966ar) {
        this.f131720c = interfaceC13976ba;
        this.f131721d = c13966ar != null && c13966ar.p();
    }
    ...
    private static void a(View view, C13957ai c13957ai) {
        ...
        if (z10) {
            c13957ai.translate(scrollX, scrollY);
        }
        a(background, view, c13957ai, true);
        if (z10) {
            c13957ai.translate(-scrollX, -scrollY);
        }
    }
    ...
    private static boolean a(Drawable drawable, View view, C13957ai c13957ai, boolean z10) {
        ...
        if (!(drawableA instanceof LayerDrawable)) {
            if (gb.a(drawableA)) {
                c13957ai.a(drawableA, view, z10);
                return true;
            }
            if (!z10) {
                return false;
            }
            drawableA.draw(c13957ai);
            return true;
        }
        ...
        for (int i10 = 0; i10 < numberOfLayers; i10++) {
            if (a(layerDrawable.getDrawable(i10), view, c13957ai, z10)) {
                z11 = true;
            }
        }
        return z11;
    ...
    private TextureView b(View view) {
        if (this.f131721d && (view instanceof TextureView)) {
    ...
    private boolean b(View view, C13957ai c13957ai) {
        if (view instanceof ImageView) {
            return a(((ImageView) view).getDrawable(), view, c13957ai, false);
        }
        return false;
    }
    ...
    */
    public int a(android.view.View r16, java.lang.Object r17, fsimpl.C14124v r18, fsimpl.C13957ai r19, fsimpl.W r20, fsimpl.bU r21) {
        /*
            Method dump skipped, instructions count: 366
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: fsimpl.C13970av.a(android.view.View, java.lang.Object, fsimpl.v, fsimpl.ai, fsimpl.W, fsimpl.bU):int");
    }

    public int a(FSComposeDraw fSComposeDraw, C14124v c14124v, Object obj, C13957ai c13957ai, Object obj2, boolean z10, RectF rectF, C14013ck c14013ck) {
        C14103fu.a("renderNode", new Object[0]);
        c13957ai.a(rectF.left, rectF.top, c14124v.e(fSComposeDraw));
        c13957ai.drawRect(rectF, (Paint) null);
        if (c14013ck.B()) {
            a(fSComposeDraw, obj, obj2, z10);
        } else {
            fSComposeDraw._fsComposeDraw(obj);
        }
        return this.f131720c.a(gd.c(fSComposeDraw), c13957ai.h());
    }

    public int a(aF aFVar, C13957ai c13957ai, RectF rectF) {
        C14103fu.a("renderIntermediate", new Object[0]);
        c13957ai.i();
        c13957ai.drawRect(rectF, (Paint) null);
        return this.f131720c.a(gd.c(aFVar), c13957ai.j());
    }

    public void a(CompoundButton compoundButton, Drawable drawable, C13957ai c13957ai) {
        int height;
        if (!gb.a(drawable)) {
            ...
            AbstractC14110h.a(compoundButton, c13957ai);
            return;
        }
        ...
        switch (gravity) {
            case 16:
                height = (c13957ai.getHeight() - intrinsicHeight) / 2;
                break;
            case BinsView.LABEL_WIDTH_DP /* 80 */:
                height = c13957ai.getHeight() - intrinsicHeight;
                break;
            default:
                height = 0;
                break;
        ...
        int width = compoundButton.isLayoutRtl() ? c13957ai.getWidth() - intrinsicWidth : 0;
        if (compoundButton.isLayoutRtl()) {
            intrinsicWidth = c13957ai.getWidth();
        }
        ...
        if (background != null) {
            ...
            if (gb.a(background)) {
                c13957ai.a(background, (View) compoundButton, true);
            }
        }
        AbstractC14110h.a(compoundButton, c13957ai);
        ...
        if (scrollX == 0 && scrollY == 0) {
            c13957ai.a(drawable, (View) compoundButton, false);
            return;
        }
        c13957ai.translate(scrollX, scrollY);
        c13957ai.a(drawable, (View) compoundButton, false);
