    ...
    */
    public okhttp3.Response intercept(okhttp3.Interceptor.Chain r19) throws java.io.IOException {
        ...
        L68:
            r0 = 0
        L69:
            boolean r4 = r1.f131771b     // Catch: java.lang.Throwable -> L81
            if (r4 != 0) goto L6f
            if (r0 == r3) goto L82
        L6f:
            com.fullstory.rust.RustInterface r3 = r1.f131770a     // Catch: java.lang.Throwable -> L81
