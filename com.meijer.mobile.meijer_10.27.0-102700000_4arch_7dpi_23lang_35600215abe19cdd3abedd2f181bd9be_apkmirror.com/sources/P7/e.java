...
@Metadata(d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\r\n\u0002\u0010$\n\u0002\u0010\b\n\u0002\u0018\u0002\n\u0002\b\b\n\u0002\u0018\u0002\n\u0002\b\b\b\u0000\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J%\u0010\n\u001a\u00020\t*\u00020\u00042\u0006\u0010\u0006\u001a\u00020\u00052\b\u0010\b\u001a\u0004\u0018\u00010\u0007H\u0002¢\u0006\u0004\b\n\u0010\u000bJ\u001b\u0010\f\u001a\u00020\t*\u00020\u00042\u0006\u0010\u0006\u001a\u00020\u0005H\u0002¢\u0006\u0004\b\f\u0010\rJ\u001b\u0010\u000e\u001a\u00020\t*\u00020\u00042\u0006\u0010\u0006\u001a\u00020\u0005H\u0002¢\u0006\u0004\b\u000e\u0010\rJ\u001b\u0010\u000f\u001a\u00020\t*\u00020\u00042\u0006\u0010\u0006\u001a\u00020\u0005H\u0002¢\u0006\u0004\b\u000f\u0010\rJ/\u0010\u0013\u001a\u00020\t*\u00020\u00042\u0006\u0010\u0010\u001a\u00020\u00072\b\u0010\u0011\u001a\u0004\u0018\u00010\u00072\b\b\u0002\u0010\u0012\u001a\u00020\u0007H\u0002¢\u0006\u0004\b\u0013\u0010\u0014J\u0019\u0010\u0015\u001a\u0004\u0018\u00010\u00072\u0006\u0010\u0006\u001a\u00020\u0005H\u0002¢\u0006\u0004\b\u0015\u0010\u0016J3\u0010\u001b\u001a\u000e\u0012\u0004\u0012\u00020\u0018\u0012\u0004\u0012\u00020\u00190\u0017*\u000e\u0012\u0004\u0012\u00020\u0018\u0012\u0004\u0012\u00020\u00190\u00172\u0006\u0010\u001a\u001a\u00020\u0018H\u0002¢\u0006\u0004\b\u001b\u0010\u001cJ\u0017\u0010\u001e\u001a\u00020\u00072\u0006\u0010\u001d\u001a\u00020\u0007H\u0002¢\u0006\u0004\b\u001e\u0010\u001fJ\u000f\u0010 \u001a\u00020\u0004H\u0002¢\u0006\u0004\b \u0010!J\u0019\u0010$\u001a\u0004\u0018\u00010\u00042\u0006\u0010#\u001a\u00020\"H\u0007¢\u0006\u0004\b$\u0010%J\u0019\u0010&\u001a\u0004\u0018\u00010\u00042\u0006\u0010#\u001a\u00020\"H\u0007¢\u0006\u0004\b&\u0010%J!\u0010(\u001a\u00020\u00042\u0006\u0010\u0006\u001a\u00020\u00052\b\u0010'\u001a\u0004\u0018\u00010\u0007H\u0001¢\u0006\u0004\b(\u0010)¨\u0006*"}, d2 = {"LP7/e;", "", "<init>", "()V", "Lorg/json/JSONObject;", "Lx;", "tombstone", "", "fallbackMessage", "", "l", "(Lorg/json/JSONObject;Lx;Ljava/lang/String;)V", "p", "(Lorg/json/JSONObject;Lx;)V", "k", "q", "key", "optionalValue", "droppedLog", "n", "(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", "e", "(Lx;)Ljava/lang/String;", "", "", "Lu;", "keyToMove", "i", "(Ljava/util/Map;I)Ljava/util/Map;", "input", "f", "(Ljava/lang/String;)Ljava/lang/String;", "h", "()Lorg/json/JSONObject;", "Landroid/app/ApplicationExitInfo;", "applicationExitInfo", "c", "(Landroid/app/ApplicationExitInfo;)Lorg/json/JSONObject;", "d", "exitInfoDescription", "j", "(Lx;Ljava/lang/String;)Lorg/json/JSONObject;", "com.dynatrace.agent_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
@SourceDebugExtension
/* loaded from: classes4.dex */
public final class e {
    private final String f(String input) {
        return SequencesKt.K(SequencesKt.M(Regex.f(new Regex("(?ms)^\".*?(?=\\n\\s*(?:DumpLatency|\\s*$))"), input, 0, 2, null), new Function1() { // from class: P7.c
    ...
    public final JSONObject d(ApplicationExitInfo applicationExitInfo) throws JSONException, IOException {
        ...
        try {
            InputStream traceInputStream = applicationExitInfo.getTraceInputStream();
            x xVarB = traceInputStream != null ? x.f166583C.b(traceInputStream) : null;
            if (xVarB != null) {
                return j(xVarB, applicationExitInfo.getDescription());
            }
            JSONObject jSONObjectH = h();
    ...
    private final String e(x tombstone) {
        ...
        while (it.hasNext()) {
            ...
            for (Object obj : value.c()) {
                ...
                sb2.append("      #" + StringsKt.B0(String.valueOf(i10), 2, '0') + " pc " + HexExtensionsKt.p(cVar.getRel_pc(), null, 1, null) + ' ' + cVar.getFile_name() + " (" + cVar.getFunction_name() + '+' + cVar.getFunction_offset() + ") (BuildId: " + cVar.getBuild_id() + ')');
                sb2.append("\n");
                i10 = i11;
            }
            sb2.append("\n");
    ...
    private final void k(JSONObject jSONObject, x xVar) throws JSONException {
        ...
        if (strB != null) {
            ...
            if (strSubstring != null) {
                strS1 = StringsKt.s1(strSubstring, ": ", null, 2, null);
            }
        }
        o(this, jSONObject, "exception.type", strS1, null, 4, null);
    }
    ...
    private final void l(JSONObject jSONObject, x xVar, String str) throws JSONException {
        ...
        if (xVar.getAbort_message().length() > 0) {
            ...
            str = CollectionsKt.B0(xVar.e(), ". ", null, null, 0, null, new Function1() { // from class: P7.d
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
