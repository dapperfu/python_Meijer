...
public final class c {
    ...
    private static final String[] f150978a = new String[0];

    /* renamed from: b, reason: collision with root package name */
    private static final Comparator<a> f150979b = new Comparator() { // from class: n2.b
    ...
    public static /* synthetic */ int a(a aVar, a aVar2) {
        int i10 = aVar.f150982c;
        int i11 = aVar2.f150982c;
        if (i10 < i11) {
            return -1;
        }
        if (i10 > i11) {
        ...
        return Integer.compare(aVar2.f150983d, aVar.f150983d);
    }
    ...
    private static String f(String str) {
        return Build.VERSION.SDK_INT >= 28 ? WebView.findAddress(str) : C15768a.c(str);
    }
    ...
    public static boolean c(Spannable spannable, int i10) {
        ...
        if ((i10 & 1) != 0) {
            ...
            g(arrayList, spannable2, e.f153147h, new String[]{"http://", "https://", "rtsp://"}, Linkify.sUrlMatchFilter, null);
        } else {
            spannable2 = spannable;
        }
        if ((i10 & 2) != 0) {
            g(arrayList, spannable2, e.f153148i, new String[]{"mailto:"}, null, null);
        }
        if ((i10 & 8) != 0) {
        ...
        while (it.hasNext()) {
            a aVar = (a) it.next();
            if (aVar.f150980a == null) {
                e(aVar.f150981b, aVar.f150982c, aVar.f150983d, spannable2);
            }
        }
        return true;
    }
    ...
    private static void g(ArrayList<a> arrayList, Spannable spannable, Pattern pattern, String[] strArr, Linkify.MatchFilter matchFilter, Linkify.TransformFilter transformFilter) {
        ...
        while (matcher.find()) {
            ...
            if (matchFilter == null || matchFilter.acceptMatch(spannable, iStart, iEnd)) {
                if (strGroup != null) {
                    a aVar = new a();
                    aVar.f150981b = i(strGroup, strArr, matcher, transformFilter);
                    aVar.f150982c = iStart;
                    aVar.f150983d = iEnd;
                    arrayList.add(aVar);
                }
            }
        ...
        while (true) {
            try {
                ...
                if (strF != null && (iIndexOf = string.indexOf(strF)) >= 0) {
                    ...
                    aVar.f150982c = iIndexOf + i10;
                    i10 += length;
                    aVar.f150983d = i10;
                    string = string.substring(length);
                    try {
                        aVar.f150981b = "geo:0,0?q=" + URLEncoder.encode(strF, "UTF-8");
                        arrayList.add(aVar);
    ...
    private static void j(ArrayList<a> arrayList, Spannable spannable) {
        ...
        for (URLSpan uRLSpan : (URLSpan[]) spannable.getSpans(0, spannable.length(), URLSpan.class)) {
            a aVar = new a();
            aVar.f150980a = uRLSpan;
            aVar.f150982c = spannable.getSpanStart(uRLSpan);
            aVar.f150983d = spannable.getSpanEnd(uRLSpan);
            arrayList.add(aVar);
        }
        Collections.sort(arrayList, f150979b);
        int size = arrayList.size();
        while (i12 < size - 1) {
            a aVar2 = arrayList.get(i12);
            int i13 = i12 + 1;
            a aVar3 = arrayList.get(i13);
            int i14 = aVar2.f150982c;
            int i15 = aVar3.f150982c;
            if (i14 <= i15 && (i10 = aVar2.f150983d) > i15) {
                int i16 = aVar3.f150983d;
                ...
                if (i11 != -1) {
                    Object obj = arrayList.get(i11).f150980a;
                    if (obj != null) {
