...
public class C16904o implements InterfaceC16889N<p6.d> {

    /* renamed from: a, reason: collision with root package name */
    private int f160258a;
        ...
        for (int i11 = 1; i11 < fArr.length; i11++) {
            ...
            if (f11 >= f10 || i11 == fArr.length - 1) {
                if (f11 <= f10) {
                    ...
                    int i12 = i11 - 1;
                    float f12 = fArr[i12];
                    fI = u6.l.i(fArr2[i12], fArr2[i11], (f10 - f12) / (f11 - f12));
                }
    ...
    int c(float f10, float f11, float[] fArr, int[] iArr) {
        ...
        for (int i10 = 1; i10 < fArr.length; i10++) {
            ...
            if (f12 >= f10 || i10 == fArr.length - 1) {
                ...
                int i11 = i10 - 1;
                float f13 = fArr[i11];
                int iC = C17231e.c((f10 - f13) / (f12 - f13), iArr[i11], iArr[i10]);
    ...
    private p6.d b(p6.d dVar, List<Float> list) {
        int i10 = this.f160258a * 4;
        if (list.size() <= i10) {
            return dVar;
        }
        float[] fArrE = dVar.e();
    ...
    */
    public p6.d a(t6.AbstractC17067c r18, float r19) throws java.io.IOException {
        /*
            Method dump skipped, instructions count: 223
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: s6.C16904o.a(t6.c, float):p6.d");
    }

    public C16904o(int i10) {
        this.f160258a = i10;
    }
}
