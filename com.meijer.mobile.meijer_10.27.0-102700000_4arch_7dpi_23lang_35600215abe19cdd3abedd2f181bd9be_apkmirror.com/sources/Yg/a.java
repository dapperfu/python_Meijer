...
public class a implements l {
    ...
    private static final o[] f40262b = new o[0];

    /* renamed from: a, reason: collision with root package name */
    private final e f40263a = new e();
    ...
    public final m a(c cVar, Map<d, ?> map) throws NotFoundException, ChecksumException, FormatException {
        ...
        if (map == null || !map.containsKey(d.PURE_BARCODE)) {
            g gVarE = new C5604c(cVar.a()).e(map);
            Gg.e eVarB2 = this.f40263a.b(gVarE.a(), map);
            oVarArrB = gVarE.b();
            eVarB = eVarB2;
        } else {
            eVarB = this.f40263a.b(c(cVar.a()), map);
            oVarArrB = f40262b;
        }
    ...
    private static Gg.b c(Gg.b bVar) throws NotFoundException {
        int[] iArrL = bVar.l();
        int[] iArrG = bVar.g();
            ...
            if (i12 < i13 && i10 < i11) {
                ...
                if (iRound > 0 && iRound2 > 0) {
                    if (iRound2 == iRound) {
                        ...
                        Gg.b bVar2 = new Gg.b(iRound, iRound2);
    ...
    private static float d(int[] iArr, Gg.b bVar) throws NotFoundException {
        int iJ = bVar.j();
        int iM = bVar.m();
        int i10 = iArr[0];
        boolean z10 = true;
