...
public class i {
    public static o a(Q1.e eVar, int i10, ArrayList<o> arrayList, o oVar) {
        int iZ0;
        int i11 = i10 == 0 ? eVar.f29559H0 : eVar.f29561I0;
        if (i11 != -1 && (oVar == null || i11 != oVar.f31620b)) {
            int i12 = 0;
            while (true) {
        ...
        if (oVar.a(eVar)) {
            ...
            if (i10 == 0) {
                eVar.f29559H0 = oVar.c();
                eVar.f29566N.b(i10, arrayList, oVar);
                eVar.f29568P.b(i10, arrayList, oVar);
            } else {
                eVar.f29561I0 = oVar.c();
                eVar.f29567O.b(i10, arrayList, oVar);
                eVar.f29570R.b(i10, arrayList, oVar);
                eVar.f29569Q.b(i10, arrayList, oVar);
            }
            eVar.f29573U.b(i10, arrayList, oVar);
        }
        return oVar;
    }
    ...
    */
    public static boolean c(Q1.f r17, R1.b.InterfaceC0714b r18) {
        /*
