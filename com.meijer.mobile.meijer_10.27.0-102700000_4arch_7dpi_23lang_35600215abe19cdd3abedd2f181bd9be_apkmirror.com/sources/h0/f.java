...
public final class f {
    ...
    static final class a extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
        ...
        final /* synthetic */ j f134150b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ InterfaceC5730l0<Boolean> f134151c;
        ...
        static final class C2120a<T> implements InterfaceC17153g {

            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ List<d> f134152a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ InterfaceC5730l0<Boolean> f134153b;

            C2120a(List<d> list, InterfaceC5730l0<Boolean> interfaceC5730l0) {
                this.f134152a = list;
                this.f134153b = interfaceC5730l0;
            }
            ...
            public final Object emit(i iVar, Continuation<? super Unit> continuation) {
                if (iVar instanceof d) {
                    this.f134152a.add(iVar);
                } else if (iVar instanceof e) {
                    this.f134152a.remove(((e) iVar).getFocus());
                }
                this.f134153b.setValue(Boxing.a(!this.f134152a.isEmpty()));
        ...
        a(j jVar, InterfaceC5730l0<Boolean> interfaceC5730l0, Continuation<? super a> continuation) {
            ...
            this.f134150b = jVar;
            this.f134151c = interfaceC5730l0;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new a(this.f134150b, this.f134151c, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                InterfaceC17152f<i> interfaceC17152fB = this.f134150b.b();
                C2120a c2120a = new C2120a(arrayList, this.f134151c);
                this.f134149a = 1;
                if (interfaceC17152fB.collect(c2120a, this) == objF) {
                    return objF;
                }
            }
            return Unit.f142422a;
