...
public final class b {
    ...
    private static final byte[] f31654a = P.q0("OpusHead");
    ...
    private static final class a {
        ...
        private final D f31660f;

        /* renamed from: g, reason: collision with root package name */
        private final D f31661g;
        ...
        public boolean a() {
            int i10 = this.f31656b + 1;
            this.f31656b = i10;
            if (i10 == this.f31655a) {
                return false;
            }
            this.f31658d = this.f31659e ? this.f31660f.O() : this.f31660f.J();
            if (this.f31656b == this.f31662h) {
                this.f31657c = this.f31661g.L();
                this.f31661g.X(4);
                int i11 = this.f31663i - 1;
                this.f31663i = i11;
                this.f31662h = i11 > 0 ? this.f31661g.L() - 1 : -1;
            }
            return true;
        }
        ...
        public a(D d10, D d11, boolean z10) throws ParserException {
            ...
            d10.W(12);
            this.f31663i = d10.L();
            C18013s.a(d10.q() == 1, "first_chunk must be 1");
            this.f31656b = -1;
        }
    }
    ...
    private static final class C0715b {
        ...
        public C0715b(String str, byte[] bArr, long j10, long j11) {
            this.f31664a = str;
            this.f31665b = bArr;
            this.f31666c = j10;
            this.f31667d = j11;
    ...
    static final class h implements e {
        ...
        public int a() {
            ...
            return i10 == -1 ? this.f31681c.L() : i10;
        }
        ...
        public h(c.C2018c c2018c, a3.t tVar) {
    ...
    static final class i implements e {
        ...
        public int a() {
            ...
            if (i10 == 8) {
                return this.f31682a.H();
            }
            if (i10 == 16) {
                return this.f31682a.P();
            }
            int i11 = this.f31685d;
            this.f31685d = i11 + 1;
            if (i11 % 2 != 0) {
                return this.f31686e & 15;
            }
            int iH = this.f31682a.H();
            this.f31686e = iH;
            return (iH & 240) >> 4;
        }
        ...
        public i(c.C2018c c2018c) {
            D d10 = c2018c.f128078b;
            this.f31682a = d10;
            d10.W(12);
            this.f31684c = d10.L() & l3.f92484c;
            this.f31683b = d10.L();
        }
    }
    ...
    static final class k {
        ...
        public boolean b() {
            c cVar = this.f31690a;
            return cVar != null && cVar.f31668a.f31672a && this.f31690a.f31668a.f31673b;
        }
    ...
    private static void I(D d10, int i10, int i11, int i12, int i13, int i14, a3.o oVar, g gVar, int i15) throws ParserException {
        ...
        if (iIntValue == 1701733238) {
            ...
            if (pairW != null) {
                ...
                oVarB = oVarB == null ? null : oVarB.b(((u) pairW.second).f31828b);
                gVar2.f31675a[i15] = (u) pairW.second;
            }
            d10.W(iF);
        }
        ...
        while (iF - i27 < i28) {
            ...
            C18013s.a(iQ > 0, "childAtomSize must be positive");
            int iQ2 = d10.q();
            if (iQ2 == 1635148611) {
                C18013s.a(str3 == null, null);
                d10.W(iF2 + 8);
                C17999d c17999dB = C17999d.b(d10);
                List<byte[]> list2 = c17999dB.f169156a;
                gVar2.f31677c = c17999dB.f169157b;
                if (!z10) {
                    fU = c17999dB.f169166k;
                }
                String str5 = c17999dB.f169167l;
                int i35 = c17999dB.f169165j;
                int i36 = c17999dB.f169162g;
                int i37 = c17999dB.f169163h;
                listY = list2;
                int i38 = c17999dB.f169164i;
                int i39 = c17999dB.f169160e;
                f.k kVar3 = kVar2;
                oVar2 = oVarB;
                kVar = kVar3;
                i16 = iF;
                ...
                if (iQ2 == 1752589123) {
                    ...
                    d10.W(iF2 + 8);
                    C cA = C.a(d10);
                    List<byte[]> list3 = cA.f169044a;
                    gVar2.f31677c = cA.f169045b;
                    if (!z10) {
                        fU = cA.f169055l;
                    }
                    int i40 = cA.f169056m;
                    int i41 = cA.f169046c;
                    String str6 = cA.f169057n;
                    int i42 = cA.f169054k;
                    listY = list3;
                    if (i42 != -1) {
                        i31 = i42;
                    ...
                    str = str2;
                    if (iQ2 == 1818785347) {
                        C18013s.a("video/hevc".equals(str3), "lhvC must follow hvcC atom");
                        f.k kVar4 = kVar2;
                        C18013s.a(kVar4 != null && kVar4.f128137b.size() >= 2, "must have at least two layers");
                        d10.W(iF2 + 8);
                        C c10 = C.c(d10, (f.k) C13466a.e(kVar4));
                        C18013s.a(gVar2.f31677c == c10.f169045b, "nalUnitLengthFieldLength must be same for both hvcC and lhvC atoms");
                        int i48 = c10.f169051h;
                        int i49 = iJ;
                        if (i48 != -1) {
                            C18013s.a(i49 == i48, "colorSpace must be the same for both views");
                        }
                        int i50 = c10.f169052i;
                        int i51 = i34;
                        if (i50 != -1) {
                            C18013s.a(i51 == i50, "colorRange must be the same for both views");
                        }
                        int i52 = c10.f169053j;
                        if (i52 != -1) {
                            int i53 = iK;
                            i25 = i53;
                            C18013s.a(i53 == i52, "colorTransfer must be the same for both views");
                        } else {
                            i25 = iK;
                        }
                        C18013s.a(i29 == c10.f169049f, "bitdepthLuma must be the same for both views");
                        C18013s.a(i30 == c10.f169050g, "bitdepthChroma must be the same for both views");
                        List<byte[]> listK = listY;
                        if (listK != null) {
                            listK = L.p().j(listK).j(c10.f169044a).k();
                            i26 = i49;
                        } else {
                            i26 = i49;
                            C18013s.a(false, "initializationData must be already set from hvcC atom");
                        }
                        str3 = "video/mv-hevc";
                        oVar2 = oVarB;
                        i18 = iIntValue;
                        ...
                        if (iQ2 == 1986361461) {
                            ...
                            if (kVarH == null || kVarH.f31690a == null) {
                                i24 = i31;
                                i31 = i24;
                                oVar2 = oVarB;
                                listY = listH;
                                ...
                                iK = i55;
                                kVar = kVar5;
                            } else if (kVar5 == null || kVar5.f128137b.size() < 2) {
                                i24 = i31;
                                if (i24 == -1) {
                                    i31 = kVarH.f31690a.f31668a.f31674c ? 5 : 4;
                                } else {
                                    i31 = i24;
                                }
                                oVar2 = oVarB;
                                ...
                                C18013s.a(kVarH.b(), "both eye views must be marked as available");
                                C18013s.a(!kVarH.f31690a.f31668a.f31674c, "for MV-HEVC, eye_views_reversed must be set to false");
                                i24 = i31;
                                i31 = i24;
                                oVar2 = oVarB;
                                listY = listH;
                            ...
                            if (iQ2 == 1685480259 || iQ2 == 1685485123) {
                                ...
                                i22 = i54;
                                i23 = i55;
                                C18009n c18009nA = C18009n.a(d10);
                                if (c18009nA != null) {
                                    str3 = "video/dolby-vision";
                                    str4 = c18009nA.f169237c;
                                }
                                ...
                                if (str7.equals("video/x-vnd.on2.vp9")) {
                                    listH = C13474i.h(bH, bH2, (byte) i29, b10);
                                }
                                boolean z11 = (iH & 1) != 0;
                                int iH2 = d10.H();
                                int iH3 = d10.H();
                                ...
                                if (iQ2 == 1635135811) {
                                    ...
                                    listY = L.y(bArr);
                                    d10.W(iF2 + 8);
                                    C5570j c5570jH = h(d10);
                                    int i59 = c5570jH.f43849e;
                                    int i60 = c5570jH.f43850f;
                                    int i61 = c5570jH.f43845a;
                                    int i62 = c5570jH.f43846b;
                                    iK = c5570jH.f43847c;
                                    i29 = i59;
                                    oVar2 = oVarB;
                                    i30 = i60;
                                    ...
                                    if (iQ2 == 1681012275) {
                                        ...
                                        C18013s.a(str3 == null, null);
                                        c0715bK = k(d10, iF2);
                                        String str8 = c0715bK.f31664a;
                                        byte[] bArr2 = c0715bK.f31665b;
                                        ...
                                        if (iQ2 == 1937126244) {
                                            ...
                                            if (iQ2 == 1634760259) {
                                                ...
                                                d10.l(bArr3, 0, i65);
                                                listY = L.y(bArr3);
                                                C5570j c5570jF = f(new D(bArr3));
                                                int i66 = c5570jF.f43849e;
                                                int i67 = c5570jF.f43850f;
                                                int i68 = c5570jF.f43845a;
                                                int i69 = c5570jF.f43846b;
                                                iK = c5570jF.f43847c;
                                                i29 = i66;
                                                i30 = i67;
                                                iJ = i68;
        ...
        t.b bVarT = new t.b().e0(i13).u0(str3).S(str4).z0(iP).d0(iP2).q0(fU).t0(i14).r0(bArrV).x0(i70).g0(list4).l0(i32).m0(i33).Y(oVar4).T(new C5570j.b().d(i71).c(i72).e(i73).f(byteBufferA != null ? byteBufferA.array() : null).g(i75).b(i74).a());
        if (c0715bK != null) {
            bVarT.Q(He.f.k(c0715bK.f31666c)).p0(He.f.k(c0715bK.f31667d));
        }
        gVar.f31676b = bVarT.N();
    }
    ...
    */
    ...
    private static final class g {
        ...
        /* renamed from: d, reason: collision with root package name */
        public int f31678d = 0;

        public g(int i10) {
            this.f31675a = new u[i10];
        }
    }
    ...
    private static g A(D d10, int i10, int i11, String str, a3.o oVar, boolean z10) throws ParserException {
        ...
        while (i12 < iQ) {
            int iF = d10.f();
            int iQ2 = d10.q();
            C18013s.a(iQ2 > 0, "childAtomSize must be positive");
            int iQ3 = d10.q();
            if (iQ3 == 1635148593 || iQ3 == 1635148595 || iQ3 == 1701733238 || iQ3 == 1831958048 || iQ3 == 1836070006 || iQ3 == 1752589105 || iQ3 == 1751479857 || iQ3 == 1932670515 || iQ3 == 1211250227 || iQ3 == 1748121139 || iQ3 == 1987063864 || iQ3 == 1987063865 || iQ3 == 1635135537 || iQ3 == 1685479798 || iQ3 == 1685479729 || iQ3 == 1685481573 || iQ3 == 1685481521 || iQ3 == 1634760241) {
                ...
                gVar.f31676b = new t.b().e0(i10).u0("application/x-camera-motion").N();
            }
            d10.W(iF + iQ2);
            i12++;
        }
    ...
    private static void B(D d10, int i10, int i11, int i12, int i13, String str, g gVar) {
        ...
        gVar.f31676b = new t.b().e0(i13).u0(str2).j0(str).y0(j10).g0(lY).N();
    }
    ...
    public static t D(c.b bVar, c.C2018c c2018c, long j10, a3.o oVar, boolean z10, boolean z11) throws ParserException {
        long[] jArr;
        long[] jArr2;
        c.b bVarD;
        Pair<long[], long[]> pairJ;
        c.b bVar2 = (c.b) C13466a.e(bVar.d(1835297121));
        int iD = d(o(((c.C2018c) C13466a.e(bVar2.e(1751411826))).f128078b));
        if (iD == -1) {
            return null;
        }
        j jVarC = C(((c.C2018c) C13466a.e(bVar.e(1953196132))).f128078b);
        long j11 = j10 == -9223372036854775807L ? jVarC.f31688b : j10;
        long j12 = t(c2018c.f128078b).f128083c;
        long jV0 = j11 != -9223372036854775807L ? P.V0(j11, 1000000L, j12) : -9223372036854775807L;
        c.b bVar3 = (c.b) C13466a.e(((c.b) C13466a.e(bVar2.d(1835626086))).d(1937007212));
        d dVarQ = q(((c.C2018c) C13466a.e(bVar2.e(1835296868))).f128078b);
        c.C2018c c2018cE = bVar3.e(1937011556);
        if (c2018cE == null) {
            throw ParserException.a("Malformed sample table (stbl) missing sample description (stsd)", null);
        }
        g gVarA = A(c2018cE.f128078b, jVarC.f31687a, jVarC.f31689c, dVarQ.f31671c, oVar, z11);
        ...
        if (gVarA.f31676b == null) {
            return null;
        }
        return new t(jVarC.f31687a, iD, dVarQ.f31669a, j12, jV0, dVarQ.f31670b, gVarA.f31676b, gVarA.f31678d, gVarA.f31675a, gVarA.f31677c, jArr, jArr2);
    }

    public static List<w> E(c.b bVar, B b10, long j10, a3.o oVar, boolean z10, boolean z11, Be.g<t, t> gVar) throws ParserException {
        t tVarApply;
        ArrayList arrayList = new ArrayList();
        for (int i10 = 0; i10 < bVar.f128077d.size(); i10++) {
            c.b bVar2 = bVar.f128077d.get(i10);
            if (bVar2.f128074a == 1953653099 && (tVarApply = gVar.apply(D(bVar2, (c.C2018c) C13466a.e(bVar.e(1836476516)), j10, oVar, z10, z11))) != null) {
                arrayList.add(y(tVarApply, (c.b) C13466a.e(((c.b) C13466a.e(((c.b) C13466a.e(bVar2.d(1835297121))).d(1835626086))).d(1937007212)), b10));
            }
        }
        return arrayList;
    }

    public static y F(c.C2018c c2018c) {
        D d10 = c2018c.f128078b;
        d10.W(8);
    ...
    private static C5570j f(D d10) {
        C5570j.b bVar = new C5570j.b();
        ...
        for (int i10 = 0; i10 < iH; i10++) {
            ...
            for (int i11 = 0; i11 < iH2; i11++) {
                ...
                if (zG) {
                    ...
                    int iH5 = c10.h(8);
                    c10.s(1);
                    bVar.d(C5570j.j(iH4)).c(c10.g() ? 1 : 2).e(C5570j.k(iH5));
                }
            }
        }
        return bVar.a();
    ...
    */
    ...
    private static C5570j h(D d10) {
        ...
        if (c10.g()) {
            int iH7 = c10.h(8);
            int iH8 = c10.h(8);
            bVar.d(C5570j.j(iH7)).c(((z10 || iH7 != 1 || iH8 != 13 || c10.h(8) != 0) ? c10.h(1) : 1) != 1 ? 2 : 1).e(C5570j.k(iH8));
        }
        return bVar.a();
    }
    ...
    static Pair<Integer, u> i(D d10, int i10, int i11) throws ParserException {
        ...
        C18013s.a(numValueOf != null, "frma atom is mandatory");
        C18013s.a(i13 != -1, "schi atom is mandatory");
        u uVarX = x(d10, i13, i14, strE);
        C18013s.a(uVarX != null, "tenc atom is mandatory");
        return Pair.create(numValueOf, (u) P.h(uVarX));
    }

    private static C0715b k(D d10, int i10) {
        d10.W(i10 + 12);
        d10.X(1);
        l(d10);
        d10.X(2);
        ...
        if ("audio/mpeg".equals(strH) || "audio/vnd.dts".equals(strH) || "audio/vnd.dts.hd".equals(strH)) {
            return new C0715b(strH, null, -1L, -1L);
        }
        d10.X(4);
        long J10 = d10.J();
        long J11 = d10.J();
        ...
        return new C0715b(strH, bArr, j10, J10 > 0 ? J10 : -1L);
    }

    public static int n(int i10) {
        return (i10 >> 24) & l3.f92484c;
    }
    ...
    private static void s(D d10, int i10, int i11, int i12, g gVar) {
        ...
        if (i10 == 1835365492) {
            ...
            String strB = d10.B();
            if (strB != null) {
                gVar.f31676b = new t.b().e0(i12).u0(strB).N();
            }
        }
    }
    ...
    private static int c(D d10, int i10, int i11, int i12) throws ParserException {
        ...
        while (iF - i11 < i12) {
            ...
            C18013s.a(z11, "childAtomSize must be positive");
            if (d10.q() == i10) {
                return iF;
            }
            iF += iQ;
    ...
    private static Pair<long[], long[]> j(c.b bVar) {
        long J10;
        long jQ;
        c.C2018c c2018cE = bVar.e(1701606260);
        if (c2018cE == null) {
            return null;
        }
        D d10 = c2018cE.f128078b;
        d10.W(8);
        int iN = n(d10.q());
        int iL = d10.L();
    ...
    private static int l(D d10) {
        int iH = d10.H();
        int i10 = iH & l3.f92485d;
        while ((iH & 128) == 128) {
            iH = d10.H();
            i10 = (i10 << 7) | (iH & l3.f92485d);
        }
        return i10;
    }
    ...
    public static y r(c.b bVar) {
        c.C2018c c2018cE = bVar.e(1751411826);
        c.C2018c c2018cE2 = bVar.e(1801812339);
        c.C2018c c2018cE3 = bVar.e(1768715124);
        if (c2018cE == null || c2018cE2 == null || c2018cE3 == null || o(c2018cE.f128078b) != 1835299937) {
            return null;
        }
        D d10 = c2018cE2.f128078b;
        d10.W(12);
        int iQ = d10.q();
    ...
    private static Pair<Integer, u> w(D d10, int i10, int i11) throws ParserException {
        ...
        while (iF - i10 < i11) {
            ...
            C18013s.a(z10, "childAtomSize must be positive");
