...
final class j {
    ...
    public static void l(int i10, B b10, t.b bVar) {
        if (i10 == 1 && b10.a()) {
            bVar.Z(b10.f169042a).a0(b10.f169043b);
        }
    }
        ...
        if (yVar != null) {
            for (int i11 = 0; i11 < yVar.e(); i11++) {
                ...
                if (aVarD instanceof e3.b) {
                    ...
                    if (!bVar2.f128070a.equals("com.android.capture.fps")) {
                        yVar2 = yVar2.a(bVar2);
                    } else if (i10 == 2) {
                        yVar2 = yVar2.a(bVar2);
                    }
