...
class a {
    ...
    private boolean d(R5.a aVar, String str, String str2) {
    ...
    File b(String str) {
        ...
        File file = new File(fileO, this.f33238a + File.separator + str);
    ...
    boolean c(String str, String str2, R5.a aVar) throws NoSuchAlgorithmException, SecurityException {
        if (!a(str, str2)) {
            return false;
        }
