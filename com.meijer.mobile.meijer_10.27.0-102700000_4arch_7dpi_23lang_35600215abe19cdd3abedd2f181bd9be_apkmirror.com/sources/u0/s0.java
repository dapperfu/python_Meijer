...
import androidx.compose.ui.platform.InterfaceC5840b1;
...
public final class s0 implements InterfaceC5840b1 {
    ...
    private C17708Q textFieldSelectionManager;
    ...
    private Function1<? super List<? extends InterfaceC18363i>, Unit> onEditCommand = c.f162576f;

    /* renamed from: d, reason: collision with root package name and from kotlin metadata */
    private Function1<? super androidx.compose.ui.text.input.a, Unit> onImeActionPerformed = d.f162577f;
    ...
    private final Lazy baseInputConnection = LazyKt.a(LazyThreadSafetyMode.f142381c, new a());
    ...
    static final class c extends Lambda implements Function1<List<? extends InterfaceC18363i>, Unit> {

        /* renamed from: f, reason: collision with root package name */
        public static final c f162576f = new c();
    ...
    static final class d extends Lambda implements Function1<androidx.compose.ui.text.input.a, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final d f162577f = new d();
    ...
    @Override // androidx.compose.ui.platform.InterfaceC5840b1
    /* renamed from: g, reason: merged with bridge method [inline-methods] */
    public u0 a(EditorInfo outAttributes) {
        C17170A.c(outAttributes, this.state.h(), this.state.getSelection(), this.imeOptions, null, 8, null);
        r0.d(outAttributes);
    ...
    public final void l(TextFieldValue value, q0.a textInputNode, ImeOptions imeOptions, Function1<? super List<? extends InterfaceC18363i>, Unit> onEditCommand, Function1<? super androidx.compose.ui.text.input.a, Unit> onImeActionPerformed) {
        this.state = value;
    ...
    public final void n(TextFieldValue textFieldValue, InterfaceC18354E offsetMapping, TextLayoutResult textLayoutResult, androidx.compose.ui.geometry.Rect innerTextFieldBounds, androidx.compose.ui.geometry.Rect decorationBoxBounds) {
        this.cursorAnchorInfoController.d(textFieldValue, offsetMapping, textLayoutResult, innerTextFieldBounds, decorationBoxBounds);
    }

    public s0(View view, Function1<? super C5331k1, Unit> function1, l0 l0Var) {
        this.view = view;
