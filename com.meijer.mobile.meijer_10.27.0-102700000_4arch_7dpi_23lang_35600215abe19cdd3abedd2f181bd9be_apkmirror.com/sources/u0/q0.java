...
public abstract class q0 implements z1.I {
    ...
    public interface a {
        ...
        C0 h1(Function2<? super InterfaceC5849e1, ? super Continuation<?>, ? extends Object> block);
    ...
    public final void j(a node) {
        if (!(this.textInputModifierNode == null)) {
            C14589e.c("Expected textInputModifierNode to be null");
        }
    ...
    public final void l(a node) {
        if (!(this.textInputModifierNode == node)) {
            C14589e.c("Expected textInputModifierNode to be " + node + " but was " + this.textInputModifierNode);
        }
