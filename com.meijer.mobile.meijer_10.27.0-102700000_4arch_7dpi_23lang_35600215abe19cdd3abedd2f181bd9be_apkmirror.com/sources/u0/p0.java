...
public final class p0 {
    ...
    private final Function1<C5331k1, Unit> localToScreen;
    ...
    private final void c() {
        ...
        C5331k1.h(this.matrix);
        this.localToScreen.invoke(C5331k1.a(this.matrix));
        ...
        Intrinsics.g(rect2);
        C5331k1.n(fArr, f10, -rect2.getTop(), 0.0f);
        ...
        Intrinsics.g(rect4);
        l0Var.e(o0.b(builder, textFieldValue, interfaceC18354E, textLayoutResult, matrix, rect3, rect4, this.includeInsertionMarker, this.includeCharacterBounds, this.includeEditorBounds, this.includeLineBounds));
    ...
    public final void d(TextFieldValue textFieldValue, InterfaceC18354E offsetMapping, TextLayoutResult textLayoutResult, Rect innerTextFieldBounds, Rect decorationBoxBounds) {
        synchronized (this.lock) {
            try {
    ...
    public p0(Function1<? super C5331k1, Unit> function1, l0 l0Var) {
