...
public final class u0 implements InputConnection {
    ...
    private final List<InterfaceC18363i> editCommands = new ArrayList();

    /* renamed from: k, reason: collision with root package name and from kotlin metadata */
    private boolean isActive = true;

    @Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0001\u001a\u00020\u0000H\n¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"Lz1/i;", "it", "", "a", "(Lz1/i;)V"}, k = 3, mv = {1, 9, 0})
    static final class a extends Lambda implements Function1<InterfaceC18363i, Unit> {
        a() {
            super(1);
        }

        public final void a(InterfaceC18363i interfaceC18363i) {
            u0.this.c(interfaceC18363i);
        }

        @Override // kotlin.jvm.functions.Function1
        public /* bridge */ /* synthetic */ Unit invoke(InterfaceC18363i interfaceC18363i) {
            a(interfaceC18363i);
    ...
    public void performHandwritingGesture(HandwritingGesture gesture, Executor executor, IntConsumer consumer) {
        if (Build.VERSION.SDK_INT >= 34) {
            C17184c.f162488a.b(this.legacyTextFieldState, this.textFieldSelectionManager, gesture, this.viewConfiguration, executor, consumer, new a());
        }
    }
    ...
    public boolean previewHandwritingGesture(PreviewableHandwritingGesture gesture, CancellationSignal cancellationSignal) {
        if (Build.VERSION.SDK_INT >= 34) {
            return C17184c.f162488a.d(this.legacyTextFieldState, this.textFieldSelectionManager, gesture, cancellationSignal);
        }
        return false;
    }
    ...
    public u0(TextFieldValue textFieldValue, k0 k0Var, boolean z10, androidx.compose.foundation.text.B b10, C17708Q c17708q, Q1 q12) {
    ...
    public final void c(InterfaceC18363i editCommand) {
        d();
        try {
