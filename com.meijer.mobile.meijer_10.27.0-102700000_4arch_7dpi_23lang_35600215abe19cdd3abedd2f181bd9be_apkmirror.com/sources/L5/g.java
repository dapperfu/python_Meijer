...
public final class g {
    ...
    public static final String i(String filePath) {
        ...
        if (StringsKt.r0(filePath)) {
            return filePath;
        }
        return new Regex(q2.f92724c).k(new Regex("[/\\\\](\\.{2,})").k(new Regex("\\.[/\\\\]").k(filePath, "\\."), "_"), "");
    }
