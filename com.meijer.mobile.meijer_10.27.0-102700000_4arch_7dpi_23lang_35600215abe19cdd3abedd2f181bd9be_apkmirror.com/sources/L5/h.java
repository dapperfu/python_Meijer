...
public final class h {
    ...
    public static final class a extends Lambda implements Function1 {
        ...
        final /* synthetic */ Function1 f17886f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ JSONArray f17887g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(Function1 function1, JSONArray jSONArray) {
            super(1);
            this.f17886f = function1;
            this.f17887g = jSONArray;
        }

        public final Object a(int i10) throws JSONException {
            Function1 function1 = this.f17886f;
            Object obj = this.f17887g.get(i10);
    ...
    public static final /* synthetic */ List a(JSONArray jSONArray, Function1 transform) {
        ...
        return SequencesKt.W(SequencesKt.M(CollectionsKt.f0(RangesKt.x(0, jSONArray.length())), new a(transform, jSONArray)));
    }
