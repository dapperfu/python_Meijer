...
public final class b {
    ...
    private static final class a implements InterfaceC3727a {

        /* renamed from: a, reason: collision with root package name */
        private final SecretKey f30010a;
        ...
        public byte[] b(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
            ...
            Cipher cipher = Cipher.getInstance("AES/GCM/NoPadding");
            cipher.init(2, this.f30010a, gCMParameterSpec);
            cipher.updateAAD(bArr2);
    ...
    public static InterfaceC3727a c(String str) throws GeneralSecurityException {
        return new a(str, d());
    }
