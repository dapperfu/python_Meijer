...
public final class C18264a {
    ...
    public C18264a(SharedPreferences sharedPreferences) {
        Intrinsics.j(sharedPreferences, "sharedPreferences");
        this.sharedPreferences = sharedPreferences;
    }

    public static /* synthetic */ void B(C18264a c18264a, long j10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public static /* synthetic */ void E(C18264a c18264a, long j10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            j10 = System.currentTimeMillis();
        }
        c18264a.D(j10);
    ...
    private final boolean r() {
        if (Instant.now().toEpochMilli() - d() < l8.b.f92527d) {
            return true;
        }
        return false;
    }
