...
public final class a implements l {
    ...
    private static final o[] f15091b = new o[0];

    /* renamed from: a, reason: collision with root package name */
    private final d f15092a = new d();
    ...
    public m a(c cVar, Map<com.google.zxing.d, ?> map) throws NotFoundException, ChecksumException, FormatException {
        ...
        if (map == null || !map.containsKey(com.google.zxing.d.PURE_BARCODE)) {
            g gVarB = new Lg.a(cVar.a()).b();
            e eVarB2 = this.f15092a.b(gVarB.a());
            oVarArrB = gVarB.b();
            eVarB = eVarB2;
        } else {
            eVarB = this.f15092a.b(c(cVar.a()));
            oVarArrB = f15091b;
        }
    ...
    private static int d(int[] iArr, Gg.b bVar) throws NotFoundException {
        int iM = bVar.m();
        int i10 = iArr[0];
        int i11 = iArr[1];
