...
public final class c {
    ...
    public static final Set<Annotation> f134097a = Collections.EMPTY_SET;

    /* renamed from: b, reason: collision with root package name */
    public static final Type[] f134098b = new Type[0];

    /* renamed from: c, reason: collision with root package name */
    public static final Class<?> f134099c;

    /* renamed from: d, reason: collision with root package name */
    private static final Class<? extends Annotation> f134100d;

    /* renamed from: e, reason: collision with root package name */
    private static final Map<Class<?>, Class<?>> f134101e;

    public static final class a implements GenericArrayType {

        /* renamed from: a, reason: collision with root package name */
        private final Type f134102a;
        ...
        public int hashCode() {
            return this.f134102a.hashCode();
        }

        public String toString() {
            return c.v(this.f134102a) + "[]";
        }

        public a(Type type) {
            this.f134102a = c.a(type);
        }
    }
    ...
    public static final class b implements ParameterizedType {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final Type f134103a;

        /* renamed from: b, reason: collision with root package name */
        private final Type f134104b;

        /* renamed from: c, reason: collision with root package name */
        public final Type[] f134105c;
        ...
        public Type[] getActualTypeArguments() {
            return (Type[]) this.f134105c.clone();
        }
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.f134105c) ^ this.f134104b.hashCode()) ^ c.g(this.f134103a);
        }

        public String toString() {
            StringBuilder sb2 = new StringBuilder((this.f134105c.length + 1) * 30);
            sb2.append(c.v(this.f134104b));
            if (this.f134105c.length == 0) {
                return sb2.toString();
            }
            sb2.append("<");
            sb2.append(c.v(this.f134105c[0]));
            for (int i10 = 1; i10 < this.f134105c.length; i10++) {
                sb2.append(", ");
                sb2.append(c.v(this.f134105c[i10]));
            }
            sb2.append(">");
            return sb2.toString();
        }
        ...
        public b(Type type, Type type2, Type... typeArr) {
            ...
            this.f134103a = typeA;
            this.f134104b = c.a(type2);
            this.f134105c = (Type[]) typeArr.clone();
            int i10 = 0;
            while (true) {
                Type[] typeArr2 = this.f134105c;
                if (i10 < typeArr2.length) {
                    typeArr2[i10].getClass();
                    c.b(this.f134105c[i10]);
                    Type[] typeArr3 = this.f134105c;
    ...
    public static final class C2117c implements WildcardType {

        /* renamed from: a, reason: collision with root package name */
        private final Type f134106a;

        /* renamed from: b, reason: collision with root package name */
        private final Type f134107b;
        ...
        public Type[] getLowerBounds() {
            Type type = this.f134107b;
            return type != null ? new Type[]{type} : c.f134098b;
        }

        @Override // java.lang.reflect.WildcardType
        public Type[] getUpperBounds() {
            return new Type[]{this.f134106a};
        }

        public int hashCode() {
            Type type = this.f134107b;
            return (type != null ? type.hashCode() + 31 : 1) ^ (this.f134106a.hashCode() + 31);
        }

        public String toString() {
            if (this.f134107b != null) {
                return "? super " + c.v(this.f134107b);
            }
            if (this.f134106a == Object.class) {
                return "?";
            }
            return "? extends " + c.v(this.f134106a);
        }

        public C2117c(Type[] typeArr, Type[] typeArr2) {
                ...
                if (typeArr.length == 1) {
                    if (typeArr2.length == 1) {
                        ...
                        if (typeArr[0] == Object.class) {
                            this.f134107b = c.a(typeArr2[0]);
                            this.f134106a = Object.class;
                            return;
                        }
    ...
    public static Set<? extends Annotation> l(Annotation[] annotationArr) {
        ...
        return linkedHashSet != null ? Collections.unmodifiableSet(linkedHashSet) : f134097a;
    }
    ...
    static {
        ...
        f134100d = cls;
        f134099c = DefaultConstructorMarker.class;
        ...
        f134101e = Collections.unmodifiableMap(linkedHashMap);
    }
    ...
    public static Type a(Type type) {
        ...
        if (!(type instanceof WildcardType) || (type instanceof C2117c)) {
            return type;
        }
        WildcardType wildcardType = (WildcardType) type;
        return new C2117c(wildcardType.getUpperBounds(), wildcardType.getLowerBounds());
    }
    ...
    public static boolean i(Class<?> cls) {
        Class<? extends Annotation> cls2 = f134100d;
