...
public final class C3764e {
    ...
    private Mv.c serializersModule;

    public C3764e(AbstractC3761b json) {
    ...
    public final JsonConfiguration a() {
        if (this.useArrayPolymorphism) {
            ...
            if (this.classDiscriminatorMode != EnumC3760a.f14394c) {
    ...
    public final Mv.c getSerializersModule() {
