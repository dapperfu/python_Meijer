...
public class C14335d implements L {

    /* renamed from: a, reason: collision with root package name */
    private final Context f134231a;

    /* renamed from: b, reason: collision with root package name */
    private final androidx.media3.exoplayer.mediacodec.g f134232b;

    /* renamed from: e, reason: collision with root package name */
    private boolean f134235e;

    /* renamed from: g, reason: collision with root package name */
    private boolean f134237g;

    /* renamed from: h, reason: collision with root package name */
    private boolean f134238h;

    /* renamed from: i, reason: collision with root package name */
    private boolean f134239i;

    /* renamed from: j, reason: collision with root package name */
    private boolean f134240j;

    /* renamed from: c, reason: collision with root package name */
    private int f134233c = 0;

    /* renamed from: d, reason: collision with root package name */
    private long f134234d = 5000;

    /* renamed from: f, reason: collision with root package name */
    private androidx.media3.exoplayer.mediacodec.l f134236f = androidx.media3.exoplayer.mediacodec.l.f56505a;

    /* renamed from: k, reason: collision with root package name */
    private long f134241k = -9223372036854775807L;

    protected void h(Context context, Handler handler, int i10, ArrayList<H0> arrayList) {
    }

    @Override // h3.L
    public H0[] a(Handler handler, androidx.media3.exoplayer.video.p pVar, androidx.media3.exoplayer.audio.e eVar, InterfaceC16717h interfaceC16717h, o3.b bVar) {
        Handler handler2;
        ArrayList<H0> arrayList = new ArrayList<>();
        k(this.f134231a, this.f134233c, this.f134236f, this.f134235e, handler, pVar, this.f134234d, arrayList);
        AudioSink audioSinkD = d(this.f134231a, this.f134237g, this.f134238h);
        if (audioSinkD != null) {
            handler2 = handler;
            c(this.f134231a, this.f134233c, this.f134236f, this.f134235e, audioSinkD, handler2, eVar, arrayList);
        } else {
            handler2 = handler;
        }
        j(this.f134231a, interfaceC16717h, handler2.getLooper(), this.f134233c, arrayList);
        g(this.f134231a, bVar, handler2.getLooper(), this.f134233c, arrayList);
        e(this.f134231a, this.f134233c, arrayList);
        f(arrayList);
        h(this.f134231a, handler2, this.f134233c, arrayList);
    ...
    protected H0 i(H0 h02, Context context, int i10, androidx.media3.exoplayer.mediacodec.l lVar, boolean z10, Handler handler, androidx.media3.exoplayer.video.p pVar, long j10) {
        if (this.f134239i && h02.getClass() == androidx.media3.exoplayer.video.h.class) {
            return new h.d(context).q(l()).v(lVar).p(j10).r(z10).s(handler).t(pVar).u(50).o(this.f134240j).n(this.f134241k).m();
        }
        return null;
    }

    protected void j(Context context, InterfaceC16717h interfaceC16717h, Looper looper, int i10, ArrayList<H0> arrayList) {
        arrayList.add(new C16718i(interfaceC16717h, looper));
    }
    ...
    */
    protected void k(android.content.Context r15, int r16, androidx.media3.exoplayer.mediacodec.l r17, boolean r18, android.os.Handler r19, androidx.media3.exoplayer.video.p r20, long r21, java.util.ArrayList<androidx.media3.exoplayer.H0> r23) {
        ...
        Lfa:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: h3.C14335d.k(android.content.Context, int, androidx.media3.exoplayer.mediacodec.l, boolean, android.os.Handler, androidx.media3.exoplayer.video.p, long, java.util.ArrayList):void");
    }
    ...
    protected InterfaceC15547c.a m() {
        return InterfaceC15547c.a.f149804a;
    }

    public C14335d(Context context) {
        this.f134231a = context;
        this.f134232b = new androidx.media3.exoplayer.mediacodec.g(context);
    }

    @Override // h3.L
    public H0 b(H0 h02, Handler handler, androidx.media3.exoplayer.video.p pVar, androidx.media3.exoplayer.audio.e eVar, InterfaceC16717h interfaceC16717h, o3.b bVar) {
        if (h02.g() == 2) {
            return i(h02, this.f134231a, this.f134233c, this.f134236f, this.f134235e, handler, pVar, this.f134234d);
        }
        return null;
    }
}
