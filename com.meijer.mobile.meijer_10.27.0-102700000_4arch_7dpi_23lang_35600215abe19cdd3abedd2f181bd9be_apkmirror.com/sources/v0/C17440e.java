...
public final class C17440e {
    ...
    public /* synthetic */ C17440e(AnnotatedString annotatedString, TextStyle textStyle, AbstractC18142l.b bVar, int i10, boolean z10, int i11, int i12, List list, L l10, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    private C17440e(AnnotatedString annotatedString, TextStyle textStyle, AbstractC18142l.b bVar, int i10, boolean z10, int i11, int i12, List<AnnotatedString.Range<Placeholder>> list, L l10) {
    ...
    private final long q(long constraints, t layoutDirection) {
        C17438c.Companion companion = C17438c.INSTANCE;
        C17438c c17438c = this.mMinLinesConstrainer;
        TextStyle textStyle = this.style;
        H1.d dVar = this.density;
        Intrinsics.g(dVar);
        C17438c c17438cA = companion.a(c17438c, layoutDirection, textStyle, dVar, this.fontFamilyResolver);
    ...
    public final void p(AnnotatedString text, TextStyle style, AbstractC18142l.b fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines, List<AnnotatedString.Range<Placeholder>> placeholders, L autoSize) {
        this.text = text;
        n(style);
    ...
    private final androidx.compose.ui.text.g e(long constraints, t layoutDirection) {
        ...
        return new androidx.compose.ui.text.g(hVarM, C17437b.a(constraints, this.softWrap, this.overflow, hVarM.c()), C17437b.b(this.softWrap, this.overflow, this.maxLines), this.overflow, null);
    }
