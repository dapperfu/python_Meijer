...
public class C17444i {

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);

    /* renamed from: d, reason: collision with root package name */
    public static final int f164298d = 8;

    /* renamed from: e, reason: collision with root package name */
    private static final C17444i f164299e = new C17444i(null, null);
    ...
    public static final class Companion {
        ...
        public final C17444i a() {
            return C17444i.f164299e;
        }
    }

    public static /* synthetic */ C17444i c(C17444i c17444i, LayoutCoordinates layoutCoordinates, TextLayoutResult textLayoutResult, int i10, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: copy");
        }
        if ((i10 & 1) != 0) {
            layoutCoordinates = c17444i.layoutCoordinates;
        }
        if ((i10 & 2) != 0) {
            textLayoutResult = c17444i.textLayoutResult;
        }
        return c17444i.b(layoutCoordinates, textLayoutResult);
    }

    public final C17444i b(LayoutCoordinates layoutCoordinates, TextLayoutResult textLayoutResult) {
        return new C17444i(layoutCoordinates, textLayoutResult);
    }
    ...
    public C17444i(LayoutCoordinates layoutCoordinates, TextLayoutResult textLayoutResult) {
