...
public final class M0 {
    ...
    static final class a extends CameraCaptureSession.StateCallback {
        ...
        private final List<CameraCaptureSession.StateCallback> f163822a = new ArrayList();

        @Override // android.hardware.camera2.CameraCaptureSession.StateCallback
        public void onActive(CameraCaptureSession cameraCaptureSession) {
            Iterator<CameraCaptureSession.StateCallback> it = this.f163822a.iterator();
            while (it.hasNext()) {
        ...
        public void onCaptureQueueEmpty(CameraCaptureSession cameraCaptureSession) {
            Iterator<CameraCaptureSession.StateCallback> it = this.f163822a.iterator();
            while (it.hasNext()) {
                C17674e.a(it.next(), cameraCaptureSession);
            }
        }
        ...
        public void onSurfacePrepared(CameraCaptureSession cameraCaptureSession, Surface surface) {
            Iterator<CameraCaptureSession.StateCallback> it = this.f163822a.iterator();
            while (it.hasNext()) {
                C17671b.a(it.next(), cameraCaptureSession, surface);
            }
        }
        ...
        a(List<CameraCaptureSession.StateCallback> list) {
            for (CameraCaptureSession.StateCallback stateCallback : list) {
                if (!(stateCallback instanceof b)) {
                    this.f163822a.add(stateCallback);
                }
            }
        }
    }
