...
public final class X {
    ...
    static final class a extends Lambda implements Function4<Integer, Integer, Integer, Integer, Unit> {
        ...
        final /* synthetic */ y f29472f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ ViewStructure f29473g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(y yVar, ViewStructure viewStructure) {
            super(4);
            this.f29472f = yVar;
            this.f29473g = viewStructure;
        }

        public final void a(int i10, int i11, int i12, int i13) {
            this.f29472f.r(this.f29473g, i10, i11, 0, 0, i12 - i10, i13 - i11);
        }
    ...
    */
    public static final void a(android.view.ViewStructure r38, r1.InterfaceC16702j r39, android.view.autofill.AutofillId r40, java.lang.String r41, s1.b r42) {
        /*
