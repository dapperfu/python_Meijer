...
public final class e {
    ...
    static final /* synthetic */ KProperty<Object>[] f40496g = {Reflection.k(new PropertyReference2Impl(e.class, "dataStore", "getDataStore(Landroid/content/Context;)Landroidx/datastore/core/DataStore;", 0))};

    /* renamed from: f, reason: collision with root package name and from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);

    /* renamed from: h, reason: collision with root package name */
    private static final f.a<Boolean> f40497h = i.a("migrated");

    /* renamed from: i, reason: collision with root package name */
    private static final r<KeyGenParameterSpec> f40498i = new r<>(new Function0() { // from class: Ys.a
    ...
    private static final r<h> f40499j = new r<>(new Function0() { // from class: Ys.b
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            return e.q();
        }
    ...
    public static final class Companion {
        ...
        public final n d(KeyGenParameterSpec keyGenParameterSpec) {
            AbstractC3761b abstractC3761bB = j.INSTANCE.b();
            p pVar = p.f31384a;
            return new n(abstractC3761bB, pVar.C(), pVar.A(), Ss.a.f34693a.a(), keyGenParameterSpec);
        }

        public final KeyGenParameterSpec b() {
            return (KeyGenParameterSpec) e.f40498i.a(this, f40505a[0]);
        }

        public final h c() {
            return (h) e.f40499j.a(this, f40505a[1]);
        }
    }
    ...
    static final class b extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f40506a = obj;
            this.f40508c |= Integer.MIN_VALUE;
    ...
    static final class d extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f40516b = obj;
            this.f40518d |= Integer.MIN_VALUE;
    ...
    static final class C0870e extends SuspendLambda implements Function2<F2.c, Continuation<? super Unit>, Object> {

        /* renamed from: a, reason: collision with root package name */
        int f40519a;

        /* renamed from: b, reason: collision with root package name */
        /* synthetic */ Object f40520b;

        C0870e(Continuation<? super C0870e> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C0870e c0870e = new C0870e(continuation);
            c0870e.f40520b = obj;
            return c0870e;
        }
        ...
        public final Object invoke(F2.c cVar, Continuation<? super Unit> continuation) {
            return ((C0870e) create(cVar, continuation)).invokeSuspend(Unit.f142422a);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f40519a == 0) {
                ResultKt.b(obj);
                ((F2.c) this.f40520b).i(e.f40497h, Boxing.a(true));
    ...
    private final InterfaceC2943h<f> l(Context context) {
        return (InterfaceC2943h) this.dataStore.getValue(context, f40496g[0]);
    }
    ...
    public static final KeyGenParameterSpec p() {
        KeyGenParameterSpec AES256_GCM_SPEC = androidx.security.crypto.e.f58698a;
    ...
    */
    public final java.lang.Object o(kotlin.coroutines.Continuation<? super java.lang.Boolean> r5) {
        ...
        L13:
            ...
            r0.<init>(r5)
        L18:
            java.lang.Object r5 = r0.f40506a
        ...
        L31:
            ...
            tv.f r5 = r5.getData()
            r0.f40508c = r3
            java.lang.Object r5 = tv.C17154h.C(r5, r0)
            if (r5 != r1) goto L49
            return r1
        L49:
            F2.f r5 = (F2.f) r5
            if (r5 == 0) goto L5f
            F2.f$a<java.lang.Boolean> r0 = Ys.e.f40497h
    ...
    */
    public final java.lang.Object s(kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        ...
        L2f:
            ...
            throw r7
        L37:
            java.lang.Object r2 = r0.f40515a
            Ys.e r2 = (Ys.e) r2
            kotlin.ResultKt.b(r7)
            goto L69
        L3f:
