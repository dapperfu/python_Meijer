...
@Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0000\n\u0002\u0010\u0007\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\u001aM\u0010\r\u001a\u00020\f*\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00012\u0006\u0010\u0004\u001a\u00020\u00032\b\b\u0002\u0010\u0006\u001a\u00020\u00052\f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00050\u00072\u0006\u0010\n\u001a\u00020\t2\u0006\u0010\u000b\u001a\u00020\tH\u0007¢\u0006\u0004\b\r\u0010\u000e¨\u0006\u000f"}, d2 = {"LJi/M;", "Landroidx/compose/ui/Modifier;", "modifier", "LH1/h;", "height", "LV0/q0;", "backgroundIndicatorColor", "", "gradientColors", "", "progressValue", "totalValue", "", "c", "(LJi/M;Landroidx/compose/ui/Modifier;FJLjava/util/List;FFLandroidx/compose/runtime/Composer;II)V", "common_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class C18297x {
    ...
    */
    public static final void c(final Ji.LocalThemeScope r19, androidx.compose.ui.Modifier r20, final float r21, long r22, final java.util.List<V0.C5346q0> r24, final float r25, final float r26, androidx.compose.runtime.Composer r27, final int r28, final int r29) {
        /*
            Method dump skipped, instructions count: 581
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: yr.C18297x.c(Ji.M, androidx.compose.ui.Modifier, float, long, java.util.List, float, float, androidx.compose.runtime.Composer, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit d(float f10, long j10, float f11, float f12, List list, X0.f Canvas) {
        ...
        long jE = U0.f.e((Float.floatToRawIntBits(fI1) << 32) | (Float.floatToRawIntBits(fI12) & 4294967295L));
        float fIntBitsToFloat2 = Float.intBitsToFloat((int) (Canvas.b() >> 32)) - (Canvas.I1(f10) / f13);
        float fI13 = Canvas.I1(f10) / f13;
        X0.f.O0(Canvas, j10, jE, U0.f.e((Float.floatToRawIntBits(fI13) & 4294967295L) | (Float.floatToRawIntBits(fIntBitsToFloat2) << 32)), fIntBitsToFloat, iB, null, 0.0f, null, 0, 480, null);
        if (f11 > 0.0f) {
            float fIntBitsToFloat3 = (f11 / f12) * Float.intBitsToFloat((int) (Canvas.b() >> 32));
            AbstractC5324i0 abstractC5324i0B = AbstractC5324i0.Companion.b(AbstractC5324i0.INSTANCE, list, 0L, 0L, 0, 14, null);
            int iB2 = companion.b();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit e(LocalThemeScope localThemeScope, Modifier modifier, float f10, long j10, List list, float f11, float f12, int i10, int i11, Composer composer, int i12) {
        c(localThemeScope, modifier, f10, j10, list, f11, f12, composer, J0.a(i10 | 1), i11);
        return Unit.f142422a;
    }
}
