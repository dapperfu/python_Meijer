...
public final class k {
    ...
    static final class a implements Function2<Composer, Integer, Unit> {
        ...
        public final void a(Composer composer, int i10) {
            ...
            P0.i(this.f9138a, N.f151529a, this.f9139b, C.f.d.f15507e, C16193g.c(C14732c.f138023f, composer, 0), null, false, false, 0L, composer, 3120, 240);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class b implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f9140a;
        ...
        public final void a(Composer composer, int i10) {
            ...
            LocalThemeScope localThemeScope = this.f9140a;
            if (this.f9141b) {
                if (this.f9142c) {
                    wVar = p.f9179a;
                } else {
                    ...
                    if (num == null) {
                        ...
                        int i11 = this.f9144e;
                        if (num != null && num.intValue() == i11 && this.f9145f) {
                            wVar = r.f9181a;
                        } else {
                            Integer num2 = this.f9143d;
                            int i12 = this.f9144e;
                            if (num2 != null && num2.intValue() == i12 && this.f9146g) {
                                wVar = t.f9183a;
                            } else {
                                Integer num3 = this.f9143d;
                                wVar = (num3 != null && num3.intValue() == this.f9144e) ? s.f9182a : (this.f9143d.intValue() >= this.f9144e && this.f9143d.intValue() > this.f9144e) ? p.f9179a : v.f9185a;
                            }
                        }
                    }
                }
                ...
                Integer num4 = this.f9143d;
                if (num4 == null) {
                    wVar = u.f9184a;
                } else {
                    int i13 = this.f9144e;
                    if (num4 != null && num4.intValue() == i13 && this.f9145f) {
                        wVar = r.f9181a;
                    } else {
                        Integer num5 = this.f9143d;
                        int i14 = this.f9144e;
                        if (num5 != null && num5.intValue() == i14 && this.f9146g) {
                            wVar = t.f9183a;
                        } else {
                            Integer num6 = this.f9143d;
                            wVar = (num6 != null && num6.intValue() == this.f9144e) ? q.f9180a : (this.f9143d.intValue() >= this.f9144e && this.f9143d.intValue() > this.f9144e) ? o.f9178a : u.f9184a;
                        }
                    }
                }
            }
            k.y(localThemeScope, wVar, this.f9144e, composer, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class c implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Integer f9149c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ int f9150d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ boolean f9151e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ boolean f9152f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f9153g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ boolean f9154h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ List<String> f9155i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ String f9156j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ r0 f9157k;

        /* renamed from: l, reason: collision with root package name */
        final /* synthetic */ int f9158l;
        ...
        public final void b(Composer composer, int i10) {
            ...
            String strC = C16193g.c(this.f9147a, composer, 0);
            String strC2 = C16193g.c(this.f9148b, composer, 0);
            Integer num = this.f9149c;
            int i11 = this.f9150d;
            if (num != null && num.intValue() == i11 && this.f9151e) {
                str = strC2;
            } else {
                Integer num2 = this.f9149c;
                int i12 = this.f9150d;
                if (num2 == null || num2.intValue() != i12 || !this.f9152f) {
                    strC = "";
                }
                str = strC;
            }
            LocalThemeScope localThemeScope = this.f9153g;
            I two = localThemeScope.getAdsTypography().getBodyCompact().getTwo();
            if (this.f9154h) {
                adsColorText01 = this.f9153g.getAdsColors().getAdsColorText01();
            } else {
                Integer num3 = this.f9149c;
                adsColorText01 = (num3 != null && this.f9150d <= num3.intValue()) ? this.f9153g.getAdsColors().getAdsColorText01() : this.f9153g.getAdsColors().getAdsColorsDisabled();
            }
            Modifier.Companion companion = Modifier.INSTANCE;
            composer.startReplaceGroup(-1224400529);
            boolean zV = composer.V(str) | composer.d(this.f9150d) | composer.D(this.f9155i) | composer.V(this.f9156j) | composer.V(this.f9149c);
            final int i13 = this.f9150d;
            final List<String> list = this.f9155i;
            final String str2 = this.f9156j;
            final Integer num4 = this.f9149c;
            Object objB = composer.B();
            if (zV || objB == Composer.INSTANCE.a()) {
                Object obj = new Function1() { // from class: Ei.l
            ...
            composer.P();
            ri.j.h(localThemeScope, new q1.Label(J.s(C16705m.d(companion, false, (Function1) objB, 1, null), this.f9157k.K(this.f9158l)), adsColorText01, null, F1.j.h(F1.j.INSTANCE.a()), 0, false, 0, two, null, 372, null), this.f9156j, null, composer, 0, 4);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class d implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ z1<Float> f9159a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f9160b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ r0 f9161c;
        ...
        public final void b(Composer composer, int i10) {
            ...
            float fFloatValue = this.f9159a.getValue().floatValue();
            long color = this.f9160b.getAdsColors().getAdsColorsDisabled().getColor();
            long color2 = this.f9160b.getAdsColors().getAdsColorBrandPrimary().getColor();
            float fK = this.f9161c.K(this.f9162d);
            float f10 = k.f9136a;
            Modifier.Companion companion = Modifier.INSTANCE;
            composer.startReplaceGroup(1849434622);
            Object objB = composer.B();
            if (objB == Composer.INSTANCE.a()) {
                objB = new Function1() { // from class: Ei.m
                    @Override // kotlin.jvm.functions.Function1
            ...
            composer.P();
            k.o(fFloatValue, C16705m.d(companion, false, (Function1) objB, 1, null), color2, fK, f10, color, composer, 24576, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class e implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Function2<Composer, Integer, Unit> f9163a;

        /* JADX WARN: Multi-variable type inference failed */
        e(Function2<? super Composer, ? super Integer, Unit> function2) {
            this.f9163a = function2;
        }
        ...
        public final void a(Composer composer, int i10) {
            ...
            Function2<Composer, Integer, Unit> function2 = this.f9163a;
            if (function2 != null) {
    ...
    static final class f implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ BorderSpec f9165b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f9166c;
        ...
        f(long j10, BorderSpec borderSpec, LocalThemeScope localThemeScope, long j11, int i10, float f10) {
            this.f9164a = j10;
            this.f9165b = borderSpec;
            this.f9166c = localThemeScope;
            this.f9167d = j11;
            this.f9168e = i10;
            this.f9169f = f10;
        }
        ...
        public final void a(Composer composer, int i10) {
            ...
            Modifier modifierD = androidx.compose.foundation.b.d(T0.e.a(J.o(modifierE, H1.h.p(20)), C16692i.f()), this.f9164a, null, 2, null);
            if (this.f9165b.getHasBorder()) {
                modifierE = C13439f.e(modifierE, C13442i.a(this.f9165b.getBorderWidth(), this.f9165b.getBorderColor()), C16692i.f());
            }
            Modifier modifierThen = modifierD.then(modifierE);
            LocalThemeScope localThemeScope = this.f9166c;
            long j10 = this.f9167d;
            int i11 = this.f9168e;
            float f10 = this.f9169f;
    ...
    */
    public static final void k(final Ji.LocalThemeScope r33, final java.util.List<java.lang.String> r34, final java.lang.Integer r35, androidx.compose.ui.Modifier r36, boolean r37, boolean r38, boolean r39, boolean r40, int r41, int r42, kotlin.jvm.functions.Function0<kotlin.Unit> r43, androidx.compose.runtime.Composer r44, final int r45, final int r46, final int r47) {
        /*
            Method dump skipped, instructions count: 1032
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: Ei.k.k(Ji.M, java.util.List, java.lang.Integer, androidx.compose.ui.Modifier, boolean, boolean, boolean, boolean, int, int, kotlin.jvm.functions.Function0, androidx.compose.runtime.Composer, int, int, int):void");
    }
    ...
    public static final androidx.compose.ui.layout.J l(final Function0 function0, final int i10, List list, final List list2, final List list3, LocalThemeScope localThemeScope, boolean z10, boolean z11, Integer num, boolean z12, boolean z13, int i11, int i12, z1 z1Var, r0 r0Var, H1.b bVar) {
        ...
        objectRef.f142835a = CollectionsKt.m();
        ...
        if (function0 != null) {
            ...
            objectRef.f142835a = arrayList;
            intRef2.f142833a = !((Collection) arrayList).isEmpty() ? ((f0) CollectionsKt.s0((List) objectRef.f142835a)).M0() : 0;
            iI1 = (int) SubcomposeLayout.I1(H1.h.p(f10));
            intRef.f142833a = (int) SubcomposeLayout.I1(H1.h.p(6));
        } else {
            iI1 = 0;
        }
        int i14 = iI1 * 2;
        int i15 = iI12 * 2;
        int i16 = ((((iL - (intRef2.f142833a * 2)) - i14) - i15) - ((i10 - 1) * iI12)) / i10;
        List list4 = list;
        ...
        int i23 = iL - ((((((int) (dM0 / 2.0d)) + i13) + (intRef2.f142833a * 2)) + i15) + i14);
        ...
        final long j10 = jA;
        return K.G0(r0Var, iL, i18 + iMax2 + intRef.f142833a, null, new Function1() { // from class: Ei.c
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj2) {
    ...
    public static final Unit m(List list, int i10, long j10, Ref.IntRef intRef, List list2, int i11, int i12, List list3, Function0 function0, Ref.ObjectRef objectRef, Ref.IntRef intRef2, int i13, f0.a aVar) {
        ...
        while (it.hasNext()) {
            ...
            f0.a.l(layout, f0Var, iM0, ((i14 / 2) - (f0Var.getHeight() / 2)) + intRef.f142833a, 0.0f, 4, null);
            int i15 = 0;
            for (Object obj : list2) {
                ...
                int i18 = i15;
                f0.a.l(aVar, f0Var2, width, intRef.f142833a, 0.0f, 4, null);
                if (i18 < list3.size()) {
                    int width2 = (width + i12) - ((int) (((f0) list3.get(i18)).getWidth() / 2));
                    if (i18 != 0 || function0 == null || ((Collection) objectRef.f142835a).isEmpty()) {
                        c10 = 2;
                    } else {
                        c10 = 2;
                        f0.a.l(aVar, (f0) CollectionsKt.s0((List) objectRef.f142835a), (width2 - intRef2.f142833a) - i13, 0, 0.0f, 4, null);
                    }
                    f0.a.l(aVar, (f0) list3.get(i18), width2, i14 + intRef.f142833a, 0.0f, 4, null);
                } else {
                    c10 = 2;
                }
                i15 = i16;
    ...
    */
    public static final void o(final float r26, androidx.compose.ui.Modifier r27, long r28, float r30, float r31, long r32, androidx.compose.runtime.Composer r34, final int r35, final int r36) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: Ei.k.o(float, androidx.compose.ui.Modifier, long, float, float, long, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    */
    private static final void r(androidx.compose.ui.Modifier r20, final float r21, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r22, androidx.compose.runtime.Composer r23, final int r24, final int r25) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: Ei.k.r(androidx.compose.ui.Modifier, float, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static final void s(final Ji.LocalThemeScope r16, androidx.compose.ui.Modifier r17, final float r18, final int r19, final long r20, final long r22, final Ei.BorderSpec r24, androidx.compose.runtime.Composer r25, final int r26, final int r27) {
        /*
            Method dump skipped, instructions count: 329
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: Ei.k.s(Ji.M, androidx.compose.ui.Modifier, float, int, long, long, Ei.n, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void u(final LocalThemeScope localThemeScope, final long j10, final int i10, final float f10, Composer composer, final int i11) {
        ...
        if ((i12 & 1171) == 1170 && composerStartRestartGroup.j()) {
            ...
            ri.j.h(localThemeScope, new q1.Label(J.i(J.z(Modifier.INSTANCE, f10), H1.h.p(0.9f * f10)), null, null, null, 0, false, 0, (I) objB, null, 382, null), strValueOf, null, composerStartRestartGroup, i13, 4);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
        ...
        if (t0L != null) {
            t0L.a(new Function2() { // from class: Ei.i
                @Override // kotlin.jvm.functions.Function2
    ...
    public static final void y(LocalThemeScope localThemeScope, final w wVar, int i10, Composer composer, final int i11) {
        ...
        if ((i12 & 147) == 146 && composerStartRestartGroup.j()) {
            ...
            if (Intrinsics.e(wVar, o.f9178a)) {
                composerStartRestartGroup.startReplaceGroup(68063174);
                C16307b.b(localThemeScope2, new q1.h.DrawableIcon(C.i.a.f15548d, null, null, null, 0.0f, null, null, 126, null), null, null, composerStartRestartGroup, i12 & 14, 6);
                composerStartRestartGroup.P();
                localThemeScope2 = localThemeScope;
                i13 = i10;
            } else {
                if (Intrinsics.e(wVar, p.f9179a)) {
                    ...
                    composerStartRestartGroup.P();
                } else if (Intrinsics.e(wVar, q.f9180a)) {
                    composerStartRestartGroup.startReplaceGroup(68080775);
                    localThemeScope2 = localThemeScope;
                    C16307b.b(localThemeScope2, new q1.h.DrawableIcon(C.i.d.f15551d, null, null, null, 0.0f, null, null, 126, null), null, null, composerStartRestartGroup, i12 & 14, 6);
                    composerStartRestartGroup.P();
                } else if (Intrinsics.e(wVar, s.f9182a)) {
                    composerStartRestartGroup.startReplaceGroup(68087429);
                    i13 = i10;
                    localThemeScope2 = localThemeScope;
                    s(localThemeScope2, Modifier.INSTANCE, H1.h.p(24), i13, C5346q0.INSTANCE.k(), localThemeScope.getAdsColors().getAdsColorBrandPrimary().getColor(), new BorderSpec(true, H1.h.p(2), localThemeScope.getAdsColors().getAdsColorBrandPrimary().getColor(), null), composerStartRestartGroup, (i12 & 14) | 25008 | ((i12 << 3) & 7168), 0);
                    composerStartRestartGroup = composerStartRestartGroup;
                    composerStartRestartGroup.P();
                } else if (Intrinsics.e(wVar, r.f9181a)) {
                    composerStartRestartGroup.startReplaceGroup(68101667);
                    localThemeScope2 = localThemeScope;
                    C16307b.b(localThemeScope2, new q1.h.DrawableIcon(C.i.e.f15552d, null, null, null, 0.0f, null, null, 126, null), null, null, composerStartRestartGroup, i12 & 14, 6);
                    composerStartRestartGroup.P();
                } else if (Intrinsics.e(wVar, t.f9183a)) {
                    composerStartRestartGroup.startReplaceGroup(68107973);
                    localThemeScope2 = localThemeScope;
                    C16307b.b(localThemeScope2, new q1.h.DrawableIcon(C.i.n.f15565d, null, null, null, 0.0f, null, null, 126, null), null, null, composerStartRestartGroup, i12 & 14, 6);
                    composerStartRestartGroup.P();
                } else if (Intrinsics.e(wVar, u.f9184a)) {
                    composerStartRestartGroup.startReplaceGroup(2111540915);
                    localThemeScope2 = localThemeScope;
                    C16307b.b(localThemeScope2, new q1.h.DrawableIcon(C.i.g.f15556d, null, null, null, 0.0f, null, null, 126, null), null, null, composerStartRestartGroup, i12 & 14, 6);
                    composerStartRestartGroup.P();
                } else {
                    if (!Intrinsics.e(wVar, v.f9185a)) {
                    ...
                    i13 = i10;
                    localThemeScope2 = localThemeScope;
                    s(localThemeScope2, Modifier.INSTANCE, H1.h.p(24), i13, C5346q0.INSTANCE.k(), localThemeScope.getAdsColors().getAdsColorsDisabled().getColor(), new BorderSpec(true, H1.h.p(1), localThemeScope.getAdsColors().getAdsColorsDisabled().getColor(), null), composerStartRestartGroup, (i12 & 14) | 25008 | ((i12 << 3) & 7168), 0);
                    composerStartRestartGroup = composerStartRestartGroup;
                    composerStartRestartGroup.P();
                }
                i13 = i10;
        ...
        T0 t0L = composerStartRestartGroup.l();
        if (t0L != null) {
            t0L.a(new Function2() { // from class: Ei.d
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
    ...
    private static final void E(X0.f fVar, float f10, float f11, long j10, float f12) {
        ...
        if (fVar.getLayoutDirection() == H1.t.f12006a) {
            z10 = true;
        } else {
            z10 = false;
        }
