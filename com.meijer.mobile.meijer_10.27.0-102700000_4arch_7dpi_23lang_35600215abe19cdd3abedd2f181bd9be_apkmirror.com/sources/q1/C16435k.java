...
import q1.ScrollCaptureCallbackC16427c;
import qv.C16623P;
import r1.C16708p;
...
public final class C16435k implements ScrollCaptureCallbackC16427c.a {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC5730l0 scrollCaptureInProgress = t1.e(Boolean.FALSE, null, 2, null);
    ...
    /* synthetic */ class a extends AdaptedFunctionReference implements Function1<ScrollCaptureCandidate, Unit> {
        ...
        public final void a(ScrollCaptureCandidate scrollCaptureCandidate) {
            ((D0.c) this.f142801a).c(scrollCaptureCandidate);
        }
    ...
    @Override // q1.ScrollCaptureCallbackC16427c.a
    public void a() {
        e(true);
    }
    ...
    static final class b extends Lambda implements Function1<ScrollCaptureCandidate, Comparable<?>> {
        ...
        public static final b f156687f = new b();
    ...
    static final class c extends Lambda implements Function1<ScrollCaptureCandidate, Comparable<?>> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final c f156688f = new c();
    ...
    public final void d(View view, C16708p semanticsOwner, CoroutineContext coroutineContext, Consumer<ScrollCaptureTarget> targets) {
        D0.c cVar = new D0.c(new ScrollCaptureCandidate[16], 0);
        m.e(semanticsOwner.d(), 0, new a(cVar), 2, null);
        cVar.A(ComparisonsKt.b(b.f156687f, c.f156688f));
        ...
        ScrollCaptureCallbackC16427c scrollCaptureCallbackC16427c = new ScrollCaptureCallbackC16427c(scrollCaptureCandidate.getNode(), scrollCaptureCandidate.getViewportBoundsInWindow(), C16623P.a(coroutineContext), this, view);
        ...
        ScrollCaptureTarget scrollCaptureTargetA = C16434j.a(view, w1.a(q.b(rectA)), new Point(n.k(jI), n.l(jI)), C16432h.a(scrollCaptureCallbackC16427c));
