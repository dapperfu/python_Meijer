...
public final class a {
    ...
    static final class C0279a implements g {

        /* renamed from: a, reason: collision with root package name */
        private final /* synthetic */ Function1 f16263a;
    ...
    public static final class b extends Lambda implements Function1<F, E> {
        ...
        final /* synthetic */ Object f16264f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ InterfaceC5730l0 f16265g;
        ...
        public static final class C0280a<R> extends Lambda implements Function1<R, Unit> {

            /* renamed from: f, reason: collision with root package name */
            final /* synthetic */ InterfaceC5730l0 f16266f;

            /* JADX WARN: Multi-variable type inference failed */
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(Object obj) {
                invoke2((C0280a<R>) obj);
                return Unit.f142422a;
            }

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C0280a(InterfaceC5730l0 interfaceC5730l0) {
                super(1);
                this.f16266f = interfaceC5730l0;
            }

            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(R r10) {
                this.f16266f.setValue(r10);
            }
        }
        ...
        public static final class C0281b implements E {
            ...
            /* renamed from: a, reason: collision with root package name */
            final /* synthetic */ Nu.b f16267a;

            public C0281b(Nu.b bVar) {
                this.f16267a = bVar;
            }

            @Override // androidx.compose.runtime.E
            public void dispose() {
                this.f16267a.dispose();
            }
        }

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public b(Object obj, InterfaceC5730l0 interfaceC5730l0) {
            super(1);
            this.f16264f = obj;
            this.f16265g = interfaceC5730l0;
        }

        @Override // kotlin.jvm.functions.Function1
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final E invoke(F f10) {
            return new C0281b(((l) this.f16264f).subscribe(new C0279a(new C0280a(this.f16265g))));
        }
    }
    ...
    public static final <R, T extends R> z1<R> a(l<T> lVar, R r10, Composer composer, int i10) {
        ...
        J.c(lVar, new b(lVar, interfaceC5730l0), composer, i11 & 14);
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
