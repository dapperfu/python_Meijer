...
public final class a {
    ...
    private static final RetrofitException b(ApolloHttpException apolloHttpException) throws IOException {
        ...
        InterfaceC15330g body = apolloHttpException.getBody();
        if (body != null) {
            Charset charsetDefaultCharset = Charset.defaultCharset();
            Intrinsics.i(charsetDefaultCharset, "defaultCharset(...)");
            strH2 = body.H2(charsetDefaultCharset);
        } else {
            strH2 = null;
        }
        if (strH2 == null) {
        ...
        Response responseError = Response.error(statusCode, ResponseBody.Companion.i(companion, strH2, null, 1, null));
        int statusCode2 = apolloHttpException.getStatusCode();
        return new RetrofitException(message, null, responseError, (statusCode2 == 401 || statusCode2 == 403) ? RetrofitException.b.f96148h : RetrofitException.b.f96143c, apolloHttpException, null);
    }
    ...
    private static final RetrofitException c(ApolloNetworkException apolloNetworkException) {
        ...
        RetrofitException.b bVar = RetrofitException.b.f96142b;
    ...
    private static final RetrofitException d(ApolloWebSocketClosedException apolloWebSocketClosedException) {
        ...
        return new RetrofitException(RetrofitException.b.f96145e, apolloWebSocketClosedException.getCause());
    }
}
