...
final class l implements X, m {
    ...
    @Metadata(d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0006\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\n\n\u0002\u0010\u000b\n\u0002\b\u0010\b\u0082\u0004\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0001¢\u0006\u0004\b\u0003\u0010\u0004J\u001f\u0010\n\u001a\u00020\t2\u0006\u0010\u0006\u001a\u00020\u00052\u0006\u0010\b\u001a\u00020\u0007H\u0016¢\u0006\u0004\b\n\u0010\u000bJ\u001f\u0010\r\u001a\u00020\t2\u0006\u0010\u0006\u001a\u00020\u00052\u0006\u0010\b\u001a\u00020\fH\u0016¢\u0006\u0004\b\r\u0010\u000eJ\u001f\u0010\u0010\u001a\u00020\t2\u0006\u0010\u0006\u001a\u00020\u00052\u0006\u0010\b\u001a\u00020\u000fH\u0016¢\u0006\u0004\b\u0010\u0010\u0011J\u0017\u0010\u0012\u001a\u00020\t2\u0006\u0010\u0006\u001a\u00020\u0005H\u0016¢\u0006\u0004\b\u0012\u0010\u0013J\u0017\u0010\u0014\u001a\u00020\u00072\u0006\u0010\u0006\u001a\u00020\u0005H\u0016¢\u0006\u0004\b\u0014\u0010\u0015J\u0017\u0010\u0016\u001a\u00020\f2\u0006\u0010\u0006\u001a\u00020\u0005H\u0016¢\u0006\u0004\b\u0016\u0010\u0017J\u0017\u0010\u0018\u001a\u00020\u000f2\u0006\u0010\u0006\u001a\u00020\u0005H\u0016¢\u0006\u0004\b\u0018\u0010\u0019J\u0017\u0010\u001b\u001a\u00020\u001a2\u0006\u0010\u0006\u001a\u00020\u0005H\u0016¢\u0006\u0004\b\u001b\u0010\u001cJ\u000f\u0010\u001d\u001a\u00020\u0005H\u0016¢\u0006\u0004\b\u001d\u0010\u001eJ\u0017\u0010\u001f\u001a\u00020\u000f2\u0006\u0010\u0006\u001a\u00020\u0005H\u0016¢\u0006\u0004\b\u001f\u0010\u0019J\u000f\u0010 \u001a\u00020\u001aH\u0016¢\u0006\u0004\b \u0010!J\u000f\u0010\"\u001a\u00020\tH\u0016¢\u0006\u0004\b\"\u0010#J\u000f\u0010$\u001a\u00020\tH\u0016¢\u0006\u0004\b$\u0010#R\u0014\u0010\u0002\u001a\u00020\u00018\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b%\u0010&R\u0014\u0010)\u001a\u00020\f8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b'\u0010(¨\u0006*"}, d2 = {"Ls4/l$a;", "Lz4/d;", "delegate", "<init>", "(Ls4/l;Lz4/d;)V", "", "index", "", "value", "", "o", "(ID)V", "", "C", "(IJ)V", "", "u0", "(ILjava/lang/String;)V", "I", "(I)V", "getDouble", "(I)D", "getLong", "(I)J", "P2", "(I)Ljava/lang/String;", "", "isNull", "(I)Z", "getColumnCount", "()I", "getColumnName", "N3", "()Z", "reset", "()V", "close", "a", "Lz4/d;", "b", "J", "threadId", "room-runtime_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
    @SourceDebugExtension
    private final class a implements InterfaceC18382d {

        /* renamed from: a, reason: collision with root package name and from kotlin metadata */
        private final InterfaceC18382d delegate;

        /* renamed from: b, reason: collision with root package name and from kotlin metadata */
        private final long threadId;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ l f160155c;

        public a(l lVar, InterfaceC18382d delegate) {
            Intrinsics.j(delegate, "delegate");
            this.f160155c = lVar;
            this.delegate = delegate;
            this.threadId = C16722d.b();
        }

        @Override // z4.InterfaceC18382d
        public void C(int index, long value) {
            if (this.f160155c.m()) {
                C18379a.b(21, "Statement is recycled");
                throw new KotlinNothingValueException();
            }
            if (this.threadId == C16722d.b()) {
                this.delegate.C(index, value);
            } else {
                C18379a.b(21, "Attempted to use statement on a different thread");
                throw new KotlinNothingValueException();
            }
        }
    ...
    @Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0082\u0004\u0018\u0000*\u0004\b\u0000\u0010\u00012\b\u0012\u0004\u0012\u00028\u00000\u00022\u00020\u0003B\u0007¢\u0006\u0004\b\u0004\u0010\u0005J2\u0010\f\u001a\u00028\u0001\"\u0004\b\u0001\u0010\u00062\u0006\u0010\b\u001a\u00020\u00072\u0012\u0010\u000b\u001a\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00028\u00010\tH\u0096@¢\u0006\u0004\b\f\u0010\rR\u0014\u0010\u0011\u001a\u00020\u000e8VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\u000f\u0010\u0010¨\u0006\u0012"}, d2 = {"Ls4/l$b;", "T", "Landroidx/room/W;", "Ls4/m;", "<init>", "(Ls4/l;)V", "R", "", "sql", "Lkotlin/Function1;", "Lz4/d;", "block", "d", "(Ljava/lang/String;Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "Lz4/b;", "c", "()Lz4/b;", "rawConnection", "room-runtime_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
    @SourceDebugExtension
    private final class b<T> implements W<T>, m {
        ...
        @Override // s4.m
        public InterfaceC18380b c() {
            return l.this.c();
        }

        @Override // androidx.room.InterfaceC6135v
        public <R> Object d(String str, Function1<? super InterfaceC18382d, ? extends R> function1, Continuation<? super R> continuation) {
    ...
    static final class e extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f160162d = obj;
            this.f160164f |= Integer.MIN_VALUE;
    ...
    static final class f extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f160168d = obj;
            this.f160170f |= Integer.MIN_VALUE;
    ...
    static final class g<R> extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f160174d = obj;
            this.f160176f |= Integer.MIN_VALUE;
    ...
    static final class h<R> extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f160181e = obj;
            this.f160183g |= Integer.MIN_VALUE;
    ...
    public /* synthetic */ class d {
        ...
        static {
            ...
            try {
                iArr[X.a.f58436a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[X.a.f58437b.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[X.a.f58438c.ordinal()] = 3;
    ...
    public l(C16872i delegate, boolean z10) {
        Intrinsics.j(delegate, "delegate");
        this.delegate = delegate;
        this.isReadOnly = z10;
    ...
    /* JADX WARN: Type inference failed for: r6v14, types: [Av.a] */
    /*
    ...
    */
    public final java.lang.Object i(androidx.room.X.a r6, kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        ...
        L13:
            ...
            r0.<init>(r7)
        L18:
            java.lang.Object r7 = r0.f160162d
            ...
            if (r2 == 0) goto L40
            if (r2 != r3) goto L38
            java.lang.Object r6 = r0.f160161c
            Av.a r6 = (Av.a) r6
            java.lang.Object r1 = r0.f160160b
            androidx.room.X$a r1 = (androidx.room.X.a) r1
            java.lang.Object r0 = r0.f160159a
            s4.l r0 = (s4.l) r0
        ...
        L55:
            ...
            z4.C18379a.a(r6, r2)     // Catch: java.lang.Throwable -> L7b
            goto Lae
        L7b:
            r6 = move-exception
            goto Lbf
        ...
        Lae:
            ...
            kotlin.Unit r6 = kotlin.Unit.f142422a     // Catch: java.lang.Throwable -> L7b
            r7.h(r4)
            return r6
        Lbf:
            r7.h(r4)
    ...
    */
    public final java.lang.Object j(boolean r6, kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        ...
        L13:
            ...
            r0.<init>(r7)
        L18:
            java.lang.Object r7 = r0.f160168d
            java.lang.Object r1 = kotlin.coroutines.intrinsics.IntrinsicsKt.f()
            int r2 = r0.f160170f
            r3 = 1
            r4 = 0
            if (r2 == 0) goto L3c
            if (r2 != r3) goto L34
            boolean r6 = r0.f160167c
            java.lang.Object r1 = r0.f160166b
            Av.a r1 = (Av.a) r1
            java.lang.Object r0 = r0.f160165a
            s4.l r0 = (s4.l) r0
            kotlin.ResultKt.b(r7)
            goto L52
        L34:
        ...
        L52:
            ...
            z4.C18379a.a(r6, r7)     // Catch: java.lang.Throwable -> L7c
            goto Lc9
        L7c:
            r6 = move-exception
            goto Ld7
        ...
        Lac:
            ...
            z4.C18379a.a(r6, r7)     // Catch: java.lang.Throwable -> L7c
        Lc9:
            kotlin.Unit r6 = kotlin.Unit.f142422a     // Catch: java.lang.Throwable -> L7c
            r1.h(r4)
            return r6
        Lcf:
    ...
    */
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:7:0x0013  */
    /* JADX WARN: Type inference failed for: r7v12, types: [Av.a] */
    @Override // androidx.room.InterfaceC6135v
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public <R> java.lang.Object d(java.lang.String r7, kotlin.jvm.functions.Function1<? super z4.InterfaceC18382d, ? extends R> r8, kotlin.coroutines.Continuation<? super R> r9) {
        /*
            r6 = this;
        ...
        L13:
            ...
            r0.<init>(r9)
        L18:
            java.lang.Object r9 = r0.f160181e
            java.lang.Object r1 = kotlin.coroutines.intrinsics.IntrinsicsKt.f()
            int r2 = r0.f160183g
            r3 = 1
            r4 = 0
            if (r2 == 0) goto L44
            if (r2 != r3) goto L3c
            java.lang.Object r7 = r0.f160180d
            Av.a r7 = (Av.a) r7
            java.lang.Object r8 = r0.f160179c
            kotlin.jvm.functions.Function1 r8 = (kotlin.jvm.functions.Function1) r8
            java.lang.Object r1 = r0.f160178b
            java.lang.String r1 = (java.lang.String) r1
            java.lang.Object r0 = r0.f160177a
            s4.l r0 = (s4.l) r0
        ...
        L44:
            ...
            r2 = 21
            if (r9 != 0) goto La5
            kotlin.coroutines.CoroutineContext r9 = r0.getF142363a()
            s4.a$a r5 = s4.C16864a.INSTANCE
            kotlin.coroutines.CoroutineContext$Element r9 = r9.g(r5)
            s4.a r9 = (s4.C16864a) r9
            if (r9 == 0) goto L9a
        ...
        L77:
            ...
            z4.d r7 = r2.S3(r7)     // Catch: java.lang.Throwable -> L8d
    ...
    public final C16872i getDelegate() {
        return this.delegate;
    }
    ...
    public final void n() {
        if (this._isRecycled.compareAndSet(false, true)) {
            try {
                C18379a.a(this.delegate, "ROLLBACK TRANSACTION");
    ...
    public <R> Object a(X.a aVar, Function2<? super W<R>, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        if (!m()) {
            C16864a c16864a = (C16864a) continuation.getF142363a().g(C16864a.INSTANCE);
            if (c16864a != null && c16864a.getConnectionWrapper() == this) {
                return o(aVar, function2, continuation);
            }
            C18379a.b(21, "Attempted to use connection on a different coroutine");
            throw new KotlinNothingValueException();
        }
        C18379a.b(21, "Connection is recycled");
        throw new KotlinNothingValueException();
    }
