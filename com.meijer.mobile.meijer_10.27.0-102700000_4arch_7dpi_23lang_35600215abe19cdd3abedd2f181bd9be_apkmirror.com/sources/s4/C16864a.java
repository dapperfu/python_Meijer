...
final class C16864a implements CoroutineContext.Element {
    ...
    public static final class Companion implements CoroutineContext.Key<C16864a> {
    ...
    public C16864a(l connectionWrapper) {
    ...
    public CoroutineContext.Key<C16864a> getKey() {
        return INSTANCE;
    }
