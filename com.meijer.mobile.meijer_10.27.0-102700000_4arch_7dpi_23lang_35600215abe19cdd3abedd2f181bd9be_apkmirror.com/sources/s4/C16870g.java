...
public final class C16870g implements InterfaceC16865b {
    ...
    static final class a<R> extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f160101h = obj;
            this.f160103j |= Integer.MIN_VALUE;
            return C16870g.this.o0(false, null, this);
        }
    }
    ...
    static final class b<R> extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super R>, Object> {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function2<X, Continuation<? super R>, Object> f160105b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ l f160106c;
        ...
        b(Function2<? super X, ? super Continuation<? super R>, ? extends Object> function2, l lVar, Continuation<? super b> continuation) {
            ...
            this.f160105b = function2;
            this.f160106c = lVar;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new b(this.f160105b, this.f160106c, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.b(obj);
            Function2<X, Continuation<? super R>, Object> function2 = this.f160105b;
            l lVar = this.f160106c;
            this.f160104a = 1;
    ...
    static final class c<R> extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super R>, Object> {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function2<X, Continuation<? super R>, Object> f160108b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Ref.ObjectRef<l> f160109c;
        ...
        c(Function2<? super X, ? super Continuation<? super R>, ? extends Object> function2, Ref.ObjectRef<l> objectRef, Continuation<? super c> continuation) {
            super(2, continuation);
            this.f160108b = function2;
            this.f160109c = objectRef;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new c(this.f160108b, this.f160109c, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.b(obj);
            Function2<X, Continuation<? super R>, Object> function2 = this.f160108b;
            l lVar = this.f160109c.f142835a;
            this.f160107a = 1;
            Object objInvoke = function2.invoke(lVar, this);
            if (objInvoke == objF) {
                return objF;
    ...
    public C16870g(final InterfaceC18381c driver, final String fileName) {
        Intrinsics.j(driver, "driver");
        Intrinsics.j(fileName, "fileName");
        this.threadLocal = new ThreadLocal<>();
        this._isClosed = new AtomicBoolean(false);
        Duration.Companion companion = Duration.INSTANCE;
        this.timeout = DurationKt.s(30, DurationUnit.f147509e);
        this.driver = driver;
        k kVar = new k(1, new Function0() { // from class: s4.e
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return C16870g.g(driver, fileName);
            }
        });
        this.readers = kVar;
        this.writers = kVar;
    ...
    private final CoroutineContext j(l connection) {
        return new C16864a(connection).m0(C16722d.a(this.threadLocal, connection));
    }
    ...
    */
    public <R> java.lang.Object o0(final boolean r13, kotlin.jvm.functions.Function2<? super androidx.room.X, ? super kotlin.coroutines.Continuation<? super R>, ? extends java.lang.Object> r14, kotlin.coroutines.Continuation<? super R> r15) {
        /*
            Method dump skipped, instructions count: 416
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: s4.C16870g.o0(boolean, kotlin.jvm.functions.Function2, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final InterfaceC18380b g(InterfaceC18381c interfaceC18381c, String str) {
        return interfaceC18381c.a(str);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final InterfaceC18380b h(InterfaceC18381c interfaceC18381c, String str) {
        InterfaceC18380b interfaceC18380bA = interfaceC18381c.a(str);
        C18379a.a(interfaceC18380bA, "PRAGMA query_only = 1");
        return interfaceC18380bA;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final InterfaceC18380b i(InterfaceC18381c interfaceC18381c, String str) {
        return interfaceC18381c.a(str);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit m(C16870g c16870g, boolean z10) {
        c16870g.l(z10);
        return Unit.f142422a;
    }

    public C16870g(final InterfaceC18381c driver, final String fileName, int i10, int i11) {
        Intrinsics.j(driver, "driver");
        Intrinsics.j(fileName, "fileName");
        this.threadLocal = new ThreadLocal<>();
        this._isClosed = new AtomicBoolean(false);
        ...
        if (i11 > 0) {
            ...
            this.readers = new k(i10, new Function0() { // from class: s4.c
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return C16870g.h(driver, fileName);
                }
            });
            this.writers = new k(i11, new Function0() { // from class: s4.d
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return C16870g.i(driver, fileName);
                }
            });
            return;
        }
