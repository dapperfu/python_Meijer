...
public final class j {
    ...
    private static final Charset f33394g = Charset.forName("UTF-8");

    /* renamed from: a, reason: collision with root package name */
    private int f33395a;

    /* renamed from: b, reason: collision with root package name */
    private long f33396b;

    /* renamed from: c, reason: collision with root package name */
    private OutputStream f33397c;

    /* renamed from: d, reason: collision with root package name */
    private byte[] f33398d;

    /* renamed from: e, reason: collision with root package name */
    private final r f33399e;

    /* renamed from: f, reason: collision with root package name */
    private final g.e f33400f;
    ...
    public final void j(byte[] bArr) throws IOException {
        ...
        if (i10 + length >= this.f33398d.length) {
            b(i10, length);
        }
        int i11 = this.f33395a;
        byte[] bArr2 = this.f33398d;
    ...
    private void b(int i10, int i11) throws IOException {
        OutputStream outputStream = this.f33397c;
        if (outputStream == null) {
            byte[] bArr = this.f33398d;
            this.f33398d = Arrays.copyOf(bArr, bArr.length + (bArr.length / 2) + i11);
            return;
        }
        try {
            outputStream.write(this.f33398d, 0, i10);
            this.f33395a = 0;
            this.f33396b += i10;
            byte[] bArr2 = this.f33398d;
            if (i11 > bArr2.length) {
                this.f33398d = Arrays.copyOf(bArr2, bArr2.length + (bArr2.length / 2) + i11);
            }
    ...
    final byte[] c(int i10) throws IOException {
        int i11 = this.f33395a;
        if (i11 + i10 >= this.f33398d.length) {
            b(i11, i10);
        }
        return this.f33398d;
    }
    ...
    public final void d() throws IOException {
        int i10;
        OutputStream outputStream = this.f33397c;
        if (outputStream == null || (i10 = this.f33395a) == 0) {
            return;
        }
        try {
            outputStream.write(this.f33398d, 0, i10);
            this.f33396b += this.f33395a;
            this.f33395a = 0;
        } catch (IOException e10) {
            throw new SerializationException("Unable to write to target stream.", e10);
        }
    ...
    public final void k(byte[] bArr) throws IOException {
        int i10 = this.f33395a;
        if ((bArr.length << 1) + i10 + 2 >= this.f33398d.length) {
        ...
        this.f33395a = i12;
        bArr2[i11] = 34;
        int iB = i12 + S6.a.b(bArr, bArr2, i12);
        byte[] bArr3 = this.f33398d;
        this.f33395a = iB + 1;
        bArr3[iB] = 34;
    }
    ...
    final void m(double d10) throws IOException {
        ...
        if (!g.a(d10, this.f33400f)) {
            i(Double.toString(d10));
            return;
        }
        int i10 = this.f33395a;
        if (i10 + 24 >= this.f33398d.length) {
            b(i10, 24);
        }
        this.f33395a += this.f33400f.l(this.f33398d, this.f33395a);
    }

    public final void n() throws IOException {
        int i10 = this.f33395a;
        if (i10 + 4 >= this.f33398d.length) {
            b(i10, 0);
        }
        int i11 = this.f33395a;
        byte[] bArr = this.f33398d;
    ...
    public String toString() {
        return new String(this.f33398d, 0, this.f33395a, f33394g);
    }

    j(byte[] bArr, r rVar) {
        this.f33400f = new g.e();
        this.f33398d = bArr;
        this.f33399e = rVar;
    }
    ...
    public final void i(String str) throws IOException {
        ...
        str.getBytes(0, length, this.f33398d, this.f33395a);
        this.f33395a += length;
    }
    ...
    public final void p(CharSequence charSequence) throws IOException {
        ...
        int i11 = length << 2;
        int i12 = length << 1;
        if (i10 + i11 + i12 + 2 >= this.f33398d.length) {
            b(i10, i11 + i12 + 2);
        }
        byte[] bArr = this.f33398d;
