...
public class h implements C8.b {
    ...
    static a f2089a = new a() { // from class: B8.g
        @Override // B8.h.a
    ...
    public static C8.a c(Display display, int i10) {
        a.b bVar = new a.b();
        DisplayMetrics displayMetricsB = C8.d.b(display);
        bVar.g(displayMetricsB.density);
        bVar.f(displayMetricsB.densityDpi);
        Point pointA = C8.d.a(display);
    ...
    @Override // C8.b
    public C8.a a(Activity activity) {
        ...
        a.b bVar = new a.b();
        Display displayA = f2089a.a(activity);
