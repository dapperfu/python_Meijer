...
@Metadata(d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010\u000b\n\u0002\b\u0003\u001a%\u0010\u0006\u001a\u00020\u0005*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u00012\b\b\u0002\u0010\u0004\u001a\u00020\u0003H\u0001¢\u0006\u0004\b\u0006\u0010\u0007\u001a9\u0010\r\u001a\u00020\u0005*\u00020\u00002\b\b\u0002\u0010\u0004\u001a\u00020\u00032\u0006\u0010\t\u001a\u00020\b2\u0012\u0010\f\u001a\u000e\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\u00050\nH\u0003¢\u0006\u0004\b\r\u0010\u000e\u001a1\u0010\u000f\u001a\u00020\u0005*\u00020\u00002\b\b\u0002\u0010\u0004\u001a\u00020\u00032\u0012\u0010\f\u001a\u000e\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\u00050\nH\u0003¢\u0006\u0004\b\u000f\u0010\u0010\u001a9\u0010\u0011\u001a\u00020\u0005*\u00020\u00002\u0006\u0010\t\u001a\u00020\b2\b\b\u0002\u0010\u0004\u001a\u00020\u00032\u0012\u0010\f\u001a\u000e\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\u00050\nH\u0003¢\u0006\u0004\b\u0011\u0010\u0012¨\u0006\u0016²\u0006\f\u0010\t\u001a\u00020\b8\nX\u008a\u0084\u0002²\u0006\u000e\u0010\u0014\u001a\u00020\u00138\n@\nX\u008a\u008e\u0002²\u0006\u000e\u0010\u0015\u001a\u00020\u00138\n@\nX\u008a\u008e\u0002"}, d2 = {"LJi/M;", "Ljq/h;", "viewModel", "Landroidx/compose/ui/Modifier;", "modifier", "", "r", "(LJi/M;Ljq/h;Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;II)V", "Ljq/h$f;", "viewState", "Lkotlin/Function1;", "Ljq/h$b;", "sendEvent", "j", "(LJi/M;Landroidx/compose/ui/Modifier;Ljq/h$f;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;II)V", "g", "(LJi/M;Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;II)V", "l", "(LJi/M;Ljq/h$f;Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;II)V", "", "loaderState", "isError", "shopandscan_playstoreRelease"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class g {
    ...
    static final class a implements Function2<Composer, Integer, Unit> {
        ...
        final /* synthetic */ LocalThemeScope f140933a;

        a(LocalThemeScope localThemeScope) {
            this.f140933a = localThemeScope;
        }
        ...
        public final void a(Composer composer, int i10) {
            ...
            g.h(this.f140933a, C16193g.c(com.meijer.mobile.shopandscan.e.f116930O, composer, 0), composer, 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class b implements Function2<Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f140934a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function1<h.b, Unit> f140935b;

        /* JADX WARN: Multi-variable type inference failed */
        b(LocalThemeScope localThemeScope, Function1<? super h.b, Unit> function1) {
            this.f140934a = localThemeScope;
            this.f140935b = function1;
        }
        ...
        public final void a(Composer composer, int i10) {
            ...
            g.g(this.f140934a, null, this.f140935b, composer, LocalThemeScope.f15770g, 1);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class c implements Function3<InterfaceC14794C, Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f140936a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ h.CheckoutState f140937b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Function1<h.b, Unit> f140938c;

        /* JADX WARN: Multi-variable type inference failed */
        c(LocalThemeScope localThemeScope, h.CheckoutState checkoutState, Function1<? super h.b, Unit> function1) {
            this.f140936a = localThemeScope;
            this.f140937b = checkoutState;
            this.f140938c = function1;
        }
        ...
        public final void a(InterfaceC14794C paddingValues, Composer composer, int i10) {
            ...
            g.l(this.f140936a, this.f140937b, D.h(Modifier.INSTANCE, paddingValues), this.f140938c, composer, LocalThemeScope.f15770g | (AbstractC5607a.f45514b << 3), 0);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class d implements Function3<InterfaceC14920X, Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Modifier f140939a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f140940b;

        d(Modifier modifier, LocalThemeScope localThemeScope) {
            this.f140939a = modifier;
            this.f140940b = localThemeScope;
        }
        ...
        public final void a(InterfaceC14920X Assemble, Composer composer, int i10) {
            ...
            o oVar = o.f2584a;
            Bi.m.d(this.f140940b, J.f(this.f140939a, 0.0f, 1, null), largeLoading, oVar, C16193g.c(com.meijer.mobile.shopandscan.e.f116907F, composer, 0), null, null, composer, LocalThemeScope.f15770g | 3072 | (q1.k.Large.f140090f << 6), 48);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final void h(LocalThemeScope localThemeScope, String str, Composer composer, int i10) {
        ...
        ri.j.h(localThemeScope, new q1.Label(null, localThemeScope.getAdsColors().getAdsColorInverse(), null, null, 0, false, 0, localThemeScope.getAdsTypography().getHeadings().getSeven(), null, 381, null), str, null, composer, LocalThemeScope.f15770g | (q1.Label.f140080j << 3) | ((i10 << 6) & 896), 4);
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
        composer.P();
    ...
    */
    private static final void j(final Ji.LocalThemeScope r33, androidx.compose.ui.Modifier r34, final jq.h.CheckoutState r35, final kotlin.jvm.functions.Function1<? super jq.h.b, kotlin.Unit> r36, androidx.compose.runtime.Composer r37, final int r38, final int r39) {
        /*
            Method dump skipped, instructions count: 267
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: jq.g.j(Ji.M, androidx.compose.ui.Modifier, jq.h$f, kotlin.jvm.functions.Function1, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void l(final Ji.LocalThemeScope r18, final jq.h.CheckoutState r19, androidx.compose.ui.Modifier r20, final kotlin.jvm.functions.Function1<? super jq.h.b, kotlin.Unit> r21, androidx.compose.runtime.Composer r22, final int r23, final int r24) {
        /*
            Method dump skipped, instructions count: 736
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: jq.g.l(Ji.M, jq.h$f, androidx.compose.ui.Modifier, kotlin.jvm.functions.Function1, androidx.compose.runtime.Composer, int, int):void");
    }

    private static final void m(LocalThemeScope localThemeScope, Modifier modifier, String str, AbstractC5607a abstractC5607a, boolean z10, boolean z11, Composer composer, int i10, int i11) {
        Modifier modifierM;
        ...
        ri.j.h(localThemeScope, label, str, null, composer, i12 | (i13 << 3) | ((i10 << 3) & 896), 4);
        C14802K.a(InterfaceC14800I.b(c14801j, Modifier.INSTANCE, 1.0f, false, 2, null), composer, 0);
        ri.j.h(localThemeScope, new q1.Label(modifier3, t10, null, F1.j.h(companion2.a()), 0, false, 0, seven, null, 372, null), C6408b.a(abstractC5607a, composer, AbstractC5607a.f45514b | ((i10 >> 6) & 14)), null, composer, i12 | (i13 << 3), 4);
        composer.v();
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
    ...
    private static final void o(LocalThemeScope localThemeScope, Modifier modifier, ShopAndScanCheckoutSummaryDecorator shopAndScanCheckoutSummaryDecorator, Composer composer, int i10, int i11) {
        ...
        MeasurePolicy measurePolicyG = C5662h.g(companion.m(), false);
        int iA = C5717f.a(composer, 0);
        InterfaceC5742s interfaceC5742sR = composer.r();
        ...
        MeasurePolicy measurePolicyA = C5665k.a(C5658d.f48555a.h(), companion.g(), composer, 48);
        ...
        String strC = C16193g.c(com.meijer.mobile.shopandscan.e.f116898C, composer, 0);
        AbstractC5607a itemTotal = shopAndScanCheckoutSummaryDecorator.getItemTotal();
        int i12 = AbstractC5607a.f45514b;
        m(localThemeScope, null, strC, itemTotal, false, false, composer, (i12 << 6) | 27648, 1);
        m(localThemeScope, null, C16193g.c(com.meijer.mobile.shopandscan.e.f117029z, composer, 0), shopAndScanCheckoutSummaryDecorator.getEstimatedTaxes(), false, false, composer, (i12 << 6) | 27648, 1);
        m(localThemeScope, null, C16193g.c(com.meijer.mobile.shopandscan.e.f116901D, composer, 0), shopAndScanCheckoutSummaryDecorator.getSubtotal(), true, false, composer, (i12 << 6) | 27648, 1);
        Modifier.Companion companion3 = Modifier.INSTANCE;
        float f10 = 12;
        C14802K.a(J.i(companion3, H1.h.p(f10)), composer, 6);
        m(localThemeScope, null, C16193g.c(com.meijer.mobile.shopandscan.e.f116904E, composer, 0), shopAndScanCheckoutSummaryDecorator.getTotalSavings(), true, false, composer, (i12 << 6) | 27648, 1);
        C14802K.a(J.i(companion3, H1.h.p(f10)), composer, 6);
        C17917Z.a(null, localThemeScope.getAdsColors().getAdsColorUIBorder02().getColor(), 0.0f, 0.0f, composer, 0, 13);
        m(localThemeScope, null, C16193g.c(com.meijer.mobile.shopandscan.e.f116892A, composer, 0), shopAndScanCheckoutSummaryDecorator.getEstimatedTotal(), false, true, composer, (i12 << 6) | 27648, 1);
        C17917Z.a(null, localThemeScope.getAdsColors().getAdsColorUIBorder02().getColor(), 0.0f, 0.0f, composer, 0, 13);
        C14802K.a(J.i(companion3, H1.h.p(f10)), composer, 6);
        ri.j.h(localThemeScope, new q1.Label(null, localThemeScope.getAdsColors().getAdsColorText02(), null, F1.j.h(F1.j.INSTANCE.f()), 0, false, 0, localThemeScope.getAdsTypography().getDetail().getOne(), null, 373, null), C16193g.c(com.meijer.mobile.shopandscan.e.f116895B, composer, 0), null, composer, LocalThemeScope.f15770g | (q1.Label.f140080j << 3), 4);
        composer.v();
        composer.v();
        if (ComposerKt.M()) {
            ComposerKt.T();
    ...
    private static final void p(LocalThemeScope localThemeScope, Modifier modifier, String str, String str2, Z0.c cVar, Composer composer, int i10, int i11) {
        ...
        float fP = H1.h.p(16);
        e.Companion companion = P0.e.INSTANCE;
        MeasurePolicy measurePolicyA = C5665k.a(c5658d.q(fP, companion.l()), companion.g(), composer, 54);
        int iA = C5717f.a(composer, 0);
        InterfaceC5742s interfaceC5742sR = composer.r();
        ...
        D1.c(composerA, modifierE, companion2.f());
        C14815g c14815g = C14815g.f139108a;
        C13457y.a(cVar, null, null, null, null, 0.0f, null, composer, ((i10 >> 9) & 14) | 48, 124);
        C5658d.m mVarQ = c5658d.q(H1.h.p(8), companion.l());
        e.b bVarG = companion.g();
        Modifier.Companion companion3 = Modifier.INSTANCE;
        MeasurePolicy measurePolicyA2 = C5665k.a(mVarQ, bVarG, composer, 54);
        int iA2 = C5717f.a(composer, 0);
        InterfaceC5742s interfaceC5742sR2 = composer.r();
        ...
        int i12 = LocalThemeScope.f15770g;
        int i13 = q1.Label.f140080j;
        ri.j.h(localThemeScope, label, str, null, composer, (i13 << 3) | i12 | ((i10 << 3) & 896), 4);
        float f11 = 13;
        ri.j.h(localThemeScope, new q1.Label(D.m(companion3, H1.h.p(f11), 0.0f, H1.h.p(f11), 0.0f, 10, null), localThemeScope.getAdsColors().getAdsColorText02(), null, F1.j.h(companion4.a()), 0, false, 0, localThemeScope.getAdsTypography().getBodyCompact().getOne(), null, 372, null), str2, null, composer, (i13 << 3) | i12 | (i10 & 896), 4);
        composer.v();
        composer.v();
        if (ComposerKt.M()) {
            ComposerKt.T();
    ...
    public static final void r(final LocalThemeScope localThemeScope, final h viewModel, Modifier modifier, Composer composer, final int i10, final int i11) {
        ...
        if ((i12 & 147) == 146 && composerStartRestartGroup.j()) {
            ...
            j(localThemeScope, modifier3, checkoutStateS, (Function1) objB, composerStartRestartGroup, ((i12 >> 3) & 112) | LocalThemeScope.f15770g | (i12 & 14) | (AbstractC5607a.f45514b << 6), 0);
            composerStartRestartGroup.startReplaceGroup(5004770);
            ...
            composerStartRestartGroup.P();
            C13588d.a(false, (Function0) objB2, composerStartRestartGroup, 0, 1);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
            modifier2 = modifier3;
    ...
    public static final void g(final LocalThemeScope localThemeScope, Modifier modifier, final Function1<? super h.b, Unit> function1, Composer composer, final int i10, final int i11) {
        ...
        if ((i12 & 3) == 2 && composerStartRestartGroup.j()) {
            ...
            C17943i.d(ComposableLambdaKt.c(-683779502, true, new a(localThemeScope), composerStartRestartGroup, 54), Modifier.INSTANCE, null, null, 0L, 0L, 0.0f, composerStartRestartGroup, 54, 124);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
            modifier3 = modifier2;
    ...
    private static final void n(LocalThemeScope localThemeScope, Modifier modifier, List<CheckoutHeaderData> list, Composer composer, int i10, int i11) {
        ...
        D1.c(composerA, modifierE, companion2.f());
        C14815g c14815g = C14815g.f139108a;
        p(localThemeScope, modifier2, C16193g.c(com.meijer.mobile.shopandscan.e.f116928N, composer, 0), C16193g.c(list.get(1).getDescription(), composer, 0), C16190d.c(list.get(1).getImage(), composer, 0), composer, i10 & 14, 0);
        composer.v();
        if (ComposerKt.M()) {
            ComposerKt.T();
        }
