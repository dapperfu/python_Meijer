...
public final class b<E> extends AbstractSet<E> implements g<E> {
    ...
    public static final int f11965f = 8;

    /* renamed from: g, reason: collision with root package name */
    private static final b f11966g;
    ...
    static {
        I0.c cVar = I0.c.f13445a;
        f11966g = new b(cVar, cVar, d.INSTANCE.a());
    }
    ...
    public g<E> add(E element) {
        ...
        if (isEmpty()) {
            return new b(element, element, this.hashMap.A(element, new a()));
        }
        Object obj = this.lastElement;
        Object obj2 = this.hashMap.get(obj);
        Intrinsics.g(obj2);
        return new b(this.firstElement, element, this.hashMap.A(obj, ((a) obj2).e(element)).A(element, new a(obj)));
    }
    ...
    public g<E> remove(E element) {
        ...
        d dVarB = this.hashMap.B(element);
        if (aVar.b()) {
            V v10 = dVarB.get(aVar.getPrevious());
            Intrinsics.g(v10);
            dVarB = dVarB.A(aVar.getPrevious(), ((a) v10).e(aVar.getNext()));
        }
        if (aVar.a()) {
            V v11 = dVarB.get(aVar.getNext());
            Intrinsics.g(v11);
            dVarB = dVarB.A(aVar.getNext(), ((a) v11).f(aVar.getPrevious()));
        }
        return new b(!aVar.b() ? aVar.getNext() : this.firstElement, !aVar.a() ? aVar.getPrevious() : this.lastElement, dVarB);
    }
