...
@Metadata(d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0017\n\u0002\u0018\u0002\n\u0002\b\b\b\u0017\u0018\u00002\u00020\u0001B\u0017\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0006\u0010\u0007JY\u0010\u0012\u001a\u00020\u00112\u0006\u0010\t\u001a\u00020\b2\u0006\u0010\n\u001a\u00020\b28\u0010\u0010\u001a4\u0012\u0013\u0012\u00110\b¢\u0006\f\b\f\u0012\b\b\r\u0012\u0004\b\b(\n\u0012\u0013\u0012\u00110\u000e¢\u0006\f\b\f\u0012\b\b\r\u0012\u0004\b\b(\u000f\u0012\u0006\u0012\u0004\u0018\u00010\u000e0\u000bH\u0012¢\u0006\u0004\b\u0012\u0010\u0013J\u0017\u0010\u0014\u001a\u00020\u00112\u0006\u0010\t\u001a\u00020\bH\u0017¢\u0006\u0004\b\u0014\u0010\u0015J\u0017\u0010\u0016\u001a\u00020\u00112\u0006\u0010\t\u001a\u00020\bH\u0017¢\u0006\u0004\b\u0016\u0010\u0015J\u0017\u0010\u0017\u001a\u00020\u00112\u0006\u0010\t\u001a\u00020\bH\u0017¢\u0006\u0004\b\u0017\u0010\u0015J\u0017\u0010\u0018\u001a\u00020\u00112\u0006\u0010\t\u001a\u00020\bH\u0017¢\u0006\u0004\b\u0018\u0010\u0015J\u0017\u0010\u0019\u001a\u00020\u00112\u0006\u0010\t\u001a\u00020\bH\u0017¢\u0006\u0004\b\u0019\u0010\u0015J\u0017\u0010\u001a\u001a\u00020\u00112\u0006\u0010\t\u001a\u00020\bH\u0017¢\u0006\u0004\b\u001a\u0010\u0015J#\u0010\u001d\u001a\u00020\u00112\b\u0010\u001b\u001a\u0004\u0018\u00010\b2\b\u0010\u001c\u001a\u0004\u0018\u00010\u000eH\u0016¢\u0006\u0004\b\u001d\u0010\u001eJ#\u0010 \u001a\u00020\u00112\b\u0010\u001b\u001a\u0004\u0018\u00010\b2\b\u0010\u001f\u001a\u0004\u0018\u00010\bH\u0016¢\u0006\u0004\b \u0010!J\u0017\u0010#\u001a\u00020\u00112\u0006\u0010\"\u001a\u00020\u000eH\u0016¢\u0006\u0004\b#\u0010$R\u0014\u0010\u0003\u001a\u00020\u00028\u0012X\u0092\u0004¢\u0006\u0006\n\u0004\b%\u0010&R\u0014\u0010\u0005\u001a\u00020\u00048\u0012X\u0092\u0004¢\u0006\u0006\n\u0004\b'\u0010(R$\u00100\u001a\u0004\u0018\u00010)8\u0016@\u0016X\u0096\u000e¢\u0006\u0012\n\u0004\b*\u0010+\u001a\u0004\b,\u0010-\"\u0004\b.\u0010/¨\u00061"}, d2 = {"Lla/g;", "", "Ll9/b;", "concurrentHandlerHolder", "Lla/s;", "jsCommandFactory", "<init>", "(Ll9/b;Lla/s;)V", "", "jsonString", "property", "Lkotlin/Function2;", "Lkotlin/ParameterName;", "name", "Lorg/json/JSONObject;", "json", "jsBridgeEventAction", "", "j", "(Ljava/lang/String;Ljava/lang/String;Lkotlin/jvm/functions/Function2;)V", "close", "(Ljava/lang/String;)V", "triggerAppEvent", "triggerMEEvent", "buttonClicked", "openExternalLink", "copyToClipboard", PreferencesHelper.PREF_ID, "resultPayload", "o", "(Ljava/lang/String;Lorg/json/JSONObject;)V", "error", "l", "(Ljava/lang/String;Ljava/lang/String;)V", "payload", "m", "(Lorg/json/JSONObject;)V", "a", "Ll9/b;", "b", "Lla/s;", "Lra/a;", "c", "Lra/a;", "i", "()Lra/a;", "p", "(Lra/a;)V", "iamWebView", "mobile-engage_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public class g {
    ...
    public g(l9.b concurrentHandlerHolder, s jsCommandFactory) {
    ...
    public static final JSONObject g(g gVar, String property, JSONObject json) {
        ...
        gVar.jsCommandFactory.m(s.a.f148760b).invoke(property, json);
        return null;
    }
    ...
    public static final JSONObject h(g gVar, String property, JSONObject json) {
        Intrinsics.j(property, "property");
        Intrinsics.j(json, "json");
        gVar.jsCommandFactory.m(s.a.f148764f).invoke(property, json);
        return null;
    }
    ...
    public static final JSONObject k(g gVar, String property, JSONObject json) {
        ...
        if (!json.optBoolean("keepInAppOpen", false)) {
            gVar.jsCommandFactory.m(s.a.f148761c).invoke(null, new JSONObject());
        }
        gVar.jsCommandFactory.m(s.a.f148763e).invoke(property, json);
        return null;
    }
    ...
    public static final JSONObject q(g gVar, String property, JSONObject json) {
        Intrinsics.j(property, "property");
        Intrinsics.j(json, "json");
        gVar.jsCommandFactory.m(s.a.f148759a).invoke(property, json);
        return null;
    }
    ...
    public static final JSONObject r(g gVar, String property, JSONObject json) {
        Intrinsics.j(property, "property");
        Intrinsics.j(json, "json");
        gVar.jsCommandFactory.m(s.a.f148762d).invoke(property, json);
        return null;
    }
    ...
    public void buttonClicked(String jsonString) throws JSONException {
        ...
        j(jsonString, "buttonId", new Function2() { // from class: la.c
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return g.g(this.f148725a, (String) obj, (JSONObject) obj2);
            }
        });
    }
    ...
    public void close(String jsonString) {
        Intrinsics.j(jsonString, "jsonString");
        this.jsCommandFactory.m(s.a.f148761c).invoke(null, new JSONObject());
    }

    @JavascriptInterface
    public void copyToClipboard(String jsonString) throws JSONException {
        Intrinsics.j(jsonString, "jsonString");
        j(jsonString, "text", new Function2() { // from class: la.a
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return g.h(this.f148723a, (String) obj, (JSONObject) obj2);
            }
        });
    }

    /* renamed from: i, reason: from getter */
    public C16736a getIamWebView() {
    ...
    public void m(final JSONObject payload) {
        ...
        if (!Intrinsics.e(Looper.myLooper(), Looper.getMainLooper())) {
            this.concurrentHandlerHolder.h(new Runnable() { // from class: la.f
                @Override // java.lang.Runnable
                public final void run() {
                    g.n(this.f148728a, payload);
                }
            });
            return;
        }
        C16736a iamWebView = getIamWebView();
        if (iamWebView != null) {
    ...
    public void o(String id2, JSONObject resultPayload) {
        try {
            m(G9.h.c(new JSONObject().put(PreferencesHelper.PREF_ID, id2).put("success", true), resultPayload));
        } catch (JSONException unused) {
        }
    }
    ...
    public void openExternalLink(String jsonString) throws JSONException {
        Intrinsics.j(jsonString, "jsonString");
        j(jsonString, "url", new Function2() { // from class: la.b
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return g.k(this.f148724a, (String) obj, (JSONObject) obj2);
            }
        });
    }

    public void p(C16736a c16736a) {
        this.iamWebView = c16736a;
    }

    @JavascriptInterface
    public void triggerAppEvent(String jsonString) throws JSONException {
        Intrinsics.j(jsonString, "jsonString");
        j(jsonString, "name", new Function2() { // from class: la.e
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return g.q(this.f148727a, (String) obj, (JSONObject) obj2);
            }
        });
    }
    ...
    public void triggerMEEvent(String jsonString) throws JSONException {
        Intrinsics.j(jsonString, "jsonString");
        j(jsonString, "name", new Function2() { // from class: la.d
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return g.r(this.f148726a, (String) obj, (JSONObject) obj2);
            }
        });
    }
    ...
    public static final void n(g gVar, JSONObject jSONObject) {
        C16736a iamWebView = gVar.getIamWebView();
        if (iamWebView != null) {
