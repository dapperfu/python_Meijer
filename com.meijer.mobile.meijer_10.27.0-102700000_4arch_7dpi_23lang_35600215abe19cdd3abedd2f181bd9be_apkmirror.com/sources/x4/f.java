...
public final class f {
    ...
    private C18016b.C2711b recreatorProvider;
    ...
    public final void d(Class<? extends a> clazz) throws NoSuchMethodException, SecurityException {
        ...
        C18016b.C2711b c2711b = this.recreatorProvider;
        if (c2711b == null) {
            c2711b = new C18016b.C2711b(this);
        }
        this.recreatorProvider = c2711b;
        try {
            clazz.getDeclaredConstructor(null);
            C18016b.C2711b c2711b2 = this.recreatorProvider;
            if (c2711b2 != null) {
