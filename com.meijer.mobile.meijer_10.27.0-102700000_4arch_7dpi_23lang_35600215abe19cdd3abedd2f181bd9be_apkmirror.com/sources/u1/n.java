...
public final class n {
    ...
    private static final long f162612a = H1.w.i(14);

    /* renamed from: b, reason: collision with root package name */
    private static final long f162613b = H1.w.i(0);

    /* renamed from: c, reason: collision with root package name */
    private static final long f162614c;

    /* renamed from: d, reason: collision with root package name */
    private static final long f162615d;

    /* renamed from: e, reason: collision with root package name */
    private static final F1.n f162616e;
    ...
    */
    public static final androidx.compose.ui.text.SpanStyle b(androidx.compose.ui.text.SpanStyle r23, long r24, V0.AbstractC5324i0 r26, float r27, long r28, kotlin.FontWeight r30, kotlin.C18153w r31, kotlin.C18154x r32, kotlin.AbstractC18142l r33, java.lang.String r34, long r35, F1.a r37, F1.TextGeometricTransform r38, B1.LocaleList r39, long r40, F1.k r42, V0.Shadow r43, u1.k r44, X0.g r45) {
        /*
    ...
    static final class a extends Lambda implements Function0<F1.n> {
        ...
        public static final a f162617f = new a();
    ...
    static {
        ...
        f162614c = companion.i();
        long jA = companion.a();
        f162615d = jA;
        f162616e = F1.n.INSTANCE.b(jA);
    }
    ...
    public static final SpanStyle c(SpanStyle spanStyle, SpanStyle spanStyle2, float f10) {
        ...
        AbstractC18142l abstractC18142l = (AbstractC18142l) d(spanStyle.getFontFamily(), spanStyle2.getFontFamily(), f10);
        ...
        FontWeight fontWeightA = C18111E.a(fontWeight, fontWeight2, f10);
        C18153w c18153w = (C18153w) d(spanStyle.getFontStyle(), spanStyle2.getFontStyle(), f10);
        C18154x c18154x = (C18154x) d(spanStyle.getFontSynthesis(), spanStyle2.getFontSynthesis(), f10);
        ...
        long jH = C5349s0.h(spanStyle.getBackground(), spanStyle2.getBackground(), f10);
        ...
        return new SpanStyle(nVarB, jF, fontWeightA, c18153w, c18154x, abstractC18142l, str, jF2, F1.a.d(fA), textGeometricTransformA, localeList, jH, kVar, C1.a(shadow, shadow2, f10), e(spanStyle.getPlatformStyle(), spanStyle2.getPlatformStyle(), f10), (X0.g) d(spanStyle.getDrawStyle(), spanStyle2.getDrawStyle(), f10), (DefaultConstructorMarker) null);
    }
    ...
    private static final k e(k kVar, k kVar2, float f10) {
        ...
        return C17210b.c(kVar, kVar2, f10);
    }
    ...
    public static final SpanStyle h(SpanStyle spanStyle) {
        ...
        long letterSpacing;
        float fA;
        F1.n nVarC = spanStyle.getTextForegroundStyle().c(a.f162617f);
        ...
        C18154x c18154xE = C18154x.e(iA);
        AbstractC18142l fontFamily = spanStyle.getFontFamily();
        if (fontFamily == null) {
            fontFamily = AbstractC18142l.INSTANCE.b();
        }
        AbstractC18142l abstractC18142l = fontFamily;
        ...
        if (drawStyle == null) {
            drawStyle = X0.j.f39072a;
        }
        return new SpanStyle(nVarC, fontSize, fontWeight2, c18153wC, c18154xE, abstractC18142l, str, j10, aVarD, textGeometricTransform2, localeList2, j11, kVar, shadow2, platformStyle, drawStyle, (DefaultConstructorMarker) null);
    }
}
