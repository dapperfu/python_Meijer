...
public interface InterfaceC15516b {
    ...
    /* renamed from: m0.b$a */
    public static final class a implements InterfaceC15516b {

        /* renamed from: a, reason: collision with root package name and from kotlin metadata */
        private final int count;

        @Override // m0.InterfaceC15516b
        public List<Integer> a(H1.d dVar, int i10, int i11) {
            return C15521g.c(i10, this.count, i11);
        }
        ...
        public a(int i10) {
            ...
            if (!z10) {
                C14589e.a("Provided count should be larger than zero");
            }
        }
    }
