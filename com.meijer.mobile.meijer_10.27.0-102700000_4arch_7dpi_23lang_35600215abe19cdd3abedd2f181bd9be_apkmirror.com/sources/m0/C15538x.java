...
public final class C15538x {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final int index;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final C15536v[] items;
    ...
    public final C15536v[] f(int offset, int layoutWidth, int layoutHeight) {
        int i10;
        int i11;
        int i12;
        int i13;
        C15536v[] c15536vArr = this.items;
        int length = c15536vArr.length;
        int i14 = 0;
        int i15 = 0;
        int i16 = 0;
        while (i14 < length) {
            C15536v c15536v = c15536vArr[i14];
            int i17 = i15 + 1;
            int iD = C15517c.d(this.spans.get(i15).getPackedValue());
            ...
            c15536v.u(i13, i18, i11, i12, i19, i10);
    ...
    public C15538x(int i10, C15536v[] c15536vArr, C15508E c15508e, List<C15517c> list, boolean z10, int i11) {
        this.index = i10;
        this.items = c15536vArr;
        this.slots = c15508e;
        this.spans = list;
        this.isVertical = z10;
        this.mainAxisSpacing = i11;
        int iMax = 0;
        for (C15536v c15536v : c15536vArr) {
            iMax = Math.max(iMax, c15536v.getMainAxisSize());
        }
