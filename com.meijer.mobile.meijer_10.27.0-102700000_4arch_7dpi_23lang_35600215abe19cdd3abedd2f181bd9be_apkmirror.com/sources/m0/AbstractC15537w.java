...
public abstract class AbstractC15537w implements InterfaceC15716B<C15536v> {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC15525k itemProvider;
    ...
    public abstract C15536v b(int index, Object key, Object contentType, int crossAxisSize, int mainAxisSpacing, List<? extends f0> placeables, long constraints, int lane, int span);

    @Override // kotlin.InterfaceC15716B
    /* renamed from: c, reason: merged with bridge method [inline-methods] */
    public C15536v a(int index, int lane, int span, long constraints) {
        return d(index, constraints, lane, span, this.defaultMainAxisSpacing);
    }

    public final C15536v d(int index, long constraints, int lane, int span, int mainAxisSpacing) {
        int iM;
        ...
        if (H1.b.j(constraints)) {
            ...
            if (!H1.b.i(constraints)) {
                C14589e.a("does not have fixed height");
            }
    ...
    public final AbstractC5517o e() {
        return this.itemProvider.e();
    }

    public final InterfaceC15761u f() {
        return this.itemProvider.b();
    }

    public AbstractC15537w(InterfaceC15525k interfaceC15525k, InterfaceC15763w interfaceC15763w, int i10) {
        this.itemProvider = interfaceC15525k;
