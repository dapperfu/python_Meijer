...
final class C15518d implements InterfaceC15509F {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final Function2<H1.d, H1.b, C15508E> calculation;
    ...
    private C15508E cachedSizes;

    @Override // m0.InterfaceC15509F
    public C15508E a(H1.d density, long constraints) {
        if (this.cachedSizes != null && H1.b.f(this.cachedConstraints, constraints) && this.cachedDensity == density.getDensity()) {
            C15508E c15508e = this.cachedSizes;
            Intrinsics.g(c15508e);
            return c15508e;
        }
        this.cachedConstraints = constraints;
        this.cachedDensity = density.getDensity();
        C15508E c15508eInvoke = this.calculation.invoke(density, H1.b.a(constraints));
        this.cachedSizes = c15508eInvoke;
        return c15508eInvoke;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public C15518d(Function2<? super H1.d, ? super H1.b, C15508E> function2) {
