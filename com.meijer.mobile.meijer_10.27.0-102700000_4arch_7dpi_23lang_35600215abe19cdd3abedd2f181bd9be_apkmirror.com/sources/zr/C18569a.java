...
public final class C18569a {
    ...
    public C18569a(Context context, int i10) {
    ...
    public static /* synthetic */ Bitmap b(C18569a c18569a, int i10, C5346q0 c5346q0, int i11, Object obj) {
        if ((i11 & 2) != 0) {
            c5346q0 = null;
        }
        return c18569a.a(i10, c5346q0);
    }

    private final int c(int drawable, C5346q0 color) {
        return ((527 + drawable) * 31) + (color != null ? C5349s0.j(color.getValue()) : 0);
    }

    private final Bitmap d(int i10, Context context, C5346q0 c5346q0) {
        ...
        if (c5346q0 != null) {
            C13462a.n(drawableE, C5349s0.j(c5346q0.getValue()));
        }
        drawableE.draw(new Canvas(bitmapCreateBitmap));
        return bitmapCreateBitmap;
    }

    public final Bitmap a(int drawable, C5346q0 tintColor) {
        Bitmap bitmapD;
        ...
        uw.a.INSTANCE.q("Hits:" + this.cache.hitCount() + " Misses:" + this.cache.missCount(), new Object[0]);
