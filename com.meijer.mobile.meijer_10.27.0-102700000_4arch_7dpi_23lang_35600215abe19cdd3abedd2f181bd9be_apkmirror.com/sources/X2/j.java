...
public final class j {
    ...
    public static final j f39101a = new j();

    public final CreationExtras a(h0 owner) {
        Intrinsics.j(owner, "owner");
        return owner instanceof InterfaceC6020j ? ((InterfaceC6020j) owner).getDefaultViewModelCreationExtras() : CreationExtras.b.f36770c;
    }

    public final f0.c b(h0 owner) {
        Intrinsics.j(owner, "owner");
        return owner instanceof InterfaceC6020j ? ((InterfaceC6020j) owner).getDefaultViewModelProviderFactory() : c.f39095b;
    }
