...
public interface a extends IInterface {
    ...
    void Y(List<MediaSessionCompat.QueueItem> list) throws RemoteException;

    void Z() throws RemoteException;

    void Z3(int i10) throws RemoteException;

    void i5(ParcelableVolumeInfo parcelableVolumeInfo) throws RemoteException;
            ...
            if (i10 != 1598968902) {
                ...
                switch (i10) {
                    ...
                    case 4:
                        ...
                        u3(mediaMetadataCompatCreateFromParcel);
                        return true;
                    case 5:
                        parcel.enforceInterface("android.support.v4.media.session.IMediaControllerCallback");
                    ...
                    case 8:
                        ...
                        i5(parcelableVolumeInfoCreateFromParcel);
                        return true;
                    case 9:
                        parcel.enforceInterface("android.support.v4.media.session.IMediaControllerCallback");
                        D0(parcel.readInt());
