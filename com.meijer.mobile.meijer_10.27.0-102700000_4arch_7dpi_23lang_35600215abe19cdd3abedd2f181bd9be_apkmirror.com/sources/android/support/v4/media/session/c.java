...
public abstract class c implements IBinder.DeathRecipient {
    ...
    final Object f45590a = e.a(new a(this));

    /* renamed from: b, reason: collision with root package name */
    android.support.v4.media.session.a f45591b;

    private static class a implements e.a {

        /* renamed from: a, reason: collision with root package name */
        private final WeakReference<c> f45592a;

        @Override // android.support.v4.media.session.e.a
        public void A0(CharSequence charSequence) {
            c cVar = this.f45592a.get();
            if (cVar != null) {
                cVar.f(charSequence);
            }
        }
        ...
        public void b(Object obj) {
            c cVar = this.f45592a.get();
            if (cVar == null || cVar.f45591b != null) {
                return;
            }
        ...
        a(c cVar) {
            this.f45592a = new WeakReference<>(cVar);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    static class b extends a.AbstractBinderC0951a {

        /* renamed from: a, reason: collision with root package name */
        private final WeakReference<c> f45593a;

        @Override // android.support.v4.media.session.a
        public void A7(boolean z10) throws RemoteException {
        }

        @Override // android.support.v4.media.session.a
        public void D0(int i10) throws RemoteException {
            c cVar = this.f45593a.get();
            if (cVar != null) {
        ...
        @Override // android.support.v4.media.session.a
        public void V6(boolean z10) throws RemoteException {
            c cVar = this.f45593a.get();
            if (cVar != null) {
        ...
        @Override // android.support.v4.media.session.a
        public void Z3(int i10) throws RemoteException {
            c cVar = this.f45593a.get();
            if (cVar != null) {
        ...
        b(c cVar) {
            this.f45593a = new WeakReference<>(cVar);
        }
    }
