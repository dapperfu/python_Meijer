...
public final /* data */ class QuizResultsResponseInner implements Serializable {
    ...
    public QuizResultsResponseInner(@g(name = "facets") List<FilterFacet> list, @g(name = "groups") List<FilterGroup> list2, @g(name = "results") List<Result> list3, @g(name = "sort_options") List<FilterSortOption> list4, @g(name = "total_num_results") int i10, @g(name = "refined_content") List<RefinedContent> list5, @g(name = "features") List<Feature> list6, @g(name = "result_sources") ResultSources resultSources) {
        this.facets = list;
        this.groups = list2;
        this.results = list3;
    ...
    public static /* synthetic */ QuizResultsResponseInner copy$default(QuizResultsResponseInner quizResultsResponseInner, List list, List list2, List list3, List list4, int i10, List list5, List list6, ResultSources resultSources, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            list = quizResultsResponseInner.facets;
        }
        if ((i11 & 2) != 0) {
            list2 = quizResultsResponseInner.groups;
        }
        if ((i11 & 4) != 0) {
            list3 = quizResultsResponseInner.results;
        }
        if ((i11 & 8) != 0) {
            list4 = quizResultsResponseInner.filterSortOptions;
        }
        if ((i11 & 16) != 0) {
            i10 = quizResultsResponseInner.resultCount;
        }
        if ((i11 & 32) != 0) {
            list5 = quizResultsResponseInner.refinedContent;
        }
        if ((i11 & 64) != 0) {
            list6 = quizResultsResponseInner.features;
        }
        if ((i11 & 128) != 0) {
            resultSources = quizResultsResponseInner.resultSources;
        }
        List list7 = list6;
        ResultSources resultSources2 = resultSources;
        int i12 = i10;
        List list8 = list5;
        return quizResultsResponseInner.copy(list, list2, list3, list4, i12, list8, list7, resultSources2);
    }
    ...
    public final QuizResultsResponseInner copy(@g(name = "facets") List<FilterFacet> facets, @g(name = "groups") List<FilterGroup> groups, @g(name = "results") List<Result> results, @g(name = "sort_options") List<FilterSortOption> filterSortOptions, @g(name = "total_num_results") int resultCount, @g(name = "refined_content") List<RefinedContent> refinedContent, @g(name = "features") List<Feature> features, @g(name = "result_sources") ResultSources resultSources) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.e(this.facets, quizResultsResponseInner.facets) && Intrinsics.e(this.groups, quizResultsResponseInner.groups) && Intrinsics.e(this.results, quizResultsResponseInner.results) && Intrinsics.e(this.filterSortOptions, quizResultsResponseInner.filterSortOptions) && this.resultCount == quizResultsResponseInner.resultCount && Intrinsics.e(this.refinedContent, quizResultsResponseInner.refinedContent) && Intrinsics.e(this.features, quizResultsResponseInner.features) && Intrinsics.e(this.resultSources, quizResultsResponseInner.resultSources);
    }
    ...
    public int hashCode() {
        ...
        int iHashCode4 = (((iHashCode3 + (list4 == null ? 0 : list4.hashCode())) * 31) + Integer.hashCode(this.resultCount)) * 31;
        ...
        return iHashCode6 + (resultSources != null ? resultSources.hashCode() : 0);
    }
