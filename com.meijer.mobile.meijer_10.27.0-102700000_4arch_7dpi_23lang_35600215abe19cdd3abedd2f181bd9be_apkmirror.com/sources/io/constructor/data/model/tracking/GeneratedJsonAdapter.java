    ...
    public ItemDetailLoadRequestBody fromJson(k reader) throws IOException {
        ...
        while (true) {
            ...
            if (!reader.hasNext()) {
                ...
                reader.d();
                if (str == null) {
                    JsonDataException jsonDataExceptionO = c.o("itemName", "item_name", reader);
                ...
                JsonDataException jsonDataExceptionO8 = c.o("us", "us", reader);
            ...
            switch (reader.z(this.options)) {
                ...
                case 0:
                    ...
                    if (strFromJson == null) {
                        JsonDataException jsonDataExceptionW = c.w("itemName", "item_name", reader);
                ...
                case 3:
                    ...
                    if (strFromJson4 == null) {
                        JsonDataException jsonDataExceptionW3 = c.w("url", "url", reader);
                ...
                case 4:
                    ...
                    if (strFromJson5 == null) {
                        JsonDataException jsonDataExceptionW4 = c.w("c", "c", reader);
                ...
                case 5:
                    ...
                    if (strFromJson6 == null) {
                        JsonDataException jsonDataExceptionW5 = c.w("i", "i", reader);
                ...
                case 6:
                    ...
                    if (numFromJson == null) {
                        JsonDataException jsonDataExceptionW6 = c.w("s", "s", reader);
                ...
                case 7:
                    ...
                    if (strFromJson7 == null) {
                        JsonDataException jsonDataExceptionW7 = c.w("key", "key", reader);
                ...
                case 9:
                    ...
                    if (listFromJson == null) {
                        JsonDataException jsonDataExceptionW8 = c.w("us", "us", reader);
