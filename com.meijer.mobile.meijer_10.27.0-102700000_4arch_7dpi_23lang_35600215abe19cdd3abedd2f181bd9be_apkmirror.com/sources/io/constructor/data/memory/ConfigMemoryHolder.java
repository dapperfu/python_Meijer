...
public final class ConfigMemoryHolder {
    ...
    public final List<Pair<String, String>> getTestCellParams() {
        ...
        if (str.length() > 0) {
            Iterator it = StringsKt.a1(str, new String[]{";"}, false, 0, 6, null).iterator();
            while (it.hasNext()) {
                List listA1 = StringsKt.a1((String) it.next(), new String[]{"="}, false, 0, 6, null);
                arrayList.add(TuplesKt.a(String.valueOf(a.a((String) listA1.get(0))), a.a((String) listA1.get(1))));
            }
        }
        return arrayList;
    }
