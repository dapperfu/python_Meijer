...
public final class DataManager {
    ...
    public final Object getAutocompleteResultsCRT(String str, Pair<String, String>[] pairArr, Continuation<? super AutocompleteResponse> continuation) {
        ...
        return this.constructorApi.getAutocompleteResultsCRT(q2.f92724c + str2 + getAdditionalParamsQueryString(pairArr), continuation);
    }
    ...
    public final Object getBrowseResultsCRT(String str, String str2, Pair<String, String>[] pairArr, Continuation<? super BrowseResponse> continuation) {
        ...
        return this.constructorApi.getBrowseResultsCRT(q2.f92724c + str3 + getAdditionalParamsQueryString(pairArr), continuation);
    }
    ...
    public final Object getRecommendationResultsCRT(String str, Pair<String, String>[] pairArr, Continuation<? super RecommendationsResponse> continuation) {
        ...
        Intrinsics.i(str2, "format(this, *args)");
        return this.constructorApi.getRecommendationResultsCRT(q2.f92724c + str2 + getAdditionalParamsQueryString(pairArr), continuation);
    }
    ...
    public final Object getSearchResultsCRT(String str, Pair<String, String>[] pairArr, Continuation<? super SearchResponse> continuation) {
        ...
        Intrinsics.i(str2, "format(this, *args)");
        return this.constructorApi.getSearchResultsCRT(q2.f92724c + str2 + getAdditionalParamsQueryString(pairArr), continuation);
    }
    ...
    public static final ConstructorData m92getAutocompleteResults$lambda3(DataManager this$0, Result result) {
    ...
    public static final ConstructorData m93getBrowseFacetOptions$lambda18(DataManager this$0, Result result) {
        ConstructorData constructorDataNetworkError;
        Intrinsics.j(this$0, "this$0");
        Intrinsics.j(result, "result");
        if (result.isError()) {
    ...
    public static final ConstructorData m94getBrowseFacets$lambda15(DataManager this$0, Result result) {
        ConstructorData constructorDataNetworkError;
        Intrinsics.j(this$0, "this$0");
        Intrinsics.j(result, "result");
        if (result.isError()) {
    ...
    public static final ConstructorData m95getBrowseGroups$lambda21(DataManager this$0, Result result) {
        ConstructorData constructorDataNetworkError;
        Intrinsics.j(this$0, "this$0");
        Intrinsics.j(result, "result");
        if (result.isError()) {
    ...
    public static final ConstructorData m96getBrowseItemsResults$lambda12(DataManager this$0, Result result) {
        ConstructorData constructorDataNetworkError;
        Intrinsics.j(this$0, "this$0");
        Intrinsics.j(result, "result");
        if (result.isError()) {
    ...
    public static final ConstructorData m97getBrowseResults$lambda9(DataManager this$0, Result result) {
        ConstructorData constructorDataNetworkError;
        Intrinsics.j(this$0, "this$0");
        Intrinsics.j(result, "result");
        if (result.isError()) {
    ...
    public static final ConstructorData m98getQuizNextQuestion$lambda27(DataManager this$0, Result it) {
        ConstructorData constructorDataNetworkError;
        Intrinsics.j(this$0, "this$0");
        Intrinsics.j(it, "it");
        if (it.isError()) {
    ...
    public static final ConstructorData m99getQuizResults$lambda30(DataManager this$0, Result it) {
        ConstructorData constructorDataNetworkError;
        Intrinsics.j(this$0, "this$0");
        Intrinsics.j(it, "it");
        if (it.isError()) {
    ...
    public static final ConstructorData m100getRecommendationResults$lambda24(DataManager this$0, Result it) {
        ConstructorData constructorDataNetworkError;
        Intrinsics.j(this$0, "this$0");
        Intrinsics.j(it, "it");
        if (it.isError()) {
    ...
    public static final ConstructorData m101getSearchResults$lambda6(DataManager this$0, Result result) {
        ConstructorData constructorDataNetworkError;
        Intrinsics.j(this$0, "this$0");
        Intrinsics.j(result, "result");
        if (result.isError()) {
    ...
    public final l<ConstructorData<AutocompleteResponse>> getAutocompleteResults(String term, Pair<String, String>[] encodedParams) {
        ...
        l<ConstructorData<AutocompleteResponse>> lVarR = this.constructorApi.getAutocompleteResults(q2.f92724c + str + getAdditionalParamsQueryString(encodedParams)).j(new o() { // from class: io.constructor.data.e
            @Override // Pu.o
            public final Object apply(Object obj) {
                return DataManager.m92getAutocompleteResults$lambda3(this.f138157a, (Result) obj);
            }
        }).r();
    ...
    public final l<ConstructorData<BrowseFacetOptionsResponse>> getBrowseFacetOptions(Pair<String, String>[] encodedParams) {
        ...
        l<ConstructorData<BrowseFacetOptionsResponse>> lVarR = this.constructorApi.getBrowseFacetOptionsResults("/browse/facet_options" + getAdditionalParamsQueryString(encodedParams)).j(new o() { // from class: io.constructor.data.j
            @Override // Pu.o
            public final Object apply(Object obj) {
                return DataManager.m93getBrowseFacetOptions$lambda18(this.f138162a, (Result) obj);
            }
        }).r();
    ...
    public final l<ConstructorData<BrowseFacetsResponse>> getBrowseFacets(Pair<String, String>[] encodedParams) {
        ...
        l<ConstructorData<BrowseFacetsResponse>> lVarR = this.constructorApi.getBrowseFacetsResults("/browse/facets" + getAdditionalParamsQueryString(encodedParams)).j(new o() { // from class: io.constructor.data.f
            @Override // Pu.o
            public final Object apply(Object obj) {
                return DataManager.m94getBrowseFacets$lambda15(this.f138158a, (Result) obj);
            }
        }).r();
        Intrinsics.i(lVarR, "constructorApi.getBrowse…\n        }.toObservable()");
        return lVarR;
    ...
    public final l<ConstructorData<BrowseGroupsResponse>> getBrowseGroups(Pair<String, String>[] encodedParams) {
        ...
        l<ConstructorData<BrowseGroupsResponse>> lVarR = this.constructorApi.getBrowseGroupsResults("/browse/groups" + getAdditionalParamsQueryString(encodedParams)).j(new o() { // from class: io.constructor.data.h
            @Override // Pu.o
            public final Object apply(Object obj) {
                return DataManager.m95getBrowseGroups$lambda21(this.f138160a, (Result) obj);
            }
        }).r();
        Intrinsics.i(lVarR, "constructorApi.getBrowse…\n        }.toObservable()");
        return lVarR;
    ...
    public final l<ConstructorData<BrowseResponse>> getBrowseItemsResults(Pair<String, String>[] encodedParams) {
        ...
        l<ConstructorData<BrowseResponse>> lVarR = this.constructorApi.getBrowseResults("/browse/items" + getAdditionalParamsQueryString(encodedParams)).j(new o() { // from class: io.constructor.data.c
            @Override // Pu.o
            public final Object apply(Object obj) {
                return DataManager.m96getBrowseItemsResults$lambda12(this.f138155a, (Result) obj);
            }
        }).r();
        Intrinsics.i(lVarR, "constructorApi.getBrowse…\n        }.toObservable()");
        return lVarR;
    ...
    public final l<ConstructorData<BrowseResponse>> getBrowseResults(String filterName, String filterValue, Pair<String, String>[] encodedParams) {
        ...
        Intrinsics.i(str, "format(this, *args)");
        l<ConstructorData<BrowseResponse>> lVarR = this.constructorApi.getBrowseResults(q2.f92724c + str + getAdditionalParamsQueryString(encodedParams)).j(new o() { // from class: io.constructor.data.g
            @Override // Pu.o
            public final Object apply(Object obj) {
                return DataManager.m97getBrowseResults$lambda9(this.f138159a, (Result) obj);
            }
        }).r();
        Intrinsics.i(lVarR, "constructorApi.getBrowse…\n        }.toObservable()");
        return lVarR;
    ...
    public final l<ConstructorData<QuizQuestionResponse>> getQuizNextQuestion(String quizId, Pair<String, String>[] encodedParams, PreferencesHelper preferencesHelper) {
        ...
        Intrinsics.i(str, "format(this, *args)");
        l<ConstructorData<QuizQuestionResponse>> lVarR = this.constructorApi.getQuizNextQuestion(scheme + "://" + quizzesServiceUrl + q2.f92724c + str + getAdditionalParamsQueryString(encodedParams)).j(new o() { // from class: io.constructor.data.b
            @Override // Pu.o
            public final Object apply(Object obj) {
                return DataManager.m98getQuizNextQuestion$lambda27(this.f138154a, (Result) obj);
            }
        }).r();
    ...
    public final l<ConstructorData<QuizResultsResponse>> getQuizResults(String quizId, Pair<String, String>[] encodedParams, PreferencesHelper preferencesHelper) {
        ...
        Intrinsics.i(str, "format(this, *args)");
        l<ConstructorData<QuizResultsResponse>> lVarR = this.constructorApi.getQuizResults(scheme + "://" + quizzesServiceUrl + q2.f92724c + str + getAdditionalParamsQueryString(encodedParams)).j(new o() { // from class: io.constructor.data.d
            @Override // Pu.o
            public final Object apply(Object obj) {
                return DataManager.m99getQuizResults$lambda30(this.f138156a, (Result) obj);
            }
        }).r();
    ...
    public final l<ConstructorData<RecommendationsResponse>> getRecommendationResults(String podId, Pair<String, String>[] encodedParams) {
        ...
        Intrinsics.i(str, "format(this, *args)");
        l<ConstructorData<RecommendationsResponse>> lVarR = this.constructorApi.getRecommendationResults(q2.f92724c + str + getAdditionalParamsQueryString(encodedParams)).j(new o() { // from class: io.constructor.data.a
            @Override // Pu.o
            public final Object apply(Object obj) {
                return DataManager.m100getRecommendationResults$lambda24(this.f138153a, (Result) obj);
            }
        }).r();
    ...
    public final l<ConstructorData<SearchResponse>> getSearchResults(String term, Pair<String, String>[] encodedParams) {
        ...
        Intrinsics.i(str, "format(this, *args)");
        l<ConstructorData<SearchResponse>> lVarR = this.constructorApi.getSearchResults(q2.f92724c + str + getAdditionalParamsQueryString(encodedParams)).j(new o() { // from class: io.constructor.data.i
            @Override // Pu.o
            public final Object apply(Object obj) {
                return DataManager.m101getSearchResults$lambda6(this.f138161a, (Result) obj);
            }
        }).r();
    ...
    public final io.reactivex.b trackSearchResultsLoaded(String term, int resultCount, String[] customerIds, Pair<String, String>[] params) {
        ...
        String strB0 = null;
        if (customerIds != null && (listZ0 = ArraysKt.Z0(customerIds, 60)) != null) {
            strB0 = CollectionsKt.B0(listZ0, ",", null, null, 0, null, null, 62, null);
        }
    ...
    public final Object getQuizNextQuestionCRT(String str, Pair<String, String>[] pairArr, PreferencesHelper preferencesHelper, Continuation<? super QuizQuestionResponse> continuation) {
        ...
        Intrinsics.i(str2, "format(this, *args)");
        return this.constructorApi.getQuizNextQuestionCRT(scheme + "://" + quizzesServiceUrl + q2.f92724c + str2 + getAdditionalParamsQueryString(pairArr), continuation);
    }
    ...
    public final Object getQuizResultsCRT(String str, Pair<String, String>[] pairArr, PreferencesHelper preferencesHelper, Continuation<? super QuizResultsResponse> continuation) {
        ...
        Intrinsics.i(str2, "format(this, *args)");
        return this.constructorApi.getQuizResultsCRT(scheme + "://" + quizzesServiceUrl + q2.f92724c + str2 + getAdditionalParamsQueryString(pairArr), continuation);
    }
}
