...
final class C4037e extends AbstractC4034b {

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    private final Object id;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C4037e(List<Function1<B, Unit>> tasks, Object id2, int i10) {
        super(tasks, i10);
    ...
    @Override // L1.AbstractC4034b
    public O1.a c(B state) {
        Intrinsics.j(state, "state");
        O1.c cVarH = state.h(this.id, e.EnumC0372e.VERTICAL_CHAIN);
