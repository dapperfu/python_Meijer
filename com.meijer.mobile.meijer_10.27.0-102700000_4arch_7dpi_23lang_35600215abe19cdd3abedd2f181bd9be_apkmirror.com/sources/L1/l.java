...
public final class l {
    ...
    private static final boolean f17755a = false;
    ...
    static final class b implements MeasurePolicy {
        ...
        static final class a extends Lambda implements Function1<f0.a, Unit> {
            ...
            public final void a(f0.a layout) {
                ...
                this.f17760f.k(layout, this.f17761g);
            }
        ...
        b(A a10, r rVar, int i10, InterfaceC5730l0<Boolean> interfaceC5730l0) {
            this.f17756a = a10;
            this.f17757b = rVar;
            this.f17758c = i10;
            this.f17759d = interfaceC5730l0;
        }
        ...
        public final J d(K MeasurePolicy, List<? extends I> measurables, long j10) {
            ...
            long jL = this.f17756a.l(j10, MeasurePolicy.getLayoutDirection(), this.f17757b, measurables, this.f17758c, MeasurePolicy);
            this.f17759d.getValue();
            return K.G0(MeasurePolicy, H1.r.g(jL), H1.r.f(jL), null, new a(this.f17756a, measurables), 4, null);
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public int e(InterfaceC5791s interfaceC5791s, List<? extends androidx.compose.ui.layout.r> list, int i10) {
            return MeasurePolicy.a.b(this, interfaceC5791s, list, i10);
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public int g(InterfaceC5791s interfaceC5791s, List<? extends androidx.compose.ui.layout.r> list, int i10) {
            return MeasurePolicy.a.c(this, interfaceC5791s, list, i10);
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public int i(InterfaceC5791s interfaceC5791s, List<? extends androidx.compose.ui.layout.r> list, int i10) {
            return MeasurePolicy.a.d(this, interfaceC5791s, list, i10);
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public int j(InterfaceC5791s interfaceC5791s, List<? extends androidx.compose.ui.layout.r> list, int i10) {
            return MeasurePolicy.a.a(this, interfaceC5791s, list, i10);
        }
    }
    ...
    static final class c extends Lambda implements Function0<Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ InterfaceC5730l0<Boolean> f17762f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ r f17763g;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        c(InterfaceC5730l0<Boolean> interfaceC5730l0, r rVar) {
            super(0);
            this.f17762f = interfaceC5730l0;
            this.f17763g = rVar;
        }

        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final void invoke2() {
            this.f17762f.setValue(Boolean.valueOf(!r0.getValue().booleanValue()));
            this.f17763g.i(true);
        }
    }
    ...
    @PublishedApi
    public static final Pair<MeasurePolicy, Function0<Unit>> h(int i10, n scope, InterfaceC5730l0<Boolean> remeasureRequesterState, A measurer, Composer composer, int i11) {
    ...
    public static final String i(Q1.e eVar) {
        return ((Object) eVar.o()) + " width " + eVar.M() + " minWidth " + eVar.B() + " maxWidth " + eVar.z() + " height " + eVar.s() + " minHeight " + eVar.A() + " maxHeight " + eVar.y() + " HDB " + eVar.v() + " VDB " + eVar.K() + " MCW " + eVar.f29623w + " MCH " + eVar.f29625x + " percentW " + eVar.f29546B + " percentH " + eVar.f29552E;
    }
