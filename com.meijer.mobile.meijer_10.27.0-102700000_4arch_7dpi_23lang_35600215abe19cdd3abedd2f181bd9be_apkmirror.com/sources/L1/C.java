...
public final class C {
    ...
    static final /* synthetic */ KProperty<Object>[] f17646a = {Reflection.f(new MutablePropertyReference1Impl(Reflection.d(C.class, "compose_release"), "designInfoProvider", "getDesignInfoProvider(Landroidx/compose/ui/semantics/SemanticsPropertyReceiver;)Landroidx/constraintlayout/compose/DesignInfoProvider;"))};

    /* renamed from: b, reason: collision with root package name */
    private static final SemanticsPropertyKey<u> f17647b;

    /* renamed from: c, reason: collision with root package name */
    private static final SemanticsPropertyKey f17648c;

    static {
        SemanticsPropertyKey<u> semanticsPropertyKey = new SemanticsPropertyKey<>("DesignInfoProvider", null, 2, null);
        f17647b = semanticsPropertyKey;
        f17648c = semanticsPropertyKey;
    }

    public static final void a(r1.u uVar, u uVar2) {
        Intrinsics.j(uVar, "<this>");
        Intrinsics.j(uVar2, "<set-?>");
        f17648c.d(uVar, f17646a[0], uVar2);
    }
}
