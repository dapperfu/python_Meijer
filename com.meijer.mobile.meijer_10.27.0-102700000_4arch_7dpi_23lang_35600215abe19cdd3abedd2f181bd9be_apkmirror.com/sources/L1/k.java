...
public abstract class k {
    ...
    static final class d extends Lambda implements Function1<B, Unit> {
        ...
        final /* synthetic */ int f17747f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ float f17748g;
        ...
        public final void a(B state) {
            ...
            P1.f fVarO = state.o(Integer.valueOf(this.f17747f));
            float f10 = this.f17748g;
            if (state.q() == H1.t.f12006a) {
                fVarO.e(f10);
            } else {
                fVarO.e(1.0f - f10);
            }
    ...
    static final class e extends Lambda implements Function1<B, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ int f17749f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ h[] f17750g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ C4038f f17751h;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        e(int i10, h[] hVarArr, C4038f c4038f) {
            super(1);
            this.f17749f = i10;
            this.f17750g = hVarArr;
            this.f17751h = c4038f;
        }

        public final void a(B state) {
            Intrinsics.j(state, "state");
            O1.c cVarH = state.h(Integer.valueOf(this.f17749f), e.EnumC0372e.HORIZONTAL_CHAIN);
            if (cVarH == null) {
                throw new NullPointerException("null cannot be cast to non-null type androidx.constraintlayout.core.state.helpers.HorizontalChainReference");
            }
            P1.g gVar = (P1.g) cVarH;
            h[] hVarArr = this.f17750g;
            ...
            gVar.b0(this.f17751h.getStyle());
            gVar.apply();
            if (this.f17751h.getBias() != null) {
                state.b(this.f17750g[0].getId()).y(this.f17751h.getBias().floatValue());
            }
        }
    ...
    static final class f extends Lambda implements Function1<B, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ int f17752f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ h[] f17753g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ C4038f f17754h;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        f(int i10, h[] hVarArr, C4038f c4038f) {
            super(1);
            this.f17752f = i10;
            this.f17753g = hVarArr;
            this.f17754h = c4038f;
        }

        public final void a(B state) {
            Intrinsics.j(state, "state");
            O1.c cVarH = state.h(Integer.valueOf(this.f17752f), e.EnumC0372e.VERTICAL_CHAIN);
            if (cVarH == null) {
                throw new NullPointerException("null cannot be cast to non-null type androidx.constraintlayout.core.state.helpers.VerticalChainReference");
            }
            P1.h hVar = (P1.h) cVarH;
            h[] hVarArr = this.f17753g;
            ArrayList arrayList = new ArrayList(hVarArr.length);
            for (h hVar2 : hVarArr) {
            ...
            hVar.b0(this.f17754h.getStyle());
            hVar.apply();
            if (this.f17754h.getBias() != null) {
                state.b(this.f17753g[0].getId()).W(this.f17754h.getBias().floatValue());
            }
        }
    ...
    public final y e(h[] elements, C4038f chainStyle) {
    ...
    public final E f(h[] elements, C4038f chainStyle) {
        Intrinsics.j(elements, "elements");
        Intrinsics.j(chainStyle, "chainStyle");
        int iD = d();
