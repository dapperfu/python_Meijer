...
public final class C4039g {
    ...
    private final InterfaceC4036d baseline;
    ...
    static final class a extends Lambda implements Function1<B, Unit> {
        ...
        public final void a(B state) {
            ...
            state.b(C4039g.this.getId()).x(((w) this.f17718g).g(state));
        }
    ...
    static final class b extends Lambda implements Function1<B, Unit> {
        ...
        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ C4039g f17720g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(float f10, C4039g c4039g) {
            super(1);
            this.f17719f = f10;
            this.f17720g = c4039g;
        }
        ...
        public final void a(B state) {
            Intrinsics.j(state, "state");
            state.b(this.f17720g.getId()).y(state.q() == H1.t.f12007b ? 1 - this.f17719f : this.f17719f);
        }
    ...
    static final class c extends Lambda implements Function1<B, Unit> {
        ...
        public final void a(B state) {
            Intrinsics.j(state, "state");
            state.b(C4039g.this.getId()).W(this.f17722g);
        }
    ...
    static final class d extends Lambda implements Function1<B, Unit> {
        ...
        public final void a(B state) {
            Intrinsics.j(state, "state");
            O1.a aVarB = state.b(C4039g.this.getId());
            G g10 = this.f17724g;
    ...
    static final class e extends Lambda implements Function1<B, Unit> {
        ...
        public final void a(B state) {
            Intrinsics.j(state, "state");
            state.b(C4039g.this.getId()).Y(((w) this.f17726g).g(state));
        }
    ...
    public static /* synthetic */ void c(C4039g c4039g, h hVar, float f10, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            f10 = 0.5f;
        }
        c4039g.b(hVar, f10);
    ...
    public static /* synthetic */ void e(C4039g c4039g, h hVar, float f10, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            f10 = 0.5f;
        }
        c4039g.d(hVar, f10);
    ...
    public static /* synthetic */ void n(C4039g c4039g, k.HorizontalAnchor horizontalAnchor, k.HorizontalAnchor horizontalAnchor2, float f10, float f11, float f12, float f13, float f14, int i10, Object obj) {
        if ((i10 & 4) != 0) {
            f10 = H1.h.p(0);
        }
        float f15 = f10;
        ...
        c4039g.l(horizontalAnchor, horizontalAnchor2, f15, f16, f12, (i10 & 32) != 0 ? H1.h.p(0) : f13, (i10 & 64) != 0 ? 0.5f : f14);
    }

    public static /* synthetic */ void o(C4039g c4039g, k.VerticalAnchor verticalAnchor, k.VerticalAnchor verticalAnchor2, float f10, float f11, float f12, float f13, float f14, int i10, Object obj) {
        if ((i10 & 4) != 0) {
            f10 = H1.h.p(0);
        }
        float f15 = f10;
        ...
        c4039g.m(verticalAnchor, verticalAnchor2, f15, f16, f12, (i10 & 32) != 0 ? H1.h.p(0) : f13, (i10 & 64) != 0 ? 0.5f : f14);
    }
