...
public abstract class AbstractC4034b implements x {
    ...
    static final class a extends Lambda implements Function1<B, Unit> {
        ...
        final /* synthetic */ k.HorizontalAnchor f17678g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ float f17679h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ float f17680i;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(k.HorizontalAnchor horizontalAnchor, float f10, float f11) {
            super(1);
            this.f17678g = horizontalAnchor;
            this.f17679h = f10;
            this.f17680i = f11;
        }
        ...
        public final void a(B state) {
            ...
            O1.a aVarC = AbstractC4034b.this.c(state);
            AbstractC4034b abstractC4034b = AbstractC4034b.this;
            k.HorizontalAnchor horizontalAnchor = this.f17678g;
            C4033a.f17662a.e()[abstractC4034b.index][horizontalAnchor.getIndex()].invoke(aVarC, horizontalAnchor.getId()).D(H1.h.l(this.f17679h)).F(H1.h.l(this.f17680i));
        }
    ...
    public AbstractC4034b(List<Function1<B, Unit>> tasks, int i10) {
