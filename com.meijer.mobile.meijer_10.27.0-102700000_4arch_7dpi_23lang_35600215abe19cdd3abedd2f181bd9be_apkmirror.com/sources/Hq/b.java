...
public final class b implements Hq.a {
    ...
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"Lqv/O;", "Lcom/meijer/mobile/shoppinglist/service/responses/FavoriteListAddItemResponse;", "<anonymous>", "(Lqv/O;)Lcom/meijer/mobile/shoppinglist/service/responses/FavoriteListAddItemResponse;"}, k = 3, mv = {2, 1, 0})
    ...
    static final class a extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super FavoriteListAddItemResponse>, Object> {
        ...
        final /* synthetic */ FavoriteListItemWireModel f13101d;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(FavoriteListItemWireModel favoriteListItemWireModel, Continuation<? super a> continuation) {
            super(2, continuation);
            this.f13101d = favoriteListItemWireModel;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return b.this.new a(this.f13101d, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(InterfaceC16622O interfaceC16622O, Continuation<? super FavoriteListAddItemResponse> continuation) {
        ...
        public final Object invokeSuspend(Object obj) throws UserNotAuthenticatedException {
            ...
            if (i10 != 0) {
                ...
                dVar = (Hq.d) this.f13098a;
                ResultKt.b(obj);
            } else {
                ResultKt.b(obj);
                dVar = b.this.shoppingListAPI;
                Xi.a aVar = b.this.authTokenProvider;
                this.f13098a = dVar;
                this.f13099b = 1;
                obj = aVar.c(this);
                if (obj != objF) {
            ...
            AddFavoritesItemsRequest addFavoritesItemsRequest = new AddFavoritesItemsRequest(this.f13101d);
            this.f13098a = null;
            this.f13099b = 2;
    ...
    static final class C0204b extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super FavoriteListAddItemResponse>, Object> {
        ...
        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ List<FavoriteListItemWireModel> f13105d;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C0204b(List<FavoriteListItemWireModel> list, Continuation<? super C0204b> continuation) {
            super(2, continuation);
            this.f13105d = list;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return b.this.new C0204b(this.f13105d, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(InterfaceC16622O interfaceC16622O, Continuation<? super FavoriteListAddItemResponse> continuation) {
            return ((C0204b) create(interfaceC16622O, continuation)).invokeSuspend(Unit.f142422a);
        }
        ...
        public final Object invokeSuspend(Object obj) throws UserNotAuthenticatedException {
            ...
            AddFavoritesItemsRequest addFavoritesItemsRequest = new AddFavoritesItemsRequest(this.f13105d);
            this.f13102a = null;
            this.f13103b = 2;
            Object objE = dVar.e((BearerToken) obj, addFavoritesItemsRequest, this);
            if (objE == objF) {
    ...
    static final class c extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Response<Unit>>, Object> {
        ...
        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ DeleteFavoritesListItemsRequest f13109d;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        c(DeleteFavoritesListItemsRequest deleteFavoritesListItemsRequest, Continuation<? super c> continuation) {
            super(2, continuation);
            this.f13109d = deleteFavoritesListItemsRequest;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return b.this.new c(this.f13109d, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) throws UserNotAuthenticatedException {
            ...
            DeleteFavoritesListItemsRequest deleteFavoritesListItemsRequest = this.f13109d;
            this.f13106a = null;
            this.f13107b = 2;
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001*\u00020\u0000H\n¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"Lqv/O;", "", "Lcom/meijer/mobile/shoppinglist/service/models/FavoriteListItemWireModel;", "<anonymous>", "(Lqv/O;)Ljava/util/List;"}, k = 3, mv = {2, 1, 0})
    ...
    static final class d extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super List<? extends FavoriteListItemWireModel>>, Object> {
        ...
        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(InterfaceC16622O interfaceC16622O, Continuation<? super List<? extends FavoriteListItemWireModel>> continuation) {
            return invoke2(interfaceC16622O, (Continuation<? super List<FavoriteListItemWireModel>>) continuation);
        }
        ...
        public final Object invoke2(InterfaceC16622O interfaceC16622O, Continuation<? super List<FavoriteListItemWireModel>> continuation) {
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r5) throws android.security.keystore.UserNotAuthenticatedException {
            ...
            L12:
                ...
                throw r5
            L1a:
                java.lang.Object r1 = r4.f13110a
                Hq.d r1 = (Hq.d) r1
                kotlin.ResultKt.b(r5)
                goto L3c
            L22:
    ...
    public b(Hq.d shoppingListAPI, Xi.a authTokenProvider, AbstractC16618K ioDispatcher) {
    ...
    public Object a(List<FavoriteListItemWireModel> list, Continuation<? super FavoriteListAddItemResponse> continuation) {
        return C16644i.g(this.ioDispatcher, new C0204b(list, null), continuation);
    }
    ...
    public Object c(DeleteFavoritesListItemsRequest deleteFavoritesListItemsRequest, Continuation<? super Response<Unit>> continuation) {
        return C16644i.g(this.ioDispatcher, new c(deleteFavoritesListItemsRequest, null), continuation);
    }
    ...
    public Object d(FavoriteListItemWireModel favoriteListItemWireModel, Continuation<? super FavoriteListAddItemResponse> continuation) {
        return C16644i.g(this.ioDispatcher, new a(favoriteListItemWireModel, null), continuation);
    }
}
