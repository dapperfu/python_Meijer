...
public final class C18359e {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final InterfaceC14176h rootPositionCalculator;
    ...
    private Function1<? super C5331k1, Unit> textFieldToRootTransform = b.f171469f;

    /* renamed from: p, reason: collision with root package name and from kotlin metadata */
    private final CursorAnchorInfo.Builder builder = new CursorAnchorInfo.Builder();

    /* renamed from: q, reason: collision with root package name and from kotlin metadata */
    private final float[] matrix = C5331k1.c(null, 1, null);
    ...
    /* renamed from: z1.e$a */
    static final class a extends Lambda implements Function1<C5331k1, Unit> {

        /* renamed from: f, reason: collision with root package name */
        public static final a f171468f = new a();
    ...
    static final class b extends Lambda implements Function1<C5331k1, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final b f171469f = new b();
    ...
    private final void c() {
        if (this.inputMethodManager.a()) {
            this.textFieldToRootTransform.invoke(C5331k1.a(this.matrix));
            ...
            InterfaceC18354E interfaceC18354E = this.offsetMapping;
            Intrinsics.g(interfaceC18354E);
            ...
            Intrinsics.g(rect2);
            interfaceC18372s.e(C18358d.b(builder, textFieldValue, interfaceC18354E, textLayoutResult, matrix, rect, rect2, this.includeInsertionMarker, this.includeCharacterBounds, this.includeEditorBounds, this.includeLineBounds));
    ...
    public final void a() {
        synchronized (this.lock) {
            ...
            this.textFieldToRootTransform = a.f171468f;
    ...
    public final void d(TextFieldValue textFieldValue, InterfaceC18354E offsetMapping, TextLayoutResult textLayoutResult, Function1<? super C5331k1, Unit> textFieldToRootTransform, Rect innerTextFieldBounds, Rect decorationBoxBounds) {
        synchronized (this.lock) {
            try {
    ...
    public C18359e(InterfaceC14176h interfaceC14176h, InterfaceC18372s interfaceC18372s) {
        this.rootPositionCalculator = interfaceC14176h;
