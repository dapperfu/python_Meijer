...
public final class C18365k {
    ...
    private TextFieldValue mBufferState = new TextFieldValue(C5913b.e(), androidx.compose.ui.text.y.INSTANCE.a(), (androidx.compose.ui.text.y) null, (DefaultConstructorMarker) null);

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private C18366l mBuffer = new C18366l(this.mBufferState.getText(), this.mBufferState.getSelection(), null);

    @Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\r\n\u0002\b\u0002\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0001\u001a\u00020\u0000H\n¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"Lz1/i;", "it", "", "a", "(Lz1/i;)Ljava/lang/CharSequence;"}, k = 3, mv = {1, 9, 0})
    /* renamed from: z1.k$a */
    static final class a extends Lambda implements Function1<InterfaceC18363i, CharSequence> {

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ InterfaceC18363i f171476f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ C18365k f171477g;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(InterfaceC18363i interfaceC18363i, C18365k c18365k) {
            super(1);
            this.f171476f = interfaceC18363i;
            this.f171477g = c18365k;
        }

        @Override // kotlin.jvm.functions.Function1
        /* renamed from: a, reason: merged with bridge method [inline-methods] */
        public final CharSequence invoke(InterfaceC18363i interfaceC18363i) {
            return (this.f171476f == interfaceC18363i ? " > " : "   ") + this.f171477g.e(interfaceC18363i);
        }
    }

    public final TextFieldValue b(List<? extends InterfaceC18363i> editCommands) {
        InterfaceC18363i interfaceC18363i;
        InterfaceC18363i interfaceC18363i2 = null;
        try {
            int size = editCommands.size();
            int i10 = 0;
            InterfaceC18363i interfaceC18363i3 = null;
            while (i10 < size) {
                try {
                    interfaceC18363i = editCommands.get(i10);
                } catch (Exception e10) {
                    e = e10;
                    interfaceC18363i2 = interfaceC18363i3;
                }
                try {
                    interfaceC18363i.a(this.mBuffer);
                    i10++;
                    interfaceC18363i3 = interfaceC18363i;
                } catch (Exception e11) {
                    e = e11;
                    interfaceC18363i2 = interfaceC18363i;
                    throw new RuntimeException(c(editCommands, interfaceC18363i2), e);
                }
            }
            ...
            TextFieldValue textFieldValue = new TextFieldValue(annotatedStringS, yVar != null ? yVar.getPackedValue() : C17207A.b(androidx.compose.ui.text.y.k(jI), androidx.compose.ui.text.y.l(jI)), this.mBuffer.d(), (DefaultConstructorMarker) null);
    ...
    private final String c(List<? extends InterfaceC18363i> editCommands, InterfaceC18363i failedCommand) throws IOException {
    ...
    public final String e(InterfaceC18363i interfaceC18363i) {
        if (interfaceC18363i instanceof CommitTextCommand) {
            StringBuilder sb2 = new StringBuilder();
            sb2.append("CommitTextCommand(text.length=");
            CommitTextCommand commitTextCommand = (CommitTextCommand) interfaceC18363i;
        ...
        if (interfaceC18363i instanceof SetComposingTextCommand) {
            StringBuilder sb3 = new StringBuilder();
            sb3.append("SetComposingTextCommand(text.length=");
            SetComposingTextCommand setComposingTextCommand = (SetComposingTextCommand) interfaceC18363i;
        ...
        if (interfaceC18363i instanceof SetComposingRegionCommand) {
            return interfaceC18363i.toString();
        }
        if (interfaceC18363i instanceof DeleteSurroundingTextCommand) {
            return interfaceC18363i.toString();
        }
        if (interfaceC18363i instanceof DeleteSurroundingTextInCodePointsCommand) {
            return interfaceC18363i.toString();
        }
        if (interfaceC18363i instanceof SetSelectionCommand) {
            return interfaceC18363i.toString();
        }
        if (interfaceC18363i instanceof C18368n) {
            return interfaceC18363i.toString();
        }
        if (interfaceC18363i instanceof C18360f) {
            return interfaceC18363i.toString();
        }
        StringBuilder sb4 = new StringBuilder();
        sb4.append("Unknown EditCommand: ");
        String strU = Reflection.b(interfaceC18363i.getClass()).u();
        if (strU == null) {
    ...
    public final void d(TextFieldValue value, T textInputSession) {
        ...
        if (!Intrinsics.e(this.mBufferState.getText().getText(), value.getText().getText())) {
            this.mBuffer = new C18366l(value.getText(), value.getSelection(), null);
