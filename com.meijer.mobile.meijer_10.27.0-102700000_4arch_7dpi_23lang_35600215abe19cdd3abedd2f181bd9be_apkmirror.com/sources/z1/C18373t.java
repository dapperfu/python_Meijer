...
public final class C18373t implements InterfaceC18372s {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final View view;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final Lazy imm = LazyKt.a(LazyThreadSafetyMode.f142381c, new a());
    ...
    static final class a extends Lambda implements Function0<InputMethodManager> {
        ...
        public final InputMethodManager invoke() {
            Object systemService = C18373t.this.view.getContext().getSystemService("input_method");
