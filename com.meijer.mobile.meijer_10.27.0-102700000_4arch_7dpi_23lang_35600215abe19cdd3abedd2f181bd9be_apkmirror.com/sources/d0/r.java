...
public final class r {
    ...
    private static final float f126992a = ViewConfiguration.getScrollFriction();

    /* renamed from: b, reason: collision with root package name */
    private static final double f126993b;

    /* renamed from: c, reason: collision with root package name */
    private static final double f126994c;
    ...
    public static final float b(H1.d dVar, float f10) {
        ...
        float f11 = f126992a;
        return (float) (f11 * density * Math.exp((f126993b / f126994c) * Math.log(dAbs / (f11 * density))));
    }
}
