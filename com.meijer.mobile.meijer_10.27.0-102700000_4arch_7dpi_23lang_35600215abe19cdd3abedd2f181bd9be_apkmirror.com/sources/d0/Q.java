...
public final class Q {
    ...
    static final class a extends Lambda implements Function1<r1.u, Unit> {
        ...
        final /* synthetic */ float f126886f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ ClosedFloatingPointRange<Float> f126887g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f126888h;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(float f10, ClosedFloatingPointRange<Float> closedFloatingPointRange, int i10) {
            super(1);
            this.f126886f = f10;
            this.f126887g = closedFloatingPointRange;
            this.f126888h = i10;
        }

        public final void a(r1.u uVar) {
            r1.s.r0(uVar, new ProgressBarRangeInfo(((Number) RangesKt.r(Float.valueOf(this.f126886f), this.f126887g)).floatValue(), this.f126887g, this.f126888h));
        }
    ...
    static final class b extends Lambda implements Function1<r1.u, Unit> {
        ...
        /* renamed from: f, reason: collision with root package name */
        public static final b f126889f = new b();
    ...
    public static final Modifier a(Modifier modifier) {
        return C16705m.c(modifier, true, b.f126889f);
    }
    ...
    public static final Modifier b(Modifier modifier, float f10, ClosedFloatingPointRange<Float> closedFloatingPointRange, int i10) {
        return C16705m.c(modifier, true, new a(f10, closedFloatingPointRange, i10));
    }
