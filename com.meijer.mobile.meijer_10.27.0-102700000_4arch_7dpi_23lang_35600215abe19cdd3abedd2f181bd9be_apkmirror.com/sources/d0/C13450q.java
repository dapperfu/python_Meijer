...
public final class C13450q {

    /* renamed from: a, reason: collision with root package name */
    public static final C13450q f126991a = new C13450q();

    public final EdgeEffect b(Context context) {
        return Build.VERSION.SDK_INT >= 31 ? C13437d.f126947a.a(context, null) : new C13454v(context);
    }

    public final float c(EdgeEffect edgeEffect) {
        if (Build.VERSION.SDK_INT >= 31) {
            return C13437d.f126947a.b(edgeEffect);
        }
        return 0.0f;
    }
    ...
    public final float e(EdgeEffect edgeEffect, float f10, float f11) {
        if (Build.VERSION.SDK_INT >= 31) {
            return C13437d.f126947a.c(edgeEffect, f10, f11);
        }
    ...
    public final void f(EdgeEffect edgeEffect, float f10) {
        if (edgeEffect instanceof C13454v) {
            ((C13454v) edgeEffect).a(f10);
        } else {
