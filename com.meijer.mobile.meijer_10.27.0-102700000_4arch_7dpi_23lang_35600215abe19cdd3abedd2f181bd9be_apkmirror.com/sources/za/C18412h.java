...
@Metadata(d1 = {"\u0000n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u000b\bÆ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003JK\u0010\u0012\u001a\u00020\u00112\u0006\u0010\u0005\u001a\u00020\u00042\u0012\u0010\b\u001a\u000e\u0012\u0004\u0012\u00020\u0007\u0012\u0004\u0012\u00020\u00070\u00062\u0006\u0010\n\u001a\u00020\t2\u0006\u0010\f\u001a\u00020\u000b2\u0006\u0010\u000e\u001a\u00020\r2\u0006\u0010\u0010\u001a\u00020\u000fH\u0007¢\u0006\u0004\b\u0012\u0010\u0013J%\u0010\u0016\u001a\u00020\u00152\u0014\u0010\u0014\u001a\u0010\u0012\u0004\u0012\u00020\u0007\u0012\u0006\u0012\u0004\u0018\u00010\u00070\u0006H\u0002¢\u0006\u0004\b\u0016\u0010\u0017J%\u0010\u0018\u001a\u00020\u00152\u0014\u0010\u0014\u001a\u0010\u0012\u0004\u0012\u00020\u0007\u0012\u0006\u0012\u0004\u0018\u00010\u00070\u0006H\u0002¢\u0006\u0004\b\u0018\u0010\u0017J%\u0010\u0019\u001a\u00020\u00152\u0014\u0010\u0014\u001a\u0010\u0012\u0004\u0012\u00020\u0007\u0012\u0006\u0012\u0004\u0018\u00010\u00070\u0006H\u0007¢\u0006\u0004\b\u0019\u0010\u0017J\u001f\u0010\u001d\u001a\u00020\u001c2\u0006\u0010\u001b\u001a\u00020\u001a2\u0006\u0010\u0005\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\u001d\u0010\u001eJ'\u0010\u001f\u001a\u00020\u001a2\u0006\u0010\n\u001a\u00020\t2\u0006\u0010\u001b\u001a\u00020\u001a2\u0006\u0010\u0005\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\u001f\u0010 J+\u0010!\u001a\u00020\u001c*\u00020\u001c2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\f\u001a\u00020\u000b2\u0006\u0010\u001b\u001a\u00020\u001aH\u0002¢\u0006\u0004\b!\u0010\"J!\u0010&\u001a\u00020\u00152\u0006\u0010$\u001a\u00020#2\b\u0010%\u001a\u0004\u0018\u00010\u0007H\u0002¢\u0006\u0004\b&\u0010'J\u0017\u0010(\u001a\u00020\u00072\u0006\u0010\u0005\u001a\u00020\u0004H\u0003¢\u0006\u0004\b(\u0010)J%\u0010,\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010+0*2\u0006\u0010\u000e\u001a\u00020\r2\u0006\u0010\u001b\u001a\u00020\u001a¢\u0006\u0004\b,\u0010-J%\u0010.\u001a\u00020\u00152\u0016\u0010\b\u001a\u0012\u0012\u0004\u0012\u00020\u0007\u0012\u0006\u0012\u0004\u0018\u00010\u0007\u0018\u00010\u0006¢\u0006\u0004\b.\u0010\u0017J-\u00100\u001a\u00020/2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\n\u001a\u00020\t2\u0006\u0010\f\u001a\u00020\u000b2\u0006\u0010\u001b\u001a\u00020\u001a¢\u0006\u0004\b0\u00101J)\u00102\u001a\u00020\u001c*\u00020\u001c2\u0006\u0010\u001b\u001a\u00020\u001a2\u0006\u0010\f\u001a\u00020\u000b2\u0006\u0010\n\u001a\u00020\t¢\u0006\u0004\b2\u00103J!\u00105\u001a\u0004\u0018\u00010\u00072\u0006\u0010\f\u001a\u00020\u000b2\b\u00104\u001a\u0004\u0018\u00010\u0007¢\u0006\u0004\b5\u00106J\u001f\u00108\u001a\u00020\u001a2\u0006\u0010\u001b\u001a\u00020\u001a2\b\u00107\u001a\u0004\u0018\u00010\u0007¢\u0006\u0004\b8\u00109¨\u0006:"}, d2 = {"Lza/h;", "", "<init>", "()V", "Landroid/content/Context;", "context", "", "", "remoteMessageData", "Lh9/c;", "deviceInfo", "LG9/f;", "fileDownloader", "Lta/a;", "actionCommandFactory", "LAa/b;", "remoteMessageMapperFactory", "", "i", "(Landroid/content/Context;Ljava/util/Map;Lh9/c;LG9/f;Lta/a;LAa/b;)V", "remoteMessage", "", "m", "(Ljava/util/Map;)Z", "n", "k", "Lza/k;", "notificationData", "Landroidx/core/app/m$e;", "d", "(Lza/k;Landroid/content/Context;)Landroidx/core/app/m$e;", "h", "(Lh9/c;Lza/k;Landroid/content/Context;)Lza/k;", "p", "(Landroidx/core/app/m$e;Landroid/content/Context;LG9/f;Lza/k;)Landroidx/core/app/m$e;", "LU8/b;", "notificationSettings", "channelId", "o", "(LU8/b;Ljava/lang/String;)Z", "b", "(Landroid/content/Context;)Ljava/lang/String;", "", "Ljava/lang/Runnable;", "f", "(Lta/a;Lza/k;)Ljava/util/List;", "l", "Landroid/app/Notification;", "c", "(Landroid/content/Context;Lh9/c;LG9/f;Lza/k;)Landroid/app/Notification;", "q", "(Landroidx/core/app/m$e;Lza/k;LG9/f;Lh9/c;)Landroidx/core/app/m$e;", "inappData", "g", "(LG9/f;Ljava/lang/String;)Ljava/lang/String;", "inAppDescriptor", "e", "(Lza/k;Ljava/lang/String;)Lza/k;", "mobile-engage_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* renamed from: za.h, reason: case insensitive filesystem */
/* loaded from: classes4.dex */
public final class C18412h {

    /* renamed from: a, reason: collision with root package name */
    public static final C18412h f171669a = new C18412h();
    ...
    public /* synthetic */ class a {
        ...
        static {
            ...
            try {
                iArr[m.f171693a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[m.f171694b.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[m.f171695c.ordinal()] = 3;
    ...
    private final NotificationData h(DeviceInfo deviceInfo, NotificationData notificationData, Context context) {
        if (!G9.a.f11285a.e() || !deviceInfo.getIsDebugMode() || o(deviceInfo.getNotificationSettings(), notificationData.getChannelId())) {
    ...
    @JvmStatic
    public static final void i(Context context, Map<String, String> remoteMessageData, DeviceInfo deviceInfo, G9.f fileDownloader, C17075a actionCommandFactory, Aa.b remoteMessageMapperFactory) {
        ...
        C18412h c18412h = f171669a;
        if (c18412h.l(remoteMessageData)) {
            for (final Runnable runnable : c18412h.f(actionCommandFactory, notificationDataA)) {
                C13500b.b().getConcurrentHandlerHolder().h(new Runnable() { // from class: za.g
        ...
        Notification notificationC = c18412h.c(applicationContext, deviceInfo, fileDownloader, notificationDataA);
    ...
    public static final boolean k(Map<String, String> remoteMessage) {
        ...
        C18412h c18412h = f171669a;
        return c18412h.m(remoteMessage) || c18412h.n(remoteMessage);
    }
    ...
    public final Notification c(Context context, DeviceInfo deviceInfo, G9.f fileDownloader, NotificationData notificationData) {
        Intrinsics.j(context, "context");
        Intrinsics.j(deviceInfo, "deviceInfo");
        Intrinsics.j(fileDownloader, "fileDownloader");
    ...
    public final List<Runnable> f(C17075a actionCommandFactory, NotificationData notificationData) {
        Intrinsics.j(actionCommandFactory, "actionCommandFactory");
        Intrinsics.j(notificationData, "notificationData");
        ...
        if (campaignId != null && campaignId.length() != 0) {
            arrayList.add(new ua.j(C13500b.b().r(), new NotificationInformation(notificationData.getCampaignId())));
        }
        if (jSONArray != null) {
    ...
    public final String g(G9.f fileDownloader, String inappData) throws JSONException {
        Intrinsics.j(fileDownloader, "fileDownloader");
        if (inappData != null) {
            try {
                JSONObject jSONObject = new JSONObject(inappData);
                if (M9.a.a(jSONObject).c("campaign_id", String.class).c("url", String.class).d().isEmpty()) {
                    String string = jSONObject.getString("url");
                    Intrinsics.i(string, "getString(...)");
                    JSONObject jSONObject2 = new JSONObject();
                    jSONObject2.put("campaignId", jSONObject.getString("campaign_id"));
                    jSONObject2.put("url", string);
                    jSONObject2.put("fileUrl", G9.f.f(fileDownloader, string, 0, 2, null));
     ...
     */
    public final m.e q(m.e eVar, NotificationData notificationData, G9.f fileDownloader, DeviceInfo deviceInfo) {
        Intrinsics.j(eVar, "<this>");
        Intrinsics.j(notificationData, "notificationData");
        Intrinsics.j(fileDownloader, "fileDownloader");
        Intrinsics.j(deviceInfo, "deviceInfo");
        G9.g gVar = G9.g.f11291a;
            ...
            switch (style.hashCode()) {
                case -1077038977:
                    if (style.equals("BIG_PICTURE")) {
                        return C18405a.f171663a.a(eVar, notificationData, bitmapF, bitmapF2);
                    }
                    break;
                case -177839924:
                    if (style.equals("THUMBNAIL")) {
                        return p.f171700a.a(eVar, notificationData, bitmapF, bitmapF2);
                    }
                    break;
                case 1547600172:
                    if (style.equals("BIG_TEXT")) {
                        return C18406b.f171664a.a(eVar, notificationData, bitmapF, bitmapF2);
                    }
                    break;
                case 1672907751:
                    if (style.equals("MESSAGE")) {
                        return C18410f.f171667a.a(eVar, notificationData, bitmapF, bitmapF2);
                    }
                    break;
            }
        }
        return C18407c.f171665a.a(eVar, notificationData, bitmapF, bitmapF2);
    }
    ...
    private final boolean o(U8.b notificationSettings, String channelId) {
    ...
    private final m.e p(m.e eVar, Context context, G9.f fVar, NotificationData notificationData) {
        JSONArray jSONArray;
        List<m.a> listM;
        String actions = notificationData.getActions();
        if (actions != null) {
        ...
        if (jSONArray == null || (listM = j.f171672a.c(context, jSONArray, notificationData)) == null) {
            listM = CollectionsKt.m();
        }
        eVar.k(notificationData.getTitle()).j(notificationData.getBody()).y(notificationData.getSmallIconResourceId()).f(false).i(C18409e.f171666a.c(context, e(notificationData, g(fVar, notificationData.getInapp()))));
        int size = listM.size();
