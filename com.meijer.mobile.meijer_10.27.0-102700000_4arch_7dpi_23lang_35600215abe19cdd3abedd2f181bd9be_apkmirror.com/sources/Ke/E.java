...
abstract class E {
    ...
    private void f(byte[] bArr, ByteBuffer byteBuffer, ByteBuffer byteBuffer2) throws GeneralSecurityException {
        ...
        for (int i12 = 0; i12 < i11; i12++) {
            ByteBuffer byteBufferA = a(bArr, this.f16461b + i12);
            if (i12 == i10) {
                Ve.f.c(byteBuffer, byteBuffer2, byteBufferA, iRemaining % 64);
            } else {
                Ve.f.c(byteBuffer, byteBuffer2, byteBufferA, 64);
            }
        }
    }
