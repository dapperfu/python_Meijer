...
public final /* data */ class CustomerSavings implements Parcelable {
    public static final Parcelable.Creator<CustomerSavings> CREATOR = new C2798a();
    ...
    public static final class C2798a implements Parcelable.Creator<CustomerSavings> {
    ...
    public CustomerSavings() {
        this(0.0d, 0.0d, 0.0d, 0.0d, 0.0d, 0.0d, 0, null, l3.f92484c, null);
    }
