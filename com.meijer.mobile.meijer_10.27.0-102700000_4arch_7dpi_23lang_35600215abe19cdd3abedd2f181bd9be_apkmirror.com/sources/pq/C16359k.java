...
@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0005\u001aG\u0010\u000b\u001a\u00020\b*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u00012\u0006\u0010\u0004\u001a\u00020\u00032\u0006\u0010\u0006\u001a\u00020\u00052\f\u0010\t\u001a\b\u0012\u0004\u0012\u00020\b0\u00072\f\u0010\n\u001a\b\u0012\u0004\u0012\u00020\b0\u0007H\u0001¢\u0006\u0004\b\u000b\u0010\f¨\u0006\r"}, d2 = {"LJi/M;", "Landroidx/compose/ui/Modifier;", "modifier", "Lhq/c;", "decorator", "", "cartIsEmpty", "Lkotlin/Function0;", "", "scannerEvent", "checkoutEvent", "b", "(LJi/M;Landroidx/compose/ui/Modifier;Lhq/c;ZLkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;Landroidx/compose/runtime/Composer;I)V", "shopandscan_playstoreRelease"}, k = 2, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* renamed from: pq.k, reason: case insensitive filesystem */
/* loaded from: classes11.dex */
public final class C16359k {
    public static final void b(final LocalThemeScope localThemeScope, final Modifier modifier, final ShopAndScanCartTotalsDecorator decorator, final boolean z10, final Function0<Unit> scannerEvent, final Function0<Unit> checkoutEvent, Composer composer, final int i10) {
        ...
        if ((74899 & i14) == 74898 && composerStartRestartGroup.j()) {
            ...
            if (z10) {
                ...
                AbstractC5607a itemCount = decorator.getItemCount();
                AbstractC5607a subtotal = decorator.getSubtotal();
                int i15 = LocalThemeScope.f15770g | (i14 & 14) | (i14 & 112);
                int i16 = AbstractC5607a.f45514b;
                C13744t.b(localThemeScope, modifier, itemCount, subtotal, composerStartRestartGroup, i15 | (i16 << 6) | (i16 << 9));
                i12 = i14;
                i13 = 0;
            ...
            int iA2 = C5717f.a(composerStartRestartGroup, i13);
            ...
            float f11 = 18;
            float f12 = 50;
            Modifier modifierB = InterfaceC14800I.b(c14801j, J.i(D.l(companion3, H1.h.p(f10), H1.h.p(f10), H1.h.p(f10), H1.h.p(f11)), H1.h.p(f12)), 2.0f, false, 2, null);
            ...
            C13747w.c(localThemeScope, InterfaceC14800I.b(c14801j, J.i(D.m(companion3, 0.0f, H1.h.p(f10), H1.h.p(f10), H1.h.p(f11), 1, null), H1.h.p(f12)), 1.0f, false, 2, null), !z10, checkoutEvent, composerStartRestartGroup, i17 | i18 | (i19 & 7168), 0);
        ...
        if (t0L != null) {
            t0L.a(new Function2() { // from class: pq.j
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return C16359k.c(localThemeScope, modifier, decorator, z10, scannerEvent, checkoutEvent, i10, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
