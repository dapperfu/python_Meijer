...
public final class c {
    ...
    private static final RoundedCornerShape f16b = C16692i.f();
    ...
    private static final n0<Float> f22h = C6327j.l(HttpResponseStatus.REDIRECTION_MULTIPLE_CHOICES, 0, C6292E.d(), 2, null);
    ...
    static final class e extends Lambda implements Function3<Boolean, Composer, Integer, Unit> {
        ...
        public final void a(boolean z10, Composer composer, int i10) {
            ...
            if (z10) {
                ...
                C17906T0.a(J.v(companion, fP), j10, c.f18d, 0L, 0, composer, 390, 24);
                composer.P();
            } else {
    ...
    public static final void b(A0.g gVar, long j10, Modifier modifier, Composer composer, int i10) {
        ...
        if (composerStartRestartGroup.p((i11 & 147) != 146, i11 & 1)) {
            ...
            boolean z10 = true;
            z1<Float> z1VarD = C6317c.d(c((z1) objB2), f22h, 0.0f, null, null, composerStartRestartGroup, 48, 28);
            Modifier modifierD = C16705m.d(modifier, false, a.f23f, 1, null);
            ...
            C13443j.a(modifierD, (Function1) objB3, composerStartRestartGroup, i12);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        } else {
