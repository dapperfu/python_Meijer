...
public final class f {
    ...
    private static final String f11147c = "f";

    /* renamed from: d, reason: collision with root package name */
    private static final ThreadLocal<SimpleDateFormat> f11148d = new a();

    /* renamed from: e, reason: collision with root package name */
    private static final ThreadLocal<SimpleDateFormat> f11149e = new b();

    /* renamed from: f, reason: collision with root package name */
    private static final ThreadLocal<SimpleDateFormat> f11150f = new c();

    /* renamed from: g, reason: collision with root package name */
    private static final List<String> f11151g = i();

    /* renamed from: h, reason: collision with root package name */
    private static final List<String> f11152h = Arrays.asList("ImageWidth", "ImageLength", "PixelXDimension", "PixelYDimension", "Compression", "JPEGInterchangeFormat", "JPEGInterchangeFormatLength", "ThumbnailImageLength", "ThumbnailImageWidth", "ThumbnailOrientation");

    /* renamed from: a, reason: collision with root package name */
    private final androidx.exifinterface.media.a f11153a;
    ...
    private static final class d {
        ...
        static final class a {
            ...
            /* renamed from: a, reason: collision with root package name */
            final double f11155a;

            double a() {
                return this.f11155a / 2.23694d;
            }
    ...
    public void d(f fVar) throws NumberFormatException {
        ArrayList<String> arrayList = new ArrayList(f11151g);
        arrayList.removeAll(f11152h);
        for (String str : arrayList) {
            String strD = this.f11153a.d(str);
            String strD2 = fVar.f11153a.d(str);
            if (strD != null && !strD.equals(strD2)) {
                fVar.f11153a.R(str, strD);
            }
        }
    }

    public String j() {
        return this.f11153a.d("ImageDescription");
    }

    public int k() {
        return this.f11153a.f("ImageLength", 0);
    }
    ...
    */
    public android.location.Location l() {
        /*
            r16 = this;
            r0 = r16
            androidx.exifinterface.media.a r1 = r0.f11153a
            java.lang.String r2 = "GPSProcessingMethod"
            java.lang.String r1 = r1.d(r2)
            androidx.exifinterface.media.a r2 = r0.f11153a
            double[] r2 = r2.j()
            androidx.exifinterface.media.a r3 = r0.f11153a
            r4 = 0
            double r6 = r3.c(r4)
            androidx.exifinterface.media.a r3 = r0.f11153a
            ...
            r3 = r10
        L2d:
            androidx.exifinterface.media.a r11 = r0.f11153a
            java.lang.String r12 = "GPSDateStamp"
            java.lang.String r11 = r11.d(r12)
            androidx.exifinterface.media.a r12 = r0.f11153a
        ...
        L45:
            if (r1 != 0) goto L49
            java.lang.String r1 = G.f.f11147c
        L49:
    ...
    public int m() {
        return this.f11153a.f("Orientation", 0);
    }

    public long o() throws NumberFormatException {
        long jS = s(this.f11153a.d("DateTimeOriginal"));
        if (jS == -1) {
            return -1L;
        }
        String strD = this.f11153a.d("SubSecTimeOriginal");
        if (strD == null) {
            return jS;
        }
        try {
    ...
    public int p() {
        return this.f11153a.f("ImageWidth", 0);
    }
    ...
    public void u(int i10) throws NumberFormatException {
        if (i10 % 90 != 0) {
            P.l(f11147c, String.format(Locale.US, "Can only rotate in right angles (eg. 0, 90, 180, 270). %d is unsupported.", Integer.valueOf(i10)));
            this.f11153a.R("Orientation", String.valueOf(0));
            return;
        }
        int i11 = i10 % 360;
        int iM = m();
        ...
        this.f11153a.R("Orientation", String.valueOf(iM));
    }
