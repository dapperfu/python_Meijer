...
public final class b {
    public static final Snackbar b(Snackbar snackbar) {
        ...
        snackbar.v0(r.b(contextE, f.f2604c, null, false, 6, null));
        View viewFindViewById = snackbar.K().findViewById(ae.f.f44670P);
        Intrinsics.h(viewFindViewById, "null cannot be cast to non-null type android.widget.TextView");
        TextView textView = (TextView) viewFindViewById;
        textView.setGravity(16);
        textView.setCompoundDrawablesWithIntrinsicBounds(i.f2697U, 0, 0, 0);
        textView.setCompoundDrawablePadding(snackbar.E().getResources().getDimensionPixelOffset(h.f2636a));
        return snackbar;
    }

    public static final Snackbar c(final Snackbar snackbar) {
        Intrinsics.j(snackbar, "<this>");
        snackbar.u0(" ", new View.OnClickListener() { // from class: Vj.a
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                b.d(snackbar, view);
            }
        });
        ((TextView) snackbar.K().findViewById(ae.f.f44669O)).setCompoundDrawablesRelativeWithIntrinsicBounds(i.f2735f, 0, 0, 0);
        return snackbar;
    }
