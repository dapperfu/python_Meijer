...
public final class Node extends C14182n {
    ...
    private C14185q pointerEvent;

    /* renamed from: h, reason: collision with root package name and from kotlin metadata */
    private boolean wasIn;

    /* renamed from: d, reason: collision with root package name and from kotlin metadata and from toString */
    private final C14325b pointerIds = new C14325b();
    ...
    private final boolean m(C14185q oldEvent, C14185q newEvent) {
    ...
    */
    public boolean a(Z.C<g1.PointerInputChange> r46, androidx.compose.ui.layout.LayoutCoordinates r47, g1.C14175g r48, boolean r49) {
        /*
    ...
    @Override // g1.C14182n
    public boolean e(C14175g internalPointerEvent) {
        boolean z10 = false;
        z10 = false;
        if (!this.relevantChanges.f() && this.modifierNode.getIsAttached()) {
            C14185q c14185q = this.pointerEvent;
            Intrinsics.g(c14185q);
            LayoutCoordinates layoutCoordinates = this.coordinates;
            Intrinsics.g(layoutCoordinates);
            long jC = layoutCoordinates.c();
            AbstractC5817m abstractC5817mH = this.modifierNode;
            int iA = C5810f0.a(16);
            D0.c cVar = null;
            while (abstractC5817mH != 0) {
                if (abstractC5817mH instanceof q0) {
                    ((q0) abstractC5817mH).s1(c14185q, EnumC14186s.f132680c, jC);
    ...
    @Override // g1.C14182n
    public boolean f(Z.C<PointerInputChange> changes, LayoutCoordinates parentCoordinates, C14175g internalPointerEvent, boolean isInBounds) {
        if (this.relevantChanges.f() || !this.modifierNode.getIsAttached()) {
            return false;
        }
        C14185q c14185q = this.pointerEvent;
        ...
        while (abstractC5817mH != 0) {
            if (abstractC5817mH instanceof q0) {
                ((q0) abstractC5817mH).s1(c14185q, EnumC14186s.f132678a, jC);
            } else if ((abstractC5817mH.getKindSet() & iA) != 0 && (abstractC5817mH instanceof AbstractC5817m)) {
                Modifier.c delegate = abstractC5817mH.getDelegate();
                int i10 = 0;
                abstractC5817mH = abstractC5817mH;
        ...
        if (this.modifierNode.getIsAttached()) {
            AbstractC5817m abstractC5817mH2 = this.modifierNode;
            int iA2 = C5810f0.a(16);
            D0.c cVar2 = null;
            while (abstractC5817mH2 != 0) {
                if (abstractC5817mH2 instanceof q0) {
                    ((q0) abstractC5817mH2).s1(c14185q, EnumC14186s.f132679b, jC);
                } else if ((abstractC5817mH2.getKindSet() & iA2) != 0 && (abstractC5817mH2 instanceof AbstractC5817m)) {
                    Modifier.c delegate2 = abstractC5817mH2.getDelegate();
                    int i12 = 0;
                    abstractC5817mH2 = abstractC5817mH2;
                    while (delegate2 != null) {
                        if ((delegate2.getKindSet() & iA2) != 0) {
                            i12++;
                            if (i12 == 1) {
                                abstractC5817mH2 = delegate2;
                            } else {
                                if (cVar2 == null) {
                                    cVar2 = new D0.c(new Modifier.c[16], 0);
                                }
                                if (abstractC5817mH2 != 0) {
                                    cVar2.c(abstractC5817mH2);
                                    abstractC5817mH2 = 0;
                                }
                                cVar2.c(delegate2);
                            }
                ...
                abstractC5817mH2 = C5815k.h(cVar2);
            }
        }
        return true;
    }
    ...
    public final C14325b getPointerIds() {
    ...
    @Override // g1.C14182n
    public void b(C14175g internalPointerEvent) {
        ...
        this.isIn = false;
        this.hasExited = C14187t.i(c14185q.getType(), C14187t.INSTANCE.b());
    }
