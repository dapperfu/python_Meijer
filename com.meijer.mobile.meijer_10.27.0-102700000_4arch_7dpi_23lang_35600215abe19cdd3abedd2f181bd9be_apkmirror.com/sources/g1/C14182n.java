...
public class C14182n {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    private final D0.c<Node> children = new D0.c<>(new Node[16], 0);

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    private final Z.T<C14182n> removeMatchingPointerInputModifierNodeList = new Z.T<>(10);

    public boolean a(Z.C<PointerInputChange> changes, LayoutCoordinates parentCoordinates, C14175g internalPointerEvent, boolean isInBounds) {
        D0.c<Node> cVar = this.children;
        Node[] c14181mArr = cVar.content;
        int size = cVar.getSize();
        boolean z10 = false;
        for (int i10 = 0; i10 < size; i10++) {
            z10 = c14181mArr[i10].a(changes, parentCoordinates, internalPointerEvent, isInBounds) || z10;
        }
        return z10;
    }
    ...
    public boolean e(C14175g internalPointerEvent) {
        ...
        boolean z10 = false;
        for (int i10 = 0; i10 < size; i10++) {
            z10 = c14181mArr[i10].e(internalPointerEvent) || z10;
        }
    ...
    public boolean f(Z.C<PointerInputChange> changes, LayoutCoordinates parentCoordinates, C14175g internalPointerEvent, boolean isInBounds) {
        ...
        boolean z10 = false;
        for (int i10 = 0; i10 < size; i10++) {
            z10 = c14181mArr[i10].f(changes, parentCoordinates, internalPointerEvent, isInBounds) || z10;
        }
        return z10;
    }
    ...
    public void h(long pointerIdValue, Z.T<Node> hitNodes) {
        ...
        int size = cVar.getSize();
        for (int i10 = 0; i10 < size; i10++) {
            c14181mArr[i10].h(pointerIdValue, hitNodes);
        }
    }
    ...
    public void i(Modifier.c pointerInputModifierNode) {
        ...
        while (this.removeMatchingPointerInputModifierNodeList.h()) {
            C14182n c14182nA = this.removeMatchingPointerInputModifierNodeList.A(r0.get_size() - 1);
            int i10 = 0;
            while (i10 < c14182nA.children.getSize()) {
                Node c14181m = c14182nA.children.content[i10];
                if (Intrinsics.e(c14181m.getModifierNode(), pointerInputModifierNode)) {
                    c14182nA.children.s(c14181m);
                    c14181m.d();
                } else {
                    this.removeMatchingPointerInputModifierNodeList.n(c14181m);
                    i10++;
                }
            }
        }
