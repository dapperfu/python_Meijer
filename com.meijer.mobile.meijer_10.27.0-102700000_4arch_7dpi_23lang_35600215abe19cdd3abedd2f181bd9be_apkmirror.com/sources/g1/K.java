...
@Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\r\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0000\u0018\u00002\u00020\u0001:\u0001\"B\u0007¢\u0006\u0004\b\u0002\u0010\u0003R.\u0010\r\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u00048\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b\u0007\u0010\b\u001a\u0004\b\t\u0010\n\"\u0004\b\u000b\u0010\fR.\u0010\u0015\u001a\u0004\u0018\u00010\u000e2\b\u0010\u000f\u001a\u0004\u0018\u00010\u000e8\u0006@FX\u0086\u000e¢\u0006\u0012\n\u0004\b\t\u0010\u0010\u001a\u0004\b\u0011\u0010\u0012\"\u0004\b\u0013\u0010\u0014R\"\u0010\u001b\u001a\u00020\u00068\u0000@\u0000X\u0080\u000e¢\u0006\u0012\n\u0004\b\u0016\u0010\u0017\u001a\u0004\b\u0007\u0010\u0018\"\u0004\b\u0019\u0010\u001aR\u001a\u0010!\u001a\u00020\u001c8\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u001d\u0010\u001e\u001a\u0004\b\u001f\u0010 ¨\u0006#"}, d2 = {"Lg1/K;", "Lg1/I;", "<init>", "()V", "Lkotlin/Function1;", "Landroid/view/MotionEvent;", "", "b", "Lkotlin/jvm/functions/Function1;", "c", "()Lkotlin/jvm/functions/Function1;", "o", "(Lkotlin/jvm/functions/Function1;)V", "onTouchEvent", "Lg1/S;", "value", "Lg1/S;", "getRequestDisallowInterceptTouchEvent", "()Lg1/S;", "p", "(Lg1/S;)V", "requestDisallowInterceptTouchEvent", "d", "Z", "()Z", "n", "(Z)V", "disallowIntercept", "Lg1/H;", "e", "Lg1/H;", "u", "()Lg1/H;", "pointerInputFilter", "a", "ui_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public final class K implements I {
    ...
    private static final class a {
        ...
        public static final a f132575a = new a("Unknown", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final a f132576b = new a("Dispatching", 1);

        /* renamed from: c, reason: collision with root package name */
        public static final a f132577c = new a("NotDispatching", 2);

        /* renamed from: d, reason: collision with root package name */
        private static final /* synthetic */ a[] f132578d;

        /* renamed from: e, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f132579e;

        static {
            a[] aVarArrA = a();
            f132578d = aVarArrA;
            f132579e = EnumEntriesKt.a(aVarArrA);
        }

        private static final /* synthetic */ a[] a() {
            return new a[]{f132575a, f132576b, f132577c};
        }
    ...
    public static final class b extends H {
        ...
        static final class a extends Lambda implements Function1<MotionEvent, Unit> {
            ...
            public final void a(MotionEvent motionEvent) {
                this.f132582f.c().invoke(motionEvent);
            }
        ...
        static final class C2089b extends Lambda implements Function1<MotionEvent, Unit> {

            /* renamed from: g, reason: collision with root package name */
            final /* synthetic */ K f132584g;
            ...
            public final void a(MotionEvent motionEvent) {
                ...
                if (motionEvent.getActionMasked() == 0) {
                    b bVar = b.this;
                    if (this.f132584g.c().invoke(motionEvent).booleanValue()) {
                        aVar = a.f132576b;
                    } else {
                        aVar = a.f132577c;
                    }
                ...
                this.f132584g.c().invoke(motionEvent);
            }
        }
        ...
        static final class c extends Lambda implements Function1<MotionEvent, Unit> {
            ...
            public final void a(MotionEvent motionEvent) {
                this.f132585f.c().invoke(motionEvent);
            }
        ...
        private final void i() {
            this.state = a.f132575a;
            K.this.n(false);
        }

        @Override // g1.H
        public void d() {
            if (this.state == a.f132576b) {
                M.a(SystemClock.uptimeMillis(), new c(K.this));
                i();
            }
        }

        private final void h(C14185q pointerEvent) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                if (listC.get(i10).p()) {
                    ...
                    this.state = a.f132577c;
                    return;
                }
            }
            LayoutCoordinates layoutCoordinates2 = getLayoutCoordinates();
            if (layoutCoordinates2 != null) {
                M.c(pointerEvent, layoutCoordinates2.r0(U0.f.INSTANCE.c()), new C2089b(K.this));
                if (this.state == a.f132576b) {
                    int size2 = list.size();
                    for (int i11 = 0; i11 < size2; i11++) {
                        listC.get(i11).a();
                    }
                    C14175g internalPointerEvent = pointerEvent.getInternalPointerEvent();
        ...
        @Override // g1.H
        public void e(C14185q pointerEvent, EnumC14186s pass, long bounds) {
            boolean z10;
            List<PointerInputChange> listC = pointerEvent.c();
            ...
            if (this.state != a.f132577c) {
                if (pass == EnumC14186s.f132678a && z10) {
                    h(pointerEvent);
                }
                if (pass == EnumC14186s.f132680c && !z10) {
                    h(pointerEvent);
                }
            }
            if (pass == EnumC14186s.f132680c) {
    ...
    public final void o(Function1<? super MotionEvent, Boolean> function1) {
