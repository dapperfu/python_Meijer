...
public final class X extends Modifier.c implements W, J, H1.d {
    ...
    private C14185q currentEvent = U.f132596a;
    ...
    private final class a<R> implements InterfaceC14171c, H1.d, Continuation<R> {
        ...
        static final class C2090a<T> extends ContinuationImpl {

            /* renamed from: a, reason: collision with root package name */
            Object f132617a;

            /* renamed from: b, reason: collision with root package name */
            /* synthetic */ Object f132618b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ a<R> f132619c;

            /* renamed from: d, reason: collision with root package name */
            int f132620d;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C2090a(a<R> aVar, Continuation<? super C2090a> continuation) {
                super(continuation);
                this.f132619c = aVar;
            }
            ...
            public final Object invokeSuspend(Object obj) {
                this.f132618b = obj;
                this.f132620d |= Integer.MIN_VALUE;
                return this.f132619c.H0(0L, null, this);
            }
        }
        ...
        static final class b extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super Unit>, Object> {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ long f132622b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ a<R> f132623c;
            ...
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new b(this.f132622b, this.f132623c, continuation);
            }
            ...
            */
            public final java.lang.Object invokeSuspend(java.lang.Object r9) {
                ...
                L20:
                    ...
                    long r6 = r6 - r2
                    r8.f132621a = r5
                    java.lang.Object r9 = qv.Z.b(r6, r8)
                    if (r9 != r0) goto L2f
                    goto L37
                L2f:
                    r8.f132621a = r4
                    java.lang.Object r9 = qv.Z.b(r2, r8)
                    if (r9 != r0) goto L38
                L37:
                    return r0
                L38:
                    g1.X$a<R> r9 = r8.f132623c
                    qv.n r9 = g1.X.a.f(r9)
                    if (r9 == 0) goto L54
        ...
        static final class c<T> extends ContinuationImpl {
            ...
            /* renamed from: a, reason: collision with root package name */
            /* synthetic */ Object f132624a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ a<R> f132625b;
            ...
            public final Object invokeSuspend(Object obj) {
                this.f132624a = obj;
                this.f132626c |= Integer.MIN_VALUE;
                return this.f132625b.i0(0L, null, this);
            }
        }
        ...
        public a(Continuation<? super R> continuation) {
            ...
            this.f132612b = X.this;
        }

        @Override // g1.InterfaceC14171c
        public long A0() {
            return X.this.A0();
        }

        public final void B(C14185q event, EnumC14186s pass) {
            InterfaceC16654n<? super C14185q> interfaceC16654n;
            if (pass != this.awaitPass || (interfaceC16654n = this.pointerAwaiter) == null) {
                return;
            }
            this.pointerAwaiter = null;
            interfaceC16654n.resumeWith(Result.b(event));
        }

        @Override // H1.d
        public int E0(float f10) {
            return this.f132612b.E0(f10);
        }

        @Override // H1.l
        /* renamed from: F1 */
        public float getFontScale() {
            return this.f132612b.getFontScale();
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Removed duplicated region for block: B:7:0x0013  */
        /* JADX WARN: Type inference failed for: r11v0, types: [long] */
        /* JADX WARN: Type inference failed for: r11v1, types: [qv.C0] */
        /* JADX WARN: Type inference failed for: r11v3, types: [qv.C0] */
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public <T> java.lang.Object H0(long r11, kotlin.jvm.functions.Function2<? super g1.InterfaceC14171c, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r13, kotlin.coroutines.Continuation<? super T> r14) {
            /*
                r10 = this;
                boolean r0 = r14 instanceof g1.X.a.C2090a
                if (r0 == 0) goto L13
                r0 = r14
                g1.X$a$a r0 = (g1.X.a.C2090a) r0
                int r1 = r0.f132620d
            ...
            L13:
                ...
                r0.<init>(r10, r14)
            L18:
                java.lang.Object r14 = r0.f132618b
                java.lang.Object r1 = kotlin.coroutines.intrinsics.IntrinsicsKt.f()
                int r2 = r0.f132620d
                r3 = 1
                if (r2 == 0) goto L38
                if (r2 != r3) goto L30
                java.lang.Object r11 = r0.f132617a
                qv.C0 r11 = (qv.C0) r11
            ...
            L38:
                ...
                if (r14 > 0) goto L57
                qv.n<? super g1.q> r14 = r10.pointerAwaiter
                if (r14 == 0) goto L57
            ...
            L57:
                ...
                r5 = 0
                r6 = 0
                qv.C0 r11 = qv.C16644i.d(r4, r5, r6, r7, r8, r9)
                r0.f132617a = r11     // Catch: java.lang.Throwable -> L2d
                r0.f132620d = r3     // Catch: java.lang.Throwable -> L2d
                java.lang.Object r14 = r13.invoke(r10, r0)     // Catch: java.lang.Throwable -> L2d
                if (r14 != r1) goto L76
                return r1
            L76:
                androidx.compose.ui.input.pointer.CancelTimeoutCancellationException r12 = androidx.compose.ui.input.pointer.CancelTimeoutCancellationException.f50945a
                r11.d(r12)
                return r14
            L7c:
                androidx.compose.ui.input.pointer.CancelTimeoutCancellationException r13 = androidx.compose.ui.input.pointer.CancelTimeoutCancellationException.f50945a
                r11.d(r13)
                throw r12
            */
        ...
        public float I1(float f10) {
            return this.f132612b.I1(f10);
        }

        @Override // H1.d
        public float K(int i10) {
            return this.f132612b.K(i10);
        }

        @Override // g1.InterfaceC14171c
        public Object K0(EnumC14186s enumC14186s, Continuation<? super C14185q> continuation) {
            C16658p c16658p = new C16658p(IntrinsicsKt.c(continuation), 1);
            c16658p.C();
            this.awaitPass = enumC14186s;
            this.pointerAwaiter = c16658p;
        ...
        public float L(float f10) {
            return this.f132612b.L(f10);
        }

        @Override // H1.d
        public float N0(long j10) {
            return this.f132612b.N0(j10);
        }

        @Override // H1.d
        public int N1(long j10) {
            return this.f132612b.N1(j10);
        }

        @Override // H1.d
        public long T(long j10) {
            return this.f132612b.T(j10);
        }
        ...
        public float getDensity() {
            return this.f132612b.getDensity();
        }
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public <T> java.lang.Object i0(long r5, kotlin.jvm.functions.Function2<? super g1.InterfaceC14171c, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r7, kotlin.coroutines.Continuation<? super T> r8) {
            /*
                r4 = this;
            ...
            L13:
                ...
                r0.<init>(r4, r8)
            L18:
                java.lang.Object r8 = r0.f132624a
                java.lang.Object r1 = kotlin.coroutines.intrinsics.IntrinsicsKt.f()
                int r2 = r0.f132626c
                r3 = 1
                if (r2 == 0) goto L31
            ...
            L31:
                ...
                r0.f132626c = r3     // Catch: androidx.compose.ui.input.pointer.PointerEventTimeoutCancellationException -> L3e
        ...
        public long o(float f10) {
            return this.f132612b.o(f10);
        }

        @Override // H1.d
        public long p(long j10) {
            return this.f132612b.p(j10);
        }
        ...
        public final void s(Throwable cause) {
            InterfaceC16654n<? super C14185q> interfaceC16654n = this.pointerAwaiter;
            if (interfaceC16654n != null) {
                interfaceC16654n.N(cause);
            }
            this.pointerAwaiter = null;
        }
        ...
        public long w(int i10) {
            return this.f132612b.w(i10);
        }

        @Override // H1.d
        public long x(float f10) {
            return this.f132612b.x(f10);
        }
    }
    ...
    public /* synthetic */ class b {
        ...
        static {
            int[] iArr = new int[EnumC14186s.values().length];
            try {
                iArr[EnumC14186s.f132678a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[EnumC14186s.f132680c.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[EnumC14186s.f132679b.ordinal()] = 3;
    ...
    private final void P2(C14185q pointerEvent, EnumC14186s pass) {
        ...
        try {
            ...
            if (i10 == 1 || i10 == 2) {
                ...
                for (int i11 = 0; i11 < size; i11++) {
                    aVarArr[i11].B(pointerEvent, pass);
                }
            } else if (i10 == 3) {
                ...
                if (size2 < aVarArr2.length) {
                    while (size2 >= 0) {
                        aVarArr2[size2].B(pointerEvent, pass);
                        size2--;
                    }
                }
            }
    ...
    @Override // g1.J
    public <R> Object g0(Function2<? super InterfaceC14171c, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        C16658p c16658p = new C16658p(IntrinsicsKt.c(continuation), 1);
        c16658p.C();
        ...
        synchronized (this.pointerHandlersLock) {
            ...
            continuationA.resumeWith(Result.b(Unit.f142422a));
        }
        c16658p.F(new c(aVar));
        Object objV = c16658p.v();
        if (objV == IntrinsicsKt.f()) {
            DebugProbesKt.c(continuation);
        }
    ...
    public void s1(C14185q pointerEvent, EnumC14186s pass, long bounds) {
        ...
        if (pass == EnumC14186s.f132678a) {
            this.currentEvent = pointerEvent;
        }
        if (this.pointerInputJob == null) {
            this.pointerInputJob = C16648k.d(j2(), null, EnumC16624Q.f157614d, new d(null), 1, null);
        }
    ...
    @Override // androidx.compose.ui.node.q0
    public void v1() {
        C14185q c14185q = this.lastPointerEvent;
        if (c14185q == null) {
            return;
        }
        ...
        for (int i10 = 0; i10 < size; i10++) {
            if (listC.get(i10).getPressed()) {
                ...
                C14185q c14185q2 = new C14185q(arrayList);
                this.currentEvent = c14185q2;
                P2(c14185q2, EnumC14186s.f132678a);
                P2(c14185q2, EnumC14186s.f132679b);
                P2(c14185q2, EnumC14186s.f132680c);
    ...
    /* renamed from: F1 */
    public float getFontScale() {
        return C5815k.o(this).getDensity().getFontScale();
    }
    ...
    @Override // H1.d
    public float getDensity() {
        return C5815k.o(this).getDensity().getDensity();
    }

    @Override // g1.J
    public Q1 getViewConfiguration() {
        return C5815k.o(this).getViewConfiguration();
    }
