...
public final class F {
    ...
    public final int b(D pointerEvent, P positionCalculator, boolean isInBounds) {
        ...
        try {
            ...
            C14175g c14175gB = this.pointerInputChangeEventProducer.b(pointerEvent, positionCalculator);
            int iM = c14175gB.b().m();
            for (int i10 = 0; i10 < iM; i10++) {
                PointerInputChange pointerInputChangeN = c14175gB.b().n(i10);
            ...
            z10 = true;
            int iM2 = c14175gB.b().m();
            for (int i11 = 0; i11 < iM2; i11++) {
                PointerInputChange pointerInputChangeN2 = c14175gB.b().n(i11);
            ...
            boolean zD = this.hitPathTracker.d(c14175gB, isInBounds);
            if (c14175gB.getSuppressMovementConsumption()) {
                z11 = false;
            } else {
                int iM3 = c14175gB.b().m();
                for (int i12 = 0; i12 < iM3; i12++) {
                    PointerInputChange pointerInputChangeN3 = c14175gB.b().n(i12);
    ...
    public F(LayoutNode layoutNode) {
        ...
        this.hitPathTracker = new C14173e(layoutNode.getCoordinates());
    }
}
