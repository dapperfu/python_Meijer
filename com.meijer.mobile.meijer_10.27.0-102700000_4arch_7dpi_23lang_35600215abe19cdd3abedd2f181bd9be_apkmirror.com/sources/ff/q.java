...
public final class q {
    static int b(List<?> list, Object obj) {
        ...
        while (listIterator.hasNext()) {
            if (C13654e.a(obj, listIterator.next())) {
    ...
    static int d(List<?> list, Object obj) {
        ...
        while (listIterator.hasPrevious()) {
            if (C13654e.a(obj, listIterator.previous())) {
    ...
    public static <E> ArrayList<E> f(int i10) {
        C13887c.a(i10, "initialArraySize");
        return new ArrayList<>(i10);
    }

    static boolean a(List<?> list, Object obj) {
        if (obj == C13655f.h(list)) {
            return true;
        }
        ...
        if ((list instanceof RandomAccess) && (list2 instanceof RandomAccess)) {
            for (int i10 = 0; i10 < size; i10++) {
                if (!C13654e.a(list.get(i10), list2.get(i10))) {
                    return false;
                }
            }
            return true;
