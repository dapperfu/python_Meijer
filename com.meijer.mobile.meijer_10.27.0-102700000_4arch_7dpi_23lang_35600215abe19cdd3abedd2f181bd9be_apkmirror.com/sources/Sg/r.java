...
final class r {
    ...
    private static final Map<String, a> f33632a;

    /* renamed from: b, reason: collision with root package name */
    private static final Map<String, a> f33633b;

    /* renamed from: c, reason: collision with root package name */
    private static final Map<String, a> f33634c;

    /* renamed from: d, reason: collision with root package name */
    private static final Map<String, a> f33635d;
    ...
    static {
        ...
        for (int i10 = 90; i10 <= 99; i10++) {
            f33632a.put(String.valueOf(i10), a.b(30));
        }
        ...
        for (int i11 = 310; i11 <= 316; i11++) {
            f33634c.put(String.valueOf(i11), a.a(6));
        }
        for (int i12 = 320; i12 <= 337; i12++) {
            f33634c.put(String.valueOf(i12), a.a(6));
        }
        for (int i13 = 340; i13 <= 357; i13++) {
            f33634c.put(String.valueOf(i13), a.a(6));
        }
        for (int i14 = 360; i14 <= 369; i14++) {
            f33634c.put(String.valueOf(i14), a.a(6));
        }
        Map<String, a> map3 = f33634c;
        map3.put("390", a.b(15));
        map3.put("391", a.b(18));
        map3.put("392", a.b(15));
        map3.put("393", a.b(18));
    ...
    static String a(String str) throws NotFoundException {
        ...
        if (str.length() >= 2) {
            a aVar = f33632a.get(str.substring(0, 2));
            if (aVar != null) {
                if (aVar.f33636a) {
                    return c(2, aVar.f33637b, str);
                }
                return b(2, aVar.f33637b, str);
            }
            if (str.length() >= 3) {
                String strSubstring = str.substring(0, 3);
                a aVar2 = f33633b.get(strSubstring);
                if (aVar2 != null) {
                    if (aVar2.f33636a) {
                        return c(3, aVar2.f33637b, str);
                    }
                    return b(3, aVar2.f33637b, str);
                }
                if (str.length() >= 4) {
                    a aVar3 = f33634c.get(strSubstring);
                    if (aVar3 != null) {
                        if (aVar3.f33636a) {
                            return c(4, aVar3.f33637b, str);
                        }
                        return b(4, aVar3.f33637b, str);
                    }
                    a aVar4 = f33635d.get(str.substring(0, 4));
                    if (aVar4 != null) {
                        if (aVar4.f33636a) {
                            return c(4, aVar4.f33637b, str);
                        }
                        return b(4, aVar4.f33637b, str);
                    }
