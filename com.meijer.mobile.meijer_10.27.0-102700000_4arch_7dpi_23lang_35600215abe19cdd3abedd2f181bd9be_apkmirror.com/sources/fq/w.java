...
@Metadata(d1 = {"\u0000B\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\t\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0006\u001aß\u0001\u0010\u0016\u001a\u00020\t*\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00012\u0006\u0010\u0004\u001a\u00020\u00032\n\u0010\u0007\u001a\u00060\u0005j\u0002`\u00062\u0016\u0010\n\u001a\u0012\u0012\b\u0012\u00060\u0005j\u0002`\u0006\u0012\u0004\u0012\u00020\t0\b2\f\u0010\f\u001a\b\u0012\u0004\u0012\u00020\t0\u000b2\u0016\u0010\r\u001a\u0012\u0012\b\u0012\u00060\u0005j\u0002`\u0006\u0012\u0004\u0012\u00020\t0\b2 \u0010\u0011\u001a\u001c\u0012\b\u0012\u00060\u000fj\u0002`\u0010\u0012\b\u0012\u00060\u0005j\u0002`\u0006\u0012\u0004\u0012\u00020\t0\u000e2\u001c\u0010\u0013\u001a\u0018\u0012\b\u0012\u00060\u0005j\u0002`\u0006\u0012\u0004\u0012\u00020\u0012\u0012\u0004\u0012\u00020\t0\u000e2\u0016\u0010\u0014\u001a\u0012\u0012\b\u0012\u00060\u0005j\u0002`\u0006\u0012\u0004\u0012\u00020\t0\b2\u0016\u0010\u0015\u001a\u0012\u0012\b\u0012\u00060\u0005j\u0002`\u0006\u0012\u0004\u0012\u00020\t0\bH\u0001¢\u0006\u0004\b\u0016\u0010\u0017¨\u0006\u0018"}, d2 = {"LJi/M;", "Landroidx/compose/ui/Modifier;", "modifier", "Lhq/f;", "decorator", "", "Lcom/meijer/mobile/shopandscan/domain/model/ShopAndScanItemLocalID;", "quantityStepperSelected", "Lkotlin/Function1;", "", "onFocusedQuantityStepper", "Lkotlin/Function0;", "onUnfocusedQuantityStepper", "onDismissRestriction", "Lkotlin/Function2;", "", "Lcom/meijer/mobile/coupon/model/common/OfferId;", "onCouponAction", "", "onUpdateItemQuantity", "onSyncItem", "onRemoveItem", "h", "(LJi/M;Landroidx/compose/ui/Modifier;Lhq/f;Ljava/lang/String;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/Composer;III)V", "shopandscan_playstoreRelease"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class w {
    ...
    static final class a implements Function3<InterfaceC14926b0, Composer, Integer, Unit> {
        ...
        final /* synthetic */ ShopAndScanItemDecorator f131337a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f131338b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ Function1<String, Unit> f131339c;
        ...
        a(ShopAndScanItemDecorator shopAndScanItemDecorator, LocalThemeScope localThemeScope, Function1<? super String, Unit> function1) {
            this.f131337a = shopAndScanItemDecorator;
            this.f131338b = localThemeScope;
            this.f131339c = function1;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Unit d(final Function1 function1, final ShopAndScanItemDecorator shopAndScanItemDecorator, Ci.o AdsInlineNotification) {
            Intrinsics.j(AdsInlineNotification, "$this$AdsInlineNotification");
            AdsInlineNotification.Q(new Function0() { // from class: fq.v
        ...
        public final void c(InterfaceC14926b0 Assemble, Composer composer, int i10) {
            ...
            AbstractC5607a title = this.f131337a.getRestriction().getTitle();
            int i11 = AbstractC5607a.f45514b;
            String strA = C6408b.a(title, composer, i11);
            String strA2 = C6408b.a(this.f131337a.getRestriction().getDescription(), composer, i11);
            LocalThemeScope localThemeScope = this.f131338b;
            composer.startReplaceGroup(-1633490746);
            boolean zV = composer.V(this.f131339c) | composer.D(this.f131337a);
            final Function1<String, Unit> function1 = this.f131339c;
            final ShopAndScanItemDecorator shopAndScanItemDecorator = this.f131337a;
            Object objB = composer.B();
            if (zV || objB == Composer.INSTANCE.a()) {
                objB = new Function1() { // from class: fq.u
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
                        return w.a.d(function1, shopAndScanItemDecorator, (Ci.o) obj);
                    }
                };
                composer.t(objB);
            }
            composer.P();
            Ci.j.i(localThemeScope, null, strA2, strA, warning, (Function1) objB, composer, LocalThemeScope.f15770g | (q1.m.Inline.f140121h << 12), 1);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    public static final void h(final LocalThemeScope localThemeScope, Modifier modifier, final ShopAndScanItemDecorator decorator, final String quantityStepperSelected, Function1<? super String, Unit> function1, Function0<Unit> onUnfocusedQuantityStepper, final Function1<? super String, Unit> onDismissRestriction, final Function2<? super Long, ? super String, Unit> onCouponAction, Function2<? super String, ? super Integer, Unit> onUpdateItemQuantity, final Function1<? super String, Unit> onSyncItem, final Function1<? super String, Unit> onRemoveItem, Composer composer, final int i10, final int i11, final int i12) {
        ...
        if ((i13 & 306783379) == 306783378 && (i14 & 3) == 2 && composerStartRestartGroup.j()) {
            ...
            MeasurePolicy measurePolicyB = G.b(c5658d.e(), companion2.l(), composerStartRestartGroup, 6);
            ...
            int i21 = LocalThemeScope.f15770g;
            int i22 = i20 & 14;
            Modifier modifier5 = modifier4;
            b0.b(localThemeScope, null, isLoading, imageUrl, imageType, composerStartRestartGroup, i21 | i22, 1);
            Modifier modifierB = InterfaceC14800I.b(c14801j, modifier5, 2.0f, false, 2, null);
            String localId = decorator.getLocalId();
            AbstractC5607a primaryText = decorator.getPrimaryText();
            AbstractC5607a primarySupportingText = decorator.getPrimarySupportingText();
            AbstractC5607a topText = decorator.getTopText();
            AbstractC5607a bottomText = decorator.getBottomText();
            AbstractC5607a bottomSupportingText = decorator.getBottomSupportingText();
            ...
            composerStartRestartGroup.P();
            int i23 = AbstractC5607a.f45514b;
            ...
            if (decorator.getRestriction() == null || decorator.getRestriction().getIsDismissed()) {
                ...
                z10 = true;
                i15 = i21;
                Q.e(localThemeScope, a1.f139760a, ComposableLambdaKt.c(-1432023313, true, new a(shopAndScanItemDecorator, localThemeScope, onDismissRestriction), composerStartRestartGroup, 54), composerStartRestartGroup, i15 | 384 | i22 | (a1.f139761b << 3));
                composerStartRestartGroup.v();
            }
            composerStartRestartGroup.P();
            ...
            if (zE) {
                ...
                z11 = z10;
                i17 = i20;
                Modifier modifierH2 = c5664j.h(androidx.compose.foundation.b.d(companion, C5346q0.q(localThemeScope.getAdsColors().getAdsColorUIBackground01().getColor(), 0.5f, 0.0f, 0.0f, 0.0f, 14, null), null, 2, null));
                float f11 = 15;
                C5662h.a(D.m(modifierH2, 0.0f, H1.h.p(f11), H1.h.p(f11), 0.0f, 9, null), composerStartRestartGroup, r13);
            } else {
                z11 = z10;
                i16 = i15;
                i17 = i20;
