...
public final class y {
    public static final void b(final LocalThemeScope localThemeScope, final Modifier modifier, Composer composer, final int i10, final int i11) {
        ...
        Composer composerStartRestartGroup = composer.startRestartGroup(751124008);
        int i13 = i11 & 1;
        if (i13 != 0) {
            i12 = i10 | 48;
        } else if ((i10 & 48) == 0) {
        ...
        if ((i12 & 17) == 16 && composerStartRestartGroup.j()) {
            ...
            if (ComposerKt.M()) {
                ComposerKt.U(751124008, i12, -1, "com.meijer.mobile.shopandscan.presentation.component.item.WarningImageComponent (WarningImageComponent.kt:23)");
            }
            ...
            C13457y.a(C16190d.c(com.meijer.mobile.shopandscan.b.f116755a, composerStartRestartGroup, 0), null, J.e(C5664j.f48612a.g(Modifier.INSTANCE, companion.e()), 0.9f), null, null, 0.0f, null, composerStartRestartGroup, 48, BinsView.TOTE_HEIGHT_DP);
        ...
        if (t0L != null) {
            t0L.a(new Function2() { // from class: fq.x
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return y.c(localThemeScope, modifier, i10, i11, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
