...
public abstract class c extends l.e {
    ...
    public c(Context context, int i10) {
        ...
        paint.setColor(Z1.b.c(context, P.f98654g));
        paint.setTypeface(Typeface.DEFAULT_BOLD);
        paint.setTextSize(context.getResources().getDimensionPixelSize(Q.f98661g));
        paint.setAntiAlias(true);
        paint2.setColor(Z1.b.c(context, i10));
        this.pad = context.getResources().getDimensionPixelOffset(Q.f98656b);
        this.margin = context.getResources().getDimensionPixelOffset(Q.f98662h);
        String string = context.getString(Nr.g.f22717X);
        Intrinsics.i(string, "getString(...)");
        String strSubstring = string.substring(0, StringsKt.o0(string, ' ', 0, false, 6, null));
        Intrinsics.i(strSubstring, "substring(...)");
        this.textNot = strSubstring;
        String strSubstring2 = string.substring(StringsKt.o0(string, ' ', 0, false, 6, null) + 1);
