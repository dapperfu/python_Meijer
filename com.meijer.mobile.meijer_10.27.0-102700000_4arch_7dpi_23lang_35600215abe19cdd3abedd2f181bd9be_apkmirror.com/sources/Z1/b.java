...
public class b {
    ...
    private static final Object f42263a = new Object();
    ...
    public static Executor h(Context context) {
        return Build.VERSION.SDK_INT >= 28 ? e.a(context) : C14839g.a(new Handler(context.getMainLooper()));
    }
    ...
    public static int c(Context context, int i10) {
        return C0894b.a(context, i10);
    }

    public static ColorStateList d(Context context, int i10) {
        return C6187h.e(context.getResources(), i10, context.getTheme());
    }
