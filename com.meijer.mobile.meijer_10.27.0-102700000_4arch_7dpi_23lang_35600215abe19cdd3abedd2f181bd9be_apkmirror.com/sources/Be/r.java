...
public final class r {
    ...
    private static class b<T> implements q<T>, Serializable {
        ...
        private final List<? extends q<? super T>> f2212a;

        @Override // Be.q
        public boolean apply(T t10) {
            for (int i10 = 0; i10 < this.f2212a.size(); i10++) {
                if (!this.f2212a.get(i10).apply(t10)) {
                    return false;
                }
            }
            return true;
        ...
        public int hashCode() {
            return this.f2212a.hashCode() + 306654252;
        }

        public String toString() {
            return r.d("and", this.f2212a);
        }
    }
