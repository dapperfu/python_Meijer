...
public final class u {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f2231a[TimeUnit.MICROSECONDS.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f2231a[TimeUnit.MILLISECONDS.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f2231a[TimeUnit.SECONDS.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f2231a[TimeUnit.MINUTES.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f2231a[TimeUnit.HOURS.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f2231a[TimeUnit.DAYS.ordinal()] = 7;
    ...
    private static String a(TimeUnit timeUnit) {
        switch (a.f2231a[timeUnit.ordinal()]) {
            case 1:
                return "ns";
            case 2:
                return "μs";
    ...
    private long e() {
        return this.f2228b ? (this.f2227a.a() - this.f2230d) + this.f2229c : this.f2229c;
    }
    ...
    public u g() {
        p.x(!this.f2228b, "This stopwatch is already running.");
        this.f2228b = true;
        this.f2230d = this.f2227a.a();
        return this;
    }
