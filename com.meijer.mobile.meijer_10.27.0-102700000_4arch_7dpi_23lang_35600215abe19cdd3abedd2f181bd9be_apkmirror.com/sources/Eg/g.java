...
public final class g {
    ...
    private static final String f8997a = "g";

    /* renamed from: b, reason: collision with root package name */
    private static final Pattern f8998b = Pattern.compile(",");
                    ...
                    if (extras.containsKey(strName)) {
                        if (dVar.a().equals(Void.class)) {
                            ...
                            if (dVar.a().isInstance(obj)) {
                                ...
                                FS.log_w(f8997a, "Ignoring hint " + dVar + " because it is not assignable from " + obj);
                            }
                        }
                    }
                }
            }
            FS.log_i(f8997a, "Hints from the Intent: " + enumMap);
            return enumMap;
        }
        return null;
    }
