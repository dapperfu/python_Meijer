...
public final class p {
    ...
    private static final Charset f11458a = Charset.defaultCharset();

    /* renamed from: b, reason: collision with root package name */
    public static final Charset f11459b;

    /* renamed from: c, reason: collision with root package name */
    public static final Charset f11460c;

    /* renamed from: d, reason: collision with root package name */
    private static final Charset f11461d;

    /* renamed from: e, reason: collision with root package name */
    private static final boolean f11462e;
    ...
    */
    public static java.nio.charset.Charset a(byte[] r21, java.util.Map<com.google.zxing.d, ?> r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: Gg.p.a(byte[], java.util.Map):java.nio.charset.Charset");
    }
    ...
    static {
        ...
        f11459b = charsetForName;
        try {
            charsetForName2 = Charset.forName("GB2312");
        } catch (UnsupportedCharsetException unused2) {
            charsetForName2 = null;
        }
        f11460c = charsetForName2;
        try {
            charsetForName3 = Charset.forName("EUC_JP");
        } catch (UnsupportedCharsetException unused3) {
        }
        f11461d = charsetForName3;
        Charset charset = f11459b;
        if ((charset != null && charset.equals(f11458a)) || (charsetForName3 != null && charsetForName3.equals(f11458a))) {
            z10 = true;
        } else {
            z10 = false;
        }
