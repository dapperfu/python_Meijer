...
@Metadata(d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0000\u0018\u00002\u00020\u0001B\u0017\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0006\u0010\u0007J!\u0010\f\u001a\u0004\u0018\u00010\b2\u0006\u0010\t\u001a\u00020\b2\u0006\u0010\u000b\u001a\u00020\nH\u0002¢\u0006\u0004\b\f\u0010\rJ)\u0010\u0014\u001a\u0004\u0018\u00010\u00132\u0006\u0010\u000e\u001a\u00020\n2\u0006\u0010\u0010\u001a\u00020\u000f2\u0006\u0010\u0012\u001a\u00020\u0011H\u0000¢\u0006\u0004\b\u0014\u0010\u0015R\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\f\u0010\u0016R\u0014\u0010\u0005\u001a\u00020\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0014\u0010\u0017¨\u0006\u0018"}, d2 = {"LG7/a;", "", "Lk8/s;", "v3configParser", "LG7/f;", "v4configParser", "<init>", "(Lk8/s;LG7/f;)V", "Lk8/q;", "oldServerConfig", "", "json", "a", "(Lk8/q;Ljava/lang/String;)Lk8/q;", "jsonBody", "Lx7/f;", "serverData", "LW7/a;", "endPointInfo", "Ly7/c;", "b", "(Ljava/lang/String;Lx7/f;LW7/a;)Ly7/c;", "Lk8/s;", "LG7/f;", "com.dynatrace.agent_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
...
public final class a {
    ...
    private final q a(q oldServerConfig, String json) throws Exception {
        ...
        if (!jSONObject2.has("bp3Config")) {
            x8.f.a("dtxCommunication", "config v3 parsing: BPv3 config missing");
            return null;
        }
        ...
        if (!z10 || lB == null || lB.longValue() <= oldServerConfig.A()) {
            ...
            p.b bVarJ2 = p.j();
            this.v3configParser.a(bVarJ, bVarJ2, jSONObject.getJSONObject("environmentConfig").getJSONObject("bp3Config"));
            this.v3configParser.c(bVarJ, bVarJ2, jSONObject.getJSONObject("appConfig").getJSONObject("bp3Config"));
            bVarJ.x(bVarJ2.j());
        }
        this.v3configParser.e(bVarJ, jSONObject2.getJSONObject("bp3Config"));
        return bVarJ.p();
    }
    ...
    public final ServerDataUpdate b(String jsonBody, LocalServerData serverData, EndPointInfo endPointInfo) throws JSONException {
        ...
        try {
            ...
            x8.f.b("dtxCommunication", "config v3 parsing: invalid JSON", e10);
            return null;
        }
    }
}
