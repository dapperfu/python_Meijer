...
public final class c implements q {
    ...
    public Gg.b a(String str, com.google.zxing.a aVar, int i10, int i11, Map<f, ?> map) throws NumberFormatException {
        int i12 = 0;
        if (map != null) {
    ...
    private static Gg.b b(String str, com.google.zxing.a aVar, int i10, int i11, Charset charset, int i12, int i13) {
        if (aVar == com.google.zxing.a.AZTEC) {
            return c(Dg.c.d(str, i12, i13, charset), i10, i11);
        }
        throw new IllegalArgumentException("Can only encode AZTEC, but got " + aVar);
    }

    private static Gg.b c(Dg.a aVar, int i10, int i11) {
        Gg.b bVarA = aVar.a();
        if (bVarA != null) {
            int iM = bVarA.m();
            int iJ = bVarA.j();
