...
public final class e {
    public static final String d(String str, final String separator) {
        ...
        return new Regex("(?<=[a-z])(?=[A-Z])|(?<=[A-Z])(?=[A-Z][a-z])").l(str, new Function1() { // from class: Fk.b
    ...
    public static final String g(String str) {
        ...
        return CollectionsKt.B0(StringsKt.a1(lowerCase, new String[]{" "}, false, 0, 6, null), " ", null, null, 0, null, new Function1() { // from class: Fk.c
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    public static final String h(String str, final List<String> excludeWords) {
        ...
        String lowerCase = str.toLowerCase(Locale.ROOT);
        Intrinsics.i(lowerCase, "toLowerCase(...)");
        return CollectionsKt.B0(StringsKt.a1(lowerCase, new String[]{" "}, false, 0, 6, null), " ", null, null, 0, null, new Function1() { // from class: Fk.d
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
