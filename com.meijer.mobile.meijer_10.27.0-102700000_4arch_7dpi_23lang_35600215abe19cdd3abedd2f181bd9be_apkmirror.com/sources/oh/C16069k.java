...
class C16069k {
    ...
    private final boolean f153764a;

    /* renamed from: b, reason: collision with root package name */
    private final AttributeRef[] f153765b;
    ...
    private AttributeRef b(LDContext lDContext, int i10, String str, AttributeRef attributeRef) {
        AttributeRef[] attributeRefArr = this.f153765b;
    ...
    private List<String> g(JsonWriter jsonWriter, LDContext lDContext, String str, LDValue lDValue, List<String> list, boolean z10) throws IOException {
        return this.f153764a ? a(list, str) : (z10 && lDContext.u()) ? a(list, str) : h(jsonWriter, lDContext, 0, str, lDValue, null, list);
    }
    ...
    C16069k(boolean z10, AttributeRef[] attributeRefArr) {
        this.f153764a = z10;
        this.f153765b = attributeRefArr == null ? new AttributeRef[0] : attributeRefArr;
    }
