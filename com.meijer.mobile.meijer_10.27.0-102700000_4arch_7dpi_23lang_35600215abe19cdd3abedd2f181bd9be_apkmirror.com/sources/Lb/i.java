...
public class i {
    ...
    private static SecureRandom f17949b = new SecureRandom();

    /* renamed from: a, reason: collision with root package name */
    private SecretKeySpec f17950a;
    ...
    private i(String str, byte[] bArr) throws Exception {
        this.f17950a = new SecretKeySpec(SecretKeyFactory.getInstance("PBKDF2WithHmacSHA1").generateSecret(new PBEKeySpec(str.toCharArray(), bArr, 3, 128)).getEncoded(), "AES");
    }

    public byte[] a() {
        byte[] bArr = new byte[16];
        f17949b.nextBytes(bArr);
        return bArr;
    }
    ...
    public final byte[] d(byte[] bArr) throws Exception {
        ...
        cipher.init(2, this.f17950a, ivParameterSpec);
    ...
    public final byte[] c(byte[] bArr) throws Exception {
        ...
        Cipher cipher = Cipher.getInstance("AES/CFB/PKCS5Padding");
        cipher.init(1, this.f17950a, ivParameterSpec);
