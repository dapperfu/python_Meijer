...
public class m<T> {
    ...
    static final C6380a f17961c = C6381b.a(m.class.getName());

    /* renamed from: a, reason: collision with root package name */
    private final Class<T> f17962a;

    /* renamed from: b, reason: collision with root package name */
    private List<Method> f17963b;

    private synchronized List<Method> b(Class<?> cls) {
        try {
            List<Method> list = this.f17963b;
            if (list != null) {
                return list;
            }
    ...
    private Method a(String str, Class<?> cls) throws SecurityException {
        ...
        for (Method method : b(this.f17962a)) {
    ...
    */
    public final void c(T r5, java.lang.String r6, java.lang.Object r7) throws java.lang.IllegalAccessException, java.lang.SecurityException, java.lang.IllegalArgumentException, java.lang.reflect.InvocationTargetException {
        ...
        L51:
            return
        L52:
            java.lang.Class<T> r5 = r4.f17962a
            r5.getName()
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: Lb.m.c(java.lang.Object, java.lang.String, java.lang.Object):void");
    }
}
