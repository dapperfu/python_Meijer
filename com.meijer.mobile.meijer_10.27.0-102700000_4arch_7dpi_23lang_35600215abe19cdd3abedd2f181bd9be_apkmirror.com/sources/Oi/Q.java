...
@Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0006\n\u0002\u0010\u000e\n\u0002\b\u0006\b\u0001\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u0013\u0010\b\u001a\u00020\u0007*\u00020\u0006H\u0017¢\u0006\u0004\b\b\u0010\tJ\u0013\u0010\n\u001a\u00020\u0007*\u00020\u0006H\u0017¢\u0006\u0004\b\n\u0010\tR\u001a\u0010\u0003\u001a\u00020\u00028\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\b\u0010\u000b\u001a\u0004\b\f\u0010\rR\u001a\u0010\u0013\u001a\u00020\u000e8\u0016X\u0096D¢\u0006\f\n\u0004\b\u000f\u0010\u0010\u001a\u0004\b\u0011\u0010\u0012¨\u0006\u0014"}, d2 = {"LOi/Q;", "LNi/c;", "LNi/l$q;", "state", "<init>", "(LNi/l$q;)V", "LJi/M;", "", "a", "(LJi/M;Landroidx/compose/runtime/Composer;I)V", "f", "LNi/l$q;", "m", "()LNi/l$q;", "", "b", "Ljava/lang/String;", "getName", "()Ljava/lang/String;", "name", "library_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* loaded from: classes7.dex */
public final class Q implements Ni.c {
    ...
    static final class a implements Function3<InterfaceC15343c, Composer, Integer, Unit> {
        ...
        final /* synthetic */ LocalThemeScope f23785a;

        a(LocalThemeScope localThemeScope) {
            this.f23785a = localThemeScope;
        }
        ...
        public final void a(InterfaceC15343c item, Composer composer, int i10) {
            ...
            Ri.b.b(this.f23785a, null, "Horizontal", "1.0", null, C4475a.f23789a.e(), composer, 200064, 9);
            if (ComposerKt.M()) {
                ComposerKt.T();
            }
        }
    ...
    static final class b implements Function3<InterfaceC15343c, Composer, Integer, Unit> {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ LocalThemeScope f23786a;

        b(LocalThemeScope localThemeScope) {
            this.f23786a = localThemeScope;
        }
    ...
    public static final Unit k(Q q10, LocalThemeScope localThemeScope, int i10, Composer composer, int i11) {
        q10.a(localThemeScope, composer, J0.a(i10 | 1));
        return Unit.f142422a;
    }
    ...
    public void a(final LocalThemeScope localThemeScope, Composer composer, final int i10) {
        ...
        if ((i11 & 3) == 2 && composerStartRestartGroup.j()) {
            ...
            if (z10 || objB == Composer.INSTANCE.a()) {
                objB = new Function1() { // from class: Oi.N
        ...
        if (t0L != null) {
            t0L.a(new Function2() { // from class: Oi.O
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return Q.k(this.f23777a, localThemeScope, i10, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    public void f(final LocalThemeScope localThemeScope, Composer composer, final int i10) {
        ...
        T0 t0L = composerStartRestartGroup.l();
        if (t0L != null) {
            t0L.a(new Function2() { // from class: Oi.P
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return Q.l(this.f23780a, localThemeScope, i10, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
