...
public final class C5283b {
    ...
    private static final class a {
        ...
        public static final a f35405a = new a("REGISTERED", 0);

        /* renamed from: b, reason: collision with root package name */
        public static final a f35406b = new a("CLEAR", 1);

        /* renamed from: c, reason: collision with root package name */
        public static final a f35407c = new a("FORCE_REFRESH", 2);

        /* renamed from: d, reason: collision with root package name */
        private static final /* synthetic */ a[] f35408d;

        /* renamed from: e, reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f35409e;

        static {
            a[] aVarArrA = a();
            f35408d = aVarArrA;
            f35409e = EnumEntriesKt.a(aVarArrA);
        }

        private static final /* synthetic */ a[] a() {
            return new a[]{f35405a, f35406b, f35407c};
        }
    ...
    public final void b(String tag) {
        ...
        this.registeredFragments.put(tag, a.f35406b);
        Iterator<a> it = this.registeredFragments.values().iterator();
        while (it.hasNext()) {
            if (it.next() == a.f35405a) {
                return;
            }
        }
        ...
        while (it2.hasNext()) {
            this.registeredFragments.put((String) it2.next(), a.f35405a);
        }
    }
    ...
    public final boolean f(String tag) {
        Intrinsics.j(tag, "tag");
        if (this.registeredFragments.get(tag) != a.f35407c) {
            return false;
        }
        this.registeredFragments.put(tag, a.f35405a);
        return true;
    }
