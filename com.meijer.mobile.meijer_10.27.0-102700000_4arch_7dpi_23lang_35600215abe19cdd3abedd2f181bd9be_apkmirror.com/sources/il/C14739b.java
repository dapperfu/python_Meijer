...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a\u0013\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u0000¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lcom/meijer/mobile/digitalshopping/api/cart/model/AvailablePartnerStoreLocationOmsResponse;", "Lej/c;", "a", "(Lcom/meijer/mobile/digitalshopping/api/cart/model/AvailablePartnerStoreLocationOmsResponse;)Lej/c;", "digitalshopping_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class C14739b {
    public static final AvailablePartnerStoreLocations a(AvailablePartnerStoreLocationOmsResponse availablePartnerStoreLocationOmsResponse) {
        ...
        List listM = null;
        PartnerStoreLocation partnerStoreLocationA = facility != null ? C14740c.a(facility) : null;
        ...
        if (listD != null) {
            ...
            while (it.hasNext()) {
                listM.add(C14741d.a((SupplementalEligibilityOmsResponse) it.next()));
            }
        }
        if (listM == null) {
