...
final class z<T> implements List<T>, KMutableList {
    ...
    public static final class a implements ListIterator<T>, KMutableListIterator {
        ...
        final /* synthetic */ Ref.IntRef f18800a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ z<T> f18801b;
        ...
        public boolean hasNext() {
            return this.f18800a.f142833a < this.f18801b.size() - 1;
        }

        @Override // java.util.ListIterator
        public boolean hasPrevious() {
            return this.f18800a.f142833a >= 0;
        }

        @Override // java.util.ListIterator, java.util.Iterator
        public T next() {
            int i10 = this.f18800a.f142833a + 1;
            n.g(i10, this.f18801b.size());
            this.f18800a.f142833a = i10;
            return this.f18801b.get(i10);
        }

        @Override // java.util.ListIterator
        public int nextIndex() {
            return this.f18800a.f142833a + 1;
        }

        @Override // java.util.ListIterator
        public T previous() {
            int i10 = this.f18800a.f142833a;
            n.g(i10, this.f18801b.size());
            this.f18800a.f142833a = i10 - 1;
            return this.f18801b.get(i10);
        }

        @Override // java.util.ListIterator
        public int previousIndex() {
            return this.f18800a.f142833a;
        }
    ...
    public boolean retainAll(Collection<? extends Object> elements) {
        ...
        SnapshotStateList<T> snapshotStateList = this.parentList;
        int i10 = this.offset;
        int iT = snapshotStateList.t(elements, i10, size() + i10);
        if (iT > 0) {
            this.structure = this.parentList.p();
            this.size = size() - iT;
        }
