...
public final class a implements InterfaceC13412a, InterfaceC14304b {
    ...
    static final class C0929a extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super SearchResult>, Object> {
        ...
        private /* synthetic */ Object f43158j;

        /* renamed from: l, reason: collision with root package name */
        final /* synthetic */ String f43160l;

        /* renamed from: m, reason: collision with root package name */
        final /* synthetic */ String f43161m;

        /* renamed from: n, reason: collision with root package name */
        final /* synthetic */ int f43162n;

        /* renamed from: o, reason: collision with root package name */
        final /* synthetic */ Map<FilterFacet, List<FilterFacetOption>> f43163o;

        /* renamed from: p, reason: collision with root package name */
        final /* synthetic */ int f43164p;

        /* renamed from: q, reason: collision with root package name */
        final /* synthetic */ int f43165q;

        /* renamed from: r, reason: collision with root package name */
        final /* synthetic */ FilterSortOption f43166r;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C0929a(String str, String str2, int i10, Map<FilterFacet, List<FilterFacetOption>> map, int i11, int i12, FilterSortOption filterSortOption, Continuation<? super C0929a> continuation) {
            ...
            this.f43164p = i11;
            this.f43165q = i12;
            this.f43166r = filterSortOption;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C0929a c0929a = a.this.new C0929a(this.f43160l, this.f43161m, this.f43162n, this.f43163o, this.f43164p, this.f43165q, this.f43166r, continuation);
            c0929a.f43158j = obj;
            return c0929a;
        }
        ...
        public final Object invoke(InterfaceC16622O interfaceC16622O, Continuation<? super SearchResult> continuation) {
            return ((C0929a) create(interfaceC16622O, continuation)).invokeSuspend(Unit.f142422a);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r23) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: Zo.a.C0929a.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    static final class b extends SuspendLambda implements Function2<InterfaceC16622O, Continuation<? super SearchResult>, Object> {
        ...
        /* renamed from: j, reason: collision with root package name */
        private /* synthetic */ Object f43176j;

        /* renamed from: l, reason: collision with root package name */
        final /* synthetic */ String f43178l;

        /* renamed from: m, reason: collision with root package name */
        final /* synthetic */ int f43179m;

        /* renamed from: n, reason: collision with root package name */
        final /* synthetic */ Map<FilterFacet, List<FilterFacetOption>> f43180n;

        /* renamed from: o, reason: collision with root package name */
        final /* synthetic */ int f43181o;

        /* renamed from: p, reason: collision with root package name */
        final /* synthetic */ int f43182p;

        /* renamed from: q, reason: collision with root package name */
        final /* synthetic */ FilterSortOption f43183q;
        ...
        b(String str, int i10, Map<FilterFacet, List<FilterFacetOption>> map, int i11, int i12, FilterSortOption filterSortOption, Continuation<? super b> continuation) {
            ...
            this.f43181o = i11;
            this.f43182p = i12;
            this.f43183q = filterSortOption;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            b bVar = a.this.new b(this.f43178l, this.f43179m, this.f43180n, this.f43181o, this.f43182p, this.f43183q, continuation);
            bVar.f43176j = obj;
            return bVar;
        }
    ...
    static final class c extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f43194k = obj;
            this.f43196m |= Integer.MIN_VALUE;
            return a.this.c(0, null, this);
        }
    }

    public a(v constructorIo, C13552a hybrisDataSource, e sponsorshipsDataStore, InterfaceC14304b multiProductDataSource, AbstractC16618K ioDispatcher) {
    ...
    private final Object m(int i10, String str, String str2, int i11, int i12, FilterSortOption filterSortOption, Map<FilterFacet, List<FilterFacetOption>> map, Continuation<? super SearchResult> continuation) {
        return C16644i.g(this.ioDispatcher, new C0929a(str2, str, i10, map, i12, i11, filterSortOption, null), continuation);
    }
    ...
    */
    ...
    public Object h(int i10, String str, int i11, int i12, Cursor cursor, Map<FilterFacet, List<FilterFacetOption>> map, FilterSortOption filterSortOption, Continuation<? super SearchResult> continuation) {
        return C16644i.g(this.ioDispatcher, new b(str, i10, map, i12, i11, filterSortOption, null), continuation);
    }
}
