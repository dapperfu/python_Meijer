...
def demo_distance_calculation():
    ...
    stores_data = [
        {
            'UnitId': 100, 'Name': 'North Store', 'City': 'Grand Rapids', 'State': 'MI',
            'Address': '1000 North Ave', 'Zip': '49503', 'PhoneNumber': '6161111111',
            'Latitude': 43.0, 'Longitude': -85.5
        },
        {
            'UnitId': 200, 'Name': 'South Store', 'City': 'Kalamazoo', 'State': 'MI',
            'Address': '2000 South Ave', 'Zip': '49001', 'PhoneNumber': '2692222222',
            'Latitude': 42.2, 'Longitude': -85.6
        },
        {
            'UnitId': 300, 'Name': 'East Store', 'City': 'Lansing', 'State': 'MI',
            'Address': '3000 East Ave', 'Zip': '48933', 'PhoneNumber': '5173333333',
            'Latitude': 42.3, 'Longitude': -84.5
        }
    ]
...
def demo_comprehensive_store():
    ...
    if store.alcohol_sale_restricted_sun_start:
        print(f"   Sunday Hours: {store.alcohol_sale_restricted_sun_start} - {store.alcohol_sale_restricted_sun_end}")
    
    print(f"\n⛽ Additional Services:")
    print(f"   Gas Station: {'✓ Available' if store.has_gas_station() else '✗ Not available'}")
