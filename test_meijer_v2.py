...
def test_credential_authentication(meijer: Meijer) -> bool:
    ...
    try:
        ...
        if meijer.credentials:
            ...
            print(f"Password: {'*' * len(meijer.credentials.get('password', '')) if meijer.credentials.get('password') else 'Not found'}")
...
def test_api_endpoints(meijer: Meijer) -> bool:
    ...
    try:
        ...
        if offers:
            print(f"First offer: {offers[0].get('title', 'No title') if offers[0] else 'No data'}")
        ...
        if home_cards:
            print(f"First card: {home_cards[0].get('title', 'No title') if home_cards[0] else 'No data'}")
        ...
        if special_offers:
            print(f"First special offer: {special_offers[0].get('title', 'No title') if special_offers[0] else 'No data'}")
        ...
        if stores:
            print(f"First store: {stores[0].get('name', 'No name') if stores[0] else 'No data'}")
