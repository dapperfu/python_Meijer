...
if analyzer.load_flows():
    ...
    api_flows = [
        ...
        if "api.meijer.com" in flow.request.pretty_url
    ...
    auth_flows = [
        ...
        if "authorization" in [k.lower() for k in flow.request.headers.keys()]
    ]
    ...
    if auth_flows:
        ...
        print(
            f"  Auth header: {flow.request.headers.get('Authorization', 'NOT_FOUND')[:100]}..."
        )
