#!/usr/bin/env python3
"""
Test the working built-in Selenium authentication method.
This uses the proven OktaSeleniumAuth class that was working.
"""
...
def test_working_selenium_auth():
    """Test the working built-in Selenium authentication."""
    try:
        ...
        print("🚀 Starting working Selenium authentication...")
        print("🌐 Browser will be visible for debugging")
        print("=" * 60)
        
        # Use the working built-in method
        ...
        if result and result.get("success"):
            ...
            # Capture the authentication data
            ...
            print("💡 Close it manually when done debugging")
