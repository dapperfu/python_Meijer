    ...
    try:
        ...
        try:
            ...
            for i, product in enumerate(products[:5]):
                ...
                print(
                    f"     Sale: ${product.sale_price or 'N/A'}"
        ...
        print(
            f"📦 Found {len(individual_products)} products out of {len(subset_upcs)} UPCs"
        )
        ...
        if multi_upc_time > 0 and individual_time > 0:
            ...
            print(
                f"   Estimated individual time for 20 UPCs: {individual_time * 4:.2f}s"
            )
