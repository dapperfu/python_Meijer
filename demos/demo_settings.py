    ...
    try:
        ...
        if choices:
            ...
            for choice in choices:
                print(
                    f"     - {choice.digital_preference_discrete_choice_value} (ID: {choice.digital_preference_discrete_choice_id})"
                )
        else:
        ...
        success = client.settings.update_customer_preference(
            "Substitutions", "Any Brand", "DigitalGrocery"
        )
        ...
        success = client.settings.update_customer_preference(
            "Substitutions", "No Substitutions", "DigitalGrocery"
        )
...
def main():
    ...
    try:
        ...
        print(
            "• Customer preferences: getCustomerPreferences, updateCustomerPreference"
        )
        ...
        print(
            "• Settings flow: Preference updates (Substitutions: Any Brand → No Substitutions)"
        )
