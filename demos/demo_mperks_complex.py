...
from meijer import Meijer, EarnedReward, MCardInfo
...
def test_mperks_earned_rewards():
    ...
    try:
        ...
        print("Content-Type: application/vnd.meijer.digitalmperks.mcardinfo-v1.0+json\n")
        
        try:
            mcard_info = meijer.get_mcard_info()
            print(f"✓ Successfully retrieved mCard info")
        ...
        try:
            ...
            print(f"✓ Successfully retrieved {len(available_rewards)} available rewards")
        ...
        print("Content-Type: application/vnd.meijer.digitalmperks.categories-v1.0+json\n")
        ...
        print("✓ All mPerks methods use client._get_api_headers() and client._make_request()")
        print("✓ mPerks functionality accessible via client.get_earned_rewards(), client.get_mcard_info(), etc.")
        ...
        if meijer.is_authenticated():
            print(f"  • meijer._access_token: {meijer._access_token[:20]}..." if meijer._access_token else "None")
        else:
            print(f"  • meijer._access_token: None (authentication required)")
...
def main():
    ...
    print("- Available rewards endpoint: GET /digital/mperks40/customer/v1/rewards/available")
