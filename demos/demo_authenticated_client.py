...
from meijer.authenticated_client import AuthenticatedMeijerClient, create_authenticated_client
        ...
        with AuthenticatedMeijerClient(headless=True) as client:
            ...
            if success:
                ...
                for cookie in session.cookies:
                    if any(prefix in cookie.name for prefix in ['ak_', 'bm_', 'JSESSIONID']):
