...
def demo_import_export():
    ...
    try:
        ...
        print(
            f"Initial state: {stats['clipped']} clipped, {stats['available']} available"
        )
        ...
        print(
            f"New state: {new_stats['clipped']} clipped, {new_stats['available']} available"
        )
        ...
        print(
            f"Restored state: {restored_stats['clipped']} clipped, {restored_stats['available']} available"
        )
        ...
        imported_count = client.coupons.import_shared_coupons(
        ...
        print(
            f"Final state: {final_stats['clipped']} clipped, {final_stats['available']} available"
        )
        ...
        print(
            f"✓ Exported {len(dry_grocery_coupons)} Dry Grocery coupons to {dry_grocery_file}"
        )
