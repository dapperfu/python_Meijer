...
def populate_shopping_list(client):
    ...
    grocery_items = [
        {"name": "Milk", "description": "Meijer Whole Milk, 1 Gallon", "upc": "4125010211"},
        {"name": "Bread", "description": "Meijer Wheat Bread, 20 oz", "upc": "4125010212"},
        {"name": "Eggs", "description": "Meijer Large Eggs, Dozen", "upc": "4125010213"},
        {"name": "Ground Turkey", "description": "Meijer Ground Turkey, 1 lb", "upc": "4125010214"},
        {"name": "Chips", "description": "Lay's Classic Potato Chips, 8 oz", "upc": "4125010215"},
        {"name": "Cookies", "description": "Oreo Chocolate Sandwich Cookies, 14.3 oz", "upc": "4125010216"},
        {"name": "Bananas", "description": "Fresh Bananas, 1 lb", "upc": "4125010217"},
        {"name": "Apples", "description": "Gala Apples, 3 lb bag", "upc": "4125010218"},
        {"name": "Yogurt", "description": "Meijer Vanilla Yogurt, 6 oz", "upc": "4125010219"},
        {"name": "Cheese", "description": "Meijer Cheddar Cheese, 8 oz", "upc": "4125010220"},
        {"name": "Cereal", "description": "Cheerios Honey Nut, 12.8 oz", "upc": "4125010221"},
        {"name": "Pasta", "description": "Barilla Spaghetti, 16 oz", "upc": "4125010222"},
        {"name": "Tomato Sauce", "description": "Hunt's Tomato Sauce, 8 oz", "upc": "4125010223"},
        {"name": "Onions", "description": "Yellow Onions, 3 lb bag", "upc": "4125010224"},
        {"name": "Potatoes", "description": "Russet Potatoes, 5 lb bag", "upc": "4125010225"}
    ]
