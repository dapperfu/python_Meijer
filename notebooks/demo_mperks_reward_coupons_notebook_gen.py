        ...
        "cells": [
            ...
            },
            {
                ...
                "source": [
                    ...
                    "else:\n",
                    '    print("[CREDIT] Purchase simulation skipped - no suitable coupon or insufficient points")',
                ],
            },
            {
                "cell_type": "markdown",
            ...
            },
            {
                ...
                "source": [
                    ...
                    "        \n",
                    '        print(f"[MONEYBAG] Point-based filtering:")\n',
...
def save_notebook(content, filename="demo_mperks_reward_coupons.ipynb"):
    ...
    print(f"[OK] Notebook saved to: {filename}")


if __name__ == "__main__":
    print("[ROCKET] Generating mPerks Reward Coupons Demo Notebook")
    print("=" * 50)
    ...
    print("[NOTEBOOK] Notebook generated successfully!")
