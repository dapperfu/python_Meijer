        ...
        "cells": [
            ...
            },
            {
                ...
                "source": [
                    ...
                    "# 1. ~/.config/meijer/auth.json (JSON format)\n",
                    "# 2. ~/.config/meijer/auth.json file\n",
                    ...
                    '    print("1. ~/.config/meijer/auth.json with valid Bearer tokens")\n',
                    '    print("2. ~/.config/meijer/auth.json with bearer, user, and password fields")\n',
            ...
            },
            {
                ...
                "source": [
                    ...
                    'print("   - Ensure ~/.config/meijer/auth.json exists with valid tokens")\n',
                    'print("   - Check if Bearer token is expired")\n',
                    'print("   - Verify ~/.config/meijer/auth.json format is correct")\n',
                    "\n",
            ...
            },
            {
                ...
                "source": [
                    ...
                    'print("   - Store tokens in ~/.config/meijer/auth.json")\n',
...
def main():
    ...
    print("[BOOKS] The notebook contains comprehensive examples of:")
    print("   - Basic barcode lookup operations")
    print("   - Bulk barcode processing")
    print("   - Store-specific pricing")
    print("   - Weighted item handling")
    print("   - Error handling and troubleshooting")
    print("   - Performance testing")
    print("   - Real-world usage patterns")
    print("   - Best practices and recommendations")
    print(f"\n[ROCKET] You can now open {filename} in Jupyter and run the examples!")
