...
def demo_coupon_commands():
    ...
    output = run_cli_command(["python3", "-m", "meijer.cli", "coupons", "list", "--limit", "5"])
    if output:
        print("✅ Success! Output:")
        print(output)
    else:
    ...
    output = run_cli_command(["python3", "-m", "meijer.cli", "coupons", "list", "--help"])
    if output:
        print("✅ Success! Output:")
        print(output)
    else:
    ...
    output = run_cli_command(["python3", "-m", "meijer.cli", "coupons", "interactive", "--help"])
    if output:
        print("✅ Success! Output:")
        print(output)
    else:
    ...
    output = run_cli_command(["python3", "-m", "meijer.cli", "coupons", "search", "--help"])
    if output:
        print("✅ Success! Output:")
        print(output)
    else:
