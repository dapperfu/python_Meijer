...
def demo_all_feedback_types():
    ...
    try:
        ...
        print("   • OPEN_CMT: 'Should allow mitm SSL. Very difficult to reverse engineer.'")
    ...
    try:
        ...
        print(f"✅ App feedback via convenience method: {app_result_simple.get('uuid', 'unknown')}")
        ...
        print(f"✅ Store feedback via convenience method: {store_result_simple.get('uuid', 'unknown')}")
        ...
        print(f"✅ Shop & Scan feedback via convenience method: {scan_result_simple.get('uuid', 'unknown')}")
    ...
    print("   meijer.feedback('store', store_name='North Muskegon', store_comment='Best store!')")
    print("   meijer.feedback('shop_scan', feedback_text='Worked perfectly', store_name='Grand Rapids')")
    print()
    print("🔧 Advanced feedback with all options:")
    print("   meijer.feedback('app', feedback_text='App feedback', rating=8, visit_reason='F', ease_rating=9, contact_name='John', email='john@example.com')")
    print("   meijer.feedback('store', store_name='Store Name', store_comment='Store feedback', rating=10, contact_name='Jane', email='jane@example.com', contact_method='B')")
    print("   meijer.feedback('shop_scan', feedback_text='Scan feedback', rating=9, store_name='Store Name', store_comment='Store comment', additional_comments='Additional info')")
